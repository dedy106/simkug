	...
	<div id="container" style="position:absolute;left:15%;top:10%;width:700px;height:400px;">		
		...
		<div id="center" style="position:absolute;left:0px;top:30px;width:100%;height:370px;border:1px solid #cdd1b6;background:#ffffff">
			...
			<div id="right" style="position:absolute;left:420px;top:0;height:100%;width:400px;" align="left">
				<div id="nyusun" class="righttop" style="-webkit-border-top-left-radius:10px;-webkit-border-bottom-right-radius:10px;-moz-border-radius-topleft:10px;-moz-border-radius-bottomright:10px;position:absolute;left:0px;top:5px;width:265px;height:175px;background:#90ac0b;">
					...
					<span class="style2">Penyusunan Anggaran</span> 					  						
					  <img id="img1" src="image/yakes2.gif" alt="" width="98" height="98" style="position:absolute;left:10px;top:60px;" />					 
				...
				<div id="support" class="rightbottom" style="-webkit-border-top-right-radius:10px;-webkit-border-bottom-left-radius:10px;-moz-border-radius-topright:10px;-moz-border-radius-bottomleft:10px;position:absolute;left:0px;top:185px;width:265px;height:175px;background:#379bc5">
					...
					<li><a href="format.php">Format Data</a></li>
					</ul>					
				</div>
