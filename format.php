...
<script language="javascript">	
	...
	function createFrameLoader(){
		try{
			...
			window.frameLoader.src = "app.php?app=app_budget_app";
		}catch(e){
			alert("createHint:"+e);
		}
	};	
	...
	function fixPNG(myImage) 
	{
	    ...
	    {			
			...
			var b9 = $("_sBottom");		
			DD_belatedPNG.fixPngArray([b1,b2,b3,b4,b5,b6,b7,b8,b9,$("_sLeftBottom"),$("_sRightBottom"),$("icon"),$("img1"),$("img2"),$("img12"),$("img11"),$("img22"),$("img21"),$("img32"),$("img31"),$("img41"),$("img42")],false);						
	    }
	};
...
<div id="system" style="position:absolute;left:0px;top:0px;width:100%;height:100%;z-index:9;background:#EAEDD8;font-family:Arial, Helvetica, sans-serif" align="center">
	<div id="container" style="position:absolute;left:15%;top:10%;width:700px;height:400px;">		
		...
		<div id="header" align="left" style="position:absolute;left:0px;top:0px;width:100%;height:30px;border:1px solid #cdd1b6;background:#d7dbc2">
			...
			<img id="indicator" src="image/process.gif" style="position:absolute;left:650px;top:5px;width:20px;height:20px" />
		</div>
		<div id="center" style="position:absolute;left:0px;top:30px;width:100%;height:370px;border:1px solid #cdd1b6;background:#ffffff">
			...
			<img src="image/yakes.gif" width="350" height="150" style="position:absolute;left:10px;top:10px;" />			
			<div style="position:absolute;left:10px;top:170px;width:400px;height:28px;margin:0 0 21px 0;font-height:14px">Selamat Datang di</div>
			<h2 style="position:absolute;left:10px;top:190px;width:400px;height:28px;margin:0 0 21px 0;font-height:50px;font-weight:bold;color:#008ccc">PPBS
			</h2>
			<h3 style="position:absolute;left:10px;top:220px;width:400px;height:28px;margin:0 0 21px 0;font-height:50px;font-weight:bold;color:#379bc5">
			...
			<p style="position:absolute;left:10px;top:220px;width:400px;height:28px;font-size:14px;line-height:18px;font:normal 14px Arial, Helvetica, sans-serif;color:#929292;"><br />
					Pembuatan sistem informasi perencanaan anggaran yang dapat membantu percepatan dan pengakurasian perencanan anggaran sebagai dasar usulan anggaran kepada Pembina YAKES TELKOM</p>
			...
			<div id="right" style="position:absolute;left:420px;top:0;height:100%;width:400px;" align="left">
				...
				<div id="support" class="rightbottom" style="-webkit-border-top-right-radius:10px;-webkit-border-bottom-left-radius:10px;-moz-border-radius-topright:10px;-moz-border-radius-bottomleft:10px;position:absolute;left:0px;top:15px;width:265px;height:300px;background:#379bc5">
					...
					<span class="style2">Format Data</span> 					  
					...
					<li><a href="tools/contoh_abau_load.xls">Upload ABAU</a></li>
					<li><a href="tools/sdm99.xls">Karyawan Pusat</a></li>
					<li><a href="tools/sdm01.xls">Karyawan Area 1</a></li>
					<li><a href="tools/sdm02.xls">Karyawan Area 2</a></li>
					<li><a href="tools/sdm03.xls">Karyawan Area 3</a></li>
					<li><a href="tools/sdm04.xls">Karyawan Area 4</a></li>
					<li><a href="tools/sdm05.xls">Karyawan Area 5</a></li>
					<li><a href="tools/sdm06.xls">Karyawan Area 6</a></li>
					<li><a href="tools/sdm07.xls">Karyawan Area 7</a></li>
					<li><a href="tools/param_gaji.xls">Parameter Gaji</a></li>
					<li><a href="tools/norma_fix.xls">Norma Fix</a></li>
					<li><a href="tools/data_aktap2.xls">Data Aktiva Tetap</a></li>
					</ul>		
					<div style="position:absolute;left:20px;top:160px;width:80px;height:18px;border:1px solid #fff;color:#fff;text-align:center;cursor:pointer;background:#379bc5;font-size:12px;" onmouseover="doMouseOver(this);" onmouseout="doMouseOut(this);" onclick="loadApp();">Masuk...
					  </div>
				</div>
