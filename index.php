...
<script language="javascript">	
	...
	<?php	    		
		...
		echo "window.app_logo='$app_logo_main';\n";
...
<script type="text/javascript" src="office/js/tiny_mce_src.js"></script>
...
<script type="text/javascript" src="classes/addon/socket.io.js"></script>
<script type="text/javascript" src="office/js/tiny_mce_src.js"></script>

</head>
<body onunload="bfrOnUnload(event);" style="overflow:hidden; font-family:Arial; font-size:11px;position:fixed;width:100%;height:100%" leftmargin="0px" rightmargin="0px" topmargin="0px" bottommargin="0px"   >      	  
	  <div id="system_block" style="z-index:3;position:absolute;left:0px;top:0px;width:100%;height:100%;display:none" align='center' valign='middle'>		
	  </div>				  
	  <div id="system_splash" style="z-index:3;position:absolute;left:0%; top:0%; width:100%; height:100%;background:#fff;display:" >				
		<img id="syssplash_img" src="image/jambu.png" width="200px" height="200px" style="z-index:999;position:absolute;left:40%;top:30%;height:200;width:200;"/>			
	  </div>
	  ...
	  <div id="systemHint" align="center" style="position:absolute;left:0px; top:0px; width:100%; height:100%;z-index:10;display:none">      		                         			 
		 <div id="dbgBg2" style="background:#4d7795;position:absolute;left:0px; top:0px;width:100%;height:100%;filter:alpha(opacity:80);opacity:0.8;moz-opacity:0.8" ></div>
		 <div id="dbgTxt2" style="padding:5px 5px 5px 5px;border-left:1px solid #cccccc;border-top:1px solid #cccccc;border-right:1px solid #999999;border-bottom:1px solid #999999;position:absolute;color: #ffffff;background:#283f60;left:0px; top:0px;width:auto;height:auto" ></div>
	  </div>
