...
require_once("server/mail/swift_required.php");
require_once("server/mail/pop3.php");
require_once("server/mail/mime_parser.php");
require_once("server/mail/rfc822_addresses.php");
class server_util_mail extends server_BasicObject
{
	
	protected $smtpHost = "smtp.googlemail.com";
	protected $smtpPort = 465;	
	protected $conType = "tls";
	protected $user = "devptsai@gmail.com";
	protected $pwd = "Saisai2019";
	...
	*/
	function __construct($lokasi = null)
	{
		...
		if (isset($lokasi)) {
			$this->lokasi = $lokasi;
			$rs = execute2("select * from mail_cfg where kode_lokasi = '".$lokasi."'");
