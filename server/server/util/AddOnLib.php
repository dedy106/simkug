...
//----------------------------------------	
	...
	function fnAkun($kode_akun)
	{
		$tmp="";
		$tmp=substr($kode_akun,0,3).".".substr($kode_akun,3,2).".".substr($kode_akun,5,2).".".substr($kode_akun,7,2);
		return $tmp;
	}
  ...
  <tr>
	...
	function terbilang_hari($bilangan) {
