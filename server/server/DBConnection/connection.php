...
* 			SAI, PT											
***********************************************************************************************/
require( "server/ADODB/adodb5/adodb.inc.php");
require( "server/ADODB/adodb5/adodb-xmlschema.inc.php" ); # or adodb-xmlschema03.inc.php
include_once("server/ADODB/adodb5/toexport.inc.php");
...
global $serverDir;
global $dirSeparator;
include("server/conf/dbSetting.php");
