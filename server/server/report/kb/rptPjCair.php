...
class server_report_kb_rptPjCair
{
	protected $caption;
	protected $filter;
	protected $filter2;
...
inner join karyawan e on a.nik_setuju=e.nik and a.kode_lokasi=e.kode_lokasi ".$this->filter;
	...
	function getHtml()
	{
		...
		global $dbLib;
		$sql="select a.no_pj,a.kode_lokasi,a.kode_pp,a.akun_pj,a.periode,date_format(a.due_date,'%d/%m/%Y') as tanggal_ptg,a.nik_pengaju,a.nik_setuju,a.no_dokumen,date_format(a.tanggal,'%d/%m/%Y') as tanggal,a.keterangan,a.nilai,
       c.nama as nama_akun,b.nama as nama_pp,d.nama as nama_pengaju,e.nama as nama_setuju,d.jabatan as jabatan_buat,e.jabatan as jabatan_setuju
from panjar_m a
...
inner join karyawan e on a.nik_setuju=e.nik and a.kode_lokasi=e.kode_lokasi ".$this->filter." order by a.no_pj";
  ...
  <tr>
    <td colspan='8' style='padding:5px'><table width='622' border='0' cellspacing='2' cellpadding='1'>
		<tr>
        <td colspan='2' class='judul_bukti' align='center'>PENGAJUAN PANJAR</td>
        </tr>
		 <tr>
      ...
      <tr>
        <td width='120' class='header_laporan'>No Panjar </td>
        <td width='476' class='header_laporan'>:&nbsp;$row->no_pj</td>
        </tr>
      <tr>
     ...
     <tr>
        <td class='header_laporan'>Tanggal Pertanggungan </td>
        <td class='header_laporan'>:&nbsp;$row->tanggal_ptg</td>
        </tr>
		<tr>
        <td class='header_laporan'>Diajukan Oleh </td>
        <td class='header_laporan'>:&nbsp;$row->nik_pengaju -&nbsp;$row->nama_pengaju</td>
        </tr>
		<tr>
		...
		<tr>
        <td class='header_laporan'>Akun Panjar </td>
        <td class='header_laporan'>:&nbsp;$row->akun_pj -&nbsp;$row->nama_akun</td>
        </tr>
