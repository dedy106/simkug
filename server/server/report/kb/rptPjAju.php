...
class server_report_kb_rptPjAju
{
	protected $caption;
	protected $filter;
	protected $rows;
	...
	function getHtml()
	{
		...
		while (!$page->EOF)
		{
			$sql = "select a.no_pj,a.kode_lokasi,a.kode_pp,a.akun_pj,a.periode,date_format(a.due_date,'%d/%m/%Y') as tanggal_ptg,a.nik_pengaju, a.catatan,
				...
				" and a.no_pj='".$page->fields[0]."' order by a.no_pj ";
			...
			$html.=	"<table width='700' align='center' cellpadding='0' cellspacing='0'>
					        ...
					        <td style='border-bottom:1px solid #111111;'><table width='100%' height='110' border='0' cellpadding='0' cellspacing='0'>
					          <tr>
					            ...
					            <td width='88%' valign='top' align='center'><table width='100%' border='0' cellspacing='0' cellpadding='3'>
					              ...
					              <tr>
					                <td align='center' class='istyle15'>".$rs->no_pj."</td>
					              </tr>
					            </table></td>
					          </tr>
					        </table></td>
					...
					$html .="<td style='border:1px solid #111111; border-right-width:0px;'>&nbsp;$rs->nama_pengaju</td>
					          </tr>
					        </table></td>
					      </tr>
					      <tr>
