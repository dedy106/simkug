...
class server_report_kb_rptDropingKirim
{
	protected $caption;
	protected $filter;
	protected $filter2;
...
inner join karyawan e on a.nik_setuju=e.nik and a.kode_lokasi=e.kode_lokasi  ".$this->filter;
	...
	function getHtml()
	{
		...
		global $dbLib;
		$sql="select a.no_kirim,a.no_alok,a.kode_lokasi,a.akun_tak,a.periode,date_format(a.due_date,'%d/%m/%Y') as due_date,a.nik_buat,a.nik_setuju,a.no_dokumen,date_format(a.tanggal,'%d/%m/%Y') as tanggal,a.keterangan,a.nilai,
       c.nama as nama_akun,d.nama as nama_buat,e.nama as nama_setuju
from dropkrm_m a
inner join masakun c on a.akun_tak=c.kode_akun and a.kode_lokasi=c.kode_lokasi
inner join karyawan d on a.nik_buat=d.nik and a.kode_lokasi=d.kode_lokasi
inner join karyawan e on a.nik_setuju=e.nik and a.kode_lokasi=e.kode_lokasi ".$this->filter." order by a.no_kirim";
		error_log($sql);
  ...
  <tr>
    <td colspan='6' style='padding:5px'><table width='622' border='0' cellspacing='2' cellpadding='1'>
		<tr>
        <td colspan='2' class='judul_bukti' align='center'>DROPING DANA KIRIM</td>
        </tr>
		 <tr>
      ...
      <tr>
        <td width='120' class='header_laporan'>No Kirim </td>
        <td width='476' class='header_laporan'>:&nbsp;$row->no_kirim</td>
        </tr>
      <tr>
     ...
     <tr>
		...
		<tr>
        <td class='header_laporan'>No Alokasi </td>
        <td class='header_laporan'>:&nbsp;$row->no_alok</td>
        </tr>
		<tr>
