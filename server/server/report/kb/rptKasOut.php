...
class server_report_kb_rptKasOut
{
	protected $caption;
	protected $filter;
	protected $rows;
	...
	function getHtml()
	{
		...
		while (!$page->EOF)
		{
			$sql = "select a.no_kas,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,c.no_bukti,d.no_dokumen,a.nilai,
				...
				from kas_m a 
				inner join kas_j b on a.no_kas=b.no_kas and a.kode_lokasi=b.kode_lokasi and a.modul='KBO_ALB' and a.jenis='KAS'
			...
			$html.=	"<table width='750' border='1' align='center' cellpadding='5' cellspacing='0' class='kotak'>
					  <tr>
					    ...
					    <td width='88%'><table width='100%' border='0' cellspacing='0' cellpadding='1'>
					      ...
					      <tr>
					        <td colspan='2' align='center' class='istyle17'>BUKTI KAS KELUAR</td>
					      </tr>
					      <tr>
					        <td colspan='2'>&nbsp;</td>
					      </tr>
