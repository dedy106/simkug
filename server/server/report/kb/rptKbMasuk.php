...
class server_report_kb_rptKbMasuk
{
	protected $caption;
	protected $filter;
	protected $filter2;
	...
	function getTotalPage()
	{
		...
		$sql="select count(distinct a.no_kas)
			...
			".$this->filter+" and a.modul='KBI_NP'";
		//error_log($sql);
	...
	function getHtml()
	{
		global $dbLib;
			...
			$sql="select a.periode,date_format(a.tanggal,'%d/%m/%Y') as tanggal,a.nilai,a.no_kas,a.akun_kb,
				...
				".$this->filter." and a.modul='KBI_NP' order by a.no_kas ";
			//error_log($sql);
	  ...
	  <tr>
	    <td colspan='8' style='padding:5px'><table width='622' border='0' cellspacing='2' cellpadding='1'>
	      <tr>
	        <td colspan='2' class='judul_bukti' align='center'>Bukti Transaksi Kas/Bank Masuk</td>
	        </tr>
		  <tr>
