	...
	function getHtml()
	{
		...
		while (!$page->EOF)
		{
			$sql = "select a.no_spb,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.akun_hutang,a.kode_terima,a.nik_buat,a.nik_setuju,(a.nilai+a.nilai_pot) as nilai,a.nilai_pot,a.nilai as tot,c.alamat,c.bank,c.no_rek,
				b.nama as nama_akun,c.nama as nama_vendor,d.nama as nama_buat,e.nama as nama_setuju,d.jabatan as jabatan_buat,e.jabatan as jabatan_setuju,c.cabang,c.nama_rek
					        ...
					        <td colspan='6' style='padding:0px' align='right'><table width='98%' border='0' cellspacing='0' cellpadding='0'>
					          <tr>
					            ...
					            <td width='50%' style='border:1px solid #111111; border-right-width:0px;'><table width='100%' border='0' cellspacing='0' cellpadding='3'>
					              <tr>
					                <td width='2%'>&nbsp;</td>
					                <td width='17%' rowspan='6' valign='top' class='istyle18'>Catatan : </td>
					              </tr>
					              <tr>
					                <td>&nbsp;</td>
					                </tr>
					      ...
					      <tr>
					        <td height='127' colspan='6' align='right' style='padding:0px;' valign='top'><table width='98%' border='0' cellspacing='0' cellpadding='3'>
					          ...
					          <tr align='center' class='istyle15'>
					            ...
					            <td style='border:1px solid #111111; border-right-width:0px;'>&nbsp;$rs->nama_buat</td>
					          </tr>
					        </table></td>
					      </tr>
					      <tr>
