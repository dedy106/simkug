...
class server_report_kb_rptFfPtg
{
	protected $caption;
	protected $filter;
	protected $filter2;
...
inner join lokasi b on a.kode_lokasi=b.kode_lokasi ".$this->filter;
		...
		{
			$tabel="ifptg_j";
			$sql="select  a.no_ffptg as no_bukti,a.no_kas,a.no_dokumen,a.periode,date_format(a.tanggal,'%d/%m/%Y') as tanggal,a.kode_lokasi
from ffptg_m a
inner join lokasi b on a.kode_lokasi=b.kode_lokasi ".$this->filter;
		}
		error_log($status.$sql);
  ...
  <tr>
    <td colspan='8' style='padding:5px'><table width='622' border='0' cellspacing='2' cellpadding='1'>
      <tr>
        <td colspan='2' class='judul_bukti' align='center'>PERTANGGUNGAN FLUKTUATIF FUND</td>
        </tr>
	  <tr>
