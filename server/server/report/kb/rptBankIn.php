...
class server_report_kb_rptBankIn
{
	protected $caption;
	protected $filter;
	protected $rows;
	...
	function getHtml()
	{
		...
		while (!$page->EOF)
		{
			$sql = "select a.no_kas,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,c.no_bukti,d.no_dokumen,a.nilai,
				...
				from kas_m a 
				inner join kas_j b on a.no_kas=b.no_kas and a.kode_lokasi=b.kode_lokasi and a.modul='KBO_ALL' and a.jenis='BANK'
			...
			$html.=	"<table width='750' border='1' align='center' cellpadding='5' cellspacing='0' class='kotak'>
					  <tr>
					    ...
					    <td width='88%'><table width='100%' border='0' cellspacing='0' cellpadding='1'>
					      ...
					      <tr>
					        <td colspan='2' align='center' class='istyle17'>BUKTI BANK MASUK</td>
					      </tr>
					      <tr>
					        <td colspan='2'>&nbsp;</td>
					      </tr>
					  ...
					  <tr>
					    <td colspan='2' valign='top' style='padding:3px'><table width='100%' border='0' cellspacing='0' cellpadding='2'>
						  ...
						  <tr>
					        <td class='istyle15' valign='top'>Nomor Akun Bank</td>
					        <td class='istyle15' style='border:1px solid #111111;'>".$rs->akun_kb."</td>
						    <td colspan='4'>&nbsp;</td>
						    </tr>
					      <tr>
					        <td colspan='6' height='5'></td>
