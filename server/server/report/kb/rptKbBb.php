...
class server_report_kb_rptKbBb
{
	protected $caption;
	protected $filter;
	protected $filter2;
  ...
  <tr bgcolor='#CCCCCC'>
    ...
    <td width='90' class='header_laporan'><div align='center'>Balance</div></td>
			...
			$sql="select a.no_kas as no_bukti,date_format(a.tanggal,'%d/%m/%Y') as tanggal,a.kode_akun,a.kode_pp,a.kode_drk,a.keterangan,
...
order by a.tanggal ";
    ...
    <td valign='top' class='isi_laporan'><div align='right'>".number_format($saldo,0,',','.')."</div></td>
			...
			$html.="<tr>
    <td height='20' colspan='5' valign='top' class='sum_laporan'><div align='right'>Mutasi</div></td>
  ...
  <tr>
    <td height='20' colspan='7' valign='top' class='sum_laporan'><div align='right'>Saldo Akhir </div></td>
