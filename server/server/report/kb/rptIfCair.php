...
class server_report_kb_rptIfCair
{
	protected $caption;
	protected $filter;
	protected $filter2;
	...
	{
		global $dbLib;
		$sql="select count(*) as jum from if_m a
left join masakun b on a.akun_if=b.kode_akun and a.kode_lokasi=b.kode_lokasi
...
inner join karyawan e on a.nik_setuju=e.nik and a.kode_lokasi=e.kode_lokasi ".$this->filter;
	...
	function getHtml()
	{
		...
		global $dbLib;
		$sql="select a.no_if,date_format(a.tanggal,'%d/%m/%Y') as tanggal,a.keterangan,a.akun_if,a.nik_pengaju,a.nik_setuju,a.nilai,
       b.nama as nama_akun,d.nama as nama_buat,e.nama as nama_setuju,d.jabatan as jabatan_buat,e.jabatan as jabatan_setuju
from if_m a
left join masakun b on a.akun_if=b.kode_akun and a.kode_lokasi=b.kode_lokasi
inner join karyawan d on a.nik_pengaju=d.nik and a.kode_lokasi=d.kode_lokasi
inner join karyawan e on a.nik_setuju=e.nik and a.kode_lokasi=e.kode_lokasi ".$this->filter." order by a.no_if";
		error_log($sql);
  ...
  <tr>
    <td style='padding:5px;'><table width='780' border='0' cellspacing='2' cellpadding='1'>
      ...
      <tr>
        ...
        <td width='620' class='isi_bukti'>:&nbsp;$row->if</td>
      </tr>
      <tr>
