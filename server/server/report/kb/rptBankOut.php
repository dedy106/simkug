...
class server_report_kb_rptBankOut
{
	protected $caption;
	protected $filter;
	protected $rows;
	...
	function getHtml()
	{
		...
		while (!$page->EOF)
		{
			$sql = "select a.no_kas,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,c.no_bukti,d.no_dokumen,a.nilai,
				...
				from kas_m a 
				inner join kas_j b on a.no_kas=b.no_kas and a.kode_lokasi=b.kode_lokasi and a.modul='KBO_ALB' and a.jenis='BANK'
			...
			if ($rs->no_bg == " " || $rs->no_bg=="" || $rs->no_bg==null)
				$bg="-";
			else $bg=$rs->no_bg;
			$html="<br />";
			$html.=	"<table width='750' border='1' align='center' cellpadding='5' cellspacing='0' class='kotak'>
					  <tr>
					    ...
					    <td width='88%'><table width='100%' border='0' cellspacing='0' cellpadding='1'>
					      ...
					      <tr>
					        <td colspan='2' align='center' class='istyle17'>BUKTI BANK KELUAR </td>
					      </tr>
					      <tr>
					        <td colspan='2'>&nbsp;</td>
					      </tr>
					  ...
					  <tr>
					    <td colspan='2' valign='top' style='padding:3px'><table width='100%' border='0' cellspacing='0' cellpadding='2'>
					      ...
					      <tr>
					        <td class='istyle15'>Dibayarkan kepada </td>
					        <td colspan='5' class='istyle15' style='border:1px solid #111111;'>".$rs->no_dokumen."</td>
					      </tr>
						  <tr>
					        <td colspan='6' height='5'></td>
					        </tr>
					      ...
					      <tr valign='top'>
					        ...
					        <td colspan='3' class='istyle15' style='border:1px solid #111111;'><em>SURAT PERINTAH BAYAR</em></td>
					        <td width='12%' align='right' class='istyle15'>Nomor &nbsp;</td>
					        <td width='21%' class='istyle15' style='border:1px solid #111111;'>".$rs->no_bukti."</td>
					      </tr>
						  <tr>
					      ...
					      <tr>
					        <td class='istyle15' valign='top'>Nomor Cek/BG</td>
					        <td colspan='5' style='padding:0px 0px 0px 0px;'><table width='100%' border='0' cellspacing='0' cellpadding='2'>
					          <tr>
					            <td class='istyle15' width='48%' style='border:1px solid #111111;'>".$bg."</td>
					            <td class='istyle15' width='19%' align='center'>Nomor Akun Bank </td>
					            <td class='istyle15' width='33%' style='border:1px solid #111111;'>".$rs->akun_kb."</td>
					          </tr>
					        </table></td>
					        </tr>
					      <tr>
					    ...
					    <td colspan='2' valign='top' style='padding:3px'><table width='100%' border='1' cellspacing='0' cellpadding='1' class='kotak'>
					      ...
					      <tr valign='top'>
					        ...
					        <td><table width='100%' border='0' cellspacing='0' cellpadding='1'>
					          ...
					          <tr>
					            <td width='7%' align='center'>&nbsp;</td>
					            <td width='87%' align='center' style='border-bottom:1px solid #111111'><em>GM Treasury &amp; Accounting / Finance &amp; Adm. Director </em></td>
					            <td width='6%' align='center'>&nbsp;</td>
					          </tr>
					          <tr>
