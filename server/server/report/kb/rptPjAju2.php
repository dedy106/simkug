...
class server_report_kb_rptPjAju2
{
	protected $caption;
	protected $filter;
	protected $rows;
	...
	function getTotalPage()
	{
		...
		$sql = "select count(distinct a.no_pj) from panjar_m a ".$this->filter;
	...
	function getHtml()
	{
		$sql0="select distinct a.no_pj from panjar_m a ".$this->filter;
		...
		while (!$page->EOF)
		{
			$sql = "select distinct a.no_pj,a.no_dokumen,a.keterangan as ket1,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.nilai as tot, a.akun_pj,m.nama as nmpjr,
				b.kode_akun,c.nama as nmakun,b.keterangan as ket2,b.nilai,a.nik_setuju,upper(e.nama) as nmstju,e.jabatan as jab1,
				a.nik_pengaju,upper(d.nama) as nmbuat,d.jabatan as jab2,a.kode_pp,f.nama as nmpp,b.kode_pp as pp,b.dc, 
				ifnull(g.nilai,0) as sisa,ifnull(h.nilai,0) as anggthn,ifnull(i.nilai,0) as anggbln
				from panjar_m a inner join panjar_j b on a.no_pj=b.no_pj and a.kode_lokasi=b.kode_lokasi
				inner join masakun c on b.kode_akun=c.kode_akun and b.kode_lokasi=c.kode_lokasi
				inner join masakun m on a.akun_pj=m.kode_akun and a.kode_lokasi=m.kode_lokasi
				...
				left join angg_r g on b.kode_akun=g.kode_akun and b.no_pj=g.no_bukti and b.kode_lokasi=g.kode_lokasi
				...
				" and a.no_pj='".$page->fields[0]."' order by a.no_pj,b.dc desc ";
			...
			$html.=	"<table width='750' border='0' align='center' cellpadding='0' cellspacing='0'>
					  <tr>
					    <td class='istyle12' align='center' style='padding-bottom:4px;'>LAMPIRAN PENGAJUAN PANJAR</td>
					  </tr>
					  <tr>
					      ...
					      <tr>
					        <td height='149'><table width='100%' border='0' cellspacing='0' cellpadding='3'>
					          <tr>
					            ...
					            <td class='istyle14' width='50%'>".$rs->no_pj."</td>
					            <td class='istyle14' width='12%'>No. SPP</td>
					            <td class='istyle14' width='2%'>:</td>
					            <td class='istyle14' width='17%'>".$rs->no_pj."</td>
					          </tr>
					          <tr>
					            <td class='istyle14'>Nama</td>
					            <td class='istyle14'>:</td>
					            <td class='istyle14'>".$rs->nik_pengaju." ".$rs->nmbuat."</td>
					            <td class='istyle14'>Nilai Panjar </td>
					            <td class='istyle14'>:</td>
					          ...
					          <tr>
					            <td class='istyle14' valign='top'>Akun</td>
					            <td class='istyle14' valign='top'>:</td>
					            <td class='istyle14' valign='top'>".$rs->akun_pj."($rs->nmpjr),untuk anggaran: </td>
					            <td class='istyle14' valign='top'>&nbsp;</td>
					            <td class='istyle14' valign='top'>&nbsp;</td>
					            <td class='istyle14' valign='top'>&nbsp;</td>
					          </tr>
					...
					while ($dt = $data->FetchNextObject($toupper=false))
					{
					  ...
					  <tr>
					    <td class='istyle14' style='padding-top:4px;'>&nbsp;&nbsp;&nbsp;&nbsp;Nilai Panjar : ".$AddOnLib->terbilang($rs->tot)."</td>
					  </tr>
					  <tr>
					    <td>&nbsp;</td>
					  </tr>
