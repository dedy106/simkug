...
class server_report_eclaim2_rptVerifikasiMail extends server_report_basic
{	
...
left join tlk_user i on h.nik_ver=i.nik ".$this->filter;
  ...
  <tr>
    ...
    echo "</table></td>
		...
		$numSent = $mail->sendMail($fromadm,$email,$emailadm,$emailttg,"Verifikasi No $no_ver ", $html,null);
