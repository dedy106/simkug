...
class server_report_gl_rptBB
{
	...
	function getHtml()
	{
		...
		$html=$AddOnLib->judul_laporan("laporan buku besar",$this->lokasi,$AddOnLib->ubah_periode($periode));
  ...
  <tr bgcolor='#CCCCCC'>
    ...
    <td width='90' class='header_laporan'><div align='center'>Balance</div></td>
			...
			$tabel ="(select * from gldt_h ".$filter2[0]." 
union all 
select * from gldt ".$filter2[0]." )";
