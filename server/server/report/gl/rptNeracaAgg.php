...
class server_report_gl_rptNeracaAgg
{
	protected $caption;
	protected $filter;
	protected $filter2;
...
case modul when 'A' then n4 else -n4 end as n4,case modul when 'A' then n5 else -n5 end as n5
from neraca_tmp 
where jenis_akun='Neraca' and nik_user='$nik_user' and level_lap<=$level_lap
order by modul,rowindex ";
		...
		$html=$AddOnLib->judul_laporan("laporan neraca anggaran",$this->lokasi,$AddOnLib->ubah_periode($periode));
  ...
  <tr>
    ...
    <td width='100' class='header_laporan'><div align='center'>Bulan Ini </div></td>
    <td width='100' class='header_laporan'><div align='center'>S/D Bulan Ini </div></td>
    <td class='header_laporan'><div align='center'>5/2</div></td>
    <td class='header_laporan'><div align='center'>5/4</div></td>
  </tr>
  <tr>
