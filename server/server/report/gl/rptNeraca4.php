...
class server_report_gl_rptNeraca4
{
	protected $caption;
	protected $filter;
	protected $filter2;
	...
	function getHtml()
	{
		...
		$html=$AddOnLib->judul_laporan("laporan neraca empat periode",$this->lokasi,"");
...
<td class='detail_laporan'><div align='right'>$so_akhir</div></td>
		...
		$sql = "select kode_neraca,kode_fs,kode_lokasi,nama,tipe,n1*-1 as n1,n2*-1 as n2,-n3 as n3,-n4 as n4,level_spasi from neraca_tmp where modul='P' order by rowindex ";
