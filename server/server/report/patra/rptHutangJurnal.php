...
class server_report_patra_rptHutangJurnal extends server_report_basic
{
...
left join karyawan c on a.nik_buat=c.nik and a.kode_lokasi=c.kode_lokasi $filter2 $modul";
	...
	function getHtml()
	{
		...
		$sql="select a.no_hutang,a.no_dokumen,a.kode_lokasi,a.periode,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tanggal1,a.keterangan,a.kode_lokasi,
...
left join karyawan c on a.nik_app=c.nik and a.kode_lokasi=c.kode_lokasi $this->filter ";
  ...
  <tr>
	...
	function doPrintHeader($sender, $page){		
		...
		$sender->Cell(10,5,"",'L',0,'C');$sender->Cell(30,5,"No Bukti",0,0,'l');$sender->Cell(5,5,":",0,0,'C');$sender->Cell($w-  55,5,$sender->row->no_hutang,'R',1,'L');
