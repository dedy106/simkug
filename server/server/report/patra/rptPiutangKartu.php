...
class server_report_patra_rptPiutangKartu extends server_report_basic
{
...
$this->filter ";
	...
	function getHtml()
	{
		...
		global $dbLib;
		$sql="select a.kode_lokasi,a.no_ar,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.nilai,b.nama as nama_cust
from patra_ar_m a
inner join patra_cust b on a.kode_cust=b.kode_cust and a.kode_lokasi=b.kode_lokasi 
  ...
  <tr >
    <td height='23' colspan='7' class='header_laporan'><table  border='0' cellspacing='2' cellpadding='1'>
      <tr>
        ...
        <td width='360' class='header_laporan'>: $row->no_ar</td>
      </tr>
	  <tr>
        <td width='99' class='header_laporan'>No Invoice</td>
...
";
			...
			$sql="select a.kode_lokasi,a.no_bukti,a.nilai_curr,date_format(b.tanggal,'%d/%m/%Y') as tanggal,b.keterangan
from patra_kaspiutang_d a
inner join kas_m b on a.no_bukti=b.no_kas and a.kode_lokasi=b.kode_lokasi
where a.no_ar='$row->no_ar' and a.kode_lokasi='$row->kode_lokasi' ";
    ...
    <td valign='top' class='isi_laporan' align='right'>".number_format($row1->nilai_curr,0,',','.')."</td>
   ...
   <td valign='top' class='isi_laporan' align='right'>".number_format($nilai_curr,0,',','.')."</td>
  <td valign='top' class='isi_laporan' align='right'>".number_format($saldo,0,',','.')."</td>
 </tr></table><br>";
