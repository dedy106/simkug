...
class server_report_investasi_Karyawan
{
	protected $caption;
	protected $filter;
	protected $filter2;
	...
	function getTotalPage()
	{
		...
		$sql="select count(*) from karyawan ".$this->filter;
		global $dbLib;
	...
	function getHtml()
	{
		/*$sql = "select a.kode, b.nama, a.so_awal, a.debet, a.kredit, a.so_akhir from glma a ".
				" inner join masakun b on b.kode = a.kode and a.kode_lokasi = b.kode_lokasi ". $this->filter .
				" order by a.kode";*/
		$sql = "select * from karyawan ".$this->filter." order by nik";
		$start = (($this->page-1) * $this->rows);
		//$sql .= " limit ". $start . "," . $this->rows;
		
		$html = "<label style='{font-size:20px;}'><b>Data Karyawan</b></label><br>"; 		
		...
		$html .= "<table width='900' border='1' cellpadding='0' cellspacing='0' bordercolor='#000000'>".				
				...
				"   <th width='70' nowrap='nowrap' scope='col'><font color='#ffffff'>NIK</font></th>".	
				"   <th width='200' nowrap='nowrap' scope='col'><font color='#ffffff'>Nama</font></th>".
				"   <th width='150' nowrap='nowrap' scope='col'><font color='#ffffff'>Jabatan</font></th>".
				"   <th width='150' nowrap='nowrap' scope='col'><font color='#ffffff'>Telepon</font></th>".
				"   <th width='150' nowrap='nowrap' scope='col'><font color='#ffffff'>e-mail</font></th>".
		...
		if (!$rs)
		{
			...
			while (!$rs->EOF)
			{
				$html .= "<tr>".
						...
						"   <td nowrap='nowrap' style='{font-size:10;}' align='right'>&nbsp;". $rs->fields[2]."&nbsp;</td>".
