...
class server_report_eclaim_rptVerifikasi extends server_report_basic
{	
...
inner join eclaim_ver h on a.no_klaim=h.no_klaim
left join eclaim_user i on h.nik_ver=i.nik ".$this->filter;
...
inner join eclaim_asuransi f on a.kode_asuransi=f.kode_asuransi
inner join eclaim_curr g on a.kode_curr=g.kode_curr
inner join eclaim_ver h on a.no_klaim=h.no_klaim and a.kode_ttg=h.kode_ttg
left join eclaim_hakakses i on h.nik_ver=i.nik and a.kode_ttg=i.kode_ttg ".$this->filter;
  ...
  <tr>
    <td align='center'  class='lokasi_laporan'>VERIFKASI LAPORAN AWAL KLAIM</td>
  </tr>
  <tr>
