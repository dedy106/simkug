...
class server_report_eclaim_rptVerifikasiMail extends server_report_basic
{	
...
left join eclaim_user i on h.nik_ver=i.nik ".$this->filter;
  ...
  <tr>
    ...
    echo "</table></td>
		...
		$numSent = $mail->sendMail(null, $email,"Verifikasi Klaim1", $html,null);
		$numSent = $mail->sendMail(null, $emailadm,"Verifikasi Klaim2", $html,null);
		$numSent = $mail->sendMail(null, $emailttg,"Verifikasi Klaim3", $html,null);
		return "";
	}
