...
class server_report_eclaim_rptLapAwalMail extends server_report_basic
{	
  ...
  <tr>
   ...
   <tr>
    ...
    <td class='laporan_isi'>$row->nik_user</td>
		...
		$numSent = $mail->sendMail(null, $email,"laporan klaim awal1", $html,null);
		$numSent = $mail->sendMail(null, $emailadm,"Laporan Klaim2", $html,null);
		$numSent = $mail->sendMail(null, $emailttg,"Laporan Klaim3", $html,null);
		return "";
	}
