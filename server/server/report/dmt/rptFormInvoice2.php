...
class server_report_dmt_rptFormInvoice2 extends server_report_basic
{	
...
";
	...
	function getHtml()
	{
		...
		$tmp=explode("/",$this->filter2);
		$nama_ver=$tmp[0];
		$sql="select a.no_ar,a.tanggal,a.keterangan,a.no_kontrak,a.nilai,substring(b.periode,1,4) as thn_kontrak
					    ...
					    <td colspan='3'><table width='100%' border='2' cellspacing='0' cellpadding='1' style='border:2px solid #111111; border-collapse:collapse'>
						  ...
						  echo "<tr valign='top'>
							...
							<tr>
					          ...
					          <tr>
					            <td class='istyle15'><strong>".$row1->nama_site."</strong></td>
					          </tr>
