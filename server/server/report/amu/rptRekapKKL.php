...
class server_report_amu_rptRekapKKL extends server_report_basic
{	
	var $tblHeader;
	var $dbField;
	var $dbSQL;
	...
	function getHtmlRegional(){
		...
		$sql0 = "select c.nama as ubis, c.kode_lokfa as divisi, b.kode_lokfa, b.nama
				...
				($diva ? " union 
					select '-',c.kode_lokfa as divisi, c.kode_lokfa, 'Kantor Divisi' from 
					amu_lokasi c  ".  $this->filter ." and c.kode_induk = '00'" : " ");					
					 
		
		$sql1 = "select kode_lokfa, count(no_gabung) as nka, sum(nilai) as nilai, sum(nilai_ap) as nilai_ap, sum(nilai_buku) as nilai_buku from (								
								select c.kode_lokfa, a.no_gabung, a.nilai, a.nilai_ap, a.nilai_buku from amu_asset a 								
								inner join amu_lokasi c on c.kode_lokfa = a.kode_lokfa and c.kode_induk = '00'													
								inner join (select distinct kode_klpfa, jenis_proc from amu_bagiklp_d ) l on l.kode_klpfa = a.kode_klpfa and l.jenis_proc = 'FISIK'								
								" .( $diva ? "where (a.ref1 = '-' or trim(a.ref1) = '' )":"") ."
								union 
								select b.kode_lokfa, a.no_gabung, a.nilai, a.nilai_ap, a.nilai_buku from amu_asset a 
								...
								inner join (select distinct kode_klpfa, jenis_proc from amu_bagiklp_d ) l on l.kode_klpfa = a.kode_klpfa and l.jenis_proc = 'FISIK'												
								union 
								select d.kode_lokfa, a.no_gabung, a.nilai, a.nilai_ap, a.nilai_buku from amu_asset a 
								...
								inner join (select distinct kode_klpfa, jenis_proc from amu_bagiklp_d ) l on l.kode_klpfa = a.kode_klpfa and l.jenis_proc = 'FISIK'																								
								) a group by kode_lokfa";
								
					$sql2 = "select kode_lokfa,count(no_gabung) as nka, sum(nilai) as nilai, sum(nilai_ap) as nilai_ap, sum(nilai_buku) as nilai_buku from (								
								select  c.kode_lokfa, a.no_gabung, a.nilai, a.nilai_ap, a.nilai_buku from amu_asset a 								
								inner join amu_lokasi c on c.kode_lokfa = a.kode_lokfa and c.kode_induk = '00'					
								inner join amu_kkl_d d on d.no_gabung = a.no_gabung 								
								inner join (select distinct kode_klpfa, jenis_proc from amu_bagiklp_d ) l on l.kode_klpfa = a.kode_klpfa and l.jenis_proc = 'FISIK'																								
								" .( $diva ? "where (a.ref1 = '-' or trim(a.ref1) = '' )":"") ."
								union 
								select b.kode_lokfa, a.no_gabung, a.nilai, a.nilai_ap, a.nilai_buku from amu_asset a 
								...
								inner join (select distinct kode_klpfa, jenis_proc from amu_bagiklp_d ) l on l.kode_klpfa = a.kode_klpfa and l.jenis_proc = 'FISIK'																								
								union 
								select dd.kode_lokfa, a.no_gabung, a.nilai, a.nilai_ap, a.nilai_buku from amu_asset a 
								inner join amu_lokasi b on b.kode_lokfa = a.kode_lokfa
						...
						$sql3 = "select kode_lokfa, count(no_gabung) as nka, sum(nilai) as nilai, sum(nilai_ap) as nilai_ap, sum(nilai_buku) as nilai_buku from (
								select c.kode_lokfa, a.no_gabung, a.nilai, a.nilai_ap, a.nilai_buku from amu_asset a 
								inner join amu_lokasi c on c.kode_lokfa = a.kode_lokfa and c.kode_induk = '00'					
						...
						$sql4 = "select kode_lokfa, count(no_gabung) as nka, sum(nilai) as nilai, sum(nilai_ap) as nilai_ap, sum(nilai_buku) as nilai_buku from (
								select c.kode_lokfa, a.no_gabung, a.nilai, a.nilai_ap, a.nilai_buku from amu_asset a 
								inner join amu_lokasi c on c.kode_lokfa = a.kode_lokfa and c.kode_induk = '00'					
								inner join amu_ba_inv d on d.no_gabung = a.no_gabung 								
								inner join (select distinct kode_klpfa, jenis_proc from amu_bagiklp_d ) l on l.kode_klpfa = a.kode_klpfa and l.jenis_proc = 'FISIK'	
								" .( $diva ? "where (a.ref1 = '-' or trim(a.ref1) = '' )":"") ."
								union
								select b.kode_lokfa, a.no_gabung, a.nilai, a.nilai_ap, a.nilai_buku from amu_asset a 
		...
		$sql1 = "select x.kode_lokfa, x.nama, a.nka, a.nilai, a.nilai_ap, a.nilai_buku, 
					...
					left outer join (".$sql2.") b on b.kode_lokfa = a.kode_lokfa 
					left outer join (".$sql3.") c on c.kode_lokfa = a.kode_lokfa 
					left outer join (".$sql4.") d on d.kode_lokfa = a.kode_lokfa order by a.kode_lokfa";
				...
				<td><table width='100%' border='0' cellspacing='2' cellpadding='1'>
				  <tr>
					...
					<table width='100%' border='0' cellspacing='2' cellpadding='1'>
					  <tr>
						<td colspan=2 align='center' class='lokasi_laporan2'>REKAPITULASI HASIL INVENTARISASI FISIK </td>						
					  </tr>					
					  <tr>
		...
		echo "<tr>
		  ...
		  <tr align='center' bgcolor='#CCCCCC'>
			...
			<td colspan='4' bgcolor='#ff6600' class='header_laporan' style='color:#ffffff'>KKIL</td>
			<td colspan='4' bgcolor='#333333' class='header_laporan' style='color:#ffffff'>KKP Rekonsiliasi</td>
			<td colspan='4' bgcolor='#ff9900' class='header_laporan' style='color:#ffffff'>Berita Acara</td>
		   </tr>
		  <tr align='center' bgcolor='#CCCCCC'>
	...
	function getHtmlDivisi(){
		...
		$sql1 = "select a.kode_lokfa,x.nama, a.nka, a.nilai, a.nilai_ap, a.nilai_buku, 
					ifnull(b.nka,0) as nka2, ifnull(b.nilai,0) as nilai2, ifnull(b.nilai_buku,0) as nilai_buku2, ifnull(b.nilai_ap,0) as nilai_ap2, 
					ifnull(c.nka,0) as nka3, ifnull(c.nilai,0) as nilai3, ifnull(c.nilai_ap,0) as nilai_ap3, ifnull(c.nilai_buku,0) as nilai_buku3,
					ifnull(d.nka,0) as nka4, ifnull(d.nilai,0) as nilai4, ifnull(d.nilai_ap,0) as nilai_ap4, ifnull(d.nilai_buku,0) as nilai_buku4  
					from 
					...
					inner join (".$sql1.") a on a.kode_Lokfa = x.kode_lokfa 
					left outer join (".$sql2.") b on b.kode_lokfa = a.kode_lokfa 
					left outer join (".$sql4.") c on c.kode_lokfa = a.kode_lokfa
					left outer join (".$sql3.") d on d.kode_lokfa = a.kode_lokfa order by a.kode_lokfa";
	...
	function createXlsDivisi(){
		...
		$sheet->write(2,2,"REKAPITULASI HASIL INVENTARISASI FISIK - ". $jns_proc, $header);
		...
		$sheet->setMerge($startRow,6,$startRow,9); $sheet->write($startRow,6,"KKIL", $hdrKonv);
		...
		$sheet->setMerge($startRow,10,$startRow,13); $sheet->write($startRow,10,"KKP Rekonsiliasi", $hdrVer);
		...
		$sheet->setMerge($startRow,14,$startRow,17); $sheet->write($startRow,14,"Berita Acara", $hdrBA);
	...
	function getHtmlArea(){
		...
		{									
				...
				$sql1 = "select kode_lokfa, count(no_gabung) as nka, sum(nilai) as nilai, sum(nilai_ap) as nilai_ap, sum(nilai_buku) as nilai_buku from (								
								select ifnull(x.dcs_area,'Kantor Regional') as kode_lokfa, a.no_gabung, a.nilai, a.nilai_ap, a.nilai_buku from amu_asset a 
								inner join amu_lokasi b on b.kode_lokfa = ". ($diva ? "a.ref1":"a.kode_lokfa"). "
								inner join amu_lokasi c on c.kode_lokfa = b.kode_induk and c.kode_induk = '00'
								inner join (select distinct kode_klpfa, jenis_proc from amu_bagiklp_d ) l on l.kode_klpfa = a.kode_klpfa and l.jenis_proc = 'FISIK'
				...
				$sql1 = "select a.kode_lokfa, a.nka, a.nilai, a.nilai_ap, a.nilai_buku, 
						ifnull(b.nka,0) as nka2, ifnull(b.nilai,0) as nilai2, ifnull(b.nilai_buku,0) as nilai_buku2, ifnull(b.nilai_ap,0) as nilai_ap2, 
						ifnull(c.nka,0) as nka3, ifnull(c.nilai,0) as nilai3, ifnull(c.nilai_ap,0) as nilai_ap3, ifnull(c.nilai_buku,0) as nilai_buku3, 
						ifnull(d.nka,0) as nka4, ifnull(d.nilai,0) as nilai4, ifnull(d.nilai_ap,0) as nilai_ap4, ifnull(d.nilai_buku,0) as nilai_buku4 
						from 
