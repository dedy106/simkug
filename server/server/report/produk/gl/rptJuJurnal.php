...
class server_report_produk_gl_rptJuJurnal extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.no_ju as no_bukti,a.no_dokumen,c.nama,date_format(b.tanggal,'%d/%m/%Y') as tanggal,a.nik_buat,
  ...
  <tr bgcolor='#CCCCCC'>
	...
	<td width='80' class='header_laporan' align='center'>Pembuat</td>
  ...
  <td valign='middle' class='isi_laporan' align='center'>$row->posted</td>
	...
	<td valign='middle' class='isi_laporan'>".$row->nik_buat."</td>
