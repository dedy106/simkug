...
class server_report_hris_rptPosSpj extends server_report_basic
{
...
order by a.no_spj ";
		...
		echo $AddOnLib->judul_laporan("posisi spj",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
		echo "<table  border='0' cellspacing='2' cellpadding='1'>
  <tr>
    <td align='center'><table border='1' cellspacing='0' cellpadding='0' class='kotak'>
   <tr bgcolor='#CCCCCC'>
     <td width='30'  align='center' class='header_laporan'>No</td>
     <td width='80'  align='center' class='header_laporan'>No spj</td>
	 <td width='60'  align='center' class='header_laporan'>Tgl spj</td>
