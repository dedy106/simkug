...
class server_report_hris_rptPosAbsen extends server_report_basic
{
...
order by a.no_absen ";
  ...
  <tr>
   ...
   <tr bgcolor='#CCCCCC'>
     ...
     <td width='80'  align='center' class='header_laporan'>No Absen</td>
	 <td width='60'  align='center' class='header_laporan'>Tgl Absen</td>
