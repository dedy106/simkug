...
class server_report_hris_rptCvSk extends server_report_basic
{	
...
a.lembaga,a.asal_lamaran,a.cabang,a.no_rek,a.nama_rek,a.nip,a.flag_gaji,n.nama as nama_kota 
 from gr_karyawan a 
inner join gr_prov b on a.kode_prov=b.kode_prov 
inner join gr_status_agama c on a.sts_agama=c.sts_agama and a.kode_lokasi = c.kode_lokasi 
inner join gr_strata d on a.kode_strata=d.kode_strata and a.kode_lokasi=d.kode_lokasi 
...
inner join gr_vendor k on a.kode_vendor=k.kode_vendor and a.kode_lokasi = k.kode_lokasi 
inner join gr_status_bank l on a.sts_bank=l.sts_bank and a.kode_lokasi = l.kode_lokasi
inner join gr_jur m on a.kode_jur=m.kode_jur and a.kode_lokasi=m.kode_lokasi
inner join gr_kota n on a.kode_kota=n.kode_kota and a.kode_lokasi=n.kode_lokasi $this->filter ";
	   ...
	   <tr>
        <td><table width='100%' border='1' cellspacing='0' cellpadding='0' class='kotak'>
          <tr align='center' bgcolor='#CCCCCC'>
			...
			$sts_sk=" and b.sts_sk<>'SK9' ";
			if ($status_sk=="Ya")
			{
				$sts_sk="";
			}
          $sql1="select date_format(a.tgl_masuk,'%d/%m/%Y') as tgl_sk,a.no_sk,a.nama as ket_sk
from gr_sk a
inner join gr_sk_d b on a.no_sk=b.no_sk and a.nik=b.nik and a.kode_lokasi=b.kode_lokasi
where a.nik = '$row->nik' and a.kode_lokasi='$row->kode_lokasi' $sts_sk order by a.tgl_masuk desc";
...
where a.nik = '$row->nik' and a.kode_lokasi='$row->kode_lokasi' order by c.tgl_masuk desc";
      ...
      <tr>
        <td><table width='100%' border='1' cellspacing='0' cellpadding='0' class='kotak'>
		  ...
		  $sql1="select a.nik,b.nama,a.no_sk,date_format(c.tgl_masuk,'%d/%m/%Y') as tgl_awal_sk,a.lama,d.nama as sanksi,date_format(a.tgl_mulai,'%d/%m/%Y') as tgl_mulai,date_format(a.tgl_selesai,'%d/%m/%Y') as tgl_selesai,a.keterangan
from gr_rwysanksi a 
inner join gr_karyawan b on a.nik=b.nik and a.kode_lokasi=b.kode_lokasi 
inner join gr_sk c on a.no_sk=c.no_sk and a.kode_lokasi=c.kode_lokasi 
