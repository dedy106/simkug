...
class server_report_addon_fp_rptFaktur
{
	protected $caption;
	protected $filter;
	protected $rows;
	...
	function getTotalPage()
	{
		...
		$sql = "select count(*) from fp_invoice a
...
inner join cust d on a.kode_cust=d.kode_cust and a.kode_lokasi=d.kode_lokasi ".$this->filter;
	...
	function getHtml()
	{
		...
		$html="";
		for ($j = 1; $j <= 2; $j++) {
		$sql = "select b.nama,a.status,concat(b.alamat,' ',b.kota,' ',b.kodepos) as alamat,b.npwp,b.tgl_pkp,c.nama as nama_app,c.jabatan,
...
inner join cust d on a.kode_cust=d.kode_cust and a.kode_lokasi=d.kode_lokasi ".$this->filter;
		...
		$html.= "<table width='650' border='0' align='center' cellpadding='0' cellspacing='0'>
				      ...
				      <tr>
				        <td ><table width='100%' border='0' cellspacing='1' cellpadding='1'>
				          ...
				          <tr>
							...
							$sql1="select nu,keterangan,nilai from fp_invoice_d where no_faktur='$rs->no_faktur' order by nu";
						...
						while ($kon2 = $data2->FetchNextObject($toupper=false))
						{
							$html.="<tr class='istyle15'>
				                  <td align='right'>";
							if ($kon2->nilai > 0)
							{ $html.=number_format($kon2->nilai,0,",",".");}
							else
							{ $html.=""; }
							$html.="</td></tr>";
							$tot+=$kon2->nilai;
				...
				<table width='650' border='0' ><tr><td align='left'>* Coret yang tidak perlu</td></tr></table> <br>";
		}
