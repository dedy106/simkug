...
global $dbLib;
class server_report_rra_rptPdrk1Pra extends server_report_basic
{	
  ...
  <tr>
    <td><table width='100%'  border='0' cellpadding='0' cellspacing='0'>
      ...
      <tr>
        <td align='center'>$row->nik_app2</td>
        <td>&nbsp;</td>
        <td align='center'>$row->nik_app1</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      ...
      <tr>
        <td>&nbsp;</td>
        <td align='center'>$row->nik_app3</td>
        <td>&nbsp;</td>
      </tr>
    </table></td>
  </tr>
