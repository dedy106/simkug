...
class server_report_saku2_frigia_rptBbCust extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		$kode_akun=$tmp[2];
		$kode_cust=$tmp[3];
		$sql="select a.kode_cust,a.nama as nama_cust,d.kode_akun,d.nama as nama_akun,a.kode_lokasi,isnull(b.so_awal,0) as so_awal,isnull(c.debet,0) as debet,isnull(c.kredit,0) as kredit, 
