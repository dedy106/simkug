...
class server_report_saku2_frigia_rptDaftarFaktur extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		$kode_lokasi=$tmp[0];
		$periode=$tmp[1];
		$sql="select a.kode_cust,b.nama as nama_cust,b.npwp,a.no_faktur,date_format(a.tanggal,'%d/%m/%Y') as tanggal,a.no_invoice,a.keterangan,a.nilai_dpp,a.nilai_ppn
			from fp_invoice a 
			inner join cust b on a.kode_cust=b.kode_cust and a.kode_lokasi=b.kode_lokasi $this->filter ";
