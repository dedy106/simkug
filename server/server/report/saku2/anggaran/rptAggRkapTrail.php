...
class server_report_saku2_anggaran_rptAggRkapTrail extends server_report_basic
{	
...
from agg_neraca_tmp where modul='B' and nik_user='$nik_user' order by rowindex ";
  ...
  <tr bgcolor='#CCCCCC'>
	...
	<td width='90' class='header_laporan' align='center'>REALISASI SD AGUSTUS $tahun_rev</td>
	...
	<td height='20' class='$css' align='left'><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenDoc('$row->kode_neraca');\">$nama</a></td>
