...
class server_report_saku2_anggaran_rptAggTB12 extends server_report_basic
{
	function getTotalPage()
	{
		...
		$mutasi=$tmp[1];
		$periode=$tmp[2];
		$sql = "select count(kode_akun) as jum from agg_glma12_tmp ";
		if ($mutasi=="Tidak")
		{
	...
	function getHtml()
	{
		...
		$mutasi=$tmp[1];
		$periode=$tmp[2];
		$sql = "select kode_akun,nama,so_awal,n01,n02,n03,n04,n05,n06,n07,n08,n09,n10,n11,n12,total from agg_glma12_tmp ";
		if ($mutasi=="Tidak")
		{
		...
		echo $AddOnLib->judul_laporan("laporan neraca percobaan 12 Periode",$this->lokasi,$AddOnLib->ubah_periode($periode));
...
<td class='isi_laporan'><div align='right'>".number_format($row->total,0,',','.')."</td>
	...
	function getSumPage()
	{
		...
		$sql = "select count(a.kode_lokasi),sum(a.n01) as n1,sum(a.n02) as n2,sum(a.n03) as n3,sum(a.n04) as n4,
			...
			from (select kode_lokasi, kode_akun,nama,n01,n02,n03,n04,n05,n06,n07,n08,n09,n10,n11,n12 from agg_glma12_tmp ";
		if ($mutasi=="Tidak")
		{
