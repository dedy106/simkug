...
class server_report_saku2_anggaran_rptAggCfTw extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$tahun="2012";
		$sql = "select kode_neraca,kode_fs,kode_lokasi,nama,tipe,level_spasi,n4,n5,n6,n7,n8,case when n1<>0 then (n2-n1)/n1 else 0 end as growth 
from agg_neraca_tmp 
...
order by rowindex ";
  ...
  <tr bgcolor='#CCCCCC'>
	...
	<td width='100' class='header_laporan'><div align='center'>TRIWULAN I</div></td>
