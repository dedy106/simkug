...
class server_report_saku2_anggaran_rptAggJurnal extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.no_bukti as no_bukti,a.no_dokumen,date_format(a.tanggal,'%d/%m/%Y') as tanggal,a.kode_akun,b.nama,a.kode_pp,a.kode_drk,a.modul,a.keterangan, 
