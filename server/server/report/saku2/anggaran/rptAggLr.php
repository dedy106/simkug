...
class server_report_saku2_anggaran_rptAggLr extends server_report_basic
{
...
order by rowindex ";
  ...
  <tr bgcolor='#CCCCCC'>
    ...
    <td width='100' class='header_laporan'><div align='center'>Estimasi 2011</div></td>
	...
	{
		echo "<td class='isi_laporan'><div align='right'>";
		echo "<a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenTb('$row->kode_neraca','$row->kode_lokasi','$periode');\">".number_format($row->n4,0,",",".")."</a>";
		echo "</div></td>";
		echo "<td class='isi_laporan'><div align='right'>";
		echo "<a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenTb('$row->kode_neraca','$row->kode_lokasi','$periode2');\">".number_format($row->n8,0,",",".")."</a>";
		echo "</div></td>";
