...
class server_report_saku2_anggaran_rptAggBulanBidang extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$tahun=$tmp[0];
		$nama_form=$tmp[1];
		$sql=" select a.kode_akun,f.nama as nama_akun,zz.kode_lokasi,zz.nama as nama_lokasi,h.kode_bidang,h.nama as nama_bidang, 
...
from (select a.kode_lokasi,a.tahun,a.kode_akun,h.kode_bidang		
	 ...
	 group by a.kode_lokasi,a.kode_akun ,h.kode_bidang
		 )g on a.kode_lokasi=g.kode_lokasi and a.kode_akun=g.kode_akun and a.kode_bidang=g.kode_bidang
