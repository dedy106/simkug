...
class server_report_saku2_anggaran_rptBukuBesarTrail extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$kode_akun=$tmp[3];
		$sql="exec sp_agg_glma_akun_tmp '$kode_akun','$kode_akun','$kode_lokasi','$kode_lokasi','$kode_lokasi','$periode','$nik_user' ";
		$rs = $dbLib->execute($sql);
