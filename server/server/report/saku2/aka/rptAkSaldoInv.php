...
class server_report_saku2_aka_rptAkSaldoInv extends server_report_basic
{	
...
inner join (select y.nim,x.no_inv,
			...
			$this->filter and (isnull(b.bpp,0)+isnull(b.sdp2,0)+isnull(b.up3,0)<>0) ";
	...
	function getHtml()
	{
	   ...
	   isnull(b.bpp,0) as debet_bpp,isnull(b.sdp2,0) as debet_sdp2,isnull(b.up3,0) as debet_up3,
	   isnull(b.bpp,0)+isnull(b.sdp2,0)+isnull(b.up3,0) as debet_total,
	   isnull(c.bpp,0) as kredit_bpp,isnull(c.sdp2,0) as kredit_sdp2,isnull(c.up3,0) as kredit_up3,
	   isnull(c.bpp,0)+isnull(c.sdp2,0)+isnull(c.up3,0) as kredit_total,
	   (isnull(b.bpp,0)+isnull(b.sdp2,0)+isnull(b.up3,0))-(isnull(c.bpp,0)+isnull(c.sdp2,0)+isnull(c.up3,0)) as saldo
from aka_mahasiswa a 
inner join aka_jurusan d on a.kode_jur=d.kode_jur and a.kode_lokasi=d.kode_lokasi 
inner join (select x.nim,x.no_inv 
			from aka_bill_d x
 ...
 ";
  ...
  <tr bgcolor='#CCCCCC'>
	...
	<td width='90' align='center' class='header_laporan'>Saldo</td>
		...
		$sak_bpp=0;$sak_sdp2=0;$sak_up3=0;$sak_total=0;$saldo=0;
