...
class server_report_saku2_aka_rptAkKartuTrail2 extends server_report_basic
{	
	...
	function getHtml()
	{
	   ...
	   isnull(b.sks,0)-isnull(d.sks,0) as so_sks,
...
where a.kode_lokasi='$kode_lokasi' and a.nim='$nim'	 ";
  ...
  <tr>
    <td colspan='14' style='padding:3px'><table width='600'  border='0' cellspacing='2' cellpadding='1'>
      <tr>
  ...
  <tr align='center'>
    <td colspan='8' rowspan='2' align='right' class='header_laporan'>Saldo Awal&nbsp; </td>
    <td class='header_laporan'>BPP</td>
    <td class='header_laporan'>SDP2</td>
    <td class='header_laporan'>UP3</td>
	<td class='header_laporan'>SKS</td>
  ...
  <tr align='center' bgcolor='#CCCCCC'>
	...
	<td width='80' class='header_laporan'>SKS</td>
    ...
    <td width='90' class='header_laporan'>Total</td>
			...
			case a.kode_produk when 'SKS' then a.nilai else 0 end as debet_sks,
...
select a.no_rekon as no_bukti,date_format(b.tanggal,'%d/%m/%Y') as tanggal,'Rekon '+a.kode_produk as keterangan,
	   ...
	   case a.kode_produk when 'SKS' then a.nilai else 0 end as kredit_sks
from aka_rekon_d a
...
where a.nim='$row->nim' and a.periode='$periode'
 ";
			...
			{	
				$debet_total=$row1->debet_bpp + $row1->debet_sdp2 + $row1->debet_up3 + $row1->debet_sks;
				$kredit_total=$row1->kredit_bpp + $row1->kredit_sdp2 + $row1->kredit_up3 + $row1->kredit_sks;
			  ...
			  echo "<tr>
				...
				<td class='isi_laporan' align='right'>".number_format($row1->debet_sks,0,",",".")."</td>
				...
				<td class='isi_laporan' align='right'>".number_format($row1->kredit_sks,0,",",".")."</td>
