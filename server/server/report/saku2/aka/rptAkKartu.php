...
class server_report_saku2_aka_rptAkKartu extends server_report_basic
{	
...
inner join (select distinct nim,kode_lokasi from aka_bill_d) c on a.nim=c.nim and a.kode_lokasi=c.kode_lokasi $filter ";
