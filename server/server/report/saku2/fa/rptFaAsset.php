...
class server_report_saku2_fa_rptFaAsset extends server_report_basic
{
	...
	function getHtml()
	{
		...
		if ($tanda!="Range")
		{
		$sql = "select a.kode_klpakun,a.kode_lokasi,b.nama as nama_klpakun,a.kode_pp,c.nama as nama_pp,a.no_fa,a.nama,date_format(a.tgl_perolehan,'%d/%m/%Y') as tgl,a.catatan,
...
order by a.kode_akun,a.tgl_perolehan ";
		...
		echo "<table width='1800' border='1' cellspacing='0' cellpadding='0' class='kotak'>
				...
				<td width='250' rowspan='2' align='center' class='header_laporan'>Catatan</td>
