...
class server_report_saku2_fa_rptFaKartu extends server_report_basic
{
...
inner join masakun d on a.kode_akun=d.kode_akun and a.kode_lokasi=d.kode_lokasi $this->filter ";
	...
	function getHtml()
	{
		...
		$periode=$tmp[2];
		$kode_lokasi1=$tmp[1];
		$sql = "select a.kode_lokasi,a.no_fa,a.nama,a.nilai,a.kode_klpakun,b.nama as nama_klp,a.periode,a.kode_pp,c.nama as nama_pp,h.nama as lokasi_fa,a.no_seri,a.merk,a.tipe,
...
left join  fa_lokasi h on a.kode_lokfa=h.kode_lokfa and a.kode_lokasi=h.kode_lokasi $this->filter ";
      ...
      <tr>
        <td colspan='8' styile='padding:5px' ><table width='700' border='0' cellspacing='2' cellpadding='1'>
          ...
          <tr>
            <td class='header_laporan'>Nama Asset</td>
          ...
          <tr>
            ...
            <td class='header_laporan'>: $row->lokasi_fa</td>
          </tr>
          <tr>
            <td class='header_laporan'>No Seri </td>
            <td class='header_laporan'>: $row->no_seri</td>
          </tr>
          <tr>
...
from fasusut_d
where kode_lokasi='$row->kode_lokasi' and no_fa='$row->no_fa' ";
		$rs1 = $dbLib->execute($sql1);
		$saldo=$row->nilai; $j=0; $debet=0; $kredit=0;
