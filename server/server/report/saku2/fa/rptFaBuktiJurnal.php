...
class server_report_saku2_fa_rptFaBuktiJurnal extends server_report_basic
{
	function getTotalPage()
	{
		...
		$periode=$tmp[2];
		$filter2=$tmp[3];
		$sql="select count(a.no_fasusut) as jum
from fasusut_m a $this->filter ";
	...
	function getHtml()
	{
		...
		$sql="select a.no_fasusut,a.no_dokumen,a.kode_lokasi,a.periode,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tanggal1,a.keterangan,a.kode_lokasi,
...
left join karyawan c on a.nik_setuju=c.nik and a.kode_lokasi=c.kode_lokasi $this->filter ";
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			echo "<table border='0' cellspacing='2' cellpadding='1'>
			  <tr>
				<td align='center' class='header_laporan'>JURNAL ASSET</td>
			  </tr>
			  <tr>
				<td><table border='0' cellspacing='2' cellpadding='1'>
				  ...
				  <tr>
					...
					<td width='496' class='header_laporan'>:&nbsp;$row->no_fasusut</td>
					</tr>
				  <tr>
