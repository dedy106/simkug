...
class server_report_saku2_gaji_rptGajiDaftarPol extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select max(a.no_gaji) as no_pos 
from hr_gaji_pos a 
inner join hr_gaji_m b on a.no_gaji=b.no_pos and a.kode_lokasi=b.kode_lokasi
where a.kode_lokasi='$kode_lokasi' and b.modul='REG'";
		$rs = $dbLib->execute($sql);
  ...
  <tr>
    <td align='center'  class='style16'>DAFTAR PEMBAYARAN GAJI PEGAWAI YAYASAN PENDIDIKAN TELKOM DI LINGKUNGAN POLITEKNIK TELKOM</td>
  </tr>
  <tr>
  ...
  <tr>
    <td><table border='1' cellspacing='0' cellpadding='0' class='kotak' >
      <tr align='center' bgcolor='#CCCCCC'>
        ...
        <td colspan='7' class='header_laporan'>TUNJANGAN</td>
      ...
      <tr align='center' bgcolor='#CCCCCC'>
        ...
        <td width='80' class='header_laporan'>RAPEL</td>
        <td width='80' class='header_laporan'>TUNJ. DPLK</td>
		<td width='80' class='header_laporan'>TUNJ. JAMOSOSTEK</td>
		...
		$sql=" select a.nik,a.nama,b.nama as nama_sts,c.nama as nama_grade,a.kode_lokasi,
...
left join hr_gaji_pos f on f.no_gaji='$no_pos' and d.kode_lokasi=f.kode_lokasi and d.nik=f.nik
...
order by a.nik";
		...
		$i=1;
		$rs = $dbLib->execute($sql);
		$gdas=0; $tdas=0; $tpos=0; $rapl=0; $tdpl=0; $tpph=0; $pdpt=0; $pdpl=0; $pgaj=0; $ppph=0; $pot3=0; $zmiw=0; $potongan=0; $total=0; $pjms=0; $tjms=0;
      ...
      echo "<tr>
        ...
        echo "<td class='isi_laporan'>";
			...
			echo "</td>";
       echo "<td class='isi_laporan' >$row->nama_grade</td>
        ...
        <td class='isi_laporan' align='right'>".number_format($row->tdpl,0,',','.')."</td>
		<td class='isi_laporan' align='right'>".number_format($row->tjms,0,',','.')."</td>
       ...
       <td class='isi_laporan' align='right'>".number_format($row->potongan,0,',','.')."</td>
	    <td class='isi_laporan' align='right'>".number_format($row->pdpt-$row->potongan,0,',','.')."</td>
      </tr>";
