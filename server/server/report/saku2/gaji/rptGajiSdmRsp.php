...
class server_report_saku2_gaji_rptGajiSdmRsp extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		$kode_lokasi=$tmp[0];
		$periode=$tmp[1];
		$sql="select a.nik,a.nama,a.sts_pajak,b.nama as nama_loker,c.nama as nama_jab,a.kode_level,a.cabang,a.no_rek,a.nama_rek,date_format(a.tgl_masuk,'%d/%m/%Y') as tgl,a.sts_nikah 
from hr_karyawan a
  ...
  <tr align='center' bgcolor='#CCCCCC'>
    ...
    <td  class='header_laporan' width='200'>NAMA</td>
	 <td  class='header_laporan' width='50'>STATUS PAJAK</td>
	  <td  class='header_laporan' width='50'>STATUS NIKAH</td>
