...
class server_report_saku2_gaji_rptGajiSlipPol extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		$sql="select a.nik,a.nama,a.kode_lokasi,b.nama as nama_loker,c.nama as sts_sdm,d.nama as nama_grade,a.nik2,
			...
			datepart(month,f.tanggal) as bulan,datepart(year,f.tanggal) as tahun,f.pesan
from hr_karyawan a
...
left join hr_struk h on g.kode_struk=h.kode_struk and g.kode_lokasi=h.kode_lokasi $this->filter order by a.nama";
