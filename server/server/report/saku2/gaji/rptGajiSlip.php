...
class server_report_saku2_gaji_rptGajiSlip extends server_report_basic
{	
...
inner join hr_gaji_m c on b.no_gaji=c.no_gaji and b.kode_lokasi=c.kode_lokasi $this->filter order by a.nik";
  ...
  <tr>
    <td><table width='700'  border='0'>
      <tr>
        <td width='120' rowspan='4'><span class='header_laporan'><img src='$pathfoto' width='100' height='113' /></span></td>
