...
class server_report_saku2_gaji_rptGajiRekapYks extends server_report_basic
{
...
order by a.no_urut ";
		...
		echo "</tr>";
		//data gaji
		$sql="select a.nik,a.nama,a.kode_lokasi,$pdpt1
from hr_karyawan a
inner join (select a.nik,a.kode_lokasi,$pdpt2
			from hr_gaji_d a
			inner join hr_karyawan b on a.nik=b.nik and a.kode_lokasi=b.kode_lokasi
			where a.no_gaji='$no_gaji' and a.kode_lokasi='$kode_lokasi'
