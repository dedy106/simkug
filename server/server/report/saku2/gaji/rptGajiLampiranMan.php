...
class server_report_saku2_gaji_rptGajiLampiranMan extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.nik,a.nama,a.no_rek,a.nama_rek,a.bank,isnull(b.total,0) as total
from hr_karyawan a 
...
union
select a.kode_param as nik,a.nama,a.no_rek,a.nama_rek,a.bank,isnull(b.total,0) as total
  ...
  <tr>
    <td><table width='600' border='1' cellspacing='0' cellpadding='0' class='kotak'>
      <tr align='center'>
        ...
        <td width='300' class='header_laporan'>NAMA PEGAWAI </td>
