...
class server_report_saku2_gl_rptBuktiJurnal extends server_report_basic
{
...
left join karyawan c on a.nik_setuju=c.nik and a.kode_lokasi=c.kode_lokasi ".$this->filter2;
	...
	function getHtml()
	{
		...
		global $dbLib;
		$sql="select distinct a.no_ju,e.no_ref,a.no_dokumen,a.kode_lokasi,a.periode,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tanggal1,a.keterangan,a.kode_lokasi,
       a.nik_buat,b.nama as nama_buat,b.jabatan as jabatan_buat,a.nik_setuju,c.nama as nama_setuju,c.jabatan as jabatan_setuju, d.kota 
			from ju_m a
			inner join ju_j e on a.no_ju=e.no_ju
			...
			echo "<table border='0' cellspacing='1' cellpadding='2' class='kotak'>
			  ...
			  <tr>
				...
				<tr>
					...
					<td class='header_laporan'>:&nbsp;$row->keterangan / $row->no_ref</td>
				  </tr>
				</table></td>
			  </tr>
			  <tr>
