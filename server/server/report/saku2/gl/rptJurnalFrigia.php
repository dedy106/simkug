...
class server_report_saku2_gl_rptJurnalFrigia extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$urut=$tmp[1];
		$periode=$tmp[2];
		$sql="select a.no_ju as no_bukti,a.no_dokumen,c.nama,date_format(b.tanggal,'%d/%m/%Y') as tanggal,b.kode_akun,b.kode_pp,b.kode_vendor,b.kode_cust,b.nik,a.posted,b.keterangan,case when b.dc='D' then b.nilai else 0 end as debet,case when b.dc='C' then b.nilai else 0 end as kredit ". 
		         "from ju_m a ".
				 "inner join ju_j b on a.no_ju=b.no_ju and a.kode_lokasi=b.kode_lokasi ".
			     "inner join masakun c on b.kode_akun=c.kode_akun and b.kode_lokasi=c.kode_lokasi ".$filter.
				 "order by $urut ";
  ...
  <tr bgcolor='#CCCCCC'>
	...
	<td width='40' class='header_laporan'><div align='center'>Vendor</div></td>
	<td width='40' class='header_laporan'><div align='center'>Cust</div></td>
	<td width='40' class='header_laporan'><div align='center'>Nik</div></td>
  <td width='30' class='header_laporan'><div align='center'>Posted</div></td>
	...
	<td valign='middle' class='isi_laporan'>$row->nik</td>
	...
	{						
		...
		$AddOnLib=new server_util_AddOnLib();						
		$sql="select a.no_ju as no_bukti,a.no_dokumen,c.nama,date_format(b.tanggal,'%d/%m/%Y') as tanggal,b.kode_akun,b.kode_pp,b.kode_vendor,b.kode_cust,b.nik,a.posted,b.keterangan,case when b.dc='D' then b.nilai else 0 end as debet,case when b.dc='C' then b.nilai else 0 end as kredit, a.kode_lokasi ". 
		         "from ju_m a ".
				 "inner join ju_j b on a.no_ju=b.no_ju and a.kode_lokasi=b.kode_lokasi ".
			     "inner join masakun c on b.kode_akun=c.kode_akun and b.kode_lokasi=c.kode_lokasi ".$filter.
				 "order by $urut ";
