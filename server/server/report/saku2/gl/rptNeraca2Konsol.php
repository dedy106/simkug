...
class server_report_saku2_gl_rptNeraca2Konsol extends server_report_basic
{
...
<td class='detail_laporan'><div align='right'>$so_akhir</div></td>
		...
		$sql = "select kode_neraca,kode_fs,kode_lokasi,nama,tipe,n1*-1 as n1,n2*-1 as n2,-(n1-n2) as selisih,level_spasi from neraca_tmp where modul='P' and nik_user='$nik_user' and level_lap<=$level_lap order by rowindex  ";
