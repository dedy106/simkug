...
class server_report_saku2_gl_rptLRAggSim extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="exec sp_neraca_agg_sim '$kode_fs','L','S','$level_lap','$periode','$kode_lokasi','$kode_lokasi','$kode_lokasi','$nik_user' ";
		$rs = $dbLib->execute($sql);	
