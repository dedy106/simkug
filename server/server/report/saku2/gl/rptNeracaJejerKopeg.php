...
class server_report_saku2_gl_rptNeracaJejerKopeg extends server_report_basic
{
    ...
    <tr bgcolor='#CCCCCC'>
      <td width='300' height='25'  class='header_laporan'>Deskripsi</td>
		<td width='90' class='header_laporan' align='center'>KOPEGTEL KANTOR PERUSAHAAN</td>
      <td width='90' class='header_laporan' align='center'>KOPEGTEL SIMPAN PINJAM</td>
...
<td class='isi_laporan' align='right'>";
			...
			{
				echo "<a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenTb('$row->kode_neraca','21','$periode');\">$n1</a>";
			}
			else
			{
				echo "$n1";
			...
			{
				echo "<a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenTb('$row->kode_neraca','22','$periode');\">$n2</a>";
			}
			else
			{
				echo "$n2";
