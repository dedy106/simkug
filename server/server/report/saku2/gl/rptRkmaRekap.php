...
class server_report_saku2_gl_rptRkmaRekap extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql=" exec sp_agg_pakai_bidang '$lokasi','Beban','$periode','$nik_user' ";
		$rs = $dbLib->execute($sql);
		$sql = "select a.kode_pp, a.nama,isnull(c.n1,0) as n1,isnull(c.n2,0) as n2,isnull(c.n5,0) as n5
from pp a
...
where a.tipe='Posting' and a.kode_lokasi='$lokasi' order by a.kode_pp ";
  ...
  <tr>
    <td><table border='1' cellspacing='0' cellpadding='0' class='kotak'>
		  <tr bgcolor='#CCCCCC'>
		    ...
		    <td height='25' colspan='6' align='center' class='header_laporan'>REKAP REALISASI RKA PER-PP SD $bln TAHUN $tahun</td>
  </tr>
		  <tr bgcolor='#CCCCCC'>
