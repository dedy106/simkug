...
class server_report_saku2_gl_rptRkmaSumber extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="exec sp_sumberdana 'FP4','$nik_user','$nik_user2','$lokasi'";
		$rs = $dbLib->execute($sql);
...
from neraca_tmp where nik_user='$nik_user2' order by rowindex ";		
  ...
  <tr>
    <td align='center' class='lokasi_laporan2'>PENGGUNAAN SUMBER DANA </td>
  </tr>
  <tr>
