...
class server_report_saku2_gl_rptJurnalModul extends server_report_basic
{
...
from  (select a.no_bukti,a.kode_lokasi,a.periode,a.no_dokumen,a.tanggal,a.kode_akun,a.kode_pp,a.kode_drk,b.kode_neraca,a.modul,a.keterangan,a.dc,a.nilai 
		from gldt a 
		inner join relakun b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi $filter $modul
		union 
		select a.no_bukti,a.kode_lokasi,a.periode,a.no_dokumen,a.tanggal,a.kode_akun,a.kode_pp,a.kode_drk,b.kode_neraca,a.modul,a.keterangan,a.dc,a.nilai 
		from gldt_h a 
		inner join relakun b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi $filter $modul
      ) a  
inner join masakun b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi $filter2 ";
	...
	function getHtml()
	{
		...
		$periode=$tmp[2];
		$filter2=$tmp[3];
		$sql="select a.no_bukti,a.no_dokumen,date_format(a.tanggal,'%d/%m/%Y') as tanggal,a.kode_akun,b.nama,a.kode_pp,a.kode_drk,a.kode_neraca,a.modul,a.keterangan, 
...
order by a.periode,a.no_bukti,a.dc desc  ";
		...
		echo $AddOnLib->judul_laporan("LAPORAN TRANSAKSI JURNAL MODUL",$this->lokasi,"Periode ".$AddOnLib->ubah_periode($periode));
  ...
  <td width='40' class='header_laporan'><div align='center'>Kode Neraca</div></td>
  <td width='30' class='header_laporan'><div align='center'>Modul</div></td>
	...
	<td valign='middle' class='isi_laporan'>$row->kode_drk</td>
	  <td valign='middle' class='isi_laporan' align='center'>$row->kode_neraca</td>
	...
	{						
		...
		$title = array($this->lokasi,"LAPORAN TRANSAKSI JURNAL MODUL",strtoupper($AddOnLib->ubah_periode($periode)));
