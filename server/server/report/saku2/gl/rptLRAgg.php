...
class server_report_saku2_gl_rptLRAgg extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="exec sp_neraca_agg '$kode_fs','L','S','$level_lap','$periode','$kode_lokasi','$kode_lokasi','$kode_lokasi','$nik_user' ";
		$rs = $dbLib->execute($sql);	
