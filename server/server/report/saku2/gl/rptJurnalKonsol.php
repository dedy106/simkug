...
class server_report_saku2_gl_rptJurnalKonsol extends server_report_basic
{
...
from (select a.kode_lokasi,a.no_urut,a.no_bukti,a.no_dokumen,a.tanggal,a.kode_akun,a.kode_pp,a.kode_drk,a.keterangan,a.dc,a.nilai
	  from gldt a
	  inner join konsol_relasi b on a.kode_lokasi=b.kode_lokasi and a.kode_akun=b.kode_akun
	  where (a.kode_lokasi between '01' and '06') and a.periode='201105' 	
	  union all
	  select a.kode_lokasi,a.no_urut,a.no_bukti,a.no_dokumen,a.tanggal,a.kode_akun,a.kode_pp,a.kode_drk,a.keterangan,a.dc,a.nilai
	  from gldt_h a
	  inner join konsol_relasi b on a.kode_lokasi=b.kode_lokasi and a.kode_akun=b.kode_akun
	  where (a.kode_lokasi between '01' and '06') and a.periode='201105'
	 )a 	 	
inner join masakun b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi ";
	...
	function getHtml()
	{
		...
		$urut=$tmp[1];
		$periode=$tmp[2];
		$sql="select a.no_bukti,a.kode_lokasi,a.no_dokumen,b.nama as nama_akun,date_format(a.tanggal,'%d/%m/%Y') as tanggal,a.kode_akun,a.kode_pp,a.kode_drk,a.keterangan,
...
order by a.no_bukti,a.no_urut ";
		...
		echo $AddOnLib->judul_laporan("LAPORAN TRANSAKSI JURNAL UMUM",$this->lokasi,"Periode ".$AddOnLib->ubah_periode($periode));
		echo "<table border='1' cellspacing='0' cellpadding='2' class='kotak'>
  <tr bgcolor='#CCCCCC'>
    <td width='20' align='center' class='header_laporan'>No</td>
	<td width='20' align='center' class='header_laporan'>Lok</td>
	<td width='70' align='center' class='header_laporan'>No Bukti</td>
	<td width='70' align='center'class='header_laporan'>No Dokumen</td>
    <td width='50' align='center' class='header_laporan'>Tanggal</td>
    <td width='50' align='center' height='25' class='header_laporan'>Akun</td>
    <td width='150' align='center' class='header_laporan'>Nama Akun </td>
    <td width='30' align='center' class='header_laporan'>PP</td>
	<td width='40' align='center' class='header_laporan'>DRK</td>
    ...
    <td class='header_laporan' class='header_laporan' align='right'>$nkredit</td>
			...
			echo "<tr>
    <td valign='middle' class='isi_laporan'>$i</td>
	 <td valign='middle' class='isi_laporan' align='center'>$row->kode_lokasi</td>
	...
	{						
		...
		$AddOnLib=new server_util_AddOnLib();						
		$sql="select a.no_ju as no_bukti,a.no_dokumen,c.nama,date_format(b.tanggal,'%d/%m/%Y') as tanggal,b.kode_akun,b.kode_pp,b.kode_drk,a.posted,b.keterangan,case when b.dc='D' then b.nilai else 0 end as debet,case when b.dc='C' then b.nilai else 0 end as kredit, a.kode_lokasi ". 
		         "from ju_m a ".
