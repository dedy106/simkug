...
class server_report_saku2_gl_rptRkmaGabung extends server_report_basic
{
...
where a.tipe='Posting' ";
		$rs2 = $dbLib->execute($sql);
		while ($row2 = $rs2->FetchNextObject($toupper=false))
		{
			$sql="exec sp_neraca_produk_pp 'FP1','L','S',1,'$periode','$lokasi','$lokasi','$lokasi','$nik_user','$row2->kode_pp','$row2->kode_pp'";
	  ...
	  <tr>
		<td align='center' class='lokasi_laporan'>".strtoupper($row2->nama)."</td>
	  </tr>
	</table></td></tr>
	  <tr>
