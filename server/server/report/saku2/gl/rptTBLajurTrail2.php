...
class server_report_saku2_gl_rptTBLajurTrail2 extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql = "select a.kode_akun,a.nama,a.kode_lokasi,a.debet,a.kredit,a.so_awal,a.so_akhir, 
...
where a.nik_user='$nik_user' and (a.so_awal<>0 or a.debet<>0 or a.kredit<>0 or a.so_akhir<>0) and  b.kode_fs='$kode_fs' and a.kode_lokasi='$kode_lokasi' and 
      b.kode_neraca in ($tmp_neraca);";
