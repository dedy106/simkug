...
class server_report_saku2_yks_rptPiutangKirim extends server_report_basic
{
...
order by a.no_valid ";
		...
		echo $AddOnLib->judul_laporan("LAPORAN TAK KIRIM PIUTANG",$this->lokasi,"Periode ".$AddOnLib->ubah_periode($periode));
      ...
      <tr>
        <td width='111' class='header_laporan'>No TAK Kirim</td>
      ...
      <tr align='center' bgcolor='#CCCCCC'>
        ...
        <td width='80' class='header_laporan'>No TAK Terima</td>
        <td width='60' class='header_laporan'>Tgl Terima </td>
      </tr>";
	  $sql1="
select a.kode_loktuj,a.akun_tak,b.nama as nama_akun,a.keterangan,a.nilai,a.no_terima,date_format(c.tanggal,'%d/%m/%Y') as tgl_terima,
...
left join yk_valid_m c on a.no_terima=c.no_valid and a.kode_loktuj=c.kode_lokasi
where a.no_valid='$row->no_valid' 
order by a.kode_loktuj";
      ...
      echo "<tr>
        ...
        <td class='isi_laporan'>$row1->no_terima</td>
