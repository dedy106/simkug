...
class server_report_saku2_yks_rptHutangTagihanIcdx extends server_report_basic
{
  ...
  <tr>
   ...
   <tr>
    <td><table border='1' cellspacing='0' cellpadding='0' class='kotak'>
      <tr bgcolor='#CCCCCC'>
    <td width='25' rowspan='2' align='center' class='header_laporan'>No</td>
    <td width='70' rowspan='2' align='center' class='header_laporan'>Bank Transfer </td>
	<td width='60' rowspan='2' align='center' class='header_laporan'>Kode Mitra</td>
    <td width='250' rowspan='2' align='center' class='header_laporan'>Nama Mitra</td>
     <td width='50' rowspan='2' align='center' class='header_laporan'>ICDX</td>
	<td width='250' rowspan='2' align='center' class='header_laporan'>Nama ICDX</td>
  ...
  ";
		$sql1 = "select b.bank_trans,a.kode_vendor,b.nama as nama_vendor,a.icdx,isnull(c.nama,'-') as nama_icdx,
sum(case when d.jenis = 'PENSIUN'  then a.nilai-a.pph else 0 end) as cc,
sum(case when d.jenis <> 'PENSIUN' then a.nilai-a.pph else 0 end) as bp
from yk_bill_d a 
inner join vendor b on a.kode_vendor=b.kode_vendor and a.kode_lokasi=b.kode_lokasi 
inner join cust d on a.loker=d.kode_cust
left join yk_icdx c on c.kode_icdx=substring(a.icdx,1,3) 
where a.no_app = '$row->no_app'
group by b.bank_trans,a.kode_vendor,b.nama,a.icdx,isnull(c.nama,'-') order by b.bank_trans,a.kode_vendor";
		...
		{	
			$debet_bp=$debet_bp+$row1->bp;
			$debet_cc=$debet_cc+$row1->cc;
			$debet_total=$debet_total+$row1->bp + $row1->cc;
  echo "<tr>
	...
	<td class='isi_laporan'>$row1->nama_icdx</td>
    <td width='80' align='right' class='isi_laporan'>".number_format($row1->bp,0,',','.')."</td>
    <td width='80' align='right' class='isi_laporan'>".number_format($row1->cc,0,',','.')."</td>
   <td width='80' align='right' class='isi_laporan'>".number_format($row1->bp+$row1->cc,0,',','.')."</td>
