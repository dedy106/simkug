...
class server_report_saku2_yks_rptTakPiutangJurnal extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$filter2=$tmp[3];
		$filter3=$tmp[4];
		$sql="select a.no_valid as no_bukti,a.no_dokumen,a.kode_lokasi,a.periode,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tanggal1,a.keterangan,a.kode_lokasi,
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
		 ...
		 $sql1="select a.kode_akun,b.nama as nama_akun,a.kode_pp,a.kode_drk, a.modul,a.keterangan,case when a.dc='D' then a.nilai else 0 end as debet,case when a.dc='C' then a.nilai else 0 end as kredit 
				...
				where a.no_valid='$row->no_bukti' order by a.kode_akun";
		//error_log($sql1);
