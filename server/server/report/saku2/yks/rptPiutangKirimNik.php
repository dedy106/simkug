...
class server_report_saku2_yks_rptPiutangKirimNik extends server_report_basic
{
...
inner join karyawan f on e.flag=f.nik and e.kode_lokasi=f.kode_lokasi $this->filter ";	
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			echo "<table width='100%' border='0' cellpadding='1' cellspacing='2'>
							  ...
							  <tr>
								<td align='center' class='header_laporan'>DAFTAR PERMINTAAN TAK KIRIM PIUTANG KEPADA MITRA KERJA</td>
							  </tr>
							  <tr>
							  ...
							  <tr>
							    <td align='center' class='header_laporan'><table border='1' cellspacing='0' cellpadding='0' class='kotak'>
                                  <tr bgcolor='#CCCCCC'>
                                    ...
                                    <td width='80' rowspan='2' align='center' class='header_laporan'>Lok Tujuan</td>
			...
			$sql1 = "select a.no_valid,a.kode_lokasi,a.nik,a.nama,a.nikkes,a.pasien,a.jenis,a.icdx,date_format(a.tgl_masuk,'%d-%m-%Y') as tgl_masuk,date_format(a.tgl_keluar,'%d-%m-%Y') as tgl_keluar,a.kode_produk,a.nama_produk,
                   a.kode_cust,a.nama_cust,a.pegawai,a.pensiun,a.nilai_kunj,a.nilai_cs,a.pegawai+a.pensiun+a.nilai_kunj-a.nilai_cs as total,a.vendor
			from (select a.no_tak as no_valid,a.kode_lokasi,a.nik,a.nama,a.nikkes,a.pasien,b.jenis,a.icdx,a.tgl_masuk,a.tgl_keluar,a.kode_produk,c.nama as nama_produk,
                   b.kode_cust,b.nama as nama_cust,d.nama as vendor,
...
left join vendor d on a.kode_vendor=d.kode_vendor and a.kode_lokkirim=d.kode_lokasi
where a.no_tak='$row->no_valid' and a.kode_lokkirim='$row->kode_lokasi' 
union all
select a.no_tak as no_valid,a.kode_lokasi,a.nik,a.nama,a.nikkes,a.pasien,b.jenis,'-' as icdx,a.tgl_masuk,a.tgl_masuk as tgl_keluar,a.kode_produk,c.nama as nama_produk,
                   b.kode_cust,b.nama as nama_cust,'-' as vendor,0 as pegawai,0 as pensiun,a.umum+a.gigi+a.kbia+a.matkes as nilai_kunj,a.cs as nilai_cs
...
where a.no_tak='$row->no_valid' and a.kode_lokkirim='$row->kode_lokasi' 
	  ...
	  ";
			...
			{				
				$beda = $tmp!=$row1->kode_lokasi; 
				
				if ($tmp!=$row1->kode_lokasi)
				{
					$tmp=$row1->kode_lokasi;
					$first = true;
					if ($i>1)
					{
				...
				if ($nama_cust!=$row1->kode_lokasi)
				{
					$nama_cust=$row1->kode_lokasi;
				};
				...
				echo "<tr>
					...
					<td align='center' class='isi_laporan'>$row1->kode_lokasi</td>
