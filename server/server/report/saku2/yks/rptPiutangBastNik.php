...
class server_report_saku2_yks_rptPiutangBastNik extends server_report_basic
{
...
inner join karyawan f on e.flag=f.nik and e.kode_lokasi=f.kode_lokasi $this->filter and a.modul='BAST'";	
		echo $sql;
...
inner join karyawan f on e.flag=f.nik and e.kode_lokasi=f.kode_lokasi $this->filter and a.modul='BAST'";	
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			...
			$sql1 = "select  a.no_piutang,a.kode_lokasi,a.nik,a.nama,a.nikkes+'-'+a.pasien as pasien,a.jenis,a.icdx,date_format(a.tgl_masuk,'%d-%m-%Y') as tgl_masuk,date_format(a.tgl_keluar,'%d-%m-%Y') as tgl_keluar,a.kode_produk,a.nama_produk,
                   a.kode_cust,a.nama_cust,a.nilai_bp,a.nilai_kunj,a.nilai_cs,a.nilai_bp+a.nilai_kunj-a.nilai_cs as total,a.vendor
			from (select a.no_piutang,a.kode_lokasi,a.nik,a.nama,a.nikkes,a.pasien,b.jenis,a.icdx,a.tgl_masuk,a.tgl_keluar,a.kode_produk,c.nama as nama_produk,
	   ...
	   where a.no_piutang='$row->no_valid' and a.kode_lokasi='$row->kode_lokasi'  $jenis --and a.flag_aktif='1'
           union all
	   select a.no_piutang,a.kode_lokasi,a.nik,a.nama,a.nikkes,a.pasien,b.jenis,'-' as icdx,a.tgl_masuk,a.tgl_masuk as tgl_keluar,a.kode_produk,c.nama as nama_produk,
	   ...
	   where a.no_piutang='$row->no_valid' and a.kode_lokasi='$row->kode_lokasi' $jenis ) a $filter3 --and a.flag_aktif='1'
