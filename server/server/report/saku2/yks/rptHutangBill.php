...
class server_report_saku2_yks_rptHutangBill extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql2="exec sp_yk_bill '$no_bill','$kode_lokasi','$nik_user' ";
		$rs2 = $dbLib->execute($sql2);
		
		$sql = "select a.no_bill,date_format(a.tanggal,'%d-%m-%Y') as tanggal,a.periode,a.keterangan,a.jenis,a.no_load,b.keterangan as ket_load
from yk_bill_m a
inner join yk_peserta_m b on a.no_load=b.no_load 
where a.kode_lokasi='$kode_lokasi' and a.no_bill='$no_bill'";	
		...
		echo $AddOnLib->judul_laporan("BILlING",$this->lokasi,"Periode ".$AddOnLib->ubah_periode($periode));
      ...
      <tr>
        <td class='header_laporan'><table border='0' cellspacing='2' cellpadding='1'>
          <tr>
            <td width='100' class='header_laporan'>No Bill </td>
            <td width='900' class='header_laporan'>: $row->no_bill</td>
          </tr>
          <tr>
          ...
          <tr>
            <td class='header_laporan'>Jenis Load </td>
      ...
      <tr>
        ...
        ";
			...
			$sql1 = "select  kode_vendor,no_ref,nik,nama,loker,date_format(tgl_masuk,'%d-%m-%Y') as tgl_masuk,date_format(tgl_keluar,'%d-%m-%Y') as tgl_keluar,icdx,band,nikkes,pasien,dokter,substring(kode_produk,1,2) as kode_produk,
       n1,n2,n3,n4,n5,n6,n7,n8,n9,n10,n11,n12,n13,n14,n15,n16,n17,n18,n19,n20,n21,no_hutang
from yk_bill_lap
where no_bill='$no_bill' and kode_lokasi='$kode_lokasi' and nik_user='$nik_user'
order by no_urut";
