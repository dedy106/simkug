...
class server_report_saku2_yks_rptBillBast2 extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql = "select a.no_hutang as no_valid,date_format(a.tanggal,'%d-%m-%Y') as tanggal,a.periode,a.keterangan,'-' as no_load,'-' as ket_load
from yk_hutang_m a
