...
class server_report_saku2_yks_rptPiutangJurnal extends server_report_basic
{
...
order by a.periode,a.no_valid,a.dc desc  ";
	...
	function getHtml()
	{
		...
		$periode=$tmp[2];
		$filter2=$tmp[3];
		$sql="select a.no_valid as no_bukti,a.no_dokumen,date_format(a.tanggal,'%d/%m/%Y') as tanggal,a.kode_akun,b.nama,a.kode_pp,a.kode_drk,a.keterangan, 
