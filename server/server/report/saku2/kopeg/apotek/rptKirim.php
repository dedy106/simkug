...
class server_report_saku2_kopeg_apotek_rptKirim extends server_report_basic
{	
	function getTotalPage()
	{
		global $dbLib;
		$sql="select count(a.no_kirim)
from apo_brg_kirim_m a  $this->filter ";
		error_log($sql);
