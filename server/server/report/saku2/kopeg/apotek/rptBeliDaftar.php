...
class server_report_saku2_kopeg_apotek_rptBeliDaftar extends server_report_basic
{
	...
	function getHtml()
	{
		...
		a.kode_gudang,c.nama as nama_gudang,a.nilai as total,a.nilai_ppn,a.nilai_diskon,a.nilai-a.nilai_ppn+a.nilai_diskon as nilai
...
$this->filter order by a.no_beli";
		...
		echo $AddOnLib->judul_laporan("pembelian non tunai",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
   ...
   <tr bgcolor='#CCCCCC'>
     ...
     <td width='90'  align='center' class='header_laporan'>Total</td>
		...
		$nilai=0;$nilai_ppn=0;$total=0;$nilai_diskon=0;
     ...
     <td class='isi_laporan' align='right'>".number_format($row->total,0,",",".")."</td>
	  ...
	  <td class='header_laporan' align='right'>".number_format($nilai_diskon,0,",",".")."</td>
