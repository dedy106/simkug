...
class server_report_saku2_kopeg_kbitt_rptPanjarRevisi extends server_report_basic
{
...
left join ( 
		...
		echo $AddOnLib->judul_laporan("revisi panjar",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
