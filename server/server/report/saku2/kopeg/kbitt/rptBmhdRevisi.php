...
class server_report_saku2_kopeg_kbitt_rptBmhdRevisi extends server_report_basic
{
	...
	function getHtml()
	{
		...
		echo $AddOnLib->judul_laporan("revisi bmhd",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
   ...
   <tr bgcolor='#CCCCCC'>
	 ...
	 <td width='130'  align='center' class='header_laporan'>Nama Akun</td>
   ...
   <td width='200'  align='center' class='header_laporan'>Keterangan</td>
	 <td width='70'  align='center' class='header_laporan'>Nilai Bruto</td>
	  <td width='70'  align='center' class='header_laporan'>Nilai Pajak</td>
	   <td width='70'  align='center' class='header_laporan'>Nilai Netto</td>
