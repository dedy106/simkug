...
class server_report_saku2_kopeg_kbitt_rptHonorRevisi extends server_report_basic
{
	...
	function getHtml()
	{
		...
		echo $AddOnLib->judul_laporan("revisi honor",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
