...
class server_report_saku2_kopeg_kbitt_rptHonorTransferPj extends server_report_basic
{
...
order by a.no_spb ";
	   ...
	   <tr bgcolor='#CCCCCC'>
		 ...
		 <td width='100'  align='center' class='header_laporan'>TGL</td>
			...
			$sql="select a.no_spb,a.no_aju,a.kode_lokasi,case when substring(b.no_rek,1,1)='0' then ''''+b.no_rek else ''''+b.no_rek end as no_rek,b.nilai,b.nama_rek,a.keterangan,b.bank,a.no_kas,isnull(convert(varchar,c.tanggal,103),'-') as tgl_kas
from it_aju_m a
...
union all
select a.no_spb,'-' as no_aju,a.kode_lokasi,case when substring(b.no_rek,1,1)='0' then ''''+b.no_rek else ''''+b.no_rek end as no_rek,sum(b.nilai) as nilai,b.nama_rek,'Honor Dosen LB' as keterangan,b.bank,a.no_kas,isnull(convert(varchar,d.tanggal,103),'-') as tgl_kas
from it_aju_m a
inner join it_aju_rek b on a.no_aju=b.no_aju and a.kode_lokasi=b.kode_lokasi
