...
class server_report_saku2_kopeg_kbitt_rptIfKartu2 extends server_report_basic
{
...
union all
select a.no_aju as no_bukti,a.tanggal,a.kode_lokasi,a.keterangan,0 as debet,a.nilai as kredit,date_format(a.tanggal,'%d/%m/%Y') as tgl,2 as nu
from it_aju_m a
where a.nik_user='$row->nik' and a.kode_lokasi='$row->kode_lokasi' and a.form='HUTIFNON'  and a.nilai<>0 and substring(a.periode,1,4)='$tahun'
union all
select a.no_aju as no_bukti,b.tanggal,a.kode_lokasi,a.keterangan,a.nilai as debet,0 as kredit,date_format(b.tanggal,'%d/%m/%Y') as tgl,3 as nu
from it_aju_m a
inner join kas_m b on a.no_kas=b.no_kas and a.kode_lokasi=b.kode_lokasi
where a.nik_user='$row->nik' and a.kode_lokasi='$row->kode_lokasi' and a.form='HUTIFNON'  and a.no_kas<>'-' and a.status_if in ('REIMBURSE','close') and substring(a.periode,1,4)='$tahun'
union all
select a.no_aju as no_bukti,a.tanggal,a.kode_lokasi,a.keterangan,0 as debet,a.nilai as kredit,date_format(a.tanggal,'%d/%m/%Y') as tgl,4 as nu
from it_aju_m a
inner join kas_m b on a.no_kas=b.no_kas and a.kode_lokasi=b.kode_lokasi
where a.nik_user='$row->nik' and a.kode_lokasi='$row->kode_lokasi' and a.form='HUTIFNON'  and a.no_kas<>'-' and a.status_if='CLOSE' and substring(a.periode,1,4)='$tahun'
order by tanggal
 ";
