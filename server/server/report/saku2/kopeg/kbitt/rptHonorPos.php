...
class server_report_saku2_kopeg_kbitt_rptHonorPos extends server_report_basic
{
	...
	function getHtml()
	{
	   ...
	   a.no_spb,date_format(l.tgl_input,'%d/%m/%Y') as tgl_spb,isnull(c.posted,'-') as posted
from it_aju_m a
...
$this->filter order by a.no_aju";
		...
		echo $AddOnLib->judul_laporan("posisi pertanggungan honor",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
