...
class server_report_saku2_kopeg_kbitt_rptPtgPosTu2 extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$nama_file="ptg_".$periode.".xls";

		$sql="select a.kode_lokasi,a.no_aju,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.kode_pp,b.nama as nama_pp,a.nilai,no_ptg,k.jenis,
	   ...
	   a.no_app,date_format(k.tgl_input,'%d/%m/%Y') as tgl_app1,date_format(k.tgl_aju,'%d/%m/%Y') as tgl_app,
			  a.nik_panjar,h.nama as nama_panjar,c.kode_bank,a.kode_akun,j.nama as nama_akun,a.progress,c.jenis,a.kode_drk,l.nama as nama_drk,
...
left join drk l on a.kode_drk=l.kode_drk and a.kode_lokasi=l.kode_lokasi and l.tahun='$tahun'
