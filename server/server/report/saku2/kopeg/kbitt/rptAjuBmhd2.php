...
class server_report_saku2_kopeg_kbitt_rptAjuBmhd2 extends server_report_basic
{
    ...
    $kode_lokasi = $tmp[1];
		$sql="select a.no_aju,j.no_bmhd,a.kode_lokasi,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.kode_pp,b.nama as nama_pp,a.nilai,a.nik_user,a.tanggal,a.kode_akun,c.nama as nama_akun,
...
left join bmhd_bayar j on a.no_aju=j.no_aju and j.kode_lokasi=a.kode_lokasi
...
$root_app="http://".$_SERVER['SERVER_NAME']."/web/server/pbh/";
  ...
  <tr>
    <td height='30' align='center' valign='middle' class='judul_bukti'>FORMULIR PENYELESAIAN BMHD</td>
  </tr>
  ...
  <tr>
    <td><table width='100%'  border='0'>
	  ...
	  <tr>
        <td width='200'>No BMHD</td>
        <td width='600'>: $row->no_bmhd </td>
      </tr>
      <tr>
        <td width='200'>PP</td>
