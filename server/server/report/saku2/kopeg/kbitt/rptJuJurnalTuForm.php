...
class server_report_saku2_kopeg_kbitt_rptJuJurnalTuForm extends server_report_basic
{
	...
	function getHtml()
	{
       ...
       a.nik_buat,b.nama as nama_buat,b.jabatan as jabatan_buat,a.nik_setuju,c.nama as nama_setuju,c.jabatan as jabatan_setuju,d.kota,a.nilai,d.logo,d.alamat
from ju_m a
...
left join karyawan c on a.nik_setuju=c.nik and a.kode_lokasi=c.kode_lokasi $this->filter";
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			$logo="image/".$row->logo;
			$alamat=$row->alamat;
			if (substr($row->no_ju,4,1)=="K")
			{
				$judul="BUKTI PENGELUARAN KAS / BANK";
				$format="KK / BK";
			}
			if (substr($row->no_ju,4,1)=="M")
			{
  ...
  <tr>
    <td><table width='800' border='0' cellspacing='2' cellpadding='1'>
	   <tr>
        ...
        <td width='612' class='istyle15'>: $row->no_ju</td>
      </tr>
      <tr>
  ...
  <tr>
    <td><table border='0' cellspacing='2' cellpadding='1'>
      <tr>
        ...
        <td width='496' class='istyle15'>:&nbsp;$row->no_ju</td>
      </tr>
      <tr>
  ...
  <tr>
    <td><table border='1' cellspacing='0' cellpadding='0' class='kotak'>
	  ...
	  $sql1="select a.kode_akun,a.no_dokumen,b.nama,a.keterangan,a.kode_pp,a.kode_drk,
