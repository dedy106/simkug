...
class server_report_saku2_kopeg_kbitt_rptNikIf extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode=$tmp[0];
		$nama_cab=$tmp[1];
		$sql="select a.nik,b.nama,a.kode_pp,c.nama as nama_pp,a.nilai 
from it_if a
...
$this->filter order by a.nik";
   ...
   <tr bgcolor='#CCCCCC'>
	 ...
	 <td class='isi_laporan' align='right'>".number_format($row->nilai,0,",",".")."</td>
		...
		echo "<tr >
     <td class='isi_laporan' align='right' colspan='5'>Total</td>
