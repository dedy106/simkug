...
class server_report_saku2_kopeg_kbitt_rptBebanPosTu2 extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.progress,a.kode_lokasi,a.no_aju,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.kode_pp,b.nama as nama_pp,a.nilai,a.kode_drk,j.nama as nama_drk,a.npajak,a.nilai+a.npajak as bruto,k.jenis,
	   ...
	   case when f.status='1' then 'Ok' when f.status='D' then 'Ambil Berkas' else f.status end as sts_ver,f.catatan as cat_ver,
