...
class server_report_saku2_kopeg_kbitt_rptBymhdSaldo extends server_report_basic
{
	...
	function getHtml()
	{
		...
		d.nilai,b.no_aju,c.no_kas,isnull(c.nilai,0) as nilai_kas,d.nilai-isnull(c.nilai,0) as saldo
from ju_m a
inner join it_aju_m b on a.no_dokumen=b.no_fiat and a.kode_lokasi=b.kode_lokasi
...
from kas_m 
where kode_lokasi='$kode_lokasi' and modul='KBITAJU' and periode<='$periode'
group by no_kas,no_dokumen,kode_lokasi  
		  )c on b.no_aju=c.no_dokumen and b.kode_lokasi=c.kode_lokasi
$this->filter ";
