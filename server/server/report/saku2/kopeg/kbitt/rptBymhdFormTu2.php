...
class server_report_saku2_kopeg_kbitt_rptBymhdFormTu2 extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.no_aju,a.kode_lokasi,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.kode_pp,b.nama as nama_pp,a.nilai,a.nik_user,a.tanggal,a.kode_akun,h.kode_akun as kode,c.nama as nama_akun,
		a.kode_drk,e.nama as nama_drk,
		a.nik_user,a.nik_app,f.nama as nama_user,g.nama as nama_app
from it_aju_m a
inner join it_aju_d h on a.no_aju=h.no_aju and a.kode_lokasi=h.kode_lokasi
...
$this->filter order by a.no_aju";
  ...
  <tr>
    <td height='30' align='center' valign='middle' class='judul_bukti'>FORMULIR PERTANGGUNGAN BDD / BYMHD</td>
  </tr>
