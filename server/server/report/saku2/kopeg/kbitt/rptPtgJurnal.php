...
class server_report_saku2_kopeg_kbitt_rptPtgJurnal extends server_report_basic
{
...
order by a.periode,a.no_ptg,a.dc desc ";
  ...
  <td width='30' class='header_laporan'><div align='center'>Modul</div></td>
	...
	{						
		...
		$AddOnLib=new server_util_AddOnLib();						
		$sql="select a.no_ptg as no_bukti,a.no_dokumen,date_format(a.tanggal,'%d/%m/%Y') as tanggal,a.kode_akun,b.nama,a.kode_pp,a.kode_drk,a.kode_cf,a.modul,a.keterangan, 
		case when a.dc='D' then a.nilai else 0 end as debet,case when a.dc='C' then a.nilai else 0 end as kredit 
		from ptg_j a  
