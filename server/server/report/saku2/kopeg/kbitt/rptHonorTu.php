...
class server_report_saku2_kopeg_kbitt_rptHonorTu extends server_report_basic
{
...
$root_app="http://".$_SERVER['SERVER_NAME']."/web/server/pbh/";
  ...
  <tr>
    <td height='30' align='center' valign='middle' class='judul_bukti'>FORMULIR PERTANGGUNGAN HONOR</td>
  </tr>
  ...
  <tr>
   ...
   <tr>
    <td><table  border='1' cellspacing='0' cellpadding='0' class='kotak'>
	  ...
	  $sql="select a.no_rek,a.nama_rek,b.bank,a.nilai+a.pajak as nilai,a.pajak,a.nilai as netto 
from it_aju_rek a
left join it_dosen b on a.keterangan=b.kode_dosen and a.kode_lokasi=b.kode_lokasi
where a.no_aju='$row->no_aju' and b.kode_lokasi='$row->kode_lokasi' 
order by a.no_rek";
