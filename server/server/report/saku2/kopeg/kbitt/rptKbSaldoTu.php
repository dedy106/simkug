...
class server_report_saku2_kopeg_kbitt_rptKbSaldoTu extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode=$tmp[1];
		$kode_lokasi=$tmp[2];
		$sql="exec sp_glma_kasit_tmp '$kode_lokasi','$kode_lokasi','$kode_lokasi','$periode','$nik_user' ";
...
from glma_tmp $this->filter and nik_user='$nik_user' and (so_awal<>0 or debet<>0 or kredit<>0 or so_akhir<>0) order by kode_akun ";
