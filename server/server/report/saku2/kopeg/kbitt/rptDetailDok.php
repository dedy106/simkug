...
class server_report_saku2_kopeg_kbitt_rptDetailDok extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$fullId = $_GET["fullId"];
		$sql="select a.no_bukti,a.modul,a.no_gambar,a.kode_lokasi from it_aju_dok a 
   ...
   <tr bgcolor='#CCCCCC'>
     ...
     <td width='60'  align='center' class='header_laporan'>Dokumen</td>	  
     </tr>  ";
