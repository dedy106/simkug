...
class server_report_saku2_kopeg_kbitt_rptHonorSaldo extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$fullId = $_GET["fullId"];
		$sql="select b.kode_dosen,b.kode_lokasi,b.nama,b.gelar,a.kode_pp,c.nama as nama_pp,
...
from (select b.keterangan,a.kode_pp,a.kode_lokasi,
...
group by b.keterangan,a.kode_pp,a.kode_lokasi 
		)a
inner join it_dosen b on a.keterangan=b.kode_dosen and a.kode_lokasi=b.kode_lokasi
inner join pp c on a.kode_pp=c.kode_pp and a.kode_lokasi=c.kode_lokasi
$this->filter
order by a.kode_pp,b.kode_dosen";
