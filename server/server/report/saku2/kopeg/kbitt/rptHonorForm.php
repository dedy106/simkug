...
class server_report_saku2_kopeg_kbitt_rptHonorForm extends server_report_basic
{
	...
	function getHtml()
	{
		...
		f.bank,d.no_rek,d.nama_rek,a.kode_drk,e.nama as nama_drk
from it_aju_m a
...
left join it_dosen f on d.keterangan=f.kode_dosen and d.kode_lokasi=f.kode_lokasi
