...
class server_report_saku2_kopeg_kbitt_rptBebanFormTu2 extends server_report_basic
{
  ...
  <tr>
   ...
   <tr>
    <td><table  border='1' cellspacing='0' cellpadding='0' class='kotak'>
	  ...
	  $sql="select a.no_rek,a.nama_rek,a.bank,case when b.no_ref1 in ('MALA','MABA','CAMABA') then a.nilai else a.nilai+isnull(a.pajak,0) end as nilai,case when b.no_ref1 in ('MALA','MABA','CAMABA') then 0 else isnull(a.pajak,0) end as pajak,a.nilai as netto 
from it_aju_rek a
