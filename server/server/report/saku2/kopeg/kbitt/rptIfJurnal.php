...
class server_report_saku2_kopeg_kbitt_rptIfJurnal extends server_report_basic
{
...
left join karyawan c on a.nik_setuju=c.nik and a.kode_lokasi=c.kode_lokasi $this->filter ";
  ...
  <tr>
	...
	function doPrintHeader($sender, $page){		
		...
		$sender->Cell(10,5,"",'L',0,'C');$sender->Cell(30,5,"No Bukti",0,0,'l');$sender->Cell(5,5,":",0,0,'C');$sender->Cell($w-  55,5,$sender->row->no_ju,'R',1,'L');
