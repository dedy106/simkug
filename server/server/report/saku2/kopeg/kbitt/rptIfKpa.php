...
class server_report_saku2_kopeg_kbitt_rptIfKpa extends server_report_basic
{
...
$this->filter";
	...
	function getHtml()
	{
		...
		$sql="select a.no_bukti,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.kode_pp,b.nama as nama_pp,a.nilai,a.kode_akun,c.nama as nama_akun,a.kode_drk,d.nama as nama_drk
from it_ifaju_m a
inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi
...
$this->filter order by a.no_bukti";
		...
		echo $AddOnLib->judul_laporan("kpa imprest fund",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
