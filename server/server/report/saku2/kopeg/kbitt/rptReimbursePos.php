...
class server_report_saku2_kopeg_kbitt_rptReimbursePos extends server_report_basic
{
...
$this->filter";
	...
	function getHtml()
	{
		...
		$sql="select a.no_aju,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.kode_pp,b.nama as nama_pp,a.nilai,
...
$this->filter order by a.no_aju";
		...
		echo $AddOnLib->judul_laporan("posisi pertanggungan reimburse",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
