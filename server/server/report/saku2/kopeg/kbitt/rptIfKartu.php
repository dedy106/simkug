...
class server_report_saku2_kopeg_kbitt_rptIfKartu extends server_report_basic
{
...
$this->filter ";
  ...
  <tr>
    <td height='23' colspan='8' class='header_laporan' align='right'>Saldo Imprest Fund </td>
    <td class='header_laporan' align='right'>".number_format($row->nilai,0,',','.')."</td>
  </tr>";
  $sql="select a.nik,b.nama,a.nilai
from it_if_sub a
inner join karyawan b on a.nik=b.nik and a.kode_lokasi=b.kode_lokasi
where a.nik_if='$row->nik' and a.kode_lokasi='$row->kode_lokasi'";
	$rs1 = $dbLib->execute($sql);
	$sub_nilai=0;
	while ($row1 = $rs1->FetchNextObject($toupper=false))
	{
		$sub_nilai+=$row1->nilai;
		echo "<tr>
    <td height='23' colspan='8' class='header_laporan' align='right'>Sub Imprest Fund : $row1->nik - $row1->nama </td>
    <td class='header_laporan' align='right'>".number_format($row1->nilai,0,',','.')."</td>
  </tr>";
	}
	echo " <tr>
    <td height='23' colspan='8' class='header_laporan' align='right'>Saldo Mutasi </td>
    <td class='header_laporan' align='right'>".number_format($row->nilai-$sub_nilai,0,',','.')."</td>
  </tr>";
...
";
			...
			$sql="select a.no_aju as no_bukti,a.no_aju as no_dokumen,a.kode_lokasi,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.kode_akun,a.kode_pp,a.kode_drk,a.keterangan,a.nilai,0 as nilai_kas,
		  a.kode_akun,c.nama as nama_akun,a.tanggal
from it_aju_m a
inner join masakun c on a.kode_akun=c.kode_akun and a.kode_lokasi=c.kode_lokasi
where a.nik_panjar='$row->nik' and a.kode_lokasi='$row->kode_lokasi'
union
select b.no_kas as no_bukti,a.no_aju as no_dokumen,b.kode_lokasi,date_format(b.tanggal,'%d/%m/%Y') as tgl,a.kode_akun,a.kode_pp,'-' as kode_drk,a.keterangan,0 as nilai,a.nilai as nilai_kas,
		  a.kode_akun,c.nama as nama_akun,a.tanggal
from it_aju_m a
