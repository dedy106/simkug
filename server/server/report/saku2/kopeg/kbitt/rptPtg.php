...
class server_report_saku2_kopeg_kbitt_rptPtg extends server_report_basic
{
...
$this->filter order by a.no_aju";
		...
		echo $AddOnLib->judul_laporan("pengajuan pertanggungan panjar",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
