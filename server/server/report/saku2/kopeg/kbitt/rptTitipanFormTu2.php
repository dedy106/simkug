...
class server_report_saku2_kopeg_kbitt_rptTitipanFormTu2 extends server_report_basic
{
...
$root_app="http://".$_SERVER['SERVER_NAME']."/web/server/pbh/";
  ...
  <tr>
    <td height='30' align='center' valign='middle' class='judul_bukti'>FORMULIR PENYELESAIN TITIPAN</td>
  </tr>
  ...
  <tr>
    <td><table width='100%'  border='0'>
	  <tr>
        <td width='200'>No Penyelesaian</td>
