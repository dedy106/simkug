...
class server_report_saku2_kopeg_fa_rptFaAssetLog extends server_report_basic
{
	...
	function getHtml()
	{
       ...
       a.umur,a.persen,a.nilai,a.barcode,
...
left join  fa_lok h on a.kode_lokfa=h.kode_lokfa and a.kode_lokasi=h.kode_lokasi
...
order by a.kode_akun,a.tgl_perolehan ";
		...
		echo "<table  border='1' cellspacing='0' cellpadding='0' class='kotak'>
				...
				<td width='150'  align='center' class='header_laporan'>Nama Klp Asset </td>
				<td width='60'  align='center' class='header_laporan'>Kode PP </td>
				<td width='150'  align='center' class='header_laporan'>Nama PP </td>
				<td width='60'  align='center' class='header_laporan'>Tanggal</td>
				<td width='100'  align='center' class='header_laporan'>No Barcode </td>
				<td width='200'  align='center' class='header_laporan'>Uraian Barang</td>
				...
				<td width='100' align='center' class='header_laporan'>Nilai Depresiasi </td>
				<td width='100'  align='center' class='header_laporan'>Write Off</td>	
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			...
			echo "</td>
				  ...
				  <td  class='isi_laporan' align='center'>$row->barcode</td>
				<td  class='isi_laporan'>$row->nama</td>
				  <td  class='isi_laporan'>$row->lokasi_fa</td>
