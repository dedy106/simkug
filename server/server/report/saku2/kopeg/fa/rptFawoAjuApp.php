...
class server_report_saku2_kopeg_fa_rptFawoAjuApp extends server_report_basic
{	
...
order by a.no_wo";
		...
		echo $AddOnLib->judul_laporan("approve pengajuan write off",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
