...
class server_report_saku2_kopeg_hutang_rptHutangAkru extends server_report_basic
{	
...
from hutang_m a $this->filter ";
	...
	function getHtml()
	{
		...
		$sql="select a.no_hutang,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.nilai,a.nilai_ppn,a.nilai-a.nilai_ppn as tagihan,
