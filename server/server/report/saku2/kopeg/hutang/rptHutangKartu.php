...
class server_report_saku2_kopeg_hutang_rptHutangKartu extends server_report_basic
{
...
";
			...
			$sql="select a.kode_lokasi,b.no_kas as no_bukti,b.nilai as nilai_kas,date_format(c.tanggal,'%d/%m/%Y') as tanggal,c.keterangan
from spb_d a
inner join spb_m b on a.no_spb=b.no_spb and a.kode_lokasi=b.kode_lokasi
inner join kas_m c on b.no_kas=c.no_kas and a.kode_lokasi=c.kode_lokasi
