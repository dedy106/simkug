...
class server_report_saku2_kopeg_bengkel_rptPiutangKartu extends server_report_basic
{
	...
	function getHtml()
	{
		...
		global $dbLib;
		$sql="select a.kode_lokasi,a.no_jual,a.no_dokumen,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.nilai+a.nilai_ppn as nilai,b.nama as nama_cust
from fri_jual_m a
  ...
  <tr >
    <td height='23' colspan='7' class='header_laporan'><table  border='0' cellspacing='2' cellpadding='1'>
      <tr>
	   ...
	   <tr>
        <td width='99' class='header_laporan'>No SPK</td>
