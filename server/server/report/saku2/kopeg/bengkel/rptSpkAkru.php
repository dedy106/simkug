...
class server_report_saku2_kopeg_bengkel_rptSpkAkru extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$alamat=$row->alamat;
		$sql="select  a.no_jual,a.no_dokumen,a.kode_lokasi,a.periode,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tanggal1,a.keterangan,a.kode_lokasi, d.kota 
			from fri_jual_m a
