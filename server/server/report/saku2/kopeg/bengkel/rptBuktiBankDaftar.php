...
class server_report_saku2_kopeg_bengkel_rptBuktiBankDaftar extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode=$tmp[0];
		$akun=$tmp[1];
		$sql="select a.no_kas as no_bukti,a.no_dokumen,c.nama,date_format(b.tanggal,'%d/%m/%Y') as tanggal,b.kode_akun,
