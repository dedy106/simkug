...
class server_report_saku2_kopeg_barang_rptSop extends server_report_basic
{	
	function getTotalPage()
	{
		global $dbLib;
		$sql="select count(a.no_sop)
from brg_sop_m a  $this->filter ";
		error_log($sql);
...
from brg_sop_m a
inner join brg_gudang b on a.kode_gudang=b.kode_gudang and a.kode_lokasi=b.kode_lokasi $this->filter
order by a.no_sop";
