...
class server_report_saku2_kopeg_barang_rptBeli extends server_report_basic
{	
...
inner join vendor b on a.kode_vendor=b.kode_vendor and a.kode_lokasi=b.kode_lokasi  $this->filter ";
	...
	function getHtml()
	{
		...
		$sql="select a.no_beli,date_format(a.tanggal,'%d/%m/%Y') as tanggal,a.no_dokumen,a.keterangan,a.kode_vendor,b.nama as nama_vendor ,a.kode_gudang,c.nama as nama_gudang
from brg_beli_m a
inner join vendor b on a.kode_vendor=b.kode_vendor and a.kode_lokasi=b.kode_lokasi
inner join brg_gudang c on a.kode_gudang=c.kode_gudang and a.kode_lokasi=c.kode_lokasi  $this->filter
order by a.no_beli";
