...
class server_report_saku2_kopeg_barang_rptKirim extends server_report_basic
{	
...
from brg_kirim_m a  $this->filter ";
	...
	function getHtml()
	{
		...
		$sql="select a.no_kirim,date_format(a.tanggal,'%d/%m/%Y') as tanggal,a.no_dokumen,a.keterangan,a.kode_asal,b.nama as nama_asal ,a.kode_tujuan,c.nama as nama_tujuan
from brg_kirim_m a
inner join brg_gudang b on a.kode_asal=b.kode_gudang and a.kode_lokasi=b.kode_lokasi
inner join brg_gudang c on a.kode_tujuan=c.kode_gudang and a.kode_lokasi=c.kode_lokasi  $this->filter
order by a.no_kirim";
  ...
  <td width='50' align='center' class='header_laporan'>Jumlah</td>
			...
			$sql1="select a.kode_brg,b.nama as nama_brg,b.merk,b.tipe,a.satuan,a.jumlah,a.stok
from brg_kirim_d a
inner join brg_m b on a.kode_brg=b.kode_brg and a.kode_lokasi=b.kode_lokasi
