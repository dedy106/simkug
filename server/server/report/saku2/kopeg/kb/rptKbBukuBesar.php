...
class server_report_saku2_kopeg_kb_rptKbBukuBesar extends server_report_basic
{
...
from (select a.kode_lokasi,a.no_kas as no_bukti,a.no_dokumen,a.tanggal,a.kode_akun,a.kode_pp,a.kode_drk,a.dc,a.nilai,a.keterangan 
	  from kas_j a 
