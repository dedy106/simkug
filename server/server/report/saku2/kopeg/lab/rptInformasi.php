...
class server_report_saku2_kopeg_lab_rptInformasi extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		$tmp=explode("/",$this->filter2);
		$nama_ver=$tmp[0];
		$sql="select no_konten,tanggal,judul,keterangan,file_gambar from lab_konten $this->filter ";
  ...
  <tr>
	...
	if ($row->file_gambar!="-")
	{
		echo "<img src='$pathfoto' align='left' width='400' height='300'>";
	}
