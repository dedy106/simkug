...
class server_report_saku2_kopeg_lab_rptLr extends server_report_basic
{
...
inner join lab_mhs f on e.nik_user=f.nim and e.kode_lokasi=f.kode_lokasi ";
  ...
  <tr>
    <td align='center' class='style16'>LABARUGI</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
  ...
  <tr>
    <td align='center'>";
		$sql="exec sp_lab_neraca '$row->kode_lokasi','L','S',1,'$no_tugas','$nik_user','$userid'";
		
		$rs1 = $dbLib->execute($sql);		
		$sql = "select kode_neraca,nama,tipe,case when jenis_akun='Pendapatan' then n1*-1 else n1 end as n1,level_spasi
				from lab_neraca_tmp where userid='$userid' and modul='L' order by rowindex ";
	
		$rs1 = $dbLib->execute($sql);
	echo "<table border='1' cellspacing='0' cellpadding='0' class='kotak'>
  <tr align='center' bgcolor='#dbeef3'>
    <td width='500' class='header_laporan'>URAIAN</td>
