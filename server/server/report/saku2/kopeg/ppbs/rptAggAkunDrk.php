...
class server_report_saku2_kopeg_ppbs_rptAggAkunDrk extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		$trail=$tmp[0];
			...
			$sql = "select a.kode_akun,a.kode_lokasi,b.nama as nama_akun,a.kode_pp,c.nama as nama_pp,a.kode_drk,d.nama as nama_drk,a.tahun,
...
<td width='90' class='header_laporan' align='center'>September</td>
  ...
  echo "<a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenDetail('$row->kode_akun','$row->kode_pp','$row->kode_drk','$row->kode_lokasi','$row->tahun');\">$row->nama_akun</a>";
  echo "</td>
  ...
  <td class='isi_laporan' align='right'>".number_format($row->total,0,',','.')."</td>
		...
		echo "<tr>
  <td height='23' class='isi_laporan' align='center' colspan='7'>Total</td>
