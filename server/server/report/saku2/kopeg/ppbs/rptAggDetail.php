...
class server_report_saku2_kopeg_ppbs_rptAggDetail extends server_report_basic
{	
...
group by kode_lokasi,kode_akun,kode_pp,kode_drk,keterangan ";
	...
	<td align='center' class='isi_laporan'>".number_format($row1->vol01,0,",",".")."</td>
    <td align='center' class='isi_laporan'>".number_format($row1->tot01,0,",",".")."</td>
    <td align='right' class='isi_laporan'>".number_format($row1->vol02,0,",",".")."</td>
    <td align='right' class='isi_laporan'>".number_format($row1->tot02,0,",",".")."</td>
	<td align='center' class='isi_laporan'>".number_format($row1->vol03,0,",",".")."</td>
    <td align='center' class='isi_laporan'>".number_format($row1->tot03,0,",",".")."</td>
    <td align='right' class='isi_laporan'>".number_format($row1->vol04,0,",",".")."</td>
    <td align='right' class='isi_laporan'>".number_format($row1->tot04,0,",",".")."</td>
	<td align='center' class='isi_laporan'>".number_format($row1->vol05,0,",",".")."</td>
    <td align='center' class='isi_laporan'>".number_format($row1->tot05,0,",",".")."</td>
    <td align='right' class='isi_laporan'>".number_format($row1->vol06,0,",",".")."</td>
    <td align='right' class='isi_laporan'>".number_format($row1->tot06,0,",",".")."</td>
	<td align='center' class='isi_laporan'>".number_format($row1->vol07,0,",",".")."</td>
    <td align='center' class='isi_laporan'>".number_format($row1->tot07,0,",",".")."</td>
    <td align='right' class='isi_laporan'>".number_format($row1->vol08,0,",",".")."</td>
    <td align='right' class='isi_laporan'>".number_format($row1->tot08,0,",",".")."</td>
	<td align='center' class='isi_laporan'>".number_format($row1->vol09,0,",",".")."</td>
    <td align='center' class='isi_laporan'>".number_format($row1->tot09,0,",",".")."</td>
    <td align='right' class='isi_laporan'>".number_format($row1->vol10,0,",",".")."</td>
    <td align='right' class='isi_laporan'>".number_format($row1->tot10,0,",",".")."</td>
	<td align='center' class='isi_laporan'>".number_format($row1->vol11,0,",",".")."</td>
    <td align='center' class='isi_laporan'>".number_format($row1->tot11,0,",",".")."</td>
    <td align='right' class='isi_laporan'>".number_format($row1->vol12,0,",",".")."</td>
	...
	<td align='center' class='isi_laporan'>".number_format($vol01,0,",",".")."</td>
    <td align='center' class='isi_laporan'>".number_format($tot01,0,",",".")."</td>
    <td align='right' class='isi_laporan'>".number_format($vol02,0,",",".")."</td>
    <td align='right' class='isi_laporan'>".number_format($tot02,0,",",".")."</td>
	<td align='center' class='isi_laporan'>".number_format($vol03,0,",",".")."</td>
    <td align='center' class='isi_laporan'>".number_format($tot03,0,",",".")."</td>
    <td align='right' class='isi_laporan'>".number_format($vol04,0,",",".")."</td>
    <td align='right' class='isi_laporan'>".number_format($tot04,0,",",".")."</td>
	<td align='center' class='isi_laporan'>".number_format($vol05,0,",",".")."</td>
    <td align='center' class='isi_laporan'>".number_format($tot05,0,",",".")."</td>
    <td align='right' class='isi_laporan'>".number_format($vol06,0,",",".")."</td>
    <td align='right' class='isi_laporan'>".number_format($tot06,0,",",".")."</td>
	<td align='center' class='isi_laporan'>".number_format($vol07,0,",",".")."</td>
    <td align='center' class='isi_laporan'>".number_format($tot07,0,",",".")."</td>
    <td align='right' class='isi_laporan'>".number_format($vol08,0,",",".")."</td>
    <td align='right' class='isi_laporan'>".number_format($tot08,0,",",".")."</td>
	<td align='center' class='isi_laporan'>".number_format($vol09,0,",",".")."</td>
    <td align='center' class='isi_laporan'>".number_format($tot09,0,",",".")."</td>
    <td align='right' class='isi_laporan'>".number_format($vol10,0,",",".")."</td>
    <td align='right' class='isi_laporan'>".number_format($tot10,0,",",".")."</td>
	<td align='center' class='isi_laporan'>".number_format($vol11,0,",",".")."</td>
    <td align='center' class='isi_laporan'>".number_format($tot11,0,",",".")."</td>
    <td align='right' class='isi_laporan'>".number_format($vol12,0,",",".")."</td>
    <td align='right' class='isi_laporan'>".number_format($tot12,0,",",".")."</td>
	<td align='center' class='isi_laporan'>".number_format($vol,0,",",".")."</td>
