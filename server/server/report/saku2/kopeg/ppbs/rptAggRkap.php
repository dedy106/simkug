...
class server_report_saku2_kopeg_ppbs_rptAggRkap extends server_report_basic
{
...
<td width='90' class='header_laporan'><div align='center'>September</div></td>
  ...
  <td class='isi_laporan' align='right'>".number_format($row->n0,0,',','.')."</td>
			...
			where b.kode_fs='$kode_fs' and b.kode_lokasi='$kode_lokasi' and b.kode_neraca='$kode_neraca' and substring(a.periode,1,4)='$tahun'
