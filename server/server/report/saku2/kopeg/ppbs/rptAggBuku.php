...
class server_report_saku2_kopeg_ppbs_rptAggBuku extends server_report_basic
{	
...
from agg_d a
inner join agg_pk b on substring(a.kode_drk,1,7)=b.kode_pk and a.tahun=b.tahun
