...
class server_report_saku2_kopeg_sju_rptCust extends server_report_basic
{
...
$this->filter";
	...
	function getHtml()
	{
		...
		$periode=$tmp[0];
		$nama_cab=$tmp[1];
		$sql="select a.kode_cust, a.nama, a.alamat, a.no_tel, a.email, a.npwp, a.pic, a.alamat2,a.kode_segmen
from sju_cust a
$this->filter order by a.kode_cust";
   ...
   <tr bgcolor='#CCCCCC'>
     ...
     <td width='80'  align='center' class='header_laporan'>Kode</td>
	  ...
	  <td width='80'  align='center' class='header_laporan'>Kode Segmen</td>
