...
class server_report_saku2_kopeg_sju_rptPiutangSaldo extends server_report_basic
{
...
where a.kode_lokasi='$kode_lokasi' and (a.n1<>0 or a.n2<>0 or a.n3<>0 or a.n4<>0) and a.nik_user='$nik_user'
order by $urut";
 ...
 <td width='100'  align='center' class='header_laporan'>Saldo Awal Piutang</td>
   ...
   ";
	...
	echo "<td class='isi_laporan'><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenSaldo('$row->kode_cust','$row->kode_lokasi');\">$row->nama</a></td>";
	 echo "<td class='isi_laporan' align='right'>".number_format($row->n1,2,",",".")."</td>
