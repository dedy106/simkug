...
class server_report_saku2_kopeg_sju_rptGlLabaRugiSimulasi extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="call sp_neraca_sju_sim '$kode_fs','L','S','1','$periode','$periode_rev','$kode_lokasi','$kode_lokasi','$kode_lokasi2','$nik_user' ";
