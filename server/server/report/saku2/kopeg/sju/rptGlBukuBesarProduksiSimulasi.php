...
class server_report_saku2_kopeg_sju_rptGlBukuBesarProduksiSimulasi extends server_report_basic
{
  ...
  <tr>
    ...
    <td colspan='10' class='header_laporan'>".$AddOnLib->fnAkun($row->kode_akun)." - ".$row->nama."</td>
  </tr>
  <tr align='center' bgcolor='#dbeef3'>
	...
	<td width='60' class='header_laporan'>Acc Exec</td>
    ...
    <td colspan='9' class='header_laporan' align='right'>Opening Balance</td>
    ...
    <td>&nbsp;</td>
	 ...
	 $sql1="select a.kode_akun,a.kode_lokasi,b.nama as nama_akun,a.nilai,a.keterangan,isnull(a.debet,0) as debet,isnull(a.kredit,0) as kredit,a.kode_curr,a.tgl,a.no_bukti,a.periode,
				a.kode_proyek,a.kode_cust,a.kode_vendor,a.nama_cust,a.nama_vendor,a.kode_task,a.nama_pic
					  from (select a.kode_lokasi,a.no_bukti,a.tanggal,a.kode_akun,a.dc,a.nilai,a.keterangan,a.periode,a.kode_curr,date_format(a.tanggal,'%d/%m/%Y') as tgl,
								   ...
								   a.kode_cust,a.kode_vendor,a.kode_proyek,b.nama as nama_cust,c.nama as nama_vendor,a.kode_task,d.nama as nama_pic
							from gldt_tmp a
							...
							left join sju_pic d on a.kode_task=d.kode_pic and a.kode_lokasi=d.kode_lokasi
							where a.kode_akun='$row->kode_akun' and a.kode_lokasi='$row->kode_lokasi' $periode2
							)a 
	  ...
	  echo " <tr>
    <td colspan='9' align='right' class='header_laporan'>Transaction</td>
  <td class='header_laporan' align='right'>".number_format($tot_debet,2,',','.')."</td>
	...
	<td class='header_laporan' align='right'>".number_format($tot_debet-$tot_kredit,2,',','.')."</td>
	  ...
	  echo " <tr>
    <td colspan='9' align='right' class='header_laporan'>Ending Balance</td>
