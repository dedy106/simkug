...
class server_report_saku2_kopeg_sju_rptGlLabaRugiKonsol extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="call sp_neraca_konsol_sju 'FS1','L','S','1','$periode','$periode_rev','$kode_lokasi','$kode_lokasi','$kode_lokasi2','$nik_user' ";
  ...
  <tr>
    <td  class='lokasi_laporan2' align='center'>LAPORAN LABA / RUGI $cabang</td>
  </tr>
  <tr>
