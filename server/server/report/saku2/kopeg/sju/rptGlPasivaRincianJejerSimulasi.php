...
class server_report_saku2_kopeg_sju_rptGlPasivaRincianJejerSimulasi extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="call sp_produk_jejer_sju_sim '$kode_fs','N','S','1','$periode','$kode_lokasi','$nik_user' ";
