...
class server_report_saku2_kopeg_sju_rptGlJurnalBukti extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select distinct a.no_bukti,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.kode_lokasi,a.periode,b.nama as nama_lokasi
				from gldt_tmp a
