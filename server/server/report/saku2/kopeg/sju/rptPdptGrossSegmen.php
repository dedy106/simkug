...
class server_report_saku2_kopeg_sju_rptPdptGrossSegmen extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select nama from sju_segmen where kode_segmen='$kode_lokasi'";
		$rs = $dbLib->execute($sql);
		$row = $rs->FetchNextObject($toupper=false);
		$cabang=$row->nama;
		
		$sql="exec sp_dw_produksi_segmen '$kode_lokasi','$kode_segmen','$periode','$nik_user';";
  ...
  <tr>
    <td align='center'><table  border='0' cellspacing='2' cellpadding='1'>
      ...
      <tr>
        <td align='center' class='lokasi_laporan2'>PENDAPATAN USAHA SEGMEN /D BULAN $bulan $tahun (GROSS)</td>
      </tr>
      <tr>
  ...
  <tr>
    <td><table border='1' cellspacing='0' cellpadding='0' class='kotak'>
      <tr align='center' bgcolor='#dbeef3'>
        ...
        <td width='250' colspan='2' rowspan='3' class='header_laporan'>JENIS ASURANSI</td>
...
order by a.kode_klp ";
        ...
        <td colspan='11' class='header_laporan'>$row->kode_klp - $row->nama</td>
			...
			$sql="select a.kode_lokasi,a.kode_cust,b.nama as nama_cust,n1,n2,n3*-1 as n3,n4,n5*-1 as n5,n6,n7
from dw_produksi a
inner join sju_cust b on a.kode_cust=b.kode_cust and a.kode_lokasi=b.kode_lokasi
where a.kode_lokasi='$kode_lokasi' and a.nik_user='$nik_user' and a.kode_klp='$row->kode_klp' and (a.n1<>0 or a.n2<>0 or a.n3<>0 or a.n4<>0 or a.n5<>0 or a.n6<>0)
