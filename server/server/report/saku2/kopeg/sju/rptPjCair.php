...
class server_report_saku2_kopeg_sju_rptPjCair extends server_report_basic
{
...
$this->filter";
	...
	function getHtml()
	{
		...
		$periode=$tmp[0];
		$nama_cab=$tmp[1];
		$sql="select a.no_kas,a.no_dokumen,date_format(b.tanggal,'%d/%m/%Y') as tgl_kas,a.keterangan,a.no_pj,
		date_format(a.tanggal,'%d/%m/%Y') as tgl_pj,a.kode_pp,c.nama as nama_pp,b.nilai
from panjar_m a
inner join kas_m b on a.no_kas=b.no_kas and a.kode_lokasi=b.kode_lokasi
inner join pp c on c.kode_pp=b.kode_pp and c.kode_lokasi=b.kode_lokasi
