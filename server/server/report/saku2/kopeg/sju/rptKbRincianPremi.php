...
class server_report_saku2_kopeg_sju_rptKbRincianPremi extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$kode_lokasi=$tmp[0];
		$periode=$tmp[1];
		$sql="select a.no_kas as no_bukti,a.keterangan,a.tanggal,a.kode_lokasi,date_format(a.tanggal,'%d/%m/%Y') as tgl,c.nama as nama_lokasi
		from kas_m a
		inner join lokasi c on a.kode_lokasi=c.kode_lokasi
        $this->filter and a.modul in ('KBPOLIS','KBPOLISFEE','KBFEEPNG','KBFEE5','KBFEE4')
		order by a.no_kas ";
  ...
  <tr>
    <td><table width='800' border='1' cellspacing='0' cellpadding='0' class='kotak'>
	 ...
	 $sql1="select a.kode_akun,b.nama as nama_akun,a.nilai,a.keterangan,case when a.dc='D' then isnull(a.nilai,0) else 0 end as debet,
			...
			where a.kode_lokasi='$row->kode_lokasi' and a.no_kas='$row->no_bukti'
			order by a.dc desc";
...
d.premi+d.p_cost+d.materai-d.fee-d.diskon-d.ppn as hutang,d.kode_curr,a.kurs,b.no_dok2,d.ke
from sju_polisbayar_d a
inner join sju_polis_m b on a.no_polis=b.no_polis and a.kode_lokasi=b.kode_lokasi
