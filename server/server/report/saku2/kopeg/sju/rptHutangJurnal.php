...
class server_report_saku2_kopeg_sju_rptHutangJurnal extends server_report_basic
{
	...
	function getHtml()
	{
		...
		global $dbLib;
		$sql="select distinct a.no_bill,a.tanggal,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.no_dokumen,a.kode_lokasi,a.periode,c.nama as nama_lokasi 
				from sju_bill_m a
    ...
    <td><table width='100%'  border='0' cellspacing='2' cellpadding='1'>
      <tr>
        ...
        <td width='200' align='center'><table width='100%'  border='1' cellspacing='0' cellpadding='0' class='kotak'>
          ...
          <tr>
            <td align='center' class='istyle15'>$row->no_bill</td>
          </tr>
          <tr>
  ...
  <tr>
	...
	$sql1="select a.kode_lokasi,a.kode_akun,a.dc,a.nilai,a.keterangan,b.nama as nama_akun,a.no_dokumen,
			...
			where a.periode='$row->periode' and a.kode_lokasi='$row->kode_lokasi' and a.no_bill='$row->no_bill'
			order by a.dc desc";
