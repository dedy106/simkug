...
class server_report_saku2_kopeg_sju_rptGlBukuBesarKonsolProduksiSimulasi extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode2=$tmp[4];
		$jenis=$tmp[5];
		$sql="exec sp_glma_dw_konsol_tmp_sim '$kode_lokasi','$periode','$nik_user' ";
		$nama_file="dok.xls";
