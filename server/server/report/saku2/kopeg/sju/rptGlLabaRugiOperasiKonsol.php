...
class server_report_saku2_kopeg_sju_rptGlLabaRugiOperasiKonsol extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="call sp_produk_konsol_sju 'FS7','L','S','1','$periode','$periode_rev','$kode_lokasi','$kode_lokasi','$kode_lokasi2','$nik_user' ";
  ...
  <tr>
    <td  class='lokasi_laporan2' align='center'>REALISASI BEBAN OPERASI DAN PEMELIHARAAN $cabang</td>
  </tr>
  <tr>
  ...
  <tr align='center' bgcolor='#dbeef3'>
   ...
   <tr align='center' bgcolor='#dbeef3'>
    ...
    <td  class='isi_laporan' align='right'>";
			...
			{
				echo "<a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenGarTw('$row->kode_neraca','$kode_lokasi','$periode');\">$n3</a>";
			}
			else
			{
				echo "$n3";
