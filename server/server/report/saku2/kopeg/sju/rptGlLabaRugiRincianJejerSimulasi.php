...
class server_report_saku2_kopeg_sju_rptGlLabaRugiRincianJejerSimulasi extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="call sp_neraca_jejer_sju_sim '$kode_fs','L','S','1','$periode','$kode_lokasi','$nik_user' ";
