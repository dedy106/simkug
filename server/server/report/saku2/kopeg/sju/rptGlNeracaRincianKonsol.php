...
class server_report_saku2_kopeg_sju_rptGlNeracaRincianKonsol extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="call sp_produk_konsol_sju 'FS2','N','S','1','$periode','$periode_rev','$kode_lokasi','$kode_lokasi','$kode_lokasi2','$nik_user' ";
		
		$rs = $dbLib->execute($sql);		
		$sql = "select kode_neraca,kode_fs,kode_lokasi,nama,tipe,level_spasi,n2,n3,n4,n5
			from neraca_tmp 
  ...
  <tr align='center' bgcolor='#dbeef3'>
   ...
   <td width='90' class='header_laporan'>REALISASI TAHUN $tahun_rev</td>
	...
	<td width='50' class='header_laporan'>( % ) TASE</td>
  </tr>
   <tr align='center' bgcolor='#dbeef3'>
    <td width='300' class='header_laporan'>(1)</td>
   <td width='90' class='header_laporan'>(3)</td>
    <td width='90' class='header_laporan'>(4)</td>
    <td width='90' class='header_laporan'>(4-3)</td>
	<td width='50' class='header_laporan'>(4/3)</td>
 </tr>";
