...
class server_report_saku2_kopeg_sju_rptGlTbJejer extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$jenis=$tmp[3];
		$trail=$tmp[4];
		$sql="call sp_glma_jejer_sju_tmp '$kode_lokasi','$periode','$nik_user' ";
		$mutasi="";
		if ($jenis=="Tidak")
		{
			$mutasi="and (a.n1<>0 or a.n2<>0 or a.n3<>0 or a.n4<>0 or a.n5<>0 or a.n6<>0 or a.n7<>0) ";
		}
		$rs = $dbLib->execute($sql);		
