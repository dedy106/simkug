...
class server_report_saku2_kopeg_sju_rptGlNeracaJejerSimulasi extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="exec sp_neraca_jejer_sju_sim '$kode_fs','N','S','1','$periode','$kode_lokasi','$nik_user' ";
   ...
   <td valign='top' class='isi_laporan' align='right'>";
    ...
    <td valign='top' class='isi_laporan' align='right'>";
	 ...
	 <td valign='top' class='isi_laporan' align='right'>";
	  ...
	  echo " </table>";
	  echo "<br>";
	  $sql = "select a.kode_lokasi,a.kode_neraca,a.nama,a.n1*-1 as n1,a.n2*-1 as n2,a.n3*-1 as n3,a.n4*-1 as n4,a.n5*-1 as n5 ,a.n6*-1 as n6,a.n7*-1 as n7,a.n8*-1 as n8,a.level_spasi,a.tipe
