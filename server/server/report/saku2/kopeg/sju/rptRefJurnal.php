...
class server_report_saku2_kopeg_sju_rptRefJurnal extends server_report_basic
{
	function getTotalPage()
	{
		...
		$sql="select count(a.no_ju) 
			     ...
			     inner join masakun c on b.kode_akun=c.kode_akun and b.kode_lokasi=c.kode_lokasi $this->filter ";
	...
	function getHtml()
	{
		...
		$tmp=explode("/",$this->filter2);
		$periode=$tmp[0];
		$sql="select a.no_ju as no_bukti,a.no_dokumen,c.nama,date_format(b.tanggal,'%d/%m/%Y') as tanggal,b.kode_akun,b.kode_pp,b.kode_drk,a.posted,b.keterangan,
