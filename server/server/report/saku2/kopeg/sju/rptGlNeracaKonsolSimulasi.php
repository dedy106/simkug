...
class server_report_saku2_kopeg_sju_rptGlNeracaKonsolSimulasi extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="exec sp_neraca_konsol_sju_sim 'FS1','N','K','1','$periode','$periode_rev','$kode_lokasi','$kode_lokasi','$kode_lokasi2','$nik_user' ";
		$rs = $dbLib->execute($sql);		
