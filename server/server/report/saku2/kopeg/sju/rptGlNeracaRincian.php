...
class server_report_saku2_kopeg_sju_rptGlNeracaRincian extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="call sp_produk_sju 'FS2','N','S','1','$periode','$periode_rev','$kode_lokasi','$kode_lokasi','$kode_lokasi2','$nik_user' ";
