...
class server_report_saku2_kopeg_sju_rptGlLabaRugiKonsolSimulasi extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="exec sp_neraca_konsol_sju_sim '$kode_fs','L','S','1','$periode','$periode_rev','$kode_lokasi','$kode_lokasi','$kode_lokasi2','$nik_user' ";
  ...
  <tr align='center' bgcolor='#dbeef3'>
    ...
    <td width='90' class='header_laporan'>REALISASI  S/D $bulan $tahun_rev</td>
     <td width='50' class='header_laporan' colspan='2'>(%) TASE</td>
  ...
  <tr align='center' bgcolor='#dbeef3'>
    ...
    <td width='50' class='header_laporan'>(3/1)</td>
	<td width='50' class='header_laporan'>(3/2)</td>
	<td width='50' class='header_laporan'>(3/4)</td>
  </tr>";
    ...
    <td  class='isi_laporan' align='right'>";
			...
			{
				echo "<a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenGarTw('$row->kode_neraca','$kode_lokasi','$periode');\">$n5</a>";
			}
			else
			{
				echo "$n5";
