...
class server_report_saku2_kopeg_sju_rptJuHutangPremi extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$kode_lokasi=$tmp[0];
		$periode=$tmp[1];
		$sql="select a.no_ju as no_bukti,a.keterangan,a.tanggal,a.kode_lokasi,date_format(a.tanggal,'%d/%m/%Y') as tgl,c.nama as nama_lokasi
		from ju_m a
		inner join lokasi c on a.kode_lokasi=c.kode_lokasi
        $this->filter and a.modul='JUHUTPOL' 
		order by a.no_ju ";
  ...
  <tr>
    <td><table width='800' border='1' cellspacing='0' cellpadding='0' class='kotak'>
	 ...
	 $sql1="select a.kode_akun,b.nama as nama_akun,a.nilai,a.keterangan,case when a.dc='D' then isnull(a.nilai,0) else 0 end as debet,
			...
			where a.kode_lokasi='$row->kode_lokasi' and a.no_ju='$row->no_bukti'
			order by a.dc desc";
...
d.premi+d.p_cost+d.materai-d.fee-d.diskon-d.ppn as hutang,d.kode_curr,b.no_dok2,
case when a.kode_curr<>d.kode_curr then d.kurs else a.kurs end as kurs 
from sju_hutbayar_d a
inner join sju_polis_m b on a.no_polis=b.no_polis and a.kode_lokasi=b.kode_lokasi
inner join sju_cust c on b.kode_cust=c.kode_cust and b.kode_lokasi=c.kode_lokasi
inner join sju_polis_termin d on a.no_polis=d.no_polis and a.kode_lokasi=d.kode_lokasi
