...
class server_report_saku2_kopeg_sju_rptKbBukuBesar extends server_report_basic
{
  ...
  <tr align='center' bgcolor='#dbeef3'>
    ...
    <td width='80' class='header_laporan'>Net Change</td>
  </tr>";
			echo " <tr>
    <td colspan='3'>&nbsp;</td>
    ...
    <td>&nbsp;</td>
	 ...
	 $sql1="select a.kode_akun,b.nama as nama_akun,a.nilai,a.keterangan,isnull(a.debet,0) as debet,isnull(a.kredit,0) as kredit,a.kode_curr,a.tgl,a.no_kas
					  from (select kode_lokasi,no_kas,tanggal,kode_akun,dc,nilai,keterangan,case when dc='D' then nilai else 0 end as debet,case when dc='C' then nilai else 0 end as kredit,kode_curr,date_format(tanggal,'%d/%m/%Y') as tgl
							from kas_j
							where kode_lokasi='$row->kode_lokasi' and kode_akun='$row->kode_akun' $sql2
							)a 
