...
class server_report_saku2_kopeg_sju_rptGlLabaRugiOperasiJejer extends server_report_basic
{
	...
	function getHtml()
	{
		...
		if ($kode_lokasi2=="")
		{
			...
			$sql="call sp_produk_jejer_sju 'FS7','L','S','1','$periode','$kode_lokasi','$nik_user' ";
		$rs = $dbLib->execute($sql);		
