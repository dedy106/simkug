...
class server_report_saku2_kopeg_sju_rptAggPdptCabang extends server_report_basic
{
  ...
  <tr align='center' bgcolor='#dbeef3'>
    ...
    <td width='40' class='header_laporan'>3/4</td>
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			...
			$sql = "select b.kode_klp,a.kode_cust,c.nama,sum(n1) as n1,sum(n2) as n2,sum(n3) as n3,sum(n4) as n4 
from sju_pdpt_cab a
...
group by b.kode_klp,a.kode_cust,c.nama
