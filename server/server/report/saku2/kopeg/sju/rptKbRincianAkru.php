...
class server_report_saku2_kopeg_sju_rptKbRincianAkru extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$kode_lokasi=$tmp[0];
		$periode=$tmp[1];
		$sql="select a.no_bill as no_bukti,a.keterangan,a.tanggal,a.kode_lokasi,date_format(a.tanggal,'%d/%m/%Y') as tgl,c.nama as nama_lokasi
		from sju_bill_m a
