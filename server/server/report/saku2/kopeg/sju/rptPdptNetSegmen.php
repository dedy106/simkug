...
class server_report_saku2_kopeg_sju_rptPdptNetSegmen extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="exec sp_dw_produksi_net_segmen '$kode_lokasi','$kode_segmen','$periode','$nik_user';";
