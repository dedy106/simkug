...
class server_report_saku2_kopeg_sju_rptHutangKartu extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode=$tmp[0];
		$kode_lokasi=$tmp[1];
		$sql="select a.kode_vendor,a.nama,ISNULL(b.premi,0) as debet,ISNULL(c.premi,0) as kredit,
...
from sju_vendor a
left join (select a.kode_vendor,a.kode_lokasi,sum((a.premi*a.kurs)) as premi
...
order by a.kode_vendor";
		...
		echo $AddOnLib->judul_laporan("kartu hutang",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
		echo "<table border='1' cellspacing='0' cellpadding='0' class='kotak' >
   <tr bgcolor='#CCCCCC'>
     <td width='30'  align='center' class='header_laporan'>No</td>
     <td width='250'  align='center' class='header_laporan'>Penanggung</td>
