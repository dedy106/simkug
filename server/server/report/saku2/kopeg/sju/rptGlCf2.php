...
class server_report_saku2_kopeg_sju_rptGlCf2 extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="exec sp_neraca_cf2 '$kode_lokasi','00','04','FS1','$periode','$periode_rev','$nik_user'";
  ...
  <tr>
    <td  class='lokasi_laporan2' align='center'>LAPORAN ARUS KAS METODE TIDAK LANGSUNG</td>
  </tr>
  <tr>
