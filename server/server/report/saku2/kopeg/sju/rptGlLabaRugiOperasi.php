...
class server_report_saku2_kopeg_sju_rptGlLabaRugiOperasi extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="call sp_produk_sju 'FS7','L','S','1','$periode','$periode_rev','$kode_lokasi','$kode_lokasi','$kode_lokasi2','$nik_user' ";
