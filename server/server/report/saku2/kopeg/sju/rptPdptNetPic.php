...
class server_report_saku2_kopeg_sju_rptPdptNetPic extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="exec sp_dw_produksi_pic_net '$kode_lokasi','$periode','$nik_user';";
  ...
  <tr>
    <td><table border='1' cellspacing='0' cellpadding='0' class='kotak'>
      <tr align='center' bgcolor='#dbeef3'>
        ...
        <td colspan='4' rowspan='3' class='header_laporan'>JENIS ASURANSI</td>
...
where a.kode_lokasi='$kode_lokasi' ";
        ...
        <td colspan='12' class='header_laporan'>$row->kode_klp - $row->nama</td>
			...
			$sql="select a.kode_lokasi,a.kode_cust,a.kode_pic,b.nama as nama_cust,c.nama as nama_pic,n1,n2,n3*-1 as n3,n4 as n4,n5,a.n6,a.n7
from dw_produksi_pic a
