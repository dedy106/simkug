...
class server_report_saku2_kopeg_sju_rptGlLabaRugiPasarJejer extends server_report_basic
{
	...
	function getHtml()
	{
		...
		if ($kode_lokasi2=="")
		{
			...
			$sql="call sp_produk_jejer_sju 'FS6','L','S','1','$periode','$kode_lokasi','$nik_user' ";
		$rs = $dbLib->execute($sql);		
		...
		echo $AddOnLib->judul_laporan("REALISASI BEBAN PEMASARAN DAN UNDERWRITING","PT SARANA JANESIA UTAMA","Periode ".$AddOnLib->ubah_periode($periode));
