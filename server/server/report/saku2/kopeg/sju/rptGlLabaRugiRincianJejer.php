...
class server_report_saku2_kopeg_sju_rptGlLabaRugiRincianJejer extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="call sp_neraca_jejer_sju '$kode_fs','L','S','1','$periode','$kode_lokasi','$nik_user' ";
  ...
  <tr>
    <td class='lokasi_laporan' align='center'>Per $bulan $tahun</td>
  </tr>
