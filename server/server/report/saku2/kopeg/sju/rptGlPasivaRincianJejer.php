...
class server_report_saku2_kopeg_sju_rptGlPasivaRincianJejer extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="call sp_produk_jejer_sju '$kode_fs','N','S','1','$periode','$kode_lokasi','$nik_user' ";
		
		$rs = $dbLib->execute($sql);		
		$sql = "select a.kode_lokasi,a.kode_neraca,a.nama,a.n1*-1 as n1,a.n2*-1 as n2,a.n3*-1 as n3,a.n4*-1 as n4,a.n5*-1 as n5 ,(a.n1+a.n2+a.n3+a.n4+a.n5)*-1 as n6,a.level_spasi,a.tipe
