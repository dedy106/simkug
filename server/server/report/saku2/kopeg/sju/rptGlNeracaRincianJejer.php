...
class server_report_saku2_kopeg_sju_rptGlNeracaRincianJejer extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="exec sp_produk_jejer_sju '$kode_fs','N','S','1','$periode','$kode_lokasi','$nik_user' ";
