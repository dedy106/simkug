...
class server_report_saku2_kopeg_sju_rptGlPasivaRincianKonsol extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="call sp_produk_konsol_sju 'FS3','N','S','1','$periode','$periode_rev','$kode_lokasi','$kode_lokasi','$kode_lokasi2','$nik_user' ";
