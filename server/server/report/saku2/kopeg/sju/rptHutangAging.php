...
class server_report_saku2_kopeg_sju_rptHutangAging extends server_report_basic
{
...
$this->filter and isnull(g.no_kashut,'-')='-'
order by d.kode_tipe,a.no_polis ";
		...
		echo $AddOnLib->judul_laporan("aging hutang",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
   ...
   <tr bgcolor='#CCCCCC'>
	 ...
	 <td width='150' rowspan='2' align='center' class='header_laporan'>Penanggung</td>
