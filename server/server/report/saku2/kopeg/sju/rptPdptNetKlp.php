...
class server_report_saku2_kopeg_sju_rptPdptNetKlp extends server_report_basic
{
  ...
  <tr>
    <td align='center'><table width='1000' border='0' cellspacing='2' cellpadding='1'>
      ...
      <tr>
        <td align='center' class='lokasi_laporan2'>PENDAPATAN USAHA KELOMPOK CUSTOMER S/D BULAN $bulan $tahun (NET)</td>
      </tr>
      <tr>
  ...
  <tr>
    <td><table border='1' cellspacing='0' cellpadding='0' class='kotak'>
      <tr align='center' bgcolor='#dbeef3'>
		...
		<td width='100' rowspan='3' class='header_laporan'>REALISASI SD $bulan $tahun_rev</td>
 ...
 ";
			...
			while ($row1 = $rs1->FetchNextObject($toupper=false))
			{
			  ...
			  echo "<tr>
				...
				<td class='isi_laporan' align='right'>".number_format($row1->n5-$row1->n6,0,',','.')."</td>
      ...
      echo "<tr>
		...
		<td class='isi_laporan' align='right'>".number_format($n3-$n5,2,',','.')."</td>
		<td class='isi_laporan' align='right'>".number_format($n5-$n6,2,',','.')."</td>
      ...
      echo "<tr>
		...
		<td class='isi_laporan' align='right'>".number_format($sum_n5-$sum_n6,2,',','.')."</td>
		<td class='isi_laporan' align='right'>".number_format($persen1,2,',','.')."</td>
		<td class='isi_laporan' align='center'>".number_format($persen2,2,',','.')."</td>
		<td class='isi_laporan' align='center'>".number_format($persen3,2,',','.')."</td>
		<td class='isi_laporan' align='center'>".number_format($persen4,2,',','.')."</td>
