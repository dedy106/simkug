...
class server_report_saku2_kopeg_sju_rptGlNeraca extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="exec sp_neraca_sju '$kode_fs','N','K','1','$periode','$periode_rev','$kode_lokasi','$kode_lokasi','$kode_lokasi2','$nik_user' ";
