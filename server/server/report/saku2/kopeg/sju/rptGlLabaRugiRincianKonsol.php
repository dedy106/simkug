...
class server_report_saku2_kopeg_sju_rptGlLabaRugiRincianKonsol extends server_report_basic
{
	...
	function getHtml()
	{
		...
		if ($kode_lokasi2=="")
		{
			...
			if ($kode_lokasi=="04") {$cabang="KANTOR SOLO";};
		}
		if ($kode_lokasi2=="")
		{
		...
		$sql="call sp_produk_konsol_sju '$kode_fs','L','S','1','$periode','$periode_rev','$kode_lokasi','$kode_lokasi','$kode_lokasi2','$nik_user' ";
