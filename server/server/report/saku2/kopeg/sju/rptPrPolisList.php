...
class server_report_saku2_kopeg_sju_rptPrPolisList extends server_report_basic
{
  ...
  <tr>
    <td><table  border='1' cellpadding='0' cellspacing='0' class='kotak' width='2700'>
      ...
      <tr bgcolor='#dbeef3' align='center'>
		...
		$sql="select  a.no_bill,a.kode_lokasi,a.no_polis,c.nama as nama_cust,d.no_dok,d.no_dok2,e.nama as nama_vendor,f.nama as nama_pic,a.no_bill,d.kode_pic,d.kode_tipe,
		...
		d.no_placing,date_format(a.due_date,'%d/%m/%Y') as due_date,h.kode_klp,j.no_quo, d.no_polisseb
from sju_polis_termin a
inner join sju_polis_m d on a.no_polis=d.no_polis and a.kode_lokasi=d.kode_lokasi
left join sju_bill_m b on a.no_bill=b.no_bill and a.kode_lokasi=b.kode_lokasi
