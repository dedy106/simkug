...
class server_report_saku2_kopeg_sju_rptGlJurnalProduksi extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.no_bukti,a.jenis,b.nama,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.nik_user,a.no_dokumen,
			...
			a.kode_cust,a.kode_vendor,a.kode_proyek,c.nama as nama_cust,d.nama as nama_vendor
		from gldt_tmp a 
