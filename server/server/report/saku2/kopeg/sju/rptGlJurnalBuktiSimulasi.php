...
class server_report_saku2_kopeg_sju_rptGlJurnalBuktiSimulasi extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode2=$tmp[3];
		$dokumen=$tmp[5];
		$sql="select a.no_bukti,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.periode,a.kode_lokasi
		from dw_bukti_gl a 
		$this->filter 
		order by a.no_bukti ";
		$rs = $dbLib->execute($sql);		
  ...
  <tr>
    <td><table width='800' border='1' cellspacing='0' cellpadding='0' class='kotak'>
	 ...
	 $sql1="select a.kode_akun,b.nama as nama_akun,a.nilai,a.keterangan,isnull(a.debet,0) as debet,isnull(a.kredit,0) as kredit,a.kode_curr,a.no_dokumen
					  from (select a.kode_lokasi,a.no_dokumen,a.kode_akun,a.dc,a.nilai,a.keterangan,case when a.dc='D' then a.nilai else 0 end as debet,case when a.dc='C' then a.nilai else 0 end as kredit,a.kode_curr
							from gldt_tmp a
