...
class server_report_saku2_kopeg_proyek_rptProyekPanjarSaldo extends server_report_basic
{
...
$this->filter";
	...
	function getHtml()
	{
		...
		$sql="select a.no_aju,date_format(a.tanggal,'%d/%m/%Y') as tgl_panjar,a.keterangan,a.kode_pp,b.nama as nama_pp,a.nilai,
	   ...
	   i.no_aju as no_ptg,i.no_kas as no_kasptg,i.no_ver as no_verptg,i.no_fiat as no_fiatptg,i.nilai as nilai_ptg,j.nilai as nilai_kas,i.progress,j.jenis,a.nilai-isnull(i.nilai,0) as saldo
from it_aju_m a
inner join pr_beban_d b on a.no_aju=b.no_aju and a.kode_lokasi=b.kode_lokasi
...
$this->filter order by a.no_aju";
  ...
  <tr bgcolor='#CCCCCC'>
    ...
    <td colspan='8' align='center' class='header_laporan'>Pertanggungjawaban</td>
  </tr>
  <tr bgcolor='#CCCCCC'>
