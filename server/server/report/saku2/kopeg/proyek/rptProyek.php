...
class server_report_saku2_kopeg_proyek_rptProyek extends server_report_basic
{
...
inner join pp c on a.kode_pp=c.kode_pp and a.kode_lokasi=c.kode_lokasi $this->filter";
	...
	function getHtml()
	{
		...
		$periode=$tmp[0];
		$nama_cab=$tmp[1];
		$sql="select a.no_proyek,a.no_dokumen,a.kode_cust,b.nama as nama_cust,a.nilai,a.nilai_ppn,a.persen_or,a.nilai_or,a.keterangan,a.uraian,a.jenis,
...
$this->filter order by a.no_proyek";
   ...
   <tr bgcolor='#CCCCCC'>
	 ...
	 <td width='90'  align='center' class='header_laporan'>Nilai OR</td>
		...
		$nilai=0; $nilai_ppn=0; $total=0; $nilai_or=0;
	 ...
	 <td class='isi_laporan'>$row->uraian</td>
