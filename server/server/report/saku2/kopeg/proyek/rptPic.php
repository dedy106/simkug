...
class server_report_saku2_kopeg_proyek_rptPic extends server_report_basic
{
...
$this->filter";
	...
	function getHtml()
	{
		...
		$periode=$tmp[0];
		$nama_cab=$tmp[1];
		$sql="select a.kode_pic, a.nama, a.alamat, a.no_tel, a.email, a.npwp,a.alamat2,a.status
from pr_pic a
$this->filter order by a.kode_pic";
		...
		echo $AddOnLib->judul_laporan("data pic",$this->lokasi,"");
		echo "<table border='1' cellspacing='0' cellpadding='0' class='kotak'>
   <tr bgcolor='#CCCCCC'>
     <td width='30'  align='center' class='header_laporan'>No</td>
     <td width='80'  align='center' class='header_laporan'>Kode</td>
	  <td width='200'  align='center' class='header_laporan'>Nama PIC</td>
