...
class server_report_saku2_kopeg_proyek_rptProyekBmhdSaldo extends server_report_basic
{
...
$this->filter order by a.no_aju";
		...
		echo $AddOnLib->judul_laporan("Saldo BHMD proyek",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
