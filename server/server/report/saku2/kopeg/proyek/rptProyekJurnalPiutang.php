...
class server_report_saku2_kopeg_proyek_rptProyekJurnalPiutang extends server_report_basic
{
...
from pr_piutang_m a $this->filter ";
	...
	function getHtml()
	{
		...
		$sql="select a.no_piutang,a.no_dokumen,a.kode_lokasi,a.periode,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tanggal1,a.keterangan,a.kode_lokasi,
