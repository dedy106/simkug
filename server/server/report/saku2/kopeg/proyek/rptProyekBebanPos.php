...
class server_report_saku2_kopeg_proyek_rptProyekBebanPos extends server_report_basic
{
...
$this->filter";
	...
	function getHtml()
	{
		...
		$sql="select a.no_aju,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.kode_pp,i.nama as nama_pp,a.nilai,
