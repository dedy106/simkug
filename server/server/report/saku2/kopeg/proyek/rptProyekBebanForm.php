...
class server_report_saku2_kopeg_proyek_rptProyekBebanForm extends server_report_basic
{
...
$this->filter";
	...
	function getHtml()
	{
		...
		d.no_proyek,e.keterangan
from it_aju_m a
inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi
inner join masakun c on a.kode_akun=c.kode_akun and a.kode_lokasi=c.kode_lokasi
inner join pr_beban_d d on a.no_aju=d.no_aju and a.kode_lokasi=d.kode_lokasi
inner join pr_proyek_m e on d.no_proyek=e.no_proyek and d.kode_lokasi=e.kode_lokasi
