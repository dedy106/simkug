...
class server_report_saku2_kopeg_proyek_rptVendor extends server_report_basic
{
...
$this->filter order by a.kode_vendor";
		...
		echo $AddOnLib->judul_laporan("data penanggung",$this->lokasi,"");
		echo "<table border='1' cellspacing='0' cellpadding='0' class='kotak'>
   <tr bgcolor='#CCCCCC'>
     <td width='30'  align='center' class='header_laporan'>No</td>
     <td width='50'  align='center' class='header_laporan'>Kode</td>
	  <td width='200'  align='center' class='header_laporan'>Nama Penanggung</td>
