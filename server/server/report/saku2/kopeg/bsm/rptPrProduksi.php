...
class server_report_saku2_kopeg_bsm_rptPrProduksi extends server_report_basic
{
  ...
  <tr>
    <td><table  border='1' cellpadding='0' cellspacing='0' class='kotak' width='1800'>
	  ...
	  <tr bgcolor='#dbeef3' align='center'>
	   ...
	   a.total,a.p_premi,a.n_premi,a.p_fee,a.n_fee,a.ppn,a.pph,date_format(a.tanggal,'%d/%m/%Y') as tgl_polis,a.objek,a.kode_tipe,a.p_cost+a.materai as biaya_adm
from bsm_polis_m a
...
order by a.kode_cust ";
			...
			$tot_pph+=$pph;
      echo "<tr>
        <td colspan='11' align='center' class='header_laporan'>Jumlah</td>
