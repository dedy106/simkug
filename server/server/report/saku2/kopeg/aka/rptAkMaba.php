...
class server_report_saku2_kopeg_aka_rptAkMaba extends server_report_basic
{	
	function getTotalPage()
	{
		global $dbLib;
		$sql="select count(a.no_tes) 
			from aka_maba a 
	...
	{
		global $dbLib;
		$sql="select a.no_tes, a.nama, a.kode_jur, b.nama as nama_jur,a.kode_jalur,c.nama as nama_jalur
			from aka_maba a 
			inner join aka_jurusan b on a.kode_jur=b.kode_jur and a.kode_lokasi=b.kode_lokasi
			inner join aka_mabajalur c on a.kode_jalur=c.kode_jalur and a.kode_lokasi=c.kode_lokasi $this->filter
  ...
  <tr bgcolor='#CCCCCC'>
    ...
    <td width='60' align='center' class='header_laporan'>no_tes</td>
    ...
    <td width='50' align='center' class='header_laporan'>Kode Jalur</td>
	<td width='100' align='center' class='header_laporan'>Nama Jalur</td>
   </tr>";
