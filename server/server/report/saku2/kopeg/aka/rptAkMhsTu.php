...
class server_report_saku2_kopeg_aka_rptAkMhsTu extends server_report_basic
{	
	...
	{
		global $dbLib;
		$sql="select a.nim, a.nama,a.kode_fakultas,c.nama as nama_fakultas,a.kode_jur, b.nama as nama_jur,a.kode_akt, a.kode_jalur, a.flag_status,a.flag_bea 
			from aka_mahasiswa a 
			inner join aka_jurusan b on a.kode_jur=b.kode_jur and a.kode_lokasi=b.kode_lokasi
			inner join aka_fakultas c on a.kode_fakultas=c.kode_fakultas and a.kode_lokasi=c.kode_lokasi $this->filter
			order by a.nim ";
  ...
  <tr bgcolor='#CCCCCC'>
    <td width='30' align='center' class='header_laporan'>No</td>
	 <td width='50' align='center' class='header_laporan'>Kode Fakultas</td>
