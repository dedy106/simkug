...
class server_report_saku2_kopeg_aka_rptAkBillBatalJurnalTu extends server_report_basic
{
	function getTotalPage()
	{
		...
		$periode=$tmp[2];
		$filter2=$tmp[3];
		$sql="select count(a.no_batal) as jum
from aka_batal_m a $this->filter ";
	...
	function getHtml()
	{
		...
		$sql="select a.no_batal,a.no_dokumen,a.kode_lokasi,a.periode,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tanggal1,a.keterangan,a.kode_lokasi
from aka_batal_m a $this->filter ";
