...
class server_report_saku2_kopeg_aka_rptAkBillJurnalBeaTu extends server_report_basic
{
...
from aka_bill_m a $this->filter ";
	  ...
	  $sql1="select a.kode_akun,b.nama,a.keterangan,a.kode_pp,a.kode_drk,case dc when 'D' then nilai else 0 end as debet,case dc when 'C' then nilai else 0 end as kredit  
			...
			where a.no_bill='$row->no_bill' and a.kode_lokasi='$row->kode_lokasi' and a.modul='BEA'
			order by a.dc desc ";
		//error_log($sql1);
