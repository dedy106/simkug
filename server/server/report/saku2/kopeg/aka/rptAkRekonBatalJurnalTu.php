...
class server_report_saku2_kopeg_aka_rptAkRekonBatalJurnalTu extends server_report_basic
{
	function getTotalPage()
	{
		...
		$periode=$tmp[2];
		$filter2=$tmp[3];
		$sql="select count(a.no_rekon) as jum
from aka_rekon_m a $this->filter ";
...
from aka_rekon_m a $this->filter ";
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			echo "<table border='0' cellspacing='2' cellpadding='1'>
			  <tr>
				<td align='center' class='header_laporan'>JURNAL PEMBATALAN REKON TAGIHAN</td>
			  </tr>
			  <tr>
