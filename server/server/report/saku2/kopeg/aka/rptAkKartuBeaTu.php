...
class server_report_saku2_kopeg_aka_rptAkKartuBeaTu extends server_report_basic
{	
...
order by a.nim ";
		...
		echo $AddOnLib->judul_laporan("kartu beasiswa mahasiswa",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
