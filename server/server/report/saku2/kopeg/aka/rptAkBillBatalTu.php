...
class server_report_saku2_kopeg_aka_rptAkBillBatalTu extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		$sql="select a.no_batal,a.keterangan,b.nim,c.nama,c.kode_jur,d.nama as nama_jur,c.kode_fakultas,e.nama as nama_fakultas,
