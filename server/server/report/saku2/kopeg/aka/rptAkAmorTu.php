...
class server_report_saku2_kopeg_aka_rptAkAmorTu extends server_report_basic
{	
...
order by b.nim
 ...
 ";
		...
		echo $AddOnLib->judul_laporan("Amortisasi Tagihan",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
