...
class server_report_saku2_kopeg_panjar_rptPjSpbForm extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode=$tmp[2];
		$filter2=$tmp[3];
		$sql="select a.no_panjar,date_format(a.tanggal,'%d/%m/%Y') as tanggal,a.kode_lokasi,a.keterangan,a.nik_buat,a.nik_setuju,c.nama as nama_buat,d.nama as nama_setuju,
    ...
    <td><table width='100%'  border='0' cellspacing='2' cellpadding='1'>
      ...
      <tr>
        <td><table width='100%'  border='1' cellspacing='0' cellpadding='0' class='kotak'>
          ...
          <tr>
            <td width='230' align='center'>Fiatur </td>
            <td width='155' rowspan='4'>&nbsp;</td>
            <td width='230' align='center'>Mengetahui,<br></td>
            <td width='155' rowspan='4'>&nbsp;</td>
            <td width='230' align='center'>Verifikasi</td>
          </tr>
          <tr>
            <td align='center'>jab<br></td>
