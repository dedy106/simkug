...
class server_report_saku2_csm_rptHutangSaldo extends server_report_basic
{
...
$this->filter";
	...
	function getHtml()
	{
	   ...
	   isnull(c.nilai_kas,0) as nilai_kas,
	   a.nilai-isnull(c.nilai_kas,0) as saldo,c.ket_kas
from csm_hutang_m a
inner join csm_vendor b on a.kode_vendor=b.kode_vendor and a.kode_lokasi=b.kode_lokasi 
left join (select no_hutang,kode_lokasi,sum(nilai) as nilai_kas,
