...
class server_report_saku2_csm_rptPiutangSaldo extends server_report_basic
{
...
$this->filter";
	...
	function getHtml()
	{
	   ...
	   isnull(c.nilai,0) as nilai_kas,a.nilai+a.nilai_ppn-isnull(c.nilai,0) as saldo,c.ket_kas
from csm_piutang_m a
inner join csm_cust b on a.kode_cust=b.kode_cust and a.kode_lokasi=b.kode_lokasi 
