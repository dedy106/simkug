...
class server_report_saku2_kpa_rptPjPtg extends server_report_basic
{
...
left join itt_panjarptg_m c on a.no_ptg=c.no_ptg and a.kode_lokasi=c.kode_lokasi
$this->filter ";
	...
	function getHtml()
	{
		...
		$sql="select a.no_ptg,a.no_panjar,a.no_km,a.no_kk,a.nik_buat,b.nama,a.kode_pp,c.nama as nama_pp,a.keterangan,date_format(a.tanggal,'%d/%m/%Y') as tgl_panjar,
		a.nilai,a.nilai_pj,a.nilai_kas
from itt_panjarptg_m a
inner join karyawan b on a.nik_buat=b.nik and a.kode_lokasi=b.kode_lokasi
...
$this->filter order by a.no_ptg";
  ...
  <tr bgcolor='#CCCCCC'>
	...
	<td width='100' align='center' class='header_laporan'>No KasBank Masuk</td>
	<td width='100' align='center' class='header_laporan'>No KasBank Keluar / Final</td>
    ...
    <td class='isi_laporan' align='center'>$i</td>
	 ...
	 <td class='isi_laporan'>$row->no_km</td>
	 <td class='isi_laporan'>$row->no_kk</td>
    ...
    <td class='isi_laporan' align='right'>".number_format($row->nilai_pj,0,",",".")."</td>
	 <td class='isi_laporan' align='right'>".number_format($row->nilai,0,",",".")."</td>
	  <td class='isi_laporan' align='right'>".number_format($row->nilai_kas,0,",",".")."</td>
		...
		echo "<tr>
    <td class='isi_laporan' align='right' colspan='11'>Total</td>
