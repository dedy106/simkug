...
class server_report_saku2_kpa_rptPjJurnal extends server_report_basic
{
...
order by a.periode,a.no_ptg,a.dc desc ";
		...
		echo $AddOnLib->judul_laporan("JURNAL pertanggungan panjar",$this->lokasi,"Periode ".$AddOnLib->ubah_periode($periode));
