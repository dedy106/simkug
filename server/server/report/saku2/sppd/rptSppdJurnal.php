...
class server_report_saku2_sppd_rptSppdJurnal extends server_report_basic
{
...
order by a.periode,a.no_kas,a.dc desc ";
		...
		echo $AddOnLib->judul_laporan("LAPORAN JURNAL perjalanan dinas",$this->lokasi,"Periode ".$AddOnLib->ubah_periode($periode));
