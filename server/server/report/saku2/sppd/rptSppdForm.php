...
class server_report_saku2_sppd_rptSppdForm extends server_report_basic
{	
...
inner join karyawan d on a.nik_app=d.nik  $this->filter";
	...
	function getHtml()
	{
       ...
       datepart(year,a.tanggal) as tahun,a.tanggal,a.kode_pp,a.nik_gar,e.nama as nama_nikgar,a.akun_uhar,
       a.nik_buat,a.nama_spj as nama_buat,a.keterangan,b.nama as nama_pp,a.nik_app,d.nama as nama_app,
	   c.jabatan,a.transport,a.harian,a.transport+a.harian as total,a.kode_lokasi,c.grade,f.nama as lokasi,a.akun_uhar,
	   f.kota
from yk_spj_m a
inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi
inner join karyawan c on a.nik_buat=c.nik 
...
where a.no_spj='$row->no_spj' ";
      ...
      <tr>
        <td><table width='100%'  border='0' cellspacing='2' cellpadding='1'>
          ...
          <tr>
            <td><u>$row->nama_nikgar</u></td>
            <td><u>$row->nama_app</u></td>
            <td><u>$row->nama_buat</u></td>
          </tr>
          <tr>
            <td>NIK.$row->nik_gar </td>
