...
class server_report_saku2_sppd_rptSppdSp extends server_report_basic
{	
...
inner join karyawan d on a.nik_app=d.nik and a.kode_lokasi=d.kode_lokasi $this->filter";
	...
	function getHtml()
	{
       ...
       datepart(year,a.tanggal) as tahun,a.tanggal,a.kode_pp,a.nik_gar,e.nama as nama_nikgar,datepart(day,a.tanggal) as tgl,
       a.nik_buat,c.nama,a.keterangan,b.nama as nama_pp,a.nik_app,d.nama as nama_app,
	   c.jabatan,a.transport,a.harian,a.transport+a.harian as total,a.kode_lokasi,a.keterangan,'-' as dasar,c.jabatan,c.grade,f.nama as lokasi,
...
inner join karyawan e on a.nik_gar=e.nik and a.kode_lokasi=e.kode_lokasi
inner join karyawan i on a.nik_perintah=i.nik and a.kode_lokasi=i.kode_lokasi
...
$this->filter order by a.no_spj";
  ...
  <tr>
	...
	<tr align='center'>
        <td colspan='2' class='judul_form'>NOMOR : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/ PS330/YAKES/2012 </td>
  </tr>
</table></td>
  </tr>
 <tr>
