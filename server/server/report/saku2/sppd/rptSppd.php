...
class server_report_saku2_sppd_rptSppd extends server_report_basic
{
...
$this->filter";
	...
	function getHtml()
	{
		...
		b.kode_pp,b.nama as nama_pp,a.transport,a.harian,a.transport+a.harian as nilai,a.nama_spj
from yk_spj_m a
inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi
...
$this->filter order by a.no_spj";
		...
		echo $AddOnLib->judul_laporan("pengajuan perjalanan dinas",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
