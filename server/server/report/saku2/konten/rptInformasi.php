...
class server_report_saku2_konten_rptInformasi extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		$tmp=explode("/",$this->filter2);
		$nama_ver=$tmp[0];
		$sql="select no_konten,tanggal,judul,keterangan,file_gambar from konten $this->filter ";
