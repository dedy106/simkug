...
class server_report_saku2_tk_rptPiutang extends server_report_basic
{
...
$this->filter";
	...
	function getHtml()
	{
		...
		$periode=$tmp[0];
		$nama_cab=$tmp[1];
		$sql="select a.no_piutang,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,
		a.nilai,a.kode_siswa,b.nama as nama_siswa
from tk_piutang_m a
inner join tk_siswa b on a.kode_siswa=b.kode_siswa and a.kode_lokasi=b.kode_lokasi 
$this->filter order by a.no_piutang";
   ...
   <tr bgcolor='#CCCCCC'>
     ...
     <td width='200'  align='center' class='header_laporan'>Nama Siswa</td>
