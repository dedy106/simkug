...
class server_report_saku2_siaga_rptLRAgg extends server_report_basic
{
...
order by rowindex ";
  ...
  <tr bgcolor='#CCCCCC'>
    ...
    <td colspan='2' class='header_laporan'><div align='center'>RKA</div></td>
  ...
  <tr bgcolor='#CCCCCC'>
    ...
    <td width='100' class='header_laporan'><div align='center'>S/D Bulan Ini </div></td>
    <td class='header_laporan'><div align='center'>4/2</div></td>
    <td class='header_laporan'><div align='center'>4/3</div></td>
  </tr>
  <tr bgcolor='#CCCCCC'>
   ...
   <td class='header_laporan'><div align='center'>3</div></td>
    ...
    <td height='23' class='isi_laporan'><div align='right'>";
			...
			{
				echo "<a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenGar('$row->kode_neraca','$row->kode_lokasi','$tahun');\">$n1</a>";
			}
			else
			{
				echo "$n1";
    ...
    <td class='isi_laporan'><div align='right'>";
			...
			{
				echo "<a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenTb('$row->kode_neraca','$row->kode_lokasi','$periode');\">$n4</a>";
			}
			else
			{
				echo "$n4";
    ...
    <td class='isi_laporan'><div align='right'>";
			...
			{
				echo "<a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenTb('$row->kode_neraca','$row->kode_lokasi','$periode');\">$n5</a>";
			}
			else
			{
				echo "$n5";
