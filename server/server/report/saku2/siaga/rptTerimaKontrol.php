...
class server_report_saku2_siaga_rptTerimaKontrol extends server_report_basic
{
...
$this->filter";
	...
	function getHtml()
	{
		...
		$sql="select a.no_terima,a.kode_lokasi,a.no_dokumen,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.atensi,a.kode_pp,b.nama as nama_pp,a.nilai,
...
$this->filter order by a.no_terima";
		...
		echo $AddOnLib->judul_laporan("kontrol penerimaan",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
   ...
   <tr bgcolor='#CCCCCC'>
     ...
     <td class='isi_laporan'>";
		echo "<a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenBukti('$row->no_terima','$row->kode_lokasi');\">$row->no_terima</a>";
		echo "</td>
