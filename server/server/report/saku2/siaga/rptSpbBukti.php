...
class server_report_saku2_siaga_rptSpbBukti extends server_report_basic
{
...
inner join karyawan b on a.nik_buat=b.nik $this->filter ";
	...
	function getHtml()
	{
		...
		$nama_user=$tmp[0];
		$sql = "select a.no_spb as no_kas,a.keterangan,b.nama,b.nama as ref1,'Jakarta' as kota,tanggal,date_format(a.tanggal,'%d/%m/%Y') as tgl,
		a.nilai,a.kurs,a.nilai,a.nilai as nilai_curr,d.nama as nama_curr,a.kode_curr
from gr_spb_m a
