...
class server_report_saku2_siaga_rptHutangAging extends server_report_basic
{
...
from gr_hutang_m a
inner join gr_vendor b on a.kode_vendor=b.kode_vendor and a.kode_lokasi=b.kode_lokasi 
left join (select a.no_hutang,a.kode_lokasi,sum(a.nilai_lain+a.nilai_kas) as nilai_kas,
				  dbo.fnGetBuktiKasHutang(no_hutang) as ket_kas
	       from gr_hutangbayar_d a
