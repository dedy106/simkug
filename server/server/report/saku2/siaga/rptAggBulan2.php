...
class server_report_saku2_siaga_rptAggBulan2 extends server_report_basic
{
  ...
  from (select x.modul,x.kode_lokasi,x.kode_akun
        from anggaran_d x
        inner join masakun y on x.kode_akun=y.kode_akun and x.kode_lokasi=y.kode_lokasi $this->filter
        group by x.modul,x.kode_lokasi,x.kode_akun) a
  inner join masakun b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi
  left join (select x.modul,x.kode_lokasi,x.kode_akun
             ...
             from anggaran_d x
	           inner join masakun y on x.kode_akun=y.kode_akun and x.kode_lokasi=y.kode_lokasi $this->filter
             group by x.modul,x.kode_lokasi,x.kode_akun) e on a.kode_akun=e.kode_akun and a.kode_lokasi=e.kode_lokasi
