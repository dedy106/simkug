...
class server_report_saku2_siaga_rptBuktiBeban extends server_report_basic
{
...
inner join karyawan b on a.nik_buat=b.nik $this->filter ";
	...
	function getHtml()
	{
		...
		$nama_user=$tmp[0];
		$sql = "select a.no_beban as no_kas,a.keterangan,b.nama,a.atensi as ref1,'Jakarta' as kota,tanggal,date_format(a.tanggal,'%d/%m/%Y') as tgl,
