...
class server_report_saku2_siaga_rptPjSaldo extends server_report_basic
{
...
$this->filter ";
	...
	function getHtml()
	{
		...
		date_format(d.tanggal,'%d/%m/%Y') as tgl_cair
from gr_panjar_m a
inner join karyawan b on a.nik_buat=b.nik and a.kode_lokasi=b.kode_lokasi
left join gr_panjarptg_m c on a.no_panjar=c.no_panjar and a.kode_lokasi=c.kode_lokasi
...
$this->filter order by a.no_panjar";
  ...
  <tr bgcolor='#CCCCCC'>
    ...
    <td colspan='3' align='center' class='header_laporan'>Pencairan</td>
