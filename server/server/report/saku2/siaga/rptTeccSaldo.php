...
class server_report_saku2_siaga_rptTeccSaldo extends server_report_basic
{
...
$this->filter";
	...
	function getHtml()
	{
	   ...
	   b.total-isnull(c.nilai_kas,0) as saldo,dbo.fnGetBuktiKasTecc(b.no_invoice,$periode) as ket_kas
from gr_tecc_m a
inner join gr_tecc_d b on a.no_tecc=b.no_tecc and a.kode_lokasi=b.kode_lokasi
