...
class server_report_saku2_siaga_rptSvcTrail extends server_report_basic
{
...
from gr_svc_m a
inner join gr_svc_d b on a.no_svc=b.no_svc and a.kode_lokasi=b.kode_lokasi $this->filter ";
		...
		echo $AddOnLib->judul_laporan("pembayaran tagihan svc",$this->lokasi,"");
