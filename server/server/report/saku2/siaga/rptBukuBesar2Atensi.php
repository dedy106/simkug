...
class server_report_saku2_siaga_rptBukuBesar2Atensi extends server_report_basic
{
...
order by a.kode_akun";
   ...
   <tr >
    <td height='23' colspan='7' style='padding:5px'><table  border='0' cellspacing='2' cellpadding='1'>
                    <tr>
  ...
  <tr bgcolor='#CCCCCC'>
	...
	<td width='200' height='23' class='header_laporan' align='center'>Atensi</td>
    ...
    <td width='90' class='header_laporan' align='center'>Balance</td>
	   ...
	   dbo.fnGetAtensi(a.no_bukti,a.modul) as atensi
from (select a.kode_lokasi,a.no_bukti,a.no_dokumen,a.periode,a.tanggal,a.kode_akun,a.kode_pp,a.kode_drk,a.dc,a.nilai,a.keterangan,a.modul 
	  ...
	  where a.kode_lokasi='$row->kode_lokasi' and substring(a.periode,1,4)=substring('$periode',1,4) and a.kode_akun='$row->kode_akun'  $this->filter
			...
			while ($row1 = $rs1->FetchNextObject($toupper=false))
			{
				...
				echo "</td>
	<td valign='top' class='isi_laporan'>".$row1->atensi."</td>
