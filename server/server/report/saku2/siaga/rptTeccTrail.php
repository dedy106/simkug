...
class server_report_saku2_siaga_rptTeccTrail extends server_report_basic
{
...
from gr_tecc_m a
inner join gr_tecc_d b on a.no_tecc=b.no_tecc and a.kode_lokasi=b.kode_lokasi $this->filter ";
