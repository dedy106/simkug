...
class server_report_saku2_siaga_rptVccCabang extends server_report_basic
{
...
left join (select a.kode_cabang,sum(c.nilai_kas) as nilai_kas
		   from gr_vcc_m a
		   inner join gr_vcc_d b on a.no_vcc=b.no_vcc and a.kode_lokasi=b.kode_lokasi
		   inner join gr_vccbayar_d c on c.no_invoice=b.no_invoice and b.kode_lokasi=c.kode_lokasi
		   group by a.kode_cabang
