...
class server_report_saku2_gar_rptAggRkapJejer extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql = "select kode_neraca,kode_fs,kode_lokasi,nama,tipe,level_spasi,
					...
					case jenis_akun when  'Pendapatan' then -(n1+n2+n3+n4+n5+n6+n7) else (n1+n2+n3+n4+n5+n6+n7) end as total
			from neraca_tmp 
