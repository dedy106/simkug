...
class server_report_saku2_gar_rptAggCapai2 extends server_report_basic
{
...
<td class='isi_laporan'>$row->nama_drk</td>
    <td class='isi_laporan' align='right'>";
			echo "".number_format($row->n1,0,',','.')."";
			echo "</td>
    <td class='isi_laporan' align='right'>";
			echo "".number_format($row->n2,0,',','.')."";
			echo "</td>
    <td class='isi_laporan'><div align='right'>";
			echo "".number_format($row->n3,0,',','.')."";
			echo "</td>
    <td class='isi_laporan'><div align='right'>";
			echo "".number_format($row->n4,0,',','.')."";
			echo "</td>
