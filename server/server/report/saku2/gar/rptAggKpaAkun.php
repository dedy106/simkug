...
class server_report_saku2_gar_rptAggKpaAkun extends server_report_basic
{
...
";	
			...
			{
				$sql="select a.no_bukti,a.no_dokumen,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.kode_akun,a.keterangan,a.kode_lokasi,a.periode,
