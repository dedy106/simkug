...
class server_report_saku2_gar_rptAggKpaAkunYks2 extends server_report_basic
{
...
select * from gldt where kode_lokasi='$row->kode_lokasi' and substring(periode,1,4)='$tahun' and kode_akun='$row->kode_akun' ".$kode_pp.$kode_drk.$periode." ) ";
			...
			$i = 1;
			echo "<tr>
	   <td height='23' colspan='8' valign='top' class='header_laporan' align='right'>ANGGARAN TRIWULAN I&nbsp;</td>
	   <td valign='top' class='header_laporan' align='right'>".number_format($row->tw1,0,',','.')."</td>
		...
		<td valign='top' class='isi_laporan' align='right'>".number_format($tw1,0,',','.')."</td>
	  </tr>";
				$i=$i+1;
			}
			echo "<tr>
...
select * from gldt where kode_lokasi='$row->kode_lokasi' and substring(periode,1,4)='$tahun' and kode_akun='$row->kode_akun' ".$kode_pp.$kode_drk.$periode." ) ";
			...
			$i = 1;
			echo "<tr>
	   <td height='23' colspan='8' valign='top' class='header_laporan' align='right'>ANGGARAN TRIWULAN II&nbsp;</td>
...
select * from gldt where kode_lokasi='$row->kode_lokasi' and substring(periode,1,4)='$tahun' and kode_akun='$row->kode_akun' ".$kode_pp.$kode_drk.$periode." ) ";
			...
			$i = 1;
			echo "<tr>
	   <td height='23' colspan='8' valign='top' class='header_laporan' align='right'>ANGGARAN TRIWULAN IV&nbsp;</td>
