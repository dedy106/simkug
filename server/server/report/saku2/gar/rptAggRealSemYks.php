...
class server_report_saku2_gar_rptAggRealSemYks extends server_report_basic
{
	...
	function getHtml()
	{
		...
		echo "<table width='1300' border='1' cellpadding='0' cellspacing='0' bordercolor='#111111' class='kotak'>
<tr>
