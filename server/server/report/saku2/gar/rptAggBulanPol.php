...
class server_report_saku2_gar_rptAggBulanPol extends server_report_basic
{
  ...
  inner join drk d on a.kode_drk=d.kode_drk and d.tahun='$tahun' and a.kode_lokasi=d.kode_lokasi";
	...
	function getHtml()
	{
		...
		$sql=" select a.kode_akun,a.kode_pp,a.kode_drk,b.nama as nama_akun,c.nama as nama_pp,d.nama as nama_drk,a.kode_lokasi,
...
<td width='90' class='header_laporan'><div align='center'>September</div></td>
  ...
  echo "<a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenGar('$row->kode_akun','$row->kode_lokasi','$tahun','$row->kode_pp','$row->kode_drk');\">".$row->nama_drk."</a>";
			echo "</td>
