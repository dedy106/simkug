...
class server_report_saku2_gar_rptAggCapaiYks extends server_report_basic
{
    ...
    <tr bgcolor='#CCCCCC'>
      ...
      <td width='70' rowspan='2' class='header_laporan'><div align='center'>Kode PP </div></td>
<td width='120' rowspan='2' class='header_laporan'><div align='center'>Nama PP </div></td>
      <td width='50' rowspan='2' class='header_laporan'><div align='center'>Kode DRK</div></td>
...
<td class='isi_laporan'>$row->nama_drk</td>
    <td class='isi_laporan' align='right'>";
			...
			echo "</td>
    <td class='isi_laporan' align='right'>";
			echo "<a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenGar('$row->kode_akun','$row->kode_lokasi','$row->tahun','$row->kode_pp','$row->kode_drk');\">".number_format($row->n2,0,',','.')."</a>";
			echo "</td>
    <td class='isi_laporan'><div align='right'>";
			echo "<a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenKartu('$row->kode_akun','$row->kode_lokasi','$row->tahun','$row->kode_pp','$row->kode_drk');\">".number_format($row->n3,0,',','.')."</a>";
			echo "</td>
    <td class='isi_laporan'><div align='right'>";
