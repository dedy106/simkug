...
class server_report_saku2_distro_rptBuktiBank extends server_report_basic
{
...
inner join karyawan b on a.nik_buat=b.nik $this->filter ";
	...
	function getHtml()
	{
		...
		$alamat=$row->alamat;
		$sql = "select a.no_kas,a.keterangan,b.nama,a.ref1,a.no_link,tanggal,date_format(a.tanggal,'%d/%m/%Y') as tgl,
		a.nilai,a.kurs,a.nilai as nilai_curr,a.nilai*a.kurs as nilai,d.nama as nama_curr
from kas_m a
