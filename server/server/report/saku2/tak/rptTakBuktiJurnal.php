...
class server_report_saku2_tak_rptTakBuktiJurnal extends server_report_basic
{
...
left join karyawan c on a.nik_setuju=c.nik and a.kode_lokasi=c.kode_lokasi ".$filter2;
		}
		else
		{
...
inner join lokasi d on a.kode_lokasi=d.kode_lokasi
left join karyawan b on a.nik_buat=b.nik and a.kode_lokasi=b.kode_lokasi
left join karyawan c on a.nik_setuju=c.nik and a.kode_lokasi=c.kode_lokasi ".$filter3;
		}
	...
	function getHtml()
	{
		...
		if ($modul=="TAK Kirim")
		{
			$sql="select a.no_kirim as no_bukti,a.no_dokumen,a.kode_lokasi,a.periode,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tanggal1,a.keterangan,a.kode_lokasi,
		...
		{
			$sql="select a.no_terima as no_bukti,a.no_dokumen,a.kode_lokasi,a.periode,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tanggal1,a.keterangan,a.kode_lokasi,
				   a.nik_buat,b.nama as nama_buat,b.jabatan as jabatan_buat,a.nik_setuju,c.nama as nama_setuju,c.jabatan as jabatan_setuju,d.kota
			from takterima_m a
			inner join lokasi d on a.kode_lokasi=d.kode_lokasi
			left join karyawan b on a.nik_buat=b.nik and a.kode_lokasi=b.kode_lokasi
		...
		if ($modul=="TAK Kirim")
		{
			$sql1="select a.kode_akun,b.nama,a.keterangan,a.kode_pp,a.kode_drk,a.modul,case dc when 'D' then nilai else 0 end as debet,case dc when 'C' then nilai else 0 end as kredit  
			from takkirim_j a
			inner join masakun b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi
			where a.no_kirim='$row->no_bukti' and a.kode_lokasi='$row->kode_lokasi'
			order by a.no_urut ";
		}
		else
		{
			...
			from takterima_j a
			inner join masakun b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi
			where a.no_terima='$row->no_bukti' and a.kode_lokasi='$row->kode_lokasi'
			order by a.no_urut ";
		}
		//error_log($sql1);
  ...
  <tr>
	...
	function doPrintHeader($sender, $page){		
		...
		$sender->Cell(10,5,"",'L',0,'C');$sender->Cell(30,5,"No Bukti",0,0,'l');$sender->Cell(5,5,":",0,0,'C');$sender->Cell($w-  55,5,$sender->row->no_bukti,'R',1,'L');
