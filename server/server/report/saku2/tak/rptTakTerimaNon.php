...
class server_report_saku2_tak_rptTakTerimaNon extends server_report_basic
{
...
inner join lokasi b on a.kode_lokkirim=b.kode_lokasi $this->filter";
	...
	function getHtml()
	{
		...
		$tmp=explode("/",$this->filter2);
		$periode=$tmp[0];
		$sql="select a.no_rekon,a.no_dokumen,date_format(a.tanggal,'%d/%m/%Y') as tanggal,a.kode_lokasi,b.nama as nama_lokasi,a.keterangan
from yk_rekon_m a
...
order by a.no_rekon";
      ...
      <tr>
        ...
        <td width='379' class='header_laporan'>: $row->no_rekon </td>
      </tr>
      <tr>
...
where a.no_rekon='$row->no_rekon' order by a.kode_akun";
