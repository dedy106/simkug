...
class server_report_saku2_tak_rptTakTerima extends server_report_basic
{
...
inner join lokasi b on a.kode_lokkirim=b.kode_lokasi $this->filter";
	...
	function getHtml()
	{
		...
		$tmp=explode("/",$this->filter2);
		$periode=$tmp[0];
		$sql="select a.no_terima,a.no_dokumen,date_format(a.tanggal,'%d/%m/%Y') as tanggal,a.kode_lokkirim,b.nama as nama_lokasi,a.no_kirim,a.keterangan
from takterima_m a
inner join lokasi b on a.kode_lokkirim=b.kode_lokasi $this->filter
