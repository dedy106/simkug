...
class server_report_saku2_kb_rptKbDropingTerima extends server_report_basic
{
...
order by a.no_kas ";
      ...
      <tr align='center' bgcolor='#CCCCCC'>
        ...
        <td width='80' class='header_laporan'>No Kas Kirim</td>
        <td width='60' class='header_laporan'>Tgl Kirim</td>
      </tr>";
	  $sql1="select a.kode_loktuj,a.akun_tak,b.nama as nama_akun,a.keterangan,a.nilai,a.no_kas,date_format(c.tanggal,'%d/%m/%Y') as tgl_terima
from yk_kasdrop_d a
...
where a.no_kasterima='$row->no_kas' order by a.kode_loktuj";
