...
a.nik_tahu, upper(d.nama) as nama_buat,upper(e.nama) as nama_tahu,e.jabatan as jab_tahu,
'-' as nama_setuju,f.nama as nama_bdh,i.nama as nama_manbdh, d.jabatan as jab_buat,
e.jabatan as jab_tahu,'-' as jab_setuju,'-' as jab_bdh,'-' as jab_manbdh ,f.flag as nik_bdh,i.flag as nik_manbdh,
f.keterangan as jab_bdh,i.keterangan as jab_manbdh
from yk_ifptg_m a 
inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi 
inner join lokasi c on a.kode_lokasi=c.kode_lokasi 
inner join karyawan d on a.nik_buat=d.nik and a.kode_lokasi=b.kode_lokasi 
...
$this->filter order by a.no_ifptg";
  ...
  <tr>
    <td align='left'><table border='1' cellspacing='0' cellpadding='0' class='kotak'>
	  ...
	  $sql1="select date_format(a.tgl_kuitansi,'%d/%m/%Y') as tanggal,a.keterangan,a.dc,a.nilai,a.kode_pp,a.kode_akun,a.kode_drk,b.nama as bidang
from yk_ifptg_j a
inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi
  ...
  <tr>
    <td align='right'><table border='0' cellspacing='0' cellpadding='0'>
      ...
      <tr align='center'>
        ...
        <td class='header_form'>$row->jab_tahu</td>
      ...
      <tr align='center'>
        <td class='header_form'>$row->jab_manbdh</td>
        <td class='header_form'>$row->jab_bdh</td>
        <td class='header_form'>PEMEGANG PANJAR</td>
      </tr>
      <tr>
        <td height='60'>&nbsp;</td>
