...
class server_report_saku2_kb_rptSpbForm extends server_report_basic
{
...
$this->filter";
	...
	function getHtml()
	{
		...
		$periode=$tmp[0];
		$nama_cab=$tmp[1];
		$sql="select a.kode_lokasi,a.no_spb,a.no_dokumen,a.keterangan,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.due_date,a.keterangan,e.nama as vendor,a.kode_pp,b.nama as nama_pp,a.nilai,
		a.nik_buat,a.nik_app,c.nama as nama_buat,d.nama as nama_app,f.kota	
from yk_spb_m a
inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi
...
$this->filter order by a.no_spb";
  ...
  <tr align='center'>
    <td height='30'>PERMOHONAN PEMBAYARAN</td>
  </tr>
  <tr>
    <td><table width='800' border='0' cellspacing='2' cellpadding='1'>
        <tr>
          <td align='center'>Nomor : $row->no_spb</td>
        </tr>
