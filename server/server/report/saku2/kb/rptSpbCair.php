...
class server_report_saku2_kb_rptSpbCair extends server_report_basic
{
...
from kas_m a
inner join yk_spb_m b on a.no_kas=b.no_kas and a.kode_lokasi=b.kode_lokasi
...
$this->filter";
	...
	function getHtml()
	{
		...
		$periode=$tmp[0];
		$nama_cab=$tmp[1];
		$sql="select a.no_kas,a.no_dokumen,date_format(a.tanggal,'%d/%m/%Y') as tgl_kas,a.keterangan,b.no_spb,
		date_format(b.tanggal,'%d/%m/%Y') as tgl_kpa,d.nama as vendor,b.kode_pp,c.nama as nama_pp,b.nilai
from kas_m a
inner join yk_spb_m b on a.no_kas=b.no_kas and a.kode_lokasi=b.kode_lokasi
inner join pp c on c.kode_pp=b.kode_pp and c.kode_lokasi=b.kode_lokasi
inner join vendor d on b.kode_vendor=d.kode_vendor and b.kode_lokasi=d.kode_lokasi
$this->filter order by a.no_kas";
		...
		echo $AddOnLib->judul_laporan("pembayaran permohonan pembayaran",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
