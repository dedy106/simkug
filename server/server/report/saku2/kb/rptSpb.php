...
class server_report_saku2_kb_rptSpb extends server_report_basic
{
...
$this->filter";
	...
	function getHtml()
	{
		...
		$sql="select a.no_spb,a.kode_lokasi,a.no_dokumen,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.due_date,a.keterangan,c.nama as vendor,a.kode_pp,b.nama as nama_pp,a.nilai
from yk_spb_m a
inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi
inner join vendor c on a.kode_vendor=c.kode_vendor and a.kode_lokasi=c.kode_lokasi
$this->filter order by a.no_spb";
		...
		echo $AddOnLib->judul_laporan("pengajuan permohonan pembayaran",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
