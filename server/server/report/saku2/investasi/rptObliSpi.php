...
class server_report_saku2_investasi_rptObliSpi extends server_report_basic
{
...
$this->filter order by a.no_spi";
		...
		echo $AddOnLib->judul_laporan("spi obligasi",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
