...
class server_report_saku2_investasi_rptRekapAsset extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="exec sp_neraca_inv '$kode_lokasi','FS2','$periode','$nik_user'";
		...
		echo $AddOnLib->judul_laporan("KOMPOSISI BERDASARKAN ALOKASI ASET",$this->lokasi,"Periode ".$AddOnLib->ubah_periode($periode));
