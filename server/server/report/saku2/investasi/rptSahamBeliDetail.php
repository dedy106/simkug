...
class server_report_saku2_investasi_rptSahamBeliDetail extends server_report_basic
{
...
$this->filter order by a.no_shmbeli";
		...
		echo $AddOnLib->judul_laporan("laporan pembelian saham",$this->lokasi,$tahun);
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			echo "<table  border='1' cellspacing='0' cellpadding='0' class='kotak'>
  <tr>
    <td colspan='13' style='padding:5px'><table width='622' border='0' cellspacing='2' cellpadding='1'>
	
        <td width='110' class='header_laporan'>No Bukti</td>
        <td width='496' class='header_laporan'>:&nbsp;$row->no_shmbeli</td>
        </tr>
      <tr>
  ...
  <tr bgcolor='#CCCCCC'>
    ...
    <td width='60' align='center' class='header_laporan'>Jumlah Beli</td>
    <td width='90' align='center' class='header_laporan'>Nilai Pembelian</td>
...
<td width='90' align='center' class='header_laporan'>levi</td>
	  ...
	  $sql1="select a.komisi,a.vat,a.levi,a.pph,a.h_oleh,a.harga,a.jumlah,a.n_beli,c.jumlah as jml_saham,
	   a.kode_saham,a.kode_broker,b.nama as nama_saham,d.nama as nama_broker,d.nama as nama_saham
...
order by a.kode_saham ";
		...
		$i=1;
		$jml_saham=0;$n_beli=0;$komisi=0;$pph=0;$levi=0;$jumlah=0;
		while ($row1 = $rs1->FetchNextObject($toupper=false))
		{
			$jumlah=$jumlah+=$row1->jumlah;
			$n_beli=$n_beli+=$row1->n_beli;
    ...
    <td class='isi_laporan' align='right'>".number_format($row1->jml_saham,0,",",".")."</td>
	  ...
	  <td class='isi_laporan' align='right'>".number_format($row1->n_beli,0,",",".")."</td>
