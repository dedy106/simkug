...
class server_report_saku2_investasi_rptSahamDevidenSaldo extends server_report_basic
{
...
left join (select b.kode_kelola,a.kode_saham,
		...
		from  inv_shmdev_m a
		inner join  inv_shmdev_d b on a.no_shmdev=b.no_shmdev
		where substring(a.periode,1,4)='$tahun'
		group by b.kode_kelola,a.kode_saham
