...
class server_report_saku2_investasi_rptSahamSpi extends server_report_basic
{
...
$this->filter ";
	...
	function getHtml()
	{
		...
		$periode=$tmp[0];
		$nama_cab=$tmp[1];
		$sql="select a.no_spi,date_format(a.tanggal,'%d/%m/%Y') as tanggal,a.keterangan,b.kode_saham,d.nama as nama_saham,b.kode_kelola,c.nama as nama_kelola,
	   b.jumlah,b.h_oleh,b.h_buku,b.h_wajar
from inv_shmspi_m a
inner join inv_shmspi_d b on a.no_spi=b.no_spi
inner join inv_kelola c on b.kode_kelola=b.kode_kelola
inner join inv_saham d on b.kode_saham=d.kode_saham
$this->filter order by a.no_spi";
		...
		echo $AddOnLib->judul_laporan("spi saham",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
