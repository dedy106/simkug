...
class server_report_saku2_investasi_rptDocKkp extends server_report_basic
{
...
$this->filter ";
	...
	function getHtml()
	{
	   ...
	   b.nama as nama_bank,a.kode_bank,c.nilai-c.pajak_akru as nilai_akru,c.nilai_cair,c.pajak_akru,c.nilai_hitung,c.pajak_hitung,c.nilai as gross_akru,
...
$this->filter $tgl order by a.no_depo";
		...
		echo $AddOnLib->judul_laporan("kkp deposito",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
