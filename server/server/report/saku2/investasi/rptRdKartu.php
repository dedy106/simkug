...
class server_report_saku2_investasi_rptRdKartu extends server_report_basic
{
...
inner join inv_rd d on c.kode_rd=d.kode_rd
 order by a.no_rdbeli";
		...
		echo $AddOnLib->judul_laporan("kartu reksadana",$this->lokasi,"");
  ...
  <tr >
    <td height='23' colspan='7' class='header_laporan'><table  border='0' cellspacing='2' cellpadding='1'>
      <tr>
        ...
        <td width='360' class='header_laporan'>: $row->no_rdbeli</td>
      </tr>
	   <tr>
      ...
      <tr>
        ...
        <td class='header_laporan'>: $row->kode_rd - $row->nama_rd</td>
      </tr>
	  <tr>
  ...
  ";
			...
			$sql="select a.no_spi as no_bukti,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,b.kode_rd,b.kode_rdkelola,
	   b.jumlah,b.h_oleh,b.h_buku,b.h_wajar
from inv_rdspi_m a
inner join inv_rdspi_d b on a.no_spi=b.no_spi
where b.kode_rd='$row->kode_rd'";
