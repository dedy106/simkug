...
class server_report_saku2_investasi_rptPsSaldo extends server_report_basic
{
...
$this->filter order by a.no_ps";
		...
		echo $AddOnLib->judul_laporan("saldo penyertaan saham",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
