...
class server_report_saku2_investasi_rptRdJualDetail extends server_report_basic
{
...
from inv_rdjual_m a
inner join inv_rdkelola b on a.kode_rdkelola=b.kode_rdkelola ".$this->filter;
		error_log($sql);
