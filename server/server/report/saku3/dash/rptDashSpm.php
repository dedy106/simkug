...
class server_report_saku3_dash_rptDashSpm extends server_report_basic
{
	...
	function getHtml()
	{
        ...
        echo"       <div class='col-md-15 col-md-3'>
                        <div class='small-box bg-".$color[$i]."'>
                            ...
                            <div class='icon'><i class='fa ".$icon[$i]."'></i></div>
                                <a href='#' class='small-box-footer' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashSpmDet','','$kode_lokasi|$periode|all|$row->kode_grafik|$kode_pp|$nik|$row->nama|$kode_fs');\"> Detail <i class='fa fa-arrow-circle-right'></i></a>
                        </div>
                    </div>";
            $i++;
        }
            ...
            echo  "<div class='col-md-15 col-md-3'>
                <div class='small-box bg-aqua'>
                    ...
                    <div class='icon'><i class='fa fa-bank'></i></div>
                        <a href='#' class='small-box-footer' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashSpmDet','','$kode_lokasi|$periode|all|CR|$kode_pp|$nik|OR|$kode_fs');\"> Detail <i class='fa fa-arrow-circle-right'></i></a>
                </div>
            </div>";    
        // }
                    ...
                    <div class='col-md-12'>
                        <div >
                            ...
                            <table id='table-spm' width='100%' class='display' >
                                ...
                                where a.kode_lokasi='$kode_lokasi' and substring(a.periode,1,4)='".substr($periode,0,4)."' and b.kode_grafik in ('DB12') and a.kode_fs='$kode_fs'
        ...
        //     // alert('hello');
        //     window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashSpm','','$kode_lokasi/$periode/$nik/$kode_pp/$kode_fs/excel');
