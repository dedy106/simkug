...
class server_report_saku3_dash_rptDashTarbakDetail1 extends server_report_basic
{
		...
		echo "<div class='panel'>
               ...
               echo"<div class='row'>
                        ...
                        switch($kunci){
                           ...
                           select 'TW1' as kode,a.kode_lokasi,sum(case when substring(a.periode,5,2) in ('01','02','03') then a.nilai else 0 end) n1
                           from sis_rekon_d a 
                           where kode_lokasi='$kode_lokasi'  and substring(periode,1,4)='$tahunLalu'
                           group by a.kode_lokasi 
                           union all
                           select 'TW2' as kode,a.kode_lokasi,
                                   sum(case when substring(a.periode,5,2) in ('04','05','06') then a.nilai else 0 end) n1  
                        ...
                        point: {
                            events: {
                                click: function() {
                                    ...
                                    // alert(kd);                        
                                    window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashTarbakDetail','','$kode_lokasi|$periode|$nik|$kode_pp|$kode_fs|$jenis|$kunci|'+kd);
                                }
                            }
                        }
                    }
