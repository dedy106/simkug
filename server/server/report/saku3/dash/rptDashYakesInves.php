...
class server_report_saku3_dash_rptDashYakesInves extends server_report_basic
{
	...
	function getHtml()
	{
        ...
        <div class='panel' style=''>
            <div class='panel-heading' style='font-size:18px;padding:10px 0px 1px 20px'> 
                ...
                <br><span style='margin-top: -0.7rem; padding-left: 0.5rem; font-size: 1.2rem; color: #808080;position: relative;' id='tglChart'></span>
            ...
            <div class='panel-body'>
                <div class='row'>
                    ...
                    <div class='col-md-4 col-xs-4 pad-more' style='padding-right:10px !important'>
                            <div class='col-md-6 col-xs-6 pad-more'>
                                <div class='panel mar-mor box-wh' style='border-radius:15px'>
                                    <div class='panel-body' style='padding:7px;padding-bottom:50px'><center><p style='color: #808080;margin-top: 10px;margin-bottom: 0px;'>Total Return</p><p style='color: #808080;margin-top: 0px;margin-bottom: 5px;font-size:8px'>&nbsp;Year To Date</p></center>
                                    <br>
                                        <div class='col-md-12 col-xs-12'>
                                        <p style='color: #808080;margin-top: 0px;margin-bottom: 5px;font-size:10px'>&nbsp;Pendapatan</p>
                                        </div>
                                        <div class='col-md-4 col-xs-4'>
                                            <img src='".$group12."' style='width: 30px;'>
                                        </div>
                                        <div class='col-md-8 col-xs-8'>
                                            <h4 class='font-weight-bold;' id='totPend' style='margin-top: 5px;margin-bottom: 10px;font-size: 17px;'>NULL</h4>
                                        </div>
                                        ...
                                        <div class='col-md-4 col-xs-4'>
                                            <img src='".$group14."' style='width: 30px;'>
                                        </div>
                                        <div class='col-md-8 col-xs-8'>
                                            <h4 class='font-weight-bold;' id='totSPI' style='margin-top: 5px;margin-bottom: 10px;font-size: 17px;'>NULL</h4>
                                        </div>
                                        <div class='col-md-12 col-xs-12' style='margin-top:31px'>
                                        <p style='color: #808080;margin-top: 0px;margin-bottom: 5px;font-size:10px'>&nbsp;Beban Investasi</p>
                                        </div>
                                        <div class='col-md-4 col-xs-4'>
                                            <img src='".$group13."' style='width: 30px;'>
                                        </div>
                                        <div class='col-md-8 col-xs-8'>
                                            <h4 class='font-weight-bold;' id='totBeb' style='margin-top: 5px;margin-bottom: 10px;font-size: 17px;'>NULL</h4>
                                        </div>
                                        <div class='col-md-12 col-xs-12' style='margin-top:31px'>
                                        <p style='color: #808080;margin-top: 0px;margin-bottom: 5px;font-size:10px'>&nbsp;Hasil Net Investasi</p>
                                        </div>
                                        <div class='col-md-4 col-xs-4'>
                                            <img src='".$group15."' style='width: 30px;'>
                                        </div>
                                        <div class='col-md-8 col-xs-8'>
                                            <h4 class='font-weight-bold;' id='totNet' style='margin-top: 5px;margin-bottom: 10px;font-size: 17px;'>NULL</h4>
                                        </div>
                            ...
                            <div class='col-md-6 col-xs-6 pad-more'>
                                <div class='panel mar-mor box-wh' style='border-radius:15px'>
                                    <div class='panel-body' style='padding:7px'>
                                        ...
                                        <p style='color: #808080;margin-top: 0px;margin-bottom: 5px;font-size:8px' id='thnSebelum'></p></center>
                            ...
                            <div class='col-md-6 col-xs-6 pad-more' id='traceROI' style='cursor:pointer'>
                                <div class='panel mar-mor box-wh' style='border-radius:15px'>
                                    <div class='panel-body' style='padding:7px'>
                                        <center><p style='color: #808080;margin-top: 10px;margin-bottom: 0px;'>&nbsp;Estimasi ROI Total</p></center>
                                        <center><h2 class='font-weight-bold' id='totROI' style='margin-top: 5px;margin-bottom: 10px;'></h2></center>
                                    </div>
                                </div>
                            </div>
                            <div class='col-md-6 col-xs-6 pad-more'>
        ...
        <script>
            ...
            $('.panel-body').on('click','#traceROI',function(){
                ...
                window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashYakesInvesROI','','$kode_lokasi|$periode|$kode_pp|$nik|$kode_fs|'+filtertgl+'|'+plan+'|'+kode_klp);
            ...
            $('.panel-body').on('click','.traceROI',function(){
                ...
                window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashYakesInvesROI','','$kode_lokasi|$periode|$kode_pp|$nik|$kode_fs|'+filtertgl+'|'+plan+'|'+kode_klp+'|'+kelas);
                    ...
                    success:function(result){    
                        if(result.status){
                            switch(index){
                                            ...
                                            point:{
                                                events : {
                                                    ...
                                                    click: function() {
                                                        ...
                                                        var plan = $('#kode_plan').text();
                                                        var kode_klp = $('#kode_klp').text();
                                                        window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashYakesInvesDet','','$kode_lokasi|$periode|$kode_pp|$nik|$kode_fs|'+filtertgl+'|'+plan+'|'+kode_klp);
                                                    }
                                                }
                                            }
                                        }
                                ...
                                if(result.persen < 0) {
                                    $('#iconPoly').html('<img style=\'width: 20px;padding-top: 15px;\' src=\'$poly2\'>');
                                }else{
                                    $('#iconPoly').html('<img style=\'width: 20px;padding-top: 15px;\' src=\'$poly1\'>');
                                }
                                break;
                                case 'roiKKP' :
