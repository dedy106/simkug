...
class server_report_saku3_dash_rptDashTelDetail extends server_report_basic
{
		...
		echo "<div class='panel'>
				<div class='panel-body'>
                    <div class='panel-heading'>
                        <a href='#' class='small-box-footer' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashTelDetail1','','$kode_lokasi|$periode|$nik|$kode_pp|$kode_fs|$jenis|$kunci');\"> Back <i class='fa fa-arrow-circle-left'></i></a>
                    </div>";
               echo"<div class='row'>
                            ...
                            <div class='box-body'>
                                ...
                                <table class='table table-striped' id='tableini'>
                                    ...
                                    inner join (select a.nis,a.no_bill,a.kode_lokasi,
                                                ...
                                                from sis_bill_d a 
                                                where a.kode_lokasi='$kode_lokasi' and a.kode_pp='$kode_pp' and substring(a.periode,1,4)='".substr($periode,0,4)."' 
                                ...
                                echo  "<tr>
                                            <td >$i</td>
                                            <td >";
                                            echo "<a style='cursor:pointer;color:blue'   onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashTelDetail2','','$kode_lokasi|$periode|$nik|$kode_pp|$kode_fs|$jenis|$kunci|$row->no_bill|$row->nis');\">$row->no_bill</a>";
                                    echo   "</td>      
                                            <td >$row->nis</td> 
                                            <td >$row->nama</td> 
                                            <td >$row->kode_jur</td>
                            ...
                            <div class='box-body'>
                                ...
                                <table class='table table-striped' id='tableini'>
                                    ...
                                    inner join (select c.nis,a.no_rekon,c.kode_lokasi,a.kode_pp,
                                                ...
                                                from sis_cd_d a 
                                                inner join sis_siswa c on a.nis=c.nis and a.kode_lokasi=c.kode_lokasi and a.kode_pp=c.kode_pp
                                                where a.kode_lokasi='$kode_lokasi' and a.kode_pp='$kode_pp' and substring(a.periode,1,4)='".substr($periode,0,4)."'  and a.dc='D'
                                ...
                                echo  "<tr>
                                            <td >$i</td>
                                            <td >";
                                            echo "<a style='cursor:pointer;color:blue'   onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashTelDetail2','','$kode_lokasi|$periode|$nik|$kode_pp|$kode_fs|$jenis|$kunci|$row->no_rekon|$row->nis');\">$row->no_rekon</a>";
                                    echo   "</td> 
                                            <th >$row->nis</th>       
                                            <td >$row->nama</td> 
                                            <td >$row->kode_jur</td>
                            ...
                            <div class='box-body'>
                                ...
                                <table class='table table-striped' id='tableini'>
                                    ...
                                    inner join (select c.nis,a.no_rekon,c.kode_lokasi,a.kode_pp,
                                                ...
                                                from sis_rekon_d a 
                                                inner join sis_siswa c on a.nis=c.nis and a.kode_lokasi=c.kode_lokasi and a.kode_pp=c.kode_pp 
                                                where a.kode_lokasi='$kode_lokasi' and a.kode_pp='$kode_pp' and substring(a.periode,1,4)='".$tahunLalu."' 
                                                group by c.nis,a.no_rekon,c.kode_lokasi,a.kode_pp
                                                union all
                                                select c.nis,a.no_bukti as no_rekon,c.kode_lokasi,a.kode_pp,
                                                    sum(a.nilai) as total,sum(a.nilai) as pdd
                                                from sis_cd_d a 
                                                inner join sis_siswa c on a.nis=c.nis and a.kode_lokasi=c.kode_lokasi and a.kode_pp=c.kode_pp
                                                where a.kode_lokasi='$kode_lokasi' and a.kode_pp='$kode_pp' and substring(a.periode,1,4)='".$tahunLalu."'  and a.dc='D'
                                                group by c.nis,a.no_bukti,c.kode_lokasi,a.kode_pp
                                                )b on a.no_kas=b.no_rekon and a.kode_lokasi=b.kode_lokasi
                                    inner join sis_siswa c on b.nis=c.nis and b.kode_lokasi=c.kode_lokasi and b.kode_pp=c.kode_pp
                                    inner join sis_kelas e on c.kode_kelas=e.kode_kelas and c.kode_lokasi=e.kode_lokasi and c.kode_pp=e.kode_pp
