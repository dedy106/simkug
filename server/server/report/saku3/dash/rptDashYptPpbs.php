...
class server_report_saku3_dash_rptDashYptPpbs extends server_report_basic
{
	...
	function getHtml()
	{
        ...
        $_SESSION['userLog'] = "ppbs";
        $_SESSION['userPwd'] = "sai";
        ...
        <script>
            ...
            function initDash(){
                loadService('capex','GET','$root_ser/dashYptPpbs.php?fx=getPeriode2'); 
                loadService('pendapatan','GET','$root_ser/dashYptPpbs.php?fx=getPeriode2');   
                loadService('investasi','GET','$root_ser/dashYptPpbs.php?fx=getPeriode2');   
            }
