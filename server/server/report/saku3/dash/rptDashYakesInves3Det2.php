...
class server_report_saku3_dash_rptDashYakesInves3Det2 extends server_report_basic
{
	...
	function getHtml()
	{
                                ...
                                <div class='col-md-12 pad-more' style='height:270px;margin-bottom:25px'>
                                    <div class='panel mar-mor box-wh'>
                                        ...
                                        <div class='panel-body'>
                                            <div id='performa' style='margin: 0 auto; padding: 0 auto;height:400px'>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <script>
            ...
            $('.panel').on('click','.klik-chart2',function(){
                ...
                var param = '$kode_plan|5|$tglakhir|'+kode;
            ...
            function initDash(){
                ...
                switch(jenis_data){
                    case 'SH' :
                        ...
                        loadService('performa','GET','$root_ser/dashYakesInves.php?fx=getNABHari','$kode_plan|5|$tglakhir|BHN'); 
