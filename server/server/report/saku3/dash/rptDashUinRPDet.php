...
class server_report_saku3_dash_rptDashUinRPDet extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		$sql="select a.no_aju,substring(periode,1,4) as tahun,a.kode_lokasi,convert(varchar,a.tanggal,103) as tgl,a.keterangan,a.kode_pp,a.kdgiat,a.kddept,a.kdunit,a.kode_akun,i.nmakun,j.nama as nama_pp
        from uin_aju_m a
        inner join uin_akun i on a.kode_akun=i.kdakun
        inner join pp j on a.kode_pp=j.kode_pp and a.kode_lokasi=j.kode_lokasi
        where a.no_aju='$this->filter' and a.kddept='$kddept' and a.kdunit='$kdunit' and a.no_rekap='PDPT'
        order by a.no_aju ";
		...
		echo $AddOnLib->judul_laporan("Laporan Realisasi Pendapatan",$this->lokasi,"");
    ...
    <td colspan='34' style='padding:5px'><table width='100%' border='0' cellspacing='2' cellpadding='1'>
      ...
      <tr>
		...
		<tr>
          ...
          <td class='header_laporan'>:&nbsp;$row->kode_akun -&nbsp; $row->nmakun</td>
        </tr>
