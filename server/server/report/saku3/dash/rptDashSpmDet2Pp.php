...
class server_report_saku3_dash_rptDashSpmDet2Pp extends server_report_basic
{
	...
	function getHtml()
	{
		...
		echo "<div class='panel'>
				<div class='panel-body'>
                    <div class='panel-heading' id='panel-heading'>
                        <a href='#' class='small-box-footer' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashSpmDetPp','','$kode_lokasi|$periode|$jenis|$kunci|$kode_pp|$nik|$nama|$kode_fs');\"> Back <i class='fa fa-arrow-circle-left'></i></a>
                    </div>";
               echo"<div class='row'>
                        ...
                        switch($param){
                            ...
                            <div class='box-body'>
                                ...
                                <table class='table table-striped' id='table-nrcL'>
                                    ...
                                    $sql="select a.kode_akun,c.nama as nama_akun,a.so_awal,a.debet,a.kredit,a.so_akhir,a.kode_pp
                                    from exs_glma_pp a
                                    inner join relakun b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi
                                    inner join masakun c on a.kode_akun=c.kode_akun and a.kode_lokasi=c.kode_lokasi
                                    where a.kode_lokasi='$kode_lokasi' and a.kode_pp='$kode_pp' and b.kode_fs='$kode_fs' and a.kode_akun='$key' and a.periode='$periode' ";
                                 ...
                                 echo  "<tr>
                                            ...
                                            <td  >$row->kode_akun</td>
                                            <td height='20' >";
                                            echo "<a style='cursor:pointer;color:blue'   onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashSpmDet3Pp','','$kode_lokasi|$periode|$nik|$kode_pp|$jenis|$kunci|$nama|$param|$key|$row->kode_akun|$kode_fs');\">$row->nama_akun</a>";
                                    echo   "</td>   
											<td  >$row->kode_pp</td>
                        ...
                        case "NrcL" :
                            ...
                            <div class='box-body'>
                                ...
                                <table class='table table-striped' id='table-nrcB'>
                                    ...
                                    $sql="select tipe from exs_neraca_pp where kode_lokasi='$kode_lokasi' and kode_pp='$kode_pp' and  kode_neraca='$key' and kode_fs='$kode_fs' ";
                                    ...
                                    if($row1->tipe == 'Posting'){
                                        ...
                                        inner join relakun b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi
                                        inner join masakun c on a.kode_akun=c.kode_akun and a.kode_lokasi=c.kode_lokasi
                                        where a.kode_lokasi='$kode_lokasi' and a.kode_pp='$kode_pp' and b.kode_fs='$kode_fs' and b.kode_neraca='$key' and a.periode='$periode'  ";
                                        
                                    }else{
                                        $sql="select a.kode_akun,b.nama as nama_akun,a.so_awal,a.debet,a.kredit,a.so_akhir,a.kode_pp
                                        from exs_glma_pp a
                                        ...
                                        where a.kode_akun in (
                                                        ...
                                                        where a.periode='$periode' and a.kode_pp='$kode_pp' and a.kode_lokasi='$kode_lokasi' and a.kode_induk='$key' and a.tipe='Posting' 
                                                        and b.kode_fs='$kode_fs')
                                        and a.periode='$periode' and a.kode_lokasi='$kode_lokasi' and a.kode_pp='$kode_pp'  ";
                                    }
        ...
        <script type='text/javascript'>
            ...
            $('#exs-to-xls').click(function(){
                // alert('hello');
                window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashBangSpmDet2','','$kode_lokasi|$periode|$nik|$kode_pp|$jenis|$kunci|$nama|$param|$key|excel');
