...
class server_report_saku3_dash_rptDashGinasDet extends server_report_basic
{
	...
	function getHtml()
	{
        ...
        <div class='panel' style=''>
            <div class='panel-heading' style='font-size:18px;padding:10px 0px 1px 20px;background:#f6f6f6;'> 
                <div class='pull-right navigasi' style='margin-right: 10px;'>
                ...
                <div class='row invoice-info' style='background:#f6f6f6;margin-left:0px;margin-right:0px;margin-top:30px'>
                    <div class='col-sm-2 invoice-col'>
                        <address>
                            ...
                            $sql = "select distinct periode from brg_trans_d where kode_lokasi='$kode_lokasi' order by periode desc";
                            $rsper = $dbLib->execute($sql);
                    ...
                    <div class='col-sm-2 invoice-col'>
                        <address>
                            ...
                            <option value=''>Pilih Periode</option>";
                            $sql2 = "select distinct periode from brg_trans_d where kode_lokasi='$kode_lokasi' order by periode desc";
                            $rsper2 = $dbLib->execute($sql2);
            ...
            <div class='panel-body'>
                <div class='row'>
                    ...
                    <br>
                    <table class='table table-striped' style='width:80%' id='table-jual'>
            ...
            $('#bTampil').click(function(){
                ...
                loadService('lapPnj','GET','$root_ser/dashGinas.php?fx=getLapPnj',per1+'|'+per2+'|'+kode_klp+'|'+order_by);
            ...
            <div class='panel-body'>
                <div class='row'>
                    ...
                    <br>
                    <table class='table table-striped' style='width:80%' id='table-vendor'>
            ...
            $('#bTampil').click(function(){
                ...
                loadService('lapVendor','GET','$root_ser/dashGinas.php?fx=getLapVendor',order_by+'|'+vendor);
            ...
            <div class='panel-body'>
                <div class='row'>
                    ...
                    <br>
                    <table class='table table-striped' style='width:80%' id='table-stock'>
                        <thead class='bg-yellow'>
                            <tr>
                                <td>No</td>
                                <td>Tanggal</td>
            ...
            function getAkun(){
                $.ajax({
                    type: 'GET',
                    url: '$root_ser/dashGinas.php?fx=getAkun',
                    dataType: 'json',
            ...
            $('#bTampil').click(function(){
                ...
                loadService('getBukuBesar','GET','$root_ser/dashGinas.php?fx=getBukuBesar',akun+'|'+tgl1+'|'+tgl2);
            ...
            $('#isiBukuBesar').on('click','.viewJurnal',function(){
                ...
                loadService('getJurnal','GET','$root_ser/dashGinas.php?fx=getJurnal',no_bukti+'|'+tgl);
        ...
        <script>
            ...
            $('.navigasi').on('click','#close_btn',function(){
                window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashGinas','','$kode_lokasi/$periode/$kode_pp/$nik/$kode_fs');
            });
            ...
            switch($kunci){
                ...
                case "sellCtg" :
                echo"
                loadService('getBukuBesar','GET','$root_ser/dashGinas.php?fx=getBukuBesar'); 
                loadService('lapPnj','GET','$root_ser/dashGinas.php?fx=getLapPnj'); ";
                break;
                case "vendor":
                echo"
                loadService('lapVendor','GET','$root_ser/dashGinas.php?fx=getLapVendor');  ";
                break;
                case "missing":
                break;
                case "cash":
