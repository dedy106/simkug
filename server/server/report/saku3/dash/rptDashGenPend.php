...
class server_report_saku3_dash_rptDashGenPend extends server_report_basic
{
            ...
            <div class='col-md-12'>
                <div class='panel'>
                    <div class='panel-heading'>
                        ...
                        <h3 class='text-left' style='font-weight: bold'>Laporan Neraca Lajur (Pendapatan)</h3>
                    ...
                    <div class='panel-body'>
                        ...
                        <center><h4 style='font-weight: bold; color: #000000;'>Neraca Lajur Pendapatann</h4></center>
                        ...
                        <table class='table table-bordered'>
                            ...
                            <tbody>";
                                // $periode    = date('Y');
                                $kode_lokasi = '32';
                                // $pendapatan =$dbLib->execute("select a.kode_akun,b.nama, sum(a.so_awal*-1) 'so_awal', sum(a.debet*-1) 'debet', sum(a.kredit) 'kredit', 
                                //                     sum(a.so_akhir*-1) 'so_akhir' from exs_glma a
                                //                     inner join masakun b on a.kode_lokasi=b.kode_lokasi and a.kode_akun=b.kode_akun
                                //                     where a.kode_lokasi = '$kode_lokasi' and b.jenis = 'Pendapatan' and a.periode='$periode'
                                ...
                                case when a.so_akhir<0 then -so_akhir else 0 end as so_akhir_kredit
                                 ...
                                 where a.kode_lokasi='$kode_lokasi' and a.periode='$periode' and b.jenis='Pendapatan'
