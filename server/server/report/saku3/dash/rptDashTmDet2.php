...
class server_report_saku3_dash_rptDashTmDet2 extends server_report_basic
{
		...
		echo "<div class='panel'>
				<div class='panel-body'>
                    <div class='panel-heading' id='panel-heading'>
                        <a href='#' class='small-box-footer' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashTmDet','','$kode_lokasi|$periode|$jenis|$kunci|$kode_pp|$nik|$nama');\"> Back <i class='fa fa-arrow-circle-left'></i></a>
                    </div>";
               echo"<div class='row'>
                        ...
                        switch($param){
                            ...
                            <div class='box-body'>
                                ...
                                <table class='table table-striped' id='table-nrcL'>
                                    ...
                                    $sql="select distinct kode_fs from db_grafik_d where kode_lokasi='$kode_lokasi'  ";
                                    ...
                                    where a.kode_lokasi='$kode_lokasi' and b.kode_fs='$row1->kode_fs' and a.kode_akun='$key' and a.periode='$periode' ";
                                    // echo $sql;
                                 ...
                                 echo  "<tr>
                                            ...
                                            <td  >$row->kode_akun</td>
                                            <td height='20' >";
                                            echo "<a style='cursor:pointer;color:blue'   onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashTmDet3','','$kode_lokasi|$periode|$nik|$kode_pp|$jenis|$kunci|$nama|$param|$key|$row->kode_akun');\">$row->nama_akun</a>";
                                    echo   "</td>                            
