...
class server_report_saku3_dash_rptDashUinDetailV3User extends server_report_basic
{
	...
	function getHtml()
	{
		...
		echo "<div class='panel'>
				...
				<div class='panel-heading'>
					<a href='#' class='small-box-footer' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashUinV3User','','$kode_lokasi/$periode/$kode_pp');\"> Back <i class='fa fa-arrow-circle-left'></i></a>
				</div>";
		echo"<div class='row'>
                                ...
                                <table class='table no-margin' id='table-budget-realisasi'>
                                    ...
                                    if ($jenis=="all")
									{
                                        if($kunci=="BBlj" OR $kunci == "BPdpt"){
                                            ...
                                            where a.kode_lokasi='$kode_lokasi' and flag_aktif='1' and a.kode_pp='$kode_pp'";
