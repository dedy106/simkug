...
class server_report_saku3_dash_rptDashTkDet extends server_report_basic
{
	...
	function getHtml()
	{
        ...
        if($jenis =="all"){
            if(substr($nama,0,3) =="Kas"){
                ...
                where c.kode_lokasi='$kode_lokasi' and b.kode_fs='$kode_fs' and c.periode='$periode' and a.kode_grafik ='DB10' and c.kode_pp='$kode_pp' and c.so_akhir<>0
            ...
            if(substr($nama,0,3)=="Pen"){
                ...
                where b.kode_grafik in ('DB05','DB09') and b.kode_lokasi='$kode_lokasi' and e.periode='$periode' and e.n4 <> 0 and e.kode_pp='$kode_pp' and e.kode_fs='$kode_fs' ";
                ...
                where a.kode_lokasi='$kode_lokasi' and substring(a.periode,1,4)='".substr($periode,0,4)."' and b.kode_grafik in ('DB05') and a.kode_pp='$kode_pp' and a.kode_fs='$kode_fs'
                ...
                from exs_neraca_pp a
				inner join db_grafik_d b on a.kode_neraca=b.kode_neraca and a.kode_lokasi=b.kode_lokasi and a.kode_fs=b.kode_fs
                where a.kode_lokasi='$kode_lokasi' and substring(a.periode,1,4)='".substr($periode,0,4)."' and b.kode_grafik ='DB09' and a.kode_pp='$kode_pp' and a.kode_fs='$kode_fs'
                group by a.kode_lokasi";
            ...
            if(substr($nama,0,3)=="Beb"){
                ...
                inner join exs_neraca_pp e on b.kode_neraca=e.kode_neraca and b.kode_lokasi=e.kode_lokasi and b.kode_fs=e.kode_fs 
                where b.kode_grafik in ('DB06','DB07') and b.kode_lokasi='$kode_lokasi' and e.periode='$periode' and e.n4 <> 0 and e.kode_pp='$kode_pp' and e.kode_fs='$kode_fs'";
                ...
                from exs_neraca_pp a
				inner join db_grafik_d b on a.kode_neraca=b.kode_neraca and a.kode_lokasi=b.kode_lokasi and a.kode_fs=b.kode_fs 
                where a.kode_lokasi='$kode_lokasi' and substring(a.periode,1,4)='".substr($periode,0,4)."' and b.kode_grafik ='DB06' and a.kode_pp='$kode_pp' and a.kode_fs='$kode_fs'
                group by a.kode_lokasi";
                ...
                from exs_neraca_pp a
				inner join db_grafik_d b on a.kode_neraca=b.kode_neraca and a.kode_lokasi=b.kode_lokasi and a.kode_fs=b.kode_fs 
                where a.kode_lokasi='$kode_lokasi' and substring(a.periode,1,4)='".substr($periode,0,4)."' and b.kode_grafik ='DB07' and a.kode_pp='$kode_pp' and a.kode_fs='$kode_fs'
                group by a.kode_lokasi";
            ...
            if(substr($nama,0,3)=="Lab"){
                ...
                from exs_neraca_pp a
                inner join db_grafik_d b on a.kode_neraca=b.kode_neraca and a.kode_lokasi=b.kode_lokasi and a.kode_fs=b.kode_fs
                where a.kode_lokasi='$kode_lokasi' and substring(a.periode,1,4)='".substr($periode,0,4)."' and b.kode_grafik='DB04' and a.kode_pp='$kode_pp' and a.kode_fs='$kode_fs' --a.kode_neraca='10' 
                group by a.kode_lokasi";
            ...
            if(substr($nama,0,2)=="OR"){
                ...
                where a.kode_lokasi='$kode_lokasi' and b.periode='$periode' and b.kode_pp='$kode_pp' and b.kode_fs='$kode_fs' order by a.kode_rasio";
		...
		echo "<div class='panel'>
				...
				<div class='panel-heading'>
					<a href='#' class='small-box-footer' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashTk','','$kode_lokasi/$periode/$kode_pp/$nik/$kode_fs');\"> Back <i class='fa fa-arrow-circle-left'></i></a>
                </div>";
                    ...
                    point: {
                        events: {
                            click: function() {
                                ...
                                window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashTelDet2','','$kode_lokasi|$periode|$nik|$kode_pp|$jenis|$kunci|$nama|NrcKas|'+kd+'|$kode_fs');
                            }
                        }
                    }
                }
                        ...
                        point: {
                            events: {
                                click: function() {
                                    ...
                                    var kd= this.options.key;
                                    // alert(kd);                        
                                    window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashTelDet2','','$kode_lokasi|$periode|$nik|$kode_pp|$jenis|$kunci|$nama|NrcL|'+kd+'|$kode_fs');
                                }
                            }
                        }
                    }
