...
class server_report_saku3_dash_rptDashYakesPlanAsset  extends server_report_basic
{
	...
	function getHtml()
	{
        ...
        <div class='panel' style=''>
            ...
            white;'> 
                ...
                Plan Asset vs Kewajiban Aktuaria 2010-2019 <span id='jplan'></span></h3>
        ...
        <div id='mySidepanel' class='sidepanel close'>
            ...
            <a href='#' data-id='plan_aset' class='sidepanel-link' style='color:#4274FE'>Plan Aset vs Kewajiban Aktuaria</a>
        ...
        <script>
            ...
            $('.modal-body').on('click','#btnOk',function(){
                ...
                $.ajax({
                    ...
                    success:function(result){  
                        ...
                        if(result.status){
                            loadService('planAset','GET','$root_ser/dashYakesInves.php?fx=getPlanAset',filtertgl+'|'+plan+'|'+kode_klp);
                            ...
                            $.ajax({
                                ...
                                success:function(result){  
                                    ...
                                    if(result.status){
                                             ...
                                             loadService('planAset','GET','$root_ser/dashYakesInves.php?fx=getPlanAset',tglreverse+'|'+plan+'|'+kode_klp);
                                             $('aside').removeClass('control-sidebar-open');
                                             $('.tab-content').hide();
                                    }
                                }
                                ...
                                case 'planAset':
                                    ...
                                    Highcharts.chart('planAset', {
                                        ...
                                        tooltip: {
                                            ...
                                            //         content += e.entries[i].dataSeries.name + ' ' + '<strong>' + sepNum(e.entries[i].dataPoint.y) + '</strong>';
                                            //         content += '<br/>';
                                            //     }
                                            //     return content;
                                            // }
                                        ...
                                        //     color:'#66ff33',
                                        //     yAxis:1,
                                        //     data: [7.66,8.93,9.89,10.89,10.79,11.77,13.03,12.26,12.69,12.94,12.80],
                                        //     dataLabels: {
                                        //         color: 'black',
                                        //         verticalAlign:'top',
                                        //     }
                                        ...
                                        //     type: 'line',
                                        //     color:'red',
                                        //     data: [3704,3822,4317,4274,5227,4593,5297,6356,6194,6469,6359,6169,6012],
                                        //     dataLabels: {
                                        //         color: 'red'
                                        //     }
                                        // },{
                                        //     name: 'Kewajiban Aktuaria',
                                        //     type: 'line', 
                                        //     yAxis:1,
                                        //     color:'#4274FE',
                                        //     data: [8.01,10.55,13.16,10.65,11.50,10.94,13.34,14.20,13.50,12.42],
                                        //     dataLabels: {
                                        //         color: '#4274FE'
                                        //     }
                                        // }],
                                    ...
                                    for(var i=0;i<result.df.length;i++){
                                        html+=`<th style='vertical-align:middle;text-align:center'>`+sepNum(result.df[i])+`%</th>`;
                                    }
                                    html+=`</tr>`;
                                    ...
                                    for(var i=0;i<result.rkd.length;i++){
                                        html+=`<th style='vertical-align:middle;text-align:center'>`+sepNum(result.rkd[i])+`%</th>`;
                                    }
                                    html+=`</tr>`;
            ...
            function initDash(){ 
                loadService('planAset','GET','$root_ser/dashYakesInves.php?fx=getPlanAset','$tglakhir|$kode_plan|$kode_klp');
            }
