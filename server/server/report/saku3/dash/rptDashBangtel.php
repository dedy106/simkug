...
class server_report_saku3_dash_rptDashBangtel extends server_report_basic
{
	...
	function getHtml()
	{
		...
		echo "
		<div class='panel'>
            <div class='panel-heading' style='font-size:18px;padding:10px 0px 1px 20px'>Tes Dashboard Keuangan 
        ...
        echo"       <div class='col-md-15 col-md-3'>
                        <div class='small-box bg-".$color[$i]."'>
                            ...
                            <div class='icon'><i class='fa ".$icon[$i]."'></i></div>
                                <a href='#' class='small-box-footer' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashBangtelDet','','$kode_lokasi|$periode|all|$row->kode_grafik|$kode_pp|$nik|$row->nama');\"> Detail <i class='fa fa-arrow-circle-right'></i></a>
                        </div>
                    </div>";
            $i++;
        }
