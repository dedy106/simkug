...
class server_report_saku3_dash_rptDashSpmDet4Pp extends server_report_basic
{
		...
		echo "<div class='panel'>
				<div class='panel-body'>
                    <div class='panel-heading'>
                        <a href='#' class='small-box-footer' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashSpmDet3Pp','','$kode_lokasi|$periode|$nik|$kode_pp|$jenis|$kunci|$nama|$param|$key|$key2|$kode_fs');\"> Back <i class='fa fa-arrow-circle-left'></i></a>
                    </div>
                    <div class='col-md-12'>";
                        echo"
                        ...
                        <div class='box-body'>";
                            ...
                            where a.kode_lokasi='$kode_lokasi' and a.no_bukti='$key3' and a.kode_pp='$kode_pp'
                            union
                            ...
                            <div class='row'>
                                ...
                                <table class='table table-striped'>
                                    ...
                                    where a.kode_lokasi='$kode_lokasi' and a.no_bukti='$row->no_bukti' and a.kode_pp='$kode_pp'
									union all
