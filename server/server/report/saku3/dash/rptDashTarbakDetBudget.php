...
class server_report_saku3_dash_rptDashTarbakDetBudget extends server_report_basic
{
                                    ...
                                    <div class='card-body'>
                                        <div class='row'>
                                            <div class='col-md-12'>
                                                ...
                                                <div class='col-md-4'>
                                                    <div class='panel'>
                                                        <div class='panel-body' style='border:1px solid #d5d5d5;border-radius:10px;text-align: center;'>
                                                            <p style='margin-bottom: 0;font-size: 10px;'>Budget</p>
                                                            <h4 style='margin-top: 5px;'>990,10 JT</h4>
                                                            <p style='margin-bottom: 0;font-size: 10px;'>Actual</p>
                                                            <h4 style='margin-top: 5px;'>980,05 JT</h4>
                                                            <p style='margin-bottom: 0;font-size: 10px;'>Different</p>
                                                            <h4 style='margin-top: 5px;'>10,05 JT</h4>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>                                            
                                            <div class='col-md-12'>
                                                <h6 class='card-title' style='padding-left:10px; padding-top:10px;'>Budget YTD</h6>
                                                <div id='income-budget-ytd' style='min-width: 300px; height: 300px; margin: 0 auto'></div>
                                                </div>
                                                <div class='col-md-12'>
                                                <h6 class='card-title' style='padding-left:10px; padding-top:10px;'>RRA YTD</h6>
                            ...
                            <div class='col-md-6'>
                                <div class='card' >
                                    <div class='card-body'>
                                        <div class='row'>
                                            <div class='col-md-12'>
                                                <h4 class='card-title' style='padding-left:10px; padding-top:10px;'>Expense Budget Overview</h4>
                                                <h6 class='card-title' style='padding-left:10px; padding-top:10px;'>Budget Current Month</h6>
                                                <div class='col-md-8'>
                                                    <div id='expense-budget-month' style='min-width: 200px; height: 200px; margin: 10 auto'>
                                                    </div>
                                                </div>
                                                <div class='col-md-4'>
                                                    <div class='panel'>
                                            ...
                                            <div class='col-md-12'>
                                            <h6 class='card-title' style='padding-left:10px; padding-top:10px;'>Budget YTD</h6>
                                            <div id='expense-budget-ytd' style='min-width: 300px; height: 300px; margin: 0 auto'></div>
                                            </div>
                                            <div class='col-md-12'>
                                            <h6 class='card-title' style='padding-left:10px; padding-top:10px;'>RRA YTD</h6>
                                            <div id='expense-rra-ytd' style='min-width: 300px; height: 300px; margin: 0 auto'></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    if(result.status){
                        switch(index){
                            case 'income' :
                                ...
                                // Budget YTD
                                Highcharts.chart('income-budget-ytd', {
                                    chart: {
                                        type: 'column'
                                    },
                                    credits: {
                            ...
                            //Budget Current Month
                                ...
                                var chartSpeed = Highcharts.chart('expense-budget-month', Highcharts.merge(gaugeOptions, {
                                    yAxis: {
                                        min: 0,
                                        max: 100,
                                        title: {
                            ...
                            // Budget YTD
                            Highcharts.chart('expense-budget-ytd', {
                                chart: {
                                    type: 'column'
                                },
                                credits: {
                                ...
                                Highcharts.chart('expense-rra-ytd', {
                                    chart: {
                                        type: 'column'
                                    },
                                    credits: {
