...
class server_report_saku3_dash_rptDashTarbakLog extends server_report_basic
{
	...
	function getHtml()
	{
        ...
        echo   "<div class='row'>
                    <div class='col-md-15 col-md-3'>
                        <div class='small-box bg-yellow'>
                            ...
                            <a href='#' class='small-box-footer' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashTarbakLogDet','','$kode_lokasi/$periode/k1/0');\"> Detail <i class='fa fa-arrow-circle-right'></i></a>
                        </div>
                    </div>
                    <div class='col-md-15 col-md-3'>
                        <div class='small-box bg-blue'>
                            ...
                            <a href='#' class='small-box-footer' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashTarbakLogDet','','$kode_lokasi/$periode/k2/1');\"> Detail <i class='fa fa-arrow-circle-right'></i></a>
                        </div>
                    </div>
                    <div class='col-md-15 col-md-3'>
                        <div class='small-box bg-purple'>
                            ...
                            <a href='#' class='small-box-footer' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashTarbakLogDet','','$kode_lokasi/$periode/k3/2');\"> Detail <i class='fa fa-arrow-circle-right'></i></a>
                        </div>
                    </div>
                    <div class='col-md-15 col-md-3'>
                        <div class='small-box bg-red'>
                            ...
                            <a href='#' class='small-box-footer' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashTarbakLogDet','','$kode_lokasi/$periode/k4/3');\"> Detail <i class='fa fa-arrow-circle-right'></i></a>
                        </div>
                    </div>
					<div class='col-md-15 col-md-3'>
                        <div class='small-box bg-green'>
                            ...
                            <div class='icon'><i class='fa fa-credit-card'></i></div>
                            <a href='#' class='small-box-footer' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashTarbakLogDet','','$kode_lokasi/$periode/k5/3');\"> Detail <i class='fa fa-arrow-circle-right'></i></a>
                        </div>
                    </div>
                </div>"; 
        ...
        $pp = "select a.kode_pp,a.nama,isnull(b.jumlah,0) as jumlah
        from pp a
        inner join (select a.kode_pp,a.kode_lokasi,count(*) as jumlah
                   from fa_asset a
        ...
        $resPP = $dbLib->execute($pp);
        while ($row = $resPP->FetchNextObject(false)){
            $pps[] = array('y'=>floatval($row->jumlah),'name'=>$row->nama,'key'=>$row->kode_pp);     
                    
            $ctgpp[]=$row->nama;
        }	

        $klp = $dbLib->execute("select a.kode_klpakun,a.nama,isnull(b.jumlah,0) as jumlah
        from fa_klpakun a
        inner join (select a.kode_klpakun,a.kode_lokasi,count(*) as jumlah
                   from fa_asset a
        ...
        while ($row = $klp->FetchNextObject(false)){
            $klps[] = array('y'=>floatval($row->jumlah),'name'=>$row->nama,'key'=>$row->kode_klpakun);     
                    
            $klpcategories[] = $row->nama;
        }
        ...
        echo "<script type='text/javascript'>
                        ...
                        point: {
                            events: {
                                click: function() {
                                    ...
                                    window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashTarbakLogDet','','$kode_lokasi/$periode/pp/'+kd);
                                }
                            }
                        }
                    }
                ...
                var options2 = {
                    ...
                    xAxis: {
                        ...
                        categories: ".json_encode($klpcategories).",
                    },
                    yAxis:{
                        title: {
                            text: null
                        ...
                        point: {
                            events: {
                                click: function() {
                                    // var id = this.name;    
                                    var kd= this.options.key;                     
                                    window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashTarbakLogDet','','$kode_lokasi/$periode/klp/'+kd);
                                }
                            }
                        }
                    }
