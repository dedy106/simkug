...
class server_report_saku3_dash_rptDashYptGroupBebanMoM extends server_report_basic
{
	...
	function getHtml()
	{
        ...
        where a.modul='L' and a.kode_lokasi='12' and a.kode_fs='FS1' and a.periode='$periode' and b.kode_bidang in ('1','2','3','4','5') and a.kode_neraca='58T' and a.n9 <> 0
        ...
        sum(case a.jenis_akun when  'Pendapatan' then -a.n9 else a.n9 end) as n9
        from exs_neraca a
        where a.modul='L' and a.kode_fs='FS1' and a.periode='$periode' and a.level_lap<=1 and a.kode_neraca='58T' and a.kode_lokasi in ('03','08','11','13','14','15') and a.n9 <> 0
