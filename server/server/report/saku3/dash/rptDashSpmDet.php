...
class server_report_saku3_dash_rptDashSpmDet extends server_report_basic
{
	...
	function getHtml()
	{
		...
		echo "<div class='panel'>
				...
				<div class='panel-heading'>
					<a href='#' class='small-box-footer' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashSpm','','$kode_lokasi/$periode/$kode_pp/$nik/$kode_fs');\"> Back <i class='fa fa-arrow-circle-left'></i></a>
				</div>";
                    ...
                    point: {
                        events: {
                            click: function() {
                                ...
                                window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashSpmDet2','','$kode_lokasi|$periode|$nik|$kode_pp|$jenis|$kunci|$nama|NrcKas|'+kd+'|$kode_fs');
                            }
                        }
                    }
                }
                        ...
                        point: {
                            events: {
                                click: function() {
                                    ...
                                    var kd= this.options.key;
                                    // alert(kd);                        
                                    window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashSpmDet2','','$kode_lokasi|$periode|$nik|$kode_pp|$jenis|$kunci|$nama|NrcL|'+kd+'|$kode_fs');
                                }
                            }
                        }
                    }
