...
class server_report_saku3_dash_rptDashYptGroupBeban extends server_report_basic
{
	...
	function getHtml()
	{
        ...
        <div class='panel'>
                            ...
                            <div class='inner' style='padding: 10px !important;'>
                                ...
                                <div class='table-responsive'>
                                    <table class='table no-border'>";
                                         while($row = $rsYoY->FetchNextObject(false)) {
                                          echo"   
                                             <tr>
                                                 <td>".$row->nama."</td>
                            ...
                            <td align='center'  > 
                                ...
                                <style>
                                    ...
                                    <tr bgcolor='#dd4b39' style='color:white'>
                                        ...
                                        <td width='90' rowspan='2' align='center' class='header_laporan isi-td' style='border-bottom:1px solid white;border-right:1px solid white;vertical-align:middle'>Actual Ytd $tahunSebelum </td>
                                        <td colspan='4' align='center' class='header_laporan isi-td' style='border-bottom:1px solid white;'>Ytd $tahun</td>
                                    </tr>
                                    <tr bgcolor='#dd4b39' style='color:white'>
            ...
            $rsBeban =$dbLib->execute($sql);

            while($row = $rsBeban->FetchNextObject(false)){
                
                $beban[] = array('y'=>round(floatval($row->rasio),2),'name'=>$row->nama,'drilldown'=>$row->kode_lokasi);   
