...
class server_report_saku3_dash_rptDashYakesInves2ROI extends server_report_basic
{
                ...
                <div class='row'>
                    <div class='col-md-2' style='background:#e8e8e9;border-radius:15px;min-height:388px'>
                        ...
                        <ul class='nav nav-tabs' style='text-align:center'>
                            ...
                            <li role='presentation' class='$act3'><a data-toggle='tab' href='#produk' >Jenis</a></li>
                        </ul>
                    </div>
                    <div class='col-md-10'>
