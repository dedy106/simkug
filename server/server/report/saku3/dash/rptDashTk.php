...
class server_report_saku3_dash_rptDashTk extends server_report_basic
{
	...
	function getHtml()
	{
        ...
        echo"       <div class='col-md-15 col-md-3'>
                        <div class='small-box bg-".$color[0]."'>
                            ...
                            <div class='icon' style='padding-top:10px'><i class='fa ".$icon[0]."'></i></div>
                                <a href='#' class='small-box-footer' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashTkDet','','$kode_lokasi|$periode|all|DB01|$kode_pp|$nik|Kas Bank|$kode_fs');\"> Detail <i class='fa fa-arrow-circle-right'></i></a>
                        </div>
                    </div>";
        ...
        echo"       <div class='col-md-15 col-md-3'>
                        <div class='small-box bg-".$color[$i]."'>
                            ...
                            <div class='icon' style='padding-top:10px'><i class='fa ".$icon[$i]."'></i></div>
                                <a href='#' class='small-box-footer' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashTkDet','','$kode_lokasi|$periode|all|$row2->kode_grafik|$kode_pp|$nik|$row2->nama|$kode_fs');\"> Detail <i class='fa fa-arrow-circle-right'></i></a>
                        </div>
                    </div>";
            $i++;
        }
         ...
         echo  "<div class='col-md-15 col-md-3'>
                    <div class='small-box bg-aqua'>
                        ...
                        <div class='icon' style='padding-top:10px'><i class='fa fa-bank'></i></div>
                            <a href='#' class='small-box-footer' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashTkDet','','$kode_lokasi|$periode|all|$kode|$kode_pp|$nik|OR');\"> Detail <i class='fa fa-arrow-circle-right'></i></a>
                    </div>
                </div>";             
                ...
                <div class='small-box bg-yellow'>
                    <div class='inner'>
                        <center>
                            ...
                            <h3 id='home_kas_box' style='font-size:30px'>".number_format($jumlah2,0,",",".")."</h3>
                        </center>
                    </div>
        ...
        echo  "<div class='col-md-15 col-md-3'>
                <div class='small-box bg-blue'>
                    ...
                    <a href='#' class='small-box-footer' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashTkDetail1','','$kode_lokasi|$periode|$kode_pp|$nik|$kode_fs|all|Tagihan');\"> Detail <i class='fa fa-arrow-circle-right'></i></a>
                </div>
            </div>";  
        ...
        echo  "<div class='col-md-15 col-md-3'>
                <div class='small-box bg-purple'>
                    ...
                    <a href='#' class='small-box-footer' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashTkDetail1','','$kode_lokasi|$periode|$kode_pp|$nik|$kode_fs|all|Pbyr');\"> Detail <i class='fa fa-arrow-circle-right'></i></a>
                </div>
            </div>"; 
        ...
        $nilai=$row->nilai;
         echo  "<div class='col-md-15 col-md-3'>
                    <div class='small-box bg-purple'>
                        ...
                        <div class='icon'><i class='fa fa-credit-card' style='margin-top:10px'></i></div>
                        <a href='#' class='small-box-footer' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashTkDetail1','','$kode_lokasi|$periode|$kode_pp|$nik|$kode_fs|all|Pbyr2');\"> Detail <i class='fa fa-arrow-circle-right'></i></a>
                    </div>
                </div>"; 
		
		// $sql = " select a.kode_lokasi,isnull(b.total,0)-isnull(d.total,0)+isnull(c.total,0)-isnull(e.total,0)as nilai
        // from lokasi a 
        ...
        //                 </center>
        //             </div>
        //             <div class='icon'><i class='fa fa-dollar' style='margin-top:10px'></i></div>
        //             <a href='#' class='small-box-footer' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashTkDetail','','$kode_lokasi|$periode|$kode_pp|$nik|$kode_fs|all|Tunggak');\"> Detail <i class='fa fa-arrow-circle-right'></i></a>
        //         </div>
        //     </div>"; 
        ...
        echo  "<div class='col-md-15 col-md-3'>
                <div class='small-box bg-aqua'>
                    ...
                    <div class='icon'><i class='fa fa-bank' style='margin-top:10px'></i></div>
                        <a href='#' class='small-box-footer' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashTkDet','','$kode_lokasi|$periode|all|CR|$kode_pp|$nik|OR|$kode_fs');\"> Detail <i class='fa fa-arrow-circle-right'></i></a>
                </div>
            </div>"; 
        ...
        $('#control-sidebar-home-tab').on('click','#dash_refresh', function(){
            ...
            if( periode == ''){
                    window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashTk','','$kode_lokasi/$periode/$kode_pp/$nik/$kode_fs');
            }else{
                    window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashTk','','$kode_lokasi/'+periode+'/$kode_pp/$nik/$kode_fs');
            } 
