...
class server_report_saku3_dash_rptDashBangtelDet extends server_report_basic
{
	...
	function getHtml()
	{
		...
		echo "<div class='panel'>
				...
				<div class='panel-heading'>
					<a href='#' class='small-box-footer' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashBangtel','','$kode_lokasi/$periode/$kode_pp/$nik');\"> Back <i class='fa fa-arrow-circle-left'></i></a>
				</div>";
                            ...
                            point: {
                                events: {
                                    click: function() {
                                        ...
                                        window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashBangtelDet2','','$kode_lokasi|$periode|$nik|$kode_pp|$jenis|$kunci|$nama|NrcL|'+kd);
                                    }
                                }
                            }
                        }
                        ...
                        point: {
                            events: {
                                click: function() {
                                    ...
                                    var kd= this.options.key;
                                    // alert(kd);                        
                                    window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashBangtelDet2','','$kode_lokasi|$periode|$nik|$kode_pp|$jenis|$kunci|$nama|NrcB|'+kd);
                                }
                            }
                        }
                    }
