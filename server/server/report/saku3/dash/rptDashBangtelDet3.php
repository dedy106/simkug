...
class server_report_saku3_dash_rptDashBangtelDet3 extends server_report_basic
{
		...
		echo "<div class='panel'>
				<div class='panel-body'>
                    <div class='panel-heading'>
                        <a href='#' class='small-box-footer' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashBangtelDet2','','$kode_lokasi|$periode|$nik|$kode_pp|$jenis|$kunci|$nama|$param|$key');\"> Back <i class='fa fa-arrow-circle-left'></i></a>
                    </div>
                    <div class='col-md-12'>";
                        echo"
                            ...
                            <div class='row'>
                                <div class='col-xs-12 table-responsive'>
                                    <table class='table table-striped' id='table-BB'>
                                        <thead>
                                            <tr>
                                                 <td><a class='btn btn-primary' id='btnTampil' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashBangtelDet3','','$kode_lokasi|$periode|$nik|$kode_pp|$jenis|$kunci|$nama|$param|$key|$key2|semua');\">Tampil Semua</a></td>
                                        ...
                                        while ($row1 = $rs1->FetchNextObject($toupper=false))
                                        {
                                            ...
                                            echo "<a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashBangtelDet4','','$kode_lokasi|$periode|$nik|$kode_pp|$jenis|$kunci|$nama|$param|$key|$key2|$row1->no_bukti');\">$row1->no_bukti</a>";
                                            echo "</td>
