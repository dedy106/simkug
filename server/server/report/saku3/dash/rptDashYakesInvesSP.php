...
class server_report_saku3_dash_rptDashYakesInvesSP extends server_report_basic
{
	...
	function getHtml()
	{
                ...
                <div class='row' style='margin-left: 12px;'>
                    <div style='padding: 0px;' class='col-md-3'>
                        <div style='margin: 0px;padding: 0px;' class='panel'>
                            ...
                            <div class='panel-body' style='padding: 0px;' id='saham_non'>
                    ...
                    <div class='row'>
                        <div class='form-group'>
                                ...
                                <div class='col-sm-9' style='margin-bottom:5px;'>
                                    ...
                                    $rsplan = $dbLib->execute("select 'all' as kode_mitra, 'All' as nama union all select kode_mitra,nama from inv_mitra where flag_aktif='1'");
                                    while($row=$rsplan->FetchNextObject($toupper=false)){
                                        
                                        echo"<option value='$row->kode_mitra' >$row->kode_mitra - $row->nama</option>";
                                    }
                                    echo"
                                    </select>   
                                </div>
                    ...
                    <div class='row'>
                        <div class='form-group'>
                                ...
                                <select class='form-control selectize' id='sort_by_inp'>
                                    ...
                                    <option value='nama_kelola' >Nama Mitra</option>
                                    <option value='nab_unit' >Harga Wajar unit</option>
        ...
        <script>
            ...
            $('.panel').on('click','#back_btn',function(){
                window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashYakesInvesDet','','$kode_lokasi|$periode|$kode_pp|$nik|$kode_fs|$tglakhir|$kode_plan|$kode_klp');
            });
            ...
            $('.panel').on('click', '.klik', function(){
                ...
                $(this).addClass('aktif');
                loadService('daftarDetail','GET','$root_ser/dashYakesInves.php?fx=getDetailSP','$tglakhir|$kode_plan|$kode_klp|'+kode); 
            ...
            $('.modal-footer').on('click', '#btnOk', function(){
                ...
                loadService('daftar_sp','GET','$root_ser/dashYakesInves.php?fx=getDaftarSP','$tglakhir|$kode_plan|$kode_klp|'+kode_rdkelola+'|'+nama_sort+'|'+sort_by);
                loadService('daftarDetail','GET','$root_ser/dashYakesInves.php?fx=getDetailSP','$tglakhir|$kode_plan|$kode_klp|'+kode_rdkelola+'|'+nama_sort+'|'+sort_by);
                        ...
                        if(result.status){
                            switch(index){
                                ...
                                for(var i=0;i<result.daftar.length;i++){
                                    ...
                                    html +=`<div class='row klik sahamnpke`+i+`' style='margin-right: -5px;margin-left: -5px;border-bottom: 1px solid #dfdfdf;padding:5px'>    
                                    <div class='col-md-12 col-xs-12' style='padding: 0px;'>
                                        <h1 hidden>`+result.daftar[i].kode_mitra+`</h1>
                                    ...
                                    <div style='padding-left: 10px;padding-right: 10px;' class='col-md-5 col-xs-5'>
                                        <h6 style='margin: 0px;'>Harga Wajar/Unit {IDR}</h6>
                                        <p style='margin-top: 5px;font-size: 18px;'>`+sepNumPas(result.daftar[i].h_wajar)+` <sup style='font-size: 8px;top: -8px !important;'>`+koma+`</sup></p>
                                    </div>
                                ...
                                // for (var x=0; x< result.daftar.length;x++){
                                    ...
                                    `<div class='row' style='margin-left: 5px;border-bottom: 1px solid #e3e1e1;'>
                                        <div class='col-md-12' style='padding-left: 0px;'>
                                            <h3 style='margin-top: 0px;'>`+line.nama+`
                                            <span class='pull-right' style='padding-right: 10px;'>`+sepNum(line.persen_sp)+`%</span>
                                            <span class='pull-right' style='font-size: 12px;color: #808080;padding-top: 5px;padding-right: 10px;'>Penyertaan Saham</span></h3>
                                        </div>
                                    </div>
                                    <div class='row' style='margin-left: 5px;border-bottom: 1px solid #e3e1e1;'>
                                        ...
                                        <div style='' class='col-md-3 col-xs-3 text-center'>
                                            <h6 style=''>SPI {IDR}</h6>
                                            <p style='margin-top: 5px;font-size: 18px;'>`+sepNum2(line.spi_buku)+`</p>
                                        </div>
                                        <div style='' class='col-md-3 col-xs-3 text-center'>
                                            <h6 style=''>Return/YTD</h6>
                                            <p style='margin-top: 5px;font-size: 18px;'><img style='width: 20px;padding-bottom: 6px;' src='`+poly+`'>`+sepNum2(line.ytd)+`%</p>
                                        </div>
                                    </div>
                                    <div class='row' style='margin-left: 5px;border-bottom: 1px solid #e3e1e1;'>
            ...
            function initDash(){
                ...
                loadService('daftar_sp','GET','$root_ser/dashYakesInves.php?fx=getDaftarSP','$tglakhir|$kode_plan|$kode_klp');
                loadService('daftarDetail','GET','$root_ser/dashYakesInves.php?fx=getDetailSP','$tglakhir|$kode_plan|$kode_klp');
