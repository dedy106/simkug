...
class server_report_saku3_dash_rptDashTelDet2 extends server_report_basic
{
	...
	function getHtml()
	{
		...
		echo "<div class='panel'>
				<div class='panel-body'>
                    <div class='panel-heading' id='panel-heading'>
                        <a href='#' class='small-box-footer' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashTelDet','','$kode_lokasi|$periode|$jenis|$kunci|$kode_pp|$nik|$nama|$kode_fs');\"> Back <i class='fa fa-arrow-circle-left'></i></a>
                    </div>";
               echo"<div class='row'>
                        ...
                        switch($param){
                            ...
                            <div class='box-body'>
                                ...
                                <table class='table table-striped' id='table-nrcL'>
                                    ...
                                    where a.kode_lokasi='$kode_lokasi' and b.kode_fs='$kode_fs' and a.kode_akun='$key' and a.periode='$periode' and a.kode_pp='$kode_pp' ";
                                 ...
                                 echo  "<tr>
                                            ...
                                            <td  >$row->kode_akun</td>
                                            <td height='20' >";
                                            echo "<a style='cursor:pointer;color:blue'   onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashTelDet3','','$kode_lokasi|$periode|$nik|$kode_pp|$jenis|$kunci|$nama|$param|$key|$row->kode_akun|$kode_fs');\">$row->nama_akun</a>";
                                    echo   "</td>                            
                            ...
                            <div class='box-body'>
                                ...
                                <table class='table table-striped' id='table-nrcB'>
                                    ...
                                    if($row1->tipe == 'Posting'){
                                        ...
                                        inner join relakun b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi
                                        inner join masakun c on a.kode_akun=c.kode_akun and a.kode_lokasi=c.kode_lokasi
                                        where a.kode_lokasi='$kode_lokasi' and b.kode_fs='$kode_fs' and b.kode_neraca='$key' and a.periode='$periode' and a.kode_pp='$kode_pp' ";
                                        ...
                                        where a.kode_akun in (
                                                        ...
                                                        where a.periode='$periode' and a.kode_lokasi='$kode_lokasi' and a.kode_pp='$kode_pp' and a.kode_induk='$key' and a.tipe='Posting' 
        ...
        <script type='text/javascript'>
            ...
            $('#exs-to-xls').click(function(){
                // alert('hello');
                window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashBangtelDet2','','$kode_lokasi|$periode|$nik|$kode_pp|$jenis|$kunci|$nama|$param|$key|excel');
