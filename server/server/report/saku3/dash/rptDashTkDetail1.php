...
class server_report_saku3_dash_rptDashTkDetail1 extends server_report_basic
{
                        ...
                        point: {
                            events: {
                                click: function() {
                                    ...
                                    // alert(kd);                        
                                    window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashTkDetail','','$kode_lokasi|$periode|$nik|$kode_pp|$kode_fs|$jenis|$kunci|'+kd);
                                }
                            }
                        }
                    }
