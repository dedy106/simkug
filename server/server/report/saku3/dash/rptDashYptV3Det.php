...
class server_report_saku3_dash_rptDashYptV3Det extends server_report_basic
{
	...
	function getHtml()
	{
		...
		echo "<div class='panel'>
				...
				<div class='panel-heading'>
					<a href='#' class='small-box-footer' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashYptV3','','$kode_lokasi/$periode/$kode_pp/$nik/$kode_fs');\"> Back <i class='fa fa-arrow-circle-left'></i></a>
				</div>";
                                ...
                                point: {
                                    events: {
                                        click: function() {
                                            ...
                                            window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashYptV3Det2','','$kode_lokasi|$periode|$nik|$kode_pp|$kode_fs|$jenis|$kunci|$nama|NrcL|'+kd);
                                        }
                                    }
                                }
                            }
            ...
            switch($kunci){
                case "k1" :
                    ...
                    while ($row = $rs2->FetchNextObject(false)){
                        $tbody.="<tr>
                                    <td>
                                    <a  style='cursor:pointer;' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashYptV3Det2','','$kode_lokasi|$periode|$nik|$kode_pp|$kode_fs|$jenis|$kunci|$nama|PB|$row->no_aju');\" >$row->no_aju</a></td>
                                    <td>$row->modul</td>
                                    <td>$row->tgl</td>
                ...
                case "k2" :
                    ...
                    while ($row = $rs2->FetchNextObject(false)){
                        $tbody.="<tr>
                                    <td><a  style='cursor:pointer;' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashYptV3Det2','','$kode_lokasi|$periode|$nik|$kode_pp|$kode_fs|$jenis|$kunci|$nama|VER|$row->no_ver');\" >$row->no_ver</a></td>
                                    <td>$row->modul</td>
                                    <td>$row->tgl</td>
                                    <td>$row->keterangan</td>
                                    <td style='text-align:right'>".number_format($row->nilai,0,",",".")."</td>
                ...
                case "k3" :
                    ...
                    $sql = "select a.no_fiat,convert(varchar,a.tanggal,103) as tgl,a.modul,b.keterangan,b.nilai
                            from fiat_m a
                    ...
                    while ($row = $rs2->FetchNextObject(false)){
                        $tbody.="<tr>
                                    <td><a  style='cursor:pointer;' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashYptV3Det2','','$kode_lokasi|$periode|$nik|$kode_pp|$kode_fs|$jenis|$kunci|$nama|FIAT|$row->no_fiat');\" >$row->no_fiat</a></td>
                                    <td>$row->modul</td>
                                    <td>$row->tgl</td>
                                    <td>$row->keterangan</td>
                                    <td style='text-align:right'>".number_format($row->nilai,0,",",".")."</td>
                ...
                case "k4" :
                    ...
                    $sql = "select distinct a.no_spb,a.periode,convert(varchar,a.tanggal,103) as tgl,a.keterangan,a.nilai
                            from it_spb_m a
                    ...
                    while ($row = $rs2->FetchNextObject(false)){
                        $tbody.="<tr>
                                    <td><a  style='cursor:pointer;' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashYptV3Det2','','$kode_lokasi|$periode|$nik|$kode_pp|$kode_fs|$jenis|$kunci|$nama|SPB|$row->no_spb');\" >$row->no_spb</a></td>
                                    <td>$row->periode</td>
                                    <td>$row->tgl</td>
                                    <td>$row->keterangan</td>
                                    <td style='text-align:right'>".number_format($row->nilai,0,",",".")."</td>
                ...
                case "k5" :
                    ...
                    $sql = "select distinct a.no_kas,convert(varchar,a.tanggal,103) as tgl,a.modul,a.keterangan,a.nilai
                            from kas_m a
                    ...
                    while ($row = $rs2->FetchNextObject(false)){
                        $tbody.="<tr>
                                    <td><a  style='cursor:pointer;' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashYptV3Det2','','$kode_lokasi|$periode|$nik|$kode_pp|$kode_fs|$jenis|$kunci|$nama|KAS|$row->no_kas');\" >$row->no_kas</a></td>
                                    <td>$row->modul</td>
                                    <td>$row->tgl</td>
                                    <td>$row->keterangan</td>
                                    <td style='text-align:right'>".number_format($row->nilai,0,",",".")."</td>
                ...
                case "app0" :
                    ...
                    while ($row = $rs2->FetchNextObject(false)){
                        $tbody.="<tr>
                                    <td><a  style='cursor:pointer;' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashYptV3Det2','','$kode_lokasi|$periode|$nik|$kode_pp|$kode_fs|$jenis|$kunci|$nama|RRA|$row->no_pdrk');\" >$row->no_pdrk</a></td>
                                    <td>$row->tgl</td>
                                    <td>$row->periode</td>
                                    <td>$row->kode_pp</td>
                                    <td>$row->keterangan</td>
                ...
                while ($row = $rs2->FetchNextObject(false)){
                    $tbody.="<tr>
                                <td>
                                <a  style='cursor:pointer;' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashYptV3Det2','','$kode_lokasi|$periode|$nik|$kode_pp|$kode_fs|$jenis|$kunci|$nama|RRA|$row->no_pdrk');\" >$row->no_pdrk</a></td>
                                <td>$row->tgl</td>
                                <td>$row->periode</td>
                                <td>$row->kode_pp</td>
                                <td>$row->keterangan</td>
                ...
                while ($row = $rs2->FetchNextObject(false)){
                    $tbody.="<tr>
                                <td>
                                <a  style='cursor:pointer;' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashYptV3Det2','','$kode_lokasi|$periode|$nik|$kode_pp|$kode_fs|$jenis|$kunci|$nama|SPJ|$row->no_spj');\" >$row->no_spj</a></td>
                                <td>$row->tgl</td>
                                <td>$row->periode</td>
                                <td>$row->kode_pp</td>
                                <td>$row->keterangan</td>
                ...
                while ($row = $rs2->FetchNextObject(false)){
                    $tbody.="<tr>
                                <td>
                                <a  style='cursor:pointer;' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashYptV3Det2','','$kode_lokasi|$periode|$nik|$kode_pp|$kode_fs|$jenis|$kunci|$nama|APD|$row->no_app');\" >$row->no_app</a></td>
                                <td>$row->tgl</td>
                                <td>$row->periode</td>
                                <td>$row->kode_pp</td>
                                <td>$row->keterangan</td>
                            ...
                            point: {
                                events: {
                                    click: function() {
                                        ...
                                        var kd= this.options.key;
                                        // alert(kd);                        
                                        window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashYptV3Det2','','$kode_lokasi|$periode|$nik|$kode_pp|$kode_fs|$jenis|$kunci|$nama|GAR|'+kd);
                                    }
                                }
                            }
                        }
