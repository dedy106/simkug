...
class server_report_saku3_dash_rptDashTeluDet2 extends server_report_basic
{
	...
	function getHtml()
	{
		...
		echo "<div class='panel'>
				<div class='panel-body'>
                    <div class='panel-heading' id='panel-heading'>
                        <a href='#' class='small-box-footer' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashTeluDet','','$kode_lokasi|$periode|$jenis|$kunci|$kode_pp|$nik|$nama|$kode_fs');\"> Back <i class='fa fa-arrow-circle-left'></i></a>
                    </div>";
               echo"<div class='row'>
                            ...
                            <div class='box-body'>
                                ...
                                <table class='table table-striped' id='table-nrcL'>
                                 ...
                                 echo  "<tr>
                                            ...
                                            <td  >$row->kode_akun</td>
                                            <td height='20' >";
                                            echo "<a style='cursor:pointer;color:blue'   onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashTeluDet3','','$kode_lokasi|$periode|$nik|$kode_pp|$jenis|$kunci|$nama|$param|$key|$row->kode_akun|$kode_fs');\">$row->nama_akun</a>";
                                    echo   "</td>                            
        ...
        <script type='text/javascript'>
            ...
            $('#exs-to-xls').click(function(){
                // alert('hello');
                window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashTeluDet2','','$kode_lokasi|$periode|$nik|$kode_pp|$jenis|$kunci|$nama|$param|$key|$kode_fs|excel');
