...
class server_report_saku3_dash_rptDashYakesDeposito extends server_report_basic
{
                        ...
                        <div class='row'  style='padding-top: 10px;'>
                                ...
                                <div class='col-md-12 pad-more' style='margin-bottom:25px'>
                                    <div class='panel mar-mor box-wh'>
                                        <div class='panel-heading text-center' style='padding-bottom:10px'>
                                            <h3 style='margin-top:0px;margin-bottom:0px;position: absolute;'>Alokasi Deposito per Bank</h3>
                                        </div>
                            ...
                            <div class='col-md-4 col-xs-12 pad-more'>
                                <div class='col-md-12 pad-more' style='height:270px;margin-bottom:25px'>
                                    <div class='panel mar-mor box-wh'>
                                        <div class='panel-heading text-center' style='padding-bottom:10px'>
                                            <h3 style='margin-top:0px;margin-bottom:0px;position: absolute;'>Daftar Deposito per Bank MI</h3>
