...
class server_report_saku3_dash_rptDashSppdU extends server_report_basic
{
	...
	function getHtml()
	{
        ...
        where a.kode_lokasi='$kode_lokasi' and a.modul = 'SPPD_USER'
        order by a.nu
                  ";
        ...
        echo"       <div class='col-md-12 col-md-3'>
                        <div class='small-box bg-".$color[$i]."'>
                            ...
                            <div class='icon'><i class='fa ".$icon[$i]."'></i></div>
                                <a href='#' class='small-box-footer' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashSppdDet2','','$kode_lokasi/$periode/$kode_pp/$nik/$row->kode_proses/server_report_saku3_dash_rptDashSppdU');\"> Detail <i class='fa fa-arrow-circle-right'></i></a>
                        </div>
                    </div>";
            $i++;
        }
        ...
        from sp_spj_m a
        where a.kode_lokasi='$kode_lokasi' and substring(a.periode,1,4)='".substr($periode,0,4)."' and a.progress='2' and a.nik_spj='$nik'
