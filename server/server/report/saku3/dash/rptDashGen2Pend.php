...
class server_report_saku3_dash_rptDashGen2Pend extends server_report_basic
{
            ...
            <div class='col-md-12'>
                <div class='panel'>
                    ...
                    <div class='panel-body'>
                        ...
                        <center><h4 style='font-weight: bold; color: #000000;'>Neraca Lajur Pendapatan</h4></center>
                ...
                function initDash(){
                    loadService('getNeracaSaldo','GET','$root_ser/generalDash.php?fx=getNeracaSaldo','Pendapatan');
                }
