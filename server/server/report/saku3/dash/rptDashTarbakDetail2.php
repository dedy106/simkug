...
class server_report_saku3_dash_rptDashTarbakDetail2 extends server_report_basic
{
		...
		echo "<div class='panel'>
				<div class='panel-body'>
                    <div class='panel-heading'>
                        <a href='#' class='small-box-footer' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashTarbakDetail','','$kode_lokasi|$periode|$kode_pp|$nik|$kode_fs|$jenis|$kunci');\"> Back <i class='fa fa-arrow-circle-left'></i></a>
                    </div>";
               echo"<div class='row'>
                        ...
                        switch($kunci){
                            ...
                            inner join sis_jur c on b.kode_jur=c.kode_jur and b.kode_lokasi=c.kode_lokasi where a.kode_lokasi='$kode_lokasi' and a.nis='$key' ";
                            // echo $sql;
                            ...
                            <div class='col-md-12'>
                                ...
                                <div class='box-body'>";
                                    ...
                                    from sis_bill_m a
                                    where a.kode_lokasi='$kode_lokasi' and a.no_bill='$key' ";
                                    ...
                                    <div class='row'>
                                        ...
                                        <table class='table table-striped'>
                                            ...
                                            where a.kode_lokasi='$kode_lokasi' and a.no_bill='$row->no_bill' and a.nis='$nis'
                                            ";
                                            // echo $sql;
                            ...
                            <div class='col-md-12'>
                                ...
                                <div class='box-body'>";
                                    ...
                                    from kas_m a
                                    where a.kode_lokasi='$kode_lokasi' and a.no_kas='$key' ";
                                    ...
                                    <div class='row'>
                                        ...
                                        <table class='table table-striped'>
                                            ...
                                            inner join sis_param b on a.kode_param=b.kode_param and a.kode_lokasi=b.kode_lokasi
                                            where a.kode_lokasi='$kode_lokasi' and a.no_rekon='$row->no_kas' and a.nis='$nis'
                                            ";
                                            // echo $sql;
                            ...
                            <div class='col-md-12'>
                                ...
                                <div class='box-body'>";
                                    ...
                                    from sis_siswa a
                                    where a.kode_lokasi='$kode_lokasi' and a.nis='$key'";
                                    ...
                                    <div class='row'>
                                        ...
                                        <table class='table table-striped'>
                                            ...
                                            left join (select x.kode_param,x.kode_lokasi,  
                                                        ...
                                                        from sis_bill_d x 			
                                                        where(x.kode_lokasi = '$kode_lokasi')and(x.periode < '$periode')  and x.nis='$key'			
