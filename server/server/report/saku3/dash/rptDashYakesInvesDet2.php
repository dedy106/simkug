...
class server_report_saku3_dash_rptDashYakesInvesDet2 extends server_report_basic
{
	...
	function getHtml()
	{
                                ...
                                <div class='col-md-12 pad-more' style='height:270px'>
                                    <div class='panel mar-mor box-wh'>
                                        <div class='panel-heading' style='padding-bottom:0px'>
                                            ...
                                            <span id='labelNBAbulan'>Harian - ".substr($tglakhir,0,4)."</span>
        ...
        <script>
            ...
            $('.panel').on('click','.klik-chart2',function(){
                ...
                $(this).css({'border-radius': '10px','box-shadow': 'none','padding': '0px','background': '#ffcc00','color':'white'});
                    ...
                    success:function(result){    
                        if(result.status){
                            ...
                            switch(index){
                                ...
                                $('.rowke0').css({'border-radius': '10px','box-shadow': 'none','padding': '0px','background': '#ffcc00','color':'white'});
                                break;
                                case 'daftar_sektor' :
                                var html ='';
