...
class server_report_saku3_dash_rptDashUinV3 extends server_report_basic
{
	...
	function getHtml()
	{
        ...
        $sql1 = "select isnull(sum(b.total)/1000000,0) as total
        from uin_usul_m a 
        inner join uin_usul_d b on a.no_usul=b.no_usul and a.kode_lokasi=b.kode_lokasi
        where (a.form='BELANJA' or a.form='BLJABT') and a.kode_lokasi='$kode_lokasi' and a.tahun='$periode'";

        $sql2 = "select isnull(sum(b.total)/1000000,0) as total
        from uin_usul_m a 
        inner join uin_usul_d b on a.no_usul=b.no_usul and a.kode_lokasi=b.kode_lokasi
        where (a.form='PDPT' or a.form='PDPTABT') and a.kode_lokasi='$kode_lokasi' and a.tahun='$periode' ";

        $sql3 = "select isnull(sum(a.nilai/1000000),0) as total
                from uin_aju_m a 
                where a.jenis <> 'PDPT' and a.kode_lokasi='$kode_lokasi' ";
		...
		echo "
		<div class='panel'>
            <div class='panel-heading' style='font-size:18px;padding:10px 0px 1px 20px'>Realisasi Anggaran
            ...
            <ul class='nav navbar-nav'><li class='dropdown notifications-menu'>
                <a href='#' class='dropdown-toggle' style='padding:0px 15px 10px 5px' data-toggle='dropdown'>
                    ...
                    <span class='label label-warning' style='font-size:8px;position: absolute;top: 0px;right: 6px;text-align: center;padding: 2px 3px;line-height: .9;'>".$rsj->fields[0]."</span>
                    </a>
                    <ul class='dropdown-menu'>";
                echo"
                    <li class='header'>You have ".$rsj->fields[0]." notifications</li>";
                    while ($row = $rsn->FetchNextObject($toupper=false)) {
                echo"
                    <li>
                        <ul class='menu'>
                        <li>
        ...
        echo   "<div class='row'>
                    <div class='col-md-12 col-md-3'>
                        <div class='small-box bg-yellow'>
                            ...
                            <a href='#' class='small-box-footer' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashUinDetailV3','','$kode_lokasi/$periode/all/BBlj');\"> Detail <i class='fa fa-arrow-circle-right'></i></a>
                        </div>
                    </div>
                    <div class='col-md-12 col-md-3'>
                        <div class='small-box bg-blue'>
                            ...
                            <div class='icon'><i class='fa fa-money'></i></div>
                            <a href='#' class='small-box-footer' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashUinDetailV3','','$kode_lokasi/$periode/all/RBlj');\"> Detail <i class='fa fa-arrow-circle-right'></i></a>
                        </div>
                    </div>
                    <div class='col-md-12 col-md-3'>
                        <div class='small-box bg-aqua'>
                            ...
                            <a href='#' class='small-box-footer' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashUinDetailV3','','$kode_lokasi/$periode/all/BPdpt');\"> Detail <i class='fa fa-arrow-circle-right'></i></a>
                        </div>
                    </div>
                    <div class='col-md-12 col-md-3'>
                        <div class='small-box bg-red'>
                            ...
                            <a href='#' class='small-box-footer' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashUinDetailV3','','$kode_lokasi/$periode/all/RPdpt');\"> Detail <i class='fa fa-arrow-circle-right'></i></a>
                        </div>
                    </div>
                </div>"; 
        ...
        inner join (select c.kdgbkpk,a.kode_lokasi, sum(a.total) as total
                    ...
                    where a.kode_lokasi='$kode_lokasi' and a.dc='D' and a.no_park='-' and a.tahun='$periode' and (e.form='BELANJA' or e.form='BLJABT')
                    group by c.kdgbkpk,a.kode_lokasi
                        )c on a.kdgbkpk=c.kdgbkpk 
        left join (select c.kdgbkpk,a.kode_lokasi, sum(a.total) as total
                    from uin_aju_d a 
                    inner join uin_akun b on a.kode_akun=b.kdakun 
                    inner join uin_gbkpk c on b.kdgbkpk=c.kdgbkpk
                    inner join uin_aju_m e on a.no_aju=e.no_aju and a.kode_lokasi=e.kode_lokasi
                    where a.kode_lokasi='$kode_lokasi' and a.dc='D' and a.tahun='$periode' and e.jenis <> 'PDPT' 
                    group by c.kdgbkpk,a.kode_lokasi
        ...
        left join uin_aju_d d on b.kdakun=d.kode_akun and c.kode_lokasi=d.kode_lokasi 
        inner join uin_usul_m e on c.no_usul=e.no_usul where c.kode_lokasi='$kode_lokasi' and (e.form='BELANJA'  or e.form='BLJABT') ");
        ...
        inner join (select b.kdakun,a.kode_lokasi, sum(a.total) as total
                    ...
                    inner join uin_akun b on a.kode_akun=b.kdakun 
                    inner join uin_usul_m e on a.no_usul=e.no_usul and a.kode_lokasi=e.kode_lokasi
                    where a.kode_lokasi='$kode_lokasi' and a.dc='D' and a.no_park='-' and a.tahun='$periode' and (e.form='PDPT' or e.form ='PDPTABT') 
       ...
       left join (select b.kdakun,a.kode_lokasi, sum(a.total) as total
        ...
        inner join uin_usul_d c on b.kdakun=c.kode_akun
        left join uin_usul_m e on c.no_usul=e.no_usul where c.kode_lokasi='$kode_lokasi' and (e.form='PDPT' or e.form='PDPTABT') ");
        ...
        inner join (select a.kode_pp,a.kode_lokasi, sum(a.total) as total
                    ...
                    where a.kode_lokasi='$kode_lokasi' and a.tahun='$periode' and (b.form='BELANJA' or b.form='BLJABT')
                    group by a.kode_pp,a.kode_lokasi
                        )c on a.kode_pp=c.kode_pp and a.kode_lokasi=c.kode_lokasi 
        left join (select a.kode_pp,a.kode_lokasi, sum(a.nilai) as total
                    from uin_aju_m a 
        ...
        left join uin_aju_m d on a.kode_pp=d.kode_pp and a.kode_lokasi=d.kode_lokasi 
        inner join uin_usul_m e on a.kode_pp=e.kode_pp and a.kode_lokasi=e.kode_lokasi where e.kode_lokasi='$kode_lokasi' and (e.form='BELANJA' or e.form='BLJABT') ");
        ...
        inner join (select a.kode_pp,a.kode_lokasi, sum(a.total) as total
                    from uin_usul_d a 
                    inner join uin_usul_m b on a.no_usul=b.no_usul and a.kode_lokasi=b.kode_lokasi
                    where a.kode_lokasi='$kode_lokasi' and a.tahun='$periode' and (b.form='PDPT' or b.form='PDPTABT')
                    group by a.kode_pp,a.kode_lokasi
                        )c on a.kode_pp=c.kode_pp and a.kode_lokasi=c.kode_lokasi 
        left join (select a.kode_pp,a.kode_lokasi, sum(a.nilai) as total
                    from uin_aju_m a 
        ...
        $res = $dbLib->execute("select distinct a.kode_pp,a.nama from pp a 
        left join uin_aju_m d on a.kode_pp=d.kode_pp and a.kode_lokasi=d.kode_lokasi 
        inner join uin_usul_m e on a.kode_pp=e.kode_pp and a.kode_lokasi=e.kode_lokasi where e.kode_lokasi='$kode_lokasi' and (e.form='PDPT' or e.form='PDPTABT') ");
