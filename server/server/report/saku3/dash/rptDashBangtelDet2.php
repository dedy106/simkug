...
class server_report_saku3_dash_rptDashBangtelDet2 extends server_report_basic
{
		...
		echo "<div class='panel'>
				<div class='panel-body'>
                    <div class='panel-heading' id='panel-heading'>
                        <a href='#' class='small-box-footer' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashBangtelDet','','$kode_lokasi|$periode|$jenis|$kunci|$kode_pp|$nik|$nama');\"> Back <i class='fa fa-arrow-circle-left'></i></a>
                    </div>";
               echo"<div class='row'>
                            ...
                            <div class='box-body'>
                                ...
                                <table class='table table-striped' id='table-nrcL'>
                                 ...
                                 echo  "<tr>
                                            ...
                                            <td height='20' >";
                                            echo "<a style='cursor:pointer;color:blue'   onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashBangtelDet3','','$kode_lokasi|$periode|$nik|$kode_pp|$jenis|$kunci|$nama|$param|$key|$row->kode_akun');\">$row->nama_akun</a>";
                                    echo   "</td>                            
                        ...
                        case "NrcB" :
                            ...
                            <div class='box-body'>
                                ...
                                <table class='table table-striped' id='table-nrcB'>
                                    ...
                                    $rs = $dbLib->execute($sql);
                                    // $sql = "select a.kode_akun,a.nama as nama_akun,a.kode_lokasi,a.debet,a.kredit,a.so_awal,so_akhir, 
                                    // case when a.so_awal>0 then so_awal else 0 end as so_awal_debet,
                                    // case when a.so_awal<0 then -so_awal else 0 end as so_awal_kredit, 
                                    // case when a.so_akhir>0 then so_akhir else 0 end as so_akhir_debet,
                                    // case when a.so_akhir<0 then -so_akhir else 0 end as so_akhir_kredit
