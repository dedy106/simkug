...
class server_report_saku3_dash_rptDashYptV3Det4 extends server_report_basic
{
	...
	function getHtml()
	{
        ...
        // if(!empty($tmp[12])){
        //     $key3=$tmp[10]."/".$tmp[11]."/".$tmp[12]; 
        // }
        
        // if(!empty($tmp[13])){
        //     $key3=$tmp[10]."/".$tmp[11]."/".$tmp[12]."/".$tmp[13]; 
        // }
        // if(!empty($tmp[14])){
        //     $key3=$tmp[10]."/".$tmp[11]."/".$tmp[12]."/".$tmp[13]."/".$tmp[14]; 
        // }
		...
		echo "<div class='panel'>
				<div class='panel-body'>
                    <div class='panel-heading'>
                        <a href='#' class='small-box-footer' onclick=\"window.parent.system.getResource(".$resource.").doOpen('server_report_saku3_dash_rptDashYptV3Det3','','$kode_lokasi|$periode|$nik|$kode_pp|$kode_fs|$jenis|$kunci|$nama|$param|$key|$key2');\"> Back <i class='fa fa-arrow-circle-left'></i></a>
                    </div>
                    <div class='col-md-12'>";
                        echo"
