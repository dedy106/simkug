...
class server_report_saku3_spm_rptFaAssetTmp extends server_report_basic
{
...
order by a.kode_akun,a.tgl_perolehan ";
		...
		echo $AddOnLib->judul_laporan("simulasi daftar aktiva operasional dan beban penyusutan asset ",$this->lokasi,"Periode ".$AddOnLib->ubah_periode($periode));
