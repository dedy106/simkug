...
class server_report_saku3_spm_rptPanjarPos extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.no_panjar,a.kode_lokasi,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.nilai,a.progress,a.kode_pp,b.nama as nama_pp,
