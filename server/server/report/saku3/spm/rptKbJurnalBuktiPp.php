...
class server_report_saku3_spm_rptKbJurnalBuktiPp extends server_report_basic
{
	...
	function getHtml()
	{
		...
		global $dbLib;
		$sql="select a.no_kas,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.no_dokumen,a.kode_lokasi,a.periode,b.nama,b.kota , a.nik_user,a.nik_app,c.nama as nama_buat,d.nama as nama_setuju 
			from kas_m a
