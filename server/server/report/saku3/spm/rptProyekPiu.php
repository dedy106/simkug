...
class server_report_saku3_spm_rptProyekPiu extends server_report_basic
{
...
order by a.kode_proyek ";
  ...
  <tr bgcolor='#CCCCCC'>
	...
	$sql="select a.no_piutang,b.keterangan,convert(varchar,b.tanggal,103) as tgl,a.kode_pp,
	   a.nilai as piu,0 as rev
...
order by b.tanggal";
    ...
    <td class='isi_laporan' align='right'>".number_format($row1->piu,0,',','.')."</td>
