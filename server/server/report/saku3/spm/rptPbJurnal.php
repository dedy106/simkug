...
class server_report_saku3_spm_rptPbJurnal extends server_report_basic
{
	...
	function getHtml()
	{
		...
		global $dbLib;
		$sql="select a.no_pb,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.no_dokumen,a.kode_lokasi,a.periode,b.nama,b.kota,a.kode_proyek,a.nik_user,c.nama as nama_buat,a.nik_app as nik1,d.nama as nama_app
			from yk_pb_m a
  ...
  <tr>
    <td><table width='800' border='1' cellspacing='0' cellpadding='0' class='kotak'>
	 ...
	 $sql1="select a.kode_akun,b.nama,a.kode_pp,a.kode_drk,a.nilai,a.keterangan,isnull(a.debet,0) as debet,isnull(a.kredit,0) as kredit,a.kode_curr
					  from (select kode_lokasi,kode_akun,kode_pp,kode_drk,dc,nilai,keterangan,case when dc='D' then nilai else 0 end as debet,case when dc='C' then nilai else 0 end as kredit,kode_curr
							from yk_pb_j
							where periode='$row->periode' and kode_lokasi='$row->kode_lokasi' and no_pb='$row->no_pb'
							)a 
  ...
  <tr>
    <td align='right'><table width='400' border='1' cellspacing='0' cellpadding='0' class='kotak'>
      ...
      <tr>
		...
		<tr>
        <td align='center'>NIK. $row->nik_user</td>
