...
class server_report_saku3_spm_rptProyekAging extends server_report_basic
{
	...
	function getHtml()
	{
		...
		a.nilai+a.nilai_ppn-a.nilai_pph as tagihan,a.akun_piutang,d.nama as nama_akun,a.kode_pp,
...
$this->filter and (a.no_piutang NOT LIKE '%RVB%') and a.tanggal<='$tgl_aging' order by a.no_piutang";
   ...
   <tr bgcolor='#CCCCCC'>
	 ...
	 <td width='80' rowspan='2'  align='center' class='header_laporan'>Cabang</td>
