...
class server_report_saku3_spm_rptGlBukuBesarPpProyek extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql = "select a.kode_lokasi,a.kode_pp,e.nama as nama_pp,a.kode_akun,d.nama,a.so_awal,a.periode,case when a.so_awal>=0 then a.so_awal else 0 end as so_debet,case when a.so_awal<0 then a.so_awal else 0 end as so_kredit
				from exs_glma_pp a 
		...
		echo $AddOnLib->judul_laporan("buku besar",$this->lokasi,$nama_periode);
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			echo "<table border='1' cellspacing='0' cellpadding='1' class='kotak'>
   <tr >
    <td height='23' colspan='13' style='padding:5px'><table  border='0' cellspacing='2' cellpadding='1'>
                    <tr>
...
from (select a.kode_lokasi,a.no_bukti,a.no_dokumen,a.periode,a.tanggal,a.kode_akun,a.kode_pp,a.kode_drk,a.dc,a.nilai,a.keterangan,a.modul
	  from gldt_h a 
	  where a.kode_lokasi='$row->kode_lokasi' and a.kode_akun='$row->kode_akun' and a.kode_pp='$row->kode_pp' $var_periode 	  
	  union all 
	 ...
	 left join cust d on c.kode_cust=d.kode_cust and c.kode_lokasi=d.kode_lokasi
    ...
    <td valign='top' class='isi_laporan' align='right'>".number_format($saldo,0,',','.')."</td>
			...
			echo "<tr>
   <td height='23' colspan='10' valign='top' class='header_laporan' align='right'>Total&nbsp;</td>
