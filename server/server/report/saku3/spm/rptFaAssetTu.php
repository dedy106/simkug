...
class server_report_saku3_spm_rptFaAssetTu extends server_report_basic
{
...
order by a.kode_akun,a.tgl_perolehan ";
		...
		$nilai2= 0 ; $nilai_buku2 = 0 ; $nilai_akm_sd2 = 0; $nilai_akm_bln2 = 0;$nilai_akm_total2 = 0;$wo=0;$wo2=0;$jml2=0;$jml=0;
		$first = true;
		$ix=1;
		$tmp = "";
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			...
			{				
				...
				$i=1;
				$nilai=0;$nilai_buku=0;$nilai_akm_sd=0;$nilai_akm_bln=0;$nilai_akm_total=0;$wo=0;$jml=0;$jml2=0;
			}
		    $nilai += $row->nilai;
		...
		echo "<tr bgcolor='#CCCCCC'>
				  ...
				  <td class='header_laporan' align='right'>".number_format($jml2,0,",",".")."</td>
