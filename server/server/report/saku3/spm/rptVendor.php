...
class server_report_saku3_spm_rptVendor extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode=$tmp[0];
		$nama_cab=$tmp[1];
		$sql="select a.kode_vendor, a.nama, a.alamat, a.no_tel, a.email, a.npwp, a.pic, a.alamat2,a.bank,a.no_rek
from vendor a
$this->filter order by a.kode_vendor";
   ...
   <tr bgcolor='#CCCCCC'>
     ...
     <td width='90'  align='center' class='header_laporan'>Bank</td>
