...
class server_report_saku3_spm_rptIfForm extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$tmp=explode("/",$this->filter2);
		$periode=$tmp[0];
	$sql="select a.no_if,a.no_dokumen,a.kode_lokasi,a.periode,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tanggal1,a.keterangan,a.kode_lokasi,
...
left join spm_rek c on a.no_if=c.no_bukti and a.kode_lokasi=c.kode_lokasi 
$this->filter";
		$rs = $dbLib->execute($sql);
  ...
  <tr>
    <td><table width='800' border='0' cellspacing='2' cellpadding='1'>
      <tr>
        <td width='200' align='center'><img src='$logo' width='200' height='64'></td>
   ...
   <tr>
    <td height='60'><table width='800' border='0' cellspacing='2' cellpadding='1'>
      <tr>
        <td align='center' class='istyle17'>BUKTI PENGAJUAN IMPREST FUND</td>
      </tr>
      <tr>
        <td align='center' class='istyle17'>Nomor : $row->no_if</td>
      </tr>
    </table></td>
  </tr>
