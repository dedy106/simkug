...
class server_report_saku3_spm_rptIfKartu extends server_report_basic
{
...
";
			...
			$sql="select a.no_kas as no_bukti,b.tanggal,a.kode_lokasi,b.keterangan,b.nilai as debet,0 as kredit,date_format(b.tanggal,'%d/%m/%Y') as tgl,2 as nu
from spm_if_m a
...
union all
select a.no_reim as no_bukti,a.tanggal,a.kode_lokasi,a.keterangan,0 as debet,a.nilai as kredit,date_format(a.tanggal,'%d/%m/%Y') as tgl,3 as nu
from spm_ifreim_m a
where a.nik='$row->nik' and a.kode_lokasi='$row->kode_lokasi' 
union all
select a.no_kas as no_bukti,b.tanggal,a.kode_lokasi,a.keterangan,b.nilai as debet,0 as kredit,date_format(a.tanggal,'%d/%m/%Y') as tgl,4 as nu
from spm_ifreim_m a
inner join kas_j b on a.no_kas=b.no_kas and a.kode_lokasi=b.kode_lokasi and a.no_reim=b.no_dokumen and a.kode_pp=b.kode_pp
where a.nik='$row->nik' and a.kode_lokasi='$row->kode_lokasi' and a.status_if<>'CLOSE'
order by tanggal,nu
 ";
