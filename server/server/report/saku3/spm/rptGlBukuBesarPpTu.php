...
class server_report_saku3_spm_rptGlBukuBesarPpTu extends server_report_basic
{
...
from (select a.kode_lokasi,a.no_bukti,a.no_dokumen,a.periode,a.tanggal,a.kode_akun,a.kode_pp,a.kode_drk,a.dc,a.nilai,a.keterangan 
	  from gldt_h a 
	  where a.kode_lokasi='$row->kode_lokasi' and a.kode_akun='$row->kode_akun' and (a.periode between '$periode_awal' and '$periode') and a.kode_pp='$kode_pp'
	  union all
