...
class server_report_saku3_spm_rptIfPtgPos extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.no_reim,h.no_ganti,a.kode_lokasi,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.progress,a.nilai,a.kode_pp,b.nama as nama_pp,
...
left join spm_ifganti_m h on a.no_reim=h.no_reim and a.kode_lokasi=h.kode_lokasi
$this->filter order by a.no_reim ";
		...
		echo $AddOnLib->judul_laporan("posisi reimburse imprest fund",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
   ...
   <tr bgcolor='#CCCCCC'>
	 ...
	 <td width='100'  align='center' class='header_laporan'>No Ganti</td>
   ...
   <td width='90'  align='center' class='header_laporan'>Nilai</td>
	...
	<td class='isi_laporan'>$row->tgl</td>
	 ...
	 <td class='isi_laporan'>$row->tgl_kas</td>
	  ...
	  <td class='header_laporan' align='center' colspan='11'>&nbsp;</td>
    </tr>";
		echo "</table><br>";
		echo "</div>";
		return "";
