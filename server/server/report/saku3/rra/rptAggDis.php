...
class server_report_saku3_rra_rptAggDis extends server_report_basic
{
	...
	function getHtml()
	{
		...
		global $dbLib;
		$sql="select convert(varchar(20),a.tanggal,103) as tgl,a.tanggal,a.no_pdrk,a.kode_lokasi,e.no_dokumen,
		a.keterangan,a.nik_buat,b.nama as nama_buat,a.nik_app3 as nik_setuju,c.nama as nama_setuju,d.kota,substring(a.periode,1,4) as tahun
from rra_pdrk_m a
inner join anggaran_m e on a.no_pdrk=e.no_agg and a.kode_lokasi=e.kode_lokasi 
inner join karyawan b on a.nik_buat=b.nik and a.kode_lokasi=b.kode_lokasi
inner join karyawan c on a.nik_app3=c.nik and a.kode_lokasi=c.kode_lokasi
inner join lokasi d on a.kode_lokasi=d.kode_lokasi $this->filter order by a.no_pdrk";
		...
		echo $AddOnLib->judul_laporan("laporan rra anggaran",$this->lokasi,$tahun);
...
inner join drk d on a.kode_drk=d.kode_drk and a.kode_lokasi=d.kode_lokasi and d.tahun='2021'
where a.no_bukti='$row->no_pdrk' and a.kode_lokasi='$row->kode_lokasi'
