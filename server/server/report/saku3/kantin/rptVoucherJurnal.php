...
class server_report_saku3_kantin_rptVoucherJurnal extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.no_ju,a.no_dokumen,a.kode_lokasi,a.periode,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tanggal1,
...
order by no_ju ";
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			echo "<table border='0' cellspacing='2' cellpadding='1'>
			  <tr>
				<td align='center' class='header_laporan'>JURNAL PEMBUATAN VOUCHER</td>
			  </tr>
			  <tr>
