...
class server_report_saku3_kantin_rptTenan extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode=$tmp[0];
		$nama_cab=$tmp[1];
		$sql="select a.kode_tenan, a.nama, a.alamat, a.pic,a.nama_rek,a.no_rek,a.bank,a.cabang
from kt_tenan a
$this->filter order by a.kode_tenan";
