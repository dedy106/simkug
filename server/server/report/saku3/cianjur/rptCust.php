...
class server_report_saku3_cianjur_rptCust extends server_report_basic
{
...
$this->filter";
	...
	function getHtml()
	{
		...
		$periode=$tmp[0];
		$nama_cab=$tmp[1];
		$sql="select kode_cust,kode_lokasi,nama,alamat,no_tel,email,npwp,pic
from cust
$this->filter order by kode_cust";
