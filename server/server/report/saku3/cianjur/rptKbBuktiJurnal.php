...
class server_report_saku3_cianjur_rptKbBuktiJurnal extends server_report_basic
{
	function getTotalPage()
	{
		...
		$periode=$tmp[2];
		$filter2=$tmp[3];
		$sql="select count(a.no_bukti) as jum
		from trans_m a
	...
	function getHtml()
	{
		...
		$periode=$tmp[2];
		$filter2=$tmp[3];
		$sql="select a.no_bukti,a.no_dokumen,a.kode_lokasi,a.periode,a.tanggal,convert(varchar,a.tanggal,103) as tanggal1,a.keterangan,a.kode_lokasi,a.nik_user,
		a.nik1,b.nama as nama_buat,b.jabatan as jabatan_buat,a.nik1,c.nama as nama_setuju,c.jabatan as jabatan_setuju,d.kota
		-- f.nik as nik_fiat,f.nama as nama_fiat
		-- isnull(e.kode_spro,'-') as kode_spro
				from trans_m a
				...
				-- left join spro e on a.kode_lokasi=e.kode_lokasi and e.kode_spro='FIATUR'
				-- left join karyawan f on e.flag=f.nik and f.kode_lokasi=e.kode_lokasi 
		$this->filter2 $modul";
...
//       <tr>
//         <td colspan='4' class='header_laporan'>$row->kota, ".substr($row->tanggal,8,2)." ".$AddOnLib->ubah_periode(substr(str_replace("-","",$row->tanggal),0,6))."</td>
//         </tr>
//       <tr>
//         <td width='120' class='header_laporan'>Diperiksa Oleh : </td>
//         <td width='120' class='header_laporan'>Dibuat Oleh : </td>
// 		<td width='120' class='header_laporan'>&nbsp;</td>
// 		 <td width='120' class='header_laporan'>Fiatur : </td>
//       </tr>
//        <tr>
//         <td height='40'>&nbsp;</td>
//         <td>&nbsp;</td>
...
// 		 <td class='header_laporan'>$row->nama_fiat</td>
//       </tr>
//       <tr>
