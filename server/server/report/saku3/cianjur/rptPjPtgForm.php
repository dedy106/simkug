...
class server_report_saku3_cianjur_rptPjPtgForm extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode=$tmp[2];
		$filter2=$tmp[3];
		$sql="select a.no_ptg,a.no_panjar,a.kode_lokasi,convert(varchar,a.tanggal,103) as tgl_ptg,a.tanggal,a.kode_lokasi,a.keterangan,a.nik_buat,a.nik_app,c.nama as nama_buat,d.nama as nama_app,
    a.kode_pp,a.nilai,c.jabatan as jab_buat,d.jabatan as jab_app,a.kode_pp,convert(varchar,e.tanggal,103) as tgl_panjar,a.nilai_pj,a.nilai as nilai_ptg,a.nilai_kas,
     f.kota
    from panjarptg2_m a
