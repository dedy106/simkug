...
class server_report_saku3_cianjur_rptPjAjuForm extends server_report_basic
{
	...
	function getHtml()
	{
       ...
       a.kode_pp,a.nilai,a.akun_panjar as kode_akun,e.nama as nama_akun,date_format(a.due_date,'%d/%m/%Y') as due_date,c.jabatan as jab_buat,d.jabatan as jab_setuju,a.kode_pp,f.nama as nama_tahu
from panjar2_m a
...
inner join karyawan f on a.nik_tahu=f.nik and a.kode_lokasi=f.kode_lokasi
...
<td><table width='800' border='0' cellspacing='0' cellpadding='0' class='kotak'>
  ...
  <td width='200' align='center'>&nbsp; </td>
  <td width='200' align='center'>&nbsp; </td>
    <td align='left' class='header_laporan' >Disetujui Oleh, </td>
    </tr>
    <tr>
    <td height='80'>&nbsp;</td>
    <td>&nbsp;</td>
