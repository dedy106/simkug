...
class server_report_saku3_cianjur_rptProyek extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$nama_cab=$tmp[0];
		$kode_lokasi=$tmp[1];
		$sql="select a.kode_proyek,a.kode_cust,b.nama as nama_cust,a.nilai,a.nama,a.nama,a.no_dokumen,a.p_or,a.nilai_or,
...
order by a.kode_proyek";
   ...
   <tr bgcolor='#CCCCCC'>
     ...
     <td width='80'    align='center' class='header_laporan'>Kode Proyek</td>
	  ...
	  <td width='150'    align='center' class='header_laporan'>No PKS</td>
	 ...
	 <td width='90'    align='center' class='header_laporan'>% OR</td>
