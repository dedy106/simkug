...
class server_report_saku3_cianjur_rptHutangSaldo extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.no_hutang, a.no_dokumen,a.tanggal,convert(varchar,a.tanggal,103) as tgl,e.nama as nama_cust,a.keterangan,a.nilai,a.nilai_ppn,a.nilai+a.nilai_ppn as tagihan, isnull(d.nilai1,0) as nilai_kas,a.nilai-isnull(d.nilai1,0) as saldo,d.no_bukti as ket_kas from hutang_m a 
		inner join vendor e on a.kode_vendor=e.kode_vendor and a.kode_lokasi=e.kode_lokasi 
		left join pb_m b on a.no_hutang=b.no_hutang and a.kode_lokasi=b.kode_lokasi
		left join spb_m c on b.no_spb=c.no_spb and b.kode_lokasi=c.kode_lokasi
		left join trans_m d on c.no_kas=d.no_bukti and c.kode_lokasi=d.kode_lokasi
