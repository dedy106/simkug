...
class server_report_saku3_cianjur_rptHutangPos extends server_report_basic
{
...
$this->filter";
	...
	function getHtml()
	{
		...
		$sql="select a.no_hutang,convert(varchar,a.tanggal,103) as tgl_hutang,a.keterangan,a.nilai,
		b.nama as nama_vendor,c.no_pb,convert(varchar,c.tanggal,103) as tgl_pb,
	    c.no_spb,convert(varchar,d.tanggal,103) as tgl_spb,
		d.no_kas,convert(varchar,e.tanggal,103) as tgl_kas,c.nilai as nilai_pb
		from hutang_m a
		...
		left join trans_m e on d.no_kas=e.no_bukti and d.kode_lokasi=e.kode_lokasi
		$this->filter
