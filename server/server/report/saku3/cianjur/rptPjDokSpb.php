...
class server_report_saku3_cianjur_rptPjDokSpb extends server_report_basic
{
...
$this->filter";
	...
	function getHtml()
	{
		...
		$periode=$tmp[0];
		$kode_lokasi=$tmp[1];
		$sql="select a.no_spb,a.kode_lokasi,convert(varchar,a.tanggal,103) as tgl,a.tanggal,convert(varchar,a.due_date,103) as due_date,a.keterangan,a.nik_buat,a.nik_sah,a.nik_fiat,a.nik_bdh,a.nilai
    ,b.nama as nama_buat,c.nama as nama_tahu,d.nama as nama_fiat,e.nama as nama_bdh,d.jabatan as jab_fiat,h.nama,g.no_panjar
    from spb_m a 
    left join karyawan b on a.nik_buat=b.nik and a.kode_lokasi=b.kode_lokasi 
    left join karyawan c on a.nik_sah=c.nik and a.kode_lokasi=c.kode_lokasi 
    ...
    inner join spb_d f on a.no_spb=f.no_spb and a.kode_lokasi=f.kode_lokasi 
    inner join panjar2_m g on f.no_bukti=g.no_panjar and f.kode_lokasi=g.kode_lokasi 
    inner join karyawan h on g.nik_buat=h.nik and g.kode_lokasi=h.kode_lokasi
    $this->filter 
    order by a.no_spb";
    ...
    if($kode_lokasi == "02"){
        $pathfoto = $path . "image/cianjur.png";
  ...
  <tr>
    <td><table width='100%'  border='0' cellspacing='1' cellpadding='1'>
      <tr>
        ...
        <td width='84%' align='center' class='istyle17' valign='bottom'>SURAT PERINTAH BAYAR PANJAR </td>
      </tr>
      <tr>
        <td align='center' class='istyle15' valign='top'>$row->no_spb </td>
      </tr>
    </table></td>
  </tr>
  <tr>
...
where a.kode_lokasi='$row->kode_lokasi' and a.no_panjar='$row->no_panjar' and a.dc='D'";
    ...
    <td><table width='100%'  border='0' cellspacing='2' cellpadding='3'>
        ...
        <td><table width='100%'  border='1' cellspacing='0' cellpadding='0' class='kotak'>
          <tr>
            ...
            <td width='41%' valign='top'><table width='100%'  border='0' cellspacing='2' cellpadding='1'>
              <tr>
                <td>Terbilang </td>
            <td width='80%'>: ".$AddOnLib->terbilang($row->nilai)."</td>
              </tr>
              <tr>
      ...
      <tr>
        <td><table width='100%'  border='1' cellspacing='0' cellpadding='0' class='kotak'>
          ...
          <tr>
            <td width='18%' align='center'>$row->jab_fiat</td>
            <td width='23%' rowspan='2'>&nbsp;</td>
            <td align='center'>Asman Administrasi </td>
