...
class server_report_saku3_cianjur_rptHutangSpb extends server_report_basic
{
    ...
    inner join karyawan c on a.nik_sah=c.nik and a.kode_lokasi=c.kode_lokasi 
    ...
    b.nama as nama_buat,c.nama as nama_tahu,d.nama as nama_fiat,e.nama as nama_bdh,convert(varchar,h.tanggal,103) as tgl_hutang,
    ...
    <td><table width='100%'  border='0' cellspacing='2' cellpadding='3'>
      ...
      <tr>
        <td><table width='100%'  border='1' cellspacing='0' cellpadding='0' class='kotak'>
          ...
          <tr>
            <td width='18%' align='center'>Direktur</td>
