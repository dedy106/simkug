...
class server_report_saku3_tpcc_rptPiutangKasJurnal extends server_report_basic
{
...
left join karyawan c on a.nik1=c.nik and a.kode_lokasi=c.kode_lokasi $this->filter ";
		...
		{
			$judul="JURNAL REVERSE PIUTANG";
			if (substr($row->no_bukti,3,2)=="BM")
			{
				$judul="JURNAL KASBANK";
			}
			echo "<table border='0' cellspacing='2' cellpadding='1'>
			  <tr>
				<td align='center' class='header_laporan'>$judul</td>
			  </tr>
			  <tr>
