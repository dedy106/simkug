...
class server_report_saku3_tpcc_bill_rptBillDaftar extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$kode_lokasi=$tmp[0];
		$periode=$tmp[1];
		$sql="select a.no_bill,a.kode_lokasi,convert(varchar,a.tanggal,103) as tgl,d.no_pks as no_kontrak,a.keterangan,b.divisi as nama_cust,
		a.keterangan,a.nilai,a.nilai_ppn,a.nilai+a.nilai_ppn as total,a.tanggal,
...
inner join piutang_d c on a.no_bill=c.no_piutang and a.kode_lokasi=c.kode_lokasi
inner join pr_proyek d on c.kode_project=d.kode_proyek and c.kode_lokasi=d.kode_lokasi
$this->filter
order by a.tanggal";
