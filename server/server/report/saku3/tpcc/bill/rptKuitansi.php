...
class server_report_saku3_tpcc_bill_rptKuitansi extends server_report_basic
{
	...
	function getHtml()
	{
        ...
        $sql="select a.no_bill,a.no_dokumen,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.no_ba,
...
echo "<table width='700' border='1' cellspacing='2' cellpadding='1'  class='kotak' >
        <tr>
            ...
            <img src='$pathfoto' width='100px' height='60px' style='padding-top:20px;padding-bottom: 200px;'></img> <span><b>KUITANSI</b>
            </span>
            <br>
            <br>
            <br>
            ...
            Alamat : Jl. Picung No. 47 Bandung 40152
			<br>Phone : +62 22 2007891
                    +62 22 82002285
			Whatsapp & Telegram : +628112282500
        ...
        echo "
                    ...
                    <tr>
                        ...
                        <td width='5'>:</td>
                        <td  colspan='2' style='font-size:12px;padding:7px'>&nbsp; $row->no_ba</td>
                    </tr>
                    <tr>
             ...
             echo "<table border='0' width='100%' cellspacing='0' cellpadding='0'>
                    ...
                    <tr>
                     ...
                     <td>&nbsp;</td>
                     <td>&nbsp;</td>
                     <td width='150'  align='center' style='font-size:12px'>$row->nama_app</td>
                     </tr>
                     <tr>
                     <td>&nbsp;</td>
                     <td>&nbsp;</td>
