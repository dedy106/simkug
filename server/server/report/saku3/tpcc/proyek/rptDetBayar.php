...
class server_report_saku3_tpcc_proyek_rptDetBayar extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$tahun=$tmp[1];
		$filter2=$tmp[2];
		$sql="select a.no_bukti,a.periode,a.nilai,a.kode_akun,a.dc,convert(varchar,c.tanggal,103) as tgl
