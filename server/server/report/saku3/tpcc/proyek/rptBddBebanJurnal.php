...
class server_report_saku3_tpcc_proyek_rptBddBebanJurnal extends server_report_basic
{
	...
	function getHtml()
	{
       ...
       a.nik_user,b.nama as nama_buat,a.nik1,c.nama as nama_app, d.kota,a.keterangan,a.no_ref2,e.kode_proyek,e.nama as nama_pr 
			from trans_m a
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			echo "<table border='0' cellspacing='2' cellpadding='1'>
			  <tr>
				<td align='center' class='header_laporan'>MEMO JURNAL BEBAN</td>
			  </tr>
			  <tr>
				<td>
