...
class server_report_saku3_tpcc_proyek_rptDataProyek extends server_report_basic
{
...
isnull(e.bdd,0) as bdd,a.nilai_or-isnull(e.bdd,0) as saldo,a.p_or,ROUND(e.bdd/a.nilai*100,0)  as r_or,i.nilai_pph,isnull(g.nilai,0) as pdpt, isnull(g.nilai,0) - isnull(e.bdd,0) as profit,isnull(h.bayar,0) as bayar,isnull(j.nilai_ppn,0) as nilai_ppn
from pr_proyek a
...
left join ( select b.kode_project,a.kode_lokasi,sum(a.nilai) as bayar 
...
left join ( select b.kode_project,a.kode_lokasi,sum(a.nilai) as nilai_pph 
		  from trans_j a 
		  inner join trans_m c on a.no_bukti=c.no_bukti and a.kode_lokasi=c.kode_lokasi
		  inner join piutang_d b on c.no_ref1=b.no_piutang and c.kode_lokasi=b.kode_lokasi 
		  where a.kode_akun='1165102'
		  group by b.kode_project,a.kode_lokasi ) i on a.kode_proyek=i.kode_project and a.kode_lokasi=i.kode_lokasi
left join ( select a.no_bukti,a.no_dokumen,a.kode_lokasi,sum(a.nilai2) as nilai_ppn
			from trans_m a
			where a.modul='PR' and a.form='AKRUPIU'
			group by a.no_bukti,a.no_dokumen,a.kode_lokasi
...
// echo $sql;
   ...
   <tr bgcolor='#CCCCCC'>
     ...
     <td width='80' rowspan='2'  align='center' class='header_laporan'>ID Proyek</td>
	 ...
	 <td width='90' rowspan='2'  align='center' class='header_laporan'>Nilai Proyek</td>
	 ...
	 <td width='90' rowspan='2'  align='center' class='header_laporan'>Pengakuan Pendapatan</td>	 
   ...
   <tr bgcolor='#CCCCCC'>
		...
		$nilai=0;  $nilai_ppn=0; $nilai_or=0; $bdd=0; $profit=0; $nilai_pph=0;$sisa_rab=0;$sisa_or=0;$pdpt=0;$bayar=0;
