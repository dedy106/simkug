...
class server_report_saku3_tpcc_proyek_rptJurnalBddRev extends server_report_basic
{
	...
	function getHtml()
	{
       ...
       a.nik_user,b.nama as nama_buat, d.kota,a.keterangan,a.no_dokumen,a.no_dokumen,e.kode_proyek,e.nama as nama_pr 
			from trans_m a
			...
			left join  pr_proyek e on a.no_dokumen=e.kode_proyek and a.kode_lokasi=e.kode_lokasi
			$this->filter
			order by a.no_bukti";
