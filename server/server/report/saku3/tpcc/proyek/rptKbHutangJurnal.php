...
class server_report_saku3_tpcc_proyek_rptKbHutangJurnal extends server_report_basic
{
	...
	function getHtml()
	{
       ...
       a.nik_user,b.nama as nama_buat,a.nik1,c.nama as nama_app, d.kota,a.keterangan,a.no_ref2,f.kode_proyek,f.nama as nama_pr 
			from trans_m a
			...
			left join  pr_or_d e on a.no_ref1=e.no_bukti and a.kode_lokasi=e.kode_lokasi
			left join  pr_proyek f on e.kode_proyek=f.kode_proyek and f.kode_lokasi=e.kode_lokasi
			$this->filter
			order by a.no_bukti";
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			echo "<table border='0' cellspacing='2' cellpadding='1'>
			  <tr>
				<td align='center' class='header_laporan'>MEMO JURNAL PENYELESAIAN HUTANG</td>
			  </tr>
			  <tr>
				<td>
