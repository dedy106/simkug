...
class server_report_saku3_tpcc_proyek_rptProyekPanjarBeban extends server_report_basic
{
	...
	function getHtml()
	{
		...
		a.nik_user as nik_buat,b.nama as nama_buat, d.kota,a.keterangan,a.no_dokumen,f.kode_proyek,f.nama as nama_pry,a.nik1 as nik_app,c.nama as nama_app,e.nama as nama_pp,g.nama as nama_consumer,f.kode_cons 
			 from trans_m a
			 ...
			 left join ptg_m h on a.no_dokumen=h.no_pj and a.kode_lokasi=h.kode_lokasi
			 left join pr_proyek f on h.no_dokumen=f.kode_proyek and h.kode_lokasi=f.kode_lokasi
			 left join consumer g on f.kode_cons=g.kode_cons and f.kode_lokasi=g.kode_lokasi
			 $this->filter
			 order by a.no_bukti";
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			echo "<table border='0' cellspacing='2' cellpadding='1'>
			  <tr>
				<td align='center' class='header_laporan'>MEMO JURNAL PTG PANJAR via BEBAN PROYEK </td>
			  </tr>
			  <tr>
				<td>
			<table border='0' cellspacing='2' cellpadding='1'>
			  ...
			  <tr>
				<td><table border='0' cellspacing='2' cellpadding='1'>
				  ...
				  <tr>
					<td width='100' class='header_laporan'>No Panjar </td>
					<td width='496' class='header_laporan'>:&nbsp;$row->no_dokumen</td>
					</tr>
				  <tr>
					<td width='100' class='header_laporan'>No Proyek </td>
					<td width='496' class='header_laporan'>:&nbsp;$row->kode_proyek | $row->nama_pry </td>
					</tr>
					<tr>
				...
				<tr>
				  ...
				  <tr>
					<td width='100' class='header_laporan'>Consumer </td>
					<td width='496' class='header_laporan'>:&nbsp;$row->kode_cons - $row->nama_consumer</td>
					</tr>
				</table></td>
			  </tr>
			  <tr>
	  ...
	  $sql1="select a.kode_akun,b.nama,a.keterangan,a.kode_pp,a.kode_drk,case dc when 'D' then nilai else 0 end as debet,case dc when 'C' then nilai else 0 end as kredit,a.no_dokumen  
			from trans_j a
