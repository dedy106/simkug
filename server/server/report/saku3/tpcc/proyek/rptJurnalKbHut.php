...
class server_report_saku3_tpcc_proyek_rptJurnalKbHut extends server_report_basic
{
	...
	function getHtml()
	{
       ...
       a.nik_user,b.nama as nama_buat, d.kota,a.keterangan,a.no_dokumen,a.no_dokumen,f.kode_proyek,f.nama as nama_pr 
			from trans_m a
			...
			left join trans_m e on a.no_ref1=e.no_bukti and a.kode_lokasi=e.kode_lokasi
			left join  pr_proyek f on e.no_dokumen=f.kode_proyek and e.kode_lokasi=f.kode_lokasi
			$this->filter
			order by a.no_bukti";
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			echo "<table border='0' cellspacing='2' cellpadding='1'>
			  <tr>
				<td align='center' class='header_laporan'>MEMO JURNAL REKLAS BDD </td>
			  </tr>
			  <tr>
				<td>
			<table border='0' cellspacing='2' cellpadding='1'>
			  ...
			  <tr>
				...
				<tr>
				  ...
				  <tr>
					<td width='100' class='header_laporan'>ID Proyek </td>
					<td width='496' class='header_laporan'>:&nbsp;$row->kode_proyek</td>
					</tr>
				  <tr>
					<td width='100' class='header_laporan'>Nama Proyek </td>
					<td width='496' class='header_laporan'>:&nbsp;$row->nama_pr</td>
					</tr>
				</table></td>
			  </tr>
			  <tr>
