...
class server_report_saku3_yspt_rptDropingAkun extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode=$tmp[1];
		$kode_pp=$tmp[2];
		$sql="select a.kode_akun,a.kode_lokasi,b.nama,ISNULL(c.nilai,0) as agg,ISNULL(d.nilai,0) as minta,
...
from (select a.kode_akun,a.kode_lokasi
	  from anggaran_d a
	  where a.kode_lokasi='$lokasi' and a.kode_pp='$kode_pp'
	  group by a.kode_akun,a.kode_lokasi
	  )a
inner join masakun b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi
left join (select a.kode_akun,a.kode_lokasi,SUM(nilai) as nilai
		   from anggaran_d a
		   where a.kode_lokasi='$lokasi' and a.periode='$periode' and a.kode_pp='$kode_pp'
		   group by a.kode_akun,a.kode_lokasi
		   )c on a.kode_akun=c.kode_akun and a.kode_lokasi=b.kode_lokasi 
left join (select b.kode_akun,a.kode_lokasi,SUM(b.nilai_usul) as nilai
		   from ys_minta_m a
...
left join (select b.kode_akun,a.kode_lokasi,SUM(b.nilai_usul) as nilai
		   from ys_minta_m a
		   inner join ys_minta_d b on a.no_minta=b.no_minta and a.kode_lokasi=b.kode_lokasi
		   where a.kode_lokasi='$lokasi' and a.periode='$periode' and a.no_app<>'-' and a.kode_pp='$kode_pp'
		   group by b.kode_akun,a.kode_lokasi
		   )e on a.kode_akun=e.kode_akun and a.kode_lokasi=e.kode_lokasi 
left join (select b.kode_akun,a.kode_lokasi,SUM(b.nilai_usul) as nilai
		   from ys_minta_m a
		   inner join ys_minta_d b on a.no_minta=b.no_minta and a.kode_lokasi=b.kode_lokasi
		   where a.kode_lokasi='$lokasi' and a.periode='$periode' and a.no_kas<>'-' and a.kode_pp='$kode_pp'
		   group by b.kode_akun,a.kode_lokasi
...
order by a.kode_akun ";
		...
		echo $AddOnLib->judul_laporan("rekap droping",$this->lokasi,"Periode ".$AddOnLib->ubah_periode($periode));
