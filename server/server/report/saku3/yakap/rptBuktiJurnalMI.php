...
class server_report_saku3_yakap_rptBuktiJurnalMI extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select distinct a.no_bukti,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.kode_lokasi,a.periode,b.nama,c.nik_user,c.nik1,
				...
				inner join karyawan d on c.nik_user=d.nik and d.kode_lokasi=c.kode_lokasi
				inner join karyawan e on c.nik1=d.nik and e.kode_lokasi=d.kode_lokasi
				$this->filter
				order by a.no_bukti ";
				// echo $sql;
