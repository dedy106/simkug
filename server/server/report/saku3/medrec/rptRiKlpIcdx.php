...
class server_report_saku3_medrec_rptRiKlpIcdx extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode=$tmp[0];
		$sort=$tmp[3];
		$sql="select a.kode_klp,a.nama,a.n1, a.n2, a.n3, a.n4, a.n5, a.n6, a.n7, a.n8, a.n9, a.n10, a.n11, a.n12, a.n13, a.n14, a.n15, a.n16, a.n17, a.n18, a.n19, a.n20, a.n21, a.n22, a.n23, a.n24 
		from (SELECT d.kode_klp, e.nama,
...
left join yk_icdx_klp e on d.kode_klp=e.kode_klp
$this->filter
group by d.kode_klp, e.nama ) a
order by $sort ";
		...
		echo $AddOnLib->judul_laporan("biaya pengobatan rawat inap",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
		echo "<table border='1' cellspacing='0' cellpadding='0' class='kotak'>
  <tr align='center' bgcolor='#B9FFCF'>
    <td class='header_laporan' rowspan='2'>No</td>
	<td class='header_laporan' width='50' rowspan='2'>KODE</td>
    <td class='header_laporan' width='200' rowspan='2'>KELOMPOK ICDX</td>
