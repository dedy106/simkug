...
class server_report_saku3_medrec_rptRest extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode=$tmp[0];
		$nama_cab=$tmp[1];
		$sql="SELECT     a.periode,a.nama, a.no_daftar, a.no_resep, a.no_rujukan, a.tanggal, a.nama_mitra, a.nama_dokter1, a.nama_dokter2, a.kode_tpk, a.nik, a.band_posisi, a.hr_area, a.loker, a.nik_kes, a.nama_pasien, 
