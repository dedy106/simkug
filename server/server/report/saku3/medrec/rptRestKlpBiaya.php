...
class server_report_saku3_medrec_rptRestKlpBiaya extends server_report_basic
{
...
";
		...
		echo $AddOnLib->judul_laporan("realisasi biaya pengobatan restitusi",$this->lokasi,"TAHUN ".$tahun);
