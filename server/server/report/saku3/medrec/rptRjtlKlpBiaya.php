...
class server_report_saku3_medrec_rptRjtlKlpBiaya extends server_report_basic
{
...
";
		...
		echo $AddOnLib->judul_laporan("realisasi biaya pengobatan RJTL",$this->lokasi,"TAHUN ".$tahun);
