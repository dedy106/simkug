...
class server_report_saku3_medrec_rptRekapProduk extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode=$tmp[0];
		$nama_cab=$tmp[1];
		$sql="SELECT     e.kode_produk, e.nama,
...
$this->filter
group by e.kode_produk,e.nama 
order by e.kode_produk ";
