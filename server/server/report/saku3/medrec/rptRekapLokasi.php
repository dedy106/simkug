...
class server_report_saku3_medrec_rptRekapLokasi extends server_report_basic
{
...
order by a.kode_lokasi ";
		...
		echo $AddOnLib->judul_laporan("rekap biaya pengobatan per area",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
