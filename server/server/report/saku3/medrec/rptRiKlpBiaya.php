...
class server_report_saku3_medrec_rptRiKlpBiaya extends server_report_basic
{
...
";
		...
		echo $AddOnLib->judul_laporan("realisasi biaya pengobatan rawat inap",$this->lokasi,"TAHUN ".$tahun);
