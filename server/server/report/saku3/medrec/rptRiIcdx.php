...
class server_report_saku3_medrec_rptRiIcdx extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode=$tmp[0];
		$sort=$tmp[3];
		$sql="select a.icdx,a.nama,a.n1, a.n2, a.n3, a.n4, a.n5, a.n6, a.n7, a.n8, a.n9, a.n10, a.n11, a.n12, a.n13, a.n14, a.n15, a.n16, a.n17, a.n18, a.n19, a.n20, a.n21, a.n22, a.n23, a.n24 
		from (SELECT upper(a.icdx) as icdx, e.nama,
...
order by $sort ";
  ...
  <tr align='center' bgcolor='#B9FFCF'>
    ...
    <td class='header_laporan' width='60' rowspan='2'>ICDX</td>
	 <td class='header_laporan' width='200' rowspan='2'>NAMA PENYAKIT </td>
  ...
  <tr bgcolor='#B9FFCF'>
    ...
    <td class='isi_laporan'>$row->icdx</td>
