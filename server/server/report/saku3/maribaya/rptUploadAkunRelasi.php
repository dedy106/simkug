...
class server_report_saku3_maribaya_rptUploadAkunRelasi extends server_report_basic
{
      ...
      echo"
        ...
        th{
		  ...
		  var dataTable = $('#table-xjan').DataTable({
            ...
            'serverSide': true,
            'ajax': {
                'url': '$root_ser/UploadExcel.php?fx=getAkunRelasi',
          ...
          $('#nw_container').on('submit', '#nw_form_insert', function(e){
            ...
            $.ajax({
              type: 'POST',
              url: '$root_ser/UploadExcel.php?fx=simpanAkunRelasiTmp',
              dataType: 'json',
              data: formData,
              contentType: false,
              cache: false,
          ...
          $('#nw_container').on('click', '#saveBtn', function(e){
            ...
            iconloading.show();
              ...
              $.ajax({
                type: 'POST',
                url: '$root_ser/UploadExcel.php?fx=simpanAkunRelasi',
                dataType: 'json',
                data: {'kode_lokasi':'$kode_lokasi'},
                success:function(result){
                  alert('Input data '+result.message);
