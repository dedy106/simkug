...
class server_report_saku3_maribaya_rptUploadJurnal extends server_report_basic
{
      ...
      echo"
        ...
        th{
          ...
          var dataTable = $('#table-xjan').DataTable({
            ...
            'serverSide': true,
            'ajax': {
                'url': '$root_ser/UploadExcel.php?fx=getJurnal',
          ...
          $('#nw_container').on('submit', '#nw_form_insert', function(e){
            ...
            $.ajax({
              type: 'POST',
              url: '$root_ser/UploadExcel.php?fx=simpanJurnalTmp',
              dataType: 'json',
              data: formData,
              contentType: false,
              cache: false,
          ...
          $('#nw_container').on('click', '#saveBtn', function(e){
            ...
            if(per ==''){
              ...
              $.ajax({
                type: 'POST',
                url: '$root_ser/UploadExcel.php?fx=simpanJurnal',
                dataType: 'json',
          ...
          $('#nw_container').on('click', '#download-tmp', function(e){
              ...
              var link = '$root_ser/UploadExcel.php?fx=getTemplateJurnal&nik_user=$nik_user';
