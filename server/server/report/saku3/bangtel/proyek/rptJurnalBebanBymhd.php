...
class server_report_saku3_bangtel_proyek_rptJurnalBebanBymhd extends server_report_basic
{
	...
	function getHtml()
	{
		...
		global $dbLib;
		$sql="select a.no_hutang,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.no_dokumen,a.kode_lokasi,a.periode,b.nama,a.kode_proyek
			from hutang_m a
		...
		{
			$judul="BUKTI JURNAL  BEBAN - BYMHD ";
    ...
    <td><table width='100%'  border='0' cellspacing='2' cellpadding='1'>
      <tr>
        ...
        <td width='200' align='center'><table width='100%'  border='1' cellspacing='0' cellpadding='0' class='kotak'>
          ...
          <tr>
            <td align='center' class='istyle15'>$row->no_hutang</td>
          </tr>
          <tr>
    ...
    <td><table width='800' border='1' cellspacing='0' cellpadding='0' class='kotak'>
	 ...
	 $sql1="select a.kode_akun,b.nama as nama_akun,a.kode_pp,a.nilai,a.keterangan,case when dc='D' then nilai else 0 end as debet,case when dc='C' then nilai else 0 end as kredit,a.kode_curr
					  ...
					  inner join masakun b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi
					   where a.periode='$row->periode' and a.kode_lokasi='$row->kode_lokasi' and a.no_hutang='$row->no_hutang'
					order by a.dc desc";
