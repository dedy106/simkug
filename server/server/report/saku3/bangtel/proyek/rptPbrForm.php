...
class server_report_saku3_bangtel_proyek_rptPbrForm extends server_report_basic
{
...
$this->filter";
	...
	function getHtml()
	{
	   ...
	   c.nama as nama_pp,a.kode_pp,a.nik_user as nik_buat,d.nama as nama_buat,a.nik_app,e.nama as nama_app,f.kota,a.kode_proyek,g.nama as namapr
from yk_pb_m a
...
left join spm_proyek g on a.kode_proyek=g.kode_proyek and g.kode_lokasi=a.kode_lokasi
$this->filter order by a.no_pb";
  ...
  <tr align='center'>
    <td height='30' class='istyle17'>PERMOHONAN PEMBAYARAN PROYEK</td>
  </tr>
  <tr>
