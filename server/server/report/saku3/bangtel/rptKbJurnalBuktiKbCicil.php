...
class server_report_saku3_bangtel_rptKbJurnalBuktiKbCicil extends server_report_basic
{
	...
	function getHtml()
	{
		...
		global $dbLib;
		$sql="select a.no_bukti,a.no_ref1,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.no_dokumen,a.param2,a.kode_lokasi,a.periode,b.nama,b.kota,a.nik1,a.nik2,c.nama as nama_buat
			from trans_m a
