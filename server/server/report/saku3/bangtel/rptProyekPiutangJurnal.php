...
class server_report_saku3_bangtel_rptProyekPiutangJurnal extends server_report_basic
{
	...
	function getHtml()
	{
       ...
       a.nik_user,b.nama as nama_buat,a.nik_app,c.nama as nama_setuju, d.kota,a.keterangan,a.no_dokumen,a.kode_proyek,a.no_kui,e.nama as namap 
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			echo "<table border='0' cellspacing='2' cellpadding='1'>
			  <tr>
				<td align='center' class='header_laporan'>JURNAL PIUTANG PROYEK</td>
			  </tr>
			  <tr>
				...
				<tr>
					<td class='header_laporan'>No Kuitansi </td>
					<td class='header_laporan'>:&nbsp;$row->no_kui</td>
				  </tr>
				</table></td>
			  </tr>
			  <tr>
