...
class server_report_saku3_bangtel_rptProyekReklasPddJurnal extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.no_piutang,a.kode_lokasi,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.kode_lokasi,
       a.nik_user,b.nama as nama_buat,a.nik_app,c.nama as nama_setuju, d.kota,a.keterangan,a.no_dokumen,a.kode_proyek,e.nama as namap 
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			echo "<table border='0' cellspacing='2' cellpadding='1'>
			  <tr>
				<td align='center' class='header_laporan'>JURNAL REKLAS PDD (PENDAPATAN)</td>
			  </tr>
			  <tr>
				<td><table border='0' cellspacing='2' cellpadding='1'>
				 
				  <tr>
					<td width='100' class='header_laporan'>No Reklas </td>
					<td width='496' class='header_laporan'>:&nbsp;$row->no_piutang</td>
					</tr>
				  <tr>
					<td width='100' class='header_laporan'>No Piutang </td>
					<td width='496' class='header_laporan'>:&nbsp;$row->no_dokumen</td>
					</tr>
				  <tr>
					<td width='100' class='header_laporan'>No Proyek </td>
					<td width='496' class='header_laporan'>:&nbsp;$row->kode_proyek |&nbsp;$row->namap</td>
					</tr>
				  <tr>
