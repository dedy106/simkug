...
class server_report_saku3_bangtel_rptPanjarPtgForm extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode=$tmp[2];
		$filter2=$tmp[3];
		$sql="select a.no_ptg,h.nik_buat,h.nik_setuju as nik_tahu,a.nik_app as nik_setuju,f.flag as nik_bdh,i.flag as nik_manbdh,h.kode_pp,h.nilai as nilai_pj,a.nilai as nilai_ptg,a.nilai_kas,
		h.akun_panjar,h.keterangan,substring(a.periode,1,4) as tahun,datepart(day,a.tanggal) as tgl,datepart(month,a.tanggal) as bulan,
...
from panjarptg2_m a
inner join panjar2_m h on a.no_panjar=h.no_panjar and a.kode_lokasi=h.kode_lokasi
...
left join karyawan d on h.nik_setuju=d.nik and h.kode_lokasi=d.kode_lokasi
left join karyawan e on a.nik_app=e.nik and h.kode_lokasi=e.kode_lokasi
...
inner join masakun g on a.akun_panjar=g.kode_akun and h.kode_lokasi=g.kode_lokasi
inner join lokasi j on a.kode_lokasi=j.kode_lokasi  $this->filter order by a.no_ptg";
  ...
  <tr>
    <td><table width='800' border='1' cellspacing='0' cellpadding='0' class='kotak'>
      <tr align='center'>
        <td class='header_laporan' height='23'>Tgl</td>
        <td class='header_laporan'>No SB </td>
        <td class='header_laporan'>Uraian Pengeluaran</td>
        <td class='header_laporan'>Jumlah</td>
        <td class='header_laporan'>No. Akun </td>
        <td class='header_laporan'>Keterangan</td>
      </tr>";
	  $i=1;
		$sql1="select a.no_ptg,date_format(a.tanggal,'%d/%m/%Y') as tanggal,a.kode_akun,a.nilai,a.kode_pp,a.kode_drk,a.keterangan
from panjarptg2_j a
where a.no_ptg='$row->no_ptg' and  a.modul='PJPTG' and a.jenis='BEBAN' order by a.kode_akun ";
      ...
      echo "<tr>
        <td class='isi_laporan' height='23'>$row1->tanggal</td>
...
where a.no_ptg='$row->no_ptg' and  a.modul in ('PJPTG','PRPTG') and a.jenis='BEBAN'
