...
class server_report_saku3_bangtel_rptBuktiJurnal extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select distinct a.no_bukti,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.kode_lokasi,a.periode,b.nama,a.nik_user,a.nik1,
				d.nama as nama_buat,e.nama as nama_setuju
				from trans_m a
				inner join lokasi b on a.kode_lokasi=b.kode_lokasi
				inner join karyawan d on a.nik_user=d.nik and d.kode_lokasi=a.kode_lokasi
				inner join karyawan e on a.nik1=e.nik and e.kode_lokasi=a.kode_lokasi
				$this->filter
				order by a.no_bukti ";
				// echo $sql;
