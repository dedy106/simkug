...
class server_report_saku3_bangtel_barang_rptPbrForm extends server_report_basic
{
...
$this->filter";
	...
	function getHtml()
	{
	   ...
	   c.nama as nama_pp,a.kode_pp,a.nik_user as nik_buat,d.nama as nama_buat,a.nik_app,e.nama as nama_app,f.kota,a.no_hutang,
	   g.keterangan as ket_spk,h.no_pesan,i.kode_proyek,i.nama as namapr
from yk_pb_m a
...
inner join log_spk_m g on a.kode_lokasi=g.kode_lokasi  and a.no_hutang=g.no_spk
inner join log_pesan_m h on h.kode_lokasi=g.kode_lokasi  and g.no_pesan=h.no_pesan
inner join spm_proyek i on h.kode_lokasi=i.kode_lokasi  and i.kode_proyek=h.kode_proyek
$this->filter order by a.no_pb";
  ...
  <tr align='center'>
    <td height='30' class='istyle17'>PERMOHONAN BAYAR PENGADAAN</td>
  </tr>
  <tr>
    <td><table width='800' border='0' cellspacing='2' cellpadding='1'>
        ...
        <tr>
          <td align='left'><table width='600' border='0' cellspacing='2' cellpadding='1'>
            ...
            <tr>
              <td>Nama Proyek</td>
              <td>: $row->kode_proyek | $row->namapr </td>
            </tr>
...
where a.no_pb='$row->no_pb' and a.kode_lokasi='$row->kode_lokasi' ";
      ...
      <tr align='center'>
		...
		$sql="select b.nama as nama_vendor,a.bank,a.cabang,a.no_rek,a.nilai,a.pajak
from yk_pb_d a
inner join vendor b on a.kode_vendor=b.kode_vendor and a.kode_lokvendor=b.kode_lokasi
		where a.no_pb='$row->no_pb' and a.kode_lokasi='$row->kode_lokasi'
		union all
		select b.nama as nama_vendor,a.bank,a.cabang,a.no_rek,a.nilai,a.pajak
from yk_pb_d a
