...
class server_report_saku3_bangtel_barang_rptSpk extends server_report_basic
{	
	...
	function getHtml()
	{
	   ...
	   a.no_pesan,c.kode_proyek,d.nama as nama_proyek
from log_spk_m a 
inner join vendor b on a.kode_vendor=b.kode_vendor and a.kode_lokasi=b.kode_lokasi
inner join log_pesan_m c on c.no_pesan=a.no_pesan and a.kode_lokasi=c.kode_lokasi
inner join spm_proyek d on c.kode_proyek=d.kode_proyek and d.kode_lokasi=c.kode_lokasi
$this->filter
order by a.no_spk";
      ...
      <tr>
	   ...
	   <tr>
        ...
        <td class='header_laporan'>:&nbsp;$row->keterangan</td>
	     ...
	     <tr>
        <td class='header_laporan' width='114'>Kode Proyek </td>
