...
class server_report_saku3_bangtel_rptProyekPiutang extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode=$tmp[0];
		$nama_cab=$tmp[1];
		$sql="select a.no_piutang,a.kode_lokasi,a.no_dokumen,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.kode_proyek,a.keterangan,
		a.nilai,a.nilai_ppn, a.nilai+a.nilai_ppn as nilai,a.nilai as tagihan,b.nama as nama_cust,a.modul,a.no_kui
...
$this->filter order by a.no_piutang";
   ...
   <tr bgcolor='#CCCCCC'>
	 ...
	 <td width='150'  align='center' class='header_laporan'>No Kuitansi</td>
	 ...
	 <td class='isi_laporan'>$row->no_kui</td>
