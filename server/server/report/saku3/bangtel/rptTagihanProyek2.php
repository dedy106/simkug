...
class server_report_saku3_bangtel_rptTagihanProyek2 extends server_report_basic
{
	...
	function getHtml()
	{
       ...
       $sql="select a.kode_lokasi,a.no_piutang,'proyek' as kode,a.kode_pp,a.no_piutang,a.akun_piutang,a.no_dokumen,convert(varchar,a.tanggal,103) as tgl, a.keterangan, a.kode_cust,a.kode_pp,a.periode,a.nilai,a.nilai_ppn,a.no_fpajak,b.nama as nama_cust,c.nama as nama_pp,a.nilai_ppn+a.nilai as total 
        ...
        <tr bgcolor='#CCCCCC'>
            ...
            <td width='60' align='center' class='header_laporan'>PPH</td>
        </tr>";
		$nilai=0;$nilai_ppn=0;$nilai_pph=0;
		...
		echo"<td class='isi_laporan'>$row1->akun_pdpt</td>";
			$sql2="select b.kode_akun as akun_pph, b.nilai as nilai_pph from spm_billbayar_d a
            left join kas_j b on a.no_bukti=b.no_kas and a.kode_lokasi=b.kode_lokasi
            where a.no_piutang='$row->no_piutang' and b.kode_akun like '5%'
            union all
            select b.kode_akun as akun_pph, b.nilai as nilai_pph from piubayar_d a
            left join kas_j b on a.no_bukti=b.no_kas and a.kode_lokasi=b.kode_lokasi
            where a.no_piutang='$row->no_piutang' and b.kode_akun like '5%'
            ";
            ...
            $nilai_pph=$nilai_pph+$row2->nilai_pph;	
		...
		echo "</td></td>
            ...
            <td class='isi_laporan' align='right'>".number_format($row2->nilai_pph,0,",",".")."</td>
            </tr>";
			$i=$i+1;
		}
		echo "<tr >
