...
class server_report_saku3_bangtel_rptPbForm extends server_report_basic
{
...
$this->filter";
	...
	function getHtml()
	{
	   ...
	   c.nama as nama_pp,a.kode_pp,a.nik_user as nik_buat,d.nama as nama_buat,a.nik_app,e.nama as nama_app,f.kota
from yk_pb_m a
...
$this->filter order by a.no_pb";
  ...
  <tr align='center'>
    <td height='30' class='istyle17'>PERMOHONAN PEMBAYARAN UMUM</td>
  </tr>
  <tr>
