...
class server_report_saku3_bangtel_rptPanjarPtgPos extends server_report_basic
{
	...
	function getHtml()
	{
       ...
       g.no_bukti as no_kas,date_format(g.tanggal,'%d/%m/%Y') as tgl_kas,a.no_final
from panjarptg2_m a
...
left join trans_m g on f.no_kas=g.no_bukti and f.kode_lokasi=g.kode_lokasi
