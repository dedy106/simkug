...
class server_report_saku3_if_rptIfKartu extends server_report_basic
{
...
";
		 ...
		 c.nama as nama_akun,a.tanggal
from if_aju_m a
inner join if_reim_m b on a.no_reim=b.no_reim and a.kode_lokasi=b.kode_lokasi
inner join masakun c on a.kode_akun=c.kode_akun and a.kode_lokasi=c.kode_lokasi
where b.nik_buat='$row->nik' and a.kode_lokasi='$row->kode_lokasi'
union
select b.no_kas as no_bukti,a.no_dokumen,b.kode_lokasi,date_format(b.tanggal,'%d/%m/%Y') as tgl,a.akun_hutang as kode_akun,a.kode_pp,'-' as kode_drk,a.keterangan,0 as nilai,a.nilai as nilai_kas,
		  c.nama as nama_akun,a.tanggal
from if_reim_m a
...
where a.nik_buat='$row->nik' and a.kode_lokasi='$row->kode_lokasi' 
order by a.tanggal
 ";
