...
class server_report_saku3_if_rptReimbForm extends server_report_basic
{
...
order by a.no_reim";
  ...
  <tr>
    <td colspan='2' align='center'><table width='100%' border='0' cellpadding='0' cellspacing='0'>
      <tr>
        <td align='center' class='lokasi_laporan2'><u>DAFTAR PERTANGGUNGAN PANJAR INSIDENTIL</u></td>
      </tr>
      <tr>
...
from if_reim_j a
inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi
where a.no_reim='$row->no_reim' and a.kode_lokasi='$row->kode_lokasi' and a.dc='D'
order by a.tanggal ";
