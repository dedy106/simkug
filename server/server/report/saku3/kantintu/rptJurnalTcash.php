...
class server_report_saku3_kantintu_rptJurnalTcash extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.no_bukti,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.kode_lokasi,
       a.nik_user,b.nama as nama_buat,a.keterangan 
			from trans_m a
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			echo "<table border='0' cellspacing='2' cellpadding='1'>
			  <tr>
				<td align='center' class='header_laporan'>Jurnal Penyelesaian Piutang Tcash</td>
			  </tr>
			  <tr>
