...
class server_report_saku3_sju16_rptAggKpaAkunPp extends server_report_basic
{
...
";	
				...
				$sql="select a.no_bukti,a.no_dokumen,convert(varchar(20),a.tanggal,103) as tgl,a.kode_akun,a.keterangan,a.kode_lokasi,a.periode,a.kode_pp,
						   case when a.dc='D' then a.nilai else 0 end as debet,case when a.dc='C' then nilai else 0 end as kredit
					from trans_j a
					where a.kode_lokasi='$row->kode_lokasi' and substring(periode,1,4)='$tahun' and kode_akun='$row->kode_akun' and kode_pp='$row->kode_pp' 
					order by a.tanggal ";
    ...
    <td height='23' valign='top' class='isi_laporan'>".$row1->kode_pp."</td>
