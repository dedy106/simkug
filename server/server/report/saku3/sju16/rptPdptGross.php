...
class server_report_saku3_sju16_rptPdptGross extends server_report_basic
{
	...
	function getHtml()
	{
		...
		if ($kode_pp=="")
		{
			$sql="exec sp_dw_produksi '$kode_lokasi','$periode','$nik_user';";
		}
		else
		{
			$sql="exec sp_dw_produksi_pp '$kode_lokasi','$periode','$nik_user';";
			$sql2="select nama from pp where kode_lokasi='$kode_lokasi' and kode_pp='$kode_pp'";
  ...
  <tr>
    <td align='center'><table  border='0' cellspacing='2' cellpadding='1'>
      ...
      <tr>
        <td align='center' class='style16'>$nama_pp</td>
      </tr>
