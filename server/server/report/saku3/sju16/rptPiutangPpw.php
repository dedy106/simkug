...
class server_report_saku3_sju16_rptPiutangPpw extends server_report_basic
{
...
order by a.due_date ";
		...
		<tr >
     <td width='30'  class='lokasi_laporan2' colspan='11'>AKAN JATUH TEMPO</td>
   </tr>
   <tr bgcolor='#CCCCCC'>
...
order by a.due_date desc";
		...
		echo "<table border='1' cellspacing='0' cellpadding='0' class='kotak' width='1200'>
		<tr >
     <td width='30' class='lokasi_laporan2' colspan='11'>SUDAH JATUH TEMPO</td>
   </tr>
   <tr bgcolor='#CCCCCC'>
     <td width='30'   align='center' class='header_laporan'>No</td>
	 <td width='60'  align='center' class='header_laporan'>Tgl Jatuh Tempo</td>
