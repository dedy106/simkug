...
class server_report_saku3_sju16_rptGlTb extends server_report_basic
{
	...
	function getHtml()
	{
		...
		if ($pp=="All")
		{
			...
			if ($periode2!="")
			{
				$sql2="exec sp_glma2_dw_tmp '$kode_lokasi','$periode2','$nik_user' ";
		...
		else
		{
			...
			if ($periode2!="")
			{
				$sql2="exec sp_glma2_pp_dw_tmp '$kode_lokasi','$periode2','$nik_user' ";
			...
			if ($trail=="1")
			{
				$sql = "select a.kode_lokasi,a.kode_akun,a.nama,a.so_awal,a.periode,a.debet,a.kredit,a.so_akhir,a.kode_pp
				from glma_pp_tmp a
				inner join relakun b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi
				$this->filter and a.nik_user='$nik_user' $tmp
				order by a.kode_akun";
