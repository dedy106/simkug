...
class server_report_saku3_sju16_rptPrPolis extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode=$tmp[0];
		$jenis=$tmp[1];
		$sql="select  a.no_polis,c.nama as nama_cust,d.no_dok,a.diskon,d.no_dok2,e.nama as nama_vendor,f.nama as nama_pic,a.no_bill,d.kode_pic,d.kode_tipe,
		...
		isnull(g.no_bukti,'-') as no_kas,isnull(g.no_kashut,'-') as no_kashut,a.ke,isnull(k.jum,0) as jum,
		d.nik_user as nik_polis,l.nik_user as nik_quo,n.nik_user as nik_placing,
		o.nama as nama_polis,p.nama as nama_quo,q.nama as nama_placing,date_format(a.due_date,'%d/%m/%Y') as due_date
...
left join (select a.no_polis,a.kode_lokasi,count(a.no_polis) as jum 
		   ...
		   )k on a.no_polis=k.no_polis and a.kode_lokasi=k.kode_lokasi
left join sju_app_m l on j.no_app=l.no_app and j.kode_lokasi=l.kode_lokasi
left join sju_placing_m m on d.no_placing=m.no_placing and d.kode_lokasi=m.kode_lokasi
left join sju_app_m n on m.no_app=n.no_app and m.kode_lokasi=n.kode_lokasi
...
left join karyawan q on n.nik_user=q.nik and n.kode_lokasi=q.kode_lokasi
$this->filter  order by a.no_polis ";
  ...
  <tr>
    <td><table width='600' border='0' cellspacing='2' cellpadding='1'>
      ...
      <tr>
        <td class='isi_bukti'>Account Manager</td>
        <td class='isi_bukti'>: $row->nama_pic </td>
      </tr>
      <tr>
        <td  class='isi_bukti'>Nomor Polis</td>
        <td  class='isi_bukti'>: $row->no_dok | $row->no_dok2 </td>
      </tr>
      <tr>
	  ...
	  <tr>
        <td class='isi_bukti'>Tanggal Jatuh Tempo (PPW)</td>
	  ...
	  <tr>
        <td class='isi_bukti'>Termin</td>
        <td class='isi_bukti'>: $row->ke dari $row->jum</td>
      </tr>
    </table></td>
  </tr>
  ...
  <tr>
    <td><table width='600' border='1' cellspacing='0' cellpadding='0' class='kotak'>
	  ...
	  <tr>
        <td colspan='3' class='isi_bukti' >Diskon</td>
        <td align='center' class='isi_bukti'>$row->kode_curr</td>
        <td class='isi_bukti' align='right'>".number_format($row->diskon,2,',','.')."</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td align='center' class='isi_bukti'>$row->kode_curr</td>
        <td class='isi_bukti' align='right'>".number_format($row->premi+$row->p_cost+$row->materai-$row->diskon,2,',','.')."</td>
      </tr>
      <tr>
  ...
  <tr>
    ...
    <td class='isi_bukti'> $row->nama_placing</td>
  </tr>
</table></td>
  </tr>
  <tr>
