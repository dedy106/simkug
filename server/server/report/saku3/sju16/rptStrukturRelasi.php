...
class server_report_saku3_sju16_rptStrukturRelasi extends server_report_basic
{
...
order by a.kode_neraca,b.kode_akun ";
		...
		echo $AddOnLib->judul_laporan("data relasi akun laporan keuangan",$this->lokasi,"");
