...
class server_report_saku3_sju16_rptPrPolisList extends server_report_basic
{
  ...
  <tr>
    <td align='center'><table  border='0' cellspacing='2' cellpadding='1' >
      ...
      <tr>
        <td>&nbsp;</td>
        <td align='center' class='style16'>LAPORAN POSISI POLIS </td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
  ...
  <tr>
    <td><table  border='1' cellpadding='0' cellspacing='0' class='kotak' width='2700'>
      <tr align='center' bgcolor='#dbeef3'>
		...
		<td width='60' rowspan='2' class='header_laporan'>Tgl Quotation</td>
		...
		<td width='60' rowspan='2' class='header_laporan'>Tgl Premi</td>
		<td width='100' rowspan='2' class='header_laporan'>Pembayaran Hutang Premi</td>
		<td width='60' rowspan='2' class='header_laporan'>Tgl Hutang Premi</td>
		<td width='100' rowspan='2' class='header_laporan'>Endorsement</td>
      </tr>
...
order by d.kode_tipe,a.no_polis";
			...
			$i=1;
			$total=0; $premi=0; $fee=0; $ppn=0; $pph=0; $biaya_adm=0; $diskon=0;
			while ($row1 = $rs1->FetchNextObject($toupper=false))
			{
			  ...
			  echo "<tr>
				...
				<td class='isi_laporan'>$row1->ke</td>
				...
				<td class='isi_laporan' align='right'>".number_format($row1->premi+$row1->biaya_adm-$row1->diskon,2,',','.')."</td>";
				...
				echo"<td class='isi_laporan'>$row1->tgl_placing</td>";
 				echo "<td class='isi_laporan'><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenJurnal('$row1->no_bill','$row1->kode_lokasi');\">$row1->no_bill</a></td>";
				echo "<td class='isi_laporan'>$row1->tgl_bill</td>";
			  ...
			  echo "<td class='isi_laporan'>$row1->no_polisseb</td>
			  </tr>";
				$i=$i+1;
			 }
			$tot_total+=$total;
			...
			$tot_pph+=$pph;
      echo "<tr>
        <td colspan='14' align='center' class='header_laporan'>Jumlah</td>
		...
		<td class='isi_laporan' align='right'>".number_format($premi+$biaya_adm-$diskon,2,',','.')."</td>
      </tr>";
