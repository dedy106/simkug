...
class server_report_saku3_sju16_rptHutang extends server_report_basic
{
	...
	function getHtml()
	{
	   ...
	   (a.premi+a.p_cost+a.materai-a.fee-a.diskon-a.ppn+a.pph)*a.kurs as hutang,
	   a.kode_vendor,e.nama as nama_vendor
...
order by c.no_bukti ";
		...
		echo $AddOnLib->judul_laporan("hutang detail" ,$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
