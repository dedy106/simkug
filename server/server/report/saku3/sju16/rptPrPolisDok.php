...
class server_report_saku3_sju16_rptPrPolisDok extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode=$tmp[0];
		$nama_cab=$tmp[1];
		$sql="select a.no_polis,a.kode_lokasi,a.no_gambar,a.kode_jenis
		...
		echo $AddOnLib->judul_laporan("dokumen polis",$this->lokasi,"");
		echo "<table border='1' cellspacing='0' cellpadding='0' class='kotak' width='600'>
   <tr bgcolor='#CCCCCC'>
     <td width='30'  align='center' class='header_laporan'>No</td>
     <td width='80'  align='center' class='header_laporan'>No Polis</td>
