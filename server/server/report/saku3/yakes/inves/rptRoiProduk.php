...
class server_report_saku3_yakes_inves_rptRoiProduk extends server_report_basic
{
	...
	function getHtml()
	{
        ...
        $sql = "select tanggal,round(nab,0) as nab
        ...
        , roi_persen,(roi_hitung2-1)*100 as roi_hari
        from inv_roi_subkelas 
        $this->filter
        ...
        echo"<table style='border-collapse: collapse;margin:10px' cellspacing='2' cellpadding='1' width='985'>
                ...
                <thead>
                    <tr>
                        <th colspan='14' style='font-size:14px;text-align:left'>LAPORAN ROI PRODUK YAKES TELKOM </th>
                    </tr>
