...
class server_report_saku3_yakes_inves_rptClosingRdOnline extends server_report_basic
{
        ...
        th{
          ...
          <script type='text/javascript'>
            ...
            function clearTmp(){
                $.ajax({
                    type: 'GET',
                    url: '$root_ser/ClosingRd.php?fx=clearTmp',
                    dataType: 'json',
            ...
            var dataTable = $('#table-shm').DataTable({
                'ajax': {
                    'url': '$root_ser/ClosingRd.php?fx=getHarga',
                    'type': 'GET',
            ...
            $('#nw_container').on('click', '#load-data', function(e){
                ...
                $.ajax({
                    type: 'POST',
                    url: '$root_ser/ClosingRd.php?fx=simpanTmp',
                    dataType: 'json',
                    success:function(result){
            ...
            $('#nw_container').on('click', '#saveBtn', function(e){
                ...
                $.ajax({
                    type: 'POST',
                    url: '$root_ser/ClosingRd.php?fx=simpan',
                    dataType: 'json',
                    success:function(result){
                        alert('Input data '+result.message);
                        if(result.status){
