...
class server_report_saku3_yakes_inves_rptDepPenempatanDOC extends server_report_basic
{
...
left join inv_depo2_m d on a.no_shop=d.no_shop and a.kode_lokasi=d.kode_lokasi and d.jenis = 'DOC'
    ...
    .printND{
       margin-top:3.5cm;
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
            ...
            echo "<table width='800' border='0' cellspacing='2' cellpadding='1' style='text-align: justify'>
            <tr>
