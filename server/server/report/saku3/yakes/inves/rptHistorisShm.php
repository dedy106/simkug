...
class server_report_saku3_yakes_inves_rptHistorisShm extends server_report_basic
{
	...
	function getHtml()
	{
        ...
        from inv_saham_kkp $this->filter
        order by tanggal ";
        // echo $sql;
        ...
        echo"<table style='border-collapse: collapse; width: 1083px;' cellspacing='2' cellpadding='1'>
                ...
                <thead>
                    <tr>
                        <th  colspan='14' style='font-size:14px'>HISTORIS DAN KKP SAHAM YAKES-TELKOM</th>
                    </tr>
                    <tr >
                ...
                <tbody>
                    <tr style=''>
                        ...
                        <td style='border-top: medium none; text-align:center' >Harga Rata-Rata Per Saham (Rp)</td>
                        <td style='border-top: medium none; text-align:center' >Jumlah (Rp)</td>
                        <td style='border-top: medium none; width: 52px;text-align:center' >Harga per Lembar Saham (Rp)</td>
                        <td style='border-top: medium none; text-align:center' >Jumlah (Rp)</td>
                    </tr>
                    ";
