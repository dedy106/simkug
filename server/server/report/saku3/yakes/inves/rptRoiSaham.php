...
class server_report_saku3_yakes_inves_rptRoiSaham extends server_report_basic
{
	...
	function getHtml()
	{
        ...
        $sql = "select distinct a.kode_kelola,b.nama
        ...
        if($res->recordCount() == 1){
            $nama_kelola = strtoupper($res->fields[1]);
        }else{
            $nama_kelola = "";
        }

        $sql = "select a.tanggal,a.nab
        ...
        echo"<table style='border-collapse: collapse;margin:10px' cellspacing='2' cellpadding='1' width='985'>
                ...
                <thead>
                    <tr>
                        <th colspan='14' style='font-size:14px;text-align:left'>LAPORAN ROI PRODUK SAHAM $nama_kelola</th>
                    </tr>
