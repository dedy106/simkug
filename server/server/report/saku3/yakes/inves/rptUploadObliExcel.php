...
class server_report_saku3_yakes_inves_rptUploadObliExcel extends server_report_basic
{
        ...
        th{
          ...
          <script type='text/javascript'>
            ...
            function getPeriode(){
                $.ajax({
                    type: 'GET',
                    url: '$root_ser/UploadExcelObli.php?fx=getPeriode2',
                    dataType: 'json',
            ...
            function clearTmp(){
              $.ajax({
                  type: 'GET',
                  url: '$root_ser/UploadExcelObli.php?fx=clearTmpObli',
                  dataType: 'json',
                  data: {'kode_lokasi':'$kode_lokasi'},
                  success:function(result){  
                      if(result.status){
          ...
          var dataTable = $('#table-Obli').DataTable({
            'ajax': {
                'url': '$root_ser/UploadExcelObli.php?fx=getHargaObli2',
                'data': {'kode_lokasi':'$kode_lokasi','periode':'$periode'},
                'type': 'GET',
                'dataSrc' : function(json) {
                    return json.data;   
          ...
          $('#nw_container').on('submit', '#nw_form_insert', function(e){
            ...
            $.ajax({
              type: 'POST',
              url: '$root_ser/UploadExcelObli.php?fx=simpanObliTmp',
              dataType: 'json',
              data: formData,
              contentType: false,
              cache: false,
          ...
          $('#nw_container').on('click', '#saveBtn', function(e){
            ...
            if(per ==''){
              ...
              $.ajax({
                type: 'POST',
                url: '$root_ser/UploadExcelObli.php?fx=simpanObliHarga',
                dataType: 'json',
