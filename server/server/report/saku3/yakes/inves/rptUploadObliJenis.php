...
class server_report_saku3_yakes_inves_rptUploadObliJenis extends server_report_basic
{
        ...
        th{
                    ...
                    <div class='col-xs-12'>
                      <div class='nav-tabs-custom'>
                          <ul class='nav nav-tabs'>
                            <li class='active'><a href='#tab_1' data-toggle='tab' aria-expanded='true'>Jenis Obligasi</a></li>
          ...
          <script type='text/javascript'>
            ...
            function getPeriode(){
                $.ajax({
                    type: 'GET',
                    url: '$root_ser/UploadObliJenis.php?fx=getPeriode2',
                    dataType: 'json',
          ...
          function clearTmp(){
              $.ajax({
                  type: 'GET',
                  url: '$root_ser/UploadObliJenis.php?fx=clearTmpObli',
                  dataType: 'json',
                  data: {'kode_lokasi':'$kode_lokasi'},
                  success:function(result){  
                      if(result.status){
          ...
          var dataTable = $('#table-Obli').DataTable({
            'ajax': {
                'url': '$root_ser/UploadObliJenis.php?fx=getObliJenis',
                'data': {'kode_lokasi':'$kode_lokasi'},
                'type': 'GET',
          ...
          $('#nw_container').on('submit', '#nw_form_insert', function(e){
            ...
            $.ajax({
              type: 'POST',
              url: '$root_ser/UploadObliJenis.php?fx=simpanObliTmp',
              dataType: 'json',
              data: formData,
              contentType: false,
              cache: false,
          ...
          $('#nw_container').on('click', '#saveBtn', function(e){
            ...
            // }else{
              $.ajax({
                type: 'POST',
                url: '$root_ser/UploadObliJenis.php?fx=simpanObliJenis',
                dataType: 'json',
                data: {'kode_lokasi':'$kode_lokasi'},
                success:function(result){
                  alert('Input data '+result.message);
