...
class server_report_saku3_yakes_inves_rptDocKkpSaldo extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.no_depo,bb.nama as no_dokumen,date_format(a.tanggal,'%d/%m/%Y') as tanggal,a.keterangan,a.jenis,
...
inner join inv_plan bb on a.kode_plan=bb.kode_plan
left join inv_depotutup_m cc on a.no_depo=cc.no_depo and cc.periode <= '$periode' 
...
$this->filter and cc.no_depo is null order by bb.nama desc,a.jenis,a.no_depo";
...
//echo $sql;
		...
		echo $AddOnLib->judul_laporan("Deposito Outstanding",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
		echo "<table border='1' cellspacing='0' cellpadding='0' class='kotak'>
   <tr bgcolor='#CCCCCC'>
     <td width='30'  align='center' class='header_laporan'>No</td>
	 <td width='80'  align='center' class='header_laporan'>No Bukti</td>
	 <td width='80'  align='center' class='header_laporan'>Plan Asset</td>
     ...
     <td width='90'  align='center' class='header_laporan'>Nilai Penempatan</td>
	 ...
	 <td width='40'  align='center' class='header_laporan'>Jumlah Hari</td>
	  <td width='60'  align='center' class='header_laporan'>Basis</td>
