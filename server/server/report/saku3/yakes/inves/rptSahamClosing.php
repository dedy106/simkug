...
class server_report_saku3_yakes_inves_rptSahamClosing extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode=$tmp[1];
		$nik_user=$tmp[2];
		$sql="exec sp_shmharga_lap '$periode','$nik_user'";
		
		$rs = $dbLib->execute($sql);	
		
		
		$sql="select a.kode_saham,b.nama,a.tgl1, a.tgl2, a.tgl3, a.tgl4, a.tgl5, a.tgl6, a.tgl7, a.tgl8, a.tgl9, a.tgl10, 
		...
		echo $AddOnLib->judul_laporan("laparan closing saham",$this->lokasi,"Periode $periode");
