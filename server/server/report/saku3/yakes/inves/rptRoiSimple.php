...
class server_report_saku3_yakes_inves_rptRoiSimple extends server_report_basic
{
	...
	function getHtml()
	{
        ...
        $sql = "select * from inv_roitot_simple 
        $this->filter
        ";
        $rs=$dbLib->execute($sql);
        ...
        echo"<table style='border-collapse: collapse;margin:10px' cellspacing='2' cellpadding='1' width='1165'>
                ...
                <thead>
                    <tr>
                        <th colspan='14' style='font-size:14px;text-align:left'>LAPORAN ROI SIMPLE DIETZ YAKES TELKOM </th>
                    </tr>
