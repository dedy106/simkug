...
class server_report_saku3_tm_rptTakTerima extends server_report_basic
{
...
left join  karyawan e on a.nik_setuju=e.nik and a.kode_lokasi=e.kode_lokasi $this->filter
...
where a.no_terima='$row->no_terima' order by a.dc desc";
