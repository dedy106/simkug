...
class server_report_saku3_tm_rptBddDisJurnal extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.no_bukti,a.no_dokumen,a.kode_lokasi,a.periode,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.kode_lokasi,
       a.nik_user,b.nama as nama_buat,b.jabatan as jabatan_buat,a.nik_app
from tu_prbeban_m a
...
left join karyawan c on a.nik_app=c.nik and a.kode_lokasi=c.kode_lokasi $this->filter";
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			echo "<table border='0' cellspacing='2' cellpadding='1'>
			  <tr>
				<td align='center' class='header_laporan'>JURNAL DISTRIBUSI BEBAN</td>
			  </tr>
			  <tr>
			  ...
			  <tr>
				...
				<td width='10' class='header_laporan'><div align='center'>ID Proyek </div></td>
				<td width='10' class='header_laporan'><div align='center'>Periode Bill</div></td>
