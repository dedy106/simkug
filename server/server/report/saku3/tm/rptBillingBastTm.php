...
class server_report_saku3_tm_rptBillingBastTm extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql2="exec sp_yk_bill_lap_bast_tm '$no_bill','$kode_lokasi','$nik_user' ";
...
where  a.nik_user='$nik_user' $loker
