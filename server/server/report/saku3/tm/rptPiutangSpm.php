...
class server_report_saku3_tm_rptPiutangSpm extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode=$tmp[0];
		$nama_cab=$tmp[1];
		$sql="select a.no_piutang,a.kode_lokasi,a.no_dokumen,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,
		a.nilai,a.nilai_ppn,a.nilai_pph, a.nilai+a.nilai_ppn-a.nilai_pph as nilai,a.nilai as tagihan,b.nama as nama_cust
from piutang_m a
