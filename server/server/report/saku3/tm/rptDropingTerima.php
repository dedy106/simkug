...
class server_report_saku3_tm_rptDropingTerima extends server_report_basic
{
    ...
    echo "</table></td>
	  ...
	  <tr>
            <td colspan='7' style='padding:10px' ><table border='1' cellspacing='2' cellpadding='1' class='kotak'>
              <tr bgcolor='#CCCCCC'>
                <td width='60' class='header_laporan' align='center'>Kode Pengirim</td>
                <td width='200' class='header_laporan' align='center'>Nama Lokasi Pengirim</td>
                <td width='300' class='header_laporan' align='center'>Keterangan</td>
                <td width='90' class='header_laporan' align='center'>Nilai</td>
              </tr>";
			  $sql1="select a.kode_lokasi,b.nama,a.keterangan,a.nilai 
from yk_kasdrop_d a
inner join lokasi b on a.kode_lokasi=b.kode_lokasi
where a.no_kasterima='$row->no_kas' ";
			  
			  $rs1 = $dbLib->execute($sql1);
			  while ($row1 = $rs1->FetchNextObject($toupper=false))
			{
              echo "<tr>
                <td class='isi_laporan'>$row1->kode_lokasi</td>
