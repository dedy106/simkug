...
class server_report_saku3_tm_rptCustSpm extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode=$tmp[0];
		$nama_cab=$tmp[1];
		$sql="select a.kode_cust, a.nama, a.alamat, a.no_tel, a.email, a.npwp, a.pic, a.alamat2,a.kode_pp
from cust a
