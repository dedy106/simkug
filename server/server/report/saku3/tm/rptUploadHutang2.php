...
class server_report_saku3_tm_rptUploadHutang2 extends server_report_basic
{
      ...
      echo"
        ...
        th{
          ...
          function clearTmp(){
              $.ajax({
                  type: 'GET',
                  url: '$root_ser/UploadExcel2.php?fx=clearTmpHut',
                  dataType: 'json',
          ...
          var dataTable = $('#table-hut').DataTable({
            ...
            // 'serverSide': true,
            'ajax': {
                'url': '$root_ser/UploadExcel2.php?fx=getHutTmp',
                'data': {'kode_lokasi':'$kode_lokasi'},
                'type': 'GET',
        ...
        $('#nw_container').on('submit', '#nw_form_insert', function(e){
            ...
            $.ajax({
              type: 'POST',
              url: '$root_ser/UploadExcel2.php?fx=simpanHutTmp',
              dataType: 'json',
              data: formData,
              contentType: false,
              cache: false,
          ...
          $('#nw_container').on('click', '#saveBtn', function(e){
            ...
            if(per ==''){
              ...
              $.ajax({
                type: 'POST',
                url: '$root_ser/UploadExcel2.php?fx=simpanHut',
                dataType: 'json',
