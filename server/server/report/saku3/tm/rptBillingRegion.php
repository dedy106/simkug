...
class server_report_saku3_tm_rptBillingRegion extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$bpcc=$tmp[4];
		$jenis=$tmp[5];
		$nama_file="billing_".$no_bareg.".xls";
		$loker = "";
		if ($bpcc == "BP") {
		...
		$sql2="exec sp_yk_bill_lap_region '$no_bareg','$kode_lokasi','$nik_user' ";
		
		$rs2 = $dbLib->execute($sql2);
		
		$sql = "select a.no_bareg as no_valid,date_format(a.tanggal,'%d-%m-%Y') as tanggal,a.periode,a.keterangan,'-' as no_load,'-' as ket_load
from yk_bareg_m a
where  a.kode_lokasi='$kode_lokasi' and a.no_bareg='$no_bareg'";
      ...
      <tr>
       ...
       a.n1,a.n2,a.n3,a.n4,a.n5,a.n6,a.n7,a.n8,a.n9,a.n10,a.n11,a.n12,a.n13,a.n14,a.n15,a.n16,a.n17,a.n18,a.n19,a.n20,a.n21,a.no_batch,a.kode_keg,a.no_rujuk,a.no_hutang,a.no_piutang,a.no_tak,a.no_selesai
from yk_bill_lap a
