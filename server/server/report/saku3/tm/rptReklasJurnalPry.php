...
class server_report_saku3_tm_rptReklasJurnalPry extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.no_reklas,a.kode_lokasi,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.kode_lokasi,
       a.nik_user,b.nama as nama_buat,a.nik_setuju,c.nama as nama_setuju, d.kota,a.keterangan,a.no_dokumen 
			  ...
			  <tr>
				<td><table border='0' cellspacing='2' cellpadding='1'>
				  ...
				  <tr>
					...
					<td width='496' class='header_laporan'>:&nbsp;$row->no_reklas</td>
					</tr>
				  <tr>
	  ...
	  $sql1="select a.kode_akun,b.nama,a.keterangan,a.kode_pp,a.kode_drk,case dc when 'D' then nilai else 0 end as debet,case dc when 'C' then nilai else 0 end as kredit  
			...
			where a.no_reklas='$row->no_reklas' and a.kode_lokasi='$row->kode_lokasi'
			order by a.no_urut ";
		//error_log($sql1);
