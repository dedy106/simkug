...
class server_report_saku3_tm_rptPiutangSaldoSpmPry extends server_report_basic
{
	...
	function getHtml()
	{
		...
		a.nilai+a.nilai_ppn as nilai,a.nilai_ppn,a.nilai as tagihan,b.nama as nama_cust,
   ...
   <tr bgcolor='#CCCCCC'>
	 ...
	 <td width='90'  align='center' class='header_laporan'>Total Piutang</td>
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			...
			if ($row->saldo==0)
			{
				$sql="select MAX(b.tanggal) as tgl_kas
					from spm_billbayar_d a
