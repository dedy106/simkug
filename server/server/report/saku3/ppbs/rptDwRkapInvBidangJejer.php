...
class server_report_saku3_ppbs_rptDwRkapInvBidangJejer extends server_report_basic
{
  ...
  <tr bgcolor='#CCCCCC'>
    <td align='center' width='300' class='header_laporan'>Deskripsi</td>";
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			...
			$tmp_sql.="sum(case when kode_bidang='$row->kode_bidang' then n13 else 0 end) as 'n13$row->kode_bidang',";
			$tmp_sql2.="sum(case when d.kode_bidang='$row->kode_bidang' then n13 else 0 end) as 'n13$row->kode_bidang',";
