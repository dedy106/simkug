...
class server_report_saku3_ppbs_rptAggPpTu extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		$sql = "select a.kode_pp,b.nama as nama_pp,a.kode_akun,c.nama as nama_akun,
...
from (select a.kode_lokasi,a.kode_akun,substring(a.periode,1,4) as tahun,a.kode_pp 	
	  from agg_d a
	  inner join masakun c on a.kode_akun=c.kode_akun and a.kode_lokasi=c.kode_lokasi
	  $this->filter
	  group by a.kode_lokasi,a.kode_akun,substring(a.periode,1,4),a.kode_pp
	  ) a  
inner join agg_pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi and b.tahun='$tahun'
inner join masakun c on a.kode_akun=c.kode_akun and a.kode_lokasi=c.kode_lokasi
left join (select a.kode_lokasi,a.kode_pp,a.kode_akun,	 
	 ...
	 group by a.kode_lokasi,a.kode_akun,a.kode_pp 
		 )g on a.kode_lokasi=g.kode_lokasi and a.kode_pp=g.kode_pp and a.kode_akun=g.kode_akun 
...
<td width='90' class='header_laporan' align='center'>September</td>
  ...
  <td class='isi_laporan' align='right'>".number_format($row->total,0,',','.')."</td>
		...
		echo "<tr>
  <td height='23' class='isi_laporan' align='center' colspan='5'>Total</td>
