...
class server_report_saku3_ppbs_rptDwRkapOutPp extends server_report_basic
{
	...
	function getHtml()
	{
		...
		while ($row2 = $rs2->FetchNextObject($toupper=false))
		{
			...
			echo $AddOnLib->judul_laporan("LAPORAN REKAP OUTLOOK LABARUGI",$this->lokasi."<br>".$row2->nama,"TAHUN $tahun");
