...
class server_report_saku3_ppbs_rptGedung extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode=$tmp[0];
		$nama_cab=$tmp[1];
		$sql="select a.kode_gedung,a.nama,a.kode_klp,b.nama as nama_klp
        from log_gedung a
        inner join log_gedung_klp b on a.kode_klp=b.kode_klp and a.kode_lokasi=b.kode_lokasi
        $this->filter order by a.kode_gedung";
        ...
        <tr bgcolor='#CCCCCC'>
            ...
            <td width='80'  align='center' class='header_laporan'>Kode Klp</td>
            <td width='200'  align='center' class='header_laporan'>Nama Klp</td>
	    </tr>  ";
