...
class server_report_saku3_ppbs_rptRkmNon extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode=$tmp[0];
		$nama_cab=$tmp[1];
		$sql="select a.kode_rkm, a.nama, a.tahun,a.kode_program,c.nama as nama_program
from agg_rkm a
inner join agg_program c on a.kode_lokasi=c.kode_lokasi and a.tahun=c.tahun and a.kode_program=c.kode_program
$this->filter 
 order by a.kode_program,a.kode_rkm";
		
		$rs = $dbLib->execute($sql);
		$AddOnLib=new server_util_AddOnLib();	
		$i=1;
		echo "<div align='center'>"; 
		echo $AddOnLib->judul_laporan("data rkm non pp",$this->lokasi,"");
