...
class server_report_saku3_ppbs_rptProgram extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode=$tmp[0];
		$nama_cab=$tmp[1];
		$sql="select a.kode_program, a.nama, a.tahun,a.kode_pp,b.nama as nama_pp
from agg_program a
inner join agg_pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi and a.tahun=b.tahun
$this->filter order by a.kode_program";
