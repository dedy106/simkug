...
class server_report_saku3_ppbs_rptDwRkapOut extends server_report_basic
{
	...
	function getHtml()
	{
		...
		echo $AddOnLib->judul_laporan("LAPORAN REKAP OUTLOOK LABARUGI",$this->lokasi,"TAHUN $tahun");
