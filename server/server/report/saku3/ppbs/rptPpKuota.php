...
class server_report_saku3_ppbs_rptPpKuota extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$kode_lokasi=$tmp[0];
		$tahun=$tmp[1];
		$sql="select a.kode_akun,a.kode_pp,b.nama as nama_akun,c.nama as nama_pp,a.n_max,a.tahun
from agg_outlook a
inner join masakun b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi
inner join agg_pp c on a.kode_pp=c.kode_pp and a.kode_lokasi=c.kode_lokasi and a.tahun=c.tahun
inner join agg_user d on c.kode_pp=d.kode_pp and c.kode_lokasi=d.kode_lokasi
$this->filter 
order by a.kode_pp ";
		...
		echo $AddOnLib->judul_laporan("DATA kuota pp",$this->lokasi,"");
