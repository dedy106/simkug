...
class server_report_saku3_ppbs_rptAggAkunDrkYptDetail extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		$sql = "select a.kode_lokasi,a.kode_akun,a.kode_lokasi,b.nama as nama_akun,a.kode_pp,c.nama as nama_pp,a.kode_drk,d.nama as nama_drk,c.tahun,a.keterangan,
	   ...
	   isnull(a.n9,0) as n9,isnull(a.n10,0) as n10,isnull(a.n11,0) as n11,isnull(a.n12,0) as n12,isnull(a.total,0) as total 
	from (select a.kode_lokasi,a.kode_akun,a.kode_pp,a.kode_drk ,a.keterangan,
   ...
   from agg_d a 
   $this->filter
   group by a.kode_lokasi,a.kode_akun,a.kode_pp,a.kode_drk,a.keterangan	  	
		  ) a  
...
<td width='150' class='header_laporan' align='center'>Kegiatan</td>
...
<td width='90' class='header_laporan' align='center'>September</td>
  ...
  <td class='isi_laporan' align='right'>".number_format($row->total,0,',','.')."</td>
		...
		echo "<tr>
  <td height='23' class='header_laporan' align='center' colspan='9'>Total</td>
