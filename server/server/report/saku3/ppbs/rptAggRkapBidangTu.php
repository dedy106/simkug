...
class server_report_saku3_ppbs_rptAggRkapBidangTu extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.kode_bidang,a.nama from agg_bidang a 
			  $this->filter
		...
		{
			$sql="exec sp_agg_rkap_bulan_bidang '$kode_fs','$tahun','$lokasi','$row2->kode_bidang','$nik_user' ";
