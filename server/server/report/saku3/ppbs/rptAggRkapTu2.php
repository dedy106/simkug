...
class server_report_saku3_ppbs_rptAggRkapTu2 extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$lokasi=$tmp[5];
		$ttd=$tmp[6];
		$sql="exec sp_exs_neraca '$kode_fs','$lokasi','$tahun','$nik_user' ";
		...
		echo $AddOnLib->judul_laporan("LAPORAN REKAP ANGGARAN LABARUGI",$this->lokasi,"TAHUN $tahun");
		echo "<table border='0' cellspacing='2' cellpadding='1'>
  <tr>
    <td><table border='1' cellspacing='0' cellpadding='0' class='kotak'>
		  <tr bgcolor='#CCCCCC'>
			<td width='500' height='25'  class='header_laporan'><div align='center'>Deskripsi</div></td>
			<td width='90' class='header_laporan' align='center'>Kuota</td>
    <td width='90' class='header_laporan' align='center'>Realisasi</td>
    <td width='90' class='header_laporan' align='center'>Selisih</td>
		</tr>";
  ...
  <td class='isi_laporan' align='right'>".number_format($row->n1-$row->n2,$koma,',','.')."</td>
			  </tr>";
