...
class server_report_saku3_ppbs_rptDwRkapInvOutPp extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.kode_pp,a.nama,a.kode_lokasi,a.tahun 
			  from agg_pp a 
		...
		while ($row2 = $rs2->FetchNextObject($toupper=false))
		{
			...
			$sql = "select c.kode_neraca,c.kode_fs,c.kode_lokasi,c.nama,c.tipe,c.level_spasi,
				...
				from agg_neraca_out_pp c
				inner join agg_pp a on c.kode_pp=a.kode_pp and c.kode_lokasi=a.kode_lokasi and c.tahun=a.tahun 
				inner join agg_bidang b on a.kode_bidang=b.kode_bidang and a.kode_lokasi=b.kode_lokasi and a.tahun=b.tahun 
				where c.kode_lokasi='$row2->kode_lokasi' and c.kode_pp='$row2->kode_pp' and c.tahun='$row2->tahun' and c.kode_fs='$kode_fs'
				order by c.rowindex ";
			...
			echo $AddOnLib->judul_laporan("LAPORAN REKAP OUTLOOK INVESTASI",$this->lokasi."<br>".$row2->nama,"TAHUN $tahun");
