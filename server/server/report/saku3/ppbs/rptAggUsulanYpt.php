...
class server_report_saku3_ppbs_rptAggUsulanYpt extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		$sql="select a.no_usul,a.kode_lokasi,a.kode_pp,a.kode_drk,c.kode_rkm,a.tahun,a.keterangan,
	   b.nama as nama_pp,c.nama as nama_drk,d.nama as nama_rkm		
from agg_usul_m a
...
inner join agg_rkm d on c.kode_rkm=d.kode_rkm and c.kode_lokasi=d.kode_lokasi and c.tahun=d.tahun
$this->filter
order by a.no_usul";
  ...
  ";
			$sql1="select distinct a.nu,a.kode_akun,a.keterangan,a.tarif,a.satuan,c.nama as nama_akun 
