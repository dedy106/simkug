...
class server_report_saku3_ppbs_rptAggAkunTu extends server_report_basic
{	
	...
	order by a.kode_akun ";
		...
		echo $AddOnLib->judul_laporan("laporan rekap1 anggaran",$this->lokasi,$AddOnLib->ubah_periode($periode));
