...
class server_report_saku3_ppbs_rptAggUsulanPark extends server_report_basic
{	
...
inner join agg_drk e on a.kode_drk=e.kode_drk and a.kode_lokasi=e.kode_lokasi and e.tahun='$tahun' 
$this->filter
order by a.no_usul";
		...
		echo $AddOnLib->judul_laporan("usulan anggaran parking",$this->lokasi,"");
