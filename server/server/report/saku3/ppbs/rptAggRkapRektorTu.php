...
class server_report_saku3_ppbs_rptAggRkapRektorTu extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$lokasi=$tmp[5];
		$kode_pp=$tmp[6];
		$sql="select a.kode_rektor,a.nama from agg_rektor a 
			  $this->filter
		...
		{
			$sql="exec sp_agg_rkap_bulan_rektor '$kode_fs','$tahun','$lokasi','$row2->kode_rektor','$nik_user' ";
