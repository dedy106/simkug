...
class server_report_saku3_ppbs_rptProgramNon extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode=$tmp[0];
		$nama_cab=$tmp[1];
		$sql="select a.kode_program, a.nama, a.tahun
from agg_program a
$this->filter 
 order by a.kode_program";
		...
		echo $AddOnLib->judul_laporan("data program non pp",$this->lokasi,"");
