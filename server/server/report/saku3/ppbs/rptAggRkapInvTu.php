...
class server_report_saku3_ppbs_rptAggRkapInvTu extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$lokasi=$tmp[5];
		$ttd=$tmp[6];
		$sql="exec sp_agg_rkap_bulan '$kode_fs','A','$tahun','$lokasi','$nik_user' ";
		
		$rs = $dbLib->execute($sql);
		$sql = "select kode_neraca,kode_fs,kode_lokasi,nama,tipe,level_spasi,n0,n1,n2,n3,n4,n5,n6,n7,n8,n9,n10,n11,n12
			from neraca_tmp 
		...
		echo $AddOnLib->judul_laporan("LAPORAN REKAP ANGGARAN INVESTASI",$this->lokasi,"TAHUN $tahun");
