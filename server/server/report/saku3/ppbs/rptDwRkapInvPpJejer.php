...
class server_report_saku3_ppbs_rptDwRkapInvPpJejer extends server_report_basic
{
  ...
  <tr bgcolor='#CCCCCC'>
    <td align='center' width='300' class='header_laporan'>Deskripsi</td>";
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			...
			$tmp_sql.="sum(case when kode_pp='$row->kode_pp' then n13 else 0 end) as 'n13$row->kode_pp',";
			$tmp_sql2.="sum(case when d.kode_pp='$row->kode_pp' then n13 else 0 end) as 'n13$row->kode_pp',";
