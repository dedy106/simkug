...
class server_report_saku3_sppd_rptAppSdm extends server_report_basic
{
    ...
    a.kode_pp,a.nik_app2,a.nik_app1,a.kode_lokasi,isnull(f.nama,'-') as jab1,isnull(g.nama,'-') as jab2,a.nilai_uhar + a.nilai_trans as total,
    h.nama as app1,e.nik_user
		from sp_spj_m a 
...
inner join sp_spj_app_m e on a.no_spj=e.no_bukti and e.kode_lokasi=a.kode_lokasi  and e.status in ('3','S') and e.form ='APPSDM' and e.no_flag='-'
inner join sp_jab f on a.kode_jab=f.kode_jab and a.kode_lokasi=f.kode_lokasi
inner join sp_jab g on a.kode_jab=g.kode_jab and a.kode_lokasi=g.kode_lokasi
inner join karyawan h on e.nik_user=h.nik and a.kode_lokasi=h.kode_lokasi 

$this->filter and a.progress in ('3','S')
order by a.no_spj";
  ...
  <td colspan='2' align='center'><br><b>DATA APPROVE SDM</b><br></br></td>
    <tr>
...
<tr>
<td>Total Uang Perjalanan Dinas</td>
