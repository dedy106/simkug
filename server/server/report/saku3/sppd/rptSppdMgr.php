...
class server_report_saku3_sppd_rptSppdMgr extends server_report_basic
{	
...
inner join karyawan d on a.nik_app=d.nik  $this->filter";
	...
	$sql="select a.no_spj,datepart(day,a.tanggal) as tgl_cuti,datename(weekday,a.tanggal) as hari,datepart(month,a.tanggal) as bulan,
	   ...
	   a.jabatan,a.transport,a.harian,a.transport+a.harian as total,a.kode_lokasi,a.keterangan,'-' as dasar,c.grade,f.nama as lokasi,
