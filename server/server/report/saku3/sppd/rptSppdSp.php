...
class server_report_saku3_sppd_rptSppdSp extends server_report_basic
{	
...
inner join karyawan d on a.nik_spj=d.nik and a.kode_lokasi=d.kode_lokasi $this->filter";
	...
	function getHtml()
	{
       ...
       datepart(year,a.tanggal) as tahun,a.tanggal,a.kode_pp,datepart(day,a.tanggal) as tgl,
       a.nik_user,a.nama_spj as nama,b.nama as nama_pp,a.nik_spj,d.nama as nama_app,a.nilai_trans,a.nilai_uhar,a.nilai_trans+a.nilai_uhar as total,a.kode_lokasi,'-' as dasar,c.jabatan,c.grade,f.nama as lokasi,isnull(h.lama,0) as lama,d.jabatan as jab_app,a.tempat,h.tgl_mulai,h.tgl_selesai,j.nama as nama_bidang,f.kota
	   --,dbo.fnSpjTujuan(a.no_spj) as tujuan,dbo.fnSpjAngkutan(a.no_spj) as angkutan
        ...
        inner join karyawan d on a.nik_spj=d.nik 
  ...
  <tr>
	...
	<tr align='center'>
        <td colspan='2' class='judul_form'>NOMOR : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/ PS330/YAKES/2014 </td>
  </tr>
</table></td>
  </tr>
 <tr>
      ...
      <tr>
        <td colspan='2'><table width='800' border='0' cellspacing='2' cellpadding='1'>
          <tr>
            ...
            <td >: $row->nama / $row->nik_user</td>
          </tr>
		  <tr>
            <td width='21'>&nbsp;</td>
            <td width='250'>b. Grade</td>
            <td>: $row->grade </td>
          </tr>
        </table></td>
        </tr>
