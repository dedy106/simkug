...
class server_report_saku3_sppd_rptPdRekapAkun extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.kode_akun,a.kode_pp,e.nama as nama_akun,d.nama as nama_pp,
	   sum(ISNULL(b.nilai_trans,0)) as trans,sum(ISNULL(b.nilai_uhar,0)) as uhar,sum(ISNULL(b.nilai_trans,0)+ISNULL(b.nilai_uhar,0)) as total
from sp_stugas_m a 
...
$this->filter
group by a.kode_akun,a.kode_pp,e.nama,d.nama
