...
class server_report_saku3_sppd_rptSppdBy extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		$tmp=explode("/",$this->filter2);
		$nama_ver=$tmp[0];
		$sql="select a.tempat,a.no_spj,datepart(day,a.tanggal) as tgl_cuti,datename(weekday,a.tanggal) as hari,datepart(day,a.tanggal) as tgl,
    datepart(month,a.tanggal) as bulan,datepart(year,a.tanggal) as tahun,a.tanggal,a.kode_pp,
    a.nik_user,c.nama as nama_buat,b.nama as nama_pp,a.nik_spj,d.nama as nama_app,a.nama_spj,
	  isnull(d.jabatan,'-') as jabatan,a.nilai_trans,a.nilai_uhar,a.nilai_trans+a.nilai_uhar as total,a.kode_lokasi,d.grade,f.nama as lokasi,f.kota,
	  a.kode_jab,a.kode_jab2,a.no_perintah
    from sp_spj_m a
    inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi
    inner join karyawan c on a.nik_user=c.nik and a.kode_lokasi=c.kode_lokasi
    inner join karyawan d on a.nik_spj=d.nik and a.kode_lokasi=d.kode_lokasi
    ...
    <td><table width='100%'  border='0'>
      ...
      <tr>
        <td><table width='100%'  border='0'>
          ...
          <tr>
            <td>&nbsp;</td>
            <td>b. Jabatan 1 / Jabatan 2 </td>
            <td>: $row->kode_jab / $row->kode_jab2 </td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>c. Lokasi </td>
      ...
      <tr>
        <td><table width='100%'  border='0'>
          ...
          <tr>
            ...
            <td><table border='1' cellspacing='0' cellpadding='0' class='kotak'>
              <tr>
                ...
                <td width='60'  align='center' class='header_form'>Kota Asal</td>
                <td width='60'  align='center' class='header_form'>Kota Tujuan</td>
              </tr>
             ";
				 $sql1="select a.no_spj,a.no_urut,b.asal,g.asal as asal1,h.nama as asal2,b.tujuan,d.nama as jenis,b.nilai as tarif,b.jumlah,isnull(c.persen,0) as persen,
		  ...
		  left join sp_perintah_m g on g.no_perintah='$row->no_perintah' and g.kode_lokasi='$row->kode_lokasi'
		  inner join sp_kota h on h.kode_kota=g.asal and h.kode_lokasi=g.kode_lokasi
          ...
          where a.no_spj='$row->no_spj' ";
			  ...
			  while ($row1 = $rs1->FetchNextObject($toupper=false))
			{
                ...
                <td class='isi_form' align='center'>$row1->asal2</td>
      ...
      <tr>
        <td><table width='100%'  border='0' cellspacing='2' cellpadding='1'>
          ...
          <tr>
            <td>NIK.$row->nik_user</td>
            <td></td>
            <td>NIK.$row->nik_spj</td>
          </tr>
        </table></td>
      </tr>
