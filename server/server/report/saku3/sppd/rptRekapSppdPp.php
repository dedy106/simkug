...
class server_report_saku3_sppd_rptRekapSppdPp extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.kode_unit,a.nama,isnull(b.nilai_uhar,0) as nilai_uhar,isnull(b.nilai_trans,0) as nilai_trans,isnull(b.nilai_uhar,0)+isnull(b.nilai_trans,0) as total
from sp_unit a
inner join (select a.kode_unit,a.kode_lokasi,sum(a.nilai_uhar) as nilai_uhar, sum(a.nilai_trans) as nilai_trans
from sp_spj_m a
$this->filter and a.progress<>'Z'
group by a.kode_unit,a.kode_lokasi
...
order by a.kode_unit ";
		...
		echo $AddOnLib->judul_laporan("rekap sppd per unit",$this->lokasi,"Periode ".$AddOnLib->ubah_periode($periode));
   ...
   <tr bgcolor='#CCCCCC'>
     ...
     <td class='isi_laporan' align='center'>$i</td>
	  <td class='isi_laporan' align='center'>$row->kode_unit</td>
