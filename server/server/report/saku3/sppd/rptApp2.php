...
class server_report_saku3_sppd_rptApp2 extends server_report_basic
{
...
$this->filter";
	...
	function getHtml()
	{
		...
		a.kode_pp,a.nik_app2,a.nik_app1,a.kode_lokasi,f.nama as app1,e.nik_user
		from sp_spj_m a 
...
inner join sp_spj_app_m e on a.no_spj=e.no_bukti and e.kode_lokasi=a.kode_lokasi  and e.status in ('2','B','Z') and e.form ='APPDIR' and e.no_flag='-'
inner join karyawan f on e.nik_user=f.nik and a.kode_lokasi=f.kode_lokasi 

$this->filter and a.progress in ('2','B','Z')
order by a.no_spj";
      ...
      <td colspan='2' align='center'><br><b>DATA APPROVE 2</b><br></br></td>
        <tr>
