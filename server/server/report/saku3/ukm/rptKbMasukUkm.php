...
class server_report_saku3_ukm_rptKbMasukUkm extends server_report_basic
{
...
from kas_m a 
where a.kode_lokasi='$row->kode_lokasi' and a.akun_kb='$row->kode_akun' and a.kode_pp='$row->kode_pp' and a.jenis='BM' $sql2 order by a.tanggal ";
