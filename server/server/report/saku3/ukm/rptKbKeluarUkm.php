...
class server_report_saku3_ukm_rptKbKeluarUkm extends server_report_basic
{
...
order by a.kode_akun";
		...
		if ($jenis=="Range")
		{
			echo $AddOnLib->judul_laporan("laporan realisasi pengeluaran ",$this->lokasi,"Periode ".$AddOnLib->ubah_periode($periode)." Sd ".$AddOnLib->ubah_periode($periode2));
			$sql2=" and a.periode between '$periode' and '$periode2' ";
		}
		else
		{
			echo $AddOnLib->judul_laporan("laporan realisasi pengeluaran ",$this->lokasi,"Periode ".$AddOnLib->ubah_periode($periode));
  ...
  <tr bgcolor='#CCCCCC'>
    ...
    <td width='90' class='header_laporan' align='center'>SALDO</td>
	   ...
	   a.nilai as kredit,0 as debet
from kas_m a 
where a.kode_lokasi='$row->kode_lokasi' and a.akun_kb='$row->kode_akun' and a.kode_pp='$row->kode_pp' and a.jenis='BK' $sql2 order by a.tanggal ";
