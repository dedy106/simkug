...
class server_report_saku3_ukm_rptKbSaldoPdptUkm extends server_report_basic
{
...
order by a.kode_jurnal
 ";
		...
		echo $AddOnLib->judul_laporan("SALDO PENERIMAAN",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
