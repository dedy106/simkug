...
class server_report_saku3_kredit_rptBrgMasuk extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		$sql="select a.no_beli,date_format(a.tanggal,'%d/%m/%Y') as tanggal,a.no_dokumen,a.keterangan,b.nama as nama_pp
from kre_beli_m a
...
order by a.no_beli";
		...
		echo $AddOnLib->judul_laporan("barang masuk ",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
