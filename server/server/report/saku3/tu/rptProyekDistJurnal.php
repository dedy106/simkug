...
class server_report_saku3_tu_rptProyekDistJurnal extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.no_bukti,a.kode_lokasi,a.periode,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.kode_lokasi,
