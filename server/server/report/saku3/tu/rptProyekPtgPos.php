...
class server_report_saku3_tu_rptProyekPtgPos extends server_report_basic
{
...
inner join tu_prbdd_d m on a.no_aju=m.no_bukti and a.kode_lokasi=m.kode_lokasi
inner join tu_proyek n on m.kode_proyek=n.kode_proyek and m.kode_lokasi=n.kode_lokasi
