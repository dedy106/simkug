...
class server_report_saku3_tu_ntf21_rptInisiasiFormPj extends server_report_basic
{
	...
	function getHtml()
	{
		...
		a.nik_user,a.nik_app,f.nama as nama_user,g.nama as nama_app,h.logo,h.alamat,i.kode_proyek,j.nama as nama_ntf
from it_aju_m a
...
left join prb_prbeban_d i on a.no_aju=i.no_bukti and a.kode_lokasi=h.kode_lokasi
left join prb_proyek j on i.kode_proyek=j.kode_proyek and i.kode_lokasi=j.kode_lokasi
...
$root_app="http://".$_SERVER['SERVER_NAME']."/web/server/pbh/";
  ...
  <tr>
    <td height='30' align='center' valign='middle' class='judul_bukti'>FORMULIR PERMOHONAN PANJAR INISIASI</td>
  </tr>
  <tr>
    <td><table width='800' border='0' cellspacing='2' cellpadding='1'>
      ...
      <tr>
        ...
        <td>: $row->kode_proyek | $row->nama_ntf </td>
      </tr>
      <tr>
