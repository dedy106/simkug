...
class server_report_saku3_tu_ntf21_rptInisiasiJoinCost extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.no_ju,a.kode_lokasi,a.periode,a.no_dokumen,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.kode_lokasi,
       a.nik_user as nik_buat,b.nama as nama_buat,b.jabatan as jabatan_buat,a.nik_setuju,d.kota,c.nama as nama_app
from ju_m a
...
left join karyawan c on a.nik_setuju=c.nik and a.kode_lokasi=c.kode_lokasi $this->filter";
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			echo "<table border='0' cellspacing='2' cellpadding='1'>
			  <tr>
				<td align='center' class='header_laporan'>MEMO JURNAL JOIN COST </td>
			  </tr>
			   <tr>
			    <td>
			<table border='0' cellspacing='2' cellpadding='1'>
			  ...
			  <tr>
				...
				<td width='100' class='header_laporan'><div align='center'>ID Proyek </div></td>
				<td width='80' class='header_laporan'><div align='center'>Periode</div></td>
	  ...
	  $sql1="select a.kode_akun,b.nama,a.keterangan,a.no_dokumen,a.kode_pp,a.periode,a.kode_drk,case dc when 'D' then nilai else 0 end as debet,case dc when 'C' then nilai else 0 end as kredit  
			from ju_j a
		...
		while ($row1 = $rs1->FetchNextObject($toupper=false))
		{
			...
			echo "<tr>
				...
				<td class='isi_laporan'>$row1->periode_beban</td>
