...
class server_report_saku3_tu_rptProyek extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.kode_proyek,a.kode_cust,b.nama as nama_cust,a.nilai,a.nilai_or,a.nama,a.kode_jenis,d.nama as nama_jenis,d.akun_pdpt,d.akun_beban,a.no_pks,
...
left join tu_rabapp_m e on a.kode_proyek=e.kode_proyek and a.kode_lokasi=e.kode_lokasi
$this->filter $tmp
order by a.kode_proyek";
   ...
   <tr bgcolor='#CCCCCC'>
	 ...
	 <td width='60'  align='center' class='header_laporan'>Akun Pendapatan</td>
	 <td width='60'  align='center' class='header_laporan'>Akun Beban</td>
