...
class server_report_saku3_tu_proyek_rptKuitansi extends server_report_basic
{
	...
	function getHtml()
	{
		...
		a.nik_user,a.nik_app,d.nama as nama_buat,e.nama as nama_app,d.jabatan as jab_buat,e.jabatan as jab_app,'-' as no_kuitansi,a.periode
        from prb_prbill_m a
        ...
        left join karyawan d on a.nik_user=d.nik
