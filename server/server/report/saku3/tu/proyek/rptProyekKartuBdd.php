...
class server_report_saku3_tu_proyek_rptProyekKartuBdd extends server_report_basic
{
...
where a.kode_lokasi='$kode_lokasi' and a.dc='D' and a.modul='AJUBEBAN' and a.kode_proyek='$row->kode_proyek'
order by a.tanggal
