...
class server_report_saku3_tu_proyek_rptProyekKartuBeban extends server_report_basic
{
...
$this->filter order by a.kode_proyek";
  ...
  <tr bgcolor='#CCCCCC'>
    <td width='100' height='23' class='header_laporan' align='center'>No Bukti1</td>
	...
	<td width='90' class='header_laporan' align='center'>Saldo</td>
			...
			$sql="select a.no_bukti,convert(varchar,a.tanggal,103) as tgl,a.keterangan,a.nilai,a.tanggal,a.modul,a.no_ref1 as no_dokumen,
			case when a.dc='D' then a.nilai else 0 end as debet, case when a.dc='C' then a.nilai else 0 end as kredit 
from prb_prbeban_d a
where a.kode_lokasi='$kode_lokasi' and a.modul in ('AJUBEBAN') and a.jenis='NONITAJU' and a.kode_proyek='$row->kode_proyek'
order by a.tanggal
