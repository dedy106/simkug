...
class server_report_saku3_tu_proyek_rptProyekKartuUnit extends server_report_basic
{
	...
	function getHtml()
	{
	   ...
	   isnull(h.nilai,0) as bdd,isnull(i.nilai,0)+isnull(h.nilai,0)+isnull(j.nilai,0) as beban,isnull(j.nilai,0) as bymhd
from prb_proyek a
...
$this->filter order by a.kode_proyek";
   ...
   <tr bgcolor='#CCCCCC'>
     ...
     <td  align='center' class='header_laporan'>h = (a-g)</td>
     <td  align='center' class='header_laporan'>I = (g/c)</td>
     <td  align='center' class='header_laporan'>j = (g/a)</td>
   </tr> ";
