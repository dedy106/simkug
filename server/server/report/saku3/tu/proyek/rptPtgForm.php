...
class server_report_saku3_tu_proyek_rptPtgForm extends server_report_basic
{
...
$this->filter";
	...
	function getHtml()
	{
		...
		$sql="select a.no_aju,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.kode_pp,b.nama as nama_pp,a.nik_user,a.tanggal,a.kode_akun,c.nama as nama_akun,a.no_ptg as ntf,
		d.bank,d.no_rek,d.nama_rek,a.nilai,a.kode_drk,e.nama as nama_drk,a.no_aju,f.nilai as nilai_panjar,a.nilai-f.nilai as sisa,h.logo,h.alamat
from it_aju_m a
inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi
...
inner join prb_prbeban_d g on a.no_aju=g.no_bukti and a.kode_lokasi=h.kode_lokasi and a.kode_pp=b.kode_pp and g.kode_akun like '5%'
inner join prb_proyek i on g.kode_proyek=i.kode_proyek and g.kode_lokasi=i.kode_lokasi 
...
$root_app="http://".$_SERVER['SERVER_NAME']."/web/server/pbh/";
  ...
  <tr>
    <td height='30' align='center' valign='middle' class='judul_bukti'>FORMULIR PERTANGGUNGAN PANJAR NTF</td>
  </tr>
  <tr>
