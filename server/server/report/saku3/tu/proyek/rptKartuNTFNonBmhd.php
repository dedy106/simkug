...
class server_report_saku3_tu_proyek_rptKartuNTFNonBmhd extends server_report_basic
{
	...
	function getHtml()
	{
        ...
        <thead style='border: solid 1px black;'>
            <tr>
                <th  colspan='6' style='font-size:14px; text-align: center;'>KARTU NTF NON BMHD</th>
            </tr>
            <tr style=''>
        ...
        ";
            ...
            $this->filter and b.kode_proyek='$row1->kode_proyek' and b.jenis<>'NONITAJU'";
