...
class server_report_saku3_tu_proyek_rptPanjarBeban extends server_report_basic
{
...
inner join prb_prbeban_d h on a.no_aju=h.no_bukti and a.kode_lokasi=h.kode_lokasi
...
$root_app="http://".$_SERVER['SERVER_NAME']."/web/server/pbh/";
  ...
  <tr>
    <td height='30' align='center' valign='middle' class='judul_bukti'>FORMULIR PENCAIRAN PANJAR PROYEK</td>
  </tr>
