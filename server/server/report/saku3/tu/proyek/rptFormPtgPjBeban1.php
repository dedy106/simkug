...
class server_report_saku3_tu_proyek_rptFormPtgPjBeban1 extends server_report_basic
{
...
$this->filter";
	...
	function getHtml()
	{
		...
		d.bank,d.no_rek,d.nama_rek,a.nilai,a.kode_drk,e.nama as nama_drk,a.no_ptg,f.nilai as nilai_panjar,a.nilai-f.nilai as sisa,h.logo,h.alamat,
				j.kode_proyek,j.nama as nama_py
...
left join prb_prbeban_d i on a.no_aju=i.no_bukti and a.kode_lokasi=i.kode_lokasi and i.kode_akun='1174101'
inner join prb_proyek j on i.kode_proyek=j.kode_proyek and i.kode_lokasi=j.kode_lokasi
  ...
  <tr>
    <td><table width='800' border='0' cellspacing='2' cellpadding='1'>
      ...
      <tr>
		...
		<td class='judul_bukti'>:$row->no_ptg</td>
      </tr>
		<tr>
			<td width='25' >ID Proyek </td>
			<td class='istyle15'>:$row->kode_proyek | $row->nama_py </td>
		</tr>
    </table></td>
  </tr>
  <tr>
