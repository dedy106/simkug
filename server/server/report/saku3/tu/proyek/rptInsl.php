...
class server_report_saku3_tu_proyek_rptInsl extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.tgl_app,a.kode_pp,a.kode_proyek,a.nama,a.kode_jenis,a.nilai_or,a.kode_drkb,a.nilai_ppn,a.nilai,a.p_or,a.nik_app,a.nik_buat,
		b.nama  as app,c.nama as buat,date_format(a.tgl_mulai,'%d/%m/%Y') as tgl1,date_format(a.tgl_selesai,'%d/%m/%Y') as tgl,a.no_pks
from tu_proyek a
...
order by a.kode_proyek";
  ...
  <tr>
    <td height='30' align='center' valign='middle' class='judul_bukti'>LAPORAN DATA INISIASI</td>
  </tr>
