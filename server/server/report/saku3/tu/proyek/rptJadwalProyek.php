...
class server_report_saku3_tu_proyek_rptJadwalProyek extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode=$tmp[0];
		$nama_cab=$tmp[1];
		$sql="select a.kode_proyek,a.periode,a.nilai_pend,c.akun_pdpt,a.nilai_beban,c.akun_beban from tu_proyek_d a
        inner join tu_proyek b on a.kode_proyek=b.kode_proyek and a.kode_lokasi=b.kode_lokasi
        inner join tu_proyek_jenis c on c.kode_jenis=b.kode_jenis and c.kode_lokasi=b.kode_lokasi
        $this->filter 
        order by a.periode
        ";
