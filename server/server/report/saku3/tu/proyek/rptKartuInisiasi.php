...
class server_report_saku3_tu_proyek_rptKartuInisiasi extends server_report_basic
{
	...
	function getHtml()
	{
        ...
        $sql2   = "select b.no_bukti, convert(varchar, b.tanggal, 103) tanggal, b.keterangan, b.dc, b.nilai 
        from prb_prbeban_d b
        inner join prb_proyek a on a.kode_lokasi=b.kode_lokasi and a.kode_proyek=b.kode_proyek
        $this->filter";
    ...
    //echo "$sql2";        
        ...
        <thead style='border: solid 1px black;'>
            <tr>
                <th  colspan='6' style='font-size:14px; text-align: center;'>KARTU INISIASI</th>
            </tr>
            <tr style=''>
                <th style='' colspan='6'>&nbsp;</th>
            </tr>
            <tr>
                <th  colspan='' style='font-size:12px; text-align: left; padding-left: 5px;'>No Inisiasi</th>
                <th  colspan='5' style='font-size:12px; text-align: left;'>: $row1->kode_proyek</th>
            </tr>
            <tr>
                <th  colspan='' style='font-size:12px; text-align: left; padding-left: 5px;'>Nama Inisiasi</th>
