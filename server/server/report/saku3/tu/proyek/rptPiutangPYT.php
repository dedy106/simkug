...
class server_report_saku3_tu_proyek_rptPiutangPYT extends server_report_basic
{
	...
	function getHtml()
	{
       ...
       a.nik1,b.nama as nama_buat,a.nik2,c.nama as nama_app, d.kota,a.keterangan,a.no_ref2 
		...
		{
            if (substr($row->no_bukti,3,3) == "PIU"){
                $judul="PIUTANG";
            }else{
                $judul="PENDAPATAN";
            }
			echo "<table border='0' cellspacing='2' cellpadding='1'>
			  <tr>
				<td align='center' class='header_laporan'>MEMO JURNAL $judul PROYEK </td>
			  </tr>
			  <tr>
				<td>
