...
class server_report_saku3_tu_proyek_rptAkruFinalPphJurnal extends server_report_basic
{
       ...
       a.nik1,b.nama as nama_buat,a.nik2,c.nama as nama_app, d.kota,a.keterangan,a.no_dokumen 
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			echo "<table border='0' cellspacing='2' cellpadding='1'>
			  <tr>
				<td align='center' class='header_laporan'>MEMO JURNAL AKRU FINALISASI PPh </td>
			  </tr>
			  <tr>
				<td>
