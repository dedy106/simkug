...
class server_report_saku3_tu_proyek_rptPiutangJurnal2 extends server_report_basic
{
	...
	function getHtml()
	{
       ...
       a.nik1,b.nama as nama_buat,a.nik2,c.nama as nama_app, d.kota,a.keterangan,a.no_ref2 
			from trans_m a
			...
			<table border='0' cellspacing='2' cellpadding='1'>
			  ...
			  <tr>
				<td><table border='0' cellspacing='2' cellpadding='1'>
				  ...
				  <tr>
					<td width='100' class='header_laporan'>No Proyek </td>
					<td width='496' class='header_laporan'>:&nbsp;$row->no_ref2</td>
					</tr>
				  <tr>
					<td width='100' class='header_laporan'>Unit PngJawab </td>
					<td width='496' class='header_laporan'>:&nbsp;$row->kode_pp</td>
					</tr>
  ...
  <tr>
    <td align='left'><table border='0' cellspacing='2' cellpadding='1'>
      ...
      <tr>
		...
		$sql="select a.no_bukti,a.kode_lokasi,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.kode_lokasi,a.tanggal,a.periode,
		a.nik_user as nik_buat,b.nama as nama_buat,a.nik_app,c.nama as nama_app, d.kota,a.keterangan,a.no_dokumen,a.nik_app,e.kode_cust   
	 from prb_prpyt_m a
	 inner join lokasi d on d.kode_lokasi = a.kode_lokasi 
	 ...
	 left join tu_proyek e on a.no_dokumen=e.kode_proyek and a.kode_lokasi=e.kode_lokasi
	 $this->filter
	 order by a.no_bukti";
 ...
 while ($row = $rs->FetchNextObject($toupper=false))
 {
	 echo "<table border='0' cellspacing='2' cellpadding='1'>
		 <tr>
		 <td align='center' class='header_laporan'>MEMO JURNAL DISTRIBUSI PENDAPATAN PROYEK </td>
		 </tr>
			<tr>
		 <td>
	 <table border='0' cellspacing='2' cellpadding='1'>
		 ...
		 <td width='60' class='header_laporan'><div align='center'>Akun</div></td>
		 <td width='200' class='header_laporan'><div align='center'>Nama Akun </div></td>
		 <td width='80' class='header_laporan'><div align='center'>ID Proyek </div></td>
		 <td width='80' class='header_laporan'><div align='center'>Periode Bill</div></td>
		 <td width='200' class='header_laporan'><div align='center'>Keterangan </div></td>
		 <td width='40' class='header_laporan'><div align='center'>PP </div></td>
 ...
 $sql1="select a.kode_akun,b.nama,a.no_dokumen,a.periode,a.keterangan,a.kode_pp,a.kode_drk,case dc when 'D' then nilai else 0 end as debet,case dc when 'C' then nilai else 0 end as kredit  
	 from prb_prpyt_j a
	 inner join masakun b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi
	 where a.no_bukti='$row->no_bukti' and a.kode_lokasi='$row->kode_lokasi'
	 order by a.no_urut ";
 ...
 <td colspan='8' class='header_laporan' align='right'>Total</td>
 <td class='header_laporan' align='right'>$tot_debet1</td>
 <td class='header_laporan' align='right'>$tot_kredit1</td>
</tr>
</table></td>
</tr>
