...
class server_report_saku3_tu_proyek_rptAgendaPos extends server_report_basic
{
...
inner join prb_prbeban_d m on a.no_aju=m.no_bukti and a.kode_lokasi=m.kode_lokasi and a.kode_akun=m.kode_akun
...
$this->filter order by a.no_aju";
		...
		echo $AddOnLib->judul_laporan("posisi pertanggungan beban proyek",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
