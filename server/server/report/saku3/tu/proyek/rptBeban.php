...
class server_report_saku3_tu_proyek_rptBeban extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.no_bukti,a.kode_lokasi,a.periode,a.no_dokumen,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.kode_lokasi,
       a.nik_user as nik_buat,b.nama as nama_buat,b.jabatan as jabatan_buat,a.nik_app,d.kota,c.nama as nama_app
from tu_prbeban_m a
...
left join karyawan c on a.nik_app=c.nik and a.kode_lokasi=c.kode_lokasi $this->filter";
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			echo "<table border='0' cellspacing='2' cellpadding='1'>
			  <tr>
				<td align='center' class='header_laporan'>MEMO JURNAL DISTRIBUSI BEBAN </td>
			  </tr>
			   <tr>
			    <td>
	  ...
	  $sql1="select a.kode_akun,b.nama,a.keterangan,a.no_dokumen,a.kode_pp,a.periode_beban,a.kode_drk,case dc when 'D' then nilai else 0 end as debet,case dc when 'C' then nilai else 0 end as kredit  
			from tu_prbeban_j a
