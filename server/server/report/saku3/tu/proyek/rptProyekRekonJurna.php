...
class server_report_saku3_tu_proyek_rptProyekRekonJurna extends server_report_basic
{
	...
	function getHtml()
	{
       ...
       a.nik1,b.nama as nama_buat,a.nik2,c.nama as nama_app, d.kota,a.keterangan,a.no_dokumen,a.no_dokumen as kode_proyek 
			from trans_m a
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			echo "<table border='0' cellspacing='2' cellpadding='1'>
			  <tr>
				<td align='center' class='header_laporan'>MEMO JURNAL PELUNASAN PIUTANG PROYEK </td>
			  </tr>
			  <tr>
				<td>
  ...
  <tr>
    <td align='left'><table border='0' cellspacing='2' cellpadding='1'>
      ...
      <tr>
        <td class='header_laporan'>$row->nik2</td>
