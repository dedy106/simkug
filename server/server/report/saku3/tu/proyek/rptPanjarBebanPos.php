...
class server_report_saku3_tu_proyek_rptPanjarBebanPos extends server_report_basic
{
...
$this->filter order by a.no_aju";
		...
		echo $AddOnLib->judul_laporan("posisi pencairan panjar proyek",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
