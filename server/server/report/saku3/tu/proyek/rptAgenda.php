...
class server_report_saku3_tu_proyek_rptAgenda extends server_report_basic
{
    ...
    $tahun=substr($tmp[0],0,4);
		...
		a.nik_user,a.nik_app,f.nama as nama_user,g.nama as nama_app,i.kode_proyek,i.nama as nama_proyek
from it_aju_m a
...
inner join ( select kode_proyek,no_bukti,kode_lokasi
            from prb_prbeban_d 
            union all
            select kode_proyek,no_bukti,kode_lokasi
            from prb_bmhd_d 
) h on a.no_aju=h.no_bukti and a.kode_lokasi=h.kode_lokasi
inner join prb_proyek i on h.kode_proyek=i.kode_proyek and h.kode_lokasi=i.kode_lokasi
...
$root_app="http://".$_SERVER['SERVER_NAME']."/web/server/pbh/";
  ...
  <tr>
    <td height='30' align='center' valign='middle' class='judul_bukti'>FORMULIR PERTANGGUNGAN BEBAN NTF </td>
  </tr>
  ...
  <tr>
    <td><table width='100%'  border='0' cellpadding='0' cellspacing='0'>
      ...
      <tr align='center' valign='bottom'>
        ...
        <td class='garis_bawah'>Nurlaela</td>
        <td class='garis_bawah'>Meithanita Denanda</td>
        <td class='garis_bawah'>$row->nama_user </td>
      </tr>
      <tr align='center' valign='bottom'>
        <td>NIP : $row->nik_app</td>
        <td>NIP : 14740029-1</td>
        <td>NIP : 17910080</td>
