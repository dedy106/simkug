...
class server_report_saku3_tu_proyek_rptPtgPanjarBebanPos extends server_report_basic
{
...
inner join prb_prbeban_d m on a.no_aju=m.no_bukti and a.kode_lokasi=m.kode_lokasi
inner join prb_proyek n on m.kode_proyek=n.kode_proyek and m.kode_lokasi=n.kode_lokasi
...
$this->filter and m.dc='D' order by a.no_aju";
		...
		echo $AddOnLib->judul_laporan("posisi pertanggungan panjar proyek",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
