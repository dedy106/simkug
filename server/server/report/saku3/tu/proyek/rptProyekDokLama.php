...
class server_report_saku3_tu_proyek_rptProyekDokLama extends server_report_basic
{
...
inner join tu_rabapp_m e on a.kode_proyek=e.kode_proyek and a.kode_lokasi=e.kode_lokasi
left join (select c.kode_proyek,c.kode_lokasi,count(a.no_rab) as jumlah
			...
			inner join tu_rabapp_m c on a.no_rab=c.no_rab and a.kode_lokasi=c.kode_lokasi
