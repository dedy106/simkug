...
class server_report_saku3_tu_proyek_rptRab extends server_report_basic
{
	...
	function getHtml()
	{
	   ...
	   a.kode_jenis,convert(varchar(20),a.tgl_mulai,103) as tgl_mulai,convert(varchar(20),a.tgl_selesai,103) as tgl_selesai,
	   e.nama as nama_app, f.nama as nama_buat,a.no_memo,a.no_dok
from prb_rab_m a
   ...
   <tr >
    <td height='23' colspan='9' style='padding:5px'><table  border='0' cellspacing='2' cellpadding='1'>
				  ...
				  <tr>
				   ...
				   <tr>
                    <td class='header_laporan'>No Memo </td>
                    <td class='header_laporan'>:&nbsp;$row->no_memo</td>
                  </tr>
				    <tr>
