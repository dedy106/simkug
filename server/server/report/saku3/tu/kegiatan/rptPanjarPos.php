...
class server_report_saku3_tu_kegiatan_rptPanjarPos extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.kode_lokasi,a.no_aju,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.kode_pp,b.nama as nama_pp,a.nilai,
	   ...
	   a.no_spb,date_format(l.tgl_input,'%d/%m/%Y') as tgl_spb,m.no_aju as no_ajuk,m.keterangan as ket
from it_aju_m a
...
left join keg_aju_m m on a.no_ajukeg=m.no_aju and a.kode_lokasi=m.kode_lokasi
