...
class server_report_saku3_tu_bmhd_rptAjuBmhdPos extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$fullId = $_GET["fullId"];
		$sql="select a.kode_lokasi,a.no_aju,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.kode_pp,b.nama as nama_pp,l.nilai,a.kode_drk,j.nama as nama_drk,
	   a.no_kas,date_format(c.tanggal,'%d/%m/%Y') as tgl_kas,c.nilai as nilai_kas,l.pajak,a.nilai as nilai_aju,
	   ...
	   a.no_app,date_format(k.tgl_input,'%d/%m/%Y') as tgl_app,l.no_bmhd as no_bmhd,n.no_spb as spb,m.nama as nama_vendor
from it_aju_m a
...
left join bmhd_bayar l on a.no_aju=l.no_aju and a.kode_lokasi=l.kode_lokasi
left join it_vendor m on l.kode_vendor=m.kode_vendor and l.kode_lokasi=m.kode_lokasi
left join it_spb_m n on a.no_spb=n.no_spb and a.kode_lokasi=n.kode_lokasi
$this->filter order by a.no_aju";
		...
		echo $AddOnLib->judul_laporan("posisi pertanggungan bmhd",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
   ...
   <tr bgcolor='#CCCCCC'>
	 ...
	 <td width='150'  align='center' class='header_laporan'>No Bmhd</td>
   ...
   <td width='200'  align='center' class='header_laporan'>Keterangan</td>
	 ...
	 <td width='90'  align='center' class='header_laporan'>Netto</td>
	  <td width='150'  align='center' class='header_laporan'>No Dok</td>
	 <td width='60'  align='center' class='header_laporan'>Tgl Dok</td>
	 <td width='170'  align='center' class='header_laporan'>No Ver</td>
	 ...
	 <td width='150'  align='center' class='header_laporan'>Keterangan Ver</td>
	  <td width='170'  align='center' class='header_laporan'>No Fiat</td>
	 <td width='60'  align='center' class='header_laporan'>Tgl Fiat</td>
	  <td width='40'  align='center' class='header_laporan'>Status Fiat</td>
	   <td width='150'  align='center' class='header_laporan'>Keterangan Fiat</td>
	    <td width='170'  align='center' class='header_laporan'>No SPB</td>
	 ...
	 <td width='90'  align='center' class='header_laporan'>Jenis Bayar</td>
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			...
			$pajak=$pajak+$row->pajak;
			$nilai_aju=$nilai_aju+$row->nilai_aju;
	 ...
	 <td class='isi_laporan'>$row->no_bmhd</td>
	 ...
	 <td class='isi_laporan'>$row->tgl_kas</td>
	  ...
	  <td class='header_laporan' align='right'>".number_format($nilai_aju,0,",",".")."</td>
