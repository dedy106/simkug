...
class server_report_saku3_tu_kantin_rptTB12Akhir extends server_report_basic
{
	...
	function getHtml()
	{
		...
		echo $AddOnLib->judul_laporan("laporan neraca lajur saldo akhir 12 Periode ",$this->lokasi,$AddOnLib->ubah_periode($periode));
