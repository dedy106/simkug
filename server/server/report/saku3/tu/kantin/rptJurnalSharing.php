...
class server_report_saku3_tu_kantin_rptJurnalSharing extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.no_kas,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.kode_lokasi,
