...
class server_report_saku3_tu_kantin_rptPbPos extends server_report_basic
{
	...
	$sql="select a.kode_lokasi,a.no_aju,date_format(a.tgl_input,'%d/%m/%Y') as tgl,a.keterangan,a.kode_pp,b.nama as nama_pp,a.nilai,a.kode_drk,j.nama as nama_drk,a.npajak,a.nilai+a.npajak as bruto,
	   ...
	   a.no_app,date_format(k.tgl_input,'%d/%m/%Y') as tgl_app1,date_format(k.tgl_input,'%d/%m/%Y') as tgl_app,
...
// echo $sql;
		...
		echo $AddOnLib->judul_laporan("posisi pertanggungan beban kantin",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
