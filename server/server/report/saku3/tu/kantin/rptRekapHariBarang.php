...
class server_report_saku3_tu_kantin_rptRekapHariBarang extends server_report_basic
{
   ...
   <tr bgcolor='#CCCCCC'>
	...
	<td width='90' align='center' class='header_laporan'>Tgl 31</td>
     ...
     <td colspan='14' class='header_laporan'>$row->nama</td>
	   ...
	   isnull(b.n21,0) as n21,isnull(b.n22,0) as n22,isnull(b.n23,0) as n23,isnull(b.n24,0) as n25,
