...
class server_report_saku3_tu_kantin_rptTBLajur extends server_report_basic
{
...
from glma_tmp a
 inner join flag_relasi c on a.kode_akun=c.kode_akun and c.kode_flag='051' and a.kode_lokasi=c.kode_lokasi
";

		if ($mutasi=="Tidak")
		{
		  $sql.=$this->filter." and a.nik_user='$nik_user' and (a.so_awal<>0 or a.debet<>0 or a.kredit<>0 or a.so_akhir<>0) order by a.kode_akun ";
		}
		else
		{
