...
class server_report_saku3_tu_rptProyekRekonJurnal extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.no_ju,a.kode_lokasi,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.kode_pp,a.keterangan,a.kode_lokasi,a.tanggal,
       a.nik_buat,b.nama as nama_buat,a.nik_setuju,c.nama as nama_app, d.kota,a.keterangan,a.no_dokumen,a.no_dokumen as kode_proyek 
			from ju_m a
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			echo "<table border='0' cellspacing='2' cellpadding='1'>
			  <tr>
				<td align='center' class='header_laporan'>MEMO JURNAL REKON PELUNASAN PROYEK </td>
			  </tr>
			  <tr>
				<td>
