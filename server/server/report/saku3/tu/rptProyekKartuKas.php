...
class server_report_saku3_tu_rptProyekKartuKas extends server_report_basic
{
...
$this->filter order by a.kode_proyek";
		...
		echo $AddOnLib->judul_laporan("Kartu Pelunasan Piutang",$this->lokasi,$AddOnLib->ubah_periode($periode));
  ...
  <tr bgcolor='#CCCCCC'>
	...
	<td width='90' class='header_laporan' align='center'>Saldo</td>
			...
			$sql="select a.no_ju as no_bukti,convert(varchar,a.tanggal,103) as tgl,a.keterangan,a.nilai,a.tanggal,a.modul,
...
where a.kode_lokasi='$kode_lokasi' and b.kode_proyek='$row->kode_proyek' and a.jenis='PIU'
order by a.tanggal
