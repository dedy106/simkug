...
class server_report_saku3_tu_rptProyekPanjar extends server_report_basic
{
...
inner join tu_prbdd_d h on a.no_aju=h.no_bukti and a.kode_lokasi=h.kode_lokasi
inner join tu_proyek i on h.kode_proyek=i.kode_proyek and h.kode_lokasi=i.kode_lokasi
