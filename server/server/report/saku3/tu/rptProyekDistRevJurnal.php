...
class server_report_saku3_tu_rptProyekDistRevJurnal extends server_report_basic
{
...
left join karyawan c on a.nik_app=c.nik and a.kode_lokasi=c.kode_lokasi $this->filter ";
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			echo "<table border='0' cellspacing='2' cellpadding='1'>
			  <tr>
				<td align='center' class='header_laporan'>MEMO JURNAL REVERSE DISTRIBUSI BEBAN </td>
			  </tr>
			   <tr>
			    <td>
