...
class server_report_saku3_tu_rptProyekKartuBeban extends server_report_basic
{
...
$this->filter order by a.kode_proyek";
		...
		echo $AddOnLib->judul_laporan("Kartu Beban",$this->lokasi,$AddOnLib->ubah_periode($periode));
...
from tu_prbdd_d a
where a.kode_lokasi='$kode_lokasi' and a.modul in ('REVBDD','REVBMHD') and a.kode_proyek='$row->kode_proyek'
order by a.tanggal
