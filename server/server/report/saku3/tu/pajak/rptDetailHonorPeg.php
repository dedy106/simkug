...
class server_report_saku3_tu_pajak_rptDetailHonorPeg extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode=$tmp[0];
		$nama_cab=$tmp[1];
		$sql="select a.no_aju,a.kode_lokasi,a.no_kas,a.kode_pp,a.tanggal,case when d.flag_dosen='1' then c.nilai else c.nilai+c.pajak end as nilai,c.pajak,c.nama_rek,
...
inner join  id_pegawa d on c.nama_rek=d.nama and c.kode_lokasi=d.kode_lokasi
$this->filter 
