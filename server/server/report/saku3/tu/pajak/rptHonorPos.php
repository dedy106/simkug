...
class server_report_saku3_tu_pajak_rptHonorPos extends server_report_basic
{
...
$this->filter order by a.no_aju";
		...
		echo $AddOnLib->judul_laporan("posisi pengajuan HONOR",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
