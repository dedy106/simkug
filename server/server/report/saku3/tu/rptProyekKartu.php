...
$this->filter order by a.kode_proyek";
  ...
  <tr>
	...
	<td  class='isi_laporan' ><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenBdd('$row->kode_proyek','$row->kode_lokasi');\">Saldo BDD</a></td>
  ...
  <tr>
	...
	<td  class='isi_laporan' ><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenBeban('$row->kode_proyek','$row->kode_lokasi');\">Saldo Beban</a></td>
