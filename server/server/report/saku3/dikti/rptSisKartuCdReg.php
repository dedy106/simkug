...
class server_report_saku3_dikti_rptSisKartuCdReg extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		$sql="select a.no_reg,a.kode_lokasi,a.nama,a.kode_lokasi
from dikti_camaba a
...
order by a.no_reg ";
 ...
 ";
		...
		from (select a.no_bukti,a.nilai,convert(varchar(20),b.tanggal,103) as tgl,b.keterangan,b.modul,b.tanggal,
			...
			where a.nim='$row->no_reg' and a.kode_lokasi='$row->kode_lokasi'  and a.dc='D'
			union all
			...
			from dikti_cd a
			inner join kas_m b on a.no_bukti=b.no_kas and a.kode_lokasi=b.kode_lokasi
			where a.nim='$row->no_reg' and a.kode_lokasi='$row->kode_lokasi'  and a.dc='C'
			union all
			select a.no_bukti,a.nilai,convert(varchar(20),b.tanggal,103) as tgl,b.keterangan,b.modul,b.tanggal,
