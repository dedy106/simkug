...
class server_report_saku3_dikti_rptSisKartuCd extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		$sql="select g.no_bukti,g.modul,a.nim,a.nama,a.kode_kelas,b.nama as nama_kelas,a.kode_lokasi,a.kode_jur,c.nama as nama_jur,a.kode_akt,'-' as id_bank
from dikti_mhs a
...
left join (select a.no_bukti,a.kode_lokasi,a.modul,a.nim
			from dikti_cd a
			where a.kode_lokasi='$kode_lokasi' 
			group by a.no_bukti,a.kode_lokasi,a.modul,a.nim
...
// echo $sql;
 ...
 ";
			...
			$sql1="select a.kode_lokasi,a.no_bukti,a.tgl,a.keterangan,a.modul,a.debet,a.kredit,a.dc
		from (select a.kode_lokasi,a.no_bukti,a.nilai,convert(varchar(20),b.tanggal,103) as tgl,b.keterangan,b.modul,b.tanggal,
			...
			union all
			select a.kode_lokasi,a.no_bukti,a.nilai,convert(varchar(20),b.tanggal,103) as tgl,b.keterangan,b.modul,b.tanggal,
...
// echo $sql1;
			...
			{	
			  ...
			  echo "<tr>
				...
				echo "<td><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenBill('$row1->no_bukti','$row1->kode_lokasi','$row1->modul');\">$row1->no_bukti</a></td>
