...
class server_report_saku3_dikti_rptSisMhsYptReg extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		$sql="select a.no_reg,a.kode_lokasi,a.nama,a.nama,a.agama,a.jk,a.tmp_lahir,a.tgl_lahir,a.kwn,a.foto,a.alamat_siswa,
