...
class server_report_saku3_dikti_rptSisSaldoSiswaJur extends server_report_basic
{	
...
from dikti_jur a 
left join (select z.kode_jur,y.kode_lokasi,
			...
			inner join dikti_jur z on y.kode_jur=z.kode_jur and y.kode_lokasi=z.kode_lokasi 
			where(x.kode_lokasi = '$kode_lokasi')and(x.periode < '$periode') 			
			group by z.kode_jur,y.kode_lokasi			
