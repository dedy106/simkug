...
class server_report_saku3_dikti_rptRekapPiuTwPp extends server_report_basic
{	
...
//  echo $sql;
		...
		echo $AddOnLib->judul_laporan("saldo piutang dikti ver 2 triwulan",$this->lokasi."<br>".$nama_pp,"PERIODE ".$AddOnLib->ubah_periode($periode));
  ...
  <tr bgcolor='#CCCCCC'>
   ...
   <td class='isi_laporan' align='center'>$i</td>
    ...
    <td class='isi_laporan'><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenDet('$row->kode_lokasi','$periode');\">$row->kode_lokasi</a></td>
