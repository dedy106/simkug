...
class server_report_saku3_dikti_rptSisJurnalPiutangYpt extends server_report_basic
{
	...
	function getHtml()
	{
		...
		global $dbLib;
		$sql="select a.no_bukti,a.tanggal,convert(varchar,a.tanggal,103) as tgl,a.kode_lokasi,a.periode,b.nama,b.kota
			from trans_m a
