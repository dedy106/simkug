...
class server_report_saku3_siswa_rptSisJurnalLunas extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.no_rekon,a.kode_lokasi,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.kode_pp,a.keterangan,a.kode_lokasi,a.tanggal,
       a.nik_user,b.nama as nama_buat, d.kota,a.keterangan,a.no_dokumen,a.no_dokumen as kode_proyek 
			from sis_rekon_m a
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			echo "<table border='0' cellspacing='2' cellpadding='1'>
			  <tr>
				<td align='center' class='header_laporan'>MEMO JURNAL PELUNASAN VIA PDD </td>
			  </tr>
			  <tr>
				<td>
