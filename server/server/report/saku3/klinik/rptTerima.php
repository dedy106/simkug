...
class server_report_saku3_klinik_rptTerima extends server_report_basic
{	
	function getTotalPage()
	{
		global $dbLib;
		$sql="select count(a.no_terima)
from kli_terima_m a  $this->filter ";
		error_log($sql);
	...
	function getHtml()
	{
		...
		$sql="select a.no_terima,a.no_kirim,date_format(a.tanggal,'%d/%m/%Y') as tanggal,a.no_dokumen,a.keterangan,a.kode_pp_asal,b.nama as nama_asal ,a.kode_pp_tujuan,c.nama as nama_tujuan
from kli_terima_m a
