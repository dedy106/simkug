...
class server_report_saku3_klinik_rptHutangSaldo extends server_report_basic
{
...
$this->filter";
	...
	function getHtml()
	{
		...
		$sql="select a.kode_lokasi,a.no_beli,a.no_dokumen,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.tanggal,a.keterangan,b.nama as nama_cust,
  ...
  <tr>
   ...
   <tr bgcolor='#CCCCCC'>
     ...
     <td class='isi_laporan'>";
		echo "<a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenBayar('$row->no_beli','$row->kode_lokasi');\">$row->no_beli</a>";
		echo "</td>
