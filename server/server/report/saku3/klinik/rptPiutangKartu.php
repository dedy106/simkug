...
class server_report_saku3_klinik_rptPiutangKartu extends server_report_basic
{
...
$this->filter ";
	...
	function getHtml()
	{
		...
		global $dbLib;
		$sql="select a.kode_lokasi,a.no_jual,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.nilai,b.nama as nama_vendor
from kli_jual_m a
inner join kli_cust b on a.kode_cust=b.kode_cust and a.kode_lokasi=b.kode_lokasi 
  ...
  <tr >
    <td height='23' colspan='7' class='header_laporan'><table  border='0' cellspacing='2' cellpadding='1'>
      <tr>
        ...
        <td width='360' class='header_laporan'>: $row->no_jual</td>
      </tr>
	  <tr>
        <td width='99' class='header_laporan'>No Invoice</td>
...
";
			...
			$sql="select a.kode_lokasi,a.no_bukti,a.no_jual,a.nilai_kas,date_format(b.tanggal,'%d/%m/%Y') as tgl_kas,b.keterangan
