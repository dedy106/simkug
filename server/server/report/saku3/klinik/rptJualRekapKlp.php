...
class server_report_saku3_klinik_rptJualRekapKlp extends server_report_basic
{	
...
group by c.kode_klp,d.nama ";
		...
		echo $AddOnLib->judul_laporan("rekap penjualan per kelompok obat",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
