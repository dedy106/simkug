...
class server_report_saku3_klinik_rptJualRekapPp extends server_report_basic
{	
...
order by a.kode_pp ";
		...
		echo $AddOnLib->judul_laporan("rekap penjualan per gudang",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
