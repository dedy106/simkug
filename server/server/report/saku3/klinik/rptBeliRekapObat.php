...
class server_report_saku3_klinik_rptBeliRekapObat extends server_report_basic
{	
...
group by b.kode_obat,c.nama ";
		...
		echo $AddOnLib->judul_laporan("rekap pembelian per obat",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
