...
class server_report_saku3_optik_rptJurnalApp extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.no_bukti,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.no_dokumen,a.kode_lokasi,a.periode,b.nama,b.kota
			...
			inner join optik_app_m c on a.no_bukti=c.no_app and a.kode_lokasi=c.kode_lokasi
			$this->filter
			order by a.tanggal ";
		$rs = $dbLib->execute($sql);
		...
		{
			$judul="BUKTI JURNAL APPROVE PEMESANAN";
