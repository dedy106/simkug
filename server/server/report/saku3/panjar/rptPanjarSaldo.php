...
class server_report_saku3_panjar_rptPanjarSaldo extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$lokasi=$tmp[0];
		$periode=$tmp[1];	
		$sql="select a.nik_pengaju,b.nama,a.kode_pp,d.nama as nama_pp,a.no_pj,a.no_kas,
