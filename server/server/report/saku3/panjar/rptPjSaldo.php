...
class server_report_saku2_kb_rptPjSaldo extends server_report_basic
{
...
left join ptg_m c on a.no_pjaju=c.no_pjaju and a.kode_lokasi=c.kode_lokasi
$this->filter ";
	...
	function getHtml()
	{
		...
		$sql="select a.no_pjaju,b.nama,a.keterangan,date_format(a.tanggal,'%d/%m/%Y') as tgl_panjar,a.no_kas,a.nilai,
		c.no_ptg,date_format(c.tanggal,'%d/%m/%Y') as tgl_ptg,c.nilai as nilai_ptg,c.nilai_kas as nilai_kas_ptg
from yk_pjaju_m a
inner join karyawan b on a.nik_buat=b.nik and a.kode_lokasi=b.kode_lokasi
left join ptg_m c on a.no_pjaju=c.no_pj and a.kode_lokasi=c.kode_lokasi
$this->filter order by a.no_pjaju";
