...
class server_report_saku3_siaga_rptFormBMHD extends server_report_basic
{
...
$this->filter order by a.no_pb ";
  ...
  <tr>
    <td align='center' class='judul_bukti'>JUSTIFIKASI PENGAJUAN BMHD</td>
  </tr>
  <tr>
 ...
 from gr_pb_j a 
  inner join gr_pb_m f on a.no_pb=f.no_pb and a.kode_lokasi=f.kode_lokasi
   left join angg_r c on f.no_pb=c.no_bukti and  a.kode_akun=c.kode_akun
...
where a.no_pb='$row->no_pb' and a.kode_lokasi='$row->kode_lokasi' and a.modul ='BMHD'
order by a.no_urut ";
