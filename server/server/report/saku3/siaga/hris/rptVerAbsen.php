...
class server_report_saku3_siaga_hris_rptVerAbsen extends server_report_basic
{	
...
inner join gr_karyawan b on a.nik_app=b.nik and a.kode_lokasi=b.kode_lokasi $this->filter order by a.no_ver";
		...
		echo $AddOnLib->judul_laporan("verifikasi absen",$this->lokasi,$AddOnLib->ubah_periode($periode));
...
";
	  ...
	  $sql1="select a.modul,a.no_bukti,a.catatan,convert(varchar,b.tanggal,103) as tanggal,b.keterangan,b.kode_loker+' - '+c.nama as loker,b.nik_buat+' - '+d.nama as karyawan,
