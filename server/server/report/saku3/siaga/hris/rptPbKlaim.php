...
class server_report_saku3_siaga_hris_rptPbKlaim extends server_report_basic
{
...
where a.no_pb='$row->no_pb' and a.kode_lokasi='$row->kode_lokasi' and c.modul in ('KLAIM')
order by a.no_urut ";
