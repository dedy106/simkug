...
class server_report_saku3_siaga_hris_rptPbBenefitSpj extends server_report_basic
{
...
where a.no_pb='$row->no_pb' and a.kode_lokasi='$row->kode_lokasi' and c.modul in ('SPJ')
order by a.no_urut ";
...
// order by a.nu ";
      $sql = "select c.no_pb,b.nama as nama_brg,'-' as satuan,1 as jumlah, a.nilai as harga from gr_kes_d a
