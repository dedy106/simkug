...
class server_report_saku3_siaga_hris_rptReimburse extends server_report_basic
{	
...
inner join gr_karyawan b on a.nik_buat=b.nik and a.kode_lokasi=b.kode_lokasi
 $this->filter order by a.no_kes ";
		...
		echo $AddOnLib->judul_laporan("laporan pengajuan benefit",$this->lokasi,$AddOnLib->ubah_periode($periode));
