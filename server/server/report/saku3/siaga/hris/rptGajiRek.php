...
class server_report_saku3_siaga_simlog_rptGajiRek extends server_report_basic
{
...
$this->filter order by a.kode_vendor";
		...
		echo $AddOnLib->judul_laporan("data lampiran gaji",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
   ...
   <tr bgcolor='#CCCCCC'>
	 ...
	 <td width='200'  align='center' class='header_laporan'>No Rekening</td>
