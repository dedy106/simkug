...
class server_report_saku3_siaga_hris_rptAppSurat extends server_report_basic
{	
...
inner join gr_karyawan b on a.nik_app=b.nik and a.kode_lokasi=b.kode_lokasi $this->filter order by a.no_app";
		...
		echo $AddOnLib->judul_laporan("approval surat keterangan",$this->lokasi,$AddOnLib->ubah_periode($periode));
  ...
  <tr bgcolor='#CCCCCC'>
	...
	<td width='150' class='header_laporan'>Kepada</td>
  </tr>
";
		
	  $sql1="select a.modul,a.no_bukti,a.catatan,convert(varchar,b.tanggal,103) as tanggal,b.kode_dept+' - '+c.nama as dept,
	  b.nik_buat+' - '+d.nama as karyawan,b.keterangan,b.kepada 
from gr_app_d a
inner join gr_surat b on a.no_bukti=b.no_surat and a.kode_lokasi=b.kode_lokasi
...
order by a.no_bukti ";
	...
	<td align='left' class='isi_laporan'>$row1->kepada</td>
  </tr>";
		$j=$j+1;
		}
