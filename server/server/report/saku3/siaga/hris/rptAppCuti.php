...
class server_report_saku3_siaga_hris_rptAppCuti extends server_report_basic
{	
...
inner join gr_karyawan b on a.nik_app=b.nik and a.kode_lokasi=b.kode_lokasi $this->filter order by a.no_app";
		...
		echo $AddOnLib->judul_laporan("approval cuti" ,$this->lokasi,$AddOnLib->ubah_periode($periode));
