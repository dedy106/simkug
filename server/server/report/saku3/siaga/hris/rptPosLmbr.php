...
class server_report_saku3_siaga_hris_rptPosLmbr extends server_report_basic
{	
...
order by a.no_lembur ";
		...
		echo $AddOnLib->judul_laporan("data posisi lembur",$this->lokasi);
		echo "<table border='1' cellspacing='0' cellpadding='0' class='kotak' >
  <tr bgcolor='#CCCCCC'>
		<td width='30' align='center' class='header_laporan'>No</td>
		<td width='100' align='center' class='header_laporan'>No Lembur</td>
		...
		<td width='80' align='center' class='header_laporan'>Dilaporkan Kepada</td>
	    <td width='100' align='center' class='header_laporan'>Tugas</td>
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			...
			<td class='isi_laporan'>$row->no_lembur</td>
