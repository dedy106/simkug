...
class server_report_saku3_siaga_hris_rptGajiPph extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$footer=$row->nama;
		$sql="select x.nik,b.nama,b.sts_pajak,x.total_bln,x.total,x.b_jab,x.ptkp,x.pkp,
