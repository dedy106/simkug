...
class server_report_saku3_siaga_hris_rptAppSppd extends server_report_basic
{	
...
inner join gr_karyawan b on a.nik_app=b.nik and a.kode_lokasi=b.kode_lokasi $this->filter order by a.no_app";
		...
		echo $AddOnLib->judul_laporan("approval perjalanan dinas",$this->lokasi,$AddOnLib->ubah_periode($periode));
  ...
  <tr bgcolor='#CCCCCC'>
	...
	<td width='150' align='center' class='header_laporan'>Status SPPD</td>
	<td width='150' align='center' class='header_laporan'>Keterangan</td>
	<td width='80' align='center' class='header_laporan'>Uang Transport</td>
...
";
	  ...
	  b.nik_buat+' - '+d.nama as karyawan,b.keterangan,b.transport,b.harian 
from gr_app_d a
inner join gr_spj_m b on a.no_bukti=b.no_spj and a.kode_lokasi=b.kode_lokasi
...
order by a.no_bukti ";
	...
	<td align='right' class='isi_laporan'>".number_format($row1->transport)."</td>
	<td align='right' class='isi_laporan'>".number_format($row1->harian)."</td>
  </tr>";
		$j=$j+1;
		}
