...
class server_report_saku3_siaga_hris_rptVerKlaim extends server_report_basic
{	
...
from gr_ver_m a
inner join gr_karyawan b on a.nik_app=b.nik and a.kode_lokasi=b.kode_lokasi $this->filter and a.modul='KLAIM' ";
...
from gr_ver_m a
inner join gr_karyawan b on a.nik_app=b.nik and a.kode_lokasi=b.kode_lokasi $this->filter and a.modul='KLAIM' order by a.no_ver";
		...
		echo $AddOnLib->judul_laporan("verifikasi FINALKLAIM",$this->lokasi,$AddOnLib->ubah_periode($periode));
...
order by b.no_klaim ";
	...
	<td align='left' class='isi_laporan'>$row1->nama_asur</td>
