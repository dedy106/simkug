...
class server_report_saku3_siaga_hris_rptCuti extends server_report_basic
{	
...
group by nik,kode_lokasi,sts_cuti) f on a.nik_buat=f.nik and a.kode_lokasi=f.kode_lokasi and a.sts_cuti=f.sts_cuti
$this->filter
 order by a.no_cuti";
//  echo $sql;		
