...
class server_report_saku3_siaga_hris_rptAppLembur extends server_report_basic
{	
...
inner join gr_karyawan b on a.nik_app=b.nik and a.kode_lokasi=b.kode_lokasi $this->filter order by a.no_app";
		...
		echo $AddOnLib->judul_laporan("approval lembur",$this->lokasi,$AddOnLib->ubah_periode($periode));
  ...
  <tr bgcolor='#CCCCCC'>
	...
	<td width='150' align='center' class='header_laporan'>Tugas</td>
	<td width='150' align='center' class='header_laporan'>Keterangan</td>
	<td width='100' align='center' class='header_laporan'>Jam</td>
	<td width='60' align='center' class='header_laporan'>Jam Kerja</td>
  </tr>
";
		
	  $sql1="select a.modul,a.no_bukti,a.catatan,convert(varchar,b.tanggal,103) as tanggal,b.keterangan,
	  b.kode_loker+' - '+c.nama as loker,b.nik_buat+' - '+d.nama as karyawan,b.tugas,b.keterangan,b.jam,b.jam_kerja 
from gr_app_d a
inner join gr_lembur b on a.no_bukti=b.no_lembur and a.kode_lokasi=b.kode_lokasi
...
order by a.no_bukti ";
	...
	<td align='left' class='isi_laporan'>$row1->tugas</td>
	<td align='left' class='isi_laporan'>$row1->keterangan</td>
	<td align='left' class='isi_laporan'>$row1->jam</td>
	<td align='right' class='isi_laporan'>".number_format($row1->jam_kerja)."</td>
  </tr>";
		$j=$j+1;
		}
