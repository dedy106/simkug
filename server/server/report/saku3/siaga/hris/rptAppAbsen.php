...
class server_report_saku3_siaga_hris_rptAppAbsen extends server_report_basic
{	
...
inner join gr_karyawan b on a.nik_app=b.nik and a.kode_lokasi=b.kode_lokasi $this->filter ";
	...
	function getHtml()
	{
		...
		$kode_bidang=$tmp[4];
		$ver=$tmp[1];
		$sql="select a.no_app,date_format(a.tanggal,'%d/%m/%Y') as tanggal,a.modul,a.nik_app,b.nama,a.catatan,a.periode,a.kode_lokasi
from gr_app_m a
inner join gr_karyawan b on a.nik_app=b.nik and a.kode_lokasi=b.kode_lokasi $this->filter order by a.no_app";
		...
		echo $AddOnLib->judul_laporan("data approval",$this->lokasi,$AddOnLib->ubah_periode($periode));
  ...
  <tr bgcolor='#CCCCCC'>
   ...
   <td width='150' class='header_laporan'>Keterangan</td>
	...
	<td width='150' class='header_laporan'>Status Absen</td>
	
  </tr>
";
		
	  $sql1="select a.modul,a.no_bukti,a.catatan,convert(varchar,b.tanggal,103) as tanggal,b.keterangan,b.nik_buat+' - '+d.nama as karyawan,
	  b.sts_absen+' - '+e.nama as absen
from gr_app_d a
inner join gr_absen b on a.no_bukti=b.no_absen and a.kode_lokasi=b.kode_lokasi
inner join gr_karyawan d on b.nik_buat=d.nik and b.kode_lokasi=d.kode_lokasi 
inner join gr_status_absen e on b.sts_absen=e.sts_absen and b.kode_lokasi=e.kode_lokasi 
...
order by a.no_bukti ";
	...
	<td align='left' class='isi_laporan'>$row1->absen</td>
