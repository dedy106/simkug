...
class server_report_saku3_siaga_hris_rptVerLembur extends server_report_basic
{	
...
inner join gr_karyawan b on a.nik_app=b.nik and a.kode_lokasi=b.kode_lokasi $this->filter order by a.no_ver";
		...
		echo $AddOnLib->judul_laporan("verifikasi lembur",$this->lokasi,$AddOnLib->ubah_periode($periode));
  ...
  <tr bgcolor='#CCCCCC'>
	...
	<td width='150' class='header_laporan'>Tugas</td>
	<td width='150' class='header_laporan'>Keterangan</td>
	<td width='100' class='header_laporan'>Jam</td>
	<td width='60' class='header_laporan'>Jam Kerja</td>
  </tr>
";
