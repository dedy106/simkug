...
class server_report_saku3_siaga_hris_rptAppReimb extends server_report_basic
{	
...
from gr_ver_m a
inner join gr_karyawan b on a.nik_app=b.nik and a.kode_lokasi=b.kode_lokasi $this->filter and a.modul='FINALREIMB' ";
...
from gr_ver_m a
inner join gr_karyawan b on a.nik_app=b.nik and a.kode_lokasi=b.kode_lokasi $this->filter and a.modul='FINALREIMB' order by a.no_ver";
		error_log($sql);
  ...
  <tr bgcolor='#CCCCCC'>
	...
	<td width='60' align='center' class='header_laporan'>Tgl Transfer</td>
...
";
	  ...
	  $sql1="select b.no_kes as no_bukti,a.catatan,convert(varchar,b.tanggal,103) as tanggal,convert(varchar,b.tgl_terima,103) as tgl_terima,b.keterangan,
	   ...
	   isnull(x.nilai,0) as nilai,convert(varchar,b.tgl_transfer,103) as tgl_transfer
from gr_ver_d a
...
order by a.no_bukti ";
	...
	<td align='left' class='isi_laporan'>$row1->tgl_transfer</td>
