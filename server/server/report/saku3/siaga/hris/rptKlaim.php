...
class server_report_saku3_siaga_hris_rptKlaim extends server_report_basic
{	
...
inner join gr_karyawan b on a.nik_buat=b.nik and a.kode_lokasi=b.kode_lokasi
 $this->filter order by a.no_klaim ";
		...
		echo $AddOnLib->judul_laporan("laporan pengajuan klaim asuransi",$this->lokasi,$AddOnLib->ubah_periode($periode));
...
";
	  ...
	  $sql1="select a.nik,a.no_urut,b.nama,a.keterangan,a.nilai
			from gr_klaim_d a 
