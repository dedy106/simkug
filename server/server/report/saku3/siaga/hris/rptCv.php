...
class server_report_saku3_siaga_hris_rptCv extends server_report_basic
{	
...
left join gr_vendor k on a.kode_vendor=k.kode_vendor and a.kode_lokasi = k.kode_lokasi 
...
inner join gr_jur m on a.kode_jur=m.kode_jur and a.kode_lokasi=m.kode_lokasi $this->filter ";
	...
	function getHtml()
	{
		...
		$sql="select a.nik,a.kode_lokasi,a.kode_prov,b.nama as nama_prov,a.no_ktp,a.nama,a.tempat, convert(varchar,a.tgl_lahir,103) as tgl_lahir,a.alamat,a.kota,a.kodepos,a.no_telp,a.no_hp,a.sex,a.email,a.gol_darah, 
a.nik2,a.npwp,a.suku,a.sts_agama,c.nama as nama_agama,a.sts_didik,d.nama as nama_didik,m.nama as nama_jur,a.foto,a.sts_pajak,convert(varchar,a.tgl_nikah,103) as tgl_nikah, 
convert(varchar(20),a.tgl_masuk,103) as tgl_masuk,a.kode_jab,a.kode_grade,a.kode_loker,a.kode_dir,a.kode_dept,a.sts_sdm,a.kode_vendor,a.sts_bank,
...
inner join gr_sk_d f on e.no_sk=f.no_sk and e.nik=f.nik and e.kode_lokasi=f.kode_lokasi
      ...
      <tr>
        <td><table width='100%' border='1' cellspacing='0' cellpadding='0' class='kotak'>
		  ...
		  $sql1="select a.nama as latih,a.nik,b.nama,d.nama as sts_latih,a.nama,a.lama,date_format(a.tgl_mulai,'%d/%m/%Y') as tgl_awal,
