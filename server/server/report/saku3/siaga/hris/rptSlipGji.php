...
class server_report_saku3_siaga_hris_rptSlipGji extends server_report_basic
{
...
left join gr_gaji_load f on e.no_gaji=f.no_gaji and e.kode_lokasi=f.kode_lokasi and a.nik=f.nik
