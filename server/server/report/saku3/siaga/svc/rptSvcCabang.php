...
class server_report_saku3_siaga_svc_rptSvcCabang extends server_report_basic
{
...
left join (select a.kode_cabang,sum(c.nilai_kas) as nilai_kas
		   from gr_svc_m a
		   inner join gr_svc_d b on a.no_svc=b.no_svc and a.kode_lokasi=b.kode_lokasi
		   inner join gr_svcbayar_d c on c.no_invoice=b.no_invoice and b.kode_lokasi=c.kode_lokasi
		   group by a.kode_cabang
