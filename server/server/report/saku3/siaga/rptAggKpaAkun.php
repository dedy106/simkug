...
class server_report_saku3_siaga_rptAggKpaAkun extends server_report_basic
{
	...
	function getHtml()
	{
		...
		echo $AddOnLib->judul_laporan("kartu pengawasan anggaran",$this->lokasi,"TAHUN ".$tahun);
	
		$sql = "select a.kode_lokasi,a.kode_akun,b.nama as nama_akun,sum(isnull(case when dc='D' then nilai else -nilai end,0)) as so_awal
from anggaran_d a
inner join masakun b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi 
$this->filter 
group by a.kode_lokasi,a.kode_akun,b.nama ";
