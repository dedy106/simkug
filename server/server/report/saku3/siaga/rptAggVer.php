...
class server_report_saku3_siaga_rptAggVer extends server_report_basic
{
	...
	function getHtml()
	{
		...
		a.nik_app2,c.nama as nama2,substring(a.periode,1,4) as tahun,d.kota,a.tanggal,c.email,a.nik_app1,e.nama as nama1
from rra_pdrk_m a
inner join karyawan b on a.nik_buat=b.nik and a.kode_lokasi=b.kode_lokasi
inner join karyawan c on a.nik_app2=c.nik and a.kode_lokasi=c.kode_lokasi
inner join karyawan e on a.nik_app1=e.nik and a.kode_lokasi=e.kode_lokasi
inner join lokasi d on a.kode_lokasi=d.kode_lokasi
 $this->filter and a.modul = 'MULTI' and a.progress in ('9') order by a.no_pdrk";
		...
		echo $AddOnLib->judul_laporan("daftar pengajuan anggaran",$this->lokasi,$tahun);
...
order by a.dc desc ";
	...
	<td align='right' class='header_laporan'>".number_format($kredit,0,",",".")."</td>
			...
			$nama2=$row->nama2;
			$nik_app2=$row->nik_app2;
			$nama1=$row->nama1;
			$nik_app1=$row->nik_app1;
	  ...
	  <tr>
		<td  class='header_laporan'>Note : Sudah di approve oleh $nama1 / $nik_app1 </td>
	  </tr>
	  <tr>
        <td  class='header_laporan'>&nbsp;</td>
        </tr>
	  <tr>
        <td  class='header_laporan'>Jakarta , $tgl</td>
        </tr>
      <tr>
      ...
      <tr>
        <td class='header_laporan'>$nama2</td>
      </tr>
      <tr>
        <td class='header_laporan'>$nik_app2</td>
      </tr>
  </table>";
		}
