...
class server_report_saku3_siaga_simlog_rptPenetapan extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		$sql="select a.no_pesan,date_format(j.tanggal,'%d/%m/%Y') as tanggal,j.no_dokumen,j.keterangan,a.kode_pp,b.nama as nama_pp,
		...
		h.kode_vendor,h.nama as nama_vendor,g.no_sph,i.no_nego,j.no_tap
from log_pesan_m a
...
order by j.no_tap";
		...
		echo $AddOnLib->judul_laporan("penetapan pemenang pemilihan langsung",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
