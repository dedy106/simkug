...
class server_report_saku3_logistik_rptSanggup extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		h.kode_vendor,h.nama as nama_vendor,g.no_sph,i.no_nego,j.no_tap,k.no_spk,l.no_sanggup
from log_pesan_m a
...
inner join log_sanggup_m l on k.no_sanggup=l.no_sanggup and k.kode_lokasi=l.kode_lokasi
$this->filter
order by k.no_spk";
		...
		echo $AddOnLib->judul_laporan("surat kesanggupan",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
  ...
  <tr>
    <td colspan='20' style='padding:5px'><table width='100%' border='0' cellspacing='2' cellpadding='1'>
      <tr>
        ...
        <td class='header_laporan'>:&nbsp;$row->no_sanggup</td>
        </tr>
		<tr>
