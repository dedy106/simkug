...
class server_report_saku3_siaga_simlog_rptAppLog extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$tmp=explode("/",$this->filter2);
		$periode=$tmp[0];
    $sql="select i.nama as proyek,h.jenis,a.kode_lokasi,a.no_app,a.tanggal,a.no_pesan, convert(varchar,a.tanggal,103) as tgl, d.kode_pp,
    d.nama as pp, a.no_dokumen,a.keterangan,a.nilai,c.nik,c.nama as pembuat,a.nik_user, f.nama as tahu,
    e.status,g.catatan,a.maksud, a.aspek ,e.modul
     from log_pesan_m a 
     inner join karyawan c on a.nik_buat=c.nik and a.kode_lokasi=c.kode_lokasi 
    inner join pp d on a.kode_ppaju=d.kode_pp and a.kode_lokasi=d.kode_lokasi
     inner join app_m e on a.no_terima=e.no_app and a.kode_lokasi=e.kode_lokasi
     inner join karyawan f on a.nik_user=f.nik and a.kode_lokasi=f.kode_lokasi 
    inner join app_d g on g.no_app=a.no_terima and a.kode_lokasi=g.kode_lokasi 
    inner join log_justerima_m h on a.no_terima=h.no_terima and a.kode_lokasi=h.kode_lokasi
    left join log_proyek i on a.kode_proyek=i.kode_proyek and a.kode_lokasi=i.kode_lokasi
 $this->filter ";
  ...
  <tr>
    <td align='center' class='istyle17'><u>APPROVE LOGISTIK </td><u>
  </tr>
  <tr>
  ...
  <tr>
  <td  height='20' class='isi_bukti'>Jenis Pengadaan</td>
...
<td class='isi_bukti'>: $row->proyek  </td>
  ...
  <tr>
  <td  height='20' class='isi_bukti'>Nilai IDR</td>
