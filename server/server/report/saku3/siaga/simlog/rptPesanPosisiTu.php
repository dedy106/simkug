...
class server_report_saku3_siaga_simlog_rptPesanPosisiTu extends server_report_basic
{
	...
	function getHtml()
	{
		...
		r.no_pb,date_format(r.tanggal,'%d/%m/%Y') as tgl_pb,r.no_agenda,
...
$this->filter  order by a.no_pesan";
   ...
   <td width='200'  align='center' class='header_laporan'>Keterangan</td>
	 ...
	 <td class='isi_laporan'>$row->tgl_sph</td>
	  ...
	  <td class='isi_laporan'><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenPb('$row->no_agenda','$row->kode_lokasi');\">$row->no_agenda</a></td>
