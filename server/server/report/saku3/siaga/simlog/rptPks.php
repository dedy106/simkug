...
class server_report_saku3_siaga_simlog_rptPks extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		$sql="select a.no_pesan,date_format(l.tanggal,'%d/%m/%Y') as tanggal,l.no_dokumen,l.keterangan,a.kode_pp,b.nama as nama_pp,
		a.kode_akun,c.nama as nama_akun,e.nama as nama_lokasi,a.lok_proses,a.maksud,a.aspek,a.no_spph,
		h.kode_vendor,h.nama as nama_vendor,g.no_sph,i.no_nego,j.no_tap,k.no_spk,l.no_pks
from log_pesan_m a
...
inner join log_pks_m l on k.no_pks=l.no_pks and k.kode_lokasi=l.kode_lokasi
$this->filter
order by l.no_pks";
		...
		echo $AddOnLib->judul_laporan("penerbitan pks",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
  ...
  <tr>
    <td colspan='20' style='padding:5px'><table width='100%' border='0' cellspacing='2' cellpadding='1'>
      <tr>
	   ...
	   <tr>
        <td class='header_laporan' width='114'>No PKS </td>
        <td class='header_laporan'>:&nbsp;$row->no_pks</td>
        </tr>
	     <tr>
