...
class server_report_saku3_logistik_rptSphTender extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		$sql="select a.no_pesan,date_format(g.tanggal,'%d/%m/%Y') as tanggal,g.no_dokumen,g.keterangan,a.kode_pp,b.nama as nama_pp,
		...
		h.kode_vendor,h.nama as nama_vendor,g.no_sph
from log_pesan_m a
...
order by g.no_sph";
		...
		echo $AddOnLib->judul_laporan("Surat Penawaran Harga",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
  ...
  <tr bgcolor='#CCCCCC'>
    ...
    <td width='90' align='center' class='header_laporan'>Harga Tawar</td>
     <td width='90' align='center' class='header_laporan'>PPN</td>
	  <td width='90' align='center' class='header_laporan'>Total</td>
  </tr>";
			$sql1="select b.kode_klpfa,c.nama as nama_klp,a.item,a.merk,a.tipe,a.catatan,a.nilai,a.jumlah,
			a.nilai_nego,d.ppn as n_ppn,a.ppn_nego,(a.nilai*a.jumlah)+d.ppn as total,(a.nilai_nego*a.jumlah)+a.ppn_nego as total_nego
from log_sph_d a
inner join log_spph_d b on a.no_spph=b.no_spph and a.kode_lokasi=b.kode_lokasi and a.no_urut=b.no_urut
inner join log_sph_m d on a.no_sph=d.no_sph and a.kode_lokasi=d.kode_lokasi
inner join fa_klp c on b.kode_klpfa=c.kode_klpfa and b.kode_lokasi=c.kode_lokasi
where a.no_sph='$row->no_sph'
order by c.kode_klpfa ";
   ...
   <td align='right' class='isi_laporan'>".number_format($row1->jumlah,0,",",".")."</td>
    <td align='right' class='isi_laporan'>".number_format($row1->nilai,0,",",".")."</td>
	 <td align='right' class='isi_laporan'>".number_format($row1->n_ppn,0,",",".")."</td>
