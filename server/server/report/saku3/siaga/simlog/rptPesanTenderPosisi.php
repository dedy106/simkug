...
class server_report_saku3_siaga_simlog_rptPesanTenderPosisi extends server_report_basic
{
	...
	function getHtml()
	{
		...
		a.kode_drk,d.nama as nama_drk,a.kode_akun,c.nama as nama_akun,a.no_app,a.no_terima,a.no_spph,i.no_sph,i.no_nego,g.no_tap,k.no_spk,l.no_pks,
		...
		date_format(l.tanggal,'%d/%m/%Y') as tgl_spk,date_format(m.tanggal,'%d/%m/%Y') as tgl_pks,n.nama as nama_vendor
from log_pesan_m a
...
left join log_justerima_m f on a.no_terima=f.no_terima and a.kode_lokasi=f.kode_lokasi and f.jenis='TD'
...
left join vendor n on h.kode_vendor=n.kode_vendor and h.kode_lokasi=n.kode_lokasi
$this->filter order by a.no_pesan";
   ...
   <td width='200'  align='center' class='header_laporan'>Keterangan</td>
	 ...
	 <td width='90'  align='center' class='header_laporan'>Approve Penerimaan</td>
	 <td width='60'  align='center' class='header_laporan'>Tgl Approve</td>
	 <td width='40'  align='center' class='header_laporan'>No SPPH</td>
	 <td width='150'  align='center' class='header_laporan'>Tgl SPPH</td>
	 ...
	 <td width='60'  align='center' class='header_laporan'>Tgl SPH</td>
	  <td width='40'  align='center' class='header_laporan'>Klarifikasi & Negosiasi</td>
	   <td width='150'  align='center' class='header_laporan'>Tgl Klarifikasi</td>
	    <td width='90'  align='center' class='header_laporan'>Penetapan Pemenang</td>
	 <td width='90'  align='center' class='header_laporan'>Tgl Penetapan</td>
	 <td width='60'  align='center' class='header_laporan'>Penerbitan SPK</td>
	 <td width='90'  align='center' class='header_laporan'>Tgl SPK</td>
	  <td width='60'  align='center' class='header_laporan'>Penerbitan PKS</td>
	 <td width='90'  align='center' class='header_laporan'>Tgl PKS</td>
	  </tr>  ";
		$nilai=0;
	 ...
	 <td class='isi_laporan'>$row->tgl_terima</td>
	  <td class='isi_laporan'><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenSpph('$row->no_spph','$row->kode_lokasi');\">$row->no_spph</a></td>
	   <td class='isi_laporan'>$row->tgl_spph</td>
