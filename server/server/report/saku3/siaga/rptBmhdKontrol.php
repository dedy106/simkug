...
class server_report_saku3_siaga_rptBmhdKontrol extends server_report_basic
{
...
$this->filter order by a.no_pb";
		...
		echo $AddOnLib->judul_laporan("kontrol pengajuan bmhd",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
   ...
   <tr bgcolor='#CCCCCC'>
	 ...
	 <td width='90'  align='center' class='header_laporan'>Attensi</td>
	...
	<td width='40'  align='center' class='header_laporan'>Status</td>
	 ...
	 <td width='150'  align='center' class='header_laporan'>No Approve Akunting</td>
