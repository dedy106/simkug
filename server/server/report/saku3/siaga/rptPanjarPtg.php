...
class server_report_saku3_siaga_rptPanjarPtg extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode=$tmp[2];
		$filter2=$tmp[3];
		$sql="select a.no_ptg,a.no_panjar,a.tanggal,a.kode_pp,b.nama as nama_pp,c.nik_buat,a.nik_tahu as nik_app_panjar,a.nik_app, 
    d.nama as nama_app,e.nama as nama_buat ,f.nama as nama_app_panjar,a.nilai,a.keterangan, c.nilai as nilai_panjar,c.nilai-a.nilai as saldo 
from gr_panjarptg_m a 
inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi 
inner join gr_pb_m c on a.no_panjar=c.no_pb and a.kode_lokasi=c.kode_lokasi 
...
$this->filter order by a.no_ptg";
  ...
  <tr>
    <td><table border='0' cellspacing='2' cellpadding='1'>
      ...
      <tr>
        <td> Jl.Letjen S parman kav 56 Jakarta</td>
  ...
  <tr>
    <td align='center' class='istyle17' >DAFTAR PERTANGGUNGAN  PANJAR </td>
  </tr>
  <tr>
  ...
  <tr>
    <td><table width='800' border='0' cellspacing='2' cellpadding='1'>
      <tr>
        ...
        <td width='91'>Pusat Pertanggungan</td>
