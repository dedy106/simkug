...
class server_report_saku3_spj_rptPdBebanFormTu3 extends server_report_basic
{
  ...
  <tr>
    <td><table width='100%'  border='0'>
	  <tr>
        ...
        <td rowspan='8' style='vertical-align:top'><img alt='$row->no_aju' src='$root_app/temp/$row->no_aju.png'></td>
      </tr>
      <tr>
        <td>Tanggal</td>
        <td>: $row->tgl </td>
