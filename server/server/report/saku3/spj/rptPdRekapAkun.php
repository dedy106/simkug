...
class server_report_saku3_spj_rptPdRekapAkun extends server_report_basic
{
...
left join (select e.kode_akun,a.kode_pp,a.kode_lokasi,
		   ...
		   inner join it_aju_m e on d.no_aju=e.no_aju and d.kode_lokasi=e.kode_lokasi
		   where e.kode_lokasi='$lokasi' and e.form='SPPD'
		   group by  e.kode_akun,a.kode_pp,a.kode_lokasi
