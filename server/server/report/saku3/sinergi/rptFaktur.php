...
class server_report_saku3_sinergi_rptFaktur extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		$html="";
		for ($j = 1; $j <= 2; $j++) {
		$sql = "select a.no_so,b.nama,b.alamat+b.kota+b.kodepos as alamat,b.npwp,b.tgl_pkp,c.nama as nama_app,c.jabatan,
       d.nama as nama_cust,d.alamat2 alamat_cust,d.npwp as npwp_cust,a.nilai,
       a.no_so as no_faktur,a.tanggal
from si_so_m a
...
inner join si_cust d on a.kode_cust=d.kode_cust and a.kode_lokasi=d.kode_lokasi ".$this->filter;
				  ...
				  <tr>
				    <td class='istyle15'><table width='100%' border='1' cellspacing='1' cellpadding='1' class='kotak'>
				      ...
				      <tr>
						...
						$sql1="select keterangan,nilai from si_so_m where no_bill='$rs->no_bill' ";
