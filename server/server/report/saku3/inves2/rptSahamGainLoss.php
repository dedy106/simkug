...
class server_report_saku3_inves2_rptSahamGainLoss extends server_report_basic
{
...
left join (select a.kode_plan,b.kode_kelola,b.kode_saham,
		...
		group by a.kode_plan,b.kode_kelola,b.kode_saham
		)d on a.kode_saham=d.kode_saham and a.kode_kelola=d.kode_kelola and a.kode_plan=d.kode_plan
left join (select a.kode_plan,b.kode_kelola,a.kode_saham,
		...
		where substring(a.periode,1,4)='$tahun'
		group by b.kode_kelola,a.kode_saham,a.kode_plan
		) e on a.kode_saham=e.kode_saham and a.kode_kelola=e.kode_kelola and a.kode_plan=e.kode_plan
		$this->filter and (isnull(d.total,0)<>0 or isnull(e.total,0)<>0)
...
";
		...
		echo $AddOnLib->judul_laporan("laporan saham gainloss dan deviden",$this->lokasi,"TAHUN $tahun");
		echo "<table  border='1' cellspacing='0' cellpadding='0' class='kotak' width='1400'>
  <tr bgcolor='#CCCCCC'>
    <td width='30' rowspan='2' align='center' class='header_laporan'>No</td>
    <td width='60' rowspan='2' align='center' class='header_laporan'>Kode Saham </td>
