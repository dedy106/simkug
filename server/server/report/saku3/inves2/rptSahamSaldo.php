...
class server_report_saku3_inves2_rptSahamSaldo extends server_report_basic
{
...
left join (select a.kode_lokasi,a.kode_saham,a.kode_kelola,a.kode_plan,
		   ...
		   from inv_shmspi_d a inner join inv_shmspi_m b on a.no_spi=b.no_spi and a.kode_lokasi=b.kode_lokasi 
		   where b.periode <= '$periode' 
		   group by a.kode_lokasi,a.kode_saham,a.kode_kelola,a.kode_plan
		   )d on b.kode_saham=d.kode_saham and b.kode_kelola=d.kode_kelola and b.kode_plan=d.kode_plan $this->filter
...
inner join inv_saham_d b on a.kode_saham=b.kode_saham
inner join inv_kelola c on b.kode_kelola=c.kode_kelola
left join (select a.kode_saham,a.kode_kelola,
			      sum(case when a.dc='D' then a.jumlah else -a.jumlah end) as jumlah,
		   ...
		   from inv_shmspi_d a inner join inv_shmspi_m b on a.no_spi=b.no_spi and a.kode_lokasi=b.kode_lokasi 
		   where b.periode <= '$periode' 
		   group by a.kode_saham,a.kode_kelola
	...
	*/
		...
		$sql="select a.kode_saham,a.nama as nama_saham,b.kode_kelola,c.nama as nama_kelola,
			  ...
			  from inv_saham a
				   ...
				   inner join inv_kelola c on b.kode_kelola=c.kode_kelola
				   left join (
					   	select a.kode_saham,a.kode_kelola,a.kode_plan,
			      			  sum(case when a.dc='D' then a.jumlah else -a.jumlah end) as jumlah,
				  			  a.h_oleh,
				  			  a.h_buku,
				  			  a.h_wajar
		   				...
		   				group by a.kode_plan,a.kode_saham,a.kode_kelola,a.h_oleh,a.h_buku,a.h_wajar
		   				) d on b.kode_saham=d.kode_saham and b.kode_kelola=d.kode_kelola and b.kode_plan=d.kode_plan
			   $this->filter and  isnull(d.jumlah,0) <> 0 order by b.kode_kelola,a.kode_saham";
