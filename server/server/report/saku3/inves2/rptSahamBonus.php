...
class server_report_saku3_inves2_rptSahamBonus extends server_report_basic
{
...
$this->filter order by a.no_shmbeli";
		...
		echo $AddOnLib->judul_laporan("saham bonus",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
