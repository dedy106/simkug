...
class server_report_saku3_inves2_rptRoiPs extends server_report_basic
{
	...
	function getHtml()
	{
		...
		//$rs=$dbLib->execute($sql);
		$sql="select a.periode, a.kode_mitra, a.tanggal, a.nab_awal, a.beli, a.jual, a.spi, a.nab_akhir, a.deviden, a.gainloss, a.naik_turun, a.hasil_gross, a.tarif_pajak, a.nilai_pajak, a.hasil_set_pajak, a.jasa_ta, 
...
$this->filter 
order by a.kode_mitra,a.tanggal";
		...
		echo $AddOnLib->judul_laporan("roi penyertaan saham",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
  ...
  ";
	...
	<td class='isi_laporan' align='center'>$row->kode_mitra</td>
