...
class server_report_saku3_inves2_rptRdBeliInv extends server_report_basic
{
	...
	function getHtml()
	{
		...
		global $dbLib;
		$sql="select a.kode_lokasi,a.no_rdbeli,a.no_dokumen,date_format(a.tanggal,'%d/%m/%Y') as tanggal,date_format(a.tgl_set,'%d/%m/%Y') as tgl_set,a.keterangan,
...
$this->filter order by a.no_rdbeli";
		...
		{
			echo "<div class='row'>
					<div class='col-md-12'><h3>PEMBELIAN REKSADANA</h3></div>
				  </div>
				  <div class='row'>
				  ...
				  <div class='row'>
					...
					<div class='col-md-10'>: $row->no_rdbeli</div>
				  </div>
				  <div class='row'>
				  ...
				  <table class='table table-hover'>
					...
					<tbody>";
					 $sql1="select a.komisi,a.vat,a.levi,a.pph,a.h_oleh,a.jumlah,a.n_beli,c.jumlah as jml_saham,
				   a.kode_rd,a.kode_rdkelola,b.nama as nama_rd,d.nama as nama_kelola,
				   a.n_beli+(a.komisi+a.vat+a.levi) as jual,a.n_beli-(a.komisi+a.vat+a.levi) as bayar
			from inv_rdbeli_d a
			...
			where a.no_rdbeli='$row->no_rdbeli' 
			order by a.kode_rd ";
