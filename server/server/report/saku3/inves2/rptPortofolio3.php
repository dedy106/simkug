...
class server_report_saku3_inves2_rptPortofolio3 extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$kode_fs=$tmp[4];
		$komp=$tmp[5];
		$sql="exec sp_inv_portofolio3 '$kode_fs','$periode','$kode_lokasi','$nik_user','$tgl','$komp' ";
		$rs = $dbLib->execute($sql);	
  ...
  <tr>
    <td  class='lokasi_laporan2' align='center'>LAPORAN PORTOFOLIO KOMPOSISI BERDASARKAN ALOKASI ASET $persen</td>
  </tr>
  <tr>
