...
class server_report_saku3_inves2_rptSahamSplit extends server_report_basic
{
...
$this->filter order by a.no_shmbeli";
		...
		echo $AddOnLib->judul_laporan("stok saham",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
