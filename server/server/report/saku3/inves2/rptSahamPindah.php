...
class server_report_saku3_inves2_rptSahamPindah extends server_report_basic
{
...
$this->filter order by a.no_shmjual";
		...
		echo $AddOnLib->judul_laporan("pindah kelola",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
