...
class server_report_saku3_inves2_rptDepTutup extends server_report_basic
{
	...
	function getHtml()
	{
		...
		d.jenis,a.nilai,a.tgl_awal,a.tgl_akhir,a.jml_hari,a.jml_bulan,d.p_bunga,d.basis,
		...
		a.nikttd2,a.jab2,g.nama as nama2,a.tanggal
from inv_shop_m a
  ...
  <tr>
    <td><table width='800' border='0' cellspacing='2' cellpadding='1'>
      ...
      <tr>
        ...
        <td>: $row->jml_bulan (a) Bulan, tanggal mulai : ".substr($row->tgl_awal,8,2)." ".$AddOnLib->ubah_periode(substr(str_replace("-","",$row->tgl_awal),0,6))." , 
		tanggal jatuh tempo : ".substr($row->tgl_akhir,8,2)." ".$AddOnLib->ubah_periode(substr(str_replace("-","",$row->tgl_akhir),0,6))." , ($row->jml_hari hari)</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>d. Tingkat Suku Bunga </td>
        <td>: ".number_format($row->p_bunga,3,",",".")."% ($row->basis hari)</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
