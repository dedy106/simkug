...
class server_report_saku3_tarbak_rptGajiAdm3 extends server_report_basic
{
	...
	function getHtml()
	{
		...
		sum(case when c.kode_param in ('LBR','INV','MTAP','RMED','EKS') then c.nilai else 0 end) as jml
		 ...
		 $this->filter and a.kode_unit='ADM' and a.kode_sdm<>'GH'
		...
		echo $AddOnLib->judul_laporan("Daftar Gaji Guru & Karyawan Tidak Tetap ADM",$this->lokasi,"");
   ...
   <tr bgcolor='#CCCCCC'>
     ...
     <td width='80'  rowspan='2' align='center' class='header_laporan'>NIP</td>
	  ...
	  <td width='90' rowspan='2' align='center' class='header_laporan'>BPJS</td>
