...
class server_report_saku3_tarbak_rptHrGajiRekapGraDetail extends server_report_basic
{
	...
	function getHtml()
	{
	   ...
	   isnull(b.gapok,0) as gapok,isnull(b.konj,0) as konj,isnull(b.tjab,0) as tjab,
	   isnull(b.tsus,0) as tsus,isnull(b.lembur,0) as lembur,isnull(b.ikop,0) as ikop,
	   isnull(b.pkop,0) as pkop,isnull(b.pas,0) as pas,isnull(b.remu,0) as remu,isnull(b.rapel,0) as rapel,
...
inner join (select a.nik,a.kode_lokasi,
				sum(case when a.kode_param='GAPOK' then a.nilai else 0 end) as gapok,
...
";
   ...
   <tr bgcolor='#CCCCCC'>
     ...
     <td width='90'  align='center' class='header_laporan'>GAPOK</td>
	 <td width='90'  align='center' class='header_laporan'>KONJUNGTUR</td>
	 <td width='90'  align='center' class='header_laporan'>TUNJANGAN JABATAN/POSISI</td>
	 ...
	 <td width='100'  align='center' class='header_laporan'>REK</td>
	 <td width='150'  align='center' class='header_laporan'>NO REKENING</td>
	  </tr>  ";
		
		$rem=0; $tsus=0; $lembur=0; $rapel=0; $pdpt=0; $ikop=0; $pkop=0; $pas=0; $pot=0; $gapok=0; $konj=0; $tjab=0; 
	 ...
	 <td class='header_laporan' align='right'>".number_format($tjab,0,',','.')."</td>
