...
class server_report_saku3_tarbak_simlog_rptPbLogPBAdk extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.no_pb,a.kode_lokasi,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.kode_pp,b.nama as nama_pp,a.nilai,a.nik_user,a.tanggal,h.logo,h.alamat,
		a.nik_user,a.nik_app,f.nama as nama_user,g.nama as nama_app
from pbh_pb_m a
inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi
inner join pbh_rek i on a.no_Pb=i.no_bukti and a.kode_lokasi=i.kode_lokasi
...
// echo $sql;
    ...
    $link=$_SERVER['REQUEST_SCHEME']."://".$_SERVER['SERVER_NAME'];
		...
		{
			$logo=$link."/image/".$row->logo;
			$alamat=$row->alamat;
			$nilai=$nilai+$row->nilai;
		echo "<table width='800' border='0' cellspacing='0' cellpadding='0' >
  <tr>
    <td align='center'><img src='$logo' width='120' height='100'></td>
  </tr>
  <tr>
