...
class server_report_saku3_tarbak_simlog_rptHutangKartu extends server_report_basic
{
	...
	function getHtml()
	{
        ...
        ";
			...
			$sql="select a.kode_lokasi,a.no_dokumen,a.no_pb as no_bukti,a.nilai as nilai_kas,date_format(a.tanggal,'%d/%m/%Y') as tanggal,a.keterangan
            from pbh_pb_m a
