...
class server_report_saku3_tarbak_rptHrGajiPphCsm extends server_report_basic
{
  ...
  from (select a.nik,a.kode_lokasi,d.sts_pajak,  
	  ...
	  inner join hr_status_pajak d on c.kode_pajak=d.sts_pajak and c.kode_lokasi=d.kode_lokasi 
       $this->filter and b.flag_pajak='1' 
	   group by a.nik,a.kode_lokasi,d.nilai,d.sts_pajak,d.biaya_jab,d.jab_max 
	 ) x 
