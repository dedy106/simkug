...
class server_report_saku3_tarbak_rptHrGajiJurnal extends server_report_basic
{
...
from hr_gaji_m a $this->filter ";
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			echo "<table border='0' cellspacing='2' cellpadding='1'>
			  <tr>
				<td align='center' class='header_laporan'>JURNAL GAJI</td>
			  </tr>
			  <tr>
			  ...
			  <tr>
				...
				<td width='80' class='header_laporan' align='center'>Akun</td>
