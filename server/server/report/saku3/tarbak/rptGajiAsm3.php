...
class server_report_saku3_tarbak_rptGajiAsm3 extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode=$tmp[0];
		$nama_cab=$tmp[1];
		$sql="select a.nik,a.nama as nip,b.periode,a.kode_sdm,b.absen,b.prestasi,b.absen,a.kode_pajak,
		a.kode_unit,b.jam,
		...
		sum(case when c.kode_param in ('TJAB') then c.nilai else 0 end) as twali,
		...
		echo $AddOnLib->judul_laporan("Daftar Gaji Guru Honor ASM",$this->lokasi,"");
   ...
   <tr bgcolor='#CCCCCC'>
     ...
     <td width='80'  rowspan='2' align='center' class='header_laporan'>NIP</td>
	  ...
	  <td width='90'  rowspan='2' align='center' class='header_laporan'>Honor/SKS</td>
	  <td width='90'   rowspan='2' align='center' class='header_laporan'>Jumlah SKS</td>
	  ...
	  <td width='90' rowspan='2' align='center' class='header_laporan'>Honororium Kelas Pagi</td>
	  ...
	  <tr bgcolor='#CCCCCC'>
		<td width='90'  align='center' class='header_laporan'>Jam</td>
	 ...
	 <td class='isi_laporan' align='right'>".number_format($netto,0,',','.')."</td>
		...
		<td class='header_laporan' align='right'>".number_format($trans1,0,',','.')."</td>
		<td class='header_laporan' align='right'>".number_format($absen,0,',','.')."</td>
