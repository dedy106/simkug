...
class server_report_saku3_tarbak_rptHrGajiLampiran extends server_report_basic
{
...
from hr_karyawan a 
inner join (select distinct a.nik 
			from hr_gaji_d a 
			where a.kode_lokasi='$kode_lokasi'
		   )f on  a.nik=f.nik 
left join (select a.nik,sum(case b.dc when 'D' then a.nilai else -a.nilai end) as total  
		   from hr_gaji_d a 
