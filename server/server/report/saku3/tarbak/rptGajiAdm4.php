...
class server_report_saku3_tarbak_rptGajiAdm4 extends server_report_basic
{
	...
	function getHtml()
	{
		...
		echo $AddOnLib->judul_laporan("Daftar Tambahan Gaji Guru & Karyawan Tidak Tetap ADM",$this->lokasi,"");
