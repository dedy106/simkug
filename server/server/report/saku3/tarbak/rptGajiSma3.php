...
class server_report_saku3_tarbak_rptGajiSma3 extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode=$tmp[0];
		$nama_cab=$tmp[1];
		$sql="select a.nik,a.nama as nip,b.periode,a.kode_sdm,b.prestasi,b.absen,a.kode_pajak,
		a.kode_unit,b.jam,
		...
		echo $AddOnLib->judul_laporan("Daftar Gaji Guru Honor SMA",$this->lokasi,"");
