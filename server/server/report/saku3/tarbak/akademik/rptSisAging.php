...
class server_report_saku3_tarbak_akademik_rptSisAging extends server_report_basic
{	
...
order by a.kode_kelas,a.nis
 ";
  ...
  <tr align='center' bgcolor='#CCCCCC'>
	...
	<td width='60' rowspan='2' class='header_laporan'>Jumlah Bulan</td>
	<td width='60' rowspan='2' class='header_laporan'>Total Piutang</td>
	<td width='60' colspan='4'  class='header_laporan'>DSP</td>
	<td width='60' colspan='4'  class='header_laporan'>SPP</td>
  </tr>
  <tr bgcolor='#CCCCCC'>
    ...
    <td width='90' align='center' class='header_laporan'>-24 Bln<</td>
     <td width='80' align='center' class='header_laporan'>-24 Bln</td>
  </tr>";
