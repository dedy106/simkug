...
class server_report_saku3_siswa_rptSisSaldoSiswaSmp extends server_report_basic
{	
...
order by a.nis
 ";
		...
		echo $AddOnLib->judul_laporan("saldo pembayaran siswa tingkat smp",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
