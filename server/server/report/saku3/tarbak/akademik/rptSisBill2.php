...
class server_report_saku3_tarbak_akademik_rptSisBill2 extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		$nama_pp=$row->nama;
		$sql="select a.nis,a.kode_lokasi,a.kode_pp,b.no_bill,d.no_rekon,b.nilai as tagihan,c.keterangan
		,d.nilai as bayar
		from sis_siswa a 
  ...
  <tr align='center' bgcolor='#CCCCCC'>
   ...
   <td class='isi_laporan' align='center'>$i</td>
    ...
    <td class='isi_laporan'>";
			echo "<a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenKartu('$row->nis','$row->no_bill','$row->kode_lokasi','$kode_pp');\">$row->no_bill</a>";
			echo "</td>
