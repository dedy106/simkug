...
class server_report_saku3_tarbak_akademik_rptSisSaldoKls extends server_report_basic
{	
...
$this->filter
group by a.kode_kelas,a.nama,a.kode_lokasi
 ...
 ";
		...
		echo $AddOnLib->judul_laporan("saldo pembayaran per kelas",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
