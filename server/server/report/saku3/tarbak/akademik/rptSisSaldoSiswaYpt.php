...
class server_report_saku3_tarbak_akademik_rptSisSaldoSiswaYpt extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		$sql="select ''''+a.id_bank as id_bank,a.nis,a.nama,a.kode_lokasi,a.kode_pp,a.kode_akt,a.kode_kelas,f.kode_jur,f.nama as nama_jur,
		b.n1 as saw_n1,b.n2 as saw_n2,b.n3 as saw_n3,b.n4 as saw_n4,b.n5 as saw_n5,b.n1+b.n2+b.n3+b.n4+b.n5 as saw_total,
		b.n6 as debet_n1,b.n7 as debet_n2,b.n8 as debet_n3,b.n9 as debet_n4,b.n10 as debet_n5,b.n6+b.n7+b.n8+b.n9+b.n10 as debet_total,
		b.n11 as kredit_n1,b.n12 as kredit_n2,b.n13 as kredit_n3,b.n14 as kredit_n4,b.n15 as kredit_n5,b.n11+b.n12+b.n13+b.n14+b.n15  as kredit_total,
		b.n16 as sak_n1,b.n17 as sak_n2,b.n18 as sak_n3,b.n19 as sak_n4,b.n20 as sak_n5,b.n16+b.n17+b.n18+b.n19+b.n20 as sak_total 
from sis_siswa a 
...
order by a.kode_kelas,a.nis
 ";
		...
		echo $AddOnLib->judul_laporan("saldo piutang siswa",$this->lokasi."<br>".$nama_pp,"PERIODE ".$AddOnLib->ubah_periode($periode));
  ...
  <tr align='center' bgcolor='#CCCCCC'>
	...
	<td width='200' rowspan='2' class='header_laporan'>No VA</td>
  ...
  <tr bgcolor='#CCCCCC'>
    <td width='80' align='center' class='header_laporan'>DP</td>
