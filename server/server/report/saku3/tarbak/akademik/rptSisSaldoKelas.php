...
class server_report_saku3_siswa_rptSisSaldoKelas extends server_report_basic
{	
...
order by a.kode_kelas
 ";
		...
		echo $ADDTKOnLib->judul_laporan("saldo pembayaran per kelas tingkat tk",$this->lokasi,"PERIODE ".$ADDTKOnLib->ubah_periode($periode));
  ...
  <tr align='center' bgcolor='#CCCCCC'>
    ...
    <td width='60' rowspan='2' class='header_laporan'>Kode </td>
