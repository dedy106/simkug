...
class server_report_saku3_tarbak_akademik_rptSisNis extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		$nama_pp=$row->nama;
		$sql="select a.nis,a.kode_lokasi,a.kode_pp,b.no_bill,b.kode_param,b.periode,b.nilai as tagihan,c.keterangan,d.nilai as bayar
		from sis_siswa a 
  ...
  <tr align='center' bgcolor='#CCCCCC'>
    ...
    <td width='80'  class='header_laporan'>Kode Param</td>
	<td width='200'   class='header_laporan'>Keterangan</td>
	<td width='50'   class='header_laporan'>Periode</td>
	<td width='90'   class='header_laporan'>Nilai Bill</td>
	<td width='90'   class='header_laporan'>Nilai Bayar</td>
   ...
   <td class='isi_laporan' align='center'>$i</td>
    ...
    <td class='isi_laporan'>";
			echo "<a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenBill('$row->nis','$row->no_bill','$row->kode_lokasi','$kode_pp');\">$row->no_bill</a>";
			echo "</td>
