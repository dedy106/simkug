...
class server_report_saku3_tarbak_rptGajiAsm2 extends server_report_basic
{
	...
	function getHtml()
	{
		...
		echo $AddOnLib->judul_laporan("Daftar Tambahan Gaji Guru & Karyawan Tetap ASM",$this->lokasi,"");
