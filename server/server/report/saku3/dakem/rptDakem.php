...
class server_report_saku3_dakem_rptDakem extends server_report_basic
{
	...
	function getHtml()
	{
	   ...
	   b.nik,b.nikkes,b.nama_nikes,b.namaaw,b.statusaw,b.nominal,date_format(b.tglmeninggal,'%d/%m/%Y') as tglmeninggal,b.namabank,b.norek,b.cabang,c.no_kas,date_format(isnull(d.tanggal,'-'),'%d/%m/%Y') as tgl_kas
from yk_dakem_m a
inner join yk_dakem_d b on a.no_dakem=b.kdtrans and a.kode_lokasi=b.kode_lokasi
left join pbh_pb_m c on a.no_pb=c.no_pb
left join kas_m d on c.no_kas=d.no_kas
