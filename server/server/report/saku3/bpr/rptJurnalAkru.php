...
class server_report_saku3_bpr_rptJurnalAkru extends server_report_basic
{
	...
	function getHtml()
	{
		...
		global $dbLib;
		$sql="select a.no_bukti,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.no_dokumen,a.kode_lokasi,a.periode,b.nama,b.kota,c.nama as nama_cust
			from trans_m a
			inner join lokasi b on a.kode_lokasi=b.kode_lokasi
			inner join cust c on a.param1=c.kode_cust and a.kode_lokasi=c.kode_lokasi
			$this->filter 
			order by a.tanggal";
    ...
    <td><table width='100%'  border='0' cellspacing='2' cellpadding='1'>
      <tr>
        ...
        <td width='200' align='center'><table width='100%'  border='1' cellspacing='0' cellpadding='0' class='kotak'>
          ...
          <tr>
            <td align='center' class='istyle15'>$row->nama_cust</td>
          </tr>
        </table></td>
      </tr>
    </table></td>
