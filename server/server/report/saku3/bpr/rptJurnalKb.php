...
class server_report_saku3_bpr_rptJurnalKb extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.no_bukti as no_bukti,a.no_dokumen,c.nama,date_format(b.tanggal,'%d/%m/%Y') as tanggal,
