...
class server_report_saku3_bpr_rptIfPtg extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$kode_lokasi=$tmp[0];
		$periode=$tmp[1];
		$sql="select a.kode_lokasi,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.no_bukti,b.no_bukti,b.nilai,e.nama as namaif,e.alamat as alamatif,a.keterangan,b.no_rek,b.bank,b.cabang,b.nama_rek,b.bruto,b.pajak,
		e.nama as nikapp,e.jabatan as jabatan_buat,g.nama as loc,g.kota,a.periode
from trans_m a
