...
class server_report_saku3_bpr_rptPnjrSal extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$jenis=$tmp[3];
		$trail=$tmp[4];
		$sql="exec sp_glma_panjar_tmp '$kode_lokasi','$periode','$nik_user' ";
  ...
  <tr>
    <td  class='lokasi_laporan2' align='center'>SALDO PANJAR</td>
  </tr>
  <tr>
