...
class server_report_saku3_bpr_rptSimpSaldoAgg extends server_report_basic
{
...
left join (select a.no_agg,a.kode_lokasi,
		   ...
		   where b.jenis='SP' and a.periode_angs<='$periode' and a.kode_lokasi='$kode_lokasi'
		   group by a.no_agg,a.kode_lokasi
...
left join (select a.no_agg,a.kode_lokasi,
		   ...
		   from kop_simpangs_d a
		   inner join kop_simp_m b on a.no_simp=b.no_simp and a.kode_lokasi=b.kode_lokasi
		   where b.jenis='SS' and a.periode_angs<='$periode' and a.jenis='SIMP' and a.kode_lokasi='$kode_lokasi'
		   group by a.no_agg,a.kode_lokasi
...
left join (select a.no_agg,a.kode_lokasi,
		   ...
		   from kop_simpangs_d a
		   inner join kop_simp_m b on a.no_simp=b.no_simp and a.kode_lokasi=b.kode_lokasi
		   where b.jenis='SW' and a.periode_angs<='$periode' and a.kode_lokasi='$kode_lokasi'
		   group by a.no_agg,a.kode_lokasi
...
left join (select a.no_agg,a.kode_lokasi,
		   ...
		   from kop_simpangs_d a
		   inner join kop_simp_m b on a.no_simp=b.no_simp and a.kode_lokasi=b.kode_lokasi
		   where b.jenis='SS' and a.periode_angs<='$periode' and a.jenis='BSIMP' and a.kode_lokasi='$kode_lokasi'
		   group by a.no_agg,a.kode_lokasi
