...
class server_report_saku3_bpr_rptPinjSaldo extends server_report_basic
{
	...
	function getHtml()
	{
	   ...
	   isnull(d.npokok,0) as npokok,isnull(d.nbunga,0) as nbunga,isnull(e.tbunga,0) as tbunga,
	   a.nilai+isnull(e.tbunga,0)-isnull(d.npokok,0)-isnull(d.nbunga,0) as saldo
from kop_pinj_m a
...
order by a.no_agg";
  ...
  <tr bgcolor='#CCCCCC'>
	...
	<td width='80' align='center' class='header_laporan'>No Pinjaman</td>
