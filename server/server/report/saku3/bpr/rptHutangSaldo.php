...
class server_report_saku3_bpr_rptHutangSaldo extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$kode_lokasi=$tmp[0];
		$periode=$tmp[1];
		$sql="select a.kode_lokasi,a.no_hutang,a.no_dokumen,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.akun_hutang,a.kode_pp,
		a.nilai+a.nilai_ppn-a.nilai_pph as nilai,a.nilai_ppn,a.nilai_pph,a.nilai as tagihan,b.nama as nama_vend,
		(a.nilai+a.nilai_ppn-a.nilai_pph)-c.nilai1 as saldo,c.nilai1 as bayar
from hu_bill_d a
inner join vendor b on a.kode_vendor=b.kode_vendor and a.kode_lokasi=b.kode_lokasi
inner join trans_m c on a.no_hutang=c.no_ref1 and a.kode_lokasi=c.kode_lokasi
$this->filter order by a.no_hutang";
   ...
   <tr bgcolor='#CCCCCC'>
	...
	<td class='isi_laporan'>";
	 ...
	 <td class='isi_laporan'>$row->nama_vend</td>
