...
class server_report_saku3_bpr_rptPinjKartu extends server_report_basic
{
	...
	function getHtml()
	{
	   ...
	   a.no_kas,date_format(d.tanggal,'%d/%m/%Y') as tgl_cair
from kop_pinj_m a
...
left join kas_m d on a.no_kas=d.no_bukti and a.kode_lokasi=d.kode_lokasi
$this->filter
order by a.no_agg";
  ...
  <tr bgcolor='#CCCCCC'>
    ...
    <td width='80' height='23' class='header_laporan' align='center'>No Bill</td>
	...
	<td width='80' class='header_laporan' align='center'>No Bayar</td>
  </tr>
";
