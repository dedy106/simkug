...
class server_report_saku3_bpr_rptSpb extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$kode_lokasi=$tmp[0];
		$periode=$tmp[1];
		$sql="select a.kode_lokasi,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.no_bukti,b.no_bukti,b.nilai,b.kode_vendor,d.nama as vend,d.alamat2,a.keterangan,b.no_rek,b.bank,b.cabang,b.nama_rek,b.bruto,b.pajak,
		e.nama as nikapp,f.nama as nikth,e.jabatan as jabatan_buat,f.jabatan as jabatan_setuju,g.nama as loc,g.kota,a.periode
from trans_m a
inner join pb_rek b on a.no_bukti=b.no_bukti and a.kode_lokasi=b.kode_lokasi
inner join vendor d on b.kode_vendor=d.kode_vendor and b.kode_lokasi=d.kode_lokasi
				inner join karyawan e on a.nik1=e.nik and a.kode_lokasi=e.kode_lokasi
				inner join karyawan f on a.nik2=f.nik and a.kode_lokasi=f.kode_lokasi 
...
$this->filter ";
		...
		echo "<table width='700' align='center' cellpadding='0' cellspacing='0'>
					          ...
					          <tr>
					            <td width='50%' style='border:1px solid #111111; border-right-width:0px;'><table width='93%' border='0' cellspacing='0' cellpadding='3'>
					              ...
					              <tr class='istyle15'>
					                ...
					                <td>:</td>
					                <td>Rp.</td>
					                <td align='right'>".number_format($row->bruto,0,',','.').",00</td>
					                <td align='right'>&nbsp;</td>
					                <td align='right'>&nbsp;</td>
					              </tr>
					              <tr class='istyle15'>
					...
					//{
						...
						else echo "<td colspan='2' style='border:1px solid #111111; border-bottom-width:0px; border-right-width:0px;'>Man UNIT $row->nikth</td>";
					//}
					...
					//else{
						if ($rs->tot >= 5000000)
							echo "<td width='25%' style='border:1px solid #111111; border-right-width:0px;'>&nbsp;</td>
									<td width='25%' style='border:1px solid #111111; border-right-width:0px;'>&nbsp;$row->app</td>";
						else echo "<td colspan='2' width='25%' style='border:1px solid #111111; border-right-width:0px;'>&nbsp;$row->app</td>";
					//}
