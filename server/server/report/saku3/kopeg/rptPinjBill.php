...
class server_report_saku3_kopeg_rptPinjBill extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.no_bill,a.kode_lokasi,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.kode_lokasi,
       a.nik_user,b.nama as nama_buat,a.nik_app,c.nama as nama_setuju, d.kota,a.keterangan,a.no_dokumen 
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			echo "<table border='0' cellspacing='2' cellpadding='1'>
			  <tr>
				<td align='center' class='header_laporan'>JURNAL PINJAMAN</td>
			  </tr>
			  <tr>
