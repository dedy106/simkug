...
class server_report_saku3_kopeg_rptAgg extends server_report_basic
{
...
a.nama_rek, a.flag_aktif, a.id_lain,b.nama as nama_lok,c.nama as nama_un
FROM  kop_agg a
inner join kop_loker b on a.kode_loker=b.kode_loker and a.kode_lokasi=b.kode_lokasi
inner join kop_unker c on a.kode_unker=c.kode_unker and a.kode_lokasi=c.kode_lokasi
$this->filter order by a.no_agg";
   ...
   <tr bgcolor='#CCCCCC'>
     ...
     <td class='isi_laporan'>$row->nama_un</td>
