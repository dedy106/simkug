...
class server_report_saku3_produk_rptProyekBebanBddRev extends server_report_basic
{
	...
	function getHtml()
	{
		...
		a.nik_user as nik_buat,b.nama as nama_buat, d.kota,a.keterangan,a.no_dokumen,a.no_dokumen as kode_proyek,a.nik1 as nik_app,c.nama as nama_app,e.nama as nama_pp,g.nama as nama_consumer,f.kode_cons 
			 ...
			 inner join pr_proyek f on a.no_dokumen=f.kode_proyek and a.kode_lokasi=f.kode_lokasi
			 inner join consumer g on f.kode_cons=g.kode_cons and f.kode_lokasi=g.kode_lokasi
			 $this->filter
			 order by a.no_bukti";
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			echo "<table border='0' cellspacing='2' cellpadding='1'>
			  <tr>
				<td align='center' class='header_laporan'>MEMO JURNAL REKLASIFIKASI BDD PROYEK </td>
			  </tr>
			  <tr>
				<td>
			  ...
			  <tr>
				<td><table border='0' cellspacing='2' cellpadding='1'>
				  ...
				  <tr>
					...
					<td width='496' class='header_laporan'>:&nbsp;$row->kode_proyek</td>
					</tr>
				  <tr>
