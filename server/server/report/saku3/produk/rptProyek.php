...
class server_report_saku3_produk_rptProyek extends server_report_basic
{
...
isnull(e.bdd,0) as bdd,a.nilai_or-isnull(e.bdd,0) as saldo,a.nilai_ppn,a.p_or,ROUND(e.bdd/a.nilai*100,0)  as r_or,a.nilai_pph,isnull(g.nilai,0) as pdpt, isnull(g.nilai,0) - isnull(e.bdd,0) as profit,isnull(h.bayar,0) as bayar
from pr_proyek a
