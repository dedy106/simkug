...
class server_report_saku3_produk_rptCust extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		$sql="select a.kode_cust,a.nama,a.kode_lokasi,a.alamat,a.email,a.npwp,a.hp 
from brg_cust a
$this->filter
order by a.kode_cust ";
  ...
  <tr bgcolor='#CCCCCC'>
		...
		<td width='300' align='center' class='header_laporan'>Nama Customer</td>
	    ...
	    <td width='80' align='center' class='header_laporan'>HP</td>
