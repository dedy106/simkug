...
class server_report_saku3_produk_rptProyekBebanRev extends server_report_basic
{
       ...
       a.nik_user,b.nama as nama_buat, d.kota,a.keterangan,a.no_dokumen,a.no_dokumen as kode_proyek 
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			echo "<table border='0' cellspacing='2' cellpadding='1'>
			  <tr>
				<td align='center' class='header_laporan'>MEMO JURNAL REVERSE BEBAN DUMMY PROYEK </td>
			  </tr>
			  <tr>
				<td>
