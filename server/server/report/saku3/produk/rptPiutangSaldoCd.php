...
class server_report_saku3_produk_rptPiutangSaldoCd extends server_report_basic
{	
...
order by a.kode_kelas,a.nis
 ";
		...
		echo $AddOnLib->judul_laporan("saldo pdd siswa",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
  ...
  <tr align='center' bgcolor='#CCCCCC'>
	...
	<td width='150'  class='header_laporan'>Jurusan</td>
