...
class server_report_saku3_produk_rptPiutangSaldo extends server_report_basic
{	
...
order by a.kode_kelas,a.nis
 ";
		...
		echo $AddOnLib->judul_laporan("saldo piutang siswa",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
