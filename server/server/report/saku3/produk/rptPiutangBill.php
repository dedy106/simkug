...
class server_report_saku3_produk_rptPiutangBill extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		$sql="select a.no_bukti,a.keterangan,b.nis,c.nama,e.kode_jur,c.kode_kelas,a.periode,substring(a.periode,5,2) as bulan,c.kode_akt,
...
from trans_m a
inner join (select a.nis,a.no_bill,c.kode_lokasi,
			...
			$this->filter
			group by a.nis,a.no_bill,c.kode_lokasi 
...
order by c.kode_kelas,c.nis
 ...
 ";
		...
		echo $AddOnLib->judul_laporan("tagihan siswa",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
