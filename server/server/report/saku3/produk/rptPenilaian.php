...
class server_report_saku3_produk_rptPenilaian extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$kode_lokasi=$tmp[0];
		$periode=$tmp[1];
		$sql="select distinct a.kode_ta, b.nama as ta, a.kode_kelas, c.nama as kelas, a.kode_jenis, d.nama as jenis 
from sis_nilai_m a
