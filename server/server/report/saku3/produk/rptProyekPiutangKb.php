...
class server_report_saku3_produk_rptProyekPiutangKb extends server_report_basic
{
	...
	function getHtml()
	{
       ...
       a.nik_user as nik_buat,b.nama as nama_buat, d.kota,a.keterangan,a.no_dokumen,a.no_dokumen as kode_proyek,a.nik1 as nik_app,c.nama as nama_app,e.nama as nama_pp 
			from trans_m a
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			echo "<table border='0' cellspacing='2' cellpadding='1'>
			  <tr>
				<td align='center' class='header_laporan'>MEMO JURNAL PEMBAYARAN PIUTANG PROYEK </td>
			  </tr>
			  <tr>
				<td>
