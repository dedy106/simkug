...
class server_report_saku3_produk_rptKelas extends server_report_basic
{	
	...
	{
		global $dbLib;
		$sql="select a.kode_kelas, a.nama, a.kode_jur, b.nama as jur, a.kode_tingkat, c.nama as ting 
		from sis_kelas a
		inner join sis_jur b on a.kode_jur=b.kode_jur and b.kode_lokasi=a.kode_lokasi 
