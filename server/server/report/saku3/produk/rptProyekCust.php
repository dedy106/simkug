...
class server_report_saku3_produk_rptProyekCust extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		$sql="select a.kode_cust,a.nama,a.kode_lokasi,a.alamat,a.npwp
from cust a
$this->filter
order by a.kode_cust ";
  ...
  <tr bgcolor='#CCCCCC'>
		...
		<td width='80' align='center' class='header_laporan'>NO NPWP</td>
