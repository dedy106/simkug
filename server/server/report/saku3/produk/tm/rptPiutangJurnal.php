...
class server_report_saku3_produk_tm_rptPiutangJurnal extends server_report_basic
{
	...
	function getHtml()
	{
       ...
       a.nik_user,b.nama as nama_buat,a.nik_app,c.nama as nama_setuju, d.kota,a.keterangan,a.no_dokumen 
			from piutang_m a
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			echo "<table border='0' cellspacing='2' cellpadding='1'>
			  <tr>
				<td align='center' class='header_laporan'>JURNAL PIUTANG</td>
			  </tr>
			  <tr>
  ...
  <tr>
    <td align='left'><table border='0' cellspacing='2' cellpadding='1'>
      <tr>
        <td colspan='2' class='header_laporan'>$row->kota1 ".substr($row->tanggal,8,2)." ".$AddOnLib->ubah_periode(substr(str_replace("-","",$row->tanggal),0,6))."</td>
        </tr>
      <tr>
        <td width='150' class='header_laporan'>Diketahui Oleh : </td>
