...
class server_report_saku3_produk_tm_rptHutangJurnal extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.no_hutang,a.kode_lokasi,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.kode_lokasi,
