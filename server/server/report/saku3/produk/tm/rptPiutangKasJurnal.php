...
class server_report_saku3_produk_tm_rptPiutangKasJurnal extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.no_kas,a.no_dokumen,a.kode_lokasi,a.periode,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.kode_lokasi,
