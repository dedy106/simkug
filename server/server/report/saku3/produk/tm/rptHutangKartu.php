...
class server_report_saku3_produk_tm_rptHutangKartu extends server_report_basic
{
...
";
			...
			$sql="select a.no_bukti,a.kode_lokasi,a.modul,a.periode,a.dc,a.nilai as nilai_kas,convert(varchar(10),b.tanggal,103) as tgl,b.keterangan
