...
class server_report_saku3_produk_tm_rptPiutangAging extends server_report_basic
{
...
left join (select a.no_piutang,a.kode_lokasi,sum(a.nilai) as nilai_kas
	       from piubayar_d a
		   inner join (
		   select tanggal,no_kas,kode_lokasi from kas_m 
		   union 
		   select tanggal,no_ju,kode_lokasi as no_kas from ju_m
