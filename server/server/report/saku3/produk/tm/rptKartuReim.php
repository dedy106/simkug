...
class server_report_saku3_produk_tm_rptKartuReim extends server_report_basic
{
...
union all
select a.no_reim as no_bukti,a.tanggal,a.kode_lokasi,a.keterangan,0 as debet,a.nilai as kredit,date_format(a.tanggal,'%d/%m/%Y') as tgl,2 as nu
from if_reim_m a
where a.nik_user='$row->nik' and a.kode_lokasi='$row->kode_lokasi'   and a.nilai<>0
order by nu
 ";
    ...
    <td  class='isi_laporan'>";
				echo "<a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenJurnal('$row1->no_reim','$row1->kode_lokasi','$periode');\">$row1->no_bukti</a>";
				echo "</td>
