...
class server_report_saku3_produk_tm_rptHutangSaldo extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$kode_lokasi=$tmp[0];
		$periode=$tmp[1];
		$sql="select a.kode_lokasi,a.no_hutang,a.no_dokumen,a.kode_pp,date_format(a.tanggal,'%d/%m/%Y') as tgl,
a.keterangan,a.nilai,a.nilai_ppn,a.bruto-a.diskon as tagihan,
b.nama as nama_cust, isnull(c.nilai,0) as nilai_kas,a.nilai-isnull(c.nilai,0) as saldo 
from tm_hutang_m a
 inner join vendor b on a.kode_vendor=b.kode_vendor and a.kode_lokasi=b.kode_lokasi
 left join (select a.no_hutang,a.kode_lokasi,sum(a.nilai) as nilai from hutbayar_d a
		   where a.kode_lokasi='$kode_lokasi' and a.periode<='$periode'
 group by a.no_hutang,a.kode_lokasi )c on a.no_hutang=c.no_hutang and a.kode_lokasi=b.kode_lokasi 
$this->filter order by a.no_hutang";
   ...
   <tr bgcolor='#CCCCCC'>
     ...
     <td class='isi_laporan'>";
		...
		echo "</td>
	<td class='isi_laporan'>";
		echo "<a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenBill('$row->no_hutang','$row->kode_lokasi');\">$row->no_dokumen</a>";
		echo "</td>	
