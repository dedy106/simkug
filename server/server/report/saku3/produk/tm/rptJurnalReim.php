...
class server_report_saku3_produk_tm_rptJurnalReim extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.no_reim,a.no_dokumen,a.kode_lokasi,a.periode,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.kode_lokasi,
       a.nik_buat,b.nama as nama_buat,b.jabatan as jabatan_buat,a.nik_user,c.nama as nama_setuju,c.jabatan as jabatan_setuju,d.kota
from if_reim_m a
...
left join karyawan c on a.nik_user=c.nik and a.kode_lokasi=c.kode_lokasi $this->filter ";
			  ...
			  <tr>
				<td><table border='0' cellspacing='2' cellpadding='1'>
				  ...
				  <tr>
					...
					<td width='496' class='header_laporan'>:&nbsp;$row->no_reim</td>
					</tr>
				  <tr>
