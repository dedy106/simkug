...
class server_report_saku3_produk_tm_rptHutangAging extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode=$tmp[1];
		$tgl_aging=$tmp[2];
		$sql="select a.kode_lokasi,a.no_dokumen,a.no_hutang,date_format(a.tanggal,'%d/%m/%Y') as tgl,b.nama as nama_cust,a.nilai as tagihan,
	   ...
	   isnull(c.nilai_kas,0) as nilai_kas,a.nilai-isnull(c.nilai_kas,0)  as saldo
from tm_hutang_m a
