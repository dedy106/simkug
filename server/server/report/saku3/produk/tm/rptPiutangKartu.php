...
class server_report_saku3_produk_tm_rptPiutangKartu extends server_report_basic
{
...
";
			...
			$sql="select a.kode_lokasi,a.no_bukti,a.nilai,a.modul,date_format(b.tanggal,'%d/%m/%Y') as tanggal,b.keterangan
from piubayar_d a
...
union all
select a.kode_lokasi,a.no_bukti,a.nilai,a.modul,date_format(b.tanggal,'%d/%m/%Y') as tanggal,b.keterangan
from piubayar_d a
