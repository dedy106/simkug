...
class server_report_saku3_produk_tm_rptPiutangSaldoCust extends server_report_basic
{
...
order by b.kode_cust";
   ...
   <tr bgcolor='#CCCCCC'>
     ...
     <td class='isi_laporan'>";
		echo "<a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenSaldo('$row->kode_cust','$kode_lokasi','$periode');\">$row->kode_cust</a>";
		echo "</td>
