...
class server_report_saku3_produk_rptGlLabaRugiPpJejer extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="exec sp_neraca_sju_pp_jejer '$kode_fs','L','$periode','$kode_lokasi','$nik_user';";
		$rs = $dbLib->execute($sql);
