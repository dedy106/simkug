...
class server_report_saku3_produk_rptKbKeluar extends server_report_basic
{
	...
	function getHtml()
	{
		...
		echo "<div align='center'>";
			...
			echo $AddOnLib->judul_laporan("pengeluaran kas bank umum",$this->lokasi,"Periode ".$AddOnLib->ubah_periode($periode));
 ...
 <tr bgcolor='#CCCCCC'>
    ...
    <td width='90' class='header_laporan' align='center'>Nilai</td>
	   ...
	   a.nilai1 
from trans_m a 
where a.kode_lokasi='$row->kode_lokasi' and a.kode_pp='$row->kode_pp' and a.param3='BK' ";
