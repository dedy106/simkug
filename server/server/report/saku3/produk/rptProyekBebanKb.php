...
class server_report_saku3_produk_rptProyekBebanKb extends server_report_basic
{
	...
	function getHtml()
	{
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			echo "<table border='0' cellspacing='2' cellpadding='1'>
			  <tr>
				<td align='center' class='header_laporan'>MEMO JURNAL PENYELESAIAN HUTANG PROYEK </td>
			  </tr>
			  <tr>
				<td>
