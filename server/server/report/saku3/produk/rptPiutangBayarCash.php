...
class server_report_saku3_produk_rptPiutangBayarCash extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		$periode=$tmp[2];
		$nama_file="rekon.xls";
		$sql="select a.no_bukti as no_rekon,a.keterangan,b.nis,c.nama,e.kode_jur,c.kode_kelas,a.periode,substring(a.periode,5,2) as bulan,c.kode_akt,
...
inner join (select c.nis,a.no_rekon,c.kode_lokasi,
			...
			)b on a.no_bukti=b.no_rekon and a.kode_lokasi=b.kode_lokasi
