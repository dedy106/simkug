...
class server_report_saku3_produk_rptPresensi extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$kode_lokasi=$tmp[0];
		$periode=$tmp[1];
		$sql="select distinct a.kode_ta, b.nama as ta, a.kode_kelas, c.nama as kelas	
from sis_presensi a
...
$this->filter ";
  ...
  <tr bgcolor='#CCCCCC'>
    ...
    <td width='150' class='header_laporan' align='center'>STATUS</td>
	</tr>

";
			
			$sql="select a.nis,b.nama,a.status
from sis_presensi a
