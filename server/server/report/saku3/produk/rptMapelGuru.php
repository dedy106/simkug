...
class server_report_saku3_produk_rptMapelGuru extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		inner join sis_matpel c on a.kode_matpel=c.kode_matpel and c.kode_lokasi=a.kode_lokasi 
		inner join sis_guru_status d on a.kode_status=d.kode_status and d.kode_lokasi=a.kode_lokasi 
