...
class server_report_saku3_produk_rptProyekPanjarBeban extends server_report_basic
{
	...
	function getHtml()
	{
		...
		a.nik_user as nik_buat,b.nama as nama_buat, d.kota,a.keterangan,a.no_dokumen,a.no_dokumen as kode_proyek,a.nik1 as nik_app,c.nama as nama_app,e.nama as nama_pp,g.nama as nama_consumer,f.kode_cons 
			 from trans_m a
			 ...
			 left join pr_proyek f on a.no_dokumen=f.kode_proyek and a.kode_lokasi=f.kode_lokasi
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			...
			<table border='0' cellspacing='2' cellpadding='1'>
			  ...
			  <tr>
				<td><table border='0' cellspacing='2' cellpadding='1'>
				  ...
				  <tr>
					...
					<td width='496' class='header_laporan'>:&nbsp;$row->kode_pp - $row->nama_pp</td>
					</tr>
			  ...
			  <tr>
				...
				<td width='60' class='header_laporan'><div align='center'>ID Proyek</div></td>
