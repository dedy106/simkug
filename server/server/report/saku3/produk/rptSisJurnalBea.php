...
class server_report_saku3_produk_rptSisJurnalBea extends server_report_basic
{
	...
	function getHtml()
	{
       ...
       a.nik_user,b.nama as nama_buat, d.kota,a.keterangan,a.no_dokumen
			from trans_m a
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			echo "<table border='0' cellspacing='2' cellpadding='1'>
			  <tr>
				<td align='center' class='header_laporan'>MEMO JURNAL PELUNASAN TAGIHAN BEASISWA </td>
			  </tr>
			  <tr>
				<td>
