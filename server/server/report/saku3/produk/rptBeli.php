...
class server_report_saku3_produk_rptBeli extends server_report_basic
{	
...
from trans_m a
 $this->filter ";
	...
	function getHtml()
	{
		...
		$sql="select DISTINCT a.no_bukti,a.tanggal,e.keterangan,a.kode_vendor,b.nama as nama_vendor ,d.kode_gudang,c.nama as nama_pp
		,a.nik_user,f.nama as nama_user,a.kode_lokasi,e.nilai2
from trans_j a
...
order by a.no_bukti ";
  ...
  <tr bgcolor='#CCCCCC'>
	...
	<td width='90' align='center' class='header_laporan'>Sub Total</td>
			...
			$sql1="select a.kode_barang,b.nama as nama_brg,a.satuan,a.jumlah,a.bonus,a.tot_diskon,a.harga,(a.harga*a.jumlah)-a.tot_diskon as total
from brg_trans_d a
...
order by a.kode_barang ";
	...
	<td align='right' class='isi_laporan'>".number_format($row1->tot_diskon,0,",",".")."</td>
	...
	<td align='right' class='isi_laporan'>".number_format($row1->total,0,",",".")."</td>
			...
			echo "<tr>
    <td colspan='4' align='right'  class='header_laporan'>PPN</td>
   ...
   <td align='right' class='header_laporan'>".number_format($total+$ppn,0,",",".")."</td>
  </tr>";
		echo "<tr>
