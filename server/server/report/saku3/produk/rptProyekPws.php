...
class server_report_saku3_produk_rptProyekPws extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$kode_lokasi=$tmp[0];
		$periode=$tmp[1];
		$sql="select a.kode_proyek,a.nama,a.kode_cust,a.nilai,a.nilai_or,b.nama as nama_cust,a.p_or,c.nama as nama_consumer
from pr_proyek a
  ...
  <tr >
    <td height='23' colspan='8' class='header_laporan'><table  border='0' cellspacing='2' cellpadding='1'>
	  ...
	  <tr>
        ...
        <td class='header_laporan'>: $row->nama_consumer</td>
      </tr>	  
	  <tr>
