...
class server_report_saku3_sapyakes_rptPjPtgForm extends server_report_basic
{
...
from panjarptg2_m a
inner join panjar2_m h on a.no_pj=h.no_panjar and a.kode_lokasi=h.kode_lokasi
