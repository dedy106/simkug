...
class server_report_saku3_sapyakes_rptPjAjuForm extends server_report_basic
{
	function getTotalPage()
	{
		...
		$periode=$tmp[2];
		$filter2=$tmp[3];
		$sql="select count(a.no_panjar) from panjar2_m a $this->filter ";
	...
	function getHtml()
	{
		...
		$periode=$tmp[2];
		$filter2=$tmp[3];
		$sql="select a.no_panjar,a.nik_buat,a.nik_app as nik_setuju,f.flag as nik_bdh,h.flag as nik_manbdh,a.kode_pp,a.nilai,a.akun_panjar,a.keterangan,substring(a.periode,1,4) as tahun,
