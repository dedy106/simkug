...
class server_report_saku3_sapyakes_rptIfForm2 extends server_report_basic
{
	...
	function getHtml()
	{
		...
		a.kode_pp,b.nama as nama_pp,a.nilai,a.user_input,a.tanggal,c.kota,a.user_input,a.nik_setuju,d.nama as nama_buat,e.nama as nama_app
from if_aju_m a
...
where a.no_aju='$row->no_aju' order by a.kode_akun ";
