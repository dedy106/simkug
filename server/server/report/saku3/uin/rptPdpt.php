...
class server_report_saku3_uin_rptPdpt extends server_report_basic
{	
  ...
  <tr>
    <td colspan='34' style='padding:5px'><table width='100%' border='0' cellspacing='2' cellpadding='1'>
		...
		$sql="select a.no_usul,a.kdgiat,a.kode_akun,
				   b.nmgiat,i.nmakun
			from (select a.no_usul,a.kdgiat,a.kode_akun
				from uin_usul_d a
				where a.no_usul='$row->no_usul'
				group by a.no_usul,a.kdgiat,a.kode_akun
				 )a
