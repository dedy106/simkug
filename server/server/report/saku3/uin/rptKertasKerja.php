...
from uin_lokasi a 
 where a.kode_lokasi='23'";
		...
		echo $AddOnLib->judul_laporan("Rincian Kertas Kerja Belanja",$this->lokasi.$nama_pp,"TAHUN ".$tahun);
...
";
	 ...
	 <td  align='right' class='header_laporan'>".number_format($row1->total,0,",",".")."</td>
		 ...
		 <td  align='right' class='header_laporan'>1</td>
		 <td  align='right' class='header_laporan'>Lembaga</td>
		 <td  align='right' class='header_laporan'></td>
			 ...
			 <td   align='right' class='header_laporan'>".number_format($row3->total,0,",",".")."</td>
				...
				order by a.kdakun";
						 ...
						 <td   align='right' class='header_laporan'>".number_format($row6->total,0,",",".")."</td>
							 ...
							 <td  align='right' class='isi_laporan'>".number_format($row7->volkeg,2,",",".")."</td>
							 <td  align='right' class='isi_laporan'>$row7->satkeg</td>
							 <td  align='right' class='isi_laporan'>".number_format($row7->hargasat,2,",",".")."</td>
							 <td   align='right' class='isi_laporan'>".number_format($row7->jumlah,2,",",".")."</td>
							 </tr> ";
