...
class server_report_saku3_uin_rptPBAgg extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="exec sp_neraca_uin '$kode_fs','L','S',1,'$periode','$kode_lokasi','$nik_user' ";
		$rs = $dbLib->execute($sql);	
		...
		echo $AddOnLib->judul_laporan("laporan pendapatan dan belanja agregat",$this->lokasi,"Periode $periode");
		echo "<table border='1' cellspacing='0' cellpadding='0' class='kotak'>
		  <tr bgcolor='#CCCCCC'>
			<td width='400' height='25'  class='header_laporan' align='center'>Uraian</td>
			<td width='100' class='header_laporan' align='center'>Target</td>
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			...
			if ($bentuk=="Detail" && $row->tipe=="Posting")
			{
				...
				$sql1="
						...
						from glma_tmp a
						inner join uin_relakun b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi
						inner join uin_neraca c on b.kode_neraca=c.kode_neraca and b.kode_fs=c.kode_fs and a.kode_lokasi=c.kode_lokasi
