...
class server_report_saku3_uin_rptRinciPdptUnit extends server_report_basic
{
	...
	function getHtml()
	{
		...
		echo $AddOnLib->judul_laporan("Laporan Rincian Pendapatan",$this->lokasi,"Tahun $tahun");
		...
		$sql="select a.kode_pp,a.nama
			...
			where a.kode_lokasi='23' and b.tahun='2019'
		...
		echo "<tr>
	 <td  class='header_laporan'>$row3->kode_pp</td>
     <td class='header_laporan'>$row3->nama</td>
...
where a.kode_lokasi='$kode_lokasi' and a.kode_fs='FS1' and substring(c.periode,1,4)='$tahun' and b.kdgiat='$row1->kdgiat' and b.kode_pp='$row3->kode_pp'
...
where a.kode_lokasi='$kode_lokasi' and a.kode_fs='FS1' and substring(c.tahun,1,4)='$tahun' and b.kdgiat='$row1->kdgiat' and b.kode_pp='$row3->kode_pp'
group by a.kode_neraca,a.kode_lokasi
		)c on a.kode_neraca=c.kode_neraca and a.kode_lokasi=c.kode_lokasi
where a.jenis_akun='Pendapatan' and a.kode_lokasi='$kode_lokasi' and a.kode_neraca like '1%'
order by a.rowindex  ";
				$no=1;
