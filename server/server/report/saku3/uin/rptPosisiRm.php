...
class server_report_saku3_uin_rptPosisiRm extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql2="select a.no_aju,a.nilai,convert(varchar,a.tanggal,103) as tgl,a.keterangan,a.kode_pp,b.nama as nama_pp,
	   a.no_fisik,a.no_ver,a.no_nota,a.no_spm,a.no_sppd,e.no_kas,a.jenis,
...
left join uin_cair_m f on e.no_kas=f.no_cair and e.kode_lokasi=f.kode_lokasi
		...
		echo $AddOnLib->judul_laporan("Laporan Posisi Realisasi RAB BLU",$this->lokasi,"Periode ".$AddOnLib->ubah_periode($periode));
