...
class server_report_saku3_uin_rptVer extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		while ($row = $rs2->FetchNextObject($toupper=false))
		{
            ...
            <td><table width='800' border='0' cellspacing='2' cellpadding='1'>
              <tr>
                <td width='150' ><img src='$logo' width='120' height='80'></td>
                <td width='650'>$nama <br />$alamat<br />Tel. $no_telp; Fax. $no_fax </td>
              </tr>
  ...
  ";
			...
			while ($row1 = $rs1->FetchNextObject($toupper=false))
			{
				// $total+=$row1->total;
                // $vol+=$row1->vol;
                if($row1->status == "CHECK"){
                    $cek="<img src='$pathfoto'>";
                }else{
                    $cek="";
                }
				echo "<tr>
                        ...
                        <td  class='isi_laporan' align='center'>$cek</td>
