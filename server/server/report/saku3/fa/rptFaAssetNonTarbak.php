...
class server_report_saku3_fa_rptFaAssetNonTarbak extends server_report_basic
{
...
// echo $sql;
		...
		echo $AddOnLib->judul_laporan("daftar non aktiva operasional",$this->lokasi,"Periode ".$AddOnLib->ubah_periode($periode));
