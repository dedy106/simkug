...
class server_report_saku3_fa_rptFaAssetTu extends server_report_basic
{
...
$this->filter ";
	...
	function getHtml()
	{
		...
		$trail = $tmp[4];
		$nama_file="asset.xls";
		$sql = "select a.kode_klpakun,a.kode_lokasi,b.nama as nama_klpakun,a.kode_pp,c.nama as nama_pp,a.catatan,a.no_fa,a.nama,date_format(a.tgl_perolehan,'%d/%m/%Y') as tgl,date_format(a.tgl_susut,'%d/%m/%Y') as susut,
...
order by a.kode_akun,a.tgl_perolehan ";
		...
		echo "<table width='1800' border='1' cellspacing='0' cellpadding='0' class='kotak'>
				...
				<td width='60' rowspan='2' align='center' class='header_laporan'>Tanggal Penyusutan</td>
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			...
			echo "</td>
				  ...
				  <td  class='isi_laporan'>$row->susut</td>
		...
		echo "<tr bgcolor='#CCCCCC'>
				  <td colspan='12' align='right' class='header_laporan'>Sub Total</td>
				  <td class='header_laporan' align='right'>".number_format($nilai,0,",",".")."</td>
				  <td class='header_laporan' align='right'>".number_format($wo,0,",",".")."</td>
				  <td class='header_laporan' align='right'>".number_format($nilai-$wo,0,",",".")."</td>
				  <td class='header_laporan' align='right'>".number_format($nilai_akm_sd,0,",",".")."</td>
