...
class server_report_saku3_gar_rptGarRelease extends server_report_basic
{
	...
	function getHtml()
	{
		...
		global $dbLib;
		$sql="select convert(varchar, a.tanggal, 101) as tgl,a.no_agg,a.kode_lokasi,a.keterangan,
	   a.nik_buat,b.nama as nama_buat,a.nik_setuju,c.nama as nama_setuju
from anggaran_m a
...
left join karyawan c on a.nik_setuju=c.nik and a.kode_lokasi=c.kode_lokasi
 $this->filter order by a.no_agg";
		...
		echo $AddOnLib->judul_laporan("laporan pengajuan release",$this->lokasi,$tahun);
