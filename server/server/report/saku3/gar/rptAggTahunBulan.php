...
class server_report_saku3_gar_rptAggTahunBulan extends server_report_basic
{
	...
	function getHtml()
	{
	   ...
	   isnull(e.agg_01,0) as n1,isnull(e.agg_02,0) as n2,isnull(e.agg_03,0) as n3,isnull(e.agg_04,0) as n4,isnull(e.agg_05,0) as n5,isnull(e.agg_06,0) as n6
         ...
         ,case when b.jenis='Pendapatan' then isnull(f.real_01,0)*-1 else isnull(f.real_01,0) end as n13,
		 case when b.jenis='Pendapatan' then isnull(f.real_02,0)*-1 else isnull(f.real_02,0) end as n14,
		 case when b.jenis='Pendapatan' then isnull(f.real_03,0)*-1 else isnull(f.real_03,0) end as n15,
		 case when b.jenis='Pendapatan' then isnull(f.real_04,0)*-1 else isnull(f.real_04,0) end as n16,
		 case when b.jenis='Pendapatan' then isnull(f.real_05,0)*-1 else isnull(f.real_05,0) end as n17,
		 case when b.jenis='Pendapatan' then isnull(f.real_06,0)*-1 else isnull(f.real_06,0) end as n18,
		 case when b.jenis='Pendapatan' then isnull(f.real_07,0)*-1 else isnull(f.real_07,0) end as n19,
		 case when b.jenis='Pendapatan' then isnull(f.real_08,0)*-1 else isnull(f.real_08,0) end as n20,
		 case when b.jenis='Pendapatan' then isnull(f.real_09,0)*-1 else isnull(f.real_09,0) end as n21,
		 case when b.jenis='Pendapatan' then isnull(f.real_10,0)*-1 else isnull(f.real_10,0) end as n22,
		 case when b.jenis='Pendapatan' then isnull(f.real_11,0)*-1 else isnull(f.real_11,0) end as n23,
		 case when b.jenis='Pendapatan' then isnull(f.real_12,0)*-1 else isnull(f.real_12,0) end as n24
from akundrk a
