...
class server_report_saku3_gar_rptAggApp extends server_report_basic
{	
...
inner join karyawan b on a.nik_app=b.nik and a.kode_lokasi=b.kode_lokasi $this->filter order by a.no_app";
		...
		echo $AddOnLib->judul_laporan("laporan approval pengajuan",$this->lokasi,$AddOnLib->ubah_periode($periode));
