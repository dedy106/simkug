...
class server_report_saku3_gar_rptAggReset extends server_report_basic
{
                    ...
                    <div class='col-xs-12'>
                      <div class='nav-tabs-custom'>
                          <ul class='nav nav-tabs'>
                            <li class='active'><a href='#tab_1' data-toggle='tab' aria-expanded='true'>Data Anggaran Reseting</a></li>
              ...
              success:function(result){
                ...
                if(result.status){
                  ...
                  for(var i=0;i< result.error_ins.length;i++){
                      html +=`<tr>
                        <td>`+result.error_ins[i].kode+`</td>
                        <td>`+result.error_ins[i].error_msg+`</td>
                      </tr>`;
                  }
                  console.log(html);
          ...
          $('#nw_container').on('click', '#saveBtn', function(e){
            ...
            if(per ==''){
              ...
              $.ajax({
                ...
                dataType: 'json',
                data: {'kode_lokasi':'$kode_lokasi','tahun':per,'nik_user':'$nik','keterangan':keterangan},
                success:function(result){
                  alert('Input data '+result.message);
                  if(result.status){
                    dataTable.ajax.reload();
