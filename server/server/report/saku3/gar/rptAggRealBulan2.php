...
class server_report_saku3_gar_rptAggRealBulan2 extends server_report_basic
{
	...
	function getHtml()
	{
		...
		//$sql2="exec sp_agg_real_bulan '$kode_lokasi','$jenis','$tahun','$nik_user'";
		//echo $sql2;
		//$sql="exec sp_agg_real_tw '$kode_lokasi','$jenis','$tahun','$nik_user'";
		//$sql="exec sp_agg_real_bulan_telu '11','Beban','2019','tel_1553687730866'";
		//echo $sql;
		//$rs = $dbLib->execute($sql);	
