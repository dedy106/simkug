...
class server_report_saku3_gar_rptAggPosTu extends server_report_basic
{
	...
	function getHtml()
	{
		...
		d.no_app,convert(varchar,d.tanggal,103) as tgl_app,isnull(g.nilai,0) as nilai,
			...
			a.nik_buat,b.nama as nama_buat,d.nik_app,h.nama as nama_app
from rra_pdrk_m a  
...
left join karyawan e on d.nik_buat=e.nik and d.kode_lokasi=e.kode_lokasi 
left join karyawan h on d.nik_app=h.nik and d.kode_lokasi=h.kode_lokasi 
...
order by a.no_pdrk";
   ...
   <tr bgcolor='#CCCCCC'>
	 ...
	 <td width='60'  align='center' class='header_laporan'>Nik App</td>
	 <td width='150'  align='center' class='header_laporan'>Nama App</td>
