...
class server_report_saku3_gar_rptAggPakai2 extends server_report_basic
{
	function getTotalPage()
	{
		...
		$nik_user=$tmp[0];
		$sql = "select count(a.kode_akun) as jum from glma_drk_tmp a where a.nik_user='$nik_user' ".$this->filter;
	...
	function getHtml()
	{
		...
		$sql="exec sp_agg_pakai '$kode_lokasi','$jenis','$periode','$nik_user'";
		$rs = $dbLib->execute($sql);	
...
// echo $sql;
  ...
  <tr bgcolor='#CCCCCC'>
	...
	<td height='25' colspan='3' class='header_laporan'><div align='center'>Target / Tahun</div></td>
	<td height='25' colspan='2' class='header_laporan'><div align='center'>Realisasi</div></td>
    <td height='25' colspan='3' class='header_laporan'><div align='center'>Sisa Anggaran</div></td>
  </tr>
   <tr bgcolor='#CCCCCC'>
     <td width='90' class='header_laporan'><div align='center'>Tahun </div></td>
	<td width='90' class='header_laporan'><div align='center'>Bulan Berjalan </div></td>
	...
	<td width='90' height='25' class='header_laporan'><div align='center'>Bulan Berjalan </div></td>
    <td width='90' class='header_laporan'><div align='center'>S.D Bulan Berjalan </div></td>
	<td width='90' class='header_laporan'><div align='center'>Sisa Anggaran Tahun </div></td>
  </tr>";
		$i=$start+1;
		$n1=0;$n2=0;$n3=0;$n4=0;$n5=0;$sisa=0; $sisa2=0; $sisa3=0;
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			...
			$sisa2=$sisa2+($row->n3-$row->n4);
			$sisa3=$sisa3+($row->n2-$row->n5);
   ...
   <td class='isi_laporan' align='right'>";
    ...
    <td class='isi_laporan'><div align='right'>".number_format($row->n3-$row->n4,0,',','.')."</div></td>
	 <td class='isi_laporan'><div align='right'>".number_format($row->n2-$row->n5,0,',','.')."</div></td>
    ...
    <td class='header_laporan'><div align='right'><span class='sum_laporan'>".number_format($sisa2,0,',','.')."</span></div></td>
	<td class='header_laporan'><div align='right'><span class='sum_laporan'>".number_format($sisa3,0,',','.')."</span></div></td>
