...
class server_report_saku3_gar_rptGarRkapKonsol extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="exec sp_rkap_dw 'K','FS1','$periode','$kode_lokasi1','$nik_user','$bentuk','$kode_bidang1','$kode_bidang2'";
