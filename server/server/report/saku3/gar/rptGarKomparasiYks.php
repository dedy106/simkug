...
class server_report_saku3_gar_rptGarKomparasiYks extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$tahun=$tmp[2];
		$jenis=$tmp[3];
		$sql="exec sp_agg_real_bulan '$kode_lokasi','$jenis','$tahun','$nik_user'";
...
<tr>
    <td rowspan='2' bgcolor='#CCCCCC' class='header_laporan' align='center'>No</td>
    <td rowspan='2' bgcolor='#CCCCCC' class='header_laporan' align='center'>Kode Akun</td>
<td rowspan='2' bgcolor='#CCCCCC' class='header_laporan' align='center'>Nama Akun</td>
    <td rowspan='2' bgcolor='#CCCCCC' class='header_laporan' align='center'>Kode PP </td>
<td rowspan='2' bgcolor='#CCCCCC' class='header_laporan' align='center'>Nama PP</td>
    <td rowspan='2' bgcolor='#CCCCCC' class='header_laporan' align='center'>Kode DRK</td>
<td rowspan='2' bgcolor='#CCCCCC' class='header_laporan' align='center'>Nama DRK</td>
    <td height='20' colspan='3' bgcolor='#CCCCCC' class='header_laporan' align='center'>Januari</td>
    <td colspan='3' bgcolor='#CCCCCC' class='header_laporan' align='center'>Februari</td>
    <td colspan='3' bgcolor='#CCCCCC' class='header_laporan' align='center'>Maret </td>
    <td colspan='3' bgcolor='#CCCCCC' class='header_laporan' align='center'>April</td>
	<td colspan='3' bgcolor='#CCCCCC' class='header_laporan' align='center'>Mei</td>
    <td colspan='3' bgcolor='#CCCCCC' class='header_laporan' align='center'>Juni </td>
    <td colspan='3' bgcolor='#CCCCCC' class='header_laporan' align='center'>Juli</td>
	<td colspan='3' bgcolor='#CCCCCC' class='header_laporan' align='center'>Agustus</td>
    <td colspan='3' bgcolor='#CCCCCC' class='header_laporan' align='center'>September </td>
    <td colspan='3' bgcolor='#CCCCCC' class='header_laporan' align='center'>Oktober</td>
	<td colspan='3' bgcolor='#CCCCCC' class='header_laporan' align='center'>November</td>
    <td colspan='3' bgcolor='#CCCCCC' class='header_laporan' align='center'>Desember </td>
   </tr>
  <tr>
    <td width='80' height='20' bgcolor='#CCCCCC' class='header_laporan' align='center'>Anggaran</td>
    <td width='80' bgcolor='#CCCCCC' class='header_laporan' align='center'>Realisasi</td>
    <td width='80' bgcolor='#CCCCCC' class='header_laporan' align='center'>Sisa</td>
    <td width='80' bgcolor='#CCCCCC' class='header_laporan' align='center'>Anggaran</td>
    <td width='80' bgcolor='#CCCCCC' class='header_laporan' align='center'>Realisasi</td>
    <td width='80' bgcolor='#CCCCCC' class='header_laporan' align='center'>Sisa</td>
    <td width='80' bgcolor='#CCCCCC' class='header_laporan' align='center'>Anggaran</td>
    <td width='80' bgcolor='#CCCCCC' class='header_laporan' align='center'>Realisasi</td>
