...
class server_report_saku3_travel_rptKbSaldo2 extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$rs = $dbLib->execute($sql);
		$sql = "select kode_akun,nama,kode_lokasi,debet,kredit,so_awal,so_akhir,
...
// echo $sql;
  ...
  <tr bgcolor='#CCCCCC'> 
    ...
    echo "</td>
<td class='isi_laporan' align='right'>".number_format($row->so_awal_debet,2,',','.')."</td>
    <td class='isi_laporan' align='right'>".number_format($row->so_awal_kredit,2,',','.')."</td>
    ...
    <td class='isi_laporan' align='right'>".number_format($row->so_akhir_debet,2,',','.')."</td>
    <td class='isi_laporan' align='right'>".number_format($row->so_akhir_kredit,2,',','.')."</td>
  </tr>";
    ...
    <td class='sum_laporan' align='right'>".number_format($so_awal_debet,2,',','.')."</td>
    <td class='sum_laporan' align='right'>".number_format($so_awal_kredit,2,',','.')."</td>
    <td class='sum_laporan' align='right'>".number_format($debet,2,',','.')."</td>
    <td class='sum_laporan' align='right'>".number_format($kredit,2,',','.')."</td>
    <td class='sum_laporan' align='right'>".number_format($so_akhir_debet,2,',','.')."</td>
    <td class='sum_laporan' align='right'>".number_format($so_akhir_kredit,2,',','.')."</td>
</tr>";
		echo "</table></div>";
		return "";
	}
