...
class server_report_saku3_travel_rptJualRekap extends server_report_basic
{	
	...
	function getHtml()
	{
	   ...
	   a.param2,b.nama as nama_cust ,a.param1,c.nama as nama_gudang
from trans_m a
inner join brg_cust b on a.param2=b.kode_cust and a.kode_lokasi=b.kode_lokasi
...
order by a.no_bukti ";
  ...
  <tr bgcolor='#CCCCCC'>
	...
	echo "<a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenKas('$row->no_bukti','$row->kode_lokasi');\">$row->no_bukti</a>";
	echo "</td>
			<td class='isi_laporan'>$row->no_dokumen</td>
			<td class='isi_laporan'>$row->tgl</td>
			<td class='isi_laporan'>$row->param1</td>
			<td class='isi_laporan'>$row->param2 - $row->nama_cust</td>
