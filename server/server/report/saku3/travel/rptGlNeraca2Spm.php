...
class server_report_saku3_travel_rptGlNeraca2Spm extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="exec sp_neraca2_dw 'FS1','N','K','1','$periode','$periode2','$kode_lokasi','$nik_user' ";
		$rs = $dbLib->execute($sql);		
		
	    $sql = "select '$kode_lokasi' as kode_lokasi,kode_neraca1,kode_neraca2,nama1,tipe1,nilai1,level_spasi1,nama2,tipe2,nilai2,level_spasi2,nilai3,nilai4 
  ...
  <tr>
    <td><table border='1' cellspacing='0' cellpadding='0' class='kotak'>
			  <tr bgcolor='#CCCCCC'>
				<td width='340'  class='header_laporan' align='center'>Aktiva</td>
				<td width='100' class='header_laporan' align='center'>$periode</td>
			<td width='100' class='header_laporan' align='center'>$periode2</td>
			<td width='340' height='25'  class='header_laporan' align='center'>Pasiva</td>
			<td width='100' class='header_laporan' align='center'>$periode</td>
			<td width='100' class='header_laporan' align='center'>$periode2</td>
			  </tr>";
