...
class server_report_saku3_travel_rptFaKartu extends server_report_basic
{
...
from fasusut_d
where kode_lokasi='$row->kode_lokasi' and no_fa='$row->no_fa' and periode<='$periode_susut' 
union all
select no_woapp as no_fasusut,periode,akun_beban,akun_ap,nilai as debet, 0 as kredit,nilai
from fawoapp_d
where kode_lokasi='$row->kode_lokasi' and no_fa='$row->no_fa' and periode<='$periode_susut' 
";
