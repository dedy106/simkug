...
class server_report_saku3_travel_rptGlNeracaNeto extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="exec sp_neraca_dw '$kode_fs','A','S','$lev','$periode','$kode_lokasi','$nik_user' ";
		$rs = $dbLib->execute($sql);	
		...
		$sql = "select kode_neraca,kode_fs,kode_lokasi,nama,tipe,level_spasi,n4
			from neraca_tmp 
  ...
  <tr>
    <td  class='lokasi_laporan2' align='center'>LAPORAN ASET NETO</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class='detail_laporan'><div align='right'>$so_akhir</div></td>
		...
		$sql = "select kode_neraca,kode_fs,kode_lokasi,nama,tipe,level_spasi,n4*-1 as n4
			from neraca_tmp 
