...
class server_report_saku3_travel_rptKwitansi extends server_report_basic
{
	...
	function getHtml()
	{
		...
		d.nama as paket, i.nik_user,e.nama_agen as agen,a.no_reg,d.kode_curr,a.nilai_p,a.nilai_t,a.saldo_t - nilai_t as sisat,a.saldo_p - nilai_p as sisap,a.bayar_tambahan, h.nama_marketing
        ...
        $this->filter
    GROUP BY i.nilai1,a.kode_lokasi,a.no_kwitansi,a.kurs, c.nama,c.telp,a.tgl_bayar,a.jadwal,a.paket,a.bayar_paket,a.sistem_bayar,a.nilai_t, 
...
";
    ...
    sum(case when a.kode_biaya in ('BO-0006','BO-0007','BO-0008') then a.nilai else 0 end) as lain
                      ...
                      where c.no_kwitansi='$row->no_kwitansi' and a.kode_lokasi='$row->kode_lokasi'
