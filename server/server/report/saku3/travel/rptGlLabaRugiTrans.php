...
class server_report_saku3_travel_rptGlLabaRugiTrans extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="exec sp_neraca_trans '$kode_fs','L','S','$lev','$periode','$kode_lokasi','$nik_user' ";
		$rs = $dbLib->execute($sql);	
  ...
  <tr>
    <td  class='lokasi_laporan2' align='center'>LAPORAN LABARUGI $nama $nama_periode</td>
  </tr>
  <tr>
