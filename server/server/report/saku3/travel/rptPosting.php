...
class server_report_saku3_travel_rptPosting extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode=$tmp[0];
		$nama_cab=$tmp[1];
		$sql="select b.nama as nama_user,c.nama as nama_app,a.no_post,a.kode_lokasi,a.periode,date_format(a.tanggal,'%d/%m/%Y') as tanggal,a.modul,a.keterangan,a.nik_buat,a.nik_app,a.no_del,a.tgl_input,a.nik_user,a.nilai
from posting_m a
...
$this->filter order by a.no_post";
		...
		echo $AddOnLib->judul_laporan("data posting",$this->lokasi,"Periode ".$AddOnLib->ubah_periode($periode));
		echo "<table border='1' cellspacing='0' cellpadding='0' class='kotak'>
   <tr bgcolor='#CCCCCC'>
     <td width='30'  align='center' class='header_laporan'>No</td>
     <td width='80'  align='center' class='header_laporan'>No Posting</td>
