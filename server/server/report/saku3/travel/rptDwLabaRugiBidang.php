...
class server_report_saku3_travel_rptDwLabaRugiBidang extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.kode_bidang,a.nama from bidang a $kode_bidang order by a.kode_bidang";
