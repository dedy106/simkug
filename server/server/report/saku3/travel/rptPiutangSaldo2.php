...
class server_report_saku3_travel_rptPiutangSaldo2 extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$filter_pbyr = $tmp[2];
		$jenis = $tmp[3];
		$nama_file = "PiutangSaldo.xls";
		$sql="select a.modul, a.kode_lokasi,a.no_piutang,a.akun_piutang,a.no_dokumen,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.nilai+a.nilai_ppn as nilai,a.nilai_ppn,a.nilai as tagihan,b.nama as nama_cust,
...
// echo $sql;
		/*and a.periode<='$periode'baris 41*/
		$rs = $dbLib->execute($sql);
   ...
   <tr bgcolor='#CCCCCC'>
	 ...
	 <td width='60' rowspan='2' align='center' class='header_laporan'>Akun Piutang</td>
