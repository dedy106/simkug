...
class server_report_saku3_travel_rptKbJurnal2 extends server_report_basic
{
  ...
  <td valign='middle' class='isi_laporan' align='center'>$row->posted</td>
    ...
    <td valign='middle' class='isi_laporan'><div align='right' >".number_format($row->debet,2,',','.')."</div></td>
    <td valign='middle' class='isi_laporan'><div align='right' >".number_format($row->kredit,2,',','.')."</div></td>
  </tr>";
			$first = true;
			$i=$i+1;
		}
