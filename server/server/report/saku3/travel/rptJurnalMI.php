...
class server_report_saku3_travel_rptJurnalMI extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.no_bukti,a.no_dokumen,b.nama,date_format(a.tanggal,'%d/%m/%Y') as tgl,
