...
class server_report_saku3_travel_rptStoreRoomReq extends server_report_basic
{	
...
from brg_kirim_m a  $this->filter ";
	...
	function getHtml()
	{
		...
		// echo $AddOnLib->judul_laporan("Store Room Request",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
                      ...
                      <table width='100%' border='0'>
                       <tbody>
                          ...
                          <tr>
                              ...
                              <td  class='judul_bukti' colspan='3' style='padding-left:100px'><b>STORE ROOM REQUEST</b></td>
                          </tr>
                          <tr>
                      ...
                      <table width='100%' cellspacing='0' cellpadding='0' border='0'>
                          <tbody>
                              ...
                              <tr align='center'>
                                  ...
                                  <td width='200'><b>Store Keeper</b></td>
                              </tr>
                              <tr align='center'>
