...
class server_report_saku3_travel_rptBayarBeli extends server_report_basic
{	
...
$this->filter ";
	...
	function getHtml()
	{
		...
		$sql="select distinct a.no_bukti,a.tanggal,a.keterangan ,e.kode_vendor,c.nama as nama_pp ,a.nik_user,f.nama as nama_user 
from trans_m a
inner join trans_j e on e.no_bukti=a.no_bukti and e.kode_lokasi=a.kode_lokasi 
 inner join brg_vendor c on e.kode_vendor=c.kode_vendor and a.kode_lokasi=c.kode_lokasi
    ...
    <td colspan='18' style='padding:5px'><table width='100%' border='0' cellspacing='2' cellpadding='1'>
      <tr>
	   ...
	   <tr>
        ...
        <td class='header_laporan'>:&nbsp;$row->kode_vendor -&nbsp; $row->nama_pp</td>
      </tr>
...
where a.no_bukti='$row->no_bukti'  and a.dc='d'
 ";
