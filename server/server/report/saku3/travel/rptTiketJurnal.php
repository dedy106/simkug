...
class server_report_saku3_travel_rptTiketJurnal extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.no_bukti,c.keterangan,a.kode_lokasi,c.no_dokumen,a.no_closing,CONVERT(varchar, c.tanggal, 105) as tgl,d.nama,d.jumlah,d.nilai*d.jumlah as nilai,d.nilai as tagihan,b.nama as nama_ven
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			echo "<table border='0' cellspacing='2' cellpadding='1'>
			  <tr>
				<td align='center' class='header_laporan'>JURNAL TIKET</td>
			  </tr>
			  <tr>
