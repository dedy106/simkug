...
class server_report_saku3_travel_rptGlNeracaTrans extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$format=$tmp[4];
		$kode_fs=$tmp[5];
		$sql="exec sp_neraca_trans '$kode_fs','A','K','$lev','$periode','$kode_lokasi','$nik_user' ";
	    ...
	    $sql = "select '$kode_lokasi' as kode_lokasi,kode_neraca1,kode_neraca2,nama1,tipe1,nilai1,level_spasi1,nama2,tipe2,nilai2,level_spasi2 
				from neraca_skontro 
				where nik_user='$nik_user' order by rowindex ";
		$nama="";
		if ($format=="Mutasi")
		{
			 $sql = "select '$kode_lokasi' as kode_lokasi,kode_neraca1,kode_neraca2,nama1,tipe1,nilai3 as nilai1,level_spasi1,nama2,tipe2,nilai4 as nilai2,level_spasi2 
				from neraca_skontro 
				where nik_user='$nik_user' order by rowindex ";
			$nama="(MUTASI)";
		}
  ...
  <tr>
    <td  class='lokasi_laporan2' align='center'>LAPORAN NERACA $nama $nama_periode</td>
  </tr>
  <tr>
