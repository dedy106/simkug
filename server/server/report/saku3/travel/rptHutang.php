...
class server_report_saku3_travel_rptHutang extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode=$tmp[0];
		$nama_cab=$tmp[1];
		$sql="select a.no_hutang,a.kode_lokasi,a.no_dokumen,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,
		a.nilai,a.nilai_ppn,a.nilai+a.nilai_ppn as nilai,a.nilai as tagihan,b.nama as nama_ven
from hutang_d a
