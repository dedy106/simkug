...
class server_report_saku3_travel_rptJuJurnalBukti extends server_report_basic
{
	...
	function getHtml()
	{
		...
		global $dbLib;
		$sql="select a.no_bukti,a.no_ref1,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.no_dokumen,a.kode_lokasi,a.periode,b.nama,b.kota,c.nama as nama_buat,a.nik1 as nik_buat,d.nama as nama_app,d.nama as nama_app,a.nik2 as nik_app,a.no_dokumen
			from trans_m a
