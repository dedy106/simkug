...
class server_report_saku3_travel_rptTransferForm extends server_report_basic
{	
...
from brg_kirim_m a  $this->filter ";
	...
	function getHtml()
	{
		...
		// echo $AddOnLib->judul_laporan("transfer form",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
                      ...
                      <table width='100%' border='0'>
                       <tbody>
                          ...
                          <tr>
                              ...
                              <td  class='judul_bukti' colspan='3' style='padding-left:100px'><b>TRANSFER FORM</b></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                              <td colspan='4'>
                                  ...
                                  <tr bgcolor='#CCCCCC'>
                                      ...
                                      <td class='header_laporan' width='300' align='center'>Item</td>
                                      <td class='header_laporan' width='140' align='center'>Unit</td>
                                      <td class='header_laporan' width='140' align='center'>Qty Transfer</td>
                                  </tr>";
                  ...
                  <td>
                      <table width='700%' cellspacing='0' cellpadding='0' border='0'>
                          <tbody>
                              ...
                              <tr align='center'>
                                  <td width='250'><b>User & Dept.Head </b> </td>
                                  <td width='250'><b>Internal Control & Acct </b></td>
                                  <td width='250'><b>Receiver</b></td>
                              </tr>
                              <tr align='center'>
