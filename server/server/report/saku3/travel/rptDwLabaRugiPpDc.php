...
class server_report_saku3_travel_rptDwLabaRugiPpDc extends server_report_basic
{
	...
	function getHtml()
	{
		...
		<td width='100' class='header_laporan' align='center'>Debet</td>
		<td width='100' class='header_laporan' align='center'>Kredit</td>
