...
class server_report_saku3_travel_rptGlBukuBesarTrans extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="exec sp_glma_trans '$kode_lokasi','$periode','$nik_user' ";
...
from (select a.kode_lokasi,a.no_bukti,a.no_dokumen,a.periode,a.tanggal,a.kode_akun,a.kode_pp,a.kode_drk,a.dc,a.nilai,a.keterangan,a.modul 
    ...
    <td valign='top' class='isi_laporan' align='right'>".number_format($ndebet,0,',','.')."</td>
    <td valign='top' class='isi_laporan' align='right'>".number_format($nkredit,0,',','.')."</td>
