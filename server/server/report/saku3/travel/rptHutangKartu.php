...
class server_report_saku3_travel_rptHutangKartu extends server_report_basic
{
	...
	function getHtml()
	{
		...
		global $dbLib;
		$sql="select a.kode_lokasi,a.no_hutang,a.no_dokumen,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.nilai+a.nilai_ppn as nilai,b.nama as nama_vendor
from hutang_d a
...
-- union all
select a.kode_lokasi,a.no_bukti,a.nilai,date_format(b.tanggal,'%d/%m/%Y') as tanggal,b.keterangan
from hutbayar_d a
inner join trans_m b on a.no_bukti=b.no_bukti and a.kode_lokasi=b.kode_lokasi
where a.no_hutang='$row->no_hutang' and a.kode_lokasi='$row->kode_lokasi' 
";
