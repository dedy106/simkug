...
class server_report_saku3_travel_rptGlTbTahunSpm extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$jenis=$tmp[3];
		$trail=$tmp[4];
		$sql="exec sp_glma_tahun_dw_mutasi_tmp '$kode_lokasi','$tahun','$nik_user' ";
...
";
	...
	echo "<td  class='isi_laporan' align='right'><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenBb('$row->kode_akun','$row->kode_lokasi','$periode16');\">".number_format($row->total,0,",",".")."</a></td>";
echo "</tr>";
