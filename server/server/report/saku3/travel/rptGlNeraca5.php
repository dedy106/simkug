...
class server_report_saku3_travel_rptGlNeraca5 extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.kode_neraca,a.nama,a.kode_fs,a.kode_lokasi,a.tipe,a.level_spasi,
				   case when a.modul='A' then isnull(b.n4,0) else isnull(-b.n4,0) end as n1,
				   case when a.modul='A' then isnull(c.n4,0) else isnull(-c.n4,0) end as n2,
				   case when a.modul='A' then isnull(d.n4,0) else isnull(-d.n4,0) end as n3,
				   case when a.modul='A' then isnull(e.n4,0) else isnull(-e.n4,0) end as n4,
				   case when a.modul='A' then isnull(f.n4,0) else isnull(-f.n4,0) end as n5
			from neraca a
			...
			where a.kode_lokasi='04' and a.kode_fs='FS1' and a.modul in ('A','P')
			order by a.modul,a.rowindex";
		$rs = $dbLib->execute($sql);
		$i = 1;
