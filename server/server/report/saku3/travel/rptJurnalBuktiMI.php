...
class server_report_saku3_travel_rptJurnalBuktiMI extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.no_bukti,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.kode_lokasi,a.periode,b.nama,c.nama as nama_buat,a.nik1 as nik_buat,d.nama as nama_app,d.nama as nama_app,a.nik2 as nik_app,a.no_dokumen
				from trans_m a
				inner join lokasi b on a.kode_lokasi=b.kode_lokasi
				left join karyawan c on a.nik1=c.nik and a.kode_lokasi=c.kode_lokasi
				left join karyawan d on a.nik2=d.nik and a.kode_lokasi=d.kode_lokasi
				$this->filter
				order by a.no_bukti ";
