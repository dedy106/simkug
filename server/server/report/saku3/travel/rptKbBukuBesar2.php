...
class server_report_saku3_travel_rptKbBukuBesar2 extends server_report_basic
{
...
order by a.kode_akun";
  ...
  <tr>
    ...
    <td class='header_laporan' align='right'>".number_format($row->so_awal,2,',','.')."</td>
  </tr>
  <tr bgcolor='#CCCCCC'>
...
where a.kode_lokasi='$row->kode_lokasi' and b.modul not in ('KBB','MII') and a.kode_akun='$row->kode_akun' $sql2 order by a.tanggal,dc desc ";
    ...
    <td valign='top' class='isi_laporan' align='right'>".number_format($row1->debet,2,',','.')."</td>
    <td valign='top' class='isi_laporan' align='right'>".number_format($row1->kredit,2,',','.')."</td>
    <td valign='top' class='isi_laporan' align='right'>".number_format($saldo,2,',','.')."</td>
  </tr>";
				
			}
			echo "<tr>
   <td height='23' colspan='6' valign='top' class='isi_laporan' align='right'>Total&nbsp;</td>
   <td valign='top' class='isi_laporan' align='right'>".number_format($debet,2,',','.')."</td>
   <td valign='top' class='isi_laporan' align='right'>".number_format($kredit,2,',','.')."</td>
