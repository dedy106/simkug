...
class server_report_saku3_travel_rptGlLabaRugiInvRra extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql = "select kode_neraca,kode_fs,kode_lokasi,nama,tipe,level_spasi,n1,n2,n3,n4,n5,n6,n7,n8,n9,n10,n11
			from exs_neraca 
  ...
  <tr>
    <td  class='lokasi_laporan2' align='center'>LAPORAN LABA INVESTASI</td>
  </tr>
  <tr>
  ...
  <tr bgcolor='#dbeef3'>
    ...
    <td width='90' rowspan='2' align='center' class='header_laporan'>Budget RRA $tahun</td>
  ...
  <tr bgcolor='#dbeef3'>
    <td width='90' align='center' class='header_laporan'>Budget RRA</td>
