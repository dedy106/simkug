...
class server_report_saku3_travel_rptKirim extends server_report_basic
{	
...
from brg_kirim_m a  $this->filter ";
	...
	function getHtml()
	{
		...
		$sql="select a.no_bukti,date_format(a.tanggal,'%d/%m/%Y') as tanggal,a.no_dokumen,a.keterangan,a.param1,b.nama as nama_asal ,a.param2,c.nama as nama_tujuan
from trans_m a
  ...
  <tr>
    <td colspan='20' style='padding:5px'><table width='100%' border='0' cellspacing='2' cellpadding='1'>
      <tr>
        ...
        <td class='header_laporan'>:&nbsp;$row->kode_gudang_asal -&nbsp; $row->nama_asal</td>
      </tr>
     
	   <tr>
        <td class='header_laporan'>Gudang Tujuan </td>
        <td class='header_laporan'>:&nbsp;$row->kode_gudang_tujuan -&nbsp; $row->nama_tujuan</td>
      </tr>
      <tr>
