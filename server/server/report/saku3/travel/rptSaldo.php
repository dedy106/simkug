...
class server_report_saku3_travel_rptSaldo extends server_report_basic
{
...
order by a.no_paket,a.no_reg ";
		...
		echo $AddOnLib->judul_laporan("saldo pembayaran",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
		echo "<table border='1' cellspacing='0' cellpadding='0' class='kotak'>
   <tr bgcolor='#CCCCCC'>
     <td width='30' rowspan='2'  align='center' class='header_laporan'>No</td>
	 <td width='80' rowspan='2' align='center' class='header_laporan'>No Reg</td>
	 <td width='80' rowspan='2' align='center' class='header_laporan'>No Peserta</td>
	  <td width='150' rowspan='2' align='center' class='header_laporan'>Nama Peserta</td>
	 <td width='150' rowspan='2' align='center' class='header_laporan'>Paket</td>
	 <td width='80' rowspan='2' align='center' class='header_laporan'>Agen</td>
	 <td width='60' rowspan='2' align='center' class='header_laporan'>Tgl Reg</td>
	 <td width='80' rowspan='2' align='center' class='header_laporan'>Flag Closing</td>
   ...
   <tr bgcolor='#CCCCCC'>
     <td width='90'  align='center' class='header_laporan'>Paket</td>
