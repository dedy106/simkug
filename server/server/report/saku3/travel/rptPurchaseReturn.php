...
class server_report_saku3_travel_rptPurchaseReturn extends server_report_basic
{	
...
from brg_kirim_m a  $this->filter ";
	...
	function getHtml()
	{
		...
		// echo $AddOnLib->judul_laporan("Purchase Return",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
                      ...
                      <table width='100%' border='0'>
                       <tbody>
                          ...
                          <tr>
                              ...
                              <td  class='judul_bukti' colspan='3' style='padding-left:100px'><b>PURCHASE RETURN</b></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                              <td colspan='4'>
                                  ...
                                  <tr bgcolor='#CCCCCC'>
                                      ...
                                      <td class='header_laporan' width='120' align='center'>Qty Receive</td>
                                      <td class='header_laporan' width='120' align='center'>Qty Return</td>
                                  </tr>";
                  ...
                  <td>
                      <table width='100%' cellspacing='0' cellpadding='0' border='0'>
                          <tbody>
                              ...
                              <tr align='center'>
                                  <td width='250'><b>Receiving </b> </td>
                                  <td width='250'><b>Security </b></td>
                                  <td width='250'><b>Supplier</b></td>
                              </tr>
                              <tr align='center'>
