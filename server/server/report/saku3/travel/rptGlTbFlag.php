...
class server_report_saku3_travel_rptGlTbFlag extends server_report_basic
{
	...
	function getHtml()
	{
       ...
       case when a.so_akhir<0 then -so_akhir else 0 end as so_akhir_kredit
		from glma_tmp a 
		inner join flag_relasi c on a.kode_akun=c.kode_akun and a.kode_lokasi=c.kode_lokasi
		$this->filter and a.nik_user='$nik_user' $mutasi and c.kode_flag='$kode_flag'
		order by a.kode_akun";
		}
