...
class server_report_saku3_travel_rptDwLabaRugiPpMutasi extends server_report_basic
{
	...
	function getHtml()
	{
		...
		while ($row2 = $rs2->FetchNextObject($toupper=false))
		{
			...
			$sql = "select a.kode_neraca,a.kode_fs,a.kode_lokasi,a.nama,a.tipe,a.level_spasi,a.kode_pp,
						case a.jenis_akun when  'Pendapatan' then -(a.n2-a.n3) else a.n2-a.n3 end as n4
			...
			echo $AddOnLib->judul_laporan("laporan laba rugi unit (mutasi)"."<br>".$nama,$this->lokasi,"Periode ".$AddOnLib->ubah_periode($periode));
		  ...
		  <td height='20' class='isi_laporan'>";
				...
				if ($bentuk=="Detail" && $row->tipe=="Posting")
				{
					...
					$sql1="	select a.kode_akun,c.nama,
								case c.jenis when  'Pendapatan' then -(a.debet-a.kredit) else a.debet-a.kredit end as n4
							from exs_glma_pp a
