...
class server_report_saku3_travel_rptReturJual extends server_report_basic
{	
...
$this->filter ";
	...
	function getHtml()
	{
		...
		$sql="select a.no_bukti,a.tanggal,a.keterangan ,d.kode_gudang,c.nama as nama_pp ,a.nik_user,f.nama as nama_user 
from trans_j a 
...
order by a.no_bukti";
		...
		echo $AddOnLib->judul_laporan("retur penjualan",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
