...
class server_report_saku3_travel_rptBeliMutasi extends server_report_basic
{	
	...
	$this->filter
	 group by a.periode,a.kode_lokasi ";
		...
		echo $AddOnLib->judul_laporan("mutasi nilai pembelian barang",$this->lokasi);
		echo "<table border='1' cellspacing='0' cellpadding='0' class='kotak' >
  <tr bgcolor='#CCCCCC'>
    <td width='60' align='center' class='header_laporan'>No</td>
    <td width='250' align='center' class='header_laporan'>Periode</td>
    <td width='250' align='center' class='header_laporan'>Jumlah Barang Pembelian</td>
	...
	echo "<a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenBb('$row->periode','$row->kode_lokasi');\">$row->periode</a>";
	echo "</td>
