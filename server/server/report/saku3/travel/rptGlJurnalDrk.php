...
class server_report_saku3_travel_rptGlJurnalDrk extends server_report_basic
{
...
where a.kode_lokasi='$lokasi'
		...
		echo $AddOnLib->judul_laporan("LAPORAN TRANSAKSI JURNALL",$this->lokasi,$nama_periode);
  ...
  <tr bgcolor='#CCCCCC'>
	...
	<td width='40' class='header_laporan' align='center'>DRK</td>
