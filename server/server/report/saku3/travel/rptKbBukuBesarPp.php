...
class server_report_saku3_travel_rptKbBukuBesarPp extends server_report_basic
{
...
order by a.kode_akun";
  ...
  <tr bgcolor='#CCCCCC'>
    ...
    <td width='90' class='header_laporan' align='center'>Balance</td>
			...
			$sql="select a.no_bukti as no_kas,a.no_dokumen,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.kode_akun,a.kode_pp,a.kode_drk,a.keterangan,b.modul,b.form,
...
where a.kode_lokasi='$row->kode_lokasi' and b.modul not in ('KBB','MII') and a.kode_akun='$row->kode_akun' and a.kode_pp='$row->kode_pp' $sql2 order by a.tanggal ";
