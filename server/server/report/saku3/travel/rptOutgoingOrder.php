...
class server_report_saku3_travel_rptOutgoingOrder extends server_report_basic
{	
...
from brg_kirim_m a  $this->filter ";
	...
	function getHtml()
	{
		...
		// echo $AddOnLib->judul_laporan("Outgoing Order",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
                      ...
                      <table width='100%' border='0'>
                       <tbody>
                          ...
                          <tr>
                              ...
                              <td  class='judul_bukti' colspan='3' style='padding-left:100px'><b>OUTGOING ORDER</b></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                              <td colspan='4'>
                                  ...
                                  <tr bgcolor='#CCCCCC'>
                                      ...
                                      <td class='header_laporan' width='120' align='center'>Qty Receipt</td>
                                  </tr>";
                  ...
                  <td>
                      <table width='100%' cellspacing='0' cellpadding='0' border='0'>
                          <tbody>
                              ...
                              <tr align='center'>
                                  <td width='200'><b>Storekeeper </b> </td>
                                  <td width='200'><b>Security </b></td>
                                  <td width='200'><b>Receiver</b></td>
                              </tr>
                              <tr align='center'>
