...
class server_report_saku3_rtrw_rptKartuLain extends server_report_basic
{
  ...
  <tr bgcolor='#CCCCCC'>
    ...
    <td width='90' class='header_laporan' align='center'>Iuran</td>
		<td width='100' class='header_laporan' align='center'>No Bukti</td>
  </tr>";
			$sql="select a.kode_rumah,a.periode_angs,a.kode_lokasi,a.nilai_rt+a.nilai_rw as nilai_rt,a.no_angs,a.kode_jenis
from rt_angs_d a
where a.kode_lokasi='$row->kode_lokasi' and a.kode_rumah='$row->kode_rumah' and a.kode_jenis='$jenis' 
order by a.periode_angs ";
			...
			while ($row1 = $rs1->FetchNextObject($toupper=false))
			{
				...
				echo "<tr>
					...
					<td  class='isi_laporan'>$row1->periode_angs</td>		
