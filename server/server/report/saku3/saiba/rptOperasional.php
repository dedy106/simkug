...
class server_report_saku3_saiba_rptOperasional extends server_report_basic
{
...
$this->filter ";
	...
	$rs = $dbLib->execute($sql);	
		...
		echo $AddOnLib->judul_laporan("laporan operasional","tingkat satuan kerja","untuk periode yang berakhir sampai dengan");
  ...
  <tr bgcolor='#CCCCCC'>
	<td  width='400' class='header_laporan' align='center'>URAIAN</td>
