...
class server_report_saku3_saiba_rptEkuitasSemester extends server_report_basic
{
  ...
  <tr bgcolor='#CCCCCC'>
	<td rowspan='2' width='500' class='header_laporan' align='center'>URAIAN</td>
    <td colspan='2' width='500' class='header_laporan' align='center'>JUMLAH</td>
	<td colspan='2' width='500' class='header_laporan' align='center'>Kenaikan (Penurunan) </td>
  </tr>
  <tr bgcolor='#CCCCCC'>
     <td width='90'  align='center' class='header_laporan'>Awal Periode</td>
	 <td width='90'  align='center' class='header_laporan'>Akhir Periode</td>
