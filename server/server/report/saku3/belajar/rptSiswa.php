...
class server_report_saku3_belajar_rptSiswa extends server_report_basic
{	
	...
	{
		global $dbLib;
		$sql="select a.nim,a.nama,a.kode_jur,b.nama_jur 
from siswa a
inner join jurusan b on a.kode_jur = b.kode_jur
 $this->filter
			order by a.nim ";
