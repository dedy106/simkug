...
class server_report_saku3_belajar_rptDetailTagihan extends server_report_basic
{	
...
*/
		$sql="select a.no_tagihan,a.tanggal,a.nim,a.keterangan,b.kode_tagihan,b.jumlah,c.jenis_tagihan,d.nama
			  from tagihan2 a
			  inner join detail_tagihan b on a.no_tagihan = b.no_tagihan
			  inner join tipe_tagihan c on b.kode_tagihan = c.kode_tagihan
			  inner join siswa d on a.nim = d.nim
			  $this->filter
			  order by a.nim ";
