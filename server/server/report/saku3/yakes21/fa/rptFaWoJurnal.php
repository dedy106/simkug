...
class server_report_saku3_yakes21_fa_rptFaWoJurnal extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode=$tmp[2];
		$filter2=$tmp[3];
		$sql="select a.no_woapp as no_bukti,a.no_dokumen,date_format(a.tanggal,'%d/%m/%Y') as tanggal,a.kode_akun,b.nama,a.kode_pp,a.kode_drk,a.keterangan, 
...
order by a.periode,a.no_woapp,a.dc desc ";
		...
		echo $AddOnLib->judul_laporan("LAPORAN JURNAL WRITE OFF",$this->lokasi,"Periode ".$AddOnLib->ubah_periode($periode));
