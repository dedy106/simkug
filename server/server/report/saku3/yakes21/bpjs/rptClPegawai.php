...
class server_report_saku3_yakes21_bpjs_rptClPegawai extends server_report_basic
{
	...
	function getHtml()
	{
		...
		echo $AddOnLib->judul_laporan("laporan bpjs claim pegawai",$this->lokasi,"PERIODE s/d ".$AddOnLib->ubah_periode($periode));
