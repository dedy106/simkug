...
class server_report_saku3_yakes21_bpjs_rptPrPensiun extends server_report_basic
{
	...
	function getHtml()
	{
		...
		isnull(c.n1,0) as n1
		from yk_bulan a
		left join (select substring(a.periode,5,2) as kode_bulan,sum(case when a.jenis='pensiun' then a.nilai else 0 end)  as premi,
		sum(case when a.jenis='pensiun' and a.jenis_tpkk='TPKK' then a.nilai else 0 end)  as n2
	...
	order by a.kode_bulan ";
		...
		echo $AddOnLib->judul_laporan("laporan iuran premi kapitasi pensiun",$this->lokasi,"Tahun ".$AddOnLib->ubah_periode($periode));
		echo "<table border='1' cellspacing='0' cellpadding='0' class='kotak'>
   <tr bgcolor='#CCCCCC'>
	 <td width='80' rowspan='2' align='center' class='header_laporan'>Bulan</td>
     <td width='80' colspan='2' align='center' class='header_laporan'>Pensiun</td>
   </tr>
   <tr bgcolor='#CCCCCC'>
