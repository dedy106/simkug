...
class server_report_saku3_yakes21_bpjs_rptUtilitasPeg extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode=$tmp[1];
		$filter_vendor=$tmp[2];
		$sql="select sum(case when a.jenis='pegawai' then a.nilai else 0 end)  as premi,
		sum(case when a.jenis='pegawai' and substring(a.periode,5,2)='01' then a.nilai else 0 end)  as n1,
		sum(case when a.jenis='pegawai' and substring(a.periode,5,2)='02' then a.nilai else 0 end)  as n2,
		sum(case when a.jenis='pegawai' and substring(a.periode,5,2)='03' then a.nilai else 0 end)  as n3,
		sum(case when a.jenis='pegawai' and substring(a.periode,5,2)='04' then a.nilai else 0 end)  as n4,
		sum(case when a.jenis='pegawai' and substring(a.periode,5,2)='05' then a.nilai else 0 end)  as n5,
		sum(case when a.jenis='pegawai' and substring(a.periode,5,2)='06' then a.nilai else 0 end)  as n6,
		sum(case when a.jenis='pegawai' and substring(a.periode,5,2)='07' then a.nilai else 0 end)  as n7,
		sum(case when a.jenis='pegawai' and substring(a.periode,5,2)='08' then a.nilai else 0 end)  as n8,
		sum(case when a.jenis='pegawai' and substring(a.periode,5,2)='09' then a.nilai else 0 end)  as n9,
		sum(case when a.jenis='pegawai' and substring(a.periode,5,2)='10' then a.nilai else 0 end)  as n10,
		sum(case when a.jenis='pegawai' and substring(a.periode,5,2)='11' then a.nilai else 0 end)  as n11,
		sum(case when a.jenis='pegawai' and substring(a.periode,5,2)='12' then a.nilai else 0 end)  as n12,
		
		sum(case when b.jenis='pegawai' and b.jenis_tpkk='TPKK'  then b.nilai else 0 end)  as n13,
		sum(case when b.jenis='pegawai' and b.jenis_tpkk='TPKK' and substring(b.periode,5,2)='01' then b.nilai else 0 end)  as n14,
		sum(case when b.jenis='pegawai' and b.jenis_tpkk='TPKK' and substring(b.periode,5,2)='02' then b.nilai else 0 end)  as n15,
		sum(case when b.jenis='pegawai' and b.jenis_tpkk='TPKK' and substring(b.periode,5,2)='03' then b.nilai else 0 end)  as n16,
		sum(case when b.jenis='pegawai' and b.jenis_tpkk='TPKK' and substring(b.periode,5,2)='04' then b.nilai else 0 end)  as n17,
		sum(case when b.jenis='pegawai' and b.jenis_tpkk='TPKK' and substring(b.periode,5,2)='05' then b.nilai else 0 end)  as n18,
		sum(case when b.jenis='pegawai' and b.jenis_tpkk='TPKK' and substring(b.periode,5,2)='06' then b.nilai else 0 end)  as n19,
		sum(case when b.jenis='pegawai' and b.jenis_tpkk='TPKK' and substring(b.periode,5,2)='07' then b.nilai else 0 end)  as n20,
		sum(case when b.jenis='pegawai' and b.jenis_tpkk='TPKK' and substring(b.periode,5,2)='08' then b.nilai else 0 end)  as n21,
		sum(case when b.jenis='pegawai' and b.jenis_tpkk='TPKK' and substring(b.periode,5,2)='09' then b.nilai else 0 end)  as n22,
		sum(case when b.jenis='pegawai' and b.jenis_tpkk='TPKK' and substring(b.periode,5,2)='10' then b.nilai else 0 end)  as n23,
		sum(case when b.jenis='pegawai' and b.jenis_tpkk='TPKK' and substring(b.periode,5,2)='11' then b.nilai else 0 end)  as n24,
		sum(case when b.jenis='pegawai' and b.jenis_tpkk='TPKK' and substring(b.periode,5,2)='12' then b.nilai else 0 end)  as n25
		...
		echo $AddOnLib->judul_laporan("laporan bpjs - utilisasi pegawai",$this->lokasi,"Tahun s/d ".$AddOnLib->ubah_periode($periode));
   ...
   <td  align='center' class='header_laporan'>No</td>
	 ...
	 <td width='80' align='center' class='header_laporan'>Desember</td>
		...
		sum(case when a.kode_lokasi=a.kode_lokasi and substring(a.periode,5,2)='12' then a.nilai else 0 end) as e12
			   ...
			   $this->filter and a.jenis='pegawai'  ";
		...
		<td width='150' class='isi_laporan' align='right'>".number_format($row3->e12,0,",",".")."</td>
		 ...
		 $sqlp3 = "select 
		 sum(case when a.kode_lokasi=a.kode_lokasi then a.bp else 0 end) as p3_0,
		 sum(case when a.kode_lokasi=a.kode_lokasi and substring(a.periode,5,2)='01' then a.bp else 0 end) as p3_1,
		 sum(case when a.kode_lokasi=a.kode_lokasi and substring(a.periode,5,2)='02' then a.bp else 0 end) as p3_2,
		 sum(case when a.kode_lokasi=a.kode_lokasi and substring(a.periode,5,2)='03' then a.bp else 0 end) as p3_3,
		 sum(case when a.kode_lokasi=a.kode_lokasi and substring(a.periode,5,2)='04' then a.bp else 0 end) as p3_4,
		 sum(case when a.kode_lokasi=a.kode_lokasi and substring(a.periode,5,2)='05' then a.bp else 0 end) as p3_5,
		 sum(case when a.kode_lokasi=a.kode_lokasi and substring(a.periode,5,2)='06' then a.bp else 0 end) as p3_6,
		 sum(case when a.kode_lokasi=a.kode_lokasi and substring(a.periode,5,2)='07' then a.bp else 0 end) as p3_7,
		 sum(case when a.kode_lokasi=a.kode_lokasi and substring(a.periode,5,2)='08' then a.bp else 0 end) as p3_8,
		 sum(case when a.kode_lokasi=a.kode_lokasi and substring(a.periode,5,2)='09' then a.bp else 0 end) as p3_9,
		 sum(case when a.kode_lokasi=a.kode_lokasi and substring(a.periode,5,2)='10' then a.bp else 0 end) as p3_10,
		 sum(case when a.kode_lokasi=a.kode_lokasi and substring(a.periode,5,2)='11' then a.bp else 0 end) as p3_11,
		 sum(case when a.kode_lokasi=a.kode_lokasi and substring(a.periode,5,2)='12' then a.bp else 0 end) as p3_12
			 from yk_bpjs_bill a 
