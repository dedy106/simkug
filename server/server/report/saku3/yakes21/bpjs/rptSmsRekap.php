...
class server_report_saku3_yakes21_bpjs_rptSmsRekap extends server_report_basic
{
...
order by a.no_paket,a.no_reg ";
   ...
   <tr bgcolor='#CCCCCC'>
	 ...
	 <td width='80' rowspan='3' align='center' class='header_laporan'>Bulan</td>
     <td colspan='6' align='center' class='header_laporan'>TW 1</td>
     <td colspan='6' align='center' class='header_laporan'>TW 1 + April 2018</td>
   </tr>
   <tr bgcolor='#CCCCCC'>
   ...
   <td colspan='2' align='center' class='header_laporan'>Pengajuan Tanpa Sms Restitusi</td>
   <td colspan='2' align='center' class='header_laporan'>Pengajuan</td>
   <td colspan='2' align='center' class='header_laporan'>Sms Restitusi</td>
   <td colspan='2' align='center' class='header_laporan'>Pengajuan Tanpa Sms Restitusi</td>
 </tr>
