...
class server_report_saku3_yakes21_bpjs_rptUtilitas extends server_report_basic
{
		...
		echo "<tr >
			...
			sum(case when a.kode_lokasi=a.kode_lokasi and substring(a.periode,5,2)='12' then a.nilai else 0 end) as e12
				...
				while ($row3 = $rs3->FetchNextObject($toupper=false))
				{
					...
					$sqlp3 = "select 
					sum(case when a.kode_lokasi=a.kode_lokasi then a.total else 0 end) as p3_0,
					sum(case when a.kode_lokasi=a.kode_lokasi and substring(a.periode,5,2)='01' then a.total else 0 end) as p3_1,
					sum(case when a.kode_lokasi=a.kode_lokasi and substring(a.periode,5,2)='02' then a.total else 0 end) as p3_2,
					sum(case when a.kode_lokasi=a.kode_lokasi and substring(a.periode,5,2)='03' then a.total else 0 end) as p3_3,
					sum(case when a.kode_lokasi=a.kode_lokasi and substring(a.periode,5,2)='04' then a.total else 0 end) as p3_4,
					sum(case when a.kode_lokasi=a.kode_lokasi and substring(a.periode,5,2)='05' then a.total else 0 end) as p3_5,
					sum(case when a.kode_lokasi=a.kode_lokasi and substring(a.periode,5,2)='06' then a.total else 0 end) as p3_6,
					sum(case when a.kode_lokasi=a.kode_lokasi and substring(a.periode,5,2)='07' then a.total else 0 end) as p3_7,
					sum(case when a.kode_lokasi=a.kode_lokasi and substring(a.periode,5,2)='08' then a.total else 0 end) as p3_8,
					sum(case when a.kode_lokasi=a.kode_lokasi and substring(a.periode,5,2)='09' then a.total else 0 end) as p3_9,
					sum(case when a.kode_lokasi=a.kode_lokasi and substring(a.periode,5,2)='10' then a.total else 0 end) as p3_10,
					sum(case when a.kode_lokasi=a.kode_lokasi and substring(a.periode,5,2)='11' then a.total else 0 end) as p3_11,
					sum(case when a.kode_lokasi=a.kode_lokasi and substring(a.periode,5,2)='12' then a.total else 0 end) as p3_12
						from yk_bpjs_bill a 
