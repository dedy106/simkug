...
class server_report_saku3_yakes21_panjar_rptPjPos extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.no_pb,a.kode_lokasi,convert(varchar,a.tanggal,103) as tgl,a.keterangan,a.nilai,a.kode_pp,b.nama as nama_pp,
  ...
  left join (select b.no_bukti, b.kode_lokasi,count(b.no_gambar) as jum_dok 
		  ...
		  $this->filter and a.modul in ('PJAJU','PJPTG') order by a.no_pb";
