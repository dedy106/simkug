...
class server_report_saku3_yakes21_panjar_rptPjAjuForm extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode=$tmp[2];
		$filter2=$tmp[3];
		$sql="select a.no_panjar,a.nik_buat,a.nik_app,f.flag as nik_bdh,h.flag as nik_manbdh,a.kode_pp,a.nilai,a.akun_panjar,a.keterangan,substring(a.periode,1,4) as tahun,
       b.nama as nama_pp,c.nama as nama_buat,e.nama as nama_app,f.nama as nama_bdh,g.nama as nama_akun,h.nama as nama_manbdh,
    ...
    <td><table width='800' border='0' cellspacing='2' cellpadding='1'>
      ...
      <tr>
        <td colspan='2'><table width='800' border='1' cellspacing='0' cellpadding='0' class='kotak'>
          <tr>
            <td width='89' align='center'  class='header_form' height='23'>Kode Akun </td>
...
where a.no_panjar='$row->no_panjar' order by a.kode_akun ";
