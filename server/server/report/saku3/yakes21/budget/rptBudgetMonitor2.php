...
class server_report_saku3_yakes21_budget_rptBudgetMonitor2 extends server_report_basic
{
...
left join (select a.kode_lokasi,a.kode_akun,a.kode_pp,a.kode_drk,
  ...
  // echo $sql;
    ...
    <tr bgcolor='#CCCCCC'>
      ...
      <td width='90' align='center' class='header_laporan' colspan='12'>REALISASI [GL]</td>
      <td width='90' align='center' class='header_laporan' colspan='4'>SALDO RELEASE [ANGGARAN]</td>
  ...
  <td class='isi_laporan' align='right'>".number_format($row->gl_b1,0,',','.')."</td>
  <td class='isi_laporan' align='right'>".number_format($row->gl_b2,0,',','.')."</td>
  <td class='isi_laporan' align='right'>".number_format($row->gl_b3,0,',','.')."</td>
  <td class='isi_laporan' align='right'>".number_format($row->gl_b4,0,',','.')."</td>
  <td class='isi_laporan' align='right'>".number_format($row->gl_b5,0,',','.')."</td>
  <td class='isi_laporan' align='right'>".number_format($row->gl_b6,0,',','.')."</td>
  <td class='isi_laporan' align='right'>".number_format($row->gl_b7,0,',','.')."</td>
  <td class='isi_laporan' align='right'>".number_format($row->gl_b8,0,',','.')."</td>
  <td class='isi_laporan' align='right'>".number_format($row->gl_b9,0,',','.')."</td>
  <td class='isi_laporan' align='right'>".number_format($row->gl_b10,0,',','.')."</td>
  <td class='isi_laporan' align='right'>".number_format($row->gl_b11,0,',','.')."</td>
  <td class='isi_laporan' align='right'>".number_format($row->gl_b12,0,',','.')."</td>

  <td class='isi_laporan' align='right'>".number_format($row->rilis_tw1-$row->gl_b1-$row->gl_b2-$row->gl_b3,0,',','.')."</td>
  <td class='isi_laporan' align='right'>".number_format($row->rilis_tw2-$row->gl_b4-$row->gl_b5-$row->gl_b6,0,',','.')."</td>
  <td class='isi_laporan' align='right'>".number_format($row->rilis_tw3-$row->gl_b7-$row->gl_b8-$row->gl_b9,0,',','.')."</td>
  <td class='isi_laporan' align='right'>".number_format($row->rilis_tw4-$row->gl_b10-$row->gl_b11-$row->gl_b12,0,',','.')."</td>

  <td class='isi_laporan' align='right'>".number_format($row->mutasi-$row->gl_b1-$row->gl_b2-$row->gl_b3-$row->gl_b4-$row->gl_b5-$row->gl_b6-$row->gl_b7-$row->gl_b8-$row->gl_b9-$row->gl_b10-$row->gl_b11-$row->gl_b12,0,',','.')."</td>
  ...
  <td class='header_laporan' align='right'>".number_format($gl_b1,0,',','.')."</td>
  <td class='header_laporan' align='right'>".number_format($gl_b2,0,',','.')."</td>
  <td class='header_laporan' align='right'>".number_format($gl_b3,0,',','.')."</td>
  <td class='header_laporan' align='right'>".number_format($gl_b4,0,',','.')."</td>
  <td class='header_laporan' align='right'>".number_format($gl_b5,0,',','.')."</td>
  <td class='header_laporan' align='right'>".number_format($gl_b6,0,',','.')."</td>
  <td class='header_laporan' align='right'>".number_format($gl_b7,0,',','.')."</td>
  <td class='header_laporan' align='right'>".number_format($gl_b8,0,',','.')."</td>
  <td class='header_laporan' align='right'>".number_format($gl_b9,0,',','.')."</td>
  <td class='header_laporan' align='right'>".number_format($gl_b10,0,',','.')."</td>
  <td class='header_laporan' align='right'>".number_format($gl_b11,0,',','.')."</td>
  <td class='header_laporan' align='right'>".number_format($gl_b12,0,',','.')."</td>

  <td class='header_laporan' align='right'>".number_format($rilis_tw1-$gl_b1-$gl_b2-$gl_b3,0,',','.')."</td>
  <td class='header_laporan' align='right'>".number_format($rilis_tw2-$gl_b4-$gl_b5-$gl_b6,0,',','.')."</td>
  <td class='header_laporan' align='right'>".number_format($rilis_tw3-$gl_b7-$gl_b8-$gl_b9,0,',','.')."</td>
  <td class='header_laporan' align='right'>".number_format($rilis_tw4-$gl_b10-$gl_b11-$gl_b12,0,',','.')."</td>
  
  <td class='header_laporan' align='right'>".number_format($mutasi-$gl_b1-$gl_b2-$gl_b3-$gl_b4-$gl_b5-$gl_b6-$gl_b7-$gl_b8-$gl_b9-$gl_b10-$gl_b11-$gl_b12,0,',','.')."</td>
