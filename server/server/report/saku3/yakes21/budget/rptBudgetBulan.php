...
class server_report_saku3_yakes21_budget_rptBudgetBulan extends server_report_basic
{
...
<td width='90' class='header_laporan'><div align='center'>September</div></td>
  ...
  <td class='isi_laporan' align='right'>".number_format($row->total,0,',','.')."</td>
    ...
    <td class='isi_lheader_laporanaporan' align='right'>".number_format($n6,0,',','.')."</td>
