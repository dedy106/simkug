...
class server_report_saku3_yakes21_piutang_rptBillingHutang extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql2="exec sp_yk_bill_lap_hutang '$no_bill','$kode_lokasi','$nik_user' ";
		$sql = "select a.no_hutang as no_valid,date_format(a.tanggal,'%d-%m-%Y') as tanggal,a.periode,a.keterangan
from yk_hutang_m a
where  a.kode_lokasi='$kode_lokasi' and a.no_hutang='$no_bill'";
