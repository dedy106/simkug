...
class server_report_saku3_yakes21_piutang_rptBillingBast extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql2="exec sp_ykbilllap_bast '$no_bill','$kode_lokasi','$nik_user' ";
...
where  a.kode_lokasi='$kode_lokasi' and a.no_selesai='$no_bill'";
      ...
      <tr>
        ...
        ";
			...
			$sql1 = "select ''''+a.kode_vendor as kode_vendor,a.no_ref,a.nik,a.nama,a.loker,date_format(a.tgl_masuk,'%d-%m-%Y') as tgl_masuk,date_format(a.tgl_keluar,'%d-%m-%Y') as tgl_keluar,a.icdx,a.band,
