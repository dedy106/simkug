...
class server_report_saku3_yakes21_gl_rptGlNeracaJejer extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="exec sp_neraca_jejer_yk '$kode_fs','A','S','$lev','$periode','$kode_lokasi','$nik_user' ";
		//echo $sql;
		$rs = $dbLib->execute($sql);	
		
		$sql = "select kode_neraca,kode_fs,kode_lokasi,nama,tipe,level_spasi,n1,n2,n3,n4,n5,n6,n7,n8,
					(n1+n2+n3+n4+n5+n6+n7+n8) as n9
			from neraca_tmp 
