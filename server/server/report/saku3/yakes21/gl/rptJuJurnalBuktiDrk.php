...
class server_report_saku3_yakes21_gl_rptJuJurnalBuktiDrk extends server_report_basic
{
	...
	function getHtml()
	{
		...
		global $dbLib;
		$sql="select a.no_ju,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.no_dokumen,a.kode_lokasi,a.periode,b.nama,b.kota,a.nik_buat,a.nik_setuju,c.nama as nama_buat,d.nama as nama_setuju
			from ju_m a
  ...
  <tr>
    <td><table width='800' border='1' cellspacing='0' cellpadding='0' class='kotak'>
	 ...
	 $sql1="select b.kode_akun,c.nama as nama_akun,b.kode_pp,b.kode_drk,b.nilai,b.keterangan, 
			case when b.dc='D' then b.nilai else 0 end as debet,
			case when b.dc='C' then b.nilai else 0 end as kredit,b.kode_curr 
			from ju_m a 
			inner join ju_j b on a.no_ju=b.no_ju 
			inner join masakun c on b.kode_akun=c.kode_akun and c.kode_lokasi=b.kode_lokasi
			where a.periode='$row->periode'  and a.no_ju='$row->no_ju'
			order by b.dc desc";
		//echo $sql1;
   ...
   <tr>
    <td align='right'><table width='400' border='1' cellspacing='0' cellpadding='0' class='kotak'>
      ...
      <tr>
        ...
        <td align='center'>NIK. $row->nik_setuju </td>
        </tr>
    </table></td>
  </tr>
</table><br>
