...
class server_report_saku3_yakes21_gl_rptGlLabaRugi extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="exec sp_neraca_yk '$kode_fs','L','S','$lev','$periode','$kode_lokasi','$nik_user' ";
		//echo $sql;
		$rs = $dbLib->execute($sql);	
		...
		$sql = "select kode_neraca,kode_fs,kode_lokasi,nama,tipe,level_spasi,
				   ...
				   case jenis_akun when  'Pendapatan' then -(n1-n2) else n1-n2 end as n3
			from neraca_tmp 
