...
class server_report_saku3_yakes21_gl_rptGlTb extends server_report_basic
{
...
<td class='isi_laporan' align='right'>".number_format($row->so_awal_debet,0,',','.')."</td>
	...
	echo "<tr>
    <td height='20' colspan='3' class='header_laporan' align='right'>Total</td>
    <td class='header_laporan' align='right'>".number_format($so_awal_debet,0,',','.')."</td>
    <td class='header_laporan' align='right'>".number_format(abs($so_awal_kredit),0,',','.')."</td>
    ...
    <td class='header_laporan' align='right'>".number_format($so_akhir_debet,0,',','.')."</td>
    <td class='header_laporan' align='right'>".number_format(abs($so_akhir_kredit),0,',','.')."</td>
</tr>";
		echo "</td></tr>";
		echo "</table></div>";
		return "";
