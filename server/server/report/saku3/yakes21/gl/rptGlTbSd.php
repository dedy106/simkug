...
class server_report_saku3_yakes21_gl_rptGlTbSd extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="exec sp_glma2_dw_tmp '$kode_lokasi','$periode','$periode2','$nik_user' ";
       ...
       case when a.so_akhir<0 then -so_akhir else 0 end as so_akhir_kredit
		...
		if ($periode2!="")
		{
			$nama_periode=$AddOnLib->ubah_periode($periode)." Sd ".$AddOnLib->ubah_periode($periode2);
		}
  ...
  <tr>
    <td class='lokasi_laporan' align='center'>".$nama_periode."</td>
  </tr>
  <tr>
    <td align='center'>";
