...
class server_report_saku3_yakes21_pbh_rptKbJurnal extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.no_kas as no_bukti,a.no_dokumen,c.nama,date_format(b.tanggal,'%d/%m/%Y') as tanggal,
		...
		from kas_m a 
		inner join kas_j b on a.no_kas=b.no_kas
