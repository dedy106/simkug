...
class server_report_saku3_yakes21_pbh_rptPb extends server_report_basic
{
    ...
    $jenis=$tmp[2];
      ...
      from pbh_pb_m a
      left join karyawan f on a.nik_buat=f.nik 
      left join karyawan g on a.nik_app=g.nik 
