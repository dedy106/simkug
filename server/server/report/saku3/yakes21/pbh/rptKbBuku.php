...
class server_report_saku3_yakes21_pbh_rptKbBuku extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="exec sp_kas_yk_tmp '$kode_lokasi','$periode','$nik_user' ";
...
from kas_j a 
where a.kode_lokasi='$row->kode_lokasi' and a.kode_akun='$row->kode_akun' $sql2 order by a.tanggal ";
