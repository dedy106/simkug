...
class server_report_saku3_aka2_rptDwSaldoTahun extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		$kode_lokasi=$tmp[0];
		$periode=$tmp[1];
		$sql="SELECT  a.kode_lokasi, a.tahunaka,a.tahunaka,a.periode, a.n1, a.n2, a.n3, a.n4, a.n5, a.n6, a.n7, a.n8, a.n9, a.n10, 
a.n11, a.n12, a.n13, a.n14, a.n15, a.n16, a.n17, a.n18, a.n19, a.n20, a.n21, a.n22, a.n23, a.n24
FROM  exs_aka_saldo_tahun a
$this->filter
order by a.tahunaka";
		//echo $sql;
		$rs = $dbLib->execute($sql);	
		...
		echo $AddOnLib->judul_laporan("saldo piutang tahun akademik",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
  ...
  <tr align='center' bgcolor='#CCCCCC'>
    ...
    <td width='80' rowspan='2' class='header_laporan'>Tahun Akademik</td>
