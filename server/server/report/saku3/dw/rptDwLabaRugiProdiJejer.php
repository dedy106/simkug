...
class server_report_saku3_dw_rptDwLabaRugiProdiJejer extends server_report_basic
{
	...
	function getHtml()
	{
		...
		echo $AddOnLib->judul_laporan("LAPORAN REKAP ANGGARAN LABARUGI JEJER PRODI",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
  ...
  <tr bgcolor='#CCCCCC'>
    ...
    echo "<td colspan='2' align='center' class='header_laporan'>$row->kode_prodi - $row->nama</td>";
			...
			while ($row1 = $rs1->FetchNextObject($toupper=false))
			{
				...
				if ($bentuk=="Detail" && $row->tipe=="Posting")
				{
					...
					$sql1="	select a.kode_akun,c.nama,$tmp_sql2
								...
								inner join exs_prodi e on d.kode_pp=e.kode_prodi and d.kode_lokasi=e.kode_lokasi
