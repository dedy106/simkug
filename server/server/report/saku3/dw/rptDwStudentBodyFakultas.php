...
class server_report_saku3_dw_rptDwStudentBodyFakultas extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql = "select a.kode_fakultas,a.nama,ISNULL(c.jum,0) as n2,ISNULL(b.jum,0) as n4,ISNULL(b.jum,0)-ISNULL(c.jum,0) as deviasi  
from aka_fakultas a
left join (select b.kode_fakultas,a.kode_lokasi,COUNT(a.nim) as jum 
		...
		group by b.kode_fakultas,a.kode_lokasi
		  )b on a.kode_fakultas=b.kode_fakultas and a.kode_lokasi=b.kode_lokasi
left join (select b.kode_fakultas,a.kode_lokasi,sum(a.jumlah) as jum
...
where a.kode_lokasi='$kode_lokasi' and a.kode_fakultas='$kode_fakultas'
order by a.kode_fakultas";
		...
		echo $AddOnLib->judul_laporan("laporan student body fakultas",$this->lokasi,"Periode ".$AddOnLib->ubah_periode($periode));
...
order by a.kode_fakultas";
		...
		$content .= $AddOnLib->judul_laporan("laporan student body fakultas",$this->lokasi,"Periode ".$AddOnLib->ubah_periode($periode));
...
order by a.kode_jur";
		...
		$content .= "<table border='1' cellspacing='0' cellpadding='0' style='border-collapse: collapse' bordercolor='#111111'>
  <tr  class='info'>
    <td width='30'  class='header_laporan' align='center'>No</td>
    <td width='50' class='header_laporan' align='center'>Kode Prodi</td>
    <td width='300' class='header_laporan' align='center'>Nama Prodi</td>
