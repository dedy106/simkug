...
class server_report_saku3_dw_rptGLJurnalBuktiTu extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select distinct a.no_bukti,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.kode_lokasi,a.periode,b.nama,b.kota
					  from (select a.no_bukti,a.tanggal,a.kode_lokasi,a.periode
							from gldt a
							$this->filter
							union
							select a.no_bukti,a.tanggal,a.kode_lokasi,a.periode
							from gldt_h a
							$this->filter
							)a 
