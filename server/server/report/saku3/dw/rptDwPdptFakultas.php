...
class server_report_saku3_dw_rptDwPdptFakultas extends server_report_basic
{
...
where a.kode_lokasi='$kode_lokasi' and (ISNULL(b.n2,0)<>0 or ISNULL(b.n4,0)<>0) and c.kode_fakultas='$kode_fakultas'";
		...
		echo $AddOnLib->judul_laporan("laporan pencapaian pendapatan"."<br>".$nama_akun,$this->lokasi,"Periode ".$AddOnLib->ubah_periode($periode));
