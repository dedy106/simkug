...
class server_report_saku3_dw_rptDwLabaRugiBidangJejer extends server_report_basic
{
  ...
  <tr bgcolor='#CCCCCC'>
    ...
    echo "<td colspan='2' align='center' class='header_laporan'>$row->kode_bidang - $row->nama</td>";
