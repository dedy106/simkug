...
class server_report_saku3_dw_rptDwKm extends server_report_basic
{
...
left join (select a.kode_lap,a.kode_lokasi,sum(case when b.jenis_akun='Pendapatan' then -b.n1 else b.n1 end) as n2
		   ...
		   where a.kode_lokasi='$kode_lokasi' and c.kode_klp='K04' and b.periode='$periode'
...
order by a.kode_klp";
		...
		echo $AddOnLib->judul_laporan("laporan KONTRAK MANAJEMEN REKTO"."<br>".$nama_akun,$this->lokasi,"Periode ".$AddOnLib->ubah_periode($periode));
