...
class server_report_saku3_dw_rptDwLabaRugiFakultasAkre extends server_report_basic
{
...
order by a.rowindex ";
			...
			echo $AddOnLib->judul_laporan("laporan sumber dana fakultas"."<br>".$nama,$this->lokasi,"");
