...
class server_report_saku3_dw_rptDwLabaRugiTu extends server_report_basic
{
	...
	function getHtml()
	{
		...
		echo $AddOnLib->judul_laporan("laporan laba rugi",$this->lokasi,"Periode ".$AddOnLib->ubah_periode($periode));
		...
		<td class='isi_laporan' align='center'>".number_format($persen3,2,',','.')."%</td>";
			...
			if ($bentuk=="Detail" && $row->tipe=="Posting")
			{
				...
				$sql1="	select a.kode_akun,c.nama,
						...
						where b.kode_fs='$kode_fs' and a.kode_lokasi='$kode_lokasi' and b.kode_neraca='$kode_neraca' and a.periode='$periode' and (a.n1<>0 or a.n2<>0 or a.n3<>0 or a.n4<>0 or a.n4<>0)
