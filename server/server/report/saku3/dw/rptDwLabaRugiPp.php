...
class server_report_saku3_dw_rptDwLabaRugiPp extends server_report_basic
{
	...
	function getHtml()
	{
		...
		while ($row2 = $rs2->FetchNextObject($toupper=false))
		{
			...
			echo $AddOnLib->judul_laporan("laporan laba rugi pp"."<br>".$nama,$this->lokasi,"Periode ".$AddOnLib->ubah_periode($periode));
