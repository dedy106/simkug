...
class server_report_saku3_gl_rptYptLabaRugiJejerPp extends server_report_basic
{
	...
	function getHtml()
	{
		...
		echo $AddOnLib->judul_laporan("LAPORAN LABARUGI JEJER",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
