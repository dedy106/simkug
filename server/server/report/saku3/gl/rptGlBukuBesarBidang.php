...
class server_report_saku3_gl_rptGlBukuBesarBidang extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$mutasi=$tmp[3];
		$var_periode=$tmp[4];
		//$sql="exec sp_glma_dw_pp_tmp '$kode_lokasi','$periode','$nik_user' ";
...
from (select a.kode_lokasi,a.no_bukti,a.no_dokumen,a.periode,a.tanggal,a.kode_akun,a.kode_pp,a.kode_drk,a.dc,a.nilai,a.keterangan 
	...
	<td valign='top' class='isi_laporan'>";
				echo "<a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenModul('$row1->no_dokumen','$row->kode_lokasi');\">$row1->no_dokumen</a>";
				echo "</td>
