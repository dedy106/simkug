...
class server_report_saku3_gl_rptYptLabaRugiGarKonsolRra extends server_report_basic
{
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			...
			if ($bentuk=="Detail" && $row->tipe=="Posting")
			{
				...
				{	
					...
					<td class='isi_laporan' align='right'>".number_format($row1->n,80,',','.')."</td>
