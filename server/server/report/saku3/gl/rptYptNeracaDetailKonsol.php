...
class server_report_saku3_gl_rptYptNeracaDetailKonsol extends server_report_basic
{
  ...
  <tr>
    <td><table border='1' cellspacing='0' cellpadding='0' class='kotak'>
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			...
			if ($bentuk=="Detail" && $row->tipe=="Posting")
			{
				...
				$sql1="select a.kode_akun,c.nama,a.so_akhir
					...
					where b.kode_fs='$kode_fs' and a.kode_lokasi='$kode_lokasi' and b.kode_neraca='$kode_neraca' and a.periode='$periode' and so_akhir<>0
		...
		$sql = "select kode_neraca,kode_fs,kode_lokasi,nama,tipe,jenis_akun,n4,level_spasi 
		from exs_neraca 
		where modul='P' and kode_lokasi='$kode_lokasi' and kode_fs='$kode_fs' and periode='$periode' and level_lap<=$lev 
		order by rowindex ";
