...
class server_report_saku3_gl_rptGlArusKas5Konsol extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="exec sp_aruskas5_konsol '$kode_lokasi','FS1','$periode','$periode2','$periode3','$periode4','$periode5','$nik_user'";
		echo $sql;
		$rs = $dbLib->execute($sql);		
