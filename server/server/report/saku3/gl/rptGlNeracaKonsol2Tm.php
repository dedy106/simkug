...
class server_report_saku3_gl_rptGlNeracaKonsol2Tm extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="exec sp_neraca_konsol2 '$kode_fs','N','K','1','$periode','$periode2','$kode_lokasi','$nik_user' ";
  ...
  <tr>
    ...
    <td valign='top' class='isi_laporan' align='right'>";
			...
			{
				echo "<a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenTbJejer('$row->kode_neraca1','$kode_lokasi','$periode');\">$nilai1</a>";
			}
			else
			{
				echo "$nilai1";
    ...
    <td valign='top' class='isi_laporan' align='right'>";
			...
			{
				echo "<a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenTbJejer('$row->kode_neraca1','$kode_lokasi','$periode2');\">$nilai3</a>";
			}
			else
			{
				echo "$nilai3";
