...
class server_report_saku3_gl_rptJuJurnalBuktiPp extends server_report_basic
{
	...
	function getHtml()
	{
		...
		global $dbLib;
		$sql="select a.no_ju,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.no_dokumen,a.kode_lokasi,a.periode,b.nama,b.kota,a.no_dokumen,a.nik_buat,
		a.nik_setuju,c.nama as buat,d.nama as setuju,c.jabatan,d.jabatan as jab
			from ju_m a
  ...
  <tr>
    <td><table width='800' border='1' cellspacing='0' cellpadding='0' class='kotak'>
	 ...
	 $sql1="select a.kode_akun,b.nama as nama_akun,a.kode_pp,a.kode_drk,a.nilai,a.keterangan,
					case when dc='D' then nilai else 0 end as debet,case when dc='C' then nilai else 0 end as kredit,a.kode_curr
					  from ju_j a
					  inner join masakun b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi
					  where a.periode='$row->periode' and a.kode_lokasi='$row->kode_lokasi' and a.no_ju='$row->no_ju'
					order by a.dc desc";
  ...
  <tr>
   ...
   <tr>
    <td align='right'><table width='400' border='0' cellspacing='0' cellpadding='0' class='kotak'>
      <tr>
      ...
      <tr>
		...
		<tr>
        <td align='center' width='80'><b>$row->buat</b></td>
        <td align='center'  width='80'><b>$row->setuju</b></td>
        </tr>
		<tr>
        <td align='center' width='80'><b>$row->jabatan</b></td>
        <td align='center'  width='80'><b>$row->jab</b></td>
        </tr>
    </table></td>
  </tr>
</table><br>
