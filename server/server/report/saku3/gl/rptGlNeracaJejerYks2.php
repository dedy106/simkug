...
class server_report_saku3_gl_rptGlNeracaJejerYks2 extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$nik_user=$tmp[2];
		$kode_fs=$tmp[3];
		$sql="exec sp_neraca_jejer_dw2 '$kode_fs','N','S','1','$periode','$kode_lokasi','$nik_user' ";
		
		$rs = $dbLib->execute($sql);		
		$sql = "select a.kode_lokasi,a.kode_neraca,a.nama,a.n1,a.n2,a.n3,a.n4,a.n5,a.n6,a.n7,a.n8,a.n1+a.n2+a.n3+a.n4+a.n5+a.n6+a.n7+a.n8 as n9,a.level_spasi,a.tipe
   ...
   <td valign='top' class='isi_laporan' align='right'>";
    ...
    <td valign='top' class='isi_laporan' align='right'>";
	 ...
	 <td valign='top' class='isi_laporan' align='right'>";
	  ...
	  echo " </table>";
	  echo "<br>";
	  $sql = "select a.kode_lokasi,a.kode_neraca,a.nama,a.n1*-1 as n1,a.n2*-1 as n2,a.n3*-1 as n3,a.n4*-1 as n4,a.n5*-1 as n5 ,a.n6*-1 as n6,a.n7*-1 as n7,a.n8*-1 as n8,
			(a.n1+a.n2+a.n3+a.n4+a.n5+a.n6+a.n7+a.n8)*-1 as n9,a.level_spasi,a.tipe
