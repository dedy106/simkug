...
class server_report_saku3_gl_rptGlJurnalSimulasi extends server_report_basic
{
...
from (select a.kode_lokasi,a.no_bukti,a.no_dokumen,a.tanggal,a.kode_akun,a.keterangan,a.dc,a.kode_pp,a.nilai,a.modul
	from gldt_tmp a $this->filter
	  )a 
