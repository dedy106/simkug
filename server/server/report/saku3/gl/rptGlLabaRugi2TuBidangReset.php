...
class server_report_saku3_gl_rptGlLabaRugi2TuBidangReset extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="exec sp_neraca2_gar_bidang_dw_reset '$kode_fs','L','S','1','$periode','$periode2','$kode_lokasi','$nik_user','$kode_bidang','$injenis' ";
		//echo $sql;
		$rs = $dbLib->execute($sql);	
