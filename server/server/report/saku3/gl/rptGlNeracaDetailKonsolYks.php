...
class server_report_saku3_gl_rptGlNeracaDetailKonsolYks extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$lev=$tmp[4];
		$bentuk=$tmp[5];
		$sql="exec sp_neraca_konsol '$kode_fs','A','K','$lev','$periode','$kode_lokasi','$nik_user' ";
