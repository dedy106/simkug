...
class server_report_saku3_gl_rptGlLabaRugiBidang extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$lev=$tmp[3];
		$kode_pp=$tmp[4];
		$sql="exec sp_neraca_bidang_dw 'FS1','L','S','$lev','$periode','$kode_lokasi','$nik_user','$kode_pp' ";
