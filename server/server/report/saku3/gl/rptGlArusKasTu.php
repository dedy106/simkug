...
class server_report_saku3_gl_rptGlArusKasTu extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="exec sp_aruskas '$kode_lokasi','FS1','$periode','$nik_user'";
		if ($jenis=="Mutasi")
		{
			$sql="exec sp_aruskas_mutasi '$kode_lokasi','FS1','$periode','$nik_user'";
		}
