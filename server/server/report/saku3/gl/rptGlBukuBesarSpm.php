...
class server_report_saku3_gl_rptGlBukuBesarSpm extends server_report_basic
{
...
from (select a.kode_lokasi,a.no_bukti,a.no_dokumen,a.periode,a.tanggal,a.kode_akun,a.kode_pp,a.kode_drk,a.dc,a.nilai,a.keterangan 
	  ...
	  from gldt a  
	  where a.kode_lokasi='$row->kode_lokasi' and a.kode_akun='$row->kode_akun' $var_periode
	 )a order by a.tanggal,a.no_bukti,dc desc  ";
 ...
 <tr>
   <td height='23' colspan='8' valign='top' class='header_laporan' align='right'>Mutasi&nbsp;</td>
   
   <td valign='top' class='header_laporan' align='right'>".number_format($debet-$kredit,0,',','.')."</td>
 </tr>
 <tr>
   <td height='23' colspan='8' valign='top' class='header_laporan' align='right'>Saldo Akhir&nbsp;</td>
