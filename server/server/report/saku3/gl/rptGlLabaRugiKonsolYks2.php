...
class server_report_saku3_gl_rptGlLabaRugiKonsolYks2 extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$kode_lokasi=$tmp[2];
		$kode_fs=$tmp[3];
		$sql="exec sp_neraca_konsol_dw2 '$kode_fs','L','K','5','$periode','$kode_lokasi','$nik_user' ";
		$rs = $dbLib->execute($sql);
