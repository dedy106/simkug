...
class server_report_saku3_gl_rptYptNeraca extends server_report_basic
{
	...
	function getHtml()
	{
	    ...
	    $sql = "select kode_lokasi,kode_neraca1,kode_neraca2,nama1,tipe1,nilai1,level_spasi1,nama2,tipe2,nilai2,level_spasi2 
		from exs_neraca_skontro
