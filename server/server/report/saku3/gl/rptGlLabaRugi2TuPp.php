...
class server_report_saku3_gl_rptGlLabaRugi2TuPp extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="exec sp_neraca2_gar_pp_dw '$kode_fs','L','S','1','$periode','$periode2','$kode_lokasi','$nik_user','$kode_pp' ";
		$rs = $dbLib->execute($sql);
