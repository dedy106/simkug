...
class server_report_saku3_gl_rptGlTbKasJejerSpm extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$jenis=$tmp[3];
		$trail=$tmp[4];
		$sql="exec sp_glma_kas_jejer_dw '$kode_lokasi','$periode','$nik_user' ";
		...
		$sql = "select a.kode_lokasi,a.kode_akun,a.nama,a.n1,a.n2,a.n3,a.n4,a.n5,a.n6,a.n7,a.n8,a.n9,a.n10,a.n11,a.n12,a.n13,a.n14,a.n15,a.n16,a.n17,a.n18,a.n19,a.n20,a.n21,a.n22
				...
				$this->filter and nik_user='$nik_user' and b.kode_flag in ('001','009')
		...
		echo $AddOnLib->judul_laporan("SALDO KASBANK LAJUR",$this->lokasi,"Periode ".$AddOnLib->ubah_periode($periode));
    ...
    <td class='isi_laporan'>$row->kode_akun</td>";
			...
			echo "<td  class='isi_laporan' align='right'><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenTb('$row->kode_akun','08','$periode');\">".number_format($row->n8,0,",",".")."</a></td>";
			...
			echo "<td  class='isi_laporan' align='right'><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenTb('$row->kode_akun','10','$periode');\">".number_format($row->n10,0,",",".")."</a></td>";
			echo "<td  class='isi_laporan' align='right'><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenTb('$row->kode_akun','11','$periode');\">".number_format($row->n11,0,",",".")."</a></td>";
			echo "<td  class='isi_laporan' align='right'><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenTb('$row->kode_akun','12','$periode');\">".number_format($row->n12,0,",",".")."</a></td>";
			echo "<td  class='isi_laporan' align='right'><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenTb('$row->kode_akun','13','$periode');\">".number_format($row->n13,0,",",".")."</a></td>";
			echo "<td  class='isi_laporan' align='right'><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenTb('$row->kode_akun','14','$periode');\">".number_format($row->n14,0,",",".")."</a></td>";
			echo "<td  class='isi_laporan' align='right'><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenTb('$row->kode_akun','15','$periode');\">".number_format($row->n15,0,",",".")."</a></td>";
			echo "<td  class='isi_laporan' align='right'><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenTb('$row->kode_akun','16','$periode');\">".number_format($row->n16,0,",",".")."</a></td>";
			echo "<td  class='isi_laporan' align='right'><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenTb('$row->kode_akun','17','$periode');\">".number_format($row->n17,0,",",".")."</a></td>";
			echo "<td  class='isi_laporan' align='right'><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenTb('$row->kode_akun','18','$periode');\">".number_format($row->n18,0,",",".")."</a></td>";
			echo "<td  class='isi_laporan' align='right'><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenTb('$row->kode_akun','19','$periode');\">".number_format($row->n19,0,",",".")."</a></td>";
			echo "<td  class='isi_laporan' align='right'><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenTb('$row->kode_akun','20','$periode');\">".number_format($row->n20,0,",",".")."</a></td>";
			echo "<td  class='isi_laporan' align='right'><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenTb('$row->kode_akun','21','$periode');\">".number_format($row->n21,0,",",".")."</a></td>";
