...
class server_report_saku3_gl_rptGlLabaRugiJejerYks2 extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$nik_user=$tmp[2];
		$kode_fs=$tmp[3];
		$sql="call sp_neraca_jejer_dw2 '$kode_fs','L','S','1','$periode','$kode_lokasi','$nik_user' ";
		...
		$sql = "select a.kode_lokasi,a.kode_neraca,a.nama,a.level_spasi,a.tipe,
				   ...
				   case jenis_akun when  'Pendapatan' then -(a.n1+a.n2+a.n3+a.n4+a.n5+a.n6+a.n7+a.n8) else (a.n1+a.n2+a.n3+a.n4+a.n5+a.n6+a.n7+a.n8) end as n9
