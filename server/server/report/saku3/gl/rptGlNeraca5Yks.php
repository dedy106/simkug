...
class server_report_saku3_gl_rptGlNeraca5Yks extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode4=$tmp[6];
		$periode5=$tmp[7];
		$sql="exec sp_neraca5_dw '$kode_fs','N','S','1','$periode','$periode2','$periode3','$periode4','$periode5','$kode_lokasi','$nik_user' ";
