...
class server_report_saku3_gl_rptYptLabaRugiJejer extends server_report_basic
{
  ...
  <tr bgcolor='#CCCCCC'>
    <td  align='center' width='300' class='header_laporan'>Deskripsi</td>";
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			...
			$jum=$jum+1;
			$tmp_sql.="sum(case when kode_lokasi='$row->kode_lokasi' then (case when jenis_akun='Pendapatan' then -n4 else n4 end) else 0 end) as 'n4$row->kode_lokasi',";
