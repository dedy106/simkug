...
class server_report_saku3_gl_rptGlTbKonsolSpm extends server_report_basic
{
  ...
  <tr bgcolor='#CCCCCC'> 
	...
	echo "<a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenTbJejer('$row->kode_akun','$row->kode_lokasi','$periode');\">$row->nama</a>";
	echo "</td>
