...
class server_report_saku3_gl_rptGlLabaRugiTahunKonsol extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="exec sp_lr_tahun_konsol_dw '$kode_fs','L','S','$lev','$tahun','$kode_lokasi','$nik_user' ";
