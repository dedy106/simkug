...
class server_report_saku3_gl_rptGlNeraca5YksKonsol extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode4=$tmp[6];
		$periode5=$tmp[7];
		$sql="exec sp_neraca5_konsol_dw '$kode_fs','N','S','1','$periode','$periode2','$periode3','$periode4','$periode5','$kode_lokasi','$nik_user' ";
...
<td width='100' class='header_laporan' align='center'>".$AddOnLib->ubah_periode($periode5)."</td>
    ...
    <td class='isi_laporan' align='right'>";
		...
		$sql = "select kode_neraca,kode_fs,kode_lokasi,nama,tipe,n1*-1 as n1,n2*-1 as n2,-n3 as n3,-n4 as n4,-n5 as n5,
