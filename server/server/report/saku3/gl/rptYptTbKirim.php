...
class server_report_saku3_gl_rptYptTbKirim extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="exec sp_ypt_tb_pp '$lokasi','$periode'";
...
order by a.kode_akun";
		...
		echo $AddOnLib->judul_laporan("data neraca lajur",$this->lokasi,"");
