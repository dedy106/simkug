...
class server_report_saku3_gl_rptGlNeracaKonsol2Ypt extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$periode2=$tmp[3];
		$lev=$tmp[4];
		$sql="exec sp_neraca_konsol2 'FS1','N','K','$lev','$periode','$periode2','$kode_lokasi','$nik_user' ";
