...
class server_report_saku3_gl_rptGlNeracaSimulasi extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$kode_fs=$tmp[3];
		$lev=$tmp[4];
		$sql="exec sp_neraca_dw_sim '$kode_fs','A','K','$lev','$periode','$kode_lokasi','$nik_user' ";
  ...
  <tr>
    <td  class='lokasi_laporan2' align='center'>LAPORAN NERACA (SIMULASI)</td>
  </tr>
  <tr>
