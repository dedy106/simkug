...
class server_report_saku3_gl_rptGLJurnalBuktiSpm extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select distinct a.no_bukti,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.kode_lokasi,a.periode,b.nama,b.kota,a.no_dokumen
				from gldt_h a
				inner join lokasi b on a.kode_lokasi=b.kode_lokasi
				$this->filter
				union
				select distinct a.no_bukti,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.kode_lokasi,a.periode,b.nama,b.kota,a.no_dokumen
				from gldt a
				inner join lokasi b on a.kode_lokasi=b.kode_lokasi
				$this->filter
				order by a.no_bukti ";
