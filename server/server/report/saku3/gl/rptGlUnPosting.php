...
class server_report_saku3_gl_rptGlUnPosting extends server_report_basic
{
	...
	function getHtml()
	{
		...
		global $dbLib;
		$sql="select a.no_unpost,a.keterangan,a.tanggal,a.modul,a.periode,a.nik_buat,a.nik_app,date_format(a.tanggal,'%d/%m/%Y') as tgl,
...
$this->filter order by a.no_unpost";
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			echo "<table border='0' cellspacing='1' cellpadding='2' class='kotak'>
			  <tr>
				<td align='center' class='header_laporan'>UNPOSTING JURNAL</td>
			  </tr>
			  <tr>
				<td><table border='0' cellspacing='2' cellpadding='1'>
				  ...
				  <tr>
					...
					<td width='496' class='header_laporan'>:&nbsp;$row->no_unpost</td>
					</tr>
