...
class server_report_saku3_gl_rptGlBukuBesarKasSpm extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="exec sp_kas_dw_tmp '$kode_lokasi','$periode_awal','$nik_user' ";
  ...
  <tr bgcolor='#CCCCCC'>
    ...
    <td width='90' class='header_laporan' align='center'>Balance</td>
			...
			$sql="select a.no_kas,a.no_dokumen,a.periode,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.kode_akun,a.kode_pp,a.kode_drk,a.keterangan,
	   case when a.dc='D' then nilai else 0 end as debet,
	   case when a.dc='C' then nilai else 0 end as kredit 
from (select a.kode_lokasi,a.no_kas,a.no_dokumen,a.periode,a.tanggal,a.kode_akun,a.kode_pp,a.kode_drk,a.dc,a.nilai,a.keterangan 
	  from kas_j a 
	  where a.kode_lokasi='$row->kode_lokasi' and a.kode_akun='$row->kode_akun' and (a.periode between '$periode_awal' and '$periode') 	  
			...
			while ($row1 = $rs1->FetchNextObject($toupper=false))
			{
				...
				echo "<a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenJurnal('$row1->no_kas','$row->kode_lokasi','$row1->periode');\">$row1->no_kas</a>";
				echo "</td>
    ...
    <td valign='top' class='isi_laporan' align='right'>".number_format($saldo,0,',','.')."</td>
			...
			echo "<tr>
   <td height='23' colspan='5' valign='top' class='header_laporan' align='right'>Total&nbsp;</td>
   ...
   <td valign='top' class='header_laporan' align='right'>&nbsp;</td>
 </tr>
 <tr>
   <td height='23' colspan='7' valign='top' class='header_laporan' align='right'>Mutasi&nbsp;</td>
   
   <td valign='top' class='header_laporan' align='right'>".number_format($debet-$kredit,0,',','.')."</td>
 </tr>
 <tr>
   <td height='23' colspan='7' valign='top' class='header_laporan' align='right'>Saldo Akhir&nbsp;</td>
