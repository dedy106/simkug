...
class server_report_saku3_gl_rptYptLabaRugiGarBa extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select nama from ypt_ba where kode_ba='$kode_ba'";
		$rs = $dbLib->execute($sql);
		...
		$sql = "select a.kode_neraca,a.kode_fs,a.kode_lokasi,a.nama,a.tipe,a.level_spasi,
			...
			from exs_neraca_ba a
			where a.modul='L'  and a.kode_fs='$kode_fs' and a.periode='$periode'  and a.level_lap<=$lev and a.kode_ba='$kode_ba'
			order by a.rowindex ";
  ...
  <tr>
    <td class='lokasi_laporan' align='center'>$this->lokasi <br>$nama_ba</td>
  </tr>
  <tr>
