...
class server_report_saku3_gl_rptGlTbTahunKonsolSpm extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$jenis=$tmp[3];
		$trail=$tmp[4];
		$sql="exec sp_glma_tahun_dw_konsol_tmp '$kode_lokasi','$tahun','$nik_user' ";
...
";
    ...
    echo "<td  class='isi_laporan' align='right'><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenTbJejer('$row->kode_akun','$row->kode_lokasi','$periode01');\">".number_format($row->n01,0,",",".")."</a></td>";
	echo "<td  class='isi_laporan' align='right'><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenTbJejer('$row->kode_akun','$row->kode_lokasi','$periode02');\">".number_format($row->n02,0,",",".")."</a></td>";
	echo "<td  class='isi_laporan' align='right'><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenTbJejer('$row->kode_akun','$row->kode_lokasi','$periode03');\">".number_format($row->n03,0,",",".")."</a></td>";
	echo "<td  class='isi_laporan' align='right'><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenTbJejer('$row->kode_akun','$row->kode_lokasi','$periode04');\">".number_format($row->n04,0,",",".")."</a></td>";
	echo "<td  class='isi_laporan' align='right'><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenTbJejer('$row->kode_akun','$row->kode_lokasi','$periode05');\">".number_format($row->n05,0,",",".")."</a></td>";
	echo "<td  class='isi_laporan' align='right'><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenTbJejer('$row->kode_akun','$row->kode_lokasi','$periode06');\">".number_format($row->n06,0,",",".")."</a></td>";
	echo "<td  class='isi_laporan' align='right'><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenTbJejer('$row->kode_akun','$row->kode_lokasi','$periode07');\">".number_format($row->n07,0,",",".")."</a></td>";
	echo "<td  class='isi_laporan' align='right'><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenTbJejer('$row->kode_akun','$row->kode_lokasi','$periode08');\">".number_format($row->n08,0,",",".")."</a></td>";
	echo "<td  class='isi_laporan' align='right'><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenTbJejer('$row->kode_akun','$row->kode_lokasi','$periode09');\">".number_format($row->n09,0,",",".")."</a></td>";
	echo "<td  class='isi_laporan' align='right'><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenTbJejer('$row->kode_akun','$row->kode_lokasi','$periode10');\">".number_format($row->n10,0,",",".")."</a></td>";
	echo "<td  class='isi_laporan' align='right'><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenTbJejer('$row->kode_akun','$row->kode_lokasi','$periode11');\">".number_format($row->n11,0,",",".")."</a></td>";
	echo "<td  class='isi_laporan' align='right'><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenTbJejer('$row->kode_akun','$row->kode_lokasi','$periode12');\">".number_format($row->n12,0,",",".")."</a></td>";
	echo "<td  class='isi_laporan' align='right'><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenTbJejer('$row->kode_akun','$row->kode_lokasi','$periode13');\">".number_format($row->n13,0,",",".")."</a></td>";
	echo "<td  class='isi_laporan' align='right'><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenTbJejer('$row->kode_akun','$row->kode_lokasi','$periode14');\">".number_format($row->n14,0,",",".")."</a></td>";
	echo "<td  class='isi_laporan' align='right'><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenTbJejer('$row->kode_akun','$row->kode_lokasi','$periode15');\">".number_format($row->n15,0,",",".")."</a></td>";
	echo "<td  class='isi_laporan' align='right'><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenTbJejer('$row->kode_akun','$row->kode_lokasi','$periode16');\">".number_format($row->n16,0,",",".")."</a></td>";
	echo "</tr>";
