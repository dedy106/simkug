...
class server_report_saku3_gl_rptGlJurnalAudit extends server_report_basic
{
...
from (select kode_lokasi,no_bukti,no_dokumen,tanggal,kode_akun,keterangan,dc,kode_pp,nilai,modul
	from gldt $this->filter
	union all
	select kode_lokasi,no_bukti,no_dokumen,tanggal,kode_akun,keterangan,dc,kode_pp,nilai,modul
