...
class server_report_saku3_siswa_rptSisBayarDaftar2 extends server_report_basic
{
    ...
    <td><table width='100%'  border='0' cellspacing='2' cellpadding='1'>
      <tr>
        ...
        <td width='200' align='center'><table width='100%'  border='1' cellspacing='0' cellpadding='0' class='kotak'>
          ...
          <tr>
            <td align='center' class='istyle15'><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenDetailByr('$row->no_kas','$row->kode_lokasi');\">$row->no_kas</a></td>
          </tr>
          <tr>
