...
class server_report_saku3_siswa_rptSisPenilaian extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$kode_lokasi=$tmp[0];
		$periode=$tmp[1];
		$sql="select distinct a.no_bukti,a.kode_ta, b.nama as ta,a.kode_kelas,c.nama as kelas,a.kode_jenis,d.nama as jenis,a.kode_matpel,e.nama as matpel 
        from sis_nilai_m a 
        ...
        inner join sis_jenisnilai d on a.kode_jenis=d.kode_jenis and a.kode_lokasi=d.kode_lokasi and a.kode_pp=d.kode_pp
        inner join sis_matpel e on a.kode_matpel=e.kode_matpel and a.kode_lokasi=e.kode_lokasi and a.kode_pp=e.kode_pp
        inner join sis_nilai f on a.no_bukti=f.no_bukti and a.kode_lokasi=f.kode_lokasi and a.kode_pp=f.kode_pp
        inner join sis_siswa g on f.nis=g.nis and f.kode_lokasi=g.kode_lokasi and f.kode_pp=g.kode_pp
        $this->filter ";
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
            ...
            <tr >
                <td height='23' colspan='7' class='header_laporan'>
                    <table  border='0' cellspacing='2' cellpadding='1'>
                        ...
                        <tr>
                            <td width='150' class='header_laporan'>Mata Pelajaran</td>
                            <td width='360' class='header_laporan'>: $row->matpel</td>
                        </tr>	
                    </table>
                </td>
            </tr>
