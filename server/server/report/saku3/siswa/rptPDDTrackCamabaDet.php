...
class server_report_saku3_siswa_rptPDDTrackCamabaDet extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		left join ( select a.no_bukti,a.kode_lokasi,sum(a.nilai) as total 
					from aka_cd_d a
					where a.kode_akun='2141104' and a.dc='$dc'
		...
		echo $AddOnLib->judul_laporan("Detail Dokumen Vouching PDD Camaba",$this->lokasi,"");
		...
		{ 
			...
			inner join aka_cd_d b on a.no_bukti=b.no_bukti and a.kode_lokasi=b.kode_lokasi and b.kode_akun='2141104'
