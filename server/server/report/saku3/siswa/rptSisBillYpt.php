...
class server_report_saku3_siswa_rptSisBillYpt extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		$sql="select a.no_bill,a.keterangan,b.nis,c.nama,e.kode_jur,b.kode_kelas,a.periode,substring(a.periode,5,2) as bulan,c.kode_akt,b.no_ref,
...
from sis_bill_m a
inner join (select a.nis,a.kode_kelas,a.no_bill,a.kode_lokasi,a.no_ref,
			...
			from sis_bill_d a 
			$filter2
			group by a.nis,a.kode_kelas,a.no_bill,a.kode_lokasi,a.no_ref
...
order by b.kode_kelas,b.nis
 ...
 ";
  ...
  <tr bgcolor='#CCCCCC'>
	...
	<td width='150' align='center' class='header_laporan'>Bukti Refrensi</td>
