...
class server_report_saku3_siswa_rptSisPDDTrack extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		echo $AddOnLib->judul_laporan("Dokumen Vouching PDD",$this->lokasi,"");
