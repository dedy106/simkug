...
class server_report_saku3_siswa_rptMhsKartuCd extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		$sql="select a.nim,a.kode_lokasi,a.nama,c.nama as nama_jur,a.kode_lokasi,a.kode_jur,a.kode_akt
