...
class server_report_saku3_siswa_rptSisKwitansi extends server_report_basic
{	
	...
	function getHtml()
	{
        ...
        $sql="select a.no_kas as no_bukti,a.tanggal,convert(varchar,a.tanggal,103) as tgl,a.periode,a.ref1 as nis, d.kota,a.nilai,b.nama,a.keterangan,a.nik_app,c.nama as nama_app,c.jabatan as jab_app 
        from kas_m a 
        inner join sis_siswa b on a.ref1=b.nis and a.kode_lokasi=b.kode_lokasi and a.kode_pp=b.kode_pp 
        inner join karyawan c on a.nik_app=c.nik and a.kode_lokasi=b.kode_lokasi and a.kode_pp=b.kode_pp 
