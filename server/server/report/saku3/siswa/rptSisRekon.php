...
class server_report_saku3_siswa_rptSisRekon extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		isnull(b.n6,0) as n6, isnull(b.n7,0) as n7, isnull(b.n8,0) as n8, isnull(b.n9,0) as n9, isnull(b.total,0) as total ,isnull(b.n10,0) as n10
from sis_rekon_m a
