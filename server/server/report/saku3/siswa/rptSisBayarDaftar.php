...
class server_report_saku3_siswa_rptSisBayarDaftar extends server_report_basic
{
	...
	function getHtml()
	{
		...
		global $dbLib;
		$sql="select distinct a.no_bukti,a.kode_lokasi,b.tanggal from sis_cd_d a 
  ...
  <tr>
    <td><table width='800' border='1' cellspacing='0' cellpadding='0' class='kotak'>
	 ...
	 $sql1="select a.no_bukti, convert(varchar,b.tanggal,103) as tgl, c.nama,a.nis,a.nilai from sis_cd_d a
     inner join kas_m b on a.no_bukti=b.no_kas and a.kode_lokasi=b.kode_lokasi
     inner join sis_siswareg c on a.nis=c.no_reg and a.kode_lokasi=c.kode_lokasi and a.kode_pp=c.kode_pp
     where a.modul in ('CDINREG','CDINREGIB') and a.no_bukti = '$row->no_bukti' and a.kode_lokasi='$row->kode_lokasi'";
