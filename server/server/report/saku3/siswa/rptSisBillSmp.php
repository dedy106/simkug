...
class server_report_saku3_siswa_rptSisBillSmp extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		$tmp=explode("/",$this->filter2);
		$periode=$tmp[0];
		$sql="select a.no_bill,a.keterangan,b.nis,b.nis,c.kode_tingkat,c.nama,
...
order by b.nis
 ...
 ";
		...
		echo $AddOnLib->judul_laporan("tagihan siswa smp",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
