...
class server_report_saku3_siswa_rptSisTarif2 extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select b.id_bank,a.nis,a.kode_pp,a.kode_lokasi,b.kode_kelas,b.nama,a.kode_akt,$kolom_sql,a.total
...
order by a.nis ";
		...
		echo $AddOnLib->judul_laporan("laporan tarif siswa",$this->lokasi,"Periode ".$periode);
