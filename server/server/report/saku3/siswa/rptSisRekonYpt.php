...
class server_report_saku3_siswa_rptSisRekonYpt extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		isnull(b.n11,0) as n11,isnull(b.n12,0) as n12, isnull(b.n13,0) as n13, isnull(b.n14,0) as n14,isnull(b.n15,0) as n15,isnull(b.n19,0) as n19,
