...
class server_report_saku3_siswa_rptSisRekonYptTk extends server_report_basic
{	
	...
	function getHtml()
	{
	    ...
	    isnull(b.n1,0) as n1,isnull(b.n2,0) as n2, isnull(b.n3,0) as n3, isnull(b.n4,0) as n4, isnull(b.n5,0) as n5,isnull(b.n6,0) as n6,isnull(b.n7,0) as n7,isnull(b.n8,0) as n8,isnull(b.n9,0) as n9,isnull(b.n10,0) as n10,isnull(b.n11,0) as n11,isnull(b.n12,0) as n12,isnull(b.n13,0) as n13,isnull(b.n14,0) as n14,isnull(b.n15,0) as n15,isnull(b.n16,0) as n16,isnull(b.n17,0) as n17,isnull(b.n18,0) as n18,isnull(b.n19,0) as n19,isnull(b.n20,0) as n20,
...
inner join (select c.nis,a.no_rekon,c.kode_lokasi,a.kode_pp,
				   ...
				   sum(case when a.kode_param in ('DSP_TK') then a.nilai else 0 end) as n6,
				   sum(case when a.kode_param in ('ASUR_TK') then a.nilai else 0 end) as n7,
				   sum(case when a.kode_param in ('DU_TK') then a.nilai else 0 end) as n8,
				   sum(case when a.kode_param in ('EVA_TK') then a.nilai else 0 end) as n9,
				   sum(case when a.kode_param in ('JOB_TK') then a.nilai else 0 end) as n10,
				   sum(case when a.kode_param in ('KARYA_TK') then a.nilai else 0 end) as n11,
				   sum(case when a.kode_param in ('KOP_TK') then a.nilai else 0 end) as n12,
				   sum(case when a.kode_param in ('LAIN_TK') then a.nilai else 0 end) as n13,
				   sum(case when a.kode_param in ('LAIN2_TK') then a.nilai else 0 end) as n14,
				   sum(case when a.kode_param in ('MOS_TK') then a.nilai else 0 end) as n15,
				   sum(case when a.kode_param in ('OSIS_TK') then a.nilai else 0 end) as n16,
				   sum(case when a.kode_param in ('PAK_TK') then a.nilai else 0 end) as n17,
				   sum(case when a.kode_param in ('PRAK_TK') then a.nilai else 0 end) as n18,
				   sum(case when a.kode_param in ('ULUM_TK') then a.nilai else 0 end) as n19,
				   sum(case when a.kode_param in ('WIS_TK') then a.nilai else 0 end) as n20,
			...
			union all
			select c.nis,a.no_bukti as no_rekon,c.kode_lokasi,a.kode_pp,0 as n1,0 as n2,0 as n3,0 as n4,0 as n5,0 as n6,0 as n7,0 as n8,0 as n9,0 as n10,0 as n11,0 as n12,0 as n13,0 as n14,0 as n15,0 as n16,0 as n17,0 as n18,0 as n19,0 as n20,
...
order by c.nis
 ...
 if ($jenis=="Excell")
  ...
  <tr bgcolor='#CCCCCC'>
	...
	<td width='80' align='center' class='header_laporan'>PDD</td>
	<td width='80' align='center' class='header_laporan'>DSP_TK</td>
	<td width='80' align='center' class='header_laporan'>ASUR_TK</td>
	<td width='80' align='center' class='header_laporan'>DU_TK</td>
	<td width='80' align='center' class='header_laporan'>EVA_TK</td>
	<td width='80' align='center' class='header_laporan'>JOB_TK</td>
	<td width='80' align='center' class='header_laporan'>KARYA_TK</td>
	<td width='80' align='center' class='header_laporan'>KOP_TK</td>
	<td width='80' align='center' class='header_laporan'>LAIN_TK</td>
	<td width='80' align='center' class='header_laporan'>LAIN2_TK</td>
	<td width='80' align='center' class='header_laporan'>MOS_TK</td>
	<td width='80' align='center' class='header_laporan'>OSIS_TK</td>
	<td width='80' align='center' class='header_laporan'>PAK_TK</td>
	<td width='80' align='center' class='header_laporan'>PRAK_TK</td>
	<td width='80' align='center' class='header_laporan'>ULUM_TK</td>
	<td width='80' align='center' class='header_laporan'>WIS_TK</td>
	<td width='90' align='center' class='header_laporan'>Jumlah</td>
  </tr>";
		$n1=0;$n2=0;$n3=0;$n4=0;$n5=0;$n6=0;$n7=0;$n8=0;$n9=0;$total=0;$n10=0;$n11=0;$n12=0;$n13=0;$n14=0;$n15=0;$n16=0;$n17=0;$n18=0;$n19=0;$n20=0;$pdd=0;
