...
class server_report_saku3_siswa_rptSisSaldoCdSiswa2 extends server_report_basic
{	
...
//  ";
// // 22/$kode_lokasi/2020 union siswareg
$sql="select ''''+a.nis as nis,a.kode_lokasi,a.nama,a.kode_kelas,a.kode_akt,a.kode_pp,b.kode_jur,f.nama as nama_jur,
isnull(c.nilai,0) as so_awal,isnull(d.nilai,0) as debet,isnull(e.nilai,0) as kredit,
isnull(c.nilai,0)+isnull(d.nilai,0)-isnull(e.nilai,0) as so_akhir,a.ket
from (
	 select a.nis,a.nama,a.kode_kelas,a.kode_akt,a.kode_lokasi,a.kode_pp,'siswa' as ket
	 from sis_siswa a
	 union all
	 select a.no_reg,a.nama,'-' as kode_kelas,'-' as kode_akt,a.kode_lokasi,a.kode_pp,'siswareg' as ket
	 from sis_siswareg a
 )  a 
left join sis_kelas b on a.kode_kelas=b.kode_kelas and a.kode_lokasi=b.kode_lokasi and a.kode_pp=b.kode_pp
left join sis_jur f on b.kode_jur=f.kode_jur and b.kode_lokasi=f.kode_lokasi and b.kode_pp=f.kode_pp
inner join (select a.nis,a.kode_pp,a.kode_lokasi
	 from sis_cd_d a
	 where a.kode_lokasi='$kode_lokasi' and a.kode_pp='$kode_pp'
	 group by a.nis,a.kode_pp,a.kode_lokasi
...
left join (select a.nis,a.kode_lokasi,a.kode_pp,sum(case when a.dc='D' then nilai else -nilai end) as nilai
 from sis_cd_d a			
 inner join (
	 select a.nis,a.kode_lokasi,a.kode_pp
	 from sis_siswa a
	 union all
...
//  echo $sql;
	...
	// 	 )g on a.nis=g.nis and a.kode_lokasi=g.kode_lokasi and a.kode_pp=g.kode_pp
	// left join (
	// 	 select a.nis,a.kode_lokasi,a.kode_pp,'siswa' as ket,sum(case when a.dc='D' then nilai else -nilai end) as nilai
	// 	 from sis_cd_d a			
	// 	 inner join sis_siswa b on a.nis=b.nis and a.kode_lokasi=b.kode_lokasi and a.kode_pp=b.kode_pp 
	// 	 where a.kode_lokasi='$kode_lokasi' and a.periode<'$periode' and a.kode_pp='$kode_pp' and a.modul NOT LIKE '%CD%'
	// 	 group by a.nis,a.kode_lokasi,a.kode_pp
	// 	 union all
	// 	 select a.nis,a.kode_lokasi,a.kode_pp,'siswareg' as ket,sum(case when a.dc='D' then nilai else -nilai end) as nilai
	// 	 from sis_cd_d a			
	// 	 inner join sis_siswareg b on a.nis=b.no_reg and a.kode_lokasi=b.kode_lokasi and a.kode_pp=b.kode_pp 
	// 	 where a.kode_lokasi='$kode_lokasi' and a.periode<'$periode' and a.kode_pp='$kode_pp' and a.modul LIKE '%CD%'
	// 	 group by a.nis,a.kode_lokasi,a.kode_pp
	//  )c on a.nis=c.nis and a.kode_lokasi=c.kode_lokasi and a.kode_pp=c.kode_pp and a.ket=c.ket
	// left join (	 select a.nis,a.kode_lokasi,a.kode_pp,'siswa' as ket,sum(a.nilai) as nilai
	// 			 from sis_cd_d a			
	// 			 inner join sis_siswa b on a.nis=b.nis and a.kode_lokasi=b.kode_lokasi and a.kode_pp=b.kode_pp
	// 			 where a.kode_lokasi='$kode_lokasi' and a.dc='D' and a.periode='$periode' and a.kode_pp='$kode_pp' and a.modul NOT LIKE '%CD%'
	// 			 group by a.nis,a.kode_lokasi,a.kode_pp
	// 			 union all
	// 			 select a.nis,a.kode_lokasi,a.kode_pp,'siswareg' as ket,sum(a.nilai) as nilai
	// 			 from sis_cd_d a			
	// 			 inner join sis_siswareg b on a.nis=b.no_reg and a.kode_lokasi=b.kode_lokasi and a.kode_pp=b.kode_pp
	// 			 where a.kode_lokasi='$kode_lokasi' and a.dc='D' and a.periode='$periode' and a.kode_pp='$kode_pp' and a.modul LIKE '%CD%'
	// 			 group by a.nis,a.kode_lokasi,a.kode_pp
	//  )d on a.nis=d.nis and a.kode_lokasi=d.kode_lokasi and a.kode_pp=d.kode_pp and a.ket=d.ket
	// left join (	select a.nis,a.kode_lokasi,a.kode_pp,'siswa' as ket,sum(a.nilai) as nilai
	// 			 from sis_cd_d a			
	// 			 inner join sis_siswa b on a.nis=b.nis and a.kode_lokasi=b.kode_lokasi and a.kode_pp=b.kode_pp
	// 			 where a.kode_lokasi='$kode_lokasi' and a.periode='$periode' and a.dc='C' and a.kode_pp='$kode_pp' and a.modul NOT LIKE '%CD%'
	// 			 group by a.nis,a.kode_lokasi,a.kode_pp
	// 			 union all
	// 			 select a.nis,a.kode_lokasi,a.kode_pp,'siswareg' as ket,sum(a.nilai) as nilai
	// 			 from sis_cd_d a			
	// 			 inner join sis_siswareg b on a.nis=b.no_reg and a.kode_lokasi=b.kode_lokasi and a.kode_pp=b.kode_pp
	// 			 where a.kode_lokasi='$kode_lokasi' and a.periode='$periode' and a.dc='C' and a.kode_pp='$kode_pp' and a.modul LIKE '%CD%'
	// 			 group by a.nis,a.kode_lokasi,a.kode_pp
	// )e on a.nis=e.nis and a.kode_lokasi=e.kode_lokasi and a.kode_pp=e.kode_pp and a.ket=e.ket
	// $this->filter
	// order by a.kode_kelas,a.nis ";
