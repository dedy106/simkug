...
class server_report_saku3_siswa_rptCalonJurnalNon extends server_report_basic
{
	...
	function getHtml()
	{
		...
		global $dbLib;
		$sql="select a.no_ju,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.kode_lokasi,a.periode,b.nama,b.kota,a.no_dokumen
			from ju_m a
    ...
    <td><table width='100%'  border='0' cellspacing='2' cellpadding='1'>
      <tr>
        ...
        <td width='200' align='center'><table width='100%'  border='1' cellspacing='0' cellpadding='0' class='kotak'>
          ...
          <tr>
            <td align='center' class='istyle15'><a style='cursor:pointer;color:blue' onclick=\"window.parent.system.getResource(".$resource.").doOpenDetailByr('$row->no_ju','$row->kode_lokasi','$row->no_dokumen');\">$row->no_ju</a></td>
          </tr>
          <tr>
  ...
  <tr>
    <td><table width='800' border='1' cellspacing='0' cellpadding='0' class='kotak'>
	 ...
	 $sql1="select a.kode_akun,b.nama,a.kode_pp,a.nilai,a.keterangan,isnull(a.debet,0) as debet,isnull(a.kredit,0) as kredit
