...
class server_report_saku3_siswa_rptSisSaldoCdSiswa3 extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		$sql="select a.nim,a.kode_lokasi,a.nama,a.kode_akt,a.kode_jur,f.nama as nama_jur,
 ...
 inner join (select a.nim,a.kode_lokasi
             ...
             inner join ( 
                 ...
                 from trans_m a where a.form in ('CDIN','CDMUTMALA','CDMUTMULTI')
                 union all
                 select a.no_aju as no_bukti,a.kode_lokasi 
                 from it_aju_m a where a.no_ref1 in ('MALA')
