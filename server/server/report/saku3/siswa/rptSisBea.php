...
class server_report_saku3_siswa_rptSisBea extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		isnull(b.n11,0) as n11,isnull(b.n12,0) as n12, isnull(b.n13,0) as n13, isnull(b.n14,0) as n14,isnull(b.n15,0) as n15,isnull(b.n16,0) as n16, isnull(b.n17,0) as n17,isnull(b.n18,0) as n18,isnull(b.n19,0) as n19,isnull(b.n20,0) as n20,
...
inner join (select c.nis,a.no_rekon,c.kode_lokasi,a.kode_pp,
				   ...
				   sum(case when a.kode_param in ('PDD') then a.nilai else 0 end) as n20,
				   sum(a.nilai) as total
			from (select a.no_rekon, a.kode_lokasi,a.kode_pp,a.kode_param, a.nilai,a.nis,a.periode
				from sis_rekon_d a
				union all
				select a.no_bukti as no_rekon, a.kode_lokasi,a.kode_pp,'PDD' as kode_param, a.nilai,a.nis,a.periode 
				from sis_cd_d a
				where a.dc ='D'
			) a 
...
//  echo $sql;
		...
		echo $AddOnLib->judul_laporan("pembayaran beasiswa",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
  ...
  <tr bgcolor='#CCCCCC'>
	...
	<td width='90' align='center' class='header_laporan'>Jumlah</td>
		...
		$n1=0;$n2=0;$n3=0;$n4=0;$n5=0;$n6=0;$n7=0;$n8=0;$n9=0;$total=0;$n10=0;$n11=0;$n12=0;$n13=0;$n14=0;$n15=0;$n16=0;$n17=0;$n18=0;$n19=0;$n20=0;
