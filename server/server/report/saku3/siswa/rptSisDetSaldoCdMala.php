...
class server_report_saku3_siswa_rptSisDetSaldoCdMala extends server_report_basic
{	
    ...
    //                  from trans_m a where a.form in ('CDIN','CDMUTMALA')
    ...
    //  order by a.nim
    //         ";
            $sql = "select a.nim,a.kode_lokasi,a.nama,g.nilai as nilai_donor,g.ref1
        ...
        left join aka_mahasiswa d on e.nim=d.nim and e.kode_lokasi=d.kode_lokasi
