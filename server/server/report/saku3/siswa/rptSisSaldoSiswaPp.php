...
class server_report_saku3_siswa_rptSisSaldoSiswaPp extends server_report_basic
{	
...
left join (select y.kode_lokasi,y.kode_pp, 
			...
			where(x.kode_lokasi = '$kode_lokasi')and(x.periode < '$periode') $filter3		
...
order by a.kode_pp
 ";
  ...
  <tr align='center' bgcolor='#CCCCCC'>
	...
	<td width='200' rowspan='2' class='header_laporan'>Nama PP</td>
