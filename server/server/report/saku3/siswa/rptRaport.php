...
class server_report_saku3_siswa_rptRaport extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		$sql="select a.no_bukti, a.kode_ta,a.kode_sem,a.kode_kelas,c.nama as kls,a.nis,b.nama as ta,d.nama as sis
from sis_raport_m a
...
order by a.kode_ta";
		...
		echo $AddOnLib->judul_laporan("laporan raport siswa ",$this->lokasi," ".$AddOnLib->ubah_periode($periode));
  ...
  <tr bgcolor='#CCCCCC'>
	...
	<td width='100' align='center' class='header_laporan'>Mata Pelajaran</td>
    <td width='300' align='center' class='header_laporan'>Nilai</td>
