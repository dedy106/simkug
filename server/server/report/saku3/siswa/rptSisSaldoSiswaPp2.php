...
class server_report_saku3_siswa_rptSisSaldoSiswaPp2 extends server_report_basic
{	
    ...
    if(intval($bulan) == 1){
        ...
        $fil3 = " where(x.kode_lokasi = 'xx')"; //biar ga muncul
    }else{
        $thnblnseb = $tahun.$bulanSeb;
        // $fil3 = " where(x.kode_lokasi = '$kode_lokasi')and (x.periode_bill between '".$tahun."01' and '".$thnblnseb."') and (x.periode between '$periode_awal' and '".$periode_rekon."') ";
        // $fil3 = " where(x.kode_lokasi = '$kode_lokasi')and (x.periode_bill between '".$tahun."01' and '".$periode."') and (x.periode between '$periode_awal' and '".$thnblnseb."') ";
        $fil3 = " where(x.kode_lokasi = '$kode_lokasi')and (x.periode_bill between '".$tahun."01' and '".$thnblnseb."') and (x.periode = '".$periode_rekon."') ";
    }
    ...
    if($range == "="){
        ...
        // $filter_2 = " where(x.kode_lokasi = '$kode_lokasi')and(x.periode between '$periode_awal' and '$periode')  "; //tagihan bulan berjalan
        $filter_2 = " where(x.kode_lokasi = '$kode_lokasi')and(x.periode = '$periode')  "; 
        $filter_3 =  $fil3 ;// periode bayar sebelum
        // $filter_4 = " where(x.kode_lokasi = '$kode_lokasi')and (x.periode_bill <= '".$tahunSeb."12') $filter_rekon "; //filter tahun sebelum
        $filter_4 = " where(x.kode_lokasi = '$kode_lokasi')and (x.periode_bill < '".$tahun."01') and (x.periode = '".$periode_rekon."') ";
