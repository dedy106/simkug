...
class server_report_saku3_logistik_rptTerima extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		b.keterangan as ket_po,c.nama as nama_vendor,a.pengirim,date_format(a.tanggal,'%d/%m/%Y') as tgl_terima,a.nik_buat,d.nama as buat,a.pengirim
from log_terima_m a 
