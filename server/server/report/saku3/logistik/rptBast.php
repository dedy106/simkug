...
class server_report_saku3_logistik_rptBast extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		$sql="select a.no_hutang,a.keterangan,a.no_dokumen,a.tanggal,a.kode_vendor,a.akun_hutang,
       b.nama as nama_vendor,c.nama as nama_akun,date_format(a.tanggal,'%d/%m/%Y') as tgl
from hutang_m a
