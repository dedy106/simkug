...
class server_report_saku3_logistik_rptNego extends server_report_basic
{	
	...
	function getHtml()
	{
		...
		$sql="select a.no_pesan,date_format(i.tanggal,'%d/%m/%Y') as tanggal,i.no_dokumen,i.keterangan,a.kode_pp,b.nama as nama_pp,
		...
		h.kode_vendor,h.nama as nama_vendor,g.no_sph,i.no_nego
from log_pesan_m a
...
order by i.no_nego";
		...
		echo $AddOnLib->judul_laporan("klarifikasi dan negosiasi",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
