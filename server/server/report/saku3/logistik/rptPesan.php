...
class server_report_saku3_logistik_rptPesan extends server_report_basic
{
	...
	function getHtml()
	{
		...
		a.nik_ttd3,a.jab_ttd1,a.jab_ttd2,a.jab_ttd3,f.nama as nama1,g.nama as nama2,h.nama as nama3,a.kode_drk,d.nama as nama_drk,a.kode_lokasi
		from log_pesan_m a 
...
order by a.no_pesan";
		...
		<td align='right' class='isi_laporan'>".number_format($row1->total,0,",",".")."</td>
				...
				echo "
				<tr>
				<th align='right' colspan='8' class='header_laporan'>Jumlah Harga</th>
				<th align='right' class='header_laporan'>".number_format($total,0,",",".")."</th>
				</tr>
    ...
    <td align='center'><table border='0' cellspacing='2' cellpadding='1'>
      <tr>
        <td width='150' class='header_laporan'>NIK TTD 1 : </td>
				<td width='150' class='header_laporan'>NIK TTD 2 : </td>
				<td width='150' class='header_laporan'>NIK TTD 3 : </td>
