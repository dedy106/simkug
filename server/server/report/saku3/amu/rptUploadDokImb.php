...
class server_report_saku3_amu_rptUploadDokImb extends server_report_basic
{
        ...
        .badge-success{
          ...
          <script type='text/javascript'>
            ...
            var dataTable = $('#table-data').DataTable({
                ...
                'serverSide': true,
                'ajax': {
                    'url': '$root_ser/UploadDokImb.php?fx=getData',
            ...
            function getJenis(param,kode_jenis=null){
                $.ajax({
                    type: 'GET',
                    url: '$root_ser/UploadDokImb.php?fx=getJenis',
                    dataType: 'json',
            ...
            $('#sai_container').on('click','#btn-upload',function(e){
                ...
                $.ajax({
                    type: 'GET',
                    url: '$root_ser/UploadDokImb.php?fx=getUploadData',
                    dataType: 'json',
                    async:false,
            ...
            $('#saku-form').on('submit', '#form-tambah', function(e){
                ...
                $.ajax({
                    type: 'POST',
                    url: '$root_ser/UploadDokImb.php?fx=simpanDok',
                    dataType: 'json',
                    data: formData,
                    contentType: false,
                    cache: false,
