...
class server_report_saku3_amu_rptUploadKelAsset extends server_report_basic
{
      ...
      echo"
        ...
        th{
          ...
          var dataTable = $('#table-xjan').DataTable({
            ...
            'serverSide': true,
            'ajax': {
                'url': '$root_ser/UploadExcel.php?fx=getKelAsset',
          ...
          $('#nw_container').on('submit', '#nw_form_insert', function(e){
            ...
            $.ajax({
              type: 'POST',
              url: '$root_ser/UploadExcel.php?fx=simpanKelAssetTmp',
              dataType: 'json',
              data: formData,
              contentType: false,
              cache: false,
          ...
          $('#nw_container').on('click', '#saveBtn', function(e){
            ...
            var cek = $('#showValue').val();
              ...
              $.ajax({
                type: 'POST',
                url: '$root_ser/UploadExcel.php?fx=simpanKelAsset',
                dataType: 'json',
