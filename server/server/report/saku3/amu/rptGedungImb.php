...
class server_report_saku3_amu_rptGedungImb extends server_report_basic
{
	...
	function getHtml()
	{
        ...
        $sql="select a.id_gedung,a.kode_lokasi,convert(varchar, a.tanggal_perolehan, 101) as tanggal_perolehan,a.nama_gedung,a.alamat,a.nilai_perolehan, 
			   ...
			   i.no_imb,i.nama as nama_imb,convert(varchar, i.tgl_terbit, 101) as tgl_terbit
		from amu_gedung a
		...
		left join amu_imb i on a.id_gedung=i.id_gedung and a.kode_lokasi=i.kode_lokasi
        $this->filter
        ...
        echo "<table border='1' cellspacing='0' cellpadding='0' class='kotak' width='1000'>
                    <tr bgcolor='#CCCCCC'>
						...
						<td align='center' class='header_laporan'  width='150'>No IMB</td>
						<td align='center' class='header_laporan'  width='150'>Keterangan</td>
						<td align='center' class='header_laporan'  width='60'>Tanggal Terbit</td>
                    </tr>
                ...
                while ($row = $rs->FetchNextObject($toupper=false))
                {
					...
					echo "</td>
						...
						<td class='isi_laporan'>$row->no_imb</td>
						<td class='isi_laporan'>$row->nama_imb</td>
						<td class='isi_laporan'>$row->tgl_terbit</td>
                    </tr>
                    ";
                    $i++;
                }
