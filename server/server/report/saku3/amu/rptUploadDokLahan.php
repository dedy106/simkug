...
class server_report_saku3_amu_rptUploadDokLahan extends server_report_basic
{
        ...
        .badge-success{
          ...
          <script type='text/javascript'>
            ...
            var dataTable = $('#table-data').DataTable({
                ...
                'serverSide': true,
                'ajax': {
                    'url': '$root_ser/UploadDokLahan.php?fx=getData',
            ...
            function getJenis(param,kode_jenis=null){
                $.ajax({
                    type: 'GET',
                    url: '$root_ser/UploadDokLahan.php?fx=getJenis',
                    dataType: 'json',
            ...
            $('#sai_container').on('click','#btn-upload',function(e){
                ...
                $.ajax({
                    type: 'GET',
                    url: '$root_ser/UploadDokLahan.php?fx=getUploadData',
                    dataType: 'json',
                    async:false,
            ...
            $('#input-dok').on('click', '.hapus-dok2', function(){
                if(confirm('Sistem akan menghapus file dari server. Apakah anda ingin menghapus data ini? ')){
                    ...
                    $.ajax({
                        type: 'DELETE',
                        url: '$root_ser/UploadDokLahan.php',
                        dataType: 'json',
            ...
            $('#saku-form').on('submit', '#form-tambah', function(e){
                ...
                $.ajax({
                    type: 'POST',
                    url: '$root_ser/UploadDokLahan.php?fx=simpanDok',
                    dataType: 'json',
                    data: formData,
                    contentType: false,
                    cache: false,
