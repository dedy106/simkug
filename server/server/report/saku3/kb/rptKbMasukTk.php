...
class server_report_saku3_kb_rptKbMasukTk extends server_report_basic
{
...
order by a.kode_akun";
		...
		if ($jenis=="Range")
		{
			echo $AddOnLib->judul_laporan("laporan realisasi penerimaan sekolah (kas a)",$this->lokasi,"Periode ".$AddOnLib->ubah_periode($periode)." Sd ".$AddOnLib->ubah_periode($periode2));
			$sql2=" and a.periode between '$periode' and '$periode2' ";
		}
		else
		{
			echo $AddOnLib->judul_laporan("laporan realisasi penerimaan sekolah (kas a)",$this->lokasi,"Periode ".$AddOnLib->ubah_periode($periode));
