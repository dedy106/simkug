...
class server_report_saku3_kb_rptKbBukuBankYks extends server_report_basic
{
  ...
  from kas_j a 
	 ...
	 order by a.tanggal  ";
			*/
			 ...
			 b.keterangan,isnull(b.debet,0) as debet,isnull(b.kredit,0) as kredit,b.kode_pp,b.kode_drk
from (select a.no_kas as no_bukti,a.kode_lokasi,a.kode_bank
	  from kas_j a
	  where a.periode='$periode' and a.kode_lokasi='$kode_lokasi' and a.kode_bank='$row->kode_rek' $var_periode 
	  group by a.no_kas,a.kode_lokasi,a.kode_bank
	  )a
inner join (select a.no_kas as no_bukti,a.no_dokumen,a.tanggal,a.kode_lokasi,a.keterangan,a.kode_akun,a.periode,a.kode_drk,a.kode_pp,
		    ...
		    where a.periode='$periode' and a.kode_lokasi='$kode_lokasi' and a.kode_bank<>'$row->kode_rek'
		   )b on a.no_bukti=b.no_bukti and a.kode_lokasi=b.kode_lokasi
where a.kode_bank='$row->kode_rek' and a.kode_lokasi='$kode_lokasi'
					order by b.tanggal ";
