...
class server_report_saku3_kb_rptKbJurnalPp extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.no_kas,a.no_kas as no_bukti,a.no_dokumen,c.nama,date_format(b.tanggal,'%d/%m/%Y') as tanggal,
  ...
  <tr bgcolor='#CCCCCC'>
    ...
    <td valign='middle' class='isi_laporan'>$row->no_kas</td>
