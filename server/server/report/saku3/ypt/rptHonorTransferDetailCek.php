...
class server_report_saku3_ypt_rptHonorTransferDetailCek extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select distinct a.no_cek,a.kode_lokasi,b.nama as nama_buat,c.nama as nama_bdh,e.nama as nama_fiat,g.nama as nama_app2,
...
inner join it_spb_m c on a.no_spb=c.no_spb and a.kode_lokasi=c.kode_lokasi
where c.no_cek='$row->no_cek' and isnull(a.form,'-')<>'HONOR'
union all
...
where d.no_cek='$row->no_cek' and isnull(a.form,'-')='HONOR'
