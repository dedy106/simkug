...
class server_report_saku3_ypt_rptAppDokFisik extends server_report_basic
{
        ...
        th{
                    ...
                    <div class='col-md-12' style='margin-bottom: 10px;box-shadow: 0px 0px 1px white;border-bottom: 1px solid #ece7e7;'>
                     <button type='submit' class='btn btn-primary' style='margin-bottom: 10px;' id='validate'><i class='fa fa-save' ></i> Simpan</button>
                      ...
                      <div class='col-md-12'>
                        ...
                        <div class='row'>
                            <div class='form-group'>
                                <label class='control-label col-sm-1'>User Input</label>
                                <div class='col-sm-3' style='margin-bottom:5px;'>
                                    <input name='user_input' type='text' max-length='50' class='form-control' required id='user_input' value=''>
                                </div>
                            </div>
                        </div>
                        <div class='row'>
                            <div class='form-group'>
                                <label class='control-label col-sm-1'>NIK Penerima</label>
                ...
                success:function(result){    
                    if(result.status){
                        if(typeof result.daftar !== 'undefined' && result.daftar.length>0){
                            ...
                            control.setValue(result.nik_terima);
                            $('#user_input').val(result.user_input);
          ...
          function loadDok(){
              ...
              $.ajax({
                ...
                dataType: 'json',
                data: {'kode_lokasi':'$kode_lokasi','no_aju':no_aju,'nik':'".$_SESSION['userLog']."'},
                success:function(result){
                  if(result.status){
