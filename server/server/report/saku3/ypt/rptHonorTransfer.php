...
class server_report_saku3_ypt_rptHonorTransfer extends server_report_basic
{
...
order by a.no_spb ";
		...
		{
			echo $AddOnLib->judul_laporan("YAYASAN PENDIDIKAN TELKOM","PEMBAYARAN TRANSFER",$row->no_spb);
...
union all
select a.no_spb,'-' as no_aju,a.kode_lokasi,case when substring(b.no_rek,1,1)='0' then ''''+b.no_rek else ''''+b.no_rek end as no_rek,sum(b.nilai) as nilai,b.nama_rek,'Honor Dosen LB' as berita,b.bank
from it_aju_m a
inner join it_aju_rek b on a.no_aju=b.no_aju and a.kode_lokasi=b.kode_lokasi
left join it_dosen c on b.keterangan=c.kode_dosen and b.kode_lokasi=c.kode_lokasi
where a.no_spb='$row->no_spb' and isnull(a.form,'-')='HONOR'
group by a.no_spb,a.kode_lokasi,b.no_rek,b.nama_rek,b.bank
