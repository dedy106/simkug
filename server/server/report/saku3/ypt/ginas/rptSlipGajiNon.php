...
class server_report_saku3_ypt_ginas_rptSlipGajiNon extends server_report_basic
{	
...
where  a.no_gaji='$row->no_gaji'  and a.nik='$row->nik' and a.kode_param in ('NGPOK','NTMK','NTJAB','NLBR')
order by b.no_urut";
...
from hr_gaji_d a
inner join hr_gaji_param b on a.kode_param=b.kode_param and a.kode_lokasi=b.kode_lokasi
where a.no_gaji='$row->no_gaji'  and a.nik='$row->nik' and a.kode_param in ('NLAIN','NGINS','NPYROL','NBPJS')
order by b.no_urut";
