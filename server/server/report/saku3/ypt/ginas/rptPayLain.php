...
class server_report_saku3_ypt_ginas_rptPayLain extends server_report_basic
{
...
order by b.nik";
		...
		echo $AddOnLib->judul_laporan("DAFTAR PAYROLL BANK LAIN",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
