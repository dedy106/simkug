...
class server_report_saku3_ypt_logistik_rptPesanLog extends server_report_basic
{
	...
	function getHtml()
	{
		...
		a.kode_akun,c.nama as nama_akun,e.nama as nama_lokasi,a.lok_proses,a.maksud,a.aspek,
		f.no_app,convert(varchar,a.tanggal,103) as tgl_app
from log_pesan_m a 
inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi
inner join masakun c on a.kode_akun=c.kode_akun and a.kode_lokasi=c.kode_lokasi 
inner join lokasi e on a.lok_proses=e.kode_lokasi 
inner join app_d f on a.no_pesan=f.no_bukti and a.kode_lokasi=f.kode_lokasi and f.status='1'
inner join app_m g on f.no_app=g.no_app and f.kode_lokasi=g.kode_lokasi 
$this->filter
order by a.no_pesan";
		...
		<tr>
		  <td class='lokasi_laporan2'><div align='center'>Justifikasi Pengadaan</div></td>
		</tr>
	  </tbody></table>";
			...
			<table border='0' cellspacing='2' cellpadding='1'>
			  ...
			  <tr>
				<td><table border='0' cellspacing='2' cellpadding='1'>
				  ...
				  <tr>
					<td width='100' class='header_laporan'>No App </td>
					<td width='496' class='header_laporan'>:&nbsp;$row->no_app</td>
					</tr>
				  <tr>
					<td width='100' class='header_laporan'>Tanggal App </td>
					<td width='496' class='header_laporan'>:&nbsp;$row->tgl_app</td>
					</tr>
