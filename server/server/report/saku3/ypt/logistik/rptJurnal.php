...
class server_report_saku3_ypt_logistik_rptJurnal extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.no_hutang,a.no_dokumen,a.kode_lokasi,a.periode,a.tanggal,convert(varchar(20),a.tanggal,103) as tgl,a.keterangan,a.kode_lokasi,
		a.nik_user,a.nik_app,b.nama as nama_buat,c.nama as nama_setuju,d.kota
from hutang_m a
...
left join karyawan c on a.nik_app=c.nik and a.kode_lokasi=c.kode_lokasi 
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			echo "<table border='0' cellspacing='2' cellpadding='1'>
			  <tr>
				<td align='center' class='header_laporan'>JURNAL HUTANG ASSET</td>
			  </tr>
			  <tr>
