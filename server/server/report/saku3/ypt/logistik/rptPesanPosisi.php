...
class server_report_saku3_ypt_logistik_rptPesanPosisi extends server_report_basic
{
	...
	function getHtml()
	{
		...
		j.no_pb,j.no_agenda,convert(varchar,j.tanggal,103) as tgl_pb,isnull(f.nilai,0) as nilai_po,a.nilai - isnull(f.nilai,0) as sisa_juskeb
from log_pesan_m a
...
$this->filter  order by a.tanggal desc";
		...
		echo "<table border='1' cellspacing='0' cellpadding='0' class='kotak' width='1670'>
   <tr bgcolor='#CCCCCC'>
