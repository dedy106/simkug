...
class server_report_saku3_ypt_logistik_rptAgendaLogPos extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.kode_lokasi,a.no_aju,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.kode_pp,b.nama as nama_pp,a.nilai,a.kode_drk,j.nama as nama_drk,a.npajak,a.nilai as bruto,
...
$this->filter order by a.no_aju";
		...
		echo $AddOnLib->judul_laporan("posisi pertanggungan logistik",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
