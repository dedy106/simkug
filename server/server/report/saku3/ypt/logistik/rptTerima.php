...
class server_report_saku3_ypt_logistik_rptTerima extends server_report_basic
{	
...
order by a.no_terima";
		...
		// echo $AddOnLib->judul_laporan("penerimaan barang / jasa",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
    echo "<table cellspacing='0' cellpadding='0' border='0' style='margin-bottom:20px;width:800px'>
		...
		<tr>
		  <td class='lokasi_laporan2'><div align='center'>Penerimaan Barang / Jasa</div></td>
		</tr>
		<tr>
