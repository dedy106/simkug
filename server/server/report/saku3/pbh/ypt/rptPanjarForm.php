...
class server_report_saku3_pbh_ypt_rptPanjarForm extends server_report_basic
{
    ...
    $kode_lokasi = $tmp[1];
		...
		a.nik_user,a.nik_app,f.nama as nama_user,g.nama as nama_app,substring(a.periode,1,4) as tahun
from pbh_pb_m a
inner join ptg_j i on a.no_pb=i.no_ptg and a.kode_lokasi=i.kode_lokasi
...
$this->filter and i.dc='D' order by a.no_pb";
		*/
		$sql="select a.no_pb,a.kode_lokasi,convert(varchar,a.tanggal,103) as tgl,a.keterangan,a.nilai,a.nik_user,a.tanggal,
		  ...
		  b.no_pj,c.nilai as nilai_pj,c.nilai-a.nilai as sisa
      from pbh_pb_m a
      left join karyawan f on a.nik_user=f.nik and a.kode_lokasi=f.kode_lokasi
      left join karyawan g on a.nik_app=g.nik and a.kode_lokasi=g.kode_lokasi
      left join lokasi h on a.kode_lokasi=h.kode_lokasi
...
$root_app="http://".$_SERVER['SERVER_NAME']."/web/server/pbh/";
  ...
  <tr>
    <td><table width='100%'  border='0'>
	  ...
	  <tr>
        <td>Jumlah Panjar (+)</td>
        <td>: ".number_format($row->nilai_pj,0,",",".")." </td>
      </tr>
	  <tr>
...
//     "<tr>
//         <td ><table  border='1' cellspacing='0' cellpadding='0' class='kotak' width='783'>
//         <tr>
...
//         </tr>";
//         $sql2="select a.kode_akun,a.kode_lokasi,a.kode_drk,a.kode_pp,
...
//          <td class='isi_laporan'>$row2->kode_pp</td>
//      <td class='isi_laporan'>$row2->nama_pp</td>
//          <td class='isi_laporan'>$row2->kode_drk</td>
//          <td class='isi_laporan'>$row2->nama_drk</td>
...
order by no_rek";
  ...
  <tr>
    <td><table width='800' border='1' cellspacing='0' cellpadding='0' class='kotak'>
      ...
      where a.no_ptg='$row->no_pb' and a.kode_lokasi='$row->kode_lokasi' and a.dc='D'
      union all
      select a.kode_akun,b.nama,a.keterangan,a.kode_pp,a.kode_drk,a.nilai*-1 as nilai
      from ptg_j a
      inner join masakun b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi
      where a.no_ptg='$row->no_pb' and a.kode_lokasi='$row->kode_lokasi' and a.dc='C' and a.jenis='PAJAK'
      order by a.kode_akun";
      ...
      echo "<tr>
        ...
        <td class='isi_bukti'>$row2->kode_akun</td>
        <td class='isi_bukti'>$row2->kode_pp</td>
        <td class='isi_bukti'>$row2->kode_drk</td>
        <td class='isi_bukti'>$row2->keterangan</td>
  ...
  <tr>
    <td><table width='800' border='0' cellspacing='2' cellpadding='1'>
      <tr>
        <td width='400' class='isi_bukti'>PERTANGGUNGAN :</td>
	  ...
	  while ($row3 = $rs3->FetchNextObject($toupper=false))
		{
          echo "<tr>
            <td class='isi_bukti' align='center'>$j</td>
            <td class='isi_bukti'>$row3->kode_akun</td>
           <td class='isi_bukti'>$row3->nama</td>
             <td class='isi_bukti' align='right'>".number_format($row3->nilai,0,",",".")."</td>
          </tr>";
			$j+=1;
		}
		  
          echo "<tr>
            <td colspan='3' align='center'>TOTAL PERTANGGUNGAN</td>
            <td class='isi_bukti' align='right'>".number_format($row->nilai,0,",",".")."</td>
          </tr>
        </table></td>
