...
class server_report_saku3_pbh_ypt_rptPanjarAjuPosYpt extends server_report_basic
{
...
$this->filter order by a.no_pb ";
		...
		echo $AddOnLib->judul_laporan("posisi pengajuan Bayar",$this->lokasi,"PERIODE ".$AddOnLib->ubah_periode($periode));
