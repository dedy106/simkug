...
class server_report_saku3_pbh_ypt_rptPanjarAju extends server_report_basic
{
  ...
  <tr>
    <td height='30' align='center' valign='middle' class='judul_bukti'>FORMULIR PENGAJUAN PANJAR</td>
  </tr>
  <tr>
	<td align='right' >
 ...
 from panjar_j a
 where a.no_pj='$row->no_pb' and a.kode_lokasi='$row->kode_lokasi'
