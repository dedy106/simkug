...
class server_report_saku3_pbh_rptIfKartu extends server_report_basic
{
...
union all
select c.no_kas as no_bukti,c.tanggal,c.kode_lokasi,c.keterangan,0 as debet,a.nilai as kredit,date_format(b.tanggal,'%d/%m/%Y') as tgl,4 as nu
from if_nik a
