...
class server_report_saku3_fitnes_rptJurnalJual extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql="select a.no_kas,a.no_dokumen,a.kode_lokasi,a.periode,a.tanggal,date_format(a.tanggal,'%d/%m/%Y') as tanggal1,
		a.keterangan,a.kode_lokasi
from kas_m a $this->filter
order by no_kas ";
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			echo "<table border='0' cellspacing='2' cellpadding='1'>
			  <tr>
				<td align='center' class='header_laporan'>JURNAL PENJUALAN VOUCHER</td>
			  </tr>
			  <tr>
