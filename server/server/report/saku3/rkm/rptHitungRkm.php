...
class server_report_saku3_rkm_rptHitungRkm extends server_report_basic
{
	...
	function getHtml()
	{
		...
		$sql=" select a.kode_akun,a.kode_pp,a.kode_ip,b.nama as nama_akun,c.nama as nama_pp,d.nama as nama_ip, 
					...
					isnull(f.n1,0)+isnull(g.n1,0) as n1,isnull(f.n2,0)+isnull(f.n2,0) as n2,isnull(f.n3,0)+isnull(f.n3,0) as n3,isnull(f.n4,0)+isnull(f.n4,0) as n4,
		...
		echo $AddOnLib->judul_laporan("perhitungan rkm",$this->lokasi,"PERIODE ".$tahun);
		echo "<table width='1600' border='1' cellspacing='0' cellpadding='0' class='kotak' width='1200'>
<tr bgcolor='#CCCCCC'>
	...
	<td width='50' class='header_laporan' align='center' >Kode Tujuan Strategis</td>
	<td width='150' class='header_laporan' align='center' >Nama Tujuan Strategis</td>
	<td width='50'  class='header_laporan' align='center' >Kode Sasaran Strategis</td>
    <td width='150' class='header_laporan' align='center' >Nama Sasaran Strategis</td>
    <td width='70'  class='header_laporan' align='center' >Kode IP</td>
    <td width='200' class='header_laporan' align='center' >Nama IP </td>
	<td width='90' class='header_laporan' align='center' >RKA Target</td>
	<td width='90' class='header_laporan' align='center' >Realisasi Anggaran</td>
	<td width='90' class='header_laporan' align='center' >Penyerapan Anggaran</td>
	<td width='90' class='header_laporan' align='center' >Score</td>
	<td width='90' class='header_laporan' align='center' >Pelaksanaan Program</td>
  </tr>";
		...
		while ($row = $rs->FetchNextObject($toupper=false))
		{
			...
			$tw2=($row->agg_tw2/$row->n2)*100;
			$twn2=($row->n2/$row->agg_tw2)*100;
			if ($tw2<=50) 
			{
				$skor2=50;
			}
  ...
  <td class='isi_laporan' align='right'>".number_format($tw2,2,',','.')."</td>
  <td class='isi_laporan' align='right'>".number_format($skor2,0,',','.')."</td>
  <td class='isi_laporan' align='right'>".number_format($twn2,0,',','.')."</td>
</tr>";
