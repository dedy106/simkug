...
class server_report_fa_rptFaSusutCepat
{
	protected $caption;
	protected $filter;
	protected $filter2;
...
inner join pp e on a.kode_pp=e.kode_pp and a.kode_lokasi=e.kode_lokasi ".$this->filter;
	...
	function getHtml()
	{
		...
		$tmp=explode("/",$this->filter2);
		$tahun=substr($tmp[0],0,4);
		$sql="select a.periode,a.tanggal,a.kode_lokasi,a.no_fasusut,a.no_dokumen,a.kode_curr,a.kurs,a.nik_buat,a.nik_setuju,a.kode_drk,a.keterangan,
       b.nama as nama_buat,c.nama as nama_setuju,d.nama as nama_drk
from fasusut_m a
inner join karyawan b on a.nik_buat=b.nik and a.kode_lokasi=b.kode_lokasi
inner join karyawan c on a.nik_setuju=c.nik and a.kode_lokasi=c.kode_lokasi
left join drk d on a.kode_drk=d.kode_drk and a.kode_lokasi=d.kode_lokasi and d.tahun='$tahun'
 ".$this->filter." order by a.no_fasusut";
		...
		$html=$AddOnLib->judul_laporan("laporan percepatan asset",$this->lokasi,$AddOnLib->ubah_periode($periode));
  ...
  <tr>
    <td colspan='9' style='padding:5px'><table width='622' border='0' cellspacing='2' cellpadding='1'>
      ...
      <tr>
        <td class='header_laporan'>No Susut </td>
        <td class='header_laporan'>:&nbsp;$row->no_fasusut</td>
        </tr>
	  <tr>
  ...
  <tr bgcolor='#CCCCCC'>
    ...
    <td width='80' align='center' class='header_laporan'>Kode Dept </td>
    ...
    <td width='100' align='center' class='header_laporan'>Nilai Susut </td>
    
  </tr>";
  
	  $sql1="select a.no_fa,b.barcode,b.nama,a.kode_pp,a.kode_akun,a.akun_bp,a.akun_ap,a.nilai
from fasusut_d a
inner join fa_asset b on a.no_fa=b.no_fa and a.kode_lokasi=b.kode_lokasi
where a.no_fasusut='$row->no_fasusut' and a.kode_lokasi='$row->kode_lokasi'
order by a.kode_akun ";
    ...
    <td  class='isi_laporan'>$row1->akun_bp</td>
    <td  class='isi_laporan'>$row1->akun_ap</td>
