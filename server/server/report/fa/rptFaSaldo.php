...
class server_report_fa_rptFaSaldo
{
	protected $caption;
	protected $filter;
	protected $rows;
	...
	function getHtml()
	{
		...
		$periode=$tmp[1];
		$nik_user=$tmp[0];
		$sql = "select kode_fa,nama,n1,n2,n3,n4,n5 from fa_tmp ".$this->filter.
		...
		$html=$AddOnLib->judul_laporan("laporan saldo asset",$this->lokasi,$AddOnLib->ubah_periode($periode));
