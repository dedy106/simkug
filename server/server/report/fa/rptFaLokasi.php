...
class server_report_fa_rptFaLokasi
{
	protected $caption;
	protected $filter;
	protected $rows;
	...
	function getTotalPage()
	{
		...
		$sql = "select count(kode_lokfa) from fa_lokasi ".$this->filter;
	...
	{
		global $dbLib;
		$sql = "select kode_lokasi,kode_lokfa,fn_spasi(nama,level_spasi) as nama from fa_lokasi ".$this->filter.
				" order by kode_lokfa ";
		...
		$html=$AddOnLib->judul_laporan("laporan lokasi asset",$this->lokasi,$AddOnLib->ubah_periode($periode));
