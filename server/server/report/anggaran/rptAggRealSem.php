...
class server_report_anggaran_rptAggRealSem
{
	protected $caption;
	protected $filter;
	protected $filter2;
	...
	function getHtml()
	{
		...
		$html=$AddOnLib->judul_laporan("laporan realisasi komparasi anggaran",$this->lokasi,$AddOnLib->ubah_periode($periode));
		$html.="<table width='1120' border='1' cellpadding='0' cellspacing='0' bordercolor='#111111' class='kotak'>
<tr>
