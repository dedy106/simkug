...
class server_report_anggaran_rptBbMta
{
	protected $caption;
	protected $filter;
	protected $filter2;
...
from anggaran_d a
inner join masakun b on a.kode_akun=b.kode_akun and b.jenis='$jenis' and a.kode_lokasi=b.kode_lokasi and(substring(b.tahun,1,4) = '$tahun')
...
order by a.kode_akun";
		...
		echo $AddOnLib->judul_laporan("laporan buku besar mta",$this->lokasi,$tahun);
  ...
  <tr bgcolor='#CCCCCC'>
    ...
    <td width='70' class='header_laporan' align='center'>Kode RKM</td>
...
";
			...
			{
				$tabel ="(select * from angg_d where kode_lokasi='$row->kode_lokasi' and substring(periode,1,4)='$tahun' and kode_akun='$row->kode_akun' ".$kode_pp.$kode_drk.$periode." )";
			}
			else
			{
