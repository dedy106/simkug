...
class server_report_anggaran_rptRkap
{
	protected $caption;
	protected $filter;
	protected $filter2;
	...
	function getHtml()
	{
		...
		$tahun=$tmp[1];
		$level_lap=$tmp[2];
		$sql = "select kode_neraca,kode_fs,kode_lokasi,nama,tipe,level_spasi,case jenis_akun when  'Pendapatan' then -n1 else n1 end as n1,
...
order by rowindex ";
		...
		$html=$AddOnLib->judul_laporan("laporan rkap anggaran",$this->lokasi,$tahun);
		$html.="<table border='1' cellspacing='0' cellpadding='0' class='kotak'>
  <tr bgcolor='#CCCCCC'>
    <td width='400' rowspan='2'  class='header_laporan'><div align='center'>Deskripsi</div></td>
