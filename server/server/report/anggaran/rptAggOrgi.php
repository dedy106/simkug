...
class server_report_anggaran_rptAggOrgi
{
	protected $caption;
	protected $filter;
	protected $filter2;
...
inner join karyawan b on a.nik_buat=b.nik and a.kode_lokasi=b.kode_lokasi
inner join karyawan c on a.nik_setuju=c.nik and a.kode_lokasi=c.kode_lokasi
".$this->filter." and a.jenis='ORGI' order by a.no_agg";
		error_log($sql);
  ...
  <tr>
    <td colspan='12' style='padding:5px'><table width='622' border='0' cellspacing='2' cellpadding='1'>
      <tr>
        <td colspan='2' class='judul_bukti' align='center'>ANGGARAN BARU</td>
        </tr>
	  <tr>
