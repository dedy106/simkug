...
class server_report_anggaran_rptRKM
{
	protected $caption;
	protected $filter;
	protected $rows;
	...
	{
		global $dbLib;
		$sql = "select kode_drk,nama,jenis_akun,modul,level_spasi from drk ".$this->filter." order by kode_drk ";
		...
		$html=$AddOnLib->judul_laporan("laporan RKM",$this->lokasi,$AddOnLib->ubah_periode($periode));
		...
		$html.="<table border='1' cellspacing='0' cellpadding='0' class='kotak'>
				<tr bgcolor='#CCCCCC'>
				 ...
				 <td width='100' class='header_laporan'><div align='center'>Jenis Akun</div></td>
