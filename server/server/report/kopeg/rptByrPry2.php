...
class server_report_kopeg_rptByrPry2
{
	protected $caption;
	protected $filter;
	protected $rows;
	...
	function getHtml()
	{
		...
		while (!$page->EOF)
		{
			...
			$html=$AddOnLib->judul_laporan("LAPORAN DAFTAR PENERIMAAN PEMBAYARAN PROYEK<br />NO. KWITANSI : ".$rs->no_bukti,$this->filter2,$AddOnLib->ubah_periode($periode));
