...
class server_report_kopeg_rptSpbHb2
{
	protected $caption;
	protected $filter;
	protected $rows;
	...
	function getTotalPage()
	{
		...
		$sql = "select count(distinct a.no_spb) from spb_m a ".$this->filter." and a.modul='SPB' and a.jenis='APBANK' ";
	...
	function getHtml()
	{
		$sql0="select distinct a.no_spb from spb_m a ".$this->filter." and a.modul='SPB' and a.jenis='APBANK' ";
		...
		while (!$page->EOF)
		{
			$sql = "select a.no_spb,a.no_dokumen,a.keterangan as ket1,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.nilai as tot,
				...
				" and a.no_spb='".$page->fields[0]."' and a.modul='SPB' and a.jenis='APBANK' order by a.no_spb,b.dc desc ";
			...
			$html.=	"<table width='750' border='0' align='center' cellpadding='0' cellspacing='0'>
					  <tr>
					    <td class='istyle12' align='center' style='padding-bottom:4px;'>LAMPIRAN SPB HUTANG BANK</td>
					  </tr>
					  <tr>
					      ...
					      <tr>
					        <td height='149'><table width='100%' border='0' cellspacing='0' cellpadding='3'>
					          ...
					          <tr>
					            ...
					            <td class='istyle14'>Nilai Hutang</td>
					            <td class='istyle14'>:</td>
					...
					while ($dt = $data->FetchNextObject($toupper=false))
					{
					  ...
					  <tr>
					    <td class='istyle14' style='padding-top:4px;'>&nbsp;&nbsp;&nbsp;&nbsp;Nilai Hutang : ".$AddOnLib->terbilang($rs->tot)."</td>
					  </tr>
					  <tr>
					    <td>&nbsp;</td>
					  </tr>
