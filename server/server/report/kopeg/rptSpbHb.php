...
class server_report_kopeg_rptSpbHb
{
	protected $caption;
	protected $filter;
	protected $rows;
	...
	function getHtml()
	{
		...
		while (!$page->EOF)
		{
			$sql = "select a.no_spb,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.akun_hutang,a.kode_terima,a.nik_buat,a.nik_setuju,(a.nilai+a.nilai_pot) as nilai,a.nilai_pot,a.nilai as tot,c.alamat,c.bank,c.no_rek,
				...
				, case when (a.nilai) >= 5000000 then g.nama else '-' end as gm, h.nama as setuju,   i.initial as nmunit
				from spb_m a
				...
				" and a.no_spb='".$page->fields[0] ."' and a.modul='SPB' and a.jenis='APBANK' order by a.no_spb ";
