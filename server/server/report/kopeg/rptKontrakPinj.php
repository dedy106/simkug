...
class server_report_kopeg_rptKontrakPinj
{
	protected $caption;
	protected $filter;
	protected $rows;
	...
	function getHtml()
	{
		...
		while (!$page->EOF)
		{
			...
			$sql = "select a.kode_agg,upper(b.nama) as nm,a.no_kontrak,date_format(now(),'%W/%M/%d/%m/%Y/%Y%m') as tglskrg,a.nilai,
				a.nilai as nominal, a.nilai_asur, a.status_bayar,
				...
				" and a.no_pinj='".$page->fields[0]."' group by a.no_pbrg order by a.no_pinj ";
			...
			$html.=	"<table width='680' border='0' align='center' cellpadding='2' cellspacing='0'>
					  <tr>
					    <td colspan='3' align='center' class='istyle16'>PERJANJIAN PEMBIAYAAN</td>
					  </tr>
					  <tr>
					    <td colspan='3' align='center' class='istyle16'>AL-MURABAHAH</td>
					  </tr>					  
					  <tr>
					    <td height='32' colspan='3' align='center' class='istyle16'>NOMOR : ".$rs->no_kontrak."</td>
					  </tr>
					  <tr>
					    <td height='32' colspan='3' align='center' class='istyle16'><img src='image/bismillah.gif' width='166px' height='26px'/></td>
					  </tr>
					  <tr>
					    <td colspan='3'>&nbsp;</td>
					  </tr>
					  ...
					  <tr>
					    ...
					    <td colspan='2' align='justify' class='istyle15'>Jumlah Pinjaman dari <strong>PIHAK PERTAMA Rp. ".number_format($rs->nominal,0,",",".")." (".$AddOnLib->terbilang($rs->nominal).")</strong> dan pembayaran kredit akan dilakukan oleh <strong>PIHAK KEDUA</strong> dalam jangka waktu selama <strong>".$rs->lama_bayar." (".$lmbyr[0].")</strong> bulan.</td>
					  </tr>
					  <tr>
					    <td colspan='3'>&nbsp;</td>
					  </tr>
