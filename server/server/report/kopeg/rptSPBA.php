...
class server_report_kopeg_rptSPBA
{
	protected $caption;
	protected $filter;
	protected $rows;
	...
	function getTotalPage()
	{
		...
		$sql = "select count(a.no_spb) ".
			"from spb_m a inner join kop_pbrg_m c on a.no_spb=c.no_spbasur and a.kode_lokasi=c.kode_lokasi and a.modul='KP.SPB' and a.jenis='PBRG_AS' and a.no_del='-' 
