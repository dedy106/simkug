...
class server_report_kopeg_rptSpbP
{
	protected $caption;
	protected $filter;
	protected $rows;
	...
	function getHtml()
	{
		...
		while (!$page->EOF)
		{
			$sql = "select a.no_spb,date_format(a.tanggal,'%d/%m/%Y') as tgl,a.keterangan,a.akun_hutang,a.kode_terima,a.nik_buat,a.nik_setuju,(a.nilai+a.nilai_pot) as nilai,a.nilai_pot,a.nilai as tot,c.alamat,c.bank,c.no_rek,a.no_invoice,
				...
				,  g.nama as gm, h.nama as setuju,   i.initial as nmunit, a.kode_pp
				from spb_m a
					        ...
					        <td colspan='6' style='padding:0px' align='right'><table width='98%' border='0' cellspacing='0' cellpadding='0'>
					          <tr>
					            ...
					            <td width='50%' style='border:1px solid #111111; border-right-width:0px;'><table width='100%' border='0' cellspacing='0' cellpadding='3'>
					              <tr>
					                <td width='2%'>&nbsp;</td>
					                <td valign='top' class='istyle18'>Catatan : </td>
					              </tr>
					              <tr>
									<td>&nbsp;</td> 
					                <td rowspan='5' valign='top'>&nbsp;invoice $rs->no_invoice</td>
					                </tr>
					              <tr>
					                <td>&nbsp;</td>
					                </tr>
