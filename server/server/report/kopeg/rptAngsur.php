...
class server_report_kopeg_rptAngsur
{
	protected $caption;
	protected $filter;
	protected $rows;
	...
	function getTotalPage()
	{
		...
		$sql = "select count(distinct a.no_angs) 
			...
			inner join kop_agg d on c.kode_agg=d.kode_agg and c.kode_lokasi=d.kode_lokasi ".$this->filter;
	...
	function getHtml()
	{
		...
		while (!$page->EOF)
		{
			$sql = "select a.no_angs,c.kode_agg,upper(d.nama) as nm,a.keterangan,b.npokok+b.nbunga as nilai,date_format(a.tanggal,'%d/%m/%Y') as tgl, 
					      ...
					      <tr>
					        ...
					        <td width='27%' colspan='2' rowspan='6' valign='bottom'><table width='100%' border='0' cellspacing='0' cellpadding='2'>
					          ...
					          <tr>
					            ...
					            <td width='73%' style='border:1px solid #CCCCCC; border-left-width:0px;' class='istyle15'>".$rs->no_angs."</td>
					          </tr>
					        </table></td>
					      </tr>
					      <tr>
