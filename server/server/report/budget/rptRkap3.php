...
class server_report_budget_rptRkap3
{
	protected $caption;
	protected $filter;
	protected $filter2;
	...
	function getHtml()
	{
		...
		$sql = "select nik_user,kode_neraca,jenis_akun,kode_lokasi,tipe,nama,level_spasi,n0,n1,n2,n3,n4,n5,n6,n7,n8,n9,
...
from agg_neraca_tmp where modul='B' and nik_user='$nik_user' order by rowindex ";
  ...
  <tr bgcolor='#CCCCCC'>
	...
	from agg_masakun a
	inner join agg_relakungarinv e on a.kode_akun=e.kode_akun and a.kode_lokasi=e.kode_lokasi 
	left join (select a.kode_akun,isnull(sum(a.rka),0) as rka,isnull(sum(a.realisasi),0) as realisasi,isnull(sum(a.outlook),0) as outlook
				from agg_outlook a
				inner join agg_relakungarinv b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi 
