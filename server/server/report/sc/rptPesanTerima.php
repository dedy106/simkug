...
class server_report_sc_rptPesanTerima extends server_report_basic
{	
...
inner join sc_jenis c on a.kode_jenis=c.kode_jenis   ";
	...
	function getHtml()
	{
		...
		$sql="select a.no_terima, date_format(a.tanggal,'%d/%m/%Y') as tanggal, a.keterangan, a.nik_buat, b.nama as nama_buat,a.jam_terima, a.no_pesan
from sc_terima_m a
inner join sc_karyawan b on a.nik_buat=b.nik
order by a.no_terima ";
		...
		echo $AddOnLib->judul_laporan("penerimaan pesanan",$this->lokasi,$AddOnLib->ubah_periode($periode));
  ...
  <tr>
    <td colspan='20' style='padding:5px'><table width='100%' border='0' cellspacing='2' cellpadding='1'>
	  ...
	  <tr>
        <td class='header_laporan' width='114'>No Pesanan </td>
