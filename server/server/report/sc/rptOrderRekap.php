...
class server_report_sc_rptOrderRekap extends server_report_basic
{	
...
inner join sc_jenis c on a.kode_jenis=c.kode_jenis   ";
	...
	function getHtml()
	{
		...
		$sql="select a.no_jurnal, date_format(a.tanggal,'%d/%m/%Y') as tanggal, a.keterangan, date_format(a.tgl_awal,'%d/%m/%Y') as tgl_awal, date_format(a.tgl_akhir,'%d/%m/%Y') as tgl_akhir
from sc_jurnal_m a
order by a.no_jurnal ";
		...
		echo $AddOnLib->judul_laporan("rekap order",$this->lokasi,$AddOnLib->ubah_periode($periode));
  ...
  <tr>
    <td colspan='20' style='padding:5px'><table width='100%' border='0' cellspacing='2' cellpadding='1'>
      <tr>
        ...
        <td class='header_laporan'>:&nbsp;$row->no_jurnal</td>
        </tr>
		<tr>
	   ...
	   <tr>
        <td class='header_laporan' width='114'>Tanggal </td>
        <td class='header_laporan'>:&nbsp;$row->tgl_awal</td>
        </tr>
		<tr>
        <td class='header_laporan' width='114'>Tanggal </td>
        <td class='header_laporan'>:&nbsp;$row->tgl_akhir</td>
        </tr>
      <tr>
  ...
  <tr bgcolor='#CCCCCC'>
    ...
    <td width='90' align='center' class='header_laporan'>Total</td>
			...
			$sql1="select a.no_po,date_format(a.tanggal,'%d/%m/%Y') as tanggal,a.keterangan,a.kode_vendor,b.nama as nama_vendor,a.nilai,a.ppn,a.nilai+a.ppn as total
from sc_po_m a
inner join sc_vendor b on a.kode_vendor=b.kode_vendor
where a.no_jurnal='$row->no_jurnal' ";
