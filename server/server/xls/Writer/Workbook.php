...
require_once 'server/xls/Writer/Format.php';
require_once 'server/xls/Writer/BIFFwriter.php';
require_once 'server/xls/Writer/Worksheet.php';
require_once 'server/xls/Writer/Parser.php';
...
class Spreadsheet_Excel_Writer_Workbook extends Spreadsheet_Excel_Writer_BIFFwriter
{
    ...
    */
    ...
    {
        include_once 'server/xls/Writer/Validator.php';
