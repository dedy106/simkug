...
window.server_util_mail.implement({
	...
	send :  function(from, to, subject, body, attach){
		this.params.clear();
		...
		this.callAsynch("sendMail");	
	},
	inbox: function(page, rowPerPage){
		this.params.clear();
		this.params.add(page);
		this.params.add(rowPerPage);
		return this.call("inbox");
	},
	inboxA: function(page, rowPerPage){
		this.params.clear();
		this.params.add(page);
		this.params.add(rowPerPage);
		this.callAsynch("inbox");
	},
	...
	getMessageA: function(msgIndex){
		this.params.clear();
		this.params.add(msgIndex);
		this.callAsynch("getMessage");
	}
});
