...
window.server_report_report.prototype.previewWithBs = function(report, filter, page, rows, showFilter, perusahaan, filter2, dataFilter, connection)
{
	this.params.clear();
	this.params.add(report);
	this.params.add(filter);
	...
	this.params.add(dataFilter);
	this.params.add(connection);
	return this.getUrl("previewWithBs");
};
window.server_report_report.prototype.previewWithHeader2 = function(report, filter, page, rows, showFilter, perusahaan, filter2, dataFilter, connection)
{
	this.params.clear();
	this.params.add(report);
	this.params.add(filter);
	...
	this.params.add(dataFilter);
	this.params.add(connection);
	return this.getUrl("previewWithHeader2");
};
