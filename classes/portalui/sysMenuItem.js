...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_sysMenuItem = function(owner, caption){
    if (owner){
        ...
        window.portalui_sysMenuItem.prototype.parent.constructor.call(this, owner);                
        this.menuForm = undefined;		
		this.data = undefined;
		this.dataType = undefined;
    }
};
window.portalui_sysMenuItem.extend(window.portalui_containerComponent);
window.sysMenuItem = window.portalui_sysMenuItem;
window.portalui_sysMenuItem.implement({
	addChild: function(child){
	    if (child instanceof portalui_sysMenuItem)
	    {
	        window.portalui_sysMenuItem.prototype.parent.addChild.call(this, child);
