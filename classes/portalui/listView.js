...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_listView = function(owner, options){
	this.itemWidth = 100;
	this.color = "#F0F9EF";
	window.portalui_listView.prototype.parent.constructor.call(this, owner, options);
...
window.portalui_listView.extend(window.portalui_control);
window.listView =window.portalui_listView;
window.portalui_listView.implement({
	...
	eventMouseUp: function(event){			
		window.portalui_listView.prototype.parent.eventMouseUp.call(this, event);	
	},
	...
	setWidth: function(data){
	    window.portalui_listView.prototype.parent.setWidth.call(this, data);
		//if (document.all)
	    {
	...
	setHeight: function(data){
	    window.portalui_listView.prototype.parent.setHeight.call(this, data);
