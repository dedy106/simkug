...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_mainMenu = function(owner){
    if (owner){
        this.caption = "";
		window.portalui_mainMenu.prototype.parent.constructor.call(this, owner);
		window.portalui_mainMenu.prototype.parent.setHeight.call(this,20);		
...
window.portalui_mainMenu.extend(window.portalui_containerControl);
window.mainMenu = window.portalui_mainMenu;
window.portalui_mainMenu.implement({
	draw: function(canvas){
		window.portalui_mainMenu.prototype.parent.draw.call(this, canvas);
	...
	setHeight: function(data){
		window.portalui_mainMenu.prototype.parent.setHeight.call(this, data);
	},
	unblock: function(){
	    var node = $(this.getFullId() + "_block");
	    if (node != undefined)
