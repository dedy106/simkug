...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_urlLoader = function(owner){
    if (owner){
		this.color = '#ffffff';//system.getConfig("form.color");
		this.caption = "Form";
        window.portalui_urlLoader.prototype.parent.constructor.call(this, owner);
...
window.portalui_urlLoader.extend(window.portalui_commonForm);
window.urlLoader = window.portalui_urlLoader;
window.portalui_urlLoader.implement({
	doDraw : function(canvas){
		canvas.style.border = "1px solid #ffffff";
		window.portalui_urlLoader.prototype.parent.doDraw.call(this, canvas);
	...
	doActivate: function(){
	    window.portalui_urlLoader.prototype.parent.doActivate.call(this); 	
	},
	doDeactivate: function(){
	    window.portalui_urlLoader.prototype.parent.doDeactivate.call(this);
	},
	getCaption: function(){
		return this.caption;
	},
	...
	close: function(){
		window.portalui_urlLoader.prototype.parent.close.call(this);
	},
