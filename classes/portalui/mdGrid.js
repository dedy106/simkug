...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_mdGrid = function(owner){
	try{
		this.selectedItem = undefined;			
		this.height = 200;
		this.widthColNo = 20;
		window.portalui_mdGrid.prototype.parent.constructor.call(this, owner);	
...
window.portalui_mdGrid.extend(window.portalui_containerControl);
window.mdGrid = window.portalui_mdGrid;
window.portalui_mdGrid.implement({
...
//-----------------------------------			
	...
	setHeight: function(data){
		window.portalui_mdGrid.prototype.parent.setHeight.call(this,data);
