...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_treeGridItem = function(parent, owner, index){
	try{
		if (owner){
			this.parent = parent;
			this.grid = owner;
			...
			this.rowIndex = index;
			window.portalui_treeGridItem.prototype.parent.constructor.call(this, parent);	
...
window.portalui_treeGridItem.extend(window.portalui_containerControl);
window.treeGridItem = window.portalui_treeGridItem;
window.portalui_treeGridItem.implement({
...
//			nodeCel.style.background = "#F0F9EF";
	...
	addChild: function(child){
	    if (child instanceof portalui_treeGridItem)
	    {
	        ...
	        window.portalui_treeGridItem.prototype.parent.addChild.call(this, child);	
...
//		this.onSelect.call(this);
	...
	treeMouseUp: function(event){
	    ...
	    if ((target != undefined) && (target.id == (n + "_frame")))
	        window.portalui_treeGridItem.prototype.parent.eventMouseUp.call(this, event);
	},
