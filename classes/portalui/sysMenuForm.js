...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_sysMenuForm = function(owner){
    if (owner){
		this.className = "portalui_sysMenuForm";
        window.portalui_sysMenuForm.prototype.parent.constructor.call(this, owner);        
        this.setWidth(200);
        this.setHeight(30);
...
window.portalui_sysMenuForm.extend(window.portalui_commonForm);
window.sysMenuForm = window.portalui_sysMenuForm;
window.portalui_sysMenuForm.implement({
	...
	doDeactivate: function(){
		try{
			window.portalui_sysMenuForm.prototype.parent.doDeactivate.call(this);
		    var app = this.getApplication();
