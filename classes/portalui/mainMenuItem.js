...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_mainMenuItem = function(owner, caption){
    if (owner){
        this.caption = caption;		
		window.portalui_mainMenuItem.prototype.parent.constructor.call(this, owner);
		window.portalui_mainMenuItem.prototype.parent.setHeight.call(this,20);		        
		this.className = "portalui_mainMenuItem";
        this.owner = owner;		
		this.setWidth(this.caption.length * 8);
    }
};
window.portalui_mainMenuItem.extend(window.portalui_control);
window.mainMenuItem = window.portalui_mainMenuItem;
window.portalui_mainMenuItem.implement({
