...
//* 			roojax jamboo											
//***********************************************************************************************
window.portalui_toolbar = function(owner, options){
	if (owner){				
		window.portalui_toolbar.prototype.parent.constructor.call(this, owner, options);		
		this.className = "portalui_toolbar";
		this.onButtonClick = new portalui_eventHandler();		
		this.buttonList = new portalui_arrayMap();
		this.separatorList = new portalui_arrayMap();
...
window.portalui_toolbar.extend(window.portalui_control);
window.toolbar = window.portalui_toolbar;
window.portalui_toolbar.implement({
