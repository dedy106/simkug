...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_imageslide = function(owner,options){	
    this.bgColor = "#ffffff";
	...
	window.portalui_imageslide.prototype.parent.constructor.call(this,owner,options);	
	this.className = "portalui_imageslide";
	this.width = 300;
	this.height = 130;		
	this.items = [];
	this.page = 0;
...
window.portalui_imageslide.extend(window.portalui_control);
window.imageslide = window.portalui_imageslide;
window.portalui_imageslide.implement({
	...
	setHeight: function(data){
		window.portalui_imageslide.prototype.parent.setHeight.call(this, data);		
		var node = $(this.getFullId() +"_frame");		
		if (node !== undefined) node.style.height = data;		
	},
	setWidth: function(data){
		window.portalui_imageslide.prototype.parent.setWidth.call(this, data);			
		var node = $(this.getFullId() +"_frame");
