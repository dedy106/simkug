...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_font = function(){
    window.portalui_font.prototype.parent.constructor.call(this);
    this.className = "portalui_font";
...
window.portalui_font.extend(window.portalui_component);
window.font =window.portalui_font;
//------------------------- Setter & Getter ------------------------------------
window.portalui_font.implement({
	getCss: function(){
