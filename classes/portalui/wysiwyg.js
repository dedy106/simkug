...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_wysiwyg = function(owner, options)
{
    if (owner)
    {        
		window.portalui_wysiwyg.prototype.parent.constructor.call(this, owner, options);		
...
window.portalui_wysiwyg.extend(window.portalui_control);
window.wysiwyg = window.portalui_wysiwyg;
//---------------------------- Function ----------------------------------------
window.portalui_wysiwyg.prototype.doSerialize = function()
{
    window.portalui_wysiwyg.prototype.parent.doSerialize.call(this);    
};
window.portalui_wysiwyg.prototype.doDraw = function(canvas)
{
...
window.portalui_wysiwyg.prototype.setWithForm = function (withForm){
	try{		
...
window.portalui_wysiwyg.prototype.eventKeyDown = function (event){
	try{		
...
window.portalui_wysiwyg.prototype.doResize = function (width, height){	
	this.wysiwyg_content.style.height = this.height - 100;
	this.wysiwyg_hidden.style.height = this.height - 100;
};
window.portalui_wysiwyg.prototype.eventKeyPress = function (event){	
	try{		
		if (this.getElementById("param1") != null){
			var obj = $$(this.getElementById("param1").value);
...
//------------------------------- Event ----------------------------------------
window.portalui_wysiwyg.prototype.disable = function (){
...
window.portalui_wysiwyg.prototype.enable = function (){
	// disable design mode or content editable feature
	if(this.wysiwyg_content.contentWindow.document.body.contentEditable) {
...
window.portalui_wysiwyg.prototype.display = function (){
	try{
	    if(this.isSupported()){
...
window.portalui_wysiwyg.prototype._display_textarea = function (){
	this.wysiwyg_hidden.style.display = "";
	this.wysiwyg_hidden.style.visibility = "";
};
window.portalui_wysiwyg.prototype.doTextFormat = function (command, optn, x, y){
	try{		
...
window.portalui_wysiwyg.prototype.toggleMode = function (){
...
window.portalui_wysiwyg.prototype._toggle_mode_ie = function (){
    if(this.viewMode == 2){
...
window.portalui_wysiwyg.prototype._toggle_mode_gecko = function (){
    if(this.viewMode == 2){
...
window.portalui_wysiwyg.prototype.getCaretPos = function (){    
	if(document.all)
		{
...
window.portalui_wysiwyg.prototype.insertNodeAtSelection = function (insertNode){    
	try{
		if(document.all)
		{
			var caretPos=this.wysiwyg_content.contentWindow.document.selection.createRange();
...
window.portalui_wysiwyg.prototype.getSelectContainer = function (){    
	try{
		if(document.all)
		{
			var caretPos=this.wysiwyg_content.contentWindow.document.selection.createRange();
...
window.portalui_wysiwyg.prototype.setSelection = function (){  
	var sel = this.getSelection();
	var range = sel.getRangeAt(0);
	var pos = range.startOffset;
...
window.portalui_wysiwyg.prototype.getSelection = function (){    
	try{
		if(document.all)
		{
			var caretPos=this.wysiwyg_content.contentWindow.document.selection.createRange();
...
window.portalui_wysiwyg.prototype.setSelectedColor = function (color, command){    
	try{	    
...
window.portalui_wysiwyg.prototype.setFocus = function(){
	this.wysiwyg_content.contentWindow.focus();
};
window.portalui_wysiwyg.prototype.getPallete = function (command, optn, x, y) {
...
window.portalui_wysiwyg.prototype.isSupported = function () {   
    return true;
};
window.portalui_wysiwyg.prototype.isMSIE = function (){
    return (typeof(document.all) == "object");
};

window.portalui_wysiwyg.prototype._get_palette_html = function (command) {    
...
//------------------------- Setter & Getter ------------------------------------
window.portalui_wysiwyg.prototype.setColor = function(data)
{
	this.bgColor = data;
	var nd = this.getCanvas()
	nd.style.background = this.bgColor;
};
window.portalui_wysiwyg.prototype.getColor = function()
{
	return this.bgColor;
};
window.portalui_wysiwyg.prototype.block = function()
{
...
window.portalui_wysiwyg.prototype.setHeight = function(data)
{
	window.portalui_wysiwyg.prototype.parent.setHeight.call(this, data);
};
window.portalui_wysiwyg.prototype.unblock = function()
{
    var node = $(this.getFullId() + "_block");
...
window.portalui_wysiwyg.prototype.navigate = function(url)
{
	this.location = url;
	this.frame.src = url;
};
window.portalui_wysiwyg.prototype.getXHTML = function (data){
	return new Html2Xhtml(data).parse()
};
window.portalui_wysiwyg.prototype.loadCss = function(){
...
window.portalui_wysiwyg.prototype.rteMouseOverFormatMenu = function (event, id, resId) {	
...
window.portalui_wysiwyg.prototype.rteMouseDownFormatMenu = function (event, id) { 	
	try{		
...
window.portalui_wysiwyg.prototype.rteMouseOutFormatMenu = function(event, id) { 			
	if (id == this.getFullId() +"format1" || id == this.getFullId() +"format2"){		
...
window.portalui_wysiwyg.prototype.rteGetOffsetTop = function (elm) { 
...
window.portalui_wysiwyg.prototype.rteGetOffsetLeft = function (elm) { 
...
window.portalui_wysiwyg.prototype.rteHideMenus = function (event,id) { 
...
window.portalui_wysiwyg.prototype.rteColorClick = function (hexcolor) { 
	this.rteHideMenus(); 
	this.doTextFormat("forecolor", hexcolor); 
	$(this.getFullId() + "_fontcolor4").style.backgroundColor = hexcolor;
}; 
window.portalui_wysiwyg.prototype.rteMouseOverMenuContents = function (event) { 	
	var target = document.all ? event.srcElement : event.target;
	target.style.color = "#FFFFFF"; 
	target.style.backgroundColor = "#316AC5"; 	
	$(this.rteName).contentWindow.setFocus();
}; 
window.portalui_wysiwyg.prototype.rteMouseOutMenuContents = function (event) { 
	var target = document.all ? event.srcElement : event.target;
	target.style.color = "#000000"; 
	target.style.backgroundColor = "#FFFFFF";	
}; 
window.portalui_wysiwyg.prototype.rteMouseDownMenuContents = function (event) { 
...
window.portalui_wysiwyg.prototype.viewDesignMode = function() { 	
	try{
...
window.portalui_wysiwyg.prototype.viewCodeMode = function() { 
	try{		
		this.rteFormHandler(); 
...
window.portalui_wysiwyg.prototype.getCode = function() { 
	try{		
		this.rteFormHandler(); 
...
window.portalui_wysiwyg.prototype.setCode = function(newHTML) { 
	try{			
...
window.portalui_wysiwyg.prototype.viewPreviewMode = function() { 
	try{				
		this.rteFormHandler(); 
...
window.portalui_wysiwyg.prototype.rteFormHandler = function () { 
	if ($(this.rteFormName).style.display == ""){ 
...
window.portalui_wysiwyg.prototype.rteFormHandler2 = function () { 
	if ($(this.rteFormName).style.display == ""){ 
...
window.portalui_wysiwyg.prototype.rteBtnInsertImage = function () { 
	window.open(rteHTMLPathInsertImage , "blank","toolbar=no,width=300,height=220");
}; 
window.portalui_wysiwyg.prototype.rteBtnEditLink = function() { 
	window.open(rteHTMLPathEditLink , "blank","toolbar=no,width=250,height=300");
}; 
window.portalui_wysiwyg.prototype.rteBtnEditTable = function () { 
	window.open(rteHTMLPathEditTable , "blank","toolbar=no,width=320,height=210");
}; 
window.portalui_wysiwyg.prototype.rteBtnCreateLink = function () { 
	window.open(rteHTMLPathInsertLink , "blank","toolbar=no,width=250,height=300");
}; 
window.portalui_wysiwyg.prototype.rteBtnPrint = function () { 
	if (document.all){ 
...
window.portalui_wysiwyg.prototype.rteInsertHTML = function (html) { 
	if (document.all) { 
...
window.portalui_wysiwyg.prototype.rteBtnInsertTableRowAfter = function() { 
	if (window.getSelection){ 
		var selected_obj = $(rteName).contentWindow.window.getSelection().focusNode;
	}else if (document.getSelection){ 
		var selected_obj = $(rteName).contentWindow.document.getSelection().focusNode;
...
window.portalui_wysiwyg.prototype.rteBtnInsertTableColumnBefore = function() {
	if (window.getSelection){ 
		var selected_obj = $(rteName).contentWindow.window.getSelection().focusNode;
	}else if (document.getSelection){ 
		var selected_obj = $(rteName).contentWindow.document.getSelection().focusNode;
...
window.portalui_wysiwyg.prototype.rteBtnInsertTableColumnAfter = function() { 
	if (window.getSelection){ 
		var selected_obj = $(rteName).contentWindow.window.getSelection().focusNode;
	}else if (document.getSelection){ 
		var selected_obj = $(rteName).contentWindow.document.getSelection().focusNode;
...
window.portalui_wysiwyg.prototype.rteBtnDeleteTableColumn = function() { 
	if (window.getSelection){ 
		var selected_obj = $(rteName).contentWindow.window.getSelection().focusNode;
	}else if (document.getSelection){ 
		var selected_obj = $(rteName).contentWindow.document.getSelection().focusNode;
...
window.portalui_wysiwyg.prototype.rteBtnDeleteTableRow = function () { 
	if (window.getSelection){ 
		var selected_obj = $(rteName).contentWindow.window.getSelection().focusNode;
	}else if (document.getSelection){ 
		var selected_obj = $(rteName).contentWindow.document.getSelection().focusNode;
...
window.portalui_wysiwyg.prototype.rteAction = function (event, id) { 	
