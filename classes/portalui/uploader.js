...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_uploader = function(owner, options){
	if (owner){
		...
		window.portalui_uploader.prototype.parent.constructor.call(this, owner, options);
		this.className = "portalui_uploader";

		window.portalui_uploader.prototype.parent.setWidth.call(this, 180);
		this.setHeight(20);
		this.isFlash = false;
...
window.portalui_uploader.extend(window.portalui_control);
window.uploader = window.portalui_uploader;
window.portalui_uploader.implement({
...
window.portalui_multiSelector = function(list_target, max ){
	window.portalui_multiSelector.prototype.parent.constructor.call(this);
...
window.portalui_multiSelector.extend(window.Function);
window.portalui_multiSelector.implement({
