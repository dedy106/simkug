...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_rssReader = function(owner, options){
    if (owner)
    {
		this.caption = "";
		window.portalui_rssReader.prototype.parent.constructor.call(this, owner,options);		
		...
		this.onRemove = new portalui_eventHandler();
...
window.portalui_rssReader.extend(window.portalui_containerControl);
//---------------------------- Function ----------------------------------------
window.portalui_rssReader.implement({
	draw: function(canvas){
		window.portalui_rssReader.prototype.parent.draw.call(this, canvas);
	...
	setWidth: function(data){
		window.portalui_rssReader.prototype.parent.setWidth.call(this, data);		
	...
	setHeight: function(data){
		window.portalui_rssReader.prototype.parent.setHeight.call(this, data);		
