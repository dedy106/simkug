...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_listBox = function(owner, options){
	this.itemWidth = 100;
	this.color = "#F0F9EF";
	window.portalui_listBox.prototype.parent.constructor.call(this, owner, options);
...
window.portalui_listBox.extend(window.portalui_control);
window.listBox = window.portalui_listBox;
window.portalui_listBox.implement({
	...
	setWidth: function(data){
		window.portalui_listBox.prototype.parent.setWidth.call(this, data);
		var frame = $(this.getFullId() + "_box");
        frame.style.width = data;    
	},
	setHeight: function(data){
		window.portalui_listBox.prototype.parent.setHeight.call(this, data);
		var frame = $(this.getFullId() + "_box");
