...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_saiCB = function(owner, options){
    if (owner){
    		this.stateRO 	= "";
		this.text 		= "";
    		this.caption 	= "saiCB";
			...
			this.width = 80;
    		window.portalui_saiCB.prototype.parent.constructor.call(this, owner,options);
	        this.className = "portalui_saiCB";	        
	        window.portalui_saiCB.prototype.parent.setWidth.call(this, 80);
	        window.portalui_saiCB.prototype.parent.setHeight.call(this, 20);
...
window.portalui_saiCB.extend(window.portalui_control);
window.saiCB = window.portalui_saiCB;
window.portalui_saiCB.implement({
	doDraw: function(canvas){
		...
		if (document.all)
			var html =   "<div id='"+n+"_frame' style='{position: absolute;left: 0;top: 0;width:100%;height: 100%;}'> "+
				...
				"<div id='"+n+"_btn' style='{position:absolute; left:"+lft+";top:0;width:18px;height:100%;"+
	...
	setWidth: function(data){
		var n = this.getFullId();
		var nd = $(n);
		window.portalui_saiCB.prototype.parent.setWidth.call(this,data); 
		this.doDraw(nd);
	},
