...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_slider = function(owner,options){	
	window.portalui_slider.prototype.parent.constructor.call(this,owner,options);	
...
window.portalui_slider.extend(window.portalui_control);
window.slider = window.portalui_slider;
window.portalui_slider.implement({
	...
	setHeight: function(data){
		window.portalui_slider.prototype.parent.setHeight.call(this,data);
