...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_imageFlow = function(owner,options){	
	window.portalui_imageFlow.prototype.parent.constructor.call(this,owner,options);	
	this.className = "portalui_imageFlow";
	this.interval = 5000;	
	this.enabled = false;
	this.opacity = 0;
	this.array_images = [];
...
window.portalui_imageFlow.extend(window.portalui_control);
window.imageFlow = window.portalui_imageFlow;
window.portalui_imageFlow.implement({
