...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_reportNavigator = function(owner, options){
	if (owner){
		try{
			window.portalui_reportNavigator.prototype.parent.constructor.call(this, owner, options);
			this.className = "portalui_reportNavigator";
			window.portalui_reportNavigator.prototype.parent.setHeight.call(this, 30);
			window.portalui_reportNavigator.prototype.parent.setWidth.call(this, 320);
			...
			this.onSendClick = new portalui_eventHandler();
			this.onSortChange = new portalui_eventHandler();
			this.rowPerPage = 30;
			
			var app = this.getApplication();
			uses("portalui_frameBrowser");//portalui_frameNavigator;
			//this.frame = new portalui_frameNavigator(app,{bound:[20,this.top + this.height + 30,620,40],visible:false});//(window.app);						
			this.browser = new portalui_frameBrowser(app,{bound:[5,this.top + this.height + 35,this.width, this.height - 117],visible:false});									
			//this.e0 = new portalui_saiLabelEdit(this.frame,{bound:[20,5,300,20],caption:"Search"});
			//this.e1 = new portalui_saiCB(this.frame,{bound:[325,5,200,20],caption:"in Field",change:[this,"doChange"]});			
			//this.b1 = new portalui_button(this.frame,{bound:[530,5,78,18],caption:"Find",click:[this,"doFindText"]});
			this.btnTop = 6;			
			this.firstBtn = new portalui_imageButton(this,{bound:[20,this.btnTop,22,22],image:"icon/"+system.getThemes()+"/imgFirst.png", hint:"First Page",tag:1,click:[this,"doNavigatorClick"],name:"firstBtn"});			
			this.leftBtn = new portalui_imageButton(this,{bound:[42,this.btnTop,22,22],image:"icon/"+system.getThemes()+"/imgLeft.png", hint:"Prev Page",tag:1,click:[this,"doNavigatorClick"],name:"leftBtn"});						
			this.rightBtn = new portalui_imageButton(this,{bound:[64,this.btnTop,22,22],image:"icon/"+system.getThemes()+"/imgRight.png", hint:"Next Page",tag:1,click:[this,"doNavigatorClick"],name:"rightBtn"});									
			this.lastBtn = new portalui_imageButton(this,{bound:[88,this.btnTop,22,22],image:"icon/"+system.getThemes()+"/imgLast.png", hint:"Last Page",tag:1,click:[this,"doNavigatorClick"],name:"LastBtn"});									
			this.allBtn = new portalui_imageButton(this,{bound:[110,this.btnTop,22,22],image:"icon/"+system.getThemes()+"/fullscreen.png", hint:"All Page",tag:1,click:[this,"doAllClick"],name:"allBtn"});															
			this.pdfBtn = new portalui_imageButton(this,{bound:[132,this.btnTop,22,22],image:"icon/"+system.getThemes()+"/pdf.png", hint:"Create PDF",tag:1,click:[this,"doPdfClick"],name:"pdfBtn"});																		
			this.xlsBtn = new portalui_imageButton(this,{bound:[154,this.btnTop,22,22],image:"icon/"+system.getThemes()+"/excel.png", hint:"export to XLS",tag:1,click:[this,"doXlsClick"],name:"xlsBtn"});																		
			this.create = new portalui_imageButton(this,{bound:[176,this.btnTop,22,22],image:"icon/"+system.getThemes()+"/word.png", hint:"export to word",tag:1,click:[this,"doCreateClick"],name:"create"});																		
			this.edit = new portalui_imageButton(this,{bound:[198,this.btnTop,22,22],image:"icon/"+system.getThemes()+"/editentries.png", hint:"Edit Record",tag:1,click:[this,"doCreateClick"],name:"edit"});																		
			this.del = new portalui_imageButton(this,{bound:[220,this.btnTop,22,22],image:"icon/"+system.getThemes()+"/delentries.png", hint:"Delete Record",tag:1,click:[this,"doCreateClick"],name:"del"});																		
			this.findText = new portalui_imageButton(this,{bound:[242,this.btnTop,22,22],image:"icon/"+system.getThemes()+"/search.png", hint:"Find Record",tag:1,click:[this,"doFindClick"],name:"findText"});																		
			this.graph = new portalui_imageButton(this,{bound:[264,this.btnTop,22,22],image:"icon/"+system.getThemes()+"/graph.png", hint:"Graph",tag:1,click:[this,"doGraphClick"],name:"graph"});																		
			this.PrintBtn = new portalui_imageButton(this,{bound:[286,this.btnTop,22,22],image:"icon/"+system.getThemes()+"/print.png", hint:"Print Page",tag:1,click:[this,"doPrintClick"],name:"PrintBtn"});																		
			this.PreviewBtn = new portalui_imageButton(this,{bound:[308,this.btnTop,22,22],image:"icon/"+system.getThemes()+"/printPreview.png", hint:"Print Preview",tag:1,click:[this,"doPreviewClick"],name:"PreviewBtn"});																											
			this.MailBtn = new portalui_imageButton(this,{bound:[330,this.btnTop,22,22],image:"icon/"+system.getThemes()+"/sendMail.png", hint:"Send Email",tag:1,click:[this,"doNavigatorClick"],name:"MailBtn"});
			this.cbSort = new portalui_saiCB(this,{bound:[352,this.btnTop,100,20],caption:"",labelWidth:0,change:[this,"doSelectChange"],items:["Sort By"], hint:"Sort By"});				
			this.img = new portalui_image(this,{bound:[20,5,15,20],image:"image/loader.gif",visible:false});						
			this.cb = new portalui_saiCB(this,{bound:[this.getWidth() / 2 ,this.btnTop,50,20],caption:"",labelWidth:0,change:[this,"doSelectChange"],items:["10","20","30","50","100","500","1000","5000","10000"], hint:"Pilih Jumlah Baris per Halaman"});				
			this.cb.setSelectedId(3);				
			this.closeBtn = new portalui_button(this,{bound:[this.getWidth() - 80,this.btnTop,80,18],caption:"Back",click:[this,"doCloseClick"]});
...
window.portalui_reportNavigator.extend(window.portalui_panel);
window.reportNavigator = window.portalui_reportNavigator;
window.portalui_reportNavigator.implement({
		...
		try{
			...
			if (sender == this.MailBtn){
			     if (this.confirmMail === undefined)
			         uses("portalui_ConfirmMail");		
			     this.confirmMail = new portalui_ConfirmMail(this.owner,{bound:[this.owner.width / 2 - 125,this.owner.height / 2 - 100,250,100],caption:"Konfirmasi Email",visible:true});			     
			     this.confirmMail.onConfirmClick.set(this.onSendClick.target,"doConfirmClick");
			     this.confirmMail.email.setFocus();
				 this.confirmMail.bringToFront();
			     return false;
	...
	setWidth: function(data){
		window.portalui_reportNavigator.prototype.parent.setWidth.call(this, data);
...
//	this.setWidth(90);
	...
	doCreateClick: function(sender){
		if (sender == this.create)
			download(this.report.getContent(),"doc");
		else 
	...
	doPreviewClick: function(sender){  
		...
		winfram.document.write("<link rel='stylesheet' type='text/css' href='bs/css/bootstrap.css'/><script type='text/javascript' src='bs/js/jquery.js'></script>");
