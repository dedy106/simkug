...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_flashObj = function(owner, options){	
	try
	{
		window.portalui_flashObj.prototype.parent.constructor.call(this,owner, options);
...
window.portalui_flashObj.extend(window.portalui_control);
window.flashObj = window.portalui_flashObj;
window.portalui_flashObj.implement({
