...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_arrayMap = function(options){
	window.portalui_arrayMap.prototype.parent.constructor.call(this);	
	this.objList = new Array();	
	this.className = "portalui_arrayMap";
	this.tag1 = 0;
	this.tag2 = 0;
	this.tag3 = 0;
...
window.portalui_arrayMap.extend(window.portalui_XMLAble);
window.arrayMap = window.portalui_arrayMap;
window.portalui_arrayMap.prototype.toString = function(){
	return "portalui_arrayMap [" + this.getLength() + " objects]";
};
window.portalui_arrayMap.implement({
	doSerialize: function(){
	    window.portalui_arrayMap.prototype.parent.doSerialize.call(this);
	...
	fromXMLNode: function(node){
	    window.portalui_arrayMap.prototype.parent.fromXMLNode.call(this, node);	    
	...
	addAll: function(otherList){	
		if (otherList instanceof portalui_arrayMap)
		{
