...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_toolTip = function(owner){
    if (owner){
        window.portalui_toolTip.prototype.parent.constructor.call(this, owner);
		window.portalui_toolTip.prototype.parent.setWidth.call(this,200);				
...
window.portalui_toolTip.extend(window.portalui_commonForm);
window.toolTip = window.portalui_toolTip;
window.portalui_toolTip.implement({
