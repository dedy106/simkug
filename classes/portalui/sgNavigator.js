...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_sgNavigator = function(owner, options){
	if (owner){
		window.portalui_sgNavigator.prototype.parent.constructor.call(this, owner, options);
		this.className = "portalui_sgNavigator";
		window.portalui_sgNavigator.prototype.parent.setHeight.call(this, 25);
		this.sg = undefined;
		...
		uses("portalui_imageButton;portalui_uploader;portalui_image");		
		this.addBtn = new portalui_imageButton(this,{bound:[2,2,22,22],image:"icon/"+system.getThemes()+"/createentries.png",hint:"Append Row",click:[this,"doNavigatorClick"],name:"addBtn"});
		this.delBtn = new portalui_imageButton(this,{bound:[24,2,22,22],image:"icon/"+system.getThemes()+"/delentries.png",hint:"Delete Row",click:[this,"doNavigatorClick"],name:"delBtn"});
		this.copyBtn = new portalui_imageButton(this,{bound:[46,2,22,22],image:"icon/"+system.getThemes()+"/copyentries.png",hint:"Copy Row",name:"copyBtn",click:[this,"doNavigatorClick"]});		
		this.separator = new portalui_image(this,{bound:[50,2,2,22],image:"icon/"+system.getThemes()+"/separator.png",name:"separator"});		
		this.downBtn = new portalui_imageButton(this,{bound:[54,2,22,22],image:"icon/"+system.getThemes()+"/down.png",hint:"Move Down",click:[this,"doNavigatorClick"],name:"addBtn"});
		this.upBtn = new portalui_imageButton(this,{bound:[76,2,22,22],image:"icon/"+system.getThemes()+"/up.png",name:"upBtn",hint:"Move Up",click:[this,"doNavigatorClick"]});
		this.separator2 = new portalui_image(this,{bound:[98,2,2,22],image:"icon/"+system.getThemes()+"/separator.png"});
		this.firstBtn = new portalui_imageButton(this,{bound:[102,2,22,22],image:"icon/"+system.getThemes()+"/imgFirst.png",name:"firstBtn",hint:"First Page",click:[this,"doNavigatorClick"]});
		this.leftBtn = new portalui_imageButton(this,{bound:[124,2,22,22],image:"icon/"+system.getThemes()+"/imgLeft.png",name:"leftBtn",hint:"Prev Page",click:[this,"doNavigatorClick"]});
		this.rightBtn = new portalui_imageButton(this,{bound:[140,2,22,22],image:"icon/"+system.getThemes()+"/imgRight.png",name:"rightBtn",hint:"Next Page",click:[this,"doNavigatorClick"]});		
		this.lastBtn = new portalui_imageButton(this,{bound:[162,2,22,22],image:"icon/"+system.getThemes()+"/imgLast.png",name:"lastBtn",hint:"Last Page",click:[this,"doNavigatorClick"]});				
		this.printBtn = new portalui_imageButton(this,{bound:[184,2,22,22],image:"icon/"+system.getThemes()+"/print.png",hint:"Print",name:"printBtn",click:[this,"doNavigatorClick"]});		
		this.xlsBtn = new portalui_imageButton(this,{bound:[206,2,22,22],image:"icon/"+system.getThemes()+"/excel.png",hint:"Save to excel",name:"xlsBtn",click:[this,"doNavigatorClick"]});		
		this.docBtn = new portalui_imageButton(this,{bound:[228,2,22,22],image:"icon/"+system.getThemes()+"/word.png",hint:"Save to word",name:"docBtn",click:[this,"doNavigatorClick"]});		
		this.loadBtn = new portalui_imageButton(this,{bound:[250,2,22,22],image:"icon/"+system.getThemes()+"/upload.png",hint:"Load to Files",name:"loadBtn",click:[this,"doNavigatorClick"]});				
		this.uploader = new portalui_uploader(this,{bound:[300,2,210,22],afterUpload:[this,"doAfterLoad"],autoSubmit:true, param4:"gridupload",param3:"object",visible:false});		
		...
		this.onBeforePager = new portalui_eventHandler();
		this.onRefreshGrid = new portalui_eventHandler();
		this.onXlsClick = new portalui_eventHandler();
		this.setColor(system.getConfig("form.navigator.color"));//system.getConfig("form.navigator.color")
		this.printHeader = "";
...
window.portalui_sgNavigator.extend(window.portalui_containerControl);
window.sgNavigator = window.portalui_sgNavigator
window.portalui_sgNavigator.implement({
	draw: function(canvas){
		window.portalui_sgNavigator.prototype.parent.draw.call(this, canvas);
	...
	setWidth: function(data){
		window.portalui_sgNavigator.prototype.parent.setWidth.call(this,data);
