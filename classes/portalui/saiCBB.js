...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_saiCBB = function(owner, options){
    if (owner){
		this.stateRO 	= "";
		this.text 		= "";
		...
		window.portalui_saiCBB.prototype.parent.constructor.call(this, owner, options);
		this.className = "portalui_saiCBB";        
		this.setLabelWidth(100);
		this.setWidth(80);
		window.portalui_saiCBB.prototype.parent.setHeight.call(this, 20);
		...
		this.onBtnRefreshClick = new portalui_eventHandler();
...
window.portalui_saiCBB.extend(window.portalui_control);
window.saiCBB = window.portalui_saiCBB;
window.portalui_saiCBB.implement({
			...
			html =   "<div id='"+n+"_frame' style='{position: absolute;left: 0;top: 0;width:100%;height: 100%;}'> "+
				...
				"<div id='"+n+"_shadow' style='{display:none;filter:alpha(opacity:0.3);opacity:0.3;moz-opacity:0.3}'>"+
				 ...
				 "<div id='"+n+"_shadLeft' style='{background:url(icon/"+system.getThemes()+"/shadBtnLeft.png) no-repeat; "+ 			 
				 	" position:absolute;left:"+(this.labelWidth-8).toString()+";top:-8;width:8;height:37;}'></div>"+		
	...
	doLostFocus: function(fromEdit){
		window.portalui_saiCBB.prototype.parent.doLostFocus.call(this);
	...
	setWidth: function(data){
		var n = this.getFullId();
		var nd = $(n);
		window.portalui_saiCBB.prototype.parent.setWidth.call(this,data); 
		this.doDraw(nd);
	},
...
//--masih belum bisa complex sql			
	...
	free: function(){
		...
		window.portalui_saiCBB.prototype.parent.free.call(this);	
	},
