...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_groupBox = function(owner, options){
    if (owner)
    {
        this.caption = "";
		window.portalui_groupBox.prototype.parent.constructor.call(this, owner, options);		
...
window.portalui_groupBox.extend(window.portalui_containerControl);
window.groupBox = window.portalui_groupBox;
//---------------------------- Function ----------------------------------------
window.portalui_groupBox.implement({
	draw: function(canvas){
		window.portalui_groupBox.prototype.parent.draw.call(this, canvas);
	    ...
	    if (document.all)
	        html =  "<div style='{position: absolute; left: 0; top: 0; width: 100%; height: 100%;}' >" +									
					...
					"</div>"+
					"<span id='" + n + "_cap' style='{position: absolute;left: 10;top: 3; width:auto; height: 20;}'> </span>"+
	...
	setHeight: function(data){
		window.portalui_groupBox.prototype.parent.setHeight.call(this, data);
		this.form.style.height = data - 25;				
		this.border.style.height = data - (systemAPI.browser.msie ? 10:12);
	},
	setWidth: function(data){
		window.portalui_groupBox.prototype.parent.setWidth.call(this, data);
