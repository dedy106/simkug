...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_webBrowser = function(owner, options){
    if (owner){        
		window.portalui_webBrowser.prototype.parent.constructor.call(this, owner, options);		
...
window.portalui_webBrowser.extend(window.portalui_control);
window.webBrowser = window.portalui_webBrowser;
//---------------------------- Function ----------------------------------------
window.portalui_webBrowser.implement({
	doDraw: function(canvas){
		var n = this.getFullId();
	    if (document.all)
	        var html =  "<div style='{position: absolute; left: 0; top: 0; width: 100%; height: 100%;}' >" +
					"<iframe id='" + n + "_frame' frameborder=0  style='{position: absolute; left: 0; top: 0; width: 100%; height: 100%}' ></iframe>"+
	...
	setHeight: function(data){
		window.portalui_webBrowser.prototype.parent.setHeight.call(this, data);
	},
	unblock: function(){
	    var node = $(this.getFullId() + "_block");
	    if (node != undefined)
