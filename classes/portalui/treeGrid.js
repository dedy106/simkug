...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_treeGrid = function(owner){
	this.selectedItem = undefined;	
	this.height = 200;
	this.widthColNo = 100;
	window.portalui_treeGrid.prototype.parent.constructor.call(this, owner);	
...
window.portalui_treeGrid.extend(window.portalui_containerControl);
window.treeGrid= window.portalui_treeGrid;
window.portalui_treeGrid.implement({
