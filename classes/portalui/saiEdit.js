...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_saiEdit = function(owner, options)
{
    if (owner)
    {
    		this.stateRO 	= "";
	        ...
	        window.portalui_saiEdit.prototype.parent.constructor.call(this, owner, options);
	        this.className = "portalui_saiEdit";
	        
	        this.setWidth(80);
	        window.portalui_saiEdit.prototype.parent.setHeight.call(this, 20);
...
window.portalui_saiEdit.extend(window.portalui_control);
window.saiEdit = window.portalui_saiEdit;
window.portalui_saiEdit.implement({
	doDraw: function(canvas){
	    var n = this.getFullId();
	    canvas.style.background = " ";
	    canvas.style.overflow = "hidden";
		var html = "<div id='"+n+"_border' style='{position: absolute;left: 0;top: 0;width:100%;height: 100%;}'> "+
			"<input id='"+n+"_edit' type='"+this.type+"' value='' "+this.stateRO+" "+
	...
	doLostFocus: function(){
		window.portalui_saiEdit.prototype.parent.doLostFocus.call(this);
	...
	doSetFocus: function(){
		...
		if (nd != undefined)
			nd.focus();
		this.isFocused = true;	
		window.portalui_saiEdit.prototype.parent.doSetFocus.call(this);
	},
	doFocus: function(){
	...
	setWidth: function(data){
		var n = this.getFullId();
		var nd = $(n);
		window.portalui_saiEdit.prototype.parent.setWidth.call(this,data); 	
		this.doDraw(nd);
	},
