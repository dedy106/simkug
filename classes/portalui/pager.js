...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_pager = function(owner,options){
	if (owner){
		window.portalui_pager.prototype.parent.constructor.call(this, owner,options);
		this.className = "portalui_pager";
		window.portalui_pager.prototype.parent.setHeight.call(this, 30);
		window.portalui_pager.prototype.parent.setWidth.call(this, 320);		
...
window.portalui_pager.extend(window.portalui_control);
window.pager = window.portalui_pager;
window.portalui_pager.implement({
	...
	setWidth: function(data){
		window.portalui_pager.prototype.parent.setWidth.call(this, data);	
