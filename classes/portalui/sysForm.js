...
window.portalui_sysForm = function(owner, options){
    if (owner){
		this.color = '#ffffff';//system.getConfig("form.color");
		this.caption = "Form";
		window.portalui_sysForm.prototype.parent.constructor.call(this, owner, options);
...
window.portalui_sysForm.extend(window.portalui_commonForm);
window.sysForm = window.portalui_sysForm;
window.portalui_sysForm.implement({
	doDraw: function(canvas){
		try{
			canvas.style.border = "1px solid #ffffff";
			window.portalui_sysForm.prototype.parent.doDraw.call(this, canvas);
	...
	doActivate: function(){
	    window.portalui_sysForm.prototype.parent.doActivate.call(this);
	    
	    var node = $(this.getFullId() + "_title");
	    node.style.color = system.getConfig("form.titleFontColor");	
	},
	doDeactivate: function(){
	    window.portalui_sysForm.prototype.parent.doDeactivate.call(this);
	...
	close: function(){
		if (this.closeToHide)
			...
			window.portalui_sysForm.prototype.parent.close.call(this);
	},
