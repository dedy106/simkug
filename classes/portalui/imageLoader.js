...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_imageLoader = function(owner){
    if (owner){
		this.color = '#ffffff';//system.getConfig("form.color");
		this.caption = "Form";
        window.portalui_imageLoader.prototype.parent.constructor.call(this, owner);
        this.className = "portalui_imageLoader";        
        this.mouseMode = 0;        
...
window.portalui_imageLoader.extend(window.portalui_commonForm);
window.imageLoader = window.portalui_imageLoader;
window.portalui_imageLoader.implement({
	doDraw: function(canvas){
		canvas.style.border = "1px solid #ffffff";
		//window.portalui_imageLoader.prototype.parent.doDraw.call(this, canvas);
	...
	doActivate: function(){
		window.portalui_imageLoader.prototype.parent.doActivate.call(this);     
	},
	doDeactivate: function(){
		window.portalui_imageLoader.prototype.parent.doDeactivate.call(this);
    },
	getCaption: function(){
		return this.caption;
	},
	...
	close: function(){
		window.portalui_imageLoader.prototype.parent.close.call(this);	
	},
