...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_selection = function(owner, options){
    if (owner){
		this.stateRO 	= "";
		this.type 		= "text";
		this.color      = "#ffffff";
		...
		window.portalui_selection.prototype.parent.constructor.call(this, owner, options);
		this.className = "portalui_selection";
		this.setWidth(80);
		window.portalui_selection.prototype.parent.setHeight.call(this, 20);
		this.wantTab = false;
		this.tabStop = true;
		this.password = false;
		this.readOnly = false;
...
window.portalui_selection.extend(window.portalui_control);
window.selection = window.portalui_selection;
window.portalui_selection.implement({
	...
	setHeight: function(data){
		window.portalui_selection.prototype.parent.setHeight.call(this, data);
	...
	setWidth: function(data){
		var n = this.getFullId();
		var nd = $(n);
		window.portalui_selection.prototype.parent.setWidth.call(this,data); 	
		this.doDraw(nd);	
	},
