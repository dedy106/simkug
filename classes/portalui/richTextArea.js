...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_richTextArea = function(owner, options){
    if (owner){        
		window.portalui_richTextArea.prototype.parent.constructor.call(this, owner, options);		
...
window.portalui_richTextArea.extend(window.portalui_control);
window.richTextArea = window.portalui_richTextArea;
//---------------------------- Function ----------------------------------------
window.portalui_richTextArea.implement({
	...
	setHeight: function(data){
		window.portalui_richTextArea.prototype.parent.setHeight.call(this, data);
		this.wysiwyg_content.style.height = data - (document.all ? 32: 30);	
	},
	setWidth: function(data){
		window.portalui_richTextArea.prototype.parent.setWidth.call(this, data);
