...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_flashChart = function(owner, options){	
	try
	{
		window.portalui_flashChart.prototype.parent.constructor.call(this,owner, options);
		this.className = "portalui_flashChart";							
...
window.portalui_flashChart.extend(window.portalui_control);
window.flashChart = window.portalui_flashChart;
window.portalui_flashChart.implement({
