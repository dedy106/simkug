...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_hintFrame = function(owner){
    if (owner)
    {
        window.portalui_hintFrame.prototype.parent.constructor.call(this, owner);
		this.className = "portalui_hintFrame";		
...
window.portalui_hintFrame.extend(window.portalui_commonForm);
window.hintFrame = window.portalui_hintFrame;
//---------------------------- Function ----------------------------------------
window.portalui_hintFrame.implement({
