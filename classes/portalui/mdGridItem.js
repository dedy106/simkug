...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_mdGridItem = function(parent, owner, index){
	try{
		if (owner){
			this.parent = parent;
			this.grid = owner;
			...
			this.rowIndex = index;
			window.portalui_mdGridItem.prototype.parent.constructor.call(this, parent);	
...
window.portalui_mdGridItem.extend(window.portalui_containerControl);
window.mdGridItem = window.portalui_mdGridItem;
window.portalui_mdGridItem.implement({
...
//			nodeCel.style.background = "#F0F9EF";
	...
	addChild: function(child){
		window.portalui_mdGridItem.prototype.parent.addChild.call(this, child);	
...
//		this.onSelect.call(this);
	...
	treeMouseUp: function(event){
	    ...
	    if ((target != undefined) && (target.id == (n + "_frame")))
	        window.portalui_mdGridItem.prototype.parent.eventMouseUp.call(this, event);
	},
	...
	setWidth: function(data){
		window.portalui_mdGridItem.prototype.parent.setWidth.call(this, data);
		var form = $(this.getFullId() +"form");
