...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_system = function(options){	
	try
	{		
		...
		window.portalui_system.prototype.parent.constructor.call(this,"system");
...
window.portalui_system.extend(window.portalui_containerControl);
window.portalui_system.implement({
