...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_eventHandler = function(target, method){
	try
	{		
        window.portalui_eventHandler.prototype.parent.constructor.call(this);
        this.className = "portalui_eventHandler";       
        this.target = target;
        this.method = method;
    }catch(e)
	{
...
window.portalui_eventHandler.extend(window.Function);
window.eventHandler = window.portalui_eventHandler;
window.portalui_eventHandler.prototype.toString = function()
{
    return this.method + "@" + this.target;
};
//---------------------------- Function ----------------------------------------
window.portalui_eventHandler.implement({
