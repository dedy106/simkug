...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_frameNavigator = function(owner){
	if (owner){
		window.portalui_frameNavigator.prototype.parent.constructor.call(this, owner);
		this.className = "portalui_frameNavigator";		
	}
};
window.portalui_frameNavigator.extend(window.portalui_commonForm);
window.frameNavigator = window.portalui_frameNavigator;
window.portalui_frameNavigator.implement({
