...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_progressbar = function(owner){
    if (owner){
		this.withImage = false;
		this.color = system.getConfig("form.button.color");
        window.portalui_progressbar.prototype.parent.constructor.call(this, owner);
        this.className = "portalui_progressbar";	
		this.owner = owner;
				
        window.portalui_progressbar.prototype.parent.setWidth.call(this, 73);
        window.portalui_progressbar.prototype.parent.setHeight.call(this, 18);
...
window.portalui_progressbar.extend(window.portalui_control);
window.progressbar = window.portalui_progressbar;
window.portalui_progressbar.implement({
