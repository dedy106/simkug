...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_saiCBBL = function(owner, options){
    if (owner){
		this.stateRO 	= "";
		this.text 		= "";
		...
		this.width = 80;
		window.portalui_saiCBBL.prototype.parent.constructor.call(this, owner, options);
		this.className = "portalui_saiCBBL";        
		window.portalui_saiCBBL.prototype.parent.setWidth.call(this, 80);
		window.portalui_saiCBBL.prototype.parent.setHeight.call(this, 20);
...
window.portalui_saiCBBL.extend(window.portalui_control);
window.saiCBBL = window.portalui_saiCBBL;
window.boFULL = 2;
window.boHALF = 1;
window.boNONE = 0;
window.portalui_saiCBBL.implement({
	doDraw: function(canvas){
		...
		if (document.all)	
			html =    "<div id='"+n+"_frame' style='{position: absolute;left: 0;top: 0;width:auto;height: 100%;}'> "+
				...
				"<div id='"+n+"_rightlabel' style='{position:absolute; left:"+lft2+";top:3;width:100%;height:100%;white-space: nowrap}'>"+this.rightLabelCaption+			
					"</div>"+
				"</div>";
		else 
			html =   "<div id='"+n+"_frame' style='{position: absolute;left: 0;top: 0;width:autp;height: 100%;}'> "+
				...
				"</div>"+//this.rightLabelWidth+"px
				"<div id='"+n+"_rightlabel' style='{position:absolute; left:"+lft2+";top:3;width:100%;height:100%;white-space: nowrap;text-overflow:ellipsis;overflow:hidden}'>"+this.rightLabelCaption+			
					"</div>"+
				"</div>";			
	...
	doLostFocus: function(fromEdit){
		window.portalui_saiCBBL.prototype.parent.doLostFocus.call(this);
	...
	setWidth: function(data){
		var n = this.getFullId();
		var nd = $(n);
		window.portalui_saiCBBL.prototype.parent.setWidth.call(this,data); 
		this.doDraw(nd);
	},
	...
	setRightLabelCaption: function(data){
		...
		if (canvas != undefined)
		{
			...
			if ( this.rightLabelWidth > 200) this.rightLabelWidth = 200;
	...
	free: function(){
		...
		window.portalui_saiCBBL.prototype.parent.free.call(this);	
	},	
