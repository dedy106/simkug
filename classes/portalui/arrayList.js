...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_arrayList = function(options){
	window.portalui_arrayList.prototype.parent.constructor.call(this);	
	this.objList = new Array();
	this.className = "portalui_arrayList";
	this.tag1 = 0;
	this.tag2 = 0;
	this.tag3 = 0;
	uses("portalui_eventHandler");
	this.onCreateObject = new portalui_eventHandler();
...
window.portalui_arrayList.extend(window.portalui_XMLAble);
window.arrayList = window.portalui_arrayList;
window.portalui_arrayList.prototype.toString = function(){
	return "portalui_arrayList [" + this.getLength() + " objects]";
};
window.portalui_arrayList.implement({
	doSerialize: function(){
		window.portalui_arrayList.prototype.parent.doSerialize.call(this);
	    ...
	    for (var j in this.objList)
	    {
	    	...
	    	else if (value instanceof portalui_XMLAble)
	...
	fromXMLNode: function(node){
	    window.portalui_arrayList.prototype.parent.fromXMLNode.call(this, node);	    
	                    ...
	                    if (childNode.attribute("isNull") != "true"){
	                        switch (type)
	                        {
	                			...
	                			default         :
	                							...
	                							if (value instanceof portalui_XMLAble)
	...
	addAll: function(otherList){	
		if (otherList instanceof portalui_arrayList){
