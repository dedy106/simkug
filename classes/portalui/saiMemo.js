...
//* 			SAI, PT											
//***********************************************************************************************
window.portalui_saiMemo = function(owner, options){
    if (owner){
		this.stateRO 	= "";
        this.text 		= "";
		...
		window.portalui_saiMemo.prototype.parent.constructor.call(this, owner,options);
...
window.portalui_saiMemo.extend(window.portalui_control);
window.saiMemo = window.portalui_saiMemo;
window.portalui_saiMemo.implement({
	...
	setWidth: function(data){
		var n = this.getFullId();
		var nd = $(n);
		window.portalui_saiMemo.prototype.parent.setWidth.call(this,data); 
		this.doDraw(nd);
	},
	setHeight: function(data){
		var n = this.getFullId();
		var nd = $(n);
		window.portalui_saiMemo.prototype.parent.setHeight.call(this,data); 		
		this.doDraw(nd);
	},
