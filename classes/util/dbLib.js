...
window.util_dbLib.implement({
	getXMLDataViaURL: function(url){
		this.params.clear();
		this.params.add(url);
		this.callAsynch("getXMLDataViaURL");
	},
	...
	sqlToHtmlA: function(sql,page,rowPerPage, title,width, fieldType, withTotal,groupBy, summary, groupHeader,calFields, totalPerGroup){
		this.params.clear();
		this.params.add(sql);
		this.params.add(page);
		this.params.add(rowPerPage);
	...
	sqlToHtmlWithHeader: function(sql,page,rowPerPage, title,width, fieldType, withTotal,groupBy, summary, groupHeader,calFields, formHeader, lokasi, periode, totalPerGroup){
		this.params.clear();
		this.params.add(sql);
		this.params.add(page);
		this.params.add(rowPerPage);
		...
		this.params.add(totalPerGroup);
		this.callAsynch("sqlToHtmlWithHeader");
	},
	...
	loginAndLoad: function(sql, usr, pwd, ldap){
		this.params.clear();
		this.params.add(sql);		
		this.params.add(usr);		
		this.params.add(pwd);
		this.params.add(ldap);
		this.callAsynch("loginAndLoad");
	}
});
