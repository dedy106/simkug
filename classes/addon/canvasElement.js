...
(function () {
	 ...
	 */
	Canvas.Element.prototype.addImage = function(oImg, oTitle) {
		...
		if (oTitle !== undefined) this._aTitles[oImg._oElement.id] = oTitle;
		this.renderAll(false);
	...
	Canvas.Element.prototype.renderAll = function(allOnTop) {
		...
		for (var i = 0, l = this._aImages.length-1; i < l; i += 1) {
			this.drawImageElement(containerCanvas, this._aImages[i], this._aTitles[this._aImages[i]._oElement.id]);			
		}
		// we render the top context
		this.drawImageElement(this._oContextTop, this._aImages[this._aImages.length-1],this._aTitles[this._aImages[this._aImages.length-1]._oElement.id]);
	};
	 ...
	 */
	Canvas.Element.prototype.drawImageElement = function(context, oImg, oTitle) {
		...
		if (oTitle !== undefined) {              
            this.drawText(context,"Arial",12,-(oTitle.length * 6/ 2),(originalImgSize.height / 2) + 10,oTitle,"#ff9900" );			
        }
	...
	Canvas.Element.prototype.drawText = function(ctxt,font,size,x,y,text, color){
