...
//* 			SAI, PT											
//***********************************************************************************************
window.portalapp_fCustProfil = function(owner){
	try{
		if (owner)
		{
			window.portalapp_fCustProfil.prototype.parent.constructor.call(this, owner);
			window.portalapp_fCustProfil.prototype.parent.setBorder.call(this, 0);		
			window.portalapp_fCustProfil.prototype.parent.setColor.call(this, "");		
			this.className = "portalapp_fCustProfil";											
			this.initComponent();		
			this.title = "Edit Profil";
		}
	}catch(e)
	{
		systemAPI.alert("[portalapp_fCustProfil]::contruct:"+e,"");
	}
};
window.portalapp_fCustProfil.extend(window.portalui_panel);
window.portalapp_fCustProfil.implement({
