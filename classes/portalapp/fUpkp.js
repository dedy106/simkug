...
//* 			SAI, PT											
//***********************************************************************************************
window.portalapp_fUpkp = function(owner){
	try{
		if (owner)
		{
			window.portalapp_fUpkp.prototype.parent.constructor.call(this, owner);
			window.portalapp_fUpkp.prototype.parent.setBorder.call(this, 0);		
			window.portalapp_fUpkp.prototype.parent.setColor.call(this, "");		
			this.className = "portalapp_fUpkp";											
			this.initComponent();		
			this.title = "Unit UPKP";
		}
	}catch(e)
	{
		systemAPI.alert("[portalapp_fUpkp]::contruct:"+e,"");
	}
};
window.portalapp_fUpkp.extend(window.portalui_panel);
window.portalapp_fUpkp.implement({
