...
//* 			SAI, PT											
//***********************************************************************************************
window.portalapp_fPinjaman = function(owner){
	try{
		if (owner)
		{
			window.portalapp_fPinjaman.prototype.parent.constructor.call(this, owner);
			window.portalapp_fPinjaman.prototype.parent.setBorder.call(this, 0);		
			window.portalapp_fPinjaman.prototype.parent.setColor.call(this, "");		
			this.className = "portalapp_fPinjaman";											
			this.initComponent();		
			this.title = "Unit Pinjaman";
		}
	}catch(e)
	{
		systemAPI.alert("[portalapp_fPinjaman]::contruct:"+e,"");
	}
};
window.portalapp_fPinjaman.extend(window.portalui_panel);
window.portalapp_fPinjaman.implement({
