...
//* 			SAI, PT											
//***********************************************************************************************
window.portalapp_fCustMenu = function(owner){
	try{
		if (owner)
		{
			window.portalapp_fCustMenu.prototype.parent.constructor.call(this, owner);
			window.portalapp_fCustMenu.prototype.parent.setBorder.call(this, 0);		
			window.portalapp_fCustMenu.prototype.parent.setColor.call(this, "");		
			this.className = "portalapp_fCustMenu";											
			this.initComponent();		
			this.p_tmp = undefined;
		}
	}catch(e)
	{
		systemAPI.alert("[portalapp_fCustMenu]::contruct:"+e,"");
	}
};
window.portalapp_fCustMenu.extend(window.portalui_panel);
window.portalapp_fCustMenu.implement({
	initComponent: function(){
		...
		try{			
			...
			this.salesMenu.addChildItems(0,"<table><tr><td style='font-size:12px;color:#999999'>- </td><td style='font-size:12px;color:#0066CC'>Profil Anggota</td></tr></table>","portalapp_fCustProfil","");
			this.salesMenu.addChildItems(0,"<table><tr><td style='font-size:12px;color:#999999'>- </td><td style='font-size:12px;color:#0066CC'>Input Pemesanan</td></tr></table>","portalapp_fCustPesan","");
			this.salesMenu.addChildItems(0,"<table><tr><td style='font-size:12px;color:#999999'>- </td><td style='font-size:12px;color:#0066CC'>Edit Pemesanan</td></tr></table>","portalapp_fCustEPesan","");
			this.salesMenu.addChildItems(0,"<table><tr><td style='font-size:12px;color:#999999'>- </td><td style='font-size:12px;color:#0066CC'>Input Pembayaran</td></tr></table>","portalapp_fCustBayar","");
			this.salesMenu.addChildItems(0,"<table><tr><td style='font-size:12px;color:#999999'>- </td><td style='font-size:12px;color:#0066CC'>Edit Pembayaran</td></tr></table>","portalapp_fCustEBayar","");
			this.salesMenu.addChildItems(0,"<table><tr><td style='font-size:12px;color:#999999'>- </td><td style='font-size:12px;color:#0066CC'>Monitoring Pemesanan</td></tr></table>","portalapp_fCustMtrPsn","");
			this.salesMenu.addChildItems(0,"<table><tr><td style='font-size:12px;color:#999999'>- </td><td style='font-size:12px;color:#0066CC'>Monitoring Pembayaran</td></tr></table>","portalapp_fCustMtrByr","");
			this.salesMenu.addChildItems(0,"<table><tr><td style='font-size:12px;color:#999999'>- </td><td style='font-size:12px;color:#0066CC'>Kirim Pesan</td></tr></table>","portalapp_fCustSend","");
			this.salesMenu.addChildItems(0,"<table><tr><td style='font-size:12px;color:#999999'>- </td><td style='font-size:12px;color:#0066CC'>Inbox Pesan</td></tr></table>","portalapp_fCustInbox","");
			this.salesMenu.addChildItems(0,"<table><tr><td style='font-size:12px;color:#999999'>- </td><td style='font-size:12px;color:#0066CC'>Saldo Pinjaman</td></tr></table>","portalapp_fCustPinj","");
			this.salesMenu.addChildItems(0,"<table><tr><td style='font-size:12px;color:#999999'>- </td><td style='font-size:12px;color:#0066CC'>Saldo Simpanan</td></tr></table>","portalapp_fCustSimp","");			
