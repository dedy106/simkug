...
//* 			SAI, PT											
//***********************************************************************************************
window.portalapp_fProfil = function(owner){
	try{
		if (owner)
		{
			window.portalapp_fProfil.prototype.parent.constructor.call(this, owner);
			window.portalapp_fProfil.prototype.parent.setBorder.call(this, 0);		
			window.portalapp_fProfil.prototype.parent.setColor.call(this, "");		
			this.className = "portalapp_fProfil";											
			this.initComponent();		
		}
	}catch(e)
	{
		systemAPI.alert("[portalapp_fProfil]::contruct:"+e,"");
	}
};
window.portalapp_fProfil.extend(window.portalui_panel);
window.portalapp_fProfil.implement({
