...
//* 			SAI, PT											
//***********************************************************************************************
window.portalapp_fWisma = function(owner){
	try{
		if (owner)
		{
			window.portalapp_fWisma.prototype.parent.constructor.call(this, owner);
			window.portalapp_fWisma.prototype.parent.setBorder.call(this, 0);
			window.portalapp_fWisma.prototype.parent.setColor.call(this, "");
			this.className = "portalapp_fWisma";											
			this.initComponent();		
			this.title = "Unit Wisma Asri";
		}
	}catch(e)
	{
		systemAPI.alert("[portalapp_fWisma]::contruct:"+e,"");
	}
};
window.portalapp_fWisma.extend(window.portalui_panel);
window.portalapp_fWisma.implement({
