...
//* 			SAI, PT											
//***********************************************************************************************
window.portalapp_fCustPesan = function(owner){
	try{
		if (owner)
		{
			window.portalapp_fCustPesan.prototype.parent.constructor.call(this, owner);
			window.portalapp_fCustPesan.prototype.parent.setBorder.call(this, 0);		
			window.portalapp_fCustPesan.prototype.parent.setColor.call(this, "");		
			this.className = "portalapp_fCustPesan";											
			this.initComponent();		
			this.title = "Input Pemesanan";
		}
	}catch(e)
	{
		systemAPI.alert("[portalapp_fCustPesan]::contruct:"+e,"");
	}
};
window.portalapp_fCustPesan.extend(window.portalui_panel);
window.portalapp_fCustPesan.implement({
