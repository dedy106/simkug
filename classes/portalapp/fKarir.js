...
//* 			SAI, PT											
//***********************************************************************************************
window.portalapp_fKarir = function(owner){
	try{
		if (owner)
		{
			window.portalapp_fKarir.prototype.parent.constructor.call(this, owner);
			window.portalapp_fKarir.prototype.parent.setBorder.call(this, 0);		
			window.portalapp_fKarir.prototype.parent.setColor.call(this, "");		
			this.className = "portalapp_fKarir";											
			this.initComponent();		
			this.title = "Unit Karir";
		}
	}catch(e)
	{
		systemAPI.alert("[portalapp_fKarir]::contruct:"+e,"");
	}
};
window.portalapp_fKarir.extend(window.portalui_panel);
window.portalapp_fKarir.implement({
	...
	doLogin : function(sender){
		try{
			...
			systemAPI.alert("app_kopeg_transaksi_fTabToko::doLogin "+e);
		}
	},
	delTmpFile : function(){
		if (this.tmpFile != ""){
