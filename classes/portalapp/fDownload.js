...
//* 			SAI, PT											
//***********************************************************************************************
window.portalapp_fDownload = function(owner){
	try{
		if (owner)
		{
			window.portalapp_fDownload.prototype.parent.constructor.call(this, owner);
			window.portalapp_fDownload.prototype.parent.setBorder.call(this, 0);		
			window.portalapp_fDownload.prototype.parent.setColor.call(this, "");		
			this.className = "portalapp_fDownload";											
			this.initComponent();		
			this.title = "Download";
		}
	}catch(e)
	{
		systemAPI.alert("[portalapp_fDownload]::contruct:"+e,"");
	}
};
window.portalapp_fDownload.extend(window.portalui_panel);
window.portalapp_fDownload.implement({
