...
//* 			SAI, PT											
//***********************************************************************************************
window.portalapp_fCustBayar = function(owner){
	try{
		if (owner)
		{
			window.portalapp_fCustBayar.prototype.parent.constructor.call(this, owner);
			window.portalapp_fCustBayar.prototype.parent.setBorder.call(this, 0);		
			window.portalapp_fCustBayar.prototype.parent.setColor.call(this, "");		
			this.className = "portalapp_fCustBayar";											
			this.initComponent();		
			this.title = "Input Pembayaran";
		}
	}catch(e)
	{
		systemAPI.alert("[portalapp_fCustBayar]::contruct:"+e,"");
	}
};
window.portalapp_fCustBayar.extend(window.portalui_panel);
window.portalapp_fCustBayar.implement({
