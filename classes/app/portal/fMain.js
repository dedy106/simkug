...
//* 			SAI, PT											
//***********************************************************************************************
window.app_portal_fMain = function(owner)
{
	if (owner)
	{	
		try
		{
			window.app_portal_fMain.prototype.parent.constructor.call(this, owner);
			window.app_portal_fMain.prototype.parent.setWidth.call(this, 600);
			window.app_portal_fMain.prototype.parent.setHeight.call(this, 450);
			this._mainButtonClick = new portalui_eventHandler();
			this.title = "Portal Back End";
			document.title = "Portal Back End";
			this._isLogedIn	= false;
			this.app._kodeMenu = "PORTALMENU";
			this._userLog = "";
			this._lokasi = "";
			this._pp = "";
			...
			this.bRun = new portalui_imageButton(this.pTool,{bound:[5,5,17,15],hint:"Execute",image:"icon/"+system.getThemes()+"/ok.png",click:"doExecuteMenu"});									
			this.cb1 = new portalui_saiCB(this.pTool,{bound:[28,3,200,20],labelWidth:0,text:"",mustCheck:false,keyDown:[this,"doMenuKeyDown"]});					
			this.bSave = new portalui_imageButton(this.pTool,{bound:[235,5,17,15],hint:"Save",click:"doSave",image:"icon/"+system.getThemes()+"/bSave2.png"});
			this.separator1 = new portalui_image(this.pTool,{bound:[260,3,2,20],image:"icon/"+system.getThemes()+"/separator.png"});		
            this.bRecall = new portalui_imageButton(this.pTool,{bound:[265,5,17,15],hint:"Refresh",image:"icon/"+system.getThemes()+"/bRefresh.png", click:"doRecall"});				
			this.bBack = new portalui_imageButton(this.pTool,{bound:[285,5,17,15],hint:"Back",image:"icon/"+system.getThemes()+"/bBack.png"});			
			this.bExit = new portalui_imageButton(this.pTool,{bound:[305,5,17,15],hint:"Exit",click:"bTutupClick",image:"icon/"+system.getThemes()+"/bExit.png"});			
			...
			this.bFind = new portalui_imageButton(this.pTool,{bound:[350,5,17,15],hint:"Search",image:"icon/"+system.getThemes()+"/bFind.png",click:"alert('under contruction','')"});			
			this.separator3 = new portalui_image(this.pTool,{bound:[370,3,2,20],image:"icon/"+system.getThemes()+"/separator.png"});
			this.bNew = new portalui_imageButton(this.pTool,{bound:[375,5,17,15],hint:"Restart Session",image:"icon/"+system.getThemes()+"/bCreateSession.png",click:"createSession"});			
			this.bClose = new portalui_imageButton(this.pTool,{bound:[395,5,17,15],hint:"End Session",image:"icon/"+system.getThemes()+"/bEndSession.png",click:"doClose"});			
			...
			this.bGenLocal = new portalui_imageButton(this.pTool,{bound:[440,5,17,15],hint:"Front End",image:"icon/"+system.getThemes()+"/bGenLocal.png",click:"gotoFrontEnd"});
			this.bChat = new portalui_imageButton(this.pTool,{bound:[460,5,17,15],hint:"Chat",image:"icon/"+system.getThemes()+"/user.png",click:"doChat"});			
//-------------------------------------caption		
...
//------------------------------------ panel transaksi -------------------------
			...
			this.bTutup = new portalui_button(this.pButton,{bound:[this.width-90,4,80,20],caption:"Tutup",icon:"url(icon/"+system.getThemes()+"/exit.png)",hint:"Exit Modul",click:"bTutupClick"});
			this.bTutup.hide();			
...
//--------------------------------------------------
			...
			systemAPI.alert("[fMain]#constructor# ",e);
		}
	}	
};
window.app_portal_fMain.extend(window.portalui_form);
window.app_portal_fMain.implement({
	gotoLogin: function(){
		uses("app_portal_fLogin");
		this.form = new app_portal_fLogin(this);
