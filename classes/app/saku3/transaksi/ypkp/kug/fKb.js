window.app_saku3_transaksi_ypkp_kug_fKb = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_ypkp_kug_fKb.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_ypkp_kug_fKb";
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[5,12,990,257], childPage:["Data Item Jurnal"]});
...
window.app_saku3_transaksi_ypkp_kug_fKb.extend(window.childForm);
window.app_saku3_transaksi_ypkp_kug_fKb.implement({
