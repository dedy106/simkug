window.app_saku3_transaksi_bpr_fKartuPinjBrg = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fKartuPinjBrg.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bpr_fKartuPinjBrg";
...
window.app_saku3_transaksi_bpr_fKartuPinjBrg.extend(window.portalui_childForm);
window.app_saku3_transaksi_bpr_fKartuPinjBrg.implement({
