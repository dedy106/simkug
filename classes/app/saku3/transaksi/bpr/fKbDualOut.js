window.app_saku3_transaksi_bpr_fKbDualOut = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fKbDualOut.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bpr_fKbDualOut";
...
window.app_saku3_transaksi_bpr_fKbDualOut.extend(window.childForm);
window.app_saku3_transaksi_bpr_fKbDualOut.implement({	
