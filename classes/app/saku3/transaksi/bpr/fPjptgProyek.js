window.app_saku3_transaksi_bpr_fPjptgProyek = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fPjptgProyek.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bpr_fPjptgProyek";
...
window.app_saku3_transaksi_bpr_fPjptgProyek.extend(window.childForm);
window.app_saku3_transaksi_bpr_fPjptgProyek.implement({
	doHitungGar: function(){	
		...
		if (this.statusGar == "1") {
			var sakhir = 0;
			if (this.stsSimpan == 1) var data = this.dbLib.getDataProvider("select fn_release1('"+this.app._lokasi+"','"+this.e_akunbeban.getText()+"','"+this.cb_pp.getText()+"','-','"+this.e_periode.getText()+"') as gar ",true);
			else var data = this.dbLib.getDataProvider("select fn_release2('"+this.app._lokasi+"','"+this.e_akunbeban.getText()+"','"+this.cb_pp.getText()+"','-','"+this.e_periode.getText()+"','"+this.e_nb.getText()+"') as gar ",true);
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					sql.add("insert into angg_r(no_bukti,modul,kode_lokasi,kode_gar,kode_pp,kode_drk,periode1,periode2,dc,saldo,nilai) values "+												
							"('"+this.nb+"','PJPTG','"+this.app._lokasi+"','"+this.e_akunbeban.getText()+"','"+this.cb_pp.getText()+"','-','"+this.e_periode.getText()+"','"+this.e_periode.getText()+"','C',"+parseNilai(this.e_saldogar.getText())+","+parseNilai(this.e_nilaiptg.getText())+")");
