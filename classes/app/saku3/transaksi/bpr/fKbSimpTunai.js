window.app_saku3_transaksi_bpr_fKbSimpTunai = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fKbSimpTunai.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bpr_fKbSimpTunai";
...
window.app_saku3_transaksi_bpr_fKbSimpTunai.extend(window.childForm);
window.app_saku3_transaksi_bpr_fKbSimpTunai.implement({
	doHitCD : function() {
