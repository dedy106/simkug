window.app_saku3_transaksi_bpr_fPiuUmumRef = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fPiuUmumRef.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bpr_fPiuUmumRef";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Akru Piutang Umum Referensi", 0);	
		...
		this.e_kui = new saiLabelEdit(this.pc2.childPage[0],{bound:[750,16,210,20],caption:"No Kuitansi", maxLength:50,readOnly:false});
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[1,10,995,213], childPage:["Data Item Pdpt","Data Anggaran","Referensi"]});
		...
		this.cb_ref = new saiCBBL(this.pc1.childPage[2],{bound:[20,10,220,20],caption:"Referensi [PP]", multiSelection:false, maxLength:10, tag:9,change:[this,"doChange"]});								
...
window.app_saku3_transaksi_bpr_fPiuUmumRef.extend(window.childForm);
window.app_saku3_transaksi_bpr_fPiuUmumRef.implement({
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					if (this.stsSimpan == 0) {
						...
						sql.add("delete from pu_bill_d where no_piutang = '"+this.e_nb.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");						
						sql.add("delete from angg_r where no_bukti = '"+this.e_nb.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");
					}

					/*
						PPh tidak dijurnal, hanya dicatet
					*/
					
					sql.add("insert into pu_bill_d(no_piutang,kode_lokasi,no_dokumen,tanggal,keterangan,kode_project,kode_cust,kode_curr,kurs,nik_app,kode_pp,nilai,periode,nik_user,tgl_input,akun_piutang,posted,nilai_ppn,nilai_pph,akun_pph,no_kui,dc) values  "+
							"('"+this.e_nb.getText()+"','"+this.app._lokasi+"','"+this.e_dok.getText()+"','"+this.dp_d1.getDateString()+"','"+this.e_ket.getText()+"','-','"+this.cb_cust.getText()+"','IDR',1,'"+this.cb_app.getText()+"','"+this.cb_pp.getText()+"',"+parseNilai(this.e_nilai.getText())+",'"+this.e_periode.getText()+"','"+this.app._userLog+"',getdate(),'"+this.cb_akun.getText()+"','F',"+parseNilai(this.e_ppn.getText())+","+parseNilai(this.e_pph.getText())+",'"+this.cb_pph.getText()+"','"+this.e_kui.getText()+"','D')");								
			
					sql.add("insert into trans_m (no_bukti,kode_lokasi,tgl_input,nik_user,periode,modul,form,posted,prog_seb,progress,kode_pp,tanggal,no_dokumen,keterangan,kode_curr,kurs,nilai1,nilai2,nilai3,nik1,nik2,nik3,no_ref1,no_ref2,no_ref3,param1,param2,param3) values "+
							"('"+this.e_nb.getText()+"','"+this.app._lokasi+"',getdate(),'"+this.app._userLog+"','"+this.e_periode.getText()+"','AR','PIUUMUM','F','0','0','"+this.cb_pp.getText()+"','"+this.dp_d1.getDateString()+"','"+this.e_dok.getText()+"','"+this.e_ket.getText()+
							"','IDR',1,"+parseNilai(this.e_nilai.getText())+","+parseNilai(this.e_ppn.getText())+","+parseNilai(this.e_pph.getText())+",'"+this.cb_app.getText()+"','-','-','"+this.cb_akun.getText()+"','"+this.cb_pph.getText()+"','-','"+this.cb_cust.getText()+"','"+this.e_kui.getText()+"','-')");					

					sql.add("insert into trans_j (no_bukti,kode_lokasi,tgl_input,nik_user,periode,no_dokumen,tanggal,nu,kode_akun,dc,nilai,nilai_curr,keterangan,modul,jenis,kode_curr,kurs,kode_pp,kode_drk,kode_cust,kode_vendor,no_fa,no_selesai,no_ref1,no_ref2,no_ref3) values "+
							"('"+this.e_nb.getText()+"','"+this.app._lokasi+"',getdate(),'"+this.app._userLog+"','"+this.e_periode.getText()+"','"+this.e_dok.getText()+"','"+this.dp_d1.getDateString()+"',0,'"+this.cb_akun.getText()+"','D',"+nilaiToFloat(this.e_total.getText())+","+nilaiToFloat(this.e_total.getText())+",'"+this.e_ket.getText()+"','PIUUMUM','PIU','IDR',1,'"+this.cb_pp.getText()+"','-','"+this.cb_cust.getText()+"','-','-','-','-','-','-')");										
					...
					if (this.sg.getRowValidCount() > 0){
						for (var i=0;i < this.sg.getRowCount();i++){
							if (this.sg.rowValid(i)){															
								var j = i+1;
								sql.add("insert into trans_j (no_bukti,kode_lokasi,tgl_input,nik_user,periode,no_dokumen,tanggal,nu,kode_akun,dc,nilai,nilai_curr,keterangan,modul,jenis,kode_curr,kurs,kode_pp,kode_drk,kode_cust,kode_vendor,no_fa,no_selesai,no_ref1,no_ref2,no_ref3) values "+
										"('"+this.e_nb.getText()+"','"+this.app._lokasi+"',getdate(),'"+this.app._userLog+"','"+this.e_periode.getText()+"','"+this.e_dok.getText()+"','"+this.dp_d1.getDateString()+"',"+j+",'"+this.sg.cells(0,i)+"','"+this.sg.cells(2,i)+"',"+parseNilai(this.sg.cells(4,i))+","+parseNilai(this.sg.cells(4,i))+",'"+this.sg.cells(3,i)+"','PIUUMUM','BBN','IDR',1,'"+this.sg.cells(5,i)+"','-','-','-','-','-','-','-','-')");								
							}
						}
					}
					if (nilaiToFloat(this.e_ppn.getText()) != 0) {
						sql.add("insert into trans_j (no_bukti,kode_lokasi,tgl_input,nik_user,periode,no_dokumen,tanggal,nu,kode_akun,dc,nilai,nilai_curr,keterangan,modul,jenis,kode_curr,kurs,kode_pp,kode_drk,kode_cust,kode_vendor,no_fa,no_selesai,no_ref1,no_ref2,no_ref3) values "+
							"('"+this.e_nb.getText()+"','"+this.app._lokasi+"',getdate(),'"+this.app._userLog+"','"+this.e_periode.getText()+"','"+this.e_dok.getText()+"','"+this.dp_d1.getDateString()+"',99,'"+this.akunPPN+"','C',"+nilaiToFloat(this.e_ppn.getText())+","+nilaiToFloat(this.e_ppn.getText())+",'"+this.e_ket.getText()+"','PIUUMUM','HUTPPN','IDR',1,'"+this.cb_pp.getText()+"','-','-','-','-','-','-','-','-')");						
					}
						...
						for (var i=0;i < this.sg2.getRowCount();i++){
							if (this.sg2.rowValid(i)){
								...
								sql.add("insert into angg_r(no_bukti,modul,kode_lokasi,kode_gar,kode_pp,kode_drk,periode1,periode2,dc,saldo,nilai,gar_thn,gar_tw,gar_bulan,no_ref,param1,param2) values "+
										"('"+this.e_nb.getText()+"','AR','"+this.app._lokasi+"','"+this.sg2.cells(0,i)+"','"+this.sg2.cells(1,i)+"','-','"+this.e_periode.getText()+"','"+this.e_periode.getText()+"','"+DC+"',"+parseNilai(this.sg2.cells(2,i))+","+nilai+",0,0,0,'-','-','-')");
							}
						}
					}
					setTipeButton(tbAllFalse);					
	...
	doClick:function(sender){		
		if (this.e_periode.getText()!= "") {
			...
			this.e_kui.setText(this.e_nb.getText());
			this.e_dok.setFocus();
	...
	doChange:function(sender){	
		try{
			if (sender == this.cb_pp && this.cb_pp.getText()!="") {
				this.cb_ref.setSQL("select kode_ref,nama from pu_ref_m where kode_pp='"+this.cb_pp.getText()+"' and flag_aktif='1' and kode_lokasi='"+this.app._lokasi+"'",["kode_ref","nama"],false,["Kode","Nama"],"and","Data Referensi",true); 			
			}
			if (sender == this.cb_ref && this.cb_ref.getText()!="") {
				...
				var data2 = this.dbLib.getDataProvider(
						"select a.kode_akun,b.nama as nama_akun,a.dc,a.keterangan,a.kode_pp,c.nama as nama_pp,a.nilai,d.akun_piu,d.akun_ppn,d.akun_pph "+
						"from pu_ref_j a inner join masakun b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi "+
						"                inner join pp c on a.kode_pp=c.kode_pp and a.kode_lokasi=c.kode_lokasi "+
						"				 inner join pu_ref_m d on a.kode_ref=d.kode_ref and a.kode_lokasi=d.kode_lokasi "+
						"where a.kode_ref = '"+this.cb_ref.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' order by a.nu",true);
				if (typeof data2 == "object" && data2.rs.rows[0] != undefined){
					...
					this.cb_akun.setText(line2.akun_piu);
					this.cb_pph.setText(line2.akun_pph);
					this.akunPPN = line2.akun_ppn;
				...
				switch(methodName){					
					case "execArraySQL" :	    				
						if (result.toLowerCase().search("error") == -1){
							if (this.preView == "1") {								
								this.nama_report="server_report_saku3_bpr_rptJurnalAkru";
	...
	doLoad3:function(sender){																				
		var strSQL = "select distinct a.no_piutang,convert(varchar,a.tanggal,103) as tgl,a.kode_cust+'-'+b.nama as cust,a.no_dokumen,a.keterangan,a.nilai+a.nilai_ppn as total "+
		             "from pu_bill_d a inner join cust b on a.kode_cust=b.kode_cust and a.kode_lokasi=b.kode_lokasi "+
					 "                 left join pu_bayar_d c on a.no_piutang=c.no_piutang and a.kode_lokasi=c.kode_lokasi "+
		...
		try{
			if (this.sg3.cells(0,row) != "") {
				...
				var strSQL = "select a.no_kui, a.tanggal,a.periode,a.no_dokumen,a.keterangan,a.kode_pp,a.akun_piutang,a.nik_app,a.kode_cust,c.nama as nama_cust,nilai_ppn , a.akun_pph,a.nilai_pph "+						 
							 "from pu_bill_d a inner join cust c on a.kode_cust=c.kode_cust and a.kode_lokasi=c.kode_lokasi "+
