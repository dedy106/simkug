window.app_saku3_transaksi_bpr_fPiuUmum = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fPiuUmum.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bpr_fPiuUmum";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Akru Piutang Umum", 0);	
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[1,10,995,213], childPage:["Data Item Pdpt","Data Anggaran"]});
...
window.app_saku3_transaksi_bpr_fPiuUmum.extend(window.childForm);
window.app_saku3_transaksi_bpr_fPiuUmum.implement({
