window.app_saku3_transaksi_bpr_fNeraca = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fNeraca.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku3_transaksi_bpr_fNeraca";
...
window.app_saku3_transaksi_bpr_fNeraca.extend(window.portalui_childForm);
window.app_saku3_transaksi_bpr_fNeraca.implement({
		...
		{ 
			...
			}else
			{
				if (sender == this.addBtn || sender == this.editBtn){
					uses("app_saku3_transaksi_bpr_fNeracaDetail");
					if (this.entryMenu == undefined)
						this.entryMenu = new app_saku3_transaksi_bpr_fNeracaDetail(this.app,this.e0.getText());
