window.app_saku3_transaksi_bpr_fKbDRK = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fKbDRK.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bpr_fKbDRK";
...
window.app_saku3_transaksi_bpr_fKbDRK.extend(window.childForm);
window.app_saku3_transaksi_bpr_fKbDRK.implement({
