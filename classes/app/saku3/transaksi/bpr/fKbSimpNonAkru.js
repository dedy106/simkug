window.app_saku3_transaksi_bpr_fKbSimpNonAkru = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fKbSimpNonAkru.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bpr_fKbSimpNonAkru";
...
window.app_saku3_transaksi_bpr_fKbSimpNonAkru.extend(window.childForm);
window.app_saku3_transaksi_bpr_fKbSimpNonAkru.implement({
