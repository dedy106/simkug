window.app_saku3_transaksi_bpr_fKartuPinjSawal = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fKartuPinjSawal.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bpr_fKartuPinjSawal";
...
window.app_saku3_transaksi_bpr_fKartuPinjSawal.extend(window.portalui_childForm);
window.app_saku3_transaksi_bpr_fKartuPinjSawal.implement({
