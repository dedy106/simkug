window.app_saku3_transaksi_bpr_fPjptgBDDproyek = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fPjptgBDDproyek.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bpr_fPjptgBDDproyek";
...
window.app_saku3_transaksi_bpr_fPjptgBDDproyek.extend(window.childForm);
window.app_saku3_transaksi_bpr_fPjptgBDDproyek.implement({
