window.app_saku3_transaksi_bpr_fPjptgSimpleBDD = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fPjptgSimpleBDD.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bpr_fPjptgSimpleBDD";
...
window.app_saku3_transaksi_bpr_fPjptgSimpleBDD.extend(window.childForm);
window.app_saku3_transaksi_bpr_fPjptgSimpleBDD.implement({
