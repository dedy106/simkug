window.app_saku3_transaksi_bpr_fBebanProyekDummy = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fBebanProyekDummy.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bpr_fBebanProyekDummy";
...
window.app_saku3_transaksi_bpr_fBebanProyekDummy.extend(window.childForm);
window.app_saku3_transaksi_bpr_fBebanProyekDummy.implement({
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					sql.add("insert into pr_or_d (no_bukti,kode_lokasi,periode,kode_proyek,kode_akun,dc,nilai,jenis,kode_pp,kode_drk,no_reverse) values "+
							"('"+this.e_nb.getText()+"','"+this.app._lokasi+"','"+this.e_periode.getText()+"','"+this.cb_proyek.getText()+"','"+this.cb_akun.getText()+"','D',"+nilaiToFloat(this.e_nilai.getText())+",'BBNDUMMY','"+this.cb_pp.getText()+"','-','-')");								
