window.app_saku3_transaksi_bpr_fBidang = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fBidang.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bpr_fBidang";
...
window.app_saku3_transaksi_bpr_fBidang.extend(window.childForm);
window.app_saku3_transaksi_bpr_fBidang.implement({
