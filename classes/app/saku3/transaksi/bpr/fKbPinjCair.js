window.app_saku3_transaksi_bpr_fKbPinjCair = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fKbPinjCair.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bpr_fKbPinjCair";
...
window.app_saku3_transaksi_bpr_fKbPinjCair.extend(window.childForm);
window.app_saku3_transaksi_bpr_fKbPinjCair.implement({
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					sql.add("insert into trans_m (no_bukti,kode_lokasi,tgl_input,nik_user,periode,modul,form,posted,prog_seb,progress,kode_pp,tanggal,no_dokumen,keterangan,kode_curr,kurs,nilai1,nilai2,nilai3,nik1,nik2,nik3,no_ref1,no_ref2,no_ref3,param1,param2,param3) values "+
							"('"+this.e_nb.getText()+"','"+this.app._lokasi+"',getdate(),'"+this.app._userLog+"','"+this.e_periode.getText()+"','KP','PINJCAIR','F','0','0','"+this.app._kodePP+"','"+this.dp_d1.getDateString()+"','"+this.e_dok.getText()+"','"+this.e_ket.getText()+
							"','IDR',1,"+parseNilai(this.e_total.getText())+",0,0,'-','-','-','"+this.cb_akun.getText()+"','-','-','-','"+this.c_jenis.getText()+"','-')");
					
					var kasIDR = nilaiToFloat(this.e_total.getText());
					sql.add("insert into trans_j (no_bukti,kode_lokasi,tgl_input,nik_user,periode,no_dokumen,tanggal,nu,kode_akun,dc,nilai,nilai_curr,keterangan,modul,jenis,kode_curr,kurs,kode_pp,kode_drk,kode_cust,kode_vendor,no_fa,no_selesai,no_ref1,no_ref2,no_ref3) values "+
							"('"+this.e_nb.getText()+"','"+this.app._lokasi+"',getdate(),'"+this.app._userLog+"','"+this.e_periode.getText()+"','-','"+this.dp_d1.getDateString()+"',0,'"+this.cb_akun.getText()+"','C',"+nilaiToFloat(this.e_total.getText())+","+kasIDR+",'"+this.e_ket.getText()+"','PINJCAIR','KB','IDR',1,'"+this.app._kodePP+"','-','-','-','-','-','-','-','-')");
					...
					for (var i=0;i < this.sg1.getRowCount();i++){
						if (this.sg1.rowValid(i) && this.sg1.cells(0,i) == "CAIR"){
							...
							sql.add("insert into trans_j (no_bukti,kode_lokasi,tgl_input,nik_user,periode,no_dokumen,tanggal,nu,kode_akun,dc,nilai,nilai_curr,keterangan,modul,jenis,kode_curr,kurs,kode_pp,kode_drk,kode_cust,kode_vendor,no_fa,no_selesai,no_ref1,no_ref2,no_ref3) values "+
									"('"+this.e_nb.getText()+"','"+this.app._lokasi+"',getdate(),'"+this.app._userLog+"','"+this.e_periode.getText()+"','"+this.sg1.cells(3,i)+"','"+this.dp_d1.getDateString()+"',"+i+",'"+this.sg1.cells(5,i)+"','D',"+nilaiPiu+","+nilaiPiu+",'Pencairan atas Pinj "+this.sg1.cells(3,i)+"','PINJCAIR','AR','IDR',1,'"+this.app._kodePP+"','-','-','-','-','-','-','-','-')");
							...
							var j = 300+i;							
							sql.add("insert into trans_j (no_bukti,kode_lokasi,tgl_input,nik_user,periode,no_dokumen,tanggal,nu,kode_akun,dc,nilai,nilai_curr,keterangan,modul,jenis,kode_curr,kurs,kode_pp,kode_drk,kode_cust,kode_vendor,no_fa,no_selesai,no_ref1,no_ref2,no_ref3) "+
									"select '"+this.e_nb.getText()+"','"+this.app._lokasi+"',getdate(),'"+this.app._userLog+"','"+this.e_periode.getText()+"',no_pinj,'"+this.dp_d1.getDateString()+"',"+j+",'"+this.akunAsu+"','C',nilai_prov,nilai_prov,'Titipan Asuransi atas "+this.sg1.cells(3,i)+"','PINJCAIR','ASURANSI','IDR',1,'"+this.app._kodePP+"','-','-','-','-','-','-','-','-' "+
					...
					if (this.sg.getRowValidCount() > 0) {
						for (var i=0;i < this.sg.getRowCount();i++){
							if (this.sg.rowValid(i)){
								...
								sql.add("insert into trans_j (no_bukti,kode_lokasi,tgl_input,nik_user,periode,no_dokumen,tanggal,nu,kode_akun,dc,nilai,nilai_curr,keterangan,modul,jenis,kode_curr,kurs,kode_pp,kode_drk,kode_cust,kode_vendor,no_fa,no_selesai,no_ref1,no_ref2,no_ref3) values "+
									"('"+this.e_nb.getText()+"','"+this.app._lokasi+"',getdate(),'"+this.app._userLog+"','"+this.e_periode.getText()+"','"+this.e_dok.getText()+"','"+this.dp_d1.getDateString()+"',"+i+",'"+this.sg.cells(0,i)+"','"+this.sg.cells(2,i).toUpperCase()+"',"+nilaiSlsIDR+",'"+nilaiToFloat(this.sg.cells(4,i))+"','"+this.sg.cells(3,i)+"','PINJCAIR','SLS','IDR',1,'"+this.app._kodePP+"','-','-','-','-','-','-','-','-')");
							}
						}
					}
					setTipeButton(tbAllFalse);					
