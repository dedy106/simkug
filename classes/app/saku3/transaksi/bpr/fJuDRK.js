window.app_saku3_transaksi_bpr_fJuDRK = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fJuDRK.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bpr_fJuDRK";
...
window.app_saku3_transaksi_bpr_fJuDRK.extend(window.childForm);
window.app_saku3_transaksi_bpr_fJuDRK.implement({				
