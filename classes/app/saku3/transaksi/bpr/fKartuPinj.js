window.app_saku3_transaksi_bpr_fKartuPinj = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fKartuPinj.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bpr_fKartuPinj";
...
window.app_saku3_transaksi_bpr_fKartuPinj.extend(window.portalui_childForm);
window.app_saku3_transaksi_bpr_fKartuPinj.implement({
	...
	doChange: function(sender){
		try{			
			...
			if (sender == this.e_materai || sender == this.e_provisi || sender == this.e_asur || sender == this.e_nilai) {
