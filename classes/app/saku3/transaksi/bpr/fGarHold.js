window.app_saku3_transaksi_bpr_fGarHold = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fGarHold.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku3_transaksi_bpr_fGarHold";
...
window.app_saku3_transaksi_bpr_fGarHold.extend(window.portalui_childForm);
window.app_saku3_transaksi_bpr_fGarHold.implement({	
