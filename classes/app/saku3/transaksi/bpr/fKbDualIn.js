window.app_saku3_transaksi_bpr_fKbDualIn = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fKbDualIn.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bpr_fKbDualIn";
...
window.app_saku3_transaksi_bpr_fKbDualIn.extend(window.childForm);
window.app_saku3_transaksi_bpr_fKbDualIn.implement({	
