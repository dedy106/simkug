window.app_saku3_transaksi_bpr_fKartuPinjBrgSawal = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fKartuPinjBrgSawal.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bpr_fKartuPinjBrgSawal";
...
window.app_saku3_transaksi_bpr_fKartuPinjBrgSawal.extend(window.portalui_childForm);
window.app_saku3_transaksi_bpr_fKartuPinjBrgSawal.implement({
