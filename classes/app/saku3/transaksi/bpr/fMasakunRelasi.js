window.app_saku3_transaksi_bpr_fMasakunRelasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fMasakunRelasi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bpr_fMasakunRelasi";
...
window.app_saku3_transaksi_bpr_fMasakunRelasi.extend(window.childForm);
window.app_saku3_transaksi_bpr_fMasakunRelasi.implement({
