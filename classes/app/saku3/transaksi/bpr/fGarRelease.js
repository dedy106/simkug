window.app_saku3_transaksi_bpr_fGarRelease = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fGarRelease.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku3_transaksi_bpr_fGarRelease";
...
window.app_saku3_transaksi_bpr_fGarRelease.extend(window.portalui_childForm);
window.app_saku3_transaksi_bpr_fGarRelease.implement({	
	doTampilClick: function() {
		...
		if (this.cb_gar.getText() == "") {
			filter = filter + " ";
			filter2 = " ";
		}
		else {
			filter = filter + " and a.kode_gar = '"+this.cb_gar.getText()+"' ";
			filter2 = " and b.kode_akun = '"+this.cb_gar.getText()+"' ";
		}
