window.app_saku3_transaksi_bpr_fBDDproyek = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fBDDproyek.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bpr_fBDDproyek";
...
window.app_saku3_transaksi_bpr_fBDDproyek.extend(window.childForm);
window.app_saku3_transaksi_bpr_fBDDproyek.implement({
