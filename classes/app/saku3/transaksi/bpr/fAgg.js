window.app_saku3_transaksi_bpr_fAgg = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fAgg.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bpr_fAgg";
...
window.app_saku3_transaksi_bpr_fAgg.extend(window.childForm);
window.app_saku3_transaksi_bpr_fAgg.implement({
