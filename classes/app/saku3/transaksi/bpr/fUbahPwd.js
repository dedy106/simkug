window.app_saku3_transaksi_bpr_fUbahPwd = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fUbahPwd.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bpr_fUbahPwd";
...
window.app_saku3_transaksi_bpr_fUbahPwd.extend(window.childForm);
window.app_saku3_transaksi_bpr_fUbahPwd.implement({
