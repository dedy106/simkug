window.app_saku3_transaksi_bpr_fKartuBDD = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fKartuBDD.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bpr_fKartuBDD";
...
window.app_saku3_transaksi_bpr_fKartuBDD.extend(window.portalui_childForm);
window.app_saku3_transaksi_bpr_fKartuBDD.implement({
