window.app_saku3_transaksi_bpr_fLokasi = function(owner){
	if (owner){
		window.app_saku3_transaksi_bpr_fLokasi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bpr_fLokasi";
		this.setTop(60);
		this.setWidth(1280);
		this.setHeight(550);
...
window.app_saku3_transaksi_bpr_fLokasi.extend(window.portalui_childForm);
window.app_saku3_transaksi_bpr_fLokasi.implement({
