window.app_saku3_transaksi_bpr_fUser = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fUser.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bpr_fUser";
...
window.app_saku3_transaksi_bpr_fUser.extend(window.childForm);
window.app_saku3_transaksi_bpr_fUser.implement({
