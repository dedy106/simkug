window.app_saku3_transaksi_bpr_fKaryawan = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fKaryawan.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bpr_fKaryawan";
...
window.app_saku3_transaksi_bpr_fKaryawan.extend(window.childForm);
window.app_saku3_transaksi_bpr_fKaryawan.implement({
	doLoadPP : function() {
