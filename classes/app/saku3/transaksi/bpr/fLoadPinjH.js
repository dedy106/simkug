window.app_saku3_transaksi_bpr_fLoadPinjH = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fLoadPinjH.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bpr_fLoadPinjH";
...
window.app_saku3_transaksi_bpr_fLoadPinjH.extend(window.childForm);
window.app_saku3_transaksi_bpr_fLoadPinjH.implement({
	...
	doChange: function(sender){
		if (sender == this.e_periode && this.e_periode.getText()!="") {
			this.e_nb.setSQL("select no_bukti, keterangan from trans_m where form in ('LOADPINJ') and posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"'",["no_bukti","keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);
		}
		if (sender == this.e_nb && this.e_nb.getText()!="") {			
			this.e_nilai.setText("0");						
			var data = this.dbLib.getDataProvider(
					   "select a.tanggal,a.keterangan,a.periode,a.no_ref1,a.nik1,a.nilai1 "+
					   "from trans_m a "+					   					  
