window.app_saku3_transaksi_bpr_fCustProyek = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fCustProyek.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bpr_fCustProyek";
...
window.app_saku3_transaksi_bpr_fCustProyek.extend(window.childForm);
window.app_saku3_transaksi_bpr_fCustProyek.implement({
	doCari: function() {
