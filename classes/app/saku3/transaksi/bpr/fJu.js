window.app_saku3_transaksi_bpr_fJu = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fJu.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bpr_fJu";
...
window.app_saku3_transaksi_bpr_fJu.extend(window.childForm);
window.app_saku3_transaksi_bpr_fJu.implement({				
