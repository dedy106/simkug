window.app_saku3_transaksi_bpr_fKbPiuProyek = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fKbPiuProyek.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bpr_fKbPiuProyek";
...
window.app_saku3_transaksi_bpr_fKbPiuProyek.extend(window.childForm);
window.app_saku3_transaksi_bpr_fKbPiuProyek.implement({
	doLoad : function() {
