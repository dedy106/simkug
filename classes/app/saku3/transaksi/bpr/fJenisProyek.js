window.app_saku3_transaksi_bpr_fJenisProyek = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fJenisProyek.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bpr_fJenisProyek";
...
window.app_saku3_transaksi_bpr_fJenisProyek.extend(window.childForm);
window.app_saku3_transaksi_bpr_fJenisProyek.implement({
