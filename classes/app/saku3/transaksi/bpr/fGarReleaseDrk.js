window.app_saku3_transaksi_bpr_fGarReleaseDrk = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fGarReleaseDrk.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku3_transaksi_bpr_fGarReleaseDrk";
...
window.app_saku3_transaksi_bpr_fGarReleaseDrk.extend(window.portalui_childForm);
window.app_saku3_transaksi_bpr_fGarReleaseDrk.implement({	
