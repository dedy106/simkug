window.app_saku3_transaksi_bpr_fRRApp = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fRRApp.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bpr_fRRApp";
...
window.app_saku3_transaksi_bpr_fRRApp.extend(window.childForm);
window.app_saku3_transaksi_bpr_fRRApp.implement({
