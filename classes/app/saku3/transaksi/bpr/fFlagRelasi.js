window.app_saku3_transaksi_bpr_fFlagRelasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fFlagRelasi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bpr_fFlagRelasi";
...
window.app_saku3_transaksi_bpr_fFlagRelasi.extend(window.childForm);
window.app_saku3_transaksi_bpr_fFlagRelasi.implement({
