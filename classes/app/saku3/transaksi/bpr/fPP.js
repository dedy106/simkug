window.app_saku3_transaksi_bpr_fPP = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fPP.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bpr_fPP";
...
window.app_saku3_transaksi_bpr_fPP.extend(window.childForm);
window.app_saku3_transaksi_bpr_fPP.implement({
