window.app_saku3_transaksi_bpr_fAkruSimp = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fAkruSimp.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bpr_fAkruSimp";
...
window.app_saku3_transaksi_bpr_fAkruSimp.extend(window.portalui_childForm);
window.app_saku3_transaksi_bpr_fAkruSimp.implement({
