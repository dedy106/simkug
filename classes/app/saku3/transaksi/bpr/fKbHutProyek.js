window.app_saku3_transaksi_bpr_fKbHutProyek = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fKbHutProyek.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bpr_fKbHutProyek";
...
window.app_saku3_transaksi_bpr_fKbHutProyek.extend(window.childForm);
window.app_saku3_transaksi_bpr_fKbHutProyek.implement({
	doLoad : function() {
