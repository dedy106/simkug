window.app_saku3_transaksi_bpr_fKbPiuUmum = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bpr_fKbPiuUmum.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bpr_fKbPiuUmum";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Penerimaan Piutang Umum", 0);	
...
window.app_saku3_transaksi_bpr_fKbPiuUmum.extend(window.childForm);
window.app_saku3_transaksi_bpr_fKbPiuUmum.implement({
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					if (this.stsSimpan == 0) {
						...
						sql.add("delete from pu_bayar_d where no_bukti = '"+this.e_nb.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");
					}
					
					sql.add("insert into trans_m (no_bukti,kode_lokasi,tgl_input,nik_user,periode,modul,form,posted,prog_seb,progress,kode_pp,tanggal,no_dokumen,keterangan,kode_curr,kurs,nilai1,nilai2,nilai3,nik1,nik2,nik3,no_ref1,no_ref2,no_ref3,param1,param2,param3) values "+
							"('"+this.e_nb.getText()+"','"+this.app._lokasi+"',getdate(),'"+this.app._userLog+"','"+this.e_periode.getText()+"','KB','KBPIU','F','0','0','"+this.app._kodePP+"','"+this.dp_d1.getDateString()+"','"+this.e_dok.getText()+"','"+this.e_ket.getText()+
							"','IDR',1,"+parseNilai(this.e_nilai.getText())+",0,0,'"+this.cb_app.getText()+"','-','-','"+this.cb_piutang.getText()+"','-','-','"+this.cb_cust.getText()+"','"+this.c_jenis.getText()+"','-')");
					
					sql.add("insert into trans_j (no_bukti,kode_lokasi,tgl_input,nik_user,periode,no_dokumen,tanggal,nu,kode_akun,dc,nilai,nilai_curr,keterangan,modul,jenis,kode_curr,kurs,kode_pp,kode_drk,kode_cust,kode_vendor,no_fa,no_selesai,no_ref1,no_ref2,no_ref3) values "+
							"('"+this.e_nb.getText()+"','"+this.app._lokasi+"',getdate(),'"+this.app._userLog+"','"+this.e_periode.getText()+"','"+this.cb_piutang.getText()+"','"+this.dp_d1.getDateString()+"',0,'"+this.akunPiutang+"','C',"+nilaiToFloat(this.e_nilai.getText())+","+nilaiToFloat(this.e_nilai.getText())+",'"+this.e_ket.getText()+"','KBPIU','PIU','IDR',1,'"+this.app._kodePP+"','-','"+this.cb_cust.getText()+"','-','-','-','-','-','-')");
					
					if (this.sg.getRowValidCount() > 0){
						for (var i=0;i < this.sg.getRowCount();i++){
							if (this.sg.rowValid(i)){																															
								sql.add("insert into trans_j (no_bukti,kode_lokasi,tgl_input,nik_user,periode,no_dokumen,tanggal,nu,kode_akun,dc,nilai,nilai_curr,keterangan,modul,jenis,kode_curr,kurs,kode_pp,kode_drk,kode_cust,kode_vendor,no_fa,no_selesai,no_ref1,no_ref2,no_ref3) values "+
										"('"+this.e_nb.getText()+"','"+this.app._lokasi+"',getdate(),'"+this.app._userLog+"','"+this.e_periode.getText()+"','"+this.e_dok.getText()+"','"+this.dp_d1.getDateString()+"',"+i+",'"+this.sg.cells(0,i)+"','"+this.sg.cells(2,i)+"',"+parseNilai(this.sg.cells(4,i))+","+parseNilai(this.sg.cells(4,i))+",'"+this.sg.cells(3,i)+"','KBPIU','KB','IDR',1,'"+this.sg.cells(5,i)+"','-','-','-','-','-','-','-','-')");
					
							}
						}
					}
					sql.add("insert into pu_bayar_d(no_bukti,no_piutang,kode_lokasi,modul,periode,nik_user,tgl_input,dc,nilai) values "+
	...
	doChange:function(sender){		
		if ((sender == this.e_periode || sender == this.cb_cust) && (this.e_periode.getText()!= "" && this.cb_cust.getText()!= "")) {			
			var strSQL = "select a.no_piutang,a.keterangan "+
						 ...
						 "             from pu_bayar_d "+
						 "			   where kode_lokasi='"+this.app._lokasi+"' group by no_piutang,kode_lokasi "+
		...
		if (sender == this.cb_piutang && this.cb_piutang.getText()!= "") {
			var strSQL = "select (a.nilai+a.nilai_ppn) -  isnull(b.bayar,0) as saldo, a.akun_piutang "+			             
						 ...
						 "               select no_piutang,kode_lokasi,sum(case dc when 'D' then nilai else -nilai end) as bayar "+
						 "               from pu_bayar_d "+
						 " 			     where no_bukti <> '"+this.e_nb.getText()+"' and kode_lokasi='"+this.app._lokasi+"' group by no_piutang,kode_lokasi "+						 
						 "				 ) b on a.no_piutang=b.no_piutang and a.kode_lokasi=b.kode_lokasi "+
		...
		if (sender == this.c_jenis && this.c_jenis.getText()!="") {
			if (this.stsSimpan == 1) this.doClick();
			if (this.c_jenis.getText() == "BM") var vFlagAkun = " in ('001','009','015') ";	
	...
	doDoubleClick3: function(sender, col , row) {
		try{
			if (this.sg3.cells(0,row) != "") {
				...
				var strSQL = "select a.akun_piutang,a.kode_cust,e.param2,e.periode,e.no_dokumen,e.tanggal,e.keterangan as ket_kas,e.nik1,e.no_ref1 "+
							 "from pu_bill_d a inner join trans_m e on e.no_ref1 = a.no_piutang and a.kode_lokasi=e.kode_lokasi "+							 
				...
				if (typeof data == "object"){
					...
					if (line != undefined){		
						...
						this.cb_cust.setSQL("select kode_cust, nama from cust where kode_cust='"+line.kode_cust+"' and  kode_lokasi='"+this.app._lokasi+"'",["kode_cust","nama"],false,["Kode","Nama"],"and","Data Customer",true);												
						var strSQL = "select a.no_piutang,a.keterangan "+
									 "from pu_bill_d a "+										
									 "where a.no_piutang='"+line.no_ref1+"' and a.kode_lokasi='"+this.app._lokasi+"'";
						this.cb_piutang.setSQL(strSQL,["a.no_piutang","a.keterangan"],false,["No Bukti","Keterangan"],"and","Data Piutang",true);											
