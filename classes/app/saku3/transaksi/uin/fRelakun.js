window.app_saku3_transaksi_uin_fRelakun = function(owner,lokasi)
{
	if (owner)
	{
		window.app_saku3_transaksi_uin_fRelakun.prototype.parent.constructor.call(this, owner);
		window.app_saku3_transaksi_uin_fRelakun.prototype.parent.setWidth.call(this, 800);
		window.app_saku3_transaksi_uin_fRelakun.prototype.parent.setHeight.call(this, 400);
		
		this.centerize();
		
		this.className = "app_saku3_transaksi_uin_fRelakun";
		
		this.mouseX = 0;
		this.mouseY = 0;					
		
		this.p1 = new panel(this,{bound:[10,10,this.width - 40,this.height - 100],caption:"Relasi Akun"});				
		
		uses("saiGrid");
		this.eSearch = new saiLabelEdit(this.p1,{bound:[5,25,245,20], caption:"Akun"});
		this.bCari = new button(this.p1, {bound:[250,25,80,20],caption:"Cari", click:[this,"doCariClick"]});
		this.sg1 = new saiGrid(this.p1,{bound:[5,50,345,277], colCount:2,colTitle:["Kode Akun","Nama"], 
				colWidth:[[1,0],[200,80]],dblClick:[this,"doDblClick"],
				readOnly:true
			});				
		this.sg = new saiGrid(this.p1,{bound:[400,50,345,300],
...
window.app_saku3_transaksi_uin_fRelakun.extend(window.commonForm);
window.app_saku3_transaksi_uin_fRelakun.implement({
	...
	setWidth: function(data){
		window.app_saku3_transaksi_uin_fRelakun.prototype.parent.setWidth.call(this, data);
		this.header.style.width = data - 23;
		this.rBg.style.left = data - 23;
	},
	doSysMouseMove: function(x, y, button, buttonState){
		window.app_saku3_transaksi_uin_fRelakun.prototype.parent.doSysMouseMove.call(this,x, y, button, buttonState);
		if (this.isClick)
		{		
	...
	doCariClick: function(sender){
		try{
			...
			var nrc = this.dblib.getDataProvider("select a.kode_akun, a.nama from masakun a "+
						" where a.kode_lokasi = '"+this.elokasi+"' and (kode_akun like '"+this.eSearch.getText()+"%' or a.nama like '"+this.eSearch.getText()+"%' ) "+ 				
