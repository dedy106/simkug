window.app_saku3_transaksi_uin_fKuota = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_uin_fKuota.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_uin_fKuota";
...
window.app_saku3_transaksi_uin_fKuota.extend(window.childForm);
window.app_saku3_transaksi_uin_fKuota.implement({
