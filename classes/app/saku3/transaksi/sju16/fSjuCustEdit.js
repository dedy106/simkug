window.app_saku3_transaksi_sju16_fSjuCustEdit = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_sju16_fSjuCustEdit.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_sju16_fSjuCustEdit";
		...
		this.e_nama = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,13,500,20],caption:"Nama", maxLength:50, tag:1, readOnly:true});
		this.e_nama2 = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,16,300,20],caption:"Inisial", maxLength:50, tag:1, readOnly:true});		
		this.cb_pp = new saiCBBL(this.pc1.childPage[1],{bound:[20,15,220,20],caption:"PP Ttg/Segmen",maxLength:10, tag:2, readOnly:true});		
		this.cb_tagih = new saiCBBL(this.pc1.childPage[1],{bound:[20,13,220,20],caption:"Cust Tagihan",  maxLength:10, tag:1, readOnly:true});
		this.cb_klp = new saiCBBL(this.pc1.childPage[1],{bound:[20,15,220,20],caption:"Group Ttg",  maxLength:10, tag:2, readOnly:true});		
		this.c_jenis = new saiCB(this.pc1.childPage[1],{bound:[20,16,200,20],caption:"Various", readOnly:true,tag:2, readOnly:true});				
...
window.app_saku3_transaksi_sju16_fSjuCustEdit.extend(window.childForm);
window.app_saku3_transaksi_sju16_fSjuCustEdit.implement({
	doCari: function() {
