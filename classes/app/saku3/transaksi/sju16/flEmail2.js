window.app_saku3_transaksi_sju16_flEmail2 = function (owner) {
    if (owner) {
        window.app_saku3_transaksi_sju16_flEmail2.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_transaksi_sju16_flEmail2";
        this.maximize();
...
window.app_saku3_transaksi_sju16_flEmail2.extend(window.childForm);
window.app_saku3_transaksi_sju16_flEmail2.implement({
    doLoad: function () {
        try {
            ...
            var nama_report = "server_report_saku3_sju16_rptEmail2";
            this.filter = "";
            this.showFilter = "";
            this.lokasi = "";
