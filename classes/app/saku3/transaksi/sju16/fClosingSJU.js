window.app_saku3_transaksi_sju16_fClosingSJU = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_sju16_fClosingSJU.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_sju16_fClosingSJU";
...
window.app_saku3_transaksi_sju16_fClosingSJU.extend(window.childForm);
window.app_saku3_transaksi_sju16_fClosingSJU.implement({	
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					if (this.isPostedAll(this.app._periode)) {	
						...
						/*
						//HARUS DUA FORM,,, JP DAN CLOSING
						
						langkah2:
						1. seting periode di tabel periode 20xx16
						2. buka/aktifkan koding jurnal penutup
						3. eksekusi closing
						4. login ulang
						5. buka koding closing (tutup jurnal penutup)
						6. eksekusi clsoing
						7. matikan koding semua
		...
		switch (event){
			...
			case "simpan" :					
				if (this.maxPeriode != parseInt(this.app._periode.substr(4,2))) {
					system.alert(this,"Periode transaksi Closing tidak valid.","Periode Closing harus "+this.maxPeriode+".");
					return false;
				}
