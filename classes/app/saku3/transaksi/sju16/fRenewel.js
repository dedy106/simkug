window.app_saku3_transaksi_sju16_fRenewel = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_sju16_fRenewel.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_sju16_fRenewel";
		...
		this.pc2 = new pageControl(this,{bound:[10,10,1000,430], childPage:["Data Renewel","List Renewel"]});		
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[5,20,990,303], childPage:["Filter Cari","Data Polis","Detail Polis"]});		
		this.l_tgl2 = new portalui_label(this.pc1.childPage[0],{bound:[20,12,100,18],caption:"Period of Insurance", underline:true});
		this.dp_d2 = new portalui_datePicker(this.pc1.childPage[0],{bound:[120,12,100,18]}); 		
		this.dp_d3 = new portalui_datePicker(this.pc1.childPage[0],{bound:[250,12,100,18]}); 	
		this.cb_cust = new saiCBBL(this.pc1.childPage[0],{bound:[20,16,220,20],caption:"Tertanggung", multiSelection:false, maxLength:10, tag:2 });
		this.cb_pic = new saiCBBL(this.pc1.childPage[0],{bound:[20,17,220,20],caption:"Acc. Marketing", multiSelection:false, maxLength:10, tag:2 });
		this.cb_tipe = new saiCBBL(this.pc1.childPage[0],{bound:[20,18,220,20],caption:"COB", multiSelection:false, maxLength:10, tag:2 });		
		this.bLoad = new button(this.pc1.childPage[0],{bound:[120,11,80,18],caption:"Load Data",click:[this,"doLoad"]});								
		...
		this.sgn1 = new portalui_sgNavigator(this.pc1.childPage[1],{bound:[0,this.pc1.height-25,this.pc1.width-1,25],buttonStyle:3,grid:this.sg1,pager:[this,"doPager"]});
   	    ...
   	    this.e_pp = new saiLabelEdit(this.pc1.childPage[2],{bound:[20,12,450,20],caption:"Segmen", readOnly:true,tag:9});		
		this.e_dok = new saiLabelEdit(this.pc1.childPage[2],{bound:[20,17,450,20],caption:"No Polis", readOnly:true ,tag:9});						
		this.e_dok2 = new saiLabelEdit(this.pc1.childPage[2],{bound:[500,17,430,20],caption:"No Sertifikat", readOnly:true,tag:9});
		this.e_noplacing = new saiLabelEdit(this.pc1.childPage[2],{bound:[20,11,450,20],caption:"No Placing", readOnly:true ,tag:9});
		this.e_tgl = new saiLabelEdit(this.pc1.childPage[2],{bound:[500,11,430,20],caption:"Period of Insurance", readOnly:true,tag:9});				
		this.e_noquo = new saiLabelEdit(this.pc1.childPage[2],{bound:[20,16,450,20],caption:"No Quotation", readOnly:true,tag:9});
		this.e_vendor = new saiLabelEdit(this.pc1.childPage[2],{bound:[500,16,430,20],caption:"Penanggung", readOnly:true,tag:9});
		this.e_cust = new saiLabelEdit(this.pc1.childPage[2],{bound:[20,12,450,20],caption:"Tertanggung", readOnly:true,tag:9});
		this.e_pic = new saiLabelEdit(this.pc1.childPage[2],{bound:[20,15,450,20],caption:"Acc Exec", readOnly:true ,tag:9});				
		
		this.c_curr = new saiCB(this.pc1.childPage[2],{bound:[20,14,200,20],caption:"Currency",readOnly:true,tag:9});		
		this.e_total = new saiLabelEdit(this.pc1.childPage[2],{bound:[270,14,200,20],caption:"Sum Insured", tag:9, tipeText:ttNilai, text:"0", readOnly:true});						
		this.e_ppremi = new saiLabelEdit(this.pc1.childPage[2],{bound:[20,16,200,20],caption:"% Premi", tag:9, tipeText:ttNilai, text:"0", readOnly:true});		
		this.e_npremi = new saiLabelEdit(this.pc1.childPage[2],{bound:[270,16,200,20],caption:"Nilai Premi", tag:9, tipeText:ttNilai, text:"0", readOnly:true});				
		
		this.e_occup = new saiLabelEdit(this.pc1.childPage[2],{bound:[20,13,450,20],caption:"Occup. of Risk", readOnly:true,tag:9});
		this.e_lokasi = new saiLabelEdit(this.pc1.childPage[2],{bound:[20,12,450,20],caption:"Loc. of Risk", readOnly:true,tag:9});
		this.e_objek = new saiLabelEdit(this.pc1.childPage[2],{bound:[20,14,450,20],caption:"Object of Risk", readOnly:true,tag:9});		
		this.e_cover = new saiLabelEdit(this.pc1.childPage[2],{bound:[20,15,450,20],caption:"Coverage", readOnly:true ,tag:9});				
...
window.app_saku3_transaksi_sju16_fRenewel.extend(window.childForm);
window.app_saku3_transaksi_sju16_fRenewel.implement({
	...
	doLoad:function(sender){		
		if (this.cb_cust.getText() == "") var filter = "  ";					
		else var filter = " a.kode_cust ='"+this.cb_cust.getText()+"' and  ";
		if (this.cb_tipe.getText() == "") var filter = filter +"  ";					
		else var filter = filter +" a.kode_tipe ='"+this.cb_tipe.getText()+"' and  ";
		if (this.cb_pic.getText() == "") var filter = filter +"  ";					
		else var filter = filter +" a.kode_pic ='"+this.cb_pic.getText()+"' and  ";

		var strSQL = "select 'INPROG' as status,a.no_polis,a.no_dok,convert(varchar,a.tgl_mulai,103) as tgl_mulai,convert(varchar,a.tgl_selesai,103) as tgl_selesai,b.kode_cust+' - '+b.nama as cust,c.kode_vendor+' - '+c.nama as vendor,a.kode_curr,a.total, "+
					 ...
					 "where "+filter+" a.flag_aktif='1' and d.no_polis is null and a.tgl_selesai between '"+this.dp_d2.getDateString()+"' and '"+this.dp_d3.getDateString()+"' and a.kode_lokasi='"+this.app._lokasi+"'";									 
	...
	doDoubleClick1: function(sender, col , row) {
		try{
			if (this.sg1.cells(0,row) != "") {			
				...
				var strSQL = "select b.no_placing,c.no_quo,d.kode_pp+' - '+d.nama as pp,c.no_quo, e.kode_pic+' - '+e.nama as pic,a.p_premi, a.no_dok2 "+
							 "from sju_polis_m a "+
	...
	doDoubleClick3: function(sender, col , row) {
		try{
			if (this.sg3.cells(0,row) != "") {
				...
				var strSQL = "select 'APP' as status,a.no_polis,a.no_dok,convert(varchar,a.tgl_mulai,103) as tgl_mulai,convert(varchar,a.tgl_selesai,103) as tgl_selesai,b.kode_cust+' - '+b.nama as cust,c.kode_vendor+' - '+c.nama as vendor,"+
							 "a.kode_curr,a.total,a.n_premi,a.occup,a.objek,a.lokasi,a.cover,a.kode_curr "+
							 "from sju_polis_m a "+					 
							 "inner join sju_renew_d xx on xx.no_polis=a.no_polis and xx.kode_lokasi=a.kode_lokasi "+
							 "inner join sju_cust b on a.kode_cust=b.kode_cust and a.kode_lokasi=b.kode_lokasi "+
							  "inner join sju_polis_vendor e on a.no_polis=e.no_polis and a.kode_lokasi=e.kode_lokasi and e.status='LEADER' "+
							 "inner join sju_vendor c on e.kode_vendor=c.kode_vendor and e.kode_lokasi=c.kode_lokasi "+							 
