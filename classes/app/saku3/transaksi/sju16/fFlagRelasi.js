window.app_saku3_transaksi_sju16_fFlagRelasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_sju16_fFlagRelasi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_sju16_fFlagRelasi";
...
window.app_saku3_transaksi_sju16_fFlagRelasi.extend(window.childForm);
window.app_saku3_transaksi_sju16_fFlagRelasi.implement({
