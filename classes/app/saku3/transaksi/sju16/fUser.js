window.app_saku3_transaksi_sju16_fUser = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_sju16_fUser.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_sju16_fUser";
...
window.app_saku3_transaksi_sju16_fUser.extend(window.childForm);
window.app_saku3_transaksi_sju16_fUser.implement({
