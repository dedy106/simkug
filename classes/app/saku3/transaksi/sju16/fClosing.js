window.app_saku3_transaksi_sju16_fClosing = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_sju16_fClosing.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_sju16_fClosing";
...
window.app_saku3_transaksi_sju16_fClosing.extend(window.childForm);
window.app_saku3_transaksi_sju16_fClosing.implement({	
