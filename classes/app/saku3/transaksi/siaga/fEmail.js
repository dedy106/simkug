window.app_saku3_transaksi_siaga_fEmail = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_fEmail.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_fEmail";
		this.itemsValue = new arrayList();
		this.maximize();

		this.app._mainForm.childFormConfig(this, "mainButtonClick","Data Email", 0);	
		
		uses("portalui_uploader;saiCBBL;saiEdit;datePicker;saiGrid;sgNavigator;pageControl;checkBox");
		uses("saiGrid",true);		
		this.pc1 = new pageControl(this,{bound:[20,12,1000,450], childPage:["Daftar Email","Data Email","Cari Data"]});				
		this.sg1 = new saiGrid(this.pc1.childPage[0],{bound:[1,5,this.pc1.width-5,this.pc1.height-35],colCount:3,tag:9,
		            colTitle:["Kode","Nama","Email"],
					colWidth:[[2,1,0],[150,200,100]],
					readOnly:true,
        ...
        this.e_mail = new saiLabelEdit(this.pc1.childPage[0],{bound:[20,12,300,20],caption:"Email", maxLength:100, tag:9});																			
...
window.app_saku3_transaksi_siaga_fEmail.extend(window.childForm);
window.app_saku3_transaksi_siaga_fEmail.implement({
		...
		try{						
			if (this.standarLib.checkEmptyByTag(this, [0,1])){
				try{									
					...
					sql.add("update karyawan set email='"+this.e_mail.getText()+"' where kode_lokasi='"+this.app._lokasi+"' and nik='"+this.cb_kode.getText()+"' ");
