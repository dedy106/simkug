window.app_saku3_transaksi_siaga_fAppRRA1 = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_fAppRRA1.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_fAppRRA1";
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Approval Manager", 0);	
...
window.app_saku3_transaksi_siaga_fAppRRA1.extend(window.childForm);
window.app_saku3_transaksi_siaga_fAppRRA1.implement({
	...
	doLoad:function(sender){		
		var strSQL = "select a.kode_lokasi,a.kode_pp+' - '+c.nama as pp,a.no_pdrk as no_bukti,b.no_dokumen,convert(varchar,a.tanggal,103) as tanggal,a.keterangan,a.sts_pdrk as jenis "+
					 ...
					 "where a.modul = 'MULTI' and a.progress in ('7') and a.periode<='"+this.e_periode.getText()+"' ";							
