window.app_saku3_transaksi_siaga_fa_fFawoE = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_fa_fFawoE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_fa_fFawoE";
		...
		this.cb_beban = new saiCBBL(this,{bound:[20,15,222,20],caption:"Akun Beban", multiSelection:false, maxLength:10, tag:2 });
		this.cb_buat = new saiCBBL(this,{bound:[20,16,222,20],caption:"NIK Pembuat", multiSelection:false, maxLength:10, tag:2 });
		this.cb_app = new saiCBBL(this,{bound:[20,17,222,20],caption:"NIK Approve", multiSelection:false, maxLength:10, tag:2});
		
		this.cb_fa = new saiCBBL(this,{bound:[20,18,222,20],caption:"No Aktiva Tetap",readOnly:true});		
		...
		this.e_akun = new portalui_saiLabelEdit(this,{bound:[500,18,502,20],caption:"Akun Aktap",readOnly:true, tag:3});
...
window.app_saku3_transaksi_siaga_fa_fFawoE.extend(window.childForm);
window.app_saku3_transaksi_siaga_fa_fFawoE.implement({
	...
	doSelectDate: function(sender, y,m,d){
		...
		this.e_nb.setSQL("select no_woapp, keterangan from fawoapp_m where posted='F' and kode_lokasi='"+this.app._lokasi+"'",["no_woapp","keterangan"],false,["No Bukti","Deskripsi"],"and","Data Bukti",true);
	},
	doChange:function(sender){		
		if (sender == this.e_nb && this.e_nb.getText()!="") {
			var strSQL = "select a.no_seri,a.merk,a.tipe,zz.nilai,a.nilai_residu,isnull(d.tot_susut,0) as tot_susut,(zz.nilai-a.nilai_residu-isnull(d.tot_susut,0)) as nilai_buku, "+
						 ...
						 "  aa.no_fa,a.nama as nama_fa,aa.akun_beban,ab.nama as nama_beban,ad.no_dokumen,ad.keterangan,convert(varchar,ad.tanggal,103) as tanggal, ad.nik_buat,ad.nik_setuju "+
						 "from fa_asset a "+
