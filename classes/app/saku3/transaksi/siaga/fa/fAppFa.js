window.app_saku3_transaksi_siaga_fa_fAppFa = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_fa_fAppFa.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_fa_fAppFa";
		...
		this.e_nb = new portalui_saiLabelEdit(this,{bound:[20,12,200,20],caption:"No Approve",maxLength:30,readOnly:true});
...
window.app_saku3_transaksi_siaga_fa_fAppFa.extend(window.childForm);
window.app_saku3_transaksi_siaga_fa_fAppFa.implement({
	...
	doLoad:function(sender){
		var strSQL = "select 'INPROG' as status,no_fa,nama,kode_akun,nilai from fa_asset where periode<='"+this.e_periode.getText()+"' and progress ='1' and kode_lokasi='"+this.app._lokasi+"' and catatan='-' and no_fa=no_baps";
