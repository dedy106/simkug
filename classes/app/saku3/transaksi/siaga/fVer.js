window.app_saku3_transaksi_siaga_fVer = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_fVer.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_fVer";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Verifikasi Permintaan Bayar", 0);	
...
window.app_saku3_transaksi_siaga_fVer.extend(window.childForm);
window.app_saku3_transaksi_siaga_fVer.implement({
	doLoad:function(sender){			
		var strSQL = "select a.tanggal as due_date,a.no_pb as no_bukti,'INPROG' as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.due_date,103) as tgl2,'PBAJU' as modul,b.kode_pp+' - '+b.nama as pp,a.no_dokumen,a.keterangan,a.nilai_curr as nilai,c.nik+' - '+c.nama as pembuat,a.no_ver as no_app,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
	...
	doDoubleClick3: function(sender, col , row) {
		try{
			if (this.sg3.cells(0,row) != "") {			
				...
				var strSQL = "select a.periode,a.tanggal,a.no_dokumen,a.keterangan,'-' as atensi,a.kode_pp,a.nik_buat,a.nik_app as nik_tahu,a.kode_curr,a.kurs,a.no_ver "+
