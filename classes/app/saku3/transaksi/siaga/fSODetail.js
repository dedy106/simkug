window.app_saku3_transaksi_siaga_fSODetail = function(owner,modul)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_fSODetail.prototype.parent.constructor.call(this, owner);
		window.app_saku3_transaksi_siaga_fSODetail.prototype.parent.setWidth.call(this, 300);
		window.app_saku3_transaksi_siaga_fSODetail.prototype.parent.setHeight.call(this, 400);
		
		this.centerize();
		
		this.className = "app_saku3_transaksi_siaga_fSODetail";
...
window.app_saku3_transaksi_siaga_fSODetail.extend(window.portalui_commonForm);
window.app_saku3_transaksi_siaga_fSODetail.prototype.doDraw = function(canvas)
{
...
window.app_saku3_transaksi_siaga_fSODetail.prototype.doAfterResize = function(event)
{
	this.p1.setWidth(this.width - 40);
...
window.app_saku3_transaksi_siaga_fSODetail.prototype.doSysMouseDown = function(x, y, button, buttonState)
{	
	window.app_saku3_transaksi_siaga_fSODetail.prototype.parent.doSysMouseDown.call(this,x, y, button, buttonState);
};
window.app_saku3_transaksi_siaga_fSODetail.prototype.doSysMouseUp = function(x, y, button, buttonState)
{	
	window.app_saku3_transaksi_siaga_fSODetail.prototype.parent.doSysMouseUp.call(this,x, y, button, buttonState);
};
window.app_saku3_transaksi_siaga_fSODetail.prototype.doSysMouseMove = function(x, y, button, buttonState)
{
	window.app_saku3_transaksi_siaga_fSODetail.prototype.parent.doSysMouseMove.call(this,x, y, button, buttonState);
	if (this.isClick)
	{		
...
window.app_saku3_transaksi_siaga_fSODetail.prototype.eventMouseDown = function(event)
{
...
window.app_saku3_transaksi_siaga_fSODetail.prototype.eventMouseUp = function(event)
{
	this.isClick = false;
	this.blockElm.style.display = "none";
	this.frameElm.style.display = "";
};
window.app_saku3_transaksi_siaga_fSODetail.prototype.eventMouseMove = function(event)
{
	if (this.isClick)
	{
		var x = event.clientX;
...
window.app_saku3_transaksi_siaga_fSODetail.prototype.doClick = function(sender)
{
	if (sender == this.b1){
		try{
...
window.app_saku3_transaksi_siaga_fSODetail.prototype.doRequestReady = function(sender, methodName, result)
{
};
window.app_saku3_transaksi_siaga_fSODetail.prototype.findBtnClick = function(sender)
{
};
//--------------------------------------------
window.app_saku3_transaksi_siaga_fSODetail.prototype.setCaption = function(data)
{
...
window.app_saku3_transaksi_siaga_fSODetail.prototype.setItemParent = function(data)
{
	this.itemParent = data;
};
window.app_saku3_transaksi_siaga_fSODetail.prototype.setSummaryItems = function(data)
{
	this.e4.clearItem();
	for (var i in data)
		this.e4.addItem(i, data[i]);	
};
window.app_saku3_transaksi_siaga_fSODetail.prototype.doClose = function(sender)
{
	system.delMouseListener(this);
};
window.app_saku3_transaksi_siaga_fSODetail.prototype.setModul = function(modul)
{
    this.e5.clearItem();
