window.app_saku3_transaksi_siaga_fVer3 = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_fVer3.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_fVer3";
...
window.app_saku3_transaksi_siaga_fVer3.extend(window.childForm);
window.app_saku3_transaksi_siaga_fVer3.implement({
