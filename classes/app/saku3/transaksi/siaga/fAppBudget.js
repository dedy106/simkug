window.app_saku3_transaksi_siaga_fAppBudget = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_fAppBudget.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_fAppBudget";
...
window.app_saku3_transaksi_siaga_fAppBudget.extend(window.childForm);
window.app_saku3_transaksi_siaga_fAppBudget.implement({
