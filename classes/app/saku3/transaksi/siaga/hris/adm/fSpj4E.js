window.app_saku3_transaksi_siaga_hris_adm_fSpj4E = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_hris_adm_fSpj4E.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_hris_adm_fSpj4E";
...
window.app_saku3_transaksi_siaga_hris_adm_fSpj4E.extend(window.childForm);
window.app_saku3_transaksi_siaga_hris_adm_fSpj4E.implement({
	...
	doChangeCell2: function(sender, col, row) {
		if (col == 2 || col == 3 || col == 0) {
			if (col == 0) {
				var data = this.dbLib.getDataProvider("select nilai from gr_spj_harian where kode_grade = '"+this.kodegrade.substr(0,1)+"' and kode_klpjab='"+this.kode_klpjab+"' and sts_spj = '"+this.sg2.cells(0,row)+"' and kode_lokasi='"+this.app._lokasi+"'",true);
				if (typeof data == "object"){
					var line = data.rs.rows[0];							
					if (line != undefined){
