window.app_saku3_transaksi_siaga_hris_adm_fAbsenE = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_hris_adm_fAbsenE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_hris_adm_fAbsenE";
...
window.app_saku3_transaksi_siaga_hris_adm_fAbsenE.extend(window.childForm);
window.app_saku3_transaksi_siaga_hris_adm_fAbsenE.implement({
