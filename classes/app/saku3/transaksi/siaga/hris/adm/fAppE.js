window.app_saku3_transaksi_siaga_hris_adm_fAppE = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_hris_adm_fAppE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_hris_adm_fAppE";
...
window.app_saku3_transaksi_siaga_hris_adm_fAppE.extend(window.childForm);
window.app_saku3_transaksi_siaga_hris_adm_fAppE.implement({
