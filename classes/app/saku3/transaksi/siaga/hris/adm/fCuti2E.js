window.app_saku3_transaksi_siaga_hris_adm_fCuti2E = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_hris_adm_fCuti2E.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_hris_adm_fCuti2E";
		...
		try {
			...
			this.e_nb.setSQL("select distinct no_cuti, alasan from gr_cuti_d where  kode_lokasi='"+this.app._lokasi+"'",["no_cuti","alasan"],false,["No Cuti","Alasan"],"and","Data Cuti",true);			
...
window.app_saku3_transaksi_siaga_hris_adm_fCuti2E.extend(window.childForm);
window.app_saku3_transaksi_siaga_hris_adm_fCuti2E.implement({
