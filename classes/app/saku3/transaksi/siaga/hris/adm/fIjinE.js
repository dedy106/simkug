window.app_saku3_transaksi_siaga_hris_adm_fIjinE = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_hris_adm_fIjinE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_hris_adm_fIjinE";
...
window.app_saku3_transaksi_siaga_hris_adm_fIjinE.extend(window.childForm);
window.app_saku3_transaksi_siaga_hris_adm_fIjinE.implement({
