window.app_saku3_transaksi_siaga_hris_gaji_fNorma = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_hris_gaji_fNorma.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_hris_gaji_fNorma";
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Data Tarif Norma Gaji per Grade", 0);	
		
		uses("saiCBBL;saiEdit;saiGrid;sgNavigator");
		this.cb_kode = new saiCBBL(this,{bound:[20,10,220,20],caption:"Grade",maxLength:10,multiSelection:false,change:[this,"doChange"]});
...
window.app_saku3_transaksi_siaga_hris_gaji_fNorma.extend(window.childForm);
window.app_saku3_transaksi_siaga_hris_gaji_fNorma.implement({
