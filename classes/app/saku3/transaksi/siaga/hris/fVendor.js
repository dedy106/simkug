window.app_saku3_transaksi_siaga_hris_fVendor = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_hris_fVendor.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_hris_fVendor";
		...
		this.pc1 = new pageControl(this,{bound:[10,12,1000,450], childPage:["Daftar Mitra","Data Mitra"]});				
		this.sg1 = new saiGrid(this.pc1.childPage[0],{bound:[1,5,this.pc1.width-5,this.pc1.height-35],colCount:4,tag:9,
					colTitle: ["Kode","Nama","Alamat","Kota"],
					colWidth:[[3,2,1,0],[200,400,200,100]],
					readOnly:true,
		...
		this.e_kodepos = new saiLabelEdit(this.pc1.childPage[1],{bound:[340,13,180,20],caption:"Kode Pos", maxLength:5, tipeText:ttAngka, tag:1});	
		...
		this.e_npwp = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,17,300,20],caption:"NPWP", maxLength:50, tag:1});	
		this.e_pic = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,18,300,20],caption:"P I C", maxLength:50, tag:1});	
		this.e_bank = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,19,300,20],caption:"Bank", maxLength:50, tag:1});	
		this.e_cabang = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,20,400,20],caption:"Cabang", maxLength:50, tag:1});	
		this.e_norek = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,21,300,20],caption:"No Rekening", maxLength:50, tag:1});	
		this.e_namarek = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,22,300,20],caption:"Nama Rekening", maxLength:50, tag:1});	
...
window.app_saku3_transaksi_siaga_hris_fVendor.extend(window.childForm);
window.app_saku3_transaksi_siaga_hris_fVendor.implement({
	...
	doLoad:function(sender){						
		var strSQL = "select kode_vendor,nama,alamat,kota from gr_vendor where kode_lokasi='"+this.app._lokasi+"' order by kode_vendor";		
	...
	doTampilData: function(page) {
		...
		for (var i=start;i<finish;i++){
			...
			this.sg1.appendData([line.kode_vendor,line.nama,line.alamat,line.kota]); 
		}
