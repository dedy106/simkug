window.app_saku3_transaksi_siaga_hris_kesehatan_fAppE = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_hris_kesehatan_fAppE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_hris_kesehatan_fAppE";
...
window.app_saku3_transaksi_siaga_hris_kesehatan_fAppE.extend(window.childForm);
window.app_saku3_transaksi_siaga_hris_kesehatan_fAppE.implement({
