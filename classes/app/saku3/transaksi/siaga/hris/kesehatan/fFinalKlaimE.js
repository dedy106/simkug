window.app_saku3_transaksi_siaga_hris_kesehatan_fFinalKlaimE = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_hris_kesehatan_fFinalKlaimE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_hris_kesehatan_fFinalKlaimE";
...
window.app_saku3_transaksi_siaga_hris_kesehatan_fFinalKlaimE.extend(window.childForm);
window.app_saku3_transaksi_siaga_hris_kesehatan_fFinalKlaimE.implement({
