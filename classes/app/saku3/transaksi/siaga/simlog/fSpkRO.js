window.app_saku3_transaksi_siaga_simlog_fSpkRO = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_simlog_fSpkRO.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_simlog_fSpkRO";
...
window.app_saku3_transaksi_siaga_simlog_fSpkRO.extend(window.childForm);
window.app_saku3_transaksi_siaga_simlog_fSpkRO.implement({	
