window.app_saku3_transaksi_siaga_simlog_fSpphTender = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_simlog_fSpphTender.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_simlog_fSpphTender";
...
window.app_saku3_transaksi_siaga_simlog_fSpphTender.extend(window.childForm);
window.app_saku3_transaksi_siaga_simlog_fSpphTender.implement({	
