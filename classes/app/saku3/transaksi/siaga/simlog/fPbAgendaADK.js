window.app_saku3_transaksi_siaga_simlog_fPbAgendaADK = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_simlog_fPbAgendaADK.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_simlog_fPbAgendaADK";
...
window.app_saku3_transaksi_siaga_simlog_fPbAgendaADK.extend(window.childForm);
window.app_saku3_transaksi_siaga_simlog_fPbAgendaADK.implement({		
