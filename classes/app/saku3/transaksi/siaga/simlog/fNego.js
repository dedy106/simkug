window.app_saku3_transaksi_siaga_simlog_fNego = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_simlog_fNego.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_simlog_fNego";
...
window.app_saku3_transaksi_siaga_simlog_fNego.extend(window.childForm);
window.app_saku3_transaksi_siaga_simlog_fNego.implement({	
