window.app_saku3_transaksi_siaga_simlog_fSanggupTL = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_simlog_fSanggupTL.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_simlog_fSanggupTL";
...
window.app_saku3_transaksi_siaga_simlog_fSanggupTL.extend(window.childForm);
window.app_saku3_transaksi_siaga_simlog_fSanggupTL.implement({	
