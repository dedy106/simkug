window.app_saku3_transaksi_siaga_simlog_fBast = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_simlog_fBast.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_simlog_fBast";
...
window.app_saku3_transaksi_siaga_simlog_fBast.extend(window.childForm);
window.app_saku3_transaksi_siaga_simlog_fBast.implement({	
	...
	doChange:function(sender){
		...
		if (sender == this.cb_spk && this.cb_spk.getText() != "" && this.stsSimpan ==1 ) {
			...
			var strSQL = "select a.no_spk+'-'+cast(a.no_urut as varchar) as id,a.item,a.merk,a.tipe,a.harga+a.ppn as harga,a.jumlah,isnull(d.jml_terima,0) as jum_terima,bb.kode_akun,c.kode_klpfa,c.nama as nama_klpfa,c.jenis "+
						 ...
						 "                 inner join fa_klp c on a.kode_klpfa = c.kode_klpfa and c.kode_klpakun=xxx.kode_akun "+ //and a.kode_lokasi=c.kode_lokasi 
