window.app_saku3_transaksi_siaga_simlog_fNegoTD = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_simlog_fNegoTD.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_simlog_fNegoTD";
...
window.app_saku3_transaksi_siaga_simlog_fNegoTD.extend(window.childForm);
window.app_saku3_transaksi_siaga_simlog_fNegoTD.implement({	
