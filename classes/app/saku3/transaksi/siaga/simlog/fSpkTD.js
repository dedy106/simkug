window.app_saku3_transaksi_siaga_simlog_fSpkTD = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_simlog_fSpkTD.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_simlog_fSpkTD";
...
window.app_saku3_transaksi_siaga_simlog_fSpkTD.extend(window.childForm);
window.app_saku3_transaksi_siaga_simlog_fSpkTD.implement({	
