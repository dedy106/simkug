window.app_saku3_transaksi_siaga_simlog_fPenetapanTD = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_simlog_fPenetapanTD.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_simlog_fPenetapanTD";
...
window.app_saku3_transaksi_siaga_simlog_fPenetapanTD.extend(window.childForm);
window.app_saku3_transaksi_siaga_simlog_fPenetapanTD.implement({	
