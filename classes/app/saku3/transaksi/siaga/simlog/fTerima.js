window.app_saku3_transaksi_siaga_simlog_fTerima = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_simlog_fTerima.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_simlog_fTerima";
...
window.app_saku3_transaksi_siaga_simlog_fTerima.extend(window.childForm);
window.app_saku3_transaksi_siaga_simlog_fTerima.implement({	
		...
		for (var i=0;i < this.sg.getRowCount();i++){
			if (this.sg.cells(7,i) != "-") {
				if (nilaiToFloat(this.sg.cells(6,i)) > nilaiToFloat(this.sg.cells(5,i))) {
					...
					var formatID = this.e_periode.getText().substr(2,2)+"-"+this.sg.cells(7,i) + "-"+ this.sg.cells(10,i).substr(0,2)+"____-"; 
					
					var formatIDKunci = this.e_periode.getText().substr(2,2)+"-"+this.sg.cells(7,i) + "-"+ this.sg.cells(10,i).substr(0,2);
