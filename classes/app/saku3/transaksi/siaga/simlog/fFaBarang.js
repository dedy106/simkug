window.app_saku3_transaksi_siaga_simlog_fFaBarang = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_simlog_fFaBarang.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_simlog_fFaBarang";
...
window.app_saku3_transaksi_siaga_simlog_fFaBarang.extend(window.childForm);
window.app_saku3_transaksi_siaga_simlog_fFaBarang.implement({
