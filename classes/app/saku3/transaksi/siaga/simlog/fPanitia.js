window.app_saku3_transaksi_siaga_simlog_fPanitia = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_simlog_fPanitia.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_simlog_fPanitia";
...
window.app_saku3_transaksi_siaga_simlog_fPanitia.extend(window.childForm);
window.app_saku3_transaksi_siaga_simlog_fPanitia.implement({
