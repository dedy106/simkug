window.app_saku3_transaksi_siaga_simlog_fPksRO = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_simlog_fPksRO.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_simlog_fPksRO";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form PKS Tender", 0);	
...
window.app_saku3_transaksi_siaga_simlog_fPksRO.extend(window.childForm);
window.app_saku3_transaksi_siaga_simlog_fPksRO.implement({	
			...
			case "clear" :
				if (modalResult == mrOk)
					...
					this.cb_spk.setSQL("select a.no_spk, a.keterangan "+
							   ...
							   "where a.modul = 'RO' and a.periode<='"+this.e_periode.getText()+"' and a.no_pks='-' and a.kode_lokasi='"+this.app._lokasi+"'",["no_spk","keterangan"],false,["No SPK","Deskripsi"],"and","Data SPK",true);			
				break;
			case "simpan" :															
			case "ubah" :																											
				this.preView = "1";												
