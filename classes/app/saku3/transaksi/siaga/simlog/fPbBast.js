window.app_saku3_transaksi_siaga_simlog_fPbBast = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_simlog_fPbBast.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_simlog_fPbBast";
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[1,12,995,348], childPage:["Otorisasi","Data Akru","Data Permohonan","Referensi Akru","Data Approval","Data Anggaran"]});
		...
		this.sg1 = new saiGrid(this.pc1.childPage[2],{bound:[1,5,this.pc1.width-5,120],colCount:9,tag:9,
...
window.app_saku3_transaksi_siaga_simlog_fPbBast.extend(window.childForm);
window.app_saku3_transaksi_siaga_simlog_fPbBast.implement({		
