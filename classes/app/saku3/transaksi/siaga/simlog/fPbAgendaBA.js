window.app_saku3_transaksi_siaga_simlog_fPbAgendaBA = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_simlog_fPbAgendaBA.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_simlog_fPbAgendaBA";
...
window.app_saku3_transaksi_siaga_simlog_fPbAgendaBA.extend(window.childForm);
window.app_saku3_transaksi_siaga_simlog_fPbAgendaBA.implement({		
