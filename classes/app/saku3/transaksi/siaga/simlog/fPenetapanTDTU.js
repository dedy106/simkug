window.app_saku3_transaksi_siaga_simlog_fPenetapanTDTU = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_simlog_fPenetapanTDTU.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_simlog_fPenetapanTDTU";
...
window.app_saku3_transaksi_siaga_simlog_fPenetapanTDTU.extend(window.childForm);
window.app_saku3_transaksi_siaga_simlog_fPenetapanTDTU.implement({	
