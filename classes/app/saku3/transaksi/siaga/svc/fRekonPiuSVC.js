window.app_saku3_transaksi_siaga_svc_fRekonPiuSVC = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_svc_fRekonPiuSVC.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_svc_fRekonPiuSVC";
		...
		this.cb_bukti = new saiCBBL(this,{bound:[20,14,250,20],caption:"No KasBank", multiSelection:false, maxLength:10, tag:2,change:[this,"doChange"]});					
...
window.app_saku3_transaksi_siaga_svc_fRekonPiuSVC.extend(window.childForm);
window.app_saku3_transaksi_siaga_svc_fRekonPiuSVC.implement({
				...
				try{														
					...
					if (this.e_pph.getText()!="0" || this.e_lain.getText()!="0") {						
						...
						sql.add("insert into ju_m(no_ju,kode_lokasi,periode,tanggal,no_dokumen,keterangan,kode_pp,modul,jenis,kode_curr,kurs,nilai,nik_buat,nik_setuju,posted,no_del,no_link,ref1,tgl_input,nik_user) values "+
								"('"+this.e_nb.getText()+"','"+this.app._lokasi+"','"+this.e_periode.getText()+"','"+this.dp_d1.getDateString()+"','"+this.cb_bukti.getText()+"','Penyelesaian atas Invoice : "+this.cb_inv.getText()+"','-','REKSVC','JU','IDR',1,"+pphLain+",'"+this.app._userLog+"','"+this.app._userLog+"','F','-','-','"+this.cb_inv.getText()+"',getdate(),'"+this.app._userLog+"')");		
						...
						if (this.e_pph.getText()!="0") {		
							sql.add("insert into ju_j(no_ju,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,nilai,kode_pp,kode_drk,kode_cust,kode_proyek,kode_task,kode_vendor,kode_lokarea,nik,kode_lokasi,modul,jenis,periode,kode_curr,kurs,nik_user,tgl_input,no_ref,ket_ref) values "+
									"('"+this.e_nb.getText()+"','-','"+this.dp_d1.getDateString()+"',0,'"+this.cb_pph.getText()+"','PPh atas Invoice : "+this.cb_inv.getText()+"','D',"+parseNilai(this.e_pph.getText())+",'"+this.app._kodePP+"','-','-','-','-','-','-','-','"+this.app._lokasi+"','REKSVC','PPH','"+this.e_periode.getText()+"','IDR',1,'"+this.app._userLog+"',getdate(),'-','-')");
							sql.add("insert into ju_j(no_ju,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,nilai,kode_pp,kode_drk,kode_cust,kode_proyek,kode_task,kode_vendor,kode_lokarea,nik,kode_lokasi,modul,jenis,periode,kode_curr,kurs,nik_user,tgl_input,no_ref,ket_ref) values "+
									"('"+this.e_nb.getText()+"','-','"+this.dp_d1.getDateString()+"',1,'"+this.akunAR+"','Penyelesaian atas Invoice : "+this.cb_inv.getText()+"','C',"+parseNilai(this.e_pph.getText())+",'"+this.app._kodePP+"','-','-','-','-','-','-','-','"+this.app._lokasi+"','REKSVC','PIU','"+this.e_periode.getText()+"','IDR',1,'"+this.app._userLog+"',getdate(),'-','-')");
						}

						if (this.e_lain.getText()!="0") {
							sql.add("insert into ju_j(no_ju,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,nilai,kode_pp,kode_drk,kode_cust,kode_proyek,kode_task,kode_vendor,kode_lokarea,nik,kode_lokasi,modul,jenis,periode,kode_curr,kurs,nik_user,tgl_input,no_ref,ket_ref) values "+
									"('"+this.e_nb.getText()+"','-','"+this.dp_d1.getDateString()+"',2,'"+this.cb_lain.getText()+"','Penyelesaian atas Invoice : "+this.cb_inv.getText()+"','D',"+parseNilai(this.e_lain.getText())+",'"+this.app._kodePP+"','-','-','-','-','-','-','-','"+this.app._lokasi+"','REKSVC','LAIN','"+this.e_periode.getText()+"','IDR',1,'"+this.app._userLog+"',getdate(),'-','-')");
							sql.add("insert into ju_j(no_ju,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,nilai,kode_pp,kode_drk,kode_cust,kode_proyek,kode_task,kode_vendor,kode_lokarea,nik,kode_lokasi,modul,jenis,periode,kode_curr,kurs,nik_user,tgl_input,no_ref,ket_ref) values "+
									"('"+this.e_nb.getText()+"','-','"+this.dp_d1.getDateString()+"',3,'"+this.akunAR+"','Penyelesaian atas Invoice : "+this.cb_inv.getText()+"','C',"+parseNilai(this.e_lain.getText())+",'"+this.app._kodePP+"','-','-','-','-','-','-','-','"+this.app._lokasi+"','REKSVC','PIU','"+this.e_periode.getText()+"','IDR',1,'"+this.app._userLog+"',getdate(),'-','-')");		
						}
