window.app_saku3_transaksi_siaga_svc_fSVCHapus = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_svc_fSVCHapus.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_svc_fSVCHapus";
...
window.app_saku3_transaksi_siaga_svc_fSVCHapus.extend(window.childForm);
window.app_saku3_transaksi_siaga_svc_fSVCHapus.implement({
