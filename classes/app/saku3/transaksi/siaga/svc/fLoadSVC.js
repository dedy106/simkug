window.app_saku3_transaksi_siaga_svc_fLoadSVC = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_svc_fLoadSVC.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_svc_fLoadSVC";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Biling SVC: Load", 0);	
		...
		this.bUpload = new portalui_uploader(this,{bound:[480,18,80,18],param3:"object",param4:"gridupload",afterUpload:[this,"doAfterUpload"],autoSubmit:true});
		...
		this.sg1 = new portalui_saiGrid(this.pc1.childPage[1],{bound:[1,5,this.pc1.width-5,this.pc1.height-33],colCount:9,tag:0,
...
window.app_saku3_transaksi_siaga_svc_fLoadSVC.extend(window.childForm);
window.app_saku3_transaksi_siaga_svc_fLoadSVC.implement({
