window.app_saku3_transaksi_siaga_svc_fBillSVCE = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_svc_fBillSVCE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_svc_fBillSVCE";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Biling SVC: Edit", 0);	
...
window.app_saku3_transaksi_siaga_svc_fBillSVCE.extend(window.childForm);
window.app_saku3_transaksi_siaga_svc_fBillSVCE.implement({	
	...
	doChange:function(sender){		
		...
		if (sender == this.e_nb && this.e_nb.getText()!="") {						
			...
			this.cb_inv.setSQL("select no_invoice,nama_cust from gr_svc_d where no_svc = '"+this.e_nb.getText()+"' and kode_lokasi='"+this.app._lokasi+"'",["no_invoice","nama_cust"],false,["No Invoice","Nama Cust"],"and","Daftar Invoice",true);							 		
		}		
		if (sender == this.cb_inv && this.cb_inv.getText()!="") {			
			var strSQL = "select a.nama_cust,a.nilai,a.diskon,a.neto,a.ppn,a.biaya,a.materai,a.total,isnull(c.bayar,0) as bayar "+
						 ...
						 "where a.no_invoice ='"+this.cb_inv.getText()+"' and a.no_svc='"+this.e_nb.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"'";			
