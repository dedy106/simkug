window.app_saku3_transaksi_siaga_svc_fSVCBatal = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_svc_fSVCBatal.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_svc_fSVCBatal";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Pembatalan Invoice SVC", 0);	
		...
		this.e_nosvc = new saiLabelEdit(this,{bound:[20,12,450,20],caption:"No SVC", readOnly:true});						
...
window.app_saku3_transaksi_siaga_svc_fSVCBatal.extend(window.childForm);
window.app_saku3_transaksi_siaga_svc_fSVCBatal.implement({
		...
		try{						
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					var data = this.dbLib.getDataProvider("select * from gr_svc where kode_cabang='"+this.cb_cabang.getText()+"' ",true);
					if (typeof data == "object"){
						var line = data.rs.rows[0];							
						if (line != undefined){							
					...
					//reverse yang lama
					/*
					sql.add("update gr_svc_d set no_invoice='"+this.e_nb.getText()+"' where no_svc='"+this.e_nosvc.getText()+"' and no_invoice='"+this.cb_inv.getText()+"' and kode_lokasi='"+this.app._lokasi+"' ");
					...
					*/
					sql.add("delete from gr_svc_d where no_svc='"+this.e_nosvc.getText()+"' and no_invoice='"+this.cb_inv.getText()+"' and kode_lokasi='"+this.app._lokasi+"' ");
					...
					sql.add("insert into gr_svc_j(no_svc,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,kode_curr,kurs,nilai_curr,nilai,kode_pp,kode_drk,kode_lokasi,modul,jenis,periode,nik_user,tgl_input) values "+
							"('"+this.e_nb.getText()+"','"+this.cb_inv.getText()+"','"+this.dp_d1.getDateString()+"',0,'"+this.akunAR+"','"+this.e_ket.getText()+"','C','IDR',1,"+this.totalLama+","+this.totalLama+",'"+this.app._kodePP+"','-','"+this.app._lokasi+"','RSVC','PIUTANG','"+this.e_periode.getText()+"','"+this.app._userLog+"',getdate())");					
					if (this.diskonLama != 0)
					sql.add("insert into gr_svc_j(no_svc,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,kode_curr,kurs,nilai_curr,nilai,kode_pp,kode_drk,kode_lokasi,modul,jenis,periode,nik_user,tgl_input) values "+
							"('"+this.e_nb.getText()+"','"+this.cb_inv.getText()+"','"+this.dp_d1.getDateString()+"',1,'"+this.akunPotPdpt+"','"+this.e_ket.getText()+"','C','IDR',1,"+this.diskonLama+","+this.diskonLama+",'"+this.app._kodePP+"','"+this.kodeDRK+"','"+this.app._lokasi+"','RSVC','DISKON','"+this.e_periode.getText()+"','"+this.app._userLog+"',getdate())");					
					if (this.nilaiLama != 0)
					sql.add("insert into gr_svc_j(no_svc,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,kode_curr,kurs,nilai_curr,nilai,kode_pp,kode_drk,kode_lokasi,modul,jenis,periode,nik_user,tgl_input) values "+
							"('"+this.e_nb.getText()+"','"+this.cb_inv.getText()+"','"+this.dp_d1.getDateString()+"',2,'"+this.akunPdpt+"','"+this.e_ket.getText()+"','D','IDR',1,"+this.nilaiLama+","+this.nilaiLama+",'"+this.app._kodePP+"','"+this.kodeDRK+"','"+this.app._lokasi+"','RSVC','PEND','"+this.e_periode.getText()+"','"+this.app._userLog+"',getdate())");
					if (this.biayaLama != 0)
					sql.add("insert into gr_svc_j(no_svc,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,kode_curr,kurs,nilai_curr,nilai,kode_pp,kode_drk,kode_lokasi,modul,jenis,periode,nik_user,tgl_input) values "+
							"('"+this.e_nb.getText()+"','"+this.cb_inv.getText()+"','"+this.dp_d1.getDateString()+"',3,'"+this.akunBiaya+"','"+this.e_ket.getText()+"','D','IDR',1,"+this.biayaLama+","+this.biayaLama+",'"+this.app._kodePP+"','"+this.kodeDRK+"','"+this.app._lokasi+"','RSVC','BIAYA','"+this.e_periode.getText()+"','"+this.app._userLog+"',getdate())");
					if (this.matLama != 0)
					sql.add("insert into gr_svc_j(no_svc,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,kode_curr,kurs,nilai_curr,nilai,kode_pp,kode_drk,kode_lokasi,modul,jenis,periode,nik_user,tgl_input) values "+
							"('"+this.e_nb.getText()+"','"+this.cb_inv.getText()+"','"+this.dp_d1.getDateString()+"',4,'"+this.akunMat+"','"+this.e_ket.getText()+"','D','IDR',1,"+this.matLama+","+this.matLama+",'"+this.app._kodePP+"','"+this.kodeDRK+"','"+this.app._lokasi+"','RSVC','MATERAI','"+this.e_periode.getText()+"','"+this.app._userLog+"',getdate())");
					if (this.ppnLama != 0)
					sql.add("insert into gr_svc_j(no_svc,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,kode_curr,kurs,nilai_curr,nilai,kode_pp,kode_drk,kode_lokasi,modul,jenis,periode,nik_user,tgl_input) values "+
							"('"+this.e_nb.getText()+"','"+this.cb_inv.getText()+"','"+this.dp_d1.getDateString()+"',5,'"+this.akunPPN+"','"+this.e_ket.getText()+"','D','IDR',1,"+this.ppnLama+","+this.ppnLama+",'"+this.app._kodePP+"','"+this.kodeDRK+"','"+this.app._lokasi+"','RSVC','PPN','"+this.e_periode.getText()+"','"+this.app._userLog+"',getdate())");
					...
					sql.add("insert into gr_svc_j(no_svc,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,kode_curr,kurs,nilai_curr,nilai,kode_pp,kode_drk,kode_lokasi,modul,jenis,periode,nik_user,tgl_input) values "+
							"('"+this.e_nb.getText()+"','"+this.cb_inv.getText()+"','"+this.dp_d1.getDateString()+"',0,'"+this.akunAR+"','"+this.e_ket.getText()+"','D','IDR',1,"+parseNilai(this.e_total.getText())+","+parseNilai(this.e_total.getText())+",'"+this.app._kodePP+"','-','"+this.app._lokasi+"','SVC','PIUTANG','"+this.e_periode.getText()+"','"+this.app._userLog+"',getdate())");
					if (this.e_diskon.getText() != "0")
					sql.add("insert into gr_svc_j(no_svc,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,kode_curr,kurs,nilai_curr,nilai,kode_pp,kode_drk,kode_lokasi,modul,jenis,periode,nik_user,tgl_input) values "+
							"('"+this.e_nb.getText()+"','"+this.cb_inv.getText()+"','"+this.dp_d1.getDateString()+"',1,'"+this.akunPotPdpt+"','"+this.e_ket.getText()+"','D','IDR',1,"+parseNilai(this.e_diskon.getText())+","+parseNilai(this.e_diskon.getText())+",'"+this.app._kodePP+"','"+this.kodeDRK+"','"+this.app._lokasi+"','SVC','DISKON','"+this.e_periode.getText()+"','"+this.app._userLog+"',getdate())");
					if (this.e_nilai.getText() != "0")
					sql.add("insert into gr_svc_j(no_svc,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,kode_curr,kurs,nilai_curr,nilai,kode_pp,kode_drk,kode_lokasi,modul,jenis,periode,nik_user,tgl_input) values "+
							"('"+this.e_nb.getText()+"','"+this.cb_inv.getText()+"','"+this.dp_d1.getDateString()+"',2,'"+this.akunPdpt+"','"+this.e_ket.getText()+"','C','IDR',1,"+parseNilai(this.e_nilai.getText())+","+parseNilai(this.e_nilai.getText())+",'"+this.app._kodePP+"','"+this.kodeDRK+"','"+this.app._lokasi+"','SVC','PEND','"+this.e_periode.getText()+"','"+this.app._userLog+"',getdate())");
					if (this.e_biaya.getText() != "0")
					sql.add("insert into gr_svc_j(no_svc,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,kode_curr,kurs,nilai_curr,nilai,kode_pp,kode_drk,kode_lokasi,modul,jenis,periode,nik_user,tgl_input) values "+
							"('"+this.e_nb.getText()+"','"+this.cb_inv.getText()+"','"+this.dp_d1.getDateString()+"',3,'"+this.akunBiaya+"','"+this.e_ket.getText()+"','C','IDR',1,"+parseNilai(this.e_biaya.getText())+","+parseNilai(this.e_biaya.getText())+",'"+this.app._kodePP+"','"+this.kodeDRK+"','"+this.app._lokasi+"','SVC','BIAYA','"+this.e_periode.getText()+"','"+this.app._userLog+"',getdate())");
					if (this.e_mat.getText() != "0")
					sql.add("insert into gr_svc_j(no_svc,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,kode_curr,kurs,nilai_curr,nilai,kode_pp,kode_drk,kode_lokasi,modul,jenis,periode,nik_user,tgl_input) values "+
							"('"+this.e_nb.getText()+"','"+this.cb_inv.getText()+"','"+this.dp_d1.getDateString()+"',4,'"+this.akunMat+"','"+this.e_ket.getText()+"','C','IDR',1,"+parseNilai(this.e_mat.getText())+","+parseNilai(this.e_mat.getText())+",'"+this.app._kodePP+"','"+this.kodeDRK+"','"+this.app._lokasi+"','SVC','MATERAI','"+this.e_periode.getText()+"','"+this.app._userLog+"',getdate())");
					if (this.e_ppn.getText() != "0")
					sql.add("insert into gr_svc_j(no_svc,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,kode_curr,kurs,nilai_curr,nilai,kode_pp,kode_drk,kode_lokasi,modul,jenis,periode,nik_user,tgl_input) values "+
							"('"+this.e_nb.getText()+"','"+this.cb_inv.getText()+"','"+this.dp_d1.getDateString()+"',5,'"+this.akunPPN+"','"+this.e_ket.getText()+"','C','IDR',1,"+parseNilai(this.e_ppn.getText())+","+parseNilai(this.e_ppn.getText())+",'"+this.app._kodePP+"','"+this.kodeDRK+"','"+this.app._lokasi+"','SVC','PPN','"+this.e_periode.getText()+"','"+this.app._userLog+"',getdate())");				
	...
	doChange:function(sender){
		if (sender == this.e_periode || sender == this.cb_cabang) {
			if (this.e_periode.getText()!="" && this.cb_cabang.getText()!="") {
				this.cb_inv.setSQL("select a.no_invoice, a.nama_cust from gr_svc_d a inner join gr_svc_m b on a.no_svc=b.no_svc and a.kode_lokasi=b.kode_lokasi "+
		...
		if (sender == this.cb_inv && this.cb_inv.getText()!="") {								  
			var data = this.dbLib.getDataProvider("select a.no_svc,a.nama_cust,a.nilai,a.diskon,a.ppn,a.biaya,a.materai,a.total,isnull(c.bayar,0) as bayar,a.akun_piutang,a.akun_piutang + ' - '+b.nama as nama,d.kode_drk,d.periode "+
			           "from gr_svc_d a inner join masakun b on a.akun_piutang=b.kode_akun and b.kode_lokasi = a.kode_lokasi "+
					   "                 inner join gr_svc_m d on a.no_svc=d.no_svc and a.kode_lokasi=d.kode_lokasi "+
					   "                 left join (select no_invoice,kode_lokasi,sum(case dc when 'D' then (nilai_kas+nilai_lain) else -(nilai_kas+nilai_lain) end) as bayar from gr_svcbayar_d group by no_invoice,kode_lokasi ) c on a.no_invoice=c.no_invoice and a.kode_lokasi=c.kode_lokasi "+
					   "where a.no_invoice='"+this.cb_inv.getText()+"' and a.kode_lokasi ='"+this.app._lokasi+"' ",true);			
			if (typeof data == "object"){
				var line = data.rs.rows[0];							
				if (line != undefined){
					this.e_nosvc.setText(line.no_svc);										
	...
	doClick:function(sender){
		if (this.e_periode.getText()!= "" && this.cb_cabang.getText()!= "") {				
			...
			var data = this.dbLib.getDataProvider("select isnull(max(substring(no_svc,5,20)),0) as no_svc from gr_svc_m where no_svc like '_______"+AddFormat+"%' and kode_lokasi='"+this.app._lokasi+"'",true);
			if (typeof data == "object"){
				var line = data.rs.rows[0];							
				if (line != undefined){
					if (line.no_svc == "0") this.e_nb.setText("RSVC001"+AddFormat);
					else {
						...
						this.e_nb.setText("RSVC"+nu+AddFormat);
					}
				} 
			}
			this.e_ket.setFocus();
