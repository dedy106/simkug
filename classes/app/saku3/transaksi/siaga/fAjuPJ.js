window.app_saku3_transaksi_siaga_fAjuPJ = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_fAjuPJ.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_fAjuPJ";
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[1,12,995,210], childPage:["Item Mata Anggaran","KPA Anggaran","Lampiran","Rincian Barang","Verifikasi"]});
...
window.app_saku3_transaksi_siaga_fAjuPJ.extend(window.childForm);
window.app_saku3_transaksi_siaga_fAjuPJ.implement({
