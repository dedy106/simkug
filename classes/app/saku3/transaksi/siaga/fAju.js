window.app_saku3_transaksi_siaga_fAju = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_fAju.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_fAju";
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[1,12,995,233], childPage:["Item Mata Anggaran","KPA Anggaran","Lampiran","Rincian Barang","Verifikasi","File Dok"]});
...
window.app_saku3_transaksi_siaga_fAju.extend(window.childForm);
window.app_saku3_transaksi_siaga_fAju.implement({
