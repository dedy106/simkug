window.app_saku3_transaksi_siaga_fAppRRADir = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siaga_fAppRRADir.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siaga_fAppRRADir";
...
window.app_saku3_transaksi_siaga_fAppRRADir.extend(window.childForm);
window.app_saku3_transaksi_siaga_fAppRRADir.implement({
	...
	doLoad:function(sender){		
		...
		// 						"where a.modul = 'MULTI' and a.progress='1' and a.periode<='"+this.e_periode.getText()+"' ";							
				...
				switch(methodName){
	    			case "execArraySQL" :	    				
						if (result.toLowerCase().search("error") == -1){														
							...
							this.filter2 = this.app._lokasi+"/"+this.app._userLog+"/"+this.e_nb.getText()+"/"+this.c_status.getText()+"/Approval Direksi"+"/"+this.app._kodePP+"/"+this.e_nopdrk.getText();
							this.viewer.prepare();
