window.app_saku3_transaksi_siswa_fParamTarifYpt2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siswa_fParamTarifYpt2.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siswa_fParamTarifYpt2";
		...
		this.bLoad = new button(this.pc1.childPage[2],{bound:[120,17,80,20],caption:"Load Param",click:[this,"doLoad"]});			
...
window.app_saku3_transaksi_siswa_fParamTarifYpt2.extend(window.childForm);
window.app_saku3_transaksi_siswa_fParamTarifYpt2.implement({
