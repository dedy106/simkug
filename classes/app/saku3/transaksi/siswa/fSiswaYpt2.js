window.app_saku3_transaksi_siswa_fSiswaYpt2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siswa_fSiswaYpt2.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siswa_fSiswaYpt2";
		...
		this.c_flag2 = new saiCBBL(this,{bound:[20,22,220,20],caption:"Status Siswa", multiSelection:false, maxLength:10, tag:2,change:[this,"doChange"]});
		...
		this.c_flag = new saiCBBL(this.pc1.childPage[1],{bound:[20,22,240,20],caption:"Status", multiSelection:false, maxLength:10, tag:2});
		this.e_tlulus = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,24,220,20],caption:"Tgl. Lulus", maxLength:50, tag:1});	

		this.sg = new saiGrid(this.pc1.childPage[1],{bound:[1,5,this.pc1.width-10,170],colCount:5,tag:0,				
...
window.app_saku3_transaksi_siswa_fSiswaYpt2.extend(window.childForm);
window.app_saku3_transaksi_siswa_fSiswaYpt2.implement({
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1])){
				try{									
					...
					sql.add("insert into sis_siswa_tarif(nis,kode_kelas,kode_param,per_awal,per_akhir,tarif,kode_lokasi,kode_pp,kode_akt) "+
							...
							"where a.nis='"+this.cb_kode.getText()+"' and xx.flag_aktif='1' and a.kode_pp='"+this.cb_pp.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"'");						
					*/
			...
			if (this.stsSimpan == 1) {
				...
				if (this.cb_kode.getText() != "") {
					var strSQL = "select a.kode_param,a.nama,isnull(b.tarif ,0) as tarif,isnull(b.per_awal ,'-') as bulan1, isnull(b.per_akhir ,'-') as bulan2 "+
								"from sis_param a "+	
								"left join sis_siswa_tarif b on a.kode_param=b.kode_param and a.kode_lokasi=b.kode_lokasi "+
								"where b.nis='"+this.cb_kode.getText()+"' and b.kode_lokasi = '"+this.app._lokasi+"' order by a.idx "; 					
				}
			}
