window.app_saku3_transaksi_siswa_fRekBillYspt2Bea = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siswa_fRekBillYspt2Bea.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siswa_fRekBillYspt2Bea";
...
window.app_saku3_transaksi_siswa_fRekBillYspt2Bea.extend(window.childForm);
window.app_saku3_transaksi_siswa_fRekBillYspt2Bea.implement({	
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{													
					...
					sql.add("insert into sis_rekon_j(no_rekon,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,nilai,kode_pp,kode_drk,kode_lokasi,modul,jenis,periode,kode_curr,kurs,nik_user,tgl_input) values "+
							"('"+this.e_nb.getText()+"','-','"+this.dp_d1.getDateString()+"',0,'"+this.cb_titip.getText()+"','"+this.e_ket.getText()+"','D',"+total+",'"+this.app._kodePP+"','-','"+this.app._lokasi+"','LOADBEA','TTP','"+this.e_periode.getText()+"','IDR',1,'"+this.app._userLog+"',getdate())");					
