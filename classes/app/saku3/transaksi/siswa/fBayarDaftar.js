window.app_saku3_transaksi_siswa_fBayarDaftar = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siswa_fBayarDaftar.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siswa_fBayarDaftar";
		...
		this.cb_pp = new saiCBBL(this.pc1.childPage[0],{bound:[20,15,220,20],caption:"Sekolah", readOnly:true, tag:2 });		
...
window.app_saku3_transaksi_siswa_fBayarDaftar.extend(window.childForm);
window.app_saku3_transaksi_siswa_fBayarDaftar.implement({
