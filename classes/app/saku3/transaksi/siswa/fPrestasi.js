window.app_saku3_transaksi_siswa_fPrestasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siswa_fPrestasi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siswa_fPrestasi";
...
window.app_saku3_transaksi_siswa_fPrestasi.extend(window.childForm);
window.app_saku3_transaksi_siswa_fPrestasi.implement({
