window.app_saku3_transaksi_siswa_fCDoutNonCashReg = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siswa_fCDoutNonCashReg.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siswa_fCDoutNonCashReg";
		this.itemsValue = new arrayList();
		this.maximize();	
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Pengeluaran CD per Calon Siswa Non Cash (Pdpt)", 0);	
...
window.app_saku3_transaksi_siswa_fCDoutNonCashReg.extend(window.childForm);
window.app_saku3_transaksi_siswa_fCDoutNonCashReg.implement({
