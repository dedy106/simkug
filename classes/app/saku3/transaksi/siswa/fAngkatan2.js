window.app_saku3_transaksi_siswa_fAngkatan2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siswa_fAngkatan2.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siswa_fAngkatan2";
...
window.app_saku3_transaksi_siswa_fAngkatan2.extend(window.childForm);
window.app_saku3_transaksi_siswa_fAngkatan2.implement({
	...
	doLoad:function(sender){								
		var strSQL = "select kode_akt, nama, kode_tingkat,flag_aktif from sis_angkat where kode_lokasi='"+this.app._lokasi+"' and kode_pp='"+this.app._kodePP+"'";		
		var data = this.dbLib.getDataProvider(strSQL,true);		
