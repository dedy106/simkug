window.app_saku3_transaksi_siswa_fAkruBillYpt2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siswa_fAkruBillYpt2.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siswa_fAkruBillYpt2";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Generate Billing Siswa", 0);	
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[1,20,995,325], childPage:["Jurnal Billing","Daftar Billing"]});		
...
window.app_saku3_transaksi_siswa_fAkruBillYpt2.extend(window.childForm);
window.app_saku3_transaksi_siswa_fAkruBillYpt2.implement({
