window.app_saku3_transaksi_siswa_fParamMod = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siswa_fParamMod.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siswa_fParamMod";
...
window.app_saku3_transaksi_siswa_fParamMod.extend(window.childForm);
window.app_saku3_transaksi_siswa_fParamMod.implement({
