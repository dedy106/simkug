window.app_saku3_transaksi_siswa_fBayarDaftarLoad = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siswa_fBayarDaftarLoad.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siswa_fBayarDaftarLoad";
		...
		this.e_piutang = new saiLabelEdit(this,{bound:[720,15,200,20],caption:"Total Tagihan", tag:1, readOnly:true, tipeText:ttNilai, text:"0"});			
...
window.app_saku3_transaksi_siswa_fBayarDaftarLoad.extend(window.childForm);
window.app_saku3_transaksi_siswa_fBayarDaftarLoad.implement({
