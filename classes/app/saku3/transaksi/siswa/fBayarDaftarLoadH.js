window.app_saku3_transaksi_siswa_fBayarDaftarLoadH = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siswa_fBayarDaftarLoadH.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siswa_fBayarDaftarLoadH";
...
window.app_saku3_transaksi_siswa_fBayarDaftarLoadH.extend(window.childForm);
window.app_saku3_transaksi_siswa_fBayarDaftarLoadH.implement({
