window.app_saku3_transaksi_siswa_fKaryawan = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siswa_fKaryawan.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siswa_fKaryawan";
		...
		this.c_jenis = new saiCB(this.pc1.childPage[1],{bound:[20,24,200,20],caption:"Status",items:["ADMIN","GURU","HONORER"], readOnly:true,tag:2});
		...
		this.cb_pp = new saiCBBL(this.pc1.childPage[1],{bound:[20,15,220,20],caption:"PP/Unit", multiSelection:false, maxLength:10, tag:2,change:[this,"doChange"]});
		this.cb_ppbaru = new saiCBBL(this.pc1.childPage[1],{bound:[520,15,220,20],caption:"PP/Unit Baru", multiSelection:false, maxLength:10, tag:2});
		...
		try {
			...
			this.cb_lokbaru.setText(this.app._lokasi);
...
window.app_saku3_transaksi_siswa_fKaryawan.extend(window.childForm);
window.app_saku3_transaksi_siswa_fKaryawan.implement({
