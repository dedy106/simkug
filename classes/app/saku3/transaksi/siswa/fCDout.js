window.app_saku3_transaksi_siswa_fCDout = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siswa_fCDout.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siswa_fCDout";
		this.itemsValue = new arrayList();
		this.maximize();	
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Pengeluaran CD per Siswa", 0);	
...
window.app_saku3_transaksi_siswa_fCDout.extend(window.childForm);
window.app_saku3_transaksi_siswa_fCDout.implement({
