window.app_saku3_transaksi_siswa_fRekBillYspt2CD = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siswa_fRekBillYspt2CD.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siswa_fRekBillYspt2CD";
...
window.app_saku3_transaksi_siswa_fRekBillYspt2CD.extend(window.childForm);
window.app_saku3_transaksi_siswa_fRekBillYspt2CD.implement({
