window.app_saku3_transaksi_siswa_fKbBillYspt2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siswa_fKbBillYspt2.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siswa_fKbBillYspt2";
		...
		this.pc1 = new pageControl(this,{bound:[20,12,900,300], childPage:["Data Tagihan","Data Pelunasan","Error Msg"]});
...
window.app_saku3_transaksi_siswa_fKbBillYspt2.extend(window.childForm);
window.app_saku3_transaksi_siswa_fKbBillYspt2.implement({
	...
	doLoad: function(sender){	
		if (this.cb_pp.getText()!="") {
			...
			var strSQL = "select aa.nis,aa.nama as siswa,aa.id_bank, a.no_bill,a.periode,a.akun_piutang,sum((a.nilai-isnull(b.tot_lunas,0))) as saldo,0 as lunas,0 as sisa,a.kode_param,c.idx "+
						 "from sis_bill_d a "+
