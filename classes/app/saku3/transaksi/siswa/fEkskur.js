window.app_saku3_transaksi_siswa_fEkskur = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siswa_fEkskur.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siswa_fEkskur";
...
window.app_saku3_transaksi_siswa_fEkskur.extend(window.childForm);
window.app_saku3_transaksi_siswa_fEkskur.implement({
