window.app_saku3_transaksi_siswa_fSiswaReg = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siswa_fSiswaReg.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siswa_fSiswaReg";
		...
		this.e_idbank = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,11,300,20],caption:"ID Bank", maxLength:30, tag:1});
...
window.app_saku3_transaksi_siswa_fSiswaReg.extend(window.childForm);
window.app_saku3_transaksi_siswa_fSiswaReg.implement({
