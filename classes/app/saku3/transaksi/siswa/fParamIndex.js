window.app_saku3_transaksi_siswa_fParamIndex = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siswa_fParamIndex.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siswa_fParamIndex";
...
window.app_saku3_transaksi_siswa_fParamIndex.extend(window.childForm);
window.app_saku3_transaksi_siswa_fParamIndex.implement({
