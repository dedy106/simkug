window.app_saku3_transaksi_siswa_fJadwalUjian = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siswa_fJadwalUjian.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siswa_fJadwalUjian";
...
window.app_saku3_transaksi_siswa_fJadwalUjian.extend(window.childForm);
window.app_saku3_transaksi_siswa_fJadwalUjian.implement({
