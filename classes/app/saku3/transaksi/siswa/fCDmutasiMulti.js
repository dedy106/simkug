window.app_saku3_transaksi_siswa_fCDmutasiMulti = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siswa_fCDmutasiMulti.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siswa_fCDmutasiMulti";
...
window.app_saku3_transaksi_siswa_fCDmutasiMulti.extend(window.childForm);
window.app_saku3_transaksi_siswa_fCDmutasiMulti.implement({
