window.app_saku3_transaksi_siswa_fCaSiswaLoadYpt = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siswa_fCaSiswaLoadYpt.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku3_transaksi_siswa_fCaSiswaLoadYpt";
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Data Calon Siswa", 0);	
...
window.app_saku3_transaksi_siswa_fCaSiswaLoadYpt.extend(window.portalui_childForm);
window.app_saku3_transaksi_siswa_fCaSiswaLoadYpt.implement({	
