window.app_saku3_transaksi_siswa_fTA = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siswa_fTA.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siswa_fTA";
...
window.app_saku3_transaksi_siswa_fTA.extend(window.childForm);
window.app_saku3_transaksi_siswa_fTA.implement({
