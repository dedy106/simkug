window.app_saku3_transaksi_siswa_fCDin = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_siswa_fCDin.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_siswa_fCDin";
...
window.app_saku3_transaksi_siswa_fCDin.extend(window.childForm);
window.app_saku3_transaksi_siswa_fCDin.implement({
