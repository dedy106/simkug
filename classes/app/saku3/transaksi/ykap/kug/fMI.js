window.app_saku3_transaksi_ykap_kug_fMI = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_ykap_kug_fMI.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_ykap_kug_fMI";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Memorial Jurnal", 0);	
		...
		this.e_debet = new saiLabelEdit(this.pc2.childPage[0],{bound:[790,11,200,20],caption:"Total Debet", tag:1, readOnly:true, tipeText:ttNilai, text:"0"});		
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[5,12,990,282], childPage:["Item Jurnal","Approval"]});
		...
		this.cb_buat = new saiCBBL(this.pc1.childPage[1],{bound:[20,10,220,20],caption:"Dibuat Oleh", multiSelection:false, maxLength:10, tag:2});		
		...
		this.e_nb2 = new saiLabelEdit(this.pc2.childPage[2],{bound:[20,14,200,20],caption:"No Bukti",tag:9});		
...
window.app_saku3_transaksi_ykap_kug_fMI.extend(window.childForm);
window.app_saku3_transaksi_ykap_kug_fMI.implement({				
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					sql.add("insert into trans_m (no_bukti,kode_lokasi,tgl_input,nik_user,periode,modul,form,posted,prog_seb,progress,kode_pp,tanggal,no_dokumen,keterangan,kode_curr,kurs,nilai1,nilai2,nilai3,nik1,nik2,nik3,no_ref1,no_ref2,no_ref3,param1,param2,param3) values "+
							"('"+this.e_nb.getText()+"','"+this.app._lokasi+"',getdate(),'"+this.app._userLog+"','"+this.e_periode.getText()+"','MI','MI','F','-','-','"+this.app._kodePP+"','"+this.dp_d1.getDateString()+"','"+this.e_dok2.getText()+"','"+this.e_ket.getText()+"','IDR',1,"+
							parseNilai(this.e_debet.getText())+",0,0,'"+this.cb_buat.getText()+"','"+this.cb_periksa.getText()+"','-','-','-','-','"+this.c_jtran.getText()+"','-','"+this.c_jenis.getText()+"')");
	...
	doModalResult: function(event, modalResult){
		...
		switch (event){
			...
			case "simpan" :															
			case "ubah" :			
				var strSQL = "select no_bukti from trans_m where modul='MI' and no_dokumen='"+this.e_dok2.getText()+"' and no_bukti <> '"+this.e_nb.getText()+"' and kode_lokasi='"+this.app._lokasi+"'";						
	...
	doCari:function(sender){																		
		var filter = "";
		if (this.e_nb2.getText()!="") filter = " and a.no_bukti like '%"+this.e_nb2.getText()+"%' ";		
		if (this.e_ket2.getText()!="") filter = " and a.keterangan like '%"+this.e_ket2.getText()+"%' ";	

		var strSQL = "select a.no_bukti,convert(varchar,a.tanggal,103) as tgl,a.param3 as jenis,a.keterangan,a.nilai1 "+
					 ...
					 "where a.periode='"+this.e_periode.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' and a.modul = 'MI' and a.posted ='F' and a.form='MI' " +filter;				
		var data = this.dbLib.getDataProvider(strSQL,true);
