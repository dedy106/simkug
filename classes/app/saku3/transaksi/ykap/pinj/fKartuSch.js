window.app_saku3_transaksi_ykap_pinj_fKartuSch = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_ykap_pinj_fKartuSch.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_ykap_pinj_fKartuSch";
		...
		this.i_del = new portalui_imageButton(this.sgn,{bound:[350,2,20,20],hint:"Delete All",image:"icon/"+system.getThemes()+"/tabCont2.png",click:[this,"doDel"]});						
...
window.app_saku3_transaksi_ykap_pinj_fKartuSch.extend(window.portalui_childForm);
window.app_saku3_transaksi_ykap_pinj_fKartuSch.implement({
	doDel: function() {
		this.sg.clear(1);
	},
