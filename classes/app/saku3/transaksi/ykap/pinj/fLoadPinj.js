window.app_saku3_transaksi_ykap_pinj_fLoadPinj = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_ykap_pinj_fLoadPinj.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_ykap_pinj_fLoadPinj";
...
window.app_saku3_transaksi_ykap_pinj_fLoadPinj.extend(window.childForm);
window.app_saku3_transaksi_ykap_pinj_fLoadPinj.implement({			
	...
	simpan: function(){			
		try{						
			this.e_nb.setText(this.standarLib.noBuktiOtomatis(this.dbLib,"trans_m","no_bukti","PTP"+this.e_periode.getText().substr(2,2)+".","00000"));						
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{													
					...
					sql.add("insert into trans_m (no_bukti,kode_lokasi,tgl_input,nik_user,periode,modul,form,posted,prog_seb,progress,kode_pp,tanggal,no_dokumen,keterangan,kode_curr,kurs,nilai1,nilai2,nilai3,nik1,nik2,nik3,no_ref1,no_ref2,no_ref3,param1,param2,param3) values "+
							"('"+this.e_nb.getText()+"','"+this.app._lokasi+"',getdate(),'"+this.app._userLog+"','"+this.e_periode.getText()+"','KB','LOAD','F','0','0','"+this.app._kodePP+"','"+this.dp_d1.getDateString()+"','-','"+this.e_ket.getText()+"','IDR',1,"+parseNilai(this.e_nilai.getText())+",0,0,'"+this.cb_app.getText()+"','-','-','-','-','-','"+this.cb_titip.getText()+"','-','-')");
					...
					sql.add("insert into kop_pinjangs_m(no_angs,no_dokumen,keterangan,tanggal,nilai,nilai_lain,nilai_sls,modul,periode,kode_lokasi,posted,kode_pp,nik_app,nik_user,tgl_input,no_kas) values  "+
							"('"+this.e_nb.getText()+"','"+this.cb_titip.getText()+"','"+this.e_ket.getText()+"','"+this.dp_d1.getDateString()+"',"+nilaiToFloat(this.e_nilai.getText())+",0,0,'LOAD','"+this.e_periode.getText()+"','"+this.app._lokasi+"','X','"+this.app._kodePP+"','"+this.cb_app.getText()+"','"+this.app._userLog+"',getdate(),'"+this.e_nb.getText()+"')");
