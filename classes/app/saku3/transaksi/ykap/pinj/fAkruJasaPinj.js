window.app_saku3_transaksi_ykap_pinj_fAkruJasaPinj = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_ykap_pinj_fAkruJasaPinj.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_ykap_pinj_fAkruJasaPinj";
...
window.app_saku3_transaksi_ykap_pinj_fAkruJasaPinj.extend(window.portalui_childForm);
window.app_saku3_transaksi_ykap_pinj_fAkruJasaPinj.implement({
			...
			if (this.standarLib.checkEmptyByTag(this, [0,2])){
				try{													
					...
					sql.add("insert into trans_m (no_bukti,kode_lokasi,tgl_input,nik_user,periode,modul,form,posted,prog_seb,progress,kode_pp,tanggal,no_dokumen,keterangan,kode_curr,kurs,nilai1,nilai2,nilai3,nik1,nik2,nik3,no_ref1,no_ref2,no_ref3,param1,param2,param3) values "+
							"('"+this.e_nb.getText()+"','"+this.app._lokasi+"',getdate(),'"+this.app._userLog+"','"+this.e_periode.getText()+"','SP','GENBILL','F','0','0','"+this.app._kodePP+"','"+this.dp_d1.getDateString()+"','-','"+this.e_desc.getText()+"','IDR',1,"+nilaiToFloat(this.e_total.getText())+",0,0,'-','-','-','-','-','-','-','-','-')");
					...
					for (var i=0; i<this.sg2.getRowCount(); i++){
						if (this.sg2.rowValid(i)){
							...
							sql.add("insert into trans_j (no_bukti,kode_lokasi,tgl_input,nik_user,periode,no_dokumen,tanggal,nu,kode_akun,dc,nilai,nilai_curr,keterangan,modul,jenis,kode_curr,kurs,kode_pp,kode_drk,kode_cust,kode_vendor,no_fa,no_selesai,no_ref1,no_ref2,no_ref3) values "+
									"('"+this.e_nb.getText()+"','"+this.app._lokasi+"',getdate(),'"+this.app._userLog+"','"+this.e_periode.getText()+"','-','"+this.dp_d1.getDateString()+"',"+i+",'"+this.sg2.cells(2,i)+"','D',"+nilaiToFloat(this.sg2.cells(6,i))+",'"+nilaiToFloat(this.sg2.cells(6,i))+"','"+this.e_desc.getText()+"','GENBILL','PJASA','IDR',1,'"+this.app._kodePP+"','-','-','-','-','-','-','-','-')");
							sql.add("insert into trans_j (no_bukti,kode_lokasi,tgl_input,nik_user,periode,no_dokumen,tanggal,nu,kode_akun,dc,nilai,nilai_curr,keterangan,modul,jenis,kode_curr,kurs,kode_pp,kode_drk,kode_cust,kode_vendor,no_fa,no_selesai,no_ref1,no_ref2,no_ref3) values "+
									"('"+this.e_nb.getText()+"','"+this.app._lokasi+"',getdate(),'"+this.app._userLog+"','"+this.e_periode.getText()+"','-','"+this.dp_d1.getDateString()+"',"+j+",'"+this.sg2.cells(4,i)+"','C',"+nilaiToFloat(this.sg2.cells(6,i))+",'"+nilaiToFloat(this.sg2.cells(6,i))+"','"+this.e_desc.getText()+"','GENBILL','PDPT','IDR',1,'"+this.app._kodePP+"','-','-','-','-','-','-','-','-')");							
						}
					}					
