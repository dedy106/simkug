window.app_saku3_transaksi_apparindo_fPostingApar = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_apparindo_fPostingApar.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_apparindo_fPostingApar";
...
window.app_saku3_transaksi_apparindo_fPostingApar.extend(window.childForm);
window.app_saku3_transaksi_apparindo_fPostingApar.implement({
			...
			if (this.c_modul.getText() != "") {
				...
				switch(this.c_modul.getText()){
					...
					case "AR" :
								...
								this.cb_bukti.setSQL("select no_piutang as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'PIU' as jenis from piutang_m where posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' ",													
