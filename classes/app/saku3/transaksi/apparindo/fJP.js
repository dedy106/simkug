window.app_saku3_transaksi_apparindo_fJP = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_apparindo_fJP.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku3_transaksi_apparindo_fJP";
...
window.app_saku3_transaksi_apparindo_fJP.extend(window.portalui_childForm);
window.app_saku3_transaksi_apparindo_fJP.implement({
	doUploadTB: function(){		
		try{
