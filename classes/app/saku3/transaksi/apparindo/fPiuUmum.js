window.app_saku3_transaksi_apparindo_fPiuUmum = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_apparindo_fPiuUmum.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_apparindo_fPiuUmum";
		...
		this.e_sertif = new saiLabelEdit(this.pc2.childPage[0],{bound:[780,16,200,20],caption:"No. Sertifikat", maxLength:150});						
		this.l_tgl2 = new portalui_label(this.pc2.childPage[0],{bound:[20,20,100,18],caption:"Due Date", underline:true});
		this.dp_d2 = new portalui_datePicker(this.pc2.childPage[0],{bound:[120,20,100,18]}); 					
		this.c_stsppn = new saiCB(this.pc2.childPage[0],{bound:[780,20,200,20],caption:"Status PPN",items:["PPN","NON"], readOnly:true,tag:9,change:[this,"doChange"]});
		...
		this.e_nilai = new saiLabelEdit(this.pc2.childPage[0],{bound:[780,13,200,20],caption:"Nilai", tag:1, readOnly:true, tipeText:ttNilai, text:"0"});								
		...
		this.e_ppn = new saiLabelEdit(this.pc2.childPage[0],{bound:[780,15,200,20],caption:"PPN", tag:1, tipeText:ttNilai, text:"0", readOnly:true});		
		...
		this.e_total = new saiLabelEdit(this.pc2.childPage[0],{bound:[780,19,200,20],caption:"Total", tag:1, readOnly:true, tipeText:ttNilai, text:"0"});		
		
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[1,10,995,232], childPage:["Data Item Jurnal"]});
		this.sg = new saiGrid(this.pc1.childPage[0],{bound:[1,5,this.pc1.width-5,this.pc1.height-30],colCount:7,tag:0,
		            colTitle:["Kode Akun","Nama Akun","DC","Keterangan","Nilai","Kode PP","Nama PP"],
					colWidth:[[6,5,4,3,2,1,0],[150,80,100,290,40,200,80]],					
		...
		try {
			...
			sql.add("select a.kode_akun,a.nama from masakun a inner join flag_relasi b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi and b.kode_flag = '044' where a.block= '0' and a.kode_lokasi = '"+this.app._lokasi+"'");						
...
window.app_saku3_transaksi_apparindo_fPiuUmum.extend(window.childForm);
window.app_saku3_transaksi_apparindo_fPiuUmum.implement({
		...
		try{						
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					sql.add("insert into piutang_m(no_piutang,kode_lokasi,no_dokumen,tanggal,keterangan,kode_project,kode_cust,kode_curr,kurs,nik_app,kode_pp,nilai,periode,nik_user,tgl_input,akun_piutang,posted,nilai_ppn,due_date,no_sertifikat) values  "+
							"('"+this.e_nb.getText()+"','"+this.app._lokasi+"','"+this.e_dok.getText()+"','"+this.dp_d1.getDateString()+"','"+this.e_ket.getText()+"','-','"+this.cb_cust.getText()+"','IDR',1,'"+this.cb_app.getText()+"','"+this.cb_pp.getText()+"',"+parseNilai(this.e_nilai.getText())+",'"+this.e_periode.getText()+"','"+this.app._userLog+"',getdate(),'"+this.cb_akun.getText()+"','F',"+parseNilai(this.e_ppn.getText())+",'"+this.dp_d2.getDateString()+"','"+this.e_sertif.getText()+"')");								
			...
			if (sender == this.sg) {
				if (col == 0){
					this.standarLib.showListData(this, "Daftar Akun",sender,undefined, 
												  "select a.kode_akun,a.nama    from masakun a inner join flag_relasi b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi and b.kode_flag='044' where a.block= '0' and a.kode_lokasi = '"+this.app._lokasi+"'",
												  "select count(*)from (select a.kode_akun,a.nama    from masakun a inner join flag_relasi b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi and b.kode_flag='044' where a.block= '0' and a.kode_lokasi = '"+this.app._lokasi+"')x",
				...
				if (col == 5){
					this.standarLib.showListData(this, "Daftar PP/Unit",sender,undefined, 
												  ...
												  "select count(*) from (select a.kode_pp,a.nama from pp a inner join karyawan_pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi and b.nik = '"+this.app._userLog+"'  where a.flag_aktif= '1' and a.kode_lokasi = '"+this.app._lokasi+"')x",
	...
	doDoubleClick3: function(sender, col , row) {
		try{
			if (this.sg3.cells(0,row) != "") {
				...
				var strSQL = "select a.tanggal,a.periode,a.no_dokumen,a.keterangan,a.kode_pp,a.akun_piutang,a.nik_app,a.kode_cust,c.nama as nama_cust,a.nilai_ppn, "+						 
							 "a.no_sertifikat,a.due_date "+
				...
				if (typeof data == "object"){					
					...
					if (line != undefined){								
						...
						this.e_sertif.setText(line.no_sertifikat);
						this.dp_d2.setText(line.due_date);
						this.cb_cust.setText(line.kode_cust,line.nama_cust);					
						this.e_ppn.setText(floatToNilai(line.nilai_ppn));

						if (parseFloat(line.nilai_ppn) != 0) this.c_stsppn.setText("PPN");
