window.app_saku3_transaksi_apparindo_fKbPiu = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_apparindo_fKbPiu.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_apparindo_fKbPiu";
		...
		this.sg = new saiGrid(this.pc1.childPage[0],{bound:[1,5,this.pc1.width-5,this.pc1.height-45],colCount:7,tag:0,
...
window.app_saku3_transaksi_apparindo_fKbPiu.extend(window.childForm);
window.app_saku3_transaksi_apparindo_fKbPiu.implement({
