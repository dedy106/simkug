window.app_saku3_transaksi_spj_fTUVerPD3v3 = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_spj_fTUVerPD3v3.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spj_fTUVerPD3v3";
...
window.app_saku3_transaksi_spj_fTUVerPD3v3.extend(window.childForm);
window.app_saku3_transaksi_spj_fTUVerPD3v3.implement({
	doLoad : function() {
				...
				switch(methodName){
	    			case "execArraySQL" :	    				
						if (result.toLowerCase().search("error") == -1){
							if (this.preView == "1") {								
								this.nama_report="server_report_saku3_spj_rptPdAppFormTu3";
