window.app_saku3_transaksi_spj_fPoh = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_spj_fPoh.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spj_fPoh";
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Data Setting POH", 0);	
		
		uses("saiCBBL;saiEdit;saiGrid;sgNavigator");		
		this.cb_nik = new saiCBBL(this,{bound:[20,11,200,20],caption:"NIK", multiSelection:false, maxLength:10, tag:1,change:[this,"doLoad"]});		
		this.cb_nik2 = new saiCBBL(this,{bound:[20,12,200,20],caption:"NIK POH", multiSelection:false, maxLength:10, tag:1});		
		this.cb_nik3 = new saiCBBL(this,{bound:[20,13,200,20],caption:"NIK Login", multiSelection:false, maxLength:10, tag:1});		
...
window.app_saku3_transaksi_spj_fPoh.extend(window.childForm);
window.app_saku3_transaksi_spj_fPoh.implement({
