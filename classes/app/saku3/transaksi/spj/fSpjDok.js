window.app_saku3_transaksi_spj_fSpjDok = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_spj_fSpjDok.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spj_fSpjDok";
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[1,12,990,348], childPage:["Data SPPD","Data Transport","Uang Harian"]});
...
window.app_saku3_transaksi_spj_fSpjDok.extend(window.childForm);
window.app_saku3_transaksi_spj_fSpjDok.implement({		
