window.app_saku3_transaksi_spj_fTUVerPD2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_spj_fTUVerPD2.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spj_fTUVerPD2";
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[5,20,990,200], childPage:["Data Pengajuan PD","Agenda","Rekening"]});		
		this.sg1 = new saiGrid(this.pc1.childPage[0],{bound:[0,5,this.pc1.width-5,this.pc1.height-35],colCount:8,tag:0,
				...
				colWidth:[[7,6,5,4,3,2,1,0],[50,100,80,300,100,250,120,80]],
...
window.app_saku3_transaksi_spj_fTUVerPD2.extend(window.childForm);
window.app_saku3_transaksi_spj_fTUVerPD2.implement({
	doLoad : function() {
		var strSQL = "select a.no_spj,b.nik+' - '+b.nama as nama,b.kode_pp,a.keterangan,CONVERT(varchar,a.tanggal,103) as tgl,a.nilai,b.nik "+
					 ...
					 "where a.progress in ('0','R') and a.kode_lokasi='"+this.app._lokasi+"' and c.nik='"+this.app._userLog+"' ";
