window.app_saku3_transaksi_spj_fTUajuPD3 = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_spj_fTUajuPD3.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spj_fTUajuPD3";
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[5,20,990,312], childPage:["Detail PD","Rekening"]});		
		...
		this.e_bank = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,22,300,20],caption:"Bank", maxLength:100, readOnly:true});						
		this.e_cabang = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,23,450,20],caption:"Cabang", maxLength:100, readOnly:true});						
		this.e_norek = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,24,300,20],caption:"No Rekeking", maxLength:100, readOnly:true});						
		this.e_namarek = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,25,300,20],caption:"Nama Rekening", maxLength:100, readOnly:true});						
...
window.app_saku3_transaksi_spj_fTUajuPD3.extend(window.childForm);
window.app_saku3_transaksi_spj_fTUajuPD3.implement({		
