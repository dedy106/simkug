window.app_saku3_transaksi_spj_fRoleApp = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_spj_fRoleApp.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spj_fRoleApp";
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Data Role Approve", 0);	
		...
		this.pc1 = new pageControl(this,{bound:[20,12,1000,450], childPage:["Daftar NIK","Data NIK","UpLoad"]});
		...
		this.sg = new portalui_saiGrid(this.pc1.childPage[2],{bound:[1,5,this.pc1.width-5,this.pc1.height-30],colCount:3,tag:9,
...
window.app_saku3_transaksi_spj_fRoleApp.extend(window.childForm);
window.app_saku3_transaksi_spj_fRoleApp.implement({
	...
	doLoad:function(sender){								
		try {
			...
			var strSQL = "select a.nik,b.nama "+
						 "from pdss_role_nik a inner join karyawan b on a.nik=b.nik "+					 
						 "order by a.nik";							
			var data = this.dbLib.getDataProvider(strSQL,true);		
