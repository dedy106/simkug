window.app_saku3_transaksi_spj_fAppDir = function(owner)
{
	if (owner)
	{		
		window.app_saku3_transaksi_spj_fAppDir.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spj_fAppDir";
...
window.app_saku3_transaksi_spj_fAppDir.extend(window.childForm);
window.app_saku3_transaksi_spj_fAppDir.implement({	
