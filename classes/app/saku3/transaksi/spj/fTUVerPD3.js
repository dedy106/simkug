window.app_saku3_transaksi_spj_fTUVerPD3 = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_spj_fTUVerPD3.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spj_fTUVerPD3";
...
window.app_saku3_transaksi_spj_fTUVerPD3.extend(window.childForm);
window.app_saku3_transaksi_spj_fTUVerPD3.implement({
	doLoad : function() {
