window.app_saku3_transaksi_spj_fAppMan = function(owner)
{
	if (owner)
	{		
		window.app_saku3_transaksi_spj_fAppMan.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spj_fAppMan";
...
window.app_saku3_transaksi_spj_fAppMan.extend(window.childForm);
window.app_saku3_transaksi_spj_fAppMan.implement({	
