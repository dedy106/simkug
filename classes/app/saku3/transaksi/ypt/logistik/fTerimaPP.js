window.app_saku3_transaksi_ypt_logistik_fTerimaPP = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_ypt_logistik_fTerimaPP.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_ypt_logistik_fTerimaPP";
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[1,12,995,268], childPage:["Item SPK","Detail Barang","Dokumen Pendukung"]});
		...
		this.sg2 = new saiGrid(this.pc1.childPage[1],{bound:[1,5,this.pc1.width-5,this.pc1.height-33],colCount:11,
...
window.app_saku3_transaksi_ypt_logistik_fTerimaPP.extend(window.childForm);
window.app_saku3_transaksi_ypt_logistik_fTerimaPP.implement({	
		...
		try {	
			if ((sender == this.cb_vendor || sender == this.e_periode) && this.cb_vendor.getText()!="" && this.e_periode.getText()!="" && this.stsSimpan == 1) {
				...
				this.cb_po.setSQL("select distinct a.no_spk, a.keterangan from log_spk_m a "+
                                ...
                                "     inner join karyawan_pp e on c.kode_pp=e.kode_pp and c.kode_lokasi=e.kode_lokasi and e.nik='"+this.app._userLog+"' "+
	...
	doLoad3:function(sender){																							
		var strSQL = "select a.no_terima,convert(varchar,a.tanggal,103) as tgl,a.keterangan,b.nama "+
                     ...
                     "				 inner join log_spk_m e on a.no_po=e.no_spk and a.kode_lokasi=e.kode_lokasi "+
                     "inner join log_pesan_m c on e.no_pesan=c.no_pesan and e.kode_lokasi=c.kode_lokasi "+ 
