window.app_saku3_transaksi_ypt_logistik_fPbAgendaBA = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_ypt_logistik_fPbAgendaBA.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_ypt_logistik_fPbAgendaBA";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Agenda Logistik Ref BAST", 0);	
		...
		this.e_nb = new portalui_saiLabelEdit(this.pc2.childPage[0],{bound:[20,11,200,20],caption:"No PB",maxLength:30,readOnly:true});
		this.e_agenda = new portalui_saiLabelEdit(this.pc2.childPage[0],{bound:[20,12,200,20],caption:"No Agenda",maxLength:30,readOnly:true});		
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[1,12,995,325], childPage:["Otorisasi","Data Akru","Data Permohonan","","Data Approval"]});//"Jurnal+ / Budget",
		...
		this.e_tanggal = new saiLabelEdit(this.pc1.childPage[2],{bound:[270,16,200,20],caption:"Tanggal", readOnly:true,tag:4});				
		this.e_kethut = new saiLabelEdit(this.pc1.childPage[2],{bound:[20,17,450,20],caption:"Keterangan", readOnly:true,tag:4});						
		this.e_akun = new saiLabelEdit(this.pc1.childPage[2],{bound:[20,16,220,20],caption:"Kode Akun", readOnly:true,tag:4});				
		this.e_namaakun = new saiLabelEdit(this.pc1.childPage[2],{bound:[250,16,220,20],labelWidth:0, caption:"", readOnly:true,tag:4});						
		this.e_saldo = new saiLabelEdit(this.pc1.childPage[2],{bound:[20,11,220,20],caption:"Saldo Hutang", tag:4, readOnly:true, tipeText:ttNilai, text:"0"});				
		this.e_ppn = new saiLabelEdit(this.pc1.childPage[2],{bound:[520,11,220,20],caption:"Nilai PPN", tag:4, readOnly:true, tipeText:ttNilai, text:"0"});				
		this.e_nilai = new saiLabelEdit(this.pc1.childPage[2],{bound:[20,12,220,20],caption:"Nilai Hutang", tag:4, tipeText:ttNilai, text:"0",change:[this,"doChange"]});				
		this.e_total = new saiLabelEdit(this.pc1.childPage[2],{bound:[520,12,220,20],caption:"Nilai Pengajuan PB", tag:4, readOnly:true, tipeText:ttNilai, text:"0"});				

		this.sg5 = new saiGrid(this.pc1.childPage[2],{bound:[1,5,this.pc1.width-5,101],colCount:9,tag:9,
		...
		this.sg1 = new saiGrid(this.pc1.childPage[3],{bound:[1,5,this.pc1.width-5,this.pc1.height-153],colCount:9,tag:9,visible:false,
		            colTitle:["Kode Akun","Nama Akun","DC","Keterangan","Nilai","Kode PP","Nama PP","Kode DRK","Nama DRK"],
					colWidth:[[8,7,6,5,4,3,2,1,0],[150,80,150,80,100,270,50,200,80]],					
		...
		this.sgn1 = new portalui_sgNavigator(this.pc1.childPage[3],{bound:[1,179,this.pc1.width-1,25],buttonStyle:2,grid:this.sg1,visible:false});		
		
		this.sg2 = new saiGrid(this.pc1.childPage[3],{bound:[1,210,this.pc1.width-5,90],colCount:9,tag:9,visible:false,
		...
		this.sgn2 = new portalui_sgNavigator(this.pc1.childPage[3],{bound:[1,this.pc1.height-25,this.pc1.width-1,25],buttonStyle:3,grid:this.sg2,visible:false});
		...
		this.e_noapp = new saiLabelEdit(this.pc1.childPage[4],{bound:[20,15,450,20],caption:"No Approve/Ver", tag:9, readOnly:true});
...
window.app_saku3_transaksi_ypt_logistik_fPbAgendaBA.extend(window.childForm);
window.app_saku3_transaksi_ypt_logistik_fPbAgendaBA.implement({		
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2,4])){
				try{														
					...
					sql.add("insert into it_aju_m(no_aju,kode_lokasi,periode,tanggal,modul,kode_akun,kode_pp,kode_drk,keterangan,nilai,tgl_input,nik_user,no_ver,no_fiat,no_kas,progress,nik_panjar,no_ptg,user_input,sts_pajak) values "+
							"('"+this.e_agenda.getText()+"','"+this.app._lokasi+"','"+this.e_periode.getText()+"','"+this.dp_d1.getDateString()+"','LOG','"+this.e_akun.getText()+"','"+this.app._kodePP+"','-','"+this.e_ket.getText()+"',"+nilaiToFloat(this.e_total.getText())+",getdate(),'"+this.app._userLog+"','-','-','-','A','-','-','"+this.app._namaUser.substr(0,50)+"','NON')");						
					sql.add("insert into it_aju_rek(no_aju,kode_lokasi,bank,no_rek,nama_rek,bank_trans,nilai,keterangan) values "+
							"('"+this.e_agenda.getText()+"','"+this.app._lokasi+"','"+this.e_bank.getText() +" ','"+this.e_norek.getText()+"','"+this.e_namarek.getText()+"','-',"+nilaiToFloat(this.e_total.getText())+",'-')");							
					...
					if (this.sg1.getRowValidCount() > 0){
						for (var i=0;i < this.sg1.getRowCount();i++){
							if (this.sg1.rowValid(i)){
								var j = i+1;
								sql.add("insert into yk_pb_j(no_pb,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,nilai,kode_pp,kode_drk,kode_lokasi,modul,jenis,periode,nik_user,tgl_input,kode_curr,kurs) values "+
										"('"+this.e_nb.getText()+"','"+this.e_dok.getText()+"','"+this.dp_d1.getDateString()+"',"+i+",'"+this.sg1.cells(0,i)+"','"+this.sg1.cells(3,i)+"','"+this.sg1.cells(2,i).toUpperCase()+"',"+nilaiToFloat(this.sg1.cells(4,i))+",'"+this.sg1.cells(5,i)+"','"+this.sg1.cells(7,i)+"','"+this.app._lokasi+"','"+this.modul+"','TAMBAH','"+this.e_periode.getText()+"','"+this.app._userLog+"',getdate(),'IDR',1)");										
							}
						}
					}	
					*/
				...
				switch(methodName){
	    			case "execArraySQL" :	    				
						if (result.toLowerCase().search("error") == -1){
							if (this.preView == "1") {								
								this.nama_report="server_report_saku3_ypt_logistik_rptAgendaForm";
	...
	doLoad3:function(sender){			
		...
		var strSQL = "select a.no_pb,convert(varchar,a.tanggal,103) as tgl,a.modul,a.no_dokumen,a.keterangan,a.progress,a.nilai "+
		             "from yk_pb_m a "+	
		             "Inner Join it_aju_m b on a.no_agenda=b.no_aju and a.kode_lokasi=b.kode_lokasi "+	
					 "where "+pp+" a.periode='"+this.e_periode.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' and a.modul = 'PBAKRU' and a.progress in ('0','R','V') and b.progress='0' ";					 
		var data = this.dbLib.getDataProvider(strSQL,true);
		if (typeof data == "object" && data.rs.rows[0] != undefined){
			this.dataJU3 = data;
	...
	doDoubleClick3: function(sender, col , row) {
		try{
			if (this.sg3.cells(0,row) != "") {
				...
				var strSQL = "select a.no_agenda,a.nilai_final,a.nilai-isnull(c.tambah,0) as nilai,a.no_hutang,a.no_ver as no_verlama,a.no_app as no_applama,a.keterangan,a.no_dokumen,a.modul,a.due_date,a.tanggal,a.nik_tahu,a.nik_app,a.progress,isnull(b.no_app,'-') as no_app,isnull(b.catatan,'-') as catatan "+
				...
				if (typeof data == "object"){
					var line = data.rs.rows[0];							
					if (line != undefined){			
						this.e_agenda.setText(line.no_agenda);										
