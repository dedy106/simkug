window.app_saku3_transaksi_ypt_logistik_fFasusutAddDrk = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_ypt_logistik_fFasusutAddDrk.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_ypt_logistik_fFasusutAddDrk";
		...
		this.cb_fa = new saiCBBL(this,{bound:[20,18,220,20],caption:"No Aktiva Tetap", multiSelection:false, maxLength:10, tag:0, change:[this,"doChange"]});		
		this.cb_drk = new saiCBBL(this,{bound:[20,20,220,20],caption:"DRK Penyusutan", readOnly:true});
...
window.app_saku3_transaksi_ypt_logistik_fFasusutAddDrk.extend(window.childForm);
window.app_saku3_transaksi_ypt_logistik_fFasusutAddDrk.implement({
