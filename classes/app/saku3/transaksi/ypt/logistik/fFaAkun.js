window.app_saku3_transaksi_ypt_logistik_fFaAkun = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_ypt_logistik_fFaAkun.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_ypt_logistik_fFaAkun";
...
window.app_saku3_transaksi_ypt_logistik_fFaAkun.extend(window.childForm);
window.app_saku3_transaksi_ypt_logistik_fFaAkun.implement({
