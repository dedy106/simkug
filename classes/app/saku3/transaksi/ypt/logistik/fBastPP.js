window.app_saku3_transaksi_ypt_logistik_fBastPP = function (owner) {
	if (owner) {
		window.app_saku3_transaksi_ypt_logistik_fBastPP.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku3_transaksi_ypt_logistik_fBastPP";
		...
		this.pc1 = new pageControl(this.pc2.childPage[0], { bound: [1, 12, 995, 304], childPage: ["Data SPK", "Data Penerimaan", "Data Jurnal+", "Data Barang","Otorisasi"] });
		...
		this.sg4 = new saiGrid(this.pc1.childPage[3], {
		...
		this.cb_app = new saiCBBL(this.pc1.childPage[4], { bound: [20, 13, 220, 20], caption: "Diperiksa Oleh", multiSelection: false, maxLength: 10, tag: 1 });
...
window.app_saku3_transaksi_ypt_logistik_fBastPP.extend(window.childForm);
window.app_saku3_transaksi_ypt_logistik_fBastPP.implement({
	isiSPK: function () {
		//belum pernah bast
	...
	doLoad3: function (sender) {
		var strSQL = "select a.no_hutang,convert(varchar,a.tanggal,103) as tgl,a.no_dokumen,a.keterangan,a.kode_vendor+' - '+b.nama as vendor,a.nilai " +
            ...
            "inner join log_spk_m d on a.no_hutang=d.no_ba and a.kode_lokasi=d.kode_lokasi "+
            "inner join log_pesan_m e on d.no_pesan=e.no_pesan and d.kode_lokasi=e.kode_lokasi "+ 
            "inner join karyawan_pp f on e.kode_pp=f.kode_pp and e.kode_lokasi=f.kode_lokasi and f.nik='"+this.app._userLog+"' "+ 
