window.app_saku3_transaksi_ypt_logistik_fFasusutRevDrk = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_ypt_logistik_fFasusutRevDrk.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_ypt_logistik_fFasusutRevDrk";
		...
		this.cb_fa = new saiCBBL(this,{bound:[20,20,220,20],caption:"No Aktiva Tetap", multiSelection:false, maxLength:10, tag:0, change:[this,"doChange"]});		
		this.cb_drk = new saiCBBL(this,{bound:[20,18,220,20],caption:"DRK Penyusutan", readOnly:true});		
		this.e_pp = new portalui_saiLabelEdit(this,{bound:[20,17,432,20],caption:"PP",readOnly:true});
		this.e_ap = new portalui_saiLabelEdit(this,{bound:[20,19,432,20],caption:"Akun Akumulasi", tag:3, readOnly:true});		
		this.e_bp = new portalui_saiLabelEdit(this,{bound:[20,21,432,20],caption:"Akun Beban",readOnly:true, tag:3});		
		...
		try {
			...
			this.cb_fa.setSQL("select a.no_fa, a.nama from fa_asset a "+
			        ...
			        "                where a.progress ='2' and zz.nilai-a.nilai_residu > isnull(tot_susut,0) and a.kode_lokasi='"+this.app._lokasi+"'",["a.no_fa","a.nama"],false,["No Aktap","Nama"],"and","Daftar Aktiva Tetap",true);
...
window.app_saku3_transaksi_ypt_logistik_fFasusutRevDrk.extend(window.childForm);
window.app_saku3_transaksi_ypt_logistik_fFasusutRevDrk.implement({
	...
	simpan: function(){			
		try{						
			this.e_nb.setText(this.standarLib.noBuktiOtomatis(this.dbLib,"fasusut_m","no_fasusut",this.app._lokasi+"-RRSU"+this.e_periode.getText().substr(2,4)+".","000"));
	...
	doChange:function(sender){
		...
		if (sender == this.cb_fa && this.cb_fa.getText()!="") {
			var strSQL = "select zz.nilai,a.nilai_residu,isnull(d.tot_susut,0) as tot_susut,(zz.nilai-a.nilai_residu-isnull(d.tot_susut,0)) as nilai_buku, "+
						 "  case when (zz.nilai-a.nilai_residu-isnull(d.tot_susut,0)) > a.nilai_susut "+
						 "		 then a.nilai_susut  "+
