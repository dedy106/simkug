window.app_saku3_transaksi_ypt_logistik_fAppPesan = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_ypt_logistik_fAppPesan.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_ypt_logistik_fAppPesan";
		...
		this.e_tglfisik = new saiLabelEdit(this.pc1.childPage[1],{bound:[270,13,200,20],caption:"Tgl Fisik", readOnly:true});
		...
		this.sgUpld = new saiGrid(this.pc1.childPage[6],{bound:[1,5,this.pc1.width-5,this.pc1.height-35],colCount:4, tag:9,
...
window.app_saku3_transaksi_ypt_logistik_fAppPesan.extend(window.childForm);
window.app_saku3_transaksi_ypt_logistik_fAppPesan.implement({	
	...
	doDoubleClick: function(sender, col , row) {
		try{
			if (this.sg.cells(0,row) != "") {			
				...
				var strSQL = "select a.nik_app+' - '+b.nama as tahu,c.no_gambar,a.maksud,a.aspek,a.kode_lokasi,convert(varchar,a.tgl_fisik,103) as tglfisik,a.nik_app "+
							 "from log_pesan_m a "+
