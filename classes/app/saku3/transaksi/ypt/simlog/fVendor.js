window.app_saku3_transaksi_ypt_simlog_fVendor = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_ypt_simlog_fVendor.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_ypt_simlog_fVendor";
...
window.app_saku3_transaksi_ypt_simlog_fVendor.extend(window.childForm);
window.app_saku3_transaksi_ypt_simlog_fVendor.implement({
