window.app_saku3_transaksi_ypt_tak_fTakTerima = function(owner)
{
	if (owner)
	{		
		window.app_saku3_transaksi_ypt_tak_fTakTerima.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_ypt_tak_fTakTerima";
		...
		uses("saiCBBL",true);
		this.pc1 = new pageControl(this,{bound:[10,18,1000,450], childPage:["Daftar Kirim","Penerimaan","Item Jurnal","Data Anggaran","Cari Data"]});		
		...
		this.sgt = new saiGrid(this.pc1.childPage[1],{bound:[1,5,this.pc1.width-5,210],colCount:9,tag:0,
		...
		this.sgv = new saiGrid(this.pc1.childPage[2],{bound:[1,5,this.pc1.width-5,this.pc1.height-35],colCount:9,tag:0,
		            colTitle:["Kode Akun","Nama Akun","DC","Keterangan","Nilai","Kode PP","Nama PP","Kode DRK","Nama DRK"],
					colWidth:[[8,7,6,5,4,3,2,1,0],[150,80,150,80,100,270,50,200,80]],					
...
window.app_saku3_transaksi_ypt_tak_fTakTerima.extend(window.childForm);
window.app_saku3_transaksi_ypt_tak_fTakTerima.implement({	
