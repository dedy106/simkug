window.app_saku3_transaksi_ypt_fa_fFaAkun = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_ypt_fa_fFaAkun.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_ypt_fa_fFaAkun";
...
window.app_saku3_transaksi_ypt_fa_fFaAkun.extend(window.childForm);
window.app_saku3_transaksi_ypt_fa_fFaAkun.implement({
