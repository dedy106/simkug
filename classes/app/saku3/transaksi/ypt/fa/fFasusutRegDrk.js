window.app_saku3_transaksi_ypt_fa_fFasusutRegDrk = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_ypt_fa_fFasusutRegDrk.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_ypt_fa_fFasusutRegDrk";
		...
		this.sg = new saiGrid(this.pc1.childPage[0],{bound:[1,5,this.pc1.width-5,this.pc1.height-30],colCount:8,tag:9,
					...
					colWidth:[[7,6,5,4,3,2,1,0],[100,80,150,80,180,80,180,80]],
...
window.app_saku3_transaksi_ypt_fa_fFasusutRegDrk.extend(window.childForm);
window.app_saku3_transaksi_ypt_fa_fFasusutRegDrk.implement({
