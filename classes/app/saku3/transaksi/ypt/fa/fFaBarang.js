window.app_saku3_transaksi_ypt_fa_fFaBarang = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_ypt_fa_fFaBarang.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_ypt_fa_fFaBarang";
...
window.app_saku3_transaksi_ypt_fa_fFaBarang.extend(window.childForm);
window.app_saku3_transaksi_ypt_fa_fFaBarang.implement({
