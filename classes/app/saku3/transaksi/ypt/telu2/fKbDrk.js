window.app_saku3_transaksi_ypt_telu2_fKbDrk = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_ypt_telu2_fKbDrk.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_ypt_telu2_fKbDrk";
		...
		this.pc1 = new pageControl(this.pc2.childPage[1],{bound:[5,12,990,303], childPage:["Data Item Jurnal","Data Anggaran","Referensi Jurnal"]});
...
window.app_saku3_transaksi_ypt_telu2_fKbDrk.extend(window.childForm);
window.app_saku3_transaksi_ypt_telu2_fKbDrk.implement({	
