window.app_saku3_transaksi_ypt_telu2_fJuDrk = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_ypt_telu2_fJuDrk.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_ypt_telu2_fJuDrk";
...
window.app_saku3_transaksi_ypt_telu2_fJuDrk.extend(window.childForm);
window.app_saku3_transaksi_ypt_telu2_fJuDrk.implement({	
