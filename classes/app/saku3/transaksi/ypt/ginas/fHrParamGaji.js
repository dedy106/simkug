window.app_saku3_transaksi_ypt_ginas_fHrParamGaji = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_ypt_ginas_fHrParamGaji.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_ypt_ginas_fHrParamGaji";
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Data Paramter Gaji Karyawan Per NIK", 0);	
...
window.app_saku3_transaksi_ypt_ginas_fHrParamGaji.extend(window.childForm);
window.app_saku3_transaksi_ypt_ginas_fHrParamGaji.implement({
