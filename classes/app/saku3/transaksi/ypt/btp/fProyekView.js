window.app_saku3_transaksi_ypt_btp_fProyekView = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_ypt_btp_fProyekView.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_ypt_btp_fProyekView";
		...
		this.cb_cons = new portalui_saiCBBL(this,{bound:[20,14,220,20],caption:"Consumer",tag:2,multiSelection:false,change:[this,"doChange"]});
		this.cb_cust = new portalui_saiCBBL(this,{bound:[20,15,220,20],caption:"Customer",tag:2,readOnly:true});
		
		this.pc2 = new pageControl(this,{bound:[10,10,1000,395], childPage:["List Project","Data Project","Filter Cari"]});		
		...
		this.pc1 = new pageControl(this.pc2.childPage[1],{bound:[1,20,996,270], childPage:["Data Proyek","Rincian RAB","File Dokumen","Data Cust"]});
		...
		this.e_jumlah = new saiLabelEdit(this.pc1.childPage[0],{bound:[20,16,200,20],caption:"Jml Jadwal", tag:1, tipeText:ttNilai, text:"0",readOnly:true,visible:false});			
		...
		this.sgr = new saiGrid(this.pc1.childPage[1],{bound:[1,5,this.pc1.width-5,this.pc1.height-35],colCount:4,tag:1,
		...
		this.e_namacust = new saiLabelEdit(this.pc1.childPage[3],{bound:[20,10,500,20],caption:"Nama Customer", tag:9,readOnly:true});				
		this.e_cons = new saiLabelEdit(this.pc1.childPage[3],{bound:[20,20,500,20],caption:"Consumer", tag:9,readOnly:true});	
		this.e_alamat = new saiLabelEdit(this.pc1.childPage[3],{bound:[20,11,500,20],caption:"Alamat", tag:9,readOnly:true});	
		this.e_kota = new saiLabelEdit(this.pc1.childPage[3],{bound:[20,12,500,20],caption:"Kota", tag:9,readOnly:true});	
		this.e_tel = new saiLabelEdit(this.pc1.childPage[3],{bound:[20,13,250,20],caption:"No Telepon", tag:9,readOnly:true});	
		this.e_fax = new saiLabelEdit(this.pc1.childPage[3],{bound:[300,13,220,20],caption:"No Faximile", tag:9,readOnly:true});	
		this.e_npwp = new saiLabelEdit(this.pc1.childPage[3],{bound:[20,15,500,20],caption:"NPWP", tag:9,readOnly:true});	
		this.e_pic = new saiLabelEdit(this.pc1.childPage[3],{bound:[20,16,500,20],caption:"Contact Person", tag:9,readOnly:true});	
		this.e_dep = new saiLabelEdit(this.pc1.childPage[3],{bound:[20,17,500,20],caption:"Departemen", tag:9,readOnly:true});	
		this.e_email = new saiLabelEdit(this.pc1.childPage[3],{bound:[20,18,500,20],caption:"Email", tag:9,readOnly:true});	
		this.e_nohp = new saiLabelEdit(this.pc1.childPage[3],{bound:[20,19,250,20],caption:"Hand Phone", tag:9,readOnly:true});	
		this.e_klp = new saiLabelEdit(this.pc1.childPage[3],{bound:[20,21,500,20],caption:"Grup Cust", tag:9,readOnly:true});	
...
window.app_saku3_transaksi_ypt_btp_fProyekView.extend(window.childForm);
window.app_saku3_transaksi_ypt_btp_fProyekView.implement({	
	...
	doSelectDate: function(sender, y,m,d){
		...
		this.cb_drkp.setSQL("select a.kode_drk, a.nama from drk a where a.tahun='"+this.e_periode.getText().substr(0,4)+"' and a.kode_lokasi='"+this.app._lokasi+"'",["kode_drk","nama"],false,["Kode","Nama"],"and","Data DRK Pendapatan",true);		
		this.cb_drkb.setSQL("select a.kode_drk, a.nama from drk a where a.tahun='"+this.e_periode.getText().substr(0,4)+"' and a.kode_lokasi='"+this.app._lokasi+"'",["kode_drk","nama"],false,["Kode","Nama"],"and","Data DRK Beban",true);																													 				
	...
	doChange: function(sender){
		try{
			if (sender == this.cb_cons && this.cb_cons.getText() != ""){				
				...
				if (this.stsSimpan==1) this.doLoad3();
			}
			
			if (sender == this.cb_kode && this.cb_kode.getText() != ""){
				var strSQL = "select a.*,c.nama as cons, isnull(b.catatan,'-') as catatan "+
							 "from pr_proyek a inner join consumer c on a.kode_cons=c.kode_cons and a.kode_lokasi=c.kode_lokasi "+
							 "left join pr_proyek_app b on a.kode_proyek=b.no_bukti and a.kode_lokasi=b.kode_lokasi and b.no_appseb='-' "+
				...
				if (typeof data == "object"){
					...
					if (line != undefined){			
						...
						var strSQL = "select a.*,b.nama as nama_klp from cust a inner join cust_klp b on a.kode_klpcust=b.kode_klpcust and a.kode_lokasi=b.kode_lokasi "+
						...
						if (typeof data == "object"){
							...
							if (line != undefined){		
								...
								this.e_klp.setText(line.nama_klp);
							}
						}
	...
	doLoad3:function(sender){		
		...
		var strSQL = "select a.kode_proyek,b.nama,a.no_pks,a.nama as keterangan,a.nilai "+
					 ...
					 "where a.kode_cons='"+this.cb_cons.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' and a.progress='0' order by a.kode_proyek desc";		
		var data = this.dbLib.getDataProvider(strSQL,true);
		if (typeof data == "object" && data.rs.rows[0] != undefined){
			this.dataJU3 = data;
