window.app_saku3_transaksi_ypt_btp_fBebanProyekDummyRev = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_ypt_btp_fBebanProyekDummyRev.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_ypt_btp_fBebanProyekDummyRev";
...
window.app_saku3_transaksi_ypt_btp_fBebanProyekDummyRev.extend(window.childForm);
window.app_saku3_transaksi_ypt_btp_fBebanProyekDummyRev.implement({
