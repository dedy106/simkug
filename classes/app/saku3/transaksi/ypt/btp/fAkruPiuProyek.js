window.app_saku3_transaksi_ypt_btp_fAkruPiuProyek = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_ypt_btp_fAkruPiuProyek.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_ypt_btp_fAkruPiuProyek";
...
window.app_saku3_transaksi_ypt_btp_fAkruPiuProyek.extend(window.childForm);
window.app_saku3_transaksi_ypt_btp_fAkruPiuProyek.implement({
