window.app_saku3_transaksi_ypt_btp_fBebanProyek = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_ypt_btp_fBebanProyek.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_ypt_btp_fBebanProyek";
		...
		this.e_saldogar = new saiLabelEdit(this.pc2.childPage[0],{bound:[775,14,200,20],caption:"Saldo Budget", tag:1, tipeText:ttNilai, text:"0", readOnly:true,visible:false});		
		...
		this.e_saldo = new saiLabelEdit(this.pc2.childPage[0],{bound:[775,17,200,20],caption:"Saldo OR", tag:1, tipeText:ttNilai, text:"0", readOnly:true});		
		...
		this.e_nilai = new saiLabelEdit(this.pc2.childPage[0],{bound:[775,18,200,20],caption:"Total Rincian", tag:1, tipeText:ttNilai, text:"0", readOnly:true,change:[this,"doChange"]});		
		...
		this.sg1 = new saiGrid(this.pc2.childPage[0],{bound:[0,5,this.pc2.width-5,182],colCount:5,tag:0,
...
window.app_saku3_transaksi_ypt_btp_fBebanProyek.extend(window.childForm);
window.app_saku3_transaksi_ypt_btp_fBebanProyek.implement({
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					sql.add("insert into trans_m (no_bukti,kode_lokasi,tgl_input,nik_user,periode,modul,form,posted,prog_seb,progress,kode_pp,tanggal,no_dokumen,keterangan,kode_curr,kurs,nilai1,nilai2,nilai3,nik1,nik2,nik3,no_ref1,no_ref2,no_ref3,param1,param2,param3) values "+
							"('"+this.e_nb.getText()+"','"+this.app._lokasi+"',getdate(),'"+this.app._userLog+"','"+this.e_periode.getText()+"','AR','BEBAN','F','-','-','"+this.cb_pp.getText()+"','"+this.dp_d1.getDateString()+"','"+this.cb_proyek.getText()+"','"+this.e_ket.getText()+"','IDR',1,"+
	...
	doLoad3:function(sender){																								
		var strSQL = "select a.no_bukti,convert(varchar,a.tanggal,103) as tgl,a.keterangan,a.nilai1+a.nilai2 as nilai "+
		             "from trans_m a "+
		             "where a.periode='"+this.e_periode.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' and posted='F' and modul ='AR' and form='BEBAN'";	
		var data = this.dbLib.getDataProvider(strSQL,true);
		if (typeof data == "object" && data.rs.rows[0] != undefined){
			this.dataJU3 = data;
			...
			if (this.sg3.cells(0,row) != "") {
				...
				if (typeof data == "object"){
					...
					if (line != undefined){								
						...
						this.cb_proyek.setSQL("select a.kode_proyek,a.nama as keterangan from pr_proyek a where a.kode_proyek='"+line.no_dokumen+"' and a.kode_lokasi='"+this.app._lokasi+"' ",["a.kode_proyek","a.keterangan"],false,["No Bukti","Keterangan"],"and","Data Proyek",true);									  
