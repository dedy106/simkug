window.app_saku3_transaksi_ypt_btp_fKbPjProyek = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_ypt_btp_fKbPjProyek.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_ypt_btp_fKbPjProyek";
...
window.app_saku3_transaksi_ypt_btp_fKbPjProyek.extend(window.childForm);
window.app_saku3_transaksi_ypt_btp_fKbPjProyek.implement({
