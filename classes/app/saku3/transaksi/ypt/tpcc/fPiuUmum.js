window.app_saku3_transaksi_ypt_tpcc_fPiuUmum = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_ypt_tpcc_fPiuUmum.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_ypt_tpcc_fPiuUmum";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Piutang Umum - DRK", 0);	
		...
		this.cb_pp = new saiCBBL(this.pc2.childPage[0],{bound:[20,18,220,20],caption:"PP", multiSelection:false, maxLength:10, tag:2,visible:false});						
		this.c_stsppn = new saiCB(this.pc2.childPage[0],{bound:[780,18,210,20],caption:"Status PPN",items:["PPN","NON"], readOnly:true,tag:9,change:[this,"doChange"]});
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[1,10,995,258], childPage:["Data Item Jurnal","Data Anggaran"]});
...
window.app_saku3_transaksi_ypt_tpcc_fPiuUmum.extend(window.childForm);
window.app_saku3_transaksi_ypt_tpcc_fPiuUmum.implement({
