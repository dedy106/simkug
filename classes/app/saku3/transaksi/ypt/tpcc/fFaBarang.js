window.app_saku3_transaksi_ypt_tpcc_fFaBarang = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_ypt_tpcc_fFaBarang.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_ypt_tpcc_fFaBarang";
...
window.app_saku3_transaksi_ypt_tpcc_fFaBarang.extend(window.childForm);
window.app_saku3_transaksi_ypt_tpcc_fFaBarang.implement({
