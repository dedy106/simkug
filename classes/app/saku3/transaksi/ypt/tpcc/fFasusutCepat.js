window.app_saku3_transaksi_ypt_tpcc_fFasusutCepat = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_ypt_tpcc_fFasusutCepat.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_ypt_tpcc_fFasusutCepat";
		...
		this.cb_fa = new saiCBBL(this,{bound:[20,22,220,20],caption:"No Aktiva Tetap", multiSelection:false, maxLength:20, tag:2, change:[this,"doChange"]});		
		this.cb_drk = new saiCBBL(this,{bound:[20,20,220,20],caption:"DRK Penyusutan", readOnly:true, maxLength:10, tag:1 });
		...
		this.e_pp = new portalui_saiLabelEdit(this,{bound:[460,17,452,20],caption:"PP",readOnly:true});		
		...
		this.e_gar = new saiLabelEdit(this,{bound:[20,27,202,20],caption:"Saldo Budget", tag:3, readOnly: true, tipeText:ttNilai, text:"0"});				
		...
		try {
			...
			this.cb_fa.setSQL("select a.no_fa, a.nama from fa_asset a "+
							  ...
							  "  where a.progress in ('2') and zz.nilai-a.nilai_residu > isnull(tot_susut,0) and a.kode_lokasi='"+this.app._lokasi+"'",
...
window.app_saku3_transaksi_ypt_tpcc_fFasusutCepat.extend(window.childForm);
window.app_saku3_transaksi_ypt_tpcc_fFasusutCepat.implement({
	...
	simpan: function(){			
		try{						
			this.e_nb.setText(this.standarLib.noBuktiOtomatis(this.dbLib,"fasusut_m","no_fasusut",this.app._lokasi+"-CSU"+this.e_periode.getText().substr(2,4)+".","0000"));
