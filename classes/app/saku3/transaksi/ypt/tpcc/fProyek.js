window.app_saku3_transaksi_ypt_tpcc_fProyek = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_ypt_tpcc_fProyek.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_ypt_tpcc_fProyek";
        ...
        this.c_mpyg = new saiCB(this.pc1.childPage[0],{bound:[270,22,200,20],caption:"Penyelenggaraan",items:["ONSITE","ONLINE"], readOnly:true,tag:2});
        ...
        this.c_mbayar = new saiCB(this.pc1.childPage[0],{bound:[270,13,200,20],caption:"Pembayaran",items:["TERMIN","DP","TAHAP"], readOnly:true,tag:2});	
...
window.app_saku3_transaksi_ypt_tpcc_fProyek.extend(window.childForm);
window.app_saku3_transaksi_ypt_tpcc_fProyek.implement({	
			...
			if (sender == this.cb_kode && this.cb_kode.getText() != ""){				
				...
				if (typeof data == "object"){
					...
					if (line != undefined){									
						...
						this.c_mbayar.setText(line.metode_bayar);
						this.c_mpyg.setText(line.metode_penyelenggara);
