window.app_saku3_transaksi_ypt_tpcc_fFasusutRev = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_ypt_tpcc_fFasusutRev.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_ypt_tpcc_fFasusutRev";
		...
		this.cb_fa = new saiCBBL(this,{bound:[20,21,220,20],caption:"No Aktiva Tetap", multiSelection:false, maxLength:10, tag:2, change:[this,"doChange"]});		
		this.cb_drk = new saiCBBL(this,{bound:[20,18,220,20],caption:"DRK Penyusutan", maxLength:10, tag:1,readOnly:true });
...
window.app_saku3_transaksi_ypt_tpcc_fFasusutRev.extend(window.childForm);
window.app_saku3_transaksi_ypt_tpcc_fFasusutRev.implement({
