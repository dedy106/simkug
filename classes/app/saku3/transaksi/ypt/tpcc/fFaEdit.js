window.app_saku3_transaksi_ypt_tpcc_fFaEdit = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_ypt_tpcc_fFaEdit.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_ypt_tpcc_fFaEdit";
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Edit Data Aktap", 0);	
		
		uses("saiCB;saiCBBL;saiEdit;datePicker;saiGrid;sgNavigator;pageControl;checkBox");		
		
		this.cb_fa = new saiCBBL(this,{bound:[20,18,250,20],caption:"Data FA", multiSelection:false, maxLength:10, tag:9,change:[this,"doLoad"]});
		
		this.pc2 = new pageControl(this,{bound:[10,10,1000,430], childPage:["Data Akiva Tetap"]});			
		this.e_periode = new portalui_saiLabelEdit(this.pc2.childPage[0],{bound:[20,12,200,20],caption:"Periode",tag:2,readOnly:true});
		...
		this.cb_pp1 = new saiCBBL(this.pc2.childPage[0],{bound:[20,18,220,20],caption:"PP Aktap", multiSelection:false, maxLength:10, tag:1});
		...
		try {
			...
			this.cb_fa.setSQL("select no_fa, nama from fa_asset where jenis='A' and kode_lokasi='"+this.app._lokasi+"'",["no_fa","nama"],false,["No FA","Nama"],"and","Data FA",true);
...
window.app_saku3_transaksi_ypt_tpcc_fFaEdit.extend(window.childForm);
window.app_saku3_transaksi_ypt_tpcc_fFaEdit.implement({
