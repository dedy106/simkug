window.app_saku3_transaksi_ypt_tpcc_fKbPiu = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_ypt_tpcc_fKbPiu.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_ypt_tpcc_fKbPiu";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form KasBank Piutang Umum", 0);	
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[1,12,995,255], childPage:["Item Jurnal Pelunasan"]});		
		this.sg = new saiGrid(this.pc1.childPage[0],{bound:[1,5,this.pc1.width-5,this.pc1.height-45],colCount:9,tag:0,
...
window.app_saku3_transaksi_ypt_tpcc_fKbPiu.extend(window.childForm);
window.app_saku3_transaksi_ypt_tpcc_fKbPiu.implement({
						...
						for (var i=0;i < this.sg.getRowCount();i++){
							if (this.sg.rowValid(i)){																							
								...
								sql.add("insert into angg_r(no_bukti,modul,kode_lokasi,kode_akun,kode_pp,kode_drk,periode1,periode2,dc,saldo,nilai) values "+
										"('"+this.e_nb.getText()+"','KBPIU','"+this.app._lokasi+"','"+this.sg.cells(0,i)+"','"+this.sg.cells(5,i)+"','"+this.sg.cells(7,i)+"','"+this.e_periode.getText()+"','"+this.e_periode.getText()+"','"+this.sg.cells(2,i)+"',0,"+parseNilai(this.sg.cells(4,i))+")");
							}
						}
					}
	...
	doLoad3:function(sender){																		
		var strSQL = "select a.no_kas,convert(varchar,a.tanggal,103) as tgl,a.jenis,a.no_dokumen,a.keterangan,a.nilai "+
		             "from kas_m a "+
					 "where a.periode='"+this.e_periode.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' and a.modul = 'KBPIU' and a.posted ='F'";						
		var data = this.dbLib.getDataProvider(strSQL,true);
		if (typeof data == "object" && data.rs.rows[0] != undefined){
			this.dataJU3 = data;
			...
			if (this.sg3.cells(0,row) != "") {
				...
				if (typeof data == "object"){
					...
					if (line != undefined){		
						...
						this.cb_piutang.setSQL("select * from piutang_m where no_piutang='"+line.no_link+"' and kode_lokasi='"+this.app._lokasi+"'",["no_piutang","keterangan"],false,["No Bukti","Keterangan"],"and","Data Piutang",true);											
