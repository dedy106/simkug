window.app_saku3_transaksi_ypt_tpcc_fFaAkun = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_ypt_tpcc_fFaAkun.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_ypt_tpcc_fFaAkun";
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Kelompok Akun Aktiva Tetap", 0);	
		...
		this.sg1 = new saiGrid(this.pc1.childPage[0],{bound:[1,5,this.pc1.width-5,this.pc1.height-33],colCount:7,tag:9,
					...
					colWidth:[[6,5,4,3,2,1,0],[200,200,200,80,50,200,80]],
		...
		this.cb_drk = new portalui_saiCBBL(this.pc1.childPage[1],{bound:[20,16,220,20],caption:"DRK", multiSelection:false,tag:1});		
...
window.app_saku3_transaksi_ypt_tpcc_fFaAkun.extend(window.childForm);
window.app_saku3_transaksi_ypt_tpcc_fFaAkun.implement({
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1])){
				try{									
					...
					sql.add("insert into fa_klpakun(kode_klpakun,nama,umur,persen,kode_akun,akun_bp,akun_deprs,kode_agg,tahun,kode_drk,kode_lokasi, flag_susut) values "+
							"('"+this.cb_kode.getText()+"','"+this.e_nama.getText()+"',"+umurBln+","+nilaiToFloat(this.e_persen.getText())+",'"+this.cb_akun.getText()+"','"+this.cb_bp.getText()+"','"+this.cb_deprs.getText()+"','-','"+this.c_tahun.getText()+"','"+this.cb_drk.getText()+"','"+this.app._lokasi+"','"+this.c_status.getText().substr(0,1)+"')");									
					setTipeButton(tbAllFalse);
