window.app_saku3_transaksi_dakem_fDokDakem = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_dakem_fDokDakem.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_dakem_fDokDakem";
...
window.app_saku3_transaksi_dakem_fDokDakem.extend(window.childForm);
window.app_saku3_transaksi_dakem_fDokDakem.implement({	
