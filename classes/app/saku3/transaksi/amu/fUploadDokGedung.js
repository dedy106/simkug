window.app_saku3_transaksi_amu_fUploadDokGedung = function (owner) {
    if (owner) {
        window.app_saku3_transaksi_amu_fUploadDokGedung.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_transaksi_amu_fUploadDokGedung";
        this.maximize();
...
window.app_saku3_transaksi_amu_fUploadDokGedung.extend(window.childForm);
window.app_saku3_transaksi_amu_fUploadDokGedung.implement({
    doLoad: function () {
        try {
            ...
            var nama_report = "server_report_saku3_amu_rptUploadDokGedung";
            this.filter = "";
            this.showFilter = "";
            this.lokasi = "";
