window.app_saku3_transaksi_amu_fUploadKelAsset = function (owner) {
    if (owner) {
        window.app_saku3_transaksi_amu_fUploadKelAsset.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_transaksi_amu_fUploadKelAsset";
        this.maximize();
...
window.app_saku3_transaksi_amu_fUploadKelAsset.extend(window.childForm);
window.app_saku3_transaksi_amu_fUploadKelAsset.implement({
    doLoad: function () {
        try {
            ...
            this.report = new server_report_report();
            var nama_report = "server_report_saku3_amu_rptUploadKelAsset";
            this.filter = "";
            this.showFilter = "";
            this.lokasi = "";
