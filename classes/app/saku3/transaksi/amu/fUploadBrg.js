window.app_saku3_transaksi_amu_fUploadBrg = function (owner) {
    if (owner) {
        window.app_saku3_transaksi_amu_fUploadBrg.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_transaksi_amu_fUploadBrg";
        this.maximize();
...
window.app_saku3_transaksi_amu_fUploadBrg.extend(window.childForm);
window.app_saku3_transaksi_amu_fUploadBrg.implement({
    doLoad: function () {
        try {
            ...
            this.report = new server_report_report();
            var nama_report = "server_report_saku3_amu_rptUploadBrg";
            this.filter = "";
            this.showFilter = "";
            this.lokasi = "";
