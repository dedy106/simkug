window.app_saku3_transaksi_amu_fUploadDokImb = function (owner) {
    if (owner) {
        window.app_saku3_transaksi_amu_fUploadDokImb.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_transaksi_amu_fUploadDokImb";
        this.maximize();
...
window.app_saku3_transaksi_amu_fUploadDokImb.extend(window.childForm);
window.app_saku3_transaksi_amu_fUploadDokImb.implement({
    doLoad: function () {
        try {
            ...
            var nama_report = "server_report_saku3_amu_rptUploadDokImb";
            this.filter = "";
            this.showFilter = "";
            this.lokasi = "";
