window.app_saku3_transaksi_amu_fUploadDok = function (owner) {
    if (owner) {
        window.app_saku3_transaksi_amu_fUploadDok.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_transaksi_amu_fUploadDok";
        this.maximize();
...
window.app_saku3_transaksi_amu_fUploadDok.extend(window.childForm);
window.app_saku3_transaksi_amu_fUploadDok.implement({
    doLoad: function () {
        try {
            ...
            var nama_report = "server_report_saku3_amu_rptUploadDok";
            this.filter = "";
            this.showFilter = "";
            this.lokasi = "";
