window.app_saku3_transaksi_amu_fUploadDokLahan = function (owner) {
    if (owner) {
        window.app_saku3_transaksi_amu_fUploadDokLahan.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_transaksi_amu_fUploadDokLahan";
        this.maximize();
...
window.app_saku3_transaksi_amu_fUploadDokLahan.extend(window.childForm);
window.app_saku3_transaksi_amu_fUploadDokLahan.implement({
    doLoad: function () {
        try {
            ...
            var nama_report = "server_report_saku3_amu_rptUploadDokLahan";
            this.filter = "";
            this.showFilter = "";
            this.lokasi = "";
