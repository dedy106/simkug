window.app_saku3_transaksi_amu_fUploadDokPbb = function (owner) {
    if (owner) {
        window.app_saku3_transaksi_amu_fUploadDokPbb.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_transaksi_amu_fUploadDokPbb";
        this.maximize();
...
window.app_saku3_transaksi_amu_fUploadDokPbb.extend(window.childForm);
window.app_saku3_transaksi_amu_fUploadDokPbb.implement({
    doLoad: function () {
        try {
            ...
            var nama_report = "server_report_saku3_amu_rptUploadDokPbb";
            this.filter = "";
            this.showFilter = "";
            this.lokasi = "";
