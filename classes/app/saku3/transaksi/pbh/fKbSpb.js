window.app_saku3_transaksi_pbh_fKbSpb = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_pbh_fKbSpb.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_pbh_fKbSpb";
...
window.app_saku3_transaksi_pbh_fKbSpb.extend(window.childForm);
window.app_saku3_transaksi_pbh_fKbSpb.implement({	
