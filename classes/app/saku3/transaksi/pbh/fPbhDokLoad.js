window.app_saku3_transaksi_pbh_fPbhDokLoad = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_pbh_fPbhDokLoad.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_pbh_fPbhDokLoad";
...
window.app_saku3_transaksi_pbh_fPbhDokLoad.extend(window.childForm);
window.app_saku3_transaksi_pbh_fPbhDokLoad.implement({
