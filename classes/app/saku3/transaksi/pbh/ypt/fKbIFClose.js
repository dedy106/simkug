window.app_saku3_transaksi_pbh_ypt_fKbIFClose = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_pbh_ypt_fKbIFClose.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_pbh_ypt_fKbIFClose";
...
window.app_saku3_transaksi_pbh_ypt_fKbIFClose.extend(window.childForm);
window.app_saku3_transaksi_pbh_ypt_fKbIFClose.implement({	
	isiCBReim: function() {
		...
		try {										
			...
			if (sender == this.cb_reim && this.cb_reim.getText()!="") {
				...
				var data = this.dbLib.getDataProvider(
							...
							"where a.jenis in ('BEBAN','PAJAK') and a.no_hutang = '"+this.cb_reim.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' order by a.no_urut",true);
