window.app_saku3_transaksi_pbh_ypt_fKbIFCair = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_pbh_ypt_fKbIFCair.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_pbh_ypt_fKbIFCair";
...
window.app_saku3_transaksi_pbh_ypt_fKbIFCair.extend(window.childForm);
window.app_saku3_transaksi_pbh_ypt_fKbIFCair.implement({	
	...
	doModalResult: function(event, modalResult){
		...
		switch (event){
			...
			case "ubah" :					
				...
				var strSQL = "select no_kas from if_nik where kode_lokasi='"+this.app._lokasi+"' and no_flag='-' and nik = '"+this.cb_nik.getText()+"'";										
