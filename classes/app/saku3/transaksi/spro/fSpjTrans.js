window.app_saku3_transaksi_spro_fSpjTrans = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_spro_fSpjTrans.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spro_fSpjTrans";
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Data Tarif Transport SPPD", 0);	
...
window.app_saku3_transaksi_spro_fSpjTrans.extend(window.childForm);
window.app_saku3_transaksi_spro_fSpjTrans.implement({
