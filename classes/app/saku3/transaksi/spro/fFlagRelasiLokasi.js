window.app_saku3_transaksi_spro_fFlagRelasiLokasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_spro_fFlagRelasiLokasi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spro_fFlagRelasiLokasi";
...
window.app_saku3_transaksi_spro_fFlagRelasiLokasi.extend(window.childForm);
window.app_saku3_transaksi_spro_fFlagRelasiLokasi.implement({
