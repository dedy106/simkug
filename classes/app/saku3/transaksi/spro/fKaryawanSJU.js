window.app_saku3_transaksi_spro_fKaryawanSJU = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_spro_fKaryawanSJU.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spro_fKaryawanSJU";
...
window.app_saku3_transaksi_spro_fKaryawanSJU.extend(window.childForm);
window.app_saku3_transaksi_spro_fKaryawanSJU.implement({
