window.app_saku3_transaksi_spro_fFlagRelasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_spro_fFlagRelasi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spro_fFlagRelasi";
...
window.app_saku3_transaksi_spro_fFlagRelasi.extend(window.childForm);
window.app_saku3_transaksi_spro_fFlagRelasi.implement({
