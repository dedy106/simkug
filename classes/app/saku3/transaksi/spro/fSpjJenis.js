window.app_saku3_transaksi_spro_fSpjJenis = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_spro_fSpjJenis.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spro_fSpjJenis";
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Data Jenis Parameter SPPD", 0);	
...
window.app_saku3_transaksi_spro_fSpjJenis.extend(window.childForm);
window.app_saku3_transaksi_spro_fSpjJenis.implement({
