window.app_saku3_transaksi_spro_fCustSpm = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_spro_fCustSpm.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spro_fCustSpm";
...
window.app_saku3_transaksi_spro_fCustSpm.extend(window.childForm);
window.app_saku3_transaksi_spro_fCustSpm.implement({
		...
		try{						
			if (this.standarLib.checkEmptyByTag(this, [0,1])){
				try{									
					...
					sql.add("insert into cust(kode_cust,kode_lokasi,nama,alamat,kota,no_tel,no_fax,npwp,pic,departemen,email,no_hp,no_fax2,alamat2) values "+
