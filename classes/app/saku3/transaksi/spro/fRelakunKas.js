window.app_saku3_transaksi_spro_fRelakunKas = function(owner,lokasi)
{
	if (owner)
	{
		window.app_saku3_transaksi_spro_fRelakunKas.prototype.parent.constructor.call(this, owner);
		window.app_saku3_transaksi_spro_fRelakunKas.prototype.parent.setWidth.call(this, 800);
		window.app_saku3_transaksi_spro_fRelakunKas.prototype.parent.setHeight.call(this, 400);
		
		this.centerize();
		
		this.className = "app_saku3_transaksi_spro_fRelakunKas";
...
window.app_saku3_transaksi_spro_fRelakunKas.extend(window.commonForm);
window.app_saku3_transaksi_spro_fRelakunKas.implement({
	...
	setWidth: function(data){
		window.app_saku3_transaksi_spro_fRelakunKas.prototype.parent.setWidth.call(this, data);
		this.header.style.width = data - 23;
		this.rBg.style.left = data - 23;
	},
	doSysMouseMove: function(x, y, button, buttonState){
		window.app_saku3_transaksi_spro_fRelakunKas.prototype.parent.doSysMouseMove.call(this,x, y, button, buttonState);
		if (this.isClick)
		{		
