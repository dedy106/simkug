window.app_saku3_transaksi_spro_fRefPdpt2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_spro_fRefPdpt2.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spro_fRefPdpt2";
...
window.app_saku3_transaksi_spro_fRefPdpt2.extend(window.childForm);
window.app_saku3_transaksi_spro_fRefPdpt2.implement({
