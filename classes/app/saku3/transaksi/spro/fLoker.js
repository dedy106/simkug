window.app_saku3_transaksi_spro_fLoker = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_spro_fLoker.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spro_fLoker";
		...
		this.sg1 = new saiGrid(this.pc1.childPage[0],{bound:[1,5,this.pc1.width-5,this.pc1.height-30],colCount:5,tag:9,
		            colTitle:["Loker","Nama","Customer","Jenis","Lokasi"],
					colWidth:[[4,3,2,1,0],[200,200,200,200,80]],
					readOnly:true,
		...
		this.e_jenis = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,11,300,20],caption:"Jenis", tag:2, readOnly:true});	
		this.e_lokasi = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,12,300,20],caption:"Lokasi", tag:2, readOnly:true});	
...
window.app_saku3_transaksi_spro_fLoker.extend(window.childForm);
window.app_saku3_transaksi_spro_fLoker.implement({
	...
	doCari:function(sender){								
		try {
			...
			var strSQL = "select a.loker,a.nama,a.kode_cust+' - '+b.nama as cust,b.jenis,b.kode_lokasi "+
						 "from yk_loker a "+
						 "     inner join cust b on a.kode_cust = b.kode_cust "+filter+
						 "order by a.loker";							
			var data = this.dbLib.getDataProvider(strSQL,true);		
