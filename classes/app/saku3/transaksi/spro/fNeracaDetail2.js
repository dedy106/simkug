window.app_saku3_transaksi_spro_fNeracaDetail2 = function(owner,modul)
{
	if (owner)
	{
		window.app_saku3_transaksi_spro_fNeracaDetail2.prototype.parent.constructor.call(this, owner);
		window.app_saku3_transaksi_spro_fNeracaDetail2.prototype.parent.setWidth.call(this, 300);
		window.app_saku3_transaksi_spro_fNeracaDetail2.prototype.parent.setHeight.call(this, 400);
		
		this.centerize();
		
		this.className = "app_saku3_transaksi_spro_fNeracaDetail2";
...
window.app_saku3_transaksi_spro_fNeracaDetail2.extend(window.commonForm);
window.app_saku3_transaksi_spro_fNeracaDetail2.implement({
	...
	doSysMouseDown: function(x, y, button, buttonState){	
		window.app_saku3_transaksi_spro_fNeracaDetail2.prototype.parent.doSysMouseDown.call(this,x, y, button, buttonState);
	},
	doSysMouseUp: function(x, y, button, buttonState){	
		window.app_saku3_transaksi_spro_fNeracaDetail2.prototype.parent.doSysMouseUp.call(this,x, y, button, buttonState);
	},
	doSysMouseMove: function(x, y, button, buttonState){
		window.app_saku3_transaksi_spro_fNeracaDetail2.prototype.parent.doSysMouseMove.call(this,x, y, button, buttonState);
		if (this.isClick)
		{		
