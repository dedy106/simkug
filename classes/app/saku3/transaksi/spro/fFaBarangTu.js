window.app_saku3_transaksi_spro_fFaBarangTu = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_spro_fFaBarangTu.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spro_fFaBarangTu";
...
window.app_saku3_transaksi_spro_fFaBarangTu.extend(window.childForm);
window.app_saku3_transaksi_spro_fFaBarangTu.implement({
