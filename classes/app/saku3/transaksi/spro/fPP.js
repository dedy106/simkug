window.app_saku3_transaksi_spro_fPP = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_spro_fPP.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spro_fPP";
...
window.app_saku3_transaksi_spro_fPP.extend(window.childForm);
window.app_saku3_transaksi_spro_fPP.implement({
