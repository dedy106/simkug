window.app_saku3_transaksi_spro_fKaryawan = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_spro_fKaryawan.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spro_fKaryawan";
...
window.app_saku3_transaksi_spro_fKaryawan.extend(window.childForm);
window.app_saku3_transaksi_spro_fKaryawan.implement({
