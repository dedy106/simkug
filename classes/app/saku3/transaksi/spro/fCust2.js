window.app_saku3_transaksi_spro_fCust2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_spro_fCust2.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spro_fCust2";
...
window.app_saku3_transaksi_spro_fCust2.extend(window.childForm);
window.app_saku3_transaksi_spro_fCust2.implement({
