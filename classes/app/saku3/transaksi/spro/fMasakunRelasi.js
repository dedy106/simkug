window.app_saku3_transaksi_spro_fMasakunRelasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_spro_fMasakunRelasi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spro_fMasakunRelasi";
		...
		this.c_modul = new saiCB(this.pc1.childPage[1],{bound:[20,12,200,20],caption:"Modul",items:["AKTIVA","PASIVA","LABARUGI"], readOnly:true,tag:2,change:[this,"doChange"]});
		this.c_jenis = new saiCB(this.pc1.childPage[1],{bound:[20,13,200,20],caption:"Jenis",readOnly:true,tag:2,change:[this,"doChange"]});
...
window.app_saku3_transaksi_spro_fMasakunRelasi.extend(window.childForm);
window.app_saku3_transaksi_spro_fMasakunRelasi.implement({
	...
	doChange: function(sender){
		try{
			if (sender == this.c_modul && this.c_modul.getText() != "")	{
				if (this.c_modul.getText() == "AKTIVA" || this.c_modul.getText() == "PASIVA") {
					this.c_jenis.items.clear();
					this.c_jenis.addItem(0,"Neraca");					
					this.c_jenis.setText("Neraca");			
				}
				else {
					this.c_jenis.items.clear();
					this.c_jenis.addItem(0,"Beban");					
					this.c_jenis.addItem(1,"Pendapatan");					
