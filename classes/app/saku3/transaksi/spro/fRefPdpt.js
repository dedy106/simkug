window.app_saku3_transaksi_spro_fRefPdpt = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_spro_fRefPdpt.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spro_fRefPdpt";
...
window.app_saku3_transaksi_spro_fRefPdpt.extend(window.childForm);
window.app_saku3_transaksi_spro_fRefPdpt.implement({
