window.app_saku3_transaksi_spro_fNeracaLokasiDetail = function(owner,modul)
{
	if (owner)
	{
		window.app_saku3_transaksi_spro_fNeracaLokasiDetail.prototype.parent.constructor.call(this, owner);
		window.app_saku3_transaksi_spro_fNeracaLokasiDetail.prototype.parent.setWidth.call(this, 300);
		window.app_saku3_transaksi_spro_fNeracaLokasiDetail.prototype.parent.setHeight.call(this, 400);
		
		this.centerize();
		
		this.className = "app_saku3_transaksi_spro_fNeracaLokasiDetail";
...
window.app_saku3_transaksi_spro_fNeracaLokasiDetail.extend(window.commonForm);
window.app_saku3_transaksi_spro_fNeracaLokasiDetail.implement({
	...
	doSysMouseDown: function(x, y, button, buttonState){	
		window.app_saku3_transaksi_spro_fNeracaLokasiDetail.prototype.parent.doSysMouseDown.call(this,x, y, button, buttonState);
	},
	doSysMouseUp: function(x, y, button, buttonState){	
		window.app_saku3_transaksi_spro_fNeracaLokasiDetail.prototype.parent.doSysMouseUp.call(this,x, y, button, buttonState);
	},
	doSysMouseMove: function(x, y, button, buttonState){
		window.app_saku3_transaksi_spro_fNeracaLokasiDetail.prototype.parent.doSysMouseMove.call(this,x, y, button, buttonState);
		if (this.isClick)
		{		
