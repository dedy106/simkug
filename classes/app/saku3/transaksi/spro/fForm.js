...
//* 			SAI, PT											
//***********************************************************************************************
window.app_saku3_transaksi_spro_fForm = function(owner){
	if (owner){
		try
		{			
			window.app_saku3_transaksi_spro_fForm.prototype.parent.constructor.call(this,owner);
			this.className  = "app_saku3_transaksi_spro_fForm";					
...
window.app_saku3_transaksi_spro_fForm.extend(window.portalui_childForm);
//------------------------------------------------------------------ event
window.app_saku3_transaksi_spro_fForm.implement({
