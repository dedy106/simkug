window.app_saku3_transaksi_spro_fFaAkunTu = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_spro_fFaAkunTu.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spro_fFaAkunTu";
...
window.app_saku3_transaksi_spro_fFaAkunTu.extend(window.childForm);
window.app_saku3_transaksi_spro_fFaAkunTu.implement({
