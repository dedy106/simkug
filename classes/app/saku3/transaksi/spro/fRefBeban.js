window.app_saku3_transaksi_spro_fRefBeban = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_spro_fRefBeban.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spro_fRefBeban";
...
window.app_saku3_transaksi_spro_fRefBeban.extend(window.childForm);
window.app_saku3_transaksi_spro_fRefBeban.implement({
