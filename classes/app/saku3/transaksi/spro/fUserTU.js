window.app_saku3_transaksi_spro_fUserTU = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_spro_fUserTU.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spro_fUserTU";
...
window.app_saku3_transaksi_spro_fUserTU.extend(window.childForm);
window.app_saku3_transaksi_spro_fUserTU.implement({
