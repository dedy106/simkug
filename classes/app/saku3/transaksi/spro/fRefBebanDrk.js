window.app_saku3_transaksi_spro_fRefBebanDrk = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_spro_fRefBebanDrk.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spro_fRefBebanDrk";
...
window.app_saku3_transaksi_spro_fRefBebanDrk.extend(window.childForm);
window.app_saku3_transaksi_spro_fRefBebanDrk.implement({
	...
	doChange: function(sender){
		try{
			if (sender == this.cb_kode && this.cb_kode.getText() != ""){
				var strSQL = "select * from refju_m where kode_ref ='"+this.cb_kode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' and jenis='BEBAN' ";						   
