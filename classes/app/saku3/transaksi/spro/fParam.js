window.app_saku3_transaksi_spro_fParam = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_spro_fParam.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spro_fParam";
...
window.app_saku3_transaksi_spro_fParam.extend(window.childForm);
window.app_saku3_transaksi_spro_fParam.implement({
