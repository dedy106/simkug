window.app_saku3_transaksi_ukm_fKbKeluarUkm = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_ukm_fKbKeluarUkm.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_ukm_fKbKeluarUkm";
...
window.app_saku3_transaksi_ukm_fKbKeluarUkm.extend(window.childForm);
window.app_saku3_transaksi_ukm_fKbKeluarUkm.implement({	
