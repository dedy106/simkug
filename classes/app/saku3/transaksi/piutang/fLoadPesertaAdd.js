window.app_saku3_transaksi_piutang_fLoadPesertaAdd = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_piutang_fLoadPesertaAdd.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku3_transaksi_piutang_fLoadPesertaAdd";
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Load Data Peserta Tambahan (Load)", 0);	
...
window.app_saku3_transaksi_piutang_fLoadPesertaAdd.extend(window.portalui_childForm);
window.app_saku3_transaksi_piutang_fLoadPesertaAdd.implement({
