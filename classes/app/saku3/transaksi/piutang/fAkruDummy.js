window.app_saku3_transaksi_piutang_fAkruDummy = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_piutang_fAkruDummy.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_piutang_fAkruDummy";
...
window.app_saku3_transaksi_piutang_fAkruDummy.extend(window.childForm);
window.app_saku3_transaksi_piutang_fAkruDummy.implement({
