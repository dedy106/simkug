window.app_saku3_transaksi_piutang_fAkruKunj = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_piutang_fAkruKunj.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_piutang_fAkruKunj";
...
window.app_saku3_transaksi_piutang_fAkruKunj.extend(window.childForm);
window.app_saku3_transaksi_piutang_fAkruKunj.implement({
...
/*			
			//KUNJUNGAN dan CS
			var strSQL ="select 'PIU KUNJ '+c.nama as ket,(case b.jenis when 'PEGAWAI' then c.akun_pku else c.akun_pap end) as kode_akun,d.nama as nama_akun,'"+dcPiu+"' as dc, "+
						...
						"abs(sum(a.umum+a.gigi+a.kbia)) as nilai,'PDPTKUNJUM' as jenis, c.drk_kunj as kode_drk,e.nama as nama_drk "+
						"from yk_billkunj_d a "+
						"          inner join yk_loker bb on a.loker=bb.loker "+
						"          inner join cust b on bb.kode_cust=b.kode_cust "+
						"		   inner join yk_kunj c on a.kode_produk=c.kode_produk "+
						...
						"select 'PDPT KUNJ '+c.nama as ket,c.akun_ob as kode_akun,d.nama as nama_akun,'"+dcPdpt+"' as dc, "+
						"abs(sum(a.matkes)) as nilai,'PDPTKUNJUM' as jenis, c.drk_kunj as kode_drk,e.nama as nama_drk "+
						"from yk_billkunj_d a "+
						"          inner join yk_loker bb on a.loker=bb.loker "+
						"          inner join cust b on bb.kode_cust=b.kode_cust "+
						"		   inner join yk_kunj c on a.kode_produk=c.kode_produk "+
						...
						//CS						
						"select 'TTP CS '+d.nama as ket,c.akun_hutcs as kode_akun,d.nama as nama_akun,'"+dcPiu+"' as dc, "+
						...
						"union all "+						
						"select 'PIU CS '+d.nama as ket,c.akun_piucs as kode_akun,d.nama as nama_akun,'"+dcPdpt+"' as dc, "+
