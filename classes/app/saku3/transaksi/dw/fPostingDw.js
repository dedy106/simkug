window.app_saku3_transaksi_dw_fPostingDw = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_dw_fPostingDw.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_dw_fPostingDw";
...
window.app_saku3_transaksi_dw_fPostingDw.extend(window.childForm);
window.app_saku3_transaksi_dw_fPostingDw.implement({
		...
		try{						
			if (this.standarLib.checkEmptyByTag(this, [0,1])){
				try{									
					...
					sql.add("exec sp_exs_proses '"+this.app._lokasi+"','"+this.e_periode.getText()+"','"+this.cb_fs.getText()+"'");
