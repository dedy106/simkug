window.app_saku3_transaksi_dw_fPostingGar = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_dw_fPostingGar.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_dw_fPostingGar";
...
window.app_saku3_transaksi_dw_fPostingGar.extend(window.childForm);
window.app_saku3_transaksi_dw_fPostingGar.implement({
	...
	doClick:function(sender){
		if (sender == this.i_gen) {
			this.e_nb.setText(this.standarLib.noBuktiOtomatis(this.dbLib,"exs_posting_m","no_post",this.app._lokasi+"-GAR"+this.e_periode.getText().substr(2,4)+".","000"));
