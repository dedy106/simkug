window.app_saku3_transaksi_dw_fPostingAka = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_dw_fPostingAka.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_dw_fPostingAka";
...
window.app_saku3_transaksi_dw_fPostingAka.extend(window.childForm);
window.app_saku3_transaksi_dw_fPostingAka.implement({
		...
		try{						
			if (this.standarLib.checkEmptyByTag(this, [0,1])){
				try{									
					...
					sql.add("exec sp_exs_aka_lap '"+this.app._lokasi+"','"+this.c_periode.getText()+"'");
