window.app_saku3_transaksi_fitnes_fKunjMedis = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_fitnes_fKunjMedis.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_fitnes_fKunjMedis";
...
window.app_saku3_transaksi_fitnes_fKunjMedis.extend(window.childForm);
window.app_saku3_transaksi_fitnes_fKunjMedis.implement({	
	doClearSg : function() {
		if (this.stsSimpan == 1) {
			this.sg1.clear();
