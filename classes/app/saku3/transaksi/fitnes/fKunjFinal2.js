window.app_saku3_transaksi_fitnes_fKunjFinal2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_fitnes_fKunjFinal2.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_fitnes_fKunjFinal2";
...
window.app_saku3_transaksi_fitnes_fKunjFinal2.extend(window.childForm);
window.app_saku3_transaksi_fitnes_fKunjFinal2.implement({	
