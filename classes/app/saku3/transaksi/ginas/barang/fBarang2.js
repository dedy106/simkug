window.app_saku3_transaksi_ginas_barang_fBarang2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_ginas_barang_fBarang2.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_ginas_barang_fBarang2";
		...
		this.sg1 = new saiGrid(this.pc1.childPage[0],{bound:[1,11,this.pc1.width-5,this.pc1.height-68],colCount:6,tag:9,
		...
		this.e_bar = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,12,300,20],caption:"Barcode", maxLength:50, tag:8});			
...
window.app_saku3_transaksi_ginas_barang_fBarang2.extend(window.childForm);
window.app_saku3_transaksi_ginas_barang_fBarang2.implement({
	...
	doModalResult: function(event, modalResult){
		...
		switch (event){
			case "clear" :
				...
				break;
			case "simpan" :	
				var strSQL = "select kode_barang from brg_barang where barcode ='"+this.e_bar.getText()+"' and kode_lokasi='"+this.app._lokasi+"'";						   
				var data = this.dbLib.getDataProvider(strSQL,true);
				if (typeof data == "object"){
					var line = data.rs.rows[0];							
					if (line != undefined){						
						system.alert(this,"Barcode Barang Duplikasi.","Duplikasi dengan Kode  ["+line.kode_barang+"]");
						return false;
					}					
				}
			...
			if (this.cb_kode.getText() != ""){
				...
				if (typeof data == "object"){
					...
					if (line != undefined){						
						...
						this.e_bar.setText(line.barcode);		
