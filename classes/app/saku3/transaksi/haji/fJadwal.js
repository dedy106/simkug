window.app_saku3_transaksi_haji_fJadwal = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_haji_fJadwal.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_haji_fJadwal";
		...
		this.sg3 = new saiGrid(this.pc2.childPage[0],{bound:[1,5,this.pc2.width-5,this.pc2.height-30],colCount:10,tag:9,
		            colTitle:["No Jadwal","Deskripsi","Tanggal","Kelas","Produk","Lama Hari","Quota","Currency","Harga","Diskon"],
					colWidth:[[9,8,7,6,5,4,3,2,1,0],[80,80,60,60,60,150,150,80,250,100]], 
					readOnly:true,
					colFormat:[[5,6,8,9],[cfNilai,cfNilai,cfNilai,cfNilai]],
					dblClick:[this,"doDoubleClick3"],autoAppend:false,defaultRow:1});		
		this.sgn3 = new portalui_sgNavigator(this.pc2.childPage[0],{bound:[1,this.pc2.height-25,this.pc2.width-1,25],buttonStyle:3,grid:this.sg3,pager:[this,"doPager3"]});
		
		this.e_nb = new portalui_saiLabelEdit(this.pc2.childPage[1],{bound:[20,12,200,20],caption:"No Jadwal",maxLength:30,readOnly:true});
		...
		this.e_ket = new portalui_saiLabelEdit(this.pc2.childPage[1],{bound:[20,13,400,20],caption:"Deskripsi", maxLength:50});				
		this.cb_kelas = new portalui_saiCBBL(this.pc2.childPage[1],{bound:[20,14,220,20],caption:"Kelas Produk",multiSelection:false,tag:2,change:[this,"doChange"]});
		this.e_produk = new portalui_saiLabelEdit(this.pc2.childPage[1],{bound:[20,15,400,20],caption:"Produk", readOnly:true,tag:2});				
		this.e_quota = new saiLabelEdit(this.pc2.childPage[1],{bound:[20,16,200,20],caption:"Quota", tag:1, tipeText:ttNilai, text:"0"});		
		this.e_lama = new saiLabelEdit(this.pc2.childPage[1],{bound:[20,17,200,20],caption:"Lama Hari", tag:1, tipeText:ttNilai, text:"0"});		
		this.c_curr = new saiCB(this.pc2.childPage[1],{bound:[20,18,200,20],caption:"Currency",readOnly:true,tag:2});
		this.e_harga = new saiLabelEdit(this.pc2.childPage[1],{bound:[20,19,200,20],caption:"Harga", tag:1, tipeText:ttNilai, text:"0",change:[this,"doChange"]});		
		this.e_diskon = new saiLabelEdit(this.pc2.childPage[1],{bound:[20,20,200,20],caption:"Diskon", tag:1, tipeText:ttNilai, text:"0",change:[this,"doChange"]});		
		this.e_neto = new saiLabelEdit(this.pc2.childPage[1],{bound:[20,21,200,20],caption:"Harga Net", tag:1, readOnly:true, tipeText:ttNilai, text:"0"});		
		this.e_fee = new saiLabelEdit(this.pc2.childPage[1],{bound:[20,23,200,20],caption:"Fee Marketing IDR", tag:1, tipeText:ttNilai, text:"0"});		
...
window.app_saku3_transaksi_haji_fJadwal.extend(window.portalui_childForm);
window.app_saku3_transaksi_haji_fJadwal.implement({
	...
	doClick:function(sender){
		try {
			if (this.e_tahun.getText()!= "") {
				...
				this.stsSimpan = 1;
				this.e_nb.setText(this.standarLib.noBuktiOtomatis(this.dbLib,"haj_jadwal","no_jadwal",this.app._lokasi+"-JD"+this.e_tahun.getText()+".","0000"));								
				this.e_ket.setFocus();
