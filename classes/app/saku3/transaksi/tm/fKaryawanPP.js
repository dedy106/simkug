window.app_saku3_transaksi_tm_fKaryawanPP = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tm_fKaryawanPP.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tm_fKaryawanPP";		
...
window.app_saku3_transaksi_tm_fKaryawanPP.extend(window.childForm);
window.app_saku3_transaksi_tm_fKaryawanPP.implement({
