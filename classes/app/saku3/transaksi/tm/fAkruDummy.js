window.app_saku3_transaksi_tm_fAkruDummy = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tm_fAkruDummy.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tm_fAkruDummy";
...
window.app_saku3_transaksi_tm_fAkruDummy.extend(window.childForm);
window.app_saku3_transaksi_tm_fAkruDummy.implement({
	...
	doJurnal:function(sender){		
		try {
			...
			var strSQL = "select d.nama as ket,"+
						...
						"  			inner join vendor xx on a.kode_vendor=xx.kode_vendor and xx.flag <> '0' "+												
