window.app_saku3_transaksi_tm_fJuBayarPiuTM = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tm_fJuBayarPiuTM.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tm_fJuBayarPiuTM";
...
window.app_saku3_transaksi_tm_fJuBayarPiuTM.extend(window.childForm);
window.app_saku3_transaksi_tm_fJuBayarPiuTM.implement({
	doLoadRev: function() {
