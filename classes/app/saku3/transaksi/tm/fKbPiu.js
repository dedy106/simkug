window.app_saku3_transaksi_tm_fKbPiu = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tm_fKbPiu.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tm_fKbPiu";
...
window.app_saku3_transaksi_tm_fKbPiu.extend(window.childForm);
window.app_saku3_transaksi_tm_fKbPiu.implement({
