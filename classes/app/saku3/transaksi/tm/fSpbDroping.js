window.app_saku3_transaksi_tm_fSpbDroping = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tm_fSpbDroping.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tm_fSpbDroping";
...
window.app_saku3_transaksi_tm_fSpbDroping.extend(window.childForm);
window.app_saku3_transaksi_tm_fSpbDroping.implement({	
