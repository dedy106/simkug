window.app_saku3_transaksi_tm_fPO = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tm_fPO.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tm_fPO";
		...
		this.pc2 = new pageControl(this,{bound:[10,10,1000,450], childPage:["Data PO","List PO"]});		
		...
		this.cb_cust = new saiCBBL(this.pc2.childPage[0],{bound:[20,16,220,20],caption:"Customer", multiSelection:false, maxLength:10, tag:2});						
...
window.app_saku3_transaksi_tm_fPO.extend(window.childForm);
window.app_saku3_transaksi_tm_fPO.implement({
