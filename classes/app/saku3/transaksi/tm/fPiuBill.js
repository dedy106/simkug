window.app_saku3_transaksi_tm_fPiuBill = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tm_fPiuBill.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tm_fPiuBill";
		...
		this.cb_akun = new saiCBBL(this.pc2.childPage[0],{bound:[20,13,220,20],caption:"Akun Piutang", readOnly:true,visible:false});								
		this.cb_bill = new saiCBBL(this.pc2.childPage[0],{bound:[20,13,220,20],caption:"No Bill", multiSelection:false, maxLength:10, tag:2,change:[this,"doChange"]});								
		this.e_nilai = new saiLabelEdit(this.pc2.childPage[0],{bound:[780,13,210,20],caption:"Nilai", tag:1, readOnly:true, tipeText:ttNilai, text:"0"});								
		...
		this.e_ppn = new saiLabelEdit(this.pc2.childPage[0],{bound:[780,15,210,20],caption:"PPN", tag:1, tipeText:ttNilai, text:"0", readOnly:true});		
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[1,10,995,255], childPage:["Data Item Jurnal","Data Anggaran"]});
		this.sg = new saiGrid(this.pc1.childPage[0],{bound:[1,5,this.pc1.width-5,this.pc1.height-30],colCount:9,tag:0,
					...
					colWidth:[[8,7,6,5,4,3,2,1,0],[130,50,100,50,100,250,40,150,80]],					
...
window.app_saku3_transaksi_tm_fPiuBill.extend(window.childForm);
window.app_saku3_transaksi_tm_fPiuBill.implement({
	...
	doChange:function(sender){
		...
		if (sender == this.cb_bill && this.cb_bill.getText() != "") {
			var strSQL = "select a.kode_pp,a.nilai,a.kode_cust,c.akun_piutang,c.akun_pdpt,c.kode_drk "+						 
						 "from bill_m a inner join kontrak_m b on a.no_kontrak=b.no_kontrak and a.kode_lokasi=b.kode_lokasi "+
						 "              inner join bill_produk c on b.kode_produk=c.kode_produk and c.kode_lokasi=b.kode_lokasi "+
			...
			if (typeof data == "object"){
				...
				if (line != undefined){		
					...
					var strSQL = "select a.nu,a.item,a.harga*a.jumlah as total,a.kode_akun,a.kode_drk,b.nama as nama_akun,c.nama as nama_drk,e.kode_pp,e.nama as nama_pp "+
								 ...
								 "where a.no_bill='"+this.cb_bill.getText()+"' and a.kode_lokasi = '"+this.app._lokasi+"' order by a.nu";						
					var data = this.dbLib.getDataProvider(strSQL,true);
					if (typeof data == "object" && data.rs.rows[0] != undefined){
						var line;
						this.sg.clear();
						for (var i in data.rs.rows){
							line = data.rs.rows[i];							
							this.sg.appendData([line.kode_akun,line.nama_akun,"C",line.item,floatToNilai(line.total),line.kode_pp,line.nama_pp,line.kode_drk,line.nama_drk]);
						}
	...
	doDoubleClick3: function(sender, col , row) {
		try{
			if (this.sg3.cells(0,row) != "") {
				...
				var strSQL = "select d.no_bill,a.tanggal,a.periode,a.no_dokumen,a.keterangan,a.kode_pp,a.akun_piutang,a.nik_app,a.kode_cust,c.nama as nama_cust,a.nilai_ppn "+						 
