window.app_saku3_transaksi_tm_fBank = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tm_fBank.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tm_fBank";
...
window.app_saku3_transaksi_tm_fBank.extend(window.childForm);
window.app_saku3_transaksi_tm_fBank.implement({
