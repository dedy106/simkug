window.app_saku3_transaksi_tm_fCustTM = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tm_fCustTM.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tm_fCustTM";
...
window.app_saku3_transaksi_tm_fCustTM.extend(window.childForm);
window.app_saku3_transaksi_tm_fCustTM.implement({
