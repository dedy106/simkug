window.app_saku3_transaksi_tm_fAkunPP = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tm_fAkunPP.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tm_fAkunPP";
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Data Relasi Akun PP: Input/Edit", 0);	
...
window.app_saku3_transaksi_tm_fAkunPP.extend(window.childForm);
window.app_saku3_transaksi_tm_fAkunPP.implement({
