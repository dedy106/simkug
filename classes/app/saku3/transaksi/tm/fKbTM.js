window.app_saku3_transaksi_tm_fKbTM = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tm_fKbTM.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tm_fKbTM";
...
window.app_saku3_transaksi_tm_fKbTM.extend(window.childForm);
window.app_saku3_transaksi_tm_fKbTM.implement({	
			...
			if (sender == this.sg) {
				if (col == 0){
					this.standarLib.showListData(this, "Daftar Akun",sender,undefined, 
							...
							"select count(*) from masakun a where a.block= '0' and a.kode_lokasi = '"+this.app._lokasi+"'",
