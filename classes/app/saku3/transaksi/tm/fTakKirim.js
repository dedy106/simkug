window.app_saku3_transaksi_tm_fTakKirim = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tm_fTakKirim.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tm_fTakKirim";
...
window.app_saku3_transaksi_tm_fTakKirim.extend(window.childForm);
window.app_saku3_transaksi_tm_fTakKirim.implement({	
