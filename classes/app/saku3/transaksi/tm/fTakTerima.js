window.app_saku3_transaksi_tm_fTakTerima = function(owner)
{
	if (owner)
	{		
		window.app_saku3_transaksi_tm_fTakTerima.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tm_fTakTerima";
...
window.app_saku3_transaksi_tm_fTakTerima.extend(window.childForm);
window.app_saku3_transaksi_tm_fTakTerima.implement({	
	...
	doDoubleClick: function(sender, col , row) {
		try{
			if (this.sg.cells(0,row) != "") {							
				...
				if (this.e_modul.getText() == "TAKUMUM" || this.e_modul.getText() == "TAKBEA" || this.e_modul.getText() == "TAKBILL" || this.e_modul.getText() == "TAKSUSUT" || this.e_modul.getText() == "TAKREV" || this.e_modul.getText() == "TAKPDREV" || this.e_modul.getText() == "PIUPRO" || this.e_modul.getText() == "TAKPJPTG" || this.e_modul.getText() == "PRTAKPPN") {
