window.app_saku3_transaksi_tm_fPiuUmum = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tm_fPiuUmum.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tm_fPiuUmum";
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[1,10,995,235], childPage:["Data Item Jurnal","Data Anggaran","File Dok"]});
...
window.app_saku3_transaksi_tm_fPiuUmum.extend(window.childForm);
window.app_saku3_transaksi_tm_fPiuUmum.implement({
