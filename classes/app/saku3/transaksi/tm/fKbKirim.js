window.app_saku3_transaksi_tm_fKbKirim = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tm_fKbKirim.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tm_fKbKirim";
		...
		this.e_nilai = new saiLabelEdit(this.pc2.childPage[0],{bound:[780,17,200,20],caption:"Total Droping", readOnly:true,tipeText:ttNilai, text:"0"});		
...
window.app_saku3_transaksi_tm_fKbKirim.extend(window.childForm);
window.app_saku3_transaksi_tm_fKbKirim.implement({
