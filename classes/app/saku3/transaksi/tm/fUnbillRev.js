window.app_saku3_transaksi_tm_fUnbillRev = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tm_fUnbillRev.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tm_fUnbillRev";
...
window.app_saku3_transaksi_tm_fUnbillRev.extend(window.childForm);
window.app_saku3_transaksi_tm_fUnbillRev.implement({
	loadData: function() {		
