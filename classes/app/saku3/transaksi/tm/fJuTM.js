window.app_saku3_transaksi_tm_fJuTM = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tm_fJuTM.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tm_fJuTM";
...
window.app_saku3_transaksi_tm_fJuTM.extend(window.childForm);
window.app_saku3_transaksi_tm_fJuTM.implement({	
