window.app_saku3_transaksi_tm_fPiuUmumSaraswati = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tm_fPiuUmumSaraswati.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tm_fPiuUmumSaraswati";
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[1,10,995,235], childPage:["Data Item Jurnal","Data Anggaran"]});
...
window.app_saku3_transaksi_tm_fPiuUmumSaraswati.extend(window.childForm);
window.app_saku3_transaksi_tm_fPiuUmumSaraswati.implement({
