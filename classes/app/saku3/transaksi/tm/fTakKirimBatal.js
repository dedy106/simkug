window.app_saku3_transaksi_tm_fTakKirimBatal = function(owner)
{
	if (owner)
	{		
		window.app_saku3_transaksi_tm_fTakKirimBatal.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tm_fTakKirimBatal";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Pembatalan TAK Kirim", 0);	
...
window.app_saku3_transaksi_tm_fTakKirimBatal.extend(window.childForm);
window.app_saku3_transaksi_tm_fTakKirimBatal.implement({	
