window.app_saku3_transaksi_tm_fKbTerima = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tm_fKbTerima.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tm_fKbTerima";
...
window.app_saku3_transaksi_tm_fKbTerima.extend(window.childForm);
window.app_saku3_transaksi_tm_fKbTerima.implement({
