window.app_saku3_transaksi_hutang_fPbAkru = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_hutang_fPbAkru.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_hutang_fPbAkru";
		...
		try {
			...
			if (this.app._userStatus == "A") sql.add("select kode_pp, nama  from pp where kode_lokasi = '"+this.app._lokasi+"' and tipe='posting' and flag_aktif ='1'");						
			else sql.add("select kode_pp, nama  from pp where kode_lokasi = '"+this.app._lokasi+"' and tipe='posting' and flag_aktif ='1' and kode_bidang='"+this.app._kodeBidang+"'");						
...
window.app_saku3_transaksi_hutang_fPbAkru.extend(window.childForm);
window.app_saku3_transaksi_hutang_fPbAkru.implement({		
