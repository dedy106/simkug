window.app_saku3_transaksi_hutang_fPbNonAkru = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_hutang_fPbNonAkru.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_hutang_fPbNonAkru";
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[1,12,995,348], childPage:["Otorisasi","Atensi Pembayaran","Jurnal","Data Anggaran","Data Approval"]});
...
window.app_saku3_transaksi_hutang_fPbNonAkru.extend(window.childForm);
window.app_saku3_transaksi_hutang_fPbNonAkru.implement({	
