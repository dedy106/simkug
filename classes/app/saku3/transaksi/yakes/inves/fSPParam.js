window.app_saku3_transaksi_yakes_inves_fSPParam = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes_inves_fSPParam.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes_inves_fSPParam";
...
window.app_saku3_transaksi_yakes_inves_fSPParam.extend(window.childForm);
window.app_saku3_transaksi_yakes_inves_fSPParam.implement({
