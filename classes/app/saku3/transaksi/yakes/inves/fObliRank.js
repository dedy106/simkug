window.app_saku3_transaksi_yakes_inves_fObliRank = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes_inves_fObliRank.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes_inves_fObliRank";
...
window.app_saku3_transaksi_yakes_inves_fObliRank.extend(window.childForm);
window.app_saku3_transaksi_yakes_inves_fObliRank.implement({
