window.app_saku3_transaksi_yakes_inves_fObliParam = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes_inves_fObliParam.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes_inves_fObliParam";
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Data Parameter Jurnal Penyertaan", 0);	
...
window.app_saku3_transaksi_yakes_inves_fObliParam.extend(window.childForm);
window.app_saku3_transaksi_yakes_inves_fObliParam.implement({
