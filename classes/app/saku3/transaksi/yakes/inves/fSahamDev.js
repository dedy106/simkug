window.app_saku3_transaksi_yakes_inves_fSahamDev = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes_inves_fSahamDev.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes_inves_fSahamDev";
...
window.app_saku3_transaksi_yakes_inves_fSahamDev.extend(window.childForm);
window.app_saku3_transaksi_yakes_inves_fSahamDev.implement({
