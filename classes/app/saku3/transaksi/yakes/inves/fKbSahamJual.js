window.app_saku3_transaksi_yakes_inves_fKbSahamJual = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes_inves_fKbSahamJual.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes_inves_fKbSahamJual";
...
window.app_saku3_transaksi_yakes_inves_fKbSahamJual.extend(window.childForm);
window.app_saku3_transaksi_yakes_inves_fKbSahamJual.implement({
