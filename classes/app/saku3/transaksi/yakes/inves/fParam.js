window.app_saku3_transaksi_yakes_inves_fParam = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes_inves_fParam.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes_inves_fParam";
...
window.app_saku3_transaksi_yakes_inves_fParam.extend(window.childForm);
window.app_saku3_transaksi_yakes_inves_fParam.implement({
