...
window.app_saku3_transaksi_yakes_inves_fSahamLoad = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes_inves_fSahamLoad.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku3_transaksi_yakes_inves_fSahamLoad";
...
window.app_saku3_transaksi_yakes_inves_fSahamLoad.extend(window.portalui_childForm);
window.app_saku3_transaksi_yakes_inves_fSahamLoad.implement({	
