window.app_saku3_transaksi_yakes_inves_fObliKKP = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes_inves_fObliKKP.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes_inves_fObliKKP";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Generate KKP Fixed Income", 0);	
		...
		this.pc1 = new pageControl(this,{bound:[10,12,1000,430], childPage:["Hasil Generate"]});
		this.sg1 = new portalui_saiGrid(this.pc1.childPage[0],{bound:[0,5,this.pc1.width-5,this.pc1.height-33],colCount:2,tag:9,
					colTitle:["Tanggal","ID Beli","No Seri","Nominal","Ni Perolehan"],
...
window.app_saku3_transaksi_yakes_inves_fObliKKP.extend(window.childForm);
window.app_saku3_transaksi_yakes_inves_fObliKKP.implement({	
