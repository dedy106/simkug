window.app_saku3_transaksi_yakes_inves_fNABdiscre = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes_inves_fNABdiscre.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes_inves_fNABdiscre";
...
window.app_saku3_transaksi_yakes_inves_fNABdiscre.extend(window.childForm);
window.app_saku3_transaksi_yakes_inves_fNABdiscre.implement({	
	doHitFee: function() {		
