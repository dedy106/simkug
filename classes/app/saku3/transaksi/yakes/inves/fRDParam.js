window.app_saku3_transaksi_yakes_inves_fRDParam = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes_inves_fRDParam.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes_inves_fRDParam";
...
window.app_saku3_transaksi_yakes_inves_fRDParam.extend(window.childForm);
window.app_saku3_transaksi_yakes_inves_fRDParam.implement({
