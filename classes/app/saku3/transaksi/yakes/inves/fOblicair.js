window.app_saku3_transaksi_yakes_inves_fOblicair = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes_inves_fOblicair.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes_inves_fOblicair";
		...
		this.cb_jenis = new saiCBBL(this,{bound:[20,18,200,20],caption:"ID Seri", multiSelection:false, maxLength:10, tag:1,change:[this,"doChange"]});		
...
window.app_saku3_transaksi_yakes_inves_fOblicair.extend(window.childForm);
window.app_saku3_transaksi_yakes_inves_fOblicair.implement({
