window.app_saku3_transaksi_yakes_inves_fPlan = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes_inves_fPlan.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes_inves_fPlan";
...
window.app_saku3_transaksi_yakes_inves_fPlan.extend(window.childForm);
window.app_saku3_transaksi_yakes_inves_fPlan.implement({
