window.app_saku3_transaksi_yakes_inves_fBankSus = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes_inves_fBankSus.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes_inves_fBankSus";
...
window.app_saku3_transaksi_yakes_inves_fBankSus.extend(window.childForm);
window.app_saku3_transaksi_yakes_inves_fBankSus.implement({		
