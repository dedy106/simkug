window.app_saku3_transaksi_yakes_inves_fRDDev = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes_inves_fRDDev.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes_inves_fRDDev";
...
window.app_saku3_transaksi_yakes_inves_fRDDev.extend(window.childForm);
window.app_saku3_transaksi_yakes_inves_fRDDev.implement({
