window.app_saku3_transaksi_yakes_inves_fSahamBonus = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes_inves_fSahamBonus.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes_inves_fSahamBonus";
...
window.app_saku3_transaksi_yakes_inves_fSahamBonus.extend(window.childForm);
window.app_saku3_transaksi_yakes_inves_fSahamBonus.implement({
