window.app_saku3_transaksi_yakes_inves_fSahamMI = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes_inves_fSahamMI.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes_inves_fSahamMI";
...
window.app_saku3_transaksi_yakes_inves_fSahamMI.extend(window.childForm);
window.app_saku3_transaksi_yakes_inves_fSahamMI.implement({
