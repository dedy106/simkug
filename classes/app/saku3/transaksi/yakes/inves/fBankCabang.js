window.app_saku3_transaksi_yakes_inves_fBankCabang = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes_inves_fBankCabang.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes_inves_fBankCabang";
...
window.app_saku3_transaksi_yakes_inves_fBankCabang.extend(window.childForm);
window.app_saku3_transaksi_yakes_inves_fBankCabang.implement({
