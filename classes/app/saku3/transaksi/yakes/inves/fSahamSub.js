window.app_saku3_transaksi_yakes_inves_fSahamSub = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes_inves_fSahamSub.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes_inves_fSahamSub";
...
window.app_saku3_transaksi_yakes_inves_fSahamSub.extend(window.childForm);
window.app_saku3_transaksi_yakes_inves_fSahamSub.implement({
