window.app_saku3_transaksi_yakes_inves_fShmPindahMIsingle = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes_inves_fShmPindahMIsingle.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes_inves_fShmPindahMIsingle";
...
window.app_saku3_transaksi_yakes_inves_fShmPindahMIsingle.extend(window.childForm);
window.app_saku3_transaksi_yakes_inves_fShmPindahMIsingle.implement({
