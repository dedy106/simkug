window.app_saku3_transaksi_yakes_inves_fSPDokLoad = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes_inves_fSPDokLoad.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes_inves_fSPDokLoad";
...
window.app_saku3_transaksi_yakes_inves_fSPDokLoad.extend(window.childForm);
window.app_saku3_transaksi_yakes_inves_fSPDokLoad.implement({
