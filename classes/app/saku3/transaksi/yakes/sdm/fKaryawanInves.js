window.app_saku3_transaksi_yakes_sdm_fKaryawanInves = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes_sdm_fKaryawanInves.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes_sdm_fKaryawanInves";
...
window.app_saku3_transaksi_yakes_sdm_fKaryawanInves.extend(window.childForm);
window.app_saku3_transaksi_yakes_sdm_fKaryawanInves.implement({	
