window.app_saku3_transaksi_yakes_koin_fKbSimpTarik = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes_koin_fKbSimpTarik.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes_koin_fKbSimpTarik";
		...
		this.sg1 = new saiGrid(this.pc1.childPage[0],{bound:[0,5,this.pc1.width-5,this.pc1.height-35],colCount:6,tag:0,
				colTitle:["No Kartu","Jenis","Deskripsi","Akun Titip","Saldo","Ni Pengambilan"],
...
window.app_saku3_transaksi_yakes_koin_fKbSimpTarik.extend(window.childForm);
window.app_saku3_transaksi_yakes_koin_fKbSimpTarik.implement({
