window.app_saku3_transaksi_yakes_koin_fLoadSimp = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes_koin_fLoadSimp.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes_koin_fLoadSimp";
...
window.app_saku3_transaksi_yakes_koin_fLoadSimp.extend(window.childForm);
window.app_saku3_transaksi_yakes_koin_fLoadSimp.implement({	
	doHitungAR: function() {
