window.app_saku3_transaksi_yakes_koin_fAkruSimpBatal = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes_koin_fAkruSimpBatal.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes_koin_fAkruSimpBatal";
		this.itemsValue = new portalui_arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Pembatalan (Reverse) Akru Simpanan", 0);	
...
window.app_saku3_transaksi_yakes_koin_fAkruSimpBatal.extend(window.portalui_childForm);
window.app_saku3_transaksi_yakes_koin_fAkruSimpBatal.implement({
