window.app_saku3_transaksi_yakes_koin_fLoadSimpH = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes_koin_fLoadSimpH.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes_koin_fLoadSimpH";
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Penghapusan Rekon Penerimaan Simpanan", 0);	
...
window.app_saku3_transaksi_yakes_koin_fLoadSimpH.extend(window.childForm);
window.app_saku3_transaksi_yakes_koin_fLoadSimpH.implement({
