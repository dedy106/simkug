window.app_saku3_transaksi_gl_fJuLintas2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_gl_fJuLintas2.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_gl_fJuLintas2";
...
window.app_saku3_transaksi_gl_fJuLintas2.extend(window.childForm);
window.app_saku3_transaksi_gl_fJuLintas2.implement({
