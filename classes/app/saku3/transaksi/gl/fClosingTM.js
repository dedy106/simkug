window.app_saku3_transaksi_gl_fClosingTM = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_gl_fClosingTM.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_gl_fClosingTM";
...
window.app_saku3_transaksi_gl_fClosingTM.extend(window.childForm);
window.app_saku3_transaksi_gl_fClosingTM.implement({
