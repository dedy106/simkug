window.app_saku3_transaksi_gl_fPostingSPM3 = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_gl_fPostingSPM3.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_gl_fPostingSPM3";
		...
		this.bLoad = new button(this,{bound:[830,18,80,18],caption:"Load Data",click:[this,"doLoad"]});			
		this.bPost = new button(this,{bound:[930,18,80,18],caption:"Posting All",click:[this,"doClick"]});			
...
window.app_saku3_transaksi_gl_fPostingSPM3.extend(window.childForm);
window.app_saku3_transaksi_gl_fPostingSPM3.implement({
		...
		switch (event){
			...
			case "simpan" :	
				...
				var strSQL = "select no_bukti+' - '+periode as bukper from ("+
						 ...
						 "from spm_ifreim_j a inner join spm_ifreim_m b on a.no_reim=b.no_reim and a.kode_lokasi=b.kode_lokasi and b.posted='F' "+
						 "where a.no_reim in ("+this.nobukti+") and a.kode_lokasi='"+this.app._lokasi+"' group by a.no_reim,a.periode "+											 						 
						 "union "+						 
						 "select a.no_ganti as no_bukti,a.periode,sum(case a.dc when 'D' then a.nilai else -a.nilai end) as total  "+
						 "from spm_ifganti_j a inner join spm_ifganti_m b on a.no_ganti=b.no_ganti and a.kode_lokasi=b.kode_lokasi and b.posted='F' "+
						 "where a.no_ganti in ("+this.nobukti+") and a.kode_lokasi='"+this.app._lokasi+"' group by a.no_ganti,a.periode "+											 						 
						 "union "+
						 ...
						 "union "+
						 "select a.no_pb as no_bukti,a.periode,sum(case a.dc when 'D' then a.nilai else -a.nilai end) as total "+
						 "from yk_pb_j a inner join yk_pb_m b on a.no_pb=b.no_pb and a.kode_lokasi=b.kode_lokasi and b.posted='F' "+
						 "where a.no_pb in ("+this.nobukti+") and a.kode_lokasi='"+this.app._lokasi+"' group by a.no_pb,a.periode "+						 
						 "union "+
						 "select a.no_reklas as no_bukti,a.periode,sum(case a.dc when 'D' then a.nilai else -a.nilai end) as total "+
						 "from spm_proyek_reklas_j a inner join spm_proyek_reklas_m b on a.no_reklas=b.no_reklas and a.kode_lokasi=b.kode_lokasi and b.posted='F' "+
						 "where a.no_reklas in ("+this.nobukti+") and a.kode_lokasi='"+this.app._lokasi+"' group by a.no_reklas,a.periode "+
						 "union "+
						 "select a.no_piutang as no_bukti,a.periode,sum(case a.dc when 'D' then a.nilai else -a.nilai end) as total "+
						 "from spm_piutang_j a inner join spm_piutang_m b on a.no_piutang=b.no_piutang and a.kode_lokasi=b.kode_lokasi and b.posted='F' "+
						 ...
						 "union "+
						 "select a.no_piutang as no_bukti,a.periode,sum(case a.dc when 'D' then a.nilai else -a.nilai end) as total "+
						 "from piutang_j a inner join piutang_m b on a.no_piutang=b.no_piutang and a.kode_lokasi=b.kode_lokasi and b.posted='F' "+
						 "where a.no_piutang in ("+this.nobukti+") and a.kode_lokasi='"+this.app._lokasi+"' group by a.no_piutang,a.periode "+
			...
			if (this.sg1.rowValid(i) && this.sg1.cells(0,i)=="TRUE") {
				...
				if (this.sg1.cells(1,i) == "JU") 
					strSQL += "union all "+
							  ...
							  "from ju_m where posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+strPP;					
				if (this.sg1.cells(1,i) == "KB") 
					strSQL += "union all "+
							  ...
							  "from kas_m where posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+strPP;				
				if (this.sg1.cells(1,i) == "HU") 
					strSQL += "union all "+
							  ...
							  "from spm_ifreim_m where posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+strPP+
							  "union all "+
							  "select 'INPROG' as status,no_ganti as no_bukti,'-' as no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'IG' as jenis "+
							  "from spm_ifganti_m where posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+strPP+
							  "union all "+
							  ...
							  "from hutang_m where posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+strPP+
							  "union all "+
							  "select 'INPROG' as status,no_pb as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'PB' as jenis "+
							  "from yk_pb_m where posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+strPP+							 
							  " ";
				if (this.sg1.cells(1,i) == "PR") 
					strSQL += "union all "+
							  ...
							  "from spm_proyek_reklas_m where posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+strPP+
							  "union all "+
					          "select 'INPROG' as status,no_piutang as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'AR' as jenis "+
							  "from spm_piutang_m where posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+strPP;					
				if (this.sg1.cells(1,i) == "PJ") 
					strSQL += "union all "+
							  ...
							  "from ptg_m where posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+strPP;		
				...
				if (this.sg1.cells(1,i) == "PU") 
					strSQL += "union all "+
							  ...
							  "from piutang_m where posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+strPP;		
				...
				if (this.sg1.cells(1,i) == "FA") 
					strSQL += "union all "+
							  ...
							  "from fasusut_m where posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+strPP;		
	...
	doChange:function(sender){
		...
		if (sender == this.c_modul && this.c_modul.getText()!="") {
			...
			if (this.c_modul.getText()=="JU") this.cb_bukti.setSQL("select no_ju as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'JU' as jenis from ju_m where posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+strPP,["no_bukti","no_dokumen","tanggal","keterangan","jenis"],false,["No Bukti","No Dokumen","Tanggal","Keterangan","Jenis"],"and","Data Bukti JU",true);			
			if (this.c_modul.getText()=="KB") this.cb_bukti.setSQL("select no_kas as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'KB' as jenis from kas_m where posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+strPP,["no_bukti","no_dokumen","tanggal","keterangan","jenis"],false,["No Bukti","No Dokumen","Tanggal","Keterangan","jenis"],"and","Data Bukti KB",true);			
			if (this.c_modul.getText()=="HU") this.cb_bukti.setSQL(
							"select no_reim as no_bukti,no_reim as no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'IR' as jenis from spm_ifreim_m where posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+strPP+
							"union "+
							...
							"union "+
							"select no_hutang as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'HUTANG' as jenis from hutang_m where posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+strPP+
							"union "+
							"select no_pb as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'PB' as jenis from yk_pb_m where posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+strPP+
							" "
			...
			if (this.c_modul.getText()=="PR") this.cb_bukti.setSQL(
							"select no_reklas as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'RBDD' as jenis from spm_proyek_reklas_m where posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+strPP+
						    "union "+
							"select no_piutang as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'AR' as jenis from spm_piutang_m where posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+strPP+
							" "
							,["no_bukti","no_dokumen","tanggal","keterangan","jenis"],false,["No Bukti","No Dokumen","Tanggal","Keterangan","Jenis"],"and","Data Bukti",true);			
			if (this.c_modul.getText()=="PJ") this.cb_bukti.setSQL("select no_ptg as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'PJPTG' as jenis from ptg_m where posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+strPP,["no_bukti","no_dokumen","tanggal","keterangan","jenis"],false,["No Bukti","No Dokumen","Tanggal","Keterangan","Jenis"],"and","Data Bukti",true);			
			if (this.c_modul.getText()=="PU") this.cb_bukti.setSQL("select no_piutang as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'PU' as jenis from piutang_m where posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+strPP,["no_bukti","no_dokumen","tanggal","keterangan","jenis"],false,["No Bukti","No Dokumen","Tanggal","Keterangan","jenis"],"and","Data Bukti PU",true);			
			if (this.c_modul.getText()=="FA") this.cb_bukti.setSQL("select no_fasusut as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'FA' as jenis from fasusut_m where posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+strPP,["no_bukti","no_dokumen","tanggal","keterangan","jenis"],false,["No Bukti","No Dokumen","Tanggal","Keterangan","jenis"],"and","Data Bukti FA",true);			
		}		
