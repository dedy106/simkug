window.app_saku3_transaksi_gl_fJPYks = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_gl_fJPYks.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku3_transaksi_gl_fJPYks";
...
window.app_saku3_transaksi_gl_fJPYks.extend(window.portalui_childForm);
window.app_saku3_transaksi_gl_fJPYks.implement({
	doUploadTB: function(){		
		try{			
