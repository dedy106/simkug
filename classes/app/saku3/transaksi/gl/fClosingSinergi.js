window.app_saku3_transaksi_gl_fClosingSinergi = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_gl_fClosingSinergi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_gl_fClosingSinergi";
...
window.app_saku3_transaksi_gl_fClosingSinergi.extend(window.childForm);
window.app_saku3_transaksi_gl_fClosingSinergi.implement({
