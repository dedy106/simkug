window.app_saku3_transaksi_gl_fClosingYks = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_gl_fClosingYks.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_gl_fClosingYks";
...
window.app_saku3_transaksi_gl_fClosingYks.extend(window.childForm);
window.app_saku3_transaksi_gl_fClosingYks.implement({
