window.app_saku3_transaksi_gl_fPostingSPM2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_gl_fPostingSPM2.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_gl_fPostingSPM2";
...
window.app_saku3_transaksi_gl_fPostingSPM2.extend(window.childForm);
window.app_saku3_transaksi_gl_fPostingSPM2.implement({
