window.app_saku3_transaksi_gl_fPostingSPM = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_gl_fPostingSPM.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_gl_fPostingSPM";
...
window.app_saku3_transaksi_gl_fPostingSPM.extend(window.childForm);
window.app_saku3_transaksi_gl_fPostingSPM.implement({
