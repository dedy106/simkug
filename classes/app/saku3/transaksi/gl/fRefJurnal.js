window.app_saku3_transaksi_gl_fRefJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_gl_fRefJurnal.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_gl_fRefJurnal";
...
window.app_saku3_transaksi_gl_fRefJurnal.extend(window.childForm);
window.app_saku3_transaksi_gl_fRefJurnal.implement({
