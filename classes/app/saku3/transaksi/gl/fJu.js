window.app_saku3_transaksi_gl_fJu = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_gl_fJu.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_gl_fJu";
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[1,12,995,350], childPage:["Data Item Jurnal","Data Anggaran","Referensi Jurnal"]});
...
window.app_saku3_transaksi_gl_fJu.extend(window.childForm);
window.app_saku3_transaksi_gl_fJu.implement({	
