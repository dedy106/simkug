window.app_saku3_transaksi_gl_fClosingYspt = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_gl_fClosingYspt.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_gl_fClosingYspt";
...
window.app_saku3_transaksi_gl_fClosingYspt.extend(window.childForm);
window.app_saku3_transaksi_gl_fClosingYspt.implement({
