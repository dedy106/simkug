window.app_saku3_transaksi_gl_fClosingThnYks = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_gl_fClosingThnYks.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_gl_fClosingThnYks";
...
window.app_saku3_transaksi_gl_fClosingThnYks.extend(window.childForm);
window.app_saku3_transaksi_gl_fClosingThnYks.implement({
