window.app_saku3_transaksi_gl_fPostingYspt = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_gl_fPostingYspt.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_gl_fPostingYspt";
...
window.app_saku3_transaksi_gl_fPostingYspt.extend(window.childForm);
window.app_saku3_transaksi_gl_fPostingYspt.implement({
