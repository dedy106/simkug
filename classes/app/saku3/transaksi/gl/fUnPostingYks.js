window.app_saku3_transaksi_gl_fUnPostingYks = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_gl_fUnPostingYks.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_gl_fUnPostingYks";
...
window.app_saku3_transaksi_gl_fUnPostingYks.extend(window.childForm);
window.app_saku3_transaksi_gl_fUnPostingYks.implement({
			...
			if (this.sg1.rowValid(i) && this.sg1.cells(0,i)=="TRUE") {
				...
				if (this.sg1.cells(1,i) == "TAK") 
					strSQL += "union all "+
							  ...
							  "from takkirim_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
							  "union all "+
							  ...
							  "from takterima_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' ";
				if (this.sg1.cells(1,i) == "AP") 
					strSQL += "union all "+
							  ...
							  "from hutang_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
							  "union all "+
							  "select 'INPROG' as status,no_reim as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'IFREIM' as jenis "+
							  "from if_reim_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' ";							  
				if (this.sg1.cells(1,i) == "AR") 
					strSQL += "union all "+
							  ...
							  "from yk_hutang_m where progress in ('1','X') and posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
							  "union all "+
							  "select 'INPROG' as status,no_rekon as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'REKON' as jenis "+
							  "from yk_rekon_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' ";
				if (this.sg1.cells(1,i) == "INV") 					
					strSQL += "union all "+
							  ...
							  "from inv_depoakru_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
							  "union all "+
							  ...
							  "from inv_depocair_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
							  "union all "+
	...
	doChange:function(sender){
		...
		if (sender == this.c_modul && this.c_modul.getText()!="") {
			...
			if (this.c_modul.getText()=="TAK") this.cb_bukti.setSQL("select no_kirim as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'KIRIM' as jenis from takkirim_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													"union "+
													"select no_terima as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'TERIMA' as jenis from takterima_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "
													,["no_bukti","no_dokumen","tanggal","keterangan","jenis"],false,["No Bukti","No Dokumen","Tanggal","Keterangan","Jenis"],"and","Data Bukti",true);
			if (this.c_modul.getText()=="AP") this.cb_bukti.setSQL("select no_hutang as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'HUTANG' as jenis from hutang_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													"union "+
													"select no_reim as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'IFREIM' as jenis from if_reim_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "
													,["no_bukti","no_dokumen","tanggal","keterangan","jenis"],false,["No Bukti","No Dokumen","Tanggal","Keterangan","Jenis"],"and","Data Bukti",true);
			if (this.c_modul.getText()=="AR") this.cb_bukti.setSQL("select no_hutang as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'PIUHUT' as jenis from yk_hutang_m where progress in ('1','X') posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													"union "+
													"select no_rekon as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'REKON' as jenis from yk_rekon_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "
													,["no_bukti","no_dokumen","tanggal","keterangan","jenis"],false,["No Bukti","No Dokumen","Tanggal","Keterangan","Jenis"],"and","Data Bukti",true);
		
			if (this.c_modul.getText()=="INV") this.cb_bukti.setSQL("select no_akru as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'DEPOAKRU' as jenis from inv_depoakru_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
			                                       "union "+
												   ...
												   "union "+
												   "select no_tutup as no_bukti,no_depo as no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'DEPOTUTUP' as jenis from inv_depotutup_m  where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' ",												   
												   "union "+
												   ...
												   "union "+
												   "select no_shmdev as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'SHMDEV' as jenis from inv_shmdev_m  where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+												   
												   "union "+
												   ...
												   "union "+
												   "select no_rddev as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'RDDEV' as jenis from inv_rddev_m  where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+										
												   "union "+
												   
												   "select no_spbeli as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'PSBELI' as jenis from inv_spbeli_m  where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
												   "union "+
												   "select no_spjual as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'PSJUAL' as jenis from inv_spjual_m  where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
												   "union "+
												   "select no_spi as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'PSSPI' as jenis from inv_spspi_m  where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "	+
												   "union "+
												   "select no_spdev as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'PSDEV' as jenis from inv_spdev_m  where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+										
			...
			switch(this.sg.cells(5,row)){
				...
				case "PSBELI" :
							strSQL = "select a.kode_akun,b.nama as nama_akun,a.dc,a.keterangan,a.nilai,a.kode_pp,c.nama as nama_pp,a.kode_drk,isnull(d.nama,'-') as nama_drk,'-' as kode_cf,'-' as nama_cf "+
									 ...
									 "                    inner join pp c on a.kode_pp=c.kode_pp and a.kode_lokasi=c.kode_lokasi "+
									 "                    left join drk d on a.kode_drk=d.kode_drk and a.kode_lokasi=d.kode_lokasi and d.tahun='"+this.e_periode.getText().substr(0,4)+"' "+
									 "where a.no_ps = '"+this.sg.cells(1,row)+"' and a.kode_lokasi='"+this.app._lokasi+"'";
					break;
				case "PSJUAL" :
							strSQL = "select a.kode_akun,b.nama as nama_akun,a.dc,a.keterangan,a.nilai,a.kode_pp,c.nama as nama_pp,a.kode_drk,isnull(d.nama,'-') as nama_drk,'-' as kode_cf,'-' as nama_cf "+
