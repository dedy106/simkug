window.app_saku3_transaksi_gl_fUnPostingKopKar = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_gl_fUnPostingKopKar.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_gl_fUnPostingKopKar";
		...
		try {
			...
			this.sg1.appendData(["TRUE","AR","Piutang Umum"]);	
...
window.app_saku3_transaksi_gl_fUnPostingKopKar.extend(window.childForm);
window.app_saku3_transaksi_gl_fUnPostingKopKar.implement({
			...
			if (this.sg1.rowValid(i) && this.sg1.cells(0,i)=="TRUE") {
				...
				if (this.sg1.cells(1,i) == "AR") 
					strSQL += "union all "+
							  ...
							  "from piutang_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' ";				
				...
				if (this.sg1.cells(1,i) == "SP") 
					strSQL += "union all "+
							  ...
							  "from kop_simpbill_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
							  "union all "+
							  ...
							  "from kop_pinjbill_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
							  ...
							  "from kop_simpangs_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
							  "union all "+
							  ...
							  "from kop_pinjangs_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
	...
	doChange:function(sender){
		...
		if (sender == this.c_modul && this.c_modul.getText()!="") {
			...
			if (this.c_modul.getText()=="AR") this.cb_bukti.setSQL("select no_piutang as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'PIUUM' as jenis from piutang_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"'",["no_bukti","no_dokumen","tanggal","keterangan","jenis"],false,["No Bukti","No Dokumen","Tanggal","Keterangan","jenis"],"and","Data Bukti",true);			
			if (this.c_modul.getText()=="SP") this.cb_bukti.setSQL(
				"select no_bill as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'SIMPBILL' as jenis from kop_simpbill_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
				"union all "+
				"select no_bill as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'PINJBILL' as jenis from kop_pinjbill_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
				"union all "+
				"select no_angs as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'SIMPANGS' as jenis from kop_simpangs_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
				"union all "+
				"select no_angs as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'PINJANGS' as jenis from kop_pinjangs_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
