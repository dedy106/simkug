window.app_saku3_transaksi_gl_fClosingSPM = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_gl_fClosingSPM.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_gl_fClosingSPM";
...
window.app_saku3_transaksi_gl_fClosingSPM.extend(window.childForm);
window.app_saku3_transaksi_gl_fClosingSPM.implement({
