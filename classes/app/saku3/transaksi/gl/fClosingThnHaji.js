window.app_saku3_transaksi_gl_fClosingThnHaji = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_gl_fClosingThnHaji.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_gl_fClosingThnHaji";
...
window.app_saku3_transaksi_gl_fClosingThnHaji.extend(window.childForm);
window.app_saku3_transaksi_gl_fClosingThnHaji.implement({
