window.app_saku3_transaksi_gl_fUnPostingYspt = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_gl_fUnPostingYspt.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_gl_fUnPostingYspt";
...
window.app_saku3_transaksi_gl_fUnPostingYspt.extend(window.childForm);
window.app_saku3_transaksi_gl_fUnPostingYspt.implement({
