window.app_saku3_transaksi_gl_fClosingKopKar = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_gl_fClosingKopKar.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_gl_fClosingKopKar";
...
window.app_saku3_transaksi_gl_fClosingKopKar.extend(window.childForm);
window.app_saku3_transaksi_gl_fClosingKopKar.implement({
