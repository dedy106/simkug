window.app_saku3_transaksi_gl_fJuYpt = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_gl_fJuYpt.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_gl_fJuYpt";
		...
		this.pc1 = new pageControl(this.pc2.childPage[1],{bound:[5,12,990,320], childPage:["Data Item Jurnal","Data Anggaran"]});
...
window.app_saku3_transaksi_gl_fJuYpt.extend(window.childForm);
window.app_saku3_transaksi_gl_fJuYpt.implement({	
