window.app_saku3_transaksi_gl_fJuSimple = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_gl_fJuSimple.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_gl_fJuSimple";
...
window.app_saku3_transaksi_gl_fJuSimple.extend(window.childForm);
window.app_saku3_transaksi_gl_fJuSimple.implement({	
