window.app_saku3_transaksi_gl_fJPKopkar = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_gl_fJPKopkar.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku3_transaksi_gl_fJPKopkar";
...
window.app_saku3_transaksi_gl_fJPKopkar.extend(window.portalui_childForm);
window.app_saku3_transaksi_gl_fJPKopkar.implement({
	doUploadTB: function(){		
		try{			
