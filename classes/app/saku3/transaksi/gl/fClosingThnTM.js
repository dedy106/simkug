window.app_saku3_transaksi_gl_fClosingThnTM = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_gl_fClosingThnTM.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_gl_fClosingThnTM";
...
window.app_saku3_transaksi_gl_fClosingThnTM.extend(window.childForm);
window.app_saku3_transaksi_gl_fClosingThnTM.implement({
