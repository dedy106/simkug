window.app_saku3_transaksi_gl_fClosingThnSPM = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_gl_fClosingThnSPM.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_gl_fClosingThnSPM";
...
window.app_saku3_transaksi_gl_fClosingThnSPM.extend(window.childForm);
window.app_saku3_transaksi_gl_fClosingThnSPM.implement({
