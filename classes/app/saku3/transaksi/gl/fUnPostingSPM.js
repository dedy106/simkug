window.app_saku3_transaksi_gl_fUnPostingSPM = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_gl_fUnPostingSPM.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_gl_fUnPostingSPM";
		...
		this.c_modul = new saiCB(this.pc1.childPage[3],{bound:[20,11,202,20],caption:"Modul",items:["JU","KB","TAK"], readOnly:true,tag:9,change:[this,"doChange"]});
...
window.app_saku3_transaksi_gl_fUnPostingSPM.extend(window.childForm);
window.app_saku3_transaksi_gl_fUnPostingSPM.implement({
