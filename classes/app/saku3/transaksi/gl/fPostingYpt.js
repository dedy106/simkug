window.app_saku3_transaksi_gl_fPostingYpt = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_gl_fPostingYpt.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_gl_fPostingYpt";
...
window.app_saku3_transaksi_gl_fPostingYpt.extend(window.childForm);
window.app_saku3_transaksi_gl_fPostingYpt.implement({
