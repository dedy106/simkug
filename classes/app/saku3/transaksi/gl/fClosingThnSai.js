window.app_saku3_transaksi_gl_fClosingThnSai = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_gl_fClosingThnSai.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_gl_fClosingThnSai";
...
window.app_saku3_transaksi_gl_fClosingThnSai.extend(window.childForm);
window.app_saku3_transaksi_gl_fClosingThnSai.implement({
