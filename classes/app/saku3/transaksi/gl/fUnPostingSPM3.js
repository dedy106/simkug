window.app_saku3_transaksi_gl_fUnPostingSPM3 = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_gl_fUnPostingSPM3.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_gl_fUnPostingSPM3";
...
window.app_saku3_transaksi_gl_fUnPostingSPM3.extend(window.childForm);
window.app_saku3_transaksi_gl_fUnPostingSPM3.implement({
