window.app_saku3_transaksi_cianjur_hutang_fPbHut = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_cianjur_hutang_fPbHut.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_cianjur_hutang_fPbHut";
		...
		this.sg3 = new saiGrid(this.pc2.childPage[1],{bound:[1,5,this.pc2.width-5,this.pc2.height-33],colCount:5,tag:9,
					colTitle:["No Bukti","Tanggal","No Hutang","Deskripsi","Total"],
		...
		this.e_nb = new portalui_saiLabelEdit(this.pc2.childPage[0],{bound:[20,12,200,20],caption:"No PB",maxLength:30,readOnly:true});
		...
		this.cb_hutang = new saiCBBL(this.pc2.childPage[0],{bound:[20,19,220,20],caption:"No Hutang", multiSelection:false, maxLength:10, tag:1,change:[this,"doChange"]});				
		this.e_saldo = new saiLabelEdit(this.pc2.childPage[0],{bound:[20,20,200,20],caption:"Saldo Hutang", tag:1, readOnly:true, tipeText:ttNilai, text:"0"});		
		this.e_nilai = new saiLabelEdit(this.pc2.childPage[0],{bound:[20,21,200,20],caption:"Nilai Tagihan", tag:1, tipeText:ttNilai, text:"0"});
...
window.app_saku3_transaksi_cianjur_hutang_fPbHut.extend(window.childForm);
window.app_saku3_transaksi_cianjur_hutang_fPbHut.implement({
	...
	simpan: function(){			
		try{						
			if(this.stsSimpan == 1) this.e_nb.setText(this.standarLib.noBuktiOtomatis(this.dbLib,"pb_m","no_pb",this.app._lokasi+"-PB"+this.e_periode.getText().substr(2,4)+".","000"));
	...
	doChange:function(sender){
		...
		if (sender == this.cb_hutang && this.cb_hutang.getText()!="" && this.stsSimpan == 1) {
	...
	doLoad3:function(sender){																				
		var strSQL = "select distinct a.no_pb,a.no_hutang,convert(varchar,a.tanggal,103) as tanggal,a.keterangan,a.nilai "+
					 "from pb_m a "+
					 "inner join hutang_j b on a.no_hutang=b.no_hutang  and a.kode_lokasi=b.kode_lokasi "+
					 "where a.periode='"+this.e_periode.getText()+"' and b.modul in ('HUTUMUM','HUTPROYEK') and a.progress='0' and a.kode_lokasi='"+this.app._lokasi+"'";						
	...
	doTampilData3: function(page) {
		...
		for (var i=start;i<finish;i++){
			...
			this.sg3.appendData([line.no_pb,line.tanggal,line.no_hutang,line.keterangan,floatToNilai(line.nilai)]); 
		}
