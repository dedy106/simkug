window.app_saku3_transaksi_cianjur_hutang_fHutProyek = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_cianjur_hutang_fHutProyek.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_cianjur_hutang_fHutProyek";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Hutang Umum", 0);	
		
		uses("saiCB;saiCBBL;saiEdit;datePicker;saiGrid;sgNavigator;pageControl;checkBox");
		this.e_periode = new portalui_saiLabelEdit(this,{bound:[230,11,202,20],caption:"Periode",tag:2,readOnly:true,visible:false});
		this.l_tgl1 = new portalui_label(this,{bound:[20,11,100,18],caption:"Tanggal", underline:true});
		this.dp_d1 = new portalui_datePicker(this,{bound:[120,11,100,18],selectDate:[this,"doSelectDate"]}); 
		
		this.pc2 = new pageControl(this,{bound:[10,10,1000,430], childPage:["Data Hutang","List Hutang"]});
		...
		this.e_ppn = new saiLabelEdit(this.pc2.childPage[0],{bound:[780,14,210,20],caption:"PPN", tag:1, tipeText:ttNilai, text:"0", change:[this,"doChange"]});		
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[5,12,990,210], childPage:["Data Item Jurnal"]});
...
window.app_saku3_transaksi_cianjur_hutang_fHutProyek.extend(window.childForm);
window.app_saku3_transaksi_cianjur_hutang_fHutProyek.implement({
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					sql.add("insert into trans_m (no_bukti,kode_lokasi,tgl_input,nik_user,periode,modul,form,posted,prog_seb,progress,kode_pp,tanggal,no_dokumen,keterangan,kode_curr,kurs,nilai1,nilai2,nilai3,nik1,nik2,nik3,no_ref1,no_ref2,no_ref3,param1,param2,param3) values "+
							"('"+this.e_nb.getText()+"','"+this.app._lokasi+"',getdate(),'"+this.app._userLog+"','"+this.e_periode.getText()+"','AP','HUTPROYEK','F','-','-','"+this.cb_pp.getText()+"','"+this.dp_d1.getDateString()+"','"+this.e_dok.getText()+"','"+this.e_ket.getText()+"','IDR',1,"+parseNilai(this.e_nilai.getText())+","+parseNilai(this.e_ppn.getText())+",0,'"+this.cb_app.getText()+"','-','-', '-','-','-', '"+this.cb_project.getText()+"','"+this.cb_vendor.getText()+"','"+this.cb_akun.getText()+"')");
					...
					sql.add("insert into hutang_j(no_hutang,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,kode_curr,kurs,nilai_curr,nilai,kode_pp,kode_drk,kode_lokasi,modul,jenis,periode,nik_user,tgl_input) values "+
							"('"+this.e_nb.getText()+"','"+this.e_dok.getText()+"','"+this.dp_d1.getDateString()+"',0,'"+this.cb_akun.getText()+"','"+this.e_ket.getText()+"','C','IDR',1,"+parseNilai(this.e_total.getText())+","+parseNilai(this.e_total.getText())+",'"+this.cb_pp.getText()+"','-','"+this.app._lokasi+"','HUTPROYEK','HUT','"+this.e_periode.getText()+"','"+this.app._userLog+"',getdate())");
					if (nilaiToFloat(this.e_ppn.getText()) != 0) {
						sql.add("insert into hutang_j(no_hutang,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,kode_curr,kurs,nilai_curr,nilai,kode_pp,kode_drk,kode_lokasi,modul,jenis,periode,nik_user,tgl_input) values "+
								"('"+this.e_nb.getText()+"','"+this.e_dok.getText()+"','"+this.dp_d1.getDateString()+"',99,'"+this.akunPPN+"','"+this.e_ket.getText()+"','D','IDR',1,"+parseNilai(this.e_ppn.getText())+","+parseNilai(this.e_ppn.getText())+",'"+this.cb_pp.getText()+"','-','"+this.app._lokasi+"','HUTPROYEK','PPNM','"+this.e_periode.getText()+"','"+this.app._userLog+"',getdate())");
					}
					if (this.sg.getRowValidCount() > 0){
						for (var i=0;i < this.sg.getRowCount();i++){
							if (this.sg.rowValid(i)){															
								var j = i+1;
								sql.add("insert into hutang_j(no_hutang,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,kode_curr,kurs,nilai_curr,nilai,kode_pp,kode_drk,kode_lokasi,modul,jenis,periode,nik_user,tgl_input) values "+
										"('"+this.e_nb.getText()+"','"+this.e_dok.getText()+"','"+this.dp_d1.getDateString()+"',"+j+",'"+this.sg.cells(0,i)+"','"+this.sg.cells(3,i)+"','"+this.sg.cells(2,i)+"','IDR',1,"+parseNilai(this.sg.cells(4,i))+","+parseNilai(this.sg.cells(4,i))+",'"+this.sg.cells(5,i)+"','-','"+this.app._lokasi+"','HUTPROYEK','BBN','"+this.e_periode.getText()+"','"+this.app._userLog+"',getdate())");
								sql.add("insert into pr_beban_d(no_bukti,kode_akun,keterangan,dc,nilai,kode_pp,kode_proyek,kode_lokasi,modul) values "+
										"('"+this.e_nb.getText()+"','"+this.sg.cells(0,i)+"','"+this.sg.cells(3,i)+"','"+this.sg.cells(2,i)+"',"+parseNilai(this.sg.cells(4,i))+",'"+this.sg.cells(5,i)+"','"+this.cb_project.getText()+"','"+this.app._lokasi+"','HUTPROYEK')");								
							}
						}
					}
	...
	doClick:function(sender){
		if (this.e_periode.getText()!= "" ) {				
			this.e_nb.setText(this.standarLib.noBuktiOtomatis(this.dbLib,"hutang_m","no_hutang",this.app._lokasi+"-HP"+this.e_periode.getText().substr(2,4)+".","000"));
			this.e_dok.setFocus();
		}
	},	
				...
				switch(methodName){
					case "execArraySQL" :	    				
						if (result.toLowerCase().search("error") == -1){							
							if(this.preView == "1"){
								this.nama_report="server_report_saku3_cianjur_rptHutangAkru";
	...
	doLoad3:function(sender){																		
		var strSQL = "select a.no_hutang,a.no_dokumen,convert(varchar,a.tanggal,103) as tanggal,a.keterangan,a.nilai "+
					 "from hutang_m a "+
					 "inner join trans_m c on a.no_hutang=c.no_bukti and a.kode_lokasi=c.kode_lokasi "+
					 "left join "+
					 "	(	select no_hutang,kode_lokasi,sum(nilai) as nilai_pb from pb_m where kode_lokasi='"+this.app._lokasi+"' "+
					 "		group by no_hutang,kode_lokasi) b  "+
					 "   	on a.no_hutang=b.no_hutang and a.kode_lokasi=b.kode_lokasi "+					 
					 "where c.posted='F' and c.form='HUTPROYEK' and a.kode_project <> '-' and (a.nilai+a.nilai_ppn-isnull(b.nilai_pb,0)) > 0 and a.periode='"+this.e_periode.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"'";											 
		var data = this.dbLib.getDataProvider(strSQL,true);
	...
	doDoubleClick3: function(sender, col , row) {
		try{
			if (this.sg3.cells(0,row) != "") {
				...
				var strSQL = "select a.no_hutang,a.no_dokumen,a.keterangan,a.tanggal,a.due_date,a.akun_hutang,a.kode_vendor,a.kode_pp,a.kode_project,b.nama as nama_akun,c.nama as nama_pp,a.nik_app,a.nilai,a.nilai_ppn "+
							"from hutang_m a "+
							"inner join masakun b on a.akun_hutang=b.kode_akun and a.kode_lokasi=b.kode_lokasi "+
				...
				strSQL = "select a.kode_akun,b.nama as nama_akun,a.dc,a.keterangan,a.nilai,a.kode_pp,c.nama as nama_pp "+
						 ...
						 "inner join pp c on a.kode_pp=c.kode_pp and a.kode_lokasi=c.kode_lokasi "+		 
						 "where a.no_hutang = '"+this.e_nb.getText()+"' and a.jenis = 'BBN' and a.kode_lokasi='"+this.app._lokasi+"' order by a.no_urut";
				var data = this.dbLib.getDataProvider(strSQL,true);
				if (typeof data == "object" && data.rs.rows[0] != undefined){
					var line2;
					this.sg.clear();
