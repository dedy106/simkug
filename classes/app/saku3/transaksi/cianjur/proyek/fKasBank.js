window.app_saku3_transaksi_cianjur_proyek_fKasBank = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_cianjur_proyek_fKasBank.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_cianjur_proyek_fKasBank";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Penerimaan Kas Bank", 0);	
...
window.app_saku3_transaksi_cianjur_proyek_fKasBank.extend(window.childForm);
window.app_saku3_transaksi_cianjur_proyek_fKasBank.implement({
