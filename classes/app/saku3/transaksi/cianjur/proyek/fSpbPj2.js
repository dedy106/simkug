window.app_saku3_transaksi_cianjur_proyek_fSpbPj2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_cianjur_proyek_fSpbPj2.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_cianjur_proyek_fSpbPj2";
...
window.app_saku3_transaksi_cianjur_proyek_fSpbPj2.extend(window.childForm);
window.app_saku3_transaksi_cianjur_proyek_fSpbPj2.implement({
				...
				switch(methodName){
	    			case "execArraySQL" :	    				
						if (result.toLowerCase().search("error") == -1){	
							if(this.preView == "1"){
								this.nama_report="server_report_saku3_cianjur_rptPjDokSpb2";
