window.app_saku3_transaksi_cianjur_proyek_fPjAju = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_cianjur_proyek_fPjAju.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_cianjur_proyek_fPjAju";
...
window.app_saku3_transaksi_cianjur_proyek_fPjAju.extend(window.childForm);
window.app_saku3_transaksi_cianjur_proyek_fPjAju.implement({
