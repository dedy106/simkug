window.app_saku3_transaksi_cianjur_kug_fKb = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_cianjur_kug_fKb.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_cianjur_kug_fKb";
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[5,12,990,280], childPage:["Data Item Jurnal","Otorisasi"]});
		...
		this.cb_buat = new saiCBBL(this.pc1.childPage[1],{bound:[20,18,220,20],caption:"Dibuat Oleh", multiSelection:false, maxLength:10, tag:2});				
		this.cb_app = new saiCBBL(this.pc1.childPage[1],{bound:[20,19,220,20],caption:"Diapprove Oleh", multiSelection:false, maxLength:10, tag:2});				
...
window.app_saku3_transaksi_cianjur_kug_fKb.extend(window.childForm);
window.app_saku3_transaksi_cianjur_kug_fKb.implement({
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					sql.add("insert into trans_m (no_bukti,kode_lokasi,tgl_input,nik_user,periode,modul,form,posted,prog_seb,progress,kode_pp,tanggal,no_dokumen,keterangan,kode_curr,kurs,nilai1,nilai2,nilai3,nik1,nik2,nik3,no_ref1,no_ref2,no_ref3,param1,param2,param3) values "+
							...
							parseNilai(this.e_debet.getText())+",0,0,'"+this.cb_buat.getText()+"','"+this.cb_app.getText()+"','-','"+this.e_bank.getText()+"','"+this.e_dok.getText()+"','-','-','"+this.c_status.getText()+"','"+this.c_jenis.getText()+"')");
		...
		try{
			if (this.e_periode.getText()!= "" && this.c_jenis.getText()!= "") {
				...
				if (typeof data == "object"){
					...
					if (line != undefined){
						if (line.no_bukti == "0") this.e_nb.setText(this.c_jenis.getText().substr(0,2)+"/"+this.e_periode.getText().substr(2,4)+"/0001");
						else {
							var idx = parseFloat(line.no_bukti.substr(8,4)) + 1;
							idx = idx.toString();
							if (idx.length == 1) var nu = "000"+idx;
							if (idx.length == 2) var nu = "00"+idx;
							if (idx.length == 3) var nu = "0"+idx;
							if (idx.length == 4) var nu = idx;
							this.e_nb.setText(this.c_jenis.getText().substr(0,2)+"/"+this.e_periode.getText().substr(2,4)+"/"+nu);						
						}
					} 
				}
				*/
