window.app_saku3_transaksi_optik_barang_fJualMitra = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_optik_barang_fJualMitra.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_optik_barang_fJualMitra";
		this.itemsValue = new portalui_arrayList();
		this.maximize();	
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Penjualan Mitra", 0);	
		...
		this.e_nb = new portalui_saiLabelEdit(this.pc2.childPage[0],{bound:[20,12,200,20],caption:"No Resep",maxLength:30,readOnly:true});
...
window.app_saku3_transaksi_optik_barang_fJualMitra.extend(window.portalui_childForm);
window.app_saku3_transaksi_optik_barang_fJualMitra.implement({
