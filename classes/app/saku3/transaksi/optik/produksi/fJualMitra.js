window.app_saku3_transaksi_optik_produksi_fJualMitra = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_optik_produksi_fJualMitra.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_optik_produksi_fJualMitra";
		...
		this.sg3 = new saiGrid(this.pc2.childPage[1],{bound:[1,5,this.pc2.width-5,this.pc2.height-33],colCount:5,tag:9,
		            colTitle:["No Resep","Tanggal","NIK","No Nota","Total"],
		...
		this.e_dok2 = new portalui_saiLabelEdit(this.pc2.childPage[0],{bound:[230,16,190,20],labelWidth:80,caption:"No Nota",maxLength:6,change:[this,"doChange"]});
		...
		this.e_loker = new portalui_saiLabelEdit(this.pc1.childPage[0],{bound:[20,16,200,20],caption:"Loker - Band",readOnly:true});
		...
		this.sg = new saiGrid(this.pc1.childPage[1],{bound:[1,5,this.pc1.width-5,this.pc1.height-33],colCount:6,tag:0,
					colTitle:["POWER MATA","SPH (+/-)","CYL (+/-)","AXIS(o)","ADD(+)","PD"],	
...
window.app_saku3_transaksi_optik_produksi_fJualMitra.extend(window.portalui_childForm);
window.app_saku3_transaksi_optik_produksi_fJualMitra.implement({		
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{																									
					...
					sql.add("insert into trans_m (no_bukti,kode_lokasi,tgl_input,nik_user,periode,modul,form,posted,prog_seb,progress,kode_pp,tanggal,no_dokumen,keterangan,kode_curr,kurs,nilai1,nilai2,nilai3,nik1,nik2,nik3,no_ref1,no_ref2,no_ref3,param1,param2,param3) values "+
							"('"+this.e_nb.getText()+"','"+this.app._lokasi+"',getdate(),'"+this.app._userLog+"','"+this.e_periode.getText()+"','AR','JMITRA','F','-','-','"+this.cb_pp.getText()+"','"+this.dp_d1.getDateString()+"','"+this.e_dok.getText()+"','"+this.e_dok.getText()+"','IDR',1,"+
	...
	doLoad3:function(sender){			
		var strSQL = "select a.no_bukti,convert(varchar,a.tanggal,103) as tgl,a.no_dokumen,a.nilai1,a.param1 as nik "+
					 "from trans_m a "+				     
					 "where a.modul='AR' and a.form='JMITRA' and a.periode='"+this.e_periode.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' and a.posted ='F' and a.kode_pp='"+this.cb_pp.getText()+"' "+
					 "order by a.no_bukti";			
