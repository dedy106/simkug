window.app_saku3_transaksi_tarbak_fRefJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_fRefJurnal.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_fRefJurnal";
		...
		this.pc1 = new pageControl(this,{bound:[20,12,1000,450], childPage:["Data Referensi","Detail Jurnal","Filter Data"]});				
		...
		try {
			...
			if (this.app._userStatus == "A") this.cb_lokasi.setSQL("select kode_lokasi, nama from lokasi where flag_konsol='0'",["kode_lokasi","nama"],false,["Kode","Nama"],"and","Data Lokasi",true);
...
window.app_saku3_transaksi_tarbak_fRefJurnal.extend(window.childForm);
window.app_saku3_transaksi_tarbak_fRefJurnal.implement({
