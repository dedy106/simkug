window.app_saku3_transaksi_tarbak_fJu = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_fJu.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_fJu";
...
window.app_saku3_transaksi_tarbak_fJu.extend(window.childForm);
window.app_saku3_transaksi_tarbak_fJu.implement({	
