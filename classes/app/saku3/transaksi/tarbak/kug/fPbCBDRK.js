window.app_saku3_transaksi_tarbak_kug_fPbCBDRK = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_kug_fPbCBDRK.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_kug_fPbCBDRK";
...
window.app_saku3_transaksi_tarbak_kug_fPbCBDRK.extend(window.childForm);
window.app_saku3_transaksi_tarbak_kug_fPbCBDRK.implement({	
