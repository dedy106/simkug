window.app_saku3_transaksi_tarbak_kug_fPbCB = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_kug_fPbCB.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_kug_fPbCB";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Permintaan Bayar [CashBasis]", 0);	
        ...
        this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[1,12,996,328], childPage:["Atensi Pembayaran","Item Jurnal","Otorisasi","Cattn Verf.","File Dok","Budget"]});    
...
window.app_saku3_transaksi_tarbak_kug_fPbCB.extend(window.childForm);
window.app_saku3_transaksi_tarbak_kug_fPbCB.implement({	
