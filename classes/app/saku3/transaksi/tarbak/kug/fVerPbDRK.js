window.app_saku3_transaksi_tarbak_kug_fVerPbDRK = function(owner)
{
	if (owner)
	{		
		window.app_saku3_transaksi_tarbak_kug_fVerPbDRK.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_kug_fVerPbDRK";
		...
		this.sg2 = new saiGrid(this.pc2.childPage[4],{bound:[1,5,this.pc2.width-5,this.pc2.height-35],colCount:6,tag:9,
...
window.app_saku3_transaksi_tarbak_kug_fVerPbDRK.extend(window.childForm);
window.app_saku3_transaksi_tarbak_kug_fVerPbDRK.implement({	
	doLoadPO: function() {		
	...
	doHitungGar: function(){
		try {
			...
			for (var i=0;i < this.sg2.getRowCount();i++){
				var data = this.dbLib.getDataProvider("select fn_saldotwdrk('"+this.app._lokasi+"','"+this.sg2.cells(0,i)+"','"+this.sg2.cells(1,i)+"','"+this.sg2.cells(2,i)+"','"+this.e_periode.getText()+"','"+this.e_nobukti.getText()+"') as gar ",true);
				if (typeof data == "object" && data.rs.rows[0] != undefined){
