window.app_saku3_transaksi_tarbak_kug_fKbSpb = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_kug_fKbSpb.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_kug_fKbSpb";
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[1,12,996,305], childPage:["Daftar SPB","Daftar Transfer","Jurnal Tambahan"]});		
...
window.app_saku3_transaksi_tarbak_kug_fKbSpb.extend(window.childForm);
window.app_saku3_transaksi_tarbak_kug_fKbSpb.implement({	
