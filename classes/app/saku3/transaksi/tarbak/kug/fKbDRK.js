window.app_saku3_transaksi_tarbak_kug_fKbDRK = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_kug_fKbDRK.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_kug_fKbDRK";
		...
		this.sg3 = new saiGrid(this.pc2.childPage[0],{bound:[1,5,this.pc2.width-5,this.pc2.height-35],colCount:7,tag:9,
					...
					colWidth:[[6,5,4,3,2,1,0],[70,100,350,180,80,80,100]],					
		...
		this.pc1 = new pageControl(this.pc2.childPage[1],{bound:[1,12,996,305], childPage:["Data Item Jurnal","Data Anggaran","Referensi Jurnal"]});
...
window.app_saku3_transaksi_tarbak_kug_fKbDRK.extend(window.childForm);
window.app_saku3_transaksi_tarbak_kug_fKbDRK.implement({	
	...
	doTampilData3: function(page) {
		...
		for (var i=start;i<finish;i++){
			...
			this.sg3.appendData([line.no_kas,line.tgl,line.jenis,line.no_dokumen,line.keterangan,line.nilai,"Pilih"]); 
		}
