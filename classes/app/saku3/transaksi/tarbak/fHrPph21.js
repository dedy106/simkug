window.app_saku3_transaksi_tarbak_fHrPph21 = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_fHrPph21.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_fHrPph21";
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Data Batas Parameter PPh21: Input/Edit", 0);	
...
window.app_saku3_transaksi_tarbak_fHrPph21.extend(window.childForm);
window.app_saku3_transaksi_tarbak_fHrPph21.implement({
