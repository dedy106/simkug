window.app_saku3_transaksi_tarbak_fKb = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_fKb.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_fKb";
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[1,12,995,325], childPage:["Item Jurnal","Data Anggaran","Referensi Jurnal"]});
...
window.app_saku3_transaksi_tarbak_fKb.extend(window.childForm);
window.app_saku3_transaksi_tarbak_fKb.implement({	
