window.app_saku3_transaksi_tarbak_simlog_fUnit = function (owner) {
    if (owner) {
        window.app_saku3_transaksi_tarbak_simlog_fUnit.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_transaksi_tarbak_simlog_fUnit";
        ...
        this.pc1 = new pageControl(this, { bound: [20, 12, 1000, 450], childPage: ["Daftar Unit", "Data Unit", "Filter Cari"] });
        this.sg1 = new saiGrid(this.pc1.childPage[0], {
            bound: [1, 5, this.pc1.width - 5, this.pc1.height - 33], colCount: 3, tag: 9,
            colTitle: ["Kode", "Nama", "Pilih"],
            colWidth: [[0, 1, 2], [100, 350, 100]],
            readOnly: true,
...
window.app_saku3_transaksi_tarbak_simlog_fUnit.extend(window.childForm);
window.app_saku3_transaksi_tarbak_simlog_fUnit.implement({
        ...
        try {
            if (this.standarLib.checkEmptyByTag(this, [0, 1])) {
                try {
                    ...
                    sql.add("insert into fa_lokasi(kode_lok,nama,kode_lokasi) values " +
    ...
    doChange: function (sender) {
        try {
            ...
            if (sender == this.cb_kode && this.cb_kode.getText() != "") {
                var strSQL = "select kode_lok,nama " +
                    "from fa_lokasi where kode_lok ='" + this.cb_kode.getText() + "' and kode_lokasi='" + this.app._lokasi + "'";
    ...
    doCari: function (sender) {
        try {
            if (this.e_kode2.getText() != "") var filter = " kode_lok like '%" + this.e_kode2.getText() + "%' ";
    ...
    doTampilData: function (page) {
        ...
        for (var i = start; i < finish; i++) {
            ...
            this.sg1.appendData([line.kode_lok, line.nama, "Pilih"]);
        }
