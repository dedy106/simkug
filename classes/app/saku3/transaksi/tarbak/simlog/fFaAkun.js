window.app_saku3_transaksi_tarbak_simlog_fFaAkun = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_simlog_fFaAkun.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_simlog_fFaAkun";
...
window.app_saku3_transaksi_tarbak_simlog_fFaAkun.extend(window.childForm);
window.app_saku3_transaksi_tarbak_simlog_fFaAkun.implement({
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1])){
				try{									
					...
					sql.add("insert into fa_klpakun(kode_klpakun,nama,umur,persen,kode_akun,akun_bp,akun_deprs,kode_agg,tahun,kode_drk,kode_lokasi, flag_susut,jenis) values "+
							"('"+this.cb_kode.getText()+"','"+this.e_nama.getText()+"',"+umurBln+","+nilaiToFloat(this.e_persen.getText())+",'"+this.cb_akun.getText()+"','"+this.cb_bp.getText()+"','"+this.cb_deprs.getText()+"','-','-','-','"+this.app._lokasi+"','"+this.c_status.getText().substr(0,1)+"','"+this.c_jenis.getText()+"')");									
					setTipeButton(tbAllFalse);
	...
	doChange: function(sender){
		try{
			if (sender == this.e_umur && this.e_umur.getText() != ""){
				if (nilaiToFloat(this.e_umur.getText()) != 0) var persen = 100 / nilaiToFloat(this.e_umur.getText());
				else var persen = 0;
