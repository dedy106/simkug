window.app_saku3_transaksi_tarbak_simlog_fBast = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_simlog_fBast.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_simlog_fBast";
...
window.app_saku3_transaksi_tarbak_simlog_fBast.extend(window.childForm);
window.app_saku3_transaksi_tarbak_simlog_fBast.implement({	
