window.app_saku3_transaksi_tarbak_simlog_fUser = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_simlog_fUser.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_simlog_fUser";
...
window.app_saku3_transaksi_tarbak_simlog_fUser.extend(window.childForm);
window.app_saku3_transaksi_tarbak_simlog_fUser.implement({
