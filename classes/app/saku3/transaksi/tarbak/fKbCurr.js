window.app_saku3_transaksi_tarbak_fKbCurr = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_fKbCurr.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_fKbCurr";
		...
		this.e_debet = new saiLabelEdit(this.pc2.childPage[0],{bound:[780,12,210,20],caption:"Total Debet (IDR)", tag:1, readOnly:true, tipeText:ttNilai, text:"0"});						
		...
		this.e_kredit = new saiLabelEdit(this.pc2.childPage[0],{bound:[780,16,210,20],caption:"Total Kredit (IDR)", tag:1, readOnly:true, tipeText:ttNilai, text:"0"});				
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[1,12,995,345], childPage:["Data Item Jurnal","Data Anggaran","Referensi Jurnal"]});
...
window.app_saku3_transaksi_tarbak_fKbCurr.extend(window.childForm);
window.app_saku3_transaksi_tarbak_fKbCurr.implement({
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					sql.add("insert into kas_m (no_kas,kode_lokasi,no_dokumen,no_bg,akun_kb,tanggal,keterangan,kode_pp,modul,jenis,periode,kode_curr,kurs,nilai,nik_buat,nik_app,tgl_input,nik_user,posted,no_del,no_link,ref1,kode_bank) values  "+
							"('"+this.e_nb.getText()+"','"+this.app._lokasi+"','-','-','-','"+this.dp_d1.getDateString()+"','"+this.e_ket.getText()+"','-','KBUMCUR','"+this.c_jenis.getText()+"','"+this.e_periode.getText()+"','-','0',"+this.nilaiKB+",'"+this.app._userLog+"','"+this.app._userLog+"',getdate(),'"+this.app._userLog+"','F','-','-','-','-')");
	...
	doDoubleClick3: function(sender, col , row) {
		try{
			if (this.sg3.cells(0,row) != "") {
				...
				var data = this.dbLib.getDataProvider("select a.tanggal,a.periode,a.keterangan,a.jenis "+
						   "from kas_m a "+						   
