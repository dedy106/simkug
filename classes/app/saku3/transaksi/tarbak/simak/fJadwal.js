window.app_saku3_transaksi_tarbak_simak_fJadwal = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_simak_fJadwal.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_simak_fJadwal";
...
window.app_saku3_transaksi_tarbak_simak_fJadwal.extend(window.childForm);
window.app_saku3_transaksi_tarbak_simak_fJadwal.implement({
