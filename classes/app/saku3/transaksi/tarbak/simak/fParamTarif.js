window.app_saku3_transaksi_tarbak_simak_fParamTarif = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_simak_fParamTarif.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_simak_fParamTarif";
...
window.app_saku3_transaksi_tarbak_simak_fParamTarif.extend(window.childForm);
window.app_saku3_transaksi_tarbak_simak_fParamTarif.implement({
