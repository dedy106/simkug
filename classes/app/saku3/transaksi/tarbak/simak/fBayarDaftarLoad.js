window.app_saku3_transaksi_tarbak_simak_fBayarDaftarLoad = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_simak_fBayarDaftarLoad.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_simak_fBayarDaftarLoad";
...
window.app_saku3_transaksi_tarbak_simak_fBayarDaftarLoad.extend(window.childForm);
window.app_saku3_transaksi_tarbak_simak_fBayarDaftarLoad.implement({
