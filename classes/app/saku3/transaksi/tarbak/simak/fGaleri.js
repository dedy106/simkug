window.app_saku3_transaksi_tarbak_simak_fGaleri = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_simak_fGaleri.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_simak_fGaleri";
...
window.app_saku3_transaksi_tarbak_simak_fGaleri.extend(window.childForm);
window.app_saku3_transaksi_tarbak_simak_fGaleri.implement({	
