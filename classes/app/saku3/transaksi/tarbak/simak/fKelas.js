window.app_saku3_transaksi_tarbak_simak_fKelas = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_simak_fKelas.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_simak_fKelas";
...
window.app_saku3_transaksi_tarbak_simak_fKelas.extend(window.childForm);
window.app_saku3_transaksi_tarbak_simak_fKelas.implement({
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1])){
				try{									
					...
					sql.add("insert into sis_kelas(kode_kelas,nama,kode_lokasi,kode_pp,kode_tingkat,kode_jur,flag_aktif) values "+
						    "('"+this.cb_kode.getText()+"','"+this.e_nama.getText()+"','"+this.app._lokasi+"','"+this.cb_pp.getText()+"','"+this.cb_tingkat.getText()+"','"+this.cb_jur.getText()+"','1')");										
					setTipeButton(tbAllFalse);
