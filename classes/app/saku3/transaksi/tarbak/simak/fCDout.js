window.app_saku3_transaksi_tarbak_simak_fCDout = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_simak_fCDout.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_simak_fCDout";
...
window.app_saku3_transaksi_tarbak_simak_fCDout.extend(window.childForm);
window.app_saku3_transaksi_tarbak_simak_fCDout.implement({
