window.app_saku3_transaksi_tarbak_simak_fSiswaDapodik = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_simak_fSiswaDapodik.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_simak_fSiswaDapodik";
		...
		this.pc1 = new pageControl(this,{bound:[20,12,1000,420], childPage:["Daftar Siswa","Data Keluarga","Data Siswa","Filter Cari"]});
		...
		this.e_nama = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,11,450,20],caption:"Nama", maxLength:50, tag:1,change:[this,"doChange"]});	
		...
		this.e_nipd = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,28,220,20],caption:"NIPD", maxLength:50, tag:1});								
		this.e_nisn = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,29,220,20],caption:"NISN", maxLength:50, tag:1});								
		this.e_nik = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,30,220,20],caption:"NIK", maxLength:50, tag:1});		
		this.e_noakta = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,40,220,20],caption:"NO. Akta", maxLength:50, tag:1});								
		this.e_tmplahir = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,16,220,20],caption:"Tempat Lahir", maxLength:50, tag:1});
		this.l_tgl = new portalui_label(this.pc1.childPage[1],{bound:[250,16,100,18],caption:"Tgl Lahir", labelWidth:200, underline:true});
		this.dp_d1 = new portalui_datePicker(this.pc1.childPage[1],{bound:[350,16,118,18],selectDate:[this,"doSelectDate"],date:new Date().getDateStr()});	
		this.c_jk = new saiCB(this.pc1.childPage[1],{bound:[20,15,220,20],caption:"Jenis Kelamin",items:["LAKI-LAKI","PEREMPUAN"], readOnly:true,tag:2});
		this.c_agama = new saiCB(this.pc1.childPage[1],{bound:[20,17,220,20],caption:"Agama",items:["ISLAM","KRISTEN","BUDHA","HINDU","KHONGHUCU"], readOnly:true,tag:2});
		this.e_tlpsiswa = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,25,220,20],caption:"Telp Siswa", maxLength:50, tag:1});								
		this.e_hpsiswa = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,26,220,20],caption:"HP Siswa", maxLength:50, tag:1});
		this.e_email = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,27,450,20],caption:"Email Siswa", maxLength:50, tag:1});	
		this.e_alamat = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,18,450,20],caption:"Alamat Siswa", maxLength:200, tag:1});
		this.e_rt = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,19,220,20],caption:"RT", maxLength:200, tag:1});
		this.e_rw = new saiLabelEdit(this.pc1.childPage[1],{bound:[250,19,220,20],caption:"RW", maxLength:200, tag:1});
		this.e_kel = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,20,220,20],caption:"Kelurahan", maxLength:200, tag:1});
		this.e_kec = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,40,220,20],caption:"Kecamatan", maxLength:200, tag:1});
		this.e_kpos = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,21,220,20],caption:"Kode Pos", maxLength:200, tag:1});
		this.e_tinggal = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,23,220,20],caption:"Jenis Tinggal", maxLength:200, tag:1})
		this.e_trans = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,24,220,20],caption:"Alat Transport", maxLength:200, tag:1})
		this.e_sekasal= new saiLabelEdit(this.pc1.childPage[1],{bound:[20,43,220,20],caption:"Sekolah Asal", maxLength:50, tag:1});	
        this.e_skhun = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,34,220,20],caption:"SKHUN", maxLength:50, tag:1});		
        this.e_pun = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,45,220,20],caption:"No Peserta Ujian", maxLength:50, tag:1});
        this.e_seriijazah = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,44,220,20],caption:"No Seri Ijazah", maxLength:50, tag:1});						
		this.c_kps = new saiCB(this.pc1.childPage[1],{bound:[20,35,220,20],caption:"Penerima KIP",items:["YA","TIDAK"], readOnly:true,tag:2});
		this.e_nokps = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,36,220,20],caption:"NO KPS", maxLength:50, tag:1});		
		this.e_nokip = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,37,220,20],caption:"NO KIP", maxLength:50, tag:1});		
		this.e_namakip = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,45,220,20],caption:"Nama KIP", maxLength:50, tag:1});	
        this.c_pip = new saiCB(this.pc1.childPage[1],{bound:[20,41,220,20],caption:"Layak PIP",items:["YA","TIDAK"], readOnly:true,tag:2});	
        this.e_alasanpip = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,410,220,20],caption:"Alasan PIP", maxLength:50, tag:1});			
		this.c_kebk = new saiCB(this.pc1.childPage[1],{bound:[20,42,220,20],caption:"Kebutuhan Khusus",items:["YA","TIDAK"], readOnly:true,tag:2});						
        ...
        this.e_nikayah = new saiLabelEdit(this.pc1.childPage[2],{bound:[20,18,400,20],caption:"NIK Ayah", maxLength:50, tag:1});
        this.e_nikibu = new saiLabelEdit(this.pc1.childPage[2],{bound:[500,18,400,20],caption:"NIK Ibu", maxLength:50, tag:1});
		this.e_thnlahirayah = new saiLabelEdit(this.pc1.childPage[2],{bound:[20,13,200,20],caption:"Th. Lahir Ayah", maxLength:50, tag:1});
		this.e_thnlahiribu = new saiLabelEdit(this.pc1.childPage[2],{bound:[500,13,200,20],caption:"Th. Lahir Ibu", maxLength:50, tag:1});
        ...
        this.e_namawali = new saiLabelEdit(this.pc1.childPage[2],{bound:[20,19,400,20],caption:"Nama Wali", maxLength:50, tag:1});
        this.e_nikwali = new saiLabelEdit(this.pc1.childPage[2],{bound:[20,22,400,20],caption:"NIK Wali", maxLength:50, tag:1});
		this.e_thnlahirwali = new saiLabelEdit(this.pc1.childPage[2],{bound:[20,23,200,20],caption:"Th. Lahir Wali", maxLength:50, tag:1});
		this.c_pddwali = new saiCB(this.pc1.childPage[2],{bound:[20,24,200,20],caption:"Pdd Wali",items:["D3","S1","S2","S3","SMA"], readOnly:true,tag:2});
		this.c_kerjawali = new saiCB(this.pc1.childPage[2],{bound:[20,25,200,20],caption:"Pekerjaan Wali",items:["PNS","Pegawai Swasta","Wiraswasta"], readOnly:true,tag:2});
		this.e_hasilwali = new saiLabelEdit(this.pc1.childPage[2],{bound:[20,26,200,20],caption:"Penghasilan Wali", maxLength:50, tag:1,tipeText:ttNilai, text:"0"});
		...
		this.e_kode2 = new saiLabelEdit(this.pc1.childPage[3],{bound:[20,10,200,20],caption:"NIS",maxLength:30,tag:9});		
...
window.app_saku3_transaksi_tarbak_simak_fSiswaDapodik.extend(window.childForm);
window.app_saku3_transaksi_tarbak_simak_fSiswaDapodik.implement({
