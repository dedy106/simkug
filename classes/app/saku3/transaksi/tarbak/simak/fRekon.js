window.app_saku3_transaksi_tarbak_simak_fRekon = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_simak_fRekon.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_simak_fRekon";
...
window.app_saku3_transaksi_tarbak_simak_fRekon.extend(window.childForm);
window.app_saku3_transaksi_tarbak_simak_fRekon.implement({
