window.app_saku3_transaksi_tarbak_simak_fCDinReg = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_simak_fCDinReg.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_simak_fCDinReg";
...
window.app_saku3_transaksi_tarbak_simak_fCDinReg.extend(window.childForm);
window.app_saku3_transaksi_tarbak_simak_fCDinReg.implement({
