window.app_saku3_transaksi_tarbak_simak_fCDoutReg = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_simak_fCDoutReg.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_simak_fCDoutReg";
		this.itemsValue = new arrayList();
		this.maximize();	
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Pengembalian PDD Siswa Baru", 0);	
		...
		this.pc2 = new pageControl(this,{bound:[10,10,1000,420], childPage:["Detail NonCash","List Bukti"]});		
		...
		this.e_nc = new saiLabelEdit(this.pc2.childPage[0],{bound:[780,17,200,20],caption:"Nilai NonCash", tag:1, readOnly:true, tipeText:ttNilai, text:"0",change:[this,"doChange"]});						
		...
		this.e_total = new saiLabelEdit(this.pc2.childPage[0],{bound:[780,16,200,20],caption:"Total", tag:1, readOnly:true, tipeText:ttNilai, text:"0"});						
		
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[1,10,995,249], childPage:["Data PDD NonCash"]});		
		this.sg = new saiGrid(this.pc1.childPage[0],{bound:[1,5,this.pc1.width-5,this.pc1.height-35],colCount:4,tag:9,
					...
					colWidth:[[3,2,1,0],[100,60,400,110]],
...
window.app_saku3_transaksi_tarbak_simak_fCDoutReg.extend(window.childForm);
window.app_saku3_transaksi_tarbak_simak_fCDoutReg.implement({
