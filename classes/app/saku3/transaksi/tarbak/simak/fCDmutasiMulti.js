window.app_saku3_transaksi_tarbak_simak_fCDmutasiMulti = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_simak_fCDmutasiMulti.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_simak_fCDmutasiMulti";
...
window.app_saku3_transaksi_tarbak_simak_fCDmutasiMulti.extend(window.childForm);
window.app_saku3_transaksi_tarbak_simak_fCDmutasiMulti.implement({
