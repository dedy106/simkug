window.app_saku3_transaksi_tarbak_simak_fKalAkad = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_simak_fKalAkad.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_simak_fKalAkad";
...
window.app_saku3_transaksi_tarbak_simak_fKalAkad.extend(window.childForm);
window.app_saku3_transaksi_tarbak_simak_fKalAkad.implement({
