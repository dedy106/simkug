window.app_saku3_transaksi_tarbak_simak_fPresensi = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_simak_fPresensi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_simak_fPresensi";
...
window.app_saku3_transaksi_tarbak_simak_fPresensi.extend(window.childForm);
window.app_saku3_transaksi_tarbak_simak_fPresensi.implement({
