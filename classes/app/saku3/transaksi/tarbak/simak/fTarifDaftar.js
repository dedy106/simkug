window.app_saku3_transaksi_tarbak_simak_fTarifDaftar = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_simak_fTarifDaftar.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_simak_fTarifDaftar";
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Data Tarif Pendaftaran Siswa Baru", 0);	
		
		uses("portalui_uploader;saiCBBL;saiEdit;datePicker;saiGrid;sgNavigator;pageControl;checkBox");
		uses("saiGrid",true);	

		this.cb_pp = new portalui_saiCBBL(this,{bound:[20,10,220,20],caption:"Sekolah", multiSelection:false, readOnly:true, tag:2,change:[this,"doChange"]});
		...
		try {
			...
			this.cb_pp.setSQL("select a.kode_pp, a.nama from pp a inner join karyawan_pp b on a.kode_pp=b.kode_pp and b.nik='"+this.app._userLog+"' and a.kode_lokasi=b.kode_lokasi where a.kode_lokasi='"+this.app._lokasi+"' ",["kode_pp","nama"],false,["Kode","Nama"],"and","Data PP",true);
...
window.app_saku3_transaksi_tarbak_simak_fTarifDaftar.extend(window.childForm);
window.app_saku3_transaksi_tarbak_simak_fTarifDaftar.implement({
	...
	doChange: function(sender){
		try{
			if (sender == this.cb_pp && this.cb_pp.getText()!="") {
				this.cb_ta.setSQL("select kode_ta, nama from sis_ta where flag_aktif='1' and kode_pp='"+this.cb_pp.getText()+"' and kode_lokasi='"+this.app._lokasi+"' ",["kode_ta","nama"],false,["Kode","Nama"],"and","Data TA",true);
			}
	...
	doLoad:function(sender){								
		var strSQL = "select b.kode_ta, b.nama, a.tarif from sis_tarif_daftar a inner join sis_ta b on a.kode_ta=b.kode_ta and a.kode_lokasi=b.kode_lokasi and a.kode_pp=b.kode_pp and b.flag_aktif='1' "+
					 "where b.kode_lokasi='"+this.app._lokasi+"' and b.kode_pp='"+this.app._kodePP+"' order by a.kode_ta desc";		
		var data = this.dbLib.getDataProvider(strSQL,true);		
