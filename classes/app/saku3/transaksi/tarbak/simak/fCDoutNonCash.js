window.app_saku3_transaksi_tarbak_simak_fCDoutNonCash = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_simak_fCDoutNonCash.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_simak_fCDoutNonCash";
		this.itemsValue = new arrayList();
		this.maximize();	
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Pengeluaran PDD Siswa Non Cash (Pdpt)", 0);	
		...
		this.e_nilai = new saiLabelEdit(this.pc2.childPage[0],{bound:[20,16,200,20],caption:"Nilai Selesai", tag:1, tipeText:ttNilai, text:"0"});				
...
window.app_saku3_transaksi_tarbak_simak_fCDoutNonCash.extend(window.childForm);
window.app_saku3_transaksi_tarbak_simak_fCDoutNonCash.implement({
