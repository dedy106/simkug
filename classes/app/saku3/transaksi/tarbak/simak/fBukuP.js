window.app_saku3_transaksi_tarbak_simak_fBukuP = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_simak_fBukuP.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_simak_fBukuP";
		...
		this.cb_pp = new portalui_saiCBBL(this,{bound:[20,10,220,20],caption:"Sekolah",tag:2,readOnly:true, change:[this,"doChange"]});	
		...
		this.cb_akt = new portalui_saiCBBL(this,{bound:[20,21,220,20],caption:"Angkatan",multiSelection:false,tag:2});			
		this.cb_kelas = new portalui_saiCBBL(this,{bound:[20,21,220,20],caption:"Kelas",multiSelection:false,tag:2});	
		this.cb_nis = new portalui_saiCBBL(this,{bound:[20,21,220,20],caption:"NIS",multiSelection:false,tag:1,change:[this,"doChange"]});			
		
		this.e_memo = new saiMemo(this,{bound:[20,5,550,150],caption:"Pesan",tag:1});
...
window.app_saku3_transaksi_tarbak_simak_fBukuP.extend(window.childForm);
window.app_saku3_transaksi_tarbak_simak_fBukuP.implement({
		...
		try{						
			if (this.standarLib.checkEmptyByTag(this, [0,1])){
				try{									
					...
					sql.add("insert into sis_bp(no_bukti,jenis,kode_akt,kode_kelas,nis,keterangan,tanggal,nik_user,kode_pp,kode_lokasi,tgl_input,kode_matpel) values "+
						    "	('"+this.e_nb.getText()+"','"+this.c_jenis.getText()+"','"+this.cb_akt.getText()+"','"+this.cb_kelas.getText()+"','"+this.cb_nis.getText()+"','"+this.e_memo.getText()+"','"+this.dp_d1.getDateString()+"','"+this.app._userLog+"','"+this.app._kodePP+"','"+this.app._lokasi+"',getdate(),'"+this.cb_matpel.getText()+"')");
					setTipeButton(tbAllFalse);
