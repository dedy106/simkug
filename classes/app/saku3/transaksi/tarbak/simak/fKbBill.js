window.app_saku3_transaksi_tarbak_simak_fKbBill = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_simak_fKbBill.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_simak_fKbBill";
...
window.app_saku3_transaksi_tarbak_simak_fKbBill.extend(window.childForm);
window.app_saku3_transaksi_tarbak_simak_fKbBill.implement({
