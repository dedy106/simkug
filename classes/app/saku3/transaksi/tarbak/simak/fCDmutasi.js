window.app_saku3_transaksi_tarbak_simak_fCDmutasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_simak_fCDmutasi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_simak_fCDmutasi";
...
window.app_saku3_transaksi_tarbak_simak_fCDmutasi.extend(window.childForm);
window.app_saku3_transaksi_tarbak_simak_fCDmutasi.implement({
