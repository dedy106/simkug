window.app_saku3_transaksi_tarbak_simak_fInfoSekolah = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_simak_fInfoSekolah.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_simak_fInfoSekolah";
...
window.app_saku3_transaksi_tarbak_simak_fInfoSekolah.extend(window.childForm);
window.app_saku3_transaksi_tarbak_simak_fInfoSekolah.implement({	
