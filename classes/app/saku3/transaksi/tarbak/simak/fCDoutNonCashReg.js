window.app_saku3_transaksi_tarbak_simak_fCDoutNonCashReg = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_simak_fCDoutNonCashReg.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_simak_fCDoutNonCashReg";
...
window.app_saku3_transaksi_tarbak_simak_fCDoutNonCashReg.extend(window.childForm);
window.app_saku3_transaksi_tarbak_simak_fCDoutNonCashReg.implement({
