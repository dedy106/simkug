window.app_saku3_transaksi_tarbak_simak_fAngkatan = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_simak_fAngkatan.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_simak_fAngkatan";
...
window.app_saku3_transaksi_tarbak_simak_fAngkatan.extend(window.childForm);
window.app_saku3_transaksi_tarbak_simak_fAngkatan.implement({
