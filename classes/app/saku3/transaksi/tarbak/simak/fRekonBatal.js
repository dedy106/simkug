window.app_saku3_transaksi_tarbak_simak_fRekonBatal = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_simak_fRekonBatal.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_simak_fRekonBatal";
...
window.app_saku3_transaksi_tarbak_simak_fRekonBatal.extend(window.childForm);
window.app_saku3_transaksi_tarbak_simak_fRekonBatal.implement({
