window.app_saku3_transaksi_tarbak_simak_fBankVA = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_simak_fBankVA.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_simak_fBankVA";
...
window.app_saku3_transaksi_tarbak_simak_fBankVA.extend(window.childForm);
window.app_saku3_transaksi_tarbak_simak_fBankVA.implement({
		...
		try{						
			if (this.standarLib.checkEmptyByTag(this, [0,1])){
				try{									
					...
					sql.add("insert into sis_bankva(kode_bank,kode_lokasi,dig_awal,dig_jum,flag_aktif,kode_pp,nama,kode_akun) values "+
						    "('"+this.cb_kode.getText()+"','"+this.app._lokasi+"','"+this.e_digawal.getText()+"','"+this.e_digjum.getText()+"','"+vSts+"','"+this.app._kodePP+"','"+this.e_nama.getText()+"','"+this.cb_akun.getText()+"')");					
					setTipeButton(tbAllFalse);
