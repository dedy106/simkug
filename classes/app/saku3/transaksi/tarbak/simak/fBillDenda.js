window.app_saku3_transaksi_tarbak_simak_fBillDenda = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_simak_fBillDenda.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_simak_fBillDenda";
...
window.app_saku3_transaksi_tarbak_simak_fBillDenda.extend(window.childForm);
window.app_saku3_transaksi_tarbak_simak_fBillDenda.implement({
