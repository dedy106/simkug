window.app_saku3_transaksi_tarbak_simak_fSiswaMigrasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_simak_fSiswaMigrasi.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku3_transaksi_tarbak_simak_fSiswaMigrasi";
...
window.app_saku3_transaksi_tarbak_simak_fSiswaMigrasi.extend(window.portalui_childForm);
window.app_saku3_transaksi_tarbak_simak_fSiswaMigrasi.implement({	
