window.app_saku3_transaksi_tarbak_simak_fCDin = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_simak_fCDin.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_simak_fCDin";
...
window.app_saku3_transaksi_tarbak_simak_fCDin.extend(window.childForm);
window.app_saku3_transaksi_tarbak_simak_fCDin.implement({
