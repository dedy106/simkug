window.app_saku3_transaksi_tarbak_simak_fSiswaReg = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_simak_fSiswaReg.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_simak_fSiswaReg";
...
window.app_saku3_transaksi_tarbak_simak_fSiswaReg.extend(window.childForm);
window.app_saku3_transaksi_tarbak_simak_fSiswaReg.implement({
