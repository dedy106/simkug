window.app_saku3_transaksi_tarbak_simak_fRekBillCD = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_simak_fRekBillCD.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_simak_fRekBillCD";
		...
		this.pc1 = new pageControl(this,{bound:[5,12,1000,330], childPage:["Daftar Parameter","Data Tagihan","Data PDD"]});
		this.sg2 = new saiGrid(this.pc1.childPage[0],{bound:[0,5,this.pc1.width-5,this.pc1.height-10],colCount:3,tag:9,
		...
		this.sg1 = new portalui_saiGrid(this.pc1.childPage[2],{bound:[1,5,this.pc1.width-5,this.pc1.height-35],colCount:2,
...
window.app_saku3_transaksi_tarbak_simak_fRekBillCD.extend(window.childForm);
window.app_saku3_transaksi_tarbak_simak_fRekBillCD.implement({
		...
		switch (event){
			...
			case "simpan" :	
				...
				if (this.dp_d1.getText().substr(0,2) != "01") {
					system.alert(this,"Transaksi tidak valid.","Tanggal Rekonsiliasi harus di tanggal 01.");
					return false;						
				}
