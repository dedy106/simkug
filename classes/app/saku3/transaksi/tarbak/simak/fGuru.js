window.app_saku3_transaksi_tarbak_simak_fGuru = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_simak_fGuru.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_simak_fGuru";
		...
		this.pc1 = new pageControl(this,{bound:[20,12,1000,440], childPage:["Daftar Guru Matpel","Data Guru Matpel"]});				
		...
		this.cb_nik = new portalui_saiCBBL(this.pc1.childPage[1],{bound:[20,12,220,20],caption:"NIK Guru",multiSelection:false,tag:1,change:[this,"doChange"]});		
		...
		this.pc2 = new pageControl(this.pc1.childPage[1],{bound:[1,12,995,361], childPage:["Data Mata Pelajaran"]});		
		this.sg = new saiGrid(this.pc2.childPage[0],{bound:[1,5,this.pc2.width-5,this.pc2.height-33],colCount:4,tag:0,
...
window.app_saku3_transaksi_tarbak_simak_fGuru.extend(window.childForm);
window.app_saku3_transaksi_tarbak_simak_fGuru.implement({
		...
		try{						
			if (this.standarLib.checkEmptyByTag(this, [0,1])){
				try{									
					...
					sql.add("delete from sis_guru_matpel where nik = '"+this.cb_nik.getText()+"' and kode_pp='"+this.app._kodePP+"' and kode_lokasi='"+this.app._lokasi+"'");						
