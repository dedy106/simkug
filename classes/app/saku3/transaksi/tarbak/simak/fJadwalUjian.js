window.app_saku3_transaksi_tarbak_simak_fJadwalUjian = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_simak_fJadwalUjian.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_simak_fJadwalUjian";
...
window.app_saku3_transaksi_tarbak_simak_fJadwalUjian.extend(window.childForm);
window.app_saku3_transaksi_tarbak_simak_fJadwalUjian.implement({
