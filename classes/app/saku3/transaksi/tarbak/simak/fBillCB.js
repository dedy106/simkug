window.app_saku3_transaksi_tarbak_simak_fBillCB = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tarbak_simak_fBillCB.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tarbak_simak_fBillCB";
...
window.app_saku3_transaksi_tarbak_simak_fBillCB.extend(window.childForm);
window.app_saku3_transaksi_tarbak_simak_fBillCB.implement({
