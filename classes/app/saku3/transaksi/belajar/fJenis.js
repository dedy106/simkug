window.app_saku3_transaksi_belajar_fJenis = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_belajar_fJenis.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_belajar_fJenis";
...
window.app_saku3_transaksi_belajar_fJenis.extend(window.childForm);
window.app_saku3_transaksi_belajar_fJenis.implement({
