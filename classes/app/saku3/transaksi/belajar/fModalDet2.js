window.app_saku3_transaksi_belajar_fModalDet2 = function(owner,modul)
{
	if (owner)
	{
		window.app_saku3_transaksi_belajar_fModalDet2.prototype.parent.constructor.call(this, owner);
		window.app_saku3_transaksi_belajar_fModalDet2.prototype.parent.setWidth.call(this, 300);
		window.app_saku3_transaksi_belajar_fModalDet2.prototype.parent.setHeight.call(this, 400);
		
		this.centerize();
		
		this.className = "app_saku3_transaksi_belajar_fModalDet2";
		
		this.mouseX = 0;
		this.mouseY = 0;			
		
		this.p1 = new panel(this,{bound:[20,10,this.width - 40,this.height - 100], borderStyle:2});						
		// this.e0 = new saiLabelEdit(this.p1,{bound:[20,11,150,20],caption:"Kode Akun"});				
		// this.e1 = new saiLabelEdit(this.p1,{bound:[20,12,300,20],caption:"Nama Akun"});						
		// this.e2 = new saiCB(this.p1,{bound:[20,13,220,20], caption:"Level Lap",items:["1","2","3"] });				
		// this.e3 = new saiCB(this.p1,{bound:[20,14,220,20], caption:"Tipe", items:["Summary","Header","Posting","SumPosted","Spasi"]});				
		// this.e4 = new saiCB(this.p1,{bound:[20,15,220,20], caption:"SumHeader",items:["1","-"]});				
        // this.e5 = new saiCB(this.p1,{bound:[20,16,220,20], caption:"Akun",items:["Neraca","Labarugi"]});
        
        this.cb_kode = new saiLabelEdit(this.p1,{bound:[20,10,200,20],caption:"Kode",maxLength:10,tag:1});
        this.e_nama = new saiLabelEdit(this.p1,{bound:[20,11,300,20],caption:"Nama", maxLength:50, tag:1});
		this.e_modul = new saiLabelEdit(this.p1,{bound:[20,12,200,20],caption:"Modul",maxLength:10, tag:1});
		this.c_format = new saiCB(this.p1,{bound:[20,13,200,20],caption:"Format Nominal",items:["Satuan","Ribuan","Jutaan"], readOnly:true,tag:2});
        this.cb_fs = new saiCB(this.p1,{bound:[20,14,220,20],caption:"Kode FS",multiSelection:false,items:["FS1"], readOnly:true,tag:2});					
...
window.app_saku3_transaksi_belajar_fModalDet2.extend(window.commonForm);
window.app_saku3_transaksi_belajar_fModalDet2.implement({
	...
	doSysMouseDown: function(x, y, button, buttonState){	
		window.app_saku3_transaksi_belajar_fModalDet2.prototype.parent.doSysMouseDown.call(this,x, y, button, buttonState);
	},
	doSysMouseUp: function(x, y, button, buttonState){	
		window.app_saku3_transaksi_belajar_fModalDet2.prototype.parent.doSysMouseUp.call(this,x, y, button, buttonState);
	},
	doSysMouseMove: function(x, y, button, buttonState){
		window.app_saku3_transaksi_belajar_fModalDet2.prototype.parent.doSysMouseMove.call(this,x, y, button, buttonState);
		if (this.isClick)
		{		
	...
	doClick: function(sender){
		...
		var value = this.cb_kode.getText() + ";" + this.e_nama.getText() +";"+ this.e_modul.getText();
		value += ";"+this.c_format.getText() + ";" + this.cb_fs.getText();
		value += ";" + "Edit" + ";" + "Hapus";
