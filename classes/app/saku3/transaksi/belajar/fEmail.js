window.app_saku3_transaksi_belajar_fEmail = function (owner) {
    if (owner) {
        window.app_saku3_transaksi_belajar_fEmail.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_transaksi_belajar_fEmail";
        this.maximize();
...
window.app_saku3_transaksi_belajar_fEmail.extend(window.childForm);
window.app_saku3_transaksi_belajar_fEmail.implement({
    doLoad: function () {
        try {
            ...
            var nama_report = "server_report_saku3_belajar_rptEmail";
            this.filter = "";
            this.showFilter = "";
            this.lokasi = "";
