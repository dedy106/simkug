window.app_saku3_transaksi_belajar_fRekBank= function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_belajar_fRekBank.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_belajar_fRekBank";
        ...
        this.e_nama = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,13,300,20],caption:"Nama Rek", maxLength:50, tag:1});	
        this.e_norek = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,14,200,20],caption:"Nomor Rek", maxLength:50, tag:1});	
        this.e_nama2 = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,15,300,20],caption:"Nama", maxLength:50, tag:1});	
        this.cb_bank = new saiCBBL(this.pc1.childPage[1],{bound:[20,16,220,20],caption:"Kode Bank", multiSelection:false, maxLength:10});			
        this.e_cabang = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,17,300,20],caption:"Cabang", maxLength:50, tag:1});	
...
window.app_saku3_transaksi_belajar_fRekBank.extend(window.childForm);
window.app_saku3_transaksi_belajar_fRekBank.implement({
