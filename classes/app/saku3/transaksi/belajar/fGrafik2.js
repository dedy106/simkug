window.app_saku3_transaksi_belajar_fGrafik2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_belajar_fGrafik2.prototype.parent.constructor.call(this,owner);
		this.maximize();		
		
		this.className  = "app_saku3_transaksi_belajar_fGrafik2";
...
window.app_saku3_transaksi_belajar_fGrafik2.extend(window.childForm);
window.app_saku3_transaksi_belajar_fGrafik2.implement({
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1])){
					...
					for (var i=0;i < this.sg2.getRowCount();i++){
						if (this.sg2.rowValid(i)) { 
							sql.add("insert into db_grafik_d(kode_grafik,kode_lokasi,kode_neraca,kode_fs,nu,nama) values ('"+this.cb_kode.getText()+"','"+this.app._lokasi+"','"+this.sg2.cells(0,i)+"','"+this.cb_fs.getText()+"',"+nu+",'"+this.sg2.cells(1,i)+"')");
							nu++;
						}
					}							
			...
			if (sender == this.cb_kode && this.cb_kode.getText() != ""){
				...
				if (typeof data == "object"){
					...
					if (line != undefined){						
						...
						var strSQL = "select a.kode_grafik, a.kode_neraca,b.nama as nama_nrc ,a.kode_fs,c.nama as nama_fs, a.nama "+
                                     "from db_grafik_d a "+
						...
						if (typeof data == "object" && data.rs.rows[0] != undefined){
							...
							for (var i in data.rs.rows){
								line = data.rs.rows[i];							
								this.sg2.appendData([line.kode_neraca,line.nama]);
							}
