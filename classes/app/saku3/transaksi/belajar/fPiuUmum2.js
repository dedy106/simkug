window.app_saku3_transaksi_belajar_fPiuUmum2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_belajar_fPiuUmum2.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_belajar_fPiuUmum2";
		...
		this.e_nb2 = new portalui_saiLabelEdit(this.pc2.childPage[2],{bound:[20,16,200,20],caption:"No Bukti",maxLength:30});
		this.e_dok2 = new saiLabelEdit(this.pc2.childPage[2],{bound:[20,17,450,20],caption:"No Dokumen", maxLength:50});
		this.bLoad = new button(this.pc2.childPage[2],{bound:[120,11,80,18],caption:"Cari Data",click:[this,"doCari"]});
...
window.app_saku3_transaksi_belajar_fPiuUmum2.extend(window.childForm);
window.app_saku3_transaksi_belajar_fPiuUmum2.implement({
	...
	doCari:function(sender){								
		try {
			if (this.e_nb2.getText() != "") {
				var filter = " a.no_piutang like '%"+this.e_nb2.getText()+"%' ";
			}
			if (this.e_dok2.getText() != "") {
				var filter = filter + " a.no_dokumen like '%"+this.e_dok2.getText()+"%' ";
			}
			//if (this.cb_jur2.getText() != "") {
			//	var filter = filter + " kode_jur like '%"+this.cb_jur2.getText()+"%' ";
			//}
	...
	doDoubleClick3: function(sender, col , row) {
		try{
			if (this.sg3.cells(0,row) != "") {
				...
				var strSQL = "select a.tanggal,a.periode,a.no_dokumen,a.keterangan,a.kode_pp,a.akun_piutang,a.nik_app,a.kode_cust,c.nama as nama_cust,nilai_ppn "+						 
