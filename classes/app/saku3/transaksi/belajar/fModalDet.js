window.app_saku3_transaksi_belajar_fModalDet = function(owner,modul)
{
	if (owner)
	{
		window.app_saku3_transaksi_belajar_fModalDet.prototype.parent.constructor.call(this, owner);
		window.app_saku3_transaksi_belajar_fModalDet.prototype.parent.setWidth.call(this, 300);
		window.app_saku3_transaksi_belajar_fModalDet.prototype.parent.setHeight.call(this, 400);
		
		this.centerize();
		
		this.className = "app_saku3_transaksi_belajar_fModalDet";
...
window.app_saku3_transaksi_belajar_fModalDet.extend(window.commonForm);
window.app_saku3_transaksi_belajar_fModalDet.implement({
	...
	doSysMouseDown: function(x, y, button, buttonState){	
		window.app_saku3_transaksi_belajar_fModalDet.prototype.parent.doSysMouseDown.call(this,x, y, button, buttonState);
	},
	doSysMouseUp: function(x, y, button, buttonState){	
		window.app_saku3_transaksi_belajar_fModalDet.prototype.parent.doSysMouseUp.call(this,x, y, button, buttonState);
	},
	doSysMouseMove: function(x, y, button, buttonState){
		window.app_saku3_transaksi_belajar_fModalDet.prototype.parent.doSysMouseMove.call(this,x, y, button, buttonState);
		if (this.isClick)
		{		
