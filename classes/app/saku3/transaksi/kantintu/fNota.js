window.app_saku3_transaksi_kantintu_fNota = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_kantintu_fNota.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_kantintu_fNota";
...
window.app_saku3_transaksi_kantintu_fNota.extend(window.childForm);
window.app_saku3_transaksi_kantintu_fNota.implement({
