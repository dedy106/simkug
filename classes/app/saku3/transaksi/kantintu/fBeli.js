window.app_saku3_transaksi_kantintu_fBeli = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_kantintu_fBeli.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_kantintu_fBeli";
		...
		this.sg3 = new saiGrid(this.pc2.childPage[1],{bound:[1,5,this.pc2.width-5,this.pc2.height-30],colCount:3,tag:9,
		            colTitle:["No Bukti","Tanggal","Dokumen"],
		...
		this.e_nilai = new saiLabelEdit(this.pc2.childPage[0],{bound:[710,12,200,20],caption:"Total", tag:1, readOnly:true, tipeText:ttNilai, text:"0"});		
		this.e_dok = new portalui_saiLabelEdit(this.pc2.childPage[0],{bound:[20,13,300,20],caption:"No Dokumen", maxLength:100});				
		this.e_diskon = new saiLabelEdit(this.pc2.childPage[0],{bound:[710,13,200,20],caption:"Diskon", tag:1, tipeText:ttNilai, text:"0",change:[this,"doChange"]});				
		this.l_tg2 = new portalui_label(this.pc2.childPage[0],{bound:[20,14,100,18],caption:"Due Date", underline:true});
		this.dp_d2 = new portalui_datePicker(this.pc2.childPage[0],{bound:[120,14,98,18]});		
		this.e_ppn = new saiLabelEdit(this.pc2.childPage[0],{bound:[710,14,200,20],caption:"Nilai PPN", tag:1, tipeText:ttNilai, text:"0",change:[this,"doChange"]});		
		this.cb_vendor = new portalui_saiCBBL(this.pc2.childPage[0],{bound:[20,15,220,20],caption:"Vendor",multiSelection:false,tag:1});
		this.e_mat = new saiLabelEdit(this.pc2.childPage[0],{bound:[710,15,200,20],caption:"Materai", tag:1, tipeText:ttNilai, text:"0",change:[this,"doChange"]});		
		this.cb_gudang = new portalui_saiCBBL(this.pc2.childPage[0],{bound:[20,16,220,20],caption:"Gudang",multiSelection:false,tag:1});
		this.e_total = new saiLabelEdit(this.pc2.childPage[0],{bound:[710,16,200,20],caption:"Total+", tag:1, readOnly:true, tipeText:ttNilai, text:"0"});		
		
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[5,12,990,280], childPage:["Data Item Barang"]});		
		this.sg = new saiGrid(this.pc1.childPage[0],{bound:[1,5,this.pc1.width-5,this.pc1.height-35],colCount:8,tag:0,
		            colTitle:["Kode","Nama Barang","Satuan","Harga","Jumlah","Bonus","Tot Diskon","SubTtl"],					
					colWidth:[[7,6,5,4,3,2,1,0],[100,100,60,60,100,60,200,200]],					
...
window.app_saku3_transaksi_kantintu_fBeli.extend(window.portalui_childForm);
window.app_saku3_transaksi_kantintu_fBeli.implement({	
		...
		try{								
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{									
					...
					sql.add("insert into kli_beli_m(no_beli,kode_lokasi,tanggal,due_date,no_dokumen,keterangan,kode_pp,periode,nik_user,tgl_input,nilai,nilai_ppn,nilai_diskon,nilai_mat,kode_vendor,no_kas,posted,modul,akun_hutang) values "+
						    "('"+this.e_nb.getText()+"','"+this.app._lokasi+"','"+this.dp_d1.getDateString()+"','"+this.dp_d2.getDateString()+"','"+this.e_dok.getText()+"','Pembelian No :"+this.e_dok.getText()+"','"+this.cb_gudang.getText()+"','"+this.e_periode.getText()+"','"+this.app._userLog+"',getdate(),"+nilaiToFloat(this.e_total.getText())+","+nilaiToFloat(this.e_ppn.getText())+","+nilaiToFloat(this.e_diskon.getText())+","+nilaiToFloat(this.e_mat.getText())+",'"+this.cb_vendor.getText()+"','-','F','NON','"+this.akunHutang+"')");
						...
						for (var i=0;i < this.sg.getRowCount();i++){
							if (this.sg.rowValid(i)){															
								...
								sql.add("insert into kli_beli_d (no_beli,kode_lokasi,periode,nu,kode_obat,kode_pp,satuan,jumlah,bonus,harga,diskon,tot_diskon,total) values "+  
									   "('"+this.e_nb.getText()+"','"+this.app._lokasi+"','"+this.e_periode.getText()+"',"+i+",'"+this.sg.cells(0,i)+"','"+this.app._kodePP+"','"+this.sg.cells(2,i)+"',"+nilaiToFloat(this.sg.cells(4,i))+","+nilaiToFloat(this.sg.cells(5,i))+","+nilaiToFloat(this.sg.cells(3,i))+","+diskonBrg+","+nilaiToFloat(this.sg.cells(6,i))+","+nilaiToFloat(this.sg.cells(7,i))+")");
							}
						}						
					}		
					...
					sql.add("insert into trans_m (no_bukti,kode_lokasi,tgl_input,nik_user,periode,modul,form,posted,prog_seb,progress,tanggal,no_dokumen,keterangan,kode_curr,kurs,nilai1,nilai2,nilai3,nik1,nik2,nik3,no_ref1,no_ref2,no_ref3) values "+
							"('"+this.e_nb.getText()+"','"+this.app._lokasi+"',getdate(),'"+this.app._userLog+"','"+this.e_periode.getText()+"','KB','BLBRG','F','-','-','"+this.dp_d1.getDateString()+"','"+this.e_dok.getText()+"','Pembelian No: "+this.e_dok.getText()+"','IDR',1,"+
					...
					sql.add("insert into trans_j (no_bukti,kode_lokasi,tgl_input,nik_user,periode,no_dokumen,tanggal,nu,kode_akun,dc,nilai,nilai_curr,keterangan,modul,jenis,kode_curr,kurs,kode_pp,kode_drk,kode_cust,kode_vendor,no_fa,no_selesai,no_ref1,no_ref2,no_ref3) values "+
							"('"+this.e_nb.getText()+"','"+this.app._lokasi+"',getdate(),'"+this.app._userLog+"','"+this.e_periode.getText()+"','"+this.e_dok.getText()+"','"+this.dp_d1.getDateString()+"',0,'"+this.akunBarang+"','D',"+this.barang+","+this.barang+",'Pembelian No :"+this.e_dok.getText()+"','KB','KB','IDR',1,'"+this.app._kodePP+"','-','-','"+this.cb_vendor.getText()+"','-','-','-','-','-')");										
					sql.add("insert into trans_j (no_bukti,kode_lokasi,tgl_input,nik_user,periode,no_dokumen,tanggal,nu,kode_akun,dc,nilai,nilai_curr,keterangan,modul,jenis,kode_curr,kurs,kode_pp,kode_drk,kode_cust,kode_vendor,no_fa,no_selesai,no_ref1,no_ref2,no_ref3) values "+
							"('"+this.e_nb.getText()+"','"+this.app._lokasi+"',getdate(),'"+this.app._userLog+"','"+this.e_periode.getText()+"','"+this.e_dok.getText()+"','"+this.dp_d1.getDateString()+"',1,'"+this.akunPPN+"','D',"+nilaiToFloat(this.e_ppn.getText())+","+nilaiToFloat(this.e_ppn.getText())+",'Pembelian No :"+this.e_dok.getText()+"','PPN','PPN','IDR',1,'"+this.app._kodePP+"','-','-','"+this.cb_vendor.getText()+"','-','-','-','-','-')");										
					sql.add("insert into trans_j (no_bukti,kode_lokasi,tgl_input,nik_user,periode,no_dokumen,tanggal,nu,kode_akun,dc,nilai,nilai_curr,keterangan,modul,jenis,kode_curr,kurs,kode_pp,kode_drk,kode_cust,kode_vendor,no_fa,no_selesai,no_ref1,no_ref2,no_ref3) values "+
							"('"+this.e_nb.getText()+"','"+this.app._lokasi+"',getdate(),'"+this.app._userLog+"','"+this.e_periode.getText()+"','"+this.e_dok.getText()+"','"+this.dp_d1.getDateString()+"',2,'"+this.akunMat+"','D',"+nilaiToFloat(this.e_mat.getText())+","+nilaiToFloat(this.e_mat.getText())+",'Pembelian No :"+this.e_dok.getText()+"','MAT','MAT','IDR',1,'"+this.app._kodePP+"','-','-','"+this.cb_vendor.getText()+"','-','-','-','-','-')");										
					
					sql.add("insert into trans_j (no_bukti,kode_lokasi,tgl_input,nik_user,periode,no_dokumen,tanggal,nu,kode_akun,dc,nilai,nilai_curr,keterangan,modul,jenis,kode_curr,kurs,kode_pp,kode_drk,kode_cust,kode_vendor,no_fa,no_selesai,no_ref1,no_ref2,no_ref3) values "+
							"('"+this.e_nb.getText()+"','"+this.app._lokasi+"',getdate(),'"+this.app._userLog+"','"+this.e_periode.getText()+"','"+this.e_dok.getText()+"','"+this.dp_d1.getDateString()+"',3,'"+this.akunDiskon+"','C',"+totDiskon+","+totDiskon+",'Pembelian No :"+this.e_dok.getText()+"','KB','KB','IDR',1,'"+this.app._kodePP+"','-','-','"+this.cb_vendor.getText()+"','-','-','-','-','-')");										
					sql.add("insert into trans_j (no_bukti,kode_lokasi,tgl_input,nik_user,periode,no_dokumen,tanggal,nu,kode_akun,dc,nilai,nilai_curr,keterangan,modul,jenis,kode_curr,kurs,kode_pp,kode_drk,kode_cust,kode_vendor,no_fa,no_selesai,no_ref1,no_ref2,no_ref3) values "+
							"('"+this.e_nb.getText()+"','"+this.app._lokasi+"',getdate(),'"+this.app._userLog+"','"+this.e_periode.getText()+"','"+this.e_dok.getText()+"','"+this.dp_d1.getDateString()+"',4,'"+this.akunDiskon+"','C',"+this.bonus+","+this.bonus+",'Pembelian No :"+this.e_dok.getText()+"','PPN','PPN','IDR',1,'"+this.app._kodePP+"','-','-','"+this.cb_vendor.getText()+"','-','-','-','-','-')");										
					sql.add("insert into trans_j (no_bukti,kode_lokasi,tgl_input,nik_user,periode,no_dokumen,tanggal,nu,kode_akun,dc,nilai,nilai_curr,keterangan,modul,jenis,kode_curr,kurs,kode_pp,kode_drk,kode_cust,kode_vendor,no_fa,no_selesai,no_ref1,no_ref2,no_ref3) values "+
							"('"+this.e_nb.getText()+"','"+this.app._lokasi+"',getdate(),'"+this.app._userLog+"','"+this.e_periode.getText()+"','"+this.e_dok.getText()+"','"+this.dp_d1.getDateString()+"',5,'"+this.akunHutang+"','C',"+nilaiToFloat(this.e_total.getText())+","+nilaiToFloat(this.e_total.getText())+",'Pembelian No :"+this.e_dok.getText()+"','MAT','MAT','IDR',1,'"+this.app._kodePP+"','-','-','"+this.cb_vendor.getText()+"','-','-','-','-','-')");										
					...
					sql.add("insert into trans_j(no_bukti,kode_lokasi,tgl_input,nik_user,periode,no_dokumen,tanggal,nu,kode_akun,dc,nilai,nilai_curr,keterangan,modul,jenis,kode_curr,kurs,kode_pp,kode_drk,kode_cust,kode_vendor,no_fa,no_selesai,no_ref1,no_ref2,no_ref3) "+
							"select "+
							"no_bukti,'"+this.app._lokasi+"',getdate(),'"+this.app._userLog+"','"+this.e_periode.getText()+"','"+this.e_dok.getText()+"','"+this.dp_d1.getDateString()+"',99,'"+this.akunDiskon+"', case when (debet-kredit)>0 then 'C' else 'D' end,abs(debet-kredit),abs(debet-kredit),'SLS','BRGBELI','SLS','IDR',1,'"+this.app._kodePP+"','-','-','"+this.cb_vendor.getText()+"','-','-','-','-','-' "+
							"from "+
							"( "+
							...
							")a where a.debet <> a.kredit and a.no_bukti='"+this.e_nb.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"'");
	...
	doClick:function(sender){
		if (this.e_periode.getText()!= "") {
			...
			this.stsSimpan = 1;
			this.e_nb.setText(this.standarLib.noBuktiOtomatis(this.dbLib,"kli_beli_m","no_beli",this.app._lokasi+"-PO"+this.e_periode.getText().substr(2,4)+".","0000"));
			this.e_dok.setFocus();
		...
		try{			
			if (col == 0){
				this.standarLib.showListData(this, "Daftar Item Barang",sender,undefined, 
											  ...
											  ["kode_obat","nama"],"and",["Kode","Nama"],false);				
			}
	...
	doChangeCell: function(sender, col, row){
		...
		try{		
			if (this.sg.cells(0,row) != "") {		
				var strSQL = "select nama,sat_kecil from kli_obat where kode_obat ='"+this.sg.cells(0,row)+"' and kode_lokasi='"+this.app._lokasi+"'";
		...
		try{
			...
			for (var i = 0; i < this.sg.rows.getLength();i++){
				if (this.sg.rowValid(i) && this.sg.cells(7,i) != ""){
					...
					this.barang += Math.round( nilaiToFloat(this.sg.cells(3,i)) * (nilaiToFloat(this.sg.cells(4,i))+nilaiToFloat(this.sg.cells(5,i))) );
				...
				switch(methodName){
	    			case "execArraySQL" :	    				
						if (result.toLowerCase().search("error") == -1){
							if (this.preView == "1") {								
								this.nama_report="server_report_saku3_kantintu_rptBeli";
	...
	doLoad3:function(sender){																		
		var strSQL = "select a.no_beli,convert(varchar,a.tanggal,103) as tgl,a.no_dokumen "+
		             "from kli_beli_m a "+					 					 
	...
	doTampilData3: function(page) {
		...
		for (var i=start;i<finish;i++){
			...
			this.sg3.appendData([line.no_beli,line.tgl,line.no_dokumen]); 
		}
	...
	doDoubleClick3: function(sender, col , row) {
		try{
			if (this.sg3.cells(0,row) != "") {
				...
				var strSQL = "select tanggal,due_date,no_dokumen,kode_vendor,kode_pp,nilai_ppn,nilai_diskon,nilai_mat "+
							 "from kli_beli_m "+							 
				...
				var data = this.dbLib.getDataProvider("select b.kode_obat,b.nama,a.satuan,a.jumlah,a.bonus,a.harga,a.tot_diskon,a.total "+
				...
				if (typeof data == "object" && data.rs.rows[0] != undefined){
					...
					for (var i in data.rs.rows){
						line = data.rs.rows[i];												
						this.sg.appendData([line.kode_obat,line.nama,line.satuan,floatToNilai(line.harga),floatToNilai(line.jumlah),floatToNilai(line.bonus),floatToNilai(line.tot_diskon),floatToNilai(line.total)]);
					}
