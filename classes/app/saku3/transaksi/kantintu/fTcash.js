window.app_saku3_transaksi_kantintu_fTcash = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_kantintu_fTcash.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_kantintu_fTcash";
		this.itemsValue = new arrayList();
		this.maximize();		
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Data Penyelesaian Piutang TCASH", 0);	
...
window.app_saku3_transaksi_kantintu_fTcash.extend(window.childForm);
window.app_saku3_transaksi_kantintu_fTcash.implement({
