window.app_saku3_transaksi_kantintu_fTerimaTC = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_kantintu_fTerimaTC.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_kantintu_fTerimaTC";
		this.itemsValue = new arrayList();
		this.maximize();		
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Data Penerimaan TCASH", 0);	
		...
		this.pc2 = new pageControl(this.pc1.childPage[0],{bound:[1,15,995,305], childPage:["Data Penerimaan Tcash"]});				
...
window.app_saku3_transaksi_kantintu_fTerimaTC.extend(window.childForm);
window.app_saku3_transaksi_kantintu_fTerimaTC.implement({
		...
		try{				
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1])){
				try{
					...
					sql.add("insert into trans_m(no_bukti,kode_lokasi,tgl_input,nik_user,periode,modul,form,posted,prog_seb,progress,tanggal,no_dokumen,keterangan,kode_curr,kurs,nilai1,nilai2,nilai3,nik1,nik2,nik3,no_ref1,no_ref2,no_ref3) "+
