window.app_saku3_transaksi_kantintu_fClosing = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_kantintu_fClosing.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_kantintu_fClosing";
		this.itemsValue = new arrayList();
		this.maximize();		
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Data Closing Shift", 0);	
		...
		this.e_nb = new portalui_saiLabelEdit(this.pc1.childPage[0],{bound:[20,11,200,20],caption:"No Closing", maxLength:20, tag:1,readOnly:true});		
...
window.app_saku3_transaksi_kantintu_fClosing.extend(window.childForm);
window.app_saku3_transaksi_kantintu_fClosing.implement({
