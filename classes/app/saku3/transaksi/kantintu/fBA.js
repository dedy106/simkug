window.app_saku3_transaksi_kantintu_fBA = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_kantintu_fBA.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_kantintu_fBA";
		...
		this.cb_closing = new saiCBBL(this.pc1.childPage[0],{bound:[20,16,220,20],caption:"No Closing", maxLength:50, tag:1 ,multiSelection:false,change:[this,"doChange"]});
		
		this.pc2 = new pageControl(this.pc1.childPage[0],{bound:[1,11,995,281], childPage:["Data Closing Shift","Detail Nota","Detail Total"]});						
...
window.app_saku3_transaksi_kantintu_fBA.extend(window.childForm);
window.app_saku3_transaksi_kantintu_fBA.implement({
