window.app_saku3_transaksi_kantintu_fNotaLoad = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_kantintu_fNotaLoad.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_kantintu_fNotaLoad";
...
window.app_saku3_transaksi_kantintu_fNotaLoad.extend(window.childForm);
window.app_saku3_transaksi_kantintu_fNotaLoad.implement({
