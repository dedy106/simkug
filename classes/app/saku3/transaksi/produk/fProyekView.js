window.app_saku3_transaksi_produk_fProyekView = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fProyekView.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fProyekView";
...
window.app_saku3_transaksi_produk_fProyekView.extend(window.childForm);
window.app_saku3_transaksi_produk_fProyekView.implement({	
