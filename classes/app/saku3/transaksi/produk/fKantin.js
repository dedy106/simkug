window.app_saku3_transaksi_produk_fKantin = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fKantin.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fKantin";
		this.itemsValue = new arrayList();
		this.maximize();	
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Data Kantin [PP - Mapping]", 0);	
		...
		this.cb_kode = new saiCBBL(this.pc1.childPage[1],{bound:[20,12,200,20],caption:"Kantin/PP", maxLength:50,readOnly:true, tag:0, multiSelection:false,change:[this,"doChange"]});		
...
window.app_saku3_transaksi_produk_fKantin.extend(window.childForm);
window.app_saku3_transaksi_produk_fKantin.implement({
