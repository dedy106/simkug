window.app_saku3_transaksi_produk_fMasakunRelasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fMasakunRelasi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fMasakunRelasi";
...
window.app_saku3_transaksi_produk_fMasakunRelasi.extend(window.childForm);
window.app_saku3_transaksi_produk_fMasakunRelasi.implement({
