window.app_saku3_transaksi_produk_fParamTarif = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fParamTarif.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fParamTarif";
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Data Tarif Parameter", 0);	
		
		uses("saiCBBL;saiEdit;saiGrid;sgNavigator");
		this.cb_pp = new saiCBBL(this,{bound:[20,10,200,20],caption:"PP / Unit", readOnly:true, tag:2});		
...
window.app_saku3_transaksi_produk_fParamTarif.extend(window.childForm);
window.app_saku3_transaksi_produk_fParamTarif.implement({
