window.app_saku3_transaksi_produk_fBukuP = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fBukuP.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fBukuP";
		...
		try {
			...
			this.cb_matpel.setSQL("select a.kode_matpel, b.nama from sis_guru_matpel a inner join sis_matpel b on a.kode_matpel=b.kode_matpel where a.nik='"+this.app._userLog+"' and a.kode_lokasi = '"+this.app._lokasi+"' and a.kode_pp = '"+this.app._kodePP+"' union select '-','-' ",["kode_matpel","nama"],false,["Kode Matpel","Nama"],"and","Data Mata Pelajaran",true);			
...
window.app_saku3_transaksi_produk_fBukuP.extend(window.childForm);
window.app_saku3_transaksi_produk_fBukuP.implement({
