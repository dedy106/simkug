window.app_saku3_transaksi_produk_fKbDualIn = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fKbDualIn.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fKbDualIn";
		...
		this.e_saldo = new saiLabelEdit(this.pc2.childPage[0],{bound:[20,14,200,20],caption:"Saldo Budget TW", tag:1, tipeText:ttNilai, text:"0",readOnly:true,visible:false});											
...
window.app_saku3_transaksi_produk_fKbDualIn.extend(window.childForm);
window.app_saku3_transaksi_produk_fKbDualIn.implement({	
