window.app_saku3_transaksi_produk_fKalAkad = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fKalAkad.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fKalAkad";
...
window.app_saku3_transaksi_produk_fKalAkad.extend(window.childForm);
window.app_saku3_transaksi_produk_fKalAkad.implement({
		...
		try{						
			if (this.standarLib.checkEmptyByTag(this, [0,1,9])){
				try{									
					...
					sql.add("delete from sis_kalender_akad where kode_ta = '"+this.cb_ta.getText()+"' and kode_lokasi='"+this.app._lokasi+"' and kode_pp='"+this.app._kodePP+"'");		
