window.app_saku3_transaksi_produk_fKbDualOut = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fKbDualOut.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fKbDualOut";
...
window.app_saku3_transaksi_produk_fKbDualOut.extend(window.childForm);
window.app_saku3_transaksi_produk_fKbDualOut.implement({	
