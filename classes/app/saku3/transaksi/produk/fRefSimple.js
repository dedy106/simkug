window.app_saku3_transaksi_produk_fRefSimple = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fRefSimple.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fRefSimple";
...
window.app_saku3_transaksi_produk_fRefSimple.extend(window.childForm);
window.app_saku3_transaksi_produk_fRefSimple.implement({
