window.app_saku3_transaksi_produk_fJenisProyek = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fJenisProyek.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fJenisProyek";
...
window.app_saku3_transaksi_produk_fJenisProyek.extend(window.childForm);
window.app_saku3_transaksi_produk_fJenisProyek.implement({
		...
		try{						
			if (this.standarLib.checkEmptyByTag(this, [0,1])){
				try{									
					...
					sql.add("insert into pr_jenis(kode_jenis,kode_lokasi,nama,akun_bdd,akun_piutang,akun_pdpt,akun_bmhd,kode_pp,akun_pyt,kelompok, akun_beban) values "+
						    "('"+this.cb_kode.getText()+"','"+this.app._lokasi+"','"+this.e_nama.getText()+"','"+this.cb_bdd.getText()+"','"+this.cb_piu.getText()+"','"+this.cb_pdpt.getText()+"','"+this.cb_bmhd.getText()+"','-','-','-','"+this.cb_beban.getText()+"')");							
					setTipeButton(tbAllFalse);
