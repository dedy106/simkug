window.app_saku3_transaksi_produk_fKbPjSimple = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fKbPjSimple.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fKbPjSimple";
...
window.app_saku3_transaksi_produk_fKbPjSimple.extend(window.childForm);
window.app_saku3_transaksi_produk_fKbPjSimple.implement({
