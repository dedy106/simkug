window.app_saku3_transaksi_produk_fInfoSekolah = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fInfoSekolah.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fInfoSekolah";
		...
		this.pc1 = new pageControl(this,{bound:[20,22,1000,450], childPage:["Upload Dokumen"]});				
...
window.app_saku3_transaksi_produk_fInfoSekolah.extend(window.childForm);
window.app_saku3_transaksi_produk_fInfoSekolah.implement({	
