window.app_saku3_transaksi_produk_fBDDproyek = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fBDDproyek.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fBDDproyek";
		...
		this.sg1 = new saiGrid(this.pc2.childPage[0],{bound:[0,5,this.pc2.width-5,270],colCount:5,tag:0,
...
window.app_saku3_transaksi_produk_fBDDproyek.extend(window.childForm);
window.app_saku3_transaksi_produk_fBDDproyek.implement({
				...
				switch(methodName){
	    			case "execArraySQL" :	    				
						if (result.toLowerCase().search("error") == -1){							
							if (this.preView == "1") {
								this.nama_report="server_report_saku3_produk_rptProyekBebanBdd";
