window.app_saku3_transaksi_produk_fKirim = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fKirim.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fKirim";
...
window.app_saku3_transaksi_produk_fKirim.extend(window.portalui_childForm);
window.app_saku3_transaksi_produk_fKirim.implement({
	...
	doClick:function(sender){
		if (this.e_periode.getText()!= "") {
			...
			this.stsSimpan = 1;
			this.e_nb.setText(this.standarLib.noBuktiOtomatis(this.dbLib,"trans_m","no_bukti",this.app._lokasi+"-MK"+this.e_periode.getText().substr(2,4)+".","0000"));						
