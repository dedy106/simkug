window.app_saku3_transaksi_produk_fAkruPiuProyek = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fAkruPiuProyek.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fAkruPiuProyek";
...
window.app_saku3_transaksi_produk_fAkruPiuProyek.extend(window.childForm);
window.app_saku3_transaksi_produk_fAkruPiuProyek.implement({
