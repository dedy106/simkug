window.app_saku3_transaksi_produk_fFlagRelasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fFlagRelasi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fFlagRelasi";
...
window.app_saku3_transaksi_produk_fFlagRelasi.extend(window.childForm);
window.app_saku3_transaksi_produk_fFlagRelasi.implement({
