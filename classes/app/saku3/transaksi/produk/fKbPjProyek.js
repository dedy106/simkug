window.app_saku3_transaksi_produk_fKbPjProyek = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fKbPjProyek.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fKbPjProyek";
...
window.app_saku3_transaksi_produk_fKbPjProyek.extend(window.childForm);
window.app_saku3_transaksi_produk_fKbPjProyek.implement({
