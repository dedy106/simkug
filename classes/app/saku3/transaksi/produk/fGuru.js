window.app_saku3_transaksi_produk_fGuru = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fGuru.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fGuru";
...
window.app_saku3_transaksi_produk_fGuru.extend(window.childForm);
window.app_saku3_transaksi_produk_fGuru.implement({
