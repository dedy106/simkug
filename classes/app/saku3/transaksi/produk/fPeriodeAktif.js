window.app_saku3_transaksi_produk_fPeriodeAktif = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fPeriodeAktif.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fPeriodeAktif";
...
window.app_saku3_transaksi_produk_fPeriodeAktif.extend(window.childForm);
window.app_saku3_transaksi_produk_fPeriodeAktif.implement({
