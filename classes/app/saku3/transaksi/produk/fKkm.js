window.app_saku3_transaksi_produk_fKkm = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fKkm.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fKkm";
		...
		this.bRekon = new button(this.pc1.childPage[1],{bound:[460,11,100,20],caption:"Validasi", click:[this,"doRekon"]});
	
		this.pc2 = new pageControl(this.pc1.childPage[1],{bound:[1,13,995,305], childPage:["Data KKM Matpel"]});				
		this.sg2 = new saiGrid(this.pc2.childPage[0],{bound:[1,5,this.pc2.width-5,this.pc2.height-35],colCount:3,tag:1,
...
window.app_saku3_transaksi_produk_fKkm.extend(window.childForm);
window.app_saku3_transaksi_produk_fKkm.implement({
