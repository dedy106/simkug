window.app_saku3_transaksi_produk_fKbPiuProyek = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fKbPiuProyek.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fKbPiuProyek";
...
window.app_saku3_transaksi_produk_fKbPiuProyek.extend(window.childForm);
window.app_saku3_transaksi_produk_fKbPiuProyek.implement({
	doLoad : function() {
