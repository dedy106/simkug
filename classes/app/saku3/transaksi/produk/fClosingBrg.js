window.app_saku3_transaksi_produk_fClosingBrg = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fClosingBrg.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fClosingBrg";
...
window.app_saku3_transaksi_produk_fClosingBrg.extend(window.portalui_childForm);
window.app_saku3_transaksi_produk_fClosingBrg.implement({
