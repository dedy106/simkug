window.app_saku3_transaksi_produk_fDisBDD = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fDisBDD.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fDisBDD";
...
window.app_saku3_transaksi_produk_fDisBDD.extend(window.portalui_childForm);
window.app_saku3_transaksi_produk_fDisBDD.implement({
