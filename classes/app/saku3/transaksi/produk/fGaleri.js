window.app_saku3_transaksi_produk_fGaleri = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fGaleri.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fGaleri";
		...
		this.cb_pp = new portalui_saiCBBL(this.pc1.childPage[0],{bound:[20,11,220,20],caption:"PP/Sekolah",multiSelection:false,tag:1,change:[this,"doChange"]});	
...
window.app_saku3_transaksi_produk_fGaleri.extend(window.childForm);
window.app_saku3_transaksi_produk_fGaleri.implement({	
