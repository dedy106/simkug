window.app_saku3_transaksi_produk_fBebanProyek = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fBebanProyek.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fBebanProyek";
		...
		this.e_saldogar = new saiLabelEdit(this.pc2.childPage[0],{bound:[775,14,200,20],caption:"Saldo Budget", tag:1, tipeText:ttNilai, text:"0", readOnly:true});		
		...
		this.sg1 = new saiGrid(this.pc2.childPage[0],{bound:[0,5,this.pc2.width-5,225],colCount:5,tag:0,
...
window.app_saku3_transaksi_produk_fBebanProyek.extend(window.childForm);
window.app_saku3_transaksi_produk_fBebanProyek.implement({
