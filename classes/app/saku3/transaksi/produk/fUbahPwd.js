window.app_saku3_transaksi_produk_fUbahPwd = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fUbahPwd.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fUbahPwd";
...
window.app_saku3_transaksi_produk_fUbahPwd.extend(window.childForm);
window.app_saku3_transaksi_produk_fUbahPwd.implement({
