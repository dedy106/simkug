window.app_saku3_transaksi_produk_fJadwal = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fJadwal.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fJadwal";
		...
		try {
			...
			this.cb_guru.setSQL("select nik, nama from karyawan where kode_lokasi = '"+this.app._lokasi+"'",["nik","nama"],false,["NIK","Nama"],"and","Data Pegawai",true);			
...
window.app_saku3_transaksi_produk_fJadwal.extend(window.childForm);
window.app_saku3_transaksi_produk_fJadwal.implement({
