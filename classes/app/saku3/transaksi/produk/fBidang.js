window.app_saku3_transaksi_produk_fBidang = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fBidang.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fBidang";
...
window.app_saku3_transaksi_produk_fBidang.extend(window.childForm);
window.app_saku3_transaksi_produk_fBidang.implement({
