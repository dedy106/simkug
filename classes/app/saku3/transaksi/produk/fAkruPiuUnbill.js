window.app_saku3_transaksi_produk_fAkruPiuUnbill = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fAkruPiuUnbill.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fAkruPiuUnbill";
...
window.app_saku3_transaksi_produk_fAkruPiuUnbill.extend(window.childForm);
window.app_saku3_transaksi_produk_fAkruPiuUnbill.implement({
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					sql.add("insert into pr_unbill_d (no_bukti,kode_lokasi,tgl_input,nik_user,periode,kode_proyek,kode_cust,akun_piutang,akun_pdpt,kode_drk,nilai,no_reverse) values "+
							"('"+this.e_nb.getText()+"','"+this.app._lokasi+"',getdate(),'"+this.app._userLog+"','"+this.e_periode.getText()+"','"+this.cb_proyek.getText()+"','"+this.cb_cust.getText()+"','"+this.cb_akunpiu.getText()+"','"+this.cb_akunpdpt.getText()+"','"+this.cb_drk.getText()+"',"+nilaiToFloat(this.e_nilai.getText())+",'-')");
