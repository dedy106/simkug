window.app_saku3_transaksi_produk_fReturBeli = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fReturBeli.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fReturBeli";
...
window.app_saku3_transaksi_produk_fReturBeli.extend(window.portalui_childForm);
window.app_saku3_transaksi_produk_fReturBeli.implement({
	doJurnal : function() {
	...
	doClick:function(sender){
		if (this.e_periode.getText()!= "") {
			...
			this.stsSimpan = 1;
			this.e_nb.setText(this.standarLib.noBuktiOtomatis(this.dbLib,"trans_m","no_bukti",this.app._lokasi+"-RB"+this.e_periode.getText().substr(2,4)+".","0000"));			
			this.e_dok.setFocus();
