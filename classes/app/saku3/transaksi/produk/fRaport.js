window.app_saku3_transaksi_produk_fRaport = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fRaport.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fRaport";
		...
		this.pc1 = new pageControl(this,{bound:[20,12,1000,480], childPage:["Data Raport","Daftar Raport"]});				
		...
		this.pc2 = new pageControl(this.pc1.childPage[0],{bound:[5,12,990,375], childPage:["Data Matpel","Data Nilai"]});		
...
window.app_saku3_transaksi_produk_fRaport.extend(window.childForm);
window.app_saku3_transaksi_produk_fRaport.implement({
