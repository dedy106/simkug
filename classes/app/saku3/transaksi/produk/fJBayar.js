window.app_saku3_transaksi_produk_fJBayar = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fJBayar.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fJBayar";
...
window.app_saku3_transaksi_produk_fJBayar.extend(window.childForm);
window.app_saku3_transaksi_produk_fJBayar.implement({
