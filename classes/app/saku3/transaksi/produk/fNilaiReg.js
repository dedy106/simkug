window.app_saku3_transaksi_produk_fNilaiReg = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fNilaiReg.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fNilaiReg";
...
window.app_saku3_transaksi_produk_fNilaiReg.extend(window.childForm);
window.app_saku3_transaksi_produk_fNilaiReg.implement({
		...
		try{
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1])){
				try{									
					...
					if (this.stsSimpan == 0) {
						sql.add("delete from sis_nilai_reg where no_bukti = '"+this.e_nb.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");
					}			
	...
	doDoubleClick: function(sender, col , row) {
		try{
			if (this.sg1.cells(0,row) != "") {			
				...
				var strSQL = "select a.no_reg,a.nilai,a.keterangan from sis_nilai_reg a inner join sis_siswareg b on a.no_reg=b.no_reg where a.no_bukti='"+this.e_nb.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' ";										
