window.app_saku3_transaksi_produk_fGbrDepan = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fGbrDepan.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fGbrDepan";
...
window.app_saku3_transaksi_produk_fGbrDepan.extend(window.childForm);
window.app_saku3_transaksi_produk_fGbrDepan.implement({
