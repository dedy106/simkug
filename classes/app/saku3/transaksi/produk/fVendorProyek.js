window.app_saku3_transaksi_produk_fVendorProyek = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fVendorProyek.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fVendorProyek";
...
window.app_saku3_transaksi_produk_fVendorProyek.extend(window.childForm);
window.app_saku3_transaksi_produk_fVendorProyek.implement({
	doCari: function() {
