window.app_saku3_transaksi_produk_fFaKlp = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fFaKlp.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fFaKlp";
...
window.app_saku3_transaksi_produk_fFaKlp.extend(window.childForm);
window.app_saku3_transaksi_produk_fFaKlp.implement({
