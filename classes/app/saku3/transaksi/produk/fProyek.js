window.app_saku3_transaksi_produk_fProyek = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fProyek.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fProyek";
...
window.app_saku3_transaksi_produk_fProyek.extend(window.childForm);
window.app_saku3_transaksi_produk_fProyek.implement({	
	...
	doSelectDate: function(sender, y,m,d){
		...
		this.cb_drkp.setSQL("select a.kode_drk, a.nama from drk a where a.tahun='"+this.periode.substr(0,4)+"' and a.kode_lokasi='"+this.app._lokasi+"'",["kode_drk","nama"],false,["Kode","Nama"],"and","Data DRK Pendapatan",true);		
		this.cb_drkb.setSQL("select a.kode_drk, a.nama from drk a where a.tahun='"+this.periode.substr(0,4)+"' and a.kode_lokasi='"+this.app._lokasi+"'",["kode_drk","nama"],false,["Kode","Nama"],"and","Data DRK Beban",true);																													 				
	},	
