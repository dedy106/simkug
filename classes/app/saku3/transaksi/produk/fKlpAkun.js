window.app_saku3_transaksi_produk_fKlpAkun = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fKlpAkun.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fKlpAkun";
...
window.app_saku3_transaksi_produk_fKlpAkun.extend(window.childForm);
window.app_saku3_transaksi_produk_fKlpAkun.implement({
