window.app_saku3_transaksi_produk_fMasgar = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fMasgar.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fMasgar";
...
window.app_saku3_transaksi_produk_fMasgar.extend(window.childForm);
window.app_saku3_transaksi_produk_fMasgar.implement({
