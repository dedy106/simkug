window.app_saku3_transaksi_produk_fBebanProyekDummy = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fBebanProyekDummy.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fBebanProyekDummy";
...
window.app_saku3_transaksi_produk_fBebanProyekDummy.extend(window.childForm);
window.app_saku3_transaksi_produk_fBebanProyekDummy.implement({
