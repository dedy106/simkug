window.app_saku3_transaksi_produk_fSiswaReg = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fSiswaReg.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fSiswaReg";
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Pendaftaran Siswa", 0);	
		...
		this.sg1 = new saiGrid(this.pc1.childPage[0],{bound:[1,5,this.pc1.width-5,this.pc1.height-35],colCount:2,tag:2,
		            colTitle:["No. Registrasi","Nama"],
		...
		this.e_un = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,33,160,20],caption:"Nilai UN Terakhir", maxLength:50, tag:1,tipeText:ttNilai, text:"0"});
		...
		this.e_namaayah = new saiLabelEdit(this.pc1.childPage[2],{bound:[20,13,390,20],caption:"Nama Ayah", maxLength:50, tag:1});
		this.e_alamatayah = new saiLabelEdit(this.pc1.childPage[2],{bound:[20,14,390,20],caption:"Alamat Ayah", maxLength:200, tag:1});
		...
		this.e_hasilayah = new saiLabelEdit(this.pc1.childPage[2],{bound:[20,16,200,20],caption:"Penghasilan Ayah", maxLength:50, tag:1,tipeText:ttNilai, text:"0"});
		this.e_hpayah = new saiLabelEdit(this.pc1.childPage[2],{bound:[20,17,200,20],caption:"HP Ayah", maxLength:50, tag:1});
		this.e_emailayah = new saiLabelEdit(this.pc1.childPage[2],{bound:[20,18,390,20],caption:"Email Ayah", maxLength:50, tag:1});	

		this.e_namaibu = new saiLabelEdit(this.pc1.childPage[2],{bound:[20,19,390,20],caption:"Nama Ibu", maxLength:50, tag:1});
		this.e_alamatibu = new saiLabelEdit(this.pc1.childPage[2],{bound:[20,20,390,20],caption:"Alamat Ibu", maxLength:200, tag:1});
		...
		this.e_hasilibu = new saiLabelEdit(this.pc1.childPage[2],{bound:[20,24,200,20],caption:"Penghasilan Ibu", maxLength:50, tag:1,tipeText:ttNilai, text:"0"});
		this.e_hpibu = new saiLabelEdit(this.pc1.childPage[2],{bound:[20,25,200,20],caption:"HP Ibu", maxLength:50, tag:1});
		this.e_emailibu = new saiLabelEdit(this.pc1.childPage[2],{bound:[20,26,390,20],caption:"Email Ibu", maxLength:50, tag:1});			

		this.e_namawali = new saiLabelEdit(this.pc1.childPage[2],{bound:[20,19,390,20],caption:"Nama Wali", maxLength:50, tag:1});
		this.e_alamatwali = new saiLabelEdit(this.pc1.childPage[2],{bound:[20,20,390,20],caption:"Alamat Wali", maxLength:200, tag:1});
		...
		this.e_hpwali = new saiLabelEdit(this.pc1.childPage[2],{bound:[20,25,200,20],caption:"HP Wali", maxLength:50, tag:1});
		this.e_emailwali = new saiLabelEdit(this.pc1.childPage[2],{bound:[20,26,390,20],caption:"Email Wali", maxLength:50, tag:1});			
		this.e_hub = new saiLabelEdit(this.pc1.childPage[2],{bound:[20,28,390,20],caption:"Hub. dgn Siswa", maxLength:50, tag:1});	

		this.c_darah = new saiCB(this.pc1.childPage[3],{bound:[20,11,160,20],caption:"Gol Darah",items:["A","AB","B","O"], readOnly:true,tag:2});
		this.e_hismed = new saiLabelEdit(this.pc1.childPage[3],{bound:[20,12,390,20],caption:"Kondisi Kesehatan", maxLength:50, tag:1});
		this.e_hisobat = new saiLabelEdit(this.pc1.childPage[3],{bound:[20,13,390,20],caption:"Dalam Pengobatan", maxLength:50, tag:1});				
		this.e_dokter = new saiLabelEdit(this.pc1.childPage[3],{bound:[20,14,390,20],caption:"Nama Dokter Klg.", maxLength:50, tag:1});
		this.e_tlpdokter = new saiLabelEdit(this.pc1.childPage[3],{bound:[20,15,200,20],caption:"Telp. Dokter", maxLength:50, tag:1});								
...
window.app_saku3_transaksi_produk_fSiswaReg.extend(window.childForm);
window.app_saku3_transaksi_produk_fSiswaReg.implement({
		...
		try{						
			if (this.standarLib.checkEmptyByTag(this, [0,1])){
				try {									
					uses("server_util_arrayList");
					var sql = new server_util_arrayList();					
					sql.add("delete from sis_siswareg where no_reg = '"+this.cb_kode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' and kode_pp='"+this.app._lokasi+"' ");			
					sql.add("insert into sis_siswareg(no_reg,kode_ta,kode_pp,tanggal,nama,agama,jk,tmp_lahir,tgl_lahir,kwn,foto,alamat_siswa,tlp_siswa,hp_siswa,email,asal_sek,no_ijazah,nilai_un,nama_ayah,nama_ibu,alamat_ayah,alamat_ibu,kerja_ayah,kerja_ibu,pdd_ayah,pdd_ibu,hasil_ayah,hasil_ibu,hp_ayah,hp_ibu,email_ayah,email_ibu,nama_wali,alamat_wali,kerja_wali,hp_wali,email_wali,hub_wali,gol_darah,kond_kes,kond_obat,dokter_klg,telp_dokter,kode_lokasi) values "+
						    "('"+this.cb_kode.getText()+"','"+this.cb_ta.getText()+"','"+this.cb_pp.getText()+"','"+this.dp_d1.getDateString()+"','"+this.e_nama.getText()+"','"+this.c_agama.getText()+"','"+this.c_jk.getText()+"','"+this.e_tmplahir.getText()+"','"+this.dp_d2.getDateString()+"','"+this.c_kwn.getText()+"','"+this.e_foto.getText()+"','"+this.e_alamat.getText()+"','"+this.e_tlpsiswa.getText()+"','"+this.e_hpsiswa.getText()+"','"+this.e_email.getText()+"','"+this.e_asal.getText()+"','"+this.e_ijazah.getText()+"',"+nilaiToFloat(this.e_un.getText())+",'"+this.e_namaayah.getText()+"','"+this.e_namaibu.getText()+"','"+this.e_alamatayah.getText()+"','"+this.e_alamatibu.getText()+"','"+this.c_kerjaayah.getText()+"','"+this.c_kerjaibu.getText()+"','"+this.c_pddayah.getText()+"','"+this.c_pddibu.getText()+"',"+nilaiToFloat(this.e_hasilayah.getText())+","+nilaiToFloat(this.e_hasilibu.getText())+",'"+this.e_hpayah.getText()+"','"+this.e_hpibu.getText()+"','"+this.e_emailayah.getText()+"','"+this.e_emailibu.getText()+"','"+this.e_namawali.getText()+"','"+this.e_alamatwali.getText()+"','"+this.c_kerjawali.getText()+"','"+this.e_hpwali.getText()+"','"+this.e_emailwali.getText()+"','"+this.e_hub.getText()+"','"+this.c_darah.getText()+"','"+this.e_hismed.getText()+"','"+this.e_hisobat.getText()+"','"+this.e_dokter.getText()+"','"+this.e_tlpdokter.getText()+"','"+this.app._lokasi+"')");
					setTipeButton(tbAllFalse);
					this.dbLib.execArraySQL(sql);
	...
	doSelectDate: function(sender, y,m,d){
		var period = "";
		if (m < 10) m = "0" + m;			
		if (parseFloat(this.app._periode.substr(4,2)) <= 12) this.period = y+""+m;
		else {
			if (m == "12") this.period = this.app._periode;
			else this.period = y+""+m;
		}
	},
	...
	doLoad:function(sender){								
		var strSQL = "select no_reg, nama from sis_siswareg where kode_lokasi='"+this.app._lokasi+"' and kode_pp = '"+this.cb_pp.getText()+"' and kode_ta = '"+this.cb_ta.getText()+"' ";		
		var data = this.dbLib.getDataProvider(strSQL,true);		
