window.app_saku3_transaksi_produk_fJual = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fJual.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fJual";
		...
		try{			
			...
			if (typeof data == "object"){
				...
				for (var i in data.rs.rows){
					line = data.rs.rows[i];					
					if (line.kode_spro == "BRGPPNK") this.akunPPN = line.flag;						
...
window.app_saku3_transaksi_produk_fJual.extend(window.portalui_childForm);
window.app_saku3_transaksi_produk_fJual.implement({
	doJurnal : function() {
