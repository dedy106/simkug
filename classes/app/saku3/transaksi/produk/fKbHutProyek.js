window.app_saku3_transaksi_produk_fKbHutProyek = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fKbHutProyek.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fKbHutProyek";
...
window.app_saku3_transaksi_produk_fKbHutProyek.extend(window.childForm);
window.app_saku3_transaksi_produk_fKbHutProyek.implement({
	doLoad : function() {
