window.app_saku3_transaksi_produk_fKbDual = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fKbDual.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fKbDual";
...
window.app_saku3_transaksi_produk_fKbDual.extend(window.childForm);
window.app_saku3_transaksi_produk_fKbDual.implement({	
