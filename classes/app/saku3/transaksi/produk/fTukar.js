window.app_saku3_transaksi_produk_fTukar = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fTukar.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fTukar";
		this.itemsValue = new portalui_arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form IN-OUT Barang", 0);	
...
window.app_saku3_transaksi_produk_fTukar.extend(window.portalui_childForm);
window.app_saku3_transaksi_produk_fTukar.implement({
	...
	doClick:function(sender){
		if (this.e_periode.getText()!= "") {
			...
			this.stsSimpan = 1;
			this.e_nb.setText(this.standarLib.noBuktiOtomatis(this.dbLib,"trans_m","no_bukti",this.app._lokasi+"-IO"+this.e_periode.getText().substr(2,4)+".","0000"));			
			this.e_dok.setFocus();
