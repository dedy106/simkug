window.app_saku3_transaksi_produk_fTenan = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fTenan.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fTenan";
...
window.app_saku3_transaksi_produk_fTenan.extend(window.childForm);
window.app_saku3_transaksi_produk_fTenan.implement({
