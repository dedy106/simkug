window.app_saku3_transaksi_produk_fKBtenan = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fKBtenan.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fKBtenan";
...
window.app_saku3_transaksi_produk_fKBtenan.extend(window.childForm);
window.app_saku3_transaksi_produk_fKBtenan.implement({
