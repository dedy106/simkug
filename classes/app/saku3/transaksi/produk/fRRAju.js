window.app_saku3_transaksi_produk_fRRAju = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fRRAju.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fRRAju";
		...
		this.cb_mtaT = new saiCBBL(this.pc1.childPage[0],{bound:[20,18,220,20],caption:"MTA Penerima", readOnly:true});		
...
window.app_saku3_transaksi_produk_fRRAju.extend(window.childForm);
window.app_saku3_transaksi_produk_fRRAju.implement({
