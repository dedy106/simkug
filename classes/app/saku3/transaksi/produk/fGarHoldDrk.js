window.app_saku3_transaksi_produk_fGarHoldDrk = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fGarHoldDrk.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku3_transaksi_produk_fGarHoldDrk";
...
window.app_saku3_transaksi_produk_fGarHoldDrk.extend(window.portalui_childForm);
window.app_saku3_transaksi_produk_fGarHoldDrk.implement({	
