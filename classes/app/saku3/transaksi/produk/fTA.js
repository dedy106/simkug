window.app_saku3_transaksi_produk_fTA = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fTA.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fTA";
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Data Tahun Ajaran", 0);	
		
		uses("portalui_uploader;saiCBBL;saiEdit;datePicker;saiGrid;sgNavigator;pageControl;checkBox");
		uses("saiGrid",true);		
		this.pc1 = new pageControl(this,{bound:[20,12,1000,450], childPage:["Daftar Tahun Ajaran","Data Tahun Ajaran"]});				
...
window.app_saku3_transaksi_produk_fTA.extend(window.childForm);
window.app_saku3_transaksi_produk_fTA.implement({
