window.app_saku3_transaksi_produk_fPjptgBDDproyek = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_produk_fPjptgBDDproyek.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_produk_fPjptgBDDproyek";
...
window.app_saku3_transaksi_produk_fPjptgBDDproyek.extend(window.childForm);
window.app_saku3_transaksi_produk_fPjptgBDDproyek.implement({
	...
	doChange:function(sender){		
		...
		if (sender == this.cb_pj && this.cb_pj.getText()!="") {
			var data = this.dbLib.getDataProvider(
					   "select convert(varchar,a.tanggal,103) as tanggal,a.akun_pj,b.nama as nama_pj,a.nilai,a.periode,a.kode_pp,c.nama as nama_pp, a.no_dokumen,e.akun_bdd "+
