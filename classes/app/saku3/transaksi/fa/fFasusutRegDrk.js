window.app_saku3_transaksi_fa_fFasusutRegDrk = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_fa_fFasusutRegDrk.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_fa_fFasusutRegDrk";
...
window.app_saku3_transaksi_fa_fFasusutRegDrk.extend(window.childForm);
window.app_saku3_transaksi_fa_fFasusutRegDrk.implement({
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{													
					...
					sql.add("insert into fasusut_d(no_fasusut,no_fa,periode,nilai,kode_lokasi,akun_bp,akun_ap,kode_akun,kode_pp,kode_drk,dc,no_del,nilai_aset,umur) "+
							...
							"		  a.kode_lokasi,c.akun_bp,c.akun_deprs,c.kode_akun,a.kode_pp_susut,c.kode_drk,'D','-',zz.nilai,a.umur "+
							"  from fa_asset a "+
