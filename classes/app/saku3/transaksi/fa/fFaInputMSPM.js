window.app_saku3_transaksi_fa_fFaInputMSPM = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_fa_fFaInputMSPM.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_fa_fFaInputMSPM";
...
window.app_saku3_transaksi_fa_fFaInputMSPM.extend(window.childForm);
window.app_saku3_transaksi_fa_fFaInputMSPM.implement({
		...
		try{						
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					var nbfa = nbfa2 = this.standarLib.noBuktiOtomatis(this.dbLib,"fa_asset","no_fa",this.app._lokasi+"-IN"+this.e_periode.getText().substr(2,4)+".","0000");
					nbfa = nbfa.substr(0,10);
					var idx = parseFloat(nbfa2.substr(10,4));
					var nu = idx2 = "";
	...
	doClick:function(sender){
		this.e_fa.setText(this.standarLib.noBuktiOtomatis(this.dbLib,"fa_asset","no_fa",this.app._lokasi+"-IN"+this.e_periode.getText().substr(2,4)+".","0000"));
		this.e_jml.setFocus();
	},
