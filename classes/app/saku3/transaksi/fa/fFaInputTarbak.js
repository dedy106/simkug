window.app_saku3_transaksi_fa_fFaInputTarbak = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_fa_fFaInputTarbak.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_fa_fFaInputTarbak";
...
window.app_saku3_transaksi_fa_fFaInputTarbak.extend(window.childForm);
window.app_saku3_transaksi_fa_fFaInputTarbak.implement({
