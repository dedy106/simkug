window.app_saku3_transaksi_fa_fFasusutRev = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_fa_fFasusutRev.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_fa_fFasusutRev";
...
window.app_saku3_transaksi_fa_fFasusutRev.extend(window.childForm);
window.app_saku3_transaksi_fa_fFasusutRev.implement({
	...
	simpan: function(){			
		try{						
			this.e_nb.setText(this.standarLib.noBuktiOtomatis(this.dbLib,"fasusut_m","no_fasusut",this.app._lokasi+"-RRSU"+this.e_periode.getText().substr(2,4)+".","0000"));
