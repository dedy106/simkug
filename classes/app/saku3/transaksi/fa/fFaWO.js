window.app_saku3_transaksi_fa_fFaWO = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_fa_fFaWO.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_fa_fFaWO";
		...
		try {
			...
			this.cb_fa.setSQL("select a.no_fa, a.nama from fa_asset a "+
							  ...
							  "where a.progress in ('2','L') and zz.nilai-isnull(tot_susut,0)>=a.nilai_residu and a.kode_lokasi='"+this.app._lokasi+"'",["a.no_fa","a.nama"],false,["No Aktap","Nama"],"and","Daftar Aktiva Tetap",true);
...
window.app_saku3_transaksi_fa_fFaWO.extend(window.childForm);
window.app_saku3_transaksi_fa_fFaWO.implement({
