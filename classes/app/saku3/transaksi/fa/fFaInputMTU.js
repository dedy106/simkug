window.app_saku3_transaksi_fa_fFaInputMTU = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_fa_fFaInputMTU.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_fa_fFaInputMTU";
		...
		this.e_fa = new saiLabelEdit(this,{bound:[20,10,200,20],caption:"No Aktap",readOnly:true});
		...
		this.e_jml = new saiLabelEdit(this,{bound:[250,10,202,20],caption:"Jumlah", tag:1, maxLength:5,tipeText:ttNilai, text:"1",change:[this,"doChange"]});		
...
window.app_saku3_transaksi_fa_fFaInputMTU.extend(window.childForm);
window.app_saku3_transaksi_fa_fFaInputMTU.implement({
		...
		try{						
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					var nbfa = nbfa2 = this.standarLib.noBuktiOtomatis(this.dbLib,"fa_asset","no_fa",this.app._lokasi+"-FA"+this.e_periode.getText().substr(2,4)+".","00000");
					nbfa = nbfa.substr(0,10);
					var idx = parseFloat(nbfa2.substr(10,5));
					var nu = idx2 = "";
	...
	doClick:function(sender){
		this.e_fa.setText(this.standarLib.noBuktiOtomatis(this.dbLib,"fa_asset","no_fa",this.app._lokasi+"-FA"+this.e_periode.getText().substr(2,4)+".","00000"));
		this.e_jml.setFocus();
	},
