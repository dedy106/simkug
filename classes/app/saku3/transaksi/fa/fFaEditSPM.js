window.app_saku3_transaksi_fa_fFaEditSPM = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_fa_fFaEditSPM.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_fa_fFaEditSPM";
...
window.app_saku3_transaksi_fa_fFaEditSPM.extend(window.childForm);
window.app_saku3_transaksi_fa_fFaEditSPM.implement({
