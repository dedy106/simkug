window.app_saku3_transaksi_fa_fFasusutCepat = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_fa_fFasusutCepat.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_fa_fFasusutCepat";
...
window.app_saku3_transaksi_fa_fFasusutCepat.extend(window.childForm);
window.app_saku3_transaksi_fa_fFasusutCepat.implement({
