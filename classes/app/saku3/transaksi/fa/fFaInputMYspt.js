window.app_saku3_transaksi_fa_fFaInputMYspt = function (owner) {
	if (owner) {
		window.app_saku3_transaksi_fa_fFaInputMYspt.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku3_transaksi_fa_fFaInputMYspt";
...
window.app_saku3_transaksi_fa_fFaInputMYspt.extend(window.childForm);
window.app_saku3_transaksi_fa_fFaInputMYspt.implement({
