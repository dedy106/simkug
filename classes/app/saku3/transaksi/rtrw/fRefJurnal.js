window.app_saku3_transaksi_rtrw_fRefJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_rtrw_fRefJurnal.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_rtrw_fRefJurnal";
		...
		this.cb_debet = new saiCBBL(this,{bound:[20,15,220,20],caption:"Akun Debet", multiSelection:false, maxLength:10, tag:2});				
		this.cb_kredit = new saiCBBL(this,{bound:[20,16,220,20],caption:"Akun Kredit", multiSelection:false, maxLength:10, tag:2});				
		this.e_nilai = new saiLabelEdit(this,{bound:[20,17,200,20],caption:"Nilai", tag:1, tipeText:ttNilai, text:"0"});		
		this.cb_pp = new saiCBBL(this,{bound:[20,16,220,20],caption:"PP", multiSelection:false, maxLength:10, tag:2});				
		this.c_modul = new saiCB(this,{bound:[20,12,200,20],caption:"Modul",items:["KB","GL"], readOnly:true,tag:2});
...
window.app_saku3_transaksi_rtrw_fRefJurnal.extend(window.childForm);
window.app_saku3_transaksi_rtrw_fRefJurnal.implement({
	...
	doChange: function(sender){
		try{
			if (this.cb_kode.getText() != ""){
				var strSQL = "select modul,kode_jurnal,nama,keterangan,akun_debet,akun_kredit,nilai,kode_pp from refju_dual where kode_jurnal ='"+this.cb_kode.getText()+"' and kode_lokasi='"+this.app._lokasi+"'";
