window.app_saku3_transaksi_rtrw_versi2_fKbLain = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_rtrw_versi2_fKbLain.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_rtrw_versi2_fKbLain";
...
window.app_saku3_transaksi_rtrw_versi2_fKbLain.extend(window.childForm);
window.app_saku3_transaksi_rtrw_versi2_fKbLain.implement({
