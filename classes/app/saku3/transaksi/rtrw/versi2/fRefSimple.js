window.app_saku3_transaksi_rtrw_versi2_fRefSimple = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_rtrw_versi2_fRefSimple.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_rtrw_versi2_fRefSimple";
...
window.app_saku3_transaksi_rtrw_versi2_fRefSimple.extend(window.childForm);
window.app_saku3_transaksi_rtrw_versi2_fRefSimple.implement({
