window.app_saku3_transaksi_rtrw_versi2_fUbahPwd = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_rtrw_versi2_fUbahPwd.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_rtrw_versi2_fUbahPwd";
...
window.app_saku3_transaksi_rtrw_versi2_fUbahPwd.extend(window.childForm);
window.app_saku3_transaksi_rtrw_versi2_fUbahPwd.implement({
