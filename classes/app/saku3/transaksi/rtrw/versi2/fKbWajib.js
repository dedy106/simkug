window.app_saku3_transaksi_rtrw_versi2_fKbWajib = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_rtrw_versi2_fKbWajib.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_rtrw_versi2_fKbWajib";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form KasBank Penerimaan Iuran Wajib", 0);	
		...
		this.c_jbayar = new saiCB(this.pc2.childPage[0],{bound:[790,15,200,20],caption:"Status Bayar",items:["NORMAL","APIH","HAPUS"], readOnly:true,tag:2});
...
window.app_saku3_transaksi_rtrw_versi2_fKbWajib.extend(window.childForm);
window.app_saku3_transaksi_rtrw_versi2_fKbWajib.implement({
		...
		try{						
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					if (this.c_jbayar.getText() == "NORMAL") {
						sql.add("insert into trans_m (no_bukti,kode_lokasi,tgl_input,nik_user,periode,modul,form,posted,prog_seb,progress,kode_pp,tanggal,no_dokumen,keterangan,kode_curr,kurs,nilai1,nilai2,nilai3,nik1,nik2,nik3,no_ref1,no_ref2,no_ref3,param1,param2,param3) values "+
								...
								"','IDR',1,"+kasIDR+",0,0,'-','-','-','-','-','-','"+this.cb_rumah.getText()+"','"+this.cb_jenis.getText()+"','-')");
											
						/*
						sql.add("insert into trans_j (no_bukti,kode_lokasi,tgl_input,nik_user,periode,no_dokumen,tanggal,nu,kode_akun,dc,nilai,nilai_curr,keterangan,modul,jenis,kode_curr,kurs,kode_pp,kode_drk,kode_cust,kode_vendor,no_fa,no_selesai,no_ref1,no_ref2,no_ref3) values "+
								"('"+this.e_nb.getText()+"','"+this.app._lokasi+"',getdate(),'"+this.app._userLog+"','"+this.e_periode.getText()+"','-','"+this.dp_d1.getDateString()+"',0,'"+this.akunKasRW+"','D',"+this.nilaiRW+","+this.nilaiRW+",'"+this.e_ket.getText()+"','RTRW','KBRW','IDR',1,'"+this.kodePP+"','-','-','-','-','-','-','-','-')");				
						sql.add("insert into trans_j (no_bukti,kode_lokasi,tgl_input,nik_user,periode,no_dokumen,tanggal,nu,kode_akun,dc,nilai,nilai_curr,keterangan,modul,jenis,kode_curr,kurs,kode_pp,kode_drk,kode_cust,kode_vendor,no_fa,no_selesai,no_ref1,no_ref2,no_ref3) values "+
								"('"+this.e_nb.getText()+"','"+this.app._lokasi+"',getdate(),'"+this.app._userLog+"','"+this.e_periode.getText()+"','-','"+this.dp_d1.getDateString()+"',0,'"+this.akunKas+"','D',"+this.nilaiRT+","+this.nilaiRT+",'"+this.e_ket.getText()+"','RTRW','KBRT','IDR',1,'"+this.kodePP+"','-','-','-','-','-','-','-','-')");				
						*/

						var totalBayar = this.nilaiRT + this.nilaiRW;
						sql.add("insert into trans_j (no_bukti,kode_lokasi,tgl_input,nik_user,periode,no_dokumen,tanggal,nu,kode_akun,dc,nilai,nilai_curr,keterangan,modul,jenis,kode_curr,kurs,kode_pp,kode_drk,kode_cust,kode_vendor,no_fa,no_selesai,no_ref1,no_ref2,no_ref3) values "+
								"('"+this.e_nb.getText()+"','"+this.app._lokasi+"',getdate(),'"+this.app._userLog+"','"+this.e_periode.getText()+"','-','"+this.dp_d1.getDateString()+"',0,'"+this.akunKas+"','D',"+totalBayar+","+totalBayar+",'"+this.e_ket.getText()+"','RTRW','KBRT','IDR',1,'"+this.kodePP+"','-','-','-','-','-','-','-','-')");				
						...
						sql.add("insert into trans_j (no_bukti,kode_lokasi,tgl_input,nik_user,periode,no_dokumen,tanggal,nu,kode_akun,dc,nilai,nilai_curr,keterangan,modul,jenis,kode_curr,kurs,kode_pp,kode_drk,kode_cust,kode_vendor,no_fa,no_selesai,no_ref1,no_ref2,no_ref3) values "+
								"('"+this.e_nb.getText()+"','"+this.app._lokasi+"',getdate(),'"+this.app._userLog+"','"+this.e_periode.getText()+"','-','"+this.dp_d1.getDateString()+"',2,'"+this.akunTitip+"','C',"+totalBayar+","+totalBayar+",'"+this.e_ket.getText()+"','RTRW','TITIP','IDR',1,'"+this.kodePP+"','-','-','-','-','-','-','-','-')");
					...
					if (this.c_jbayar.getText() == "APIH") {
						for (var i=0;i < this.sg1.getRowCount();i++){
							if (this.sg1.rowValid(i) && this.sg1.cells(0,i) == "BAYAR"){
								sql.add("insert into rt_angs_d (no_angs,kode_rumah,kode_jenis,periode_bill,periode_angs,nilai_rt,nilai_rw,kode_lokasi,kode_pp,dc,modul,jenis,no_setor) values "+
										"('18-REKONAPIH.01','"+this.cb_rumah.getText()+"','"+this.cb_jenis.getText()+"','"+this.sg1.cells(1,i)+"','"+this.e_periode.getText()+"',"+nilaiToFloat(this.sg1.cells(2,i))+","+nilaiToFloat(this.sg1.cells(3,i))+",'"+this.app._lokasi+"','"+this.kodePP+"','D','KBIUR','APIH','BELUM')");									
							}
						}
					}


					if (this.c_jbayar.getText() == "HAPUS") {
						for (var i=0;i < this.sg1.getRowCount();i++){
							if (this.sg1.rowValid(i) && this.sg1.cells(0,i) == "BAYAR"){
								sql.add("insert into rt_angs_d (no_angs,kode_rumah,kode_jenis,periode_bill,periode_angs,nilai_rt,nilai_rw,kode_lokasi,kode_pp,dc,modul,jenis,no_setor) values "+
										"('18-16HAPUS.01','"+this.cb_rumah.getText()+"','"+this.cb_jenis.getText()+"','"+this.sg1.cells(1,i)+"','"+this.e_periode.getText()+"',"+nilaiToFloat(this.sg1.cells(2,i))+","+nilaiToFloat(this.sg1.cells(3,i))+",'"+this.app._lokasi+"','"+this.kodePP+"','D','KBIUR','WO','HAPUS')");									
							}
						}
					}
			...
			if (sender == this.cb_rumah && this.cb_rumah.getText()!="") {
				...
				if (typeof data == "object"){
					...
					if (line != undefined){				
						...
						this.akunKas = line.akun_kas;
						this.akunKasRW = line.akun_kastitip;
