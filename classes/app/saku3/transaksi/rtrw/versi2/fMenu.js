...
//* 			SAI, PT											
//***********************************************************************************************
window.app_saku3_transaksi_rtrw_versi2_fMenu = function(owner){
	if (owner){
		try{
			window.app_saku3_transaksi_rtrw_versi2_fMenu.prototype.parent.constructor.call(this, owner);
			this.className = "app_saku3_transaksi_rtrw_versi2_fMenu";
...
window.app_saku3_transaksi_rtrw_versi2_fMenu.extend(window.portalui_childForm);
window.app_saku3_transaksi_rtrw_versi2_fMenu.implement({
	...
	entriesClick: function(sender){
		try{
			uses("app_saku3_transaksi_rtrw_versi2_fMenuDetail");	
			if (this.entryMenu !== undefined) this.entryMenu.free();
			this.entryMenu = new app_saku3_transaksi_rtrw_versi2_fMenuDetail(this.app);
