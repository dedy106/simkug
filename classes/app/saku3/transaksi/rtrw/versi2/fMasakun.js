window.app_saku3_transaksi_rtrw_versi2_fMasakun = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_rtrw_versi2_fMasakun.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_rtrw_versi2_fMasakun";
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Data Pos-Pos Keuangan", 0);	
		...
		try {
			...
			this.cb_gar.setSQL("select kode_gar, nama from masgar where kode_lokasi='"+this.app._lokasi+"' union select '-','-' ",["kode_gar","nama"],false,["Kode","Nama"],"and","Data Mata Anggaran",true);
...
window.app_saku3_transaksi_rtrw_versi2_fMasakun.extend(window.childForm);
window.app_saku3_transaksi_rtrw_versi2_fMasakun.implement({
