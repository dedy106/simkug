window.app_saku3_transaksi_rtrw_versi2_fPeriodeAktif = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_rtrw_versi2_fPeriodeAktif.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_rtrw_versi2_fPeriodeAktif";
...
window.app_saku3_transaksi_rtrw_versi2_fPeriodeAktif.extend(window.childForm);
window.app_saku3_transaksi_rtrw_versi2_fPeriodeAktif.implement({
