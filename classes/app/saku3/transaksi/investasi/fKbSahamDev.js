window.app_saku3_transaksi_investasi_fKbSahamDev = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_investasi_fKbSahamDev.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_investasi_fKbSahamDev";
...
window.app_saku3_transaksi_investasi_fKbSahamDev.extend(window.childForm);
window.app_saku3_transaksi_investasi_fKbSahamDev.implement({
