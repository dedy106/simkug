window.app_saku3_transaksi_investasi_fKbSahamBeliE = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_investasi_fKbSahamBeliE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_investasi_fKbSahamBeliE";
...
window.app_saku3_transaksi_investasi_fKbSahamBeliE.extend(window.childForm);
window.app_saku3_transaksi_investasi_fKbSahamBeliE.implement({
