window.app_saku3_transaksi_investasi_fDOCEdit = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_investasi_fDOCEdit.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_investasi_fDOCEdit";
...
window.app_saku3_transaksi_investasi_fDOCEdit.extend(window.childForm);
window.app_saku3_transaksi_investasi_fDOCEdit.implement({
