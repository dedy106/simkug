window.app_saku3_transaksi_investasi_fKbSahamJual = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_investasi_fKbSahamJual.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_investasi_fKbSahamJual";
...
window.app_saku3_transaksi_investasi_fKbSahamJual.extend(window.childForm);
window.app_saku3_transaksi_investasi_fKbSahamJual.implement({
