window.app_saku3_transaksi_investasi_fRDSPIE = function(owner)
{
	if (owner)
	{		
		window.app_saku3_transaksi_investasi_fRDSPIE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_investasi_fRDSPIE";
...
window.app_saku3_transaksi_investasi_fRDSPIE.extend(window.childForm);
window.app_saku3_transaksi_investasi_fRDSPIE.implement({		
