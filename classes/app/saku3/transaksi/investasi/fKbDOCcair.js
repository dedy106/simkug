window.app_saku3_transaksi_investasi_fKBDOCcair = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_investasi_fKBDOCcair.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_investasi_fKBDOCcair";
...
window.app_saku3_transaksi_investasi_fKBDOCcair.extend(window.childForm);
window.app_saku3_transaksi_investasi_fKBDOCcair.implement({
