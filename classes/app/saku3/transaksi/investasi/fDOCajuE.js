window.app_saku3_transaksi_investasi_fDOCajuE = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_investasi_fDOCajuE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_investasi_fDOCajuE";
		...
		this.cb_bank = new saiCBBL(this,{bound:[20,19,222,20],caption:"Bank Sumber", multiSelection:false, maxLength:10, tag:2});		
...
window.app_saku3_transaksi_investasi_fDOCajuE.extend(window.childForm);
window.app_saku3_transaksi_investasi_fDOCajuE.implement({
