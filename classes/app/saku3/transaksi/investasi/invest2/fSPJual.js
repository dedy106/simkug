window.app_saku3_transaksi_investasi_invest2_fSPJual = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_investasi_invest2_fSPJual.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_investasi_invest2_fSPJual";
...
window.app_saku3_transaksi_investasi_invest2_fSPJual.extend(window.childForm);
window.app_saku3_transaksi_investasi_invest2_fSPJual.implement({
