window.app_saku3_transaksi_investasi_invest2_fObliJenis = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_investasi_invest2_fObliJenis.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_investasi_invest2_fObliJenis";
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Data Obligasi", 0);	
		
		uses("saiCB;saiCBBL;saiEdit;datePicker;saiGrid;sgNavigator;pageControl;checkBox");
		this.pc2 = new pageControl(this,{bound:[10,10,1000,440], childPage:["List Obligasi","Data Obligasi"]});		
		...
		this.cb_obligor = new saiCBBL(this.pc2.childPage[1],{bound:[20,21,220,20],caption:"Obligor", multiSelection:false, maxLength:10, tag:2});
...
window.app_saku3_transaksi_investasi_invest2_fObliJenis.extend(window.childForm);
window.app_saku3_transaksi_investasi_invest2_fObliJenis.implement({
	...
	doLoad3:function(sender){														
		var strSQL = "select kode_jenis,nama from inv_oblijenis order by kode_jenis";
		...
		if (typeof data == "object" && data.rs.rows[0] != undefined){
			...
			for (var i=0;i<this.dataJU3.rs.rows.length;i++){
				...
				this.sg3.appendData([line.kode_jenis,line.nama]); 
			}			
