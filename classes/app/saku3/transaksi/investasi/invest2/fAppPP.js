window.app_saku3_transaksi_investasi_invest2_fAppPP = function(owner)
{
	if (owner)
	{		
		window.app_saku3_transaksi_investasi_invest2_fAppPP.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_investasi_invest2_fAppPP";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Approval Properti", 0);	
		...
		this.sg1 = new saiGrid(this.pc1.childPage[1],{bound:[1,5,this.pc1.width-5,212],colCount:5,tag:0,				
				colTitle:["Kd Properti","Nama Mitra","Harga","Jml Lbr","Nilai"],
		...
		this.c_modul2 = new saiCB(this.pc1.childPage[3],{bound:[20,11,200,20],caption:"Modul",items:["PPBELI","PPJUAL","PPSPI"], readOnly:true,tag:9,change:[this,"doChange"]});
...
window.app_saku3_transaksi_investasi_invest2_fAppPP.extend(window.childForm);
window.app_saku3_transaksi_investasi_invest2_fAppPP.implement({	
		...
		try{														
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					//---------------- flag bukti					
					if (this.e_modul.getText() == "PPBELI") sql.add("update inv_ppbeli_m set no_app1='"+this.e_nb.getText()+"',progress='"+vStatus+"' where no_ppbeli='"+this.e_nobukti.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");
					if (this.e_modul.getText() == "PPJUAL") sql.add("update inv_ppjual_m set no_app1='"+this.e_nb.getText()+"',progress='"+vStatus+"' where no_ppjual='"+this.e_nobukti.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");
					if (this.e_modul.getText() == "PPSPI") sql.add("update inv_ppspi_m set no_app1='"+this.e_nb.getText()+"',progress='"+vStatus+"' where no_spi='"+this.e_nobukti.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");
	...
	doModalResult: function(event, modalResult){
		...
		switch (event){
			...
			case "hapus" :	
				...
				if (this.e_modul.getText() == "PPBELI") sql.add("update inv_ppbeli_m set no_app1='-',progress='0' where no_ppbeli='"+this.e_nobukti.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");				
				if (this.e_modul.getText() == "PPJUAL") sql.add("update inv_ppjual_m set no_app1='-',progress='0' where no_ppjual='"+this.e_nobukti.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");								
				if (this.e_modul.getText() == "PPSPI") sql.add("update inv_ppspi_m set no_app1='-',progress='0' where no_spi='"+this.e_nobukti.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");
	...
	doChange:function(sender){				
		if (sender == this.c_modul2 && this.e_periode.getText() != "") {
			if (this.c_modul2.getText() == "PPBELI") this.cb_nb.setSQL("select no_ppbeli keterangan from inv_ppbeli_m where modul='PPBELI' and periode='"+this.e_periode.getText()+"' and progress in ('1','M') and kode_lokasi='"+this.app._lokasi+"'",["no_ppbeli","keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);				
			if (this.c_modul2.getText() == "PPJUAL") this.cb_nb.setSQL("select no_ppjual, keterangan from inv_ppjual_m where modul='PPJUAL' and periode='"+this.e_periode.getText()+"' and progress in ('1','M') and kode_lokasi='"+this.app._lokasi+"'",["no_ppjual","keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);				
			if (this.c_modul2.getText() == "PPSPI") this.cb_nb.setSQL("select no_spi, keterangan from inv_ppspi_m where modul='PPSPI' and periode='"+this.e_periode.getText()+"' and progress in ('1','M') and kode_lokasi='"+this.app._lokasi+"'",["no_spi","keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);							
		}
		if (sender == this.cb_nb && this.cb_nb.getText() != "") {
			if (this.c_modul2.getText() == "PPBELI") {					
				var strSQL = "select a.tgl_set as due_date,a.no_ppbeli as no_bukti,case a.progress when '1' then 'APPROVE' else 'RETURN' end as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.tgl_set,103) as tgl2,a.modul,a.keterangan,a.nilai,a.no_app1,convert(varchar,a.tgl_input,120) as tglinput,b.nik+' - '+b.nama as buat "+
							 "from inv_ppbeli_m a inner join karyawan b on a.nik_buat=b.nik "+					 
							 "where a.no_ppbeli='"+this.cb_nb.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' ";
			...
			if (this.c_modul2.getText() == "PPJUAL") {					
				var strSQL = "select a.tgl_set as due_date,a.no_ppjual as no_bukti,case a.progress when '1' then 'APPROVE' else 'RETURN' end as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.tgl_set,103) as tgl2,a.modul,a.keterangan,a.nilai_piutang+a.nilai_piugl as nilai,a.no_app1,convert(varchar,a.tgl_input,120) as tglinput,b.nik+' - '+b.nama as buat "+
							 "from inv_ppjual_m a inner join karyawan b on a.nik_buat=b.nik "+					 
							 "where a.no_ppjual='"+this.cb_nb.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' ";
			...
			if (this.c_modul2.getText() == "PPSPI") {					
				var strSQL = "select a.tanggal as due_date,a.no_spi as no_bukti,case a.progress when '1' then 'APPROVE' else 'RETURN' end as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.tanggal,103) as tgl2,a.modul,a.keterangan,a.nilai,a.no_app1,convert(varchar,a.tgl_input,120) as tglinput,b.nik+' - '+b.nama as buat "+
							 "from inv_ppspi_m a inner join karyawan b on a.nik_buat=b.nik "+					 
	...
	doClick:function(sender){		
		this.e_nb.setText(this.standarLib.noBuktiOtomatis(this.dbLib,"inv_app2_m","no_app",this.app._lokasi+"-PPM"+this.e_periode.getText().substr(2,4)+".","0000"));												
	...
	doLoadData:function(){
		if (this.e_modul.getText() == "PPBELI") {
			strSQL1 = "select a.kode_properti,b.nama,a.harga,a.jumlah,a.n_beli "+
					  "from inv_ppbeli_d a inner join inv_properti b on a.kode_properti=b.kode_properti "+					 					 
					  "where a.no_ppbeli='"+this.e_nobukti.getText()+"' ";					
			...
			if (typeof data1 == "object" && data1.rs.rows[0] != undefined){
				...
				for (var i in data1.rs.rows){
					...
					this.sg1.appendData([line1.kode_properti,line1.nama,parseFloat(line1.harga),parseFloat(line1.jumlah),parseFloat(line1.n_beli)]);
				}
			} else this.sg1.clear(1);									
		}
		if (this.e_modul.getText() == "PPJUAL") {
			var strSQL1 = "select b.kode_properti,b.nama,d.h_jual,d.jumlah as jml,d.n_jual "+
						 "from inv_ppjual_d d "+						 
						 "     inner join inv_properti b on d.kode_properti=b.kode_properti "+						 
						 "where d.no_ppjual = '"+this.e_nobukti.getText()+"' ";			
			...
			if (typeof data == "object" && data.rs.rows[0] != undefined){
				...
				for (var i in data.rs.rows){
					line = data.rs.rows[i];																													
					this.sg1.appendData([line.kode_properti,line.nama,floatToNilai(line.h_jual),floatToNilai(line.jml),floatToNilai(line.n_jual),floatToNilai(line.komisi),floatToNilai(line.vat),floatToNilai(line.levi),floatToNilai(line.pph)]);
				}					
			} else this.sg1.clear(1);															
		}		
		
		if (this.e_modul.getText() == "PPSPI") {
			var strSQL1 = "select d.kode_properti,b.nama,(d.h_wajar-d.h_buku) * d.jumlah as nilai "+
						 "from inv_ppspi_d d "+						 
						 "     inner join inv_properti b on d.kode_properti=b.kode_properti "+						 
			...
			if (typeof data == "object" && data.rs.rows[0] != undefined){
				...
				for (var i in data.rs.rows){
					line = data.rs.rows[i];						
					this.sg1.appendData([line.kode_properti,line.nama,"0","0",floatToNilai(line.nilai)]);
	...
	doLoadGar:function(){			
		if (this.e_modul.getText() == "PPBELI" || this.e_modul.getText() == "PPJUAL" ) {
	...
	doLoadJurnal:function(){
		if (this.e_modul.getText() == "PPBELI") {			  
			var strSQL3 = "select b.kode_akun,b.nama as nama_akun,a.dc,a.keterangan,a.nilai,a.kode_pp,c.nama as nama_pp,d.kode_drk,isnull(d.nama,'-') as nama_drk "+
					  "from inv_ppbeli_j a inner join masakun b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi "+
					  "               inner join pp c on a.kode_pp=c.kode_pp and a.kode_lokasi=c.kode_lokasi "+												  
					  "               left join drk d on d.kode_drk=a.kode_drk and d.kode_lokasi=a.kode_lokasi and d.tahun=substring(a.periode,1,4) "+
					  "where a.no_ppbeli = '"+this.e_nobukti.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' order by a.dc desc";
		}
		if (this.e_modul.getText() == "PPJUAL") {			  
			var strSQL3 = "select b.kode_akun,b.nama as nama_akun,a.dc,a.keterangan,a.nilai,a.kode_pp,c.nama as nama_pp,d.kode_drk,isnull(d.nama,'-') as nama_drk "+
					  "from inv_ppjual_j a inner join masakun b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi "+
					  "               inner join pp c on a.kode_pp=c.kode_pp and a.kode_lokasi=c.kode_lokasi "+												  
					  "               left join drk d on d.kode_drk=a.kode_drk and d.kode_lokasi=a.kode_lokasi and d.tahun=substring(a.periode,1,4) "+
					  "where a.no_ppjual = '"+this.e_nobukti.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' order by a.dc desc";
		}
	...
	doLoad:function(sender){																		
		var strSQL = "select a.tgl_set as due_date,a.no_ppbeli as no_bukti,'INPROG' as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.tgl_set,103) as tgl2,a.modul,a.keterangan,a.nilai,a.no_app1,convert(varchar,a.tgl_input,120) as tglinput,b.nik+' - '+b.nama as buat "+
		             "from inv_ppbeli_m a inner join karyawan b on a.nik_buat=b.nik "+					 
					 "where a.progress='0' and a.kode_lokasi='"+this.app._lokasi+"' "+					 					 
		
					 "union all "+
					 "select a.tgl_set as due_date,a.no_ppjual as no_bukti,'INPROG' as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.tgl_set,103) as tgl2,a.modul,a.keterangan,a.nilai_piutang+a.nilai_piugl as nilai,a.no_app1,convert(varchar,a.tgl_input,120) as tglinput,b.nik+' - '+b.nama as buat "+
		             "from inv_ppjual_m a inner join karyawan b on a.nik_buat=b.nik "+					 
					 "where a.progress='0' and a.kode_lokasi='"+this.app._lokasi+"' "+					 					 
