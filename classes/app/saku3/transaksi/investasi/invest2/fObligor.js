window.app_saku3_transaksi_investasi_invest2_fObligor = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_investasi_invest2_fObligor.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_investasi_invest2_fObligor";
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Data Obligor", 0);	
		
		uses("saiCB;saiCBBL;saiEdit;datePicker;saiGrid;sgNavigator;pageControl;checkBox");
		this.pc2 = new pageControl(this,{bound:[10,10,1000,440], childPage:["List Obligor","Data Obligor"]});		
		...
		this.cb_obligasi = new saiCBBL(this.pc2.childPage[1],{bound:[20,20,220,20],caption:"Akun Obligasi", multiSelection:false, maxLength:10, tag:2});		
		this.cb_piutang = new saiCBBL(this.pc2.childPage[1],{bound:[20,21,220,20],caption:"Akun Piu. Obligasi", multiSelection:false, maxLength:10, tag:2});		
		this.cb_piukupon = new saiCBBL(this.pc2.childPage[1],{bound:[20,22,220,20],caption:"Akun Piu. Kupon", multiSelection:false, maxLength:10, tag:2});		
		this.cb_pdpt = new saiCBBL(this.pc2.childPage[1],{bound:[20,11,220,20],caption:"Akun Ppdt Kupon", multiSelection:false, maxLength:10, tag:2});						
		this.cb_amor = new saiCBBL(this.pc2.childPage[1],{bound:[20,13,220,20],caption:"Akun Ppdt Amor", multiSelection:false, maxLength:10, tag:2});						
		this.cb_spi = new saiCBBL(this.pc2.childPage[1],{bound:[20,14,220,20],caption:"Akun SPI", multiSelection:false, maxLength:10, tag:2});						
		this.cb_gainlos = new saiCBBL(this.pc2.childPage[1],{bound:[20,12,220,20],caption:"Akun Gain/Loss", multiSelection:false, maxLength:10, tag:2});						
...
window.app_saku3_transaksi_investasi_invest2_fObligor.extend(window.childForm);
window.app_saku3_transaksi_investasi_invest2_fObligor.implement({
	...
	doLoad3:function(sender){														
		...
		if (typeof data == "object" && data.rs.rows[0] != undefined){
			...
			for (var i=0;i<this.dataJU3.rs.rows.length;i++){
				...
				this.sg3.appendData([line.kode_obligor,line.nama]); 
			}			
