window.app_saku3_transaksi_investasi_fKbpinbukE = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_investasi_fKbpinbukE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_investasi_fKbpinbukE";
...
window.app_saku3_transaksi_investasi_fKbpinbukE.extend(window.childForm);
window.app_saku3_transaksi_investasi_fKbpinbukE.implement({
	...
	doChange:function(sender){
		...
		if (sender == this.e_nb && this.e_nb.getText()!="") {
			...
			var data = this.dbLib.getDataProvider("select kode_rek from inv_bank where kode_bank='"+this.cb_bank.getText()+"'",true);
			if (typeof data == "object"){
				var line = data.rs.rows[0];							
				if (line != undefined){					
