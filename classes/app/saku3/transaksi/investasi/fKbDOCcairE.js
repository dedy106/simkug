window.app_saku3_transaksi_investasi_fKBDOCcairE = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_investasi_fKBDOCcairE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_investasi_fKBDOCcairE";
		...
		this.cb_drk = new saiCBBL(this,{bound:[20,17,200,20],caption:"DRK Biaya Adm", multiSelection:false, maxLength:10, tag:2});				
		...
		this.p1 = new panel(this,{bound:[10,23,900,260],caption:"Daftar Bunga Deposito"});
		...
		try {
			...
			var data = this.dbLib.getDataProvider("select kode_spro,flag from spro where kode_spro in ('DEPOADM','DOCADM','DEPOADMDRK') and kode_lokasi = '"+this.app._lokasi+"'",true);
...
window.app_saku3_transaksi_investasi_fKBDOCcairE.extend(window.childForm);
window.app_saku3_transaksi_investasi_fKBDOCcairE.implement({
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					sql.add("insert into kas_j(no_kas,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,nilai,kode_pp,kode_drk,kode_cf,ref1,kode_lokasi,modul,jenis,periode,kode_curr,kurs,nik_user,tgl_input,kode_bank) values "+
							"('"+this.e_nb.getText()+"','"+this.e_dok.getText()+"','"+this.dp_d1.getDateString()+"',0,'"+this.cb_akun.getText()+"','"+this.e_ket.getText()+"','D',"+parseNilai(this.e_nilai.getText())+",'"+this.app._kodePP+"','-','"+this.cb_cf.getText()+"','-','"+this.app._lokasi+"','KBDOCCAIR','KB','"+this.e_periode.getText()+"','IDR',1,'"+this.app._userLog+"',getdate(),'"+this.cb_rek.getText()+"')");												
