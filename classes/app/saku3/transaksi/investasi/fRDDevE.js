window.app_saku3_transaksi_investasi_fRDDevE = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_investasi_fRDDevE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_investasi_fRDDevE";
...
window.app_saku3_transaksi_investasi_fRDDevE.extend(window.childForm);
window.app_saku3_transaksi_investasi_fRDDevE.implement({
