window.app_saku3_transaksi_investasi_fKbRDJual = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_investasi_fKbRDJual.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_investasi_fKbRDJual";
...
window.app_saku3_transaksi_investasi_fKbRDJual.extend(window.childForm);
window.app_saku3_transaksi_investasi_fKbRDJual.implement({
