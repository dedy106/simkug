window.app_saku3_transaksi_investasi_fSaham = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_investasi_fSaham.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_investasi_fSaham";
		...
		this.sg1 = new saiGrid(this.p1,{bound:[0,20,795,315],tag:9,readOnly:true,colTitle: ["Kode","Nama","Kelompok"]});		
...
window.app_saku3_transaksi_investasi_fSaham.extend(window.childForm);
window.app_saku3_transaksi_investasi_fSaham.implement({
