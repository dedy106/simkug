window.app_saku3_transaksi_logistik_fPenetapanTDTU = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_logistik_fPenetapanTDTU.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_logistik_fPenetapanTDTU";
...
window.app_saku3_transaksi_logistik_fPenetapanTDTU.extend(window.childForm);
window.app_saku3_transaksi_logistik_fPenetapanTDTU.implement({	
