window.app_saku3_transaksi_logistik_fSpkTDTU = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_logistik_fSpkTDTU.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_logistik_fSpkTDTU";
...
window.app_saku3_transaksi_logistik_fSpkTDTU.extend(window.childForm);
window.app_saku3_transaksi_logistik_fSpkTDTU.implement({	
