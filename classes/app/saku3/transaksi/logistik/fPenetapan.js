window.app_saku3_transaksi_logistik_fPenetapan = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_logistik_fPenetapan.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_logistik_fPenetapan";
...
window.app_saku3_transaksi_logistik_fPenetapan.extend(window.childForm);
window.app_saku3_transaksi_logistik_fPenetapan.implement({	
