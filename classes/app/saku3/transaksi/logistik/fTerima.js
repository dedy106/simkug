window.app_saku3_transaksi_logistik_fTerima = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_logistik_fTerima.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_logistik_fTerima";
...
window.app_saku3_transaksi_logistik_fTerima.extend(window.childForm);
window.app_saku3_transaksi_logistik_fTerima.implement({	
