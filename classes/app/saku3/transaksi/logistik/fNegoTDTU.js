window.app_saku3_transaksi_logistik_fNegoTDTU = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_logistik_fNegoTDTU.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_logistik_fNegoTDTU";
...
window.app_saku3_transaksi_logistik_fNegoTDTU.extend(window.childForm);
window.app_saku3_transaksi_logistik_fNegoTDTU.implement({	
