window.app_saku3_transaksi_logistik_fPbAppLogTU = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_logistik_fPbAppLogTU.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_logistik_fPbAppLogTU";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Approve Justifikasi Kebutuhan : Input", 0);	
...
window.app_saku3_transaksi_logistik_fPbAppLogTU.extend(window.childForm);
window.app_saku3_transaksi_logistik_fPbAppLogTU.implement({	
	...
	doLoad:function(sender){												
		...
		var strSQL = "select a.due_date,a.no_panjar as no_pb,'INPROG' as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.due_date,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,a.no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_app "+
					 ...
					 //"where "+nikApp2+" a.progress='0' and a.kode_lokasi='"+this.app._lokasi+"' "+ 14-4-20
					 ...
					 //"where "+nikApp+" a.progress='0' and a.kode_lokasi='"+this.app._lokasi+"' "+ 14-4-20
					 "where a.progress='0' and a.kode_lokasi='"+this.app._lokasi+"' "+ 
					 "union "+					 					 
					 ...
					 "                   inner join karyawan c on a.nik_buat=c.nik "+					 
					 //"where "+nikApp+" a.progress='0' and a.kode_lokasi='"+this.app._lokasi+"' and a.periode<='"+this.e_periode.getText()+"' "+ 14-4-20
	...
	doCari:function(sender){						
		...
		if (this.app._userStatus == "A") var nikApp = ""; else var nikApp = " a.nik_app = '"+this.app._userLog+"' and "; 
		if (this.app._userStatus == "A") var nikApp2 = ""; else var nikApp2 = " a.nik_setuju = '"+this.app._userLog+"' and "; 
		var strSQL = "select a.due_date, a.no_panjar as no_pb,"+
		             ...
		             "from log_pesan_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
					 "                   inner join karyawan c on a.nik_buat=c.nik "+					 
					// "where "+nikApp+" a.kode_lokasi='"+this.app._lokasi+"' "+filter+" "+ 14/4/20 --deny
					"where a.kode_lokasi='"+this.app._lokasi+"' "+filter+" "+
