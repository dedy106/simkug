window.app_saku3_transaksi_logistik_fPksRO = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_logistik_fPksRO.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_logistik_fPksRO";
...
window.app_saku3_transaksi_logistik_fPksRO.extend(window.childForm);
window.app_saku3_transaksi_logistik_fPksRO.implement({	
