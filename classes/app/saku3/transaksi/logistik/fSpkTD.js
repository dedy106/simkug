window.app_saku3_transaksi_logistik_fSpkTD = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_logistik_fSpkTD.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_logistik_fSpkTD";
...
window.app_saku3_transaksi_logistik_fSpkTD.extend(window.childForm);
window.app_saku3_transaksi_logistik_fSpkTD.implement({	
