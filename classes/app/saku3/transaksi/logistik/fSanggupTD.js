window.app_saku3_transaksi_logistik_fSanggupTD = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_logistik_fSanggupTD.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_logistik_fSanggupTD";
...
window.app_saku3_transaksi_logistik_fSanggupTD.extend(window.childForm);
window.app_saku3_transaksi_logistik_fSanggupTD.implement({	
