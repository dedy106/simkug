window.app_saku3_transaksi_logistik_fSphTender = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_logistik_fSphTender.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_logistik_fSphTender";
...
window.app_saku3_transaksi_logistik_fSphTender.extend(window.childForm);
window.app_saku3_transaksi_logistik_fSphTender.implement({	
