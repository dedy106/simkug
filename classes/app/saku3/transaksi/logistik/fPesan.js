window.app_saku3_transaksi_logistik_fPesan = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_logistik_fPesan.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_logistik_fPesan";
...
window.app_saku3_transaksi_logistik_fPesan.extend(window.childForm);
window.app_saku3_transaksi_logistik_fPesan.implement({	
