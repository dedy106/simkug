window.app_saku3_transaksi_logistik_fNegoPL = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_logistik_fNegoPL.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_logistik_fNegoPL";
...
window.app_saku3_transaksi_logistik_fNegoPL.extend(window.childForm);
window.app_saku3_transaksi_logistik_fNegoPL.implement({	
