window.app_saku3_transaksi_logistik_fBast = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_logistik_fBast.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_logistik_fBast";
...
window.app_saku3_transaksi_logistik_fBast.extend(window.childForm);
window.app_saku3_transaksi_logistik_fBast.implement({	
