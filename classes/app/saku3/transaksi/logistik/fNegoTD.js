window.app_saku3_transaksi_logistik_fNegoTD = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_logistik_fNegoTD.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_logistik_fNegoTD";
...
window.app_saku3_transaksi_logistik_fNegoTD.extend(window.childForm);
window.app_saku3_transaksi_logistik_fNegoTD.implement({	
