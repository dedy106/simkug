window.app_saku3_transaksi_logistik_fPksPL = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_logistik_fPksPL.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_logistik_fPksPL";
...
window.app_saku3_transaksi_logistik_fPksPL.extend(window.childForm);
window.app_saku3_transaksi_logistik_fPksPL.implement({	
