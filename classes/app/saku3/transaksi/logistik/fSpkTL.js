window.app_saku3_transaksi_logistik_fSpkTL = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_logistik_fSpkTL.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_logistik_fSpkTL";
...
window.app_saku3_transaksi_logistik_fSpkTL.extend(window.childForm);
window.app_saku3_transaksi_logistik_fSpkTL.implement({	
