window.app_saku3_transaksi_logistik_fNegoTUPL = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_logistik_fNegoTUPL.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_logistik_fNegoTUPL";
...
window.app_saku3_transaksi_logistik_fNegoTUPL.extend(window.childForm);
window.app_saku3_transaksi_logistik_fNegoTUPL.implement({	
