window.app_saku3_transaksi_logistik_fPks = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_logistik_fPks.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_logistik_fPks";
...
window.app_saku3_transaksi_logistik_fPks.extend(window.childForm);
window.app_saku3_transaksi_logistik_fPks.implement({	
