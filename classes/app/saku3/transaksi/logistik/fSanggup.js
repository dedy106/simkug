window.app_saku3_transaksi_logistik_fSanggup = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_logistik_fSanggup.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_logistik_fSanggup";
...
window.app_saku3_transaksi_logistik_fSanggup.extend(window.childForm);
window.app_saku3_transaksi_logistik_fSanggup.implement({	
