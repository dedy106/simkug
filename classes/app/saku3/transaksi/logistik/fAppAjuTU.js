window.app_saku3_transaksi_logistik_fAppAjuTU = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_logistik_fAppAjuTU.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_logistik_fAppAjuTU";
...
window.app_saku3_transaksi_logistik_fAppAjuTU.extend(window.childForm);
window.app_saku3_transaksi_logistik_fAppAjuTU.implement({	
