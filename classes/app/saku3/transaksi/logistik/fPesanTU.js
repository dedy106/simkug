window.app_saku3_transaksi_logistik_fPesanTU = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_logistik_fPesanTU.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_logistik_fPesanTU";
...
window.app_saku3_transaksi_logistik_fPesanTU.extend(window.childForm);
window.app_saku3_transaksi_logistik_fPesanTU.implement({	
