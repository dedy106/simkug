window.app_saku3_transaksi_logistik_fPksTD = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_logistik_fPksTD.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_logistik_fPksTD";
...
window.app_saku3_transaksi_logistik_fPksTD.extend(window.childForm);
window.app_saku3_transaksi_logistik_fPksTD.implement({	
