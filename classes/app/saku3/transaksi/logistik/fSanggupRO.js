window.app_saku3_transaksi_logistik_fSanggupRO = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_logistik_fSanggupRO.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_logistik_fSanggupRO";
...
window.app_saku3_transaksi_logistik_fSanggupRO.extend(window.childForm);
window.app_saku3_transaksi_logistik_fSanggupRO.implement({	
