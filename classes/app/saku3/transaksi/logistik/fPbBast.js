window.app_saku3_transaksi_logistik_fPbBast = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_logistik_fPbBast.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_logistik_fPbBast";
...
window.app_saku3_transaksi_logistik_fPbBast.extend(window.childForm);
window.app_saku3_transaksi_logistik_fPbBast.implement({		
