window.app_saku3_transaksi_logistik_fAjuTU = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_logistik_fAjuTU.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_logistik_fAjuTU";
...
window.app_saku3_transaksi_logistik_fAjuTU.extend(window.childForm);
window.app_saku3_transaksi_logistik_fAjuTU.implement({	
