window.app_saku3_transaksi_logistik_fSph = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_logistik_fSph.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_logistik_fSph";
		...
		this.cb_vendor = new saiCBBL(this.pc2.childPage[0],{bound:[20,13,220,20],caption:"Mitra", readOnly:true, change:[this,"doChange"]}); //multiSelection:false, maxLength:10, tag:0,
...
window.app_saku3_transaksi_logistik_fSph.extend(window.childForm);
window.app_saku3_transaksi_logistik_fSph.implement({	
