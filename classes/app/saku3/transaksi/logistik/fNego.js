window.app_saku3_transaksi_logistik_fNego = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_logistik_fNego.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_logistik_fNego";
...
window.app_saku3_transaksi_logistik_fNego.extend(window.childForm);
window.app_saku3_transaksi_logistik_fNego.implement({	
