window.app_saku3_transaksi_gar_fAppPusat = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_gar_fAppPusat.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_gar_fAppPusat";
...
window.app_saku3_transaksi_gar_fAppPusat.extend(window.childForm);
window.app_saku3_transaksi_gar_fAppPusat.implement({
	...
	doLoad:function(sender){		
		var strSQL = "select a.kode_lokasi,a.kode_pp+' - '+c.nama as pp,a.no_pdrk as no_bukti,b.no_dokumen,convert(varchar,a.tanggal,103) as tanggal,a.keterangan,a.sts_pdrk as jenis "+
					 ...
					 "where ((a.modul = 'LOCAL' and a.progress='0' and a.kode_lokasi='"+this.app._lokasi+"') or (a.modul in ('MULTI','RRTW') and a.progress='V') or (a.modul = 'ABT' and a.progress='0') ) and a.periode<='"+this.e_periode.getText()+"' ";							
