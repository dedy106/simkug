window.app_saku3_transaksi_gar_fRRAjuLocalSusut = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_gar_fRRAjuLocalSusut.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_gar_fRRAjuLocalSusut";
		...
		try {
			...
			this.cb_akunD.setSQL("select distinct a.kode_akun, a.nama from masakun a inner join anggaran_d b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi "+
			                     ...
			                     "where a.kode_akun like '5107%' and b.periode like '"+this.e_periode.getText().substr(0,4)+"%' and b.kode_lokasi='"+this.app._lokasi+"' "+bidang,["a.kode_akun","a.nama"],false,["Kode","Nama"],"and","Data Akun Donor",true);
...
window.app_saku3_transaksi_gar_fRRAjuLocalSusut.extend(window.childForm);
window.app_saku3_transaksi_gar_fRRAjuLocalSusut.implement({
