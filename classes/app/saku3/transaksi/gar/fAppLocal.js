window.app_saku3_transaksi_gar_fAppLocal = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_gar_fAppLocal.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_gar_fAppLocal";
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Approval RRA Local: Input", 0);	
		
		uses("saiCBBL;saiEdit;datePicker;saiGrid;sgNavigator;pageControl");
		this.e_periode = new portalui_saiLabelEdit(this,{bound:[20,11,202,20],caption:"Periode",tag:2,readOnly:true,change:[this,"doChange"],visible:false});
		this.l_tgl1 = new portalui_label(this,{bound:[20,11,100,18],caption:"Tanggal", underline:true});		
		this.dp_d1 = new portalui_datePicker(this,{bound:[120,11,100,18],selectDate:[this,"doSelectDate"]}); 		
		this.pc1 = new pageControl(this,{bound:[20,12,1000,430], childPage:["Data Reprogramming","Detail Reprogramming"]});
		this.sg = new saiGrid(this.pc1.childPage[0],{bound:[1,5,this.pc1.width-5,this.pc1.height-35],colCount:6,tag:0,
		            colTitle:["PP","No Bukti","No Dokumen","Tanggal","Keterangan","Jenis"],
					colWidth:[[5,4,3,2,1,0],[80,400,80,100,100,200]],
...
window.app_saku3_transaksi_gar_fAppLocal.extend(window.childForm);
window.app_saku3_transaksi_gar_fAppLocal.implement({
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{				
					...
					sql.add("insert into rra_app_m(no_app, kode_lokasi,tanggal,keterangan,modul,periode,no_del,nik_buat,nik_app,nik_user,tgl_input,jenis_form) values "+
						    "('"+this.e_nb.getText()+"','"+this.app._lokasi+"','"+this.dp_d1.getDateString()+"','"+this.e_ket.getText()+"','LOCAL','"+this.e_periode.getText()+"','-','"+this.app._userLog+"','"+this.app._userLog+"','"+this.app._userLog+"',getdate(),'APP')");
					sql.add("insert into rra_app_d(no_app,modul,kode_lokasi,no_bukti,kode_lokbukti,sts_pdrk,catatan,status) values "+
							"('"+this.e_nb.getText()+"','LOCAL','"+this.app._lokasi+"','"+this.e_nopdrk.getText()+"','"+this.app._lokasi+"','RRR','-','"+this.c_status.getText()+"')");
					...
					sql.add("insert into dbtm.dbo.anggaran_d (no_agg,kode_lokasi,no_urut,kode_pp,kode_akun,kode_drk,volume,periode,nilai,nilai_sat,dc,satuan,tgl_input,nik_user,modul,nilai_kas,no_sukka) "+
							"select a.no_agg,a.kode_lokasi,a.no_urut,a.kode_pp,b.akun_tm,a.kode_drk,a.volume,a.periode,sum(a.nilai),sum(a.nilai),a.dc,a.satuan,a.tgl_input,a.nik_user,a.modul,sum(a.nilai),'"+this.e_nopdrk.getText()+"' "+
							"from anggaran_d a inner join xakuntm b on a.kode_akun=b.akun_yakes "+
							"where a.no_agg='"+this.e_nopdrk.getText()+"' "+
	...
	doLoad:function(sender){		
		if (this.app._userStatus == "A") var nikApp = ""; else var nikApp = " a.nik_app3 = '"+this.app._userLog+"' and "; 
		var strSQL = "select a.kode_pp+' - '+c.nama as pp,a.no_pdrk as no_bukti,b.no_dokumen,convert(varchar,a.tanggal,103) as tanggal,a.keterangan,a.sts_pdrk as jenis "+
					 "from rra_pdrk_m a "+
					 "    inner join anggaran_m b on a.no_pdrk=b.no_agg and a.kode_lokasi=b.kode_lokasi "+
					 "    inner join pp c on a.kode_pp=c.kode_pp and a.kode_lokasi=c.kode_lokasi "+
					 "where "+nikApp+" a.modul='LOCAL' and a.progress='0' and a.periode<='"+this.e_periode.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' ";					
	...
	doTampilData: function(page) {
		...
		for (var i=start;i<finish;i++){
			...
			this.sg.appendData([line.pp,line.no_bukti,line.no_dokumen,line.tanggal,line.keterangan,line.jenis.toUpperCase()]);
		}
	...
	doDoubleClick: function(sender, col , row) {
		if (this.sg.cells(1,row) != "") {
			this.e_nopdrk.setText(this.sg.cells(1,row));
