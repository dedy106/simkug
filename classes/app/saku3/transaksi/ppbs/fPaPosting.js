window.app_saku3_transaksi_ppbs_fPaPosting = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_ppbs_fPaPosting.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_ppbs_fPaPosting";
...
window.app_saku3_transaksi_ppbs_fPaPosting.extend(window.childForm);
window.app_saku3_transaksi_ppbs_fPaPosting.implement({
