window.app_saku3_transaksi_ppbs_fPaRkm = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_ppbs_fPaRkm.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_ppbs_fPaRkm";
...
window.app_saku3_transaksi_ppbs_fPaRkm.extend(window.childForm);
window.app_saku3_transaksi_ppbs_fPaRkm.implement({
		...
		try{						
			if (this.standarLib.checkEmptyByTag(this, [0,1])){
				try{									
					...
					sql.add("insert into agg_rkm(kode_rkm,nama,kode_lokasi,flag_aktif,tahun,kode_program,kode_pp) values ('"+
							this.cb_kode.getText()+"','"+this.e_nama.getText()+"','"+this.app._lokasi+"','"+this.c_status.getText().substr(0,1)+"','"+this.c_tahun.getText()+"','"+this.cb_program.getText()+"','"+this.cb_pp.getText()+"')");
					setTipeButton(tbAllFalse);
			...
			if (this.sg.getRowValidCount() > 0){
				...
				for (var i=0;i < this.sg.getRowCount();i++){
					if (this.sg.rowValid(i)){
						sql.add("insert into agg_rkm(kode_rkm,nama,kode_lokasi,flag_aktif,tahun,kode_program,kode_pp) values ('"+
							this.sg.cells(0,i)+"','"+this.sg.cells(1,i)+"','"+this.app._lokasi+"','1','"+this.sg.cells(2,i)+"','"+this.sg.cells(3,i)+"','"+this.sg.cells(4,i)+"')");
	...
	doChange: function(sender){
		try{
			...
			if (this.cb_kode.getText() != ""){
				var strSQL = "select kode_rkm,nama,tahun,kode_program,kode_pp from agg_rkm where kode_rkm ='"+this.cb_kode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' and tahun='"+this.c_tahun.getText()+"'";						   
