window.app_saku3_transaksi_klinik_fVendor = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_klinik_fVendor.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_klinik_fVendor";
...
window.app_saku3_transaksi_klinik_fVendor.extend(window.childForm);
window.app_saku3_transaksi_klinik_fVendor.implement({
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1])){
				try{									
					...
					sql.add("insert into kli_vendor(kode_vendor,kode_lokasi,nama,flag_aktif,alamat,alamat2,no_tel,no_tel2,no_fax,email,npwp,pic) values "+
						    "	('"+this.cb_kode.getText()+"','"+this.app._lokasi+"','"+this.e_nama.getText()+"','1','"+this.e_alamat.getText()+"','"+this.e_alamat2.getText()+"','"+this.e_tel.getText()+"','"+this.e_hp.getText()+"','"+this.e_fax.getText()+"','"+this.e_email.getText()+"','"+this.e_npwp.getText()+"','"+this.e_pic.getText()+"')");
					setTipeButton(tbAllFalse);
		...
		try{						
			if (this.standarLib.checkEmptyByTag(this, [0,1])){
				try {									
					...
					sql.add("update kli_vendor set nama='"+this.e_nama.getText()+"',flag_aktif='"+vSts+"',alamat='"+this.e_alamat.getText()+"',alamat2='"+this.e_alamat2.getText()+"',no_tel='"+this.e_tel.getText()+"',no_tel2='"+this.e_hp.getText()+"',no_fax='"+this.e_fax.getText()+"',email='"+this.e_email.getText()+"',npwp='"+this.e_npwp.getText()+"',pic='"+this.e_pic.getText()+"' "+
