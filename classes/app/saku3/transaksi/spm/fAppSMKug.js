window.app_saku3_transaksi_spm_fAppSMKug = function(owner)
{
	if (owner)
	{		
		window.app_saku3_transaksi_spm_fAppSMKug.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spm_fAppSMKug";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Approval SM Keuangan", 0);	
		...
		this.pc1 = new pageControl(this,{bound:[10,18,1000,407], childPage:["Daftar Bukti","Verifikasi","Item Verifikasi","Jurnal & Budget","File Dok","Filter Data"]});		
		...
		this.sg1 = new saiGrid(this.pc1.childPage[1],{bound:[1,16,this.pc1.width-5,189],colCount:7,tag:9,
...
window.app_saku3_transaksi_spm_fAppSMKug.extend(window.childForm);
window.app_saku3_transaksi_spm_fAppSMKug.implement({	
		...
		try{														
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					if (this.c_status.getText() == "RETURN") var vStatus = "K"; else var vStatus = "4";										
					sql.add("update spm_app_m set no_flag='"+this.e_nb.getText()+"' where no_bukti='"+this.e_nobukti.getText()+"' and no_flag='-' and form='APPKUG' and modul='"+this.e_modul.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");
					...
					sql.add("insert into spm_app_m (no_app,kode_lokasi,tanggal,periode,tgl_input,nik_user,status,modul,form,no_bukti,catatan,no_flag,nik_bdh,nik_fiat) values "+
							"('"+this.e_nb.getText()+"','"+this.app._lokasi+"','"+this.dp_d1.getDateString()+"','"+this.e_periode.getText()+"',getdate(),'"+this.app._userLog+"','"+vStatus+"','"+this.e_modul.getText()+"','APPKUG','"+this.e_nobukti.getText()+"','"+this.e_memo.getText()+"','-','X','X')");
												
					//---------------- flag bukti					
					if (this.e_modul.getText() == "IFAJU") sql.add("update spm_if_m set no_app3='"+this.e_nb.getText()+"',progress='"+vStatus+"' where no_if='"+this.e_nobukti.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");
					if (this.e_modul.getText() == "IFREIM") sql.add("update spm_ifreim_m set no_app3='"+this.e_nb.getText()+"',progress='"+vStatus+"' where no_reim='"+this.e_nobukti.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");
					if (this.e_modul.getText() == "PBBAU") sql.add("update yk_pb_m set no_app3='"+this.e_nb.getText()+"',progress='"+vStatus+"' where no_pb='"+this.e_nobukti.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");
					if (this.e_modul.getText() == "PBPR") sql.add("update yk_pb_m set no_app3='"+this.e_nb.getText()+"',progress='"+vStatus+"' where no_pb='"+this.e_nobukti.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");
					if (this.e_modul.getText() == "PBBDD") sql.add("update yk_pb_m set no_app3='"+this.e_nb.getText()+"',progress='"+vStatus+"' where no_pb='"+this.e_nobukti.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");
					if (this.e_modul.getText() == "PBLOG") sql.add("update yk_pb_m set no_app3='"+this.e_nb.getText()+"',progress='"+vStatus+"' where no_pb='"+this.e_nobukti.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");
					if (this.e_modul.getText() == "PJAJU") sql.add("update panjar2_m set no_app3='"+this.e_nb.getText()+"',progress='"+vStatus+"' where no_panjar='"+this.e_nobukti.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");
					if (this.e_modul.getText() == "PJPTG" || this.e_modul.getText() == "PRPTG") sql.add("update panjarptg2_m set no_app3='"+this.e_nb.getText()+"',progress='"+vStatus+"' where no_ptg='"+this.e_nobukti.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");
					
					if (this.e_modul.getText() == "SPPD") sql.add("update pd_spj_m set no_app3='"+this.e_nb.getText()+"',progress='"+vStatus+"' where no_spj='"+this.e_nobukti.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");
	...
	doModalResult: function(event, modalResult){
		...
		switch (event){
			...
			case "ubah" :					
				this.preView = "1";				
				if (this.e_modul.getText() != "IFREIM" && this.e_modul.getText() != "PJPTG" ){
			...
			case "hapus" :	
				...
				if (this.e_modul.getText() == "IFAJU") sql.add("update spm_if_m set no_app3='-',progress='3' where no_if='"+this.e_nobukti.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");
				if (this.e_modul.getText() == "IFREIM") sql.add("update spm_ifreim_m set no_app3='-',progress='3' where no_reim='"+this.e_nobukti.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");
				if (this.e_modul.getText() == "PBBAU") sql.add("update yk_pb_m set no_app3='-',progress='3' where no_pb='"+this.e_nobukti.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");
				if (this.e_modul.getText() == "PBPR") sql.add("update yk_pb_m set no_app3='-',progress='3' where no_pb='"+this.e_nobukti.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");
				if (this.e_modul.getText() == "PBBDD") sql.add("update yk_pb_m set no_app3='-',progress='3' where no_pb='"+this.e_nobukti.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");
				if (this.e_modul.getText() == "PBLOG") sql.add("update yk_pb_m set no_app3='-',progress='3' where no_pb='"+this.e_nobukti.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");
				if (this.e_modul.getText() == "PJAJU") sql.add("update panjar2_m set no_app3='-',progress='3' where no_panjar='"+this.e_nobukti.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");
				if (this.e_modul.getText() == "PJPTG" || this.e_modul.getText() == "PRPTG") sql.add("update panjarptg2_m set no_app3='-',progress='3' where no_ptg='"+this.e_nobukti.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");

				if (this.e_modul.getText() == "SPPD") sql.add("update pd_spj_m set no_app3='-',progress='3' where no_spj='"+this.e_nobukti.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");
	...
	doChange:function(sender){		
		...
		if (sender == this.c_modul2) {
			if (this.c_modul2.getText() == "IFAJU") this.cb_nb.setSQL("select no_if, keterangan from spm_if_m where periode<='"+this.e_periode.getText()+"' and progress in ('4','K') and kode_lokasi='"+this.app._lokasi+"'",["no_if","keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);		
			if (this.c_modul2.getText() == "IFREIM") this.cb_nb.setSQL("select no_reim, keterangan from spm_ifreim_m where periode<='"+this.e_periode.getText()+"' and progress in ('4','K') and kode_lokasi='"+this.app._lokasi+"'",["no_reim","keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);		
			if (this.c_modul2.getText() == "PBBAU") this.cb_nb.setSQL("select no_pb, keterangan from yk_pb_m where periode<='"+this.e_periode.getText()+"' and progress in ('4','K') and kode_lokasi='"+this.app._lokasi+"'",["no_pb","keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);					
			if (this.c_modul2.getText() == "PBPR") this.cb_nb.setSQL("select no_pb, keterangan from yk_pb_m where periode<='"+this.e_periode.getText()+"' and progress in ('4','K') and kode_lokasi='"+this.app._lokasi+"'",["no_pb","keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);					
			if (this.c_modul2.getText() == "PBBDD") this.cb_nb.setSQL("select no_pb, keterangan from yk_pb_m where periode<='"+this.e_periode.getText()+"' and progress in ('4','K') and kode_lokasi='"+this.app._lokasi+"'",["no_pb","keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);					
			if (this.c_modul2.getText() == "PBLOG") this.cb_nb.setSQL("select no_pb, keterangan from yk_pb_m where periode<='"+this.e_periode.getText()+"' and progress in ('4','K') and kode_lokasi='"+this.app._lokasi+"'",["no_pb","keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);					
			if (this.c_modul2.getText() == "PJAJU") this.cb_nb.setSQL("select no_panjar, keterangan from panjar2_m where periode<='"+this.e_periode.getText()+"' and progress in ('4','K') and kode_lokasi='"+this.app._lokasi+"'",["no_panjar","keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);					
			if (this.c_modul2.getText() == "PJPTG" || this.c_modul2.getText() == "PRPTG") this.cb_nb.setSQL("select no_ptg, keterangan from panjarptg2_m where periode<='"+this.e_periode.getText()+"' and progress in ('4','K') and kode_lokasi='"+this.app._lokasi+"'",["no_ptg","keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);					
			...
			if (this.c_modul2.getText() == "SPPD") {
				this.cb_nb.setSQL("select b.no_spj, b.no_dokumen from pd_spj_m b inner join pd_aju_m a on a.no_aju=b.no_aju and a.kode_lokasi=b.kode_lokasi "+
								  "where b.periode<='"+this.e_periode.getText()+"' and b.progress in ('4','K') and a.kode_lokasi='"+this.app._lokasi+"'",["no_spj","no_dokumen"],false,["No Bukti","No Dokumen"],"and","Daftar Bukti",true);					
			}

		}
		if (sender == this.cb_nb && this.cb_nb.getText() != "") {
			if (this.c_modul2.getText() == "IFAJU") {
				var strSQL = "select a.no_ver,a.tanggal as due_date,a.no_if as no_bukti,case a.progress when '4' then 'APPROVE' else 'RETURN' end as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.tanggal,103) as tgl2,'IFAJU' as modul,b.kode_pp+' - '+b.nama as pp,a.no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_app3,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
			...
			if (this.c_modul2.getText() == "IFREIM") {					
				var strSQL = "select a.no_ver,a.tanggal as due_date,a.no_reim as no_bukti,case a.progress when '4' then 'APPROVE' else 'RETURN' end as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.tanggal,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,'-' as no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_app3,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
			...
			if (this.c_modul2.getText() == "PBBAU") {					
				var strSQL = "select a.no_ver,a.due_date,a.no_pb as no_bukti,case a.progress when '4' then 'APPROVE' else 'RETURN' end as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.tanggal,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,'-' as no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_app3,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
			...
			if (this.c_modul2.getText() == "PJPTG" || this.c_modul2.getText() == "PRPTG") {
				var strSQL = "select a.no_ver,a.tanggal as due_date,a.no_ptg as no_bukti,case a.progress when '4' then 'APPROVE' else 'RETURN' end as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.tanggal,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,a.no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_app3,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
			...
			if (this.c_modul2.getText() == "SPPD") {					
				var strSQL = "select a.no_ver,aa.tanggal as due_date,a.no_spj as no_bukti,case a.progress when '4' then 'APPROVE' else 'RETURN' end as status,convert(varchar,aa.tanggal,103) as tgl,convert(varchar,aa.tanggal,103) as tgl2,'SPPD' as modul,aa.kode_pp+' - '+b.nama as pp,a.no_dokumen,aa.tujuan as keterangan,dd.nilai,c.nik+' - '+c.nama as pembuat,a.no_app3,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,aa.kode_pp "+
	...
	doLoad:function(sender){																														
		var strSQL = "select a.no_ver,a.tanggal as due_date,a.no_if as no_bukti,'INPROG' as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.tanggal,103) as tgl2,'IFAJU' as modul,b.kode_pp+' - '+b.nama as pp,a.no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_app3,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
						"from spm_if_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
						"                inner join karyawan c on a.nik=c.nik and a.kode_lokasi=c.kode_lokasi "+
						"where a.progress='3' and a.kode_lokasi='"+this.app._lokasi+"' "+					 
						"union all "+
		...
		if (this.cb_pp.getText() != "") {
			if (this.c_modul3.getText() == "IFAJU")	{
				strSQL = "select a.no_ver,a.tanggal as due_date,a.no_if as no_bukti,'INPROG' as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.tanggal,103) as tgl2,'IFAJU' as modul,b.kode_pp+' - '+b.nama as pp,a.no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_app3,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
						 "from spm_if_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
						 "                inner join karyawan c on a.nik=c.nik and a.kode_lokasi=c.kode_lokasi "+
						 "where a.progress='3' and a.kode_lokasi='"+this.app._lokasi+"' and a.kode_pp='"+this.cb_pp.getText()+"'";
			}	
			if (this.c_modul3.getText() == "IFREIM")	{
				strSQL = "select a.no_ver,a.tanggal as due_date,a.no_reim as no_bukti,'INPROG' as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.tanggal,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,'-' as no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_app3,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
						 "from spm_ifreim_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
			...
			if (this.c_modul3.getText() == "PBBAU")	{
				strSQL = "select a.no_ver,a.due_date,a.no_pb as no_bukti,'INPROG' as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.due_date,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,'-' as no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_app3,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
						 "from yk_pb_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
						 "               inner join karyawan c on a.nik_user=c.nik and a.kode_lokasi=c.kode_lokasi "+
						 "where a.progress='3' and a.kode_lokasi='"+this.app._lokasi+"' and a.kode_pp='"+this.cb_pp.getText()+"' and a.modul ='PBBAU' ";
			}	
			if (this.c_modul3.getText() == "PBPR")	{
 				strSQL = "select a.no_ver,a.due_date,a.no_pb as no_bukti,'INPROG' as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.due_date,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,'-' as no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_app3,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
						 "from yk_pb_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
						 "               inner join karyawan c on a.nik_user=c.nik and a.kode_lokasi=c.kode_lokasi "+
						 "where a.progress='3' and a.kode_lokasi='"+this.app._lokasi+"' and a.kode_pp='"+this.cb_pp.getText()+"' and a.modul ='PBPR' ";
			} 
			if (this.c_modul3.getText() == "PBBDD")	{
				strSQL = "select a.no_ver,a.due_date,a.no_pb as no_bukti,'INPROG' as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.due_date,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,'-' as no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_app3,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
						 "from yk_pb_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
						 "               inner join karyawan c on a.nik_user=c.nik and a.kode_lokasi=c.kode_lokasi "+
						 "where a.progress='3' and a.kode_lokasi='"+this.app._lokasi+"' and a.kode_pp='"+this.cb_pp.getText()+"' and a.modul ='PBBDD' ";
			}
			if (this.c_modul3.getText() == "PBLOG")	{
				strSQL = "select a.no_ver,a.due_date,a.no_pb as no_bukti,'INPROG' as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.due_date,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,'-' as no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_app3,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
						 "from yk_pb_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
						 "               inner join karyawan c on a.nik_user=c.nik and a.kode_lokasi=c.kode_lokasi "+
						 "where a.progress='3' and a.kode_lokasi='"+this.app._lokasi+"' and a.kode_pp='"+this.cb_pp.getText()+"' and a.modul ='PBLOG' ";
			} 
			if (this.c_modul3.getText() == "PJAJU")	{
				strSQL = "select a.no_ver,a.due_date,a.no_panjar as no_bukti,'INPROG' as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.due_date,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,a.no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_app3,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
						 "from panjar2_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
						 "                 inner join karyawan c on a.nik_buat=c.nik and a.kode_lokasi=c.kode_lokasi "+
						 "where a.progress='3' and a.kode_lokasi='"+this.app._lokasi+"' and a.kode_pp='"+this.cb_pp.getText()+"'";
			} 
			if (this.c_modul3.getText() == "PJPTG" || this.c_modul3.getText() == "PRPTG")	{
				strSQL = "select a.no_ver,a.tanggal as due_date,a.no_ptg as no_bukti,'INPROG' as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.tanggal,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,a.no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_app3,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
						 "from panjarptg2_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
						 "                 inner join karyawan c on a.nik_buat=c.nik and a.kode_lokasi=c.kode_lokasi "+
						 "where a.progress='3' and a.kode_lokasi='"+this.app._lokasi+"' and a.kode_pp='"+this.cb_pp.getText()+"'";
			} 
			if (this.c_modul3.getText() == "SPPD")	{
				strSQL = "select a.no_ver,aa.tanggal as due_date,a.no_spj as no_bukti,'INPROG' as status,convert(varchar,aa.tanggal,103) as tgl,convert(varchar,aa.tanggal,103) as tgl2,'SPPD' as modul,aa.kode_pp+' - '+b.nama as pp,a.no_dokumen,aa.tujuan as keterangan,dd.nilai,c.nik+' - '+c.nama as pembuat,a.no_app3,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,aa.kode_pp "+
						"from pd_spj_m a inner join pd_aju_m aa on a.no_aju=aa.no_aju and a.kode_lokasi=aa.kode_lokasi "+
						"				  inner join pp b on aa.kode_pp=b.kode_pp and aa.kode_lokasi=b.kode_lokasi "+
						"				  inner join ( "+
						"						select no_spj,sum(total) as nilai "+
	...
	doTampilData: function(page) {
		...
		for (var i=start;i<finish;i++){
			...
			this.sg.appendData([line.modul.toUpperCase(),line.no_ver,line.no_bukti,line.status.toUpperCase(),line.tgl,line.tgl2,line.pp,line.no_dokumen,line.keterangan,floatToNilai(line.nilai),line.pembuat,line.no_app3,line.tglinput,line.kode_pp]); 
		}
