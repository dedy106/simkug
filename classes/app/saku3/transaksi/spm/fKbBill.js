window.app_saku3_transaksi_spm_fKbBill = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_spm_fKbBill.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spm_fKbBill";
		...
		this.sg1 = new saiGrid(this.pc1.childPage[0],{bound:[0,5,this.pc1.width-5,this.pc1.height-35],colCount:8,tag:0,
				...
				colWidth:[[7,6,5,4,3,2,1,0],[60,150,100,60,300,150,150,80]],
...
window.app_saku3_transaksi_spm_fKbBill.extend(window.childForm);
window.app_saku3_transaksi_spm_fKbBill.implement({
