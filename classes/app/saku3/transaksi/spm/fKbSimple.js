window.app_saku3_transaksi_spm_fKbSimple = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_spm_fKbSimple.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spm_fKbSimple";
		...
		this.pc1 = new pageControl(this.pc2.childPage[1],{bound:[5,12,990,300], childPage:["Data Item Jurnal","Data Anggaran","Otorisasi","Referensi Jurnal"]});
		...
		this.cb_periksa = new saiCBBL(this.pc1.childPage[2],{bound:[20,17,200,20],caption:"Diperiksa Oleh", multiSelection:false, maxLength:10, tag:1});

		this.cb_ref = new saiCBBL(this.pc1.childPage[3],{bound:[20,17,200,20],caption:"Bukti Ref", multiSelection:false, maxLength:10, tag:9,change:[this,"doChange"]});
		this.e_nb2 = new saiLabelEdit(this.pc2.childPage[3],{bound:[20,14,200,20],caption:"No Bukti",maxLength:30,tag:9});		
		this.e_ket2 = new saiLabelEdit(this.pc2.childPage[3],{bound:[20,15,450,20],caption:"Deskripsi",tag:9});		
		...
		try {
			...
			this.cb_periksa.setSQL("select nik, nama from karyawan where flag_aktif='1' and kode_lokasi='"+this.app._lokasi+"'",["nik","nama"],false,["NIK","Nama"],"and","Data Karyawan",true);					
...
window.app_saku3_transaksi_spm_fKbSimple.extend(window.childForm);
window.app_saku3_transaksi_spm_fKbSimple.implement({	
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					sql.add("insert into kas_m (no_kas,kode_lokasi,no_dokumen,no_bg,akun_kb,tanggal,keterangan,kode_pp,modul,jenis,periode,kode_curr,kurs,nilai,nik_buat,nik_app,tgl_input,nik_user,posted,no_del,no_link,ref1,kode_bank) values  "+
							"('"+this.e_nb.getText()+"','"+this.app._lokasi+"','"+this.e_dok.getText()+"','-','-','"+this.dp_d1.getDateString()+"','"+this.e_ket.getText()+"','"+this.app._kodePP+"','KBUMUM','"+this.c_jenis.getText()+"','"+this.e_periode.getText()+"','IDR',1,"+parseNilai(this.e_debet.getText())+",'"+this.app._userLog+"','"+this.cb_periksa.getText()+"',getdate(),'"+this.app._userLog+"','F','-','-','-','-')");																
				...
				switch(methodName){
	    			case "execArraySQL" :	    				
						if (result.toLowerCase().search("error") == -1){
							if (this.preView == "1") {								
								this.nama_report="server_report_saku3_spm_rptKbJurnalBukti";
			...
			if (this.sg3.cells(0,row) != "") {
				...
				if (typeof data == "object"){
					...
					if (line != undefined){
						...
						this.cb_periksa.setText(line.nik_app);						
					}
				}
