window.app_saku3_transaksi_spm_fBill2_btl = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_spm_fBill2_btl.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spm_fBill2_btl";
...
window.app_saku3_transaksi_spm_fBill2_btl.extend(window.childForm);
window.app_saku3_transaksi_spm_fBill2_btl.implement({
	...
	doChange:function(sender){	
		...
		if (sender == this.cb_proyek && this.cb_proyek.getText()!="") {
			var strSQL = "select a.kode_cust,b.akun_piutang,b.akun_pdpt,a.nilai "+
