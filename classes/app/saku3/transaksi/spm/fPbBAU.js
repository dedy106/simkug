window.app_saku3_transaksi_spm_fPbBAU = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_spm_fPbBAU.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spm_fPbBAU";
		...
		try {
			...
			//if (this.stsAdmin == "A") sql.add("select a.kode_pp,a.nama from pp where a.flag_aktif= '1' and a.kode_lokasi = '"+this.app._lokasi+"'");
			//else 
...
window.app_saku3_transaksi_spm_fPbBAU.extend(window.childForm);
window.app_saku3_transaksi_spm_fPbBAU.implement({	
	...
	doLoad3:function(sender){																				
		...
		var strSQL = "select a.no_pb,convert(varchar,a.tanggal,103) as tgl,a.modul,a.no_dokumen,a.keterangan,a.progress,a.nilai, "+
					 ...
					 "where a.posted='F' and a.kode_pp = '"+this.app._kodePP+"' and a.periode<='"+this.e_periode.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' and a.modul = 'PBBAU' and a.progress in ('0','C','X','F','S','V') ";
