window.app_saku3_transaksi_spm_fVer = function(owner)
{
	if (owner)
	{		
		window.app_saku3_transaksi_spm_fVer.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spm_fVer";
...
window.app_saku3_transaksi_spm_fVer.extend(window.childForm);
window.app_saku3_transaksi_spm_fVer.implement({	
	...
	doLoad:function(sender){	
		try {					
			...
			var strSQL = "select a.tanggal as due_date,a.no_if as no_bukti,case a.progress when '1' then 'INPROG' else 'RETURN' end as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.tanggal,103) as tgl2,'IFAJU' as modul,b.kode_pp+' - '+b.nama as pp,a.no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_ver,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
					"from spm_if_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
					"                inner join karyawan c on a.nik=c.nik and a.kode_lokasi=c.kode_lokasi "+
					"where a.progress in ('1','K','F') and a.kode_lokasi='"+this.app._lokasi+"'  "+					 
					"union all "+
				
					"select a.tanggal as due_date,a.no_reim as no_bukti,case a.progress when '1' then 'INPROG' else 'RETURN' end as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.tanggal,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,'-' as no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_ver,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
					"from spm_ifreim_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
					"                    inner join karyawan c on a.nik=c.nik and a.kode_lokasi=c.kode_lokasi "+
					"where a.progress in ('1','K','F') and a.kode_lokasi='"+this.app._lokasi+"'  "+					 
					...
					"select a.due_date,a.no_pb as no_bukti,case a.progress when '2' then 'INPROG' else 'RETURN' end as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.due_date,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,'-' as no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_ver,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
					"from yk_pb_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
					"               inner join karyawan c on a.nik_user=c.nik and a.kode_lokasi=c.kode_lokasi "+
					"where a.progress in ('2','K','F') and a.kode_lokasi='"+this.app._lokasi+"'  "+					 
				
					"union all "+
				
					"select a.due_date,a.no_panjar as no_bukti,case a.progress when '2' then 'INPROG' else 'RETURN' end as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.due_date,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,a.no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_ver,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
					"from panjar2_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
					"                inner join karyawan c on a.nik_buat=c.nik and a.kode_lokasi=c.kode_lokasi "+
					"where a.progress in ('2','K','F') and a.kode_lokasi='"+this.app._lokasi+"' "+					 
					...
					"select a.tanggal as due_date,a.no_ptg as no_bukti,case a.progress when '2' then 'INPROG' else 'RETURN' end as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.tanggal,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,a.no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_ver,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
					"from panjarptg2_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
					"                inner join karyawan c on a.nik_buat=c.nik and a.kode_lokasi=c.kode_lokasi "+
					"where a.progress in ('2','K','F') and a.kode_lokasi='"+this.app._lokasi+"' "+	
			...
			if (this.cb_pp.getText() != "") {
				if (this.c_modul3.getText() == "IFAJU")	{
					strSQL = "select a.tanggal as due_date,a.no_if as no_bukti,case a.progress when '1' then 'INPROG' else 'RETURN' end as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.tanggal,103) as tgl2,'IFAJU' as modul,b.kode_pp+' - '+b.nama as pp,a.no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_ver,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
							"from spm_if_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
							"                inner join karyawan c on a.nik=c.nik and a.kode_lokasi=c.kode_lokasi and a.kode_pp='"+this.cb_pp.getText()+"' "+
							"where a.progress in ('1','K','F') and a.kode_lokasi='"+this.app._lokasi+"' order by a.no_if";
				}	
				if (this.c_modul3.getText() == "IFREIM")	{
					strSQL =  "select a.tanggal as due_date,a.no_reim as no_bukti,case a.progress when '1' then 'INPROG' else 'RETURN' end as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.tanggal,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,'-' as no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_ver,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
							"from spm_ifreim_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
							"                    inner join karyawan c on a.nik=c.nik and a.kode_lokasi=c.kode_lokasi and a.kode_pp='"+this.cb_pp.getText()+"' "+
							"where a.progress in ('1','K','F') and a.kode_lokasi='"+this.app._lokasi+"' order by a.no_reim";
				}	 
				if (this.c_modul3.getText() == "PBBAU")	{
					strSQL =  "select a.due_date,a.no_pb as no_bukti,case a.progress when '2' then 'INPROG' else 'RETURN' end as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.due_date,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,'-' as no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_ver,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
							"from yk_pb_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
							"               inner join karyawan c on a.nik_user=c.nik and a.kode_lokasi=c.kode_lokasi "+
							"where a.progress in ('2','K','F') and a.kode_lokasi='"+this.app._lokasi+"' and a.modul='PBBAU' and a.kode_pp='"+this.cb_pp.getText()+"' order by a.no_pb";
				}	
				if (this.c_modul3.getText() == "PBPR")	{
					strSQL =  "select a.due_date,a.no_pb as no_bukti,case a.progress when '2' then 'INPROG' else 'RETURN' end as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.due_date,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,'-' as no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_ver,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
							"from yk_pb_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
							"               inner join karyawan c on a.nik_user=c.nik and a.kode_lokasi=c.kode_lokasi "+
							"where a.progress in ('2','K','F') and a.kode_lokasi='"+this.app._lokasi+"' and a.modul='PBPR' and a.kode_pp='"+this.cb_pp.getText()+"' order by a.no_pb";
				} 
				if (this.c_modul3.getText() == "PBBDD")	{
					strSQL =  "select a.due_date,a.no_pb as no_bukti,case a.progress when '2' then 'INPROG' else 'RETURN' end as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.due_date,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,'-' as no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_ver,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
							"from yk_pb_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
							"               inner join karyawan c on a.nik_user=c.nik and a.kode_lokasi=c.kode_lokasi "+
							"where a.progress in ('2','K','F') and a.kode_lokasi='"+this.app._lokasi+"' and a.modul='PBBDD' and a.kode_pp='"+this.cb_pp.getText()+"' order by a.no_pb";
				}
				if (this.c_modul3.getText() == "PBLOG")	{
					strSQL =  "select a.due_date,a.no_pb as no_bukti,case a.progress when '2' then 'INPROG' else 'RETURN' end as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.due_date,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,'-' as no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_ver,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
							"from yk_pb_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
							"               inner join karyawan c on a.nik_user=c.nik and a.kode_lokasi=c.kode_lokasi "+
							"where a.progress in ('2','K','F') and a.kode_lokasi='"+this.app._lokasi+"' and a.modul='PBLOG' and a.kode_pp='"+this.cb_pp.getText()+"' order by a.no_pb";
				} 
				if (this.c_modul3.getText() == "PJAJU")	{
					strSQL =  "select a.due_date,a.no_panjar as no_bukti,case a.progress when '2' then 'INPROG' else 'RETURN' end as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.due_date,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,a.no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_ver,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
							"from panjar2_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
							"                inner join karyawan c on a.nik_buat=c.nik and a.kode_lokasi=c.kode_lokasi "+
							"where a.progress in ('2','K','F') and a.kode_lokasi='"+this.app._lokasi+"' and a.kode_pp='"+this.cb_pp.getText()+"' order by a.no_panjar";
				} 
				if (this.c_modul3.getText() == "PJPTG")	{
					strSQL =  "select a.tanggal as due_date,a.no_ptg as no_bukti,case a.progress when '2' then 'INPROG' else 'RETURN' end as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.tanggal,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,a.no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_ver,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
							"from panjarptg2_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
							"                inner join karyawan c on a.nik_buat=c.nik and a.kode_lokasi=c.kode_lokasi "+
							"where a.progress in ('2','K','F') and a.kode_lokasi='"+this.app._lokasi+"' and a.kode_pp='"+this.cb_pp.getText()+"' order by a.no_ptg";
				} 
