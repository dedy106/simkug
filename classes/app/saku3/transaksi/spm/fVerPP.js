window.app_saku3_transaksi_spm_fVerPP = function(owner)
{
	if (owner)
	{		
		window.app_saku3_transaksi_spm_fVerPP.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spm_fVerPP";
		...
		this.c_modul3 = new saiCB(this,{bound:[20,10,200,20],caption:"Modul",items:["IFAJU","IFREIM","PBBAU","PBPR","PBBDD","PJAJU","PJPTG"], tag:9,change:[this,"doChange"]});
		this.e_periode = new portalui_saiLabelEdit(this,{bound:[20,11,200,20],caption:"Periode",tag:2,readOnly:true,visible:false});
		this.l_tgl1 = new portalui_label(this,{bound:[20,11,100,18],caption:"Tanggal", underline:true});
		this.dp_d1 = new portalui_datePicker(this,{bound:[120,11,98,18],selectDate:[this,"doSelectDate"]});		
		
		this.pc1 = new pageControl(this,{bound:[10,18,1000,380], childPage:["Daftar Bukti","Verifikasi","Item Verifikasi","Jurnal & Budget","Filter Data"]});		
		...
		this.c_modul2 = new saiCB(this.pc1.childPage[4],{bound:[20,11,200,20],caption:"Modul",items:["IFAJU","IFREIM","PBBAU","PBPR","PBBDD","PJAJU","PJPTG"], readOnly:true,tag:9,change:[this,"doChange"]});
		...
		try {			
			...
			this.cb_pp.setSQL("select a.kode_pp, a.nama from pp a "+
							  ...
							  "where a.kode_lokasi='"+this.app._lokasi+"' and a.flag_aktif='1'",["kode_pp","nama"],false,["Kode","Nama"],"and","Data Unit/Cabang",true);
...
window.app_saku3_transaksi_spm_fVerPP.extend(window.childForm);
window.app_saku3_transaksi_spm_fVerPP.implement({	
	...
	doChange:function(sender){				
		...
		if (sender == this.c_modul2) {
			...
			if (this.c_modul2.getText() == "IFAJU") 
				this.cb_nb.setSQL("select distinct a.no_if, a.keterangan from spm_if_m a "+vppLogin+" where a.periode<='"+this.e_periode.getText()+"' and a.progress in ('3','V') and a.kode_lokasi='"+this.app._lokasi+"'",["no_if","keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);		
			if (this.c_modul2.getText() == "IFREIM") 
				this.cb_nb.setSQL("select distinct a.no_reim, a.keterangan from spm_ifreim_m a "+vppLogin+" where a.periode<='"+this.e_periode.getText()+"' and a.progress in ('3','V') and a.kode_lokasi='"+this.app._lokasi+"'",["no_reim","keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);					
			if (this.c_modul2.getText() == "PBBAU") 
				this.cb_nb.setSQL("select distinct a.no_pb, a.keterangan from yk_pb_m a "+vppLogin+" where a.periode<='"+this.e_periode.getText()+"' and a.progress in ('3','V') and a.kode_lokasi='"+this.app._lokasi+"'",["no_pb","keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);					
			if (this.c_modul2.getText() == "PBPR") 
				this.cb_nb.setSQL("select distinct a.no_pb, a.keterangan from yk_pb_m a "+vppLogin+" where a.periode<='"+this.e_periode.getText()+"' and a.progress in ('3','V') and a.kode_lokasi='"+this.app._lokasi+"'",["no_pb","keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);					
			if (this.c_modul2.getText() == "PBBDD") 
				this.cb_nb.setSQL("select distinct a.no_pb, a.keterangan from yk_pb_m a "+vppLogin+" where a.periode<='"+this.e_periode.getText()+"' and a.progress in ('3','V') and a.kode_lokasi='"+this.app._lokasi+"'",["no_pb","keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);					
			if (this.c_modul2.getText() == "PJAJU") 
				this.cb_nb.setSQL("select distinct a.no_panjar, a.keterangan from panjar2_m a "+vppLogin+" where a.periode<='"+this.e_periode.getText()+"' and a.progress in ('3','V') and a.kode_lokasi='"+this.app._lokasi+"'",["no_panjar","keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);					
			if (this.c_modul2.getText() == "PJPTG" || this.c_modul2.getText() == "PRPTG") 
				this.cb_nb.setSQL("select distinct a.no_ptg, a.keterangan from panjarptg2_m a "+vppLogin+" where a.periode<='"+this.e_periode.getText()+"' and a.progress in ('3','V') and a.kode_lokasi='"+this.app._lokasi+"'",["no_ptg","keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);					
		}
	...
	doLoad:function(sender){															
		if (this.c_modul3.getText() == "" && this.cb_pp.getText() == "") {		
			var strSQL = "select distinct a.tanggal as due_date,a.no_if as no_bukti,case a.progress when '1' then 'INPROG' else 'RETURN' end as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.tanggal,103) as tgl2,'IFAJU' as modul,b.kode_pp+' - '+b.nama as pp,a.no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_ver,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
					 "from spm_if_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
					 "                inner join karyawan c on a.nik=c.nik and a.kode_lokasi=c.kode_lokasi "+
					 ...
					 "select distinct a.tanggal as due_date,a.no_reim as no_bukti,case a.progress when '1' then 'INPROG' else 'RETURN' end as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.tanggal,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,'-' as no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_ver,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
					 "from spm_ifreim_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
					 "                    inner join karyawan c on a.nik=c.nik and a.kode_lokasi=c.kode_lokasi "+
					 "			     	  inner join karyawan_pp x on b.kode_pp=x.kode_pp and b.kode_lokasi=x.kode_lokasi and x.nik='"+this.app._userLog+"' "+
					 "where a.progress in ('1','K','F') and a.kode_lokasi='"+this.app._lokasi+"'  "+					 
					 ...
					 "select distinct a.due_date,a.no_pb as no_bukti,case a.progress when '2' then 'INPROG' else 'RETURN' end as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.due_date,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,'-' as no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_ver,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
					 "from yk_pb_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
					 "               inner join karyawan c on a.nik_user=c.nik and a.kode_lokasi=c.kode_lokasi "+
					 "			     inner join karyawan_pp x on b.kode_pp=x.kode_pp and b.kode_lokasi=x.kode_lokasi and x.nik='"+this.app._userLog+"' "+
					 ...
					 "select distinct a.due_date,a.no_panjar as no_bukti,case a.progress when '2' then 'INPROG' else 'RETURN' end as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.due_date,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,a.no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_ver,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
					 "from panjar2_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
					 "                 inner join karyawan c on a.nik_buat=c.nik and a.kode_lokasi=c.kode_lokasi "+
					 "			       inner join karyawan_pp x on b.kode_pp=x.kode_pp and b.kode_lokasi=x.kode_lokasi and x.nik='"+this.app._userLog+"' "+
					 "where a.progress in ('2','K','F') and a.kode_lokasi='"+this.app._lokasi+"' "+					 
					 ...
					 "select distinct a.tanggal as due_date,a.no_ptg as no_bukti,case a.progress when '2' then 'INPROG' else 'RETURN' end as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.tanggal,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,a.no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_ver,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
					 "from panjarptg2_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
					 "                    inner join karyawan c on a.nik_buat=c.nik and a.kode_lokasi=c.kode_lokasi "+
					 "			     	  inner join karyawan_pp x on b.kode_pp=x.kode_pp and b.kode_lokasi=x.kode_lokasi and x.nik='"+this.app._userLog+"' "+
					 "where a.progress in ('2','K','F') and a.kode_lokasi='"+this.app._lokasi+"' "+	
			...
			if (this.cb_pp.getText() != "") {
				...
				if (this.c_modul3.getText() == "PBBAU")	{
					strSQL =  "select a.due_date,a.no_pb as no_bukti,case a.progress when '2' then 'INPROG' else 'RETURN' end as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.due_date,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,'-' as no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_ver,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
						 "from yk_pb_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
						 "               inner join karyawan c on a.nik_user=c.nik and a.kode_lokasi=c.kode_lokasi "+
						 "where a.progress in ('2','K','F') and a.kode_lokasi='"+this.app._lokasi+"' and a.modul='PBBAU' and a.kode_pp='"+this.cb_pp.getText()+"' ";
				}	
				if (this.c_modul3.getText() == "PBPR")	{
					strSQL =  "select a.due_date,a.no_pb as no_bukti,case a.progress when '2' then 'INPROG' else 'RETURN' end as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.due_date,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,'-' as no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_ver,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
						 "from yk_pb_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
						 "               inner join karyawan c on a.nik_user=c.nik and a.kode_lokasi=c.kode_lokasi "+
						 "where a.progress in ('2','K','F') and a.kode_lokasi='"+this.app._lokasi+"' and a.modul='PBPR' and a.kode_pp='"+this.cb_pp.getText()+"' ";
				} 
				if (this.c_modul3.getText() == "PBBDD")	{
					strSQL =  "select a.due_date,a.no_pb as no_bukti,case a.progress when '2' then 'INPROG' else 'RETURN' end as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.due_date,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,'-' as no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_ver,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
						 "from yk_pb_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
						 "               inner join karyawan c on a.nik_user=c.nik and a.kode_lokasi=c.kode_lokasi "+
						 "where a.progress in ('2','K','F') and a.kode_lokasi='"+this.app._lokasi+"' and a.modul='PBBDD' and a.kode_pp='"+this.cb_pp.getText()+"' ";
				} 
				if (this.c_modul3.getText() == "PJAJU")	{
					strSQL =  "select a.due_date,a.no_panjar as no_bukti,case a.progress when '2' then 'INPROG' else 'RETURN' end as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.due_date,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,a.no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_ver,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
						 "from panjar2_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
						 "                inner join karyawan c on a.nik_buat=c.nik and a.kode_lokasi=c.kode_lokasi "+
						 "where a.progress in ('2','K','F') and a.kode_lokasi='"+this.app._lokasi+"' and a.kode_pp='"+this.cb_pp.getText()+"' ";
				} 
