window.app_saku3_transaksi_spm_fKbSpb = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_spm_fKbSpb.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spm_fKbSpb";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form KasBank SPB : Input/Edit", 0);	
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[1,12,995,315], childPage:["Daftar SPB","Daftar Transfer","Jurnal Tambahan","Data Anggaran"]});		
...
window.app_saku3_transaksi_spm_fKbSpb.extend(window.childForm);
window.app_saku3_transaksi_spm_fKbSpb.implement({	
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					if (this.stsSimpan == 0) {
						...
						sql.add("update spm_if_m set progress='5', no_kas='-', flag_aktif='0' where no_kas = '"+this.e_nb.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");
						sql.add("update spm_ifreim_m set progress='5', no_kas='-' where no_kas = '"+this.e_nb.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");						
						...
						sql.add("update pd_spj_m set progress='5', no_kas='-' where no_kas = '"+this.e_nb.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");	
					}			
					...
					sql.add("insert into kas_j(no_kas,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,nilai,kode_pp,kode_drk,kode_cf,ref1,kode_lokasi,modul,jenis,periode,kode_curr,kurs,nik_user,tgl_input,kode_bank,nilai_curr) values "+
							"('"+this.e_nb.getText()+"','"+this.e_dok.getText()+"','"+this.dp_d1.getDateString()+"',999,'"+this.cb_akun.getText()+"','"+this.e_ket.getText()+"','C',"+nilaiToFloat(this.e_nilaikb.getText())+",'"+this.ppAkunKB+"','-','-','-','"+this.app._lokasi+"','KBSPB','KB','"+this.e_periode.getText()+"','IDR',1,'"+this.app._userLog+"',getdate(),'-',"+nilaiToFloat(this.e_nilaikb.getText())+")");
										
					for (var i=0;i < this.dataJU5.rs.rows.length;i++){
						line = this.dataJU5.rs.rows[i];
						if (line.status.toUpperCase() == "BAYAR") {
							sql.add("update spm_if_m set progress='6', no_kas='"+this.e_nb.getText()+"', flag_aktif='1' where no_if = '"+line.no_bukti+"' and kode_lokasi='"+this.app._lokasi+"'");
							sql.add("update spm_ifreim_m set progress='6', no_kas='"+this.e_nb.getText()+"' where no_reim = '"+line.no_bukti+"' and kode_lokasi='"+this.app._lokasi+"'");						
							...
							sql.add("update pd_spj_m set progress='6', no_kas='"+this.e_nb.getText()+"' where no_spj = '"+line.no_bukti+"' and kode_lokasi='"+this.app._lokasi+"'");
							
							if (line.modul.toUpperCase() == "IFAJU") {
								sql.add("insert into kas_j(no_kas,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,nilai,kode_pp,kode_drk,kode_cf,ref1,kode_lokasi,modul,jenis,periode,kode_curr,kurs,nik_user,tgl_input,kode_bank,nilai_curr) "+
										"select '"+this.e_nb.getText()+"',b.no_if,'"+this.dp_d1.getDateString()+"',c.no_urut,c.kode_akun,c.keterangan,c.dc,c.nilai,c.kode_pp,c.kode_drk,'-','-','"+this.app._lokasi+"','KBSPB',c.jenis,'"+this.e_periode.getText()+"',c.kode_curr,c.kurs,'"+this.app._userLog+"',getdate(),'-',c.nilai "+
										"from spm_app_j c inner join spm_if_m b on c.no_app=b.no_ver and c.kode_lokasi=b.kode_lokasi "+
										"where b.no_ver='"+line.no_spb+"' and b.kode_lokasi='"+this.app._lokasi+"'");							
							}
							if (line.modul.toUpperCase() == "IFREIM") {
								sql.add("insert into kas_j(no_kas,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,nilai,kode_pp,kode_drk,kode_cf,ref1,kode_lokasi,modul,jenis,periode,kode_curr,kurs,nik_user,tgl_input,kode_bank,nilai_curr) "+
										"select '"+this.e_nb.getText()+"',b.no_reim,'"+this.dp_d1.getDateString()+"',c.no_urut,c.kode_akun,c.keterangan,c.dc,c.nilai,c.kode_pp,c.kode_drk,'-','-','"+this.app._lokasi+"','KBSPB',c.jenis,'"+this.e_periode.getText()+"',c.kode_curr,c.kurs,'"+this.app._userLog+"',getdate(),'-',c.nilai "+
										"from spm_app_j c inner join spm_ifreim_m b on c.no_app=b.no_ver and c.kode_lokasi=b.kode_lokasi "+
										"where b.no_ver='"+line.no_spb+"' and b.kode_lokasi='"+this.app._lokasi+"'");							
							}
							if (line.modul.toUpperCase() == "PBBAU") {
								sql.add("insert into kas_j(no_kas,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,nilai,kode_pp,kode_drk,kode_cf,ref1,kode_lokasi,modul,jenis,periode,kode_curr,kurs,nik_user,tgl_input,kode_bank,nilai_curr) "+
										"select '"+this.e_nb.getText()+"',b.no_pb,'"+this.dp_d1.getDateString()+"',c.no_urut,c.kode_akun,c.keterangan,c.dc,c.nilai,c.kode_pp,c.kode_drk,'-','-','"+this.app._lokasi+"','KBSPB',c.jenis,'"+this.e_periode.getText()+"',c.kode_curr,c.kurs,'"+this.app._userLog+"',getdate(),'-',c.nilai "+
										"from spm_app_j c inner join yk_pb_m b on c.no_app=b.no_ver and c.kode_lokasi=b.kode_lokasi "+
										"where b.no_ver='"+line.no_spb+"' and b.kode_lokasi='"+this.app._lokasi+"'");							
							}
							if (line.modul.toUpperCase() == "PBPR") {
								sql.add("insert into kas_j(no_kas,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,nilai,kode_pp,kode_drk,kode_cf,ref1,kode_lokasi,modul,jenis,periode,kode_curr,kurs,nik_user,tgl_input,kode_bank,nilai_curr) "+
										"select '"+this.e_nb.getText()+"',b.no_pb,'"+this.dp_d1.getDateString()+"',c.no_urut,c.kode_akun,c.keterangan,c.dc,c.nilai,c.kode_pp,c.kode_drk,'-','-','"+this.app._lokasi+"','KBSPB',c.jenis,'"+this.e_periode.getText()+"',c.kode_curr,c.kurs,'"+this.app._userLog+"',getdate(),'-',c.nilai "+
										"from spm_app_j c inner join yk_pb_m b on c.no_app=b.no_ver and c.kode_lokasi=b.kode_lokasi "+
										"where b.no_ver='"+line.no_spb+"' and b.kode_lokasi='"+this.app._lokasi+"'");							
							}
							if (line.modul.toUpperCase() == "PBBDD") {
								sql.add("insert into kas_j(no_kas,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,nilai,kode_pp,kode_drk,kode_cf,ref1,kode_lokasi,modul,jenis,periode,kode_curr,kurs,nik_user,tgl_input,kode_bank,nilai_curr) "+
										"select '"+this.e_nb.getText()+"',b.no_pb,'"+this.dp_d1.getDateString()+"',c.no_urut,c.kode_akun,c.keterangan,c.dc,c.nilai,c.kode_pp,c.kode_drk,'-','-','"+this.app._lokasi+"','KBSPB',c.jenis,'"+this.e_periode.getText()+"',c.kode_curr,c.kurs,'"+this.app._userLog+"',getdate(),'-',c.nilai "+
										"from spm_app_j c inner join yk_pb_m b on c.no_app=b.no_ver and c.kode_lokasi=b.kode_lokasi "+
										"where b.no_ver='"+line.no_spb+"' and b.kode_lokasi='"+this.app._lokasi+"'");							
							}
							if (line.modul.toUpperCase() == "PBLOG") {
								sql.add("insert into kas_j(no_kas,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,nilai,kode_pp,kode_drk,kode_cf,ref1,kode_lokasi,modul,jenis,periode,kode_curr,kurs,nik_user,tgl_input,kode_bank,nilai_curr) "+
										"select '"+this.e_nb.getText()+"',b.no_pb,'"+this.dp_d1.getDateString()+"',c.no_urut,c.kode_akun,c.keterangan,c.dc,c.nilai,c.kode_pp,c.kode_drk,'-','-','"+this.app._lokasi+"','KBSPB',c.jenis,'"+this.e_periode.getText()+"',c.kode_curr,c.kurs,'"+this.app._userLog+"',getdate(),'-',c.nilai "+
										"from spm_app_j c inner join yk_pb_m b on c.no_app=b.no_ver and c.kode_lokasi=b.kode_lokasi "+
										"where b.no_ver='"+line.no_spb+"' and b.kode_lokasi='"+this.app._lokasi+"'");							
							}
							if (line.modul.toUpperCase() == "PJAJU") {
								sql.add("insert into kas_j(no_kas,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,nilai,kode_pp,kode_drk,kode_cf,ref1,kode_lokasi,modul,jenis,periode,kode_curr,kurs,nik_user,tgl_input,kode_bank,nilai_curr) "+
										"select '"+this.e_nb.getText()+"',b.no_panjar,'"+this.dp_d1.getDateString()+"',c.no_urut,c.kode_akun,c.keterangan,c.dc,c.nilai,c.kode_pp,c.kode_drk,'-','-','"+this.app._lokasi+"','KBSPB',c.jenis,'"+this.e_periode.getText()+"',c.kode_curr,c.kurs,'"+this.app._userLog+"',getdate(),'-',c.nilai "+
										"from spm_app_j c inner join panjar2_m b on c.no_app=b.no_ver and c.kode_lokasi=b.kode_lokasi "+
										"where b.no_ver='"+line.no_spb+"' and b.kode_lokasi='"+this.app._lokasi+"'");							
							}
							if (line.modul.toUpperCase() == "SPPD") {
								sql.add("insert into kas_j(no_kas,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,nilai,kode_pp,kode_drk,kode_cf,ref1,kode_lokasi,modul,jenis,periode,kode_curr,kurs,nik_user,tgl_input,kode_bank,nilai_curr) "+
										"select '"+this.e_nb.getText()+"',b.no_spj,'"+this.dp_d1.getDateString()+"',c.no_urut,c.kode_akun,c.keterangan,c.dc,c.nilai,c.kode_pp,c.kode_drk,'-','-','"+this.app._lokasi+"','KBSPB',c.jenis,'"+this.e_periode.getText()+"',c.kode_curr,c.kurs,'"+this.app._userLog+"',getdate(),'-',c.nilai "+
										"from spm_app_j c inner join pd_spj_m b on c.no_app=b.no_ver and c.kode_lokasi=b.kode_lokasi "+
										"where b.no_ver='"+line.no_spb+"' and b.kode_lokasi='"+this.app._lokasi+"'");							
							}
						...
						for (var i=0;i < this.sg2.getRowCount();i++){
							if (this.sg2.rowValid(i)){
								...
								sql.add("insert into angg_r(no_bukti,modul,kode_lokasi,kode_akun,kode_pp,kode_drk,periode1,periode2,dc,saldo,nilai) values "+
										"('"+this.e_nb.getText()+"','KBSPB','"+this.app._lokasi+"','"+this.sg2.cells(0,i)+"','"+this.sg2.cells(2,i)+"','"+this.sg2.cells(4,i)+"','"+this.e_periode.getText()+"','"+this.e_periode.getText()+"','"+DC+"',"+parseNilai(this.sg2.cells(4,i))+","+nilai+")");
							}
						}
					}					
					setTipeButton(tbAllFalse);					
	...
	doLoad:function(sender){		
		this.dataJU5 = {rs:{rows:[]}};
		var strSQL = "select 'INPROG' as status,b.no_ver as no_spb,b.no_if as no_bukti,convert(varchar,b.tanggal,103) as tgl,convert(varchar,b.tanggal,103) as duedate,b.keterangan,c.nilai,'IFAJU' as modul,b.tanggal "+
					 ...
					 "select 'INPROG' as status,b.no_ver as no_spb,b.no_reim as no_bukti,convert(varchar,b.tanggal,103) as tgl,convert(varchar,b.tanggal,103) as duedate,b.keterangan,c.nilai,b.modul,b.tanggal "+
					 ...
					 "select 'INPROG' as status,b.no_ver as no_spb,b.no_pb as no_bukti,convert(varchar,b.tanggal,103) as tgl,convert(varchar,b.tanggal,103) as duedate,b.keterangan,c.nilai,b.modul,b.tanggal "+
					 ...
					 "select 'INPROG' as status,b.no_ver as no_spb,b.no_panjar as no_bukti,convert(varchar,b.tanggal,103) as tgl,convert(varchar,b.due_date,103) as duedate,b.keterangan,c.nilai,a.modul,b.tanggal "+
					 ...
					 "select 'INPROG' as status,b.no_ver as no_spb,b.no_spj as no_bukti,convert(varchar,aa.tanggal,103) as tgl,convert(varchar,aa.tanggal,103) as duedate,aa.tujuan keterangan,dd.nilai,a.modul,aa.tanggal "+
					 "from spm_app_m a inner join pd_spj_m b on a.no_app=b.no_ver and a.kode_lokasi=b.kode_lokasi "+
					 "				   inner join pd_aju_m aa on b.no_aju=aa.no_aju and aa.kode_lokasi=b.kode_lokasi "+
					 "				   inner join ( "+
					 "						select no_spj,sum(total) as nilai "+
					 "						from pd_spj_d "+
					 "						where kode_lokasi='"+this.app._lokasi+"' group by no_spj "+
					 " 				   ) dd on b.no_spj=dd.no_spj "+
					 "                 inner join (select no_app,sum(case dc when 'D' then nilai else -nilai end) as nilai "+
					 "                             from spm_app_j where kode_lokasi='"+this.app._lokasi+"' group by no_app) c on a.no_app=c.no_app  "+
					 "where b.progress='5' and b.no_kas='-' and b.kode_lokasi='"+this.app._lokasi+"' "+
	...
	doDoubleClick5: function(sender, col , row) {
		...
		if (noSPB != "") {					
			var strSQL = "select a.bank,a.cabang,a.no_rek,a.nama_rek,a.bruto,a.pajak,a.nilai "+
						 "from spm_rek a inner join spm_if_m b on a.no_bukti=b.no_if and a.kode_lokasi=b.kode_lokasi "+
						 ...
						 "from spm_rek a inner join spm_ifreim_m b on a.no_bukti=b.no_reim and a.kode_lokasi=b.kode_lokasi "+
						 "where b.no_ver in ("+noSPB+") and b.kode_lokasi ='"+this.app._lokasi+"' "+
						 "union all "+
						 ...
						 "select a.bank,a.cabang,a.no_rek,a.nama_rek,a.bruto,a.pajak,a.nilai "+
						 "from spm_rek a inner join pd_spj_m c on a.no_bukti=c.no_spj and a.kode_lokasi=c.kode_lokasi  "+
						 "where c.no_ver in ("+noSPB+") and c.kode_lokasi ='"+this.app._lokasi+"' "+
				...
				switch(methodName){
	    			case "execArraySQL" :	    				
						if (result.toLowerCase().search("error") == -1){
							if (this.preView == "1") {								
								this.nama_report="server_report_saku3_kb_rptKbDaftarTransferSpm";
	...
	doLoad3:function(sender){																		
		var strSQL = "select a.no_kas,convert(varchar,a.tanggal,103) as tgl,a.jenis,a.no_dokumen,a.keterangan,a.nilai "+
		             "from kas_m a "+					 					 
					 "where a.no_del='-' and a.periode='"+this.e_periode.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' and a.modul = 'KBSPB' and a.posted ='F'";		
		var data = this.dbLib.getDataProvider(strSQL,true);
		if (typeof data == "object" && data.rs.rows[0] != undefined){
			this.dataJU3 = data;
	...
	doDoubleClick3: function(sender, col , row) {
		try{
			if (this.sg3.cells(0,row) != "") {
				...
				var strSQL = "select 'BAYAR' as status,b.no_ver as no_spb,b.no_if as no_bukti,convert(varchar,b.tanggal,103) as tgl,convert(varchar,b.tanggal,103) as duedate,b.keterangan,b.nilai,'IFAJU' as modul "+
							 "from spm_app_m a inner join spm_if_m b on a.no_app=b.no_ver and a.kode_lokasi=b.kode_lokasi "+
							 ...
							 "select 'BAYAR' as status,b.no_ver as no_spb,b.no_spj as no_bukti,convert(varchar,aa.tanggal,103) as tgl,convert(varchar,aa.tanggal,103) as duedate,aa.tujuan keterangan,dd.nilai,a.modul "+
							 "from spm_app_m a inner join pd_spj_m b on a.no_app=b.no_ver and a.kode_lokasi=b.kode_lokasi "+
							 "				   inner join pd_aju_m aa on b.no_aju=aa.no_aju and aa.kode_lokasi=b.kode_lokasi "+
							 "				   inner join ( "+
							 "						select no_spj,sum(total) as nilai "+
				...
				var data = this.dbLib.getDataProvider(
							...
							"              inner join pp c on a.kode_pp=c.kode_pp and a.kode_lokasi=c.kode_lokasi "+							
							"where a.no_bukti = '"+this.e_nb.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' and a.modul='KBSPB' order by a.kode_akun",true);
				if (typeof data == "object" && data.rs.rows[0] != undefined){
					var line;
					this.sg2.clear();
					for (var i in data.rs.rows){
