window.app_saku3_transaksi_spm_fReklasBDDvendor = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_spm_fReklasBDDvendor.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spm_fReklasBDDvendor";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Penyelesaian BDD by Vendor", 0);	
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[5,12,990,242], childPage:["Data BDD","Data Anggaran"]});
...
window.app_saku3_transaksi_spm_fReklasBDDvendor.extend(window.childForm);
window.app_saku3_transaksi_spm_fReklasBDDvendor.implement({		
