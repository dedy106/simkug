window.app_saku3_transaksi_spm_fJenisProyek = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_spm_fJenisProyek.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spm_fJenisProyek";
		...
		this.p1 = new panel(this.pc1.childPage[1],{bound:[1,23,600,253],caption:"Akun Beban Proyek"});
...
window.app_saku3_transaksi_spm_fJenisProyek.extend(window.childForm);
window.app_saku3_transaksi_spm_fJenisProyek.implement({
		...
		try{						
			if (this.standarLib.checkEmptyByTag(this, [0,1])){
				try{									
					...
					sql.add("insert into spm_proyek_jenis(kode_jenis,kode_lokasi,nama,akun_bdd,akun_piutang,akun_pdpt,akun_bmhd,kode_pp,akun_pph) values "+
						    "('"+this.cb_kode.getText()+"','"+this.app._lokasi+"','"+this.e_nama.getText()+"','"+this.cb_bdd.getText()+"','"+this.cb_piu.getText()+"','"+this.cb_pdpt.getText()+"','"+this.cb_bmhd.getText()+"','"+this.cb_pp.getText()+"','"+this.cb_pph.getText()+"')");
