window.app_saku3_transaksi_spm_fAppCab = function(owner)
{
	if (owner)
	{		
		window.app_saku3_transaksi_spm_fAppCab.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spm_fAppCab";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Approval Ka Cabang", 0);	
		
		uses("saiCB;saiMemo;saiCBBL;saiEdit;datePicker;saiGrid;sgNavigator;pageControl;checkBox");				
		uses("saiCBBL",true);
		this.c_modul3 = new saiCB(this,{bound:[20,10,200,20],caption:"Modul",items:["IFAJU","IFREIM","PBBAU","PBPR","PBBDD","PBLOG","PJAJU","PJPTG"], tag:9,change:[this,"doChange"]});
		this.e_periode = new portalui_saiLabelEdit(this,{bound:[20,11,200,20],caption:"Periode",tag:2,readOnly:true,visible:false});
		this.l_tgl1 = new portalui_label(this,{bound:[20,11,100,18],caption:"Tanggal", underline:true});
		this.dp_d1 = new portalui_datePicker(this,{bound:[120,11,98,18],selectDate:[this,"doSelectDate"]});		
		
		this.pc1 = new pageControl(this,{bound:[10,18,1000,407], childPage:["Daftar Bukti","Detail Bukti","Jurnal & Budget","Filter Data"]});		
		...
		this.c_modul2 = new saiCB(this.pc1.childPage[3],{bound:[20,11,200,20],caption:"Modul",items:["IFAJU","IFREIM","PBBAU","PBPR","PBBDD","PBLOG","PJAJU","PJPTG","PRPTG"], readOnly:true,tag:9,change:[this,"doChange"]});
...
window.app_saku3_transaksi_spm_fAppCab.extend(window.childForm);
window.app_saku3_transaksi_spm_fAppCab.implement({	
		...
		try{															
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					if (this.e_modul.getText() == "PBLOG") sql.add("update yk_pb_m set no_app='"+this.e_nb.getText()+"',progress='"+vStatus+"' where no_pb='"+this.e_nobukti.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");
	...
	doModalResult: function(event, modalResult){
		...
		switch (event){
			...
			case "hapus" :	
				...
				if (this.e_modul.getText() == "PBLOG") sql.add("update yk_pb_m set no_app='-',progress='0' where no_pb='"+this.e_nobukti.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");
	...
	doChange:function(sender){	
		...
		if (sender == this.c_modul2) {
			if (this.c_modul2.getText() == "IFAJU") this.cb_nb.setSQL("select no_if, keterangan from spm_if_m where kode_pp='"+this.app._kodePP+"' and periode<='"+this.e_periode.getText()+"' and progress in ('1','C') and kode_lokasi='"+this.app._lokasi+"'",["no_if","keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);		
			if (this.c_modul2.getText() == "IFREIM") this.cb_nb.setSQL("select no_reim, keterangan from spm_ifreim_m where kode_pp='"+this.app._kodePP+"' and periode<='"+this.e_periode.getText()+"' and progress in ('1','C') and kode_lokasi='"+this.app._lokasi+"'",["no_reim","keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);		
			if (this.c_modul2.getText() == "PBBAU") this.cb_nb.setSQL("select no_pb, keterangan from yk_pb_m where kode_pp='"+this.app._kodePP+"' and periode<='"+this.e_periode.getText()+"' and progress in ('1','C') and kode_lokasi='"+this.app._lokasi+"'",["no_pb","keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);								
			if (this.c_modul2.getText() == "PBPR") this.cb_nb.setSQL("select no_pb, keterangan from yk_pb_m where kode_pp='"+this.app._kodePP+"' and periode<='"+this.e_periode.getText()+"' and progress in ('1','C') and kode_lokasi='"+this.app._lokasi+"'",["no_pb","keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);					
			if (this.c_modul2.getText() == "PBBDD") this.cb_nb.setSQL("select no_pb, keterangan from yk_pb_m where kode_pp='"+this.app._kodePP+"' and periode<='"+this.e_periode.getText()+"' and progress in ('1','C') and kode_lokasi='"+this.app._lokasi+"'",["no_pb","keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);					
			if (this.c_modul2.getText() == "PBLOG") this.cb_nb.setSQL("select no_pb, keterangan from yk_pb_m where kode_pp='"+this.app._kodePP+"' and periode<='"+this.e_periode.getText()+"' and progress in ('1','C') and kode_lokasi='"+this.app._lokasi+"'",["no_pb","keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);					
			if (this.c_modul2.getText() == "PJAJU") this.cb_nb.setSQL("select no_panjar, keterangan from panjar2_m where kode_pp='"+this.app._kodePP+"' and periode<='"+this.e_periode.getText()+"' and progress in ('1','C') and kode_lokasi='"+this.app._lokasi+"'",["no_panjar","keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);					
			if (this.c_modul2.getText() == "PJPTG" || this.c_modul2.getText() == "PRPTG") this.cb_nb.setSQL("select no_ptg, keterangan from panjarptg2_m where kode_pp='"+this.app._kodePP+"' and periode<='"+this.e_periode.getText()+"' and progress in ('1','C') and kode_lokasi='"+this.app._lokasi+"'",["no_ptg","keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);					
		}
		if (sender == this.cb_nb && this.cb_nb.getText() != "") {
			...
			if (this.c_modul2.getText() == "PBBAU") {					
				var strSQL = "select a.due_date,a.no_pb as no_bukti,case a.progress when '1' then 'APPROVE' else 'RETURN' end as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.tanggal,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,'-' as no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_app as no_app1,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
	...
	doClick:function(sender){		
		this.e_nb.setText(this.standarLib.noBuktiOtomatis(this.dbLib,"spm_app_m","no_app",this.app._lokasi+"-APC"+this.e_periode.getText().substr(2,4)+".","0000"));												
	...
	doLoad:function(sender){	
		if (this.c_modul3.getText() == "")	{															
			var strSQL = "select a.tanggal as due_date,a.no_if as no_bukti,'INPROG' as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.tanggal,103) as tgl2,'IFAJU' as modul,b.kode_pp+' - '+b.nama as pp,a.no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_app1,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
						 "from spm_if_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
						 "                inner join karyawan c on a.nik=c.nik and a.kode_lokasi=c.kode_lokasi "+
						 "where a.progress='0' and a.kode_lokasi='"+this.app._lokasi+"' and a.kode_pp='"+this.app._kodePP+"' and a.nik_app='"+this.app._userLog+"' "+					 
						 ...
						 "from spm_ifreim_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
						 "                    inner join karyawan c on a.nik=c.nik and a.kode_lokasi=c.kode_lokasi "+
						 "where a.progress='0' and a.kode_lokasi='"+this.app._lokasi+"' and a.kode_pp='"+this.app._kodePP+"' "+					 
						 ...
						 "from yk_pb_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
						 "               inner join karyawan c on a.nik_user=c.nik and a.kode_lokasi=c.kode_lokasi "+
						 "where a.progress='0' and a.kode_lokasi='"+this.app._lokasi+"' and a.kode_pp='"+this.app._kodePP+"' and a.modul<>'REVPB' "+					 
					 
						 "union all "+
					 
						 "select a.due_date,a.no_panjar as no_bukti,'INPROG' as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.due_date,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,a.no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_app as no_app1,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
						 "from panjar2_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
						 "                 inner join karyawan c on a.nik_buat=c.nik and a.kode_lokasi=c.kode_lokasi "+
						 "where a.progress='0' and a.kode_lokasi='"+this.app._lokasi+"' and a.kode_pp='"+this.app._kodePP+"' "+					 
			...
			if (this.c_modul3.getText() == "PBBAU")	{
				strSQL = "select a.due_date,a.no_pb as no_bukti,'INPROG' as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.due_date,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,'-' as no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_app as no_app1,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
						 "from yk_pb_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
						 "               inner join karyawan c on a.nik_user=c.nik and a.kode_lokasi=c.kode_lokasi "+
						 "where a.progress='0' and a.kode_lokasi='"+this.app._lokasi+"' and a.kode_pp='"+this.app._kodePP+"' and a.modul='PBBAU'";
			}	
			if (this.c_modul3.getText() == "PBPR")	{
				strSQL = "select a.due_date,a.no_pb as no_bukti,'INPROG' as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.due_date,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,'-' as no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_app as no_app1,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
						 "from yk_pb_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
						 "               inner join karyawan c on a.nik_user=c.nik and a.kode_lokasi=c.kode_lokasi "+
						 "where a.progress='0' and a.kode_lokasi='"+this.app._lokasi+"' and a.kode_pp='"+this.app._kodePP+"' and a.modul='PBPR'";
			} 
			if (this.c_modul3.getText() == "PBBDD")	{
				strSQL = "select a.due_date,a.no_pb as no_bukti,'INPROG' as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.due_date,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,'-' as no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_app as no_app1,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
						 "from yk_pb_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
						 "               inner join karyawan c on a.nik_user=c.nik and a.kode_lokasi=c.kode_lokasi "+
						 "where a.progress='0' and a.kode_lokasi='"+this.app._lokasi+"' and a.kode_pp='"+this.app._kodePP+"' and a.modul='PBBDD'";
			} 
			if (this.c_modul3.getText() == "PBLOG")	{
				strSQL = "select a.due_date,a.no_pb as no_bukti,'INPROG' as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.due_date,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,'-' as no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_app as no_app1,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
						 "from yk_pb_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
						 "               inner join karyawan c on a.nik_user=c.nik and a.kode_lokasi=c.kode_lokasi "+
						 "where a.progress='0' and a.kode_lokasi='"+this.app._lokasi+"' and a.kode_pp='"+this.app._kodePP+"' and a.modul='PBLOG'";
			} 
	...
	doTampilData: function(page) {
		...
		for (var i=start;i<finish;i++){
			...
			this.sg.appendData([line.modul.toUpperCase(),line.no_bukti,line.status.toUpperCase(),line.tgl,line.tgl2,line.pp,line.no_dokumen,line.keterangan,floatToNilai(line.nilai),line.pembuat,line.no_app1,line.tglinput,line.kode_pp]); 
		}
