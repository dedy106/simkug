window.app_saku3_transaksi_spm_fHutangAkru = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_spm_fHutangAkru.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spm_fHutangAkru";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Akru Hutang", 0);	
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[5,12,990,244], childPage:["Data Item Jurnal","Data Anggaran"]});
...
window.app_saku3_transaksi_spm_fHutangAkru.extend(window.childForm);
window.app_saku3_transaksi_spm_fHutangAkru.implement({	
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					sql.add("insert into hutang_m(no_hutang,kode_lokasi,no_dokumen,tanggal,keterangan,kode_project,kode_vendor,kode_curr,kurs,nik_app,kode_pp,nilai,periode,nik_user,tgl_input,akun_hutang,posted,nilai_ppn,modul,no_ref,kode_proyek) values  "+
							"('"+this.e_nb.getText()+"','"+this.app._lokasi+"','"+this.e_dok.getText()+"','"+this.dp_d1.getDateString()+"','"+this.e_ket.getText()+"','-','"+this.cb_vendor.getText()+"','IDR',1,'"+this.app._userLog+"','"+this.cb_pp.getText()+"',"+parseNilai(this.e_total.getText())+",'"+this.e_periode.getText()+"','"+this.app._userLog+"',getdate(),'"+this.cb_akun.getText()+"','F',0,'AKRU','-','"+this.cb_proyek.getText()+"')");
