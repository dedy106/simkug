window.app_saku3_transaksi_spm_fBillDummy2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_spm_fBillDummy2.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_spm_fBillDummy2";
...
window.app_saku3_transaksi_spm_fBillDummy2.extend(window.childForm);
window.app_saku3_transaksi_spm_fBillDummy2.implement({
