window.app_saku3_transaksi_yspt_dikti_fCDoutNonCash = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_dikti_fCDoutNonCash.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_dikti_fCDoutNonCash";
		this.itemsValue = new arrayList();
		this.maximize();	
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Penyelesaian PDD MHS", 0);	
		...
		this.cb_nim = new saiCBBL(this.pc2.childPage[0],{bound:[20,18,220,20],caption:"NIM", multiSelection:false, maxLength:10, tag:1, change:[this,"doChange"]});				
...
window.app_saku3_transaksi_yspt_dikti_fCDoutNonCash.extend(window.childForm);
window.app_saku3_transaksi_yspt_dikti_fCDoutNonCash.implement({
			...
			if (this.sg3.cells(0,row) != "") {
				...
				if (typeof data == "object"){
					...
					if (line != undefined){																
						...
						this.cb_nim.setSQL("select nim, nama from dikti_mhs where nim ='"+line.param1+"' and kode_lokasi='"+this.app._lokasi+"' "
										   				,["nim","nama"],false,["NIM","Nama"],"and","Daftar Mahasiswa",true);												   
