window.app_saku3_transaksi_yspt_fMintaKb = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_fMintaKb.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_fMintaKb";
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[1,12,995,305], childPage:["Detail Permintaan","Budget"]});
...
window.app_saku3_transaksi_yspt_fMintaKb.extend(window.childForm);
window.app_saku3_transaksi_yspt_fMintaKb.implement({
