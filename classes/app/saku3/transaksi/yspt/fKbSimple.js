window.app_saku3_transaksi_yspt_fKbSimple = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_fKbSimple.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_fKbSimple";		
		...
		this.pc1 = new pageControl(this.pc2.childPage[1],{bound:[5,12,990,300], childPage:["Data Item Jurnal","Data Anggaran","Referensi Jurnal"]});
...
window.app_saku3_transaksi_yspt_fKbSimple.extend(window.childForm);
window.app_saku3_transaksi_yspt_fKbSimple.implement({	
