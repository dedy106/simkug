window.app_saku3_transaksi_yspt_sistem_fSpro = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_sistem_fSpro.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_sistem_fSpro";
...
window.app_saku3_transaksi_yspt_sistem_fSpro.extend(window.childForm);
window.app_saku3_transaksi_yspt_sistem_fSpro.implement({
