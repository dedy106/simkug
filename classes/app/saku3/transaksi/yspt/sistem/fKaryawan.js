window.app_saku3_transaksi_yspt_sistem_fKaryawan = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_sistem_fKaryawan.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_sistem_fKaryawan";
		...
		this.c_jenis = new saiCB(this.pc1.childPage[1],{bound:[20,24,200,20],caption:"Status",items:["ORGANIK","GURU"], readOnly:true,tag:2});
...
window.app_saku3_transaksi_yspt_sistem_fKaryawan.extend(window.childForm);
window.app_saku3_transaksi_yspt_sistem_fKaryawan.implement({
	doLoadPP : function() {
