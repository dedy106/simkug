window.app_saku3_transaksi_yspt_mhs_fParamBiaya = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_mhs_fParamBiaya.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_mhs_fParamBiaya";
...
window.app_saku3_transaksi_yspt_mhs_fParamBiaya.extend(window.childForm);
window.app_saku3_transaksi_yspt_mhs_fParamBiaya.implement({		
