window.app_saku3_transaksi_yspt_fJuSimple = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_fJuSimple.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_fJuSimple";		
...
window.app_saku3_transaksi_yspt_fJuSimple.extend(window.childForm);
window.app_saku3_transaksi_yspt_fJuSimple.implement({	
