window.app_saku3_transaksi_yspt_simak_fBayarDaftarLoadH = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_simak_fBayarDaftarLoadH.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_simak_fBayarDaftarLoadH";
...
window.app_saku3_transaksi_yspt_simak_fBayarDaftarLoadH.extend(window.childForm);
window.app_saku3_transaksi_yspt_simak_fBayarDaftarLoadH.implement({
