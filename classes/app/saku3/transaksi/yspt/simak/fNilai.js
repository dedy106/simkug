window.app_saku3_transaksi_yspt_simak_fNilai = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_simak_fNilai.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_simak_fNilai";
...
window.app_saku3_transaksi_yspt_simak_fNilai.extend(window.childForm);
window.app_saku3_transaksi_yspt_simak_fNilai.implement({
