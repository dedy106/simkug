window.app_saku3_transaksi_yspt_simak_fTarifDaftar = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_simak_fTarifDaftar.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_simak_fTarifDaftar";
...
window.app_saku3_transaksi_yspt_simak_fTarifDaftar.extend(window.childForm);
window.app_saku3_transaksi_yspt_simak_fTarifDaftar.implement({
