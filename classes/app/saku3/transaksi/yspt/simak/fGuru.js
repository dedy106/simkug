window.app_saku3_transaksi_yspt_simak_fGuru = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_simak_fGuru.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_simak_fGuru";
...
window.app_saku3_transaksi_yspt_simak_fGuru.extend(window.childForm);
window.app_saku3_transaksi_yspt_simak_fGuru.implement({
