window.app_saku3_transaksi_yspt_simak_fTA = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_simak_fTA.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_simak_fTA";
		...
		this.pc1 = new pageControl(this,{bound:[20,12,1000,440], childPage:["Daftar Tahun Ajaran","Data Tahun Ajaran"]});				
...
window.app_saku3_transaksi_yspt_simak_fTA.extend(window.childForm);
window.app_saku3_transaksi_yspt_simak_fTA.implement({
