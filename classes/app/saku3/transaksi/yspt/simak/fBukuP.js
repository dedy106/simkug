window.app_saku3_transaksi_yspt_simak_fBukuP = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_simak_fBukuP.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_simak_fBukuP";
...
window.app_saku3_transaksi_yspt_simak_fBukuP.extend(window.childForm);
window.app_saku3_transaksi_yspt_simak_fBukuP.implement({
