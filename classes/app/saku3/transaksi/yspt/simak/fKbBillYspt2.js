window.app_saku3_transaksi_yspt_simak_fKbBillYspt2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_simak_fKbBillYspt2.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_simak_fKbBillYspt2";
		...
		this.pc1 = new pageControl(this,{bound:[5,12,1000,330], childPage:["Data Tagihan","Data Pelunasan","Error Msg"]});
		...
		this.sg1 = new portalui_saiGrid(this.pc1.childPage[1],{bound:[1,5,this.pc1.width-5,this.pc1.height-35],colCount:4,
...
window.app_saku3_transaksi_yspt_simak_fKbBillYspt2.extend(window.childForm);
window.app_saku3_transaksi_yspt_simak_fKbBillYspt2.implement({
		...
		try{						
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{													
					...
					//jika idbank sudah dipake oleh sis_siswa maka gak boleh update id banknya ke noreg (30 juli 2020)					
					sql.add("update a set a.nis=b.no_reg "+
							"from sis_cd_d a "+
							
							"inner join (select a.id_bank,a.kode_pp,a.no_reg,a.kode_lokasi "+
							"			from sis_siswareg a left join sis_siswa b on a.id_bank=b.id_bank and a.kode_lokasi=b.kode_lokasi and a.kode_pp=b.kode_pp "+
							"			where b.nis is null and a.kode_pp='"+this.cb_pp.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' "+
							"			) b on a.nis=b.id_bank and a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
