window.app_saku3_transaksi_yspt_simak_fRekBillYsptBeaAlokasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_simak_fRekBillYsptBeaAlokasi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_simak_fRekBillYsptBeaAlokasi";
		...
		this.e_sisa = new saiLabelEdit(this,{bound:[790,17,200,20],caption:"Tot Sisa Beasiswa", tag:1, readOnly:true, tipeText:ttNilai, text:"0"});		
		...
		this.pc1 = new pageControl(this,{bound:[1,12,995,360], childPage:["Alokasi Beasiswa","Data Tagihan","Data Pelunasan"]});
		...
		this.cb_drk = new saiCBBL(this.pc1.childPage[0],{bound:[20,21,220,20],caption:"DRK", readOnly:true, maxLength:10, tag:2 });
...
window.app_saku3_transaksi_yspt_simak_fRekBillYsptBeaAlokasi.extend(window.childForm);
window.app_saku3_transaksi_yspt_simak_fRekBillYsptBeaAlokasi.implement({	
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{													
					...
					sql.add("insert into sis_rekon_j(no_rekon,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,nilai,kode_pp,kode_drk,kode_lokasi,modul,jenis,periode,kode_curr,kurs,nik_user,tgl_input) values "+
							"('"+this.e_nb.getText()+"','-','"+this.dp_d1.getDateString()+"',0,'"+this.cb_titip.getText()+"','"+this.e_ket.getText()+"','D',"+total+",'"+this.cb_ppkirim.getText()+"','"+this.cb_drk.getText()+"','"+this.app._lokasi+"','LOADBEA','TTP','"+this.e_periode.getText()+"','IDR',1,'"+this.app._userLog+"',getdate())");					
					
					sql.add("insert into angg_r(no_bukti,modul,kode_lokasi,kode_akun,kode_pp,kode_drk,periode1,periode2,dc,saldo,nilai) values "+
							"('"+this.e_nb.getText()+"','LOADBEA','"+this.app._lokasi+"','"+this.cb_titip.getText()+"','"+this.cb_ppkirim.getText()+"','"+this.cb_drk.getText()+"','"+this.e_periode.getText()+"','"+this.e_periode.getText()+"','D',0,"+total+")");
