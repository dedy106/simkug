window.app_saku3_transaksi_yspt_simak_fRekonYpt = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_simak_fRekonYpt.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_simak_fRekonYpt";
...
window.app_saku3_transaksi_yspt_simak_fRekonYpt.extend(window.childForm);
window.app_saku3_transaksi_yspt_simak_fRekonYpt.implement({
