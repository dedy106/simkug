window.app_saku3_transaksi_yspt_simak_fAkruBillYpt2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_simak_fAkruBillYpt2.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_simak_fAkruBillYpt2";
		...
		this.sg = new saiGrid(this.pc1.childPage[0],{bound:[0,5,this.pc1.width-5,this.pc1.height-35],colCount:6,tag:0,
				colTitle:["PP / Unit","Kode Param","Nama Parameter","Akun Piutang","Akun Pdpt","Nilai"],
...
window.app_saku3_transaksi_yspt_simak_fAkruBillYpt2.extend(window.childForm);
window.app_saku3_transaksi_yspt_simak_fAkruBillYpt2.implement({
