window.app_saku3_transaksi_yspt_simak_fCDoutNonCash = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_simak_fCDoutNonCash.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_simak_fCDoutNonCash";
...
window.app_saku3_transaksi_yspt_simak_fCDoutNonCash.extend(window.childForm);
window.app_saku3_transaksi_yspt_simak_fCDoutNonCash.implement({
