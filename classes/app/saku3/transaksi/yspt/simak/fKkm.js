window.app_saku3_transaksi_yspt_simak_fKkm = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_simak_fKkm.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_simak_fKkm";
...
window.app_saku3_transaksi_yspt_simak_fKkm.extend(window.childForm);
window.app_saku3_transaksi_yspt_simak_fKkm.implement({
