window.app_saku3_transaksi_yspt_simak_fParamTarifAdd = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_simak_fParamTarifAdd.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_simak_fParamTarifAdd";
		...
		try {
			...
			sql.add("select a.kode_tingkat, a.nama from sis_tingkat a inner join sis_tingkat_pp b on a.kode_tingkat=b.kode_tingkat and a.kode_lokasi=b.kode_lokasi and b.kode_pp='"+this.app._kodePP+"' where a.kode_lokasi='"+this.app._lokasi+"'");	
...
window.app_saku3_transaksi_yspt_simak_fParamTarifAdd.extend(window.childForm);
window.app_saku3_transaksi_yspt_simak_fParamTarifAdd.implement({	
			...
			if (sender == this.sg1) {
				if (col == 0){
					this.standarLib.showListData(this, "Daftar Tingkat",sender,undefined, 
												  ...
												  "select count(*) from (select a.kode_tingkat from sis_tingkat a inner join sis_tingkat_pp b on a.kode_tingkat=b.kode_tingkat and a.kode_lokasi=b.kode_lokasi and b.kode_pp='"+this.app._kodePP+"' where a.kode_lokasi='"+this.app._lokasi+"') a",
