window.app_saku3_transaksi_yspt_simak_fGbrDepan = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_simak_fGbrDepan.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_simak_fGbrDepan";
...
window.app_saku3_transaksi_yspt_simak_fGbrDepan.extend(window.childForm);
window.app_saku3_transaksi_yspt_simak_fGbrDepan.implement({
