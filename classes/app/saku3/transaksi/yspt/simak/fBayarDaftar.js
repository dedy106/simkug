window.app_saku3_transaksi_yspt_simak_fBayarDaftar = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_simak_fBayarDaftar.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_simak_fBayarDaftar";
...
window.app_saku3_transaksi_yspt_simak_fBayarDaftar.extend(window.childForm);
window.app_saku3_transaksi_yspt_simak_fBayarDaftar.implement({
