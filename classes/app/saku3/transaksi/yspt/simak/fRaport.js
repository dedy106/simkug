window.app_saku3_transaksi_yspt_simak_fRaport = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_simak_fRaport.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_simak_fRaport";
...
window.app_saku3_transaksi_yspt_simak_fRaport.extend(window.childForm);
window.app_saku3_transaksi_yspt_simak_fRaport.implement({
