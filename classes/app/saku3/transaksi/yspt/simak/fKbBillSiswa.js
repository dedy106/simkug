window.app_saku3_transaksi_yspt_simak_fKbBillSiswa = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_simak_fKbBillSiswa.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_simak_fKbBillSiswa";
...
window.app_saku3_transaksi_yspt_simak_fKbBillSiswa.extend(window.childForm);
window.app_saku3_transaksi_yspt_simak_fKbBillSiswa.implement({
