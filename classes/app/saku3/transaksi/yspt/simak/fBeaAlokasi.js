window.app_saku3_transaksi_yspt_simak_fBeaAlokasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_simak_fBeaAlokasi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_simak_fBeaAlokasi";
...
window.app_saku3_transaksi_yspt_simak_fBeaAlokasi.extend(window.childForm);
window.app_saku3_transaksi_yspt_simak_fBeaAlokasi.implement({	
