...
window.app_saku3_transaksi_yspt_simak_fKbBillVA = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_simak_fKbBillVA.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_simak_fKbBillVA";
...
window.app_saku3_transaksi_yspt_simak_fKbBillVA.extend(window.childForm);
window.app_saku3_transaksi_yspt_simak_fKbBillVA.implement({
