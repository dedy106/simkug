window.app_saku3_transaksi_yspt_fAppCab = function(owner)
{
	if (owner)
	{		
		window.app_saku3_transaksi_yspt_fAppCab.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_fAppCab";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Approval & Verifikasi", 0);	
		
		uses("saiCB;saiMemo;saiCBBL;saiEdit;datePicker;saiGrid;sgNavigator;pageControl;checkBox");				
		uses("saiCBBL",true);
		this.c_modul3 = new saiCB(this,{bound:[20,10,200,20],caption:"Modul",items:["DROPING"], tag:9,change:[this,"doChange"]});
...
window.app_saku3_transaksi_yspt_fAppCab.extend(window.childForm);
window.app_saku3_transaksi_yspt_fAppCab.implement({	
