window.app_saku3_transaksi_yspt_kug_fFasusutRev = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_kug_fFasusutRev.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_kug_fFasusutRev";
...
window.app_saku3_transaksi_yspt_kug_fFasusutRev.extend(window.childForm);
window.app_saku3_transaksi_yspt_kug_fFasusutRev.implement({
