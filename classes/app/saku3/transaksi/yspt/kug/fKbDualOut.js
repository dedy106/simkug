window.app_saku3_transaksi_yspt_kug_fKbDualOut = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_kug_fKbDualOut.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_kug_fKbDualOut";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form KasBank Dual Akun Pengeluaran", 0);	
...
window.app_saku3_transaksi_yspt_kug_fKbDualOut.extend(window.childForm);
window.app_saku3_transaksi_yspt_kug_fKbDualOut.implement({	
