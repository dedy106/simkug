window.app_saku3_transaksi_yspt_kug_fJP = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_kug_fJP.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku3_transaksi_yspt_kug_fJP";
		...
		this.bGar = new portalui_button(this,{bound:[580,15,80,20],caption:"Tampil",hint:"Load",image:"icon/"+system.getThemes()+"/tabCont2.png",click:[this,"doUploadTB"]});
		
		this.p1 = new portalui_panel(this,{bound:[20,189,900,344],caption:"Data Saldo Akun"});
		this.sg1 = new saiGrid(this.p1,{bound:[0,20,this.p1.width-5,this.p1.height-50],colCount:6,tag:0,
...
window.app_saku3_transaksi_yspt_kug_fJP.extend(window.portalui_childForm);
window.app_saku3_transaksi_yspt_kug_fJP.implement({
	doUploadTB: function(){		
		try{
			...
			sql = "select a.kode_akun,b.nama,a.so_awal,a.debet,a.kredit,round(a.so_akhir,4) as so_akhir "+
				  "from glma_tmp a inner join masakun b on b.kode_akun = a.kode_akun and b.kode_lokasi = a.kode_lokasi and b.modul = 'L' where a.kode_lokasi ='"+this.app._lokasi+"' and a.nik_user = '"+this.nik_user+"' and round(a.so_akhir,4) <> 0 order by a.kode_akun";
