window.app_saku3_transaksi_yspt_kug_fJuSimple = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_kug_fJuSimple.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_kug_fJuSimple";
		...
		this.sg3 = new saiGrid(this.pc2.childPage[1],{bound:[1,5,this.pc2.width-5,this.pc2.height-32],colCount:4,tag:9,
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[1,12,995,337], childPage:["Data Item Jurnal","Data Anggaran"]});
...
window.app_saku3_transaksi_yspt_kug_fJuSimple.extend(window.childForm);
window.app_saku3_transaksi_yspt_kug_fJuSimple.implement({	
	...
	doModalResult: function(event, modalResult){
		...
		switch (event){
			...
			case "simpan" :															
			case "ubah" :		
				if (parseFloat(this.e_periode.getText().substring(0,4)) > 2017)	{
					system.alert(this,"Transaksi tidak valid.","Hanya untuk tahun transaksi kurang dari 2018.");
					return false;						
				}													
				this.preView = "1";
				this.sg.validasi();																
