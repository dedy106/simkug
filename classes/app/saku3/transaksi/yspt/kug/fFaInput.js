window.app_saku3_transaksi_yspt_kug_fFaInput = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_kug_fFaInput.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_kug_fFaInput";
...
window.app_saku3_transaksi_yspt_kug_fFaInput.extend(window.childForm);
window.app_saku3_transaksi_yspt_kug_fFaInput.implement({
