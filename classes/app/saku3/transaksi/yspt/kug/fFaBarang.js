window.app_saku3_transaksi_yspt_kug_fFaBarang = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_kug_fFaBarang.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_kug_fFaBarang";
...
window.app_saku3_transaksi_yspt_kug_fFaBarang.extend(window.childForm);
window.app_saku3_transaksi_yspt_kug_fFaBarang.implement({
