window.app_saku3_transaksi_yspt_kug_fClosing = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_kug_fClosing.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_kug_fClosing";
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Closing Periode Bulanan", 0);	
...
window.app_saku3_transaksi_yspt_kug_fClosing.extend(window.childForm);
window.app_saku3_transaksi_yspt_kug_fClosing.implement({
