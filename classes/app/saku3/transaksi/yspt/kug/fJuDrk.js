window.app_saku3_transaksi_yspt_kug_fJuDrk = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_kug_fJuDrk.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_kug_fJuDrk";
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[5,12,990,327], childPage:["Data Item Jurnal","Data Anggaran","Referensi Jurnal"]});
...
window.app_saku3_transaksi_yspt_kug_fJuDrk.extend(window.childForm);
window.app_saku3_transaksi_yspt_kug_fJuDrk.implement({	
