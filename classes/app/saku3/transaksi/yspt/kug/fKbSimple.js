window.app_saku3_transaksi_yspt_kug_fKbSimple = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_kug_fKbSimple.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_kug_fKbSimple";		
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form KasBank Umum NonDRK", 0);	
		...
		this.pc2 = new pageControl(this,{bound:[10,10,1000,440], childPage:["Data Jurnal","List Jurnal","Cari Data"]});		
		...
		this.c_jenis = new saiCB(this.pc2.childPage[0],{bound:[20,11,200,20],caption:"Modul",items:["BK","BM"], readOnly:true,tag:2,change:[this,"doChange"]});		
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[5,12,990,315], childPage:["Data Item Jurnal","Data Anggaran","Referensi Jurnal"]});
...
window.app_saku3_transaksi_yspt_kug_fKbSimple.extend(window.childForm);
window.app_saku3_transaksi_yspt_kug_fKbSimple.implement({	
	...
	doModalResult: function(event, modalResult){
		...
		switch (event){
			...
			case "simpan" :															
			case "ubah" :		
				//hanya untuk 2018 ke atas tidak boleh, harus pakai yg drk
				if ( parseFloat(this.e_periode.getText().substr(0,4)) > 2017 ) {
					system.alert(this,"Transaksi tidak valid.","Sistem hanya untuk transaksi 2017 ke bawah.");
					return false;						
				}
	...
	doChange:function(sender){
		...
		if (sender == this.cb_ref && this.cb_ref.getText()!="") {
			var data = this.dbLib.getDataProvider(
					   "select a.kode_akun,b.nama as nama_akun,a.kode_pp,c.nama as nama_pp,a.dc,a.nilai,a.keterangan  "+
