window.app_saku3_transaksi_yspt_kug_fRefKeluar = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_kug_fRefKeluar.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_kug_fRefKeluar";
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Template Pengeluaran", 0);	
...
window.app_saku3_transaksi_yspt_kug_fRefKeluar.extend(window.childForm);
window.app_saku3_transaksi_yspt_kug_fRefKeluar.implement({
