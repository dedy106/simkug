window.app_saku3_transaksi_yspt_kug_fFasusutReg = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_kug_fFasusutReg.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_kug_fFasusutReg";
...
window.app_saku3_transaksi_yspt_kug_fFasusutReg.extend(window.childForm);
window.app_saku3_transaksi_yspt_kug_fFasusutReg.implement({
