window.app_saku3_transaksi_yspt_kug_fMasakunRelasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_kug_fMasakunRelasi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_kug_fMasakunRelasi";
...
window.app_saku3_transaksi_yspt_kug_fMasakunRelasi.extend(window.childForm);
window.app_saku3_transaksi_yspt_kug_fMasakunRelasi.implement({
