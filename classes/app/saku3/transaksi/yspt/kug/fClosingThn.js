window.app_saku3_transaksi_yspt_kug_fClosingThn = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_kug_fClosingThn.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_kug_fClosingThn";
...
window.app_saku3_transaksi_yspt_kug_fClosingThn.extend(window.childForm);
window.app_saku3_transaksi_yspt_kug_fClosingThn.implement({
