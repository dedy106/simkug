window.app_saku3_transaksi_yspt_kug_fFasusutCepat = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_kug_fFasusutCepat.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_kug_fFasusutCepat";
...
window.app_saku3_transaksi_yspt_kug_fFasusutCepat.extend(window.childForm);
window.app_saku3_transaksi_yspt_kug_fFasusutCepat.implement({
