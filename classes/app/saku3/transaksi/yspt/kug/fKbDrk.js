window.app_saku3_transaksi_yspt_kug_fKbDrk = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_kug_fKbDrk.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_kug_fKbDrk";
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[1,12,995,305], childPage:["Data Item Jurnal","Data Anggaran","Referensi Jurnal"]});
...
window.app_saku3_transaksi_yspt_kug_fKbDrk.extend(window.childForm);
window.app_saku3_transaksi_yspt_kug_fKbDrk.implement({	
