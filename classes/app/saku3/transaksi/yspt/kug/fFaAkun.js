window.app_saku3_transaksi_yspt_kug_fFaAkun = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_kug_fFaAkun.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_kug_fFaAkun";
...
window.app_saku3_transaksi_yspt_kug_fFaAkun.extend(window.childForm);
window.app_saku3_transaksi_yspt_kug_fFaAkun.implement({
