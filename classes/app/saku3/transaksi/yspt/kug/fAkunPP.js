window.app_saku3_transaksi_yspt_kug_fAkunPP = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_kug_fAkunPP.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_kug_fAkunPP";
...
window.app_saku3_transaksi_yspt_kug_fAkunPP.extend(window.childForm);
window.app_saku3_transaksi_yspt_kug_fAkunPP.implement({
