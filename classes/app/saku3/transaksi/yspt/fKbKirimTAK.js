window.app_saku3_transaksi_yspt_fKbKirimTAK = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yspt_fKbKirimTAK.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yspt_fKbKirimTAK";
		...
		this.sg = new saiGrid(this.pc1.childPage[0],{bound:[1,5,this.pc1.width-5,this.pc1.height-30],colCount:7,tag:0,
		            colTitle:["Rek Penerima","Nama Akun","Nilai Pengajuan","No Pengajuan","PP/Unit","Keterangan","Kode PP"],
...
window.app_saku3_transaksi_yspt_fKbKirimTAK.extend(window.childForm);
window.app_saku3_transaksi_yspt_fKbKirimTAK.implement({
