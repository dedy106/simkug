window.app_saku3_transaksi_panjar_fPjAju = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_panjar_fPjAju.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_panjar_fPjAju";
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[5,12,990,350], childPage:["Pemegang & Approval","Item Akun","Data Anggaran","Cat. Approval"]});		
...
window.app_saku3_transaksi_panjar_fPjAju.extend(window.childForm);
window.app_saku3_transaksi_panjar_fPjAju.implement({
