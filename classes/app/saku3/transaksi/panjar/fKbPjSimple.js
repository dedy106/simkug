window.app_saku3_transaksi_panjar_fKbPjSimple = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_panjar_fKbPjSimple.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_panjar_fKbPjSimple";
...
window.app_saku3_transaksi_panjar_fKbPjSimple.extend(window.childForm);
window.app_saku3_transaksi_panjar_fKbPjSimple.implement({
