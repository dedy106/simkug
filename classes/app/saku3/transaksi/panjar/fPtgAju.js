window.app_saku3_transaksi_panjar_fPtgAju = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_panjar_fPtgAju.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_panjar_fPtgAju";
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[5,10,990,347], childPage:["Data Panjar","Item Mata Anggaran","KPA Anggaran","Cat. Approval"]});
...
window.app_saku3_transaksi_panjar_fPtgAju.extend(window.childForm);
window.app_saku3_transaksi_panjar_fPtgAju.implement({
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					if (this.stsSimpan == 0) {
						...
						sql.add("delete from angg_r where no_bukti = '"+this.cb_pj.getText()+"' and kode_lokasi='"+this.app._lokasi+"' and modul ='PJPTG2'");					
						...
						for (var i=0;i < this.sg2.getRowCount();i++){
							if (this.sg2.rowValid(i)){
								...
								sql.add("insert into angg_r(no_bukti,modul,kode_lokasi,kode_akun,kode_pp,kode_drk,periode1,periode2,dc,saldo,nilai) values "+
										"	('"+this.e_nb.getText()+"','PJPTG2','"+this.app._lokasi+"','"+this.sg2.cells(0,i)+"','"+this.sg2.cells(2,i)+"','"+this.sg2.cells(4,i)+"','"+this.periodePJ+"','"+this.e_periode.getText()+"','"+DC+"',"+parseNilai(this.sg2.cells(6,i))+","+nilai+")");
							}
						}
					}				
	...
	doHitungGar: function(){
		...
		var sls = 0;
		for (var i=0;i < this.sg2.getRowCount();i++){			
			if (this.stsSimpan == 1) var data = this.dbLib.getDataProvider("select fn_cekagg3('"+this.sg2.cells(2,i)+"','"+this.app._lokasi+"','"+this.sg2.cells(0,i)+"','"+this.sg2.cells(4,i)+"','"+this.periodePJ+"','"+this.cb_pj.getText()+"') as gar ",true);				
			else var data = this.dbLib.getDataProvider("select fn_cekagg3('"+this.sg2.cells(2,i)+"','"+this.app._lokasi+"','"+this.sg2.cells(0,i)+"','"+this.sg2.cells(4,i)+"','"+this.periodePJ+"','"+this.e_nb.getText()+"') as gar ",true);
