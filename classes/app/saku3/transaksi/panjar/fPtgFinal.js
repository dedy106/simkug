window.app_saku3_transaksi_panjar_fPtgFinal = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_panjar_fPtgFinal.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_panjar_fPtgFinal";
		...
		this.cb_akun = new portalui_saiLabelEdit(this.pc1.childPage[2],{bound:[20,16,200,20],caption:"Kode Akun",maxLength:30,readOnly:true});
...
window.app_saku3_transaksi_panjar_fPtgFinal.extend(window.childForm);
window.app_saku3_transaksi_panjar_fPtgFinal.implement({
				...
				try{														
					...
					if (nilaiToFloat(this.e_nilaikb.getText()) == 0) {
						...
						sql.add("insert into kas_m (no_kas,kode_lokasi,no_dokumen,no_bg,akun_kb,tanggal,keterangan,kode_pp,modul,jenis,periode,kode_curr,kurs,nilai,nik_buat,nik_app,tgl_input,nik_user,posted,no_del,no_link,ref1,kode_bank) values  "+
							    "('"+this.e_nbkb.getText()+"','"+this.app._lokasi+"','"+this.e_nb.getText()+"','-','"+this.cb_akun.getText()+"','"+this.dp_d1.getDateString()+"','"+this.e_ket.getText()+"','"+this.app._kodePP+"','KBSLSPJ','"+this.c_jenis.getText()+"','"+this.e_periode.getText()+"','IDR',1,"+parseNilai(this.e_nilaikb.getText())+",'"+this.app._userLog+"','"+this.app._userLog+"',getdate(),'"+this.app._userLog+"','F','-','"+this.e_noptg.getText()+"','"+this.e_nopj.getText()+"','"+this.cb_rek.getText()+"')");
						sql.add("insert into kas_j(no_kas,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,nilai,kode_pp,kode_drk,kode_cf,ref1,kode_lokasi,modul,jenis,periode,kode_curr,kurs,nik_user,tgl_input,kode_bank) values "+
								"('"+this.e_nbkb.getText()+"','"+this.e_nb.getText()+"','"+this.dp_d1.getDateString()+"',98,'"+this.cb_akun.getText()+"','"+this.e_ket.getText()+"','"+DCkb+"',"+Math.abs(nilaiToFloat(this.e_nilaikb.getText()))+",'"+this.app._kodePP+"','-','-','-','"+this.app._lokasi+"','KBSLSPJ','KB','"+this.e_periode.getText()+"','IDR',1,'"+this.app._userLog+"',getdate(),'"+this.cb_rek.getText()+"')");
