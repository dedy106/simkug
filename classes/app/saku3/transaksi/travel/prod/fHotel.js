window.app_saku3_transaksi_travel_prod_fHotel = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_travel_prod_fHotel.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_travel_prod_fHotel";
...
window.app_saku3_transaksi_travel_prod_fHotel.extend(window.childForm);
window.app_saku3_transaksi_travel_prod_fHotel.implement({
