window.app_saku3_transaksi_travel_prod_fPembimbingRelasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_travel_prod_fPembimbingRelasi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_travel_prod_fPembimbingRelasi";
...
window.app_saku3_transaksi_travel_prod_fPembimbingRelasi.extend(window.childForm);
window.app_saku3_transaksi_travel_prod_fPembimbingRelasi.implement({	
