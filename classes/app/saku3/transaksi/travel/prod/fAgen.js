window.app_saku3_transaksi_travel_prod_fAgen = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_travel_prod_fAgen.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_travel_prod_fAgen";
		this.itemsValue = new arrayList();
		this.maximize();		
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Data Agen", 0);			
		...
		this.dp_d1 = new portalui_datePicker(this.pc1.childPage[1],{bound:[390,29,98,18]});
		...
		this.cb_marketing = new saiCBBL(this.pc1.childPage[1],{bound:[20,17,280,20],caption:"Marketing", multiSelection:false, maxLength:10, tag:1, rightLabelVisible:true});				
...
window.app_saku3_transaksi_travel_prod_fAgen.extend(window.childForm);
window.app_saku3_transaksi_travel_prod_fAgen.implement({
