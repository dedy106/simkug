window.app_saku3_transaksi_travel_prod_fPesan = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_travel_prod_fPesan.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_travel_prod_fPesan";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Pesan Mobile", 0);	
		...
		this.sg4 = new saiGrid(this.pc2.childPage[0],{bound:[1,5,500,this.pc2.height-33],colCount:2,tag:1,
...
window.app_saku3_transaksi_travel_prod_fPesan.extend(window.childForm);
window.app_saku3_transaksi_travel_prod_fPesan.implement({
