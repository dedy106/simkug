window.app_saku3_transaksi_travel_kug_fKbDago = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_travel_kug_fKbDago.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_travel_kug_fKbDago";
...
window.app_saku3_transaksi_travel_kug_fKbDago.extend(window.childForm);
window.app_saku3_transaksi_travel_kug_fKbDago.implement({
