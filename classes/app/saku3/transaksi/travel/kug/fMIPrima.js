window.app_saku3_transaksi_travel_kug_fMIPrima = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_travel_kug_fMIPrima.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_travel_kug_fMIPrima";
        ...
        this.cb_buat = new saiCBBL(this.pc2.childPage[0],{bound:[20,18,220,20],caption:"NIK Pembuat", multiSelection:false, maxLength:10, tag:1,change:[this,"doChange"]});	
        this.cb_app = new saiCBBL(this.pc2.childPage[0],{bound:[20,19,220,20],caption:"NIK Pemeriksa", multiSelection:false, maxLength:10, tag:1,change:[this,"doChange"]});				

		
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[5,12,990,262], childPage:["Item Jurnal"]});
		...
		try {
            ...
            this.cb_buat.setText("12345");
            this.cb_app.setText("67890");			
...
window.app_saku3_transaksi_travel_kug_fMIPrima.extend(window.childForm);
window.app_saku3_transaksi_travel_kug_fMIPrima.implement({				
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					sql.add("insert into trans_m (no_bukti,kode_lokasi,tgl_input,nik_user,periode,modul,form,posted,prog_seb,progress,kode_pp,tanggal,no_dokumen,keterangan,kode_curr,kurs,nilai1,nilai2,nilai3,nik1,nik2,nik3,no_ref1,no_ref2,no_ref3,param1,param2,param3) values "+
							...
							parseNilai(this.e_debet.getText())+",0,0,'"+this.cb_buat.getText()+"','"+this.cb_app.getText()+"','-','-','-','-','-','-','"+this.c_jenis.getText()+"')");
	...
	doTampilData3: function(page) {
		...
		for (var i=start;i<finish;i++){
			...
			this.sg3.appendData([line.no_bukti,line.tgl,line.no_dokumen,line.keterangan,line.nilai1]); 
		}
