window.app_saku3_transaksi_travel_kug_fUser = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_travel_kug_fUser.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_travel_kug_fUser";
...
window.app_saku3_transaksi_travel_kug_fUser.extend(window.childForm);
window.app_saku3_transaksi_travel_kug_fUser.implement({
