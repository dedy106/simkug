window.app_saku3_transaksi_travel_kug_fParam = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_travel_kug_fParam.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_travel_kug_fParam";
...
window.app_saku3_transaksi_travel_kug_fParam.extend(window.childForm);
window.app_saku3_transaksi_travel_kug_fParam.implement({
