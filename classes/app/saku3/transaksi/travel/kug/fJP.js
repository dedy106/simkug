window.app_saku3_transaksi_travel_kug_fJP = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_travel_kug_fJP.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_travel_kug_fJP";
...
window.app_saku3_transaksi_travel_kug_fJP.extend(window.childForm);
window.app_saku3_transaksi_travel_kug_fJP.implement({	
