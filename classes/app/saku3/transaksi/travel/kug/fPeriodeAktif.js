window.app_saku3_transaksi_travel_kug_fPeriodeAktif = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_travel_kug_fPeriodeAktif.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_travel_kug_fPeriodeAktif";
...
window.app_saku3_transaksi_travel_kug_fPeriodeAktif.extend(window.childForm);
window.app_saku3_transaksi_travel_kug_fPeriodeAktif.implement({
