window.app_saku3_transaksi_travel_kug_fRefKb = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_travel_kug_fRefKb.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_travel_kug_fRefKb";
		...
		this.pc1 = new pageControl(this,{bound:[20,12,1000,430], childPage:["Daftar Template ","Data Template","Filter Data"]});				
		...
		this.e_kode2 = new saiLabelEdit(this.pc1.childPage[2],{bound:[20,14,200,20],caption:"Kode",tag:9});		
...
window.app_saku3_transaksi_travel_kug_fRefKb.extend(window.childForm);
window.app_saku3_transaksi_travel_kug_fRefKb.implement({
	...
	doCari:function(sender){																									
		var filter = "";
		if (this.e_kode2.getText()!="") filter = " and a.kode_ref like '%"+this.e_kode2.getText()+"%' ";	
		if (this.e_ket2.getText()!="") filter = " and a.nama like '%"+this.e_ket2.getText()+"%' ";	
		...
		var strSQL = "select a.kode_ref,a.nama,a.akun_debet,a.akun_kredit,a.jenis,a.kode_pp+' | '+b.nama as pp "+
					 			 ...
					 			 "where a.kode_lokasi='"+this.app._lokasi+"' and a.jenis='"+this.c_jenis.getText()+"' "+filter+" order by a.kode_ref ";		
		var data = this.dbLib.getDataProvider(strSQL,true);		
