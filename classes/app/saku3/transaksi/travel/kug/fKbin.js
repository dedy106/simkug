window.app_saku3_transaksi_travel_kug_fKbin = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_travel_kug_fKbin.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_travel_kug_fKbin";
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[5,12,990,303], childPage:["Item Transaksi"]});
...
window.app_saku3_transaksi_travel_kug_fKbin.extend(window.childForm);
window.app_saku3_transaksi_travel_kug_fKbin.implement({	
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					sql.add("insert into trans_m (no_bukti,kode_lokasi,tgl_input,nik_user,periode,modul,form,posted,prog_seb,progress,kode_pp,tanggal,no_dokumen,keterangan,kode_curr,kurs,nilai1,nilai2,nilai3,nik1,nik2,nik3,no_ref1,no_ref2,no_ref3,param1,param2,param3) values "+
							"('"+this.e_nb.getText()+"','"+this.app._lokasi+"',getdate(),'"+this.app._userLog+"','"+this.e_periode.getText()+"','KB','KBIN','F','-','-','"+this.cb_pp.getText()+"','"+this.dp_d1.getDateString()+"','-','"+this.e_atensi.getText()+"','IDR',1,"+
