window.app_saku3_transaksi_travel_kug_fVendor = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_travel_kug_fVendor.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_travel_kug_fVendor";
		...
		try {
			...
			this.doLoad();	
			this.cb_akun.setSQL("select a.kode_akun, a.nama from masakun a inner join flag_relasi b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi and b.kode_flag = '024' where a.kode_lokasi = '"+this.app._lokasi+"'",["kode_akun","nama"],false,["Kode","Nama"],"and","Data Akun",true);
...
window.app_saku3_transaksi_travel_kug_fVendor.extend(window.childForm);
window.app_saku3_transaksi_travel_kug_fVendor.implement({
