window.app_saku3_transaksi_travel_kug_fPerLock = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_travel_kug_fPerLock.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_travel_kug_fPerLock";
...
window.app_saku3_transaksi_travel_kug_fPerLock.extend(window.childForm);
window.app_saku3_transaksi_travel_kug_fPerLock.implement({
