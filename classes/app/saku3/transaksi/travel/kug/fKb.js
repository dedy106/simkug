window.app_saku3_transaksi_travel_kug_fKb = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_travel_kug_fKb.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_travel_kug_fKb";
...
window.app_saku3_transaksi_travel_kug_fKb.extend(window.childForm);
window.app_saku3_transaksi_travel_kug_fKb.implement({
