window.app_saku3_transaksi_travel_kug_fMasakunRelasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_travel_kug_fMasakunRelasi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_travel_kug_fMasakunRelasi";
		...
		this.pc2 = new pageControl(this.pc1.childPage[1],{bound:[5,12,990,230], childPage:["Flag Akun","Lap Keuangan","Mapping PP"]});		
		...
		this.bPP = new portalui_imageButton(this.sgn4,{bound:[this.sgn4.width - 25,2,22,22],image:"icon/"+system.getThemes()+"/reload.png", hint:"Load PP",click:[this,"doLoadPP"]});
...
window.app_saku3_transaksi_travel_kug_fMasakunRelasi.extend(window.childForm);
window.app_saku3_transaksi_travel_kug_fMasakunRelasi.implement({
