window.app_saku3_transaksi_travel_kug_fMIDago = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_travel_kug_fMIDago.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_travel_kug_fMIDago";
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[5,12,990,302], childPage:["Item Jurnal"]});
...
window.app_saku3_transaksi_travel_kug_fMIDago.extend(window.childForm);
window.app_saku3_transaksi_travel_kug_fMIDago.implement({				
