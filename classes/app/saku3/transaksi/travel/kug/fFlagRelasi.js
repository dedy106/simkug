window.app_saku3_transaksi_travel_kug_fFlagRelasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_travel_kug_fFlagRelasi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_travel_kug_fFlagRelasi";
...
window.app_saku3_transaksi_travel_kug_fFlagRelasi.extend(window.childForm);
window.app_saku3_transaksi_travel_kug_fFlagRelasi.implement({
