window.app_saku3_transaksi_travel_kug_fUbahPwd = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_travel_kug_fUbahPwd.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_travel_kug_fUbahPwd";
...
window.app_saku3_transaksi_travel_kug_fUbahPwd.extend(window.childForm);
window.app_saku3_transaksi_travel_kug_fUbahPwd.implement({
