window.app_saku3_transaksi_travel_barang_fSawal = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_travel_barang_fSawal.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_travel_barang_fSawal";
...
window.app_saku3_transaksi_travel_barang_fSawal.extend(window.portalui_childForm);
window.app_saku3_transaksi_travel_barang_fSawal.implement({
