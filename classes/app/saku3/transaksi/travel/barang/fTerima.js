window.app_saku3_transaksi_travel_barang_fTerima = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_travel_barang_fTerima.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_travel_barang_fTerima";
...
window.app_saku3_transaksi_travel_barang_fTerima.extend(window.portalui_childForm);
window.app_saku3_transaksi_travel_barang_fTerima.implement({	
	...
	doClick:function(sender){
		if (this.e_periode.getText()!= "") {
			...
			this.stsSimpan = 1;
			this.e_nb.setText(this.standarLib.noBuktiOtomatis(this.dbLib,"trans_m","no_bukti","MT/"+this.e_periode.getText().substr(2,4)+"/","0000"));
			this.e_dok.setFocus();
