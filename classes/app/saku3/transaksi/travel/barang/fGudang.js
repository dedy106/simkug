window.app_saku3_transaksi_travel_barang_fGudang = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_travel_barang_fGudang.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_travel_barang_fGudang";
...
window.app_saku3_transaksi_travel_barang_fGudang.extend(window.childForm);
window.app_saku3_transaksi_travel_barang_fGudang.implement({
