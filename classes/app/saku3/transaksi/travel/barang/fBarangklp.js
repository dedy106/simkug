window.app_saku3_transaksi_travel_barang_fBarangklp = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_travel_barang_fBarangklp.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_travel_barang_fBarangklp";
...
window.app_saku3_transaksi_travel_barang_fBarangklp.extend(window.childForm);
window.app_saku3_transaksi_travel_barang_fBarangklp.implement({
