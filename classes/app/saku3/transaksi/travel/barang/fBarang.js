window.app_saku3_transaksi_travel_barang_fBarang = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_travel_barang_fBarang.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_travel_barang_fBarang";
...
window.app_saku3_transaksi_travel_barang_fBarang.extend(window.childForm);
window.app_saku3_transaksi_travel_barang_fBarang.implement({
