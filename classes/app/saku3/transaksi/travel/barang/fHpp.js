window.app_saku3_transaksi_travel_barang_fHpp = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_travel_barang_fHpp.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_travel_barang_fHpp";
...
window.app_saku3_transaksi_travel_barang_fHpp.extend(window.portalui_childForm);
window.app_saku3_transaksi_travel_barang_fHpp.implement({
