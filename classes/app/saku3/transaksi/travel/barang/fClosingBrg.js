window.app_saku3_transaksi_travel_barang_fClosingBrg = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_travel_barang_fClosingBrg.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_travel_barang_fClosingBrg";
		this.itemsValue = new portalui_arrayList();
		this.maximize();	
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Closing Barang Tahunan", 0);	
...
window.app_saku3_transaksi_travel_barang_fClosingBrg.extend(window.portalui_childForm);
window.app_saku3_transaksi_travel_barang_fClosingBrg.implement({
	...
	doClick:function(sender){
		if (this.e_periode.getText()!= "") {
			...
			this.stsSimpan = 1;
			this.e_nb.setText(this.standarLib.noBuktiOtomatis(this.dbLib,"trans_m","no_bukti","CLB/"+this.e_periode.getText().substr(2,4)+"/","0000"));			
			this.e_ket.setFocus();
