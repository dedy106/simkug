window.app_saku3_transaksi_travel_barang_fStok = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_travel_barang_fStok.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_travel_barang_fStok";
...
window.app_saku3_transaksi_travel_barang_fStok.extend(window.portalui_childForm);
window.app_saku3_transaksi_travel_barang_fStok.implement({
