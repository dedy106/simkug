window.app_saku3_transaksi_travel_barang_fBeli = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_travel_barang_fBeli.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_travel_barang_fBeli";
...
window.app_saku3_transaksi_travel_barang_fBeli.extend(window.portalui_childForm);
window.app_saku3_transaksi_travel_barang_fBeli.implement({	
