window.app_saku3_transaksi_travel_aset_fFaEdit = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_travel_aset_fFaEdit.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_travel_aset_fFaEdit";
		...
		try {
			...
			this.cb_fa.setSQL("select no_fa, nama from fa_asset where jenis='A' and kode_lokasi='"+this.app._lokasi+"'",["no_fa","nama"],false,["No Barang","Nama"],"and","Data FA",true);
...
window.app_saku3_transaksi_travel_aset_fFaEdit.extend(window.childForm);
window.app_saku3_transaksi_travel_aset_fFaEdit.implement({
