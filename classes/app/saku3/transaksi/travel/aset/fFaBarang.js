window.app_saku3_transaksi_travel_aset_fFaBarang = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_travel_aset_fFaBarang.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_travel_aset_fFaBarang";
...
window.app_saku3_transaksi_travel_aset_fFaBarang.extend(window.childForm);
window.app_saku3_transaksi_travel_aset_fFaBarang.implement({
