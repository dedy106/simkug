window.app_saku3_transaksi_travel_aset_fFaInput = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_travel_aset_fFaInput.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_travel_aset_fFaInput";
...
window.app_saku3_transaksi_travel_aset_fFaInput.extend(window.childForm);
window.app_saku3_transaksi_travel_aset_fFaInput.implement({
