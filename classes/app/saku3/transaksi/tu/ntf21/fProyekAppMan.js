window.app_saku3_transaksi_tu_ntf21_fProyekAppMan = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tu_ntf21_fProyekAppMan.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tu_ntf21_fProyekAppMan";
...
window.app_saku3_transaksi_tu_ntf21_fProyekAppMan.extend(window.childForm);
window.app_saku3_transaksi_tu_ntf21_fProyekAppMan.implement({	
	...
	doLoad3:function(sender){		
		...
		var strSQL = "select a.kode_proyek,b.nama,a.no_pks,a.nama as keterangan,a.nilai "+
					 ...
					 "where a.versi = 'NTF21' and a.kode_lokasi='"+this.app._lokasi+"' and a.progress='0' order by a.kode_proyek";	
		var data = this.dbLib.getDataProvider(strSQL,true);
		if (typeof data == "object" && data.rs.rows[0] != undefined){
			this.dataJU3 = data;
