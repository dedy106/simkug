window.app_saku3_transaksi_tu_ntf21_fTagihVer = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tu_ntf21_fTagihVer.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tu_ntf21_fTagihVer";
...
window.app_saku3_transaksi_tu_ntf21_fTagihVer.extend(window.childForm);
window.app_saku3_transaksi_tu_ntf21_fTagihVer.implement({	
	...
	doLoad3:function(sender){		
		...
		var strSQL = "select c.no_bill,convert(varchar,c.tanggal,103) as tgl,c.keterangan,a.kode_proyek,b.nama,c.nilai,c.nilai_ppn "+
					 ...
					 "where c.kode_lokasi='"+this.app._lokasi+"' and c.progress in ('0','P') order by c.no_bill";	
