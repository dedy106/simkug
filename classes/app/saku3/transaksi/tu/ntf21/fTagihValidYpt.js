window.app_saku3_transaksi_tu_ntf21_fTagihValidYpt = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tu_ntf21_fTagihValidYpt.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tu_ntf21_fTagihValidYpt";
...
window.app_saku3_transaksi_tu_ntf21_fTagihValidYpt.extend(window.childForm);
window.app_saku3_transaksi_tu_ntf21_fTagihValidYpt.implement({	
