window.app_saku3_transaksi_tu_pajak_fHonDosMulti = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tu_pajak_fHonDosMulti.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tu_pajak_fHonDosMulti";
...
window.app_saku3_transaksi_tu_pajak_fHonDosMulti.extend(window.childForm);
window.app_saku3_transaksi_tu_pajak_fHonDosMulti.implement({	
