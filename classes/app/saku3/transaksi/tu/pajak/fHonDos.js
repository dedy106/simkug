window.app_saku3_transaksi_tu_pajak_fHonDos = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tu_pajak_fHonDos.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tu_pajak_fHonDos";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Pengajuan Beban Honor Dosen", 0);	
...
window.app_saku3_transaksi_tu_pajak_fHonDos.extend(window.childForm);
window.app_saku3_transaksi_tu_pajak_fHonDos.implement({	
	...
	doLoad3:function(sender){																
		var strSQL = "select no_aju, convert(varchar,tanggal,103) as tgl, keterangan, nilai "+
					 "from it_aju_m "+
					 "where kode_pp='"+this.app._kodePP+"' and form = 'HONDOS' and modul='UMUM' and progress in ('A','K','R') and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"'";
