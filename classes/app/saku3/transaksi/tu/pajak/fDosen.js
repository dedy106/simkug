window.app_saku3_transaksi_tu_pajak_fDosen = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tu_pajak_fDosen.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tu_pajak_fDosen";
		...
		this.e_gelar = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,10,200,20],caption:"Gelar", maxLength:50, tag:1});	
...
window.app_saku3_transaksi_tu_pajak_fDosen.extend(window.childForm);
window.app_saku3_transaksi_tu_pajak_fDosen.implement({
		...
		try{						
			if (this.standarLib.checkEmptyByTag(this, [0,1])){
				try{									
					...
					sql.add("insert into it_dosen(kode_dosen,kode_lokasi,nama,gelar,alamat,no_tel,email,npwp,bank,cabang,no_rek,nama_rek,no_ktp) values "+
