window.app_saku3_transaksi_tu_tak_fTakKirim = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tu_tak_fTakKirim.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tu_tak_fTakKirim";
...
window.app_saku3_transaksi_tu_tak_fTakKirim.extend(window.childForm);
window.app_saku3_transaksi_tu_tak_fTakKirim.implement({	
