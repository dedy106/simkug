window.app_saku3_transaksi_tu_tak_fTakKirim2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tu_tak_fTakKirim2.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tu_tak_fTakKirim2";
...
window.app_saku3_transaksi_tu_tak_fTakKirim2.extend(window.childForm);
window.app_saku3_transaksi_tu_tak_fTakKirim2.implement({	
