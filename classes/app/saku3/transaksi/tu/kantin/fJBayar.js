window.app_saku3_transaksi_tu_kantin_fJBayar = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tu_kantin_fJBayar.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tu_kantin_fJBayar";
...
window.app_saku3_transaksi_tu_kantin_fJBayar.extend(window.childForm);
window.app_saku3_transaksi_tu_kantin_fJBayar.implement({
