window.app_saku3_transaksi_tu_pbh_fPegawai = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tu_pbh_fPegawai.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tu_pbh_fPegawai";
...
window.app_saku3_transaksi_tu_pbh_fPegawai.extend(window.childForm);
window.app_saku3_transaksi_tu_pbh_fPegawai.implement({
		...
		try{						
			if (this.standarLib.checkEmptyByTag(this, [0,1])){
				try{									
					...
					sql.add("insert into it_pegawai(nik,kode_lokasi,nama,gelar,alamat,no_tel,email,npwp,bank,cabang,no_rek,nama_rek,no_ktp) values "+
						    "('"+this.cb_kode.getText()+"','"+this.app._lokasi+"','"+this.e_nama.getText()+"','"+this.e_gelar.getText()+"','"+this.e_alamat.getText()+"','"+this.e_tel.getText()+"','"+this.e_mail.getText()+"','"+this.e_npwp.getText()+"','"+this.e_bank.getText()+"','"+this.e_cabang.getText()+"','"+this.e_norek.getText()+"','"+this.e_namarek.getText()+"','"+this.e_ktp.getText()+"')");
					setTipeButton(tbAllFalse);
