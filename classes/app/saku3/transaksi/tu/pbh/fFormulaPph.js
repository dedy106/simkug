window.app_saku3_transaksi_tu_pbh_fFormulaPph = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tu_pbh_fFormulaPph.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tu_pbh_fFormulaPph";
...
window.app_saku3_transaksi_tu_pbh_fFormulaPph.extend(window.childForm);
window.app_saku3_transaksi_tu_pbh_fFormulaPph.implement({
