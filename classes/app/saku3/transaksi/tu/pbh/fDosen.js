window.app_saku3_transaksi_tu_pbh_fDosen = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tu_pbh_fDosen.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tu_pbh_fDosen";
		...
		this.cb_pp = new portalui_saiCBBL(this.pc1.childPage[1],{bound:[20,11,220,20],caption:"Prodi/PP",readOnly:true,tag:2}); 		
...
window.app_saku3_transaksi_tu_pbh_fDosen.extend(window.childForm);
window.app_saku3_transaksi_tu_pbh_fDosen.implement({
