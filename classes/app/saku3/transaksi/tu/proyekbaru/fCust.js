window.app_saku3_transaksi_tu_proyekbaru_fCust = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tu_proyekbaru_fCust.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tu_proyekbaru_fCust";
...
window.app_saku3_transaksi_tu_proyekbaru_fCust.extend(window.childForm);
window.app_saku3_transaksi_tu_proyekbaru_fCust.implement({
		...
		try{						
			if (this.standarLib.checkEmptyByTag(this, [0,1])){
				try{									
					...
					sql.add("insert into prb_cust(kode_cust,kode_lokasi,nama,alamat,no_tel,email,npwp,pic,alamat2,no_fax,kode_pp,wapu,jabatan) values "+
						    "('"+this.cb_kode.getText()+"','"+this.app._lokasi+"','"+this.e_nama.getText()+"','"+this.e_alamat.getText()+"','"+this.e_tel.getText()+"','"+this.e_mail.getText()+"','"+this.e_npwp.getText()+"','"+this.e_pic.getText()+"','"+this.e_alamat2.getText()+"','"+this.e_fax.getText()+"','-','-','"+this.e_jabatan.getText()+"')");
					setTipeButton(tbAllFalse);
