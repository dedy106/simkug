window.app_saku3_transaksi_tu_proyekbaru_fJenisProyek = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tu_proyekbaru_fJenisProyek.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tu_proyekbaru_fJenisProyek";
		...
		//this.c_jenis = new saiCB(this.pc1.childPage[1],{bound:[20,18,200,20],caption:"PPh Psl 4 Ayat 2",items:["PPH42","NON"], readOnly:true,tag:2});
...
window.app_saku3_transaksi_tu_proyekbaru_fJenisProyek.extend(window.childForm);
window.app_saku3_transaksi_tu_proyekbaru_fJenisProyek.implement({
		...
		try{						
			if (this.standarLib.checkEmptyByTag(this, [0,1])){
				try{									
					...
					sql.add("insert into prb_proyek_jenis(kode_jenis,kode_lokasi,nama,akun_bdd,akun_piutang,akun_pdpt,akun_bmhd,akun_pyt,kelompok, akun_beban,   kode_pp,flag_aktif,flag_memo,tahun,kode_drkb,kode_drkp,jenis_pph42) values "+
						    "('"+this.cb_kode.getText()+"','"+this.app._lokasi+"','"+this.e_nama.getText()+"','"+this.cb_bdd.getText()+"','"+this.cb_piu.getText()+"','"+this.cb_pdpt.getText()+"','"+this.cb_bmhd.getText()+"','"+this.cb_pyt.getText()+"','"+this.c_kelompok.getText()+"','"+this.cb_beban.getText()+"' ,'"+this.cb_pp.getText()+"','"+this.c_aktif.getText().substr(0,1)+"','-','"+this.c_tahun.getText()+"','"+this.cb_drkb.getText()+"','"+this.cb_drkp.getText()+"','-')");	//"+this.c_memo.getText().substr(0,1)+"    "+this.c_jenis.getText()+"
					setTipeButton(tbAllFalse);
