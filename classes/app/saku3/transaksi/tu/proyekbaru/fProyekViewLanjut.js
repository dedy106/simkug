window.app_saku3_transaksi_tu_proyekbaru_fProyekViewLanjut = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tu_proyekbaru_fProyekViewLanjut.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tu_proyekbaru_fProyekViewLanjut";
...
window.app_saku3_transaksi_tu_proyekbaru_fProyekViewLanjut.extend(window.childForm);
window.app_saku3_transaksi_tu_proyekbaru_fProyekViewLanjut.implement({	
		...
		try{
			if (sender == this.cb_kode && this.cb_kode.getText() != ""){
				var strSQL = "select a.*,c.jenis_pph42, x.no_rab,	isnull(b.catatan,'-') as catatan,isnull(b.nik_user,'"+this.app._userLog+"') as nik_app "+
							 ...
							 "left  join prb_proyek_app b on a.kode_proyek=b.no_bukti and a.kode_lokasi=b.kode_lokasi and b.no_appseb='-' and b.modul='APP_PR' "+
	...
	doLoad3:function(sender){		
		...
		var strSQL = "select a.kode_proyek,b.nama,a.no_pks,a.nama as keterangan,a.nilai "+
					 ...
					 "where a.versi='PRO20' and a.kode_lokasi='"+this.app._lokasi+"' and a.progress='A' order by a.kode_proyek";	
		var data = this.dbLib.getDataProvider(strSQL,true);
		if (typeof data == "object" && data.rs.rows[0] != undefined){
			this.dataJU3 = data;
