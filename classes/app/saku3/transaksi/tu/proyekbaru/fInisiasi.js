window.app_saku3_transaksi_tu_proyekbaru_fInisiasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tu_proyekbaru_fInisiasi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tu_proyekbaru_fInisiasi";		
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Data Inisiasi Proyek", 0);	
		
		uses("saiCBBL;saiEdit;saiGrid;sgNavigator");
		
		this.pc2 = new pageControl(this,{bound:[10,10,1000,460], childPage:["Data Inisiasi","List Inisiasi"]});		
...
window.app_saku3_transaksi_tu_proyekbaru_fInisiasi.extend(window.childForm);
window.app_saku3_transaksi_tu_proyekbaru_fInisiasi.implement({			
	...
	doLoad3:function(sender){																				
		var strSQL = "select a.kode_proyek,a.nama as keterangan,a.nilai_or as nilai "+
		             "from prb_proyek a where  a.kode_lokasi='"+this.app._lokasi+"' and a.modul = 'INISIASI' and a.versi='PRO20'";		
