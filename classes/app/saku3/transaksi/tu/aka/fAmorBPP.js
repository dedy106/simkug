window.app_saku3_transaksi_tu_aka_fAmorBPP = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tu_aka_fAmorBPP.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tu_aka_fAmorBPP";
...
window.app_saku3_transaksi_tu_aka_fAmorBPP.extend(window.childForm);
window.app_saku3_transaksi_tu_aka_fAmorBPP.implement({
