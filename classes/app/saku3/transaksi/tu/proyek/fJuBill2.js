window.app_saku3_transaksi_tu_proyek_fJuBill2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tu_proyek_fJuBill2.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tu_proyek_fJuBill2";
		...
		this.sg1 = new saiGrid(this.pc1.childPage[0],{bound:[0,5,this.pc1.width-5,this.pc1.height-33],colCount:7,tag:0,
				...
				colWidth:[[6,5,4,3,2,1,0],[100,100,100,80,350,100,100]],
...
window.app_saku3_transaksi_tu_proyek_fJuBill2.extend(window.childForm);
window.app_saku3_transaksi_tu_proyek_fJuBill2.implement({
				...
				try{														
					...
					for (var i=0;i < this.sg1.getRowCount();i++){
						if (this.sg1.rowValid(i) && this.sg1.cells(5,i) != "0"){	
							...
							sql.add("insert into ju_j(no_ju,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,nilai,kode_pp,kode_drk,kode_cust,kode_proyek,kode_task,kode_vendor,kode_lokarea,nik,kode_lokasi,modul,jenis,periode,kode_curr,kurs,nik_user,tgl_input,no_ref,ket_ref) values "+
									"('"+this.e_nb.getText()+"','"+this.sg1.cells(0,i)+"','"+this.dp_d1.getDateString()+"',"+i+",'"+this.sg1.cells(3,i)+"','Pelunasan atas Proyek "+this.sg1.cells(1,i)+"','C',"+nilaiToFloat(this.sg1.cells(5,i))+",'"+this.sg1.cells(6,i)+"','-','-','-','-','-','-','-','"+this.app._lokasi+"','PIUPRO','PIU','"+this.e_periode.getText()+"','IDR',1,'"+this.app._userLog+"',getdate(),'"+this.cb_cust.getText()+"','-')");
						}
					}
