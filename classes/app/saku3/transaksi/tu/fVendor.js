window.app_saku3_transaksi_tu_fVendor = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tu_fVendor.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tu_fVendor";		
...
window.app_saku3_transaksi_tu_fVendor.extend(window.childForm);
window.app_saku3_transaksi_tu_fVendor.implement({
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1])){
				try{									
					...
					sql.add("insert into vendor(kode_vendor,kode_lokasi,nama,alamat,no_tel,email,npwp,pic,alamat2,bank,cabang,no_rek,nama_rek,no_fax,no_pictel,spek,kode_klpvendor,penilaian,bank_trans,jenis, akun_hutang) values "+
						    "('"+this.cb_kode.getText()+"','"+this.app._lokasi+"','"+this.e_nama.getText()+"','"+this.e_alamat.getText()+"','"+this.e_tel.getText()+"','"+this.e_mail.getText()+"','"+this.e_npwp.getText()+"','"+this.e_pic.getText()+"','"+this.e_alamat2.getText()+"','"+this.e_bank.getText()+"','"+this.e_cabang.getText()+"','"+this.e_norek.getText()+"','"+this.e_namarek.getText()+"','"+this.e_fax.getText()+"','"+this.e_pictel.getText()+"','"+this.e_spek.getText()+"','"+this.cb_klp.getText()+"','"+this.e_nilai.getText()+"','"+this.c_btrans.getText()+"','"+this.c_jenis.getText()+"','"+this.cb_akun.getText()+"')"); //,'"+this.c_flag.getText().substr(0,1)+"'
		...
		try{						
			if (this.standarLib.checkEmptyByTag(this, [0,1])){
				try {									
					...
					sql.add("update vendor set nama='"+this.e_nama.getText()+"',alamat='"+this.e_alamat.getText()+"',no_tel='"+this.e_tel.getText()+"',email='"+this.e_mail.getText()+"',npwp='"+this.e_npwp.getText()+"',pic='"+this.e_pic.getText()+"',alamat2='"+this.e_alamat2.getText()+"',bank='"+this.e_bank.getText()+"',cabang='"+this.e_cabang.getText()+"',no_rek='"+this.e_norek.getText()+"',nama_rek='"+this.e_namarek.getText()+"',no_fax='"+this.e_fax.getText()+"',no_pictel='"+this.e_pictel.getText()+"',spek='"+this.e_spek.getText()+"',kode_klpvendor='"+this.cb_klp.getText()+"',penilaian='"+this.e_nilai.getText()+"',bank_trans='"+this.c_btrans.getText()+"',jenis='"+this.c_jenis.getText()+"', akun_hutang='"+this.cb_akun.getText()+"' "+ //,flag='"+this.c_flag.getText().substr(0,1)+"'
