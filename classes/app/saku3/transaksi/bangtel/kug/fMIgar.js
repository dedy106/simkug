window.app_saku3_transaksi_bangtel_kug_fMIgar = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bangtel_kug_fMIgar.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bangtel_kug_fMIgar";
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[5,12,990,325], childPage:["Item Jurnal","Budget"]});
...
window.app_saku3_transaksi_bangtel_kug_fMIgar.extend(window.childForm);
window.app_saku3_transaksi_bangtel_kug_fMIgar.implement({	
	...
	doClick:function(sender){
		if (this.e_periode.getText()!= "" && this.c_jenis.getText()!= "") {
			...
			this.stsSimpan = 1;
			var AddFormat = this.c_jenis.getText()+"/"+this.e_periode.getText().substr(2,4)+"/____%";
			...
			if (typeof data == "object"){
				var line = data.rs.rows[0];							
				if (line != undefined){
					if (line.no_bukti == "0") this.e_nb.setText(this.c_jenis.getText()+"/"+this.e_periode.getText().substr(2,4)+"/0001");
					else {
						...
						this.e_nb.setText(this.c_jenis.getText()+"/"+this.e_periode.getText().substr(2,4)+"/"+nu);						
					}
				} 
			}
			this.e_ket.setFocus();
