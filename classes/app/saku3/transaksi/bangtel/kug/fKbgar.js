window.app_saku3_transaksi_bangtel_kug_fKbgar = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bangtel_kug_fKbgar.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bangtel_kug_fKbgar";
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[5,12,990,280], childPage:["Data Item Jurnal","Budget"]});
...
window.app_saku3_transaksi_bangtel_kug_fKbgar.extend(window.childForm);
window.app_saku3_transaksi_bangtel_kug_fKbgar.implement({
						...
						for (var i=0;i < this.sg2.getRowCount();i++){
							if (this.sg2.rowValid(i)){
								...
								sql.add("insert into angg_r(no_bukti,modul,kode_lokasi,kode_akun,kode_pp,kode_drk,periode1,periode2,dc,saldo,nilai) values "+
										"	('"+this.e_nb.getText()+"','MI','"+this.app._lokasi+"','"+this.sg2.cells(0,i)+"','"+this.sg2.cells(1,i)+"','-','"+this.e_periode.getText()+"','"+this.e_periode.getText()+"','"+DC+"',"+parseNilai(this.sg2.cells(2,i))+","+nilai+")");
							}
						}
					}
