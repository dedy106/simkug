window.app_saku3_transaksi_bangtel_kug_fMI = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bangtel_kug_fMI.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bangtel_kug_fMI";
...
window.app_saku3_transaksi_bangtel_kug_fMI.extend(window.childForm);
window.app_saku3_transaksi_bangtel_kug_fMI.implement({				
