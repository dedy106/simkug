window.app_saku3_transaksi_bangtel_kug_fGarApp2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bangtel_kug_fGarApp2.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bangtel_kug_fGarApp2";
...
window.app_saku3_transaksi_bangtel_kug_fGarApp2.extend(window.childForm);
window.app_saku3_transaksi_bangtel_kug_fGarApp2.implement({
