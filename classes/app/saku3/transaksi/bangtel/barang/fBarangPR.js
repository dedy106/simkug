window.app_saku3_transaksi_bangtel_barang_fBarangPR = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bangtel_barang_fBarangPR.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bangtel_barang_fBarangPR";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Pemakaian Barang Proyek", 0);	
...
window.app_saku3_transaksi_bangtel_barang_fBarangPR.extend(window.childForm);
window.app_saku3_transaksi_bangtel_barang_fBarangPR.implement({	
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					sql.add("insert into spm_proyek_bdd(no_bukti,modul,kode_proyek,nu,keterangan,dc,nilai,kode_lokasi,periode) values "+
							"('"+this.e_nb.getText()+"','BRGPR','"+this.cb_proyek.getText()+"',0,'"+this.e_ket.getText()+"','D',"+nilaiToFloat(this.e_total.getText())+",'"+this.app._lokasi+"','"+this.e_periode.getText()+"')");										
