window.app_saku3_transaksi_bangtel_fVendor = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bangtel_fVendor.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bangtel_fVendor";
...
window.app_saku3_transaksi_bangtel_fVendor.extend(window.childForm);
window.app_saku3_transaksi_bangtel_fVendor.implement({
