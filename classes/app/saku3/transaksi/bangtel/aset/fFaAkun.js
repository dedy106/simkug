window.app_saku3_transaksi_bangtel_aset_fFaAkun = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bangtel_aset_fFaAkun.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bangtel_aset_fFaAkun";
...
window.app_saku3_transaksi_bangtel_aset_fFaAkun.extend(window.childForm);
window.app_saku3_transaksi_bangtel_aset_fFaAkun.implement({
