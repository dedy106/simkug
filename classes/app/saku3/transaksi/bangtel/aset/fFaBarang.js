window.app_saku3_transaksi_bangtel_aset_fFaBarang = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bangtel_aset_fFaBarang.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bangtel_aset_fFaBarang";
		...
		this.pc1 = new pageControl(this,{bound:[20,12,1000,460], childPage:["Daftar Barang","Data Barang","Filter Cari"]});
		this.sg1 = new saiGrid(this.pc1.childPage[0],{bound:[1,5,this.pc1.width-5,this.pc1.height-33],colCount:4,tag:9,
		            colTitle:["Kode","Nama","Klp Akun Barang","Jenis"],
		...
		this.cb_akun = new saiCBBL(this.pc1.childPage[1],{bound:[20,14,220,20],caption:"Klp Akun", multiSelection:false, maxLength:10, tag:2});		
		this.c_jenis = new saiCB(this.pc1.childPage[1],{bound:[20,15,200,20],caption:"Jenis",items:["AKTAP","INVENTORI","NON"], readOnly:true,tag:2});		
...
window.app_saku3_transaksi_bangtel_aset_fFaBarang.extend(window.childForm);
window.app_saku3_transaksi_bangtel_aset_fFaBarang.implement({
			...
			if (sender == this.cb_kode && this.cb_kode.getText() != ""){
				...
				if (typeof data == "object"){
					...
					if (line != undefined){						
						...
						if (line.jenis == "I") this.c_jenis.setText("INVENTORI");
	...
	doCari:function(sender){								
		try {
			...
			var strSQL = "select a.kode_klpfa,a.nama,a.kode_klpakun+' - '+ b.nama as akun,case a.jenis when 'A' then 'AKTAP' when 'I' then 'INVENTORI' else 'NON' end as jenis "+
