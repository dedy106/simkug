window.app_saku3_transaksi_bangtel_fCust = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bangtel_fCust.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bangtel_fCust";
...
window.app_saku3_transaksi_bangtel_fCust.extend(window.childForm);
window.app_saku3_transaksi_bangtel_fCust.implement({
