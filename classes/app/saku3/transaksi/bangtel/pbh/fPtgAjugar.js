window.app_saku3_transaksi_bangtel_pbh_fPtgAjugar = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bangtel_pbh_fPtgAjugar.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bangtel_pbh_fPtgAjugar";
		...
		try {
			...
			sql.add("select a.kode_pp, a.nama from pp a inner join karyawan_pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi and b.nik='"+this.app._userLog+"' where a.kode_lokasi='"+this.app._lokasi+"' and a.tipe='posting' and a.flag_aktif ='1'");
...
window.app_saku3_transaksi_bangtel_pbh_fPtgAjugar.extend(window.childForm);
window.app_saku3_transaksi_bangtel_pbh_fPtgAjugar.implement({
