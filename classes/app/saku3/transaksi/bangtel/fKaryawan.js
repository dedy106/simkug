window.app_saku3_transaksi_bangtel_fKaryawan = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_bangtel_fKaryawan.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_bangtel_fKaryawan";
...
window.app_saku3_transaksi_bangtel_fKaryawan.extend(window.childForm);
window.app_saku3_transaksi_bangtel_fKaryawan.implement({
	doLoadPP : function() {
