window.app_saku3_transaksi_yakes21_gl_fNeraca = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes21_gl_fNeraca.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku3_transaksi_yakes21_gl_fNeraca";
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Setting Neraca", 0);	
		
		this.maximize();
		uses("portalui_saiCBBL;util_standar");
		this.elokasi = new portalui_saiCBBL(this,{bound:[20,25,220,20], caption:"Lokasi", multiSelection:false, 
			sql:["select kode_lokasi, nama from lokasi where kode_lokasi = '00' ", ["kode_lokasi","nama"], false, ["Kode Lokasi", "Nama"], "and", "Daftar Lokasi", true]
		});				
		
		if (this.app._userStatus !="A"){
			this.elokasi.setReadOnly(true);			
		}
		this.eKlp = new portalui_saiCBBL(this,{bound:[20, 11, 220, 20], caption:"Versi Neraca", multiSelection:false, 
			sql:["select kode_fs, nama from fs where kode_lokasi = '00' ", ["kode_fs","nama"], false, ["Kode FS","Nama"],"and","Daftar Versi Laporan",true]
		});					
		this.e0 = new portalui_saiCB(this,{bound:[20,12,200,20], caption:"Tipe Neraca", items:["AKTIVA","PASIVA","LABARUGI","MODAL"]});						
		this.btn = new portalui_imageButton(this,{bound:[225,12,22,22], hint:"Reload", image:"icon/"+system.getThemes()+"/reload.png", click:"doClick"});								
		
		this.addBtn = new portalui_imageButton(this,{bound:[527,12,22,22], hint:"Tambah", image:"icon/"+system.getThemes()+"/createentries.png", click:[this,"entriesClick"]});				
		this.editBtn = new portalui_imageButton(this,{bound:[547,12,22,22], hint:"Edit",image:"icon/"+system.getThemes()+"/editentries.png", click:[this,"entriesClick"]});				
		this.delBtn = new portalui_imageButton(this,{bound:[567,12,22,22], hint:"Hapus",image:"icon/"+system.getThemes()+"/delentries.png", click:[this,"entriesClick"]});		
		this.relBtn = new portalui_imageButton(this,{bound:[587, 12, 22, 22], hint:"Relasi Akun", image:"icon/"+system.getThemes()+"/relakun.png", click:[this,"entriesClick"]});		
		this.downBtn = new portalui_imageButton(this,{bound:[607,12,22,22], hint:"Geser Turun", image:"icon/"+system.getThemes()+"/down.png", click:[this,"entriesClick"]});				
		this.upBtn = new portalui_imageButton(this,{bound:[627,12,22,22], hint:"Geser Naik", image:"icon/"+system.getThemes()+"/up.png", click:[this,"entriesClick"]});		
		this.leftBtn = new portalui_imageButton(this,{bound:[647,12,22,22], hint:"Geser Kiri", image:"icon/"+system.getThemes()+"/bleft.png", click:[this,"entriesClick"]});				
		this.rightBtn = new portalui_imageButton(this,{bound:[667,12,22,22], hint:"Geser Kanan", image:"icon/"+system.getThemes()+"/bright.png", click:[this,"entriesClick"]});								
		this.rootBtn = new portalui_imageButton(this,{bound:[687,12,22,22], hint:"Tidak ada yang pilih", caption:"R",image:"icon/"+system.getThemes()+"/imgSelect.png", click:[this,"entriesClick"]});						
		
		this.treev = new portalui_treeView(this,{bound:[20,14,700,this.getHeight() - 100], dblClick:[this,"treeClick"]});
...
window.app_saku3_transaksi_yakes21_gl_fNeraca.extend(window.portalui_childForm);
window.app_saku3_transaksi_yakes21_gl_fNeraca.implement({
		...
		{ 
			...
			}else
			{
				if (sender == this.addBtn || sender == this.editBtn){
					uses("app_saku3_transaksi_yakes21_gl_fNeracaDetail");
					if (this.entryMenu == undefined)
						this.entryMenu = new app_saku3_transaksi_yakes21_gl_fNeracaDetail(this.app,this.e0.getText());
