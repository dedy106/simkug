window.app_saku3_transaksi_yakes21_gl_fMasakunRelasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes21_gl_fMasakunRelasi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes21_gl_fMasakunRelasi";
		...
		this.sg1 = new saiGrid(this.pc1.childPage[0],{bound:[1,5,this.pc1.width-5,this.pc1.height-35],colCount:6,tag:9,
		            colTitle:["Kode Akun","Nama Akun","Curr","Modul","Jenis","Pilih"],
					colWidth:[[5,4,3,2,1,0],[70,80,80,50,400,100]],
					readOnly:true,
		...
		this.pc2 = new pageControl(this.pc1.childPage[1],{bound:[1,12,995,302], childPage:["Data Umum","Flag Akun","Lap Keuangan"]});		
		this.c_modul = new saiCB(this.pc2.childPage[0],{bound:[20,12,200,20],caption:"Modul",items:["AKTIVA","PASIVA","LABARUGI"], readOnly:true,tag:2});
		this.c_jenis = new saiCB(this.pc2.childPage[0],{bound:[20,13,200,20],caption:"Jenis",items:["Neraca","Pendapatan","Beban"], readOnly:true,tag:2,change:[this,"doChange"]});		
		this.c_normal = new saiCB(this.pc2.childPage[0],{bound:[20,24,200,20],caption:"Normal Account",items:["D. Debet","C. Kredit"], readOnly:true,tag:2});				
		...
		this.sg3 = new saiGrid(this.pc2.childPage[2],{bound:[1,5,this.pc2.width-5,this.pc2.height-35],colCount:4,tag:9,
					...
					autoAppend:true,defaultRow:1});		
		this.sgn3 = new portalui_sgNavigator(this.pc2.childPage[2],{bound:[0,this.pc2.height-25,this.pc2.width-1,25],buttonStyle:2,grid:this.sg3});		
...
window.app_saku3_transaksi_yakes21_gl_fMasakunRelasi.extend(window.childForm);
window.app_saku3_transaksi_yakes21_gl_fMasakunRelasi.implement({
				...
				if (this.cb_kode.getText() != "" ){
					...
					if (typeof data == "object"){
						...
						if (line != undefined){
							...
							var data = this.dbLib.getDataProvider("select distinct b.kode_fs,b.nama as nama_fs,c.kode_neraca,c.nama as nama_lap "+
							           "from relakun a "+
									   ...
									   "where a.kode_akun = '"+this.cb_kode.getText()+"' ",true); //and a.kode_lokasi='"+this.app._lokasi+"'
							if (typeof data == "object" && data.rs.rows[0] != undefined){
								var line;
								this.sg3.clear();
								for (var i in data.rs.rows){
	...
	doTampilData: function(page) {		
		...
		for (var i=start;i<finish;i++){
			...
			this.sg1.appendData([line.kode_akun,line.nama,line.kode_curr,line.modul,line.jenis,"Pilih"]); 
		}
