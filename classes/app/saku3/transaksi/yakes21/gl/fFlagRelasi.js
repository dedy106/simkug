window.app_saku3_transaksi_yakes21_gl_fFlagRelasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes21_gl_fFlagRelasi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes21_gl_fFlagRelasi";
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Data Relasi Flag Akun", 0);	
...
window.app_saku3_transaksi_yakes21_gl_fFlagRelasi.extend(window.childForm);
window.app_saku3_transaksi_yakes21_gl_fFlagRelasi.implement({
