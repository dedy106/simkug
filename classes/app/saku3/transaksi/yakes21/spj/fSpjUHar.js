window.app_saku3_transaksi_yakes21_spj_fSpjUHar = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes21_spj_fSpjUHar.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes21_spj_fSpjUHar";
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Tarif Uang Harian per Band", 0);	
...
window.app_saku3_transaksi_yakes21_spj_fSpjUHar.extend(window.childForm);
window.app_saku3_transaksi_yakes21_spj_fSpjUHar.implement({
