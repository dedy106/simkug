window.app_saku3_transaksi_yakes21_budget_fHoldTW = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes21_budget_fHoldTW.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes21_budget_fHoldTW";
		...
		this.c_jenis = new saiCB(this.pc2.childPage[0],{bound:[20,18,200,20],caption:"Jenis",items:["TW1","TW2","TW3","TW4"], readOnly:true,tag:2,change:[this,"doChange"]});				
		...
		this.sg = new saiGrid(this.pc1.childPage[0],{bound:[1,5,this.pc1.width-5,this.pc1.height-33],colCount:9,tag:0,
		            colTitle:["Kode MTA","Nama MTA","Kode PP","Nama PP","Kode DRK","Nama DRK","TW","Saldo","Nilai Hold"],
...
window.app_saku3_transaksi_yakes21_budget_fHoldTW.extend(window.childForm);
window.app_saku3_transaksi_yakes21_budget_fHoldTW.implement({	
	doHold: function() {
		try {		
			var tahun = this.e_periode.getText().substr(0,4);
			if (this.c_jenis.getText() == "TW1") var bulanTW = "'"+tahun+"01','"+tahun+"02','"+tahun+"03'";
			if (this.c_jenis.getText() == "TW2") var bulanTW = "'"+tahun+"04','"+tahun+"05','"+tahun+"06'";
			if (this.c_jenis.getText() == "TW3") var bulanTW = "'"+tahun+"07','"+tahun+"08','"+tahun+"09'";
			if (this.c_jenis.getText() == "TW4") var bulanTW = "'"+tahun+"10','"+tahun+"11','"+tahun+"12'";

			var strSQL = "select a.kode_akun,a.kode_pp,a.kode_drk,b.nama as nama_akun,c.nama as nama_pp,d.nama as nama_drk, "+
						"sum(case a.dc when 'D' then a.nilai else -a.nilai end) as saldo "+
						"from angg_r a "+
						...
						"where a.kode_lokasi ='"+this.cb_lokasi.getText()+"' and a.periode1 in ("+bulanTW+") "+
						"group by a.kode_akun,a.kode_pp,a.kode_drk,b.nama,c.nama,d.nama ";
	...
	doTampilData: function(page) {
		...
		for (var i=start;i<finish;i++){
			line = this.dataGAR.rs.rows[i];		
			this.sg.appendData([line.kode_akun, line.nama_akun, line.kode_pp, line.nama_pp, line.kode_drk, line.nama_drk, this.c_jenis.getText(), floatToNilai(line.saldo), floatToNilai(line.saldo)]);						
		}
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					if (this.c_jenis.getText() == "TW1") {
						var bulanTW = "'"+tahun+"01','"+tahun+"02','"+tahun+"03'";
						var bulan = tahun+'01';
					}
					if (this.c_jenis.getText() == "TW2") {
						var bulanTW = "'"+tahun+"04','"+tahun+"05','"+tahun+"06'";
						var bulan = tahun+'04';
					}
					if (this.c_jenis.getText() == "TW3") {
						var bulanTW = "'"+tahun+"07','"+tahun+"08','"+tahun+"09'";
						var bulan = tahun+'07';
					}
					if (this.c_jenis.getText() == "TW4") {
						var bulanTW = "'"+tahun+"10','"+tahun+"11','"+tahun+"12'";
						var bulan = tahun+'10';
					}

					sql.add("insert into angg_r (no_bukti, modul, kode_lokasi, kode_akun, kode_pp, kode_drk, periode1, periode2, dc, saldo, nilai) "+
						"select '"+this.e_nb.getText()+"','HOLD',a.kode_lokasi,a.kode_akun,a.kode_pp,a.kode_drk,'"+bulan+"','"+bulan+"','C',  "+
						"sum(case a.dc when 'D' then a.nilai else -a.nilai end) as saldo "+
						"from angg_r a "+
						"where a.kode_lokasi ='"+this.cb_lokasi.getText()+"' and a.periode1 in ("+bulanTW+") "+
						"group by a.kode_akun,a.kode_pp,a.kode_drk,a.kode_lokasi ");

					//tambahan/pengurangan anggaran_d jika saldo rilis ketambahan dari rra rilis
