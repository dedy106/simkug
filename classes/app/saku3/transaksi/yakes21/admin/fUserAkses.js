window.app_saku3_transaksi_yakes21_admin_fUserAkses = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes21_admin_fUserAkses.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes21_admin_fUserAkses";
...
window.app_saku3_transaksi_yakes21_admin_fUserAkses.extend(window.childForm);
window.app_saku3_transaksi_yakes21_admin_fUserAkses.implement({
