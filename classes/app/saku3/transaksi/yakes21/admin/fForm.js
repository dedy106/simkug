...
//* 			SAI, PT											
//***********************************************************************************************
window.app_saku3_transaksi_yakes21_admin_fForm = function(owner){
	if (owner){
		try
		{			
			window.app_saku3_transaksi_yakes21_admin_fForm.prototype.parent.constructor.call(this,owner);
			this.className  = "app_saku3_transaksi_yakes21_admin_fForm";					
...
window.app_saku3_transaksi_yakes21_admin_fForm.extend(window.portalui_childForm);
//------------------------------------------------------------------ event
window.app_saku3_transaksi_yakes21_admin_fForm.implement({
