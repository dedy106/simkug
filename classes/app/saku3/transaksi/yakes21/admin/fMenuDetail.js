...
//* 			SAI, PT											
//***********************************************************************************************
window.app_saku3_transaksi_yakes21_admin_fMenuDetail = function(owner){
	if (owner){
		try{
			window.app_saku3_transaksi_yakes21_admin_fMenuDetail.prototype.parent.constructor.call(this, owner);
			window.app_saku3_transaksi_yakes21_admin_fMenuDetail.prototype.parent.setWidth.call(this, 300);
			window.app_saku3_transaksi_yakes21_admin_fMenuDetail.prototype.parent.setHeight.call(this, 400);		
			this.centerize();
			this.className = "app_saku3_transaksi_yakes21_admin_fMenuDetail";
			this.mouseX = 0;
			this.mouseY = 0;					
...
window.app_saku3_transaksi_yakes21_admin_fMenuDetail.extend(window.portalui_commonForm);
window.app_saku3_transaksi_yakes21_admin_fMenuDetail.implement({
	...
	doSysMouseMove: function(x, y, button, buttonState){
		window.app_saku3_transaksi_yakes21_admin_fMenuDetail.prototype.parent.doSysMouseMove.call(this,x, y, button, buttonState);
		if (this.isClick){
