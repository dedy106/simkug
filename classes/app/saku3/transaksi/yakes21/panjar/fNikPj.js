window.app_saku3_transaksi_yakes21_panjar_fNikPj = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes21_panjar_fNikPj.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes21_panjar_fNikPj";
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Daftar Pemegang Panjar", 0);	
		...
		this.pc1 = new pageControl(this,{bound:[20,12,1000,400], childPage:["Daftar Pemegang","NIK Panjar"]});				
...
window.app_saku3_transaksi_yakes21_panjar_fNikPj.extend(window.childForm);
window.app_saku3_transaksi_yakes21_panjar_fNikPj.implement({
	...
	doLoad:function(sender){	
		if (this.cb_lokasi.getText()!="") {							
			var strSQL = "select a.nik,a.nama "+
						 "from karyawan a inner join panjar2_nik c on a.nik=c.nik and a.flag_aktif ='1' "+
