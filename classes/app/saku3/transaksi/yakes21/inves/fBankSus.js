window.app_saku3_transaksi_yakes21_inves_fBankSus = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes21_inves_fBankSus.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes21_inves_fBankSus";
		...
		this.pc2 = new pageControl(this,{bound:[10,10,1000,450], childPage:["Data Suspend","Aktif Suspend"]});		
		this.sg3 = new saiGrid(this.pc2.childPage[1],{bound:[1,5,this.pc2.width-5,this.pc2.height-33],colCount:7,tag:9,
		            colTitle:["No Bukti","Tanggal","Tgl Berakhir","Deskripsi","Mitra","Status","Pilih"],
					colWidth:[[6,5,4,3,2,1,0],[70,80,200,300,80,80,100]],
					readOnly:true,
...
window.app_saku3_transaksi_yakes21_inves_fBankSus.extend(window.childForm);
window.app_saku3_transaksi_yakes21_inves_fBankSus.implement({		
	...
	doTampilData3: function(page) {
		...
		for (var i=start;i<finish;i++){
			...
			this.sg3.appendData([line.no_suspen,line.tgl_awal,line.tgl_akhir,line.keterangan,line.mitra,line.status,"Pilih"]); 
		}
