window.app_saku3_transaksi_yakes21_inves_fGlobalIndex = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes21_inves_fGlobalIndex.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes21_inves_fGlobalIndex";
...
window.app_saku3_transaksi_yakes21_inves_fGlobalIndex.extend(window.childForm);
window.app_saku3_transaksi_yakes21_inves_fGlobalIndex.implement({
