window.app_saku3_transaksi_yakes21_inves_fRDMI = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes21_inves_fRDMI.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes21_inves_fRDMI";
...
window.app_saku3_transaksi_yakes21_inves_fRDMI.extend(window.childForm);
window.app_saku3_transaksi_yakes21_inves_fRDMI.implement({
