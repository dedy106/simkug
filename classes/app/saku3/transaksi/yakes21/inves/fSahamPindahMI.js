window.app_saku3_transaksi_yakes21_inves_fSahamPindahMI = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes21_inves_fSahamPindahMI.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes21_inves_fSahamPindahMI";
...
window.app_saku3_transaksi_yakes21_inves_fSahamPindahMI.extend(window.childForm);
window.app_saku3_transaksi_yakes21_inves_fSahamPindahMI.implement({
