window.app_saku3_transaksi_yakes21_inves_fSPDev = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes21_inves_fSPDev.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes21_inves_fSPDev";
...
window.app_saku3_transaksi_yakes21_inves_fSPDev.extend(window.childForm);
window.app_saku3_transaksi_yakes21_inves_fSPDev.implement({
