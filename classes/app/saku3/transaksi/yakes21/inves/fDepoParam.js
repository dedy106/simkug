window.app_saku3_transaksi_yakes21_inves_fDepoParam = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes21_inves_fDepoParam.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes21_inves_fDepoParam";
...
window.app_saku3_transaksi_yakes21_inves_fDepoParam.extend(window.childForm);
window.app_saku3_transaksi_yakes21_inves_fDepoParam.implement({
