window.app_saku3_transaksi_yakes21_inves_fKustodi = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes21_inves_fKustodi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes21_inves_fKustodi";
...
window.app_saku3_transaksi_yakes21_inves_fKustodi.extend(window.childForm);
window.app_saku3_transaksi_yakes21_inves_fKustodi.implement({
