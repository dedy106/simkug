window.app_saku3_transaksi_yakes21_inves_fSPDevApp = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes21_inves_fSPDevApp.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes21_inves_fSPDevApp";
...
window.app_saku3_transaksi_yakes21_inves_fSPDevApp.extend(window.childForm);
window.app_saku3_transaksi_yakes21_inves_fSPDevApp.implement({
	isiCBAkru: function() {
