window.app_saku3_transaksi_yakes21_inves_fRDJenis = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes21_inves_fRDJenis.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes21_inves_fRDJenis";
...
window.app_saku3_transaksi_yakes21_inves_fRDJenis.extend(window.childForm);
window.app_saku3_transaksi_yakes21_inves_fRDJenis.implement({
