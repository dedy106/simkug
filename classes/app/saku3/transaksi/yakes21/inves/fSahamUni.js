window.app_saku3_transaksi_yakes21_inves_fSahamUni = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes21_inves_fSahamUni.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku3_transaksi_yakes21_inves_fSahamUni";
...
window.app_saku3_transaksi_yakes21_inves_fSahamUni.extend(window.portalui_childForm);
window.app_saku3_transaksi_yakes21_inves_fSahamUni.implement({	
