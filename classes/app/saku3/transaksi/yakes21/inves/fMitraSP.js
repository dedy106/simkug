window.app_saku3_transaksi_yakes21_inves_fMitraSP = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes21_inves_fMitraSP.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes21_inves_fMitraSP";
...
window.app_saku3_transaksi_yakes21_inves_fMitraSP.extend(window.childForm);
window.app_saku3_transaksi_yakes21_inves_fMitraSP.implement({
