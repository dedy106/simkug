window.app_saku3_transaksi_yakes21_inves_fSahamSplit = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes21_inves_fSahamSplit.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes21_inves_fSahamSplit";
...
window.app_saku3_transaksi_yakes21_inves_fSahamSplit.extend(window.childForm);
window.app_saku3_transaksi_yakes21_inves_fSahamSplit.implement({
