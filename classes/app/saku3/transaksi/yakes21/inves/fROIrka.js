window.app_saku3_transaksi_yakes21_inves_fROIrka = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes21_inves_fROIrka.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes21_inves_fROIrka";
...
window.app_saku3_transaksi_yakes21_inves_fROIrka.extend(window.childForm);
window.app_saku3_transaksi_yakes21_inves_fROIrka.implement({
