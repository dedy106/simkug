window.app_saku3_transaksi_yakes21_inves_fDepoRekon = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes21_inves_fDepoRekon.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes21_inves_fDepoRekon";
...
window.app_saku3_transaksi_yakes21_inves_fDepoRekon.extend(window.childForm);
window.app_saku3_transaksi_yakes21_inves_fDepoRekon.implement({
	getData: function() {
		this.sg.clear();
		var strSQL = "select "+
