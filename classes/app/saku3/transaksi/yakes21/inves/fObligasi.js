window.app_saku3_transaksi_yakes21_inves_fObligasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes21_inves_fObligasi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes21_inves_fObligasi";
...
window.app_saku3_transaksi_yakes21_inves_fObligasi.extend(window.childForm);
window.app_saku3_transaksi_yakes21_inves_fObligasi.implement({			
