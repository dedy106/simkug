window.app_saku3_transaksi_yakes21_inves_fAktuaria = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes21_inves_fAktuaria.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes21_inves_fAktuaria";
...
window.app_saku3_transaksi_yakes21_inves_fAktuaria.extend(window.childForm);
window.app_saku3_transaksi_yakes21_inves_fAktuaria.implement({
