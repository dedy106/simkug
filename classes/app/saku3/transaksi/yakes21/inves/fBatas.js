window.app_saku3_transaksi_yakes21_inves_fBatas = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes21_inves_fBatas.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes21_inves_fBatas";
...
window.app_saku3_transaksi_yakes21_inves_fBatas.extend(window.childForm);
window.app_saku3_transaksi_yakes21_inves_fBatas.implement({
	doCopy: function() {
