window.app_saku3_transaksi_yakes21_inves_fBMarkID = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes21_inves_fBMarkID.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes21_inves_fBMarkID";
...
window.app_saku3_transaksi_yakes21_inves_fBMarkID.extend(window.childForm);
window.app_saku3_transaksi_yakes21_inves_fBMarkID.implement({	
