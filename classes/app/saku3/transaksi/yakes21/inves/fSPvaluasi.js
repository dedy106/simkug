window.app_saku3_transaksi_yakes21_inves_fSPvaluasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes21_inves_fSPvaluasi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes21_inves_fSPvaluasi";
...
window.app_saku3_transaksi_yakes21_inves_fSPvaluasi.extend(window.childForm);
window.app_saku3_transaksi_yakes21_inves_fSPvaluasi.implement({	
