window.app_saku3_transaksi_yakes21_inves_fBank = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes21_inves_fBank.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes21_inves_fBank";
...
window.app_saku3_transaksi_yakes21_inves_fBank.extend(window.childForm);
window.app_saku3_transaksi_yakes21_inves_fBank.implement({
