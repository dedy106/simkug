window.app_saku3_transaksi_yakes21_inves_fSahamDevApp = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes21_inves_fSahamDevApp.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes21_inves_fSahamDevApp";
...
window.app_saku3_transaksi_yakes21_inves_fSahamDevApp.extend(window.childForm);
window.app_saku3_transaksi_yakes21_inves_fSahamDevApp.implement({
	isiCBAkru: function() {
