window.app_saku3_transaksi_yakes21_inves_fRDDevApp = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes21_inves_fRDDevApp.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes21_inves_fRDDevApp";
...
window.app_saku3_transaksi_yakes21_inves_fRDDevApp.extend(window.childForm);
window.app_saku3_transaksi_yakes21_inves_fRDDevApp.implement({
	isiCBAkru: function() {
