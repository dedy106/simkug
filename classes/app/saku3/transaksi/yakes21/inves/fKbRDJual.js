window.app_saku3_transaksi_yakes21_inves_fKbRDJual = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes21_inves_fKbRDJual.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes21_inves_fKbRDJual";
...
window.app_saku3_transaksi_yakes21_inves_fKbRDJual.extend(window.childForm);
window.app_saku3_transaksi_yakes21_inves_fKbRDJual.implement({
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					sql.add("insert into kas_m (no_kas,kode_lokasi,no_dokumen,no_bg,akun_kb,tanggal,keterangan,kode_pp,modul,jenis,periode,kode_curr,kurs,nilai,nik_buat,nik_app,tgl_input,nik_user,posted,no_del,no_link,ref1,kode_bank) values  "+
							"('"+this.e_nb.getText()+"','"+this.app._lokasi+"','"+this.e_dok.getText()+"','-','"+this.cb_akun.getText()+"','"+this.dp_d1.getDateString()+"','"+this.e_ket.getText()+"','"+this.app._kodePP+"','KBRDJUAL','"+this.c_jenis.getText()+"','"+this.e_periode.getText()+"','IDR',1,"+parseNilai(this.e_nilai.getText())+",'"+this.app._userLog+"','-',getdate(),'"+this.app._userLog+"','F','-','-','"+this.cb_plan.getText()+"','0')");
