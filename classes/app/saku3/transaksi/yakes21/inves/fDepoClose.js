window.app_saku3_transaksi_yakes21_inves_fDepoClose = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes21_inves_fDepoClose.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes21_inves_fDepoClose";
...
window.app_saku3_transaksi_yakes21_inves_fDepoClose.extend(window.childForm);
window.app_saku3_transaksi_yakes21_inves_fDepoClose.implement({	
