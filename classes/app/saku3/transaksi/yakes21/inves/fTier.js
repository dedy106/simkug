window.app_saku3_transaksi_yakes21_inves_fTier = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes21_inves_fTier.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes21_inves_fTier";
...
window.app_saku3_transaksi_yakes21_inves_fTier.extend(window.childForm);
window.app_saku3_transaksi_yakes21_inves_fTier.implement({
