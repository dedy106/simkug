window.app_saku3_transaksi_yakes21_inves_fRD = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes21_inves_fRD.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes21_inves_fRD";
...
window.app_saku3_transaksi_yakes21_inves_fRD.extend(window.childForm);
window.app_saku3_transaksi_yakes21_inves_fRD.implement({
