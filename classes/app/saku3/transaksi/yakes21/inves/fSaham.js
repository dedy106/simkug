window.app_saku3_transaksi_yakes21_inves_fSaham = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes21_inves_fSaham.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes21_inves_fSaham";
...
window.app_saku3_transaksi_yakes21_inves_fSaham.extend(window.childForm);
window.app_saku3_transaksi_yakes21_inves_fSaham.implement({
