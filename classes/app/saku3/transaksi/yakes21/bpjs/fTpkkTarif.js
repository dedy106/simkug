window.app_saku3_transaksi_yakes21_bpjs_fTpkkTarif = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_yakes21_bpjs_fTpkkTarif.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_yakes21_bpjs_fTpkkTarif";
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Tarif TPKK", 0);	
		...
		this.pc1 = new pageControl(this,{bound:[20,12,1000,410], childPage:["Daftar TPKK","Data TPKK","Copy Data"]});				
		this.sg1 = new saiGrid(this.pc1.childPage[0],{bound:[1,5,this.pc1.width-5,this.pc1.height-35],colCount:4,tag:9,
		            colTitle:["Kode","Nama","Tarif","Pilih"],
...
window.app_saku3_transaksi_yakes21_bpjs_fTpkkTarif.extend(window.childForm);
window.app_saku3_transaksi_yakes21_bpjs_fTpkkTarif.implement({
	...
	doTampilData: function(page) {
		...
		for (var i=start;i<finish;i++){
			...
			this.sg1.appendData([line.kode_tpkk,line.nama,floatToNilai(line.tarif),"Pilih"]); 
		}
