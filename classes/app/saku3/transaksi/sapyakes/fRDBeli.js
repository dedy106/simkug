window.app_saku3_transaksi_sapyakes_fRDBeli = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_sapyakes_fRDBeli.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_sapyakes_fRDBeli";
		...
		this.cb_app = new saiCBBL(this.pc2.childPage[0],{bound:[20,11,220,20],caption:"NIK Post SAP", multiSelection:false, maxLength:10, tag:2,visible:false});								
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[1,22,995,305], childPage:["Data Reksadana","Rekap Data"]});			
		...
		this.sg2 = new saiGrid(this.pc1.childPage[1],{bound:[1,5,this.pc1.width-5,195],colCount:3,tag:9,
...
window.app_saku3_transaksi_sapyakes_fRDBeli.extend(window.childForm);
window.app_saku3_transaksi_sapyakes_fRDBeli.implement({
		...
		try{						
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					sql.add("insert into inv_rdbeli_m(no_rdbeli,kode_lokasi,periode,tanggal,nik_user,tgl_input,posted,no_kas,progress,nik_buat,  no_dokumen,keterangan,kode_drk,kode_rdkelola,tgl_set,nilai_komisi,nilai_ppn,nilai_levy,nilai_pph,no_app1,no_spb,kode_pp,modul,nilai, nik_app) values "+
						    "('"+this.e_nb.getText()+"','"+this.app._lokasi+"','"+this.e_periode.getText()+"','"+this.dp_d1.getDateString()+"','"+this.app._userLog+"',getdate(),'F','-','0','"+this.app._userLog+"',  '-','"+this.e_ket.getText()+"','"+this.cb_drk.getText()+"','"+this.cb_kelola.getText()+"','"+this.dp_d2.getDateString()+"',"+nilaiToFloat(this.e_komisi.getText())+","+nilaiToFloat(this.e_ppn.getText())+","+nilaiToFloat(this.e_levy.getText())+","+nilaiToFloat(this.e_pph.getText())+",'-','-','"+this.kodepp+"','RDBELI',"+nilaiToFloat(this.e_neto.getText())+",'"+this.cb_app.getText()+"')");
