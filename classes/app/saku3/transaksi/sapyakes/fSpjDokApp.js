window.app_saku3_transaksi_sapyakes_fSpjDokApp = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_sapyakes_fSpjDokApp.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_sapyakes_fSpjDokApp";
...
window.app_saku3_transaksi_sapyakes_fSpjDokApp.extend(window.childForm);
window.app_saku3_transaksi_sapyakes_fSpjDokApp.implement({		
