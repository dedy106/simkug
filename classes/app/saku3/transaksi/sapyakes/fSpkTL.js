window.app_saku3_transaksi_sapyakes_fSpkTL = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_sapyakes_fSpkTL.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_sapyakes_fSpkTL";
...
window.app_saku3_transaksi_sapyakes_fSpkTL.extend(window.childForm);
window.app_saku3_transaksi_sapyakes_fSpkTL.implement({	
