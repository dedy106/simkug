window.app_saku3_transaksi_sapyakes_fAppBudget = function(owner)
{
	...
	{		
		...
		this.c_modul3 = new saiCB(this,{bound:[20,10,200,20],caption:"Modul",items:["IFAJU","DAKEM","DAKEMADM","SPPD","PH","RES","RPH","TPIU","DEPO","SHM","RD","SP"], tag:9,change:[this,"doChange"]});//log
		...
		this.c_status = new saiCB(this.pc1.childPage[1],{bound:[20,11,200,20],caption:"Status",items:["APPROVE"], readOnly:true,tag:0});//,"RETURN"
		...
		this.c_modul2 = new saiCB(this.pc1.childPage[2],{bound:[20,11,200,20],caption:"Modul",items:["IFAJU","DAKEM","DAKEMADM","SPPD","PH","RES","RPH","TPIU","IDEPO","BDEPO","CBDEP","KBDEP","TTPDEPO","KBDEPTP","BSHM","DSHM","KBDSHM","KBJSHM","SPISHM",     "BRD","JRD","KBJRD","DRD","KBDRD"], readOnly:true,tag:9,change:[this,"doChange"]});
...
window.app_saku3_transaksi_sapyakes_fAppBudget.implement({	
	doLoad:function(sender){			
		...
		if (this.c_modul3.getText() == "SPPD")	{
			var strSQL = "select a.tanggal as due_date,a.no_spj as no_bukti,'INPROG' as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.tanggal,103) as tgl2,'SPPD' as modul,b.kode_pp+' - '+b.nama as pp,z.no_doksap as no_dokumen,a.keterangan,a.transport+harian as nilai,c.nik+' - '+c.nama as pembuat,a.no_appsap as no_app,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
						 ...
						 "where a.periode<='"+this.e_periode.getText()+"' and a.progress='A' and a.kode_lokasi='"+this.app._lokasi+"' and a.nik_appsap='"+this.app._userLog+"' ";							 
		}		
		...
		if (this.c_modul3.getText() == "TPIU")	{
			var strSQL = "select a.tanggal as due_date,a.no_terima as no_bukti,'INPROG' as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.tanggal,103) as tgl2,'TPIU' as modul,b.kode_pp+' - '+b.nama as pp,z.no_doksap as no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_app,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
						 ...
						 "                inner join karyawan c on a.nik_buat=c.nik and a.kode_lokasi=c.kode_lokasi "+
						 "                inner join (select distinct no_dokumen as no_bukti,kode_lokasi,no_doksap from glsap where kode_lokasi='"+this.app._lokasi+"' and periode<='"+this.e_periode.getText()+"') z on a.no_terima=z.no_bukti and a.kode_lokasi=z.kode_lokasi "+	//muncul glsap nya detail ,,, tidak boleh koreksi					
						 "where a.periode<='"+this.e_periode.getText()+"' and a.progress='0' and a.kode_lokasi='"+this.app._lokasi+"' and a.nik_setuju='"+this.app._userLog+"' ";							 
		}
		...
		/*
		if (this.c_modul3.getText() == "LOG")	{
			var strSQL = "select a.tanggal as due_date,a.no_pesan as no_bukti,'INPROG' as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.tanggal,103) as tgl2,'PR' as modul,b.kode_pp+' - '+b.nama as pp,'-' as no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_app,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
		...
		try{														
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					//---------------- flag bukti					
					if (this.e_modul.getText() == "IFAJU") sql.add("update if_aju_m set no_app='"+this.e_nb.getText()+"',progress='"+vStatus+"',posted='"+vPosted+"' where no_aju='"+this.e_nobukti.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");
					...
					if (this.e_modul.getText() == "SPPD") sql.add("update yk_spj_m set no_appsap='"+this.e_nb.getText()+"',progress='"+vStatus+"',posted='"+vPosted+"' where no_spj='"+this.e_nobukti.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");			
	...
	doModalResult: function(event, modalResult){
		...
		switch (event){
			...
			case "ubah" :								
				this.preView = "1";	
				/*			
				if (nilaiToFloat(this.e_nilai.getText()) <= 0 && this.e_modul.getText() != "TTPDEPO") {				
			...
			case "hapus" :	
				...
				if (this.e_modul.getText() == "IFAJU") sql.add("update if_aju_m set no_app='-',progress='0',posted='F' where no_aju='"+this.e_nobukti.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");
				...
				if (this.e_modul.getText() == "SPPD") sql.add("update yk_spj_m set no_appsap='-',progress='A',posted='F' where no_spj='"+this.e_nobukti.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");			
	...
	doChange:function(sender){	
		...
		if (sender == this.c_modul2) {
			...
			if (this.c_modul2.getText() == "DAKEMADM") {
				this.cb_nb.setSQL("select distinct a.no_aju, a.keterangan from yk_dakem_m a inner join glsap b on a.no_aju=b.no_bukti and b.no_doksap='-' "+
								  "where a.nik_app='"+this.app._userLog+"' and a.periode='"+this.e_periode.getText()+"' "+
								  "and a.progress in ('1','C') and a.kode_lokasi='"+this.app._lokasi+"'",
			...
			//if (this.c_modul2.getText() == "PR") this.cb_nb.setSQL("select no_pesan, keterangan from log_pesan_m where nik_app='"+this.app._userLog+"' and kode_pp='"+this.app._kodePP+"' and periode<='"+this.e_periode.getText()+"' and progress in ('1','C') and kode_lokasi='"+this.app._lokasi+"'",["no_pesan","keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);		
		}
		...
		if (this.cb_nb && this.cb_nb.getText() != "") {
			...
			if (this.c_modul2.getText() == "IDEPO") {
				var strSQL = "select a.tanggal as due_date,a.no_depo as no_bukti,case a.progress when '1' then 'APPROVE' else 'RETURN' end as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.tanggal,103) as tgl2,'IDEPO' as modul,b.kode_pp+' - '+b.nama as pp,z.no_doksap as no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,d.no_app,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
							 ...
							 "                inner join karyawan c on a.nik_buat=c.nik and a.kode_lokasi=c.kode_lokasi "+
							 "                inner join (select distinct no_bukti as no_bukti,kode_lokasi,no_doksap from glsap where kode_lokasi='"+this.app._lokasi+"' and periode<='"+this.e_periode.getText()+"') z on a.no_depo=z.no_bukti and a.kode_lokasi=z.kode_lokasi "+							
							 "where a.no_depo='"+this.cb_nb.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' and d.nik_sap='"+this.app._userLog+"' ";							 
				var data = this.dbLib.getDataProvider(strSQL,true);
				if (typeof data == "object" && data.rs.rows[0] != undefined){
					this.dataJU = data;
					this.sgn.setTotalPage(Math.ceil(data.rs.rows.length/20));
			...
			/*
			if (this.c_modul2.getText() == "PR") {
				var strSQL = "select a.tanggal as due_date,a.no_pesan as no_bukti,case a.progress when '1' then 'APPROVE' else 'RETURN' end as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.tanggal,103) as tgl2,'PR' as modul,b.kode_pp+' - '+b.nama as pp,'-' as no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,d.no_app,a.kode_lokasi,convert(varchar,a.tgl_input,120) as tglinput,b.kode_pp "+
							 "from log_pesan_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
							 "                inner join karyawan c on a.nik_buat=c.nik and a.kode_lokasi=c.kode_lokasi "+							 
							 "where a.no_pesan='"+this.cb_nb.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' and a.nik_app='"+this.app._userLog+"' ";							 
				var data = this.dbLib.getDataProvider(strSQL,true);
				if (typeof data == "object" && data.rs.rows[0] != undefined){
					this.dataJU = data;
					this.sgn.setTotalPage(Math.ceil(data.rs.rows.length/20));
	...
	doLoadUsulGLSAP:function(row){
		var strSQL1 = "select a.kode_akun,isnull(b.nama,'-') as nama_akun,a.kode_pp,isnull(c.nama,'-') as nama_pp,a.kode_drk,isnull(d.nama,'-') as nama_drk,a.dc,a.keterangan,a.nilai "+
					  ...
					  "where a.no_bukti like '"+this.e_nobukti.getText()+"%' and a.kode_lokasi='"+this.app._lokasi+"' order by a.dc desc";
	...
	doLoadUsulJML:function(row){
		if (this.sg.cells(0,row) == "IFAJU") {
			var strSQL1 = "select a.kode_akun,b.nama as nama_akun,a.kode_pp,c.nama as nama_pp,a.kode_drk,d.nama as nama_drk,a.dc,a.keterangan,a.nilai "+
						  "from if_aju_j a inner join masakun b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi "+
						  "				   inner join pp c on a.kode_pp=c.kode_pp and a.kode_lokasi=c.kode_lokasi "+
						  "                left join drk d on a.kode_drk=d.kode_drk and a.kode_lokasi=d.kode_lokasi and substring(a.periode,1,4)=d.tahun "+
						  "where a.no_aju = '"+this.e_nobukti.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' order by a.dc desc";
		}
		if (this.sg.cells(0,row) == "DAKEM")	{
			var strSQL1 = "select a.kode_akun,b.nama as nama_akun,a.kode_pp,c.nama as nama_pp,'-' as kode_drk,'-' as nama_drk,a.dc,a.keterangan,a.nilai "+
						  "from yk_dakem_j a inner join masakun b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi "+
						  "				     inner join pp c on a.kode_pp=c.kode_pp and a.kode_lokasi=c.kode_lokasi "+						  
						  "where a.no_dakem = '"+this.e_nobukti.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' order by a.dc desc";
		}
		if (this.sg.cells(0,row) == "DAKEMADM") {
			var strSQL1 = "select a.kode_akun,b.nama as nama_akun,a.kode_pp,c.nama as nama_pp,a.kode_drk,d.nama as nama_drk,a.dc,a.keterangan,a.nilai "+
						  "from yk_dakemadm_j a inner join masakun b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi "+
						  "				   inner join pp c on a.kode_pp=c.kode_pp and a.kode_lokasi=c.kode_lokasi "+
						  "                left join drk d on a.kode_drk=d.kode_drk and a.kode_lokasi=d.kode_lokasi and substring(a.periode,1,4)=d.tahun "+
						  "where a.no_aju = '"+this.e_nobukti.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' order by a.dc desc";
		}
		if (this.sg.cells(0,row) == "SPPD")	{
			var strSQL1 = "select a.kode_akun,b.nama as nama_akun,a.kode_pp,c.nama as nama_pp,'-' as kode_drk,'-' as nama_drk,a.dc,a.keterangan,a.nilai "+
						  "from yk_spj_j a inner join masakun b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi "+
						  "				     inner join pp c on a.kode_pp=c.kode_pp and a.kode_lokasi=c.kode_lokasi "+						  
						  "where a.no_spj = '"+this.e_nobukti.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' order by a.dc desc";
		}
		if (this.sg.cells(0,row) == "PH")	{
			var strSQL1 = "select a.kode_akun,b.nama as nama_akun,a.kode_pp,c.nama as nama_pp,'-' as kode_drk,'-' as nama_drk,a.dc,a.keterangan,a.nilai "+
						  ...
						  "				      inner join pp c on a.kode_pp=c.kode_pp and a.kode_lokasi=c.kode_lokasi "+						  
						  "where a.no_hutang = '"+this.e_nobukti.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' order by a.dc desc";
		}
		if (this.sg.cells(0,row) == "RES")	{
			var strSQL1 = "select a.kode_akun,b.nama as nama_akun,a.kode_pp,c.nama as nama_pp,'-' as kode_drk,'-' as nama_drk,a.dc,a.keterangan,a.nilai "+
						  ...
						  "				      inner join pp c on a.kode_pp=c.kode_pp and a.kode_lokasi=c.kode_lokasi "+						  
						  "where a.no_reim = '"+this.e_nobukti.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' order by a.dc desc";
		}
		if (this.sg.cells(0,row) == "RPH")	{
			var strSQL1 = "select a.kode_akun,b.nama as nama_akun,a.kode_pp,c.nama as nama_pp,'-' as kode_drk,'-' as nama_drk,a.dc,a.keterangan,a.nilai "+
						  ...
						  "				     inner join pp c on a.kode_pp=c.kode_pp and a.kode_lokasi=c.kode_lokasi "+						  
						  "where a.no_rekon = '"+this.e_nobukti.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' order by a.dc desc";
		}
		
		
		if (this.sg.cells(0,row) == "TPIU")	{
			var strSQL1 = "select a.kode_akun,b.nama as nama_akun,a.kode_pp,c.nama as nama_pp,'-' as kode_drk,'-' as nama_drk,a.dc,a.keterangan,a.nilai "+
						  "from takterima_j a inner join masakun b on a.kode_akun=b.kode_akun and b.kode_lokasi='99' "+
						  "				      inner join pp c on a.kode_pp=c.kode_pp and c.kode_lokasi<>'00' "+						  
						  "where a.no_terima = '"+this.e_nobukti.getText()+"'  order by a.dc desc";
		}
		if (this.sg.cells(0,row) == "IDEPO")	{
			var strSQL1 = "select a.kode_akun,b.nama as nama_akun,a.kode_pp,c.nama as nama_pp,'-' as kode_drk,'-' as nama_drk,a.dc,a.keterangan,a.nilai "+
						  "from glsap a inner join masakun b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi "+
						  "				      inner join pp c on a.kode_pp=c.kode_pp and a.kode_lokasi=c.kode_lokasi "+						  
		...
		if (this.sg.cells(0,row) == "CBDEP")	{
			var strSQL1 = "select a.kode_akun,b.nama as nama_akun,a.kode_pp,c.nama as nama_pp,'-' as kode_drk,'-' as nama_drk,a.dc,a.keterangan,a.nilai "+
						  ...
						  "				      inner join pp c on a.kode_pp=c.kode_pp and a.kode_lokasi=c.kode_lokasi "+						  
						  "where a.no_cair = '"+this.e_nobukti.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' order by a.dc desc";
		}
		if (this.sg.cells(0,row) == "KBDEP")	{
			var strSQL1 = "select a.kode_akun,b.nama as nama_akun,a.kode_pp,c.nama as nama_pp,'-' as kode_drk,'-' as nama_drk,a.dc,a.keterangan,a.nilai "+
						  "from kas_j a inner join masakun b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi "+
						  "				      inner join pp c on a.kode_pp=c.kode_pp and a.kode_lokasi=c.kode_lokasi "+						  
						  "where a.no_kas = '"+this.e_nobukti.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' order by a.dc desc";
		}
		if (this.sg.cells(0,row) == "TTPDEPO")	{
			var strSQL1 = "select a.kode_akun,b.nama as nama_akun,a.kode_pp,c.nama as nama_pp,'-' as kode_drk,'-' as nama_drk,a.dc,a.keterangan,a.nilai "+
						  ...
						  "				      inner join pp c on a.kode_pp=c.kode_pp and a.kode_lokasi=c.kode_lokasi "+						  
						  "where a.no_tutup = '"+this.e_nobukti.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' order by a.dc desc";
		}
		...
		if (this.sg.cells(0,row) == "BSHM")	{
			var strSQL1 = "select a.kode_akun,b.nama as nama_akun,a.kode_pp,c.nama as nama_pp,isnull(a.kode_drk,'-') as kode_drk,isnull(d.nama,'-') as nama_drk,a.dc,a.keterangan,a.nilai "+
		...
		if (this.sg.cells(0,row) == "BRD")	{
			var strSQL1 = "select a.kode_akun,b.nama as nama_akun,a.kode_pp,c.nama as nama_pp,isnull(a.kode_drk,'-') as kode_drk,isnull(d.nama,'-') as nama_drk,a.dc,a.keterangan,a.nilai "+
						  ...
						  "				      inner join pp c on a.kode_pp=c.kode_pp and a.kode_lokasi=c.kode_lokasi "+		
						  "                   left join drk d on a.kode_drk=d.kode_drk and a.kode_lokasi=d.kode_lokasi and substring(a.periode,1,4)=d.tahun "+				  
						  "where a.no_rdbeli = '"+this.e_nobukti.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' order by a.dc desc";
		}
						...
						if (result.toLowerCase().search("error") == -1){							
							if (this.preView == "1") {
								...
								if (this.c_status.getText() == "APPROVE") {
									...
									if (this.e_modul.getText() == "SPIRD") this.app.services.postSAP(this.e_nobukti.getText(),"SPISHM", function(data){ alert(data); });
