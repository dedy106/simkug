window.app_saku3_transaksi_sapyakes_fKbBunga = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_sapyakes_fKbBunga.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_sapyakes_fKbBunga";
		...
		this.cb_app = new saiCBBL(this.pc2.childPage[0],{bound:[20,17,220,20],caption:"NIK Post SAP", multiSelection:false, maxLength:10, tag:2,change:[this,"doChange"],visible:false});				
		...
		this.p1 = new panel(this.pc2.childPage[0],{bound:[1,23,995,300],caption:"Daftar Bunga Deposito"});
...
window.app_saku3_transaksi_sapyakes_fKbBunga.extend(window.childForm);
window.app_saku3_transaksi_sapyakes_fKbBunga.implement({
