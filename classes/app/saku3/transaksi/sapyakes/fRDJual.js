window.app_saku3_transaksi_sapyakes_fRDJual = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_sapyakes_fRDJual.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_sapyakes_fRDJual";
...
window.app_saku3_transaksi_sapyakes_fRDJual.extend(window.childForm);
window.app_saku3_transaksi_sapyakes_fRDJual.implement({
