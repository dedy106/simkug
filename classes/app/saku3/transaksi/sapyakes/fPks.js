window.app_saku3_transaksi_sapyakes_fPks = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_sapyakes_fPks.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_sapyakes_fPks";
...
window.app_saku3_transaksi_sapyakes_fPks.extend(window.childForm);
window.app_saku3_transaksi_sapyakes_fPks.implement({	
