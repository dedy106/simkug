window.app_saku3_transaksi_tpcc_bill_fKbPiu = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tpcc_bill_fKbPiu.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tpcc_bill_fKbPiu";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Penyelesaian Piutang Billing", 0);	
		...
		this.e_akunpiu = new saiLabelEdit(this.pc2.childPage[0],{bound:[790,18,200,20],caption:"Akun Piutang", readOnly:true});												
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[1,12,996,236], childPage:["Item Jurnal Pelunasan"]});		
...
window.app_saku3_transaksi_tpcc_bill_fKbPiu.extend(window.childForm);
window.app_saku3_transaksi_tpcc_bill_fKbPiu.implement({
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					sql.add("insert into trans_m (no_bukti,kode_lokasi,tgl_input,nik_user,periode,modul,form,posted,prog_seb,progress,kode_pp,tanggal,no_dokumen,keterangan,kode_curr,kurs,nilai1,nilai2,nilai3,nik1,nik2,nik3,no_ref1,no_ref2,no_ref3,param1,param2,param3) values "+
							...
							parseNilai(this.e_nilai.getText())+",0,0,'"+this.cb_app.getText()+"','-','-','"+this.cb_piutang.getText()+"','-','-','"+this.cb_cust.getText()+"','-','"+this.c_jenis.getText()+"')");
	...
	doChange:function(sender){		
		...
		if ((sender == this.e_periode || sender == this.cb_cust) && (this.e_periode.getText()!= "" && this.cb_cust.getText()!= "" && this.stsSimpan==1)) {			
			var strSQL = "select a.no_piutang,a.keterangan from piutang_d a "+
						 ...
						 "where a.modul='PIUBILL' and a.kode_cust='"+this.cb_cust.getText()+"' and a.nilai+a.nilai_ppn-a.nilai_pph>isnull(b.bayar,0) and a.periode<='"+this.e_periode.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"'";
