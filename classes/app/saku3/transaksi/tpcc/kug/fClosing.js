window.app_saku3_transaksi_tpcc_kug_fClosing = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tpcc_kug_fClosing.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tpcc_kug_fClosing";
...
window.app_saku3_transaksi_tpcc_kug_fClosing.extend(window.childForm);
window.app_saku3_transaksi_tpcc_kug_fClosing.implement({	
