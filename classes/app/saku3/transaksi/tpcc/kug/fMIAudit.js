window.app_saku3_transaksi_tpcc_kug_fMIAudit = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tpcc_kug_fMIAudit.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tpcc_kug_fMIAudit";
...
window.app_saku3_transaksi_tpcc_kug_fMIAudit.extend(window.childForm);
window.app_saku3_transaksi_tpcc_kug_fMIAudit.implement({				
