window.app_saku3_transaksi_tpcc_kug_fJP = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tpcc_kug_fJP.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tpcc_kug_fJP";
...
window.app_saku3_transaksi_tpcc_kug_fJP.extend(window.childForm);
window.app_saku3_transaksi_tpcc_kug_fJP.implement({	
	...
	simpan: function(){			
		try{			
			...
			this.e_nb.setText(this.standarLib.noBuktiOtomatis(this.dbLib,"jp","no_bukti",this.app._lokasi+"-CLS"+this.e_periode.getText().substr(2,4)+".","000"));
