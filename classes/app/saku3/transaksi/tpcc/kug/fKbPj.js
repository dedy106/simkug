window.app_saku3_transaksi_tpcc_kug_fKbPj = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tpcc_kug_fKbPj.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tpcc_kug_fKbPj";
...
window.app_saku3_transaksi_tpcc_kug_fKbPj.extend(window.childForm);
window.app_saku3_transaksi_tpcc_kug_fKbPj.implement({
