window.app_saku3_transaksi_tpcc_kug_fClosingBulan = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_tpcc_kug_fClosingBulan.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_tpcc_kug_fClosingBulan";
...
window.app_saku3_transaksi_tpcc_kug_fClosingBulan.extend(window.childForm);
window.app_saku3_transaksi_tpcc_kug_fClosingBulan.implement({
	doClose: function() {
