window.app_saku3_transaksi_kopeg_fKartuSimpSawal = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_kopeg_fKartuSimpSawal.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_kopeg_fKartuSimpSawal";
...
window.app_saku3_transaksi_kopeg_fKartuSimpSawal.extend(window.portalui_childForm);
window.app_saku3_transaksi_kopeg_fKartuSimpSawal.implement({
	...
	doClick:function(sender){
		try {			
			...
			this.stsSimpan = 1;
			this.e_nb.setText(this.standarLib.noBuktiOtomatis(this.dbLib,"kop_simp_m","no_simp",this.app._lokasi+"-"+this.e_jenis.getText()+this.cb_agg.getText()+".","0000"));		
		    this.dp_d1.setFocus();
