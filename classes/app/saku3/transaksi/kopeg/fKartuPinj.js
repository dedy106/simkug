window.app_saku3_transaksi_kopeg_fKartuPinj = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_kopeg_fKartuPinj.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_kopeg_fKartuPinj";
...
window.app_saku3_transaksi_kopeg_fKartuPinj.extend(window.portalui_childForm);
window.app_saku3_transaksi_kopeg_fKartuPinj.implement({
