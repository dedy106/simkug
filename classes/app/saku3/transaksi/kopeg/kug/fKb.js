window.app_saku3_transaksi_kopeg_kug_fKb = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_kopeg_kug_fKb.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_kopeg_kug_fKb";
...
window.app_saku3_transaksi_kopeg_kug_fKb.extend(window.childForm);
window.app_saku3_transaksi_kopeg_kug_fKb.implement({
	...
	doClick:function(sender){
		try{
			if (this.e_periode.getText()!= "" && this.c_jenis.getText()!= "") {
				...
				this.stsSimpan = 1;
				var AddFormat = this.app._lokasi+"-"+this.c_jenis.getText().substr(0,2)+this.e_periode.getText().substr(2,4)+".___%";
				...
				if (typeof data == "object"){
					...
					if (line != undefined){
						if (line.no_bukti == "0") this.e_nb.setText(this.app._lokasi+"-"+this.c_jenis.getText().substr(0,2)+this.e_periode.getText().substr(2,4)+".0001");
						else {
							...
							this.e_nb.setText(this.app._lokasi+"-"+this.c_jenis.getText().substr(0,2)+this.e_periode.getText().substr(2,4)+"."+nu);						
						}
					} 
				}
