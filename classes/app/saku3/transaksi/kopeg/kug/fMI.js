window.app_saku3_transaksi_kopeg_kug_fMI = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_kopeg_kug_fMI.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_kopeg_kug_fMI";
...
window.app_saku3_transaksi_kopeg_kug_fMI.extend(window.childForm);
window.app_saku3_transaksi_kopeg_kug_fMI.implement({				
	...
	doClick:function(sender){
		if (this.e_periode.getText()!= "" && this.c_jenis.getText()!= "") {
			...
			this.stsSimpan = 1;
			var AddFormat =  this.app._lokasi+"-"+this.c_jenis.getText()+this.e_periode.getText().substr(2,4)+".____%";
			...
			if (typeof data == "object"){
				...
				if (line != undefined){
					if (line.no_bukti == "0") this.e_nb.setText(this.app._lokasi+"-"+this.c_jenis.getText()+this.e_periode.getText().substr(2,4)+".0001");
					else {
						var idx = parseFloat(line.no_bukti.substr(10,4)) + 1;
						idx = idx.toString();
						if (idx.length == 1) var nu = "000"+idx;
						if (idx.length == 2) var nu = "00"+idx;
						if (idx.length == 3) var nu = "0"+idx;
						if (idx.length == 4) var nu = idx;
						this.e_nb.setText(this.app._lokasi+"-"+this.c_jenis.getText()+this.e_periode.getText().substr(2,4)+"."+nu);						
					}
				} 				
			}
			this.e_ket.setFocus();
