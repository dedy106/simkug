window.app_saku3_transaksi_kopeg_fAgg = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_kopeg_fAgg.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_kopeg_fAgg";
...
window.app_saku3_transaksi_kopeg_fAgg.extend(window.childForm);
window.app_saku3_transaksi_kopeg_fAgg.implement({
