window.app_saku3_transaksi_kopeg_fKartuPinjBrgSawal = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_kopeg_fKartuPinjBrgSawal.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_kopeg_fKartuPinjBrgSawal";
		...
		this.e_bunga = new portalui_saiLabelEdit(this.pc2.childPage[0],{bound:[20,31,200,20],caption:"Tot Margin",tipeText:ttNilai, text:"0", change:[this,"doChange"]});
...
window.app_saku3_transaksi_kopeg_fKartuPinjBrgSawal.extend(window.portalui_childForm);
window.app_saku3_transaksi_kopeg_fKartuPinjBrgSawal.implement({
