window.app_saku3_transaksi_kopeg_fLoadSimpH = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_kopeg_fLoadSimpH.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_kopeg_fLoadSimpH";
...
window.app_saku3_transaksi_kopeg_fLoadSimpH.extend(window.childForm);
window.app_saku3_transaksi_kopeg_fLoadSimpH.implement({
	...
	doChange: function(sender){
		if (sender == this.e_periode && this.e_periode.getText()!="") {
			this.e_nb.setSQL("select no_angs, keterangan from kop_simpangs_m where modul in ('LOAD') and posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"'",["no_angs","keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);
		}
