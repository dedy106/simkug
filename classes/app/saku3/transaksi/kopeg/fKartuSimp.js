window.app_saku3_transaksi_kopeg_fKartuSimp = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_kopeg_fKartuSimp.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_kopeg_fKartuSimp";
...
window.app_saku3_transaksi_kopeg_fKartuSimp.extend(window.portalui_childForm);
window.app_saku3_transaksi_kopeg_fKartuSimp.implement({
