window.app_saku3_transaksi_kopeg_fKartuPinjBrg = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_kopeg_fKartuPinjBrg.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_kopeg_fKartuPinjBrg";
		this.itemsValue = new portalui_arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Kartu Pinjaman Barang", 0);	
		...
		this.e_bunga = new portalui_saiLabelEdit(this.pc2.childPage[0],{bound:[20,31,200,20],caption:"Total Margin",tipeText:ttNilai, text:"0", change:[this,"doChange"]});
...
window.app_saku3_transaksi_kopeg_fKartuPinjBrg.extend(window.portalui_childForm);
window.app_saku3_transaksi_kopeg_fKartuPinjBrg.implement({
	...
	generateSch: function(){
	    try{         
    		...
    		var margin = Math.round(bunga / lm);
