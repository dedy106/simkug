window.app_saku3_transaksi_dago_fAgenda = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_dago_fAgenda.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_dago_fAgenda";
...
window.app_saku3_transaksi_dago_fAgenda.extend(window.childForm);
window.app_saku3_transaksi_dago_fAgenda.implement({
