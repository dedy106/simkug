window.app_saku3_transaksi_dago_fPembayaran = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_dago_fPembayaran.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_dago_fPembayaran";
		...
		this.e_curr = new saiLabelEdit(this.pc2.childPage[1],{bound:[520,16,200,20],caption:"Currency",readOnly:true,tag:3});	
		...
		this.c_curr = new saiLabelEdit(this.pc2.childPage[1],{bound:[520,15,140,20],caption:"Curr Bayar - Kurs",readOnly:true,tag:2,change:[this,"doChange"]});												
		this.e_kurs = new saiLabelEdit(this.pc2.childPage[1],{bound:[670,15,50,20],caption:"", tag:3, labelWidth:0, readOnly:true, tipeText:ttNilai, text:"1",tag:2,change:[this,"doChange"]});								
		this.e_ket = new saiLabelEdit(this.pc2.childPage[1],{bound:[20,17,200,20],caption:"Jadwal", maxLength:10});	
		this.e_bayar = new saiLabelEdit(this.pc2.childPage[1],{bound:[520,17,200,20],caption:"Nilai Bayar Curr", tag:3, tipeText:ttNilai, text:"0",readOnly:true});							
		this.cb_peserta = new portalui_saiCBBL(this.pc2.childPage[1],{bound:[20,15,220,20],caption:"Paket",multiSelection:false,tag:1,change:[this,"doChange"]});
		this.e_bayarIDR = new saiLabelEdit(this.pc2.childPage[1],{bound:[520,15,200,20],caption:"Nilai Bayar", tag:3, tipeText:ttNilai, text:"0", change:[this,"doChange"]});									
		...
		this.e_kelas = new saiLabelEdit(this.pc2.childPage[1],{bound:[20,14,200,20],caption:"Sistem Pembayaran",items:["Cash","Transfer"],readOnly:true,tag:1});							
		...
		this.e_totBiaya = new saiLabelEdit(this.pc2.childPage[1],{bound:[790,100,200,20],caption:"Total Biaya", tag:3, tipeText:ttNilai, text:"0", readOnly:true});					
...
window.app_saku3_transaksi_dago_fPembayaran.extend(window.childForm);
window.app_saku3_transaksi_dago_fPembayaran.implement({
