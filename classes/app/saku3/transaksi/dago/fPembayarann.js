window.app_saku3_transaksi_dago_fPembayarann = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_dago_fPembayarann.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_dago_fPembayarann";
		...
		this.pc2 = new pageControl(this,{bound:[10,10,1000,420], childPage:["List Pembayaran","Data Kwitansi","Histori"]});		
		
		this.sg3 = new saiGrid(this.pc2.childPage[0],{bound:[1,5,this.pc2.width-5,this.pc2.height-30],colCount:6,tag:9,
		            colTitle:["No Kwitansi","Tanggal","Nama Peserta","Paket","Jadwal","Total Biaya"],
					colWidth:[[5,4,3,2,1,0],[200,200,250,150,80,100]],
					readOnly:true,
					dblClick:[this,"doDoubleClick3"],autoAppend:false,defaultRow:1});		
		this.sgn3 = new portalui_sgNavigator(this.pc2.childPage[0],{bound:[1,this.pc2.height-25,this.pc2.width-1,25],buttonStyle:3,grid:this.sg3,pager:[this,"doPager3"]});
						
		this.e_nb = new portalui_saiLabelEdit(this.pc2.childPage[1],{bound:[20,16,200,20],caption:"No Kwitansi",maxLength:30,readOnly:true});
		...
		this.e_curr = new saiLabelEdit(this.pc2.childPage[1],{bound:[520,16,200,20],caption:"Marketing",readOnly:true,tag:3});	
		this.e_tgl = new saiLabelEdit(this.pc2.childPage[1],{bound:[20,13,200,25],caption:"Tanggal Bayar",tag:3, readOnly:true});	
		this.e_saldo = new saiLabelEdit(this.pc2.childPage[1],{bound:[520,13,200,20],caption:"Agent", readOnly:true,tag:3});			
		this.cb_akun = new saiCBBL(this.pc2.childPage[1],{bound:[20,15,220,20],caption:"Nama Peserta", multiSelection:false, maxLength:10, tag:2,change:[this,"doChange"]});
		this.c_curr = new saiLabelEdit(this.pc2.childPage[1],{bound:[520,15,140,20],caption:"Diskon",readOnly:true,tag:2,change:[this,"doChange"]});												
		this.e_ket = new saiLabelEdit(this.pc2.childPage[1],{bound:[20,17,200,20],caption:"Jadwal", maxLength:10});	
		this.e_bayar = new saiLabelEdit(this.pc2.childPage[1],{bound:[520,17,200,20],caption:"Type Room", tag:3,readOnly:true});							
		this.cb_peserta = new saiLabelEdit(this.pc2.childPage[1],{bound:[20,15,220,20],caption:"Paket",multiSelection:false,tag:1,change:[this,"doChange"]});
		this.e_neto = new saiLabelEdit(this.pc2.childPage[1],{bound:[20,12,200,20],caption:"Harga (Neto) Curr", tag:3, readOnly:true, tipeText:ttNilai, text:"0"});							
		this.e_duedate = new saiLabelEdit(this.pc2.childPage[1],{bound:[20,13,200,20],caption:"Telepon",tag:3, tipeText:ttNilai, text:"0"});
		this.e_kelas = new saiCB(this.pc2.childPage[1],{bound:[20,14,200,20],caption:"Sistem Pembayaran",items:["Cash","Transfer"],readOnly:true,tag:1});							
		
		this.pc1 = new pageControl(this.pc2.childPage[1],{bound:[5,12,990,200], childPage:["Pembayaran"]});				
		this.e_jadwal = new saiLabelEdit(this.pc2.childPage[1],{bound:[20,12,200,20],caption:"Biaya Wajib",tag:3, readOnly:true});						
		this.e_curr = new saiLabelEdit(this.pc2.childPage[1],{bound:[250,12,200,20],caption:"Mahram",readOnly:true,tag:3});										
		this.e_neto = new saiLabelEdit(this.pc2.childPage[1],{bound:[500,12,200,20],caption:"Currency", tag:3, readOnly:true, tipeText:ttNilai, text:"0"});							
		this.e_tgl = new saiLabelEdit(this.pc2.childPage[1],{bound:[20,13,200,20],caption:"Transportasi",tag:3, readOnly:true});				
		this.e_saldo = new saiLabelEdit(this.pc2.childPage[1],{bound:[250,13,200,20],caption:"Saldo Curr", tag:3, readOnly:true, tipeText:ttNilai, text:"0"});	
		this.e_bayar = new saiLabelEdit(this.pc2.childPage[1],{bound:[500,13,200,20],caption:"Nilai Bayar Curr", tag:3, tipeText:ttNilai, text:"0",readOnly:true});			
		this.e_kelas = new saiLabelEdit(this.pc2.childPage[1],{bound:[20,18,200,20],caption:"Biaya Optional",tag:3, readOnly:true});					
		this.c_curr = new saiLabelEdit(this.pc2.childPage[1],{bound:[250,18,140,20],caption:"Curr Bayar - Kurs",readOnly:true,tag:2,change:[this,"doChange"]});										
		this.e_kurs = new saiLabelEdit(this.pc2.childPage[1],{bound:[400,18,50,20],caption:"", tag:3, labelWidth:0, readOnly:true, tipeText:ttNilai, text:"1",tag:2,change:[this,"doChange"]});						
		this.e_bayarIDR = new saiLabelEdit(this.pc2.childPage[1],{bound:[500,18,200,20],caption:"Nilai Bayar", tag:3, tipeText:ttNilai, text:"0", change:[this,"doChange"]});					
					
		this.sg1 = new saiGrid(this.pc2.childPage[2],{bound:[0,5,this.pc2.width-5,this.pc2.height-30],colCount:6,tag:9,
				colTitle:["No Kwitansi","Tanggal","Nama Peserta","Paket","Jadwal","Total Biaya"],
				colWidth:[[5,4,3,2,1,0],[80,100,80,300,80,100]],
				readOnly:true,
				colFormat:[[0],[cfNilai]],												
		...
		try {
			...
			this.cb_akun.setSQL("select no_peserta, nama from dgw_peserta where kode_lokasi='"+this.app._lokasi+"' ",["no_peserta","nama"],false,["No Peserta","Nama"],"and","Data Peserta",true);
...
window.app_saku3_transaksi_dago_fPembayarann.extend(window.childForm);
window.app_saku3_transaksi_dago_fPembayarann.implement({
		...
		try{						
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					sql.add("insert into dgw_pembayaran (no_kwitansi,nama_peserta, jadwal, tgl_bayar, paket, harga, sistem_bayar, telp, type_room, jml_byr_usd, jml_byr_rp, biaya_wjb, trans, biaya_op, mahram, keterangan) values  "+
