window.app_saku3_transaksi_kb_fKbSimple = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_kb_fKbSimple.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_kb_fKbSimple";
...
window.app_saku3_transaksi_kb_fKbSimple.extend(window.childForm);
window.app_saku3_transaksi_kb_fKbSimple.implement({	
