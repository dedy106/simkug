window.app_saku3_transaksi_kb_fRefJurnalSimple = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_kb_fRefJurnalSimple.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_kb_fRefJurnalSimple";
...
window.app_saku3_transaksi_kb_fRefJurnalSimple.extend(window.childForm);
window.app_saku3_transaksi_kb_fRefJurnalSimple.implement({
