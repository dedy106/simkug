window.app_saku3_transaksi_kb_fAjuReimKB = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_kb_fAjuReimKB.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_kb_fAjuReimKB";
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Pengajuan Reimburse KasBank: Input", 0);	
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[1,5,995,280], childPage:["Data Bukti KasBank","Detail Transaksi","Catatan Approval"]});		
		...
		this.sg2 = new saiGrid(this.pc1.childPage[1],{bound:[0,5,this.pc1.width-5,this.pc1.height-30],colCount:12,tag:9,
...
window.app_saku3_transaksi_kb_fAjuReimKB.extend(window.childForm);
window.app_saku3_transaksi_kb_fAjuReimKB.implement({
