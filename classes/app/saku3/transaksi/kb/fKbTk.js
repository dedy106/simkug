window.app_saku3_transaksi_kb_fKbTk = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_kb_fKbTk.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_kb_fKbTk";
		...
		this.c_jenis = new saiCB(this.pc2.childPage[1],{bound:[20,12,220,20],caption:"Jenis",items:["BEBAN","PENDAPATAN"], readOnly:true,tag:2,change:[this,"doChange"]});
...
window.app_saku3_transaksi_kb_fKbTk.extend(window.childForm);
window.app_saku3_transaksi_kb_fKbTk.implement({	
