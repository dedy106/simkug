window.app_saku3_transaksi_kb_fAjuKBTitip2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_kb_fAjuKBTitip2.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_kb_fAjuKBTitip2";
		...
		this.cb_vendor = new saiCBBL(this.pc1.childPage[1],{bound:[20,14,222,20],caption:"Kode Vendor", multiSelection:false, maxLength:10, tag:1,change:[this,"doChange"]});
...
window.app_saku3_transaksi_kb_fAjuKBTitip2.extend(window.childForm);
window.app_saku3_transaksi_kb_fAjuKBTitip2.implement({	
	...
	doChange:function(sender){
		if (sender == this.cb_kb && this.cb_kb.getText() != "") {
			var strSQL =  "select c.kode_akun,c.nama,a.nilai-isnull(b.pakai,0) as saldo,d.bank,d.cabang,d.no_rek,d.nama_rek "+
						  "from kas_titip a "+
			...
			if (typeof data == "object"){
				...
				if (line != undefined){								
					...
					this.e_ket.setText(this.cb_kb.rightLabelCaption);
				}
			}
		}
	...
	doCari:function(sender){								
		try {
			...
			var strSQL = "select a.no_kas,convert(varchar,c.tanggal,103) as tgl,a.keterangan,a.kode_vendor,b.nama as nama_vendor,d.nilai,d.no_aju as no_aju "+
		             "from kas_titip a "+
	...
	doLoad:function(sender){	
		var strSQL = "select a.no_kas,convert(varchar,c.tanggal,103) as tgl,a.keterangan,a.kode_vendor,b.nama as nama_vendor,a.nilai-isnull(d.bayar,0) as nilai,'-' as no_aju "+
		             "from kas_titip a "+
					 "inner join it_vendor b on a.kode_vendor=b.kode_vendor and a.kode_lokasi=b.kode_lokasi "+
					 "inner join kas_m c on a.no_kas=c.no_kas and a.kode_lokasi=c.kode_lokasi "+
					 "left join ( "+
