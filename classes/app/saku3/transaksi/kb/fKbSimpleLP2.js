window.app_saku3_transaksi_kb_fKbSimpleLP2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_kb_fKbSimpleLP2.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_kb_fKbSimpleLP2";
		...
		this.c_jenis = new saiCB(this.pc2.childPage[1],{bound:[20,11,200,20],caption:"Modul",items:["BK","BM","KK","KM",], readOnly:true,tag:2,change:[this,"doChange"]});		
		...
		this.pc1 = new pageControl(this.pc2.childPage[1],{bound:[5,12,990,300], childPage:["Data Item Jurnal","Referensi Jurnal"]});
...
window.app_saku3_transaksi_kb_fKbSimpleLP2.extend(window.childForm);
window.app_saku3_transaksi_kb_fKbSimpleLP2.implement({	
		...
		switch (event){
			...
			case "ubah" :															
				...
				*/
				...
				var akunKB = false;				
				if (this.c_jenis.getText() == "BK" || this.c_jenis.getText() == "KK") var dc = "C"; else var dc = "D";
