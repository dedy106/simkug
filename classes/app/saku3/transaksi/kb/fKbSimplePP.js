window.app_saku3_transaksi_kb_fKbSimplePP = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_kb_fKbSimplePP.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_kb_fKbSimplePP";
...
window.app_saku3_transaksi_kb_fKbSimplePP.extend(window.childForm);
window.app_saku3_transaksi_kb_fKbSimplePP.implement({	
