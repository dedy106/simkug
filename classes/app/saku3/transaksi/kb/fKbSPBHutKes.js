/*
no rekon matikan yg dari TM di yk_hutang_d
*/
window.app_saku3_transaksi_kb_fKbSPBHutKes = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_kb_fKbSPBHutKes.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_kb_fKbSPBHutKes";
...
window.app_saku3_transaksi_kb_fKbSPBHutKes.extend(window.childForm);
window.app_saku3_transaksi_kb_fKbSPBHutKes.implement({	
