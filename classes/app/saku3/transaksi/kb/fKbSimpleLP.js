window.app_saku3_transaksi_kb_fKbSimpleLP = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_kb_fKbSimpleLP.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_kb_fKbSimpleLP";
...
window.app_saku3_transaksi_kb_fKbSimpleLP.extend(window.childForm);
window.app_saku3_transaksi_kb_fKbSimpleLP.implement({	
