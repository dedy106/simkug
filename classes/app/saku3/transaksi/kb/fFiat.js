window.app_saku3_transaksi_kb_fFiat = function(owner)
{
	if (owner)
	{		
		window.app_saku3_transaksi_kb_fFiat.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_kb_fFiat";
...
window.app_saku3_transaksi_kb_fFiat.extend(window.childForm);
window.app_saku3_transaksi_kb_fFiat.implement({	
		...
		try{		
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					if (this.modul == "PINBUK") sql.add("update inv_spb_surat set progress='"+prog+"',no_fiat='"+this.e_nb.getText()+"' where no_spb='"+this.e_nospb.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");					
					else sql.add("update spb_m set progress='"+prog+"',no_fiat='"+this.e_nb.getText()+"' where no_spb='"+this.e_nospb.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");
	...
	doModalResult: function(event, modalResult){
		...
		switch (event){
			...
			case "hapus" :	
				...
				if (this.modul == "PINBUK") sql.add("update inv_spb_surat set progress='0',no_fiat='-' where no_spb='"+this.e_nospb.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");									
				else sql.add("update spb_m set progress='0',no_fiat='-' where no_spb='"+this.e_nospb.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");									
				setTipeButton(tbAllFalse);	
				this.dbLib.execArraySQL(sql);
		...
		try{
			if (this.sg.cells(0,row) != "") {			
				...
				if (this.modul != "DROPING") {
					if (this.modul == "PJ2_SPB" || this.modul == "PJLOG_SPB" ||this.modul == "IFREIM_SPB" || this.modul == "PD_SPB") {
				...
				if (this.modul == "INV_SPB") {
					var strSQL3 = "select a.kode_vendor,b.nama,a.bank,a.cabang,a.no_rek,a.nama_rek,a.nilai,isnull(a.pajak,0) as pajak,a.keterangan "+
								  "from spb_d a inner join inv_bank b on a.kode_vendor=b.kode_bank "+
								  "where a.no_spb='"+this.e_nospb.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"'";										
				}				
				if (this.modul == "PINBUK") {
					var strSQL3 = "select a.bsumber2 as kode_vendor,b.nama,b.nama as bank,b.alamat as cabang,b.no_rek,b.nama_rek,c.nilai,0 as pajak,a.hal2 as keterangan "+
								  "from inv_spb_surat a inner join inv_bank b on a.bsumber2=b.kode_bank "+
								  "                     inner join inv_shop_m c on a.no_spb=c.no_spb "+
								  "where a.no_spb='"+this.e_nospb.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"'";										
				}
				if (this.modul == "SHMBELI") {
					var strSQL3 = "select a.kode_vendor,a.nama_rek,a.bank,a.cabang,a.no_rek,a.nama_rek,a.nilai,isnull(a.pajak,0) as pajak,a.keterangan "+
								  "from spb_d a "+
								  "where a.no_spb='"+this.e_nospb.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"'";										
				}
				...
				if (this.modul == "SPBELI") {
					var strSQL3 = "select a.kode_vendor,a.nama_rek,a.bank,a.cabang,a.no_rek,a.nama_rek,a.nilai,isnull(a.pajak,0) as pajak,a.keterangan "+
								  "from spb_d a "+
								  "where a.no_spb='"+this.e_nospb.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"'";										
				}
				if (this.modul == "OBBELI") {
					var strSQL3 = "select a.kode_vendor,a.nama_rek,a.bank,a.cabang,a.no_rek,a.nama_rek,a.nilai,isnull(a.pajak,0) as pajak,a.keterangan "+
								  "from spb_d a "+
								  "where a.no_spb='"+this.e_nospb.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"'";										
				}
	...
	doLoad:function(sender){		
		var strSQL = "select a.no_spb,'INPROG' as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.due_date,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,a.no_bukti as no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_fiat "+
					 ...
					 "where a.no_fiat='-' and a.kode_lokasi='"+this.app._lokasi+"' and a.periode<='"+this.e_periode.getText()+"' "+					 
					 "union "+				
					 ...
					 "where a.periode<='"+this.e_periode.getText()+"' and a.no_fiat='-' and a.kode_lokasi='"+this.app._lokasi+"' and a.modul in ('DROPING','PJ2_SPB','PJLOG_SPB','IFREIM_SPB','PD_SPB','DAKEM_SPB','HUTKES_SPB') "+					 
					 "union "+
					 
					 "select a.no_spb,'INPROG' as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.due_date,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,a.no_bukti as no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_fiat "+
		             "from spb_m a inner join inv_shop_m d on a.no_spb=d.no_spb and a.kode_lokasi=d.kode_lokasi "+
					 "             inner join pp b on d.kode_pp=b.kode_pp and d.kode_lokasi=b.kode_lokasi "+
					 "             inner join karyawan c on d.nik_app=c.nik "+
					 "where a.no_fiat='-' and a.kode_lokasi='"+this.app._lokasi+"' and a.periode<='"+this.e_periode.getText()+"' "+					 
					 "union "+
					 
					 "select a.no_spb,'INPROG' as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.due_date,103) as tgl2,'PINBUK' as modul,b.kode_pp+' - '+b.nama as pp,a.no_bukti as no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,e.no_fiat "+
		             "from spb_m a inner join inv_shop_m d on a.no_spb=d.no_spb and a.kode_lokasi=d.kode_lokasi "+
					 "             inner join pp b on d.kode_pp=b.kode_pp and d.kode_lokasi=b.kode_lokasi "+
					 "             inner join karyawan c on d.nik_app=c.nik "+
					 "             inner join inv_spb_surat e on a.no_spb=e.no_spb and a.kode_lokasi=e.kode_lokasi "+
					 "where e.no_fiat='-' and e.kode_lokasi='"+this.app._lokasi+"' and a.periode<='"+this.e_periode.getText()+"' "+
					 "union "+
					 
					 "select a.no_spb,'INPROG' as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.due_date,103) as tgl2,d.modul,b.kode_pp+' - '+b.nama as pp,a.no_bukti as no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_fiat "+
		             "from spb_m a inner join inv_shmbeli_m d on a.no_spb=d.no_spb and a.kode_lokasi=d.kode_lokasi "+
					 "             inner join pp b on d.kode_pp=b.kode_pp and d.kode_lokasi=b.kode_lokasi "+
					 "             inner join karyawan c on d.nik_buat=c.nik "+					 
					 "where a.no_fiat='-' and a.kode_lokasi='"+this.app._lokasi+"' and a.periode<='"+this.e_periode.getText()+"' "+
					 "union "+
					 ...
					 "select a.no_spb,'INPROG' as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.due_date,103) as tgl2,d.modul,b.kode_pp+' - '+b.nama as pp,a.no_bukti as no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_fiat "+
		             "from spb_m a inner join inv_rdbeli_m d on a.no_spb=d.no_spb and a.kode_lokasi=d.kode_lokasi "+
					 "             inner join pp b on d.kode_pp=b.kode_pp and d.kode_lokasi=b.kode_lokasi "+
					 "             inner join karyawan c on d.nik_buat=c.nik "+					 
					 "where a.no_fiat='-' and a.kode_lokasi='"+this.app._lokasi+"' and a.periode<='"+this.e_periode.getText()+"' "+
					 "union "+
					 ...
					 "select a.no_spb,'INPROG' as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.due_date,103) as tgl2,d.modul,b.kode_pp+' - '+b.nama as pp,a.no_bukti as no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_fiat "+
		             "from spb_m a inner join inv_spbeli_m d on a.no_spb=d.no_spb and a.kode_lokasi=d.kode_lokasi "+
					 "             inner join pp b on d.kode_pp=b.kode_pp and d.kode_lokasi=b.kode_lokasi "+
					 "             inner join karyawan c on d.nik_buat=c.nik "+					 
					 "where a.no_fiat='-' and a.kode_lokasi='"+this.app._lokasi+"' and a.periode<='"+this.e_periode.getText()+"' "+
					 "union "+
					 ...
					 "select a.no_spb,'INPROG' as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.due_date,103) as tgl2,d.modul,b.kode_pp+' - '+b.nama as pp,a.no_bukti as no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_fiat "+
		             "from spb_m a inner join inv_oblibeli_m d on a.no_spb=d.no_spb and a.kode_lokasi=d.kode_lokasi "+
					 "             inner join pp b on d.kode_pp=b.kode_pp and d.kode_lokasi=b.kode_lokasi "+
					 "             inner join karyawan c on d.nik_buat=c.nik "+					 
					 "where a.no_fiat='-' and a.kode_lokasi='"+this.app._lokasi+"' and a.periode<='"+this.e_periode.getText()+"' "+
	...
	doCari:function(sender){						
		...
		var strSQL = "select a.no_spb,'"+this.c_status2.getText()+"' as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.due_date,103) as tgl2,a.modul,b.kode_pp+' - '+b.nama as pp,a.no_bukti as no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_fiat "+
					 ...
					 "             inner join pp b on d.kode_pp=b.kode_pp and d.kode_lokasi=b.kode_lokasi "+
					 "             inner join karyawan c on d.nik_app=c.nik "+
					 "where a.periode<='"+this.e_periode.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' "+filter+" "+				 
					 "union "+				
					 ...
					 "where a.periode<='"+this.e_periode.getText()+"' and a.modul in ('DROPING','PJ2_SPB','PJLOG_SPB','IFREIM_SPB','PD_SPB','DAKEM_SPB','HUTKES_SPB') and a.kode_lokasi='"+this.app._lokasi+"' "+filter+" "+		
					 "union "+				
					 ...
					 "select e.no_spb,'"+this.c_status2.getText()+"' as status,convert(varchar,e.tanggal,103) as tgl,convert(varchar,e.due_date,103) as tgl2,'PINBUK' as modul,b.kode_pp+' - '+b.nama as pp,e.no_bukti as no_dokumen,e.keterangan,e.nilai,c.nik+' - '+c.nama as pembuat,a.no_fiat "+
		             "from spb_m e inner join inv_shop_m d on e.no_spb=d.no_spb and e.kode_lokasi=d.kode_lokasi "+
					 "             inner join pp b on d.kode_pp=b.kode_pp and d.kode_lokasi=b.kode_lokasi "+
					 "             inner join karyawan c on d.nik_app=c.nik "+
					 "             inner join inv_spb_surat a on a.no_spb=e.no_spb and a.kode_lokasi=e.kode_lokasi "+
					 "where e.periode<='"+this.e_periode.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' "+filter+" "+
					 "union "+				
					 
					 "select a.no_spb,'"+this.c_status2.getText()+"' as status,convert(varchar,a.tanggal,103) as tgl,convert(varchar,a.due_date,103) as tgl2,'SHMBELI' as modul,b.kode_pp+' - '+b.nama as pp,a.no_bukti as no_dokumen,a.keterangan,a.nilai,c.nik+' - '+c.nama as pembuat,a.no_fiat "+
		             "from spb_m a inner join inv_shmbeli_m d on a.no_spb=d.no_spb and a.kode_lokasi=d.kode_lokasi "+
					 "             inner join pp b on d.kode_pp=b.kode_pp and d.kode_lokasi=b.kode_lokasi "+
					 "             inner join karyawan c on d.nik_buat=c.nik "+					 
					 "where a.periode<='"+this.e_periode.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' "+filter+" "+
