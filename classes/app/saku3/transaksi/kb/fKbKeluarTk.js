window.app_saku3_transaksi_kb_fKbKeluarTk = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_kb_fKbKeluarTk.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_kb_fKbKeluarTk";
...
window.app_saku3_transaksi_kb_fKbKeluarTk.extend(window.childForm);
window.app_saku3_transaksi_kb_fKbKeluarTk.implement({	
