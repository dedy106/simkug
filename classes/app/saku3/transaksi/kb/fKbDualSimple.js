window.app_saku3_transaksi_kb_fKbDualSimple = function(owner)
{
	if (owner)
	{
		window.app_saku3_transaksi_kb_fKbDualSimple.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku3_transaksi_kb_fKbDualSimple";
...
window.app_saku3_transaksi_kb_fKbDualSimple.extend(window.childForm);
window.app_saku3_transaksi_kb_fKbDualSimple.implement({	
	...
	simpan: function(){			
		try{						
			if (this.stsSimpan == 1) this.e_nb.setText(this.standarLib.noBuktiOtomatis(this.dbLib,"kas_m","no_kas",this.app._lokasi+"-"+this.c_jenis.getText()+this.e_periode.getText().substr(2,4)+".","0000"));						
