// JavaScript Document
window.app_saku3_report_spm_flJurnalBatalBymhd = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spm_flJurnalBatalBymhd.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spm_flJurnalBatalBymhd";
		this.maximize();
...
window.app_saku3_report_spm_flJurnalBatalBymhd.extend(window.portalui_childForm);
window.app_saku3_report_spm_flJurnalBatalBymhd.implement({
