// JavaScript Document
window.app_saku3_report_spm_flDwLabaRugiPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spm_flDwLabaRugiPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spm_flDwLabaRugiPp";
		this.maximize();
...
window.app_saku3_report_spm_flDwLabaRugiPp.extend(window.portalui_childForm);
window.app_saku3_report_spm_flDwLabaRugiPp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_spm_rptDwLabaRugiPp";
				if (this.sg1.getCell(2,5)=="Mutasi")
				{
					this.nama_report="server_report_saku3_spm_rptDwLabaRugiPpMutasi";
				}
				if (this.sg1.getCell(2,5)=="DC")
				{
					this.nama_report="server_report_saku3_spm_rptDwLabaRugiPpDc";
				}
