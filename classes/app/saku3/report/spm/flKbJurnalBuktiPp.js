// JavaScript Document
window.app_saku3_report_spm_flKbJurnalBuktiPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spm_flKbJurnalBuktiPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spm_flKbJurnalBuktiPp";
		this.maximize();
...
window.app_saku3_report_spm_flKbJurnalBuktiPp.extend(window.portalui_childForm);
window.app_saku3_report_spm_flKbJurnalBuktiPp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_spm_rptKbJurnalBuktiPp";
