window.app_saku3_report_spm_flSppdAju = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spm_flSppdAju.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spm_flSppdAju";
		this.maximize();
...
window.app_saku3_report_spm_flSppdAju.extend(window.childForm);
window.app_saku3_report_spm_flSppdAju.implement({
		...
		try{			
			...
			if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Pengajuan",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_aju, a.dasar from pd_aju_m a "+this.filter,
												"select count(*) from pd_aju_m a "+this.filter,
												new Array("a.no_aju","a.dasar"),"and",new Array("No Bukti","Keterangan"));
			}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_spm_flSppdAju]::mainButtonClick:"+e);
		}
	},
