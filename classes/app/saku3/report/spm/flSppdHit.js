window.app_saku3_report_spm_flSppdHit = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spm_flSppdHit.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spm_flSppdHit";
		this.maximize();
...
window.app_saku3_report_spm_flSppdHit.extend(window.childForm);
window.app_saku3_report_spm_flSppdHit.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				this.gridLib.SGEditData(this.sg1,0,new Array(0,1,2), new Array("Lokasi","=",this.app._lokasi));
				this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Periode","=",this.periode));
				this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("No KPA","All",""));
			}else{
				// cek ulang pp
				if (this.app._userStatus!="A")
				{
		    	...
		    	this.filter =  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("a.no_spj",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and");
			...
			systemAPI.alert("[app_saku3_report_spm_flSppdHit]::mainButtonClick:"+e);
		}
	},
