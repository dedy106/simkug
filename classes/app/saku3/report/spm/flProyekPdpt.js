window.app_saku3_report_spm_flProyekPdpt = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spm_flProyekPdpt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spm_flProyekPdpt";
		this.maximize();
...
window.app_saku3_report_spm_flProyekPdpt.extend(window.childForm);
window.app_saku3_report_spm_flProyekPdpt.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_spm_rptProyekPdpt";
			...
			systemAPI.alert("[app_saku3_report_spm_flProyekPdpt]::mainButtonClick:"+e);
		}
	},
