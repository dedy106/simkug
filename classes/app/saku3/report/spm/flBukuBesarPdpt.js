window.app_saku3_report_spm_flBukuBesarPdpt = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spm_flBukuBesarPdpt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spm_flBukuBesarPdpt";
		this.maximize();
...
window.app_saku3_report_spm_flBukuBesarPdpt.extend(window.childForm);
window.app_saku3_report_spm_flBukuBesarPdpt.implement({
		...
		try
		{
			...
			else
			{
				...
				if (this.sg1.getCell(2,3)=="Akun")
				{
					...
					this.nama_report="server_report_saku3_spm_rptPdpt";
				}
				if (this.sg1.getCell(2,3)=="Akun Customer")
				{
					...
					this.nama_report="server_report_saku3_spm_rptPdptCust";
				}
				if (this.sg1.getCell(2,3)=="Detail")
				{
					...
					this.nama_report="server_report_saku3_spm_rptPdptDetail";
				}
	...
	doOpenAkun: function(kode_akun,kode_lokasi){
		...
		nama_report="server_report_saku3_spm_rptPdptCust";
	...
	doOpenAkunCust: function(kode_akun,kode_cust,kode_lokasi){
		...
		nama_report="server_report_saku3_spm_rptPdptDetail";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
	...
	doOpenNilaii: function(no_akun,kode_lokasi,periode){
		...
		nama_report="server_report_saku3_spm_rptBukuBesarPdpt";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
