window.app_saku3_report_spm_flProyekSaldoSpm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spm_flProyekSaldoSpm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spm_flProyekSaldoSpm";
		this.maximize();
...
window.app_saku3_report_spm_flProyekSaldoSpm.extend(window.childForm);
window.app_saku3_report_spm_flProyekSaldoSpm.implement({
	...
	{		
		...
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5,6],[2,2,2,2,2,0,0]);	
		if (row == 5)
		{
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2 = nama_cab+"/"+this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,5)+"/"+this.sg1.getCell(2,6);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_spm_rptProyekSaldoSpm";
			...
			systemAPI.alert("[app_saku3_report_spm_flProyekSaldoSpm]::mainButtonClick:"+e);
		}
	},
	...
	doOpenKartu: function(kode_proyek,kode_lokasi){
		...
		filter2="";
		nama_report="server_report_saku3_spm_rptKartuProyek";
	...
	doOpenJurnal: function(no_bukti,kode_lokasi){
		...
		nama_report="server_report_saku3_spm_rptGlJurnalBukti";
	...
	doOpenBdd: function(kode_proyek,kode_lokasi){
		...
		nama_report="server_report_saku3_spm_rptProyekBdd";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
	...
	doOpenBeban: function(kode_proyek,kode_lokasi){
		...
		nama_report="server_report_saku3_spm_rptProyekBeban";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
	...
	doOpenBymhd: function(kode_proyek,kode_lokasi){
		...
		nama_report="server_report_saku3_spm_rptProyekBymhd";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
	...
	doOpenBymhdKas: function(kode_proyek,kode_lokasi){
		...
		nama_report="server_report_saku3_spm_rptProyekBymhdKas";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
	...
	doOpenPiutang: function(kode_proyek,kode_lokasi){
		...
		nama_report="server_report_saku3_spm_rptProyekPiu";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
	...
	doOpenPiutangKas: function(kode_proyek,kode_lokasi){
		...
		nama_report="server_report_saku3_spm_rptProyekPiuKas";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
