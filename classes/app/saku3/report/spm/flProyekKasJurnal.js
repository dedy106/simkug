window.app_saku3_report_spm_flProyekKasJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spm_flProyekKasJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spm_flProyekKasJurnal";
		this.maximize();
...
window.app_saku3_report_spm_flProyekKasJurnal.extend(window.childForm);
window.app_saku3_report_spm_flProyekKasJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_spm_rptProyekKasJurnal";
			...
			systemAPI.alert("[app_saku3_report_spm_flProyekKasJurnal]::mainButtonClick:"+e);
		}
	},
