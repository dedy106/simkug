// JavaScript Document
window.app_saku3_report_spm_flDwLabaRugiRegionalJejer = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spm_flDwLabaRugiRegionalJejer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spm_flDwLabaRugiRegionalJejer";
		this.maximize();
...
window.app_saku3_report_spm_flDwLabaRugiRegionalJejer.extend(window.portalui_childForm);
window.app_saku3_report_spm_flDwLabaRugiRegionalJejer.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_spm_rptDwLabaRugiRegionalJejer";
