window.app_saku3_report_spm_flTagihanProyek = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spm_flTagihanProyek.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spm_flTagihanProyek";
		this.maximize();
...
window.app_saku3_report_spm_flTagihanProyek.extend(window.childForm);
window.app_saku3_report_spm_flTagihanProyek.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_spm_rptTagihanProyek";
			...
			systemAPI.alert("[app_saku3_report_spm_flTagihanProyek]::mainButtonClick:"+e);
		}
	},
