window.app_saku3_report_spm_flPbSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spm_flPbSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spm_flPbSaldo";
		this.maximize();
...
window.app_saku3_report_spm_flPbSaldo.extend(window.childForm);
window.app_saku3_report_spm_flPbSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_spm_rptPbSaldo";
			...
			systemAPI.alert("[app_saku3_report_spm_flPbSaldo]::mainButtonClick:"+e);
		}
	},
