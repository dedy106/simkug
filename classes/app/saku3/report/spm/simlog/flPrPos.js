window.app_saku3_report_spm_simlog_flPrPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spm_simlog_flPrPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spm_simlog_flPrPos";
		this.maximize();
...
window.app_saku3_report_spm_simlog_flPrPos.extend(window.childForm);
window.app_saku3_report_spm_simlog_flPrPos.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from log_pesan_m where modul='LOGBAST' and kode_lokasi='"+this.app._lokasi+"' order by periode",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_spm_simlog_rptPrPos";
			...
			systemAPI.alert("[app_saku3_report_spm_simlog_flPrPos]::mainButtonClick:"+e);
		}
	},
