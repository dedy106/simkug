window.app_saku3_report_spm_flIfPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spm_flIfPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spm_flIfPos";
		this.maximize();
...
window.app_saku3_report_spm_flIfPos.extend(window.childForm);
window.app_saku3_report_spm_flIfPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_spm_rptIfPos";
			...
			systemAPI.alert("[app_saku3_report_spm_flIfPos]::mainButtonClick:"+e);
		}
	},
