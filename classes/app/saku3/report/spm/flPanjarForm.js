window.app_saku3_report_spm_flPanjarForm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spm_flPanjarForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spm_flPanjarForm";
		this.maximize();
...
window.app_saku3_report_spm_flPanjarForm.extend(window.childForm);
window.app_saku3_report_spm_flPanjarForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_spm_flPanjarForm]::mainButtonClick:"+e);
		}
	},
