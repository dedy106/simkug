window.app_saku3_report_spm_flPanjarSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spm_flPanjarSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spm_flPanjarSaldo";
		this.maximize();
...
window.app_saku3_report_spm_flPanjarSaldo.extend(window.childForm);
window.app_saku3_report_spm_flPanjarSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_spm_rptPanjarSaldo";
			...
			systemAPI.alert("[app_saku3_report_spm_flPanjarSaldo]::mainButtonClick:"+e);
		}
	},
