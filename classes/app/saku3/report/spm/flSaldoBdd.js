window.app_saku3_report_spm_flSaldoBdd = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spm_flSaldoBdd.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spm_flSaldoBdd";
		this.maximize();
...
window.app_saku3_report_spm_flSaldoBdd.extend(window.childForm);
window.app_saku3_report_spm_flSaldoBdd.implement({
		...
		try{			
			...
			if (row ==5)
			{
				...
				var sql="select a.kode_akun,b.nama "+
						...
						"from yk_pb_j a "+filter+" and a.jenis='bmhd' "+
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5],["123","123","23","123","3","123"]);
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5],[2,2,0,2,2,2]);	
		// if (row == 2)
		// {
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_spm_rptSaldoBdd";
			...
			systemAPI.alert("[app_saku3_report_spm_flSaldoBdd]::mainButtonClick:"+e);
		}
	},
