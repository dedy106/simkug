// JavaScript Document
window.app_saku3_report_spm_flDwLabaRugiBidang = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spm_flDwLabaRugiBidang.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spm_flDwLabaRugiBidang";
		this.maximize();
...
window.app_saku3_report_spm_flDwLabaRugiBidang.extend(window.portalui_childForm);
window.app_saku3_report_spm_flDwLabaRugiBidang.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_spm_rptDwLabaRugiBidang";
