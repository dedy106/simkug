window.app_saku3_report_spm_flPanjarPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spm_flPanjarPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spm_flPanjarPos";
		this.maximize();
...
window.app_saku3_report_spm_flPanjarPos.extend(window.childForm);
window.app_saku3_report_spm_flPanjarPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_spm_rptPanjarPos";
			...
			systemAPI.alert("[app_saku3_report_spm_flPanjarPos]::mainButtonClick:"+e);
		}
	},
