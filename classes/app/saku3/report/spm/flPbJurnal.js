window.app_saku3_report_spm_flPbJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spm_flPbJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spm_flPbJurnal";
		this.maximize();
...
window.app_saku3_report_spm_flPbJurnal.extend(window.childForm);
window.app_saku3_report_spm_flPbJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_spm_rptPbJurnal";
			...
			systemAPI.alert("[app_saku3_report_spm_flPbJurnal]::mainButtonClick:"+e);
		}
	},
