window.app_saku3_report_spm_flSaldoProyek = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spm_flSaldoProyek.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spm_flSaldoProyek";
		this.maximize();
...
window.app_saku3_report_spm_flSaldoProyek.extend(window.childForm);
window.app_saku3_report_spm_flSaldoProyek.implement({
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6],["123","123","3","123","123","3","123"]);
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_spm_rptSaldoProyek";
			...
			systemAPI.alert("[app_saku3_report_spm_flSaldoProyek]::mainButtonClick:"+e);
		}
	},
