window.app_saku3_report_spm_flKartuProyek = function (owner) {
	if (owner) {
		window.app_saku3_report_spm_flKartuProyek.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku3_report_spm_flKartuProyek";
		this.maximize();
...
window.app_saku3_report_spm_flKartuProyek.extend(window.childForm);
window.app_saku3_report_spm_flKartuProyek.implement({
	...
	mainButtonClick: function (sender) {
		try {
			if (sender === this.app._mainForm.bClear2) {
				...
				this.nama_report = "server_report_saku3_spm_rptKartuProyek";
			...
			systemAPI.alert("[app_saku3_report_spm_flKartuProyek]::mainButtonClick:" + e);
		}
	},
