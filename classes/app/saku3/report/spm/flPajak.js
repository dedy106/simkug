window.app_saku3_report_spm_flPajak = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spm_flPajak.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spm_flPajak";
		this.maximize();
...
window.app_saku3_report_spm_flPajak.extend(window.childForm);
window.app_saku3_report_spm_flPajak.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_spm_rptPajak";
