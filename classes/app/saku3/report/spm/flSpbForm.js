window.app_saku3_report_spm_flSpbForm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spm_flSpbForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spm_flSpbForm";
		this.maximize();
...
window.app_saku3_report_spm_flSpbForm.extend(window.childForm);
window.app_saku3_report_spm_flSpbForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_spm_flSpbForm]::mainButtonClick:"+e);
		}
	},
