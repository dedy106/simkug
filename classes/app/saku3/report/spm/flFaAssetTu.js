window.app_saku3_report_spm_flFaAssetTu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spm_flFaAssetTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spm_flFaAssetTu";
		this.maximize();
...
window.app_saku3_report_spm_flFaAssetTu.extend(window.childForm);
window.app_saku3_report_spm_flFaAssetTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_spm_rptFaAssetTu";
