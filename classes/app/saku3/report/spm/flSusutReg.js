window.app_saku3_report_spm_flSusutReg = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spm_flSusutReg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spm_flSusutReg";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("No Susut","All",""));
...
window.app_saku3_report_spm_flSusutReg.extend(window.childForm);
window.app_saku3_report_spm_flSusutReg.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row ==	2)
			{
				this.filterRep.ListDataSGFilter(this, "Data Susut",this.sg1, this.sg1.row, this.sg1.col,
														  "select no_fasusut, keterangan from fasusut_m "+
														   this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  "select count(no_fasusut) from fasusut_m "+
														  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  new Array("no_fasusut","keterangan"),"and");
			}
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from fasusut_m where kode_lokasi='"+this.app._lokasi+"' order by periode desc",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_spm_rptSusutReg";
			...
			systemAPI.alert("[app_saku3_report_spm_flSusutReg]::mainButtonClick:"+e);
		}
	},
