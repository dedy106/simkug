window.app_saku3_report_spm_flGlTbPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spm_flGlTbPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spm_flGlTbPp";
		this.maximize();
...
window.app_saku3_report_spm_flGlTbPp.extend(window.childForm);
window.app_saku3_report_spm_flGlTbPp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_spm_rptGlTbPp";
