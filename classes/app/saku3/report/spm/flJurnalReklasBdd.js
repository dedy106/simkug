// JavaScript Document
window.app_saku3_report_spm_flJurnalReklasBdd = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spm_flJurnalReklasBdd.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spm_flJurnalReklasBdd";
		this.maximize();
...
window.app_saku3_report_spm_flJurnalReklasBdd.extend(window.portalui_childForm);
window.app_saku3_report_spm_flJurnalReklasBdd.implement({
