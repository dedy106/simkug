// JavaScript Document
window.app_saku3_report_spm_flDwLabaRugiRegionalPpJejer = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spm_flDwLabaRugiRegionalPpJejer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spm_flDwLabaRugiRegionalPpJejer";
		this.maximize();
...
window.app_saku3_report_spm_flDwLabaRugiRegionalPpJejer.extend(window.portalui_childForm);
window.app_saku3_report_spm_flDwLabaRugiRegionalPpJejer.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_spm_rptDwLabaRugiRegionalPpJejer";
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,3)+"/"+this.sg1.getCell(2,4)+"/"+this.sg1.getCell(2,5)+"/"+this.sg1.getCell(2,2);
