window.app_saku3_report_spm_flGlTbPpJejer = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spm_flGlTbPpJejer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spm_flGlTbPpJejer";
		this.maximize();
...
window.app_saku3_report_spm_flGlTbPpJejer.extend(window.childForm);
window.app_saku3_report_spm_flGlTbPpJejer.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_spm_rptGlTbPpJejer";
