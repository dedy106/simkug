window.app_saku3_report_spm_flProyekSaldoCust = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spm_flProyekSaldoCust.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spm_flProyekSaldoCust";
		this.maximize();
...
window.app_saku3_report_spm_flProyekSaldoCust.extend(window.childForm);
window.app_saku3_report_spm_flProyekSaldoCust.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_spm_rptProyekSaldoCust";
			...
			systemAPI.alert("[app_saku3_report_spm_flProyekSaldoCust]::mainButtonClick:"+e);
		}
	},
	...
	doOpenSaldo: function(kode_cust,kode_lokasi,periode){
		...
		nama_report="server_report_saku3_spm_rptProyekSaldo2";
