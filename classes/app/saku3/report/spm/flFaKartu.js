window.app_saku3_report_spm_flFaKartu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spm_flFaKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spm_flFaKartu";
		this.maximize();
...
window.app_saku3_report_spm_flFaKartu.extend(window.childForm);
window.app_saku3_report_spm_flFaKartu.implement({
