window.app_saku3_report_spm_flPanjarPtgPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spm_flPanjarPtgPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spm_flPanjarPtgPos";
		this.maximize();
...
window.app_saku3_report_spm_flPanjarPtgPos.extend(window.childForm);
window.app_saku3_report_spm_flPanjarPtgPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_spm_rptPanjarPtgPos";
			...
			systemAPI.alert("[app_saku3_report_spm_flPanjarPtgPos]::mainButtonClick:"+e);
		}
	},
