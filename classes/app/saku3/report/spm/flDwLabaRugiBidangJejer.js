// JavaScript Document
window.app_saku3_report_spm_flDwLabaRugiBidangJejer = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spm_flDwLabaRugiBidangJejer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spm_flDwLabaRugiBidangJejer";
		this.maximize();
...
window.app_saku3_report_spm_flDwLabaRugiBidangJejer.extend(window.portalui_childForm);
window.app_saku3_report_spm_flDwLabaRugiBidangJejer.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_spm_rptDwLabaRugiBidangJejer";
