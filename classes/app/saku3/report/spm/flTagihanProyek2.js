window.app_saku3_report_spm_flTagihanProyek2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spm_flTagihanProyek2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spm_flTagihanProyek2";
		this.maximize();
...
window.app_saku3_report_spm_flTagihanProyek2.extend(window.childForm);
window.app_saku3_report_spm_flTagihanProyek2.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_spm_rptTagihanProyek2";
			...
			systemAPI.alert("[app_saku3_report_spm_flTagihanProyek2]::mainButtonClick:"+e);
		}
	},
