window.app_saku3_report_spm_flFaJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spm_flFaJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spm_flFaJurnal";
		this.maximize();
...
window.app_saku3_report_spm_flFaJurnal.extend(window.childForm);
window.app_saku3_report_spm_flFaJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_saku3_spm_rptFaJurnal";
				if (this.sg1.getCell(2,3)=="Memo Jurnal")
				{
					this.nama_report="server_report_saku3_spm_rptFaBuktiJurnal";
				}
