window.app_saku3_report_spm_flProyekPiutang = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spm_flProyekPiutang.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spm_flProyekPiutang";
		this.maximize();
...
window.app_saku3_report_spm_flProyekPiutang.extend(window.childForm);
window.app_saku3_report_spm_flProyekPiutang.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_spm_rptProyekPiutang";
			...
			systemAPI.alert("[app_saku3_report_spm_flProyekPiutang]::mainButtonClick:"+e);
		}
	},
