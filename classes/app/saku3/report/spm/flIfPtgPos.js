window.app_saku3_report_spm_flIfPtgPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spm_flIfPtgPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spm_flIfPtgPos";
		this.maximize();
...
window.app_saku3_report_spm_flIfPtgPos.extend(window.childForm);
window.app_saku3_report_spm_flIfPtgPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_spm_rptIfPtgPos";
			...
			systemAPI.alert("[app_saku3_report_spm_flIfPtgPos]::mainButtonClick:"+e);
		}
	},
