window.app_saku3_report_spm_flFaSaldoTu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spm_flFaSaldoTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spm_flFaSaldoTu";
		this.maximize();
...
window.app_saku3_report_spm_flFaSaldoTu.extend(window.childForm);
window.app_saku3_report_spm_flFaSaldoTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_spm_rptFaSaldoTu";
