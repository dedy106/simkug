// JavaScript Document
window.app_saku3_report_kb_flTitipAju = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kb_flTitipAju.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kb_flTitipAju";
		this.maximize();
...
window.app_saku3_report_kb_flTitipAju.extend(window.portalui_childForm);
window.app_saku3_report_kb_flTitipAju.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_kb_rptTitipAju";
