// JavaScript Document
window.app_saku3_report_kb_flKbSaldoCurr = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kb_flKbSaldoCurr.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kb_flKbSaldoCurr";
		this.maximize();
...
window.app_saku3_report_kb_flKbSaldoCurr.extend(window.portalui_childForm);
window.app_saku3_report_kb_flKbSaldoCurr.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_kb_rptKbSaldoCurr";
				this.dbLib.execQuerySync(this.sql);	
	...
	doOpenBb: function(kode_akun,kode_lokasi){
		...
		filter="where kode_lokasi='"+kode_lokasi+"' and kode_akun='"+kode_akun+"'";
		nama_report="server_report_saku3_kb_rptKbBukuBesarCurr";
