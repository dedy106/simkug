window.app_saku3_report_kb_flKbTbAkunYks = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kb_flKbTbAkunYks.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kb_flKbTbAkunYks";
		this.maximize();
...
window.app_saku3_report_kb_flKbTbAkunYks.extend(window.childForm);
window.app_saku3_report_kb_flKbTbAkunYks.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			if (sender == this.app._mainForm.bBack)
			{
				...
				if (this.link=="3")
				{
					this.doOpenBb(this.kode_bank,this.kode_lokasi,this.periode);
				}
			}
			else
			{
				...
				this.nama_report="server_report_saku3_kb_rptKbTbAkunYks";
	...
	doOpenTb: function(kode_akun,kode_lokasi,periode){
		...
		nama_report="server_report_saku3_kb_rptKbTbYks";
	...
	doOpenBb: function(kode_bank,kode_lokasi,periode){
		...
		var var_periode=" and a.periode='"+periode+"'";
		filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.app._nikUser+"/"+"Tidak/"+var_periode;
		filter="where a.kode_lokasi='"+kode_lokasi+"' and a.kode_bank='"+kode_bank+"' ";
