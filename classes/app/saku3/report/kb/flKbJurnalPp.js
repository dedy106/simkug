// JavaScript Document
window.app_saku3_report_kb_flKbJurnalPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kb_flKbJurnalPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kb_flKbJurnalPp";
		this.maximize();
...
window.app_saku3_report_kb_flKbJurnalPp.extend(window.portalui_childForm);
window.app_saku3_report_kb_flKbJurnalPp.implement({
