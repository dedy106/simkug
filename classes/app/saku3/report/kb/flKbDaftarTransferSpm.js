// JavaScript Document
window.app_saku3_report_kb_flKbDaftarTransferSpm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kb_flKbDaftarTransferSpm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kb_flKbDaftarTransferSpm";
		this.maximize();
...
window.app_saku3_report_kb_flKbDaftarTransferSpm.extend(window.portalui_childForm);
window.app_saku3_report_kb_flKbDaftarTransferSpm.implement({
