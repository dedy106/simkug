// JavaScript Document
window.app_saku3_report_kb_flKbSaldoTk = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kb_flKbSaldoTk.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kb_flKbSaldoTk";
		this.maximize();
...
window.app_saku3_report_kb_flKbSaldoTk.extend(window.portalui_childForm);
window.app_saku3_report_kb_flKbSaldoTk.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_kb_rptKbSaldoTk";
				this.dbLib.execQuerySync(this.sql);	
	...
	doOpenBb: function(kode_akun,kode_lokasi,periode,kode_pp){
		...
		nama_report="server_report_saku3_kb_rptKbBukuBesarTk";
