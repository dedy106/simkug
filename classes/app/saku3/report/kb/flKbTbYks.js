window.app_saku3_report_kb_flKbTbYks = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kb_flKbTbYks.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kb_flKbTbYks";
		this.maximize();
...
window.app_saku3_report_kb_flKbTbYks.extend(window.childForm);
window.app_saku3_report_kb_flKbTbYks.implement({
		...
		try{			
			...
			if (row == 5)
			{
				this.filterRep.ListDataSGFilter(this, "Data Akun",this.sg1, this.sg1.row, this.sg1.col,
													...
													"where a.block= '0' and b.kode_flag in ('001','009') "+
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5],["123","123","13","123","123","123"]);
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5],[2,0,0,2,2,2]);	
		if (row == 1)
		{
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.app._nikUser+"/"+this.sg1.getCell(2,3);
				this.nama_report="server_report_saku3_kb_rptKbTbYks";
	...
	doOpenBb: function(kode_akun,kode_lokasi,periode){
		...
		filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.app._nikUser+"/"+"Tidak/"+var_periode;
		filter="where a.kode_lokasi='"+kode_lokasi+"' and a.kode_bank='"+kode_akun+"' ";
		nama_report="server_report_saku3_kb_rptKbBukuBesarYks";
