window.app_saku3_report_kb_flTitipPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kb_flTitipPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kb_flTitipPos";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from it_aju_m where kode_lokasi='"+this.app._lokasi+"' and form='TITIP'");
...
window.app_saku3_report_kb_flTitipPos.extend(window.childForm);
window.app_saku3_report_kb_flTitipPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_kb_rptTitipPos";
			...
			systemAPI.alert("[app_saku3_report_kb_flTitipPos]::mainButtonClick:"+e);
		}
	},
