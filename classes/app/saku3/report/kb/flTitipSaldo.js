// JavaScript Document
window.app_saku3_report_kb_flTitipSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kb_flTitipSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kb_flTitipSaldo";
		this.maximize();
...
window.app_saku3_report_kb_flTitipSaldo.extend(window.portalui_childForm);
window.app_saku3_report_kb_flTitipSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_kb_rptTitipSaldo";
