window.app_saku3_report_kb_flKbBukuBankYks = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kb_flKbBukuBankYks.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kb_flKbBukuBankYks";
		this.maximize();
...
window.app_saku3_report_kb_flKbBukuBankYks.extend(window.childForm);
window.app_saku3_report_kb_flKbBukuBankYks.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_kb_rptKbBukuBankYks";
