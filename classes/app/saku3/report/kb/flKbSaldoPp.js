// JavaScript Document
window.app_saku3_report_kb_flKbSaldoPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kb_flKbSaldoPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kb_flKbSaldoPp";
		this.maximize();
...
window.app_saku3_report_kb_flKbSaldoPp.extend(window.portalui_childForm);
window.app_saku3_report_kb_flKbSaldoPp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_kb_rptKbSaldoPp";
				this.dbLib.execQuerySync(this.sql);	
	...
	doOpenBb: function(kode_akun,kode_lokasi,periode,kode_pp){
		...
		nama_report="server_report_saku3_kb_rptKbBukuBesarPp";
	...
	doOpenJurnal: function(no_bukti,kode_lokasi){
		...
		filter2="";
		nama_report="server_report_saku3_kb_rptKbJurnalBukti";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
