// JavaScript Document
window.app_saku3_report_kb_flKbBukti = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kb_flKbBukti.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kb_flKbBukti";
		this.maximize();
...
window.app_saku3_report_kb_flKbBukti.extend(window.portalui_childForm);
window.app_saku3_report_kb_flKbBukti.implement({
