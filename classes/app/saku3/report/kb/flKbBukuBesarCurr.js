...
//* 			SAI, PT											
//***********************************************************************************************
window.app_saku3_report_kb_flKbBukuBesarCurr = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kb_flKbBukuBesarCurr.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kb_flKbBukuBesarCurr";
		this.maximize();
...
window.app_saku3_report_kb_flKbBukuBesarCurr.extend(window.portalui_childForm);
window.app_saku3_report_kb_flKbBukuBesarCurr.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_kb_rptKbBukuBesarCurr";
