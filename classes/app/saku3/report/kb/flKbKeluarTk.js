// JavaScript Document
window.app_saku3_report_kb_flKbKeluarTk = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kb_flKbKeluarTk.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kb_flKbKeluarTk";
		this.maximize();
...
window.app_saku3_report_kb_flKbKeluarTk.extend(window.portalui_childForm);
window.app_saku3_report_kb_flKbKeluarTk.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_kb_rptKbKeluarTk";
				this.dbLib.execQuerySync(this.sql);	
