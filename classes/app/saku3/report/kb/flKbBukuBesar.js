...
//* 			SAI, PT											
//***********************************************************************************************
window.app_saku3_report_kb_flKbBukuBesar = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kb_flKbBukuBesar.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kb_flKbBukuBesar";
		this.maximize();
...
window.app_saku3_report_kb_flKbBukuBesar.extend(window.portalui_childForm);
window.app_saku3_report_kb_flKbBukuBesar.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_kb_rptKbBukuBesar";
