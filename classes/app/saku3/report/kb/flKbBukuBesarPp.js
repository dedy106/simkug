...
//* 			SAI, PT											
//***********************************************************************************************
window.app_saku3_report_kb_flKbBukuBesarPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kb_flKbBukuBesarPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kb_flKbBukuBesarPp";
		this.maximize();
...
window.app_saku3_report_kb_flKbBukuBesarPp.extend(window.portalui_childForm);
window.app_saku3_report_kb_flKbBukuBesarPp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_kb_rptKbBukuBesarPp";
