// JavaScript Document
window.app_saku3_report_kb_flKbJurnalYks = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kb_flKbJurnalYks.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kb_flKbJurnalYks";
		this.maximize();
...
window.app_saku3_report_kb_flKbJurnalYks.extend(window.portalui_childForm);
window.app_saku3_report_kb_flKbJurnalYks.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_kb_rptKbJurnalYks";
