window.app_saku3_report_kb_flKbDaftarTransfer = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kb_flKbDaftarTransfer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kb_flKbDaftarTransfer";
		this.maximize();
...
window.app_saku3_report_kb_flKbDaftarTransfer.extend(window.childForm);
window.app_saku3_report_kb_flKbDaftarTransfer.implement({
		...
		try{			
			...
			if (row == 4)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Rekening",this.sg1, this.sg1.row, this.sg1.col,
														  ...
														  new Array("kode_rek","keterangan"),"and");
			}
			...
			if (row == 5)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Akun",this.sg1, this.sg1.row, this.sg1.col,
														  "select a.no_kas,a.keterangan  from kas_m a  "+filter ,
														  "select count(a.no_kas) from kas_m a "+filter,
														  new Array("a.no_kas","a.keterangan"),"and");			}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_kb_rptKbDaftarTransfer";
	...
	doOpenJurnal: function(no_bukti,kode_lokasi){
		...
		filter2="";
		nama_report="server_report_saku2_kopeg_sju_rptGlJurnalBukti";
