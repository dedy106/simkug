window.app_saku3_report_sppd_flJab = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sppd_flJab.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sppd_flJab";
		this.maximize();
...
window.app_saku3_report_sppd_flJab.extend(window.childForm);
window.app_saku3_report_sppd_flJab.implement({
		...
		try{			
			...
			if (row ==1)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Jabatan",this.sg1, this.sg1.row, this.sg1.col,
									"select kode_jab, nama from sp_jab "+this.filter,
									"select count(*) from sp_jab "+this.filter,
									new Array("kode_jab","nama"),"and",new Array("Kode","Nama"));
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_sppd_rptJab";
