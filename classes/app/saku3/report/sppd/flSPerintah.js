window.app_saku3_report_sppd_flSPerintah = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sppd_flSPerintah.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sppd_flSPerintah";
		this.maximize();
...
window.app_saku3_report_sppd_flSPerintah.extend(window.childForm);
window.app_saku3_report_sppd_flSPerintah.implement({
