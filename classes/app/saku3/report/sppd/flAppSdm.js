window.app_saku3_report_sppd_flAppSdm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sppd_flAppSdm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sppd_flAppSdm";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("No PD","All",""));
...
window.app_saku3_report_sppd_flAppSdm.extend(window.childForm);
window.app_saku3_report_sppd_flAppSdm.implement({
		...
		try{			
			...
			if (row ==	1)
			{
				this.filterRep.ListDataSGFilter(this, "Data App",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_spj, b.keterangan from sp_spj_m a inner join sp_perintah_m b on a.no_perintah = b.no_perintah and a.kode_lokasi=b.kode_lokasi where a.nik_app1='"+this.app._userLog+"' and a.progress in ('3','S') ",
												"select count(*) from sp_spj_m a where a.nik_app1='"+this.app._userLog+"' and a.progress in ('3','S') ",
												new Array("a.no_spj","b.keterangan"),"where",new Array("a.no_spj","b.keterangan"));
			}
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.no_spj",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							" and a.nik_app1='"+this.app._userLog+"' ";
			...
			systemAPI.alert("[app_saku3_report_sppd_flAppSdm]::mainButtonClick:"+e);
		}
	},
