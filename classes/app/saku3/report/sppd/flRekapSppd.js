window.app_saku3_report_sppd_flRekapSppd = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sppd_flRekapSppd.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sppd_flRekapSppd";
		this.maximize();
...
window.app_saku3_report_sppd_flRekapSppd.extend(window.childForm);
window.app_saku3_report_sppd_flRekapSppd.implement({
		...
		try{			
			...
			if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Karyawan",this.sg1, this.sg1.row, this.sg1.col,
												"select a.nik, a.nama from karyawan a "+this.filter,
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_sppd_rptRekapSppd";
			...
			systemAPI.alert("[app_saku3_report_sppd_flRekapSppd]::mainButtonClick:"+e);
		}
	},
