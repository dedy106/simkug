window.app_saku3_report_sppd_flJenisPD = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sppd_flJenisPD.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sppd_flJenisPD";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Jenis Parameter B. Transportasi", 2);
...
window.app_saku3_report_sppd_flJenisPD.extend(window.childForm);
window.app_saku3_report_sppd_flJenisPD.implement({
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1],["3","1"]); //123, 123 untuk setting =, range, all	
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
                ...
                this.filterRep.filterStr("kode_jenis",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");

							  this.showFilter = this.filterRep.showFilter(this.sg1);
				this.nama_report = "server_report_saku3_sppd_rptJenisPD";
