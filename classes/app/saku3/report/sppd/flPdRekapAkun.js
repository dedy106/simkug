window.app_saku3_report_sppd_flPdRekapAkun = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sppd_flPdRekapAkun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sppd_flPdRekapAkun";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Bentuk Laporan","=","PP"));
...
window.app_saku3_report_sppd_flPdRekapAkun.extend(window.childForm);
window.app_saku3_report_sppd_flPdRekapAkun.implement({
		...
		try{			
			...
			if (row ==2)
			{
				...
				var sql2="select count(a.kode_akun) "+
						...
						"			from it_aju_m a "+filter+
						"			group by a.kode_akun,a.kode_lokasi "+
						"			)b on a.nik=b.kode_akun and a.kode_lokasi=b.kode_lokasi "+filter;
				this.filterRep.ListDataSGFilter(this, "Data Karyawan",this.sg1, this.sg1.row, this.sg1.col,sql,sql2,
												new Array("a.kode_akun","a.nama"),"where",new Array("Kode Akun","Nama"));
			}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				if (this.sg1.getCell(2,3)=="PP")
				{
					this.nama_report = "server_report_saku3_sppd_rptPdRekapAkun";
				}
				if (this.sg1.getCell(2,3)=="Unit")
				{
					this.nama_report = "server_report_saku3_sppd_rptPdRekapUnit";
			...
			systemAPI.alert("[app_saku3_report_sppd_flPdRekapAkun]::mainButtonClick:"+e);
		}
	},
