window.app_saku3_report_sppd_flGrade = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sppd_flGrade.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sppd_flGrade";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Grade", 2);
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Grade","All",""));
	
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_sppd_flGrade.extend(window.childForm);
window.app_saku3_report_sppd_flGrade.implement({
		...
		try{			
			...
			if (row ==1)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Grade",this.sg1, this.sg1.row, this.sg1.col,
									"select kode_band, kode_lokasi from sp_grade "+this.filter,
									"select count(*) from sp_grade "+this.filter,
									new Array("kode_band","kode_lokasi"),"and",new Array("Kode Band","Lokasi"));
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1],["3","123"]);//123, 123 untuk setting =, range, all	
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							  this.filterRep.filterStr("kode_band",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");

							  this.showFilter = this.filterRep.showFilter(this.sg1);
				this.nama_report = "server_report_saku3_sppd_rptGrade";
