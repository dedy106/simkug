window.app_saku3_report_sppd_flRole = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sppd_flRole.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sppd_flRole";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Role Approval", 2);
...
window.app_saku3_report_sppd_flRole.extend(window.childForm);
window.app_saku3_report_sppd_flRole.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			if (row ==0)
			{
				this.filterRep.ListDataSGFilter(this, "Data Lokasi",this.sg1, this.sg1.row, this.sg1.col,
												"select kode_lokasi, nik from sp_role",
												"select count(*) from sp_role",
												new Array("kode_lokasi","nik"),"where",new Array("Kode","Nama"));
			}
			if (row ==1)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Role",this.sg1, this.sg1.row, this.sg1.col,
									"select a.nik, b.nama from sp_role a join karyawan b on a.nik=b.nik "+this.filter,
									"select count(a.nik) from sp_role a join karyawan b on a.nik=b.nik "+this.filter,
									new Array("a.nik","b.nama"),"and",new Array("Nik","Nama"));
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_sppd_rptRole";
