window.app_saku3_report_sppd_flSppdPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sppd_flSppdPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sppd_flSppdPos";
		this.maximize();
...
window.app_saku3_report_sppd_flSppdPos.extend(window.childForm);
window.app_saku3_report_sppd_flSppdPos.implement({
		...
		try{			
			...
			if (row ==3)
			{
				this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							" and a.modul='UMUM' and a.form='SPPD'";
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_sppd_rptSppdPos";
			...
			systemAPI.alert("[app_saku3_report_sppd_flSppdPos]::mainButtonClick:"+e);
		}
	},
