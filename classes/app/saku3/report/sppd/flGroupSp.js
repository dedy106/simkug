window.app_saku3_report_sppd_flGroupSp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sppd_flGroupSp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sppd_flGroupSp";
		this.maximize();
...
window.app_saku3_report_sppd_flGroupSp.extend(window.childForm);
window.app_saku3_report_sppd_flGroupSp.implement({
		...
		try{			
			...
			if (row == 3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Surat Perintah",this.sg1, this.sg1.row, this.sg1.col,
									"select a.no_perintah, keterangan from sp_perintah_m a "+this.filter,
									"select count(*) from sp_perintah_m a "+this.filter,
									new Array("a.no_perintah","keterangan"),"and",new Array("Kode","Keterangan"));
			}
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("a.kode_pp",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
							this.filterRep.filterStr("a.no_perintah",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and");
				this.filter2 = this.sg1.getCell(2,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_sppd_rptGroupSp";
