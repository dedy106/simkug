window.app_saku3_report_sppd_flKaryawan = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sppd_flKaryawan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sppd_flKaryawan";
		this.maximize();
		...
		this.sg1 = new saiGrid(this.p1,{bound:[1,20,700,177],colCount:4,cellExit:[this,"doCellExit"],
				...
				colWidth:[[0,2,3],[250,150,150]],colTitle:["Filter","Type","From","To"], 
...
window.app_saku3_report_sppd_flKaryawan.extend(window.childForm);
window.app_saku3_report_sppd_flKaryawan.implement({
		...
		try{
			...
			if (row ==1)
			{
								this.filterRep.ListDataSGFilter(this, "Data PP",this.sg1, this.sg1.row, this.sg1.col,
														  "select distinct b.kode_pp as kd, (b.nama) as pp from karyawan a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi"+
														   this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(2,0)," where "),
														  "select count(b.kode_pp) from karyawan a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi"+
														  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(2,0)," where "),
														  ["b.kode_pp","b.nama"],"and",["Kode","PP"]);
			...
			if (row ==2)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Kode Karyawan",this.sg1, this.sg1.row, this.sg1.col,
									"select nik, nama from karyawan "+this.filter,
									"select count(*) from karyawan "+this.filter,
									new Array("nik","nama"),"and",new Array("Nik","Nama"));
			}				
		}catch(e){
			systemAPI.alert(e);
		}
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3],["3","123","123","123"]);//123, 123 untuk setting =, range, all	
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("PP","=",""));
			}else{
				...
				this.nama_report = "server_report_saku3_sppd_rptKaryawan";
