window.app_saku3_report_sppd_flRekapSppdPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sppd_flRekapSppdPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sppd_flRekapSppdPp";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Bentuk Laporan","=","PP"));
...
window.app_saku3_report_sppd_flRekapSppdPp.extend(window.childForm);
window.app_saku3_report_sppd_flRekapSppdPp.implement({
	...
	{		
		...
		else
		{
			...
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3],[3,0,0,0,1]);
		}	
		if (row == 1)
		{
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("PP","Unit"));
		}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				if (this.sg1.getCell(2,2)=="PP")
				{
					this.nama_report = "server_report_saku3_sppd_rptRekapSppdUn";
				}
				if (this.sg1.getCell(2,2)=="Unit")
				{
					this.nama_report = "server_report_saku3_sppd_rptRekapSppdPp";
			...
			systemAPI.alert("[app_saku3_report_sppd_flRekapSppdPp]::mainButtonClick:"+e);
		}
	},
