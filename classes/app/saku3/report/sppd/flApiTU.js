window.app_saku3_report_sppd_flApiTU = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sppd_flApiTU.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sppd_flApiTU";
        this.maximize();
...
window.app_saku3_report_sppd_flApiTU.extend(window.childForm);
window.app_saku3_report_sppd_flApiTU.implement({
	doLoad:function(){
        try{
            uses("saiCBBL;saiEdit;saiGrid;sgNavigator;app_saku3_dashboard;pageControl;util_ajaxCaller;listView;util_file;app_lab_remote_dataProvider;tinymceCtrl;reportViewer;server_report_report;server_util_Map;webBrowser");
			...
			this.report = new server_report_report();
			var nama_report="server_report_saku3_sppd_vApiTU";
			this.filter="";
			this.showFilter = "";
			this.lokasi = "";
