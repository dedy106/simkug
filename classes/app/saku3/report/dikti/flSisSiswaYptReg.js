window.app_saku3_report_dikti_flSisSiswaYptReg = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dikti_flSisSiswaYptReg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dikti_flSisSiswaYptReg";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("No Registrasi","All",""));
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Output Laporan","=","Layar"));
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_dikti_flSisSiswaYptReg.extend(window.childForm);
window.app_saku3_report_dikti_flSisSiswaYptReg.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_dikti_rptSisSiswaYptReg";
