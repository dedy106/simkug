window.app_saku3_report_dikti_flSisPindah = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dikti_flSisPindah.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dikti_flSisPindah";
		this.maximize();
...
window.app_saku3_report_dikti_flSisPindah.extend(window.childForm);
window.app_saku3_report_dikti_flSisPindah.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_dikti_rptSisPindah";
			...
			systemAPI.alert("[app_saku3_report_dikti_flSisPindah]::mainButtonClick:"+e);
		}
	},
