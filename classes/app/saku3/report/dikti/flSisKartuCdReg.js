window.app_saku3_report_dikti_flSisKartuCdReg = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dikti_flSisKartuCdReg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dikti_flSisKartuCdReg";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("ID Reg","All",""));
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Output Laporan","=","Layar"));
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_dikti_flSisKartuCdReg.extend(window.childForm);
window.app_saku3_report_dikti_flSisKartuCdReg.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_dikti_rptSisKartuCdReg";
