window.app_saku3_report_dikti_flSisSaldoSiswaPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dikti_flSisSaldoSiswaPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dikti_flSisSaldoSiswaPp";
		this.maximize();
...
window.app_saku3_report_dikti_flSisSaldoSiswaPp.extend(window.childForm);
window.app_saku3_report_dikti_flSisSaldoSiswaPp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_dikti_rptSisSaldoSiswaPp";
