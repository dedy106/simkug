window.app_saku3_report_dikti_flSisRekonYpt = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dikti_flSisRekonYpt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dikti_flSisRekonYpt";
		this.maximize();
...
window.app_saku3_report_dikti_flSisRekonYpt.extend(window.childForm);
window.app_saku3_report_dikti_flSisRekonYpt.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_dikti_rptSisRekonYpt";
