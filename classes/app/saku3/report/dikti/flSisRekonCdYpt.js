window.app_saku3_report_dikti_flSisRekonCdYpt = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dikti_flSisRekonCdYpt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dikti_flSisRekonCdYpt";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from trans_m where form in ('MHSREKON','REKONCD','MHSNONKAS') and kode_lokasi='"+this.app._lokasi+"' ");
...
window.app_saku3_report_dikti_flSisRekonCdYpt.extend(window.childForm);
window.app_saku3_report_dikti_flSisRekonCdYpt.implement({
		...
		try{			
			...
			if (row ==5)
			{
				this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							"and a.form in ('MHSREKON','REKONCD','MHSNONKAS') ";
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6,7],["3","123","123","123","123","123","3"]);
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5,6,7],[2,2,2,2,2,2,0]);	
		if (row == 1)
		{
			this.sg1.columns.get(2).pickList.clear();
			this.dbLib.setItemsFromSQL("select distinct periode from trans_m where modul in ('MHSREKON','REKONCD','MHSNONKAS') and kode_lokasi='"+this.app._lokasi+"' order by periode",[this.sg1.columns.get(2).pickList]);
		}
		if (row == 6)
		{
			this.sg1.columns.get(2).pickList.clear();
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_dikti_rptSisRekonCdYpt";
