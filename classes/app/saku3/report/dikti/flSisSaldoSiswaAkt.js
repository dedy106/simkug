window.app_saku3_report_dikti_flSisSaldoSiswaAkt = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dikti_flSisSaldoSiswaAkt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dikti_flSisSaldoSiswaAkt";
		this.maximize();
...
window.app_saku3_report_dikti_flSisSaldoSiswaAkt.extend(window.childForm);
window.app_saku3_report_dikti_flSisSaldoSiswaAkt.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_dikti_rptSisSaldoSiswaAkt";
