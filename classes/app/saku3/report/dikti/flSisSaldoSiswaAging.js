window.app_saku3_report_dikti_flSisSaldoSiswaAging = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dikti_flSisSaldoSiswaAging.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dikti_flSisSaldoSiswaAging";
		this.maximize();
...
window.app_saku3_report_dikti_flSisSaldoSiswaAging.extend(window.childForm);
window.app_saku3_report_dikti_flSisSaldoSiswaAging.implement({
