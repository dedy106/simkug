window.app_saku3_report_dikti_flSisSaldoSiswaJur = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dikti_flSisSaldoSiswaJur.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dikti_flSisSaldoSiswaJur";
		this.maximize();
...
window.app_saku3_report_dikti_flSisSaldoSiswaJur.extend(window.childForm);
window.app_saku3_report_dikti_flSisSaldoSiswaJur.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_dikti_rptSisSaldoSiswaJur";
