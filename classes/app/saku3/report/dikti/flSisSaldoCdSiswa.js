window.app_saku3_report_dikti_flSisSaldoCdSiswa = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dikti_flSisSaldoCdSiswa.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dikti_flSisSaldoCdSiswa";
		this.maximize();
...
window.app_saku3_report_dikti_flSisSaldoCdSiswa.extend(window.childForm);
window.app_saku3_report_dikti_flSisSaldoCdSiswa.implement({
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6,7],["3","3","123","123","123","123","13","3"]);
		...
		try
		{
			...
			else
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("f.kode_jur",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
				...
				this.nama_report = "server_report_saku3_dikti_rptSisSaldoCdSiswa";
