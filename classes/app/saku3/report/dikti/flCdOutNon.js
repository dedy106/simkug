window.app_saku3_report_dikti_flCdOutNon = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dikti_flCdOutNon.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dikti_flCdOutNon";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from trans_m where kode_lokasi='"+this.app._lokasi+"' and form='JUCDOUT' ");
...
window.app_saku3_report_dikti_flCdOutNon.extend(window.childForm);
window.app_saku3_report_dikti_flCdOutNon.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_dikti_rptCdOutNon";
