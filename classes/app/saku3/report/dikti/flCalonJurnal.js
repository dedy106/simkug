window.app_saku3_report_dikti_flCalonJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dikti_flCalonJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dikti_flCalonJurnal";
		this.maximize();
...
window.app_saku3_report_dikti_flCalonJurnal.extend(window.childForm);
window.app_saku3_report_dikti_flCalonJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_dikti_rptCalonJurnal";
