window.app_saku3_report_dikti_flSisTarif = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dikti_flSisTarif.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dikti_flSisTarif";
		this.maximize();
...
window.app_saku3_report_dikti_flSisTarif.extend(window.childForm);
window.app_saku3_report_dikti_flSisTarif.implement({
	...
	{		
		...
		{
			var filter=this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where");
			var sql="select distinct a.periode from sis_bill_d a "+filter+" order by a.periode desc"
