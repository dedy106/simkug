window.app_saku3_report_dikti_flSisJurnalRekonYptNon = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dikti_flSisJurnalRekonYptNon.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dikti_flSisJurnalRekonYptNon";
		this.maximize();
...
window.app_saku3_report_dikti_flSisJurnalRekonYptNon.extend(window.childForm);
window.app_saku3_report_dikti_flSisJurnalRekonYptNon.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_dikti_rptSisJurnalRekonYptNon";
			...
			systemAPI.alert("[app_saku3_report_dikti_flSisJurnalRekonYptNon]::mainButtonClick:"+e);
		}
	},
