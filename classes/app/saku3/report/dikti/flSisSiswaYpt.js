window.app_saku3_report_dikti_flSisSiswaYpt = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dikti_flSisSiswaYpt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dikti_flSisSiswaYpt";
		this.maximize();
...
window.app_saku3_report_dikti_flSisSiswaYpt.extend(window.childForm);
window.app_saku3_report_dikti_flSisSiswaYpt.implement({
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.kode_status",this.sg1.getCell(1,5),this.sg1.getCell(2,5),this.sg1.getCell(3,5),"and");
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,6);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				this.nama_report = "server_report_saku3_dikti_rptSisSiswaYpt";
