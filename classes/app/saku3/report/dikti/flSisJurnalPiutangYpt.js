window.app_saku3_report_dikti_flSisJurnalPiutangYpt = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dikti_flSisJurnalPiutangYpt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dikti_flSisJurnalPiutangYpt";
		this.maximize();
...
window.app_saku3_report_dikti_flSisJurnalPiutangYpt.extend(window.childForm);
window.app_saku3_report_dikti_flSisJurnalPiutangYpt.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from trans_m where kode_lokasi='"+this.app._lokasi+"' and form='MHSBILL' order by periode desc",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_dikti_rptSisJurnalPiutangYpt";
			...
			systemAPI.alert("[app_saku3_report_dikti_flSisJurnalPiutangYpt]::mainButtonClick:"+e);
		}
	},
