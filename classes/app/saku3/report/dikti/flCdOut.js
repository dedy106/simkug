window.app_saku3_report_dikti_flCdOut = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dikti_flCdOut.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dikti_flCdOut";
		this.maximize();
...
window.app_saku3_report_dikti_flCdOut.extend(window.childForm);
window.app_saku3_report_dikti_flCdOut.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_dikti_rptCdOut";
			...
			systemAPI.alert("[app_saku3_report_dikti_flCdOut]::mainButtonClick:"+e);
		}
	},
