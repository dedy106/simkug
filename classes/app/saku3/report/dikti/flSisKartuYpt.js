window.app_saku3_report_dikti_flSisKartuYpt = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dikti_flSisKartuYpt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dikti_flSisKartuYpt";
		this.maximize();
...
window.app_saku3_report_dikti_flSisKartuYpt.extend(window.childForm);
window.app_saku3_report_dikti_flSisKartuYpt.implement({
	...
	{		
		...
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5,6,7,8],[2,2,2,2,2,2,2,0,0]);	
		if (row == 1)
		{
			var filter=this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where");
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2 =this.sg1.getCell(2,0)+"/"+this.app._kodePP+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,7);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				
				this.nama_report = "server_report_saku3_dikti_rptSisKartuYpt";
