window.app_saku3_report_dikti_flBayarDaftarSis = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dikti_flBayarDaftarSis.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dikti_flBayarDaftarSis";
		this.maximize();
...
window.app_saku3_report_dikti_flBayarDaftarSis.extend(window.childForm);
window.app_saku3_report_dikti_flBayarDaftarSis.implement({
	...
	{		
		...
		if (row == 2)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct a.periode from dikti_cd a  "+filter+" order by a.periode desc",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}		
	},
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_dikti_rptSisBayarDaftar";
