window.app_saku3_report_dikti_flSisJurnalLunas = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dikti_flSisJurnalLunas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dikti_flSisJurnalLunas";
		this.maximize();
...
window.app_saku3_report_dikti_flSisJurnalLunas.extend(window.childForm);
window.app_saku3_report_dikti_flSisJurnalLunas.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_dikti_flSisJurnalLunas]::mainButtonClick:"+e);
		}
	},
