window.app_saku3_report_logistik_flPesanPosisi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_logistik_flPesanPosisi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_logistik_flPesanPosisi";
		this.maximize();
...
window.app_saku3_report_logistik_flPesanPosisi.extend(window.childForm);
window.app_saku3_report_logistik_flPesanPosisi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_logistik_rptPesanPosisi";
			...
			systemAPI.alert("[app_saku3_report_logistik_flPesanPosisi]::mainButtonClick:"+e);
		}
	},
