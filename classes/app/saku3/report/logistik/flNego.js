window.app_saku3_report_logistik_flNego = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_logistik_flNego.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_logistik_flNego";
		this.maximize();
...
window.app_saku3_report_logistik_flNego.extend(window.childForm);
window.app_saku3_report_logistik_flNego.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_logistik_flNego]::mainButtonClick:"+e);
		}
	},
