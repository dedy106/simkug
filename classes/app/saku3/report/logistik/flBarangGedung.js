window.app_saku3_report_logistik_flBarangGedung = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_logistik_flBarangGedung.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_logistik_flBarangGedung";
		this.maximize();
...
window.app_saku3_report_logistik_flBarangGedung.extend(window.childForm);
window.app_saku3_report_logistik_flBarangGedung.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from log_sph_m where kode_lokasi='"+this.app._lokasi+"' order by periode desc",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_logistik_rptBarangGedung";
			...
			systemAPI.alert("[app_saku3_report_logistik_flBarangGedung]::mainButtonClick:"+e);
		}
	},
	...
	doOpenKartu: function(kode_gedung,kode_lokasi){
		this.kode_gedung=kode_gedung;
		this.kode_lokasi=kode_lokasi;
		this.link="1";
		filter = "where a.kode_gedung='"+kode_gedung+"' and a.kode_lokasi='"+kode_lokasi+"' ";
		filter2=this.sg1.getCell(2,0)+"/Detail";
		nama_report="server_report_saku3_logistik_rptBarangKartu";
