window.app_saku3_report_logistik_flSpk = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_logistik_flSpk.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_logistik_flSpk";
		this.maximize();
...
window.app_saku3_report_logistik_flSpk.extend(window.childForm);
window.app_saku3_report_logistik_flSpk.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_logistik_flSpk]::mainButtonClick:"+e);
		}
	},
