window.app_saku3_report_logistik_flSph = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_logistik_flSph.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_logistik_flSph";
		this.maximize();
...
window.app_saku3_report_logistik_flSph.extend(window.childForm);
window.app_saku3_report_logistik_flSph.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_logistik_flSph]::mainButtonClick:"+e);
		}
	},
