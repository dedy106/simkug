window.app_saku3_report_logistik_flBast = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_logistik_flBast.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_logistik_flBast";
		this.maximize();
...
window.app_saku3_report_logistik_flBast.extend(window.childForm);
window.app_saku3_report_logistik_flBast.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_logistik_flBast]::mainButtonClick:"+e);
		}
	},
