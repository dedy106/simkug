window.app_saku3_report_logistik_flPks = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_logistik_flPks.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_logistik_flPks";
		this.maximize();
...
window.app_saku3_report_logistik_flPks.extend(window.childForm);
window.app_saku3_report_logistik_flPks.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_logistik_flPks]::mainButtonClick:"+e);
		}
	},
