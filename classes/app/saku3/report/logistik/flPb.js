window.app_saku3_report_logistik_flPb = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_logistik_flPb.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_logistik_flPb";
		this.maximize();
...
window.app_saku3_report_logistik_flPb.extend(window.childForm);
window.app_saku3_report_logistik_flPb.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
		    	...
		    	this.filter =  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("a.no_pb",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
			...
			systemAPI.alert("[app_saku3_report_logistik_flPb]::mainButtonClick:"+e);
		}
	},
	...
	doOpenBukti: function(no_bukti,kode_lokasi){
		this.link="1";
		filter = "where a.yk_pb_m='"+no_bukti+"' and a.kode_lokasi='"+kode_lokasi+"' ";
