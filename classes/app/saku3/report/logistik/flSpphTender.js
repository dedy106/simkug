window.app_saku3_report_logistik_flSpphTender = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_logistik_flSpphTender.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_logistik_flSpphTender";
		this.maximize();
...
window.app_saku3_report_logistik_flSpphTender.extend(window.childForm);
window.app_saku3_report_logistik_flSpphTender.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_logistik_rptSpphTender";
			...
			systemAPI.alert("[app_saku3_report_logistik_flSpphTender]::mainButtonClick:"+e);
		}
	},
