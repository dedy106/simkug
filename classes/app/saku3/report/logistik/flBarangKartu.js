window.app_saku3_report_logistik_flBarangKartu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_logistik_flBarangKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_logistik_flBarangKartu";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Kelompok Gedung","All",""));
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Gedung","All",""));
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Jenis","=","Detail"));
...
window.app_saku3_report_logistik_flBarangKartu.extend(window.childForm);
window.app_saku3_report_logistik_flBarangKartu.implement({
		...
		try{			
			...
			if (row ==1)
			{
				this.filterRep.ListDataSGFilter(this, "Data Kelompok Gedung",this.sg1, this.sg1.row, this.sg1.col,
														  "select kode_klp, nama from log_gedung_klp "+
														   this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  "select count(kode_klp) from log_gedung_klp "+
														  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
			...
			if (row ==2)
			{
				this.filterRep.ListDataSGFilter(this, "Data Gedung",this.sg1, this.sg1.row, this.sg1.col,
														  "select kode_gedung, nama from log_gedung "+
														   this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  "select count(kode_gedung) from log_gedung "+
														  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  new Array("kode_gedung","nama"),"and");
			}			
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_logistik_rptBarangKartu";
			...
			systemAPI.alert("[app_saku3_report_logistik_flBarangKartu]::mainButtonClick:"+e);
		}
	},
