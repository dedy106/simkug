window.app_saku3_report_logistik_flPesanTenderPosisi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_logistik_flPesanTenderPosisi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_logistik_flPesanTenderPosisi";
		this.maximize();
...
window.app_saku3_report_logistik_flPesanTenderPosisi.extend(window.childForm);
window.app_saku3_report_logistik_flPesanTenderPosisi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_logistik_rptPesanTenderPosisi";
			...
			systemAPI.alert("[app_saku3_report_logistik_flPesanTenderPosisi]::mainButtonClick:"+e);
		}
	},
