window.app_saku3_report_logistik_flSpph = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_logistik_flSpph.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_logistik_flSpph";
		this.maximize();
...
window.app_saku3_report_logistik_flSpph.extend(window.childForm);
window.app_saku3_report_logistik_flSpph.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_logistik_flSpph]::mainButtonClick:"+e);
		}
	},
