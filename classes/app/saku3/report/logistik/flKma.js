window.app_saku3_report_logistik_flKma = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_logistik_flKma.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_logistik_flKma";
		this.maximize();
...
window.app_saku3_report_logistik_flKma.extend(window.childForm);
window.app_saku3_report_logistik_flKma.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_logistik_rptKma";
			...
			systemAPI.alert("[app_saku3_report_logistik_flKma]::mainButtonClick:"+e);
		}
	},
