window.app_saku3_report_logistik_flAggInv = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_logistik_flAggInv.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_logistik_flAggInv";
		this.maximize();
...
window.app_saku3_report_logistik_flAggInv.extend(window.portalui_childForm);
window.app_saku3_report_logistik_flAggInv.implement({
