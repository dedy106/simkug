window.app_saku3_report_logistik_flVendor = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_logistik_flVendor.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_logistik_flVendor";
		this.maximize();
...
window.app_saku3_report_logistik_flVendor.extend(window.childForm);
window.app_saku3_report_logistik_flVendor.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_logistik_rptVendor";
			...
			systemAPI.alert("[app_saku3_report_logistik_flVendor]::mainButtonClick:"+e);
		}
	},
