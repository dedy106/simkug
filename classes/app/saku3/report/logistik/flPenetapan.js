window.app_saku3_report_logistik_flPenetapan = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_logistik_flPenetapan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_logistik_flPenetapan";
		this.maximize();
...
window.app_saku3_report_logistik_flPenetapan.extend(window.childForm);
window.app_saku3_report_logistik_flPenetapan.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_logistik_flPenetapan]::mainButtonClick:"+e);
		}
	},
