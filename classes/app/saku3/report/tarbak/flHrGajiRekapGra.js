window.app_saku3_report_tarbak_flHrGajiRekapGra = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_flHrGajiRekapGra.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_flHrGajiRekapGra";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,[0,1,2],["Jenis","=","Summary"]);
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_tarbak_flHrGajiRekapGra.extend(window.childForm);
window.app_saku3_report_tarbak_flHrGajiRekapGra.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_saku3_tarbak_rptHrGajiRekapGra";
					if (this.sg1.getCell(2,4)=="Detail")
					{
						this.nama_report = "server_report_saku3_tarbak_rptHrGajiRekapGraDetail";
					}
