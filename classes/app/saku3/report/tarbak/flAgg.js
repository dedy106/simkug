window.app_saku3_report_tarbak_flAgg = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_flAgg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_flAgg";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,5,[0,1,2],["Status Anggaran","=","Berjalan"]);
...
window.app_saku3_report_tarbak_flAgg.extend(window.portalui_childForm);
window.app_saku3_report_tarbak_flAgg.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			var modul="";
			if (this.sg1.getCell(2,5)!="Berjalan")
			{
			...
			this.filter=this.filterRep.filterStr("x.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
						...
						this.filterRep.filterStr("x.kode_akun",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+jenis+modul;
			...
			{			
				this.nama_report="server_report_saku3_tarbak_rptAggTw";
			}
			if (this.sg1.getCell(2,4)=="Semester")
			{
				this.nama_report="server_report_saku3_tarbak_rptAggSem";
			}
			if (this.sg1.getCell(2,4)=="Bulanan")
			{
				this.nama_report="server_report_saku3_tarbak_rptAggBulan";
			}
