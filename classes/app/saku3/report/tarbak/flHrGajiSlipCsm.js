window.app_saku3_report_tarbak_flHrGajiSlipCsm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_flHrGajiSlipCsm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_flHrGajiSlipCsm";
		this.maximize();
...
window.app_saku3_report_tarbak_flHrGajiSlipCsm.extend(window.childForm);
window.app_saku3_report_tarbak_flHrGajiSlipCsm.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_saku3_tarbak_rptHrGajiSlipCsm";
