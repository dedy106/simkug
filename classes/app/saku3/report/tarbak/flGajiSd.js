window.  app_saku3_report_tarbak_flGajiSd = function(owner)
{
	if (owner)
	{
		window.  app_saku3_report_tarbak_flGajiSd.prototype.parent.constructor.call(this,owner);
		this.className = "  app_saku3_report_tarbak_flGajiSd";
		this.maximize();
...
window.  app_saku3_report_tarbak_flGajiSd.extend(window.childForm);
window.  app_saku3_report_tarbak_flGajiSd.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				{
					this.nama_report="server_report_saku3_tarbak_rptGajiSd1";
				}
				else
				{
					this.nama_report="server_report_saku3_tarbak_rptGajiSd2";
				}	
