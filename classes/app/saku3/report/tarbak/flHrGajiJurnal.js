window.app_saku3_report_tarbak_flHrGajiJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_flHrGajiJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_flHrGajiJurnal";
		this.maximize();
...
window.app_saku3_report_tarbak_flHrGajiJurnal.extend(window.childForm);
window.app_saku3_report_tarbak_flHrGajiJurnal.implement({
		...
		try{			
			...
			if (row == 2)
			{
				this.filterRep.ListDataSGFilter(this, "Data Jurnal",this.sg1, this.sg1.row, this.sg1.col,
													"select a.no_gaji, a.nama from hr_gaji_m a ",
													"select count(*) from hr_gaji_m a ",
													["a.no_gaji","a.nama"],"and",["NIK","Nama"], false, this.sg1.cells(1,row) == "in");
			}	
			...
			else
			{
				...
				else
				{
					...
					this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
								...
								this.filterRep.filterStr("a.no_gaji",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
						
					this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/";
					this.showFilter = this.filterRep.showFilter(this.sg1);
					var result  = new arrayMap();		
					this.lokasi=this.app._namalokasi;
					this.nama_report = "server_report_saku3_tarbak_rptHrGajiJurnal";
