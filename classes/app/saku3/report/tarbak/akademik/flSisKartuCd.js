window.app_saku3_report_tarbak_akademik_flSisKartuCd = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_akademik_flSisKartuCd.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_akademik_flSisKartuCd";
		this.maximize();
...
window.app_saku3_report_tarbak_akademik_flSisKartuCd.extend(window.childForm);
window.app_saku3_report_tarbak_akademik_flSisKartuCd.implement({
		...
		try
		{
			...
			else
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.kode_pp",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							//this.filterRep.filterStr("g.periode",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
				...
				this.filter3 =this.filterRep.filterStr("a.periode",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
				...
				this.nama_report = "server_report_saku3_tarbak_akademik_rptSisKartuCd";
	...
	doOpenBill: function(no_bukti,kode_lokasi,kode_pp,modul){
		...
		if (modul=="loadsiskb")
		{
			filter="where a.no_bukti='"+no_bukti+"' and a.kode_lokasi='"+kode_lokasi+"' and a.kode_pp='"+kode_pp+"'";
			nama_report="server_report_saku3_tarbak_akademik_rptSisPindah2";
		}
		else
		{
			filter="where a.no_bukti='"+no_bukti+"' and a.kode_lokasi='"+kode_lokasi+"' and a.kode_pp='"+kode_pp+"'";
