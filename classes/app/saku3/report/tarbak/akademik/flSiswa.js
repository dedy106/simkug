window.app_saku3_report_siswa_flSiswa = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSiswa.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSiswa";
		this.maximize();
...
window.app_saku3_report_siswa_flSiswa.extend(window.childForm);
window.app_saku3_report_siswa_flSiswa.implement({
...
||||||| .r10086
				...
				this.filterRep.ListDataSGFilter(this, "Data Angkatan",this.sg1, this.sg1.row, this.sg1.col,
												...
												new Array("a.kode_akt","a.sis_angkat"),"and",new Array("No Bukti","Keterangan"));				
=======
...
<<<<<<< .mine
				...
				this.filterRep.ListDataSGFilter(this, "Data Kelas",this.sg1, this.sg1.row, this.sg1.col,
												...
												new Array("a.kode_kelas","a.nama"),"and",new Array("Kode","Keterangan"));				
||||||| .r10086
							this.filterRep.filterStr("a.kode_pp",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4),"and");
				this.filterRep.ListDataSGFilter(this, "Data Tingkat",this.sg1, this.sg1.row, this.sg1.col,
												...
												new Array("a.kode_tingkat","a.nama"),"and",new Array("Kode","Keterangan"));				
=======
						this.filterRep.filterStr("a.kode_pp",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");
				this.filterRep.ListDataSGFilter(this, "Data Tingkat",this.sg1, this.sg1.row, this.sg1.col,
												"select a.kode_tingkat, a.nama from sis_tingkat a "+filter,
...
||||||| .r10086
							  this.filterRep.filterStr("a.kode_akt",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							  this.filterRep.filterStr("a.kode_kelas",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
...
>>>>>>> .r11624
				...
				this.nama_report = "server_report_saku3_siswa_rptSiswa";
