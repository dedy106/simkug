window.app_saku3_report_siswa_flSisSiswa = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisSiswa.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisSiswa";
		this.maximize();
...
window.app_saku3_report_siswa_flSisSiswa.extend(window.childForm);
window.app_saku3_report_siswa_flSisSiswa.implement({
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.kode_tingkat",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("a.nis",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and");
				this.showFilter = this.filterRep.showFilter(this.sg1);
				this.nama_report = "server_report_saku3_siswa_rptSisSiswa";
