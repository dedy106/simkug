window.app_saku3_report_siswa_flTingkat = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flTingkat.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flTingkat";
		this.maximize();
...
window.app_saku3_report_siswa_flTingkat.extend(window.childForm);
window.app_saku3_report_siswa_flTingkat.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siswa_rptTingkat";
