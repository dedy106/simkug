window.app_saku3_report_tarbak_akademik_flSisKartu2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_akademik_flSisKartu2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_akademik_flSisKartu2";
		this.maximize();
...
window.app_saku3_report_tarbak_akademik_flSisKartu2.extend(window.childForm);
window.app_saku3_report_tarbak_akademik_flSisKartu2.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			if (sender == this.app._mainForm.bBack)
			{
				...
				{
					this.doOpenBill(this.nis,this.no_bill,this.kode_lokasi,this.kode_pp);					
					
				}if (this.link=="3")
				{
					this.doOpenBill2(this.nis,this.no_bill,this.kode_lokasi,this.kode_pp);					
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tarbak_akademik_rptSisKartu2";
	...
	doOpenKartu: function(nis,kode_lokasi,kode_pp){
		...
		nama_report="server_report_saku3_tarbak_akademik_rptSisNis";
		...
		doOpenBill: function(nis,no_bill,kode_lokasi,kode_pp){
		...
		this.kode_pp=kode_pp;
		this.link="2";
		filter = "where a.nis='"+nis+"' and b.no_bill='"+no_bill+"' and a.kode_lokasi='"+kode_lokasi+"' and a.kode_pp='"+kode_pp+"'";
		filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,2);
		nama_report="server_report_saku3_tarbak_akademik_rptSisBill2";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
