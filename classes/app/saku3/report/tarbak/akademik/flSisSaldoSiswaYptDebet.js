window.app_saku3_report_tarbak_akademik_flSisSaldoSiswaYptDebet = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_akademik_flSisSaldoSiswaYptDebet.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_akademik_flSisSaldoSiswaYptDebet";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,7,new Array(0,1,2), new Array("Status Siswa","All",""));
	this.gridLib.SGEditData(this.sg1,8,new Array(0,1,2), new Array("Output Laporan","=","Layar"));
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_tarbak_akademik_flSisSaldoSiswaYptDebet.extend(window.childForm);
window.app_saku3_report_tarbak_akademik_flSisSaldoSiswaYptDebet.implement({
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6,7,8],["3","23","3","123","123","123","123","13","3"]);
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5,6,7,8],[2,2,0,2,2,2,2,0,0]);	
		if (row == 2)
		{
			var filter=this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
						this.filterRep.filterStr("a.kode_pp",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and"); 
		...
		try
		{
			...
			else
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.flag_aktif",this.sg1.getCell(1,7),this.sg1.getCell(2,7).substr(0,1),this.sg1.getCell(3,7).substr(0,1),"and");
				...
				this.nama_report = "server_report_saku3_tarbak_akademik_rptSisSaldoSiswaYptDebet";
