window.app_saku3_report_tarbak_akademik_flRekapPiuTw = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_akademik_flRekapPiuTw.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_akademik_flRekapPiuTw";
		this.maximize();
...
window.app_saku3_report_tarbak_akademik_flRekapPiuTw.extend(window.childForm);
window.app_saku3_report_tarbak_akademik_flRekapPiuTw.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tarbak_akademik_rptRekapPiuTw";
