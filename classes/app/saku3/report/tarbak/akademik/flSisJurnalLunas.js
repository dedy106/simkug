window.app_saku3_report_tarbak_akademik_flSisJurnalLunas = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_akademik_flSisJurnalLunas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_akademik_flSisJurnalLunas";
		this.maximize();
...
window.app_saku3_report_tarbak_akademik_flSisJurnalLunas.extend(window.childForm);
window.app_saku3_report_tarbak_akademik_flSisJurnalLunas.implement({
		...
		try{			
			...
			if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Bukti",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_rekon, a.keterangan from sis_rekon_m a "+filter,
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
		    	...
		    	this.filter =  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.no_kas",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and")+
														" and a.modul='LOADSISKB' ";
				this.filter2 = this.sg1.getCell(2,1)+"/";
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_tarbak_akademik_rptSisJurnalRekonYptNon";
			...
			systemAPI.alert("[app_saku3_report_tarbak_akademik_flSisJurnalLunas]::mainButtonClick:"+e);
		}
	},
