window.app_saku3_report_tarbak_akademik_flPpTarif = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_akademik_flPpTarif.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_akademik_flPpTarif";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Tarif per PP", 2);
...
window.app_saku3_report_tarbak_akademik_flPpTarif.extend(window.childForm);
window.app_saku3_report_tarbak_akademik_flPpTarif.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tarbak_akademik_rptPpTarif";
