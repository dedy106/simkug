window.app_saku3_report_tarbak_akademik_flSisSaldoSiswaAging = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_akademik_flSisSaldoSiswaAging.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_akademik_flSisSaldoSiswaAging";
		this.maximize();
...
window.app_saku3_report_tarbak_akademik_flSisSaldoSiswaAging.extend(window.childForm);
window.app_saku3_report_tarbak_akademik_flSisSaldoSiswaAging.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tarbak_akademik_rptSisSaldoSiswaAging";
