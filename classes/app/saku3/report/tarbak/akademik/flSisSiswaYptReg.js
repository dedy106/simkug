window.app_saku3_report_tarbak_akademik_flSisSiswaYptReg = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_akademik_flSisSiswaYptReg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_akademik_flSisSiswaYptReg";
		this.maximize();
...
window.app_saku3_report_tarbak_akademik_flSisSiswaYptReg.extend(window.childForm);
window.app_saku3_report_tarbak_akademik_flSisSiswaYptReg.implement({
		...
		try{			
			...
			if (row == 2)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Calon Siswa",this.sg1, this.sg1.row, this.sg1.col,
												"select no_reg, nama from sis_siswareg ",
												"select count(*) from sis_siswareg",
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tarbak_akademik_rptSisSiswaYptReg";
