window.app_saku3_report_tarbak_akademik_flCdOut = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_akademik_flCdOut.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_akademik_flCdOut";
		this.maximize();
...
window.app_saku3_report_tarbak_akademik_flCdOut.extend(window.childForm);
window.app_saku3_report_tarbak_akademik_flCdOut.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tarbak_akademik_rptCdOut";
			...
			systemAPI.alert("[app_saku3_report_tarbak_akademik_flCdOut]::mainButtonClick:"+e);
		}
	},
