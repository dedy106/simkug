window.app_saku3_report_tarbak_akademik_flSisRekonRkp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_akademik_flSisRekonRkp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_akademik_flSisRekonRkp";
		this.maximize();
...
window.app_saku3_report_tarbak_akademik_flSisRekonRkp.extend(window.childForm);
window.app_saku3_report_tarbak_akademik_flSisRekonRkp.implement({
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.filter2 =this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							  ...
							  "/"+this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,2)+"/"+this.sg1.getCell(2,4);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				
				
				this.nama_report = "server_report_saku3_tarbak_akademik_rptSisRekonRkp";
