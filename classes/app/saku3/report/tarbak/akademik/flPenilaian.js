window.app_saku3_report_siswa_flPenilaian = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flPenilaian.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flPenilaian";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Kode Kelas","All",""));
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Jenis Penilaian","All",""));
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Tahun Ajaran","=",this.periode));
	
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_siswa_flPenilaian.extend(window.childForm);
window.app_saku3_report_siswa_flPenilaian.implement({
		...
		try{			
			...
			if (row ==2)
			{
				this.filterRep.ListDataSGFilter(this, "Data Penilaian",this.sg1, this.sg1.row, this.sg1.col,
														  "select a.kode_jenis, a.nama from sis_jenisnilai a  "+
														   this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(2,0)," where "),
														  "select count(a.kode_jenis) from sis_jenisnilai a "+
														  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(2,0)," where "),
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							  this.filterRep.filterStr("a.kode_kelas",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							  this.filterRep.filterStr("a.kode_jenis",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
							  this.filterRep.filterStr("a.kode_ta",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and");

							  this.showFilter = this.filterRep.showFilter(this.sg1);
				this.nama_report = "server_report_saku3_siswa_rptPenilaian";
