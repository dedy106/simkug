window.app_saku3_report_siswa_flEkskur = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flEkskur.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flEkskur";
		this.maximize();
...
window.app_saku3_report_siswa_flEkskur.extend(window.childForm);
window.app_saku3_report_siswa_flEkskur.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siswa_rptEkskur";
