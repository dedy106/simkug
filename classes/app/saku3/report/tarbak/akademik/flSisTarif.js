window.app_saku3_report_tarbak_akademik_flSisTarif = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_akademik_flSisTarif.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_akademik_flSisTarif";
		this.maximize();
...
window.app_saku3_report_tarbak_akademik_flSisTarif.extend(window.childForm);
window.app_saku3_report_tarbak_akademik_flSisTarif.implement({
		...
		try
		{
			...
			else
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.kode_akt",this.sg1.getCell(1,5),this.sg1.getCell(2,5),this.sg1.getCell(3,5),"and")+
							this.filterRep.filterStr("b.flag_aktif",this.sg1.getCell(1,6),this.sg1.getCell(2,6),this.sg1.getCell(3,6),"and")+
				...
				this.nama_report = "server_report_saku3_tarbak_akademik_rptSisTarif2";
