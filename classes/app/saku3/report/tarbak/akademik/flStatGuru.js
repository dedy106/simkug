window.app_saku3_report_siswa_flStatGuru = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flStatGuru.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flStatGuru";
		this.maximize();
...
window.app_saku3_report_siswa_flStatGuru.extend(window.childForm);
window.app_saku3_report_siswa_flStatGuru.implement({
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							  this.filterRep.filterStr("kode_status",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							  this.filterRep.filterStr("kode_pp",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
				this.showFilter = this.filterRep.showFilter(this.sg1);
				this.nama_report = "server_report_saku3_siswa_rptStatGuru";
