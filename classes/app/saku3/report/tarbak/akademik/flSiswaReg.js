window.app_saku3_report_siswa_flSiswaReg = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSiswaReg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSiswaReg";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Tahun Ajaran","All",""));
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Jenis Kelamin","All",""));
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("Agama","All",""));	
	
	
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_siswa_flSiswaReg.extend(window.childForm);
window.app_saku3_report_siswa_flSiswaReg.implement({
		...
		try{			
			...
			if (row ==2)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data TA",this.sg1, this.sg1.row, this.sg1.col,
														  "select a.kode_ta, a.nama from sis_ta a  "+filter,
														  "select count(a.kode_ta) from sis_ta a "+filter,
	...
	{		
		...
		if (row == 3)
		{
			...
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("LAKI-LAKI","PEREMPUAN"));
		}
		if (row == 4)
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("ISLAM","KRISTEN","BUDHA","HINDU","KHONGHUCU"));
		}
	},
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							  ...
							  this.filterRep.filterStr("a.jk",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and")+							  
							  this.filterRep.filterStr("a.agama",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4),"and");
				this.filter2 =this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				this.nama_report = "server_report_saku3_siswa_rptSiswaReg";
