window.app_saku3_report_tarbak_akademik_flSisRekonYpt = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_akademik_flSisRekonYpt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_akademik_flSisRekonYpt";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from sis_rekon_m where kode_lokasi='"+this.app._lokasi+"' ");
...
window.app_saku3_report_tarbak_akademik_flSisRekonYpt.extend(window.childForm);
window.app_saku3_report_tarbak_akademik_flSisRekonYpt.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tarbak_akademik_rptSisRekonYpt";
