window.app_saku3_report_tarbak_akademik_flSisSaldoKls = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_akademik_flSisSaldoKls.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_akademik_flSisSaldoKls";
		this.maximize();
...
window.app_saku3_report_tarbak_akademik_flSisSaldoKls.extend(window.childForm);
window.app_saku3_report_tarbak_akademik_flSisSaldoKls.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tarbak_akademik_rptSisSaldoKls";
