window.app_saku3_report_tarbak_akademik_flSisSaldoSiswaJur = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_akademik_flSisSaldoSiswaJur.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_akademik_flSisSaldoSiswaJur";
		this.maximize();
...
window.app_saku3_report_tarbak_akademik_flSisSaldoSiswaJur.extend(window.childForm);
window.app_saku3_report_tarbak_akademik_flSisSaldoSiswaJur.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tarbak_akademik_rptSisSaldoSiswaJur";
