window.app_saku3_report_siswa_flSisSaldoTingkat = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisSaldoTingkat.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisSaldoTingkat";
		this.maximize();
...
window.app_saku3_report_siswa_flSisSaldoTingkat.extend(window.childForm);
window.app_saku3_report_siswa_flSisSaldoTingkat.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_siswa_rptSisSaldoTingkat";
