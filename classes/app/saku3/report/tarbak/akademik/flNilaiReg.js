window.app_saku3_report_siswa_flNilaiReg = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flNilaiReg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flNilaiReg";
		this.maximize();
...
window.app_saku3_report_siswa_flNilaiReg.extend(window.childForm);
window.app_saku3_report_siswa_flNilaiReg.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siswa_rptNilaiReg";
