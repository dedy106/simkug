window.app_saku3_report_tarbak_akademik_flSisJurnalRekonYpt = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_akademik_flSisJurnalRekonYpt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_akademik_flSisJurnalRekonYpt";
		this.maximize();
...
window.app_saku3_report_tarbak_akademik_flSisJurnalRekonYpt.extend(window.childForm);
window.app_saku3_report_tarbak_akademik_flSisJurnalRekonYpt.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tarbak_akademik_rptSisJurnalRekonYpt";
			...
			systemAPI.alert("[app_saku3_report_tarbak_akademik_flSisJurnalRekonYpt]::mainButtonClick:"+e);
		}
	},
