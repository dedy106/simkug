window.app_saku3_report_tarbak_akademik_flSisRekonYptNon = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_akademik_flSisRekonYptNon.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_akademik_flSisRekonYptNon";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from kas_m where kode_lokasi='"+this.app._lokasi+"' and modul in ('LOADSISKB','KBBILSIS') ");
...
window.app_saku3_report_tarbak_akademik_flSisRekonYptNon.extend(window.childForm);
window.app_saku3_report_tarbak_akademik_flSisRekonYptNon.implement({
		...
		try{			
			...
			if (row ==6)
			{
				this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							" and modul in ('LOADSISKB','KBBILSIS') ";
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.filter2 =this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							  ...
							  this.filterRep.filterStr("a.no_kas",this.sg1.getCell(1,6),this.sg1.getCell(2,6),this.sg1.getCell(3,6),"and")+" and a.modul in ('LOADSISKB','KBBILSIS') "+
							  "/"+this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,2)+"/"+this.sg1.getCell(2,7);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				
				
				this.nama_report = "server_report_saku3_tarbak_akademik_rptSisRekonYptNon";
