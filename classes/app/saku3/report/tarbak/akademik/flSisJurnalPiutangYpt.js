window.app_saku3_report_tarbak_akademik_flSisJurnalPiutangYpt = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_akademik_flSisJurnalPiutangYpt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_akademik_flSisJurnalPiutangYpt";
		this.maximize();
...
window.app_saku3_report_tarbak_akademik_flSisJurnalPiutangYpt.extend(window.childForm);
window.app_saku3_report_tarbak_akademik_flSisJurnalPiutangYpt.implement({
		...
		try{			
			...
			if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Bukti",this.sg1, this.sg1.row, this.sg1.col,
												...
												"select count(*) from sis_bill_m a "+this.filter,
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from sis_bill_m where kode_lokasi='"+this.app._lokasi+"' order by periode desc",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tarbak_akademik_rptSisJurnalPiutangYpt";
			...
			systemAPI.alert("[app_saku3_report_tarbak_akademik_flSisJurnalPiutangYpt]::mainButtonClick:"+e);
		}
	},
