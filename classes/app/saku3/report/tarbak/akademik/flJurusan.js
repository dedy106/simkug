window.app_saku3_report_siswa_flJurusan = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flJurusan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flJurusan";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Kode Jurusan","All",""));
	
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_siswa_flJurusan.extend(window.childForm);
window.app_saku3_report_siswa_flJurusan.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siswa_rptJurusan";
