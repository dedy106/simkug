window.app_saku3_report_tarbak_akademik_flSisKartuCdReg = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_akademik_flSisKartuCdReg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_akademik_flSisKartuCdReg";
		this.maximize();
...
window.app_saku3_report_tarbak_akademik_flSisKartuCdReg.extend(window.childForm);
window.app_saku3_report_tarbak_akademik_flSisKartuCdReg.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tarbak_akademik_rptSisKartuCdReg";
