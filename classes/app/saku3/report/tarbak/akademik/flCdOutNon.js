window.app_saku3_report_tarbak_akademik_flCdOutNon = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_akademik_flCdOutNon.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_akademik_flCdOutNon";
		this.maximize();
...
window.app_saku3_report_tarbak_akademik_flCdOutNon.extend(window.childForm);
window.app_saku3_report_tarbak_akademik_flCdOutNon.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tarbak_akademik_rptCdOutNon";
