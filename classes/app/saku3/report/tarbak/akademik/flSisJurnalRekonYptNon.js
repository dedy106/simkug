window.app_saku3_report_tarbak_akademik_flSisJurnalRekonYptNon = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_akademik_flSisJurnalRekonYptNon.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_akademik_flSisJurnalRekonYptNon";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from kas_m where kode_lokasi='"+this.app._lokasi+"' and modul='LOADSISKB' ");
...
window.app_saku3_report_tarbak_akademik_flSisJurnalRekonYptNon.extend(window.childForm);
window.app_saku3_report_tarbak_akademik_flSisJurnalRekonYptNon.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_tarbak_akademik_flSisJurnalRekonYptNon]::mainButtonClick:"+e);
		}
	},
