window.app_saku3_report_siswa_flSisKartu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisKartu";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("NIS","All",""));
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_siswa_flSisKartu.extend(window.childForm);
window.app_saku3_report_siswa_flSisKartu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siswa_rptSisKartu";
