window.app_saku3_report_tarbak_akademik_flSisAging = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisAging.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisAging";
		this.maximize();
...
window.app_saku3_report_siswa_flSisAging.extend(window.childForm);
window.app_saku3_report_siswa_flSisAging.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tarbak_akademik_rptSisAging";
