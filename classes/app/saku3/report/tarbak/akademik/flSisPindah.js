window.app_saku3_report_tarbak_akademik_flSisPindah = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_akademik_flSisPindah.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_akademik_flSisPindah";
		this.maximize();
...
window.app_saku3_report_tarbak_akademik_flSisPindah.extend(window.childForm);
window.app_saku3_report_tarbak_akademik_flSisPindah.implement({
		...
		try{			
			...
			if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Bukti",this.sg1, this.sg1.row, this.sg1.col,
												...
												"select count(*) from sis_rekon_m a "+this.filter,
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from sis_rekon_m where kode_lokasi='"+this.app._lokasi+"' order by periode desc",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tarbak_akademik_rptSisPindah";
			...
			systemAPI.alert("[app_saku3_report_tarbak_akademik_flSisPindah]::mainButtonClick:"+e);
		}
	},
	...
	doOpenBills: function(no_bukti,kode_lokasi){
		...
		this.link="1";
		filter2 = "";
		filter=" where a.no_kas='"+no_bukti+"' and a.kode_lokasi='"+kode_lokasi+"' and a.kode_pp='"+kode_pp+"' and a.modul='"+modul+"' ";
		nama_report="server_report_saku3_tarbak_akademik_rptSisPindah";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
