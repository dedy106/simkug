window.app_saku3_report_tarbak_akademik_flCalonJurnalNon = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_akademik_flCalonJurnalNon.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_akademik_flCalonJurnalNon";
		this.maximize();
...
window.app_saku3_report_tarbak_akademik_flCalonJurnalNon.extend(window.childForm);
window.app_saku3_report_tarbak_akademik_flCalonJurnalNon.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tarbak_akademik_rptCalonJurnalNon";
