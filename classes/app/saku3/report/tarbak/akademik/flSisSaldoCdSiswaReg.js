window.app_saku3_report_tarbak_akademik_flSisSaldoCdSiswaReg = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_akademik_flSisSaldoCdSiswaReg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_akademik_flSisSaldoCdSiswaReg";
		this.maximize();
...
window.app_saku3_report_tarbak_akademik_flSisSaldoCdSiswaReg.extend(window.childForm);
window.app_saku3_report_tarbak_akademik_flSisSaldoCdSiswaReg.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2 =this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,2)+"/"+this.sg1.getCell(2,4);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				
				
				this.nama_report = "server_report_saku3_tarbak_akademik_rptSisSaldoCdSiswaReg";
	...
	doOpenKartu: function(nis,kode_lokasi,kode_pp){
		...
		nama_report="server_report_saku3_tarbak_akademik_rptSisKartuCdReg";
