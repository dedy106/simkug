window.app_saku3_report_tarbak_flHakakses = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_flHakakses.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_flHakakses";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan User Akses", 2);
...
window.app_saku3_report_tarbak_flHakakses.extend(window.childForm);
window.app_saku3_report_tarbak_flHakakses.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row == 2)
			{
				...
				var sql1="select a.nik,a.nama from karyawan a "+filter;
                var sql2="select count(a.nik) from karyawan a "+filter;
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tarbak_rptHakakses";
