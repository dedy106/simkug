window.app_saku3_report_tarbak_flHrGajiPph = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_flHrGajiPph.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_flHrGajiPph";
		this.maximize();
...
window.app_saku3_report_tarbak_flHrGajiPph.extend(window.childForm);
window.app_saku3_report_tarbak_flHrGajiPph.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_saku3_tarbak_rptHrGajiPph";
