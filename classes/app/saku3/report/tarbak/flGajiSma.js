window.  app_saku3_report_tarbak_flGajiSma = function(owner)
{
	if (owner)
	{
		window.  app_saku3_report_tarbak_flGajiSma.prototype.parent.constructor.call(this,owner);
		this.className = "  app_saku3_report_tarbak_flGajiSma";
		this.maximize();
...
window.  app_saku3_report_tarbak_flGajiSma.extend(window.childForm);
window.  app_saku3_report_tarbak_flGajiSma.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				{
					this.nama_report="server_report_saku3_tarbak_rptGajiSma1";
				}
				else
				{
					this.nama_report="server_report_saku3_tarbak_rptGajiSma2";
				}	
