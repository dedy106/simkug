window.app_saku3_report_tarbak_flHrKaryawan2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_flHrKaryawan2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_flHrKaryawan2";
		this.maximize();
...
window.app_saku3_report_tarbak_flHrKaryawan2.extend(window.childForm);
window.app_saku3_report_tarbak_flHrKaryawan2.implement({
		...
		try{			
			...
			if (row == 5)
			{
				this.filterRep.ListDataSGFilter(this, "Data Customer",this.sg1, this.sg1.row, this.sg1.col,
														  "select a.kode_cust, a.nama from hr_cust a   "+
														   this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  "select count(a.kode_cust) from hr_cust a "+
														  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tarbak_rptHrKaryawan2";
