window.app_saku3_report_tarbak_flHrKaryawan = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_flHrKaryawan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_flHrKaryawan";
		this.maximize();
...
window.app_saku3_report_tarbak_flHrKaryawan.extend(window.childForm);
window.app_saku3_report_tarbak_flHrKaryawan.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tarbak_rptHrKaryawan";
	...
	doOpenKaryawan: function(nik,kode_lokasi){
		
		this.nik=nik;
		this.kode_lokasi=kode_lokasi;
		this.link="1";
		filter = " where a.kode_lokasi='"+kode_lokasi+"' and nik='"+nik+"'";
		filter2="";
		nama_report="server_report_saku3_tarbak_rptHrKaryawanCv";
