// JavaScript Document
window.app_saku3_report_tarbak_flCoa = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_flCoa.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_flCoa";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Jenis","=","COA"));
...
window.app_saku3_report_tarbak_flCoa.extend(window.portalui_childForm);
window.app_saku3_report_tarbak_flCoa.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		if (row == 2)
		{
			...
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("COA","Struktur"));
		}
	},
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_tarbak_rptCoa";
			
			if (this.sg1.getCell(2,2)=="Struktur")
			{
				this.nama_report="server_report_saku3_tarbak_rptCoaStruktur";
			}
