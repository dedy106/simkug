window.app_saku3_report_tarbak_flHrGajiPphGra = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_flHrGajiPphGra.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_flHrGajiPphGra";
		this.maximize();
...
window.app_saku3_report_tarbak_flHrGajiPphGra.extend(window.childForm);
window.app_saku3_report_tarbak_flHrGajiPphGra.implement({
	...
	doSelectCell: function(sender, col, row){		
		...
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4],["3","123","123i","123i","3"]);
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_saku3_tarbak_rptHrGajiPphGra";
