window.  app_saku3_report_tarbak_flGajiAsm = function(owner)
{
	if (owner)
	{
		window.  app_saku3_report_tarbak_flGajiAsm.prototype.parent.constructor.call(this,owner);
		this.className = "  app_saku3_report_tarbak_flGajiAsm";
		this.maximize();
...
window.  app_saku3_report_tarbak_flGajiAsm.extend(window.childForm);
window.  app_saku3_report_tarbak_flGajiAsm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				{
					this.nama_report="server_report_saku3_tarbak_rptGajiAsm1";
				}
				else
				{
					this.nama_report="server_report_saku3_tarbak_rptGajiAsm2";
				}	
