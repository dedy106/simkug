window.app_saku3_report_tarbak_flAggCapai = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_flAggCapai.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_flAggCapai";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,[0,1,2],["Jenis Akun","=","Beban"]);
	this.gridLib.SGEditData(this.sg1,5,[0,1,2],["Jenis Mutasi","=","Mutasi"]);
...
window.app_saku3_report_tarbak_flAggCapai.extend(window.portalui_childForm);
window.app_saku3_report_tarbak_flAggCapai.implement({
	...
	doSelectCell: function(sender, col, row){
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6],["3","3","3","123","3","3","3"]);
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5,6],[2,0,0,2,0,0,0]);
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				{
					var sql = "call sp_agg_capai ('"+this.sg1.getCell(2,0)+"','"+this.sg1.getCell(2,4)+"','"+this.sg1.getCell(2,5)+"','"+this.sg1.getCell(2,1)+"','"+this.sg1.getCell(2,2)+"','"+this.nik_user+"')";
				}
				else
				{
					var sql = "call sp_agg_capai_gl ('"+this.sg1.getCell(2,0)+"','"+this.sg1.getCell(2,4)+"','"+this.sg1.getCell(2,5)+"','"+this.sg1.getCell(2,1)+"','"+this.sg1.getCell(2,2)+"','"+this.nik_user+"')";
				}
				this.nama_report="server_report_saku3_tarbak_rptAggCapai";
	...
	doOpenKartu: function(kode_akun,kode_lokasi,tahun){
		...
		filter2=tahun+"/"+this.sg1.getCell(2,6)+"/"+this.app._nikUser;
