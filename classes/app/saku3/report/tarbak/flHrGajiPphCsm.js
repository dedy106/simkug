window.app_saku3_report_tarbak_flHrGajiPphCsm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_flHrGajiPphCsm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_flHrGajiPphCsm";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,3,[0,1,2],["No Gaji","=",this.no_gaji]);
	
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_tarbak_flHrGajiPphCsm.extend(window.childForm);
window.app_saku3_report_tarbak_flHrGajiPphCsm.implement({
	...
	doSelectCell: function(sender, col, row){		
		...
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3],["3","123i","123i","3"]);
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_saku3_tarbak_rptHrGajiPphCsm";
