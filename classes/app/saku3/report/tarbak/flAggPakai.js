window.app_saku3_report_tarbak_flAggPakai = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_flAggPakai.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_flAggPakai";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,[0,1,2],["Realisasi","=","General Ledger"]);
...
window.app_saku3_report_tarbak_flAggPakai.extend(window.portalui_childForm);
window.app_saku3_report_tarbak_flAggPakai.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_tarbak_rptAggPakai";
	...
	doOpenKartu: function(kode_akun,kode_lokasi,tahun){
		...
		filter2=tahun+"/"+this.sg1.getCell(2,4)+"/"+this.app._nikUser;
