window.app_saku3_report_tarbak_simlog_flPbLogBA = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_simlog_flPbLogBA.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_simlog_flPbLogBA";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from pbh_pb_m where kode_lokasi='"+this.app._lokasi+"' and modul='PBBA'");
...
window.app_saku3_report_tarbak_simlog_flPbLogBA.extend(window.childForm);
window.app_saku3_report_tarbak_simlog_flPbLogBA.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from pbh_pb_m where modul='PBBA' and kode_lokasi='"+this.app._lokasi+"' order by periode",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tarbak_simlog_rptPbLogBA";
			...
			systemAPI.alert("[app_saku3_report_tarbak_simlog_flPbLogBA]::mainButtonClick:"+e);
		}
	},
