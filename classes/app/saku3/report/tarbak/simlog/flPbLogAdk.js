window.app_saku3_report_tarbak_simlog_flPbLogAdk = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_simlog_flPbLogAdk.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_simlog_flPbLogAdk";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from pbh_pb_m where kode_lokasi='"+this.app._lokasi+"' and modul='LOG'");
...
window.app_saku3_report_tarbak_simlog_flPbLogAdk.extend(window.childForm);
window.app_saku3_report_tarbak_simlog_flPbLogAdk.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tarbak_simlog_rptPbLogADK";
			...
			systemAPI.alert("[app_saku3_report_tarbak_simlog_flPbLogAdk]::mainButtonClick:"+e);
		}
	},
