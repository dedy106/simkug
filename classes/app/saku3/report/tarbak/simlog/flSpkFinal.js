window.app_saku3_report_tarbak_simlog_flSpkFinal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_simlog_flSpkFinal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_simlog_flSpkFinal";
		this.maximize();
...
window.app_saku3_report_tarbak_simlog_flSpkFinal.extend(window.childForm);
window.app_saku3_report_tarbak_simlog_flSpkFinal.implement({
		...
		try{			
			...
			if (row ==2)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Pengajuan",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_spk, a.keterangan from log_spk_m a "+this.filter,
												"select count(*) from log_spk_m a "+this.filter,
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tarbak_simlog_rptSpkFinal";
			...
			systemAPI.alert("[app_saku3_report_tarbak_simlog_flSpkFinal]::mainButtonClick:"+e);
		}
	},
