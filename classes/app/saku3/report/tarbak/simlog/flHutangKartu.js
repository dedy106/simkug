window.app_saku3_report_tarbak_simlog_flHutangKartu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_simlog_flHutangKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_simlog_flHutangKartu";
		this.maximize();
...
window.app_saku3_report_tarbak_simlog_flHutangKartu.extend(window.childForm);
window.app_saku3_report_tarbak_simlog_flHutangKartu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tarbak_simlog_rptHutangKartu";
			...
			systemAPI.alert("[app_saku3_report_tarbak_simlog_flHutangKartu]::mainButtonClick:"+e);
		}
	},
