// JavaScript Document
window.app_saku3_report_tarbak_simlog_flVendor = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_simlog_flVendor.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_simlog_flVendor";
		this.maximize();
...
window.app_saku3_report_tarbak_simlog_flVendor.extend(window.portalui_childForm);
window.app_saku3_report_tarbak_simlog_flVendor.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_tarbak_simlog_rptVendor";
