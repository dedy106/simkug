window.app_saku3_report_tarbak_simlog_flPesanPosisi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_simlog_flPesanPosisi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_simlog_flPesanPosisi";
		this.maximize();
...
window.app_saku3_report_tarbak_simlog_flPesanPosisi.extend(window.childForm);
window.app_saku3_report_tarbak_simlog_flPesanPosisi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tarbak_simlog_rptPesanPosisi";
			...
			systemAPI.alert("[app_saku3_report_tarbak_simlog_flPesanPosisi]::mainButtonClick:"+e);
		}
	},
	...
	doOpenPesan: function(no_bukti,kode_lokasi){
		...
		nama_report="server_report_saku3_tarbak_simlog_rptPesan";
	...
	doOpenSpk: function(no_bukti,kode_lokasi){
		...
		filter2=this.sg1.getCell(2,1);
		nama_report="server_report_saku3_tarbak_simlog_rptSpkFinal";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
    ...
    doOpenTerima: function(no_bukti,kode_lokasi){
		...
		filter2=this.sg1.getCell(2,1);
		nama_report="server_report_saku3_tarbak_simlog_rptTerima";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
    ...
    doOpenHutang: function(no_bukti,kode_lokasi){
		...
		filter2=this.sg1.getCell(2,1);
		nama_report="server_report_saku3_tarbak_simlog_rptBast";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
    ...
    doOpenPb: function(no_bukti,kode_lokasi){
		...
		filter2=this.sg1.getCell(2,1);
		nama_report="server_report_saku3_tarbak_simlog_rptPbLogBA";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
