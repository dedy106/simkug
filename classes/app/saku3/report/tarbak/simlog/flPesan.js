window.app_saku3_report_tarbak_simlog_flPesan = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_simlog_flPesan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_simlog_flPesan";
		this.maximize();
...
window.app_saku3_report_tarbak_simlog_flPesan.extend(window.childForm);
window.app_saku3_report_tarbak_simlog_flPesan.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row ==2)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Purchase Order",this.sg1, this.sg1.row, this.sg1.col,
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tarbak_simlog_rptPesan";
			...
			systemAPI.alert("[app_saku3_report_tarbak_simlog_flPesan]::mainButtonClick:"+e);
		}
	},
