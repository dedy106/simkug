window.app_saku3_report_tarbak_flHrKaryawanCv = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_flHrKaryawanCv.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_flHrKaryawanCv";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Status","All",""));
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Golongan","All",""));
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Jabatan","All",""));
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("Lokasi Kerja","All",""));
	this.gridLib.SGEditData(this.sg1,5,new Array(0,1,2), new Array("Kode PP","All",""));
	this.gridLib.SGEditData(this.sg1,6,new Array(0,1,2), new Array("NIK","All",""));
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_tarbak_flHrKaryawanCv.extend(window.childForm);
window.app_saku3_report_tarbak_flHrKaryawanCv.implement({
		...
		try{			
			...
			if (row == 1)
			{
				this.filterRep.ListDataSGFilter(this, "Data Status",this.sg1, this.sg1.row, this.sg1.col,
														  "select a.kode_sdm, a.nama from hr_sdm a   "+
														   this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  "select count(a.kode_sdm) from hr_sdm a "+
														  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  ["a.kode_sdm","a.nama"],"and",["Kode","Nama"]);
			}
			if (row == 2)
			{
				this.filterRep.ListDataSGFilter(this, "Data Golongan",this.sg1, this.sg1.row, this.sg1.col,
														  "select a.kode_gol, a.nama from hr_gol a   "+
														   this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  "select count(a.kode_gol) from hr_gol a "+
														  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  ["a.kode_gol","a.nama"],"and",["Kode","Nama"]);
			}
			if (row == 3)
			{
				this.filterRep.ListDataSGFilter(this, "Data Jabatan",this.sg1, this.sg1.row, this.sg1.col,
														  "select a.kode_jab, a.nama from hr_jab a   "+
														   this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  "select count(a.kode_jab) from hr_jab a "+
														  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  ["a.kode_jab","a.nama"],"and",["Kode","Nama"]);
			}
			if (row == 4)
			{
				this.filterRep.ListDataSGFilter(this, "Data Lokasi Kerja",this.sg1, this.sg1.row, this.sg1.col,
														  "select a.kode_loker, a.nama from hr_loker a   "+
														   this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  "select count(a.kode_loker) from hr_loker a "+
														  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  ["a.kode_loker","a.nama"],"and",["Kode","Nama"]);
			}
			if (row == 5)
			{
			...
			if (row == 6)
			{
				...
				var filter=this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.kode_sdm",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("a.kode_gol",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
				...
				var sql1="select a.nik,a.nama from hr_karyawan a "+filter;
				var sql2="select count(a.nik) from hr_karyawan a "+filter;
				this.filterRep.ListDataSGFilter(this, "Data Karyawan",this.sg1, this.sg1.row, this.sg1.col,sql1,sql2,
												new Array("a.nik","a.nama"),"and",new Array("NIK","Nama"),"and");
			}			
		}catch(e){
			systemAPI.alert(e);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tarbak_rptHrKaryawanCv";
