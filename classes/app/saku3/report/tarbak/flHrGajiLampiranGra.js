window.app_saku3_report_tarbak_flHrGajiLampiranGra = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_flHrGajiLampiranGra.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_flHrGajiLampiranGra";
		this.maximize();
...
window.app_saku3_report_tarbak_flHrGajiLampiranGra.extend(window.childForm);
window.app_saku3_report_tarbak_flHrGajiLampiranGra.implement({
		...
		try{			
			...
			if (row == 2)
			{
				this.filterRep.ListDataSGFilter(this, "Data Status Pegawai",this.sg1, this.sg1.row, this.sg1.col,
													"select kode_sdm, nama from hr_sdm where kode_lokasi = '"+this.app._lokasi+"' ",
													"select count(*) from hr_sdm  where kode_lokasi = '"+this.app._lokasi+"' ",
													["kode_sdm","nama"],"and",["Status","Keterangan"], false, this.sg1.cells(1,row) == "in");
			}
			if (row == 3)
			{
			...
			else
			{
				...
				else
				{
					...
					this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
								this.filterRep.filterStr("a.kode_sdm",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
					...
					this.nama_report = "server_report_saku3_tarbak_rptHrGajiLampiranGra";
