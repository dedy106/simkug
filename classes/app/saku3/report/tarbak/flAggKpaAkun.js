window.app_saku3_report_tarbak_flAggKpaAkun = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_flAggKpaAkun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_flAggKpaAkun";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,[0,1,2],["Periode Mutasi","All",""]);
...
window.app_saku3_report_tarbak_flAggKpaAkun.extend(window.portalui_childForm);
window.app_saku3_report_tarbak_flAggKpaAkun.implement({
	...
	doSelectCell: function(sender, col, row){
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5],["123","123","123","3","13","3"]);
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				if (this.sg1.getCell(2,5)=="General Ledger")
				{
					this.filter2=this.sg1.getCell(2,3)+"/"+this.sg1.getCell(2,1)+"/"+
				...
				{
					this.filter2=this.sg1.getCell(2,3)+"/"+this.sg1.getCell(2,1)+"/"+
								this.filterRep.filterStr("periode",this.sg1.getCell(1,6),this.sg1.getCell(2,6),this.sg1.getCell(3,6),"and")+"/"+
								this.sg1.getCell(2,5)+"/"+this.app._nikUser+"/"+this.sg1.getCell(2,0);
					var sql = "call sp_angg_d ('"+this.sg1.getCell(2,0)+"','"+this.sg1.getCell(2,1)+"','"+this.app._nikUser+"')";
					this.dbLib.execQuerySync(sql);	
				}
				
				this.nama_report="server_report_saku3_tarbak_rptAggKpaAkun";
