window.  app_saku3_report_tarbak_flGajiAdm = function(owner)
{
	if (owner)
	{
		window.  app_saku3_report_tarbak_flGajiAdm.prototype.parent.constructor.call(this,owner);
		this.className = "  app_saku3_report_tarbak_flGajiAdm";
		this.maximize();
...
window.  app_saku3_report_tarbak_flGajiAdm.extend(window.childForm);
window.  app_saku3_report_tarbak_flGajiAdm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				{
					this.nama_report="server_report_saku3_tarbak_rptGajiAdm1";
				}
				else
				{
					this.nama_report="server_report_saku3_tarbak_rptGajiAdm2";
				}	
