window.  app_saku3_report_tarbak_flGajiTk = function(owner)
{
	if (owner)
	{
		window.  app_saku3_report_tarbak_flGajiTk.prototype.parent.constructor.call(this,owner);
		this.className = "  app_saku3_report_tarbak_flGajiTk";
		this.maximize();
...
window.  app_saku3_report_tarbak_flGajiTk.extend(window.childForm);
window.  app_saku3_report_tarbak_flGajiTk.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				{
					this.nama_report="server_report_saku3_tarbak_rptGajiTk1";
				}
				else
				{
					this.nama_report="server_report_saku3_tarbak_rptGajiTk2";
				}	
