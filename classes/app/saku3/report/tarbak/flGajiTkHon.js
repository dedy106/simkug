window.  app_saku3_report_tarbak_flGajiTkHon = function(owner)
{
	if (owner)
	{
		window.  app_saku3_report_tarbak_flGajiTkHon.prototype.parent.constructor.call(this,owner);
		this.className = "  app_saku3_report_tarbak_flGajiTkHon";
		this.maximize();
...
window.  app_saku3_report_tarbak_flGajiTkHon.extend(window.childForm);
window.  app_saku3_report_tarbak_flGajiTkHon.implement({
		...
		try{			
			...
			if (row == 2)
			{
				this.filterRep.ListDataSGFilter(this, "Data Karyawan",this.sg1, this.sg1.row, this.sg1.col,
													"select a.nik, a.nama from hr_karyawan a where a.kode_sdm='GH' and a.kode_unit='TK' ",
													"select count(*) from hr_karyawan a where a.kode_sdm='GH' and a.kode_unit='TK' ",
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				{
					this.nama_report="server_report_saku3_tarbak_rptGajiTk3";
				}
				else
				{
					this.nama_report="server_report_saku3_tarbak_rptGajiTk4";
				}	
