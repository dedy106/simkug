window.  app_saku3_report_tarbak_flGajiSdHon = function(owner)
{
	if (owner)
	{
		window.  app_saku3_report_tarbak_flGajiSdHon.prototype.parent.constructor.call(this,owner);
		this.className = "  app_saku3_report_tarbak_flGajiSdHon";
		this.maximize();
...
window.  app_saku3_report_tarbak_flGajiSdHon.extend(window.childForm);
window.  app_saku3_report_tarbak_flGajiSdHon.implement({
		...
		try{			
			...
			if (row == 2)
			{
				this.filterRep.ListDataSGFilter(this, "Data Karyawan",this.sg1, this.sg1.row, this.sg1.col,
													"select a.nik, a.nama from hr_karyawan a where a.kode_sdm='GH' and a.kode_unit='SD' ",
													"select count(*) from hr_karyawan a where a.kode_sdm='GH' and a.kode_unit='SD' ",
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				{
					this.nama_report="server_report_saku3_tarbak_rptGajiSd3";
				}
				else
				{
					this.nama_report="server_report_saku3_tarbak_rptGajiSd4";
				}	
