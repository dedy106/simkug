window.  app_saku3_report_tarbak_flGajiSmp = function(owner)
{
	if (owner)
	{
		window.  app_saku3_report_tarbak_flGajiSmp.prototype.parent.constructor.call(this,owner);
		this.className = "  app_saku3_report_tarbak_flGajiSmp";
		this.maximize();
...
window.  app_saku3_report_tarbak_flGajiSmp.extend(window.childForm);
window.  app_saku3_report_tarbak_flGajiSmp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				{
					this.nama_report="server_report_saku3_tarbak_rptGajiSmp1";
				}
				else
				{
					this.nama_report="server_report_saku3_tarbak_rptGajiSmp2";
				}	
