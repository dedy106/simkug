window.app_saku3_report_tarbak_flHrJob = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tarbak_flHrJob.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tarbak_flHrJob";
		this.maximize();
...
window.app_saku3_report_tarbak_flHrJob.extend(window.childForm);
window.app_saku3_report_tarbak_flHrJob.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tarbak_rptHrJob";
