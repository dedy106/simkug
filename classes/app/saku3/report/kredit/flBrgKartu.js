window.app_saku3_report_kredit_flBrgKartu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kredit_flBrgKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kredit_flBrgKartu";
		this.maximize();
...
window.app_saku3_report_kredit_flBrgKartu.extend(window.childForm);
window.app_saku3_report_kredit_flBrgKartu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_kredit_rptBrgKartu";
			...
			systemAPI.alert("[app_saku3_report_kredit_flBrgKartu]::mainButtonClick:"+e);
		}
	},
