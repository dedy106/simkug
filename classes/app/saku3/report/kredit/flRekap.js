window.app_saku3_report_kredit_flRekap = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kredit_flRekap.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kredit_flRekap";
		this.maximize();
...
window.app_saku3_report_kredit_flRekap.extend(window.childForm);
window.app_saku3_report_kredit_flRekap.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_kredit_rptRekap";
			...
			systemAPI.alert("[app_saku3_report_kredit_flRekap]::mainButtonClick:"+e);
		}
	},
