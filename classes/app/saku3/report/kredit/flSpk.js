window.app_saku3_report_kredit_flSpk = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kredit_flSpk.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kredit_flSpk";
		this.maximize();
...
window.app_saku3_report_kredit_flSpk.extend(window.childForm);
window.app_saku3_report_kredit_flSpk.implement({
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("a.no_ttb",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
				this.filter2 = this.sg1.getCell(2,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_kredit_rptSpk";
			...
			systemAPI.alert("[app_saku3_report_kredit_flSpk]::mainButtonClick:"+e);
		}
	},
