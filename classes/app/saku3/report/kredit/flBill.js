window.app_saku3_report_kredit_flBill = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kredit_flBill.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kredit_flBill";
		this.maximize();
...
window.app_saku3_report_kredit_flBill.extend(window.childForm);
window.app_saku3_report_kredit_flBill.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_kredit_flBill]::mainButtonClick:"+e);
		}
	},
