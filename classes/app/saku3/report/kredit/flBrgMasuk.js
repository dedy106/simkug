window.app_saku3_report_kredit_flBrgMasuk = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kredit_flBrgMasuk.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kredit_flBrgMasuk";
		this.maximize();
...
window.app_saku3_report_kredit_flBrgMasuk.extend(window.childForm);
window.app_saku3_report_kredit_flBrgMasuk.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Barang Masuk",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_beli, a.keterangan from kre_beli_m a "+filter,
												"select count(a.no_beli) from kre_beli_m a "+filter,
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_kredit_flBrgMasuk]::mainButtonClick:"+e);
		}
	},
