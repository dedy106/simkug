window.app_saku3_report_kredit_flTtb = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kredit_flTtb.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kredit_flTtb";
		this.maximize();
...
window.app_saku3_report_kredit_flTtb.extend(window.childForm);
window.app_saku3_report_kredit_flTtb.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_kredit_flTtb]::mainButtonClick:"+e);
		}
	},
