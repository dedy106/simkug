window.app_saku3_report_kredit_flBrgStokJejer = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kredit_flBrgStokJejer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kredit_flBrgStokJejer";
		this.maximize();
...
window.app_saku3_report_kredit_flBrgStokJejer.extend(window.childForm);
window.app_saku3_report_kredit_flBrgStokJejer.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_kredit_rptBrgStokJejer";
			...
			systemAPI.alert("[app_saku3_report_kredit_flBrgStokJejer]::mainButtonClick:"+e);
		}
	},
