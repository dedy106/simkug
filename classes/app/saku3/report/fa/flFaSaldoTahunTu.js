window.app_saku3_report_fa_flFaSaldoTahunTu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_fa_flFaSaldoTahunTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_fa_flFaSaldoTahunTu";
		this.maximize();
...
window.app_saku3_report_fa_flFaSaldoTahunTu.extend(window.childForm);
window.app_saku3_report_fa_flFaSaldoTahunTu.implement({
		...
		try
		{
			...
			else
			{
				...
				this.filter3= this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
								this.filterRep.filterStr("j.jenis",this.sg1.getCell(1,5),this.sg1.getCell(2,5),this.sg1.getCell(3,5),"and");	
				this.showFilter = this.filterRep.showFilter(this.sg1);
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,3)+"/"+this.sg1.getCell(2,1)+"/"+this.filter3;
				this.nama_report="server_report_saku3_fa_rptFaSaldoTahunTu";
	...
	doOpenAsset: function(kode_akun,kode_lokasi,tahun){
		...
		nama_report="server_report_saku3_fa_rptFaAssetTu";
