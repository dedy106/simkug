window.app_saku3_report_fa_flFaAssetTmp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_fa_flFaAssetTmp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_fa_flFaAssetTmp";
		this.maximize();
...
window.app_saku3_report_fa_flFaAssetTmp.extend(window.childForm);
window.app_saku3_report_fa_flFaAssetTmp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_fa_rptFaAssetTmp";
