window.app_saku3_report_fa_flFaSaldoTahun = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_fa_flFaSaldoTahun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_fa_flFaSaldoTahun";
		this.maximize();
...
window.app_saku3_report_fa_flFaSaldoTahun.extend(window.childForm);
window.app_saku3_report_fa_flFaSaldoTahun.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_fa_rptFaSaldoTahun";
