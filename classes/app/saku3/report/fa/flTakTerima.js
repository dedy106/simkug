window.app_saku3_report_fa_flFaTerima = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_fa_flFaTerima.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_fa_flFaTerima";
		this.maximize();
...
window.app_saku3_report_fa_flFaTerima.extend(window.childForm);
window.app_saku3_report_fa_flFaTerima.implement({
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.lokasi=this.dbLib.getPeriodeFromSQL("select nama as periode from lokasi where kode_lokasi='"+this.sg1.getCell(2,0)+"'");
					...
					this.nama_report = "server_report_saku3_fa_rptFaTerima";
			...
			systemAPI.alert("[app_saku3_report_fa_flFaTerima]::mainButtonClick:"+e);
		}
	},
