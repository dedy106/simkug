window.app_saku3_report_fa_flFaJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_fa_flFaJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_fa_flFaJurnal";
		this.maximize();
...
window.app_saku3_report_fa_flFaJurnal.extend(window.childForm);
window.app_saku3_report_fa_flFaJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_saku3_fa_rptFaJurnal";
				if (this.sg1.getCell(2,3)=="Memo Jurnal")
				{
					this.nama_report="server_report_saku3_fa_rptFaBuktiJurnal";
				}
