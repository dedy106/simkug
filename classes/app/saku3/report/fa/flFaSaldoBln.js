window.app_saku3_report_fa_flFaSaldoBln = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_fa_flFaSaldoBln.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_fa_flFaSaldoBln";
		this.maximize();
...
window.app_saku3_report_fa_flFaSaldoBln.extend(window.childForm);
window.app_saku3_report_fa_flFaSaldoBln.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_fa_rptFaSaldoBln";
	...
	doOpenAsset: function(kode_akun,kode_lokasi,periode,kode_pp){
		...
		nama_report="server_report_saku3_fa_rptFaAsset2";
