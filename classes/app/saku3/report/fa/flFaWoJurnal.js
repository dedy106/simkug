window.app_saku3_report_fa_flFaWoJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_fa_flFaWoJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_fa_flFaWoJurnal";
		this.maximize();
...
window.app_saku3_report_fa_flFaWoJurnal.extend(window.childForm);
window.app_saku3_report_fa_flFaWoJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_saku3_fa_rptFaWoJurnal";
				if (this.sg1.getCell(2,3)=="Memo Jurnal")
				{
					this.nama_report="server_report_saku3_fa_rptFaWoBuktiJurnal";
				}
