window.app_saku3_report_fa_flFaLokasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_fa_flFaLokasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_fa_flFaLokasi";
		this.maximize();
...
window.app_saku3_report_fa_flFaLokasi.extend(window.childForm);
window.app_saku3_report_fa_flFaLokasi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_fa_rptFaLokasi";
