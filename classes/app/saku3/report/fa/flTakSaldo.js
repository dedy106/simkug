window.app_saku3_report_fa_flFaSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_fa_flFaSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_fa_flFaSaldo";
		this.maximize();
...
window.app_saku3_report_fa_flFaSaldo.extend(window.childForm);
window.app_saku3_report_fa_flFaSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_fa_rptFaSaldo";
			...
			systemAPI.alert("[app_saku3_report_fa_flFaSaldo]::mainButtonClick:"+e);
		}
	},
