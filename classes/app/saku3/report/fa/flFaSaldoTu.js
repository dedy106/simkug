window.app_saku3_report_fa_flFaSaldoTu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_fa_flFaSaldoTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_fa_flFaSaldoTu";
		this.maximize();
...
window.app_saku3_report_fa_flFaSaldoTu.extend(window.childForm);
window.app_saku3_report_fa_flFaSaldoTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_fa_rptFaSaldoTu";
