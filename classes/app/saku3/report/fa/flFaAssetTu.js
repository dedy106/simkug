window.app_saku3_report_fa_flFaAssetTu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_fa_flFaAssetTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_fa_flFaAssetTu";
		this.maximize();
...
window.app_saku3_report_fa_flFaAssetTu.extend(window.childForm);
window.app_saku3_report_fa_flFaAssetTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_fa_rptFaAssetTu";
