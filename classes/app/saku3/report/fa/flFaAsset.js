window.app_saku3_report_fa_flFaAsset = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_fa_flFaAsset.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_fa_flFaAsset";
		this.maximize();
...
window.app_saku3_report_fa_flFaAsset.extend(window.childForm);
window.app_saku3_report_fa_flFaAsset.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_fa_rptFaAsset";
