window.app_saku3_report_fa_flFaSaldoYpt = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_fa_flFaSaldoYpt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_fa_flFaSaldoYpt";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,0,[0,1,2], ["Lokasi","All",""]);
...
window.app_saku3_report_fa_flFaSaldoYpt.extend(window.childForm);
window.app_saku3_report_fa_flFaSaldoYpt.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_fa_rptFaSaldoYpt";
