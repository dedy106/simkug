window.app_saku3_report_fa_flFaAssetLog = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_fa_flFaAssetLog.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_fa_flFaAssetLog";
		this.maximize();
...
window.app_saku3_report_fa_flFaAssetLog.extend(window.childForm);
window.app_saku3_report_fa_flFaAssetLog.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_fa_rptFaAssetLog";
