window.app_saku3_report_fa_flFaKirim = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_fa_flFaKirim.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_fa_flFaKirim";
		this.maximize();
...
window.app_saku3_report_fa_flFaKirim.extend(window.childForm);
window.app_saku3_report_fa_flFaKirim.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_fa_rptFaKirim";
			...
			systemAPI.alert("[app_saku3_report_fa_flFaKirim]::mainButtonClick:"+e);
		}
	},
