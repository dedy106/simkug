window.app_saku3_report_fa_flFaAssetNonTarbak = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_fa_flFaAssetNonTarbak.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_fa_flFaAssetNonTarbak";
		this.maximize();
...
window.app_saku3_report_fa_flFaAssetNonTarbak.extend(window.childForm);
window.app_saku3_report_fa_flFaAssetNonTarbak.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_fa_rptFaAssetNonTarbak";
