window.app_saku3_report_fa_flFaKartu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_fa_flFaKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_fa_flFaKartu";
		this.maximize();
...
window.app_saku3_report_fa_flFaKartu.extend(window.childForm);
window.app_saku3_report_fa_flFaKartu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_fa_rptFaKartu";
