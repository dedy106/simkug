window.app_saku3_report_kopeg_flSimpSaldoAgg = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kopeg_flSimpSaldoAgg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kopeg_flSimpSaldoAgg";
		this.maximize();
...
window.app_saku3_report_kopeg_flSimpSaldoAgg.extend(window.childForm);
window.app_saku3_report_kopeg_flSimpSaldoAgg.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from kop_simpangs_d where kode_lokasi='"+this.app._lokasi+"' order by periode",[this.sg1.columns.get(2).pickList]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_kopeg_rptSimpSaldoAgg";
