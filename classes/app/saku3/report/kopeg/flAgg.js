window.app_saku3_report_kopeg_flAgg = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kopeg_flAgg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kopeg_flAgg";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("No Anggota","All",""));
	
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_kopeg_flAgg.extend(window.childForm);
window.app_saku3_report_kopeg_flAgg.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row == 1)
			{
				...
				var sql1="select a.no_agg,a.nama from kop_agg a  "+filter;
				var sql2="select count(a.no_agg) from kop_agg a  "+filter;
				this.filterRep.ListDataSGFilter(this, "Data Anggota",this.sg1, this.sg1.row, this.sg1.col,sql1,sql2,
												new Array("a.no_agg","a.nama"),"and",new Array("no_agg","Nama"),"and");
			}			
		}catch(e){
			systemAPI.alert(e);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("no_agg","All",""));
			}else{
				...
				this.nama_report = "server_report_saku3_kopeg_rptAgg";
