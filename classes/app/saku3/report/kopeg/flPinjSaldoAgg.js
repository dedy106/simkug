window.app_saku3_report_kopeg_flPinjSaldoAgg = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kopeg_flPinjSaldoAgg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kopeg_flPinjSaldoAgg";
		this.maximize();
...
window.app_saku3_report_kopeg_flPinjSaldoAgg.extend(window.childForm);
window.app_saku3_report_kopeg_flPinjSaldoAgg.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_kopeg_rptPinjSaldoAgg";
