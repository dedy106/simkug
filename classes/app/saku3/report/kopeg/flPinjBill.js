window.app_saku3_report_kopeg_flPinjBill = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kopeg_flPinjBill.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kopeg_flPinjBill";
		this.maximize();
...
window.app_saku3_report_kopeg_flPinjBill.extend(window.childForm);
window.app_saku3_report_kopeg_flPinjBill.implement({
		...
		try{			
			...
			if (row ==2)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_pinj,a.keterangan from kop_pinjbill_m a "+this.filter,
												"select count(a.no_pinj) from kop_pinjbill_m a "+this.filter,
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_kopeg_rptPinjBill";
