window.app_saku3_report_kopeg_flPinjSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kopeg_flPinjSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kopeg_flPinjSaldo";
		this.maximize();
...
window.app_saku3_report_kopeg_flPinjSaldo.extend(window.childForm);
window.app_saku3_report_kopeg_flPinjSaldo.implement({
		...
		try{			
			...
			if (row == 2)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Anggota",this.sg1, this.sg1.row, this.sg1.col,
														  ...
														  "select count(a.no_agg) from kop_agg a "+filter,
														  ["a.no_agg","a.nama"],"and",["Kode","Nama"]);
			}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_kopeg_rptPinjSaldo";
