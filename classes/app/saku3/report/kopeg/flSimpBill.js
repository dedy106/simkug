window.app_saku3_report_kopeg_flSimpBill = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kopeg_flSimpBill.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kopeg_flSimpBill";
		this.maximize();
...
window.app_saku3_report_kopeg_flSimpBill.extend(window.childForm);
window.app_saku3_report_kopeg_flSimpBill.implement({
		...
		try{			
			...
			if (row ==2)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_pinj,a.keterangan from kop_simpbill_m a "+this.filter,
												"select count(a.no_pinj) from kop_simpbill_m a "+this.filter,
												new Array("a.no_pinj","a.keterangan"),"and",new Array("No Bukti","Keterangan"));
			}		
		}catch(e){
			systemAPI.alert(e);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_kopeg_rptSimpBill";
