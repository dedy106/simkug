window.app_saku3_report_pbh_flIfPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_pbh_flIfPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_pbh_flIfPos";
		this.maximize();
...
window.app_saku3_report_pbh_flIfPos.extend(window.childForm);
window.app_saku3_report_pbh_flIfPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_pbh_flIfPos]::mainButtonClick:"+e);
		}
	},
