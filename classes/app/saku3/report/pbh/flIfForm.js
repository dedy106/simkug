window.app_saku3_report_pbh_flIfForm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_pbh_flIfForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_pbh_flIfForm";
		this.maximize();
...
window.app_saku3_report_pbh_flIfForm.extend(window.childForm);
window.app_saku3_report_pbh_flIfForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_pbh_rptIfForm";
			...
			systemAPI.alert("[app_saku3_report_pbh_flIfForm]::mainButtonClick:"+e);
		}
	},
