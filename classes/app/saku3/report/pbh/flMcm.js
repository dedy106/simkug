window.app_saku3_report_pbh_flMcm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_pbh_flMcm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_pbh_flMcm";
		this.maximize();
...
window.app_saku3_report_pbh_flMcm.extend(window.childForm);
window.app_saku3_report_pbh_flMcm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_pbh_flMcm]::mainButtonClick:"+e);
		}
	},
