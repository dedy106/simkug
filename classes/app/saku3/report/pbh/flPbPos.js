window.app_saku3_report_pbh_flPbPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_pbh_flPbPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_pbh_flPbPos";
		this.maximize();
...
window.app_saku3_report_pbh_flPbPos.extend(window.childForm);
window.app_saku3_report_pbh_flPbPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_pbh_rptPbPos";
			...
			systemAPI.alert("[app_saku3_report_pbh_flPbPos]::mainButtonClick:"+e);
		}
	},
	...
	doOpenPb: function(no_bukti,kode_lokasi){
		...
		nama_report="server_report_saku3_pbh_rptPengajuanPB";
	...
	doOpenVer: function(no_bukti,kode_lokasi){
		...
		nama_report="server_report_saku3_pbh_rptVer";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
	...
	doOpenSpb: function(no_bukti,kode_lokasi){
		...
		nama_report="server_report_saku3_pbh_rptSpb";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
	...
	doOpenKas: function(no_bukti,kode_lokasi){
		...
		nama_report="server_report_saku3_pbh_rptKbPb";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
