window.app_saku3_report_pbh_flPengajuanDana = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_pbh_flPengajuanDana.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_pbh_flPengajuanDana";
		this.maximize();
...
window.app_saku3_report_pbh_flPengajuanDana.extend(window.childForm);
window.app_saku3_report_pbh_flPengajuanDana.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_pbh_rptPengajuanDana";
			...
			systemAPI.alert("[app_saku3_report_pbh_flPengajuanDana]::mainButtonClick:"+e);
		}
	},
