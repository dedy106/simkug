window.app_saku3_report_pbh_flSpb = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_pbh_flSpb.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_pbh_flSpb";
		this.maximize();
...
window.app_saku3_report_pbh_flSpb.extend(window.childForm);
window.app_saku3_report_pbh_flSpb.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_pbh_rptSpb";
			...
			systemAPI.alert("[app_saku3_report_pbh_flSpb]::mainButtonClick:"+e);
		}
	},
