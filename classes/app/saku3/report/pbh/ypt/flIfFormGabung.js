window.app_saku3_report_pbh_ypt_flIfFormGabung = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_pbh_ypt_flIfFormGabung.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_pbh_ypt_flIfFormGabung";
		this.maximize();
...
window.app_saku3_report_pbh_ypt_flIfFormGabung.extend(window.childForm);
window.app_saku3_report_pbh_ypt_flIfFormGabung.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_pbh_ypt_flIfFormGabung]::mainButtonClick:"+e);
		}
	},
