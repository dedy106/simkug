window.app_saku3_report_pbh_ypt_flIfKartu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_pbh_ypt_flIfKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_pbh_ypt_flIfKartu";
		this.maximize();
...
window.app_saku3_report_pbh_ypt_flIfKartu.extend(window.childForm);
window.app_saku3_report_pbh_ypt_flIfKartu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_pbh_ypt_rptIfKartu";
			...
			systemAPI.alert("[app_saku3_report_pbh_ypt_flIfKartu]::mainButtonClick:"+e);
		}
	},
