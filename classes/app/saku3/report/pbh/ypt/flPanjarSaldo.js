window.app_saku3_report_pbh_ypt_flPanjarSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_pbh_ypt_flPanjarSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_pbh_ypt_flPanjarSaldo";
		this.maximize();
...
window.app_saku3_report_pbh_ypt_flPanjarSaldo.extend(window.childForm);
window.app_saku3_report_pbh_ypt_flPanjarSaldo.implement({
		...
		try{			
			...
			if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data PB",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_pb, a.keterangan from panjar_m a "+filter,
												"select count(a.no_pb) from panjar_m a "+filter,
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_pbh_ypt_rptPanjarSaldo";
			...
			systemAPI.alert("[app_saku3_report_pbh_ypt_flPanjarSaldo]::mainButtonClick:"+e);
		}
	},
