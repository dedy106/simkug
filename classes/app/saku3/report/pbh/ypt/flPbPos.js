window.app_saku3_report_pbh_ypt_flPbPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_pbh_ypt_flPbPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_pbh_ypt_flPbPos";
		this.maximize();
...
window.app_saku3_report_pbh_ypt_flPbPos.extend(window.childForm);
window.app_saku3_report_pbh_ypt_flPbPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_pbh_ypt_rptPbPos";
			...
			systemAPI.alert("[app_saku3_report_pbh_ypt_flPbPos]::mainButtonClick:"+e);
		}
	},
