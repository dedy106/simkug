// JavaScript Document
window.app_saku3_report_pbh_ypt_flKbJurnalPtg = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_pbh_ypt_flKbJurnalPtg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_pbh_ypt_flKbJurnalPtg";
		this.maximize();
...
window.app_saku3_report_pbh_ypt_flKbJurnalPtg.extend(window.portalui_childForm);
window.app_saku3_report_pbh_ypt_flKbJurnalPtg.implement({
	doEllipseClick: function(sender, col, row){
		...
		if (row == 3)
		{
			...
			this.filterRep.filterStr("a.kode_pp",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+ " and a.modul='KBPTG' ";
	...
	doSelectCell: function(sender, col, row){
		...
		this.filterRep.setSGFilterRowTipe(this.sg1, row,new Array(0,1,2,3,4),new  Array("3","123","123","123"));
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.filter=this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"where") +
						...
						this.filterRep.filterStr("a.no_kas",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and")+" and a.modul='KBPTG' ";
