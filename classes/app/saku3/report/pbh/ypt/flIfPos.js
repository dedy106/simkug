window.app_saku3_report_pbh_ypt_flIfPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_pbh_ypt_flIfPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_pbh_ypt_flIfPos";
		this.maximize();
...
window.app_saku3_report_pbh_ypt_flIfPos.extend(window.childForm);
window.app_saku3_report_pbh_ypt_flIfPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_pbh_ypt_rptIfPos";
			...
			systemAPI.alert("[app_saku3_report_pbh_ypt_flIfPos]::mainButtonClick:"+e);
		}
	},
