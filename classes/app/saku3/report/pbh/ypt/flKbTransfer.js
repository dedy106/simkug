window.app_saku3_report_pbh_ypt_flKbTransfer = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_pbh_ypt_flKbTransfer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_pbh_ypt_flKbTransfer";
		this.maximize();
...
window.app_saku3_report_pbh_ypt_flKbTransfer.extend(window.childForm);
window.app_saku3_report_pbh_ypt_flKbTransfer.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptKbTransfer";
				if (this.sg1.getCell(2,4)=="Detail")
				{
					this.nama_report = "server_report_saku2_kopeg_kbitt_rptKbTransferDetail";
				}
			...
			systemAPI.alert("[app_saku3_report_pbh_ypt_flKbTransfer]::mainButtonClick:"+e);
		}
	},
