window.app_saku3_report_pbh_ypt_flPbPosYpt = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_pbh_ypt_flPbPosYpt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_pbh_ypt_flPbPosYpt";
		this.maximize();
...
window.app_saku3_report_pbh_ypt_flPbPosYpt.extend(window.childForm);
window.app_saku3_report_pbh_ypt_flPbPosYpt.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_pbh_ypt_rptPbPosYpt";
			...
			systemAPI.alert("[app_saku3_report_pbh_ypt_flPbPosYpt]::mainButtonClick:"+e);
		}
	},
