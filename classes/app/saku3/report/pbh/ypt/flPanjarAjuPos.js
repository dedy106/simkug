window.app_saku3_report_pbh_ypt_flPanjarAjuPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_pbh_ypt_flPanjarAjuPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_pbh_ypt_flPanjarAjuPos";
		this.maximize();
...
window.app_saku3_report_pbh_ypt_flPanjarAjuPos.extend(window.childForm);
window.app_saku3_report_pbh_ypt_flPanjarAjuPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_pbh_ypt_rptPanjarAjuPos";
			...
			systemAPI.alert("[app_saku3_report_pbh_ypt_flPanjarAjuPos]::mainButtonClick:"+e);
		}
	},
