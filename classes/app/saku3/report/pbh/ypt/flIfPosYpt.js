window.app_saku3_report_pbh_ypt_flIfPosYpt = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_pbh_ypt_flIfPosYpt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_pbh_ypt_flIfPosYpt";
		this.maximize();
...
window.app_saku3_report_pbh_ypt_flIfPosYpt.extend(window.childForm);
window.app_saku3_report_pbh_ypt_flIfPosYpt.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_pbh_ypt_rptIfPosYpt";
			...
			systemAPI.alert("[app_saku3_report_pbh_ypt_flIfPosYpt]::mainButtonClick:"+e);
		}
	},
	...
	doOpenPb: function(no_bukti,kode_lokasi){
		...
		nama_report="server_report_saku3_pbh_ypt_rptIfFormGabung";
