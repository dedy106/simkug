window.app_saku3_report_pbh_ypt_flPengajuanPB = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_pbh_ypt_flPengajuanPB.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_pbh_ypt_flPengajuanPB";
		this.maximize();
...
window.app_saku3_report_pbh_ypt_flPengajuanPB.extend(window.childForm);
window.app_saku3_report_pbh_ypt_flPengajuanPB.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_pbh_ypt_flPengajuanPB]::mainButtonClick:"+e);
		}
	},
