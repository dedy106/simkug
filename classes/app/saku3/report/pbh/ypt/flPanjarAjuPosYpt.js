window.app_saku3_report_pbh_ypt_flPanjarAjuPosYpt = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_pbh_ypt_flPanjarAjuPosYpt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_pbh_ypt_flPanjarAjuPosYpt";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from pbh_pb_m where kode_lokasi='"+this.app._lokasi+"' and modul='PJAJU' ");
...
window.app_saku3_report_pbh_ypt_flPanjarAjuPosYpt.extend(window.childForm);
window.app_saku3_report_pbh_ypt_flPanjarAjuPosYpt.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_pbh_ypt_rptPanjarAjuPosYpt";
			...
			systemAPI.alert("[app_saku3_report_pbh_ypt_flPanjarAjuPosYpt]::mainButtonClick:"+e);
		}
	},
	...
	doOpenPb: function(no_bukti,kode_lokasi){
		...
		nama_report="server_report_saku3_pbh_ypt_rptPanjarAju";
