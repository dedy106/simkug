window.app_saku3_report_pbh_ypt_flSpb = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_pbh_ypt_flSpb.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_pbh_ypt_flSpb";
		this.maximize();
...
window.app_saku3_report_pbh_ypt_flSpb.extend(window.childForm);
window.app_saku3_report_pbh_ypt_flSpb.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_pbh_ypt_flSpb]::mainButtonClick:"+e);
		}
	},
