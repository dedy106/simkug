window.app_saku3_report_pbh_ypt_flPanjarAju = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_pbh_ypt_flPanjarAju.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_pbh_ypt_flPanjarAju";
		this.maximize();
...
window.app_saku3_report_pbh_ypt_flPanjarAju.extend(window.childForm);
window.app_saku3_report_pbh_ypt_flPanjarAju.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_pbh_ypt_flPanjarAju]::mainButtonClick:"+e);
		}
	},
