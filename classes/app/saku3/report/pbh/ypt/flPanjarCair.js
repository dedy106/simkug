window.app_saku3_report_pbh_ypt_flPanjarCair = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_pbh_ypt_flPanjarCair.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_pbh_ypt_flPanjarCair";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from kas_m where kode_lokasi='"+this.app._lokasi+"' and modul='KBPJCAIR' ");
...
window.app_saku3_report_pbh_ypt_flPanjarCair.extend(window.childForm);
window.app_saku3_report_pbh_ypt_flPanjarCair.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_pbh_ypt_rptPanjarCair";
			...
			systemAPI.alert("[app_saku3_report_pbh_ypt_flPanjarCair]::mainButtonClick:"+e);
		}
	},
