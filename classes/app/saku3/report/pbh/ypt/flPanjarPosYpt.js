window.app_saku3_report_pbh_ypt_flPanjarPosYpt = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_pbh_ypt_flPanjarPosYpt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_pbh_ypt_flPanjarPosYpt";
		this.maximize();
...
window.app_saku3_report_pbh_ypt_flPanjarPosYpt.extend(window.childForm);
window.app_saku3_report_pbh_ypt_flPanjarPosYpt.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_pbh_ypt_rptPanjarPosYpt";
			...
			systemAPI.alert("[app_saku3_report_pbh_ypt_flPanjarPosYpt]::mainButtonClick:"+e);
		}
	},
