window.app_saku3_report_pbh_ypt_flIfForm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_pbh_ypt_flIfForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_pbh_ypt_flIfForm";
		this.maximize();
...
window.app_saku3_report_pbh_ypt_flIfForm.extend(window.childForm);
window.app_saku3_report_pbh_ypt_flIfForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_pbh_ypt_flIfForm]::mainButtonClick:"+e);
		}
	},
