window.app_saku3_report_pbh_ypt_flDokFisik = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_pbh_ypt_flDokFisik.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_pbh_ypt_flDokFisik";
        this.maximize();
...
window.app_saku3_report_pbh_ypt_flDokFisik.extend(window.childForm);
window.app_saku3_report_pbh_ypt_flDokFisik.implement({
	doLoad:function(){
        try{
            ...
            this.dashboard = new webBrowser(this,{bound:[20, 20, this.width - 60, 452]});

			uses("server_report_report");
			this.report = new server_report_report();
			var nama_report="server_report_saku3_pbh_ypt_rptDokFisik";
			this.filter="";
			this.showFilter = "";
			this.lokasi = "";
