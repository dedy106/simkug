window.app_saku3_report_pbh_ypt_flPanjarPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_pbh_ypt_flPanjarPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_pbh_ypt_flPanjarPos";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from pbh_pb_m where kode_lokasi='"+this.app._lokasi+"' and modul='PJPTG' ");
...
window.app_saku3_report_pbh_ypt_flPanjarPos.extend(window.childForm);
window.app_saku3_report_pbh_ypt_flPanjarPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_pbh_ypt_rptPanjarPos";
			...
			systemAPI.alert("[app_saku3_report_pbh_ypt_flPanjarPos]::mainButtonClick:"+e);
		}
	},
	...
	doOpenPb: function(no_bukti,kode_lokasi){
		...
		this.link="1";
		filter = "where a.no_pb='"+no_bukti+"' and a.kode_lokasi='"+kode_lokasi+"' and a.modul='PJPTG' ";
		// filter2="";
		filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1);
		// nama_report="server_report_saku3_pbh_ypt_rptPengajuanPB";
		nama_report="server_report_saku3_pbh_ypt_rptPanjarForm";
