window.app_saku3_report_pbh_flIfCair = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_pbh_flIfCair.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_pbh_flIfCair";
		this.maximize();
...
window.app_saku3_report_pbh_flIfCair.extend(window.childForm);
window.app_saku3_report_pbh_flIfCair.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_pbh_rptIfCair";
			...
			systemAPI.alert("[app_saku3_report_pbh_flIfCair]::mainButtonClick:"+e);
		}
	},
