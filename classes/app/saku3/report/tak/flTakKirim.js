window.app_saku3_report_tak_flTakKirim = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tak_flTakKirim.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tak_flTakKirim";
		this.maximize();
...
window.app_saku3_report_tak_flTakKirim.extend(window.childForm);
window.app_saku3_report_tak_flTakKirim.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tak_rptTakKirim";
			...
			systemAPI.alert("[app_saku3_report_tak_flTakKirim]::mainButtonClick:"+e);
		}
	},
