window.app_saku3_report_tak_flTakSaldoKonsol = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tak_flTakSaldoKonsol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tak_flTakSaldoKonsol";
		this.maximize();
...
window.app_saku3_report_tak_flTakSaldoKonsol.extend(window.childForm);
window.app_saku3_report_tak_flTakSaldoKonsol.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tak_rptTakSaldoKonsol";
			...
			systemAPI.alert("[app_saku3_report_tak_flTakSaldoKonsol]::mainButtonClick:"+e);
		}
	},
