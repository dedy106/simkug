window.app_saku3_report_tak_flTakSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tak_flTakSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tak_flTakSaldo";
		this.maximize();
...
window.app_saku3_report_tak_flTakSaldo.extend(window.childForm);
window.app_saku3_report_tak_flTakSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tak_rptTakSaldo";
			...
			systemAPI.alert("[app_saku3_report_tak_flTakSaldo]::mainButtonClick:"+e);
		}
	},
