window.app_saku3_report_tak_flTakTerima = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tak_flTakTerima.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tak_flTakTerima";
		this.maximize();
...
window.app_saku3_report_tak_flTakTerima.extend(window.childForm);
window.app_saku3_report_tak_flTakTerima.implement({
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.lokasi=this.dbLib.getPeriodeFromSQL("select nama as periode from lokasi where kode_lokasi='"+this.sg1.getCell(2,0)+"'");
					...
					this.nama_report = "server_report_saku3_tak_rptTakTerima";
			...
			systemAPI.alert("[app_saku3_report_tak_flTakTerima]::mainButtonClick:"+e);
		}
	},
