window.app_saku3_report_cianjur_flPjPtgForm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_cianjur_flPjPtgForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_cianjur_flPjPtgForm";
		this.maximize();
...
window.app_saku3_report_cianjur_flPjPtgForm.extend(window.childForm);
window.app_saku3_report_cianjur_flPjPtgForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_cianjur_flPjPtgForm]::mainButtonClick:"+e);
		}
	},
