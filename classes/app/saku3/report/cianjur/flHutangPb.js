window.app_saku3_report_cianjur_flHutangPb = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_cianjur_flHutangPb.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_cianjur_flHutangPb";
		this.maximize();
...
window.app_saku3_report_cianjur_flHutangPb.extend(window.childForm);
window.app_saku3_report_cianjur_flHutangPb.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_cianjur_flHutangPb]::mainButtonClick:"+e);
		}
	},
