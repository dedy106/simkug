window.app_saku3_report_cianjur_flPjAjuForm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_cianjur_flPjAjuForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_cianjur_flPjAjuForm";
		this.maximize();
...
window.app_saku3_report_cianjur_flPjAjuForm.extend(window.childForm);
window.app_saku3_report_cianjur_flPjAjuForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_cianjur_rptPjAjuForm";
			...
			systemAPI.alert("[app_saku3_report_cianjur_flPjAjuForm]::mainButtonClick:"+e);
		}
	},
