window.app_saku3_report_cianjur_flHutangSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_cianjur_flHutangSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_cianjur_flHutangSaldo";
		this.maximize();
...
window.app_saku3_report_cianjur_flHutangSaldo.extend(window.childForm);
window.app_saku3_report_cianjur_flHutangSaldo.implement({
		...
		try{			
			...
			if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Invoice",this.sg1, this.sg1.row, this.sg1.col,
												...
												"select count(a.no_hutang) from hutang_m a "+filter,
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_cianjur_rptHutangSaldo";
			...
			systemAPI.alert("[app_saku3_report_cianjur_flHutangSaldo]::mainButtonClick:"+e);
		}
	},
