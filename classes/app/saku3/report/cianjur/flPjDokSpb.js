window.app_saku3_report_cianjur_flPjDokSpb = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_cianjur_flPjDokSpb.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_cianjur_flPjDokSpb";
		this.maximize();
...
window.app_saku3_report_cianjur_flPjDokSpb.extend(window.childForm);
window.app_saku3_report_cianjur_flPjDokSpb.implement({
		...
		try{			
			...
			if (row ==2)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data SPB",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_spb, a.keterangan from spb_m a "+filter+" and a.modul ='PJ' ",
												"select count(a.no_spb) from spb_m a "+filter+" and a.modul ='PJ' ",
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_cianjur_flPjDokSpb]::mainButtonClick:"+e);
		}
	},
