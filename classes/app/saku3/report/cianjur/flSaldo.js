window. app_saku3_report_cianjur_flSaldo = function(owner)
{
	if (owner)
	{
		window. app_saku3_report_cianjur_flSaldo.prototype.parent.constructor.call(this,owner);
		this.className = " app_saku3_report_cianjur_flSaldo";
		this.maximize();
...
window. app_saku3_report_cianjur_flSaldo.extend(window.childForm);
window. app_saku3_report_cianjur_flSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_cianjur_rptSaldo";
