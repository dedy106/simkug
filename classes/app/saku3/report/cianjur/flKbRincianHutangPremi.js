window.app_saku3_report_cianjur_flKbRincianHutangPremi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_cianjur_flKbRincianHutangPremi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_cianjur_flKbRincianHutangPremi";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from trans_m where kode_lokasi='"+this.app._lokasi+"' and form='KBMULTI'");
...
window.app_saku3_report_cianjur_flKbRincianHutangPremi.extend(window.childForm);
window.app_saku3_report_cianjur_flKbRincianHutangPremi.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from trans_m where kode_lokasi='"+this.app._lokasi+"' and form='KBMULTI' order by periode",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_cianjur_rptKbRincianHutangPremi";
			...
			systemAPI.alert("[app_saku3_report_cianjur_flKbRincianHutangPremi]::mainButtonClick:"+e);
		}
	},
