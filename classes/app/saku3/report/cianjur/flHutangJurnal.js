window.app_saku3_report_cianjur_flHutangJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_cianjur_flHutangJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_cianjur_flHutangJurnal";
		this.maximize();
...
window.app_saku3_report_cianjur_flHutangJurnal.extend(window.childForm);
window.app_saku3_report_cianjur_flHutangJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_saku3_cianjur_rptHutangJurnal";
