window.app_saku3_report_cianjur_flPjAjuForm2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_cianjur_flPjAjuForm2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_cianjur_flPjAjuForm2";
		this.maximize();
...
window.app_saku3_report_cianjur_flPjAjuForm2.extend(window.childForm);
window.app_saku3_report_cianjur_flPjAjuForm2.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_cianjur_flPjAjuForm2]::mainButtonClick:"+e);
		}
	},
