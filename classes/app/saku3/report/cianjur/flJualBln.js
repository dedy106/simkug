window.app_saku3_report_cianjur_flJualBln = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_cianjur_flJualBln.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_cianjur_flJualBln";
		this.maximize();
...
window.app_saku3_report_cianjur_flJualBln.extend(window.childForm);
window.app_saku3_report_cianjur_flJualBln.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_cianjur_rptJualBln";
			...
			systemAPI.alert("[app_saku3_report_cianjur_flJualBln]::mainButtonClick:"+e);
		}
	},
