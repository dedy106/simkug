window.app_saku3_report_cianjur_flPjAju = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_cianjur_flPjAju.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_cianjur_flPjAju";
		this.maximize();
...
window.app_saku3_report_cianjur_flPjAju.extend(window.childForm);
window.app_saku3_report_cianjur_flPjAju.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_cianjur_rptPjAju";
			...
			systemAPI.alert("[app_saku3_report_cianjur_flPjAju]::mainButtonClick:"+e);
		}
	},
