window.app_saku3_report_cianjur_flProyekList = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_cianjur_flProyekList.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_cianjur_flProyekList";
		this.maximize();
...
window.app_saku3_report_cianjur_flProyekList.extend(window.childForm);
window.app_saku3_report_cianjur_flProyekList.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_cianjur_rptProyekList";
			...
			systemAPI.alert("[app_saku3_report_cianjur_flProyekList]::mainButtonClick:"+e);
		}
	},
