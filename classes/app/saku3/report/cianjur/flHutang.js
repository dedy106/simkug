window.app_saku3_report_cianjur_flHutang = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_cianjur_flHutang.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_cianjur_flHutang";
		this.maximize();
...
window.app_saku3_report_cianjur_flHutang.extend(window.childForm);
window.app_saku3_report_cianjur_flHutang.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_cianjur_rptHutang";
			...
			systemAPI.alert("[app_saku3_report_cianjur_flHutang]::mainButtonClick:"+e);
		}
	},
