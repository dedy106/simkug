window.app_saku3_report_cianjur_flHutangSpb = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_cianjur_flHutangSpb.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_cianjur_flHutangSpb";
		this.maximize();
...
window.app_saku3_report_cianjur_flHutangSpb.extend(window.childForm);
window.app_saku3_report_cianjur_flHutangSpb.implement({
		...
		try{			
			...
			if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data SPB",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_spb, a.keterangan from spb_m a "+filter+" and a.modul='PBHU'",
												"select count(a.no_spb) from spb_m a "+filter+" and a.modul='PBHU'",
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_cianjur_flHutangSpb]::mainButtonClick:"+e);
		}
	},
