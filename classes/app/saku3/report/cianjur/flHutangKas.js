window.app_saku3_report_cianjur_flHutangKas = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_cianjur_flHutangKas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_cianjur_flHutangKas";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from trans_m where kode_lokasi='"+this.app._lokasi+"' and modul='KBSPB'");
...
window.app_saku3_report_cianjur_flHutangKas.extend(window.childForm);
window.app_saku3_report_cianjur_flHutangKas.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_saku3_cianjur_rptBuktiBank";
