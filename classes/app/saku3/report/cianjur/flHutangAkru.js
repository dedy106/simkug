window.app_saku3_report_cianjur_flHutangAkru = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_cianjur_flHutangAkru.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_cianjur_flHutangAkru";
		this.maximize();
...
window.app_saku3_report_cianjur_flHutangAkru.extend(window.childForm);
window.app_saku3_report_cianjur_flHutangAkru.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_cianjur_flHutangAkru]::mainButtonClick:"+e);
		}
	},
