window.app_saku3_report_cianjur_flOtorisasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_cianjur_flOtorisasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_cianjur_flOtorisasi";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Kode Otorisasi","All",""));
...
window.app_saku3_report_cianjur_flOtorisasi.extend(window.childForm);
window.app_saku3_report_cianjur_flOtorisasi.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row ==	1)
			{
				this.filterRep.ListDataSGFilter(this, "Data Otorisasi",this.sg1, this.sg1.row, this.sg1.col,
														  "select nik from app_otorisasi "+
														   this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  "select count(nik) from app_otorisasi "+
														  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  new Array("nik"),"and");
			}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_cianjur_rptOtorisasi";
			...
			systemAPI.alert("[app_saku3_report_cianjur_flOtorisasi]::mainButtonClick:"+e);
		}
	},
