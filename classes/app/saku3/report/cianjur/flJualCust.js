window.app_saku3_report_cianjur_flJualCust = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_cianjur_flJualCust.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_cianjur_flJualCust";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from apo_brg_jual_m  ");
...
window.app_saku3_report_cianjur_flJualCust.extend(window.childForm);
window.app_saku3_report_cianjur_flJualCust.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_cianjur_rptJualCust";
			...
			systemAPI.alert("[app_saku3_report_cianjur_flJualCust]::mainButtonClick:"+e);
		}
	},
