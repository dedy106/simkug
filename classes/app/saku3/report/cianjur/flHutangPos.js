window.app_saku3_report_cianjur_flHutangPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_cianjur_flHutangPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_cianjur_flHutangPos";
		this.maximize();
...
window.app_saku3_report_cianjur_flHutangPos.extend(window.childForm);
window.app_saku3_report_cianjur_flHutangPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_cianjur_rptHutangPos";
			...
			systemAPI.alert("[app_saku3_report_cianjur_flHutangPos]::mainButtonClick:"+e);
		}
	},
