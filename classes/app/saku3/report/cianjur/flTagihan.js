window. app_saku3_report_cianjur_flTagihan = function(owner)
{
	if (owner)
	{
		window. app_saku3_report_cianjur_flTagihan.prototype.parent.constructor.call(this,owner);
		this.className = " app_saku3_report_cianjur_flTagihan";
		this.maximize();
...
window. app_saku3_report_cianjur_flTagihan.extend(window.childForm);
window. app_saku3_report_cianjur_flTagihan.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row ==	3)
			{
				var sql=this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+
				...
				this.filterRep.ListDataSGFilter(this, "Data Tagihan",this.sg1, this.sg1.row, this.sg1.col,
														  "select a.no_bukti, keterangan from trans_m a "+sql,
														  "select count(a.no_bukti) from trans_m a "+sql,
														  new Array("a.no_bukti","a.keterangan"),"and");
			}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_cianjur_rptTagihan";
	...
	doOpenBb: function(kode_akun,kode_lokasi){
		...
		nama_report="server_report_saku2_kopeg_sju_rptKbBukuBesar";
