window.app_saku3_report_cianjur_flPjSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_cianjur_flPjSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_cianjur_flPjSaldo";
		this.maximize();
...
window.app_saku3_report_cianjur_flPjSaldo.extend(window.childForm);
window.app_saku3_report_cianjur_flPjSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_cianjur_rptPjSaldo";
			...
			systemAPI.alert("[app_saku3_report_cianjur_flPjSaldo]::mainButtonClick:"+e);
		}
	},
