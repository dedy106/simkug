window.app_saku3_report_cianjur_flCust = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_cianjur_flCust.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_cianjur_flCust";
		this.maximize();
...
window.app_saku3_report_cianjur_flCust.extend(window.childForm);
window.app_saku3_report_cianjur_flCust.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_cianjur_rptCust";
			...
			systemAPI.alert("[app_saku3_report_cianjur_flCust]::mainButtonClick:"+e);
		}
	},
