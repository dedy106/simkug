window.app_saku3_report_cianjur_flPjKas = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_cianjur_flPjKas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_cianjur_flPjKas";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from trans_m where kode_lokasi='"+this.app._lokasi+"' and modul='KBSPBPJ'");
...
window.app_saku3_report_cianjur_flPjKas.extend(window.childForm);
window.app_saku3_report_cianjur_flPjKas.implement({
