window.app_saku3_report_spj_flPdRekapPpTu2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spj_flPdRekapPpTu2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spj_flPdRekapPpTu2";
		this.maximize();
...
window.app_saku3_report_spj_flPdRekapPpTu2.extend(window.childForm);
window.app_saku3_report_spj_flPdRekapPpTu2.implement({
			...
			if (row == 2)
			{
				...
				if (this.app._userStatus=="A")
				{
					var sql="select a.kode_pp, a.nama "+
						"from pp a "+
						"inner join (select a.kode_pp,a.kode_lokasi from angg_r a "+
						"			where  '"+tahun+"' between  substring(a.periode1,1,4) and substring(a.periode2,1,4)  "+filter+" and a.modul='ITKBAJU' "+
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_spj_rptPdRekapPpTu2";
			...
			systemAPI.alert("[app_saku3_report_spj_flPdRekapPpTu2]::mainButtonClick:"+e);
		}
	},
