window.app_saku3_report_spj_flPdPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spj_flPdPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spj_flPdPos";
		this.maximize();
...
window.app_saku3_report_spj_flPdPos.extend(window.childForm);
window.app_saku3_report_spj_flPdPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_spj_rptPdPos";
			...
			systemAPI.alert("[app_saku3_report_spj_flPdPos]::mainButtonClick:"+e);
		}
	},
