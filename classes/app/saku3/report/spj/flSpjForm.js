window.app_saku3_report_spj_flSpjForm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spj_flSpjForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spj_flSpjForm";
		this.maximize();
...
window.app_saku3_report_spj_flSpjForm.extend(window.childForm);
window.app_saku3_report_spj_flSpjForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_spj_flSpjForm]::mainButtonClick:"+e);
		}
	},
