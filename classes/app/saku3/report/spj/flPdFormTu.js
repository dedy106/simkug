window.app_saku3_report_spj_flPdFormTu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spj_flPdFormTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spj_flPdFormTu";
		this.maximize();
...
window.app_saku3_report_spj_flPdFormTu.extend(window.childForm);
window.app_saku3_report_spj_flPdFormTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_spj_flPdFormTu]::mainButtonClick:"+e);
		}
	},
