window.app_saku3_report_spj_flSpjRole = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spj_flSpjRole.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spj_flSpjRole";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,0,new Array(0,1,2), new Array("NIK","All",""));
...
window.app_saku3_report_spj_flSpjRole.extend(window.childForm);
window.app_saku3_report_spj_flSpjRole.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_spj_rptSpjRole";
			...
			systemAPI.alert("[app_saku3_report_spj_flSpjRole]::mainButtonClick:"+e);
		}
	},
