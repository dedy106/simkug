window.app_saku3_report_spj_flPdRekapTu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spj_flPdRekapTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spj_flPdRekapTu";
		this.maximize();
...
window.app_saku3_report_spj_flPdRekapTu.extend(window.childForm);
window.app_saku3_report_spj_flPdRekapTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_spj_rptPdRekapTu";
			...
			systemAPI.alert("[app_saku3_report_spj_flPdRekapTu]::mainButtonClick:"+e);
		}
	},
