window.app_saku3_report_spj_flSpjSuper = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spj_flSpjSuper.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spj_flSpjSuper";
		this.maximize();
...
window.app_saku3_report_spj_flSpjSuper.extend(window.childForm);
window.app_saku3_report_spj_flSpjSuper.implement({
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							" and b.kode_bidang='"+this.bidang+"' " +  "  and a.modul='PD21'  ";
				...
				{
					this.nama_report = "server_report_saku3_spj_rptSpjSp";
				}
				if (this.sg1.getCell(2,5)=="Surat Perintah Manager")
				{
					this.nama_report = "server_report_saku3_spj_rptSpjSpMgr";
				}
			...
			systemAPI.alert("[app_saku3_report_spj_flSpjSuper]::mainButtonClick:"+e);
		}
	},
