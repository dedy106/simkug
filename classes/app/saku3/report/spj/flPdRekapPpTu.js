window.app_saku3_report_spj_flPdRekapPpTu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spj_flPdRekapPpTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spj_flPdRekapPpTu";
		this.maximize();
...
window.app_saku3_report_spj_flPdRekapPpTu.extend(window.childForm);
window.app_saku3_report_spj_flPdRekapPpTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_spj_rptPdRekapPpTu";
			...
			systemAPI.alert("[app_saku3_report_spj_flPdRekapPpTu]::mainButtonClick:"+e);
		}
	},
