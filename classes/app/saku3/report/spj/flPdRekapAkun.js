window.app_saku3_report_spj_flPdRekapAkun = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spj_flPdRekapAkun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spj_flPdRekapAkun";
		this.maximize();
...
window.app_saku3_report_spj_flPdRekapAkun.extend(window.childForm);
window.app_saku3_report_spj_flPdRekapAkun.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_spj_rptPdRekapAkun";
			...
			systemAPI.alert("[app_saku3_report_spj_flPdRekapAkun]::mainButtonClick:"+e);
		}
	},
