window.app_saku3_report_spj_flSpjPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spj_flSpjPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spj_flSpjPos";
		this.maximize();
...
window.app_saku3_report_spj_flSpjPos.extend(window.childForm);
window.app_saku3_report_spj_flSpjPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_spj_rptSpjPos";
			...
			systemAPI.alert("[app_saku3_report_spj_flSpjPos]::mainButtonClick:"+e);
		}
	},
