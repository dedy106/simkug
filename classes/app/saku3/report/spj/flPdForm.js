window.app_saku3_report_spj_flPdForm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spj_flPdForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spj_flPdForm";
		this.maximize();
...
window.app_saku3_report_spj_flPdForm.extend(window.childForm);
window.app_saku3_report_spj_flPdForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_spj_rptPdForm";
			...
			systemAPI.alert("[app_saku3_report_spj_flPdForm]::mainButtonClick:"+e);
		}
	},
