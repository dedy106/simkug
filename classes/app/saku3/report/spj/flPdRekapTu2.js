window.app_saku3_report_spj_flPdRekapTu2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spj_flPdRekapTu2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spj_flPdRekapTu2";
		this.maximize();
...
window.app_saku3_report_spj_flPdRekapTu2.extend(window.childForm);
window.app_saku3_report_spj_flPdRekapTu2.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter =  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("f.kode_pp",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
				...
				this.nama_report = "server_report_saku3_spj_rptPdRekapTu2";
			...
			systemAPI.alert("[app_saku3_report_spj_flPdRekapTu2]::mainButtonClick:"+e);
		}
	},
