window.app_saku3_report_spj_flSpjForm2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spj_flSpjForm2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spj_flSpjForm2";
		this.maximize();
...
window.app_saku3_report_spj_flSpjForm2.extend(window.childForm);
window.app_saku3_report_spj_flSpjForm2.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_spj_flSpjForm2]::mainButtonClick:"+e);
		}
	},
