window.app_saku3_report_spj_flSpjVer = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spj_flSpjVer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spj_flSpjVer";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("No Ver SPPD","All",""));
...
window.app_saku3_report_spj_flSpjVer.extend(window.childForm);
window.app_saku3_report_spj_flSpjVer.implement({
		...
		try{			
			...
			if (row ==4)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data SPJ",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_app, a.maksud from yk_spj_app a "+this.filter, 
												"select count(*) from yk_spj_app a "+this.filter,
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_spj_flSpjVer]::mainButtonClick:"+e);
		}
	},
