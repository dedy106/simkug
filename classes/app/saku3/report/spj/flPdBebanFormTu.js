window.app_saku3_report_spj_flPdBebanFormTu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_spj_flPdBebanFormTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_spj_flPdBebanFormTu";
		this.maximize();
...
window.app_saku3_report_spj_flPdBebanFormTu.extend(window.childForm);
window.app_saku3_report_spj_flPdBebanFormTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_spj_rptPdBebanFormTu";
			...
			systemAPI.alert("[app_saku3_report_spj_flPdBebanFormTu]::mainButtonClick:"+e);
		}
	},
