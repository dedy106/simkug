window.app_saku3_report_siswa_flSisSaldoCdSekolahReg = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisSaldoCdSekolahReg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisSaldoCdSekolahReg";
		this.maximize();
...
window.app_saku3_report_siswa_flSisSaldoCdSekolahReg.extend(window.childForm);
window.app_saku3_report_siswa_flSisSaldoCdSekolahReg.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_siswa_rptSisSaldoCdSekolahReg";
	...
	doOpenKartu: function(kode_lokasi,kode_pp){
		...
		nama_report="server_report_saku3_siswa_rptSisSaldoCdSiswaReg";
