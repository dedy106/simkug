window.app_saku3_report_siswa_flJadwal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flJadwal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flJadwal";
		this.maximize();
	...
	this.ta=this.dbLib.getPeriodeFromSQL("select kode_ta as periode from sis_ta where kode_lokasi='"+this.app._lokasi+"' and kode_pp='"+this.app._kodePP+"' and flag_aktif='1'");
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Tahun Ajaran","=",this.ta));
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Kelas","All",""));
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("Jenis Laporan","=","Kelas"));
	
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_siswa_flJadwal.extend(window.childForm);
window.app_saku3_report_siswa_flJadwal.implement({
	...
	{		
		...
		if (row == 4)
		{
			...
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("Kelas","Harian"));
		}
	},
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siswa_rptJadwal";
