window.app_saku3_report_siswa_flSisEkskul = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisEkskul.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisEkskul";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Ekstrakulikuler", 2);
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(substring(convert(varchar,tgl_input,112),1,6)) as periode from sis_ekskul where kode_lokasi='"+this.app._lokasi+"' and kode_pp='"+this.app._kodePP+"'");
...
window.app_saku3_report_siswa_flSisEkskul.extend(window.childForm);
window.app_saku3_report_siswa_flSisEkskul.implement({
	...
	{		
		...
		if (row == 2)
		{
			var filter=this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
						this.filterRep.filterStr("a.kode_pp",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and"); 
			var sql="select distinct substring(convert(varchar,a.tgl_input,112),1,6) as periode from sis_ekskul a "+filter+" order by substring(convert(varchar,a.tgl_input,112),1,6) desc";
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.filter =this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							  ...
							  this.filterRep.filterStr("b.kode_akt",this.sg1.getCell(1,5),this.sg1.getCell(2,5),this.sg1.getCell(3,5),"and")+
				...
				this.nama_report = "server_report_saku3_siswa_rptSisEkskul";
