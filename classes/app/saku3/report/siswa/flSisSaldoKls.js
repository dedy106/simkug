window.app_saku3_report_siswa_flSisSaldoKls = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisSaldoKls.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisSaldoKls";
		this.maximize();
...
window.app_saku3_report_siswa_flSisSaldoKls.extend(window.childForm);
window.app_saku3_report_siswa_flSisSaldoKls.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_siswa_rptSisSaldoKls";
