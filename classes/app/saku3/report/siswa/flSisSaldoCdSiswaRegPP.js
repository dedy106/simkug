window.app_saku3_report_siswa_flSisSaldoCdSiswaRegPP = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisSaldoCdSiswaRegPP.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisSaldoCdSiswaRegPP";
		this.maximize();
...
window.app_saku3_report_siswa_flSisSaldoCdSiswaRegPP.extend(window.childForm);
window.app_saku3_report_siswa_flSisSaldoCdSiswaRegPP.implement({
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4],["3","23","23","3","123"]);
		...
		try
		{
			...
			else
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
                            this.filterRep.filterStr("a.kode_pp",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
                            this.filterRep.filterStr("g.kode_ta",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4),"and");
				...
				this.filter2 =this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,2)+"/"+this.sg1.getCell(2,3)+"/"+this.filter3;
				this.showFilter = this.filterRep.showFilter(this.sg1);
				
				
				this.nama_report = "server_report_saku3_siswa_rptSisSaldoCdSiswaRegPP";
