window.app_saku3_report_siswa_flSisKugSiswa = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisKugSiswa.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisKugSiswa";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("NIS","=",this.app._userLog));
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_siswa_flSisKugSiswa.extend(window.childForm);
window.app_saku3_report_siswa_flSisKugSiswa.implement({
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3],["3","23","3","123"]);
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_siswa_rptSisKugSiswa";
	...
	doOpenTagihan: function(){
		
	
		this.link="1";
		filter = "";
		filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,2)+"/"+this.sg1.getCell(2,3);
		nama_report="server_report_saku3_siswa_rptSisKugSiswaTagihan";
