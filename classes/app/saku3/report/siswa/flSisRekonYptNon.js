window.app_saku3_report_siswa_flSisRekonYptNon = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisRekonYptNon.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisRekonYptNon";
		this.maximize();
...
window.app_saku3_report_siswa_flSisRekonYptNon.extend(window.childForm);
window.app_saku3_report_siswa_flSisRekonYptNon.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siswa_rptSisRekonYptNon";
