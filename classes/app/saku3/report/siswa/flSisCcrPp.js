window.app_saku3_report_siswa_flSisCcrPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisCcrPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisCcrPp";
		this.maximize();
...
window.app_saku3_report_siswa_flSisCcrPp.extend(window.childForm);
window.app_saku3_report_siswa_flSisCcrPp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_siswa_rptSisCcrPp";
