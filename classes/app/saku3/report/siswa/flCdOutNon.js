window.app_saku3_report_siswa_flCdOutNon = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flCdOutNon.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flCdOutNon";
		this.maximize();
...
window.app_saku3_report_siswa_flCdOutNon.extend(window.childForm);
window.app_saku3_report_siswa_flCdOutNon.implement({
