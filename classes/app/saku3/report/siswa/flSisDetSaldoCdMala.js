window.app_saku3_report_siswa_flSisDetSaldoCdMala = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisDetSaldoCdMala.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisDetSaldoCdMala";
		this.maximize();
...
window.app_saku3_report_siswa_flSisDetSaldoCdMala.extend(window.childForm);
window.app_saku3_report_siswa_flSisDetSaldoCdMala.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			// 	var sql1="select a.no_tes,a.nama from aka_MALA a "+filter;
			// 	var sql2="select count(a.no_tes) from aka_MALA a "+filter;
