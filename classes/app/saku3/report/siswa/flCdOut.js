window.app_saku3_report_siswa_flCdOut = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flCdOut.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flCdOut";
		this.maximize();
...
window.app_saku3_report_siswa_flCdOut.extend(window.childForm);
window.app_saku3_report_siswa_flCdOut.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_siswa_flCdOut]::mainButtonClick:"+e);
		}
	},
