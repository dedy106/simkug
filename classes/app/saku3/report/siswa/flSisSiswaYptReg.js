window.app_saku3_report_siswa_flSisSiswaYptReg = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisSiswaYptReg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisSiswaYptReg";
		this.maximize();
...
window.app_saku3_report_siswa_flSisSiswaYptReg.extend(window.childForm);
window.app_saku3_report_siswa_flSisSiswaYptReg.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row == 2)
			{
				...
				"select distinct a.kode_ta,b.nama from sis_siswareg a "+
				"inner join sis_angkat b on a.kode_ta=b.kode_akt and a.kode_lokasi=b.kode_lokasi and a.kode_pp=b.kode_pp "+filter+" order by a.kode_ta desc ",
				"select count (distinct a.kode_ta) from sis_siswareg a "+
															"inner join sis_angkat b on a.kode_ta=b.kode_akt and a.kode_lokasi=b.kode_lokasi and a.kode_pp=b.kode_pp "+filter,
			...
			if (row == 3)
			{
				var filter=this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("kode_ta",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
				this.filterRep.ListDataSGFilter(this, "Data Calon Siswa",this.sg1, this.sg1.row, this.sg1.col,
												"select no_reg, nama from sis_siswareg "+filter,
												"select count(*) from sis_siswareg "+filter,
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.kode_pp",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("a.kode_ta",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
				...
				this.nama_report = "server_report_saku3_siswa_rptSisSiswaYptReg";
