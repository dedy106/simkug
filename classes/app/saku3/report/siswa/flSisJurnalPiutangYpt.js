window.app_saku3_report_siswa_flSisJurnalPiutangYpt = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisJurnalPiutangYpt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisJurnalPiutangYpt";
		this.maximize();
...
window.app_saku3_report_siswa_flSisJurnalPiutangYpt.extend(window.childForm);
window.app_saku3_report_siswa_flSisJurnalPiutangYpt.implement({
		...
		try{			
			...
			if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Bukti",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_kas, a.keterangan from sis_bill_m a "+this.filter,
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_siswa_flSisJurnalPiutangYpt]::mainButtonClick:"+e);
		}
	},
