window.app_saku3_report_siswa_flSisSaldoJur = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisSaldoJur.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisSaldoJur";
		this.maximize();
...
window.app_saku3_report_siswa_flSisSaldoJur.extend(window.childForm);
window.app_saku3_report_siswa_flSisSaldoJur.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_siswa_rptSisSaldoJur";
