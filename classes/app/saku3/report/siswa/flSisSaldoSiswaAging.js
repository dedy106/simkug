window.app_saku3_report_siswa_flSisSaldoSiswaAging = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisSaldoSiswaAging.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisSaldoSiswaAging";
		this.maximize();
...
window.app_saku3_report_siswa_flSisSaldoSiswaAging.extend(window.childForm);
window.app_saku3_report_siswa_flSisSaldoSiswaAging.implement({
	...
	{	
		if(this.app._userStatus == "A"){
			...
			this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6,7,8],["3","3","3","123","123","123","123","13","3"]);
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5,6,7,8],[2,2,0,2,2,2,2,0,0]);	
		}	
		if (row == 2)
		{
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filterpp = this.filterRep.filterStr("x.kode_pp",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");

				this.filter2 =this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,2)+"/"+this.sg1.getCell(2,8)+"/"+this.filterpp;
				this.showFilter = this.filterRep.showFilter(this.sg1);
				
				
				this.nama_report = "server_report_saku3_siswa_rptSisSaldoSiswaAging";
