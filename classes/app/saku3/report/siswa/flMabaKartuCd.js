window.app_saku3_report_siswa_flMabaKartuCd = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flMabaKartuCd.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flMabaKartuCd";
		this.maximize();
...
window.app_saku3_report_siswa_flMabaKartuCd.extend(window.childForm);
window.app_saku3_report_siswa_flMabaKartuCd.implement({
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6],["3","3","123","123","123","13","3"]);
		...
		try
		{
			...
			else
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							// this.filterRep.filterStr("a.flag_status",this.sg1.getCell(1,5),this.sg1.getCell(2,5).substr(0,1),this.sg1.getCell(3,5).substr(0,1),"and");
				this.filter2 =this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,2)+"/"+this.sg1.getCell(2,6);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				
				
				this.nama_report = "server_report_saku3_siswa_rptMabaKartuCd";
