window.app_saku3_report_siswa_flSisSaldoCdSiswa3 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisSaldoCdSiswa3.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisSaldoCdSiswa3";
		this.maximize();
...
window.app_saku3_report_siswa_flSisSaldoCdSiswa3.extend(window.childForm);
window.app_saku3_report_siswa_flSisSaldoCdSiswa3.implement({
		...
		try{			
			...
			if (row == 8)
			{
				...
				var sql1="select distinct a.no_bukti,b.keterangan "+
						...
						"		from trans_m a "+
						"		where a.form in ('CDIN','CDMUTMALA') "+
						"		union all "+
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_siswa_rptSisSaldoCdSiswa3";
