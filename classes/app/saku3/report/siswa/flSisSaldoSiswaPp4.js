window.app_saku3_report_siswa_flSisSaldoSiswaPp4 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisSaldoSiswaPp4.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisSaldoSiswaPp4";
		this.maximize();
	...
	this.periode2=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from sis_rekon_d where kode_lokasi='"+this.app._lokasi+"'");
	...
	// this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Periode Rekon","=",this.periode2));
	...
	this.gridLib.SGEditData(this.sg1,5,new Array(0,1,2), new Array("Tampil Nol","=","Tidak"));
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_siswa_flSisSaldoSiswaPp4.extend(window.childForm);
window.app_saku3_report_siswa_flSisSaldoSiswaPp4.implement({
	doEllipseClick: function(sender, col, row){
		try{			
            ...
            if (row == 3)
			{
				...
				var sql="select a.nis, a.nama "+
                "from sis_siswa a "+filter;
                var sql2="select count(a.nis) "+
                "from sis_siswa a "+filter;
                this.filterRep.ListDataSGFilter(this, "Data Siswa",this.sg1, this.sg1.row, this.sg1.col,sql,sql2,
                new Array("a.nis","a.nama"),"and",new Array("NIS","Nama"));
	...
	{		
		...
		// {
		// 	var filter=this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where");
		// 	var sql="select distinct a.periode from sis_rekon_d a "+filter+" order by a.periode desc";
		// 	this.sg1.columns.get(2).pickList.clear();
		// 	this.dbLib.setItemsFromSQL(sql,[this.sg1.columns.get(2).pickList]);		
        // }
		...
		try
		{
			...
			else
			{
                ...
                this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
                              ...
                              this.filterRep.filterStr("a.nis",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4),"and");
				this.filter2 =this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,2)+"/"+this.sg1.getCell(2,4)+"/"+this.sg1.getCell(1,1)+"/"+this.sg1.getCell(2,5);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				
				
				this.nama_report = "server_report_saku3_siswa_rptSisSaldoSiswaPp4";
