window.app_saku3_report_siswa_flKelas = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flKelas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flKelas";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("Kode Kelas","All",""));
	
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_siswa_flKelas.extend(window.childForm);
window.app_saku3_report_siswa_flKelas.implement({
		...
		try{			
			...
			if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Jurusan",this.sg1, this.sg1.row, this.sg1.col,
												...
												new Array("a.kode_jur","a.nama"),"and",new Array("Kode","Keterangan"));				
			}
			if (row ==4)
			{
				filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siswa_rptKelas";
