window.app_saku3_report_siswa_flMhsKartuCd = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flMhsKartuCd.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flMhsKartuCd";
		this.maximize();
...
window.app_saku3_report_siswa_flMhsKartuCd.extend(window.childForm);
window.app_saku3_report_siswa_flMhsKartuCd.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_siswa_rptMhsKartuCd";
