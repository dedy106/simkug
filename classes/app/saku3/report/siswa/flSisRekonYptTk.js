window.app_saku3_report_siswa_flSisRekonYptTk = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisRekonYptTk.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisRekonYptTk";
		this.maximize();
...
window.app_saku3_report_siswa_flSisRekonYptTk.extend(window.childForm);
window.app_saku3_report_siswa_flSisRekonYptTk.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siswa_rptSisRekonYptTk";
