window.app_saku3_report_siswa_flSisPenilaian = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisPenilaian.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisPenilaian";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Penilaian Siswa", 2);
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(substring(convert(varchar,tgl_input,112),1,6)) as periode from sis_nilai_m where kode_lokasi='"+this.app._lokasi+"' and kode_pp='"+this.app._kodePP+"'");
...
window.app_saku3_report_siswa_flSisPenilaian.extend(window.childForm);
window.app_saku3_report_siswa_flSisPenilaian.implement({
	...
	{		
		...
		if (row == 2)
		{
			var filter=this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
						this.filterRep.filterStr("a.kode_pp",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and"); 
			var sql="select distinct substring(convert(varchar,a.tgl_input,112),1,6) as periode from sis_nilai_m a "+filter+" order by substring(convert(varchar,a.tgl_input,112),1,6) desc";
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.filter =this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							  this.filterRep.filterStr("a.kode_pp",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							  this.filterRep.filterStr("substring(convert(varchar,a.tgl_input,112),1,6)",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
							  ...
							  this.filterRep.filterStr("g.kode_akt",this.sg1.getCell(1,5),this.sg1.getCell(2,5),this.sg1.getCell(3,5),"and")+
							  this.filterRep.filterStr("g.nis",this.sg1.getCell(1,6),this.sg1.getCell(2,6),this.sg1.getCell(3,6),"and");
				...
				this.nama_report = "server_report_saku3_siswa_rptSisPenilaian";
