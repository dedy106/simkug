window.app_saku3_report_siswa_flSisKartuYpt = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisKartuYpt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisKartuYpt";
		this.maximize();
...
window.app_saku3_report_siswa_flSisKartuYpt.extend(window.childForm);
window.app_saku3_report_siswa_flSisKartuYpt.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_siswa_rptSisKartuYpt";
