window.app_saku3_report_siswa_flSisRekon = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisRekon.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisRekon";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("No Rekon","All",""));;
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_siswa_flSisRekon.extend(window.childForm);
window.app_saku3_report_siswa_flSisRekon.implement({
		...
		if (row == 2)
			...
			if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Rekon",this.sg1, this.sg1.row, this.sg1.col,
												...
												new Array("a.no_rekon","a.keterangan"),"and",new Array("No Rekon","Keterangan"));
			}		
		}catch(e){
			systemAPI.alert(e);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							  this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							  this.filterRep.filterStr("c.kode_tingkat",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
							  this.filterRep.filterStr("a.no_rekon",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and");
				...
				{
					this.nama_report = "server_report_saku3_siswa_rptSisRekon";
				}
				if (this.sg1.getCell(2,2)=="SD")
				{
					this.nama_report = "server_report_saku3_siswa_rptSisRekonSd";
				}
				if (this.sg1.getCell(2,2)=="SMP")
				{
					this.nama_report = "server_report_saku3_siswa_rptSisRekonSmp";
				}
				if (this.sg1.getCell(2,2)=="SMA")
				{
					this.nama_report = "server_report_saku3_siswa_rptSisRekonSma";
				}
				if (this.sg1.getCell(2,2)=="ASM")
				{
					this.nama_report = "server_report_saku3_siswa_rptSisRekonAsm";
				}
