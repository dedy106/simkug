window.app_saku3_report_siswa_flTarifParam = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flTarifParam.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flTarifParam";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Angkatan","=",this.periode));
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Output Laporan","=","Layar"));
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_siswa_flTarifParam.extend(window.childForm);
window.app_saku3_report_siswa_flTarifParam.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siswa_rptTarifParam";
