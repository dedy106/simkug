window.app_saku3_report_siswa_flSisJurnalRekonYptNon = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisJurnalRekonYptNon.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisJurnalRekonYptNon";
		this.maximize();
...
window.app_saku3_report_siswa_flSisJurnalRekonYptNon.extend(window.childForm);
window.app_saku3_report_siswa_flSisJurnalRekonYptNon.implement({
		...
		try{			
			...
			if (row ==3)
			{
				this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							" and a.modul in ('LOADSISKB','KBBILSIS') ";
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from kas_m where kode_lokasi='"+this.app._lokasi+"' and modul in ('LOADSISKB','KBBILSIS') order by periode desc",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_siswa_flSisJurnalRekonYptNon]::mainButtonClick:"+e);
		}
	},
