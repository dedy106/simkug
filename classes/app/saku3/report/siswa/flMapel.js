window.app_saku3_report_siswa_flMapel = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flMapel.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flMapel";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Kode Pelajaran","All",""));
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Sifat Pelajaran","All",""));
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Kode PP","All",this.app._kodePP));
	
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_siswa_flMapel.extend(window.childForm);
window.app_saku3_report_siswa_flMapel.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row ==2)
			{
				this.filterRep.ListDataSGFilter(this, "Data Sifat Pelajaran",this.sg1, this.sg1.row, this.sg1.col,
														  "select a.sifat, a.keterangan from sis_matpel a  "+
														   this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(2,0)," where "),
														  "select count(a.sifat) from sis_matpel a "+
														  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(2,0)," where "),
														  ["a.sifat","a.keterangan"],"and",["Kode","Nama"]);
			}	
			if (row ==3)
			{
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							  this.filterRep.filterStr("a.kode_matpel",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							  this.filterRep.filterStr("a.sifat",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
							  this.filterRep.filterStr("a.kode_pp",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and");							  

							  this.showFilter = this.filterRep.showFilter(this.sg1);
				this.nama_report = "server_report_saku3_siswa_rptMapel";
