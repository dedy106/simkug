window. app_saku3_report_siswa_flCdIn = function(owner)
{
	if (owner)
	{
		window. app_saku3_report_siswa_flCdIn.prototype.parent.constructor.call(this,owner);
		this.className = " app_saku3_report_siswa_flCdIn";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from kas_m where kode_lokasi='"+this.app._lokasi+"' and modul='CDINLOAD'  ");
...
window. app_saku3_report_siswa_flCdIn.extend(window.childForm);
window. app_saku3_report_siswa_flCdIn.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[ app_saku3_report_siswa_flCdIn]::mainButtonClick:"+e);
		}
	},
