window.app_saku3_report_siswa_flPrestasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flPrestasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flPrestasi";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Siswa", 2);
...
window.app_saku3_report_siswa_flPrestasi.extend(window.childForm);
window.app_saku3_report_siswa_flPrestasi.implement({
		...
		try{			
			...
			if (row == 2)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Siswa",this.sg1, this.sg1.row, this.sg1.col,
												"select a.nis, a.nama from sis_siswa a "+filter,
												"select count(a.nis) from sis_siswa a "+filter,
												new Array("a.nis","a.nama"),"and",new Array("Kode","Keterangan"));				
			}			
		}catch(e){
			systemAPI.alert(e);
		}
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.kode_pp",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("a.nis",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
				this.showFilter = this.filterRep.showFilter(this.sg1);
				this.nama_report = "server_report_saku3_siswa_rptPrestasi";
