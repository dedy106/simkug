window.app_saku3_report_siswa_flSisPDDTrack = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisPDDTrack.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisPDDTrack";
		this.maximize();
    ...
    "   from aka_cd_d where kode_akun='2141101' and kode_lokasi = '"+this.app._lokasi+"') and kode_lokasi='"+this.app._lokasi+"' ");
...
window.app_saku3_report_siswa_flSisPDDTrack.extend(window.childForm);
window.app_saku3_report_siswa_flSisPDDTrack.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_siswa_rptSisPDDTrack";
	...
	doOpenDetail: function(no_bukti,kode_lokasi,dc){
		...
		nama_report="server_report_saku3_siswa_rptSisPDDTrackDet";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
