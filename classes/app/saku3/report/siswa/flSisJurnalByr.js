window.app_saku3_report_siswa_flSisJurnalByr = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisJurnalByr.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisJurnalByr";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from kas_m where kode_lokasi='"+this.app._lokasi+"' and kode_pp='"+this.app._kodePP+"' and modul='CDINREG'");
...
window.app_saku3_report_siswa_flSisJurnalByr.extend(window.childForm);
window.app_saku3_report_siswa_flSisJurnalByr.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siswa_rptSisJurnalByr";
