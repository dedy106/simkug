window.app_saku3_report_siswa_flSisRaport = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisRaport.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisRaport";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Raport Siswa", 2);
...
window.app_saku3_report_siswa_flSisRaport.extend(window.childForm);
window.app_saku3_report_siswa_flSisRaport.implement({
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5],["3","123","123","123","123","123"]);
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5],[2,2,2,2,2,2]);	
		// if (row == 2)
		// {
		// 	var filter=this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
		// 				this.filterRep.filterStr("a.kode_pp",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and"); 
		// 	var sql="select distinct substring(convert(varchar,a.tgl_input,112),1,6) as periode from sis_nilai_m a "+filter+" order by a.tgl_input desc"
			...
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.filter =this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							//   this.filterRep.filterStr("substring(convert(varchar,a.tgl_input,112),1,6)",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
							  ...
							  this.filterRep.filterStr("d.kode_akt",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4),"and")+
							  this.filterRep.filterStr("d.nis",this.sg1.getCell(1,5),this.sg1.getCell(2,5),this.sg1.getCell(3,5),"and");
				
				this.filter2 = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							  this.filterRep.filterStr("a.kode_pp",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							  "/"+this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1);				
		    	
				this.showFilter = this.filterRep.showFilter(this.sg1);
				this.nama_report = "server_report_saku3_siswa_rptSisRaport";
