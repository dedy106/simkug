window.app_saku3_report_siswa_flSisKartuCd = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisKartuCd.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisKartuCd";
		this.maximize();
...
window.app_saku3_report_siswa_flSisKartuCd.extend(window.childForm);
window.app_saku3_report_siswa_flSisKartuCd.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_siswa_rptSisKartuCd";
