window.app_saku3_report_siswa_flSisKartuYpt2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisKartuYpt2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisKartuYpt2";
		this.maximize();
...
window.app_saku3_report_siswa_flSisKartuYpt2.extend(window.childForm);
window.app_saku3_report_siswa_flSisKartuYpt2.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_siswa_rptSisKartuYpt2";
