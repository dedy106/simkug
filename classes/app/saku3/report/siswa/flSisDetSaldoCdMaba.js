window.app_saku3_report_siswa_flSisDetSaldoCdMaba = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisDetSaldoCdMaba.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisDetSaldoCdMaba";
		this.maximize();
...
window.app_saku3_report_siswa_flSisDetSaldoCdMaba.extend(window.childForm);
window.app_saku3_report_siswa_flSisDetSaldoCdMaba.implement({
