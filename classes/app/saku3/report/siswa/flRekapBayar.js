window.app_saku3_report_siswa_flRekapBayar = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flRekapBayar.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flRekapBayar";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from sis_reg_bayar where kode_lokasi='"+this.app._lokasi+"' and kode_pp='"+this.app._kodePP+"' ");
...
window.app_saku3_report_siswa_flRekapBayar.extend(window.childForm);
window.app_saku3_report_siswa_flRekapBayar.implement({
	...
	{		
		...
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4],[2,2,0,2]);
		if (row == 2)
		{
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siswa_rptRekapBayar";
