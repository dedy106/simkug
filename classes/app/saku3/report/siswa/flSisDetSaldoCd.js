window.app_saku3_report_siswa_flSisDetSaldoCd = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisDetSaldoCd.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisDetSaldoCd";
		this.maximize();
...
window.app_saku3_report_siswa_flSisDetSaldoCd.extend(window.childForm);
window.app_saku3_report_siswa_flSisDetSaldoCd.implement({
