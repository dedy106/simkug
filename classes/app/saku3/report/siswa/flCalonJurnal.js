window.app_saku3_report_siswa_flCalonJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flCalonJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flCalonJurnal";
		this.maximize();
...
window.app_saku3_report_siswa_flCalonJurnal.extend(window.childForm);
window.app_saku3_report_siswa_flCalonJurnal.implement({
