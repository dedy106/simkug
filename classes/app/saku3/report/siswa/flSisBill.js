window.app_saku3_report_siswa_flSisBill = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisBill.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisBill";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("No Tagihan","All",""));
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_siswa_flSisBill.extend(window.childForm);
window.app_saku3_report_siswa_flSisBill.implement({
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5],["3","23","3","123","123","123"]);
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							  ...
							  this.filterRep.filterStr("c.nis",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and")+
				...
				{
					this.nama_report = "server_report_saku3_siswa_rptSisBill";
				}
				if (this.sg1.getCell(2,2)=="SMP")
				{
					this.nama_report = "server_report_saku3_siswa_rptSisBillSmp";
				}
