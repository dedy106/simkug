window.app_saku3_report_siswa_flSisHakakses = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisHakakses.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisHakakses";
		this.maximize();
...
window.app_saku3_report_siswa_flSisHakakses.extend(window.childForm);
window.app_saku3_report_siswa_flSisHakakses.implement({
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2],["3","23","123","123"]);
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_siswa_rptSisHakakses";
