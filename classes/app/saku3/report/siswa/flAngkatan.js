window.app_saku3_report_siswa_flAngkatan = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flAngkatan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flAngkatan";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Kode Angkatan","All",""));
	
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_siswa_flAngkatan.extend(window.childForm);
window.app_saku3_report_siswa_flAngkatan.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siswa_rptAngkatan";
