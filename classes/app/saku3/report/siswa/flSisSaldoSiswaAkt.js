window.app_saku3_report_siswa_flSisSaldoSiswaAkt = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisSaldoSiswaAkt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisSaldoSiswaAkt";
		this.maximize();
...
window.app_saku3_report_siswa_flSisSaldoSiswaAkt.extend(window.childForm);
window.app_saku3_report_siswa_flSisSaldoSiswaAkt.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter3 = this.filterRep.filterStr("x.kode_pp",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");


				this.filter2 =this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,2)+"/"+this.sg1.getCell(2,4)+"/"+this.sg1.getCell(1,1)+"/"+this.filter3;
				this.showFilter = this.filterRep.showFilter(this.sg1);
				
				
				this.nama_report = "server_report_saku3_siswa_rptSisSaldoSiswaAkt";
