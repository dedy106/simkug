window.app_saku3_report_siswa_flSisSaldoPyt = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisSaldoPyt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisSaldoPyt";
		this.maximize();
...
window.app_saku3_report_siswa_flSisSaldoPyt.extend(window.childForm);
window.app_saku3_report_siswa_flSisSaldoPyt.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_siswa_rptSisSaldoPyt";
