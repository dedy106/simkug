window.app_saku3_report_siswa_flSisJurnalRekonYpt = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisJurnalRekonYpt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisJurnalRekonYpt";
		this.maximize();
...
window.app_saku3_report_siswa_flSisJurnalRekonYpt.extend(window.childForm);
window.app_saku3_report_siswa_flSisJurnalRekonYpt.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_siswa_flSisJurnalRekonYpt]::mainButtonClick:"+e);
		}
	},
