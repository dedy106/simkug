window.app_saku3_report_siswa_flSisSaldoCdSiswa = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisSaldoCdSiswa.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisSaldoCdSiswa";
		this.maximize();
...
window.app_saku3_report_siswa_flSisSaldoCdSiswa.extend(window.childForm);
window.app_saku3_report_siswa_flSisSaldoCdSiswa.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_siswa_rptSisSaldoCdSiswa";
