window.app_saku3_report_siswa_flKkm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flKkm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flKkm";
		this.maximize();
...
window.app_saku3_report_siswa_flKkm.extend(window.childForm);
window.app_saku3_report_siswa_flKkm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siswa_rptKkm";
