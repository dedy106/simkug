window.app_saku3_report_siswa_flSisBillYptKelas = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisBillYptKelas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisBillYptKelas";
		this.maximize();
...
window.app_saku3_report_siswa_flSisBillYptKelas.extend(window.childForm);
window.app_saku3_report_siswa_flSisBillYptKelas.implement({
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6,7],["3","123","3","123","123","123","3","3"]);
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5,6,7],[2,2,0,2,2,2,0,0]);	
		if (row == 2)
		{
			var filter=this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
						this.filterRep.filterStr("a.kode_pp",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and"); 
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siswa_rptSisBillYptKelas";
