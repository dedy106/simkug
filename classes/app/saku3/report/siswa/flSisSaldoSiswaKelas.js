window.app_saku3_report_siswa_flSisSaldoSiswaKelas = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisSaldoSiswaKelas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisSaldoSiswaKelas";
		this.maximize();
...
window.app_saku3_report_siswa_flSisSaldoSiswaKelas.extend(window.childForm);
window.app_saku3_report_siswa_flSisSaldoSiswaKelas.implement({
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6],["3","23","3","123","123","13","3"]);
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter3 = this.filterRep.filterStr("y.flag_aktif",this.sg1.getCell(1,5),this.sg1.getCell(2,5).substr(0,1),this.sg1.getCell(3,5).substr(0,1),"and");

				this.filter2 =this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,2)+"/"+this.sg1.getCell(2,6)+"/"+this.filter3;
				this.showFilter = this.filterRep.showFilter(this.sg1);
				
				
				this.nama_report = "server_report_saku3_siswa_rptSisSaldoSiswaKelas";
