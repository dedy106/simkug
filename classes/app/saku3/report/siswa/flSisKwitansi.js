window.app_saku3_report_siswa_flSisKwitansi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisKwitansi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisKwitansi";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from kas_m where kode_lokasi='"+this.app._lokasi+"' and kode_pp='"+this.app._kodePP+"' and modul in ('KBBILSIS','KBCDIN') ");
...
window.app_saku3_report_siswa_flSisKwitansi.extend(window.childForm);
window.app_saku3_report_siswa_flSisKwitansi.implement({
		...
		try
		{
			...
			else
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							// this.filterRep.filterStr("a.kode_kelas",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4),"and")+
							// this.filterRep.filterStr("a.kode_akt",this.sg1.getCell(1,5),this.sg1.getCell(2,5),this.sg1.getCell(3,5),"and")+
                            this.filterRep.filterStr("a.ref1",this.sg1.getCell(1,6),this.sg1.getCell(2,6),this.sg1.getCell(3,6),"and")+
