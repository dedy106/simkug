window.app_saku3_report_siswa_flSisSaldoTA = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisSaldoTA.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisSaldoTA";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Tahun Akademik","All",""));
	...
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("Akun Piutang","All",""));
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
	//this.pager=10;
	
};
window.app_saku3_report_siswa_flSisSaldoTA.extend(window.childForm);
window.app_saku3_report_siswa_flSisSaldoTA.implement({
		...
		try{			
            ...
            if (row == 3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Mahasiswa",this.sg1, this.sg1.row, this.sg1.col,
												"select a.nim, a.nama from aka_mahasiswa a ",
												"select count(*) from aka_mahasiswa a",
												new Array("a.nim","a.nama"),"where",new Array("a.nim","a.nama"));
			}	
			if (row == 4)
			{
				var filter=this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where");
				this.filterRep.ListDataSGFilter(this, "Data Akun Piutang",this.sg1, this.sg1.row, this.sg1.col,
												"select distinct a.akun_piutang, b.nama from aka_bill_d a inner join masakun b on a.akun_piutang=b.kode_akun and a.kode_lokasi=b.kode_lokasi "+filter,
												"select count(distinct(a.akun_piutang)) from aka_bill_d a "+filter,
												new Array("a.akun_piutang","b.nama"),"where",new Array("a.akun_piutang","b.nama"));
			}	
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
                ...
                this.filter = this.filterRep.filterStr("x.kode_pp",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2)," where ")+
                this.filterRep.filterStr("x.nim",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3)," and ")+
				this.filterRep.filterStr("x.tahunaka",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1)," and ")+
				this.filterRep.filterStr("x.akun_piutang",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4)," and ");
				this.filter2 = this.sg1.getCell(2,0)+"|";
				this.showFilter = this.filterRep.showFilter(this.sg1);
				this.nama_report = "server_report_saku3_siswa_rptSisSaldoTA";
