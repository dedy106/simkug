window.app_saku3_report_siswa_flSisSaldoPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisSaldoPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisSaldoPp";
		this.maximize();
...
window.app_saku3_report_siswa_flSisSaldoPp.extend(window.childForm);
window.app_saku3_report_siswa_flSisSaldoPp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siswa_rptSisSaldoPp";
