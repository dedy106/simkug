window.app_saku3_report_siswa_flSisSaldoCdSekolah = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flSisSaldoCdSekolah.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flSisSaldoCdSekolah";
		this.maximize();
...
window.app_saku3_report_siswa_flSisSaldoCdSekolah.extend(window.childForm);
window.app_saku3_report_siswa_flSisSaldoCdSekolah.implement({
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3],["3","23","3","3"]);
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_siswa_rptSisSaldoCdSekolah";
	...
	doOpenSaldoSiswa: function(kode_lokasi,kode_pp){
		...
		filter2=this.sg1.getCell(2,0)+"/"+kode_pp+"/"+this.sg1.getCell(2,2);
		nama_report="server_report_saku3_siswa_rptSisSaldoCdSiswa2";
