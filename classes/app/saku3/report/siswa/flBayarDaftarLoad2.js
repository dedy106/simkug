window.app_saku3_report_siswa_flBayarDaftarLoad2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siswa_flBayarDaftarLoad2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siswa_flBayarDaftarLoad2";
		this.maximize();
...
window.app_saku3_report_siswa_flBayarDaftarLoad2.extend(window.childForm);
window.app_saku3_report_siswa_flBayarDaftarLoad2.implement({
