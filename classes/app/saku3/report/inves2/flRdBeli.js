window.app_saku3_report_inves2_flRdBeli = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flRdBeli.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flRdBeli";
		this.maximize();
...
window.app_saku3_report_inves2_flRdBeli.extend(window.childForm);
window.app_saku3_report_inves2_flRdBeli.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_inves2_rptRdBeli";
			...
			systemAPI.alert("[app_saku3_report_inves2_flRdBeli]::mainButtonClick:"+e);
		}
	},
