window.app_saku3_report_inves2_flDocKkp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flDocKkp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flDocKkp";
		this.maximize();
...
window.app_saku3_report_inves2_flDocKkp.extend(window.childForm);
window.app_saku3_report_inves2_flDocKkp.implement({
		...
		try{			
			...
			if (row ==4)
			{
				filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.bdepo",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and");
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4],["123","1236","13","123","123"]);
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.jenis",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
							this.filterRep.filterStr("a.bdepo",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and")+
							this.filterRep.filterStr("a.no_depo",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4),"and");
				this.filter2 = this.sg1.getCell(2,1)+";"+this.sg1.getCell(1,5)
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_inves2_rptDocKkpSaldo";
			...
			systemAPI.alert("[app_saku3_report_inves2_flDocKkp]::mainButtonClick:"+e);
		}
	},
