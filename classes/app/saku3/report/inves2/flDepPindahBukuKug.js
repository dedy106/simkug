window.app_saku3_report_inves2_flDepPindahBukuKug = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flDepPindahBukuKug.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flDepPindahBukuKug";
		this.maximize();
...
window.app_saku3_report_inves2_flDepPindahBukuKug.extend(window.childForm);
window.app_saku3_report_inves2_flDepPindahBukuKug.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_inves2_rptDepPindahBukuKug";
