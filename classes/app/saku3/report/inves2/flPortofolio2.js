// JavaScript Document
window.app_saku3_report_inves2_flPortofolio2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flPortofolio2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flPortofolio2";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("Komposisi","=","3070"));
...
window.app_saku3_report_inves2_flPortofolio2.extend(window.portalui_childForm);
window.app_saku3_report_inves2_flPortofolio2.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("3070","5050"));
		}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_inves2_rptPortofolio2";
