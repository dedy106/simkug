window.app_saku3_report_inves2_flSahamSplit = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flSahamSplit.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flSahamSplit";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from inv_shmbeli_m where modul='SHMSPLIT' ");
...
window.app_saku3_report_inves2_flSahamSplit.extend(window.childForm);
window.app_saku3_report_inves2_flSahamSplit.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_inves2_rptSahamSplit";
				if (this.sg1.getCell(2,4)=="Detail")
				{
					this.nama_report = "server_report_saku3_inves2_rptSahamSplitDetail";
				}
			...
			systemAPI.alert("[app_saku3_report_inves2_flSahamSplit]::mainButtonClick:"+e);
		}
	},
