// JavaScript Document
window.app_saku3_report_inves2_flRoiHari = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flRoiHari.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flRoiHari";
		this.maximize();
...
window.app_saku3_report_inves2_flRoiHari.extend(window.portalui_childForm);
window.app_saku3_report_inves2_flRoiHari.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_inves2_rptRoiHari";
