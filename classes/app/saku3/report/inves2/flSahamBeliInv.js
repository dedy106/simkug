window.app_saku3_report_inves2_flSahamBeliInv = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flSahamBeliInv.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flSahamBeliInv";
		this.maximize();
...
window.app_saku3_report_inves2_flSahamBeliInv.extend(window.childForm);
window.app_saku3_report_inves2_flSahamBeliInv.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_inves2_rptSahamBeliInv";
			...
			systemAPI.alert("[app_saku3_report_inves2_flSahamBeliInv]::mainButtonClick:"+e);
		}
	},
