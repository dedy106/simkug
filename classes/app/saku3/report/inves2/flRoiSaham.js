window.app_saku3_report_inves2_flRoiSaham = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flRoiSaham.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flRoiSaham";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from inv_saham_roi ");
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Kelola","All",""));
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_inves2_flRoiSaham.extend(window.childForm);
window.app_saku3_report_inves2_flRoiSaham.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from inv_saham_roi order by periode desc",[this.sg1.columns.get(2).pickList]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_inves2_rptRoiSaham";
