window.app_saku3_report_inves2_flDepPindahBuku = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flDepPindahBuku.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flDepPindahBuku";
		this.maximize();
...
window.app_saku3_report_inves2_flDepPindahBuku.extend(window.childForm);
window.app_saku3_report_inves2_flDepPindahBuku.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_inves2_rptDepPindahBuku";
