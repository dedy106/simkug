window.app_saku3_report_inves2_flSahamBeliForm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flSahamBeliForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flSahamBeliForm";
		this.maximize();
...
window.app_saku3_report_inves2_flSahamBeliForm.extend(window.childForm);
window.app_saku3_report_inves2_flSahamBeliForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_inves2_rptSahamBeliForm";
			...
			systemAPI.alert("[app_saku3_report_inves2_flSahamBeliForm]::mainButtonClick:"+e);
		}
	},
