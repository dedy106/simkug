window.app_saku3_report_inves2_flRdBeliInv = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flRdBeliInv.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flRdBeliInv";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Broker / MI","All",""));
...
window.app_saku3_report_inves2_flRdBeliInv.extend(window.childForm);
window.app_saku3_report_inves2_flRdBeliInv.implement({
		...
		try{			
			...
			if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Pembelian",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_rdbeli, a.keterangan from inv_rdbeli_m a "+filter,
												"select count(a.no_rdbeli) from inv_rdbeli_m a "+filter,
												new Array("a.no_rdbeli","a.keterangan"),"and",new Array("No Bukti","Keterangan"));
			}
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4],["123","1236","123","123","3"]);
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("a.kode_rdkelola",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
							this.filterRep.filterStr("a.no_rdbeli",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and");
				this.filter2 = this.sg1.getCell(2,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_inves2_rptRdBeliInv";
			...
			systemAPI.alert("[app_saku3_report_inves2_flRdBeliInv]::mainButtonClick:"+e);
		}
	},
