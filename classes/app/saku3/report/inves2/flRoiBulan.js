// JavaScript Document
window.app_saku3_report_inves2_flRoiBulan = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flRoiBulan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flRoiBulan";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(substring(periode,1,4)) as periode from inv_depo2_m ");
...
window.app_saku3_report_inves2_flRoiBulan.extend(window.portalui_childForm);
window.app_saku3_report_inves2_flRoiBulan.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_inves2_rptRoiBulan";
