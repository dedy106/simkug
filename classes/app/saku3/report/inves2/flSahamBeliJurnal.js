window.app_saku3_report_inves2_flSahamBeliJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flSahamBeliJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flSahamBeliJurnal";
		this.maximize();
...
window.app_saku3_report_inves2_flSahamBeliJurnal.extend(window.childForm);
window.app_saku3_report_inves2_flSahamBeliJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_saku3_inves2_rptSahamBeliJurnal";
