window.app_saku3_report_inves2_flDepPenempatan = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flDepPenempatan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flDepPenempatan";
		this.maximize();
...
window.app_saku3_report_inves2_flDepPenempatan.extend(window.childForm);
window.app_saku3_report_inves2_flDepPenempatan.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_inves2_rptDepPenempatan";
