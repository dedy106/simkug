window.app_saku3_report_inves2_flSahamJual = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flSahamJual.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flSahamJual";
		this.maximize();
...
window.app_saku3_report_inves2_flSahamJual.extend(window.childForm);
window.app_saku3_report_inves2_flSahamJual.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_inves2_rptSahamJual";
				if (this.sg1.getCell(2,4)=="Detail")
				{
					this.nama_report = "server_report_saku3_inves2_rptSahamJualDetail";
				}
			...
			systemAPI.alert("[app_saku3_report_inves2_flSahamJual]::mainButtonClick:"+e);
		}
	},
