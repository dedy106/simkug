window.app_saku3_report_inves2_flRoiDep = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flRoiDep.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flRoiDep";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Jenis","=","DEPOSITO"));
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_inves2_flRoiDep.extend(window.childForm);
window.app_saku3_report_inves2_flRoiDep.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_inves2_rptRoiDep";
