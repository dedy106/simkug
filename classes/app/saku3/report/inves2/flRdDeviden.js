window.app_saku3_report_inves2_flRdDeviden = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flRdDeviden.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flRdDeviden";
		this.maximize();
...
window.app_saku3_report_inves2_flRdDeviden.extend(window.childForm);
window.app_saku3_report_inves2_flRdDeviden.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_inves2_rptRdDeviden";
				if (this.sg1.getCell(2,4)=="Detail")
				{
					this.nama_report = "server_report_saku3_inves2_rptRdDevidenDetail";
				}
			...
			systemAPI.alert("[app_saku3_report_inves2_flRdDeviden]::mainButtonClick:"+e);
		}
	},
