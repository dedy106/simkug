window.app_saku3_report_inves2_flRdSpi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flRdSpi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flRdSpi";
		this.maximize();
...
window.app_saku3_report_inves2_flRdSpi.extend(window.childForm);
window.app_saku3_report_inves2_flRdSpi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_inves2_flRdSpi]::mainButtonClick:"+e);
		}
	},
