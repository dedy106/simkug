window.app_saku3_report_inves2_flSahamBonus = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flSahamBonus.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flSahamBonus";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from inv_shmbeli_m where modul='SHMBONUS' ");
...
window.app_saku3_report_inves2_flSahamBonus.extend(window.childForm);
window.app_saku3_report_inves2_flSahamBonus.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_inves2_rptSahamBonus";
				if (this.sg1.getCell(2,4)=="Detail")
				{
					this.nama_report = "server_report_saku3_inves2_rptSahamBonusDetail";
				}
			...
			systemAPI.alert("[app_saku3_report_inves2_flSahamBonus]::mainButtonClick:"+e);
		}
	},
