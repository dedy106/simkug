window.app_saku3_report_inves2_flSahamSpi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flSahamSpi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flSahamSpi";
		this.maximize();
...
window.app_saku3_report_inves2_flSahamSpi.extend(window.childForm);
window.app_saku3_report_inves2_flSahamSpi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_inves2_rptSahamSpi";
			...
			systemAPI.alert("[app_saku3_report_inves2_flSahamSpi]::mainButtonClick:"+e);
		}
	},
