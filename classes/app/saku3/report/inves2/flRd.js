window.app_saku3_report_inves2_flRd = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flRd.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flRd";
		this.maximize();
...
window.app_saku3_report_inves2_flRd.extend(window.childForm);
window.app_saku3_report_inves2_flRd.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_inves2_rptRd";
			...
			systemAPI.alert("[app_saku3_report_inves2_flRd]::mainButtonClick:"+e);
		}
	},
