window.app_saku3_report_inves2_flSahamSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flSahamSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flSahamSaldo";
		this.maximize();
...
window.app_saku3_report_inves2_flSahamSaldo.extend(window.childForm);
window.app_saku3_report_inves2_flSahamSaldo.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from inv_shmbeli_m where kode_lokasi='"+this.app._lokasi+"' order by periode desc",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
		if (row == 2)
		{
			this.sg1.columns.get(2).pickList.clear();
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_inves2_rptSahamSaldo";
			...
			systemAPI.alert("[app_saku3_report_inves2_flSahamSaldo]::mainButtonClick:"+e);
		}
	},
