window.app_saku3_report_inves2_flSahamSaldoNilai = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flSahamSaldoNilai.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flSahamSaldoNilai";
		this.maximize();
...
window.app_saku3_report_inves2_flSahamSaldoNilai.extend(window.childForm);
window.app_saku3_report_inves2_flSahamSaldoNilai.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_inves2_rptSahamSaldoNilai";
			...
			systemAPI.alert("[app_saku3_report_inves2_flSahamSaldoNilai]::mainButtonClick:"+e);
		}
	},
