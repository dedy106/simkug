window.app_saku3_report_inves2_flDocKbJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flDocKbJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flDocKbJurnal";
		this.maximize();
...
window.app_saku3_report_inves2_flDocKbJurnal.extend(window.childForm);
window.app_saku3_report_inves2_flDocKbJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_saku3_inves2_rptDocKbJurnal";
