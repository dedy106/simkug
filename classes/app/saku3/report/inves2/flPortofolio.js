// JavaScript Document
window.app_saku3_report_inves2_flPortofolio = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flPortofolio.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flPortofolio";
		this.maximize();
...
window.app_saku3_report_inves2_flPortofolio.extend(window.portalui_childForm);
window.app_saku3_report_inves2_flPortofolio.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_inves2_rptPortofolio";
