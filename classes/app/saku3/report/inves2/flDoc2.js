window.app_saku3_report_inves2_flDoc = function(owner)
{
	...
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Tgl Jatuh Tempo","All",""));
		...
		try{			
			...
			if (row ==4)
			{
				filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.tgl_selesai",this.sg1.getCell(1,4),this.sg1.getCellDateValue(2,4),this.sg1.getCellDateValue(3,4),"and");
