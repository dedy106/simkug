window.app_saku3_report_inves2_flSahamKbJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flSahamKbJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flSahamKbJurnal";
		this.maximize();
...
window.app_saku3_report_inves2_flSahamKbJurnal.extend(window.childForm);
window.app_saku3_report_inves2_flSahamKbJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_saku3_inves2_rptSahamKbJurnal";
