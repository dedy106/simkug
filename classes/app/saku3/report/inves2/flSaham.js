window.app_saku3_report_inves2_flSaham = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flSaham.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flSaham";
		this.maximize();
...
window.app_saku3_report_inves2_flSaham.extend(window.childForm);
window.app_saku3_report_inves2_flSaham.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_inves2_rptSaham";
			...
			systemAPI.alert("[app_saku3_report_inves2_flSaham]::mainButtonClick:"+e);
		}
	},
