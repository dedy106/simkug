window.app_saku3_report_inves2_flSahamDeviden = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flSahamDeviden.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flSahamDeviden";
		this.maximize();
...
window.app_saku3_report_inves2_flSahamDeviden.extend(window.childForm);
window.app_saku3_report_inves2_flSahamDeviden.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_inves2_rptSahamDeviden";
				if (this.sg1.getCell(2,4)=="Detail")
				{
					this.nama_report = "server_report_saku3_inves2_rptSahamDevidenDetail";
				}
			...
			systemAPI.alert("[app_saku3_report_inves2_flSahamDeviden]::mainButtonClick:"+e);
		}
	},
