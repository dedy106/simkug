window.app_saku3_report_inves2_flDepKomposisi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flDepKomposisi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flDepKomposisi";
		this.maximize();
...
window.app_saku3_report_inves2_flDepKomposisi.extend(window.childForm);
window.app_saku3_report_inves2_flDepKomposisi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_inves2_rptDepKomposisi";
