// JavaScript Document
window.app_saku3_report_inves2_flPortofolio3 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flPortofolio3.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flPortofolio3";
		this.maximize();
...
window.app_saku3_report_inves2_flPortofolio3.extend(window.portalui_childForm);
window.app_saku3_report_inves2_flPortofolio3.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_inves2_rptPortofolio3";
