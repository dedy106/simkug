window.app_saku3_report_inves2_flRoiPs = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flRoiPs.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flRoiPs";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from inv_sp_roi  ");
...
window.app_saku3_report_inves2_flRoiPs.extend(window.childForm);
window.app_saku3_report_inves2_flRoiPs.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from inv_sp_roi order by periode desc",[this.sg1.columns.get(2).pickList]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_inves2_rptRoiPs";
