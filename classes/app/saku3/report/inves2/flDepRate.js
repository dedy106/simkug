window.app_saku3_report_inves2_flDepRate = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flDepRate.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flDepRate";
		this.maximize();
...
window.app_saku3_report_inves2_flDepRate.extend(window.childForm);
window.app_saku3_report_inves2_flDepRate.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_inves2_rptDepRate";
