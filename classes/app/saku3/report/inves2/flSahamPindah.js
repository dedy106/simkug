window.app_saku3_report_inves2_flSahamPindah = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flSahamPindah.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flSahamPindah";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from inv_shmjual_m where modul='JPINDAH' ");
...
window.app_saku3_report_inves2_flSahamPindah.extend(window.childForm);
window.app_saku3_report_inves2_flSahamPindah.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_inves2_rptSahamPindah";
				if (this.sg1.getCell(2,4)=="Detail")
				{
					this.nama_report = "server_report_saku3_inves2_rptSahamPindahDetail";
				}
			...
			systemAPI.alert("[app_saku3_report_inves2_flSahamPindah]::mainButtonClick:"+e);
		}
	},
