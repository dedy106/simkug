window.app_saku3_report_inves2_flRdSpiBulan = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flRdSpiBulan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flRdSpiBulan";
		this.maximize();
...
window.app_saku3_report_inves2_flRdSpiBulan.extend(window.childForm);
window.app_saku3_report_inves2_flRdSpiBulan.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_inves2_rptRdSpiBulan";
			...
			systemAPI.alert("[app_saku3_report_inves2_flRdSpiBulan]::mainButtonClick:"+e);
		}
	},
