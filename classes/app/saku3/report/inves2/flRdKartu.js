window.app_saku2_report_investasi_flRdKartu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_investasi_flRdKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_investasi_flRdKartu";
		this.maximize();
...
window.app_saku2_report_investasi_flRdKartu.extend(window.childForm);
window.app_saku2_report_investasi_flRdKartu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_investasi_rptRdKartu";
			...
			systemAPI.alert("[app_saku2_report_investasi_flRdKartu]::mainButtonClick:"+e);
		}
	},
