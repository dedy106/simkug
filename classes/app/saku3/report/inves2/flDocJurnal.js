window.app_saku3_report_inves2_flDocJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flDocJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flDocJurnal";
		this.maximize();
...
window.app_saku3_report_inves2_flDocJurnal.extend(window.childForm);
window.app_saku3_report_inves2_flDocJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_saku3_inves2_rptDocJurnal";
