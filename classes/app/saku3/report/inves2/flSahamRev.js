window.app_saku3_report_inves2_flSahamRev = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flSahamRev.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flSahamRev";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from inv_shmjual_m where modul='SHMREV' ");
...
window.app_saku3_report_inves2_flSahamRev.extend(window.childForm);
window.app_saku3_report_inves2_flSahamRev.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_inves2_rptSahamRev";
				if (this.sg1.getCell(2,4)=="Detail")
				{
					this.nama_report = "server_report_saku3_inves2_rptSahamRevDetail";
				}
			...
			systemAPI.alert("[app_saku3_report_inves2_flSahamRev]::mainButtonClick:"+e);
		}
	},
