window.app_saku3_report_inves2_flSahamJualInv = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flSahamJualInv.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flSahamJualInv";
		this.maximize();
...
window.app_saku3_report_inves2_flSahamJualInv.extend(window.childForm);
window.app_saku3_report_inves2_flSahamJualInv.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_inves2_rptSahamJualInv";
			...
			systemAPI.alert("[app_saku3_report_inves2_flSahamJualInv]::mainButtonClick:"+e);
		}
	},
