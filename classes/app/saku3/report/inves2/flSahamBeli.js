window.app_saku3_report_inves2_flSahamBeli = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flSahamBeli.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flSahamBeli";
		this.maximize();
...
window.app_saku3_report_inves2_flSahamBeli.extend(window.childForm);
window.app_saku3_report_inves2_flSahamBeli.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_inves2_rptSahamBeli";
				if (this.sg1.getCell(2,4)=="Detail")
				{
					this.nama_report = "server_report_saku3_inves2_rptSahamBeliDetail";
				}
			...
			systemAPI.alert("[app_saku3_report_inves2_flSahamBeli]::mainButtonClick:"+e);
		}
	},
