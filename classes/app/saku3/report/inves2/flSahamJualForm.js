window.app_saku3_report_inves2_flSahamJualForm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flSahamJualForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flSahamJualForm";
		this.maximize();
...
window.app_saku3_report_inves2_flSahamJualForm.extend(window.childForm);
window.app_saku3_report_inves2_flSahamJualForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_inves2_rptSahamJualForm";
			...
			systemAPI.alert("[app_saku3_report_inves2_flSahamJualForm]::mainButtonClick:"+e);
		}
	},
