window.app_saku3_report_inves2_flDocAkru = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flDocAkru.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flDocAkru";
		this.maximize();
...
window.app_saku3_report_inves2_flDocAkru.extend(window.childForm);
window.app_saku3_report_inves2_flDocAkru.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_inves2_rptDocAkru";
			...
			systemAPI.alert("[app_saku3_report_inves2_flDocAkru]::mainButtonClick:"+e);
		}
	},
