window.app_saku3_report_inves2_flSahamSpiJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flSahamSpiJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flSahamSpiJurnal";
		this.maximize();
...
window.app_saku3_report_inves2_flSahamSpiJurnal.extend(window.childForm);
window.app_saku3_report_inves2_flSahamSpiJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_saku3_inves2_rptSahamSpiJurnal";
