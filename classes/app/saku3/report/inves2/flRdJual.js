window.app_saku3_report_inves2_flRdJual = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flRdJual.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flRdJual";
		this.maximize();
...
window.app_saku3_report_inves2_flRdJual.extend(window.childForm);
window.app_saku3_report_inves2_flRdJual.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_inves2_rptRdJual";
				if (this.sg1.getCell(2,4)=="Detail")
				{
					this.nama_report = "server_report_saku3_inves2_rptRdJualDetail";
				}
			...
			systemAPI.alert("[app_saku3_report_inves2_flRdJual]::mainButtonClick:"+e);
		}
	},
