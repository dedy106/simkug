window.app_saku3_report_inves2_flRdSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_inves2_flRdSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_inves2_flRdSaldo";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from inv_rdspi_m ");
	...
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Kode Kelompok","All",""));
...
window.app_saku3_report_inves2_flRdSaldo.extend(window.childForm);
window.app_saku3_report_inves2_flRdSaldo.implement({
		...
		try{			
			...
			if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Kelompok",this.sg1, this.sg1.row, this.sg1.col,
												"select a.kode_rdklp, a.nama from inv_rdklp a "+filter,
												"select count(a.kode_rdklp) from inv_rdklp a "+filter,
			...
			if (row ==4)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Reksadana",this.sg1, this.sg1.row, this.sg1.col,
												...
												"inner join inv_rdklp c on b.kode_rdklp=c.kode_rdklp "+filter,
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.filter = //this.filterRep.filterStr("c.jenis",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"where")+
							this.filterRep.filterStr("a.kode_rdklp",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"where")+
							this.filterRep.filterStr("a.kode_rd",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4),"and");
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_inves2_rptRdSaldo";
			...
			systemAPI.alert("[app_saku3_report_inves2_flRdSaldo]::mainButtonClick:"+e);
		}
	},
