window.app_saku3_report_droping_flDropingSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_droping_flDropingSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_droping_flDropingSaldo";
		this.maximize();
...
window.app_saku3_report_droping_flDropingSaldo.extend(window.childForm);
window.app_saku3_report_droping_flDropingSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_droping_flDropingSaldo]::mainButtonClick:"+e);
		}
	},
