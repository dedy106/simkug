window.app_saku3_report_droping_flDropingKirim = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_droping_flDropingKirim.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_droping_flDropingKirim";
		this.maximize();
...
window.app_saku3_report_droping_flDropingKirim.extend(window.childForm);
window.app_saku3_report_droping_flDropingKirim.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_droping_rptDropingKirim";
			...
			systemAPI.alert("[app_saku3_report_droping_flDropingKirim]::mainButtonClick:"+e);
		}
	},
