window.app_saku3_report_gar_flAggResetList = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gar_flAggResetList.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gar_flAggResetList";
        this.maximize();
...
window.app_saku3_report_gar_flAggResetList.extend(window.childForm);
window.app_saku3_report_gar_flAggResetList.implement({
	doLoad:function(){
        try{
			...
			this.report = new server_report_report();
			var nama_report="server_report_saku3_gar_rptAggResetList";
			this.filter="";
			this.showFilter = "";
			this.lokasi = "";
