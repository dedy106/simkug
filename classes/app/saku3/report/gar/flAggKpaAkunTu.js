window.app_saku3_report_gar_flAggKpaAkunTu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gar_flAggKpaAkunTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gar_flAggKpaAkunTu";
		this.maximize();
...
window.app_saku3_report_gar_flAggKpaAkunTu.extend(window.portalui_childForm);
window.app_saku3_report_gar_flAggKpaAkunTu.implement({
