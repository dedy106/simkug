window.app_saku3_report_gar_flGarPosTu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gar_flGarPosTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gar_flGarPosTu";
		this.maximize();
...
window.app_saku3_report_gar_flGarPosTu.extend(window.childForm);
window.app_saku3_report_gar_flGarPosTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gar_rptAggPosTu";
				this.dbLib.execQuerySync(this.sql);	
