window.app_saku3_report_gar_flAggPpRekap = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gar_flAggPpRekap.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gar_flAggPpRekap";
		this.maximize();
...
window.app_saku3_report_gar_flAggPpRekap.extend(window.portalui_childForm);
window.app_saku3_report_gar_flAggPpRekap.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.filter=this.filterRep.filterStr("x.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"and")+
						...
						this.filterRep.filterStr("x.kode_pp",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+jenis+modul;
			this.filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,3);	
			if (this.sg1.getCell(2,4)=="Triwulan")
			{			
				this.nama_report="server_report_saku3_gar_rptAggTwPpRekap";
			}
			if (this.sg1.getCell(2,4)=="Semester")
			{
				this.nama_report="server_report_saku3_gar_rptAggSemPpRekap";
			}
			if (this.sg1.getCell(2,4)=="Bulanan")
			{
				this.nama_report="server_report_saku3_gar_rptAggBulanPpRekap";
			}
