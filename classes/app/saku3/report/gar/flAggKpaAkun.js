window.app_saku3_report_gar_flAggKpaAkun = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gar_flAggKpaAkun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gar_flAggKpaAkun";
		this.maximize();
...
window.app_saku3_report_gar_flAggKpaAkun.extend(window.portalui_childForm);
window.app_saku3_report_gar_flAggKpaAkun.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_gar_rptAggKpaAkun";
				
				if (this.sg1.getCell(2,7)=="Anggaran")
				{
					var sql = "call sp_angg_d2 ('"+this.sg1.getCell(2,0)+"','"+this.sg1.getCell(2,5)+"','"+this.sg1.getCell(2,1)+"','"+this.nik_user+"')";
