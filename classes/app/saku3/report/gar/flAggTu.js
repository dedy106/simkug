window.app_saku3_report_gar_flAggTu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gar_flAggTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gar_flAggTu";
		this.maximize();
...
window.app_saku3_report_gar_flAggTu.extend(window.portalui_childForm);
window.app_saku3_report_gar_flAggTu.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,["Berjalan","Original","Reseting","Deviasi"]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			if (this.sg1.getCell(2,7)=="Reseting")
			{
				modul=" and x.modul in ('ORGI','ABT') ";
			}
			if (this.sg1.getCell(2,7)=="Deviasi")
			{
				modul=" and x.modul in ('ABT') ";
			}
