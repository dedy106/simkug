window.app_saku3_report_gar_flGarHoldSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gar_flGarHoldSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gar_flGarHoldSaldo";
		this.maximize();
...
window.app_saku3_report_gar_flGarHoldSaldo.extend(window.portalui_childForm);
window.app_saku3_report_gar_flGarHoldSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.filter=this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where") +
					...
					" and a.jenis='HOLD'";
			this.nama_report="server_report_saku3_gar_rptGarHoldSaldo";	
