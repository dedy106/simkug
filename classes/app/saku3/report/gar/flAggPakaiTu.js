window.app_saku3_report_gar_flAggPakaiTu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gar_flAggPakaiTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gar_flAggPakaiTu";
		this.maximize();
...
window.app_saku3_report_gar_flAggPakaiTu.extend(window.portalui_childForm);
window.app_saku3_report_gar_flAggPakaiTu.implement({
