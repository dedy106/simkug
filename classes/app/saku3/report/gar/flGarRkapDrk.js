window.app_saku3_report_gar_flGarRkapDrk = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gar_flGarRkapDrk.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gar_flGarRkapDrk";
		this.maximize();
...
window.app_saku3_report_gar_flGarRkapDrk.extend(window.portalui_childForm);
window.app_saku3_report_gar_flGarRkapDrk.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_gar_rptGarRkapDrk";
