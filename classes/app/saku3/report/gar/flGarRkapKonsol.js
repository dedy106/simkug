window.app_saku3_report_gar_flGarRkapKonsol = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gar_flGarRkapKonsol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gar_flGarRkapKonsol";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2,3), new Array("Kode Bidang ","Range","1","4"));
...
window.app_saku3_report_gar_flGarRkapKonsol.extend(window.portalui_childForm);
window.app_saku3_report_gar_flGarRkapKonsol.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_gar_rptGarRkapKonsol";
