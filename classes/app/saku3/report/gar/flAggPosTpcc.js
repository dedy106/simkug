window.app_saku3_report_gar_flAggPosTpcc = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gar_flAggPosTpcc.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gar_flAggPosTpcc";
		this.maximize();
...
window.app_saku3_report_gar_flAggPosTpcc.extend(window.childForm);
window.app_saku3_report_gar_flAggPosTpcc.implement({
	doEllipseClick: function(sender, col, row){
		...
		if (row == 3)
		{
			...
			this.filterRep.ListDataSGFilter(this, "Data Anggaran",this.sg1, this.sg1.row, this.sg1.col,sql1,sql2,["a.no_pdrk","a.keterangan"],"and",["No Anggaran","Keterangan"]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gar_rptAggPosTpcc";
				this.dbLib.execQuerySync(this.sql);	
	...
	doOpenBukti: function(no_bukti,kode_lokasi){
		...
		nama_report="server_report_saku3_gar_rptAjuAgg";
