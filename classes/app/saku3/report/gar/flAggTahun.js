window.app_saku3_report_gar_flAggTahun = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gar_flAggTahun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gar_flAggTahun";
		this.maximize();
...
window.app_saku3_report_gar_flAggTahun.extend(window.portalui_childForm);
window.app_saku3_report_gar_flAggTahun.implement({
