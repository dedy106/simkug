window.app_saku3_report_gar_flGarPakaiYks = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gar_flGarPakaiYks.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gar_flGarPakaiYks";
		this.maximize();
...
window.app_saku3_report_gar_flGarPakaiYks.extend(window.portalui_childForm);
window.app_saku3_report_gar_flGarPakaiYks.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gar_rptGarPakaiYks";
