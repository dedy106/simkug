window.app_saku3_report_gar_flAggTahunTu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gar_flAggTahunTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gar_flAggTahunTu";
		this.maximize();
...
window.app_saku3_report_gar_flAggTahunTu.extend(window.portalui_childForm);
window.app_saku3_report_gar_flAggTahunTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2=this.nik_user+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,8);	
