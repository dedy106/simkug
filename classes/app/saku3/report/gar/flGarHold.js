window.app_saku3_report_gar_flGarHold = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gar_flGarHold.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gar_flGarHold";
		this.maximize();
...
window.app_saku3_report_gar_flGarHold.extend(window.portalui_childForm);
window.app_saku3_report_gar_flGarHold.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.filter=this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where") +
					...
					" and a.jenis='HOLD'";
			this.nama_report="server_report_saku3_gar_rptGarHold";	
