window.app_saku3_report_gar_flGarKomparasiYks = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gar_flGarKomparasiYks.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gar_flGarKomparasiYks";
		this.maximize();
...
window.app_saku3_report_gar_flGarKomparasiYks.extend(window.portalui_childForm);
window.app_saku3_report_gar_flGarKomparasiYks.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				{
					if (this.sg1.getCell(2,6)=="Investasi")
					{
						jenis=" and b.jenis='Neraca' ";
					}
					else
					{
						jenis=" and b.jenis='"+this.sg1.getCell(2,6)+"' ";
					}
				}
				this.filter=this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"and")+
							...
							this.filterRep.filterStr("a.kode_drk",this.sg1.getCell(1,5),this.sg1.getCell(2,5),this.sg1.getCell(3,5),"and")+jenis;
				this.filter2=this.app._nikUser+"/"+this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,6);	
				this.nama_bidang=this.dbLib.getPeriodeFromSQL("select nama as periode from bidang where kode_bidang='"+this.sg1.getCell(2,3)+"'");
				this.nama_report="server_report_saku3_gar_rptGarKomparasiYks";
