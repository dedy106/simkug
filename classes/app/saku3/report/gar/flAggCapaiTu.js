window.app_saku3_report_gar_flAggCapaiTu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gar_flAggCapaiTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gar_flAggCapaiTu";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode1) as periode from angg_r where kode_lokasi='"+this.app._lokasi+"'");
	this.gridLib.SGEditData(this.sg1,0,[0,1,2],["Lokasi","=",this.app._lokasi]);
	this.gridLib.SGEditData(this.sg1,1,[0,1,2],["Periode 1","=",this.periode]);
...
window.app_saku3_report_gar_flAggCapaiTu.extend(window.portalui_childForm);
window.app_saku3_report_gar_flAggCapaiTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_gar_rptAggCapai";
