window.app_saku3_report_gar_flGarKpaAkunYks = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gar_flGarKpaAkunYks.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gar_flGarKpaAkunYks";
		this.maximize();
...
window.app_saku3_report_gar_flGarKpaAkunYks.extend(window.portalui_childForm);
window.app_saku3_report_gar_flGarKpaAkunYks.implement({
	doEllipseClick: function(sender, col, row){
		...
		if (row == 5)
		{
			this.filterRep.ListDataSGFilter(this, "Data DRK",this.sg1, this.sg1.row, this.sg1.col,
													  ...
													  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," and "),
													  new Array("kode_drk","nama"),"and",new Array("kode","nama"),"where");
		}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gar_rptGarKpaAkunYks";
