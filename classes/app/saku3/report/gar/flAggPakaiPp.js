window.app_saku3_report_gar_flAggPakaiPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gar_flAggPakaiPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gar_flAggPakaiPp";
		this.maximize();
...
window.app_saku3_report_gar_flAggPakaiPp.extend(window.portalui_childForm);
window.app_saku3_report_gar_flAggPakaiPp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				{ 
					var sql = "call sp_agg_pakai_pp ('"+this.sg1.getCell(2,0)+"','"+this.sg1.getCell(2,5)+"','"+this.sg1.getCell(2,1)+"','"+this.nik_user+"')";
				}else
				{
					var sql = "call sp_agg_pakai_pp_gl ('"+this.sg1.getCell(2,0)+"','"+this.sg1.getCell(2,5)+"','"+this.sg1.getCell(2,1)+"','"+this.nik_user+"')";
				}
				
				this.nama_report="server_report_saku3_gar_rptAggPakaiPp";
