window.app_saku3_report_gar_flGarPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gar_flGarPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gar_flGarPos";
		this.maximize();
...
window.app_saku3_report_gar_flGarPos.extend(window.childForm);
window.app_saku3_report_gar_flGarPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gar_rptAggPos";
				this.dbLib.execQuerySync(this.sql);	
