window.app_saku3_report_gar_flAggTahunDrk = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gar_flAggTahunDrk.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gar_flAggTahunDrk";
		this.maximize();
...
window.app_saku3_report_gar_flAggTahunDrk.extend(window.portalui_childForm);
window.app_saku3_report_gar_flAggTahunDrk.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				{
					this.nama_report="server_report_saku3_gar_rptAggTahunTw";
				}
				
				if (this.sg1.getCell(2,6)=="Bulanan")
				{
					this.nama_report="server_report_saku3_gar_rptAggTahunBulan";
				}
