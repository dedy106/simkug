window.app_saku3_report_gar_flAggTahunTu2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gar_flAggTahunTu2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gar_flAggTahunTu2";
		this.maximize();
...
window.app_saku3_report_gar_flAggTahunTu2.extend(window.portalui_childForm);
window.app_saku3_report_gar_flAggTahunTu2.implement({
	...
	doSelectCell: function(sender, col, row){
		if (this.app._userStatus=="A")
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6,7,8],["123","123","123","123","123","3","3","3","3"]);
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5,6,7,8],[2,0,2,2,2,0,0,0,0]);
		}
		if (this.app._userStatus=="U")
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6,7,8],["3","3","123","3","123","3","3","3","3"]);
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5,6,7,8],[3,0,2,3,2,0,0,0,0]);
		}
		if (this.app._userStatus=="P")
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6,7,8],["3","3","123","23","123","3","3","3","3"]);
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,["Anggaran","Closing"]);
		}
		if (row == 8)
		{
			this.sg1.columns.get(2).pickList.clear();
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2=this.nik_user+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,8)+"/"+this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,5);	
				if (this.sg1.getCell(2,6)=="Triwulan")
				{
					...
					this.nama_report="server_report_saku3_gar_rptAggRealTw2";
				}
				if (this.sg1.getCell(2,6)=="Semester")
				{
					...
					this.nama_report="server_report_saku3_gar_rptAggRealSem2";
				}
				if (this.sg1.getCell(2,6)=="Bulanan")
				{
					...
					this.nama_report="server_report_saku3_gar_rptAggRealBulan2";
				}
