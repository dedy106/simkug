window.app_saku3_report_gar_flAggKpaAkunPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gar_flAggKpaAkunPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gar_flAggKpaAkunPp";
		this.maximize();
...
window.app_saku3_report_gar_flAggKpaAkunPp.extend(window.portalui_childForm);
window.app_saku3_report_gar_flAggKpaAkunPp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gar_rptAggKpaAkunPp";
