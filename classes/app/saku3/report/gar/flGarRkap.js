window.app_saku3_report_gar_flGarRkap = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gar_flGarRkap.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gar_flGarRkap";
		this.maximize();
...
window.app_saku3_report_gar_flGarRkap.extend(window.portalui_childForm);
window.app_saku3_report_gar_flGarRkap.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_gar_rptGarRkap";
