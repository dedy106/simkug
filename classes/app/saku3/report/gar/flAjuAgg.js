window.app_saku3_report_gar_flAjuAgg = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gar_flAjuAgg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gar_flAjuAgg";
		this.maximize();
...
window.app_saku3_report_gar_flAjuAgg.extend(window.portalui_childForm);
window.app_saku3_report_gar_flAjuAgg.implement({
