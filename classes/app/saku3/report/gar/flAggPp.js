window.app_saku3_report_gar_flAggPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gar_flAggPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gar_flAggPp";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,5,[0,1,2],["Periodik Laporan","=","Triwulan"]);
	this.gridLib.SGEditData(this.sg1,6,[0,1,2],["Status Anggaran","=","Berjalan"]);
...
window.app_saku3_report_gar_flAggPp.extend(window.portalui_childForm);
window.app_saku3_report_gar_flAggPp.implement({
	...
	doSelectCell: function(sender, col, row){
		if (this.app._userStatus=="A")
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6],["123","123","123","123","13","3","3"]);
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5,6],[2,0,2,2,0,0,0]);
		}
		if (this.app._userStatus=="U")
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6],["3","3","123","3","13","3","3"]);
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5,6],[3,0,2,3,0,0,0]);
		}
		if (this.app._userStatus=="P")
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6],["3","3","123","23","13","3","3"]);
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5,6],[3,0,2,2,0,0,0]);
		}
		if (row == 1)
		{
	...
	mainButtonClick: function(sender){
		try
		{
			...
			var modul="";
			if (this.sg1.getCell(2,6)!="Berjalan")
			{
			...
			this.filter=this.filterRep.filterStr("x.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"and")+
						...
						this.filterRep.filterStr("x.kode_pp",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and")+jenis+modul;
			...
			{			
				this.nama_report="server_report_saku3_gar_rptAggTwPp";
			}
			if (this.sg1.getCell(2,5)=="Semester")
			{
				this.nama_report="server_report_saku3_gar_rptAggSemPp";
			}
			if (this.sg1.getCell(2,5)=="Bulanan")
			{
				this.nama_report="server_report_saku3_gar_rptAggBulanPp";
			}
