window.app_saku3_report_gar_flGarPdrk = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gar_flGarPdrk.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gar_flGarPdrk";
		this.maximize();
...
window.app_saku3_report_gar_flGarPdrk.extend(window.portalui_childForm);
window.app_saku3_report_gar_flGarPdrk.implement({
