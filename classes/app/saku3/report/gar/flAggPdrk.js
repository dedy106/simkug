window.app_saku2_report_gar_flAggPdrk = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gar_flAggPdrk.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gar_flAggPdrk";
		this.maximize();
...
window.app_saku2_report_gar_flAggPdrk.extend(window.portalui_childForm);
window.app_saku2_report_gar_flAggPdrk.implement({
