window.app_saku3_report_gar_flAggReset = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gar_flAggReset.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gar_flAggReset";
        this.maximize();
...
window.app_saku3_report_gar_flAggReset.extend(window.childForm);
window.app_saku3_report_gar_flAggReset.implement({
	doLoad:function(){
        try{
			...
			this.report = new server_report_report();
			var nama_report="server_report_saku3_gar_rptAggReset";
			this.filter="";
			this.showFilter = "";
			this.lokasi = "";
