window.app_saku3_report_gar_flAggTahunTelu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gar_flAggTahunTelu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gar_flAggTahunTelu";
		this.maximize();
...
window.app_saku3_report_gar_flAggTahunTelu.extend(window.portalui_childForm);
window.app_saku3_report_gar_flAggTahunTelu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				{
					this.nama_report="server_report_saku3_gar_rptAggRealTwTelu";
				}
				if (this.sg1.getCell(2,6)=="Semester")
				{
					this.nama_report="server_report_saku3_gar_rptAggRealSemTelu";
				}
				if (this.sg1.getCell(2,6)=="Bulanan")
				{
					this.nama_report="server_report_saku3_gar_rptAggRealBulanTelu";
				}
