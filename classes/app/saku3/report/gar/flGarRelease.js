window.app_saku3_report_gar_flGarRelease = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gar_flGarRelease.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gar_flGarRelease";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(tahun) as periode from anggaran_m where kode_lokasi='"+this.app._lokasi+"' and jenis='RILIS' ");
...
window.app_saku3_report_gar_flGarRelease.extend(window.portalui_childForm);
window.app_saku3_report_gar_flGarRelease.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.filter=this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where") +
					...
					" and a.jenis='RILIS'";
			this.nama_report="server_report_saku3_gar_rptGarRelease";	
