window.app_saku3_report_gar_flGarYks = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gar_flGarYks.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gar_flGarYks";
		this.maximize();
...
window.app_saku3_report_gar_flGarYks.extend(window.portalui_childForm);
window.app_saku3_report_gar_flGarYks.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			{			
				this.nama_report="server_report_saku3_gar_rptGarTwYks";
			}
			if (this.sg1.getCell(2,6)=="Semester")
			{
				this.nama_report="server_report_saku3_gar_rptGarSemYks";
			}
			if (this.sg1.getCell(2,6)=="Bulanan")
			{
				this.nama_report="server_report_saku3_gar_rptGarBulanYks";
			}
