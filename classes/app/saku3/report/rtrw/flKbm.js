window.app_saku3_report_rtrw_flKbm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_rtrw_flKbm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_rtrw_flKbm";
		this.maximize();
...
window.app_saku3_report_rtrw_flKbm.extend(window.childForm);
window.app_saku3_report_rtrw_flKbm.implement({
