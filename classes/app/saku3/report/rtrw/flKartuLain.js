// JavaScript Document
window.app_saku3_report_rtrw_flKartuLain = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_rtrw_flKartuLain.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_rtrw_flKartuLain";
		this.maximize();
...
window.app_saku3_report_rtrw_flKartuLain.extend(window.portalui_childForm);
window.app_saku3_report_rtrw_flKartuLain.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_rtrw_rptKartuLain";
				this.dbLib.execQuerySync(this.sql);	
	...
	doOpenBuku: function(kode_akun,kode_lokasi,periode,kode_pp){
		...
		this.link="1";
		filter = "where a.kode_akun='"+kode_akun+"' and a.kode_lokasi='"+kode_lokasi+"' and a.periode='"+periode+"' and a.kode_pp='"+kode_pp+"' ";
