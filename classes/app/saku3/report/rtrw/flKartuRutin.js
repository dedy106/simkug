// JavaScript Document
window.app_saku3_report_rtrw_flKartuRutin = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_rtrw_flKartuRutin.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_rtrw_flKartuRutin";
		this.maximize();
...
window.app_saku3_report_rtrw_flKartuRutin.extend(window.portalui_childForm);
window.app_saku3_report_rtrw_flKartuRutin.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_rtrw_rptKartuRutin";
				this.dbLib.execQuerySync(this.sql);	
