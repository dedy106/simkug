// JavaScript Document
window.app_saku3_report_rtrw_flJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_rtrw_flJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_rtrw_flJurnal";
		this.maximize();
...
window.app_saku3_report_rtrw_flJurnal.extend(window.portalui_childForm);
window.app_saku3_report_rtrw_flJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_rtrw_rptJurnal";
				this.dbLib.execQuerySync(this.sql);	
