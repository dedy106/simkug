window.app_saku3_report_rtrw_flRumah = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_rtrw_flRumah.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_rtrw_flRumah";
		this.maximize();
...
window.app_saku3_report_rtrw_flRumah.extend(window.childForm);
window.app_saku3_report_rtrw_flRumah.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row ==1)
			{
				this.filterRep.ListDataSGFilter(this, "Data Rumah",this.sg1, this.sg1.row, this.sg1.col,
														  "select a.kode_rumah, a.alamat from rt_rumah a  "+
														   this.filterRep.filterStr("a.kode_rumah",this.sg1.getCell(2,0)," where "),
														  "select count(a.kode_rumah) from rt_rumah a "+
														  this.filterRep.filterStr("a.kode_rumah",this.sg1.getCell(2,0)," where "),
														  ["a.kode_rumah","a.nama"],"and",["Kode","Nama"]);
			}
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							  this.filterRep.filterStr("kode_rumah",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");
				this.showFilter = this.filterRep.showFilter(this.sg1);
				this.nama_report = "server_report_saku3_rtrw_rptRumah";
