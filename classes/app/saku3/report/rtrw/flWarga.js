window.app_saku3_report_rtrw_flWarga = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_rtrw_flWarga.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_rtrw_flWarga";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Kode Warga","All",""));
	
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_rtrw_flWarga.extend(window.childForm);
window.app_saku3_report_rtrw_flWarga.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row ==1)
			{
				this.filterRep.ListDataSGFilter(this, "Data Warga",this.sg1, this.sg1.row, this.sg1.col,
														  "select a.nik, a.nama from rt_warga a  "+
														   this.filterRep.filterStr("a.nik",this.sg1.getCell(2,0)," where "),
														  "select count(a.nik) from rt_warga a "+
														  this.filterRep.filterStr("a.nik",this.sg1.getCell(2,0)," where "),
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("nik",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"where")+
							  this.filterRep.filterStr("nik",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");
				this.showFilter = this.filterRep.showFilter(this.sg1);
				this.nama_report = "server_report_saku3_rtrw_rptWarga";
