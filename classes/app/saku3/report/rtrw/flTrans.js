// JavaScript Document
window.app_saku3_report_rtrw_flTrans = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_rtrw_flTrans.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_rtrw_flTrans";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Referensi","All",""));
...
window.app_saku3_report_rtrw_flTrans.extend(window.portalui_childForm);
window.app_saku3_report_rtrw_flTrans.implement({
	doEllipseClick: function(sender, col, row){
		...
		if (row == 3)
		{
			...
			this.filterRep.ListDataSGFilter(this, "Data Jurnal",this.sg1, this.sg1.row, this.sg1.col,sql,sql2,
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_rtrw_rptTrans";
				this.dbLib.execQuerySync(this.sql);	
