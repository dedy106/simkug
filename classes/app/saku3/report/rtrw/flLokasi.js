window.app_saku3_report_rtrw_flLokasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_rtrw_flLokasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_rtrw_flLokasi";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,0,new Array(0,1,2), new Array("Data RW","=",this.app._lokasi));
	
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_rtrw_flLokasi.extend(window.childForm);
window.app_saku3_report_rtrw_flLokasi.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			if (row ==0)
			{
				this.filterRep.ListDataSGFilter(this, "Data RW",this.sg1, this.sg1.row, this.sg1.col,
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_rtrw_rptLokasi";
