window.app_saku3_report_rtrw_flIuran = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_rtrw_flIuran.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_rtrw_flIuran";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("RT","All",""));
...
window.app_saku3_report_rtrw_flIuran.extend(window.childForm);
window.app_saku3_report_rtrw_flIuran.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row ==1)
			{
				this.filterRep.ListDataSGFilter(this, "Data Periode",this.sg1, this.sg1.row, this.sg1.col,
												"select tgl_mulai, tgl_selesai from rt_iuran_jenis where kode_lokasi='"+this.app._lokasi+"'",
												"select count(*) from rt_iuran_jenis where kode_lokasi='"+this.app._lokasi+"'",
												new Array("tgl_mulai","tgl_selesai"),"where",new Array("Mulai","Selesai"));
			}			
			if (row ==2)
			{
				this.filterRep.ListDataSGFilter(this, "Data RT",this.sg1, this.sg1.row, this.sg1.col,
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_rtrw_rptIuran";
			...
			systemAPI.alert("[app_saku3_report_rtrw_flIuran]::mainButtonClick:"+e);
		}
	},
