window.app_saku3_report_rtrw_flLapPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_rtrw_flLapPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_rtrw_flLapPp";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Kode RT","All",""));
	
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_rtrw_flLapPp.extend(window.childForm);
window.app_saku3_report_rtrw_flLapPp.implement({
			...
			if (row ==1)
			{
				this.filterRep.ListDataSGFilter(this, "Data RT",this.sg1, this.sg1.row, this.sg1.col,
														  "select a.kode_pp, a.nama from pp a  "+
														   this.filterRep.filterStr("a.kode_pp",this.sg1.getCell(2,0)," where "),
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_rtrw_rptLapPp";
