window.app_saku3_report_maribaya_flUploadAkun = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_maribaya_flUploadAkun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_maribaya_flUploadAkun";
        this.maximize();
...
window.app_saku3_report_maribaya_flUploadAkun.extend(window.childForm);
window.app_saku3_report_maribaya_flUploadAkun.implement({
	doLoad:function(){
        try{
			...
			this.report = new server_report_report();
			var nama_report="server_report_saku3_maribaya_rptUploadAkun";
			this.filter="";
			this.showFilter = "";
			this.lokasi = "";
