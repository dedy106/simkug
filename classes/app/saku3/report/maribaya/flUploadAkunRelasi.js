window.app_saku3_report_maribaya_flUploadAkunRelasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_maribaya_flUploadAkunRelasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_maribaya_flUploadAkunRelasi";
        this.maximize();
...
window.app_saku3_report_maribaya_flUploadAkunRelasi.extend(window.childForm);
window.app_saku3_report_maribaya_flUploadAkunRelasi.implement({
	doLoad:function(){
        try{
			...
			this.report = new server_report_report();
			var nama_report="server_report_saku3_maribaya_rptUploadAkunRelasi";
			this.filter="";
			this.showFilter = "";
			this.lokasi = "";
