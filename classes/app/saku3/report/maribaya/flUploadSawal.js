window.app_saku3_report_maribaya_flUploadSawal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_maribaya_flUploadSawal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_maribaya_flUploadSawal";
        this.maximize();
...
window.app_saku3_report_maribaya_flUploadSawal.extend(window.childForm);
window.app_saku3_report_maribaya_flUploadSawal.implement({
	doLoad:function(){
        try{
			...
			this.report = new server_report_report();
			var nama_report="server_report_saku3_maribaya_rptUploadSawal";
			this.filter="";
			this.showFilter = "";
			this.lokasi = "";
