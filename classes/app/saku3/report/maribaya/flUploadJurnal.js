window.app_saku3_report_maribaya_flUploadJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_maribaya_flUploadJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_maribaya_flUploadJurnal";
        this.maximize();
...
window.app_saku3_report_maribaya_flUploadJurnal.extend(window.childForm);
window.app_saku3_report_maribaya_flUploadJurnal.implement({
	doLoad:function(){
        try{
			...
			this.report = new server_report_report();
			var nama_report="server_report_saku3_maribaya_rptUploadJurnal";
			this.filter="";
			this.showFilter = "";
			this.lokasi = "";
