window.app_saku3_report_uin_flVer = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_uin_flVer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_uin_flVer";
		this.maximize();
...
window.app_saku3_report_uin_flVer.extend(window.childForm);
window.app_saku3_report_uin_flVer.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_uin_flVer]::mainButtonClick:"+e);
		}
	},
