window.app_saku3_report_uin_flRBApdpt = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_uin_flRBApdpt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_uin_flRBApdpt";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,[0,1,2],["Unit","=",this.app._kodePP]);
...
window.app_saku3_report_uin_flRBApdpt.extend(window.portalui_childForm);
window.app_saku3_report_uin_flRBApdpt.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.app._userLog+"/"+this.sg1.getCell(1,2)+"/"+this.sg1.getCell(2,2);	
			this.nama_report="server_report_saku3_uin_rptRBApdpt";
