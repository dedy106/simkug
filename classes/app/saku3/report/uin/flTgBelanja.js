window.  app_saku3_report_uin_flTgBelanja = function(owner)
{
	if (owner)
	{
		window.  app_saku3_report_uin_flTgBelanja.prototype.parent.constructor.call(this,owner);
		this.className = "  app_saku3_report_uin_flTgBelanja";
		this.maximize();
...
window.  app_saku3_report_uin_flTgBelanja.extend(window.childForm);
window.  app_saku3_report_uin_flTgBelanja.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_uin_rptTgBelanja";
			...
			systemAPI.alert("[  app_saku3_report_uin_flTgBelanja]::mainButtonClick:"+e);
		}
	},
