window.app_saku3_report_uin_flGarRekapRab = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_uin_flGarRekapRab.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_uin_flGarRekapRab";
		this.maximize();
...
window.app_saku3_report_uin_flGarRekapRab.extend(window.childForm);
window.app_saku3_report_uin_flGarRekapRab.implement({
	...
	{		
		...
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4],["3","123"]);
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4],[2,0]);	
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_uin_rptGarRekapRab";
			...
			systemAPI.alert("[app_saku3_report_uin_flGarRekapRab]::mainButtonClick:"+e);
		}
	},
    ...
    doOpenBeban: function(kode_pp,kode_lokasi,tahun){
		this.kode_pp=kode_pp;
		this.kode_lokasi=kode_lokasi;
		this.tahun=tahun;
		this.link="1";
		filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1);
		filter="where a.kode_lokasi='"+kode_lokasi+"' and a.tahun='"+tahun+"' and a.kode_pp='"+kode_pp+"'";
		nama_report="server_report_saku3_uin_rptKertasKerja";
	...
	doOpenPdpt: function(kode_pp,kode_lokasi,tahun){
		this.kode_pp=kode_pp;
		this.kode_lokasi=kode_lokasi;
		this.tahun=tahun;
		this.link="1";
		filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1);
		filter="where a.kode_lokasi='"+kode_lokasi+"' and a.tahun='"+tahun+"' and a.kode_pp='"+kode_pp+"'";
		nama_report="server_report_saku3_uin_rptRBApdpt";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
	},
