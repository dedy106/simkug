window.app_saku3_report_uin_flRBAblj = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_uin_flRBAblj.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_uin_flRBAblj";
		this.maximize();
...
window.app_saku3_report_uin_flRBAblj.extend(window.portalui_childForm);
window.app_saku3_report_uin_flRBAblj.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_uin_rptRBAblj";
