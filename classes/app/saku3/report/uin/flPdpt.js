window.app_saku3_report_uin_flPdpt = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_uin_flPdpt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_uin_flPdpt";
		this.maximize();
...
window.app_saku3_report_uin_flPdpt.extend(window.childForm);
window.app_saku3_report_uin_flPdpt.implement({
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where") +
							  ...
							  " and a.form='PDPT' and a.status='ORGI'  ";
				...
				this.nama_report = "server_report_saku3_uin_rptPdpt";
			...
			systemAPI.alert("[app_saku3_report_uin_flPdpt]::mainButtonClick:"+e);
		}
	},
