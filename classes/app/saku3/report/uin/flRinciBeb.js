window.app_saku3_report_uin_flRinciBeb = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_uin_flRinciBeb.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_uin_flRinciBeb";
		this.maximize();
...
window.app_saku3_report_uin_flRinciBeb.extend(window.childForm);
window.app_saku3_report_uin_flRinciBeb.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_uin_rptRinciBeb";
				if (this.sg1.getCell(2,2)=="Unit")
				{
					this.nama_report = "server_report_saku3_uin_rptRinciBebUnit";
				}
			...
			systemAPI.alert("[app_saku3_report_uin_flRinciBeb]::mainButtonClick:"+e);
		}
	},
