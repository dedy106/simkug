window.app_saku3_report_uin_flRinciPdpt = function(owner)
{
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Jenis","=","Rekap"));
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Kode Unit","All",""));
...
window.app_saku3_report_uin_flRinciPdpt.implement({
	...
	{		
		...
		if (row == 2)
		{
			...
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("Rekap","Unit"));
		}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,2)+"/"+this.app._userLog;
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_uin_rptRinciPdpt";
				if (this.sg1.getCell(2,2)=="Unit")
				{
					this.nama_report = "server_report_saku3_uin_rptRinciPdptUnit";
				}
