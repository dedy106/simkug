window.app_saku3_report_uin_flRinciPdpt = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_uin_flRinciPdpt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_uin_flRinciPdpt";
		this.maximize();
...
window.app_saku3_report_uin_flRinciPdpt.extend(window.childForm);
window.app_saku3_report_uin_flRinciPdpt.implement({
		...
		try{			
			...
			if (row == 3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Daftar Bukti",this.sg1, this.sg1.row, this.sg1.col,
														  "select no_usul, keterangan from uin_usul_m "+filter,
														  "select count(no_usul) from uin_usul_m "+filter,
	...
	{		
		...
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3],["123","3","123"]);
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where") +
							  ...
							  this.filterRep.filterStr("a.no_usul",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and")+
							  " and a.form='BELANJA' and a.status='ORGI' ";
				...
				this.nama_report = "server_report_saku3_uin_rptBelanja";
			...
			systemAPI.alert("[app_saku3_report_uin_flRinciPdpt]::mainButtonClick:"+e);
		}
	},
