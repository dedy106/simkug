window.app_saku3_report_uin_flGarDetail = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_uin_flGarDetail.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_uin_flGarDetail";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Unit","All",""));
...
window.app_saku3_report_uin_flGarDetail.extend(window.childForm);
window.app_saku3_report_uin_flGarDetail.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_uin_rptGarDetail";
			...
			systemAPI.alert("[app_saku3_report_uin_flGarDetail]::mainButtonClick:"+e);
		}
	},
