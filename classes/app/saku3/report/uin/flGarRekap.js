window.app_saku3_report_uin_flGarRekap = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_uin_flGarRekap.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_uin_flGarRekap";
		this.maximize();
...
window.app_saku3_report_uin_flGarRekap.extend(window.childForm);
window.app_saku3_report_uin_flGarRekap.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_uin_rptGarRekap";
			...
			systemAPI.alert("[app_saku3_report_uin_flGarRekap]::mainButtonClick:"+e);
		}
	},
