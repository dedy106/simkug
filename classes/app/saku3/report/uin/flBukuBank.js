window.app_saku3_report_uin_flBukuBank = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_uin_flBukuBank.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_uin_flBukuBank";
		this.maximize();
...
window.app_saku3_report_uin_flBukuBank.extend(window.childForm);
window.app_saku3_report_uin_flBukuBank.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row == 2)
			{
				var filter = this.filterRep.filterStr("kdsatker",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where") +
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_uin_rptBukuBank";
			...
			systemAPI.alert("[app_saku3_report_uin_flBukuBank]::mainButtonClick:"+e);
		}
	},
