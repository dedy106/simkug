window.app_saku3_report_uin_flPosisi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_uin_flPosisi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_uin_flPosisi";
		this.maximize();
...
window.app_saku3_report_uin_flPosisi.extend(window.childForm);
window.app_saku3_report_uin_flPosisi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_uin_rptPosisi";
				/*
				if (this.sg1.getCell(2,3)=="RM")
				{
					this.nama_report = "server_report_saku3_uin_rptPosisiRm";
				}
				*/
			...
			systemAPI.alert("[app_saku3_report_uin_flPosisi]::mainButtonClick:"+e);
		}
	},
