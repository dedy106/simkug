window.app_saku3_report_uin_flSerahTerima = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_uin_flSerahTerima.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_uin_flSerahTerima";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from uin_stdok_m where kode_lokasi='"+this.app._lokasi+"'");
...
window.app_saku3_report_uin_flSerahTerima.extend(window.childForm);
window.app_saku3_report_uin_flSerahTerima.implement({
		...
		try{			
			...
			if (row == 3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Daftar Bukti",this.sg1, this.sg1.row, this.sg1.col,
														  "select a.no_fisik, a.nama_serah from uin_stdok_m a inner join uin_aju_m b on a.no_aju=b.no_aju and a.kode_lokasi=b.kode_lokasi "+filter,
														  "select count(no_fisik) from uin_stdok_m a inner join uin_aju_m b on a.no_aju=b.no_aju and a.kode_lokasi=b.kode_lokasi "+filter,
														  ["a.no_fisik","a.nama_serah"],"and",["No Bukti","Nama Penyerah"]);
			}			
		}catch(e){
			systemAPI.alert(e);
		}
	...
	{		
		...
		if (row == 1)
		{
			this.dbLib.setItemsFromSQL("select distinct periode from uin_stdok_m  ",[this.sg1.columns.get(2).pickList]);
		}
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where") +
							  ...
							  this.filterRep.filterStr("c.no_fisik",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and");
				...
				this.nama_report = "server_report_saku3_uin_rptSerahTerima";
			...
			systemAPI.alert("[app_saku3_report_uin_flSerahTerima]::mainButtonClick:"+e);
		}
	},
