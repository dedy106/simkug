window.  app_saku3_report_uin_flKegiatan = function(owner)
{
	if (owner)
	{
		window.  app_saku3_report_uin_flKegiatan.prototype.parent.constructor.call(this,owner);
		this.className = "  app_saku3_report_uin_flKegiatan";
		this.maximize();
...
window.  app_saku3_report_uin_flKegiatan.extend(window.childForm);
window.  app_saku3_report_uin_flKegiatan.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_uin_rptKegiatan";
			...
			systemAPI.alert("[  app_saku3_report_uin_flKegiatan]::mainButtonClick:"+e);
		}
	},
