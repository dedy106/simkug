window.app_saku3_report_uin_flProKeg = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_uin_flProKeg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_uin_flProKeg";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,0,[0,1,2],["Satker","=",this.satker]);
	this.gridLib.SGEditData(this.sg1,1,[0,1,2],["Tahun Anggaran","=",this.periode]);
...
window.app_saku3_report_uin_flProKeg.extend(window.portalui_childForm);
window.app_saku3_report_uin_flProKeg.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_uin_rptProKeg";
