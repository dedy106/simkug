window.app_saku3_report_uin_flAng = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_uin_flAng.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_uin_flAng";
		this.maximize();
...
window.app_saku3_report_uin_flAng.extend(window.childForm);
window.app_saku3_report_uin_flAng.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.filter2 = this.app._userLog+"/"+this.app._lokasi+"/"+this.app._kodePP;
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_uin_rptAng";
			...
			systemAPI.alert("[app_saku3_report_uin_flAng]::mainButtonClick:"+e);
		}
	},
