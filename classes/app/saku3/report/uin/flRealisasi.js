window.app_saku3_report_uin_flRealisasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_uin_flRealisasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_uin_flRealisasi";
		this.maximize();
...
window.app_saku3_report_uin_flRealisasi.extend(window.childForm);
window.app_saku3_report_uin_flRealisasi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_uin_flRealisasi]::mainButtonClick:"+e);
		}
	},
