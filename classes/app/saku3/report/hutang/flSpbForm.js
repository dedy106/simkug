window.app_saku3_report_hutang_flSpbForm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_hutang_flSpbForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_hutang_flSpbForm";
		this.maximize();
...
window.app_saku3_report_hutang_flSpbForm.extend(window.childForm);
window.app_saku3_report_hutang_flSpbForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_hutang_flSpbForm]::mainButtonClick:"+e);
		}
	},
