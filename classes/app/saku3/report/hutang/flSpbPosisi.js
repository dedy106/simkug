window.app_saku3_report_hutang_flSpbPosisi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_hutang_flSpbPosisi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_hutang_flSpbPosisi";
		this.maximize();
...
window.app_saku3_report_hutang_flSpbPosisi.extend(window.childForm);
window.app_saku3_report_hutang_flSpbPosisi.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from spb_m where kode_lokasi='"+this.app._lokasi+"' order by periode desc",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_hutang_rptSpbPosisi";
			...
			systemAPI.alert("[app_saku3_report_hutang_flSpbPosisi]::mainButtonClick:"+e);
		}
	},
