window.app_saku3_report_hutang_flPbForm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_hutang_flPbForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_hutang_flPbForm";
		this.maximize();
...
window.app_saku3_report_hutang_flPbForm.extend(window.childForm);
window.app_saku3_report_hutang_flPbForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_hutang_flPbForm]::mainButtonClick:"+e);
		}
	},
