window.app_saku3_report_hutang_flHutangKartu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_hutang_flHutangKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_hutang_flHutangKartu";
		this.maximize();
...
window.app_saku3_report_hutang_flHutangKartu.extend(window.childForm);
window.app_saku3_report_hutang_flHutangKartu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_hutang_rptHutangKartu";
			...
			systemAPI.alert("[app_saku3_report_hutang_flHutangKartu]::mainButtonClick:"+e);
		}
	},
