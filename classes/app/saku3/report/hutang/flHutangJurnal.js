window.app_saku3_report_hutang_flHutangJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_hutang_flHutangJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_hutang_flHutangJurnal";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from hutang_m where kode_lokasi='"+this.app._lokasi+"'  and modul='AKRU'");
...
window.app_saku3_report_hutang_flHutangJurnal.extend(window.childForm);
window.app_saku3_report_hutang_flHutangJurnal.implement({
