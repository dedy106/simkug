window.app_saku3_report_hutang_flHutangRevJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_hutang_flHutangRevJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_hutang_flHutangRevJurnal";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from hutang_m where kode_lokasi='"+this.app._lokasi+"' and modul='REV'");
...
window.app_saku3_report_hutang_flHutangRevJurnal.extend(window.childForm);
window.app_saku3_report_hutang_flHutangRevJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_saku3_hutang_rptHutangJurnal";
