window.app_saku3_report_klinik_flBeliRekapKlp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_klinik_flBeliRekapKlp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_klinik_flBeliRekapKlp";
		this.maximize();
...
window.app_saku3_report_klinik_flBeliRekapKlp.extend(window.childForm);
window.app_saku3_report_klinik_flBeliRekapKlp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_klinik_rptBeliRekapKlp";
			...
			systemAPI.alert("[app_saku3_report_klinik_flBeliRekapKlp]::mainButtonClick:"+e);
		}
	},
