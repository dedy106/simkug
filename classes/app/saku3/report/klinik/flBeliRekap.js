window.app_saku3_report_klinik_flBeliRekap = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_klinik_flBeliRekap.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_klinik_flBeliRekap";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from kli_beli_m ");
...
window.app_saku3_report_klinik_flBeliRekap.extend(window.childForm);
window.app_saku3_report_klinik_flBeliRekap.implement({
		...
		try{			
			...
			if (row ==3)
			{
				this.filterRep.ListDataSGFilter(this, "Data Gudang",this.sg1, this.sg1.row, this.sg1.col,
												"select kode_gudang, nama from kli_pp ",
												"select count(*) from kli_pp ",
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_klinik_rptBeliRekap";
			...
			systemAPI.alert("[app_saku3_report_klinik_flBeliRekap]::mainButtonClick:"+e);
		}
	},
