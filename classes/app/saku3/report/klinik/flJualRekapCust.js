window.app_saku3_report_klinik_flJualRekapCust = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_klinik_flJualRekapCust.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_klinik_flJualRekapCust";
		this.maximize();
...
window.app_saku3_report_klinik_flJualRekapCust.extend(window.childForm);
window.app_saku3_report_klinik_flJualRekapCust.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_klinik_rptJualRekapCust";
			...
			systemAPI.alert("[app_saku3_report_klinik_flJualRekapCust]::mainButtonClick:"+e);
		}
	},
