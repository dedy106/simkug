window.app_saku3_report_klinik_flPiutangAging = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_klinik_flPiutangAging.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_klinik_flPiutangAging";
		this.maximize();
...
window.app_saku3_report_klinik_flPiutangAging.extend(window.childForm);
window.app_saku3_report_klinik_flPiutangAging.implement({
		...
		try{			
			...
			if (row == 2)
			{
				this.filterRep.ListDataSGFilter(this, "Data Customer",this.sg1, this.sg1.row, this.sg1.col,
														  "select kode_cust, nama from kli_cust "+
														   this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  "select count(kode_cust) from kli_cust "+
														  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
			...
			if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Invoice",this.sg1, this.sg1.row, this.sg1.col,
												...
												"select count(b.no_jual) from kli_jual_m a "+filter,
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_klinik_rptPiutangAging";
			...
			systemAPI.alert("[app_saku3_report_klinik_flPiutangAging]::mainButtonClick:"+e);
		}
	},
