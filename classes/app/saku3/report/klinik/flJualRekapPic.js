window.app_saku3_report_klinik_flJualRekapPic = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_klinik_flJualRekapPic.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_klinik_flJualRekapPic";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Marketing","All",""));
...
window.app_saku3_report_klinik_flJualRekapPic.extend(window.childForm);
window.app_saku3_report_klinik_flJualRekapPic.implement({
		...
		try{			
			...
			if (row ==2)
			{
				this.filterRep.ListDataSGFilter(this, "Data Marketing",this.sg1, this.sg1.row, this.sg1.col,
												"select kode_pic, nama from kli_pic ",
												"select count(*) from kli_pic ",
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.kode_pic",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
				this.filter2 = this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,0);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_klinik_rptJualRekapPic";
			...
			systemAPI.alert("[app_saku3_report_klinik_flJualRekapPic]::mainButtonClick:"+e);
		}
	},
