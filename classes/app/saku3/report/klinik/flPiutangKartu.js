window.app_saku3_report_klinik_flPiutangKartu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_klinik_flPiutangKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_klinik_flPiutangKartu";
		this.maximize();
...
window.app_saku3_report_klinik_flPiutangKartu.extend(window.childForm);
window.app_saku3_report_klinik_flPiutangKartu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_klinik_rptPiutangKartu";
			...
			systemAPI.alert("[app_saku3_report_klinik_flPiutangKartu]::mainButtonClick:"+e);
		}
	},
