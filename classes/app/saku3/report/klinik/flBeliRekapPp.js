window.app_saku3_report_klinik_flBeliRekapPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_klinik_flBeliRekapPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_klinik_flBeliRekapPp";
		this.maximize();
...
window.app_saku3_report_klinik_flBeliRekapPp.extend(window.childForm);
window.app_saku3_report_klinik_flBeliRekapPp.implement({
		...
		try{			
			...
			if (row ==2)
			{
				this.filterRep.ListDataSGFilter(this, "Data Gudang",this.sg1, this.sg1.row, this.sg1.col,
												"select kode_pp, nama from kli_pp ",
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_klinik_rptBeliRekapPp";
			...
			systemAPI.alert("[app_saku3_report_klinik_flBeliRekapPp]::mainButtonClick:"+e);
		}
	},
