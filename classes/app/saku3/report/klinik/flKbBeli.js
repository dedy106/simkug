window.app_saku3_report_klinik_flKbBeli = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_klinik_flKbBeli.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_klinik_flKbBeli";
		this.maximize();
...
window.app_saku3_report_klinik_flKbBeli.extend(window.childForm);
window.app_saku3_report_klinik_flKbBeli.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_klinik_flKbBeli]::mainButtonClick:"+e);
		}
	},
