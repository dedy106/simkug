window.app_saku3_report_klinik_flJualRekapPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_klinik_flJualRekapPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_klinik_flJualRekapPp";
		this.maximize();
...
window.app_saku3_report_klinik_flJualRekapPp.extend(window.childForm);
window.app_saku3_report_klinik_flJualRekapPp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_klinik_rptJualRekapPp";
			...
			systemAPI.alert("[app_saku3_report_klinik_flJualRekapPp]::mainButtonClick:"+e);
		}
	},
