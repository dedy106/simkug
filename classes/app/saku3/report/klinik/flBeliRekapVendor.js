window.app_saku3_report_klinik_flBeliRekapVendor = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_klinik_flBeliRekapVendor.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_klinik_flBeliRekapVendor";
		this.maximize();
...
window.app_saku3_report_klinik_flBeliRekapVendor.extend(window.childForm);
window.app_saku3_report_klinik_flBeliRekapVendor.implement({
		...
		try{			
			...
			if (row ==2)
			{
				this.filterRep.ListDataSGFilter(this, "Data vendor",this.sg1, this.sg1.row, this.sg1.col,
												"select kode_cust, nama from kli_vendor ",
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_klinik_rptBeliRekapVendor";
			...
			systemAPI.alert("[app_saku3_report_klinik_flBeliRekapVendor]::mainButtonClick:"+e);
		}
	},
