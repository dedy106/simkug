window.app_saku3_report_klinik_flBeliJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_klinik_flBeliJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_klinik_flBeliJurnal";
		this.maximize();
...
window.app_saku3_report_klinik_flBeliJurnal.extend(window.childForm);
window.app_saku3_report_klinik_flBeliJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_klinik_rptBeliJurnal";
			...
			systemAPI.alert("[app_saku3_report_klinik_flBeliJurnal]::mainButtonClick:"+e);
		}
	},
