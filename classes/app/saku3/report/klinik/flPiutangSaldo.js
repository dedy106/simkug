window.app_saku3_report_klinik_flPiutangSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_klinik_flPiutangSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_klinik_flPiutangSaldo";
		this.maximize();
...
window.app_saku3_report_klinik_flPiutangSaldo.extend(window.childForm);
window.app_saku3_report_klinik_flPiutangSaldo.implement({
		...
		try{			
			...
			if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Invoice",this.sg1, this.sg1.row, this.sg1.col,
												...
												new Array("a.no_jual","a.keterangan"),"and",new Array("No Invoice","Keterangan"));
			}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_klinik_rptPiutangSaldo";
			...
			systemAPI.alert("[app_saku3_report_klinik_flPiutangSaldo]::mainButtonClick:"+e);
		}
	},
