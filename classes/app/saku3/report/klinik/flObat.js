window.app_saku3_report_klinik_flObat = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_klinik_flObat.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_klinik_flObat";
		this.maximize();
...
window.app_saku3_report_klinik_flObat.extend(window.childForm);
window.app_saku3_report_klinik_flObat.implement({
		...
		try{			
			...
			if (row ==1)
			{
				this.filterRep.ListDataSGFilter(this, "Data Kelompok",this.sg1, this.sg1.row, this.sg1.col,
												"select kode_klp, nama from kli_obat_klp ",
												"select count(*) from kli_obat_klp ",
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.kode_obat",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
				this.filter2 = this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,0)+"/"+this.app._nikUser;
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_klinik_rptObat";
			...
			systemAPI.alert("[app_saku3_report_klinik_flObat]::mainButtonClick:"+e);
		}
	},
