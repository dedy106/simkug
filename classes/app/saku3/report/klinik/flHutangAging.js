window.app_saku3_report_klinik_flHutangAging = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_klinik_flHutangAging.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_klinik_flHutangAging";
		this.maximize();
...
window.app_saku3_report_klinik_flHutangAging.extend(window.childForm);
window.app_saku3_report_klinik_flHutangAging.implement({
		...
		try{			
			...
			if (row == 2)
			{
				this.filterRep.ListDataSGFilter(this, "Data Vendor",this.sg1, this.sg1.row, this.sg1.col,
														  "select kode_vendor, nama from kli_vendor "+
														   this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  "select count(kode_vendor) from kli_vendor "+
														  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
			...
			if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Invoice",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_jual, a.keterangan from kli_beli_m a "+filter,
												"select count(b.no_jual) from kli_beli_m a "+filter,
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_klinik_rptHutangAging";
			...
			systemAPI.alert("[app_saku3_report_klinik_flHutangAging]::mainButtonClick:"+e);
		}
	},
