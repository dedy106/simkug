window.app_saku3_report_klinik_flJualJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_klinik_flJualJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_klinik_flJualJurnal";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from kli_jual_m  ");
...
window.app_saku3_report_klinik_flJualJurnal.extend(window.childForm);
window.app_saku3_report_klinik_flJualJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_klinik_rptJualJurnal";
			...
			systemAPI.alert("[app_saku3_report_klinik_flJualJurnal]::mainButtonClick:"+e);
		}
	},
