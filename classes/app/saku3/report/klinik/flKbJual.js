window.app_saku3_report_klinik_flKbJual = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_klinik_flKbJual.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_klinik_flKbJual";
		this.maximize();
...
window.app_saku3_report_klinik_flKbJual.extend(window.childForm);
window.app_saku3_report_klinik_flKbJual.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_klinik_flKbJual]::mainButtonClick:"+e);
		}
	},
