window.app_saku3_report_klinik_flJual = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_klinik_flJual.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_klinik_flJual";
		this.maximize();
...
window.app_saku3_report_klinik_flJual.extend(window.childForm);
window.app_saku3_report_klinik_flJual.implement({
		...
		try{			
			...
			if (row ==3)
			{
				this.filterRep.ListDataSGFilter(this, "Data Gudang",this.sg1, this.sg1.row, this.sg1.col,
												"select kode_gudang, nama from apo_brg_gudang where kode_lokasi='"+this.app._lokasi+"'",
												"select count(*) from apo_brg_gudang where kode_lokasi='"+this.app._lokasi+"'",
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_klinik_flJual]::mainButtonClick:"+e);
		}
	},
