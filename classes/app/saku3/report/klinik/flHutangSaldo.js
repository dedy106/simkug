window.app_saku3_report_klinik_flHutangSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_klinik_flHutangSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_klinik_flHutangSaldo";
		this.maximize();
...
window.app_saku3_report_klinik_flHutangSaldo.extend(window.childForm);
window.app_saku3_report_klinik_flHutangSaldo.implement({
		...
		try{			
			...
			if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Invoice",this.sg1, this.sg1.row, this.sg1.col,
												...
												new Array("a.no_beli","a.keterangan"),"and",new Array("No Invoice","Keterangan"));
			}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_klinik_rptHutangSaldo";
			...
			systemAPI.alert("[app_saku3_report_klinik_flHutangSaldo]::mainButtonClick:"+e);
		}
	},
