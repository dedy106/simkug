window.app_saku3_report_klinik_flHutangKartu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_klinik_flHutangKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_klinik_flHutangKartu";
		this.maximize();
...
window.app_saku3_report_klinik_flHutangKartu.extend(window.childForm);
window.app_saku3_report_klinik_flHutangKartu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_klinik_rptHutangKartu";
			...
			systemAPI.alert("[app_saku3_report_klinik_flHutangKartu]::mainButtonClick:"+e);
		}
	},
