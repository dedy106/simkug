window.app_saku3_report_klinik_flJualRekapKlp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_klinik_flJualRekapKlp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_klinik_flJualRekapKlp";
		this.maximize();
...
window.app_saku3_report_klinik_flJualRekapKlp.extend(window.childForm);
window.app_saku3_report_klinik_flJualRekapKlp.implement({
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("c.kode_klp",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
				this.filter2 = this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,0);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_klinik_rptJualRekapKlp";
			...
			systemAPI.alert("[app_saku3_report_klinik_flJualRekapKlp]::mainButtonClick:"+e);
		}
	},
