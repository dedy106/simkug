// JavaScript Document
window.app_saku3_report_panjar_flPanjarPtgJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_panjar_flPanjarPtgJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_panjar_flPanjarPtgJurnal";
		this.maximize();
...
window.app_saku3_report_panjar_flPanjarPtgJurnal.extend(window.portalui_childForm);
window.app_saku3_report_panjar_flPanjarPtgJurnal.implement({
