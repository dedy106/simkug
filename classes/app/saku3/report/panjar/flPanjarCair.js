window.app_saku3_report_panjar_flPanjarCair = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_panjar_flPanjarCair.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_panjar_flPanjarCair";
		this.maximize();
...
window.app_saku3_report_panjar_flPanjarCair.extend(window.childForm);
window.app_saku3_report_panjar_flPanjarCair.implement({
		...
		try{			
			...
			if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Karyawan",this.sg1, this.sg1.row, this.sg1.col,
												...
												"select count(*) from karyawan a "+ filter,
			...
			if (row ==4)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Panjar",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_ptg, a.keterangan from ptg_m a "+filter,
												"select count(*) from panjar_m a "+filter,
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_panjar_rptPanjarCair";
			...
			systemAPI.alert("[app_saku3_report_panjar_flPanjarCair]::mainButtonClick:"+e);
		}
	},
