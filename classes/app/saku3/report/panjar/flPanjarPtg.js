window.app_saku3_report_panjar_flPanjarPtg = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_panjar_flPanjarPtg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_panjar_flPanjarPtg";
		this.maximize();
...
window.app_saku3_report_panjar_flPanjarPtg.extend(window.childForm);
window.app_saku3_report_panjar_flPanjarPtg.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_panjar_rptPanjarPtg";
			...
			systemAPI.alert("[app_saku3_report_panjar_flPanjarPtg]::mainButtonClick:"+e);
		}
	},
