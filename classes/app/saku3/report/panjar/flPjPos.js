window.app_saku3_report_panjar_flPjPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_panjar_flPjPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_panjar_flPjPos";
		this.maximize();
...
window.app_saku3_report_panjar_flPjPos.extend(window.childForm);
window.app_saku3_report_panjar_flPjPos.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from yk_pjaju_m where kode_lokasi='"+this.app._lokasi+"' order by periode",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_panjar_rptPjPos";
			...
			systemAPI.alert("[app_saku3_report_panjar_flPjPos]::mainButtonClick:"+e);
		}
	},
