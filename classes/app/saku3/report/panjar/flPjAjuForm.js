window.app_saku3_report_panjar_flPjAjuForm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_panjar_flPjAjuForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_panjar_flPjAjuForm";
		this.maximize();
...
window.app_saku3_report_panjar_flPjAjuForm.extend(window.childForm);
window.app_saku3_report_panjar_flPjAjuForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_panjar_flPjAjuForm]::mainButtonClick:"+e);
		}
	},
