window.app_saku3_report_pajak_flHonor = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_pajak_flHonor.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_pajak_flHonor";
		this.maximize();
...
window.app_saku3_report_pajak_flHonor.extend(window.childForm);
window.app_saku3_report_pajak_flHonor.implement({
		...
		try
		{
			...
			else
			{
				...
				*/
				...
				this.nama_report = "server_report_saku3_pajak_rptHonor";
			...
			systemAPI.alert("[app_saku3_report_pajak_flHonor]::mainButtonClick:"+e);
		}
	},
