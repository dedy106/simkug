window.app_saku3_report_pajak_flHonor2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_pajak_flHonor2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_pajak_flHonor2";
		this.maximize();
...
window.app_saku3_report_pajak_flHonor2.extend(window.childForm);
window.app_saku3_report_pajak_flHonor2.implement({
		...
		try
		{
			...
			else
			{
				...
				*/
				...
				this.nama_report = "server_report_saku3_pajak_rptHonor2";
			...
			systemAPI.alert("[app_saku3_report_pajak_flHonor2]::mainButtonClick:"+e);
		}
	},
