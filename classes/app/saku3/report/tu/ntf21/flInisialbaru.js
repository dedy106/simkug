window.app_saku3_report_tu_ntf21_flInisialbaru = function (owner) {
	if (owner) {
		window.app_saku3_report_tu_ntf21_flInisialbaru.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku3_report_tu_ntf21_flInisialbaru";
		this.maximize();
...
window.app_saku3_report_tu_ntf21_flInisialbaru.extend(window.childForm);
window.app_saku3_report_tu_ntf21_flInisialbaru.implement({
	...
	mainButtonClick: function (sender) {
		try {
			if (sender === this.app._mainForm.bClear2) {
				...
				this.nama_report = "server_report_saku3_tu_ntf21_rptInisiasi";
			...
			systemAPI.alert("[app_saku3_report_tu_ntf21_flInisialbaru]::mainButtonClick:" + e);
		}
	},
