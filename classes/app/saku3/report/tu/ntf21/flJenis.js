window.app_saku3_report_tu_ntf21_flJenis = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_ntf21_flJenis.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_ntf21_flJenis";
		this.maximize();
...
window.app_saku3_report_tu_ntf21_flJenis.extend(window.childForm);
window.app_saku3_report_tu_ntf21_flJenis.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tu_ntf21_rptJenis";
			...
			systemAPI.alert("[app_saku3_report_tu_ntf21_flJenis]::mainButtonClick:"+e);
		}
	},
