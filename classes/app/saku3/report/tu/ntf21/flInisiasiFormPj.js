window.app_saku3_report_tu_ntf21_flInisiasiFormPj = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_ntf21_flInisiasiFormPj.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_ntf21_flInisiasiFormPj";
		this.maximize();
...
window.app_saku3_report_tu_ntf21_flInisiasiFormPj.extend(window.childForm);
window.app_saku3_report_tu_ntf21_flInisiasiFormPj.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tu_ntf21_rptInisiasiFormPj";
			...
			systemAPI.alert("[app_saku3_report_tu_ntf21_flInisiasiFormPj]::mainButtonClick:"+e);
		}
	},
