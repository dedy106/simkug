window.app_saku3_report_tu_ntf21_flProyekAkt = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_ntf21_flProyekAkt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_ntf21_flProyekAkt";
		this.maximize();
...
window.app_saku3_report_tu_ntf21_flProyekAkt.extend(window.childForm);
window.app_saku3_report_tu_ntf21_flProyekAkt.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			// 											  "select kode_cust, nama from prb_cust "+
			// 											   this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
			// 											  "select count(kode_cust) from prb_cust "+
			// 											  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				if(this.sg1.getCell(1,2) == "="){
					var filter_pp = " and (a.kode_pp = '"+this.sg1.getCell(2,2)+"' OR a.pp_rab = '"+this.sg1.getCell(2,2)+"')";
				}else if(this.sg1.getCell(1,2) == "Range"){
					var filter_pp = " and ( (a.kode_pp between '"+this.sg1.getCell(2,2)+"' and '"+this.sg1.getCell(2,3)+"') OR (a.pp_rab between '"+this.sg1.getCell(2,2)+"' and '"+this.sg1.getCell(2,3)+"') )";
				}else{
					var filter_pp = "";
				}
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.kode_proyek",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and")+filter_pp;

							this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_tu_ntf21_rptProyekAkt";
			...
			systemAPI.alert("[app_saku3_report_tu_ntf21_flProyekAkt]::mainButtonClick:"+e);
		}
	},
