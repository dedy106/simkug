window.app_saku3_report_tu_ntf21_flInisiasiJoinCost = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_ntf21_flInisiasiJoinCost.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_ntf21_flInisiasiJoinCost";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from ju_m where modul='IJC'  ");
...
window.app_saku3_report_tu_ntf21_flInisiasiJoinCost.extend(window.childForm);
window.app_saku3_report_tu_ntf21_flInisiasiJoinCost.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tu_ntf21_rptInisiasiJoinCost";
			...
			systemAPI.alert("[app_saku3_report_tu_ntf21_flInisiasiJoinCost]::mainButtonClick:"+e);
		}
	},
