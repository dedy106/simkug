window.app_saku3_report_tu_ntf21_flInisiasiFormPtg = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_ntf21_flInisiasiFormPtg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_ntf21_flInisiasiFormPtg";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from it_aju_m where kode_lokasi='"+this.app._lokasi+"' and form='PJINISIASI'");
...
window.app_saku3_report_tu_ntf21_flInisiasiFormPtg.extend(window.childForm);
window.app_saku3_report_tu_ntf21_flInisiasiFormPtg.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tu_ntf21_rptInisiasiFormPtg";
			...
			systemAPI.alert("[app_saku3_report_tu_ntf21_flInisiasiFormPtg]::mainButtonClick:"+e);
		}
	},
