window.app_saku3_report_tu_ntf21_flCust = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_ntf21_flCust.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_ntf21_flCust";
		this.maximize();
...
window.app_saku3_report_tu_ntf21_flCust.extend(window.childForm);
window.app_saku3_report_tu_ntf21_flCust.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tu_ntf21_rptCust";
			...
			systemAPI.alert("[app_saku3_report_tu_ntf21_flCust]::mainButtonClick:"+e);
		}
	},
