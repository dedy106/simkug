window.app_saku3_report_tu_pajak_flPegawai = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_pajak_flPegawai.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_pajak_flPegawai";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Kode Pegawai","All",""));
	
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_tu_pajak_flPegawai.extend(window.childForm);
window.app_saku3_report_tu_pajak_flPegawai.implement({
		...
		try{			
			...
			if (row == 1)
			{
				this.filterRep.ListDataSGFilter(this, "Data Pegawai",this.sg1, this.sg1.row, this.sg1.col,
												"select nik, nama from it_pegawai",
												"select count(*) from it_pegawai",
												new Array("nik","nama"),"where",new Array("Kode","Nama"));
			}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tu_pajak_rptPegawai";
