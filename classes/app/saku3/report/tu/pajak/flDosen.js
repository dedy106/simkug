window.app_saku3_report_tu_pajak_flDosen = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_pajak_flDosen.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_pajak_flDosen";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Kode Dosen","All",""));
	
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_tu_pajak_flDosen.extend(window.childForm);
window.app_saku3_report_tu_pajak_flDosen.implement({
		...
		try{			
			...
			if (row == 1)
			{
				this.filterRep.ListDataSGFilter(this, "Data Dosen",this.sg1, this.sg1.row, this.sg1.col,
												...
												"select count(*) from it_dosen",
												new Array("kode_dosen","nama"),"where",new Array("Kode","Nama"));
			}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tu_pajak_rptDosen";
