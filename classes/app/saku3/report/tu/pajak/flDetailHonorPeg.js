window.app_saku3_report_tu_pajak_flDetailHonorPeg = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_pajak_flDetailHonorPeg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_pajak_flDetailHonorPeg";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from it_aju_m where kode_lokasi='"+this.app._lokasi+"' and form='PEGAWAI' ");
...
window.app_saku3_report_tu_pajak_flDetailHonorPeg.extend(window.childForm);
window.app_saku3_report_tu_pajak_flDetailHonorPeg.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from it_aju_m where kode_lokasi='"+this.app._lokasi+"' and form='PEGAWAI' order by periode",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
		if (row === 5)
		{
			this.sg1.columns.get(2).pickList.clear();
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_tu_pajak_flDetailHonorPeg]::mainButtonClick:"+e);
		}
	},
