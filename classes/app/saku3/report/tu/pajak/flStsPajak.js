window.app_saku3_report_tu_pajak_flStsPajak = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_pajak_flStsPajak.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_pajak_flStsPajak";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Kode Pajak","All",""));
	
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_tu_pajak_flStsPajak.extend(window.childForm);
window.app_saku3_report_tu_pajak_flStsPajak.implement({
		...
		try{			
			...
			if (row == 1)
			{
				this.filterRep.ListDataSGFilter(this, "Data Pajak",this.sg1, this.sg1.row, this.sg1.col,
												"select kode_pajak, nama from it_stspajak",
												"select count(*) from it_stspajak",
												new Array("kode_pajak","nama"),"where",new Array("Kode","Nama"));
			}
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							  this.filterRep.filterStr("kode_pajak",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");
				this.showFilter = this.filterRep.showFilter(this.sg1);
				this.nama_report = "server_report_saku3_tu_pajak_rptStsPajak";
