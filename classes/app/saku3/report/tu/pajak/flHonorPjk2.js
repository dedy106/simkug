window.app_saku3_report_tu_pajak_flHonorPjk2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_pajak_flHonorPjk2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_pajak_flHonorPjk2";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from it_aju_m where kode_lokasi='"+this.app._lokasi+"' and form in ('NONPEG','HONOR1')  ");
...
window.app_saku3_report_tu_pajak_flHonorPjk2.extend(window.childForm);
window.app_saku3_report_tu_pajak_flHonorPjk2.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from it_aju_m where kode_lokasi='"+this.app._lokasi+"' and form in ('NONPEG','HONOR1')  order by periode",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
		if (row === 5)
		{
			this.sg1.columns.get(2).pickList.clear();
		...
		try
		{
			...
			else
			{
				...
				*/
				...
				this.nama_report = "server_report_saku3_tu_pajak_rptHonorPjk2";
			...
			systemAPI.alert("[app_saku3_report_tu_pajak_flHonorPjk2]::mainButtonClick:"+e);
		}
	},
