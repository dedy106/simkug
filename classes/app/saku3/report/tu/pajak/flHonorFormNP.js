window.app_saku3_report_tu_pajak_flHonorFormNP = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_pajak_flHonorFormNP.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_pajak_flHonorFormNP";
		this.maximize();
...
window.app_saku3_report_tu_pajak_flHonorFormNP.extend(window.childForm);
window.app_saku3_report_tu_pajak_flHonorFormNP.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Pengajuaan",this.sg1, this.sg1.row, this.sg1.col,
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from it_aju_m where form in ('PEGAWAI','HONOR') and  kode_lokasi='"+this.app._lokasi+"' order by periode",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_tu_pajak_flHonorFormNP]::mainButtonClick:"+e);
		}
	},
