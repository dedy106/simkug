window.app_saku3_report_tu_pajak_flFormula = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_pajak_flFormula.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_pajak_flFormula";
		this.maximize();
...
window.app_saku3_report_tu_pajak_flFormula.extend(window.childForm);
window.app_saku3_report_tu_pajak_flFormula.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct jenis from pjk_pph21 where kode_lokasi='"+this.app._lokasi+"' order by jenis",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}	
	},
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							  this.filterRep.filterStr("jenis",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");
				this.showFilter = this.filterRep.showFilter(this.sg1);
				this.nama_report = "server_report_saku3_tu_pajak_rptFormula";
