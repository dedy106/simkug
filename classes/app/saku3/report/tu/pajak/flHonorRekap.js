window.app_saku3_report_tu_pajak_flHonorRekap = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_pajak_flHonorRekap.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_pajak_flHonorRekap";
		this.maximize();
...
window.app_saku3_report_tu_pajak_flHonorRekap.extend(window.childForm);
window.app_saku3_report_tu_pajak_flHonorRekap.implement({
		...
		try
		{
			...
			else
			{
				...
				*/
				...
				this.nama_report = "server_report_saku3_tu_pajak_rptHonorRekap";
			...
			systemAPI.alert("[app_saku3_report_tu_pajak_flHonorRekap]::mainButtonClick:"+e);
		}
	},
