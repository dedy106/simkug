// JavaScript Document
window.app_saku3_report_tu_flProyekShu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_flProyekShu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_flProyekShu";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Kode FS","=","FP5"));
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Bentuk Laporan","=","Summary"));
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("Kode PP","=","4102"));
...
window.app_saku3_report_tu_flProyekShu.extend(window.portalui_childForm);
window.app_saku3_report_tu_flProyekShu.implement({
	doEllipseClick: function(sender, col, row){
		...
		if (row == 4)
		{
			...
			this.filterRep.ListDataSGFilter(this, "Data PP",this.sg1, this.sg1.row, this.sg1.col,sql,sql2,new Array("a.kode_pp","a.nama"),"and");
		}
	},
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_tu_rptProyekShu";
