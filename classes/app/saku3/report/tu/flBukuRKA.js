window.app_saku3_report_tu_flBukuRKA = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_flBukuRKA.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_flBukuRKA";
        this.maximize();
...
window.app_saku3_report_tu_flBukuRKA.extend(window.childForm);
window.app_saku3_report_tu_flBukuRKA.implement({
	doLoad:function(){
        try{
			...
			this.report = new server_report_report();
			var nama_report="server_report_saku3_tu_rptBukuRKA";
			this.filter="";
			this.showFilter = "";
			this.lokasi = "";

			this.filter2 = this.app._lokasi+"/"+this.app._periode+"/"+this.app._userLog;
