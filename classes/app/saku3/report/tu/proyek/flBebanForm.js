window.app_saku3_report_tu_proyek_flBebanForm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_proyek_flBebanForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_proyek_flBebanForm";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from it_aju_m where kode_lokasi='"+this.app._lokasi+"' and form='INISIASI'");
...
window.app_saku3_report_tu_proyek_flBebanForm.extend(window.childForm);
window.app_saku3_report_tu_proyek_flBebanForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_tu_proyek_flBebanForm]::mainButtonClick:"+e);
		}
	},
