window.app_saku3_report_tu_proyek_flJoinCost = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_proyek_flJoinCost.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_proyek_flJoinCost";
		this.maximize();
...
window.app_saku3_report_tu_proyek_flJoinCost.extend(window.childForm);
window.app_saku3_report_tu_proyek_flJoinCost.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tu_proyek_rptJoinCost";
			...
			systemAPI.alert("[app_saku3_report_tu_proyek_flJoinCost]::mainButtonClick:"+e);
		}
	},
