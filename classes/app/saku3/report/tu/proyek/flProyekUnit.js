window.app_saku3_report_tu_proyek_flProyekUnit = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_proyek_flProyekUnit.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_proyek_flProyekUnit";
		this.maximize();
...
window.app_saku3_report_tu_proyek_flProyekUnit.extend(window.childForm);
window.app_saku3_report_tu_proyek_flProyekUnit.implement({
			...
			if (row == 2)
			{
				...
				else
				{
					var sql="select a.kode_pp,a.nama "+
						...
						"			group by kode_pp,kode_lokasi "+
                        "			)b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
                        "inner join karyawan_pp c on a.kode_pp=c.kode_pp and c.nik='"+this.app._userLog+"' "+
						"where a.kode_lokasi='"+this.app._lokasi+"' ";
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tu_proyek_rptProyekUnit";
			...
			systemAPI.alert("[app_saku3_report_tu_proyek_flProyekUnit]::mainButtonClick:"+e);
		}
	},
