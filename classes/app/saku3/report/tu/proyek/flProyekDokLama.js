window.app_saku3_report_tu_proyek_flProyekDokLama = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_proyek_flProyekDokLama.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_proyek_flProyekDokLama";
		this.maximize();
...
window.app_saku3_report_tu_proyek_flProyekDokLama.extend(window.childForm);
window.app_saku3_report_tu_proyek_flProyekDokLama.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tu_proyek_rptProyekDokLama";
			...
			systemAPI.alert("[app_saku3_report_tu_proyek_flProyekDokLama]::mainButtonClick:"+e);
		}
	},
	...
	doOpenDok: function(no_bukti,kode_lokasi){
		...
		nama_report="server_report_saku3_tu_proyek_rptProyekDokDetailLama";
