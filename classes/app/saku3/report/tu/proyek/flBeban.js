window.app_saku3_report_tu_proyek_flBeban = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_proyek_flBeban.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_proyek_flBeban";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from tu_prbeban_m where modul='INIBDD'  ");
...
window.app_saku3_report_tu_proyek_flBeban.extend(window.childForm);
window.app_saku3_report_tu_proyek_flBeban.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_tu_proyek_flBeban]::mainButtonClick:"+e);
		}
	},
