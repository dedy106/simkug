window.app_saku3_report_tu_proyek_flInisialbaru = function (owner) {
	if (owner) {
		window.app_saku3_report_tu_proyek_flInisialbaru.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku3_report_tu_proyek_flInisialbaru";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1, 1, new Array(0, 1, 2), new Array("ID Kegiatan", "All", ""));
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
	this.doSelectCell(this.sg1, 2, 3);
};
window.app_saku3_report_tu_proyek_flInisialbaru.extend(window.childForm);
window.app_saku3_report_tu_proyek_flInisialbaru.implement({
	doEllipseClick: function (sender, col, row) {
		try {
			...
			if (row == 1) {
				...
				this.filterRep.ListDataSGFilter(this, "ID Kegiatan", this.sg1, this.sg1.row, this.sg1.col,
					"select a.kode_proyek, a.nama from prb_proyek a " + this.filter,
					"select count(*) from prb_proyek a " + this.filter,
					new Array("a.kode_proyek", "a.nama"), "and", new Array("Kode", "Keterangan"));
			}
	...
	mainButtonClick: function (sender) {
		try {
			...
			systemAPI.alert("[app_saku3_report_tu_proyek_flInisialbaru]::mainButtonClick:" + e);
		}
	},
