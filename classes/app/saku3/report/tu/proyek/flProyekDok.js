window.app_saku3_report_tu_proyek_flProyekDok = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_proyek_flProyekDok.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_proyek_flProyekDok";
		this.maximize();
...
window.app_saku3_report_tu_proyek_flProyekDok.extend(window.childForm);
window.app_saku3_report_tu_proyek_flProyekDok.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tu_proyek_rptProyekDok";
			...
			systemAPI.alert("[app_saku3_report_tu_proyek_flProyekDok]::mainButtonClick:"+e);
		}
	},
	...
	doOpenDok: function(no_bukti,kode_lokasi){
		this.link="2";
		filter = "where a.no_ref='"+no_bukti+"' and a.kode_lokasi='"+kode_lokasi+"' ";
		filter2=this.app._namaUser;
		nama_report="server_report_saku3_tu_proyek_rptProyekDokDetail";
