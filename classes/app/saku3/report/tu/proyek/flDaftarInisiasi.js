window.app_saku3_report_tu_proyek_flDaftarInisiasi = function (owner) {
    if (owner) {
        window.app_saku3_report_tu_proyek_flDaftarInisiasi.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_report_tu_proyek_flDaftarInisiasi";
        this.maximize();
    ...
    this.periode = this.dbLib.getPeriodeFromSQL("select max(periode) as periode from trans_m where form='PPHREKON' ");
...
window.app_saku3_report_tu_proyek_flDaftarInisiasi.extend(window.childForm);
window.app_saku3_report_tu_proyek_flDaftarInisiasi.implement({
        ...
        try {
            ...
            if (row == 1) {
                ...
                if (this.app._userStatus == "A") {
                    this.filterRep.ListDataSGFilter(this, "Data PP", this.sg1, this.sg1.row, this.sg1.col,
                        "select a.kode_pp,nama from pp a inner join karyawan_pp b on a.kode_pp=b.kode_pp " +
                        this.filterRep.filterStr("a.kode_lokasi", this.sg1.getCell(1, 0), this.sg1.getCell(2, 0), this.sg1.getCell(3, 0), " where ") +
                        " and a.flag_aktif='1' and b.nik ='" + this.app._userLog + "'",
                        "select count(a.kode_pp) from pp a inner join karyawan_pp b on a.kode_pp=b.kode_pp " +
                        this.filterRep.filterStr("a.kode_lokasi", this.sg1.getCell(1, 0), this.sg1.getCell(2, 0), this.sg1.getCell(3, 0), " where ") +
                        " and a.flag_aktif='1' and b.nik ='" + this.app._userLog + "'",
            ...
            if (row == 2) {
                filter = this.filterRep.filterStr("a.kode_lokasi", this.sg1.getCell(1, 0), this.sg1.getCell(2, 0), this.sg1.getCell(3, 0), "where") +
                    ...
                    " and a.modul='INISIASI'";
                this.filterRep.ListDataSGFilter(this, "Data Daftar Inisiasi", this.sg1, this.sg1.row, this.sg1.col,
    ...
    doSelectCell: function (sender, col, row) {
        ...
        /*if (row == 1) {
            ...
            this.dbLib.setItemsFromSQL("select distinct periode from trans_m where form='PPHREKON' and kode_lokasi='" + this.app._lokasi + "' order by periode desc", [this.sg1.columns.get(2).pickList, this.sg1.columns.get(3).pickList]);
        }*/
        ...
        try {
            if (sender === this.app._mainForm.bClear2) {
                ...
                this.filter = this.filterRep.filterStr("a.kode_lokasi", this.sg1.getCell(1, 0), this.sg1.getCell(2, 0), this.sg1.getCell(3, 0), "where") +
                    this.filterRep.filterStr("a.kode_pp", this.sg1.getCell(1, 1), this.sg1.getCell(2, 1), this.sg1.getCell(3, 1), "and") +
                    this.filterRep.filterStr("a.kode_proyek", this.sg1.getCell(1, 2), this.sg1.getCell(2, 2), this.sg1.getCell(3, 2), "and") +
                    "and a.modul = 'INISIASI'";
                this.filter2 = this.sg1.getCell(2, 0);
                this.showFilter = this.filterRep.showFilter(this.sg1);
                var result = new arrayMap();
                this.nama_report = "server_report_saku3_tu_proyek_rptDaftarInisiasi";
            ...
            systemAPI.alert("[app_saku3_report_tu_proyek_flDaftarInisiasi]::mainButtonClick:" + e);
        }
    },
    ...
    doOpenKartu: function (kode_proyek, kode_pp, kode_lokasi) {
        this.kode_proyek = kode_proyek;
        this.kode_pp = kode_pp;
        this.kode_lokasi = kode_lokasi;
        filter = "where a.kode_proyek='" + kode_proyek + "' and a.kode_pp='" + kode_pp + "' and a.kode_lokasi='" + kode_lokasi + "'";
        filter2 = "";
        nama_report = "server_report_saku3_tu_proyek_rptKartuInisiasi";
