window.app_saku3_report_tu_proyek_flPanjarPtg = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_proyek_flPanjarPtg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_proyek_flPanjarPtg";
		this.maximize();
...
window.app_saku3_report_tu_proyek_flPanjarPtg.extend(window.childForm);
window.app_saku3_report_tu_proyek_flPanjarPtg.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tu_proyek_rptPanjarPtg";
			...
			systemAPI.alert("[app_saku3_report_tu_proyek_flPanjarPtg]::mainButtonClick:"+e);
		}
	},
