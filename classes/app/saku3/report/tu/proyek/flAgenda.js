window.app_saku3_report_tu_proyek_flAgenda = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_proyek_flAgenda.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_proyek_flAgenda";
		this.maximize();
...
window.app_saku3_report_tu_proyek_flAgenda.extend(window.childForm);
window.app_saku3_report_tu_proyek_flAgenda.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_tu_proyek_flAgenda]::mainButtonClick:"+e);
		}
	},
