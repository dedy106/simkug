window.app_saku3_report_tu_proyek_flPanjar = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_proyek_flPanjar.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_proyek_flPanjar";
		this.maximize();
...
window.app_saku3_report_tu_proyek_flPanjar.extend(window.childForm);
window.app_saku3_report_tu_proyek_flPanjar.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_tu_proyek_flPanjar]::mainButtonClick:"+e);
		}
	},
