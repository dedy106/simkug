window.app_saku3_report_tu_proyek_flDok = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_proyek_flDok.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_proyek_flDok";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Dokumen","All",""));
...
window.app_saku3_report_tu_proyek_flDok.extend(window.childForm);
window.app_saku3_report_tu_proyek_flDok.implement({
		...
		try{			
			...
			if (row ==	1)
			{
				this.filterRep.ListDataSGFilter(this, "Data Mitra",this.sg1, this.sg1.row, this.sg1.col,
														  "select kode_jenis, nama from prb_dok_jenis "+
														   this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  "select count(kode_jenis) from prb_dok_jenis "+
														  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tu_proyek_rptDok";
			...
			systemAPI.alert("[app_saku3_report_tu_proyek_flDok]::mainButtonClick:"+e);
		}
	},
