window.app_saku3_report_tu_proyek_flRabPos = function (owner) {
	if (owner) {
		window.app_saku3_report_tu_proyek_flRabPos.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku3_report_tu_proyek_flRabPos";
		this.maximize();
...
window.app_saku3_report_tu_proyek_flRabPos.extend(window.childForm);
window.app_saku3_report_tu_proyek_flRabPos.implement({
	...
	mainButtonClick: function (sender) {
		try {
			if (sender === this.app._mainForm.bClear2) {
				...
				this.nama_report = "server_report_saku3_tu_proyek_rptRabPos";
			...
			systemAPI.alert("[app_saku3_report_tu_proyek_flRabPos]::mainButtonClick:" + e);
		}
	},
