window.app_saku3_report_tu_proyek_flAkruSelesaiBmhdJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_proyek_flAkruSelesaiBmhdJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_proyek_flAkruSelesaiBmhdJurnal";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from trans_m where modul='REVBMHD' ");
...
window.app_saku3_report_tu_proyek_flAkruSelesaiBmhdJurnal.extend(window.childForm);
window.app_saku3_report_tu_proyek_flAkruSelesaiBmhdJurnal.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from trans_m where modul='REVBMHD' and kode_lokasi='"+this.app._lokasi+"' order by periode desc",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_tu_proyek_flAkruSelesaiBmhdJurnal]::mainButtonClick:"+e);
		}
	},
