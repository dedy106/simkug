window.app_saku3_report_tu_proyek_flProyekSisih = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_proyek_flProyekSisih.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_proyek_flProyekSisih";
		this.maximize();
...
window.app_saku3_report_tu_proyek_flProyekSisih.extend(window.childForm);
window.app_saku3_report_tu_proyek_flProyekSisih.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tu_proyek_rptProyekSisih";
			...
			systemAPI.alert("[app_saku3_report_tu_proyek_flProyekSisih]::mainButtonClick:"+e);
		}
	},
