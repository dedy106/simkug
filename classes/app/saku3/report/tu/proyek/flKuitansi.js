window.app_saku3_report_tu_proyek_flKuitansi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_proyek_flKuitansi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_proyek_flKuitansi";
		this.maximize();
...
window.app_saku3_report_tu_proyek_flKuitansi.extend(window.childForm);
window.app_saku3_report_tu_proyek_flKuitansi.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from prb_prbill_m where kode_lokasi='"+this.app._lokasi+"' order by periode",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.app._kode_PP;
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_tu_proyek_rptKuitansi";
			...
			systemAPI.alert("[app_saku3_report_tu_proyek_flKuitansi]::mainButtonClick:"+e);
		}
	},
