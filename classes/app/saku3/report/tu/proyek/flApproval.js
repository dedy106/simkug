window.app_saku3_report_tu_proyek_flApproval = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_proyek_flApproval.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_proyek_flApproval";
		this.maximize();
...
window.app_saku3_report_tu_proyek_flApproval.extend(window.childForm);
window.app_saku3_report_tu_proyek_flApproval.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tu_proyek_rptApproval";
			...
			systemAPI.alert("[app_saku3_report_tu_proyek_flApproval]::mainButtonClick:"+e);
		}
	},
