window.app_saku3_report_tu_proyek_flJurnalJointCost = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_proyek_flJurnalJointCost.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_proyek_flJurnalJointCost";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from tu_prbeban_m where modul='JCOSTINI'  ");
...
window.app_saku3_report_tu_proyek_flJurnalJointCost.extend(window.childForm);
window.app_saku3_report_tu_proyek_flJurnalJointCost.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_tu_proyek_flJurnalJointCost]::mainButtonClick:"+e);
		}
	},
