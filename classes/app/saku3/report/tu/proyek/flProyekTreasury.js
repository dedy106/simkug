window.app_saku3_report_tu_proyek_flProyekTreasury = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_proyek_flProyekTreasury.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_proyek_flProyekTreasury";
		this.maximize();
...
window.app_saku3_report_tu_proyek_flProyekTreasury.extend(window.childForm);
window.app_saku3_report_tu_proyek_flProyekTreasury.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tu_proyek_rptProyekTreasury";
			...
			systemAPI.alert("[app_saku3_report_tu_proyek_flProyekTreasury]::mainButtonClick:"+e);
		}
	},
