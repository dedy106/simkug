window.app_saku3_report_tu_proyek_flKartuNTFNonBmhd = function (owner) {
    if (owner) {
        window.app_saku3_report_tu_proyek_flKartuNTFNonBmhd.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_report_tu_proyek_flKartuNTFNonBmhd";
        this.maximize();
    ...
    this.gridLib.SGEditData(this.sg1, 2, new Array(0, 1, 2), new Array("Kode NTF", "All", ""));
...
window.app_saku3_report_tu_proyek_flKartuNTFNonBmhd.extend(window.childForm);
window.app_saku3_report_tu_proyek_flKartuNTFNonBmhd.implement({
        ...
        try {
            ...
            if (row == 2) {
                filter = this.filterRep.filterStr("a.kode_lokasi", this.sg1.getCell(1, 0), this.sg1.getCell(2, 0), this.sg1.getCell(3, 0), "where") +
                    ...
                    " and a.modul='PROYEK'";
                this.filterRep.ListDataSGFilter(this, "Data Daftar NTF", this.sg1, this.sg1.row, this.sg1.col,
    ...
    mainButtonClick: function (sender) {
        try {
            if (sender === this.app._mainForm.bClear2) {
                ...
                this.nama_report = "server_report_saku3_tu_proyek_rptKartuNTFNonBmhd";
            ...
            systemAPI.alert("[app_saku3_report_tu_proyek_flKartuNTFNonBmhd]::mainButtonClick:" + e);
        }
    },
