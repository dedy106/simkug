window.app_saku3_report_tu_proyek_flAjuHonor = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_proyek_flAjuHonor.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_proyek_flAjuHonor";
		this.maximize();
...
window.app_saku3_report_tu_proyek_flAjuHonor.extend(window.childForm);
window.app_saku3_report_tu_proyek_flAjuHonor.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tu_proyek_rptAjuHonor";
			...
			systemAPI.alert("[app_saku3_report_tu_proyek_flAjuHonor]::mainButtonClick:"+e);
		}
	},
