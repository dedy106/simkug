window.app_saku3_report_tu_proyek_flJenis = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_proyek_flJenis.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_proyek_flJenis";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Jenis Proyek","All",""));
...
window.app_saku3_report_tu_proyek_flJenis.extend(window.childForm);
window.app_saku3_report_tu_proyek_flJenis.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tu_proyek_rptJenis";
			...
			systemAPI.alert("[app_saku3_report_tu_proyek_flJenis]::mainButtonClick:"+e);
		}
	},
