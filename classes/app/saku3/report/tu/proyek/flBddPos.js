window.app_saku3_report_tu_proyek_flBddPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_proyek_flBddPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_proyek_flBddPos";
		this.maximize();
...
window.app_saku3_report_tu_proyek_flBddPos.extend(window.childForm);
window.app_saku3_report_tu_proyek_flBddPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tu_proyek_rptBddPos";
			...
			systemAPI.alert("[app_saku3_report_tu_proyek_flBddPos]::mainButtonClick:"+e);
		}
	},
