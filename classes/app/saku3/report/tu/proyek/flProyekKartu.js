window.app_saku3_report_tu_proyek_flProyekKartu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_proyek_flProyekKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_proyek_flProyekKartu";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(dbo.fnPeriode(tgl_app)) as periode from prb_proyek where kode_lokasi='"+this.app._lokasi+"'  ");
...
window.app_saku3_report_tu_proyek_flProyekKartu.extend(window.childForm);
window.app_saku3_report_tu_proyek_flProyekKartu.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct dbo.fnPeriode(tgl_app) as periode from prb_proyek where kode_lokasi='"+this.app._lokasi+"'  order by dbo.fnPeriode(tgl_app)",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
		if (row == 5)
		{
			this.sg1.columns.get(2).pickList.clear();
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tu_proyek_rptProyekKartu";
				if (this.sg1.getCell(2,5)=="Piutang")
				{
					this.nama_report = "server_report_saku3_tu_proyek_rptProyekKartuPiutang";
				}
				if (this.sg1.getCell(2,5)=="BDD")
				{
					this.nama_report = "server_report_saku3_tu_proyek_rptProyekKartuBdd";
				}
				if (this.sg1.getCell(2,5)=="BYMHD")
				{
					this.nama_report = "server_report_saku3_tu_proyek_rptProyekKartuBymhd";
				}
				if (this.sg1.getCell(2,5)=="Beban")
				{
					this.nama_report = "server_report_saku3_tu_proyek_rptProyekKartuBeban";
				}
				if (this.sg1.getCell(2,5)=="Pendapatan")
				{
					this.nama_report = "server_report_saku3_tu_proyek_rptProyekKartuPdpt";
				}
				if (this.sg1.getCell(2,5)=="Pelunasan")
				{
					this.nama_report = "server_report_saku3_tu_proyek_rptProyekKartuKas";
				}
			...
			systemAPI.alert("[app_saku3_report_tu_proyek_flProyekKartu]::mainButtonClick:"+e);
		}
	},
	...
	doOpenPiutang: function(no_bukti,kode_lokasi){
		...
		filter2="";
		nama_report="server_report_saku3_tu_proyek_rptProyekKartuPiutang";
	...
	doOpenBdd: function(no_bukti,kode_lokasi){
		...
		filter = "where a.kode_proyek='"+no_bukti+"' and a.kode_lokasi='"+kode_lokasi+"' ";
		filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1);
		nama_report="server_report_saku3_tu_proyek_rptProyekKartuBdd";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
	...
	doOpenBymhd: function(no_bukti,kode_lokasi){
		...
		filter = "where a.kode_proyek='"+no_bukti+"' and a.kode_lokasi='"+kode_lokasi+"' ";
		filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1);
		nama_report="server_report_saku3_tu_proyek_rptProyekKartuBymhd";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
	...
	doOpenBeban: function(no_bukti,kode_lokasi){
		...
		filter = "where a.kode_proyek='"+no_bukti+"' and a.kode_lokasi='"+kode_lokasi+"' ";
		filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1);
		nama_report="server_report_saku3_tu_proyek_rptProyekKartuBeban";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
	...
	doOpenPdpt: function(no_bukti,kode_lokasi){
		...
		filter = "where a.kode_proyek='"+no_bukti+"' and a.kode_lokasi='"+kode_lokasi+"' ";
		filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1);
		nama_report="server_report_saku3_tu_proyek_rptProyekKartuPdpt";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
	...
	doOpenKas: function(no_bukti,kode_lokasi){
		...
		filter = "where a.kode_proyek='"+no_bukti+"' and a.kode_lokasi='"+kode_lokasi+"' ";
		filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1);
		nama_report="server_report_saku3_tu_proyek_rptProyekKartuKas";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
