window.app_saku3_report_tu_proyek_flPiutangJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_proyek_flPiutangJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_proyek_flPiutangJurnal";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from trans_m where form='PRPIUGAB'  ");
...
window.app_saku3_report_tu_proyek_flPiutangJurnal.extend(window.childForm);
window.app_saku3_report_tu_proyek_flPiutangJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_tu_proyek_flPiutangJurnal]::mainButtonClick:"+e);
		}
	},
