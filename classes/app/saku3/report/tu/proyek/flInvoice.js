window.app_saku3_report_tu_proyek_flInvoice = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_proyek_flInvoice.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_proyek_flInvoice";
		this.maximize();
...
window.app_saku3_report_tu_proyek_flInvoice.extend(window.childForm);
window.app_saku3_report_tu_proyek_flInvoice.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tu_proyek_rptInvoice";
			...
			systemAPI.alert("[app_saku3_report_tu_proyek_flInvoice]::mainButtonClick:"+e);
		}
	},
