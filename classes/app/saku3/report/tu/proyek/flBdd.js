window.app_saku3_report_tu_proyek_flBdd = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_proyek_flBdd.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_proyek_flBdd";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from it_aju_m where kode_lokasi='"+this.app._lokasi+"' and form='INISIAL' ");
...
window.app_saku3_report_tu_proyek_flBdd.extend(window.childForm);
window.app_saku3_report_tu_proyek_flBdd.implement({
		...
		try{			
			...
			if (row ==5)
			{
				filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							" and a.modul='UMUM' and a.form='INISIAL' ";
				var sql="select a.no_aju,a.keterangan "+
						"from it_aju_m a "+
						"inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
						"inner join tu_prbdd_d c on a.no_aju=c.no_bukti and a.kode_lokasi=c.kode_lokasi "+
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from it_aju_m where kode_lokasi='"+this.app._lokasi+"' and modul='UMUM' and form='INISIAL' order by periode",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("i.kode_cust",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
							this.filterRep.filterStr("i.kode_jenis",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and")+
							this.filterRep.filterStr("i.kode_proyek",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4),"and")+
			...
			systemAPI.alert("[app_saku3_report_tu_proyek_flBdd]::mainButtonClick:"+e);
		}
	},
