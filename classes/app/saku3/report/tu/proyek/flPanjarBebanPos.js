window.app_saku3_report_tu_proyek_flPanjarBebanPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_proyek_flPanjarBebanPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_proyek_flPanjarBebanPos";
		this.maximize();
...
window.app_saku3_report_tu_proyek_flPanjarBebanPos.extend(window.childForm);
window.app_saku3_report_tu_proyek_flPanjarBebanPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tu_proyek_rptPanjarBebanPos";
			...
			systemAPI.alert("[app_saku3_report_tu_proyek_flPanjarBebanPos]::mainButtonClick:"+e);
		}
	},
