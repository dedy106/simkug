window.app_saku3_report_tu_proyek_flKartuNTF = function (owner) {
    if (owner) {
        window.app_saku3_report_tu_proyek_flKartuNTF.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_report_tu_proyek_flKartuNTF";
        this.maximize();
...
window.app_saku3_report_tu_proyek_flKartuNTF.extend(window.childForm);
window.app_saku3_report_tu_proyek_flKartuNTF.implement({
    ...
    mainButtonClick: function (sender) {
        try {
            if (sender === this.app._mainForm.bClear2) {
                ...
                this.nama_report = "server_report_saku3_tu_proyek_rptKartuNTF";
            ...
            systemAPI.alert("[app_saku3_report_tu_proyek_flKartuNTF]::mainButtonClick:" + e);
        }
    },
