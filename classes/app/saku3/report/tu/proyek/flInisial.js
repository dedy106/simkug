window.app_saku3_report_tu_proyek_flInisial = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_proyek_flInisial.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_proyek_flInisial";
		this.maximize();
...
window.app_saku3_report_tu_proyek_flInisial.extend(window.childForm);
window.app_saku3_report_tu_proyek_flInisial.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_tu_proyek_flInisial]::mainButtonClick:"+e);
		}
	},
