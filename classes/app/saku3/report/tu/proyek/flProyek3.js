window.app_saku3_report_tu_proyek_flProyek3 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_proyek_flProyek3.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_proyek_flProyek3";
		this.maximize();
...
window.app_saku3_report_tu_proyek_flProyek3.extend(window.childForm);
window.app_saku3_report_tu_proyek_flProyek3.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tu_proyek_rptProyek3";
			...
			systemAPI.alert("[app_saku3_report_tu_proyek_flProyek3]::mainButtonClick:"+e);
		}
	},
