window.app_saku3_report_tu_proyek_flKartuInisiasi = function (owner) {
    if (owner) {
        window.app_saku3_report_tu_proyek_flKartuInisiasi.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_report_tu_proyek_flKartuInisiasi";
        this.maximize();
...
window.app_saku3_report_tu_proyek_flKartuInisiasi.extend(window.childForm);
window.app_saku3_report_tu_proyek_flKartuInisiasi.implement({
    ...
    mainButtonClick: function (sender) {
        try {
            if (sender === this.app._mainForm.bClear2) {
                ...
                this.nama_report = "server_report_saku3_tu_proyek_rptKartuInisiasi";
            ...
            systemAPI.alert("[app_saku3_report_tu_proyek_flKartuInisiasi]::mainButtonClick:" + e);
        }
    },
