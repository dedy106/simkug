window.app_saku3_report_tu_proyek_flJurnalBddBeban = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_proyek_flJurnalBddBeban.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_proyek_flJurnalBddBeban";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from trans_m where form='FINALBDD'  ");
...
window.app_saku3_report_tu_proyek_flJurnalBddBeban.extend(window.childForm);
window.app_saku3_report_tu_proyek_flJurnalBddBeban.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tu_proyek_rptJurnalBddBeban";
			...
			systemAPI.alert("[app_saku3_report_tu_proyek_flJurnalBddBeban]::mainButtonClick:"+e);
		}
	},
