window.app_saku3_report_tu_proyek_flProyek = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_proyek_flProyek.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_proyek_flProyek";
		this.maximize();
...
window.app_saku3_report_tu_proyek_flProyek.extend(window.childForm);
window.app_saku3_report_tu_proyek_flProyek.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tu_proyek_rptProyek";
			...
			systemAPI.alert("[app_saku3_report_tu_proyek_flProyek]::mainButtonClick:"+e);
		}
	},
