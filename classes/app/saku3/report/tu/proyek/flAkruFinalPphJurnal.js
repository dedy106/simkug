window.app_saku3_report_tu_proyek_flAkruFinalPphJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_proyek_flAkruFinalPphJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_proyek_flAkruFinalPphJurnal";
		this.maximize();
...
window.app_saku3_report_tu_proyek_flAkruFinalPphJurnal.extend(window.childForm);
window.app_saku3_report_tu_proyek_flAkruFinalPphJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_tu_proyek_flAkruFinalPphJurnal]::mainButtonClick:"+e);
		}
	},
