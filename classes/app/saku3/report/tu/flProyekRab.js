window.app_saku3_report_tu_flProyekRab = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_flProyekRab.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_flProyekRab";
		this.maximize();
...
window.app_saku3_report_tu_flProyekRab.extend(window.childForm);
window.app_saku3_report_tu_flProyekRab.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from tu_rab_m where kode_lokasi='"+this.app._lokasi+"' ",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_tu_flProyekRab]::mainButtonClick:"+e);
		}
	},
