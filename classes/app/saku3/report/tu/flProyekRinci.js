window.app_saku3_report_tu_flProyekRinci = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_flProyekRinci.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_flProyekRinci";
		this.maximize();
...
window.app_saku3_report_tu_flProyekRinci.extend(window.childForm);
window.app_saku3_report_tu_flProyekRinci.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tu_rptProyekRinci";
			...
			systemAPI.alert("[app_saku3_report_tu_flProyekRinci]::mainButtonClick:"+e);
		}
	},
