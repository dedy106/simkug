window.app_saku3_report_tu_kegiatan_flTakKirim = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_kegiatan_flTakKirim.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_kegiatan_flTakKirim";
		this.maximize();
...
window.app_saku3_report_tu_kegiatan_flTakKirim.extend(window.childForm);
window.app_saku3_report_tu_kegiatan_flTakKirim.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_tu_kegiatan_flTakKirim]::mainButtonClick:"+e);
		}
	},
