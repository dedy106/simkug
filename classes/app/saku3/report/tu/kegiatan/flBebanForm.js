window.app_saku3_report_tu_kegiatan_flBebanForm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_kegiatan_flBebanForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_kegiatan_flBebanForm";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from it_aju_m where kode_lokasi='"+this.app._lokasi+"' and form='KEGBDD'");
...
window.app_saku3_report_tu_kegiatan_flBebanForm.extend(window.childForm);
window.app_saku3_report_tu_kegiatan_flBebanForm.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from it_aju_m where kode_lokasi='"+this.app._lokasi+"' and form='KEGBDD' order by periode",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tu_kegiatan_rptBebanForm";
			...
			systemAPI.alert("[app_saku3_report_tu_kegiatan_flBebanForm]::mainButtonClick:"+e);
		}
	},
