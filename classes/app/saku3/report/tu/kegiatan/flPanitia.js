window.app_saku3_report_tu_kegiatan_flPanitia = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_kegiatan_flPanitia.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_kegiatan_flPanitia";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Panitia","All",""));
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("PIC","All",""));
...
window.app_saku3_report_tu_kegiatan_flPanitia.extend(window.childForm);
window.app_saku3_report_tu_kegiatan_flPanitia.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row ==	1)
			{
				this.filterRep.ListDataSGFilter(this, "Data Panitia",this.sg1, this.sg1.row, this.sg1.col,
														  "select kode_panitia, nama from keg_panitia_m "+
														   this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  "select count(kode_panitia) from keg_panitia_m "+
														  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  new Array("kode_panitia","nama"),"and");
			}
			if (row ==	2)
			{
				this.filterRep.ListDataSGFilter(this, "Data PIC",this.sg1, this.sg1.row, this.sg1.col,
														  "select a.pic, b.nama from keg_panitia_m a inner join karyawan b on a.pic=b.nik and a.kode_lokasi=b.kode_lokasi "+
														   this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  "select count(a.pic) from keg_panitia_m a inner join karyawan b on a.pic=b.nik and a.kode_lokasi=b.kode_lokasi "+
														  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  new Array("pic","nama"),"and");
			}
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.kode_panitia",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("a.pic",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
				this.filter2 = this.sg1.getCell(2,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_tu_kegiatan_rptPanitia";
			...
			systemAPI.alert("[app_saku3_report_tu_kegiatan_flPanitia]::mainButtonClick:"+e);
		}
	},
