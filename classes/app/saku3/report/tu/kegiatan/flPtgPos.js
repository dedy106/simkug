window.app_saku3_report_tu_kegiatan_flPtgPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_kegiatan_flPtgPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_kegiatan_flPtgPos";
		this.maximize();
...
window.app_saku3_report_tu_kegiatan_flPtgPos.extend(window.childForm);
window.app_saku3_report_tu_kegiatan_flPtgPos.implement({
		...
		try{			
			...
			if (row ==3)
			{
				this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							" and a.modul='PJPTG' and a.form='KEGBDD' ";
		...
		try
		{
			...
			else
			{
		    	...
		    	this.filter =  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							" and a.modul='PJPTG' and a.form in ('KEGBDD','PTGMULTIBD') ";
				this.filter2 = this.sg1.getCell(2,1)+"/";
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_tu_kegiatan_rptPtgPos";
			...
			systemAPI.alert("[app_saku3_report_tu_kegiatan_flPtgPos]::mainButtonClick:"+e);
		}
	},
	...
	doOpenKas: function(no_bukti,kode_lokasi){
		...
		filter2="";
		nama_report="server_report_saku3_tu_kegiatan_rptJurnalPanjar";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
