window.app_saku3_report_tu_kegiatan_flTakPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_kegiatan_flTakPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_kegiatan_flTakPos";
		this.maximize();
...
window.app_saku3_report_tu_kegiatan_flTakPos.extend(window.childForm);
window.app_saku3_report_tu_kegiatan_flTakPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tu_kegiatan_rptTakPos";
			...
			systemAPI.alert("[app_saku3_report_tu_kegiatan_flTakPos]::mainButtonClick:"+e);
		}
	},
