window.app_saku3_report_tu_kegiatan_flPtgPanjar = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_kegiatan_flPtgPanjar.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_kegiatan_flPtgPanjar";
		this.maximize();
...
window.app_saku3_report_tu_kegiatan_flPtgPanjar.extend(window.childForm);
window.app_saku3_report_tu_kegiatan_flPtgPanjar.implement({
		...
		try{			
			...
			if (row ==3)
			{
				this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							" and a.modul='PJPTG' and a.form='PTGMULTIBD' ";
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tu_kegiatan_rptPtgPanjar";
			...
			systemAPI.alert("[app_saku3_report_tu_kegiatan_flPtgPanjar]::mainButtonClick:"+e);
		}
	},
