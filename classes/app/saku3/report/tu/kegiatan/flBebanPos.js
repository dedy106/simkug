window.app_saku3_report_tu_kegiatan_flBebanPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_kegiatan_flBebanPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_kegiatan_flBebanPos";
		this.maximize();
...
window.app_saku3_report_tu_kegiatan_flBebanPos.extend(window.childForm);
window.app_saku3_report_tu_kegiatan_flBebanPos.implement({
		...
		try{			
			...
			if (row ==3)
			{
				this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							" and a.modul='UMUM' and a.form='KEGBDD'";
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tu_kegiatan_rptBebanPos";
			...
			systemAPI.alert("[app_saku3_report_tu_kegiatan_flBebanPos]::mainButtonClick:"+e);
		}
	},
	...
	doOpenKas: function(no_bukti,kode_lokasi){
		...
		filter2="";
		nama_report="server_report_saku3_tu_kegiatan_rptJurnalBeban";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
