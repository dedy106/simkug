window.app_saku3_report_tu_kegiatan_flJurnalPanjar = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_kegiatan_flJurnalPanjar.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_kegiatan_flJurnalPanjar";
		this.maximize();
...
window.app_saku3_report_tu_kegiatan_flJurnalPanjar.extend(window.childForm);
window.app_saku3_report_tu_kegiatan_flJurnalPanjar.implement({
		...
		try{			
			...
			if (row == 2)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Jurnal",this.sg1, this.sg1.row, this.sg1.col,
														  "select a.no_kas, a.keterangan from it_aju_m a inner join kas_m b on a.no_kas=b.no_kas "+filter ,
														  "select count(a.no_kas) from it_aju_m a "+filter,
															new Array("a.no_kas","a.keterangan"),"where",new Array("kode","nama"));
			}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_saku3_tu_kegiatan_rptJurnalPanjar";
