window.app_saku3_report_tu_kegiatan_flPanjarPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_kegiatan_flPanjarPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_kegiatan_flPanjarPos";
		this.maximize();
...
window.app_saku3_report_tu_kegiatan_flPanjarPos.extend(window.childForm);
window.app_saku3_report_tu_kegiatan_flPanjarPos.implement({
		...
		try{			
			...
			if (row ==3)
			{
				this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							" and a.modul='PANJAR' and a.form in ('KEGBDD','PMULTIBDD') ";
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tu_kegiatan_rptPanjarPos";
			...
			systemAPI.alert("[app_saku3_report_tu_kegiatan_flPanjarPos]::mainButtonClick:"+e);
		}
	},
