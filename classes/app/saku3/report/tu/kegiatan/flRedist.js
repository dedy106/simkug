window.app_saku3_report_tu_kegiatan_flRedist = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_kegiatan_flRedist.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_kegiatan_flRedist";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("No Redistribusi","All",""));
...
window.app_saku3_report_tu_kegiatan_flRedist.extend(window.childForm);
window.app_saku3_report_tu_kegiatan_flRedist.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row ==	1)
			{
				this.filterRep.ListDataSGFilter(this, "Data Redistribusi",this.sg1, this.sg1.row, this.sg1.col,
														  "select no_rra, keterangan from keg_rra_m "+
														   this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  "select count(no_rra) from keg_rra_m "+
														  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  new Array("no_rra","keterangan"),"and");
			}
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.no_rra",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");
				this.filter2 = this.sg1.getCell(2,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_tu_kegiatan_rptRedist";
			...
			systemAPI.alert("[app_saku3_report_tu_kegiatan_flRedist]::mainButtonClick:"+e);
		}
	},
