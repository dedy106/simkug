window.app_saku3_report_tu_kegiatan_flPanjar = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_kegiatan_flPanjar.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_kegiatan_flPanjar";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from it_aju_m where kode_lokasi='"+this.app._lokasi+"' and modul='PANJAR'");
...
window.app_saku3_report_tu_kegiatan_flPanjar.extend(window.childForm);
window.app_saku3_report_tu_kegiatan_flPanjar.implement({
		...
		try{			
			...
			if (row ==3)
			{
				this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							" and a.modul='PANJAR' and a.form='KEGBDD' ";
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tu_kegiatan_rptPanjar";
			...
			systemAPI.alert("[app_saku3_report_tu_kegiatan_flPanjar]::mainButtonClick:"+e);
		}
	},
