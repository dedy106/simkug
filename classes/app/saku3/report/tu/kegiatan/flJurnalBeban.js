window.app_saku3_report_tu_kegiatan_flJurnalBeban = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_kegiatan_flJurnalBeban.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_kegiatan_flJurnalBeban";
		this.maximize();
...
window.app_saku3_report_tu_kegiatan_flJurnalBeban.extend(window.childForm);
window.app_saku3_report_tu_kegiatan_flJurnalBeban.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_saku3_tu_kegiatan_rptJurnalBeban";
