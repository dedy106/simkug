window.app_saku3_report_tu_kegiatan_flInisial = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_kegiatan_flInisial.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_kegiatan_flInisial";
		this.maximize();
...
window.app_saku3_report_tu_kegiatan_flInisial.extend(window.childForm);
window.app_saku3_report_tu_kegiatan_flInisial.implement({
		...
		try{			
			...
			if (row ==1)
			{
				...
				this.filterRep.ListDataSGFilter(this, "ID Kegiatan",this.sg1, this.sg1.row, this.sg1.col,
												"select a.kode_proyek, a.nama from tu_proyek a "+this.filter,
												"select count(*) from tu_proyek a "+this.filter,
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tu_proyek_rptInisial";
			...
			systemAPI.alert("[app_saku3_report_tu_kegiatan_flInisial]::mainButtonClick:"+e);
		}
	},
