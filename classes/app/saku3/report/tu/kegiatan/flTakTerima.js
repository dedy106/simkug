window.app_saku3_report_tu_kegiatan_flTakTerima = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_kegiatan_flTakTerima.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_kegiatan_flTakTerima";
		this.maximize();
...
window.app_saku3_report_tu_kegiatan_flTakTerima.extend(window.childForm);
window.app_saku3_report_tu_kegiatan_flTakTerima.implement({
		...
		try{			
			...
			if (row ==2)
			{
				this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							" and a.modul='TAKPJPTG' ";							
				this.filterRep.ListDataSGFilter(this, "Data TAK Terima",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_terima, a.keterangan from takterima_m a "+this.filter,
												"select count(*) from takterima_m a "+this.filter,
												new Array("a.no_terima","a.keterangan"),"and",new Array("No Terima","Keterangan"));
			}
	...
	{		
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("TAK Terima"));
		}
	},
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Periode","=",this.periode));
				this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("No Bukti","All",""));
				this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Bentuk Laporan","=","TAK Terima"));
			}else{
				...
				this.lokasi=this.dbLib.getPeriodeFromSQL("select nama as periode from lokasi where kode_lokasi='"+this.sg1.getCell(2,0)+"'");
					...
					this.nama_report = "server_report_saku3_tu_kegiatan_rptTakTerima";
			...
			systemAPI.alert("[app_saku3_report_tu_kegiatan_flTakTerima]::mainButtonClick:"+e);
		}
	},
