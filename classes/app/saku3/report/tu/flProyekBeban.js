window.app_saku3_report_tu_flProyekBeban = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_flProyekBeban.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_flProyekBeban";
		this.maximize();
...
window.app_saku3_report_tu_flProyekBeban.extend(window.childForm);
window.app_saku3_report_tu_flProyekBeban.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_tu_flProyekBeban]::mainButtonClick:"+e);
		}
	},
