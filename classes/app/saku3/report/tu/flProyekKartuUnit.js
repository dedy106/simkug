window.app_saku3_report_tu_flProyekKartuUnit = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_flProyekKartuUnit.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_flProyekKartuUnit";
		this.maximize();
...
window.app_saku3_report_tu_flProyekKartuUnit.extend(window.childForm);
window.app_saku3_report_tu_flProyekKartuUnit.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tu_rptProyekKartuUnit";
			...
			systemAPI.alert("[app_saku3_report_tu_flProyekKartuUnit]::mainButtonClick:"+e);
		}
	},
