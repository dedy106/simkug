window.app_saku3_report_tu_flProyekKartuBdh = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_flProyekKartuBdh.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_flProyekKartuBdh";
		this.maximize();
...
window.app_saku3_report_tu_flProyekKartuBdh.extend(window.childForm);
window.app_saku3_report_tu_flProyekKartuBdh.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tu_rptProyekKartuBdh";
			...
			systemAPI.alert("[app_saku3_report_tu_flProyekKartuBdh]::mainButtonClick:"+e);
		}
	},
