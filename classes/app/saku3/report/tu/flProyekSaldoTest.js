window.app_saku3_report_tu_flProyekSaldoTest = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_flProyekSaldoTest.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_flProyekSaldoTest";
		this.maximize();
...
window.app_saku3_report_tu_flProyekSaldoTest.extend(window.childForm);
window.app_saku3_report_tu_flProyekSaldoTest.implement({
	...
	{		
		...
		else this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6],["123","1235","123","3","123","123","123"]);
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tu_rptProyekSaldoTest";
			...
			systemAPI.alert("[app_saku3_report_tu_flProyekSaldoTest]::mainButtonClick:"+e);
		}
	},
