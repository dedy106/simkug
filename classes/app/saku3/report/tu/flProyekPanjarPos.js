window.app_saku3_report_tu_flProyekPanjarPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_flProyekPanjarPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_flProyekPanjarPos";
		this.maximize();
...
window.app_saku3_report_tu_flProyekPanjarPos.extend(window.childForm);
window.app_saku3_report_tu_flProyekPanjarPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tu_rptProyekPanjarPos";
			...
			systemAPI.alert("[app_saku3_report_tu_flProyekPanjarPos]::mainButtonClick:"+e);
		}
	},
