window.app_saku3_report_tu_flPP = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_flPP.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_flPP";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("PP","All",""));
...
window.app_saku3_report_tu_flPP.extend(window.childForm);
window.app_saku3_report_tu_flPP.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tu_rptPP";
			...
			systemAPI.alert("[app_saku3_report_tu_flPP]::mainButtonClick:"+e);
		}
	},
