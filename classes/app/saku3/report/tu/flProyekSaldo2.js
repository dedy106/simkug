window.app_saku3_report_tu_flProyekSaldo2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_flProyekSaldo2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_flProyekSaldo2";
		this.maximize();
...
window.app_saku3_report_tu_flProyekSaldo2.extend(window.childForm);
window.app_saku3_report_tu_flProyekSaldo2.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tu_rptProyekSaldo2";
			...
			systemAPI.alert("[app_saku3_report_tu_flProyekSaldo2]::mainButtonClick:"+e);
		}
	},
