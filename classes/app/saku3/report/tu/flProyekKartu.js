window.app_saku3_report_tu_flProyekKartu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_flProyekKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_flProyekKartu";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,5,new Array(0,1,2), new Array("Jenis Kartu","=","Rekap"));
...
window.app_saku3_report_tu_flProyekKartu.extend(window.childForm);
window.app_saku3_report_tu_flProyekKartu.implement({
	...
	{		
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("Rekap","Piutang","Pelunasan",'BDD','BYMHD','Pendapatan','Beban'));
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.kode_cust",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
							this.filterRep.filterStr("a.kode_jenis",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and")+
							this.filterRep.filterStr("a.kode_proyek",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4),"and");
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_tu_rptProyekKartu";
				if (this.sg1.getCell(2,5)=="Piutang")
				{
					this.nama_report = "server_report_saku3_tu_rptProyekKartuPiutang";
				}
				if (this.sg1.getCell(2,5)=="BDD")
				{
					this.nama_report = "server_report_saku3_tu_rptProyekKartuBdd";
				}
				if (this.sg1.getCell(2,5)=="BYMHD")
				{
					this.nama_report = "server_report_saku3_tu_rptProyekKartuBymhd";
				}
				if (this.sg1.getCell(2,5)=="Beban")
				{
					this.nama_report = "server_report_saku3_tu_rptProyekKartuBeban";
				}
				if (this.sg1.getCell(2,5)=="Pendapatan")
				{
					this.nama_report = "server_report_saku3_tu_rptProyekKartuPdpt";
				}
				if (this.sg1.getCell(2,5)=="Pelunasan")
				{
					this.nama_report = "server_report_saku3_tu_rptProyekKartuKas";
				}
			...
			systemAPI.alert("[app_saku3_report_tu_flProyekKartu]::mainButtonClick:"+e);
		}
	},
	...
	doOpenPiutang: function(no_bukti,kode_lokasi){
		...
		filter2="";
		nama_report="server_report_saku3_tu_rptProyekKartuPiutang";
	...
	doOpenBdd: function(no_bukti,kode_lokasi){
		...
		filter = "where a.kode_proyek='"+no_bukti+"' and a.kode_lokasi='"+kode_lokasi+"' ";
		filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1);
		nama_report="server_report_saku3_tu_rptProyekKartuBdd";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());

	},
	doOpenBymhd: function(no_bukti,kode_lokasi){
		...
		filter = "where a.kode_proyek='"+no_bukti+"' and a.kode_lokasi='"+kode_lokasi+"' ";
		filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1);
		nama_report="server_report_saku3_tu_rptProyekKartuBymhd";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());

	},
	doOpenBeban: function(no_bukti,kode_lokasi){
		...
		filter = "where a.kode_proyek='"+no_bukti+"' and a.kode_lokasi='"+kode_lokasi+"' ";
		filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1);
		nama_report="server_report_saku3_tu_rptProyekKartuBeban";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());

	},
	doOpenPdpt: function(no_bukti,kode_lokasi){
		...
		filter = "where a.kode_proyek='"+no_bukti+"' and a.kode_lokasi='"+kode_lokasi+"' ";
		filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1);
		nama_report="server_report_saku3_tu_rptProyekKartuPdpt";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
	...
	doOpenKas: function(no_bukti,kode_lokasi){
		...
		filter = "where a.kode_proyek='"+no_bukti+"' and a.kode_lokasi='"+kode_lokasi+"' ";
		filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1);
		nama_report="server_report_saku3_tu_rptProyekKartuKas";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
