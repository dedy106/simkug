window.app_saku3_report_tu_flProyekTagihanJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_flProyekTagihanJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_flProyekTagihanJurnal";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from ju_m where modul='BILLPRO'  ");
...
window.app_saku3_report_tu_flProyekTagihanJurnal.extend(window.childForm);
window.app_saku3_report_tu_flProyekTagihanJurnal.implement({
		...
		try{			
			...
			if (row ==2)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Billing",this.sg1, this.sg1.row, this.sg1.col,
												...
												new Array("a.no_ju","a.keterangan"),"and",new Array("No Bill","Keterangan"));
			}
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from ju_m where modul='BILLPRO' and kode_lokasi='"+this.app._lokasi+"' order by periode desc",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tu_rptProyekTagihanJurnal";
			...
			systemAPI.alert("[app_saku3_report_tu_flProyekTagihanJurnal]::mainButtonClick:"+e);
		}
	},
	...
	doOpenBayar: function(no_ju,kode_lokasi){
	...
	doOpenJurnal: function(no_ju,kode_lokasi){
		this.link="2";
		filter = "where a.no_ju='"+no_ju+"' and a.kode_lokasi='"+kode_lokasi+"' ";
