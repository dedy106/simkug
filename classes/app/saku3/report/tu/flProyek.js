window.app_saku3_report_tu_flProyek = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_flProyek.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_flProyek";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,6,new Array(0,1,2), new Array("Status","All",""));
...
window.app_saku3_report_tu_flProyek.extend(window.childForm);
window.app_saku3_report_tu_flProyek.implement({
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6],["123","123","123","123","123","123","13"]);
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("Approve","Revisi"));
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tu_rptProyek";
			...
			systemAPI.alert("[app_saku3_report_tu_flProyek]::mainButtonClick:"+e);
		}
	},
