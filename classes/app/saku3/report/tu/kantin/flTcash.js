window.app_saku3_report_tu_kantin_flTcash = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_kantin_flTcash.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_kantin_flTcash";
		this.maximize();
...
window.app_saku3_report_tu_kantin_flTcash.extend(window.childForm);
window.app_saku3_report_tu_kantin_flTcash.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_tu_kantin_flTcash]::mainButtonClick:"+e);
		}
	},
