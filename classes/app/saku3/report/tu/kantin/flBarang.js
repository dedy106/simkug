window.app_saku3_report_tu_kantin_flBarang = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_kantin_flBarang.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_kantin_flBarang";
		this.maximize();
...
window.app_saku3_report_tu_kantin_flBarang.extend(window.childForm);
window.app_saku3_report_tu_kantin_flBarang.implement({
		...
		try{			
			...
			if (row ==	1)
			{
				this.filterRep.ListDataSGFilter(this, "Data Kelompok",this.sg1, this.sg1.row, this.sg1.col,
														  "select kode_klp, nama from ktu_barang_klp "+
														   this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  "select count(kode_klp) from ktu_barang_klp "+
														  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
			...
			if (row ==	2)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Kelompok",this.sg1, this.sg1.row, this.sg1.col,
														  "select kode_barang, nama from ktu_barang "+filter,
														  "select count(kode_barang) from ktu_barang "+filter,
														  new Array("kode_barang","nama"),"and");
			}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tu_kantin_rptBarang";
			...
			systemAPI.alert("[app_saku3_report_tu_kantin_flBarang]::mainButtonClick:"+e);
		}
	},
