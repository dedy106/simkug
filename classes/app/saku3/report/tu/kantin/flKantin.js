window.app_saku3_report_tu_kantin_flKantin = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_kantin_flKantin.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_kantin_flKantin";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Kantin","All",""));
...
window.app_saku3_report_tu_kantin_flKantin.extend(window.childForm);
window.app_saku3_report_tu_kantin_flKantin.implement({
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.kode_kantin",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");
				this.filter2 = this.sg1.getCell(2,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_tu_kantin_rptKantin";
			...
			systemAPI.alert("[app_saku3_report_tu_kantin_flKantin]::mainButtonClick:"+e);
		}
	},
