window.app_saku3_report_tu_kantin_flJurnalSharing = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_kantin_flJurnalSharing.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_kantin_flJurnalSharing";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from kas_m where kode_lokasi='"+this.app._lokasi+"' and modul='KBKANTIN' ");
...
window.app_saku3_report_tu_kantin_flJurnalSharing.extend(window.childForm);
window.app_saku3_report_tu_kantin_flJurnalSharing.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_tu_kantin_flJurnalSharing]::mainButtonClick:"+e);
		}
	},
