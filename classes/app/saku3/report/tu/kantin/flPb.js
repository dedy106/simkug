window.app_saku3_report_tu_kantin_flPb = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_kantin_flPb.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_kantin_flPb";
		this.maximize();
...
window.app_saku3_report_tu_kantin_flPb.extend(window.childForm);
window.app_saku3_report_tu_kantin_flPb.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_tu_kantin_flPb]::mainButtonClick:"+e);
		}
	},
