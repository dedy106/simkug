window.app_saku3_report_tu_kantin_flJurnalRekon = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_kantin_flJurnalRekon.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_kantin_flJurnalRekon";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from kas_m where kode_lokasi='"+this.app._lokasi+"' and modul='REKBAYAR' ");
...
window.app_saku3_report_tu_kantin_flJurnalRekon.extend(window.childForm);
window.app_saku3_report_tu_kantin_flJurnalRekon.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_tu_kantin_flJurnalRekon]::mainButtonClick:"+e);
		}
	},
