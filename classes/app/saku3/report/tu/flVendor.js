window.app_saku3_report_tu_flVendor = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_flVendor.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_flVendor";
		this.maximize();
...
window.app_saku3_report_tu_flVendor.extend(window.childForm);
window.app_saku3_report_tu_flVendor.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tu_rptVendor";
			...
			systemAPI.alert("[app_saku3_report_tu_flVendor]::mainButtonClick:"+e);
		}
	},
