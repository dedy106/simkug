window.app_saku3_report_tu_flProyekPtgPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tu_flProyekPtgPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tu_flProyekPtgPos";
		this.maximize();
...
window.app_saku3_report_tu_flProyekPtgPos.extend(window.childForm);
window.app_saku3_report_tu_flProyekPtgPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tu_rptProyekPtgPos";
			...
			systemAPI.alert("[app_saku3_report_tu_flProyekPtgPos]::mainButtonClick:"+e);
		}
	},
	...
	doOpenBukti: function(no_bukti,kode_lokasi){
		...
		nama_report="server_report_saku3_tu_rptProyekPtg";
