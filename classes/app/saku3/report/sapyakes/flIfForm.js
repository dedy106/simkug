window.app_saku3_report_sapyakes_flIfForm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sapyakes_flIfForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sapyakes_flIfForm";
		this.maximize();
...
window.app_saku3_report_sapyakes_flIfForm.extend(window.childForm);
window.app_saku3_report_sapyakes_flIfForm.implement({
		...
		try{			
			...
			if (row == 3)
			{
				this.filterRep.ListDataSGFilter(this, "Data Karyawan",this.sg1, this.sg1.row, this.sg1.col,
														  ...
														  "select count(a.user_input) "+
															"from if_aju_m a "+
															"inner join karyawan b on a.user_input=b.nik and a.kode_lokasi=b.kode_lokasi  "+
														  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  new Array("a.user_input","a,nama"),"and");
			}
			if (row ==4)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data IF",this.sg1, this.sg1.row, this.sg1.col,
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_sapyakes_rptIfForm2";
			...
			systemAPI.alert("[app_saku3_report_sapyakes_flIfForm]::mainButtonClick:"+e);
		}
	},
