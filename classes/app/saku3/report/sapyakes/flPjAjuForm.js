window.app_saku3_report_sapyakes_flPjAjuForm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sapyakes_flPjAjuForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sapyakes_flPjAjuForm";
		this.maximize();
...
window.app_saku3_report_sapyakes_flPjAjuForm.extend(window.childForm);
window.app_saku3_report_sapyakes_flPjAjuForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_sapyakes_flPjAjuForm]::mainButtonClick:"+e);
		}
	},
