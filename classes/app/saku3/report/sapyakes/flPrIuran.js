window.app_saku3_report_sapyakes_flPrIuran = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sapyakes_flPrIuran.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sapyakes_flPrIuran";
		this.maximize();
...
window.app_saku3_report_sapyakes_flPrIuran.extend(window.childForm);
window.app_saku3_report_sapyakes_flPrIuran.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_sapyakes_rptPrRinci";
				
				if (this.sg1.getCell(2,2)=="Pegawai")
				{
					this.nama_report = "server_report_saku3_sapyakes_rptPrPegawai";
				}
				if (this.sg1.getCell(2,2)=="Pensiun")
				{
					this.nama_report = "server_report_saku3_sapyakes_rptPrPensiun";
				}
			...
			systemAPI.alert("[app_saku3_report_sapyakes_flPrIuran]::mainButtonClick:"+e);
		}
	},
