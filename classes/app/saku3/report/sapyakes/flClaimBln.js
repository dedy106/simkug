window.app_saku3_report_sapyakes_flClaimBln = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sapyakes_flClaimBln.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sapyakes_flClaimBln";
		this.maximize();
...
window.app_saku3_report_sapyakes_flClaimBln.extend(window.childForm);
window.app_saku3_report_sapyakes_flClaimBln.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_sapyakes_rptClTotalb";
				
				if (this.sg1.getCell(2,2)=="Pegawai")
				{
					this.nama_report = "server_report_saku3_sapyakes_rptClPegawaib";
				}
				if (this.sg1.getCell(2,2)=="Pensiun")
				{
					this.nama_report = "server_report_saku3_sapyakes_rptClPensiunb";
				}
			...
			systemAPI.alert("[app_saku3_report_sapyakes_flClaimBln]::mainButtonClick:"+e);
		}
	},
