window.app_saku3_report_sapyakes_flAjuPosisi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sapyakes_flAjuPosisi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sapyakes_flAjuPosisi";
		this.maximize();
...
window.app_saku3_report_sapyakes_flAjuPosisi.extend(window.childForm);
window.app_saku3_report_sapyakes_flAjuPosisi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_sapyakes_rptAjuPosisi";
			...
			systemAPI.alert("[app_saku3_report_sapyakes_flAjuPosisi]::mainButtonClick:"+e);
		}
	},
