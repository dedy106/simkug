window.app_saku3_report_sapyakes_flReimbPosisi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sapyakes_flReimbPosisi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sapyakes_flReimbPosisi";
		this.maximize();
...
window.app_saku3_report_sapyakes_flReimbPosisi.extend(window.childForm);
window.app_saku3_report_sapyakes_flReimbPosisi.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row ==4)
			{
				...
				alert("select a.no_reim, a.keterangan from if_reim_m a "+
		...
		try
		{
			...
			else
			{
		    	...
		    	this.filter =  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.no_reim",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4),"and");
				this.filter2 = this.sg1.getCell(2,1)+"/";
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_sapyakes_rptReimbPosisi";
			...
			systemAPI.alert("[app_saku3_report_sapyakes_flReimbPosisi]::mainButtonClick:"+e);
		}
	},
