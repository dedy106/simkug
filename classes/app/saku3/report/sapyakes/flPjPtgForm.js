window.app_saku3_report_sapyakes_flPjPtgForm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sapyakes_flPjPtgForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sapyakes_flPjPtgForm";
		this.maximize();
...
window.app_saku3_report_sapyakes_flPjPtgForm.extend(window.childForm);
window.app_saku3_report_sapyakes_flPjPtgForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_sapyakes_flPjPtgForm]::mainButtonClick:"+e);
		}
	},
