window.app_saku3_report_sapyakes_flSmsRest = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sapyakes_flSmsRest.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sapyakes_flSmsRest";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Jenis Laporan","=","Detail"));
...
window.app_saku3_report_sapyakes_flSmsRest.extend(window.childForm);
window.app_saku3_report_sapyakes_flSmsRest.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode as periode from yk_bpjs_cob ",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
		if (row == 2)
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("Rekap","Detail","Bulanan"));
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_sapyakes_rptSmsDet";
				if (this.sg1.getCell(2,2)=="Rekap")
				{
					this.nama_report = "server_report_saku3_sapyakes_rptSmsRekap";
				}
				if (this.sg1.getCell(2,2)=="Bulanan")
				{
					this.nama_report = "server_report_saku3_sapyakes_rptSmsBulan";
				}
			...
			systemAPI.alert("[app_saku3_report_sapyakes_flSmsRest]::mainButtonClick:"+e);
		}
	},
