window.app_saku3_report_sapyakes_flReimbForm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sapyakes_flReimbForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sapyakes_flReimbForm";
		this.maximize();
...
window.app_saku3_report_sapyakes_flReimbForm.extend(window.childForm);
window.app_saku3_report_sapyakes_flReimbForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter = this.filter + " and substring(a.kode_pp,3,1)='"+this.bidang+"' ";			
				this.filter2 = this.sg1.getCell(2,1)+"/";
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_sapyakes_rptReimbForm";
			...
			systemAPI.alert("[app_saku3_report_sapyakes_flReimbForm]::mainButtonClick:"+e);
		}
	},
