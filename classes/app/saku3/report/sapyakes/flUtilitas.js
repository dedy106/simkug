window.app_saku3_report_sapyakes_flUtilitas = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sapyakes_flUtilitas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sapyakes_flUtilitas";
		this.maximize();
...
window.app_saku3_report_sapyakes_flUtilitas.extend(window.childForm);
window.app_saku3_report_sapyakes_flUtilitas.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_sapyakes_rptUtilitas";
				
				if (this.sg1.getCell(2,2)=="Pegawai")
				{
					this.nama_report = "server_report_saku3_sapyakes_rptUtilitasPeg";
				}
				if (this.sg1.getCell(2,2)=="Pensiun")
				{
					this.nama_report = "server_report_saku3_sapyakes_rptUtilitasPen";
				}
			...
			systemAPI.alert("[app_saku3_report_sapyakes_flUtilitas]::mainButtonClick:"+e);
		}
	},
