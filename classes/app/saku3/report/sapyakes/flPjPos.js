window.app_saku3_report_sapyakes_flPjPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sapyakes_flPjPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sapyakes_flPjPos";
		this.maximize();
...
window.app_saku3_report_sapyakes_flPjPos.extend(window.childForm);
window.app_saku3_report_sapyakes_flPjPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_sapyakes_rptPjPos";
			...
			systemAPI.alert("[app_saku3_report_sapyakes_flPjPos]::mainButtonClick:"+e);
		}
	},
