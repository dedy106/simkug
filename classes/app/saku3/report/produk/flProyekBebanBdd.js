window.app_saku3_report_produk_flProyekBebanBdd = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flProyekBebanBdd.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flProyekBebanBdd";
		this.maximize();
...
window.app_saku3_report_produk_flProyekBebanBdd.extend(window.childForm);
window.app_saku3_report_produk_flProyekBebanBdd.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_produk_flProyekBebanBdd]::mainButtonClick:"+e);
		}
	},
