window.app_saku3_report_produk_flSisJurnalGen = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flSisJurnalGen.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flSisJurnalGen";
		this.maximize();
...
window.app_saku3_report_produk_flSisJurnalGen.extend(window.childForm);
window.app_saku3_report_produk_flSisJurnalGen.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_produk_flSisJurnalGen]::mainButtonClick:"+e);
		}
	},
