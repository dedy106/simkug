window.app_saku3_report_produk_flProyekPiutangJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flProyekPiutangJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flProyekPiutangJurnal";
		this.maximize();
...
window.app_saku3_report_produk_flProyekPiutangJurnal.extend(window.childForm);
window.app_saku3_report_produk_flProyekPiutangJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_produk_flProyekPiutangJurnal]::mainButtonClick:"+e);
		}
	},
