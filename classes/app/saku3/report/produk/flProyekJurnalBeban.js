window.app_saku3_report_produk_flProyekJurnalBeban = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flProyekJurnalBeban.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flProyekJurnalBeban";
		this.maximize();
...
window.app_saku3_report_produk_flProyekJurnalBeban.extend(window.childForm);
window.app_saku3_report_produk_flProyekJurnalBeban.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_produk_flProyekJurnalBeban]::mainButtonClick:"+e);
		}
	},
