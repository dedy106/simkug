window.app_saku3_report_produk_flKbTb = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flKbTb.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flKbTb";
		this.maximize();
...
window.app_saku3_report_produk_flKbTb.extend(window.childForm);
window.app_saku3_report_produk_flKbTb.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_produk_rptKbTb";
