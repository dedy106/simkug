window.app_saku3_report_produk_flGlNeraca = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flGlNeraca.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flGlNeraca";
		this.maximize();
...
window.app_saku3_report_produk_flGlNeraca.extend(window.childForm);
window.app_saku3_report_produk_flGlNeraca.implement({
		...
		try{			
			...
			if (row == 3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data FS",this.sg1, this.sg1.row, this.sg1.col,
														  "select kode_fs,nama from fs "+lokasi+" and kode_fs in ('FS1','FS2','FS3')",
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				{
					this.nama_report="server_report_saku3_produk_rptGlNeraca";
				}
				if (this.sg1.getCell(2,3)=="FS2")
				{
					this.nama_report="server_report_saku3_produk_rptGlNeracaRincian";
				}
				if (this.sg1.getCell(2,3)=="FS3")
				{
					this.nama_report="server_report_saku3_produk_rptGlPasivaRincian";
				}
