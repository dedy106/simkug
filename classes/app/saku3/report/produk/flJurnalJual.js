window.app_saku3_report_produk_flJurnalJual = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flJurnalJual.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flJurnalJual";
		this.maximize();
...
window.app_saku3_report_produk_flJurnalJual.extend(window.childForm);
window.app_saku3_report_produk_flJurnalJual.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_produk_rptJurnalJual";
			...
			systemAPI.alert("[app_saku3_report_produk_flJurnalJual]::mainButtonClick:"+e);
		}
	},
