window.app_saku3_report_produk_flProyekBebanRev = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flProyekBebanRev.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flProyekBebanRev";
		this.maximize();
...
window.app_saku3_report_produk_flProyekBebanRev.extend(window.childForm);
window.app_saku3_report_produk_flProyekBebanRev.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_produk_flProyekBebanRev]::mainButtonClick:"+e);
		}
	},
