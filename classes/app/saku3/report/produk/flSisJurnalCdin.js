window.app_saku3_report_produk_flSisJurnalCdin = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flSisJurnalCdin.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flSisJurnalCdin";
		this.maximize();
...
window.app_saku3_report_produk_flSisJurnalCdin.extend(window.childForm);
window.app_saku3_report_produk_flSisJurnalCdin.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_produk_flSisJurnalCdin]::mainButtonClick:"+e);
		}
	},
