window.app_saku3_report_produk_flSisJurnalCdout = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flSisJurnalCdout.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flSisJurnalCdout";
		this.maximize();
...
window.app_saku3_report_produk_flSisJurnalCdout.extend(window.childForm);
window.app_saku3_report_produk_flSisJurnalCdout.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_produk_flSisJurnalCdout]::mainButtonClick:"+e);
		}
	},
