window.app_saku3_report_produk_flKbBukuBesar = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flKbBukuBesar.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flKbBukuBesar";
		this.maximize();
...
window.app_saku3_report_produk_flKbBukuBesar.extend(window.childForm);
window.app_saku3_report_produk_flKbBukuBesar.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_produk_rptKbBukuBesar";
