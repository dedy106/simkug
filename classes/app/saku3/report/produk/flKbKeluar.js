// JavaScript Document
window.app_saku3_report_produk_flKbKeluar = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flKbKeluar.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flKbKeluar";
		this.maximize();
...
window.app_saku3_report_produk_flKbKeluar.extend(window.portalui_childForm);
window.app_saku3_report_produk_flKbKeluar.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_produk_rptKbKeluar";
				this.dbLib.execQuerySync(this.sql);	
