window.app_saku3_report_produk_flProyekPanjar = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flProyekPanjar.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flProyekPanjar";
		this.maximize();
...
window.app_saku3_report_produk_flProyekPanjar.extend(window.childForm);
window.app_saku3_report_produk_flProyekPanjar.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_produk_flProyekPanjar]::mainButtonClick:"+e);
		}
	},
