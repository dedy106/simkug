window.app_saku3_report_produk_flBayarBeli = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flBayarBeli.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flBayarBeli";
		this.maximize();
...
window.app_saku3_report_produk_flBayarBeli.extend(window.childForm);
window.app_saku3_report_produk_flBayarBeli.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_produk_rptBayarBeli";
			...
			systemAPI.alert("[app_saku3_report_produk_flBayarBeli]::mainButtonClick:"+e);
		}
	},
