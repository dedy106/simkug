window.app_saku3_report_produk_flBillDaftar = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flBillDaftar.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flBillDaftar";
		this.maximize();
...
window.app_saku3_report_produk_flBillDaftar.extend(window.childForm);
window.app_saku3_report_produk_flBillDaftar.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_produk_flBillDaftar]::mainButtonClick:"+e);
		}
	},
	...
	doOpenBill: function(no_bukti,kode_lokasi){
		...
		nama_report="server_report_saku3_produk_rptBillGabung";
