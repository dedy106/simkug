window.app_saku3_report_produk_flJadwal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flJadwal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flJadwal";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Tahun Ajaran","All",""));
...
window.app_saku3_report_produk_flJadwal.extend(window.childForm);
window.app_saku3_report_produk_flJadwal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_produk_rptJadwal";
