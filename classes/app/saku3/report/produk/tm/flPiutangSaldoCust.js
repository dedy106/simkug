window.app_saku3_report_produk_tm_flPiutangSaldoCust = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_tm_flPiutangSaldoCust.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_tm_flPiutangSaldoCust";
		this.maximize();
...
window.app_saku3_report_produk_tm_flPiutangSaldoCust.extend(window.childForm);
window.app_saku3_report_produk_tm_flPiutangSaldoCust.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_produk_tm_rptPiutangSaldoCust";
			...
			systemAPI.alert("[app_saku3_report_produk_tm_flPiutangSaldoCust]::mainButtonClick:"+e);
		}
	},
	...
	doOpenSaldo: function(kode_cust,kode_lokasi,periode){
		...
		this.link="1";
		filter = "where a.kode_cust='"+kode_cust+"' and a.kode_lokasi='"+kode_lokasi+"' and a.periode='"+periode+"'";
		filter2=kode_lokasi+"/"+periode+"/";
		nama_report="server_report_saku3_produk_tm_rptPiutangSaldo";
