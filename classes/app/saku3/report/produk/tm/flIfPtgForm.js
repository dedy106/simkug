window.app_saku3_report_produk_tm_flIfPtgForm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_tm_flIfPtgForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_tm_flIfPtgForm";
		this.maximize();
...
window.app_saku3_report_produk_tm_flIfPtgForm.extend(window.childForm);
window.app_saku3_report_produk_tm_flIfPtgForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_produk_tm_rptReim";
			...
			systemAPI.alert("[app_saku3_report_produk_tm_flIfPtgForm]::mainButtonClick:"+e);
		}
	},
