window.app_saku3_report_produk_tm_flReimKartu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_tm_flReimKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_tm_flReimKartu";
		this.maximize();
...
window.app_saku3_report_produk_tm_flReimKartu.extend(window.childForm);
window.app_saku3_report_produk_tm_flReimKartu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_produk_tm_flReimKartu]::mainButtonClick:"+e);
		}
	},
