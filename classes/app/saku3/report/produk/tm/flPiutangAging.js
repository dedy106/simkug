window.app_saku3_report_produk_tm_flPiutangAging = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_tm_flPiutangAging.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_tm_flPiutangAging";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("Tanggal Aging","=",new Date().lclFormat()));
...
window.app_saku3_report_produk_tm_flPiutangAging.extend(window.childForm);
window.app_saku3_report_produk_tm_flPiutangAging.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_produk_tm_rptPiutangAging";
			...
			systemAPI.alert("[app_saku3_report_produk_tm_flPiutangAging]::mainButtonClick:"+e);
		}
	},
