window.app_saku3_report_produk_tm_flHutangJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_tm_flHutangJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_tm_flHutangJurnal";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from tm_hutang_m  ");
...
window.app_saku3_report_produk_tm_flHutangJurnal.extend(window.childForm);
window.app_saku3_report_produk_tm_flHutangJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_produk_tm_rptHutangJurnal";
			...
			systemAPI.alert("[app_saku3_report_produk_tm_flHutangJurnal]::mainButtonClick:"+e);
		}
	},
