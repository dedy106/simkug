window.app_saku3_report_produk_tm_flPiutang = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_tm_flPiutang.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_tm_flPiutang";
		this.maximize();
...
window.app_saku3_report_produk_tm_flPiutang.extend(window.childForm);
window.app_saku3_report_produk_tm_flPiutang.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_produk_tm_rptPiutang";
			...
			systemAPI.alert("[app_saku3_report_produk_tm_flPiutang]::mainButtonClick:"+e);
		}
	},
