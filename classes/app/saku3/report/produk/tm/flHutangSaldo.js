window.app_saku3_report_produk_tm_flHutangSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_tm_flHutangSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_tm_flHutangSaldo";
		this.maximize();
...
window.app_saku3_report_produk_tm_flHutangSaldo.extend(window.childForm);
window.app_saku3_report_produk_tm_flHutangSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_produk_tm_rptHutangSaldo";
			...
			systemAPI.alert("[app_saku3_report_produk_tm_flHutangSaldo]::mainButtonClick:"+e);
		}
	},
