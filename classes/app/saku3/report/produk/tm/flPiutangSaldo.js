window.app_saku3_report_produk_tm_flPiutangSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_tm_flPiutangSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_tm_flPiutangSaldo";
		this.maximize();
...
window.app_saku3_report_produk_tm_flPiutangSaldo.extend(window.childForm);
window.app_saku3_report_produk_tm_flPiutangSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_produk_tm_rptPiutangSaldo";
			...
			systemAPI.alert("[app_saku3_report_produk_tm_flPiutangSaldo]::mainButtonClick:"+e);
		}
	},
	...
	doOpenDok: function(no_bukti,kode_lokasi){
		...
		nama_report="server_report_saku3_produk_tm_rptDetailDok";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
