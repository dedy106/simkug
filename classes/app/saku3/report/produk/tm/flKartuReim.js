window.app_saku3_report_produk_tm_flKartuReim = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_tm_flKartuReim.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_tm_flKartuReim";
		this.maximize();
...
window.app_saku3_report_produk_tm_flKartuReim.extend(window.childForm);
window.app_saku3_report_produk_tm_flKartuReim.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_produk_tm_rptKartuReim";
			...
			systemAPI.alert("[app_saku3_report_produk_tm_flKartuReim]::mainButtonClick:"+e);
		}
	},
