window.app_saku3_report_produk_tm_flPiutangKartu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_tm_flPiutangKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_tm_flPiutangKartu";
		this.maximize();
...
window.app_saku3_report_produk_tm_flPiutangKartu.extend(window.childForm);
window.app_saku3_report_produk_tm_flPiutangKartu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_produk_tm_rptPiutangKartu";
			...
			systemAPI.alert("[app_saku3_report_produk_tm_flPiutangKartu]::mainButtonClick:"+e);
		}
	},
