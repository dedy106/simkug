window.app_saku3_report_produk_tm_flFnik = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_tm_flFnik.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_tm_flFnik";
		this.maximize();
...
window.app_saku3_report_produk_tm_flFnik.extend(window.childForm);
window.app_saku3_report_produk_tm_flFnik.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_produk_tm_rptFnik";
			...
			systemAPI.alert("[app_saku3_report_produk_tm_flFnik]::mainButtonClick:"+e);
		}
	},
