window.app_saku3_report_produk_tm_flHutangKasJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_tm_flHutangKasJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_tm_flHutangKasJurnal";
		this.maximize();
...
window.app_saku3_report_produk_tm_flHutangKasJurnal.extend(window.childForm);
window.app_saku3_report_produk_tm_flHutangKasJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_produk_tm_rptHutangKasJurnal";
			...
			systemAPI.alert("[app_saku3_report_produk_tm_flHutangKasJurnal]::mainButtonClick:"+e);
		}
	},
