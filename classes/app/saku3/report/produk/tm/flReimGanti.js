window.app_saku3_report_produk_tm_flReimGanti = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_tm_flReimGanti.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_tm_flReimGanti";
		this.maximize();
...
window.app_saku3_report_produk_tm_flReimGanti.extend(window.childForm);
window.app_saku3_report_produk_tm_flReimGanti.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_produk_tm_rptReimGanti";
			...
			systemAPI.alert("[app_saku3_report_produk_tm_flReimGanti]::mainButtonClick:"+e);
		}
	},
