window.app_saku3_report_produk_tm_flPiutangJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_tm_flPiutangJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_tm_flPiutangJurnal";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from piutang_m  ");
...
window.app_saku3_report_produk_tm_flPiutangJurnal.extend(window.childForm);
window.app_saku3_report_produk_tm_flPiutangJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_produk_tm_rptPiutangJurnal";
			...
			systemAPI.alert("[app_saku3_report_produk_tm_flPiutangJurnal]::mainButtonClick:"+e);
		}
	},
