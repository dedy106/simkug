window.app_saku3_report_produk_flMapel = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flMapel.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flMapel";
		this.maximize();
...
window.app_saku3_report_produk_flMapel.extend(window.childForm);
window.app_saku3_report_produk_flMapel.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_produk_rptMapel";
