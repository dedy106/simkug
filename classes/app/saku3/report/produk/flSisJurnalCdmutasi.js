window.app_saku3_report_produk_flSisJurnalCdmutasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flSisJurnalCdmutasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flSisJurnalCdmutasi";
		this.maximize();
...
window.app_saku3_report_produk_flSisJurnalCdmutasi.extend(window.childForm);
window.app_saku3_report_produk_flSisJurnalCdmutasi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_produk_flSisJurnalCdmutasi]::mainButtonClick:"+e);
		}
	},
