window.app_saku3_report_produk_flTerima = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flTerima.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flTerima";
		this.maximize();
...
window.app_saku3_report_produk_flTerima.extend(window.childForm);
window.app_saku3_report_produk_flTerima.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_produk_rptTerima";
			...
			systemAPI.alert("[app_saku3_report_produk_flTerima]::mainButtonClick:"+e);
		}
	},
