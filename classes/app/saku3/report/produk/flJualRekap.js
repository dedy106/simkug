window.app_saku3_report_produk_flJualRekap = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flJualRekap.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flJualRekap";
		this.maximize();
...
window.app_saku3_report_produk_flJualRekap.extend(window.childForm);
window.app_saku3_report_produk_flJualRekap.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_produk_rptJualRekap";
			...
			systemAPI.alert("[app_saku3_report_produk_flJualRekap]::mainButtonClick:"+e);
		}
	},
	...
	doOpenKas: function(no_bukti,kode_lokasi){
		...
		nama_report="server_report_saku3_produk_rptJual";
