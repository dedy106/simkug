window.app_saku3_report_produk_flBayarJual = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flBayarJual.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flBayarJual";
		this.maximize();
...
window.app_saku3_report_produk_flBayarJual.extend(window.childForm);
window.app_saku3_report_produk_flBayarJual.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_produk_flBayarJual]::mainButtonClick:"+e);
		}
	},
