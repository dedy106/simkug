window.app_saku3_report_produk_flKontrolTenan = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flKontrolTenan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flKontrolTenan";
		this.maximize();
...
window.app_saku3_report_produk_flKontrolTenan.extend(window.childForm);
window.app_saku3_report_produk_flKontrolTenan.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_produk_rptKontrolTenan";
			...
			systemAPI.alert("[app_saku3_report_produk_flKontrolTenan]::mainButtonClick:"+e);
		}
	},
