window.app_saku3_report_produk_flProyekSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flProyekSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flProyekSaldo";
		this.maximize();
...
window.app_saku3_report_produk_flProyekSaldo.extend(window.childForm);
window.app_saku3_report_produk_flProyekSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_produk_rptProyekSaldo";
			...
			systemAPI.alert("[app_saku3_report_produk_flProyekSaldo]::mainButtonClick:"+e);
		}
	},
