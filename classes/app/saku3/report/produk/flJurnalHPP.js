window.app_saku3_report_produk_flJurnalHPP = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flJurnalHPP.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flJurnalHPP";
		this.maximize();
...
window.app_saku3_report_produk_flJurnalHPP.extend(window.childForm);
window.app_saku3_report_produk_flJurnalHPP.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_produk_flJurnalHPP]::mainButtonClick:"+e);
		}
	},
