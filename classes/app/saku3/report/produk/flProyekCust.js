window.app_saku3_report_produk_flProyekCust = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flProyekCust.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flProyekCust";
		this.maximize();
...
window.app_saku3_report_produk_flProyekCust.extend(window.childForm);
window.app_saku3_report_produk_flProyekCust.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_produk_rptProyekCust";
			...
			systemAPI.alert("[app_saku3_report_produk_flProyekCust]::mainButtonClick:"+e);
		}
	},
