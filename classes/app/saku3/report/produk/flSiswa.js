window.app_saku3_report_produk_flSiswa = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flSiswa.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flSiswa";
		this.maximize();
...
window.app_saku3_report_produk_flSiswa.extend(window.childForm);
window.app_saku3_report_produk_flSiswa.implement({
		...
		try{			
			...
			if (row ==1)
			{
				this.filterRep.ListDataSGFilter(this, "Data Angkatan",this.sg1, this.sg1.row, this.sg1.col,
														  "select a.kode_akt, a.nama from sis_angkat a  "+
														   this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(2,0)," where "),
														  "select count(a.kode_akt) from sis_angkat a "+
														  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(2,0)," where "),
			...
			if (row ==3)
			{
				this.filterRep.ListDataSGFilter(this, "Data Status",this.sg1, this.sg1.row, this.sg1.col,
														  "select a.kode_ss, a.nama from sis_siswa_status a  "+
														   this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(2,0)," where "),
														  "select count(a.kode_ss) from sis_siswa_status a "+
														  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(2,0)," where "),
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							  ...
							  this.filterRep.filterStr("d.kode_ss",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and");

							  this.showFilter = this.filterRep.showFilter(this.sg1);
				this.nama_report = "server_report_saku3_produk_rptSiswa";
