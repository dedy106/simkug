window.app_saku3_report_produk_flPiutangBayarCash = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flPiutangBayarCash.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flPiutangBayarCash";
		this.maximize();
...
window.app_saku3_report_produk_flPiutangBayarCash.extend(window.childForm);
window.app_saku3_report_produk_flPiutangBayarCash.implement({
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.filter2 =this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							  ...
							  this.filterRep.filterStr("a.no_bukti",this.sg1.getCell(1,6),this.sg1.getCell(2,6),this.sg1.getCell(3,6),"and")+"/"+this.sg1.getCell(2,7)+"/"+this.sg1.getCell(2,2);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				
				
				this.nama_report = "server_report_saku3_produk_rptPiutangBayarCash";
