window.app_saku3_report_produk_flVendor = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flVendor.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flVendor";
		this.maximize();
...
window.app_saku3_report_produk_flVendor.extend(window.childForm);
window.app_saku3_report_produk_flVendor.implement({
		...
		try{			
			...
			if (row ==1)
			{
				this.filterRep.ListDataSGFilter(this, "Data Vendor",this.sg1, this.sg1.row, this.sg1.col,
												"select kode_vendor, nama from brg_vendor ",
												"select count(*) from brg_vendor ",
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_produk_rptVendor";
			...
			systemAPI.alert("[app_saku3_report_produk_flVendor]::mainButtonClick:"+e);
		}
	},
