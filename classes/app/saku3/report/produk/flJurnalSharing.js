window.app_saku3_report_produk_flJurnalSharing = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flJurnalSharing.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flJurnalSharing";
		this.maximize();
...
window.app_saku3_report_produk_flJurnalSharing.extend(window.childForm);
window.app_saku3_report_produk_flJurnalSharing.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_produk_rptJurnalSharing";
			...
			systemAPI.alert("[app_saku3_report_produk_flJurnalSharing]::mainButtonClick:"+e);
		}
	},
