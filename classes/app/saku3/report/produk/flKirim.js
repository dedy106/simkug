window.app_saku3_report_produk_flKirim = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flKirim.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flKirim";
		this.maximize();
...
window.app_saku3_report_produk_flKirim.extend(window.childForm);
window.app_saku3_report_produk_flKirim.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_produk_rptKirim";
			...
			systemAPI.alert("[app_saku3_report_produk_flKirim]::mainButtonClick:"+e);
		}
	},
