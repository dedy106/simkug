window.app_saku3_report_produk_flBeli = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flBeli.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flBeli";
		this.maximize();
...
window.app_saku3_report_produk_flBeli.extend(window.childForm);
window.app_saku3_report_produk_flBeli.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_produk_flBeli]::mainButtonClick:"+e);
		}
	},
