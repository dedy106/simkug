window.app_saku3_report_produk_flTukarBrg = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flTukarBrg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flTukarBrg";
		this.maximize();
...
window.app_saku3_report_produk_flTukarBrg.extend(window.childForm);
window.app_saku3_report_produk_flTukarBrg.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_produk_rptTukarBrg";
			...
			systemAPI.alert("[app_saku3_report_produk_flTukarBrg]::mainButtonClick:"+e);
		}
	},
