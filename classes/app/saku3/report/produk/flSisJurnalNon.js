window.app_saku3_report_produk_flSisJurnalNon = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flSisJurnalNon.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flSisJurnalNon";
		this.maximize();
...
window.app_saku3_report_produk_flSisJurnalNon.extend(window.childForm);
window.app_saku3_report_produk_flSisJurnalNon.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_produk_flSisJurnalNon]::mainButtonClick:"+e);
		}
	},
