window.app_saku3_report_produk_flAgg = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flAgg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flAgg";
		this.maximize();
...
window.app_saku3_report_produk_flAgg.extend(window.portalui_childForm);
window.app_saku3_report_produk_flAgg.implement({
	doEllipseClick: function(sender, col, row){
		...
		if (row == 3)
		{
			var sql1="select a.kode_akun, a.nama "+
					...
					"			where kode_lokasi='"+this.sg1.getCell(2,0)+"' and substring(periode,1,4)='"+this.sg1.getCell(2,1)+"' "+
	...
	doSelectCell: function(sender, col, row){
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4],["123","123","3","13","3"]);
	...
	mainButtonClick: function(sender){
		try
		{
			...
			if (this.sg1.getCell(1,4)!="All")
			{
				...
				{
					jenis=" and y.jenis='"+this.sg1.getCell(2,4)+"' ";
				}
			}
			...
			this.filter=this.filterRep.filterStr("x.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
						...
						this.filterRep.filterStr("x.kode_akun",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and")+jenis;
			this.filter2=this.sg1.getCell(2,2)+"/";	
			
			this.nama_report="server_report_saku3_produk_rptAggBulan";
