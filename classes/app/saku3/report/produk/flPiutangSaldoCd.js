window.app_saku3_report_produk_flPiutangSaldoCd = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flPiutangSaldoCd.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flPiutangSaldoCd";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,5,new Array(0,1,2), new Array("Status Mahasiswa","=","1. AKTIF"));
	this.gridLib.SGEditData(this.sg1,6,new Array(0,1,2), new Array("Periode","=",this.periode));
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_produk_flPiutangSaldoCd.extend(window.childForm);
window.app_saku3_report_produk_flPiutangSaldoCd.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_produk_rptPiutangSaldoCd";
