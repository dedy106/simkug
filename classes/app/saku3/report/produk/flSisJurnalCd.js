window.app_saku3_report_produk_flSisJurnalCd = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flSisJurnalCd.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flSisJurnalCd";
		this.maximize();
...
window.app_saku3_report_produk_flSisJurnalCd.extend(window.childForm);
window.app_saku3_report_produk_flSisJurnalCd.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_produk_flSisJurnalCd]::mainButtonClick:"+e);
		}
	},
