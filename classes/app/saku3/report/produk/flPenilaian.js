window.app_saku3_report_produk_flPenilaian = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flPenilaian.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flPenilaian";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Tahun Ajaran","All",""));
	
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_produk_flPenilaian.extend(window.childForm);
window.app_saku3_report_produk_flPenilaian.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_produk_rptPenilaian";
