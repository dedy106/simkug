window.app_saku3_report_produk_flJurnalBeli = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flJurnalBeli.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flJurnalBeli";
		this.maximize();
...
window.app_saku3_report_produk_flJurnalBeli.extend(window.childForm);
window.app_saku3_report_produk_flJurnalBeli.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_produk_rptJurnalBeli";
			...
			systemAPI.alert("[app_saku3_report_produk_flJurnalBeli]::mainButtonClick:"+e);
		}
	},
