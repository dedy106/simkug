// JavaScript Document
window.app_saku3_report_produk_flKbSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flKbSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flKbSaldo";
		this.maximize();
...
window.app_saku3_report_produk_flKbSaldo.extend(window.portalui_childForm);
window.app_saku3_report_produk_flKbSaldo.implement({
		...
		if (row == 2)
			{
				this.filterRep.ListDataSGFilter(this, "Data Akun",this.sg1, this.sg1.row, this.sg1.col,
													...
													"where a.block= '0' and b.kode_flag in ('001','009') and a.kode_curr='IDR' "+
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_produk_rptKbSaldo";
				this.dbLib.execQuerySync(this.sql);	
