window.app_saku3_report_produk_flProyekPiutangUnbill = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flProyekPiutangUnbill.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flProyekPiutangUnbill";
		this.maximize();
...
window.app_saku3_report_produk_flProyekPiutangUnbill.extend(window.childForm);
window.app_saku3_report_produk_flProyekPiutangUnbill.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_produk_flProyekPiutangUnbill]::mainButtonClick:"+e);
		}
	},
