window.app_saku3_report_produk_flGlNeracaJejer = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flGlNeracaJejer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flGlNeracaJejer";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Jenis","==","PP"));
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_produk_flGlNeracaJejer.extend(window.childForm);
window.app_saku3_report_produk_flGlNeracaJejer.implement({
	...
	{		
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("PP","Divisi"));
		}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				{
					this.nama_report="server_report_saku3_produk_rptGlNeracaPpJejer";
				}
				if (this.sg1.getCell(2,3)=="FS2")
				{
					this.nama_report="server_report_saku3_produk_rptGlNeracaRincianJejer";
				}
				if (this.sg1.getCell(2,3)=="FS3")
				{
					this.nama_report="server_report_saku3_produk_rptGlPasivaRincianJejer";
				}
