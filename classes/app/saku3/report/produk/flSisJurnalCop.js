window.app_saku3_report_produk_flSisJurnalCop = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flSisJurnalCop.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flSisJurnalCop";
		this.maximize();
...
window.app_saku3_report_produk_flSisJurnalCop.extend(window.childForm);
window.app_saku3_report_produk_flSisJurnalCop.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_produk_flSisJurnalCop]::mainButtonClick:"+e);
		}
	},
