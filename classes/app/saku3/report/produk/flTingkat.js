window.app_saku3_report_produk_flTingkat = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flTingkat.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flTingkat";
		this.maximize();
...
window.app_saku3_report_produk_flTingkat.extend(window.childForm);
window.app_saku3_report_produk_flTingkat.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_produk_rptTingkat";
