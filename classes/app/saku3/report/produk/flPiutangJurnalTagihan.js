window.app_saku3_report_produk_flPiutangJurnalTagihan = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flPiutangJurnalTagihan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flPiutangJurnalTagihan";
		this.maximize();
...
window.app_saku3_report_produk_flPiutangJurnalTagihan.extend(window.childForm);
window.app_saku3_report_produk_flPiutangJurnalTagihan.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_produk_rptPiutangJurnalTagihan";
			...
			systemAPI.alert("[app_saku3_report_produk_flPiutangJurnalTagihan]::mainButtonClick:"+e);
		}
	},
