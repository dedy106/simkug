window.app_saku3_report_produk_flProyekPws = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flProyekPws.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flProyekPws";
		this.maximize();
...
window.app_saku3_report_produk_flProyekPws.extend(window.childForm);
window.app_saku3_report_produk_flProyekPws.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_produk_rptProyekPws";
			...
			systemAPI.alert("[app_saku3_report_produk_flProyekPws]::mainButtonClick:"+e);
		}
	},
