window.app_saku3_report_produk_flProyekMaster = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flProyekMaster.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flProyekMaster";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("No Bukti","All",""));
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Metode Penyelenggaraan","All",""));
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Metode Pembayaran","All",""));
...
window.app_saku3_report_produk_flProyekMaster.extend(window.childForm);
window.app_saku3_report_produk_flProyekMaster.implement({
		...
		try{			
			...
			if (row ==1)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Proyek",this.sg1, this.sg1.row, this.sg1.col,
												...
												new Array("a.kode_proyek","a.nama"),"and",new Array("No Proyek","Keterangan"));
			}
	...
	{		
		...
		if (row == 2)
		{
			...
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("ONSITE","ONLINE"));
		}
		if (row == 3)
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("TERMIN","DP","TAHAP"));
		}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.lokasi=this.dbLib.getPeriodeFromSQL("select nama as lokasi from lokasi where kode_lokasi='"+this.sg1.getCell(1,0)+"'");
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.metode_penyelenggara",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
							this.filterRep.filterStr("a.metode_bayar",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and");
				this.filter2 = this.sg1.getCell(1,0);
			...
			systemAPI.alert("[app_saku3_report_produk_flProyekMaster]::mainButtonClick:"+e);
		}
	},
