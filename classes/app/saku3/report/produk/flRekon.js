window.app_saku3_report_produk_flRekon = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flRekon.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flRekon";
		this.maximize();
...
window.app_saku3_report_produk_flRekon.extend(window.childForm);
window.app_saku3_report_produk_flRekon.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_produk_rptRekon";
			...
			systemAPI.alert("[app_saku3_report_produk_flRekon]::mainButtonClick:"+e);
		}
	},
