window.app_saku3_report_produk_flGlPdpt = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flGlPdpt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flGlPdpt";
		this.maximize();
...
window.app_saku3_report_produk_flGlPdpt.extend(window.childForm);
window.app_saku3_report_produk_flGlPdpt.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,2)+"/"+this.app._nikUser+"/"+this.sg1.getCell(2,3);
				...
				if (this.sg1.getCell(2,6)=="Tertanggung")
				{
					...
					{
						this.nama_report = "server_report_saku3_produk_rptPdptNet";
					}
					else
					{
						this.nama_report = "server_report_saku3_produk_rptPdptGross";
					}
				}
			...
			systemAPI.alert("[app_saku3_report_produk_flGlPdpt]::mainButtonClick:"+e);
		}
	},
