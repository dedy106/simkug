window.app_saku3_report_produk_flProyekCons = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flProyekCons.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flProyekCons";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Kode Consumer","All",""));
...
window.app_saku3_report_produk_flProyekCons.extend(window.childForm);
window.app_saku3_report_produk_flProyekCons.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row ==1)
			{
				this.filterRep.ListDataSGFilter(this, "Data Consumer",this.sg1, this.sg1.row, this.sg1.col,
												"select kode_cons, nama from consumer ",
												"select count(*) from cust ",
												new Array("kode_cons","nama"),"where",new Array("kode","nama"));
			}
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.kode_cons",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");
				this.filter2 = this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,0)+"/"+this.app._nikUser;
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_produk_rptProyekCons";
			...
			systemAPI.alert("[app_saku3_report_produk_flProyekCons]::mainButtonClick:"+e);
		}
	},
