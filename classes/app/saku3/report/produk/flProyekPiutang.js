window.app_saku3_report_produk_flProyekPiutang = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flProyekPiutang.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flProyekPiutang";
		this.maximize();
...
window.app_saku3_report_produk_flProyekPiutang.extend(window.childForm);
window.app_saku3_report_produk_flProyekPiutang.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_produk_rptProyekPiutang";
			...
			systemAPI.alert("[app_saku3_report_produk_flProyekPiutang]::mainButtonClick:"+e);
		}
	},
