window.app_saku3_report_produk_flPiutangJurnalBayar = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flPiutangJurnalBayar.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flPiutangJurnalBayar";
		this.maximize();
...
window.app_saku3_report_produk_flPiutangJurnalBayar.extend(window.childForm);
window.app_saku3_report_produk_flPiutangJurnalBayar.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_produk_rptPiutangJurnalBayar";
			...
			systemAPI.alert("[app_saku3_report_produk_flPiutangJurnalBayar]::mainButtonClick:"+e);
		}
	},
