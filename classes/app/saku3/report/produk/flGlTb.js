window.app_saku3_report_produk_flGlTb = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flGlTb.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flGlTb";
		this.maximize();
...
window.app_saku3_report_produk_flGlTb.extend(window.childForm);
window.app_saku3_report_produk_flGlTb.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_produk_rptGlTb";
