// JavaScript Document
window.app_saku3_report_produk_flBeliMutasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flBeliMutasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flBeliMutasi";
		this.maximize();
...
window.app_saku3_report_produk_flBeliMutasi.extend(window.portalui_childForm);
window.app_saku3_report_produk_flBeliMutasi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_produk_rptBeliMutasi";
				this.dbLib.execQuerySync(this.sql);	
