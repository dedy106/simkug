window.app_saku3_report_produk_flKbBukuBank = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flKbBukuBank.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flKbBukuBank";
		this.maximize();
...
window.app_saku3_report_produk_flKbBukuBank.extend(window.childForm);
window.app_saku3_report_produk_flKbBukuBank.implement({
