window.app_saku3_report_produk_flPresensi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flPresensi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flPresensi";
		this.maximize();
...
window.app_saku3_report_produk_flPresensi.extend(window.childForm);
window.app_saku3_report_produk_flPresensi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_produk_rptPresensi";
