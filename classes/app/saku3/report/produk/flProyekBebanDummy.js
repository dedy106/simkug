window.app_saku3_report_produk_flProyekBebanDummy = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flProyekBebanDummy.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flProyekBebanDummy";
		this.maximize();
...
window.app_saku3_report_produk_flProyekBebanDummy.extend(window.childForm);
window.app_saku3_report_produk_flProyekBebanDummy.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_produk_flProyekBebanDummy]::mainButtonClick:"+e);
		}
	},
