window.app_saku3_report_produk_flProyekPiutangRev = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flProyekPiutangRev.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flProyekPiutangRev";
		this.maximize();
...
window.app_saku3_report_produk_flProyekPiutangRev.extend(window.childForm);
window.app_saku3_report_produk_flProyekPiutangRev.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_produk_rptProyekPiutangRev";
			...
			systemAPI.alert("[app_saku3_report_produk_flProyekPiutangRev]::mainButtonClick:"+e);
		}
	},
