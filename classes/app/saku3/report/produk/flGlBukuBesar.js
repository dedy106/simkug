window.app_saku3_report_produk_flGlBukuBesar = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flGlBukuBesar.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flGlBukuBesar";
		this.maximize();
...
window.app_saku3_report_produk_flGlBukuBesar.extend(window.childForm);
window.app_saku3_report_produk_flGlBukuBesar.implement({
	...
	{		
		...
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5,6,7],[2,0,2,2,0,1,0,0,0]);	
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.app._nikUser+"/"+this.sg1.getCell(2,3)+"/"+var_periode+"/"+this.sg1.getCell(2,7)+"/"+this.sg1.getCell(1,1)+"/"+this.sg1.getCell(3,1)+"/"+this.sg1.getCell(1,2);
