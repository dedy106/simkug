window.app_saku3_report_produk_flProyek = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flProyek.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flProyek";
		this.maximize();
...
window.app_saku3_report_produk_flProyek.extend(window.childForm);
window.app_saku3_report_produk_flProyek.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_produk_rptProyek";
			...
			systemAPI.alert("[app_saku3_report_produk_flProyek]::mainButtonClick:"+e);
		}
	},
