window.app_saku3_report_produk_flProyekPanjarBdd = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flProyekPanjarBdd.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flProyekPanjarBdd";
		this.maximize();
...
window.app_saku3_report_produk_flProyekPanjarBdd.extend(window.childForm);
window.app_saku3_report_produk_flProyekPanjarBdd.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_produk_flProyekPanjarBdd]::mainButtonClick:"+e);
		}
	},
