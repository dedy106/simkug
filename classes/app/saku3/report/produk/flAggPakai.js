window.app_saku3_report_produk_flAggPakai = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flAggPakai.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flAggPakai";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,[0,1,2],["periode","=",this.periode]);
...
window.app_saku3_report_produk_flAggPakai.extend(window.portalui_childForm);
window.app_saku3_report_produk_flAggPakai.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		if (row == 2)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from anggaran_d "+
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_produk_rptAggPakai";
