window.app_saku3_report_produk_flProyekBebanBddRev = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flProyekBebanBddRev.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flProyekBebanBddRev";
		this.maximize();
...
window.app_saku3_report_produk_flProyekBebanBddRev.extend(window.childForm);
window.app_saku3_report_produk_flProyekBebanBddRev.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_produk_flProyekBebanBddRev]::mainButtonClick:"+e);
		}
	},
