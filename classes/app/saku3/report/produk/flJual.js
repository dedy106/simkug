window.app_saku3_report_produk_flJual = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flJual.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flJual";
		this.maximize();
...
window.app_saku3_report_produk_flJual.extend(window.childForm);
window.app_saku3_report_produk_flJual.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_produk_flJual]::mainButtonClick:"+e);
		}
	},
