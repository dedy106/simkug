window.app_saku3_report_produk_flBeliRekap = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flBeliRekap.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flBeliRekap";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Gudang","All",""));
...
window.app_saku3_report_produk_flBeliRekap.extend(window.childForm);
window.app_saku3_report_produk_flBeliRekap.implement({
		...
		try{			
			...
			if (row ==2)
			{
				this.filterRep.ListDataSGFilter(this, "Data Vendor",this.sg1, this.sg1.row, this.sg1.col,
												"select kode_vendor, nama from brg_vendor where kode_lokasi='"+this.app._lokasi+"'",
												"select count(*) from brg_vendor where kode_lokasi='"+this.app._lokasi+"'",
												new Array("kode_vendor","nama"),"where",new Array("kode","nama"));
			}
			if (row ==3)
			{
			...
			if (row ==4)
			{
				filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.param2",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("b.kode_vendor",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
							this.filterRep.filterStr("c.kode_gudang",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and")+
				...
				this.nama_report = "server_report_saku3_produk_rptBeliRekap";
			...
			systemAPI.alert("[app_saku3_report_produk_flBeliRekap]::mainButtonClick:"+e);
		}
	},
	...
	doOpenJurnal: function(no_bukti,kode_lokasi){
		...
		nama_report="server_report_saku3_produk_rptBeli";
