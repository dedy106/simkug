window.app_saku3_report_produk_flJurnalReturJual = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flJurnalReturJual.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flJurnalReturJual";
		this.maximize();
...
window.app_saku3_report_produk_flJurnalReturJual.extend(window.childForm);
window.app_saku3_report_produk_flJurnalReturJual.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_produk_rptJurnalReturJual";
			...
			systemAPI.alert("[app_saku3_report_produk_flJurnalReturJual]::mainButtonClick:"+e);
		}
	},
