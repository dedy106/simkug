window.app_saku3_report_produk_flAngkatan = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flAngkatan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flAngkatan";
		this.maximize();
...
window.app_saku3_report_produk_flAngkatan.extend(window.childForm);
window.app_saku3_report_produk_flAngkatan.implement({
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							  this.filterRep.filterStr("kode_akt",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");
				this.showFilter = this.filterRep.showFilter(this.sg1);
				this.nama_report = "server_report_saku3_produk_rptAngkatan";
