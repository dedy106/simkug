window.app_saku3_report_produk_flProyekPiutangJurnalUnbil = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flProyekPiutangJurnalUnbil.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flProyekPiutangJurnalUnbil";
		this.maximize();
...
window.app_saku3_report_produk_flProyekPiutangJurnalUnbil.extend(window.childForm);
window.app_saku3_report_produk_flProyekPiutangJurnalUnbil.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_produk_flProyekPiutangJurnalUnbil]::mainButtonClick:"+e);
		}
	},
