// JavaScript Document
window.app_saku3_report_produk_flKbMasuk = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flKbMasuk.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flKbMasuk";
		this.maximize();
...
window.app_saku3_report_produk_flKbMasuk.extend(window.portalui_childForm);
window.app_saku3_report_produk_flKbMasuk.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_produk_rptKbMasuk";
				this.dbLib.execQuerySync(this.sql);	
