window.app_saku3_report_produk_flProyekPanjarSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flProyekPanjarSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flProyekPanjarSaldo";
		this.maximize();
...
window.app_saku3_report_produk_flProyekPanjarSaldo.extend(window.childForm);
window.app_saku3_report_produk_flProyekPanjarSaldo.implement({
		...
		try{			
			...
			if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Pengajuan",this.sg1, this.sg1.row, this.sg1.col,
												...
												new Array("a.no_pj","a.keterangan"),"and",new Array("No Bukti","Keterangan"));
			}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_produk_rptProyekPanjarSaldo";
			...
			systemAPI.alert("[app_saku3_report_produk_flProyekPanjarSaldo]::mainButtonClick:"+e);
		}
	},
