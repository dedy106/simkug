window.app_saku3_report_produk_flDiskonBrg = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flDiskonBrg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flDiskonBrg";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Kode Barang","All",""));
...
window.app_saku3_report_produk_flDiskonBrg.extend(window.childForm);
window.app_saku3_report_produk_flDiskonBrg.implement({
		...
		try{			
			...
			if (row ==1)
			{
				this.filterRep.ListDataSGFilter(this, "Data Barang",this.sg1, this.sg1.row, this.sg1.col,
												"select a.kode_barang,b.nama from brg_diskonjual_d a inner join brg_barang b on a.kode_barang=b.kode_barang ",
												"select count(a.kode_barang) from brg_diskonjual_d ",
												new Array("a.kode_barang","b.nama"),"where",new Array("kode","nama"));
			}
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.kode_barang",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");
			...
			systemAPI.alert("[app_saku3_report_produk_flDiskonBrg]::mainButtonClick:"+e);
		}
	},
