window.app_saku3_report_produk_flGlLabaRugi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flGlLabaRugi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flGlLabaRugi";
		this.maximize();
...
window.app_saku3_report_produk_flGlLabaRugi.extend(window.childForm);
window.app_saku3_report_produk_flGlLabaRugi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_produk_rptGlLabaRugi";
