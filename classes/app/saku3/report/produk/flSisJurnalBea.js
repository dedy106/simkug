window.app_saku3_report_produk_flSisJurnalBea = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flSisJurnalBea.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flSisJurnalBea";
		this.maximize();
...
window.app_saku3_report_produk_flSisJurnalBea.extend(window.childForm);
window.app_saku3_report_produk_flSisJurnalBea.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_produk_flSisJurnalBea]::mainButtonClick:"+e);
		}
	},
