window.app_saku3_report_produk_flStatGuru = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flStatGuru.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flStatGuru";
		this.maximize();
...
window.app_saku3_report_produk_flStatGuru.extend(window.childForm);
window.app_saku3_report_produk_flStatGuru.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_produk_rptStatGuru";
