window.app_saku3_report_produk_flKelas = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flKelas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flKelas";
		this.maximize();
...
window.app_saku3_report_produk_flKelas.extend(window.childForm);
window.app_saku3_report_produk_flKelas.implement({
		...
		try{			
			...
			if (row ==3)
			{
				this.filterRep.ListDataSGFilter(this, "Data Jurusan",this.sg1, this.sg1.row, this.sg1.col,
														  "select a.kode_jur, a.nama from sis_jur a  "+
														   this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(2,0)," where "),
														  "select count(a.kode_jur) from sis_jur a "+
														  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(2,0)," where "),
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_produk_rptKelas";
