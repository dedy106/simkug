window.app_saku3_report_produk_flBarang = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flBarang.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flBarang";
		this.maximize();
...
window.app_saku3_report_produk_flBarang.extend(window.childForm);
window.app_saku3_report_produk_flBarang.implement({
		...
		try{			
			...
			if (row ==2)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Barang",this.sg1, this.sg1.row, this.sg1.col,
														  "select a.kode_barang, a.nama from brg_barang a   "+filter,
														  "select count(a.kode_barang) from brg_barang a "+filter,
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.kode_klp",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("a.kode_barang",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
				this.filter2 = this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,0)+"/"+this.app._nikUser;
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_produk_rptBarang";
			...
			systemAPI.alert("[app_saku3_report_produk_flBarang]::mainButtonClick:"+e);
		}
	},
