window.app_saku3_report_produk_flGlArusKas = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flGlArusKas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flGlArusKas";
		this.maximize();
...
window.app_saku3_report_produk_flGlArusKas.extend(window.childForm);
window.app_saku3_report_produk_flGlArusKas.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,2)+"/"+this.app._nikUser+"/"+this.sg1.getCell(3,0);
				this.nama_report="server_report_saku3_produk_rptGlArusKas";
	...
	doOpenTb: function(kode_neraca,kode_lokasi){
		...
		this.link="1";
		filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.app._nikUser+"/1";
		filter="where a.kode_lokasi='"+kode_lokasi+"' and b.kode_neraca='"+kode_neraca+"' ";
		nama_report="server_report_saku3_gl_rptGlTbArusKas";
	...
	doOpenBb: function(kode_akun,kode_lokasi,periode){
		...
		nama_report="server_report_saku2_kopeg_sju_rptGlTbArusKas";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
