window.app_saku3_report_produk_flTcash = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flTcash.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flTcash";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Nomor Bukti Tcash","All",""));
...
window.app_saku3_report_produk_flTcash.extend(window.childForm);
window.app_saku3_report_produk_flTcash.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row ==	1)
			{
				this.filterRep.ListDataSGFilter(this, "Data Bukti Tcash",this.sg1, this.sg1.row, this.sg1.col,
														  "select no_bukti_t, ket from ktu_tcash_m "+
														   this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  "select count(no_bukti_t) from ktu_tcash_m "+
														  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  new Array("no_bukti_t","ket"),"and");
			}
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.no_bukti_t",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");
				this.filter2 = this.sg1.getCell(2,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_produk_rptTcash";
			...
			systemAPI.alert("[app_saku3_report_produk_flTcash]::mainButtonClick:"+e);
		}
	},
