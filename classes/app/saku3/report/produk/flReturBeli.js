window.app_saku3_report_produk_flReturBeli = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flReturBeli.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flReturBeli";
		this.maximize();
...
window.app_saku3_report_produk_flReturBeli.extend(window.childForm);
window.app_saku3_report_produk_flReturBeli.implement({
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("d.kode_gudang",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and")+
							this.filterRep.filterStr("a.no_bukti",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4),"and")+
							" and e.form = 'BRGRETBELI' ";
				this.filter2 = this.sg1.getCell(2,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_produk_rptReturBeli";
			...
			systemAPI.alert("[app_saku3_report_produk_flReturBeli]::mainButtonClick:"+e);
		}
	},
