window.app_saku3_report_produk_flProyekPiutangJurnalUnbill = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flProyekPiutangJurnalUnbill.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flProyekPiutangJurnalUnbill";
		this.maximize();
...
window.app_saku3_report_produk_flProyekPiutangJurnalUnbill.extend(window.childForm);
window.app_saku3_report_produk_flProyekPiutangJurnalUnbill.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_produk_rptProyekPiutangJurnalUnbill";
			...
			systemAPI.alert("[app_saku3_report_produk_flProyekPiutangJurnalUnbill]::mainButtonClick:"+e);
		}
	},
