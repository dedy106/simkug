window.app_saku3_report_produk_flStokOp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flStokOp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flStokOp";
		this.maximize();
...
window.app_saku3_report_produk_flStokOp.extend(window.childForm);
window.app_saku3_report_produk_flStokOp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_produk_rptStokOp";
			...
			systemAPI.alert("[app_saku3_report_produk_flStokOp]::mainButtonClick:"+e);
		}
	},
