// JavaScript Document
window.app_saku3_report_produk_flKbBuku = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_produk_flKbBuku.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_produk_flKbBuku";
		this.maximize();
...
window.app_saku3_report_produk_flKbBuku.extend(window.portalui_childForm);
window.app_saku3_report_produk_flKbBuku.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_produk_rptKbBuku";
				this.dbLib.execQuerySync(this.sql);	
