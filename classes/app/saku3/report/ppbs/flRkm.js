window.app_saku3_report_ppbs_flRkm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flRkm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flRkm";
		this.maximize();
...
window.app_saku3_report_ppbs_flRkm.extend(window.childForm);
window.app_saku3_report_ppbs_flRkm.implement({
		...
		try{			
			...
			if (row ==	1)
			{
				this.filterRep.ListDataSGFilter(this, "Data RKM",this.sg1, this.sg1.row, this.sg1.col,
														  "select kode_rkm, nama from agg_rkm "+
														   this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  "select count(kode_rkm) from agg_rkm "+
														  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_ppbs_rptRkm";
			...
			systemAPI.alert("[app_saku3_report_ppbs_flRkm]::mainButtonClick:"+e);
		}
	},
