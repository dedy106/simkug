window.app_saku3_report_ppbs_flPpKuotaPakai = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flPpKuotaPakai.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flPpKuotaPakai";
		this.maximize();
...
window.app_saku3_report_ppbs_flPpKuotaPakai.extend(window.childForm);
window.app_saku3_report_ppbs_flPpKuotaPakai.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_ppbs_rptPpKuotaPakai";
			...
			systemAPI.alert("[app_saku3_report_ppbs_flPpKuotaPakai]::mainButtonClick:"+e);
		}
	},
