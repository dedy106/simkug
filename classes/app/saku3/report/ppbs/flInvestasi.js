// JavaScript Document
window.app_saku3_report_ppbs_flInvestasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flInvestasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flInvestasi";
		this.maximize();
...
window.app_saku3_report_ppbs_flInvestasi.extend(window.portalui_childForm);
window.app_saku3_report_ppbs_flInvestasi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_ppbs_rptInvestasi";
