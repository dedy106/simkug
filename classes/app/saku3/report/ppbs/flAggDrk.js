window.app_saku3_report_ppbs_flAggDrk = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flAggDrk.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flAggDrk";
		this.maximize();
...
window.app_saku3_report_ppbs_flAggDrk.extend(window.childForm);
window.app_saku3_report_ppbs_flAggDrk.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_ppbs_flAggDrk]::mainButtonClick:"+e);
		}
	},
