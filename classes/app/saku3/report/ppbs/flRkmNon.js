window.app_saku3_report_ppbs_flRkmNon = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flRkmNon.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flRkmNon";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Kode RKM","All",""));
...
window.app_saku3_report_ppbs_flRkmNon.extend(window.childForm);
window.app_saku3_report_ppbs_flRkmNon.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row ==	1)
			{
				...
				"select kode_rkm, nama from agg_rkm where kode_pp is NULL",
				"select count(*) from agg_rkm where kode_pp is NULL",
				new Array("kode_rkm","nama"),"where",new Array("kode","nama"));
			}
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.kode_rkm",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
				...
				this.nama_report = "server_report_saku3_ppbs_rptRkmNon";
			...
			systemAPI.alert("[app_saku3_report_ppbs_flRkmNon]::mainButtonClick:"+e);
		}
	},
