// JavaScript Document
window.app_saku3_report_ppbs_flDwRkapRektor = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flDwRkapRektor.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flDwRkapRektor";
		this.maximize();
...
window.app_saku3_report_ppbs_flDwRkapRektor.extend(window.portalui_childForm);
window.app_saku3_report_ppbs_flDwRkapRektor.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_ppbs_rptDwRkapRektor";
