window.app_saku3_report_ppbs_flAggUsul = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flAggUsul.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flAggUsul";
		this.maximize();
...
window.app_saku3_report_ppbs_flAggUsul.extend(window.childForm);
window.app_saku3_report_ppbs_flAggUsul.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_ppbs_rptAggUsul";
			...
			systemAPI.alert("[app_saku3_report_ppbs_flAggUsul]::mainButtonClick:"+e);
		}
	},
