window.app_saku3_report_ppbs_flAggParamNilai = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flAggParamNilai.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flAggParamNilai";
		this.maximize();
...
window.app_saku3_report_ppbs_flAggParamNilai.extend(window.childForm);
window.app_saku3_report_ppbs_flAggParamNilai.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_ppbs_rptAggParamNilai";
			...
			systemAPI.alert("[app_saku3_report_ppbs_flAggParamNilai]::mainButtonClick:"+e);
		}
	},
