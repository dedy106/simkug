// JavaScript Document
window.app_saku3_report_ppbs_flDwRkapEval = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flDwRkapEval.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flDwRkapEval";
		this.maximize();
...
window.app_saku3_report_ppbs_flDwRkapEval.extend(window.portalui_childForm);
window.app_saku3_report_ppbs_flDwRkapEval.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_ppbs_rptDwRkapEval";
