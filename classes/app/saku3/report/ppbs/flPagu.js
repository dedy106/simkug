window.app_saku3_report_ppbs_flPagu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flPagu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flPagu";
		this.maximize();
...
window.app_saku3_report_ppbs_flPagu.extend(window.childForm);
window.app_saku3_report_ppbs_flPagu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_ppbs_rptPagu";
			...
			systemAPI.alert("[app_saku3_report_ppbs_flPagu]::mainButtonClick:"+e);
		}
	},
