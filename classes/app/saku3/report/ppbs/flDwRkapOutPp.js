// JavaScript Document
window.app_saku3_report_ppbs_flDwRkapOutPp = function(owner) {
    if (owner) {
        window.app_saku3_report_ppbs_flDwRkapOutPp.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_report_ppbs_flDwRkapOutPp";
        this.maximize();
...
window.app_saku3_report_ppbs_flDwRkapOutPp.extend(window.portalui_childForm);
window.app_saku3_report_ppbs_flDwRkapOutPp.implement({
        ...
        try {
            ...
            if (sender == this.app._mainForm.bBack) {
                ...
                if (this.link == "1") {
                    ...
                    this.nama_report = "server_report_saku3_ppbs_rptDwRkapOutPp";
    ...
    doOpenTb: function(kode_neraca, kode_lokasi) {
        ...
        this.link = "1";
        filter2 = this.sg1.getCell(2, 1) + "/" + this.sg1.getCell(2, 6) + "/" + this.sg1.getCell(2, 6) + "/T";;

        filter = " where c.kode_neraca='" + kode_neraca + "' and a.kode_lokasi='" + kode_lokasi + "' and a.tahun_gar='" + this.sg1.getCell(2, 1) + "' and c.kode_fs='" + this.sg1.getCell(2, 2) + "' and a.kode_pp='" + this.sg1.getCell(2, 5) + "'";
        this.nama_report = "server_report_saku3_ppbs_rptDwOutPp";
