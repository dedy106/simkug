window.app_saku3_report_ppbs_flRkmAkun = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flRkmAkun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flRkmAkun";
		this.maximize();
...
window.app_saku3_report_ppbs_flRkmAkun.extend(window.childForm);
window.app_saku3_report_ppbs_flRkmAkun.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_ppbs_rptRkmAkun";
			...
			systemAPI.alert("[app_saku3_report_ppbs_flRkmAkun]::mainButtonClick:"+e);
		}
	},
