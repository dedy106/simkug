// JavaScript Document
window.app_saku3_report_ppbs_flAggRkapInv = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flAggRkapInv.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flAggRkapInv";
		this.maximize();
...
window.app_saku3_report_ppbs_flAggRkapInv.extend(window.portalui_childForm);
window.app_saku3_report_ppbs_flAggRkapInv.implement({
