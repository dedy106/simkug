window.app_saku3_report_ppbs_flDrk = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flDrk.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flDrk";
		this.maximize();
...
window.app_saku3_report_ppbs_flDrk.extend(window.childForm);
window.app_saku3_report_ppbs_flDrk.implement({
		...
		try{			
			...
			if (row ==	4)
			{
				var filter=this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+
						...
						this.filterRep.filterStr("a.kode_program",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2)," and ")+
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.kode_rkm",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3)," and ")+
				...
				this.nama_report = "server_report_saku3_ppbs_rptDrk";
			...
			systemAPI.alert("[app_saku3_report_ppbs_flDrk]::mainButtonClick:"+e);
		}
	},
