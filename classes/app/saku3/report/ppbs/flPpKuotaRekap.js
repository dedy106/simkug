window.app_saku3_report_ppbs_flPpKuotaRekap = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flPpKuotaRekap.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flPpKuotaRekap";
		this.maximize();
...
window.app_saku3_report_ppbs_flPpKuotaRekap.extend(window.childForm);
window.app_saku3_report_ppbs_flPpKuotaRekap.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_ppbs_rptPpKuotaRekap";
			...
			systemAPI.alert("[app_saku3_report_ppbs_flPpKuotaRekap]::mainButtonClick:"+e);
		}
	},
