window.app_saku3_report_ppbs_flDrkNilai = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flDrkNilai.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flDrkNilai";
		this.maximize();
...
window.app_saku3_report_ppbs_flDrkNilai.extend(window.childForm);
window.app_saku3_report_ppbs_flDrkNilai.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_ppbs_rptDrkNilai";
			...
			systemAPI.alert("[app_saku3_report_ppbs_flDrkNilai]::mainButtonClick:"+e);
		}
	},
