window.app_saku3_report_ppbs_flAggUsulanRekap = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flAggUsulanRekap.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flAggUsulanRekap";
		this.maximize();
...
window.app_saku3_report_ppbs_flAggUsulanRekap.extend(window.childForm);
window.app_saku3_report_ppbs_flAggUsulanRekap.implement({
	...
	{		
		...
		else
		{
			...
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3],[2,0,3,0]);	
		}
		if (row == 1)
		{
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_ppbs_rptAggUsulanRekap";
			...
			systemAPI.alert("[app_saku3_report_ppbs_flAggUsulanRekap]::mainButtonClick:"+e);
		}
	},
