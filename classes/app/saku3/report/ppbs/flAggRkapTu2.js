// JavaScript Document
window.app_saku3_report_ppbs_flAggRkapTu2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flAggRkapTu2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flAggRkapTu2";
		this.maximize();
...
window.app_saku3_report_ppbs_flAggRkapTu2.extend(window.portalui_childForm);
window.app_saku3_report_ppbs_flAggRkapTu2.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct substring(tahun) from agg_tahun where kode_lokasi='"+this.app._lokasi+"' order by tahun desc",[this.sg1.columns.get(2).pickList]);
		}
		if (row == 3)
		{
			this.sg1.columns.get(2).pickList.clear();
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_ppbs_rptAggRkapTu2";
