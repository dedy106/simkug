window.app_saku3_report_ppbs_flPpKuotaPakaiRekap = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flPpKuotaPakaiRekap.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flPpKuotaPakaiRekap";
		this.maximize();
...
window.app_saku3_report_ppbs_flPpKuotaPakaiRekap.extend(window.childForm);
window.app_saku3_report_ppbs_flPpKuotaPakaiRekap.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_ppbs_rptPpKuotaPakaiRekap";
			...
			systemAPI.alert("[app_saku3_report_ppbs_flPpKuotaPakaiRekap]::mainButtonClick:"+e);
		}
	},
