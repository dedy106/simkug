// JavaScript Document
window.app_saku3_report_ppbs_flAggRkapTu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flAggRkapTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flAggRkapTu";
		this.maximize();
...
window.app_saku3_report_ppbs_flAggRkapTu.extend(window.portalui_childForm);
window.app_saku3_report_ppbs_flAggRkapTu.implement({
		...
		try
		{
			...
			if (sender == this.app._mainForm.bBack)
			{
				...
				if (this.link=="1")
				{
					...
					this.nama_report="server_report_saku3_ppbs_rptAggRkapTu";
