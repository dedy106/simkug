// JavaScript Document
window.app_saku3_report_ppbs_flAggRkapBidangTu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flAggRkapBidangTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flAggRkapBidangTu";
		this.maximize();
...
window.app_saku3_report_ppbs_flAggRkapBidangTu.extend(window.portalui_childForm);
window.app_saku3_report_ppbs_flAggRkapBidangTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_ppbs_rptAggRkapBidangTu";
	...
	doOpenTb: function(kode_neraca,kode_lokasi){
		...
		filter=" where b.kode_neraca='"+kode_neraca+"' and b.kode_lokasi='"+kode_lokasi+"' and substring(a.periode,1,4)='"+this.sg1.getCell(2,1)+"' and b.kode_fs='"+this.sg1.getCell(2,2)+"' ";
	...
	doOpenUsulan: function(kode_akun,kode_pp,kode_drk,kode_lokasi,tahun){
		...
		this.link="2";
		filter2 = tahun+"/";
		filter="where a.kode_akun='"+kode_akun+"' and a.kode_pp='"+kode_pp+"' and a.kode_drk='"+kode_drk+"' and a.tahun='"+tahun+"' ";
