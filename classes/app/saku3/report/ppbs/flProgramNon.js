window.app_saku3_report_ppbs_flProgramNon = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flProgramNon.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flProgramNon";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Kode Program","All",""));
...
window.app_saku3_report_ppbs_flProgramNon.extend(window.childForm);
window.app_saku3_report_ppbs_flProgramNon.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row ==	1)
			{
				...
				"select kode_program, nama from agg_program where kode_pp is NULL",
				"select count(*) from agg_program where kode_pp is NULL",
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.kode_program",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
				...
				this.nama_report = "server_report_saku3_ppbs_rptProgramNon";
			...
			systemAPI.alert("[app_saku3_report_ppbs_flProgramNon]::mainButtonClick:"+e);
		}
	},
