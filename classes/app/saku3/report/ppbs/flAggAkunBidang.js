window.app_saku3_report_ppbs_flAggAkunBidang = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flAggAkunBidang.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flAggAkunBidang";
		this.maximize();
...
window.app_saku3_report_ppbs_flAggAkunBidang.extend(window.childForm);
window.app_saku3_report_ppbs_flAggAkunBidang.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_ppbs_flAggAkunBidang]::mainButtonClick:"+e);
		}
	},
