window.app_saku3_report_ppbs_flAggUsulanProdi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flAggUsulanProdi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flAggUsulanProdi";
		this.maximize();
...
window.app_saku3_report_ppbs_flAggUsulanProdi.extend(window.childForm);
window.app_saku3_report_ppbs_flAggUsulanProdi.implement({
	...
	{		
		...
		else
		{
			...
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2],[2,0,3]);	
		}
		if (row == 1)
		{
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_ppbs_rptAggUsulanProdi";
			...
			systemAPI.alert("[app_saku3_report_ppbs_flAggUsulanProdi]::mainButtonClick:"+e);
		}
	},
