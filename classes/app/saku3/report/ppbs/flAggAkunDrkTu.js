window.app_saku3_report_ppbs_flAggAkunDrkTu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flAggAkunDrkTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flAggAkunDrkTu";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,5,[0,1,2],["Periodik Laporan","=","Bulanan"]);
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
	
};
window.app_saku3_report_ppbs_flAggAkunDrkTu.extend(window.childForm);
window.app_saku3_report_ppbs_flAggAkunDrkTu.implement({
	...
	doSelectCell: function(sender, col, row){
		if (this.app._userStatus=="A")
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5],["123","3","123","123","123","3"]);
		...
		else
		{
			...
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5],[2,0,2,3,2,0]);
		}
		if (row == 1)
		{
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2=this.sg1.getCell(2,1)+"/"+this.app._namaForm;
				...
				{
					this.nama_report = "server_report_saku2_kopeg_ppbs_rptAggTw";
				}
	...
	doOpenUsulan: function(kode_akun,kode_pp,kode_drk,kode_lokasi,tahun){
		...
		this.nama_report="server_report_saku3_ppbs_rptAggUsulanRincianYpt";
