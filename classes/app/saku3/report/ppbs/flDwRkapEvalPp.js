// JavaScript Document
window.app_saku3_report_ppbs_flDwRkapEvalPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flDwRkapEvalPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flDwRkapEvalPp";
		this.maximize();
...
window.app_saku3_report_ppbs_flDwRkapEvalPp.extend(window.portalui_childForm);
window.app_saku3_report_ppbs_flDwRkapEvalPp.implement({
		...
		try
		{
			...
			if (sender == this.app._mainForm.bBack)
			{
				...
				if (this.link=="1")
				{
					...
					this.nama_report = "server_report_saku3_ppbs_rptDwRkapPp";
			...
			else
			{
				...
				this.filter=this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("kode_pp",this.sg1.getCell(1,5),this.sg1.getCell(2,5),this.sg1.getCell(3,5),"and")+
							this.filterRep.filterStr("tahun",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");
						
				
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,2)+"/"+this.sg1.getCell(2,3)+"/"+this.sg1.getCell(2,4)+"/"+this.sg1.getCell(2,5)+"/"+this.app._nikUser;
				this.nama_report="server_report_saku3_ppbs_rptDwRkapEvalPp";
