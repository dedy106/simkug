window.app_saku3_report_ppbs_flRuang = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flRuang.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flRuang";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Kode Gedung","All",""));
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Kode Ruang","All",""));
...
window.app_saku3_report_ppbs_flRuang.extend(window.childForm);
window.app_saku3_report_ppbs_flRuang.implement({
	doEllipseClick: function(sender, col, row){
		try{			
            ...
            if (row ==	2)
			{
				this.filterRep.ListDataSGFilter(this, "Data Ruang",this.sg1, this.sg1.row, this.sg1.col,
														  "select kode_ruang, nama from log_ruang "+
														   this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+this.filterRep.filterStr("kode_gedung",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1)," and "),
														  "select count(kode_ruang) from log_ruang "+
														  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+this.filterRep.filterStr("kode_gedung",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1)," and "),
														  new Array("kode_ruang","nama"),"and");
			}
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.kode_ruang",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
				this.filter2 = this.sg1.getCell(2,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_ppbs_rptRuang";
			...
			systemAPI.alert("[app_saku3_report_ppbs_flRuang]::mainButtonClick:"+e);
		}
	},
