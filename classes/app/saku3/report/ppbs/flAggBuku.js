window.app_saku3_report_ppbs_flAggBuku = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flAggBuku.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flAggBuku";
		this.maximize();
...
window.app_saku3_report_ppbs_flAggBuku.extend(window.childForm);
window.app_saku3_report_ppbs_flAggBuku.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_ppbs_rptAggBuku";
			...
			systemAPI.alert("[app_saku3_report_ppbs_flAggBuku]::mainButtonClick:"+e);
		}
	},
