// JavaScript Document
window.app_saku3_report_ppbs_flDwRkapEvalBidang = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flDwRkapEvalBidang.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flDwRkapEvalBidang";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,5,[0,1,2],["Kode Bidang","=",this.pp]);
...
window.app_saku3_report_ppbs_flDwRkapEvalBidang.extend(window.portalui_childForm);
window.app_saku3_report_ppbs_flDwRkapEvalBidang.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		this.filterRep.setSGFilterRowTipe(this.sg1, row,new Array(0,1,2,3,4,5),new  Array("123","123","123","3","3","123"));
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,new Array(0,1,2,3,4,5),new  Array(2,0,2,0,0,2));
		...
		try
		{
			...
			else
			{
				...
				this.filter=this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("kode_bidang",this.sg1.getCell(1,6),this.sg1.getCell(2,6),this.sg1.getCell(3,6),"and")+
							this.filterRep.filterStr("tahun",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");
				...
				this.nama_report="server_report_saku3_ppbs_rptDwRkapEvalBidang";
