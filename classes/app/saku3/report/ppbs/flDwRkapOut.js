// JavaScript Document
window.app_saku3_report_ppbs_flDwRkapOut = function(owner) {
    if (owner) {
        window.app_saku3_report_ppbs_flDwRkapOut.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_report_ppbs_flDwRkapOut";
        this.maximize();
...
window.app_saku3_report_ppbs_flDwRkapOut.extend(window.portalui_childForm);
window.app_saku3_report_ppbs_flDwRkapOut.implement({
    ...
    doSelectCell: function(sender, col, row) {
        ...
        if (row == 1) {
            ...
            this.dbLib.setItemsFromSQL("select tahun from agg_tahun where kode_lokasi='" + this.app._lokasi + "' order by periode desc", [this.sg1.columns.get(2).pickList]);
        }
        if (row == 3) {
            this.sg1.columns.get(2).pickList.clear();
    ...
    mainButtonClick: function(sender) {
        try {
            ...
            if (sender == this.app._mainForm.bBack) {
                ...
                this.nama_report = "server_report_saku3_ppbs_rptDwRkapOut";
    ...
    doOpenTb: function(kode_neraca, kode_lokasi) {
        ...
        filter = " where c.kode_neraca='" + kode_neraca + "' and a.kode_lokasi='" + kode_lokasi + "' and a.tahun_gar='" + this.sg1.getCell(2, 1) + "' and c.kode_fs='" + this.sg1.getCell(2, 2) + "' ";
