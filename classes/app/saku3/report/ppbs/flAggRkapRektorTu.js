// JavaScript Document
window.app_saku3_report_ppbs_flAggRkapRektorTu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flAggRkapRektorTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flAggRkapRektorTu";
		this.maximize();
...
window.app_saku3_report_ppbs_flAggRkapRektorTu.extend(window.portalui_childForm);
window.app_saku3_report_ppbs_flAggRkapRektorTu.implement({
	doEllipseClick: function(sender, col, row){
		...
		if (row ==5)
		{
			this.filterRep.ListDataSGFilter(this, "Data Rektorat",this.sg1, this.sg1.row, this.sg1.col,
													  ...
													  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+"  ",
													  "select count(*) from agg_rektor "+
													  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+"  ",
													  new Array("kode_rektor","nama"),"and");
		}
	},
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_ppbs_rptAggRkapRektorTu";
