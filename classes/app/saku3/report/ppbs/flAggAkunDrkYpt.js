window.app_saku3_report_ppbs_flAggAkunDrkYpt = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flAggAkunDrkYpt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flAggAkunDrkYpt";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,5,[0,1,2],["Jenis Laporan","=","Rekap"]);
	this.gridLib.SGEditData(this.sg1,6,new Array(0,1,2), new Array("Output Laporan","=","Layar"));
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
	
};
window.app_saku3_report_ppbs_flAggAkunDrkYpt.extend(window.childForm);
window.app_saku3_report_ppbs_flAggAkunDrkYpt.implement({
	...
	doSelectCell: function(sender, col, row){
		if (this.app._userStatus=="A")
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6],["123","3","123","123","123","3","3"]);
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5,6],[2,0,2,2,2,0,0]);
		}
		else
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6],["123","3","123","3","123","3","3"]);
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5,6],[2,0,2,3,2,0,0]);
		}
		if (row == 1)
		{
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_ppbs_rptAggAkunDrkYpt";
				if (this.sg1.getCell(2,5)=="Detail")
				{
					this.nama_report = "server_report_saku3_ppbs_rptAggAkunDrkYptDetail";
				}
