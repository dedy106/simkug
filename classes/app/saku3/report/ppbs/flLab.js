window.app_saku3_report_ppbs_flLab = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flLab.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flLab";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Kode Lab","All",""));
...
window.app_saku3_report_ppbs_flLab.extend(window.childForm);
window.app_saku3_report_ppbs_flLab.implement({
	doEllipseClick: function(sender, col, row){
		try{			
            ...
            if (row ==	2)
			{
				this.filterRep.ListDataSGFilter(this, "Data Lab",this.sg1, this.sg1.row, this.sg1.col,
														  "select kode_lab, nama from log_lab "+
														   this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+this.filterRep.filterStr("kode_pp",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1)," and "),
														  "select count(kode_lab) from log_lab "+
														  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+this.filterRep.filterStr("kode_pp",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1)," and "),
														  new Array("kode_lab","nama"),"and");
			}
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.kode_lab",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
				this.filter2 = this.sg1.getCell(2,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_ppbs_rptLab";
			...
			systemAPI.alert("[app_saku3_report_ppbs_flLab]::mainButtonClick:"+e);
		}
	},
