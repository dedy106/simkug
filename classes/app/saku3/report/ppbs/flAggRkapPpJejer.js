// JavaScript Document
window.app_saku3_report_ppbs_flAggRkapPpJejer = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flAggRkapPpJejer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flAggRkapPpJejer";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,6,[0,1,2],["Kode Bidang","All",""]);
...
window.app_saku3_report_ppbs_flAggRkapPpJejer.extend(window.portalui_childForm);
window.app_saku3_report_ppbs_flAggRkapPpJejer.implement({
	doEllipseClick: function(sender, col, row){
		...
		if (row ==7)
		{
			...
			else
			{
				this.filterRep.ListDataSGFilter(this, "Data PP",this.sg1, this.sg1.row, this.sg1.col,
													  "select kode_pp, nama from agg_pp "+
													  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+" and kode_pp='"+this.pp+"' ",
													  "select count(*) from agg_pp "+
													  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+" and kode_pp='"+this.pp+"' ",
													  new Array("kode_pp","nama"),"and");
			}
		...
		if (row == 5)
		{
			this.filterRep.ListDataSGFilter(this, "Data Rektorat",this.sg1, this.sg1.row, this.sg1.col,
													  "select kode_rektor,nama from agg_rektor "+
													  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
													  "select count(kode_rektor) from agg_rektor "+
													  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
	...
	doSelectCell: function(sender, col, row){
		if (this.app._userStatus=="A")
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,new Array(0,1,2,3,4,5,6,7,8),new  Array("123","123","123","3","3","123","123","123","3"));
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,new Array(0,1,2,3,4,5,6,7,8),new  Array(2,0,2,0,0,2,2,2,0));
		}
		else
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,new Array(0,1,2,3,4,5,6,7,8),new  Array("123","123","123","3","3","3","3","3","3"));
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,new Array(0,1,2,3,4,5,6,7,8),new  Array(2,0,2,0,0,3,3,3,0));
		}
		if (row == 1)
		{
		...
		try
		{
			...
			else
			{
				...
				this.filter=this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("b.kode_rektor",this.sg1.getCell(1,5),this.sg1.getCell(2,5),this.sg1.getCell(3,5),"and")+
							this.filterRep.filterStr("b.kode_bidang",this.sg1.getCell(1,6),this.sg1.getCell(2,6),this.sg1.getCell(3,6),"and")+
							this.filterRep.filterStr("a.kode_pp",this.sg1.getCell(1,7),this.sg1.getCell(2,7),this.sg1.getCell(3,7),"and");
						
				this.filter2 = this.nik_user+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,4)+"/"+this.sg1.getCell(2,3)+"/"+this.sg1.getCell(2,2)+"/"+this.kode_lokasi+"/"+this.sg1.getCell(2,8);
				
				this.nama_report="server_report_saku3_ppbs_rptAggRkapPpJejer";
