window.app_saku3_report_ppbs_flAggAkunTu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flAggAkunTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flAggAkunTu";
		this.maximize();
...
window.app_saku3_report_ppbs_flAggAkunTu.extend(window.childForm);
window.app_saku3_report_ppbs_flAggAkunTu.implement({
