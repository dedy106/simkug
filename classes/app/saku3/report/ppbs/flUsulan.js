window.app_saku3_report_ppbs_flUsulan = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flUsulan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flUsulan";
		this.maximize();
...
window.app_saku3_report_ppbs_flUsulan.extend(window.childForm);
window.app_saku3_report_ppbs_flUsulan.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_ppbs_rptUsulan";
			...
			systemAPI.alert("[app_saku3_report_ppbs_flUsulan]::mainButtonClick:"+e);
		}
	},
