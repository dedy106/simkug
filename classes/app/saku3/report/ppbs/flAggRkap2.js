window.app_saku3_report_ppbs_flAggRkap2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flAggRkap2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flAggRkap2";
		this.maximize();
...
window.app_saku3_report_ppbs_flAggRkap2.extend(window.childForm);
window.app_saku3_report_ppbs_flAggRkap2.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_ppbs_flAggRkap2]::mainButtonClick:"+e);
		}
	},
