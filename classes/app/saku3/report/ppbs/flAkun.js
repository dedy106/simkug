window.app_saku3_report_ppbs_flAkun = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flAkun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flAkun";
		this.maximize();
...
window.app_saku3_report_ppbs_flAkun.extend(window.childForm);
window.app_saku3_report_ppbs_flAkun.implement({
	...
	{		
		...
		if (row == 2)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct tahun as periode from agg_usul_m "+
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.filterRep.filterStr("x.kode_akun",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
				this.filterRep.filterStr("y.tahun",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
							
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,2);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_ppbs_rptAkun";
			...
			systemAPI.alert("[app_saku3_report_ppbs_flAkun]::mainButtonClick:"+e);
		}
	},
