window.app_saku3_report_ppbs_flPpKuotaRekapAkun = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flPpKuotaRekapAkun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flPpKuotaRekapAkun";
		this.maximize();
...
window.app_saku3_report_ppbs_flPpKuotaRekapAkun.extend(window.childForm);
window.app_saku3_report_ppbs_flPpKuotaRekapAkun.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_ppbs_rptPpKuotaRekapAkun";
			...
			systemAPI.alert("[app_saku3_report_ppbs_flPpKuotaRekapAkun]::mainButtonClick:"+e);
		}
	},
