// JavaScript Document
window.app_saku3_report_ppbs_flDwRkap = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flDwRkap.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flDwRkap";
		this.maximize();
...
window.app_saku3_report_ppbs_flDwRkap.extend(window.portalui_childForm);
window.app_saku3_report_ppbs_flDwRkap.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,2)+"/"+this.sg1.getCell(2,3)+"/"+this.sg1.getCell(2,4)+"/"+this.app._nikUser;
				
				this.nama_report="server_report_saku3_ppbs_rptDwRkap";
