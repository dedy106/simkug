window.app_saku3_report_ppbs_flAggAkun = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flAggAkun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flAggAkun";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,[0,1,2],["Jenis Laporan","=","Lokasi"]);
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
	
};
window.app_saku3_report_ppbs_flAggAkun.extend(window.childForm);
window.app_saku3_report_ppbs_flAggAkun.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				{
					var sql =  "select a.kode_akun,a.nama_akun,a.kode_lokasi,a.nama_lokasi,a.agg_01,a.agg_02,a.agg_03,a.agg_04,a.agg_05,a.agg_06,a.agg_07,a.agg_08,a.agg_09,a.agg_10,a.agg_11,a.agg_12,a.agg_total "+
							"from (select a.kode_akun,f.nama as nama_akun,zz.kode_lokasi,zz.nama as nama_lokasi, "+
							...
							"inner join neracagar c on b.kode_neraca=c.kode_neraca and b.kode_lokasi=c.kode_lokasi "+
							"order by c.rowindex,a.kode_akun ";	
					...
					this.title = new server_util_arrayList({items:["Kode Akun","Nama Akun","Kode Lok","Nama Lokasi","Januari","Februari","Maret","April","Mei","Juni","Juli","Agustus","September","Oktober","November","Desember","Total"]});
				...
				{
					var sql =  "select a.kode_akun,a.nama_akun,a.kode_lokasi,a.nama_lokasi,a.agg_01,a.agg_02,a.agg_03,a.agg_04,a.agg_total "+
							"from (select a.kode_akun,f.nama as nama_akun,zz.kode_lokasi,zz.nama as nama_lokasi, "+
			...
			systemAPI.alert("[app_saku3_report_ppbs_flAggAkun]::mainButtonClick:"+e);
		}
	},
