// JavaScript Document
window.app_saku3_report_ppbs_flAggRkapInvOutTu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flAggRkapInvOutTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flAggRkapInvOutTu";
		this.maximize();
...
window.app_saku3_report_ppbs_flAggRkapInvOutTu.extend(window.portalui_childForm);
window.app_saku3_report_ppbs_flAggRkapInvOutTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_ppbs_rptAggRkapInvOutTu";
