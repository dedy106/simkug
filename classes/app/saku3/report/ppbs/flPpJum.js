window.app_saku3_report_ppbs_flPpJum = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flPpJum.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flPpJum";
		this.maximize();
...
window.app_saku3_report_ppbs_flPpJum.extend(window.childForm);
window.app_saku3_report_ppbs_flPpJum.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_ppbs_rptPpJum";
			...
			systemAPI.alert("[app_saku3_report_ppbs_flPpJum]::mainButtonClick:"+e);
		}
	},
