window.app_saku3_report_ppbs_flPaDrk = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flPaDrk.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flPaDrk";
		this.maximize();
...
window.app_saku3_report_ppbs_flPaDrk.extend(window.childForm);
window.app_saku3_report_ppbs_flPaDrk.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,4)+"/"+this.sg1.getCell(2,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_ppbs_rptPaDrk";
			...
			systemAPI.alert("[app_saku3_report_ppbs_flPaDrk]::mainButtonClick:"+e);
		}
	},
