// JavaScript Document
window.app_saku3_report_ppbs_flDwRkapBudget = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flDwRkapBudget.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flDwRkapBudget";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,0,new Array(0,1,2), new Array("Lokasi","=","20"));
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Tahun","=",this.periode));
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Output","=","layar"));
...
window.app_saku3_report_ppbs_flDwRkapBudget.extend(window.portalui_childForm);
window.app_saku3_report_ppbs_flDwRkapBudget.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_ppbs_rptDwRkapBudget";
