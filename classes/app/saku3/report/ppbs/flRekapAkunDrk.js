window.app_saku3_report_ppbs_flRekapAkunDrk = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flRekapAkunDrk.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flRekapAkunDrk";
		this.maximize();
...
window.app_saku3_report_ppbs_flRekapAkunDrk.extend(window.childForm);
window.app_saku3_report_ppbs_flRekapAkunDrk.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				{
					this.nama_report = "server_report_saku3_ppbs_rptRekapAkunDrk";
				}
				else
				{
