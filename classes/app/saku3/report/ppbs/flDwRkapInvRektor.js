// JavaScript Document
window.app_saku3_report_ppbs_flDwRkapInvRektor = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flDwRkapInvRektor.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flDwRkapInvRektor";
		this.maximize();
	...
	this.pp=this.dbLib.getPeriodeFromSQL("select c.kode_rektor as periode from agg_user a "+
	...
	this.gridLib.SGEditData(this.sg1,5,[0,1,2],["Kode Rektor","=",this.pp]);
...
window.app_saku3_report_ppbs_flDwRkapInvRektor.extend(window.portalui_childForm);
window.app_saku3_report_ppbs_flDwRkapInvRektor.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2 = this.nik_user+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,4)+"/"+this.sg1.getCell(2,3)+"/"+this.sg1.getCell(2,2)+"/"+this.kode_lokasi;
				
				this.nama_report="server_report_saku3_ppbs_rptDwRkapInvRektor";
