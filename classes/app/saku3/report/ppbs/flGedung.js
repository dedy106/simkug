window.app_saku3_report_ppbs_flGedung = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flGedung.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flGedung";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Kode Klp","All",""));
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Kode Gedung","All",""));
...
window.app_saku3_report_ppbs_flGedung.extend(window.childForm);
window.app_saku3_report_ppbs_flGedung.implement({
            ...
            if (row ==	2)
			{
				this.filterRep.ListDataSGFilter(this, "Data Gedung",this.sg1, this.sg1.row, this.sg1.col,
														  "select kode_gedung, nama from log_gedung "+
														   this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+this.filterRep.filterStr("kode_klp",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1)," and "),
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_ppbs_rptGedung";
			...
			systemAPI.alert("[app_saku3_report_ppbs_flGedung]::mainButtonClick:"+e);
		}
	},
