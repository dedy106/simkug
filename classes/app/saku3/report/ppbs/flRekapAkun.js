window.app_saku3_report_ppbs_flRekapAkun = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flRekapAkun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flRekapAkun";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,[0,1,2],["Jenis Akun","=","Investasi"]);
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
	
};
window.app_saku3_report_ppbs_flRekapAkun.extend(window.childForm);
window.app_saku3_report_ppbs_flRekapAkun.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			if (sender == this.app._mainForm.bBack)
			{
				...
				if (this.link=="2")
				{
					this.doOpenTbDrk(this.kode_neraca,this.kode_lokasi);
				}
			...
			else
			{
				...
				if (this.sg1.getCell(1,4)!="All")
				{
					...
					{
						jenis=" and c.jenis='Neraca' ";
					}
					else
					{
						jenis=" and c.jenis='"+this.sg1.getCell(2,4)+"' ";
					}
				}
		    	this.filter =  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where") +
							  ...
							  this.filterRep.filterStr("a.kode_akun",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+jenis;
				...
				{
					this.nama_report = "server_report_saku3_ppbs_rptRekapAkun";
				}
				else
				{
					this.nama_report = "server_report_saku3_ppbs_rptAggTw";
				}
