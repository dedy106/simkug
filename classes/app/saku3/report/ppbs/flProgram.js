window.app_saku3_report_ppbs_flProgram = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flProgram.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flProgram";
		this.maximize();
...
window.app_saku3_report_ppbs_flProgram.extend(window.childForm);
window.app_saku3_report_ppbs_flProgram.implement({
		...
		try{			
			...
			if (row ==	1)
			{
				this.filterRep.ListDataSGFilter(this, "Data Program",this.sg1, this.sg1.row, this.sg1.col,
														  "select kode_program, nama from agg_program "+
														   this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  "select count(kode_program) from agg_program "+
														  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_ppbs_rptProgram";
			...
			systemAPI.alert("[app_saku3_report_ppbs_flProgram]::mainButtonClick:"+e);
		}
	},
