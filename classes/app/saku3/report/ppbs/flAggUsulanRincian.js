window.app_saku3_report_ppbs_flAggUsulanRincian = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flAggUsulanRincian.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flAggUsulanRincian";
		this.maximize();
...
window.app_saku3_report_ppbs_flAggUsulanRincian.extend(window.childForm);
window.app_saku3_report_ppbs_flAggUsulanRincian.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_ppbs_flAggUsulanRincian]::mainButtonClick:"+e);
		}
	},
