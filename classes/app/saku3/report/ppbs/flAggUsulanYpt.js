window.app_saku3_report_ppbs_flAggUsulanYpt = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flAggUsulanYpt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flAggUsulanYpt";
		this.maximize();
...
window.app_saku3_report_ppbs_flAggUsulanYpt.extend(window.childForm);
window.app_saku3_report_ppbs_flAggUsulanYpt.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_ppbs_flAggUsulanYpt]::mainButtonClick:"+e);
		}
	},
