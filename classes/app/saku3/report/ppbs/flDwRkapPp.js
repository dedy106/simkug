// JavaScript Document
window.app_saku3_report_ppbs_flDwRkapPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flDwRkapPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flDwRkapPp";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select tahun as periode from agg_tahun where kode_lokasi='"+this.app._lokasi+"' ");
...
window.app_saku3_report_ppbs_flDwRkapPp.extend(window.portalui_childForm);
window.app_saku3_report_ppbs_flDwRkapPp.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select tahun from agg_tahun where kode_lokasi='"+this.app._lokasi+"' order by tahun desc",[this.sg1.columns.get(2).pickList]);
		}
		if (row == 3)
		{
			this.sg1.columns.get(2).pickList.clear();
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,2)+"/"+this.sg1.getCell(2,3)+"/"+this.sg1.getCell(2,4)+"/"+this.sg1.getCell(2,5)+"/"+this.app._nikUser+"/"+this.sg1.getCell(2,6);
				this.nama_report="server_report_saku3_ppbs_rptDwRkapPp";
