window.app_saku3_report_ppbs_flAggPpTu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flAggPpTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flAggPpTu";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,[0,1,2],["Kode PP","=",this.pp]);
...
window.app_saku3_report_ppbs_flAggPpTu.extend(window.childForm);
window.app_saku3_report_ppbs_flAggPpTu.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4],["123","3","3","123","123"]);
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4],[2,0,3,0,0]);
		}
		if (row == 1)
		{
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter =  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where") +
							  ...
							  this.filterRep.filterStr("a.kode_pp",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+jenis;
				...
				{
					this.nama_report = "server_report_saku3_ppbs_rptAggPpTu";
				}
				else
				{
