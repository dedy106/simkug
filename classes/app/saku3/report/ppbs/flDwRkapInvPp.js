// JavaScript Document
window.app_saku3_report_ppbs_flDwRkapInvPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flDwRkapInvPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flDwRkapInvPp";
		this.maximize();
...
window.app_saku3_report_ppbs_flDwRkapInvPp.extend(window.portalui_childForm);
window.app_saku3_report_ppbs_flDwRkapInvPp.implement({
		...
		try
		{
			...
			if (sender == this.app._mainForm.bBack)
			{
				...
				if (this.link=="1")
				{
					...
					this.nama_report = "server_report_saku3_ppbs_rptDwRkapInvPp";
