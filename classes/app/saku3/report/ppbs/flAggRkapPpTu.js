// JavaScript Document
window.app_saku3_report_ppbs_flAggRkapPpTu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ppbs_flAggRkapPpTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ppbs_flAggRkapPpTu";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,7,[0,1,2],["Kode PP","=",this.pp]);
...
window.app_saku3_report_ppbs_flAggRkapPpTu.extend(window.portalui_childForm);
window.app_saku3_report_ppbs_flAggRkapPpTu.implement({
		...
		try
		{
			...
			if (sender == this.app._mainForm.bBack)
			{
				...
				if (this.link=="1")
				{
					...
					this.nama_report = "server_report_saku2_kopeg_ppbs_rptAggRkap";
			...
			else
			{
				...
				this.nama_report="server_report_saku3_ppbs_rptAggRkapPpTu";
	...
	doOpenTb: function(kode_neraca,kode_lokasi){
		...
		filter=" where b.kode_neraca='"+kode_neraca+"' and b.kode_lokasi='"+kode_lokasi+"' and substring(a.periode,1,4)='"+this.sg1.getCell(2,1)+"' and b.kode_fs='"+this.sg1.getCell(2,2)+"' and a.kode_pp='"+this.sg1.getCell(2,7)+"'";
	...
	doOpenTbDrk: function(kode_akun,kode_lokasi){
		...
		filter=" where a.kode_akun='"+kode_akun+"' and a.kode_lokasi='"+kode_lokasi+"' and substring(a.periode,1,4)='"+this.sg1.getCell(2,1)+"' and a.kode_pp='"+this.sg1.getCell(2,7)+"'";
	...
	doOpenUsulan: function(kode_akun,kode_pp,kode_drk,kode_lokasi,tahun){
		...
		this.link="2";
		filter2 = tahun+"/";
		filter="where a.kode_akun='"+kode_akun+"' and a.kode_pp='"+kode_pp+"' and a.kode_drk='"+kode_drk+"' and a.tahun='"+tahun+"' and a.kode_pp='"+this.sg1.getCell(2,7)+"'";
