window.app_saku3_report_rra_flAggPdrk = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_rra_flAggPdrk.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_rra_flAggPdrk";
		this.maximize();
...
window.app_saku3_report_rra_flAggPdrk.extend(window.portalui_childForm);
window.app_saku3_report_rra_flAggPdrk.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_rra_rptAggPdrkS";	
