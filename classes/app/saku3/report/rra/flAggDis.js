window.app_saku3_report_rra_flAggDis = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_rra_flAggDis.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_rra_flAggDis";
		this.maximize();
...
window.app_saku3_report_rra_flAggDis.extend(window.portalui_childForm);
window.app_saku3_report_rra_flAggDis.implement({
