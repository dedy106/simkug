window.app_saku3_report_rra_flAggDisPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_rra_flAggDisPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_rra_flAggDisPos";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,[0,1,2],["Kode PP","=",this.app._kodePP]);
...
window.app_saku3_report_rra_flAggDisPos.extend(window.portalui_childForm);
window.app_saku3_report_rra_flAggDisPos.implement({
		...
		if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Invoice",this.sg1, this.sg1.row, this.sg1.col,
												...
												"select count(a.no_pdrk) from rra_pdrk_m a "+this.filter,
	...
	doSelectCell: function(sender, col, row){
		...
		if (row == 2)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from rra_pdrk_m "+
	...
	doOpenBukti: function(no_bukti,kode_lokasi){
		...
		filter2="";
		nama_report="server_report_saku3_rra_rptAggDis";
