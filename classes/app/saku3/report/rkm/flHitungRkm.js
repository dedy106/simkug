window.app_saku3_report_rkm_flHitungRkm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_rkm_flHitungRkm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_rkm_flHitungRkm";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,6,[0,1,2],["Periodik Laporan","=","Triwulan I"]);
...
window.app_saku3_report_rkm_flHitungRkm.extend(window.childForm);
window.app_saku3_report_rkm_flHitungRkm.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row ==4)
			{
				this.filterRep.ListDataSGFilter(this, "Data IP",this.sg1, this.sg1.row, this.sg1.col,
												"select kode_ip,nama from rkm_ip ",
												"select count(*) from rkm_ip ",
												new Array("kode_ip","nama"),"where",new Array("Kode IP","Nama"));
			}			
	...
	{		
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,["Triwulan I","Triwulan II","Triwulan III","Triwulan IV"]);
		}
	},
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("x.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("x.kode_ip",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4),"and")+jenis;
							
				var filter3 = this.filterRep.filterStr("x.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("substring(x.periode,1,4)",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("x.kode_akun",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
							this.filterRep.filterStr("x.kode_pp",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and")+
							this.filterRep.filterStr("x.kode_drk",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4),"and")+jenis;
							
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+filter3+"/"+this.sg1.getCell(2,6);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_rkm_rptHitungRkm";
			...
			systemAPI.alert("[app_saku3_report_rkm_flHitungRkm]::mainButtonClick:"+e);
		}
	},
