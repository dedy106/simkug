window.app_saku3_report_rkm_flRkmTs = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_rkm_flRkmTs.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_rkm_flRkmTs";
		this.maximize();
...
window.app_saku3_report_rkm_flRkmTs.extend(window.childForm);
window.app_saku3_report_rkm_flRkmTs.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_rkm_rptRkmTs";
			...
			systemAPI.alert("[app_saku3_report_rkm_flRkmTs]::mainButtonClick:"+e);
		}
	},
