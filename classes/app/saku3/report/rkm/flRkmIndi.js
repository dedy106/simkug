window.app_saku3_report_rkm_flRkmIndi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_rkm_flRkmIndi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_rkm_flRkmIndi";
		this.maximize();
	...
	this.tahun=this.dbLib.getPeriodeFromSQL("select max(tahun) as periode from rkm_ip where kode_lokasi='"+this.app._lokasi+"' ");
...
window.app_saku3_report_rkm_flRkmIndi.extend(window.childForm);
window.app_saku3_report_rkm_flRkmIndi.implement({
	...
	{		
		...
		if (row == 1)
		{
			this.dbLib.setItemsFromSQL("select distinct tahun from rkm_ip a "+
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_rkm_rptRkmIndi";
			...
			systemAPI.alert("[app_saku3_report_rkm_flRkmIndi]::mainButtonClick:"+e);
		}
	},
