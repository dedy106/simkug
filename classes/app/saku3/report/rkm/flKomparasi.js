window.app_saku3_report_rkm_flKomparasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_rkm_flKomparasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_rkm_flKomparasi";
		this.maximize();
...
window.app_saku3_report_rkm_flKomparasi.extend(window.childForm);
window.app_saku3_report_rkm_flKomparasi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+filter3;
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_rkm_rptKomparasi";
			...
			systemAPI.alert("[app_saku3_report_rkm_flKomparasi]::mainButtonClick:"+e);
		}
	},
