window.app_saku3_report_rkm_flRkmPu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_rkm_flRkmPu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_rkm_flRkmPu";
		this.maximize();
	...
	this.tahun=this.dbLib.getPeriodeFromSQL("select max(tahun) as periode from rkm_Pu where kode_lokasi='"+this.app._lokasi+"' ");
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Bidang","All",""));
...
window.app_saku3_report_rkm_flRkmPu.extend(window.childForm);
window.app_saku3_report_rkm_flRkmPu.implement({
	...
	{		
		...
		if (row == 1)
		{
			this.dbLib.setItemsFromSQL("select distinct tahun from rkm_pu a "+
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_rkm_rptRkmPu";
			...
			systemAPI.alert("[app_saku3_report_rkm_flRkmPu]::mainButtonClick:"+e);
		}
	},
