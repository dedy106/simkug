window.app_saku3_report_rkm_flPenilaian = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_rkm_flPenilaian.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_rkm_flPenilaian";
		this.maximize();
	...
	this.pp=this.dbLib.getPeriodeFromSQL("select nik_user as periode from rkm_ss where nik_user='"+this.app._userLog+"' and kode_lokasi='"+this.app._lokasi+"' ");
	...
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("Kode Indikator","All",""));
...
window.app_saku3_report_rkm_flPenilaian.extend(window.childForm);
window.app_saku3_report_rkm_flPenilaian.implement({
		...
		try{			
			...
			if (row ==2)
			{
				this.filterRep.ListDataSGFilter(this, "Data Akun",this.sg1, this.sg1.row, this.sg1.col,
												...
												new Array("kode_akun","nama"),"where",new Array("Kode Akun","Nama"));
			}			
			if (row ==3)
			{
				this.filterRep.ListDataSGFilter(this, "Data PP",this.sg1, this.sg1.row, this.sg1.col,
												"select kode_pp,nama from rkm_pp ",
												"select count(*) from rkm_pp ",
												new Array("kode_pp","nama"),"where",new Array("Kode PP","Nama"));
			}			
			if (row ==4)
			{
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_rkm_rptPenilaian";
			...
			systemAPI.alert("[app_saku3_report_rkm_flPenilaian]::mainButtonClick:"+e);
		}
	},
