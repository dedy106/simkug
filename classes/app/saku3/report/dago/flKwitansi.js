window.app_saku3_report_dago_flKwitansi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dago_flKwitansi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dago_flKwitansi";
		this.maximize();
...
window.app_saku3_report_dago_flKwitansi.extend(window.childForm);
window.app_saku3_report_dago_flKwitansi.implement({
		...
		try{			
			...
			if (row ==2)
			{
				this.filterRep.ListDataSGFilter(this, "Data Registrasi",this.sg1, this.sg1.row, this.sg1.col,
														  "select a.no_reg, a.no_peserta from dgw_reg a  "+
														   this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(2,0)," where "),
														  "select count(a.no_reg) from dgw_reg a "+
														  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(2,0)," where "),
														  ["a.no_reg","a.no_peserta"],"and",["Kode","Peserta"]);
			}
