window.app_saku3_report_dago_flAgen = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dago_flAgen.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dago_flAgen";
		this.maximize();
...
window.app_saku3_report_dago_flAgen.extend(window.childForm);
window.app_saku3_report_dago_flAgen.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_dago_rptAgen";
