window.app_saku3_report_dago_flSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dago_flSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dago_flSaldo";
		this.maximize();
...
window.app_saku3_report_dago_flSaldo.extend(window.childForm);
window.app_saku3_report_dago_flSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_dago_rptSaldo";
			...
			systemAPI.alert("[app_saku3_report_dago_flSaldo]::mainButtonClick:"+e);
		}
	},
