window.app_saku3_report_dago_flRekapbayar = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dago_flRekapbayar.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dago_flRekapbayar";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Nomor Kwitansi","All",""));
	
	
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_dago_flRekapbayar.extend(window.childForm);
window.app_saku3_report_dago_flRekapbayar.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			{
	this.gridLib.SGEditData(this.sg1,0,new Array(0,1), new Array("Kode Lokasi","=",this.app._lokasi));
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1), new Array("Nomor Kwitansi","All",""));
			}else{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							  this.filterRep.filterStr("a.no_kwitansi",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");
				this.showFilter = this.filterRep.showFilter(this.sg1);
				this.nama_report = "server_report_saku3_dago_rptRekapbayar";
