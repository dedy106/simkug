window.app_saku3_report_dago_flGroup = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dago_flGroup.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dago_flGroup";
		this.maximize();
...
window.app_saku3_report_dago_flGroup.extend(window.childForm);
window.app_saku3_report_dago_flGroup.implement({
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Kode Lokasi","All",""));
				...
				this.nama_report = "server_report_saku3_dago_rptGroup";
