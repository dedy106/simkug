window.app_saku3_report_dago_flJurnalKas = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dago_flJurnalKas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dago_flJurnalKas";
		this.maximize();
...
window.app_saku3_report_dago_flJurnalKas.extend(window.childForm);
window.app_saku3_report_dago_flJurnalKas.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from kas_m where kode_lokasi='"+this.app._lokasi+"' and modul='KBREG'  order by periode",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_dago_rptJurnalKas";
			...
			systemAPI.alert("[app_saku3_report_dago_flJurnalKas]::mainButtonClick:"+e);
		}
	},
