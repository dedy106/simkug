window.app_saku3_report_dago_flKartu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dago_flKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dago_flKartu";
		this.maximize();
...
window.app_saku3_report_dago_flKartu.extend(window.childForm);
window.app_saku3_report_dago_flKartu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_dago_rptKartu";
			...
			systemAPI.alert("[app_saku3_report_dago_flKartu]::mainButtonClick:"+e);
		}
	},
