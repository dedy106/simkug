window.app_saku3_report_dago_flRegistrasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dago_flRegistrasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dago_flRegistrasi";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Nomor Registrasi","All",""));
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Nomor Peserta","All",""));
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Jenis Laporan","=","Daftar"));
	
	
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_dago_flRegistrasi.extend(window.childForm);
window.app_saku3_report_dago_flRegistrasi.implement({
		...
		try{			
			...
			if (row ==1)
			{
				this.filterRep.ListDataSGFilter(this, "Data Registrasi",this.sg1, this.sg1.row, this.sg1.col,
														  "select a.no_reg, no_peserta from dgw_reg a  "+
														   this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(2,0)," where "),
														  "select count(a.no_reg) from dgw_reg a "+
														  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(2,0)," where "),
														  ["a.no_reg","a.no_peserta"],"and",["Kode","No Peserta"]);
			}
			if (row ==2)
			{
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Kode Lokasi","All",""));
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							  this.filterRep.filterStr("a.no_reg",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");
				this.showFilter = this.filterRep.showFilter(this.sg1);
				this.nama_report = "server_report_saku3_dago_rptRegist";
				if (this.sg1.getCell(2,3)=="Form")
	...
	doOpenReg: function(no_reg,kode_lokasi){
		...
		nama_report="server_report_saku3_dago_rptRegistrasi";
