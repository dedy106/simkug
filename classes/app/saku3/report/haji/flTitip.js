window.app_saku3_report_haji_flTitip = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_haji_flTitip.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_haji_flTitip";
		this.maximize();
...
window.app_saku3_report_haji_flTitip.extend(window.childForm);
window.app_saku3_report_haji_flTitip.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_haji_rptTitip";
			...
			systemAPI.alert("[app_saku3_report_haji_flTitip]::mainButtonClick:"+e);
		}
	},
