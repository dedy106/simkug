window.app_saku3_report_haji_flTitipKartu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_haji_flTitipKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_haji_flTitipKartu";
		this.maximize();
...
window.app_saku3_report_haji_flTitipKartu.extend(window.childForm);
window.app_saku3_report_haji_flTitipKartu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_haji_rptTitipKartu";
			...
			systemAPI.alert("[app_saku3_report_haji_flTitipKartu]::mainButtonClick:"+e);
		}
	},
