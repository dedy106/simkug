window.app_saku3_report_haji_flCust = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_haji_flCust.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_haji_flCust";
		this.maximize();
...
window.app_saku3_report_haji_flCust.extend(window.childForm);
window.app_saku3_report_haji_flCust.implement({
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.no_peserta",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");
				this.filter2 = this.sg1.getCell(2,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_haji_rptCust";
			...
			systemAPI.alert("[app_saku3_report_haji_flCust]::mainButtonClick:"+e);
		}
	},
