window.app_saku3_report_tm_flTagihan = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tm_flTagihan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tm_flTagihan";
		this.maximize();
...
window.app_saku3_report_tm_flTagihan.extend(window.childForm);
window.app_saku3_report_tm_flTagihan.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			}else
			{
				...
				this.nama_report="server_report_saku3_tm_rptTagihan";
