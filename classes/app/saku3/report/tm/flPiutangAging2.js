window.app_saku3_report_tm_flPiutangAging2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tm_flPiutangAging2.prototype.parent.constructor.call(this,owner);
        this.className = "app_saku3_report_tm_flPiutangAging2";
		this.maximize();
...
window.app_saku3_report_tm_flPiutangAging2.extend(window.childForm);
window.app_saku3_report_tm_flPiutangAging2.implement({
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3],["123","1236","123","123","3"]);
	...
	mainButtonClick: function(sender){
		try
		{
			...
			if (sender == this.app._mainForm.bBack)
			{
				...
				if (this.link=="2")
				{
					this.doOpenKartu(this.no_bukti,this.kode_lokasi,this.periode);					
			...
			else
			{
				...
				this.filter2 =this.sg1.getCell(2,0)+"/"+periode+"/"+this.sg1.getCellDateValue(2,4);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_tm_rptPiutangAging2";
			...
			systemAPI.alert("[app_saku3_report_tm_flPiutangAging2]::mainButtonClick:"+e);
		}
	},
	...
	doOpenKartu: function(no_bukti,kode_lokasi,periode){
