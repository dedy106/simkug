window.app_saku3_report_tm_flGlBukuBesarPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tm_flGlBukuBesarPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tm_flGlBukuBesarPp";
		this.maximize();
...
window.app_saku3_report_tm_flGlBukuBesarPp.extend(window.childForm);
window.app_saku3_report_tm_flGlBukuBesarPp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_tm_rptGlBukuBesarPp";
