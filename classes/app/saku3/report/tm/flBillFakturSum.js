window.app_saku3_report_tm_flBillFakturSum = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tm_flBillFakturSum.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tm_flBillFakturSum";
		this.maximize();
...
window.app_saku3_report_tm_flBillFakturSum.extend(window.childForm);
window.app_saku3_report_tm_flBillFakturSum.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tm_rptBillFakturSum";
			...
			systemAPI.alert("[app_saku3_report_tm_flBillFakturSum]::mainButtonClick:"+e);
		}
	},
