window.app_saku3_report_tm_flKbTbTm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tm_flKbTbTm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tm_flKbTbTm";
		this.maximize();
...
window.app_saku3_report_tm_flKbTbTm.extend(window.childForm);
window.app_saku3_report_tm_flKbTbTm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_tm_rptKbTbTm";
	...
	doOpenBb: function(kode_akun,kode_lokasi,periode){
		...
		nama_report="server_report_saku3_tm_rptKbBukuBesarTm";
