window.app_saku3_report_tm_flPiutangSaldoCust = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tm_flPiutangSaldoCust.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tm_flPiutangSaldoCust";
		this.maximize();
...
window.app_saku3_report_tm_flPiutangSaldoCust.extend(window.childForm);
window.app_saku3_report_tm_flPiutangSaldoCust.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			var sql="select distinct periode from piutang_m where kode_lokasi='"+this.app._lokasi+"' "+
				"union "+
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tm_rptPiutangSaldoCust";
			...
			systemAPI.alert("[app_saku3_report_tm_flPiutangSaldoCust]::mainButtonClick:"+e);
		}
	},
	...
	doOpenSaldo: function(kode_cust,kode_lokasi,periode){
		...
		nama_report="server_report_saku3_tm_rptPiutangSaldoSpm";
