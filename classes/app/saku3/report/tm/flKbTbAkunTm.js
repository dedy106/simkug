window.app_saku3_report_tm_flKbTbAkunTm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tm_flKbTbAkunTm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tm_flKbTbAkunTm";
		this.maximize();
...
window.app_saku3_report_tm_flKbTbAkunTm.extend(window.childForm);
window.app_saku3_report_tm_flKbTbAkunTm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_tm_rptKbTbAkunTm";
	...
	doOpenTb: function(kode_akun,kode_lokasi,periode){
		...
		nama_report="server_report_saku3_tm_rptKbTbTm";
