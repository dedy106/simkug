window.app_saku3_report_tm_flPiutangAging = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tm_flPiutangAging.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tm_flPiutangAging";
		this.maximize();
...
window.app_saku3_report_tm_flPiutangAging.extend(window.childForm);
window.app_saku3_report_tm_flPiutangAging.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tm_rptPiutangAging";
			...
			systemAPI.alert("[app_saku3_report_tm_flPiutangAging]::mainButtonClick:"+e);
		}
	},
