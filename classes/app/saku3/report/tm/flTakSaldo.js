window.app_saku3_report_tm_flTakSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tm_flTakSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tm_flTakSaldo";
		this.maximize();
...
window.app_saku3_report_tm_flTakSaldo.extend(window.childForm);
window.app_saku3_report_tm_flTakSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tm_rptTakSaldo";
			...
			systemAPI.alert("[app_saku3_report_tm_flTakSaldo]::mainButtonClick:"+e);
		}
	},
