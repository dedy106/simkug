window.app_saku3_report_tm_flTakTerima = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tm_flTakTerima.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tm_flTakTerima";
		this.maximize();
...
window.app_saku3_report_tm_flTakTerima.extend(window.childForm);
window.app_saku3_report_tm_flTakTerima.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_tm_flTakTerima]::mainButtonClick:"+e);
		}
	},
