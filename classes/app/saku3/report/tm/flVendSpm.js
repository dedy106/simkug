window.app_saku3_report_tm_flVendSpm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tm_flVendSpm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tm_flVendSpm";
		this.maximize();
...
window.app_saku3_report_tm_flVendSpm.extend(window.childForm);
window.app_saku3_report_tm_flVendSpm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tm_rptVendorSpm";
			...
			systemAPI.alert("[app_saku3_report_tm_flVendSpm]::mainButtonClick:"+e);
		}
	},
