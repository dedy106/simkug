window.app_saku3_report_tm_flBillInvoice = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tm_flBillInvoice.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tm_flBillInvoice";
		this.maximize();
...
window.app_saku3_report_tm_flBillInvoice.extend(window.childForm);
window.app_saku3_report_tm_flBillInvoice.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_tm_flBillInvoice]::mainButtonClick:"+e);
		}
	},
