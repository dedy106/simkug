// JavaScript Document
window.app_saku3_report_tm_flKbJurnalBuktiTm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tm_flKbJurnalBuktiTm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tm_flKbJurnalBuktiTm";
		this.maximize();
...
window.app_saku3_report_tm_flKbJurnalBuktiTm.extend(window.portalui_childForm);
window.app_saku3_report_tm_flKbJurnalBuktiTm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_tm_rptKbJurnalBuktiTm";
