window.app_saku3_report_tm_flDropingKirim = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tm_flDropingKirim.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tm_flDropingKirim";
		this.maximize();
...
window.app_saku3_report_tm_flDropingKirim.extend(window.childForm);
window.app_saku3_report_tm_flDropingKirim.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tm_rptDropingKirim";
			...
			systemAPI.alert("[app_saku3_report_tm_flDropingKirim]::mainButtonClick:"+e);
		}
	},
