window.app_saku3_report_tm_flKbBukuBesarTm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tm_flKbBukuBesarTm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tm_flKbBukuBesarTm";
		this.maximize();
...
window.app_saku3_report_tm_flKbBukuBesarTm.extend(window.childForm);
window.app_saku3_report_tm_flKbBukuBesarTm.implement({
	...
	{		
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("OPERASIONAL"));
		}
		if (row == 6)
		{
			this.sg1.columns.get(2).pickList.clear();
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_tm_rptKbBukuBesarTm";
	...
	doOpenJurnal: function(no_bukti,kode_lokasi){
		...
		filter2="";
		nama_report="server_report_saku3_tm_rptKbJurnalBuktiTm";
