window.app_saku3_report_tm_flPiutangKasJurnalPry = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tm_flPiutangKasJurnalPry.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tm_flPiutangKasJurnalPry";
		this.maximize();
...
window.app_saku3_report_tm_flPiutangKasJurnalPry.extend(window.childForm);
window.app_saku3_report_tm_flPiutangKasJurnalPry.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_tm_flPiutangKasJurnalPry]::mainButtonClick:"+e);
		}
	},
