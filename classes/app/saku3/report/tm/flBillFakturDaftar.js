window.app_saku3_report_tm_flBillFakturDaftar = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tm_flBillFakturDaftar.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tm_flBillFakturDaftar";
		this.maximize();
...
window.app_saku3_report_tm_flBillFakturDaftar.extend(window.childForm);
window.app_saku3_report_tm_flBillFakturDaftar.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tm_rptBillFakturDaftar";
			...
			systemAPI.alert("[app_saku3_report_tm_flBillFakturDaftar]::mainButtonClick:"+e);
		}
	},
