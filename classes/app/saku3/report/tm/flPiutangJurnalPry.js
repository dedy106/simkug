window.app_saku3_report_tm_flPiutangJurnalPry = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tm_flPiutangJurnalPry.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tm_flPiutangJurnalPry";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from spm_piutang_m  ");
...
window.app_saku3_report_tm_flPiutangJurnalPry.extend(window.childForm);
window.app_saku3_report_tm_flPiutangJurnalPry.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_tm_flPiutangJurnalPry]::mainButtonClick:"+e);
		}
	},
