window.app_saku3_report_tm_flBillKuitansi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tm_flBillKuitansi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tm_flBillKuitansi";
		this.maximize();
...
window.app_saku3_report_tm_flBillKuitansi.extend(window.childForm);
window.app_saku3_report_tm_flBillKuitansi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tm_rptBillKuitansi";
			...
			systemAPI.alert("[app_saku3_report_tm_flBillKuitansi]::mainButtonClick:"+e);
		}
	},
