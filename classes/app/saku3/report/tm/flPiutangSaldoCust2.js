window.app_saku3_report_tm_flPiutangSaldoCust2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tm_flPiutangSaldoCust2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tm_flPiutangSaldoCust2";
		this.maximize();
...
window.app_saku3_report_tm_flPiutangSaldoCust2.extend(window.childForm);
window.app_saku3_report_tm_flPiutangSaldoCust2.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tm_rptPiutangSaldoCust2";
			...
			systemAPI.alert("[app_saku3_report_tm_flPiutangSaldoCust2]::mainButtonClick:"+e);
		}
	},
	...
	doOpenSaldo: function(kode_cust,kode_lokasi,periode){
		...
		nama_report="server_report_saku3_tm_rptPiutangSaldo";
