window.app_saku3_report_tm_flUploadHutang = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tm_flUploadHutang.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tm_flUploadHutang";
        this.maximize();
...
window.app_saku3_report_tm_flUploadHutang.extend(window.childForm);
window.app_saku3_report_tm_flUploadHutang.implement({
	doLoad:function(){
        try{
			...
			this.report = new server_report_report();
			var nama_report="server_report_saku3_tm_rptUploadHutang";
			this.filter="";
			this.showFilter = "";
			this.lokasi = "";
