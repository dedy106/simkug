window.app_saku3_report_tm_flTakKirim = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tm_flTakKirim.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tm_flTakKirim";
		this.maximize();
...
window.app_saku3_report_tm_flTakKirim.extend(window.childForm);
window.app_saku3_report_tm_flTakKirim.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_tm_flTakKirim]::mainButtonClick:"+e);
		}
	},
