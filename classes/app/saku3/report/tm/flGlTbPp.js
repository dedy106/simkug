window.app_saku3_report_tm_flGlTbPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tm_flGlTbPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tm_flGlTbPp";
		this.maximize();
...
window.app_saku3_report_tm_flGlTbPp.extend(window.childForm);
window.app_saku3_report_tm_flGlTbPp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.app._nikUser+"/"+this.sg1.getCell(2,3)+"//"+this.sg1.getCell(2,4)+"/"+this.sg1.getCell(2,5);
				this.nama_report="server_report_saku3_tm_rptGlTbPp";
	...
	doOpenBb: function(kode_akun,kode_lokasi,periode,kode_pp){
		...
		filter="where a.kode_lokasi='"+kode_lokasi+"' and a.kode_akun='"+kode_akun+"' and a.kode_pp='"+kode_pp+"' and a.periode='"+periode+"'";
