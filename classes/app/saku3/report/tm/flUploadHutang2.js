window.app_saku3_report_tm_flUploadHutang2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tm_flUploadHutang2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tm_flUploadHutang2";
        this.maximize();
...
window.app_saku3_report_tm_flUploadHutang2.extend(window.childForm);
window.app_saku3_report_tm_flUploadHutang2.implement({
	doLoad:function(){
        try{
			...
			this.report = new server_report_report();
			var nama_report="server_report_saku3_tm_rptUploadHutang2";
			this.filter="";
			this.showFilter = "";
			this.lokasi = "";
