// JavaScript Document
window.app_saku3_report_tm_flKbJurnalTm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tm_flKbJurnalTm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tm_flKbJurnalTm";
		this.maximize();
...
window.app_saku3_report_tm_flKbJurnalTm.extend(window.portalui_childForm);
window.app_saku3_report_tm_flKbJurnalTm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_tm_rptKbJurnalTm";
