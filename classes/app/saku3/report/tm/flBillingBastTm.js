window.app_saku3_report_tm_flBillingBastTm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tm_flBillingBastTm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tm_flBillingBastTm";
		this.maximize();
	...
	this.bill=this.dbLib.getPeriodeFromSQL("select max(no_selesai) as periode from yk_batm_m where  kode_lokasi='"+this.app._lokasi+"'");
...
window.app_saku3_report_tm_flBillingBastTm.extend(window.childForm);
window.app_saku3_report_tm_flBillingBastTm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			}else
			{
				...
				this.nama_report="server_report_saku3_tm_rptBillingBastTm";
