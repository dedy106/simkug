window.app_saku3_report_tm_flBillForm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tm_flBillForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tm_flBillForm";
		this.maximize();
...
window.app_saku3_report_tm_flBillForm.extend(window.childForm);
window.app_saku3_report_tm_flBillForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tm_rptBillForm";
			...
			systemAPI.alert("[app_saku3_report_tm_flBillForm]::mainButtonClick:"+e);
		}
	},
