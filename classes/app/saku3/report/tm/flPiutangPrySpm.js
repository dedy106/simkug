window.app_saku3_report_tm_flPiutangPrySpm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tm_flPiutangPrySpm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tm_flPiutangPrySpm";
		this.maximize();
...
window.app_saku3_report_tm_flPiutangPrySpm.extend(window.childForm);
window.app_saku3_report_tm_flPiutangPrySpm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tm_rptPiutangPrySpm";
			...
			systemAPI.alert("[app_saku3_report_tm_flPiutangPrySpm]::mainButtonClick:"+e);
		}
	},
