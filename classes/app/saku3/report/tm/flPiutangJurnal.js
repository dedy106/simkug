window.app_saku3_report_tm_flPiutangJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tm_flPiutangJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tm_flPiutangJurnal";
		this.maximize();
...
window.app_saku3_report_tm_flPiutangJurnal.extend(window.childForm);
window.app_saku3_report_tm_flPiutangJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_tm_flPiutangJurnal]::mainButtonClick:"+e);
		}
	},
