window.app_saku3_report_tm_flPiutangSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tm_flPiutangSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tm_flPiutangSaldo";
		this.maximize();
	...
	// this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("Tanggal","=",new Date().lclFormat()));
...
window.app_saku3_report_tm_flPiutangSaldo.extend(window.childForm);
window.app_saku3_report_tm_flPiutangSaldo.implement({
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4],["123","1236","123","123","6"]);
		...
		try
		{
			...
			else
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("a.kode_cust",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
							this.filterRep.filterStr("a.no_piutang",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and");
				var filter_periode = this.filterRep.filterStr("a.periode",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4),"and");
				var periode=this.sg1.getCell(2,1);
				if (this.sg1.getCell(1,1)=="Range")
				{
					periode=this.sg1.getCell(3,1);
				}
				this.filter2 = this.sg1.getCell(2,0)+"/"+periode+"/"+filter_periode;
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_tm_rptPiutangSaldo";
			...
			systemAPI.alert("[app_saku3_report_tm_flPiutangSaldo]::mainButtonClick:"+e);
		}
	},
