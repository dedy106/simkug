window.app_saku3_report_tm_flPiutangKartuSpm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tm_flPiutangKartuSpm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tm_flPiutangKartuSpm";
		this.maximize();
...
window.app_saku3_report_tm_flPiutangKartuSpm.extend(window.childForm);
window.app_saku3_report_tm_flPiutangKartuSpm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tm_rptPiutangKartuSpm";
			...
			systemAPI.alert("[app_saku3_report_tm_flPiutangKartuSpm]::mainButtonClick:"+e);
		}
	},
