window.app_saku3_report_tm_flPiutangSpm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tm_flPiutangSpm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tm_flPiutangSpm";
		this.maximize();
...
window.app_saku3_report_tm_flPiutangSpm.extend(window.childForm);
window.app_saku3_report_tm_flPiutangSpm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tm_rptPiutangSpm";
			...
			systemAPI.alert("[app_saku3_report_tm_flPiutangSpm]::mainButtonClick:"+e);
		}
	},
