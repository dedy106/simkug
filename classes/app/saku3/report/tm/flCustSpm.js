window.app_saku3_report_tm_flCustSpm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tm_flCustSpm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tm_flCustSpm";
		this.maximize();
...
window.app_saku3_report_tm_flCustSpm.extend(window.childForm);
window.app_saku3_report_tm_flCustSpm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tm_rptCustSpm";
			...
			systemAPI.alert("[app_saku3_report_tm_flCustSpm]::mainButtonClick:"+e);
		}
	},
