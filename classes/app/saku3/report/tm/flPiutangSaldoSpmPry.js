window.app_saku3_report_tm_flPiutangSaldoSpmPry = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tm_flPiutangSaldoSpmPry.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tm_flPiutangSaldoSpmPry";
		this.maximize();
...
window.app_saku3_report_tm_flPiutangSaldoSpmPry.extend(window.childForm);
window.app_saku3_report_tm_flPiutangSaldoSpmPry.implement({
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5],["123","1236","123","123","123","123"]);
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tm_rptPiutangSaldoSpmPry";
			...
			systemAPI.alert("[app_saku3_report_tm_flPiutangSaldoSpmPry]::mainButtonClick:"+e);
		}
	},
