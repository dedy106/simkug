window.app_saku3_report_tm_flBillFaktur = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tm_flBillFaktur.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tm_flBillFaktur";
		this.maximize();
...
window.app_saku3_report_tm_flBillFaktur.extend(window.childForm);
window.app_saku3_report_tm_flBillFaktur.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tm_rptBillFaktur";
			...
			systemAPI.alert("[app_saku3_report_tm_flBillFaktur]::mainButtonClick:"+e);
		}
	},
