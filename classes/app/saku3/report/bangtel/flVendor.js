window.app_saku3_report_bangtel_flVendor = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bangtel_flVendor.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bangtel_flVendor";
		this.maximize();
...
window.app_saku3_report_bangtel_flVendor.extend(window.childForm);
window.app_saku3_report_bangtel_flVendor.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_bangtel_rptVendor";
			...
			systemAPI.alert("[app_saku3_report_bangtel_flVendor]::mainButtonClick:"+e);
		}
	},
