window.app_saku3_report_bangtel_flProyekPdpt = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bangtel_flProyekPdpt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bangtel_flProyekPdpt";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,6,new Array(0,1,2), new Array("Jenis","=","LUNAS"));
...
window.app_saku3_report_bangtel_flProyekPdpt.extend(window.childForm);
window.app_saku3_report_bangtel_flProyekPdpt.implement({
		...
		try{			
			...
			if (row ==5)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Invoice",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_piutang, a.keterangan from spm_piutang_m a "+filter,
												"select count(a.no_piutang) from spm_piutang_m a "+filter,
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6,7],["123","1236","123","123","123","123","123","123"]);
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5,6,7],[2,0,2,2,2,2,0,0]);	
		if (row == 1)
		{
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,6)+"/"+this.sg1.getCell(2,7);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_bangtel_rptProyekPdpt";
			...
			systemAPI.alert("[app_saku3_report_bangtel_flProyekPdpt]::mainButtonClick:"+e);
		}
	},
