window.app_saku3_report_bangtel_flPajak = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bangtel_flPajak.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bangtel_flPajak";
		this.maximize();
...
window.app_saku3_report_bangtel_flPajak.extend(window.childForm);
window.app_saku3_report_bangtel_flPajak.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row == 2)
			{
				...
				"and kode_akun in ('213.101','111.506','111.508','111.701') ";
	...
	{		
		...
		else
		{
			...
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5],[3,0,2,2,1,0]);	
		}
		if (row == 1)
		{
	...
	mainButtonClick: function(sender){
		try
		{
			...
			if (sender == this.app._mainForm.bBack)
			{
				...
				if (this.link=="2")
				{
					this.doOpenNilai(this.no_akun,this.kode_lokasi);					
					
				}
				if (this.link=="3")
				{
					this.doOpenNilaii(this.no_akun,this.kode_lokasi);					
					
				}if (this.link=="4")
				{
					this.doOpenNilaiii(this.no_akun,this.kode_lokasi);					
			...
			else
			{
				...
				"and a.kode_akun in ('213.101','111.506','111.508','111.701') ";
                            
				this.filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1);
				this.nama_report="server_report_saku3_bangtel_rptPajak";
	...
	doOpenNilai: function(no_akun,kode_lokasi,periode){
