window.app_saku3_report_bangtel_flFaNonAsset = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bangtel_flFaNonAsset.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bangtel_flFaNonAsset";
		this.maximize();
...
window.app_saku3_report_bangtel_flFaNonAsset.extend(window.childForm);
window.app_saku3_report_bangtel_flFaNonAsset.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row == 3)
			{
				this.filterRep.ListDataSGFilter(this, "Data KlpAkun",this.sg1, this.sg1.row, this.sg1.col,
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6],["3","236","236","123","123","3","123"]);
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5,6],[2,0,0,2,2,0,2]);	
		if (row == 1)
		{
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_bangtel_rptFaNonAsset";
