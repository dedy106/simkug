window.app_saku3_report_bangtel_flKaryawan = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bangtel_flKaryawan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bangtel_flKaryawan";
		this.maximize();
...
window.app_saku3_report_bangtel_flKaryawan.extend(window.childForm);
window.app_saku3_report_bangtel_flKaryawan.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_bangtel_rptKaryawan";
			...
			systemAPI.alert("[app_saku3_report_bangtel_flKaryawan]::mainButtonClick:"+e);
		}
	},
