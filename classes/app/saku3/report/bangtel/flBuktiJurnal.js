// JavaScript Document
window.app_saku3_report_bangtel_flBuktiJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bangtel_flBuktiJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bangtel_flBuktiJurnal";
		this.maximize();
...
window.app_saku3_report_bangtel_flBuktiJurnal.extend(window.portalui_childForm);
window.app_saku3_report_bangtel_flBuktiJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_bangtel_rptBuktiJurnal";
