window.app_saku3_report_bangtel_flKontrolProyek = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bangtel_flKontrolProyek.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bangtel_flKontrolProyek";
		this.maximize();
...
window.app_saku3_report_bangtel_flKontrolProyek.extend(window.childForm);
window.app_saku3_report_bangtel_flKontrolProyek.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_bangtel_rptKontrolProyek";
			...
			systemAPI.alert("[app_saku3_report_bangtel_flKontrolProyek]::mainButtonClick:"+e);
		}
	},
