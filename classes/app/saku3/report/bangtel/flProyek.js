window.app_saku3_report_bangtel_flProyek = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bangtel_flProyek.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bangtel_flProyek";
		this.maximize();
...
window.app_saku3_report_bangtel_flProyek.extend(window.childForm);
window.app_saku3_report_bangtel_flProyek.implement({
	...
	{		
		...
		if (row == 5)
		{
			...
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("1.ONGOING","2.STAGNAN","3.REKON","4.BAUT","5.BAST","6.CLOSE"));
		}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_bangtel_rptProyek";
			...
			systemAPI.alert("[app_saku3_report_bangtel_flProyek]::mainButtonClick:"+e);
		}
	},
