window.app_saku3_report_bangtel_flProyekKartu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bangtel_flProyekKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bangtel_flProyekKartu";
		this.maximize();
...
window.app_saku3_report_bangtel_flProyekKartu.extend(window.childForm);
window.app_saku3_report_bangtel_flProyekKartu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_bangtel_rptProyekKartu";
			...
			systemAPI.alert("[app_saku3_report_bangtel_flProyekKartu]::mainButtonClick:"+e);
		}
	},
