window.app_saku3_report_bangtel_barang_flTerima = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bangtel_barang_flTerima.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bangtel_barang_flTerima";
		this.maximize();
...
window.app_saku3_report_bangtel_barang_flTerima.extend(window.childForm);
window.app_saku3_report_bangtel_barang_flTerima.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_bangtel_barang_flTerima]::mainButtonClick:"+e);
		}
	},
