// JavaScript Document
window.app_saku3_report_bangtel_barang_flJurnalTerimaBrg = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bangtel_barang_flJurnalTerimaBrg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bangtel_barang_flJurnalTerimaBrg";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from trans_m where modul='LOGTRM' and kode_lokasi='"+this.app._lokasi+"'");
...
window.app_saku3_report_bangtel_barang_flJurnalTerimaBrg.extend(window.portalui_childForm);
window.app_saku3_report_bangtel_barang_flJurnalTerimaBrg.implement({
	doEllipseClick: function(sender, col, row){
		...
		if (row == 2)
		{
			...
			var sql1="select a.no_hutang,a.keterangan from trans_m a "+filter; 
			var sql2="select count(a.no_hutang) from trans_m a "+filter;
	...
	doSelectCell: function(sender, col, row){
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from trans_m where modul='LOGTRM' and kode_lokasi='"+this.app._lokasi+"' order by periode desc",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_bangtel_barang_rptJurnalTerimaBrg";
