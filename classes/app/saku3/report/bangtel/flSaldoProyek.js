window.app_saku3_report_bangtel_flSaldoProyek = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bangtel_flSaldoProyek.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bangtel_flSaldoProyek";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,5,new Array(0,1,2), new Array("Jenis Laporan","=","OutStanding"));
...
window.app_saku3_report_bangtel_flSaldoProyek.extend(window.childForm);
window.app_saku3_report_bangtel_flSaldoProyek.implement({
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6],["123","123","36","123","123","3","123"]);
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5,6],[2,2,0,2,2,0,2]);	
		if (row == 2)
		{
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("OutStanding","Lunas","Semua"));
		}
	},
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("e.kode_akun",this.sg1.getCell(1,6),this.sg1.getCell(2,6),this.sg1.getCell(3,6),"and");
				...
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,2)+"/"+this.sg1.getCell(2,5);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_bangtel_rptSaldoProyek";
			...
			systemAPI.alert("[app_saku3_report_bangtel_flSaldoProyek]::mainButtonClick:"+e);
		}
	},
