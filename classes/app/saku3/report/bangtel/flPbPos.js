window.app_saku3_report_bangtel_flPbPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bangtel_flPbPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bangtel_flPbPos";
		this.maximize();
...
window.app_saku3_report_bangtel_flPbPos.extend(window.childForm);
window.app_saku3_report_bangtel_flPbPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_bangtel_rptPbPos";
			...
			systemAPI.alert("[app_saku3_report_bangtel_flPbPos]::mainButtonClick:"+e);
		}
	},
	...
	doOpenBukti: function(no_bukti,kode_lokasi){
		...
		nama_report="server_report_saku3_bangtel_rptPbForm";
