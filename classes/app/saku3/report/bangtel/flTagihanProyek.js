window.app_saku3_report_bangtel_flTagihanProyek = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bangtel_flTagihanProyek.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bangtel_flTagihanProyek";
		this.maximize();
...
window.app_saku3_report_bangtel_flTagihanProyek.extend(window.childForm);
window.app_saku3_report_bangtel_flTagihanProyek.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_bangtel_rptTagihanProyek";
			...
			systemAPI.alert("[app_saku3_report_bangtel_flTagihanProyek]::mainButtonClick:"+e);
		}
	},
