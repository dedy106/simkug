window.app_saku3_report_bangtel_flPanjarPtgForm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bangtel_flPanjarPtgForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bangtel_flPanjarPtgForm";
		this.maximize();
...
window.app_saku3_report_bangtel_flPanjarPtgForm.extend(window.childForm);
window.app_saku3_report_bangtel_flPanjarPtgForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_bangtel_flPanjarPtgForm]::mainButtonClick:"+e);
		}
	},
