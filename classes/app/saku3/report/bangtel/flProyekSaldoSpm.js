window.app_saku3_report_bangtel_flProyekSaldoSpm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bangtel_flProyekSaldoSpm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bangtel_flProyekSaldoSpm";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("Kode Proyek","All",""));
...
window.app_saku3_report_bangtel_flProyekSaldoSpm.extend(window.childForm);
window.app_saku3_report_bangtel_flProyekSaldoSpm.implement({
		...
		try{			
			...
			if (row == 3)
			{
				this.filterRep.ListDataSGFilter(this, "Data Jenis",this.sg1, this.sg1.row, this.sg1.col,
														  "select kode_jenis, nama from spm_proyek_jenis "+
														   this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  "select count(kode_jenis) from spm_proyek_jenis "+
														  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
	...
	{		
		...
		if (row == 5)
		{
			...
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("0.CLOSE","1.OGP","2.BATAL","3.MASALALU"));
		}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			if (sender == this.app._mainForm.bBack)
			{
				...
				if (this.link=="2")
				{
					this.doOpenKartu(this.kode_proyek,this.kode_lokasi);
				}
			...
			else
			{
				...
				this.filter2 = nama_cab+"/"+this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,5);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_bangtel_rptProyekSaldoSpm";
			...
			systemAPI.alert("[app_saku3_report_bangtel_flProyekSaldoSpm]::mainButtonClick:"+e);
		}
	},
	...
	doOpenJurnal: function(no_bukti,kode_lokasi){
		...
		nama_report="server_report_saku3_bangtel_rptGlJurnalBukti";
		
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());

	},
	doOpenBdd: function(kode_proyek,kode_lokasi){
		...
		nama_report="server_report_saku3_bangtel_rptProyekBdd";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());

	},
	doOpenBeban: function(kode_proyek,kode_lokasi){
		...
		nama_report="server_report_saku3_bangtel_rptProyekBeban";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());

	},
	doOpenBymhd: function(kode_proyek,kode_lokasi){
		...
		nama_report="server_report_saku3_bangtel_rptProyekBymhd";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());

	},
	doOpenBymhdKas: function(kode_proyek,kode_lokasi){
		...
		nama_report="server_report_saku3_bangtel_rptProyekBymhdKas";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());

	},
	doOpenPiutang: function(kode_proyek,kode_lokasi){
		...
		nama_report="server_report_saku3_bangtel_rptProyekPiu";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());

	},
	doOpenPiutangKas: function(kode_proyek,kode_lokasi){
		...
		nama_report="server_report_saku3_bangtel_rptProyekPiuKas";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());

	},
	doOpenJurnalBdd: function(no_bukti,kode_lokasi){
		this.link="2";
