window.app_saku3_report_bangtel_flFaAsset = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bangtel_flFaAsset.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bangtel_flFaAsset";
		this.maximize();
...
window.app_saku3_report_bangtel_flFaAsset.extend(window.childForm);
window.app_saku3_report_bangtel_flFaAsset.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_bangtel_rptFaAsset";
