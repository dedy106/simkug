window.app_saku3_report_bangtel_flPanjarForm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bangtel_flPanjarForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bangtel_flPanjarForm";
		this.maximize();
...
window.app_saku3_report_bangtel_flPanjarForm.extend(window.childForm);
window.app_saku3_report_bangtel_flPanjarForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_bangtel_flPanjarForm]::mainButtonClick:"+e);
		}
	},
