window.app_saku3_report_bangtel_flProyekReklasPddJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bangtel_flProyekReklasPddJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bangtel_flProyekReklasPddJurnal";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from spm_piutang_m where modul='PDD'  ");
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("No Reklas","All",""));
...
window.app_saku3_report_bangtel_flProyekReklasPddJurnal.extend(window.childForm);
window.app_saku3_report_bangtel_flProyekReklasPddJurnal.implement({
		...
		try{			
			...
			if (row ==2)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Pemesanan",this.sg1, this.sg1.row, this.sg1.col,
												...
												new Array("a.no_piutang","a.keterangan"),"and",new Array("No Bukti","Keterangan"));
			}
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from spm_piutang_m  where modul='PDD' and kode_lokasi='"+this.app._lokasi+"' order by periode desc",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("a.no_piutang",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
							" and a.modul='PDD' ";
				this.filter2 = this.sg1.getCell(2,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_bangtel_rptProyekReklasPddJurnal";
			...
			systemAPI.alert("[app_saku3_report_bangtel_flProyekReklasPddJurnal]::mainButtonClick:"+e);
		}
	},
