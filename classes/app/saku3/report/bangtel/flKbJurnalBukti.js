// JavaScript Document
window.app_saku3_report_bangtel_flKbJurnalBukti = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bangtel_flKbJurnalBukti.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bangtel_flKbJurnalBukti";
		this.maximize();
...
window.app_saku3_report_bangtel_flKbJurnalBukti.extend(window.portalui_childForm);
window.app_saku3_report_bangtel_flKbJurnalBukti.implement({
