window.app_saku3_report_bangtel_flProyekSaldoCust = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bangtel_flProyekSaldoCust.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bangtel_flProyekSaldoCust";
		this.maximize();
...
window.app_saku3_report_bangtel_flProyekSaldoCust.extend(window.childForm);
window.app_saku3_report_bangtel_flProyekSaldoCust.implement({
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2],["123","1236","123"]);
	...
	mainButtonClick: function(sender){
		try
		{
			...
			if (sender == this.app._mainForm.bBack)
			{
				...
				if (this.link=="2")
				{
					this.doOpenSaldo(this.kode_cust,this.kode_lokasi,this.periode);					
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_bangtel_rptProyekSaldoCust";
			...
			systemAPI.alert("[app_saku3_report_bangtel_flProyekSaldoCust]::mainButtonClick:"+e);
		}
	},
	...
	doOpenSaldo: function(kode_cust,kode_lokasi,periode){
		this.kode_cust=kode_cust;
		this.kode_lokasi=kode_lokasi;
		this.periode=periode;
		this.link="1";
		filter = "where a.kode_cust='"+kode_cust+"' and a.kode_lokasi='"+kode_lokasi+"' ";
		filter2=kode_lokasi+"/"+periode+"/";
		nama_report="server_report_saku3_bangtel_rptProyekSaldo2";
