window.app_saku3_report_saiba_flKppn = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_saiba_flKppn.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_saiba_flKppn";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Data KPPN", 2);
	...
	this.gridLib.SGEditData(this.sg1,0,new Array(0,1,2), new Array("KPPN","All",""));
	
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_saiba_flKppn.extend(window.childForm);
window.app_saku3_report_saiba_flKppn.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			if (row ==0)
			{
				this.filterRep.ListDataSGFilter(this, "Data KPPN",this.sg1, this.sg1.row, this.sg1.col,
												"select kdkppn, nmkppn from t_kppn",
												"select count(*) from t_kppn",
												new Array("kdkppn","nmkppn"),"where",new Array("Kode","Nama"));
			}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kdkppn",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							  this.filterRep.filterStr("a.nmkppn",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");

							  this.showFilter = this.filterRep.showFilter(this.sg1);
				this.nama_report = "server_report_saku3_saiba_rptKppn";
