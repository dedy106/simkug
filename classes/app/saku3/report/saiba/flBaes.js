window.app_saku3_report_saiba_flBaes = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_saiba_flBaes.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_saiba_flBaes";
		this.maximize();
...
window.app_saku3_report_saiba_flBaes.extend(window.childForm);
window.app_saku3_report_saiba_flBaes.implement({
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kddept",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							  this.filterRep.filterStr("a.nmdept",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");

							  this.showFilter = this.filterRep.showFilter(this.sg1);
				this.nama_report = "server_report_saku3_saiba_rptBaes";
