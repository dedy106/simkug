window.app_saku3_report_saiba_flKanwil = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_saiba_flKanwil.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_saiba_flKanwil";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Data Kanwil", 2);
...
window.app_saku3_report_saiba_flKanwil.extend(window.childForm);
window.app_saku3_report_saiba_flKanwil.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kdba",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							  this.filterRep.filterStr("a.kdes1",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");

							  this.showFilter = this.filterRep.showFilter(this.sg1);
				this.nama_report = "server_report_saku3_saiba_rptKanwil";
