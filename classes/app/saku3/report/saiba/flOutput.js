window.app_saku3_report_saiba_flOutput = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_saiba_flOutput.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_saiba_flOutput";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,0,new Array(0,1,2), new Array("Kegiatan","All",""));
	
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_saiba_flOutput.extend(window.childForm);
window.app_saku3_report_saiba_flOutput.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			if (row ==0)
			{
				this.filterRep.ListDataSGFilter(this, "Data Kegiatan",this.sg1, this.sg1.row, this.sg1.col,
												"select kdgiat, nmgiat from t_giat",
												"select count(*) from t_giat",
												new Array("kdgiat","nmgiat"),"where",new Array("Kode","Nama"));
			}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kdgiat",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							  this.filterRep.filterStr("a.nmgiat",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");

							  this.showFilter = this.filterRep.showFilter(this.sg1);
				this.nama_report = "server_report_saku3_saiba_rptOutput";
