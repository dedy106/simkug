window.app_saku3_report_saiba_flAkun2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_saiba_flAkun2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_saiba_flAkun2";
		this.maximize();
...
window.app_saku3_report_saiba_flAkun2.extend(window.childForm);
window.app_saku3_report_saiba_flAkun2.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			if (row ==0)
			{
				this.filterRep.ListDataSGFilter(this, "Data Akun",this.sg1, this.sg1.row, this.sg1.col,
												"select kdperk2,nmperk2 from t_perk2",
												"select count(*) from t_perk2",
												new Array("kdperk2","nmperk2"),"where",new Array("kode","nama"));
			}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kdperk2",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							  this.filterRep.filterStr("a.nmperk2",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");

							  this.showFilter = this.filterRep.showFilter(this.sg1);
				this.nama_report = "server_report_saku3_saiba_rptAkun2";
