window.app_saku3_report_saiba_flNeracaPercobaan = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_saiba_flNeracaPercobaan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_saiba_flNeracaPercobaan";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,[0,1,2],["Kode Akun","All",""]);
...
window.app_saku3_report_saiba_flNeracaPercobaan.extend(window.portalui_childForm);
window.app_saku3_report_saiba_flNeracaPercobaan.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,["Tahunan","Semester","Bulanan"]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			{			
				this.nama_report="server_report_saku3_saiba_rptNeracaTahun";
			}
			if (this.sg1.getCell(2,6)=="Semester")
			{
				this.nama_report="server_report_saku3_saiba_rptNeracaSemester";
			}
			if (this.sg1.getCell(2,6)=="Bulanan")
			{
				this.nama_report="server_report_saku3_saiba_rptNeracaBulan";
			}
