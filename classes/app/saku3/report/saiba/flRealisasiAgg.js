window.app_saku3_report_saiba_flRealisasiAgg = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_saiba_flRealisasiAgg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_saiba_flRealisasiAgg";
		this.maximize();
...
window.app_saku3_report_saiba_flRealisasiAgg.extend(window.portalui_childForm);
window.app_saku3_report_saiba_flRealisasiAgg.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,["Tahunan","Semester","Tahunan Komparatif","Semester Komparatif"]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			if (this.sg1.getCell(2,6)=="Tahunan Komparatif")
			{
				this.nama_report="server_report_saku3_saiba_rptOprBulan";
			}
			if (this.sg1.getCell(2,6)=="Semester Komparatif")
			{
				this.nama_report="server_report_saku3_saiba_rptOprBulan";
			}		
