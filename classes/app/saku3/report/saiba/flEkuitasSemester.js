// JavaScript Document
window.app_saku3_report_saiba_flEkuitasSemester = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_saiba_flEkuitasSemester.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_saiba_flEkuitasSemester";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Kementrian Negara/Lembaga","=",this.app._kodePP));
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Periode","=",this.periode));
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Wilayah/Propinsi","=",this.akun));
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("Jenis Kewenangan","=",this.akun));
...
window.app_saku3_report_saiba_flEkuitasSemester.extend(window.portalui_childForm);
window.app_saku3_report_saiba_flEkuitasSemester.implement({
	...
	doSelectCell : function(sender, col, row){
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3],["123","13","13","3"]);
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3],[2,2,0,2]);	
		if (row == 1)
		{
			this.sg1.columns.get(2).pickList.clear();
			this.dbLib.setItemsFromSQL("select distinct periode from trans_m where kode_lokasi='"+this.app._lokasi+"' order by periode desc",[this.sg1.columns.get(2).pickList]);
		}
		...
		try
		{
			...
			else
			{
				...
				this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+
							this.filterRep.filterStr("c.kode_pp",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1)," and ")+
				...
				this.nama_report="server_report_saku3_saiba_rptEkuitasSemester";
				this.dbLib.execQuerySync(this.sql);	
	...
	doOpenJurnal: function(no_bukti,kode_lokasi){
		...
		filter2="";
		nama_report="server_report_saku3_produk_rptKbJurnalKb";
