window.app_saku3_report_saiba_flBukuBesarNeraca = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_saiba_flBukuBesarNeraca.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_saiba_flBukuBesarNeraca";
		this.maximize();
...
window.app_saku3_report_saiba_flBukuBesarNeraca.extend(window.childForm);
window.app_saku3_report_saiba_flBukuBesarNeraca.implement({
