window.app_saku3_report_saiba_flOperasional = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_saiba_flOperasional.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_saiba_flOperasional";
		this.maximize();
...
window.app_saku3_report_saiba_flOperasional.extend(window.portalui_childForm);
window.app_saku3_report_saiba_flOperasional.implement({
