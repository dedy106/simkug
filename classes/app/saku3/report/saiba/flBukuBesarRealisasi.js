window.app_saku3_report_saiba_flBukuBesarRealisasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_saiba_flBukuBesarRealisasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_saiba_flBukuBesarRealisasi";
		this.maximize();
...
window.app_saku3_report_saiba_flBukuBesarRealisasi.extend(window.childForm);
window.app_saku3_report_saiba_flBukuBesarRealisasi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_saiba_rptBukuBesarNeraca";
