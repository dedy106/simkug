window.app_saku3_report_saiba_flAkun6 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_saiba_flAkun6.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_saiba_flAkun6";
		this.maximize();
...
window.app_saku3_report_saiba_flAkun6.extend(window.childForm);
window.app_saku3_report_saiba_flAkun6.implement({
