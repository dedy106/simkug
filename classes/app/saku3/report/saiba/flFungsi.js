window.app_saku3_report_saiba_flFungsi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_saiba_flFungsi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_saiba_flFungsi";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Data BA-ES1", 2);
	...
	this.gridLib.SGEditData(this.sg1,0,new Array(0,1,2), new Array("Fungsi","All",""));
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Subfungsi","All",""));
	
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_saiba_flFungsi.extend(window.childForm);
window.app_saku3_report_saiba_flFungsi.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row ==1)
			{
				this.filterRep.ListDataSGFilter(this, "Data Sub",this.sg1, this.sg1.row, this.sg1.col,
												"select distinct kdsfungsi, nmsfungsi from t_sfungsi",
												"select count(*) from t_sfungsi",
												new Array("kdsfungsi","nmfungsi"),"where",new Array("Kode","Nama"));
			}
		}catch(e){
			systemAPI.alert(e);
		}
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kdfungsi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							  this.filterRep.filterStr("a.nmfungsi",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");

							  this.showFilter = this.filterRep.showFilter(this.sg1);
				this.nama_report = "server_report_saku3_saiba_rptFungsi";
