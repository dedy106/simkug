window.app_saku3_report_saiba_flEkuitas = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_saiba_flEkuitas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_saiba_flEkuitas";
		this.maximize();
...
window.app_saku3_report_saiba_flEkuitas.extend(window.portalui_childForm);
window.app_saku3_report_saiba_flEkuitas.implement({
