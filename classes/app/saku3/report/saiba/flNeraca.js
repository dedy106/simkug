window.app_saku3_report_saiba_flNeraca = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_saiba_flNeraca.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_saiba_flNeraca";
		this.maximize();
...
window.app_saku3_report_saiba_flNeraca.extend(window.portalui_childForm);
window.app_saku3_report_saiba_flNeraca.implement({
