window.app_saku3_report_optik_flMitra = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_optik_flMitra.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_optik_flMitra";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Kode Mitra","All",""));
...
window.app_saku3_report_optik_flMitra.extend(window.childForm);
window.app_saku3_report_optik_flMitra.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_optik_rptMitra";
			...
			systemAPI.alert("[app_saku3_report_optik_flMitra]::mainButtonClick:"+e);
		}
	},
