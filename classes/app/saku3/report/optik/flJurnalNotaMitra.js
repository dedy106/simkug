// JavaScript Document
window.app_saku3_report_optik_flJurnalNotaMitra = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_optik_flJurnalNotaMitra.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_optik_flJurnalNotaMitra";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from trans_m where form='JMITRA'  and kode_lokasi='"+this.app._lokasi+"'");
...
window.app_saku3_report_optik_flJurnalNotaMitra.extend(window.portalui_childForm);
window.app_saku3_report_optik_flJurnalNotaMitra.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_optik_rptJurnalNotaMitra";
