// JavaScript Document
window.app_saku3_report_optik_flJurnalApp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_optik_flJurnalApp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_optik_flJurnalApp";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from trans_m where form='APPROVE'  and kode_lokasi='"+this.app._lokasi+"'");
...
window.app_saku3_report_optik_flJurnalApp.extend(window.portalui_childForm);
window.app_saku3_report_optik_flJurnalApp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_optik_rptJurnalApp";
