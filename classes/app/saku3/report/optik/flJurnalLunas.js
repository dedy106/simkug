// JavaScript Document
window.app_saku3_report_optik_flJurnalLunas = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_optik_flJurnalLunas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_optik_flJurnalLunas";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from trans_m where form='KBBILL'  and kode_lokasi='"+this.app._lokasi+"'");
...
window.app_saku3_report_optik_flJurnalLunas.extend(window.portalui_childForm);
window.app_saku3_report_optik_flJurnalLunas.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_optik_rptJurnalLunas";
