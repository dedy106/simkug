window.app_saku3_report_optik_flPeserta = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_optik_flPeserta.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_optik_flPeserta";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Kode Peserta","All",""));
...
window.app_saku3_report_optik_flPeserta.extend(window.childForm);
window.app_saku3_report_optik_flPeserta.implement({
		...
		try{			
			...
			if (row ==1)
			{
				this.filterRep.ListDataSGFilter(this, "Data Peserta",this.sg1, this.sg1.row, this.sg1.col,
												"select kode_loker, nama from optik_loker ",
												"select count(*) from optik_loker ",
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_optik_rptPeserta";
			...
			systemAPI.alert("[app_saku3_report_optik_flPeserta]::mainButtonClick:"+e);
		}
	},
