window.app_saku3_report_bpr_flPiutangKartu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bpr_flPiutangKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bpr_flPiutangKartu";
		this.maximize();
...
window.app_saku3_report_bpr_flPiutangKartu.extend(window.childForm);
window.app_saku3_report_bpr_flPiutangKartu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_bpr_rptPiutangKartu";
			...
			systemAPI.alert("[app_saku3_report_bpr_flPiutangKartu]::mainButtonClick:"+e);
		}
	},
