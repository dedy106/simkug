window.app_saku3_report_bpr_flSimpSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bpr_flSimpSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bpr_flSimpSaldo";
		this.maximize();
...
window.app_saku3_report_bpr_flSimpSaldo.extend(window.childForm);
window.app_saku3_report_bpr_flSimpSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_bpr_rptSimpSaldo";
