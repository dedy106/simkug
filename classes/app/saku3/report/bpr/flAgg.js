window.app_saku3_report_bpr_flAgg = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bpr_flAgg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bpr_flAgg";
		this.maximize();
...
window.app_saku3_report_bpr_flAgg.extend(window.childForm);
window.app_saku3_report_bpr_flAgg.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_bpr_rptAgg";
