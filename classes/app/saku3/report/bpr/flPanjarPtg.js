window.app_saku3_report_bpr_flPanjarPtg = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bpr_flPanjarPtg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bpr_flPanjarPtg";
		this.maximize();
...
window.app_saku3_report_bpr_flPanjarPtg.extend(window.childForm);
window.app_saku3_report_bpr_flPanjarPtg.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_bpr_rptPtgPnjr";
			...
			systemAPI.alert("[app_saku3_report_bpr_flPanjarPtg]::mainButtonClick:"+e);
		}
	},
