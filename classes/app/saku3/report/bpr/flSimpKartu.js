window.app_saku3_report_bpr_flSimpKartu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bpr_flSimpKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bpr_flSimpKartu";
		this.maximize();
...
window.app_saku3_report_bpr_flSimpKartu.extend(window.childForm);
window.app_saku3_report_bpr_flSimpKartu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_bpr_rptSimpKartu";
