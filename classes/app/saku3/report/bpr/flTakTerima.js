window.app_saku3_report_bpr_flTakTerima = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bpr_flTakTerima.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bpr_flTakTerima";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from trans_m where form='TTUMUM' and kode_lokasi='"+this.app._lokasi+"' ");
...
window.app_saku3_report_bpr_flTakTerima.extend(window.childForm);
window.app_saku3_report_bpr_flTakTerima.implement({
		...
		try{			
			...
			if (row ==2)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data TAK Terima",this.sg1, this.sg1.row, this.sg1.col,
												...
												new Array("a.no_bukti","a.keterangan"),"and",new Array("No Terima","Keterangan"));
			}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_bpr_flTakTerima]::mainButtonClick:"+e);
		}
	},
