window.app_saku3_report_bpr_flAng = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bpr_flAng.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bpr_flAng";
		this.maximize();
...
window.app_saku3_report_bpr_flAng.extend(window.portalui_childForm);
window.app_saku3_report_bpr_flAng.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_bpr_rptAggBulan";
