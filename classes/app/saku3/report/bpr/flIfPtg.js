window.app_saku3_report_bpr_flIfPtg = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bpr_flIfPtg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bpr_flIfPtg";
		this.maximize();
...
window.app_saku3_report_bpr_flIfPtg.extend(window.childForm);
window.app_saku3_report_bpr_flIfPtg.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_bpr_flIfPtg]::mainButtonClick:"+e);
		}
	},
