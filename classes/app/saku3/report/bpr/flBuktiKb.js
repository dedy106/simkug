// JavaScript Document
window.app_saku3_report_bpr_flBuktiKb = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bpr_flBuktiKb.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bpr_flBuktiKb";
		this.maximize();
...
window.app_saku3_report_bpr_flBuktiKb.extend(window.portalui_childForm);
window.app_saku3_report_bpr_flBuktiKb.implement({
