window.app_saku3_report_bpr_flPinjBill = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bpr_flPinjBill.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bpr_flPinjBill";
		this.maximize();
...
window.app_saku3_report_bpr_flPinjBill.extend(window.childForm);
window.app_saku3_report_bpr_flPinjBill.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_bpr_rptPinjBill";
