window.app_saku3_report_bpr_flSimpKas = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bpr_flSimpKas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bpr_flSimpKas";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from trans_m where kode_lokasi='"+this.app._lokasi+"' and modul='KBSIMP'");
...
window.app_saku3_report_bpr_flSimpKas.extend(window.childForm);
window.app_saku3_report_bpr_flSimpKas.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_bpr_rptSimpKas";
			...
			systemAPI.alert("[app_saku3_report_bpr_flSimpKas]::mainButtonClick:"+e);
		}
	},
