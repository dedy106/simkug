// JavaScript Document
window.app_saku3_report_bpr_flAggRkap = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bpr_flAggRkap.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bpr_flAggRkap";
		this.maximize();
...
window.app_saku3_report_bpr_flAggRkap.extend(window.portalui_childForm);
window.app_saku3_report_bpr_flAggRkap.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_bpr_rptAggRkap";
