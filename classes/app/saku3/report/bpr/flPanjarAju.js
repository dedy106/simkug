window.app_saku3_report_bpr_flPanjarAju = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bpr_flPanjarAju.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bpr_flPanjarAju";
		this.maximize();
...
window.app_saku3_report_bpr_flPanjarAju.extend(window.childForm);
window.app_saku3_report_bpr_flPanjarAju.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_bpr_rptPanjarAju";
			...
			systemAPI.alert("[app_saku3_report_bpr_flPanjarAju]::mainButtonClick:"+e);
		}
	},
