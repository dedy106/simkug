window.app_saku3_report_bpr_flAggDis = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bpr_flAggDis.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bpr_flAggDis";
		this.maximize();
...
window.app_saku3_report_bpr_flAggDis.extend(window.portalui_childForm);
window.app_saku3_report_bpr_flAggDis.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_bpr_rptAggDis";	
