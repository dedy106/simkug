window.app_saku3_report_bpr_flPinjKartu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bpr_flPinjKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bpr_flPinjKartu";
		this.maximize();
...
window.app_saku3_report_bpr_flPinjKartu.extend(window.childForm);
window.app_saku3_report_bpr_flPinjKartu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_bpr_rptPinjKartu";
