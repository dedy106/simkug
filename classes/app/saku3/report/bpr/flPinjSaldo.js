window.app_saku3_report_bpr_flPinjSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bpr_flPinjSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bpr_flPinjSaldo";
		this.maximize();
	...
	{
		this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Anggota","=",this.app._userLog));
	}
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("No Bukti","All",""));
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_bpr_flPinjSaldo.extend(window.childForm);
window.app_saku3_report_bpr_flPinjSaldo.implement({
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3],["3","23","123","123"]);
