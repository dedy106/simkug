window.app_saku3_report_bpr_flPjSaldoC = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bpr_flPjSaldoC.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bpr_flPjSaldoC";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Saldo Panjar", 2);
...
window.app_saku3_report_bpr_flPjSaldoC.extend(window.portalui_childForm);
window.app_saku3_report_bpr_flPjSaldoC.prototype.doEllipseClick= function(sender, col, row)
{
	if (row ==1)
	{
...
window.app_saku3_report_bpr_flPjSaldoC.prototype.doSelectCell = function(sender, col, row)
{
...
window.app_saku3_report_bpr_flPjSaldoC.prototype.mainButtonClick = function(sender)
{
	try
	{
		...
		if (this.sg1.getCell(1,1) == "=")
		{
			...
			{
				var sql = "call sp_glma_panjar_tmp ('"+this.kode_lokasi+"','"+this.kode_lokasi1+"','"+this.kode_lokasi2+"','"+this.sg1.getCell(2,0)+"','"+this.nik_user+"')";
				this.nama_report="server_report_saku3_bpr_rptPjSaldo";
			}
...
window.app_saku3_report_bpr_flPjSaldoC.prototype.doRequestReady = function(sender, methodName, result)
{
	switch (methodName)
	{
		case "preview" : 
...
window.app_saku3_report_bpr_flPjSaldoC.prototype.doSelectedPage = function(sender, page)
{
	this.report.preview(this.nama_report,this.filter, page,this.pager, this.showFilter,this.lokasi, this.filter2);
	this.page=page;
	this.allBtn = false;
};
window.app_saku3_report_bpr_flPjSaldoC.prototype.doCloseReportClick = function(sender)
{
...
window.app_saku3_report_bpr_flPjSaldoC.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_saku3_report_bpr_flPjSaldoC.prototype.doRowPerPageChange = function(sender, rowperpage)
{
