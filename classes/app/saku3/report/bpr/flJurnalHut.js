window.app_saku3_report_bpr_flJurnalHut = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bpr_flJurnalHut.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bpr_flJurnalHut";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from trans_m where modul='AP'  ");
...
window.app_saku3_report_bpr_flJurnalHut.extend(window.childForm);
window.app_saku3_report_bpr_flJurnalHut.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_bpr_rptJurnalHut";
			...
			systemAPI.alert("[app_saku3_report_bpr_flJurnalHut]::mainButtonClick:"+e);
		}
	},
