window.app_saku3_report_bpr_flPnjrSal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bpr_flPnjrSal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bpr_flPnjrSal";
		this.maximize();
...
window.app_saku3_report_bpr_flPnjrSal.extend(window.childForm);
window.app_saku3_report_bpr_flPnjrSal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_bpr_rptPnjrSal";
