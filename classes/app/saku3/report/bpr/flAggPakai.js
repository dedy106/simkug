window.app_saku3_report_bpr_flAggPakai = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bpr_flAggPakai.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bpr_flAggPakai";
		this.maximize();
...
window.app_saku3_report_bpr_flAggPakai.extend(window.portalui_childForm);
window.app_saku3_report_bpr_flAggPakai.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_bpr_rptAggPakai";
