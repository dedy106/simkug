window.app_saku3_report_bpr_flKbVer = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bpr_flKbVer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bpr_flKbVer";
		this.maximize();
...
window.app_saku3_report_bpr_flKbVer.extend(window.childForm);
window.app_saku3_report_bpr_flKbVer.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_bpr_flKbVer]::mainButtonClick:"+e);
		}
	},
