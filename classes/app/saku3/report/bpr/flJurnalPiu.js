window.app_saku3_report_bpr_flJurnalPiu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bpr_flJurnalPiu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bpr_flJurnalPiu";
		this.maximize();
...
window.app_saku3_report_bpr_flJurnalPiu.extend(window.childForm);
window.app_saku3_report_bpr_flJurnalPiu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_bpr_rptJurnalPiu";
			...
			systemAPI.alert("[app_saku3_report_bpr_flJurnalPiu]::mainButtonClick:"+e);
		}
	},
