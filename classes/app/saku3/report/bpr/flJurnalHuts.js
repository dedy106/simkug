window.app_saku3_report_bpr_flJurnalHuts = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bpr_flJurnalHuts.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bpr_flJurnalHuts";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from trans_m where modul='KB'  ");
...
window.app_saku3_report_bpr_flJurnalHuts.extend(window.childForm);
window.app_saku3_report_bpr_flJurnalHuts.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_bpr_rptJurnalHuts";
			...
			systemAPI.alert("[app_saku3_report_bpr_flJurnalHuts]::mainButtonClick:"+e);
		}
	},
