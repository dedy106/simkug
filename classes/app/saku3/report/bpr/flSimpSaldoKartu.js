window.app_saku3_report_bpr_flSimpSaldoKartu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bpr_flSimpSaldoKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bpr_flSimpSaldoKartu";
		this.maximize();
	...
	{
		this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Anggota","All",""));
	}
	else
	{
		this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Anggota","=",this.app._userLog));
	}
	
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_bpr_flSimpSaldoKartu.extend(window.childForm);
window.app_saku3_report_bpr_flSimpSaldoKartu.implement({
		...
		try
		{
			...
			else
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							  this.filterRep.filterStr("a.no_agg",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");
				this.filter2 = this.sg1.getCell(2,0);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				
				this.nama_report = "server_report_saku3_bpr_rptSimpSaldoKartu";
