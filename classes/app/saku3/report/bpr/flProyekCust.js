window.app_saku3_report_bpr_flProyekCust = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bpr_flProyekCust.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bpr_flProyekCust";
		this.maximize();
...
window.app_saku3_report_bpr_flProyekCust.extend(window.childForm);
window.app_saku3_report_bpr_flProyekCust.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_bpr_rptProyekCust";
			...
			systemAPI.alert("[app_saku3_report_bpr_flProyekCust]::mainButtonClick:"+e);
		}
	},
