window.app_saku3_report_bpr_flAggTahun = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bpr_flAggTahun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bpr_flAggTahun";
		this.maximize();
...
window.app_saku3_report_bpr_flAggTahun.extend(window.portalui_childForm);
window.app_saku3_report_bpr_flAggTahun.implement({
		...
		try
		{
			...
			else
			{
				...
				if (this.sg1.getCell(2,6)=="Triwulan")
				{
					...
					this.nama_report="server_report_saku3_bpr_rptAggRealTw";
				}
				if (this.sg1.getCell(2,6)=="Semester")
				{
					...
					this.nama_report="server_report_saku3_gar_rptAggRealSem";
				}
				if (this.sg1.getCell(2,6)=="Bulanan")
				{
					...
					this.nama_report="server_report_saku3_gar_rptAggRealBulan";
				}
