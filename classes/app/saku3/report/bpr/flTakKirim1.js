window.app_saku3_report_bpr_flTakKirim1 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bpr_flTakKirim1.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bpr_flTakKirim1";
		this.maximize();
...
window.app_saku3_report_bpr_flTakKirim1.extend(window.childForm);
window.app_saku3_report_bpr_flTakKirim1.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from trans_m order by periode",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
		if (row == 3)
		{
			this.sg1.columns.get(2).pickList.clear();
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_bpr_flTakKirim1]::mainButtonClick:"+e);
		}
	},
