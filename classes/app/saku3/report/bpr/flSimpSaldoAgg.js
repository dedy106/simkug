window.app_saku3_report_bpr_flSimpSaldoAgg = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bpr_flSimpSaldoAgg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bpr_flSimpSaldoAgg";
		this.maximize();
...
window.app_saku3_report_bpr_flSimpSaldoAgg.extend(window.childForm);
window.app_saku3_report_bpr_flSimpSaldoAgg.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_bpr_rptSimpSaldoAgg";
