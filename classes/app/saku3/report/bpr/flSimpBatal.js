window.app_saku3_report_bpr_flSimpBatal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bpr_flSimpBatal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bpr_flSimpBatal";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from trans_m where kode_lokasi='"+this.app._lokasi+"' and modul='BTLBILL'");
...
window.app_saku3_report_bpr_flSimpBatal.extend(window.childForm);
window.app_saku3_report_bpr_flSimpBatal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_bpr_rptSimpBatal";
			...
			systemAPI.alert("[app_saku3_report_bpr_flSimpBatal]::mainButtonClick:"+e);
		}
	},
