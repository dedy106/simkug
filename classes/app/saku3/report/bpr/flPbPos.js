window.app_saku3_report_bpr_flPbPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bpr_flPbPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bpr_flPbPos";
		this.maximize();
...
window.app_saku3_report_bpr_flPbPos.extend(window.childForm);
window.app_saku3_report_bpr_flPbPos.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from trans_m where  form='PBDIR' andkode_lokasi='"+this.app._lokasi+"' order by periode",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_bpr_rptPbPos";
			...
			systemAPI.alert("[app_saku3_report_bpr_flPbPos]::mainButtonClick:"+e);
		}
	},
