window.app_saku3_report_bpr_flJurnalAkru = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bpr_flJurnalAkru.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bpr_flJurnalAkru";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from trans_m where modul='AR'  ");
...
window.app_saku3_report_bpr_flJurnalAkru.extend(window.childForm);
window.app_saku3_report_bpr_flJurnalAkru.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_bpr_flJurnalAkru]::mainButtonClick:"+e);
		}
	},
