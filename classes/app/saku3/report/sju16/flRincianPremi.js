window.app_saku3_report_sju16_flRincianPremi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sju16_flRincianPremi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sju16_flRincianPremi";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Jenis","=","Akru Premi"));
...
window.app_saku3_report_sju16_flRincianPremi.extend(window.childForm);
window.app_saku3_report_sju16_flRincianPremi.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row == 4)
			{
				if (this.sg1.getCell(2,3)=="Akru Premi")
				{
					filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							" and a.form in ('BILL','BTL_BILL') ";
					var sql="select a.no_bukti,a.keterangan from trans_m a "+filter;
					var sql2="select count(a.no_bukti) from trans_m a "+filter;
				...
				if (this.sg1.getCell(2,3)=="Penerimaan Premi dan Brokerage Via Bank")
				{
					filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.periode",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
							" and  a.form in ('TRM_PREMI') and a.modul='KB' ";
					var sql="select a.no_bukti,a.keterangan from trans_m a "+filter;
					var sql2="select count(a.no_bukti) from trans_m a "+filter;
					this.filterRep.ListDataSGFilter(this, "Data Bukti",this.sg1, this.sg1.row, this.sg1.col,sql ,sql2,
													new Array("a.no_bukti","a.keterangan"),"and",new Array("No Bukti","Keterangan"));
				}
				if (this.sg1.getCell(2,3)=="Penerimaan Premi dan Brokerage Non Bank")
				{
					filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.periode",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
							" and a.form='FEE_PREMI' and a.modul='MI' ";
					var sql="select a.no_bukti,a.keterangan from trans_m a "+filter;
					var sql2="select count(a.no_bukti) from trans_m a "+filter;
					this.filterRep.ListDataSGFilter(this, "Data Bukti",this.sg1, this.sg1.row, this.sg1.col,sql ,sql2,
													new Array("a.no_bukti","a.keterangan"),"and",new Array("No Bukti","Keterangan"));
				...
				if (this.sg1.getCell(2,3)=="Pembayaran Hutang Premi Via Bank")
				{
					filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.periode",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
							" and a.form='BYR_PREMI' and a.modul='KB' ";
					var sql="select a.no_bukti,a.keterangan from trans_m a "+filter;
					var sql2="select count(a.no_bukti) from trans_m a "+filter;
					this.filterRep.ListDataSGFilter(this, "Data Bukti",this.sg1, this.sg1.row, this.sg1.col,sql ,sql2,
													new Array("a.no_bukti","a.keterangan"),"and",new Array("No Bukti","Keterangan"));
				}
				if (this.sg1.getCell(2,3)=="Pembayaran Hutang Premi Non Bank")
				{
					filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.periode",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
							" and a.form='BYR_PREMI' and a.modul='MI' ";
					var sql="select a.no_bukti,a.keterangan from ju_m a "+filter;
					var sql2="select count(a.no_bukti) from ju_m a "+filter;
					this.filterRep.ListDataSGFilter(this, "Data Bukti",this.sg1, this.sg1.row, this.sg1.col,sql ,sql2,
													new Array("a.no_bukti","a.keterangan"),"and",new Array("No Bukti","Keterangan"));
				}
				if (this.sg1.getCell(2,3)=="Pembayaran KasBank")
				{
					filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.periode",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
							" and a.form='BYR_PREMI' and a.modul='KB' ";
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4],["123","123","123","3","123"]);
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4],[2,2,0,0,2]);	
		if (row == 2)
		{
			this.sg1.columns.get(2).pickList.clear();
			this.dbLib.setItemsFromSQL("select distinct periode from trans_m where kode_lokasi='"+this.app._lokasi+"'  order by periode",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
		if (row == 3)
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("Akru Premi","Penerimaan Premi dan Brokerage Via Bank","Penerimaan Premi dan Brokerage Non Bank","Pembayaran Hutang Premi Via Bank","Pembayaran Hutang Premi Non Bank","Pembayaran KasBank"));
		}	
	},
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,2);
				if (this.sg1.getCell(2,3)=="Akru Premi")
				{
				...
				if (this.sg1.getCell(2,3)=="Penerimaan Premi dan Brokerage Non Bank")
				{
					this.nama_report = "server_report_saku3_sju16_rptJuRincianPremi";
				}
				if (this.sg1.getCell(2,3)=="Pembayaran Hutang Premi Via Bank")
				{
				...
				if (this.sg1.getCell(2,3)=="Pembayaran Hutang Premi Non Bank")
				{
					this.nama_report = "server_report_saku3_sju16_rptJuHutangPremi";
				}
				if (this.sg1.getCell(2,3)=="Pembayaran KasBank")
				{
					this.nama_report = "server_report_saku3_sju16_rptKbRincianHutangPremi2";
				}
			...
			systemAPI.alert("[app_saku3_report_sju16_flRincianPremi]::mainButtonClick:"+e);
		}
	},
