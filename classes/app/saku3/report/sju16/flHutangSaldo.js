window.app_saku3_report_sju16_flHutangSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sju16_flHutangSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sju16_flHutangSaldo";
		this.maximize();
...
window.app_saku3_report_sju16_flHutangSaldo.extend(window.childForm);
window.app_saku3_report_sju16_flHutangSaldo.implement({
	...
	{		
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("Outstanding Hutang Premi","Summary Mutasi","Detail Mutasi","Hutang","Hutang Summary"));
		}
		if (row == 4)
		{
			this.sg1.columns.get(2).pickList.clear();
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_sju16_rptHutangSaldoOut";
				if (this.sg1.getCell(2,3)=="Summary Mutasi")
				{
					this.nama_report = "server_report_saku3_sju16_rptHutangSaldo";
				}
				if (this.sg1.getCell(2,3)=="Detail Mutasi")
				{
					this.nama_report = "server_report_saku3_sju16_rptHutangSaldoPolis";
				}
				if (this.sg1.getCell(2,3)=="Hutang")
				{
					...
					this.nama_report = "server_report_saku3_sju16_rptHutang";
				}
				if (this.sg1.getCell(2,3)=="Hutang Summary")
				{
					this.filter = this.filter+ this.filterRep.filterStr("b.kode_pp",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");
					this.nama_report = "server_report_saku3_sju16_rptHutangSum";
				}
			...
			systemAPI.alert("[app_saku3_report_sju16_flHutangSaldo]::mainButtonClick:"+e);
		}
	},
