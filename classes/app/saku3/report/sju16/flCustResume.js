window.app_saku3_report_sju16_flCustResume = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sju16_flCustResume.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sju16_flCustResume";
		this.maximize();
...
window.app_saku3_report_sju16_flCustResume.extend(window.childForm);
window.app_saku3_report_sju16_flCustResume.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_sju16_rptCustResume";
			...
			systemAPI.alert("[app_saku3_report_sju16_flCustResume]::mainButtonClick:"+e);
		}
	},
