// JavaScript Document
window.app_saku3_report_sju16_flAkun = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sju16_flAkun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sju16_flAkun";
		this.maximize();
...
window.app_saku3_report_sju16_flAkun.extend(window.portalui_childForm);
window.app_saku3_report_sju16_flAkun.implement({
	doEllipseClick: function(sender, col, row){
		...
		if (row == 1)
		{
			...
			this.filterRep.ListDataSGFilter(this, "Data Akun",this.sg1, this.sg1.row, this.sg1.col,
												  "select kode_akun,kode_lokasi,nama from masakun "+filter,
												  "select count(kode_akun) from masakun "+filter,
											new Array("kode_akun","nama"),"and",new Array("Kode Akun","Nama Akun"));
		}
	},	
	doSelectCell: function(sender, col, row){
		
		this.filterRep.setSGFilterRowTipe(this.sg1,row,new Array(0,1),new  Array("13","123"));
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_sju16_rptAkun";
