window.app_saku3_report_sju16_flTagihan = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sju16_flTagihan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sju16_flTagihan";
		this.maximize();
...
window.app_saku3_report_sju16_flTagihan.extend(window.childForm);
window.app_saku3_report_sju16_flTagihan.implement({
