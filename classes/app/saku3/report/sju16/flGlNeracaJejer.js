window.app_saku3_report_sju16_flGlNeracaJejer = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sju16_flGlNeracaJejer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sju16_flGlNeracaJejer";
		this.maximize();
...
window.app_saku3_report_sju16_flGlNeracaJejer.extend(window.childForm);
window.app_saku3_report_sju16_flGlNeracaJejer.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				{
					this.nama_report="server_report_saku3_sju16_rptGlNeracaPpJejer";
				}
				if (this.sg1.getCell(2,3)=="FS2")
				{
					this.nama_report="server_report_saku3_sju16_rptGlNeracaRincianJejer";
				}
				if (this.sg1.getCell(2,3)=="FS3")
				{
					this.nama_report="server_report_saku3_sju16_rptGlPasivaRincianJejer";
				}
