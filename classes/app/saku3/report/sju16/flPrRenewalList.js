window.app_saku3_report_sju16_flPrRenewalList = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sju16_flPrRenewalList.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sju16_flPrRenewalList";
		this.maximize();
...
window.app_saku3_report_sju16_flPrRenewalList.extend(window.childForm);
window.app_saku3_report_sju16_flPrRenewalList.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_sju16_rptPrRenewalList";
			...
			systemAPI.alert("[app_saku3_report_sju16_flPrRenewalList]::mainButtonClick:"+e);
		}
	},
