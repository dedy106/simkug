window.app_saku3_report_sju16_flAgg = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sju16_flAgg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sju16_flAgg";
		this.maximize();
...
window.app_saku3_report_sju16_flAgg.extend(window.portalui_childForm);
window.app_saku3_report_sju16_flAgg.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_sju16_rptAggBulan";
