window.app_saku3_report_sju16_flKbTb = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sju16_flKbTb.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sju16_flKbTb";
		this.maximize();
...
window.app_saku3_report_sju16_flKbTb.extend(window.childForm);
window.app_saku3_report_sju16_flKbTb.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_sju16_rptKbTb";
	...
	doOpenBb: function(kode_akun,kode_lokasi){
		...
		nama_report="server_report_saku3_sju16_rptKbBukuBesar";
