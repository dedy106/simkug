window.app_saku3_report_sju16_flAjuBayar = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sju16_flAjuBayar.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sju16_flAjuBayar";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("No PB","All",""));
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
	this.doSelectCell(this.sg1,2,3);
};
window.app_saku3_report_sju16_flAjuBayar.extend(window.childForm);
window.app_saku3_report_sju16_flAjuBayar.implement({
		...
		try{	
			...
			if (row ==2)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data PB",this.sg1, this.sg1.row, this.sg1.col,
													"select a.no_pb, a.keterangan from sju_pb_m a "+filter,
													"select count(*) from sju_pb_m a "+filter,
													new Array("a.no_pb","a.nama"),"and",new Array("No PB","Keterangan"));
			}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_sju16_flAjuBayar]::mainButtonClick:"+e);
		}
	},
