window.app_saku3_report_sju16_flGlLabaRugiJejer = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sju16_flGlLabaRugiJejer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sju16_flGlLabaRugiJejer";
		this.maximize();
...
window.app_saku3_report_sju16_flGlLabaRugiJejer.extend(window.childForm);
window.app_saku3_report_sju16_flGlLabaRugiJejer.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_sju16_rptGlLabaRugiPpJejer";
				if (this.sg1.getCell(2,3)=="Divisi")
				{
					this.nama_report="server_report_saku3_sju16_rptGlLabaRugiBidangJejer";
				}
