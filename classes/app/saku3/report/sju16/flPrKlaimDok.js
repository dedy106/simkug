window.app_saku3_report_sju16_flPrKlaimDok = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sju16_flPrKlaimDok.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sju16_flPrKlaimDok";
		this.maximize();
...
window.app_saku3_report_sju16_flPrKlaimDok.extend(window.childForm);
window.app_saku3_report_sju16_flPrKlaimDok.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_sju16_rptPrKlaimDok";
			...
			systemAPI.alert("[app_saku3_report_sju16_flPrKlaimDok]::mainButtonClick:"+e);
		}
	},
