window.app_saku3_report_sju16_flAjuSpd = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sju16_flAjuSpd.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sju16_flAjuSpd";
		this.maximize();
...
window.app_saku3_report_sju16_flAjuSpd.extend(window.childForm);
window.app_saku3_report_sju16_flAjuSpd.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_sju16_rptAjuSpd";
			...
			systemAPI.alert("[app_saku3_report_sju16_flAjuSpd]::mainButtonClick:"+e);
		}
	},
