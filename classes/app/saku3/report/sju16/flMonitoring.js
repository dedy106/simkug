window.app_saku3_report_sju16_flMonitoring = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sju16_flMonitoring.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sju16_flMonitoring";
		this.maximize();
...
window.app_saku3_report_sju16_flMonitoring.extend(window.childForm);
window.app_saku3_report_sju16_flMonitoring.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			if (sender == this.app._mainForm.bBack)
			{
				...
				if (this.link=="2")
				{
					this.doOpenBayar(this.kode_lokasi);					
					
				}
				if (this.link=="3")
				{
					this.doOpenBb(this.kode_lokasi);					
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_sju16_rptMonitoring2";
			...
			systemAPI.alert("[app_saku3_report_sju16_flMonitoring]::mainButtonClick:"+e);
		}
	},
	...
	doOpenBayar: function(kode_lokasi){
		...
		nama_report="server_report_saku3_sju16_rptAjuMoni";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());

	},
	doOpenBb: function(kode_lokasi){

		this.kode_lokasi=kode_lokasi;
		this.link="3";
		filter = "where a.kode_lokasi='"+kode_lokasi+"' and a.no_kas <> '-' ";
		filter2="";
		
		nama_report="server_report_saku3_sju16_rptDetMoni";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());

	},
	doOpenJurnal: function(no_kas,kode_lokasi){
		this.no_kas=no_kas;
		this.kode_lokasi=kode_lokasi;
		this.link="2";
		filter = "where a.no_bukti='"+no_kas+"' and a.kode_lokasi='"+kode_lokasi+"' ";
		filter2="";
		nama_report="server_report_saku3_sju16_rptGlJurnal";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
