window.app_saku3_report_sju16_flAjuProm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sju16_flAjuProm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sju16_flAjuProm";
		this.maximize();
...
window.app_saku3_report_sju16_flAjuProm.extend(window.childForm);
window.app_saku3_report_sju16_flAjuProm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_sju16_flAjuProm]::mainButtonClick:"+e);
		}
	},
