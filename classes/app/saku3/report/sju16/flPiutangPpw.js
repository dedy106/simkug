window.app_saku3_report_sju16_flPiutangPpw = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sju16_flPiutangPpw.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sju16_flPiutangPpw";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2,3), new Array("Tanggal PPW","=",new Date().lclFormat(),""));
...
window.app_saku3_report_sju16_flPiutangPpw.extend(window.childForm);
window.app_saku3_report_sju16_flPiutangPpw.implement({
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4],["123","123","3","3","3"]);
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4],[2,2,1,0,0]);	
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2 = this.sg1.getCell(2,0)+"|"+this.sg1.getCellDateValue(2,2)+"|"+this.urut+"|"+this.sg1.getCell(2,2);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();	
				this.nama_report = "server_report_saku3_sju16_rptPiutangPpw";
				if (this.sg1.getCell(2,3)=="Summary")
				{
					this.nama_report = "server_report_saku3_sju16_rptPiutangPpwSum";
				}
			...
			systemAPI.alert("[app_saku3_report_sju16_flPiutangPpw]::mainButtonClick:"+e);
		}
	},
	...
	doOpenDetail: function(kode_cust,kode_lokasi){
		this.kode_cust=kode_cust;
		this.kode_lokasi=kode_lokasi;
		this.link="1";
		filter = "where b.kode_cust='"+kode_cust+"' and a.kode_lokasi='"+kode_lokasi+"' ";
		filter2=this.sg1.getCell(2,0)+"|"+this.sg1.getCellDateValue(2,2)+"|"+this.urut+"|"+this.sg1.getCell(2,2);
		
		nama_report="server_report_saku3_sju16_rptPiutangPpw";
