window.app_saku3_report_sju16_flCust = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sju16_flCust.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sju16_flCust";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Kode Tertanggung","All",""));
...
window.app_saku3_report_sju16_flCust.extend(window.childForm);
window.app_saku3_report_sju16_flCust.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_sju16_rptCust";
			...
			systemAPI.alert("[app_saku3_report_sju16_flCust]::mainButtonClick:"+e);
		}
	},
	...
	doOpenDok: function(kode_cust, kode_lokasi) {
        ...
        filter2 = "";
        nama_report = "server_report_saku3_sju16_rptCustDok";
