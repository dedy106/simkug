window.app_saku3_report_sju16_flGlTbJejerPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sju16_flGlTbJejerPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sju16_flGlTbJejerPp";
		this.maximize();
...
window.app_saku3_report_sju16_flGlTbJejerPp.extend(window.childForm);
window.app_saku3_report_sju16_flGlTbJejerPp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_sju16_rptGlTbJejerPp";
	...
	doOpenBb: function(kode_akun,kode_lokasi,periode,kode_pp){
		...
		filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.app._nikUser+"/"+this.sg1.getCell(1,1)+"/"+this.sg1.getCell(2,4);
