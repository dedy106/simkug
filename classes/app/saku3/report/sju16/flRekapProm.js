window.app_saku3_report_sju16_flRekapProm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sju16_flRekapProm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sju16_flRekapProm";
		this.maximize();
...
window.app_saku3_report_sju16_flRekapProm.extend(window.childForm);
window.app_saku3_report_sju16_flRekapProm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_sju16_rptRekapProm";
			...
			systemAPI.alert("[app_saku3_report_sju16_flRekapProm]::mainButtonClick:"+e);
		}
	},
