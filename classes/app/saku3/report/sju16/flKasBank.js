window.app_saku3_report_sju16_flKasBank = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sju16_flKasBank.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sju16_flKasBank";
		this.maximize();
...
window.app_saku3_report_sju16_flKasBank.extend(window.childForm);
window.app_saku3_report_sju16_flKasBank.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_sju16_flKasBank]::mainButtonClick:"+e);
		}
	},
