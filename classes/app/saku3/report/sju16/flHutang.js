window.app_saku3_report_sju16_flHutang = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sju16_flHutang.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sju16_flHutang";
		this.maximize();
...
window.app_saku3_report_sju16_flHutang.extend(window.childForm);
window.app_saku3_report_sju16_flHutang.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_sju16_flHutang]::mainButtonClick:"+e);
		}
	},
	...
	doOpenDetail: function(kode_cust,kode_lokasi){
		...
		filter = this.filter+ " and a.kode_vendor='"+kode_cust+"' and a.kode_lokasi='"+kode_lokasi+"' ";
		filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,2)+"/"+this.sg1.getCell(2,9);
		
		nama_report="server_report_saku3_sju16_rptHutang";
