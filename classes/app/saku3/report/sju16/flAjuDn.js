window.app_saku3_report_sju16_flAjuDn = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sju16_flAjuDn.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sju16_flAjuDn";
		this.maximize();
...
window.app_saku3_report_sju16_flAjuDn.extend(window.childForm);
window.app_saku3_report_sju16_flAjuDn.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_sju16_flAjuDn]::mainButtonClick:"+e);
		}
	},
