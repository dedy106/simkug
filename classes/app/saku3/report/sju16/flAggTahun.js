window.app_saku3_report_sju16_flAggTahun = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sju16_flAggTahun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sju16_flAggTahun";
		this.maximize();
...
window.app_saku3_report_sju16_flAggTahun.extend(window.portalui_childForm);
window.app_saku3_report_sju16_flAggTahun.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_sju16_rptAggRealBulanPp";
