window.app_saku3_report_sju16_flGlPdpt = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sju16_flGlPdpt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sju16_flGlPdpt";
		this.maximize();
...
window.app_saku3_report_sju16_flGlPdpt.extend(window.childForm);
window.app_saku3_report_sju16_flGlPdpt.implement({
	...
	{		
		if (this.app._userStatus=="A")
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6],["123","123","3","3","13","13","3"]);
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5,6],[2,2,0,0,2,2,0]);	
		}
		else
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6],["123","3","3","3","13","13","3"]);
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5,6],[2,2,0,0,2,2,0]);	
		}
		if (row == 2)
		{
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,2)+"/"+this.app._nikUser+"/"+this.sg1.getCell(2,3)+"/"+this.sg1.getCell(2,1);
				...
				if (this.sg1.getCell(2,6)=="Tertanggung")
				{
					...
					{
						this.nama_report = "server_report_saku3_sju16_rptPdptNet";
					}
					else
					{
						this.nama_report = "server_report_saku3_sju16_rptPdptGross";
					}
				}
				if (this.sg1.getCell(2,6)=="PIC")
				{
					...
					if (this.sg1.getCell(2,3)=="NET")
					{
						this.nama_report = "server_report_saku3_sju16_rptPdptNetPic";
					}
					else
					{
						this.nama_report = "server_report_saku3_sju16_rptPdptGrossPic";
					}
				}
			...
			systemAPI.alert("[app_saku3_report_sju16_flGlPdpt]::mainButtonClick:"+e);
		}
	},
