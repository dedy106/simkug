window.app_saku3_report_sju16_flGlTb = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sju16_flGlTb.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sju16_flGlTb";
		this.maximize();
...
window.app_saku3_report_sju16_flGlTb.extend(window.childForm);
window.app_saku3_report_sju16_flGlTb.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				{
					this.filter=this.filter+this.filterRep.filterStr("a.kode_pp",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1)," and ");
				}
				this.filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,2)+"/"+this.app._nikUser+"/"+this.sg1.getCell(1,1)+"/"+this.sg1.getCell(2,4)+"//"+this.sg1.getCell(3,2);
				this.nama_report="server_report_saku3_sju16_rptGlTb";
