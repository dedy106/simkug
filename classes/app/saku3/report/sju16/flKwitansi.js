window.app_saku3_report_sju16_flKwitansi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sju16_flKwitansi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sju16_flKwitansi";
		this.maximize();
...
window.app_saku3_report_sju16_flKwitansi.extend(window.childForm);
window.app_saku3_report_sju16_flKwitansi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_sju16_rptPrKwitansi";
