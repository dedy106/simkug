window.app_saku3_report_sju16_flGlNeraca = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sju16_flGlNeraca.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sju16_flGlNeraca";
		this.maximize();
...
window.app_saku3_report_sju16_flGlNeraca.extend(window.childForm);
window.app_saku3_report_sju16_flGlNeraca.implement({
		...
		try{			
			...
			if (row == 3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data FS",this.sg1, this.sg1.row, this.sg1.col,
														  "select kode_fs,nama from fs "+lokasi+" and kode_fs in ('FS1','FS2','FS3','FS10','FS11')",
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				if (this.sg1.getCell(2,3)=="FS1")
				{
					this.nama_report="server_report_saku3_sju16_rptGlNeraca";
				}
				if (this.sg1.getCell(2,3)=="FS2")
				{
					this.nama_report="server_report_saku3_sju16_rptGlNeracaRincian";
				}
				if (this.sg1.getCell(2,3)=="FS3")
				{
					this.nama_report="server_report_saku3_sju16_rptGlPasivaRincian";
				}
				if (this.sg1.getCell(2,3)=="FS10")
				{
					this.nama_report="server_report_saku3_sju16_rptGlNeraca";
				}
				if (this.sg1.getCell(2,3)=="FS11")
				{
					this.nama_report="server_report_saku3_sju16_rptGlNeraca";
				}
