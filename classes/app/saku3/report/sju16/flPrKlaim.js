window.app_saku3_report_sju16_flPrKlaim = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sju16_flPrKlaim.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sju16_flPrKlaim";
		this.maximize();
...
window.app_saku3_report_sju16_flPrKlaim.extend(window.childForm);
window.app_saku3_report_sju16_flPrKlaim.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_sju16_rptPrKlaim";
			...
			systemAPI.alert("[app_saku3_report_sju16_flPrKlaim]::mainButtonClick:"+e);
		}
	},
