window.app_saku3_report_sju16_flPajakProm2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sju16_flPajakProm2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sju16_flPajakProm2";
		this.maximize();
...
window.app_saku3_report_sju16_flPajakProm2.extend(window.childForm);
window.app_saku3_report_sju16_flPajakProm2.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_sju16_rptPajakProm2";
			...
			systemAPI.alert("[app_saku3_report_sju16_flPajakProm2]::mainButtonClick:"+e);
		}
	},
