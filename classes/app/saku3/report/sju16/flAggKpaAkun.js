window.app_saku3_report_sju16_flAggKpaAkun = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sju16_flAggKpaAkun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sju16_flAggKpaAkun";
		this.maximize();
...
window.app_saku3_report_sju16_flAggKpaAkun.extend(window.portalui_childForm);
window.app_saku3_report_sju16_flAggKpaAkun.implement({
	...
	doSelectCell: function(sender, col, row){
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4],["123","123","3","123","3"]);
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4],[2,2,0,2,0]);
		
		if (row == 2)
		{
			this.sg1.columns.get(2).pickList.clear();
			this.dbLib.setItemsFromSQL("select distinct substring(periode,1,4) from anggaran_d "+
									   "where kode_lokasi='"+this.app._lokasi+"' order by substring(periode,1,4) desc",[this.sg1.columns.get(2).pickList]);
		}
		if (row == 4)
		{
			this.sg1.columns.get(2).pickList.clear();
	...
	mainButtonClick: function(sender){
		try
		{
			...
			if (this.sg1.getCell(1,4)!="All")
			{
				...
				{
					jenis=" and b.jenis='Neraca' ";
				}
				else
				{
					jenis=" and b.jenis='"+this.sg1.getCell(2,4)+"' ";
				}
			}
			...
			this.filter=this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
						...
						this.filterRep.filterStr("a.kode_akun",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and")+jenis;
			this.filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,2)+"/"+this.sg1.getCell(2,4)+"/"+this.app._nikUser;	
			
			this.nama_report="server_report_saku3_sju16_rptAggKpaAkunPp";
