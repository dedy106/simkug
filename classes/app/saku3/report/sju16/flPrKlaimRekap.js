window.app_saku3_report_sju16_flPrKlaimRekap = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sju16_flPrKlaimRekap.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sju16_flPrKlaimRekap";
		this.maximize();
...
window.app_saku3_report_sju16_flPrKlaimRekap.extend(window.childForm);
window.app_saku3_report_sju16_flPrKlaimRekap.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_sju16_rptPrKlaimRekap";
			...
			systemAPI.alert("[app_saku3_report_sju16_flPrKlaimRekap]::mainButtonClick:"+e);
		}
	},
