window.app_saku3_report_sju16_flPiutang = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sju16_flPiutang.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sju16_flPiutang";
		this.maximize();
		...
		this.sg1 = new saiGrid(this.p1,{bound:[1,20,700,220],colCount:4,cellExit:[this,"doCellExit"],
...
window.app_saku3_report_sju16_flPiutang.extend(window.childForm);
window.app_saku3_report_sju16_flPiutang.implement({
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("c.periode",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
							this.filterRep.filterStr("b.kode_tipe",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and")+
							this.filterRep.filterStr("b.kode_cust",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4),"and")+
							this.filterRep.filterStr("b.kode_pic",this.sg1.getCell(1,6),this.sg1.getCell(2,6),this.sg1.getCell(3,6),"and")+
							this.filterRep.filterStr("a.no_polis",this.sg1.getCell(1,7),this.sg1.getCell(2,7),this.sg1.getCell(3,7),"and");
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,2)+"/"+this.sg1.getCell(2,9);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				if (this.sg1.getCell(2,8)=="Summary")
				{				
					this.nama_report = "server_report_saku3_sju16_rptPiutangSum";
				}
				if (this.sg1.getCell(2,8)=="Detail")
				{				
			...
			systemAPI.alert("[app_saku3_report_sju16_flPiutang]::mainButtonClick:"+e);
		}
	},
	...
	doOpenDetail: function(kode_cust,kode_lokasi){
		...
		filter = this.filter+ " and b.kode_cust='"+kode_cust+"' and a.kode_lokasi='"+kode_lokasi+"' ";
		filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,2)+"/"+this.sg1.getCell(2,9);
		
		nama_report="server_report_saku3_sju16_rptPiutang";
