// JavaScript Document
window.app_saku3_report_sju16_flStruktur = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sju16_flStruktur.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sju16_flStruktur";
		this.maximize();
...
window.app_saku3_report_sju16_flStruktur.extend(window.portalui_childForm);
window.app_saku3_report_sju16_flStruktur.implement({
	doEllipseClick: function(sender, col, row){
		...
		if (row == 1)
		{
			...
			this.filterRep.ListDataSGFilter(this, "Data FS",this.sg1, this.sg1.row, this.sg1.col,
												  "select kode_fs,kode_lokasi,nama from fs "+filter,
												  "select count(kode_fs) from fs "+filter,
		...
		if (row == 2)
		{
			...
			this.filterRep.ListDataSGFilter(this, "Data Neraca",this.sg1, this.sg1.row, this.sg1.col,
												  "select kode_neraca,nama from neraca "+filter,
												  "select count(kode_neraca) from neraca "+filter,
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_sju16_rptStruktur";
			if (this.sg1.getCell(2,3)=="Relasi Akun")
			{
				this.nama_report="server_report_saku3_sju16_rptStrukturRelasi";
			}
