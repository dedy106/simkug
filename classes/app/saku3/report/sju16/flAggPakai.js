window.app_saku3_report_sju16_flAggPakai = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sju16_flAggPakai.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sju16_flAggPakai";
		this.maximize();
...
window.app_saku3_report_sju16_flAggPakai.extend(window.portalui_childForm);
window.app_saku3_report_sju16_flAggPakai.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_sju16_rptAggPakai";
