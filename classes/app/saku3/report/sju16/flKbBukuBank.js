window.app_saku3_report_sju16_flKbBukuBank = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sju16_flKbBukuBank.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sju16_flKbBukuBank";
		this.maximize();
...
window.app_saku3_report_sju16_flKbBukuBank.extend(window.childForm);
window.app_saku3_report_sju16_flKbBukuBank.implement({
	...
	{		
		...
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5,6],[2,2,0,2,0,1,0]);	
		if (row == 2)
		{
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,2)+"/"+this.app._nikUser+"/"+this.sg1.getCell(1,1)+"/"+this.sg1.getCell(2,4)+"/"+this.sg1.getCell(2,6);
				this.nama_report="server_report_saku3_sju16_rptKbBukuBank";
