window.app_saku3_report_sju16_flEmail = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sju16_flEmail.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sju16_flEmail";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Acc Marketing","All",""));
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2,3), new Array("Tanggal Jatuh Tempo","=",new Date().lclFormat(),new Date().lclFormat()));
...
window.app_saku3_report_sju16_flEmail.extend(window.childForm);
window.app_saku3_report_sju16_flEmail.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row ==	1)
			{
				this.filterRep.ListDataSGFilter(this, "Data Acc Marketing",this.sg1, this.sg1.row, this.sg1.col,
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.kode_pic",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("a.tgl_selesai",this.sg1.getCell(1,2),this.sg1.getCellDateValue(2,2),this.sg1.getCellDateValue(3,2),"and");
				this.filter2 = this.sg1.getCell(2,1);
				this.showFilter = this.filterRep.filterStr("a.kode_pic",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"where")+"/";
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_sju16_rptEmail";
			...
			systemAPI.alert("[app_saku3_report_sju16_flEmail]::mainButtonClick:"+e);
		}
	},
