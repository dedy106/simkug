window.app_saku3_report_kantintu_flJurnalRekon = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kantintu_flJurnalRekon.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kantintu_flJurnalRekon";
		this.maximize();
...
window.app_saku3_report_kantintu_flJurnalRekon.extend(window.childForm);
window.app_saku3_report_kantintu_flJurnalRekon.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_kantintu_rptJurnalRekon";
			...
			systemAPI.alert("[app_saku3_report_kantintu_flJurnalRekon]::mainButtonClick:"+e);
		}
	},
