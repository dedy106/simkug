window.app_saku3_report_kantintu_flRekon = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kantintu_flRekon.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kantintu_flRekon";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Nomor Rekon Tenan","All",""));
...
window.app_saku3_report_kantintu_flRekon.extend(window.childForm);
window.app_saku3_report_kantintu_flRekon.implement({
		...
		try{			
			...
			if (row ==	1)
			{
				this.filterRep.ListDataSGFilter(this, "Data Mitra",this.sg1, this.sg1.row, this.sg1.col,
														  "select no_rekon, kode_tenan from ktu_rekon_d "+
														   this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  "select count(no_rekon) from ktu_rekon_d "+
														  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  new Array("no_rekon","kode_tenan"),"and");
			}
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.no_rekon",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");
			...
			systemAPI.alert("[app_saku3_report_kantintu_flRekon]::mainButtonClick:"+e);
		}
	},
