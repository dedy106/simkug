window.app_saku3_report_kantintu_flJurnalTcash = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kantintu_flJurnalTcash.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kantintu_flJurnalTcash";
		this.maximize();
...
window.app_saku3_report_kantintu_flJurnalTcash.extend(window.childForm);
window.app_saku3_report_kantintu_flJurnalTcash.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_kantintu_rptJurnalTcash";
			...
			systemAPI.alert("[app_saku3_report_kantintu_flJurnalTcash]::mainButtonClick:"+e);
		}
	},
