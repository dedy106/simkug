window.app_saku3_report_kantintu_flJurnalBA = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kantintu_flJurnalBA.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kantintu_flJurnalBA";
		this.maximize();
...
window.app_saku3_report_kantintu_flJurnalBA.extend(window.childForm);
window.app_saku3_report_kantintu_flJurnalBA.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_kantintu_rptJurnalBa";
			...
			systemAPI.alert("[app_saku3_report_kantintu_flJurnalBA]::mainButtonClick:"+e);
		}
	},
