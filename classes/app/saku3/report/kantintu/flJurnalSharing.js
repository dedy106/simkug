window.app_saku3_report_kantintu_flJurnalSharing = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kantintu_flJurnalSharing.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kantintu_flJurnalSharing";
		this.maximize();
...
window.app_saku3_report_kantintu_flJurnalSharing.extend(window.childForm);
window.app_saku3_report_kantintu_flJurnalSharing.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_kantintu_rptJurnalSharing";
			...
			systemAPI.alert("[app_saku3_report_kantintu_flJurnalSharing]::mainButtonClick:"+e);
		}
	},
