window.app_saku3_report_kantintu_flTcash = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kantintu_flTcash.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kantintu_flTcash";
		this.maximize();
...
window.app_saku3_report_kantintu_flTcash.extend(window.childForm);
window.app_saku3_report_kantintu_flTcash.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_kantintu_flTcash]::mainButtonClick:"+e);
		}
	},
