window.app_saku3_report_if_flReimbPosisi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_if_flReimbPosisi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_if_flReimbPosisi";
		this.maximize();
...
window.app_saku3_report_if_flReimbPosisi.extend(window.childForm);
window.app_saku3_report_if_flReimbPosisi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_if_rptReimbPosisi";
			...
			systemAPI.alert("[app_saku3_report_if_flReimbPosisi]::mainButtonClick:"+e);
		}
	},
	...
	doOpenBukti: function(no_bukti,kode_lokasi){
		...
		nama_report="server_report_saku3_if_rptReimbForm";
