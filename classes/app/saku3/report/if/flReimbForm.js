window.app_saku3_report_if_flReimbForm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_if_flReimbForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_if_flReimbForm";
		this.maximize();
...
window.app_saku3_report_if_flReimbForm.extend(window.childForm);
window.app_saku3_report_if_flReimbForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_if_rptReimbForm";
			...
			systemAPI.alert("[app_saku3_report_if_flReimbForm]::mainButtonClick:"+e);
		}
	},
