window.app_saku3_report_if_flIfKartu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_if_flIfKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_if_flIfKartu";
		this.maximize();
...
window.app_saku3_report_if_flIfKartu.extend(window.childForm);
window.app_saku3_report_if_flIfKartu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_if_rptIfKartu";
			...
			systemAPI.alert("[app_saku3_report_if_flIfKartu]::mainButtonClick:"+e);
		}
	},
