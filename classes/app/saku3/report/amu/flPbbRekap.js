window.app_saku3_report_amu_flPbbRekap= function (owner) {
    if (owner) {
        window.app_saku3_report_amu_flPbbRekap.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_report_amu_flPbbRekap";
        this.maximize();
...
window.app_saku3_report_amu_flPbbRekap.extend(window.childForm);
window.app_saku3_report_amu_flPbbRekap.implement({
    ...
    mainButtonClick: function (sender) {
        try {
            if (sender === this.app._mainForm.bClear2) {
                ...
                this.nama_report = "server_report_saku3_amu_rptPbbRekap";
