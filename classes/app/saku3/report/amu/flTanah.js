window.app_saku3_report_amu_flTanah = function (owner) {
    if (owner) {
        window.app_saku3_report_amu_flTanah.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_report_amu_flTanah";
        this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("Status Lahan","All",""));
...
window.app_saku3_report_amu_flTanah.extend(window.childForm);
window.app_saku3_report_amu_flTanah.implement({
    ...
    mainButtonClick: function (sender) {
        try {
            if (sender === this.app._mainForm.bClear2) {
                ...
                this.nama_report = "server_report_saku3_amu_rptTanah";
