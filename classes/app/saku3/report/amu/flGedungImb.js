window.app_saku3_report_amu_flGedungImb = function (owner) {
    if (owner) {
        window.app_saku3_report_amu_flGedungImb.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_report_amu_flGedungImb";
        this.maximize();
...
window.app_saku3_report_amu_flGedungImb.extend(window.childForm);
window.app_saku3_report_amu_flGedungImb.implement({
    ...
    mainButtonClick: function (sender) {
        try {
            if (sender === this.app._mainForm.bClear2) {
                ...
                this.nama_report = "server_report_saku3_amu_rptGedungImb";
