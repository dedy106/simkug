window.app_saku3_report_amu_flAsetKartu = function (owner) {
    if (owner) {
        window.app_saku3_report_amu_flAsetKartu.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_report_amu_flAsetKartu";
        this.maximize();
    ...
    this.gridLib.SGEditData(this.sg1, 2, new Array(0, 1, 2), new Array("Kelompok Barang", "All", ""));
	this.gridLib.SGEditData(this.sg1, 3, new Array(0, 1, 2), new Array("Nomor Asset", "All", ""));
    this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_amu_flAsetKartu.extend(window.childForm);
window.app_saku3_report_amu_flAsetKartu.implement({
        ...
        try {
			...
			if (row == 3) {
                ...
                this.filterRep.ListDataSGFilter(this, "Data Asset", this.sg1, this.sg1.row, this.sg1.col,
                    "select a.no_bukti,a.nama_inv from amu_asset_bergerak a "+filter,
                    "select count(*) from amu_asset_bergerak a  "+filter,
                    new Array("a.no_bukti", "a.nama_inv"), "and", new Array("No Asset", "Deskripsi"));
            }
        } catch (e) {
            systemAPI.alert(e);
        }
    ...
    mainButtonClick: function (sender) {
        try {
            if (sender === this.app._mainForm.bClear2) {
                ...
                this.nama_report = "server_report_saku3_amu_rptAssetKartu";
