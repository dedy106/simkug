window.app_saku3_report_amu_flPbAsetPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_amu_flPbAsetPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_amu_flPbAsetPos";
		this.maximize();
...
window.app_saku3_report_amu_flPbAsetPos.extend(window.childForm);
window.app_saku3_report_amu_flPbAsetPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_amu_rptPbAsetPos";
			...
			systemAPI.alert("[app_saku3_report_amu_flPbAsetPos]::mainButtonClick:"+e);
		}
	},
