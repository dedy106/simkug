window.app_saku3_report_amu_flQrCode = function (owner) {
    if (owner) {
        window.app_saku3_report_amu_flQrCode.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_report_amu_flQrCode";
        this.maximize();
...
window.app_saku3_report_amu_flQrCode.extend(window.childForm);
window.app_saku3_report_amu_flQrCode.implement({
    ...
    mainButtonClick: function (sender) {
        try {
            if (sender === this.app._mainForm.bClear2) {
                ...
                this.nama_report = "server_report_saku3_amu_rptQrCode";
