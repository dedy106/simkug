window.app_saku3_report_amu_flPbAsurPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_amu_flPbAsurPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_amu_flPbAsurPos";
		this.maximize();
...
window.app_saku3_report_amu_flPbAsurPos.extend(window.childForm);
window.app_saku3_report_amu_flPbAsurPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_amu_rptPbAsurPos";
			...
			systemAPI.alert("[app_saku3_report_amu_flPbAsurPos]::mainButtonClick:"+e);
		}
	},
