window.app_saku3_report_amu_flSumurPantau = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_amu_flSumurPantau.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_amu_flSumurPantau";
		this.maximize();
...
window.app_saku3_report_amu_flSumurPantau.extend(window.childForm);
window.app_saku3_report_amu_flSumurPantau.implement({
		...
		try{			
            ...
            if (row == 2)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Sumur",this.sg1, this.sg1.row, this.sg1.col,
												"select a.id_sumur, a.nama_sumur from amu_sumur_pantau a "+filter,
												"select count(a.id_sumur) from amu_sumur_pantau a "+filter,
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_amu_rptSumurPantau";
			...
			systemAPI.alert("[app_saku3_report_amu_flSumurPantau]::mainButtonClick:"+e);
		}
	},
