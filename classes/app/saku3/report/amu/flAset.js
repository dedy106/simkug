window.app_saku3_report_amu_flAset = function (owner) {
    if (owner) {
        window.app_saku3_report_amu_flAset.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_report_amu_flAset";
        this.maximize();
	...
	this.gridLib.SGEditData(this.sg1, 3, new Array(0, 1, 2), new Array("Ruangan", "All", ""));
	this.gridLib.SGEditData(this.sg1, 4, new Array(0, 1, 2), new Array("Barang", "All", ""));
	this.gridLib.SGEditData(this.sg1, 5, new Array(0, 1, 2), new Array("Jenis Laporan", "=", "Gedung"));
    this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_amu_flAset.extend(window.childForm);
window.app_saku3_report_amu_flAset.implement({
    ...
    doSelectCell: function (sender, col, row) {
        this.filterRep.setSGFilterRowTipe(this.sg1, row, [0, 1, 2,3,4,5], ["3", "3", "123","123","123","3"]);
        this.filterRep.setSGFilterRowButtonStyle(this.sg1, row, [0, 1, 2,3,4,5], [2, 2, 2,2,2,0]);
		if (row == 5)
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("Gedung","Ruangan","Barang"));
		}
    },
        ...
        try {
			...
			if (sender == this.app._mainForm.bBack)
			{
				...
				if (this.link=="1")
				{
					...
					this.nama_report = "server_report_saku3_amu_rptAsetGedung";
				...
				if (this.link=="2")
				{
					this.doOpenRuang(this.kode_gedung,this.kode_lokasi);
				}
				if (this.link=="3")
				{
					this.doOpenBarang(this.kode_gedung,this.kode_ruangan,this.kode_lokasi);
				}
			...
			else
			{
				...
				if (this.sg1.getCell(2,5)=="Gedung") {
				...
				if (this.sg1.getCell(2,5)=="Ruangan") {
					this.filter = this.filterRep.filterStr("a.kode_lokasi", this.sg1.getCell(1, 0), this.sg1.getCell(2, 0), this.sg1.getCell(3, 0), "where") +
								this.filterRep.filterStr("a.kode_pp", this.sg1.getCell(1, 1), this.sg1.getCell(2, 1), this.sg1.getCell(3, 1), "and") ;
					this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1);
					this.nama_report = "server_report_saku3_amu_rptAsetRuang";	
				}
				if (this.sg1.getCell(2,5)=="Barang") {
					this.filter = this.filterRep.filterStr("a.kode_lokasi", this.sg1.getCell(1, 0), this.sg1.getCell(2, 0), this.sg1.getCell(3, 0), "where") +
								this.filterRep.filterStr("a.kode_pp", this.sg1.getCell(1, 1), this.sg1.getCell(2, 1), this.sg1.getCell(3, 1), "and") ;
					this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1);
					this.nama_report = "server_report_saku3_amu_rptAset";	
				}
    ...
    doOpenDetail: function (kode_gedung,kode_ruangan,kode_klp,kode_lokasi) {
        this.kode_klp = kode_klp;
        ...
        filter = this.filterRep.filterStr("a.kode_lokasi", this.sg1.getCell(1, 0), this.sg1.getCell(2, 0), this.sg1.getCell(3, 0), "where") +
                 this.filterRep.filterStr("a.kode_pp", this.sg1.getCell(1, 1), this.sg1.getCell(2, 1), this.sg1.getCell(3, 1), "and") +
				 " and d.id_gedung='" + kode_gedung + "' and d.no_ruangan='"+kode_ruangan+"' and a.kode_klp='" + kode_klp + "'";
        filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1);
		
        nama_report = "server_report_saku3_amu_rptAsetDetail";
	...
	doOpenRuang: function (kode_gedung,kode_lokasi) {
        this.kode_gedung = kode_gedung;
        this.link = "1";
        filter = this.filterRep.filterStr("a.kode_lokasi", this.sg1.getCell(1, 0), this.sg1.getCell(2, 0), this.sg1.getCell(3, 0), "where") +
                 this.filterRep.filterStr("a.kode_pp", this.sg1.getCell(1, 1), this.sg1.getCell(2, 1), this.sg1.getCell(3, 1), "and") +
				 " and a.id_gedung='" + kode_gedung + "'";
        filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1);
		
        nama_report = "server_report_saku3_amu_rptAsetRuang";
        this.viewer.useIframe(this.report.previewWithHeader(nama_report, filter, this.page, this.pager, this.showFilter, this.lokasi, filter2)+ "&resource=" + this.resourceId + "&fullId=" + this.getFullId());
    },
	
	doOpenBarang: function (kode_gedung,kode_ruangan,kode_lokasi) {
        this.kode_gedung = kode_gedung;
		this.kode_ruangan = kode_ruangan;
        this.link = "2";
        filter = this.filterRep.filterStr("a.kode_lokasi", this.sg1.getCell(1, 0), this.sg1.getCell(2, 0), this.sg1.getCell(3, 0), "where") +
                 this.filterRep.filterStr("a.kode_pp", this.sg1.getCell(1, 1), this.sg1.getCell(2, 1), this.sg1.getCell(3, 1), "and") +
				 " and b.no_ruangan='"+kode_ruangan+"' and b.id_gedung='" + kode_gedung + "'";
        filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1);
		
        nama_report = "server_report_saku3_amu_rptAset";
        this.viewer.useIframe(this.report.previewWithHeader(nama_report, filter, this.page, this.pager, this.showFilter, this.lokasi, filter2)+ "&resource=" + this.resourceId + "&fullId=" + this.getFullId());
    },
