window.app_saku3_report_amu_flAssetGer = function (owner) {
    if (owner) {
        window.app_saku3_report_amu_flAssetGer.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_report_amu_flAssetGer";
        this.maximize();
        this.app._mainForm.childFormConfig(this, "mainButtonClick", "Kartu Monitoring Asset Bergerak", 2);
...
window.app_saku3_report_amu_flAssetGer.extend(window.childForm);
window.app_saku3_report_amu_flAssetGer.implement({
    doEllipseClick: function (sender, col, row) {
        try {
            if (row == 1) {
                this.filterRep.ListDataSGFilter(this, "Data Kelompok Asset", this.sg1, this.sg1.row, this.sg1.col,
        ...
        try {
            if (sender === this.app._mainForm.bClear2) {
                ...
                this.filter = this.filterRep.filterStr("a.kode_lokasi", this.sg1.getCell(1, 0), this.sg1.getCell(2, 0), this.sg1.getCell(3, 0), "where") +
                    this.filterRep.filterStr("b.kode_klp", this.sg1.getCell(1, 1), this.sg1.getCell(2, 1), this.sg1.getCell(3, 1), "and");
                this.showFilter = this.filterRep.showFilter(this.sg1);
                this.nama_report = "server_report_saku3_amu_rptAssetGer";
    ...
    /*doOpenTanah: function (id_lahan) {
        this.id_lahan = id_lahan;
        this.link = "1";
        filter = "where a.id_Lahan='" + id_lahan + "'";
        filter2 = "";
        nama_report = "server_report_saku3_amu_rptTanah";
