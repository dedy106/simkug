window.app_saku3_report_amu_flPbAsur = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_amu_flPbAsur.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_amu_flPbAsur";
		this.maximize();
...
window.app_saku3_report_amu_flPbAsur.extend(window.childForm);
window.app_saku3_report_amu_flPbAsur.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_amu_rptPbAsur";
			...
			systemAPI.alert("[app_saku3_report_amu_flPbAsur]::mainButtonClick:"+e);
		}
	},
