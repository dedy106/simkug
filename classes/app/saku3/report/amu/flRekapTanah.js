window.app_saku3_report_amu_flRekapTanah = function (owner) {
    if (owner) {
        window.app_saku3_report_amu_flRekapTanah.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_report_amu_flRekapTanah";
        this.maximize();
    ...
    this.gridLib.SGEditData(this.sg1, 4, new Array(0, 1, 2), new Array("ID Lahan", "All", ""));
    

    this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_amu_flRekapTanah.extend(window.childForm);
window.app_saku3_report_amu_flRekapTanah.implement({
        ...
        try {
            if (sender === this.app._mainForm.bClear2) {
                ...
                this.filter = this.filterRep.filterStr("a.kode_lokasi", this.sg1.getCell(1, 0), this.sg1.getCell(2, 0), this.sg1.getCell(3, 0), "where") +
                    ...
                    this.filterRep.filterStr("a.id_lahan", this.sg1.getCell(1, 4), this.sg1.getCell(2, 4), this.sg1.getCell(3, 4), "and") ;
                this.showFilter = this.filterRep.showFilter(this.sg1);
                this.nama_report = "server_report_saku3_amu_rptRekapTanah";
