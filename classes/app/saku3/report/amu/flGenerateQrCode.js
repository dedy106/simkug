window.app_saku3_report_amu_flGenerateQrCode = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_amu_flGenerateQrCode.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_amu_flGenerateQrCode";
        this.maximize();
...
window.app_saku3_report_amu_flGenerateQrCode.extend(window.childForm);
window.app_saku3_report_amu_flGenerateQrCode.implement({
	doLoad:function(){
        try{
			...
			this.report = new server_report_report();
			var nama_report="server_report_saku3_amu_rptGenerateQrCode";
			this.filter="";
			this.showFilter = "";
			this.lokasi = "";
