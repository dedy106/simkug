window.app_saku3_report_amu_flTanahMilik = function (owner) {
    if (owner) {
        window.app_saku3_report_amu_flTanahMilik.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_report_amu_flTanahMilik";
        this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("Status Lahan","=","Milik"));
...
window.app_saku3_report_amu_flTanahMilik.extend(window.childForm);
window.app_saku3_report_amu_flTanahMilik.implement({
    ...
    mainButtonClick: function (sender) {
        try {
            if (sender === this.app._mainForm.bClear2) {
                ...
                this.nama_report = "server_report_saku3_amu_rptTanahMilik";
	...
	doOpenDetail: function(id_lahan,kode_lokasi){
     	...
     	nama_report="server_report_saku3_amu_rptTanahMilikDetail";
