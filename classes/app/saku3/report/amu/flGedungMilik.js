window.app_saku3_report_amu_flGedungMilik = function (owner) {
    if (owner) {
        window.app_saku3_report_amu_flGedungMilik.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_report_amu_flGedungMilik";
        this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("Status Gedung","=","Milik"));
	this.gridLib.SGEditData(this.sg1,5,new Array(0,1,2), new Array("Status Milik","All",""));
    this.gridLib.SGEditData(this.sg1, 6, new Array(0, 1, 2), new Array("ID Gedung", "All", ""));
    

    this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_amu_flGedungMilik.extend(window.childForm);
window.app_saku3_report_amu_flGedungMilik.implement({
        ...
        try {
            ...
            if (row == 6) {
                this.filterRep.ListDataSGFilter(this, "Data Gedung", this.sg1, this.sg1.row, this.sg1.col,
                    ...
                    new Array("id_gedung", "nama_gedung"), "where", new Array("ID", "Nama"));
            }
    ...
    doSelectCell: function (sender, col, row) {
        ...
        if (row == 4)
		{
			...
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("Milik"));
		}
		if (row == 5)
		{
			this.sg1.columns.get(2).pickList.clear();
        ...
        try {
            if (sender === this.app._mainForm.bClear2) {
                ...
                this.filter = this.filterRep.filterStr("a.kode_lokasi", this.sg1.getCell(1, 0), this.sg1.getCell(2, 0), this.sg1.getCell(3, 0), "where") +
                    this.filterRep.filterStr("e.id_provinsi", this.sg1.getCell(1, 1), this.sg1.getCell(2, 1), this.sg1.getCell(3, 1), "and") +
					this.filterRep.filterStr("d.id_kota", this.sg1.getCell(1, 2), this.sg1.getCell(2, 2), this.sg1.getCell(3, 2), "and") +
					this.filterRep.filterStr("g.id_kawasan", this.sg1.getCell(1, 3), this.sg1.getCell(2, 3), this.sg1.getCell(3, 3), "and") +
					this.filterRep.filterStr("a.status", this.sg1.getCell(1, 4), this.sg1.getCell(2, 4), this.sg1.getCell(3, 4), "and") +
                    ...
                    this.filterRep.filterStr("a.id_gedung", this.sg1.getCell(1, 6), this.sg1.getCell(2, 6), this.sg1.getCell(3, 6), "and") ;
				
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)
				
                this.showFilter = this.filterRep.showFilter(this.sg1);
                this.nama_report = "server_report_saku3_amu_rptGedungMilik";
	...
	doOpenDetail: function(id_lahan,kode_lokasi){
     	...
     	this.link="1";
     	filter = "where a.id_gedung='"+id_lahan+"' and a.kode_lokasi='"+kode_lokasi+"'";
     	filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)
     	nama_report="server_report_saku3_amu_rptGedungMilikDetail";
