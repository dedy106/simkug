window.app_saku3_report_amu_flSumurResapan = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_amu_flSumurResapan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_amu_flSumurResapan";
		this.maximize();
...
window.app_saku3_report_amu_flSumurResapan.extend(window.childForm);
window.app_saku3_report_amu_flSumurResapan.implement({
		...
		try{			
            ...
            if (row == 2)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Sumur",this.sg1, this.sg1.row, this.sg1.col,
												"select a.id_sumur, a.nama_sumur from amu_sumur_resap a "+filter,
												"select count(a.id_sumur) from amu_sumur_resap a "+filter,
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_amu_rptSumurResapan";
			...
			systemAPI.alert("[app_saku3_report_amu_flSumurResapan]::mainButtonClick:"+e);
		}
	},
