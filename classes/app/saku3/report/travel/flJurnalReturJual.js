window.app_saku3_report_travel_flJurnalReturJual = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flJurnalReturJual.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flJurnalReturJual";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from trans_m  ");
...
window.app_saku3_report_travel_flJurnalReturJual.extend(window.childForm);
window.app_saku3_report_travel_flJurnalReturJual.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_travel_rptJurnalReturJual";
			...
			systemAPI.alert("[app_saku3_report_travel_flJurnalReturJual]::mainButtonClick:"+e);
		}
	},
