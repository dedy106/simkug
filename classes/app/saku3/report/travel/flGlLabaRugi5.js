// JavaScript Document
window.app_saku3_report_travel_flGlLabaRugi5 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flGlLabaRugi5.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flGlLabaRugi5";
		this.maximize();
...
window.app_saku3_report_travel_flGlLabaRugi5.extend(window.portalui_childForm);
window.app_saku3_report_travel_flGlLabaRugi5.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_travel_rptGlLabaRugi5";
