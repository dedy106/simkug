window.app_saku3_report_travel_flJurnalReturBeli = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flJurnalReturBeli.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flJurnalReturBeli";
		this.maximize();
...
window.app_saku3_report_travel_flJurnalReturBeli.extend(window.childForm);
window.app_saku3_report_travel_flJurnalReturBeli.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_travel_rptJurnalReturBeli";
			...
			systemAPI.alert("[app_saku3_report_travel_flJurnalReturBeli]::mainButtonClick:"+e);
		}
	},
