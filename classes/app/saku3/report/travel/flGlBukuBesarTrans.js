window.app_saku3_report_travel_flGlBukuBesarTrans = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flGlBukuBesarTrans.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flGlBukuBesarTrans";
		this.maximize();
...
window.app_saku3_report_travel_flGlBukuBesarTrans.extend(window.childForm);
window.app_saku3_report_travel_flGlBukuBesarTrans.implement({
	...
	{		
		if (this.app._userStatus=="A" && this.pusat=="1" )
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5],["13","123","123","123","123","3"]);
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_travel_rptGlBukuBesarTrans";
	...
	doOpenJurnal: function(no_bukti,kode_lokasi){
		...
		filter2="";
		nama_report="server_report_saku3_travel_rptGlJurnalBuktiTrans";
