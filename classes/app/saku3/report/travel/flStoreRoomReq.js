window.app_saku3_report_travel_flStoreRoomReq = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flStoreRoomReq.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flStoreRoomReq";
		this.maximize();
...
window.app_saku3_report_travel_flStoreRoomReq.extend(window.childForm);
window.app_saku3_report_travel_flStoreRoomReq.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_travel_rptStoreRoomReq";
			...
			systemAPI.alert("[app_saku3_report_travel_flStoreRoomReq]::mainButtonClick:"+e);
		}
	},
