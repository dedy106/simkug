window.app_saku3_report_travel_flReturJual = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flReturJual.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flReturJual";
		this.maximize();
...
window.app_saku3_report_travel_flReturJual.extend(window.childForm);
window.app_saku3_report_travel_flReturJual.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_travel_rptReturJual";
			...
			systemAPI.alert("[app_saku3_report_travel_flReturJual]::mainButtonClick:"+e);
		}
	},
