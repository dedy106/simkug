window.app_saku3_report_travel_flGlBukuBesarPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flGlBukuBesarPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flGlBukuBesarPp";
		this.maximize();
...
window.app_saku3_report_travel_flGlBukuBesarPp.extend(window.childForm);
window.app_saku3_report_travel_flGlBukuBesarPp.implement({
	...
	{		
		...
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5,6],[2,0,2,0,1,2,0]);	
		if (row == 1)
		{
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_travel_rptGlBukuBesarPp";
