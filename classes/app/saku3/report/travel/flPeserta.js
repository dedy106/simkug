window.app_saku3_report_dago_flPeserta = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dago_flPeserta.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dago_flPeserta";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Data Peserta", 2);
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("No Peserta","All",""));
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Jenis Kelamin","All",""));
	
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_dago_flPeserta.extend(window.childForm);
window.app_saku3_report_dago_flPeserta.implement({
		...
		try{			
			...
			if (row ==1)
			{
				this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.jk",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");

				this.filterRep.ListDataSGFilter(this, "Data Peserta",this.sg1, this.sg1.row, this.sg1.col,
														  "select a.no_peserta, a.nama from dgw_peserta a  "+
	...
	{		
		...
		if (row == 2)
		{
			...
			this.dbLib.setItemsFromSQL("select jk from dgw_peserta where kode_lokasi='"+this.app._lokasi+"' group by jk",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}	
	},
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							  this.filterRep.filterStr("no_peserta",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							  this.filterRep.filterStr("jk",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
				this.showFilter = this.filterRep.showFilter(this.sg1);
				this.nama_report = "server_report_saku3_travel_rptPeserta";
