window.app_saku3_report_travel_flPiutangKartu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flPiutangKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flPiutangKartu";
		this.maximize();
...
window.app_saku3_report_travel_flPiutangKartu.extend(window.childForm);
window.app_saku3_report_travel_flPiutangKartu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_travel_rptPiutangKartu";
			...
			systemAPI.alert("[app_saku3_report_travel_flPiutangKartu]::mainButtonClick:"+e);
		}
	},
