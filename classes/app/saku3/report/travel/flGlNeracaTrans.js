// JavaScript Document
window.app_saku3_report_travel_flGlNeracaTrans = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flGlNeracaTrans.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flGlNeracaTrans";
		this.maximize();
...
window.app_saku3_report_travel_flGlNeracaTrans.extend(window.portalui_childForm);
window.app_saku3_report_travel_flGlNeracaTrans.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_travel_rptGlNeracaTrans";
				if (this.sg1.getCell(2,4)=="Mutasi")
				{
					this.nama_report="server_report_saku3_travel_rptGlNeracaMutasiTrans";
				}				
