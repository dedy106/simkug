...
//* 			SAI, PT											
//***********************************************************************************************
window.app_saku3_report_travel_flKbBukuBesar = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flKbBukuBesar.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flKbBukuBesar";
		this.maximize();
...
window.app_saku3_report_travel_flKbBukuBesar.extend(window.portalui_childForm);
window.app_saku3_report_travel_flKbBukuBesar.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_travel_rptKbBukuBesar";
	...
	doOpenJurnal: function(no_bukti,kode_lokasi,periode){
		...
		filter2="";
		nama_report="server_report_saku3_travel_rptKbJurnalBukti";
