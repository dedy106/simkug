window.app_saku3_report_travel_flGlTbPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flGlTbPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flGlTbPp";
		this.maximize();
...
window.app_saku3_report_travel_flGlTbPp.extend(window.childForm);
window.app_saku3_report_travel_flGlTbPp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.app._nikUser+"/"+this.sg1.getCell(2,3)+"//"+this.sg1.getCell(2,4);
				this.nama_report="server_report_saku3_travel_rptGlTbPp";
