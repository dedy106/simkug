window.app_saku3_report_travel_flOutgoingOrder = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flOutgoingOrder.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flOutgoingOrder";
		this.maximize();
...
window.app_saku3_report_travel_flOutgoingOrder.extend(window.childForm);
window.app_saku3_report_travel_flOutgoingOrder.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_travel_rptOutgoingOrder";
			...
			systemAPI.alert("[app_saku3_report_travel_flOutgoingOrder]::mainButtonClick:"+e);
		}
	},
