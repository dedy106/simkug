window.app_saku3_report_travel_flPiutangSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flPiutangSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flPiutangSaldo";
		this.maximize();
...
window.app_saku3_report_travel_flPiutangSaldo.extend(window.childForm);
window.app_saku3_report_travel_flPiutangSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_travel_rptPiutangSaldo";
			...
			systemAPI.alert("[app_saku3_report_travel_flPiutangSaldo]::mainButtonClick:"+e);
		}
	},
