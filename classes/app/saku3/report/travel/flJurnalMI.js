// JavaScript Document
window.app_saku3_report_travel_flJurnalMI = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flJurnalMI.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flJurnalMI";
		this.maximize();
...
window.app_saku3_report_travel_flJurnalMI.extend(window.portalui_childForm);
window.app_saku3_report_travel_flJurnalMI.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.dbLib.setItemsFromSQL("select distinct modul from trans_m where kode_lokasi='"+this.app._lokasi+"' order by modul",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
		if (row === 4)
		{
			this.sg1.columns.get(2).pickList.clear();
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_travel_rptJurnalMI";
