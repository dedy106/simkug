window.app_saku3_report_travel_flJualMutasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flJualMutasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flJualMutasi";
		this.maximize();
...
window.app_saku3_report_travel_flJualMutasi.extend(window.childForm);
window.app_saku3_report_travel_flJualMutasi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_travel_rptJualMutasi";
			...
			systemAPI.alert("[app_saku3_report_travel_flJualMutasi]::mainButtonClick:"+e);
		}
	},
