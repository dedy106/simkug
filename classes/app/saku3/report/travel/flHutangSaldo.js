window.app_saku3_report_travel_flHutangSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flHutangSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flHutangSaldo";
		this.maximize();
...
window.app_saku3_report_travel_flHutangSaldo.extend(window.childForm);
window.app_saku3_report_travel_flHutangSaldo.implement({
		...
		try
		{
			...
			else
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.no_hutang",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and");				this.filter2 = this.sg1.getCell(2,1);
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_travel_rptHutangSaldo";
			...
			systemAPI.alert("[app_saku3_report_travel_flHutangSaldo]::mainButtonClick:"+e);
		}
	},
