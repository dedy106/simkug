window.app_saku3_report_travel_flFaKartu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flFaKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flFaKartu";
		this.maximize();
...
window.app_saku3_report_travel_flFaKartu.extend(window.childForm);
window.app_saku3_report_travel_flFaKartu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_travel_rptFaKartu";
