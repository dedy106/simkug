window.app_saku3_report_travel_flJurnalClosing = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flJurnalClosing.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flJurnalClosing";
		this.maximize();
...
window.app_saku3_report_travel_flJurnalClosing.extend(window.childForm);
window.app_saku3_report_travel_flJurnalClosing.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_travel_rptJurnalClosing";
			...
			systemAPI.alert("[app_saku3_report_travel_flJurnalClosing]::mainButtonClick:"+e);
		}
	},
