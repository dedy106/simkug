window.app_saku3_report_travel_flBeliRekap = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flBeliRekap.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flBeliRekap";
		this.maximize();
...
window.app_saku3_report_travel_flBeliRekap.extend(window.childForm);
window.app_saku3_report_travel_flBeliRekap.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_travel_rptBeliRekap";
			...
			systemAPI.alert("[app_saku3_report_travel_flBeliRekap]::mainButtonClick:"+e);
		}
	},
