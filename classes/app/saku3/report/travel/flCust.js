window.app_saku3_report_travel_flCust = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flCust.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flCust";
		this.maximize();
...
window.app_saku3_report_travel_flCust.extend(window.childForm);
window.app_saku3_report_travel_flCust.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_travel_rptCust";
			...
			systemAPI.alert("[app_saku3_report_travel_flCust]::mainButtonClick:"+e);
		}
	},
