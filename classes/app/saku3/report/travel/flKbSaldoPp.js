// JavaScript Document
window.app_saku3_report_travel_flKbSaldoPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flKbSaldoPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flKbSaldoPp";
		this.maximize();
...
window.app_saku3_report_travel_flKbSaldoPp.extend(window.portalui_childForm);
window.app_saku3_report_travel_flKbSaldoPp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_travel_rptKbSaldoPp";
				this.dbLib.execQuerySync(this.sql);	
	...
	doOpenBb: function(kode_akun,kode_lokasi,periode,kode_pp){
		...
		nama_report="server_report_saku3_travel_rptKbBukuBesarPp";
