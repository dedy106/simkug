window.app_saku3_report_travel_flJurnalKas = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flJurnalKas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flJurnalKas";
		this.maximize();
...
window.app_saku3_report_travel_flJurnalKas.extend(window.childForm);
window.app_saku3_report_travel_flJurnalKas.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from trans_m where kode_lokasi='"+this.app._lokasi+"' and modul='KBREG'  order by periode",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_travel_rptJurnalKas";
			...
			systemAPI.alert("[app_saku3_report_travel_flJurnalKas]::mainButtonClick:"+e);
		}
	},
