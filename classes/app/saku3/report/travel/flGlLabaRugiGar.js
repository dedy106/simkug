// JavaScript Document
window.app_saku3_report_travel_flGlLabaRugiGar = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flGlLabaRugiGar.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flGlLabaRugiGar";
		this.maximize();
...
window.app_saku3_report_travel_flGlLabaRugiGar.extend(window.portalui_childForm);
window.app_saku3_report_travel_flGlLabaRugiGar.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_travel_rptGlLabaRugiGar";
				if (this.sg1.getCell(2,5)=="RRA"){
					this.nama_report="server_report_saku3_travel_rptGlLabaRugiGarRra";
				}
