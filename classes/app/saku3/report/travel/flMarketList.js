window.app_saku3_report_travel_flMarketList = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flMarketList.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flMarketList";
		this.maximize();
...
window.app_saku3_report_travel_flMarketList.extend(window.childForm);
window.app_saku3_report_travel_flMarketList.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_travel_rptMarketList";
			...
			systemAPI.alert("[app_saku3_report_travel_flMarketList]::mainButtonClick:"+e);
		}
	},
