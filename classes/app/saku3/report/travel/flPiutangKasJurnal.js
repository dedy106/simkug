window.app_saku3_report_travel_flPiutangKasJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flPiutangKasJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flPiutangKasJurnal";
		this.maximize();
...
window.app_saku3_report_travel_flPiutangKasJurnal.extend(window.childForm);
window.app_saku3_report_travel_flPiutangKasJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_travel_flPiutangKasJurnal]::mainButtonClick:"+e);
		}
	},
