window.app_saku3_report_travel_bill_flCust = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_bill_flCust.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_bill_flCust";
		this.maximize();
...
window.app_saku3_report_travel_bill_flCust.extend(window.childForm);
window.app_saku3_report_travel_bill_flCust.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_travel_bill_rptCust";
			...
			systemAPI.alert("[app_saku3_report_travel_bill_flCust]::mainButtonClick:"+e);
		}
	},
