window.app_saku3_report_travel_bill_flBillPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_bill_flBillPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_bill_flBillPos";
		this.maximize();
...
window.app_saku3_report_travel_bill_flBillPos.extend(window.childForm);
window.app_saku3_report_travel_bill_flBillPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_travel_bill_rptBillPos";
			...
			systemAPI.alert("[app_saku3_report_travel_bill_flBillPos]::mainButtonClick:"+e);
		}
	},
