window.app_saku3_report_travel_bill_flKuitansi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_bill_flKuitansi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_bill_flKuitansi";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from bill_m where kode_lokasi='"+this.app._lokasi+"'");
...
window.app_saku3_report_travel_bill_flKuitansi.extend(window.childForm);
window.app_saku3_report_travel_bill_flKuitansi.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from bill_m where kode_lokasi='"+this.app._lokasi+"' order by periode",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_travel_bill_rptKuitansi";
			...
			systemAPI.alert("[app_saku3_report_travel_bill_flKuitansi]::mainButtonClick:"+e);
		}
	},
