window.app_saku3_report_travel_bill_flKontrak = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_bill_flKontrak.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_bill_flKontrak";
		this.maximize();
...
window.app_saku3_report_travel_bill_flKontrak.extend(window.childForm);
window.app_saku3_report_travel_bill_flKontrak.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_travel_bill_flKontrak]::mainButtonClick:"+e);
		}
	},
