window.app_saku3_report_travel_flPiutangSaldoCust = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flPiutangSaldoCust.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flPiutangSaldoCust";
		this.maximize();
...
window.app_saku3_report_travel_flPiutangSaldoCust.extend(window.childForm);
window.app_saku3_report_travel_flPiutangSaldoCust.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_travel_rptPiutangSaldoCust";
			...
			systemAPI.alert("[app_saku3_report_travel_flPiutangSaldoCust]::mainButtonClick:"+e);
		}
	},
