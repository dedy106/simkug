// JavaScript Document
window.app_saku3_report_travel_flGlJurnalBuktiYks = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flGlJurnalBuktiYks.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flGlJurnalBuktiYks";
		this.maximize();
...
window.app_saku3_report_travel_flGlJurnalBuktiYks.extend(window.portalui_childForm);
window.app_saku3_report_travel_flGlJurnalBuktiYks.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_travel_rptGlJurnalBuktiYks";
