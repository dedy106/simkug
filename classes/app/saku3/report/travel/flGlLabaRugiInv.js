// JavaScript Document
window.app_saku3_report_travel_flGlLabaRugiInv = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flGlLabaRugiInv.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flGlLabaRugiInv";
		this.maximize();
...
window.app_saku3_report_travel_flGlLabaRugiInv.extend(window.portalui_childForm);
window.app_saku3_report_travel_flGlLabaRugiInv.implement({
		...
		if (row ==0)
		{
			if (this.app._lokasi=="20")
			{
				this.filterRep.ListDataSGFilter(this, "Data Lokasi",this.sg1, this.sg1.row, this.sg1.col,
											"select kode_lokasi, nama from lokasi where flag_aktif='1' ",
											"select count(*) from lokasi where flag_aktif='1'  ",
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_travel_rptGlLabaRugiInv";
				if (this.sg1.getCell(2,5)=="RRA"){
					this.nama_report="server_report_saku3_travel_rptGlLabaRugiInvRra";
				}
