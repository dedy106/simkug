window.app_saku3_report_travel_flTerima = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flTerima.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flTerima";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Gudang Asal","All",""));
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Gudang Tujuan","All",""));
...
window.app_saku3_report_travel_flTerima.extend(window.childForm);
window.app_saku3_report_travel_flTerima.implement({
		...
		try{			
			...
			if (row ==2)
			{
				this.filterRep.ListDataSGFilter(this, "Data Gudang",this.sg1, this.sg1.row, this.sg1.col,
												"select kode_gudang, nama from brg_gudang ",
												"select count(*) from brg_gudang ",
			...
			if (row ==4)
			{
				filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							" and a.form = 'BRGTERIMA' ";
							
							
				this.filterRep.ListDataSGFilter(this, "Data Kirim Barang",this.sg1, this.sg1.row, this.sg1.col,
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_travel_rptTerima";
			...
			systemAPI.alert("[app_saku3_report_travel_flTerima]::mainButtonClick:"+e);
		}
	},
