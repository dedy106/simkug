window.app_saku3_report_travel_flSaldoHut = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flSaldoHut.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flSaldoHut";
		this.maximize();
...
window.app_saku3_report_travel_flSaldoHut.extend(window.childForm);
window.app_saku3_report_travel_flSaldoHut.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_travel_rptSaldoHut";
			...
			systemAPI.alert("[app_saku3_report_travel_flSaldoHut]::mainButtonClick:"+e);
		}
	},
