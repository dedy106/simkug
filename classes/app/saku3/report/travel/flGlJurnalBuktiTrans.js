// JavaScript Document
window.app_saku3_report_travel_flGlJurnalBuktiTrans = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flGlJurnalBuktiTrans.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flGlJurnalBuktiTrans";
		this.maximize();
...
window.app_saku3_report_travel_flGlJurnalBuktiTrans.extend(window.portalui_childForm);
window.app_saku3_report_travel_flGlJurnalBuktiTrans.implement({
	doEllipseClick: function(sender, col, row){
		...
		if (row == 3)
		{
			...
			var sql1="select distinct a.no_bukti,a.periode from gldt a "+filter+
					"union select distinct a.no_bukti,a.periode from gldt_h a "+filter; 
			var sql2="select count(distinct a.no_bukti) from gldt a "+filter;
			
			this.filterRep.ListDataSGFilter(this, "Data Jurnal",this.sg1, this.sg1.row, this.sg1.col,sql1,sql2,
			                                new Array("a.no_bukti","a.periode"),"and",new Array("No Bukti","Periode"),"and");
	...
	doSelectCell: function(sender, col, row){
		...
		this.filterRep.setSGFilterRowTipe(this.sg1, row,new Array(0,1,2,3),new  Array("3","123","123","123"));
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,new Array(0,1,2,3),new  Array(3,0,0,2));
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_travel_rptGlJurnalBuktiTrans";
