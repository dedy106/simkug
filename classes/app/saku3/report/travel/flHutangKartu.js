window.app_saku3_report_travel_flHutangKartu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flHutangKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flHutangKartu";
		this.maximize();
...
window.app_saku3_report_travel_flHutangKartu.extend(window.childForm);
window.app_saku3_report_travel_flHutangKartu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_travel_rptHutangKartu";
			...
			systemAPI.alert("[app_saku3_report_travel_flHutangKartu]::mainButtonClick:"+e);
		}
	},
