window.app_saku3_report_travel_flGlTbTrans = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flGlTbTrans.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flGlTbTrans";
		this.maximize();
...
window.app_saku3_report_travel_flGlTbTrans.extend(window.childForm);
window.app_saku3_report_travel_flGlTbTrans.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_travel_rptGlTbTrans";
