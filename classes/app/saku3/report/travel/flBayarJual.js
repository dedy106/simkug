window.app_saku3_report_travel_flBayarJual = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flBayarJual.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flBayarJual";
		this.maximize();
...
window.app_saku3_report_travel_flBayarJual.extend(window.childForm);
window.app_saku3_report_travel_flBayarJual.implement({
		...
		try{			
			...
			if (row ==2)
			{
				this.filterRep.ListDataSGFilter(this, "Data Customer",this.sg1, this.sg1.row, this.sg1.col,
												"select kode_cust, nama from brg_cust where kode_lokasi='"+this.app._lokasi+"'",
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_travel_rptBayarJual";
			...
			systemAPI.alert("[app_saku3_report_travel_flBayarJual]::mainButtonClick:"+e);
		}
	},
