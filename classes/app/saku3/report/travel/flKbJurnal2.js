// JavaScript Document
window.app_saku3_report_travel_flKbJurnal2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flKbJurnal2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flKbJurnal2";
		this.maximize();
...
window.app_saku3_report_travel_flKbJurnal2.extend(window.portalui_childForm);
window.app_saku3_report_travel_flKbJurnal2.implement({
	doEllipseClick: function(sender, col, row){
		...
		if (row == 2)
		{
			...
			var filter=this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"where") +
						...
						" and a.modul in ('KB','KBSPB','KBSPBPJ') ";
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_travel_rptKbJurnal2";
