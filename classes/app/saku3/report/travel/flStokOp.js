window.app_saku3_report_travel_flStokOp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flStokOp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flStokOp";
		this.maximize();
...
window.app_saku3_report_travel_flStokOp.extend(window.childForm);
window.app_saku3_report_travel_flStokOp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.app._nikUser+"/"+this.sg1.getCell(1,1)+"/"+this.sg1.getCell(3,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_travel_rptStokOp";
			...
			systemAPI.alert("[app_saku3_report_travel_flStokOp]::mainButtonClick:"+e);
		}
	},
	...
	doOpenBayar: function(no_bukti,kode_lokasi){
		...
		this.link="1";
		filter = "where a.no_beli='"+no_bukti+"' and a.kode_lokasi='"+kode_lokasi+"' ";
		filter2="";
