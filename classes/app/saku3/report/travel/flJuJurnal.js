// JavaScript Document
window.app_saku3_report_travel_flJuJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flJuJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flJuJurnal";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from trans_m where kode_lokasi='"+this.app._lokasi+"' and modul in ('MI')");
...
window.app_saku3_report_travel_flJuJurnal.extend(window.portalui_childForm);
window.app_saku3_report_travel_flJuJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_travel_rptJuJurnal";
