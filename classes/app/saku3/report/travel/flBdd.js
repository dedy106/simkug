window.app_saku3_report_travel_flBdd = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flBdd.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flBdd";
		this.maximize();
...
window.app_saku3_report_travel_flBdd.extend(window.childForm);
window.app_saku3_report_travel_flBdd.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_travel_flBdd]::mainButtonClick:"+e);
		}
	},
