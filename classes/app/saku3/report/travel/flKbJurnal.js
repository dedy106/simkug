// JavaScript Document
window.app_saku3_report_travel_flKbJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flKbJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flKbJurnal";
		this.maximize();
...
window.app_saku3_report_travel_flKbJurnal.extend(window.portalui_childForm);
window.app_saku3_report_travel_flKbJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_travel_rptKbJurnal";
