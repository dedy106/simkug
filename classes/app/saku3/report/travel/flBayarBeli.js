window.app_saku3_report_travel_flBayarBeli = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flBayarBeli.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flBayarBeli";
		this.maximize();
...
window.app_saku3_report_travel_flBayarBeli.extend(window.childForm);
window.app_saku3_report_travel_flBayarBeli.implement({
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("e.kode_vendor",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
				...
				this.nama_report = "server_report_saku3_travel_rptBayarBeli";
			...
			systemAPI.alert("[app_saku3_report_travel_flBayarBeli]::mainButtonClick:"+e);
		}
	},
