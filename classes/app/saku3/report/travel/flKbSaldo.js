// JavaScript Document
window.app_saku3_report_travel_flKbSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flKbSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flKbSaldo";
		this.maximize();
...
window.app_saku3_report_travel_flKbSaldo.extend(window.portalui_childForm);
window.app_saku3_report_travel_flKbSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_travel_rptKbSaldo";
				this.dbLib.execQuerySync(this.sql);	
	...
	doOpenBb: function(kode_akun,kode_lokasi){
		...
		nama_report="server_report_saku3_travel_rptKbBukuBesar";
