window.app_saku3_report_travel_flTiketKartu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flTiketKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flTiketKartu";
		this.maximize();
...
window.app_saku3_report_travel_flTiketKartu.extend(window.childForm);
window.app_saku3_report_travel_flTiketKartu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_travel_rptTiketKartu";
			...
			systemAPI.alert("[app_saku3_report_travel_flTiketKartu]::mainButtonClick:"+e);
		}
	},
