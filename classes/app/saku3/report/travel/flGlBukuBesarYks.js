window.app_saku3_report_travel_flGlBukuBesarYks = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flGlBukuBesarYks.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flGlBukuBesarYks";
		this.maximize();
...
window.app_saku3_report_travel_flGlBukuBesarYks.extend(window.childForm);
window.app_saku3_report_travel_flGlBukuBesarYks.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_travel_rptGlBukuBesarYks";
	...
	doOpenJurnal: function(no_bukti,kode_lokasi){
		...
		filter2="";
		nama_report="server_report_saku3_travel_rptGlJurnalBuktiYks";
