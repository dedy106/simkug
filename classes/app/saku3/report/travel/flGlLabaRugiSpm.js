// JavaScript Document
window.app_saku3_report_travel_flGlLabaRugiSpm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flGlLabaRugiSpm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flGlLabaRugiSpm";
		this.maximize();
...
window.app_saku3_report_travel_flGlLabaRugiSpm.extend(window.portalui_childForm);
window.app_saku3_report_travel_flGlLabaRugiSpm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_travel_rptGlLabaRugiSpm";
				if (this.sg1.getCell(2,4)=="Mutasi")
				{
					this.nama_report="server_report_saku3_travel_rptGlLabaRugiMutasi";
				}	
				if (this.sg1.getCell(2,4)=="DC")
				{
					this.nama_report="server_report_saku3_travel_rptGlLabaRugiDc";
				}
