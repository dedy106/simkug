// JavaScript Document
window.app_saku3_report_travel_flGlNeracaNetoUbah = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flGlNeracaNetoUbah.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flGlNeracaNetoUbah";
		this.maximize();
...
window.app_saku3_report_travel_flGlNeracaNetoUbah.extend(window.portalui_childForm);
window.app_saku3_report_travel_flGlNeracaNetoUbah.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_travel_rptGlNeracaNetoUbah";
				if (this.sg1.getCell(2,4)=="Mutasi")
				{
					this.nama_report="server_report_saku3_travel_rptGlNeracaMutasiNetoUbah";
				}				
