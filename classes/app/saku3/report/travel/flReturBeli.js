window.app_saku3_report_travel_flReturBeli = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flReturBeli.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flReturBeli";
		this.maximize();
...
window.app_saku3_report_travel_flReturBeli.extend(window.childForm);
window.app_saku3_report_travel_flReturBeli.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_travel_rptReturBeli";
			...
			systemAPI.alert("[app_saku3_report_travel_flReturBeli]::mainButtonClick:"+e);
		}
	},
