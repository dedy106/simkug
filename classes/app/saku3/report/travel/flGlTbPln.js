window.app_saku3_report_travel_flGlTbPln = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flGlTbPln.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flGlTbPln";
		this.maximize();
...
window.app_saku3_report_travel_flGlTbPln.extend(window.childForm);
window.app_saku3_report_travel_flGlTbPln.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_travel_rptGlTbPln";
