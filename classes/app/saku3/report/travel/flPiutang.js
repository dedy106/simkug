window.app_saku3_report_travel_flPiutang = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flPiutang.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flPiutang";
		this.maximize();
...
window.app_saku3_report_travel_flPiutang.extend(window.childForm);
window.app_saku3_report_travel_flPiutang.implement({
		...
		try{			
			...
			if (row ==3)
			{
				filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							// "and a.form='AKRU' ";
							"and a.form in ('AKRU','PIUBILL','UNBILL') ";
		...
		try
		{
			...
			else
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							// "and c.form='AKRU' ";
							"and c.form in ('AKRU','PIUBILL','UNBILL') ";
				this.filter2 = this.sg1.getCell(2,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_travel_rptPiutang";
			...
			systemAPI.alert("[app_saku3_report_travel_flPiutang]::mainButtonClick:"+e);
		}
	},
