window.app_saku3_report_travel_flPurchaseOrder = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flPurchaseOrder.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flPurchaseOrder";
		this.maximize();
...
window.app_saku3_report_travel_flPurchaseOrder.extend(window.childForm);
window.app_saku3_report_travel_flPurchaseOrder.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_travel_rptPurchaseOrder";
			...
			systemAPI.alert("[app_saku3_report_travel_flPurchaseOrder]::mainButtonClick:"+e);
		}
	},
