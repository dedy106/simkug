window.app_saku3_report_travel_flBeli = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flBeli.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flBeli";
		this.maximize();
...
window.app_saku3_report_travel_flBeli.extend(window.childForm);
window.app_saku3_report_travel_flBeli.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_travel_rptBeli";
			...
			systemAPI.alert("[app_saku3_report_travel_flBeli]::mainButtonClick:"+e);
		}
	},
