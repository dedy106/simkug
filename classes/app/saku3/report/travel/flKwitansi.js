window.app_saku3_report_travel_flKwitansi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flKwitansi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flKwitansi";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Kwitansi", 2);
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Nomor Kwitansi","All",""));
	
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_travel_flKwitansi.extend(window.childForm);
window.app_saku3_report_travel_flKwitansi.implement({
		...
		try{			
			...
			if (row ==1)
			{
				this.filterRep.ListDataSGFilter(this, "Data Kwitansi",this.sg1, this.sg1.row, this.sg1.col,
														  "select a.no_reg,a.no_kwitansi from dgw_pembayaran a  "+
														   this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(2,0)," where "),
														  "select count(a.no_reg) from dgw_pembayaran a "+
														  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(2,0)," where "),
														  ["a.no_reg","a.no_kwitansi"],"and",["No Registasi","No Bukti"]);
			}
			if (row ==2)
			{
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Kode Lokasi","All",""));
				...
				this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							 this.filterRep.filterStr("a.no_reg",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							  this.filterRep.filterStr("a.no_kwitansi",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
							  "and i.form='KBREG' ";
				this.showFilter = this.filterRep.showFilter(this.sg1);
				this.nama_report = "server_report_saku3_travel_rptKwitansi";
