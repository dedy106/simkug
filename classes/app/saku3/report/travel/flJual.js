window.app_saku3_report_travel_flJual = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flJual.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flJual";
		this.maximize();
...
window.app_saku3_report_travel_flJual.extend(window.childForm);
window.app_saku3_report_travel_flJual.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_travel_rptJual";
			...
			systemAPI.alert("[app_saku3_report_travel_flJual]::mainButtonClick:"+e);
		}
	},
