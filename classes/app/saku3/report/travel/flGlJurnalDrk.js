// JavaScript Document
window.app_saku3_report_travel_flGlJurnalDrk = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flGlJurnalDrk.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flGlJurnalDrk";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,5,new Array(0,1,2), new Array("Sum Jurnal","=","Ya"));
...
window.app_saku3_report_travel_flGlJurnalDrk.extend(window.portalui_childForm);
window.app_saku3_report_travel_flGlJurnalDrk.implement({
	doEllipseClick: function(sender, col, row){
		...
		if (row == 3)
		{
			...
			var filter=this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"where") +
						...
						"and a.form='MI' ";
			var sql1="select a.no_bukti,a.keterangan from trans_m a "+filter; 
	...
	doSelectCell: function(sender, col, row){
		...
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,new Array(0,1,2,3,4,5),new  Array(3,0,0,2,0,0));
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.filter2 = this.sg1.getCell(2,1)+"/"+this.sg1.getCell(1,1)+"/"+this.sg1.getCell(3,1)+"/"+this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,4)+"/"+this.sg1.getCell(2,5);
			this.nama_report="server_report_saku3_travel_rptGlJurnalDrk";
			if (this.sg1.getCell(2,5)=="Tidak")
			{
				this.nama_report="server_report_saku3_travel_rptGlJurnalDrk2";
			}
