window.app_saku3_report_travel_flGlTbLap = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flGlTbLap.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flGlTbLap";
		this.maximize();
...
window.app_saku3_report_travel_flGlTbLap.extend(window.childForm);
window.app_saku3_report_travel_flGlTbLap.implement({
