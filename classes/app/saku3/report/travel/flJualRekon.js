window.app_saku3_report_travel_flJualRekon = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flJualRekon.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flJualRekon";
		this.maximize();
...
window.app_saku3_report_travel_flJualRekon.extend(window.childForm);
window.app_saku3_report_travel_flJualRekon.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from trans_m where kode_lokasi='"+this.app._lokasi+"' and modul='JUALBATCH'  order by periode",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_travel_rptJualRekon";
			...
			systemAPI.alert("[app_saku3_report_travel_flJualRekon]::mainButtonClick:"+e);
		}
	},
