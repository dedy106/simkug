window.app_saku3_report_travel_flKirim = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flKirim.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flKirim";
		this.maximize();
...
window.app_saku3_report_travel_flKirim.extend(window.childForm);
window.app_saku3_report_travel_flKirim.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_travel_rptKirim";
			...
			systemAPI.alert("[app_saku3_report_travel_flKirim]::mainButtonClick:"+e);
		}
	},
	...
	doOpenBayar: function(no_bukti,kode_lokasi){
		...
		this.link="1";
		filter = "where a.no_kirim='"+no_bukti+"' and a.kode_lokasi='"+kode_lokasi+"' ";
		filter2="";
