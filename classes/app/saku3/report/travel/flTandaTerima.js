window.app_saku3_report_travel_flTandaTerima = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flTandaTerima.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flTandaTerima";
		this.maximize();
...
window.app_saku3_report_travel_flTandaTerima.extend(window.childForm);
window.app_saku3_report_travel_flTandaTerima.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_travel_rptTandaTerima";
			...
			systemAPI.alert("[app_saku3_report_travel_flTandaTerima]::mainButtonClick:"+e);
		}
	},
