window.app_saku3_report_travel_flPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flPp";
		this.maximize();
...
window.app_saku3_report_travel_flPp.extend(window.childForm);
window.app_saku3_report_travel_flPp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_travel_rptPp";
			...
			systemAPI.alert("[app_saku3_report_travel_flPp]::mainButtonClick:"+e);
		}
	},
