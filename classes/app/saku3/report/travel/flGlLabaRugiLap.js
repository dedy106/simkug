// JavaScript Document
window.app_saku3_report_travel_flGlLabaRugiLap = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flGlLabaRugiLap.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flGlLabaRugiLap";
		this.maximize();
...
window.app_saku3_report_travel_flGlLabaRugiLap.extend(window.portalui_childForm);
window.app_saku3_report_travel_flGlLabaRugiLap.implement({
