// JavaScript Document
window.app_saku3_report_travel_flGlNeracaTahun = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flGlNeracaTahun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flGlNeracaTahun";
		this.maximize();
...
window.app_saku3_report_travel_flGlNeracaTahun.extend(window.portalui_childForm);
window.app_saku3_report_travel_flGlNeracaTahun.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_travel_rptGlNeracaTahun";
