// JavaScript Document
window.app_saku3_report_travel_flGlNeracaLap = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flGlNeracaLap.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flGlNeracaLap";
		this.maximize();
...
window.app_saku3_report_travel_flGlNeracaLap.extend(window.portalui_childForm);
window.app_saku3_report_travel_flGlNeracaLap.implement({
