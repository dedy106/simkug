// JavaScript Document
window.app_saku3_report_travel_flGlLabaRugiPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flGlLabaRugiPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flGlLabaRugiPp";
		this.maximize();
...
window.app_saku3_report_travel_flGlLabaRugiPp.extend(window.portalui_childForm);
window.app_saku3_report_travel_flGlLabaRugiPp.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		this.filterRep.setSGFilterRowTipe(this.sg1, row,new Array(0,1,2,3,4,5),new  Array("123","123","123","3","123","123"));
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2 = this.app._nikUser+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,3)+"/"+this.sg1.getCell(2,5);
				
				this.nama_report="server_report_saku3_travel_rptGlLabaRugiPp";
	...
	doOpenTb: function(kode_neraca,kode_lokasi){
		...
		filter="where a.kode_lokasi='"+kode_lokasi+"' and b.kode_neraca='"+kode_neraca+"' and a.kode_pp='"+this.sg1.getCell(2,5)+"'";
		filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.app._nikUser+"/Tidak/1/"+this.sg1.getCell(2,5);
		nama_report="server_report_saku3_travel_rptGlTbPp";
	...
	doOpenBb: function(kode_akun,kode_lokasi,periode){
		...
		//this.filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.app._nikUser+"/Tidak/"+var_periode+"/"+this.sg1.getCell(2,6)+"/"+this.sg1.getCell(1,1)+"/"+this.sg1.getCell(3,1);
		filter="where a.kode_lokasi='"+kode_lokasi+"' and a.kode_akun='"+kode_akun+"' and a.kode_pp='"+this.sg1.getCell(2,5)+"'";
		nama_report="server_report_saku3_travel_rptGlBukuBesarPp";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
