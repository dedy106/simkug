window.app_saku3_report_travel_flPiutangJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flPiutangJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flPiutangJurnal";
		this.maximize();
...
window.app_saku3_report_travel_flPiutangJurnal.extend(window.childForm);
window.app_saku3_report_travel_flPiutangJurnal.implement({
		...
		try
		{
			...
			else
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							"and e.form in ('AKRU','PIUBILL','UNBILL') ";
			...
			systemAPI.alert("[app_saku3_report_travel_flPiutangJurnal]::mainButtonClick:"+e);
		}
	},
