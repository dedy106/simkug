window.app_saku3_report_travel_flGlBukuBesarLap = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flGlBukuBesarLap.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flGlBukuBesarLap";
		this.maximize();
...
window.app_saku3_report_travel_flGlBukuBesarLap.extend(window.childForm);
window.app_saku3_report_travel_flGlBukuBesarLap.implement({
