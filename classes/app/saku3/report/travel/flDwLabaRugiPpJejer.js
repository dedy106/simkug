// JavaScript Document
window.app_saku3_report_travel_flDwLabaRugiPpJejer = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flDwLabaRugiPpJejer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flDwLabaRugiPpJejer";
		this.maximize();
...
window.app_saku3_report_travel_flDwLabaRugiPpJejer.extend(window.portalui_childForm);
window.app_saku3_report_travel_flDwLabaRugiPpJejer.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_travel_rptDwLabaRugiPpJejer";
	...
	doOpenTb: function(kode_lokasi,periode,kode_neraca,kode_pp){
		...
		filter2=this.sg1.getCell(2,0)+"/"+periode+"/-/Tidak/1/"+kode_pp;
