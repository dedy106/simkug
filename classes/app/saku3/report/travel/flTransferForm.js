window.app_saku3_report_travel_flTransferForm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flTransferForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flTransferForm";
		this.maximize();
...
window.app_saku3_report_travel_flTransferForm.extend(window.childForm);
window.app_saku3_report_travel_flTransferForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_travel_rptTransferForm";
			...
			systemAPI.alert("[app_saku3_report_travel_flTransferForm]::mainButtonClick:"+e);
		}
	},
