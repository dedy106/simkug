window.app_saku3_report_travel_flHutangAging = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flHutangAging.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flHutangAging";
		this.maximize();
...
window.app_saku3_report_travel_flHutangAging.extend(window.childForm);
window.app_saku3_report_travel_flHutangAging.implement({
		...
		try{			
			...
			if (row ==3)
			{
				filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.kode_vendor",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");				this.filterRep.ListDataSGFilter(this, "Data Bukti",this.sg1, this.sg1.row, this.sg1.col,
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_travel_rptHutangAging";
			...
			systemAPI.alert("[app_saku3_report_travel_flHutangAging]::mainButtonClick:"+e);
		}
	},
