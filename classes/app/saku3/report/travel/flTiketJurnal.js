window.app_saku3_report_travel_flTiketJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flTiketJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flTiketJurnal";
		this.maximize();
...
window.app_saku3_report_travel_flTiketJurnal.extend(window.childForm);
window.app_saku3_report_travel_flTiketJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_travel_rptTiketJurnal";
			...
			systemAPI.alert("[app_saku3_report_travel_flTiketJurnal]::mainButtonClick:"+e);
		}
	},
