// JavaScript Document
window.app_saku3_report_travel_flJuJurnalBukti = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flJuJurnalBukti.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flJuJurnalBukti";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from trans_m where kode_lokasi='"+this.app._lokasi+"' and modul='MI'");
...
window.app_saku3_report_travel_flJuJurnalBukti.extend(window.portalui_childForm);
window.app_saku3_report_travel_flJuJurnalBukti.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_travel_rptJuJurnalBukti";
