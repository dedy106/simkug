window.app_saku3_report_travel_flJurnalJual = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flJurnalJual.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flJurnalJual";
		this.maximize();
...
window.app_saku3_report_travel_flJurnalJual.extend(window.childForm);
window.app_saku3_report_travel_flJurnalJual.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_travel_rptJurnalJual";
			...
			systemAPI.alert("[app_saku3_report_travel_flJurnalJual]::mainButtonClick:"+e);
		}
	},
