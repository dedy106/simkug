// JavaScript Document
window.app_saku3_report_travel_flGlNeracaNeto = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flGlNeracaNeto.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flGlNeracaNeto";
		this.maximize();
...
window.app_saku3_report_travel_flGlNeracaNeto.extend(window.portalui_childForm);
window.app_saku3_report_travel_flGlNeracaNeto.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_travel_rptGlNeracaNeto";
				if (this.sg1.getCell(2,4)=="Mutasi")
				{
					this.nama_report="server_report_saku3_travel_rptGlNeracaMutasiNeto";
				}				
