window.app_saku3_report_travel_flVendor = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flVendor.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flVendor";
		this.maximize();
...
window.app_saku3_report_travel_flVendor.extend(window.childForm);
window.app_saku3_report_travel_flVendor.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_travel_rptVendor";
			...
			systemAPI.alert("[app_saku3_report_travel_flVendor]::mainButtonClick:"+e);
		}
	},
