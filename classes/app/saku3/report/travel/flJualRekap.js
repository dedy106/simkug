window.app_saku3_report_travel_flJualRekap = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flJualRekap.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flJualRekap";
		this.maximize();
...
window.app_saku3_report_travel_flJualRekap.extend(window.childForm);
window.app_saku3_report_travel_flJualRekap.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_travel_rptJualRekap";
			...
			systemAPI.alert("[app_saku3_report_travel_flJualRekap]::mainButtonClick:"+e);
		}
	},
