window.app_saku3_report_travel_flJurnalBeli = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flJurnalBeli.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flJurnalBeli";
		this.maximize();
...
window.app_saku3_report_travel_flJurnalBeli.extend(window.childForm);
window.app_saku3_report_travel_flJurnalBeli.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_travel_rptJurnalBeli";
			...
			systemAPI.alert("[app_saku3_report_travel_flJurnalBeli]::mainButtonClick:"+e);
		}
	},
