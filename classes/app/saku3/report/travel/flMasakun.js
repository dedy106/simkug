// JavaScript Document
window.app_sak3_report_travel_flMasakun = function(owner)
{
	if (owner)
	{
		window.app_sak3_report_travel_flMasakun.prototype.parent.constructor.call(this,owner);
		this.className = "app_sak3_report_travel_flMasakun";
		this.maximize();
...
window.app_sak3_report_travel_flMasakun.extend(window.portalui_childForm);
window.app_sak3_report_travel_flMasakun.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_travel_rptMasakun";
