window.app_saku3_report_travel_flHutang = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flHutang.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flHutang";
		this.maximize();
...
window.app_saku3_report_travel_flHutang.extend(window.childForm);
window.app_saku3_report_travel_flHutang.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_travel_rptHutang";
			...
			systemAPI.alert("[app_saku3_report_travel_flHutang]::mainButtonClick:"+e);
		}
	},
