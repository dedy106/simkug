window.app_saku3_report_travel_flHutangJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flHutangJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flHutangJurnal";
		this.maximize();
...
window.app_saku3_report_travel_flHutangJurnal.extend(window.childForm);
window.app_saku3_report_travel_flHutangJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_travel_flHutangJurnal]::mainButtonClick:"+e);
		}
	},
