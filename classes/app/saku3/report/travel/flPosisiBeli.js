window.app_saku3_report_travel_flPosisiBeli = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flPosisiBeli.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flPosisiBeli";
		this.maximize();
...
window.app_saku3_report_travel_flPosisiBeli.extend(window.childForm);
window.app_saku3_report_travel_flPosisiBeli.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_travel_rptBeliPos";
			...
			systemAPI.alert("[app_saku3_report_travel_flPosisiBeli]::mainButtonClick:"+e);
		}
	},
