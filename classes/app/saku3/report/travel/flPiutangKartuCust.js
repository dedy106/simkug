window.app_saku3_report_travel_flPiutangKartuCust = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flPiutangKartuCust.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flPiutangKartuCust";
		this.maximize();
...
window.app_saku3_report_travel_flPiutangKartuCust.extend(window.childForm);
window.app_saku3_report_travel_flPiutangKartuCust.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_travel_rptPiutangKartuCust";
			...
			systemAPI.alert("[app_saku3_report_travel_flPiutangKartuCust]::mainButtonClick:"+e);
		}
	},
