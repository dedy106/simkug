window.app_saku3_report_travel_flJurnalHPP = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flJurnalHPP.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flJurnalHPP";
		this.maximize();
...
window.app_saku3_report_travel_flJurnalHPP.extend(window.childForm);
window.app_saku3_report_travel_flJurnalHPP.implement({
		...
		try{			
			...
			if (row ==2)
			{
				filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							" and a.form = 'BRGHPP' ";
				this.filterRep.ListDataSGFilter(this, "Data Jurnal HPP",this.sg1, this.sg1.row, this.sg1.col,
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_travel_rptJurnalHPP";
			...
			systemAPI.alert("[app_saku3_report_travel_flJurnalHPP]::mainButtonClick:"+e);
		}
	},
