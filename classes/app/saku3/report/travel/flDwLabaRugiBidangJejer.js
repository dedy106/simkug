// JavaScript Document
window.app_saku3_report_travel_flDwLabaRugiBidangJejer = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flDwLabaRugiBidangJejer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flDwLabaRugiBidangJejer";
		this.maximize();
...
window.app_saku3_report_travel_flDwLabaRugiBidangJejer.extend(window.portalui_childForm);
window.app_saku3_report_travel_flDwLabaRugiBidangJejer.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_travel_rptDwLabaRugiBidangJejer";
