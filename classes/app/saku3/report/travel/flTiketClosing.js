window.app_saku3_report_travel_flTiketClosing = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flTiketClosing.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flTiketClosing";
		this.maximize();
...
window.app_saku3_report_travel_flTiketClosing.extend(window.childForm);
window.app_saku3_report_travel_flTiketClosing.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_travel_rptTiketClosing";
			...
			systemAPI.alert("[app_saku3_report_travel_flTiketClosing]::mainButtonClick:"+e);
		}
	},
