// JavaScript Document
window.app_saku3_report_travel_flGlLabaRugiTrans = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flGlLabaRugiTrans.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flGlLabaRugiTrans";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("Format","=","Saldo Akhir"));
...
window.app_saku3_report_travel_flGlLabaRugiTrans.extend(window.portalui_childForm);
window.app_saku3_report_travel_flGlLabaRugiTrans.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2 = this.app._nikUser+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,3)+"/"+this.sg1.getCell(2,4)+"/"+this.sg1.getCell(2,2);
				
				this.nama_report="server_report_saku3_travel_rptGlLabaRugiTrans";
				if (this.sg1.getCell(2,4)=="Mutasi")
				{
					this.nama_report="server_report_saku3_travel_rptGlLabaRugiMutasiTrans";
				}	
				if (this.sg1.getCell(2,4)=="DC")
				{
					this.nama_report="server_report_saku3_travel_rptGlLabaRugiDcTrans";
				}
	...
	doOpenTb: function(kode_neraca,kode_lokasi){
		...
		nama_report="server_report_saku3_travel_rptGlTbTrans";
	...
	doOpenBb: function(kode_akun,kode_lokasi,periode){
		...
		nama_report="server_report_saku3_travel_rptGlBukuBesarTrans";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
