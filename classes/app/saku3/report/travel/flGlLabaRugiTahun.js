// JavaScript Document
window.app_saku3_report_travel_flGlLabaRugiTahun = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flGlLabaRugiTahun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flGlLabaRugiTahun";
		this.maximize();
...
window.app_saku3_report_travel_flGlLabaRugiTahun.extend(window.portalui_childForm);
window.app_saku3_report_travel_flGlLabaRugiTahun.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2 = this.app._nikUser+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,3)+"/"+this.sg1.getCell(2,4)+"/"+this.sg1.getCell(2,5)+"/"+this.sg1.getCell(2,2);
				
				this.nama_report="server_report_saku3_travel_rptGlLabaRugiTahun";
