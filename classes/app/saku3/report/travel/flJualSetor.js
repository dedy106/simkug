window.app_saku3_report_travel_flJualSetor = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flJualSetor.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flJualSetor";
		this.maximize();
...
window.app_saku3_report_travel_flJualSetor.extend(window.childForm);
window.app_saku3_report_travel_flJualSetor.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from trans_m where kode_lokasi='"+this.app._lokasi+"' and modul='JUALSETOR'  order by periode",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_travel_rptJualSetor";
			...
			systemAPI.alert("[app_saku3_report_travel_flJualSetor]::mainButtonClick:"+e);
		}
	},
