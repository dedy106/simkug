// JavaScript Document
window.app_saku3_report_travel_flGlNeracaSpm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flGlNeracaSpm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flGlNeracaSpm";
		this.maximize();
...
window.app_saku3_report_travel_flGlNeracaSpm.extend(window.portalui_childForm);
window.app_saku3_report_travel_flGlNeracaSpm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_travel_rptGlNeracaSpm";
				if (this.sg1.getCell(2,4)=="Mutasi")
				{
					this.nama_report="server_report_saku3_travel_rptGlNeracaMutasi";
				}				
