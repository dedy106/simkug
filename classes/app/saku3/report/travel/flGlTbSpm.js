window.app_saku3_report_travel_flGlTbSpm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_travel_flGlTbSpm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_travel_flGlTbSpm";
		this.maximize();
...
window.app_saku3_report_travel_flGlTbSpm.extend(window.childForm);
window.app_saku3_report_travel_flGlTbSpm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.app._nikUser+"/"+this.sg1.getCell(2,3)+"/0/"+this.sg1.getCell(2,4);
				this.nama_report="server_report_saku3_travel_rptGlTbSpm";
