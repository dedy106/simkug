window.app_saku3_report_belajar_flSiswa = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_belajar_flSiswa.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_belajar_flSiswa";
		this.maximize();
...
window.app_saku3_report_belajar_flSiswa.extend(window.childForm);
window.app_saku3_report_belajar_flSiswa.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_belajar_rptSiswa";
