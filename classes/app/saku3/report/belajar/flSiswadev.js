window.app_saku3_report_belajar_flSiswadev = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_belajar_flSiswadev.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_belajar_flSiswadev";
		this.maximize();
...
window.app_saku3_report_belajar_flSiswadev.extend(window.childForm);
window.app_saku3_report_belajar_flSiswadev.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			if (row ==0)
			{
				this.filterRep.ListDataSGFilter(this, "Data Jurusan",this.sg1, this.sg1.row, this.sg1.col,
												"select kode_jur, nama from dev_jur",
												"select count(*) from dev_jur",
												new Array("kode_jur","nama"),"where",new Array("kode_jur","nama"));
			}
			if (row ==1)
			{
				this.filterRep.ListDataSGFilter(this, "Data Siswa",this.sg1, this.sg1.row, this.sg1.col,
												...
												"select count(a.nim) from dev_siswa a "+
												this.filterRep.filterStr("a.kode_jur",this.sg1.getCell(1,0)," where "),
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_belajar_rptSiswadev";
