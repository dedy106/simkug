window.app_saku3_report_belajar_flTagihan = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_belajar_flTagihan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_belajar_flTagihan";
		this.maximize();
...
window.app_saku3_report_belajar_flTagihan.extend(window.childForm);
window.app_saku3_report_belajar_flTagihan.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			if (row ==0)
			{
				this.filterRep.ListDataSGFilter(this, "Data Tagihan Siswa",this.sg1, this.sg1.row, this.sg1.col,
												"select a.nim, a.no_tagihan from tagihan a",
												"select count(*) from tagihan a",
												new Array("a.nim","a.no_tagihan"),"where",new Array("NIM","No_Tagihan"));
			}
			/*if (row ==1)
			{
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_belajar_rptTagihan";
