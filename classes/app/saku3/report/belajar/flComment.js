window.app_saku3_report_belajar_flComment = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_belajar_flComment.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_belajar_flComment";
        this.maximize();
...
window.app_saku3_report_belajar_flComment.extend(window.childForm);
window.app_saku3_report_belajar_flComment.implement({
	doLoad:function(){
        try{
            uses("saiCBBL;saiEdit;saiGrid;sgNavigator;app_saku3_dashboard;pageControl;util_ajaxCaller;listView;util_file;app_lab_remote_dataProvider;tinymceCtrl;reportViewer;server_report_report;server_util_Map;webBrowser");
			...
			this.report = new server_report_report();
			var nama_report="server_report_saku3_belajar_vComment";
			this.filter="";
			this.showFilter = "";
			this.lokasi = "";
