window.app_saku3_report_belajar_flTipeTagihan = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_belajar_flTipeTagihan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_belajar_flTipeTagihan";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,0,new Array(0,1,2), new Array("Kode Tagihan","All",""));
	
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_belajar_flTipeTagihan.extend(window.childForm);
window.app_saku3_report_belajar_flTipeTagihan.implement({
		...
		try{			
			if (row ==0)
			{
				this.filterRep.ListDataSGFilter(this, "Data Tagihan",this.sg1, this.sg1.row, this.sg1.col,
												...
												new Array("kode_tagihan","jenis_tagihan"),"where",new Array("kode_tagihan","jenis_tagihan"));
			}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("kode_tagihan",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where");
							  //this.filterRep.filterStr("a.nim",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");
				this.showFilter = this.filterRep.showFilter(this.sg1);
				this.nama_report = "server_report_saku3_belajar_rptTipeTagihan";
