// JavaScript Document
window.app_saku3_report_investasi_flNeracaInv = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_investasi_flNeracaInv.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_investasi_flNeracaInv";
		this.maximize();
...
window.app_saku3_report_investasi_flNeracaInv.extend(window.portalui_childForm);
window.app_saku3_report_investasi_flNeracaInv.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_investasi_rptNeracaInv";
