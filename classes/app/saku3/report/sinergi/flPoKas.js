window.app_saku3_report_sinergi_flPoKas = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sinergi_flPoKas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sinergi_flPoKas";
		this.maximize();
...
window.app_saku3_report_sinergi_flPoKas.extend(window.childForm);
window.app_saku3_report_sinergi_flPoKas.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_sinergi_rptPoKas";
			...
			systemAPI.alert("[app_saku3_report_sinergi_flPoKas]::mainButtonClick:"+e);
		}
	},
