window.app_saku3_report_sinergi_flSo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sinergi_flSo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sinergi_flSo";
		this.maximize();
...
window.app_saku3_report_sinergi_flSo.extend(window.childForm);
window.app_saku3_report_sinergi_flSo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tm_rptBillInvoice";
			...
			systemAPI.alert("[app_saku3_report_sinergi_flSo]::mainButtonClick:"+e);
		}
	},
