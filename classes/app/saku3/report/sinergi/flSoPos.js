window.app_saku3_report_sinergi_flSoPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sinergi_flSoPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sinergi_flSoPos";
		this.maximize();
...
window.app_saku3_report_sinergi_flSoPos.extend(window.childForm);
window.app_saku3_report_sinergi_flSoPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tm_rptSoPos";
			...
			systemAPI.alert("[app_saku3_report_sinergi_flSoPos]::mainButtonClick:"+e);
		}
	},
