window.app_saku3_report_sinergi_flSoKas = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sinergi_flSoKas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sinergi_flSoKas";
		this.maximize();
...
window.app_saku3_report_sinergi_flSoKas.extend(window.childForm);
window.app_saku3_report_sinergi_flSoKas.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_sinergi_rptSoKas";
			...
			systemAPI.alert("[app_saku3_report_sinergi_flSoKas]::mainButtonClick:"+e);
		}
	},
