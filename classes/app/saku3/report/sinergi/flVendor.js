window.app_saku3_report_sinergi_flVendor = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sinergi_flVendor.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sinergi_flVendor";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Kode Suplier","All",""));
...
window.app_saku3_report_sinergi_flVendor.extend(window.childForm);
window.app_saku3_report_sinergi_flVendor.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_sinergi_rptVendor";
			...
			systemAPI.alert("[app_saku3_report_sinergi_flVendor]::mainButtonClick:"+e);
		}
	},
