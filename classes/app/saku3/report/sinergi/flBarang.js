window.app_saku3_report_sinergi_flBarang = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sinergi_flBarang.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sinergi_flBarang";
		this.maximize();
...
window.app_saku3_report_sinergi_flBarang.extend(window.childForm);
window.app_saku3_report_sinergi_flBarang.implement({
		...
		try{			
			...
			if (row ==	1)
			{
				this.filterRep.ListDataSGFilter(this, "Data Barang",this.sg1, this.sg1.row, this.sg1.col,
														  "select kode_barang, nama from si_barang "+
														   this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  "select count(kode_barang) from si_barang "+
														  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_sinergi_rptBarang";
			...
			systemAPI.alert("[app_saku3_report_sinergi_flBarang]::mainButtonClick:"+e);
		}
	},
