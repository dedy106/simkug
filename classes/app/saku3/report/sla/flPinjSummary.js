window.app_saku3_report_sla_flPinjSummary = function(owner) {
    if (owner) {
        window.app_saku3_report_sla_flPinjSummary.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_report_sla_flPinjSummary";
        this.maximize();
...
window.app_saku3_report_sla_flPinjSummary.extend(window.childForm);
window.app_saku3_report_sla_flPinjSummary.implement({
    ...
    mainButtonClick: function(sender) {
        try {
            if (sender === this.app._mainForm.bClear2) {
                ...
                this.nama_report = "server_report_saku3_sla_rptPinjSummary";
            ...
            systemAPI.alert("[app_saku3_report_sla_flPinjSummary]::mainButtonClick:" + e);
        }
    },
