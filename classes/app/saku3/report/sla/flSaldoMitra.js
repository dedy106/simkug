...
window.app_saku3_report_sla_flSaldoMitra.implement({
    ...
    mainButtonClick: function(sender) {
        try {
			...
			if (sender == this.app._mainForm.bBack)
			{
				...
				if (this.link=="2")
				{
					this.doOpenSaldo(this.kode_mitra);
				}
			...
			else
			{
                ...
                this.nama_report = "server_report_saku3_sla_rptSaldoMitra";
    ...
    doOpenSaldo: function(kode_mitra) {

        this.kode_mitra = kode_mitra;
        this.link = "1";
        filter = "where a.kode_mitra='" + kode_mitra + "' ";
        filter2 = "";
