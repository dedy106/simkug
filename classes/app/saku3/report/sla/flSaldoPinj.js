window.app_saku3_report_sla_flSaldoPinj = function(owner) {
    if (owner) {
        window.app_saku3_report_sla_flSaldoPinj.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_report_sla_flSaldoPinj";
        this.maximize();
...
window.app_saku3_report_sla_flSaldoPinj.extend(window.childForm);
window.app_saku3_report_sla_flSaldoPinj.implement({
    ...
    mainButtonClick: function(sender) {
        try {
            if (sender === this.app._mainForm.bClear2) {
                ...
                this.nama_report = "server_report_saku3_sla_rptSaldoPinj";
            ...
            systemAPI.alert("[app_saku3_report_sla_flSaldoPinj]::mainButtonClick:" + e);
        }
    },
