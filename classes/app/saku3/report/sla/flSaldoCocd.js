window.app_saku3_report_sla_flSaldoCocd = function(owner) {
    if (owner) {
        window.app_saku3_report_sla_flSaldoCocd.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_report_sla_flSaldoCocd";
        this.maximize();
    ...
    this.gridLib.SGEditData(this.sg1, 1, new Array(0, 1, 2), new Array("Perusahaan", "All", ""));
...
window.app_saku3_report_sla_flSaldoCocd.extend(window.childForm);
window.app_saku3_report_sla_flSaldoCocd.implement({
        ...
        try {
			...
			else
			{
                ...
                this.filter = this.filterRep.filterStr("a.periode", this.sg1.getCell(1, 0), this.sg1.getCell(2, 0), this.sg1.getCell(3, 0), "where") +
                    this.filterRep.filterStr("a.kode_cocd", this.sg1.getCell(1, 1), this.sg1.getCell(2, 1), this.sg1.getCell(3, 1), "and") ;
                this.filter2 = this.sg1.getCell(2, 1);
                this.showFilter = this.filterRep.showFilter(this.sg1);
                var result = new arrayMap();
                this.nama_report = "server_report_saku3_sla_rptSaldoCocd";
            ...
            systemAPI.alert("[app_saku3_report_sla_flSaldoCocd]::mainButtonClick:" + e);
        }
    },
    ...
    doOpenSaldo: function(kode_cocd) {

        this.kode_cocd = kode_cocd;
        this.link = "1";
        filter = "where a.kode_cocd='" + kode_cocd + "' ";
        filter2 = "";
