window.app_saku3_report_sla_flSaldoMitra = function(owner) {
    if (owner) {
        window.app_saku3_report_sla_flSaldoMitra.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_report_sla_flSaldoMitra";
        this.maximize();
    ...
    this.gridLib.SGEditData(this.sg1, 1, new Array(0, 1, 2), new Array("Clasification", "All", ""));
...
window.app_saku3_report_sla_flSaldoMitra.extend(window.childForm);
window.app_saku3_report_sla_flSaldoMitra.implement({
    doEllipseClick: function(sender, col, row) {
        try {
            
            if (row == 1) {
                this.filterRep.ListDataSGFilter(this, "Data Clasification", this.sg1, this.sg1.row, this.sg1.col,
    ...
    mainButtonClick: function(sender) {
        try {
			...
			if (sender == this.app._mainForm.bBack)
			{
				...
				if (this.link=="2")
				{
					this.doOpenSaldo(this.no_bukti);
				}
			...
			else
			{
                ...
                this.filter = this.filterRep.filterStr("a.periode", this.sg1.getCell(1, 0), this.sg1.getCell(2, 0), this.sg1.getCell(3, 0), "where") +
                    this.filterRep.filterStr("a.kode_class", this.sg1.getCell(1, 1), this.sg1.getCell(2, 1), this.sg1.getCell(3, 1), "and") ;
                this.filter2 = this.sg1.getCell(2, 1);
                this.showFilter = this.filterRep.showFilter(this.sg1);
                var result = new arrayMap();
                this.nama_report = "server_report_saku3_sla_rptSaldoClass";
            ...
            systemAPI.alert("[app_saku3_report_sla_flSaldoMitra]::mainButtonClick:" + e);
        }
    },
    ...
    doOpenSaldo: function(kode_class) {

        this.kode_class = kode_class;
        this.link = "1";
        filter = "where a.kode_class='" + kode_class + "' ";
        filter2 = "";
        nama_report = "server_report_saku3_sla_rptSaldoPinj";
