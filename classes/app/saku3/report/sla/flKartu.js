window.app_saku3_report_sla_flKartu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sla_flKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sla_flKartu";
		this.maximize();
...
window.app_saku3_report_sla_flKartu.extend(window.childForm);
window.app_saku3_report_sla_flKartu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_sla_flKartu]::mainButtonClick:"+e);
		}
	},
