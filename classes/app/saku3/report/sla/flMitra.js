window.app_saku3_report_sla_flMitra = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_sla_flMitra.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_sla_flMitra";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,0,new Array(0,1,2), new Array("Kode Mitra","All",""));
...
window.app_saku3_report_sla_flMitra.extend(window.childForm);
window.app_saku3_report_sla_flMitra.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_sla_rptMitra";
			...
			systemAPI.alert("[app_saku3_report_sla_flMitra]::mainButtonClick:"+e);
		}
	},
