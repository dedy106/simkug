window.app_saku3_report_sla_flManRisk = function(owner) {
    if (owner) {
        window.app_saku3_report_sla_flManRisk.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_report_sla_flManRisk";
        this.maximize();
...
window.app_saku3_report_sla_flManRisk.extend(window.childForm);
window.app_saku3_report_sla_flManRisk.implement({
    ...
    doSelectCell: function(sender, col, row) {
        ...
        if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from sla_ris_class_d where kode_lokasi='"+this.app._lokasi+"' order by periode",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
    ...
    mainButtonClick: function(sender) {
        try {
            if (sender === this.app._mainForm.bClear2) {
                ...
                this.nama_report = "server_report_saku3_sla_rptManRisk";
            ...
            systemAPI.alert("[app_saku3_report_sla_flManRisk]::mainButtonClick:" + e);
        }
    },
