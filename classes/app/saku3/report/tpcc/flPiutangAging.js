window.app_saku3_report_tpcc_flPiutangAging = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tpcc_flPiutangAging.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tpcc_flPiutangAging";
		this.maximize();
...
window.app_saku3_report_tpcc_flPiutangAging.extend(window.childForm);
window.app_saku3_report_tpcc_flPiutangAging.implement({
		...
		try
		{
			...
			else
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.no_piutang",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and");				this.filter2 = this.sg1.getCell(2,1);
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCellDateValue(2,4);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_tpcc_rptPiutangAging";
			...
			systemAPI.alert("[app_saku3_report_tpcc_flPiutangAging]::mainButtonClick:"+e);
		}
	},
