window.app_saku3_report_tpcc_flPiutangJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tpcc_flPiutangJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tpcc_flPiutangJurnal";
		this.maximize();
...
window.app_saku3_report_tpcc_flPiutangJurnal.extend(window.childForm);
window.app_saku3_report_tpcc_flPiutangJurnal.implement({
		...
		try{			
			...
			if (row ==3)
			{
				filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							"and a.form in ('AKRU','PIUBILL','UNBILL','REVUBILL') ";
		...
		try
		{
			...
			else
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							"and e.form in ('AKRU','PIUBILL','UNBILL','REVUBILL') ";
				this.filter2 = this.sg1.getCell(2,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_tpcc_rptPiutangJurnal";
			...
			systemAPI.alert("[app_saku3_report_tpcc_flPiutangJurnal]::mainButtonClick:"+e);
		}
	},
