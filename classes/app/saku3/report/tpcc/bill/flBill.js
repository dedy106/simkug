window.app_saku3_report_tpcc_bill_flBill = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tpcc_bill_flBill.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tpcc_bill_flBill";
		this.maximize();
...
window.app_saku3_report_tpcc_bill_flBill.extend(window.childForm);
window.app_saku3_report_tpcc_bill_flBill.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tpcc_bill_rptBill";
			...
			systemAPI.alert("[app_saku3_report_tpcc_bill_flBill]::mainButtonClick:"+e);
		}
	},
