window.app_saku3_report_tpcc_bill_flKuitansi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tpcc_bill_flKuitansi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tpcc_bill_flKuitansi";
		this.maximize();
...
window.app_saku3_report_tpcc_bill_flKuitansi.extend(window.childForm);
window.app_saku3_report_tpcc_bill_flKuitansi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tpcc_bill_rptKuitansi";
			...
			systemAPI.alert("[app_saku3_report_tpcc_bill_flKuitansi]::mainButtonClick:"+e);
		}
	},
