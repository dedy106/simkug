window.app_saku3_report_tpcc_bill_flFaktur = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tpcc_bill_flFaktur.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tpcc_bill_flFaktur";
		this.maximize();
...
window.app_saku3_report_tpcc_bill_flFaktur.extend(window.childForm);
window.app_saku3_report_tpcc_bill_flFaktur.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tpcc_bill_rptFaktur";
			...
			systemAPI.alert("[app_saku3_report_tpcc_bill_flFaktur]::mainButtonClick:"+e);
		}
	},
