window.app_saku3_report_tpcc_bill_flKontrakKartu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tpcc_bill_flKontrakKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tpcc_bill_flKontrakKartu";
		this.maximize();
...
window.app_saku3_report_tpcc_bill_flKontrakKartu.extend(window.childForm);
window.app_saku3_report_tpcc_bill_flKontrakKartu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tpcc_bill_rptKontrakKartu";
			...
			systemAPI.alert("[app_saku3_report_tpcc_bill_flKontrakKartu]::mainButtonClick:"+e);
		}
	},
