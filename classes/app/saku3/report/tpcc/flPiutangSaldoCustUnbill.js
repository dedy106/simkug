window.app_saku3_report_tpcc_flPiutangSaldoCustUnbill = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tpcc_flPiutangSaldoCustUnbill.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tpcc_flPiutangSaldoCustUnbill";
		this.maximize();
...
window.app_saku3_report_tpcc_flPiutangSaldoCustUnbill.extend(window.childForm);
window.app_saku3_report_tpcc_flPiutangSaldoCustUnbill.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tpcc_rptPiutangSaldoCustUnbill";
			...
			systemAPI.alert("[app_saku3_report_tpcc_flPiutangSaldoCustUnbill]::mainButtonClick:"+e);
		}
	},
	...
	doOpenSaldo: function(kode_cust,kode_lokasi){
		...
		nama_report="server_report_saku3_tpcc_rptPiutangSaldoUnbill";
