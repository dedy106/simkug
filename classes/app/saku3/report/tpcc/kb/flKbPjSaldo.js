window.app_saku3_report_tpcc_kb_flKbPjSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tpcc_kb_flKbPjSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tpcc_kb_flKbPjSaldo";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("Akun Panjar","All",""));
	this.gridLib.SGEditData(this.sg1,5,new Array(0,1,2), new Array("No Panjar","All",""));
	this.gridLib.SGEditData(this.sg1,6,new Array(0,1,2), new Array("Bentuk Laporan","=","Karyawan"));
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
	this.doSelectCell(this.sg1,2,5);
};
window.app_saku3_report_tpcc_kb_flKbPjSaldo.extend(window.childForm);
window.app_saku3_report_tpcc_kb_flKbPjSaldo.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row ==4)
			{
				...
				var sql1 = "select distinct a.akun_pj,b.nama "+ 
				"from panjar_m a "+
				"inner join masakun b on a.akun_pj=b.kode_akun and a.kode_lokasi=b.kode_lokasi "+this.filter;

				var sql2 = "select count(distinct a.akun_pj) "+
				"from panjar_m a "+
				"inner join masakun b on a.akun_pj=b.kode_akun and a.kode_lokasi=b.kode_lokasi "+this.filter;
				this.filterRep.ListDataSGFilter(this, "Data Panjar",this.sg1, this.sg1.row, this.sg1.col,
												sql1,
												sql2,
												new Array("a.akun_pj","b.nama"),"and",new Array("Kode Akun","Nama"));
			}
			...
			if (row ==5)
			{
				this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.kode_pp",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
							this.filterRep.filterStr("a.nik_pengaju",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and")+
							this.filterRep.filterStr("a.akun_pj",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4),"and");
				this.filterRep.ListDataSGFilter(this, "Data Panjar",this.sg1, this.sg1.row, this.sg1.col,
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from panjar_m where kode_lokasi='"+this.app._lokasi+"' order by periode",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
		if (row == 6)
		{
			this.sg1.columns.get(2).pickList.clear();
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.nik_pengaju",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and")+
							this.filterRep.filterStr("a.akun_pj",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4),"and")+
							this.filterRep.filterStr("a.no_pj",this.sg1.getCell(1,5),this.sg1.getCell(2,5),this.sg1.getCell(3,5),"and");
				
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();	
			
				if (this.sg1.getCell(2,6)=="Karyawan")
				{
					this.filter3 = this.filterRep.filterStr("c.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");
					...
					this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.akun_pj",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4),"and")+
							this.filterRep.filterStr("a.no_pj",this.sg1.getCell(1,5),this.sg1.getCell(2,5),this.sg1.getCell(3,5),"and");
					this.filter2 = this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,6)+"/"+this.filter3;
				
				}
				if (this.sg1.getCell(2,6)=="PP")
				{
					this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("a.kode_pp",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
					this.filter2 = this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,6)+"/"+this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.kode_pp",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
				}
				
				this.nama_report = "server_report_saku3_tpcc_kb_rptKbPjSaldo";
			...
			systemAPI.alert("[app_saku3_report_tpcc_kb_flKbPjSaldo]::mainButtonClick:"+e);
		}
	},
