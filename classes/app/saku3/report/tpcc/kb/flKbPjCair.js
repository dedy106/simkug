window.app_saku3_report_tpcc_kb_flKbPjCair = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tpcc_kb_flKbPjCair.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tpcc_kb_flKbPjCair";
		this.maximize();
...
window.app_saku3_report_tpcc_kb_flKbPjCair.extend(window.childForm);
window.app_saku3_report_tpcc_kb_flKbPjCair.implement({
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.filter2 = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("a.kode_pp",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
							this.filterRep.filterStr("a.no_dokumen",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4),"and")+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,5);
				...
				// 		"inner join trans_m c on a.no_bukti=c.no_bukti and a.kode_lokasi=c.kode_lokasi "+this.filter2+modul+
			...
			systemAPI.alert("[app_saku3_report_tpcc_kb_flKbPjCair]::mainButtonClick:"+e);
		}
	},
