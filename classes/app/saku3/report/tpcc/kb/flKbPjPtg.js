window.app_saku3_report_tpcc_kb_flKbPjPtg = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tpcc_kb_flKbPjPtg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tpcc_kb_flKbPjPtg";
		this.maximize();
...
window.app_saku3_report_tpcc_kb_flKbPjPtg.extend(window.childForm);
window.app_saku3_report_tpcc_kb_flKbPjPtg.implement({
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.filter2 = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("a.kode_pp",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
							this.filterRep.filterStr("a.no_bukti",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4),"and")+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,5);
			...
			systemAPI.alert("[app_saku3_report_tpcc_kb_flKbPjPtg]::mainButtonClick:"+e);
		}
	},
