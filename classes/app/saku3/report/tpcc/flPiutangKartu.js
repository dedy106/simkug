window.app_saku3_report_tpcc_flPiutangKartu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tpcc_flPiutangKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tpcc_flPiutangKartu";
		this.maximize();
...
window.app_saku3_report_tpcc_flPiutangKartu.extend(window.childForm);
window.app_saku3_report_tpcc_flPiutangKartu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tpcc_rptPiutangKartu";
			...
			systemAPI.alert("[app_saku3_report_tpcc_flPiutangKartu]::mainButtonClick:"+e);
		}
	},
