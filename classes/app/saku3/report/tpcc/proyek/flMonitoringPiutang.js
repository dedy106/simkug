window.app_saku3_report_tpcc_proyek_flMonitoringPiutang = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tpcc_proyek_flMonitoringPiutang.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tpcc_proyek_flMonitoringPiutang";
		this.maximize();
...
window.app_saku3_report_tpcc_proyek_flMonitoringPiutang.extend(window.childForm);
window.app_saku3_report_tpcc_proyek_flMonitoringPiutang.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tpcc_proyek_rptMonitoringPiutang";
			...
			systemAPI.alert("[app_saku3_report_tpcc_proyek_flMonitoringPiutang]::mainButtonClick:"+e);
		}
	},
