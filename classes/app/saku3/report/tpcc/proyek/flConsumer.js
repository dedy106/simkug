window.app_saku3_report_tpcc_proyek_flConsumer = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tpcc_proyek_flConsumer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tpcc_proyek_flConsumer";
		this.maximize();
...
window.app_saku3_report_tpcc_proyek_flConsumer.extend(window.childForm);
window.app_saku3_report_tpcc_proyek_flConsumer.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tpcc_proyek_rptConsumer";
			...
			systemAPI.alert("[app_saku3_report_tpcc_proyek_flConsumer]::mainButtonClick:"+e);
		}
	},
