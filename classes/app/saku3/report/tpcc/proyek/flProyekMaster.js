window.app_saku3_report_tpcc_proyek_flProyekMaster = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tpcc_proyek_flProyekMaster.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tpcc_proyek_flProyekMaster";
		this.maximize();
...
window.app_saku3_report_tpcc_proyek_flProyekMaster.extend(window.childForm);
window.app_saku3_report_tpcc_proyek_flProyekMaster.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tpcc_proyek_rptProyekMaster";
			...
			systemAPI.alert("[app_saku3_report_tpcc_proyek_flProyekMaster]::mainButtonClick:"+e);
		}
	},
