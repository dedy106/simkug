window.app_saku3_report_tpcc_proyek_flCust = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tpcc_proyek_flCust.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tpcc_proyek_flCust";
		this.maximize();
...
window.app_saku3_report_tpcc_proyek_flCust.extend(window.childForm);
window.app_saku3_report_tpcc_proyek_flCust.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tpcc_proyek_rptCust";
			...
			systemAPI.alert("[app_saku3_report_tpcc_proyek_flCust]::mainButtonClick:"+e);
		}
	},
