window.app_saku3_report_tpcc_proyek_flDataProyek = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tpcc_proyek_flDataProyek.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tpcc_proyek_flDataProyek";
		this.maximize();
...
window.app_saku3_report_tpcc_proyek_flDataProyek.extend(window.childForm);
window.app_saku3_report_tpcc_proyek_flDataProyek.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tpcc_proyek_rptDataProyek";
			...
			systemAPI.alert("[app_saku3_report_tpcc_proyek_flDataProyek]::mainButtonClick:"+e);
		}
	},
