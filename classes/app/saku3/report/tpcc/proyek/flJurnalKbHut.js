window.app_saku3_report_tpcc_proyek_flJurnalKbHut = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tpcc_proyek_flJurnalKbHut.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tpcc_proyek_flJurnalKbHut";
		this.maximize();
...
window.app_saku3_report_tpcc_proyek_flJurnalKbHut.extend(window.childForm);
window.app_saku3_report_tpcc_proyek_flJurnalKbHut.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tpcc_proyek_rptJurnalKbHut";
			...
			systemAPI.alert("[app_saku3_report_tpcc_proyek_flJurnalKbHut]::mainButtonClick:"+e);
		}
	},
