window.app_saku3_report_tpcc_proyek_flJurnalBddRev = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tpcc_proyek_flJurnalBddRev.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tpcc_proyek_flJurnalBddRev";
		this.maximize();
...
window.app_saku3_report_tpcc_proyek_flJurnalBddRev.extend(window.childForm);
window.app_saku3_report_tpcc_proyek_flJurnalBddRev.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_tpcc_proyek_flJurnalBddRev]::mainButtonClick:"+e);
		}
	},
