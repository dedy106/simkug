window.app_saku3_report_tpcc_proyek_flProyek = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tpcc_proyek_flProyek.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tpcc_proyek_flProyek";
		this.maximize();
...
window.app_saku3_report_tpcc_proyek_flProyek.extend(window.childForm);
window.app_saku3_report_tpcc_proyek_flProyek.implement({
		...
		try{			
			...
			if (row == 2)
			{
				this.filterRep.ListDataSGFilter(this, "Data Customer",this.sg1, this.sg1.row, this.sg1.col,
														  "select kode_cust, nama from brg_cust "+
														   this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  "select count(kode_cust) from brg_cust "+
														  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
			...
			if (row == 3)
			{
				this.filterRep.ListDataSGFilter(this, "Data Jenis",this.sg1, this.sg1.row, this.sg1.col,
														  "select kode_jenis, nama from pr_jenis "+
														   this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  "select count(kode_jenis) from pr_jenis "+
														  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
			...
			if (row ==4)
			{
				this.filterRep.ListDataSGFilter(this, "Data Proyek",this.sg1, this.sg1.row, this.sg1.col,
														  "select kode_proyek, nama from pr_proyek "+
														   this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  "select count(kode_proyek) from pr_proyek "+
														  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  new Array("kode_proyek","nama"),"and");
			}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.filter2 = nama_cab+"/"+this.sg1.getCell(2,0);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_tpcc_proyek_rptProyek";
			...
			systemAPI.alert("[app_saku3_report_tpcc_proyek_flProyek]::mainButtonClick:"+e);
		}
	},
	...
	doOpenDetailBayar: function(no_bukti,kode_lokasi,jenis){
		...
		nama_report="server_report_saku3_tpcc_proyek_rptProyekDetBayar";
