window.app_saku3_report_tpcc_proyek_flProyekPiutang = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tpcc_proyek_flProyekPiutang.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tpcc_proyek_flProyekPiutang";
		this.maximize();
...
window.app_saku3_report_tpcc_proyek_flProyekPiutang.extend(window.childForm);
window.app_saku3_report_tpcc_proyek_flProyekPiutang.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tpcc_proyek_rptProyekPiutang";
			...
			systemAPI.alert("[app_saku3_report_tpcc_proyek_flProyekPiutang]::mainButtonClick:"+e);
		}
	},
	...
	doOpenPiutang: function(no_bukti,kode_lokasi){
		...
		nama_report="server_report_saku3_produk_rptProyekPiutangJurnal";
