window.app_saku3_report_tpcc_proyek_flDetailPiutang = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tpcc_proyek_flDetailPiutang.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tpcc_proyek_flDetailPiutang";
		this.maximize();
...
window.app_saku3_report_tpcc_proyek_flDetailPiutang.extend(window.childForm);
window.app_saku3_report_tpcc_proyek_flDetailPiutang.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tpcc_proyek_rptDetailPiutang";
			...
			systemAPI.alert("[app_saku3_report_tpcc_proyek_flDetailPiutang]::mainButtonClick:"+e);
		}
	},
