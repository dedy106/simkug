window.app_saku3_report_ypt_flKasKirim = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ypt_flKasKirim.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ypt_flKasKirim";
		this.maximize();
...
window.app_saku3_report_ypt_flKasKirim.extend(window.childForm);
window.app_saku3_report_ypt_flKasKirim.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_ypt_rptKasKirim";
			...
			systemAPI.alert("[app_saku3_report_ypt_flKasKirim]::mainButtonClick:"+e);
		}
	},
