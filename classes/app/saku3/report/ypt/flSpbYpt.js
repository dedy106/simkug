window.app_saku3_report_ypt_flSpbYpt = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ypt_flSpbYpt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ypt_flSpbYpt";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("No Bilyet","All",""));
...
window.app_saku3_report_ypt_flSpbYpt.extend(window.childForm);
window.app_saku3_report_ypt_flSpbYpt.implement({
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter =  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.no_cek",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and");
			...
			systemAPI.alert("[app_saku3_report_ypt_flSpbYpt]::mainButtonClick:"+e);
		}
	},
