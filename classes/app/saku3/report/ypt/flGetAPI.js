window.app_saku3_report_ypt_flGetAPI = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ypt_flGetAPI.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ypt_flGetAPI";
        this.maximize();
...
window.app_saku3_report_ypt_flGetAPI.extend(window.childForm);
window.app_saku3_report_ypt_flGetAPI.implement({
	doLoad:function(){
        try{
			...
			this.report = new server_report_report();
			var nama_report="server_report_saku3_ypt_rptGetAPI";
			this.filter="";
			this.showFilter = "";
			this.lokasi = "";
