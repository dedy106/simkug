window.app_saku3_report_ypt_flCekGar = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ypt_flCekGar.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ypt_flCekGar";
        this.maximize();
...
window.app_saku3_report_ypt_flCekGar.extend(window.childForm);
window.app_saku3_report_ypt_flCekGar.implement({
	doLoad:function(){
        try{
			...
			var nama_report="server_report_saku3_ypt_rptCekGar";
			this.filter="";
			this.showFilter = "";
			this.lokasi = "";
