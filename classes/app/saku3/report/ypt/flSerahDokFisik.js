window.app_saku3_report_ypt_flSerahDokFisik = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ypt_flSerahDokFisik.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ypt_flSerahDokFisik";
		this.maximize();
...
window.app_saku3_report_ypt_flSerahDokFisik.extend(window.childForm);
window.app_saku3_report_ypt_flSerahDokFisik.implement({
	...
	doSelectCell: function(sender, col, row){		
		...
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2],["3","123","6"]);
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2],[0,2,0]);
			...
			else
			{
				...
				else
				{
					...
					this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
								this.filterRep.filterStr("a.kode_pp",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and") + " and e.nik='"+this.app._userLog+"' ";
					...
					this.nama_report = "server_report_saku3_ypt_rptSerahDokFisik";
    ...
    doOpenBukti: function(kode_pp,kode_lokasi,jenis){
		this.link="1";
		filter = "where a.kode_pp='"+kode_pp+"' and a.kode_lokasi='"+kode_lokasi+"' ";
		filter2=this.sg1.getCell(2,2)+"/"+jenis;
		nama_report="server_report_saku3_ypt_rptSerahDokFisikDet";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
