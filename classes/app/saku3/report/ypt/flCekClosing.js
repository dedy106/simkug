window.app_saku3_report_ypt_flCekClosing = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ypt_flCekClosing.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ypt_flCekClosing";
        this.maximize();
...
window.app_saku3_report_ypt_flCekClosing.extend(window.childForm);
window.app_saku3_report_ypt_flCekClosing.implement({
	doLoad:function(){
        try{
			...
			this.report = new server_report_report();
			var nama_report="server_report_saku3_ypt_rptCekClosing";
			this.filter="";
			this.showFilter = "";
			this.lokasi = "";
