window.app_saku3_report_ypt_flAppDokFisik = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ypt_flAppDokFisik.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ypt_flAppDokFisik";
        this.maximize();
...
window.app_saku3_report_ypt_flAppDokFisik.extend(window.childForm);
window.app_saku3_report_ypt_flAppDokFisik.implement({
	doLoad:function(){
        try{
			// this.formLock = 0;
			...
			if (this.formLock == 1) {
				...
				this.report = new server_report_report();
				var nama_report="server_report_saku3_ypt_rptAppDokFisik";
				this.filter="";
				this.showFilter = "";
				this.lokasi = "";
