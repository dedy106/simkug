window.app_saku3_report_ypt_logistik_flJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ypt_logistik_flJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ypt_logistik_flJurnal";
		this.maximize();
...
window.app_saku3_report_ypt_logistik_flJurnal.extend(window.childForm);
window.app_saku3_report_ypt_logistik_flJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_ypt_logistik_rptJurnal";
			...
			systemAPI.alert("[app_saku3_report_ypt_logistik_flJurnal]::mainButtonClick:"+e);
		}
	},
