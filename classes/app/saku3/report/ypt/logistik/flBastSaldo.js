window.app_saku3_report_ypt_logistik_flBastSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ypt_logistik_flBastSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ypt_logistik_flBastSaldo";
		this.maximize();
...
window.app_saku3_report_ypt_logistik_flBastSaldo.extend(window.childForm);
window.app_saku3_report_ypt_logistik_flBastSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
		    	...
		    	this.filter =  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("a.no_hutang",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_ypt_logistik_rptBastSaldo";
			...
			systemAPI.alert("[app_saku3_report_ypt_logistik_flBastSaldo]::mainButtonClick:"+e);
		}
	},
	...
	doOpenBukti: function(no_bukti,kode_lokasi){
		this.link="1";
		filter = "where a.hutang_m='"+no_bukti+"' and a.kode_lokasi='"+kode_lokasi+"' ";
