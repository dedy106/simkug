window.app_saku3_report_ypt_logistik_flPb = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ypt_logistik_flPb.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ypt_logistik_flPb";
		this.maximize();
...
window.app_saku3_report_ypt_logistik_flPb.extend(window.childForm);
window.app_saku3_report_ypt_logistik_flPb.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_ypt_logistik_rptPb";
			...
			systemAPI.alert("[app_saku3_report_ypt_logistik_flPb]::mainButtonClick:"+e);
		}
	},
