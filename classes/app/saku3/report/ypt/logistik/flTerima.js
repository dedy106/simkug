window.app_saku3_report_ypt_logistik_flTerima = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ypt_logistik_flTerima.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ypt_logistik_flTerima";
		this.maximize();
...
window.app_saku3_report_ypt_logistik_flTerima.extend(window.childForm);
window.app_saku3_report_ypt_logistik_flTerima.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_ypt_logistik_rptTerima";
			...
			systemAPI.alert("[app_saku3_report_ypt_logistik_flTerima]::mainButtonClick:"+e);
		}
	},
