window.app_saku3_report_ypt_logistik_flLampiran4 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ypt_logistik_flLampiran4.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ypt_logistik_flLampiran4";
		this.maximize();
...
window.app_saku3_report_ypt_logistik_flLampiran4.extend(window.childForm);
window.app_saku3_report_ypt_logistik_flLampiran4.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row ==3)
			{
				var sql="select a.no_pesan,b.no_app,a.keterangan "+
						"from log_pesan_m a "+
						"inner join app_d b on a.no_pesan=b.no_bukti and a.kode_lokasi=b.kode_lokasi ";
				...
				this.filterRep.ListDataSGFilter(this, "Data Pengajuan",this.sg1, this.sg1.row, this.sg1.col,sql+this.filter,sql+this.filter,
												new Array("a.no_pesan","a.no_app","a.keterangan"),"and",new Array("No Bukti","No App","Keterangan"));
			}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_ypt_logistik_rptLampiran4";
			...
			systemAPI.alert("[app_saku3_report_ypt_logistik_flLampiran4]::mainButtonClick:"+e);
		}
	},
