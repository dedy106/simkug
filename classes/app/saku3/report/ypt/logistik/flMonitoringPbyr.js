window.app_saku3_report_ypt_logistik_flMonitoringPbyr = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ypt_logistik_flMonitoringPbyr.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ypt_logistik_flMonitoringPbyr";
		this.maximize();
...
window.app_saku3_report_ypt_logistik_flMonitoringPbyr.extend(window.childForm);
window.app_saku3_report_ypt_logistik_flMonitoringPbyr.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_ypt_logistik_rptMonitoringPbyr";
			...
			systemAPI.alert("[app_saku3_report_ypt_logistik_flMonitoringPbyr]::mainButtonClick:"+e);
		}
	},
