window.app_saku3_report_ypt_logistik_flMonitoring = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ypt_logistik_flMonitoring.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ypt_logistik_flMonitoring";
		this.maximize();
...
window.app_saku3_report_ypt_logistik_flMonitoring.extend(window.childForm);
window.app_saku3_report_ypt_logistik_flMonitoring.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_ypt_logistik_rptMonitoring";
			...
			systemAPI.alert("[app_saku3_report_ypt_logistik_flMonitoring]::mainButtonClick:"+e);
		}
	},
