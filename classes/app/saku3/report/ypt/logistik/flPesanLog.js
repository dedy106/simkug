window.app_saku3_report_ypt_logistik_flPesanLog = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ypt_logistik_flPesanLog.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ypt_logistik_flPesanLog";
		this.maximize();
...
window.app_saku3_report_ypt_logistik_flPesanLog.extend(window.childForm);
window.app_saku3_report_ypt_logistik_flPesanLog.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_ypt_logistik_rptPesanLog";
			...
			systemAPI.alert("[app_saku3_report_ypt_logistik_flPesanLog]::mainButtonClick:"+e);
		}
	},
