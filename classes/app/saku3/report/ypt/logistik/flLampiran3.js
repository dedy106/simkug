window.app_saku3_report_ypt_logistik_flLampiran3 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ypt_logistik_flLampiran3.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ypt_logistik_flLampiran3";
		this.maximize();
...
window.app_saku3_report_ypt_logistik_flLampiran3.extend(window.childForm);
window.app_saku3_report_ypt_logistik_flLampiran3.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_ypt_logistik_rptLampiran3";
			...
			systemAPI.alert("[app_saku3_report_ypt_logistik_flLampiran3]::mainButtonClick:"+e);
		}
	},
