window.app_saku3_report_ypt_logistik_flPesan = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ypt_logistik_flPesan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ypt_logistik_flPesan";
		this.maximize();
...
window.app_saku3_report_ypt_logistik_flPesan.extend(window.childForm);
window.app_saku3_report_ypt_logistik_flPesan.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_ypt_logistik_flPesan]::mainButtonClick:"+e);
		}
	},
