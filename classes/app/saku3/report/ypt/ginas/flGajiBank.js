window.app_saku3_report_ypt_ginas_flGajiBank = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ypt_ginas_flGajiBank.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ypt_ginas_flGajiBank";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("NIK","All",""));
...
window.app_saku3_report_ypt_ginas_flGajiBank.extend(window.childForm);
window.app_saku3_report_ypt_ginas_flGajiBank.implement({
		...
		try{			
			...
			if (row ==2)
			{
				this.filterRep.ListDataSGFilter(this, "Data Bank",this.sg1, this.sg1.row, this.sg1.col,
												"select distinct a.bank from hr_karyawan a ",
												"select distinct a.bank from hr_karyawan a ",
												new Array("a.bank"),"and",new Array("Bank"));
			}
		...
		try
		{
			...
			else
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
								...
								this.filterRep.filterStr("a.bank",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_ypt_ginas_rptGajiBank";
			...
			systemAPI.alert("[app_saku3_report_ypt_ginas_flGajiBank]::mainButtonClick:"+e);
		}
	},
