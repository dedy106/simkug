window.app_saku3_report_ypt_ginas_flRekapGaji = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ypt_ginas_flRekapGaji.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ypt_ginas_flRekapGaji";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,3,[0,1,2],["Output Laporan","=","Tel-U"]);
	
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_ypt_ginas_flRekapGaji.extend(window.childForm);
window.app_saku3_report_ypt_ginas_flRekapGaji.implement({
	...
	doSelectCell: function(sender, col, row){		
		...
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3],["3","123","123","2"]);
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3],[0,0,2,0]);
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("Tel-U","Non"));
		}
	},
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_saku3_ypt_ginas_rptRekapGj";
					if (this.sg1.getCell(2,3)=="Non")
					{
						this.nama_report = "server_report_saku3_ypt_ginas_rptRekapNon";
					}
