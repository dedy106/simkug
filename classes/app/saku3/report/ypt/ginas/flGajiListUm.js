window.app_saku3_report_ypt_ginas_flGajiListUm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ypt_ginas_flGajiListUm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ypt_ginas_flGajiListUm";
		this.maximize();
...
window.app_saku3_report_ypt_ginas_flGajiListUm.extend(window.childForm);
window.app_saku3_report_ypt_ginas_flGajiListUm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_ypt_ginas_rptGajiListUm";
			...
			systemAPI.alert("[app_saku3_report_ypt_ginas_flGajiListUm]::mainButtonClick:"+e);
		}
	},
