window.app_saku3_report_ypt_ginas_flGajiList = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ypt_ginas_flGajiList.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ypt_ginas_flGajiList";
		this.maximize();
...
window.app_saku3_report_ypt_ginas_flGajiList.extend(window.childForm);
window.app_saku3_report_ypt_ginas_flGajiList.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_ypt_ginas_rptGajiList";
			...
			systemAPI.alert("[app_saku3_report_ypt_ginas_flGajiList]::mainButtonClick:"+e);
		}
	},
