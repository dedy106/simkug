window.app_saku3_report_ypt_ginas_flCekSelisih = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ypt_ginas_flCekSelisih.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ypt_ginas_flCekSelisih";
		this.maximize();
...
window.app_saku3_report_ypt_ginas_flCekSelisih.extend(window.childForm);
window.app_saku3_report_ypt_ginas_flCekSelisih.implement({
		...
		try{			
			...
			if (row ==3)
			{
				this.filterRep.ListDataSGFilter(this, "Data Karyawan",this.sg1, this.sg1.row, this.sg1.col,
												"select a.nik , a.nama from hr_karyawan a where a.bm='-' ",
												"select a.nik , a.nama  from hr_karyawan a where a.bm='-' ",
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_ypt_ginas_rptCekSelisih";
			...
			systemAPI.alert("[app_saku3_report_ypt_ginas_flCekSelisih]::mainButtonClick:"+e);
		}
	},
