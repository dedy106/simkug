// JavaScript Document
window.app_saku3_report_ypt_ginas_flPayrolList = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ypt_ginas_flPayrolList.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ypt_ginas_flPayrolList";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Jenis Bank","=","MANDIRI"));
...
window.app_saku3_report_ypt_ginas_flPayrolList.extend(window.portalui_childForm);
window.app_saku3_report_ypt_ginas_flPayrolList.implement({
	...
	doSelectCell : function(sender, col, row){
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("MANDIRI","BANK LAIN","TUNAI"));
		}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			if (sender == this.app._mainForm.bBack)
			{
				...
				if (this.link=="2")
				{
					this.doOpenBb(this.nik,this.kode_lokasi);
				}
			}
			else
			{
				...
				if (this.app._lokasi == this.app._kodeLokasiKonsol)
				{
					...
					this.filter = this.filterRep.filterStr("b.kode_lokasi",this.sg1.getCell(1,0),this.app._lokasi,this.app._lokasi,"where")+
				...
				if (this.sg1.getCell(2,3)=="MANDIRI")
				{
					this.nama_report="server_report_saku3_ypt_ginas_rptPayMan";
				}
				if (this.sg1.getCell(2,3)=="BANK LAIN")
				{
					this.nama_report="server_report_saku3_ypt_ginas_rptPayLain";
					
				}
				if (this.sg1.getCell(2,3)=="TUNAI")
				{
					this.nama_report="server_report_saku3_ypt_ginas_rptPayTun";
				}
	...
	doOpenBb: function(nik,kode_lokasi){
		this.nik=nik;
		this.kode_lokasi=kode_lokasi;
		this.link="1";
		filter2 = kode_lokasi+"/"+this.sg1.getCell(2,1)+"/"+this.app._nikUser+"/"+nik;
		filter="";
