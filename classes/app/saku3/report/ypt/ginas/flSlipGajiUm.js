window.app_saku3_report_ypt_ginas_flSlipGajiUm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ypt_ginas_flSlipGajiUm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ypt_ginas_flSlipGajiUm";
		this.maximize();
...
window.app_saku3_report_ypt_ginas_flSlipGajiUm.extend(window.childForm);
window.app_saku3_report_ypt_ginas_flSlipGajiUm.implement({
		...
		try{			
			...
			if (row ==3)
			{
				this.filterRep.ListDataSGFilter(this, "Data Karyawan",this.sg1, this.sg1.row, this.sg1.col,
												"select a.nik , a.nama from hr_karyawan a  inner join hr_gaji_loadumum b on a.nik=b.nik and a.kode_lokasi=b.kode_lokasi ",
												"select a.nik , a.nama  from hr_karyawan a  inner join hr_gaji_loadumum b on a.nik=b.nik and a.kode_lokasi=b.kode_lokasi  ",
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_ypt_ginas_rptSlipGajiNon";
			...
			systemAPI.alert("[app_saku3_report_ypt_ginas_flSlipGajiUm]::mainButtonClick:"+e);
		}
	},
