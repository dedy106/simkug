window.app_saku3_report_ypt_flHonorTransfer = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ypt_flHonorTransfer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ypt_flHonorTransfer";
		this.maximize();
...
window.app_saku3_report_ypt_flHonorTransfer.extend(window.childForm);
window.app_saku3_report_ypt_flHonorTransfer.implement({
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter =  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.no_cek",this.sg1.getCell(1,5),this.sg1.getCell(2,5),this.sg1.getCell(3,5),"and");
				this.filter2 = this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,3);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_ypt_rptHonorTransferDetail";
				if (this.sg1.getCell(2,4)=="CEK")
				{
					this.nama_report = "server_report_saku3_ypt_rptHonorTransferDetailCek";
				}
			...
			systemAPI.alert("[app_saku3_report_ypt_flHonorTransfer]::mainButtonClick:"+e);
		}
	},
