window.app_saku3_report_ypt_flTransferSimonal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ypt_flTransferSimonal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ypt_flTransferSimonal";
        this.maximize();
        
        
        // uses("saiCBBL;saiEdit;saiGrid;sgNavigator;app_saku3_amuboard;pageControl;util_ajaxCaller;listView;util_file;app_lab_remote_dataProvider;tinymceCtrl;reportViewer;server_report_report;server_util_Map;webBrowser");
...
window.app_saku3_report_ypt_flTransferSimonal.extend(window.childForm);
window.app_saku3_report_ypt_flTransferSimonal.implement({
	doLoad:function(){
        try{
			...
			this.report = new server_report_report();
			var nama_report="server_report_saku3_ypt_rptTransferSimonal";
			this.filter="";
			this.showFilter = "";
			this.lokasi = "";
