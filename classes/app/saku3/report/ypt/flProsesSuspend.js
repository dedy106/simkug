window.app_saku3_report_ypt_flProsesSuspend = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ypt_flProsesSuspend.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ypt_flProsesSuspend";
        this.maximize();
...
window.app_saku3_report_ypt_flProsesSuspend.extend(window.childForm);
window.app_saku3_report_ypt_flProsesSuspend.implement({
	doLoad:function(){
        try{
			...
			this.report = new server_report_report();
			var nama_report="server_report_saku3_ypt_rptProsesSuspend";
			this.filter="";
			this.showFilter = "";
			this.lokasi = "";
