// JavaScript Document
window.app_saku3_report_dash_flDashApi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dash_flDashApi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dash_flDashApi";
		this.maximize();
...
window.app_saku3_report_dash_flDashApi.extend(window.portalui_childForm);
window.app_saku3_report_dash_flDashApi.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,new Array(0,1),new  Array(3,0));
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_dash_rptDashApi";
	...
	doOpenTagihan2: function(nb){
		this.nb=nb;
		this.link="1";
		filter = "where a.no_tagihan='"+nb+"'";
		filter2="";
		nama_report="server_report_saku3_belajar_rptTagihandev";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2));
	},
	doOpenPbyr: function(nim){
		this.nim=nim;
		this.link="1";
		filter = "where a.nim='"+nim+"'";
		filter2="";
		nama_report="server_report_saku3_belajar_rptPbyr";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2));
	}
});
