// JavaScript Document
window.app_saku3_report_dash_flDashTest = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dash_flDashTest.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dash_flDashTest";
		this.maximize();
...
window.app_saku3_report_dash_flDashTest.extend(window.portalui_childForm);
window.app_saku3_report_dash_flDashTest.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_dash_rptDashBaru";
	...
	doOpen: function(nama_report,filter,filter2){
		...
		this.viewer.useIframe(this.report.previewWithBs(nama_report,this.filter, 1,1, this.showFilter, this.lokasi,this.filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
