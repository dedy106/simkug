// JavaScript Document
window.app_saku3_report_dash_flDashYpt = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dash_flDashYpt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dash_flDashYpt";
		this.maximize();
...
window.app_saku3_report_dash_flDashYpt.extend(window.portalui_childForm);
window.app_saku3_report_dash_flDashYpt.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_dash_rptDashYpt";
