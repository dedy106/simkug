window.app_saku3_report_dash_flDash = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dash_flDash.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dash_flDash";
        this.maximize();
...
window.app_saku3_report_dash_flDash.extend(window.childForm);
window.app_saku3_report_dash_flDash.implement({
	doLoad:function(){
        try{
            uses("saiCBBL;saiEdit;saiGrid;sgNavigator;app_saku3_dashboard;pageControl;util_ajaxCaller;listView;util_file;app_lab_remote_dataProvider;tinymceCtrl;reportViewer;server_report_report;server_util_Map;webBrowser");
			...
			this.report = new server_report_report();
			var nama_report="server_report_saku3_dash_rptDashBaru";
			this.filter="";
			this.showFilter = "";
			this.lokasi = "";
