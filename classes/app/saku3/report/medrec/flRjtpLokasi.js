// JavaScript Document
window.app_saku3_report_medrec_flRjtpLokasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_medrec_flRjtpLokasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_medrec_flRjtpLokasi";
		this.maximize();
...
window.app_saku3_report_medrec_flRjtpLokasi.extend(window.portalui_childForm);
window.app_saku3_report_medrec_flRjtpLokasi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_medrec_rptRjtpLokasi";
