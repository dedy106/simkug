// JavaScript Document
window.app_saku3_report_medrec_flRjtl = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_medrec_flRjtl.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_medrec_flRjtl";
		this.maximize();
...
window.app_saku3_report_medrec_flRjtl.extend(window.portalui_childForm);
window.app_saku3_report_medrec_flRjtl.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_medrec_rptRjtl";
