// JavaScript Document
window.app_saku3_report_medrec_flRi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_medrec_flRi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_medrec_flRi";
		this.maximize();
...
window.app_saku3_report_medrec_flRi.extend(window.portalui_childForm);
window.app_saku3_report_medrec_flRi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_medrec_rptRi";
