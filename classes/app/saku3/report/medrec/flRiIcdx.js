// JavaScript Document
window.app_saku3_report_medrec_flRiIcdx = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_medrec_flRiIcdx.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_medrec_flRiIcdx";
		this.maximize();
...
window.app_saku3_report_medrec_flRiIcdx.extend(window.portalui_childForm);
window.app_saku3_report_medrec_flRiIcdx.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_medrec_rptRiIcdx";
