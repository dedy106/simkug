// JavaScript Document
window.app_saku3_report_medrec_flRestKlpBiaya = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_medrec_flRestKlpBiaya.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_medrec_flRestKlpBiaya";
		this.maximize();
...
window.app_saku3_report_medrec_flRestKlpBiaya.extend(window.portalui_childForm);
window.app_saku3_report_medrec_flRestKlpBiaya.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_medrec_rptRestKlpBiaya";
