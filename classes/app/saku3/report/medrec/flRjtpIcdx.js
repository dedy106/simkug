// JavaScript Document
window.app_saku3_report_medrec_flRjtpIcdx = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_medrec_flRjtpIcdx.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_medrec_flRjtpIcdx";
		this.maximize();
...
window.app_saku3_report_medrec_flRjtpIcdx.extend(window.portalui_childForm);
window.app_saku3_report_medrec_flRjtpIcdx.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_medrec_rptRjtpIcdx";
