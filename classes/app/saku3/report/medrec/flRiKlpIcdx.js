// JavaScript Document
window.app_saku3_report_medrec_flRiKlpIcdx = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_medrec_flRiKlpIcdx.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_medrec_flRiKlpIcdx";
		this.maximize();
...
window.app_saku3_report_medrec_flRiKlpIcdx.extend(window.portalui_childForm);
window.app_saku3_report_medrec_flRiKlpIcdx.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.filter=this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"where") +
						...
						" and substring(a.kode_produk,1,1)='3'"
			this.filter2 = this.sg1.getCell(2,1)+"/"+this.sg1.getCell(1,1)+"/"+this.sg1.getCell(3,1)+"/"+sort;
			this.nama_report="server_report_saku3_medrec_rptRiKlpIcdx";
