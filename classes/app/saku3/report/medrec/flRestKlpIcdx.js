// JavaScript Document
window.app_saku3_report_medrec_flRestKlpIcdx = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_medrec_flRestKlpIcdx.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_medrec_flRestKlpIcdx";
		this.maximize();
...
window.app_saku3_report_medrec_flRestKlpIcdx.extend(window.portalui_childForm);
window.app_saku3_report_medrec_flRestKlpIcdx.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_medrec_rptRestKlpIcdx";
