// JavaScript Document
window.app_saku3_report_medrec_flRjtlKlpIcdx = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_medrec_flRjtlKlpIcdx.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_medrec_flRjtlKlpIcdx";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Sort By","=","Kelompok ICDX"));
...
window.app_saku3_report_medrec_flRjtlKlpIcdx.extend(window.portalui_childForm);
window.app_saku3_report_medrec_flRjtlKlpIcdx.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("Kelompok ICDX","Nilai Kunjungan Besar Kecil","Nilai Kunjungan Kecil Besar"));
	...
	mainButtonClick: function(sender){
		try
		{
			...
			var sort=" a.kode_klp ";
			if (this.sg1.getCell(2,2)=="Nilai Kunjungan Besar Kecil")
			{
				sort=" a.n22 desc ";
			}
			if (this.sg1.getCell(2,2)=="Nilai Kunjungan Kecil Besar")
			{
				sort=" a.n22 asc ";
			}
			this.filter=this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"where") +
						...
						" and substring(a.kode_produk,1,1)='2'"
			this.filter2 = this.sg1.getCell(2,1)+"/"+this.sg1.getCell(1,1)+"/"+this.sg1.getCell(3,1)+"/"+sort;
			this.nama_report="server_report_saku3_medrec_rptRjtlKlpIcdx";
