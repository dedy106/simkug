// JavaScript Document
window.app_saku3_report_medrec_flRjtlKlpBiayaGrafik = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_medrec_flRjtlKlpBiayaGrafik.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_medrec_flRjtlKlpBiayaGrafik";
		this.maximize();
...
window.app_saku3_report_medrec_flRjtlKlpBiayaGrafik.extend(window.portalui_childForm);
window.app_saku3_report_medrec_flRjtlKlpBiayaGrafik.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_medrec_rptRjtlKlpBiaya";
