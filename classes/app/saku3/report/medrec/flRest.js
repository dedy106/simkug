// JavaScript Document
window.app_saku3_report_medrec_flRest = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_medrec_flRest.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_medrec_flRest";
		this.maximize();
...
window.app_saku3_report_medrec_flRest.extend(window.portalui_childForm);
window.app_saku3_report_medrec_flRest.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_medrec_rptRest";
