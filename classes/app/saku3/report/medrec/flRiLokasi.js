// JavaScript Document
window.app_saku3_report_medrec_flRiLokasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_medrec_flRiLokasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_medrec_flRiLokasi";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from dbexs.dbo.dbexs.dbo.exs_harian ");
...
window.app_saku3_report_medrec_flRiLokasi.extend(window.portalui_childForm);
window.app_saku3_report_medrec_flRiLokasi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_medrec_rptRiLokasi";
