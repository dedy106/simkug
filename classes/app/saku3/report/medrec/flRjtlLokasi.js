// JavaScript Document
window.app_saku3_report_medrec_flRjtlLokasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_medrec_flRjtlLokasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_medrec_flRjtlLokasi";
		this.maximize();
...
window.app_saku3_report_medrec_flRjtlLokasi.extend(window.portalui_childForm);
window.app_saku3_report_medrec_flRjtlLokasi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_medrec_rptRjtlLokasi";
