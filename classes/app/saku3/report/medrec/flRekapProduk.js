// JavaScript Document
window.app_saku3_report_medrec_flRekapProduk = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_medrec_flRekapProduk.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_medrec_flRekapProduk";
		this.maximize();
...
window.app_saku3_report_medrec_flRekapProduk.extend(window.portalui_childForm);
window.app_saku3_report_medrec_flRekapProduk.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_medrec_rptRekapProduk";
