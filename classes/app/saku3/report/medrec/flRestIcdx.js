// JavaScript Document
window.app_saku3_report_medrec_flRestIcdx = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_medrec_flRestIcdx.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_medrec_flRestIcdx";
		this.maximize();
...
window.app_saku3_report_medrec_flRestIcdx.extend(window.portalui_childForm);
window.app_saku3_report_medrec_flRestIcdx.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_medrec_rptRestIcdx";
