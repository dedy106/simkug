// JavaScript Document
window.app_saku3_report_medrec_flRiKlpBiaya = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_medrec_flRiKlpBiaya.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_medrec_flRiKlpBiaya";
		this.maximize();
...
window.app_saku3_report_medrec_flRiKlpBiaya.extend(window.portalui_childForm);
window.app_saku3_report_medrec_flRiKlpBiaya.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_medrec_rptRiKlpBiaya";
