// JavaScript Document
window.app_saku3_report_medrec_flRjtpKlpBiayaGrafik = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_medrec_flRjtpKlpBiayaGrafik.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_medrec_flRjtpKlpBiayaGrafik";
		this.maximize();
...
window.app_saku3_report_medrec_flRjtpKlpBiayaGrafik.extend(window.portalui_childForm);
window.app_saku3_report_medrec_flRjtpKlpBiayaGrafik.implement({
