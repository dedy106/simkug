// JavaScript Document
window.app_saku3_report_medrec_flRjtlIcdx = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_medrec_flRjtlIcdx.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_medrec_flRjtlIcdx";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Sort By","=","ICDX"));
...
window.app_saku3_report_medrec_flRjtlIcdx.extend(window.portalui_childForm);
window.app_saku3_report_medrec_flRjtlIcdx.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("ICDX","Nilai Kunjungan Besar Kecil","Nilai Kunjungan Kecil Besar"));
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_medrec_rptRjtlIcdx";
