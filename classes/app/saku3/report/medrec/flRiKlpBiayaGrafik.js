// JavaScript Document
window.app_saku3_report_medrec_flRiKlpBiayaGrafik = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_medrec_flRiKlpBiayaGrafik.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_medrec_flRiKlpBiayaGrafik";
		this.maximize();
...
window.app_saku3_report_medrec_flRiKlpBiayaGrafik.extend(window.portalui_childForm);
window.app_saku3_report_medrec_flRiKlpBiayaGrafik.implement({
