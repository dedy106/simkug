// JavaScript Document
window.app_saku3_report_medrec_flRekapProdukLokasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_medrec_flRekapProdukLokasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_medrec_flRekapProdukLokasi";
		this.maximize();
...
window.app_saku3_report_medrec_flRekapProdukLokasi.extend(window.portalui_childForm);
window.app_saku3_report_medrec_flRekapProdukLokasi.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.dbLib.setItemsFromSQL("select distinct jenis as periode from dbsimkug.dbo.cust",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.filter=this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"where")+
						this.filterRep.filterStr("g.jenis",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
			this.filter2 = this.sg1.getCell(2,1)+"/"+this.sg1.getCell(1,1)+"/"+this.sg1.getCell(3,1);
			this.nama_report="server_report_saku3_medrec_rptRekapProdukLokasi";
