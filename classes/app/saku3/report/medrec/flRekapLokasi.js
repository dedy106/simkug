// JavaScript Document
window.app_saku3_report_medrec_flRekapLokasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_medrec_flRekapLokasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_medrec_flRekapLokasi";
		this.maximize();
...
window.app_saku3_report_medrec_flRekapLokasi.extend(window.portalui_childForm);
window.app_saku3_report_medrec_flRekapLokasi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_medrec_rptRekapLokasi";
