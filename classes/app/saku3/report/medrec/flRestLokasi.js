// JavaScript Document
window.app_saku3_report_medrec_flRestLokasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_medrec_flRestLokasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_medrec_flRestLokasi";
		this.maximize();
...
window.app_saku3_report_medrec_flRestLokasi.extend(window.portalui_childForm);
window.app_saku3_report_medrec_flRestLokasi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_medrec_rptRestLokasi";
