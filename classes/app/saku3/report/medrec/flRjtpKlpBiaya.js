// JavaScript Document
window.app_saku3_report_medrec_flRjtpKlpBiaya = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_medrec_flRjtpKlpBiaya.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_medrec_flRjtpKlpBiaya";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(substring(periode,1,4)) as periode from dbexs.dbo.exs_harian ");
...
window.app_saku3_report_medrec_flRjtpKlpBiaya.extend(window.portalui_childForm);
window.app_saku3_report_medrec_flRjtpKlpBiaya.implement({
