// JavaScript Document
window.app_saku3_report_medrec_flRjtpKlpIcdx = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_medrec_flRjtpKlpIcdx.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_medrec_flRjtpKlpIcdx";
		this.maximize();
...
window.app_saku3_report_medrec_flRjtpKlpIcdx.extend(window.portalui_childForm);
window.app_saku3_report_medrec_flRjtpKlpIcdx.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_medrec_rptRjtpKlpIcdx";
