// JavaScript Document
window.app_saku3_report_medrec_flDwBpJejer = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_medrec_flDwBpJejer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_medrec_flDwBpJejer";
		this.maximize();
...
window.app_saku3_report_medrec_flDwBpJejer.extend(window.portalui_childForm);
window.app_saku3_report_medrec_flDwBpJejer.implement({
		...
		try
		{
			...
			else
			{
				...
				this.filter =  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.jenis_cust",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
				this.nama_report="server_report_saku3_medrec_rptDwBpJejer";
