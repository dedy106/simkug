// JavaScript Document
window.app_saku3_report_medrec_flRjtlKlpBiaya = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_medrec_flRjtlKlpBiaya.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_medrec_flRjtlKlpBiaya";
		this.maximize();
...
window.app_saku3_report_medrec_flRjtlKlpBiaya.extend(window.portalui_childForm);
window.app_saku3_report_medrec_flRjtlKlpBiaya.implement({
