window.app_saku3_report_kantin_flVoucherJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kantin_flVoucherJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kantin_flVoucherJurnal";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from kt_ba_m where kode_lokasi='"+this.app._lokasi+"' ");
...
window.app_saku3_report_kantin_flVoucherJurnal.extend(window.childForm);
window.app_saku3_report_kantin_flVoucherJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_kantin_rptVoucherJurnal";
