window.app_saku3_report_kantin_flPb = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kantin_flPb.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kantin_flPb";
		this.maximize();
...
window.app_saku3_report_kantin_flPb.extend(window.childForm);
window.app_saku3_report_kantin_flPb.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_kantin_rptPb";
			...
			systemAPI.alert("[app_saku3_report_kantin_flPb]::mainButtonClick:"+e);
		}
	},
