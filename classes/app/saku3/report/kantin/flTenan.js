window.app_saku3_report_kantin_flTenan = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kantin_flTenan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kantin_flTenan";
		this.maximize();
...
window.app_saku3_report_kantin_flTenan.extend(window.childForm);
window.app_saku3_report_kantin_flTenan.implement({
		...
		try{			
			...
			if (row ==	1)
			{
				this.filterRep.ListDataSGFilter(this, "Data Mitra",this.sg1, this.sg1.row, this.sg1.col,
														  "select kode_tenan, nama from kt_tenan "+
														   this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  "select count(kode_tenan) from kt_tenan "+
														  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_kantin_rptTenan";
			...
			systemAPI.alert("[app_saku3_report_kantin_flTenan]::mainButtonClick:"+e);
		}
	},
