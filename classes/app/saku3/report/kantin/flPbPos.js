window.app_saku3_report_kantin_flPbPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kantin_flPbPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kantin_flPbPos";
		this.maximize();
...
window.app_saku3_report_kantin_flPbPos.extend(window.childForm);
window.app_saku3_report_kantin_flPbPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_kantin_rptPbPos";
			...
			systemAPI.alert("[app_saku3_report_kantin_flPbPos]::mainButtonClick:"+e);
		}
	},
