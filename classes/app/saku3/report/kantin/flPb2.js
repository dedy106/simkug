window.app_saku3_report_kantin_flPb2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kantin_flPb2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kantin_flPb2";
		this.maximize();
...
window.app_saku3_report_kantin_flPb2.extend(window.childForm);
window.app_saku3_report_kantin_flPb2.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_kantin_rptPb2";
			...
			systemAPI.alert("[app_saku3_report_kantin_flPb2]::mainButtonClick:"+e);
		}
	},
