window.app_saku3_report_kantin_flBast = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_kantin_flBast.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_kantin_flBast";
		this.maximize();
...
window.app_saku3_report_kantin_flBast.extend(window.childForm);
window.app_saku3_report_kantin_flBast.implement({
		...
		try{			
			...
			if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Berita Acara",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_ba,a.keterangan from kt_ba_m a "+this.filter,
												"select count(a.no_ba) from kt_ba_m a "+this.filter,
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_kantin_rptBast";
