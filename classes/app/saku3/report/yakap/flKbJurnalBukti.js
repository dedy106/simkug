// JavaScript Document
window.app_saku3_report_yakap_flKbJurnalBukti = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakap_flKbJurnalBukti.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakap_flKbJurnalBukti";
		this.maximize();
...
window.app_saku3_report_yakap_flKbJurnalBukti.extend(window.portalui_childForm);
window.app_saku3_report_yakap_flKbJurnalBukti.implement({
