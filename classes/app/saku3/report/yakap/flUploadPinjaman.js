window.app_saku3_report_yakap_flUploadPinjaman = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakap_flUploadPinjaman.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakap_flUploadPinjaman";
        this.maximize();
...
window.app_saku3_report_yakap_flUploadPinjaman.extend(window.childForm);
window.app_saku3_report_yakap_flUploadPinjaman.implement({
	doLoad:function(){
        try{
			...
			this.report = new server_report_report();
			var nama_report="server_report_saku3_yakap_rptUploadPinjaman";
			this.filter="";
			this.showFilter = "";
			this.lokasi = "";
