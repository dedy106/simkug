// JavaScript Document
window.app_saku3_report_yakap_flBuktiJurnalMI = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakap_flBuktiJurnalMI.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakap_flBuktiJurnalMI";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from trans_m where modul='MI' and kode_lokasi='"+this.app._lokasi+"'");
...
window.app_saku3_report_yakap_flBuktiJurnalMI.extend(window.portalui_childForm);
window.app_saku3_report_yakap_flBuktiJurnalMI.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.dbLib.setItemsFromSQL("select distinct modul from trans_m where modul='MI' and kode_lokasi='"+this.app._lokasi+"' order by modul",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
		if (row === 4)
		{
			this.sg1.columns.get(2).pickList.clear();
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_yakap_rptBuktiJurnalMI";
