window.app_saku3_report_apparindo_flAnggota = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_apparindo_flAnggota.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_apparindo_flAnggota";
		this.maximize();
...
window.app_saku3_report_apparindo_flAnggota.extend(window.childForm);
window.app_saku3_report_apparindo_flAnggota.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_apparindo_rptAnggota2";
			...
			systemAPI.alert("[app_saku3_report_apparindo_flAnggota]::mainButtonClick:"+e);
		}
	},
