window.app_saku3_report_apparindo_flKonfirmasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_apparindo_flKonfirmasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_apparindo_flKonfirmasi";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Customer","All",""));
...
window.app_saku3_report_apparindo_flKonfirmasi.extend(window.childForm);
window.app_saku3_report_apparindo_flKonfirmasi.implement({
		...
		try{			
			...
			if (row ==	2)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Pengajuan",this.sg1, this.sg1.row, this.sg1.col,
									"select a.no_bukti, a.keterangan from lab_konfirmasi a "+this.filter,
									"select count(*) from lab_konfirmasi a "+this.filter,
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.filterRep.filterStr("a.no_bukti",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");
				this.filter2 = this.sg1.getCell(2,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_apparindo_rptKonfirmasi";
			...
			systemAPI.alert("[app_saku3_report_apparindo_flKonfirmasi]::mainButtonClick:"+e);
		}
	},
