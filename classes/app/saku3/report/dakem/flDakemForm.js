window.app_saku3_report_dakem_flDakemForm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dakem_flDakemForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dakem_flDakemForm";
		this.maximize();
...
window.app_saku3_report_dakem_flDakemForm.extend(window.childForm);
window.app_saku3_report_dakem_flDakemForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_dakem_rptDakemForm";
			...
			systemAPI.alert("[app_saku3_report_dakem_flDakemForm]::mainButtonClick:"+e);
		}
	},
