window.app_saku3_report_dakem_flDakemPosisi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dakem_flDakemPosisi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dakem_flDakemPosisi";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from yk_dakem_m where kode_lokasi='"+this.app._lokasi+"'");
...
window.app_saku3_report_dakem_flDakemPosisi.extend(window.childForm);
window.app_saku3_report_dakem_flDakemPosisi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_dakem_rptDakemPosisi";
			...
			systemAPI.alert("[app_saku3_report_dakem_flDakemPosisi]::mainButtonClick:"+e);
		}
	},
