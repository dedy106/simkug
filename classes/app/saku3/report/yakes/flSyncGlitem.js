window.app_saku3_report_yakes_flSyncGlitem = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes_flSyncGlitem.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes_flSyncGlitem";
        this.maximize();
...
window.app_saku3_report_yakes_flSyncGlitem.extend(window.childForm);
window.app_saku3_report_yakes_flSyncGlitem.implement({
	doLoad:function(){
        try{
			...
			this.report = new server_report_report();
			var nama_report="server_report_saku3_yakes_rptSyncGlitem";
			this.filter="";
			this.showFilter = "";
			this.lokasi = "";
