window.app_saku3_report_yakes_flSyncSAP = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes_flSyncSAP.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes_flSyncSAP";
        this.maximize();
...
window.app_saku3_report_yakes_flSyncSAP.extend(window.childForm);
window.app_saku3_report_yakes_flSyncSAP.implement({
	doLoad:function(){
        try{
			...
			this.report = new server_report_report();
			var nama_report="server_report_saku3_yakes_rptSyncSAP";
			this.filter="";
			this.showFilter = "";
			this.lokasi = "";
