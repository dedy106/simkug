window.app_saku3_report_yakes_inves_flPendDepo = function (owner) {
    if (owner) {
        window.app_saku3_report_yakes_inves_flPendDepo.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_report_yakes_inves_flPendDepo";
        this.maximize();
...
window.app_saku3_report_yakes_inves_flPendDepo.extend(window.childForm);
window.app_saku3_report_yakes_inves_flPendDepo.implement({
        ...
        try {
            if (sender === this.app._mainForm.bClear2) {
                ...
                this.filter = this.filterRep.filterStr("a.kode_lokasi", this.sg1.getCell(1, 0), this.sg1.getCell(2, 0), this.sg1.getCell(3, 0), "where")+
                            ...
                            this.filterRep.filterStr("b.kode_plan", this.sg1.getCell(1, 2), this.sg1.getCell(2, 2), this.sg1.getCell(3, 2), "and");
                ...
                this.nama_report = "server_report_saku3_yakes_inves_rptPendDepo";
            ...
            systemAPI.alert("[app_saku3_report_yakes_inves_flPendDepo]::mainButtonClick:" + e);
        }
    },
