window.app_saku3_report_yakes_inves_flRekapRdBund = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes_inves_flRekapRdBund.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes_inves_flRekapRdBund";
		this.maximize();
...
window.app_saku3_report_yakes_inves_flRekapRdBund.extend(window.childForm);
window.app_saku3_report_yakes_inves_flRekapRdBund.implement({
	...
	{		
		...
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3],[2,0,1,2]);	
		if (row == 1)
		{
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.filter2 = this.sg1.getCell(2,1)+"/"+this.sg1.getCellDateValue(2,2)+"/"+this.sg1.getCell(2,3);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_yakes_inves_rptRekapRdBund";									
			...
			systemAPI.alert("[app_saku3_report_yakes_inves_flRekapRdBund]::mainButtonClick:"+e);
		}
	},
