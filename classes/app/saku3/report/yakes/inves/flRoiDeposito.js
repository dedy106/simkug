window.app_saku3_report_yakes_inves_flRoiDeposito = function (owner) {
    if (owner) {
        window.app_saku3_report_yakes_inves_flRoiDeposito.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_report_yakes_inves_flRoiDeposito";
        this.maximize();
    ...
    this.gridLib.SGEditData(this.sg1, 2, new Array(0, 1, 2), new Array("Jenis Deposito", "All",""));
...
window.app_saku3_report_yakes_inves_flRoiDeposito.extend(window.childForm);
window.app_saku3_report_yakes_inves_flRoiDeposito.implement({
    ...
    doSelectCell: function (sender, col, row) {
        ...
        if (row == 2) {
            this.sg1.columns.get(2).pickList.clear();
            this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("DOC","DEPO"));
        }
        ...
        try {
            if (sender === this.app._mainForm.bClear2) {
                ...
                this.filter = 
                            ...
                            this.filterRep.filterStr("a.kode_subkelas", this.sg1.getCell(1, 2), this.sg1.getCell(2, 2), this.sg1.getCell(3, 2), "and");
               
                this.filter2 = this.sg1.getCell(2, 1)+"/"+this.sg1.getCell(2,2);
                this.showFilter = this.filterRep.showFilter(this.sg1);
                var result = new arrayMap();
                this.nama_report = "server_report_saku3_yakes_inves_rptRoiDeposito";
            ...
            systemAPI.alert("[app_saku3_report_yakes_inves_flRoiDeposito]::mainButtonClick:" + e);
        }
    },
