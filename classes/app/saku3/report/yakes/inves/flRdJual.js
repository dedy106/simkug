window.app_saku3_report_yakes_inves_flRdJual = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes_inves_flRdJual.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes_inves_flRdJual";
		this.maximize();
...
window.app_saku3_report_yakes_inves_flRdJual.extend(window.childForm);
window.app_saku3_report_yakes_inves_flRdJual.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_yakes_inves_rptRdJual";
			...
			systemAPI.alert("[app_saku3_report_yakes_inves_flRdJual]::mainButtonClick:"+e);
		}
	},
