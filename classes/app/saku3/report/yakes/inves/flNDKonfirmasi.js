window.app_saku3_report_yakes_inves_flNDKonfirmasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes_inves_flNDKonfirmasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes_inves_flNDKonfirmasi";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Broker / MI","=","YKT"));
...
window.app_saku3_report_yakes_inves_flNDKonfirmasi.extend(window.childForm);
window.app_saku3_report_yakes_inves_flNDKonfirmasi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_yakes_inves_rptNDKonfirmasi";
			...
			systemAPI.alert("[app_saku3_report_yakes_inves_flNDKonfirmasi]::mainButtonClick:"+e);
		}
	},
