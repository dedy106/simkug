window.app_saku3_report_yakes_inves_flNDpbh1 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes_inves_flNDpbh1.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes_inves_flNDpbh1";
		this.maximize();
...
window.app_saku3_report_yakes_inves_flNDpbh1.extend(window.childForm);
window.app_saku3_report_yakes_inves_flNDpbh1.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_yakes_inves_rptNDpbh1";
			...
			systemAPI.alert("[app_saku3_report_yakes_inves_flNDpbh1]::mainButtonClick:"+e);
		}
	},
