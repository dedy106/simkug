window.app_saku3_report_yakes_inves_flSpClosing = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes_inves_flSpClosing.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes_inves_flSpClosing";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from inv_sp_kkp ");
...
window.app_saku3_report_yakes_inves_flSpClosing.extend(window.childForm);
window.app_saku3_report_yakes_inves_flSpClosing.implement({
		...
		try{			
            ...
            if (row == 2)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Mitra",this.sg1, this.sg1.row, this.sg1.col,
												...
												new Array("a.kode_mitra","a.nama"),"and",new Array("Kode Saham","Nama"));
			}
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from inv_sp_kkp order by periode desc",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_yakes_inves_rptSpClosing";									
			...
			systemAPI.alert("[app_saku3_report_yakes_inves_flSpClosing]::mainButtonClick:"+e);
		}
	},
