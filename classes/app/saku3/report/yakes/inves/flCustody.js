window.app_saku3_report_yakes_inves_flCustody = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes_inves_flCustody.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes_inves_flCustody";
		this.maximize();
...
window.app_saku3_report_yakes_inves_flCustody.extend(window.childForm);
window.app_saku3_report_yakes_inves_flCustody.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_yakes_inves_rptCustody";
			...
			systemAPI.alert("[app_saku3_report_yakes_inves_flCustody]::mainButtonClick:"+e);
		}
	},
