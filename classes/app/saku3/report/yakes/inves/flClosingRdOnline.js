window.app_saku3_report_yakes_inves_flClosingRdOnline = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes_inves_flClosingRdOnline.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes_inves_flClosingRdOnline";
        this.maximize();
...
window.app_saku3_report_yakes_inves_flClosingRdOnline.extend(window.childForm);
window.app_saku3_report_yakes_inves_flClosingRdOnline.implement({
	doLoad:function(){
        try{
			...
			this.report = new server_report_report();
			var nama_report="server_report_saku3_yakes_inves_rptClosingRdOnline";
			this.filter="";
			this.showFilter = "";
			this.lokasi = "";
