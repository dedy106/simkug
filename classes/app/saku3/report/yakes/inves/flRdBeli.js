window.app_saku3_report_yakes_inves_flRdBeli = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes_inves_flRdBeli.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes_inves_flRdBeli";
		this.maximize();
...
window.app_saku3_report_yakes_inves_flRdBeli.extend(window.childForm);
window.app_saku3_report_yakes_inves_flRdBeli.implement({
		...
		try{			
			...
			if (row == 2)
			{
				this.filterRep.ListDataSGFilter(this, "Data Broker / MI",this.sg1, this.sg1.row, this.sg1.col,
														  "select kode_kelola, nama from inv_rdkelola ",
														  "select count(kode_kelola) from inv_rdkelola ",
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_yakes_inves_rptRdBeli";
			...
			systemAPI.alert("[app_saku3_report_yakes_inves_flRdBeli]::mainButtonClick:"+e);
		}
	},
