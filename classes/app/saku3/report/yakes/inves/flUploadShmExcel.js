window.app_saku3_report_yakes_inves_flUploadShmExcel = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes_inves_flUploadShmExcel.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes_inves_flUploadShmExcel";
        this.maximize();
...
window.app_saku3_report_yakes_inves_flUploadShmExcel.extend(window.childForm);
window.app_saku3_report_yakes_inves_flUploadShmExcel.implement({
	doLoad:function(){
        try{
			...
			this.report = new server_report_report();
			var nama_report="server_report_saku3_yakes_inves_rptUploadShmExcel";
			this.filter="";
			this.showFilter = "";
			this.lokasi = "";
