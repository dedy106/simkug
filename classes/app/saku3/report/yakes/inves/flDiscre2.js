window.app_saku3_report_yakes_inves_flDiscre2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes_inves_flDiscre2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes_inves_flDiscre2";
		this.maximize();
...
window.app_saku3_report_yakes_inves_flDiscre2.extend(window.childForm);
window.app_saku3_report_yakes_inves_flDiscre2.implement({
		...
		try{			
			...
			if (row == 2)
			{
				this.filterRep.ListDataSGFilter(this, "Data MI",this.sg1, this.sg1.row, this.sg1.col,
												"select kode_kelola, nama from inv_kelola where flag_aktif='1' and jenis <> 'SWAKELOLA' ",
												"select count(kode_kelola) from inv_kelola where flag_aktif='1' and jenis <> 'SWAKELOLA' ",
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_yakes_inves_rptDiscre2";									
			...
			systemAPI.alert("[app_saku3_report_yakes_inves_flDiscre2]::mainButtonClick:"+e);
		}
	},
