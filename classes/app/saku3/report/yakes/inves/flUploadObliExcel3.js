window.app_saku3_report_yakes_inves_flUploadObliExcel3 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes_inves_flUploadObliExcel3.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes_inves_flUploadObliExcel3";
        this.maximize();
...
window.app_saku3_report_yakes_inves_flUploadObliExcel3.extend(window.childForm);
window.app_saku3_report_yakes_inves_flUploadObliExcel3.implement({
	doLoad:function(){
        try{
			...
			this.report = new server_report_report();
			var nama_report="server_report_saku3_yakes_inves_rptUploadObliExcel3";
			this.filter="";
			this.showFilter = "";
			this.lokasi = "";
