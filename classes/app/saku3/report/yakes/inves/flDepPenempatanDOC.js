window.app_saku3_report_yakes_inves_flDepPenempatanDOC = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes_inves_flDepPenempatanDOC.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes_inves_flDepPenempatanDOC";
		this.maximize();
...
window.app_saku3_report_yakes_inves_flDepPenempatanDOC.extend(window.childForm);
window.app_saku3_report_yakes_inves_flDepPenempatanDOC.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_yakes_inves_rptDepPenempatanDOC";
