window.app_saku3_report_yakes_inves_flClosingSahamOnline = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes_inves_flClosingSahamOnline.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes_inves_flClosingSahamOnline";
        this.maximize();
...
window.app_saku3_report_yakes_inves_flClosingSahamOnline.extend(window.childForm);
window.app_saku3_report_yakes_inves_flClosingSahamOnline.implement({
	doLoad:function(){
        try{
			...
			this.report = new server_report_report();
			var nama_report="server_report_saku3_yakes_inves_rptClosingSahamOnline";
			this.filter="";
			this.showFilter = "";
			this.lokasi = "";
