window.app_saku3_report_yakes_inves_flSPMutasi = function (owner) {
    if (owner) {
        window.app_saku3_report_yakes_inves_flSPMutasi.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_report_yakes_inves_flSPMutasi";
        this.maximize();
...
window.app_saku3_report_yakes_inves_flSPMutasi.extend(window.childForm);
window.app_saku3_report_yakes_inves_flSPMutasi.implement({
    ...
    mainButtonClick: function (sender) {
        try {
            if (sender === this.app._mainForm.bClear2) {
                ...
                this.nama_report = "server_report_saku3_yakes_inves_rptSPMutasi";
            ...
            systemAPI.alert("[app_saku3_report_yakes_inves_flSPMutasi]::mainButtonClick:" + e);
        }
    },
