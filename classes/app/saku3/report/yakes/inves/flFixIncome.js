window.app_saku3_report_yakes_inves_flFixIncome = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes_inves_flFixIncome.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes_inves_flFixIncome";
		this.maximize();
...
window.app_saku3_report_yakes_inves_flFixIncome.extend(window.childForm);
window.app_saku3_report_yakes_inves_flFixIncome.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_yakes_inves_rptFixIncome";
			...
			systemAPI.alert("[app_saku3_report_yakes_inves_flFixIncome]::mainButtonClick:"+e);
		}
	},
