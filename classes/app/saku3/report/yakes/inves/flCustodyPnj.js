window.app_saku3_report_yakes_inves_flCustodyPnj = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes_inves_flCustodyPnj.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes_inves_flCustodyPnj";
		this.maximize();
...
window.app_saku3_report_yakes_inves_flCustodyPnj.extend(window.childForm);
window.app_saku3_report_yakes_inves_flCustodyPnj.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_yakes_inves_rptCustodyPnj";									
			...
			systemAPI.alert("[app_saku3_report_yakes_inves_flCustodyPnj]::mainButtonClick:"+e);
		}
	},
