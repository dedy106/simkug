window.app_saku3_report_yakes_inves_flRoiTotal = function (owner) {
    if (owner) {
        window.app_saku3_report_yakes_inves_flRoiTotal.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_report_yakes_inves_flRoiTotal";
        this.maximize();
    ...
    this.gridLib.SGEditData(this.sg1, 2, new Array(0, 1, 2), new Array("Kode Plan", "=", ""));
...
window.app_saku3_report_yakes_inves_flRoiTotal.extend(window.childForm);
window.app_saku3_report_yakes_inves_flRoiTotal.implement({
    ...
    mainButtonClick: function (sender) {
        try {
            if (sender === this.app._mainForm.bClear2) {
                ...
                this.nama_report = "server_report_saku3_yakes_inves_rptRoiTotal";
            ...
            systemAPI.alert("[app_saku3_report_yakes_inves_flRoiTotal]::mainButtonClick:" + e);
        }
    },
