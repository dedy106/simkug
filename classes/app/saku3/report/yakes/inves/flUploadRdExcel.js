window.app_saku3_report_yakes_inves_flUploadRdExcel = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes_inves_flUploadRdExcel.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes_inves_flUploadRdExcel";
        this.maximize();
...
window.app_saku3_report_yakes_inves_flUploadRdExcel.extend(window.childForm);
window.app_saku3_report_yakes_inves_flUploadRdExcel.implement({
	doLoad:function(){
        try{
			...
			this.report = new server_report_report();
			var nama_report="server_report_saku3_yakes_inves_rptUploadRdExcel";
			this.filter="";
			this.showFilter = "";
			this.lokasi = "";
