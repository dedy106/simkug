window.app_saku3_report_yakes_inves_flRoiKelas = function (owner) {
    if (owner) {
        window.app_saku3_report_yakes_inves_flRoiKelas.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_report_yakes_inves_flRoiKelas";
        this.maximize();
    ...
    this.gridLib.SGEditData(this.sg1, 2, new Array(0, 1, 2), new Array("Kode Kelas", "=", ""));
...
window.app_saku3_report_yakes_inves_flRoiKelas.extend(window.childForm);
window.app_saku3_report_yakes_inves_flRoiKelas.implement({
    ...
    doSelectCell: function (sender, col, row) {
        this.filterRep.setSGFilterRowTipe(this.sg1, row, [0, 1, 2], ["123", "23", "3"]);
    ...
    mainButtonClick: function (sender) {
        try {
            if (sender === this.app._mainForm.bClear2) {
                ...
                this.nama_report = "server_report_saku3_yakes_inves_rptRoiKelas";
            ...
            systemAPI.alert("[app_saku3_report_yakes_inves_flRoiKelas]::mainButtonClick:" + e);
        }
    },
