window.app_saku3_report_yakes_inves_flGlobalIssue = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes_inves_flGlobalIssue.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes_inves_flGlobalIssue";
        this.maximize();
...
window.app_saku3_report_yakes_inves_flGlobalIssue.extend(window.childForm);
window.app_saku3_report_yakes_inves_flGlobalIssue.implement({
	doLoad:function(){
        try{
			...
			this.report = new server_report_report();
			var nama_report="server_report_saku3_yakes_inves_rptGlobalIssue";
			this.filter="";
			this.showFilter = "";
			this.lokasi = "";
