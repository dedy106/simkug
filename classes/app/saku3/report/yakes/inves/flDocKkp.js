window.app_saku3_report_yakes_inves_flDocKkp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes_inves_flDocKkp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes_inves_flDocKkp";
		this.maximize();
...
window.app_saku3_report_yakes_inves_flDocKkp.extend(window.childForm);
window.app_saku3_report_yakes_inves_flDocKkp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_yakes_inves_rptDocKkpSaldo";
			...
			systemAPI.alert("[app_saku3_report_yakes_inves_flDocKkp]::mainButtonClick:"+e);
		}
	},
