window.app_saku3_report_yakes_inves_flObliTrans = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes_inves_flObliTrans.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes_inves_flObliTrans";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("MI","=",""));
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("No Seri","All",""));
...
window.app_saku3_report_yakes_inves_flObliTrans.extend(window.childForm);
window.app_saku3_report_yakes_inves_flObliTrans.implement({
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3],["3","123","3","13"]);
        this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3],[0,0,2,2]);
        if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from inv_obli_harga order by periode desc",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
	},
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
                ...
                this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("MI","=",""));
                this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("No Seri","=",""));
			}else{
		    	...
		    	this.filter = this.filterRep.filterStr("e.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"where")+
							this.filterRep.filterStr("d.kode_rdkelola",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
				...
				this.nama_report = "server_report_saku3_yakes_inves_rptObliTrans";
			...
			systemAPI.alert("[app_saku3_report_yakes_inves_flObliTrans]::mainButtonClick:"+e);
		}
	},
