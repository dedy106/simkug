window.app_saku3_report_yakes_inves_flUploadObliJenis = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes_inves_flUploadObliJenis.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes_inves_flUploadObliJenis";
        this.maximize();
...
window.app_saku3_report_yakes_inves_flUploadObliJenis.extend(window.childForm);
window.app_saku3_report_yakes_inves_flUploadObliJenis.implement({
	doLoad:function(){
        try{
			...
			this.report = new server_report_report();
			var nama_report="server_report_saku3_yakes_inves_rptUploadObliJenis";
			this.filter="";
			this.showFilter = "";
			this.lokasi = "";
