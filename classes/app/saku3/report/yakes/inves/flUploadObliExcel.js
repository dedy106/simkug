window.app_saku3_report_yakes_inves_flUploadObliExcel = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes_inves_flUploadObliExcel.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes_inves_flUploadObliExcel";
        this.maximize();
...
window.app_saku3_report_yakes_inves_flUploadObliExcel.extend(window.childForm);
window.app_saku3_report_yakes_inves_flUploadObliExcel.implement({
	doLoad:function(){
        try{
			...
			this.report = new server_report_report();
			var nama_report="server_report_saku3_yakes_inves_rptUploadObliExcel";
			this.filter="";
			this.showFilter = "";
			this.lokasi = "";
