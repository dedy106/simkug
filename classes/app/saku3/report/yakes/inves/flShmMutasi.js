window.app_saku3_report_yakes_inves_flShmMutasi = function (owner) {
    if (owner) {
        window.app_saku3_report_yakes_inves_flShmMutasi.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_report_yakes_inves_flShmMutasi";
        this.maximize();
    ...
    var sqlper = "select max(periode) as periode from inv_shm_harga ";
...
window.app_saku3_report_yakes_inves_flShmMutasi.extend(window.childForm);
window.app_saku3_report_yakes_inves_flShmMutasi.implement({
    ...
    doSelectCell: function (sender, col, row) {
        ...
        if (row == 1) {
            ...
            var sql = "select distinct periode from inv_shm_harga order by periode desc ";
    ...
    mainButtonClick: function (sender) {
        try {
            if (sender === this.app._mainForm.bClear2) {
                ...
                this.nama_report = "server_report_saku3_yakes_inves_rptShmMutasi";
            ...
            systemAPI.alert("[app_saku3_report_yakes_inves_flShmMutasi]::mainButtonClick:" + e);
        }
    },
