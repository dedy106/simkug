window.app_saku3_report_yakes_inves_flDepNDTransferDana = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes_inves_flDepNDTransferDana.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes_inves_flDepNDTransferDana";
		this.maximize();
...
window.app_saku3_report_yakes_inves_flDepNDTransferDana.extend(window.childForm);
window.app_saku3_report_yakes_inves_flDepNDTransferDana.implement({
		...
		try{			
			...
			if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data",this.sg1, this.sg1.row, this.sg1.col,
												...
												"select count(a.keterangan) from inv_shop_m a "+this.filter,
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_yakes_inves_rptDepNDTransferDana";
