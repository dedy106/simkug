window.app_saku3_report_yakes_inves_flRoiSimple = function (owner) {
    if (owner) {
        window.app_saku3_report_yakes_inves_flRoiSimple.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_report_yakes_inves_flRoiSimple";
        this.maximize();
...
window.app_saku3_report_yakes_inves_flRoiSimple.extend(window.childForm);
window.app_saku3_report_yakes_inves_flRoiSimple.implement({
    ...
    mainButtonClick: function (sender) {
        try {
            if (sender === this.app._mainForm.bClear2) {
                ...
                this.nama_report = "server_report_saku3_yakes_inves_rptRoiSimple";
            ...
            systemAPI.alert("[app_saku3_report_yakes_inves_flRoiSimple]::mainButtonClick:" + e);
        }
    },
