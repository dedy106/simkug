window.app_saku3_report_yakes_inves_flRdClosing = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes_inves_flRdClosing.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes_inves_flRdClosing";
		this.maximize();
...
window.app_saku3_report_yakes_inves_flRdClosing.extend(window.childForm);
window.app_saku3_report_yakes_inves_flRdClosing.implement({
		...
		try{			
            ...
            if (row == 2)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Reksadana",this.sg1, this.sg1.row, this.sg1.col,
												...
												new Array("a.kode_rd","a.nama"),"and",new Array("Kode Saham","Nama"));
			}
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
                ...
                this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+ 
							this.filterRep.filterStr("a.kode_rd",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.app._nikUser;
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_yakes_inves_rptRdClosing";									
			...
			systemAPI.alert("[app_saku3_report_yakes_inves_flRdClosing]::mainButtonClick:"+e);
		}
	},
