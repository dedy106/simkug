window.app_saku3_report_yakes_inves_flRekapSaham = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes_inves_flRekapSaham.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes_inves_flRekapSaham";
		this.maximize();
...
window.app_saku3_report_yakes_inves_flRekapSaham.extend(window.childForm);
window.app_saku3_report_yakes_inves_flRekapSaham.implement({
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4],["123","3","123","3","13"]);
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_kelola",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"where");
				this.filter2 = this.sg1.getCell(2,1)+"/"+this.sg1.getCellDateValue(2,3)+"/"+this.sg1.getCell(2,4);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_yakes_inves_rptRekapSaham";									
			...
			systemAPI.alert("[app_saku3_report_yakes_inves_flRekapSaham]::mainButtonClick:"+e);
		}
	},
