window.app_saku3_report_yakes_inves_flFixIncomeDet = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes_inves_flFixIncomeDet.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes_inves_flFixIncomeDet";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Jenis Obligasi","All",""));
...
window.app_saku3_report_yakes_inves_flFixIncomeDet.extend(window.childForm);
window.app_saku3_report_yakes_inves_flFixIncomeDet.implement({
		...
		try{			
			...
			if (row ==2)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Jenis Obligasi",this.sg1, this.sg1.row, this.sg1.col,
												"select a.kode_jenis, a.nama from inv_oblijenis a "+filter,
												"select count(a.kode_jenis) from inv_oblijenis a "+filter,
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.kode_rdkelola",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("a.kode_jenis",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
				this.filter2 = this.sg1.getCell(2,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();	
				this.nama_report = "server_report_saku3_yakes_inves_rptFixIncomeDet";
			...
			systemAPI.alert("[app_saku3_report_yakes_inves_flFixIncomeDet]::mainButtonClick:"+e);
		}
	},
