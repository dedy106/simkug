window.app_saku3_report_yakes_inves_flJustifikasiDeposito = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes_inves_flJustifikasiDeposito.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes_inves_flJustifikasiDeposito";
		this.maximize();
...
window.app_saku3_report_yakes_inves_flJustifikasiDeposito.extend(window.childForm);
window.app_saku3_report_yakes_inves_flJustifikasiDeposito.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_yakes_inves_rptJustifikasiDeposito";
