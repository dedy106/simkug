window.app_saku3_report_yakes_inves_flPenawaranRate = function (owner) {
    if (owner) {
        window.app_saku3_report_yakes_inves_flPenawaranRate.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_report_yakes_inves_flPenawaranRate";
        this.maximize();
...
window.app_saku3_report_yakes_inves_flPenawaranRate.extend(window.childForm);
window.app_saku3_report_yakes_inves_flPenawaranRate.implement({
    ...
    mainButtonClick: function (sender) {
        try {
            if (sender === this.app._mainForm.bClear2) {
                ...
                this.nama_report = "server_report_saku3_yakes_inves_rptPenawaranRate";
            ...
            systemAPI.alert("[app_saku3_report_yakes_inves_flPenawaranRate]::mainButtonClick:" + e);
        }
    },
