window.app_saku3_report_yakes_inves_flRdPph = function (owner) {
    if (owner) {
        window.app_saku3_report_yakes_inves_flRdPph.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_report_yakes_inves_flRdPph";
        this.maximize();
    ...
    this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from inv_rd_harga ");
...
window.app_saku3_report_yakes_inves_flRdPph.extend(window.childForm);
window.app_saku3_report_yakes_inves_flRdPph.implement({
    ...
    doSelectCell: function (sender, col, row) {
        this.filterRep.setSGFilterRowTipe(this.sg1, row, [0, 1], ["123", "23"]);
        ...
        if (row == 1) {
            ...
            this.dbLib.setItemsFromSQL("select distinct periode from inv_rd_harga  order by periode desc", [this.sg1.columns.get(2).pickList, this.sg1.columns.get(3).pickList]);
        }
    ...
    mainButtonClick: function (sender) {
        try {
            if (sender === this.app._mainForm.bClear2) {
                ...
                this.nama_report = "server_report_saku3_yakes_inves_rptRdPph";
            ...
            systemAPI.alert("[app_saku3_report_yakes_inves_flRdPph]::mainButtonClick:" + e);
        }
    },
