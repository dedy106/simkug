window.app_saku3_report_yakes_inves_flSahamBeliInv = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes_inves_flSahamBeliInv.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes_inves_flSahamBeliInv";
		this.maximize();
...
window.app_saku3_report_yakes_inves_flSahamBeliInv.extend(window.childForm);
window.app_saku3_report_yakes_inves_flSahamBeliInv.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Pembelian",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_shmbeli, a.keterangan from inv_shmbeli_m a "+filter,
												"select count(a.no_shmbeli) from inv_shmbeli_m a "+filter,
												new Array("a.no_shmbeli","a.keterangan"),"and",new Array("No Bukti","Keterangan"));
			}
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3],["123","1236","123","123"]);
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4],[2,0,2,2]);	
		if (row == 1)
		{
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("a.kode_kelola",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
							this.filterRep.filterStr("a.no_shmbeli",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and");
				this.filter2 = this.sg1.getCell(2,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();						
				this.nama_report = "server_report_saku3_yakes_inves_rptSahamBeliInv";
			...
			systemAPI.alert("[app_saku3_report_yakes_inves_flSahamBeliInv]::mainButtonClick:"+e);
		}
	},
	...
	doOpenBayar: function(no_bukti,kode_lokasi){
		...
		this.link="1";
		filter = "where a.no_shmbeli='"+no_bukti+"' and a.kode_lokasi='"+kode_lokasi+"' ";
		filter2="";
