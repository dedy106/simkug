window.app_saku3_report_yakes_inves_flNotaDinas = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes_inves_flNotaDinas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes_inves_flNotaDinas";
		this.maximize();
...
window.app_saku3_report_yakes_inves_flNotaDinas.extend(window.childForm);
window.app_saku3_report_yakes_inves_flNotaDinas.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_yakes_inves_rptNotaDinas";
			...
			systemAPI.alert("[app_saku3_report_yakes_inves_flNotaDinas]::mainButtonClick:"+e);
		}
	},
