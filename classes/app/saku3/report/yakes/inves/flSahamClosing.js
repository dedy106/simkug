window.app_saku3_report_yakes_inves_flSahamClosing = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes_inves_flSahamClosing.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes_inves_flSahamClosing";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Kode Saham","All",""));
...
window.app_saku3_report_yakes_inves_flSahamClosing.extend(window.childForm);
window.app_saku3_report_yakes_inves_flSahamClosing.implement({
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
                ...
                this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+ 
							this.filterRep.filterStr("a.kode_saham",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.app._nikUser;
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_yakes_inves_rptSahamClosing";									
			...
			systemAPI.alert("[app_saku3_report_yakes_inves_flSahamClosing]::mainButtonClick:"+e);
		}
	},
