window.app_saku3_report_yakes_inves_flDiscre = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes_inves_flDiscre.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes_inves_flDiscre";
		this.maximize();
...
window.app_saku3_report_yakes_inves_flDiscre.extend(window.childForm);
window.app_saku3_report_yakes_inves_flDiscre.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_yakes_inves_rptDiscre";									
			...
			systemAPI.alert("[app_saku3_report_yakes_inves_flDiscre]::mainButtonClick:"+e);
		}
	},
