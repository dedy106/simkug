window.app_saku3_report_yakes_inves_flDepMutasi = function (owner) {
    if (owner) {
        window.app_saku3_report_yakes_inves_flDepMutasi.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_report_yakes_inves_flDepMutasi";
        this.maximize();
...
window.app_saku3_report_yakes_inves_flDepMutasi.extend(window.childForm);
window.app_saku3_report_yakes_inves_flDepMutasi.implement({
    ...
    mainButtonClick: function (sender) {
        try {
            if (sender === this.app._mainForm.bClear2) {
                ...
                this.filter2 = this.sg1.getCell(2, 1)+"/"+this.sg1.getCell(2,2)+"/"+this.filter2+"/"+this.filter3;
                this.showFilter = this.filterRep.showFilter(this.sg1);
                var result = new arrayMap();
                this.nama_report = "server_report_saku3_yakes_inves_rptDepMutasi";
            ...
            systemAPI.alert("[app_saku3_report_yakes_inves_flDepMutasi]::mainButtonClick:" + e);
        }
    },
