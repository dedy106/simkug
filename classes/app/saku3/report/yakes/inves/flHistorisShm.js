window.app_saku3_report_yakes_inves_flHistorisShm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes_inves_flHistorisShm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes_inves_flHistorisShm";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from inv_saham_kkp ");
	...
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Kode Saham","=",""));
...
window.app_saku3_report_yakes_inves_flHistorisShm.extend(window.childForm);
window.app_saku3_report_yakes_inves_flHistorisShm.implement({
		...
		try{			
            ...
            if (row == 3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Saham",this.sg1, this.sg1.row, this.sg1.col,
												"select a.kode_saham, a.nama from inv_saham a ",
												"select count(a.kode_saham) from inv_saham a ",
												new Array("a.kode_saham","a.nama"),"and",new Array("Kode Saham","Nama"));
			}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
                ...
                this.filterRep.filterStr("kode_saham",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and");
				this.filter2 = this.sg1.getCell(2,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_yakes_inves_rptHistorisShm";									
			...
			systemAPI.alert("[app_saku3_report_yakes_inves_flHistorisShm]::mainButtonClick:"+e);
		}
	},
