window.app_saku3_report_yakes_inves_flRekapPbl = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes_inves_flRekapPbl.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes_inves_flRekapPbl";
		this.maximize();
...
window.app_saku3_report_yakes_inves_flRekapPbl.extend(window.childForm);
window.app_saku3_report_yakes_inves_flRekapPbl.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_yakes_inves_rptRekapPbl";
			...
			systemAPI.alert("[app_saku3_report_yakes_inves_flRekapPbl]::mainButtonClick:"+e);
		}
	},
