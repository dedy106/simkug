window.app_saku3_report_yakes_inves_flRekapJualGab = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes_inves_flRekapJualGab.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes_inves_flRekapJualGab";
		this.maximize();
...
window.app_saku3_report_yakes_inves_flRekapJualGab.extend(window.childForm);
window.app_saku3_report_yakes_inves_flRekapJualGab.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.filter = 
				this.filterRep.filterStr("c.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
				...
				this.nama_report = "server_report_saku3_yakes_inves_rptRekapJualGab";									
			...
			systemAPI.alert("[app_saku3_report_yakes_inves_flRekapJualGab]::mainButtonClick:"+e);
		}
	},
