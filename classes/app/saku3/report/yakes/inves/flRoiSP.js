window.app_saku3_report_yakes_inves_flRoiSP = function (owner) {
    if (owner) {
        window.app_saku3_report_yakes_inves_flRoiSP.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_report_yakes_inves_flRoiSP";
        this.maximize();
    ...
    this.gridLib.SGEditData(this.sg1, 3, new Array(0, 1, 2), new Array("Mitra", "=",""));
...
window.app_saku3_report_yakes_inves_flRoiSP.extend(window.childForm);
window.app_saku3_report_yakes_inves_flRoiSP.implement({
        ...
        try {
            ...
            if (row == 3) {
                this.filterRep.ListDataSGFilter(this, "Data Mitra", this.sg1, this.sg1.row, this.sg1.col,
                    "select distinct kode_mitra, nama from inv_mitra where flag_aktif='1' ",
                    "select count(distinct kode_mitra) from inv_mitra where flag_aktif='1' ",
                    new Array("kode_mitra","nama"),"where",new Array("Kode","Nama"));
            }
        ...
        try {
            if (sender === this.app._mainForm.bClear2) {
                ...
                this.filter = 
                            ...
                            this.filterRep.filterStr("a.kode_mitra", this.sg1.getCell(1,3), this.sg1.getCell(2,3), this.sg1.getCell(3,3), "and");
               
                this.filter2 = this.sg1.getCell(2, 1)+"/"+this.sg1.getCell(2,2);
                this.showFilter = this.filterRep.showFilter(this.sg1);
                var result = new arrayMap();
                this.nama_report = "server_report_saku3_yakes_inves_rptRoiSP";
            ...
            systemAPI.alert("[app_saku3_report_yakes_inves_flRoiSP]::mainButtonClick:" + e);
        }
    },
