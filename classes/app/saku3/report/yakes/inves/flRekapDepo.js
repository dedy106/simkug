window.app_saku3_report_yakes_inves_flRekapDepo = function (owner) {
    if (owner) {
        window.app_saku3_report_yakes_inves_flRekapDepo.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_report_yakes_inves_flRekapDepo";
        this.maximize();
    ...
    this.gridLib.SGEditData(this.sg1, 4, new Array(0, 1, 2), new Array("Tanggal", "=", tgl));
...
window.app_saku3_report_yakes_inves_flRekapDepo.extend(window.childForm);
window.app_saku3_report_yakes_inves_flRekapDepo.implement({
    ...
    doSelectCell: function (sender, col, row) {
        ...
        this.filterRep.setSGFilterRowButtonStyle(this.sg1, row, [0, 1, 2, 3, 4], [2, 0, 2, 2, 1]);
        if (row == 1) {
        ...
        try {
            if (sender === this.app._mainForm.bClear2) {
                ...
                this.filter = this.filterRep.filterStr("a.kode_lokasi", this.sg1.getCell(1, 0), this.sg1.getCell(2, 0), this.sg1.getCell(3, 0), "where")+
                            this.filterRep.filterStr("a.kode_kelola", this.sg1.getCell(1, 2), this.sg1.getCell(2, 2), this.sg1.getCell(3, 2), "and")+
                            this.filterRep.filterStr("a.kode_plan", this.sg1.getCell(1, 3), this.sg1.getCell(2, 3), this.sg1.getCell(3, 3), "and");
                this.filter2 = this.sg1.getCell(2, 1) + "/" + this.sg1.getCellDateValue(2, 4);
                this.showFilter = this.filterRep.showFilter(this.sg1);
                var result = new arrayMap();
                this.nama_report = "server_report_saku3_yakes_inves_rptRekapDepo";
            ...
            systemAPI.alert("[app_saku3_report_yakes_inves_flRekapDepo]::mainButtonClick:" + e);
        }
    },
