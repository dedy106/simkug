window.app_saku3_report_yakes_inves_flRekapRd = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes_inves_flRekapRd.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes_inves_flRekapRd";
		this.maximize();
...
window.app_saku3_report_yakes_inves_flRekapRd.extend(window.childForm);
window.app_saku3_report_yakes_inves_flRekapRd.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.filter2 = this.sg1.getCell(2,1)+"/"+this.sg1.getCellDateValue(2,3);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_yakes_inves_rptRekapRd";									
			...
			systemAPI.alert("[app_saku3_report_yakes_inves_flRekapRd]::mainButtonClick:"+e);
		}
	},
