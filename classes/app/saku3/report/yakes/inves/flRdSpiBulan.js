window.app_saku3_report_yakes_inves_flRdSpiBulan = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes_inves_flRdSpiBulan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes_inves_flRdSpiBulan";
		this.maximize();
...
window.app_saku3_report_yakes_inves_flRdSpiBulan.extend(window.childForm);
window.app_saku3_report_yakes_inves_flRdSpiBulan.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.filter = this.filterRep.filterStr("a.kode_rdklp",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"where")+
				...
				this.nama_report = "server_report_saku3_yakes_inves_rptRdSpiBulan";
			...
			systemAPI.alert("[app_saku3_report_yakes_inves_flRdSpiBulan]::mainButtonClick:"+e);
		}
	},
