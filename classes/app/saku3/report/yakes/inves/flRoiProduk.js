window.app_saku3_report_yakes_inves_flRoiProduk = function (owner) {
    if (owner) {
        window.app_saku3_report_yakes_inves_flRoiProduk.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_report_yakes_inves_flRoiProduk";
        this.maximize();
    ...
    this.gridLib.SGEditData(this.sg1, 2, new Array(0, 1, 2), new Array("Jenis Produk", "=", ""));
...
window.app_saku3_report_yakes_inves_flRoiProduk.extend(window.childForm);
window.app_saku3_report_yakes_inves_flRoiProduk.implement({
    doEllipseClick: function (sender, col, row) {
        try {
            ...
            if (row == 2) {
                this.filterRep.ListDataSGFilter(this, "Data Jenis Produk", this.sg1, this.sg1.row, this.sg1.col,
                    "select kode_subkelas,nama from inv_subkelas ",
                    "select count(kode_subkelas) from inv_subkelas ",
                    new Array("kode_subkelas", "nama"), "and");
            }
        ...
        try {
            if (sender === this.app._mainForm.bClear2) {
                ...
                // this.filterRep.filterStr("kode_lokasi", this.sg1.getCell(1, 0), this.sg1.getCell(2, 0), this.sg1.getCell(3, 0), "where")+
                            ...
                            this.filterRep.filterStr("kode_subkelas", this.sg1.getCell(1, 2), this.sg1.getCell(2, 2), this.sg1.getCell(3, 2), "and");
               
                this.filter2 = this.sg1.getCell(2, 1)+"/"+this.sg1.getCell(2,2);
                this.showFilter = this.filterRep.showFilter(this.sg1);
                var result = new arrayMap();
                this.nama_report = "server_report_saku3_yakes_inves_rptRoiProduk";
            ...
            systemAPI.alert("[app_saku3_report_yakes_inves_flRoiProduk]::mainButtonClick:" + e);
        }
    },
