window.app_saku3_report_yspt_flKasTerima = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yspt_flKasTerima.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yspt_flKasTerima";
		this.maximize();
...
window.app_saku3_report_yspt_flKasTerima.extend(window.childForm);
window.app_saku3_report_yspt_flKasTerima.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_yspt_flKasTerima]::mainButtonClick:"+e);
		}
	},
