window.app_saku3_report_yspt_flKasKirim = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yspt_flKasKirim.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yspt_flKasKirim";
		this.maximize();
...
window.app_saku3_report_yspt_flKasKirim.extend(window.childForm);
window.app_saku3_report_yspt_flKasKirim.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_yspt_flKasKirim]::mainButtonClick:"+e);
		}
	},
