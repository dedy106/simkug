window.app_saku3_report_yspt_flDropingKas = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yspt_flDropingKas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yspt_flDropingKas";
		this.maximize();
...
window.app_saku3_report_yspt_flDropingKas.extend(window.childForm);
window.app_saku3_report_yspt_flDropingKas.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_yspt_flDropingKas]::mainButtonClick:"+e);
		}
	},
