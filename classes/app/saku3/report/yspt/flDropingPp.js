window.app_saku3_report_yspt_flDropingPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yspt_flDropingPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yspt_flDropingPp";
		this.maximize();
...
window.app_saku3_report_yspt_flDropingPp.extend(window.childForm);
window.app_saku3_report_yspt_flDropingPp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_yspt_rptDropingPp";
			...
			systemAPI.alert("[app_saku3_report_yspt_flDropingPp]::mainButtonClick:"+e);
		}
	},
