window.app_saku3_report_yspt_flDropingKirim = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yspt_flDropingKirim.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yspt_flDropingKirim";
		this.maximize();
...
window.app_saku3_report_yspt_flDropingKirim.extend(window.childForm);
window.app_saku3_report_yspt_flDropingKirim.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_yspt_flDropingKirim]::mainButtonClick:"+e);
		}
	},
