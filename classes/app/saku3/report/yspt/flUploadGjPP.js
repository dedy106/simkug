window.app_saku3_report_yspt_flUploadGjPP = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yspt_flUploadGjPP.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yspt_flUploadGjPP";
        this.maximize();
...
window.app_saku3_report_yspt_flUploadGjPP.extend(window.childForm);
window.app_saku3_report_yspt_flUploadGjPP.implement({
	doLoad:function(){
        try{
			...
			this.report = new server_report_report();
			var nama_report="server_report_saku3_yspt_rptUploadGjPP";
			this.filter="";
			this.showFilter = "";
			this.lokasi = "";
