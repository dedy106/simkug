window.app_saku3_report_yspt_flDropingAkun = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yspt_flDropingAkun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yspt_flDropingAkun";
		this.maximize();
...
window.app_saku3_report_yspt_flDropingAkun.extend(window.childForm);
window.app_saku3_report_yspt_flDropingAkun.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_yspt_rptDropingAkun";
			...
			systemAPI.alert("[app_saku3_report_yspt_flDropingAkun]::mainButtonClick:"+e);
		}
	},
