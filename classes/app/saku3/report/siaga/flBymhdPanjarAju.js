window.app_saku3_report_siaga_flBymhdPanjarAju = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_flBymhdPanjarAju.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_flBymhdPanjarAju";
		this.maximize();
...
window.app_saku3_report_siaga_flBymhdPanjarAju.extend(window.childForm);
window.app_saku3_report_siaga_flBymhdPanjarAju.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siaga_rptBymhdPanjarAju";
			...
			systemAPI.alert("[app_saku3_report_siaga_flBymhdPanjarAju]::mainButtonClick:"+e);
		}
	},
