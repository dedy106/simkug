window.app_saku3_report_siaga_flAggApp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_flAggApp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_flAggApp";
		this.maximize();
...
window.app_saku3_report_siaga_flAggApp.extend(window.portalui_childForm);
window.app_saku3_report_siaga_flAggApp.implement({
