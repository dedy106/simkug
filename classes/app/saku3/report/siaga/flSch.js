window.app_saku3_report_siaga_flSch = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_flSch.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_flSch";
		this.maximize();
...
window.app_saku3_report_siaga_flSch.extend(window.childForm);
window.app_saku3_report_siaga_flSch.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siaga_rptSchDet";
			...
			systemAPI.alert("[app_saku3_report_siaga_flSch]::mainButtonClick:"+e);
		}
	},
