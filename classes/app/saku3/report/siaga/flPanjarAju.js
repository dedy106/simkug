window.app_saku3_report_siaga_flPanjarAju = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_flPanjarAju.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_flPanjarAju";
		this.maximize();
...
window.app_saku3_report_siaga_flPanjarAju.extend(window.childForm);
window.app_saku3_report_siaga_flPanjarAju.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_siaga_flPanjarAju]::mainButtonClick:"+e);
		}
	},
