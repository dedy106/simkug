window.app_saku3_report_siaga_flSpbForm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_flSpbForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_flSpbForm";
		this.maximize();
...
window.app_saku3_report_siaga_flSpbForm.extend(window.childForm);
window.app_saku3_report_siaga_flSpbForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_siaga_flSpbForm]::mainButtonClick:"+e);
		}
	},
