window.app_saku3_report_siaga_hris_gajinew_flGajiRekapBulan = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_gajinew_flGajiRekapBulan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_gajinew_flGajiRekapBulan";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select substring(max(periode),1,4) as periode from gr_gaji_m where kode_lokasi='"+this.app._lokasi+"'");
...
window.app_saku3_report_siaga_hris_gajinew_flGajiRekapBulan.extend(window.childForm);
window.app_saku3_report_siaga_hris_gajinew_flGajiRekapBulan.implement({
	...
	doSelectCell: function(sender, col, row){		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct substring(periode,1,4) from gr_gaji_m where kode_lokasi='"+this.app._lokasi+"'",[this.sg1.columns.get(2).pickList]);
		}
	},
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_saku3_siaga_hris_gaji_rptGjRekapBulan";
	...
	doOpenSlip: function(no_bukti,kode_lokasi){
		...
		nama_report="server_report_hris_rptSlipGaji";
	...
	doOpenVer: function(no_bukti,kode_lokasi){
		...
		filter2=this.app._namaUser;
		nama_report="server_report_hris_rptVerSurat";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
	...
	doOpenApp: function(no_bukti,kode_lokasi){
		...
		filter2=this.app._namaUser;
		nama_report="server_report_hris_rptAppSurat";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
