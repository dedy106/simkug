window.app_saku3_report_siaga_hris_gajinew_flRekapAkun = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_gajinew_flRekapAkun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_gajinew_flRekapAkun";
		this.maximize();
...
window.app_saku3_report_siaga_hris_gajinew_flRekapAkun.extend(window.childForm);
window.app_saku3_report_siaga_hris_gajinew_flRekapAkun.implement({
	...
	doSelectCell: function(sender, col, row){		
		...
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2],[0,0,2]);
			...
			else
			{
				...
				else
				{
					...
					this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
								...
								this.filterRep.filterStr("b.sts_sdm",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
						
					this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1);
					this.showFilter = this.filterRep.showFilter(this.sg1);
					var result  = new arrayMap();		
					this.lokasi=this.app._namalokasi;
					this.nama_report = "server_report_saku3_siaga_hris_gaji_rptRekapAkun";
