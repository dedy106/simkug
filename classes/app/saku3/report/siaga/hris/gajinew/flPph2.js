window.app_saku3_report_siaga_hris_gajinew_flPph2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_gajinew_flPph2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_gajinew_flPph2";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,3,[0,1,2],["Status Pajak","All",""]);
...
window.app_saku3_report_siaga_hris_gajinew_flPph2.extend(window.childForm);
window.app_saku3_report_siaga_hris_gajinew_flPph2.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row == 3)
			{
				this.filterRep.ListDataSGFilter(this, "Data Status Pajak",this.sg1, this.sg1.row, this.sg1.col,
												"select sts_pajak, nama from gr_status_pajak ",
												"select count(*) from gr_status_pajak ",
												new Array("sts_pajak","nama"),"where",new Array("kode","nama"));
			}
			if (row == 4)
			{
				filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
						this.filterRep.filterStr("a.sts_sdm",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
						this.filterRep.filterStr("a.sts_pajak",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and");
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_saku3_siaga_hris_gaji_rptPph";
