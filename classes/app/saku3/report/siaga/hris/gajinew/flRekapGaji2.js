window.app_saku3_report_siaga_hris_gajinew_flRekapGaji2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_gajinew_flRekapGaji2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_gajinew_flRekapGaji2";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,[0,1,2],["Format Laporan","=","Bulanan"]);
	
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_siaga_hris_gajinew_flRekapGaji2.extend(window.childForm);
window.app_saku3_report_siaga_hris_gajinew_flRekapGaji2.implement({
	...
	doSelectCell: function(sender, col, row){		
		...
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4],["3","3","123","123","2"]);
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4],[0,0,2,2,0]);
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_saku3_siaga_hris_gaji_rptRekapGj";
					if (this.sg1.getCell(2,4)=="Harian")
					{
						this.nama_report = "server_report_saku3_siaga_hris_gaji_rptRekapGjHarian";
					}
