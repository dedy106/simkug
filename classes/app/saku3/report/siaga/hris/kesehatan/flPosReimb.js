window.app_saku3_report_siaga_hris_kesehatan_flPosReimb = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_kesehatan_flPosReimb.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_kesehatan_flPosReimb";
		this.maximize();
...
window.app_saku3_report_siaga_hris_kesehatan_flPosReimb.extend(window.childForm);
window.app_saku3_report_siaga_hris_kesehatan_flPosReimb.implement({
			...
			else
			{
				...
				else
				{
					...
					this.filter = this.filterRep.filterStr("a.kode_lokasi","=",this.app._lokasi,this.app._lokasi,"where")+
						...
						this.filterRep.filterStr("b.kode_dept",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and")+
						this.filterRep.filterStr("b.nik",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4),"and")+
						this.filterRep.filterStr("a.no_kes",this.sg1.getCell(1,5),this.sg1.getCell(2,5),this.sg1.getCell(3,5),"and");	
					this.filter2 = this.sg1.getCell(2,0)+"/";
					this.showFilter = this.filterRep.showFilter(this.sg1);
					var result  = new arrayMap();		
					this.lokasi=this.app._namalokasi;
					this.nama_report = "server_report_siaga_hris_rptPosReimb";
