window.app_saku3_report_siaga_hris_kesehatan_flPbBenefit = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_kesehatan_flPbBenefit.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_kesehatan_flPbBenefit";
		this.maximize();
...
window.app_saku3_report_siaga_hris_kesehatan_flPbBenefit.extend(window.childForm);
window.app_saku3_report_siaga_hris_kesehatan_flPbBenefit.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_kesehatan_flPbBenefit]::mainButtonClick:"+e);
		}
	},
