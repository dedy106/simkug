window.app_saku3_report_siaga_hris_kesehatan_flReimbUser = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_kesehatan_flReimbUser.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_kesehatan_flReimbUser";
		this.maximize();
...
window.app_saku3_report_siaga_hris_kesehatan_flReimbUser.extend(window.childForm);
window.app_saku3_report_siaga_hris_kesehatan_flReimbUser.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_kesehatan_flReimbUser]::mainButtonClick:"+e);
		}
	},
