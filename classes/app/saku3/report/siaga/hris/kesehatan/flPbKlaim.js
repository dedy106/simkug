window.app_saku3_report_siaga_hris_kesehatan_flPbKlaim = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_kesehatan_flPbKlaim.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_kesehatan_flPbKlaim";
		this.maximize();
...
window.app_saku3_report_siaga_hris_kesehatan_flPbKlaim.extend(window.childForm);
window.app_saku3_report_siaga_hris_kesehatan_flPbKlaim.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siaga_hris_rptPbKlaim";
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_kesehatan_flPbKlaim]::mainButtonClick:"+e);
		}
	},
