window.app_saku3_report_siaga_hris_kesehatan_flPbBenefitSpj = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_kesehatan_flPbBenefitSpj.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_kesehatan_flPbBenefitSpj";
		this.maximize();
...
window.app_saku3_report_siaga_hris_kesehatan_flPbBenefitSpj.extend(window.childForm);
window.app_saku3_report_siaga_hris_kesehatan_flPbBenefitSpj.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_kesehatan_flPbBenefitSpj]::mainButtonClick:"+e);
		}
	},
