window.app_hris_report_kesehatan_flReimbKartuUser = function(owner)
{
	if (owner)
	{
		window.app_hris_report_kesehatan_flReimbKartuUser.prototype.parent.constructor.call(this,owner);
		this.className = "app_hris_report_kesehatan_flReimbKartuUser";
		this.maximize();
...
window.app_hris_report_kesehatan_flReimbKartuUser.extend(window.childForm);
window.app_hris_report_kesehatan_flReimbKartuUser.implement({
