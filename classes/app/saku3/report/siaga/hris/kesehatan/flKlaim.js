window.app_saku3_report_siaga_hris_kesehatan_flKlaim = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_kesehatan_flKlaim.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_kesehatan_flKlaim";
		this.maximize();
...
window.app_saku3_report_siaga_hris_kesehatan_flKlaim.extend(window.childForm);
window.app_saku3_report_siaga_hris_kesehatan_flKlaim.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siaga_hris_rptKlaimDetail";
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_kesehatan_flKlaim]::mainButtonClick:"+e);
		}
	},
