window.app_saku3_report_siaga_hris_kesehatan_flKlaimUser = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_kesehatan_flKlaimUser.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_kesehatan_flKlaimUser";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("No Klaim","All",""));
	
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
	this.doSelectCell(this.sg1,2,3);
};
window.app_saku3_report_siaga_hris_kesehatan_flKlaimUser.extend(window.childForm);
window.app_saku3_report_siaga_hris_kesehatan_flKlaimUser.implement({
		...
		try{	
				...
				if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Klaim",this.sg1, this.sg1.row, this.sg1.col,
											"select a.no_klaim, a.keterangan from gr_klaim_m a "+
											"inner join gr_karyawan b on a.nik_buat=b.nik and a.kode_lokasi=b.kode_lokasi "+filter,
											"select count(a.no_klaim) from gr_klaim_m a "+
											"inner join gr_karyawan b on a.nik_buat=b.nik and a.kode_lokasi=b.kode_lokasi "+filter,
				new Array("a.no_klaim","a.keterangan"),"and",new Array("Surat","Keterangan"));
			}					
		}catch(e){
			systemAPI.alert(e);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siaga_hris_rptKlaim";
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_kesehatan_flKlaimUser]::mainButtonClick:"+e);
		}
	},
