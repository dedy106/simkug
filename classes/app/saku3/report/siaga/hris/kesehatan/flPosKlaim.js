window.app_saku3_report_siaga_hris_kesehatan_flPosKlaim = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_kesehatan_flPosKlaim.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_kesehatan_flPosKlaim";
		this.maximize();
...
window.app_saku3_report_siaga_hris_kesehatan_flPosKlaim.extend(window.childForm);
window.app_saku3_report_siaga_hris_kesehatan_flPosKlaim.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				alert('a');
				this.nama_report = "server_report_saku3_siaga_hris_rptPosKlaim";
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_kesehatan_flPosKlaim]::mainButtonClick:"+e);
		}
	},
