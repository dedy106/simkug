window.app_saku3_report_siaga_hris_kesehatan_flPosReimbUser = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_kesehatan_flPosReimbUser.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_kesehatan_flPosReimbUser";
		this.maximize();
...
window.app_saku3_report_siaga_hris_kesehatan_flPosReimbUser.extend(window.childForm);
window.app_saku3_report_siaga_hris_kesehatan_flPosReimbUser.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from gr_kes_m where kode_lokasi='"+this.app._lokasi+"' order by periode desc",[this.sg1.columns.get(2).pickList]);
		}
	},
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siaga_hris_rptPosReimbur";
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_kesehatan_flPosReimbUser]::mainButtonClick:"+e);
		}
	},
