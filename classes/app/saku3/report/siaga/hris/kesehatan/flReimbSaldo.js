window.app_saku3_report_siaga_hris_kesehatan_flReimbSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_kesehatan_flReimbSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_kesehatan_flReimbSaldo";
		this.maximize();
...
window.app_saku3_report_siaga_hris_kesehatan_flReimbSaldo.extend(window.childForm);
window.app_saku3_report_siaga_hris_kesehatan_flReimbSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siaga_hris_rptSaldoReimb";
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_kesehatan_flReimbSaldo]::mainButtonClick:"+e);
		}
	},
