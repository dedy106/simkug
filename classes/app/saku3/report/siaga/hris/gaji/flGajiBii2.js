window.app_saku3_report_siaga_hris_gaji_flGajiBii2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_gaji_flGajiBii2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_gaji_flGajiBii2";
		this.maximize();
...
window.app_saku3_report_siaga_hris_gaji_flGajiBii2.extend(window.childForm);
window.app_saku3_report_siaga_hris_gaji_flGajiBii2.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_siaga_hris_rptGajiBii";
