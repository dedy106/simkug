window.app_saku3_report_siaga_hris_gaji_flAkdhk2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_gaji_flAkdhk2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_gaji_flAkdhk2";
		this.maximize();
...
window.app_saku3_report_siaga_hris_gaji_flAkdhk2.extend(window.childForm);
window.app_saku3_report_siaga_hris_gaji_flAkdhk2.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_siaga_hris_rptGajiAkdhk";
