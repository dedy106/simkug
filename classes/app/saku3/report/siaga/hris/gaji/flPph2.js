window.app_saku3_report_siaga_hris_gaji_flPph2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_gaji_flPph2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_gaji_flPph2";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,[0,1,2],["Status Pajak","All",""]);
	this.gridLib.SGEditData(this.sg1,3,[0,1,2],["NIK","All",""]);
	
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_siaga_hris_gaji_flPph2.extend(window.childForm);
window.app_saku3_report_siaga_hris_gaji_flPph2.implement({
		...
		try{			
			...
			if (row == 3)
			{
				filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.sts_pajak",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
			...
			else
			{
				...
				else
				{
					...
					this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
								...
								this.filterRep.filterStr("d.sts_pajak",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
					...
					this.nama_report = "server_report_saku3_siaga_hris_rptPph";
