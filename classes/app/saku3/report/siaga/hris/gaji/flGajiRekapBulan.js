window.app_saku3_report_siaga_hris_gaji_flGajiRekapBulan = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_gaji_flGajiRekapBulan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_gaji_flGajiRekapBulan";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,[0,1,2],["Jabatan","All",""]);
	this.gridLib.SGEditData(this.sg1,3,[0,1,2],["NIK","All",""]);
	
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_siaga_hris_gaji_flGajiRekapBulan.extend(window.childForm);
window.app_saku3_report_siaga_hris_gaji_flGajiRekapBulan.implement({
			...
			else
			{
				...
				else
				{
					...
					this.filter = this.filterRep.filterStr("x.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
								...
								this.filterRep.filterStr("y.kode_so",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
								this.filterRep.filterStr("x.nik",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and");
						
					//this.filter2 = this.sg1.getCell(2,1)+"/"+this.filterRep.filterStr("a.ko",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
					this.showFilter = this.filterRep.showFilter(this.sg1);
					var result  = new arrayMap();		
					this.lokasi=this.app._namalokasi;
					this.nama_report = "server_report_saku3_siaga_hris_rptGjRekapBulan";
