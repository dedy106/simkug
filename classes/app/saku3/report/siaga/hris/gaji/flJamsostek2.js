window.app_saku3_report_siaga_hris_gaji_flJamsostek2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_gaji_flJamsostek2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_gaji_flJamsostek2";
		this.maximize();
...
window.app_saku3_report_siaga_hris_gaji_flJamsostek2.extend(window.childForm);
window.app_saku3_report_siaga_hris_gaji_flJamsostek2.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_siaga_hris_rptGajiSamsostek";
