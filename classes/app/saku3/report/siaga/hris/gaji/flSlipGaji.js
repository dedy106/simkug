window.app_saku3_report_siaga_hris_gaji_flSlipGaji = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_gaji_flSlipGaji.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_gaji_flSlipGaji";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Slip Gaji", 2);
...
window.app_saku3_report_siaga_hris_gaji_flSlipGaji.extend(window.portalui_childForm);
window.app_saku3_report_siaga_hris_gaji_flSlipGaji.prototype.doEllipseClick= function(sender, col, row)
{
...
window.app_saku3_report_siaga_hris_gaji_flSlipGaji.prototype.doSelectCell = function(sender, col, row)
{
...
window.app_saku3_report_siaga_hris_gaji_flSlipGaji.prototype.mainButtonClick = function(sender)
{
	try
	{
		...
		else
		{
			...
			this.nama_report = "server_report_siaga_hris_rptSlipGaji";
			var flag_gaji="";
			if (this.sg1.getCell(2,6)=="Pegawai")
			{
				flag_gaji=" and a.flag_gaji='NON' ";
			...
			this.filter2=this.app._lokasi+"/"+this.sg1.getCell(2,0);	
	...
	{
		alert("[app_saku3_report_siaga_hris_gaji_flSlipGaji]::mainButtonClick:"+e);
	}
};
window.app_saku3_report_siaga_hris_gaji_flSlipGaji.prototype.doRequestReady = function(sender, methodName, result)
{
...
window.app_saku3_report_siaga_hris_gaji_flSlipGaji.prototype.getStringHeader = function(){
...
window.app_saku3_report_siaga_hris_gaji_flSlipGaji.prototype.doConfirmClick = function(sender){
	try{
		if (sender === sender.owner.bConfirm){
			...
			if (to !== ""){
				sender.owner.free();
				var d = new Date();
				var subject = "Slip Gaji Karyawan Bulan "+ubahPeriode(this.sg1.getCell(2,0)).toUpperCase();
...
window.app_saku3_report_siaga_hris_gaji_flSlipGaji.prototype.doSelectedPage = function(sender, page)
{
	this.viewer.useIframe(this.report.previewWithHeader(this.nama_report,this.filter, this.page,  this.pager, this.showFilter, this.lokasi,this.filter2));
	this.page = page;
	this.allBtn = false;
};
window.app_saku3_report_siaga_hris_gaji_flSlipGaji.prototype.previewReport = function(dthtml)
{
...
window.app_saku3_report_siaga_hris_gaji_flSlipGaji.prototype.doCloseReportClick = function(sender)
{
...
window.app_saku3_report_siaga_hris_gaji_flSlipGaji.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_saku3_report_siaga_hris_gaji_flSlipGaji.prototype.doRowPerPageChange = function(sender, rowperpage)
{
