window.app_saku3_report_siaga_hris_gaji_flGajiRekap = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_gaji_flGajiRekap.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_gaji_flGajiRekap";
		this.maximize();
...
window.app_saku3_report_siaga_hris_gaji_flGajiRekap.extend(window.childForm);
window.app_saku3_report_siaga_hris_gaji_flGajiRekap.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("d.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"where")+
				...
				this.nama_report = "server_report_saku3_siaga_hris_rptGajiRekap";
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_gaji_flGajiRekap]::mainButtonClick:"+e);
		}
	},
