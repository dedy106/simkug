window.app_saku3_report_siaga_hris_gaji_flRekapGajiBulan2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_gaji_flRekapGajiBulan2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_gaji_flRekapGajiBulan2";
		this.maximize();
...
window.app_saku3_report_siaga_hris_gaji_flRekapGajiBulan2.extend(window.childForm);
window.app_saku3_report_siaga_hris_gaji_flRekapGajiBulan2.implement({
		...
		try{			
			...
			if (row == 3)
			{
				this.filterRep.ListDataSGFilter(this, "Data Karyawan",this.sg1, this.sg1.row, this.sg1.col,
													"select a.nik, a.nama from gr_karyawan a ",
													"select count(*) from gr_karyawan a ",
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_siaga_hris_rptRekapGajiBulan";
