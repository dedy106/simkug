window.app_saku3_report_siaga_simlog_flGaji = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_simlog_flGaji.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_simlog_flGaji";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Unit Kerja","All",""));
...
window.app_saku3_report_siaga_simlog_flGaji.extend(window.childForm);
window.app_saku3_report_siaga_simlog_flGaji.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siaga_simlog_rptGaji";
			...
			systemAPI.alert("[app_saku3_report_siaga_simlog_flGaji]::mainButtonClick:"+e);
		}
	},
