window.app_saku3_report_siaga_simlog_flGajiRek = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_simlog_flGajiRek.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_simlog_flGajiRek";
		this.maximize();
...
window.app_saku3_report_siaga_simlog_flGajiRek.extend(window.childForm);
window.app_saku3_report_siaga_simlog_flGajiRek.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siaga_simlog_rptGajiRek";
			...
			systemAPI.alert("[app_saku3_report_siaga_simlog_flGajiRek]::mainButtonClick:"+e);
		}
	},
