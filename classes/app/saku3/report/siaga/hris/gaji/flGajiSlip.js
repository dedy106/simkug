window.app_saku3_report_siaga_hris_gaji_flGajiSlip = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_gaji_flGajiSlip.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_gaji_flGajiSlip";
		this.maximize();
...
window.app_saku3_report_siaga_hris_gaji_flGajiSlip.extend(window.childForm);
window.app_saku3_report_siaga_hris_gaji_flGajiSlip.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siaga_hris_rptSlipGaji";
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_gaji_flGajiSlip]::mainButtonClick:"+e);
		}
	},
