window.app_saku3_report_siaga_hris_gaji_flLampiranGaji2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_gaji_flLampiranGaji2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_gaji_flLampiranGaji2";
		this.maximize();
...
window.app_saku3_report_siaga_hris_gaji_flLampiranGaji2.extend(window.childForm);
window.app_saku3_report_siaga_hris_gaji_flLampiranGaji2.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_saku3_siaga_hris_rptLpGaji";
