window.app_saku3_report_siaga_hris_gaji_flJamsos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_gaji_flJamsos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_gaji_flJamsos";
		this.maximize();
...
window.app_saku3_report_siaga_hris_gaji_flJamsos.extend(window.childForm);
window.app_saku3_report_siaga_hris_gaji_flJamsos.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_saku3_siaga_hris_rptJamsos";
