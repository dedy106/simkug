window.app_saku3_report_siaga_simlog_flGajiRes = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_simlog_flGajiRes.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_simlog_flGajiRes";
		this.maximize();
...
window.app_saku3_report_siaga_simlog_flGajiRes.extend(window.childForm);
window.app_saku3_report_siaga_simlog_flGajiRes.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siaga_simlog_rptGajiRes";
			...
			systemAPI.alert("[app_saku3_report_siaga_simlog_flGajiRes]::mainButtonClick:"+e);
		}
	},
