window.app_saku3_report_siaga_hris_gaji_flGjBii = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_gaji_flGjBii.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_gaji_flGjBii";
		this.maximize();
...
window.app_saku3_report_siaga_hris_gaji_flGjBii.extend(window.childForm);
window.app_saku3_report_siaga_hris_gaji_flGjBii.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_saku3_siaga_hris_rptGjBii";
