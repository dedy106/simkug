window.app_saku3_report_siaga_hris_karyawan_flRwyHg = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_karyawan_flRwyHg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_karyawan_flRwyHg";
		this.maximize();
...
window.app_saku3_report_siaga_hris_karyawan_flRwyHg.extend(window.childForm);
window.app_saku3_report_siaga_hris_karyawan_flRwyHg.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siaga_hris_rptRwyHg";
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_karyawan_flRwyHg]::mainButtonClick:"+e);
		}
	},
