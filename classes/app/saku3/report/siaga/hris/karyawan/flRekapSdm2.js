window.app_saku3_report_siaga_hris_karyawan_flRekapSdm2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_karyawan_flRekapSdm2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_karyawan_flRekapSdm2";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(dbo.Periode(tanggal)) as periode from gr_karyawan ");
...
window.app_saku3_report_siaga_hris_karyawan_flRekapSdm2.extend(window.childForm);
window.app_saku3_report_siaga_hris_karyawan_flRekapSdm2.implement({
	...
	doSelectCell: function(sender, col, row){		
		...
		if (row == 0)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct dbo.Periode(tanggal) as periode from gr_karyawan_d where kode_lokasi='"+this.app._lokasi+"' order by periode desc",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_siaga_hris_rptRekapSdm";
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_karyawan_flRekapSdm2]::mainButtonClick:"+e);
		}
	},
