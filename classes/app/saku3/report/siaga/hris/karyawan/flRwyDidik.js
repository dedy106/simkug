window.app_saku3_report_siaga_hris_karyawan_flRwyDidik = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_karyawan_flRwyDidik.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_karyawan_flRwyDidik";
		this.maximize();
...
window.app_saku3_report_siaga_hris_karyawan_flRwyDidik.extend(window.childForm);
window.app_saku3_report_siaga_hris_karyawan_flRwyDidik.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_karyawan_flRwyDidik]::mainButtonClick:"+e);
		}
	},
