window.app_saku3_report_siaga_hris_karyawan_flSoSdm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_karyawan_flSoSdm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_karyawan_flSoSdm";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,0,new Array(0,1,2), new Array("Tanggal","=",new Date().lclFormat()));
...
window.app_saku3_report_siaga_hris_karyawan_flSoSdm.extend(window.childForm);
window.app_saku3_report_siaga_hris_karyawan_flSoSdm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2 =this.sg1.getCell(2,0)+"/"+this.sg1.getCellDateValue(2,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_siaga_hris_rptSoSdm";
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_karyawan_flSoSdm]::mainButtonClick:"+e);
		}
	},
