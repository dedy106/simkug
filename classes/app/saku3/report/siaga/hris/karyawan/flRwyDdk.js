window.app_saku3_report_siaga_hris_karyawan_flRwyDdk = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_karyawan_flRwyDdk.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_karyawan_flRwyDdk";
		this.maximize();
...
window.app_saku3_report_siaga_hris_karyawan_flRwyDdk.extend(window.childForm);
window.app_saku3_report_siaga_hris_karyawan_flRwyDdk.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siaga_hris_rptRwyDdk";
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_karyawan_flRwyDdk]::mainButtonClick:"+e);
		}
	},
