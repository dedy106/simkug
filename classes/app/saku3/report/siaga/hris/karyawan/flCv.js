window.app_saku3_report_siaga_hris_karyawan_flCv = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_karyawan_flCv.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_karyawan_flCv";
		this.maximize();
...
window.app_saku3_report_siaga_hris_karyawan_flCv.extend(window.childForm);
window.app_saku3_report_siaga_hris_karyawan_flCv.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siaga_hris_rptCvSk";
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_karyawan_flCv]::mainButtonClick:"+e);
		}
	},
