window.app_saku3_report_siaga_hris_karyawan_flRwyLth = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_karyawan_flRwyLth.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_karyawan_flRwyLth";
		this.maximize();
...
window.app_saku3_report_siaga_hris_karyawan_flRwyLth.extend(window.childForm);
window.app_saku3_report_siaga_hris_karyawan_flRwyLth.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siaga_hris_rptRwyLth";
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_karyawan_flRwyLth]::mainButtonClick:"+e);
		}
	},
