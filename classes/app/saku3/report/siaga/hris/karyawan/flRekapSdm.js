window.app_saku3_report_siaga_hris_karyawan_flRekapSdm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_karyawan_flRekapSdm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_karyawan_flRekapSdm";
		this.maximize();
...
window.app_saku3_report_siaga_hris_karyawan_flRekapSdm.extend(window.childForm);
window.app_saku3_report_siaga_hris_karyawan_flRekapSdm.implement({
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				if (this.sg1.getCell(1,1)=="All")
				{
					...
					this.nama_report = "server_report_saku3_siaga_hris_rptRekapLoker";
				}
				else
				{
					this.nama_report = "server_report_saku3_siaga_hris_rptRekapLokerPeriode";
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_karyawan_flRekapSdm]::mainButtonClick:"+e);
		}
	},
