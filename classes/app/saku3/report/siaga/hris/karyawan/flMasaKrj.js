window.app_saku3_report_siaga_hris_karyawan_flMasaKrj = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_karyawan_flMasaKrj.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_karyawan_flMasaKrj";
		this.maximize();
...
window.app_saku3_report_siaga_hris_karyawan_flMasaKrj.extend(window.childForm);
window.app_saku3_report_siaga_hris_karyawan_flMasaKrj.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_so",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"where")+
				...
				this.nama_report = "server_report_saku3_siaga_hris_rptMasaKrj";
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_karyawan_flMasaKrj]::mainButtonClick:"+e);
		}
	},
