window.app_hris_report_karyawan_flMutasi = function(owner)
{
	if (owner)
	{
		window.app_hris_report_karyawan_flMutasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_hris_report_karyawan_flMutasi";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Mutasi", 2);
...
window.app_hris_report_karyawan_flMutasi.extend(window.childForm);
window.app_hris_report_karyawan_flMutasi.implement({
		...
		try
		{
			...
			else
			{
		    	...
		    	this.filter = this.filterRep.filterStr("b.kode_lokasi","=",this.app._lokasi,this.app._lokasi,"where")+
							...
							this.filterRep.filterStr("a.flag_form","=","MUTASI","MUTASI","and");;
			...
			systemAPI.alert("[app_hris_report_karyawan_flMutasi]::mainButtonClick:"+e);
		}
	},
