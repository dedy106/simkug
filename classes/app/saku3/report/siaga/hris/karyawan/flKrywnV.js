window.app_saku3_report_siaga_hris_karyawan_flKrywnV = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_karyawan_flKrywnV.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_karyawan_flKrywnV";
		this.maximize();
...
window.app_saku3_report_siaga_hris_karyawan_flKrywnV.extend(window.childForm);
window.app_saku3_report_siaga_hris_karyawan_flKrywnV.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siaga_hris_rptKrywnV";
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_karyawan_flKrywnV]::mainButtonClick:"+e);
		}
	},
