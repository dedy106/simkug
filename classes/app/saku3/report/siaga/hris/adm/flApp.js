window.app_saku3_report_siaga_hris_adm_flApp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_adm_flApp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_adm_flApp";
		this.maximize();
...
window.app_saku3_report_siaga_hris_adm_flApp.extend(window.childForm);
window.app_saku3_report_siaga_hris_adm_flApp.implement({
		...
		try{	
				...
				if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data App",this.sg1, this.sg1.row, this.sg1.col,
											"select a.no_app, a.catatan from gr_ver_m a "+
											"inner join gr_karyawan b on a.nik_user=b.nik and a.kode_lokasi=b.kode_lokasi "+filter,
											"select count(a.no_app) from gr_ver_m a "+
											"inner join gr_karyawan b on a.nik_user=b.nik and a.kode_lokasi=b.kode_lokasi "+filter,
				new Array("a.no_app","a.catatan"),"and",new Array("App","catatan"));
			}					
		}catch(e){
			systemAPI.alert(e);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siaga_hris_rptAppAbsen";
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_adm_flApp]::mainButtonClick:"+e);
		}
	},
