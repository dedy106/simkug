window.app_saku3_report_siaga_hris_adm_flPosAbsen = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_adm_flPosAbsen.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_adm_flPosAbsen";
		this.maximize();
...
window.app_saku3_report_siaga_hris_adm_flPosAbsen.extend(window.childForm);
window.app_saku3_report_siaga_hris_adm_flPosAbsen.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siaga_hris_rptPosAbsn";
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_adm_flPosAbsen]::mainButtonClick:"+e);
		}
	},
