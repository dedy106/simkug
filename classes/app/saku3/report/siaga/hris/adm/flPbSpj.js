window.app_saku3_report_siaga_hris_adm_flPbSpj = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_adm_flPbSpj.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_adm_flPbSpj";
		this.maximize();
...
window.app_saku3_report_siaga_hris_adm_flPbSpj.extend(window.childForm);
window.app_saku3_report_siaga_hris_adm_flPbSpj.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siaga_hris_rptPbSpj";
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_adm_flPbSpj]::mainButtonClick:"+e);
		}
	},
