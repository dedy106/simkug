window.app_saku3_report_siaga_hris_adm_flPosLembur = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_adm_flPosLembur.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_adm_flPosLembur";
		this.maximize();
...
window.app_saku3_report_siaga_hris_adm_flPosLembur.extend(window.childForm);
window.app_saku3_report_siaga_hris_adm_flPosLembur.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siaga_hris_rptPosLmbr";
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_adm_flPosLembur]::mainButtonClick:"+e);
		}
	},
