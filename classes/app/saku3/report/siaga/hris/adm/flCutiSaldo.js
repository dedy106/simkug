window.app_saku3_report_siaga_hris_adm_flCutiSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_adm_flCutiSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_adm_flCutiSaldo";
		this.maximize();
...
window.app_saku3_report_siaga_hris_adm_flCutiSaldo.extend(window.childForm);
window.app_saku3_report_siaga_hris_adm_flCutiSaldo.implement({
	...
	doSelectCell: function(sender, col, row){		
		...
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6],["123","3","3","3","3","3","3","3"]);
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5,6],[0,3,3,3,3,3,2,2]);
		}
		if (row == 0)
		{
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_siaga_hris_rptCutiSaldo";
		...
		{
			alert("[app_saku3_report_siaga_hris_adm_flCutiSaldo]::mainButtonClick:"+e);
		}
	},
