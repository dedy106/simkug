window.app_saku3_report_siaga_hris_adm_flPsCuti = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_adm_flPsCuti.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_adm_flPsCuti";
		this.maximize();
...
window.app_saku3_report_siaga_hris_adm_flPsCuti.extend(window.childForm);
window.app_saku3_report_siaga_hris_adm_flPsCuti.implement({
	doEllipseClick: function(sender, col, row){
		try{	
			...
			if (row == 2)
			{
				filter = this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"where");
			...
			if (row ==3)
			{
				filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"where")+
							this.filterRep.filterStr("a.kode_jab",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"where")+
							this.filterRep.filterStr("b.kode_jab",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
							this.filterRep.filterStr("a.nik_buat",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and")+
							this.filterRep.filterStr("a.sts_cuti",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4),"and")+
				...
				this.nama_report = "server_report_saku3_siaga_hris_rptPsCuti";
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_adm_flPsCuti]::mainButtonClick:"+e);
		}
	},
