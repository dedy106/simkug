window.app_saku3_report_siaga_hris_adm_flPosIjin = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_adm_flPosIjin.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_adm_flPosIjin";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Posisi Ijin", 2);
...
window.app_saku3_report_siaga_hris_adm_flPosIjin.extend(window.childForm);
window.app_saku3_report_siaga_hris_adm_flPosIjin.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_siaga_hris_rptPosIjin";
	...
	doOpenBukti: function(no_bukti,kode_lokasi){
		this.link="1";
		filter = "where a.no_ijin='"+no_bukti+"' and a.kode_lokasi='"+kode_lokasi+"' ";
	...
	doOpenVer: function(no_bukti,kode_lokasi){
		...
		filter2=this.app._namaUser;
		nama_report="server_report_hris_rptVerIjin";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
	...
	doOpenApp: function(no_bukti,kode_lokasi){
		...
		filter2=this.app._namaUser;
		nama_report="server_report_hris_rptAppIjin";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
