window.app_saku3_report_siaga_hris_adm_flAjuPd = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_adm_flAjuPd.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_adm_flAjuPd";
		this.maximize();
...
window.app_saku3_report_siaga_hris_adm_flAjuPd.extend(window.childForm);
window.app_saku3_report_siaga_hris_adm_flAjuPd.implement({
		...
		try{	
				...
				if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data SPPD",this.sg1, this.sg1.row, this.sg1.col,
													 "select a.no_spj, a.keterangan from gr_spj_m a "+filter,
													"select count(*) from gr_spj_m a "+filter,
													new Array("a.no_spj","a.keterangan"),"and",new Array("SPJ","Keterangan"));
			}					
		}catch(e){
			systemAPI.alert(e);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_adm_flAjuPd]::mainButtonClick:"+e);
		}
	},
