window.app_saku3_report_siaga_hris_adm_flCutiKartu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_adm_flCutiKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_adm_flCutiKartu";
		this.maximize();
...
window.app_saku3_report_siaga_hris_adm_flCutiKartu.extend(window.childForm);
window.app_saku3_report_siaga_hris_adm_flCutiKartu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				{
					this.nama_report = "server_report_siaga_hris_rptCutiKartu";
				}
		...
		{
			alert("[app_saku3_report_siaga_hris_adm_flCutiKartu]::mainButtonClick:"+e);
		}
	},
