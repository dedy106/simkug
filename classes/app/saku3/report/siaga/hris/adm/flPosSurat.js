window.app_saku3_report_siaga_hris_adm_flPosSurat = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_adm_flPosSurat.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_adm_flPosSurat";
		this.maximize();
...
window.app_saku3_report_siaga_hris_adm_flPosSurat.extend(window.childForm);
window.app_saku3_report_siaga_hris_adm_flPosSurat.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_siaga_hris_rptPosSurat";
	...
	doOpenBukti: function(no_bukti,kode_lokasi){
		this.link="1";
		filter = "where a.no_surat='"+no_bukti+"' and a.kode_lokasi='"+kode_lokasi+"' ";
