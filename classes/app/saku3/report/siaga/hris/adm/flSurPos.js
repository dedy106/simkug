window.app_saku3_report_siaga_hris_adm_flSurPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_adm_flSurPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_adm_flSurPos";
		this.maximize();
...
window.app_saku3_report_siaga_hris_adm_flSurPos.extend(window.childForm);
window.app_saku3_report_siaga_hris_adm_flSurPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siaga_hris_rptPosSur";
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_adm_flSurPos]::mainButtonClick:"+e);
		}
	},
