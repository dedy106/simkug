window.app_saku3_report_siaga_hris_adm_flCuti = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_adm_flCuti.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_adm_flCuti";
		this.maximize();
...
window.app_saku3_report_siaga_hris_adm_flCuti.extend(window.childForm);
window.app_saku3_report_siaga_hris_adm_flCuti.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_adm_flCuti]::mainButtonClick:"+e);
		}
	},
