window.app_saku3_report_siaga_hris_adm_flIzin = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_adm_flIzin.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_adm_flIzin";
		this.maximize();
...
window.app_saku3_report_siaga_hris_adm_flIzin.extend(window.childForm);
window.app_saku3_report_siaga_hris_adm_flIzin.implement({
		...
		try{	
				...
				if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Surat",this.sg1, this.sg1.row, this.sg1.col,
											...
											"inner join gr_karyawan b on a.nik_buat=b.nik and a.kode_lokasi=b.kode_lokasi "+filter,
				new Array("a.no_ijin","a.keterangan"),"and",new Array("Surat","Keterangan"));
			}					
		}catch(e){
			systemAPI.alert(e);
		}
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("c.kode_jab",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"where")+
							...
							this.filterRep.filterStr("a.no_ijin",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and");
							
				this.filter2 = this.sg1.getCell(2,1)+"/";
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				
				this.nama_report = "server_report_saku3_siaga_hris_rptIjin";
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_adm_flIzin]::mainButtonClick:"+e);
		}
	},
