window.app_saku3_report_siaga_hris_adm_flDetCuti = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_adm_flDetCuti.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_adm_flDetCuti";
		this.maximize();
...
window.app_saku3_report_siaga_hris_adm_flDetCuti.extend(window.childForm);
window.app_saku3_report_siaga_hris_adm_flDetCuti.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siaga_hris_rptDetCuti";
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_adm_flDetCuti]::mainButtonClick:"+e);
		}
	},
