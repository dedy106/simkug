window.app_saku3_report_siaga_hris_adm_flAbsenBulan = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_adm_flAbsenBulan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_adm_flAbsenBulan";
		this.maximize();
...
window.app_saku3_report_siaga_hris_adm_flAbsenBulan.extend(window.childForm);
window.app_saku3_report_siaga_hris_adm_flAbsenBulan.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_siaga_hris_rptAbsenBulan";
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_adm_flAbsenBulan]::mainButtonClick:"+e);
		}
	},
