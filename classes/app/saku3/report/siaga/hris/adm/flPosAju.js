window.app_saku3_report_siaga_hris_adm_flPosAju = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_adm_flPosAju.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_adm_flPosAju";
		this.maximize();
...
window.app_saku3_report_siaga_hris_adm_flPosAju.extend(window.childForm);
window.app_saku3_report_siaga_hris_adm_flPosAju.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siaga_hris_rptPosSpj";
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_adm_flPosAju]::mainButtonClick:"+e);
		}
	},
