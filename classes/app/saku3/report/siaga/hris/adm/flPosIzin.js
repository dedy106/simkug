window.app_saku3_report_siaga_hris_adm_flPosIzin = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_adm_flPosIzin.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_adm_flPosIzin";
		this.maximize();
...
window.app_saku3_report_siaga_hris_adm_flPosIzin.extend(window.childForm);
window.app_saku3_report_siaga_hris_adm_flPosIzin.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siaga_hris_rptPosIzin";
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_adm_flPosIzin]::mainButtonClick:"+e);
		}
	},
