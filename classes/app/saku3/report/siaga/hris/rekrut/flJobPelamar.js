window.app_saku3_report_siaga_hris_rekrut_flJobPelamar = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_rekrut_flJobPelamar.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_rekrut_flJobPelamar";
		this.maximize();
...
window.app_saku3_report_siaga_hris_rekrut_flJobPelamar.extend(window.childForm);
window.app_saku3_report_siaga_hris_rekrut_flJobPelamar.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_rekrut_flJobPelamar]::mainButtonClick:"+e);
		}
	},
