window.app_saku3_report_siaga_hris_rekrut_flPelamarr = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_rekrut_flPelamarr.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_rekrut_flPelamarr";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Pendidikan","All",""));
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("NIP","All",""));
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
	this.doSelectCell(this.sg1,2,3);
};
window.app_saku3_report_siaga_hris_rekrut_flPelamarr.extend(window.childForm);
window.app_saku3_report_siaga_hris_rekrut_flPelamarr.implement({
		...
		try{	
			...
			if (row ==1)
			{
				this.filterRep.ListDataSGFilter(this, "Data Pendidikan",this.sg1, this.sg1.row, this.sg1.col,
												"select sts_didik, nama from gr_status_didik ",
												"select count(*) from gr_status_didik ",
												new Array("sts_didik","nama"),"where",new Array("kode","nama"));
			}			
			if (row ==2)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Pelamar",this.sg1, this.sg1.row, this.sg1.col,
												"select a.nip, a.nama from gr_rekrut_pelamar a "+filter,
												"select count(a.nip) from gr_rekrut_pelamar a "+filter,
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_rekrut_flPelamarr]::mainButtonClick:"+e);
		}
	},
