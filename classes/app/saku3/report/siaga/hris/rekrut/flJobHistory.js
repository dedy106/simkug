window.app_saku3_report_siaga_hris_rekrut_flJobHistory = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_rekrut_flJobHistory.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_rekrut_flJobHistory";
		this.maximize();
...
window.app_saku3_report_siaga_hris_rekrut_flJobHistory.extend(window.childForm);
window.app_saku3_report_siaga_hris_rekrut_flJobHistory.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_rekrut_flJobHistory]::mainButtonClick:"+e);
		}
	},
