window.app_saku3_report_siaga_hris_rekrut_flJob2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_rekrut_flJob2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_rekrut_flJob2";
		this.maximize();
...
window.app_saku3_report_siaga_hris_rekrut_flJob2.extend(window.childForm);
window.app_saku3_report_siaga_hris_rekrut_flJob2.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siaga_hris_rptJob";
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_rekrut_flJob2]::mainButtonClick:"+e);
		}
	},
