window.app_saku3_report_siaga_hris_rekrut_flJobPelamarr = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_rekrut_flJobPelamarr.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_rekrut_flJobPelamarr";
		this.maximize();
...
window.app_saku3_report_siaga_hris_rekrut_flJobPelamarr.extend(window.childForm);
window.app_saku3_report_siaga_hris_rekrut_flJobPelamarr.implement({
		...
		try{	
			...
			if (row ==2)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Pelamar",this.sg1, this.sg1.row, this.sg1.col,
												"select a.nip, a.nama from gr_rekrut_job_pelamar a "+filter,
												"select count(a.nip) from gr_rekrut_job_pelamar a "+filter,
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.sts_didik",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
				...
				this.nama_report = "server_report_saku3_siaga_hris_rptPelamar";
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_rekrut_flJobPelamarr]::mainButtonClick:"+e);
		}
	},
