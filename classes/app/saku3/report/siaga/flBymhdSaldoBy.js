// JavaScript Document
window.app_saku3_report_siaga_flBymhdSaldoBy = function(owner)
{
	if (owner)
	{
	...
	var sql="select max(a.periode) as periode from (select distinct periode from ju_m where kode_lokasi='"+this.app._lokasi+"' and modul in ('BYMHD') "+
					"union "+
