window.app_saku3_report_siaga_flFormBMHD = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_flFormBMHD.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_flFormBMHD";
		this.maximize();
...
window.app_saku3_report_siaga_flFormBMHD.extend(window.childForm);
window.app_saku3_report_siaga_flFormBMHD.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_siaga_flFormBMHD]::mainButtonClick:"+e);
		}
	},
