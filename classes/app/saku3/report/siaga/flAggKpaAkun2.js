window.app_saku3_report_siaga_flAggKpaAkun2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_flAggKpaAkun2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_flAggKpaAkun2";
		this.maximize();
...
window.app_saku3_report_siaga_flAggKpaAkun2.extend(window.portalui_childForm);
window.app_saku3_report_siaga_flAggKpaAkun2.implement({
	...
	doSelectCell: function(sender, col, row){
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5],["123","2","123","3","123","3"]);
		...
		try
		{
			...
			else
			{
				...
				this.filter=this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							"and a.modul='ORGI' ";
				var periode2=this.filterRep.filterStr("b.periode",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4),"and");			
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.app._nikUser+"/"+periode2;
			
				this.nama_report="server_report_saku3_siaga_rptAggKpaAkun";
