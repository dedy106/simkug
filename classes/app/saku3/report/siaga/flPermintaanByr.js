window.app_saku3_report_siaga_flPermintaanByr = function (owner) {
    if (owner) {
        window.app_saku3_report_siaga_flPermintaanByr.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku3_report_siaga_flPermintaanByr";
        this.maximize();
...
window.app_saku3_report_siaga_flPermintaanByr.extend(window.childForm);
window.app_saku3_report_siaga_flPermintaanByr.implement({
    ...
    mainButtonClick: function (sender) {
        try {
            ...
            systemAPI.alert("[app_saku3_report_siaga_flPermintaanByr]::mainButtonClick:" + e);
        }
    },
