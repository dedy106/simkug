window.app_saku3_report_siaga_simlog_flPenetapan = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_simlog_flPenetapan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_simlog_flPenetapan";
		this.maximize();
...
window.app_saku3_report_siaga_simlog_flPenetapan.extend(window.childForm);
window.app_saku3_report_siaga_simlog_flPenetapan.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
		    	...
		    	this.filter =  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("j.no_tap",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
				this.filter2 = this.sg1.getCell(2,1)+"/";
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_siaga_simlog_rptPenetapan";
			...
			systemAPI.alert("[app_saku3_report_siaga_simlog_flPenetapan]::mainButtonClick:"+e);
		}
	},
	...
	doOpenBukti: function(no_bukti,kode_lokasi){
		this.link="1";
		filter = "where a.log_tap_m='"+no_bukti+"' and a.kode_lokasi='"+kode_lokasi+"' ";
