window.app_saku3_report_siaga_simlog_flTerima = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_simlog_flTerima.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_simlog_flTerima";
		this.maximize();
...
window.app_saku3_report_siaga_simlog_flTerima.extend(window.childForm);
window.app_saku3_report_siaga_simlog_flTerima.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_siaga_simlog_flTerima]::mainButtonClick:"+e);
		}
	},
