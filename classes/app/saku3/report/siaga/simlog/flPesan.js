window.app_saku3_report_siaga_simlog_flPesan = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_simlog_flPesan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_simlog_flPesan";
		this.maximize();
...
window.app_saku3_report_siaga_simlog_flPesan.extend(window.childForm);
window.app_saku3_report_siaga_simlog_flPesan.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_siaga_simlog_flPesan]::mainButtonClick:"+e);
		}
	},
