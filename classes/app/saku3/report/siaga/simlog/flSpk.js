window.app_saku3_report_siaga_simlog_flSpk = function (owner) {
	if (owner) {
		window.app_saku3_report_siaga_simlog_flSpk.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku3_report_siaga_simlog_flSpk";
		this.maximize();
...
window.app_saku3_report_siaga_simlog_flSpk.extend(window.childForm);
window.app_saku3_report_siaga_simlog_flSpk.implement({
		...
		try {
			...
			if (row == 2) {
				...
				this.filterRep.ListDataSGFilter(this, "Data Pengajuan", this.sg1, this.sg1.row, this.sg1.col,
					"select a.no_spk, a.keterangan from log_spk_m a " + this.filter + "and a.modul='SPK'",
					"select count(*) from log_spk_m a " + this.filter + "and a.modul='SPK'",
					new Array("a.no_spk", "a.keterangan"), "and", new Array("No Bukti", "Keterangan"));
			}
		...
		try {
			if (sender === this.app._mainForm.bClear2) {
				...
				if (sender == this.app._mainForm.bBack) {
					...
					this.filter = this.filterRep.filterStr("a.kode_lokasi", this.sg1.getCell(1, 0), this.sg1.getCell(2, 0), this.sg1.getCell(3, 0), "where") +
						this.filterRep.filterStr("a.periode", this.sg1.getCell(1, 1), this.sg1.getCell(2, 1), this.sg1.getCell(3, 1), "and") +
						this.filterRep.filterStr("k.no_spk", this.sg1.getCell(1, 2), this.sg1.getCell(2, 2), this.sg1.getCell(3, 2), "and");
					this.filter2 = this.sg1.getCell(2, 1) + "/";
					this.showFilter = this.filterRep.showFilter(this.sg1);
					var result = new arrayMap();
					this.nama_report = "server_report_saku3_siaga_simlog_rptSpk";
			...
			systemAPI.alert("[app_saku3_report_siaga_simlog_flSpk]::mainButtonClick:" + e);
		}
	},
	...
	doOpenBukti: function (no_bukti, kode_lokasi) {
		this.link = "1";
		filter = "where a.log_spk_m='" + no_bukti + "' and a.kode_lokasi='" + kode_lokasi + "' ";
