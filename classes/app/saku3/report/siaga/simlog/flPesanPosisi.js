window.app_saku3_report_siaga_simlog_flPesanPosisi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_simlog_flPesanPosisi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_simlog_flPesanPosisi";
		this.maximize();
...
window.app_saku3_report_siaga_simlog_flPesanPosisi.extend(window.childForm);
window.app_saku3_report_siaga_simlog_flPesanPosisi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_siaga_simlog_rptPesanPosisi";
			...
			systemAPI.alert("[app_saku3_report_siaga_simlog_flPesanPosisi]::mainButtonClick:"+e);
		}
	},
	...
	doOpenPesan: function(no_bukti,kode_lokasi){
		...
		nama_report="server_report_saku3_siaga_simlog_rptPesan";
	...
	doOpenDetail: function(no_bukti,kode_lokasi){
		this.link="1";
		alert('a');
		filter = "where a.no_pesan='"+no_bukti+"' and a.kode_lokasi='"+kode_lokasi+"' ";
		filter2=this.sg1.getCell(2,1);
		nama_report="server_report_saku3_siaga_simlog_rptPesanDetail";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
