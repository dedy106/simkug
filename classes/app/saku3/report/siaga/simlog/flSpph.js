window.app_saku3_report_siaga_simlog_flSpph = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_simlog_flSpph.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_simlog_flSpph";
		this.maximize();
...
window.app_saku3_report_siaga_simlog_flSpph.extend(window.childForm);
window.app_saku3_report_siaga_simlog_flSpph.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_siaga_simlog_flSpph]::mainButtonClick:"+e);
		}
	},
