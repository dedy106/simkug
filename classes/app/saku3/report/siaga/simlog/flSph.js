window.app_saku3_report_siaga_simlog_flSph = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_simlog_flSph.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_simlog_flSph";
		this.maximize();
...
window.app_saku3_report_siaga_simlog_flSph.extend(window.childForm);
window.app_saku3_report_siaga_simlog_flSph.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_siaga_simlog_flSph]::mainButtonClick:"+e);
		}
	},
