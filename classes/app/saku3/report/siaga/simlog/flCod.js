window.app_saku3_report_siaga_simlog_flCod = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_simlog_flCod.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_simlog_flCod";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("No PR","All",""));
...
window.app_saku3_report_siaga_simlog_flCod.extend(window.childForm);
window.app_saku3_report_siaga_simlog_flCod.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row ==2)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data COD",this.sg1, this.sg1.row, this.sg1.col,
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_siaga_simlog_flCod]::mainButtonClick:"+e);
		}
	},
