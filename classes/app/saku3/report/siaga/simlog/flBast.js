window.app_saku3_report_siaga_simlog_flBast = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_simlog_flBast.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_simlog_flBast";
		this.maximize();
...
window.app_saku3_report_siaga_simlog_flBast.extend(window.childForm);
window.app_saku3_report_siaga_simlog_flBast.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_siaga_simlog_flBast]::mainButtonClick:"+e);
		}
	},
