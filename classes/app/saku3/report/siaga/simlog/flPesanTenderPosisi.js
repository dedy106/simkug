window.app_saku3_report_siaga_simlog_flPesanTenderPosisi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_simlog_flPesanTenderPosisi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_simlog_flPesanTenderPosisi";
		this.maximize();
...
window.app_saku3_report_siaga_simlog_flPesanTenderPosisi.extend(window.childForm);
window.app_saku3_report_siaga_simlog_flPesanTenderPosisi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
		    	...
		    	this.filter =  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("a.no_pesan",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
				this.filter2 = this.sg1.getCell(2,1)+"/";
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_siaga_simlog_rptPesanTenderPosisi";
			...
			systemAPI.alert("[app_saku3_report_siaga_simlog_flPesanTenderPosisi]::mainButtonClick:"+e);
		}
	},
