window.app_saku3_report_siaga_simlog_flSphTender = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_simlog_flSphTender.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_simlog_flSphTender";
		this.maximize();
...
window.app_saku3_report_siaga_simlog_flSphTender.extend(window.childForm);
window.app_saku3_report_siaga_simlog_flSphTender.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
		    	...
		    	this.filter =  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("g.no_sph",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
			...
			systemAPI.alert("[app_saku3_report_siaga_simlog_flSphTender]::mainButtonClick:"+e);
		}
	},
