window.app_saku3_report_siaga_hris_flGaji = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_flGaji.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_flGaji";
		this.maximize();
...
window.app_saku3_report_siaga_hris_flGaji.extend(window.childForm);
window.app_saku3_report_siaga_hris_flGaji.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siaga_hris_rptGaji";
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_flGaji]::mainButtonClick:"+e);
		}
	},
