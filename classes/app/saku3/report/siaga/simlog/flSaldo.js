window.app_saku3_report_logistik_flSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_logistik_flSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_logistik_flSaldo";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from log_sph_m  ");
	...
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Gedung","All",""));
...
window.app_saku3_report_logistik_flSaldo.extend(window.childForm);
window.app_saku3_report_logistik_flSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_logistik_rptSaldo";
			...
			systemAPI.alert("[app_saku3_report_logistik_flSaldo]::mainButtonClick:"+e);
		}
	},
