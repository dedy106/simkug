window.app_saku3_report_siaga_simlog_flPanitia = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_simlog_flPanitia.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_simlog_flPanitia";
		this.maximize();
...
window.app_saku3_report_siaga_simlog_flPanitia.extend(window.childForm);
window.app_saku3_report_siaga_simlog_flPanitia.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_siaga_simlog_rptPanitia";
			...
			systemAPI.alert("[app_saku3_report_siaga_simlog_flPanitia]::mainButtonClick:"+e);
		}
	},
