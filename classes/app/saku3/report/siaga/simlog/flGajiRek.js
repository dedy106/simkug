window.app_saku3_report_siaga_hris_flGajiRek = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_flGajiRek.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_flGajiRek";
		this.maximize();
...
window.app_saku3_report_siaga_hris_flGajiRek.extend(window.childForm);
window.app_saku3_report_siaga_hris_flGajiRek.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_flGajiRek]::mainButtonClick:"+e);
		}
	},
