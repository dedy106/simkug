window.app_saku3_report_siaga_hris_flGajiRes = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_hris_flGajiRes.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_hris_flGajiRes";
		this.maximize();
...
window.app_saku3_report_siaga_hris_flGajiRes.extend(window.childForm);
window.app_saku3_report_siaga_hris_flGajiRes.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_siaga_hris_flGajiRes]::mainButtonClick:"+e);
		}
	},
