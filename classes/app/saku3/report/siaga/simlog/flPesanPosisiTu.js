window.app_saku3_report_siaga_simlog_flPesanPosisiTu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_simlog_flPesanPosisiTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_simlog_flPesanPosisiTu";
		this.maximize();
...
window.app_saku3_report_siaga_simlog_flPesanPosisiTu.extend(window.childForm);
window.app_saku3_report_siaga_simlog_flPesanPosisiTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_siaga_simlog_rptPesanPosisiTu";
			...
			systemAPI.alert("[app_saku3_report_siaga_simlog_flPesanPosisiTu]::mainButtonClick:"+e);
		}
	},
