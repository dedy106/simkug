window.app_saku3_report_siaga_flAggKpaAkun = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_flAggKpaAkun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_flAggKpaAkun";
		this.maximize();
...
window.app_saku3_report_siaga_flAggKpaAkun.extend(window.portalui_childForm);
window.app_saku3_report_siaga_flAggKpaAkun.implement({
