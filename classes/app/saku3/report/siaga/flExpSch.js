window.app_saku3_report_siaga_flExpSch = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_flExpSch.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_flExpSch";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1), new Array("No Kartu","All"));
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_siaga_flExpSch.extend(window.childForm);
window.app_saku3_report_siaga_flExpSch.implement({
		...
		try{			
			...
			if (row == 2)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Jurnal",this.sg1, this.sg1.row, this.sg1.col,
														  "select no_kartu, keterangan from gr_kartu_m "+filter ,
														  "select count(no_kartu) from gr_kartu_m "+filter,
														  new Array("no_kartu","keterangan"),"and");
			}
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from gr_kartu_m where kode_lokasi='"+this.app._lokasi+"' order by periode desc",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+
							...
							this.filterRep.filterStr("a.no_kartu",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2)," and ");
				this.filter2=this.sg1.getCell(2,1);
				this.nama_report="server_report_saku3_siaga_rptExpSch";
