window.app_saku3_report_siaga_flBebanAju = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_flBebanAju.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_flBebanAju";
		this.maximize();
...
window.app_saku3_report_siaga_flBebanAju.extend(window.childForm);
window.app_saku3_report_siaga_flBebanAju.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_siaga_flBebanAju]::mainButtonClick:"+e);
		}
	},
