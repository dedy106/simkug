window.app_saku3_report_siaga_flAggTahun = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_flAggTahun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_flAggTahun";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,5,[0,1,2],["Realisasi","=","Anggaran"]);
...
window.app_saku3_report_siaga_flAggTahun.extend(window.portalui_childForm);
window.app_saku3_report_siaga_flAggTahun.implement({
		...
		try
		{
			...
			else
			{
				...
				if (this.sg1.getCell(2,4)=="Bulanan")
				{
					...
					alert(sql);
					this.nama_report="server_report_saku3_siaga_rptAggRealBulan";
				}
				if (this.sg1.getCell(2,4)=="Triwulan")
				{
					...
					this.nama_report="server_report_saku2_siaga_rptAggRealTw";
				}
				if (this.sg1.getCell(2,4)=="Semester")
				{
					...
					this.nama_report="server_report_saku2_siaga_rptAggRealSem";
				}
