window.app_saku3_report_siaga_aset_flSubPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_aset_flSubPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_aset_flSubPp";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Kode SubPP","All",""));
...
window.app_saku3_report_siaga_aset_flSubPp.extend(window.childForm);
window.app_saku3_report_siaga_aset_flSubPp.implement({
		...
		try{			
			...
			if (row ==	1)
			{
				this.filterRep.ListDataSGFilter(this, "Data SubPP",this.sg1, this.sg1.row, this.sg1.col,
														  ...
														  "select count(kode_subpp) from am_subpp "+
														  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  new Array("kode_subpp","nama"),"and");
			}
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.kode_subpp",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");
				this.filter2 = this.sg1.getCell(2,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_siaga_aset_rptSubPp";
			...
			systemAPI.alert("[app_saku3_report_siaga_aset_flSubPp]::mainButtonClick:"+e);
		}
	},
