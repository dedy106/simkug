window.app_saku3_report_siaga_aset_flKlpBrg = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_aset_flKlpBrg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_aset_flKlpBrg";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Kode Kelompok Barang","All",""));
...
window.app_saku3_report_siaga_aset_flKlpBrg.extend(window.childForm);
window.app_saku3_report_siaga_aset_flKlpBrg.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row ==	1)
			{
				this.filterRep.ListDataSGFilter(this, "Data KlpBarang",this.sg1, this.sg1.row, this.sg1.col,
														  "select kode_klpbarang, nama from am_klpbarang "+
														   this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  "select count(kode_klpbarang) from am_klpbarang "+
														  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  new Array("kode_klpbarang","nama"),"and");
			}
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.kode_klpbarang",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");
				this.filter2 = this.sg1.getCell(2,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_siaga_aset_rptKlpBrg";
			...
			systemAPI.alert("[app_saku3_report_siaga_aset_flKlpBrg]::mainButtonClick:"+e);
		}
	},
