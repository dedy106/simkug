window.app_saku3_report_siaga_aset_flSubKateg = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_aset_flSubKateg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_aset_flSubKateg";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Kode SubKategori","All",""));
...
window.app_saku3_report_siaga_aset_flSubKateg.extend(window.childForm);
window.app_saku3_report_siaga_aset_flSubKateg.implement({
		...
		try{			
			...
			if (row ==	1)
			{
				this.filterRep.ListDataSGFilter(this, "Data SubKategori",this.sg1, this.sg1.row, this.sg1.col,
														  ...
														  "select count(kode_subkateg) from am_subkateg "+
														  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  new Array("kode_subkateg","nama"),"and");
			}
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.kode_subkateg",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");
				this.filter2 = this.sg1.getCell(2,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_siaga_aset_rptSubKateg";
			...
			systemAPI.alert("[app_saku3_report_siaga_aset_flSubKateg]::mainButtonClick:"+e);
		}
	},
