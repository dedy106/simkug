window.app_saku3_report_siaga_aset_flPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_aset_flPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_aset_flPp";
		this.maximize();
...
window.app_saku3_report_siaga_aset_flPp.extend(window.childForm);
window.app_saku3_report_siaga_aset_flPp.implement({
		...
		try{			
			...
			if (row ==	1)
			{
				this.filterRep.ListDataSGFilter(this, "Data PP",this.sg1, this.sg1.row, this.sg1.col,
														  ...
														  "select count(kode_pp) from am_pp "+
														  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siaga_aset_rptPp";
			...
			systemAPI.alert("[app_saku3_report_siaga_aset_flPp]::mainButtonClick:"+e);
		}
	},
