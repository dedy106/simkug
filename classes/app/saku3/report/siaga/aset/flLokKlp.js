window.app_saku3_report_siaga_aset_flLokKlp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_aset_flLokKlp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_aset_flLokKlp";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Kode Kelompok","All",""));
...
window.app_saku3_report_siaga_aset_flLokKlp.extend(window.childForm);
window.app_saku3_report_siaga_aset_flLokKlp.implement({
		...
		try{			
			...
			if (row ==	1)
			{
				this.filterRep.ListDataSGFilter(this, "Data Lokasi",this.sg1, this.sg1.row, this.sg1.col,
														  ...
														  "select count(kode_klp) from am_lokasi_klp "+
														  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siaga_aset_rptLokKlp";
			...
			systemAPI.alert("[app_saku3_report_siaga_aset_flLokKlp]::mainButtonClick:"+e);
		}
	},
