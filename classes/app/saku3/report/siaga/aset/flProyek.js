window.app_saku3_report_siaga_aset_flProyek = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_aset_flProyek.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_aset_flProyek";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Kode Proyek","All",""));
...
window.app_saku3_report_siaga_aset_flProyek.extend(window.childForm);
window.app_saku3_report_siaga_aset_flProyek.implement({
		...
		try{			
			...
			if (row ==	1)
			{
				this.filterRep.ListDataSGFilter(this, "Data Proyek",this.sg1, this.sg1.row, this.sg1.col,
														  ...
														  "select count(kode_proyek) from am_proyek "+
														  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_siaga_aset_rptProyek";
			...
			systemAPI.alert("[app_saku3_report_siaga_aset_flProyek]::mainButtonClick:"+e);
		}
	},
