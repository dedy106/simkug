window.app_saku3_report_siaga_flBebanSpb = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_flBebanSpb.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_flBebanSpb";
		this.maximize();
...
window.app_saku3_report_siaga_flBebanSpb.extend(window.childForm);
window.app_saku3_report_siaga_flBebanSpb.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_siaga_flBebanSpb]::mainButtonClick:"+e);
		}
	},
