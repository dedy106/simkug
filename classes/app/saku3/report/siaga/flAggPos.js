window.app_saku3_report_siaga_flAggPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_flAggPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_flAggPos";
		this.maximize();
...
window.app_saku3_report_siaga_flAggPos.extend(window.childForm);
window.app_saku3_report_siaga_flAggPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_siaga_rptAggPos";
				this.dbLib.execQuerySync(this.sql);	
