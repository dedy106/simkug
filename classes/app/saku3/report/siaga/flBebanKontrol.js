window.app_saku3_report_siaga_flBebanKontrol = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_flBebanKontrol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_flBebanKontrol";
		this.maximize();
...
window.app_saku3_report_siaga_flBebanKontrol.extend(window.childForm);
window.app_saku3_report_siaga_flBebanKontrol.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_siaga_rptBebanKontrol";
			...
			systemAPI.alert("[app_saku3_report_siaga_flBebanKontrol]::mainButtonClick:"+e);
		}
	},
