window.app_saku3_report_siaga_flAngPosV2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_flAngPosV2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_flAngPosV2";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,[0,1,2],["Periode","=",this.app._kodePP]);
	this.gridLib.SGEditData(this.sg1,3,[0,1,2],["No Bukti","All",""]);
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
	
};
window.app_saku3_report_siaga_flAngPosV2.extend(window.childForm);
window.app_saku3_report_siaga_flAngPosV2.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_siaga_rptAngPosV2";
				this.dbLib.execQuerySync(this.sql);	
	...
	doOpenBukti: function(no_bukti,kode_lokasi){
		...
		nama_report="server_report_saku3_siaga_rptAggPdrk";
