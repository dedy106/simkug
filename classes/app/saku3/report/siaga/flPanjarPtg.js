window.app_saku3_report_siaga_flPanjarPtg = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_flPanjarPtg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_flPanjarPtg";
		this.maximize();
...
window.app_saku3_report_siaga_flPanjarPtg.extend(window.childForm);
window.app_saku3_report_siaga_flPanjarPtg.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row ==4)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Pertanggungan",this.sg1, this.sg1.row, this.sg1.col,sql,sql2,
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_siaga_flPanjarPtg]::mainButtonClick:"+e);
		}
	},
