window.app_saku3_report_siaga_flPanjarKontrol = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_flPanjarKontrol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_flPanjarKontrol";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from gr_pb_m where kode_lokasi='"+this.app._lokasi+"' and modul='PJAJU'");
...
window.app_saku3_report_siaga_flPanjarKontrol.extend(window.childForm);
window.app_saku3_report_siaga_flPanjarKontrol.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from gr_pb_m where kode_lokasi='"+this.app._lokasi+"' and modul='PJAJU' order by periode desc",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
		if (row == 5)
		{
			this.sg1.columns.get(2).pickList.clear();
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							" and a.modul='PJAJU'";
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(1,1)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(3,1)+"/"+this.sg1.getCell(2,5);
			...
			systemAPI.alert("[app_saku3_report_siaga_flPanjarKontrol]::mainButtonClick:"+e);
		}
	},
