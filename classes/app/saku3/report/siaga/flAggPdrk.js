window.app_saku3_report_siaga_flAggPdrk = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_flAggPdrk.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_flAggPdrk";
		this.maximize();
...
window.app_saku3_report_siaga_flAggPdrk.extend(window.portalui_childForm);
window.app_saku3_report_siaga_flAggPdrk.implement({
