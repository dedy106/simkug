window.app_saku3_report_siaga_flBuktiBebanEmail = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_flBuktiBebanEmail.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_flBuktiBebanEmail";
		this.maximize();
...
window.app_saku3_report_siaga_flBuktiBebanEmail.extend(window.childForm);
window.app_saku3_report_siaga_flBuktiBebanEmail.implement({
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("a.kode_pp",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
							this.filterRep.filterStr("e.no_pb",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and");
				this.filter2 = this.app._namaUser + "/" +this.app._userLog + "/" + this.app._userPwd + "/"+this.sg1.getCell(2,4)+"/"+this.sg1.getCell(2,5)+"/"+this.sg1.getCell(2,3);
			...
			systemAPI.alert("[app_saku3_report_siaga_flBuktiBebanEmail]::mainButtonClick:"+e);
		}
	},
