window.app_saku3_report_siaga_flSchSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_flSchSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_flSchSaldo";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("No Kartu","All",""));
...
window.app_saku3_report_siaga_flSchSaldo.extend(window.childForm);
window.app_saku3_report_siaga_flSchSaldo.implement({
		...
		try{			
			...
			if (row ==	2)
			{
				this.filterRep.ListDataSGFilter(this, "Data Kartu",this.sg1, this.sg1.row, this.sg1.col,
														  "select no_kartu, keterangan from gr_kartu_m "+
														   this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  "select count(no_kartu) from gr_kartu_m "+
														  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("b.kode_vendor",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
				...
				this.nama_report = "server_report_saku3_siaga_rptSchSaldo";
			...
			systemAPI.alert("[app_saku3_report_siaga_flSchSaldo]::mainButtonClick:"+e);
		}
	},
