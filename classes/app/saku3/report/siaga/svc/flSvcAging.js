window.app_saku3_report_siaga_svc_flSvcAging = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_svc_flSvcAging.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_svc_flSvcAging";
		this.maximize();
...
window.app_saku3_report_siaga_svc_flSvcAging.extend(window.childForm);
window.app_saku3_report_siaga_svc_flSvcAging.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_siaga_svc_rptSvcAging";
			...
			systemAPI.alert("[app_saku3_report_siaga_svc_flSvcAging]::mainButtonClick:"+e);
		}
	},
