window.app_saku3_report_siaga_svc_flSvcCabang = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_svc_flSvcCabang.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_svc_flSvcCabang";
		this.maximize();
...
window.app_saku3_report_siaga_svc_flSvcCabang.extend(window.childForm);
window.app_saku3_report_siaga_svc_flSvcCabang.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_siaga_svc_rptSvcCabang";
			...
			systemAPI.alert("[app_saku3_report_siaga_svc_flSvcCabang]::mainButtonClick:"+e);
		}
	},
	...
	doOpenBayar: function(kode_cabang,kode_lokasi){
		this.kode_cabang=kode_cabang;
		this.kode_lokasi=kode_lokasi;
		this.link="1";
		filter = "where a.kode_cabang='"+kode_cabang+"' and b.kode_lokasi='"+kode_lokasi+"' ";
		filter2="";
