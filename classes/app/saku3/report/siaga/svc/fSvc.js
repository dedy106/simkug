window.app_saku3_report_siaga_svc_fSvc = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_siaga_svc_fSvc.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_siaga_svc_fSvc";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Cabang","=",this.cab));
...
window.app_saku3_report_siaga_svc_fSvc.extend(window.childForm);
window.app_saku3_report_siaga_svc_fSvc.implement({
		...
		try{			
			...
			if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Invoice",this.sg1, this.sg1.row, this.sg1.col,
												...
												"inner join gr_svc_d b on a.no_tecc=b.no_tecc and a.kode_lokasi=b.kode_lokasi "+filter,
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from gr_svc_m where kode_lokasi='"+this.app._lokasi+"' order by periode",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("a.kode_cabang",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
							this.filterRep.filterStr("b.no_invoice",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and");
				this.nama_cab=this.dbLib.getPeriodeFromSQL("select nama as periode from gr_cabang where kode_cabang='"+this.sg1.getCell(2,2)+"' ");
				this.filter2 = this.sg1.getCell(2,1)+"/"+this.nama_cab;
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_siaga_svc_rptSvc";
			...
			systemAPI.alert("[app_saku3_report_siaga_svc_fSvc]::mainButtonClick:"+e);
		}
	},
