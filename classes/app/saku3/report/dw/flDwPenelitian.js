// JavaScript Document
window.app_saku3_report_dw_flDwPenelitian = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dw_flDwPenelitian.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dw_flDwPenelitian";
		this.maximize();
...
window.app_saku3_report_dw_flDwPenelitian.extend(window.portalui_childForm);
window.app_saku3_report_dw_flDwPenelitian.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_dw_rptDwPenelitian";
