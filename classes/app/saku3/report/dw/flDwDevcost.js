// JavaScript Document
window.app_saku3_report_dw_flDwDevcost = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dw_flDwDevcost.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dw_flDwDevcost";
		this.maximize();
...
window.app_saku3_report_dw_flDwDevcost.extend(window.portalui_childForm);
window.app_saku3_report_dw_flDwDevcost.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_dw_rptDwDevcost";
