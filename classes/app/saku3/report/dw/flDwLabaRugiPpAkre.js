// JavaScript Document
window.app_saku3_report_dw_flDwLabaRugiPpAkre = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dw_flDwLabaRugiPpAkre.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dw_flDwLabaRugiPpAkre";
		this.maximize();
	...
	this.fs=this.dbLib.getPeriodeFromSQL("select kode_fs1 as periode from fs_akre where  kode_lokasi='"+this.app._lokasi+"' and kode_pp='"+this.app._kodePP+"'");
	if (this.fs=="")
	{
		this.fs="FP6";
	}
...
window.app_saku3_report_dw_flDwLabaRugiPpAkre.extend(window.portalui_childForm);
window.app_saku3_report_dw_flDwLabaRugiPpAkre.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_dw_rptDwLabaRugiPpAkre";
