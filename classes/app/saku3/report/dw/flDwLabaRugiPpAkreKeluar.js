// JavaScript Document
window.app_saku3_report_dw_flDwLabaRugiPpAkreKeluar = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dw_flDwLabaRugiPpAkreKeluar.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dw_flDwLabaRugiPpAkreKeluar";
		this.maximize();
	...
	this.fs=this.dbLib.getPeriodeFromSQL("select kode_fs2 as periode from fs_akre where  kode_lokasi='"+this.app._lokasi+"' and kode_pp='"+this.app._kodePP+"'");
	if (this.fs=="")
	{
		this.fs="FP2";
	}
...
window.app_saku3_report_dw_flDwLabaRugiPpAkreKeluar.extend(window.portalui_childForm);
window.app_saku3_report_dw_flDwLabaRugiPpAkreKeluar.implement({
	doEllipseClick: function(sender, col, row){
		...
		if (row == 3)
		{
			...
			{
				var sql="select a.kode_pp,a.nama from exs_pp a "+
						"where a.kode_lokasi='"+this.app._lokasi+"'  ";
				
				var sql2="select count(a.kode_pp) from exs_pp a "+
						"where a.kode_lokasi='"+this.app._lokasi+"' ";
			}
			else
			{
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_dw_rptDwLabaRugiPpAkreKeluar";
