// JavaScript Document
window.app_saku3_report_dw_flDwLabaRugiBidang = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dw_flDwLabaRugiBidang.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dw_flDwLabaRugiBidang";
		this.maximize();
	...
	var sql="select d.kode_bidang as periode "+
			"from pp d "+
	...
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("Kode Bidang","=",this.pp));
...
window.app_saku3_report_dw_flDwLabaRugiBidang.extend(window.portalui_childForm);
window.app_saku3_report_dw_flDwLabaRugiBidang.implement({
	doEllipseClick: function(sender, col, row){
		...
		if (row == 4)
		{
			this.filterRep.ListDataSGFilter(this, "Data Bidang",this.sg1, this.sg1.row, this.sg1.col,
													  "select kode_bidang,nama from exs_bidang "+
													  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+
													  " and flag_aktif='1' ",
													  "select count(kode_bidang) from exs_bidang "+
													  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+
													  " and flag_aktif='1' ",
		...
		try
		{
			...
			else
			{
				...
				var bidang=this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.kode_bidang",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4),"and");
				this.nama_report="server_report_saku3_dw_rptDwLabaRugiBidang";
