// JavaScript Document
window.app_saku3_report_dw_flDwPdptProdiGrafik = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dw_flDwPdptProdiGrafik.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dw_flDwPdptProdiGrafik";
		this.maximize();
		...
		this.pg1 = new pageControl(this,{bound:[0,0,this.width - 20, this.height -30], childPage:["Filter","Grafik Prodi","Tabel","Trail"], pageChange:[this,"doPageChange"]});
	...
	try{
		...
		this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Kode Prodi","=",this.app._kodePP));
...
window.app_saku3_report_dw_flDwPdptProdiGrafik.extend(window.portalui_childForm);
window.app_saku3_report_dw_flDwPdptProdiGrafik.implement({
	doEllipseClick: function(sender, col, row){
		...
		if (row == 3)
		{
			this.filterRep.ListDataSGFilter(this, "Data Prodi",this.sg1, this.sg1.row, this.sg1.col,
													  "select kode_jur,nama from aka_jurusan "+
													  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ") ,
													  "select count(kode_jur) from aka_jurusan "+
													  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
													  new Array("kode_jur","nama"),"where");
		}
	},
	...
	mainButtonClick: function(sender){
		...
		//	this.app._mainForm.reportNavigator.rearrange();
			...
			var sql = "select a.kode_pp,a.nama,ISNULL(b.n2*-1,0) as n2,ISNULL(b.n4*-1,0) as n4,ISNULL(b.n4*-1,0)-ISNULL(b.n2*-1,0) as deviasi "+
					...
					"where a.kode_lokasi='11' and (ISNULL(b.n2,0)<>0 or ISNULL(b.n4,0)<>0) and a.kode_pp='"+this.sg1.getCell(2,3)+"' ";
