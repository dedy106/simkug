// JavaScript Document
window.app_saku3_report_dw_flDwPpm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dw_flDwPpm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dw_flDwPpm";
		this.maximize();
...
window.app_saku3_report_dw_flDwPpm.extend(window.portalui_childForm);
window.app_saku3_report_dw_flDwPpm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_dw_rptDwppm";
