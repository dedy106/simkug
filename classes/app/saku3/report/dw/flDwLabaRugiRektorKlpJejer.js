// JavaScript Document
window.app_saku3_report_dw_flDwLabaRugiRektorKlpJejer = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dw_flDwLabaRugiRektorKlpJejer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dw_flDwLabaRugiRektorKlpJejer";
		this.maximize();
...
window.app_saku3_report_dw_flDwLabaRugiRektorKlpJejer.extend(window.portalui_childForm);
window.app_saku3_report_dw_flDwLabaRugiRektorKlpJejer.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_dw_rptDwLabaRugiRektorKlpJejer";
	...
	doOpenGar: function(kode_lokasi,periode,kode_neraca,kode_klp){
		...
		filter="where a.kode_lokasi='"+kode_lokasi+"' and e.kode_neraca='"+kode_neraca+"' and e.kode_fs='"+this.sg1.getCell(2,2)+"' and a.tahun='"+tahun+"' and f.kode_klp='"+kode_klp+"'";
