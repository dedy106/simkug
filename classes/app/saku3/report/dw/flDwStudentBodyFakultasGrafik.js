// JavaScript Document
window.app_saku3_report_dw_flDwStudentBodyFakultasGrafik = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dw_flDwStudentBodyFakultasGrafik.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dw_flDwStudentBodyFakultasGrafik";
		this.maximize();
	...
	try{
		...
		this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Kode Fakultas","=",this.fakultas));
...
window.app_saku3_report_dw_flDwStudentBodyFakultasGrafik.extend(window.portalui_childForm);
window.app_saku3_report_dw_flDwStudentBodyFakultasGrafik.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.filter =  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
						...
						" and a.periode='201502'";
			this.nama_report="server_report_saku3_dw_rptDwStudentBodyFakultas";
		...
		//	this.app._mainForm.reportNavigator.rearrange();
			...
			var sql = "select c.kode_fakultas,c.nama,sum(a.n1) as n2,sum(a.n2) as n4 "+
						"from exs_pdpt_ppbs a "+
						"inner join exs_prodi b on a.kode_pp=b.kode_prodi and a.kode_lokasi=b.kode_lokasi "+
						"inner join exs_fakultas c on b.kode_fakultas=c.kode_fakultas and b.kode_lokasi=c.kode_lokasi "+
						this.filter+
						"group by c.kode_fakultas,c.nama "+
						"order by c.kode_fakultas ";
			...
			var options = {
				...
				var sql = "select b.kode_prodi,b.nama,sum(a.n1) as n2,sum(a.n2) as n4 "+
						"from exs_pdpt_ppbs a "+
						"inner join exs_prodi b on a.kode_pp=b.kode_prodi and a.kode_lokasi=b.kode_lokasi "+
						"inner join exs_fakultas c on b.kode_fakultas=c.kode_fakultas and b.kode_lokasi=c.kode_lokasi "+
						"where a.kode_lokasi='11' and a.periode='201502' "+
						"group by b.kode_prodi,b.nama "+
						"order by b.kode_prodi";
				...
				for (var i = 0; i < data.rs.rows.length; i++){
					var line = data.rs.rows[i];
						...
						categories.push(line.nama);
						this.dataCategories.push(line.kode_prodi);
						series1.data.push(parseFloat(line.n2));
						series2.data.push(parseFloat(line.n4));
