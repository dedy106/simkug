// JavaScript Document
window.app_saku3_report_dw_flDwInvestasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dw_flDwInvestasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dw_flDwInvestasi";
		this.maximize();
...
window.app_saku3_report_dw_flDwInvestasi.extend(window.portalui_childForm);
window.app_saku3_report_dw_flDwInvestasi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_dw_rptDwInvestasi";
