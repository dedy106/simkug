// JavaScript Document
window.app_saku3_report_dw_flDwStudentBodyProdiGrafik = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dw_flDwStudentBodyProdiGrafik.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dw_flDwStudentBodyProdiGrafik";
		this.maximize();
	...
	try{
		...
		this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Kode Prodi","=",this.app._kodePP));
...
window.app_saku3_report_dw_flDwStudentBodyProdiGrafik.extend(window.portalui_childForm);
window.app_saku3_report_dw_flDwStudentBodyProdiGrafik.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_dw_rptDwStudentBodyProdi";
