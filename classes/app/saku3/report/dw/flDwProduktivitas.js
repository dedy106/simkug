// JavaScript Document
window.app_saku3_report_dw_flDwProduktivitas = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dw_flDwProduktivitas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dw_flDwProduktivitas";
		this.maximize();
...
window.app_saku3_report_dw_flDwProduktivitas.extend(window.portalui_childForm);
window.app_saku3_report_dw_flDwProduktivitas.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_dw_rptDwProduktivitas";
