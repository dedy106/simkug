// JavaScript Document
window.app_saku3_report_dw_flDwPdptTuGrafik = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dw_flDwPdptTuGrafik.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dw_flDwPdptTuGrafik";
		this.maximize();
		...
		this.pg1 = new pageControl(this,{bound:[0,0,this.width - 20, this.height -30], childPage:["Filter","Grafik TU","Grafik Fakultas","Grafik Prodi","Tabel","Trail"], pageChange:[this,"doPageChange"]});
		...
		this.viewer = new reportViewer(this.pg1.childPage[4],{bound:[0,0,this.width - 35, this.height - 35]});
...
window.app_saku3_report_dw_flDwPdptTuGrafik.extend(window.portalui_childForm);
window.app_saku3_report_dw_flDwPdptTuGrafik.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_dw_rptDwPdptTu";
		...
		//	this.app._mainForm.reportNavigator.rearrange();
			...
			var sql = "select c.kode_lokasi,c.nama,sum(ISNULL(b.n2*-1,0)) as n2,sum(ISNULL(b.n4*-1,0)) as n4,sum(ISNULL(b.n4*-1,0)-ISNULL(b.n2*-1,0)) as deviasi "+
					"from exs_pp a "+
					...
					"where a.kode_lokasi='11' and (ISNULL(b.n2,0)<>0 or ISNULL(b.n4,0)<>0)"+
					"group by c.kode_lokasi,c.nama";
