// JavaScript Document
window.app_saku3_report_dw_flDwLabaRugiBulan = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dw_flDwLabaRugiBulan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dw_flDwLabaRugiBulan";
		this.maximize();
...
window.app_saku3_report_dw_flDwLabaRugiBulan.extend(window.portalui_childForm);
window.app_saku3_report_dw_flDwLabaRugiBulan.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_dw_rptDwLabaRugiBulan";
