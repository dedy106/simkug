// JavaScript Document
window.app_saku3_report_dw_flDwLabaRugiFakultasJejer = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dw_flDwLabaRugiFakultasJejer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dw_flDwLabaRugiFakultasJejer";
		this.maximize();
...
window.app_saku3_report_dw_flDwLabaRugiFakultasJejer.extend(window.portalui_childForm);
window.app_saku3_report_dw_flDwLabaRugiFakultasJejer.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_dw_rptDwLabaRugiFakultasJejer";
