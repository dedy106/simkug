// JavaScript Document
window.app_saku3_report_dw_flDwKm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dw_flDwKm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dw_flDwKm";
		this.maximize();
...
window.app_saku3_report_dw_flDwKm.extend(window.portalui_childForm);
window.app_saku3_report_dw_flDwKm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_dw_rptDwKm";
