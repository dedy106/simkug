// JavaScript Document
window.app_saku3_report_dw_flDwLabaRugiFakultasAkreKeluar = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dw_flDwLabaRugiFakultasAkreKeluar.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dw_flDwLabaRugiFakultasAkreKeluar";
		this.maximize();
	...
	this.fs=this.dbLib.getPeriodeFromSQL("select kode_fs2 as periode from fs_akre where  kode_lokasi='"+this.app._lokasi+"' and kode_pp='"+this.fakultas+"'");
	if (this.fs=="")
	{
		this.fs="FP2";
	}
...
window.app_saku3_report_dw_flDwLabaRugiFakultasAkreKeluar.extend(window.portalui_childForm);
window.app_saku3_report_dw_flDwLabaRugiFakultasAkreKeluar.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_dw_rptDwLabaRugiFakultasAkreKeluar";
