// JavaScript Document
window.app_saku3_report_dw_flDwKeluarDana = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dw_flDwKeluarDana.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dw_flDwKeluarDana";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("Saldo Periode","=","Periode Aktif"));
...
window.app_saku3_report_dw_flDwKeluarDana.extend(window.portalui_childForm);
window.app_saku3_report_dw_flDwKeluarDana.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("Periode Aktif","Akhir Tahun"));
		}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_dw_rptDwKeluarDana";
