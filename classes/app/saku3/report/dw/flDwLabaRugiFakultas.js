// JavaScript Document
window.app_saku3_report_dw_flDwLabaRugiFakultas = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dw_flDwLabaRugiFakultas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dw_flDwLabaRugiFakultas";
		this.maximize();
	...
	this.pp=this.dbLib.getPeriodeFromSQL(sql);
	...
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("Kode Fakultas","=",this.pp));
...
window.app_saku3_report_dw_flDwLabaRugiFakultas.extend(window.portalui_childForm);
window.app_saku3_report_dw_flDwLabaRugiFakultas.implement({
		...
		try
		{
			...
			else
			{
				...
				var bidang=this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.kode_fakultas",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4),"and");
				this.nama_report="server_report_saku3_dw_rptDwLabaRugiFakultas";
