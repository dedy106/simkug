// JavaScript Document
window.app_saku3_report_dw_flDwLabaRugiPpSharingJejer = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dw_flDwLabaRugiPpSharingJejer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dw_flDwLabaRugiPpSharingJejer";
		this.maximize();
...
window.app_saku3_report_dw_flDwLabaRugiPpSharingJejer.extend(window.portalui_childForm);
window.app_saku3_report_dw_flDwLabaRugiPpSharingJejer.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_dw_rptDwLabaRugiPpSharingJejer";
