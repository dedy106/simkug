// JavaScript Document
window.app_saku3_report_dw_flDwStudentBodyGrafik = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dw_flDwStudentBodyGrafik.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dw_flDwStudentBodyGrafik";
		this.maximize();
...
window.app_saku3_report_dw_flDwStudentBodyGrafik.extend(window.portalui_childForm);
window.app_saku3_report_dw_flDwStudentBodyGrafik.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		this.filterRep.setSGFilterRowTipe(this.sg1, row,new Array(0,1),new  Array("123","3"));
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,new Array(0,1),new  Array(2,0));
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_dw_rptDwStudentBodyDetail";
		...
		//	this.app._mainForm.reportNavigator.rearrange();
			...
			var sql = "select a.kode_lokasi,d.nama,sum(a.n1) as n2,sum(a.n2) as n4 "+
			...
			var options = {
				...
				for (var i = 0; i < data.rs.rows.length; i++){
					var line = data.rs.rows[i];
						...
						categories.push(line.kode_prodi);
