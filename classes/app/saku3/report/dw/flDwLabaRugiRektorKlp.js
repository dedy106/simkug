// JavaScript Document
window.app_saku3_report_dw_flDwLabaRugiRektorKlp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dw_flDwLabaRugiRektorKlp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dw_flDwLabaRugiRektorKlp";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("Kode Rektor","=","1"));
...
window.app_saku3_report_dw_flDwLabaRugiRektorKlp.extend(window.portalui_childForm);
window.app_saku3_report_dw_flDwLabaRugiRektorKlp.implement({
	doEllipseClick: function(sender, col, row){
		...
		if (row == 4)
		{
			this.filterRep.ListDataSGFilter(this, "Data Rektor",this.sg1, this.sg1.row, this.sg1.col,
													  "select kode_klp,nama from exs_rektor_klp "+
													  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+
													  " and flag_aktif='1' ",
													  "select count(kode_klp) from exs_rektor_klp "+
													  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+
													  " and flag_aktif='1' ",
													  new Array("kode_klp","nama"),"where");
		}
	},
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_dw_rptDwLabaRugiRektorKlp";
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,3)+"/"+klp+"/"+this.sg1.getCell(2,5);
	...
	doOpenGar: function(kode_lokasi,periode,kode_neraca,kode_klp){
		...
		filter="where a.kode_lokasi='"+kode_lokasi+"' and e.kode_neraca='"+kode_neraca+"' and e.kode_fs='"+this.sg1.getCell(2,2)+"' and a.tahun='"+tahun+"' and g.kode_klp='"+kode_klp+"'";
	...
	doOpenGarSd: function(kode_lokasi,periode,kode_neraca,kode_klp){
		this.kode_neraca=kode_neraca;
		this.kode_lokasi=kode_lokasi;
		this.periode=periode;
		this.kode_klp=kode_klp;
	...
	doOpenTb: function(kode_lokasi,periode,kode_neraca,kode_klp){
		this.kode_neraca=kode_neraca;
		this.kode_lokasi=kode_lokasi;
		this.periode=periode;
		this.kode_klp=kode_klp;
		...
		filter2=this.sg1.getCell(2,0)+"/"+periode+"/"+kode_neraca+"/"+this.sg1.getCell(2,2);
		filter="where a.kode_lokasi='"+kode_lokasi+"' and b.kode_neraca='"+kode_neraca+"' and b.kode_fs='"+this.sg1.getCell(2,2)+"' and a.periode='"+periode+"' and g.kode_klp='"+kode_klp+"'";
