// JavaScript Document
window.app_saku3_report_dw_flDwLabaRugiRektorJejer = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dw_flDwLabaRugiRektorJejer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dw_flDwLabaRugiRektorJejer";
		this.maximize();
...
window.app_saku3_report_dw_flDwLabaRugiRektorJejer.extend(window.portalui_childForm);
window.app_saku3_report_dw_flDwLabaRugiRektorJejer.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_dw_rptDwLabaRugiRektorJejer";
