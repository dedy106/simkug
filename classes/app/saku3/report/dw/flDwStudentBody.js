// JavaScript Document
window.app_saku3_report_dw_flDwStudentBody = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dw_flDwStudentBody.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dw_flDwStudentBody";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Bentuk Laporan","=","Proporsi"));
...
window.app_saku3_report_dw_flDwStudentBody.extend(window.portalui_childForm);
window.app_saku3_report_dw_flDwStudentBody.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("Summary","Detail","Proporsi"));
		}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				if(this.sg1.getCell(2,2)=="Summary")
				{
					this.nama_report="server_report_saku3_dw_rptDwStudentBody";
				}
				if(this.sg1.getCell(2,2)=="Detail")
				{
					this.nama_report="server_report_saku3_dw_rptDwStudentBodyDetail";
				}
				if(this.sg1.getCell(2,2)=="Proporsi")
				{
					this.nama_report="server_report_saku3_dw_rptDwStudentBodyProporsi";
				}
