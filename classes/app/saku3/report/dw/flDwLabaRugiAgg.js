// JavaScript Document
window.app_saku3_report_dw_flDwLabaRugiAgg = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dw_flDwLabaRugiAgg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dw_flDwLabaRugiAgg";
		this.maximize();
...
window.app_saku3_report_dw_flDwLabaRugiAgg.extend(window.portalui_childForm);
window.app_saku3_report_dw_flDwLabaRugiAgg.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_dw_rptDwLabaRugiAgg";
