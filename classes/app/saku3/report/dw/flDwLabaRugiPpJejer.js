// JavaScript Document
window.app_saku3_report_dw_flDwLabaRugiPpJejer = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dw_flDwLabaRugiPpJejer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dw_flDwLabaRugiPpJejer";
		this.maximize();
...
window.app_saku3_report_dw_flDwLabaRugiPpJejer.extend(window.portalui_childForm);
window.app_saku3_report_dw_flDwLabaRugiPpJejer.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_dw_rptDwLabaRugiPpJejer";
