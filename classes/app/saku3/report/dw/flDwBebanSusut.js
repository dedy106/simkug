// JavaScript Document
window.app_saku3_report_dw_flDwBebanSusut = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dw_flDwBebanSusut.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dw_flDwBebanSusut";
		this.maximize();
...
window.app_saku3_report_dw_flDwBebanSusut.extend(window.portalui_childForm);
window.app_saku3_report_dw_flDwBebanSusut.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_dw_rptDwBebanSusut";
