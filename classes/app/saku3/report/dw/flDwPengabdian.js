// JavaScript Document
window.app_saku3_report_dw_flDwPengabdian = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dw_flDwPengabdian.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dw_flDwPengabdian";
		this.maximize();
...
window.app_saku3_report_dw_flDwPengabdian.extend(window.portalui_childForm);
window.app_saku3_report_dw_flDwPengabdian.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_dw_rptDwPengabdian";
