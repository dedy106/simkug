// JavaScript Document
window.app_saku3_report_dw_flDwLabaRugiPpSharing = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dw_flDwLabaRugiPpSharing.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dw_flDwLabaRugiPpSharing";
		this.maximize();
...
window.app_saku3_report_dw_flDwLabaRugiPpSharing.extend(window.portalui_childForm);
window.app_saku3_report_dw_flDwLabaRugiPpSharing.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_dw_rptDwLabaRugiPpSharing";
