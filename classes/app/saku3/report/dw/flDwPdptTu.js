// JavaScript Document
window.app_saku3_report_dw_flDwPdptTu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dw_flDwPdptTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dw_flDwPdptTu";
		this.maximize();
...
window.app_saku3_report_dw_flDwPdptTu.extend(window.portalui_childForm);
window.app_saku3_report_dw_flDwPdptTu.implement({
