// JavaScript Document
window.app_saku3_report_dw_flDwNeraca = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dw_flDwNeraca.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dw_flDwNeraca";
		this.maximize();
...
window.app_saku3_report_dw_flDwNeraca.extend(window.portalui_childForm);
window.app_saku3_report_dw_flDwNeraca.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_dw_rptDwNeraca";
