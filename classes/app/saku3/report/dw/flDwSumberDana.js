// JavaScript Document
window.app_saku3_report_dw_flDwSumberDana = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dw_flDwSumberDana.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dw_flDwSumberDana";
		this.maximize();
...
window.app_saku3_report_dw_flDwSumberDana.extend(window.portalui_childForm);
window.app_saku3_report_dw_flDwSumberDana.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_dw_rptDwSumberDana";
