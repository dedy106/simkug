// JavaScript Document
window.app_saku3_report_dw_flDwPdptPpJejer = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dw_flDwPdptPpJejer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dw_flDwPdptPpJejer";
		this.maximize();
...
window.app_saku3_report_dw_flDwPdptPpJejer.extend(window.portalui_childForm);
window.app_saku3_report_dw_flDwPdptPpJejer.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_dw_rptDwPdptPpJejer";
