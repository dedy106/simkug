// JavaScript Document
window.app_saku3_report_dw_flDwLabaRugiProdiJejer = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_dw_flDwLabaRugiProdiJejer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_dw_flDwLabaRugiProdiJejer";
		this.maximize();
...
window.app_saku3_report_dw_flDwLabaRugiProdiJejer.extend(window.portalui_childForm);
window.app_saku3_report_dw_flDwLabaRugiProdiJejer.implement({
	doEllipseClick: function(sender, col, row){
		...
		if (row == 4)
		{
			this.filterRep.ListDataSGFilter(this, "Data Prodi",this.sg1, this.sg1.row, this.sg1.col,
													  "select kode_prodi,nama from exs_prodi "+
													  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+
													  " and flag_aktif='1' ",
													  "select count(kode_prodi) from exs_prodi "+
													  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+
													  " and flag_aktif='1' ",
													  new Array("kode_prodi","nama"),"where");
		}
	},
	doSelectCell: function(sender, col, row){
		this.filterRep.setSGFilterRowTipe(this.sg1, row,new Array(0,1,2,3,4),new  Array("123","3","123","3","123"));
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,new Array(0,1,2,3,4),new  Array(2,0,2,0,2));
	...
	mainButtonClick: function(sender){
		try
		{
			...
			if (sender == this.app._mainForm.bBack)
			{
				...
				if (this.link=="3")
				{
					this.doOpenBb(this.kode_akun,this.kode_lokasi,this.periode,this.kode_prodi);
				}
			...
			else
			{
				...
				this.nama_report="server_report_saku3_dw_rptDwLabaRugiProdiJejer";
	...
	doOpenBb: function(kode_akun,kode_lokasi,periode,kode_prodi){
		...
		this.link="2";
		filter2=this.sg1.getCell(2,0)+"/"+periode+"/"+kode_prodi;
		filter="where a.kode_lokasi='"+kode_lokasi+"' and a.kode_akun='"+kode_akun+"' and a.periode='"+periode+"' and a.kode_prodi='"+kode_prodi+"'";
