window.app_saku3_report_yakes21_budget_flBudgetPakai = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_budget_flBudgetPakai.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_budget_flBudgetPakai";
		this.maximize();
...
window.app_saku3_report_yakes21_budget_flBudgetPakai.extend(window.portalui_childForm);
window.app_saku3_report_yakes21_budget_flBudgetPakai.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_yakes21_budget_rptBudgetPakai";
