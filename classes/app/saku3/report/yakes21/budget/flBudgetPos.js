window.app_saku3_report_yakes21_budget_flBudgetPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_budget_flBudgetPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_budget_flBudgetPos";
		this.maximize();
...
window.app_saku3_report_yakes21_budget_flBudgetPos.extend(window.childForm);
window.app_saku3_report_yakes21_budget_flBudgetPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_yakes21_budget_rptBudgetPos";
				this.dbLib.execQuerySync(this.sql);	
