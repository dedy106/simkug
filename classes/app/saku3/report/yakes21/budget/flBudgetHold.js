window.app_saku3_report_yakes21_budget_flBudgetHold = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_budget_flBudgetHold.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_budget_flBudgetHold";
		this.maximize();
...
window.app_saku3_report_yakes21_budget_flBudgetHold.extend(window.childForm);
window.app_saku3_report_yakes21_budget_flBudgetHold.implement({
	doEllipseClick: function(sender, col, row){
		...
		if (row == 2)
		{
			...
			this.filterRep.ListDataSGFilter(this, "Data RRA Anggaran",this.sg1, this.sg1.row, this.sg1.col,sql1,sql2,["a.no_agg","a.keterangan"],"and",["No Anggaran","Keterangan"]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_yakes21_budget_rptBudgetHold";
				this.dbLib.execQuerySync(this.sql);	
