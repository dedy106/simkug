window.app_saku3_report_yakes21_budget_flBudgetKpa = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_budget_flBudgetKpa.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_budget_flBudgetKpa";
		this.maximize();
...
window.app_saku3_report_yakes21_budget_flBudgetKpa.extend(window.portalui_childForm);
window.app_saku3_report_yakes21_budget_flBudgetKpa.implement({
	doEllipseClick: function(sender, col, row){
		...
		if (row == 3)
		{
				...
				if (this.app._userStatus=="A") {
					var sql = "select a.kode_pp,a.nama from pp a where a.kode_lokasi <>'00' ";
					var sql2 = "select count(*) from pp a where a.kode_lokasi <>'00' ";
				}
				else {
					var sql = "select a.kode_pp,a.nama from pp a inner join karyawan_pp b on a.kode_pp=b.kode_pp and a.kode_lokasi<>'00' where b.nik='"+this.app._userLog+"' ";
					var sql2 = "select count(*) from pp a inner join karyawan_pp b on a.kode_pp=b.kode_pp and a.kode_lokasi<>'00' where b.nik='"+this.app._userLog+"' ";
				}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2=this.sg1.getCell(2,5)+"/"+this.sg1.getCell(2,1)+"/"+
							 this.filterRep.filterStr("a.kode_pp",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and")+"/"+
							 this.filterRep.filterStr("a.kode_drk",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4),"and")+"/"+
							 this.filterRep.filterStr("a.periode",this.sg1.getCell(1,6),this.sg1.getCell(2,6),this.sg1.getCell(3,6),"and")+"/"+
							 this.app._nikUser+"/"+this.sg1.getCell(2,7)+"/";
				this.nama_report="server_report_saku3_yakes21_budget_rptBudgetKpa";
