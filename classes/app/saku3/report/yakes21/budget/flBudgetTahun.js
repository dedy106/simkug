window.app_saku3_report_yakes21_budget_flBudgetTahun = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_budget_flBudgetTahun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_budget_flBudgetTahun";
		this.maximize();
...
window.app_saku3_report_yakes21_budget_flBudgetTahun.extend(window.portalui_childForm);
window.app_saku3_report_yakes21_budget_flBudgetTahun.implement({
			...
			var tahun=this.sg1.getCell(2,1).substr(0,4);
				if (this.app._userStatus=="A")
				{
					if (this.app._lokasi == "11"){
							...
							"			where substring(a.periode,1,4)='"+tahun+"' "+filter+" and kode_akun not in ('5213116xxx') "+
							"			group by kode_akun,kode_lokasi "+
							"		   )b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi "+filter2;
				...
				else
				{
					if (this.app._lokasi == "11"){
							var sql="select a.kode_akun, a.nama "+
								...
								"			where b.nik='"+this.app._userLog+"' and substring(a.periode,1,4)='"+tahun+"' "+filter+" and kode_akun not in ('5213116xxx') "+
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.app._nikUser+"/"+this.sg1.getCell(2,5)+"/"+this.sg1.getCell(2,8);	
				if (this.sg1.getCell(2,6)=="Triwulan")
				{
					this.nama_report="server_report_saku3_yakes21_budget_rptBudgetTahunTw";
				}
				
				if (this.sg1.getCell(2,6)=="Bulanan")
				{
					this.nama_report="server_report_saku3_yakes21_budget_rptBudgetTahun";
				}
