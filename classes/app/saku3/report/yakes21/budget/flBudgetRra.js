window.app_saku3_report_yakes21_budget_flBudgetRra = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_budget_flBudgetRra.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_budget_flBudgetRra";
		this.maximize();
...
window.app_saku3_report_yakes21_budget_flBudgetRra.extend(window.childForm);
window.app_saku3_report_yakes21_budget_flBudgetRra.implement({
