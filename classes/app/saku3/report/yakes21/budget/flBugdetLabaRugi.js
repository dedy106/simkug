// JavaScript Document
window.app_saku3_report_yakes21_budget_flBudgetLabaRugi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_budget_flBudgetLabaRugi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_budget_flBudgetLabaRugi";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Kode FS","=",'FS8'));
...
window.app_saku3_report_yakes21_budget_flBudgetLabaRugi.extend(window.portalui_childForm);
window.app_saku3_report_yakes21_budget_flBudgetLabaRugi.implement({
	...
	doSelectCell: function(sender, col, row){
		if (this.app._userStatus == "A") {
			this.filterRep.setSGFilterRowTipe(this.sg1, row,new Array(0,1,2,3,4,5),new  Array("13","123","123","3","3","3"));
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_yakes21_budget_rptBudgetLabaRugi";
