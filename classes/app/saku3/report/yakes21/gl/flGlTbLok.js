window.app_saku3_report_yakes21_gl_flGlTbLok = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_gl_flGlTbLok.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_gl_flGlTbLok";
		this.maximize();
...
window.app_saku3_report_yakes21_gl_flGlTbLok.extend(window.childForm);
window.app_saku3_report_yakes21_gl_flGlTbLok.implement({
