// JavaScript Document
window.app_saku3_report_yakes21_gl_flGlNeracaLok = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_gl_flGlNeracaLok.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_gl_flGlNeracaLok";
		this.maximize();
...
window.app_saku3_report_yakes21_gl_flGlNeracaLok.extend(window.portalui_childForm);
window.app_saku3_report_yakes21_gl_flGlNeracaLok.implement({
