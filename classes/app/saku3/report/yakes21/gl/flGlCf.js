// JavaScript Document
window.app_saku3_report_yakes21_gl_flGlCf = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_gl_flGlCf.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_gl_flGlCf";
		this.maximize();
...
window.app_saku3_report_yakes21_gl_flGlCf.extend(window.portalui_childForm);
window.app_saku3_report_yakes21_gl_flGlCf.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_yakes21_gl_rptGlCf";
