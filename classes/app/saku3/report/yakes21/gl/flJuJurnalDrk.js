// JavaScript Document
window.app_saku3_report_yakes21_gl_flJuJurnalDrk = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_gl_flJuJurnalDrk.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_gl_flJuJurnalDrk";
		this.maximize();
...
window.app_saku3_report_yakes21_gl_flJuJurnalDrk.extend(window.portalui_childForm);
window.app_saku3_report_yakes21_gl_flJuJurnalDrk.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.filter2 = this.sg1.getCell(2,1)+"/"+this.sg1.getCell(1,1)+"/"+this.sg1.getCell(3,1)+"/"+this.sg1.getCell(2,3);
			this.nama_report="server_report_saku3_yakes21_gl_rptJuJurnalDrk";
