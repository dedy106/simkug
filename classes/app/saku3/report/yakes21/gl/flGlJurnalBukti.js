// JavaScript Document
window.app_saku3_report_yakes21_gl_flGlJurnalBukti = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_gl_flGlJurnalBukti.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_gl_flGlJurnalBukti";
		this.maximize();
...
window.app_saku3_report_yakes21_gl_flGlJurnalBukti.extend(window.portalui_childForm);
window.app_saku3_report_yakes21_gl_flGlJurnalBukti.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		this.filterRep.setSGFilterRowTipe(this.sg1, row,new Array(0,1,2,3,4),new  Array("3","123","123","123","123"));
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,new Array(0,1,2,3,4),new  Array(3,0,2,0,2));
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.dbLib.setItemsFromSQL("select distinct modul from gldt_h where kode_lokasi='"+this.app._lokasi+"' order by modul",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
	},
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_yakes21_gl_rptGlJurnalBukti";
