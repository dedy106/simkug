// JavaScript Document
window.app_saku3_report_yakes21_gl_flGlLabaRugi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_gl_flGlLabaRugi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_gl_flGlLabaRugi";
		this.maximize();
...
window.app_saku3_report_yakes21_gl_flGlLabaRugi.extend(window.portalui_childForm);
window.app_saku3_report_yakes21_gl_flGlLabaRugi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_yakes21_gl_rptGlLabaRugi";
