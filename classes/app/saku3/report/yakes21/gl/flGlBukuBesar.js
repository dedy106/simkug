window.app_saku3_report_yakes21_gl_flGlBukuBesar = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_gl_flGlBukuBesar.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_gl_flGlBukuBesar";
		this.maximize();
...
window.app_saku3_report_yakes21_gl_flGlBukuBesar.extend(window.childForm);
window.app_saku3_report_yakes21_gl_flGlBukuBesar.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row == 2)
			{
				...
				if (this.sg1.getCell(2,0)=="") {
					var filter="where kode_lokasi='0' "
				}
	...
	{		
		if (this.app._userStatus=="A" && this.pusat=="1" )
		{
			...
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5],[2,0,2,0,1,0]);	
		}
		else
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5],["3","123","123","123","123","3"]);
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5],[3,0,2,0,1,0]);	
		}
		if (row == 1)
		{
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.app._nikUser+"/"+this.sg1.getCell(2,3)+"/"+var_periode+"/"+this.sg1.getCell(2,5);
				this.nama_report="server_report_saku3_yakes21_gl_rptGlBukuBesar";
