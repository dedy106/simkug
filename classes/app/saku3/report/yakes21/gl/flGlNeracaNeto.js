// JavaScript Document
window.app_saku3_report_yakes21_gl_flGlNeracaNeto = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_gl_flGlNeracaNeto.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_gl_flGlNeracaNeto";
		this.maximize();
...
window.app_saku3_report_yakes21_gl_flGlNeracaNeto.extend(window.portalui_childForm);
window.app_saku3_report_yakes21_gl_flGlNeracaNeto.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_yakes21_gl_rptGlNeracaNeto";
