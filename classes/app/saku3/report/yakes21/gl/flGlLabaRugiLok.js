// JavaScript Document
window.app_saku3_report_yakes21_gl_flGlLabaRugiLok = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_gl_flGlLabaRugiLok.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_gl_flGlLabaRugiLok";
		this.maximize();
...
window.app_saku3_report_yakes21_gl_flGlLabaRugiLok.extend(window.portalui_childForm);
window.app_saku3_report_yakes21_gl_flGlLabaRugiLok.implement({
