// JavaScript Document
window.app_saku3_report_yakes21_gl_flGlNeracaJejer = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_gl_flGlNeracaJejer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_gl_flGlNeracaJejer";
		this.maximize();
...
window.app_saku3_report_yakes21_gl_flGlNeracaJejer.extend(window.portalui_childForm);
window.app_saku3_report_yakes21_gl_flGlNeracaJejer.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_yakes21_gl_rptGlNeracaJejer";
