window.app_saku3_report_yakes21_gl_flGlBukuBesarLok = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_gl_flGlBukuBesarLok.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_gl_flGlBukuBesarLok";
		this.maximize();
...
window.app_saku3_report_yakes21_gl_flGlBukuBesarLok.extend(window.childForm);
window.app_saku3_report_yakes21_gl_flGlBukuBesarLok.implement({
