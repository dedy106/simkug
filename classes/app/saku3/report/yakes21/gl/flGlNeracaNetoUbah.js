// JavaScript Document
window.app_saku3_report_yakes21_gl_flGlNeracaNetoUbah = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_gl_flGlNeracaNetoUbah.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_gl_flGlNeracaNetoUbah";
		this.maximize();
...
window.app_saku3_report_yakes21_gl_flGlNeracaNetoUbah.extend(window.portalui_childForm);
window.app_saku3_report_yakes21_gl_flGlNeracaNetoUbah.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,new Array(0,1,2,3,4),new  Array(3,0,3,0,0));
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_yakes21_gl_rptGlNeracaNetoUbah";
	...
	doOpenTb: function(kode_neraca,kode_lokasi,periode){
		...
		nama_report="server_report_saku3_yakes21_gl_rptGlTb";
