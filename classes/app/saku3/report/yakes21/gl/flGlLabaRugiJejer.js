// JavaScript Document
window.app_saku3_report_yakes21_gl_flGlLabaRugiJejer = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_gl_flGlLabaRugiJejer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_gl_flGlLabaRugiJejer";
		this.maximize();
...
window.app_saku3_report_yakes21_gl_flGlLabaRugiJejer.extend(window.portalui_childForm);
window.app_saku3_report_yakes21_gl_flGlLabaRugiJejer.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_yakes21_gl_rptGlLabaRugiJejer";
	...
	doOpenTb: function(kode_neraca,kode_lokasi,periode){
		...
		this.link="1";
		filter2=kode_lokasi+"/"+this.periode+"/"+this.app._nikUser+"/"+"Tidak/1";
