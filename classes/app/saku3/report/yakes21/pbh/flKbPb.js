// JavaScript Document
window.app_saku3_report_yakes21_pbh_flKbPb = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_pbh_flKbPb.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_pbh_flKbPb";
		this.maximize();
...
window.app_saku3_report_yakes21_pbh_flKbPb.extend(window.portalui_childForm);
window.app_saku3_report_yakes21_pbh_flKbPb.implement({
