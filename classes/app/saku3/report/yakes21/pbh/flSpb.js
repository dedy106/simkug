window.app_saku3_report_yakes21_pbh_flSpb = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_pbh_flSpb.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_pbh_flSpb";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("No Bukti","=",""));
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Jenis Laporan","=","Form SPB"));
...
window.app_saku3_report_yakes21_pbh_flSpb.extend(window.childForm);
window.app_saku3_report_yakes21_pbh_flSpb.implement({
		...
		try{			
			...
			if (row ==2)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data SPB",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_spb, a.keterangan from spb_m a "+filter,
												"select count(a.no_spb) from spb_m a "+filter,
	...
	{		
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("Form SPB","Lampiran","Gabung","SPB"));
		}
	},
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				if (this.sg1.getCell(2,3)=="SPB") {
					this.nama_report = "server_report_saku3_yakes21_pbh_rptSpb2";
				}
				if (this.sg1.getCell(2,3)=="Form SPB") {
					this.nama_report = "server_report_saku3_yakes21_pbh_rptSpbForm";
				}
				if (this.sg1.getCell(2,3)=="Gabung") {
					this.nama_report = "server_report_saku3_yakes21_pbh_rptSpb";
				}
				if (this.sg1.getCell(2,3)=="Lampiran") {
					this.nama_report = "server_report_saku3_yakes21_pbh_rptSpbLampiran";
				}
			...
			systemAPI.alert("[app_saku3_report_yakes21_pbh_flSpb]::mainButtonClick:"+e);
		}
	},
