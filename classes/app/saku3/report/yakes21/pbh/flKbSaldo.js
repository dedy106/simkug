// JavaScript Document
window.app_saku3_report_yakes21_pbh_flKbSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_pbh_flKbSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_pbh_flKbSaldo";
		this.maximize();
...
window.app_saku3_report_yakes21_pbh_flKbSaldo.extend(window.portalui_childForm);
window.app_saku3_report_yakes21_pbh_flKbSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_yakes21_pbh_rptKbSaldo";
				this.dbLib.execQuerySync(this.sql);	
	...
	doOpenBb: function(kode_akun,kode_lokasi){
		...
		nama_report="server_report_saku3_yakes21_pbh_rptKbBuku";
	...
	doOpenJurnal: function(no_bukti,kode_lokasi){
		...
		filter2="";
		nama_report="server_report_saku3_yakes21_pbh_rptKbJurnal";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
