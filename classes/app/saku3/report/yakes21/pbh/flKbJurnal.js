// JavaScript Document
window.app_saku3_report_yakes21_pbh_flKbJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_pbh_flKbJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_pbh_flKbJurnal";
		this.maximize();
...
window.app_saku3_report_yakes21_pbh_flKbJurnal.extend(window.portalui_childForm);
window.app_saku3_report_yakes21_pbh_flKbJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_yakes21_pbh_rptKbJurnal";
