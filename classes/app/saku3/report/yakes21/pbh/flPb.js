window.app_saku3_report_yakes21_pbh_flPb = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_pbh_flPb.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_pbh_flPb";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("Jenis Laporan","=","Form"));
...
window.app_saku3_report_yakes21_pbh_flPb.extend(window.childForm);
window.app_saku3_report_yakes21_pbh_flPb.implement({
		...
		try{			
			...
			if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data PB",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_pb, a.keterangan from pbh_pb_m a "+filter,
												"select count(a.no_pb) from pbh_pb_m a "+filter,
	...
	{		
		...
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5],["123","123","3","123","3","3"]);
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5],[2,0,2,2,0,0]);
		}
		if (row == 1)
		{
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("Form","SPP"));
		}
		if (row == 5)
		{
			this.sg1.columns.get(2).pickList.clear();
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				if (this.sg1.getCell(2,4)=="SPP") {
					this.nama_report = "server_report_saku3_yakes21_pbh_rptPbSpp";
				}
			...
			systemAPI.alert("[app_saku3_report_yakes21_pbh_flPb]::mainButtonClick:"+e);
		}
	},
