window.app_saku3_report_yakes21_flTesDakemApi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_flTesDakemApi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_flTesDakemApi";
        this.maximize();
...
window.app_saku3_report_yakes21_flTesDakemApi.extend(window.childForm);
window.app_saku3_report_yakes21_flTesDakemApi.implement({
	doLoad:function(){
        try{
			...
			this.report = new server_report_report();
			var nama_report="server_report_saku3_yakes21_rptTesDakemApi";
			this.filter="";
			this.showFilter = "";
			this.lokasi = "";
