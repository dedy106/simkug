window.app_saku3_report_yakes21_spj_flSpjForm2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_spj_flSpjForm2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_spj_flSpjForm2";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,5,new Array(0,1,2), new Array("Jenis SPPD","=","Biaya"));
...
window.app_saku3_report_yakes21_spj_flSpjForm2.extend(window.childForm);
window.app_saku3_report_yakes21_spj_flSpjForm2.implement({
		...
		try{			
			...
			if (row ==4)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data SPJ",this.sg1, this.sg1.row, this.sg1.col,
												...
												"inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+this.filter + "  and a.modul='PD21' ",
												
												"select count(*) from "+
												"yk_spj_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+this.filter+"  and a.modul='PD21' ",												
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				if (this.sg1.getCell(2,5)=="Biaya")
				{
					this.nama_report = "server_report_saku3_yakes21_spj_rptSpjForm";
				}
			...
			systemAPI.alert("[app_saku3_report_yakes21_spj_flSpjForm2]::mainButtonClick:"+e);
		}
	},
