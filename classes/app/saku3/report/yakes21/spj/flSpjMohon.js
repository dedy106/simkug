window.app_saku3_report_yakes21_spj_flSpjMohon = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_spj_flSpjMohon.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_spj_flSpjMohon";
		this.maximize();
...
window.app_saku3_report_yakes21_spj_flSpjMohon.extend(window.childForm);
window.app_saku3_report_yakes21_spj_flSpjMohon.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				{
					this.nama_report = "server_report_saku3_yakes21_spj_rptSpjTerbit";
				}
			...
			systemAPI.alert("[app_saku3_report_yakes21_spj_flSpjMohon]::mainButtonClick:"+e);
		}
	},
