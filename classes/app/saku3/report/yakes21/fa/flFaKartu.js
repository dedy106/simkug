window.app_saku3_report_yakes21_fa_flFaKartuTu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_fa_flFaKartuTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_fa_flFaKartuTu";
		this.maximize();
...
window.app_saku3_report_yakes21_fa_flFaKartuTu.extend(window.childForm);
window.app_saku3_report_yakes21_fa_flFaKartuTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_yakes21_fa_rptFaKartu";
