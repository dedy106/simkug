window.app_saku3_report_yakes21_if_flIfForm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_if_flIfForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_if_flIfForm";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("No IF","=",""));
...
window.app_saku3_report_yakes21_if_flIfForm.extend(window.childForm);
window.app_saku3_report_yakes21_if_flIfForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_yakes21_if_flIfForm]::mainButtonClick:"+e);
		}
	},
