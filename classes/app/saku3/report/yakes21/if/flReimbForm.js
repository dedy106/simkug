window.app_saku3_report_yakes21_if_flReimbForm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_if_flReimbForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_if_flReimbForm";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("No Bukti","=",""));
...
window.app_saku3_report_yakes21_if_flReimbForm.extend(window.childForm);
window.app_saku3_report_yakes21_if_flReimbForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_yakes21_if_rptReimbForm";
			...
			systemAPI.alert("[app_saku3_report_yakes21_if_flReimbForm]::mainButtonClick:"+e);
		}
	},
