window.app_saku3_report_yakes21_if_flIfPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_if_flIfPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_if_flIfPos";
		this.maximize();
...
window.app_saku3_report_yakes21_if_flIfPos.extend(window.childForm);
window.app_saku3_report_yakes21_if_flIfPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_yakes21_if_rptIfPos";
			...
			systemAPI.alert("[app_saku3_report_yakes21_if_flIfPos]::mainButtonClick:"+e);
		}
	},
