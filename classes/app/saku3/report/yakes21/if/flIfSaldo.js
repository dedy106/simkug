window.app_saku3_report_yakes21_if_flIfSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_if_flIfSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_if_flIfSaldo";
		this.maximize();
...
window.app_saku3_report_yakes21_if_flIfSaldo.extend(window.childForm);
window.app_saku3_report_yakes21_if_flIfSaldo.implement({
		...
		try{			
			...
			if (row == 3)
			{
				this.filterRep.ListDataSGFilter(this, "Data Karyawan",this.sg1, this.sg1.row, this.sg1.col,
															"select distinct a.nik_if,b.nama "+
															"from if_aju_m a "+
															"inner join karyawan b on a.nik_if=b.nik   "+
														   this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  "select count(a.nik_if) "+
															"from if_aju_m a "+
															"inner join karyawan b on a.nik_if=b.nik "+
														  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  new Array("nik_if","nama"),"and");
			}
			if (row ==4)
			{
				this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.nik_if",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and")+
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_yakes21_if_rptIfSaldo";
			...
			systemAPI.alert("[app_saku3_report_yakes21_if_flIfSaldo]::mainButtonClick:"+e);
		}
	},
