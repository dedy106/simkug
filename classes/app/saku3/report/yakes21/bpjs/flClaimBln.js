window.app_saku3_report_yakes21_bpjs_flClaimBln = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_bpjs_flClaimBln.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_bpjs_flClaimBln";
		this.maximize();
...
window.app_saku3_report_yakes21_bpjs_flClaimBln.extend(window.childForm);
window.app_saku3_report_yakes21_bpjs_flClaimBln.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_yakes21_bpjs_rptClTotalb";
				
				if (this.sg1.getCell(2,2)=="Pegawai")
				{
					this.nama_report = "server_report_saku3_yakes21_bpjs_rptClPegawaib";
				}
				if (this.sg1.getCell(2,2)=="Pensiun")
				{
					this.nama_report = "server_report_saku3_yakes21_bpjs_rptClPensiunb";
				}
			...
			systemAPI.alert("[app_saku3_report_yakes21_bpjs_flClaimBln]::mainButtonClick:"+e);
		}
	},
