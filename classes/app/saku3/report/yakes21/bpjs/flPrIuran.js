window.app_saku3_report_yakes21_bpjs_flPrIuran = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_bpjs_flPrIuran.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_bpjs_flPrIuran";
		this.maximize();
...
window.app_saku3_report_yakes21_bpjs_flPrIuran.extend(window.childForm);
window.app_saku3_report_yakes21_bpjs_flPrIuran.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_yakes21_bpjs_rptPrRinci";
				
				if (this.sg1.getCell(2,2)=="Pegawai")
				{
					this.nama_report = "server_report_saku3_yakes21_bpjs_rptPrPegawai";
				}
				if (this.sg1.getCell(2,2)=="Pensiun")
				{
					this.nama_report = "server_report_saku3_yakes21_bpjs_rptPrPensiun";
				}
			...
			systemAPI.alert("[app_saku3_report_yakes21_bpjs_flPrIuran]::mainButtonClick:"+e);
		}
	},
