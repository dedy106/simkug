window.app_saku3_report_yakes21_panjar_flPjSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_panjar_flPjSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_panjar_flPjSaldo";
		this.maximize();
...
window.app_saku3_report_yakes21_panjar_flPjSaldo.extend(window.childForm);
window.app_saku3_report_yakes21_panjar_flPjSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_yakes21_panjar_rptPjSaldo";
			...
			systemAPI.alert("[app_saku3_report_yakes21_panjar_flPjSaldo]::mainButtonClick:"+e);
		}
	},
