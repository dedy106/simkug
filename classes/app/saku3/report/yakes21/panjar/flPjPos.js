window.app_saku3_report_yakes21_panjar_flPjPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_panjar_flPjPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_panjar_flPjPos";
		this.maximize();
...
window.app_saku3_report_yakes21_panjar_flPjPos.extend(window.childForm);
window.app_saku3_report_yakes21_panjar_flPjPos.implement({
		...
		try{			
			...
			if (row ==4)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Panjar",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_panjar, a.keterangan from panjar2_m a where substring(a.kode_pp,3,1)='"+this.app._kodeBidang+"' "+this.filter,
												"select count(*) from panjar2_m a where substring(a.kode_pp,3,1)='"+this.app._kodeBidang+"' "+this.filter,
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_yakes21_panjar_rptPjPos";
			...
			systemAPI.alert("[app_saku3_report_yakes21_panjar_flPjPos]::mainButtonClick:"+e);
		}
	},
