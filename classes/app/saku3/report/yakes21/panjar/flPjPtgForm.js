window.app_saku3_report_yakes21_panjar_flPjPtgForm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_panjar_flPjPtgForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_panjar_flPjPtgForm";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("No Panjar","=",""));
...
window.app_saku3_report_yakes21_panjar_flPjPtgForm.extend(window.childForm);
window.app_saku3_report_yakes21_panjar_flPjPtgForm.implement({
		...
		try{			
			...
			if (row ==4)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Panjar",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_ptg, a.keterangan from panjarptg2_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+this.filter,
												"select count(*) from panjarptg2_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+this.filter,
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.filter = this.filter + " and substring(a.kode_pp,3,1)='"+this.app._kodeBidang+"' ";						
				this.filter2 = this.sg1.getCell(2,1)+"/";
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku3_yakes21_panjar_rptPjPtgForm";
			...
			systemAPI.alert("[app_saku3_report_yakes21_panjar_flPjPtgForm]::mainButtonClick:"+e);
		}
	},
