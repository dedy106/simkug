window.app_saku3_report_yakes21_piutang_flBillingHutangPeriode = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_piutang_flBillingHutangPeriode.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_piutang_flBillingHutangPeriode";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Jenis","=","BPCCGR"));
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Tampilan Laporan","=","Excell"));
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
	this.doSelectCell(this.sg1,2,3);
};
window.app_saku3_report_yakes21_piutang_flBillingHutangPeriode.extend(window.childForm);
window.app_saku3_report_yakes21_piutang_flBillingHutangPeriode.implement({
	...
	{		
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("BPCCGR","BP","CC","GR","BPTLKM"));
		}
		if (row == 3)
		{
			this.sg1.columns.get(2).pickList.clear();
	...
	mainButtonClick: function(sender){
		try
		{
			...
			}else
			{
				...
				this.filter2 = this.app._nikUser+"/"+this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,2)+"/"+this.sg1.getCell(2,3);
