window.app_saku3_report_yakes21_piutang_flTagihanNik = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_piutang_flTagihanNik.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_piutang_flTagihanNik";
		this.maximize();
	...
	this.nb=this.dbLib.getPeriodeFromSQL("select max(no_hutang) as periode from yk_hutang_m where kode_lokasi='"+this.app._lokasi+"'");
	...
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("No Hutang","=",this.nb));
...
window.app_saku3_report_yakes21_piutang_flTagihanNik.extend(window.childForm);
window.app_saku3_report_yakes21_piutang_flTagihanNik.implement({
		...
		try{			
			...
			if (row ==4)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Approve Hutang",this.sg1, this.sg1.row, this.sg1.col,
												...
												new Array("no_hutang","keterangan"),"and",new Array("No Approve","Keterangan"));
			}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			}else
			{
				...
				var bank=this.filterRep.filterStr("e.bank_trans",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and");
				this.nama_report="server_report_saku3_yakes21_piutang_rptTagihanNik";
