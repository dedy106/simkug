window.app_saku3_report_yakes21_piutang_flHutangKesSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_piutang_flHutangKesSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_piutang_flHutangKesSaldo";
		this.maximize();
...
window.app_saku3_report_yakes21_piutang_flHutangKesSaldo.extend(window.childForm);
window.app_saku3_report_yakes21_piutang_flHutangKesSaldo.implement({
		...
		try{			
			...
			if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Invoice",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_hutang, a.keterangan from yk_hutang_m a "+filter,
												"select count(b.no_hutang) from yk_hutang_m a "+filter,
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_yakes21_piutang_rptHutangKesSaldo";
			...
			systemAPI.alert("[app_saku3_report_yakes21_piutang_flHutangKesSaldo]::mainButtonClick:"+e);
		}
	},
