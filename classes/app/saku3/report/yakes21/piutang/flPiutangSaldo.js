window.app_saku3_report_yakes21_piutang_flPiutangSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_piutang_flPiutangSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_piutang_flPiutangSaldo";
		this.maximize();
...
window.app_saku3_report_yakes21_piutang_flPiutangSaldo.extend(window.childForm);
window.app_saku3_report_yakes21_piutang_flPiutangSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_yakes21_piutang_rptPiutangSaldo";
			...
			systemAPI.alert("[app_saku3_report_yakes21_piutang_flPiutangSaldo]::mainButtonClick:"+e);
		}
	},
