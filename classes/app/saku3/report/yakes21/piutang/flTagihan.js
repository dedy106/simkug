window.app_saku3_report_yakes21_piutang_flTagihan = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_piutang_flTagihan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_piutang_flTagihan";
		this.maximize();
...
window.app_saku3_report_yakes21_piutang_flTagihan.extend(window.childForm);
window.app_saku3_report_yakes21_piutang_flTagihan.implement({
		...
		try{			
			...
			{				
				...
				this.filterRep.ListDataSGFilter(this, "Data Approve Hutang",this.sg1, this.sg1.row, this.sg1.col,
												...
												new Array("no_hutang","keterangan"),"and",new Array("No Bukti","Keterangan"));
			}
	...
	{		
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("MANDIRI","BNI","BRI","X-MANDIRI"));
		}
		if (row == 5)
		{
			this.sg1.columns.get(2).pickList.clear();
	...
	mainButtonClick: function(sender){
		try
		{
			...
			}else
			{
				...
				this.nama_report="server_report_saku3_yakes21_piutang_rptTagihan";
