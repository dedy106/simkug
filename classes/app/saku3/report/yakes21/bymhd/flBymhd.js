window.app_saku3_report_yakes21_bymhd_flBymhd = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_bymhd_flBymhd.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_bymhd_flBymhd";
		this.maximize();
...
window.app_saku3_report_yakes21_bymhd_flBymhd.extend(window.childForm);
window.app_saku3_report_yakes21_bymhd_flBymhd.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_yakes21_bymhd_rptBymhd";
			...
			systemAPI.alert("[app_saku3_report_yakes21_bymhd_flBymhd]::mainButtonClick:"+e);
		}
	},
