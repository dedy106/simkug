window.app_saku3_report_yakes21_bymhd_flBymhdPos = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_yakes21_bymhd_flBymhdPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_yakes21_bymhd_flBymhdPos";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("No Bukti PB","=",""));
...
window.app_saku3_report_yakes21_bymhd_flBymhdPos.extend(window.childForm);
window.app_saku3_report_yakes21_bymhd_flBymhdPos.implement({
		...
		try{			
			...
			if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Pengajuan",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_hutang, a.keterangan from pbh_pb_m a "+this.filter,
												"select count(*) from pbh_pb_m a "+this.filter,
												new Array("a.no_hutang","a.keterangan"),"and",new Array("No Bukti","Keterangan"));
			}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_yakes21_bymhd_rptBymhdPos";
			...
			systemAPI.alert("[app_saku3_report_yakes21_bymhd_flBymhdPos]::mainButtonClick:"+e);
		}
	},
