window.app_saku3_report_piutang_flHutangKesSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_piutang_flHutangKesSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_piutang_flHutangKesSaldo";
		this.maximize();
...
window.app_saku3_report_piutang_flHutangKesSaldo.extend(window.childForm);
window.app_saku3_report_piutang_flHutangKesSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_piutang_rptHutangKesSaldo";
			...
			systemAPI.alert("[app_saku3_report_piutang_flHutangKesSaldo]::mainButtonClick:"+e);
		}
	},
