window.app_saku3_report_piutang_flBillingBast = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_piutang_flBillingBast.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_piutang_flBillingBast";
		this.maximize();
...
window.app_saku3_report_piutang_flBillingBast.extend(window.childForm);
window.app_saku3_report_piutang_flBillingBast.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			}else
			{
				...
				this.nama_report="server_report_saku3_piutang_rptBillingBast";
