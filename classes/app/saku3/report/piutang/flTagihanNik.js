window.app_saku3_report_piutang_flTagihanNik = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_piutang_flTagihanNik.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_piutang_flTagihanNik";
		this.maximize();
...
window.app_saku3_report_piutang_flTagihanNik.extend(window.childForm);
window.app_saku3_report_piutang_flTagihanNik.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			}else
			{
				...
				this.nama_report="server_report_saku3_piutang_rptTagihanNik";
