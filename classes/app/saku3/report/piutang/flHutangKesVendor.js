window.app_saku3_report_piutang_flHutangKesVendor = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_piutang_flHutangKesVendor.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_piutang_flHutangKesVendor";
		this.maximize();
...
window.app_saku3_report_piutang_flHutangKesVendor.extend(window.childForm);
window.app_saku3_report_piutang_flHutangKesVendor.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_piutang_rptHutangKesVendor";
			...
			systemAPI.alert("[app_saku3_report_piutang_flHutangKesVendor]::mainButtonClick:"+e);
		}
	},
