window.app_saku3_report_piutang_flBillingHutangPeriode = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_piutang_flBillingHutangPeriode.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_piutang_flBillingHutangPeriode";
		this.maximize();
...
window.app_saku3_report_piutang_flBillingHutangPeriode.extend(window.childForm);
window.app_saku3_report_piutang_flBillingHutangPeriode.implement({
