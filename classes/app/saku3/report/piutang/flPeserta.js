window.app_saku3_report_piutang_flPeserta = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_piutang_flPeserta.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_piutang_flPeserta";
		this.maximize();
...
window.app_saku3_report_piutang_flPeserta.extend(window.childForm);
window.app_saku3_report_piutang_flPeserta.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_piutang_rptPeserta";
			...
			systemAPI.alert("[app_saku3_report_piutang_flPeserta]::mainButtonClick:"+e);
		}
	},
