window.app_saku3_report_fitnes_flRekap = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_fitnes_flRekap.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_fitnes_flRekap";
		this.maximize();
...
window.app_saku3_report_fitnes_flRekap.extend(window.childForm);
window.app_saku3_report_fitnes_flRekap.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_fitnes_rptRekap";
