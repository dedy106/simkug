window.app_saku3_report_fitnes_flJualKupon = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_fitnes_flJualKupon.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_fitnes_flJualKupon";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from kas_m where kode_lokasi='"+this.app._lokasi+"' and modul='KBVOC' ");
...
window.app_saku3_report_fitnes_flJualKupon.extend(window.childForm);
window.app_saku3_report_fitnes_flJualKupon.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_fitnes_rptJualKupon";
