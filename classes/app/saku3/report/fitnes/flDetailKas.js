window.app_saku3_report_fitnes_flDetailKas = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_fitnes_flDetailKas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_fitnes_flDetailKas";
		this.maximize();
...
window.app_saku3_report_fitnes_flDetailKas.extend(window.childForm);
window.app_saku3_report_fitnes_flDetailKas.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_fitnes_rptDetailKas";
