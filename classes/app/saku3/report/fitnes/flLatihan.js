window.app_saku3_report_fitnes_flLatihan = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_fitnes_flLatihan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_fitnes_flLatihan";
		this.maximize();
...
window.app_saku3_report_fitnes_flLatihan.extend(window.childForm);
window.app_saku3_report_fitnes_flLatihan.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_fitnes_rptLatihan";
