window.app_saku3_report_fitnes_flJurnalJual = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_fitnes_flJurnalJual.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_fitnes_flJurnalJual";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from kas_m where modul='KBVOC'  ");
...
window.app_saku3_report_fitnes_flJurnalJual.extend(window.childForm);
window.app_saku3_report_fitnes_flJurnalJual.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_fitnes_rptJurnalJual";
			...
			systemAPI.alert("[app_saku3_report_fitnes_flJurnalJual]::mainButtonClick:"+e);
		}
	},
