window.app_saku3_report_fitnes_flHadir = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_fitnes_flHadir.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_fitnes_flHadir";
		this.maximize();
...
window.app_saku3_report_fitnes_flHadir.extend(window.childForm);
window.app_saku3_report_fitnes_flHadir.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_fitnes_rptHadir";
