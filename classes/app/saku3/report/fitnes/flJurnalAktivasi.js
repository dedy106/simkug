window.app_saku3_report_fitnes_flJurnalAktivasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_fitnes_flJurnalAktivasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_fitnes_flJurnalAktivasi";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from ju_m where modul='JUKUPON'  ");
...
window.app_saku3_report_fitnes_flJurnalAktivasi.extend(window.childForm);
window.app_saku3_report_fitnes_flJurnalAktivasi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_fitnes_rptJurnalAktivasi";
			...
			systemAPI.alert("[app_saku3_report_fitnes_flJurnalAktivasi]::mainButtonClick:"+e);
		}
	},
