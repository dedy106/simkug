window.app_saku3_report_fitnes_flJurnalExpire = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_fitnes_flJurnalExpire.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_fitnes_flJurnalExpire";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from ju_m where modul='JUEXP'  ");
...
window.app_saku3_report_fitnes_flJurnalExpire.extend(window.childForm);
window.app_saku3_report_fitnes_flJurnalExpire.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_fitnes_rptJurnalExpire";
			...
			systemAPI.alert("[app_saku3_report_fitnes_flJurnalExpire]::mainButtonClick:"+e);
		}
	},
