window.app_saku3_report_fitnes_flDetail = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_fitnes_flDetail.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_fitnes_flDetail";
		this.maximize();
...
window.app_saku3_report_fitnes_flDetail.extend(window.childForm);
window.app_saku3_report_fitnes_flDetail.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_fitnes_rptDetail";
