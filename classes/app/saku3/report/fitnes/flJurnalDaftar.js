window.app_saku3_report_fitnes_flJurnalDaftar = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_fitnes_flJurnalDaftar.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_fitnes_flJurnalDaftar";
		this.maximize();
...
window.app_saku3_report_fitnes_flJurnalDaftar.extend(window.childForm);
window.app_saku3_report_fitnes_flJurnalDaftar.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_fitnes_rptJurnalDaftar";
			...
			systemAPI.alert("[app_saku3_report_fitnes_flJurnalDaftar]::mainButtonClick:"+e);
		}
	},
