// JavaScript Document
window.app_saku3_report_gl_flGlJurnalTm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlJurnalTm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlJurnalTm";
		this.maximize();
...
window.app_saku3_report_gl_flGlJurnalTm.extend(window.portalui_childForm);
window.app_saku3_report_gl_flGlJurnalTm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_gl_rptGlJurnalTm";
			if (this.sg1.getCell(2,5)=="Tidak")
			{
				this.nama_report="server_report_saku3_gl_rptGlJurnalTm2";
			}
