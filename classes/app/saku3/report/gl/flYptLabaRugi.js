// JavaScript Document
window.app_saku3_report_gl_flYptLabaRugi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flYptLabaRugi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flYptLabaRugi";
		this.maximize();
...
window.app_saku3_report_gl_flYptLabaRugi.extend(window.portalui_childForm);
window.app_saku3_report_gl_flYptLabaRugi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptYptLabaRugi";
				if (this.sg1.getCell(2,4)=="Detail")
				{
					this.nama_report="server_report_saku3_gl_rptYptLabaRugiDetail";
				}
