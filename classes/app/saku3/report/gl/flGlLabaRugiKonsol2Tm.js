// JavaScript Document
window.app_saku3_report_gl_flGlLabaRugiKonsol2Tm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlLabaRugiKonsol2Tm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlLabaRugiKonsol2Tm";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Periode Pembanding","=",this.periode));
...
window.app_saku3_report_gl_flGlLabaRugiKonsol2Tm.extend(window.portalui_childForm);
window.app_saku3_report_gl_flGlLabaRugiKonsol2Tm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				var in_lap="S";
				this.filter2 = this.nik_user+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,3)+"/"+this.sg1.getCell(2,2);
				
				this.nama_report="server_report_saku3_gl_rptGlLabaRugiKonsol2Tm";
