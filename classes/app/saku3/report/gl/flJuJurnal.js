// JavaScript Document
window.app_saku3_report_gl_flJuJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flJuJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flJuJurnal";
		this.maximize();
...
window.app_saku3_report_gl_flJuJurnal.extend(window.portalui_childForm);
window.app_saku3_report_gl_flJuJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_gl_rptJuJurnal";
