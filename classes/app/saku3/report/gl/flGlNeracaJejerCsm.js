window.app_saku3_report_gl_flGlNeracaJejerCsm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlNeracaJejerCsm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlNeracaJejerCsm";
		this.maximize();
...
window.app_saku3_report_gl_flGlNeracaJejerCsm.extend(window.childForm);
window.app_saku3_report_gl_flGlNeracaJejerCsm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlNeracaJejerCsm";
