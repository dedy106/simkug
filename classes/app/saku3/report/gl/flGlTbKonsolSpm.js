window.app_saku3_report_gl_flGlTbKonsolSpm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlTbKonsolSpm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlTbKonsolSpm";
		this.maximize();
...
window.app_saku3_report_gl_flGlTbKonsolSpm.extend(window.childForm);
window.app_saku3_report_gl_flGlTbKonsolSpm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlTbKonsolSpm";
