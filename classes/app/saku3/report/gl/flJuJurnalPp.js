// JavaScript Document
window.app_saku3_report_gl_flJuJurnalPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flJuJurnalPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flJuJurnalPp";
		this.maximize();
...
window.app_saku3_report_gl_flJuJurnalPp.extend(window.portalui_childForm);
window.app_saku3_report_gl_flJuJurnalPp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_gl_rptJuJurnalPp";
