window.app_saku3_report_gl_flGlBukuBesarSimulasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlBukuBesarSimulasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlBukuBesarSimulasi";
		this.maximize();
...
window.app_saku3_report_gl_flGlBukuBesarSimulasi.extend(window.childForm);
window.app_saku3_report_gl_flGlBukuBesarSimulasi.implement({
	...
	{		
		if (this.app._userStatus=="A")
		{
			...
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5,6],[2,0,2,0,1,0,0,0]);	
		}
		else
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6],["3","123","123","123","123","3","3"]);
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5,6],[3,0,2,0,1,0,0]);	
		}
		if (row == 1)
		{
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlBukuBesarSimulasi";
