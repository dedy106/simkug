window.app_saku3_report_gl_flGlTbSpm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlTbSpm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlTbSpm";
		this.maximize();
...
window.app_saku3_report_gl_flGlTbSpm.extend(window.childForm);
window.app_saku3_report_gl_flGlTbSpm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlTbSpm";
