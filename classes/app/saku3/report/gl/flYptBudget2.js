// JavaScript Document
window.app_saku3_report_gl_flYptBudget2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flYptBudget2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flYptBudget2";
		this.maximize();
...
window.app_saku3_report_gl_flYptBudget2.extend(window.portalui_childForm);
window.app_saku3_report_gl_flYptBudget2.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptYptBudget2";
				if (this.sg1.getCell(2,4)=="Detail")
				{
					this.nama_report="server_report_saku3_gl_rptYptBudgetDetail2";
				}
