window.app_saku3_report_gl_flGlLabaRugiJejerYks2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlLabaRugiJejerYks2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlLabaRugiJejerYks2";
		this.maximize();
...
window.app_saku3_report_gl_flGlLabaRugiJejerYks2.extend(window.childForm);
window.app_saku3_report_gl_flGlLabaRugiJejerYks2.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlLabaRugiJejerYks2";
