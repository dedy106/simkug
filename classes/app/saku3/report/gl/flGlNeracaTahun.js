// JavaScript Document
window.app_saku3_report_gl_flGlNeracaTahun = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlNeracaTahun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlNeracaTahun";
		this.maximize();
...
window.app_saku3_report_gl_flGlNeracaTahun.extend(window.portalui_childForm);
window.app_saku3_report_gl_flGlNeracaTahun.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlNeracaTahun";
