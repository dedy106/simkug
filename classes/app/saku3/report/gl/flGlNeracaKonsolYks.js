// JavaScript Document
window.app_saku3_report_gl_flGlNeracaKonsolYks = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlNeracaKonsolYks.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlNeracaKonsolYks";
		this.maximize();
...
window.app_saku3_report_gl_flGlNeracaKonsolYks.extend(window.portalui_childForm);
window.app_saku3_report_gl_flGlNeracaKonsolYks.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlNeracaKonsolYks";
				if (this.sg1.getCell(2,4)=="Detail")
				{
					this.nama_report="server_report_saku3_gl_rptGlNeracaDetailKonsolYks";
				}
