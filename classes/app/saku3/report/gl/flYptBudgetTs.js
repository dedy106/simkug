// JavaScript Document
window.app_saku3_report_gl_flYptBudgetTs = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flYptBudgetTs.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flYptBudgetTs";
		this.maximize();
...
window.app_saku3_report_gl_flYptBudgetTs.extend(window.portalui_childForm);
window.app_saku3_report_gl_flYptBudgetTs.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptYptBudgetTs";
				if (this.sg1.getCell(2,4)=="Detail")
				{
					this.nama_report="server_report_saku3_gl_rptYptBudgetDetailTs";
				}
