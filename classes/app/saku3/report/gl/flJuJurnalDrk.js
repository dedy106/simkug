// JavaScript Document
window.app_saku3_report_gl_flJuJurnalDrk = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flJuJurnalDrk.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flJuJurnalDrk";
		this.maximize();
...
window.app_saku3_report_gl_flJuJurnalDrk.extend(window.portalui_childForm);
window.app_saku3_report_gl_flJuJurnalDrk.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_gl_rptJuJurnalDrk";
