// JavaScript Document
window.app_saku3_report_gl_flYptPdptGrafik = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flYptPdptGrafik.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flYptPdptGrafik";
		this.maximize();
		...
		this.pg1 = new pageControl(this,{bound:[0,0,this.width - 20, this.height -30], childPage:["Filter","Pendapatan YPT Group","Beban YPT Group","Pendapatan Group Sekolah","Beban Group Sekolah","Pendapatan Sekolah","Beban Sekolah","Budget Commitee"], pageChange:[this,"doPageChange"]});
		...
		this.viewer = new reportViewer(this.pg1.childPage[7],{bound:[0,0,this.width - 35, this.height - 35]});
		//this.viewer2 = new reportViewer(this.pg1.childPage[5],{bound:[0,0,this.width - 35, this.height - 35]});
	...
	try{
		...
		this.chart = new highchart(this.pg1.childPage[1],{bound:[0,0,this.width - 25, this.height - 30]});
		this.chart2 = new highchart(this.pg1.childPage[2],{bound:[0,0,this.width - 25, this.height - 30]});
		this.chart3 = new highchart(this.pg1.childPage[3],{bound:[0,0,this.width - 25, this.height - 30]});
		this.chart4 = new highchart(this.pg1.childPage[4],{bound:[0,0,this.width - 25, this.height - 30]});
		this.chart5 = new highchart(this.pg1.childPage[5],{bound:[0,0,this.width - 25, this.height - 30]});
		this.chart6 = new highchart(this.pg1.childPage[6],{bound:[0,0,this.width - 25, this.height - 30]});
	}catch(e){
		alert(e);
	}
};
window.app_saku3_report_gl_flYptPdptGrafik.extend(window.portalui_childForm);
window.app_saku3_report_gl_flYptPdptGrafik.implement({
	doEllipseClick: function(sender, col, row){
		...
		if (row == 2)
		{
			var filter=this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
						" and a.kode_flag='01' ";
			var sql="select a.kode_akun,b.nama "+
				"from exs_flag_akun a "+
				"inner join masakun b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi "+filter;
			var sql2="select count(a.kode_akun) "+
				"from exs_flag_akun a "+
				"inner join masakun b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi "+filter;	
			this.filterRep.ListDataSGFilter(this, "Data Akun",this.sg1, this.sg1.row, this.sg1.col,sql,sql2,new Array("a.kode_akun","a.nama"),"and",new Array("Kode Akun","Nama"));
		}
	},
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_gl_rptYptBudget";
		...
		//	this.app._mainForm.reportNavigator.rearrange();
			...
			sql="exec sp_ypt_budget_ba '"+this.sg1.getCell(2,0)+"','"+this.sg1.getCell(2,1)+"','"+this.app._nikUser+"'";
				this.dbLib.execQuerySync(sql);	
			
			
			//this.nama=this.dbLib.getPeriodeFromSQL("select nama as periode from masakun where kode_akun='"+this.sg1.getCell(2,2)+"' and kode_lokasi='"+this.sg1.getCell(2,0)+"'");
			var sql = "select a.kode_lokasi,c.nama,isnull(b.n2,0) as n2,isnull(b.n4,0) as n4 "+
					"from ypt_lokasi a "+
					"inner join (select b.kode_lok,sum(a.n2) as n2,sum(a.n6*-1)as n4 "+
					"			from ypt_budget_ba a "+
					"			inner join ypt_ba b on a.kode_ba=b.kode_ba and a.kode_lokasi=b.kode_lokasi "+
					"			where a.nik_user='"+this.app._nikUser+"' and a.jenis='P' "+
					"			group by b.kode_lok "+
					"			)b on a.kode_lokasi=b.kode_lok "+
					"inner join lokasi c on a.kode_lokasi=c.kode_lokasi "+
					"order by a.kode_lokasi";
			this.nama="Pendapatan YPT Group";
			...
			for (var i = 0; i < data.rs.rows.length; i++){
				var line = data.rs.rows[i];
					...
					this.dataCategories.push(line.kode_lokasi);
			...
			var options = {
				...
				var sql = "select a.kode_lokasi,c.nama,isnull(b.n2,0) as n2,isnull(b.n4,0) as n4 "+
					"from ypt_lokasi a "+
					"inner join (select b.kode_lok,sum(a.n2) as n2,sum(a.n6)as n4 "+
					"			from ypt_budget_ba a "+
					"			inner join ypt_ba b on a.kode_ba=b.kode_ba and a.kode_lokasi=b.kode_lokasi "+
					"			where a.nik_user='"+this.app._nikUser+"' and a.jenis='B' "+
					"			group by b.kode_lok "+
					"			)b on a.kode_lokasi=b.kode_lok "+
					"inner join lokasi c on a.kode_lokasi=c.kode_lokasi "+
					"order by a.kode_lokasi";
				this.nama="Beban YPT Group";
				var data = this.dbLib.getDataProvider(sql, true);
				var categories = [];
				...
				for (var i = 0; i < data.rs.rows.length; i++){
					var line = data.rs.rows[i];
						...
						categories.push(line.nama);
						this.dataCategories.push(line.kode_fakultas);
						series1.data.push(parseFloat(line.n2));
						series2.data.push(parseFloat(line.n4));
				...
				var sql = "select a.kode_bidang,a.nama,isnull(b.n2,0) as n2,isnull(b.n4,0) as n4 "+
					"from ypt_bidang a "+
					"inner join (select b.kode_bidang,sum(a.n2) as n2,sum(a.n6*-1)as n4 "+
					"			from ypt_budget_ba a "+
					"			inner join ypt_ba b on a.kode_ba=b.kode_ba and a.kode_lokasi=b.kode_lokasi "+
					"			where a.nik_user='"+this.app._nikUser+"' and a.jenis='P' "+
					"			group by b.kode_bidang "+
					"			)b on a.kode_bidang=b.kode_bidang "+
					"where a.nu<=7 "+
					"order by a.nu";
				this.nama="Pendapatan Telkom School";
				var data = this.dbLib.getDataProvider(sql, true);
				var categories = [];
				...
				var options2 = {
					...
					options2.series.push(series1);
					options2.series.push(series2);
					this.chart3.setChartData(options2);
					
				//beban sekolah
				
				var sql = "select a.kode_bidang,a.nama,isnull(b.n2,0) as n2,isnull(b.n4,0) as n4 "+
					"from ypt_bidang a "+
					"inner join (select b.kode_bidang,sum(a.n2) as n2,sum(a.n6)as n4 "+
					"			from ypt_budget_ba a "+
					"			inner join ypt_ba b on a.kode_ba=b.kode_ba and a.kode_lokasi=b.kode_lokasi "+
					"			where a.nik_user='"+this.app._nikUser+"' and a.jenis='B' "+
					"			group by b.kode_bidang "+
				...
				var options2 = {
					...
					options2.series.push(series1);
					options2.series.push(series2);
					this.chart4.setChartData(options2);
				
				//pdpt sekolah
				
				var sql = "select a.kode_ba,a.kode_ba as nama,isnull(b.n2,0) as n2,isnull(b.n4,0) as n4 "+
					"from ypt_ba a "+
					"inner join (select b.kode_ba,sum(a.n2) as n2,sum(a.n6*-1)as n4 "+
					"			from ypt_budget_ba a "+
					"			inner join ypt_ba b on a.kode_ba=b.kode_ba and a.kode_lokasi=b.kode_lokasi "+
					"			where a.nik_user='"+this.app._nikUser+"' and a.jenis='P' "+
					"			group by b.kode_ba "+
					"			)b on a.kode_ba=b.kode_ba "+
					"where substring(a.kode_ba,1,2)<>'YP' "+
					"order by a.kode_ba";
				this.nama="Pendapatan Telkom School";
				var data = this.dbLib.getDataProvider(sql, true);
				var categories = [];
				...
				var options2 = {
					...
					options2.series.push(series1);
					options2.series.push(series2);
					this.chart5.setChartData(options2);
					
				//beban sekolah
				
				var sql = "select a.kode_bidang,a.kode_ba as nama,isnull(b.n2,0) as n2,isnull(b.n4,0) as n4 "+
					"from ypt_ba a "+
					"inner join (select b.kode_ba,sum(a.n2) as n2,sum(a.n6)as n4 "+
					"			from ypt_budget_ba a "+
					"			inner join ypt_ba b on a.kode_ba=b.kode_ba and a.kode_lokasi=b.kode_lokasi "+
					"			where a.nik_user='"+this.app._nikUser+"' and a.jenis='B' "+
					"			group by b.kode_ba "+
				...
				var options2 = {
					...
					options2.series.push(series1);
					options2.series.push(series2);
					this.chart6.setChartData(options2);
