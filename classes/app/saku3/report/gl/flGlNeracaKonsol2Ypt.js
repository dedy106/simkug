// JavaScript Document
window.app_saku3_report_gl_flGlNeracaKonsol2Ypt = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlNeracaKonsol2Ypt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlNeracaKonsol2Ypt";
		this.maximize();
...
window.app_saku3_report_gl_flGlNeracaKonsol2Ypt.extend(window.portalui_childForm);
window.app_saku3_report_gl_flGlNeracaKonsol2Ypt.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				in_lap="K";
				this.nama_report="server_report_saku3_gl_rptGlNeracaKonsol2Ypt";
	...
	doOpenTb: function(kode_neraca,kode_lokasi,periode){
		...
		filter="where a.kode_lokasi='"+this.sg1.getCell(2,0)+"' and b.kode_neraca='"+kode_neraca+"' ";
