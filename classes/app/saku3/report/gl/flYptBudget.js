// JavaScript Document
window.app_saku3_report_gl_flYptBudget = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flYptBudget.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flYptBudget";
		this.maximize();
...
window.app_saku3_report_gl_flYptBudget.extend(window.portalui_childForm);
window.app_saku3_report_gl_flYptBudget.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				{
					this.nama_report="server_report_saku3_gl_rptYptBudgetDetail";
				}
