window.app_saku3_report_gl_flGlTbJejerTm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlTbJejerTm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlTbJejerTm";
		this.maximize();
...
window.app_saku3_report_gl_flGlTbJejerTm.extend(window.childForm);
window.app_saku3_report_gl_flGlTbJejerTm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlTbJejerTm";
