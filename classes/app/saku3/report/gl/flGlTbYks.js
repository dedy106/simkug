window.app_saku3_report_gl_flGlTbYks = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlTbYks.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlTbYks";
		this.maximize();
...
window.app_saku3_report_gl_flGlTbYks.extend(window.childForm);
window.app_saku3_report_gl_flGlTbYks.implement({
