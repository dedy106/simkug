// JavaScript Document
window.app_saku3_report_gl_flGlNeraca2Tu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlNeraca2Tu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlNeraca2Tu";
		this.maximize();
...
window.app_saku3_report_gl_flGlNeraca2Tu.extend(window.portalui_childForm);
window.app_saku3_report_gl_flGlNeraca2Tu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlNeraca2Tu";
