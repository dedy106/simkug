window.app_saku3_report_gl_flGlBukuBesarYks = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlBukuBesarYks.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlBukuBesarYks";
		this.maximize();
...
window.app_saku3_report_gl_flGlBukuBesarYks.extend(window.childForm);
window.app_saku3_report_gl_flGlBukuBesarYks.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlBukuBesarYks";
