window.app_saku3_report_gl_flYptTbJejer = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flYptTbJejer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flYptTbJejer";
		this.maximize();
...
window.app_saku3_report_gl_flYptTbJejer.extend(window.childForm);
window.app_saku3_report_gl_flYptTbJejer.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptYptTbJejer";
