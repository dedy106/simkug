window.app_saku3_report_gl_flGlTbTahunYks = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlTbTahunYks.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlTbTahunYks";
		this.maximize();
...
window.app_saku3_report_gl_flGlTbTahunYks.extend(window.childForm);
window.app_saku3_report_gl_flGlTbTahunYks.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlTbTahunYks";
