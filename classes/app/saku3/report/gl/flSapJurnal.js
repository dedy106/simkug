window.app_saku3_report_gl_flSapJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flSapJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flSapJurnal";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,0,new Array(0,1,2), new Array("Lokasi","=","12"));
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Periode","=",this.periode));
	this.gridLib.SGEditData(this.sg1,2,[0,1,2],["Output Laporan","=","Layar"]);
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_gl_flSapJurnal.extend(window.childForm);
window.app_saku3_report_gl_flSapJurnal.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			if (row ==0)
			{
				this.filterRep.ListDataSGFilter(this, "Data Lokasi",this.sg1, this.sg1.row, this.sg1.col,
												"select kode_lokasi, nama from lokasi where kode_lokasi in ('03','07','08','11','12')",
												"select count(*) from lokasi where kode_lokasi in ('03','07','08','11','12')",
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptSapJurnal";
