window.app_saku3_report_gl_flGlTbSap = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlTbSap.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlTbSap";
		this.maximize();
...
window.app_saku3_report_gl_flGlTbSap.extend(window.childForm);
window.app_saku3_report_gl_flGlTbSap.implement({
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3],["123","3","3"]);
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3],[2,0,0]);	
		if (row == 1)
		{
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlTbSap";
