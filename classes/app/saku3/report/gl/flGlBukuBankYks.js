window.app_saku3_report_gl_flGlBukuBankYks = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlBukuBankYks.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlBukuBankYks";
		this.maximize();
...
window.app_saku3_report_gl_flGlBukuBankYks.extend(window.childForm);
window.app_saku3_report_gl_flGlBukuBankYks.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlBukuBankYks";
