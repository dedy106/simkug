window.app_saku3_report_gl_flGlNeracaJejerYks2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlNeracaJejerYks2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlNeracaJejerYks2";
		this.maximize();
...
window.app_saku3_report_gl_flGlNeracaJejerYks2.extend(window.childForm);
window.app_saku3_report_gl_flGlNeracaJejerYks2.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlNeracaJejerYks2";
