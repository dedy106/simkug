window.app_saku3_report_gl_flGlBukuBesarPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlBukuBesarPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlBukuBesarPp";
		this.maximize();
...
window.app_saku3_report_gl_flGlBukuBesarPp.extend(window.childForm);
window.app_saku3_report_gl_flGlBukuBesarPp.implement({
	...
	{		
		...
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5],[2,0,2,0,1,2]);	
		if (row == 1)
		{
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlBukuBesarPp";
