// JavaScript Document
window.app_saku3_report_gl_flGlNeraca2Spm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlNeraca2Spm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlNeraca2Spm";
		this.maximize();
...
window.app_saku3_report_gl_flGlNeraca2Spm.extend(window.portalui_childForm);
window.app_saku3_report_gl_flGlNeraca2Spm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlNeraca2Spm";
