// JavaScript Document
window.app_saku3_report_gl_flJuJurnalBuktiPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flJuJurnalBuktiPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flJuJurnalBuktiPp";
		this.maximize();
...
window.app_saku3_report_gl_flJuJurnalBuktiPp.extend(window.portalui_childForm);
window.app_saku3_report_gl_flJuJurnalBuktiPp.implement({
	doEllipseClick: function(sender, col, row){
		...
		if (row == 3)
		{
			...
			var sql1="select a.no_ju,a.no_dokumen from ju_m a "+filter; 
			...
			this.filterRep.ListDataSGFilter(this, "Data Jurnal",this.sg1, this.sg1.row, this.sg1.col,sql1,sql2,
			                                new Array("a.no_ju","a.no_dokumen"),"and",new Array("No Bukti","No Jurnal"),"and");
