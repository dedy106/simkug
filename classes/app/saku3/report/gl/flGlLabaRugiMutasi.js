// JavaScript Document
window.app_saku3_report_gl_flGlLabaRugiMutasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlLabaRugiMutasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlLabaRugiMutasi";
		this.maximize();
...
window.app_saku3_report_gl_flGlLabaRugiMutasi.extend(window.portalui_childForm);
window.app_saku3_report_gl_flGlLabaRugiMutasi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlLabaRugiMutasi";
