// JavaScript Document
window.app_saku3_report_gl_flGlLabaRugiKonsolYks = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlLabaRugiKonsolYks.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlLabaRugiKonsolYks";
		this.maximize();
...
window.app_saku3_report_gl_flGlLabaRugiKonsolYks.extend(window.portalui_childForm);
window.app_saku3_report_gl_flGlLabaRugiKonsolYks.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlLabaRugiKonsolYks";
				if (this.sg1.getCell(2,4)=="Detail")
				{
					this.nama_report="server_report_saku3_gl_rptGlLabaRugiDetailKonsolYks";
				}
