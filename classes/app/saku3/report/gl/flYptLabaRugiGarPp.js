// JavaScript Document
window.app_saku3_report_gl_flYptLabaRugiGarPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flYptLabaRugiGarPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flYptLabaRugiGarPp";
		this.maximize();
...
window.app_saku3_report_gl_flYptLabaRugiGarPp.extend(window.portalui_childForm);
window.app_saku3_report_gl_flYptLabaRugiGarPp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptYptLabaRugiGarPp";
				if (this.sg1.getCell(2,6)=="RRA"){
					this.nama_report="server_report_saku3_gl_rptYptLabaRugiGarPpRra";
				}
				if (this.sg1.getCell(2,6)=="Reseting"){
					this.nama_report="server_report_saku3_gl_rptYptLabaRugiGarPpReset";
				}
