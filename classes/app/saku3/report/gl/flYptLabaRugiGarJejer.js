window.app_saku3_report_gl_flYptLabaRugiGarJejer = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flYptLabaRugiGarJejer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flYptLabaRugiGarJejer";
		this.maximize();
...
window.app_saku3_report_gl_flYptLabaRugiGarJejer.extend(window.childForm);
window.app_saku3_report_gl_flYptLabaRugiGarJejer.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptYptLabaRugiGarJejer";
