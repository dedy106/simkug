window.app_saku3_report_gl_flGlNeracaJejerTm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlNeracaJejerTm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlNeracaJejerTm";
		this.maximize();
...
window.app_saku3_report_gl_flGlNeracaJejerTm.extend(window.childForm);
window.app_saku3_report_gl_flGlNeracaJejerTm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlNeracaJejerTm";
