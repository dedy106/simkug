// JavaScript Document
window.app_saku3_report_gl_flGlSum = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlSum.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlSum";
		this.maximize();
...
window.app_saku3_report_gl_flGlSum.extend(window.portalui_childForm);
window.app_saku3_report_gl_flGlSum.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_gl_rptGlSum";
