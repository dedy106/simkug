window.app_saku3_report_gl_flYptNeracaJejer = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flYptNeracaJejer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flYptNeracaJejer";
		this.maximize();
...
window.app_saku3_report_gl_flYptNeracaJejer.extend(window.childForm);
window.app_saku3_report_gl_flYptNeracaJejer.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptYptNeracaJejer";
