window.app_saku3_report_gl_flGlArusKasTrg = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlArusKasTrg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlArusKasTrg";
		this.maximize();
...
window.app_saku3_report_gl_flGlArusKasTrg.extend(window.childForm);
window.app_saku3_report_gl_flGlArusKasTrg.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.app._nikUser+"/"+this.sg1.getCell(3,0)+"/"+this.sg1.getCell(2,4);
				this.nama_report="server_report_saku3_gl_rptGlArusKasTrg";
	...
	doOpenBb: function(kode_akun,kode_lokasi,periode){
		...
		nama_report="server_report_saku3_gl_rptGlBukuBesarArusKas";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
