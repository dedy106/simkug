// JavaScript Document
window.app_saku3_report_gl_flGlJurnalDrk = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlJurnalDrk.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlJurnalDrk";
		this.maximize();
...
window.app_saku3_report_gl_flGlJurnalDrk.extend(window.portalui_childForm);
window.app_saku3_report_gl_flGlJurnalDrk.implement({
	doEllipseClick: function(sender, col, row){
		...
		if (row == 4)
		{
			...
			var sql1="select a.no_ju,a.keterangan from ju_m a "+filter; 
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.filterRep.filterStr("modul",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and")+
			...
			this.nama_report="server_report_saku3_gl_rptGlJurnalDrk";
			if (this.sg1.getCell(2,6)=="Tidak")
			{
				this.nama_report="server_report_saku3_gl_rptGlJurnalDrk2";
			}
