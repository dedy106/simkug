// JavaScript Document
window.app_saku3_report_gl_flYptNeracaKonsol = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flYptNeracaKonsol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flYptNeracaKonsol";
		this.maximize();
...
window.app_saku3_report_gl_flYptNeracaKonsol.extend(window.portalui_childForm);
window.app_saku3_report_gl_flYptNeracaKonsol.implement({
	...
	doSelectCell: function(sender, col, row){
		if (this.app._userStatus=="A")
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,new Array(0,1,2,3,4),new  Array("13","1234","123","3","3"));
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptYptNeracaKonsol";
				if (this.sg1.getCell(2,4)=="Detail")
				{
					this.nama_report="server_report_saku3_gl_rptYptNeracaDetailKonsol";
				}
