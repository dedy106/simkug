// JavaScript Document
window.app_saku3_report_gl_flYptNeraca = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flYptNeraca.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flYptNeraca";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,0,new Array(0,1,2), new Array("Lokasi","=","03"));
...
window.app_saku3_report_gl_flYptNeraca.extend(window.portalui_childForm);
window.app_saku3_report_gl_flYptNeraca.implement({
	doEllipseClick: function(sender, col, row){
		if (row ==0)
		{
		
				this.filterRep.ListDataSGFilter(this, "Data Lokasi",this.sg1, this.sg1.row, this.sg1.col,
											"select kode_lokasi, nama from lokasi where kode_lokkonsol='20'",
											"select count(*) from lokasi where kode_lokkonsol='20'",
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptYptNeraca";
				if (this.sg1.getCell(2,4)=="Detail")
				{
					this.nama_report="server_report_saku3_gl_rptYptNeracaDetail";
				}
