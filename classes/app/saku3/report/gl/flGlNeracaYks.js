// JavaScript Document
window.app_saku3_report_gl_flGlNeracaYks = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlNeracaYks.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlNeracaYks";
		this.maximize();
...
window.app_saku3_report_gl_flGlNeracaYks.extend(window.portalui_childForm);
window.app_saku3_report_gl_flGlNeracaYks.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlNeracaYks";
				if (this.sg1.getCell(2,4)=="Detail")
				{
					this.nama_report="server_report_saku3_gl_rptGlNeracaDetailYks";
				}
