// JavaScript Document
window.app_saku3_report_gl_flYptLabaRugiGarBidang = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flYptLabaRugiGarBidang.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flYptLabaRugiGarBidang";
		this.maximize();
...
window.app_saku3_report_gl_flYptLabaRugiGarBidang.extend(window.portalui_childForm);
window.app_saku3_report_gl_flYptLabaRugiGarBidang.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptYptLabaRugiGarBidang";
