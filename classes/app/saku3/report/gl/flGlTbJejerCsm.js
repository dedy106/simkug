window.app_saku3_report_gl_flGlTbJejerCsm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlTbJejerCsm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlTbJejerCsm";
		this.maximize();
...
window.app_saku3_report_gl_flGlTbJejerCsm.extend(window.childForm);
window.app_saku3_report_gl_flGlTbJejerCsm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlTbJejerCsm";
