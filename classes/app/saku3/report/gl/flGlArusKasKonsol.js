window.app_saku3_report_gl_flGlArusKasKonsol = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlArusKasKonsol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlArusKasKonsol";
		this.maximize();
...
window.app_saku3_report_gl_flGlArusKasKonsol.extend(window.childForm);
window.app_saku3_report_gl_flGlArusKasKonsol.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlArusKasKonsol";
