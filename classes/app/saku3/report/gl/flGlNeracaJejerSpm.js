window.app_saku3_report_gl_flGlNeracaJejerSpm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlNeracaJejerSpm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlNeracaJejerSpm";
		this.maximize();
...
window.app_saku3_report_gl_flGlNeracaJejerSpm.extend(window.childForm);
window.app_saku3_report_gl_flGlNeracaJejerSpm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlNeracaJejerSpm";
