// JavaScript Document
window.app_saku3_report_gl_flGlLabaRugiBidang = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlLabaRugiBidang.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlLabaRugiBidang";
		this.maximize();
...
window.app_saku3_report_gl_flGlLabaRugiBidang.extend(window.portalui_childForm);
window.app_saku3_report_gl_flGlLabaRugiBidang.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		this.filterRep.setSGFilterRowTipe(this.sg1, row,new Array(0,1,2,3,4),new  Array("123","123","123","3","123"));
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2 = this.app._nikUser+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,3)+"/"+this.sg1.getCell(2,4);
				
				this.nama_report="server_report_saku3_gl_rptGlLabaRugiBidang";
