window.app_saku3_report_gl_flSapTbPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flSapTbPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flSapTbPp";
		this.maximize();
...
window.app_saku3_report_gl_flSapTbPp.extend(window.childForm);
window.app_saku3_report_gl_flSapTbPp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptSapTbPp";
