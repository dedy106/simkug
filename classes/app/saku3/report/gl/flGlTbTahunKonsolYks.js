window.app_saku3_report_gl_flGlTbTahunKonsolYks = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlTbTahunKonsolYks.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlTbTahunKonsolYks";
		this.maximize();
...
window.app_saku3_report_gl_flGlTbTahunKonsolYks.extend(window.childForm);
window.app_saku3_report_gl_flGlTbTahunKonsolYks.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlTbTahunKonsolYks";
