window.app_saku3_report_gl_flGlLabaRugiJejerGsd = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlLabaRugiJejerGsd.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlLabaRugiJejerGsd";
		this.maximize();
...
window.app_saku3_report_gl_flGlLabaRugiJejerGsd.extend(window.childForm);
window.app_saku3_report_gl_flGlLabaRugiJejerGsd.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlLabaRugiJejerGsd";
