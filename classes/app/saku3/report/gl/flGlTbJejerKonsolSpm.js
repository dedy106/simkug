window.app_saku3_report_gl_flGlTbJejerKonaolSpm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlTbJejerKonaolSpm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlTbJejerKonaolSpm";
		this.maximize();
...
window.app_saku3_report_gl_flGlTbJejerKonaolSpm.extend(window.childForm);
window.app_saku3_report_gl_flGlTbJejerKonaolSpm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlTbJejerKonsolSpm";
