// JavaScript Document
window.app_saku3_report_gl_flGlNeracaKonsolSpm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlNeracaKonsolSpm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlNeracaKonsolSpm";
		this.maximize();
...
window.app_saku3_report_gl_flGlNeracaKonsolSpm.extend(window.portalui_childForm);
window.app_saku3_report_gl_flGlNeracaKonsolSpm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				in_lap="K";
				this.nama_report="server_report_saku3_gl_rptGlNeracaKonsolSpm";
				
				this.filter2 = this.app._nikUser+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,2);
