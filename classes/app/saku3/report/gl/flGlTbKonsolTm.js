window.app_saku3_report_gl_flGlTbKonsolTm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlTbKonsolTm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlTbKonsolTm";
		this.maximize();
...
window.app_saku3_report_gl_flGlTbKonsolTm.extend(window.childForm);
window.app_saku3_report_gl_flGlTbKonsolTm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlTbKonsolTm";
