window.app_saku3_report_gl_flGlTbTarbak = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlTbTarbak.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlTbTarbak";
		this.maximize();
...
window.app_saku3_report_gl_flGlTbTarbak.extend(window.childForm);
window.app_saku3_report_gl_flGlTbTarbak.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlTbYks";
				if (this.sg1.getCell(2,4)=="Tahunan")
				{
					this.nama_report="server_report_saku3_gl_rptGlTbTahun";
				}
				if (this.sg1.getCell(1,1)=="Range")
				{
					this.nama_report="server_report_saku3_gl_rptGlTbTarbak";
				}
