// JavaScript Document
window.app_saku3_report_gl_flGlLabaRugi2TuReset = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlLabaRugi2TuReset.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlLabaRugi2TuReset";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,[0,1,2],["Status Anggaran","=","Reseting"]);
...
window.app_saku3_report_gl_flGlLabaRugi2TuReset.extend(window.portalui_childForm);
window.app_saku3_report_gl_flGlLabaRugi2TuReset.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlLabaRugi2TuReset";
