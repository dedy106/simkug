window.app_saku3_report_gl_flGlNeracaSimulasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlNeracaSimulasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlNeracaSimulasi";
		this.maximize();
...
window.app_saku3_report_gl_flGlNeracaSimulasi.extend(window.childForm);
window.app_saku3_report_gl_flGlNeracaSimulasi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlNeracaSimulasi";
