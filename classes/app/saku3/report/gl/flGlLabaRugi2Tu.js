// JavaScript Document
window.app_saku3_report_gl_flGlLabaRugi2Tu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlLabaRugi2Tu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlLabaRugi2Tu";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("Mutasi Nol","=","Ya"));
...
window.app_saku3_report_gl_flGlLabaRugi2Tu.extend(window.portalui_childForm);
window.app_saku3_report_gl_flGlLabaRugi2Tu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlLabaRugi2Tu";
