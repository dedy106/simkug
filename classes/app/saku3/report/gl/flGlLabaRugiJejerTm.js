window.app_saku3_report_gl_flGlLabaRugiJejerTm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlLabaRugiJejerTm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlLabaRugiJejerTm";
		this.maximize();
...
window.app_saku3_report_gl_flGlLabaRugiJejerTm.extend(window.childForm);
window.app_saku3_report_gl_flGlLabaRugiJejerTm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlLabaRugiJejerTm";
