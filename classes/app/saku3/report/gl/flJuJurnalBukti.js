// JavaScript Document
window.app_saku3_report_gl_flJuJurnalBukti = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flJuJurnalBukti.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flJuJurnalBukti";
		this.maximize();
...
window.app_saku3_report_gl_flJuJurnalBukti.extend(window.portalui_childForm);
window.app_saku3_report_gl_flJuJurnalBukti.implement({
