window.app_saku3_report_gl_flGlTbTahunPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlTbTahunPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlTbTahunPp";
		this.maximize();
...
window.app_saku3_report_gl_flGlTbTahunPp.extend(window.childForm);
window.app_saku3_report_gl_flGlTbTahunPp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlTbTahunPp";
