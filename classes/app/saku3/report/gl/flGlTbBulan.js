window.app_saku3_report_gl_flGlTbBulan = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlTbBulan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlTbBulan";
		this.maximize();
...
window.app_saku3_report_gl_flGlTbBulan.extend(window.childForm);
window.app_saku3_report_gl_flGlTbBulan.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlTbBulan";
