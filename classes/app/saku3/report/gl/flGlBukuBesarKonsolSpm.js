window.app_saku3_report_gl_flGlBukuBesarKonsolSpm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlBukuBesarKonsolSpm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlBukuBesarKonsolSpm";
		this.maximize();
...
window.app_saku3_report_gl_flGlBukuBesarKonsolSpm.extend(window.childForm);
window.app_saku3_report_gl_flGlBukuBesarKonsolSpm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlBukuBesarKonsolSpm";
