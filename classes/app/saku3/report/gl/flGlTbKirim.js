window.app_saku3_report_gl_flGlTbKirim = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlTbKirim.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlTbKirim";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,[0,1,2],["Jenis ","=","Neraca Lajur"]);
	this.gridLib.SGEditData(this.sg1,3,[0,1,2],["Output Laporan","=","Layar"]);
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_gl_flGlTbKirim.extend(window.childForm);
window.app_saku3_report_gl_flGlTbKirim.implement({
	...
	{		
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("Neraca Lajur","Anggaran"));
		}
		if (row == 3)
		{
			this.sg1.columns.get(2).pickList.clear();
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlTbKirim";
				if (this.sg1.getCell(2,2)=="Anggaran")
				{
					this.nama_report="server_report_saku3_gl_rptGlGarKirim";
				}
