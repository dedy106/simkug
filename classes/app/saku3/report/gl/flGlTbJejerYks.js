window.app_saku3_report_gl_flGlTbJejerYks = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlTbJejerYks.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlTbJejerYks";
		this.maximize();
...
window.app_saku3_report_gl_flGlTbJejerYks.extend(window.childForm);
window.app_saku3_report_gl_flGlTbJejerYks.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlTbJejerYks";
