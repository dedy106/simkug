window.app_saku3_report_gl_flGlArusKasTu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlArusKasTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlArusKasTu";
		this.maximize();
...
window.app_saku3_report_gl_flGlArusKasTu.extend(window.childForm);
window.app_saku3_report_gl_flGlArusKasTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlArusKasTu";
