window.app_saku3_report_gl_flGlLabaRugiJejerSpm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlLabaRugiJejerSpm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlLabaRugiJejerSpm";
		this.maximize();
...
window.app_saku3_report_gl_flGlLabaRugiJejerSpm.extend(window.childForm);
window.app_saku3_report_gl_flGlLabaRugiJejerSpm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlLabaRugiJejerSpm";
