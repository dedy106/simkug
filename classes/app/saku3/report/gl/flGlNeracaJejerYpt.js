window.app_saku3_report_gl_flGlNeracaJejerYpt = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlNeracaJejerYpt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlNeracaJejerYpt";
		this.maximize();
...
window.app_saku3_report_gl_flGlNeracaJejerYpt.extend(window.childForm);
window.app_saku3_report_gl_flGlNeracaJejerYpt.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlNeracaJejerYpt";
