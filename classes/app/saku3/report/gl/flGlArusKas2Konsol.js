window.app_saku3_report_gl_flGlArusKas2Konsol = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlArusKas2Konsol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlArusKas2Konsol";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,5,new Array(0,1,2), new Array("Periode Pembanding","=",this.periode));
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_gl_flGlArusKas2Konsol.extend(window.childForm);
window.app_saku3_report_gl_flGlArusKas2Konsol.implement({
	...
	{		
		...
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5],[3,0,2,0,0,0]);	
		if (row == 1)
		{
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.app._nikUser+"/"+this.sg1.getCell(2,5);
				this.nama_report="server_report_saku3_gl_rptGlArusKas2Konsol";
