window.app_saku3_report_gl_flGlTbTahunSpm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlTbTahunSpm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlTbTahunSpm";
		this.maximize();
...
window.app_saku3_report_gl_flGlTbTahunSpm.extend(window.childForm);
window.app_saku3_report_gl_flGlTbTahunSpm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlTbTahunSpm";
