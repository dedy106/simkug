// JavaScript Document
window.app_saku3_report_gl_flKbJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flKbJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flKbJurnal";
		this.maximize();
...
window.app_saku3_report_gl_flKbJurnal.extend(window.portalui_childForm);
window.app_saku3_report_gl_flKbJurnal.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		this.filterRep.setSGFilterRowTipe(this.sg1, row,new Array(0,1,2,3),new  Array("3","23","123","3"));
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.filter2 = this.sg1.getCell(2,1)+"/"+this.sg1.getCell(1,1)+"/"+this.sg1.getCell(3,1)+"/"+this.app._nikUser+"/"+this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,3);
			this.nama_report="server_report_saku3_gl_rptKbJurnal";
