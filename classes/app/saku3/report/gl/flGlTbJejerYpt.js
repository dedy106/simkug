window.app_saku3_report_gl_flGlTbJejerYpt = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlTbJejerYpt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlTbJejerYpt";
		this.maximize();
...
window.app_saku3_report_gl_flGlTbJejerYpt.extend(window.childForm);
window.app_saku3_report_gl_flGlTbJejerYpt.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlTbJejerYpt";
