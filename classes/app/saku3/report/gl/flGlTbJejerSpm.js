window.app_saku3_report_gl_flGlTbJejerSpm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlTbJejerSpm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlTbJejerSpm";
		this.maximize();
...
window.app_saku3_report_gl_flGlTbJejerSpm.extend(window.childForm);
window.app_saku3_report_gl_flGlTbJejerSpm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlTbJejerSpm";
