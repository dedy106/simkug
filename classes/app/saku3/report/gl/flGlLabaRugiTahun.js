// JavaScript Document
window.app_saku3_report_gl_flGlLabaRugiTahun = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlLabaRugiTahun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlLabaRugiTahun";
		this.maximize();
...
window.app_saku3_report_gl_flGlLabaRugiTahun.extend(window.portalui_childForm);
window.app_saku3_report_gl_flGlLabaRugiTahun.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlLabaRugiTahun";
