window.app_saku3_report_gl_flGlTbPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlTbPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlTbPp";
		this.maximize();
...
window.app_saku3_report_gl_flGlTbPp.extend(window.childForm);
window.app_saku3_report_gl_flGlTbPp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlTbPp";
	...
	doOpenBb: function(kode_akun,kode_lokasi,periode,kode_pp){
		...
		nama_report="server_report_saku3_gl_rptGlBukuBesarPp";
