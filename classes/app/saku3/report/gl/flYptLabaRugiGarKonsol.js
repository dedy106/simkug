// JavaScript Document
window.app_saku3_report_gl_flYptLabaRugiGarKonsol = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flYptLabaRugiGarKonsol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flYptLabaRugiGarKonsol";
		this.maximize();
	...
	this.lokasi=this.dbLib.getPeriodeFromSQL("select kode_lokasi as periode from lokasi where flag_aktif='1' and kode_lokkonsol='-'");
	this.gridLib.SGEditData(this.sg1,0,new Array(0,1,2), new Array("Lokasi","=",this.lokasi));
	...
	this.gridLib.SGEditData(this.sg1,5,new Array(0,1,2), new Array("Anggaran","=","Original"));
...
window.app_saku3_report_gl_flYptLabaRugiGarKonsol.extend(window.portalui_childForm);
window.app_saku3_report_gl_flYptLabaRugiGarKonsol.implement({
	doEllipseClick: function(sender, col, row){
		if (row ==0)
		{
			this.filterRep.ListDataSGFilter(this, "Data Lokasi",this.sg1, this.sg1.row, this.sg1.col,
											"select kode_lokasi, nama from lokasi where kode_lokkonsol='-' and flag_aktif='1' ",
											"select count(*) from lokasi where kode_lokkonsol='-' and flag_aktif='1'  ",
	...
	doSelectCell: function(sender, col, row){
		this.filterRep.setSGFilterRowTipe(this.sg1, row,new Array(0,1,2,3,4,5),new  Array("3","123","123","3","3","3"));
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("Original","RRA"));
		}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptYptLabaRugiGarKonsol";
				if (this.sg1.getCell(2,5)=="RRA"){
					this.nama_report="server_report_saku3_gl_rptYptLabaRugiGarKonsolRra";
				}
