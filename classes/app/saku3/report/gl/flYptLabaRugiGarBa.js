// JavaScript Document
window.app_saku3_report_gl_flYptLabaRugiGarBa = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flYptLabaRugiGarBa.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flYptLabaRugiGarBa";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,5,new Array(0,1,2), new Array("Kode BA","=","YPT0"));
...
window.app_saku3_report_gl_flYptLabaRugiGarBa.extend(window.portalui_childForm);
window.app_saku3_report_gl_flYptLabaRugiGarBa.implement({
	doEllipseClick: function(sender, col, row){
		...
		if (row == 5)
		{
			this.filterRep.ListDataSGFilter(this, "Data Bisnis Area",this.sg1, this.sg1.row, this.sg1.col,
													  "select kode_ba,nama from ypt_ba ",
													  "select count(kode_ba) from ypt_ba ",
													  new Array("kode_ba","nama"),"where");
		}
	},
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptYptLabaRugiGarBa";
