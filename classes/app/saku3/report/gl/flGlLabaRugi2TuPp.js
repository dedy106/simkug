// JavaScript Document
window.app_saku3_report_gl_flGlLabaRugi2TuPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlLabaRugi2TuPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlLabaRugi2TuPp";
		this.maximize();
...
window.app_saku3_report_gl_flGlLabaRugi2TuPp.extend(window.portalui_childForm);
window.app_saku3_report_gl_flGlLabaRugi2TuPp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlLabaRugi2TuPp";
				this.filter2 = this.app._nikUser+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,3)+"/"+this.sg1.getCell(2,4)+"/"+this.pp+"/"+this.sg1.getCell(2,2);
