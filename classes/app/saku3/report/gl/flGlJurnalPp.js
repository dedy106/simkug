// JavaScript Document
window.app_saku3_report_gl_flGlJurnalPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlJurnalPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlJurnalPp";
		this.maximize();
...
window.app_saku3_report_gl_flGlJurnalPp.extend(window.portalui_childForm);
window.app_saku3_report_gl_flGlJurnalPp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_gl_rptGlJurnalPp";
			if (this.sg1.getCell(2,5)=="Tidak")
			{
				this.nama_report="server_report_saku3_gl_rptGlJurnalPp2";
			}
