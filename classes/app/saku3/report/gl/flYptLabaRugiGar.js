// JavaScript Document
window.app_saku3_report_gl_flYptLabaRugiGar = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flYptLabaRugiGar.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flYptLabaRugiGar";
		this.maximize();
...
window.app_saku3_report_gl_flYptLabaRugiGar.extend(window.portalui_childForm);
window.app_saku3_report_gl_flYptLabaRugiGar.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptYptLabaRugiGar";
				if (this.sg1.getCell(2,5)=="RRA"){
					this.nama_report="server_report_saku3_gl_rptYptLabaRugiGarRra";
				}
				if (this.sg1.getCell(2,5)=="Reseting"){
					this.nama_report="server_report_saku3_gl_rptYptLabaRugiGarReset";
				}
