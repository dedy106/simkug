// JavaScript Document
window.app_saku3_report_gl_flGlLabaRugiSpm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlLabaRugiSpm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlLabaRugiSpm";
		this.maximize();
...
window.app_saku3_report_gl_flGlLabaRugiSpm.extend(window.portalui_childForm);
window.app_saku3_report_gl_flGlLabaRugiSpm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlLabaRugiSpm";
