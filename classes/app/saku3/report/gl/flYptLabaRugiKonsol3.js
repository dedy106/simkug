// JavaScript Document
window.app_saku3_report_gl_flYptLabaRugiKonsol3 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flYptLabaRugiKonsol3.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flYptLabaRugiKonsol3";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Jenis Laporan","=","Saldo Akhir"));
...
window.app_saku3_report_gl_flYptLabaRugiKonsol3.extend(window.portalui_childForm);
window.app_saku3_report_gl_flYptLabaRugiKonsol3.implement({
	...
	doSelectCell: function(sender, col, row){
		this.filterRep.setSGFilterRowTipe(this.sg1, row,new Array(0,1,2,3),new  Array("3","123","123","3"));
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptYptLabaRugiKonsol3";
