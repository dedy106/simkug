// JavaScript Document
window.app_saku3_report_gl_flYptLabaRugiKonsol = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flYptLabaRugiKonsol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flYptLabaRugiKonsol";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,5,new Array(0,1,2), new Array("Jenis Laporan","=","Saldo Akhir"));
...
window.app_saku3_report_gl_flYptLabaRugiKonsol.extend(window.portalui_childForm);
window.app_saku3_report_gl_flYptLabaRugiKonsol.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptYptLabaRugiKonsol";
				if (this.sg1.getCell(2,4)=="Detail")
				{
					this.nama_report="server_report_saku3_gl_rptYptLabaRugiDetailKonsol";
				}
				if (this.sg1.getCell(2,5)=="Mutasi")
				{
					this.nama_report="server_report_saku3_gl_rptYptLabaRugiKonsolMutasi";
				}
