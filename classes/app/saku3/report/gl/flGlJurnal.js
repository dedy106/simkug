// JavaScript Document
window.app_saku3_report_gl_flGlJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlJurnal";
		this.maximize();
...
window.app_saku3_report_gl_flGlJurnal.extend(window.portalui_childForm);
window.app_saku3_report_gl_flGlJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_gl_rptGlJurnal";
