// JavaScript Document
window.app_saku3_report_gl_flGlLabaRugiTahunKonsol = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlLabaRugiTahunKonsol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlLabaRugiTahunKonsol";
		this.maximize();
...
window.app_saku3_report_gl_flGlLabaRugiTahunKonsol.extend(window.portalui_childForm);
window.app_saku3_report_gl_flGlLabaRugiTahunKonsol.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			if (sender == this.app._mainForm.bBack)
			{
				...
				if (this.link=="2")
				{
					this.doOpenTbJejer(this.kode_neraca,this.kode_lokasi,this.periode);
				}
				if (this.link=="3")
				{
			...
			else
			{
				...
				this.filter2 = this.app._nikUser+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,3)+"/"+this.sg1.getCell(2,2);
				
				this.nama_report="server_report_saku3_gl_rptGlLabaRugiTahunKonsol";
	...
	doOpenTbJejer: function(kode_neraca,kode_lokasi,periode){
