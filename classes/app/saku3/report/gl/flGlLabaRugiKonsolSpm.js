// JavaScript Document
window.app_saku3_report_gl_flGlLabaRugiKonsolSpm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlLabaRugiKonsolSpm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlLabaRugiKonsolSpm";
		this.maximize();
...
window.app_saku3_report_gl_flGlLabaRugiKonsolSpm.extend(window.portalui_childForm);
window.app_saku3_report_gl_flGlLabaRugiKonsolSpm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlLabaRugiKonsolSpm";
