window.app_saku3_report_gl_flYptLabaRugiJejer = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flYptLabaRugiJejer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flYptLabaRugiJejer";
		this.maximize();
...
window.app_saku3_report_gl_flYptLabaRugiJejer.extend(window.childForm);
window.app_saku3_report_gl_flYptLabaRugiJejer.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptYptLabaRugiJejer";
