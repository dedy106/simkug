// JavaScript Document
window.app_saku3_report_gl_flGlLabaRugi5YksKonsol = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlLabaRugi5YksKonsol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlLabaRugi5YksKonsol";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Periode Pembanding 2","=",this.app._periode));
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("Periode Pembanding 3","=",this.app._periode));
	this.gridLib.SGEditData(this.sg1,5,new Array(0,1,2), new Array("Periode Pembanding 4","=",this.app._periode));
	this.gridLib.SGEditData(this.sg1,6,new Array(0,1,2), new Array("Periode Pembanding 5","=",this.app._periode));
...
window.app_saku3_report_gl_flGlLabaRugi5YksKonsol.extend(window.portalui_childForm);
window.app_saku3_report_gl_flGlLabaRugi5YksKonsol.implement({
	...
	doSelectCell: function(sender, col, row){
		this.filterRep.setSGFilterRowTipe(this.sg1, row,new Array(0,1,2,3,4,5,6),new  Array("3","3","123","123","123","123","123"));
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlLabaRugi5YksKonsol";
				this.filter2 = this.app._nikUser+"/"+this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,2)+"/"+this.sg1.getCell(2,3)+"/"+this.sg1.getCell(2,4)+"/"+this.sg1.getCell(2,5)+"/"+this.sg1.getCell(2,6);
