window.app_saku3_report_gl_flGlLabaRugiJejerYpt = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlLabaRugiJejerYpt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlLabaRugiJejerYpt";
		this.maximize();
...
window.app_saku3_report_gl_flGlLabaRugiJejerYpt.extend(window.childForm);
window.app_saku3_report_gl_flGlLabaRugiJejerYpt.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlLabaRugiJejerYpt";
