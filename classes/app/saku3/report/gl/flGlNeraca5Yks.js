// JavaScript Document
window.app_saku3_report_gl_flGlNeraca5Yks = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlNeraca5Yks.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlNeraca5Yks";
		this.maximize();
...
window.app_saku3_report_gl_flGlNeraca5Yks.extend(window.portalui_childForm);
window.app_saku3_report_gl_flGlNeraca5Yks.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlNeraca5Yks";
