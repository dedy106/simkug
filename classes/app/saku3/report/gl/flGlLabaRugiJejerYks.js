window.app_saku3_report_gl_flGlLabaRugiJejerYks = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlLabaRugiJejerYks.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlLabaRugiJejerYks";
		this.maximize();
...
window.app_saku3_report_gl_flGlLabaRugiJejerYks.extend(window.childForm);
window.app_saku3_report_gl_flGlLabaRugiJejerYks.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlLabaRugiJejerYks";
