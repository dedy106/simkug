// JavaScript Document
window.app_saku3_report_gl_flGlNeracaKonsolYks2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlNeracaKonsolYks2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlNeracaKonsolYks2";
		this.maximize();
...
window.app_saku3_report_gl_flGlNeracaKonsolYks2.extend(window.portalui_childForm);
window.app_saku3_report_gl_flGlNeracaKonsolYks2.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				in_lap="K";
				this.nama_report="server_report_saku3_gl_rptGlNeracaKonsolYks2";
	...
	doOpenTb: function(kode_neraca,kode_lokasi,periode){
		...
		this.link="1";
		filter2=this.sg1.getCell(2,0)+"/"+periode+"/"+this.app._nikUser+"/"+"Tidak/3";
