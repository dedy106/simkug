// JavaScript Document
window.app_saku3_report_gl_flGlLabaRugiSpmUnit = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlLabaRugiSpmUnit.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlLabaRugiSpmUnit";
		this.maximize();
...
window.app_saku3_report_gl_flGlLabaRugiSpmUnit.extend(window.portalui_childForm);
window.app_saku3_report_gl_flGlLabaRugiSpmUnit.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlLabaRugiSpmUnit";
