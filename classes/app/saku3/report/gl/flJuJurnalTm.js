// JavaScript Document
window.app_saku3_report_gl_flJuJurnalTm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flJuJurnalTm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flJuJurnalTm";
		this.maximize();
...
window.app_saku3_report_gl_flJuJurnalTm.extend(window.portalui_childForm);
window.app_saku3_report_gl_flJuJurnalTm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_gl_rptJuJurnalTm";
