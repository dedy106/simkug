window.app_saku3_report_gl_flYptLabaRugiJejerPp = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flYptLabaRugiJejerPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flYptLabaRugiJejerPp";
		this.maximize();
...
window.app_saku3_report_gl_flYptLabaRugiJejerPp.extend(window.childForm);
window.app_saku3_report_gl_flYptLabaRugiJejerPp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptYptLabaRugiJejerPp";
