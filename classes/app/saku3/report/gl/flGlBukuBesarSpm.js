window.app_saku3_report_gl_flGlBukuBesarSpm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlBukuBesarSpm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlBukuBesarSpm";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,6,new Array(0,1,2), new Array("Jenis Laporan","=","Buku Besar"));
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_gl_flGlBukuBesarSpm.extend(window.childForm);
window.app_saku3_report_gl_flGlBukuBesarSpm.implement({
	...
	{		
		...
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5,6],[2,0,2,0,1,0,0]);	
		if (row == 1)
		{
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlBukuBesarSpm";
				if (this.sg1.getCell(2,6)=="Buku Besar Proyek")
				{
					this.nama_report="server_report_saku3_gl_rptGlBukuBesarSpmProyek";
				}
