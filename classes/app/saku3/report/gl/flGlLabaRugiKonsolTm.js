// JavaScript Document
window.app_saku3_report_gl_flGlLabaRugiKonsolTm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlLabaRugiKonsolTm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlLabaRugiKonsolTm";
		this.maximize();
...
window.app_saku3_report_gl_flGlLabaRugiKonsolTm.extend(window.portalui_childForm);
window.app_saku3_report_gl_flGlLabaRugiKonsolTm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				var in_lap="S";
				this.filter2 = this.nik_user+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,2)+"/"+this.sg1.getCell(2,3)+"/"+this.sg1.getCell(2,4);
				
				this.nama_report="server_report_saku3_gl_rptGlLabaRugiKonsolTm" ;
