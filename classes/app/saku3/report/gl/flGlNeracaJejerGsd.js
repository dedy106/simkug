window.app_saku3_report_gl_flGlNeracaJejerGsd = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlNeracaJejerGsd.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlNeracaJejerGsd";
		this.maximize();
...
window.app_saku3_report_gl_flGlNeracaJejerGsd.extend(window.childForm);
window.app_saku3_report_gl_flGlNeracaJejerGsd.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlNeracaJejerGsd";
