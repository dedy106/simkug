// JavaScript Document
window.app_saku3_report_gl_flGlNeraca2Yks = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlNeraca2Yks.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlNeraca2Yks";
		this.maximize();
...
window.app_saku3_report_gl_flGlNeraca2Yks.extend(window.portalui_childForm);
window.app_saku3_report_gl_flGlNeraca2Yks.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlNeraca2Yks";
				if (this.sg1.getCell(2,5)=="Detail")
				{
					this.nama_report="server_report_saku3_gl_rptGlNeraca2DetailYks";
				}
