window.app_saku3_report_gl_flGlTbSimulasi = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlTbSimulasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlTbSimulasi";
		this.maximize();
...
window.app_saku3_report_gl_flGlTbSimulasi.extend(window.childForm);
window.app_saku3_report_gl_flGlTbSimulasi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				{
					this.nama_report="server_report_saku3_gl_rptGlTbSimulasiTahun";
				}
