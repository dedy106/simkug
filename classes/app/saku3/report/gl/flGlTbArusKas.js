window.app_saku3_report_gl_flGlTbArusKas = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlTbArusKas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlTbArusKas";
		this.maximize();
...
window.app_saku3_report_gl_flGlTbArusKas.extend(window.childForm);
window.app_saku3_report_gl_flGlTbArusKas.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlTbArusKas";
