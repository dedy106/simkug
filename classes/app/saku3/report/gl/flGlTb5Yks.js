// JavaScript Document
window.app_saku3_report_gl_flGlTb5Yks = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlTb5Yks.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlTb5Yks";
		this.maximize();
...
window.app_saku3_report_gl_flGlTb5Yks.extend(window.portalui_childForm);
window.app_saku3_report_gl_flGlTb5Yks.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlTb5Yks";
