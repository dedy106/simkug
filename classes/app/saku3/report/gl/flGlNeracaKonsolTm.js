// JavaScript Document
window.app_saku3_report_gl_flGlNeracaKonsolTm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlNeracaKonsolTm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlNeracaKonsolTm";
		this.maximize();
...
window.app_saku3_report_gl_flGlNeracaKonsolTm.extend(window.portalui_childForm);
window.app_saku3_report_gl_flGlNeracaKonsolTm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				in_lap="K";
				this.nama_report="server_report_saku3_gl_rptGlNeracaKonsolTm";
				if (this.sg1.getCell(2,4)=="Detail")
				{
					this.nama_report="server_report_saku3_gl_rptGlNeracaKonsolDetailTm";	
				}
				this.filter2 = this.app._nikUser+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,2)+"/"+this.sg1.getCell(2,3)+"/"+this.sg1.getCell(2,4);
