// JavaScript Document
window.app_saku3_report_gl_flGlNeracaKonsol2Yks = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlNeracaKonsol2Yks.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlNeracaKonsol2Yks";
		this.maximize();
...
window.app_saku3_report_gl_flGlNeracaKonsol2Yks.extend(window.portalui_childForm);
window.app_saku3_report_gl_flGlNeracaKonsol2Yks.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				in_lap="K";
				this.nama_report="server_report_saku3_gl_rptGlNeracaKonsol2Yks";
