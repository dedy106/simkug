window.app_saku3_report_gl_flGlArusKas = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlArusKas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlArusKas";
		this.maximize();
...
window.app_saku3_report_gl_flGlArusKas.extend(window.childForm);
window.app_saku3_report_gl_flGlArusKas.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlArusKas";
