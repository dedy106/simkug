// JavaScript Document
window.app_saku3_report_gl_flGlJurnalAudit = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlJurnalAudit.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlJurnalAudit";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Output","=","Excel"));
...
window.app_saku3_report_gl_flGlJurnalAudit.extend(window.portalui_childForm);
window.app_saku3_report_gl_flGlJurnalAudit.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.filter2 = this.sg1.getCell(2,1)+"/"+this.sg1.getCell(1,1)+"/"+this.sg1.getCell(3,1)+"/"+this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,2);
			this.nama_report="server_report_saku3_gl_rptGlJurnalAudit";
