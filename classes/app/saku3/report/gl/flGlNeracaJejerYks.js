window.app_saku3_report_gl_flGlNeracaJejerYks = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlNeracaJejerYks.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlNeracaJejerYks";
		this.maximize();
...
window.app_saku3_report_gl_flGlNeracaJejerYks.extend(window.childForm);
window.app_saku3_report_gl_flGlNeracaJejerYks.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlNeracaJejerYks";
