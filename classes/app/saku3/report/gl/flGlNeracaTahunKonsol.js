// JavaScript Document
window.app_saku3_report_gl_flGlNeracaTahunKonsol = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlNeracaTahunKonsol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlNeracaTahunKonsol";
		this.maximize();
...
window.app_saku3_report_gl_flGlNeracaTahunKonsol.extend(window.portalui_childForm);
window.app_saku3_report_gl_flGlNeracaTahunKonsol.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2 = this.app._nikUser+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,3);
				
				this.nama_report="server_report_saku3_gl_rptGlNeracaTahunKonsol";
