window.app_saku3_report_gl_flGlTbJejerGsd = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlTbJejerGsd.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlTbJejerGsd";
		this.maximize();
...
window.app_saku3_report_gl_flGlTbJejerGsd.extend(window.childForm);
window.app_saku3_report_gl_flGlTbJejerGsd.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlTbJejerGsd";
