// JavaScript Document
window.app_saku3_report_gl_flJuJurnalBuktiDrk = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flJuJurnalBuktiDrk.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flJuJurnalBuktiDrk";
		this.maximize();
...
window.app_saku3_report_gl_flJuJurnalBuktiDrk.extend(window.portalui_childForm);
window.app_saku3_report_gl_flJuJurnalBuktiDrk.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_gl_rptJuJurnalBuktiDrk";
