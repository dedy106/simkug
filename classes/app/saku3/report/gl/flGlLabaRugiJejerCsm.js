window.app_saku3_report_gl_flGlLabaRugiJejerCsm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlLabaRugiJejerCsm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlLabaRugiJejerCsm";
		this.maximize();
...
window.app_saku3_report_gl_flGlLabaRugiJejerCsm.extend(window.childForm);
window.app_saku3_report_gl_flGlLabaRugiJejerCsm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlLabaRugiJejerCsm";
