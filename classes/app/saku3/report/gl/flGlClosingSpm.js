// JavaScript Document
window.app_saku3_report_gl_flGlClosingSpm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlClosingSpm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlClosingSpm";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from gl_closing ");
...
window.app_saku3_report_gl_flGlClosingSpm.extend(window.portalui_childForm);
window.app_saku3_report_gl_flGlClosingSpm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_gl_rptGlClosingSpm";
