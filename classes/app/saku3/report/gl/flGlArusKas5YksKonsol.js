// JavaScript Document
window.app_saku3_report_gl_flGlArusKas5YksKonsol = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_gl_flGlArusKas5YksKonsol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_gl_flGlArusKas5YksKonsol";
		this.maximize();
...
window.app_saku3_report_gl_flGlArusKas5YksKonsol.extend(window.portalui_childForm);
window.app_saku3_report_gl_flGlArusKas5YksKonsol.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_gl_rptGlArusKas5Konsol";
