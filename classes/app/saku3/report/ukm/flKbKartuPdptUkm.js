// JavaScript Document
window.app_saku3_report_ukm_flKbKartuPdptUkm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ukm_flKbKartuPdptUkm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ukm_flKbKartuPdptUkm";
		this.maximize();
...
window.app_saku3_report_ukm_flKbKartuPdptUkm.extend(window.portalui_childForm);
window.app_saku3_report_ukm_flKbKartuPdptUkm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_ukm_rptKbKartuPdptUkm";
				this.dbLib.execQuerySync(this.sql);	
