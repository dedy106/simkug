// JavaScript Document
window.app_saku3_report_ukm_flKbKartuBebanUkm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ukm_flKbKartuBebanUkm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ukm_flKbKartuBebanUkm";
		this.maximize();
...
window.app_saku3_report_ukm_flKbKartuBebanUkm.extend(window.portalui_childForm);
window.app_saku3_report_ukm_flKbKartuBebanUkm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_ukm_rptKbKartuBebanUkm";
				this.dbLib.execQuerySync(this.sql);	
