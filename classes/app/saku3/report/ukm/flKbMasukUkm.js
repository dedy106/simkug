// JavaScript Document
window.app_saku3_report_ukm_flKbMasukUkm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ukm_flKbMasukUkm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ukm_flKbMasukUkm";
		this.maximize();
...
window.app_saku3_report_ukm_flKbMasukUkm.extend(window.portalui_childForm);
window.app_saku3_report_ukm_flKbMasukUkm.implement({
		...
		if (row == 2)
			{
				this.filterRep.ListDataSGFilter(this, "Data Akun",this.sg1, this.sg1.row, this.sg1.col,
													...
													"where a.block= '0' and b.kode_flag in ('048') and a.kode_curr='IDR' "+
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_ukm_rptKbMasukUkm";
				this.dbLib.execQuerySync(this.sql);	
