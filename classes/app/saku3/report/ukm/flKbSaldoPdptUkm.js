// JavaScript Document
window.app_saku3_report_ukm_flKbSaldoPdptUkm = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_ukm_flKbSaldoPdptUkm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_ukm_flKbSaldoPdptUkm";
		this.maximize();
...
window.app_saku3_report_ukm_flKbSaldoPdptUkm.extend(window.portalui_childForm);
window.app_saku3_report_ukm_flKbSaldoPdptUkm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku3_ukm_rptKbSaldoPdptUkm";
				this.dbLib.execQuerySync(this.sql);	
	...
	doOpenBb: function(kode_jurnal,kode_lokasi,periode,kode_pp){
		...
		nama_report="server_report_saku3_ukm_rptKbKartuMasukUkm";
