window.app_saku3_report_aka2_flAkAmorBatalJurnalTu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_aka2_flAkAmorBatalJurnalTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_aka2_flAkAmorBatalJurnalTu";
		this.maximize();
...
window.app_saku3_report_aka2_flAkAmorBatalJurnalTu.extend(window.childForm);
window.app_saku3_report_aka2_flAkAmorBatalJurnalTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_aka2_rptAkAmorBatalJurnalTu";
			...
			systemAPI.alert("[app_saku3_report_aka2_flAkAmorBatalJurnalTu]::mainButtonClick:"+e);
		}
	},
