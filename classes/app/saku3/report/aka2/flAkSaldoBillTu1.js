window.app_saku3_report_aka2_flAkSaldoBillTu1 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_aka2_flAkSaldoBillTu1.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_aka2_flAkSaldoBillTu1";
		this.maximize();
...
window.app_saku3_report_aka2_flAkSaldoBillTu1.extend(window.childForm);
window.app_saku3_report_aka2_flAkSaldoBillTu1.implement({
	...
	{		
		if (this.app._userStatus=="A")
		{		
			this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5],["3","36","123","123","123","3"]);
		}else{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5],["3","36","3","123","123","3"]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,5)+"/"+this.sg1.getCell(2,6)+"/"+sql_sub+"/"+this.sg1.getCell(3,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				this.nama_report = "server_report_saku3_aka2_rptAkSaldoBillTu1";
