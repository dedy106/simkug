window.app_saku3_report_aka2_flDwSaldoNim = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_aka2_flDwSaldoNim.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_aka2_flDwSaldoNim";
		this.maximize();
...
window.app_saku3_report_aka2_flDwSaldoNim.extend(window.childForm);
window.app_saku3_report_aka2_flDwSaldoNim.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_aka2_rptDwSaldoNim";
