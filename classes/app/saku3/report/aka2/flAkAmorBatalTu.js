window.app_saku3_report_aka2_flAkAmorBatalTu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_aka2_flAkAmorBatalTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_aka2_flAkAmorBatalTu";
		this.maximize();
...
window.app_saku3_report_aka2_flAkAmorBatalTu.extend(window.childForm);
window.app_saku3_report_aka2_flAkAmorBatalTu.implement({
