window.app_saku3_report_aka2_flAkBillBatalJurnalTu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_aka2_flAkBillBatalJurnalTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_aka2_flAkBillBatalJurnalTu";
		this.maximize();
...
window.app_saku3_report_aka2_flAkBillBatalJurnalTu.extend(window.childForm);
window.app_saku3_report_aka2_flAkBillBatalJurnalTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku3_report_aka2_flAkBillBatalJurnalTu]::mainButtonClick:"+e);
		}
	},
