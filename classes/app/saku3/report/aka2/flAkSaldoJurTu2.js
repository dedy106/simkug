window.app_saku3_report_aka2_flAkSaldoJurTu2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_aka2_flAkSaldoJurTu2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_aka2_flAkSaldoJurTu2";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("Tampil Saldo Nol","=","Tidak"));
	this.gridLib.SGEditData(this.sg1,5,new Array(0,1,2), new Array("Status Piutang","All",""));
		}else{
...
window.app_saku3_report_aka2_flAkSaldoJurTu2.extend(window.childForm);
window.app_saku3_report_aka2_flAkSaldoJurTu2.implement({
	...
	{		
		if (this.app._userStatus=="A")
		{
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5],["3","26","123","123","13","13"]);
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5],[2,0,2,2,0,0]);
		}else{
			
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5],["3","26","3","123","13","13"]);
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5],[2,0,2,2,0,0]);
		}	
		if (row == 1)
		{
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(3,1)+"/"+this.sg1.getCell(2,4)+"/"+this.sg1.getCell(2,5);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				this.nama_report = "server_report_saku3_aka2_rptAkSaldoJurTu2";
