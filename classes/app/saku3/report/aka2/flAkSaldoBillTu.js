window.app_saku3_report_aka2_flAkSaldoBillTu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_aka2_flAkSaldoBillTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_aka2_flAkSaldoBillTu";
		this.maximize();
	...
	if (this.app._userStatus=="A")
	{
		...
		this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("Tahun Akademik","All",""));
		this.gridLib.SGEditData(this.sg1,5,new Array(0,1,2), new Array("NIM","All",""));
		this.gridLib.SGEditData(this.sg1,6,new Array(0,1,2), new Array("Tampil Saldo Nol","=","Tidak"));
		this.gridLib.SGEditData(this.sg1,7,new Array(0,1,2), new Array("Tampilan Laporan","=","Layar"));	
		this.gridLib.SGEditData(this.sg1,8,new Array(0,1,2), new Array("Status Piutang","All",""));
	}else{
		this.gridLib.SGEditData(this.sg1,0,new Array(0,1,2), new Array("Lokasi","=",this.app._lokasi));
		this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Periode ","<=",this.periode));
...
window.app_saku3_report_aka2_flAkSaldoBillTu.extend(window.childForm);
window.app_saku3_report_aka2_flAkSaldoBillTu.implement({
		...
		try{			
			...
			if (row == 5)
			{
				...
				var filter=this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+
							 ...
							 this.filterRep.filterStr("a.tahunaka",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4)," and ");
			...
			if (row == 4)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Tahun Akademik",this.sg1, this.sg1.row, this.sg1.col,
														  "select distinct a.tahunaka from aka_tahunaka a  "+filter,
														  "select count(distinct a.tahunaka) from aka_tahunaka a "+filter,
														  ["a.tahunaka"],"and",["Tahun Akademik"]);
			}
	...
	{		
		if (this.app._userStatus=="A")
		{		
			this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6,7,8],["3","236","123","123","123","123","13","13","13"]);			
		}else{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6,7,8],["3","236","3","123","123","123","13","13","13"]);
		}
		...
		try
		{
			...
			else
			{
				...
				var sql_sub =this.filterRep.filterStr("x.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+
							 ...
							 this.filterRep.filterStr("y.nim",this.sg1.getCell(1,5),this.sg1.getCell(2,5),this.sg1.getCell(3,5)," and ");
				var filPeriod =this.filterRep.filterStr("periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1)," and ");
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,6)+"/"+this.sg1.getCell(2,7)+"/"+sql_sub+"/"+this.sg1.getCell(2,8)+"/"+this.sg1.getCell(3,1)+"/"+filPeriod;
				this.showFilter = this.filterRep.showFilter(this.sg1);
				this.nama_report = "server_report_saku3_aka2_rptAkSaldoBillTu";
