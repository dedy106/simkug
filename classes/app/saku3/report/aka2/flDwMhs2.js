window.app_saku3_report_aka2_flDwMhs2 = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_aka2_flDwMhs2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_aka2_flDwMhs2";
		this.maximize();
...
window.app_saku3_report_aka2_flDwMhs2.extend(window.childForm);
window.app_saku3_report_aka2_flDwMhs2.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_aka2_rptDwMhs2";
