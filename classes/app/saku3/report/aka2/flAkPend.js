window.app_saku3_report_aka2_flAkPend = function (owner) {
	if (owner) {
		window.app_saku3_report_aka2_flAkPend.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku3_report_aka2_flAkPend";
		this.maximize();
...
window.app_saku3_report_aka2_flAkPend.extend(window.childForm);
window.app_saku3_report_aka2_flAkPend.implement({
	...
	mainButtonClick: function (sender) {
		try {
			if (sender === this.app._mainForm.bClear2) {
				...
				this.nama_report = "server_report_saku3_aka2_rptAkPend";
