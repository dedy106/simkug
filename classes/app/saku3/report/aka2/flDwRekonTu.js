window.app_saku3_report_aka2_flDwRekonTu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_aka2_flDwRekonTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_aka2_flDwRekonTu";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,7,new Array(0,1,2), new Array("Pembatalan","=","Tidak"));
	this.gridLib.SGEditData(this.sg1,8,new Array(0,1,2), new Array("No Batal","All",""));
	}else{
	this.gridLib.SGEditData(this.sg1,0,new Array(0,1,2), new Array("Lokasi","=",this.app._lokasi));
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Periode ","=",this.periode));
	...
	this.gridLib.SGEditData(this.sg1,5,new Array(0,1,2), new Array("No Bukti","All",""));
	this.gridLib.SGEditData(this.sg1,6,new Array(0,1,2), new Array("Tampilan Laporan","=","Layar"));
	this.gridLib.SGEditData(this.sg1,7,new Array(0,1,2), new Array("Pembatalan","=","Ya"));
	this.gridLib.SGEditData(this.sg1,8,new Array(0,1,2), new Array("No Batal","All",""));
	}
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku3_report_aka2_flDwRekonTu.extend(window.childForm);
window.app_saku3_report_aka2_flDwRekonTu.implement({
	...
	{		
		if (this.app._userStatus=="A")
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6,7,8],["3","123","123","123","123","123","3","3","123"]);
		}else{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6,7,8],["3","123","3","123","123","123","3","3","123"]);
		}
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5,6,7],[2,0,2,2,2,2,0,0,2]);	
		if (row == 1)
		{
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							  ...
							  this.filterRep.filterStr("f.no_rekon",this.sg1.getCell(1,8),this.sg1.getCell(2,8),this.sg1.getCell(3,8),"and");
				this.filter2 = this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,6)+"/"+this.app._lokasi+"/"+this.sg1.getCell(2,7);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				this.nama_report = "server_report_saku3_aka2_rptDwRekonTu";
