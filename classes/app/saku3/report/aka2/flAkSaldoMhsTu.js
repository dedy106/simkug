window.app_saku3_report_aka2_flAkSaldoMhsTu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_aka2_flAkSaldoMhsTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_aka2_flAkSaldoMhsTu";
		this.maximize();
...
window.app_saku3_report_aka2_flAkSaldoMhsTu.extend(window.childForm);
window.app_saku3_report_aka2_flAkSaldoMhsTu.implement({
	...
	{		
		if (this.app._userStatus=="A")
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6,7,8],["3","26","123","123","123","3","3","13","13"]);
		}else{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6,7,8],["3","26","3","123","123","3","3","13","13"]);			
		}
		...
		try
		{
			...
			else
			{
		    	...
		    	this.filter =this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+
							 this.filterRep.filterStr("h.kode_fakultas",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2)," and ")+
							 this.filterRep.filterStr("a.kode_jur",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3)," and ")+
				...
				var sql_sub =this.filterRep.filterStr("x.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+
							 this.filterRep.filterStr("y.kode_fakultas",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2)," and ")+
							 this.filterRep.filterStr("y.kode_jur",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3)," and ")+
            ...
            var filterper = " and x.periode between '"+this.sg1.getCell(2,1)+"' and '"+this.sg1.getCell(3,1)+"' ";
				...
				this.nama_report = "server_report_saku3_aka2_rptAkSaldoMhsTu";
