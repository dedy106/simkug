window.app_saku3_report_aka2_flDwSaldoTahun = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_aka2_flDwSaldoTahun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_aka2_flDwSaldoTahun";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from exs_aka_saldo_tahun where kode_lokasi='"+this.app._lokasi+"' ");
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Tahuh Akademik","All",""));
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
	//this.pager=10;
	
};
window.app_saku3_report_aka2_flDwSaldoTahun.extend(window.childForm);
window.app_saku3_report_aka2_flDwSaldoTahun.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from exs_aka_saldo_tahun where kode_lokasi='"+this.app._lokasi+"' order by periode desc",[this.sg1.columns.get(2).pickList]);
		}
		...
		try
		{
			...
			else
			{
		    	...
		    	this.filter =this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+
							 ...
							 this.filterRep.filterStr("a.tahunaka",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2)," and ");
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				this.nama_report = "server_report_saku3_aka2_rptDwSaldoTahun";
