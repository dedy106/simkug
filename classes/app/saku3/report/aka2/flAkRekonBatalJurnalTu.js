window.app_saku3_report_aka2_flAkRekonBatalJurnalTu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_aka2_flAkRekonBatalJurnalTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_aka2_flAkRekonBatalJurnalTu";
		this.maximize();
...
window.app_saku3_report_aka2_flAkRekonBatalJurnalTu.extend(window.childForm);
window.app_saku3_report_aka2_flAkRekonBatalJurnalTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_aka2_rptAkRekonBatalJurnalTu";
			...
			systemAPI.alert("[app_saku3_report_aka2_flAkRekonBatalJurnalTu]::mainButtonClick:"+e);
		}
	},
