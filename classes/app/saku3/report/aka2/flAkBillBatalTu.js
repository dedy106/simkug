window.app_saku3_report_aka2_flAkBillBatalTu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_aka2_flAkBillBatalTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_aka2_flAkBillBatalTu";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from aka_batal_m where kode_lokasi='"+this.app._lokasi+"' ");
...
window.app_saku3_report_aka2_flAkBillBatalTu.extend(window.childForm);
window.app_saku3_report_aka2_flAkBillBatalTu.implement({
		...
		try{			
			...
			if (row ==5)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Invoice",this.sg1, this.sg1.row, this.sg1.col,
												...
												new Array("a.no_batal","a.keterangan"),"and",new Array("No Tagihan","Keterangan"));
			}			
		}catch(e){
			systemAPI.alert(e);
		}
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							  ...
							  this.filterRep.filterStr("a.no_batal",this.sg1.getCell(1,5),this.sg1.getCell(2,5),this.sg1.getCell(3,5),"and");
				...
				this.filter2 = this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,6)+"/"+filter2;
				this.showFilter = this.filterRep.showFilter(this.sg1);
				this.nama_report = "server_report_saku3_aka2_rptAkBillBatalTu";
	...
	doOpenJurnalBatal: function(nim,kode_lokasi,no_batal){
		
		this.nim=nim;
		this.kode_lokasi=kode_lokasi;
		this.no_batal=no_batal;
		this.link="1";
		filter = " where a.kode_lokasi = '"+kode_lokasi+"' and a.no_batal = '"+no_batal+"' ";
		filter2=this.sg1.getCell(2,1);
		nama_report="server_report_saku3_aka2_rptAkBillBatalJurnalTu";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
