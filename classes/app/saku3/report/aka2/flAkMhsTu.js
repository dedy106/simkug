window.app_saku3_report_aka2_flAkMhsTu = function (owner) {
	if (owner) {
		window.app_saku3_report_aka2_flAkMhsTu.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku3_report_aka2_flAkMhsTu";
		this.maximize();
	...
	if (this.app._userStatus=="A")
	{
			...
			this.gridLib.SGEditData(this.sg1, 4, new Array(0, 1, 2), new Array("NPM", "All", ""));
...
window.app_saku3_report_aka2_flAkMhsTu.extend(window.childForm);
window.app_saku3_report_aka2_flAkMhsTu.implement({
	...
	mainButtonClick: function (sender) {
		try {
			if (sender === this.app._mainForm.bClear2) {
				...
				this.nama_report = "server_report_saku3_aka2_rptAkMhsTu";
