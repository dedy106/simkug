window.app_saku3_report_aka2_flAkSaldoJurTu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_aka2_flAkSaldoJurTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_aka2_flAkSaldoJurTu";
		this.maximize();
...
window.app_saku3_report_aka2_flAkSaldoJurTu.extend(window.childForm);
window.app_saku3_report_aka2_flAkSaldoJurTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_aka2_rptAkSaldoJurTu";
