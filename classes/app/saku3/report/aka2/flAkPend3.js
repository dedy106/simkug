window.app_saku3_report_aka2_flAkPend3 = function (owner) {
	if (owner) {
		window.app_saku3_report_aka2_flAkPend3.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku3_report_aka2_flAkPend3";
		this.maximize();
...
window.app_saku3_report_aka2_flAkPend3.extend(window.childForm);
window.app_saku3_report_aka2_flAkPend3.implement({
	...
	mainButtonClick: function (sender) {
		try {
			if (sender === this.app._mainForm.bClear2) {
				...
				this.nama_report = "server_report_saku3_aka2_rptAkPend3";
