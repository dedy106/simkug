window.app_saku3_report_aka2_flDwBill = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_aka2_flDwBill.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_aka2_flDwBill";
		this.maximize();
...
window.app_saku3_report_aka2_flDwBill.extend(window.childForm);
window.app_saku3_report_aka2_flDwBill.implement({
