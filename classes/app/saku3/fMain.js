...
//* 			SAI, PT											
//***********************************************************************************************
window.app_saku3_fMain = function(owner)
{
	if (owner)
	{	
		try
		{
			window.app_saku3_fMain.prototype.parent.constructor.call(this, owner);			
...
window.app_saku3_fMain.extend(window.form);
window.app_saku3_fMain.implement({
...
//--------------------------------`------------------
	...
	gotoLogin: function(){
		uses("app_saku3_fLogin");
		this.form = new app_saku3_fLogin(this);
	...
	initDashboard: function(){		
		try{
			...
			var nama_report=this.app._dash;
			this.filter="";
			this.showFilter = "";
			this.lokasi = "";
			this.filter2 = this.app._lokasi+"/"+this.app._periode+"/"+this.app._kodePP+"/"+this.app._userLog+"/"+this.app._kodeFs;
	...
	bTutupClick: function(sender){	
		try{			
			this.pReport.hide();
			this.bDraft.hide();
			if (this.form instanceof app_saku3_fLogin && sender == this.bExit){
				return false;
			}			
			if (this.form == undefined){
