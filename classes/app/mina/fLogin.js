...
//* 			SAI, PT											
//***********************************************************************************************
window.app_mina_fLogin = function(owner){
	if (owner){
		try{		
			window.app_mina_fLogin.prototype.parent.constructor.call(this, owner);
			this.className  = "app_mina_fLogin";			
			...
			systemAPI.alert("[app_mina_fLogin]::oncreate lib : ",e);
		}
	}
};
window.app_mina_fLogin.extend(window.childForm);
window.app_mina_fLogin.implement({
