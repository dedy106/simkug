...
//* 			SAI, PT											
//***********************************************************************************************
window.app_fileExplorer_app = function(owner){
	window.app_fileExplorer_app.prototype.parent.constructor.call(this, owner);
	this.className = "app_fileExplorer_app";
	this.onTerminate.set(this,"doTerminate");
	this.form = undefined;
	this.setTitle("File Browser");
	this.showForm();
};
window.app_fileExplorer_app.extend(window.application);
window.app_fileExplorer_app.implement({
	showForm: function(){
		try
		{
			...
			this._rfcCall = true;			
			this._mainForm = new app_fileExplorer_fMain(this);	
	...
	doKeyDown: function(charCode, buttonState, keyCode, event){
		try{			
			window.app_fileExplorer_app.prototype.parent.doKeyDown.call(this, charCode, buttonState, keyCode, event);
