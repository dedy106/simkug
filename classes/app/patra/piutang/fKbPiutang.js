window.app_patra_piutang_fKbPiutang = function(owner)
{
	if (owner)
	{
		window.app_patra_piutang_fKbPiutang.prototype.parent.constructor.call(this,owner);
		this.className  = "app_patra_piutang_fKbPiutang";
		...
		this.c_curr = new saiCB(this,{bound:[20,19,180,20],caption:"Curr - Kurs",items:["IDR","USD"], maxLength:3, tag:2,change:[this,"doChange"]});
		...
		this.cb_piutang = new saiCBBL(this,{bound:[20,17,220,20],caption:"No Bukti AR", multiSelection:false, maxLength:10, tag:2,change:[this,"doChange"]});				
		this.e_totcurr = new saiLabelEdit(this,{bound:[700,17,220,20],caption:"Nilai KB Original", tag:1, readOnly:true, tipeText:ttNilai, text:"0"});		
		...
		this.e_total = new saiLabelEdit(this,{bound:[700,18,220,20],caption:"Nilai KB Konvensi", tag:1, readOnly:true, tipeText:ttNilai, text:"0"});		
...
window.app_patra_piutang_fKbPiutang.extend(window.childForm);
window.app_patra_piutang_fKbPiutang.implement({
	...
	doChange:function(sender){
		...
		if ((sender == this.cb_cust && this.cb_cust.getText()!="") || (sender == this.c_curr && this.c_curr.getText()!="")) {			
			this.cb_piutang.setText("","");
			this.cb_piutang.setSQL("select a.no_ar,(a.no_dokumen+'-'+a.keterangan) as keterangan from patra_ar_m a "+
								   ...
								   "            union "+
								   "            select no_ar,kode_lokasi,sum(nilai_curr) as bayar from patra_kaspiutang_d where jenis = 'AR' group by no_ar,kode_lokasi) b on a.no_ar=b.no_ar and a.kode_lokasi=b.kode_lokasi "+
								   "where a.kode_cust='"+this.cb_cust.getText()+"' and a.kode_curr ='"+this.c_curr.getText()+"' and (a.nilai_curr+a.ppn_curr) > isnull(b.bayar,0) and a.periode<='"+this.e_periode.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"'",
								   ["no_ar","keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti Piutang",true);
		}
