window.app_patra_report_flPiutang = function(owner)
{
	if (owner)
	{
		window.app_patra_report_flPiutang.prototype.parent.constructor.call(this,owner);
		this.className = "app_patra_report_flPiutang";
		this.maximize();
...
window.app_patra_report_flPiutang.extend(window.childForm);
window.app_patra_report_flPiutang.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_patra_rptPiutang";
			...
			systemAPI.alert("[app_patra_report_flPiutang]::mainButtonClick:"+e);
		}
	},
