window.app_patra_report_flVendor = function(owner)
{
	if (owner)
	{
		window.app_patra_report_flVendor.prototype.parent.constructor.call(this,owner);
		this.className = "app_patra_report_flVendor";
		this.maximize();
...
window.app_patra_report_flVendor.extend(window.childForm);
window.app_patra_report_flVendor.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_patra_rptVendor";
			...
			systemAPI.alert("[app_patra_report_flVendor]::mainButtonClick:"+e);
		}
	},
