window.app_patra_report_flHutangKartu = function(owner)
{
	if (owner)
	{
		window.app_patra_report_flHutangKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_patra_report_flHutangKartu";
		this.maximize();
...
window.app_patra_report_flHutangKartu.extend(window.childForm);
window.app_patra_report_flHutangKartu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_patra_rptHutangKartu";
			...
			systemAPI.alert("[app_patra_report_flHutangKartu]::mainButtonClick:"+e);
		}
	},
