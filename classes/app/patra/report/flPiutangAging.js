window.app_patra_report_flPiutangAging = function(owner)
{
	if (owner)
	{
		window.app_patra_report_flPiutangAging.prototype.parent.constructor.call(this,owner);
		this.className = "app_patra_report_flPiutangAging";
		this.maximize();
...
window.app_patra_report_flPiutangAging.extend(window.childForm);
window.app_patra_report_flPiutangAging.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_patra_rptPiutangAging";
			...
			systemAPI.alert("[app_patra_report_flPiutangAging]::mainButtonClick:"+e);
		}
	},
