window.app_patra_report_flHutang = function(owner)
{
	if (owner)
	{
		window.app_patra_report_flHutang.prototype.parent.constructor.call(this,owner);
		this.className = "app_patra_report_flHutang";
		this.maximize();
...
window.app_patra_report_flHutang.extend(window.childForm);
window.app_patra_report_flHutang.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_patra_rptHutang";
			...
			systemAPI.alert("[app_patra_report_flHutang]::mainButtonClick:"+e);
		}
	},
