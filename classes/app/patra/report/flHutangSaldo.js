window.app_patra_report_flHutangSaldo = function(owner)
{
	if (owner)
	{
		window.app_patra_report_flHutangSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_patra_report_flHutangSaldo";
		this.maximize();
...
window.app_patra_report_flHutangSaldo.extend(window.childForm);
window.app_patra_report_flHutangSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_patra_rptHutangSaldo";
			...
			systemAPI.alert("[app_patra_report_flHutangSaldo]::mainButtonClick:"+e);
		}
	},
	...
	doOpenJurnal: function(no_bukti,kode_lokasi){
		...
		nama_report="server_report_patra_rptHutangJurnal";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
	...
	doOpenKas: function(no_bukti,kode_lokasi){
		...
		filter2=this.app._namaUser;
		nama_report="server_report_patra_rptKbJurnal";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
