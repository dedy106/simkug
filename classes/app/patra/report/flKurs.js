window.app_patra_report_flKurs = function(owner)
{
	if (owner)
	{
		window.app_patra_report_flKurs.prototype.parent.constructor.call(this,owner);
		this.className = "app_patra_report_flKurs";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Kode Curr","All",""));
...
window.app_patra_report_flKurs.extend(window.childForm);
window.app_patra_report_flKurs.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row ==	1)
			{
				this.filterRep.ListDataSGFilter(this, "Data Krs",this.sg1, this.sg1.row, this.sg1.col,
														  "select kode_curr, nama from gr_kurs "+
														   this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  "select count(kode_curr) from gr_kurs "+
														  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  new Array("kode_curr","nama"),"and");
			}
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.kode_curr",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");
				this.filter2 = this.sg1.getCell(2,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_patra_rptKurs";
			...
			systemAPI.alert("[app_patra_report_flKurs]::mainButtonClick:"+e);
		}
	},
