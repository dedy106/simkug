window.app_patra_report_flCust = function(owner)
{
	if (owner)
	{
		window.app_patra_report_flCust.prototype.parent.constructor.call(this,owner);
		this.className = "app_patra_report_flCust";
		this.maximize();
...
window.app_patra_report_flCust.extend(window.childForm);
window.app_patra_report_flCust.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_patra_rptCust";
			...
			systemAPI.alert("[app_patra_report_flCust]::mainButtonClick:"+e);
		}
	},
