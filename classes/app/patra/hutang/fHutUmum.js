window.app_patra_hutang_fHutUmum = function(owner)
{
	if (owner)
	{
		window.app_patra_hutang_fHutUmum.prototype.parent.constructor.call(this,owner);		
		this.className  = "app_patra_hutang_fHutUmum";
		...
		this.pc1 = new pageControl(this,{bound:[20,12,980,250], childPage:["Data Item Jurnal","Data Anggaran"]});
...
window.app_patra_hutang_fHutUmum.extend(window.childForm);
window.app_patra_hutang_fHutUmum.implement({
	...
	doChange:function(sender){					
		if (sender == this.cb_pp && this.cb_pp.getText() != "") this.doClick();
	...
	doClick:function(sender){
		if (this.e_periode.getText()!= "" ) {	
			this.e_nb.setText(this.standarLib.noBuktiOtomatis(this.dbLib,"patra_hutang_m","no_hutang",this.app._lokasi+"-HUT"+this.e_periode.getText().substr(2,4)+".","000"));
			this.e_dok.setFocus();
		}
	},	
					...
					case "execArraySQL" :	    				
						if (result.toLowerCase().search("error") == -1){
							if (this.cb1.isSelected()) {								
								this.nama_report="server_report_patra_rptHutangJurnal";
