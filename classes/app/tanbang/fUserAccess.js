window.app_assetsap_fUserAccess = function(owner)
{
	if (owner)
	{
		window.app_assetsap_fUserAccess.prototype.parent.constructor.call(this,owner);
		this.className  = "app_assetsap_fUserAccess";
		this.maximize();
...
window.app_assetsap_fUserAccess.extend(window.portalui_childForm);
window.app_assetsap_fUserAccess.implement({
