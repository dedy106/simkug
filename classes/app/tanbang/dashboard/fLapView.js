 ...
 * @author dweexfuad
 */
window.app_assetsap_dashboard_fLapView = function(owner,options, callObj)
{
    if (owner)
    {	
		try{
	        window.app_assetsap_dashboard_fLapView.prototype.parent.constructor.call(this, owner,options);        
            this.className = "app_assetsap_dashboard_fLapView";
...
window.app_assetsap_dashboard_fLapView.extend(window.childForm);
window.app_assetsap_dashboard_fLapView.implement({    
