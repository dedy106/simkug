window.app_tanbang_master_fKodya = function(owner)
{
	if (owner)
	{
		window.app_tanbang_master_fKodya.prototype.parent.constructor.call(this,owner);
		this.className  = "app_tanbang_master_fKodya";
		this.maximize();
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Data Kodya", 0);	
//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
		try
		{		
			...
			this.ed_kode = new saiCBBL(this, {
				...
				sql:["select a.kode_kodya, a.nama,a.kode_prop, b.nama as nmprop  from amu_kodya a inner join amu_propinsi b on b.kode_prop = a.kode_prop and b.kode_lokasi = a.kode_lokasi where a.kode_lokasi = '"+this.app._lokasi+"' ", ["kode_kodya", "nama","kode_prop","nmprop"], false, ["Kode Kodya","Nama","Kode Propinsi","Nama Propinsi"], "and", "Daftar Kodya",false]
			});			
...
window.app_tanbang_master_fKodya.extend(window.childForm);
//------------------------------------------------------------------ event
window.app_tanbang_master_fKodya.implement({
