window.app_assetsap_master_fKecamatan = function(owner)
{
	if (owner)
	{
		window.app_assetsap_master_fKecamatan.prototype.parent.constructor.call(this,owner);
		this.className  = "app_assetsap_master_fKecamatan";
		this.maximize();
...
window.app_assetsap_master_fKecamatan.extend(window.childForm);
//------------------------------------------------------------------ event
window.app_assetsap_master_fKecamatan.implement({
