window.app_tanbang_master_fPropinsi = function(owner)
{
	if (owner)
	{
		window.app_tanbang_master_fPropinsi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_tanbang_master_fPropinsi";
		this.maximize();
...
window.app_tanbang_master_fPropinsi.extend(window.childForm);
//------------------------------------------------------------------ event
window.app_tanbang_master_fPropinsi.implement({
