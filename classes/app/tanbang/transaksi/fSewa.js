window.app_tanbang_transaksi_fSewa = function(owner) {
	if (owner){
		window.app_tanbang_transaksi_fSewa.prototype.parent.constructor.call(this,owner);
		this.maximize();
		this.className  = "app_tanbang_transaksi_fSewa";		
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Penggunaan Ruangan", 0);	
		...
		this.cb_ruang = new saiCBBL(this,{bound:[20,12,200,20], caption:"Ruag"});				
		this.ed_jml = new saiLabelEdit(this,{bound:[20,14,200,20], caption:"Max Orang"});						
		this.cb_cust = new saiCBBL(this,{bound:[20,21,200,20], caption:"Penghuni"});
		this.ed_kontrak = new saiLabelEdit(this,{bound:[20,12,200,20], caption:"No Kontrak"});
		...
		this.cb_untuk = new saiCBBL(this,{bound:[20,21,200,20], caption:"Peruntukan"});
		this.cb_guna = new saiCBBL(this,{bound:[20,22,200,20], caption:"Penggunaan"});
		...
		this.p2 = new panel(this,{bound:[450,240,400,230],caption:"Fasilitas"});
		this.sg2 = new saiGrid(this.p1,{bound:[1,20,395,180],colCount:2,colTitle:["Jabatan","Jumlah"],
					colWidth:[[1,0],[100,100]], readOnly:true, change:[this,"doGridChange"], tag:3});		
		this.sgn2 = new sgNavigator(this.p2,{bound:[1,this.p1.height - 25,395,25],buttonStyle:1, grid:this.sg2});
...
window.app_tanbang_transaksi_fSewa.extend(window.childForm);
window.app_tanbang_transaksi_fSewa.implement({	
	...
	doClick: function(sender){
		this.ed_kode.setText(this.standarLib.noBuktiOtomatis(this.dbLib,'tb_ruang','kode_ruang',"R"+this.ed_Periode.getText().substring(2)+"/",'0000'));
	},
