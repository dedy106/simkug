...
//* 			SAI, PT											
//***********************************************************************************************
window.app_saku2_fMain2 = function(owner)
{
	if (owner)
	{	
		try
		{
			window.app_saku2_fMain2.prototype.parent.constructor.call(this, owner);
			window.app_saku2_fMain2.prototype.parent.setWidth.call(this, 600);
			window.app_saku2_fMain2.prototype.parent.setHeight.call(this, 450);
			this._mainButtonClick = new portalui_eventHandler();			
			this.title = "SISFOKUG";
			document.title = "SISFOKUG";
			this._isLogedIn	= false;
			this.app._kodeMenu = "SISFOKUG";
			this._userLog = "";
			this._lokasi = "";
			this._pp = "";
			...
			this.centerize();							
			uses("saiCB;panelWidget;saiLabelEdit;image;imageButton;button;timer;label;saiCBBL;panel;reportNavigator;treeView;treeNode;statusBar;marquee;util_addOnLib;util_standar;imageButton");					
			this.className  = "fMain2";			
			this.formCaption = "SISFOKUG";	
...
//-------------------------------------caption		
			...
			this.lblCaption = new label(this.pCaption,{bound:[10,2,500,22],caption:this.formCaption,fontColor:system.getConfig("app.headerColor"),bold:true,italics:true,fontSize:14});						
////------------------------------------ panel button -------------------------		
...
//--------------------------------------------------
			...
			//Logo pojok kanan
			this.setImage("url(image/themes/"+system.getThemes()+"/logoyakes.png)");
			...
			this.infoUnit = new control(this,{bound:[this.treev.width + 30,this.treev.top + this.treev.height - 60,this.width - this.treev.width - 40,60]});
...
window.app_saku2_fMain2.extend(window.form);
window.app_saku2_fMain2.implement({
	gotoLogin: function(){
		uses("app_saku2_fLogin2");
		this.form = new app_saku2_fLogin2(this);
	...
	doAfterLogin: function(){
		try{		    
			...
			this.bTutup.click();
			this.unblock();	
			this.sb.setText1(this.app._lokasi +" - "+this.app._namalokasi);
			this.sb.setText2("Periode "+this.app._periode);
			...
			this.listInfo = new panel(this,{bound:[this.getWidth() - 325,55,300,200],caption:"User Info",color:"url(icon/"+system.getThemes()+"/background.png)",visible:false});
				
				this.lUser = new label(this.listInfo,{bound:[10,5,80,18],fontColor:"#0000ff",underline:true,caption:"User Login"});				
				this.lUser1 = new label(this.listInfo,{bound:[90,5,this.listInfo.width - 90,18],fontColor:"#0000ff",caption:this.app._userLog});				
				this.lPrd = new label(this.listInfo,{bound:[10,25,80,18],fontColor:"#0000ff",underline:true,caption:"Periode"});				
				this.lPrd1 = new label(this.listInfo,{bound:[90,25,this.listInfo.width - 90,18],fontColor:"#0000ff",caption:this.app._periode});				
				this.lTime = new label(this.listInfo,{bound:[10,45,80,18],fontColor:"#0000ff",underline:true,caption:"Login Time"});				
				this.app._loginTime = new Date();
				this.lTime1 = new label(this.listInfo,{bound:[90,45,this.listInfo.width - 90,18],fontColor:"#0000ff",caption:dayName[this.app._loginTime.getDay()] +" "+this.app._loginTime.getDate()+"/"+this.app._loginTime.getBln()+"/"+this.app._loginTime.getFullYear()+" "+this.app._loginTime.getHours()+":"+this.app._loginTime.getMinutes()});				
				this.lLok = new label(this.listInfo,{bound:[10,65,80,18],fontColor:"#0000ff",underline:true,caption:"User Location"});				
				this.lLok1 = new label(this.listInfo,{bound:[90,65,this.listInfo.width - 90,18],fontColor:"#0000ff",caption:this.app._lokasi});				
				this.lPP = new label(this.listInfo,{bound:[10,85,80,18],fontColor:"#0000ff",underline:true,caption:"User Office"});
				this.lPP1 = new label(this.listInfo,{bound:[90,85,this.listInfo.width - 90,18],fontColor:"#0000ff",caption:this.app._kodePP});				
				this.ldb = new label(this.listInfo,{bound:[10,105,80,18],fontColor:"#0000ff",underline:true,caption:"Database"});
				this.ldb1 = new label(this.listInfo,{bound:[90,105,this.listInfo.width - 90,18],fontColor:"#0000ff",caption:this.app._dbname});				
				this.ldb = new label(this.listInfo,{bound:[10,125,80,18],fontColor:"#0000ff",underline:true,caption:"Host"});
				this.ldb2 = new label(this.listInfo,{bound:[90,125,this.listInfo.width - 90,18],fontColor:"#0000ff",caption:clientInfo.host});				
				this.ldb = new label(this.listInfo,{bound:[10,145,80,18],fontColor:"#0000ff",underline:true,caption:"My Comp"});
				this.ldb2 = new label(this.listInfo,{bound:[90,145,this.listInfo.width - 90,18],fontColor:"#0000ff",caption:this.app._hostname});				
				this.ldb = new label(this.listInfo,{bound:[10,165,80,18],fontColor:"#0000ff",underline:true,caption:"Session"});
				this.ldb2 = new label(this.listInfo,{bound:[90,165,this.listInfo.width - 90,18],fontColor:"#0000ff",caption:this.app._userSession});				
			...
			this.infoPerusahaan.getCanvas().innerHTML = "<table border=0 cellspacing=0 cellpadding=0 width='100%'>"+
					...
					"</td></tr>"+
					"<tr><td align='center' >"+
					"<img src='image/yakes.png' width='500' height='150'/>"+
					"</td></tr>"+
					"<tr><td height='30'></td></tr>"+					
					"<tr><td align='center'>"+
					"<span style='font-size:20pt;font-weight:bold;color:#299bcf;font-family:Arial, Helvetica, Sans-serif;'> SISFOKUG </span>"+
					"</td></tr>"+
					"<tr><td align='center'>"+
					"<span style='font-size:14pt;font-weight:bold;color:#ff9900;font-family:Arial, Helvetica, Sans-serif;'> Sistem Informasi Keuangan</span>"+
					"</td></tr>"+
					"<tr><td align='center' height='100' valign='bottom'>"+
					"<span style='font-size:12pt;font-weight:bold;color:#64b264;font-family:Arial, Helvetica, Sans-serif;'> Selamat Bekerja</span>"+
					"</td></tr>"+
					"<tr><td align='center' height='30' valign='bottom'>"+
					"<span style='font-size:12pt;font-weight:bold;color:#299bcf;font-family:Arial, Helvetica, Sans-serif;'>"+this.app._namaUser+" - "+ this.app._userLog+"</span>"+
					"</td></tr>"+
					" </table>";
	...
	getUserMenu: function(kodeMenu){  		   
	   this.dbLib.getDataXMLA("select * from menu where kode_klp = '"+this.app._kodeMenu+"'   order by kode_klp, rowindex");			
	},
