window.app_saku2_fUser = function(owner)
{
	if (owner)
	{
		window.app_saku2_fUser.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_fUser";
...
window.app_saku2_fUser.extend(window.childForm);
window.app_saku2_fUser.implement({
