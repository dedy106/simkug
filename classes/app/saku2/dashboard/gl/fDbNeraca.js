window.app_saku2_dashboard_gl_fDbNeraca = function(owner)
{
	if (owner)
	{
		window.app_saku2_dashboard_gl_fDbNeraca.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_dashboard_gl_fDbNeraca";
...
window.app_saku2_dashboard_gl_fDbNeraca.extend(window.childForm);
window.app_saku2_dashboard_gl_fDbNeraca.implement({
