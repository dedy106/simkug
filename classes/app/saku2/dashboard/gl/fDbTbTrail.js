window.app_saku2_dashboard_gl_fDbTbTrail = function(owner)
{
	if (owner)
	{
		window.app_saku2_dashboard_gl_fDbTbTrail.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_dashboard_gl_fDbTbTrail";
...
window.app_saku2_dashboard_gl_fDbTbTrail.extend(window.childForm);
window.app_saku2_dashboard_gl_fDbTbTrail.implement({
