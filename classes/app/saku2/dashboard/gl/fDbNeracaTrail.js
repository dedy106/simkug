window.app_saku2_dashboard_gl_fDbNeracaTrail = function(owner)
{
	if (owner)
	{
		window.app_saku2_dashboard_gl_fDbNeracaTrail.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_dashboard_gl_fDbNeracaTrail";
		...
		this.pc1 = new pageControl(this,{bound:[15,12,900,500], childPage:["Filter","Aktiva","Pasiva","Laba Rugi","Neraca Percobaan","Buku Besar","Jurnal Transaksi","Memo Jurnal"]});
		...
		this.sgn4 = new portalui_sgNavigator(this.pc1.childPage[1],{bound:[1,this.pc1.height-25,this.pc1.width-1,25],buttonStyle:bsViewExt,grid:this.sg,pager:[this,"doPager4"]});		
		...
		this.sgn5 = new portalui_sgNavigator(this.pc1.childPage[2],{bound:[1,this.pc1.height-25,this.pc1.width-1,25],buttonStyle:bsViewExt,grid:this.sg,pager:[this,"doPager5"]});		
		...
		this.sgn6 = new portalui_sgNavigator(this.pc1.childPage[3],{bound:[1,this.pc1.height-25,this.pc1.width-1,25],buttonStyle:bsViewExt,grid:this.sg,pager:[this,"doPager6"]});		
		...
		this.bPrint = new imageButton(this.pc1.childPage[7],{bound:[800,0,22,20], hint:"Print", image:"icon/"+system.getThemes()+"/print.png",click:[this,"doPrintClick"]});
		this.bExcel = new imageButton(this.pc1.childPage[7],{bound:[823,0,22,20], hint:"Excel", image:"icon/"+system.getThemes()+"/excel.png", click:[this,"doPrintClick"]});
		this.bEmail = new imageButton(this.pc1.childPage[7],{bound:[846,0,22,20], hint:"Email", image:"icon/"+system.getThemes()+"/sendMail.png",click:[this,"doPrintClick"]});
...
window.app_saku2_dashboard_gl_fDbNeracaTrail.extend(window.childForm);
window.app_saku2_dashboard_gl_fDbNeracaTrail.implement({
	...
	doDoubleClick3: function(sender, col , row) 
	{
		try{
			...
			{
				this.filter2=" where a.no_ptg='"+no_bukti+"'";
			...
			{
				this.filter2=" where a.no_bukti='"+no_bukti+"'";
	...
	doPager6: function(sender, page) {
		this.doTampilData6(page);
	}
});