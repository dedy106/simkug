window.app_saku2_dashboard_gl_fDbNeracaPpTrail = function(owner)
{
	if (owner)
	{
		window.app_saku2_dashboard_gl_fDbNeracaPpTrail.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_dashboard_gl_fDbNeracaPpTrail";
...
window.app_saku2_dashboard_gl_fDbNeracaPpTrail.extend(window.childForm);
window.app_saku2_dashboard_gl_fDbNeracaPpTrail.implement({
	...
	mainButtonClick:function(sender)
	{
		try
		{
			...
			else
			{
				...
				sql="call sp_neraca_pp ('"+this.sg1.getCell(2,2)+"','L','S',5,'"+this.sg1.getCell(2,1)+"','"+this.kode_lokasi+"','"+this.kode_lokasi1+"','"+this.kode_lokasi2+"','"+this.app._nikUser+"','"+this.kode_pp1+"','"+this.kode_pp2+"')";
	...
	{
		var sql = "call sp_glma_pp_trail_tmp ('"+kode_neraca+"','"+this.kode_lokasi+"','"+this.kode_lokasi1+"','"+this.kode_lokasi2+"','"+this.sg1.getCell(2,1)+"','"+this.app._nikUser+"','"+this.sg1.getCell(2,3)+"')";
	...
	doDoubleClick: function(sender, col , row) 
	{
		if (this.sg.cells(4,row)!=0 || this.sg.cells(5,row)!=0)
		{
			...
			var sql = "call sp_bb_pp ('"+this.sg.cells(0,row)+"','"+this.sg.cells(0,row)+"','"+this.sg1.getCell(2,0)+"','"+this.sg1.getCell(2,1)+"','"+this.sg1.getCell(2,1)+"','"+this.app._nikUser+"','0','"+this.sg1.getCell(2,3)+"')";
			this.dbLib.execQuerySync(sql);	
