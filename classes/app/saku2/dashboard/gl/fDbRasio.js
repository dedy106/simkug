window.app_saku2_dashboard_gl_fDbRasio = function(owner)
{
	if (owner)
	{
		window.app_saku2_dashboard_gl_fDbRasio.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_dashboard_gl_fDbRasio";
...
window.app_saku2_dashboard_gl_fDbRasio.extend(window.childForm);
window.app_saku2_dashboard_gl_fDbRasio.implement({
