window.app_saku2_dashboard_gl_fDbNeracaGar = function(owner)
{
	if (owner)
	{
		window.app_saku2_dashboard_gl_fDbNeracaGar.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_dashboard_gl_fDbNeracaGar";
...
window.app_saku2_dashboard_gl_fDbNeracaGar.extend(window.childForm);
window.app_saku2_dashboard_gl_fDbNeracaGar.implement({
