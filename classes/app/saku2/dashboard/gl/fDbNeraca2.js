window.app_saku2_dashboard_gl_fDbNeraca2 = function(owner)
{
	if (owner)
	{
		window.app_saku2_dashboard_gl_fDbNeraca2.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_dashboard_gl_fDbNeraca2";
...
window.app_saku2_dashboard_gl_fDbNeraca2.extend(window.childForm);
window.app_saku2_dashboard_gl_fDbNeraca2.implement({
