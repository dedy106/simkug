window.app_saku2_dashboard_gl_fDbNeracaTrailKonsol = function(owner)
{
	if (owner)
	{
		window.app_saku2_dashboard_gl_fDbNeracaTrailKonsol.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_dashboard_gl_fDbNeracaTrailKonsol";
		...
		this.pc1 = new pageControl(this,{bound:[15,12,900,500], childPage:["Filter","Aktiva","Pasiva","Labarugi","TB Summary","TB Detail","TB Lokasi","Buku Besar","Jurnal Transaksi","Memo Jurnal"]});
		...
		{
			this.periode=this.app._periode
		}
		...
		this.sg6 = new saiGrid(this.pc1.childPage[1],{bound:[1,10,this.pc1.width-5,this.pc1.height-40],colCount:7,tag:0,
		            colTitle:["Kode Neraca","Uraian","Lokasi","Saldo Awal","Debet","Kredit","Saldo Akhir"],
		...
		this.sgn6 = new portalui_sgNavigator(this.pc1.childPage[1],{bound:[1,this.pc1.height-25,250,25],buttonStyle:4,grid:this.sg,pager:[this,"doPager"]});		
		this.sg7 = new saiGrid(this.pc1.childPage[2],{bound:[1,10,this.pc1.width-5,this.pc1.height-40],colCount:7,tag:0,
		            colTitle:["Kode Neraca","Uraian","Lokasi","Saldo Awal","Debet","Kredit","Saldo Akhir"],
					colWidth:[[6,5,4,3,2,1,0],[110,110,110,110,40,280,80]],
					colFormat:[[3,4,5,6],[cfNilai,cfNilai,cfNilai,cfNilai]],readOnly: true,defaultRow:1,
					dblClick:[this,"doDoubleClick7"]});
		this.sgn7 = new portalui_sgNavigator(this.pc1.childPage[2],{bound:[1,this.pc1.height-25,250,25],buttonStyle:4,grid:this.sg,pager:[this,"doPager"]});		
		this.sg8 = new saiGrid(this.pc1.childPage[3],{bound:[1,10,this.pc1.width-5,this.pc1.height-40],colCount:7,tag:0,
		            colTitle:["Kode Neraca","Uraian","Lokasi","Saldo Awal","Debet","Kredit","Saldo Akhir"],
					colWidth:[[6,5,4,3,2,1,0],[110,110,110,110,40,280,80]],
					colFormat:[[3,4,5,6],[cfNilai,cfNilai,cfNilai,cfNilai]],readOnly: true,defaultRow:1,
					dblClick:[this,"doDoubleClick8"]});
		this.sgn8 = new portalui_sgNavigator(this.pc1.childPage[3],{bound:[1,this.pc1.height-25,250,25],buttonStyle:4,grid:this.sg,pager:[this,"doPager"]});		

		this.sg = new saiGrid(this.pc1.childPage[4],{bound:[1,10,this.pc1.width-5,this.pc1.height-40],colCount:7,tag:0,
		            colTitle:["Kode Akun","Nama Akun","Lokasi","Saldo Awal","Debet","Kredit","Saldo Akhir"],
					colWidth:[[6,5,4,3,2,1,0],[110,110,110,110,40,280,80]],
					colFormat:[[3,4,5,6],[cfNilai,cfNilai,cfNilai,cfNilai]],readOnly: true,defaultRow:1,
					dblClick:[this,"doDoubleClick"]});
		this.sgn = new portalui_sgNavigator(this.pc1.childPage[4],{bound:[1,this.pc1.height-25,250,25],buttonStyle:4,grid:this.sg,pager:[this,"doPager"]});		
		...
		this.sg2 = new saiGrid(this.pc1.childPage[7],{bound:[1,11,this.pc1.width-5,this.pc1.height-63],colCount:9,tag:9,
		...
		this.sgn2 = new portalui_sgNavigator(this.pc1.childPage[7],{bound:[1,this.pc1.height-25,this.pc1.width-1,25],buttonStyle:bsViewExt,grid:this.sg2,pager:[this,"doPager2"]});
		
		this.sg3 = new saiGrid(this.pc1.childPage[8],{bound:[1,10,this.pc1.width-5,this.pc1.height-40],colCount:10,tag:9,
		...
		this.sgn3 = new portalui_sgNavigator(this.pc1.childPage[8],{bound:[1,this.pc1.height-25,this.pc1.width-1,25],buttonStyle:bsViewExt,grid:this.sg3,pager:[this,"doPager3"]});
		
		this.sg4 = new saiGrid(this.pc1.childPage[5],{bound:[1,10,this.pc1.width-5,this.pc1.height-40],colCount:7,tag:0,
		            colTitle:["Kode Akun","Nama Akun","Lokasi","Saldo Awal","Debet","Kredit","Saldo Akhir"],
					colWidth:[[6,5,4,3,2,1,0],[110,110,110,110,40,280,80]],
					colFormat:[[3,4,5,6],[cfNilai,cfNilai,cfNilai,cfNilai]],readOnly: true,defaultRow:1,
					dblClick:[this,"doDoubleClick4"]});
		this.sgn4 = new portalui_sgNavigator(this.pc1.childPage[5],{bound:[1,this.pc1.height-25,250,25],buttonStyle:4,grid:this.sg,pager:[this,"doPager"]});		

		this.sg5 = new saiGrid(this.pc1.childPage[6],{bound:[1,10,this.pc1.width-5,this.pc1.height-40],colCount:7,tag:0,
		            colTitle:["Kode Akun","Nama Akun","Lokasi","Saldo Awal","Debet","Kredit","Saldo Akhir"],
					colWidth:[[6,5,4,3,2,1,0],[110,110,110,110,40,280,80]],
					colFormat:[[3,4,5,6],[cfNilai,cfNilai,cfNilai,cfNilai]],readOnly: true,defaultRow:1,
					dblClick:[this,"doDoubleClick5"]});
		this.sgn5 = new portalui_sgNavigator(this.pc1.childPage[6],{bound:[1,this.pc1.height-25,250,25],buttonStyle:4,grid:this.sg,pager:[this,"doPager"]});		
		...
		this.bPrint = new imageButton(this.pc1.childPage[9],{bound:[800,0,22,20], hint:"Print", image:"icon/"+system.getThemes()+"/print.png",click:[this,"doPrintClick"]});
		this.bExcel = new imageButton(this.pc1.childPage[9],{bound:[823,0,22,20], hint:"Excel", image:"icon/"+system.getThemes()+"/excel.png", click:[this,"doPrintClick"]});
		this.bEmail = new imageButton(this.pc1.childPage[9],{bound:[846,0,22,20], hint:"Email", image:"icon/"+system.getThemes()+"/sendMail.png",click:[this,"doPrintClick"]});
...
window.app_saku2_dashboard_gl_fDbNeracaTrailKonsol.extend(window.childForm);
window.app_saku2_dashboard_gl_fDbNeracaTrailKonsol.implement({
	...
	doSelectCell:function(sender, col, row)
	{
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from periode  order by periode desc",[this.sg1.columns.get(2).pickList]);
		}
	},
		...
		try
		{
			...
			else
			{
				...
				if (typeof data == "object" && data.rs.rows[0] != undefined){
					var line;
					this.dataJU = data;
					this.sgn7.setTotalPage(Math.ceil(data.rs.rows.length/this.pager));
					this.sgn7.rearrange();
					this.doTampilData7(1);
				} else this.sg7.clear(1);
				//labarugi
				var strSQL= "select kode_neraca,tipe,fn_spasi(nama,level_spasi) as nama,kode_lokasi,"+
				...
				if (typeof data == "object" && data.rs.rows[0] != undefined){
					var line;
					this.dataJU = data;
					this.sgn8.setTotalPage(Math.ceil(data.rs.rows.length/this.pager));
					this.sgn8.rearrange();
					this.doTampilData8(1);
				} else this.sg8.clear(1);
	...
	doDoubleClick7: function(sender, col , row) 
	{
		this.doTampilTb(this.sg7.cells(0,row));
	},
	doDoubleClick8: function(sender, col , row) 
	{
		this.doTampilTb(this.sg8.cells(0,row));
	},
	...
	doTampilData6: function(page) {
		...
		for (var i=start;i<finish;i++){
			...
			this.sg6.appendData([line.kode_neraca,line.nama,line.kode_lokasi,floatToNilai(line.n1),floatToNilai(line.n2),floatToNilai(line.n3),floatToNilai(line.n4)]);

		}
		this.sg6.setNoUrut(start);
	},
	doTampilData7: function(page) {
		this.sg7.clear();
		this.page = page;
		var start = (page - 1) * this.pager;
		var finish = (start + this.pager > this.dataJU.rs.rows.length? this.dataJU.rs.rows.length:start+this.pager);
		for (var i=start;i<finish;i++){
			line = this.dataJU.rs.rows[i];							
			this.sg7.appendData([line.kode_neraca,line.nama,line.kode_lokasi,floatToNilai(line.n1),floatToNilai(line.n2),floatToNilai(line.n3),floatToNilai(line.n4)]);

		}
		this.sg7.setNoUrut(start);
	},
	doTampilData8: function(page) {
		this.sg8.clear();
		this.page = page;
		var start = (page - 1) * this.pager;
		var finish = (start + this.pager > this.dataJU.rs.rows.length? this.dataJU.rs.rows.length:start+this.pager);
		for (var i=start;i<finish;i++){
			line = this.dataJU.rs.rows[i];							
			this.sg8.appendData([line.kode_neraca,line.nama,line.kode_lokasi,floatToNilai(line.n1),floatToNilai(line.n2),floatToNilai(line.n3),floatToNilai(line.n4)]);

		}
		this.sg8.setNoUrut(start);
	},
	...
	doDoubleClick3: function(sender, col , row) 
	{
		try{
			...
			this.pc1.setActivePage(this.pc1.childPage[9]);
		}catch(e){
			systemAPI.alert(e);
		}
