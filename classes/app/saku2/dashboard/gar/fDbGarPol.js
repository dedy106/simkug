window.app_saku2_dashboard_gar_fDbGarPol = function(owner)
{
	if (owner)
	{
		window.app_saku2_dashboard_gar_fDbGarPol.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_dashboard_gar_fDbGarPol";
		...
		this.pc1 = new pageControl(this,{bound:[15,12,1000,500], childPage:["Filter","Budget Commite","Pendapatan Operasional","Beban Operasinal ","Pendapatan Non Operasional","Beban Non Operasinal ","Data Trail"]});
		...
		this.fr2 = new panel(this.pc1.childPage[3],{bound:[10,10,frameWidth,480],caption:"Aktiva Tidak Berwujud"});									            		        							
		...
		this.fr2.grid = new saiGrid(this.fr2,{bound:[5,30,this.fr2.getClientWidth() - 30,this.fr2.getClientHeight() - 50],colCount:3,colTitle:["Group By","Anggaran","Realisasi"],visible:false, readOnly:true, dblClick:[this,"doGridClick"],colWidth:[[2,1,0],[100,100,200]], colAlign:[[1],[alCenter]]});		         	                        
		...
		this.fr3 = new panel(this.pc1.childPage[4],{bound:[10,10,frameWidth,480],caption:"Kewajiban"});									            		        							
		...
		this.fr3.bXls = new imageButton(this.fr3,{bound:[frameWidth - 75,2,18,16],image:"icon/dynpro/excel2.png",hint:"Save to excel",click:[this,"doBtnClick"], name:"xls"});
		this.fr3.grid = new saiGrid(this.fr3,{bound:[5,30,this.fr3.getClientWidth() - 30,this.fr3.getClientHeight() - 50],colCount:3,colTitle:["Group By","Anggaran","Realisasi"],visible:false, readOnly:true, dblClick:[this,"doGridClick"],colWidth:[[2,1,0],[100,100,200]], colAlign:[[1],[alCenter]]});		         	                        
		...
		this.fr4 = new panel(this.pc1.childPage[5],{bound:[10,10,frameWidth,480],caption:"Pendapatan Operasional"});									            		        							
		...
		this.fr4.bXls = new imageButton(this.fr4,{bound:[frameWidth - 75,2,18,16],image:"icon/dynpro/excel2.png",hint:"Save to excel",click:[this,"doBtnClick"], name:"xls"});
		this.fr4.grid = new saiGrid(this.fr4,{bound:[5,30,this.fr4.getClientWidth() - 30,this.fr4.getClientHeight() - 50],colCount:3,colTitle:["Group By","Anggaran","Realisasi"],visible:false, readOnly:true, dblClick:[this,"doGridClick"],colWidth:[[2,1,0],[100,100,200]], colAlign:[[1],[alCenter]]});		         	                        
		...
		var cnv2= this.pc1.childPage[6].getClientCanvas();
...
window.app_saku2_dashboard_gar_fDbGarPol.extend(window.childForm);
window.app_saku2_dashboard_gar_fDbGarPol.implement({
	...
	mainButtonClick:function(sender)
	{
		try
		{
			...
			{
				sql="call sp_neraca_agg_pol ('"+this.sg1.getCell(2,2)+"','L','S',5,'"+this.sg1.getCell(2,1)+"','"+this.sg1.getCell(2,0)+"','"+this.sg1.getCell(2,0)+"','"+this.sg1.getCell(2,0)+"','"+this.app._nikUser+"')";
				...
				sql.add("select a.kode_neraca+'-'+b.nama as nama,abs(round(b.n5/1000,0)) as tot,abs(round(b.n3/1000,0)) as gar "+
						"from db_grafik_d a "+
						"inner join neraca_tmp b on a.kode_lokasi=b.kode_lokasi and a.kode_neraca=b.kode_neraca "+
						"where b.nik_user='"+this.app._nikUser+"' and a.kode_grafik='GA03' order by a.no");
				sql.add("select a.kode_neraca+'-'+b.nama as nama,abs(round(b.n5/1000,0)) as tot,abs(round(b.n3/1000,0)) as gar  "+
						"from db_grafik_d a "+
						"inner join neraca_tmp b on a.kode_lokasi=b.kode_lokasi and a.kode_neraca=b.kode_neraca "+
						"where b.nik_user='"+this.app._nikUser+"' and a.kode_grafik='GA04' order by a.no");
				sql.add("select a.kode_neraca+'-'+b.nama as nama,abs(round(b.n5/1000,0)) as tot,abs(round(b.n3/1000,0)) as gar  "+
						"from db_grafik_d a "+
						"inner join neraca_tmp b on a.kode_lokasi=b.kode_lokasi and a.kode_neraca=b.kode_neraca "+
						"where b.nik_user='"+this.app._nikUser+"' and a.kode_grafik='GA05' order by a.no");
				sql.add("select a.kode_neraca+'-'+b.nama as nama,abs(round(b.n5/1000,0)) as tot,abs(round(b.n3/1000,0)) as gar  "+
						"from db_grafik_d a "+
						"inner join neraca_tmp b on a.kode_lokasi=b.kode_lokasi and a.kode_neraca=b.kode_neraca "+
						"where b.nik_user='"+this.app._nikUser+"' and a.kode_grafik='GA06' order by a.no");
	...
	doBtnClick: function(sender){
		try{
			...
			if (sender == this.fr2.bXls ){
				this.doSaveXls(sender);
			}
			if (sender == this.fr3.bXls ){
				this.doSaveXls(sender);
			}
			if (sender == this.fr4.bXls ){
				this.doSaveXls(sender);
			}
	...
	doDetail: function() 
	{
		...
		nama_report="server_report_saku2_gl_rptLRAggPol";
