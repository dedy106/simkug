window.app_saku2_dashboard_siaga_fDbNeracaGar = function(owner)
{
	if (owner)
	{
		window.app_saku2_dashboard_siaga_fDbNeracaGar.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_dashboard_siaga_fDbNeracaGar";
		...
		this.pc1 = new pageControl(this,{bound:[15,12,1000,500], childPage:["Filter","Beban Operasinal ","Pendapatan Operasional","Investasi","Pendapatan Pendidikan","Beban Pendidikan","Data Trail"]});
		...
		this.fr6.grid = new saiGrid(this.fr6,{bound:[5,30,this.fr6.getClientWidth() - 30,this.fr6.getClientHeight() - 50],colCount:3,colTitle:["Group By","Anggaran","Realisasi"],visible:false, readOnly:true, dblClick:[this,"doGridClick"],colWidth:[[1,0],[100,100,200]], colAlign:[[1],[alCenter]]});		         	                        
...
window.app_saku2_dashboard_siaga_fDbNeracaGar.extend(window.childForm);
window.app_saku2_dashboard_siaga_fDbNeracaGar.implement({
	...
	mainButtonClick:function(sender)
	{
		try
		{
			...
			{
				sql="call sp_neraca_agg ('"+this.sg1.getCell(2,2)+"','A','S',5,'"+this.sg1.getCell(2,1)+"','"+this.sg1.getCell(2,0)+"','"+this.sg1.getCell(2,0)+"','"+this.sg1.getCell(2,0)+"','"+this.app._nikUser+"')";
