window.app_saku2_report_csm_flProject = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_csm_flProject.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_csm_flProject";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Kode Customer","All",""));
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Kode Project","All",""));
...
window.app_saku2_report_csm_flProject.extend(window.childForm);
window.app_saku2_report_csm_flProject.implement({
		...
		try{			
			...
			if (row ==	2)
			{
				this.filterRep.ListDataSGFilter(this, "Data Project",this.sg1, this.sg1.row, this.sg1.col,
														  "select kode_project, nama from csm_project "+
														   this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  "select count(kode_project) from csm_project "+
														  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  new Array("kode_project","nama"),"and");
			}
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.kode_project",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
				this.filter2 = this.sg1.getCell(2,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku2_csm_rptProject";
			...
			systemAPI.alert("[app_saku2_report_csm_flProject]::mainButtonClick:"+e);
		}
	},
