window.app_saku2_report_csm_flVendor = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_csm_flVendor.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_csm_flVendor";
		this.maximize();
...
window.app_saku2_report_csm_flVendor.extend(window.childForm);
window.app_saku2_report_csm_flVendor.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_csm_rptVendor";
			...
			systemAPI.alert("[app_saku2_report_csm_flVendor]::mainButtonClick:"+e);
		}
	},
