window.app_saku2_report_csm_flHutangSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_csm_flHutangSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_csm_flHutangSaldo";
		this.maximize();
...
window.app_saku2_report_csm_flHutangSaldo.extend(window.childForm);
window.app_saku2_report_csm_flHutangSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_csm_rptHutangSaldo";
			...
			systemAPI.alert("[app_saku2_report_csm_flHutangSaldo]::mainButtonClick:"+e);
		}
	},
