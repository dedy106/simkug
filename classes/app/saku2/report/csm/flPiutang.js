window.app_saku2_report_csm_flPiutang = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_csm_flPiutang.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_csm_flPiutang";
		this.maximize();
...
window.app_saku2_report_csm_flPiutang.extend(window.childForm);
window.app_saku2_report_csm_flPiutang.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_csm_rptPiutang";
			...
			systemAPI.alert("[app_saku2_report_csm_flPiutang]::mainButtonClick:"+e);
		}
	},
