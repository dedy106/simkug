window.app_saku2_report_csm_flPiutangSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_csm_flPiutangSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_csm_flPiutangSaldo";
		this.maximize();
...
window.app_saku2_report_csm_flPiutangSaldo.extend(window.childForm);
window.app_saku2_report_csm_flPiutangSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_csm_rptPiutangSaldo";
			...
			systemAPI.alert("[app_saku2_report_csm_flPiutangSaldo]::mainButtonClick:"+e);
		}
	},
