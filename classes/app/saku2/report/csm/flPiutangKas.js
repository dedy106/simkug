window.app_saku2_report_csm_flPiutangKas = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_csm_flPiutangKas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_csm_flPiutangKas";
		this.maximize();
...
window.app_saku2_report_csm_flPiutangKas.extend(window.childForm);
window.app_saku2_report_csm_flPiutangKas.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_saku2_csm_rptBuktiBank";
