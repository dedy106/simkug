window.app_saku2_report_csm_flPiutangKartu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_csm_flPiutangKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_csm_flPiutangKartu";
		this.maximize();
...
window.app_saku2_report_csm_flPiutangKartu.extend(window.childForm);
window.app_saku2_report_csm_flPiutangKartu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_csm_rptPiutangKartu";
			...
			systemAPI.alert("[app_saku2_report_csm_flPiutangKartu]::mainButtonClick:"+e);
		}
	},
