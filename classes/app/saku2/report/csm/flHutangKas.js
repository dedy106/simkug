window.app_saku2_report_csm_flHutangKas = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_csm_flHutangKas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_csm_flHutangKas";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from kas_m where kode_lokasi='"+this.app._lokasi+"' and modul='KBHUT'");
...
window.app_saku2_report_csm_flHutangKas.extend(window.childForm);
window.app_saku2_report_csm_flHutangKas.implement({
