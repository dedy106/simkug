window.app_saku2_report_anggaran_flAggNeraca = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_anggaran_flAggNeraca.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_anggaran_flAggNeraca";
		this.maximize();
...
window.app_saku2_report_anggaran_flAggNeraca.extend(window.childForm);
window.app_saku2_report_anggaran_flAggNeraca.implement({
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				if (this.sg1.getCell(2,6)=="Tahunan")
				{
					...
					{
						this.nama_report="server_report_saku2_anggaran_rptAggNeracaStafel";
					}
					else
					{
						this.nama_report="server_report_saku2_anggaran_rptAggNeracaStafelDc";
					}
				...
				{
					this.nama_report="server_report_saku2_anggaran_rptAggNeracaStafelTw";
			...
			systemAPI.alert("[app_saku2_report_anggaran_flAggNeraca]::mainButtonClick:"+e);
		}
	},
