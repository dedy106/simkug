window.app_saku2_report_anggaran_flAggAkunPp = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_anggaran_flAggAkunPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_anggaran_flAggAkunPp";
		this.maximize();
...
window.app_saku2_report_anggaran_flAggAkunPp.extend(window.childForm);
window.app_saku2_report_anggaran_flAggAkunPp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				{
					var sql =  "select a.kode_akun,f.nama as nama_akun,zz.kode_lokasi,zz.nama as nama_lokasi,a.kode_pp,h.nama as nama_pp, "+
							...
							"from (select a.kode_lokasi,a.tahun,a.kode_akun,a.kode_pp "+	
							"	  from agg_d a "+this.filter+
							"group by a.kode_lokasi,a.tahun,a.kode_akun,a.kode_pp ) a  "+
							...
							"left join ( "+
							"	 select a.kode_lokasi,a.kode_akun,a.kode_pp, "+
							...
							"	 from agg_d a "+this.filter+
							"	 group by a.kode_lokasi,a.kode_akun,a.kode_pp "+
							"		 )g on a.kode_lokasi=g.kode_lokasi and a.kode_akun=g.kode_akun and a.kode_pp=g.kode_pp "+this.filter+
							"group by a.kode_akun,f.nama,zz.kode_lokasi,zz.nama,a.kode_pp,h.nama "+
"							order by zz.kode_lokasi,zz.nama,a.kode_pp,h.nama,a.kode_akun,f.nama";	
					this.scriptSqlCount = "select count(a.kode_akun) from (select a.kode_akun "+
							...
							"	 group by a.kode_lokasi,a.kode_akun,a.kode_pp "+
							"		 )g on a.kode_lokasi=g.kode_lokasi and a.kode_akun=g.kode_akun and a.kode_pp=g.kode_pp "+this.filter+
							"group by a.kode_akun,f.nama,zz.kode_lokasi,zz.nama,a.kode_pp,h.nama) a  ";
					this.title = new server_util_arrayList({items:["Kode Akun","Nama Akun","Lok","Nama Lokasi","Kode PP","Nama PP","Januari","Februari","Maret","April","Mei","Juni","Juli","Agustus","September","Oktober","November","Desember","Total"]});
			...
			systemAPI.alert("[app_saku2_report_anggaran_flAggAkunPp]::mainButtonClick:"+e);
		}
	},
