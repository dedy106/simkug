window.app_saku2_report_anggaran_flAggBuku = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_anggaran_flAggBuku.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_anggaran_flAggBuku";
		this.maximize();
...
window.app_saku2_report_anggaran_flAggBuku.extend(window.childForm);
window.app_saku2_report_anggaran_flAggBuku.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.jenis_agg="";
				if (this.sg1.getCell(2,5)=="Baru")
				{
					this.jenis_agg=" and a.jenis_agg='T' ";
				}
				if (this.sg1.getCell(2,5)=="Lama")
				{
					this.jenis_agg=" and a.jenis_agg<>'T' ";
				}
				...
				this.nama_report = "server_report_saku2_anggaran_rptAggBuku";
			...
			systemAPI.alert("[app_saku2_report_anggaran_flAggBuku]::mainButtonClick:"+e);
		}
	},
