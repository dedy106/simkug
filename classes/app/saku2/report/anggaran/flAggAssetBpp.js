window.app_saku2_report_anggaran_flAggAssetBpp = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_anggaran_flAggAssetBpp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_anggaran_flAggAssetBpp";
		this.maximize();
...
window.app_saku2_report_anggaran_flAggAssetBpp.extend(window.childForm);
window.app_saku2_report_anggaran_flAggAssetBpp.implement({
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.gridLib.SGEditData(this.sg1,7,new Array(0,1,2), new Array("Kode Bidang","All",""));
					...
					this.sql="select b.nama,a.no_fa,a.nama,e.akun_bpp,c.nama as nama_akun,a.kode_pp3,g.nama as nama_pp,a.kode_drk,d.nama as nama_drk, "+
							...
							"inner join pp g on a.kode_pp3=g.kode_pp and a.kode_lokasi=g.kode_lokasi "+
							...
							"inner join masakun c on e.akun_bpp=c.kode_akun and e.kode_lokasi=c.kode_lokasi "+ 
					...
					this.scriptSqlCount =   "select count(a.no_fa) "+	
							...
							"	   group by a.no_fa,a.kode_param)f on a.no_fa=f.no_fa and e.kode_param=f.kode_param "+
							this.filter+" and  isnull(f.total,0)<>0 ";	
					this.title = new server_util_arrayList({items:["Kelompok Asset","No Asset","Nama","Kode Akun","Nama Akun","Kode PP","Nama PP","Kode DRK","Nama DRK","Kode Param","Nama Param","Satuan","Tgl Perolehan","Jumlah","Nilai Perolehan","Januari","Februari","Maret","April","Mei","Juni","Juli","Agustus","September","Oktober","November","Desember","Total"]});
					this.widthTable = new server_util_arrayList({items:[150,60,150,60,150,50,150,60,150,60,150,60,60,40,80,80,80,80,80,80,80,80,80,80,80,80,80,80]});
			...
			systemAPI.alert("[app_saku2_report_anggaran_flAggAssetBpp]::mainButtonClick:"+e);
		}
	},
