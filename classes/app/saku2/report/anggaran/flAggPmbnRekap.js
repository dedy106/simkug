window.app_saku2_report_anggaran_flAggPmbnRekap = function(owner)
{
	
	try{
	if (owner)
	{
		window.app_saku2_report_anggaran_flAggPmbnRekap.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_anggaran_flAggPmbnRekap";
		this.maximize();
...
window.app_saku2_report_anggaran_flAggPmbnRekap.extend(window.portalui_childForm);
window.app_saku2_report_anggaran_flAggPmbnRekap.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				{
					var sql="select e.nik,e.nama,g.nama as nama_jab,e.kode_band, "+
							...
							"from agg_pembina e "+
							"inner join agg_jab g on e.jabatan=g.kode_jab "+
							...
							"	from agg_pembina_d a "+
							"	inner join agg_pembina_m b on a.no_pembina=b.no_pembina and a.kode_lokasi=b.kode_lokasi "+this.filter2+
				...
				if (this.jenisLap === "Bulanan"){
					this.title = new server_util_arrayList({items:["NIK","Nama","Jabatan","Band","Januari","Februari","Maret","April","Mei","Juni","Juli","Agustus","September","Oktober","November","Desember","Total"]});
					this.widthTable = new server_util_arrayList({items:[60,200,200,40,80,80,80,80,80,80,80,80,80,80,80,80,100]});
			...
			systemAPI.alert("[app_saku2_report_anggaran_flAggPmbnRekap]::mainButtonClick:"+e);
		}
	},
