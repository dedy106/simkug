// JavaScript Document
window.app_saku2_report_anggaran_flAggTb = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_anggaran_flAggTb.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_anggaran_flAggTb";
		this.maximize();
...
window.app_saku2_report_anggaran_flAggTb.extend(window.portalui_childForm);
window.app_saku2_report_anggaran_flAggTb.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			if (this.sg1.getCell(2,3)=="Neraca Percobaan")
			{
				...
				this.nama_report="server_report_saku2_anggaran_rptAggTBPercobaan";
			}
			if (this.sg1.getCell(2,3)=="Neraca Lajur")
			{
				var sql = "call sp_agg_glma_tmp ('"+this.kode_lokasi+"','"+this.kode_lokasi1+"','"+this.kode_lokasi2+"','"+this.sg1.getCell(2,1)+"','"+this.nik_user+"')";								
				this.nama_report="server_report_saku2_anggaran_rptAggTBLajur";
