window.app_saku2_report_anggaran_flAggOutAkun2 = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_anggaran_flAggOutAkun2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_anggaran_flAggOutAkun2";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(tahun) as periode from agg_outlook ");
...
window.app_saku2_report_anggaran_flAggOutAkun2.extend(window.childForm);
window.app_saku2_report_anggaran_flAggOutAkun2.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct(substring(periode,1,4)) as periode from agg_outlook "+
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_anggaran_rptAggOutAkun";
