window.app_saku2_report_anggaran_flAggJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_anggaran_flAggJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_anggaran_flAggJurnal";
		this.maximize();
...
window.app_saku2_report_anggaran_flAggJurnal.extend(window.childForm);
window.app_saku2_report_anggaran_flAggJurnal.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row == 3)
			{
				...
				var sql1="select distinct a.no_bukti,a.keterangan from agg_gldt a "+filter; 
				var sql2="select count(distinct a.no_bukti) from agg_gldt a "+filter;
	...
	{		
		...
		if (row == 0)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct(periode) as periode from agg_gldt "+
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_saku2_anggaran_rptAggJurnal";
