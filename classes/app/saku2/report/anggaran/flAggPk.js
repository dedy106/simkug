window.app_saku2_report_anggaran_flAggPk = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_anggaran_flAggPk.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_anggaran_flAggPk";
		this.maximize();
...
window.app_saku2_report_anggaran_flAggPk.extend(window.childForm);
window.app_saku2_report_anggaran_flAggPk.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_anggaran_flAggPk]::mainButtonClick:"+e);
		}
	},
