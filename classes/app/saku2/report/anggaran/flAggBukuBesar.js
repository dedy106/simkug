window.app_saku2_report_anggaran_flAggBukuBesar = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_anggaran_flAggBukuBesar.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_anggaran_flAggBukuBesar";
		this.maximize();
...
window.app_saku2_report_anggaran_flAggBukuBesar.extend(window.portalui_childForm);
window.app_saku2_report_anggaran_flAggBukuBesar.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku2_anggaran_rptAggBukuBesar";
