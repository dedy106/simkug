window.app_saku2_report_anggaran_flAggAkun = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_anggaran_flAggAkun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_anggaran_flAggAkun";
		this.maximize();
...
window.app_saku2_report_anggaran_flAggAkun.extend(window.childForm);
window.app_saku2_report_anggaran_flAggAkun.implement({
