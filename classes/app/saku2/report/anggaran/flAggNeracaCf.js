window.app_saku2_report_anggaran_flAggNeracaCf = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_anggaran_flAggNeracaCf.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_anggaran_flAggNeracaCf";
		this.maximize();
...
window.app_saku2_report_anggaran_flAggNeracaCf.extend(window.childForm);
window.app_saku2_report_anggaran_flAggNeracaCf.implement({
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				if (this.sg1.getCell(2,6)=="Tahunan")
				{
					...
					{
						this.nama_report="server_report_saku2_anggaran_rptAggCf";
					}
					else
					{
						this.nama_report="server_report_saku2_anggaran_rptAggCfDc";
					}
				}
				else
				{
					this.nama_report="server_report_saku2_anggaran_rptAggCfTw";
					sql="call sp_agg_neraca_cf_tw ('"+this.sg1.getCell(2,3)+"','A',"+this.sg1.getCell(2,4)+",'"+this.sg1.getCell(2,1)+"','"+this.sg1.getCell(2,2)+"','"+this.sg1.getCell(2,0)+"','"+this.nik_user+"')";
			...
			systemAPI.alert("[app_saku2_report_anggaran_flAggNeracaCf]::mainButtonClick:"+e);
		}
	},
