window.app_saku2_report_dakem_flDakem = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_dakem_flDakem.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_dakem_flDakem";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from yk_dakem_m ");
...
window.app_saku2_report_dakem_flDakem.extend(window.childForm);
window.app_saku2_report_dakem_flDakem.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from yk_dakem_m where kode_lokasi='"+this.app._lokasi+"' order by periode",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
		...
		try
		{
			...
			else
			{
				...
				this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("a.no_dakem",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
				...
				this.nama_report = "server_report_saku2_dakem_rptDakem";
			...
			systemAPI.alert("[app_saku2_report_dakem_flDakem]::mainButtonClick:"+e);
		}
	},
