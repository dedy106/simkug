window.app_saku2_report_tk_flSiswa = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_tk_flSiswa.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_tk_flSiswa";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Kode Tingkat","All",""));
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Kode Siswa","All",""));
...
window.app_saku2_report_tk_flSiswa.extend(window.childForm);
window.app_saku2_report_tk_flSiswa.implement({
		...
		try{			
			...
			if (row ==	2)
			{
				var filter=this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+
						 this.filterRep.filterStr("kode_tingkat",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1)," and ");
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_tk_rptSiswa";
			...
			systemAPI.alert("[app_saku2_report_tk_flSiswa]::mainButtonClick:"+e);
		}
	},
