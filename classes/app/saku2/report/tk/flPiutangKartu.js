window.app_saku2_report_tk_flPiutangKartu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_tk_flPiutangKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_tk_flPiutangKartu";
		this.maximize();
...
window.app_saku2_report_tk_flPiutangKartu.extend(window.childForm);
window.app_saku2_report_tk_flPiutangKartu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_tk_rptPiutangKartu";
			...
			systemAPI.alert("[app_saku2_report_tk_flPiutangKartu]::mainButtonClick:"+e);
		}
	},
