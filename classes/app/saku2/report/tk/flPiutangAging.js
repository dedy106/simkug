window.app_saku2_report_tk_flPiutangAging = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_tk_flPiutangAging.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_tk_flPiutangAging";
		this.maximize();
...
window.app_saku2_report_tk_flPiutangAging.extend(window.childForm);
window.app_saku2_report_tk_flPiutangAging.implement({
		...
		try{			
			...
			if (row == 2)
			{
				this.filterRep.ListDataSGFilter(this, "Data Siswa",this.sg1, this.sg1.row, this.sg1.col,
														  "select kode_siswa, nama from tk_siswa "+
														   this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  "select count(kode_siswa) from tk_siswa "+
														  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
			...
			if (row ==3)
			{
				filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.kode_siswa",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
				this.filterRep.ListDataSGFilter(this, "Data Invoice",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_piutang, a.keterangan from tk_piutang_m a "+filter,
												"select count(b.no_piutang) from tk_piutang_m a "+filter,
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_tk_rptPiutangAging";
			...
			systemAPI.alert("[app_saku2_report_tk_flPiutangAging]::mainButtonClick:"+e);
		}
	},
