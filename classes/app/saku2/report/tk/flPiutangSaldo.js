window.app_saku2_report_tk_flPiutangSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_tk_flPiutangSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_tk_flPiutangSaldo";
		this.maximize();
...
window.app_saku2_report_tk_flPiutangSaldo.extend(window.childForm);
window.app_saku2_report_tk_flPiutangSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_tk_rptPiutangSaldo";
			...
			systemAPI.alert("[app_saku2_report_tk_flPiutangSaldo]::mainButtonClick:"+e);
		}
	},
