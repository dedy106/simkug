window.app_saku2_report_tk_flTarif = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_tk_flTarif.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_tk_flTarif";
		this.maximize();
...
window.app_saku2_report_tk_flTarif.extend(window.childForm);
window.app_saku2_report_tk_flTarif.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_tk_rptTarif";
			...
			systemAPI.alert("[app_saku2_report_tk_flTarif]::mainButtonClick:"+e);
		}
	},
