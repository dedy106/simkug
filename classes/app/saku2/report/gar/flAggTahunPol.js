window.app_saku2_report_gar_flAggTahunPol = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gar_flAggTahunPol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gar_flAggTahunPol";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,0,[0,1,2,3],["Lokasi","=",this.app._lokasi,""]);
...
window.app_saku2_report_gar_flAggTahunPol.extend(window.portalui_childForm);
window.app_saku2_report_gar_flAggTahunPol.implement({
		...
		try
		{
			...
			else
			{
				...
				if (this.sg1.getCell(2,6)=="Triwulan")
				{
					...
					this.nama_report="server_report_saku2_gar_rptAggRealTw2";
				}
				if (this.sg1.getCell(2,6)=="Semester")
				{
					...
					this.nama_report="server_report_saku2_gar_rptAggRealSem2";
				}
