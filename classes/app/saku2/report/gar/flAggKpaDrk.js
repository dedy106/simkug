window.app_saku2_report_gar_flAggKpaDrk = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gar_flAggKpaDrk.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gar_flAggKpaDrk";
		this.maximize();
...
window.app_saku2_report_gar_flAggKpaDrk.extend(window.portalui_childForm);
window.app_saku2_report_gar_flAggKpaDrk.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_gar_rptAggKpaDrk";
				/*
