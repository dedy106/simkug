window.app_saku2_report_gar_flAggAkunJejer = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gar_flAggAkunJejer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gar_flAggAkunJejer";
		this.maximize();
...
window.app_saku2_report_gar_flAggAkunJejer.extend(window.childForm);
window.app_saku2_report_gar_flAggAkunJejer.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_gar_rptAggAkunJejer";
