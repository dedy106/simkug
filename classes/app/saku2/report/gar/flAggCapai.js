window.app_saku2_report_gar_flAggCapai = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gar_flAggCapai.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gar_flAggCapai";
		this.maximize();
...
window.app_saku2_report_gar_flAggCapai.extend(window.portalui_childForm);
window.app_saku2_report_gar_flAggCapai.implement({
