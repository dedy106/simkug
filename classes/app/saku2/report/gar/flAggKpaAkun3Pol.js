window.app_saku2_report_gar_flAggKpaAkun3Pol = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gar_flAggKpaAkun3Pol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gar_flAggKpaAkun3Pol";
		this.maximize();
...
window.app_saku2_report_gar_flAggKpaAkun3Pol.extend(window.portalui_childForm);
window.app_saku2_report_gar_flAggKpaAkun3Pol.implement({
