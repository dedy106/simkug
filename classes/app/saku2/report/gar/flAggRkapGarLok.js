// JavaScript Document
window.app_saku2_report_gar_flAggRkapGarLok = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gar_flAggRkapGarLok.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gar_flAggRkapGarLok";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,3,[0,1,2],["Periodik Laporan","=","Triwulan"]);
...
window.app_saku2_report_gar_flAggRkapGarLok.extend(window.portalui_childForm);
window.app_saku2_report_gar_flAggRkapGarLok.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("Triwulan","Semester","Bulanan"));
		}
		if (row == 4)
		{
			this.sg1.columns.get(2).pickList.clear();
		...
		try
		{
			...
			if (sender == this.app._mainForm.bBack)
			{
				...
				if (this.link=="1")
				{
					...
					this.nama_report = "server_report_saku2_gar_rptAggGar";
			...
			else
			{
				...
				sql="call sp_neracagar_konsol ('"+this.sg1.getCell(2,2)+"','N','K',5,'"+this.sg1.getCell(2,1)+"','"+this.kode_lokasi+"','"+this.kode_lokasi1+"','"+this.kode_lokasi2+"','"+this.nik_user+"')";
				if (this.sg1.getCell(2,3)=="Bulanan")
				{
					this.nama_report="server_report_saku2_gar_rptAggRkapGarLok";
				}
				if (this.sg1.getCell(2,3)=="Triwulan")
				{
					this.nama_report = "server_report_saku2_gar_rptAggRkapGarTwLok";
				}
	...
	doOpenGar: function(kode_neraca,kode_lokasi,tahun){
		...
		nama_report="server_report_saku2_gar_rptAggBulanNeraca";
