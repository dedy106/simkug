// JavaScript Document
window.app_saku2_report_gar_flAggRkapReal = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gar_flAggRkapReal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gar_flAggRkapReal";
		this.maximize();
...
window.app_saku2_report_gar_flAggRkapReal.extend(window.portalui_childForm);
window.app_saku2_report_gar_flAggRkapReal.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		else
		{
			...
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,new Array(0,1,2,3),new  Array(3,0,0));
		}
		if (row == 1)
		{
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2 = this.nik_user+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,3)+"/"+this.app._namaForm;
				...
				sql="call sp_rkap ('"+this.sg1.getCell(2,2)+"','"+this.sg1.getCell(2,1)+"','"+this.kode_lokasi+"','"+this.kode_lokasi1+"','"+this.kode_lokasi2+"','"+this.nik_user+"','"+this.sg1.getCell(2,3)+"')";
				this.nama_report="server_report_saku2_gar_rptAggRkapReal";
