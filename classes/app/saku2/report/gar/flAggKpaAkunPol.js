window.app_saku2_report_gar_flAggKpaAkunPol = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gar_flAggKpaAkunPol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gar_flAggKpaAkunPol";
		this.maximize();
...
window.app_saku2_report_gar_flAggKpaAkunPol.extend(window.portalui_childForm);
window.app_saku2_report_gar_flAggKpaAkunPol.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_gar_rptAggKpaAkun2";
