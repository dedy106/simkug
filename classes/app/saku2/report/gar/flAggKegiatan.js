window.app_saku2_report_gar_flAggKegiatan = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gar_flAggKegiatan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gar_flAggKegiatan";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,6,[0,1,2],["Status Anggaran","=","Closing"]);
...
window.app_saku2_report_gar_flAggKegiatan.extend(window.portalui_childForm);
window.app_saku2_report_gar_flAggKegiatan.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				{ 
					var sql = "call sp_agg_pakai ('"+this.sg1.getCell(2,0)+"','"+this.sg1.getCell(2,5)+"','"+this.sg1.getCell(2,1)+"','"+this.nik_user+"')";
				}
				else
				{
					var sql = "call sp_agg_pakai_gl ('"+this.sg1.getCell(2,0)+"','"+this.sg1.getCell(2,5)+"','"+this.sg1.getCell(2,1)+"','"+this.nik_user+"')";
				}
				alert(sql);
				this.nama_report="server_report_saku2_gar_rptAggKegiatan";
