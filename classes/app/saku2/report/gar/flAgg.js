window.app_saku2_report_gar_flAgg = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gar_flAgg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gar_flAgg";
		this.maximize();
...
window.app_saku2_report_gar_flAgg.extend(window.portalui_childForm);
window.app_saku2_report_gar_flAgg.implement({
	...
	doSelectCell: function(sender, col, row){
		if (this.app._userStatus=="A")
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6,7],["123","123","123","123","123","13","3","3"]);
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5,6,7],[2,0,2,2,2,0,0,0]);
		}
		if (this.app._userStatus=="U")
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6,7],["3","3","123","3","123","13","3","3"]);
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5,6,7],[3,0,2,3,2,0,0,0]);
		}
		if (this.app._userStatus=="P")
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6,7],["3","3","123","23","123","13","3","3"]);
	...
	mainButtonClick: function(sender){
		try
		{
			...
			{			
				...
				{
					var sql = "call sp_agg_tw ('"+this.sg1.getCell(2,0)+"','"+this.sg1.getCell(2,5)+"','"+this.sg1.getCell(2,1)+"','"+this.nik_user+"')";
				}
				else
				{
					var sql = "call sp_agg_tw_org ('"+this.sg1.getCell(2,0)+"','"+this.sg1.getCell(2,5)+"','"+this.sg1.getCell(2,1)+"','"+this.nik_user+"')";
				}
				*/		
			...
			if (this.sg1.getCell(2,6)=="Semester")
			{
				...
				if (this.sg1.getCell(2,7)=="Closing")
				{
					var sql = "call sp_agg_sem ('"+this.sg1.getCell(2,0)+"','"+this.sg1.getCell(2,5)+"','"+this.sg1.getCell(2,1)+"','"+this.nik_user+"')";
				}
				else
				{
					var sql = "call sp_agg_sem_org ('"+this.sg1.getCell(2,0)+"','"+this.sg1.getCell(2,5)+"','"+this.sg1.getCell(2,1)+"','"+this.nik_user+"')";
				}
				*/
			...
			if (this.sg1.getCell(2,6)=="Bulanan")
			{
				...
				if (this.sg1.getCell(2,7)=="Closing")
				{
					var sql = "call sp_agg_bulan ('"+this.sg1.getCell(2,0)+"','"+this.sg1.getCell(2,5)+"','"+this.sg1.getCell(2,1)+"','"+this.nik_user+"')";
				}
				else
				{
					var sql = "call sp_agg_bulan_org ('"+this.sg1.getCell(2,0)+"','"+this.sg1.getCell(2,5)+"','"+this.sg1.getCell(2,1)+"','"+this.nik_user+"')";
				}
				*/
