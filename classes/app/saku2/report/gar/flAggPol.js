window.app_saku2_report_gar_flAggPol = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gar_flAggPol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gar_flAggPol";
		this.maximize();
...
window.app_saku2_report_gar_flAggPol.extend(window.portalui_childForm);
window.app_saku2_report_gar_flAggPol.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			{
				this.nama_report="server_report_saku2_gar_rptAggBulanPol";
			}
	...
	doOpenGar: function(kode_akun,kode_lokasi,tahun,kode_pp,kode_drk){
		...
		filter2=tahun;
		nama_report="server_report_saku2_kopeg_ppbs_rptAggDetailKeg";
