// JavaScript Document
window.app_saku2_report_gar_flAggProduk = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gar_flAggProduk.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gar_flAggProduk";
		this.maximize();
...
window.app_saku2_report_gar_flAggProduk.extend(window.portalui_childForm);
window.app_saku2_report_gar_flAggProduk.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		{					
			this.filterRep.setSGFilterRowTipe(this.sg1, row,new Array(0,1,2,3,4),new  Array("123","123","3","3","3"));
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_pp=this.dbLib.getPeriodeFromSQL("select nama as periode from pp where kode_lokasi='"+this.sg1.getCell(2,0)+"' and kode_pp='"+this.sg1.getCell(2,3)+"' ");
				
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,2)+"/"+this.sg1.getCell(2,3)+"/"+this.sg1.getCell(2,4)+"/"+this.nama_pp;
				this.nama_report="server_report_saku2_gar_rptAggProduk";
