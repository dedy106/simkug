window.app_saku2_report_gar_flAggApp = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gar_flAggApp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gar_flAggApp";
		this.maximize();
...
window.app_saku2_report_gar_flAggApp.extend(window.portalui_childForm);
window.app_saku2_report_gar_flAggApp.implement({
