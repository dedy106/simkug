window.app_saku2_report_gar_flAggKpaAkun = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gar_flAggKpaAkun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gar_flAggKpaAkun";
		this.maximize();
...
window.app_saku2_report_gar_flAggKpaAkun.extend(window.portalui_childForm);
window.app_saku2_report_gar_flAggKpaAkun.implement({
