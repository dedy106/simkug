window.app_saku2_report_gar_flAggTahun2 = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gar_flAggTahun2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gar_flAggTahun2";
		this.maximize();
...
window.app_saku2_report_gar_flAggTahun2.extend(window.portalui_childForm);
window.app_saku2_report_gar_flAggTahun2.implement({
