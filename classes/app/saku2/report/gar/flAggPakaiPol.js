window.app_saku2_report_gar_flAggPakaiPol = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gar_flAggPakaiPol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gar_flAggPakaiPol";
		this.maximize();
...
window.app_saku2_report_gar_flAggPakaiPol.extend(window.portalui_childForm);
window.app_saku2_report_gar_flAggPakaiPol.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_gar_rptAggPakai";
