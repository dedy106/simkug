window.app_saku2_report_gar_flAggKpaAkun2 = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gar_flAggKpaAkun2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gar_flAggKpaAkun2";
		this.maximize();
...
window.app_saku2_report_gar_flAggKpaAkun2.extend(window.portalui_childForm);
window.app_saku2_report_gar_flAggKpaAkun2.implement({
