// JavaScript Document
window.app_saku2_report_gar_flAggRkapJejer = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gar_flAggRkapJejer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gar_flAggRkapJejer";
		this.maximize();
...
window.app_saku2_report_gar_flAggRkapJejer.extend(window.portalui_childForm);
window.app_saku2_report_gar_flAggRkapJejer.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				sql="call sp_neracagar_jejer ('"+this.sg1.getCell(2,2)+"','N','K',5,'"+this.sg1.getCell(2,1)+"','"+this.kode_lokasi+"','"+this.kode_lokasi1+"','"+this.kode_lokasi2+"','"+this.nik_user+"')";
				this.nama_report="server_report_saku2_gar_rptAggRkapJejer";
