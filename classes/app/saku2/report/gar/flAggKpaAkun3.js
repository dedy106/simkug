window.app_saku2_report_gar_flAggKpaAkun3 = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gar_flAggKpaAkun3.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gar_flAggKpaAkun3";
		this.maximize();
...
window.app_saku2_report_gar_flAggKpaAkun3.extend(window.portalui_childForm);
window.app_saku2_report_gar_flAggKpaAkun3.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_gar_rptAggKpaAkun3";
