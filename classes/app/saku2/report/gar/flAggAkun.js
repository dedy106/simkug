window.app_saku2_report_gar_flAggAkun = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gar_flAggAkun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gar_flAggAkun";
		this.maximize();
...
window.app_saku2_report_gar_flAggAkun.extend(window.childForm);
window.app_saku2_report_gar_flAggAkun.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				{
					this.nama_report = "server_report_saku2_gar_rptAggAkunBulan";
				}
				if (this.sg1.getCell(2,3)=="Triwulan")
				{
					this.nama_report = "server_report_saku2_gar_rptAggAkunTw";
				}
