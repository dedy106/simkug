window.app_saku2_report_gar_flAggAkunLok = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gar_flAggAkunLok.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gar_flAggAkunLok";
		this.maximize();
...
window.app_saku2_report_gar_flAggAkunLok.extend(window.childForm);
window.app_saku2_report_gar_flAggAkunLok.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				{
					this.nama_report = "server_report_saku2_gar_rptAggAkunBulanLok";
				}
				if (this.sg1.getCell(2,3)=="Triwulan")
				{
					this.nama_report = "server_report_saku2_gar_rptAggAkunTwLok";
				}
