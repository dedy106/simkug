window.app_saku2_report_gar_flAggPakaiYks = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gar_flAggPakaiYks.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gar_flAggPakaiYks";
		this.maximize();
...
window.app_saku2_report_gar_flAggPakaiYks.extend(window.portalui_childForm);
window.app_saku2_report_gar_flAggPakaiYks.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6,7],["3","3","123","123","123","123","3","3"]);
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				{ 
					var sql = "call sp_agg_pakai ('"+this.sg1.getCell(2,0)+"','"+this.sg1.getCell(2,6)+"','"+this.sg1.getCell(2,1)+"','"+this.nik_user+"')";
				}else
				{
					var sql = "call sp_agg_pakai_gl ('"+this.sg1.getCell(2,0)+"','"+this.sg1.getCell(2,6)+"','"+this.sg1.getCell(2,1)+"','"+this.nik_user+"')";
				}
				
				this.nama_report="server_report_saku2_gar_rptAggPakaiYks";
	...
	doOpenKartu: function(kode_akun,kode_lokasi,tahun,kode_pp,kode_drk){
		...
		filter2=this.sg1.getCell(2,6)+"/"+tahun+"/"+kode_pp+"/"+kode_drk+"/"+tahun+"/"+this.app._nikUser+"/"+this.sg1.getCell(2,7)+"/"+this.sg1.getCell(2,3)+"/"+this.nama_bidang+"/"+"1";
