window.app_saku2_report_gar_flAggPakai = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gar_flAggPakai.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gar_flAggPakai";
		this.maximize();
...
window.app_saku2_report_gar_flAggPakai.extend(window.portalui_childForm);
window.app_saku2_report_gar_flAggPakai.implement({
