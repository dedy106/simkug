window.app_saku2_report_gar_flAggKpaAkunYks = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gar_flAggKpaAkunYks.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gar_flAggKpaAkunYks";
		this.maximize();
...
window.app_saku2_report_gar_flAggKpaAkunYks.extend(window.portalui_childForm);
window.app_saku2_report_gar_flAggKpaAkunYks.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_gar_rptAggKpaAkunYks2";
