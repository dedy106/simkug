// JavaScript Document
window.app_saku2_report_gar_flAggRkapGar = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gar_flAggRkapGar.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gar_flAggRkapGar";
		this.maximize();
...
window.app_saku2_report_gar_flAggRkapGar.extend(window.portalui_childForm);
window.app_saku2_report_gar_flAggRkapGar.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				{
					this.nama_report="server_report_saku2_gar_rptAggRkapGar";
				}
				if (this.sg1.getCell(2,3)=="Triwulan")
				{
					this.nama_report = "server_report_saku2_gar_rptAggRkapGarTw";
				}
