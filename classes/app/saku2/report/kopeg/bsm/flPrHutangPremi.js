window.app_saku2_report_kopeg_bsm_flPrHutangPremi = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_bsm_flPrHutangPremi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_bsm_flPrHutangPremi";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,7,new Array(0,1,2), new Array("Jenis Laporan","=","Screen"));
...
window.app_saku2_report_kopeg_bsm_flPrHutangPremi.extend(window.childForm);
window.app_saku2_report_kopeg_bsm_flPrHutangPremi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_bsm_rptPrHutangPremi";
			...
			systemAPI.alert("[app_saku2_report_kopeg_bsm_flPrHutangPremi]::mainButtonClick:"+e);
		}
	},
