window.app_saku2_report_kopeg_bsm_flPrRekapCust = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_bsm_flPrRekapCust.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_bsm_flPrRekapCust";
		this.maximize();
...
window.app_saku2_report_kopeg_bsm_flPrRekapCust.extend(window.childForm);
window.app_saku2_report_kopeg_bsm_flPrRekapCust.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_bsm_rptPrRekapCust";
			...
			systemAPI.alert("[app_saku2_report_kopeg_bsm_flPrRekapCust]::mainButtonClick:"+e);
		}
	},
