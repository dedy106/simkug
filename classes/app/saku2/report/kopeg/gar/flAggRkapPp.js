// JavaScript Document
window.app_saku2_report_kopeg_gar_flAggRkapPp = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_gar_flAggRkapPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_gar_flAggRkapPp";
		this.maximize();
...
window.app_saku2_report_kopeg_gar_flAggRkapPp.extend(window.portalui_childForm);
window.app_saku2_report_kopeg_gar_flAggRkapPp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2 = this.nik_user+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,4)+"/"+this.sg1.getCell(2,3)+"/"+this.app._namaForm+"/"+this.kode_lokasi+"/"+this.sg1.getCell(2,2)+"/"+this.sg1.getCell(2,6);
				
				this.nama_report="server_report_saku2_kopeg_gar_rptAggRkapPp";
