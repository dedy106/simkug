// JavaScript Document
window.app_saku2_report_kopeg_gar_flDrk = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_gar_flDrk.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_gar_flDrk";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(tahun) as periode from drk where kode_lokasi='"+this.app._lokasi+"' ");
...
window.app_saku2_report_kopeg_gar_flDrk.extend(window.portalui_childForm);
window.app_saku2_report_kopeg_gar_flDrk.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,new Array(0,1),new  Array(2,0,2));	
	},
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku2_kopeg_gar_rptDrk";
