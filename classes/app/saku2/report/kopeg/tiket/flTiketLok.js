window.app_saku2_report_kopeg_tiket_flTiketLok = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_tiket_flTiketLok.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_tiket_flTiketLok";
		this.maximize();
...
window.app_saku2_report_kopeg_tiket_flTiketLok.extend(window.childForm);
window.app_saku2_report_kopeg_tiket_flTiketLok.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_tiket_rptTiketLok";
