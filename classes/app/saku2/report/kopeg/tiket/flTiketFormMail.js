window.app_saku2_report_kopeg_tiket_flTiketFormMail = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_tiket_flTiketFormMail.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_tiket_flTiketFormMail";
		this.maximize();
...
window.app_saku2_report_kopeg_tiket_flTiketFormMail.extend(window.childForm);
window.app_saku2_report_kopeg_tiket_flTiketFormMail.implement({
