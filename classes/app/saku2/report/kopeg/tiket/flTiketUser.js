window.app_saku2_report_kopeg_tiket_flTiketUser = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_tiket_flTiketUser.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_tiket_flTiketUser";
		this.maximize();
...
window.app_saku2_report_kopeg_tiket_flTiketUser.extend(window.childForm);
window.app_saku2_report_kopeg_tiket_flTiketUser.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_tiket_rptTiketUser";
