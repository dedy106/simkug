window.app_saku2_report_kopeg_tiket_flTiket = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_tiket_flTiket.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_tiket_flTiket";
		this.maximize();
...
window.app_saku2_report_kopeg_tiket_flTiket.extend(window.childForm);
window.app_saku2_report_kopeg_tiket_flTiket.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_tiket_rptTiket";
