// JavaScript Document
window.app_saku2_report_kopeg_gl_flNeraca4 = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_gl_flNeraca4.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_gl_flNeraca4";
		this.maximize();
...
window.app_saku2_report_kopeg_gl_flNeraca4.extend(window.portalui_childForm);
window.app_saku2_report_kopeg_gl_flNeraca4.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_gl_rptNeraca4";
