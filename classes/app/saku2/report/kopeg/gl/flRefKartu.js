window.app_saku2_report_kopeg_gl_flRefKartu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_gl_flRefKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_gl_flRefKartu";
		this.maximize();
...
window.app_saku2_report_kopeg_gl_flRefKartu.extend(window.childForm);
window.app_saku2_report_kopeg_gl_flRefKartu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_gl_rptRefKartu";
