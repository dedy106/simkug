// JavaScript Document
window.app_saku2_report_kopeg_gl_flTbPp = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_gl_flTbPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_gl_flTbPp";
		this.maximize();
...
window.app_saku2_report_kopeg_gl_flTbPp.extend(window.portalui_childForm);
window.app_saku2_report_kopeg_gl_flTbPp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2 = this.nik_user+"/"+this.sg1.getCell(2,5)+"/"+this.sg1.getCell(2,1)+"/"+this.nama_pp;
				...
				if (this.sg1.getCell(2,4)=="Neraca Percobaan")
				{
					...
					this.nama_report="server_report_saku2_kopeg_gl_rptTBPercobaan";
				}
				if (this.sg1.getCell(2,4)=="Neraca Lajur")
				{
					this.sql = "call sp_glma_pp_tmp ('"+this.kode_lokasi+"','"+this.kode_lokasi1+"','"+this.kode_lokasi2+"','"+this.sg1.getCell(2,1)+"','"+this.nik_user+"','"+this.kode_pp1+"','"+this.kode_pp2+"')";								
					this.nama_report="server_report_saku2_kopeg_gl_rptTBLajur";
				...
				if (this.sg1.getCell(2,4)=="12 Periode")
				{
					...
					this.nama_report="server_report_saku2_kopeg_gl_rptTB12";
				}
