// JavaScript Document
window.app_saku2_report_kopeg_gl_flNeraca2 = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_gl_flNeraca2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_gl_flNeraca2";
		this.maximize();
...
window.app_saku2_report_kopeg_gl_flNeraca2.extend(window.portalui_childForm);
window.app_saku2_report_kopeg_gl_flNeraca2.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_gl_rptNeraca2";
