// JavaScript Document
window.app_saku2_report_kopeg_gl_flTb = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_gl_flTb.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_gl_flTb";
		this.maximize();
...
window.app_saku2_report_kopeg_gl_flTb.extend(window.portalui_childForm);
window.app_saku2_report_kopeg_gl_flTb.implement({
