// JavaScript Document
window.app_saku2_report_kopeg_gl_flNeracaMutasi = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_gl_flNeracaMutasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_gl_flNeracaMutasi";
		this.maximize();
...
window.app_saku2_report_kopeg_gl_flNeracaMutasi.extend(window.portalui_childForm);
window.app_saku2_report_kopeg_gl_flNeracaMutasi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				{
					this.nama_report="server_report_saku2_kopeg_gl_rptNeracaMutasi";
				}
				else
				{
					this.nama_report="server_report_saku2_kopeg_gl_rptNeracaMutasiDC";
				}	
