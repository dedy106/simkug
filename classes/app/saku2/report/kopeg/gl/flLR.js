// JavaScript Document
window.app_saku2_report_kopeg_gl_flLR = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_gl_flLR.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_gl_flLR";
		this.maximize();
...
window.app_saku2_report_kopeg_gl_flLR.extend(window.portalui_childForm);
window.app_saku2_report_kopeg_gl_flLR.implement({
