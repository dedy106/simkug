// JavaScript Document
window.app_saku2_report_kopeg_gl_flJurnalSju = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_gl_flJurnalSju.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_gl_flJurnalSju";
		this.maximize();
...
window.app_saku2_report_kopeg_gl_flJurnalSju.extend(window.portalui_childForm);
window.app_saku2_report_kopeg_gl_flJurnalSju.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			{
				this.nama_report="server_report_saku2_kopeg_gl_rptBuktiJurnalSju";
			}
