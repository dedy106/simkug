window.app_saku2_report_kopeg_gl_flRefJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_gl_flRefJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_gl_flRefJurnal";
		this.maximize();
...
window.app_saku2_report_kopeg_gl_flRefJurnal.extend(window.childForm);
window.app_saku2_report_kopeg_gl_flRefJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				{
					this.nama_report="server_report_saku2_kopeg_gl_rptRefJurnal";
				}
				else
				{
					this.nama_report="server_report_saku2_kopeg_gl_rptRefJurnalBukti";
				}
