// JavaScript Document
window.app_saku2_report_kopeg_gl_flLRPp = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_gl_flLRPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_gl_flLRPp";
		this.maximize();
...
window.app_saku2_report_kopeg_gl_flLRPp.extend(window.portalui_childForm);
window.app_saku2_report_kopeg_gl_flLRPp.implement({
		...
		try
		{
			...
			if (sender == this.app._mainForm.bBack)
			{
				...
				if (this.link=="1")
				{
					...
					this.nama_report = "server_report_saku2_kopeg_gl_rptLR";
			...
			else
			{
				...
				sql="call sp_neraca_pp ('"+this.sg1.getCell(2,2)+"','L','"+in_lap+"',"+this.sg1.getCell(2,3)+",'"+this.sg1.getCell(2,1)+"','"+this.app._lokasi+"','"+this.app._lokasi+"','"+this.app._lokasi+"','"+this.nik_user+"','"+this.sg1.getCell(2,5)+"','"+this.sg1.getCell(2,5)+"')";
