// JavaScript Document
window.app_saku2_report_kopeg_gl_flNeraca = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_gl_flNeraca.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_gl_flNeraca";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick",this.app._namaForm, 2);
		uses("saiGrid;reportViewer;server_report_report;util_dbLarge;util_filterRep;util_gridLib");	
		this.p1 = new panel(this,{bound:[10,10,702,210],border:3, caption:"Filter"});
		this.sg1 = new saiGrid(this.p1,{bound:[1,20,700,180],colCount:4,cellExit:[this,"doCellExit"],
...
window.app_saku2_report_kopeg_gl_flNeraca.extend(window.portalui_childForm);
window.app_saku2_report_kopeg_gl_flNeraca.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,new Array(0,1,2,3,4,5,6,7),new  Array("123","1234","123","3","3","3","3","3"));
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,new Array(0,1,2,3,4,5,6,7),new  Array(2,0,2,0,0,0,0,0));
		}
		else
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,new Array(0,1,2,3,4,5,6,7),new  Array("3","1234","123","3","3","3","3","3"));
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				{
					in_lap="K";
					this.nama_report="server_report_saku2_kopeg_gl_rptNeraca";
				}
				else
				{
					this.nama_report="server_report_saku2_kopeg_gl_rptNeracaStafel";
				}
				this.filter2 = this.nik_user+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,3)+"/"+this.sg1.getCell(2,5)+"/"+this.app._namaForm+"/"+this.kode_lokasi+"/"+this.sg1.getCell(2,6)+"/"+this.sg1.getCell(2,7);
