...
//* 			SAI, PT											
//***********************************************************************************************
window.app_saku2_report_kopeg_gl_flBukuBesarPp = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_gl_flBukuBesarPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_gl_flBukuBesarPp";
		this.maximize();
...
window.app_saku2_report_kopeg_gl_flBukuBesarPp.extend(window.portalui_childForm);
window.app_saku2_report_kopeg_gl_flBukuBesarPp.implement({
	doEllipseClick: function(sender, col, row){
		...
		if (row == 3)
		{
			this.filterRep.ListDataSGFilter(this, "Data Akun",this.sg1, this.sg1.row, this.sg1.col,
													  "select a.kode_akun, a.nama from masakun a where a.block= '0' and a.modul='L' "+
													   this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," and ")+" ",
													  "select count(a.kode_akun) from masakun a where a.block= '0' and a.modul='L' "+
													  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," and "),
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter=this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1)," and ")+
				...
				this.filter2 = this.app._namaForm+"/"+this.sg1.getCell(2,1)+"/"+this.app._nikUser+"/"+this.kode_pp1+"/"+this.nama_pp+"/"+this.sg1.getCell(2,5);
				this.nama_report="server_report_saku2_kopeg_gl_rptBukuBesarPp";
				...
				{
					this.sql = "call sp_glma_pp_akun_tmp ('"+this.sg1.getCell(2,3)+"','"+this.sg1.getCell(2,3)+"','"+this.sg1.getCell(2,0)+"','"+this.sg1.getCell(2,0)+"','"+this.sg1.getCell(2,0)+"','"+this.sg1.getCell(2,1)+"','"+this.app._nikUser+"','"+this.kode_pp1+"','"+this.kode_pp2+"')";
				}
				if (this.sg1.getCell(1,3)=="Range")
				{
					this.sql = "call sp_glma_pp_akun_tmp ('"+this.sg1.getCell(2,3)+"','"+this.sg1.getCell(3,3)+"','"+this.sg1.getCell(2,0)+"','"+this.sg1.getCell(2,0)+"','"+this.sg1.getCell(2,0)+"','"+this.sg1.getCell(2,1)+"','"+this.app._nikUser+"','"+this.kode_pp1+"','"+this.kode_pp2+"')";
				}
