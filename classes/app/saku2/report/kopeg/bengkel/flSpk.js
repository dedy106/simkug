window.app_saku2_report_kopeg_bengkel_flSpk = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_bengkel_flSpk.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_bengkel_flSpk";
		this.maximize();
...
window.app_saku2_report_kopeg_bengkel_flSpk.extend(window.childForm);
window.app_saku2_report_kopeg_bengkel_flSpk.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_bengkel_flSpk]::mainButtonClick:"+e);
		}
	},
