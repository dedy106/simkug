window.app_saku2_report_kopeg_bengkel_flSpkKas = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_bengkel_flSpkKas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_bengkel_flSpkKas";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from kas_m where kode_lokasi='"+this.app._lokasi+"' and modul='KBJUAL'");
...
window.app_saku2_report_kopeg_bengkel_flSpkKas.extend(window.childForm);
window.app_saku2_report_kopeg_bengkel_flSpkKas.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from kas_m where kode_lokasi='"+this.app._lokasi+"' and modul='KBJUAL' order by periode desc",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
		if (row == 4)
		{
			this.sg1.columns.get(2).pickList.clear();
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				{
					this.nama_report="server_report_saku2_kopeg_bengkel_rptBuktiBankDaftar";
				}
				else
				{
					this.nama_report="server_report_saku2_kopeg_bengkel_rptBuktiBank";
				}
