window.app_saku2_report_kopeg_bengkel_flSpkCust = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_bengkel_flSpkCust.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_bengkel_flSpkCust";
		this.maximize();
...
window.app_saku2_report_kopeg_bengkel_flSpkCust.extend(window.childForm);
window.app_saku2_report_kopeg_bengkel_flSpkCust.implement({
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5],["123","123","123","13","13","123"]);
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.no_spk",this.sg1.getCell(1,5),this.sg1.getCell(2,5),this.sg1.getCell(3,5),"and");
				this.filter2 = this.sg1.getCell(2,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku2_kopeg_bengkel_rptSpkCust";
			...
			systemAPI.alert("[app_saku2_report_kopeg_bengkel_flSpkCust]::mainButtonClick:"+e);
		}
	},
