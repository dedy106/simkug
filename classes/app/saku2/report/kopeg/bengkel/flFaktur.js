window.app_saku2_report_kopeg_bengkel_flFaktur = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_bengkel_flFaktur.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_bengkel_flFaktur";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("No Faktur","All",""));
...
window.app_saku2_report_kopeg_bengkel_flFaktur.extend(window.childForm);
window.app_saku2_report_kopeg_bengkel_flFaktur.implement({
		...
		try{			
			...
			if (row ==4)
			{
				filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.kode_cust",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
				this.filterRep.ListDataSGFilter(this, "Data Faktur",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_jual, a.no_dokumen,a.kode_cust from fri_jual_m a "+filter,
												"select count(a.no_jual) from fri_jual_m a "+filter,
												new Array("a.no_jual","a.no_dokumen","a.kode_cust"),"and",new Array("No Bukti","No SPK","Customer"));
			}			
		}catch(e){
			systemAPI.alert(e);
		}
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("a.kode_cust",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
							this.filterRep.filterStr("a.no_faktur",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and")+
			...
			systemAPI.alert("[app_saku2_report_kopeg_bengkel_flFaktur]::mainButtonClick:"+e);
		}
	},
