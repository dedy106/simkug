window.app_saku2_report_kopeg_bengkel_flSpkPos = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_bengkel_flSpkPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_bengkel_flSpkPos";
		this.maximize();
...
window.app_saku2_report_kopeg_bengkel_flSpkPos.extend(window.childForm);
window.app_saku2_report_kopeg_bengkel_flSpkPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_bengkel_rptSpkPos";
			...
			systemAPI.alert("[app_saku2_report_kopeg_bengkel_flSpkPos]::mainButtonClick:"+e);
		}
	},
