window.app_saku2_report_kopeg_bengkel_flJualHarianCash = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_bengkel_flJualHarianCash.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_bengkel_flJualHarianCash";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Jenis KBM","All",""));
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("Customer","All",""));
...
window.app_saku2_report_kopeg_bengkel_flJualHarianCash.extend(window.childForm);
window.app_saku2_report_kopeg_bengkel_flJualHarianCash.implement({
		...
		try{			
			...
			if (row ==5)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Penjualan",this.sg1, this.sg1.row, this.sg1.col,
												...
												new Array("a.no_jual","a.keterangan"),"and",new Array("No Bukti","No Polisi"));
			}
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6],["123","123","123","13","123","123","13"]);
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5,6],[2,0,2,0,2,2,1]);	
		if (row == 1)
		{
		...
		try
		{
			...
			else
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.no_jual",this.sg1.getCell(1,5),this.sg1.getCell(2,5),this.sg1.getCell(3,5),"and")+tanggal;
				this.filter2 = this.sg1.getCell(2,1)+"|"+this.sg1.getCellDateValue(2,6);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku2_kopeg_bengkel_rptJualHarianCash";
			...
			systemAPI.alert("[app_saku2_report_kopeg_bengkel_flJualHarianCash]::mainButtonClick:"+e);
		}
	},
