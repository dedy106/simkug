window.app_saku2_report_kopeg_panjar_flPjPtgForm = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_panjar_flPjPtgForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_panjar_flPjPtgForm";
		this.maximize();
...
window.app_saku2_report_kopeg_panjar_flPjPtgForm.extend(window.childForm);
window.app_saku2_report_kopeg_panjar_flPjPtgForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_panjar_flPjPtgForm]::mainButtonClick:"+e);
		}
	},
