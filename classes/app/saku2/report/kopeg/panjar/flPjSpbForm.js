window.app_saku2_report_kopeg_panjar_flPjSpbForm = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_panjar_flPjSpbForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_panjar_flPjSpbForm";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from panjarptg2_m ");
...
window.app_saku2_report_kopeg_panjar_flPjSpbForm.extend(window.childForm);
window.app_saku2_report_kopeg_panjar_flPjSpbForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_panjar_rptPjSpbForm";
			...
			systemAPI.alert("[app_saku2_report_kopeg_panjar_flPjSpbForm]::mainButtonClick:"+e);
		}
	},
