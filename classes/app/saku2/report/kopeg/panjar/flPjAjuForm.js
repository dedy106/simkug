window.app_saku2_report_kopeg_panjar_flPjAjuForm = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_panjar_flPjAjuForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_panjar_flPjAjuForm";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from panjar2_m ");
...
window.app_saku2_report_kopeg_panjar_flPjAjuForm.extend(window.childForm);
window.app_saku2_report_kopeg_panjar_flPjAjuForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_panjar_flPjAjuForm]::mainButtonClick:"+e);
		}
	},
