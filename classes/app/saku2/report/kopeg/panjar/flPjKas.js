window.app_saku2_report_kopeg_panjar_flPjKas = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_panjar_flPjKas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_panjar_flPjKas";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from kas_m where kode_lokasi='"+this.app._lokasi+"' and modul='KBSPBPJ'");
...
window.app_saku2_report_kopeg_panjar_flPjKas.extend(window.childForm);
window.app_saku2_report_kopeg_panjar_flPjKas.implement({
