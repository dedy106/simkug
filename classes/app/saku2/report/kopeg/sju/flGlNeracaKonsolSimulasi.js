window.app_saku2_report_kopeg_sju_flGlNeracaKonsolSimulasi = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flGlNeracaKonsolSimulasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flGlNeracaKonsolSimulasi";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flGlNeracaKonsolSimulasi.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flGlNeracaKonsolSimulasi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_sju_rptGlNeracaKonsolSimulasi";
				...
				{
					this.nama_report="server_report_saku2_kopeg_sju_rptGlNeracaRincianKonsolSimulasi";
				}
				if (this.sg1.getCell(2,2)=="FS3")
				{
					this.nama_report="server_report_saku2_kopeg_sju_rptGlPasivaRincianKonsolSimulasi";
				}
