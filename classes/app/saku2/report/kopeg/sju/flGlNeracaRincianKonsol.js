window.app_saku2_report_kopeg_sju_flGlNeracaRincianKonsol = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flGlNeracaRincianKonsol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flGlNeracaRincianKonsol";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flGlNeracaRincianKonsol.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flGlNeracaRincianKonsol.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				{
					this.nama_report="server_report_saku2_kopeg_sju_rptGlNeracaRincianKonsol";
				}
				if (this.sg1.getCell(2,2)=="FS3")
				{
					this.nama_report="server_report_saku2_kopeg_sju_rptGlPasivaRincianKonsol";
				}
	...
	doOpenTb: function(kode_neraca,kode_lokasi,periode){
		...
		nama_report="server_report_saku2_kopeg_sju_rptGlTbJejer";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
	...
	doOpenBb: function(kode_akun,kode_lokasi,periode){
		...
		nama_report="server_report_saku2_kopeg_sju_rptGlBukuBesar";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
