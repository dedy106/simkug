window.app_saku2_report_kopeg_sju_flGlTbArusKas = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flGlTbArusKas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flGlTbArusKas";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flGlTbArusKas.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flGlTbArusKas.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_sju_rptGlTbArusKas";
	...
	doOpenBb: function(kode_akun,kode_lokasi,periode){
		...
		nama_report="server_report_saku2_kopeg_sju_rptGlBukuBesarArusKas";
