window.app_saku2_report_kopeg_sju_flGlLabaRugiSdm = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flGlLabaRugiSdm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flGlLabaRugiSdm";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flGlLabaRugiSdm.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flGlLabaRugiSdm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_sju_rptGlLabaRugiSdm";
