window.app_saku2_report_kopeg_sju_flGlLabaRugiPasarKonsol = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flGlLabaRugiPasarKonsol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flGlLabaRugiPasarKonsol";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Kode FS","=","FS6"));
...
window.app_saku2_report_kopeg_sju_flGlLabaRugiPasarKonsol.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flGlLabaRugiPasarKonsol.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_sju_rptGlLabaRugiPasarKonsol";
