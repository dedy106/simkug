window.app_saku2_report_kopeg_sju_flAggPdptCabang = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flAggPdptCabang.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flAggPdptCabang";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flAggPdptCabang.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flAggPdptCabang.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				{
					this.nama_report="server_report_saku2_kopeg_sju_rptAggPdptCabangGroup";
				}
				else
				{
					this.nama_report="server_report_saku2_kopeg_sju_rptAggPdptCabang";
				}
