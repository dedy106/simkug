window.app_saku2_report_kopeg_sju_flPrKonfirmasi = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPrKonfirmasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPrKonfirmasi";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flPrKonfirmasi.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPrKonfirmasi.implement({
		...
		try{			
			...
			if (row ==6)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Quotation",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_quo, catat from sju_quo_m a "+filter,
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.no_quo",this.sg1.getCell(1,6),this.sg1.getCell(2,6),this.sg1.getCell(3,6),"and");
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flPrKonfirmasi]::mainButtonClick:"+e);
		}
	},
