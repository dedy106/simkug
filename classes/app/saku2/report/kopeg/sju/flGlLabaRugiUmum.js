window.app_saku2_report_kopeg_sju_flGlLabaRugiUmum = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flGlLabaRugiUmum.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flGlLabaRugiUmum";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flGlLabaRugiUmum.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flGlLabaRugiUmum.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_sju_rptGlLabaRugiUmum";
