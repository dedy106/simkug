window.app_saku2_report_kopeg_sju_flKbJurnalBukti = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flKbJurnalBukti.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flKbJurnalBukti";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flKbJurnalBukti.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flKbJurnalBukti.implement({
