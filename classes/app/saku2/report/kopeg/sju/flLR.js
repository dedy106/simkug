// JavaScript Document
window.app_saku2_report_kopeg_sju_flLR = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flLR.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flLR";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flLR.extend(window.portalui_childForm);
window.app_saku2_report_kopeg_sju_flLR.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2 = this.nik_user+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,4)+"/"+this.sg1.getCell(2,3)+"/"+this.app._namaForm+"/"+this.kode_lokasi;
				
				this.nama_report="server_report_saku2_kopeg_sju_rptLR";
