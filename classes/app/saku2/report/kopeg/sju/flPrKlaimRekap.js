window.app_saku2_report_kopeg_sju_flPrKlaimRekap = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPrKlaimRekap.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPrKlaimRekap";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flPrKlaimRekap.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPrKlaimRekap.implement({
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2],["123","123"]);
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_sju_rptPrKlaimRekap";
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flPrKlaimRekap]::mainButtonClick:"+e);
		}
	},
