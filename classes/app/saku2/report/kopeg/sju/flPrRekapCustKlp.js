window.app_saku2_report_kopeg_sju_flPrRekapCustKlp = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPrRekapCustKlp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPrRekapCustKlp";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flPrRekapCustKlp.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPrRekapCustKlp.implement({
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1],["123","3","3"]);
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1],[2,0,0]);	
		if (row == 1)
		{
	...
	mainButtonClick: function(sender){
		try
		{
			...
			if (sender == this.app._mainForm.bBack)
			{
				...
				if (this.link=="2")
				{
					this.doOpenPolisList(this.kode_klp,this.kode_lokasi);
				}			
			}
			else
			{
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flPrRekapCustKlp]::mainButtonClick:"+e);
		}
	},
	...
	doOpenPolisList: function(kode_klp,kode_lokasi){
		this.kode_klp=kode_klp;
		this.kode_lokasi=kode_lokasi;
		this.link="1";
		filter = "where c.kode_klp='"+kode_klp+"' and a.kode_lokasi='"+kode_lokasi+"' ";
		filter2="";
