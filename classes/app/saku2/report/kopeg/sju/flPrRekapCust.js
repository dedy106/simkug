window.app_saku2_report_kopeg_sju_flPrRekapCust = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPrRekapCust.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPrRekapCust";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flPrRekapCust.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPrRekapCust.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flPrRekapCust]::mainButtonClick:"+e);
		}
	},
	...
	doOpenPolisList: function(kode_cust,kode_lokasi){
