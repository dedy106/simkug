window.app_saku2_report_kopeg_sju_flGlCf = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flGlCf.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flGlCf";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flGlCf.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flGlCf.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_saku2_kopeg_sju_rptGlCf";
