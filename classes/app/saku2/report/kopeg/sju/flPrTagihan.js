window.app_saku2_report_kopeg_sju_flPrTagihan = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPrTagihan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPrTagihan";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flPrTagihan.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPrTagihan.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flPrTagihan]::mainButtonClick:"+e);
		}
	},
