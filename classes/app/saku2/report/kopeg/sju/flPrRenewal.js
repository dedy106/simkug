window.app_saku2_report_kopeg_sju_flPrRenewal = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPrRenewal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPrRenewal";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flPrRenewal.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPrRenewal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flPrRenewal]::mainButtonClick:"+e);
		}
	},
