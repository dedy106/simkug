window.app_saku2_report_kopeg_sju_flGlJurnalBukti = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flGlJurnalBukti.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flGlJurnalBukti";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flGlJurnalBukti.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flGlJurnalBukti.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_saku2_kopeg_sju_rptGlJurnalBukti";
