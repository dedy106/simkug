window.app_saku2_report_kopeg_sju_flPjPtgJurnalPas = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPjPtgJurnalPas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPjPtgJurnalPas";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from kas_m where kode_lokasi='"+this.app._lokasi+"' and modul='KBPTG'");
...
window.app_saku2_report_kopeg_sju_flPjPtgJurnalPas.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPjPtgJurnalPas.implement({
