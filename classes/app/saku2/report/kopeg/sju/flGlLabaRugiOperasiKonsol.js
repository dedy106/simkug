window.app_saku2_report_kopeg_sju_flGlLabaRugiOperasiKonsol = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flGlLabaRugiOperasiKonsol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flGlLabaRugiOperasiKonsol";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Kode FS","=","FS7"));
...
window.app_saku2_report_kopeg_sju_flGlLabaRugiOperasiKonsol.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flGlLabaRugiOperasiKonsol.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.app._nikUser+"/"+this.sg1.getCell(3,0);
				this.nama_report="server_report_saku2_kopeg_sju_rptGlLabaRugiOperasiKonsol";
	...
	doOpenTb: function(kode_neraca,kode_lokasi,periode){
		...
		this.periode=periode;
		this.link="1";
		filter2=this.sg1.getCell(2,0)+"/"+periode+"/"+this.app._nikUser+"/"+"Tidak/2";
