window.app_saku2_report_kopeg_sju_flGlLabaRugiOperasi = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flGlLabaRugiOperasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flGlLabaRugiOperasi";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flGlLabaRugiOperasi.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flGlLabaRugiOperasi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_sju_rptGlLabaRugiOperasi";
	...
	doOpenGar: function(kode_neraca,kode_lokasi,periode){
		...
		filter="where x.kode_lokasi='"+kode_lokasi+"' and z.kode_neraca='"+kode_neraca+"' and substring(x.periode,1,4)='"+periode.substr(0,4)+"' and z.kode_fs='FP6' ";
