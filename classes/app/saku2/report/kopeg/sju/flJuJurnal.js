window.app_saku2_report_kopeg_sju_flJuJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flJuJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flJuJurnal";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from ju_m where kode_lokasi='"+this.app._lokasi+"'");
...
window.app_saku2_report_kopeg_sju_flJuJurnal.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flJuJurnal.implement({
		...
		try{			
			...
			if (row == 2)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Dokumen",this.sg1, this.sg1.row, this.sg1.col,
														  "select no_dokumen, nama from dokumen  "+filter ,
														  "select count(no_dokumen) from dokumen "+filter,
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_saku2_kopeg_sju_rptJuJurnal";
