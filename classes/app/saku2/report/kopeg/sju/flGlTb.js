window.app_saku2_report_kopeg_sju_flGlTb = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flGlTb.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flGlTb";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flGlTb.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flGlTb.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_sju_rptGlTb";
