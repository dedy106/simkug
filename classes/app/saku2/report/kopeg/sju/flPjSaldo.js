window.app_saku2_report_kopeg_sju_flPjSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPjSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPjSaldo";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flPjSaldo.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPjSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_sju_rptPjSaldo";
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flPjSaldo]::mainButtonClick:"+e);
		}
	},
