window.app_saku2_report_kopeg_sju_flCust = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flCust.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flCust";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flCust.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flCust.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_sju_rptCust";
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flCust]::mainButtonClick:"+e);
		}
	},
