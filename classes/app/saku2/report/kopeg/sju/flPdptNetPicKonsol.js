window.app_saku2_report_kopeg_sju_flPdptNetPicKonsol = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPdptNetPicKonsol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPdptNetPicKonsol";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from gldt_tmp where kode_lokasi<>'10'");
...
window.app_saku2_report_kopeg_sju_flPdptNetPicKonsol.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPdptNetPicKonsol.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from gldt_tmp where kode_lokasi<>'10' order by periode desc",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
		if (row == 2)
		{
			this.sg1.columns.get(2).pickList.clear();
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flPdptNetPicKonsol]::mainButtonClick:"+e);
		}
	},
