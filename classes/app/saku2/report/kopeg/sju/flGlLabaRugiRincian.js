window.app_saku2_report_kopeg_sju_flGlLabaRugiRincian = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flGlLabaRugiRincian.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flGlLabaRugiRincian";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flGlLabaRugiRincian.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flGlLabaRugiRincian.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_sju_rptGlLabaRugiRincian";
