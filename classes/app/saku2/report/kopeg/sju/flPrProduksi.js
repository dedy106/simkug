window.app_saku2_report_kopeg_sju_flPrProduksi = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPrProduksi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPrProduksi";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flPrProduksi.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPrProduksi.implement({
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("b.kode_vendor",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4),"and")+
				...
				this.nama_report = "server_report_saku2_kopeg_sju_rptPrProduksi";
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flPrProduksi]::mainButtonClick:"+e);
		}
	},
