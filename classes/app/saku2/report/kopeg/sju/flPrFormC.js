window.app_saku2_report_kopeg_sju_flPrFormC = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPrFormC.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPrFormC";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flPrFormC.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPrFormC.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_sju_rptPrFormC";
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flPrFormC]::mainButtonClick:"+e);
		}
	},
