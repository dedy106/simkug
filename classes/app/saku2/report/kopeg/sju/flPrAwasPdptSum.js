window.app_saku2_report_kopeg_sju_flPrAwasPdptSum = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPrAwasPdptSum.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPrAwasPdptSum";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flPrAwasPdptSum.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPrAwasPdptSum.implement({
		...
		try
		{
			...
			else
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("d.kode_vendor",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and")+
				...
				this.nama_report = "server_report_saku2_kopeg_sju_rptPrAwasPdptSum";
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flPrAwasPdptSum]::mainButtonClick:"+e);
		}
	},
