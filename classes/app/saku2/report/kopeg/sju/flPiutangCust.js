window.app_saku2_report_kopeg_sju_flPiutangCust = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPiutangCust.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPiutangCust";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flPiutangCust.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPiutangCust.implement({
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3],["123","12368","123","3"]);
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(1,1)+"/"+this.sg1.getCell(3,1)+"/"+this.sg1.getCell(2,3);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku2_kopeg_sju_rptPiutangCust";
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flPiutangCust]::mainButtonClick:"+e);
		}
	},
