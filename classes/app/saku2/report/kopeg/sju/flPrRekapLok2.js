window.app_saku2_report_kopeg_sju_flPrRekapLok2 = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPrRekapLok2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPrRekapLok2";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flPrRekapLok2.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPrRekapLok2.implement({
	...
	{		
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("Marketing","Tertanggung","Jenis Tertanggung","Cabang"));
		}	
	},
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flPrRekapLok2]::mainButtonClick:"+e);
		}
	},
	...
	doOpenPolisList: function(kode_lokasi){
