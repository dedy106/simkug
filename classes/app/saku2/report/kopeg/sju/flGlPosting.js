window.app_saku2_report_kopeg_sju_flGlPosting = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flGlPosting.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flGlPosting";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flGlPosting.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flGlPosting.implement({
		...
		try{			
			...
			if (row == 2)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Daftar Bukti",this.sg1, this.sg1.row, this.sg1.col,
														  "select no_post, keterangan from posting_m  "+filter ,
														  "select count(no_post) from posting_m "+filter,
														  new Array("no_post","keterangan"),"and");
			}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				{
					this.nama_report="server_report_saku2_kopeg_sju_rptGlPosting";
				}
				else
				{
					this.nama_report="server_report_saku2_kopeg_sju_rptGlPostingDetail";
				}
