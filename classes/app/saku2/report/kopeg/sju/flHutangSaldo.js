window.app_saku2_report_kopeg_sju_flHutangSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flHutangSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flHutangSaldo";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flHutangSaldo.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flHutangSaldo.implement({
		...
		try
		{
			...
			else
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("d.kode_vendor",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
				...
				this.nama_report = "server_report_saku2_kopeg_sju_rptHutangSaldo";
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flHutangSaldo]::mainButtonClick:"+e);
		}
	},
