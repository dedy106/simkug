window.app_saku2_report_kopeg_sju_flPrRekapCobKonsol = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPrRekapCobKonsol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPrRekapCobKonsol";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Periode Polis","All",""));
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Tertanggung","All",""));
	...
	this.gridLib.SGEditData(this.sg1,5,new Array(0,1,2), new Array("Short By","=","Tertanggung"));
...
window.app_saku2_report_kopeg_sju_flPrRekapCobKonsol.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPrRekapCobKonsol.implement({
	...
	{		
		...
		if (row == 1)
		{
			var sql="select distinct periode from sju_polis_m where kode_lokasi='"+this.sg1.getCell(2,0)+"' "+ 
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("Tertanggung","Premi","Brokerage"));
		}
	},
	mainButtonClick: function(sender){
		try
		{
			...
			if (sender == this.app._mainForm.bBack)
			{
				...
				if (this.link=="2")
				{
					this.doOpenPolisList(this.kode_pic,this.kode_lokasi);
				}			
			}
			else
			{
				...
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.filterRep.filterStr("b.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+"/"+this.sg1.getCell(2,5);

				
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku2_kopeg_sju_rptPrRekapCob";
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flPrRekapCobKonsol]::mainButtonClick:"+e);
		}
	},
	...
	doOpenPolisList: function(kode_pic,kode_lokasi){
		this.kode_pic=kode_pic;
		this.kode_lokasi=kode_lokasi;
		this.link="1";
		filter = "where a.kode_pic='"+kode_pic+"' and a.kode_lokasi='"+kode_lokasi+"' ";
		filter2="";
		nama_report="server_report_saku2_kopeg_sju_rptPrPolisList";
