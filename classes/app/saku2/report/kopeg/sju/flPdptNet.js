window.app_saku2_report_kopeg_sju_flPdptNet = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPdptNet.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPdptNet";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flPdptNet.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPdptNet.implement({
	...
	{		
		...
		else
		{
			...
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1],[3,0,0]);	
		}
		if (row == 1)
		{
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flPdptNet]::mainButtonClick:"+e);
		}
	},
