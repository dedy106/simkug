window.app_saku2_report_kopeg_sju_flPrPolisList = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPrPolisList.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPrPolisList";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flPrPolisList.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPrPolisList.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_kopeg_sju_rptPrPolisList";
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flPrPolisList]::mainButtonClick:"+e);
		}
	},
