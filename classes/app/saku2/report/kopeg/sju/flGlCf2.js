window.app_saku2_report_kopeg_sju_flGlCf2 = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flGlCf2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flGlCf2";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flGlCf2.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flGlCf2.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_saku2_kopeg_sju_rptGlCf2";
