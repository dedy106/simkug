window.app_saku2_report_kopeg_sju_flGlLabaRugiRincianKonsolSimulasi = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flGlLabaRugiRincianKonsolSimulasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flGlLabaRugiRincianKonsolSimulasi";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flGlLabaRugiRincianKonsolSimulasi.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flGlLabaRugiRincianKonsolSimulasi.implement({
		...
		try{			
			...
			if (row == 2)
			{
				this.filterRep.ListDataSGFilter(this, "Data FS",this.sg1, this.sg1.row, this.sg1.col,
														  "select kode_fs,nama from fs where kode_fs in ('FS4','FS5','FS6','FS7') "+
														  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," and "),
														  "select count(kode_fs) from fs where kode_fs in ('FS4','FS5','FS6','FS7')  "+
														  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," and "),
