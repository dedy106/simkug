window.app_saku2_report_kopeg_sju_flGlLabaRugiKonsol = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flGlLabaRugiKonsol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flGlLabaRugiKonsol";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flGlLabaRugiKonsol.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flGlLabaRugiKonsol.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_sju_rptGlLabaRugiKonsol";
