window.app_saku2_report_kopeg_sju_flGlNeracaRincianJejer = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flGlNeracaRincianJejer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flGlNeracaRincianJejer";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flGlNeracaRincianJejer.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flGlNeracaRincianJejer.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				{
					this.nama_report="server_report_saku2_kopeg_sju_rptGlNeracaRincianJejer";
				}
				if (this.sg1.getCell(2,2)=="FS3")
				{
					this.nama_report="server_report_saku2_kopeg_sju_rptGlPasivaRincianJejer";
				}
