window.app_saku2_report_kopeg_sju_flGlLabaRugiUmumKonsol = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flGlLabaRugiUmumKonsol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flGlLabaRugiUmumKonsol";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Kode FS","=","FS5"));
...
window.app_saku2_report_kopeg_sju_flGlLabaRugiUmumKonsol.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flGlLabaRugiUmumKonsol.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_sju_rptGlLabaRugiUmumKonsol";
