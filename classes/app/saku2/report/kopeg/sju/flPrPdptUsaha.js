window.app_saku2_report_kopeg_sju_flPrPdptUsaha = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPrPdptUsaha.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPrPdptUsaha";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flPrPdptUsaha.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPrPdptUsaha.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_sju_rptPrPdptusaha";
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flPrPdptUsaha]::mainButtonClick:"+e);
		}
	},
