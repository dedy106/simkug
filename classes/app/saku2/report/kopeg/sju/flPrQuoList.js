window.app_saku2_report_kopeg_sju_flPrQuoList = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPrQuoList.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPrQuoList";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flPrQuoList.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPrQuoList.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_sju_rptPrQuoList";
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flPrQuoList]::mainButtonClick:"+e);
		}
	},
