window.app_saku2_report_kopeg_sju_flGlNeracaSimulasi = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flGlNeracaSimulasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flGlNeracaSimulasi";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flGlNeracaSimulasi.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flGlNeracaSimulasi.implement({
	...
	{		
		...
		else
		{
			...
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3],[3,0,2,3]);
		}
		if (row == 1)
		{
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				{
					this.nama_report="server_report_saku2_kopeg_sju_rptGlNeracaSimulasi";
				}
