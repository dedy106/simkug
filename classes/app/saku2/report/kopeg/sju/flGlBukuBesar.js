window.app_saku2_report_kopeg_sju_flGlBukuBesar = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flGlBukuBesar.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flGlBukuBesar";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flGlBukuBesar.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flGlBukuBesar.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_sju_rptGlBukuBesar";
