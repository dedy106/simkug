window.app_saku2_report_kopeg_sju_flKbBukuBesar = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flKbBukuBesar.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flKbBukuBesar";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flKbBukuBesar.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flKbBukuBesar.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_sju_rptKbBukuBesar";
