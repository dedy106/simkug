window.app_saku2_report_kopeg_sju_flPdptLokasi = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPdptLokasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPdptLokasi";
		this.maximize();
	...
	this.lokasi=this.dbLib.getPeriodeFromSQL("select kode_lokasi as periode from lokasi where flag_konsol='1'");
...
window.app_saku2_report_kopeg_sju_flPdptLokasi.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPdptLokasi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_sju_rptPdptLokasi";
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flPdptLokasi]::mainButtonClick:"+e);
		}
	},
