window.app_saku2_report_kopeg_sju_flGlTbSimulasi = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flGlTbSimulasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flGlTbSimulasi";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flGlTbSimulasi.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flGlTbSimulasi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.app._nikUser+"/"+this.sg1.getCell(2,3)+"//"+this.periode_awal+"/"+this.sg1.getCell(3,1);
				
				this.nama_report="server_report_saku2_kopeg_sju_rptGlTbSimulasi";
				if (this.sg1.getCell(2,4)=="Tahunan")
				{
					this.nama_report="server_report_saku2_kopeg_sju_rptGlTbSimulasiTahun";
				}
