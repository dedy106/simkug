window.app_saku2_report_kopeg_sju_flPrKlaim = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPrKlaim.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPrKlaim";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flPrKlaim.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPrKlaim.implement({
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.no_polis",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and")+
				...
				this.nama_report = "server_report_saku2_kopeg_sju_rptPrKlaim";
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flPrKlaim]::mainButtonClick:"+e);
		}
	},
