// JavaScript Document
window.app_saku2_report_kopeg_sju_flNeraca = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flNeraca.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flNeraca";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flNeraca.extend(window.portalui_childForm);
window.app_saku2_report_kopeg_sju_flNeraca.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				in_lap="K";
				this.nama_report="server_report_saku2_kopeg_sju_rptNeraca";
				
				this.filter2 = this.nik_user+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,3)+"/"+this.kode_lokasi;
