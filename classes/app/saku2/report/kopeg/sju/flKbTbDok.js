window.app_saku2_report_kopeg_sju_flKbTbDok = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flKbTbDok.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flKbTbDok";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Kode Dokumen","All",""));
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Tampil Mutasi Nol","=","Ya"));
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku2_report_kopeg_sju_flKbTbDok.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flKbTbDok.implement({
	...
	{		
		...
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4],[2,0,2,0]);	
		if (row == 1)
		{
		...
		try
		{
			...
			else
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+
							...
							this.filterRep.filterStr("dbo.fnDokumen(a.no_kas)",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2)," and ");
				var filter3 = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+
							this.filterRep.filterStr("a.no_dokumen",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2)," and ");
				this.filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,3)+"/"+filter3;
				this.nama_report="server_report_saku2_kopeg_sju_rptKbTbDok";
	...
	doOpenBb: function(no_dokumen,kode_lokasi,periode){
		this.no_dokumen=no_dokumen;
		this.kode_lokasi=kode_lokasi;
		this.periode=periode;
		this.link="1";
		filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.app._nikUser+"/"+"Tidak/1";
		filter="where a.kode_lokasi='"+kode_lokasi+"' and dbo.fnDokumen(a.no_kas)='"+no_dokumen+"' ";
		nama_report="server_report_saku2_kopeg_sju_rptKbJurnal";
