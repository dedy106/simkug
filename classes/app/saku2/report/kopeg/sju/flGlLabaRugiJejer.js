window.app_saku2_report_kopeg_sju_flGlLabaRugiJejer = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flGlLabaRugiJejer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flGlLabaRugiJejer";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flGlLabaRugiJejer.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flGlLabaRugiJejer.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_sju_rptGlLabaRugiJejer";
