window.app_saku2_report_kopeg_sju_flGlRekapVendor = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flGlRekapVendor.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flGlRekapVendor";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flGlRekapVendor.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flGlRekapVendor.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			if (sender == this.app._mainForm.bBack)
			{
				...
				if (this.link=="2")
				{
					this.doOpenDetail(this.kode_vendor,this.kode_lokasi,this.kode_tipe);
				}			
			}
			else
			{
				...
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(1,1)+"/"+this.sg1.getCell(3,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku2_kopeg_sju_rptGlRekapVendor";
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flGlRekapVendor]::mainButtonClick:"+e);
		}
	},
	...
	doOpenDetail: function(kode_vendor,kode_lokasi,kode_tipe){
		...
		filter = "where a.kode_vendor='"+kode_vendor+"' and a.kode_lokasi='"+kode_lokasi+"' and a.kode_proyek='"+kode_tipe+"' "+periode;
		filter2="";
		nama_report="server_report_saku2_kopeg_sju_rptGlRekapVendorDetail";
	...
	doOpenPolisList: function(no_polis,kode_lokasi){
