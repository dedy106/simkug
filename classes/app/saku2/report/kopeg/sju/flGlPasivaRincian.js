window.app_saku2_report_kopeg_sju_flGlPasivaRincian = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flGlPasivaRincian.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flGlPasivaRincian";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flGlPasivaRincian.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flGlPasivaRincian.implement({
