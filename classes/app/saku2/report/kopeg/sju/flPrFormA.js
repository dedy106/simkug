window.app_saku2_report_kopeg_sju_flPrFormA = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPrFormA.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPrFormA";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flPrFormA.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPrFormA.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_sju_rptPrFormA";
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flPrFormA]::mainButtonClick:"+e);
		}
	},
