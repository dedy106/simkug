window.app_saku2_report_kopeg_sju_flPrPolis = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPrPolis.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPrPolis";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flPrPolis.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPrPolis.implement({
	...
	{		
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("Screen","Word"));
		}
	},
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("d.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("d.no_polis",this.sg1.getCell(1,6),this.sg1.getCell(2,6),this.sg1.getCell(3,6),"and");
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,7);
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flPrPolis]::mainButtonClick:"+e);
		}
	},
