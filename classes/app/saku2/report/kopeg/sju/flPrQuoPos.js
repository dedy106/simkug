window.app_saku2_report_kopeg_sju_flPrQuoPos = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPrQuoPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPrQuoPos";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,6,new Array(0,1,2), new Array("No Quotation","All",""));
...
window.app_saku2_report_kopeg_sju_flPrQuoPos.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPrQuoPos.implement({
		...
		try{			
			...
			if (row == 2)
			{
				this.filterRep.ListDataSGFilter(this, "Data COB",this.sg1, this.sg1.row, this.sg1.col,
														  "select kode_tipe, nama from sju_tipe "+
														   this.filterRep.kode_tipe("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  "select count(kode_klp) from sju_tipe "+
			...
			if (row ==6)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Polis",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_quo, no_dok from sju_quo_m a "+filter,
												"select count(a.no_quo) from sju_quo_m a "+filter,
												new Array("a.no_quo","a.no_dok"),"and",new Array("No Polis","No Dok Polis"));
			}
		...
		try
		{
			...
			else
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.no_quo",this.sg1.getCell(1,6),this.sg1.getCell(2,6),this.sg1.getCell(3,6),"and")+tanggal;
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,7);
				
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku2_kopeg_sju_rptPrQuoPos";
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flPrQuoPos]::mainButtonClick:"+e);
		}
	},
