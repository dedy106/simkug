window.app_saku2_report_kopeg_sju_flGlWorksheet = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flGlWorksheet.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flGlWorksheet";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flGlWorksheet.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flGlWorksheet.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_sju_rptGlWorksheet";
