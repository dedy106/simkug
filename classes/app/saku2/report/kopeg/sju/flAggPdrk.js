window.app_saku2_report_kopeg_sju_flAggPdrk = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flAggPdrk.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flAggPdrk";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flAggPdrk.extend(window.portalui_childForm);
window.app_saku2_report_kopeg_sju_flAggPdrk.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku2_kopeg_sju_rptAggPdrk";	
