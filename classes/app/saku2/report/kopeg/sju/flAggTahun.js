window.app_saku2_report_kopeg_sju_flAggTahun = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flAggTahun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flAggTahun";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flAggTahun.extend(window.portalui_childForm);
window.app_saku2_report_kopeg_sju_flAggTahun.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,["Triwulan"]);
		}
		if (row == 5)
		{
			this.sg1.columns.get(2).pickList.clear();
		...
		try
		{
			...
			else
			{
				...
				if (this.sg1.getCell(2,4)=="Triwulan")
				{
					...
					this.nama_report="server_report_saku2_kopeg_sju_rptAggRealTw";
				}
				if (this.sg1.getCell(2,4)=="Semester")
				{
					...
					this.nama_report="server_report_saku2_kopeg_sju_rptAggRealSem";
				}
