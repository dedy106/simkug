window.app_saku2_report_kopeg_sju_flPiutang = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPiutang.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPiutang";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("Status","=","OutStanding"));
...
window.app_saku2_report_kopeg_sju_flPiutang.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPiutang.implement({
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4],["123","12368","123","123","3"]);
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("All","OutStanding","Lunas"));
		}	
	},
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(1,1)+"/"+this.sg1.getCell(3,1)+"/"+this.sg1.getCell(2,4);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku2_kopeg_sju_rptPiutang";
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flPiutang]::mainButtonClick:"+e);
		}
	},
