window.app_saku2_report_kopeg_sju_flPjPtgJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPjPtgJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPjPtgJurnal";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flPjPtgJurnal.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPjPtgJurnal.implement({
