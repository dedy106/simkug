window.app_saku2_report_kopeg_sju_flPrHutangPremi = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPrHutangPremi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPrHutangPremi";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flPrHutangPremi.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPrHutangPremi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_sju_rptPrHutangPremi";
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flPrHutangPremi]::mainButtonClick:"+e);
		}
	},
