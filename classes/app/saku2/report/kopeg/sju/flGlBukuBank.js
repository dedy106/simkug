window.app_saku2_report_kopeg_sju_flGlBukuBank = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flGlBukuBank.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flGlBukuBank";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flGlBukuBank.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flGlBukuBank.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_sju_rptGlBukuBank";
