window.app_saku2_report_kopeg_sju_flPrBukuPolis = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPrBukuPolis.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPrBukuPolis";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,6,new Array(0,1,2), new Array("Digit Koma","=","4"));
...
window.app_saku2_report_kopeg_sju_flPrBukuPolis.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPrBukuPolis.implement({
	...
	{		
		...
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5,6,7],[2,0,2,2,2,2,0,1]);	
		if (row == 1)
		{
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.no_polis",this.sg1.getCell(1,5),this.sg1.getCell(2,5),this.sg1.getCell(3,5),"and")+tanggal;
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,6);
				
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku2_kopeg_sju_rptPrBukuPolis";
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flPrBukuPolis]::mainButtonClick:"+e);
		}
	},
