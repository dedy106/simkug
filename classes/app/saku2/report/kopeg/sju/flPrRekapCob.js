window.app_saku2_report_kopeg_sju_flPrRekapCob = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPrRekapCob.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPrRekapCob";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flPrRekapCob.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPrRekapCob.implement({
	...
	{		
		...
		if (row == 1)
		{
			var sql="select distinct periode from sju_polis_m where kode_lokasi='"+this.app._lokasi+"' "+ 
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flPrRekapCob]::mainButtonClick:"+e);
		}
	},
