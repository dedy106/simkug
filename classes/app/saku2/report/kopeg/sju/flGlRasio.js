window.app_saku2_report_kopeg_sju_flGlRasio = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flGlRasio.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flGlRasio";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flGlRasio.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flGlRasio.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.filter2=this.app._nikUser+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,0)+"/"+this.sg1.getCell(3,2);
				if (this.sg1.getCell(2,3)=="Summary")
				{
					this.nama_report="server_report_saku2_kopeg_sju_rptGlRasio";
				}
				else
				{
					this.nama_report="server_report_saku2_kopeg_sju_rptGlRasioDetail";
				}
