window.app_saku2_report_kopeg_sju_flJuHutangPremi = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flJuHutangPremi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flJuHutangPremi";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from ju_m where kode_lokasi='"+this.app._lokasi+"' and modul='JUHUTPOL' ");
...
window.app_saku2_report_kopeg_sju_flJuHutangPremi.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flJuHutangPremi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flJuHutangPremi]::mainButtonClick:"+e);
		}
	},
