window.app_saku2_report_kopeg_sju_flKbRincianAkru = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flKbRincianAkru.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flKbRincianAkru";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flKbRincianAkru.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flKbRincianAkru.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flKbRincianAkru]::mainButtonClick:"+e);
		}
	},
