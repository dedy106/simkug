window.app_saku2_report_kopeg_sju_flGlTbJejer = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flGlTbJejer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flGlTbJejer";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flGlTbJejer.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flGlTbJejer.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_sju_rptGlTbJejer";
	...
	doOpenBbKonsol: function(kode_akun,kode_lokasi,periode){
		...
		filter="where a.kode_lokasi='"+kode_lokasi+"' and a.kode_akun='"+kode_akun+"' ";
		nama_report="server_report_saku2_kopeg_sju_rptGlBukuBesarKonsol";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
