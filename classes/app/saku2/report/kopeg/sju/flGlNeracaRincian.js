window.app_saku2_report_kopeg_sju_flGlNeracaRincian = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flGlNeracaRincian.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flGlNeracaRincian";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flGlNeracaRincian.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flGlNeracaRincian.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_sju_rptGlNeracaRincian";
				...
				{
					this.nama_report="server_report_saku2_kopeg_sju_rptGlPasivaRincian";
				}
	...
	doOpenTb: function(kode_neraca,kode_lokasi,periode){
		...
		nama_report="server_report_saku2_kopeg_sju_rptGlTb";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
