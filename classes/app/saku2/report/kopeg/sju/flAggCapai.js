window.app_saku2_report_kopeg_sju_flAggCapai = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flAggCapai.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flAggCapai";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flAggCapai.extend(window.portalui_childForm);
window.app_saku2_report_kopeg_sju_flAggCapai.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2=this.nik_user+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,3);	
				
				this.nama_report="server_report_saku2_kopeg_sju_rptAggCapai";
