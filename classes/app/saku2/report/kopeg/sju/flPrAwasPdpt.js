window.app_saku2_report_kopeg_sju_flPrAwasPdpt = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPrAwasPdpt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPrAwasPdpt";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flPrAwasPdpt.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPrAwasPdpt.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flPrAwasPdpt]::mainButtonClick:"+e);
		}
	},
