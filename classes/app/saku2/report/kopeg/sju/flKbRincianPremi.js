window.app_saku2_report_kopeg_sju_flKbRincianPremi = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flKbRincianPremi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flKbRincianPremi";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flKbRincianPremi.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flKbRincianPremi.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from kas_m where kode_lokasi='"+this.app._lokasi+"' and modul='KBPOLIS' order by periode",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flKbRincianPremi]::mainButtonClick:"+e);
		}
	},
