window.app_saku2_report_kopeg_sju_flPrFormB = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPrFormB.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPrFormB";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flPrFormB.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPrFormB.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_sju_rptPrFormB";
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flPrFormB]::mainButtonClick:"+e);
		}
	},
