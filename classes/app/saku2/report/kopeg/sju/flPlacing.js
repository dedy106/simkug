window.app_saku2_report_kopeg_sju_flPlacing = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPlacing.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPlacing";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Jenis Asuransi","All",""));
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("No Bukti","All",""));
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("Jenis Laporan","=","Screen"));
...
window.app_saku2_report_kopeg_sju_flPlacing.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPlacing.implement({
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.no_placing",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and");
				this.filter2 = this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,4);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku2_kopeg_sju_rptPlacing";
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flPlacing]::mainButtonClick:"+e);
		}
	},
