window.app_saku2_report_kopeg_sju_flVendor = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flVendor.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flVendor";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Kode Penanggung","All",""));
...
window.app_saku2_report_kopeg_sju_flVendor.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flVendor.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_sju_rptVendor";
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flVendor]::mainButtonClick:"+e);
		}
	},
