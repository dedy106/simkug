window.app_saku2_report_kopeg_sju_flKbBt = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flKbBt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flKbBt";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flKbBt.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flKbBt.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_sju_rptKbBt";
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flKbBt]::mainButtonClick:"+e);
		}
	},
