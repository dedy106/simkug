window.app_saku2_report_kopeg_sju_flHutangKartu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flHutangKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flHutangKartu";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flHutangKartu.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flHutangKartu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_sju_rptHutangKartu";
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flHutangKartu]::mainButtonClick:"+e);
		}
	},
