window.app_saku2_report_kopeg_sju_flGlLabaRugi = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flGlLabaRugi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flGlLabaRugi";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flGlLabaRugi.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flGlLabaRugi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_sju_rptGlLabaRugi";
