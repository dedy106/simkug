window.app_saku2_report_kopeg_sju_flGlBukuBesarSimulasi = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flGlBukuBesarSimulasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flGlBukuBesarSimulasi";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,5,new Array(0,1,2), new Array("Sort By","=","Tanggal"));
	this.gridLib.SGEditData(this.sg1,6,new Array(0,1,2), new Array("Format Laporan","=","Buku Besar"));
	this.gridLib.SGEditData(this.sg1,7,new Array(0,1,2), new Array("Output Laporan","=","Layar"));
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku2_report_kopeg_sju_flGlBukuBesarSimulasi.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flGlBukuBesarSimulasi.implement({
	...
	{		
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("Buku Besar","Produksi"));
		}
		if (row == 7)
		{
			this.sg1.columns.get(2).pickList.clear();
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.app._nikUser+"/"+this.sg1.getCell(2,3)+"/"+var_periode+"/"+this.sg1.getCell(2,7)+"/"+this.sg1.getCell(1,1)+"/"+this.sg1.getCell(3,1);
				
				this.nama_report="server_report_saku2_kopeg_sju_rptGlBukuBesarSimulasi";
				if (this.sg1.getCell(2,6)=="Produksi")
				{
					this.nama_report="server_report_saku2_kopeg_sju_rptGlBukuBesarProduksiSimulasi";
				}
