window.app_saku2_report_kopeg_sju_flPjCair = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPjCair.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPjCair";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flPjCair.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPjCair.implement({
		...
		try{			
			...
			if (row ==4)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Panjar",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_panjar, a.keterangan from panjar_m a "+this.filter,
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_sju_rptPjCair";
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flPjCair]::mainButtonClick:"+e);
		}
	},
