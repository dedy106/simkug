window.app_saku2_report_kopeg_sju_flPrPlacing = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPrPlacing.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPrPlacing";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flPrPlacing.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPrPlacing.implement({
		...
		try{			
			...
			if (row ==6)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Invoice",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_placing, '-' as keterangan from sju_placing_m a "+filter,
												"select count(a.no_placing) from sju_placing_m a "+filter,
												new Array("a.no_placing","b.keterangan"),"and",new Array("No Invoice","Keterangan"));
			}
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.no_placing",this.sg1.getCell(1,6),this.sg1.getCell(2,6),this.sg1.getCell(3,6),"and");
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flPrPlacing]::mainButtonClick:"+e);
		}
	},
