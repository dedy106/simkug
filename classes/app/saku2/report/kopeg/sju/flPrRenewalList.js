window.app_saku2_report_kopeg_sju_flPrRenewalList = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPrRenewalList.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPrRenewalList";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Periode Akru Polis","<=",this.periode));
	...
	this.gridLib.SGEditData(this.sg1,7,new Array(0,1,2,3), new Array("Tanggal","Range",new Date().lclFormat(),new Date().lclFormat()));
...
window.app_saku2_report_kopeg_sju_flPrRenewalList.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPrRenewalList.implement({
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6,7],["1234","123","123","123","123","123","3","123"]);
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.filter2 = this.sg1.getCell(2,0)+";"+this.sg1.getCell(2,1)+";"+this.sg1.getCell(2,1)+";"+this.sg1.getCell(2,6)+";"+this.sg1.getCellDateValue(2,7)+";"+this.sg1.getCellDateValue(3,7);
				
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku2_kopeg_sju_rptPrRenewalList";
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flPrRenewalList]::mainButtonClick:"+e);
		}
	},
