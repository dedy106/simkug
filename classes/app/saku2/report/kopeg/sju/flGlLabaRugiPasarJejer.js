window.app_saku2_report_kopeg_sju_flGlLabaRugiPasarJejer = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flGlLabaRugiPasarJejer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flGlLabaRugiPasarJejer";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flGlLabaRugiPasarJejer.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flGlLabaRugiPasarJejer.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_sju_rptGlLabaRugiPasarJejer";
