window.app_saku2_report_kopeg_sju_flQuo = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flQuo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flQuo";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flQuo.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flQuo.implement({
		...
		try{			
			...
			if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Invoice",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_quo, '-' as keterangan from sju_quo_m a "+filter,
												"select count(a.no_quo) from sju_quo_m a "+filter,
												new Array("a.no_quo","b.keterangan"),"and",new Array("No Invoice","Keterangan"));
			}
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.no_quo",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and");
				this.filter2 = this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,4);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku2_kopeg_sju_rptQuo";
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flQuo]::mainButtonClick:"+e);
		}
	},
