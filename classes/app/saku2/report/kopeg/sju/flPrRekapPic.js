window.app_saku2_report_kopeg_sju_flPrRekapPic = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPrRekapPic.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPrRekapPic";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flPrRekapPic.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPrRekapPic.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flPrRekapPic]::mainButtonClick:"+e);
		}
	},
