window.app_saku2_report_kopeg_sju_flAggPdpt = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flAggPdpt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flAggPdpt";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flAggPdpt.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flAggPdpt.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_saku2_kopeg_sju_rptAggPdpt";
