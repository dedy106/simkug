window.app_saku2_report_kopeg_sju_flGlTbJejerSimulasi = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flGlTbJejerSimulasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flGlTbJejerSimulasi";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flGlTbJejerSimulasi.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flGlTbJejerSimulasi.implement({
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4],["123","3","123","123"]);
		...
		try
		{
			...
			if (sender == this.app._mainForm.bBack)
			{
				...
				if (this.link=="2")
				{
					...
					{
						this.doOpenBbKonsol(this.kode_akun,this.sg1.getCell(2,0),this.periode);
					}
				}
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_sju_rptGlTbJejerSimulasi";
	...
	doOpenBbKonsol: function(kode_akun,kode_lokasi,periode){
		this.kode_akun=kode_akun;
		...
		filter="where a.kode_lokasi='"+kode_lokasi+"' and a.kode_akun='"+kode_akun+"' ";
		nama_report="server_report_saku2_kopeg_sju_rptGlBukuBesarKonsolSimulasi";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
