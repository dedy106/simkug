// JavaScript Document
window.app_saku2_report_kopeg_sju_flLRKonsol = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flLRKonsol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flLRKonsol";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flLRKonsol.extend(window.portalui_childForm);
window.app_saku2_report_kopeg_sju_flLRKonsol.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				var in_lap="S";
				this.filter2 = this.nik_user+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,0);
				
				this.nama_report="server_report_saku2_kopeg_sju_rptLRKonsol";
