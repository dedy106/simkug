window.app_saku2_report_kopeg_sju_flGlNeraca = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flGlNeraca.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flGlNeraca";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flGlNeraca.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flGlNeraca.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_sju_rptGlNeraca";
