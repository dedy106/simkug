// JavaScript Document
window.app_saku2_report_kopeg_sju_flNeracaKonsol = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flNeracaKonsol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flNeracaKonsol";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flNeracaKonsol.extend(window.portalui_childForm);
window.app_saku2_report_kopeg_sju_flNeracaKonsol.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				in_lap="K";
				this.nama_report="server_report_saku2_kopeg_sju_rptNeracaKonsol";
