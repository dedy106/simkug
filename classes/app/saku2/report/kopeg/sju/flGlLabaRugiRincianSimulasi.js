window.app_saku2_report_kopeg_sju_flGlLabaRugiRincianSimulasi = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flGlLabaRugiRincianSimulasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flGlLabaRugiRincianSimulasi";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flGlLabaRugiRincianSimulasi.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flGlLabaRugiRincianSimulasi.implement({
	...
	doOpenGar: function(kode_neraca,kode_lokasi,periode){
		...
		this.link="1";
		filter2=this.sg1.getCell(2,1).substr(0,4)+"/2";
		filter="where x.kode_lokasi='"+kode_lokasi+"' and z.kode_neraca='"+kode_neraca+"' and substring(x.periode,1,4)='"+periode.substr(0,4)+"' and z.kode_fs='"+this.sg1.getCell(2,2)+"'";
