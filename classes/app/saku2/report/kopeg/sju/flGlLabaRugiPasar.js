window.app_saku2_report_kopeg_sju_flGlLabaRugiPasar = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flGlLabaRugiPasar.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flGlLabaRugiPasar";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flGlLabaRugiPasar.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flGlLabaRugiPasar.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_sju_rptGlLabaRugiPasar";
