window.app_saku2_report_kopeg_sju_flRefKartu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flRefKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flRefKartu";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flRefKartu.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flRefKartu.implement({
		...
		try
		{
			...
			else
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.no_ju",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+modul;
				this.filter2 = this.sg1.getCell(2,1)+"/";
				this.nama_report="server_report_saku2_kopeg_sju_rptRefKartu";
