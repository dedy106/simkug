window.app_saku2_report_kopeg_sju_flAggKonsolJejer = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flAggKonsolJejer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flAggKonsolJejer";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,3,[0,1,2],["Periodik Laporan","=","Tahunan"]);
...
window.app_saku2_report_kopeg_sju_flAggKonsolJejer.extend(window.portalui_childForm);
window.app_saku2_report_kopeg_sju_flAggKonsolJejer.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,["Tahunan","Triwulan"]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter=this.filterRep.filterStr("z.kode_lokkonsol",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
				...
				if (this.sg1.getCell(2,3)=="Tahunan")
				{
					this.nama_report="server_report_saku2_kopeg_sju_rptAggBulanKonsolJejer";
				}
				else
				{
					this.nama_report="server_report_saku2_kopeg_sju_rptAggTwKonsolJejer";
				}
