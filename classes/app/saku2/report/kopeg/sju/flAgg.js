window.app_saku2_report_kopeg_sju_flAgg = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flAgg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flAgg";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flAgg.extend(window.portalui_childForm);
window.app_saku2_report_kopeg_sju_flAgg.implement({
	...
	doSelectCell: function(sender, col, row){
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5],["123","123","123","13","3","3"]);
	...
	mainButtonClick: function(sender){
		try
		{
			...
			{
				if (this.sg1.getCell(2,3)=="Investasi")
				{
					jenis=" and y.jenis='Neraca' ";
				}
				else
				{
					jenis=" and y.jenis='"+this.sg1.getCell(2,3)+"' ";
				}
			}
			...
			this.filter=this.filterRep.filterStr("x.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
						...
						this.filterRep.filterStr("x.kode_akun",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+jenis;
			this.filter2=this.sg1.getCell(2,1)+"/";	
			if (this.sg1.getCell(2,4)=="Triwulan")
			{			
				this.nama_report="server_report_saku2_kopeg_sju_rptAggTw";
			}
			if (this.sg1.getCell(2,4)=="Semester")
			{
				this.nama_report="server_report_saku2_kopeg_sju_rptAggSem";
			}
			if (this.sg1.getCell(2,4)=="Bulanan")
			{
				this.nama_report="server_report_saku2_kopeg_sju_rptAggBulan";
			}
