window.app_saku2_report_kopeg_sju_flPiutangAging = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPiutangAging.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPiutangAging";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from sju_bill_m ");
...
window.app_saku2_report_kopeg_sju_flPiutangAging.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPiutangAging.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_kopeg_sju_rptPiutangAging";
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flPiutangAging]::mainButtonClick:"+e);
		}
	},
