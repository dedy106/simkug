window.app_saku2_report_kopeg_sju_flAggKpaAkun = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flAggKpaAkun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flAggKpaAkun";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flAggKpaAkun.extend(window.portalui_childForm);
window.app_saku2_report_kopeg_sju_flAggKpaAkun.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,3)+"/"+this.sg1.getCell(2,4)+"/"+this.app._nikUser
				this.nama_report="server_report_saku2_kopeg_sju_rptAggKpaAkun";
