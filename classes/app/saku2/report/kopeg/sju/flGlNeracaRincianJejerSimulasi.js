window.app_saku2_report_kopeg_sju_flGlNeracaRincianJejerSimulasi = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flGlNeracaRincianJejerSimulasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flGlNeracaRincianJejerSimulasi";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flGlNeracaRincianJejerSimulasi.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flGlNeracaRincianJejerSimulasi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				{
					this.nama_report="server_report_saku2_kopeg_sju_rptGlNeracaRincianJejerSimulasi";
				}
				if (this.sg1.getCell(2,2)=="FS3")
				{
					this.nama_report="server_report_saku2_kopeg_sju_rptGlPasivaRincianJejerSimulasi";
				}
	...
	doOpenBb: function(kode_akun,kode_lokasi,periode){
		...
		this.periode=periode;
		this.link="2";
		filter2=kode_lokasi+"/"+periode+"/"+this.app._nikUser+"/"+"Tidak/2";
