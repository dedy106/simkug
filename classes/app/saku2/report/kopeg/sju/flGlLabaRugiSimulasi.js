window.app_saku2_report_kopeg_sju_flGlLabaRugiSimulasi = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flGlLabaRugiSimulasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flGlLabaRugiSimulasi";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flGlLabaRugiSimulasi.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flGlLabaRugiSimulasi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_sju_rptGlLabaRugiSimulasi";
				/*
				if (this.sg1.getCell(2,2)!="FS1")
				{
					this.nama_report="server_report_saku2_kopeg_sju_rptGlLabaRugiRincianSimulasi";
				}
				*/
	...
	doOpenTb: function(kode_neraca,kode_lokasi,periode){
		...
		filter="where a.kode_lokasi='"+kode_lokasi+"' and b.kode_neraca='"+kode_neraca+"' and b.kode_fs='"+this.sg1.getCell(2,2)+"'";
