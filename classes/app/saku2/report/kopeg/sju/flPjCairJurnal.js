window.app_saku2_report_kopeg_sju_flPjCairJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPjCairJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPjCairJurnal";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flPjCairJurnal.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPjCairJurnal.implement({
