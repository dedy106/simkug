window.app_saku2_report_kopeg_sju_flPdptNetKlp = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flPdptNetKlp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flPdptNetKlp";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flPdptNetKlp.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flPdptNetKlp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				{
					this.nama_report = "server_report_saku2_kopeg_sju_rptPdptNetKlp";
				}
				else
				{
					this.nama_report = "server_report_saku2_kopeg_sju_rptPdptGrossKlp";
				}
			...
			systemAPI.alert("[app_saku2_report_kopeg_sju_flPdptNetKlp]::mainButtonClick:"+e);
		}
	},
