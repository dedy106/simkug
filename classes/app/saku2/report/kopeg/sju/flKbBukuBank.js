window.app_saku2_report_kopeg_sju_flKbBukuBank = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_sju_flKbBukuBank.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_sju_flKbBukuBank";
		this.maximize();
...
window.app_saku2_report_kopeg_sju_flKbBukuBank.extend(window.childForm);
window.app_saku2_report_kopeg_sju_flKbBukuBank.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_sju_rptKbBukuBank";
