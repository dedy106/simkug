window.app_saku2_report_kopeg_flAnggota = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_flAnggota.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_flAnggota";
		this.maximize();
...
window.app_saku2_report_kopeg_flAnggota.extend(window.childForm);
window.app_saku2_report_kopeg_flAnggota.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_rptAnggota";
			...
			systemAPI.alert("[app_saku2_report_kopeg_flAnggota]::mainButtonClick:"+e);
		}
	},
