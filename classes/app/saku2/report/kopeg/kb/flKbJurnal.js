window.app_saku2_report_kopeg_kb_flKbJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kb_flKbJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kb_flKbJurnal";
		this.maximize();
...
window.app_saku2_report_kopeg_kb_flKbJurnal.extend(window.childForm);
window.app_saku2_report_kopeg_kb_flKbJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				{
					this.nama_report="server_report_saku2_kopeg_kb_rptKbBuktiJurnal";
				}
