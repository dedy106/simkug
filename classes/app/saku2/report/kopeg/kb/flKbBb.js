...
//* 			SAI, PT											
//***********************************************************************************************
window.app_saku2_report_kopeg_kb_flKbBb = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kb_flKbBb.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kb_flKbBb";
		this.maximize();
...
window.app_saku2_report_kopeg_kb_flKbBb.extend(window.portalui_childForm);
window.app_saku2_report_kopeg_kb_flKbBb.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_kb_rptKbBukuBesar";
