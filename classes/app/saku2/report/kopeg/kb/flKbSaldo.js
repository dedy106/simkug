// JavaScript Document
window.app_saku2_report_kopeg_kb_flKbSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kb_flKbSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kb_flKbSaldo";
		this.maximize();
...
window.app_saku2_report_kopeg_kb_flKbSaldo.extend(window.portalui_childForm);
window.app_saku2_report_kopeg_kb_flKbSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_kb_rptKbSaldo";
				this.dbLib.execQuerySync(this.sql);	
