// JavaScript Document
window.app_saku2_report_kopeg_ppbs_flAggRkap = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_ppbs_flAggRkap.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_ppbs_flAggRkap";
		this.maximize();
...
window.app_saku2_report_kopeg_ppbs_flAggRkap.extend(window.portalui_childForm);
window.app_saku2_report_kopeg_ppbs_flAggRkap.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_ppbs_rptAggRkap";
				sql="call sp_agg_rkap_bulan ('"+this.sg1.getCell(2,2)+"','L','"+this.sg1.getCell(2,1)+"','"+this.kode_lokasi+"','"+this.kode_lokasi1+"','"+this.kode_lokasi2+"','"+this.nik_user+"')";
