// JavaScript Document
window.app_saku2_report_kopeg_ppbs_flAggRkapPp = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_ppbs_flAggRkapPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_ppbs_flAggRkapPp";
		this.maximize();
...
window.app_saku2_report_kopeg_ppbs_flAggRkapPp.extend(window.portalui_childForm);
window.app_saku2_report_kopeg_ppbs_flAggRkapPp.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3],["3","3","3","123"]);
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_ppbs_rptAggRkapPp";
				sql="call sp_agg_rkap_bulan_pp ('"+this.sg1.getCell(2,2)+"','"+this.sg1.getCell(2,1)+"','"+this.kode_lokasi+"','"+this.sg1.getCell(2,3)+"','"+this.nik_user+"')";
				alert(sql);
