window.app_saku2_report_kopeg_ppbs_flAggUsul = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_ppbs_flAggUsul.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_ppbs_flAggUsul";
		this.maximize();
...
window.app_saku2_report_kopeg_ppbs_flAggUsul.extend(window.childForm);
window.app_saku2_report_kopeg_ppbs_flAggUsul.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_ppbs_flAggUsul]::mainButtonClick:"+e);
		}
	},
