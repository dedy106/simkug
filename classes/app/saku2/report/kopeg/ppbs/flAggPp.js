window.app_saku2_report_kopeg_ppbs_flAggPp = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_ppbs_flAggPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_ppbs_flAggPp";
		this.maximize();
...
window.app_saku2_report_kopeg_ppbs_flAggPp.extend(window.childForm);
window.app_saku2_report_kopeg_ppbs_flAggPp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				{
					this.nama_report = "server_report_saku2_kopeg_ppbs_rptAggPp";
				}
				else
				{
