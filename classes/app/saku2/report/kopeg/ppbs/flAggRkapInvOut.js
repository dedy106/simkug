// JavaScript Document
window.app_saku2_report_kopeg_ppbs_flAggRkapInvOut = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_ppbs_flAggRkapInvOut.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_ppbs_flAggRkapInvOut";
		this.maximize();
...
window.app_saku2_report_kopeg_ppbs_flAggRkapInvOut.extend(window.portalui_childForm);
window.app_saku2_report_kopeg_ppbs_flAggRkapInvOut.implement({
		...
		try
		{
			...
			if (sender == this.app._mainForm.bBack)
			{
				...
				if (this.link=="1")
				{
					...
					this.nama_report = "server_report_saku2_kopeg_ppbs_rptAggRkapInvOut";
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_ppbs_rptAggRkapInvOut";
				sql="call sp_agg_rkap_out ('"+this.sg1.getCell(2,2)+"','A','"+this.sg1.getCell(2,1)+"','"+this.sg1.getCell(2,5)+"','"+this.kode_lokasi+"','"+this.kode_lokasi1+"','"+this.kode_lokasi2+"','"+this.nik_user+"')";
