window.app_saku2_report_kopeg_ppbs_flAggAkunDrk = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_ppbs_flAggAkunDrk.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_ppbs_flAggAkunDrk";
		this.maximize();
...
window.app_saku2_report_kopeg_ppbs_flAggAkunDrk.extend(window.childForm);
window.app_saku2_report_kopeg_ppbs_flAggAkunDrk.implement({
