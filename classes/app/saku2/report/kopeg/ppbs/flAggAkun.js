window.app_saku2_report_kopeg_ppbs_flAggAkun = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_ppbs_flAggAkun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_ppbs_flAggAkun";
		this.maximize();
...
window.app_saku2_report_kopeg_ppbs_flAggAkun.extend(window.childForm);
window.app_saku2_report_kopeg_ppbs_flAggAkun.implement({
