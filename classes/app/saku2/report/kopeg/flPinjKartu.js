window.app_saku2_report_kopeg_flPinjKartu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_flPinjKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_flPinjKartu";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Kode Anggota","All",""));
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("No Pinjaman","All",""));
...
window.app_saku2_report_kopeg_flPinjKartu.extend(window.childForm);
window.app_saku2_report_kopeg_flPinjKartu.implement({
		...
		try{			
			...
			if (row == 1)
			{
				this.filterRep.ListDataSGFilter(this, "Data Anggota",this.sg1, this.sg1.row, this.sg1.col,
														  "select kode_agg, nama from kop_agg "+
														   this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  "select count(kode_agg) from kop_agg "+
														  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  new Array("kode_agg","nama"),"and");
			}
			if (row === 2)
			{
			this.filterRep.ListDataSGFilter(this, "Data No. Pinjaman",this.sg1, this.sg1.row, this.sg1.col,
										  "select no_pinj,keterangan from kop_pinj_m where kode_lokasi ='"+this.sg1.getCell(2,0)+"'  ",
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_rptPinjKartu";
			...
			systemAPI.alert("[app_saku2_report_kopeg_flPinjKartu]::mainButtonClick:"+e);
		}
	},
