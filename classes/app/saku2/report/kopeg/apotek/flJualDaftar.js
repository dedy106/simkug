window.app_saku2_report_kopeg_apotek_flJualDaftar = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_apotek_flJualDaftar.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_apotek_flJualDaftar";
		this.maximize();
...
window.app_saku2_report_kopeg_apotek_flJualDaftar.extend(window.childForm);
window.app_saku2_report_kopeg_apotek_flJualDaftar.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_apotek_rptJualDaftar";
			...
			systemAPI.alert("[app_saku2_report_kopeg_apotek_flJualDaftar]::mainButtonClick:"+e);
		}
	},
