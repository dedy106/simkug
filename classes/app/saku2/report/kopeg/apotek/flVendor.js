window.app_saku2_report_kopeg_apotek_flVendor = function (owner) {
    if (owner) {
        window.app_saku2_report_kopeg_apotek_flVendor.prototype.parent.constructor.call(this, owner);
        this.className = "app_saku2_report_kopeg_apotek_flVendor";
        this.maximize();
    ...
    this.gridLib.SGEditData(this.sg1, 1, new Array(0, 1, 2), new Array("Vendor", "All", ""));
...
window.app_saku2_report_kopeg_apotek_flVendor.extend(window.childForm);
window.app_saku2_report_kopeg_apotek_flVendor.implement({
    ...
    mainButtonClick: function (sender) {
        try {
            if (sender === this.app._mainForm.bClear2) {
                ...
                this.nama_report = "server_report_saku2_kopeg_apotek_rptVendor";
            ...
            systemAPI.alert("[app_saku2_report_kopeg_apotek_flVendor]::mainButtonClick:" + e);
        }
    },
