window.app_saku2_report_kopeg_apotek_flBeliDaftar = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_apotek_flBeliDaftar.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_apotek_flBeliDaftar";
		this.maximize();
...
window.app_saku2_report_kopeg_apotek_flBeliDaftar.extend(window.childForm);
window.app_saku2_report_kopeg_apotek_flBeliDaftar.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_apotek_rptBeliDaftar";
			...
			systemAPI.alert("[app_saku2_report_kopeg_apotek_flBeliDaftar]::mainButtonClick:"+e);
		}
	},
