window.app_saku2_report_kopeg_apotek_flJualJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_apotek_flJualJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_apotek_flJualJurnal";
		this.maximize();
...
window.app_saku2_report_kopeg_apotek_flJualJurnal.extend(window.childForm);
window.app_saku2_report_kopeg_apotek_flJualJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_apotek_rptJualJurnal";
			...
			systemAPI.alert("[app_saku2_report_kopeg_apotek_flJualJurnal]::mainButtonClick:"+e);
		}
	},
