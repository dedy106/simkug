window.app_saku2_report_kopeg_apotek_flBeli = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_apotek_flBeli.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_apotek_flBeli";
		this.maximize();
...
window.app_saku2_report_kopeg_apotek_flBeli.extend(window.childForm);
window.app_saku2_report_kopeg_apotek_flBeli.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_apotek_flBeli]::mainButtonClick:"+e);
		}
	},
