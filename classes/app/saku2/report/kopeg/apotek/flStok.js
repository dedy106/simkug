window.app_saku2_report_kopeg_apotek_flStok = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_apotek_flStok.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_apotek_flStok";
		this.maximize();
...
window.app_saku2_report_kopeg_apotek_flStok.extend(window.childForm);
window.app_saku2_report_kopeg_apotek_flStok.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_apotek_rptStok";
			...
			systemAPI.alert("[app_saku2_report_kopeg_apotek_flStok]::mainButtonClick:"+e);
		}
	},
