window.app_saku2_report_kopeg_apotek_flJualAgg = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_apotek_flJualAgg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_apotek_flJualAgg";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from apo_brg_jual_m where modul='AGG' ");
...
window.app_saku2_report_kopeg_apotek_flJualAgg.extend(window.childForm);
window.app_saku2_report_kopeg_apotek_flJualAgg.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_apotek_rptJualAgg";
			...
			systemAPI.alert("[app_saku2_report_kopeg_apotek_flJualAgg]::mainButtonClick:"+e);
		}
	},
