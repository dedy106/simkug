window.app_saku2_report_kopeg_apotek_flKbBeli = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_apotek_flKbBeli.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_apotek_flKbBeli";
		this.maximize();
...
window.app_saku2_report_kopeg_apotek_flKbBeli.extend(window.childForm);
window.app_saku2_report_kopeg_apotek_flKbBeli.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_apotek_rptKbBeli";
			...
			systemAPI.alert("[app_saku2_report_kopeg_apotek_flKbBeli]::mainButtonClick:"+e);
		}
	},
