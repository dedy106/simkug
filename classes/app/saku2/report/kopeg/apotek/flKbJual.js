window.app_saku2_report_kopeg_apotek_flKbJual = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_apotek_flKbJual.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_apotek_flKbJual";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from kas_m where modul='KBJUAL' ");
...
window.app_saku2_report_kopeg_apotek_flKbJual.extend(window.childForm);
window.app_saku2_report_kopeg_apotek_flKbJual.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_apotek_rptKbJual";
			...
			systemAPI.alert("[app_saku2_report_kopeg_apotek_flKbJual]::mainButtonClick:"+e);
		}
	},
