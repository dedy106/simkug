window.app_saku2_report_kopeg_apotek_flJual = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_apotek_flJual.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_apotek_flJual";
		this.maximize();
...
window.app_saku2_report_kopeg_apotek_flJual.extend(window.childForm);
window.app_saku2_report_kopeg_apotek_flJual.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_apotek_flJual]::mainButtonClick:"+e);
		}
	},
