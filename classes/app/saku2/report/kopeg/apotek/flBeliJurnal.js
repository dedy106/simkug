window.app_saku2_report_kopeg_apotek_flBeliJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_apotek_flBeliJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_apotek_flBeliJurnal";
		this.maximize();
...
window.app_saku2_report_kopeg_apotek_flBeliJurnal.extend(window.childForm);
window.app_saku2_report_kopeg_apotek_flBeliJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_apotek_rptBeliJurnal";
			...
			systemAPI.alert("[app_saku2_report_kopeg_apotek_flBeliJurnal]::mainButtonClick:"+e);
		}
	},
