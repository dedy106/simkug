window.app_saku2_report_kopeg_logistik_flFinal = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_logistik_flFinal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_logistik_flFinal";
		this.maximize();
...
window.app_saku2_report_kopeg_logistik_flFinal.extend(window.childForm);
window.app_saku2_report_kopeg_logistik_flFinal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_logistik_flFinal]::mainButtonClick:"+e);
		}
	},
