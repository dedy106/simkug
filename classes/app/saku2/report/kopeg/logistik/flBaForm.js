window.app_saku2_report_kopeg_logistik_flBaForm = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_logistik_flBaForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_logistik_flBaForm";
		this.maximize();
...
window.app_saku2_report_kopeg_logistik_flBaForm.extend(window.childForm);
window.app_saku2_report_kopeg_logistik_flBaForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_logistik_rptBaForm";
			...
			systemAPI.alert("[app_saku2_report_kopeg_logistik_flBaForm]::mainButtonClick:"+e);
		}
	},
