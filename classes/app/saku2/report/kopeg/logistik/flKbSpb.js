window.app_saku2_report_kopeg_logistik_flKbSpb = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_logistik_flKbSpb.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_logistik_flKbSpb";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from kas_m where modul='KBSPBLOG' ");
...
window.app_saku2_report_kopeg_logistik_flKbSpb.extend(window.childForm);
window.app_saku2_report_kopeg_logistik_flKbSpb.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_logistik_rptKbSpb";
			...
			systemAPI.alert("[app_saku2_report_kopeg_logistik_flKbSpb]::mainButtonClick:"+e);
		}
	},
