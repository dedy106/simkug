window.app_saku2_report_kopeg_logistik_flSpb = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_logistik_flSpb.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_logistik_flSpb";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from spb_m where modul='LOG' ");
...
window.app_saku2_report_kopeg_logistik_flSpb.extend(window.childForm);
window.app_saku2_report_kopeg_logistik_flSpb.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_logistik_flSpb]::mainButtonClick:"+e);
		}
	},
