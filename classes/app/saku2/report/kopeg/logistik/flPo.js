window.app_saku2_report_kopeg_logistik_flPo = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_logistik_flPo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_logistik_flPo";
		this.maximize();
...
window.app_saku2_report_kopeg_logistik_flPo.extend(window.childForm);
window.app_saku2_report_kopeg_logistik_flPo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_logistik_flPo]::mainButtonClick:"+e);
		}
	},
