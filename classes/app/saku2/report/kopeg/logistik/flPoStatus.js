window.app_saku2_report_kopeg_logistik_flPoStatus = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_logistik_flPoStatus.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_logistik_flPoStatus";
		this.maximize();
...
window.app_saku2_report_kopeg_logistik_flPoStatus.extend(window.childForm);
window.app_saku2_report_kopeg_logistik_flPoStatus.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_logistik_rptPoStatus";
			...
			systemAPI.alert("[app_saku2_report_kopeg_logistik_flPoStatus]::mainButtonClick:"+e);
		}
	},
