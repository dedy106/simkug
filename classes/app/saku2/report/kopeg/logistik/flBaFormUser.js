window.app_saku2_report_kopeg_logistik_flBaFormUser = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_logistik_flBaFormUser.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_logistik_flBaFormUser";
		this.maximize();
...
window.app_saku2_report_kopeg_logistik_flBaFormUser.extend(window.childForm);
window.app_saku2_report_kopeg_logistik_flBaFormUser.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_logistik_rptBaFormUser";
			...
			systemAPI.alert("[app_saku2_report_kopeg_logistik_flBaFormUser]::mainButtonClick:"+e);
		}
	},
