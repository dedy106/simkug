window.app_saku2_report_kopeg_logistik_flBa = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_logistik_flBa.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_logistik_flBa";
		this.maximize();
...
window.app_saku2_report_kopeg_logistik_flBa.extend(window.childForm);
window.app_saku2_report_kopeg_logistik_flBa.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_logistik_flBa]::mainButtonClick:"+e);
		}
	},
