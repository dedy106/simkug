window.app_saku2_report_kopeg_logistik_flBaJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_logistik_flBaJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_logistik_flBaJurnal";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from log_ba_m  where kode_lokasi='"+this.app._lokasi+"' ");
...
window.app_saku2_report_kopeg_logistik_flBaJurnal.extend(window.childForm);
window.app_saku2_report_kopeg_logistik_flBaJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_logistik_rptBaJurnal";
			...
			systemAPI.alert("[app_saku2_report_kopeg_logistik_flBaJurnal]::mainButtonClick:"+e);
		}
	},
