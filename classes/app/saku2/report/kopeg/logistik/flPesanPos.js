window.app_saku2_report_kopeg_logistik_flPesanPos = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_logistik_flPesanPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_logistik_flPesanPos";
		this.maximize();
...
window.app_saku2_report_kopeg_logistik_flPesanPos.extend(window.childForm);
window.app_saku2_report_kopeg_logistik_flPesanPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_logistik_rptPesanPos";
			...
			systemAPI.alert("[app_saku2_report_kopeg_logistik_flPesanPos]::mainButtonClick:"+e);
		}
	},
