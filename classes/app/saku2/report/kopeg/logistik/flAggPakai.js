window.app_saku2_report_kopeg_logistik_flAggPakai = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_logistik_flAggPakai.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_logistik_flAggPakai";
		this.maximize();
...
window.app_saku2_report_kopeg_logistik_flAggPakai.extend(window.portalui_childForm);
window.app_saku2_report_kopeg_logistik_flAggPakai.implement({
	...
	doOpenKartu: function(kode_akun,kode_lokasi,tahun,kode_pp,kode_drk){
		...
		filter2=tahun+"/"+this.sg1.getCell(2,7)+"/"+this.app._nikUser;
