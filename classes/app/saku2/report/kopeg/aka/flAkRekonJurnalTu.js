window.app_saku2_report_kopeg_aka_flAkRekonJurnalTu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_aka_flAkRekonJurnalTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_aka_flAkRekonJurnalTu";
		this.maximize();
...
window.app_saku2_report_kopeg_aka_flAkRekonJurnalTu.extend(window.childForm);
window.app_saku2_report_kopeg_aka_flAkRekonJurnalTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_aka_rptAkRekonJurnalTu";
			...
			systemAPI.alert("[app_saku2_report_kopeg_aka_flAkRekonJurnalTu]::mainButtonClick:"+e);
		}
	},
