window.app_saku2_report_kopeg_aka_flAkRekon = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_aka_flAkRekon.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_aka_flAkRekon";
		this.maximize();
...
window.app_saku2_report_kopeg_aka_flAkRekon.extend(window.childForm);
window.app_saku2_report_kopeg_aka_flAkRekon.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_aka_rptAkRekon";
