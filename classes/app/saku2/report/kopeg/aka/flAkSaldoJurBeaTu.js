window.app_saku2_report_kopeg_aka_flAkSaldoJurBeaTu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_aka_flAkSaldoJurBeaTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_aka_flAkSaldoJurBeaTu";
		this.maximize();
...
window.app_saku2_report_kopeg_aka_flAkSaldoJurBeaTu.extend(window.childForm);
window.app_saku2_report_kopeg_aka_flAkSaldoJurBeaTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_kopeg_aka_rptAkSaldoJurBeaTu";
