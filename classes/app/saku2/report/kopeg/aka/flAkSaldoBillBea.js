window.app_saku2_report_kopeg_aka_flAkSaldoBillBea = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_aka_flAkSaldoBillBea.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_aka_flAkSaldoBillBea";
		this.maximize();
...
window.app_saku2_report_kopeg_aka_flAkSaldoBillBea.extend(window.childForm);
window.app_saku2_report_kopeg_aka_flAkSaldoBillBea.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_kopeg_aka_rptAkSaldoBillBea";
