window.app_saku2_report_kopeg_aka_flAkSaldoJurBea = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_aka_flAkSaldoJurBea.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_aka_flAkSaldoJurBea";
		this.maximize();
...
window.app_saku2_report_kopeg_aka_flAkSaldoJurBea.extend(window.childForm);
window.app_saku2_report_kopeg_aka_flAkSaldoJurBea.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_kopeg_aka_rptAkSaldoJurBea";
	...
	doOpenSaldoMhs: function(kode_jur,kode_lokasi){
		...
		nama_report="server_report_saku2_kopeg_aka_rptAkSaldoMhsBea";
