window.app_saku2_report_kopeg_aka_flAkAmorBatal = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_aka_flAkAmorBatal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_aka_flAkAmorBatal";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("No Amortisasi","All",""));
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku2_report_kopeg_aka_flAkAmorBatal.extend(window.childForm);
window.app_saku2_report_kopeg_aka_flAkAmorBatal.implement({
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							  ...
							  this.filterRep.filterStr("a.no_amor",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4),"and")+
							  " and a.modul='AMORBTL' ";
				this.filter2 = this.sg1.getCell(2,1)+"/";
				this.showFilter = this.filterRep.showFilter(this.sg1);
				this.nama_report = "server_report_saku2_kopeg_aka_rptAkAmorBatal";
