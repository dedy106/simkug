window.app_saku2_report_kopeg_aka_flAkBillJurnalTu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_aka_flAkBillJurnalTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_aka_flAkBillJurnalTu";
		this.maximize();
...
window.app_saku2_report_kopeg_aka_flAkBillJurnalTu.extend(window.childForm);
window.app_saku2_report_kopeg_aka_flAkBillJurnalTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_aka_rptAkBillJurnalTu";
			...
			systemAPI.alert("[app_saku2_report_kopeg_aka_flAkBillJurnalTu]::mainButtonClick:"+e);
		}
	},
