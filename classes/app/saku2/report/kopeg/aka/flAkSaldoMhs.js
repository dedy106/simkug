window.app_saku2_report_kopeg_aka_flAkSaldoMhs = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_aka_flAkSaldoMhs.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_aka_flAkSaldoMhs";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("Tampilan Laporan","=","Layar"));
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
	//this.pager=10;
	
};
window.app_saku2_report_kopeg_aka_flAkSaldoMhs.extend(window.childForm);
window.app_saku2_report_kopeg_aka_flAkSaldoMhs.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_kopeg_aka_rptAkSaldoMhs";
