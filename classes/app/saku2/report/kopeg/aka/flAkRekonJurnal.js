window.app_saku2_report_kopeg_aka_flAkRekonJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_aka_flAkRekonJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_aka_flAkRekonJurnal";
		this.maximize();
...
window.app_saku2_report_kopeg_aka_flAkRekonJurnal.extend(window.childForm);
window.app_saku2_report_kopeg_aka_flAkRekonJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_aka_flAkRekonJurnal]::mainButtonClick:"+e);
		}
	},
