window.app_saku2_report_kopeg_aka_flAkAmor = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_aka_flAkAmor.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_aka_flAkAmor";
		this.maximize();
...
window.app_saku2_report_kopeg_aka_flAkAmor.extend(window.childForm);
window.app_saku2_report_kopeg_aka_flAkAmor.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_aka_rptAkAmor";
