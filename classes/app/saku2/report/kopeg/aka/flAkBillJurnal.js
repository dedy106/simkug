window.app_saku2_report_kopeg_aka_flAkBillJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_aka_flAkBillJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_aka_flAkBillJurnal";
		this.maximize();
...
window.app_saku2_report_kopeg_aka_flAkBillJurnal.extend(window.childForm);
window.app_saku2_report_kopeg_aka_flAkBillJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_aka_flAkBillJurnal]::mainButtonClick:"+e);
		}
	},
