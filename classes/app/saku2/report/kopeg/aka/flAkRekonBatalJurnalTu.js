window.app_saku2_report_kopeg_aka_flAkRekonBatalJurnalTu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_aka_flAkRekonBatalJurnalTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_aka_flAkRekonBatalJurnalTu";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from aka_rekon_m  where kode_lokasi='"+this.app._lokasi+"' and modul='REKBTL' ");
...
window.app_saku2_report_kopeg_aka_flAkRekonBatalJurnalTu.extend(window.childForm);
window.app_saku2_report_kopeg_aka_flAkRekonBatalJurnalTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_aka_rptAkRekonBatalJurnalTu";
			...
			systemAPI.alert("[app_saku2_report_kopeg_aka_flAkRekonBatalJurnalTu]::mainButtonClick:"+e);
		}
	},
