window.app_saku2_report_kopeg_aka_flAkSaldoJalurMaba = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_aka_flAkSaldoJalurMaba.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_aka_flAkSaldoJalurMaba";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Jalur","All",""));
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
	//this.pager=10;
	
};
window.app_saku2_report_kopeg_aka_flAkSaldoJalurMaba.extend(window.childForm);
window.app_saku2_report_kopeg_aka_flAkSaldoJalurMaba.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			if (sender == this.app._mainForm.bBack)
			{
				...
				if (this.link=="2")
				{
					this.doOpenSaldoMhs(this.kode_jalur,this.kode_lokasi);					
			...
			else
			{
		    	...
		    	this.filter =this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+
							 this.filterRep.filterStr("a.kode_jalur",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2)," and ");
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				this.nama_report = "server_report_saku2_kopeg_aka_rptAkSaldoJalurMaba";
	...
	doOpenSaldoMhs: function(kode_jalur,kode_lokasi){
		this.link="1";
		this.kode_jalur=kode_jalur;
		this.kode_lokasi=kode_lokasi;
		this.link="1";
		filter = " where a.kode_lokasi='"+this.kode_lokasi+"' and a.kode_jalur='"+this.kode_jalur+"'";
		filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+kode_jalur;
		nama_report="server_report_saku2_kopeg_aka_rptAkSaldoBillMaba";
	...
	doOpenKartuMhs: function(nim,kode_lokasi){
		...
		filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.kode_jalur+"/"+nim;;
