window.app_saku2_report_kopeg_aka_flAkBillBatalJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_aka_flAkBillBatalJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_aka_flAkBillBatalJurnal";
		this.maximize();
...
window.app_saku2_report_kopeg_aka_flAkBillBatalJurnal.extend(window.childForm);
window.app_saku2_report_kopeg_aka_flAkBillBatalJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_aka_rptAkBillBatalJurnal";
			...
			systemAPI.alert("[app_saku2_report_kopeg_aka_flAkBillBatalJurnal]::mainButtonClick:"+e);
		}
	},
