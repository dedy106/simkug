window.app_saku2_report_kopeg_aka_flAkAmorBatalTu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_aka_flAkAmorBatalTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_aka_flAkAmorBatalTu";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from aka_amor_m where kode_lokasi='"+this.app._lokasi+"' and modul='AMORBTL' ");
...
window.app_saku2_report_kopeg_aka_flAkAmorBatalTu.extend(window.childForm);
window.app_saku2_report_kopeg_aka_flAkAmorBatalTu.implement({
		...
		try{			
			...
			if (row ==5)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Invoice",this.sg1, this.sg1.row, this.sg1.col,
												...
												new Array("a.no_amor","a.keterangan"),"and",new Array("No Tagihan","Keterangan"));
			}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_aka_rptAkAmorBatalTu";
