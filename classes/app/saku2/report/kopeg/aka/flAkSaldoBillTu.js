window.app_saku2_report_kopeg_aka_flAkSaldoBillTu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_aka_flAkSaldoBillTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_aka_flAkSaldoBillTu";
		this.maximize();
...
window.app_saku2_report_kopeg_aka_flAkSaldoBillTu.extend(window.childForm);
window.app_saku2_report_kopeg_aka_flAkSaldoBillTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_kopeg_aka_rptAkSaldoBillTu";
