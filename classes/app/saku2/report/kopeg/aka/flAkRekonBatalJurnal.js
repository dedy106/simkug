window.app_saku2_report_kopeg_aka_flAkRekonBatalJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_aka_flAkRekonBatalJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_aka_flAkRekonBatalJurnal";
		this.maximize();
...
window.app_saku2_report_kopeg_aka_flAkRekonBatalJurnal.extend(window.childForm);
window.app_saku2_report_kopeg_aka_flAkRekonBatalJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_aka_rptAkRekonBatalJurnal";
			...
			systemAPI.alert("[app_saku2_report_kopeg_aka_flAkRekonBatalJurnal]::mainButtonClick:"+e);
		}
	},
