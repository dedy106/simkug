window.app_saku2_report_kopeg_aka_flAkSaldoJurTu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_aka_flAkSaldoJurTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_aka_flAkSaldoJurTu";
		this.maximize();
...
window.app_saku2_report_kopeg_aka_flAkSaldoJurTu.extend(window.childForm);
window.app_saku2_report_kopeg_aka_flAkSaldoJurTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_kopeg_aka_rptAkSaldoJurTu";
