window.app_saku2_report_kopeg_aka_flAkBillJurnalBeaTu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_aka_flAkBillJurnalBeaTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_aka_flAkBillJurnalBeaTu";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from aka_bill_m  where kode_lokasi='"+this.app._lokasi+"'  and jenis='BEA' ");
...
window.app_saku2_report_kopeg_aka_flAkBillJurnalBeaTu.extend(window.childForm);
window.app_saku2_report_kopeg_aka_flAkBillJurnalBeaTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_aka_rptAkBillJurnalBeaTu";
			...
			systemAPI.alert("[app_saku2_report_kopeg_aka_flAkBillJurnalBeaTu]::mainButtonClick:"+e);
		}
	},
