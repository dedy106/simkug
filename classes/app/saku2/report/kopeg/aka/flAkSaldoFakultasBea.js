window.app_saku2_report_kopeg_aka_flAkSaldoFakultasBea = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_aka_flAkSaldoFakultasBea.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_aka_flAkSaldoFakultasBea";
		this.maximize();
...
window.app_saku2_report_kopeg_aka_flAkSaldoFakultasBea.extend(window.childForm);
window.app_saku2_report_kopeg_aka_flAkSaldoFakultasBea.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_kopeg_aka_rptAkSaldoFakultasBea";
	...
	doOpenSaldoJur: function(kode_lokasi,kode_fakultas){
		...
		nama_report="server_report_saku2_kopeg_aka_rptAkSaldoJurBeaTu";
