window.app_saku2_report_kopeg_aka_flAkBillJurnalMaba = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_aka_flAkBillJurnalMaba.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_aka_flAkBillJurnalMaba";
		this.maximize();
...
window.app_saku2_report_kopeg_aka_flAkBillJurnalMaba.extend(window.childForm);
window.app_saku2_report_kopeg_aka_flAkBillJurnalMaba.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_aka_flAkBillJurnalMaba]::mainButtonClick:"+e);
		}
	},
