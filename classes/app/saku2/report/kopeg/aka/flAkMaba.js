window.app_saku2_report_kopeg_aka_flAkMaba = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_aka_flAkMaba.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_aka_flAkMaba";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("No Tes","All",""));
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku2_report_kopeg_aka_flAkMaba.extend(window.childForm);
window.app_saku2_report_kopeg_aka_flAkMaba.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("no_tes","All",""));
			}else{
				...
				this.nama_report = "server_report_saku2_kopeg_aka_rptAkMaba";
