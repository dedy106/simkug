window.app_saku2_report_kopeg_aka_flAkAmorJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_aka_flAkAmorJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_aka_flAkAmorJurnal";
		this.maximize();
...
window.app_saku2_report_kopeg_aka_flAkAmorJurnal.extend(window.childForm);
window.app_saku2_report_kopeg_aka_flAkAmorJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_aka_flAkAmorJurnal]::mainButtonClick:"+e);
		}
	},
