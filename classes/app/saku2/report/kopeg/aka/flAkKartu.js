window.app_saku2_report_kopeg_aka_flAkKartu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_aka_flAkKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_aka_flAkKartu";
		this.maximize();
...
window.app_saku2_report_kopeg_aka_flAkKartu.extend(window.childForm);
window.app_saku2_report_kopeg_aka_flAkKartu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			}else
			{
				...
				this.nama_report = "server_report_saku2_kopeg_aka_rptAkKartu";
