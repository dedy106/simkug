window.app_saku2_report_kopeg_aka_flAkSaldoMhsBea = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_aka_flAkSaldoMhsBea.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_aka_flAkSaldoMhsBea";
		this.maximize();
...
window.app_saku2_report_kopeg_aka_flAkSaldoMhsBea.extend(window.childForm);
window.app_saku2_report_kopeg_aka_flAkSaldoMhsBea.implement({
	...
	{		
		...
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2],[2,0,2,2]);	
		if (row == 1)
		{
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_kopeg_aka_rptAkSaldoMhsBea";
