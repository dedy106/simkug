window.app_saku2_report_kopeg_aka_flAkSaldoJur = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_aka_flAkSaldoJur.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_aka_flAkSaldoJur";
		this.maximize();
...
window.app_saku2_report_kopeg_aka_flAkSaldoJur.extend(window.childForm);
window.app_saku2_report_kopeg_aka_flAkSaldoJur.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_kopeg_aka_rptAkSaldoJur";
