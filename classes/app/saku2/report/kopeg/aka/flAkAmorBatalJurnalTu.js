window.app_saku2_report_kopeg_aka_flAkAmorBatalJurnalTu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_aka_flAkAmorBatalJurnalTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_aka_flAkAmorBatalJurnalTu";
		this.maximize();
...
window.app_saku2_report_kopeg_aka_flAkAmorBatalJurnalTu.extend(window.childForm);
window.app_saku2_report_kopeg_aka_flAkAmorBatalJurnalTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_aka_rptAkAmorBatalJurnalTu";
			...
			systemAPI.alert("[app_saku2_report_kopeg_aka_flAkAmorBatalJurnalTu]::mainButtonClick:"+e);
		}
	},
