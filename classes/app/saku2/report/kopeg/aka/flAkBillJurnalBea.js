window.app_saku2_report_kopeg_aka_flAkBillJurnalBea = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_aka_flAkBillJurnalBea.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_aka_flAkBillJurnalBea";
		this.maximize();
...
window.app_saku2_report_kopeg_aka_flAkBillJurnalBea.extend(window.childForm);
window.app_saku2_report_kopeg_aka_flAkBillJurnalBea.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_aka_rptAkBillJurnalBea";
			...
			systemAPI.alert("[app_saku2_report_kopeg_aka_flAkBillJurnalBea]::mainButtonClick:"+e);
		}
	},
