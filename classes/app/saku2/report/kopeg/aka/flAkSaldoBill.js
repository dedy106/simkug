window.app_saku2_report_kopeg_aka_flAkSaldoBill = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_aka_flAkSaldoBill.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_aka_flAkSaldoBill";
		this.maximize();
...
window.app_saku2_report_kopeg_aka_flAkSaldoBill.extend(window.childForm);
window.app_saku2_report_kopeg_aka_flAkSaldoBill.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_kopeg_aka_rptAkSaldoBill";
