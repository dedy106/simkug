window.app_saku2_report_kopeg_aka_flAkSaldoMhsBeaTu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_aka_flAkSaldoMhsBeaTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_aka_flAkSaldoMhsBeaTu";
		this.maximize();
...
window.app_saku2_report_kopeg_aka_flAkSaldoMhsBeaTu.extend(window.childForm);
window.app_saku2_report_kopeg_aka_flAkSaldoMhsBeaTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,5)+"/"+this.sg1.getCell(2,6)+"/"+sql_sub;
				this.showFilter = this.filterRep.showFilter(this.sg1);
				this.nama_report = "server_report_saku2_kopeg_aka_rptAkSaldoMhsBeaTu";
