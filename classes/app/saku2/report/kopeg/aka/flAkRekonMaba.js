window.app_saku2_report_kopeg_aka_flAkRekonMaba = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_aka_flAkRekonMaba.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_aka_flAkRekonMaba";
		this.maximize();
...
window.app_saku2_report_kopeg_aka_flAkRekonMaba.extend(window.childForm);
window.app_saku2_report_kopeg_aka_flAkRekonMaba.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_aka_rptAkRekonMaba";
