window.app_saku2_report_kopeg_aka_flAkBillBatalTu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_aka_flAkBillBatalTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_aka_flAkBillBatalTu";
		this.maximize();
...
window.app_saku2_report_kopeg_aka_flAkBillBatalTu.extend(window.childForm);
window.app_saku2_report_kopeg_aka_flAkBillBatalTu.implement({
		...
		try{			
			...
			if (row ==5)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Invoice",this.sg1, this.sg1.row, this.sg1.col,
												...
												"select count(a.no_batal) from aka_bill_m a "+this.filter,
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_aka_rptAkBillBatalTu";
