window.app_saku2_report_kopeg_aka_flAkAmorJurnalTu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_aka_flAkAmorJurnalTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_aka_flAkAmorJurnalTu";
		this.maximize();
...
window.app_saku2_report_kopeg_aka_flAkAmorJurnalTu.extend(window.childForm);
window.app_saku2_report_kopeg_aka_flAkAmorJurnalTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_aka_rptAkAmorJurnalTu";
			...
			systemAPI.alert("[app_saku2_report_kopeg_aka_flAkAmorJurnalTu]::mainButtonClick:"+e);
		}
	},
