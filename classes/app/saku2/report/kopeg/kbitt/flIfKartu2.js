window.app_saku2_report_kopeg_kbitt_flIfKartu2 = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flIfKartu2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flIfKartu2";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Tahun","=",this.periode.substr(0,4)));
...
window.app_saku2_report_kopeg_kbitt_flIfKartu2.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flIfKartu2.implement({
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3],["3","13","123","123"]);
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptIfKartu2";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flIfKartu2]::mainButtonClick:"+e);
		}
	},
