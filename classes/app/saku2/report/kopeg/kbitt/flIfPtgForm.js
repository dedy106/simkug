window.app_saku2_report_kopeg_kbitt_flIfPtgForm = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flIfPtgForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flIfPtgForm";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flIfPtgForm.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flIfPtgForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flIfPtgForm]::mainButtonClick:"+e);
		}
	},
