window.app_saku2_report_kopeg_kbitt_flReimbursePos = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flReimbursePos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flReimbursePos";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flReimbursePos.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flReimbursePos.implement({
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter =  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("a.kode_pp",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
							this.filterRep.filterStr("a.no_aju",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and")+tanggal+" and a.modul='HUTIF'";
				this.filter2 = this.sg1.getCell(2,1)+"/";
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptReimbursePos";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flReimbursePos]::mainButtonClick:"+e);
		}
	},
