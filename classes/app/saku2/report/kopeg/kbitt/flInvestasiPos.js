window.app_saku2_report_kopeg_kbitt_flInvestasiPos = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flInvestasiPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flInvestasiPos";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from it_aju_m where kode_lokasi='"+this.app._lokasi+"' and modul='LOG'");
...
window.app_saku2_report_kopeg_kbitt_flInvestasiPos.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flInvestasiPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptInvestasiPos";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flInvestasiPos]::mainButtonClick:"+e);
		}
	},
