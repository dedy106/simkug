window.app_saku2_report_kopeg_kbitt_flBebanFormDok = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flBebanFormDok.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flBebanFormDok";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flBebanFormDok.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flBebanFormDok.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flBebanFormDok]::mainButtonClick:"+e);
		}
	},
