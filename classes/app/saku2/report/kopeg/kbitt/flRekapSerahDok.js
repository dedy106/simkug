window.app_saku2_report_kopeg_kbitt_flRekapSerahDok = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flRekapSerahDok.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flRekapSerahDok";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flRekapSerahDok.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flRekapSerahDok.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptRekapSerahDok";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flRekapSerahDok]::mainButtonClick:"+e);
		}
	},
    ...
    doOpenDetail: function(jenis,kode_lokasi){
		...
		filter2=jenis;
		nama_report="server_report_saku2_kopeg_kbitt_rptRekapSerahDokDet";
