window.app_saku2_report_kopeg_kbitt_flPtgPosTu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flPtgPosTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flPtgPosTu";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flPtgPosTu.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flPtgPosTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptPtgPosTu";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flPtgPosTu]::mainButtonClick:"+e);
		}
	},
