window.app_saku2_report_kopeg_kbitt_flBebanTu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flBebanTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flBebanTu";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flBebanTu.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flBebanTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptBebanTu";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flBebanTu]::mainButtonClick:"+e);
		}
	},
