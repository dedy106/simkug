window.app_saku2_report_kopeg_kbitt_flHonorTransfer = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flHonorTransfer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flHonorTransfer";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flHonorTransfer.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flHonorTransfer.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptHonorTransfer";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flHonorTransfer]::mainButtonClick:"+e);
		}
	},
