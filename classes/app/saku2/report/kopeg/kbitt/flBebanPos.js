window.app_saku2_report_kopeg_kbitt_flBebanPos = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flBebanPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flBebanPos";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flBebanPos.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flBebanPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptBebanPos";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flBebanPos]::mainButtonClick:"+e);
		}
	},
