window.app_saku2_report_kopeg_kbitt_flIfPos = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flIfPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flIfPos";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flIfPos.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flIfPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptIfPos";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flIfPos]::mainButtonClick:"+e);
		}
	},
