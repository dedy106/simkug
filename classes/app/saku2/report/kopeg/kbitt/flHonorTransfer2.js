window.app_saku2_report_kopeg_kbitt_flHonorTransfer2 = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flHonorTransfer2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flHonorTransfer2";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flHonorTransfer2.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flHonorTransfer2.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptHonorTransfer2";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flHonorTransfer2]::mainButtonClick:"+e);
		}
	},
