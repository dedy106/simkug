window.app_saku2_report_kopeg_kbitt_flPanjar = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flPanjar.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flPanjar";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flPanjar.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flPanjar.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptPanjar";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flPanjar]::mainButtonClick:"+e);
		}
	},
