...
//* 			SAI, PT											
//***********************************************************************************************
window.app_saku2_report_kopeg_kbitt_flKbBbKantin = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flKbBbKantin.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flKbBbKantin";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flKbBbKantin.extend(window.portalui_childForm);
window.app_saku2_report_kopeg_kbitt_flKbBbKantin.implement({
		...
		if (row == 2)
			{
				this.filterRep.ListDataSGFilter(this, "Data Akun",this.sg1, this.sg1.row, this.sg1.col,
													...
													"where a.block= '0' and (b.kode_flag='052') "+
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_kbitt_rptKbBukuBesarKantin";
				this.sql = "call sp_glma_kas_tmp ('"+this.sg1.getCell(2,0)+"','"+this.sg1.getCell(2,0)+"','"+this.sg1.getCell(2,0)+"','"+this.sg1.getCell(2,1)+"','"+this.app._nikUser+"')";	
