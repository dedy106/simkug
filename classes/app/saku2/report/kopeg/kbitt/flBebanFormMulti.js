window.app_saku2_report_kopeg_kbitt_flBebanFormMulti = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flBebanFormMulti.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flBebanFormMulti";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from it_aju_m where kode_lokasi='"+this.app._lokasi+"' and form='MULTI'");
...
window.app_saku2_report_kopeg_kbitt_flBebanFormMulti.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flBebanFormMulti.implement({
		...
		try{			
			...
			if (row ==3)
			{
				this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							" and a.modul='UMUM' and a.form='MULTI'";
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from it_aju_m where kode_lokasi='"+this.app._lokasi+"' and form='MULTI' order by periode",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptBebanFormMulti";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flBebanFormMulti]::mainButtonClick:"+e);
		}
	},
