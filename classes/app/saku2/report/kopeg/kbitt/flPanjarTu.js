window.app_saku2_report_kopeg_kbitt_flPanjarTu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flPanjarTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flPanjarTu";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flPanjarTu.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flPanjarTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptPanjarTu";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flPanjarTu]::mainButtonClick:"+e);
		}
	},
