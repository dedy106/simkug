window.app_saku2_report_kopeg_kbitt_flBebanFormTu2 = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flBebanFormTu2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flBebanFormTu2";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flBebanFormTu2.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flBebanFormTu2.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flBebanFormTu2]::mainButtonClick:"+e);
		}
	},
