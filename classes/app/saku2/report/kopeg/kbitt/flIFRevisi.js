window.app_saku2_report_kopeg_kbitt_flIFRevisi = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flIFRevisi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flIFRevisi";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flIFRevisi.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flIFRevisi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptIFRevisi";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flIFRevisi]::mainButtonClick:"+e);
		}
	},
	...
	doOpenVer: function(no_bukti,kode_pp,periode,kode_lokasi){
		this.link="1";
		filter = "where a.no_aju='"+no_bukti+"' and a.kode_lokasi='"+kode_lokasi+"' and a.kode_pp='"+kode_pp+"' and a.form in ('HUTIFNON') ";
		filter2=periode+"/Layar/posisi imprest fund";
