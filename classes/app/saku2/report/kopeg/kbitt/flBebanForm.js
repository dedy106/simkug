window.app_saku2_report_kopeg_kbitt_flBebanForm = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flBebanForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flBebanForm";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flBebanForm.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flBebanForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flBebanForm]::mainButtonClick:"+e);
		}
	},
