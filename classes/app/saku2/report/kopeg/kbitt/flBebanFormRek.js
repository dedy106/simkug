window.app_saku2_report_kopeg_kbitt_flBebanFormRek = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flBebanFormRek.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flBebanFormRek";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flBebanFormRek.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flBebanFormRek.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptBebanFormRek";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flBebanFormRek]::mainButtonClick:"+e);
		}
	},
