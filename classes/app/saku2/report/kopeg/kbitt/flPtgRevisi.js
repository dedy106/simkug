window.app_saku2_report_kopeg_kbitt_flPtgRevisi = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flPtgRevisi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flPtgRevisi";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flPtgRevisi.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flPtgRevisi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptPtgRevisi";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flPtgRevisi]::mainButtonClick:"+e);
		}
	},
	...
	doOpenVer: function(no_bukti,kode_pp,periode,kode_lokasi){
		this.link="1";
		filter = "where a.no_aju='"+no_bukti+"' and a.kode_lokasi='"+kode_lokasi+"' and a.kode_pp='"+kode_pp+"' and a.modul in ('PJPTG') ";
		filter2=periode+"/Layar/posisi pertanggungan panjar";
