window.app_saku2_report_kopeg_kbitt_flAjuPDD = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flAjuPDD.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flAjuPDD";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flAjuPDD.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flAjuPDD.implement({
		...
		try{			
			...
			if (row ==3)
			{
				this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							" and a.modul in ('UMUM') and a.no_ref1 in ('MALA','MABA') ";
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flAjuPDD]::mainButtonClick:"+e);
		}
	},
