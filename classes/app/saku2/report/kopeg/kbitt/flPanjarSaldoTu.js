window.app_saku2_report_kopeg_kbitt_flPanjarSaldoTu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flPanjarSaldoTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flPanjarSaldoTu";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flPanjarSaldoTu.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flPanjarSaldoTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptPanjarSaldoTu";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flPanjarSaldoTu]::mainButtonClick:"+e);
		}
	},
