window.app_saku2_report_kopeg_kbitt_flBeban = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flBeban.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flBeban";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flBeban.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flBeban.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptBeban";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flBeban]::mainButtonClick:"+e);
		}
	},
