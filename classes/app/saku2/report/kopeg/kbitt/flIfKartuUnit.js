window.app_saku2_report_kopeg_kbitt_flIfKartuUnit = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flIfKartuUnit.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flIfKartuUnit";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from it_ifaju_m where kode_lokasi='"+this.app._lokasi+"'");
...
window.app_saku2_report_kopeg_kbitt_flIfKartuUnit.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flIfKartuUnit.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptIfKartuUnit";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flIfKartuUnit]::mainButtonClick:"+e);
		}
	},
