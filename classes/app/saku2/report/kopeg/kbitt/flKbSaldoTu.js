// JavaScript Document
window.app_saku2_report_kopeg_kbitt_flKbSaldoTu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flKbSaldoTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flKbSaldoTu";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flKbSaldoTu.extend(window.portalui_childForm);
window.app_saku2_report_kopeg_kbitt_flKbSaldoTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_kbitt_rptKbSaldoTu";
				this.dbLib.execQuerySync(this.sql);	
