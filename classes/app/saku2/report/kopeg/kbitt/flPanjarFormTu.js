window.app_saku2_report_kopeg_kbitt_flPanjarFormTu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flPanjarFormTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flPanjarFormTu";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flPanjarFormTu.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flPanjarFormTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flPanjarFormTu]::mainButtonClick:"+e);
		}
	},
