window.app_saku2_report_kopeg_kbitt_flBebanPosTuPdd= function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flBebanPosTuPdd.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flBebanPosTuPdd";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,8,new Array(0,1,2), new Array("Bukti Keluar","All",""));
...
window.app_saku2_report_kopeg_kbitt_flBebanPosTuPdd.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flBebanPosTuPdd.implement({
	...
	{		
		if (this.app._userStatus=="A")
		{
			...
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5,6,7,8],[2,0,2,2,2,2,1,0,2]);	
		}
		else
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6,7,8],["123","123","3","123","123","123","123","3","123"]);
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5,6,7,8],[3,0,2,2,2,2,2,1,2]);
		}
		if (row == 1)
		{
		...
		try
		{
			...
			else
			{
		    	...
		    	this.filter =  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.kode_pp",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
							this.filterRep.filterStr("a.kode_akun",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and")+
							// this.filterRep.filterStr("o.nim",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4),"and")+
							this.filterRep.filterStr("a.no_aju",this.sg1.getCell(1,5),this.sg1.getCell(2,5),this.sg1.getCell(3,5),"and")+tanggal+
							this.filterRep.filterStr("a.no_kas",this.sg1.getCell(1,8),this.sg1.getCell(2,8),this.sg1.getCell(3,8),"and")+
							" and a.modul in ('UMUM','BMULTI') and a.no_ref1 in ('MALA','MABA','CAMABA') ";
				...
				this.filter2 = this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,7)+"/"+this.filter3;
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptBebanPosTuPdd";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flBebanPosTuPdd]::mainButtonClick:"+e);
		}
	},
