window.app_saku2_report_kopeg_kbitt_flInvestasiRevisi = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flInvestasiRevisi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flInvestasiRevisi";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flInvestasiRevisi.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flInvestasiRevisi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptInvestasiRevisi";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flInvestasiRevisi]::mainButtonClick:"+e);
		}
	},
	...
	doOpenVer: function(no_bukti,kode_pp,periode,kode_lokasi){
		...
		filter2=periode+"/Layar/posisi pertanggungan investasi";
