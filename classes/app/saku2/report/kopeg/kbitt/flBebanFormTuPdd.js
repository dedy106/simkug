window.app_saku2_report_kopeg_kbitt_flBebanFormTuPdd = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flBebanFormTuPdd.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flBebanFormTuPdd";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flBebanFormTuPdd.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flBebanFormTuPdd.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flBebanFormTuPdd]::mainButtonClick:"+e);
		}
	},
