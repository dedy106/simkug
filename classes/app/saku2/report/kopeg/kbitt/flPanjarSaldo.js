window.app_saku2_report_kopeg_kbitt_flPanjarSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flPanjarSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flPanjarSaldo";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flPanjarSaldo.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flPanjarSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptPanjarSaldo2";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flPanjarSaldo]::mainButtonClick:"+e);
		}
	},
	...
	doOpenPtg: function(no_bukti,kode_lokasi){
		...
		else
		{
			...
			nama_report="server_report_saku2_kopeg_kbitt_rptPtgJurnal";
		}
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
