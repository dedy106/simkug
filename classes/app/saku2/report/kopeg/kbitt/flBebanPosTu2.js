window.app_saku2_report_kopeg_kbitt_flBebanPosTu2 = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flBebanPosTu2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flBebanPosTu2";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,8,new Array(0,1,2), new Array("Posted","All",""));
...
window.app_saku2_report_kopeg_kbitt_flBebanPosTu2.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flBebanPosTu2.implement({
	...
	{		
		if (this.app._userStatus=="A")
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6,7,8],["123","123","123","123","123","123","3","123","13"]);
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5,6,7,8],[2,0,2,2,2,1,0,2,0]);	
		}
		else if(this.app._userStatus=="P")
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6,7,8],["123","123","23","123","123","123","3","123","13"]);
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5,6,7,8],[3,0,2,2,2,2,1,2,0]);
		}
		else
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6,7,8],["123","123","3","123","123","123","3","123","13"]);
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5,6,7,8],[3,0,2,2,2,2,1,2,0]);
		}
		if (row == 1)
		{
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				{
					if(this.sg1.getCell(2,8) == "Posting"){
						var posted_from = "T";
					}else{
						var posted_from = "-";
					}
				...
				if (this.sg1.getCell(1,8)=="Range")
				{
					...
					if(this.sg1.getCell(3,8) == "Posting"){
						var posted_to = "T";
					}else{
						var posted_to = "-";
					}
		    	...
		    	this.filter =  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.no_kas",this.sg1.getCell(1,7),this.sg1.getCell(2,7),this.sg1.getCell(3,7),"and")+posted+
							" and a.modul in ('UMUM','BMULTI') and a.progress not in ('J','L') ";
				this.filter2 = this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,6);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptBebanPosTu2";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flBebanPosTu2]::mainButtonClick:"+e);
		}
	},
