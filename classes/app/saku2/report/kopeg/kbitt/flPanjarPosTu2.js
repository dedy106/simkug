window.app_saku2_report_kopeg_kbitt_flPanjarPosTu2 = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flPanjarPosTu2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flPanjarPosTu2";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flPanjarPosTu2.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flPanjarPosTu2.implement({
	...
	{		
		if (this.app._userStatus=="A")
		{
			...
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5,6],[2,0,2,2,1,2,0]);	
		}
		else
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5,6],["123","123","123","123","123","123","3"]);
		...
		try
		{
			...
			else
			{
		    	...
		    	this.filter =  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("a.kode_pp",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
							this.filterRep.filterStr("a.no_aju",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and")+tanggal+this.filterRep.filterStr("a.no_kas",this.sg1.getCell(1,5),this.sg1.getCell(2,5),this.sg1.getCell(3,5),"and")+
							" and a.modul='PANJAR' ";
				this.filter2 = this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,6);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptPanjarPosTu2";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flPanjarPosTu2]::mainButtonClick:"+e);
		}
	},
