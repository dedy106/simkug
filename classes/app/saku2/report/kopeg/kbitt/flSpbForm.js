window.app_saku2_report_kopeg_kbitt_flSpbForm = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flSpbForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flSpbForm";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flSpbForm.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flSpbForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flSpbForm]::mainButtonClick:"+e);
		}
	},
