window.app_saku2_report_kopeg_kbitt_flIfSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flIfSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flIfSaldo";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flIfSaldo.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flIfSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptIfSaldo";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flIfSaldo]::mainButtonClick:"+e);
		}
	},
