window.app_saku2_report_kopeg_kbitt_flSpbFormYpt = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flSpbFormYpt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flSpbFormYpt";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flSpbFormYpt.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flSpbFormYpt.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptSpbYpt";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flSpbFormYpt]::mainButtonClick:"+e);
		}
	},
