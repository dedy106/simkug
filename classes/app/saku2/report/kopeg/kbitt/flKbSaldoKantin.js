// JavaScript Document
window.app_saku2_report_kopeg_kbitt_flKbSaldoKantin = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flKbSaldoKantin.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flKbSaldoKantin";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flKbSaldoKantin.extend(window.portalui_childForm);
window.app_saku2_report_kopeg_kbitt_flKbSaldoKantin.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_kbitt_rptKbSaldoKantin";
				this.dbLib.execQuerySync(this.sql);	
