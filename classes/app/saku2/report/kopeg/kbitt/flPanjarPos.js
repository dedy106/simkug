window.app_saku2_report_kopeg_kbitt_flPanjarPos = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flPanjarPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flPanjarPos";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flPanjarPos.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flPanjarPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptPanjarPos";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flPanjarPos]::mainButtonClick:"+e);
		}
	},
