window.app_saku2_report_kopeg_kbitt_flPtgFormTu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flPtgFormTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flPtgFormTu";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flPtgFormTu.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flPtgFormTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flPtgFormTu]::mainButtonClick:"+e);
		}
	},
