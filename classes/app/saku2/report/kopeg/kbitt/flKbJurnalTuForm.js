window.app_saku2_report_kopeg_kbitt_flKbJurnalTuForm = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flKbJurnalTuForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flKbJurnalTuForm";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flKbJurnalTuForm.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flKbJurnalTuForm.implement({
