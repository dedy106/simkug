window.app_saku2_report_kopeg_kbitt_flHonorForm = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flHonorForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flHonorForm";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flHonorForm.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flHonorForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flHonorForm]::mainButtonClick:"+e);
		}
	},
