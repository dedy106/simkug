window.app_saku2_report_kopeg_kbitt_flSpbPos = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flSpbPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flSpbPos";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flSpbPos.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flSpbPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptSpbTuPos";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flSpbPos]::mainButtonClick:"+e);
		}
	},
