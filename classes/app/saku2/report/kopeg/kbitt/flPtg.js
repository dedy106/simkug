window.app_saku2_report_kopeg_kbitt_flPtg = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flPtg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flPtg";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flPtg.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flPtg.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptPtg";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flPtg]::mainButtonClick:"+e);
		}
	},
