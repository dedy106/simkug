window.app_saku2_report_kopeg_kbitt_flReimburse = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flReimburse.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flReimburse";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flReimburse.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flReimburse.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptReimburse";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flReimburse]::mainButtonClick:"+e);
		}
	},
