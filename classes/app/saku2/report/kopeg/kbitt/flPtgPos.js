window.app_saku2_report_kopeg_kbitt_flPtgPos = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flPtgPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flPtgPos";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flPtgPos.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flPtgPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptPtgPos";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flPtgPos]::mainButtonClick:"+e);
		}
	},
