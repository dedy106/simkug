window.app_saku2_report_kopeg_kbitt_flIfJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flIfJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flIfJurnal";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from ju_m where kode_lokasi='"+this.app._lokasi+"' and modul='KBITT'");
...
window.app_saku2_report_kopeg_kbitt_flIfJurnal.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flIfJurnal.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from ju_m where kode_lokasi='"+this.app._lokasi+"' and modul='KBITT' order by periode desc",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+
							...
							" and a.modul in ('ITIFAJU','ITIFAJUNON','KBITT') ";
				this.filter2=this.sg1.getCell(2,1);
				this.nama_report="server_report_saku2_kopeg_kbitt_rptIfJurnal";
