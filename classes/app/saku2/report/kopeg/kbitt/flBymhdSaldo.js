// JavaScript Document
window.app_saku2_report_kopeg_kbitt_flBymhdSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flBymhdSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flBymhdSaldo";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flBymhdSaldo.extend(window.portalui_childForm);
window.app_saku2_report_kopeg_kbitt_flBymhdSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_kbitt_rptBymhdSaldo";
				this.dbLib.execQuerySync(this.sql);	
