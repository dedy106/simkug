window.app_saku2_report_kopeg_kbitt_flPanjarPosTu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flPanjarPosTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flPanjarPosTu";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flPanjarPosTu.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flPanjarPosTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptPanjarPosTu";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flPanjarPosTu]::mainButtonClick:"+e);
		}
	},
