window.app_saku2_report_kopeg_kbitt_flPtgJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flPtgJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flPtgJurnal";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flPtgJurnal.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flPtgJurnal.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row == 2)
			{
				...
				var sql1="select distinct a.no_ptg,a.no_dokumen from ptg_m a "+filter+modul; 
				var sql2="select count(distinct a.no_ptg) from ptg_m a "+filter+modul;
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_saku2_kopeg_kbitt_rptPtgJurnal";
				if (this.sg1.getCell(2,3)=="Memo Jurnal")
				{
					this.nama_report="server_report_saku2_kopeg_kbitt_rptPtgBuktiJurnal";
				}
