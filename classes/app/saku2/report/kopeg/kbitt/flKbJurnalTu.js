window.app_saku2_report_kopeg_kbitt_flKbJurnalTu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flKbJurnalTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flKbJurnalTu";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flKbJurnalTu.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flKbJurnalTu.implement({
		...
		try{			
			...
			if (row == 2)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Jurnal",this.sg1, this.sg1.row, this.sg1.col,
														  "select no_kas, no_dokumen from kas_m "+filter ,
														  "select count(no_kas) from kas_m "+filter,
														  new Array("no_kas","no_dokumen"),"and");
			}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_saku2_kopeg_kbitt_rptKbJurnalTu";
