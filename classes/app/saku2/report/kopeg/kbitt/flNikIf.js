window.app_saku2_report_kopeg_kbitt_flNikIf = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flNikIf.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flNikIf";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Jenis ","=","Pemegang IF"));
...
window.app_saku2_report_kopeg_kbitt_flNikIf.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flNikIf.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("Pemegang IF","Pemegang Sub IF"));
		}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				if (this.sg1.getCell(2,1)=="Pemegang IF")
				{
					this.nama_report = "server_report_saku2_kopeg_kbitt_rptNikIf";
				}
				else
				{
					this.nama_report = "server_report_saku2_kopeg_kbitt_rptNikIfSub";
				}
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flNikIf]::mainButtonClick:"+e);
		}
	},
