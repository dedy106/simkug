window.app_saku2_report_kopeg_kbitt_flInvestasi = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flInvestasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flInvestasi";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flInvestasi.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flInvestasi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptInvestasi";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flInvestasi]::mainButtonClick:"+e);
		}
	},
