window.app_saku2_report_kopeg_kbitt_flIfForm = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flIfForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flIfForm";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from kas_m where kode_lokasi='"+this.app._lokasi+"' and modul='KBIFCAIR' ");
...
window.app_saku2_report_kopeg_kbitt_flIfForm.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flIfForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptIfForm";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flIfForm]::mainButtonClick:"+e);
		}
	},
