window.app_saku2_report_kopeg_kbitt_flBebanFormTu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flBebanFormTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flBebanFormTu";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flBebanFormTu.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flBebanFormTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flBebanFormTu]::mainButtonClick:"+e);
		}
	},
