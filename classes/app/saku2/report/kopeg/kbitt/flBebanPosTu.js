window.app_saku2_report_kopeg_kbitt_flBebanPosTu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flBebanPosTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flBebanPosTu";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flBebanPosTu.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flBebanPosTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptBebanPosTu";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flBebanPosTu]::mainButtonClick:"+e);
		}
	},
