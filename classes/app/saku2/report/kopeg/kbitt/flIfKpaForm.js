window.app_saku2_report_kopeg_kbitt_flIfKpaForm = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flIfKpaForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flIfKpaForm";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flIfKpaForm.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flIfKpaForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flIfKpaForm]::mainButtonClick:"+e);
		}
	},
