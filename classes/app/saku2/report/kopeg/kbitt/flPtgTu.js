window.app_saku2_report_kopeg_kbitt_flPtgTu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flPtgTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flPtgTu";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flPtgTu.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flPtgTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptPtgTu";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flPtgTu]::mainButtonClick:"+e);
		}
	},
