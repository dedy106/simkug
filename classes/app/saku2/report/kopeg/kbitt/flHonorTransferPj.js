window.app_saku2_report_kopeg_kbitt_flHonorTransferPj = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flHonorTransferPj.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flHonorTransferPj";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("Jenis Laporan","=","Rekap"));
...
window.app_saku2_report_kopeg_kbitt_flHonorTransferPj.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flHonorTransferPj.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptHonorTransferPj";
				if (this.sg1.getCell(2,4)=="Detail")
				{
					this.nama_report = "server_report_saku2_kopeg_kbitt_rptHonorTransferDetailPj";
				}
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flHonorTransferPj]::mainButtonClick:"+e);
		}
	},
