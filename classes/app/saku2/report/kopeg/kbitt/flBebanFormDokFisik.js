window.app_saku2_report_kopeg_kbitt_flBebanFormDokFisik = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flBebanFormDokFisik.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flBebanFormDokFisik";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flBebanFormDokFisik.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flBebanFormDokFisik.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flBebanFormDokFisik]::mainButtonClick:"+e);
		}
	},
