window.app_saku2_report_kopeg_kbitt_flIfKartu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flIfKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flIfKartu";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flIfKartu.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flIfKartu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptIfKartu";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flIfKartu]::mainButtonClick:"+e);
		}
	},
