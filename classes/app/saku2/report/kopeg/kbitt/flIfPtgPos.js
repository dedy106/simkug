window.app_saku2_report_kopeg_kbitt_flIfPtgPos = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flIfPtgPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flIfPtgPos";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flIfPtgPos.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flIfPtgPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptIfPtgPos";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flIfPtgPos]::mainButtonClick:"+e);
		}
	},
