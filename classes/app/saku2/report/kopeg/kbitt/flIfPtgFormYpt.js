window.app_saku2_report_kopeg_kbitt_flIfPtgFormYpt = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flIfPtgFormYpt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flIfPtgFormYpt";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flIfPtgFormYpt.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flIfPtgFormYpt.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flIfPtgFormYpt]::mainButtonClick:"+e);
		}
	},
