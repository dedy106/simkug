window.app_saku2_report_kopeg_kbitt_flKbSiapBayar = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flKbSiapBayar.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flKbSiapBayar";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flKbSiapBayar.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flKbSiapBayar.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptKbSiapBayar";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flKbSiapBayar]::mainButtonClick:"+e);
		}
	},
