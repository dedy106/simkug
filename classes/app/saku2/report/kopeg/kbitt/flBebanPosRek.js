window.app_saku2_report_kopeg_kbitt_flBebanPosRek = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_kbitt_flBebanPosRek.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_kbitt_flBebanPosRek";
		this.maximize();
...
window.app_saku2_report_kopeg_kbitt_flBebanPosRek.extend(window.childForm);
window.app_saku2_report_kopeg_kbitt_flBebanPosRek.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_kbitt_rptBebanPosRek";
			...
			systemAPI.alert("[app_saku2_report_kopeg_kbitt_flBebanPosRek]::mainButtonClick:"+e);
		}
	},
