window.app_saku2_report_kopeg_proyek_flVendor = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_proyek_flVendor.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_proyek_flVendor";
		this.maximize();
...
window.app_saku2_report_kopeg_proyek_flVendor.extend(window.childForm);
window.app_saku2_report_kopeg_proyek_flVendor.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_proyek_rptVendor";
			...
			systemAPI.alert("[app_saku2_report_kopeg_proyek_flVendor]::mainButtonClick:"+e);
		}
	},
