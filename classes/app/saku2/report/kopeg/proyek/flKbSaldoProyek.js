// JavaScript Document
window.app_saku2_report_kopeg_proyek_flKbSaldoProyek = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_proyek_flKbSaldoProyek.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_proyek_flKbSaldoProyek";
		this.maximize();
...
window.app_saku2_report_kopeg_proyek_flKbSaldoProyek.extend(window.portalui_childForm);
window.app_saku2_report_kopeg_proyek_flKbSaldoProyek.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kb_rptKbSaldo";
				this.dbLib.execQuerySync(this.sql);	
