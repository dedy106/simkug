window.app_saku2_report_kopeg_proyek_flProyek = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_proyek_flProyek.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_proyek_flProyek";
		this.maximize();
...
window.app_saku2_report_kopeg_proyek_flProyek.extend(window.childForm);
window.app_saku2_report_kopeg_proyek_flProyek.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_proyek_rptProyek";
			...
			systemAPI.alert("[app_saku2_report_kopeg_proyek_flProyek]::mainButtonClick:"+e);
		}
	},
