window.app_saku2_report_kopeg_proyek_flProyekLr = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_proyek_flProyekLr.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_proyek_flProyekLr";
		this.maximize();
...
window.app_saku2_report_kopeg_proyek_flProyekLr.extend(window.childForm);
window.app_saku2_report_kopeg_proyek_flProyekLr.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_proyek_flProyekLr]::mainButtonClick:"+e);
		}
	},
