window.app_saku2_report_kopeg_proyek_flProyekBeban = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_proyek_flProyekBeban.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_proyek_flProyekBeban";
		this.maximize();
...
window.app_saku2_report_kopeg_proyek_flProyekBeban.extend(window.childForm);
window.app_saku2_report_kopeg_proyek_flProyekBeban.implement({
		...
		try{			
			...
			if (row ==5)
			{
				filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							"' and a.modul='BEBAN' ";
				this.filterRep.ListDataSGFilter(this, "Data Beban Proyek",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_aju, a.keterangan from pr_beban_d a "+filter,
												"select count(a.no_aju) from pr_beban_d a "+filter,
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5],["123","123","123","123","123"]);
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5],[2,0,2,2,2]);	
		if (row == 1)
		{
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("c.jenis",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and")+
				...
				this.nama_report = "server_report_saku2_kopeg_proyek_rptProyekBeban";
			...
			systemAPI.alert("[app_saku2_report_kopeg_proyek_flProyekBeban]::mainButtonClick:"+e);
		}
	},
