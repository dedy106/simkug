window.app_saku2_report_kopeg_proyek_flProyekJurnalPyt = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_proyek_flProyekJurnalPyt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_proyek_flProyekJurnalPyt";
		this.maximize();
...
window.app_saku2_report_kopeg_proyek_flProyekJurnalPyt.extend(window.childForm);
window.app_saku2_report_kopeg_proyek_flProyekJurnalPyt.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_proyek_flProyekJurnalPyt]::mainButtonClick:"+e);
		}
	},
