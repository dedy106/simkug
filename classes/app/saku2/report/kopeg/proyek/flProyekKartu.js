window.app_saku2_report_kopeg_proyek_flProyekKartu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_proyek_flProyekKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_proyek_flProyekKartu";
		this.maximize();
...
window.app_saku2_report_kopeg_proyek_flProyekKartu.extend(window.childForm);
window.app_saku2_report_kopeg_proyek_flProyekKartu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_proyek_flProyekKartu]::mainButtonClick:"+e);
		}
	},
	...
	doOpenBukti: function(no_aju,kode_lokasi){
		this.no_aju=no_aju;
		this.kode_lokasi=kode_lokasi;
		this.link="1";
