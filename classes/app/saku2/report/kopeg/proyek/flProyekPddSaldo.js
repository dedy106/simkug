window.app_saku2_report_kopeg_proyek_flProyekPddSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_proyek_flProyekPddSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_proyek_flProyekPddSaldo";
		this.maximize();
...
window.app_saku2_report_kopeg_proyek_flProyekPddSaldo.extend(window.childForm);
window.app_saku2_report_kopeg_proyek_flProyekPddSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_proyek_rptProyekPddSaldo";
			...
			systemAPI.alert("[app_saku2_report_kopeg_proyek_flProyekPddSaldo]::mainButtonClick:"+e);
		}
	},
