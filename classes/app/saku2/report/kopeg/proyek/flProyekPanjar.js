window.app_saku2_report_kopeg_proyek_flProyekPanjar = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_proyek_flProyekPanjar.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_proyek_flProyekPanjar";
		this.maximize();
...
window.app_saku2_report_kopeg_proyek_flProyekPanjar.extend(window.childForm);
window.app_saku2_report_kopeg_proyek_flProyekPanjar.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_proyek_rptProyekPanjar";
			...
			systemAPI.alert("[app_saku2_report_kopeg_proyek_flProyekPanjar]::mainButtonClick:"+e);
		}
	},
