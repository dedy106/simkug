window.app_saku2_report_kopeg_proyek_flProyekSpm = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_proyek_flProyekSpm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_proyek_flProyekSpm";
		this.maximize();
...
window.app_saku2_report_kopeg_proyek_flProyekSpm.extend(window.childForm);
window.app_saku2_report_kopeg_proyek_flProyekSpm.implement({
		...
		try{			
			...
			if (row ==4)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Proyek",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_proyek, a.keterangan from spm_proyek a "+filter,
												"select count(a.no_proyek) from spm_proyek a "+filter,
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,2,3,4],["123","123","13","123"]);
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,2,3,4],[2,2,0,2]);	
		if (row == 3)
		{
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_proyek_rptProyekSpm";
			...
			systemAPI.alert("[app_saku2_report_kopeg_proyek_flProyekSpm]::mainButtonClick:"+e);
		}
	},
