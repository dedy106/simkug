window.app_saku2_report_kopeg_proyek_flProyekBmhd = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_proyek_flProyekBmhd.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_proyek_flProyekBmhd";
		this.maximize();
...
window.app_saku2_report_kopeg_proyek_flProyekBmhd.extend(window.childForm);
window.app_saku2_report_kopeg_proyek_flProyekBmhd.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_proyek_rptProyekBmhd";
			...
			systemAPI.alert("[app_saku2_report_kopeg_proyek_flProyekBmhd]::mainButtonClick:"+e);
		}
	},
