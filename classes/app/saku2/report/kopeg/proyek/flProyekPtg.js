window.app_saku2_report_kopeg_proyek_flProyekPtg = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_proyek_flProyekPtg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_proyek_flProyekPtg";
		this.maximize();
...
window.app_saku2_report_kopeg_proyek_flProyekPtg.extend(window.childForm);
window.app_saku2_report_kopeg_proyek_flProyekPtg.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_proyek_flProyekPtg]::mainButtonClick:"+e);
		}
	},
