window.app_saku2_report_kopeg_proyek_flPic = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_proyek_flPic.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_proyek_flPic";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Kode PIC","All",""));
...
window.app_saku2_report_kopeg_proyek_flPic.extend(window.childForm);
window.app_saku2_report_kopeg_proyek_flPic.implement({
		...
		try{			
			...
			if (row ==	1)
			{
				this.filterRep.ListDataSGFilter(this, "Data PIC",this.sg1, this.sg1.row, this.sg1.col,
														  "select kode_pic, nama from pr_pic "+
														   this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  "select count(kode_pic) from pr_pic "+
														  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("pr_picomer","All",""));
				...
				this.nama_report = "server_report_saku2_kopeg_proyek_rptPic";
			...
			systemAPI.alert("[app_saku2_report_kopeg_proyek_flPic]::mainButtonClick:"+e);
		}
	},
