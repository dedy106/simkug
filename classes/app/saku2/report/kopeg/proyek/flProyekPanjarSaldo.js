window.app_saku2_report_kopeg_proyek_flProyekPanjarSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_proyek_flProyekPanjarSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_proyek_flProyekPanjarSaldo";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("No Proyek","All",""));
...
window.app_saku2_report_kopeg_proyek_flProyekPanjarSaldo.extend(window.childForm);
window.app_saku2_report_kopeg_proyek_flProyekPanjarSaldo.implement({
		...
		try{			
			...
			if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Proyek",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_proyek, a.keterangan from pr_beban_d a "+filter,
												"select count(a.no_proyek) from pr_beban_d a "+filter,
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.no_proyek",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and")+
				...
				this.nama_report = "server_report_saku2_kopeg_proyek_rptProyekPanjarSaldo";
			...
			systemAPI.alert("[app_saku2_report_kopeg_proyek_flProyekPanjarSaldo]::mainButtonClick:"+e);
		}
	},
