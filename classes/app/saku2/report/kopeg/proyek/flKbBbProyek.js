...
//* 			SAI, PT											
//***********************************************************************************************
window.app_saku2_report_kopeg_proyek_flKbBbProyek = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_proyek_flKbBbProyek.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_proyek_flKbBbProyek";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Kode Customer","All",""));
...
window.app_saku2_report_kopeg_proyek_flKbBbProyek.extend(window.portalui_childForm);
window.app_saku2_report_kopeg_proyek_flKbBbProyek.implement({
		...
		if (row == 3)
		{
			this.filterRep.ListDataSGFilter(this, "Data Proyek",this.sg1, this.sg1.row, this.sg1.col,
													  "select kode_project, keterangan from project "+
													   this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
													  "select count(kode_project) from project "+
													  this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
													  ["kode_project","keterangan"],"and",["Kode","Keterangan"]);
		}
		
	},
	doSelectCell: function(sender, col, row){
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3],["1234","123","123","123"]);
		...
		try
		{
			...
			else
			{
				...
				this.filter=this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," and ")+
							...
							this.filterRep.filterStr("a.kode_project",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3)," and ");
				
				//this.filter2 = this.app._namaForm+"/"+filter_akun+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,0)+"/"+this.app._nikUser+"/"+sort;
				this.nama_report="server_report_saku2_kopeg_proyek_rptKbBbProyek";
