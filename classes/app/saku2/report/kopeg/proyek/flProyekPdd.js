window.app_saku2_report_kopeg_proyek_flProyekPdd = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_proyek_flProyekPdd.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_proyek_flProyekPdd";
		this.maximize();
...
window.app_saku2_report_kopeg_proyek_flProyekPdd.extend(window.childForm);
window.app_saku2_report_kopeg_proyek_flProyekPdd.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_proyek_rptProyekPdd";
			...
			systemAPI.alert("[app_saku2_report_kopeg_proyek_flProyekPdd]::mainButtonClick:"+e);
		}
	},
