window.app_saku2_report_kopeg_proyek_flProyekBebanPos = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_proyek_flProyekBebanPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_proyek_flProyekBebanPos";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from pr_beban_d where kode_lokasi='"+this.app._lokasi+"' and modul='BEBAN'");
...
window.app_saku2_report_kopeg_proyek_flProyekBebanPos.extend(window.childForm);
window.app_saku2_report_kopeg_proyek_flProyekBebanPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_proyek_rptProyekBebanPos";
			...
			systemAPI.alert("[app_saku2_report_kopeg_proyek_flProyekBebanPos]::mainButtonClick:"+e);
		}
	},
