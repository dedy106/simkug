window.app_saku2_report_kopeg_proyek_flProyekBmhdSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_proyek_flProyekBmhdSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_proyek_flProyekBmhdSaldo";
		this.maximize();
...
window.app_saku2_report_kopeg_proyek_flProyekBmhdSaldo.extend(window.childForm);
window.app_saku2_report_kopeg_proyek_flProyekBmhdSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_proyek_rptProyekBmhdSaldo";
			...
			systemAPI.alert("[app_saku2_report_kopeg_proyek_flProyekBmhdSaldo]::mainButtonClick:"+e);
		}
	},
