window.app_saku2_report_kopeg_proyek_flKbJurnalProyek = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_proyek_flKbJurnalProyek.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_proyek_flKbJurnalProyek";
		this.maximize();
...
window.app_saku2_report_kopeg_proyek_flKbJurnalProyek.extend(window.childForm);
window.app_saku2_report_kopeg_proyek_flKbJurnalProyek.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_saku2_kb_rptKbJurnal";
