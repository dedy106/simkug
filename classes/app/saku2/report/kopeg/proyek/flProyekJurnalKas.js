window.app_saku2_report_kopeg_proyek_flProyekJurnalKas = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_proyek_flProyekJurnalKas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_proyek_flProyekJurnalKas";
		this.maximize();
...
window.app_saku2_report_kopeg_proyek_flProyekJurnalKas.extend(window.childForm);
window.app_saku2_report_kopeg_proyek_flProyekJurnalKas.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_proyek_rptProyekJurnalKas";
			...
			systemAPI.alert("[app_saku2_report_kopeg_proyek_flProyekJurnalKas]::mainButtonClick:"+e);
		}
	},
