window.app_saku2_report_kopeg_flPinjApp = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_flPinjApp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_flPinjApp";
		this.maximize();
...
window.app_saku2_report_kopeg_flPinjApp.extend(window.childForm);
window.app_saku2_report_kopeg_flPinjApp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_rptPinjApp";
			...
			systemAPI.alert("[app_saku2_report_kopeg_flPinjApp]::mainButtonClick:"+e);
		}
	},
