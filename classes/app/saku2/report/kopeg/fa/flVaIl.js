window.app_saku2_report_kopeg_fa_flVaIl = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_fa_flVaIl.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_fa_flVaIl";
		this.maximize();
...
window.app_saku2_report_kopeg_fa_flVaIl.extend(window.childForm);
window.app_saku2_report_kopeg_fa_flVaIl.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_fa_rptVaIl";
			...
			systemAPI.alert("[app_saku2_report_kopeg_fa_flVaIl]::mainButtonClick:"+e);
		}
	},
