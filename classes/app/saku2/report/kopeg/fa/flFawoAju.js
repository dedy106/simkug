window.app_saku2_report_kopeg_fa_flFawoAju = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_fa_flFawoAju.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_fa_flFawoAju";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from fawo_m ");
...
window.app_saku2_report_kopeg_fa_flFawoAju.extend(window.childForm);
window.app_saku2_report_kopeg_fa_flFawoAju.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_fa_rptFawoAju";
			...
			systemAPI.alert("[app_saku2_report_kopeg_fa_flFawoAju]::mainButtonClick:"+e);
		}
	},
