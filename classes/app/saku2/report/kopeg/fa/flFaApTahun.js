window.app_saku2_report_kopeg_fa_flFaApTahun = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_fa_flFaApTahun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_fa_flFaApTahun";
		this.maximize();
...
window.app_saku2_report_kopeg_fa_flFaApTahun.extend(window.childForm);
window.app_saku2_report_kopeg_fa_flFaApTahun.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_fa_rptFaApTahun";
