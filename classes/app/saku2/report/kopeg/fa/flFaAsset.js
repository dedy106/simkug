window.app_saku2_report_kopeg_fa_flFaAsset = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_fa_flFaAsset.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_fa_flFaAsset";
		this.maximize();
...
window.app_saku2_report_kopeg_fa_flFaAsset.extend(window.childForm);
window.app_saku2_report_kopeg_fa_flFaAsset.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row == 4)
			{
				...
				var sql1="select a.no_fa,a.nama from gl_fa_asset a "+filter; 
				var sql2="select count(a.no_fa) from gl_fa_asset a "+filter; 
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5],["3","236","236","123","123","3"]);
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_fa_rptFaAsset";
