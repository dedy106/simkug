window.app_saku2_report_kopeg_fa_flFaSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_fa_flFaSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_fa_flFaSaldo";
		this.maximize();
...
window.app_saku2_report_kopeg_fa_flFaSaldo.extend(window.childForm);
window.app_saku2_report_kopeg_fa_flFaSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_fa_rptFaSaldo";
