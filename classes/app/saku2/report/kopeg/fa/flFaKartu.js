window.app_saku2_report_kopeg_fa_flFaKartu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_fa_flFaKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_fa_flFaKartu";
		this.maximize();
...
window.app_saku2_report_kopeg_fa_flFaKartu.extend(window.childForm);
window.app_saku2_report_kopeg_fa_flFaKartu.implement({
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4],["3","236","236","123","123"]);
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_fa_rptFaKartu";
