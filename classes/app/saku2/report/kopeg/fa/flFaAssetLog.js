window.app_saku2_report_kopeg_fa_flFaAssetLog = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_fa_flFaAssetLog.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_fa_flFaAssetLog";
		this.maximize();
...
window.app_saku2_report_kopeg_fa_flFaAssetLog.extend(window.childForm);
window.app_saku2_report_kopeg_fa_flFaAssetLog.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_fa_rptFaAssetLog";
