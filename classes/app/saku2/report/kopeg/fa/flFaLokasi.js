window.app_saku2_report_kopeg_fa_flFaLokasi = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_fa_flFaLokasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_fa_flFaLokasi";
		this.maximize();
...
window.app_saku2_report_kopeg_fa_flFaLokasi.extend(window.childForm);
window.app_saku2_report_kopeg_fa_flFaLokasi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			if (sender == this.app._mainForm.bBack)
			{
				...
				if (this.link=="2")
				{
					this.doOpenAsset(this.kode_lok,this.kode_lokasi);
				}
			}
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_fa_rptFaLokasi";
	...
	doOpenAsset: function(kode_lok,kode_lokasi){
		this.kode_lok=kode_lok;
		this.kode_lokasi=kode_lokasi;
		this.link="1";
		filter2 = kode_lokasi+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,2);
		filter=" where a.kode_lokfa='"+kode_lok+"' and a.kode_lokasi='"+kode_lokasi+"'";
		nama_report="server_report_saku2_kopeg_fa_rptFaAssetLog";
