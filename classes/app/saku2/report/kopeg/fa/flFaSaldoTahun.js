window.app_saku2_report_kopeg_fa_flFaSaldoTahun = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_fa_flFaSaldoTahun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_fa_flFaSaldoTahun";
		this.maximize();
...
window.app_saku2_report_kopeg_fa_flFaSaldoTahun.extend(window.childForm);
window.app_saku2_report_kopeg_fa_flFaSaldoTahun.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kopeg_fa_rptFaSaldoTahun";
	...
	doOpenAsset: function(kode_akun,kode_lokasi,tahun){
		...
		nama_report="server_report_saku2_kopeg_fa_rptFaAsset";
	...
	doOpenBbAsset: function(no_fa,kode_lokasi){
		...
		nama_report="server_report_saku2_kopeg_fa_rptFaKartu";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
