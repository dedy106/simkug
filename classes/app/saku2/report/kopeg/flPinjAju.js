window.app_saku2_report_kopeg_flPinjAju = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_flPinjAju.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_flPinjAju";
		this.maximize();
...
window.app_saku2_report_kopeg_flPinjAju.extend(window.childForm);
window.app_saku2_report_kopeg_flPinjAju.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_rptPinjAju";
			...
			systemAPI.alert("[app_saku2_report_kopeg_flPinjAju]::mainButtonClick:"+e);
		}
	},
