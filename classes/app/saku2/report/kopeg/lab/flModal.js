window.app_saku2_report_kopeg_lab_flModal = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_lab_flModal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_lab_flModal";
		this.maximize();
...
window.app_saku2_report_kopeg_lab_flModal.extend(window.childForm);
window.app_saku2_report_kopeg_lab_flModal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_kopeg_lab_rptModal";
			...
			systemAPI.alert("[app_saku2_report_kopeg_lab_flModal]::mainButtonClick:"+e);
		}
	},
