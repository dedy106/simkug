window.app_saku2_report_kopeg_lab_flJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_lab_flJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_lab_flJurnal";
		this.maximize();
...
window.app_saku2_report_kopeg_lab_flJurnal.extend(window.childForm);
window.app_saku2_report_kopeg_lab_flJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_lab_rptJurnal";
			...
			systemAPI.alert("[app_saku2_report_kopeg_lab_flJurnal]::mainButtonClick:"+e);
		}
	},
