window.app_saku2_report_kopeg_lab_flBukuBesar = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_lab_flBukuBesar.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_lab_flBukuBesar";
		this.maximize();
...
window.app_saku2_report_kopeg_lab_flBukuBesar.extend(window.childForm);
window.app_saku2_report_kopeg_lab_flBukuBesar.implement({
	...
	{		
		...
		else
		{
			...
			this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2],["123","123","123","123"]);
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2],[2,2,2,2]);	
		}
	},
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_kopeg_lab_rptBukuBesar";
			...
			systemAPI.alert("[app_saku2_report_kopeg_lab_flBukuBesar]::mainButtonClick:"+e);
		}
	},
