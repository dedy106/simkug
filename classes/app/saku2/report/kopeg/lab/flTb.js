window.app_saku2_report_kopeg_lab_flTb = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_lab_flTb.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_lab_flTb";
		this.maximize();
...
window.app_saku2_report_kopeg_lab_flTb.extend(window.childForm);
window.app_saku2_report_kopeg_lab_flTb.implement({
	...
	{	
		...
		{	
			this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3],["123","2","123","123"]);
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3],[2,3,2,2]);	
		}
		else
		{
		...
		if (row == 4)
		{
			...
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("Nett Off","Mutasi"));
		}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2 = this.app._nikUser+"/";
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku2_kopeg_lab_rptTb";
				//this.sg1.defocus()
			...
			systemAPI.alert("[app_saku2_report_kopeg_lab_flTb]::mainButtonClick:"+e);
		}
	},
