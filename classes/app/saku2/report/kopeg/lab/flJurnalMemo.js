window.app_saku2_report_kopeg_lab_flJurnalMemo = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_lab_flJurnalMemo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_lab_flJurnalMemo";
		this.maximize();
...
window.app_saku2_report_kopeg_lab_flJurnalMemo.extend(window.childForm);
window.app_saku2_report_kopeg_lab_flJurnalMemo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_lab_flJurnalMemo]::mainButtonClick:"+e);
		}
	},
