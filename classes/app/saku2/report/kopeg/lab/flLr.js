window.app_saku2_report_kopeg_lab_flLr = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_lab_flLr.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_lab_flLr";
		this.maximize();
...
window.app_saku2_report_kopeg_lab_flLr.extend(window.childForm);
window.app_saku2_report_kopeg_lab_flLr.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_kopeg_lab_rptLr";
			...
			systemAPI.alert("[app_saku2_report_kopeg_lab_flLr]::mainButtonClick:"+e);
		}
	},
