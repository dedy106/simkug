window.app_saku2_report_kopeg_lab_flReview = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_lab_flReview.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_lab_flReview";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Dosen","=",this.app._userLog));
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Kode Tugas","=",this.no_tugas));
...
window.app_saku2_report_kopeg_lab_flReview.extend(window.childForm);
window.app_saku2_report_kopeg_lab_flReview.implement({
		...
		try{			
			...
			if (row ==	2)
			{
				var filter=this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+
						this.filterRep.filterStr("kode_dosen",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1)," and ");
		...
		try
		{
			...
			else
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+
							this.filterRep.filterStr("a.kode_dosen",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1)," and ")+
							this.filterRep.filterStr("a.no_tugas",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
				this.filter2 = this.app._nikUser+"/"+this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,2);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku2_kopeg_lab_rptReview";
			...
			systemAPI.alert("[app_saku2_report_kopeg_lab_flReview]::mainButtonClick:"+e);
		}
	},
