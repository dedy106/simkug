window.app_saku2_report_kopeg_lab_flAkun = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_lab_flAkun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_lab_flAkun";
		this.maximize();
	...
	this.dbLarge = new util_dbLarge();
		...
		this.no_tugas=this.dbLib.getPeriodeFromSQL("select max(no_tugas) as periode from lab_masakun where kode_lokasi='"+this.app._lokasi+"' and nik_user='"+this.app._userLog+"'");
...
window.app_saku2_report_kopeg_lab_flAkun.extend(window.childForm);
window.app_saku2_report_kopeg_lab_flAkun.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row ==	2)
			{
				ilter= this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+
						this.filterRep.filterStr("nim",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1)," and ");
			...
			if (row ==	3)
			{
				filter= this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+
						this.filterRep.filterStr("nik_use",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1)," and ")+
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_lab_rptAkun";
			...
			systemAPI.alert("[app_saku2_report_kopeg_lab_flAkun]::mainButtonClick:"+e);
		}
	},
