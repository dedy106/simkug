window.app_saku2_report_kopeg_lab_flArusKas = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_lab_flArusKas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_lab_flArusKas";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("No Tugas","All",""));
...
window.app_saku2_report_kopeg_lab_flArusKas.extend(window.childForm);
window.app_saku2_report_kopeg_lab_flArusKas.implement({
		...
		try{			
			...
			if (row ==	2)
			{
				filter= this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+
						this.filterRep.filterStr("no_tugas",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1)," and ");
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.no_tugas",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
				...
				this.nama_report = "server_report_saku2_kopeg_lab_rptArusKas";
			...
			systemAPI.alert("[app_saku2_report_kopeg_lab_flArusKas]::mainButtonClick:"+e);
		}
	},
