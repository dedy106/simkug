window.app_saku2_report_kopeg_lab_flDosen = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_lab_flDosen.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_lab_flDosen";
		this.maximize();
...
window.app_saku2_report_kopeg_lab_flDosen.extend(window.childForm);
window.app_saku2_report_kopeg_lab_flDosen.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_lab_rptDosen";
			...
			systemAPI.alert("[app_saku2_report_kopeg_lab_flDosen]::mainButtonClick:"+e);
		}
	},
