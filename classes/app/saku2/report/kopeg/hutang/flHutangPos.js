window.app_saku2_report_kopeg_hutang_flHutangPos = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_hutang_flHutangPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_hutang_flHutangPos";
		this.maximize();
...
window.app_saku2_report_kopeg_hutang_flHutangPos.extend(window.childForm);
window.app_saku2_report_kopeg_hutang_flHutangPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_hutang_rptHutangPos";
			...
			systemAPI.alert("[app_saku2_report_kopeg_hutang_flHutangPos]::mainButtonClick:"+e);
		}
	},
