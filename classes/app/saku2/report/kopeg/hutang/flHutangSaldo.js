window.app_saku2_report_kopeg_hutang_flHutangSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_hutang_flHutangSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_hutang_flHutangSaldo";
		this.maximize();
...
window.app_saku2_report_kopeg_hutang_flHutangSaldo.extend(window.childForm);
window.app_saku2_report_kopeg_hutang_flHutangSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_kopeg_hutang_rptHutangSaldo";
			...
			systemAPI.alert("[app_saku2_report_kopeg_hutang_flHutangSaldo]::mainButtonClick:"+e);
		}
	},
