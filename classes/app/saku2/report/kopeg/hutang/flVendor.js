window.app_saku2_report_kopeg_hutang_flVendor = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_hutang_flVendor.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_hutang_flVendor";
		this.maximize();
...
window.app_saku2_report_kopeg_hutang_flVendor.extend(window.childForm);
window.app_saku2_report_kopeg_hutang_flVendor.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_hutang_rptVendor";
			...
			systemAPI.alert("[app_saku2_report_kopeg_hutang_flVendor]::mainButtonClick:"+e);
		}
	},
