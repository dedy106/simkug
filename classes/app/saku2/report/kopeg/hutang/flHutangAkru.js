window.app_saku2_report_kopeg_hutang_flHutangAkru = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_hutang_flHutangAkru.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_hutang_flHutangAkru";
		this.maximize();
...
window.app_saku2_report_kopeg_hutang_flHutangAkru.extend(window.childForm);
window.app_saku2_report_kopeg_hutang_flHutangAkru.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_hutang_flHutangAkru]::mainButtonClick:"+e);
		}
	},
