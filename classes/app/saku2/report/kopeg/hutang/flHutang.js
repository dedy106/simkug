window.app_saku2_report_kopeg_hutang_flHutang = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_hutang_flHutang.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_hutang_flHutang";
		this.maximize();
...
window.app_saku2_report_kopeg_hutang_flHutang.extend(window.childForm);
window.app_saku2_report_kopeg_hutang_flHutang.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_hutang_rptHutang";
			...
			systemAPI.alert("[app_saku2_report_kopeg_hutang_flHutang]::mainButtonClick:"+e);
		}
	},
