window.app_saku2_report_kopeg_hutang_flHutangSpb = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_hutang_flHutangSpb.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_hutang_flHutangSpb";
		this.maximize();
...
window.app_saku2_report_kopeg_hutang_flHutangSpb.extend(window.childForm);
window.app_saku2_report_kopeg_hutang_flHutangSpb.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kopeg_hutang_flHutangSpb]::mainButtonClick:"+e);
		}
	},
