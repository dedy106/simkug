window.app_saku2_report_kopeg_barang_flKbBeli = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_barang_flKbBeli.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_barang_flKbBeli";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from kas_m where modul='KBBELI' ");
...
window.app_saku2_report_kopeg_barang_flKbBeli.extend(window.childForm);
window.app_saku2_report_kopeg_barang_flKbBeli.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_barang_rptKbBeli";
			...
			systemAPI.alert("[app_saku2_report_kopeg_barang_flKbBeli]::mainButtonClick:"+e);
		}
	},
