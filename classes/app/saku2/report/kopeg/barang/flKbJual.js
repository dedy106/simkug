window.app_saku2_report_kopeg_barang_flKbJual = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kopeg_barang_flKbJual.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kopeg_barang_flKbJual";
		this.maximize();
...
window.app_saku2_report_kopeg_barang_flKbJual.extend(window.childForm);
window.app_saku2_report_kopeg_barang_flKbJual.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kopeg_barang_rptKbJual";
			...
			systemAPI.alert("[app_saku2_report_kopeg_barang_flKbJual]::mainButtonClick:"+e);
		}
	},
