window.app_saku2_report_frigia_inv_flJenisBrg = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_frigia_inv_flJenisBrg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_frigia_inv_flJenisBrg";
		this.maximize();
...
window.app_saku2_report_frigia_inv_flJenisBrg.extend(window.portalui_childForm);
window.app_saku2_report_frigia_inv_flJenisBrg.prototype.doEllipseClick= function(sender, col, row)
{
		if (row == 0){
...
window.app_saku2_report_frigia_inv_flJenisBrg.prototype.doSelectCell = function(sender, col, row)
{
...
window.app_saku2_report_frigia_inv_flJenisBrg.prototype.mainButtonClick = function(sender)
{
	try
	{
	...
	{
		alert("[app_saku2_report_frigia_inv_flJenisBrg]::mainButtonClick:"+e);
	}
};
window.app_saku2_report_frigia_inv_flJenisBrg.prototype.doRequestReady = function(sender, methodName, result)
{
...
window.app_saku2_report_frigia_inv_flJenisBrg.prototype.getStringHeader = function(){
...
window.app_saku2_report_frigia_inv_flJenisBrg.prototype.doConfirmClick = function(sender){
	try{
...
window.app_saku2_report_frigia_inv_flJenisBrg.prototype.doSelectedPage = function(sender, page)
{
	var dthtml = this.dbLib.sqlToHtml(this.sqlScript,page,this.pager, this.title, this.widthTable, this.fieldType,false);			
	this.previewReport(dthtml);			
	this.page=page;
};
window.app_saku2_report_frigia_inv_flJenisBrg.prototype.previewReport = function(dthtml)
{
...
window.app_saku2_report_frigia_inv_flJenisBrg.prototype.doCloseReportClick = function(sender)
{
...
window.app_saku2_report_frigia_inv_flJenisBrg.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_saku2_report_frigia_inv_flJenisBrg.prototype.doRowPerPageChange = function(sender, rowperpage)
{
