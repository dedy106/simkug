window.app_saku2_report_frigia_flGajiPph = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_frigia_flGajiPph.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_frigia_flGajiPph";
		this.maximize();
...
window.app_saku2_report_frigia_flGajiPph.extend(window.childForm);
window.app_saku2_report_frigia_flGajiPph.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_frigia_rptGajiPph";
			...
			systemAPI.alert("[app_saku2_report_frigia_flGajiPph]::mainButtonClick:"+e);
		}
	},
