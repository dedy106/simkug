window.app_saku2_report_frigia_flGajiSlip = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_frigia_flGajiSlip.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_frigia_flGajiSlip";
		this.maximize();
...
window.app_saku2_report_frigia_flGajiSlip.extend(window.childForm);
window.app_saku2_report_frigia_flGajiSlip.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_frigia_rptGajiSlip";
			...
			systemAPI.alert("[app_saku2_report_frigia_flGajiSlip]::mainButtonClick:"+e);
		}
	},
