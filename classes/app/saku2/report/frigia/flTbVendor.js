// JavaScript Document
window.app_saku2_report_frigia_flTbVendor = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_frigia_flTbVendor.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_frigia_flTbVendor";
		this.maximize();
...
window.app_saku2_report_frigia_flTbVendor.extend(window.portalui_childForm);
window.app_saku2_report_frigia_flTbVendor.implement({
	doEllipseClick: function(sender, col, row){
		...
		if (row == 3)
		{
			this.filterRep.ListDataSGFilter(this, "Data Vendor",this.sg1, this.sg1.row, this.sg1.col,
													  ...
													  "INNER JOIN flag_relasi b ON a.kode_lokasi=b.kode_lokasi AND b.kode_flag='024' AND b.kode_akun='"+this.sg1.getCell(2,2)+"' "+
													  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
													  new Array("a.kode_vendor","a.nama"),"where");
		}
	},
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.sql=" select a.kode_vendor,a.nama,isnull(b.so_awal,0) as so_awal,isnull(c.debet,0) as debet,isnull(c.kredit,0) as kredit, "+
	...
	previewReport: function(dthtml){
		var html = "<div align='center' class='judul_laporan' style='{width:100%;font-size:14;font-weight:bold;}'>"+this.app._namalokasi.toUpperCase()+"<br>Laporan Saldo Hutang<br>";			
		var d = new Date();
