...
//* 			SAI, PT											
//***********************************************************************************************
window.app_saku2_report_frigia_flBbCust = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_frigia_flBbCust.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_frigia_flBbCust";
		this.maximize();
		
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Buku Besar Piutang", 2);
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Kode Akun","=","115001"));
...
window.app_saku2_report_frigia_flBbCust.extend(window.portalui_childForm);
window.app_saku2_report_frigia_flBbCust.implement({
	doEllipseClick: function(sender, col, row){
		...
		if (row == 2)
		{
			this.filterRep.ListDataSGFilter(this, "Data Akun",this.sg1, this.sg1.row, this.sg1.col,
													  ...
													  "inner join flag_relasi b on a.kode_lokasi=a.kode_lokasi and b.kode_flag='003' and a.kode_akun=b.kode_akun "+
													  "where a.block= '0' "+
		...
		if (row == 3)
		{
			this.filterRep.ListDataSGFilter(this, "Data Customer",this.sg1, this.sg1.row, this.sg1.col,
													  "select kode_cust, nama from cust "+
													   this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+" order by kode_cust",
	...
	mainButtonClick: function(sender){
		try{
			...
			this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,2)+"/"+this.filterRep.filterStr("a.kode_cust",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and");
			
			this.nama_report="server_report_saku2_frigia_rptBbCust";
