window.app_saku2_report_frigia_flGajiBulan = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_frigia_flGajiBulan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_frigia_flGajiBulan";
		this.maximize();
...
window.app_saku2_report_frigia_flGajiBulan.extend(window.childForm);
window.app_saku2_report_frigia_flGajiBulan.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_frigia_rptGajiBulan";
			...
			systemAPI.alert("[app_saku2_report_frigia_flGajiBulan]::mainButtonClick:"+e);
		}
	},
