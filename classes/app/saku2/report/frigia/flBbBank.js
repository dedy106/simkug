...
//* 			SAI, PT											
//***********************************************************************************************
window.app_saku2_report_frigia_flBbBank = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_frigia_flBbBank.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_frigia_flBbBank";
		this.maximize();
		
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Buku Besar Kas&Bank", 2);
...
window.app_saku2_report_frigia_flBbBank.extend(window.portalui_childForm);
window.app_saku2_report_frigia_flBbBank.implement({
	...
	mainButtonClick: function(sender){
		try{
			...
			this.nama_report="server_report_saku2_frigia_rptBbBank";
