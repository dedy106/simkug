// JavaScript Document
window.app_saku2_report_frigia_flTbBank = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_frigia_flTbBank.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_frigia_flTbBank";
		this.maximize();
...
window.app_saku2_report_frigia_flTbBank.extend(window.portalui_childForm);
window.app_saku2_report_frigia_flTbBank.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			var sql=" select a.kode_akun,a.nama,d.kode_pp,d.nama as nama_pp,isnull(b.so_awal,0) as so_awal,isnull(c.debet,0) as debet,isnull(c.kredit,0) as kredit, "+
	...
	previewReport: function(dthtml){
		var html = "<div align='center' class='judul_laporan' style='{width:100%;font-size:14;font-weight:bold;}'>"+this.app._namalokasi.toUpperCase()+"<br>SALDO KAS BANK<br>Periode "+periodeToName(this.sg1.getCell(2,1))+"<br>";			
		var d = new Date();
