window.app_saku2_report_frigia_flGajiRekap = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_frigia_flGajiRekap.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_frigia_flGajiRekap";
		this.maximize();
...
window.app_saku2_report_frigia_flGajiRekap.extend(window.childForm);
window.app_saku2_report_frigia_flGajiRekap.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_frigia_rptGajiRekap";
			...
			systemAPI.alert("[app_saku2_report_frigia_flGajiRekap]::mainButtonClick:"+e);
		}
	},
