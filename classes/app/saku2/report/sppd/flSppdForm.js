window.app_saku2_report_sppd_flSppdForm = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_sppd_flSppdForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_sppd_flSppdForm";
		this.maximize();
...
window.app_saku2_report_sppd_flSppdForm.extend(window.childForm);
window.app_saku2_report_sppd_flSppdForm.implement({
	...
	{		
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("Biaya","Surat Perintah","Surat Perintah Manager"));
		}
	},
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				{
					this.nama_report = "server_report_saku2_sppd_rptSppdForm";
				}
				if (this.sg1.getCell(2,5)=="Surat Perintah")
				{
					this.nama_report = "server_report_saku2_sppd_rptSppdSp";
				}
				if (this.sg1.getCell(2,5)=="Surat Perintah Manager")
				{
					this.nama_report = "server_report_saku2_sppd_rptSppdSpMgr";
				}
			...
			systemAPI.alert("[app_saku2_report_sppd_flSppdForm]::mainButtonClick:"+e);
		}
	},
