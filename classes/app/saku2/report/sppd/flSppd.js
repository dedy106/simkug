window.app_saku2_report_sppd_flSppd = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_sppd_flSppd.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_sppd_flSppd";
		this.maximize();
...
window.app_saku2_report_sppd_flSppd.extend(window.childForm);
window.app_saku2_report_sppd_flSppd.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_sppd_rptSppd";
			...
			systemAPI.alert("[app_saku2_report_sppd_flSppd]::mainButtonClick:"+e);
		}
	},
