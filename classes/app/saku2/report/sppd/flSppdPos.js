window.app_saku2_report_sppd_flSppdPos = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_sppd_flSppdPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_sppd_flSppdPos";
		this.maximize();
...
window.app_saku2_report_sppd_flSppdPos.extend(window.childForm);
window.app_saku2_report_sppd_flSppdPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_sppd_rptSppdPos";
			...
			systemAPI.alert("[app_saku2_report_sppd_flSppdPos]::mainButtonClick:"+e);
		}
	},
