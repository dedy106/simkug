window.app_saku2_report_ak_flAkKartu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_ak_flAkKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_ak_flAkKartu";
		this.maximize();
...
window.app_saku2_report_ak_flAkKartu.extend(window.childForm);
window.app_saku2_report_ak_flAkKartu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			}else
			{
				...
				this.nama_report = "server_report_saku2_aka_rptAkKartu";
