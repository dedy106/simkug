window.app_saku2_report_ak_flAkJurnalImt = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_ak_flAkJurnalImt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_ak_flAkJurnalImt";
		this.maximize();
...
window.app_saku2_report_ak_flAkJurnalImt.extend(window.childForm);
window.app_saku2_report_ak_flAkJurnalImt.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_ak_flAkJurnalImt]::mainButtonClick:"+e);
		}
	},
