window.app_saku2_report_ak_flAkAging = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_ak_flAkAging.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_ak_flAkAging";
		this.maximize();
...
window.app_saku2_report_ak_flAkAging.extend(window.childForm);
window.app_saku2_report_ak_flAkAging.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_ak_flAkAging]::mainButtonClick:"+e);
		}
	},
	initColumn: function(){
		try{		
