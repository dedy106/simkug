window.app_saku2_report_ak_flAkKartuImt = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_ak_flAkKartuImt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_ak_flAkKartuImt";
		this.maximize();
...
window.app_saku2_report_ak_flAkKartuImt.extend(window.childForm);
window.app_saku2_report_ak_flAkKartuImt.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			}else
			{
				...
				this.nama_report = "server_report_saku2_aka_rptAkKartuImt";
