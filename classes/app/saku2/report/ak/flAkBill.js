window.app_saku2_report_ak_flAkBill = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_ak_flAkBill.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_ak_flAkBill";
		this.maximize();
...
window.app_saku2_report_ak_flAkBill.extend(window.childForm);
window.app_saku2_report_ak_flAkBill.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_ak_flAkBill]::mainButtonClick:"+e);
		}
	},
	initColumn: function(){
		try{		
