window.app_saku2_report_ak_flAkSaldoJur3 = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_ak_flAkSaldoJur3.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_ak_flAkSaldoJur3";
		this.maximize();
...
window.app_saku2_report_ak_flAkSaldoJur3.extend(window.childForm);
window.app_saku2_report_ak_flAkSaldoJur3.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_aka_rptAkSaldoJur3";
