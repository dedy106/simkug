window.app_saku2_report_ak_flAkBatalImt = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_ak_flAkBatalImt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_ak_flAkBatalImt";
		this.maximize();
...
window.app_saku2_report_ak_flAkBatalImt.extend(window.childForm);
window.app_saku2_report_ak_flAkBatalImt.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_ak_flAkBatalImt]::mainButtonClick:"+e);
		}
	},
	initColumn: function(){
		try{		
