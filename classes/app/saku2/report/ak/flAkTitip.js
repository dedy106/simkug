window.app_saku2_report_ak_flAkTitip = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_ak_flAkTitip.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_ak_flAkTitip";
		this.maximize();
...
window.app_saku2_report_ak_flAkTitip.extend(window.childForm);
window.app_saku2_report_ak_flAkTitip.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_ak_flAkTitip]::mainButtonClick:"+e);
		}
	},
