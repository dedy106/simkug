window.app_saku2_report_ak_flAkSaldoJur2 = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_ak_flAkSaldoJur2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_ak_flAkSaldoJur2";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Bentuk Laporan","=","S1"));
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
	//this.pager=10;
	
};
window.app_saku2_report_ak_flAkSaldoJur2.extend(window.childForm);
window.app_saku2_report_ak_flAkSaldoJur2.implement({
	...
	{		
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("S1","S2"));
		}
	},
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_aka_rptAkSaldoJur2";
