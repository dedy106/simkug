window.app_saku2_report_ak_flAkAmor = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_ak_flAkAmor.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_ak_flAkAmor";
		this.maximize();
...
window.app_saku2_report_ak_flAkAmor.extend(window.childForm);
window.app_saku2_report_ak_flAkAmor.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				{
					var sql = "select a.no_amor,a.no_dokumen,date_format(a.tanggal,'%d/%m/%Y') as tanggal,a.keterangan,a.kode_pp,a.kode_drk, a.nilai "+
							"from aka_amor_m a "+
			...
			systemAPI.alert("[app_saku2_report_ak_flAkAmor]::mainButtonClick:"+e);
		}
	},
