window.app_saku2_report_ak_flAkMhs = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_ak_flAkMhs.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_ak_flAkMhs";
		this.maximize();
...
window.app_saku2_report_ak_flAkMhs.extend(window.childForm);
window.app_saku2_report_ak_flAkMhs.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_aka_rptAkMhs";
