window.app_saku2_report_ak_flAkSaldoJur = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_ak_flAkSaldoJur.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_ak_flAkSaldoJur";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Bentuk Laporan","=","Jurusan"));
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
	//this.pager=10;
	
};
window.app_saku2_report_ak_flAkSaldoJur.extend(window.childForm);
window.app_saku2_report_ak_flAkSaldoJur.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_aka_rptAkSaldoJur";
				if (this.sg1.getCell(2,3)=="Invoice")
				{
					this.nama_report = "server_report_saku2_aka_rptAkSaldoInv";
				}
	...
	doOpenSaldoMhs: function(kode_jur,kode_lokasi){
		...
		nama_report="server_report_saku2_aka_rptAkSaldoMhsTrail";
	...
	doOpenKartuMhs: function(nim,kode_lokasi){
		...
		nama_report="server_report_saku2_aka_rptAkKartuTrail";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
