window.app_saku2_report_ak_flAkSaldoAmorImt = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_ak_flAkSaldoAmorImt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_ak_flAkSaldoAmorImt";
		this.maximize();
...
window.app_saku2_report_ak_flAkSaldoAmorImt.extend(window.childForm);
window.app_saku2_report_ak_flAkSaldoAmorImt.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_ak_flAkSaldoAmorImt]::mainButtonClick:"+e);
		}
	},
	initColumn: function(){
		try{		
