window.app_saku2_report_kpa_flPjPtg = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kpa_flPjPtg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kpa_flPjPtg";
		this.maximize();
...
window.app_saku2_report_kpa_flPjPtg.extend(window.childForm);
window.app_saku2_report_kpa_flPjPtg.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kpa_rptPjPtg";
			...
			systemAPI.alert("[app_saku2_report_kpa_flPjPtg]::mainButtonClick:"+e);
		}
	},
