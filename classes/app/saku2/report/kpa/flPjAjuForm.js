window.app_saku2_report_kpa_flPjAjuForm = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kpa_flPjAjuForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kpa_flPjAjuForm";
		this.maximize();
...
window.app_saku2_report_kpa_flPjAjuForm.extend(window.childForm);
window.app_saku2_report_kpa_flPjAjuForm.implement({
		...
		try{			
			...
			if (row ==4)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Panjar",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_panjar, a.keterangan from itt_panjar_m a "+this.filter,
												"select count(*) from itt_panjar_m a "+this.filter,
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kpa_rptPjAjuForm";
			...
			systemAPI.alert("[app_saku2_report_kpa_flPjAjuForm]::mainButtonClick:"+e);
		}
	},
