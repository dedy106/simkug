window.app_saku2_report_kpa_flKpa = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kpa_flKpa.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kpa_flKpa";
		this.maximize();
...
window.app_saku2_report_kpa_flKpa.extend(window.childForm);
window.app_saku2_report_kpa_flKpa.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kpa_rptKpa";
			...
			systemAPI.alert("[app_saku2_report_kpa_flKpa]::mainButtonClick:"+e);
		}
	},
