window.app_saku2_report_kpa_flKpaCair = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kpa_flKpaCair.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kpa_flKpaCair";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from kas_m where modul='KBKPA' ");
	...
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Akun KasBank","All",""));
...
window.app_saku2_report_kpa_flKpaCair.extend(window.childForm);
window.app_saku2_report_kpa_flKpaCair.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from kas_m where modul='KBKPA' and kode_lokasi='"+this.app._lokasi+"' order by periode",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("No KPA","All",""));
			}else{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("a.akun_kb",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and")+
				...
				this.nama_report = "server_report_saku2_kpa_rptKpaCair";
			...
			systemAPI.alert("[app_saku2_report_kpa_flKpaCair]::mainButtonClick:"+e);
		}
	},
