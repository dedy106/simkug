window.app_saku2_report_kpa_flPjAju = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kpa_flPjAju.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kpa_flPjAju";
		this.maximize();
...
window.app_saku2_report_kpa_flPjAju.extend(window.childForm);
window.app_saku2_report_kpa_flPjAju.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kpa_rptPjAju";
			...
			systemAPI.alert("[app_saku2_report_kpa_flPjAju]::mainButtonClick:"+e);
		}
	},
