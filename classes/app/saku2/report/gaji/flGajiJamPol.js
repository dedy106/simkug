window.app_saku2_report_gaji_flGajiJamPol = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gaji_flGajiJamPol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gaji_flGajiJamPol";
		this.maximize();
...
window.app_saku2_report_gaji_flGajiJamPol.extend(window.childForm);
window.app_saku2_report_gaji_flGajiJamPol.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_saku2_gaji_rptGajiJamPol";
