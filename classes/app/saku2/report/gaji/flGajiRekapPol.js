window.app_saku2_report_gaji_flGajiRekapPol = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gaji_flGajiRekapPol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gaji_flGajiRekapPol";
		this.maximize();
...
window.app_saku2_report_gaji_flGajiRekapPol.extend(window.childForm);
window.app_saku2_report_gaji_flGajiRekapPol.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_saku2_gaji_rptGajiRekapPol";
