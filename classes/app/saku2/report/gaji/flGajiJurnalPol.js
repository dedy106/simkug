window.app_saku2_report_gaji_flGajiJurnalPol = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gaji_flGajiJurnalPol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gaji_flGajiJurnalPol";
		this.maximize();
...
window.app_saku2_report_gaji_flGajiJurnalPol.extend(window.childForm);
window.app_saku2_report_gaji_flGajiJurnalPol.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_gaji_rptGajiJurnalPol";
			...
			systemAPI.alert("[app_saku2_report_gaji_flGajiJurnalPol]::mainButtonClick:"+e);
		}
	},
