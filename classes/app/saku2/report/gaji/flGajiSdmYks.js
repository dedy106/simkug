window.app_saku2_report_gaji_flGajiSdmYks = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gaji_flGajiSdmYks.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gaji_flGajiSdmYks";
		this.maximize();
...
window.app_saku2_report_gaji_flGajiSdmYks.extend(window.childForm);
window.app_saku2_report_gaji_flGajiSdmYks.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_gaji_flGajiSdmYks]::mainButtonClick:"+e);
		}
	},
