window.app_saku2_report_gaji_flGajiSdmPol = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gaji_flGajiSdmPol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gaji_flGajiSdmPol";
		this.maximize();
...
window.app_saku2_report_gaji_flGajiSdmPol.extend(window.childForm);
window.app_saku2_report_gaji_flGajiSdmPol.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_gaji_rptGajiSdmPol";
			...
			systemAPI.alert("[app_saku2_report_gaji_flGajiSdmPol]::mainButtonClick:"+e);
		}
	},
