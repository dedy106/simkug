window.app_saku2_report_gaji_flGajiSlipPol = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gaji_flGajiSlipPol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gaji_flGajiSlipPol";
		this.maximize();
...
window.app_saku2_report_gaji_flGajiSlipPol.extend(window.childForm);
window.app_saku2_report_gaji_flGajiSlipPol.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_saku2_gaji_rptGajiSlipPol";
