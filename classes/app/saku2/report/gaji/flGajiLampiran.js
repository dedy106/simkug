window.app_saku2_report_gaji_flGajiLampiran = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gaji_flGajiLampiran.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gaji_flGajiLampiran";
		this.maximize();
...
window.app_saku2_report_gaji_flGajiLampiran.extend(window.childForm);
window.app_saku2_report_gaji_flGajiLampiran.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_saku2_gaji_rptGajiLampiran";
