window.app_saku2_report_gaji_flGajiSlipYks = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gaji_flGajiSlipYks.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gaji_flGajiSlipYks";
		this.maximize();
...
window.app_saku2_report_gaji_flGajiSlipYks.extend(window.childForm);
window.app_saku2_report_gaji_flGajiSlipYks.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_saku2_gaji_rptGajiSlipYks";
