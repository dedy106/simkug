window.app_saku2_report_gaji_flGajiDaftarYks = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gaji_flGajiDaftarYks.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gaji_flGajiDaftarYks";
		this.maximize();
...
window.app_saku2_report_gaji_flGajiDaftarYks.extend(window.childForm);
window.app_saku2_report_gaji_flGajiDaftarYks.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_saku2_gaji_rptGajiDaftarYks";
