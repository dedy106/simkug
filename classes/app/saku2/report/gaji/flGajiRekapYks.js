window.app_saku2_report_gaji_flGajiRekapYks = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gaji_flGajiRekapYks.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gaji_flGajiRekapYks";
		this.maximize();
...
window.app_saku2_report_gaji_flGajiRekapYks.extend(window.childForm);
window.app_saku2_report_gaji_flGajiRekapYks.implement({
		...
		try{			
			...
			if (row == 2)
			{
				this.filterRep.ListDataSGFilter(this, "Data Status Pegawai",this.sg1, this.sg1.row, this.sg1.col,
													...
													"select count(*) from hr_status_sdm  where kode_lokasi = '"+this.app._lokasi+"' ",
			...
			else
			{
				...
				else
				{
					...
					this.filter = this.filterRep.filterStr("f.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
								this.filterRep.filterStr("f.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
								...
								this.filterRep.filterStr("f.no_gaji",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4),"and");
					this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,4);
					this.showFilter = this.filterRep.showFilter(this.sg1);
					var result  = new arrayMap();		
					this.lokasi=this.app._namalokasi;
					this.nama_report = "server_report_saku2_gaji_rptGajiRekapYks";
