window.app_saku2_report_gaji_flGajiLampiranYks = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gaji_flGajiLampiranYks.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gaji_flGajiLampiranYks";
		this.maximize();
...
window.app_saku2_report_gaji_flGajiLampiranYks.extend(window.childForm);
window.app_saku2_report_gaji_flGajiLampiranYks.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_saku2_gaji_rptGajiLampiranYks";
