window.app_saku2_report_gaji_flGajiRekapRsp = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gaji_flGajiRekapRsp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gaji_flGajiRekapRsp";
		this.maximize();
...
window.app_saku2_report_gaji_flGajiRekapRsp.extend(window.childForm);
window.app_saku2_report_gaji_flGajiRekapRsp.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_saku2_gaji_rptGajiRekapRsp";
