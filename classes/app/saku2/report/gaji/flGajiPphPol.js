window.app_saku2_report_gaji_flGajiPphPol = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gaji_flGajiPphPol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gaji_flGajiPphPol";
		this.maximize();
...
window.app_saku2_report_gaji_flGajiPphPol.extend(window.childForm);
window.app_saku2_report_gaji_flGajiPphPol.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_saku2_gaji_rptGajiPphPol";
