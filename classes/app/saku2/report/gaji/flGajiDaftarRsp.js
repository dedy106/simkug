window.app_saku2_report_gaji_flGajiDaftarRsp = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gaji_flGajiDaftarRsp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gaji_flGajiDaftarRsp";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,3,[0,1,2],["Lokasi Kerja","All",""]);
	this.gridLib.SGEditData(this.sg1,4,[0,1,2],["NIK","All",""]);
	this.gridLib.SGEditData(this.sg1,5,[0,1,2],["No Gaji","=",this.no_gaji]);
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku2_report_gaji_flGajiDaftarRsp.extend(window.childForm);
window.app_saku2_report_gaji_flGajiDaftarRsp.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row == 3)
			{
				this.filterRep.ListDataSGFilter(this, "Data Loker",this.sg1, this.sg1.row, this.sg1.col,
													"select a.kode_loker, a.nama from hr_loker a where a.kode_lokasi = '"+this.app._lokasi+"' ",
													"select count(*) from hr_loker a where a.kode_lokasi = '"+this.app._lokasi+"' ",
	...
	doSelectCell: function(sender, col, row){		
		...
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5],["3","123i","123i","123i","123i","3"]);
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5],[0,0,2,2,2,2]);
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_saku2_gaji_rptGajiDaftarRsp";
