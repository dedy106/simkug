window.app_saku2_report_gaji_flGajiRekap = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gaji_flGajiRekap.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gaji_flGajiRekap";
		this.maximize();
...
window.app_saku2_report_gaji_flGajiRekap.extend(window.childForm);
window.app_saku2_report_gaji_flGajiRekap.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_saku2_gaji_rptGajiRekap";
