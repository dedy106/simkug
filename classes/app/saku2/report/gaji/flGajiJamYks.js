window.app_saku2_report_gaji_flGajiJamYks = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gaji_flGajiJamYks.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gaji_flGajiJamYks";
		this.maximize();
...
window.app_saku2_report_gaji_flGajiJamYks.extend(window.childForm);
window.app_saku2_report_gaji_flGajiJamYks.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_saku2_gaji_rptGajiJamYks";
