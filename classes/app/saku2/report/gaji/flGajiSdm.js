window.app_saku2_report_gaji_flGajiSdm = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gaji_flGajiSdm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gaji_flGajiSdm";
		this.maximize();
...
window.app_saku2_report_gaji_flGajiSdm.extend(window.childForm);
window.app_saku2_report_gaji_flGajiSdm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_gaji_rptGajiSdm";
			...
			systemAPI.alert("[app_saku2_report_gaji_flGajiSdm]::mainButtonClick:"+e);
		}
	},
