window.app_saku2_report_gaji_flGajiThrPol = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gaji_flGajiThrPol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gaji_flGajiThrPol";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan THR", 2);
...
window.app_saku2_report_gaji_flGajiThrPol.extend(window.childForm);
window.app_saku2_report_gaji_flGajiThrPol.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_saku2_gaji_rptGajiThrPol";
