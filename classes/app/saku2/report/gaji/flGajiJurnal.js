window.app_saku2_report_gaji_flGajiJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gaji_flGajiJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gaji_flGajiJurnal";
		this.maximize();
...
window.app_saku2_report_gaji_flGajiJurnal.extend(window.childForm);
window.app_saku2_report_gaji_flGajiJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_gaji_rptGajiJurnal";
			...
			systemAPI.alert("[app_saku2_report_gaji_flGajiJurnal]::mainButtonClick:"+e);
		}
	},
