window.app_saku2_report_gaji_flGajiLampiranPol = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gaji_flGajiLampiranPol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gaji_flGajiLampiranPol";
		this.maximize();
...
window.app_saku2_report_gaji_flGajiLampiranPol.extend(window.childForm);
window.app_saku2_report_gaji_flGajiLampiranPol.implement({
	...
	doSelectCell: function(sender, col, row){		
		...
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5],["3","123i","123i","123i","123","3"]);
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					if (this.sg1.getCell(2,5)=="MANDIRI")
					{
						this.nama_report = "server_report_saku2_gaji_rptGajiLampiranMan";
						
					}
					else
					{
						this.nama_report = "server_report_saku2_gaji_rptGajiLampiranNon";
					}
