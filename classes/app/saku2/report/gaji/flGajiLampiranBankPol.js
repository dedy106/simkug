window.app_saku2_report_gaji_flGajiLampiranBankPol = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gaji_flGajiLampiranBankPol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gaji_flGajiLampiranBankPol";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,5,[0,1,2],["Jenis Transfer","=","MANDIRI"]);
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku2_report_gaji_flGajiLampiranBankPol.extend(window.childForm);
window.app_saku2_report_gaji_flGajiLampiranBankPol.implement({
		...
		try{			
			...
			if (row == 3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Karyawan",this.sg1, this.sg1.row, this.sg1.col,
													"select a.nik, a.nama from hr_karyawan a "+filter,
													"select count(*) from hr_karyawan a "+filter,
	...
	doSelectCell: function(sender, col, row){		
		...
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5],["3","123i","123i","123i","3","3"]);
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1,2,3,4,5],[0,0,2,2,0,0]);
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("MANDIRI","NON"));
		}
	},
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					var jenis_bank=" and a.jenis_bank='NON' "
					if (this.sg1.getCell(2,5)=="MANDIRI")
					{
						jenis_bank=" and a.jenis_bank='MANDIRI' "
					}
					this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
								...
								this.filterRep.filterStr("a.nik",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and")+jenis_bank;
					...
					if (this.sg1.getCell(2,5)=="MANDIRI")
					{
						this.nama_report = "server_report_saku2_gaji_rptGajiLampiranBankMan";
						
					}
					else
					{
						this.nama_report = "server_report_saku2_gaji_rptGajiLampiranBankNonMan";
					}
