window.app_saku2_report_gaji_flGajiPph = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gaji_flGajiPph.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gaji_flGajiPph";
		this.maximize();
...
window.app_saku2_report_gaji_flGajiPph.extend(window.childForm);
window.app_saku2_report_gaji_flGajiPph.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_saku2_gaji_rptGajiPph";
