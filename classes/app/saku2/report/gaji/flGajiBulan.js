window.app_saku2_report_gaji_flGajiBulan = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gaji_flGajiBulan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gaji_flGajiBulan";
		this.maximize();
...
window.app_saku2_report_gaji_flGajiBulan.extend(window.childForm);
window.app_saku2_report_gaji_flGajiBulan.implement({
	...
	doSelectCell: function(sender, col, row){		
		...
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3],["3","123i","123i","123i"]);
			...
			else
			{
				...
				else
				{
					...
					this.filter = this.filterRep.filterStr("x.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
								...
								this.filterRep.filterStr("y.sts_sdm",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
								this.filterRep.filterStr("x.nik",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and");
						
					this.filter2 = this.sg1.getCell(2,1)+"/";
					this.showFilter = this.filterRep.showFilter(this.sg1);
					var result  = new arrayMap();		
					this.lokasi=this.app._namalokasi;
					this.nama_report = "server_report_saku2_gaji_rptGajiBulan";
	...
	doOpenGaji: function(no_bukti,kode_lokasi){
		this.link="1";
		filter = "where b.nik='"+no_bukti+"' and b.periode='"+this.sg1.getCell(2,1)+"' ";
		filter2=this.sg1.getCell(2,1)+"/";
		nama_report="server_report_hris_rptGajiRekap";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());

	},
	doOpenKaryawan: function(nik,kode_lokasi){
		this.link="1";
		filter = "where a.nik='"+nik+"' and a.periode='"+this.sg1.getCell(2,1)+"' ";
