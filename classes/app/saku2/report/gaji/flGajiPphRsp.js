window.app_saku2_report_gaji_flGajiPphRsp = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gaji_flGajiPphRsp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gaji_flGajiPphRsp";
		this.maximize();
...
window.app_saku2_report_gaji_flGajiPphRsp.extend(window.childForm);
window.app_saku2_report_gaji_flGajiPphRsp.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_saku2_gaji_rptGajiPphRsp";
