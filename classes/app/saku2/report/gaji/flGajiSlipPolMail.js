window.app_saku2_report_gaji_flGajiSlipPolMail = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gaji_flGajiSlipPolMail.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gaji_flGajiSlipPolMail";
		this.maximize();
...
window.app_saku2_report_gaji_flGajiSlipPolMail.extend(window.childForm);
window.app_saku2_report_gaji_flGajiSlipPolMail.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_saku2_gaji_rptGajiSlipPolMail";
