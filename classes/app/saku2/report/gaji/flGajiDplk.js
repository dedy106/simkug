window.app_saku2_report_gaji_flGajiDplk = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gaji_flGajiDplk.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gaji_flGajiDplk";
		this.maximize();
...
window.app_saku2_report_gaji_flGajiDplk.extend(window.childForm);
window.app_saku2_report_gaji_flGajiDplk.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_saku2_gaji_rptGajiDplk";
