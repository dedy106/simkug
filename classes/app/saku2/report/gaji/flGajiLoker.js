window.app_saku2_report_gaji_flGajiLoker = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gaji_flGajiLoker.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gaji_flGajiLoker";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,[0,1,2],["Lokasi Kerja","All",""]);
	
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku2_report_gaji_flGajiLoker.extend(window.childForm);
window.app_saku2_report_gaji_flGajiLoker.implement({
		...
		try{			
			...
			if (row == 2)
			{
				this.filterRep.ListDataSGFilter(this, "Data Lokasi Kerja",this.sg1, this.sg1.row, this.sg1.col,
													...
													"select count(*) from hr_loker  where kode_lokasi = '"+this.app._lokasi+"' ",
													["kode_loker","nama"],"and",["Status","Keterangan"], false, this.sg1.cells(1,row) == "in");
			}
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_saku2_gaji_rptGajiLoker";
