window.app_saku2_report_gaji_flGajiJamsos = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gaji_flGajiJamsos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gaji_flGajiJamsos";
		this.maximize();
...
window.app_saku2_report_gaji_flGajiJamsos.extend(window.childForm);
window.app_saku2_report_gaji_flGajiJamsos.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_saku2_gaji_rptGajiJamsos";
