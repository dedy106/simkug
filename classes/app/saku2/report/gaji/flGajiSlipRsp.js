window.app_saku2_report_gaji_flGajiSlipRsp = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gaji_flGajiSlipRsp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gaji_flGajiSlipRsp";
		this.maximize();
...
window.app_saku2_report_gaji_flGajiSlipRsp.extend(window.childForm);
window.app_saku2_report_gaji_flGajiSlipRsp.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_saku2_gaji_rptGajiSlipRsp";
