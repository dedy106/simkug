window.app_saku2_report_gaji_flGajiJurnalYks = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gaji_flGajiJurnalYks.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gaji_flGajiJurnalYks";
		this.maximize();
...
window.app_saku2_report_gaji_flGajiJurnalYks.extend(window.childForm);
window.app_saku2_report_gaji_flGajiJurnalYks.implement({
		...
		try{			
			...
			if (row ==2)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Jurnal",this.sg1, this.sg1.row, this.sg1.col,
												...
												"select count(a.no_gaji) from hr_gaji_m a "+filter,
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from hr_gaji_m where kode_lokasi='"+this.app._lokasi+"' order by periode",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_gaji_rptGajiJurnalYks";
			...
			systemAPI.alert("[app_saku2_report_gaji_flGajiJurnalYks]::mainButtonClick:"+e);
		}
	},
	...
	doOpenBayar: function(no_bukti,kode_lokasi){
		...
		this.link="1";
		filter = "where a.no_gaji='"+no_bukti+"' and a.kode_lokasi='"+kode_lokasi+"' ";
		filter2="";
