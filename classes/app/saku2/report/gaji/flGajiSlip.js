window.app_saku2_report_gaji_flGajiSlip = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gaji_flGajiSlip.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gaji_flGajiSlip";
		this.maximize();
...
window.app_saku2_report_gaji_flGajiSlip.extend(window.childForm);
window.app_saku2_report_gaji_flGajiSlip.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_saku2_gaji_rptGajiSlip";
