window.app_saku2_report_gaji_flGajiPphYks = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gaji_flGajiPphYks.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gaji_flGajiPphYks";
		this.maximize();
...
window.app_saku2_report_gaji_flGajiPphYks.extend(window.childForm);
window.app_saku2_report_gaji_flGajiPphYks.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_saku2_gaji_rptGajiPphYks";
