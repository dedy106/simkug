window.app_saku2_report_gaji_flGajiDplkPol = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gaji_flGajiDplkPol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gaji_flGajiDplkPol";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,[0,1,2],["Status Pegawai","=","1"]);
...
window.app_saku2_report_gaji_flGajiDplkPol.extend(window.childForm);
window.app_saku2_report_gaji_flGajiDplkPol.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_saku2_gaji_rptGajiDplkPol";
