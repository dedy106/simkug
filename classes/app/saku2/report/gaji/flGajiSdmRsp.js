window.app_saku2_report_gaji_flGajiSdmRsp = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gaji_flGajiSdmRsp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gaji_flGajiSdmRsp";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,1,[0,1,2],["Loker","All",""]);
...
window.app_saku2_report_gaji_flGajiSdmRsp.extend(window.childForm);
window.app_saku2_report_gaji_flGajiSdmRsp.implement({
		...
		try{			
			...
			if (row ==1)
			{
				this.filterRep.ListDataSGFilter(this, "Data Loker",this.sg1, this.sg1.row, this.sg1.col,
												...
												new Array("kode_loker","nama"),"where",new Array("kode","nama"));
			}
			if (row == 2)
			{
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_gaji_rptGajiSdmRsp";
			...
			systemAPI.alert("[app_saku2_report_gaji_flGajiSdmRsp]::mainButtonClick:"+e);
		}
	},
