window.app_saku2_report_tak_flTakTerima = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_tak_flTakTerima.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_tak_flTakTerima";
		this.maximize();
...
window.app_saku2_report_tak_flTakTerima.extend(window.childForm);
window.app_saku2_report_tak_flTakTerima.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				{
					this.nama_report = "server_report_saku2_tak_rptTakTerima";
			...
			systemAPI.alert("[app_saku2_report_tak_flTakTerima]::mainButtonClick:"+e);
		}
	},
