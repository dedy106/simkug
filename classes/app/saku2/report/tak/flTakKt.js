window.app_saku2_report_tak_flTakKt = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_tak_flTakKt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_tak_flTakKt";
		this.maximize();
...
window.app_saku2_report_tak_flTakKt.extend(window.childForm);
window.app_saku2_report_tak_flTakKt.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				if (this.sg1.getCell(2,3)=="TAK Kirim")
				{
					this.nama_report = "server_report_saku2_tak_rptTakKirim";
			...
			systemAPI.alert("[app_saku2_report_tak_flTakKt]::mainButtonClick:"+e);
		}
	},
