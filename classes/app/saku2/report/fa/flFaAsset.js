window.app_saku2_report_fa_flFaAsset = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_fa_flFaAsset.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_fa_flFaAsset";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,[0,1,2], ["Jenis Laporan","=","Asset"]);
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku2_report_fa_flFaAsset.extend(window.childForm);
window.app_saku2_report_fa_flFaAsset.implement({
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4],["3","236","123","123","3"]);
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,["Akun","Asset"]);
		}
		...
		try
		{
			...
			else
			{
		    	...
		    	this.filter=this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("a.kode_klpakun",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
							this.filterRep.filterStr("a.no_fa",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and");
				this.filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(3,1)+"/"+this.sg1.getCell(1,1);
