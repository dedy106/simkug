window.app_saku2_report_fa_flFaLokasi = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_fa_flFaLokasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_fa_flFaLokasi";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Lokasi","All",""));
	
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku2_report_fa_flFaLokasi.extend(window.childForm);
window.app_saku2_report_fa_flFaLokasi.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row == 2)
			{
				var sql1="select kode_lokfa,nama from fa_lokasi "+
						 this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
						 "   ";
				var sql2="select count(kode_lokfa) from fa_lokasi "+
						 this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where");
				
				this.filterRep.ListDataSGFilter(this, "Data Lokasi",this.sg1, this.sg1.row, this.sg1.col,sql1,sql2,new Array("kode_lokfa","Nama"),"and");
			}
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select a.periode "+
									...
									"	 )a "+
									"order by a.periode desc",[this.sg1.columns.get(2).pickList]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_fa_rptFaLokasi";
	...
	doOpenAsset: function(kode_akun,kode_lokasi){
		...
		filter=" where a.kode_lokfa='"+kode_akun+"' and a.kode_lokasi='"+kode_lokasi+"'";
		nama_report="server_report_saku2_fa_rptFaAssetTrail";
