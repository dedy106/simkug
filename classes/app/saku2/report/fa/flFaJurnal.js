window.app_saku2_report_fa_flFaJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_fa_flFaJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_fa_flFaJurnal";
		this.maximize();
...
window.app_saku2_report_fa_flFaJurnal.extend(window.childForm);
window.app_saku2_report_fa_flFaJurnal.implement({
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("a.no_fasusut",this.sg1.getCell(1,5),this.sg1.getCell(2,5),this.sg1.getCell(3,5),"and");
				this.filter2=this.sg1.getCell(2,1)+"/";
				this.nama_report="server_report_saku2_fa_rptFaJurnal";
				if (this.sg1.getCell(2,3)=="Memo Jurnal")
				{
					this.nama_report="server_report_saku2_fa_rptFaBuktiJurnal";
				}
