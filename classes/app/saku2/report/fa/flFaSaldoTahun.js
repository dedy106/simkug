window.app_saku2_report_fa_flFaSaldoTahun = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_fa_flFaSaldoTahun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_fa_flFaSaldoTahun";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,3,[0,1,2], ["Periode","<=",this.periode]);
	
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_saku2_report_fa_flFaSaldoTahun.extend(window.childForm);
window.app_saku2_report_fa_flFaSaldoTahun.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_fa_rptFaSaldoTahun";
	...
	doOpenAsset: function(kode_akun,kode_lokasi,tahun){
		...
		nama_report="server_report_saku2_fa_rptFaAsset";
