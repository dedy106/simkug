window.app_saku2_report_investasi_flPsSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_investasi_flPsSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_investasi_flPsSaldo";
		this.maximize();
...
window.app_saku2_report_investasi_flPsSaldo.extend(window.childForm);
window.app_saku2_report_investasi_flPsSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_investasi_rptPsSaldo";
			...
			systemAPI.alert("[app_saku2_report_investasi_flPsSaldo]::mainButtonClick:"+e);
		}
	},
