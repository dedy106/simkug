window.app_saku2_report_investasi_flSahamBeli = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_investasi_flSahamBeli.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_investasi_flSahamBeli";
		this.maximize();
...
window.app_saku2_report_investasi_flSahamBeli.extend(window.childForm);
window.app_saku2_report_investasi_flSahamBeli.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_investasi_rptSahamBeli";
				if (this.sg1.getCell(2,4)=="Detail")
				{
					this.nama_report = "server_report_saku2_investasi_rptSahamBeliDetail";
				}
			...
			systemAPI.alert("[app_saku2_report_investasi_flSahamBeli]::mainButtonClick:"+e);
		}
	},
