window.app_saku2_report_investasi_flRekapAsset = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_investasi_flRekapAsset.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_investasi_flRekapAsset";
		this.maximize();
...
window.app_saku2_report_investasi_flRekapAsset.extend(window.childForm);
window.app_saku2_report_investasi_flRekapAsset.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_saku2_investasi_rptRekapAsset";
