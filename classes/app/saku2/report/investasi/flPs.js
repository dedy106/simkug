window.app_saku2_report_investasi_flPs = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_investasi_flPs.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_investasi_flPs";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,0,new Array(0,1,2), new Array("Kode Saham","All",""));
...
window.app_saku2_report_investasi_flPs.extend(window.childForm);
window.app_saku2_report_investasi_flPs.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_mitra",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where");
				this.filter2 = this.sg1.getCell(2,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku2_investasi_rptPs";
			...
			systemAPI.alert("[app_saku2_report_investasi_flPs]::mainButtonClick:"+e);
		}
	},
