window.app_saku2_report_investasi_flRdBeli = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_investasi_flRdBeli.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_investasi_flRdBeli";
		this.maximize();
...
window.app_saku2_report_investasi_flRdBeli.extend(window.childForm);
window.app_saku2_report_investasi_flRdBeli.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_investasi_rptRdBeli";
			...
			systemAPI.alert("[app_saku2_report_investasi_flRdBeli]::mainButtonClick:"+e);
		}
	},
