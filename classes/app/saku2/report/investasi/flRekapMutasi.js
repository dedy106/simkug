window.app_saku2_report_investasi_flRekapMutasi = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_investasi_flRekapMutasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_investasi_flRekapMutasi";
		this.maximize();
...
window.app_saku2_report_investasi_flRekapMutasi.extend(window.childForm);
window.app_saku2_report_investasi_flRekapMutasi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_saku2_investasi_rptRekapMutasi";
