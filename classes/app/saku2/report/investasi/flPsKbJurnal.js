window.app_saku2_report_investasi_flPsKbJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_investasi_flPsKbJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_investasi_flPsKbJurnal";
		this.maximize();
...
window.app_saku2_report_investasi_flPsKbJurnal.extend(window.childForm);
window.app_saku2_report_investasi_flPsKbJurnal.implement({
