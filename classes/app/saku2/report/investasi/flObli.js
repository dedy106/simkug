window.app_saku2_report_investasi_flObli = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_investasi_flObli.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_investasi_flObli";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,0,new Array(0,1,2), new Array("Kode Jenis","All",""));
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Kode Obligasi","All",""));
...
window.app_saku2_report_investasi_flObli.extend(window.childForm);
window.app_saku2_report_investasi_flObli.implement({
			...
			if (row == 1)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Saham",this.sg1, this.sg1.row, this.sg1.col,
														  "select kode_jenis, nama from inv_oblijenis "+
														   this.filterRep.filterStr("kode_obligor",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_obligor",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
				...
				this.nama_report = "server_report_saku2_investasi_rptObli";
			...
			systemAPI.alert("[app_saku2_report_investasi_flObli]::mainButtonClick:"+e);
		}
	},
