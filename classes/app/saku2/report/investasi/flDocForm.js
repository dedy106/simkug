window.app_saku2_report_investasi_flDocForm = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_investasi_flDocForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_investasi_flDocForm";
		this.maximize();
...
window.app_saku2_report_investasi_flDocForm.extend(window.childForm);
window.app_saku2_report_investasi_flDocForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_investasi_rptDocForm";
			...
			systemAPI.alert("[app_saku2_report_investasi_flDocForm]::mainButtonClick:"+e);
		}
	},
