window.app_saku2_report_investasi_flDakemForm = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_investasi_flDakemForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_investasi_flDakemForm";
		this.maximize();
...
window.app_saku2_report_investasi_flDakemForm.extend(window.childForm);
window.app_saku2_report_investasi_flDakemForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_investasi_rptDakemForm";
			...
			systemAPI.alert("[app_saku2_report_investasi_flDakemForm]::mainButtonClick:"+e);
		}
	},
