window.app_saku2_report_investasi_flRdJual = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_investasi_flRdJual.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_investasi_flRdJual";
		this.maximize();
...
window.app_saku2_report_investasi_flRdJual.extend(window.childForm);
window.app_saku2_report_investasi_flRdJual.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_investasi_rptRdJual";
				if (this.sg1.getCell(2,4)=="Detail")
				{
					this.nama_report = "server_report_saku2_investasi_rptRdJualDetail";
				}
			...
			systemAPI.alert("[app_saku2_report_investasi_flRdJual]::mainButtonClick:"+e);
		}
	},
