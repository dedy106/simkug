window.app_saku2_report_investasi_flSahamSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_investasi_flSahamSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_investasi_flSahamSaldo";
		this.maximize();
...
window.app_saku2_report_investasi_flSahamSaldo.extend(window.childForm);
window.app_saku2_report_investasi_flSahamSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_investasi_rptSahamSaldo";
			...
			systemAPI.alert("[app_saku2_report_investasi_flSahamSaldo]::mainButtonClick:"+e);
		}
	},
