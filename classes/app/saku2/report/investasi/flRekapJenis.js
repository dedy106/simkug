window.app_saku2_report_investasi_flRekapJenis = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_investasi_flRekapJenis.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_investasi_flRekapJenis";
		this.maximize();
...
window.app_saku2_report_investasi_flRekapJenis.extend(window.childForm);
window.app_saku2_report_investasi_flRekapJenis.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_saku2_investasi_rptRekapJenis";
