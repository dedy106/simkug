window.app_saku2_report_investasi_flSaham = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_investasi_flSaham.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_investasi_flSaham";
		this.maximize();
...
window.app_saku2_report_investasi_flSaham.extend(window.childForm);
window.app_saku2_report_investasi_flSaham.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_saham",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where");
				this.filter2 = this.sg1.getCell(2,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku2_investasi_rptSaham";
			...
			systemAPI.alert("[app_saku2_report_investasi_flSaham]::mainButtonClick:"+e);
		}
	},
