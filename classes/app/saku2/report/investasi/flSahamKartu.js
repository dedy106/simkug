window.app_saku2_report_investasi_flSahamKartu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_investasi_flSahamKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_investasi_flSahamKartu";
		this.maximize();
...
window.app_saku2_report_investasi_flSahamKartu.extend(window.childForm);
window.app_saku2_report_investasi_flSahamKartu.implement({
		...
		try{			
			...
			if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Penempatan",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_depo, a.keterangan from inv_shmbeli_m a "+filter,
												"select count(a.no_depo) from inv_shmbeli_m a "+filter,
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2 = this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+"kartu";
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku2_investasi_rptSahamKartu";
			...
			systemAPI.alert("[app_saku2_report_investasi_flSahamKartu]::mainButtonClick:"+e);
		}
	},
