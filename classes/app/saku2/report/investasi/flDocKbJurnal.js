window.app_saku2_report_investasi_flDocKbJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_investasi_flDocKbJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_investasi_flDocKbJurnal";
		this.maximize();
...
window.app_saku2_report_investasi_flDocKbJurnal.extend(window.childForm);
window.app_saku2_report_investasi_flDocKbJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_saku2_investasi_rptDocKbJurnal";
