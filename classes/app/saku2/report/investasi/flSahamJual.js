window.app_saku2_report_investasi_flSahamJual = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_investasi_flSahamJual.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_investasi_flSahamJual";
		this.maximize();
...
window.app_saku2_report_investasi_flSahamJual.extend(window.childForm);
window.app_saku2_report_investasi_flSahamJual.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_investasi_rptSahamJual";
				if (this.sg1.getCell(2,4)=="Detail")
				{
					this.nama_report = "server_report_saku2_investasi_rptSahamJualDetail";
				}
			...
			systemAPI.alert("[app_saku2_report_investasi_flSahamJual]::mainButtonClick:"+e);
		}
	},
