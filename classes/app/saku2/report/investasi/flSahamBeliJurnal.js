window.app_saku2_report_investasi_flSahamBeliJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_investasi_flSahamBeliJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_investasi_flSahamBeliJurnal";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from inv_shmbeli_m where kode_lokasi='"+this.app._lokasi+"'");
...
window.app_saku2_report_investasi_flSahamBeliJurnal.extend(window.childForm);
window.app_saku2_report_investasi_flSahamBeliJurnal.implement({
		...
		try{			
			...
			if (row == 2)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Jurnal",this.sg1, this.sg1.row, this.sg1.col,
														  "select no_shmbeli, keterangan from inv_shmbeli_m  "+filter ,
														  "select count(no_shmbeli) from inv_shmbeli_m "+filter,
														  new Array("no_shmbeli","keterangan"),"and");
			}
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+
							...
							this.filterRep.filterStr("a.no_shmbeli",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2)," and ");
				this.filter2=this.sg1.getCell(2,1);
				this.nama_report="server_report_saku2_investasi_rptSahamBeliJurnal";
