window.app_saku2_report_investasi_flSahamDeviden = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_investasi_flSahamDeviden.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_investasi_flSahamDeviden";
		this.maximize();
...
window.app_saku2_report_investasi_flSahamDeviden.extend(window.childForm);
window.app_saku2_report_investasi_flSahamDeviden.implement({
		...
		try{			
			...
			if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Penjualan",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_shmdev, a.keterangan from inv_shmdev_m a "+filter,
												"select count(a.no_shmdev) from inv_shmdev_m a "+filter,
												new Array("a.no_shmdev","a.keterangan"),"and",new Array("No Bukti","Keterangan"));
			}
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
							this.filterRep.filterStr("b.kode_kelola",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
							this.filterRep.filterStr("a.no_shmdev",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and");
				this.filter2 = this.sg1.getCell(2,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku2_investasi_rptSahamDeviden";
				if (this.sg1.getCell(2,4)=="Detail")
				{
					this.nama_report = "server_report_saku2_investasi_rptSahamDevidenDetail";
				}
			...
			systemAPI.alert("[app_saku2_report_investasi_flSahamDeviden]::mainButtonClick:"+e);
		}
	},
	...
	doOpenBayar: function(no_bukti,kode_lokasi){
		...
		this.link="1";
		filter = "where a.no_shmdev='"+no_bukti+"' and a.kode_lokasi='"+kode_lokasi+"' ";
		filter2="";
