window.app_saku2_report_investasi_flDoc = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_investasi_flDoc.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_investasi_flDoc";
		this.maximize();
...
window.app_saku2_report_investasi_flDoc.extend(window.childForm);
window.app_saku2_report_investasi_flDoc.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_investasi_rptDoc";
			...
			systemAPI.alert("[app_saku2_report_investasi_flDoc]::mainButtonClick:"+e);
		}
	},
