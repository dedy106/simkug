window.app_saku2_report_investasi_flSahamKbJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_investasi_flSahamKbJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_investasi_flSahamKbJurnal";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from kas_m where kode_lokasi='"+this.app._lokasi+"' and modul like 'KBDOC%'");
...
window.app_saku2_report_investasi_flSahamKbJurnal.extend(window.childForm);
window.app_saku2_report_investasi_flSahamKbJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_saku2_investasi_rptSahamKbJurnal";
