window.app_saku2_report_investasi_flDocPinbukForm = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_investasi_flDocPinbukForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_investasi_flDocPinbukForm";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from kas_m where modul='KBPB' ");
...
window.app_saku2_report_investasi_flDocPinbukForm.extend(window.childForm);
window.app_saku2_report_investasi_flDocPinbukForm.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row ==3)
			{
				filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"and")+
							this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");
							this.filterRep.filterStr("b.kode_bank",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
				this.filterRep.ListDataSGFilter(this, "Data Pemindabukuan",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_kas,a.keterangan  "+
												"from kas_m a "+
												"inner join inv_kas_add b on a.no_kas=b.no_kas and a.kode_lokasi=b.kode_lokasi "+
												"where modul='KBPB' "+filter,
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_investasi_rptDocPinbukForm";
			...
			systemAPI.alert("[app_saku2_report_investasi_flDocPinbukForm]::mainButtonClick:"+e);
		}
	},
