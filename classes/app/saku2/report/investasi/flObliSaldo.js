window.app_saku2_report_investasi_flObliSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_investasi_flObliSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_investasi_flObliSaldo";
		this.maximize();
...
window.app_saku2_report_investasi_flObliSaldo.extend(window.childForm);
window.app_saku2_report_investasi_flObliSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_investasi_rptObliSaldo";
			...
			systemAPI.alert("[app_saku2_report_investasi_flObliSaldo]::mainButtonClick:"+e);
		}
	},
