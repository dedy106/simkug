window.app_saku2_report_investasi_flRd = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_investasi_flRd.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_investasi_flRd";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,0,new Array(0,1,2), new Array("Kode Kelompok","All",""));
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Kode Reksa Dana","All",""));
...
window.app_saku2_report_investasi_flRd.extend(window.childForm);
window.app_saku2_report_investasi_flRd.implement({
			...
			if (row == 1)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Saham",this.sg1, this.sg1.row, this.sg1.col,
														  "select kode_rd, nama from inv_rd "+
														   this.filterRep.filterStr("kode_rdklp",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  "select count(kode_rd) from inv_rd "+
														  this.filterRep.filterStr("kode_rdklp",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
														  new Array("kode_rd","nama"),"and");
			}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			{
				this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("Kode Saham","All",""));
			}else{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_rdklp",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("a.kode_rd",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");
				this.filter2 = this.sg1.getCell(2,1);
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new arrayMap();		
				this.nama_report = "server_report_saku2_investasi_rptRd";
			...
			systemAPI.alert("[app_saku2_report_investasi_flRd]::mainButtonClick:"+e);
		}
	},
