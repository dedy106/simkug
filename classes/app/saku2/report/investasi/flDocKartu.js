window.app_saku2_report_investasi_flDocKartu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_investasi_flDocKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_investasi_flDocKartu";
		this.maximize();
...
window.app_saku2_report_investasi_flDocKartu.extend(window.childForm);
window.app_saku2_report_investasi_flDocKartu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_investasi_rptDocKartu";
			...
			systemAPI.alert("[app_saku2_report_investasi_flDocKartu]::mainButtonClick:"+e);
		}
	},
