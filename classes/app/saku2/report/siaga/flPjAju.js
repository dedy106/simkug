window.app_saku2_report_siaga_flPjAju = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flPjAju.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flPjAju";
		this.maximize();
...
window.app_saku2_report_siaga_flPjAju.extend(window.childForm);
window.app_saku2_report_siaga_flPjAju.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_siaga_flPjAju]::mainButtonClick:"+e);
		}
	},
