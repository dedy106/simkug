window.app_saku2_report_siaga_flAgg = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flAgg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flAgg";
		this.maximize();
...
window.app_saku2_report_siaga_flAgg.extend(window.portalui_childForm);
window.app_saku2_report_siaga_flAgg.implement({
