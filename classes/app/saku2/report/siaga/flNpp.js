window.app_saku2_report_siaga_flNpp = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flNpp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flNpp";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from gr_npp_m where kode_lokasi='"+this.app._lokasi+"'");
...
window.app_saku2_report_siaga_flNpp.extend(window.childForm);
window.app_saku2_report_siaga_flNpp.implement({
