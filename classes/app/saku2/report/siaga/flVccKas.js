window.app_saku2_report_siaga_flVccKas = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flVccKas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flVccKas";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from kas_m where kode_lokasi='"+this.app._lokasi+"' and modul in ('KBVCC','KBVCC2')");
...
window.app_saku2_report_siaga_flVccKas.extend(window.childForm);
window.app_saku2_report_siaga_flVccKas.implement({
