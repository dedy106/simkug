// JavaScript Document
window.app_saku2_report_siaga_flNeraca = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flNeraca.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flNeraca";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,6,new Array(0,1,2), new Array("Tanda Tangan","=","Tidak"));
...
window.app_saku2_report_siaga_flNeraca.extend(window.portalui_childForm);
window.app_saku2_report_siaga_flNeraca.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,new Array(0,1,2,3,4,5,6),new  Array("123","1234","123","3","3","3","3"));
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,new Array(0,1,2,3,4,5,6),new  Array(2,0,2,0,0,0,0));
		}
		else
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,new Array(0,1,2,3,4,5,6),new  Array("3","1234","123","3","3","3","3"));
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,new Array(0,1,2,3,4,5,6),new  Array(3,0,2,0,0,0,0));
		}
		if (row == 1)
		{
			if (this.app._kodeLokasiKonsol==this.app._lokasi)
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				{
					in_lap="K";
					this.nama_report="server_report_saku2_gl_rptNeraca";
				}
				else
				{
					this.nama_report="server_report_saku2_gl_rptNeracaStafel";
				}
				this.filter2 = this.nik_user+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,3)+"/"+this.sg1.getCell(2,5)+"/"+this.app._namaForm+"/"+this.kode_lokasi+"/"+this.sg1.getCell(2,6);
