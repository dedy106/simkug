window.app_saku2_report_siaga_flStrukturKeuangan = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flStrukturKeuangan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flStrukturKeuangan";
		this.maximize();
...
window.app_saku2_report_siaga_flStrukturKeuangan.extend(window.childForm);
window.app_saku2_report_siaga_flStrukturKeuangan.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_siaga_rptStrukturKeuangan";
			...
			systemAPI.alert("[app_saku2_report_siaga_flStrukturKeuangan]::mainButtonClick:"+e);
		}
	},
