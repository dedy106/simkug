window.app_saku2_report_siaga_flGlJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flGlJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flGlJurnal";
		this.maximize();
...
window.app_saku2_report_siaga_flGlJurnal.extend(window.childForm);
window.app_saku2_report_siaga_flGlJurnal.implement({
