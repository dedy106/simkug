window.app_saku2_report_siaga_flVccAging = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flVccAging.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flVccAging";
		this.maximize();
...
window.app_saku2_report_siaga_flVccAging.extend(window.childForm);
window.app_saku2_report_siaga_flVccAging.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_siaga_rptVccAging";
			...
			systemAPI.alert("[app_saku2_report_siaga_flVccAging]::mainButtonClick:"+e);
		}
	},
