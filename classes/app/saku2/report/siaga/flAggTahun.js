window.app_saku2_report_siaga_flAggTahun = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flAggTahun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flAggTahun";
		this.maximize();
...
window.app_saku2_report_siaga_flAggTahun.extend(window.portalui_childForm);
window.app_saku2_report_siaga_flAggTahun.implement({
		...
		try
		{
			...
			else
			{
				...
				if (this.sg1.getCell(2,4)=="Bulanan")
				{
					...
					this.nama_report="server_report_saku2_siaga_rptAggRealBulan";
				}
