window.app_saku2_report_siaga_flHutangSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flHutangSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flHutangSaldo";
		this.maximize();
...
window.app_saku2_report_siaga_flHutangSaldo.extend(window.childForm);
window.app_saku2_report_siaga_flHutangSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_siaga_rptHutangSaldo";
			...
			systemAPI.alert("[app_saku2_report_siaga_flHutangSaldo]::mainButtonClick:"+e);
		}
	},
