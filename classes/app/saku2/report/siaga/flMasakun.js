window.app_saku2_report_siaga_flMasakun = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flMasakun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flMasakun";
		this.maximize();
...
window.app_saku2_report_siaga_flMasakun.extend(window.childForm);
window.app_saku2_report_siaga_flMasakun.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_siaga_rptMasakun";
			...
			systemAPI.alert("[app_saku2_report_siaga_flMasakun]::mainButtonClick:"+e);
		}
	},
