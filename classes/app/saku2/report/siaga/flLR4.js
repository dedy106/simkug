// JavaScript Document
window.app_saku2_report_siaga_flLR4 = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flLR4.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flLR4";
		this.maximize();
...
window.app_saku2_report_siaga_flLR4.extend(window.portalui_childForm);
window.app_saku2_report_siaga_flLR4.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_gl_rptLR4";
