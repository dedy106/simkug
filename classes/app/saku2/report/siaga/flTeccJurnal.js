window.app_saku2_report_siaga_flTeccJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flTeccJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flTeccJurnal";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from gr_tecc_m where kode_lokasi='"+this.app._lokasi+"'");
...
window.app_saku2_report_siaga_flTeccJurnal.extend(window.childForm);
window.app_saku2_report_siaga_flTeccJurnal.implement({
		...
		try{			
			...
			if (row == 2)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Jurnal",this.sg1, this.sg1.row, this.sg1.col,
														  "select no_tecc, keterangan from gr_tecc_m  "+filter ,
														  "select count(no_tecc) from gr_tecc_m "+filter,
														  new Array("no_tecc","keterangan"),"and");
			}
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+
							...
							this.filterRep.filterStr("a.no_tecc",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2)," and ");
				this.filter2=this.sg1.getCell(2,1);
				this.nama_report="server_report_saku2_siaga_rptTeccJurnal";
