// JavaScript Document
window.app_saku2_report_siaga_flLR2 = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flLR2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flLR2";
		this.maximize();
...
window.app_saku2_report_siaga_flLR2.extend(window.portalui_childForm);
window.app_saku2_report_siaga_flLR2.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2 = this.nik_user+"/"+this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,4)+"/"+this.sg1.getCell(2,3)+"/"+this.app._namaForm;
				var in_lap="S";
				if (this.app._kodeLokasiKonsol==this.app._lokasi)
				{
				...
				this.nama_report="server_report_saku2_gl_rptLR2";
