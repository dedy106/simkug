window.app_saku2_report_siaga_flBuktibank = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flBuktibank.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flBuktibank";
		this.maximize();
...
window.app_saku2_report_siaga_flBuktibank.extend(window.childForm);
window.app_saku2_report_siaga_flBuktibank.implement({
