window.app_saku2_report_siaga_flPiutangKartu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flPiutangKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flPiutangKartu";
		this.maximize();
...
window.app_saku2_report_siaga_flPiutangKartu.extend(window.childForm);
window.app_saku2_report_siaga_flPiutangKartu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_siaga_rptPiutangKartu";
			...
			systemAPI.alert("[app_saku2_report_siaga_flPiutangKartu]::mainButtonClick:"+e);
		}
	},
