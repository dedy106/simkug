window.app_saku2_report_siaga_flHutangLogKontrak = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flHutangLogKontrak.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flHutangLogKontrak";
		this.maximize();
...
window.app_saku2_report_siaga_flHutangLogKontrak.extend(window.childForm);
window.app_saku2_report_siaga_flHutangLogKontrak.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_siaga_rptHutangLogKontrak";
			...
			systemAPI.alert("[app_saku2_report_siaga_flHutangLogKontrak]::mainButtonClick:"+e);
		}
	},
