window.app_saku2_report_siaga_flPjBukti = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flPjBukti.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flPjBukti";
		this.maximize();
...
window.app_saku2_report_siaga_flPjBukti.extend(window.childForm);
window.app_saku2_report_siaga_flPjBukti.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from gr_panjar_m where kode_lokasi='"+this.app._lokasi+"' order by periode",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_siaga_flPjBukti]::mainButtonClick:"+e);
		}
	},
