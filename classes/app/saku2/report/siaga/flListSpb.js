window.app_saku2_report_siaga_flListSpb = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flListSpb.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flListSpb";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Daftar Pembayaran SPB", 2);
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from gr_spb_m where kode_lokasi='"+this.app._lokasi+"'");
	...
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("No SPB","All",""));
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("No List","All",""));
...
window.app_saku2_report_siaga_flListSpb.extend(window.childForm);
window.app_saku2_report_siaga_flListSpb.implement({
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4],["123i","123i","123i","123i","123i"]);
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_saku2_siaga_rptListSpb";
