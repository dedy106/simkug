window.app_saku2_report_siaga_flAgg2 = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flAgg2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flAgg2";
		this.maximize();
...
window.app_saku2_report_siaga_flAgg2.extend(window.portalui_childForm);
window.app_saku2_report_siaga_flAgg2.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			{			
				this.nama_report="server_report_saku2_siaga_rptAggTw";
			}
			if (this.sg1.getCell(2,4)=="Semester")
			{
				this.nama_report="server_report_saku2_siaga_rptAggSem";
			}
			if (this.sg1.getCell(2,4)=="Bulanan")
			{
				this.nama_report="server_report_saku2_siaga_rptAggBulan";
			}
