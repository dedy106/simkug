// JavaScript Document
window.app_saku2_report_siaga_flKbSaldoValas = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flKbSaldoValas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flKbSaldoValas";
		this.maximize();
...
window.app_saku2_report_siaga_flKbSaldoValas.extend(window.portalui_childForm);
window.app_saku2_report_siaga_flKbSaldoValas.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_siaga_rptKbSaldoValas";
				this.dbLib.execQuerySync(this.sql);	
	...
	doOpenBb: function(kode_akun,kode_lokasi){
		...
		filter="";
		nama_report="server_report_saku2_siaga_rptBukuKasTrail";
