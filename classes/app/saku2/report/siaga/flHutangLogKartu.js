window.app_saku2_report_siaga_flHutangLogKartu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flHutangLogKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flHutangLogKartu";
		this.maximize();
...
window.app_saku2_report_siaga_flHutangLogKartu.extend(window.childForm);
window.app_saku2_report_siaga_flHutangLogKartu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_siaga_rptHutangLogKartu";
			...
			systemAPI.alert("[app_saku2_report_siaga_flHutangLogKartu]::mainButtonClick:"+e);
		}
	},
