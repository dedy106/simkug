window.app_saku2_report_siaga_flPiutangAging = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flPiutangAging.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flPiutangAging";
		this.maximize();
...
window.app_saku2_report_siaga_flPiutangAging.extend(window.childForm);
window.app_saku2_report_siaga_flPiutangAging.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_siaga_rptPiutangAging";
			...
			systemAPI.alert("[app_saku2_report_siaga_flPiutangAging]::mainButtonClick:"+e);
		}
	},
