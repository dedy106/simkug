window.app_saku2_report_siaga_flBeban = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flBeban.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flBeban";
		this.maximize();
...
window.app_saku2_report_siaga_flBeban.extend(window.childForm);
window.app_saku2_report_siaga_flBeban.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_siaga_flBeban]::mainButtonClick:"+e);
		}
	},
