// JavaScript Document
window.app_saku2_report_siaga_flLRAgg = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flLRAgg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flLRAgg";
		this.maximize();
...
window.app_saku2_report_siaga_flLRAgg.extend(window.portalui_childForm);
window.app_saku2_report_siaga_flLRAgg.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				sql="call sp_neraca_agg ('"+this.sg1.getCell(2,2)+"','L','"+in_lap+"',"+this.sg1.getCell(2,3)+",'"+this.sg1.getCell(2,1)+"','"+this.kode_lokasi+"','"+this.kode_lokasi1+"','"+this.kode_lokasi2+"','"+this.nik_user+"')";
				this.nama_report="server_report_saku2_siaga_rptLRAgg";
	...
	doOpenTb: function(kode_neraca,kode_lokasi){
		...
		filter="";
		var sql = "call sp_glma_trail_tmp ('"+this.sg1.getCell(2,2)+"','"+kode_neraca+"','"+kode_lokasi+"','"+kode_lokasi+"','"+kode_lokasi+"','"+this.sg1.getCell(2,1)+"','"+this.app._nikUser+"')";
	...
	doOpenGar: function(kode_neraca,kode_lokasi,tahun){
		...
		filter2="";
		nama_report="server_report_saku2_siaga_rptAggBulanNeracaTrail";
		this.viewer.useIframe(this.report.previewWithHeader(nama_report,filter, this.page,  this.pager, this.showFilter, this.lokasi,filter2)+"&resource="+ this.resourceId+"&fullId="+this.getFullId());
	},
