window.app_saku2_report_siaga_flPjSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flPjSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flPjSaldo";
		this.maximize();
...
window.app_saku2_report_siaga_flPjSaldo.extend(window.childForm);
window.app_saku2_report_siaga_flPjSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_siaga_rptPjSaldo";
			...
			systemAPI.alert("[app_saku2_report_siaga_flPjSaldo]::mainButtonClick:"+e);
		}
	},
