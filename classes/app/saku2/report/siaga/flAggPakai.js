window.app_saku2_report_siaga_flAggPakai = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flAggPakai.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flAggPakai";
		this.maximize();
...
window.app_saku2_report_siaga_flAggPakai.extend(window.portalui_childForm);
window.app_saku2_report_siaga_flAggPakai.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_siaga_rptAggPakai";
