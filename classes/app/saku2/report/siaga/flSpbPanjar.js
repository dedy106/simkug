window.app_saku2_report_siaga_flSpbPanjar = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flSpbPanjar.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flSpbPanjar";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from gr_spb_m where kode_lokasi='"+this.app._lokasi+"' and jenis='PANJAR' ");
...
window.app_saku2_report_siaga_flSpbPanjar.extend(window.childForm);
window.app_saku2_report_siaga_flSpbPanjar.implement({
