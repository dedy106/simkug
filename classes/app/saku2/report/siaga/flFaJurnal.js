window.app_saku2_report_siaga_flFaJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flFaJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flFaJurnal";
		this.maximize();
...
window.app_saku2_report_siaga_flFaJurnal.extend(window.childForm);
window.app_saku2_report_siaga_flFaJurnal.implement({
		...
		try{			
			...
			if (row == 2)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Jurnal",this.sg1, this.sg1.row, this.sg1.col,
														  "select no_fasusut, keterangan from fasusut_m  "+filter ,
														  "select count(no_fasusut) from fasusut_m "+filter,
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_saku2_siaga_rptFaJurnal";
