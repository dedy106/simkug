window.app_saku2_report_siaga_flHutang = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flHutang.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flHutang";
		this.maximize();
...
window.app_saku2_report_siaga_flHutang.extend(window.childForm);
window.app_saku2_report_siaga_flHutang.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_siaga_rptHutang";
			...
			systemAPI.alert("[app_saku2_report_siaga_flHutang]::mainButtonClick:"+e);
		}
	},
