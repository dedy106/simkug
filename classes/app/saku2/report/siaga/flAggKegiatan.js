window.app_saku2_report_siaga_flAggKegiatan = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flAggKegiatan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flAggKegiatan";
		this.maximize();
...
window.app_saku2_report_siaga_flAggKegiatan.extend(window.portalui_childForm);
window.app_saku2_report_siaga_flAggKegiatan.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku2_siaga_rptAggKegiatan";
