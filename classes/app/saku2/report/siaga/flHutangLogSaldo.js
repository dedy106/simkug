window.app_saku2_report_siaga_flHutangLogSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flHutangLogSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flHutangLogSaldo";
		this.maximize();
...
window.app_saku2_report_siaga_flHutangLogSaldo.extend(window.childForm);
window.app_saku2_report_siaga_flHutangLogSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_siaga_rptHutangLogSaldo";
			...
			systemAPI.alert("[app_saku2_report_siaga_flHutangLogSaldo]::mainButtonClick:"+e);
		}
	},
	...
	doOpenKartu: function(no_bukti,kode_lokasi){
		...
		filter2="";
		nama_report="server_report_saku2_siaga_rptHutangLogKartu";
