window.app_saku2_report_siaga_flBebanJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flBebanJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flBebanJurnal";
		this.maximize();
...
window.app_saku2_report_siaga_flBebanJurnal.extend(window.childForm);
window.app_saku2_report_siaga_flBebanJurnal.implement({
