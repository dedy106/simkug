window.app_saku2_report_siaga_flAggCapai = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flAggCapai.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flAggCapai";
		this.maximize();
...
window.app_saku2_report_siaga_flAggCapai.extend(window.portalui_childForm);
window.app_saku2_report_siaga_flAggCapai.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_siaga_rptAggCapai";
