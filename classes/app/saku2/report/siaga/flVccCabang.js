window.app_saku2_report_siaga_flVccCabang = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flVccCabang.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flVccCabang";
		this.maximize();
...
window.app_saku2_report_siaga_flVccCabang.extend(window.childForm);
window.app_saku2_report_siaga_flVccCabang.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_siaga_rptVccCabang";
			...
			systemAPI.alert("[app_saku2_report_siaga_flVccCabang]::mainButtonClick:"+e);
		}
	},
