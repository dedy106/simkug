// JavaScript Document
window.app_saku2_report_siaga_flGlJurnalAudit = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flGlJurnalAudit.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flGlJurnalAudit";
		this.maximize();
...
window.app_saku2_report_siaga_flGlJurnalAudit.extend(window.portalui_childForm);
window.app_saku2_report_siaga_flGlJurnalAudit.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		this.filterRep.setSGFilterRowTipe(this.sg1, row,new Array(0,1,2,3,4),new  Array("123","123","123","123","3"));
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.filter2 = this.sg1.getCell(2,1)+"/"+this.sg1.getCell(1,1)+"/"+this.sg1.getCell(3,1)+"/"+this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,4);
			this.nama_report="server_report_saku2_siaga_rptGlJurnalAudit";
