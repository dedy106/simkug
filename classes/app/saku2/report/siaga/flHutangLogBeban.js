window.app_saku2_report_siaga_flHutangLogBeban = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flHutangLogBeban.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flHutangLogBeban";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from gr_beban_m where modul='BKON' ");
...
window.app_saku2_report_siaga_flHutangLogBeban.extend(window.childForm);
window.app_saku2_report_siaga_flHutangLogBeban.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_siaga_flHutangLogBeban]::mainButtonClick:"+e);
		}
	},
