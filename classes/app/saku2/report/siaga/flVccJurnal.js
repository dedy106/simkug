window.app_saku2_report_siaga_flVccJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flVccJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flVccJurnal";
		this.maximize();
...
window.app_saku2_report_siaga_flVccJurnal.extend(window.childForm);
window.app_saku2_report_siaga_flVccJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_saku2_siaga_rptVccJurnal";
