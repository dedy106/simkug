window.app_saku2_report_siaga_flBukuKas = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flBukuKas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flBukuKas";
		this.maximize();
...
window.app_saku2_report_siaga_flBukuKas.extend(window.portalui_childForm);
window.app_saku2_report_siaga_flBukuKas.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct(periode) as periode from kas_j "+
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_siaga_rptBukuKas";
				this.filter2=this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.app._nikUser+"/"+this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+"/"+this.sg1.getCell(2,3);
