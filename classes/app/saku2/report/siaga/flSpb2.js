window.app_saku2_report_siaga_flSpb2 = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flSpb2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flSpb2";
		this.maximize();
...
window.app_saku2_report_siaga_flSpb2.extend(window.childForm);
window.app_saku2_report_siaga_flSpb2.implement({
