window.app_saku2_report_siaga_flCust = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flCust.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flCust";
		this.maximize();
...
window.app_saku2_report_siaga_flCust.extend(window.childForm);
window.app_saku2_report_siaga_flCust.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_siaga_rptCust";
			...
			systemAPI.alert("[app_saku2_report_siaga_flCust]::mainButtonClick:"+e);
		}
	},
