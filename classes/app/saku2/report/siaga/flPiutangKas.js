window.app_saku2_report_siaga_flPiutangKas = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flPiutangKas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flPiutangKas";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from kas_m where kode_lokasi='"+this.app._lokasi+"' and modul='KBPIUTANG'");
...
window.app_saku2_report_siaga_flPiutangKas.extend(window.childForm);
window.app_saku2_report_siaga_flPiutangKas.implement({
