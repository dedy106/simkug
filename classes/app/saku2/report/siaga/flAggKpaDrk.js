window.app_saku2_report_siaga_flAggKpaDrk = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flAggKpaDrk.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flAggKpaDrk";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,[0,1,2],["Kode Akun","All",""]);
...
window.app_saku2_report_siaga_flAggKpaDrk.extend(window.portalui_childForm);
window.app_saku2_report_siaga_flAggKpaDrk.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.filter=this.filterRep.filterStr("a.kode_drk",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"where")+
						this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"and")+
			...
			this.filter2=this.sg1.getCell(2,5)+"/"+this.sg1.getCell(2,1)+"/"+
						 ...
						 this.filterRep.filterStr("kode_akun",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4),"and")+"/"+
			...
			this.nama_report="server_report_saku2_siaga_rptAggKpaDrk";
			/*
