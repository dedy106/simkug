window.app_saku2_report_siaga_flBuktiKas = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flBuktiKas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flBuktiKas";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("No Kas","All",""));
...
window.app_saku2_report_siaga_flBuktiKas.extend(window.childForm);
window.app_saku2_report_siaga_flBuktiKas.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_saku2_siaga_rptBuktiKas";
