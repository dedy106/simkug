window.app_saku2_report_siaga_flHutangKas = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flHutangKas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flHutangKas";
		this.maximize();
...
window.app_saku2_report_siaga_flHutangKas.extend(window.childForm);
window.app_saku2_report_siaga_flHutangKas.implement({
