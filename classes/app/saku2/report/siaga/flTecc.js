window.app_saku2_report_siaga_flTecc = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flTecc.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flTecc";
		this.maximize();
...
window.app_saku2_report_siaga_flTecc.extend(window.childForm);
window.app_saku2_report_siaga_flTecc.implement({
	...
	{		
		...
		if (row == 1)
		{
			...
			this.dbLib.setItemsFromSQL("select distinct periode from gr_tecc_m where kode_lokasi='"+this.app._lokasi+"' order by periode",[this.sg1.columns.get(2).pickList,this.sg1.columns.get(3).pickList]);
		}
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_siaga_rptTecc";
			...
			systemAPI.alert("[app_saku2_report_siaga_flTecc]::mainButtonClick:"+e);
		}
	},
