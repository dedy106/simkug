window.app_saku2_report_siaga_flVccJurnalDet = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flVccJurnalDet.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flVccJurnalDet";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from gr_vcc_m where kode_lokasi='"+this.app._lokasi+"'");
...
window.app_saku2_report_siaga_flVccJurnalDet.extend(window.childForm);
window.app_saku2_report_siaga_flVccJurnalDet.implement({
		...
		try{			
			...
			if (row == 2)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Jurnal",this.sg1, this.sg1.row, this.sg1.col,
														  "select no_vcc, keterangan from gr_vcc_m  "+filter ,
														  "select count(no_vcc) from gr_vcc_m "+filter,
														  new Array("no_vcc","keterangan"),"and");
			}
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+
							...
							this.filterRep.filterStr("a.no_vcc",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2)," and ");
				this.filter2=this.sg1.getCell(2,1);
				this.nama_report="server_report_saku2_siaga_rptVccJurnalDet";
