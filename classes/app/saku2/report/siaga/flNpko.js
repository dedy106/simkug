window.app_saku2_report_siaga_flNpko = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flNpko.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flNpko";
		this.maximize();
...
window.app_saku2_report_siaga_flNpko.extend(window.childForm);
window.app_saku2_report_siaga_flNpko.implement({
