window.app_saku2_report_siaga_flTeccCabang = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flTeccCabang.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flTeccCabang";
		this.maximize();
...
window.app_saku2_report_siaga_flTeccCabang.extend(window.childForm);
window.app_saku2_report_siaga_flTeccCabang.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_siaga_rptTeccCabang";
			...
			systemAPI.alert("[app_saku2_report_siaga_flTeccCabang]::mainButtonClick:"+e);
		}
	},
