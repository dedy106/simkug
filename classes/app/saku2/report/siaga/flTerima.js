window.app_saku2_report_siaga_flTerima = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flTerima.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flTerima";
		this.maximize();
...
window.app_saku2_report_siaga_flTerima.extend(window.childForm);
window.app_saku2_report_siaga_flTerima.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_siaga_flTerima]::mainButtonClick:"+e);
		}
	},
