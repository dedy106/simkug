// JavaScript Document
window.app_saku2_report_siaga_flNeracaMutasi = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flNeracaMutasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flNeracaMutasi";
		this.maximize();
...
window.app_saku2_report_siaga_flNeracaMutasi.extend(window.portalui_childForm);
window.app_saku2_report_siaga_flNeracaMutasi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				{
					this.nama_report="server_report_saku2_gl_rptNeracaMutasi";
				}
				else
				{
					this.nama_report="server_report_saku2_gl_rptNeracaMutasiDC";
				}	
