window.app_saku2_report_siaga_flTeccSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flTeccSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flTeccSaldo";
		this.maximize();
...
window.app_saku2_report_siaga_flTeccSaldo.extend(window.childForm);
window.app_saku2_report_siaga_flTeccSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_siaga_rptTeccSaldo";
			...
			systemAPI.alert("[app_saku2_report_siaga_flTeccSaldo]::mainButtonClick:"+e);
		}
	},
