// JavaScript Document
window.app_saku2_report_siaga_flLR = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flLR.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flLR";
		this.maximize();
...
window.app_saku2_report_siaga_flLR.extend(window.portalui_childForm);
window.app_saku2_report_siaga_flLR.implement({
