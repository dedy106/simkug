window.app_saku2_report_siaga_flAggPdrk = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flAggPdrk.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flAggPdrk";
		this.maximize();
...
window.app_saku2_report_siaga_flAggPdrk.extend(window.portalui_childForm);
window.app_saku2_report_siaga_flAggPdrk.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku2_siaga_rptAggPdrk";	
