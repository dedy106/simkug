window.app_saku2_report_siaga_flPjCairJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flPjCairJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flPjCairJurnal";
		this.maximize();
...
window.app_saku2_report_siaga_flPjCairJurnal.extend(window.childForm);
window.app_saku2_report_siaga_flPjCairJurnal.implement({
