window.app_saku2_report_siaga_flSpb = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_siaga_flSpb.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_siaga_flSpb";
		this.maximize();
...
window.app_saku2_report_siaga_flSpb.extend(window.childForm);
window.app_saku2_report_siaga_flSpb.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_saku2_siaga_rptSpb";
