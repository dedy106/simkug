window.app_saku2_report_yks_flBpcc = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_yks_flBpcc.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_yks_flBpcc";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Jenis Laporan ","=","Lokasi"));
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
	
};
window.app_saku2_report_yks_flBpcc.extend(window.childForm);
window.app_saku2_report_yks_flBpcc.implement({
	...
	{		
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,["Lokasi","Konsolidasi"]);
		}
	},
	mainButtonClick: function(sender){
		try
		{
			...
			}else
			{
				...
				this.nama_report="server_report_saku2_yks_rptBpcc";
