window.app_saku2_report_yks_flHutangJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_yks_flHutangJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_yks_flHutangJurnal";
		this.maximize();
...
window.app_saku2_report_yks_flHutangJurnal.extend(window.childForm);
window.app_saku2_report_yks_flHutangJurnal.implement({
	...
	{		
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.dbLib.setItemsFromSQL("select distinct modul from yk_rekon_m where kode_lokasi='"+this.sg1.getCell(2,0)+"' "+
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_saku2_yks_rptHutangJurnal";				
