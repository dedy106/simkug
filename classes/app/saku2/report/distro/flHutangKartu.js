window.app_saku2_report_distro_flHutangKartu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_distro_flHutangKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_distro_flHutangKartu";
		this.maximize();
...
window.app_saku2_report_distro_flHutangKartu.extend(window.childForm);
window.app_saku2_report_distro_flHutangKartu.implement({
	doEllipseClick: function(sender, col, row){
		try{			
			...
			if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data PO",this.sg1, this.sg1.row, this.sg1.col,
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_distro_rptHutangKartu";
			...
			systemAPI.alert("[app_saku2_report_distro_flHutangKartu]::mainButtonClick:"+e);
		}
	},
