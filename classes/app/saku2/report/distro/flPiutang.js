window.app_saku2_report_distro_flPiutang = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_distro_flPiutang.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_distro_flPiutang";
		this.maximize();
...
window.app_saku2_report_distro_flPiutang.extend(window.childForm);
window.app_saku2_report_distro_flPiutang.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_distro_flPiutang]::mainButtonClick:"+e);
		}
	},
