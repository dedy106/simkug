window.app_saku2_report_distro_flDoKas = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_distro_flDoKas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_distro_flDoKas";
		this.maximize();
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from kas_m where kode_lokasi='"+this.app._lokasi+"' and modul='KBDO'");
...
window.app_saku2_report_distro_flDoKas.extend(window.childForm);
window.app_saku2_report_distro_flDoKas.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_saku2_distro_rptBuktiBank";
