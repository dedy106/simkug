window.app_saku2_report_distro_flDo = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_distro_flDo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_distro_flDo";
		this.maximize();
...
window.app_saku2_report_distro_flDo.extend(window.childForm);
window.app_saku2_report_distro_flDo.implement({
		...
		try{			
			...
			if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data DO",this.sg1, this.sg1.row, this.sg1.col,
												"select a.no_do, a.keterangan from ds_po_m a "+filter,
												"select count(b.no_do) from ds_po_m a "+filter,
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_distro_rptDo";
			...
			systemAPI.alert("[app_saku2_report_distro_flDo]::mainButtonClick:"+e);
		}
	},
