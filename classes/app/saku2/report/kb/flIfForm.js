window.app_saku2_report_kb_flIfForm = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kb_flIfForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kb_flIfForm";
		this.maximize();
...
window.app_saku2_report_kb_flIfForm.extend(window.childForm);
window.app_saku2_report_kb_flIfForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_kb_rptKbIf";
			...
			systemAPI.alert("[app_saku2_report_kb_flIfForm]::mainButtonClick:"+e);
		}
	},
