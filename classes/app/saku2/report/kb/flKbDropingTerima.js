window.app_saku2_report_kb_flKbDropingTerima = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kb_flKbDropingTerima.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kb_flKbDropingTerima";
		this.maximize();
...
window.app_saku2_report_kb_flKbDropingTerima.extend(window.childForm);
window.app_saku2_report_kb_flKbDropingTerima.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kb_flKbDropingTerima]::mainButtonClick:"+e);
		}
	},
