window.app_saku2_report_kb_flKbFa = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kb_flKbFa.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kb_flKbFa";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan KasBank Pengadaan Aktap", 2);
	...
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("Bentuk Laporan","=","Transaksi"));
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
	this.doSelectCell(this.sg1,2,4);
};
window.app_saku2_report_kb_flKbFa.extend(window.childForm);
window.app_saku2_report_kb_flKbFa.implement({
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				if (this.sg1.getCell(2,5)=="Transaksi")
				{
					...
					this.fieldType = new server_util_arrayList({items:["S","S","S","S","S","S","S","S","S","S","S","S","S","S","S","S","S","N","N"]});																
					this.summary = new server_util_arrayList({items:["N","N","N","N","N","N","N","N","N","N","N","N","N","N","N","N","N","Y","Y"]});
				}
				else
				{
			...
			systemAPI.alert("[app_saku2_report_kb_flKbFa]::mainButtonClick:"+e);
		}
	},
