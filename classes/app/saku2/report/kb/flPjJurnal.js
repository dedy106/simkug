window.app_saku2_report_kb_flPjJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kb_flPjJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kb_flPjJurnal";
		this.maximize();
...
window.app_saku2_report_kb_flPjJurnal.extend(window.childForm);
window.app_saku2_report_kb_flPjJurnal.implement({
		...
		try{			
			...
			if (row == 2)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Jurnal",this.sg1, this.sg1.row, this.sg1.col,
														  "select no_ptg, keterangan from ptg_m  "+filter ,
														  "select count(no_ptg) from ptg_m "+filter,
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_saku2_kb_rptPjJurnal";
