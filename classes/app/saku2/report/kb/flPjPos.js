window.app_saku2_report_kb_flPjPos = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kb_flPjPos.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kb_flPjPos";
		this.maximize();
...
window.app_saku2_report_kb_flPjPos.extend(window.childForm);
window.app_saku2_report_kb_flPjPos.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kb_rptPjPos";
			...
			systemAPI.alert("[app_saku2_report_kb_flPjPos]::mainButtonClick:"+e);
		}
	},
