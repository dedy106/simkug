		...
		try{
			...
			switch(this.sg1.getCell(1,2)){
    			case "All":
    			    ...
    			    var data = this.dbLib.getDataProvider("select max(a.kode_akun) as kd1, min(a.kode_akun) as kd2 from masakun a "+
														"inner join flag_relasi b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi "+
													    "where a.block= '0' and (b.kode_flag='001' or b.kode_flag='009') and a.kode_lokasi = '"+this.app._lokasi+"' ",true); 
		    ...
		    try{
                switch (methodName)
    			{
    				...
    				case "getDataProviderPage" :
                        ...
                        allHtml += "      </tr>";
                        allHtml += "      <tr>";
                        allHtml += "        <td  class='lokasi_laporan'><div align='center'>Laporan Buku Besar KasBank</div></td>";
                        allHtml += "      </tr>";
                        allHtml += "      <tr>";
            ...
            for (var i in result.rs.rows){
                ...
                if (this.kd_akun != line.kode_akun){                                        
					...
					htmlHeader = "<table width='100%' border='0' cellspacing='2' cellpadding='1'>"+
							...
							"  </tr>"+
							"</table>";										
					retHtml += "<table width='900' border='1' cellspacing='0' cellpadding='0' class='kotak'>";																		
					...
					retHtml += "<tr bgcolor='#CCCCCC'>"+
						...
						"	 <td width='90' height='23' class='header_laporan'><div align='center'>No Dokumen</div></td>"+
						...
						"    <td width='50' class='header_laporan'><div align='center'>Kode DRK</div></td>"+
    ...
    convertToHeader: function(result){     
        try{   
            if (result.rs.rows[0] !== undefined){
                ...
                var html ="<table width='900' border='1' cellspacing='0' cellpadding='1' class='kotak'>"+
                  "<tr>"+
