window.app_saku2_report_kb_flPjAjuForm = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kb_flPjAjuForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kb_flPjAjuForm";
		this.maximize();
...
window.app_saku2_report_kb_flPjAjuForm.extend(window.childForm);
window.app_saku2_report_kb_flPjAjuForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kb_rptKbPjAju";
			...
			systemAPI.alert("[app_saku2_report_kb_flPjAjuForm]::mainButtonClick:"+e);
		}
	},
