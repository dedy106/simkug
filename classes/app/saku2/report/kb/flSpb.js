window.app_saku2_report_kb_flSpb = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kb_flSpb.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kb_flSpb";
		this.maximize();
...
window.app_saku2_report_kb_flSpb.extend(window.childForm);
window.app_saku2_report_kb_flSpb.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_kb_rptSpb";
			...
			systemAPI.alert("[app_saku2_report_kb_flSpb]::mainButtonClick:"+e);
		}
	},
