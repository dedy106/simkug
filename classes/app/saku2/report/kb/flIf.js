window.app_saku2_report_kb_flIf = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kb_flIf.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kb_flIf";
		this.maximize();
...
window.app_saku2_report_kb_flIf.extend(window.childForm);
window.app_saku2_report_kb_flIf.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_kb_rptIf";
			...
			systemAPI.alert("[app_saku2_report_kb_flIf]::mainButtonClick:"+e);
		}
	},
