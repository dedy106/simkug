window.app_saku2_report_kb_flKbBdd = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kb_flKbBdd.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kb_flKbBdd";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan KasBank BDD", 2);
...
window.app_saku2_report_kb_flKbBdd.extend(window.childForm);
window.app_saku2_report_kb_flKbBdd.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kb_flKbBdd]::mainButtonClick:"+e);
		}
	},
