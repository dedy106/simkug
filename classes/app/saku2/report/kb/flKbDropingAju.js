window.app_saku2_report_kb_flKbDropingAju = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kb_flKbDropingAju.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kb_flKbDropingAju";
		this.maximize();
...
window.app_saku2_report_kb_flKbDropingAju.extend(window.childForm);
window.app_saku2_report_kb_flKbDropingAju.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku2_kb_rptKbDropingAju";
			...
			systemAPI.alert("[app_saku2_report_kb_flKbDropingAju]::mainButtonClick:"+e);
		}
	},
