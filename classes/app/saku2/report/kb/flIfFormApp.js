window.app_saku2_report_kb_flIfFormApp = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kb_flIfFormApp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kb_flIfFormApp";
		this.maximize();
...
window.app_saku2_report_kb_flIfFormApp.extend(window.childForm);
window.app_saku2_report_kb_flIfFormApp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_kb_rptIfApp";
			...
			systemAPI.alert("[app_saku2_report_kb_flIfFormApp]::mainButtonClick:"+e);
		}
	},
