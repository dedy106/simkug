window.app_saku2_report_kb_flSpbForm = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kb_flSpbForm.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kb_flSpbForm";
		this.maximize();
...
window.app_saku2_report_kb_flSpbForm.extend(window.childForm);
window.app_saku2_report_kb_flSpbForm.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku2_kb_rptSpbForm";
			...
			systemAPI.alert("[app_saku2_report_kb_flSpbForm]::mainButtonClick:"+e);
		}
	},
