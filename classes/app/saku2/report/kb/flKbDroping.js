window.app_saku2_report_kb_flKbDroping = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kb_flKbDroping.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kb_flKbDroping";
		this.maximize();
...
window.app_saku2_report_kb_flKbDroping.extend(window.childForm);
window.app_saku2_report_kb_flKbDroping.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				{
					this.nama_report = "server_report_saku2_kb_rptKbDroping";
			...
			systemAPI.alert("[app_saku2_report_kb_flKbDroping]::mainButtonClick:"+e);
		}
	},
