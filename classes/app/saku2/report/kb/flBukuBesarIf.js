...
//* 			SAI, PT											
//***********************************************************************************************
window.app_saku2_report_kb_flBukuBesarIf = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kb_flBukuBesarIf.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kb_flBukuBesarIf";
		this.maximize();
...
window.app_saku2_report_kb_flBukuBesarIf.extend(window.portalui_childForm);
window.app_saku2_report_kb_flBukuBesarIf.implement({
	...
	doSelectCell: function(sender, col, row){
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4],["123","23","123","123","123"]);
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku2_kb_rptBukuBesarIf";
