window.app_saku2_report_kb_flKbPjSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kb_flKbPjSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kb_flKbPjSaldo";
		this.maximize();
...
window.app_saku2_report_kb_flKbPjSaldo.extend(window.childForm);
window.app_saku2_report_kb_flKbPjSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku2_report_kb_flKbPjSaldo]::mainButtonClick:"+e);
		}
	},
