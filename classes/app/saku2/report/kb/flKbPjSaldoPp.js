window.app_saku2_report_kb_flKbPjSaldoPp = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_kb_flKbPjSaldoPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_kb_flKbPjSaldoPp";
		this.maximize();
...
window.app_saku2_report_kb_flKbPjSaldoPp.extend(window.childForm);
window.app_saku2_report_kb_flKbPjSaldoPp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_kb_rptKbPjSaldoPp";
	...
	doOpenPanjar: function(kode_pp,kode_lokasi,periode){
		this.kode_pp=kode_pp;
		this.kode_lokasi=kode_lokasi;
		this.periode=periode;
		this.link="1";
		filter = "where a.kode_pp='"+kode_pp+"' and a.kode_lokasi='"+kode_lokasi+"' and a.periode<='"+periode+"'";
		filter2="";
		nama_report="server_report_saku2_kb_rptKbPjSaldo";
