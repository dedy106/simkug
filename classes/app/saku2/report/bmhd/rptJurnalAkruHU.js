// JavaScript Document
window.app_saku3_report_bmhd_flJurnalAkruHU = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_bmhd_flJurnalAkruHU.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_bmhd_flJurnalAkruHU";
		this.maximize();
...
window.app_saku3_report_bmhd_flJurnalAkruHU.extend(window.portalui_childForm);
window.app_saku3_report_bmhd_flJurnalAkruHU.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			{
				this.nama_report="server_report_saku2_gl_rptJurnal";
			}
			else
			{
