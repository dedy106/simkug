// JavaScript Document
window.app_saku2_report_gl_flTbBidang = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flTbBidang.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flTbBidang";
		this.maximize();
...
window.app_saku2_report_gl_flTbBidang.extend(window.portalui_childForm);
window.app_saku2_report_gl_flTbBidang.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.filter2 = this.nik_user+"/"+this.sg1.getCell(2,5)+"/"+this.sg1.getCell(2,1);
			...
			{
				var sql = "call sp_glma_bidang_tmp ('"+this.kode_lokasi+"','"+this.kode_lokasi1+"','"+this.kode_lokasi2+"','"+this.sg1.getCell(2,1)+"','"+this.nik_user+"','"+this.kode_pp1+"','"+this.kode_pp2+"')";
			...
			{
				var sql = "call sp_glma12_bidang_tmp ('"+this.sg1.getCell(2,0)+"','"+this.sg1.getCell(2,1)+"','"+this.nik_user+"','"+this.kode_pp1+"','"+this.kode_pp2+"')";
