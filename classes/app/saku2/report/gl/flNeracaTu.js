// JavaScript Document
window.app_saku2_report_gl_flNeracaTu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flNeracaTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flNeracaTu";
		this.maximize();
...
window.app_saku2_report_gl_flNeracaTu.extend(window.portalui_childForm);
window.app_saku2_report_gl_flNeracaTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			if (sender == this.app._mainForm.bBack)
			{
				...
				if (this.link=="2")
				{
					this.doOpenTbKonsol(this.kode_neraca,this.lok);
				}
				if (this.link=="3")
				{
					this.doOpenTbLokasi(this.kode_akun,this.lok);
				}
				if (this.link=="4")
				{
					this.doOpenTb(this.kode_akun,this.lok);
				}
				if (this.link=="5")
				{
					this.doOpenBb(this.akun,this.lok);
				}
			...
			else
			{
				...
				{
					in_lap="K";
					this.nama_report="server_report_saku2_gl_rptNeracaKonsol";
				}
				else
				{
					this.nama_report="server_report_saku2_gl_rptNeracaStafelKonsol";
				}
				this.filter2 = this.nik_user+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,3)+"/"+this.sg1.getCell(2,5)+"/"+this.app._namaForm+"/"+this.kode_lokasi;
				sql="call sp_neraca_tu ('"+this.sg1.getCell(2,2)+"','A','"+in_lap+"',"+this.sg1.getCell(2,3)+",'"+this.sg1.getCell(2,1)+"','"+this.app._lokasi+"','"+this.app._nikUser+"')";
				//alert(sql);
