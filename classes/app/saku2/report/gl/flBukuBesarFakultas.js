...
//* 			SAI, PT											
//***********************************************************************************************
window.app_saku2_report_gl_flBukuBesarFakultas = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flBukuBesarFakultas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flBukuBesarFakultas";
		this.maximize();
...
window.app_saku2_report_gl_flBukuBesarFakultas.extend(window.portalui_childForm);
window.app_saku2_report_gl_flBukuBesarFakultas.implement({
		...
		try
		{
			...
			else
			{
				...
				var filter_akun=this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+
							this.filterRep.filterStr("a.kode_akun",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3)," and ");
				this.filter2 = this.sg1.getCell(2,1)+"/"+this.app._nikUser+"/"+this.sg1.getCell(2,0)+"/"+filter_akun;
				this.nama_report="server_report_saku2_gl_rptBukuBesarFakultas";
