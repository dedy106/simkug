// JavaScript Document
window.app_saku2_report_gl_flLRTu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flLRTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flLRTu";
		this.maximize();
...
window.app_saku2_report_gl_flLRTu.extend(window.portalui_childForm);
window.app_saku2_report_gl_flLRTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_gl_rptLRTu";
				sql="call sp_neraca_tu ('"+this.sg1.getCell(2,2)+"','L','"+in_lap+"',"+this.sg1.getCell(2,3)+",'"+this.sg1.getCell(2,1)+"','"+this.app._lokasi+"','"+this.app._nikUser+"')";
