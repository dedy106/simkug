// JavaScript Document
window.app_saku2_report_gl_flNeraca2Konsol = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flNeraca2Konsol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flNeraca2Konsol";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("Periode Pembanding","=",this.periode));
...
window.app_saku2_report_gl_flNeraca2Konsol.extend(window.portalui_childForm);
window.app_saku2_report_gl_flNeraca2Konsol.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2 = this.nik_user+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,4)+"/"+this.sg1.getCell(2,3)+"/"+this.app._namaForm;
				var in_lap="S";
				if (this.app._kodeLokasiKonsol==this.app._lokasi)
				{
				...
				sql="call sp_neraca2 ('"+this.sg1.getCell(2,2)+"','A','"+in_lap+"',"+this.sg1.getCell(2,3)+",'"+this.sg1.getCell(2,1)+"','"+this.sg1.getCell(2,4)+"','"+this.kode_lokasi+"','"+this.kode_lokasi1+"','"+this.kode_lokasi2+"','"+this.nik_user+"')";
				this.nama_report="server_report_saku2_gl_rptNeraca2Konsol";
