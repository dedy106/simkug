// JavaScript Document
window.app_saku_gl_report_flLRJejer2 = function(owner)
{
	if (owner)
	{
		window.app_saku_gl_report_flLRJejer2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_gl_report_flLRJejer2";
		this.maximize();
...
window.app_saku_gl_report_flLRJejer2.extend(window.portalui_childForm);
window.app_saku_gl_report_flLRJejer2.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			sql="call sp_neraca_jejer2 ('"+this.sg1.getCell(2,2)+"','L','"+in_lap+"',"+this.sg1.getCell(2,3)+",'"+this.sg1.getCell(2,1)+"','"+this.kode_lokasi+"','"+this.nik_user+"')";
			
			this.dbLib.execQuerySync(sql);	
			
			this.nama_report="server_report_gl_rptLRJejer2";
