// JavaScript Document
window.app_saku2_report_gl_flNeracaMutasi = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flNeracaMutasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flNeracaMutasi";
		this.maximize();
...
window.app_saku2_report_gl_flNeracaMutasi.extend(window.portalui_childForm);
window.app_saku2_report_gl_flNeracaMutasi.implement({
