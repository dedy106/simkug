// JavaScript Document
window.app_saku2_report_gl_flInvestasi = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flInvestasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flInvestasi";
		this.maximize();
...
window.app_saku2_report_gl_flInvestasi.extend(window.portalui_childForm);
window.app_saku2_report_gl_flInvestasi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku2_gl_rptInvestasi";
