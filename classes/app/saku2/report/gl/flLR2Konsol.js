// JavaScript Document
window.app_saku2_report_gl_flLR2Konsol = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flLR2Konsol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flLR2Konsol";
		this.maximize();
...
window.app_saku2_report_gl_flLR2Konsol.extend(window.portalui_childForm);
window.app_saku2_report_gl_flLR2Konsol.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				sql="call sp_neraca2 ('"+this.sg1.getCell(2,2)+"','L','"+in_lap+"',"+this.sg1.getCell(2,3)+",'"+this.sg1.getCell(2,1)+"','"+this.sg1.getCell(2,4)+"','"+this.kode_lokasi+"','"+this.kode_lokasi1+"','"+this.kode_lokasi2+"','"+this.nik_user+"')";
				this.nama_report="server_report_saku2_gl_rptLR2Konsol";
