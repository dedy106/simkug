// JavaScript Document
window.app_saku2_report_gl_flTbTu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flTbTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flTbTu";
		this.maximize();
...
window.app_saku2_report_gl_flTbTu.extend(window.portalui_childForm);
window.app_saku2_report_gl_flTbTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				var sql = "call sp_glma_tu_tmp ('"+this.app._lokasi+"','"+this.sg1.getCell(2,1)+"','"+this.app._nikUser+"')";								
				this.nama_report="server_report_saku2_gl_rptTBLajurTu";
