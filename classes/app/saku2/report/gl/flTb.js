// JavaScript Document
window.app_saku2_report_gl_flTb = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flTb.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flTb";
		this.maximize();
...
window.app_saku2_report_gl_flTb.extend(window.portalui_childForm);
window.app_saku2_report_gl_flTb.implement({
	...
	doSelectCell : function(sender, col, row){
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("Neraca Percobaan","Neraca Lajur","12 Periode Mutasi","12 Periode Saldo Akhir"));
		}
		if (row == 4)
		{
			this.sg1.columns.get(2).pickList.clear();
		...
		try
		{
			...
			else
			{
				...
				if (this.sg1.getCell(2,3)=="12 Periode Saldo Akhir")
				{
					...
					this.nama_report="server_report_saku2_gl_rptTB12Akhir";
				}
