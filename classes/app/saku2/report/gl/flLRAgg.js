// JavaScript Document
window.app_saku2_report_gl_flLRAgg = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flLRAgg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flLRAgg";
		this.maximize();
...
window.app_saku2_report_gl_flLRAgg.extend(window.portalui_childForm);
window.app_saku2_report_gl_flLRAgg.implement({
