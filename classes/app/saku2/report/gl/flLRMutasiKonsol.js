// JavaScript Document
window.app_saku2_report_gl_flLRMutasiKonsol = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flLRMutasiKonsol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flLRMutasiKonsol";
		this.maximize();
...
window.app_saku2_report_gl_flLRMutasiKonsol.extend(window.portalui_childForm);
window.app_saku2_report_gl_flLRMutasiKonsol.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				{
					this.nama_report="server_report_saku2_gl_rptLRMutasiKonsol";
				}
				else
				{
					this.nama_report="server_report_saku2_gl_rptLRMutasiDCKonsol";
				}	
