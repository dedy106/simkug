// JavaScript Document
window.app_saku2_report_gl_flRkmaRekap = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flRkmaRekap.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flRkmaRekap";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,new Array(0,1,2), new Array("Bentuk Laporan","=","Summary"));
...
window.app_saku2_report_gl_flRkmaRekap.extend(window.portalui_childForm);
window.app_saku2_report_gl_flRkmaRekap.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_gl_rptRkmaRekap";
