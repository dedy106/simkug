// JavaScript Document
window.app_saku2_report_gl_flTBJejerDiv = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flTBJejerDiv.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flTBJejerDiv";
		this.maximize();
...
window.app_saku2_report_gl_flTBJejerDiv.extend(window.portalui_childForm);
window.app_saku2_report_gl_flTBJejerDiv.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				var sql = "call sp_glma_jejer_div_tmp ('"+this.kode_lokasi+"','"+this.sg1.getCell(2,1)+"','"+this.nik_user+"')";
				this.nama_report="server_report_saku2_gl_rptTBJejerDiv";
