// JavaScript Document
window.app_saku2_report_gl_flLRPsak = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flLRPsak.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flLRPsak";
		this.maximize();
...
window.app_saku2_report_gl_flLRPsak.extend(window.portalui_childForm);
window.app_saku2_report_gl_flLRPsak.implement({
