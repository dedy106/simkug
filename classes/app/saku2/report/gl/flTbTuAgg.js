// JavaScript Document
window.app_saku2_report_gl_flTbTuAgg = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flTbTuAgg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flTbTuAgg";
		this.maximize();
...
window.app_saku2_report_gl_flTbTuAgg.extend(window.portalui_childForm);
window.app_saku2_report_gl_flTbTuAgg.implement({
	...
	doSelectCell : function(sender, col, row){
		...
		this.filterRep.setSGFilterRowTipe(this.sg1, row,new Array(0,1,2,3),new  Array("123","1234","123","3"));
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2 = this.nik_user+"/"+this.sg1.getCell(2,3)+"/"+this.sg1.getCell(2,1);
				
				var sql = "call sp_glma_gar_tu ('"+this.app._lokasi+"','"+this.sg1.getCell(2,1)+"','"+this.app._nikUser+"')";
				alert(sql);
				this.nama_report="server_report_saku2_gl_rptTBTuAgg";
