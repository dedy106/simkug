// JavaScript Document
window.app_saku2_report_gl_flLRJejerTu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flLRJejerTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flLRJejerTu";
		this.maximize();
...
window.app_saku2_report_gl_flLRJejerTu.extend(window.portalui_childForm);
window.app_saku2_report_gl_flLRJejerTu.implement({
	...
	mainButtonClick: function(sender){	
		try
		{
			...
			{	
				...
				this.nama_report="server_report_saku2_gl_rptLRJejerTu";
				var sql="call sp_neraca_jejer_tu ('"+this.sg1.getCell(2,2)+"','L','"+in_lap+"',"+this.sg1.getCell(2,3)+",'"+this.sg1.getCell(2,1)+"','"+this.kode_lokasi+"','"+this.nik_user+"')";
