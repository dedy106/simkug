// JavaScript Document
window.app_saku2_report_gl_flTbKonsol = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flTbKonsol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flTbKonsol";
		this.maximize();
...
window.app_saku2_report_gl_flTbKonsol.extend(window.portalui_childForm);
window.app_saku2_report_gl_flTbKonsol.implement({
		...
		try
		{
			...
			else
			{
				...
				if (this.sg1.getCell(2,3)=="Neraca Percobaan")
				{
					...
					this.nama_report="server_report_saku2_gl_rptTBPercobaanKonsol";
				}
				if (this.sg1.getCell(2,3)=="Neraca Lajur")
				{
					var sql = "call sp_glma_tmp ('"+this.kode_lokasi+"','"+this.kode_lokasi1+"','"+this.kode_lokasi2+"','"+this.sg1.getCell(2,1)+"','"+this.nik_user+"')";								
					this.nama_report="server_report_saku2_gl_rptTBLajurKonsol";
					
				}
				if (this.sg1.getCell(2,3)=="12 Periode")
				{
					var sql = "call sp_glma12_tmp ('"+this.sg1.getCell(2,0)+"','"+this.sg1.getCell(2,1)+"','"+this.nik_user+"')";
					this.nama_report="server_report_saku2_gl_rptTB12Konsol";
				}
	...
	doOpenJurnal: function(no_bukti,kode_lokasi){
		...
		filter2=this.sg1.getCell(2,1)+"/"+kode_lokasi;
