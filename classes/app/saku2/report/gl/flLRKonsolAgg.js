// JavaScript Document
window.app_saku2_report_gl_flLRKonsolAgg = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flLRKonsolAgg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flLRKonsolAgg";
		this.maximize();
...
window.app_saku2_report_gl_flLRKonsolAgg.extend(window.portalui_childForm);
window.app_saku2_report_gl_flLRKonsolAgg.implement({
