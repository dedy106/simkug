// JavaScript Document
window.app_saku2_report_gl_flTBJejerKopeg = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flTBJejerKopeg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flTBJejerKopeg";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Bentuk Neraca","=","Summary"));
...
window.app_saku2_report_gl_flTBJejerKopeg.extend(window.portalui_childForm);
window.app_saku2_report_gl_flTBJejerKopeg.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2 = this.nik_user+"/"+this.sg1.getCell(2,4)+"/"+this.sg1.getCell(2,1)+"/"+this.app._namaForm;
				...
				var sql = "call sp_glma_jejer_kopeg_tmp ('"+this.kode_lokasi+"','"+this.sg1.getCell(2,1)+"','"+this.nik_user+"')";
				this.nama_report="server_report_saku2_gl_rptTBJejerKopeg";
