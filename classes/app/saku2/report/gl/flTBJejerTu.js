// JavaScript Document
window.app_saku2_report_gl_flTBJejerTu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flTBJejerTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flTBJejerTu";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Tampil Saldo Nol","=","Ya"));
...
window.app_saku2_report_gl_flTBJejerTu.extend(window.portalui_childForm);
window.app_saku2_report_gl_flTBJejerTu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2 = this.app._nikUser+"/"+this.sg1.getCell(2,3)+"/"+this.sg1.getCell(2,1);
				
				var sql = "call sp_glma_jejer_tu_tmp ('"+this.app._lokasi+"','"+this.sg1.getCell(2,1)+"','"+this.app._nikUser+"')";
				
				this.nama_report="server_report_saku2_gl_rptTBJejerTu";
	...
	doOpenTb: function(kode_akun,kode_lokasi){
		...
		this.link="1";
		filter2 = "trail3_"+this.app._nikUser+"/"+this.sg1.getCell(2,1)+"/"+kode_akun+"/"+kode_lokasi+"/"+this.sg1.getCell(2,0)+"/-/tb/-" ;
		filter="";
	...
	doOpenBb: function(kode_akun,kode_lokasi){
		...
		this.lok=kode_lokasi;
		this.link="2";
		filter2 = kode_lokasi+"/"+this.sg1.getCell(2,1)+"/trail2_"+this.app._nikUser+"/"+kode_akun;
		filter="";
