// JavaScript Document
window.app_saku2_report_gl_flLRAggJejerTu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flLRAggJejerTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flLRAggJejerTu";
		this.maximize();
...
window.app_saku2_report_gl_flLRAggJejerTu.extend(window.portalui_childForm);
window.app_saku2_report_gl_flLRAggJejerTu.implement({
	...
	mainButtonClick: function(sender){	
		try
		{
			...
			{	
				...
				this.nama_report="server_report_saku2_gl_rptLRAggJejerTu";
