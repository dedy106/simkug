// JavaScript Document
window.app_saku2_report_gl_flLR = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flLR.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flLR";
		this.maximize();
		...
		this.sg1 = new saiGrid(this.p1,{bound:[1,20,700,190],colCount:4,cellExit:[this,"doCellExit"],
...
window.app_saku2_report_gl_flLR.extend(window.portalui_childForm);
window.app_saku2_report_gl_flLR.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2 = this.nik_user+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,4)+"/"+this.sg1.getCell(2,3)+"/"+this.app._namaForm+"/"+this.kode_lokasi+"/"+this.sg1.getCell(2,5)+"/"+this.sg1.getCell(2,6);
