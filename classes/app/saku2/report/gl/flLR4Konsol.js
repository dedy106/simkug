// JavaScript Document
window.app_saku2_report_gl_flLR4Konsol = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flLR4Konsol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flLR4Konsol";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("Periode Pembanding 2","=",this.periode));
	this.gridLib.SGEditData(this.sg1,5,new Array(0,1,2), new Array("Periode Pembanding 3","=",this.periode));
	this.gridLib.SGEditData(this.sg1,6,new Array(0,1,2), new Array("Periode Pembanding 4","=",this.periode));
...
window.app_saku2_report_gl_flLR4Konsol.extend(window.portalui_childForm);
window.app_saku2_report_gl_flLR4Konsol.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,new Array(0,1,2,3,4,5,6,7),new  Array("123","123","123","3","3","3","3","3"));
		...
		else
		{
			...
			this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,new Array(0,1,2,3,4,5,6,7),new  Array(3,0,2,0,0,0,0,0));
		}
		if (row == 1)
		{
			if (this.app._kodeLokasiKonsol==this.app._lokasi)
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				sql="call sp_neraca4 ('"+this.sg1.getCell(2,2)+"','L','"+in_lap+"',"+this.sg1.getCell(2,3)+",'"+this.sg1.getCell(2,1)+"','"+this.sg1.getCell(2,4)+"','"+this.sg1.getCell(2,5)+"','"+this.sg1.getCell(2,6)+"','"+this.kode_lokasi+"','"+this.kode_lokasi1+"','"+this.kode_lokasi2+"','"+this.nik_user+"')";
				this.nama_report="server_report_saku2_gl_rptLR4Konsol";
