// JavaScript Document
window.app_saku2_report_gl_flLRKonsol = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flLRKonsol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flLRKonsol";
		this.maximize();
...
window.app_saku2_report_gl_flLRKonsol.extend(window.portalui_childForm);
window.app_saku2_report_gl_flLRKonsol.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_gl_rptLRKonsol";
