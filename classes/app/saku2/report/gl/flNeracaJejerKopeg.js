// JavaScript Document
window.app_saku2_report_gl_flNeracaJejerKopeg = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flNeracaJejerKopeg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flNeracaJejerKopeg";
		this.maximize();
...
window.app_saku2_report_gl_flNeracaJejerKopeg.extend(window.portalui_childForm);
window.app_saku2_report_gl_flNeracaJejerKopeg.implement({
	...
	mainButtonClick: function(sender){	
		try
		{
			...
			{	
				...
				this.nama_report="server_report_saku2_gl_rptNeracaJejerKopeg";
				var sql="call sp_neraca_jejer_kopeg ('"+this.sg1.getCell(2,2)+"','A','"+in_lap+"',"+this.sg1.getCell(2,3)+",'"+this.sg1.getCell(2,1)+"','"+this.kode_lokasi+"','"+this.nik_user+"')";
