// JavaScript Document
window.app_saku2_report_gl_flLRPp = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flLRPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flLRPp";
		this.maximize();
...
window.app_saku2_report_gl_flLRPp.extend(window.portalui_childForm);
window.app_saku2_report_gl_flLRPp.implement({
