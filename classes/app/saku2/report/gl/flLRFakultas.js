// JavaScript Document
window.app_saku2_report_gl_flLRFakultas = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flLRFakultas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flLRFakultas";
		this.maximize();
...
window.app_saku2_report_gl_flLRFakultas.extend(window.portalui_childForm);
window.app_saku2_report_gl_flLRFakultas.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_gl_rptLRFakultas";
