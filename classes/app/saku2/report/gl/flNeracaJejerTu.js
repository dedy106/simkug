// JavaScript Document
window.app_saku2_report_gl_flNeracaJejerTu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flNeracaJejerTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flNeracaJejerTu";
		this.maximize();
...
window.app_saku2_report_gl_flNeracaJejerTu.extend(window.portalui_childForm);
window.app_saku2_report_gl_flNeracaJejerTu.implement({
	...
	mainButtonClick: function(sender){	
		try
		{
			...
			if (sender == this.app._mainForm.bBack)
			{
				...
				if (this.link=="2")
				{
					this.doOpenTb(this.kode_neraca,this.lok);
				}
				if (this.link=="3")
				{
			...
			{	
				...
				this.filter2 = this.nik_user+"/"+this.sg1.getCell(2,1)+"/"+this.app._namaForm;
				var in_lap="S";
				...
				this.nama_report="server_report_saku2_gl_rptNeracaJejerTu";
				var sql="call sp_neraca_jejer_tu ('"+this.sg1.getCell(2,2)+"','A','"+in_lap+"',"+this.sg1.getCell(2,3)+",'"+this.sg1.getCell(2,1)+"','"+this.kode_lokasi+"','"+this.nik_user+"')";
	...
	doOpenTb: function(kode_neraca,kode_lokasi){
		...
		this.link="1";
		filter2 = "trail3_"+this.app._nikUser+"/"+this.sg1.getCell(2,1)+"/-/"+kode_lokasi+"/"+this.sg1.getCell(2,0)+"/"+kode_neraca+"/neraca/"+this.sg1.getCell(2,2) ;
		filter="";
		//var sql = "call sp_glma_jejer_trail_tu_tmp ('"+this.sg1.getCell(2,2)+"','"+this.kode_neraca+"','"+this.lok+"','"+this.lok+"','"+this.lok+"','"+this.sg1.getCell(2,1)+"','trail3_"+this.app._nikUser+"')";
		//this.dbLib.execQuerySync(sql);	
		nama_report="server_report_saku2_gl_rptTBLajurTuTrail";
