// JavaScript Document
window.app_saku2_report_gl_flMasakun = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flMasakun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flMasakun";
		this.maximize();
...
window.app_saku2_report_gl_flMasakun.extend(window.portalui_childForm);
window.app_saku2_report_gl_flMasakun.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku2_gl_rptMasakun";
