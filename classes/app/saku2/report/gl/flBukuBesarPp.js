...
//* 			SAI, PT											
//***********************************************************************************************
window.app_saku2_report_gl_flBukuBesarPp = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flBukuBesarPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flBukuBesarPp";
		this.maximize();
...
window.app_saku2_report_gl_flBukuBesarPp.extend(window.portalui_childForm);
window.app_saku2_report_gl_flBukuBesarPp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_gl_rptBukuBesarPp";
