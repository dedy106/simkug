// JavaScript Document
window.app_saku2_report_gl_flNeracaFakultas = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flNeracaFakultas.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flNeracaFakultas";
		this.maximize();
...
window.app_saku2_report_gl_flNeracaFakultas.extend(window.portalui_childForm);
window.app_saku2_report_gl_flNeracaFakultas.implement({
	...
	doOpenTb: function(kode_neraca,kode_lokasi){
		...
		this.link="1";
		filter2 = this.app._nikUser+"/"+this.sg1.getCell(2,1)+"/Tidak/1" ;
		filter="where a.nik_user='"+this.app._nikUser+"' and e.kode_neraca='"+kode_neraca+"' ";
		var sql = "call sp_glma_pp_dw_tmp ('"+kode_lokasi+"','"+this.sg1.getCell(2,1)+"','"+this.app._nikUser+"')";
		this.dbLib.execQuerySync(sql);	
		nama_report="server_report_saku2_gl_rptTBLajurPp";
