// JavaScript Document
window.app_saku2_report_gl_flJurnalFrigia = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flJurnalFrigia.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flJurnalFrigia";
		this.maximize();
...
window.app_saku2_report_gl_flJurnalFrigia.extend(window.portalui_childForm);
window.app_saku2_report_gl_flJurnalFrigia.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			{
				this.nama_report="server_report_saku2_gl_rptJurnalFrigia";
			}
			else
			{
				this.nama_report="server_report_saku2_gl_rptBuktiJurnalBantu";
			}
