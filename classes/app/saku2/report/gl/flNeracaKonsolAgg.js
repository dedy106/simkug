// JavaScript Document
window.app_saku2_report_gl_flNeracaKonsolAgg = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flNeracaKonsolAgg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flNeracaKonsolAgg";
		this.maximize();
...
window.app_saku2_report_gl_flNeracaKonsolAgg.extend(window.portalui_childForm);
window.app_saku2_report_gl_flNeracaKonsolAgg.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku2_gl_rptNeracaAgg";
