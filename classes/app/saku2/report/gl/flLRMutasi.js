// JavaScript Document
window.app_saku2_report_gl_flLRMutasi = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flLRMutasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flLRMutasi";
		this.maximize();
...
window.app_saku2_report_gl_flLRMutasi.extend(window.portalui_childForm);
window.app_saku2_report_gl_flLRMutasi.implement({
