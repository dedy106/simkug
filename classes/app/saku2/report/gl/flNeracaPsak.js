// JavaScript Document
window.app_saku2_report_gl_flNeracaPsak = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flNeracaPsak.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flNeracaPsak";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("Bentuk Neraca","=","Stafel"));
...
window.app_saku2_report_gl_flNeracaPsak.extend(window.portalui_childForm);
window.app_saku2_report_gl_flNeracaPsak.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			sql="call sp_psak ('"+this.sg1.getCell(2,2)+"','A','"+in_lap+"',"+this.sg1.getCell(2,3)+",'"+this.sg1.getCell(2,1)+"','"+this.kode_lokasi+"','"+this.kode_lokasi1+"','"+this.kode_lokasi2+"','"+this.nik_user+"')";
