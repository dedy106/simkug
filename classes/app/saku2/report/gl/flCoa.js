// JavaScript Document
window.app_saku2_report_gl_flCoa = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flCoa.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flCoa";
		this.maximize();
...
window.app_saku2_report_gl_flCoa.extend(window.portalui_childForm);
window.app_saku2_report_gl_flCoa.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku2_gl_rptCoa";
			
			if (this.sg1.getCell(2,2)=="Struktur")
			{
				this.nama_report="server_report_saku2_gl_rptCoaStruktur";
			}
