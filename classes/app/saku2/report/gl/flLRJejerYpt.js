// JavaScript Document
window.app_saku2_report_gl_flLRJejerYpt = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flLRJejerYpt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flLRJejerYpt";
		this.maximize();
...
window.app_saku2_report_gl_flLRJejerYpt.extend(window.portalui_childForm);
window.app_saku2_report_gl_flLRJejerYpt.implement({
