// JavaScript Document
window.app_saku2_report_gl_flNeracaKonsol = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flNeracaKonsol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flNeracaKonsol";
		this.maximize();
...
window.app_saku2_report_gl_flNeracaKonsol.extend(window.portalui_childForm);
window.app_saku2_report_gl_flNeracaKonsol.implement({
