// JavaScript Document
window.app_saku2_report_gl_flNeracaJejerYpt = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flNeracaJejerYpt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flNeracaJejerYpt";
		this.maximize();
...
window.app_saku2_report_gl_flNeracaJejerYpt.extend(window.portalui_childForm);
window.app_saku2_report_gl_flNeracaJejerYpt.implement({
	...
	mainButtonClick: function(sender){	
		try
		{
			...
			{	
				...
				var sql="call sp_neraca_jejer_ypt ('"+this.sg1.getCell(2,2)+"','A','"+in_lap+"',"+this.sg1.getCell(2,3)+",'"+this.sg1.getCell(2,1)+"','"+this.kode_lokasi+"','"+this.nik_user+"')";
