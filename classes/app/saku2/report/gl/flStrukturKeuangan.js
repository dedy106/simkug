// JavaScript Document
window.app_saku2_report_gl_flStrukturKeuangan = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flStrukturKeuangan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flStrukturKeuangan";
		this.maximize();
	...
	var tanda="=";
	this.gridLib.SGEditData(this.sg1,0,new Array(0,1,2), new Array("Kode Lokasi",this.tanda,this.app._lokasi));
	this.gridLib.SGEditData(this.sg1,1,new Array(0,1,2), new Array("=",this.app._kodeFs));
...
window.app_saku2_report_gl_flStrukturKeuangan.extend(window.portalui_childForm);
window.app_saku2_report_gl_flStrukturKeuangan.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku2_gl_rptStrukturKeuangan";
