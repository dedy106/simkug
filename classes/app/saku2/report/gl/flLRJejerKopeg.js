// JavaScript Document
window.app_saku2_report_gl_flLRJejerKopeg = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flLRJejerKopeg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flLRJejerKopeg";
		this.maximize();
...
window.app_saku2_report_gl_flLRJejerKopeg.extend(window.portalui_childForm);
window.app_saku2_report_gl_flLRJejerKopeg.implement({
	...
	mainButtonClick: function(sender){	
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_gl_rptLRJejerKopeg";
				sql="call sp_neraca_jejer_kopeg ('"+this.sg1.getCell(2,2)+"','L','"+in_lap+"',"+this.sg1.getCell(2,3)+",'"+this.sg1.getCell(2,1)+"','"+this.kode_lokasi+"','"+this.nik_user+"')";
