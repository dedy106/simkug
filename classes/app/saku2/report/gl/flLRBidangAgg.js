// JavaScript Document
window.app_saku2_report_gl_flLRBidangAgg = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flLRBidangAgg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flLRBidangAgg";
		this.maximize();
...
window.app_saku2_report_gl_flLRBidangAgg.extend(window.portalui_childForm);
window.app_saku2_report_gl_flLRBidangAgg.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku2_gl_rptLRPpAgg";
			sql="call sp_neraca_bidang_agg ('"+this.sg1.getCell(2,2)+"','L','"+in_lap+"',"+this.sg1.getCell(2,3)+",'"+this.sg1.getCell(2,1)+"','"+this.app._lokasi+"','"+this.app._lokasi+"','"+this.app._lokasi+"','"+this.nik_user+"','"+this.sg1.getCell(2,5)+"','"+this.sg1.getCell(2,5)+"')";
