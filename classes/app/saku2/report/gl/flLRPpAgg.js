// JavaScript Document
window.app_saku2_report_gl_flLRPpAgg = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flLRPpAgg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flLRPpAgg";
		this.maximize();
...
window.app_saku2_report_gl_flLRPpAgg.extend(window.portalui_childForm);
window.app_saku2_report_gl_flLRPpAgg.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			sql="call sp_neraca_pp_agg ('"+this.sg1.getCell(2,2)+"','L','"+in_lap+"',"+this.sg1.getCell(2,3)+",'"+this.sg1.getCell(2,1)+"','"+this.app._lokasi+"','"+this.app._lokasi+"','"+this.app._lokasi+"','"+this.nik_user+"','"+this.sg1.getCell(2,5)+"','"+this.sg1.getCell(2,5)+"')";
