// JavaScript Document
window.app_saku2_report_gl_flNeracaJejerYakes = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flNeracaJejerYakes.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flNeracaJejerYakes";
		this.maximize();
...
window.app_saku2_report_gl_flNeracaJejerYakes.extend(window.portalui_childForm);
window.app_saku2_report_gl_flNeracaJejerYakes.implement({
	...
	mainButtonClick: function(sender){	
		try
		{
			...
			{	
				...
				this.nama_report="server_report_saku2_gl_rptNeracaJejerYakes";
				var sql="call sp_neraca_jejer_yakes ('"+this.sg1.getCell(2,2)+"','A','"+in_lap+"',"+this.sg1.getCell(2,3)+",'"+this.sg1.getCell(2,1)+"','"+this.kode_lokasi+"','"+this.nik_user+"')";
