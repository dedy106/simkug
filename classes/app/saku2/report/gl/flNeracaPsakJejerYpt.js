// JavaScript Document
window.app_saku2_report_gl_flNeracaPsakJejerYpt = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flNeracaPsakJejerYpt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flNeracaPsakJejerYpt";
		this.maximize();
...
window.app_saku2_report_gl_flNeracaPsakJejerYpt.extend(window.portalui_childForm);
window.app_saku2_report_gl_flNeracaPsakJejerYpt.implement({
	...
	mainButtonClick: function(sender){	
		try
		{
			...
			{	
				...
				this.nama_report="server_report_saku2_gl_rptNeracaJejerYpt";
				var sql="call sp_psak_jejer_ypt ('"+this.sg1.getCell(2,2)+"','A','"+in_lap+"',"+this.sg1.getCell(2,3)+",'"+this.sg1.getCell(2,1)+"','"+this.kode_lokasi+"','"+this.nik_user+"')";
	...
	doOpenTb: function(kode_neraca,kode_lokasi){
		...
		filter="";
		var sql = "call sp_glma_jejer_trail_tmp ('"+this.sg1.getCell(2,2)+"','"+this.kode_neraca+"','"+this.lok+"','"+this.lok+"','"+this.lok+"','"+this.sg1.getCell(2,1)+"','trail3_"+this.app._nikUser+"')";
		this.dbLib.execQuerySync(sql);	
