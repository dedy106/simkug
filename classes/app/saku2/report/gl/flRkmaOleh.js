// JavaScript Document
window.app_saku2_report_gl_flRkmaOleh = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flRkmaOleh.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flRkmaOleh";
		this.maximize();
...
window.app_saku2_report_gl_flRkmaOleh.extend(window.portalui_childForm);
window.app_saku2_report_gl_flRkmaOleh.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_gl_rptRkmaOleh";
