// JavaScript Document
window.app_saku2_report_gl_flRkmaGabung = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flRkmaGabung.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flRkmaGabung";
		this.maximize();
...
window.app_saku2_report_gl_flRkmaGabung.extend(window.portalui_childForm);
window.app_saku2_report_gl_flRkmaGabung.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		else
		{
			...
			this.filterRep.setSGFilterRowTipe(this.sg1, row,new Array(0,1,2,3,4),new  Array("3","3","123","3","3","3"));			
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_gl_rptRkmaGabung";
