// JavaScript Document
window.app_saku2_report_gl_flLRMutasi2 = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flLRMutasi2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flLRMutasi2";
		this.maximize();
...
window.app_saku2_report_gl_flLRMutasi2.extend(window.portalui_childForm);
window.app_saku2_report_gl_flLRMutasi2.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				sql="call sp_neraca2_mutasi ('"+this.sg1.getCell(2,2)+"','L','"+in_lap+"',"+this.sg1.getCell(2,3)+",'"+this.sg1.getCell(2,1)+"','"+this.sg1.getCell(2,4)+"','"+this.kode_lokasi+"','"+this.kode_lokasi1+"','"+this.kode_lokasi2+"','"+this.nik_user+"')";
