// JavaScript Document
window.app_saku2_report_gl_flLRJejer = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flLRJejer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flLRJejer";
		this.maximize();
...
window.app_saku2_report_gl_flLRJejer.extend(window.portalui_childForm);
window.app_saku2_report_gl_flLRJejer.implement({
	...
	mainButtonClick: function(sender){	
		if (sender == this.app._mainForm.bPreview)
		{
			try
			{
				...
				this.nama_report="server_report_saku2_gl_rptLRJejer";
