// JavaScript Document
window.app_saku2_report_gl_flLRAggSim = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flLRAggSim.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flLRAggSim";
		this.maximize();
...
window.app_saku2_report_gl_flLRAggSim.extend(window.portalui_childForm);
window.app_saku2_report_gl_flLRAggSim.implement({
		...
		try
		{
			...
			if (sender == this.app._mainForm.bBack)
			{
				...
				if (this.link=="1")
				{
					...
					this.nama_report = "server_report_saku2_gl_rptLRAgg";
			...
			else
			{
				...
				this.filter2 = this.nik_user+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,4)+"/"+this.sg1.getCell(2,3)+"/"+this.app._namaForm+"/"+this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,2);
				this.nama_report="server_report_saku2_gl_rptLRAggSim";
	...
	doOpenGar: function(kode_neraca,kode_lokasi,tahun){
		...
		this.link="1";
		this.lokasi=this.app._namalokasi;
		filter = "where z.kode_neraca='"+kode_neraca+"' and z.kode_lokasi='"+kode_lokasi+"' and substring(x.periode,1,4)='"+tahun+"' and z.kode_fs='"+this.sg1.getCell(2,2)+"'";
