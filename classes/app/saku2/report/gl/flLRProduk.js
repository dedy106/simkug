// JavaScript Document
window.app_saku2_report_gl_flLRProduk = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flLRProduk.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flLRProduk";
		this.maximize();
...
window.app_saku2_report_gl_flLRProduk.extend(window.portalui_childForm);
window.app_saku2_report_gl_flLRProduk.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_gl_rptLRProduk";
				sql="call sp_neraca_produk ('"+this.sg1.getCell(2,2)+"','L','"+in_lap+"',"+this.sg1.getCell(2,3)+",'"+this.sg1.getCell(2,1)+"','"+this.kode_lokasi+"','"+this.kode_lokasi1+"','"+this.kode_lokasi2+"','"+this.nik_user+"')";
