...
//* 			SAI, PT											
//***********************************************************************************************
window.app_saku2_report_gl_flBukuBesarKonsol = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flBukuBesarKonsol.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flBukuBesarKonsol";
		this.maximize();
...
window.app_saku2_report_gl_flBukuBesarKonsol.extend(window.portalui_childForm);
window.app_saku2_report_gl_flBukuBesarKonsol.implement({
