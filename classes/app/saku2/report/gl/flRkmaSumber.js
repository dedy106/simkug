// JavaScript Document
window.app_saku2_report_gl_flRkmaSumber = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flRkmaSumber.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flRkmaSumber";
		this.maximize();
...
window.app_saku2_report_gl_flRkmaSumber.extend(window.portalui_childForm);
window.app_saku2_report_gl_flRkmaSumber.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_gl_rptRkmaSumber";
