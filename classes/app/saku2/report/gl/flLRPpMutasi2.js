// JavaScript Document
window.app_saku2_report_gl_flLRPpMutasi2 = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flLRPpMutasi2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flLRPpMutasi2";
		this.maximize();
...
window.app_saku2_report_gl_flLRPpMutasi2.extend(window.portalui_childForm);
window.app_saku2_report_gl_flLRPpMutasi2.implement({
	...
	doSelectCell: function(sender, col, row){
		this.filterRep.setSGFilterRowTipe(this.sg1, row,new Array(0,1,2,3,4,5),new  Array("3","3","123","3","3","123"));
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_gl_rptLRMutasi2";
				sql="call sp_neraca2_mutasi_pp ('"+this.sg1.getCell(2,2)+"','L','"+in_lap+"',"+this.sg1.getCell(2,3)+",'"+this.sg1.getCell(2,1)+"','"+this.sg1.getCell(2,4)+"','"+this.kode_lokasi+"','"+this.kode_lokasi1+"','"+this.kode_lokasi2+"','"+this.nik_user+"','"+this.sg1.getCell(2,5)+"','"+this.sg1.getCell(2,5)+"')";
