// JavaScript Document
window.app_saku2_report_gl_flJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flJurnal";
		this.maximize();
...
window.app_saku2_report_gl_flJurnal.extend(window.portalui_childForm);
window.app_saku2_report_gl_flJurnal.implement({
