...
//* 			SAI, PT											
//***********************************************************************************************
window.app_saku2_report_gl_flBukuBesar = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flBukuBesar.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flBukuBesar";
		this.maximize();
...
window.app_saku2_report_gl_flBukuBesar.extend(window.portalui_childForm);
window.app_saku2_report_gl_flBukuBesar.implement({
	...
	mainButtonClick: function(sender){
		try{
			...
			var sql = "call sp_bb ('"+this.kode_akun1+"','"+this.kode_akun2+"','"+this.sg1.getCell(2,0)+"','"+periode1+"','"+periode2+"','"+this.nik_user+"','"+tampilNol+"')";
			...
			this.page = 1;
			this.nama_report = "server_report_saku2_gl_rptBukuBesar";
        ...
        try{   
            if (result.rs.rows[0] !== undefined){
                ...
                var html ="<table width='900' border='1' cellspacing='0' cellpadding='1' class='kotak'>"+
                  "<tr>"+
                    "<td height='23' colspan='9' class='header_laporan'><table width='100%' border='0' cellspacing='2' cellpadding='1'>"+
                      "<tr>"+
                        "<td class='header_laporan'>Kode Akun  </td>"+
                        "<td class='header_laporan'>:&nbsp;"+line.kode_akun+"</td>"+
                      "</tr>"+
