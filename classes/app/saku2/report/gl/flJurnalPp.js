// JavaScript Document
window.app_saku2_report_gl_flJurnalPp = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flJurnalPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flJurnalPp";
		this.maximize();
...
window.app_saku2_report_gl_flJurnalPp.extend(window.portalui_childForm);
window.app_saku2_report_gl_flJurnalPp.implement({
