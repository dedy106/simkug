// JavaScript Document
window.app_saku2_report_gl_flNeraca = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flNeraca.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flNeraca";
		this.maximize();
...
window.app_saku2_report_gl_flNeraca.extend(window.portalui_childForm);
window.app_saku2_report_gl_flNeraca.implement({
