// JavaScript Document
window.app_saku2_report_gl_flLRTuAgg = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flLRTuAgg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flLRTuAgg";
		this.maximize();
...
window.app_saku2_report_gl_flLRTuAgg.extend(window.portalui_childForm);
window.app_saku2_report_gl_flLRTuAgg.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_gl_rptLRTuAgg";
				sql="call sp_neraca_tu_gar ('"+this.sg1.getCell(2,2)+"','L','"+in_lap+"',"+this.sg1.getCell(2,3)+",'"+this.sg1.getCell(2,1)+"','"+this.app._lokasi+"','"+this.app._nikUser+"')";
