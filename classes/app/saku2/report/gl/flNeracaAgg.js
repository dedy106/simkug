// JavaScript Document
window.app_saku2_report_gl_flNeracaAgg = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flNeracaAgg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flNeracaAgg";
		this.maximize();
...
window.app_saku2_report_gl_flNeracaAgg.extend(window.portalui_childForm);
window.app_saku2_report_gl_flNeracaAgg.implement({
