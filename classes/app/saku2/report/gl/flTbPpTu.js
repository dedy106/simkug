// JavaScript Document
window.app_saku2_report_gl_flTbPpTu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flTbPpTu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flTbPpTu";
		this.maximize();
...
window.app_saku2_report_gl_flTbPpTu.extend(window.portalui_childForm);
window.app_saku2_report_gl_flTbPpTu.implement({
		...
		try
		{
			...
			else
			{
				...
				if (this.sg1.getCell(2,4)=="Neraca Lajur")
				{
					...
					this.nama_report="server_report_saku2_gl_rptTBLajurPp";
