// JavaScript Document
window.app_saku2_report_gl_flTBJejer = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flTBJejer.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flTBJejer";
		this.maximize();
...
window.app_saku2_report_gl_flTBJejer.extend(window.portalui_childForm);
window.app_saku2_report_gl_flTBJejer.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			{
				var sql = "call sp_glma_jejer_tmp ('"+this.kode_lokasi+"','"+this.sg1.getCell(2,1)+"','"+this.nik_user+"')";
				this.nama_report="server_report_saku2_gl_rptTBJejer";
			}
			if (this.sg1.getCell(2,3)=="12 Periode")
			{
				var sql = "call sp_glma12_tmp ('"+this.sg1.getCell(2,1)+"','"+this.sg1.getCell(2,1)+"','"+this.nik_user+"')";
