// JavaScript Document
window.app_saku2_report_gl_flRkmaRekapBidang = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flRkmaRekapBidang.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flRkmaRekapBidang";
		this.maximize();
...
window.app_saku2_report_gl_flRkmaRekapBidang.extend(window.portalui_childForm);
window.app_saku2_report_gl_flRkmaRekapBidang.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_saku2_gl_rptRkmaRekapBidang";
