// JavaScript Document
window.app_saku2_report_gl_flTBJejerYakes = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flTBJejerYakes.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flTBJejerYakes";
		this.maximize();
...
window.app_saku2_report_gl_flTBJejerYakes.extend(window.portalui_childForm);
window.app_saku2_report_gl_flTBJejerYakes.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2 = this.nik_user+"/"+this.sg1.getCell(2,3)+"/"+this.sg1.getCell(2,1)+"/"+this.app._namaForm;
				...
				var sql = "call sp_glma_jejer_yakes_tmp ('"+this.kode_lokasi+"','"+this.sg1.getCell(2,1)+"','"+this.nik_user+"')";
				this.nama_report="server_report_saku2_gl_rptTBJejerYakes";
