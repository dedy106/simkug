...
window.app_saku2_report_gl_flJurnalBantu = function(owner)
{
	if (owner)
	{
		window.app_saku2_report_gl_flJurnalBantu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku2_report_gl_flJurnalBantu";
		this.maximize();
...
window.app_saku2_report_gl_flJurnalBantu.extend(window.portalui_childForm);
window.app_saku2_report_gl_flJurnalBantu.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			{
				this.nama_report="server_report_saku2_gl_rptJurnalBantu";
			}
			else
			{
