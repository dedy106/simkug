window.app_saku2_transaksi_tk_fClosing = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_tk_fClosing.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_tk_fClosing";
...
window.app_saku2_transaksi_tk_fClosing.extend(window.childForm);
window.app_saku2_transaksi_tk_fClosing.implement({
