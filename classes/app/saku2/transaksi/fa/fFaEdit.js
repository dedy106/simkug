window.app_saku2_transaksi_fa_fFaEdit = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_fa_fFaEdit.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_fa_fFaEdit";
		...
		this.cb_fa = new saiCBBL(this,{bound:[20,10,220,20],caption:"No Aktap",maxLength:20,btnClick:[this,"doBtnClick"],rightLabelVisible:false,change:[this,"doChange"]});
		this.e_nama = new portalui_saiLabelEdit(this,{bound:[20,18,432,20],caption:"Deskripsi",maxLength:150, tag:1});
		this.e_barcode = new portalui_saiLabelEdit(this,{bound:[20,20,432,20],caption:"Nomor Aset",maxLength:50, tag:1});		
...
window.app_saku2_transaksi_fa_fFaEdit.extend(window.childForm);
window.app_saku2_transaksi_fa_fFaEdit.implement({
	...
	doChange:function(sender){	
		if (sender == this.cb_fa && this.cb_fa.getText() != ""){
			...
			var strSQL = "select a.barcode,a.nama,a.no_seri,a.merk,a.tipe,a.nilai,a.nilai_residu,isnull(d.tot_susut,0) as tot_susut,(a.nilai-a.nilai_residu-isnull(d.tot_susut,0)) as nilai_buku,convert(varchar,a.tgl_perolehan,103) as tgl_perolehan,convert(varchar,a.tgl_susut,103) as tgl_susut,a.kode_klpakun,a.kode_klpfa, "+
						 "  b.kode_akun,x.nama as nama_akun,b.akun_bp,z.nama as nama_bp,b.akun_deprs,y.nama as nama_deprs,a.kode_pp,c.nama as nama_pp,a.umur,a.kode_pp_susut,c.nama as nama_pp_susut,bb.nama as nama_klp,b.nama as nama_klpakun,a.persen,a.jenis "+
						 "from fa_asset a  "+
		...
		try{
			if (sender == this.cb_fa) {   
			    this.standarLib.showListData(this, "Daftar Aktiva Tetap",sender,undefined, 
											  "select no_fa, nama  from fa_asset where progress = '2' and kode_lokasi='"+this.app._lokasi+"'",
											  "select count(no_fa) from fa_asset where progress = '2' and kode_lokasi='"+this.app._lokasi+"'",
