window.app_saku2_transaksi_fa_fFaInput = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_fa_fFaInput.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_fa_fFaInput";
		...
		this.e_periode = new portalui_saiLabelEdit(this,{bound:[20,14,202,20],caption:"Periode",tag:2,readOnly:false});
...
window.app_saku2_transaksi_fa_fFaInput.extend(window.childForm);
window.app_saku2_transaksi_fa_fFaInput.implement({
