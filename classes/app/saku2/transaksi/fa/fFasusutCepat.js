window.app_saku2_transaksi_fa_fFasusutCepat = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_fa_fFasusutCepat.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_fa_fFasusutCepat";
		...
		this.cb_fa = new saiCBBL(this,{bound:[20,18,220,20],caption:"No Aktiva Tetap", multiSelection:false, maxLength:20, tag:2, change:[this,"doChange"]});		
		...
		try {
			...
			this.cb_fa.setSQL("select a.no_fa, a.nama from fa_asset a "+
			        ...
			        "                where a.progress in ('2','L') and a.nilai-a.nilai_residu > isnull(tot_susut,0) and a.kode_lokasi='"+this.app._lokasi+"'",["a.no_fa","a.nama"],false,["No Aktap","Nama"],"and","Daftar Aktiva Tetap",true);
...
window.app_saku2_transaksi_fa_fFasusutCepat.extend(window.childForm);
window.app_saku2_transaksi_fa_fFasusutCepat.implement({
