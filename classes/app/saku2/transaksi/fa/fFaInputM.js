window.app_saku2_transaksi_fa_fFaInputM = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_fa_fFaInputM.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_fa_fFaInputM";
...
window.app_saku2_transaksi_fa_fFaInputM.extend(window.childForm);
window.app_saku2_transaksi_fa_fFaInputM.implement({
