window.app_saku2_transaksi_fa_fFaEditM = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_fa_fFaEditM.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_fa_fFaEditM";
...
window.app_saku2_transaksi_fa_fFaEditM.extend(window.childForm);
window.app_saku2_transaksi_fa_fFaEditM.implement({
