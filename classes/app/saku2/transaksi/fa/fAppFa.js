window.app_saku2_transaksi_fa_fAppFa = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_fa_fAppFa.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_fa_fAppFa";
...
window.app_saku2_transaksi_fa_fAppFa.extend(window.childForm);
window.app_saku2_transaksi_fa_fAppFa.implement({
	...
	doClick:function(sender){
		if (sender == this.i_gen) {
			this.e_nb.setText(this.standarLib.noBuktiOtomatis(this.dbLib,"fa_baps_m","no_baps",this.app._lokasi+"-BAST"+this.e_periode.getText().substr(2,4)+".","000"));
			this.e_ket.setFocus();
		}
