window.app_saku2_transaksi_fa_fAppFaE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_fa_fAppFaE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_fa_fAppFaE";
...
window.app_saku2_transaksi_fa_fAppFaE.extend(window.childForm);
window.app_saku2_transaksi_fa_fAppFaE.implement({
