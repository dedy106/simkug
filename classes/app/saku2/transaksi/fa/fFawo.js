window.app_saku2_transaksi_fa_fFawo = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_fa_fFawo.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_fa_fFawo";
		...
		try {
			...
			this.cb_fa.setSQL("select a.no_fa, a.nama from fa_asset a "+
			        ...
			        "                where a.progress in ('2','L') and a.nilai-isnull(tot_susut,0)>=a.nilai_residu and a.kode_lokasi='"+this.app._lokasi+"'",["a.no_fa","a.nama"],false,["No Aktap","Nama"],"and","Daftar Aktiva Tetap",true);
...
window.app_saku2_transaksi_fa_fFawo.extend(window.childForm);
window.app_saku2_transaksi_fa_fFawo.implement({
