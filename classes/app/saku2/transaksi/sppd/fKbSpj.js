window.app_saku2_transaksi_sppd_fKbSpj = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_sppd_fKbSpj.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_sppd_fKbSpj";
		...
		this.bTampil = new button(this,{bound:[660,17,80,18],caption:"Tampil Data",click:[this,"doLoad"]});			
		this.i_appAll = new portalui_imageButton(this,{bound:[750,17,20,20],hint:"Approve All",image:"icon/"+system.getThemes()+"/tabCont2.png",click:[this,"doClick"]});
...
window.app_saku2_transaksi_sppd_fKbSpj.extend(window.childForm);
window.app_saku2_transaksi_sppd_fKbSpj.implement({
	...
	doLoad:function(sender){
		var strSQL = "select 'INPROG' as status,a.no_spj,d.no_dokumen+' | '+a.no_ver as no_ver,convert(varchar,a.tanggal,103) as tanggal,a.keterangan,a.kode_pp,a.nik_buat+' - '+c.nama as pengaju,a.transport,a.harian,a.akun_uhar,a.kode_drk "+
					 ...
					 "where a.progress ='1' and a.periode<='"+this.e_periode.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"'";		
