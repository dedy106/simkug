window.app_saku2_transaksi_konten_fKonten = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_konten_fKonten.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_konten_fKonten";
...
window.app_saku2_transaksi_konten_fKonten.extend(window.childForm);
window.app_saku2_transaksi_konten_fKonten.implement({
	...
	doChange:function(sender){
		if (this.cb_loker.getText()!="") {
			this.cb_buat.setSQL("select nik, nama from karyawan where kode_loker ='"+this.cb_loker.getText()+"' and kode_lokasi='"+this.app._lokasi+"'",["nik","nama"],false,["NIK","Nama"],"and","Data NIK Pembuat",true);			
		}
	},
