window.app_saku2_transaksi_kpa_fKpaVer = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kpa_fKpaVer.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kpa_fKpaVer";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Verifikasi Permohonan : Input", 0);	
		...
		this.pc1 = new pageControl(this,{bound:[20,18,980,480], childPage:["Data Permohonan","Detail Permohonan","Akun Verifikasi","Data KPA"]});				
		this.sg = new saiGrid(this.pc1.childPage[0],{bound:[1,10,this.pc1.width-5,this.pc1.height-40],colCount:9,tag:0,
		            colTitle:["No Bukti","Tanggal","Due Date","No Dokumen","Nilai","Untuk Pembayaran","Pihak Ketiga","PP","Pemohon"],
					colWidth:[[8,7,6,5,4,3,2,1,0],[100,100,150,200,100,150,80,80,100]],
					readOnly:true,colFormat:[[4],[cfNilai]],
					dblClick:[this,"doDoubleClick"],autoAppend:false,defaultRow:1});		
		this.sgn = new portalui_sgNavigator(this.pc1.childPage[0],{bound:[1,this.pc1.height-25,this.pc1.width-1,25],buttonStyle:3,grid:this.sg,pager:[this,"doPager"]});
						
		this.c_status = new saiCB(this.pc1.childPage[1],{bound:[20,10,202,20],caption:"Status Approval",items:["APPROVE","REJECT","RETURN"], readOnly:true,tag:2,change:[this,"doChange"]});
		...
		this.e_total = new saiLabelEdit(this.pc1.childPage[1],{bound:[770,12,200,20],caption:"Total", tag:1, readOnly:true, tipeText:ttNilai, text:"0"});		
		...
		this.sg4 = new saiGrid(this.pc1.childPage[3],{bound:[1,10,this.pc1.width-5,this.pc1.height-40],colCount:9,tag:9,
...
window.app_saku2_transaksi_kpa_fKpaVer.extend(window.childForm);
window.app_saku2_transaksi_kpa_fKpaVer.implement({
	...
	simpan: function(){			
		try{		
			this.e_nb.setText(this.standarLib.noBuktiOtomatis(this.dbLib,"itt_ver_m","no_ver",this.app._lokasi+"-VER"+this.e_periode.getText().substr(2,4)+".","0000"));		
	...
	doLoad:function(sender){		
		var strSQL = "select no_kpa,convert(varchar,a.tanggal,103) as tanggal,convert(varchar,a.due_date,103) as due_date,a.no_dokumen,a.nilai,a.keterangan,a.vendor,b.kode_pp+' - '+b.nama as pp,c.nik+' - '+c.nama as pemohon "+
		             "from itt_kpa_m a "+
	...
	doTampilData: function(page) {
		...
		for (var i=start;i<finish;i++){
			...
			this.sg.appendData([line.no_kpa,line.tanggal,line.due_date,line.no_dokumen,floatToNilai(line.nilai),line.keterangan,line.vendor,line.pp,line.pemohon]);
		}
