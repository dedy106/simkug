window.app_saku2_transaksi_kpa_fKbPtg = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kpa_fKbPtg.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kpa_fKbPtg";
		...
		this.e_nb = new portalui_saiLabelEdit(this,{bound:[20,12,202,20],caption:"Bukti Masuk",maxLength:30,readOnly:true});		
...
window.app_saku2_transaksi_kpa_fKbPtg.extend(window.childForm);
window.app_saku2_transaksi_kpa_fKbPtg.implement({
	...
	doClick:function(sender){
		this.e_nb.setText(this.standarLib.noBuktiOtomatis(this.dbLib,"kas_m","no_kas",this.app._lokasi+"-BM"+this.e_periode.getText().substr(2,4)+".","000"));
		this.e_nokk.setText(this.standarLib.noBuktiOtomatis(this.dbLib,"kas_m","no_kas",this.app._lokasi+"-BK"+this.e_periode.getText().substr(2,4)+".","000"));									
		this.e_dok.setFocus()
	},			
	...
	doLoad:function(sender){		
		//"No Bukti","No Panjar","Tanggal","No Dokumen","Keterangan","Nilai Panjar","Nilai Perttg.","Nilai Kas","Kode Akun","PP","Pemohon"
		var strSQL = "select a.no_ptg,a.no_panjar,convert(varchar,a.tanggal,103) as tanggal,a.no_dokumen,a.keterangan,a.nilai_pj,a.nilai,a.nilai_kas,a.akun_panjar,b.kode_pp+' - '+b.nama as pp,c.nik+' - '+c.nama as pemohon "+
					 ...
					 "where a.periode<='"+this.e_periode.getText()+"' and a.progress='1' and a.nilai_kas<>0";			
