window.app_saku2_transaksi_kpa_fPjAju = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kpa_fPjAju.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kpa_fPjAju";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Input Permohonan Panjar: Input", 0);	
...
window.app_saku2_transaksi_kpa_fPjAju.extend(window.childForm);
window.app_saku2_transaksi_kpa_fPjAju.implement({
	...
	doModalResult: function(event, modalResult){
		...
		switch (event){
			...
			case "simpan" :		
				...
				*/
				// proteksi user pp di lepas dulu
				for (var i=0;i < this.sg.getRowCount();i++){
					if (!this.sg.rowValid(i)){
						var isKosong = true;
	...
	doClick:function(sender){
		this.e_nb.setText(this.standarLib.noBuktiOtomatis(this.dbLib,"itt_panjar_m","no_panjar",this.app._lokasi+"-PJ"+this.e_periode.getText().substr(2,4)+".","0000"));
		this.e_dok.setFocus();
	},
