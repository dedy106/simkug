window.app_saku2_transaksi_kpa_fKpa = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kpa_fKpa.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kpa_fKpa";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Input Permohonan KasBank: Input", 0);	
		...
		this.pc1 = new pageControl(this,{bound:[20,12,980,307], childPage:["Item Mata Anggaran","KPA Anggaran"]});
...
window.app_saku2_transaksi_kpa_fKpa.extend(window.childForm);
window.app_saku2_transaksi_kpa_fKpa.implement({
	...
	doClick:function(sender){
		this.e_nb.setText(this.standarLib.noBuktiOtomatis(this.dbLib,"itt_kpa_m","no_kpa",this.app._lokasi+"-KPA"+this.e_periode.getText().substr(2,4)+".","0000"));
		this.e_dok.setFocus();
	},
