window.app_saku2_transaksi_siaga_fNpko = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_siaga_fNpko.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_siaga_fNpko";
		...
		this.sg = new saiGrid(this.pc1.childPage[0],{bound:[1,10,this.pc1.width-5,this.pc1.height-40],colCount:10,tag:0,
					...
					columnReadOnly:[true,[1,4,6,7,8,9],[0,2,3,5]],
...
window.app_saku2_transaksi_siaga_fNpko.extend(window.childForm);
window.app_saku2_transaksi_siaga_fNpko.implement({
					...
					if (this.sg.getRowValidCount() > 0){
						for (var i=0;i < this.sg.getRowCount();i++){
							if (this.sg.rowValid(i)){
								sql.add("insert into gr_npko_d(no_npko,kode_lokasi,no_urut,kode_akun,kode_pp,kode_drk,periode,nilai,gar_tahun,gar_bulan,gar_sd,dc,no_spb) values "+
