window.app_saku2_transaksi_siaga_fBillVccE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_siaga_fBillVccE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_siaga_fBillVccE";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Biling VCC: Edit", 0);	
...
window.app_saku2_transaksi_siaga_fBillVccE.extend(window.childForm);
window.app_saku2_transaksi_siaga_fBillVccE.implement({	
		...
		try{									
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					sql.add("delete from gr_vcc_m where no_vcc='"+this.e_nb.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");
					sql.add("delete from gr_vcc_j where no_vcc='"+this.e_nb.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");					
					sql.add("delete from gr_vcc_d where no_vcc='"+this.e_nb.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");					
					...
					var data = this.dbLib.getDataProvider("select akun_ar,akun_pot_pend,akun_pend,akun_ppn,akun_biaya,akun_materai from gr_vcc where kode_cabang = '"+this.cb_cabang.getText()+"'",true);
					if (typeof data == "object"){
						...
						if (line != undefined){	
							...
							sql.add("insert into gr_vcc_j(no_vcc,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,kode_curr,kurs,nilai_curr,nilai,kode_pp,kode_drk,kode_lokasi,modul,jenis,periode,nik_user,tgl_input) values "+
									"('"+this.e_nb.getText()+"','-','"+this.dp_d1.getDateString()+"',0,'"+line.akun_ar+"','"+this.e_ket.getText()+"','D','IDR',1,"+parseNilai(this.e_total.getText())+","+parseNilai(this.e_total.getText())+",'"+this.cb_pp.getText()+"','-','"+this.app._lokasi+"','VCC','PIUTANG','"+this.e_periode.getText()+"','"+this.app._userLog+"',getdate())");
							if (this.e_diskon.getText() != "0")
							sql.add("insert into gr_vcc_j(no_vcc,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,kode_curr,kurs,nilai_curr,nilai,kode_pp,kode_drk,kode_lokasi,modul,jenis,periode,nik_user,tgl_input) values "+
									"('"+this.e_nb.getText()+"','-','"+this.dp_d1.getDateString()+"',1,'"+line.akun_pot_pend+"','"+this.e_ket.getText()+"','D','IDR',1,"+parseNilai(this.e_diskon.getText())+","+parseNilai(this.e_diskon.getText())+",'"+this.cb_pp.getText()+"','"+this.cb_drk.getText()+"','"+this.app._lokasi+"','VCC','DISKON','"+this.e_periode.getText()+"','"+this.app._userLog+"',getdate())");
							if (this.e_nilai.getText() != "0")
							sql.add("insert into gr_vcc_j(no_vcc,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,kode_curr,kurs,nilai_curr,nilai,kode_pp,kode_drk,kode_lokasi,modul,jenis,periode,nik_user,tgl_input) values "+
									"('"+this.e_nb.getText()+"','-','"+this.dp_d1.getDateString()+"',2,'"+line.akun_pend+"','"+this.e_ket.getText()+"','C','IDR',1,"+parseNilai(this.e_nilai.getText())+","+parseNilai(this.e_nilai.getText())+",'"+this.cb_pp.getText()+"','"+this.cb_drk.getText()+"','"+this.app._lokasi+"','VCC','PEND','"+this.e_periode.getText()+"','"+this.app._userLog+"',getdate())");
							if (this.e_biaya.getText() != "0")
							sql.add("insert into gr_vcc_j(no_vcc,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,kode_curr,kurs,nilai_curr,nilai,kode_pp,kode_drk,kode_lokasi,modul,jenis,periode,nik_user,tgl_input) values "+
									"('"+this.e_nb.getText()+"','-','"+this.dp_d1.getDateString()+"',3,'"+line.akun_biaya+"','"+this.e_ket.getText()+"','C','IDR',1,"+parseNilai(this.e_biaya.getText())+","+parseNilai(this.e_biaya.getText())+",'"+this.cb_pp.getText()+"','"+this.cb_drk.getText()+"','"+this.app._lokasi+"','VCC','BIAYA','"+this.e_periode.getText()+"','"+this.app._userLog+"',getdate())");
							if (this.e_materai.getText() != "0")
							sql.add("insert into gr_vcc_j(no_vcc,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,kode_curr,kurs,nilai_curr,nilai,kode_pp,kode_drk,kode_lokasi,modul,jenis,periode,nik_user,tgl_input) values "+
									"('"+this.e_nb.getText()+"','-','"+this.dp_d1.getDateString()+"',4,'"+line.akun_materai+"','"+this.e_ket.getText()+"','C','IDR',1,"+parseNilai(this.e_materai.getText())+","+parseNilai(this.e_materai.getText())+",'"+this.cb_pp.getText()+"','"+this.cb_drk.getText()+"','"+this.app._lokasi+"','VCC','MATERAI','"+this.e_periode.getText()+"','"+this.app._userLog+"',getdate())");
							if (this.e_ppn.getText() != "0")
							sql.add("insert into gr_vcc_j(no_vcc,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,kode_curr,kurs,nilai_curr,nilai,kode_pp,kode_drk,kode_lokasi,modul,jenis,periode,nik_user,tgl_input) values "+
									"('"+this.e_nb.getText()+"','-','"+this.dp_d1.getDateString()+"',5,'"+line.akun_ppn+"','"+this.e_ket.getText()+"','C','IDR',1,"+parseNilai(this.e_ppn.getText())+","+parseNilai(this.e_ppn.getText())+",'"+this.cb_pp.getText()+"','"+this.cb_drk.getText()+"','"+this.app._lokasi+"','VCC','PPN','"+this.e_periode.getText()+"','"+this.app._userLog+"',getdate())");
						} 
					}
	...
	doChange:function(sender){		
		if (sender == this.e_periode || sender == this.cb_cabang) {
			if (this.e_periode.getText()!="" && this.cb_cabang.getText()!="") 
				this.e_nb.setSQL("select no_vcc,keterangan from gr_vcc_m where posted='F' and kode_cabang='"+this.cb_cabang.getText()+"' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"'",["no_vcc","keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);							 		
		}
		...
		if (sender == this.e_nb && this.e_nb.getText()!="") {						
			var data = this.dbLib.getDataProvider("select a.periode,a.tanggal,a.keterangan,a.kode_pp,b.nama as nama_pp,a.nik_buat,c.nama as nama_buat,a.nik_app,d.nama as nama_app,a.kode_drk,e.nama as nama_drk "+
			           "from gr_vcc_m a inner join pp b on a.kode_pp = b.kode_pp and a.kode_lokasi=b.kode_lokasi "+	
					   ...
					   "where a.no_vcc='"+this.e_nb.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"'",true);
			if (typeof data == "object"){
				var line = data.rs.rows[0];							
				if (line != undefined){					
			...
			this.cb_inv.setSQL("select no_invoice,nama_cust from gr_vcc_d where no_vcc = '"+this.e_nb.getText()+"' and kode_lokasi='"+this.app._lokasi+"'",["no_invoice","nama_cust"],false,["No Invoice","Nama Cust"],"and","Daftar Invoice",true);							 		
		}		
		if (sender == this.cb_inv && this.cb_inv.getText()!="") {			
			var strSQL = "select a.nama_cust,a.nilai,a.diskon,a.neto,a.ppn,a.biaya,a.materai,a.total,isnull(c.bayar,0) as bayar "+
						 ...
						 "where a.no_invoice ='"+this.cb_inv.getText()+"' and a.no_vcc='"+this.e_nb.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"'";			
