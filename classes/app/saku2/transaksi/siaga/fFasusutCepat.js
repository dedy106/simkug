window.app_saku2_transaksi_siaga_fFasusutCepat = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_siaga_fFasusutCepat.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_siaga_fFasusutCepat";
...
window.app_saku2_transaksi_siaga_fFasusutCepat.extend(window.childForm);
window.app_saku2_transaksi_siaga_fFasusutCepat.implement({
