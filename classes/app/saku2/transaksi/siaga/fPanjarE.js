window.app_saku2_transaksi_siaga_fPanjarE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_siaga_fPanjarE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_siaga_fPanjarE";
...
window.app_saku2_transaksi_siaga_fPanjarE.extend(window.childForm);
window.app_saku2_transaksi_siaga_fPanjarE.implement({
	...
	doChange:function(sender){		
		...
		if (sender == this.e_nb && this.e_nb.getText()!="") {
			...
			var data = this.dbLib.getDataProvider("select a.tanggal,a.periode,a.no_dokumen,a.due_date,a.keterangan,a.nik_buat,b.nama as nama_buat,a.nik_app,bb.nama as nama_app,a.kode_curr,a.kurs,a.kode_pp,c.nama as nama_pp,a.akun_panjar,d.nama as nama_panjar "+
			           "from gr_panjar_m a "+
			...
			var data = this.dbLib.getDataProvider(
						...
						"where a.no_bukti = '"+this.e_nb.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' and a.modul='PANJAR' order by a.kode_akun",true);
			if (typeof data == "object" && data.rs.rows[0] != undefined){
				var line;
				this.sg2.clear();
				for (var i in data.rs.rows){
