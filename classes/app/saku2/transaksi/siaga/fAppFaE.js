window.app_saku2_transaksi_siaga_fAppFaE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_siaga_fAppFaE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_siaga_fAppFaE";
...
window.app_saku2_transaksi_siaga_fAppFaE.extend(window.childForm);
window.app_saku2_transaksi_siaga_fAppFaE.implement({
		...
		try{									
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{													
					...
					sql.add("update fa_asset set progress='1',no_baps='-' where no_baps='"+this.e_nb.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");
	...
	doLoad:function(sender){
		var strSQL = "select 'APP' as status,no_fa,nama,kode_akun,nilai from fa_asset where no_baps='"+this.e_nb.getText()+"' and kode_lokasi='"+this.app._lokasi+"'";
