window.app_saku2_transaksi_siaga_fLoadVcc = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_siaga_fLoadVcc.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_siaga_fLoadVcc";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Biling VCC: Load", 0);	
...
window.app_saku2_transaksi_siaga_fLoadVcc.extend(window.childForm);
window.app_saku2_transaksi_siaga_fLoadVcc.implement({
