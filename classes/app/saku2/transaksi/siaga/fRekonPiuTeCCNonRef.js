window.app_saku2_transaksi_siaga_fRekonPiuTeCCNonRef = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_siaga_fRekonPiuTeCCNonRef.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_siaga_fRekonPiuTeCCNonRef";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Rekon Piutang TeCC", 0);	
...
window.app_saku2_transaksi_siaga_fRekonPiuTeCCNonRef.extend(window.childForm);
window.app_saku2_transaksi_siaga_fRekonPiuTeCCNonRef.implement({
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					if (this.e_pph.getText()!="0" || this.e_lain.getText()!="0") {						
						...
						sql.add("insert into gr_teccbayar_d(no_bukti,kode_lokasi,no_invoice,akun_piutang,nilai_kas,nilai_lain,periode,dc,modul,akun_pph,akun_lain) values "+
						...
						sql.add("insert into ju_m(no_ju,kode_lokasi,periode,tanggal,no_dokumen,keterangan,kode_pp,modul,jenis,kode_curr,kurs,nilai,nik_buat,nik_setuju,posted,no_del,no_link,ref1,tgl_input,nik_user) values "+
								"('"+this.e_nb.getText()+"','"+this.app._lokasi+"','"+this.e_periode.getText()+"','"+this.dp_d1.getDateString()+"','"+this.cb_inv.getText()+"','Penyelesaian atas Invoice : "+this.cb_inv.getText()+"','-','REKTPCC','JU','IDR',1,"+pphLain+",'"+this.app._userLog+"','"+this.app._userLog+"','F','-','-','"+this.cb_inv.getText()+"',getdate(),'"+this.app._userLog+"')");		
						...
						if (this.e_pph.getText()!="0") {		
							sql.add("insert into ju_j(no_ju,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,nilai,kode_pp,kode_drk,kode_cust,kode_proyek,kode_task,kode_vendor,kode_lokarea,nik,kode_lokasi,modul,jenis,periode,kode_curr,kurs,nik_user,tgl_input,no_ref,ket_ref) values "+
									"('"+this.e_nb.getText()+"','"+this.cb_inv.getText()+"','"+this.dp_d1.getDateString()+"',0,'"+this.cb_pph.getText()+"','PPh atas Invoice : "+this.cb_inv.getText()+"','D',"+parseNilai(this.e_pph.getText())+",'"+this.app._kodePP+"','-','-','-','-','-','-','-','"+this.app._lokasi+"','REKTPCC','PPH','"+this.e_periode.getText()+"','IDR',1,'"+this.app._userLog+"',getdate(),'-','-')");
							sql.add("insert into ju_j(no_ju,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,nilai,kode_pp,kode_drk,kode_cust,kode_proyek,kode_task,kode_vendor,kode_lokarea,nik,kode_lokasi,modul,jenis,periode,kode_curr,kurs,nik_user,tgl_input,no_ref,ket_ref) values "+
									"('"+this.e_nb.getText()+"','"+this.cb_inv.getText()+"','"+this.dp_d1.getDateString()+"',1,'"+this.akunAR+"','Penyelesaian atas Invoice : "+this.cb_inv.getText()+"','C',"+parseNilai(this.e_pph.getText())+",'"+this.app._kodePP+"','-','-','-','-','-','-','-','"+this.app._lokasi+"','REKTPCC','PIU','"+this.e_periode.getText()+"','IDR',1,'"+this.app._userLog+"',getdate(),'-','-')");
						}

						if (this.e_lain.getText()!="0") {
							sql.add("insert into ju_j(no_ju,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,nilai,kode_pp,kode_drk,kode_cust,kode_proyek,kode_task,kode_vendor,kode_lokarea,nik,kode_lokasi,modul,jenis,periode,kode_curr,kurs,nik_user,tgl_input,no_ref,ket_ref) values "+
									"('"+this.e_nb.getText()+"','"+this.cb_inv.getText()+"','"+this.dp_d1.getDateString()+"',2,'"+this.cb_lain.getText()+"','Penyelesaian atas Invoice : "+this.cb_inv.getText()+"','D',"+parseNilai(this.e_lain.getText())+",'"+this.app._kodePP+"','-','-','-','-','-','-','-','"+this.app._lokasi+"','REKTPCC','LAIN','"+this.e_periode.getText()+"','IDR',1,'"+this.app._userLog+"',getdate(),'-','-')");
							sql.add("insert into ju_j(no_ju,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,nilai,kode_pp,kode_drk,kode_cust,kode_proyek,kode_task,kode_vendor,kode_lokarea,nik,kode_lokasi,modul,jenis,periode,kode_curr,kurs,nik_user,tgl_input,no_ref,ket_ref) values "+
									"('"+this.e_nb.getText()+"','"+this.cb_inv.getText()+"','"+this.dp_d1.getDateString()+"',3,'"+this.akunAR+"','Penyelesaian atas Invoice : "+this.cb_inv.getText()+"','C',"+parseNilai(this.e_lain.getText())+",'"+this.app._kodePP+"','-','-','-','-','-','-','-','"+this.app._lokasi+"','REKTPCC','PIU','"+this.e_periode.getText()+"','IDR',1,'"+this.app._userLog+"',getdate(),'-','-')");		
						}
