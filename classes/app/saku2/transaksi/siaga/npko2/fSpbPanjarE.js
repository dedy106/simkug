window.app_saku2_transaksi_siaga_npko2_fSpbPanjarE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_siaga_npko2_fSpbPanjarE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_siaga_npko2_fSpbPanjarE";
		...
		this.cb_panjar = new saiCBBL(this,{bound:[20,17,220,20],caption:"No Panjar", readOnly:true});
...
window.app_saku2_transaksi_siaga_npko2_fSpbPanjarE.extend(window.childForm);
window.app_saku2_transaksi_siaga_npko2_fSpbPanjarE.implement({
		...
		try{									
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					sql.add("update gr_panjar_m set no_spb='-' where no_spb='"+this.e_nb.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");
	...
	doChange:function(sender){
		if (sender == this.e_periode) {			
			if (this.e_periode.getText()!="") {
				this.e_nb.setSQL("select no_spb, keterangan from gr_spb_m where jenis = 'PANJAR' and no_kas='-' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"'",["no_spb","keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);
			}			
		}
		//
		if (sender == this.e_nb && this.e_nb.getText()!="") {
			this.cb1.setSelected(true);			
			var strSQL = "select b.no_panjar,b.keterangan as ket_pj,a.tanggal,a.due_date,a.keterangan,a.kode_curr,a.kurs,a.nik_buat,a.nik_setuju,c.nik as nik_pj,c.nama as nama_pj,a.kode_pp,a.nilai,a.periode,  a.no_po,a.tgl_po,a.tgl_ba,a.no_dok,a.no_ref,a.tgl_dok "+
			             "from gr_spb_m a inner join gr_panjar_m b on a.no_spb=b.no_spb and a.kode_lokasi=b.kode_lokasi "+
						 "                inner join karyawan c on c.nik=b.nik_buat and b.kode_lokasi=c.kode_lokasi  "+
			...
			if (typeof data == "object"){
				...
				if (line != undefined){
					...
					this.cb_nik.setText(line.nik_pj,line.nama_pj);
