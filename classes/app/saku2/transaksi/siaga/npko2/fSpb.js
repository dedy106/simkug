window.app_saku2_transaksi_siaga_npko2_fSpb = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_siaga_npko2_fSpb.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_siaga_npko2_fSpb";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Input SPB via NPP: Input", 0);	
		...
		this.cb_app = new saiCBBL(this,{bound:[20,17,200,20],caption:"Mgr/GM Finance", multiSelection:false, maxLength:10, tag:2});		
		...
		this.cb_npp = new saiCBBL(this,{bound:[20,17,220,20],caption:"No NPP", multiSelection:false, maxLength:10, tag:1,change:[this,"doChange"]});
...
window.app_saku2_transaksi_siaga_npko2_fSpb.extend(window.childForm);
window.app_saku2_transaksi_siaga_npko2_fSpb.implement({
	...
	doChange:function(sender){
		if (sender == this.e_periode) {
			if (this.e_periode.getText()!="") {
				var strSQL = "select no_npp,keterangan from gr_npp_m where no_spb='-' and periode<='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"'";
				this.cb_npp.setSQL(strSQL,["no_npp","keterangan"],false,["No NPP","Deskripsi"],"and","Data NPP",true);			
			}
		}
		if (sender == this.cb_npp && this.cb_npp.getText()!="") {
			var strSQL = "select a.kode_akun,a.kode_pp,a.kode_drk,a.nilai,a.nilai_curr,b.nama as nama_akun,c.nama as nama_pp,d.nama as nama_drk,a.periode,a.dc,a.keterangan,f.kode_vendor,f.nama as nama_vendor,a.kode_curr,a.kurs,e.nilai_ppn "+
						 ...
						 "                 inner join gr_vendor f on f.kode_vendor=e.kode_vendor and e.kode_lokasi=f.kode_lokasi "+
