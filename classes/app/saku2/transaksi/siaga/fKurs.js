window.app_saku2_transaksi_siaga_fKurs = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_siaga_fKurs.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_siaga_fKurs";
...
window.app_saku2_transaksi_siaga_fKurs.extend(window.childForm);
window.app_saku2_transaksi_siaga_fKurs.implement({
