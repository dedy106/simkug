window.app_saku2_transaksi_siaga_fBillTeCC = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_siaga_fBillTeCC.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_siaga_fBillTeCC";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Biling TeCC: Input", 0);	
...
window.app_saku2_transaksi_siaga_fBillTeCC.extend(window.childForm);
window.app_saku2_transaksi_siaga_fBillTeCC.implement({	
