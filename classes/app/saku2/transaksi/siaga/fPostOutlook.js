window.app_saku2_transaksi_siaga_fPostOutlook = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_siaga_fPostOutlook.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_siaga_fPostOutlook";
...
window.app_saku2_transaksi_siaga_fPostOutlook.extend(window.childForm);
window.app_saku2_transaksi_siaga_fPostOutlook.implement({
	...
	doLoad:function(sender){		
		if (this.e_tahun.getText() != "") {						
			this.sg.clear();
			sql="call sp_agg_rkap_total_inv ('FS1','0','"+this.e_tahun.getText()+"','00','01','99','1','3','"+this.app._nikUser+"','"+this.e_periode.getText()+"')";
			...
			sql="call sp_agg_rkap_total_inv ('FS1','0','"+this.e_tahun.getText()+"','00','01','99','4','4','"+this.app._nikUser+"','"+this.e_periode.getText()+"')";
			this.dbLib.execQuerySync(sql);	
