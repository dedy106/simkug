window.app_saku2_transaksi_siaga_fLoadVccE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_siaga_fLoadVccE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_siaga_fLoadVccE";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Biling VCC: Pembatalan", 0);	
...
window.app_saku2_transaksi_siaga_fLoadVccE.extend(window.childForm);
window.app_saku2_transaksi_siaga_fLoadVccE.implement({	
	...
	doChange:function(sender){		
		...
		if (sender == this.e_nb && this.e_nb.getText()!="") {						
			...
			var strSQL = "select a.no_invoice,a.nama_cust,a.nilai,a.diskon,a.neto,a.ppn,a.biaya,a.materai,a.total,isnull(c.bayar,0) as bayar "+
						 ...
						 "where a.no_vcc='"+this.e_nb.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"'";
