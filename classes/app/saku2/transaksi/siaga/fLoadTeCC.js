window.app_saku2_transaksi_siaga_fLoadTeCC = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_siaga_fLoadTeCC.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_siaga_fLoadTeCC";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Biling TeCC: Load", 0);	
...
window.app_saku2_transaksi_siaga_fLoadTeCC.extend(window.childForm);
window.app_saku2_transaksi_siaga_fLoadTeCC.implement({
