window.app_saku2_transaksi_siaga_fTeCCBatal = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_siaga_fTeCCBatal.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_siaga_fTeCCBatal";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Pembatalan Invoice TeCC: Input", 0);	
		...
		this.e_notecc = new saiLabelEdit(this,{bound:[20,12,450,20],caption:"No TeCC", readOnly:true});						
...
window.app_saku2_transaksi_siaga_fTeCCBatal.extend(window.childForm);
window.app_saku2_transaksi_siaga_fTeCCBatal.implement({
		...
		try{						
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					var data = this.dbLib.getDataProvider("select * from gr_tecc where kode_cabang='"+this.cb_cabang.getText()+"' ",true);
					if (typeof data == "object"){
						var line = data.rs.rows[0];							
						if (line != undefined){							
					...
					//reverse yang lama
					/*
					sql.add("update gr_tecc_d set no_invoice='"+this.e_nb.getText()+"' where no_tecc='"+this.e_notecc.getText()+"' and no_invoice='"+this.cb_inv.getText()+"' and kode_lokasi='"+this.app._lokasi+"' ");
					...
					*/
					sql.add("delete from gr_tecc_d where no_tecc='"+this.e_notecc.getText()+"' and no_invoice='"+this.cb_inv.getText()+"' and kode_lokasi='"+this.app._lokasi+"' ");
					...
					sql.add("insert into gr_tecc_j(no_tecc,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,kode_curr,kurs,nilai_curr,nilai,kode_pp,kode_drk,kode_lokasi,modul,jenis,periode,nik_user,tgl_input) values "+
							"('"+this.e_nb.getText()+"','"+this.cb_inv.getText()+"','"+this.dp_d1.getDateString()+"',0,'"+this.akunAR+"','"+this.e_ket.getText()+"','C','IDR',1,"+this.totalLama+","+this.totalLama+",'"+this.app._kodePP+"','-','"+this.app._lokasi+"','RTECC','PIUTANG','"+this.e_periode.getText()+"','"+this.app._userLog+"',getdate())");					
					if (this.diskonLama != 0)
					sql.add("insert into gr_tecc_j(no_tecc,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,kode_curr,kurs,nilai_curr,nilai,kode_pp,kode_drk,kode_lokasi,modul,jenis,periode,nik_user,tgl_input) values "+
							"('"+this.e_nb.getText()+"','"+this.cb_inv.getText()+"','"+this.dp_d1.getDateString()+"',1,'"+this.akunPotPdpt+"','"+this.e_ket.getText()+"','C','IDR',1,"+this.diskonLama+","+this.diskonLama+",'"+this.app._kodePP+"','"+this.kodeDRK+"','"+this.app._lokasi+"','RTECC','DISKON','"+this.e_periode.getText()+"','"+this.app._userLog+"',getdate())");					
					if (this.nilaiLama != 0)
					sql.add("insert into gr_tecc_j(no_tecc,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,kode_curr,kurs,nilai_curr,nilai,kode_pp,kode_drk,kode_lokasi,modul,jenis,periode,nik_user,tgl_input) values "+
							"('"+this.e_nb.getText()+"','"+this.cb_inv.getText()+"','"+this.dp_d1.getDateString()+"',2,'"+this.akunPdpt+"','"+this.e_ket.getText()+"','D','IDR',1,"+this.nilaiLama+","+this.nilaiLama+",'"+this.app._kodePP+"','"+this.kodeDRK+"','"+this.app._lokasi+"','RTECC','PEND','"+this.e_periode.getText()+"','"+this.app._userLog+"',getdate())");
					if (this.biayaLama != 0)
					sql.add("insert into gr_tecc_j(no_tecc,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,kode_curr,kurs,nilai_curr,nilai,kode_pp,kode_drk,kode_lokasi,modul,jenis,periode,nik_user,tgl_input) values "+
							"('"+this.e_nb.getText()+"','"+this.cb_inv.getText()+"','"+this.dp_d1.getDateString()+"',3,'"+this.akunBiaya+"','"+this.e_ket.getText()+"','D','IDR',1,"+this.biayaLama+","+this.biayaLama+",'"+this.app._kodePP+"','"+this.kodeDRK+"','"+this.app._lokasi+"','RTECC','BIAYA','"+this.e_periode.getText()+"','"+this.app._userLog+"',getdate())");
					if (this.matLama != 0)
					sql.add("insert into gr_tecc_j(no_tecc,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,kode_curr,kurs,nilai_curr,nilai,kode_pp,kode_drk,kode_lokasi,modul,jenis,periode,nik_user,tgl_input) values "+
							"('"+this.e_nb.getText()+"','"+this.cb_inv.getText()+"','"+this.dp_d1.getDateString()+"',4,'"+this.akunMat+"','"+this.e_ket.getText()+"','D','IDR',1,"+this.matLama+","+this.matLama+",'"+this.app._kodePP+"','"+this.kodeDRK+"','"+this.app._lokasi+"','RTECC','MATERAI','"+this.e_periode.getText()+"','"+this.app._userLog+"',getdate())");
					if (this.ppnLama != 0)
					sql.add("insert into gr_tecc_j(no_tecc,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,kode_curr,kurs,nilai_curr,nilai,kode_pp,kode_drk,kode_lokasi,modul,jenis,periode,nik_user,tgl_input) values "+
							"('"+this.e_nb.getText()+"','"+this.cb_inv.getText()+"','"+this.dp_d1.getDateString()+"',5,'"+this.akunPPN+"','"+this.e_ket.getText()+"','D','IDR',1,"+this.ppnLama+","+this.ppnLama+",'"+this.app._kodePP+"','"+this.kodeDRK+"','"+this.app._lokasi+"','RTECC','PPN','"+this.e_periode.getText()+"','"+this.app._userLog+"',getdate())");
					...
					sql.add("insert into gr_tecc_j(no_tecc,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,kode_curr,kurs,nilai_curr,nilai,kode_pp,kode_drk,kode_lokasi,modul,jenis,periode,nik_user,tgl_input) values "+
							"('"+this.e_nb.getText()+"','"+this.cb_inv.getText()+"','"+this.dp_d1.getDateString()+"',0,'"+this.akunAR+"','"+this.e_ket.getText()+"','D','IDR',1,"+parseNilai(this.e_total.getText())+","+parseNilai(this.e_total.getText())+",'"+this.app._kodePP+"','-','"+this.app._lokasi+"','TECC','PIUTANG','"+this.e_periode.getText()+"','"+this.app._userLog+"',getdate())");
					if (this.e_diskon.getText() != "0")
					sql.add("insert into gr_tecc_j(no_tecc,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,kode_curr,kurs,nilai_curr,nilai,kode_pp,kode_drk,kode_lokasi,modul,jenis,periode,nik_user,tgl_input) values "+
							"('"+this.e_nb.getText()+"','"+this.cb_inv.getText()+"','"+this.dp_d1.getDateString()+"',1,'"+this.akunPotPdpt+"','"+this.e_ket.getText()+"','D','IDR',1,"+parseNilai(this.e_diskon.getText())+","+parseNilai(this.e_diskon.getText())+",'"+this.app._kodePP+"','"+this.kodeDRK+"','"+this.app._lokasi+"','TECC','DISKON','"+this.e_periode.getText()+"','"+this.app._userLog+"',getdate())");
					if (this.e_nilai.getText() != "0")
					sql.add("insert into gr_tecc_j(no_tecc,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,kode_curr,kurs,nilai_curr,nilai,kode_pp,kode_drk,kode_lokasi,modul,jenis,periode,nik_user,tgl_input) values "+
							"('"+this.e_nb.getText()+"','"+this.cb_inv.getText()+"','"+this.dp_d1.getDateString()+"',2,'"+this.akunPdpt+"','"+this.e_ket.getText()+"','C','IDR',1,"+parseNilai(this.e_nilai.getText())+","+parseNilai(this.e_nilai.getText())+",'"+this.app._kodePP+"','"+this.kodeDRK+"','"+this.app._lokasi+"','TECC','PEND','"+this.e_periode.getText()+"','"+this.app._userLog+"',getdate())");
					if (this.e_biaya.getText() != "0")
					sql.add("insert into gr_tecc_j(no_tecc,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,kode_curr,kurs,nilai_curr,nilai,kode_pp,kode_drk,kode_lokasi,modul,jenis,periode,nik_user,tgl_input) values "+
							"('"+this.e_nb.getText()+"','"+this.cb_inv.getText()+"','"+this.dp_d1.getDateString()+"',3,'"+this.akunBiaya+"','"+this.e_ket.getText()+"','C','IDR',1,"+parseNilai(this.e_biaya.getText())+","+parseNilai(this.e_biaya.getText())+",'"+this.app._kodePP+"','"+this.kodeDRK+"','"+this.app._lokasi+"','TECC','BIAYA','"+this.e_periode.getText()+"','"+this.app._userLog+"',getdate())");
					if (this.e_mat.getText() != "0")
					sql.add("insert into gr_tecc_j(no_tecc,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,kode_curr,kurs,nilai_curr,nilai,kode_pp,kode_drk,kode_lokasi,modul,jenis,periode,nik_user,tgl_input) values "+
							"('"+this.e_nb.getText()+"','"+this.cb_inv.getText()+"','"+this.dp_d1.getDateString()+"',4,'"+this.akunMat+"','"+this.e_ket.getText()+"','C','IDR',1,"+parseNilai(this.e_mat.getText())+","+parseNilai(this.e_mat.getText())+",'"+this.app._kodePP+"','"+this.kodeDRK+"','"+this.app._lokasi+"','TECC','MATERAI','"+this.e_periode.getText()+"','"+this.app._userLog+"',getdate())");
					if (this.e_ppn.getText() != "0")
					sql.add("insert into gr_tecc_j(no_tecc,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,kode_curr,kurs,nilai_curr,nilai,kode_pp,kode_drk,kode_lokasi,modul,jenis,periode,nik_user,tgl_input) values "+
							"('"+this.e_nb.getText()+"','"+this.cb_inv.getText()+"','"+this.dp_d1.getDateString()+"',5,'"+this.akunPPN+"','"+this.e_ket.getText()+"','C','IDR',1,"+parseNilai(this.e_ppn.getText())+","+parseNilai(this.e_ppn.getText())+",'"+this.app._kodePP+"','"+this.kodeDRK+"','"+this.app._lokasi+"','TECC','PPN','"+this.e_periode.getText()+"','"+this.app._userLog+"',getdate())");				
	...
	doChange:function(sender){
		if (sender == this.e_periode || sender == this.cb_cabang) {
			if (this.e_periode.getText()!="" && this.cb_cabang.getText()!="") {
				this.cb_inv.setSQL("select a.no_invoice, a.nama_cust from gr_tecc_d a inner join gr_tecc_m b on a.no_tecc=b.no_tecc and a.kode_lokasi=b.kode_lokasi "+
		...
		if (sender == this.cb_inv && this.cb_inv.getText()!="") {								  
			var data = this.dbLib.getDataProvider("select a.no_tecc,a.nama_cust,a.nilai,a.diskon,a.ppn,a.biaya,a.materai,a.total,isnull(c.bayar,0) as bayar,a.akun_piutang,a.akun_piutang + ' - '+b.nama as nama,d.kode_drk,d.periode "+
			           "from gr_tecc_d a inner join masakun b on a.akun_piutang=b.kode_akun and b.kode_lokasi = a.kode_lokasi "+
					   "                 inner join gr_tecc_m d on a.no_tecc=d.no_tecc and a.kode_lokasi=d.kode_lokasi "+
					   "                 left join (select no_invoice,kode_lokasi,sum(case dc when 'D' then (nilai_kas+nilai_lain) else -(nilai_kas+nilai_lain) end) as bayar from gr_teccbayar_d group by no_invoice,kode_lokasi ) c on a.no_invoice=c.no_invoice and a.kode_lokasi=c.kode_lokasi "+
					   "where a.no_invoice='"+this.cb_inv.getText()+"' and a.kode_lokasi ='"+this.app._lokasi+"' ",true);			
			if (typeof data == "object"){
				var line = data.rs.rows[0];							
				if (line != undefined){
					this.e_notecc.setText(line.no_tecc);										
	...
	doClick:function(sender){
		if (this.e_periode.getText()!= "" && this.cb_cabang.getText()!= "") {				
			...
			if (typeof data == "object"){
				var line = data.rs.rows[0];							
				if (line != undefined){
					if (line.no_tecc == "0") this.e_nb.setText("RTEC001"+AddFormat);
					else {
						...
						this.e_nb.setText("RTEC"+nu+AddFormat);
					}
				} 
			}
			this.e_ket.setFocus();
