window.app_saku2_transaksi_siaga_fTeCCHapus = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_siaga_fTeCCHapus.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_siaga_fTeCCHapus";
...
window.app_saku2_transaksi_siaga_fTeCCHapus.extend(window.childForm);
window.app_saku2_transaksi_siaga_fTeCCHapus.implement({
