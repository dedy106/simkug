window.app_saku2_transaksi_siaga_fRelakunGar = function(owner,lokasi)
{
	if (owner)
	{
		window.app_saku2_transaksi_siaga_fRelakunGar.prototype.parent.constructor.call(this, owner);
		window.app_saku2_transaksi_siaga_fRelakunGar.prototype.parent.setWidth.call(this, 800);
		window.app_saku2_transaksi_siaga_fRelakunGar.prototype.parent.setHeight.call(this, 400);
		
		this.centerize();
		
		this.className = "app_saku2_transaksi_siaga_fRelakunGar";
...
window.app_saku2_transaksi_siaga_fRelakunGar.extend(window.portalui_commonForm);
window.app_saku2_transaksi_siaga_fRelakunGar.prototype.doDraw = function(canvas){
...
window.app_saku2_transaksi_siaga_fRelakunGar.prototype.doAfterResize = function(event){
	this.p1.setWidth(this.width - 40);
...
window.app_saku2_transaksi_siaga_fRelakunGar.prototype.setWidth = function(data){
	window.app_saku2_transaksi_siaga_fRelakunGar.prototype.parent.setWidth.call(this, data);
	this.header.style.width = data - 23;
	this.rBg.style.left = data - 23;
};
window.app_saku2_transaksi_siaga_fRelakunGar.prototype.doSysMouseMove = function(x, y, button, buttonState){
	window.app_saku2_transaksi_siaga_fRelakunGar.prototype.parent.doSysMouseMove.call(this,x, y, button, buttonState);
	if (this.isClick)
	{		
...
window.app_saku2_transaksi_siaga_fRelakunGar.prototype.eventMouseDown = function(event){	
...
window.app_saku2_transaksi_siaga_fRelakunGar.prototype.eventMouseUp = function(event){
	this.isClick = false;
	this.blockElm.style.display = "none";
	this.frameElm.style.display = "";
};
window.app_saku2_transaksi_siaga_fRelakunGar.prototype.eventMouseMove = function(event){
	if (this.isClick)
	{
		var x = event.clientX;
		var y = event.clientY;
...
window.app_saku2_transaksi_siaga_fRelakunGar.prototype.doClick = function(sender){
	try{
		if (sender == this.b1)
...
//--------------------------------------------
window.app_saku2_transaksi_siaga_fRelakunGar.prototype.setCaption = function(data){
...
window.app_saku2_transaksi_siaga_fRelakunGar.prototype.setItemParent = function(data){
	this.itemParent = data;
};
window.app_saku2_transaksi_siaga_fRelakunGar.prototype.entriesClick = function(sender, col, row){
...
window.app_saku2_transaksi_siaga_fRelakunGar.prototype.show = function()
{
	this.showModal();
...
window.app_saku2_transaksi_siaga_fRelakunGar.prototype.hide = function()
{
...
window.app_saku2_transaksi_siaga_fRelakunGar.prototype.loadNeraca = function(){		
	var filter = "(";
...
window.app_saku2_transaksi_siaga_fRelakunGar.prototype.doClose = function(sender)
{
	system.delMouseListener(this);
};
window.app_saku2_transaksi_siaga_fRelakunGar.prototype.doCariClick = function(sender)
{
	try{
		this.sg1.clear();
		var filter = "(";
