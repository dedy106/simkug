window.app_saku2_transaksi_siaga_fNeracaGar = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_siaga_fNeracaGar.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku2_transaksi_siaga_fNeracaGar";
...
window.app_saku2_transaksi_siaga_fNeracaGar.extend(window.portalui_childForm);
window.app_saku2_transaksi_siaga_fNeracaGar.implement({
		...
		{ 
			...
			}else
			{
				if (sender == this.addBtn || sender == this.editBtn){
					uses("app_saku2_transaksi_siaga_fNeracaGarDetail");
					if (this.entryMenu == undefined)
						this.entryMenu = new app_saku2_transaksi_siaga_fNeracaGarDetail(this.app);
