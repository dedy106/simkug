window.app_saku2_transaksi_siaga_fMintaBayarE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_siaga_fMintaBayarE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_siaga_fMintaBayarE";
		...
		this.e_atensi = new saiLabelEdit(this,{bound:[20,14,450,20],caption:"Atensi", maxLength:150});				
...
window.app_saku2_transaksi_siaga_fMintaBayarE.extend(window.childForm);
window.app_saku2_transaksi_siaga_fMintaBayarE.implement({
	...
	doModalResult: function(event, modalResult){
		...
		switch (event){
			...
			case "ubah" :		
				...
				//di loss cek periode karena tidak memakai anggaran
				/*
	...
	doChange:function(sender){		
		...
		if (sender == this.e_nb && this.e_nb.getText()!="") {
			...
			var data = this.dbLib.getDataProvider("select a.tanggal,a.periode,a.no_dokumen,a.atensi,a.keterangan,a.nik_buat,b.nama as nama_buat,a.nik_app,bb.nama as nama_app,a.kode_curr,a.kurs,a.kode_pp,c.nama as nama_pp  "+
			           "from gr_beban_m a "+
