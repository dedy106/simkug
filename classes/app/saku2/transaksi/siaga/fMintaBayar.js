window.app_saku2_transaksi_siaga_fMintaBayar = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_siaga_fMintaBayar.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_siaga_fMintaBayar";
...
window.app_saku2_transaksi_siaga_fMintaBayar.extend(window.childForm);
window.app_saku2_transaksi_siaga_fMintaBayar.implement({
