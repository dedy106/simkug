window.app_saku2_transaksi_siaga_fArumumE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_siaga_fArumumE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_siaga_fArumumE";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Penerimaan Umum: Edit", 0);	
		...
		this.cb_pp = new saiCBBL(this,{bound:[20,12,200,20],caption:"PP", readOnly:true,change:[this,"doChange"]});
...
window.app_saku2_transaksi_siaga_fArumumE.extend(window.childForm);
window.app_saku2_transaksi_siaga_fArumumE.implement({
		...
		try{									
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					sql.add("delete from gr_terima_m where no_terima = '"+this.e_nb.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");
					sql.add("delete from gr_terima_d where no_terima = '"+this.e_nb.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");
	...
	doChange:function(sender){		
		if (sender == this.e_periode && this.e_periode.getText()!="") {			
			this.e_nb.setSQL("select no_terima, keterangan from gr_terima_m where no_kas='-' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"'",["no_terima","keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);
		}
