window.app_saku2_transaksi_siaga_fVccHapus = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_siaga_fVccHapus.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_siaga_fVccHapus";
...
window.app_saku2_transaksi_siaga_fVccHapus.extend(window.childForm);
window.app_saku2_transaksi_siaga_fVccHapus.implement({
