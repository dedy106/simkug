window.app_saku2_transaksi_siaga_fPanjar = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_siaga_fPanjar.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_siaga_fPanjar";
		...
		this.cb_akun = new saiCBBL(this,{bound:[20,15,200,20],caption:"Akun Panjar", multiSelection:false, maxLength:10, tag:0});					
...
window.app_saku2_transaksi_siaga_fPanjar.extend(window.childForm);
window.app_saku2_transaksi_siaga_fPanjar.implement({
		...
		try{						
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					sql.add("insert into gr_panjar_m(no_panjar,kode_lokasi,no_dokumen,tanggal,keterangan,kode_pp,nik_buat,nik_app,due_date,kode_curr,kurs,nilai,nilai_curr,periode,nik_user,tgl_input,no_kas,progress,akun_panjar) values "+
						...
						for (var i=0;i < this.sg2.getRowCount();i++){
							if (this.sg2.rowValid(i)){
								...
								sql.add("insert into angg_r(no_bukti,modul,kode_lokasi,kode_akun,kode_pp,kode_drk,periode1,periode2,dc,saldo,nilai) values "+
										"	('"+this.e_nb.getText()+"','PANJAR','"+this.app._lokasi+"','"+this.sg2.cells(0,i)+"','"+this.sg2.cells(2,i)+"','"+this.sg2.cells(4,i)+"','"+this.e_periode.getText()+"','"+this.e_periode.getText()+"','"+DC+"',"+parseNilai(this.sg2.cells(6,i))+","+nilai+")");
							}
						}
					}
	...
	viewBukti : function(){
		try {
			this.flag="1";
			this.nama_report="server_report_saku2_siaga_rptPjBukti";
