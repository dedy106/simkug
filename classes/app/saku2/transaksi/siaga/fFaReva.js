window.app_saku2_transaksi_siaga_fFaReva = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_siaga_fFaReva.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_siaga_fFaReva";
...
window.app_saku2_transaksi_siaga_fFaReva.extend(window.childForm);
window.app_saku2_transaksi_siaga_fFaReva.implement({
