window.app_saku2_transaksi_siaga_fFawo = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_siaga_fFawo.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_siaga_fFawo";
...
window.app_saku2_transaksi_siaga_fFawo.extend(window.childForm);
window.app_saku2_transaksi_siaga_fFawo.implement({
