window.app_saku2_transaksi_siaga_fFaRevaE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_siaga_fFaRevaE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_siaga_fFaRevaE";
		...
		this.cb_fa = new saiCBBL(this,{bound:[20,10,220,20],caption:"No Aktap",readOnly:true});
		this.e_nama = new portalui_saiLabelEdit(this,{bound:[20,18,432,20],caption:"Deskripsi",maxLength:150, tag:1, readOnly:true});		
		this.e_seri = new portalui_saiLabelEdit(this,{bound:[20,19,432,20],caption:"Nomor Seri",maxLength:50, tag:1, readOnly:true});
		this.e_merk = new portalui_saiLabelEdit(this,{bound:[20,17,432,20],caption:"Merk",maxLength:100, tag:1, readOnly:true});
		this.e_tipe = new portalui_saiLabelEdit(this,{bound:[20,16,432,20],caption:"Tipe",maxLength:100, tag:1, readOnly:true});		
...
window.app_saku2_transaksi_siaga_fFaRevaE.extend(window.childForm);
window.app_saku2_transaksi_siaga_fFaRevaE.implement({
