window.app_saku2_transaksi_siaga_fFaKlp = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_siaga_fFaKlp.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_siaga_fFaKlp";
		...
		this.cb_akun = new saiCBBL(this,{bound:[20,12,200,20],caption:"Kelompok Akun", multiSelection:false, maxLength:10});	
		...
		try {
			...
			this.cb_akun.setSQL("select a.kode_klpakun, a.nama from fa_klpakun a "+
								"where a.kode_lokasi='"+this.app._lokasi+"' ",["a.kode_klpakun","a.nama"],false,["Kode","Nama"],"and","Daftar Kelompok",true);	
...
window.app_saku2_transaksi_siaga_fFaKlp.extend(window.childForm);
window.app_saku2_transaksi_siaga_fFaKlp.implement({
