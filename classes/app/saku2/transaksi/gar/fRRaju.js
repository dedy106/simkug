window.app_saku2_transaksi_gar_fRRaju = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_gar_fRRaju.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_gar_fRRaju";
...
window.app_saku2_transaksi_gar_fRRaju.extend(window.childForm);
window.app_saku2_transaksi_gar_fRRaju.implement({
