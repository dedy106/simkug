window.app_saku2_transaksi_gar_fAbt = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_gar_fAbt.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_gar_fAbt";
...
window.app_saku2_transaksi_gar_fAbt.extend(window.childForm);
window.app_saku2_transaksi_gar_fAbt.implement({
