window.app_saku2_transaksi_gl_fPostingYks = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_gl_fPostingYks.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_gl_fPostingYks";
...
window.app_saku2_transaksi_gl_fPostingYks.extend(window.childForm);
window.app_saku2_transaksi_gl_fPostingYks.implement({
				...
				switch(this.c_modul.getText()){
					...
					case "INV" :
								strSQL = "select 'INPROG' as status,no_akru as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'DEPOAKRU' as jenis "+
										 ...
										 " ";
								this.cb_bukti.setSQL(
													 "select no_akru as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'DEPOAKRU' as jenis from inv_depoakru_m where posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 "union "+
													 ...
													 "union "+
													 "select no_beli as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'OBLBELI' as jenis from inv_oblibeli_m where posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 "union "+
													 "select no_akru as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'OBLAKRU' as jenis from inv_obliakru_m where posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 "union "+
													 "select no_spi as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'OBLSPI' as jenis from inv_oblispi_m where posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 "union "+
													 "select no_amor as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'OBLAMOR' as jenis from inv_obliamor_m where posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 "union "+
													 "select no_oblijual as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'OBLJUAL' as jenis from inv_oblijual_m where posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 "union "+
													 "select no_cair as no_bukti,'-' as no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'OBLCAIR' as jenis from inv_oblicair_m where posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
