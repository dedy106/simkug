window.app_saku2_transaksi_gl_fClosingThn = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_gl_fClosingThn.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_gl_fClosingThn";
...
window.app_saku2_transaksi_gl_fClosingThn.extend(window.childForm);
window.app_saku2_transaksi_gl_fClosingThn.implement({
