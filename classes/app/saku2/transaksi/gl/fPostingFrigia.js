window.app_saku2_transaksi_gl_fPostingFrigia = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_gl_fPostingFrigia.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_gl_fPostingFrigia";
...
window.app_saku2_transaksi_gl_fPostingFrigia.extend(window.childForm);
window.app_saku2_transaksi_gl_fPostingFrigia.implement({
				...
				switch(this.c_modul.getText()){
					...
					case "AR" :
								...
								this.cb_bukti.setSQL("select no_bill as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'AKBIL' as jenis from aka_bill_m where posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													...
													"union "+
													"select no_jual as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'FRIJUAL' as jenis from fri_jual_m where posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' ",
