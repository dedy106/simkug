window.app_saku2_transaksi_gl_fUnPostingYks = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_gl_fUnPostingYks.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_gl_fUnPostingYks";
		...
		this.c_modul = new saiCB(this,{bound:[20,22,200,20],caption:"Modul",items:["JU","KB","PTG","FA","AR","AP","TAK","INV"], readOnly:true,tag:2,change:[this,"doChange"]});
...
window.app_saku2_transaksi_gl_fUnPostingYks.extend(window.childForm);
window.app_saku2_transaksi_gl_fUnPostingYks.implement({
				...
				switch(this.c_modul.getText()){
					...
					case "PTG" :
								...
								this.cb_bukti.setSQL("select no_ptg as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'PJPTG' as jenis from ptg_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 "union "+
													 "select no_selesai as no_bukti,no_ptg as no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'GRPTG' as jenis from gr_panjarselesai_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' ",["no_bukti","no_dokumen","tanggal","keterangan","jenis"],false,["No Bukti","No Dokumen","Tanggal","Keterangan","Jenis"],"and","Data Bukti PJPTG",true);
						break;												
					case "FA" :
					...
					case "AR" :
								strSQL = "select 'INPROG' as status,no_bill as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'AKBIL' as jenis "+
										 ...
										 "from yk_valid_m "+
										 "where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' and modul <> 'VALID' "+
										 "union "+
										 ...
										 "from gr_piutang_m "+
										 "where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' ";
								this.cb_bukti.setSQL("select no_bill as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'AKBIL' as jenis from aka_bill_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
												     "union "+
													 "select no_amor as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'AMOR' as jenis from aka_amor_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 "union "+
													 "select no_rekon as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'REKON' as jenis from aka_rekon_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 "union "+
													 "select no_batal as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'BATAL' as jenis from aka_batal_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 "union "+
													 "select no_sisih as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'SISIH' as jenis from aka_sisih_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 "union "+
													 "select no_valid as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'ARKES' as jenis from yk_valid_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' and modul <> 'VALID' "+
													 "union "+
													 "select no_ar as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'ARPATRA' as jenis from patra_ar_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 "union "+
													 "select no_tecc as no_bukti,kode_cabang as no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'TECC' as jenis from gr_tecc_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 "union "+
													 "select no_piutang as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'ARSIAGA' as jenis from gr_piutang_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' ",
					...
					case "AP" :
								strSQL = "select 'INPROG' as status,no_hutang as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'HUTKES' as jenis "+
										 ...
										 "from fri_gaji_m "+
										 "where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' ";
								this.cb_bukti.setSQL("select no_hutang as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'HUTKES' as jenis from yk_hutang_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
									                 "union "+
													 "select no_rekon as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'REKKES' as jenis from yk_rekon_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 "union "+
													 "select no_spb as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'SPB' as jenis from spb_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 "union "+
													 "select no_ppn as no_bukti,'-' as no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'RASPPN' as jenis from ras_ppn_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 "union "+
													 "select no_gaji as no_bukti,'-' as no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'FRIGAJI' as jenis from fri_gaji_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' ",
					...
					case "TAK" :
								strSQL = "select 'INPROG' as status,no_kirim as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'TAKKIRIM' as jenis "+
										 ...
										 "from takterima_m "+
										 "where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"'";
								this.cb_bukti.setSQL("select no_kirim as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'TAKKIRIM' as jenis from takkirim_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 "union "+
													 "select no_terima as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'TAKTERIMA' as jenis from takterima_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' ",
													 ["no_bukti","no_dokumen","tanggal","keterangan","jenis"],false,["No Bukti","No Dokumen","Tanggal","Keterangan","Jenis"],"and","Data Bukti TAK",true);
						break;												
					case "INV" :
								strSQL = "select 'INPROG' as status,no_akru as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'DEPOAKRU' as jenis "+
										 "from inv_depoakru_m "+
										 "where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"'" +
										 "union "+
										 ...
										 "union "+
										 "select 'INPROG' as status,no_beli as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'OBLBELI' as jenis "+
										 "from inv_oblibeli_m "+
										 "where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
										 "union "+
										 "select 'INPROG' as status,no_akru as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'OBLAKRU' as jenis "+
										 "from inv_obliakru_m "+
										 "where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
										 "union "+
										 "select 'INPROG' as status,no_spi as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'OBLSPI' as jenis "+
										 "from inv_oblispi_m "+
										 "where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
										 "union "+
										 "select 'INPROG' as status,no_amor as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'OBLAMOR' as jenis "+
										 "from inv_obliamor_m "+
										 "where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+										 
										 "union "+
										 "select 'INPROG' as status,no_oblijual as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'OBLJUAL' as jenis "+
										 "from inv_oblijual_m "+
										 "where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
										 "union "+
										 "select 'INPROG' as status,no_cair as no_bukti,'-' as no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'OBLCAIR' as jenis "+
										 "from inv_oblicair_m "+
										 "where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
										 
										 " ";
								this.cb_bukti.setSQL("select no_akru as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'DEPOAKRU' as jenis from inv_depoakru_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 "union "+
													 "select no_cair as no_bukti,no_depo as no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'DEPOCAIR' as jenis from inv_depocair_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 "union "+
													 "select no_shmbeli as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'SHMBELI' as jenis from inv_shmbeli_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 "union "+
													 "select no_shmjual as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'SHMJUAL' as jenis from inv_shmjual_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 "union "+
													 "select no_spi as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'SHMSPI' as jenis from inv_shmspi_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 "union "+
													 "select no_rdbeli as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'RDBELI' as jenis from inv_rdbeli_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 "union "+
													 "select no_rdjual as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'RDJUAL' as jenis from inv_rdjual_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													  "union "+
													 "select no_spi as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'RDSPI' as jenis from inv_rdspi_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+													 
													
													 "union "+
													 "select no_beli as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'OBLBELI' as jenis from inv_oblibeli_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 "union "+
													 "select no_akru as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'OBLAKRU' as jenis from inv_obliakru_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 "union "+
													 "select no_spi as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'OBLSPI' as jenis from inv_oblispi_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 "union "+
													 "select no_amor as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'OBLAMOR' as jenis from inv_obliamor_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 "union "+
													 "select no_oblijual as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'OBLJUAL' as jenis from inv_oblijual_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 "union "+
													 "select no_cair as no_bukti,'-' as no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'OBLCAIR' as jenis from inv_oblicair_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
			...
			switch(this.sg.cells(5,row)){
				...
				case "DEPOAKRU" :
							strSQL = "select a.kode_akun,b.nama as nama_akun,a.dc,a.keterangan,a.nilai,a.kode_pp,c.nama as nama_pp,a.kode_drk,isnull(d.nama,'-') as nama_drk,'-' as kode_cf,'-' as nama_cf "+
									 ...
									 "                      inner join pp c on a.kode_pp=c.kode_pp and a.kode_lokasi=c.kode_lokasi "+
									 "                      left join drk d on a.kode_drk=d.kode_drk and a.kode_lokasi=d.kode_lokasi and d.tahun='"+this.e_periode.getText().substr(0,4)+"' "+
									 "where a.no_akru = '"+this.sg.cells(1,row)+"' and a.kode_lokasi='"+this.app._lokasi+"'";
					break;
				case "DEPOCAIR" :
							strSQL = "select a.kode_akun,b.nama as nama_akun,a.dc,a.keterangan,a.nilai,a.kode_pp,c.nama as nama_pp,a.kode_drk,isnull(d.nama,'-') as nama_drk,'-' as kode_cf,'-' as nama_cf "+
									 ...
									 "                      inner join pp c on a.kode_pp=c.kode_pp and a.kode_lokasi=c.kode_lokasi "+
									 "                      left join drk d on a.kode_drk=d.kode_drk and a.kode_lokasi=d.kode_lokasi and d.tahun='"+this.e_periode.getText().substr(0,4)+"' "+
									 "where a.no_cair = '"+this.sg.cells(1,row)+"' and a.kode_lokasi='"+this.app._lokasi+"'";
					break;
				case "DEPOTUTUP" :
							strSQL = "select a.kode_akun,b.nama as nama_akun,a.dc,a.keterangan,a.nilai,a.kode_pp,c.nama as nama_pp,a.kode_drk,isnull(d.nama,'-') as nama_drk,'-' as kode_cf,'-' as nama_cf "+
									 ...
									 "                      inner join pp c on a.kode_pp=c.kode_pp and a.kode_lokasi=c.kode_lokasi "+
									 "                      left join drk d on a.kode_drk=d.kode_drk and a.kode_lokasi=d.kode_lokasi and d.tahun='"+this.e_periode.getText().substr(0,4)+"' "+
									 "where a.no_tutup = '"+this.sg.cells(1,row)+"' and a.kode_lokasi='"+this.app._lokasi+"'";
					break;
				case "SHMBELI" :
							strSQL = "select a.kode_akun,b.nama as nama_akun,a.dc,a.keterangan,a.nilai,a.kode_pp,c.nama as nama_pp,a.kode_drk,isnull(d.nama,'-') as nama_drk,'-' as kode_cf,'-' as nama_cf "+
				...
				case "OBLBELI" :
							strSQL = "select a.kode_akun,b.nama as nama_akun,a.dc,a.keterangan,a.nilai,a.kode_pp,c.nama as nama_pp,a.kode_drk,isnull(d.nama,'-') as nama_drk,'-' as kode_cf,'-' as nama_cf "+
									 ...
									 "                      inner join pp c on a.kode_pp=c.kode_pp and a.kode_lokasi=c.kode_lokasi "+
									 "                      left join drk d on a.kode_drk=d.kode_drk and a.kode_lokasi=d.kode_lokasi and d.tahun='"+this.e_periode.getText().substr(0,4)+"' "+
									 "where a.no_beli = '"+this.sg.cells(1,row)+"' and a.kode_lokasi='"+this.app._lokasi+"'";
					break;
				case "OBLJUAL" :
							strSQL = "select a.kode_akun,b.nama as nama_akun,a.dc,a.keterangan,a.nilai,a.kode_pp,c.nama as nama_pp,a.kode_drk,isnull(d.nama,'-') as nama_drk,'-' as kode_cf,'-' as nama_cf "+
									 "from inv_oblijual_j a inner join masakun b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi "+
									 "                      inner join pp c on a.kode_pp=c.kode_pp and a.kode_lokasi=c.kode_lokasi "+
									 "                      left join drk d on a.kode_drk=d.kode_drk and a.kode_lokasi=d.kode_lokasi and d.tahun='"+this.e_periode.getText().substr(0,4)+"' "+
									 "where a.no_oblijual = '"+this.sg.cells(1,row)+"' and a.kode_lokasi='"+this.app._lokasi+"'";
					break;
				case "OBLSPI" :
							strSQL = "select a.kode_akun,b.nama as nama_akun,a.dc,a.keterangan,a.nilai,a.kode_pp,c.nama as nama_pp,a.kode_drk,isnull(d.nama,'-') as nama_drk,'-' as kode_cf,'-' as nama_cf "+
				...
				case "OBLAMOR" :
							strSQL = "select a.kode_akun,b.nama as nama_akun,a.dc,a.keterangan,a.nilai,a.kode_pp,c.nama as nama_pp,a.kode_drk,isnull(d.nama,'-') as nama_drk,'-' as kode_cf,'-' as nama_cf "+
									 "from inv_obliamor_j a inner join masakun b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi "+
									 "                      inner join pp c on a.kode_pp=c.kode_pp and a.kode_lokasi=c.kode_lokasi "+
									 "                      left join drk d on a.kode_drk=d.kode_drk and a.kode_lokasi=d.kode_lokasi and d.tahun='"+this.e_periode.getText().substr(0,4)+"' "+
									 "where a.no_amor = '"+this.sg.cells(1,row)+"' and a.kode_lokasi='"+this.app._lokasi+"'";
					break;	
				case "OBLCAIR" :
							strSQL = "select a.kode_akun,b.nama as nama_akun,a.dc,a.keterangan,a.nilai,a.kode_pp,c.nama as nama_pp,a.kode_drk,isnull(d.nama,'-') as nama_drk,'-' as kode_cf,'-' as nama_cf "+
									 "from inv_oblicair_j a inner join masakun b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi "+
									 "                      inner join pp c on a.kode_pp=c.kode_pp and a.kode_lokasi=c.kode_lokasi "+
									 "                      left join drk d on a.kode_drk=d.kode_drk and a.kode_lokasi=d.kode_lokasi and d.tahun='"+this.e_periode.getText().substr(0,4)+"' "+
									 "where a.no_cair = '"+this.sg.cells(1,row)+"' and a.kode_lokasi='"+this.app._lokasi+"'";
					break;	
