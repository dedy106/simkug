window.app_saku2_transaksi_gl_fJuTU = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_gl_fJuTU.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_gl_fJuTU";
...
window.app_saku2_transaksi_gl_fJuTU.extend(window.childForm);
window.app_saku2_transaksi_gl_fJuTU.implement({	
