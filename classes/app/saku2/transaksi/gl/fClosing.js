window.app_saku2_transaksi_gl_fClosing = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_gl_fClosing.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_gl_fClosing";
...
window.app_saku2_transaksi_gl_fClosing.extend(window.childForm);
window.app_saku2_transaksi_gl_fClosing.implement({
