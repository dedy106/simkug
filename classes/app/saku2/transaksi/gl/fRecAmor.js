window.app_saku2_transaksi_gl_fRecAmor = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_gl_fRecAmor.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_gl_fRecAmor";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Transaksi Recurring : Input", 0);	
		
		uses("saiCBBL;saiEdit;datePicker;saiGrid;sgNavigator;pageControl;checkBox");
		this.e_periode = new portalui_saiLabelEdit(this,{bound:[20,14,202,20],caption:"Periode",tag:2,readOnly:true});
		this.l_tgl1 = new portalui_label(this,{bound:[20,11,100,18],caption:"Tanggal", underline:true});
		this.dp_d1 = new portalui_datePicker(this,{bound:[120,11,100,18],selectDate:[this,"doSelectDate"]}); 
		this.e_nb = new portalui_saiLabelEdit(this,{bound:[20,12,202,20],caption:"No Jurnal",maxLength:30,readOnly:true});
		...
		this.pc1 = new pageControl(this,{bound:[20,12,900,287], childPage:["Data Transaksi Reccuring","Detail Transaksi","Data Anggaran"]});
		...
		this.sg3 = new saiGrid(this.pc1.childPage[1],{bound:[1,10,this.pc1.width-5,this.pc1.height-40],colCount:9,tag:9,
...
window.app_saku2_transaksi_gl_fRecAmor.extend(window.childForm);
window.app_saku2_transaksi_gl_fRecAmor.implement({
	...
	doLoadData: function(sender){		
		var strSQL = "select a.no_kas,b.no_dokumen,convert(varchar,b.tanggal,103) as tanggal,a.keterangan,a.per_awal,a.per_akhir,a.nilai_bdd,"+
		             "      case when a.nilai_rec <= (a.nilai_bdd - isnull(c.nilai_beban,0)) then a.nilai_rec else (a.nilai_bdd - isnull(c.nilai_beban,0)) end as nilai_rec,a.nilai_bdd - isnull(c.nilai_beban,0) as saldo "+  
					 ...
					 "where a.flag_periode='"+this.e_periode.getText()+"' and '"+this.e_periode.getText()+"' between a.per_awal and a.per_akhir and a.kode_lokasi='"+this.app._lokasi+"'";
		...
		var strSQL = "select a.kode_akun,b.nama as nama_akun,sum(a.nilai) as nilai,a.kode_pp,c.nama as nama_pp,a.kode_drk,isnull(d.nama,'-') as nama_drk "+
				 ...
				 "where a.dc='D' and a.no_kas in ("+nokas+") and a.kode_lokasi='"+this.app._lokasi+"' "+
				 "group by a.kode_akun,b.nama,a.kode_pp,c.nama,a.kode_drk,isnull(d.nama,'-')";
		var data = this.dbLib.getDataProvider(strSQL,true);
		if (typeof data == "object" && data.rs.rows[0] != undefined){
			var line;
			this.sg2.clear();
			for (var i in data.rs.rows){
				line = data.rs.rows[i];											
				var data2 = this.dbLib.getDataProvider("select fn_cekagg2('"+line.kode_pp+"','"+this.app._lokasi+"','"+line.kode_akun+"','"+line.kode_drk+"','"+this.e_periode.getText()+"') as gar ",true);
				if (typeof data2 == "object" && data2.rs.rows[0] != undefined){
					var line2 = data2.rs.rows[0];
					data2 = line2.gar.split(";");
					var sls = parseFloat(data2[0]) - parseFloat(data2[1]);
					var sak = sls - parseFloat(line.nilai);
				}				
				this.sg2.appendData([line.kode_akun,line.nama_akun,line.kode_pp,line.nama_pp,line.kode_drk,line.nama_drk,floatToNilai(sls),floatToNilai(line.nilai),floatToNilai(sak)]); 
			}			
