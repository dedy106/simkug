window.app_saku2_transaksi_gl_fUnPostingpatra = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_gl_fUnPostingpatra.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_gl_fUnPostingpatra";
...
window.app_saku2_transaksi_gl_fUnPostingpatra.extend(window.childForm);
window.app_saku2_transaksi_gl_fUnPostingpatra.implement({
				...
				switch(this.c_modul.getText()){
					...
					case "AP" :
								...
								this.cb_bukti.setSQL("select no_hutang as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'HUTKES' as jenis from yk_hutang_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 ...
													 "union "+
													 "select no_hutang as no_bukti,'-' as no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'HUTPATRA' as jenis from patra_hutang_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' ",
