window.app_saku2_transaksi_gl_fFa = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_gl_fFa.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_gl_fFa";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Pengadaan Aktiva Tetap via JU: Input", 0);	
		...
		this.e_nb = new portalui_saiLabelEdit(this,{bound:[20,12,202,20],caption:"No JU",maxLength:30,readOnly:true});
...
window.app_saku2_transaksi_gl_fFa.extend(window.childForm);
window.app_saku2_transaksi_gl_fFa.implement({
