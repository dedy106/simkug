window.app_saku2_transaksi_gl_fClosingFrigia = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_gl_fClosingFrigia.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_gl_fClosingFrigia";
...
window.app_saku2_transaksi_gl_fClosingFrigia.extend(window.childForm);
window.app_saku2_transaksi_gl_fClosingFrigia.implement({
	...
	isPostedAll: function(periode){
		...
		if (ck != "") { 
			...
			if (data[1] != "0"){
				result = result && false;
				msg+= "Data Modul PIUTANG [BILL,AMOR,REKON,BTL,SISIH,ARYKS,ARPATRA,FRIJUAL] masih ada yang belum diposting.("+data[1]+" data)\n";
			}
		}
