window.app_saku2_transaksi_gl_fUnPostingYpt = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_gl_fUnPostingYpt.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_gl_fUnPostingYpt";
...
window.app_saku2_transaksi_gl_fUnPostingYpt.extend(window.childForm);
window.app_saku2_transaksi_gl_fUnPostingYpt.implement({
				...
				switch(this.c_modul.getText()){
					...
					case "FA" :
								...
								this.cb_bukti.setSQL("select no_fasusut as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'FASST' as jenis from fasusut_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 ...
													 "union "+
													 "select no_ba as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'LOGBA' as jenis from log_ba_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"'",
					...
					case "AR" :
								...
								this.cb_bukti.setSQL("select no_bill as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'AKBIL' as jenis from aka_bill_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 ...
													 "union "+													
													 "select no_piutang as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'PIUUM' as jenis from csm_piutang_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 "union "+													
													 "select no_piutang as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'PIU' as jenis from piutang_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 "union "+													
													 "select no_piutang as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'PIUPR' as jenis from pr_piutang_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 "union "+													
													 "select no_pdd as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'PDDPR' as jenis from pr_pdd_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' ",								                    
					...
					case "GAJI" :
								strSQL = "select 'INPROG' as status,no_gaji as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'GAJI' as jenis "+
										 ...
										 "where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"'" +
										 " ";
								this.cb_bukti.setSQL("select no_gaji as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'GAJI' as jenis from takkirim_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 " ",
													 ["no_bukti","no_dokumen","tanggal","keterangan","jenis"],false,["No Bukti","No Dokumen","Tanggal","Keterangan","Jenis"],"and","Data Bukti Gaji",true);
						break;							
					case "AP" :
								...
								this.cb_bukti.setSQL("select no_bmhd as no_bukti,no_proyek as no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'BMHD' as jenis from pr_bmhd_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 "union "+
													 "select no_hutang as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'HUTANG' as jenis from hutang_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 "union "+
													 "select no_bmhd as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'HUMHD' as jenis from bmhd_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' ",
					...
					case "PR" :
								...
								this.cb_bukti.setSQL("select no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'PRPIU' as jenis from tu_prpiutang_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 "union  "+
													 "select no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'PRPYT' as jenis from tu_prpyt_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 "union  "+
													 "select no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'PRBBN' as jenis from tu_prbeban_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' ",
													 ["no_bukti","no_dokumen","tanggal","keterangan","jenis"],false,["No Bukti","No Dokumen","Tanggal","Keterangan","Jenis"],"and","Data Bukti",true);
						break;	
					case "TR" :
								strSQL = "select 'INPROG' as status,no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'TR' as jenis "+
										 "from trans_m "+
										 "where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"'";
								this.cb_bukti.setSQL("select no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'TR' as jenis from trans_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"'",["no_bukti","no_dokumen","tanggal","keterangan","jenis"],false,["No Bukti","No Dokumen","Tanggal","Keterangan","Jenis"],"and","Data Bukti",true);
						break;				
				}
