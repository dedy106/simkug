window.app_saku2_transaksi_gl_fJP = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_gl_fJP.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku2_transaksi_gl_fJP";
...
window.app_saku2_transaksi_gl_fJP.extend(window.portalui_childForm);
window.app_saku2_transaksi_gl_fJP.implement({
	doUploadTB: function(){		
		try{
