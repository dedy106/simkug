window.app_saku2_transaksi_gl_fJuTUE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_gl_fJuTUE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_gl_fJuTUE";
...
window.app_saku2_transaksi_gl_fJuTUE.extend(window.childForm);
window.app_saku2_transaksi_gl_fJuTUE.implement({
	...
	doChange:function(sender){
		if (sender == this.e_periode && this.e_periode.getText()!="") {
			this.e_nb.setSQL("select no_ju, keterangan from ju_m where jenis not in ('AKTAP','REC') and modul = 'JU' and posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"'",["no_ju","keterangan"],false,["No JU","Deskripsi"],"and","Daftar Bukti JU",true);
		}
