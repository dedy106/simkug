window.app_saku2_transaksi_gl_fUnPostingFrigia = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_gl_fUnPostingFrigia.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_gl_fUnPostingFrigia";
...
window.app_saku2_transaksi_gl_fUnPostingFrigia.extend(window.childForm);
window.app_saku2_transaksi_gl_fUnPostingFrigia.implement({
				...
				switch(this.c_modul.getText()){
					...
					case "AR" :
								strSQL = "select 'INPROG' as status,no_bill as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'AKBIL' as jenis "+
										 ...
										 "where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
										 "union "+
										 "select 'INPROG' as status,no_jual as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'FRIJUAL' as jenis "+
										 "from fri_jual_m "+
										 "where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' ";
								this.cb_bukti.setSQL("select no_bill as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'AKBIL' as jenis from aka_bill_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 ...
													 "union "+
													 "select no_jual as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'FRIJUAL' as jenis from fri_jual_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' ",
	...
	doDoubleClick: function(sender, col , row) {
		if (this.sg.cells(1,row) != "") {
			...
			switch(this.sg.cells(5,row)){
				...
				case "FRIJUAL" :
							strSQL = "select a.kode_akun,b.nama as nama_akun,a.dc,a.keterangan,a.nilai,a.kode_pp,c.nama as nama_pp,a.kode_drk,isnull(d.nama,'-') as nama_drk,'-' as kode_cf,'-' as nama_cf "+
									 "from fri_jual_j a inner join masakun b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi "+
									 "                  inner join pp c on a.kode_pp=c.kode_pp and a.kode_lokasi=c.kode_lokasi "+
									 "                  left join drk d on a.kode_drk=d.kode_drk and a.kode_lokasi=d.kode_lokasi and d.tahun='"+this.e_periode.getText().substr(0,4)+"' "+
									 "where a.no_jual = '"+this.sg.cells(1,row)+"' and a.kode_lokasi='"+this.app._lokasi+"'";
					break;										
				case "HUTKES" :
							strSQL = "select a.kode_akun,b.nama as nama_akun,a.dc,a.keterangan,a.nilai,a.kode_pp,c.nama as nama_pp,a.kode_drk,isnull(d.nama,'-') as nama_drk,'-' as kode_cf,'-' as nama_cf "+
