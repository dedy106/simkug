window.app_saku2_transaksi_gl_fClosingDivre = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_gl_fClosingDivre.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_gl_fClosingDivre";
...
window.app_saku2_transaksi_gl_fClosingDivre.extend(window.childForm);
window.app_saku2_transaksi_gl_fClosingDivre.implement({
