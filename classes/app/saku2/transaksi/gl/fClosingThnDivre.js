window.app_saku2_transaksi_gl_fClosingThnDivre = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_gl_fClosingThnDivre.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_gl_fClosingThnDivre";
...
window.app_saku2_transaksi_gl_fClosingThnDivre.extend(window.childForm);
window.app_saku2_transaksi_gl_fClosingThnDivre.implement({
