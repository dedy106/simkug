window.app_saku2_transaksi_frigia_inv_fMasuk = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_frigia_inv_fMasuk.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_frigia_inv_fMasuk";
...
window.app_saku2_transaksi_frigia_inv_fMasuk.extend(window.portalui_childForm);
window.app_saku2_transaksi_frigia_inv_fMasuk.implement({	
