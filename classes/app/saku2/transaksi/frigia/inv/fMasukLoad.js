window.app_saku2_transaksi_frigia_inv_fMasukLoad = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_frigia_inv_fMasukLoad.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_frigia_inv_fMasukLoad";
...
window.app_saku2_transaksi_frigia_inv_fMasukLoad.extend(window.portalui_childForm);
window.app_saku2_transaksi_frigia_inv_fMasukLoad.implement({	
