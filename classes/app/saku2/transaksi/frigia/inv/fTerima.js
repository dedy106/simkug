window.app_saku2_transaksi_frigia_inv_fTerima = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_frigia_inv_fTerima.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_frigia_inv_fTerima";
...
window.app_saku2_transaksi_frigia_inv_fTerima.extend(window.portalui_childForm);
window.app_saku2_transaksi_frigia_inv_fTerima.implement({	
