window.app_saku2_transaksi_frigia_inv_transaksi_fKeluarE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_frigia_inv_transaksi_fKeluarE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_frigia_inv_transaksi_fKeluarE";
...
window.app_saku2_transaksi_frigia_inv_transaksi_fKeluarE.extend(window.portalui_childForm);
window.app_saku2_transaksi_frigia_inv_transaksi_fKeluarE.implement({
