window.app_saku2_transaksi_frigia_inv_fMasukE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_frigia_inv_fMasukE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_frigia_inv_fMasukE";
...
window.app_saku2_transaksi_frigia_inv_fMasukE.extend(window.portalui_childForm);
window.app_saku2_transaksi_frigia_inv_fMasukE.implement({	
