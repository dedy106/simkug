window.app_saku2_transaksi_frigia_inv_transaksi_fKirimE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_frigia_inv_transaksi_fKirimE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_frigia_inv_transaksi_fKirimE";
...
window.app_saku2_transaksi_frigia_inv_transaksi_fKirimE.extend(window.portalui_childForm);
window.app_saku2_transaksi_frigia_inv_transaksi_fKirimE.implement({
