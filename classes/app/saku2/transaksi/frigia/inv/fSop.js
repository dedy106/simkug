window.app_saku2_transaksi_frigia_inv_fSop = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_frigia_inv_fSop.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku2_transaksi_frigia_inv_fSop";
...
window.app_saku2_transaksi_frigia_inv_fSop.extend(window.portalui_childForm);
window.app_saku2_transaksi_frigia_inv_fSop.implement({
