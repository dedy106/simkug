window.app_saku2_transaksi_anggaran_fLoadSppdPersenB = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_anggaran_fLoadSppdPersenB.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku2_transaksi_anggaran_fLoadSppdPersenB";
		...
		this.e_nb = new saiCBBL(this,{bound:[20,12,223,20],caption:"No BPD", multiSelection:false, maxLength:10, tag:1, readOnly:true,change:[this,"doChange"]});		
		this.cb_akun = new saiCBBL(this,{bound:[20,13,200,20],caption:"Akun BPD", readOnly:true});		
		this.cb_pp = new saiCBBL(this,{bound:[20,11,200,20],caption:"PP", readOnly:true});		
...
window.app_saku2_transaksi_anggaran_fLoadSppdPersenB.extend(window.portalui_childForm);
window.app_saku2_transaksi_anggaran_fLoadSppdPersenB.implement({			
			...
			case "hapus" :							
					...
					if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
						try{														
							...
							sql.add("delete from agg_pd_m where no_pd ='"+this.e_nb.getText()+"' and kode_pp='"+this.cb_pp.getText()+"' and kode_lokasi='"+this.app._lokasi+"' and tahun ='"+this.e_tahun.getText()+"'");
							sql.add("delete from agg_pd_d where no_pd ='"+this.e_nb.getText()+"' and kode_pp='"+this.cb_pp.getText()+"' and kode_lokasi='"+this.app._lokasi+"' and tahun ='"+this.e_tahun.getText()+"'");
							sql.add("delete from agg_d where no_bukti ='"+this.e_nb.getText()+"' and modul='BSPPD' and kode_pp='"+this.cb_pp.getText()+"' and kode_lokasi='"+this.app._lokasi+"' and tahun ='"+this.e_tahun.getText()+"'");
