window.app_saku2_transaksi_anggaran_fLoadNorma = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_anggaran_fLoadNorma.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku2_transaksi_anggaran_fLoadNorma";
		...
		this.p1 = new portalui_panel(this,{bound:[20,189,800,500],caption:"Data Norma Biaya Variabel"});
...
window.app_saku2_transaksi_anggaran_fLoadNorma.extend(window.portalui_childForm);
window.app_saku2_transaksi_anggaran_fLoadNorma.implement({
			...
			case "simpan" :			
					...
					if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
						try{
							...
							sql.add("insert into agg_var (kode_var,nama,tahun) select distinct kode_var,nama_var,tahun from agg_norma_var where tahun = '"+this.e_tahun.getText()+"'");
