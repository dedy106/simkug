window.app_saku2_transaksi_anggaran_fNeracaGarDetail = function(owner,modul)
{
	if (owner)
	{
		window.app_saku2_transaksi_anggaran_fNeracaGarDetail.prototype.parent.constructor.call(this, owner);
		window.app_saku2_transaksi_anggaran_fNeracaGarDetail.prototype.parent.setWidth.call(this, 300);
		window.app_saku2_transaksi_anggaran_fNeracaGarDetail.prototype.parent.setHeight.call(this, 400);
		
		this.centerize();
		
		this.className = "app_saku2_transaksi_anggaran_fNeracaGarDetail";
...
window.app_saku2_transaksi_anggaran_fNeracaGarDetail.extend(window.portalui_commonForm);
window.app_saku2_transaksi_anggaran_fNeracaGarDetail.prototype.doDraw = function(canvas)
{
...
window.app_saku2_transaksi_anggaran_fNeracaGarDetail.prototype.doAfterResize = function(event)
{
	this.p1.setWidth(this.width - 40);
...
window.app_saku2_transaksi_anggaran_fNeracaGarDetail.prototype.doSysMouseDown = function(x, y, button, buttonState)
{	
	window.app_saku2_transaksi_anggaran_fNeracaGarDetail.prototype.parent.doSysMouseDown.call(this,x, y, button, buttonState);
};
window.app_saku2_transaksi_anggaran_fNeracaGarDetail.prototype.doSysMouseUp = function(x, y, button, buttonState)
{	
	window.app_saku2_transaksi_anggaran_fNeracaGarDetail.prototype.parent.doSysMouseUp.call(this,x, y, button, buttonState);
};
window.app_saku2_transaksi_anggaran_fNeracaGarDetail.prototype.doSysMouseMove = function(x, y, button, buttonState)
{
	window.app_saku2_transaksi_anggaran_fNeracaGarDetail.prototype.parent.doSysMouseMove.call(this,x, y, button, buttonState);
	if (this.isClick)
	{		
...
window.app_saku2_transaksi_anggaran_fNeracaGarDetail.prototype.eventMouseDown = function(event)
{
...
window.app_saku2_transaksi_anggaran_fNeracaGarDetail.prototype.eventMouseUp = function(event)
{
	this.isClick = false;
	this.blockElm.style.display = "none";
	this.frameElm.style.display = "";
};
window.app_saku2_transaksi_anggaran_fNeracaGarDetail.prototype.eventMouseMove = function(event)
{
	if (this.isClick)
	{
		var x = event.clientX;
...
window.app_saku2_transaksi_anggaran_fNeracaGarDetail.prototype.doClick = function(sender)
{
	if (sender == this.b1){
		try{
...
window.app_saku2_transaksi_anggaran_fNeracaGarDetail.prototype.doRequestReady = function(sender, methodName, result)
{
};
window.app_saku2_transaksi_anggaran_fNeracaGarDetail.prototype.findBtnClick = function(sender)
{
};
//--------------------------------------------
window.app_saku2_transaksi_anggaran_fNeracaGarDetail.prototype.setCaption = function(data)
{
...
window.app_saku2_transaksi_anggaran_fNeracaGarDetail.prototype.setItemParent = function(data)
{
	this.itemParent = data;
};
window.app_saku2_transaksi_anggaran_fNeracaGarDetail.prototype.setSummaryItems = function(data)
{
	this.e4.clearItem();
	for (var i in data)
		this.e4.addItem(i, data[i]);	
};
window.app_saku2_transaksi_anggaran_fNeracaGarDetail.prototype.doClose = function(sender)
{
	system.delMouseListener(this);
};
window.app_saku2_transaksi_anggaran_fNeracaGarDetail.prototype.setModul = function(modul)
{
    this.e5.clearItem();
