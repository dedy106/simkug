window.app_saku2_transaksi_anggaran_fLoadAbauPersenB = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_anggaran_fLoadAbauPersenB.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku2_transaksi_anggaran_fLoadAbauPersenB";
...
window.app_saku2_transaksi_anggaran_fLoadAbauPersenB.extend(window.portalui_childForm);
window.app_saku2_transaksi_anggaran_fLoadAbauPersenB.implement({			
