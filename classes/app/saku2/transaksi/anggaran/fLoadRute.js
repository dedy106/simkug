window.app_saku2_transaksi_anggaran_fLoadRute = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_anggaran_fLoadRute.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku2_transaksi_anggaran_fLoadRute";
		...
		this.p1 = new portalui_panel(this,{bound:[20,189,600,500],caption:"Data Rute dan Tarif Perjalan Dinas"});
...
window.app_saku2_transaksi_anggaran_fLoadRute.extend(window.portalui_childForm);
window.app_saku2_transaksi_anggaran_fLoadRute.implement({
