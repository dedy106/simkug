window.app_saku2_transaksi_inv_fRepair = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_inv_fRepair.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_inv_fRepair";
...
window.app_saku2_transaksi_inv_fRepair.extend(window.childForm);
window.app_saku2_transaksi_inv_fRepair.implement({
