window.app_saku2_transaksi_yks_fKbPiutang = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_yks_fKbPiutang.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_yks_fKbPiutang";
...
window.app_saku2_transaksi_yks_fKbPiutang.extend(window.childForm);
window.app_saku2_transaksi_yks_fKbPiutang.implement({
