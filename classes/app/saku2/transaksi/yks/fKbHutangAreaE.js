window.app_saku2_transaksi_yks_fKBHutangAreaE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_yks_fKBHutangAreaE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_yks_fKBHutangAreaE";
...
window.app_saku2_transaksi_yks_fKBHutangAreaE.extend(window.childForm);
window.app_saku2_transaksi_yks_fKBHutangAreaE.implement({
