window.app_saku2_transaksi_yks_fRekon = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_yks_fRekon.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_yks_fRekon";
...
window.app_saku2_transaksi_yks_fRekon.extend(window.childForm);
window.app_saku2_transaksi_yks_fRekon.implement({
