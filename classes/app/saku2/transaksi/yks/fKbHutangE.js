window.app_saku2_transaksi_yks_fKBHutangE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_yks_fKBHutangE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_yks_fKBHutangE";
...
window.app_saku2_transaksi_yks_fKBHutangE.extend(window.childForm);
window.app_saku2_transaksi_yks_fKBHutangE.implement({
	...
	doJurnal:function(sender){
		if (this.cb_akun.getText() != "") {
			...
			var strSQL = "select c.flag as kode_akun,d.nama as nama_akun,'D' as dc,'MUTASI KEWAJIBAN' as ket,sum(a.nilai_bp+a.nilai_cc) as total,'"+this.app._kodePP+"' as kode_pp,e.nama as nama_pp,'-' as kode_drk,'-' as nama_drk,'-' as kode_cf,'-' as nama_cf "+
						 "from yk_hutang_d a "+
						 //"     inner join vendor aa on a.kode_vendor=aa.kode_vendor and a.kode_lokasi=aa.kode_lokasi "+
