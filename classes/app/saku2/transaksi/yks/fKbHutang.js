window.app_saku2_transaksi_yks_fKBHutang = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_yks_fKBHutang.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_yks_fKBHutang";
...
window.app_saku2_transaksi_yks_fKBHutang.extend(window.childForm);
window.app_saku2_transaksi_yks_fKBHutang.implement({
