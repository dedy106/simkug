window.app_saku2_transaksi_yks_fKbCS = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_yks_fKbCS.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_yks_fKbCS";
...
window.app_saku2_transaksi_yks_fKbCS.extend(window.childForm);
window.app_saku2_transaksi_yks_fKbCS.implement({
