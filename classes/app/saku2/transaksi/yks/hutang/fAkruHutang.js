window.app_saku2_transaksi_yks_hutang_fAkruHutang = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_yks_hutang_fAkruHutang.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_yks_hutang_fAkruHutang";
...
window.app_saku2_transaksi_yks_hutang_fAkruHutang.extend(window.childForm);
window.app_saku2_transaksi_yks_hutang_fAkruHutang.implement({
