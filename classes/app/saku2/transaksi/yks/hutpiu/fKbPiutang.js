window.app_saku2_transaksi_yks_hutpiu_fKbPiutang = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_yks_hutpiu_fKbPiutang.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_yks_hutpiu_fKbPiutang";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form KasBank Penerimaan Pelunasan Piutang : Input", 0);	
		...
		this.e_nilai = new saiLabelEdit(this,{bound:[750,17,220,20],caption:"Nilai KasBank", tag:1, readOnly:true, tipeText:ttNilai, text:"0"});		
		
		this.bTampil = new button(this,{bound:[550,17,80,18],caption:"Tampil Data",click:[this,"doLoad"]});			
		this.bJurnal = new button(this,{bound:[650,17,80,18],caption:"Jurnal",click:[this,"doJurnal"]});
				
		this.pc1 = new pageControl(this,{bound:[20,20,950,280], childPage:["Data Billing","Detail Billing","Detail Jurnal","Jurnal Tambahan"]});		
...
window.app_saku2_transaksi_yks_hutpiu_fKbPiutang.extend(window.childForm);
window.app_saku2_transaksi_yks_hutpiu_fKbPiutang.implement({
	...
	doLoad:function(sender){
		if (this.e_periode.getText() != "") {
			var data = this.dbLib.getDataProvider(
					   ...
					   ") a where a.nilai <> 0 group by a.no_valid,a.loker_bast,convert(varchar,a.tanggal,103),a.keterangan,a.modul order by a.loker_bast,a.tanggal",true);
