window.app_saku2_transaksi_yks_hutpiu_fKbPiutangE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_yks_hutpiu_fKbPiutangE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_yks_hutpiu_fKbPiutangE";
...
window.app_saku2_transaksi_yks_hutpiu_fKbPiutangE.extend(window.childForm);
window.app_saku2_transaksi_yks_hutpiu_fKbPiutangE.implement({
