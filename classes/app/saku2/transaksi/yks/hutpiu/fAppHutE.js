window.app_saku2_transaksi_yks_hutpiu_fAppHutE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_yks_hutpiu_fAppHutE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_yks_hutpiu_fAppHutE";
		...
		this.e_total = new saiLabelEdit(this,{bound:[800,17,200,20],caption:"Total", tag:1, readOnly:true, tipeText:ttNilai, text:"0"});		
...
window.app_saku2_transaksi_yks_hutpiu_fAppHutE.extend(window.childForm);
window.app_saku2_transaksi_yks_hutpiu_fAppHutE.implement({
	...
	doChange:function(sender){
		...
		if (sender == this.e_nb && this.e_nb.getText()!="") {
			...
			var data = this.dbLib.getDataProvider(
						...
						"where x.modul='HUTKES' and a.kode_lokasi='"+this.app._lokasi+"' and a.no_app='"+this.e_nb.getText()+"' order by a.kode_vendor,a.no_inv",true);
			if (typeof data == "object" && data.rs.rows[0] != undefined){
				var line;
				this.sg.clear();
