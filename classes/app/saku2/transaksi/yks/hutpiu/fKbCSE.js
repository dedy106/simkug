window.app_saku2_transaksi_yks_hutpiu_fKbCSE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_yks_hutpiu_fKbCSE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_yks_hutpiu_fKbCSE";
...
window.app_saku2_transaksi_yks_hutpiu_fKbCSE.extend(window.childForm);
window.app_saku2_transaksi_yks_hutpiu_fKbCSE.implement({
