window.app_saku2_transaksi_yks_hutpiu_fRekonE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_yks_hutpiu_fRekonE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_yks_hutpiu_fRekonE";
...
window.app_saku2_transaksi_yks_hutpiu_fRekonE.extend(window.childForm);
window.app_saku2_transaksi_yks_hutpiu_fRekonE.implement({
	...
	doChange:function(sender){
		if (sender == this.e_periode && this.e_periode.getText()!="") {
			this.e_nb.setSQL("select no_rekon, keterangan from yk_rekon_m "+
			                 "where modul = 'REKON' and posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"'",["no_rekon","keterangan"],false,["No Rekon","Deskripsi"],"and","Daftar Bukti",true);
		}
