window.app_saku2_transaksi_yks_hutpiu_fKBHutangArea = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_yks_hutpiu_fKBHutangArea.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_yks_hutpiu_fKBHutangArea";
...
window.app_saku2_transaksi_yks_hutpiu_fKBHutangArea.extend(window.childForm);
window.app_saku2_transaksi_yks_hutpiu_fKBHutangArea.implement({
