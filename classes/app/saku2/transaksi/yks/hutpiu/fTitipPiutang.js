window.app_saku2_transaksi_yks_hutpiu_fTitipPiutang = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_yks_hutpiu_fTitipPiutang.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_yks_hutpiu_fTitipPiutang";
...
window.app_saku2_transaksi_yks_hutpiu_fTitipPiutang.extend(window.childForm);
window.app_saku2_transaksi_yks_hutpiu_fTitipPiutang.implement({
