window.app_saku2_transaksi_yks_hutpiu_fAkruPiuHutE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_yks_hutpiu_fAkruPiuHutE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_yks_hutpiu_fAkruPiuHutE";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Akru Piutang - Hutang: Edit", 0);	
...
window.app_saku2_transaksi_yks_hutpiu_fAkruPiuHutE.extend(window.childForm);
window.app_saku2_transaksi_yks_hutpiu_fAkruPiuHutE.implement({
