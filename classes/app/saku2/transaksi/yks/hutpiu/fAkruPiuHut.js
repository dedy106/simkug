window.app_saku2_transaksi_yks_hutpiu_fAkruPiuHut = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_yks_hutpiu_fAkruPiuHut.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_yks_hutpiu_fAkruPiuHut";
...
window.app_saku2_transaksi_yks_hutpiu_fAkruPiuHut.extend(window.childForm);
window.app_saku2_transaksi_yks_hutpiu_fAkruPiuHut.implement({
	...
	doTampil:function(sender){		
		if (this.e_periode.getText() != "") {
			var strSQL = "select a.no_bill,convert(varchar,a.tanggal,103) as tanggal,a.keterangan,a.nilai,b.total_kunj,b.total_cs,a.jenis "+
						 ...
						 "where a.jenis = 'NONRESTITUSI' and a.progress = '0' and a.periode<='"+this.e_periode.getText()+"' and a.kode_lokasi = '"+this.app._lokasi+"'"; 						 
