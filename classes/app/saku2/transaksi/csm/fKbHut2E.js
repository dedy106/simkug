window.app_saku2_transaksi_csm_fKbHut2E = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_csm_fKbHut2E.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_csm_fKbHut2E";
...
window.app_saku2_transaksi_csm_fKbHut2E.extend(window.childForm);
window.app_saku2_transaksi_csm_fKbHut2E.implement({
	...
	doChange:function(sender){
		...
		if (sender == this.e_nb && this.e_nb.getText()!= "") {			
			var strSQL = "select (a.nilai+a.nilai_ppn) -  isnull(b.bayar,0) as saldo, a.akun_hutang,'-' as ket, "+
