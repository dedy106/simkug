window.app_saku2_transaksi_csm_fHutUmum = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_csm_fHutUmum.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_csm_fHutUmum";
...
window.app_saku2_transaksi_csm_fHutUmum.extend(window.childForm);
window.app_saku2_transaksi_csm_fHutUmum.implement({
