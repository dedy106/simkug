window.app_saku2_transaksi_csm_fPiuUmum = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_csm_fPiuUmum.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_csm_fPiuUmum";
		...
		this.cb_project = new saiCBBL(this,{bound:[20,14,220,20],caption:"ID Project", multiSelection:false, maxLength:10, tag:1,change:[this,"doChange"]});						
...
window.app_saku2_transaksi_csm_fPiuUmum.extend(window.childForm);
window.app_saku2_transaksi_csm_fPiuUmum.implement({
	...
	doChange:function(sender){		
		if (sender == this.cb_project && this.cb_project.getText()!="") {
			var strSQL = "select a.kode_cust,a.nama  from csm_cust a inner join csm_project b on a.kode_cust=b.kode_cust and a.kode_lokasi=b.kode_lokasi "+
			             "where b.kode_project ='"+this.cb_project.getText()+"' and b.kode_lokasi='"+this.app._lokasi+"'";						   
	...
	doClick:function(sender){
		if (this.e_periode.getText()!= "" ) {				
			this.e_nb.setText(this.standarLib.noBuktiOtomatis(this.dbLib,"csm_piutang_m","no_piutang",this.app._lokasi+"-PU"+this.e_periode.getText().substr(2,4)+".","000"));
			this.e_dok.setFocus();
		}
	},	
