window.app_saku2_transaksi_csm_fClosing = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_csm_fClosing.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_csm_fClosing";
...
window.app_saku2_transaksi_csm_fClosing.extend(window.childForm);
window.app_saku2_transaksi_csm_fClosing.implement({
