window.app_saku2_transaksi_csm_fHutUmum2 = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_csm_fHutUmum2.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_csm_fHutUmum2";
...
window.app_saku2_transaksi_csm_fHutUmum2.extend(window.childForm);
window.app_saku2_transaksi_csm_fHutUmum2.implement({
	...
	doClick:function(sender){
		if (this.e_periode.getText()!= "" ) {				
			this.e_nb.setText(this.standarLib.noBuktiOtomatis(this.dbLib,"csm_hutang_m","no_hutang",this.app._lokasi+"-HU"+this.e_periode.getText().substr(2,4)+".","000"));
			this.e_dok.setFocus();
		}
	},	
