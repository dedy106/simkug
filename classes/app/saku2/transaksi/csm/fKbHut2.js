window.app_saku2_transaksi_csm_fKbHut2 = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_csm_fKbHut2.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_csm_fKbHut2";
...
window.app_saku2_transaksi_csm_fKbHut2.extend(window.childForm);
window.app_saku2_transaksi_csm_fKbHut2.implement({
