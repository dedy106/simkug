window.app_saku2_transaksi_csm_fClosingThn = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_csm_fClosingThn.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_csm_fClosingThn";
...
window.app_saku2_transaksi_csm_fClosingThn.extend(window.childForm);
window.app_saku2_transaksi_csm_fClosingThn.implement({
