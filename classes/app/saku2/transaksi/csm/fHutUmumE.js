window.app_saku2_transaksi_csm_fHutUmumE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_csm_fHutUmumE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_csm_fHutUmumE";
...
window.app_saku2_transaksi_csm_fHutUmumE.extend(window.childForm);
window.app_saku2_transaksi_csm_fHutUmumE.implement({
	...
	doChange:function(sender){
		...
		if (sender == this.e_nb && this.e_nb.getText()!="") {			
			var strSQL = "select a.tanggal,a.periode,a.no_dokumen,a.keterangan,a.kode_pp,a.akun_hutang,a.nik_app,a.kode_project,b.keterangan as ket_project,a.kode_vendor,c.nama as nama_vendor "+						 
						 "from csm_hutang_m a inner join csm_project b on a.kode_project=b.kode_project and a.kode_lokasi=b.kode_lokasi "+
