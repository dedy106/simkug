window.app_saku2_transaksi_kopeg_logistik_fPesan = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_logistik_fPesan.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_logistik_fPesan";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Pemesanan Logistik : Input", 0);	
		
		uses("portalui_uploader;saiCBBL;saiEdit;datePicker;saiGrid;sgNavigator;pageControl;checkBox");
		this.e_periode = new portalui_saiLabelEdit(this,{bound:[20,14,202,20],caption:"Periode",tag:2,readOnly:true});
		this.l_tgl1 = new portalui_label(this,{bound:[20,11,100,18],caption:"Tanggal", underline:true});
		this.dp_d1 = new portalui_datePicker(this,{bound:[120,11,100,18],selectDate:[this,"doSelectDate"]}); 		
		this.c_jenis = new saiCB(this,{bound:[20,22,202,20],caption:"Jenis",items:["CAPEX"], readOnly:true,tag:2, change:[this,"doChange"]});
		...
		this.cb_pp = new saiCBBL(this,{bound:[20,12,200,20],caption:"PP", multiSelection:false, maxLength:10, tag:2, change:[this,"doChange"]});		
		this.cb_drk = new saiCBBL(this,{bound:[20,13,200,20],caption:"DRK", multiSelection:false, maxLength:10, tag:2, change:[this,"doChange"]});		
		this.cb_akun = new saiCBBL(this,{bound:[20,14,200,20],caption:"Akun Anggaran", multiSelection:false, maxLength:10, tag:2, change:[this,"doChange"]});				
...
window.app_saku2_transaksi_kopeg_logistik_fPesan.extend(window.childForm);
window.app_saku2_transaksi_kopeg_logistik_fPesan.implement({	
	...
	doClick:function(sender){
		this.e_nb.setText(this.standarLib.noBuktiOtomatis(this.dbLib,"log_pesan_m","no_pesan",this.app._lokasi+"-RQ"+this.e_periode.getText().substr(2,4)+".","000"));
		this.e_dok.setFocus();
		setTipeButton(tbSimpan);
	},	
