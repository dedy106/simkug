window.app_saku2_transaksi_kopeg_logistik_fFinalBAE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_logistik_fFinalBAE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_logistik_fFinalBAE";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Finalisasi BAST : Edit", 0);	
		...
		this.cb_vendor = new saiCBBL(this,{bound:[20,14,220,20],caption:"Vendor", readOnly:true, tag:1});						
		this.cb_po = new saiCBBL(this,{bound:[20,16,220,20],caption:"No PO", readOnly:true, tag:1});		
		...
		this.cb_termin = new saiCBBL(this,{bound:[20,15,200,20],caption:"Termin",readOnly:true, tag:1 });				
...
window.app_saku2_transaksi_kopeg_logistik_fFinalBAE.extend(window.childForm);
window.app_saku2_transaksi_kopeg_logistik_fFinalBAE.implement({	
		...
		try{									
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					sql.add("update log_po_termin set no_final='-' where no_final='"+this.e_nb.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");				
	...
	doChange:function(sender){		
		if (sender == this.e_periode && this.e_periode.getText()!="") {
			...
			this.e_nb.setSQL("select a.no_ba, a.keterangan from log_ba_m a inner join log_po_termin b on a.no_po=b.no_po and a.nu=b.nu and a.kode_lokasi=b.kode_lokasi and a.no_ba=b.no_final "+
			                 "where b.no_spb='-' and a.modul = 'MTN' and a.periode='"+this.e_periode.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"'",["a.no_ba","a.keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);			
		}
		if (sender == this.e_nb && this.e_nb.getText()!= "") {						
			var strSQL = "select a.tanggal,a.periode,a.keterangan,a.no_dokumen,a.nik_buat,a.nik_app,b.no_po,c.keterangan as ket_po,c.kode_vendor,d.nama as nama_vendor,b.nu,b.termin,b.nilai,b.nilai_ppn,b.nilai+b.nilai_ppn as total,b.akun_hutang "+
						 "from log_ba_m a inner join log_po_termin b on a.no_ba=b.no_final and a.nu=b.nu and a.no_po=b.no_po and a.kode_lokasi=b.kode_lokasi "+
