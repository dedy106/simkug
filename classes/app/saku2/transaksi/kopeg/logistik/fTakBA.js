window.app_saku2_transaksi_kopeg_logistik_fTakBA = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_logistik_fTakBA.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_logistik_fTakBA";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form TAK Hutang PO: Input", 0);	
		...
		this.sg = new saiGrid(this.pc1.childPage[0],{bound:[1,10,this.pc1.width-5,this.pc1.height-40],colCount:13,tag:0,
					...
					picklist:[[0],[new portalui_arrayMap({items:["TAK","INPROG"]})]],
...
window.app_saku2_transaksi_kopeg_logistik_fTakBA.extend(window.childForm);
window.app_saku2_transaksi_kopeg_logistik_fTakBA.implement({
	...
	simpan: function(){			
		try{						
			this.e_nb.setText(this.standarLib.noBuktiOtomatis(this.dbLib,"takkirim_m","no_kirim",this.app._lokasi+"-TLOG"+this.e_periode.getText().substr(2,4)+".","000"));
