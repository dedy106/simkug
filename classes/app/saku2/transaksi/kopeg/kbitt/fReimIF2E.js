window.app_saku2_transaksi_kopeg_kbitt_fReimIF2E = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kbitt_fReimIF2E.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kbitt_fReimIF2E";
...
window.app_saku2_transaksi_kopeg_kbitt_fReimIF2E.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kbitt_fReimIF2E.implement({	
