window.app_saku2_transaksi_kopeg_kbitt_fAjuPtgLokE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kbitt_fAjuPtgLokE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kbitt_fAjuPtgLokE";
...
window.app_saku2_transaksi_kopeg_kbitt_fAjuPtgLokE.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kbitt_fAjuPtgLokE.implement({	
	...
	doChange:function(sender){
		if (sender == this.e_periode && this.e_periode.getText()!="") {						
			this.e_nb.setSQL("select no_aju, keterangan from it_aju_m where modul='PJPTG' and progress in ('0','R') and periode<='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' ",["no_aju","keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);		
		}
