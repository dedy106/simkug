window.app_saku2_transaksi_kopeg_kbitt_fAjuPtgM = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kbitt_fAjuPtgM.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kbitt_fAjuPtgM";
		...
		this.pc1 = new pageControl(this,{bound:[20,12,1000,300], childPage:["Item Pertanggungan","Data Anggaran"]});		
...
window.app_saku2_transaksi_kopeg_kbitt_fAjuPtgM.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kbitt_fAjuPtgM.implement({	
