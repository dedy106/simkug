window.app_saku2_transaksi_kopeg_kbitt_fAjuKBBrutoMrekE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kbitt_fAjuKBBrutoMrekE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kbitt_fAjuKBBrutoMrekE";
...
window.app_saku2_transaksi_kopeg_kbitt_fAjuKBBrutoMrekE.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kbitt_fAjuKBBrutoMrekE.implement({	
