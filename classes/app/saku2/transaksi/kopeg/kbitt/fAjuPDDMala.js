window.app_saku2_transaksi_kopeg_kbitt_fAjuPDDMala = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kbitt_fAjuPDDMala.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kbitt_fAjuPDDMala";
...
window.app_saku2_transaksi_kopeg_kbitt_fAjuPDDMala.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kbitt_fAjuPDDMala.implement({	
	doLoad: function() {
		this.stsSimpan = 0;
		...
		var strSQL = "select top 20 b.bank,b.no_rek,b.nama_rek,b.nilai,b.nim,c.nama "+
					"from aka_cd_d b "+
	...
	doChange:function(sender){
		if (sender == this.c_jenis && this.c_jenis.getText()!="") {
			...
			else this.cb_akun.setText("2141101");
		}
	},	
