window.app_saku2_transaksi_kopeg_kbitt_fFiatKBakru = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kbitt_fFiatKBakru.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kbitt_fFiatKBakru";
...
window.app_saku2_transaksi_kopeg_kbitt_fFiatKBakru.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kbitt_fFiatKBakru.implement({
