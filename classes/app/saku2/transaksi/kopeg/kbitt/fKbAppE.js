window.app_saku2_transaksi_kopeg_kbitt_fKbAppE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kbitt_fKbAppE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kbitt_fKbAppE";
...
window.app_saku2_transaksi_kopeg_kbitt_fKbAppE.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kbitt_fKbAppE.implement({
