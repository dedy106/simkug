window.app_saku2_transaksi_kopeg_kbitt_fAjuPDDMabaE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kbitt_fAjuPDDMabaE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kbitt_fAjuPDDMabaE";
		...
		this.pc1 = new pageControl(this.pc2.childPage[0],{bound:[1,12,996,200], childPage:["Daftar Rekening"]});
		this.sg1 = new saiGrid(this.pc1.childPage[0],{bound:[0,5,this.pc1.width-5,this.pc1.height-33],colCount:7,tag:0,
				colTitle:["No Peserta","Nama","Bank","No Rekening","Nama Rekening","Nilai","Thn Akademik"],
...
window.app_saku2_transaksi_kopeg_kbitt_fAjuPDDMabaE.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kbitt_fAjuPDDMabaE.implement({	
	doLoad: function() {
		this.stsSimpan = 0;
	...
	doChange:function(sender){
		if (sender == this.c_jenis && this.c_jenis.getText()!="") {
			if (this.c_jenis.getText() == "CAMABA") this.cb_akun.setText("2141101");
