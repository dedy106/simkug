window.app_saku2_transaksi_kopeg_kbitt_fAjuKBBrutoMrekAdminE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kbitt_fAjuKBBrutoMrekAdminE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kbitt_fAjuKBBrutoMrekAdminE";
...
window.app_saku2_transaksi_kopeg_kbitt_fAjuKBBrutoMrekAdminE.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kbitt_fAjuKBBrutoMrekAdminE.implement({	
