window.app_saku2_transaksi_kopeg_kbitt_fAppDokFisik = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kbitt_fAppDokFisik.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kbitt_fAppDokFisik";
...
window.app_saku2_transaksi_kopeg_kbitt_fAppDokFisik.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kbitt_fAppDokFisik.implement({	
