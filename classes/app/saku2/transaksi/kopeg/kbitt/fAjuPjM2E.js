window.app_saku2_transaksi_kopeg_kbitt_fAjuPjM2E = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kbitt_fAjuPjM2E.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kbitt_fAjuPjM2E";
		...
		this.pc1 = new pageControl(this,{bound:[20,12,1000,340], childPage:["Item Pertanggungan","Data Anggaran","Data Rekening"]});		
...
window.app_saku2_transaksi_kopeg_kbitt_fAjuPjM2E.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kbitt_fAjuPjM2E.implement({		
