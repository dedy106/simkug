window.app_saku2_transaksi_kopeg_kbitt_fEditDRK = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kbitt_fEditDRK.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kbitt_fEditDRK";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Edit DRK KasBank : Input", 0);	
...
window.app_saku2_transaksi_kopeg_kbitt_fEditDRK.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kbitt_fEditDRK.implement({
						...
						for (var i=0;i < this.sg1.getRowCount();i++){
							if (this.sg1.rowValid(i)){
								if (this.sg1.cells(7,i) != "-") {
									sql.add("update kas_j set kode_drk='"+this.sg1.cells(7,i)+"' where no_urut="+this.sg1.cells(9,i)+" and dc='"+this.sg1.cells(2,i)+"' and keterangan='"+this.sg1.cells(3,i)+"' and kode_pp ='"+this.sg1.cells(5,i)+"' and kode_akun='"+this.sg1.cells(0,i)+"' and no_kas='"+this.nokas+"' and kode_lokasi='"+this.app._lokasi+"'"); 								
								}
							}
						}
					}							
