window.app_saku2_transaksi_kopeg_kbitt_fAppDokFisik4 = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kbitt_fAppDokFisik4.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kbitt_fAppDokFisik4";
...
window.app_saku2_transaksi_kopeg_kbitt_fAppDokFisik4.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kbitt_fAppDokFisik4.implement({	
