window.app_saku2_transaksi_kopeg_kbitt_fAjuKBBruto = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kbitt_fAjuKBBruto.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kbitt_fAjuKBBruto";
		...
		this.e_saldo = new saiLabelEdit(this,{bound:[20,18,202,20],caption:"Saldo Budget TW", tag:1, tipeText:ttNilai, text:"0", readOnly:true});
...
window.app_saku2_transaksi_kopeg_kbitt_fAjuKBBruto.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kbitt_fAjuKBBruto.implement({	
