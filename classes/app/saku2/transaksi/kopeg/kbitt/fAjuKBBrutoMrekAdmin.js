window.app_saku2_transaksi_kopeg_kbitt_fAjuKBBrutoMrekAdmin = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kbitt_fAjuKBBrutoMrekAdmin.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kbitt_fAjuKBBrutoMrekAdmin";
...
window.app_saku2_transaksi_kopeg_kbitt_fAjuKBBrutoMrekAdmin.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kbitt_fAjuKBBrutoMrekAdmin.implement({	
