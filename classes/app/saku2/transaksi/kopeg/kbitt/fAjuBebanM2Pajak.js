window.app_saku2_transaksi_kopeg_kbitt_fAjuBebanM2Pajak = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kbitt_fAjuBebanM2Pajak.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kbitt_fAjuBebanM2Pajak";
...
window.app_saku2_transaksi_kopeg_kbitt_fAjuBebanM2Pajak.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kbitt_fAjuBebanM2Pajak.implement({		
