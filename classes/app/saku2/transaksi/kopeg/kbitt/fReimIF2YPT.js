window.app_saku2_transaksi_kopeg_kbitt_fReimIF2YPT = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kbitt_fReimIF2YPT.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kbitt_fReimIF2YPT";
...
window.app_saku2_transaksi_kopeg_kbitt_fReimIF2YPT.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kbitt_fReimIF2YPT.implement({	
