window.app_saku2_transaksi_kopeg_kbitt_fKbApp = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kbitt_fKbApp.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kbitt_fKbApp";
		...
		this.pc1 = new pageControl(this,{bound:[10,18,1000,480], childPage:["Data Pengajuan","Detail Pengajuan","Item Jurnal","Filter Data"]});
...
window.app_saku2_transaksi_kopeg_kbitt_fKbApp.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kbitt_fKbApp.implement({
	...
	doCari:function(sender){				
		var filter = "where a.progress in ('2') ";		
		if (this.e_nobukti.getText()!="") filter = filter+" and a.no_aju='"+this.e_nobukti.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"'";
		if (nilaiToFloat(this.e_nominal.getText())!=0) filter = filter+" and a.nilai="+nilaiToFloat(this.e_nominal.getText())+" and a.kode_lokasi='"+this.app._lokasi+"'";		
