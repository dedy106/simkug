window.app_saku2_transaksi_kopeg_kbitt_fVerKBDRKEOn = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kbitt_fVerKBDRKEOn.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kbitt_fVerKBDRKEOn";
...
window.app_saku2_transaksi_kopeg_kbitt_fVerKBDRKEOn.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kbitt_fVerKBDRKEOn.implement({
	...
	doChange:function(sender){
		...
		if (sender == this.e_nb && this.e_nb.getText()!="") {					
			var strSQL = "select a.tanggal as tgl,b.catatan,case c.progress when '1' then 'APPROVE' when 'R' then 'REVISI' end as progress,c.npajak,"+
                         ...
                         "			   inner join it_ajuapp_m d on c.no_aju=d.no_aju and c.kode_lokasi=d.kode_lokasi and d.jenis='ONLINE' and c.no_app=d.no_app "+				 						 
