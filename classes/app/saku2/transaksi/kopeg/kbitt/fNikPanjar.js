window.app_saku2_transaksi_kopeg_kbitt_fNikPanjar = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kbitt_fNikPanjar.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kbitt_fNikPanjar";
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Data Karyawan Panjar: Input/Edit", 0);	
...
window.app_saku2_transaksi_kopeg_kbitt_fNikPanjar.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kbitt_fNikPanjar.implement({
