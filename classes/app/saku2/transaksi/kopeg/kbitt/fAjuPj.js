window.app_saku2_transaksi_kopeg_kbitt_fAjuPj = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kbitt_fAjuPj.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kbitt_fAjuPj";
...
window.app_saku2_transaksi_kopeg_kbitt_fAjuPj.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kbitt_fAjuPj.implement({	
