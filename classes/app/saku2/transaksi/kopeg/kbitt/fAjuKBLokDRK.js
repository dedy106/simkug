window.app_saku2_transaksi_kopeg_kbitt_fAjuKBLokDRK = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kbitt_fAjuKBLokDRK.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kbitt_fAjuKBLokDRK";
...
window.app_saku2_transaksi_kopeg_kbitt_fAjuKBLokDRK.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kbitt_fAjuKBLokDRK.implement({	
