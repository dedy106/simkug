window.app_saku2_transaksi_kopeg_kbitt_fAppDokFisik2 = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kbitt_fAppDokFisik2.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kbitt_fAppDokFisik2";
        ...
        this.e_barcode = new portalui_saiLabelEdit(this,{bound:[232,11,202,20],caption:"Barcode",maxLength:30,change:[this,"doChange"]});		
...
window.app_saku2_transaksi_kopeg_kbitt_fAppDokFisik2.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kbitt_fAppDokFisik2.implement({	
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					sql.add("insert into it_ajuapp_m(no_app,no_aju,kode_lokasi,periode,tgl_input,user_input,tgl_aju,nik_terima,jenis) values "+
						    "('"+this.e_nb.getText()+"','"+this.e_noaju.getText()+"','"+this.app._lokasi+"','"+this.e_periode.getText()+"',getdate(),'"+this.e_user.getText()+"','"+this.dp_d2.getDateString()+"','"+this.cb_terima.getText()+"','OFFLINE')");					
