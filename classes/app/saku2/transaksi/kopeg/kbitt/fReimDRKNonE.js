window.app_saku2_transaksi_kopeg_kbitt_fReimDRKNonE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kbitt_fReimDRKNonE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kbitt_fReimDRKNonE";
...
window.app_saku2_transaksi_kopeg_kbitt_fReimDRKNonE.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kbitt_fReimDRKNonE.implement({	
	...
	doChange:function(sender){		
		...
		if (sender == this.e_nb && this.e_nb.getText()!="") {				
			var data = this.dbLib.getDataProvider("select a.kode_pp,a.nik_panjar,a.keterangan,a.periode,a.tanggal,a.modul,isnull(b.no_gambar,'') as no_gambar  "+
					   "from it_aju_m a left join it_aju_dok b on a.no_aju=b.no_bukti and a.kode_lokasi=b.kode_lokasi "+					   
