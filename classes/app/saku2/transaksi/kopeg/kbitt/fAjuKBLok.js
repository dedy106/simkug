window.app_saku2_transaksi_kopeg_kbitt_fAjuKBLok = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kbitt_fAjuKBLok.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kbitt_fAjuKBLok";
...
window.app_saku2_transaksi_kopeg_kbitt_fAjuKBLok.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kbitt_fAjuKBLok.implement({	
