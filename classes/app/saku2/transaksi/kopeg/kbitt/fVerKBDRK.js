window.app_saku2_transaksi_kopeg_kbitt_fVerKBDRK = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kbitt_fVerKBDRK.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kbitt_fVerKBDRK";
...
window.app_saku2_transaksi_kopeg_kbitt_fVerKBDRK.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kbitt_fVerKBDRK.implement({
