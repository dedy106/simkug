window.app_saku2_transaksi_kopeg_kbitt_fAjuPjE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kbitt_fAjuPjE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kbitt_fAjuPjE";
...
window.app_saku2_transaksi_kopeg_kbitt_fAjuPjE.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kbitt_fAjuPjE.implement({	
