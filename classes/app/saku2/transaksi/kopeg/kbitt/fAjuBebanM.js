window.app_saku2_transaksi_kopeg_kbitt_fAjuBebanM = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kbitt_fAjuBebanM.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kbitt_fAjuBebanM";
		...
		this.sg1 = new saiGrid(this.pc1.childPage[0],{bound:[1,5,this.pc1.width-5,this.pc1.height-30],colCount:5,tag:0,
					...
					afterPaste:[this,"doAfterPaste"],pasteEnable:true,
...
window.app_saku2_transaksi_kopeg_kbitt_fAjuBebanM.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kbitt_fAjuBebanM.implement({	
	doAfterPaste: function(sender,totalRow){
		try {						
			for (var i=0;i < this.sg1.getRowCount();i++){			
				if (this.sg1.rowValid(i)){
					this.doChangeCell1(this.sg1,0,i);				
					this.doChangeCell1(this.sg1,2,i);				
				}
			}			
			this.sg1.validasi();		
		} catch(e) {alert(e);}
