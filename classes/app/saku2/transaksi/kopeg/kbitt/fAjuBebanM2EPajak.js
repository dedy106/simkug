window.app_saku2_transaksi_kopeg_kbitt_fAjuBebanM2EPajak = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kbitt_fAjuBebanM2EPajak.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kbitt_fAjuBebanM2EPajak";
		...
		try {
			...
			this.cb_akun.setSQL("select a.kode_akun, a.nama from masakun a inner join flag_relasi b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi "+								
								"where b.kode_flag in ('100') and b.kode_akun like '2%' and a.kode_lokasi='"+this.app._lokasi+"'",["kode_akun","nama"],false,["Kode","Nama"],"and","Data Akun",true);													
...
window.app_saku2_transaksi_kopeg_kbitt_fAjuBebanM2EPajak.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kbitt_fAjuBebanM2EPajak.implement({		
