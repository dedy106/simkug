window.app_saku2_transaksi_kopeg_kbitt_fAjuKBLokDRKE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kbitt_fAjuKBLokDRKE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kbitt_fAjuKBLokDRKE";
...
window.app_saku2_transaksi_kopeg_kbitt_fAjuKBLokDRKE.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kbitt_fAjuKBLokDRKE.implement({	
	...
	doChange:function(sender){				
		...
		if (sender == this.e_periode && this.e_periode.getText()!="") {						
			...
			else this.e_nb.setSQL("select no_aju, keterangan from it_aju_m where kode_pp ='"+this.app._kodePP+"' and form = 'SINGLE' and modul='UMUM' and progress in ('A','K','R') and periode<='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' ",["no_aju","keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);		
		}		
