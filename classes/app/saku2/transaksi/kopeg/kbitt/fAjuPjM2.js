window.app_saku2_transaksi_kopeg_kbitt_fAjuPjM2 = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kbitt_fAjuPjM2.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kbitt_fAjuPjM2";
		...
		this.pc1 = new pageControl(this,{bound:[20,12,1000,320], childPage:["Item Pertanggungan","Data Anggaran","Panjar Terbuka","Data Rekening"]});		
...
window.app_saku2_transaksi_kopeg_kbitt_fAjuPjM2.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kbitt_fAjuPjM2.implement({		
