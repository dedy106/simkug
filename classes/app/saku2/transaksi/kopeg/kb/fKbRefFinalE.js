window.app_saku2_transaksi_kopeg_kb_fKbRefFinalE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kb_fKbRefFinalE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kb_fKbRefFinalE";
...
window.app_saku2_transaksi_kopeg_kb_fKbRefFinalE.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kb_fKbRefFinalE.implement({
