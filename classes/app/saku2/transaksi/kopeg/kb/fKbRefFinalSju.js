window.app_saku2_transaksi_kopeg_kb_fKbRefFinalSju = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kb_fKbRefFinalSju.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kb_fKbRefFinalSju";
...
window.app_saku2_transaksi_kopeg_kb_fKbRefFinalSju.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kb_fKbRefFinalSju.implement({	
