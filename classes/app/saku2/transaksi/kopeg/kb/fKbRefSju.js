window.app_saku2_transaksi_kopeg_kb_fKbRefSju = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kb_fKbRefSju.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kb_fKbRefSju";
...
window.app_saku2_transaksi_kopeg_kb_fKbRefSju.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kb_fKbRefSju.implement({
