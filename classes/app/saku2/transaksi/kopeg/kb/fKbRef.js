window.app_saku2_transaksi_kopeg_kb_fKbRef = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kb_fKbRef.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kb_fKbRef";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form KasBank Referensi: Input", 0);	
...
window.app_saku2_transaksi_kopeg_kb_fKbRef.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kb_fKbRef.implement({
