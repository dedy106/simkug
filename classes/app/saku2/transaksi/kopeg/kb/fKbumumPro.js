window.app_saku2_transaksi_kopeg_kb_fKbumumPro = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kb_fKbumumPro.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kb_fKbumumPro";
...
window.app_saku2_transaksi_kopeg_kb_fKbumumPro.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kb_fKbumumPro.implement({
