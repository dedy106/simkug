window.app_saku2_transaksi_kopeg_kb_fKbUmBulan = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kb_fKbUmBulan.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kb_fKbUmBulan";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form KasBank Umum Gar Bulanan: Input", 0);	
...
window.app_saku2_transaksi_kopeg_kb_fKbUmBulan.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kb_fKbUmBulan.implement({
