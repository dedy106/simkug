window.app_saku2_transaksi_kopeg_kb_fKbumumSju = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kb_fKbumumSju.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kb_fKbumumSju";
...
window.app_saku2_transaksi_kopeg_kb_fKbumumSju.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kb_fKbumumSju.implement({
