window.app_saku2_transaksi_kopeg_kb_fKbumumCjr = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kb_fKbumumCjr.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kb_fKbumumCjr";
...
window.app_saku2_transaksi_kopeg_kb_fKbumumCjr.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kb_fKbumumCjr.implement({
