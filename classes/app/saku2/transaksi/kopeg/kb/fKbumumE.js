window.app_saku2_transaksi_kopeg_kb_fKbumumE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kb_fKbumumE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kb_fKbumumE";
...
window.app_saku2_transaksi_kopeg_kb_fKbumumE.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kb_fKbumumE.implement({
