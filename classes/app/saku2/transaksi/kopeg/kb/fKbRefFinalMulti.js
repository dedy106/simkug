window.app_saku2_transaksi_kopeg_kb_fKbRefFinalMulti = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_kb_fKbRefFinalMulti.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_kb_fKbRefFinalMulti";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form KasBank Finalisasi Ref Multi: Input", 0);	
...
window.app_saku2_transaksi_kopeg_kb_fKbRefFinalMulti.extend(window.childForm);
window.app_saku2_transaksi_kopeg_kb_fKbRefFinalMulti.implement({	
