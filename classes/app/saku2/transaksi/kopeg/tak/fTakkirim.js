window.app_saku2_transaksi_kopeg_tak_fTakkirim = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_tak_fTakkirim.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_tak_fTakkirim";
...
window.app_saku2_transaksi_kopeg_tak_fTakkirim.extend(window.childForm);
window.app_saku2_transaksi_kopeg_tak_fTakkirim.implement({
		...
		switch (event){
			...
			case "simpan" :	
				if (this.flagDokFree == "1") {				
					var data = this.dbLib.getDataProvider("select no_kirim from takkirim_m where no_dokumen='"+this.e_dok.getText()+"' and kode_lokasi='"+this.app._lokasi+"'",true);
					if (typeof data == "object"){
						var line = data.rs.rows[0];							
						if (line != undefined){
				...
				if (!akunTAK) {
					system.alert(this,"Transaksi tidak valid.","Akun TAK tidak ditemukan");
					return false;						
				}
