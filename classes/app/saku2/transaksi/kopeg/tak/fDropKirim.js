window.app_saku2_transaksi_kopeg_tak_fDropKirim = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_tak_fDropKirim.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_tak_fDropKirim";
...
window.app_saku2_transaksi_kopeg_tak_fDropKirim.extend(window.childForm);
window.app_saku2_transaksi_kopeg_tak_fDropKirim.implement({
