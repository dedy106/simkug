window.app_saku2_transaksi_kopeg_fa_fFawoYPT = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_fa_fFawoYPT.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_fa_fFawoYPT";
		...
		this.cb_pp = new saiCBBL(this,{bound:[20,19,200,20],caption:"PP", multiSelection:false, maxLength:10, tag:2,change:[this,"doChange"]});
		...
		this.cb_beban = new saiCBBL(this,{bound:[20,15,200,20],caption:"Akun Beban", multiSelection:false, maxLength:10, tag:2,change:[this,"doChange"]});
		...
		this.e_akun = new portalui_saiLabelEdit(this,{bound:[20,18,432,20],caption:"Akun Aktap",readOnly:true, tag:3});
...
window.app_saku2_transaksi_kopeg_fa_fFawoYPT.extend(window.childForm);
window.app_saku2_transaksi_kopeg_fa_fFawoYPT.implement({
		...
		try{						
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2,3])){
				try{													
					...
					sql.add("update gl_fa_asset set progress = 'W' where no_fa='"+this.cb_fa.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");
