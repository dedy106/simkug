window.app_saku2_transaksi_kopeg_fa_fFasusutYPT2 = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_fa_fFasusutYPT2.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_fa_fFasusutYPT2";
...
window.app_saku2_transaksi_kopeg_fa_fFasusutYPT2.extend(window.childForm);
window.app_saku2_transaksi_kopeg_fa_fFasusutYPT2.implement({
