window.app_saku2_transaksi_kopeg_fa_fFawoYPTE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_fa_fFawoYPTE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_fa_fFawoYPTE";
		...
		this.cb_pp = new saiCBBL(this,{bound:[20,19,200,20],caption:"PP", readOnly:true});
		this.cb_drk = new saiCBBL(this,{bound:[20,18,200,20],caption:"DRK Penghapusan", readOnly:true});
		this.cb_beban = new saiCBBL(this,{bound:[20,15,200,20],caption:"Akun Beban", readOnly:true});
		this.cb_buat = new saiCBBL(this,{bound:[20,16,200,20],caption:"NIK Pembuat", multiSelection:false, maxLength:10, tag:2 });
		this.cb_app = new saiCBBL(this,{bound:[20,17,200,20],caption:"NIK Approve", multiSelection:false, maxLength:10, tag:2});
		
		this.cb_fa = new saiCBBL(this,{bound:[20,18,250,20],caption:"No Aktiva Tetap",readOnly:true});		
...
window.app_saku2_transaksi_kopeg_fa_fFawoYPTE.extend(window.childForm);
window.app_saku2_transaksi_kopeg_fa_fFawoYPTE.implement({
