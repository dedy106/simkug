window.app_saku2_transaksi_kopeg_fa_fFasusutRev = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_fa_fFasusutRev.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_fa_fFasusutRev";
...
window.app_saku2_transaksi_kopeg_fa_fFasusutRev.extend(window.childForm);
window.app_saku2_transaksi_kopeg_fa_fFasusutRev.implement({
