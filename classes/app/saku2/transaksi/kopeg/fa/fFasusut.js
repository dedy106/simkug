window.app_saku2_transaksi_kopeg_fa_fFasusut = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_fa_fFasusut.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_fa_fFasusut";
...
window.app_saku2_transaksi_kopeg_fa_fFasusut.extend(window.childForm);
window.app_saku2_transaksi_kopeg_fa_fFasusut.implement({
