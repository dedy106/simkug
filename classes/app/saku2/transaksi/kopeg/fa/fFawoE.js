window.app_saku2_transaksi_kopeg_fa_fFawoE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_fa_fFawoE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_fa_fFawoE";
...
window.app_saku2_transaksi_kopeg_fa_fFawoE.extend(window.childForm);
window.app_saku2_transaksi_kopeg_fa_fFawoE.implement({
