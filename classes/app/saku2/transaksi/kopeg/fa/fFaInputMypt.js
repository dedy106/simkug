window.app_saku2_transaksi_kopeg_fa_fFaInputMypt = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_fa_fFaInputMypt.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_fa_fFaInputMypt";
...
window.app_saku2_transaksi_kopeg_fa_fFaInputMypt.extend(window.childForm);
window.app_saku2_transaksi_kopeg_fa_fFaInputMypt.implement({
