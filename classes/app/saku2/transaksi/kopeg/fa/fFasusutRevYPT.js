window.app_saku2_transaksi_kopeg_fa_fFasusutRevYPT = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_fa_fFasusutRevYPT.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_fa_fFasusutRevYPT";
		...
		this.cb_fa = new saiCBBL(this,{bound:[20,20,250,20],caption:"No Aktiva Tetap", multiSelection:false, maxLength:10, tag:0, change:[this,"doChange"]});		
		this.cb_drk = new saiCBBL(this,{bound:[20,18,200,20],caption:"DRK Penyusutan", readOnly:true});		
...
window.app_saku2_transaksi_kopeg_fa_fFasusutRevYPT.extend(window.childForm);
window.app_saku2_transaksi_kopeg_fa_fFasusutRevYPT.implement({
