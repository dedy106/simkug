...
window.app_saku2_transaksi_kopeg_apotek_fBeliPtgE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_apotek_fBeliPtgE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_apotek_fBeliPtgE";
		this.itemsValue = new portalui_arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Pembatalan Pembelian Barang via Panjar: Edit", 0);	
		...
		this.cb_nik = new portalui_saiCBBL(this,{bound:[20,19,200,20],caption:"NIK Pemegang",tag:1,readOnly:true});	
		this.e_diskon = new saiLabelEdit(this,{bound:[720,19,200,20],caption:"Diskon", tag:1, tipeText:ttNilai, text:"0",readOnly:true});		
		this.cb_pj = new portalui_saiCBBL(this,{bound:[20,18,220,20],caption:"No Panjar",tag:1,readOnly:true});		
		this.e_ppn = new saiLabelEdit(this,{bound:[720,18,200,20],caption:"Nilai PPN", tag:1, readOnly:true, tipeText:ttNilai, text:"0"});		
		this.cb_vendor = new portalui_saiCBBL(this,{bound:[20,15,200,20],caption:"Vendor",tag:1});		
		this.e_mat = new saiLabelEdit(this,{bound:[720,15,200,20],caption:"Materai", tag:1, readOnly:true, tipeText:ttNilai, text:"0"});		
...
window.app_saku2_transaksi_kopeg_apotek_fBeliPtgE.extend(window.portalui_childForm);
window.app_saku2_transaksi_kopeg_apotek_fBeliPtgE.implement({	
	...
	doChange:function(sender){
		if (sender == this.e_periode && this.e_periode.getText() != "") {
			this.e_nb.setSQL("select a.no_beli, a.keterangan from apo_brg_beli_m a inner join panjarptg2_m b on a.no_beli=b.no_ptg and a.kode_lokasi=b.kode_lokasi "+
							 "where b.progress='0' and a.posted='F' and a.periode='"+this.e_periode.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"'",["a.no_beli","a.keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);
		}		
		if (sender == this.e_nb && this.e_nb.getText()!="") {
			var strSQL = "select a.nilai,a.akun_panjar,a.no_panjar,a.keterangan, "+
						 " b.nik_buat,c.nama as nama_buat "+
			...
			if (typeof data == "object"){
				var line = data.rs.rows[0];							
				if (line != undefined){							
					this.cb_nik.setText(line.nik_buat,line.nama_buat);
					this.cb_pj.setText(line.no_panjar,line.keterangan);
					this.akunpj = line.akun_panjar;
					this.e_pj.setText(floatToNilai(line.nilai));																				
				} 
			}			
			var strSQL = "select no_dokumen,keterangan,periode,tanggal,kode_vendor,kode_gudang,nilai,nilai_ppn,nilai_diskon,nilai_mat "+
