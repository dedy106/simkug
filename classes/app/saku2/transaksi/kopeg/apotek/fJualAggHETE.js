window.app_saku2_transaksi_kopeg_apotek_fJualAggHETE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_apotek_fJualAggHETE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_apotek_fJualAggHETE";
		...
		this.e_periode = new portalui_saiLabelEdit(this,{bound:[20,11,200,20],caption:"Periode",readOnly:true,tag:2,change:[this,"doChange"],visible:false});
		this.l_tgl = new portalui_label(this,{bound:[20,11,100,18],caption:"Tanggal", underline:true});
		this.dp_d1 = new portalui_datePicker(this,{bound:[120,11,98,18],selectDate:[this,"doSelectDate"]});
		this.e_nb = new saiCBBL(this,{bound:[20,12,245,20],caption:"No Bukti", multiSelection:false, maxLength:10, readOnly:true,change:[this,"doChange"]});
		this.e_dok = new portalui_saiLabelEdit(this,{bound:[20,13,225,20],caption:"No Resep", maxLength:100});						
		this.cb_icdx = new portalui_saiCBBL(this,{bound:[20,18,220,20],caption:"Pola Penyakit",multiSelection:false,tag:2});
		...
		this.cb_cust = new portalui_saiCBBL(this,{bound:[20,15,220,20],caption:"Customer",multiSelection:false,tag:1,change:[this,"doChange"]});
		this.e_nilai = new saiLabelEdit(this,{bound:[720,15,200,20],caption:"Total", tag:1, readOnly:true, tipeText:ttNilai, text:"0"});		
		this.cb_nik = new portalui_saiCBBL(this,{bound:[20,17,220,20],caption:"NIKes",multiSelection:false});		
...
window.app_saku2_transaksi_kopeg_apotek_fJualAggHETE.extend(window.portalui_childForm);
window.app_saku2_transaksi_kopeg_apotek_fJualAggHETE.implement({
