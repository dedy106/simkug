window.app_saku2_transaksi_kopeg_apotek_fKbJual = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_apotek_fKbJual.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_apotek_fKbJual";
		...
		this.cb_jual = new saiCBBL(this,{bound:[20,17,220,20],caption:"No Penjualan", multiSelection:false, maxLength:10, tag:1,change:[this,"doChange"]});				
...
window.app_saku2_transaksi_kopeg_apotek_fKbJual.extend(window.childForm);
window.app_saku2_transaksi_kopeg_apotek_fKbJual.implement({
	...
	doChange:function(sender){
		if ((sender == this.e_periode || sender == this.cb_cust) && (this.e_periode.getText()!= "" && this.cb_cust.getText()!= "")) {
			var strSQL = "select a.no_jual,a.keterangan,a.kode_lokasi from apo_brg_jual_m a "+
						 ...
						 "where a.modul<>'AGG' and a.kode_cust='"+this.cb_cust.getText()+"' and a.nilai>isnull(b.bayar,0) and a.periode<='"+this.e_periode.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"'";
