window.app_saku2_transaksi_kopeg_apotek_fJualHET = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_apotek_fJualHET.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_apotek_fJualHET";
		...
		this.cb_dokter = new portalui_saiCBBL(this,{bound:[20,14,220,20],caption:"Dokter",multiSelection:false,tag:1,change:[this,"doChange"]});
		this.e_tarif = new saiLabelEdit(this,{bound:[720,14,200,20],caption:"Tarif Dokter", tag:1, tipeText:ttNilai, text:"0",change:[this,"doChange"]});		
		this.e_pasien = new portalui_saiLabelEdit(this,{bound:[20,15,450,20],caption:"Nama Pasien", maxLength:100});						
		this.e_nilai = new saiLabelEdit(this,{bound:[720,15,200,20],caption:"Total", tag:1, readOnly:true, tipeText:ttNilai, text:"0"});		
		this.e_ket = new portalui_saiLabelEdit(this,{bound:[20,14,450,20],caption:"Keterangan", maxLength:150});				
		...
		this.cb_cust = new portalui_saiCBBL(this,{bound:[20,15,220,20],caption:"Customer",multiSelection:false,tag:1});
		...
		try{			
			...
			var data = this.dbLib.getDataProvider("select kode_spro,flag,value1 from spro where kode_spro in ('OBTMARGIN','OBTPDPTDOK','OBTPIUDOK','RESEPFREE','OBTPDPT','OBTHPP','HUTPPN','OBTPIU','OBTINV','OBTPOT') and kode_lokasi = '"+this.app._lokasi+"'",true);			
...
window.app_saku2_transaksi_kopeg_apotek_fJualHET.extend(window.portalui_childForm);
window.app_saku2_transaksi_kopeg_apotek_fJualHET.implement({
