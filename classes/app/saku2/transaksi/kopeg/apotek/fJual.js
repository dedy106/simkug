window.app_saku2_transaksi_kopeg_apotek_fJual = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_apotek_fJual.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_apotek_fJual";
...
window.app_saku2_transaksi_kopeg_apotek_fJual.extend(window.portalui_childForm);
window.app_saku2_transaksi_kopeg_apotek_fJual.implement({
