window.app_saku2_transaksi_kopeg_apotek_fJualAggHET = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_apotek_fJualAggHET.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_apotek_fJualAggHET";
		...
		this.cb_cust = new portalui_saiCBBL(this,{bound:[20,15,220,20],caption:"Customer",multiSelection:false,tag:2,change:[this,"doChange"]});		
		...
		this.cb_gudang = new portalui_saiCBBL(this,{bound:[20,16,220,20],caption:"Gudang",multiSelection:false,tag:2,change:[this,"doChange"]});
...
window.app_saku2_transaksi_kopeg_apotek_fJualAggHET.extend(window.portalui_childForm);
window.app_saku2_transaksi_kopeg_apotek_fJualAggHET.implement({
