window.app_saku2_transaksi_kopeg_apotek_fJualHETE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_apotek_fJualHETE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_apotek_fJualHETE";
...
window.app_saku2_transaksi_kopeg_apotek_fJualHETE.extend(window.portalui_childForm);
window.app_saku2_transaksi_kopeg_apotek_fJualHETE.implement({
