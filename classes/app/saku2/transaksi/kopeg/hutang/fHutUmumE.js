window.app_saku2_transaksi_kopeg_hutang_fHutUmumE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_hutang_fHutUmumE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_hutang_fHutUmumE";
...
window.app_saku2_transaksi_kopeg_hutang_fHutUmumE.extend(window.childForm);
window.app_saku2_transaksi_kopeg_hutang_fHutUmumE.implement({
	...
	doChange:function(sender){
		if (sender == this.e_periode && this.e_periode.getText()!= "") {			
			this.e_nb.setSQL("select a.no_hutang, a.keterangan from hutang_m a left join pb_m b on a.no_hutang=b.no_pb and a.kode_lokasi=b.kode_lokasi "+							 
			                 "where b.no_hutang is null and a.posted='F' and a.periode='"+this.e_periode.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' "+
			                 "and a.no_hutang not in (select distinct no_hutang from hutbayar_d)",["a.no_hutang","a.keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);			
		}		
		if (sender == this.e_nb && this.e_nb.getText()!="") {			
			var strSQL = "select a.tanggal,a.periode,a.no_dokumen,a.keterangan,a.kode_pp,a.akun_hutang,a.nik_app,a.kode_project,b.keterangan as ket_project,a.kode_vendor,c.nama as nama_vendor,nilai_ppn "+						 
						 "from hutang_m a inner join project b on a.kode_project=b.kode_project and a.kode_lokasi=b.kode_lokasi "+
