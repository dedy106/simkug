window.app_saku2_transaksi_kopeg_hutang_fSpbHutE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_hutang_fSpbHutE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_hutang_fSpbHutE";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Verifikasi Permintaan Bayar (SPB) : Edit", 0);	
		...
		this.e_nb2 = new portalui_saiLabelEdit(this,{bound:[20,13,202,20],caption:"No SPB",readOnly:true,tag:9});		
		
		this.pc1 = new pageControl(this,{bound:[20,18,980,460], childPage:["Detail Permintaan","Item Jurnal","Otorisasi SPB"]});										
		...
		this.e_nopb = new saiLabelEdit(this.pc1.childPage[0],{bound:[20,13,450,20],caption:"No PB", readOnly:true});						
		this.e_tgl = new saiLabelEdit(this.pc1.childPage[0],{bound:[520,13,450,20],caption:"Tanggal", readOnly:true});								
		this.e_nohutang = new saiLabelEdit(this.pc1.childPage[0],{bound:[20,14,450,20],caption:"No Hutang", readOnly:true});								
		this.e_duedate = new saiLabelEdit(this.pc1.childPage[0],{bound:[520,14,450,20],caption:"Due Date", readOnly:true});												
		this.e_ket = new saiLabelEdit(this.pc1.childPage[0],{bound:[20,10,450,20],caption:"Deskripsi", readOnly:true});										
		this.e_pp = new saiLabelEdit(this.pc1.childPage[0],{bound:[20,15,450,20],caption:"PP/Unit", readOnly:true});														
		this.e_akun = new saiLabelEdit(this.pc1.childPage[0],{bound:[520,15,450,20],caption:"Akun Hutang", readOnly:true});								
		this.e_vendor = new saiLabelEdit(this.pc1.childPage[0],{bound:[20,16,450,20],caption:"Vendor", readOnly:true});								
		this.e_bank = new saiLabelEdit(this.pc1.childPage[0],{bound:[520,16,450,20],caption:"Data Transfer", readOnly:true});										
		this.e_user = new saiLabelEdit(this.pc1.childPage[0],{bound:[20,18,450,20],caption:"Pengaju", readOnly:true});								
		this.e_tglinput = new saiLabelEdit(this.pc1.childPage[0],{bound:[520,18,450,20],caption:"Tgl Input", readOnly:true});		
		this.e_nilai = new saiLabelEdit(this.pc1.childPage[0],{bound:[20,17,200,20],caption:"Nominal", tag:9, readOnly:true, tipeText:ttNilai, text:"0"});						
		this.e_memo = new saiMemo(this.pc1.childPage[0],{bound:[20,12,450,80],caption:"Catatan Verifikasi",tag:9,readOnly:true});
		...
		this.cb1 = new portalui_checkBox(this.sgn1,{bound:[420,5,100,25],caption:"Preview",selected:true});		
		...
		this.l_tgl1 = new portalui_label(this.pc1.childPage[2],{bound:[20,11,100,18],caption:"Tanggal SPB", underline:true});
		this.dp_d1 = new portalui_datePicker(this.pc1.childPage[2],{bound:[120,11,100,18],selectDate:[this,"doSelectDate"]}); 				
		this.cb_buat = new saiCBBL(this.pc1.childPage[2],{bound:[20,16,200,20],caption:"Dibuat Oleh", multiSelection:false, maxLength:10, tag:2});				
		this.cb_tahu = new saiCBBL(this.pc1.childPage[2],{bound:[20,17,200,20],caption:"Diketahui Oleh", multiSelection:false, maxLength:10, tag:2});				
		this.cb_fiat = new saiCBBL(this.pc1.childPage[2],{bound:[20,19,200,20],caption:"Difiat Oleh", multiSelection:false, maxLength:10, tag:2});								
		this.cb_bdh = new saiCBBL(this.pc1.childPage[2],{bound:[20,20,200,20],caption:"Bendahara", multiSelection:false, maxLength:10, tag:2});								
...
window.app_saku2_transaksi_kopeg_hutang_fSpbHutE.extend(window.childForm);
window.app_saku2_transaksi_kopeg_hutang_fSpbHutE.implement({
	...
	doChange:function(sender){
		if (sender == this.e_periode && this.e_periode.getText() != "") {										 							 
			this.e_nb.setSQL("select b.no_ver, b.no_bukti "+
							 "from ver_d b inner join pb_m a on a.no_pb=b.no_bukti and a.kode_lokasi=b.kode_lokasi and b.modul='PBHU' "+
							 "             inner join ver_m c on b.no_ver=c.no_ver and a.kode_lokasi=c.kode_lokasi and c.no_verseb='-' "+
							 "             left join spb_m x on a.no_spb=x.no_spb and a.kode_lokasi=x.kode_lokasi "+
			                 "where (x.no_kas is null or x.no_kas = '-') and c.status in ('APPROVE','REVISI') and a.progress = '1' and c.periode='"+this.e_periode.getText()+"' and b.kode_lokasi='"+this.app._lokasi+"'",["b.no_ver","b.no_bukti"],false,["No Ver","No PB"],"and","Daftar Bukti",true);
		}		
		if (sender == this.e_nb && this.e_nb.getText()!="") {										
			var strSQL = "select x.tanggal as tgl,y.catatan,case f.progress when '1' then 'APPROVE' when 'R' then 'REVISI' end as progress,f.no_spb,z.nik_buat,z.nik_tahu,z.nik_fiat,z.nik_bdh, "+
						 ...
						 "     inner join spb_m z on f.no_spb=z.no_spb and f.kode_lokasi=z.kode_lokasi "+
						 "where x.no_ver ='"+this.e_nb.getText()+"' and x.kode_lokasi = '"+this.app._lokasi+"' "+
						 "union all "+
						 "select x.tanggal as tgl,y.catatan,case f.progress when '1' then 'APPROVE' when 'R' then 'REVISI' end as progress,f.no_spb,z.nik_buat,z.nik_tahu,z.nik_fiat,z.nik_bdh, "+
					     "       f.no_pb,convert(varchar,f.tanggal,103) as tanggal,a.no_hutang,f.nilai,f.keterangan,a.kode_pp+' - '+b.nama as pp,a.kode_vendor+' - '+d.nama as vendor, convert(varchar,f.tgl_input,103) as tgl_input, f.nik_buat+' - '+c.nama as pengaju,a.akun_hutang,d.bank+' - '+d.cabang +' - '+ d.no_rek +' - '+d.nama_rek as transfer,convert(varchar,f.due_date,103) as due_date "+
