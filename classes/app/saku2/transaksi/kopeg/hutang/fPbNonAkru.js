window.app_saku2_transaksi_kopeg_hutang_fPbNonAkru = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_hutang_fPbNonAkru.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_hutang_fPbNonAkru";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Permintaan Bayar Non Akru: Input", 0);	
		...
		this.e_nb = new portalui_saiLabelEdit(this,{bound:[20,16,202,20],caption:"No PB",maxLength:30,readOnly:true});
...
window.app_saku2_transaksi_kopeg_hutang_fPbNonAkru.extend(window.childForm);
window.app_saku2_transaksi_kopeg_hutang_fPbNonAkru.implement({
