window.app_saku2_transaksi_kopeg_hutang_fKbSpbE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_hutang_fKbSpbE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_hutang_fKbSpbE";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form KasBank SPB (Hutang Proses): Edit", 0);	
...
window.app_saku2_transaksi_kopeg_hutang_fKbSpbE.extend(window.childForm);
window.app_saku2_transaksi_kopeg_hutang_fKbSpbE.implement({
	...
	doChange:function(sender){
		if (sender == this.e_periode && this.e_periode.getText()!= "") {
			this.e_nb.setSQL("select no_kas, keterangan from kas_m where no_del='-' and modul = 'KBSPB' and posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"'",["no_kas","keterangan"],false,["No KasBank","Deskripsi"],"and","Daftar Bukti KB",true);			
		}
