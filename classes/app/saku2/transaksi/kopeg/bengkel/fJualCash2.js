window.app_saku2_transaksi_kopeg_bengkel_fJualCash2 = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_bengkel_fJualCash2.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_bengkel_fJualCash2";
		...
		this.e_periode = new portalui_saiLabelEdit(this,{bound:[270,11,200,20],caption:"Periode",readOnly:true,tag:2});
		this.l_tgl = new portalui_label(this,{bound:[20,11,100,18],caption:"Tanggal", underline:true});
		this.dp_d1 = new portalui_datePicker(this,{bound:[120,11,98,18],selectDate:[this,"doSelectDate"]});
		this.e_nb = new portalui_saiLabelEdit(this,{bound:[20,13,200,20],caption:"No Bukti",maxLength:30,readOnly:true});
		...
		this.e_nilai = new saiLabelEdit(this,{bound:[720,16,200,20],caption:"Total", tag:1, readOnly:true, tipeText:ttNilai, text:"0"});	
		...
		this.pc1 = new pageControl(this,{bound:[20,20,900,420], childPage:["Item Barang"]});
...
window.app_saku2_transaksi_kopeg_bengkel_fJualCash2.extend(window.portalui_childForm);
window.app_saku2_transaksi_kopeg_bengkel_fJualCash2.implement({
