window.app_saku2_transaksi_kopeg_bengkel_fInspeksi2 = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_bengkel_fInspeksi2.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_bengkel_fInspeksi2";
...
window.app_saku2_transaksi_kopeg_bengkel_fInspeksi2.extend(window.portalui_childForm);
window.app_saku2_transaksi_kopeg_bengkel_fInspeksi2.implement({
