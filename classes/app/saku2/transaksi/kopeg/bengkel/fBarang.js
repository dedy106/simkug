window.app_saku2_transaksi_kopeg_bengkel_fBarang = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_bengkel_fBarang.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_bengkel_fBarang";
...
window.app_saku2_transaksi_kopeg_bengkel_fBarang.extend(window.portalui_childForm);
window.app_saku2_transaksi_kopeg_bengkel_fBarang.implement({
