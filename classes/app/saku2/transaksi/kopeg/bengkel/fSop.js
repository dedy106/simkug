window.app_saku2_transaksi_kopeg_bengkel_fSop = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_bengkel_fSop.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku2_transaksi_kopeg_bengkel_fSop";
...
window.app_saku2_transaksi_kopeg_bengkel_fSop.extend(window.portalui_childForm);
window.app_saku2_transaksi_kopeg_bengkel_fSop.implement({
