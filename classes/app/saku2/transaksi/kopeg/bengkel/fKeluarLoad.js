window.app_saku2_transaksi_kopeg_bengkel_fKeluarLoad = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_bengkel_fKeluarLoad.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_bengkel_fKeluarLoad";
...
window.app_saku2_transaksi_kopeg_bengkel_fKeluarLoad.extend(window.portalui_childForm);
window.app_saku2_transaksi_kopeg_bengkel_fKeluarLoad.implement({
