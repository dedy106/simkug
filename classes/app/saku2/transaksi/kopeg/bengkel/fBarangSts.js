window.app_saku2_transaksi_kopeg_bengkel_fBarangSts = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_bengkel_fBarangSts.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_bengkel_fBarangSts";
...
window.app_saku2_transaksi_kopeg_bengkel_fBarangSts.extend(window.portalui_childForm);
window.app_saku2_transaksi_kopeg_bengkel_fBarangSts.implement({
