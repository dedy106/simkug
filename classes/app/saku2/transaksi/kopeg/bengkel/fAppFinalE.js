window.app_saku2_transaksi_kopeg_bengkel_fAppFinalE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_bengkel_fAppFinalE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_bengkel_fAppFinalE";
		...
		this.e_km = new saiLabelEdit(this.pc1.childPage[1],{bound:[270,13,202,20],caption:"KM Asal", tipeText:ttNilai, text:"0"});																
		...
		this.e_memojasa = new saiMemo(this.pc1.childPage[1],{bound:[20,16,450,80],caption:"Keterangan Jasa",tag:9});		
		this.e_memo = new saiMemo(this.pc1.childPage[1],{bound:[520,16,450,80],caption:"Catatan Invoice",tag:9});
...
window.app_saku2_transaksi_kopeg_bengkel_fAppFinalE.extend(window.childForm);
window.app_saku2_transaksi_kopeg_bengkel_fAppFinalE.implement({
	...
	doChange:function(sender){			
		...
		if (sender == this.e_nb && this.e_nb.getText()!="") {
				var strSQL = "select a.periode,a.tanggal as tgl,a.catatan,a.nilai_service,a.nilai_diskon,a.nilai_ppn, "+
