window.app_saku2_transaksi_kopeg_bengkel_fPiuFinalList = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_bengkel_fPiuFinalList.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_bengkel_fPiuFinalList";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Finalisasi Piutang List: Input", 0);	
		...
		this.e_nobukti = new saiLabelEdit(this.pc1.childPage[1],{bound:[20,11,200,20],caption:"No Invoice",tag:9});
...
window.app_saku2_transaksi_kopeg_bengkel_fPiuFinalList.extend(window.childForm);
window.app_saku2_transaksi_kopeg_bengkel_fPiuFinalList.implement({
	...
	doLoad:function(sender){
		if (this.e_periode.getText()!="") {
			var strSQL = "select a.no_jual,b.no_spk,convert(varchar,b.tanggal,103) as tanggal,b.cust,b.alamat,b.no_tel,(a.nilai+a.nilai_service-a.nilai_diskon+a.nilai_ppn - isnull(c.bayar,0)) as saldo,0 as nilai_bayar,a.akun_piutang "+
