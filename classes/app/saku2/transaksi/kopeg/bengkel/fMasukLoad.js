window.app_saku2_transaksi_kopeg_bengkel_fMasukLoad = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_bengkel_fMasukLoad.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_bengkel_fMasukLoad";
...
window.app_saku2_transaksi_kopeg_bengkel_fMasukLoad.extend(window.portalui_childForm);
window.app_saku2_transaksi_kopeg_bengkel_fMasukLoad.implement({	
