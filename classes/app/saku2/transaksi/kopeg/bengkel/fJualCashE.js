window.app_saku2_transaksi_kopeg_bengkel_fJualCashE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_bengkel_fJualCashE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_bengkel_fJualCashE";
		...
		this.pc1 = new pageControl(this,{bound:[20,20,900,450], childPage:["Item Barang","Data Penjualan"]});
...
window.app_saku2_transaksi_kopeg_bengkel_fJualCashE.extend(window.portalui_childForm);
window.app_saku2_transaksi_kopeg_bengkel_fJualCashE.implement({
		...
		if (sender == this.e_nb && this.e_nb.getText()!="") {			
			...
			if (typeof data == "object"){
				...
				if (line != undefined){					
					...
					this.e_cust.setText(line.keterangan);
