window.app_saku2_transaksi_kopeg_gl_fJuLoadTrans = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_gl_fJuLoadTrans.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_gl_fJuLoadTrans";
...
window.app_saku2_transaksi_kopeg_gl_fJuLoadTrans.extend(window.childForm);
window.app_saku2_transaksi_kopeg_gl_fJuLoadTrans.implement({
