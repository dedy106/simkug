window.app_saku2_transaksi_kopeg_gl_fJuBulan = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_gl_fJuBulan.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_gl_fJuBulan";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Jurnal Umum Gar Bulanan: Input", 0);	
...
window.app_saku2_transaksi_kopeg_gl_fJuBulan.extend(window.childForm);
window.app_saku2_transaksi_kopeg_gl_fJuBulan.implement({	
