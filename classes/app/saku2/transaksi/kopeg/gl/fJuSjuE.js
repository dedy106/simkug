window.app_saku2_transaksi_kopeg_gl_fJuSjuE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_gl_fJuSjuE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_gl_fJuSjuE";
...
window.app_saku2_transaksi_kopeg_gl_fJuSjuE.extend(window.childForm);
window.app_saku2_transaksi_kopeg_gl_fJuSjuE.implement({
