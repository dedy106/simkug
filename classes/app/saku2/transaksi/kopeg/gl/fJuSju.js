window.app_saku2_transaksi_kopeg_gl_fJuSju = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_gl_fJuSju.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_gl_fJuSju";
...
window.app_saku2_transaksi_kopeg_gl_fJuSju.extend(window.childForm);
window.app_saku2_transaksi_kopeg_gl_fJuSju.implement({	
