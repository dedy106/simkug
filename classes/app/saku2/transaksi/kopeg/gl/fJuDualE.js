window.app_saku2_transaksi_kopeg_gl_fJuDualE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_gl_fJuDualE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_gl_fJuDualE";
...
window.app_saku2_transaksi_kopeg_gl_fJuDualE.extend(window.childForm);
window.app_saku2_transaksi_kopeg_gl_fJuDualE.implement({	
