window.app_saku2_transaksi_kopeg_gl_fJuRefFinalSjuE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_gl_fJuRefFinalSjuE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_gl_fJuRefFinalSjuE";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Jurnal Umum Finalisasi Ref: Edit", 0);	
...
window.app_saku2_transaksi_kopeg_gl_fJuRefFinalSjuE.extend(window.childForm);
window.app_saku2_transaksi_kopeg_gl_fJuRefFinalSjuE.implement({
	...
	doChange:function(sender){
		...
		*/
		if (sender == this.e_periode && this.e_periode.getText()!="") {
			this.e_nb.setSQL("select no_ju, keterangan from ju_m where modul = 'JUADJ' and posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"'",["no_ju","keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);
		}
		if (sender == this.e_nb && this.e_nb.getText()!="") {
			var data = this.dbLib.getDataProvider("select a.no_dokumen,convert(varchar,a.tanggal,103) as tanggal,a.periode,a.keterangan,a.jenis,a.nik_buat,b.nama as nama_buat,a.nik_setuju,c.nama as nama_setuju, "+
					   ...
					   "            inner join ju_j g on a.no_ju=g.no_ju and a.kode_lokasi=g.kode_lokasi and g.jenis='AKUNREF' "+
					   "            left join ( "+
					   ...
					   "where a.no_ju='"+this.e_nb.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' "+
					   "union "+
					   "select a.no_dokumen,convert(varchar,a.tanggal,103) as tanggal,a.periode,a.keterangan,a.jenis,a.nik_buat,b.nama as nama_buat,a.nik_setuju,c.nama as nama_setuju, "+
			...
			var data = this.dbLib.getDataProvider(
						...
						"where a.jenis<>'AKUNREF' and a.no_ju = '"+this.e_nb.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' order by a.no_urut",true);
			if (typeof data == "object" && data.rs.rows[0] != undefined){
				var line;
				this.sg.clear();
				for (var i in data.rs.rows){
