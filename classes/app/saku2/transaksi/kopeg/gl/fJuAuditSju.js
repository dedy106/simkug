window.app_saku2_transaksi_kopeg_gl_fJuAuditSju = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_gl_fJuAuditSju.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_gl_fJuAuditSju";
...
window.app_saku2_transaksi_kopeg_gl_fJuAuditSju.extend(window.childForm);
window.app_saku2_transaksi_kopeg_gl_fJuAuditSju.implement({
