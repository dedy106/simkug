window.app_saku2_transaksi_kopeg_gl_fJu = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_gl_fJu.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_gl_fJu";
...
window.app_saku2_transaksi_kopeg_gl_fJu.extend(window.childForm);
window.app_saku2_transaksi_kopeg_gl_fJu.implement({	
