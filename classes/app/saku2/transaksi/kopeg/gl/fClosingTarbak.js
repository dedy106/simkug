window.app_saku2_transaksi_kopeg_gl_fClosingTarbak = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_gl_fClosingTarbak.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_gl_fClosingTarbak";
...
window.app_saku2_transaksi_kopeg_gl_fClosingTarbak.extend(window.childForm);
window.app_saku2_transaksi_kopeg_gl_fClosingTarbak.implement({
