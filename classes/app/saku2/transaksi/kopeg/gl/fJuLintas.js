window.app_saku2_transaksi_kopeg_gl_fJuLintas = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_gl_fJuLintas.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_gl_fJuLintas";
...
window.app_saku2_transaksi_kopeg_gl_fJuLintas.extend(window.childForm);
window.app_saku2_transaksi_kopeg_gl_fJuLintas.implement({
