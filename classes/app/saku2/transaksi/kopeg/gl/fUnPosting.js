window.app_saku2_transaksi_kopeg_gl_fUnPosting = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_gl_fUnPosting.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_gl_fUnPosting";
...
window.app_saku2_transaksi_kopeg_gl_fUnPosting.extend(window.childForm);
window.app_saku2_transaksi_kopeg_gl_fUnPosting.implement({
				...
				switch(this.c_modul.getText()){
					...
					case "AR" :
								strSQL = "select 'INPROG' as status,no_piutang as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'PIUUM' as jenis "+
										 ...
										 "where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' ";
								this.cb_bukti.setSQL("select no_piutang as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'PIUUM' as jenis from piutang_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
												     "union "+
													 "select no_sisih as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'PIUSSH' as jenis from piutang_sisih_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' ",
					...
					case "AP" :
								strSQL = "select 'INPROG' as status,no_hutang as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'HUTUM' as jenis "+
										 "from hutang_m "+
										 "where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' ";										 
								this.cb_bukti.setSQL("select no_hutang as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'HUTKES' as jenis from hutang_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' ",									                 
					...
					case "APO" :
								...
								this.cb_bukti.setSQL("select no_beli as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'APOBELI' as jenis from apo_brg_beli_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
												     "union "+
													 "select no_jual as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'APOJUAL' as jenis from apo_brg_jual_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 "union "+
													 "select no_sop as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'APOSOP' as jenis from apo_brg_sop_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' ",
								                    ["no_bukti","no_dokumen","tanggal","keterangan","jenis"],false,["No Bukti","No Dokumen","Tanggal","Keterangan","Jenis"],"and","Data Bukti Piutang",true);
						break;	
					case "BRG" :
								...
								this.cb_bukti.setSQL("select no_beli as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'BRGBELI' as jenis from brg_beli_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
								                     "union "+
													 "select no_jual as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'BRGJUAL' as jenis from brg_jual_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' "+
													 "union "+
													 "select no_sop as no_bukti,no_dokumen,convert(varchar,tanggal,103) as tanggal,keterangan,'BRGSOP' as jenis from brg_sop_m where posted='T' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"' ",
													["no_bukti","no_dokumen","tanggal","keterangan","jenis"],false,["No Bukti","No Dokumen","Tanggal","Keterangan","Jenis"],"and","Data Bukti Piutang",true);
						break;
