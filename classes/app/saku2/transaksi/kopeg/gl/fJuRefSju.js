window.app_saku2_transaksi_kopeg_gl_fJuRefSju = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_gl_fJuRefSju.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_gl_fJuRefSju";
...
window.app_saku2_transaksi_kopeg_gl_fJuRefSju.extend(window.childForm);
window.app_saku2_transaksi_kopeg_gl_fJuRefSju.implement({	
