window.app_saku2_transaksi_kopeg_gl_fJuRefSjuE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_gl_fJuRefSjuE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_gl_fJuRefSjuE";
		...
		this.c_jenis = new saiLabelEdit(this,{bound:[20,15,203,20],caption:"Jenis Dok", readOnly:true});				
...
window.app_saku2_transaksi_kopeg_gl_fJuRefSjuE.extend(window.childForm);
window.app_saku2_transaksi_kopeg_gl_fJuRefSjuE.implement({
