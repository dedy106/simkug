window.app_saku2_transaksi_kopeg_gl_fJuRefFinalE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_gl_fJuRefFinalE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_gl_fJuRefFinalE";
...
window.app_saku2_transaksi_kopeg_gl_fJuRefFinalE.extend(window.childForm);
window.app_saku2_transaksi_kopeg_gl_fJuRefFinalE.implement({
