window.app_saku2_transaksi_kopeg_gl_fJPSju = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_gl_fJPSju.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku2_transaksi_kopeg_gl_fJPSju";
...
window.app_saku2_transaksi_kopeg_gl_fJPSju.extend(window.portalui_childForm);
window.app_saku2_transaksi_kopeg_gl_fJPSju.implement({
	doUploadTB: function(){		
		try{
			...
			sql = "select a.kode_akun,b.nama,a.so_awal,a.debet,a.kredit,round(a.so_akhir,2) as so_akhir "+
				  "from glma_tmp a inner join masakun b on b.kode_akun = a.kode_akun and b.kode_lokasi = a.kode_lokasi and b.modul = 'L' where a.kode_lokasi ='"+this.app._lokasi+"' and a.nik_user = '"+this.nik_user+"' and round(a.so_akhir,2) <> 0 order by a.kode_akun";
