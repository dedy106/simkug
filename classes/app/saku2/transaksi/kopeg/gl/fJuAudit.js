window.app_saku2_transaksi_kopeg_gl_fJuAudit = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_gl_fJuAudit.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_gl_fJuAudit";
...
window.app_saku2_transaksi_kopeg_gl_fJuAudit.extend(window.childForm);
window.app_saku2_transaksi_kopeg_gl_fJuAudit.implement({
