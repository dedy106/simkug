window.app_saku2_transaksi_kopeg_gl_fJuRefFinalSju = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_gl_fJuRefFinalSju.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_gl_fJuRefFinalSju";
...
window.app_saku2_transaksi_kopeg_gl_fJuRefFinalSju.extend(window.childForm);
window.app_saku2_transaksi_kopeg_gl_fJuRefFinalSju.implement({	
