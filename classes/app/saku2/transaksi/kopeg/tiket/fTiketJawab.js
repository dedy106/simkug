window.app_saku2_transaksi_kopeg_tiket_fTiketJawab = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_tiket_fTiketJawab.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_tiket_fTiketJawab";
...
window.app_saku2_transaksi_kopeg_tiket_fTiketJawab.extend(window.childForm);
window.app_saku2_transaksi_kopeg_tiket_fTiketJawab.implement({	
