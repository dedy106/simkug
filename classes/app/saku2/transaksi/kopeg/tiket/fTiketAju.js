window.app_saku2_transaksi_kopeg_tiket_fTiketAju = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_tiket_fTiketAju.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_tiket_fTiketAju";
...
window.app_saku2_transaksi_kopeg_tiket_fTiketAju.extend(window.childForm);
window.app_saku2_transaksi_kopeg_tiket_fTiketAju.implement({	
