window.app_saku2_transaksi_kopeg_gaji_fGajiLoad = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_gaji_fGajiLoad.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku2_transaksi_kopeg_gaji_fGajiLoad";
...
window.app_saku2_transaksi_kopeg_gaji_fGajiLoad.extend(window.portalui_childForm);
window.app_saku2_transaksi_kopeg_gaji_fGajiLoad.implement({
