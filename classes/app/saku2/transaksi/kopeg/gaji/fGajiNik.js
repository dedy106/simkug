window.app_saku2_transaksi_kopeg_gaji_fGajiNik = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_gaji_fGajiNik.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_gaji_fGajiNik";
...
window.app_saku2_transaksi_kopeg_gaji_fGajiNik.extend(window.childForm);
window.app_saku2_transaksi_kopeg_gaji_fGajiNik.implement({
