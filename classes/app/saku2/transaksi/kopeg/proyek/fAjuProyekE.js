window.app_saku2_transaksi_kopeg_proyek_fAjuProyekE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_proyek_fAjuProyekE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_proyek_fAjuProyekE";
...
window.app_saku2_transaksi_kopeg_proyek_fAjuProyekE.extend(window.childForm);
window.app_saku2_transaksi_kopeg_proyek_fAjuProyekE.implement({	
	...
	doChange:function(sender){
		...
		if (sender == this.e_nb && this.e_nb.getText()!="") {
			var data = this.dbLib.getDataProvider("select aa.no_proyek,a.progress,a.modul,a.tanggal,a.periode,a.keterangan,a.nilai,a.kode_pp,a.kode_akun,a.kode_drk,isnull(x.no_ver,'-') as no_ver,isnull(x.catatan,'-') as catatan,a.user_input "+
