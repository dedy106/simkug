window.app_saku2_transaksi_kopeg_proyek_fAkruPiuTerminE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_proyek_fAkruPiuTerminE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_proyek_fAkruPiuTerminE";
...
window.app_saku2_transaksi_kopeg_proyek_fAkruPiuTerminE.extend(window.childForm);
window.app_saku2_transaksi_kopeg_proyek_fAkruPiuTerminE.implement({
