window.app_saku2_transaksi_kopeg_proyek_fPddFinalE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_proyek_fPddFinalE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_proyek_fPddFinalE";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Finalisasi PDD: Edit", 0);	
		...
		this.e_pdd = new saiLabelEdit(this,{bound:[710,14,210,20],caption:"Total PDD", tag:1, readOnly:true, tipeText:ttNilai, text:"0"});		
		...
		this.pc1 = new pageControl(this,{bound:[20,12,900,240], childPage:["Data PDD","Item Jurnal Pdpt"]});
		this.sg1 = new saiGrid(this.pc1.childPage[0],{bound:[1,5,this.pc1.width-5,this.pc1.height-35],colCount:6,tag:0,
		            colTitle:["No Piutang","Periode","Akun PDD","Keterangan","Nilai PDD","Nilai Final"],
...
window.app_saku2_transaksi_kopeg_proyek_fPddFinalE.extend(window.childForm);
window.app_saku2_transaksi_kopeg_proyek_fPddFinalE.implement({
	...
	doChange:function(sender){		
		...
		if (sender == this.e_nb && this.e_nb.getText()!="") {
			...
			var strSQL = "select a.no_piutang,a.periode,a.akun_pdd,a.keterangan,a.nilai-isnull(b.pdd,0) as saldo,c.nilai "+						
					"from pr_piutang_m a "+
