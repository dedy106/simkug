window.app_saku2_transaksi_kopeg_proyek_fBmhdProyek = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_proyek_fBmhdProyek.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_proyek_fBmhdProyek";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Pengajuan BMHD Project: Input", 0);	
...
window.app_saku2_transaksi_kopeg_proyek_fBmhdProyek.extend(window.childForm);
window.app_saku2_transaksi_kopeg_proyek_fBmhdProyek.implement({	
	...
	doClick:function(sender){
		this.e_nb.setText(this.standarLib.noBuktiOtomatis(this.dbLib,"pr_bmhd_m","no_bmhd",this.app._lokasi+'-'+this.e_periode.getText().substr(2,2)+".","00000"));
	...
	doChange:function(sender){
		if (sender==this.cb_pp && this.cb_pp.getText()!="") {			
			this.cb_id.setText("","");
			this.cb_id.setSQL("select no_proyek, keterangan from pr_proyek_m where flag_aktif in ('1','2') and tahun = '"+this.e_periode.getText().substr(0,4)+"' and kode_pp='"+this.cb_pp.getText()+"' and progress ='1' and kode_lokasi='"+this.app._lokasi+"'",["no_proyek","keterangan"],false,["ID Project","Deskripsi"],"and","Data Project",true);						
