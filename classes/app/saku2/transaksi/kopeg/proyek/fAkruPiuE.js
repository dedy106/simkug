window.app_saku2_transaksi_kopeg_proyek_fAkruPiuE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_proyek_fAkruPiuE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_proyek_fAkruPiuE";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Akru Piutang Project: Edit", 0);	
...
window.app_saku2_transaksi_kopeg_proyek_fAkruPiuE.extend(window.childForm);
window.app_saku2_transaksi_kopeg_proyek_fAkruPiuE.implement({
		...
		try{									
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					sql.add("delete from angg_r where no_bukti='"+this.e_nb.getText()+"' and kode_lokasi='"+this.app._lokasi+"' and modul='PIUPROJECT'");
		...
		if (sender == this.e_nb && this.e_nb.getText()!="") {
			...
			if (typeof data == "object"){
				...
				if (line != undefined){
					...
					this.e_pdd.setText(floatToNilai(line.nilai_pdd));										
	...
	doNilaiChange: function(){
		try{			
			...
			this.e_total.setText(floatToNilai(tot + nilaiToFloat(this.e_ppn.getText()) + nilaiToFloat(this.e_pdd.getText()) ));
		}catch(e)
		{
