window.app_saku2_transaksi_kopeg_gar_fApp = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_gar_fApp.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_gar_fApp";
...
window.app_saku2_transaksi_kopeg_gar_fApp.extend(window.childForm);
window.app_saku2_transaksi_kopeg_gar_fApp.implement({
				...
				try{				
					...
					for (var i=0;i < this.dataJU.rs.rows.length;i++){
						...
						if (line.status.toUpperCase() == "APP"){
							...
							sql.add("insert into anggaran_d (no_agg,kode_lokasi,no_urut,kode_pp,kode_akun,kode_drk,volume,periode,nilai_sat,nilai,dc,satuan,nik_user,tgl_input,modul,buffer)  "+		
									"select a.no_pdrk,a.kode_lokasi,a.no_urut,a.kode_pp,a.kode_akun,a.kode_drk,1,a.periode,a.nilai,a.nilai,a.dc,'-',b.nik_user,getdate(),'RRA',0 "+
