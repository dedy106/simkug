window.app_saku2_transaksi_kopeg_gar_fAbtE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_gar_fAbtE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_gar_fAbtE";
...
window.app_saku2_transaksi_kopeg_gar_fAbtE.extend(window.childForm);
window.app_saku2_transaksi_kopeg_gar_fAbtE.implement({	
