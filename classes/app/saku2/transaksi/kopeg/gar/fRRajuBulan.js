window.app_saku2_transaksi_kopeg_gar_fRRajuBulan = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_gar_fRRajuBulan.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_gar_fRRajuBulan";
		...
		this.pc1 = new pageControl(this,{bound:[20,16,900,300], childPage:["Data Donor","Data Penerima"]});
...
window.app_saku2_transaksi_kopeg_gar_fRRajuBulan.extend(window.childForm);
window.app_saku2_transaksi_kopeg_gar_fRRajuBulan.implement({
