window.app_saku2_transaksi_kopeg_gar_fAbt = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_gar_fAbt.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_gar_fAbt";
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Penambahan Anggaran (ABT): Input", 0);	
...
window.app_saku2_transaksi_kopeg_gar_fAbt.extend(window.childForm);
window.app_saku2_transaksi_kopeg_gar_fAbt.implement({
	...
	simpan: function(){			
		try{						
			this.e_nb.setText(this.standarLib.noBuktiOtomatis(this.dbLib,"anggaran_m","no_agg",this.app._lokasi+"-ABT"+this.e_periode.getText().substr(2,4)+".","000"));
					...
					if (this.sg.getRowValidCount() > 0){
						for (var i=0;i < this.sg.getRowCount();i++){
							if (this.sg.rowValid(i)){
								...
								/* harus di approve tidak langsung
