window.app_saku2_transaksi_kopeg_ppbs_fUsulan = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_ppbs_fUsulan.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_ppbs_fUsulan";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Usulan Anggaran : Input", 0);	
...
window.app_saku2_transaksi_kopeg_ppbs_fUsulan.extend(window.childForm);
window.app_saku2_transaksi_kopeg_ppbs_fUsulan.implement({	
