window.app_saku2_transaksi_kopeg_ppbs_fEvalAkun = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_ppbs_fEvalAkun.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_ppbs_fEvalAkun";
...
window.app_saku2_transaksi_kopeg_ppbs_fEvalAkun.extend(window.childForm);
window.app_saku2_transaksi_kopeg_ppbs_fEvalAkun.implement({	
