window.app_saku2_transaksi_kopeg_panjar_fKbpanjarE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_panjar_fKbpanjarE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_panjar_fKbpanjarE";
...
window.app_saku2_transaksi_kopeg_panjar_fKbpanjarE.extend(window.childForm);
window.app_saku2_transaksi_kopeg_panjar_fKbpanjarE.implement({
