...
*/
window.app_saku2_transaksi_kopeg_panjar_fPjptgPro = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_panjar_fPjptgPro.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_panjar_fPjptgPro";
...
window.app_saku2_transaksi_kopeg_panjar_fPjptgPro.extend(window.childForm);
window.app_saku2_transaksi_kopeg_panjar_fPjptgPro.implement({
