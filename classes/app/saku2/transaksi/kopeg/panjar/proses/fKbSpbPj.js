window.app_saku2_transaksi_kopeg_panjar_proses_fKbSpbPj = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_panjar_proses_fKbSpbPj.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_panjar_proses_fKbSpbPj";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form KasBank SPB (Panjar Proses): Input", 0);	
...
window.app_saku2_transaksi_kopeg_panjar_proses_fKbSpbPj.extend(window.childForm);
window.app_saku2_transaksi_kopeg_panjar_proses_fKbSpbPj.implement({
