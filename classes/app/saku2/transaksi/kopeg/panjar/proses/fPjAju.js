window.app_saku2_transaksi_kopeg_panjar_proses_fPjAju = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_panjar_proses_fPjAju.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_panjar_proses_fPjAju";
...
window.app_saku2_transaksi_kopeg_panjar_proses_fPjAju.extend(window.childForm);
window.app_saku2_transaksi_kopeg_panjar_proses_fPjAju.implement({
