window.app_saku2_transaksi_kopeg_panjar_proses_fPtgFinal = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_panjar_proses_fPtgFinal.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_panjar_proses_fPtgFinal";
		...
		this.pc1 = new pageControl(this,{bound:[20,18,980,400], childPage:["Data Pertanggungan","Detail Pertanggungan","Kas Bank"]});				
...
window.app_saku2_transaksi_kopeg_panjar_proses_fPtgFinal.extend(window.childForm);
window.app_saku2_transaksi_kopeg_panjar_proses_fPtgFinal.implement({
	...
	doClick:function(sender){
		...
		if (sender == this.i_genkb) {
			this.e_nbkb.setText(this.standarLib.noBuktiOtomatis(this.dbLib,"kas_m","no_kas",this.app._lokasi+"-"+this.c_jenis.getText()+this.e_periode.getText().substr(2,4)+".","000"));
