...
*/
window.app_saku2_transaksi_kopeg_panjar_fPjptgProCsm = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_panjar_fPjptgProCsm.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_panjar_fPjptgProCsm";
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Pertanggungan Panjar Proyek (CSM): Input", 0);	
...
window.app_saku2_transaksi_kopeg_panjar_fPjptgProCsm.extend(window.childForm);
window.app_saku2_transaksi_kopeg_panjar_fPjptgProCsm.implement({
