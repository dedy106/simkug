window.app_saku2_transaksi_kopeg_panjar_fKbpanjarSjuE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_panjar_fKbpanjarSjuE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_panjar_fKbpanjarSjuE";
...
window.app_saku2_transaksi_kopeg_panjar_fKbpanjarSjuE.extend(window.childForm);
window.app_saku2_transaksi_kopeg_panjar_fKbpanjarSjuE.implement({
	...
	doChange:function(sender){
		...
		if (sender == this.e_periode && this.e_periode.getText()!="") {
			this.e_nb.setSQL("select no_kas, keterangan from kas_m where no_del='-' and modul = 'KBPJ' and posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"'",["no_kas","keterangan"],false,["No KB","Deskripsi"],"and","Daftar Bukti KB",true);
		}
		if (sender == this.e_nb && this.e_nb.getText()!="") {
			var data = this.dbLib.getDataProvider("select d.no_pj,convert(varchar,a.tanggal,103) as tanggal,convert(varchar,d.due_date,103) as due_date,a.periode,a.no_bg,a.keterangan,a.jenis,a.nik_buat,b.nama as nama_buat,a.nik_app,c.nama as nama_app,a.no_dokumen, "+
					   "           a.nilai,a.akun_kb,d.akun_pj,d.kode_pp,e.kode_cf,f.nama as nama_kb,g.nama as nama_pj,h.nama as nama_pp "+
