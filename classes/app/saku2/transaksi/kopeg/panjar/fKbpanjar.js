window.app_saku2_transaksi_kopeg_panjar_fKbpanjar = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_panjar_fKbpanjar.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_panjar_fKbpanjar";
...
window.app_saku2_transaksi_kopeg_panjar_fKbpanjar.extend(window.childForm);
window.app_saku2_transaksi_kopeg_panjar_fKbpanjar.implement({
