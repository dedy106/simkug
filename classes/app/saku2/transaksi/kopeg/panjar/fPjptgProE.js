...
*/
window.app_saku2_transaksi_kopeg_panjar_fPjptgProE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_panjar_fPjptgProE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_panjar_fPjptgProE";
...
window.app_saku2_transaksi_kopeg_panjar_fPjptgProE.extend(window.childForm);
window.app_saku2_transaksi_kopeg_panjar_fPjptgProE.implement({
