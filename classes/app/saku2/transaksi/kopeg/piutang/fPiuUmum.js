window.app_saku2_transaksi_kopeg_piutang_fPiuUmum = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_piutang_fPiuUmum.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_piutang_fPiuUmum";
...
window.app_saku2_transaksi_kopeg_piutang_fPiuUmum.extend(window.childForm);
window.app_saku2_transaksi_kopeg_piutang_fPiuUmum.implement({
	...
	doChange:function(sender){		
		if (sender == this.cb_project && this.cb_project.getText()!="") {
			var strSQL = "select a.kode_cust,a.nama  from cust a inner join project b on a.kode_cust=b.kode_cust and a.kode_lokasi=b.kode_lokasi "+
	...
	doClick:function(sender){
		if (this.e_periode.getText()!= "" ) {				
			this.e_nb.setText(this.standarLib.noBuktiOtomatis(this.dbLib,"piutang_m","no_piutang",this.app._lokasi+"-PU"+this.e_periode.getText().substr(2,4)+".","000"));
			this.e_dok.setFocus();
		}
	},	
