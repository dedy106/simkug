window.app_saku2_transaksi_kopeg_piutang_fKbPiu = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_piutang_fKbPiu.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_piutang_fKbPiu";
...
window.app_saku2_transaksi_kopeg_piutang_fKbPiu.extend(window.childForm);
window.app_saku2_transaksi_kopeg_piutang_fKbPiu.implement({
