window.app_saku2_transaksi_kopeg_spro_fVaJenis = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_spro_fVaJenis.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_spro_fVaJenis";
...
window.app_saku2_transaksi_kopeg_spro_fVaJenis.extend(window.childForm);
window.app_saku2_transaksi_kopeg_spro_fVaJenis.implement({
