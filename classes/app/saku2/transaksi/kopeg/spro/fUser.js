window.app_saku2_transaksi_kopeg_spro_fUser = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_spro_fUser.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_spro_fUser";
...
window.app_saku2_transaksi_kopeg_spro_fUser.extend(window.childForm);
window.app_saku2_transaksi_kopeg_spro_fUser.implement({
