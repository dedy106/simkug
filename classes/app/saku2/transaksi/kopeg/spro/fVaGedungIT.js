window.app_saku2_transaksi_kopeg_spro_fVaGedungIT = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_spro_fVaGedungIT.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_spro_fVaGedungIT";
...
window.app_saku2_transaksi_kopeg_spro_fVaGedungIT.extend(window.childForm);
window.app_saku2_transaksi_kopeg_spro_fVaGedungIT.implement({
