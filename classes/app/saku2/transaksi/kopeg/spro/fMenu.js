...
//* 			SAI, PT											
//***********************************************************************************************
window.app_saku2_transaksi_kopeg_spro_fMenu = function(owner){
	if (owner){
		try{
			window.app_saku2_transaksi_kopeg_spro_fMenu.prototype.parent.constructor.call(this, owner);
			this.className = "app_saku2_transaksi_kopeg_spro_fMenu";
...
window.app_saku2_transaksi_kopeg_spro_fMenu.extend(window.portalui_childForm);
window.app_saku2_transaksi_kopeg_spro_fMenu.implement({
	...
	entriesClick: function(sender){
		try{
			uses("app_saku2_transaksi_kopeg_spro_fMenuDetail");	
			if (this.entryMenu !== undefined) this.entryMenu.free();
			this.entryMenu = new app_saku2_transaksi_kopeg_spro_fMenuDetail(this.app);
