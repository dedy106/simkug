window.app_saku2_transaksi_kopeg_spro_fParam = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_spro_fParam.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_spro_fParam";
		...
		this.e_modul = new saiLabelEdit(this,{bound:[20,12,200,20],caption:"Modul", maxLength:10, tag:1});	
		this.e_flag = new saiLabelEdit(this,{bound:[20,13,400,20],caption:"Flag", maxLength:200, tag:1});	
		this.e_val1 = new saiLabelEdit(this,{bound:[20,14,200,20],caption:"Value 1",tag:1,tipeText:ttNilai, text:"0"});	
		this.e_val2 = new saiLabelEdit(this,{bound:[20,15,200,20],caption:"Value 2",tag:1,tipeText:ttNilai, text:"0"});	
		this.e_ket = new saiLabelEdit(this,{bound:[20,16,400,20],caption:"Keterangan", maxLength:150, tag:1});	
...
window.app_saku2_transaksi_kopeg_spro_fParam.extend(window.childForm);
window.app_saku2_transaksi_kopeg_spro_fParam.implement({
			...
			if (this.cb_kode.getText() != ""){
				...
				if (typeof data == "object"){
					...
					if (line != undefined){						
						...
						this.e_val1.setText(line.value1);
						this.e_val2.setText(line.value2);
		...
		try{
			if (sender == this.cb_kode) {   
			    this.standarLib.showListData(this, "Daftar Parameter",sender,undefined, 
											  "select kode_spro, nama  from spro where kode_lokasi='"+this.app._lokasi+"'",
											  "select count(kode_spro) from spro where kode_lokasi='"+this.app._lokasi+"'",
											  ["kode_spro","nama"],"and",["Kode","Nama"],false);				
			}
		}catch(e){
			systemAPI.alert(e);
		}
