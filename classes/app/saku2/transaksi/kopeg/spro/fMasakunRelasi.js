window.app_saku2_transaksi_kopeg_spro_fMasakunRelasi = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_spro_fMasakunRelasi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_spro_fMasakunRelasi";
		...
		this.sg3 = new saiGrid(this.pc2.childPage[1],{bound:[0,5,this.pc2.width-5,140],colCount:4,tag:9,
					...
					autoAppend:true,defaultRow:1});		
		this.sgn3 = new portalui_sgNavigator(this.pc2.childPage[1],{bound:[0,this.pc2.height-25,this.pc2.width-1,25],buttonStyle:3,grid:this.sg3});		
		...
		this.sg4 = new saiGrid(this.pc2.childPage[2],{bound:[0,5,this.pc2.width-5,140],colCount:4,tag:9,
					...
					readOnly:true,buttonStyle:[[0,2],[bsEllips,bsEllips]],
					autoAppend:true,defaultRow:1});		
		this.sgn4 = new portalui_sgNavigator(this.pc2.childPage[2],{bound:[0,this.pc2.height-25,this.pc2.width-1,25],buttonStyle:3,grid:this.sg4});		
...
window.app_saku2_transaksi_kopeg_spro_fMasakunRelasi.extend(window.childForm);
window.app_saku2_transaksi_kopeg_spro_fMasakunRelasi.implement({
