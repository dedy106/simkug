window.app_saku2_transaksi_kopeg_spro_fSjuVendor = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_spro_fSjuVendor.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_spro_fSjuVendor";
		...
		this.cb_hutang = new saiCBBL(this,{bound:[20,12,200,20],caption:"Akun Hutang", multiSelection:false, maxLength:10, tag:2});
		...
		try {
			...
			this.cb_hutang.setSQL("select a.kode_akun, a.nama from masakun a inner join flag_relasi b on a.kode_akun=b.kode_akun and a.kode_lokasi=b.kode_lokasi "+
			                      "where b.kode_flag = '024' and b.kode_lokasi = '"+this.app._lokasi+"'",["a.kode_akun","a.nama"],false,["Kode","Nama"],"and","Data Akun",true);
		}catch(e){
			systemAPI.alert(e);
		}
	}
};
window.app_saku2_transaksi_kopeg_spro_fSjuVendor.extend(window.childForm);
window.app_saku2_transaksi_kopeg_spro_fSjuVendor.implement({
