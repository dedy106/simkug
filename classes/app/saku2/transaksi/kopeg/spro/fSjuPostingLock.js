window.app_saku2_transaksi_kopeg_spro_fSjuPostingLock = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_spro_fSjuPostingLock.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_spro_fSjuPostingLock";
...
window.app_saku2_transaksi_kopeg_spro_fSjuPostingLock.extend(window.childForm);
window.app_saku2_transaksi_kopeg_spro_fSjuPostingLock.implement({
