window.app_saku2_transaksi_kopeg_spro_fCust = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_spro_fCust.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_spro_fCust";
		...
		//hide
		this.e_bank = new saiLabelEdit(this,{bound:[20,19,250,20],caption:"Bank", maxLength:50, tag:9, visible:false});			
		this.e_cabang = new saiLabelEdit(this,{bound:[20,18,250,20],caption:"Cabang", maxLength:50, tag:9, visible:false});			
		this.e_norek = new saiLabelEdit(this,{bound:[20,19,250,20],caption:"No Rekening", maxLength:50, tag:9, visible:false});			
		this.e_namarek = new saiLabelEdit(this,{bound:[20,18,250,20],caption:"Nama Rekening", maxLength:50, tag:9, visible:false});			
...
window.app_saku2_transaksi_kopeg_spro_fCust.extend(window.childForm);
window.app_saku2_transaksi_kopeg_spro_fCust.implement({
		...
		try{						
			if (this.standarLib.checkEmptyByTag(this, [0,1])){
				try{									
					...
					sql.add("insert into cust(kode_cust,kode_lokasi,nama,alamat,no_tel,email,npwp,pic,alamat2,bank,cabang,no_rek,nama_rek) values "+
	...
	doChange: function(sender){
		try{
			if (sender == this.cb_kode && this.cb_kode.getText() != ""){
				var strSQL = "select kode_cust,nama,alamat,no_tel,email,npwp,alamat2,pic,bank,cabang,no_rek,nama_rek from cust "+
						     "where kode_cust ='"+this.cb_kode.getText()+"' and kode_lokasi='"+this.app._lokasi+"'";						   
