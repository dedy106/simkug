window.app_saku2_transaksi_kopeg_sju_fKbHutang = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_sju_fKbHutang.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_sju_fKbHutang";
		...
		this.cb_vendor = new saiCBBL(this,{bound:[20,19,220,20],caption:"Penanggung", multiSelection:false, maxLength:10, tag:0,change:[this,"doChange"]});							
...
window.app_saku2_transaksi_kopeg_sju_fKbHutang.extend(window.childForm);
window.app_saku2_transaksi_kopeg_sju_fKbHutang.implement({
	...
	doChange:function(sender){		
		...
		if (sender == this.cb_vendor && this.cb_vendor.getText()!="" && this.c_curr.getText()!="") {
			this.sg2.clear(1);
			var strSQL = "select a.nu,a.no_bill,a.no_polis,aa.no_dok as keterangan,a.akun_hutang,a.kurs,round(a.premi+a.p_cost+a.materai-a.fee-a.diskon-a.ppn,2) as nilai_hut,a.pph,round(a.premi+a.p_cost+a.materai-a.fee-a.diskon-a.ppn+a.pph,2) as nilai_kas "+
						 ...
						 "where a.kode_curr='"+this.c_curr.getText()+"' and c.kode_vendor='"+this.cb_vendor.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' and a.no_bill<>'-' ";
