window.app_saku2_transaksi_kopeg_sju_fDokRelasi = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_sju_fDokRelasi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_sju_fDokRelasi";
		...
		try {
			...
			this.cb_flag.setSQL("select no_dokumen, nama from sju_dokumen where kode_lokasi='"+this.app._lokasi+"'",["no_dokumen","nama"],false,["Kode","Nama"],"and","Data PP",true);
		}catch(e){
			systemAPI.alert(e);
		}
	}
};
window.app_saku2_transaksi_kopeg_sju_fDokRelasi.extend(window.childForm);
window.app_saku2_transaksi_kopeg_sju_fDokRelasi.implement({
