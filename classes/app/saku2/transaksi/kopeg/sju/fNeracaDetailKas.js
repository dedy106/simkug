window.app_saku2_transaksi_kopeg_sju_fNeracaDetailKas = function(owner,modul)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_sju_fNeracaDetailKas.prototype.parent.constructor.call(this, owner);
		window.app_saku2_transaksi_kopeg_sju_fNeracaDetailKas.prototype.parent.setWidth.call(this, 300);
		window.app_saku2_transaksi_kopeg_sju_fNeracaDetailKas.prototype.parent.setHeight.call(this, 400);
		
		this.centerize();
		
		this.className = "app_saku2_transaksi_kopeg_sju_fNeracaDetailKas";
...
window.app_saku2_transaksi_kopeg_sju_fNeracaDetailKas.extend(window.commonForm);
window.app_saku2_transaksi_kopeg_sju_fNeracaDetailKas.implement({
	...
	doSysMouseDown: function(x, y, button, buttonState){	
		window.app_saku2_transaksi_kopeg_sju_fNeracaDetailKas.prototype.parent.doSysMouseDown.call(this,x, y, button, buttonState);
	},
	doSysMouseUp: function(x, y, button, buttonState){	
		window.app_saku2_transaksi_kopeg_sju_fNeracaDetailKas.prototype.parent.doSysMouseUp.call(this,x, y, button, buttonState);
	},
	doSysMouseMove: function(x, y, button, buttonState){
		window.app_saku2_transaksi_kopeg_sju_fNeracaDetailKas.prototype.parent.doSysMouseMove.call(this,x, y, button, buttonState);
		if (this.isClick)
		{		
