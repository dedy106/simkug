window.app_saku2_transaksi_kopeg_sju_fKbPiutang = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_sju_fKbPiutang.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_sju_fKbPiutang";
...
window.app_saku2_transaksi_kopeg_sju_fKbPiutang.extend(window.childForm);
window.app_saku2_transaksi_kopeg_sju_fKbPiutang.implement({
	...
	doChange:function(sender){		
		...
		if (sender == this.cb_cust && this.cb_cust.getText()!="") {						
			var strSQL = "select a.nu,a.no_bill,a.no_polis,aa.no_dok as keterangan,a.akun_piutang,a.kurs,(a.premi-a.diskon+a.p_cost+a.materai)-isnull(c.bayar,0) as saldo "+
