window.app_saku2_transaksi_kopeg_sju_fPolisSawal = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_sju_fPolisSawal.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kopeg_sju_fPolisSawal";
		...
		this.e_nb = new portalui_saiLabelEdit(this.pc2.childPage[0],{bound:[20,14,200,20],caption:"No Register",maxLength:30});				
		...
		this.e_quo3 = new saiLabelEdit(this.pc2.childPage[3],{bound:[20,13,300,20],caption:"No Dokumen", tag:9, maxLength:50});								
...
window.app_saku2_transaksi_kopeg_sju_fPolisSawal.extend(window.childForm);
window.app_saku2_transaksi_kopeg_sju_fPolisSawal.implement({		
						...
						for (var i=0;i < this.sg2.getRowCount();i++){
							if (this.sg2.rowValid(i)){								
								sql.add("insert into sju_polis_termin(no_polis,kode_lokasi,nu,ke,kode_vendor,keterangan,kode_curr,premi,fee,diskon,p_cost,tipe,tgl_bill,no_bill,kurs,akun_piutang,akun_hutang,ppn,pph,due_date,materai,no_tagih) values "+
										"('"+this.e_nb.getText()+"','"+this.app._lokasi+"',"+i+","+this.sg2.cells(0,i)+",'"+this.cb_vendor.getText()+"','"+this.sg2.cells(2,i)+"','"+this.c_curr.getText()+"',"+nilaiToFloat(this.sg2.cells(3,i))+","+nilaiToFloat(this.sg2.cells(4,i))+","+nilaiToFloat(this.sg2.cells(7,i))+","+nilaiToFloat(this.sg2.cells(8,i))+",'-','"+this.sg2.getCellDateValue(1,i)+"','"+this.e_nb.getText()+"',1,'114010100','211010000',"+nilaiToFloat(this.sg2.cells(5,i))+","+nilaiToFloat(this.sg2.cells(6,i))+",'"+this.sg2.getCellDateValue(1,i)+"',"+nilaiToFloat(this.sg2.cells(9,i))+",'"+this.e_nb.getText()+"')");
							}
						}
					}	
