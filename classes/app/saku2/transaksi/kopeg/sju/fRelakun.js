window.app_saku2_transaksi_kopeg_sju_fRelakun = function(owner,lokasi)
{
	if (owner)
	{
		window.app_saku2_transaksi_kopeg_sju_fRelakun.prototype.parent.constructor.call(this, owner);
		window.app_saku2_transaksi_kopeg_sju_fRelakun.prototype.parent.setWidth.call(this, 800);
		window.app_saku2_transaksi_kopeg_sju_fRelakun.prototype.parent.setHeight.call(this, 400);
		
		this.centerize();
		
		this.className = "app_saku2_transaksi_kopeg_sju_fRelakun";
...
window.app_saku2_transaksi_kopeg_sju_fRelakun.extend(window.commonForm);
window.app_saku2_transaksi_kopeg_sju_fRelakun.implement({
	...
	setWidth: function(data){
		window.app_saku2_transaksi_kopeg_sju_fRelakun.prototype.parent.setWidth.call(this, data);
		this.header.style.width = data - 23;
		this.rBg.style.left = data - 23;
	},
	doSysMouseMove: function(x, y, button, buttonState){
		window.app_saku2_transaksi_kopeg_sju_fRelakun.prototype.parent.doSysMouseMove.call(this,x, y, button, buttonState);
		if (this.isClick)
		{		
