window.app_saku2_transaksi_gaji_fKaryawan = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_gaji_fKaryawan.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_gaji_fKaryawan";
		...
		this.cb_pp = new saiCBBL(this,{bound:[20,18,200,20],caption:"Lokasi Kerja", multiSelection:false, maxLength:10, tag:2});
		this.e_nama = new saiLabelEdit(this,{bound:[20,11,400,20],caption:"Nama", maxLength:50, tag:1});	
		this.cb_jabatan = new saiCBBL(this,{bound:[20,13,200,20],caption:"Posisi", multiSelection:false, maxLength:10, tag:2});
		this.c_band = new saiCB(this,{bound:[20,22,202,20],caption:"Level",items:["1","2","3","4","5","6","7","8","9"], readOnly:true,tag:2});		
		...
		this.p1 = new panel(this,{bound:[10,23,900,203],caption:"Daftar hr_karyawan"});
...
window.app_saku2_transaksi_gaji_fKaryawan.extend(window.childForm);
window.app_saku2_transaksi_gaji_fKaryawan.implement({
		...
		try{						
			if (this.standarLib.checkEmptyByTag(this, [0,1])){
				try{									
					...
					sql.add("insert into hr_karyawan(nik,nama,kode_lokasi,alamat,kota,kode_pos,no_telp,npwp,bank,cabang,no_rek,nama_rek,kode_pp,jabatan,grade) values "+
	...
	doChange: function(sender){
		try{
			if (sender == this.cb_lokasi && this.cb_lokasi.getText() != ""){				
				this.cb_pp.setSQL("select kode_loker, nama from hr_loker where kode_lokasi='"+this.cb_lokasi.getText()+"'",["kode_Loker","nama"],false,["Kode","Nama"],"and","Data Lokasi Kerja",true);
				this.cb_jabatan.setSQL("select kode_jab, nama from hr_jab where kode_lokasi='"+this.cb_lokasi.getText()+"'",["kode_jab","nama"],false,["Kode","Nama"],"and","Data Posisi",true);
			}
			if (sender == this.cb_kode && this.cb_kode.getText() != ""){
				var data = this.dbLib.getDataProvider("select a.nama,a.alamat,a.kota,a.kode_pos,a.no_telp,a.npwp,a.bank,a.cabang,a.no_rek,a.nama_rek,a.kode_level,a.kode_loker,b.nama as nama_loker,a.kode_lokasi,c.nama as nama_lokasi,a.kode_jab,d.nama as nama_jab "+
				           " from hr_karyawan a "+
				...
				if (typeof data == "object"){
					...
					if (line != undefined){
						...
						this.cb_pp.setText(line.kode_loker,line.nama_loker);
						this.e_nama.setText(line.nama);
						this.cb_jabatan.setText(line.kode_jab,line.nama_jab);
						...
						this.c_band.setText(line.kode_level);
	...
	doTampilClick: function(sender){
		try{			
			var temp = this.dbLib.runSQL("select a.nik,a.nama,a.kode_lokasi+'-'+c.nama as lokasi,a.kode_pp+'-'+b.nama as pp,a.alamat,a.kota,a.kode_pos,a.no_telp,a.npwp,a.bank,a.cabang,a.no_rek,a.nama_rek, a.jabatan "+
			                             "from hr_karyawan a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
