window.app_saku2_transaksi_tak_fDropTerima = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_tak_fDropTerima.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_tak_fDropTerima";
...
window.app_saku2_transaksi_tak_fDropTerima.extend(window.childForm);
window.app_saku2_transaksi_tak_fDropTerima.implement({
		...
		if (this.e_periode.getText() != "") {
			...
			if (typeof data == "object" && data.rs.rows[0] != undefined){
				...
				for (var i in data.rs.rows){
					line = data.rs.rows[i];							
					this.sg.appendData(["INPROG",line.no_kas,line.no_dokumen,line.kode_lokasi,line.akun_tak,line.keterangan,floatToNilai(line.nilai),line.tanggal]);
				}
