window.app_saku2_transaksi_tak_fTakkirim = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_tak_fTakkirim.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_tak_fTakkirim";
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form TAK Umum Kirim : Input", 0);	
...
window.app_saku2_transaksi_tak_fTakkirim.extend(window.childForm);
window.app_saku2_transaksi_tak_fTakkirim.implement({
