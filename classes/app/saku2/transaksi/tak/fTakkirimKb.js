window.app_saku2_transaksi_tak_fTakkirimKb = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_tak_fTakkirimKb.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_tak_fTakkirimKb";
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form TAK Permintaan Pembayaran : Input", 0);	
...
window.app_saku2_transaksi_tak_fTakkirimKb.extend(window.childForm);
window.app_saku2_transaksi_tak_fTakkirimKb.implement({
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					sql.add("insert into takkirim_m(no_kirim,kode_lokasi,periode,tanggal,no_dokumen,keterangan,kode_pp,modul,jenis,kode_curr,kurs,nilai,nik_buat,nik_setuju,posted,no_del,no_link,ref1,tgl_input,nik_user,kode_loktuj,progress) values "+
						    "('"+this.e_nb.getText()+"','"+this.app._lokasi+"','"+this.e_periode.getText()+"','"+this.dp_d1.getDateString()+"','"+this.e_dok.getText()+"','"+this.e_ket.getText()+"','-','TAKKB','KIRIM','IDR',1,"+parseNilai(this.e_trans.getText())+",'"+this.cb_buat.getText()+"','"+this.cb_app.getText()+"','F','-','-','"+this.cb_vendor.getText()+"',getdate(),'"+this.app._userLog+"','"+this.cb_tujuan.getText()+"','0')");
