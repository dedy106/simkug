window.app_saku2_transaksi_aka_fRekonLoad = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_aka_fRekonLoad.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_aka_fRekonLoad";
		...
		this.sg1 = new portalui_saiGrid(this.pc1.childPage[1],{bound:[0,5,this.pc1.width-5,this.pc1.height-35],colCount:7,
					colTitle:["NIM","Nama","No Invoice","BPP","UP3","SDP2","ID Bank"],
					colWidth:[[6,5,4,3,2,1,0],[80,100,100,100,180,200,80]],
...
window.app_saku2_transaksi_aka_fRekonLoad.extend(window.childForm);
window.app_saku2_transaksi_aka_fRekonLoad.implement({
	...
	selectPage: function(sender,page){
		...
		for (var i=start; i < finish;i++){
			line = this.dataUpload.rows[i];
			this.sg1.appendData([line.nim,line.nama,line.no_invoice,floatToNilai(line.bpp),floatToNilai(line.up3),floatToNilai(line.sdp2),line.id_bank]);
		}
