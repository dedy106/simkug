window.app_saku2_transaksi_aka_fBillLoadBea = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_aka_fBillLoadBea.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku2_transaksi_aka_fBillLoadBea";
		...
		this.pc1 = new pageControl(this,{bound:[20,20,900,330], childPage:["Data Billing Mahasiswa","Pesan Kesalahan"]});				
		this.sg1 = new portalui_saiGrid(this.pc1.childPage[0],{bound:[1,10,this.pc1.width-5,this.pc1.height-40],colCount:16,
...
window.app_saku2_transaksi_aka_fBillLoadBea.extend(window.portalui_childForm);
window.app_saku2_transaksi_aka_fBillLoadBea.implement({
					...
					if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
						try{
							...
							sql.add("insert into aka_bill_m(no_bill,no_dokumen,kode_lokasi,periode,tanggal,keterangan,kode_pp,kode_drk,jenis,posted,nik_user,tgl_input) values "+ 
									"('"+this.e_nb.getText()+"','-','"+this.app._lokasi+"','"+this.e_periode.getText()+"','"+this.dp_d1.getDateString()+"','"+this.e_ket.getText()+"','"+this.cb_pp.getText()+"','"+this.cb_drk.getText()+"','BEA','F','"+this.app._userLog+"',getdate())");						
							...
							sql.add("insert into aka_bill_d (no_bill,kode_lokasi,no_inv,nim,periode,kode_produk,akun_piutang,akun_pdpt,akun_pdd,nilai,periode_susut,periode_sisih) "+
									"select b.no_bill,b.kode_lokasi,b.no_bill+'-'+b.nim,b.nim,'"+this.e_periode.getText()+"','BEABPP', a.akun_piutang,a.akun_pdpt,a.akun_pdd,b.bpp as nilai,'"+this.e_periode.getText()+"','"+this.e_periode.getText()+"' "+
									"from aka_bill_load b inner join aka_produk a on 'BEABPP' = a.kode_produk and b.kode_lokasi=a.kode_lokasi "+
									"where b.no_bill = '"+this.e_nb.getText()+"' and b.kode_lokasi = '"+this.app._lokasi+"' and b.bpp<>0"+
									"union "+
									"select b.no_bill,b.kode_lokasi,b.no_bill+'-'+b.nim,b.nim,'"+this.e_periode.getText()+"','BEAUP3', a.akun_piutang,a.akun_pdpt,a.akun_pdd,b.up3 as nilai,'"+this.e_periode.getText()+"','"+this.e_periode.getText()+"' "+
									"from aka_bill_load b inner join aka_produk a on 'BEAUP3' = a.kode_produk and b.kode_lokasi=a.kode_lokasi "+
									"where b.no_bill = '"+this.e_nb.getText()+"' and b.kode_lokasi = '"+this.app._lokasi+"' and b.up3<>0"+
									"union "+
									"select b.no_bill,b.kode_lokasi,b.no_bill+'-'+b.nim,b.nim,'"+this.e_periode.getText()+"','BEASDP2', a.akun_piutang,a.akun_pdpt,a.akun_pdd,b.sdp2 as nilai,'"+this.e_periode.getText()+"','"+this.e_periode.getText()+"' "+
									"from aka_bill_load b inner join aka_produk a on 'BEASDP2' = a.kode_produk and b.kode_lokasi=a.kode_lokasi "+
									"where b.no_bill = '"+this.e_nb.getText()+"' and b.kode_lokasi = '"+this.app._lokasi+"' and b.sdp2<>0"+
									"union "+
									"select b.no_bill,b.kode_lokasi,b.no_bill+'-'+b.nim,b.nim,'"+this.e_periode.getText()+"','BEASKS', a.akun_piutang,a.akun_pdpt,a.akun_pdd,b.sks as nilai,'"+this.e_periode.getText()+"','"+this.e_periode.getText()+"' "+
									"from aka_bill_load b inner join aka_produk a on 'BEASKS' = a.kode_produk and b.kode_lokasi=a.kode_lokasi "+
									"where b.no_bill = '"+this.e_nb.getText()+"' and b.kode_lokasi = '"+this.app._lokasi+"' and b.sks<>0"+
									"union "+
									"select b.no_bill,b.kode_lokasi,b.no_bill+'-'+b.nim,b.nim,'"+this.e_periode.getText()+"','BEAS2BPP', a.akun_piutang,a.akun_pdpt,a.akun_pdd,b.s2bpp as nilai,'"+this.e_periode.getText()+"','"+this.e_periode.getText()+"' "+
									"from aka_bill_load b inner join aka_produk a on 'BEAS2BPP' = a.kode_produk and b.kode_lokasi=a.kode_lokasi "+
									"where b.no_bill = '"+this.e_nb.getText()+"' and b.kode_lokasi = '"+this.app._lokasi+"' and b.s2bpp<>0"+
									"union "+
									"select b.no_bill,b.kode_lokasi,b.no_bill+'-'+b.nim,b.nim,'"+this.e_periode.getText()+"','BEAS2UP3', a.akun_piutang,a.akun_pdpt,a.akun_pdd,b.s2up3 as nilai,'"+this.e_periode.getText()+"','"+this.e_periode.getText()+"' "+
									"from aka_bill_load b inner join aka_produk a on 'BEAS2UP3' = a.kode_produk and b.kode_lokasi=a.kode_lokasi "+
									"where b.no_bill = '"+this.e_nb.getText()+"' and b.kode_lokasi = '"+this.app._lokasi+"' and b.s2up3<>0"+
									"union "+
									"select b.no_bill,b.kode_lokasi,b.no_bill+'-'+b.nim,b.nim,'"+this.e_periode.getText()+"','BEAS2SDP2', a.akun_piutang,a.akun_pdpt,a.akun_pdd,b.s2sdp2 as nilai,'"+this.e_periode.getText()+"','"+this.e_periode.getText()+"' "+
									"from aka_bill_load b inner join aka_produk a on 'BEAS2SDP2' = a.kode_produk and b.kode_lokasi=a.kode_lokasi "+
									"where b.no_bill = '"+this.e_nb.getText()+"' and b.kode_lokasi = '"+this.app._lokasi+"' and b.s2sdp2<>0"+
									"union "+
									"select b.no_bill,b.kode_lokasi,b.no_bill+'-'+b.nim,b.nim,'"+this.e_periode.getText()+"','BEAS2SKS', a.akun_piutang,a.akun_pdpt,a.akun_pdd,b.s2sks as nilai,'"+this.e_periode.getText()+"','"+this.e_periode.getText()+"' "+
									"from aka_bill_load b inner join aka_produk a on 'BEAS2SKS' = a.kode_produk and b.kode_lokasi=a.kode_lokasi "+
