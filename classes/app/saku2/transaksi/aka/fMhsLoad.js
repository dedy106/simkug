window.app_saku2_transaksi_aka_fMhsLoad = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_aka_fMhsLoad.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku2_transaksi_aka_fMhsLoad";
		...
		this.bUpload = new portalui_uploader(this,{bound:[620,14,100,20],param3:"object",param4:"gridupload",afterUpload:[this,"doAfterUpload"],autoSubmit:true});		
...
window.app_saku2_transaksi_aka_fMhsLoad.extend(window.portalui_childForm);
window.app_saku2_transaksi_aka_fMhsLoad.implement({	
