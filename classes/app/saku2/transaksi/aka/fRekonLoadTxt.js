window.app_saku2_transaksi_aka_fRekonLoadTxt = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_aka_fRekonLoadTxt.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_aka_fRekonLoadTxt";
...
window.app_saku2_transaksi_aka_fRekonLoadTxt.extend(window.childForm);
window.app_saku2_transaksi_aka_fRekonLoadTxt.implement({
