window.app_saku2_transaksi_aka_fAmorPddProdi2 = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_aka_fAmorPddProdi2.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_aka_fAmorPddProdi2";
...
window.app_saku2_transaksi_aka_fAmorPddProdi2.extend(window.childForm);
window.app_saku2_transaksi_aka_fAmorPddProdi2.implement({
		...
		try{						
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{													
					...
					sql.add("call sp_ar_amor_prodi ('"+this.app._lokasi+"','"+this.e_periode.getText()+"','"+perNext+"','"+this.e_nb.getText()+"')");
				...
				switch(methodName){
	    			case "execArraySQL" :	    				
						if (result.toLowerCase().search("error") == -1){
							this.nama_report="server_report_saku2_aka_rptAmorPddJurnal";
