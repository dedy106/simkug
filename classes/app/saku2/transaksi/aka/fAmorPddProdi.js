window.app_saku2_transaksi_aka_fAmorPddProdi = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_aka_fAmorPddProdi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_aka_fAmorPddProdi";
...
window.app_saku2_transaksi_aka_fAmorPddProdi.extend(window.childForm);
window.app_saku2_transaksi_aka_fAmorPddProdi.implement({
