window.app_saku2_transaksi_aka_fAmorPdd = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_aka_fAmorPdd.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_aka_fAmorPdd";
...
window.app_saku2_transaksi_aka_fAmorPdd.extend(window.childForm);
window.app_saku2_transaksi_aka_fAmorPdd.implement({
