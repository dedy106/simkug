window.app_saku2_transaksi_aka_aka2_fRekonLoad19 = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_aka_aka2_fRekonLoad19.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_aka_aka2_fRekonLoad19";
...
window.app_saku2_transaksi_aka_aka2_fRekonLoad19.extend(window.childForm);
window.app_saku2_transaksi_aka_aka2_fRekonLoad19.implement({		
