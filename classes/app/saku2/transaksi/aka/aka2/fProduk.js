window.app_saku2_transaksi_aka_aka2_fProduk = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_aka_aka2_fProduk.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_aka_aka2_fProduk";
...
window.app_saku2_transaksi_aka_aka2_fProduk.extend(window.childForm);
window.app_saku2_transaksi_aka_aka2_fProduk.implement({
