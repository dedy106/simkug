window.app_saku2_transaksi_aka_aka2_fTAKpdpt19 = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_aka_aka2_fTAKpdpt19.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_aka_aka2_fTAKpdpt19";
...
window.app_saku2_transaksi_aka_aka2_fTAKpdpt19.extend(window.childForm);
window.app_saku2_transaksi_aka_aka2_fTAKpdpt19.implement({	
	...
	doLoad: function(sender){		
		...
		if (this.c_jenis.getText() == "ALL") {
			var strSQL = "select aa.nim,aa.nama as mhs,a.no_inv,a.periode,a.kode_produk,c.nama,a.akun_pdpt,(a.nilai-isnull(b.tot_tak,0)) as nilai,a.kode_pp,a.kode_drk "+						 
						 ...
						 "      inner join (select distinct kode_produk,nama,kode_lokasi from aka_produk) c on a.kode_produk=c.kode_produk and a.kode_lokasi=c.kode_lokasi "+
						 ...
						 "where (a.nilai-isnull(b.tot_tak,0)) > 0 and a.kode_lokasi = '"+this.app._lokasi+"' order by aa.nim,a.periode";		
		}
		else {
			var strSQL = "select aa.nim,aa.nama as mhs,a.no_inv,a.periode,a.kode_produk,c.nama,a.akun_pdpt,(a.nilai-isnull(b.tot_tak,0)) as nilai,a.kode_pp,a.kode_drk "+						 
						 "from  "+
						 ...
						 "where a.periode = '"+this.c_periode2.getText()+"' and (a.nilai-isnull(b.tot_tak,0)) > 0 and a.kode_lokasi = '"+this.app._lokasi+"' order by aa.nim,a.periode";					
		}
