window.app_saku2_transaksi_aka_fTagihanLoadTU = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_aka_fTagihanLoadTU.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku2_transaksi_aka_fTagihanLoadTU";
		...
		this.cb_fak = new saiCBBL(this,{bound:[20,15,220,20],caption:"Fakultas", multiSelection:false, maxLength:10, tag:2,change:[this,"doChange"]});		
		...
		this.pc1 = new pageControl(this,{bound:[20,20,900,360], childPage:["Data Billing Mahasiswa","Pesan Kesalahan"]});				
...
window.app_saku2_transaksi_aka_fTagihanLoadTU.extend(window.portalui_childForm);
window.app_saku2_transaksi_aka_fTagihanLoadTU.implement({	
					...
					if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
						try{
							...
							sql.add("insert into aka_bill_m(no_bill,no_dokumen,kode_lokasi,periode,tanggal,keterangan,kode_pp,kode_drk,jenis,posted,nik_user,tgl_input,kode_fakultas) values "+ 
									"('"+this.e_nb.getText()+"','-','"+this.app._lokasi+"','"+this.e_periode.getText()+"','"+this.dp_d1.getDateString()+"','"+this.e_ket.getText()+"','-','-','BLOAD','F','"+this.app._userLog+"',getdate(),'"+this.cb_fak.getText()+"')");													
							...
							sql.add("insert into aka_bill_d (no_bill,kode_lokasi,no_inv,nim,periode,kode_produk,akun_piutang,akun_pdpt,akun_pdd,nilai,periode_susut,periode_sisih,kode_fakultas) "+
									"select b.no_bill,b.kode_lokasi,b.no_bill+'-'+b.nim,b.nim,'"+this.e_periode.getText()+"','BPP', a.akun_piutang,a.akun_pdpt,a.akun_pdd,b.bpp as nilai,'"+this.e_periode.getText()+"','"+this.e_periode.getText()+"','"+this.cb_fak.getText()+"' "+
									"from aka_bill_load b inner join aka_produk a on 'BPP' = a.kode_produk and b.kode_lokasi=a.kode_lokasi and a.kode_fakultas='"+this.cb_fak.getText()+"' "+
									"where b.bpp <> 0 and b.no_bill = '"+this.e_nb.getText()+"' and b.kode_lokasi = '"+this.app._lokasi+"' "+
									"union "+
									"select b.no_bill,b.kode_lokasi,b.no_bill+'-'+b.nim,b.nim,'"+this.e_periode.getText()+"','UP3', a.akun_piutang,a.akun_pdpt,a.akun_pdd,b.up3 as nilai,'"+this.e_periode.getText()+"','"+this.e_periode.getText()+"','"+this.cb_fak.getText()+"' "+
									"from aka_bill_load b inner join aka_produk a on 'UP3' = a.kode_produk and b.kode_lokasi=a.kode_lokasi and a.kode_fakultas='"+this.cb_fak.getText()+"' "+
									"where b.up3 <> 0 and b.no_bill = '"+this.e_nb.getText()+"' and b.kode_lokasi = '"+this.app._lokasi+"' "+
									"union "+
									"select b.no_bill,b.kode_lokasi,b.no_bill+'-'+b.nim,b.nim,'"+this.e_periode.getText()+"','SDP2', a.akun_piutang,a.akun_pdpt,a.akun_pdd,b.sdp2 as nilai,'"+this.e_periode.getText()+"','"+this.e_periode.getText()+"','"+this.cb_fak.getText()+"' "+
									"from aka_bill_load b inner join aka_produk a on 'SDP2' = a.kode_produk and b.kode_lokasi=a.kode_lokasi and a.kode_fakultas='"+this.cb_fak.getText()+"' "+
									"where b.sdp2 <> 0 and b.no_bill = '"+this.e_nb.getText()+"' and b.kode_lokasi = '"+this.app._lokasi+"' "+
									"union "+
									"select b.no_bill,b.kode_lokasi,b.no_bill+'-'+b.nim,b.nim,'"+this.e_periode.getText()+"','SKS', a.akun_piutang,a.akun_pdpt,a.akun_pdd,b.sks as nilai,'"+this.e_periode.getText()+"','"+this.e_periode.getText()+"','"+this.cb_fak.getText()+"' "+
									"from aka_bill_load b inner join aka_produk a on 'SKS' = a.kode_produk and b.kode_lokasi=a.kode_lokasi and a.kode_fakultas='"+this.cb_fak.getText()+"' "+
									"where b.sks <> 0 and b.no_bill = '"+this.e_nb.getText()+"' and b.kode_lokasi = '"+this.app._lokasi+"' "+
									"");
							var akun_pdd=this.dbLib.getPeriodeFromSQL("select akun_pdd  as periode from aka_produk where kode_lokasi='"+this.app._lokasi+"' and kode_produk='BPP' and kode_fakultas='"+this.cb_fak.getText()+"'");
