window.app_saku2_transaksi_aka_fAmorPddProdiBeaTU = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_aka_fAmorPddProdiBeaTU.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_aka_fAmorPddProdiBeaTU";
...
window.app_saku2_transaksi_aka_fAmorPddProdiBeaTU.extend(window.childForm);
window.app_saku2_transaksi_aka_fAmorPddProdiBeaTU.implement({
		...
		try{						
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{													
					...
					sql.add("call sp_ar_amor_prodi_bea_tu ('"+this.app._lokasi+"','"+this.e_periode.getText()+"','"+perNext+"','"+this.e_nb.getText()+"')");
