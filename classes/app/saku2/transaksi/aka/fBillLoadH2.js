window.app_saku2_transaksi_aka_fBillLoadH2 = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_aka_fBillLoadH2.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku2_transaksi_aka_fBillLoadH2";
...
window.app_saku2_transaksi_aka_fBillLoadH2.extend(window.portalui_childForm);
window.app_saku2_transaksi_aka_fBillLoadH2.implement({
