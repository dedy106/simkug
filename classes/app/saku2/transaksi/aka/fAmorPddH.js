window.app_saku2_transaksi_aka_fAmorPddH = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_aka_fAmorPddH.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_aka_fAmorPddH";
...
window.app_saku2_transaksi_aka_fAmorPddH.extend(window.childForm);
window.app_saku2_transaksi_aka_fAmorPddH.implement({
