window.app_saku2_transaksi_aka_fRekonLoadNIM = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_aka_fRekonLoadNIM.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_aka_fRekonLoadNIM";
		...
		this.bTampil = new button(this,{bound:[420,18,80,20],caption:"Data Tagihan", click:[this,"doLoad"]});
		this.bGet = new button(this,{bound:[520,18,80,20],caption:"Get Data Xml", click:[this,"doGetFile"]});
		this.bUpload = new portalui_uploader(this,{bound:[620,18,80,20],param3:"json",param4:"gridupload",afterUpload:[this,"doAfterUpload"],autoSubmit:true});		
...
window.app_saku2_transaksi_aka_fRekonLoadNIM.extend(window.childForm);
window.app_saku2_transaksi_aka_fRekonLoadNIM.implement({
	doGetFile: function(sender){
		try{
			//this.dbLib.getXMLDataViaURL("http://127.0.0.1/xml/PembayaranMahasiswa.xml");
			this.dbLib.getXMLDataViaURL("http://simkug.politekniktelkom.ac.id/PembayaranMahasiswa.xml");
		}catch(e){
			alert(e);
		}
	},
				...
				switch(methodName){
	    			...
	    			case "execArraySQL" :	    				
						if (result.toLowerCase().search("error") == -1){
						  this.nama_report="server_report_saku2_aka_rptRekonLoadNIMJurnal";
