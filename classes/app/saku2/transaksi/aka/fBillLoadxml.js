window.app_saku2_transaksi_aka_fBillLoadxml = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_aka_fBillLoadxml.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku2_transaksi_aka_fBillLoadxml";
		...
		this.bGet = new button(this,{bound:[500,15,80,20],caption:"Get Data", click:[this,"doGetFile"]});
		this.bUpload = new portalui_uploader(this,{bound:[615,15,80,18],param3:"json",param4:"gridupload",afterUpload:[this,"doAfterUpload"],autoSubmit:true});				
...
window.app_saku2_transaksi_aka_fBillLoadxml.extend(window.portalui_childForm);
window.app_saku2_transaksi_aka_fBillLoadxml.implement({
