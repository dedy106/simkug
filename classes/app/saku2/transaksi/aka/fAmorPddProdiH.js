window.app_saku2_transaksi_aka_fAmorPddProdiH = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_aka_fAmorPddProdiH.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_aka_fAmorPddProdiH";
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Amortisasi Pendapatan Diterima Dimuka (Prodi): Pembatalan", 0);	
...
window.app_saku2_transaksi_aka_fAmorPddProdiH.extend(window.childForm);
window.app_saku2_transaksi_aka_fAmorPddProdiH.implement({
