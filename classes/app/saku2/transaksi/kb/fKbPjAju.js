window.app_saku2_transaksi_kb_fKbPjAju = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kb_fKbPjAju.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kb_fKbPjAju";
		...
		this.cb_pj = new saiCBBL(this,{bound:[20,15,220,20],caption:"No Panjar", multiSelection:false, maxLength:10, tag:1, change:[this,"doChange"]});
		...
		this.pc1 = new pageControl(this,{bound:[20,12,980,307], childPage:["Data Item Panjar","Item Jurnal KasBank"]});
...
window.app_saku2_transaksi_kb_fKbPjAju.extend(window.childForm);
window.app_saku2_transaksi_kb_fKbPjAju.implement({
	...
	doSelectDate: function(sender, y,m,d){
		...
		this.cb_pj.setSQL("select no_pjaju, keterangan from yk_pjaju_m where progress='1' and periode<='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"'",["no_pjaju","keterangan"],false,["No Panjar","Deskripsi"],"and","Daftar Bukti",true);
		this.e_nb.setText("");
	},
