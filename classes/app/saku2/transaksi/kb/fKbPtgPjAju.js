window.app_saku2_transaksi_kb_fKbPtgPjAju = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kb_fKbPtgPjAju.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kb_fKbPtgPjAju";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form KasBank Pertanggungan Panjar: Input", 0);	
...
window.app_saku2_transaksi_kb_fKbPtgPjAju.extend(window.childForm);
window.app_saku2_transaksi_kb_fKbPtgPjAju.implement({
	...
	doSelectDate: function(sender, y,m,d){
		...
		this.cb_ptg.setSQL("select no_ptg, keterangan from ptg_m where modul = 'PJPTGAJU' and progress='1' and periode<='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"'",["no_ptg","keterangan"],false,["No Pertgg","Deskripsi"],"and","Daftar Bukti Pertanggungan",true);
		this.e_nb.setText("");
	},
