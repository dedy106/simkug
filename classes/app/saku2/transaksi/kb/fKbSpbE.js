window.app_saku2_transaksi_kb_fKbSpbE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kb_fKbSpbE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kb_fKbSpbE";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form KasBank SPB : Edit", 0);	
		...
		this.cb_spb = new saiCBBL(this,{bound:[20,15,220,20],caption:"No SPB", readOnly:true, maxLength:10, tag:1});
		...
		this.pc1 = new pageControl(this,{bound:[20,12,980,327], childPage:["Data Item Pertgg","Item Jurnal KasBank","Detail Transfer"]});
...
window.app_saku2_transaksi_kb_fKbSpbE.extend(window.childForm);
window.app_saku2_transaksi_kb_fKbSpbE.implement({
		...
		try{									
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					sql.add("update yk_spb_m set no_kas='-' where no_spb='"+this.cb_spb.getText()+"' and kode_lokasi='"+this.app._lokasi+"'");
	...
	doChange:function(sender){
		...
		if (sender == this.e_nb && this.e_nb.getText() != "") {
			var data = this.dbLib.getDataProvider("select d.no_spb,d.keterangan as ket,a.no_dokumen,convert(varchar,a.tanggal,103) as tanggal,a.periode,a.keterangan,a.jenis,a.nik_buat,b.nama as nama_buat,a.nik_app,c.nama as nama_setuju "+
					   "from kas_m a "+
			           "	inner join karyawan b on a.nik_buat=b.nik and a.kode_lokasi=b.kode_lokasi "+
			           "	inner join karyawan c on a.nik_app=c.nik and a.kode_lokasi=c.kode_lokasi "+
					   "	inner join yk_spb_m d on a.no_kas=d.no_kas and a.kode_lokasi=d.kode_lokasi "+
			...
			if (typeof data == "object"){
				...
				if (line != undefined){
					...
					this.cb_spb.setText(line.no_spb,line.ket);
				} 
			}			
