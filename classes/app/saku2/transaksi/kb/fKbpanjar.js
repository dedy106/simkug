window.app_saku2_transaksi_kb_fKbpanjar = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kb_fKbpanjar.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kb_fKbpanjar";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form KasBank Pengambilan Panjar: Input", 0);	
...
window.app_saku2_transaksi_kb_fKbpanjar.extend(window.childForm);
window.app_saku2_transaksi_kb_fKbpanjar.implement({
	...
	simpan: function(){			
		try{						
			...
			this.e_pj.setText(this.standarLib.noBuktiOtomatis(this.dbLib,"panjar_m","no_pj",this.app._lokasi+"-PJ"+this.e_periode.getText().substr(2,4)+".","000"));
