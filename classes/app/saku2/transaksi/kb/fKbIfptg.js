window.app_saku2_transaksi_kb_fKbIfptg = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kb_fKbIfptg.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kb_fKbIfptg";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form KasBank Pertanggungan IF: Input", 0);	
...
window.app_saku2_transaksi_kb_fKbIfptg.extend(window.childForm);
window.app_saku2_transaksi_kb_fKbIfptg.implement({
