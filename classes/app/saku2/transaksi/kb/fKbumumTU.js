window.app_saku2_transaksi_kb_fKbumumTU = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kb_fKbumumTU.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kb_fKbumumTU";
...
window.app_saku2_transaksi_kb_fKbumumTU.extend(window.childForm);
window.app_saku2_transaksi_kb_fKbumumTU.implement({
