window.app_saku2_transaksi_kb_fSpb = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kb_fSpb.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kb_fSpb";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Input Permintaan Bayar: Input", 0);	
		...
		try {
			...
			this.cb_pp.setSQL("select kode_pp, nama from pp where tipe='posting' and flag_aktif ='1' and kode_lokasi='"+this.app._lokasi+"'",["kode_pp","nama"],false,["Kode","Nama"],"and","Data PP",true); //boleh semua bidang (kang iwan yg nginputnya sendirian
...
window.app_saku2_transaksi_kb_fSpb.extend(window.childForm);
window.app_saku2_transaksi_kb_fSpb.implement({
	...
	doClick:function(sender){
		this.e_nb.setText(this.standarLib.noBuktiOtomatis(this.dbLib,"yk_spb_m","no_spb",this.app._lokasi+"-PB"+this.e_periode.getText().substr(2,4)+".","000"));
		this.e_dok.setFocus();
	},
