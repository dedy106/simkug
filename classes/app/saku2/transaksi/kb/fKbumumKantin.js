window.app_saku2_transaksi_kb_fKbumumKantin = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kb_fKbumumKantin.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kb_fKbumumKantin";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form KasBank Umum: Input", 0);	
...
window.app_saku2_transaksi_kb_fKbumumKantin.extend(window.childForm);
window.app_saku2_transaksi_kb_fKbumumKantin.implement({
