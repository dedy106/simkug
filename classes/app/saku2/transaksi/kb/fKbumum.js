window.app_saku2_transaksi_kb_fKbumum = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kb_fKbumum.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kb_fKbumum";
...
window.app_saku2_transaksi_kb_fKbumum.extend(window.childForm);
window.app_saku2_transaksi_kb_fKbumum.implement({
