...
*/
window.app_saku2_transaksi_kb_fPjptgE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kb_fPjptgE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kb_fPjptgE";
		...
		this.pc1 = new pageControl(this,{bound:[20,12,900,257], childPage:["Data Panjar","Item Jurnal Pertanggungan","Data Anggaran"]});
		...
		this.cb1 = new portalui_checkBox(this.pc1.childPage[0],{bound:[20,5,100,25],caption:"Preview",selected:true});
...
window.app_saku2_transaksi_kb_fPjptgE.extend(window.childForm);
window.app_saku2_transaksi_kb_fPjptgE.implement({
	    			...
	    			case "execArraySQL" :	    				
						if (result.toLowerCase().search("error") == -1){
							if (this.cb1.isSelected()) {	
								...
								this.filter = "//PJPTG/"+" where a.kode_lokasi='"+this.app._lokasi+"' and a.no_ptg='"+this.e_nb.getText()+"'";
								this.filter2 = "";
								this.viewer.prepare();
