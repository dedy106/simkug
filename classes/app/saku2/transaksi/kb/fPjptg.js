...
*/
window.app_saku2_transaksi_kb_fPjptg = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_kb_fPjptg.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_kb_fPjptg";
...
window.app_saku2_transaksi_kb_fPjptg.extend(window.childForm);
window.app_saku2_transaksi_kb_fPjptg.implement({
