window.app_saku2_transaksi_investasi_fKbSahamDevE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_investasi_fKbSahamDevE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_investasi_fKbSahamDevE";
...
window.app_saku2_transaksi_investasi_fKbSahamDevE.extend(window.childForm);
window.app_saku2_transaksi_investasi_fKbSahamDevE.implement({
