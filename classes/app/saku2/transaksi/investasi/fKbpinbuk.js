window.app_saku2_transaksi_investasi_fKbpinbuk = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_investasi_fKbpinbuk.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_investasi_fKbpinbuk";
...
window.app_saku2_transaksi_investasi_fKbpinbuk.extend(window.childForm);
window.app_saku2_transaksi_investasi_fKbpinbuk.implement({
