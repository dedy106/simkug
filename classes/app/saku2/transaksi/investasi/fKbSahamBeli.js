window.app_saku2_transaksi_investasi_fKbSahamBeli = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_investasi_fKbSahamBeli.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_investasi_fKbSahamBeli";
...
window.app_saku2_transaksi_investasi_fKbSahamBeli.extend(window.childForm);
window.app_saku2_transaksi_investasi_fKbSahamBeli.implement({
