window.app_saku2_transaksi_investasi_fKbDOCcair = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_investasi_fKbDOCcair.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_investasi_fKbDOCcair";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form KasBank Penerimaan Bunga Deposito: Input", 0);	
		...
		this.p1 = new panel(this,{bound:[10,23,900,300],caption:"Daftar Bunga Deposito"});
...
window.app_saku2_transaksi_investasi_fKbDOCcair.extend(window.childForm);
window.app_saku2_transaksi_investasi_fKbDOCcair.implement({
	...
	doLoad:function(sender){
		if (this.e_periode.getText() != "") {
			...
			if (typeof data == "object" && data.rs.rows[0] != undefined){
				...
				for (var i in data.rs.rows){
					line = data.rs.rows[i];							
					this.sg.appendData(["INPROG",line.no_depo,line.tgl,line.keterangan,line.kode_bank,line.akun_piutang,floatToNilai(line.nilai_cair),line.no_cair,line.no_akru,line.kode_pp,line.kode_drk,floatToNilai(line.nilai_adm),line.modul]);
				}
