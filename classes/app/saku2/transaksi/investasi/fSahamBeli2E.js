window.app_saku2_transaksi_investasi_fSahamBeli2E = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_investasi_fSahamBeli2E.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_investasi_fSahamBeli2E";
...
window.app_saku2_transaksi_investasi_fSahamBeli2E.extend(window.childForm);
window.app_saku2_transaksi_investasi_fSahamBeli2E.implement({
	...
	doChange:function(sender){		
		if (sender == this.e_periode && this.e_periode.getText()!="") {						
			this.e_nb.setSQL("select no_shmbeli, keterangan from inv_shmbeli_m where progress ='0' and posted='F' and periode='"+this.e_periode.getText()+"' and kode_lokasi='"+this.app._lokasi+"'",["no_shmbeli","keterangan"],false,["No Bukti","Deskripsi"],"and","Daftar Bukti",true);
		}
