window.app_saku2_transaksi_investasi_fDOCaju = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_investasi_fDOCaju.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_investasi_fDOCaju";
		...
		this.cb_bank = new saiCBBL(this,{bound:[20,19,200,20],caption:"Bank Sumber", multiSelection:false, maxLength:10, tag:2,change:[this,"doChange"]});				
...
window.app_saku2_transaksi_investasi_fDOCaju.extend(window.childForm);
window.app_saku2_transaksi_investasi_fDOCaju.implement({
