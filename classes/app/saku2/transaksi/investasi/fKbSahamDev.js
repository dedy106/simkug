window.app_saku2_transaksi_investasi_fKbSahamDev = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_investasi_fKbSahamDev.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_investasi_fKbSahamDev";
		...
		this.bTampil = new button(this,{bound:[600,15,80,18],caption:"Data Deviden Saham",click:[this,"doLoad"]});			
...
window.app_saku2_transaksi_investasi_fKbSahamDev.extend(window.childForm);
window.app_saku2_transaksi_investasi_fKbSahamDev.implement({
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{														
					...
					sql.add("insert into kas_m (no_kas,kode_lokasi,no_dokumen,no_bg,akun_kb,tanggal,keterangan,kode_pp,modul,jenis,periode,kode_curr,kurs,nilai,nik_buat,nik_app,tgl_input,nik_user,posted,no_del,no_link,ref1,kode_bank) values  "+
							"('"+this.e_nb.getText()+"','"+this.app._lokasi+"','"+this.e_dok.getText()+"','-','"+this.cb_akun.getText()+"','"+this.dp_d1.getDateString()+"','"+this.e_ket.getText()+"','"+this.app._kodePP+"','KBSHMDEV','"+this.c_jenis.getText()+"','"+this.e_periode.getText()+"','IDR',1,"+parseNilai(this.e_nilai.getText())+",'"+this.cb_buat.getText()+"','"+this.cb_app.getText()+"',getdate(),'"+this.app._userLog+"','F','-','-','-','-')");										
	...
	doLoad:function(sender){
		if (this.e_periode.getText() != "") {
			var strSQL = "select a.no_shmdev,convert(varchar,a.tanggal,103) as tanggal,a.keterangan,a.kode_saham,b.kode_kelola,b.nilai_kb "+						 
			...
			if (typeof data == "object" && data.rs.rows[0] != undefined){
				...
				for (var i in data.rs.rows){
					line = data.rs.rows[i];							
					this.sg.appendData(["INPROG",line.no_shmdev,line.tanggal,line.keterangan,line.kode_saham,line.kode_kelola,floatToNilai(line.nilai_kb)]);
				}
