window.app_saku2_transaksi_investasi_fReksadana = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_investasi_fReksadana.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_investasi_fReksadana";
		...
		this.sg1 = new saiGrid(this.p1,{bound:[0,20,795,355],tag:9,readOnly:true,colTitle: ["Kode","Nama","Kelompok","Manajer Investasi"]});		
...
window.app_saku2_transaksi_investasi_fReksadana.extend(window.childForm);
window.app_saku2_transaksi_investasi_fReksadana.implement({
