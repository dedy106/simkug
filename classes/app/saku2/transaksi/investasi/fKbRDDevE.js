window.app_saku2_transaksi_investasi_fKbRDDevE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_investasi_fKbRDDevE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_investasi_fKbRDDevE";
...
window.app_saku2_transaksi_investasi_fKbRDDevE.extend(window.childForm);
window.app_saku2_transaksi_investasi_fKbRDDevE.implement({
