window.app_saku2_transaksi_investasi_fSahamDevE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_investasi_fSahamDevE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_investasi_fSahamDevE";
...
window.app_saku2_transaksi_investasi_fSahamDevE.extend(window.childForm);
window.app_saku2_transaksi_investasi_fSahamDevE.implement({
