window.app_saku2_transaksi_investasi_fRDBeliE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_investasi_fRDBeliE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_investasi_fRDBeliE";
...
window.app_saku2_transaksi_investasi_fRDBeliE.extend(window.childForm);
window.app_saku2_transaksi_investasi_fRDBeliE.implement({
