window.app_saku2_transaksi_investasi_fDOCcairE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_investasi_fDOCcairE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_investasi_fDOCcairE";
...
window.app_saku2_transaksi_investasi_fDOCcairE.extend(window.childForm);
window.app_saku2_transaksi_investasi_fDOCcairE.implement({
