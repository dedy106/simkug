window.app_saku2_transaksi_investasi_fKbRDBeli = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_investasi_fKbRDBeli.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_investasi_fKbRDBeli";
...
window.app_saku2_transaksi_investasi_fKbRDBeli.extend(window.childForm);
window.app_saku2_transaksi_investasi_fKbRDBeli.implement({
