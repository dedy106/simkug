window.app_saku2_transaksi_investasi_fKbRDJualE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_investasi_fKbRDJualE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_investasi_fKbRDJualE";
...
window.app_saku2_transaksi_investasi_fKbRDJualE.extend(window.childForm);
window.app_saku2_transaksi_investasi_fKbRDJualE.implement({
