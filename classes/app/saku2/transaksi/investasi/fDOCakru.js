window.app_saku2_transaksi_investasi_fDOCakru = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_investasi_fDOCakru.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_investasi_fDOCakru";
		...
		this.p1 = new panel(this,{bound:[20,23,900,343],caption:"Data Deposito"});
...
window.app_saku2_transaksi_investasi_fDOCakru.extend(window.childForm);
window.app_saku2_transaksi_investasi_fDOCakru.implement({
