window.app_saku2_transaksi_investasi_fKbSahamJual = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_investasi_fKbSahamJual.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_investasi_fKbSahamJual";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form KasBank Penjualan Saham: Input", 0);	
		...
		this.bTampil = new button(this,{bound:[600,15,80,18],caption:"Data Saham",click:[this,"doLoad"]});			
...
window.app_saku2_transaksi_investasi_fKbSahamJual.extend(window.childForm);
window.app_saku2_transaksi_investasi_fKbSahamJual.implement({
	...
	doLoad:function(sender){
		if (this.e_periode.getText() != "") {			
			var strSQL = "select a.no_shmjual,convert(varchar,a.tanggal,103) as tgl,a.keterangan,c.nama as kelola,a.nilai_piutang,a.nilai_pph,a.nilai_piugl,a.akun_piutang,a.akun_piugl "+
						 ...
						 "where a.no_kasjual ='-' and a.periode<='"+this.e_periode.getText()+"' and a.kode_lokasi = '"+this.app._lokasi+"' order by a.no_shmjual";						
