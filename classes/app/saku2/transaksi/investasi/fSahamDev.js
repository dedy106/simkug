window.app_saku2_transaksi_investasi_fSahamDev = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_investasi_fSahamDev.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_investasi_fSahamDev";
...
window.app_saku2_transaksi_investasi_fSahamDev.extend(window.childForm);
window.app_saku2_transaksi_investasi_fSahamDev.implement({
