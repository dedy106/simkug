window.app_saku2_transaksi_investasi_fKbRDDev = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_investasi_fKbRDDev.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_investasi_fKbRDDev";
		...
		this.bTampil = new button(this,{bound:[600,15,80,18],caption:"Data Deviden Reksadana",click:[this,"doLoad"]});			
...
window.app_saku2_transaksi_investasi_fKbRDDev.extend(window.childForm);
window.app_saku2_transaksi_investasi_fKbRDDev.implement({
	...
	doLoad:function(sender){
		if (this.e_periode.getText() != "") {
			var strSQL = "select a.no_rddev,convert(varchar,a.tanggal,103) as tanggal,a.keterangan,a.kode_rdkelola + ' - '+b.nama as mi,a.nilai "+						 
			             "from inv_rddev_m a inner join inv_rdkelola b on a.kode_rdkelola = b.kode_rdkelola where a.no_kas='-' and a.periode<='"+this.e_periode.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"'";						
