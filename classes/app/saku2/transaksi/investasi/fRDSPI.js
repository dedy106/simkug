window.app_saku2_transaksi_investasi_fRDSPI = function(owner)
{
	if (owner)
	{		
		window.app_saku2_transaksi_investasi_fRDSPI.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_investasi_fRDSPI";
...
window.app_saku2_transaksi_investasi_fRDSPI.extend(window.childForm);
window.app_saku2_transaksi_investasi_fRDSPI.implement({
						...
						for (var i=0;i < this.sg2.getRowCount();i++){
							if (this.sg2.rowValid(i)){
								if (nilaiToFloat(this.sg2.cells(1,i)) > 0 ) {
									...
									var strSQL = "select top 1 status from inv_rdkelola where akun_spi='"+this.sg2.cells(0,i)+"'";
									...
									if (status != "DAKEM") var akunCr = this.akunNT;
									else  var akunCr = this.akunNTDKM;
									...
									if (status != "DAKEM") var akunDr = this.akunNT;
									else var akunDr = this.akunNTDKM;
	...
	doLoadData: function(sender){
		...
		this.e_nilai.setText("0");		
		var strSQL = "select y.akun_spi,x.kode_rdkelola,a.kode_rd,x.nama,a.jumlah,a.h_oleh * a.jumlah as nilai_oleh,a.h_buku * a.jumlah as nilai_buku,0 as nilai_wajar,0 as nilai_sls,0 as total,isnull(b.nilai_spi,0) as total_spi "+
