window.app_saku2_transaksi_investasi_fRDJualE = function(owner)
{
	if (owner)
	{
		window.app_saku2_transaksi_investasi_fRDJualE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_transaksi_investasi_fRDJualE";
...
window.app_saku2_transaksi_investasi_fRDJualE.extend(window.childForm);
window.app_saku2_transaksi_investasi_fRDJualE.implement({
