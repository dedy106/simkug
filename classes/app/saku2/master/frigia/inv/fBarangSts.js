window.app_saku2_master_frigia_inv_fBarangSts = function(owner)
{
	if (owner)
	{
		window.app_saku2_master_frigia_inv_fBarangSts.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_master_frigia_inv_fBarangSts";
...
window.app_saku2_master_frigia_inv_fBarangSts.extend(window.portalui_childForm);
window.app_saku2_master_frigia_inv_fBarangSts.implement({
