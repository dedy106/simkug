window.app_saku2_master_frigia_inv_fBarang = function(owner)
{
	if (owner)
	{
		window.app_saku2_master_frigia_inv_fBarang.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_master_frigia_inv_fBarang";
...
window.app_saku2_master_frigia_inv_fBarang.extend(window.portalui_childForm);
window.app_saku2_master_frigia_inv_fBarang.implement({
