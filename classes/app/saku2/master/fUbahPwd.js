window.app_saku2_master_fUbahPwd = function(owner)
{
	if (owner)
	{
		window.app_saku2_master_fUbahPwd.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_master_fUbahPwd";
...
window.app_saku2_master_fUbahPwd.extend(window.childForm);
window.app_saku2_master_fUbahPwd.implement({
