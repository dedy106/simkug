window.app_saku2_master_gl_fNeracaProdukDetail = function(owner,modul)
{
	if (owner)
	{
		window.app_saku2_master_gl_fNeracaProdukDetail.prototype.parent.constructor.call(this, owner);
		window.app_saku2_master_gl_fNeracaProdukDetail.prototype.parent.setWidth.call(this, 300);
		window.app_saku2_master_gl_fNeracaProdukDetail.prototype.parent.setHeight.call(this, 400);
		
		this.centerize();
		
		this.className = "app_saku2_master_gl_fNeracaProdukDetail";
...
window.app_saku2_master_gl_fNeracaProdukDetail.extend(window.portalui_commonForm);
window.app_saku2_master_gl_fNeracaProdukDetail.prototype.doDraw = function(canvas)
{
...
window.app_saku2_master_gl_fNeracaProdukDetail.prototype.doAfterResize = function(event)
{
	this.p1.setWidth(this.width - 40);
...
window.app_saku2_master_gl_fNeracaProdukDetail.prototype.doSysMouseDown = function(x, y, button, buttonState)
{	
	window.app_saku2_master_gl_fNeracaProdukDetail.prototype.parent.doSysMouseDown.call(this,x, y, button, buttonState);
};
window.app_saku2_master_gl_fNeracaProdukDetail.prototype.doSysMouseUp = function(x, y, button, buttonState)
{	
	window.app_saku2_master_gl_fNeracaProdukDetail.prototype.parent.doSysMouseUp.call(this,x, y, button, buttonState);
};
window.app_saku2_master_gl_fNeracaProdukDetail.prototype.doSysMouseMove = function(x, y, button, buttonState)
{
	window.app_saku2_master_gl_fNeracaProdukDetail.prototype.parent.doSysMouseMove.call(this,x, y, button, buttonState);
	if (this.isClick)
	{		
...
window.app_saku2_master_gl_fNeracaProdukDetail.prototype.eventMouseDown = function(event)
{
...
window.app_saku2_master_gl_fNeracaProdukDetail.prototype.eventMouseUp = function(event)
{
	this.isClick = false;
	this.blockElm.style.display = "none";
	this.frameElm.style.display = "";
};
window.app_saku2_master_gl_fNeracaProdukDetail.prototype.eventMouseMove = function(event)
{
	if (this.isClick)
	{
		var x = event.clientX;
...
window.app_saku2_master_gl_fNeracaProdukDetail.prototype.doClick = function(sender)
{
	if (sender == this.b1){
		try{
...
window.app_saku2_master_gl_fNeracaProdukDetail.prototype.doRequestReady = function(sender, methodName, result)
{
};
window.app_saku2_master_gl_fNeracaProdukDetail.prototype.findBtnClick = function(sender)
{
};
//--------------------------------------------
window.app_saku2_master_gl_fNeracaProdukDetail.prototype.setCaption = function(data)
{
...
window.app_saku2_master_gl_fNeracaProdukDetail.prototype.setItemParent = function(data)
{
	this.itemParent = data;
};
window.app_saku2_master_gl_fNeracaProdukDetail.prototype.setSummaryItems = function(data)
{
	this.e4.clearItem();
	for (var i in data)
		this.e4.addItem(i, data[i]);	
};
window.app_saku2_master_gl_fNeracaProdukDetail.prototype.doClose = function(sender)
{
	system.delMouseListener(this);
};
window.app_saku2_master_gl_fNeracaProdukDetail.prototype.setModul = function(modul)
{
	/*
    this.e5.clearItem();
