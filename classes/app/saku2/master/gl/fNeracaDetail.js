window.app_saku2_master_gl_fNeracaDetail = function(owner,modul)
{
	if (owner)
	{
		window.app_saku2_master_gl_fNeracaDetail.prototype.parent.constructor.call(this, owner);
		window.app_saku2_master_gl_fNeracaDetail.prototype.parent.setWidth.call(this, 300);
		window.app_saku2_master_gl_fNeracaDetail.prototype.parent.setHeight.call(this, 400);
		
		this.centerize();
		
		this.className = "app_saku2_master_gl_fNeracaDetail";
		...
		this.b1 = new button(this,{bound:[this.width - 200,this.height - 50,80,20],caption:"Ok",icon:"url(icon/"+system.getThemes()+"/bOk2.png)",click:"dClick"});				
...
window.app_saku2_master_gl_fNeracaDetail.extend(window.commonForm);
window.app_saku2_master_gl_fNeracaDetail.implement({
	...
	doSysMouseDown: function(x, y, button, buttonState){	
		window.app_saku2_master_gl_fNeracaDetail.prototype.parent.doSysMouseDown.call(this,x, y, button, buttonState);
	},
	doSysMouseUp: function(x, y, button, buttonState){	
		window.app_saku2_master_gl_fNeracaDetail.prototype.parent.doSysMouseUp.call(this,x, y, button, buttonState);
	},
	doSysMouseMove: function(x, y, button, buttonState){
		window.app_saku2_master_gl_fNeracaDetail.prototype.parent.doSysMouseMove.call(this,x, y, button, buttonState);
		if (this.isClick)
		{		
