window.app_saku2_master_gl_fFsDb = function(owner)
{
	if (owner)
	{
		window.app_saku2_master_gl_fFsDb.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_master_gl_fFsDb";
		this.setTop(60);
		this.setWidth(1280);
		this.setHeight(550);
...
window.app_saku2_master_gl_fFsDb.extend(window.portalui_childForm);
//------------------------------------------------------------------ event
window.app_saku2_master_gl_fFsDb.implement({
