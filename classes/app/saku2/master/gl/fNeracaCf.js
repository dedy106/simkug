window.app_saku2_master_gl_fNeracaCf = function(owner)
{
	if (owner)
	{
		window.app_saku2_master_gl_fNeracaCf.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku2_master_gl_fNeracaCf";
...
window.app_saku2_master_gl_fNeracaCf.extend(window.portalui_childForm);
window.app_saku2_master_gl_fNeracaCf.implement({
		...
		{ 
		 	if (sender == this.relBtn)
			{
				...
				if (this.selectedItem.data.get("tipe").toLowerCase() == "posting"){
					uses("app_saku2_master_gl_fRelakunCf",true);
					if (this.relakun != undefined)
						this.relakun.free();
					this.relakun = new app_saku2_master_gl_fRelakunCf(this.app);
			...
			}else
			{
				if (sender == this.addBtn || sender == this.editBtn){
					uses("app_saku2_master_gl_fNeracaCfDetail");
					if (this.entryMenu == undefined)
						this.entryMenu = new app_saku2_master_gl_fNeracaCfDetail(this.app);
