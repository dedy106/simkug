...
//* 			SAI, PT											
//***********************************************************************************************
window.app_saku2_fLogin = function(owner){
	if (owner){
		try{		
			window.app_saku2_fLogin.prototype.parent.constructor.call(this, owner);
			this.className  = "app_saku2_fLogin";			
			...
			systemAPI.alert("[app_saku2_fLogin]::oncreate lib : ",e);
		}
	}
};
window.app_saku2_fLogin.extend(window.childForm);
window.app_saku2_fLogin.implement({
	doClose: function(){
