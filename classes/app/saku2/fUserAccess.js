window.app_saku2_fUserAccess = function(owner)
{
	if (owner)
	{
		window.app_saku2_fUserAccess.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku2_fUserAccess";
		this.maximize();
        ...
        this.p1 = new panel(this,{bound:[10,10,this.width-20, this.height - 80],caption:"Log User Login"});
...
window.app_saku2_fUserAccess.extend(window.childForm);
window.app_saku2_fUserAccess.implement({
