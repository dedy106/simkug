...
//* 			SAI, PT											
//***********************************************************************************************
window.app_saku2_fMain = function(owner)
{
	if (owner)
	{	
		try
		{
			window.app_saku2_fMain.prototype.parent.constructor.call(this, owner);			
...
//--------------------------------------------------
			...
			else this.setImage("url(image/themes/"+system.getThemes()+"/logo.png)");
...
window.app_saku2_fMain.extend(window.form);
window.app_saku2_fMain.implement({
	gotoLogin: function(){
		uses("app_saku2_fLogin");
		this.form = new app_saku2_fLogin(this);
	...
	initDashboard: function(){		
		uses("saiCBBL;saiEdit;saiGrid;;util_ajaxCaller;sgNavigator;pageControl;app_saku2_dashboard;fileExplorer;listView;util_file;PopUpMenu;MenuItem;app_saku2_remote_dataProvider");
		this.dashboard = new app_saku2_dashboard(this,{bound:[this.treev.width + 20, this.treev.top, this.width - this.treev.width - 30, this.treev.height]});		
	},
