...
//* 			SAI, PT											
//***********************************************************************************************
window.app_saku2_fLogin2 = function(owner){
	if (owner){
		try{		
			window.app_saku2_fLogin2.prototype.parent.constructor.call(this, owner);
			this.className  = "app_saku2_fLogin22";			
			...
			systemAPI.alert("[app_saku2_fLogin2]::oncreate lib : ",e);
		}
	}
};
window.app_saku2_fLogin2.extend(window.childForm);
window.app_saku2_fLogin2.implement({
    mainButtonClick: function(sender){
		try{
			...
			this.dbLib.loginAndLoad("select a.kode_klp_menu, a.nik, a.nama, a.pass, a.status_admin, a.klp_akses, a.kode_lokasi,b.nama as nmlok, "+
									"       c.kode_pp,d.nama as nama_pp,b.kode_lokkonsol "+ 
									"from hakakses a "+
