...
//* 			SAI, PT											
//***********************************************************************************************
window.app_saku2_app2 = function(owner){
	window.app_saku2_app2.prototype.parent.constructor.call(this, owner);
	this.className = "app_saku2_app2";
	this.onTerminate.set(this,"doTerminate");
	this.form = undefined;
	this.setTitle("SISFOKUG");
	this.showForm();
};
window.app_saku2_app2.extend(window.application);
window.app_saku2_app2.implement({
	showForm: function(){
		try
		{
			uses("util_dbLib;form;childForm;app_saku2_fMain2");		
			this._dbSetting = "mssql";
			this.dbLib = new util_dbLib(undefined, "mssql");
			this._mainForm = new app_saku2_fMain2(this);	
	...
	doKeyDown: function(charCode, buttonState, keyCode, event){
		try{			
			window.app_saku2_app2.prototype.parent.doKeyDown.call(this, charCode, buttonState, keyCode, event);
