window.app_assetsap_master_fNetre = function(owner)
{
	if (owner)
	{
		window.app_assetsap_master_fNetre.prototype.parent.constructor.call(this,owner);
		this.className  = "app_assetsap_master_fNetre";
		this.maximize();
...
window.app_assetsap_master_fNetre.extend(window.childForm);
//------------------------------------------------------------------ event
window.app_assetsap_master_fNetre.implement({
