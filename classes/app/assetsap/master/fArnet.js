window.app_assetsap_master_fArnet = function(owner)
{
	if (owner)
	{
		window.app_assetsap_master_fArnet.prototype.parent.constructor.call(this,owner);
		this.className  = "app_assetsap_master_fArnet";
		this.maximize();
...
window.app_assetsap_master_fArnet.extend(window.childForm);
//------------------------------------------------------------------ event
window.app_assetsap_master_fArnet.implement({
