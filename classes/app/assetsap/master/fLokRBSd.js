window.app_assetsap_master_fLokRBSd = function(owner)
{
	if (owner)
	{
		window.app_assetsap_master_fLokRBSd.prototype.parent.constructor.call(this,owner);
		this.className  = "app_assetsap_master_fLokRBSd";
		this.maximize();
...
window.app_assetsap_master_fLokRBSd.extend(window.childForm);
//------------------------------------------------------------------ event
window.app_assetsap_master_fLokRBSd.implement({
