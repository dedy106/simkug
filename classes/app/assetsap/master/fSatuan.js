window.app_assetsap_master_fSatuan = function(owner)
{
	if (owner)
	{
		window.app_assetsap_master_fSatuan.prototype.parent.constructor.call(this,owner);
		this.className  = "app_assetsap_master_fSatuan";
		this.maximize();
...
window.app_assetsap_master_fSatuan.extend(window.childForm);
//------------------------------------------------------------------ event
window.app_assetsap_master_fSatuan.implement({
