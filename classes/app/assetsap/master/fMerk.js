window.app_assetsap_master_fMerk = function(owner)
{
	if (owner)
	{
		window.app_assetsap_master_fMerk.prototype.parent.constructor.call(this,owner);
		this.className  = "app_assetsap_master_fMerk";
		this.maximize();
...
window.app_assetsap_master_fMerk.extend(window.childForm);
//------------------------------------------------------------------ event
window.app_assetsap_master_fMerk.implement({
