window.app_assetsap_master_fAlat = function(owner)
{
	if (owner)
	{
		window.app_assetsap_master_fAlat.prototype.parent.constructor.call(this,owner);
		this.className  = "app_assetsap_master_fAlat";
		this.maximize();
...
window.app_assetsap_master_fAlat.extend(window.childForm);
//------------------------------------------------------------------ event
window.app_assetsap_master_fAlat.implement({
