window.app_assetsap_master_fLokRBS = function(owner)
{
	if (owner)
	{
		window.app_assetsap_master_fLokRBS.prototype.parent.constructor.call(this,owner);
		this.className  = "app_assetsap_master_fLokRBS";
		this.maximize();
...
window.app_assetsap_master_fLokRBS.extend(window.childForm);
//------------------------------------------------------------------ event
window.app_assetsap_master_fLokRBS.implement({
