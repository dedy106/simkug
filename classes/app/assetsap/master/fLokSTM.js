window.app_assetsap_master_fLokSTM = function(owner)
{
	if (owner)
	{
		window.app_assetsap_master_fLokSTM.prototype.parent.constructor.call(this,owner);
		this.className  = "app_assetsap_master_fLokSTM";
		this.maximize();
...
window.app_assetsap_master_fLokSTM.extend(window.childForm);
//------------------------------------------------------------------ event
window.app_assetsap_master_fLokSTM.implement({
