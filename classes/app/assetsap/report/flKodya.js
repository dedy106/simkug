window.app_assetsap_report_flKodya = function(owner)
{
	if (owner)
	{
		window.app_assetsap_report_flKodya.prototype.parent.constructor.call(this,owner);
		this.className = "app_assetsap_report_flKodya";
		this.maximize();
...
window.app_assetsap_report_flKodya.extend(window.childForm);
window.app_assetsap_report_flKodya.implement({
