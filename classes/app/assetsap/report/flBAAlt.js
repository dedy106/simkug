...
//* 			SAI, PT											
//***********************************************************************************************
window.app_assetsap_report_flBAAlt = function(owner)
{
	if (owner)
	{
		window.app_assetsap_report_flBAAlt.prototype.parent.constructor.call(this,owner);
		this.className = "app_assetsap_report_flBAAlt";
		this.maximize();
		
		this.app._mainForm.childFormConfig(this, "mainButtonClick","BA Verifikasi Aset Prosedur Alternatif", 2);
...
window.app_assetsap_report_flBAAlt.extend(window.childForm);
window.app_assetsap_report_flBAAlt.implement({
	...
	mainButtonClick: function(sender){
		try{
			...
			this.nama_report = "server_report_amu_rptBAVer";			
