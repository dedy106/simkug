...
//* 			SAI, PT											
//***********************************************************************************************
window.app_assetsap_report_flRekapKK = function(owner)
{
	if (owner)
	{
		window.app_assetsap_report_flRekapKK.prototype.parent.constructor.call(this,owner);
		this.className = "app_assetsap_report_flRekapKK";
		this.maximize();
		
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Rekapitulasi Hasil Verifikasi", 2);
...
window.app_assetsap_report_flRekapKK.extend(window.childForm);
window.app_assetsap_report_flRekapKK.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		if (row == 4)
		{
			this.sg1.columns.get(2).setPicklist(new portalui_arrayMap({items:["DIVISI","REGIONAL","AREA","VENDOR"]}));			
		}		
	...
	mainButtonClick: function(sender){
		try{
			...
			this.nama_report = "server_report_amu_rptRekapKK";						
