...
//* 			SAI, PT											
//***********************************************************************************************
window.app_assetsap_report_flBARekon = function(owner)
{	
	try{
		if (owner)
		{
			window.app_assetsap_report_flBARekon.prototype.parent.constructor.call(this,owner);
			this.className = "app_assetsap_report_flBARekon";
			this.maximize();
			
			this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Berita Acara Rekonsiliasi", 2);		
		...
		this.gridLib.SGEditData(this.sg1,1,[0,1,2],["No BA","All",""]);	
...
window.app_assetsap_report_flBARekon.extend(window.childForm);
window.app_assetsap_report_flBARekon.implement({
		...
		if (row == 1)
		{
			this.filterRep.ListDataSGFilter(this, "Data Rekon",this.sg1, this.sg1.row, this.sg1.col,
													  "select no_ba, keterangan from amu_ba_m "+													   
													   this.filterRep.filterStr("kode_lokfa",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ")+" and jenis_ba = 'REKON' order by no_ba",
													  "select count(no_ba) from amu_ba_m "+													  
													  this.filterRep.filterStr("kode_lokfa",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where ") + "and jenis_ba = 'REKON' ",
	...
	mainButtonClick: function(sender){
		try{
			...
			this.page = 1;
			this.nama_report = "server_report_amu_rptBAKKP";
