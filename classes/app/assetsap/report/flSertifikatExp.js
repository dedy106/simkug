window.app_assetsap_report_flSertifikatExp = function(owner)
{
	if (owner)
	{
		window.app_assetsap_report_flSertifikatExp.prototype.parent.constructor.call(this,owner);
		this.className = "app_assetsap_report_flSertifikatExp";
		this.maximize();
...
window.app_assetsap_report_flSertifikatExp.extend(window.childForm);
window.app_assetsap_report_flSertifikatExp.implement({
		...
		try
		{
			if (sender === this.app._mainForm.bClear2){
		    	...
		    	this.filter = this.filterRep.filterStr("b.kode_prop",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.tgl_akhir",this.sg1.getCell(1,1),this.sg1.getCellDateValue(2,1),this.sg1.getCellDateValue(3,1),"and")+
				...
				var sql = "select distinct date_format(a.tgl_akhir, '%d-%m-%Y') as tgl, a.nama, a.no_surat,b.alamat, b.kel, b.kec, b.kode_kodya, b.kode_prop, b.tanah, b.kode_lokfa   "+
				...
				this.scriptSqlCount = "select count(distinct a.kode_lokfa, b.alamat, b.kel, b.kec, b.kode_kodya, b.kode_prop, b.tanah, b.bangun, a.no_reg, a.no_surat, a.nama,c.nama, a.keterangan) "+
						...
						"	inner join amu_fisik c on c.kode_fisik = a.kode_fisik and c.kode_lokasi = a.kode_lokasi "+
						this.filter;				
				this.title = new server_util_arrayList({items:["Tanggal","Nama","Sertifikat","Alamat","Kelurahan","Kecamatan","Kodya","Propinsi","Luas","Lokasi"]});
			...
			systemAPI.alert("[app_assetsap_report_flSertifikatExp]::mainButtonClick:"+e);
		}
	},
	...
	previewReport: function(dthtml){
		var html = "<div align='center' class='judul_laporan' style='{width:100%;font-size:14;font-weight:bold;}'><br><br>"+this.app._namalokasi.toUpperCase()+"<br>Sertifikat yang Habis Masa Berlaku<br>Posisi : "+this.sg1.getCell(2,1)+"<br />";
		var d = new Date();
