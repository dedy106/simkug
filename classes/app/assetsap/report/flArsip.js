window.app_assetsap_report_flArsip = function(owner)
{
	if (owner)
	{
		window.app_assetsap_report_flArsip.prototype.parent.constructor.call(this,owner);
		this.className = "app_assetsap_report_flArsip";
		this.maximize();
...
window.app_assetsap_report_flArsip.extend(window.childForm);
window.app_assetsap_report_flArsip.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2){
		    	...
		    	this.filter = this.filterRep.filterStr("b.kode_prop",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							this.filterRep.filterStr("b.kode_kodya",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
							this.filterRep.filterStr("a.tgl_awal",this.sg1.getCell(1,1),this.sg1.getCellDateValue(2,1),this.sg1.getCellDateValue(3,1),"and")+
							this.filterRep.filterStr("a.kode_lokfa",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and")+
							this.filterRep.filterStr("a.no_surat",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4),"and");
				...
				var sql = "select distinct a.kode_lokfa, b.alamat, b.kel, b.kec, b.kode_kodya as kodya, b.kode_prop as prop, b.tanah, b.bangun, a.no_reg, a.no_surat, a.nama,date_format(a.tgl_awal,'%d-%m-%Y') as tgl_awal, c.nama as nmfisik, a.keterangan   "+
						" from amu_arsip a inner join amu_lokfa b on b.kode_lokfa = a.kode_lokfa and b.kode_lokasi = a.kode_lokasi "+											
						//"	inner join amu_kodya e on e.kode_lokasi = a.kode_lokasi and e.kode_kodya = b.kode_kodya "+
						//"	inner join amu_propinsi f on f.kode_lokasi = a.kode_lokasi and f.kode_prop = b.kode_prop "+
				...
				this.scriptSqlCount = "select count(distinct a.kode_lokfa, b.alamat, b.kel, b.kec, b.kode_kodya, b.kode_prop, b.tanah, b.bangun, a.no_reg, a.no_surat, a.nama,c.nama, a.keterangan) "+
						...
						"	inner join amu_fisik c on c.kode_fisik = a.kode_fisik and c.kode_lokasi = a.kode_lokasi "+
						this.filter;				
				this.title = new server_util_arrayList({items:["Lokasi","Alamat","Kelurahan","Kecamatan","Kodya/Kabupaten","Propinsi","Luas Tanah","Luas Bangunan","No Register","Nomor","Nama","Tanggal","Fisik","Keterangan"]});
				this.widthTable = new server_util_arrayList({items:[80,150,100,100,100,100,100,100,100,150,100,100,150]});
			...
			systemAPI.alert("[app_assetsap_report_flArsip]::mainButtonClick:"+e);
		}
	},
