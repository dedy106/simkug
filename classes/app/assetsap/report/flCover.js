window.app_assetsap_report_flCover = function(owner)
{
	if (owner)
	{
		window.app_assetsap_report_flCover.prototype.parent.constructor.call(this,owner);
		this.className = "app_assetsap_report_flCover";
		this.maximize();
...
window.app_assetsap_report_flCover.extend(window.childForm);
window.app_assetsap_report_flCover.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_assetsap_report_flCover]::mainButtonClick:"+e);
		}
	},
