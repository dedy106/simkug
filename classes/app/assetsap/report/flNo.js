window.app_assetsap_report_flNo = function(owner)
{
	if (owner)
	{
		window.app_assetsap_report_flNo.prototype.parent.constructor.call(this,owner);
		this.className = "app_assetsap_report_flNo";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Daftar Nomor Lokasi", 2);
...
window.app_assetsap_report_flNo.extend(window.childForm);
window.app_assetsap_report_flNo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2){
				...
				var sql = "select distinct a.kode_lokfa, a.alamat, a.kel, a.kec,e.nama as kodya, f.nama as prop, a.tanah, count(distinct b.no_arsip) as tot  "+
						" from amu_lokfa a  "+											
						...
						"	left outer join amu_arsip b on b.kode_lokfa = a.kode_lokfa and b.kode_lokasi = a.kode_lokasi "+			
						this.filter +" group by a.kode_lokfa, a.alamat, a.kel, a.kec,e.nama, f.nama, a.tanah order by a.kode_lokfa" ;
				this.scriptSqlCount = "select count(distinct a.kode_lokfa, a.alamat, a.kel, a.kec,e.nama, f.nama, a.tanah, a.bangun) "+
						" from amu_lokfa a  "+											
						"	inner join amu_kodya e on e.kode_lokasi = a.kode_lokasi and e.kode_kodya = a.kode_kodya "+
						"	inner join amu_propinsi f on f.kode_lokasi = a.kode_lokasi and f.kode_prop = a.kode_prop "+						
						this.filter;				
				this.title = new server_util_arrayList({items:["Lokasi","Alamat","Kelurahan","Kecamatan","Kodya/Kabupaten","Propinsi","Luas Tanah","Arsip"]});
				...
				this.summary = new server_util_arrayList({items:["S","S","S","S","S","S","S","Y"]});	
			...
			systemAPI.alert("[app_assetsap_report_flNo]::mainButtonClick:"+e);
		}
	},
	...
	previewReport: function(dthtml){
		var html = "<div align='center' class='judul_laporan' style='{width:100%;font-size:14;font-weight:bold;}'><br><br>"+this.app._namalokasi.toUpperCase()+"<br>Daftar Lokasi<br>Posisi : "+this.sg1.getCell(2,1)+"<br />";
		var d = new Date();
