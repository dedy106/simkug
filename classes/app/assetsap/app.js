...
//* 			SAI, PT											
//***********************************************************************************************
window.app_assetsap_app = function(owner){
	window.app_assetsap_app.prototype.parent.constructor.call(this, owner);
	this.className = "app_assetsap_app";
	this.onTerminate.set(this,"doTerminate");
	this.form = undefined;
	this.setTitle("V E A T");
	this.showForm();
};
window.app_assetsap_app.extend(window.application);
window.app_assetsap_app.implement({
	showForm: function(){
		try
		{
			uses("util_dbLib;form;childForm");		
			this._dbSetting = "oraveat";				
			this._mainForm = new app_assetsap_fMain(this);	
	...
	doKeyDown: function(charCode, buttonState, keyCode, event){
		try{			
			window.app_assetsap_app.prototype.parent.doKeyDown.call(this, charCode, buttonState, keyCode, event);
