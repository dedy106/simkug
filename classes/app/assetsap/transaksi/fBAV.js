    ...
    initComponent: function(){
		try{
			...
			var sql =  "select  count(*)"+
					...
					" where a.kode_lokasi = '"+this.app._lokasi+"' and a.periode = '"+this.app._periode+"' and a.jenis_ba = 'KKIL'";
	...
	doEllipsFilterClick: function(sender, col, row){
		if (row == 1)
		{
			this.filterRep.ListDataSGFilter(this, "Data lokasi Aset(Bus.Area)",sender, sender.row, sender.col,
					...
					" where a.kode_lokasi = '"+this.app._lokasi+"'  and a.jenis_ba like 'KKIL' and a.periode = '"+this.app._periode +"' and  a.kode_lokfa like '"+(this.app._userStatus == "A" || this.app._userStatus == "U"? this.app._kodeLokfa : "%")+"' ",
