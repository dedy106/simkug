 ...
 * @author dweexfuad
 */
window.app_assetsap_transaksi_fTTDBA = function(owner, ba, klpfa, fa, formView) {
	if (owner){
		
		window.app_assetsap_transaksi_fTTDBA.prototype.parent.constructor.call(this,owner);
		this.maximize();
		this.className  = "app_assetsap_transaksi_fTTDBA";		
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Perubahan Tanda Tangan data BA Verifikasi  ", 0);	
...
window.app_assetsap_transaksi_fTTDBA.extend(window.childForm);
window.app_assetsap_transaksi_fTTDBA.implement({
