 ...
 * @author dweexfuad
 */
window.app_assetsap_transaksi_fTTDKonv = function(owner, ba, klpfa, fa, formView) {
	if (owner){
		
		window.app_assetsap_transaksi_fTTDKonv.prototype.parent.constructor.call(this,owner);
		this.maximize();
		this.className  = "app_assetsap_transaksi_fTTDKonv";		
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Perubahan Tanda Tangan data Konversi  ", 0);	
...
window.app_assetsap_transaksi_fTTDKonv.extend(window.childForm);
window.app_assetsap_transaksi_fTTDKonv.implement({
