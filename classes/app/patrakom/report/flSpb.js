window.app_patrakom_report_flSpb = function(owner)
{
	if (owner)
	{
		window.app_patrakom_report_flSpb.prototype.parent.constructor.call(this,owner);
		this.className = "app_patrakom_report_flSpb";
		this.maximize();
...
window.app_patrakom_report_flSpb.extend(window.portalui_childForm);
window.app_patrakom_report_flSpb.implement({
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.dbname = this.app._dbEng;
					this.nama_report="server_report_patrakom_rptSpb";
