window.app_frigia_report_flJenisKBM = function(owner)
{
	if (owner)
	{
		window.app_frigia_report_flJenisKBM.prototype.parent.constructor.call(this,owner);
		this.className = "app_frigia_report_flJenisKBM";
		this.maximize();
...
window.app_frigia_report_flJenisKBM.extend(window.portalui_childForm);
window.app_frigia_report_flJenisKBM.prototype.doEllipseClick= function(sender, col, row)
{
		if (row == 0){
...
window.app_frigia_report_flJenisKBM.prototype.doSelectCell = function(sender, col, row)
{
...
window.app_frigia_report_flJenisKBM.prototype.mainButtonClick = function(sender)
{
	try
	{
	...
	{
		alert("[app_frigia_report_flJenisKBM]::mainButtonClick:"+e);
	}
};
window.app_frigia_report_flJenisKBM.prototype.doRequestReady = function(sender, methodName, result)
{
...
window.app_frigia_report_flJenisKBM.prototype.getStringHeader = function(){
...
window.app_frigia_report_flJenisKBM.prototype.doConfirmClick = function(sender){
	try{
...
window.app_frigia_report_flJenisKBM.prototype.doSelectedPage = function(sender, page)
{
	var dthtml = this.dbLib.sqlToHtml(this.sqlScript,page,this.pager, this.title, this.widthTable, this.fieldType,false);			
	this.previewReport(dthtml);			
	this.page=page;
};
window.app_frigia_report_flJenisKBM.prototype.previewReport = function(dthtml)
{
...
window.app_frigia_report_flJenisKBM.prototype.doCloseReportClick = function(sender)
{
...
window.app_frigia_report_flJenisKBM.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_frigia_report_flJenisKBM.prototype.doRowPerPageChange = function(sender, rowperpage)
{
