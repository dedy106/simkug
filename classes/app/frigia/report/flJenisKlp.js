window.app_frigia_report_flJenisKlp = function(owner)
{
	if (owner)
	{
		window.app_frigia_report_flJenisKlp.prototype.parent.constructor.call(this,owner);
		this.className = "app_frigia_report_flJenisKlp";
		this.maximize();
...
window.app_frigia_report_flJenisKlp.extend(window.portalui_childForm);
window.app_frigia_report_flJenisKlp.prototype.doEllipseClick= function(sender, col, row)
{
		if (row == 0){
...
window.app_frigia_report_flJenisKlp.prototype.doSelectCell = function(sender, col, row)
{
...
window.app_frigia_report_flJenisKlp.prototype.mainButtonClick = function(sender)
{
	try
	{
	...
	{
		alert("[app_frigia_report_flJenisKlp]::mainButtonClick:"+e);
	}
};
window.app_frigia_report_flJenisKlp.prototype.doRequestReady = function(sender, methodName, result)
{
...
window.app_frigia_report_flJenisKlp.prototype.getStringHeader = function(){
...
window.app_frigia_report_flJenisKlp.prototype.doConfirmClick = function(sender){
	try{
...
window.app_frigia_report_flJenisKlp.prototype.doSelectedPage = function(sender, page)
{
	var dthtml = this.dbLib.sqlToHtml(this.sqlScript,page,this.pager, this.title, this.widthTable, this.fieldType,false);			
	this.previewReport(dthtml);			
	this.page=page;
};
window.app_frigia_report_flJenisKlp.prototype.previewReport = function(dthtml)
{
...
window.app_frigia_report_flJenisKlp.prototype.doCloseReportClick = function(sender)
{
...
window.app_frigia_report_flJenisKlp.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_frigia_report_flJenisKlp.prototype.doRowPerPageChange = function(sender, rowperpage)
{
