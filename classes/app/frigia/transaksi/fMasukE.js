window.app_frigia_transaksi_fMasukE = function(owner)
{
	if (owner)
	{
		window.app_frigia_transaksi_fMasukE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_frigia_transaksi_fMasukE";
...
window.app_frigia_transaksi_fMasukE.extend(window.portalui_childForm);
window.app_frigia_transaksi_fMasukE.implement({	
