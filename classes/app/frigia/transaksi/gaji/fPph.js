window.app_frigia_transaksi_gaji_fPph = function(owner)
{
	if (owner)
	{
		window.app_frigia_transaksi_gaji_fPph.prototype.parent.constructor.call(this,owner);
		this.className  = "app_frigia_transaksi_gaji_fPph";
...
window.app_frigia_transaksi_gaji_fPph.extend(window.childForm);
window.app_frigia_transaksi_gaji_fPph.implement({
