window.app_frigia_transaksi_gaji_fHitung = function(owner)
{
	if (owner)
	{
		window.app_frigia_transaksi_gaji_fHitung.prototype.parent.constructor.call(this,owner);
		this.className  = "app_frigia_transaksi_gaji_fHitung";
...
window.app_frigia_transaksi_gaji_fHitung.extend(window.childForm);
window.app_frigia_transaksi_gaji_fHitung.implement({
