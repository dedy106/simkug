window.app_frigia_transaksi_gaji_fPTKP = function(owner)
{
	if (owner)
	{
		window.app_frigia_transaksi_gaji_fPTKP.prototype.parent.constructor.call(this,owner);
		this.className  = "app_frigia_transaksi_gaji_fPTKP";
...
window.app_frigia_transaksi_gaji_fPTKP.extend(window.childForm);
window.app_frigia_transaksi_gaji_fPTKP.implement({
