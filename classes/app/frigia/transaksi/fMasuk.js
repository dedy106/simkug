window.app_frigia_transaksi_fMasuk = function(owner)
{
	if (owner)
	{
		window.app_frigia_transaksi_fMasuk.prototype.parent.constructor.call(this,owner);
		this.className  = "app_frigia_transaksi_fMasuk";
...
window.app_frigia_transaksi_fMasuk.extend(window.portalui_childForm);
window.app_frigia_transaksi_fMasuk.implement({	
