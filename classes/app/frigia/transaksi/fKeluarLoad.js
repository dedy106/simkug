window.app_frigia_transaksi_fKeluarLoad = function(owner)
{
	if (owner)
	{
		window.app_frigia_transaksi_fKeluarLoad.prototype.parent.constructor.call(this,owner);
		this.className  = "app_frigia_transaksi_fKeluarLoad";
...
window.app_frigia_transaksi_fKeluarLoad.extend(window.portalui_childForm);
window.app_frigia_transaksi_fKeluarLoad.implement({
