window.app_frigia_transaksi_fKirim = function(owner)
{
	if (owner)
	{
		window.app_frigia_transaksi_fKirim.prototype.parent.constructor.call(this,owner);
		this.className  = "app_frigia_transaksi_fKirim";
...
window.app_frigia_transaksi_fKirim.extend(window.portalui_childForm);
window.app_frigia_transaksi_fKirim.implement({
