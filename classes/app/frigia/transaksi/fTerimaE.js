window.app_frigia_transaksi_fTerimaE = function(owner)
{
	if (owner)
	{
		window.app_frigia_transaksi_fTerimaE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_frigia_transaksi_fTerimaE";
...
window.app_frigia_transaksi_fTerimaE.extend(window.portalui_childForm);
window.app_frigia_transaksi_fTerimaE.implement({	
