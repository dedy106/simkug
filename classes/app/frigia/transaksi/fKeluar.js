window.app_frigia_transaksi_fKeluar = function(owner)
{
	if (owner)
	{
		window.app_frigia_transaksi_fKeluar.prototype.parent.constructor.call(this,owner);
		this.className  = "app_frigia_transaksi_fKeluar";
...
window.app_frigia_transaksi_fKeluar.extend(window.portalui_childForm);
window.app_frigia_transaksi_fKeluar.implement({
