window.app_hrmis_admin_fLockTrans = function(owner){
	if (owner){
		window.app_hrmis_admin_fLockTrans.prototype.parent.constructor.call(this, owner);
		this.className = "app_hrmis_admin_fLockTrans";
...
window.app_hrmis_admin_fLockTrans.extend(window.portalui_childForm);
window.app_hrmis_admin_fLockTrans.implement({
