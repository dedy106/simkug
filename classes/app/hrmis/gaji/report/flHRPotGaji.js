window.app_hrmis_gaji_report_flHRPotGaji = function(owner)
{
	if (owner)
	{
		window.app_hrmis_gaji_report_flHRPotGaji.prototype.parent.constructor.call(this,owner);
		this.className = "app_hrmis_gaji_report_flHRPotGaji";
		this.maximize();
...
window.app_hrmis_gaji_report_flHRPotGaji.extend(window.portalui_childForm);
window.app_hrmis_gaji_report_flHRPotGaji.prototype.doEllipseClick= function(sender, col, row)
{
	if (row == 0)
	{
...
window.app_hrmis_gaji_report_flHRPotGaji.prototype.doSelectCell = function(sender, col, row)
{
...
window.app_hrmis_gaji_report_flHRPotGaji.prototype.mainButtonClick = function(sender)
{
	try
	{
	...
	{
		alert("[app_hrmis_gaji_report_flHRPotGaji]::mainButtonClick:"+e);
	}
};
window.app_hrmis_gaji_report_flHRPotGaji.prototype.jenisReport = function(jenis,filter)
{
	try
	{
	...
	{
		alert("[app_hrmis_gaji_report_flHRPotGaji]::jenisReport:"+e);
	}
};
window.app_hrmis_gaji_report_flHRPotGaji.prototype.doRequestReady = function(sender, methodName, result)
{
	switch (methodName)
	{
		case "preview" : 
...
window.app_hrmis_gaji_report_flHRPotGaji.prototype.doSelectedPage = function(sender, page)
{
...
window.app_hrmis_gaji_report_flHRPotGaji.prototype.previewReport = function(dthtml,jenis)
{
...
window.app_hrmis_gaji_report_flHRPotGaji.prototype.doCloseReportClick = function(sender)
{
...
window.app_hrmis_gaji_report_flHRPotGaji.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_hrmis_gaji_report_flHRPotGaji.prototype.doRowPerPageChange = function(sender, rowperpage)
{
