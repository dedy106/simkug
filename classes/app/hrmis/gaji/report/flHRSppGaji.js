window.app_hrmis_gaji_report_flHRSppGaji = function(owner)
{
	if (owner)
	{
		window.app_hrmis_gaji_report_flHRSppGaji.prototype.parent.constructor.call(this,owner);
		this.className = "app_hrmis_gaji_report_flHRSppGaji";
		this.maximize();
...
window.app_hrmis_gaji_report_flHRSppGaji.extend(window.portalui_childForm);
window.app_hrmis_gaji_report_flHRSppGaji.prototype.doEllipseClick= function(sender, col, row)
{
	if (row ==0)
	{
...
window.app_hrmis_gaji_report_flHRSppGaji.prototype.doSelectCell = function(sender, col, row)
{	
...
window.app_hrmis_gaji_report_flHRSppGaji.prototype.mainButtonClick = function(sender)
{
	try
	{
...
window.app_hrmis_gaji_report_flHRSppGaji.prototype.doRequestReady = function(sender, methodName, result)
{
	switch (methodName)
	{
		case "preview" : 
...
window.app_hrmis_gaji_report_flHRSppGaji.prototype.doSelectedPage = function(sender, page)
{
	this.report.preview(this.nama_report,this.filter, page,this.pager, this.lokasi, this.showFilter,this.filter2);
	this.page=page;
	this.allBtn = false;
};
window.app_hrmis_gaji_report_flHRSppGaji.prototype.doCloseReportClick = function(sender)
{
...
window.app_hrmis_gaji_report_flHRSppGaji.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_hrmis_gaji_report_flHRSppGaji.prototype.doRowPerPageChange = function(sender, rowperpage)
{
