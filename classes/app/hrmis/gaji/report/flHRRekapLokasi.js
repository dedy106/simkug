window.app_hrmis_gaji_report_flHRRekapLokasi = function(owner)
{
	if (owner)
	{
		window.app_hrmis_gaji_report_flHRRekapLokasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_hrmis_gaji_report_flHRRekapLokasi";
		this.maximize();
...
window.app_hrmis_gaji_report_flHRRekapLokasi.extend(window.portalui_childForm);
window.app_hrmis_gaji_report_flHRRekapLokasi.prototype.doEllipseClick= function(sender, col, row)
{
	if (row == 0)
	{
...
window.app_hrmis_gaji_report_flHRRekapLokasi.prototype.doSelectCell = function(sender, col, row)
{
	if (this.userStatus=="A")
	{
...
window.app_hrmis_gaji_report_flHRRekapLokasi.prototype.mainButtonClick = function(sender)
{
	try
	{
	...
	{
		alert("[app_hrmis_gaji_report_flHRRekapLokasi]::mainButtonClick:"+e);
	}
};
window.app_hrmis_gaji_report_flHRRekapLokasi.prototype.jenisReport = function(jenis,filter)
{
	try
	{
	...
	{
		alert("[app_hrmis_gaji_report_flHRRekapLokasi]::jenisReport:"+e);
	}
};
window.app_hrmis_gaji_report_flHRRekapLokasi.prototype.doRequestReady = function(sender, methodName, result)
{
	switch (methodName)
	{
		case "preview" : 
...
window.app_hrmis_gaji_report_flHRRekapLokasi.prototype.doSelectedPage = function(sender, page)
{
...
window.app_hrmis_gaji_report_flHRRekapLokasi.prototype.previewReport = function(dthtml,jenis)
{
...
window.app_hrmis_gaji_report_flHRRekapLokasi.prototype.doCloseReportClick = function(sender)
{
...
window.app_hrmis_gaji_report_flHRRekapLokasi.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_hrmis_gaji_report_flHRRekapLokasi.prototype.doRowPerPageChange = function(sender, rowperpage)
{
