window.app_hrmis_gaji_report_flHRSlip2 = function(owner)
{
	if (owner)
	{
		window.app_hrmis_gaji_report_flHRSlip2.prototype.parent.constructor.call(this,owner);
		this.className = "app_hrmis_gaji_report_flHRSlip2";
		this.maximize();
...
window.app_hrmis_gaji_report_flHRSlip2.extend(window.portalui_childForm);
window.app_hrmis_gaji_report_flHRSlip2.prototype.doEllipseClick= function(sender, col, row)
{
	if (row == 0)
	{
...
window.app_hrmis_gaji_report_flHRSlip2.prototype.doSelectCell = function(sender, col, row)
{
...
window.app_hrmis_gaji_report_flHRSlip2.prototype.mainButtonClick = function(sender)
{
	try
	{
	...
	{
		alert("[app_hrmis_gaji_report_flHRSlip2]::mainButtonClick:"+e);
	}
};
window.app_hrmis_gaji_report_flHRSlip2.prototype.jenisReport = function(jenis,filter)
{
	try
	{
...
window.app_hrmis_gaji_report_flHRSlip2.prototype.doRequestReady = function(sender, methodName, result)
{
	switch (methodName)
	{
		case "preview" : 
...
window.app_hrmis_gaji_report_flHRSlip2.prototype.doSelectedPage = function(sender, page)
{
...
window.app_hrmis_gaji_report_flHRSlip2.prototype.previewReport = function(dthtml,jenis)
{
	
	this.viewer.preview(html);
	this.allHtml = html;
};
window.app_hrmis_gaji_report_flHRSlip2.prototype.doCloseReportClick = function(sender)
{
...
window.app_hrmis_gaji_report_flHRSlip2.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_hrmis_gaji_report_flHRSlip2.prototype.doRowPerPageChange = function(sender, rowperpage)
{
