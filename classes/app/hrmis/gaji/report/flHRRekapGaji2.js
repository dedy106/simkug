window.app_hrmis_gaji_report_flHRRekapGaji2 = function(owner)
{
	if (owner)
	{
		window.app_hrmis_gaji_report_flHRRekapGaji2.prototype.parent.constructor.call(this,owner);
		this.className = "app_hrmis_gaji_report_flHRRekapGaji2";
		this.maximize();
...
window.app_hrmis_gaji_report_flHRRekapGaji2.extend(window.portalui_childForm);
window.app_hrmis_gaji_report_flHRRekapGaji2.prototype.doEllipseClick= function(sender, col, row)
{
	if (row == 0)
	{
...
window.app_hrmis_gaji_report_flHRRekapGaji2.prototype.doSelectCell = function(sender, col, row)
{
...
window.app_hrmis_gaji_report_flHRRekapGaji2.prototype.mainButtonClick = function(sender)
{
	try
	{
	...
	{
		alert("[app_hrmis_gaji_report_flHRRekapGaji2]::mainButtonClick:"+e);
	}
};
window.app_hrmis_gaji_report_flHRRekapGaji2.prototype.jenisReport = function(jenis,filter)
{
	try
	{
	...
	{
		alert("[app_hrmis_gaji_report_flHRRekapGaji2]::jenisReport:"+e);
	}
};
window.app_hrmis_gaji_report_flHRRekapGaji2.prototype.doRequestReady = function(sender, methodName, result)
{
	switch (methodName)
	{
		case "preview" : 
...
window.app_hrmis_gaji_report_flHRRekapGaji2.prototype.doSelectedPage = function(sender, page)
{
...
window.app_hrmis_gaji_report_flHRRekapGaji2.prototype.previewReport = function(dthtml,jenis)
{
...
window.app_hrmis_gaji_report_flHRRekapGaji2.prototype.doCloseReportClick = function(sender)
{
...
window.app_hrmis_gaji_report_flHRRekapGaji2.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_hrmis_gaji_report_flHRRekapGaji2.prototype.doRowPerPageChange = function(sender, rowperpage)
{
