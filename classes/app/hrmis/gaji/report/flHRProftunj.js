window.app_hrmis_gaji_report_flHRProftunj = function(owner)
{
	if (owner)
	{
		window.app_hrmis_gaji_report_flHRProftunj.prototype.parent.constructor.call(this,owner);
		this.className = "app_hrmis_gaji_report_flHRProftunj";
		this.maximize();
...
window.app_hrmis_gaji_report_flHRProftunj.extend(window.portalui_childForm);
window.app_hrmis_gaji_report_flHRProftunj.prototype.doEllipseClick= function(sender, col, row)
{
	if (row == 0)
	{
...
window.app_hrmis_gaji_report_flHRProftunj.prototype.doSelectCell = function(sender, col, row)
{
...
window.app_hrmis_gaji_report_flHRProftunj.prototype.mainButtonClick = function(sender)
{
	try
	{
	...
	{
		alert("[app_hrmis_gaji_report_flHRProftunj]::mainButtonClick:"+e);
	}
};
window.app_hrmis_gaji_report_flHRProftunj.prototype.doRequestReady = function(sender, methodName, result)
{
	switch (methodName)
	{
		case "preview" : 
...
window.app_hrmis_gaji_report_flHRProftunj.prototype.doSelectedPage = function(sender, page)
{
	var dthtml = this.dbLib.sqlToHtml(this.sqlScript,page,this.pager, this.title, this.widthTable, this.fieldType,false);			
	this.previewReport(dthtml);			
	this.page=page;
};
window.app_hrmis_gaji_report_flHRProftunj.prototype.previewReport = function(dthtml)
{
...
window.app_hrmis_gaji_report_flHRProftunj.prototype.doCloseReportClick = function(sender)
{
...
window.app_hrmis_gaji_report_flHRProftunj.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_hrmis_gaji_report_flHRProftunj.prototype.doRowPerPageChange = function(sender, rowperpage)
{
