window.app_hrmis_gaji_transaksi_fPot = function(owner)
{
	if (owner)
	{
		window.app_hrmis_gaji_transaksi_fPot.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hrmis_gaji_transaksi_fPot";
		this.maximize();
...
window.app_hrmis_gaji_transaksi_fPot.extend(window.portalui_childForm);
window.app_hrmis_gaji_transaksi_fPot.prototype.mainButtonClick = function(sender)
{
...
window.app_hrmis_gaji_transaksi_fPot.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.app_hrmis_gaji_transaksi_fPot.prototype.showClick = function(sender)
{	
...
window.app_hrmis_gaji_transaksi_fPot.prototype.tampilClick = function(sender)
{
	this.sg1.clearAll();
...
window.app_hrmis_gaji_transaksi_fPot.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_hrmis_gaji_transaksi_fPot.prototype.doRequestReady = function(sender, methodName, result)
{
