window.app_hrmis_gaji_transaksi_fUpload = function(owner)
{
	if (owner)
	{
		window.app_hrmis_gaji_transaksi_fUpload.prototype.parent.constructor.call(this, owner);
		this.className = "app_hrmis_gaji_transaksi_fUpload";
...
window.app_hrmis_gaji_transaksi_fUpload.extend(window.portalui_childForm);
window.app_hrmis_gaji_transaksi_fUpload.implement({
