window.app_hrmis_gaji_transaksi_fUploadPoltek = function(owner)
{
	if (owner)
	{
		window.app_hrmis_gaji_transaksi_fUploadPoltek.prototype.parent.constructor.call(this, owner);
		this.className = "app_hrmis_gaji_transaksi_fUploadPoltek";
		...
		this.sg1 = new portalui_saiGrid(this.p1,{bound:[0,20,900,200],colCount:8,
				colTitle:["NIK","Nama","Kop. SumBa","Pot. Kesehatan","Pinlun","Kop. Citra","Bank Yudha","Kop. Poltek"],readOnly:true,
				colFormat:[[2,3,4,5,6,7],[cfNilai, cfNilai, cfNilai,cfNilai, cfNilai, cfNilai]], colWidth:[[0,1,2,3,4],[100,200,100,100,100,100,100,100]]});		
...
window.app_hrmis_gaji_transaksi_fUploadPoltek.extend(window.portalui_childForm);
window.app_hrmis_gaji_transaksi_fUploadPoltek.implement({
		...
		switch (event){
			...
			case "simpan" :
					try{
						...
						var sqlText = "insert into gaji_load_pot_d (no_bukti, no_urut,nik,kosb, pkes, pinl,koct,byd1,kopt,kode_lokasi,periode)values";
						var sqlArray= [];		
						var fieldName = ["KOSB", "PKES", "PINL","KOCT","BYD1","KOPT"];
