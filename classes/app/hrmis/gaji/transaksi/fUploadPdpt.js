window.app_hrmis_gaji_transaksi_fUploadPdpt = function(owner)
{
	if (owner)
	{
		window.app_hrmis_gaji_transaksi_fUploadPdpt.prototype.parent.constructor.call(this, owner);
		this.className = "app_hrmis_gaji_transaksi_fUploadPdpt";
...
window.app_hrmis_gaji_transaksi_fUploadPdpt.extend(window.portalui_childForm);
window.app_hrmis_gaji_transaksi_fUploadPdpt.implement({
