window.app_hrmis_gaji_transaksi_fGabsen = function(owner)
{
	if (owner)
	{
		window.app_hrmis_gaji_transaksi_fGabsen.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hrmis_gaji_transaksi_fGabsen";
		this.maximize();
...
window.app_hrmis_gaji_transaksi_fGabsen.extend(window.portalui_childForm);
window.app_hrmis_gaji_transaksi_fGabsen.prototype.mainButtonClick = function(sender)
{
...
window.app_hrmis_gaji_transaksi_fGabsen.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.app_hrmis_gaji_transaksi_fGabsen.prototype.showClick = function(sender)
{	
...
window.app_hrmis_gaji_transaksi_fGabsen.prototype.tampilClick = function(sender)
{
	this.sg1.clearAll();
...
window.app_hrmis_gaji_transaksi_fGabsen.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_hrmis_gaji_transaksi_fGabsen.prototype.doRequestReady = function(sender, methodName, result)
{
