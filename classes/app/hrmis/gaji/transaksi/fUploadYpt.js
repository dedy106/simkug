window.app_hrmis_gaji_transaksi_fUploadYpt = function(owner)
{
	if (owner)
	{
		window.app_hrmis_gaji_transaksi_fUploadYpt.prototype.parent.constructor.call(this, owner);
		this.className = "app_hrmis_gaji_transaksi_fUploadYpt";
		...
		this.sg1 = new portalui_saiGrid(this.p1,{bound:[0,20,900,200],colCount:8,
				colTitle:["NIK","Nama","Pin Lun","Uang Kuliah ME25","Kosumba YPT","Kosumba BNI","Koperasi Citra(ITT)","Koperasoi GIAT(IMT)"],readOnly:true,
				colFormat:[[2,3,4,5,6,7],[cfNilai, cfNilai, cfNilai,cfNilai, cfNilai, cfNilai]], colWidth:[[0,1,2,3,4],[100,200,100,100,100]]});		
...
window.app_hrmis_gaji_transaksi_fUploadYpt.extend(window.portalui_childForm);
window.app_hrmis_gaji_transaksi_fUploadYpt.implement({
