window.app_hrmis_gaji_transaksi_fGjurnal= function(owner)
{
	if (owner)
	{
		window.app_hrmis_gaji_transaksi_fGjurnal.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hrmis_gaji_transaksi_fGjurnal";
		this.maximize();
		...
		try
		{
			...
			uses("app_hrmis_fJurnalViewer",true);			
			this.jurnal = new app_hrmis_fJurnalViewer(this.app);
...
window.app_hrmis_gaji_transaksi_fGjurnal.extend(window.portalui_childForm);
window.app_hrmis_gaji_transaksi_fGjurnal.prototype.mainButtonClick = function(sender)
{
...
window.app_hrmis_gaji_transaksi_fGjurnal.prototype.simpan = function()
{
	if  (this.nKB <= 0)
	{
...
window.app_hrmis_gaji_transaksi_fGjurnal.prototype.doModalResult = function(event, modalResult)
{
...
window.app_hrmis_gaji_transaksi_fGjurnal.prototype.genClick = function(sender)
{
	try
	{
...
window.app_hrmis_gaji_transaksi_fGjurnal.prototype.loadClick = function(sender)
{
	try
	{
		this.sg1.clear(); 
...
window.app_hrmis_gaji_transaksi_fGjurnal.prototype.doSelect = function(sender, year, month, day)
{
	if (month < 10)
		month = "0"+month;
	this.ed_period.setText(year.toString()+month);
};
window.app_hrmis_gaji_transaksi_fGjurnal.prototype.doEditChange = function(sender)
{
...
window.app_hrmis_gaji_transaksi_fGjurnal.prototype.FindBtnClick = function(sender, event)
{
	try
	{
		if (sender == this.cb_curr) 
...
window.app_hrmis_gaji_transaksi_fGjurnal.prototype.doFindBtnClick = function(sender, col, row) 
{
	try
	{
		switch(col)
...
window.app_hrmis_gaji_transaksi_fGjurnal.prototype.doNilaiChange = function()
{
	try
	{
		var totD = totC = 0; 
...
window.app_hrmis_gaji_transaksi_fGjurnal.prototype.hitungGar = function()
{
...
window.app_hrmis_gaji_transaksi_fGjurnal.prototype.garClick = function(sender)
{
	try
	{
		if (this.nKB != "0")
...
window.app_hrmis_gaji_transaksi_fGjurnal.prototype.doRequestReady = function(sender, methodName, result)
{
