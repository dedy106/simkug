window.app_hrmis_gaji_master_fHRJabsatunj = function(owner)
{
	if (owner)
	{
		window.app_hrmis_gaji_master_fHRJabsatunj.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hrmis_gaji_master_fHRJabsatunj";
		this.maximize();
...
window.app_hrmis_gaji_master_fHRJabsatunj.extend(window.portalui_childForm);
window.app_hrmis_gaji_master_fHRJabsatunj.prototype.mainButtonClick = function(sender)
{
...
window.app_hrmis_gaji_master_fHRJabsatunj.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.app_hrmis_gaji_master_fHRJabsatunj.prototype.showClick = function(sender)
{	
...
window.app_hrmis_gaji_master_fHRJabsatunj.prototype.tampilClick = function(sender)
{
	this.sg1.clearAll();
...
window.app_hrmis_gaji_master_fHRJabsatunj.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_hrmis_gaji_master_fHRJabsatunj.prototype.doRequestReady = function(sender, methodName, result)
{
