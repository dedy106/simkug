window.app_hrmis_gaji_master_fHRGadas = function(owner)
{
	if (owner)
	{
		window.app_hrmis_gaji_master_fHRGadas.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hrmis_gaji_master_fHRGadas";
		this.maximize();
...
window.app_hrmis_gaji_master_fHRGadas.extend(window.portalui_childForm);
window.app_hrmis_gaji_master_fHRGadas.prototype.mainButtonClick = function(sender)
{
...
window.app_hrmis_gaji_master_fHRGadas.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.app_hrmis_gaji_master_fHRGadas.prototype.showClick = function(sender)
{	
...
window.app_hrmis_gaji_master_fHRGadas.prototype.tampilClick = function(sender)
{
	this.sg1.clearAll();
...
window.app_hrmis_gaji_master_fHRGadas.prototype.doRequestReady = function(sender, methodName, result)
{
