window.app_hrmis_gaji_master_fHRJabtunj = function(owner)
{
	if (owner)
	{
		window.app_hrmis_gaji_master_fHRJabtunj.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hrmis_gaji_master_fHRJabtunj";
		this.maximize();
...
window.app_hrmis_gaji_master_fHRJabtunj.extend(window.portalui_childForm);
window.app_hrmis_gaji_master_fHRJabtunj.prototype.mainButtonClick = function(sender)
{
...
window.app_hrmis_gaji_master_fHRJabtunj.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.app_hrmis_gaji_master_fHRJabtunj.prototype.showClick = function(sender)
{	
...
window.app_hrmis_gaji_master_fHRJabtunj.prototype.tampilClick = function(sender)
{
	this.sg1.clearAll();
...
window.app_hrmis_gaji_master_fHRJabtunj.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_hrmis_gaji_master_fHRJabtunj.prototype.doRequestReady = function(sender, methodName, result)
{
