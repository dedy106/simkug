window.app_hrmis_gaji_master_fHRtunjhp = function(owner)
{
	if (owner)
	{
		window.app_hrmis_gaji_master_fHRtunjhp.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hrmis_gaji_master_fHRtunjhp";
		this.maximize();
...
window.app_hrmis_gaji_master_fHRtunjhp.extend(window.portalui_childForm);
window.app_hrmis_gaji_master_fHRtunjhp.prototype.mainButtonClick = function(sender)
{
...
window.app_hrmis_gaji_master_fHRtunjhp.prototype.doModalResult = function(event, modalResult)
{
	switch (event)
	{
		case "clear" :
...
window.app_hrmis_gaji_master_fHRtunjhp.prototype.showClick = function(sender)
{	
...
window.app_hrmis_gaji_master_fHRtunjhp.prototype.tampilClick = function(sender)
{
	this.sg1.clearAll();
...
window.app_hrmis_gaji_master_fHRtunjhp.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_hrmis_gaji_master_fHRtunjhp.prototype.doRequestReady = function(sender, methodName, result)
{
