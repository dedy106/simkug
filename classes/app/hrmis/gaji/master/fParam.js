window.app_hrmis_gaji_master_fParam = function(owner)
{
	if (owner)
	{
		window.app_hrmis_gaji_master_fParam.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hrmis_gaji_master_fParam";
		this.maximize();
...
window.app_hrmis_gaji_master_fParam.extend(window.portalui_childForm);
window.app_hrmis_gaji_master_fParam.prototype.mainButtonClick = function(sender)
{
...
window.app_hrmis_gaji_master_fParam.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
				...
				{					
					...
					for (var i=0; i < this.sg1.rows.getLength(); i++){						
						if (this.sg1.rowValid(i)){
							scr1 = "insert into gaji_param_d(nu,no_dok,kode_param,nama,jenis,kode_akun,sts_param,kode_lokkonsol,kode_ref) values ("+i+",'"+this.ed_nb.getText()+"','"+this.sg1.getCell(0,i)+"','"+this.sg1.getCell(1,i)+"','"+this.sg1.getCell(2,i)+"','"+this.sg1.getCell(3,i)+"','"+this.sg1.getCell(5,i)+"','"+this.lokkonsol+"','"+this.sg1.getCell(6,i)+"')";
							sql.add(scr1);
						}
					}
...
window.app_hrmis_gaji_master_fParam.prototype.showClick = function(sender)
{	
...
window.app_hrmis_gaji_master_fParam.prototype.doFindBtnClick = function(sender, col, row) 
{
	try
	{
		switch(col)
...
window.app_hrmis_gaji_master_fParam.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_hrmis_gaji_master_fParam.prototype.doRequestReady = function(sender, methodName, result)
{
