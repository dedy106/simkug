window.app_hrmis_gaji_master_fHRProftunj = function(owner)
{
	if (owner)
	{
		window.app_hrmis_gaji_master_fHRProftunj.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hrmis_gaji_master_fHRProftunj";
		this.maximize();
...
window.app_hrmis_gaji_master_fHRProftunj.extend(window.portalui_childForm);
window.app_hrmis_gaji_master_fHRProftunj.prototype.mainButtonClick = function(sender)
{
...
window.app_hrmis_gaji_master_fHRProftunj.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.app_hrmis_gaji_master_fHRProftunj.prototype.showClick = function(sender)
{	
...
window.app_hrmis_gaji_master_fHRProftunj.prototype.tampilClick = function(sender)
{
	this.sg1.clearAll();
...
window.app_hrmis_gaji_master_fHRProftunj.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_hrmis_gaji_master_fHRProftunj.prototype.doRequestReady = function(sender, methodName, result)
{
