...
//* 			SAI, PT											
//***********************************************************************************************
window.app_hrmis_fForm = function(owner){
	if (owner){
		try
		{			
			window.app_hrmis_fForm.prototype.parent.constructor.call(this,owner);
			this.className  = "app_hrmis_fForm";					
...
window.app_hrmis_fForm.extend(window.portalui_childForm);
//------------------------------------------------------------------ event
window.app_hrmis_fForm.implement({
