window.app_hrmis_sdm_master_fHRstatus = function(owner)
{
	if (owner)
	{
		window.app_hrmis_sdm_master_fHRstatus.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hrmis_sdm_master_fHRstatus";
		this.maximize();
...
window.app_hrmis_sdm_master_fHRstatus.extend(window.portalui_childForm);
window.app_hrmis_sdm_master_fHRstatus.prototype.mainButtonClick = function(sender)
{
...
window.app_hrmis_sdm_master_fHRstatus.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.app_hrmis_sdm_master_fHRstatus.prototype.showClick = function(sender)
{	
...
window.app_hrmis_sdm_master_fHRstatus.prototype.tampilClick = function(sender)
{
	this.sg1.clearAll();
...
window.app_hrmis_sdm_master_fHRstatus.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_hrmis_sdm_master_fHRstatus.prototype.doRequestReady = function(sender, methodName, result)
{
