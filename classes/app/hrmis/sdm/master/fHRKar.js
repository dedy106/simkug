window.app_hrmis_sdm_master_fHRKar = function(owner)
{
	if (owner)
	{
		window.app_hrmis_sdm_master_fHRKar.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hrmis_sdm_master_fHRKar";
		this.maximize();
...
window.app_hrmis_sdm_master_fHRKar.extend(window.portalui_childForm);
window.app_hrmis_sdm_master_fHRKar.prototype.mainButtonClick = function(sender){
...
window.app_hrmis_sdm_master_fHRKar.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.app_hrmis_sdm_master_fHRKar.prototype.showClick = function(sender)
{
...
window.app_hrmis_sdm_master_fHRKar.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_hrmis_sdm_master_fHRKar.prototype.doRequestReady = function(sender, methodName, result)
{
...
window.app_hrmis_sdm_master_fHRKar.implement({
