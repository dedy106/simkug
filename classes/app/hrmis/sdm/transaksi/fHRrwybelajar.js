window.app_hrmis_sdm_transaksi_fHRrwybelajar = function(owner)
{
	if (owner)
	{
		window.app_hrmis_sdm_transaksi_fHRrwybelajar.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hrmis_sdm_transaksi_fHRrwybelajar";
		this.maximize();
...
window.app_hrmis_sdm_transaksi_fHRrwybelajar.extend(window.portalui_childForm);
window.app_hrmis_sdm_transaksi_fHRrwybelajar.prototype.sg1init = function(sg)
{
...
window.app_hrmis_sdm_transaksi_fHRrwybelajar.prototype.doEditChange = function(sender)
{
...
window.app_hrmis_sdm_transaksi_fHRrwybelajar.prototype.mainButtonClick = function(sender)
{
...
window.app_hrmis_sdm_transaksi_fHRrwybelajar.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
				...
				{					
					...
					for (var i=0; i < this.sg1.rows.getLength(); i++)
					{
						if (this.sg1.rowValid(i)) {								
							scr1 = "insert into hr_belajar_d (nik,no_pid,kode_lokkonsol,no_urut,semester,ipk,keterangan,nilai) values ('"+this.cb_nik.getText()+"','"+this.cb_pid.getText()+"','"+this.lokkonsol+"',"+idx+",'"+this.sg1.getCell(0,i)+
...
window.app_hrmis_sdm_transaksi_fHRrwybelajar.prototype.show2Click = function(sender)
{
	if (this.cb_nik.getText() != "")
	{
		try
...
window.app_hrmis_sdm_transaksi_fHRrwybelajar.prototype.showClick = function(sender)
{
		...
		{			
			...
			if (data instanceof portalui_arrayMap)
			{
				if (data.get(0) != undefined)
				{
					...
					this.ed_tjab.setText(nilaiToFloat(parfloat(line.get("tjab"))));
...
window.app_hrmis_sdm_transaksi_fHRrwybelajar.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_hrmis_sdm_transaksi_fHRrwybelajar.prototype.doRequestReady = function(sender, methodName, result)
{
...
window.app_hrmis_sdm_transaksi_fHRrwybelajar.implement({
