window.app_hrmis_sdm_transaksi_fHRrwyharga = function(owner)
{
	if (owner)
	{
		window.app_hrmis_sdm_transaksi_fHRrwyharga.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hrmis_sdm_transaksi_fHRrwyharga";
		this.maximize();
...
window.app_hrmis_sdm_transaksi_fHRrwyharga.extend(window.portalui_childForm);
window.app_hrmis_sdm_transaksi_fHRrwyharga.prototype.sg1init = function(sg)
{
	sg.columns.get(4).setColumnFormat(window.cfNilai);
	sg.setColWidth(new Array(4,3,2,1,0),
					new Array(200,400,80,80,120));
};
window.app_hrmis_sdm_transaksi_fHRrwyharga.prototype.sg1onDblClick = function(sender, col, row)
{
	try
	{		
...
window.app_hrmis_sdm_transaksi_fHRrwyharga.prototype.doEditChange = function(sender)
{
...
window.app_hrmis_sdm_transaksi_fHRrwyharga.prototype.mainButtonClick = function(sender)
{
...
window.app_hrmis_sdm_transaksi_fHRrwyharga.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.app_hrmis_sdm_transaksi_fHRrwyharga.prototype.show2Click = function(sender)
{
	if (this.cb_nik.getText() != "")
	{
		try
...
window.app_hrmis_sdm_transaksi_fHRrwyharga.prototype.showClick = function(sender)
{
...
window.app_hrmis_sdm_transaksi_fHRrwyharga.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_hrmis_sdm_transaksi_fHRrwyharga.prototype.doRequestReady = function(sender, methodName, result)
{
...
window.app_hrmis_sdm_transaksi_fHRrwyharga.implement({
