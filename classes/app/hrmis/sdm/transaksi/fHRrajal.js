window.GUI_sdm_transaksi_fHRrajal = function(owner)
{
	if (owner)
	{
		window.GUI_sdm_transaksi_fHRrajal.prototype.parent.constructor.call(this,owner);
		this.className  = "GUI_sdm_transaksi_fHRrajal";
		this.maximize();
		...
		this.cb_nik = new controls_saiCBBL(this);
		...
		this.ed_tmplahir = new controls_saiLabelEdit(this);
		...
		this.ed_tgllahir = new controls_saiLabelEdit(this);
		...
		this.ed_alamat = new controls_saiLabelEdit(this);
		...
		this.cb_pasien = new controls_saiCBBL(this);
		...
		uses("controls_saiLabelEdit");
		this.ed_umur = new controls_saiLabelEdit(this);
		...
		this.ed_nb = new controls_saiLabelEdit(this);
		...
		this.cb_rs = new controls_saiCBBL(this);
		...
		this.cb_klinik = new controls_saiCBBL(this);
		...
		this.ed_jml = new controls_saiLabelEdit(this);
		...
		this.dp_tglselesai = new controls_datePicker(this);
...
window.GUI_sdm_transaksi_fHRrajal.extend(window.controls_childForm);
window.GUI_sdm_transaksi_fHRrajal.prototype.sg1init = function(sg)
{
...
window.GUI_sdm_transaksi_fHRrajal.prototype.sg1onDblClick = function(sender, col, row)
{
	try
	{		
...
window.GUI_sdm_transaksi_fHRrajal.prototype.doEditChange = function(sender)
{
...
window.GUI_sdm_transaksi_fHRrajal.prototype.mainButtonClick = function(sender)
{
...
window.GUI_sdm_transaksi_fHRrajal.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.GUI_sdm_transaksi_fHRrajal.prototype.showClick = function(sender)
{
...
window.GUI_sdm_transaksi_fHRrajal.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.GUI_sdm_transaksi_fHRrajal.prototype.doRequestReady = function(sender, methodName, result)
{
