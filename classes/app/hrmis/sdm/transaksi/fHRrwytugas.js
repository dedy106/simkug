window.app_hrmis_sdm_transaksi_fHRrwytugas = function(owner)
{
	if (owner)
	{
		window.app_hrmis_sdm_transaksi_fHRrwytugas.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hrmis_sdm_transaksi_fHRrwytugas";
		this.maximize();
...
window.app_hrmis_sdm_transaksi_fHRrwytugas.extend(window.portalui_childForm);
window.app_hrmis_sdm_transaksi_fHRrwytugas.prototype.sg1init = function(sg)
{
	sg.setColWidth([7,6,5,4,3,2,1,0],
				[260,100,100,110,110,80,80,50]);
};
window.app_hrmis_sdm_transaksi_fHRrwytugas.prototype.sg1onDblClick = function(sender, col, row)
{
	try
	{		
...
window.app_hrmis_sdm_transaksi_fHRrwytugas.prototype.doEditChange = function(sender)
{
...
window.app_hrmis_sdm_transaksi_fHRrwytugas.prototype.mainButtonClick = function(sender)
{
...
window.app_hrmis_sdm_transaksi_fHRrwytugas.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.app_hrmis_sdm_transaksi_fHRrwytugas.prototype.show2Click = function(sender)
{
	if (this.cb_nik.getText() != "")
	{
		try
...
window.app_hrmis_sdm_transaksi_fHRrwytugas.prototype.showClick = function(sender)
{
...
window.app_hrmis_sdm_transaksi_fHRrwytugas.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_hrmis_sdm_transaksi_fHRrwytugas.prototype.doRequestReady = function(sender, methodName, result)
{
