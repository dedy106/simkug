window.GUI_sdm_transaksi_fHRSKI = function(owner)
{
	if (owner)
	{
		window.GUI_sdm_transaksi_fHRSKI.prototype.parent.constructor.call(this,owner);
		this.className  = "GUI_sdm_transaksi_fHRSKI";
		this.maximize();
		...
		this.ed_avg = new controls_saiLabelEdit(this);
		...
		this.ed_ski = new controls_saiLabelEdit(this);
		...
		this.ed_kompetensi = new controls_saiLabelEdit(this);
...
window.GUI_sdm_transaksi_fHRSKI.extend(window.controls_childForm);

window.GUI_sdm_transaksi_fHRSKI.prototype.sg1init = function(sg)
{
	sg.setColWidth(new Array(4,3,2,1,0),
					new Array(100,100,100,100,80));	
}

window.GUI_sdm_transaksi_fHRSKI.prototype.sg1onDblClick = function(sender, col, row)
{
	try
	{			
...
window.GUI_sdm_transaksi_fHRSKI.prototype.mainButtonClick = function(sender)
{
...
window.GUI_sdm_transaksi_fHRSKI.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.GUI_sdm_transaksi_fHRSKI.prototype.showClick = function(sender)
{
...
window.GUI_sdm_transaksi_fHRSKI.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.GUI_sdm_transaksi_fHRSKI.prototype.doRequestReady = function(sender, methodName, result)
{
