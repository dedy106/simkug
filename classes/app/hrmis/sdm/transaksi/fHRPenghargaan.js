window.GUI_sdm_transaksi_fHRPenghargaan = function(owner)
{
	if (owner)
	{
		window.GUI_sdm_transaksi_fHRPenghargaan.prototype.parent.constructor.call(this,owner);
		this.className  = "GUI_sdm_transaksi_fHRPenghargaan";
		this.maximize();
		...
		this.ed_penghargaan = new controls_saiLabelEdit(this);
		...
		this.ed_uang = new controls_saiLabelEdit(this);
		...
		this.ed_nikttd = new controls_saiLabelEdit(this);
...
window.GUI_sdm_transaksi_fHRPenghargaan.extend(window.controls_childForm);

window.GUI_sdm_transaksi_fHRPenghargaan.prototype.sg1init = function(sg)
{
...
window.GUI_sdm_transaksi_fHRPenghargaan.prototype.sg1onDblClick = function(sender, col, row)
{
	try
	{			
...
window.GUI_sdm_transaksi_fHRPenghargaan.prototype.mainButtonClick = function(sender)
{
...
window.GUI_sdm_transaksi_fHRPenghargaan.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.GUI_sdm_transaksi_fHRPenghargaan.prototype.showClick = function(sender)
{
...
window.GUI_sdm_transaksi_fHRPenghargaan.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.GUI_sdm_transaksi_fHRPenghargaan.prototype.doRequestReady = function(sender, methodName, result)
{
