window.GUI_sdm_transaksi_fHRplafon = function(owner)
{
	if (owner)
	{
		window.GUI_sdm_transaksi_fHRplafon.prototype.parent.constructor.call(this,owner);
		this.className  = "GUI_sdm_transaksi_fHRplafon";
		this.maximize();
		...
		this.cb_jenis = new controls_saiCBBL(this);
		...
		this.ed_nilai = new controls_saiLabelEdit(this);
		...
		this.ed_persen = new controls_saiLabelEdit(this);
...
window.GUI_sdm_transaksi_fHRplafon.extend(window.controls_childForm);
window.GUI_sdm_transaksi_fHRplafon.prototype.sg1init = function(sg)
{
	sg.setColWidth(new Array(5,4,3,2,1,0),
					new Array(100,100,100,200,300,100));
}

window.GUI_sdm_transaksi_fHRplafon.prototype.sg1onDblClick = function(sender, col, row)
{
	try
	{		
...
window.GUI_sdm_transaksi_fHRplafon.prototype.mainButtonClick = function(sender)
{
...
window.GUI_sdm_transaksi_fHRplafon.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.GUI_sdm_transaksi_fHRplafon.prototype.showClick = function(sender)
{
...
window.GUI_sdm_transaksi_fHRplafon.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.GUI_sdm_transaksi_fHRplafon.prototype.doRequestReady = function(sender, methodName, result)
{
