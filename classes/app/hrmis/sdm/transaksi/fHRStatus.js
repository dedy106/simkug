window.GUI_sdm_transaksi_fHRStatus = function(owner)
{
	if (owner)
	{
		window.GUI_sdm_transaksi_fHRStatus.prototype.parent.constructor.call(this,owner);
		this.className  = "GUI_sdm_transaksi_fHRStatus";
		this.maximize();
...
window.GUI_sdm_transaksi_fHRStatus.extend(window.controls_childForm);

window.GUI_sdm_transaksi_fHRStatus.prototype.sg1init = function(sg)
{
	sg.setColWidth(new Array(4,3,2,1,0),
					new Array(80,150,100,80,80));	
}

window.GUI_sdm_transaksi_fHRStatus.prototype.sg1onDblClick = function(sender, col, row)
{
	try
	{			
...
window.GUI_sdm_transaksi_fHRStatus.prototype.mainButtonClick = function(sender)
{
...
window.GUI_sdm_transaksi_fHRStatus.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.GUI_sdm_transaksi_fHRStatus.prototype.showClick = function(sender)
{
...
window.GUI_sdm_transaksi_fHRStatus.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.GUI_sdm_transaksi_fHRStatus.prototype.doRequestReady = function(sender, methodName, result)
{
