window.GUI_sdm_transaksi_fHRDinas2 = function(owner)
{
	if (owner)
	{
		window.GUI_sdm_transaksi_fHRDinas2.prototype.parent.constructor.call(this,owner);
		this.className  = "GUI_sdm_transaksi_fHRDinas2";
		this.maximize();
		...
		uses("controls_saiCB");
		this.ed_status = new controls_saiCB(this);
		...
		this.cb_profesi = new controls_saiCB(this);
		...
		this.cb_ijasah = new controls_saiCB(this);
		...
		this.cb_ijaaku = new controls_saiCB(this);
		...
		this.cb_jurusan = new controls_saiCB(this);
		...
		uses("controls_saiLabelEdit");
		this.ed_pkltingkat = new controls_saiLabelEdit(this);
		...
		this.ed_tingkat = new controls_saiLabelEdit(this);
		...
		//----
		this.cb_jabs = new controls_saiCBBL(this);
		...
		this.cb_jabf = new controls_saiCBBL(this);
		...
		this.ed_jabket = new controls_saiLabelEdit(this);
		...
		this.cb_blntingkat = new controls_saiCB(this);
		...
		this.cb_blngaji = new controls_saiCB(this);
		...
		this.ed_gaji = new controls_saiLabelEdit(this);
		...
		this.ed_tahun = new controls_saiLabelEdit(this);
		...
		this.ed_bulan = new controls_saiLabelEdit(this);
...
window.GUI_sdm_transaksi_fHRDinas2.extend(window.controls_childForm);

window.GUI_sdm_transaksi_fHRDinas2.prototype.sg1init = function(sg)
{
	sg.setColWidth(new Array(8,7,6,5,4,3,2,1,0),
					new Array(150,100,80,150,80,100,150,80,80));
}

window.GUI_sdm_transaksi_fHRDinas2.prototype.sg1onDblClick = function(sender, col, row)
{
	try
	{			
...
window.GUI_sdm_transaksi_fHRDinas2.prototype.mainButtonClick = function(sender)
{
...
window.GUI_sdm_transaksi_fHRDinas2.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.GUI_sdm_transaksi_fHRDinas2.prototype.showClick = function(sender)
{
...
window.GUI_sdm_transaksi_fHRDinas2.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.GUI_sdm_transaksi_fHRDinas2.prototype.doRequestReady = function(sender, methodName, result)
{
