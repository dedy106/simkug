window.app_hrmis_sdm_transaksi_fHRrwyjabs = function(owner)
{
	if (owner)
	{
		window.app_hrmis_sdm_transaksi_fHRrwyjabs.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hrmis_sdm_transaksi_fHRrwyjabs";
		this.maximize();
...
window.app_hrmis_sdm_transaksi_fHRrwyjabs.extend(window.portalui_childForm);
window.app_hrmis_sdm_transaksi_fHRrwyjabs.prototype.sg1init = function(sg)
{
	sg.setColWidth([9,8,7,6,5,4,3,2,1,0],
				[80,100,100,100,120,120,80,80,80,120]);
};
window.app_hrmis_sdm_transaksi_fHRrwyjabs.prototype.sg1onDblClick = function(sender, col, row)
{
	try
	{		
...
window.app_hrmis_sdm_transaksi_fHRrwyjabs.prototype.doEditChange = function(sender)
{
...
window.app_hrmis_sdm_transaksi_fHRrwyjabs.prototype.mainButtonClick = function(sender)
{
...
window.app_hrmis_sdm_transaksi_fHRrwyjabs.prototype.doModalResult = function(event, modalResult)
{			
	var stsAktif = "0";
...
window.app_hrmis_sdm_transaksi_fHRrwyjabs.prototype.show2Click = function(sender)
{
	if (this.cb_nik.getText() != "")
	{
		try
...
window.app_hrmis_sdm_transaksi_fHRrwyjabs.prototype.showClick = function(sender)
{
...
window.app_hrmis_sdm_transaksi_fHRrwyjabs.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_hrmis_sdm_transaksi_fHRrwyjabs.prototype.doRequestReady = function(sender, methodName, result)
{
...
window.app_hrmis_sdm_transaksi_fHRrwyjabs.implement({
