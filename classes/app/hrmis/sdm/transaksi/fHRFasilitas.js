window.GUI_sdm_transaksi_fHRFasilitas = function(owner)
{
	if (owner)
	{
		window.GUI_sdm_transaksi_fHRFasilitas.prototype.parent.constructor.call(this,owner);
		this.className  = "GUI_sdm_transaksi_fHRFasilitas";
		this.maximize();
...
window.GUI_sdm_transaksi_fHRFasilitas.extend(window.controls_childForm);

window.GUI_sdm_transaksi_fHRFasilitas.prototype.sg1init = function(sg)
{
...
window.GUI_sdm_transaksi_fHRFasilitas.prototype.sg1onDblClick = function(sender, col, row)
{
	try
	{			
...
window.GUI_sdm_transaksi_fHRFasilitas.prototype.mainButtonClick = function(sender)
{
...
window.GUI_sdm_transaksi_fHRFasilitas.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.GUI_sdm_transaksi_fHRFasilitas.prototype.showClick = function(sender)
{
...
window.GUI_sdm_transaksi_fHRFasilitas.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.GUI_sdm_transaksi_fHRFasilitas.prototype.doRequestReady = function(sender, methodName, result)
{
