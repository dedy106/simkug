window.app_hrmis_sdm_transaksi_fHRcekup = function(owner)
{
	if (owner)
	{
		window.app_hrmis_sdm_transaksi_fHRcekup.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hrmis_sdm_transaksi_fHRcekup";
		this.maximize();
...
window.app_hrmis_sdm_transaksi_fHRcekup.extend(window.portalui_childForm);
window.app_hrmis_sdm_transaksi_fHRcekup.prototype.sg1init = function(sg)
{
	sg.setColWidth([4,3,2,1,0],[100,200,200,200,100]);
};
window.app_hrmis_sdm_transaksi_fHRcekup.prototype.sg1onDblClick = function(sender, col, row)
{
	try
	{		
...
window.app_hrmis_sdm_transaksi_fHRcekup.prototype.doEditChange = function(sender)
{
...
window.app_hrmis_sdm_transaksi_fHRcekup.prototype.mainButtonClick = function(sender)
{
...
window.app_hrmis_sdm_transaksi_fHRcekup.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.app_hrmis_sdm_transaksi_fHRcekup.prototype.showClick = function(sender)
{
...
window.app_hrmis_sdm_transaksi_fHRcekup.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_hrmis_sdm_transaksi_fHRcekup.prototype.doRequestReady = function(sender, methodName, result)
{
