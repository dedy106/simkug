window.app_hrmis_sdm_transaksi_fHRrwyprofesi = function(owner)
{
	if (owner)
	{
		window.app_hrmis_sdm_transaksi_fHRrwyprofesi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hrmis_sdm_transaksi_fHRrwyprofesi";
		this.maximize();
...
window.app_hrmis_sdm_transaksi_fHRrwyprofesi.extend(window.portalui_childForm);
window.app_hrmis_sdm_transaksi_fHRrwyprofesi.prototype.sg1init = function(sg)
{
	sg.setColWidth([6,5,4,3,2,1,0],
					[80,220,200,200,80,80,120]);
};
window.app_hrmis_sdm_transaksi_fHRrwyprofesi.prototype.sg1onDblClick = function(sender, col, row)
{
	try
	{		
...
window.app_hrmis_sdm_transaksi_fHRrwyprofesi.prototype.doEditChange = function(sender)
{
...
window.app_hrmis_sdm_transaksi_fHRrwyprofesi.prototype.mainButtonClick = function(sender)
{
...
window.app_hrmis_sdm_transaksi_fHRrwyprofesi.prototype.doModalResult = function(event, modalResult)
{			
	var stsAktif = "0";
...
window.app_hrmis_sdm_transaksi_fHRrwyprofesi.prototype.show2Click = function(sender)
{
	if (this.cb_nik.getText() != "")
	{
		try
...
window.app_hrmis_sdm_transaksi_fHRrwyprofesi.prototype.showClick = function(sender)
{
...
window.app_hrmis_sdm_transaksi_fHRrwyprofesi.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_hrmis_sdm_transaksi_fHRrwyprofesi.prototype.doRequestReady = function(sender, methodName, result)
{
...
window.app_hrmis_sdm_transaksi_fHRrwyprofesi.implement({
	doChange: function(sender){
		if (sender == this.ed_nosk){
			try{
				var data = this.dbLib.getDataProvider("select tgl_sk, tgl_mulai, tgl_berlaku, abs(datediff(now(),tgl_mulai)) as jmlhari  from hr_sk where kode_lokkonsol = '"+this.app._lokKonsol+"' and nik = '"+this.cb_nik.getText()+"' and no_sk ='"+this.ed_nosk.getText()+"' ",true);			
