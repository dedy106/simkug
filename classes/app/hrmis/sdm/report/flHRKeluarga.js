window.GUI_sdm_report_flHRKeluarga = function(owner)
{
	if (owner)
	{
		window.GUI_sdm_report_flHRKeluarga.prototype.parent.constructor.call(this,owner);
		this.className = "GUI_sdm_report_flHRKeluarga";
		this.maximize();
...
window.GUI_sdm_report_flHRKeluarga.extend(window.controls_childForm);

window.GUI_sdm_report_flHRKeluarga.prototype.doEllipseClick= function(sender, col, row)
{
	if (row == 0)
	{
...
window.GUI_sdm_report_flHRKeluarga.prototype.doSelectCell = function(sender, col, row)
{
...
window.GUI_sdm_report_flHRKeluarga.prototype.mainButtonClick = function(sender)
{
	try
	{
	...
	{
		alert("[GUI_sdm_report_flHRKeluarga]::mainButtonClick:"+e);
	}
}

window.GUI_sdm_report_flHRKeluarga.prototype.doRequestReady = function(sender, methodName, result)
{
		switch (methodName)
		{
			case "preview" : 
...
window.GUI_sdm_report_flHRKeluarga.prototype.doSelectedPage = function(sender, page)
{
	this.report.preview("server_report_sdm_rptKeluarga",this.filter, page, 30, this.showFilter, this.app._namalokasi);		
	this.page=page;
}

window.GUI_sdm_report_flHRKeluarga.prototype.doCloseReportClick = function(sender)
{
...
window.GUI_sdm_report_flHRKeluarga.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
