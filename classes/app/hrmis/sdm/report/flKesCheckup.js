window.app_hrmis_sdm_report_flKesCheckup = function(owner)
{
	if (owner)
	{
		window.app_hrmis_sdm_report_flKesCheckup.prototype.parent.constructor.call(this,owner);
		this.className = "app_hrmis_sdm_report_flKesCheckup";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan General Check Up", 2);
...
window.app_hrmis_sdm_report_flKesCheckup.extend(window.portalui_childForm);
window.app_hrmis_sdm_report_flKesCheckup.prototype.doEllipseClick= function(sender, col, row)
{
	if (row == 0)
	{
...
window.app_hrmis_sdm_report_flKesCheckup.prototype.doSelectCell = function(sender, col, row)
{
...
window.app_hrmis_sdm_report_flKesCheckup.prototype.mainButtonClick = function(sender)
{
	try
	{
	...
	{
		alert("[app_hrmis_sdm_report_flKesCheckup]::mainButtonClick:"+e);
	}
};
window.app_hrmis_sdm_report_flKesCheckup.prototype.jenisReport = function(jenis,filter)
{
	try
	{
		...
		var fieldType = new server_util_arrayList();
			...
			var sql = "select a.nik,b.nama,date_format(a.tanggal,'%d/%m/%Y') as tanggal,a.kategori,a.catatan,a.tindak,a.lokasi "+
					  "from hr_cekup a "+
					  "inner join karyawan b on a.nik=b.nik " +this.filter+
					  "order by a.nik ";
			...
			title.add("Tanggal");width.add(50);fieldType.add("S");
			title.add("Kategori");width.add(100);fieldType.add("S");
			title.add("Catatan");width.add(100);fieldType.add("S");
			title.add("Tindak Lanjut");width.add(100);fieldType.add("S");
			title.add("Lokasi Mitra");width.add(100);fieldType.add("S");
	...
	{
		alert("[app_hrmis_sdm_report_flKesCheckup]::jenisReport:"+e);
	}
};
window.app_hrmis_sdm_report_flKesCheckup.prototype.doRequestReady = function(sender, methodName, result)
{
	switch (methodName)
	{
		case "preview" : 
...
window.app_hrmis_sdm_report_flKesCheckup.prototype.doSelectedPage = function(sender, page)
{
...
window.app_hrmis_sdm_report_flKesCheckup.prototype.previewReport = function(dthtml,jenis)
{
...
window.app_hrmis_sdm_report_flKesCheckup.prototype.doCloseReportClick = function(sender)
{
...
window.app_hrmis_sdm_report_flKesCheckup.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_hrmis_sdm_report_flKesCheckup.prototype.doRowPerPageChange = function(sender, rowperpage)
{
