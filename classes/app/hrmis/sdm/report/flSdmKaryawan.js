window.app_hrmis_sdm_report_flSdmKaryawan = function(owner)
{
	if (owner)
	{
		window.app_hrmis_sdm_report_flSdmKaryawan.prototype.parent.constructor.call(this,owner);
		this.className = "app_hrmis_sdm_report_flSdmKaryawan";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,[0,1,2],["NIK Karyawan","All",""]);
	this.gridLib.SGEditData(this.sg1,3,[0,1,2],["Jenis Laporan","=","General"]);
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_hrmis_sdm_report_flSdmKaryawan.extend(window.portalui_childForm);
window.app_hrmis_sdm_report_flSdmKaryawan.prototype.doEllipseClick= function(sender, col, row)
{
	if (row == 0)
	{
...
window.app_hrmis_sdm_report_flSdmKaryawan.prototype.doSelectCell = function(sender, col, row)
{
...
window.app_hrmis_sdm_report_flSdmKaryawan.prototype.mainButtonClick = function(sender)
{
	try
	{
	...
	{
		alert("[app_hrmis_sdm_report_flSdmKaryawan]::mainButtonClick:"+e);
	}
};
window.app_hrmis_sdm_report_flSdmKaryawan.prototype.jenisReport = function(jenis,filter)
{
	try
	{
...
"from karyawan k  "+filter+" order by k.nik ";
		...
		{
			var sql = "select k.nik,k.nama,b.nama as loker,c.nama as uker,k.agama "+
		...
		{
			var sql = "select k.nik,k.nama,b.jenjang,b.jurusan,b.institusi "+
				"from karyawan k left join hr_dinas2 a on k.nik=a.nik and k.kode_lokasi=a.kode_lokasi "+
		...
		{
			var sql = "select k.nik,k.nama,concat(timestampdiff(year,k.tgl_lahir,now()),' thn') as umur, "+
	...
	{
		alert("[app_hrmis_sdm_report_flSdmKaryawan]::jenisReport:"+e);
	}
};
window.app_hrmis_sdm_report_flSdmKaryawan.prototype.doRequestReady = function(sender, methodName, result)
{
	switch (methodName)
	{
		case "preview" : 
...
window.app_hrmis_sdm_report_flSdmKaryawan.prototype.doSelectedPage = function(sender, page)
{
...
window.app_hrmis_sdm_report_flSdmKaryawan.prototype.previewReport = function(dthtml,jenis)
{
...
window.app_hrmis_sdm_report_flSdmKaryawan.prototype.doCloseReportClick = function(sender)
{
...
window.app_hrmis_sdm_report_flSdmKaryawan.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_hrmis_sdm_report_flSdmKaryawan.prototype.doRowPerPageChange = function(sender, rowperpage)
{
