window.app_hrmis_sdm_report_flSdmManPower = function(owner)
{
	if (owner)
	{
		window.app_hrmis_sdm_report_flSdmManPower.prototype.parent.constructor.call(this,owner);
		this.className = "app_hrmis_sdm_report_flSdmManPower";
		this.maximize();
...
window.app_hrmis_sdm_report_flSdmManPower.extend(window.portalui_childForm);
window.app_hrmis_sdm_report_flSdmManPower.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_hrmis_sdm_report_flSdmManPower]::mainButtonClick:"+e);
		}
	},
	...
	getSQL: function(jnsLap,filter,tipe){
		...
		if (jnsLap === "Pribadi"){
			if (tipe === 0){
				...
				"	(select 'Jenis Kelamin' as nmcol1,a.sex as col1,count(a.sex) as col2 "+
				...
				"	group by a.sex) union "+
				"	(select 'Umur' as nmcol1,'20-35' as col1,count(a.tgl_lahir) as col2 "+
				"	from karyawan a left outer join hr_dinas2 b on a.nik=b.nik and a.kode_lokkonsol=b.kode_lokkonsol "+
				"	"+filter+" and abs(cast(datediff (year,a.tgl_lahir,getdate()) as decimal))>19 "+
				"	and abs(cast(datediff (year,a.tgl_lahir,getdate()) as decimal))<36 "+
				"	) union "+
				"	(select 'Umur' as nmcol1,'36-45' as col1,count(a.tgl_lahir) as col2 "+
				"	from karyawan a left outer join hr_dinas2 b on a.nik=b.nik and a.kode_lokkonsol=b.kode_lokkonsol "+
				"	"+filter+" and abs(cast(datediff (year,a.tgl_lahir,getdate()) as decimal))>35 "+
				"	and abs(cast(datediff (year,a.tgl_lahir,getdate()) as decimal))<46 "+
				"	) union "+
				"	(select 'Umur' as nmcol1,'>50' as col1,count(a.tgl_lahir) as col2 "+
				"	from karyawan a left outer join hr_dinas2 b on a.nik=b.nik and a.kode_lokkonsol=b.kode_lokkonsol "+
				"	"+filter+" and abs(cast(datediff (year,a.tgl_lahir,getdate()) as decimal))>49 "+
				"	) union "+
				"	(select 'Masa Kerja' as nmcol1,'<2' as col1,count(*) as col2 "+
				"	from karyawan a left outer join hr_dinas2 b on a.nik=b.nik and a.kode_lokkonsol=b.kode_lokkonsol "+
				"	"+filter+" and abs(cast(datediff (year,a.tgl_masuk,getdate()) as decimal))<2 "+
				"	) union "+
				"	(select 'Masa Kerja' as nmcol1,'2<5' as col1,count(*) as col2 "+
				"	from karyawan a left outer join hr_dinas2 b on a.nik=b.nik and a.kode_lokkonsol=b.kode_lokkonsol "+
				"	"+filter+" and abs(cast(datediff (year,a.tgl_masuk,getdate()) as decimal))>= 2 "+
				"	and abs(cast(datediff (year,a.tgl_masuk,getdate()) as decimal))<6 "+
				"	) union "+
				"	(select 'Masa Kerja' as nmcol1,'6<10' as col1,count(*) as col2 "+
				"	from karyawan a left outer join hr_dinas2 b on a.nik=b.nik and a.kode_lokkonsol=b.kode_lokkonsol "+
				"	"+filter+" and abs(cast(datediff (year,a.tgl_masuk,getdate()) as decimal))>5 "+
				"	and abs(cast(datediff (year,a.tgl_masuk,getdate()) as decimal))<11 "+
				"	) union "+
				"	(select 'Agama' as nmcol1,a.agama as col1,count(*) as col2 "+
				...
				"	(select 'Status Kawin' as nmcol1,a.status as col1,count(*) as col2 "+
				"	from karyawan a left outer join hr_dinas2 b on a.nik=b.nik and a.kode_lokkonsol=b.kode_lokkonsol "+
				...
				"	group by c.institusi,c.jurusan,c.jenjang) "+
				"	) as a";
			}else if (tipe === 1){
				...
				"	(select 'Masa Kerja' as nmcol1,'2<5' as col1,count(*) as col2 "+
				"	from karyawan a left outer join hr_dinas2 b on a.nik=b.nik and a.kode_lokkonsol=b.kode_lokkonsol "+
				"	"+filter+" and abs(cast(datediff (year,a.tgl_masuk,getdate()) as decimal))>1 "+
				"	and abs(cast(datediff (year,a.tgl_masuk,getdate()) as decimal))<6 "+
				"	) union "+
				"	(select 'Masa Kerja' as nmcol1,'6<10' as col1,count(*) as col2 "+
				"	from karyawan a left outer join hr_dinas2 b on a.nik=b.nik and a.kode_lokkonsol=b.kode_lokkonsol "+
