window.app_hrmis_sdm_report_flRekapBKes2 = function(owner)
{
	if (owner)
	{
		window.app_hrmis_sdm_report_flRekapBKes2.prototype.parent.constructor.call(this,owner);
		this.className = "app_hrmis_sdm_report_flRekapBKes2";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,0,[0,1,2],["Kode Lokasi",this.tanda,this.app._lokasi]);
...
window.app_hrmis_sdm_report_flRekapBKes2.extend(window.portalui_childForm);
window.app_hrmis_sdm_report_flRekapBKes2.implement({
	...
	doSelectCell: function(sender, col, row)
	{
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.dbLib.setItemsFromSQL("select distinct nama from kes_klp_provider where kode_lokasi='"+this.app._lokasi+"' ",[this.sg1.columns.get(2).pickList]);
		}
	},
	mainButtonClick: function(sender)
	{
		try
		{
			...
			}else
			{
				...
				this.nama_report="server_report_sdm_rptRekapBKes2";
		...
		{
			alert("[app_hrmis_sdm_report_flRekapBKes2]::mainButtonClick:"+e);
		}
	},
