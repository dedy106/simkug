window.app_hrmis_sdm_report_flSdmLoker = function(owner)
{
	if (owner)
	{
		window.app_hrmis_sdm_report_flSdmLoker.prototype.parent.constructor.call(this,owner);
		this.className = "app_hrmis_sdm_report_flSdmLoker";
		this.maximize();
...
window.app_hrmis_sdm_report_flSdmLoker.extend(window.portalui_childForm);
window.app_hrmis_sdm_report_flSdmLoker.prototype.doEllipseClick= function(sender, col, row)
{
	if (row ==0)
	{
...
window.app_hrmis_sdm_report_flSdmLoker.prototype.doSelectCell = function(sender, col, row)
{
	this.filterRep.setSGFilterRowTipe(this.sg1, row,[0],["123"]);
	this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0],[2]);
};
window.app_hrmis_sdm_report_flSdmLoker.prototype.mainButtonClick = function(sender)
{
	try
	{
	...
	{
		alert("[app_hrmis_sdm_report_flSdmLoker]::mainButtonClick:"+e);
	}
};
window.app_hrmis_sdm_report_flSdmLoker.prototype.doRequestReady = function(sender, methodName, result)
{
	switch (methodName)
	{
		case "preview" : 			
...
window.app_hrmis_sdm_report_flSdmLoker.prototype.doSelectedPage = function(sender, page)
{
	this.report.preview(this.objReport,this.filter, page, this.pager, this.showFilter, this.app._namalokasi);			
	this.page=page;
};
window.app_hrmis_sdm_report_flSdmLoker.prototype.previewReport = function(dthtml)
{
...
window.app_hrmis_sdm_report_flSdmLoker.prototype.doCloseReportClick = function(sender)
{
...
window.app_hrmis_sdm_report_flSdmLoker.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_hrmis_sdm_report_flSdmLoker.prototype.doRowPerPageChange = function(sender, rowperpage)
{
