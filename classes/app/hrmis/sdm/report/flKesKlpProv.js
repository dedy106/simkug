window.app_hrmis_sdm_report_flKesKlpProv = function(owner)
{
	if (owner)
	{
		window.app_hrmis_sdm_report_flKesKlpProv.prototype.parent.constructor.call(this,owner);
		this.className = "app_hrmis_sdm_report_flKesKlpProv";
		this.maximize();		
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Kelompok Provider", 2);
...
window.app_hrmis_sdm_report_flKesKlpProv.extend(window.portalui_childForm);
window.app_hrmis_sdm_report_flKesKlpProv.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			}else
			{
				...
				var sql = "select kode_klp,nama from kes_klp_provider "+this.filter;
				this.scriptSqlCount = "select count(kode_klp) from kes_klp_provider "+this.filter;
				
				this.title = new server_util_arrayList({items:["Kode Provider","Nama Provider"]});
			...
			systemAPI.alert("[app_hrmis_sdm_report_flKesKlpProv]::mainButtonClick:"+e);
		}
	},
	...
	previewReport: function(dthtml){
		var header = "LAPORAN KELOMPOK PROVIDER";
