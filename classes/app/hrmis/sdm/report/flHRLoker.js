window.GUI_sdm_report_flHRLoker = function(owner)
{
	if (owner)
	{
		window.GUI_sdm_report_flHRLoker.prototype.parent.constructor.call(this,owner);
		this.className = "GUI_sdm_report_flHRLoker";
		this.maximize();
...
window.GUI_sdm_report_flHRLoker.extend(window.controls_childForm);

window.GUI_sdm_report_flHRLoker.prototype.doEllipseClick= function(sender, col, row)
{
		if (row == 0)
		{
...
window.GUI_sdm_report_flHRLoker.prototype.doSelectCell = function(sender, col, row)
{
	if (this.userStatus=="A")
	{
...
window.GUI_sdm_report_flHRLoker.prototype.mainButtonClick = function(sender)
{
	try
	{
	...
	{
		alert("[GUI_sdm_report_flHRLoker]::mainButtonClick:"+e);
	}
}

window.GUI_sdm_report_flHRLoker.prototype.doRequestReady = function(sender, methodName, result)
{
		switch (methodName)
		{
			case "preview" : 
...
window.GUI_sdm_report_flHRLoker.prototype.doSelectedPage = function(sender, page)
{
...
window.GUI_sdm_report_flHRLoker.prototype.previewReport = function(dthtml)
{
...
window.GUI_sdm_report_flHRLoker.prototype.doCloseReportClick = function(sender)
{
...
window.GUI_sdm_report_flHRLoker.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
