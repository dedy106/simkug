window.app_hrmis_sdm_report_flSdmJabatan = function(owner)
{
	if (owner)
	{
		window.app_hrmis_sdm_report_flSdmJabatan.prototype.parent.constructor.call(this,owner);
		this.className = "app_hrmis_sdm_report_flSdmJabatan";
		this.maximize();
...
window.app_hrmis_sdm_report_flSdmJabatan.extend(window.portalui_childForm);
window.app_hrmis_sdm_report_flSdmJabatan.prototype.doEllipseClick= function(sender, col, row)
{
	if (row ==0)
	{
...
window.app_hrmis_sdm_report_flSdmJabatan.prototype.doSelectCell = function(sender, col, row)
{
	this.filterRep.setSGFilterRowTipe(this.sg1, row,[0],["123"]);
	this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0],[2]);
};
window.app_hrmis_sdm_report_flSdmJabatan.prototype.mainButtonClick = function(sender)
{
	try
	{
	...
	{
		alert("[app_hrmis_sdm_report_flSdmJabatan]::mainButtonClick:"+e);
	}
};
window.app_hrmis_sdm_report_flSdmJabatan.prototype.doRequestReady = function(sender, methodName, result)
{
	switch (methodName)
	{
		case "preview" : 
...
window.app_hrmis_sdm_report_flSdmJabatan.prototype.doSelectedPage = function(sender, page)
{
	var dthtml = this.dbLib.sqlToHtml(this.sqlScript,page,this.pager, this.title, this.widthTable, this.fieldType,false);			
	this.previewReport(dthtml);			
	this.page=page;
};
window.app_hrmis_sdm_report_flSdmJabatan.prototype.previewReport = function(dthtml)
{
...
window.app_hrmis_sdm_report_flSdmJabatan.prototype.doCloseReportClick = function(sender)
{
...
window.app_hrmis_sdm_report_flSdmJabatan.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_hrmis_sdm_report_flSdmJabatan.prototype.doRowPerPageChange = function(sender, rowperpage)
{
