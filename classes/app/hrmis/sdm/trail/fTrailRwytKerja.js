window.app_hrmis_sdm_trail_fTrailRwytKerja = function(owner)
{
	try
	{
		if (owner)
		{
			window.app_hrmis_sdm_trail_fTrailRwytKerja.prototype.parent.constructor.call(this, owner);
			this.className = "app_hrmis_sdm_trail_fTrailRwytKerja";			
			this.maximize();
	...
	{
		alert("[app_hrmis_sdm_trail_fTrailRwytKerja]::contructor: "+e);
	}
};
window.app_hrmis_sdm_trail_fTrailRwytKerja.extend(window.portalui_childForm);
window.app_hrmis_sdm_trail_fTrailRwytKerja.prototype.doEllipseClick= function(sender, col, row)
{
	if (row == 0)
	{
...
window.app_hrmis_sdm_trail_fTrailRwytKerja.prototype.doSelectCell = function(sender, col, row)
{
	if (this.userStatus=="A")
	{
...
window.app_hrmis_sdm_trail_fTrailRwytKerja.prototype.execTrail = function(kode)
{
	try
	{
	...
	{
		alert("[app_hrmis_sdm_trail_fTrailRwytKerja]::execTrail:"+e);
	}
};
window.app_hrmis_sdm_trail_fTrailRwytKerja.prototype.mainButtonClick = function(sender)
{
	try
	{
	...
	{
		alert("[app_hrmis_sdm_trail_fTrailRwytKerja]::mainButtonClick:"+e);
	}
};
window.app_hrmis_sdm_trail_fTrailRwytKerja.prototype.createPanelRwyt = function()
{
...
window.app_hrmis_sdm_trail_fTrailRwytKerja.prototype.mgOnExpand = function(sender)
{
