window.app_hrmis_referensi_report_flCust = function(owner)
{
	if (owner)
	{
		window.app_hrmis_referensi_report_flCust.prototype.parent.constructor.call(this,owner);
		this.className = "app_hrmis_referensi_report_flCust";
		this.maximize();
...
window.app_hrmis_referensi_report_flCust.extend(window.portalui_childForm);
window.app_hrmis_referensi_report_flCust.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				var sql = "select v.kode_cust,v.kode_lokasi,v.nama,v.alamat,v.kota,v.kode_pos,v.no_telp,v.no_fax,v.npwp,v.pic,k.nama "+
			...
			systemAPI.alert("[app_hrmis_referensi_report_flCust]::mainButtonClick:"+e);
		}
	},
