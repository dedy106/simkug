window.app_hrmis_referensi_report_flBank = function(owner)
{
	if (owner)
	{
		window.app_hrmis_referensi_report_flBank.prototype.parent.constructor.call(this,owner);
		this.className = "app_hrmis_referensi_report_flBank";
		this.maximize();
...
window.app_hrmis_referensi_report_flBank.extend(window.portalui_childForm);
window.app_hrmis_referensi_report_flBank.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_hrmis_referensi_report_flBank]::mainButtonClick:"+e);
		}
	},
