window.app_hrmis_referensi_transaksi_fSpro = function(owner)
{
	if (owner)
	{
		window.app_hrmis_referensi_transaksi_fSpro.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hrmis_referensi_transaksi_fSpro";
		this.setTop(60);
		this.setWidth(1280);
		this.setHeight(550);
...
window.app_hrmis_referensi_transaksi_fSpro.extend(window.portalui_childForm);
window.app_hrmis_referensi_transaksi_fSpro.prototype.mainButtonClick = function(sender){
...
window.app_hrmis_referensi_transaksi_fSpro.prototype.doModalResult = function(event, modalResult)
{
	switch (event)
	{
		case "clear" :
...
window.app_hrmis_referensi_transaksi_fSpro.prototype.doRequestReady = function(sender, methodName, result)
{
