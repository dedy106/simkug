window.app_hrmis_referensi_transaksi_fCurr = function(owner)
{
	if (owner)
	{
		window.app_hrmis_referensi_transaksi_fCurr.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hrmis_referensi_transaksi_fCurr";
		this.setTop(60);
		this.setWidth(1280);
		this.setHeight(550);
...
window.app_hrmis_referensi_transaksi_fCurr.extend(window.portalui_childForm);
window.app_hrmis_referensi_transaksi_fCurr.prototype.mainButtonClick = function(sender)
{
...
window.app_hrmis_referensi_transaksi_fCurr.prototype.doModalResult = function(event, modalResult)
{
	switch (event)
	{
		case "clear" :
...
window.app_hrmis_referensi_transaksi_fCurr.prototype.showClick = function(sender)
{
	try 
	{
...
window.app_hrmis_referensi_transaksi_fCurr.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_hrmis_referensi_transaksi_fCurr.prototype.doRequestReady = function(sender, methodName, result)
{
