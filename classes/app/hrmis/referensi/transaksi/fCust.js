window.app_hrmis_referensi_transaksi_fCust = function(owner)
{
	if (owner)
	{
		window.app_hrmis_referensi_transaksi_fCust.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hrmis_referensi_transaksi_fCust";
		this.maximize();
...
window.app_hrmis_referensi_transaksi_fCust.extend(window.portalui_childForm);
window.app_hrmis_referensi_transaksi_fCust.prototype.mainButtonClick = function(sender){
...
window.app_hrmis_referensi_transaksi_fCust.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.app_hrmis_referensi_transaksi_fCust.prototype.showClick = function(sender)
{
...
window.app_hrmis_referensi_transaksi_fCust.prototype.FindBtnClick = function(sender, event){
	try
	{
...
window.app_hrmis_referensi_transaksi_fCust.prototype.doRequestReady = function(sender, methodName, result)
{
