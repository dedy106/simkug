window.app_hrmis_referensi_transaksi_fBank2 = function(owner)
{
	if (owner)
	{
		window.app_hrmis_referensi_transaksi_fBank2.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hrmis_referensi_transaksi_fBank2";
		this.setTop(60);
		this.setWidth(1280);
		this.setHeight(550);
...
window.app_hrmis_referensi_transaksi_fBank2.extend(window.portalui_childForm);
window.app_hrmis_referensi_transaksi_fBank2.prototype.mainButtonClick = function(sender)
{
...
window.app_hrmis_referensi_transaksi_fBank2.prototype.doModalResult = function(event, modalResult)
{
	switch (event)
	{
		case "clear" :
...
window.app_hrmis_referensi_transaksi_fBank2.prototype.showClick = function(sender)
{
	try 
	{
...
window.app_hrmis_referensi_transaksi_fBank2.prototype.FindBtnClick = function(sender, event)
{
	try
	{
		...
		if (sender == this.cb_akun) 
		{
		    this.standarLib.showListData(this, "Daftar Akun KasBank",this.cb_akun,undefined, 
										  "select a.kode_akun, a.nama from masakun a inner join flag_relasi b on a.kode_akun=b.kode_akun where a.block= '0' and b.kode_flag in ('001','009') and a.kode_lokasi ='"+this.cb_lokasi.getText()+"'",
										  "select count(a.kode_akun)  from masakun a inner join flag_relasi b on a.kode_akun=b.kode_akun where a.block= '0' and b.kode_flag in ('001','009') and a.kode_lokasi ='"+this.cb_lokasi.getText()+"'",
...
window.app_hrmis_referensi_transaksi_fBank2.prototype.doRequestReady = function(sender, methodName, result)
{
