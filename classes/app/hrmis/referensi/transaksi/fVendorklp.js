window.app_hrmis_referensi_transaksi_fVendorklp = function(owner){
	if (owner)
	{
		window.app_hrmis_referensi_transaksi_fVendorklp.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hrmis_referensi_transaksi_fVendorklp";
		this.maximize();
...
window.app_hrmis_referensi_transaksi_fVendorklp.extend(window.portalui_childForm);
window.app_hrmis_referensi_transaksi_fVendorklp.prototype.mainButtonClick = function(sender){
...
window.app_hrmis_referensi_transaksi_fVendorklp.prototype.doModalResult = function(event, modalResult){	
	switch (event)
	{
		case "clear" :
			if (modalResult == mrOk)
...
window.app_hrmis_referensi_transaksi_fVendorklp.prototype.showClick = function(sender){
...
window.app_hrmis_referensi_transaksi_fVendorklp.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_hrmis_referensi_transaksi_fVendorklp.prototype.doRequestReady = function(sender, methodName, result)
{
