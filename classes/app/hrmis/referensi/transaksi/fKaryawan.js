window.app_hrmis_referensi_transaksi_fKaryawan = function(owner)
{
	if (owner)
	{
		window.app_hrmis_referensi_transaksi_fKaryawan.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hrmis_referensi_transaksi_fKaryawan";
		this.maximize();
...
window.app_hrmis_referensi_transaksi_fKaryawan.extend(window.portalui_childForm);
window.app_hrmis_referensi_transaksi_fKaryawan.prototype.mainButtonClick = function(sender)
{
...
window.app_hrmis_referensi_transaksi_fKaryawan.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.app_hrmis_referensi_transaksi_fKaryawan.prototype.showClick = function(sender)
{
...
window.app_hrmis_referensi_transaksi_fKaryawan.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_hrmis_referensi_transaksi_fKaryawan.prototype.doRequestReady = function(sender, methodName, result)
{
