...
//* 			SAI, PT											
//***********************************************************************************************
window.app_hrmis_fKlpAkses = function(owner){
	if (owner){
		try{
			window.app_hrmis_fKlpAkses.prototype.parent.constructor.call(this, owner);
			this.className = "app_hrmis_fKlpAkses";
		...
		{
			systemAPI.alert("[app_hrmis_fKlpAkses]::constructor:"+e);
		}
		
		this.setTabChildIndex();
	}
};
window.app_hrmis_fKlpAkses.extend(window.portalui_childForm);
window.app_hrmis_fKlpAkses.implement({
