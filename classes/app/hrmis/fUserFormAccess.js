window.app_hrmis_fUserFormAccess = function(owner)
{
	if (owner)
	{
		window.app_hrmis_fUserFormAccess.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hrmis_fUserFormAccess";
		this.maximize();
...
window.app_hrmis_fUserFormAccess.extend(window.portalui_childForm);
window.app_hrmis_fUserFormAccess.implement({
