...
//* 			SAI, PT											
//***********************************************************************************************
window.app_hrmis_fMain = function(owner)
{
	if (owner)
	{	
		try
		{
			window.app_hrmis_fMain.prototype.parent.constructor.call(this, owner);
			window.app_hrmis_fMain.prototype.parent.setWidth.call(this, 600);
			window.app_hrmis_fMain.prototype.parent.setHeight.call(this, 450);
...
window.app_hrmis_fMain.extend(window.portalui_form);
window.app_hrmis_fMain.implement({	
	gotoLogin: function(){
		uses("app_hrmis_fLogin");
		this.form = new app_hrmis_fLogin(this);
	...
	bTutupClick: function(sender){	
		try{
			if ((sender == this.bTutup)||(sender == this.bExit) && this.activeChildForm) //this.activeChildForm.free();
			...
			switch(kodeForm){
				...
				default :
					...
					{				    						
						...
						eval(script);									
					}else throw("Data form tidak ditemukan.("+temp+")");
					break;
			}
