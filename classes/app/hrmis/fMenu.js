...
//* 			SAI, PT											
//***********************************************************************************************
window.app_hrmis_fMenu = function(owner){
	if (owner){
		try{
			window.app_hrmis_fMenu.prototype.parent.constructor.call(this, owner);
			this.className = "app_hrmis_fMenu";
...
window.app_hrmis_fMenu.extend(window.portalui_childForm);
window.app_hrmis_fMenu.implement({
	...
	entriesClick: function(sender){
		try{
			uses("app_hrmis_fMenuDetail");	
			if (this.entryMenu !== undefined) this.entryMenu.free();
			this.entryMenu = new app_hrmis_fMenuDetail(this.app);
