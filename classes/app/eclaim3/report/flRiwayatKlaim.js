// JavaScript Document
window.app_eclaim3_report_flRiwayatKlaim = function(owner)
{
	if (owner)
	{
		window.app_eclaim3_report_flRiwayatKlaim.prototype.parent.constructor.call(this,owner);
		this.className = "app_eclaim3_report_flRiwayatKlaim";
		this.maximize();
...
window.app_eclaim3_report_flRiwayatKlaim.extend(window.portalui_childForm);
window.app_eclaim3_report_flRiwayatKlaim.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_eclaim3_rptRwyKlaimSum";
