// JavaScript Document
window.app_eclaim3_report_flLapAwal = function(owner)
{
	if (owner)
	{
		window.app_eclaim3_report_flLapAwal.prototype.parent.constructor.call(this,owner);
		this.className = "app_eclaim3_report_flLapAwal";
		this.maximize();
...
window.app_eclaim3_report_flLapAwal.extend(window.portalui_childForm);
window.app_eclaim3_report_flLapAwal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_eclaim3_rptLapAwal";
