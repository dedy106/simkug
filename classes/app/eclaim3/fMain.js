...
//* 			SAI, PT											
//***********************************************************************************************
window.app_eclaim3_fMain = function(owner)
{
	if (owner)
	{	
		try
		{
			window.app_eclaim3_fMain.prototype.parent.constructor.call(this, owner);			
...
window.app_eclaim3_fMain.extend(window.form);
window.app_eclaim3_fMain.implement({
	gotoLogin: function(){
		uses("app_eclaim3_fLogin");
		this.form = new app_eclaim3_fLogin(this);
	...
	initDashboard: function(){		
		uses("saiCBBL;saiEdit;saiGrid;;util_ajaxCaller;sgNavigator;pageControl;app_eclaim3_dashboard;fileExplorer;listView;util_file;PopUpMenu;MenuItem;app_eclaim3_remote_dataProvider");
		this.dashboard = new app_eclaim3_dashboard(this,{bound:[this.treev.width + 20, this.treev.top, this.width - this.treev.width - 30, this.treev.height]});		
	},
	...
	bTutupClick: function(sender){	
		try{
			if (this.form instanceof app_eclaim3_fLogin && sender == this.bExit){
				return false;
			}			
