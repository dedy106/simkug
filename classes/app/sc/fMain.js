...
//* 			SAI, PT											
//***********************************************************************************************
window.app_sc_fMain = function(owner)
{
	if (owner)
	{	
		try
		{
			window.app_sc_fMain.prototype.parent.constructor.call(this, owner);			
...
window.app_sc_fMain.extend(window.form);
window.app_sc_fMain.implement({
	gotoLogin: function(){
		uses("app_sc_fLogin");
		this.form = new app_sc_fLogin(this);
	...
	initDashboard: function(){		
		uses("saiCBBL;saiEdit;saiGrid;;util_ajaxCaller;sgNavigator;pageControl;app_sc_dashboard;fileExplorer;listView;util_file;PopUpMenu;MenuItem;app_sc_remote_dataProvider");
		this.dashboard = new app_sc_dashboard(this,{bound:[this.treev.width + 20, this.treev.top, this.width - this.treev.width - 30, this.treev.height]});		
	},
