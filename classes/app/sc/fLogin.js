...
//* 			SAI, PT											
//***********************************************************************************************
window.app_sc_fLogin = function(owner){
	if (owner){
		try{		
			window.app_sc_fLogin.prototype.parent.constructor.call(this, owner);
			this.className  = "app_sc_fLogin";			
			...
			systemAPI.alert("[app_sc_fLogin]::oncreate lib : ",e);
		}
	}
};
window.app_sc_fLogin.extend(window.childForm);
window.app_sc_fLogin.implement({
