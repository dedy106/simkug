sc.app_saku2_fUser = function(owner)
{
	if (owner)
	{
		sc.app_saku2_fUser.prototype.parent.constructor.call(this,owner);
...
sc.app_saku2_fUser.extend(sc.childForm);
sc.app_saku2_fUser.implement({
