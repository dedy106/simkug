window.app_sc_report_flPesan = function(owner)
{
	if (owner)
	{
		window.app_sc_report_flPesan.prototype.parent.constructor.call(this,owner);
		this.className = "app_sc_report_flPesan";
		this.maximize();
...
window.app_sc_report_flPesan.extend(window.childForm);
window.app_sc_report_flPesan.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_sc_rptPesan";
			...
			systemAPI.alert("[app_sc_report_flPesan]::mainButtonClick:"+e);
		}
	},
