...
//* 			SAI, PT											
//***********************************************************************************************
window.app_dmt_fMain = function(owner)
{
	if (owner)
	{	
		try
		{
			window.app_dmt_fMain.prototype.parent.constructor.call(this, owner);			
...
window.app_dmt_fMain.extend(window.form);
window.app_dmt_fMain.implement({
	gotoLogin: function(){
		uses("app_dmt_fLogin");
		this.form = new app_dmt_fLogin(this);
	...
	initDashboard: function(){		
		uses("saiCBBL;saiEdit;saiGrid;;util_ajaxCaller;sgNavigator;pageControl;app_dmt_dashboard;fileExplorer;listView;util_file;PopUpMenu;MenuItem;app_dmt_remote_dataProvider");
		this.dashboard = new app_dmt_dashboard(this,{bound:[this.treev.width + 20, this.treev.top, this.width - this.treev.width - 30, this.treev.height]});		
	},
