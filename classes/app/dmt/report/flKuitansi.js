window.app_dmt_report_flKuitansi = function(owner)
{
	if (owner)
	{
		window.app_dmt_report_flKuitansi.prototype.parent.constructor.call(this,owner);
		this.className = "app_dmt_report_flKuitansi";
		this.maximize();		
...
window.app_dmt_report_flKuitansi.extend(window.portalui_childForm);
window.app_dmt_report_flKuitansi.implement({
	...
	mainButtonClick: function(sender)
	{
		try
		{
			...
			}else
			{
				...
				this.nama_report="server_report_dmt_rptKuitansi";
		...
		{
			alert("[app_dmt_report_flKuitansi]::mainButtonClick:"+e);
		}
	},
