window.app_dmt_report_flTerimaPpn = function(owner)
{
	if (owner)
	{
		window.app_dmt_report_flTerimaPpn.prototype.parent.constructor.call(this,owner);
		this.className = "app_dmt_report_flTerimaPpn";
		this.maximize();		
...
window.app_dmt_report_flTerimaPpn.extend(window.portalui_childForm);
window.app_dmt_report_flTerimaPpn.implement({
	...
	mainButtonClick: function(sender)
	{
		...
		{
			alert("[app_dmt_report_flTerimaPpn]::mainButtonClick:"+e);
		}
	},
