window.app_dmt_report_flFormInvoice = function(owner)
{
	if (owner)
	{
		window.app_dmt_report_flFormInvoice.prototype.parent.constructor.call(this,owner);
		this.className = "app_dmt_report_flFormInvoice";
		this.maximize();		
...
window.app_dmt_report_flFormInvoice.extend(window.portalui_childForm);
window.app_dmt_report_flFormInvoice.implement({
	...
	mainButtonClick: function(sender)
	{
		try
		{
			...
			}else
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							this.filterRep.filterStr("a.no_ar",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4),"and");
				if (this.sg1.getCell(2,5)=="Versi 1")
				{
					this.nama_report="server_report_dmt_rptFormInvoice1";
				}
				else
				{
					this.nama_report="server_report_dmt_rptFormInvoice2";
				}
		...
		{
			alert("[app_dmt_report_flFormInvoice]::mainButtonClick:"+e);
		}
	},
