window.app_dmt_report_flFaktur = function(owner)
{
	if (owner)
	{
		window.app_dmt_report_flFaktur.prototype.parent.constructor.call(this,owner);
		this.className = "app_dmt_report_flFaktur";
		this.maximize();		
	...
	this.gridLib.SGEditData(this.sg1,5,[0,1,2],["Lembar","=","Lembar 1"]);
	this.pager = 1;
};
window.app_dmt_report_flFaktur.extend(window.portalui_childForm);
window.app_dmt_report_flFaktur.implement({
	...
	doSelectCell: function(sender, col, row)
	{
		...
		if (row === 5)
		{
			...
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,["Lembar 1","Lembar 2","Lembar 3","Lembar 4"]);
		}
	},
	mainButtonClick: function(sender)
	{
		try
		{
			...
			}else
			{
				...
				this.nama_report="server_report_dmt_rptFaktur";
		...
		{
			alert("[app_dmt_report_flFaktur]::mainButtonClick:"+e);
		}
	},
