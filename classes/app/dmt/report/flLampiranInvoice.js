window.app_dmt_report_flLampiranInvoice = function(owner)
{
	if (owner)
	{
		window.app_dmt_report_flLampiranInvoice.prototype.parent.constructor.call(this,owner);
		this.className = "app_dmt_report_flLampiranInvoice";
		this.maximize();		
...
window.app_dmt_report_flLampiranInvoice.extend(window.portalui_childForm);
window.app_dmt_report_flLampiranInvoice.implement({
	...
	mainButtonClick: function(sender)
	{
		...
		{
			alert("[app_dmt_report_flLampiranInvoice]::mainButtonClick:"+e);
		}
	},
