window.app_dmt_report_flAmor = function(owner)
{
	if (owner)
	{
		window.app_dmt_report_flAmor.prototype.parent.constructor.call(this,owner);
		this.className = "app_dmt_report_flAmor";
		this.maximize();		
	...
	this.periode=this.dbLib.getPeriodeFromSQL("select max(periode) as periode from dmt_akru_m where kode_lokasi ='"+this.app._lokasi+"' and modul='AMOR'");
...
window.app_dmt_report_flAmor.extend(window.portalui_childForm);
window.app_dmt_report_flAmor.implement({
		...
		if (row == 4)
		{
			this.standar.ListDataSGFilter2(this, "Data Invoice",this.sg1, this.sg1.row, this.sg1.col,
										  ...
										  this.filterRep.filterStr("no_kontrak",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and")+
											this.filterRep.filterStr("periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+	
										  " and kode_lokasi = '"+this.sg1.getCell(2,0)+"' and modul='AMOR'",
	...
	doSelectCell: function(sender, col, row)
	{
		...
		if (row === 1){
			this.dbLib.setItemsFromSQL("select distinct periode from dmt_akru_m where kode_lokasi = '"+this.sg1.getCell(2,0)+"' and modul='AMOR' ",[this.sg1.columns.get(2).pickList]);
		}
		if (row === 5)
		{
	...
	mainButtonClick: function(sender)
	{
		try
		{
			...
			}else
			{
		    	...
		    	this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							...
							" and a.modul='AMOR'";
				this.nama_report="server_report_dmt_rptBilling";
		...
		{
			alert("[app_dmt_report_flAmor]::mainButtonClick:"+e);
		}
	},
