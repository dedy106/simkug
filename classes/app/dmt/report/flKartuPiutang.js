window.app_dmt_report_flKartuPiutang = function(owner)
{
	if (owner)
	{
		window.app_dmt_report_flKartuPiutang.prototype.parent.constructor.call(this,owner);
		this.className = "app_dmt_report_flKartuPiutang";
		this.maximize();		
...
window.app_dmt_report_flKartuPiutang.extend(window.portalui_childForm);
window.app_dmt_report_flKartuPiutang.implement({
	...
	mainButtonClick: function(sender)
	{
		try
		{
			...
			}else
			{
				...
				this.nama_report="server_report_dmt_rptKartuPiutang";
				this.filter2 = this.sg1.getCell(2,1)+"/"+this.filterRep.filterStr("periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+"/"+
							   this.filterRep.filterStr("a.kode_cust",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"where");
		...
		{
			alert("[app_dmt_report_flKartuPiutang]::mainButtonClick:"+e);
		}
	},
