...
//* 			SAI, PT											
//***********************************************************************************************
window.app_frontend_kopeg_fLogin = function(owner){
	try{
		if (owner)
		{
			window.app_frontend_kopeg_fLogin.prototype.parent.constructor.call(this, owner);
			window.app_frontend_kopeg_fLogin.prototype.parent.setBorder.call(this, 0);		
			window.app_frontend_kopeg_fLogin.prototype.parent.setColor.call(this, "");		
			this.className = "app_frontend_kopeg_fLogin";											
			this.initComponent();		
		}
	}catch(e)
	{
		systemAPI.alert("[app_frontend_kopeg_fLogin]::contruct:"+e,"");
	}
};
window.app_frontend_kopeg_fLogin.extend(window.portalui_panel);
window.app_frontend_kopeg_fLogin.implement({
