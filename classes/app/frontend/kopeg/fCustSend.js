...
//* 			SAI, PT											
//***********************************************************************************************
window.app_frontend_kopeg_fCustSend = function(owner){
	try{
		if (owner)
		{
			window.app_frontend_kopeg_fCustSend.prototype.parent.constructor.call(this, owner);
			window.app_frontend_kopeg_fCustSend.prototype.parent.setBorder.call(this, 0);		
			window.app_frontend_kopeg_fCustSend.prototype.parent.setColor.call(this, "");		
			this.className = "app_frontend_kopeg_fCustSend";											
			this.initComponent();		
			this.title = "Kirim Pesan";
		}
	}catch(e)
	{
		systemAPI.alert("[app_frontend_kopeg_fCustSend]::contruct:"+e,"");
	}
};
window.app_frontend_kopeg_fCustSend.extend(window.portalui_panel);
window.app_frontend_kopeg_fCustSend.implement({
