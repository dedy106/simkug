...
//* 			SAI, PT											
//***********************************************************************************************
window.app_frontend_kopeg_fUsaha = function(owner){
	try{
		if (owner)
		{
			window.app_frontend_kopeg_fUsaha.prototype.parent.constructor.call(this, owner);
			window.app_frontend_kopeg_fUsaha.prototype.parent.setBorder.call(this, 0);		
			window.app_frontend_kopeg_fUsaha.prototype.parent.setColor.call(this, "");		
			this.className = "app_frontend_kopeg_fUsaha";											
			this.initComponent();		
			this.title = "Unit Usaha";
		}
	}catch(e)
	{
		systemAPI.alert("[app_frontend_kopeg_fUsaha]::contruct:"+e,"");
	}
};
window.app_frontend_kopeg_fUsaha.extend(window.portalui_panel);
window.app_frontend_kopeg_fUsaha.implement({
