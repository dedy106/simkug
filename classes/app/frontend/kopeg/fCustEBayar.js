...
//* 			SAI, PT											
//***********************************************************************************************
window.app_frontend_kopeg_fCustEBayar = function(owner){
	try{
		if (owner)
		{
			window.app_frontend_kopeg_fCustEBayar.prototype.parent.constructor.call(this, owner);
			window.app_frontend_kopeg_fCustEBayar.prototype.parent.setBorder.call(this, 0);		
			window.app_frontend_kopeg_fCustEBayar.prototype.parent.setColor.call(this, "");		
			this.className = "app_frontend_kopeg_fCustEBayar";											
			this.initComponent();		
			this.title = "Edit Pembayaran";
		}
	}catch(e)
	{
		systemAPI.alert("[app_frontend_kopeg_fCustEBayar]::contruct:"+e,"");
	}
};
window.app_frontend_kopeg_fCustEBayar.extend(window.portalui_panel);
window.app_frontend_kopeg_fCustEBayar.implement({
