...
//* 			SAI, PT											
//***********************************************************************************************
window.app_frontend_kopeg_fCustEPesan = function(owner){
	try{
		if (owner)
		{
			window.app_frontend_kopeg_fCustEPesan.prototype.parent.constructor.call(this, owner);
			window.app_frontend_kopeg_fCustEPesan.prototype.parent.setBorder.call(this, 0);		
			window.app_frontend_kopeg_fCustEPesan.prototype.parent.setColor.call(this, "");		
			this.className = "app_frontend_kopeg_fCustEPesan";											
			this.initComponent();		
			this.title = "Edit Pemesanan";
		}
	}catch(e)
	{
		systemAPI.alert("[app_frontend_kopeg_fCustEPesan]::contruct:"+e,"");
	}
};
window.app_frontend_kopeg_fCustEPesan.extend(window.portalui_panel);
window.app_frontend_kopeg_fCustEPesan.implement({
