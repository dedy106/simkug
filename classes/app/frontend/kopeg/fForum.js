...
//* 			SAI, PT											
//***********************************************************************************************
window.app_frontend_kopeg_fForum = function(owner){
	try{
		if (owner)
		{
			window.app_frontend_kopeg_fForum.prototype.parent.constructor.call(this, owner);
			window.app_frontend_kopeg_fForum.prototype.parent.setBorder.call(this, 0);		
			window.app_frontend_kopeg_fForum.prototype.parent.setColor.call(this, "");		
			this.className = "app_frontend_kopeg_fForum";											
			this.initComponent();		
			this.title = "Unit Pinjaman";
		}
	}catch(e)
	{
		systemAPI.alert("[app_frontend_kopeg_fForum]::contruct:"+e,"");
	}
};
window.app_frontend_kopeg_fForum.extend(window.portalui_panel);
window.app_frontend_kopeg_fForum.implement({
			...
			if (typeof(data)=="object"){
				if (data.rs.rows[0] != undefined){
					...
					{						
						...
						post.setCaption("by <a href='#' onclick='return window.app_frontend_kopeg_transaksi_fTabForum.userklik=true;' style='color:#aa0000;'>"+line.nik_buat+"</a> >> "+line.tgljam);
						post.fnt.setSize(8);
						...
						last.setCaption("by <a href='#' onclick='return window.app_frontend_kopeg_transaksi_fTabForum.userklik=true;' style='color:#aa0000;'>"+line.nik_buat+"</a><br>"+line.lastpost);
						last.fnt.setSize(8);
						last.setColor("#655d9f");
	...
	doUserClick: function(gettag){
		...
		{
			system.alert(this,"app_frontend_kopeg_transaksi_fTabForum::doUserClick : "+e,"");
		}
	},
	...
	doPager: function(sender,pageid){
		try{
			...
			systemAPI.alert("app_frontend_kopeg_transaksi_fTabForum.prototype.doPager"+e);
		}
	},
	...
	showPost: function(data,pageid){
		...
		{			
			...
			if (typeof data == "object"){
				if (data.rs.rows[0] != undefined){										
					...
					for (var i in data.rs.rows){
						...
						post2.setCaption("<a href='#' onclick='return window.app_frontend_kopeg_transaksi_fTabForum.userklik=true;' style='color:#aa0000;'>"+line.nik_buat+"</a>");
						post2.fnt.setSize(8);
			...
			system.alert(this,"app_frontend_kopeg_transaksi_fTabForum::showPost : "+e,"");
		}
	},
	...
	doBtnEdit : function(sender){
		...
		{
			system.alert(this,"app_frontend_kopeg_transaksi_fTabForum::doBtnEdit : "+e,"");
		}
	},
	doBtnClick: function(sender){
		...
		{
			system.alert(this,"app_frontend_kopeg_transaksi_fTabForum::doBtnClick : "+e,"");
		}
	},
