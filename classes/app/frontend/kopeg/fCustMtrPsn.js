...
//* 			SAI, PT											
//***********************************************************************************************
window.app_frontend_kopeg_fCustMtrPsn = function(owner){
	try{
		if (owner)
		{
			window.app_frontend_kopeg_fCustMtrPsn.prototype.parent.constructor.call(this, owner);
			window.app_frontend_kopeg_fCustMtrPsn.prototype.parent.setBorder.call(this, 0);		
			window.app_frontend_kopeg_fCustMtrPsn.prototype.parent.setColor.call(this, "");		
			this.className = "app_frontend_kopeg_fCustMtrPsn";											
			this.initComponent();		
			this.title = "Monitoring Pemesanan";
		}
	}catch(e)
	{
		systemAPI.alert("[app_frontend_kopeg_fCustMtrPsn]::contruct:"+e,"");
	}
};
window.app_frontend_kopeg_fCustMtrPsn.extend(window.portalui_panel);
window.app_frontend_kopeg_fCustMtrPsn.implement({
