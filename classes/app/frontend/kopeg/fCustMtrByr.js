...
//* 			SAI, PT											
//***********************************************************************************************
window.app_frontend_kopeg_fCustMtrByr = function(owner){
	try{
		if (owner)
		{
			window.app_frontend_kopeg_fCustMtrByr.prototype.parent.constructor.call(this, owner);
			window.app_frontend_kopeg_fCustMtrByr.prototype.parent.setBorder.call(this, 0);		
			window.app_frontend_kopeg_fCustMtrByr.prototype.parent.setColor.call(this, "");		
			this.className = "app_frontend_kopeg_fCustMtrByr";											
			this.initComponent();		
			this.title = "Monitoring Pembayaran";
		}
	}catch(e)
	{
		systemAPI.alert("[app_frontend_kopeg_fCustMtrByr]::contruct:"+e,"");
	}
};
window.app_frontend_kopeg_fCustMtrByr.extend(window.portalui_panel);
window.app_frontend_kopeg_fCustMtrByr.implement({
