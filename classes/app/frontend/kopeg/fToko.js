...
//* 			SAI, PT											
//***********************************************************************************************
window.app_frontend_kopeg_fToko = function(owner){
	try{
		if (owner)
		{
			window.app_frontend_kopeg_fToko.prototype.parent.constructor.call(this, owner);
			window.app_frontend_kopeg_fToko.prototype.parent.setBorder.call(this, 0);		
			window.app_frontend_kopeg_fToko.prototype.parent.setColor.call(this, "");		
			this.className = "app_frontend_kopeg_fToko";											
			this.initComponent();		
		}
	}catch(e)
	{
		systemAPI.alert("[app_frontend_kopeg_fToko]::contruct:"+e,"");
	}
};
window.app_frontend_kopeg_fToko.extend(window.portalui_panel);
window.app_frontend_kopeg_fToko.implement({
	...
	doCheckOut : function(sender){
		try{
			...
			systemAPI.alert("app_frontend_kopeg_transaksi_fTabToko::doCheckOut "+e);
		}
	},
