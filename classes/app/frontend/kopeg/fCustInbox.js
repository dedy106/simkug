...
//* 			SAI, PT											
//***********************************************************************************************
window.app_frontend_kopeg_fCustInbox = function(owner){
	try{
		if (owner)
		{
			window.app_frontend_kopeg_fCustInbox.prototype.parent.constructor.call(this, owner);
			window.app_frontend_kopeg_fCustInbox.prototype.parent.setBorder.call(this, 0);		
			window.app_frontend_kopeg_fCustInbox.prototype.parent.setColor.call(this, "");		
			this.className = "app_frontend_kopeg_fCustInbox";											
			this.initComponent();		
			this.title = "Inbox";
		}
	}catch(e)
	{
		systemAPI.alert("[app_frontend_kopeg_fCustInbox]::contruct:"+e,"");
	}
};
window.app_frontend_kopeg_fCustInbox.extend(window.portalui_panel);
window.app_frontend_kopeg_fCustInbox.implement({
