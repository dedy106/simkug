...
window.app_frontend_alpa_fMember.implement({
		...
		try{
			...
			{	
                if (item === undefined || item.img == "isClassName"){
                    ...
                    this.detail.fade(); 
                    this.detail.getClientCanvas().style.top = 35;
                    var id = className;
	...
	initMenu: function(userInfo){
        ...
        for (var i=0;i < (userInfo.status == "anggota" ? 11:12) ;i++) img[img.length] = "isClassName";
        for (var i=0;i < (userInfo.status == "anggota" ? 11:12) ;i++) shortDesc[shortDesc.length] = "";
	   ...
	   if (userInfo.status == "anggota"){	        
            ...
            title[title.length] = "Berita";id[id.length] = "app_frontend_alpa_fCustPHT";    
       }else{            
	        title[title.length] = "Point Sales";id[id.length] = "app_frontend_alpa_fPointSales";	        	        
	        title[title.length] = "Stock";id[id.length] = "app_frontend_alpa_fStock";	        
	        title[title.length] = "Info Produk";id[id.length] = "app_frontend_alpa_fProdukInfo";	        
       }
    ...
    deinit: function(){        
       ...
       if (this.defaultMenu === undefined){
          ...
          this.doChildItemsClick(this.profile,this.defaultMenu.id[0],this.profile.items.more[0].item);				
       }
    },
