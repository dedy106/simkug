window.app_mede_report_flPo = function(owner)
{
	if (owner)
	{
		window.app_mede_report_flPo.prototype.parent.constructor.call(this,owner);
		this.className = "app_mede_report_flPo";
		this.maximize();		
...
window.app_mede_report_flPo.extend(window.portalui_childForm);
window.app_mede_report_flPo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_mede_report_flPo]::mainButtonClick:"+e);
		}
	},
