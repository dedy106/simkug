window.app_mede_report_flPRequisition = function(owner)
{
	if (owner)
	{
		window.app_mede_report_flPRequisition.prototype.parent.constructor.call(this,owner);
		this.className = "app_mede_report_flPRequisition";
		this.maximize();
		this.app._mainForm.childFormConfig(this,"mainButtonClick","Laporan Purchase Requisition",2);
...
window.app_mede_report_flPRequisition.extend(window.portalui_childForm);
window.app_mede_report_flPRequisition.implement({
	...
	mainButtonClick: function(sender)
	{
		try
		{
			...
			}else
			{
				...
				this.nama_report="server_report_trisha_rptPRequisition";
		...
		{
			alert("[app_mede_report_flPRequisition]::mainButtonClick:"+e);
		}
	},
