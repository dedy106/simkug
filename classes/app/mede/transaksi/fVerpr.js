window.app_mede_transaksi_fVerpr = function(owner)
{
	if (owner)
	{
		window.app_mede_transaksi_fVerpr.prototype.parent.constructor.call(this,owner);
		this.className  = "app_mede_transaksi_fVerpr";
		this.maximize();
		...
		this.cb_pembuat = new portalui_saiCBBL(this,{bound:[20,100,185,20],caption:"Dibuat Oleh"});
		...
		this.sg1 = new portalui_saiGrid(this.p1,{bound:[1,20,895,165],colCount:11,colTitle:["Status","Catatan","No PR","No Dokumen","RKM","PP","Tanggal","Deskripsi","Currency","Nilai","Pembuat"],
		...
		this.sgNav =  new portalui_sgNavigator(this,{bound:[623,120,297,25],grid:this.sg,border:0,buttonStyle:3});
...
window.app_mede_transaksi_fVerpr.extend(window.portalui_childForm);
window.app_mede_transaksi_fVerpr.implement({
