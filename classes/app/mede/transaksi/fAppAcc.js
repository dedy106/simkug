window.app_mede_transaksi_fAppAcc = function(owner)
{
	if (owner)
	{
		window.app_mede_transaksi_fAppAcc.prototype.parent.constructor.call(this,owner);
		this.className  = "app_mede_transaksi_fAppAcc";
		this.maximize();
		this.itemsValue = new portalui_arrayList();	
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Approval Accounting: Input", 0);	
...
window.app_mede_transaksi_fAppAcc.extend(window.portalui_childForm);
window.app_mede_transaksi_fAppAcc.implement({});
