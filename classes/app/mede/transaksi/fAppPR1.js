window.app_mede_transaksi_fAppPR1 = function(owner)
{
	if (owner)
	{
		window.app_mede_transaksi_fAppPR1.prototype.parent.constructor.call(this,owner);
		this.className  = "app_mede_transaksi_fAppPR1";
		this.maximize();
		this.itemsValue = new portalui_arrayList();	
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Approve PR dan Justifikasi(VP): Input", 0);	
		...
		this.cb_setuju = new portalui_saiCBBL(this,{bound:[20,121,185,20],caption:"Disetujui VP",readOnly:true});		
		this.cb_setuju2 = new portalui_saiCBBL(this,{bound:[20,122,185,20],caption:"Disetujui Dir",readOnly:true});		
...
window.app_mede_transaksi_fAppPR1.extend(window.portalui_childForm);
window.app_mede_transaksi_fAppPR1.implement({
			...
			try
			{
				...
				sql.add("insert into doc_verpr_m (no_ver,kode_lokasi,keterangan,tanggal,periode,no_del,nik_buat,nik_app,nik_user,tgl_input,nilai) values "+
						"       ('"+this.ed_nb.getText()+"','"+this.app._lokasi+"','"+this.ed_desc.getText()+"','"+this.dp_tgl1.getDate()+"',"+
								"'"+this.ed_period.getText()+"','-','"+this.cb_setuju.getText()+"','"+this.cb_setuju2.getText()+
