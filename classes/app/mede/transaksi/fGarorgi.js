window.app_mede_transaksi_fGarorgi = function(owner)
{  
	if (owner)
	{
		window.app_mede_transaksi_fGarorgi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_mede_transaksi_fGarorgi";
		this.maximize();
		this.itemsValue = new portalui_arrayList();	
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Upload Anggaran: Input", 0);	
		
		this.ed_period = new portalui_saiLabelEdit(this,{bound:[20,10,182,20],caption:"Tahun Anggaran",readOnly:true});
		this.lblTgl1 = new portalui_label(this,{bound:[20,32,101,20],caption:"Tgl Anggaran",underline:true});
		uses("portalui_datePicker");	
		this.dp_tgl1 = new portalui_datePicker(this,{bound:[120,34,82,18]});
		this.ed_nb = new portalui_saiLabelEdit(this,{bound:[20,54,230,20],caption:"No Bukti", readOnly:true});
		...
		this.uploader.setParam3("kode_akun;nama_akun;kode_cc;nama_cc;kode_drk;nama_drk;periode;nilai");
		...
		this.sg1.setColTitle(new Array("Kode Akun","Nama Akun","Cost Center","Nama Cost Center","Kode DRK","Nama DRK","Periode","Nilai Satuan"));
		this.sg1.setColWidth(new Array(7,6,5,4,3,2,1,0),new Array(100,50,120,80,120,80,120,60));	
...
window.app_mede_transaksi_fGarorgi.extend(window.portalui_childForm);
window.app_mede_transaksi_fGarorgi.prototype.doSelect = function(sender, year, month, day)
{
	if (month < 10)
		month = "0"+month;
	this.ed_period.setText(year.toString());
};
window.app_mede_transaksi_fGarorgi.prototype.mainButtonClick = function(sender)
{
...
window.app_mede_transaksi_fGarorgi.prototype.simpan = function()
{	
	try
	{
...
window.app_mede_transaksi_fGarorgi.prototype.doModalResult = function(event, modalResult)
{
...
window.app_mede_transaksi_fGarorgi.prototype.genClick = function(sender)
{
	try
	{
...
window.app_mede_transaksi_fGarorgi.prototype.doEditChange = function(sender)
{
...
window.app_mede_transaksi_fGarorgi.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_mede_transaksi_fGarorgi.prototype.doFindBtnClick = function(sender, col, row) 
{
	try
	{
		switch(col)
	...
	{
		alert("[app_mede_transaksi_fGarorgi] : doFindBtnClick : " + e);
	}
};
window.app_mede_transaksi_fGarorgi.prototype.doNilaiChange = function()
{
	try
	{
	...
	{
		alert("[app_mede_transaksi_fGarorgi]::doNilaiChange:"+e);
	}
};
window.app_mede_transaksi_fGarorgi.prototype.doCellExit = function()
{
	this.sg1.validasi();
};
window.app_mede_transaksi_fGarorgi.prototype.doRequestReady = function(sender, methodName, result)
{
...
window.app_mede_transaksi_fGarorgi.prototype.doAfterLoad = function(sender, result,data)
{
	try{	
		if (result){			
...
window.app_mede_transaksi_fGarorgi.prototype.doLoadData = function(data, page)
{
	var rs, arr;
	this.sg1.clear();		
...
window.app_mede_transaksi_fGarorgi.prototype.doSelectedPage = function(sender, page)
{
