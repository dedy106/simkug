window.app_mede_transaksi_fKB = function(owner)
{
	if (owner)
	{
		window.app_mede_transaksi_fKB.prototype.parent.constructor.call(this,owner);
		this.className  = "app_mede_transaksi_fKB";
		this.maximize();
		...
		this.e_nilai = new portalui_saiLabelEdit(this,{bound:[610,28,200,20],caption:"Total Tagihan",tipeText:ttNilai,alignment:alLeft, readOnly:true, text: "0"});
		this.cb_pph = new portalui_saiCBBL(this,{bound:[20,29,200,20],caption:"Akun PPh",btnClick:[this,"doBtnClick"],readOnly: true, tag:9});		
		this.e_kas = new portalui_saiLabelEdit(this,{bound:[610,29,200,20],caption:"Total KasBank",tipeText:ttNilai,alignment:alLeft, readOnly:true, text: "0"});
		this.cb_cust = new portalui_saiCBBL(this,{bound:[20,26,200,20],caption:"Vendor",btnClick:[this,"doBtnClick"],readOnly: true});				
		this.bLoad = new portalui_imageButton(this,{bound:[270,26,22,22],click:[this,"doLoadClick"],hint:"Search",image:"icon/"+system.getThemes()+"/reload.png",visible:false});
		this.i_viewer = new portalui_imageButton(this,{bound:[810,26,20,20],hint:"Tampil Jurnal",image:"icon/"+system.getThemes()+"/tabCont2.png",click:[this,"doClick"]});				
		this.e_pph = new portalui_saiLabelEdit(this,{bound:[610,26,200,20],caption:"Nilai PPh",tipeText:ttNilai,alignment:alLeft,change :[this,"doChange"]});
		
		this.p1 = new portalui_panel(this,{bound:[20,30,810,290],caption:"Data Invoice"});
		this.sg = new portalui_saiGrid(this.p1,{bound:[0,20,810,265],colCount:7,colTitle:["No Invoice","Tanggal","Keterangan","Akun AP","Nama Akun","Sisa Tagihan","Nilai Bayar"],
		...
		this.cb_kontrak = new portalui_saiCBBL(this,{bound:[20,27,250,20],caption:"No Kontrak",btnClick:[this,"doBtnClick"],readOnly: true,rightLabelVisible:false, visible:false});		
...
window.app_mede_transaksi_fKB.extend(window.portalui_childForm);
window.app_mede_transaksi_fKB.implement({
