window.app_mede_transaksi_fAP = function(owner)
{
	if (owner)
	{
		window.app_mede_transaksi_fAP.prototype.parent.constructor.call(this,owner);
		this.className  = "app_mede_transaksi_fAP";
		this.maximize();
		this.itemsValue = new portalui_arrayList();	
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Jurnal Hutang: Input", 0);	
		...
		this.ed_nb = new portalui_saiLabelEdit(this,{bound:[20,56,220,20],caption:"No Bukti",readOnly:true});
		...
		this.bShow = new portalui_button(this,{bound:[546,122,80,20],caption:"Tampil"});		
		this.p1 = new portalui_panel(this,{bound:[20,144,900,330],caption:"Daftar Invoice"});		
		this.sg1 = new portalui_saiGrid(this.p1,{bound:[1,20,895,165],colCount:10,colTitle:["Approve","No Invoice","Vendor","Tanggal","Tgl Jth Tempo","Deskripsi","Currency","Nilai","PPN","Pnj"],
			colWidth:[[9,8,7,6,5,4,3,2,1,0],[100,60,200,80,80,100,100,100,200,60]],
			readOnly:true,colFormat:[[7,8],[cfNilai]]});						
		this.sg1.columns.get(0).setPicklist(new portalui_arrayMap({items:["APP","NONAPP","INPROG"]}))		
		this.sg2 = new portalui_saiGrid(this.p1,{bound:[1,190,895,135],colCount:9,colTitle:["No","Kode Akun","Nama Akun","DC","Keterangan","Nilai","Kode PP","Nama PP","Kode RKM","Nama RKM"],
			colWidth:[[8,7,6,5,4,3,2,1,0],[100,60,200,80,80,100,100,100,200]],
			readOnly:true,colFormat:[[7,8],[cfNilai]]});								
...
window.app_mede_transaksi_fAP.extend(window.portalui_childForm);
window.app_mede_transaksi_fAP.implement({
