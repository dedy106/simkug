window.app_mede_transaksi_fDownloadPO = function(owner)
{
	if (owner)
	{
		window.app_mede_transaksi_fDownloadPO.prototype.parent.constructor.call(this,owner);
		this.className  = "app_mede_transaksi_fDownloadPO";
		this.maximize();
		this.itemsValue = new portalui_arrayList();	
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Retreive PO: Input", 0);	
		...
		this.ed_nb = new portalui_saiLabelEdit(this,{bound:[20,56,220,20],caption:"No Download",readOnly:true});
		...
		this.sg1 = new portalui_saiGrid(this.p1,{bound:[1,20,895,165],colCount:10,colTitle:["No PO","No Dokumen","Vendor","Tgl Mulai","Tgl Selesai","Deskripsi","Currency","Nilai","PPN","Pnj"],
...
window.app_mede_transaksi_fDownloadPO.extend(window.portalui_childForm);
window.app_mede_transaksi_fDownloadPO.implement({
