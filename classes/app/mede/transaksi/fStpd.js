window.app_mede_transaksi_fStpd = function(owner)
{
	if (owner)
	{
		window.app_mede_transaksi_fStpd.prototype.parent.constructor.call(this,owner);
		this.className  = "app_mede_transaksi_fStpd";
		this.maximize();
		this.itemsValue = new portalui_arrayList();	
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form STPD: Input", 0);	
		...
		this.l_tgl = new portalui_label(this,{bound:[20,11,100,18],caption:"Tanggal Berangkat",underline:true});
		this.dp_tgl2 = new portalui_datePicker(this,{bound:[120,11,80,18]});
		this.l_tgl = new portalui_label(this,{bound:[20,12,100,18],caption:"Tanggal Pulang",underline:true});
		this.dp_tgl3 = new portalui_datePicker(this,{bound:[120,12,80,18]});
...
window.app_mede_transaksi_fStpd.extend(window.portalui_childForm);
window.app_mede_transaksi_fStpd.implement({});
