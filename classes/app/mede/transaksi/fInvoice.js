window.app_mede_transaksi_fInvoice = function(owner)
{
	if (owner)
	{
		window.app_mede_transaksi_fInvoice.prototype.parent.constructor.call(this,owner);
		this.className  = "app_mede_transaksi_fInvoice";
		this.maximize();
		this.itemsValue = new portalui_arrayList();	
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Invoice Vendor : Input", 0);	
		...
		this.ed_nb = new portalui_saiLabelEdit(this,{bound:[20,76,220,20],caption:"No Invoice",readOnly:true});
		...
		this.ed_ref2 = new portalui_saiLabelEdit(this,{bound:[20,120,300,20],caption:"Dok. Invoice",maxLength:50});
		...
		this.cb_po = new portalui_saiCBBL(this,{bound:[20,1,220,20],caption:"No PO",readOnly:true, rightLabelVisible:false});
		...
		this.cb_akun = new portalui_saiCBBL(this,{bound:[20,212,185,20],caption:"Akun ADP/UM",readOnly:true});
		this.cb_pph = new portalui_saiCBBL(this,{bound:[20,256,185,20],caption:"Akun PPh",readOnly:true});
		...
		this.ed_total = new portalui_saiLabelEdit(this,{bound:[315, 410,200,20],caption:"Total Tagihan",tipeText:ttNilai, alignment:alRight, tag:1, text:"0"});
...
window.app_mede_transaksi_fInvoice.extend(window.portalui_childForm);
window.app_mede_transaksi_fInvoice.implement({
