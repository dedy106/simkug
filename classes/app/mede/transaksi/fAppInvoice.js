window.app_mede_transaksi_fAppInvoice = function(owner)
{
	if (owner)
	{
		window.app_mede_transaksi_fAppInvoice.prototype.parent.constructor.call(this,owner);
		this.className  = "app_mede_transaksi_fAppInvoice";
		this.maximize();
		this.itemsValue = new portalui_arrayList();	
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Approve Invoice: Input", 0);	
		...
		this.sg1 = new portalui_saiGrid(this.p1,{bound:[1,20,895,165],colCount:10,colTitle:["APP","No Invoice","Vendor","Tanggal","Tgl Jth Tempo","Deskripsi","Currency","Nilai","PPN","Pnj"],
		...
		this.sg2 = new portalui_saiTable(this.p1,{bound:[1,190,895,135],tag:2,colTitle:["No","No PO","Tgl Mulai","Tgl Selesai","Deskripsi","Currency","Nilai","PPN","Pnj"]});
...
window.app_mede_transaksi_fAppInvoice.extend(window.portalui_childForm);
window.app_mede_transaksi_fAppInvoice.implement({
