window.app_mede_transaksi_fGardis = function(owner)
{  
	if (owner)
	{
		window.app_mede_transaksi_fGardis.prototype.parent.constructor.call(this,owner);
		this.className  = "app_mede_transaksi_fGardis";
		this.maximize();
		...
		this.cb_pp.setCaption("Cost Center");
		...
		this.cb_drk.setCaption("Data DRK");
		...
		this.cb_pp2.setCaption("Cost Center");
		...
		this.cb_drk2.setCaption("Data DRK");
		...
		this.sg1.setColTitle(new Array("Akun Asal","Cost Center Asal","DRK Asal","Bulan Asal","Nilai","Akun Tuj","Cost Center Tuj","DRK Tuj","Bulan Tuj"));
...
window.app_mede_transaksi_fGardis.extend(window.portalui_childForm);
window.app_mede_transaksi_fGardis.prototype.doSelect = function(sender, year, month, day)
{
	if (month < 10)
		month = "0"+month;
	this.ed_period.setText(year.toString());
};
window.app_mede_transaksi_fGardis.prototype.mainButtonClick = function(sender)
{
...
window.app_mede_transaksi_fGardis.prototype.simpan = function()
{	
	try
	{
...
window.app_mede_transaksi_fGardis.prototype.doModalResult = function(event, modalResult)
{
...
window.app_mede_transaksi_fGardis.prototype.genClick = function(sender)
{
	try
	{
...
window.app_mede_transaksi_fGardis.prototype.doEditChange = function(sender)
{
...
window.app_mede_transaksi_fGardis.prototype.showClick = function(sender)
{
...
window.app_mede_transaksi_fGardis.prototype.okClick = function(sender)
{
...
window.app_mede_transaksi_fGardis.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_mede_transaksi_fGardis.prototype.doNilaiChange = function()
{
	try
	{
		var tot = 0;
	...
	{
		alert("[app_mede_transaksi_fGardis]::doNilaiChange:"+e);
	}
};
window.app_mede_transaksi_fGardis.prototype.doRequestReady = function(sender, methodName, result)
{
...
window.app_mede_transaksi_fGardis.prototype.doAfterLoad = function(sender, result,data)
{
	try{	
		if (result){				
			var rs, arr;
