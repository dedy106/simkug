window.app_budget_master_fFlagakun = function(owner)
{
	if (owner)
	{
		window.app_budget_master_fFlagakun.prototype.parent.constructor.call(this,owner);
		this.className  = "app_budget_master_fFlagakun";
		this.setTop(60);
		this.setWidth(1280);
		this.setHeight(550);
...
window.app_budget_master_fFlagakun.extend(window.portalui_childForm);
window.app_budget_master_fFlagakun.prototype.mainButtonClick = function(sender)
{
...
window.app_budget_master_fFlagakun.prototype.doModalResult = function(event, modalResult)
{
	switch (event)
	{
		case "clear" :
...
window.app_budget_master_fFlagakun.prototype.showClick = function(sender)
{
	try 
	{
...
window.app_budget_master_fFlagakun.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_budget_master_fFlagakun.prototype.doRequestReady = function(sender, methodName, result)
{
