window.app_budget_master_fNeracaCfDetail = function(owner,modul)
{
	if (owner)
	{
		window.app_budget_master_fNeracaCfDetail.prototype.parent.constructor.call(this, owner);
		window.app_budget_master_fNeracaCfDetail.prototype.parent.setWidth.call(this, 300);
		window.app_budget_master_fNeracaCfDetail.prototype.parent.setHeight.call(this, 400);
		
		this.centerize();
		
		this.className = "app_budget_master_fNeracaCfDetail";
...
window.app_budget_master_fNeracaCfDetail.extend(window.portalui_commonForm);
window.app_budget_master_fNeracaCfDetail.prototype.doDraw = function(canvas)
{
...
window.app_budget_master_fNeracaCfDetail.prototype.doAfterResize = function(event)
{
	this.p1.setWidth(this.width - 40);
...
window.app_budget_master_fNeracaCfDetail.prototype.doSysMouseDown = function(x, y, button, buttonState)
{	
	window.app_budget_master_fNeracaCfDetail.prototype.parent.doSysMouseDown.call(this,x, y, button, buttonState);
};
window.app_budget_master_fNeracaCfDetail.prototype.doSysMouseUp = function(x, y, button, buttonState)
{	
	window.app_budget_master_fNeracaCfDetail.prototype.parent.doSysMouseUp.call(this,x, y, button, buttonState);
};
window.app_budget_master_fNeracaCfDetail.prototype.doSysMouseMove = function(x, y, button, buttonState)
{
	window.app_budget_master_fNeracaCfDetail.prototype.parent.doSysMouseMove.call(this,x, y, button, buttonState);
	if (this.isClick)
	{		
...
window.app_budget_master_fNeracaCfDetail.prototype.eventMouseDown = function(event)
{
...
window.app_budget_master_fNeracaCfDetail.prototype.eventMouseUp = function(event)
{
	this.isClick = false;
	this.blockElm.style.display = "none";
	this.frameElm.style.display = "";
};
window.app_budget_master_fNeracaCfDetail.prototype.eventMouseMove = function(event)
{
	if (this.isClick)
	{
		var x = event.clientX;
...
window.app_budget_master_fNeracaCfDetail.prototype.doClick = function(sender)
{
	if (sender == this.b1){
		try{
...
window.app_budget_master_fNeracaCfDetail.prototype.doRequestReady = function(sender, methodName, result)
{
};
window.app_budget_master_fNeracaCfDetail.prototype.findBtnClick = function(sender)
{
};
//--------------------------------------------
window.app_budget_master_fNeracaCfDetail.prototype.setCaption = function(data)
{
...
window.app_budget_master_fNeracaCfDetail.prototype.setItemParent = function(data)
{
	this.itemParent = data;
};
window.app_budget_master_fNeracaCfDetail.prototype.setSummaryItems = function(data)
{
	this.e4.clearItem();
	for (var i in data)
		this.e4.addItem(i, data[i]);	
};
window.app_budget_master_fNeracaCfDetail.prototype.doClose = function(sender)
{
	system.delMouseListener(this);
};
window.app_budget_master_fNeracaCfDetail.prototype.setModul = function(modul)
{
    this.e5.clearItem();
