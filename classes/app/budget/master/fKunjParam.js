 ...
 * @author dweexfuad
 */
window.app_budget_master_fKunjParam = function(owner)
{
	if (owner)
	{
		window.app_budget_master_fKunjParam.prototype.parent.constructor.call(this,owner);
		this.className  = "app_budget_master_fKunjParam";
		this.setTop(60);
		this.setWidth(1280);
		this.setHeight(550);
...
window.app_budget_master_fKunjParam.extend(window.portalui_childForm);
//------------------------------------------------------------------ event
window.app_budget_master_fKunjParam.implement({
	...
	doTampilClick: function(sender){
		try{			
			var temp = this.dbLib.runSQL("select b.nama as jenis,a.kode_param,a.nama,a.akun_tpkk,c.nama as nama_tpkk "+
										"from agg_kunj_param a "+
										"inner join agg_kunj_jenis b on a.kode_jenis=b.kode_jenis "+
										"left join masakun c on a.akun_tpkk=c.kode_akun and a.kode_lokasi=c.kode_lokasi ");
