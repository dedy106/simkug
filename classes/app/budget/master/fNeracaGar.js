window.app_budget_master_fNeracaGar = function(owner)
{
	if (owner)
	{
		window.app_budget_master_fNeracaGar.prototype.parent.constructor.call(this, owner);
		this.className = "app_budget_master_fNeracaGar";
...
window.app_budget_master_fNeracaGar.extend(window.portalui_childForm);
window.app_budget_master_fNeracaGar.implement({
