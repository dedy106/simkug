window.app_budget_master_fFSGar = function(owner)
{
	if (owner)
	{
		window.app_budget_master_fFSGar.prototype.parent.constructor.call(this,owner);
		this.className  = "app_budget_master_fFSGar";
		this.setTop(60);
		this.setWidth(1280);
		this.setHeight(550);
...
window.app_budget_master_fFSGar.extend(window.portalui_childForm);
//------------------------------------------------------------------ event
window.app_budget_master_fFSGar.implement({
