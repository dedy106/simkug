window.app_budget_master_fLokasi = function(owner){
	if (owner){
		window.app_budget_master_fLokasi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_budget_master_fLokasi";
		this.setTop(60);
		this.setWidth(1280); 
		this.setHeight(550);
...
window.app_budget_master_fLokasi.extend(window.portalui_childForm);
window.app_budget_master_fLokasi.implement({
