window.app_saku_anggaran_transaksi_fGarorgi = function(owner)
{  
	if (owner)
	{
		window.app_saku_anggaran_transaksi_fGarorgi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_anggaran_transaksi_fGarorgi";
		this.maximize();
		this.itemsValue = new portalui_arrayList();	
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Data Anggaran Original: Input", 0);	
		...
		this.uploader.setParam3("kode_akun;nama_akun;kode_dept;nama_dept;kode_rkm;nama_rkm;periode;volume;satuan;nilai");
...
window.app_saku_anggaran_transaksi_fGarorgi.extend(window.portalui_childForm);
window.app_saku_anggaran_transaksi_fGarorgi.prototype.doSelect = function(sender, year, month, day)
{
	if (month < 10)
		month = "0"+month;
	this.ed_period.setText(year.toString());
};
window.app_saku_anggaran_transaksi_fGarorgi.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_anggaran_transaksi_fGarorgi.prototype.simpan = function()
{	
	try
	{
...
window.app_saku_anggaran_transaksi_fGarorgi.prototype.doModalResult = function(event, modalResult)
{
...
window.app_saku_anggaran_transaksi_fGarorgi.prototype.genClick = function(sender)
{
	try
	{
...
window.app_saku_anggaran_transaksi_fGarorgi.prototype.doEditChange = function(sender)
{
...
window.app_saku_anggaran_transaksi_fGarorgi.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_saku_anggaran_transaksi_fGarorgi.prototype.doFindBtnClick = function(sender, col, row) 
{
	try
	{
		switch(col)
	...
	{
		alert("[app_saku_anggaran_transaksi_fGarorgi] : doFindBtnClick : " + e);
	}
};
window.app_saku_anggaran_transaksi_fGarorgi.prototype.doNilaiChange = function()
{
	try
	{
	...
	{
		alert("[app_saku_anggaran_transaksi_fGarorgi]::doNilaiChange:"+e);
	}
};
window.app_saku_anggaran_transaksi_fGarorgi.prototype.doCellExit = function()
{
	this.sg1.validasi();
};
window.app_saku_anggaran_transaksi_fGarorgi.prototype.doRequestReady = function(sender, methodName, result)
{
...
window.app_saku_anggaran_transaksi_fGarorgi.prototype.doAfterLoad = function(sender, result,data)
{
	try{	
		if (result){			
...
window.app_saku_anggaran_transaksi_fGarorgi.prototype.doLoadData = function(data, page)
{
	var rs, arr;
	this.sg1.clear();		
...
window.app_saku_anggaran_transaksi_fGarorgi.prototype.doSelectedPage = function(sender, page)
{
