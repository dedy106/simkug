 ...
 * @author dweexfuad
 */
window.app_budget_transaksi_fKunjBp = function(owner)
{
	if (owner)
	{
		window.app_budget_transaksi_fKunjBp.prototype.parent.constructor.call(this,owner);
		this.className  = "app_budget_transaksi_fKunjBp";
		this.setTop(60);
		this.setWidth(1280);
		this.setHeight(550);
		this.itemsValue = new portalui_arrayList();
		
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Biaya Pengobatan", 0);	
...
window.app_budget_transaksi_fKunjBp.extend(window.portalui_childForm);
//------------------------------------------------------------------ event
window.app_budget_transaksi_fKunjBp.implement({
