...
window.app_saku_gaji_transaksi_fGajiAll.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_gaji_transaksi_fGajiAll.prototype.doSelect = function(sender, year, month, day)
{
	if (month < 10)
		month = "0"+month;
	this.ed_period.setText(year.toString()+month);		
};
window.app_saku_gaji_transaksi_fGajiAll.prototype.genClick = function(sender)
{
	try
	{
...
window.app_saku_gaji_transaksi_fGajiAll.prototype.simpan = function()
{
	this.bGen.click();
...
window.app_saku_gaji_transaksi_fGajiAll.prototype.doModalResult = function(event, modalResult)
{			
...
window.app_saku_gaji_transaksi_fGajiAll.prototype.showClick = function(sender)
{		
		...
		try
		{
			if (this.cb_nik.getText() != "")
			{
				var line,data = runArraySQL("select a.nik, ifnull(a.jml,0) as jml "+
								...
								"select datediff(now(),tgl_lahir) as jmlhari,status,nik "+
									"from karyawan where kode_lokkonsol = '"+this.lokkonsol+"'\r\n"+
								"select a.kode_loker2,b.nama as nama_loker,a.nik "+
								...
								"select concat(a.kode_pp,' - ',b.nama)as nama_pp,a.alamat,a.grade, a.nik "+
									" from karyawan a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
									" where a.kode_lokasi='"+this.app._lokasi+"' \r\n"+
								"select kode_param, nik, ifnull(nilai,0) as nilai, nik "+
								...
								"select a.kode_param, a.value1, a.value2, a.nik "+
...
window.app_saku_gaji_transaksi_fGajiAll.prototype.hitungClick = function(sender)
{	
...
window.app_saku_gaji_transaksi_fGajiAll.prototype.doEditChange = function(sender)
{
...
window.app_saku_gaji_transaksi_fGajiAll.prototype.FindBtnClick = function(sender, event)
{
	try
	{
		if (sender == this.cb_nik) 
...
window.app_saku_gaji_transaksi_fGajiAll.prototype.doChange = function(sender, col, row) 
{
	try
	{
		switch(col)
...
window.app_saku_gaji_transaksi_fGajiAll.prototype.doChange2 = function(sender, col, row) 
{
	try
	{
		switch(col)
...
window.app_saku_gaji_transaksi_fGajiAll.prototype.doNilaiChange = function()
{
	try
	{
		this.sg1.onChange.set(undefined, undefined);
...
window.app_saku_gaji_transaksi_fGajiAll.prototype.doNilaiChange2 = function()
{
	try
	{
		var tot = 0; 
...
window.app_saku_gaji_transaksi_fGajiAll.prototype.doRequestReady = function(sender, methodName, result)
{
...
window.app_saku_gaji_transaksi_fGajiAll.prototype.loadParam = function(){	
	try{
...
window.app_saku_gaji_transaksi_fGajiAll.prototype.getDplkUsia = function(usia){
	var line;
...
window.app_saku_gaji_transaksi_fGajiAll.prototype.getDplkTingkat = function(tingkat){
	var line;
...
window.app_saku_gaji_transaksi_fGajiAll.prototype.getTunjProf = function(kdProf, pddk){
	var line;
...
window.app_saku_gaji_transaksi_fGajiAll.prototype.getTunjJabs = function(kdJabs, kdJabf){
	var line;
...
window.app_saku_gaji_transaksi_fGajiAll.prototype.getTunjJabf = function(kdJabf, pddk){
	var line;
...
window.app_saku_gaji_transaksi_fGajiAll.prototype.getTunjJabatanStruk= function(){
	try{
		var tjabs2 = 0;
...
window.app_saku_gaji_transaksi_fGajiAll.prototype.getTunjJabatanFung= function(){
	var tjabf;
	if (this.kodejabf == "-"){
	  tjabf = 0;
	}else{	
...
window.app_saku_gaji_transaksi_fGajiAll.prototype.getTunjProfesi= function(){
	var tprof = 0;
	if (this.kodestspeg == "1")
	{		
		if (this.kodeprof == "-")
...
window.app_saku_gaji_transaksi_fGajiAll.prototype.getTunjParam= function(kode){
...
window.app_saku_gaji_transaksi_fGajiAll.prototype.hitungPPh= function(){
	try{
		var rowPPh;
		var totbln = 0;
...
window.app_saku_gaji_transaksi_fGajiAll.prototype.getDataKontrak = function(kode){
