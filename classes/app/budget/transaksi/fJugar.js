window.app_budget_transaksi_fJugar = function(owner)
{
	if (owner)
	{
		window.app_budget_transaksi_fJugar.prototype.parent.constructor.call(this,owner);
		this.className  = "app_budget_transaksi_fJugar";
		this.maximize();
		this.itemsValue = new portalui_arrayList();	
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Jurnal Estimasi Anggaran: Input", 0);			
		...
		this.cb_jenis.addItem(0,"ESTIMASI");
		...
		{		    
			...
			this.cb_jenis.setText("ESTIMASI");
...
window.app_budget_transaksi_fJugar.extend(window.portalui_childForm);
window.app_budget_transaksi_fJugar.implement({
	...
	doFindBtnClick: function(sender, col, row) {
		...
		{
			systemAPI.alert("[app_budget_transaksi_fJugar] : doFindBtnClick : " + e);
		}
	},
	doNilaiChange: function(){
		...
		{
			alert("[app_budget_transaksi_fJugar]::doNilaiChange:"+e);
		}
	},
