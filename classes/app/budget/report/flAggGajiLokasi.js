window.app_budget_report_flAggGajiLokasi = function(owner)
{
	
	try{
	if (owner)
	{
		window.app_budget_report_flAggGajiLokasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_budget_report_flAggGajiLokasi";
		this.maximize();
...
window.app_budget_report_flAggGajiLokasi.extend(window.portalui_childForm);
window.app_budget_report_flAggGajiLokasi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_budget_report_flAggGajiLokasi]::mainButtonClick:"+e);
		}
	},
