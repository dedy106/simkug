// JavaScript Document
window.app_budget_report_flAggTb = function(owner)
{
	if (owner)
	{
		window.app_budget_report_flAggTb.prototype.parent.constructor.call(this,owner);
		this.className = "app_budget_report_flAggTb";
		this.maximize();
...
window.app_budget_report_flAggTb.extend(window.portalui_childForm);
window.app_budget_report_flAggTb.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			if (this.sg1.getCell(2,3)=="Neraca Lajur")
			{
				...
				this.nama_report="server_report_budget_rptTBLajur";
