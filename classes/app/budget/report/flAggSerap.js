window.app_budget_report_flAggSerap = function(owner)
{
	if (owner)
	{
		window.app_budget_report_flAggSerap.prototype.parent.constructor.call(this,owner);
		this.className = "app_budget_report_flAggSerap";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Realisasi Penyerapan Anggaran", 2);
...
window.app_budget_report_flAggSerap.extend(window.portalui_childForm);
window.app_budget_report_flAggSerap.prototype.doEllipseClick= function(sender, col, row)
{
...
window.app_budget_report_flAggSerap.prototype.doSelectCell = function(sender, col, row)
{
...
window.app_budget_report_flAggSerap.prototype.mainButtonClick = function(sender)
{
	try
	{
		...
		else
		{
			...
			this.nama_report = "server_report_budget_rptAggSerap";
	...
	{
		alert("[app_budget_report_flAggSerap]::mainButtonClick:"+e);
	}
};
window.app_budget_report_flAggSerap.prototype.doRequestReady = function(sender, methodName, result)
{
...
window.app_budget_report_flAggSerap.prototype.getStringHeader = function(){
...
window.app_budget_report_flAggSerap.prototype.doConfirmClick = function(sender){
	try{
...
window.app_budget_report_flAggSerap.prototype.doSelectedPage = function(sender, page)
{
	this.viewer.useIframe(this.report.previewWithHeader(this.nama_report,this.filter, this.page,  this.pager, this.showFilter, this.lokasi,this.filter2));
	this.page = page;
	this.allBtn = false;
};
window.app_budget_report_flAggSerap.prototype.previewReport = function(dthtml)
{
...
window.app_budget_report_flAggSerap.prototype.doCloseReportClick = function(sender)
{
...
window.app_budget_report_flAggSerap.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_budget_report_flAggSerap.prototype.doRowPerPageChange = function(sender, rowperpage)
{
