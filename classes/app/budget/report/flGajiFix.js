window.app_budget_report_flGajiFix = function(owner)
{
	if (owner)
	{
		window.app_budget_report_flGajiFix.prototype.parent.constructor.call(this,owner);
		this.className = "app_budget_report_flGajiFix";
		this.maximize();
...
window.app_budget_report_flGajiFix.extend(window.portalui_childForm);
window.app_budget_report_flGajiFix.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_budget_report_flGajiFixs]::mainButtonClick:"+e);
		}
	},
