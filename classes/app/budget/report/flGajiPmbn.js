window.app_budget_report_flGajiPmbn = function(owner)
{
	if (owner)
	{
		window.app_budget_report_flGajiPmbn.prototype.parent.constructor.call(this,owner);
		this.className = "app_budget_report_flGajiPmbn";
		this.maximize();
...
window.app_budget_report_flGajiPmbn.extend(window.portalui_childForm);
window.app_budget_report_flGajiPmbn.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2){
				...
				var sql = "select a.nik,a.nama,c.nama as nama_jab,a.kode_band,a.kode_loker, e.nama as nama_pp,f.nama as nama_kota,f.idx  ";
				...
				sql +=	"		   from agg_gajipmbn_d a "+
								  "		   inner join agg_gajipmbn_m c on a.no_gaji=c.no_gaji and a.kode_lokasi=c.kode_lokasi "+this.filter+
								  "			  ) b on a.nik=b.nik "+this.filter2+
								  "	group by a.nik, a.nama,c.nama,a.kode_band,a.kode_loker, e.nama,f.nama,f.idx  order by a.nik";									
			...
			systemAPI.alert("[app_budget_report_flGajiPmbns]::mainButtonClick:"+e);
		}
	},
	...
	previewReport: function(dthtml){
		var html = "<div align='center' class='judul_laporan' style='{width:100%;font-size:14;font-weight:bold;}'><br><br>"+this.app._namalokasi.toUpperCase()+"<br>LAPORAN BIAYA PENYELENGGARAAN YAKES<br />";
		var d = new Date();
