window.app_budget_report_flAggGajiBln = function(owner)
{
	
	try{
	if (owner)
	{
		window.app_budget_report_flAggGajiBln.prototype.parent.constructor.call(this,owner);
		this.className = "app_budget_report_flAggGajiBln";
		this.maximize();
...
window.app_budget_report_flAggGajiBln.extend(window.portalui_childForm);
window.app_budget_report_flAggGajiBln.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_budget_report_flAggGajiBln]::mainButtonClick:"+e);
		}
	},
