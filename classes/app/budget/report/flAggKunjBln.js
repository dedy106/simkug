window.app_budget_report_flAggKunjBln = function(owner)
{
	
	try{
	if (owner)
	{
		window.app_budget_report_flAggKunjBln.prototype.parent.constructor.call(this,owner);
		this.className = "app_budget_report_flAggKunjBln";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Pendapatan Kunjungan", 2);
...
window.app_budget_report_flAggKunjBln.extend(window.portalui_childForm);
window.app_budget_report_flAggKunjBln.implement({
	...
	mainButtonClick: function(sender){
		try
		{
				...
				if (this.lap == "Parameter Layanan")
				{
					if (this.jenisLap == "Bulanan")
					{
						var sql="select e.nama, "+
								...
								"	   sum(case when substring(a.periode,5,2) between '01' and '01' then a.jumlah*14500 else 0 end ) as g01, "+
								"	   sum(case when substring(a.periode,5,2) between '02' and '02' then a.jumlah*14500 else 0 end ) as g02, "+
								"	   sum(case when substring(a.periode,5,2) between '03' and '03' then a.jumlah*14500 else 0 end ) as g03, "+
								"	   sum(case when substring(a.periode,5,2) between '04' and '04' then a.jumlah*14500 else 0 end ) as g04, "+
								"	   sum(case when substring(a.periode,5,2) between '05' and '05' then a.jumlah*14500 else 0 end ) as g05, "+
								"	   sum(case when substring(a.periode,5,2) between '06' and '06' then a.jumlah*14500 else 0 end ) as g06, "+
								"	   sum(case when substring(a.periode,5,2) between '07' and '07' then a.jumlah*14500 else 0 end ) as g07, "+
								"	   sum(case when substring(a.periode,5,2) between '08' and '08' then a.jumlah*14500 else 0 end ) as g08, "+
								"	   sum(case when substring(a.periode,5,2) between '09' and '09' then a.jumlah*14500 else 0 end ) as g09, "+
								"	   sum(case when substring(a.periode,5,2) between '10' and '10' then a.jumlah*14500 else 0 end ) as g10, "+
								"	   sum(case when substring(a.periode,5,2) between '11' and '11' then a.jumlah*14500 else 0 end ) as g11, "+
								"	   sum(case when substring(a.periode,5,2) between '12' and '12' then a.jumlah*14500 else 0 end ) as g12, "+
								"	   sum(case when substring(a.periode,5,2) between '01' and '12' then a.jumlah*14500 else 0 end ) as tot_nilai, "+ 
								...
								"   inner join agg_bpcc_param b on a.kode_param=b.kode_param and b.kode_bpcc='1' and b.modul='BP' "+this.filter2+
								"	group by a.kode_param)f on e.kode_param=f.kode_param "+
								"where e.kode_bpcc='1' and e.modul='BP' "+
					...
					if (this.jenisLap == "Triwulan")
					{
						var sql="select e.nama, "+
								...
								"from agg_bpcc_param e "+
								"left join (select a.kode_param, "+
								"	   sum(case when substring(a.periode,5,2) between '01' and '03' then a.jumlah*14500 else 0 end ) as g01, "+
								"	   sum(case when substring(a.periode,5,2) between '04' and '06' then a.jumlah*14500 else 0 end ) as g02, "+
								"	   sum(case when substring(a.periode,5,2) between '07' and '09' then a.jumlah*14500 else 0 end ) as g03, "+
								"	   sum(case when substring(a.periode,5,2) between '10' and '12' then a.jumlah*14500 else 0 end ) as g04, "+
								"	   sum(case when substring(a.periode,5,2) between '01' and '12' then a.jumlah*14500 else 0 end ) as tot_nilai, "+ 
					...
					if (this.jenisLap == "Semester")
					{
						var sql="select e.nama, "+
								...
								"from agg_bpcc_param e "+
								"left join (select a.kode_param, "+
								"	   sum(case when substring(a.periode,5,2) between '01' and '06' then a.jumlah*14500 else 0 end ) as g01, "+
								"	   sum(case when substring(a.periode,5,2) between '07' and '12' then a.jumlah*14500 else 0 end ) as g02, "+
								"	   sum(case when substring(a.periode,5,2) between '01' and '12' then a.jumlah*14500 else 0 end ) as tot_nilai, "+ 
				...
				if (this.lap == "Jenis Layanan")
				{
					if (this.jenisLap == "Bulanan")
					{
						var sql="select e.nama, "+
								...
								"	from agg_bpcc_peserta a "+
								"   inner join agg_bpcc_param b on a.kode_param=b.kode_param and b.kode_bpcc='1' and b.modul='BP' "+this.filter2+
								"	group by b.kode_bpcc)f on e.kode_bpcc=f.kode_bpcc "+
			...
			systemAPI.alert("[app_budget_report_flAggKunjBln]::mainButtonClick:"+e);
		}
	},
	...
	previewReport: function(dthtml){
		var header = "LAPORAN PENDAPATAN KUNJUNGAN <br>"+this.lap.toUpperCase()+" "+this.jenisLap.toUpperCase()+" <br>TAHUN "+this.sg1.getCell(2,1);
