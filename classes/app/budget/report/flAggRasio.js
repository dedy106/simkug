window.app_budget_report_flAggRasio = function(owner)
{
	if (owner)
	{
		window.app_budget_report_flAggRasio.prototype.parent.constructor.call(this,owner);
		this.className = "app_budget_report_flAggRasio";
		this.maximize();
...
window.app_budget_report_flAggRasio.extend(window.portalui_childForm);
window.app_budget_report_flAggRasio.prototype.doEllipseClick= function(sender, col, row)
{
...
window.app_budget_report_flAggRasio.prototype.doSelectCell = function(sender, col, row)
{
...
window.app_budget_report_flAggRasio.prototype.mainButtonClick = function(sender)
{
	try
	{
		...
		else
		{
			...
			if (this.sg1.getCell(2,2)=="Saldo Akhir")
			{
				this.nama_report="server_report_budget_rptAggRasio";
			}
			else
			{
				this.nama_report="server_report_budget_rptAggTw";
			}
	...
	{
		alert("[app_budget_report_flAggRasio]::mainButtonClick:"+e);
	}
};
window.app_budget_report_flAggRasio.prototype.doRequestReady = function(sender, methodName, result)
{
...
window.app_budget_report_flAggRasio.prototype.getStringHeader = function(){
...
window.app_budget_report_flAggRasio.prototype.doConfirmClick = function(sender){
	try{
...
window.app_budget_report_flAggRasio.prototype.doSelectedPage = function(sender, page)
{
	this.viewer.useIframe(this.report.previewWithHeader(this.nama_report,this.filter, this.page,  this.pager, this.showFilter, this.lokasi,this.filter2));
	this.page = page;
	this.allBtn = false;
};
window.app_budget_report_flAggRasio.prototype.previewReport = function(dthtml)
{
...
window.app_budget_report_flAggRasio.prototype.doCloseReportClick = function(sender)
{
...
window.app_budget_report_flAggRasio.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_budget_report_flAggRasio.prototype.doRowPerPageChange = function(sender, rowperpage)
{
