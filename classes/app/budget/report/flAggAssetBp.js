window.app_budget_report_flAggAssetBp = function(owner)
{
	if (owner)
	{
		window.app_budget_report_flAggAssetBp.prototype.parent.constructor.call(this,owner);
		this.className = "app_budget_report_flAggAssetBp";
		this.maximize();
		this.app._mainForm.childFormConfig(this,"mainButtonClick","Laporan Biaya Penyusutan (BP) Aktiva Tetap",2);
...
window.app_budget_report_flAggAssetBp.extend(window.portalui_childForm);
window.app_budget_report_flAggAssetBp.prototype.doEllipseClick= function(sender, col, row)
{
...
window.app_budget_report_flAggAssetBp.prototype.doSelectCell = function(sender, col, row)
{
...
window.app_budget_report_flAggAssetBp.prototype.mainButtonClick = function(sender)
{
	try
	{
		...
		else
		{
			...
			this.sql="select b.nama,a.no_fa,a.nama,a.kode_akun,c.nama as nama_akun,a.kode_pp2,g.nama as nama_pp,a.kode_rka2,d.nama as nama_drk, "+
					...
					"inner join agg_rka d on a.kode_rka2=d.kode_rka  "+
					"inner join agg_pp g on a.kode_pp2=g.kode_pp and a.kode_lokasi=g.kode_lokasi "+
	...
	{
		alert("[app_budget_report_flAggAssetBp]::mainButtonClick:"+e);
	}
};
window.app_budget_report_flAggAssetBp.prototype.doRequestReady = function(sender, methodName, result)
{
...
window.app_budget_report_flAggAssetBp.prototype.getStringHeader = function(){
...
window.app_budget_report_flAggAssetBp.prototype.doConfirmClick = function(sender){
	try{
...
window.app_budget_report_flAggAssetBp.prototype.doSelectedPage = function(sender, page)
{
	var dthtml = this.dbLib.sqlToHtml(this.sqlScript,page,this.pager, this.title, this.widthTable, this.fieldType,false);			
	this.previewReport(dthtml);			
	this.page=page;
};
window.app_budget_report_flAggAssetBp.prototype.previewReport = function(dthtml)
{
	var html = "<div align='center' class='judul_laporan' style='{width:100%;font-size:14;font-weight:bold;}'><br><br>"+this.app._namalokasi.toUpperCase()+"<br>Laporan Biaya Penyusutan (BP) Aktiva Tetap<br>Tahun "+this.sg1.getCell(2,1)+"<br>";			
	var d = new Date();
...
window.app_budget_report_flAggAssetBp.prototype.doCloseReportClick = function(sender)
{
...
window.app_budget_report_flAggAssetBp.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_budget_report_flAggAssetBp.prototype.doRowPerPageChange = function(sender, rowperpage)
{
