...
//* 			SAI, PT											
//***********************************************************************************************
window.app_budget_report_flBB = function(owner)
{
	if (owner)
	{
		window.app_budget_report_flBB.prototype.parent.constructor.call(this,owner);
		this.className = "app_budget_report_flBB";
		this.maximize();
...
window.app_budget_report_flBB.extend(window.portalui_childForm);
window.app_budget_report_flBB.implement({
	...
	mainButtonClick: function(sender){
		try{
			...
			this.nama_report="server_report_budget_rptBB";
