window.app_budget_report_flAggAkunPP = function(owner)
{
	if (owner)
	{
		window.app_budget_report_flAggAkunPP.prototype.parent.constructor.call(this,owner);
		this.className = "app_budget_report_flAggAkunPP";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Rekapitulasi RKA Per Akun PP", 2);
...
window.app_budget_report_flAggAkunPP.extend(window.portalui_childForm);
window.app_budget_report_flAggAkunPP.prototype.doEllipseClick= function(sender, col, row)
{
...
window.app_budget_report_flAggAkunPP.prototype.doSelectCell = function(sender, col, row)
{
...
window.app_budget_report_flAggAkunPP.prototype.mainButtonClick = function(sender)
{
	try
	{
		...
		{ 
			...
			this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Kode PP","All",""));
			this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("Periodik Laporan","=","Bulanan"));
			this.gridLib.SGEditData(this.sg1,5,new Array(0,1,2), new Array("Jenis Laporan","=","Summary"));
		}
		else
		{
			...
			this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where") +
				  ...
				  this.filterRep.filterStr("a.kode_pp",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and")+this.filter2;
				  
			this.showFilter = this.filterRep.showFilter(this.sg1);
			if (this.sg1.getCell(2,4)=="Bulanan")
			{
				this.sql =  "select a.kode_akun,f.nama as nama_akun,a.kode_pp,e.nama as nama_pp, "+
						...
						"from (select a.kode_lokasi,a.kode_pp,a.tahun,a.kode_akun,a.progress "+	
						"	  from agg_d a "+this.filter+
						"group by a.kode_lokasi,a.kode_pp,a.tahun,a.kode_akun,a.progress ) a  "+
						...
						"left join ( "+
						"	 select a.kode_lokasi,a.kode_pp,a.kode_akun, "+
						...
						"	 from agg_d a "+this.filter+
						"	 group by a.kode_lokasi,a.kode_pp,a.kode_akun "+
						"		 )g on a.kode_lokasi=g.kode_lokasi and a.kode_akun=g.kode_akun and a.kode_pp=g.kode_pp "+this.filter+
				...
				title.add("Nama PP");width.add(200);fieldType.add("S");
	...
	{
		alert("[app_budget_report_flAggAkunPP]::mainButtonClick:"+e);
	}
};
window.app_budget_report_flAggAkunPP.prototype.doRequestReady = function(sender, methodName, result)
{
...
window.app_budget_report_flAggAkunPP.prototype.getStringHeader = function(){
...
window.app_budget_report_flAggAkunPP.prototype.doConfirmClick = function(sender){
	try{
...
window.app_budget_report_flAggAkunPP.prototype.doSelectedPage = function(sender, page)
{
	var dthtml = this.dbLib.sqlToHtml(this.sqlScript,page,this.pager, this.title, this.widthTable, this.fieldType,false);			
	this.previewReport(dthtml);			
	this.page=page;
};
window.app_budget_report_flAggAkunPP.prototype.previewReport = function(dthtml)
{
	var html = "<div align='center' class='judul_laporan' style='{width:100%;font-size:14;font-weight:bold;}'><br><br>"+this.app._namalokasi.toUpperCase()+"<br>Laporan Rekapitulasi RKA Per Akun PP<br>";			
	var d = new Date();
...
window.app_budget_report_flAggAkunPP.prototype.doCloseReportClick = function(sender)
{
...
window.app_budget_report_flAggAkunPP.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_budget_report_flAggAkunPP.prototype.doRowPerPageChange = function(sender, rowperpage)
{
