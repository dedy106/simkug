window.app_budget_report_flKunjBp = function(owner)
{
	if (owner)
	{
		window.app_budget_report_flKunjBp.prototype.parent.constructor.call(this,owner);
		this.className = "app_budget_report_flKunjBp";
		this.maximize();
...
window.app_budget_report_flKunjBp.extend(window.portalui_childForm);
window.app_budget_report_flKunjBp.prototype.doEllipseClick= function(sender, col, row)
{
...
window.app_budget_report_flKunjBp.prototype.doSelectCell = function(sender, col, row)
{
...
window.app_budget_report_flKunjBp.prototype.mainButtonClick = function(sender)
{
	try
	{
		...
		else
		{
			...
			if (this.sg1.getCell(2,3)=="Summary Kunjungan")
			{
				this.sql =  "select c.nama,"+
							"	   sum(case when a.jenis_tpk='TPKK' and a.status_pst='PEGAWAI' and a.jenis_pst='KK' then a.jumlah else 0 end) as tpkk_kk, "+
							"	   sum(case when a.jenis_tpk='TPKK' and a.status_pst='PEGAWAI' and a.jenis_pst='ISU' then a.jumlah else 0 end) as tpkk_isu, "+
							"	   sum(case when a.jenis_tpk='TPKK' and a.status_pst='PEGAWAI' and a.jenis_pst='ANAK' then a.jumlah else 0 end) as tpkk_anak, "+
							"	   sum(case when a.jenis_tpk='TPKK' and a.status_pst='PEGAWAI' then a.jumlah else 0 end) as tot_tpkk, "+
			...
			{
				this.sql =  "select c.nama,"+
							"	   sum(case when a.jenis_tpk='TPKK' and a.status_pst='PEGAWAI' and a.jenis_pst='KK' then a.nilai_biaya else 0 end) as tpkk_kk, "+
							"	   sum(case when a.jenis_tpk='TPKK' and a.status_pst='PEGAWAI' and a.jenis_pst='ISU' then a.nilai_biaya else 0 end) as tpkk_isu, "+
							"	   sum(case when a.jenis_tpk='TPKK' and a.status_pst='PEGAWAI' and a.jenis_pst='ANAK' then a.nilai_biaya else 0 end) as tpkk_anak, "+
							"	   sum(case when a.jenis_tpk='TPKK' and a.status_pst='PEGAWAI' then a.nilai_biaya else 0 end) as tot_tpkk, "+
			...
			{
				this.sql =  "select c.nama,"+
							"	   sum(case when a.jenis_tpk='TPKK' and a.status_pst='PEGAWAI' and a.jenis_pst='KK' then a.nilai_biaya/jumlah else 0 end) as tpkk_kk, "+
							"	   sum(case when a.jenis_tpk='TPKK' and a.status_pst='PEGAWAI' and a.jenis_pst='ISU' then a.nilai_biaya/jumlah else 0 end) as tpkk_isu, "+
							"	   sum(case when a.jenis_tpk='TPKK' and a.status_pst='PEGAWAI' and a.jenis_pst='ANAK' then a.nilai_biaya/jumlah else 0 end) as tpkk_anak, "+
							"	   sum(case when a.jenis_tpk='TPKK' and a.status_pst='PEGAWAI' then a.nilai_biaya/jumlah else 0 end) as tot_tpkk, "+
	...
	{
		alert("[app_budget_report_flKunjBp]::mainButtonClick:"+e);
	}
};
window.app_budget_report_flKunjBp.prototype.doRequestReady = function(sender, methodName, result)
{
...
window.app_budget_report_flKunjBp.prototype.getStringHeader = function(){
...
window.app_budget_report_flKunjBp.prototype.doConfirmClick = function(sender){
	try{
...
window.app_budget_report_flKunjBp.prototype.doSelectedPage = function(sender, page)
{
	var dthtml = this.dbLib.sqlToHtml(this.sqlScript,page,this.pager, this.title, this.widthTable, this.fieldType,false);			
	this.previewReport(dthtml);			
	this.page=page;
};
window.app_budget_report_flKunjBp.prototype.previewReport = function(dthtml)
{
...
window.app_budget_report_flKunjBp.prototype.doCloseReportClick = function(sender)
{
...
window.app_budget_report_flKunjBp.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_budget_report_flKunjBp.prototype.doRowPerPageChange = function(sender, rowperpage)
{
