window.app_budget_report_flAggEvalAbau = function(owner)
{
	if (owner)
	{
		window.app_budget_report_flAggEvalAbau.prototype.parent.constructor.call(this,owner);
		this.className = "app_budget_report_flAggEvalAbau";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Evaluasi Norma Biaya Variabel", 2);
...
window.app_budget_report_flAggEvalAbau.extend(window.portalui_childForm);
window.app_budget_report_flAggEvalAbau.prototype.doEllipseClick= function(sender, col, row)
{
...
window.app_budget_report_flAggEvalAbau.prototype.doSelectCell = function(sender, col, row)
{
...
window.app_budget_report_flAggEvalAbau.prototype.mainButtonClick = function(sender)
{
	try
	{
		...
		else
		{
			...
			this.nama_report = "server_report_budget_rptAggEvalAbau";
	...
	{
		alert("[app_budget_report_flAggEvalAbau]::mainButtonClick:"+e);
	}
};
window.app_budget_report_flAggEvalAbau.prototype.doRequestReady = function(sender, methodName, result)
{
...
window.app_budget_report_flAggEvalAbau.prototype.getStringHeader = function(){
...
window.app_budget_report_flAggEvalAbau.prototype.doConfirmClick = function(sender){
	try{
...
window.app_budget_report_flAggEvalAbau.prototype.doSelectedPage = function(sender, page)
{
	this.viewer.useIframe(this.report.previewWithHeader(this.nama_report,this.filter, this.page,  this.pager, this.showFilter, this.lokasi,this.filter2));
	this.page = page;
	this.allBtn = false;
};
window.app_budget_report_flAggEvalAbau.prototype.previewReport = function(dthtml)
{
...
window.app_budget_report_flAggEvalAbau.prototype.doCloseReportClick = function(sender)
{
...
window.app_budget_report_flAggEvalAbau.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_budget_report_flAggEvalAbau.prototype.doRowPerPageChange = function(sender, rowperpage)
{
