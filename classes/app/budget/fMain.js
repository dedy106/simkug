...
//* 			SAI, PT											
//***********************************************************************************************
window.app_budget_fMain = function(owner)
{
	if (owner)
	{	
		try
		{
			window.app_budget_fMain.prototype.parent.constructor.call(this, owner);
			window.app_budget_fMain.prototype.parent.setWidth.call(this, 600);
			window.app_budget_fMain.prototype.parent.setHeight.call(this, 450);
			...
			this.centerize();							
			uses("portalui_saiCB;portalui_saiLabelEdit;portalui_slider;portalui_image;portalui_imageButton;portalui_button;portalui_timer;portalui_label;portalui_saiCBBL;portalui_panel;portalui_reportNavigator;portalui_treeView;portalui_treeNode;portalui_statusBar;portalui_marquee;util_addOnLib;util_standar;portalui_imageButton");
			this.className  = "fMain";
			
			this.formCaption = "PPBS";	
			...
			this.bGenLocal = new portalui_imageButton(this.pTool,{bound:[440,5,17,15],hint:"Front End",image:"icon/"+system.getThemes()+"/bGenLocal.png",click:[this,"openNewWindow"]});
...
//--------------------------------------------------
			...
			this.infoPerusahaan = new control(this,{bound:[this.treev.width + 30,this.treev.top,this.width - this.treev.width - 40,this.treev.height]});
...
window.app_budget_fMain.extend(window.portalui_form);
window.app_budget_fMain.implement({
	gotoLogin: function(){		
		this.form = new app_budget_fLogin(this);
	...
	doAfterLogin: function(){
		try{		    
			...
			this.btnList = new portalui_image(this,{bound:[this.width - 50,30,20,20],hint:"User Info",showHint:true, color:"",image:"image/userinfo.png",click:[this,"doBtnList"]});
			...
			this.infoPerusahaan.getCanvas().innerHTML = "<table border=0 cellspacing=0 cellpadding=0 width='100%'>"+
					...
					"<tr><td align='center'>"+
					"<span style='font-size:20pt;font-weight:bold;color:#299bcf;font-family:Arial, Helvetica, Sans-serif;'> P P B S </span>"+
					"</td></tr>"+
					"<tr><td align='center'>"+
					"<span style='font-size:14pt;font-weight:bold;color:#ff9900;font-family:Arial, Helvetica, Sans-serif;'> Planning Programing Budgeting System</span>"+
					"</td></tr>"+
	...
	bTutupClick: function(sender){	
		try{
			...
			this.marquee.show();
			this.setFormCaption("PPBS easy menu access");
