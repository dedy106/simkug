...
//* 			SAI, PT											
//***********************************************************************************************
window.app_kopeg_fMenuDetail = function(owner){
	if (owner){
		try{
			window.app_kopeg_fMenuDetail.prototype.parent.constructor.call(this, owner);
			window.app_kopeg_fMenuDetail.prototype.parent.setWidth.call(this, 300);
			window.app_kopeg_fMenuDetail.prototype.parent.setHeight.call(this, 400);		
			this.centerize();
			this.className = "app_kopeg_fMenuDetail";
			this.mouseX = 0;
			this.mouseY = 0;					
...
window.app_kopeg_fMenuDetail.extend(window.portalui_commonForm);
window.app_kopeg_fMenuDetail.implement({
	...
	doSysMouseMove: function(x, y, button, buttonState){
		window.app_kopeg_fMenuDetail.prototype.parent.doSysMouseMove.call(this,x, y, button, buttonState);
		if (this.isClick){
