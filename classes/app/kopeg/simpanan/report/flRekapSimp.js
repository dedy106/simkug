window.app_kopeg_simpanan_report_flRekapSimp = function(owner)
{
	if (owner)
	{
		window.app_kopeg_simpanan_report_flRekapSimp.prototype.parent.constructor.call(this,owner);
		this.className = "app_kopeg_simpanan_report_flRekapSimp";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Rekapitulasi Saldo Simpanan", 2);
...
window.app_kopeg_simpanan_report_flRekapSimp.extend(window.portalui_childForm);
window.app_kopeg_simpanan_report_flRekapSimp.implement({
...
this.app._mainForm.reportNavigator.serverDownload = true;	
				...
				this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
						...
						this.filterRep.filterStr("a.no_simp",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4),"and");
				this.filter2= this.sg1.getCell(2,1)+";"+this.app._namalokasi.toUpperCase();
				this.nama_report="server_report_kopeg_rptRekapSimp";
