...
//* 			SAI, PT											
//***********************************************************************************************
window.app_kopeg_fKlpAkses = function(owner){
	if (owner){
		try{
			window.app_kopeg_fKlpAkses.prototype.parent.constructor.call(this, owner);
			this.className = "app_kopeg_fKlpAkses";
		...
		{
			systemAPI.alert("[app_kopeg_fKlpAkses]::constructor:"+e);
		}
		
		this.setTabChildIndex();
	}
};
window.app_kopeg_fKlpAkses.extend(window.portalui_childForm);
window.app_kopeg_fKlpAkses.implement({
