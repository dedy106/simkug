// JavaScript Document
window.app_kopeg_piutang_report_flGlJurnalByrPry = function(owner)
{
	if (owner)
	{
		window.app_kopeg_piutang_report_flGlJurnalByrPry.prototype.parent.constructor.call(this,owner);
		this.className = "app_kopeg_piutang_report_flGlJurnalByrPry";
		this.maximize();
...
window.app_kopeg_piutang_report_flGlJurnalByrPry.extend(window.portalui_childForm);
window.app_kopeg_piutang_report_flGlJurnalByrPry.implement({
	doEllipseClick: function(sender, col, row){
		...
		if (row == 3)
		{
			...
			var sql1="select a.no_bukti,a.keterangan from kop_proyekbayar_m a "+filter; 
			var sql2="select count(a.no_bukti) from kop_proyekbayar_m a "+filter;
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_saku3_rptGlJurnalArbyr";
