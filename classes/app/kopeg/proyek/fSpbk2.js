window.app_kopeg_proyek_fSpbk2 = function(owner)
{
	if (owner)
	{
		window.app_kopeg_proyek_fSpbk2.prototype.parent.constructor.call(this,owner);
		this.className  = "app_kopeg_proyek_fSpbk2";
...
window.app_kopeg_proyek_fSpbk2.extend(window.portalui_childForm);
window.app_kopeg_proyek_fSpbk2.implement({
				...
				try{									
					...
					for (var i=0; i < this.sg2.rows.getLength(); i++){
						if (this.sg2.rowValid(i)) {
							if (!baris1) { scr1 += ",";}	
							scr1 += "('"+this.nb+"','"+this.sg2.getCell(9,i)+"','"+this.dp_d1.getDate()+"',"+idx+",'"+this.sg2.getCell(0,i)+
	...
	doLoadData:function(sender){ 
		if (this.cb_nbLama.getText() != ""){
			var data = this.dbLib.getDataProvider("select a.no_dokumen,a.keterangan,a.kode_curr,a.kurs,a.nik_buat,a.nik_setuju,b.nama as nama_buat,c.nama as nama_setuju,a.due_date,a.kode_terima,d.nama as nama_terima,a.periode,a.posted,a.tanggal,a.akun_hutang,aa.nama as nama_akun,a.no_fpajak, "+
											      "       x.kode_akun,y.nama as nama_akun,x.keterangan as ket,x.dc,x.nilai,x.kode_pp,ifnull(z.nama,'-') as nama_pp,x.kode_drk,ifnull(zz.nama,'-') as nama_drk,cc.no_proyek,cc.no_dokumen as nodok "+
												  ...
												  "             inner join kop_proyek_m cc on x.no_dokumen=cc.no_proyek and x.kode_lokasi=cc.kode_lokasi "+
			...
			if (typeof data == "object" && data.rs.rows[0] != undefined){
				...
				for (var i in data.rs.rows){
					line = data.rs.rows[i];							
					this.sg2.appendData([line.kode_akun,line.nama_akun,line.ket,line.dc.toUpperCase(),floatToNilai(line.nilai),line.kode_pp,line.nama_pp,line.kode_drk,line.nama_drk,line.no_proyek,line.nodok]);
				}
