window.app_kopeg_pinjbrg_report_flRSched = function(owner)
{
	if (owner)
	{
		window.app_kopeg_pinjbrg_report_flRSched.prototype.parent.constructor.call(this,owner);
		this.className = "app_kopeg_pinjbrg_report_flRSched";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Realisasi Schedule Angsuran", 2);
	...
	this.getPeriode="select distinct periode from kop_pinj_m where kode_lokasi ='"+this.lokasi+"' order by periode";
...
window.app_kopeg_pinjbrg_report_flRSched.extend(window.portalui_childForm);
window.app_kopeg_pinjbrg_report_flRSched.implement({
	doEllipseClick: function(sender, col, row)
	{
		...
		if (row === 3)
		{
			this.filterRep.ListDataSGFilter(this, "Data Nasabah",this.sg1, this.sg1.row, this.sg1.col,
										  "select kode_agg, nama from kop_agg a "+
		...
		if (row === 4)
		{
			this.filterRep.ListDataSGFilter(this, "Data No. Kredit Barang",this.sg1, this.sg1.row, this.sg1.col,
										  "select distinct a.no_kontrak,a.keterangan from kop_pbrg_m a inner join kop_agg b on b.kode_agg = a.kode_agg and b.kode_lokasi = a.kode_lokasi "+
										  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
										  ...
										  "select count(distinct a.no_pbrg) from kop_pbrg_m a inner join kop_agg b on b.kode_agg = a.kode_agg and b.kode_lokasi = a.kode_lokasi "+
										  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
											this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
											this.filterRep.filterStr("b.kode_loker",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
											this.filterRep.filterStr("a.kode_agg",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and"),
										  ["a.no_kontrak","a.keterangan"],"and",["No. Kredit","Keterangan"]);
		}
	},
	doSelectCell: function(sender, col, row)
	{
		...
		if (this.userStatus==="A"){
			this.filterRep.setSGFilterRowTipe(this.sg1, row,new Array(0,1,2,3,4),new  Array("3","13","13","13","13"));
		...
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.filter = this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
						...
						this.filterRep.filterStr("b.kode_loker",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and")+
						this.filterRep.filterStr("a.kode_agg",this.sg1.getCell(1,3),this.sg1.getCell(2,3),this.sg1.getCell(3,3),"and")+
						this.filterRep.filterStr("a.no_pbrg",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4),"and");
				this.filter2= this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
						this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and")+
						this.filterRep.filterStr("a.no_pbrg",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4),"and");
				this.nama_report="server_report_kopeg_rptRSchedPbrg";
