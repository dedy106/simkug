window.app_kopeg_pinjaman_report_flSpbT = function(owner)
{
	if (owner)
	{
		window.app_kopeg_pinjaman_report_flSpbT.prototype.parent.constructor.call(this,owner);
		this.className = "app_kopeg_pinjaman_report_flSpbT";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan SPB Titipan Pinjaman", 2);
...
window.app_kopeg_pinjaman_report_flSpbT.extend(window.portalui_childForm);
window.app_kopeg_pinjaman_report_flSpbT.implement({
	doEllipseClick: function(sender, col, row)
	{
		...
		if (row === 4)
		{
			this.filterRep.ListDataSGFilter(this, "Data No. SPB Asuransi Pinjaman",this.sg1, this.sg1.row, this.sg1.col,
										  "select no_spb,keterangan from spb_m where kode_lokasi='"+this.sg1.getCell(2,0)+"' and periode='"+this.sg1.getCell(2,1)+"' and modul='KP.SPB' and jenis='PINJ_TK' and no_del='-'",
										  "select count(*) from spb_m where kode_lokasi='"+this.sg1.getCell(2,0)+"' and periode='"+this.sg1.getCell(2,1)+"' and modul='KP.SPB' and jenis='PINJ_TK' and no_del='-'",
	...
	mainButtonClick: function(sender)
	{
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_kopeg_rptSPBT2";
