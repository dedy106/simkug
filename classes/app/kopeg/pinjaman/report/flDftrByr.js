window.app_kopeg_pinjaman_report_flDftrByr = function(owner)
{
	if (owner)
	{
		window.app_kopeg_pinjaman_report_flDftrByr.prototype.parent.constructor.call(this,owner);
		this.className = "app_kopeg_pinjaman_report_flDftrByr";
		this.maximize();
...
window.app_kopeg_pinjaman_report_flDftrByr.extend(window.portalui_childForm);
window.app_kopeg_pinjaman_report_flDftrByr.implement({
	...
	mainButtonClick: function(sender)
	{
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.filter2= this.app._namalokasi.toUpperCase()+";"+this.sg1.getCell(2,1);
				this.nama_report="server_report_kopeg_rptDftrByr";
