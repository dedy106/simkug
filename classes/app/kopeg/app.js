...
//* 			SAI, PT											
//***********************************************************************************************
window.app_kopeg_app = function(owner){
	window.app_kopeg_app.prototype.parent.constructor.call(this, owner);
	this.className = "app_kopeg_app";
	this.onTerminate.set(this,"doTerminate");
	this.form = undefined;
	this.setTitle("jamboo eKoperasi");
	this.showForm();
};
window.app_kopeg_app.extend(window.portalui_application);
window.app_kopeg_app.implement({
	showForm: function(){
		try
		{
			var step = "load";			
			...
			step = "create";		
			this._mainForm = new app_kopeg_fMain(this);	
	...
	doKeyDown: function(charCode, buttonState, keyCode, event){
		try{			
			window.app_kopeg_app.prototype.parent.doKeyDown.call(this, charCode, buttonState, keyCode, event);			
