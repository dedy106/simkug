...
//* 			SAI, PT											
//***********************************************************************************************
window.app_kopeg_fForm = function(owner){
	if (owner){
		try
		{			
			window.app_kopeg_fForm.prototype.parent.constructor.call(this,owner);
			this.className  = "app_kopeg_fForm";					
...
window.app_kopeg_fForm.extend(window.portalui_childForm);
//------------------------------------------------------------------ event
window.app_kopeg_fForm.implement({
