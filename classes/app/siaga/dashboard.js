window.app_siaga_dashboard = function(owner,options)
{
	if (owner)
	{
		window.app_siaga_dashboard.prototype.parent.constructor.call(this,owner,options);
		this.className  = "app_siaga_dashboard";
...
window.app_siaga_dashboard.extend(window.panel);
window.app_siaga_dashboard.implement({
	...
	setWidth: function(data){
		window.app_siaga_dashboard.prototype.parent.setWidth.call(this,data);
		if (this.pg1){
