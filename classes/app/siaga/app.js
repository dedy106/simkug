...
//* 			SAI, PT											
//***********************************************************************************************
window.app_siaga_app = function(owner){
	window.app_siaga_app.prototype.parent.constructor.call(this, owner);
	this.className = "app_siaga_app";
...
window.app_siaga_app.extend(window.application);
window.app_siaga_app.implement({
	showForm: function(){
		try
		{
			...
			this._mainForm = new app_siaga_fMain(this);	
			//alert("fmain");
	...
	doKeyDown: function(charCode, buttonState, keyCode, event){
		try{			
			window.app_siaga_app.prototype.parent.doKeyDown.call(this, charCode, buttonState, keyCode, event);
