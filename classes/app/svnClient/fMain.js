...
window.app_builder_fMain = function(owner)
{
	...
	{	
		try
		{
			...
			window.app_builder_fMain.prototype.parent.setWidth.call(this, 600);
			window.app_builder_fMain.prototype.parent.setHeight.call(this, 150);
			this._mainButtonClick = new portalui_eventHandler();
			this.title = "jamboo Builder (jIDE)";		
			this._isLogedIn	= false;
			this.app._kodeMenu = "BUILDERMENU";
			...
			this.centerize();					
			uses("portalui_saiCB;portalui_image;portalui_imageButton;portalui_button");
			uses("portalui_label;portalui_saiLabelEdit;portalui_panel;portalui_treeView;portalui_treeNode");
			uses("util_file;util_addOnLib;util_standar");
			...
			this.maximize();			
			this.setHeight(70);
			uses("portalui_mainMenu;portalui_MenuForm;portalui_PopUpMenu;portalui_MenuItem",true);					
...
window.app_builder_fMain.implement({
	initLoad: function(){
		try{
			//----------------------------------------------------------------- tree View-----------------------------------			
			uses("portalui_sysForm;portalui_radioButton;portalui_checkBox;portalui_groupBox;portalui_bevel;portalui_flashObj;portalui_saiGrid;portalui_pageControl;portalui_childPage");
			this.compList = new portalui_sysForm(this.app,{bound:[10,80,220,200],caption:"Pallete",closeToHide:true,visible:true, afterResize:[this,"doFormResize"], borderStyle:bsSizeToolWin});								
			this.treev = new portalui_treeView(this.compList,{bound:[0,0,220, this.compList.height - 22], childLenght:250});						
			...
			//--------------------------------------------------
			this.editorFrm = new portalui_sysForm(this.app,{bound:[240,80,system.screenWidth - 240,system.screenHeight - 200],caption:"Source",closeToHide:true,visible:true, afterResize:[this,"doFormResize"]});														
			this.editor = new portalui_flashObj(this.editorFrm, {bound:[0,0,this.editorFrm.width, this.editorFrm.height - 20],flashFile:"jambooIDE-debug/jambooIDE.swf"});											
			//---------------------------------
			this.propertyFrm = new portalui_sysForm(this.app,{bound:[10,285,220,system.screenHeight - 400],caption:"Object Inspector",closeToHide:true, visible:true, afterResize:[this,"doFormResize"], borderStyle:bsSizeToolWin});														
			this.pageCtrl = new portalui_pageControl(this.propertyFrm,{bound:[0,0,this.propertyFrm.width, this.propertyFrm.height - 25],color:"transparent"});
			...
			this.eFolder = new portalui_saiLabelEdit(this.designFrm,{bound:[20,90,400, 20],caption:"Folder",text:"app"});
			...
			this.eAppFolder = new portalui_saiLabelEdit(this.designApp,{bound:[20,190,400, 20],caption:"Folder",text:"app"});
			...
			this.designDbg = new portalui_sysForm(this.app,{bound:[0,system.screenHeight - 105,system.screenWidth,100],caption:"Process Message",visible:true, resizeAble:false,closeToHide:true, borderStyle:bsSizeToolWin});											
			this.dbgMsg = new portalui_control(this.designDbg,{bound:[0,0,this.designDbg.width,100]});			
			this.dbgMsg.addStyle("overflow:auto;padding:5px");			
			uses("app_builder_component_controls_control;app_builder_component_controls_containerControl;app_builder_component_controls_commonForm");								
			this.getComponent();					
		...
		try{
			if (sender == this.bAppOk){
				...
				if (this.rbAppFrmNormal.isSelected()){										
					this.appMainForm = new portalui_sysForm(this.app,{bound:[240,50,system.screenWidth - 250,500],caption:"Form",name:this.eAppFrmClass.getText()});										
					this.appMainForm.setFormStyle(fsNormal);
				}else if(this.rbAppFrmMdi.isSelected()){					
					this.appMainForm = new portalui_sysForm(this.app,{bound:[240,150,system.screenWidth - 250,500],caption:"MDIForm",name:this.eAppFrmClass.getText()});										
	...
	doSelectCtrl : function(sender){		
		try{
			var comp;			
			if (this.activeDesigner !== undefined){
				 var owner = this.activeDesigner;
			}
