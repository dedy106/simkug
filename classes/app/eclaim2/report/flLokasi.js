window.app_eclaim2_report_flLokasi = function(owner)
{
	if (owner)
	{
		window.app_eclaim2_report_flLokasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_eclaim2_report_flLokasi";
		this.maximize();
...
window.app_eclaim2_report_flLokasi.extend(window.portalui_childForm);
window.app_eclaim2_report_flLokasi.implement({
	...
	mainButtonClick: function(sender){
		...
		{
			alert("[app_eclaim2_report_flLokasi]::mainButtonClick:"+e);
		}
	},
