window.app_eclaim2_report_flVerifikasiSwa = function(owner)
{
	if (owner)
	{
		window.app_eclaim2_report_flVerifikasiSwa.prototype.parent.constructor.call(this,owner);
		this.className = "app_eclaim2_report_flVerifikasiSwa";
		this.maximize();
...
window.app_eclaim2_report_flVerifikasiSwa.extend(window.portalui_childForm);
window.app_eclaim2_report_flVerifikasiSwa.implement({
	doEllipseClick:function(sender, col, row)
	{
		...
		if (row == 6)
		{
			...
			this.filterRep.ListDataSGFilter(this, "Data Klaim",this.sg1, this.sg1.row, this.sg1.col,
													  "select a.no_klaim,b.no_dokumen,date_format(b.tanggal,'%d/%m/%Y') as tanggal from tlk_ver_swa a "+
													  "inner join tlk_klaim b on a.no_klaim=b.no_klaim "+filter,
													  "select count(a.no_klaim) from tlk_ver_swa a "+
													  "inner join tlk_klaim b on a.no_klaim=b.no_klaim "+filter,
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_eclaim2_rptVerifikasiSwa";
