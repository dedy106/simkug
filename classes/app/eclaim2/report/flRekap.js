window.app_eclaim2_report_flRekap = function(owner)
{
	if (owner)
	{
		window.app_eclaim2_report_flRekap.prototype.parent.constructor.call(this,owner);
		this.className = "app_eclaim2_report_flRekap";
		this.maximize();
...
window.app_eclaim2_report_flRekap.extend(window.portalui_childForm);
window.app_eclaim2_report_flRekap.implement({
		...
		try
		{
			...
			else
			{
				...
				if (this.sg1.getCell(2,2)=="Versi 2011")
				{
					...
					this.nama_report="server_report_eclaim2_rptRekapKlaim";
				}
				if (this.sg1.getCell(2,2)=="Versi 2012")
				{
					...
					this.filter2=this.filterRep.filterStr("a.no_polis",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"where")+"/"+this.sg1.getCell(2,0);			
					this.showFilter = this.filterRep.showFilter(this.sg1);
					this.nama_report="server_report_eclaim2_rptRekapKlaim2";
				}
