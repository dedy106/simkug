window.app_eclaim2_report_flSebab = function(owner)
{
	if (owner)
	{
		window.app_eclaim2_report_flSebab.prototype.parent.constructor.call(this,owner);
		this.className = "app_eclaim2_report_flSebab";
		this.maximize();
...
window.app_eclaim2_report_flSebab.extend(window.portalui_childForm);
window.app_eclaim2_report_flSebab.implement({
	...
	mainButtonClick: function(sender){
		...
		{
			alert("[app_eclaim2_report_flSebab]::mainButtonClick:"+e);
		}
	},
	...
	previewReport: function(dthtml){
		var html = "<div align='center' class='judul_laporan' style='{width:100%;font-size:14;font-weight:bold;}'><br><br>"+this.app._namalokasi.toUpperCase()+"<br>LAPORAN PENYEBAB KERUGIAN <br>";			
		var d = new Date();
