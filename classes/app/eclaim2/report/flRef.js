window.app_eclaim2_report_flRef = function(owner)
{
	if (owner)
	{
		window.app_eclaim2_report_flRef.prototype.parent.constructor.call(this,owner);
		this.className = "app_eclaim2_report_flRef";
		this.maximize();
...
window.app_eclaim2_report_flRef.extend(window.portalui_childForm);
window.app_eclaim2_report_flRef.implement({
	...
	mainButtonClick: function(sender){
		...
		{
			alert("[app_eclaim2_report_flRef]::mainButtonClick:"+e);
		}
	},
	...
	previewReport: function(dthtml){
		var html = "<div align='center' class='judul_laporan' style='{width:100%;font-size:14;font-weight:bold;}'><br><br>"+this.app._namalokasi.toUpperCase()+"<br>LAPORAN DOKUMEN <br>";			
		var d = new Date();
