// JavaScript Document
window.app_eclaim2_report_flLapAwalSwa = function(owner)
{
	if (owner)
	{
		window.app_eclaim2_report_flLapAwalSwa.prototype.parent.constructor.call(this,owner);
		this.className = "app_eclaim2_report_flLapAwalSwa";
		this.maximize();
...
window.app_eclaim2_report_flLapAwalSwa.extend(window.portalui_childForm);
window.app_eclaim2_report_flLapAwalSwa.implement({
