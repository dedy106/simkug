// JavaScript Document
window.app_eclaim2_report_flRiwayatKlaimSwa = function(owner)
{
	if (owner)
	{
		window.app_eclaim2_report_flRiwayatKlaimSwa.prototype.parent.constructor.call(this,owner);
		this.className = "app_eclaim2_report_flRiwayatKlaimSwa";
		this.maximize();
...
window.app_eclaim2_report_flRiwayatKlaimSwa.extend(window.portalui_childForm);
window.app_eclaim2_report_flRiwayatKlaimSwa.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_eclaim2_rptRwyKlaimSum";
			if (this.sg1.getCell(2,11)=="Long")
			{
				this.nama_report="server_report_eclaim2_rptRwyKlaim";
			}
