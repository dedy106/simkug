// JavaScript Document
window.app_eclaim2_report_flVendorKlaim = function(owner)
{
	if (owner)
	{
		window.app_eclaim2_report_flVendorKlaim.prototype.parent.constructor.call(this,owner);
		this.className = "app_eclaim2_report_flVendorKlaim";
		this.maximize();		
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Vendor Klaim", 2);
...
window.app_eclaim2_report_flVendorKlaim.extend(window.portalui_childForm);
window.app_eclaim2_report_flVendorKlaim.implement({
