window.app_eclaim2_report_flJA = function(owner)
{
	if (owner)
	{
		window.app_eclaim2_report_flJA.prototype.parent.constructor.call(this,owner);
		this.className = "app_eclaim2_report_flJA";
		this.maximize();
...
window.app_eclaim2_report_flJA.extend(window.portalui_childForm);
window.app_eclaim2_report_flJA.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.sql =  "select kode_asuransi,skode,  nama "+
							"from tlk_asuransi "+this.filter+
							" order by kode_asuransi ";
				this.scriptSqlCount =  "select count(kode_asuransi) from tlk_asuransi "+this.filter;
		...
		{
			alert("[app_eclaim2_report_flJA]::mainButtonClick:"+e);
		}
	},
