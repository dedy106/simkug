window.app_eclaim2_report_flKlaimDaftar = function(owner)
{
	if (owner)
	{
		window.app_eclaim2_report_flKlaimDaftar.prototype.parent.constructor.call(this,owner);
		this.className = "app_eclaim2_report_flKlaimDaftar";
		this.maximize();
...
window.app_eclaim2_report_flKlaimDaftar.extend(window.portalui_childForm);
window.app_eclaim2_report_flKlaimDaftar.implement({
	...
	mainButtonClick: function(sender){
		...
		{
			alert("[app_eclaim2_report_flKlaimDaftar]::mainButtonClick:"+e);
		}
	},
