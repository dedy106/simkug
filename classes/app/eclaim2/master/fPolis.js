window.app_eclaim2_master_fPolis = function(owner) {
	if (owner){
		window.app_eclaim2_master_fPolis.prototype.parent.constructor.call(this,owner);
		this.maximize();
		this.className  = "app_eclaim2_master_fPolis";		
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Data Polis", 0);	
		uses("saiMemo;saiEdit;uploader;datePicker;checkBox;util_file");
		this.cb_ttg = new saiCBBL(this,{bound:[20,4,200,20], caption:"Tertanggung", btnClick:[this,"doFindBtnClick"],tag:1});		
		//this.ed_periode = new saiLabelEdit(this,{bound:[20,0,200,20],caption:"Periode"});
		this.ed_polis = new saiCBBL(this,{bound:[20,1,300,20], caption:"No Polis", btnClick:[this,"doFindBtnClick"],change:[this,"doChange"], tag:1});		
		this.cb_png = new saiCBBL(this,{bound:[20,5,200,20], caption:"Penanggung", btnClick:[this,"doFindBtnClick"],tag:1});		
		this.cb_ja = new saiCBBL(this,{bound:[20,6,200,20], caption:"Jenis Asuransi", btnClick:[this,"doFindBtnClick"],tag:1});		
		//this.cb_acc = new saiCBBL(this,{bound:[20,7,300,20], caption:"Acc", btnClick:[this,"doFindBtnClick"], tag:1});		
		this.l_tgl = new label(this,{bound:[20,2,100,20],caption:"Tanggal Polis",underline:true});
		this.dp_tgl = new datePicker(this,{bound:[120,2,100,18], selectDate:[this,"doSelectedDate"]});		
		this.l_tglAwal = new label(this,{bound:[20,9,100,20],caption:"Periode Awal",underline:true});
		this.dp_tglAwal = new datePicker(this,{bound:[120,9,100,18]});		
		this.l_tglAkhir = new label(this,{bound:[20,10,100,20],caption:"Periode Akhir",underline:true});
		this.dp_tglAkhir = new datePicker(this,{bound:[120,10,100,18]});		
		this.cb_curr = new saiCBBL(this,{bound:[20,11,200,20], caption:"Currency - Kurs ", btnClick:[this,"doFindBtnClick"], tag:1});		
		this.ed_kurs = new saiEdit(this,{bound:[230,11,80,20],tipeText:ttNilai, text:"",tag:1});
		this.ed_nilai = new saiLabelEdit(this,{bound:[20,12,200,20],caption:"Nilai Pertanggungan",tag:1, tipeText:ttNilai});
		this.ed_premi = new saiLabelEdit(this,{bound:[20,13,200,20],caption:"Nilai Premi",tag:1, tipeText:ttNilai});
		this.ed_obyek = new saiMemo(this,{bound:[20,8,500,50],caption:"Obyek Pertanggungan", tag:1}); 
		this.ed_ket = new saiMemo(this,{bound:[20,13,500,50],caption:"Keterangan", tag:1});
		this.ed_file = new saiLabelEdit(this,{bound:[20,3,300,20],caption:"File Dokumen", readOnly:true, tag:1});
		this.up_file = new uploader(this,{bound:[330,3,80,20],param1:"uploadTo",param2:"server/media/tmp/",param3:"object",param4:"server/media/",autoSubmit:true,afterUpload:[this,"doAfterLoad"], tag:1});
		this.cb_aktif = new checkBox(this,{bound:[20,14,100,20],caption:"Status Aktif",selected:true});
...
window.app_eclaim2_master_fPolis.extend(window.childForm);
window.app_eclaim2_master_fPolis.implement({
	...
	doModalResult: function(event, result){				
		try{					
			...
			switch(event){
				case "simpan" :
					sql.add("insert into tlk_polis (no_polis, tanggal, kode_png, kode_asuransi, kode_ttg, obyek, nilai, periode_awal, periode_akhir, status, kode_kurs, kurs, keterangan, file_dok, kode_lokasi, premi, tgl_input, nik_user)values"+
				...
				break;
				case "ubah" :
					sql.add("update tlk_polis set kode_png = '"+this.cb_png.getText()+"',"+
				...
				break;
				case "hapus" :
					sql.add("delete from tlk_polis where kode_lokasi = '"+this.app._lokasi+"' and no_polis ='"+this.ed_polis.getText()+"'  ");
				break;
			}
	...
	doFindBtnClick: function(sender){
		switch(sender){
			case this.cb_ja : this.standarLib.showListData(this, "Data Jenis Asuransi",sender,undefined, 
											  ...
											  " inner join tlk_asuransi_ttg b on b.kode_asuransi = a.kode_asuransi and b.kode_lokasi = a.kode_lokasi where a.kode_lokasi = '"+this.app._lokasi+"' and b.kode_ttg = '"+this.app._kodeTtg+"'",
			...
			case this.cb_png : this.standarLib.showListData(this, "Data Penangggung",sender,undefined, 
											  "select kode_png, nama from tlk_png where kode_lokasi = '"+this.app._lokasi+"'",
											  "select count(*) from tlk_png where kode_lokasi = '"+this.app._lokasi+"'",											  
	...
	doChange: function(sender){		
		...
		if (sender.getText() != ""){	
			var data = this.dbLib.getDataProvider("select * from tlk_polis where kode_lokasi = '"+this.app._lokasi+"' and no_polis = '"+sender.getText()+"' ",true);
	...
	doClick: function(sender){
		this.ed_polis.setText(this.standarLib.noBuktiOtomatis(this.dbLib,'tlk_polis','no_polis',this.app._lokasi+"-JA.",'000'));
	},
