...
//* 			SAI, PT											
//***********************************************************************************************
window.app_eclaim2_fLogin = function(owner){
	if (owner){
		try{		
			window.app_eclaim2_fLogin.prototype.parent.constructor.call(this, owner);
			this.className  = "app_eclaim2_fLogin";			
			...
			systemAPI.alert("[app_eclaim2_fLogin]::oncreate lib : ",e);
		}
	}
};
window.app_eclaim2_fLogin.extend(window.childForm);
window.app_eclaim2_fLogin.implement({
