window.app_eclaim2_transaksi_fVerV = function(owner)
{
	if (owner)
	{
		window.app_eclaim2_transaksi_fVerV.prototype.parent.constructor.call(this,owner);
		this.className  = "app_eclaim2_transaksi_fVerV";
...
window.app_eclaim2_transaksi_fVerV.extend(window.childForm);
window.app_eclaim2_transaksi_fVerV.implement({
		...
		try
		{
			...
			else
			{
				...
				var sql="select a.no_ver,a.no_klaim,date_format(a.tanggal,'%d/%m/%Y') as tanggal, "+
						"a.no_dokumen,a.keterangan,b.alamat    "+
						"from tlk_ver a "+
