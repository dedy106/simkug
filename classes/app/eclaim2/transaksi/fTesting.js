window.app_eclaim2_transaksi_fTesting = function(owner) {
	if (owner){
		window.app_eclaim2_transaksi_fTesting.prototype.parent.constructor.call(this,owner);
		this.maximize();
		this.className  = "app_eclaim2_transaksi_fTesting";		
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Testing Hasil Survey: Input", 0);	
		...
		this.ed_kode = new saiLabelEdit(this,{bound:[20,2,200,20],caption:"No Testing",readOnly:true});
...
window.app_eclaim2_transaksi_fTesting.extend(window.childForm);
window.app_eclaim2_transaksi_fTesting.implement({
			...
			switch(event){
				...
				case "simpan" :
					if (this.standarLib.checkEmptyByTag(this,[0,1,2])){
						...
						sql.add("insert into tlk_testing (no_testing, no_klaim, periode, tanggal, no_dokumen, kode_lokasi, tgl_input, nik_user, status,keterangan) values"+
