window.app_eclaim2_transaksi_fDokumenK = function(owner) {
	if (owner){
		window.app_eclaim2_transaksi_fDokumenK.prototype.parent.constructor.call(this,owner);
		this.maximize();
		this.className  = "app_eclaim2_transaksi_fDokumenK";		
...
window.app_eclaim2_transaksi_fDokumenK.extend(window.portalui_childForm);
window.app_eclaim2_transaksi_fDokumenK.implement({
	...
	doFindBtnClick: function(sender){
		if (sender == this.cb_klaim){
			this.standarLib.showListData(this, "Data Klaim",sender,undefined, 
										  "select no_klaim, alamat from tlk_klaim where kode_lokasi = '"+this.app._lokasi+"' and kode_ttg='"+this.app._kodeTtg+"' and progress in ('7') and status='1' ",
										  "select count(no_klaim) from tlk_klaim where kode_lokasi = '"+this.app._lokasi+"' and kode_ttg='"+this.app._kodeTtg+"' and progress in ('7') and status='1' ",
		...
		if (sender == this.ed_kode){
			this.standarLib.showListData(this, "Data Dokumen ",sender,undefined, 
										  ...
										  " where a.kode_lokasi = '"+this.app._lokasi+"' and b.kode_ttg='"+this.app._kodeTtg+"' and b.progress='7'  and b.status='1' ",
