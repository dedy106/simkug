window.app_eclaim2_transaksi_fLapView = function(owner,options, callObj)
{
    if (owner)
    {
		try{
	        window.app_eclaim2_transaksi_fLapView.prototype.parent.constructor.call(this, owner,options);        
            this.className = "app_eclaim2_transaksi_fLapView";
...
window.app_eclaim2_transaksi_fLapView.extend(window.portalui_childForm);
window.app_eclaim2_transaksi_fLapView.implement({    
	...
	setValue: function(value){
		var data = this.dbLib.getDataProvider("select a.no_klaim, a.kode_ttg, a.kode_lokasi, a.no_dokumen,a.no_polis, date_format(a.tanggal,'%d/%m/%Y') as tanggal, a.alamat, a.penyebab, "+
			...
			"   h.nama as nama_ttg,c.nama as nama_obyek,d.nama as nama_sebab,g.nama as nama_lok,i.nama as nama_asuransi "+
						" from tlk_klaim a inner join tlk_lokasi b on b.kode_lokasi = a.kode_lokasi and b.kode_lok = a.kode_lok "+
						" inner join tlk_asuransi i on a.kode_lokasi=i.kode_lokasi and a.kode_asuransi=i.kode_asuransi "+
						"	left outer join tlk_obyek c on c.kode_lokasi = a.kode_lokasi and c.kode_obyek = a.kode_obyek "+
						"	left outer join tlk_sebab d on d.kode_lokasi = a.kode_lokasi and d.kode_sebab = a.kode_sebab "+
						"	left outer join tlk_adjust e on e.kode_lokasi = a.kode_lokasi and e.no_klaim = a.no_klaim "+
