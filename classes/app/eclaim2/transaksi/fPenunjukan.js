window.app_eclaim2_transaksi_fPenunjukan = function(owner) {
	if (owner){
		window.app_eclaim2_transaksi_fPenunjukan.prototype.parent.constructor.call(this,owner);
		this.maximize();
		this.className  = "app_eclaim2_transaksi_fPenunjukan";		
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Penunjukan Vendor: Input", 0);	
		...
		this.ed_kode = new saiLabelEdit(this,{bound:[20,2,200,20],caption:"No Penunjukan",readOnly:true});
...
window.app_eclaim2_transaksi_fPenunjukan.extend(window.childForm);
window.app_eclaim2_transaksi_fPenunjukan.implement({
			...
			switch(event){
				...
				case "simpan" :
					if (this.standarLib.checkEmptyByTag(this,[0,1,2])){
						...
						sql.add("insert into tlk_penunjukan (no_penunjukan, no_klaim, periode, tanggal, no_dokumen, kode_lokasi, tgl_input, nik_user, status,keterangan) values"+
