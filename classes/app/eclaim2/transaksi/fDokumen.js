window.app_eclaim2_transaksi_fDokumen = function(owner) {
	if (owner){
		window.app_eclaim2_transaksi_fDokumen.prototype.parent.constructor.call(this,owner);
		this.maximize();
		this.className  = "app_eclaim2_transaksi_fDokumen";		
...
window.app_eclaim2_transaksi_fDokumen.extend(window.childForm);
window.app_eclaim2_transaksi_fDokumen.implement({
	...
	doFindBtnClick: function(sender){
		if (sender == this.cb_klaim){
			this.standarLib.showListData(this, "Data Klaim",sender,undefined, 
										  ...
										  "select count(no_klaim) from tlk_klaim where kode_lokasi = '"+this.app._lokasi+"' and kode_ttg='"+this.app._kodeTtg+"' and progress in ('6') and status='1' ",//"+this.app._userLog+"
