...
//* 			SAI, PT											
//***********************************************************************************************
window.app_eclaim2_transaksi_fBASTV = function(owner,options){
	try{
		if (owner)
		{
			window.app_eclaim2_transaksi_fBASTV.prototype.parent.constructor.call(this, owner,options);
			this.className = "app_eclaim2_transaksi_fBASTV";
			this.maximize();
	...
	{
		alert("[app_eclaim2_transaksi_fBASTV]::contruct:"+e,"");
	}
};
window.app_eclaim2_transaksi_fBASTV.extend(window.childForm);
window.app_eclaim2_transaksi_fBASTV.implement({
