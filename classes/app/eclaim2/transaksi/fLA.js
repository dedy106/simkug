window.app_eclaim2_transaksi_fLA = function(owner) {
	if (owner){
		window.app_eclaim2_transaksi_fLA.prototype.parent.constructor.call(this,owner);
		this.maximize();
		this.className  = "app_eclaim2_transaksi_fLA";		
		...
		this.ed_alamat = new saiLabelEdit(this,{bound:[20,14,400,20],caption:"Lokasi Kejadian", maxLength:100});
		this.ed_penyebab = new saiLabelEdit(this,{bound:[20,15,500,20],caption:"Kronologi", maxLength:200});
		this.ed_tindakan = new saiLabelEdit(this,{bound:[20,16,500,20],caption:"Tindakan", maxLength:200});
		...
		*/
		...
		this.cb_lok.setText(this.app._kodeLok,this.app._namaLok);
	}
};
window.app_eclaim2_transaksi_fLA.extend(window.childForm);
window.app_eclaim2_transaksi_fLA.implement({
	...
	doSelectedDate: function(sender, y, m, d){
	   ...
	   this.polis=this.dbLib.getPeriodeFromSQL("select no_polis as periode from tlk_polis where ('"+this.dp_tgl.getDateString()+"' between periode_awal and periode_akhir)");
	   this.cb_polis.setText(this.polis);
    },
