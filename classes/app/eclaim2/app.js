...
//* 			SAI, PT											
//***********************************************************************************************
window.app_eclaim2_app = function(owner){
	window.app_eclaim2_app.prototype.parent.constructor.call(this, owner);
	this.className = "app_eclaim2_app";
...
window.app_eclaim2_app.extend(window.application);
window.app_eclaim2_app.implement({
	showForm: function(){
		try
		{
			uses("util_dbLib;form;childForm");		
			this._dbSetting = "mysql";			
			this._mainForm = new app_eclaim2_fMain(this);	
	...
	doKeyDown: function(charCode, buttonState, keyCode, event){
		try{			
			window.app_eclaim2_app.prototype.parent.doKeyDown.call(this, charCode, buttonState, keyCode, event);
