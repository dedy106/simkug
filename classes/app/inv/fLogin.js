...
//* 			SAI, PT											
//***********************************************************************************************
window.app_inv_fLogin = function(owner){
	if (owner){
		try{		
			window.app_inv_fLogin.prototype.parent.constructor.call(this, owner);
			this.className  = "app_inv_fLogin";			
			...
			systemAPI.alert("[app_inv_fLogin]::oncreate lib : ",e);
		}
	}
};
window.app_inv_fLogin.extend(window.childForm);
window.app_inv_fLogin.implement({
    mainButtonClick: function(sender){
		try{
			...
			//this.owner.block();	
				...
				this.dbLib.loginAndLoad("select  a.kode_klp_menu, a.nik, a.nama, a.pass, a.status_admin, a.klp_akses, a.kode_lokasi,b.nama as nmlok,c.kode_loker "+
									"from hakakses a "+
									"inner join lokasi b on b.kode_lokasi = a.kode_lokasi "+
									"left join inv_karyawan c on a.nik=c.nik and a.kode_lokasi=c.kode_lokasi "+
