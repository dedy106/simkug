window.app_inv_master_fKaryawan = function(owner)
{
	if (owner)
	{
		window.app_inv_master_fKaryawan.prototype.parent.constructor.call(this,owner);
		this.className  = "app_inv_master_fKaryawan";
...
window.app_inv_master_fKaryawan.extend(window.childForm);
window.app_inv_master_fKaryawan.implement({
