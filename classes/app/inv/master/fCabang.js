window.app_inv_master_fCabang = function(owner)
{
	if (owner)
	{
		window.app_inv_master_fCabang.prototype.parent.constructor.call(this,owner);
		this.className  = "app_inv_master_fCabang";
...
window.app_inv_master_fCabang.extend(window.childForm);
window.app_inv_master_fCabang.implement({
