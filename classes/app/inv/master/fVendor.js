window.app_inv_master_fVendor = function(owner)
{
	if (owner)
	{
		window.app_inv_master_fVendor.prototype.parent.constructor.call(this,owner);
		this.className  = "app_inv_master_fVendor";
...
window.app_inv_master_fVendor.extend(window.childForm);
window.app_inv_master_fVendor.implement({
