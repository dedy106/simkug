window.app_inv_master_fCust = function(owner)
{
	if (owner)
	{
		window.app_inv_master_fCust.prototype.parent.constructor.call(this,owner);
		this.className  = "app_inv_master_fCust";
...
window.app_inv_master_fCust.extend(window.childForm);
window.app_inv_master_fCust.implement({
