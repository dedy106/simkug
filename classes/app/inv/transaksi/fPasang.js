window.app_inv_transaksi_fPasang = function(owner)
{
	if (owner)
	{
		window.app_inv_transaksi_fPasang.prototype.parent.constructor.call(this,owner);
		this.className  = "app_inv_transaksi_fPasang";
...
window.app_inv_transaksi_fPasang.extend(window.childForm);
window.app_inv_transaksi_fPasang.implement({
