window.app_inv_transaksi_fStatus = function(owner)
{
	if (owner)
	{
		window.app_inv_transaksi_fStatus.prototype.parent.constructor.call(this,owner);
		this.className  = "app_inv_transaksi_fStatus";
...
window.app_inv_transaksi_fStatus.extend(window.childForm);
window.app_inv_transaksi_fStatus.implement({
