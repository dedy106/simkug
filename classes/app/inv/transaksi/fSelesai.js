window.app_inv_transaksi_fSelesai = function(owner)
{
	if (owner)
	{
		window.app_inv_transaksi_fSelesai.prototype.parent.constructor.call(this,owner);
		this.className  = "app_inv_transaksi_fSelesai";
...
window.app_inv_transaksi_fSelesai.extend(window.childForm);
window.app_inv_transaksi_fSelesai.implement({
