...
//* 			SAI, PT											
//***********************************************************************************************
window.app_inv_fMain = function(owner)
{
	if (owner)
	{	
		try
		{
			window.app_inv_fMain.prototype.parent.constructor.call(this, owner);			
...
window.app_inv_fMain.extend(window.form);
window.app_inv_fMain.implement({
	gotoLogin: function(){
		uses("app_inv_fLogin");
		this.form = new app_inv_fLogin(this);
	...
	initDashboard: function(){		
		uses("saiCBBL;saiEdit;saiGrid;;util_ajaxCaller;sgNavigator;pageControl;app_inv_dashboard;fileExplorer;listView;util_file;PopUpMenu;MenuItem;app_inv_remote_dataProvider");
		this.dashboard = new app_inv_dashboard(this,{bound:[this.treev.width + 20, this.treev.top, this.width - this.treev.width - 30, this.treev.height]});		
	},
