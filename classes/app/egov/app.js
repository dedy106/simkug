...
//* 			SAI, PT											
//***********************************************************************************************
window.app_egov_app = function(owner){
	window.app_egov_app.prototype.parent.constructor.call(this, owner);
	this.className = "app_egov_app";
	this.onTerminate.set(this,"doTerminate");
	this.form = undefined;
	this.setTitle("jamboo eGoverment");
	this.showForm();
};
window.app_egov_app.extend(window.portalui_application);
window.app_egov_app.implement({
	showForm: function(){
		try
		{
			var step = "load";			
	...
	doKeyDown: function(charCode, buttonState, keyCode, event){
		try{			
			window.app_egov_app.prototype.parent.doKeyDown.call(this, charCode, buttonState, keyCode, event);			
