...
//* 			SAI, PT											
//***********************************************************************************************
window.app_egov_fUserPwd = function(owner)
{
	if (owner)
	{
		window.app_egov_fUserPwd.prototype.parent.constructor.call(this,owner);
		this.className  = "app_egov_fUserPwd";
		this.setTop(60);
		this.setWidth(1280);
		this.setHeight(550);
...
window.app_egov_fUserPwd.extend(window.portalui_childForm);
//------------------------------------------------------------------ event
window.app_egov_fUserPwd.prototype.mainButtonClick = function(sender){
...
window.app_egov_fUserPwd.prototype.doModalResult = function(event, modalResult){
...
window.app_egov_fUserPwd.prototype.keyPress = function(sender, charCode, buttonState ){
//	setTipeButton(tbSimpan);
};
window.app_egov_fUserPwd.prototype.doEditChange = function(sender){
};											  
window.app_egov_fUserPwd.prototype.EditExit = function(sender){
};
window.app_egov_fUserPwd.prototype.FindBtnClick = function(sender, event){
	try{
...
window.app_egov_fUserPwd.prototype.doRequestReady = function(sender, methodName, result){
	switch	(methodName){
		case "execArraySQL" :
