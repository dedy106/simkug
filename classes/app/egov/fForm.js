...
//* 			SAI, PT											
//***********************************************************************************************
window.app_egov_fForm = function(owner){
	if (owner){
		try
		{			
			window.app_egov_fForm.prototype.parent.constructor.call(this,owner);
			this.className  = "app_egov_fForm";					
...
window.app_egov_fForm.extend(window.portalui_childForm);
//------------------------------------------------------------------ event
window.app_egov_fForm.implement({
