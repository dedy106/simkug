...
//* 			SAI, PT											
//***********************************************************************************************
window.app_egov_fMain = function(owner)
{
	if (owner)
	{	
		try
		{
			window.app_egov_fMain.prototype.parent.constructor.call(this, owner);
			window.app_egov_fMain.prototype.parent.setWidth.call(this, 600);
			window.app_egov_fMain.prototype.parent.setHeight.call(this, 450);
			...
			this.bGenLocal = new portalui_imageButton(this.pTool,{bound:[413,5,17,15],hint:"Front End",image:"icon/"+system.getThemes()+"/bGenLocal.png",click:[this,"gotoFrontEnd"]});
...
window.app_egov_fMain.extend(window.portalui_form);
window.app_egov_fMain.implement({
	gotoLogin: function(){
		uses("app_egov_fLogin");
		this.form = new app_egov_fLogin(this);
