...
//* 			SAI, PT											
//***********************************************************************************************
window.app_eclaim_fLogin = function(owner){
	if (owner){
		try{		
			window.app_eclaim_fLogin.prototype.parent.constructor.call(this, owner);
			this.className  = "app_eclaim_fLogin";			
			...
			systemAPI.alert("[app_eclaim_fLogin]::oncreate lib : ",e);
		}
	}
};
window.app_eclaim_fLogin.extend(window.childForm);
window.app_eclaim_fLogin.implement({
    ...
    mainButtonClick: function(sender){
		try{
			...
			this.dbLib.loginAndLoad("select  a.kode_klp_menu, a.nik, a.nama, a.pass, a.status_admin, a.kode_lokasi, a.klp_akses, a.kode_ttg,b.nama,"+
									"	     c.nama as nama_ttg, c.gambar, a.kode_lok, d.nama as nmLok,a.email, e.email_adm,e.email_ttg "+
									"from eclaim_hakakses a "+
									"inner join lokasi b on b.kode_lokasi = a.kode_lokasi "+
									"inner join eclaim_ttg c on a.kode_ttg=c.kode_ttg  "+
									"left join eclaim_lokasi d on d.kode_ttg = a.kode_ttg and d.kode_lok = a.kode_lok "+
									"left join eclaim_spro e on a.kode_ttg=e.kode_ttg "+
