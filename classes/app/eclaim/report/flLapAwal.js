window.app_eclaim_report_flLapAwal = function(owner)
{
	if (owner)
	{
		window.app_eclaim_report_flLapAwal.prototype.parent.constructor.call(this,owner);
		this.className = "app_eclaim_report_flLapAwal";
		this.maximize();
...
window.app_eclaim_report_flLapAwal.extend(window.childForm);
window.app_eclaim_report_flLapAwal.implement({
	doEllipseClick: function(sender, col, row){
		...
		if (row == 5)
		{
			...
			this.filter = this.filterRep.filterStr("a.periode",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where") +
					  ...
					  this.filterRep.filterStr("a.kode_lok",this.sg1.getCell(1,4),this.sg1.getCell(2,4),this.sg1.getCell(3,4),"and")+user_lok;
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_eclaim_rptLapAwal";
			...
			systemAPI.alert("[app_eclaim_report_flLapAwal]::mainButtonClick:"+e);
		}
	},
