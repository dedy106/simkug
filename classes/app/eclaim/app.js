...
//* 			SAI, PT											
//***********************************************************************************************
window.app_eclaim_app = function(owner){
	window.app_eclaim_app.prototype.parent.constructor.call(this, owner);
	this.className = "app_eclaim_app";
...
window.app_eclaim_app.extend(window.application);
window.app_eclaim_app.implement({
	showForm: function(){
		try
		{
			uses("util_dbLib;form;childForm");		
			this._dbSetting = "mysql";			
			this._mainForm = new app_eclaim_fMain(this);	
	...
	doKeyDown: function(charCode, buttonState, keyCode, event){
		try{			
			window.app_eclaim_app.prototype.parent.doKeyDown.call(this, charCode, buttonState, keyCode, event);
