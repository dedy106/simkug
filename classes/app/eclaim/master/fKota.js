window.app_eclaim_master_fKota = function(owner)
{
	if (owner){
		window.app_eclaim_master_fKota.prototype.parent.constructor.call(this, owner);
		this.className = "app_eclaim_master_fKota";
...
window.app_eclaim_master_fKota.extend(window.portalui_childForm);
window.app_eclaim_master_fKota.implement({
...
window.app_eclaimg_master_fFrameAdd.extend(window.portalui_commonForm);
