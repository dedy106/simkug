window.app_saku_kb_report_flPjSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku_kb_report_flPjSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_kb_report_flPjSaldo";
		this.maximize();
...
window.app_saku_kb_report_flPjSaldo.extend(window.portalui_childForm);
window.app_saku_kb_report_flPjSaldo.prototype.doEllipseClick= function(sender, col, row)
{
	if (row ==1)
	{
...
window.app_saku_kb_report_flPjSaldo.prototype.doSelectCell = function(sender, col, row)
{
...
window.app_saku_kb_report_flPjSaldo.prototype.mainButtonClick = function(sender)
{
	try
	{
		...
		if (this.sg1.getCell(1,1) == "=")
		{
			...
			if (this.sg1.getCell(2,3)=="Per Akun")
			{
				...
				this.nama_report="server_report_kb_rptPjSaldo";
			}
...
window.app_saku_kb_report_flPjSaldo.prototype.doRequestReady = function(sender, methodName, result)
{
	switch (methodName)
	{
		case "preview" : 
...
window.app_saku_kb_report_flPjSaldo.prototype.doSelectedPage = function(sender, page)
{
	this.report.preview(this.nama_report,this.filter, page,this.pager, this.showFilter,this.lokasi, this.filter2);
	this.page=page;
	this.allBtn = false;
};
window.app_saku_kb_report_flPjSaldo.prototype.doCloseReportClick = function(sender)
{
...
window.app_saku_kb_report_flPjSaldo.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_saku_kb_report_flPjSaldo.prototype.doRowPerPageChange = function(sender, rowperpage)
{
