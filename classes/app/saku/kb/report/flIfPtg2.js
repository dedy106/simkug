window.app_saku_kb_report_flIfPtg2 = function(owner)
{
	if (owner)
	{
		window.app_saku_kb_report_flIfPtg2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_kb_report_flIfPtg2";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Pertanggungjawaban Penggunaan Kas Kecil", 2);
	...
	this.getPeriode="select distinct periode from ifptg_m where kode_lokasi ='"+this.lokasi+"' order by periode desc ";
...
window.app_saku_kb_report_flIfPtg2.extend(window.portalui_childForm);
window.app_saku_kb_report_flIfPtg2.implement({
	...
	doSelectCell: function(sender, col, row)
	{
		...
		if (this.userStatus==="A"){
			this.filterRep.setSGFilterRowTipe(this.sg1, row,new Array(0,1,2,3,4),new  Array("3","3","13","3","13"));
	...
	mainButtonClick: function(sender)
	{
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				if (this.sg1.getCell(2,3) === "REIMBURSE"){
					this.nama_report="server_report_kb_rptIFPtg2";
