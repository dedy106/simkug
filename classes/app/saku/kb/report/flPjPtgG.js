window.app_saku_kb_report_flPjPtgG = function(owner)
{
	if (owner)
	{
		window.app_saku_kb_report_flPjPtgG.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_kb_report_flPjPtgG";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Pertanggungjawaban Panjar Kerja", 2);
...
window.app_saku_kb_report_flPjPtgG.extend(window.portalui_childForm);
window.app_saku_kb_report_flPjPtgG.implement({
	...
	mainButtonClick: function(sender)
	{
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_kb_rptPjPtgG";
