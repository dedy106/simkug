window.app_saku_kb_report_flSpbG = function(owner)
{
	if (owner)
	{
		window.app_saku_kb_report_flSpbG.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_kb_report_flSpbG";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Surat Perintah Bayar", 2);
...
window.app_saku_kb_report_flSpbG.extend(window.portalui_childForm);
window.app_saku_kb_report_flSpbG.implement({
	...
	mainButtonClick: function(sender)
	{
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report="server_report_kb_rptSpbG";
