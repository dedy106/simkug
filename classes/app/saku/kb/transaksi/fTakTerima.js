window.app_saku_kb_transaksi_fTakTerima = function(owner){
	if (owner)
	{
		window.app_saku_kb_transaksi_fTakTerima.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_kb_transaksi_fTakTerima";
		this.maximize();
		this.itemsValue = new portalui_arrayList();	
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form TAK Kas Bank Terima : Input", 0);
		...
		uses("portalui_datePicker;portalui_saiGrid;portalui_sgNavigator;app_saku_fJurnalViewer;util_dbLarge");	
...
window.app_saku_kb_transaksi_fTakTerima.extend(window.portalui_childForm);
window.app_saku_kb_transaksi_fTakTerima.implement({
		...
		if (this.standarLib.checkEmptyByTag(this, new Array("0")))
		{
			try
			{
				...
				sql.add("insert into kas_m (no_kas,kode_lokasi,no_dokumen,no_bg,akun_kb,tanggal,keterangan,kode_pp,modul,jenis,"+
						...
						"('"+this.ed_nb.getText()+"','"+this.app._lokasi+"','"+this.ed_dok.getText()+"','"+this.ed_giro.getText()+"','"+this.cb_akun.getText()+"','"+this.dp_tgl1.getDate()+"','"+this.ed_desc.getText()+"','-','KBI_NP','"+this.jenis+"','"+
				...
				sql.add("insert into kas_j (no_kas,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,nilai,kode_pp,kode_drk,ref1,"+
						...
						"('"+this.ed_nb.getText()+"','"+this.ed_dok.getText()+"','"+this.dp_tgl1.getDate()+"',0,'"+this.cb_akun.getText()+
				...
				{		
					if (this.sg1.rowValid(i)){
						...
						sql.add("insert into angg_r (no_bukti,modul,kode_lokasi,kode_akun,kode_pp,kode_drk,periode1,periode2,dc,saldo,nilai) values "+	
								"('"+this.ed_nb.getText()+"','KBINP','"+this.app._lokasi+"','"+this.sg1.getCell(0,i)+"','"+this.sg1.getCell(5,i)+"','"+this.sg1.getCell(7,i)+"','"+
								this.ed_period.getText()+"','"+this.ed_period.getText()+"','"+this.sg1.getCell(3,i)+"',0,"+parseNilai(this.sg1.getCell(4,i))+")");
					}
				}
				sql.add("update kas_m set no_bukti2 = '"+this.ed_nb.getText()+"' where kode_lokasi2 ='"+this.app._lokasi+"' and kode_lokasi = '"+this.cb_lokasi.getText()+"' and no_kas = '"+this.cb_nbkirim.getText()+"' ");
	...
	doChange: function(sender){
		if (sender == this.cb_lokasi){
			...
			this.cb_nbkirim.setSQL("select no_kas, keterangan from kas_m where kode_lokasi2 = '"+this.app._lokasi+"' and kode_lokasi = '"+this.cb_lokasi.getText()+"' and no_bukti2 = '-'  and jenis like 'T%'",["no_kas","keterangan"],false,["No KAS","Keterangan"],"and","Daftar TAK Kirim",true);
	...
	doFindBtnClick: function(sender, col, row){
		...
		{
			alert("[app_saku_kb_transaksi_fTakTerima] : doFindBtnClick : " + e);
		}
	},
	doNilaiChange: function(){
		...
		{
			alert("[app_saku_kb_transaksi_fTakTerima]::doNilaiChange:"+e);
		}
	},
	doCellEnter: function(sender, col, row){
		...
		{
			alert("app_saku_kb_transaksi_fTakTerima::doCellEnter : " + e);
			}	
	},
