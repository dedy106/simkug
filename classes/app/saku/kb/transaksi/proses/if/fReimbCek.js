window.app_saku_kb_transaksi_proses_if_fReimbCek= function(owner)
{
	if (owner)
	{
		window.app_saku_kb_transaksi_proses_if_fReimbCek.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_kb_transaksi_proses_if_fReimbCek";
		this.maximize();
...
window.app_saku_kb_transaksi_proses_if_fReimbCek.extend(window.portalui_childForm);
window.app_saku_kb_transaksi_proses_if_fReimbCek.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_kb_transaksi_proses_if_fReimbCek.prototype.simpan = function(){	
	this.hitungGar();
...
window.app_saku_kb_transaksi_proses_if_fReimbCek.prototype.doModalResult = function(event, modalResult)
{
		...
		case "simpan" :
			...
			*/
			if  (nilaiToFloat(this.ed_nilaiif.getText()) < nilaiToFloat(this.ed_nilai.getText())){
				system.alert(this,"Nilai pengajuan pertanggungan tidak valid.","Nilai tidak boleh melebihi saldo IF.");
				return false;
			}
			if  (nilaiToFloat(this.ed_nilai.getText()) < 0){
...
window.app_saku_kb_transaksi_proses_if_fReimbCek.prototype.genClick = function(sender)
{
	try
	{
...
window.app_saku_kb_transaksi_proses_if_fReimbCek.prototype.doSelect = function(sender, year, month, day)
{
	if (month < 10)
		month = "0"+month;
...
window.app_saku_kb_transaksi_proses_if_fReimbCek.prototype.doEditChange = function(sender)
{
...
window.app_saku_kb_transaksi_proses_if_fReimbCek.prototype.showClick = function(sender)
{
	try 
	{
...
window.app_saku_kb_transaksi_proses_if_fReimbCek.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_saku_kb_transaksi_proses_if_fReimbCek.prototype.doCellExit = function(sender, col, row) 
{
	try
	{
		switch(col)
...
window.app_saku_kb_transaksi_proses_if_fReimbCek.prototype.doCellEnter = function(sender, col, row) 
{
	try
	{
		switch(col)
...
window.app_saku_kb_transaksi_proses_if_fReimbCek.prototype.doFindBtnClick = function(sender, col, row) 
{
	try
	{
		switch(col)
...
window.app_saku_kb_transaksi_proses_if_fReimbCek.prototype.doSgChange=function(sender, col, row){
   try{
...
window.app_saku_kb_transaksi_proses_if_fReimbCek.prototype.doNilaiChange = function()
{
	try
	{
		var totD = totC = nKB = 0; 
...
window.app_saku_kb_transaksi_proses_if_fReimbCek.prototype.hitungGar = function()
{
...
window.app_saku_kb_transaksi_proses_if_fReimbCek.prototype.garClick = function(sender)
{
	try
	{
...
window.app_saku_kb_transaksi_proses_if_fReimbCek.prototype.loadMasterData =  function(){
...
window.app_saku_kb_transaksi_proses_if_fReimbCek.prototype.doRequestReady = function(sender, methodName, result)
{
...
window.app_saku_kb_transaksi_proses_if_fReimbCek.prototype.doCloseReportClick = function(sender){
...
window.app_saku_kb_transaksi_proses_if_fReimbCek.prototype.clearLayar = function(sender){
