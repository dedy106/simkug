window.app_saku_kb_transaksi_proses_pj_fPtgajuk= function(owner){
	if (owner){
		window.app_saku_kb_transaksi_proses_pj_fPtgajuk.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_kb_transaksi_proses_pj_fPtgajuk";
		this.maximize();
		this.itemsValue = new portalui_arrayList();	
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Pengajuan Pertanggungan Panjar: Koreksi", 0);
		...
		this.cb_preview = new portalui_checkBox(this.p1,{bound:[this.p1.width - 100,213,16],caption:"Preview",checked:true});
		/*
...
window.app_saku_kb_transaksi_proses_pj_fPtgajuk.extend(window.portalui_childForm);
window.app_saku_kb_transaksi_proses_pj_fPtgajuk.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_kb_transaksi_proses_pj_fPtgajuk.prototype.ubah = function(){
...
window.app_saku_kb_transaksi_proses_pj_fPtgajuk.prototype.doModalResult = function(event, modalResult)
{
...
window.app_saku_kb_transaksi_proses_pj_fPtgajuk.prototype.genClick = function(sender)
{
	try
	{
...
window.app_saku_kb_transaksi_proses_pj_fPtgajuk.prototype.doSelect = function(sender, year, month, day)
{
	if (month < 10)
		month = "0"+month;
	this.ed_period.setText(year.toString()+month);
};
window.app_saku_kb_transaksi_proses_pj_fPtgajuk.prototype.doEditChange = function(sender)
{
...
window.app_saku_kb_transaksi_proses_pj_fPtgajuk.prototype.showClick = function(sender)
{
		...
		if (this.cb_bukti != undefined) {
			try 
			{
				...
				var line,data = this.dbLib.runSQL(" select  a.no_pj, a.no_dokumen, a.keterangan, a.kode_curr, a.kurs, a.nik_buat, a.nik_setuju, b.nama as nama_buat, c.nama as nama_setuju,a.tanggal, "+
												  "         a.periode,a.akun_pj,x.keterangan as ket,x.nilai as nilai_pj,x.periode as periode_pj "+
...
window.app_saku_kb_transaksi_proses_pj_fPtgajuk.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_saku_kb_transaksi_proses_pj_fPtgajuk.prototype.doCellExit = function(sender, col, row) 
{
	try
	{
		switch(col)
...
window.app_saku_kb_transaksi_proses_pj_fPtgajuk.prototype.doNilaiChange = function()
{
	try
	{
		var totD = totC = nKB = 0; 
...
window.app_saku_kb_transaksi_proses_pj_fPtgajuk.prototype.hitungGar = function()
{
...
window.app_saku_kb_transaksi_proses_pj_fPtgajuk.prototype.garClick = function(sender)
{
	try
	{
...
window.app_saku_kb_transaksi_proses_pj_fPtgajuk.prototype.doRequestReady = function(sender, methodName, result)
{
