window.app_saku_kb_transaksi_proses_fSpb= function(owner)
{
	if (owner)
	{
		window.app_saku_kb_transaksi_proses_fSpb.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_kb_transaksi_proses_fSpb";
		this.maximize();
		this.itemsValue = new portalui_arrayList();	
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Surat Permintaan Pembayaran: Input", 0);	
...
window.app_saku_kb_transaksi_proses_fSpb.extend(window.portalui_childForm);
window.app_saku_kb_transaksi_proses_fSpb.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_kb_transaksi_proses_fSpb.prototype.simpan = function()
{
...
window.app_saku_kb_transaksi_proses_fSpb.prototype.doModalResult = function(event, modalResult)
{
...
window.app_saku_kb_transaksi_proses_fSpb.prototype.genClick = function(sender)
{
	try{
...
window.app_saku_kb_transaksi_proses_fSpb.prototype.doSelect = function(sender, year, month, day)
{
	if (month < 10)
		month = "0"+month;
...
window.app_saku_kb_transaksi_proses_fSpb.prototype.doEditChange = function(sender)
{
...
window.app_saku_kb_transaksi_proses_fSpb.prototype.FindBtnClick = function(sender, event)
{
	try
	{
		if (sender == this.cb_curr) 
...
window.app_saku_kb_transaksi_proses_fSpb.prototype.doSgChange= function(sender, col, row){
   try{
...
window.app_saku_kb_transaksi_proses_fSpb.prototype.doCellExit = function(sender, col, row) 
{
	try
	{
		switch(col)
...
window.app_saku_kb_transaksi_proses_fSpb.prototype.doCellEnter = function(sender, col, row) 
{
	try
	{
		switch(col)
...
window.app_saku_kb_transaksi_proses_fSpb.prototype.doFindBtnClick = function(sender, col, row) 
{
	try
	{
		switch(col)
...
window.app_saku_kb_transaksi_proses_fSpb.prototype.doNilaiChange = function()
{
	try
	{
		var totD = totC = nKB = 0; 
...
window.app_saku_kb_transaksi_proses_fSpb.prototype.hitungGar = function()
{
...
window.app_saku_kb_transaksi_proses_fSpb.prototype.garClick = function(sender)
{
	try
	{
...
window.app_saku_kb_transaksi_proses_fSpb.prototype.doRequestReady = function(sender, methodName, result)
{
    			...
    			case "execArraySQL" :
					...
					if (result.toLowerCase().search("error") == -1)					
					{
						...
						if (this.cb1.isSelected()) {
							//if (this.app._lokasi=== "31" || this.app._lokasi === "21")
							this.nama_report="server_report_kb_rptSpp";
							this.filter = " where a.kode_lokasi='"+this.app._lokasi+"' and a.periode='"+this.ed_period.getText()+"' and a.no_spb='"+this.ed_nb.getText()+"' ";
							this.filter2 = "";
							this.viewer.prepare();
...
window.app_saku_kb_transaksi_proses_fSpb.prototype.clearLayar = function(){
...
window.app_saku_kb_transaksi_proses_fSpb.prototype.loadMasterData = function(){
...
window.app_saku_kb_transaksi_proses_fSpb.prototype.doCloseReportClick= function(sender)
{
