window.app_saku_kb_transaksi_proses_depo_fDepotmp = function(owner)
{
	if (owner)
	{
		window.app_saku_kb_transaksi_proses_depo_fDepotmp.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_kb_transaksi_proses_depo_fDepotmp";
		this.maximize();
...
window.app_saku_kb_transaksi_proses_depo_fDepotmp.extend(window.portalui_childForm);
window.app_saku_kb_transaksi_proses_depo_fDepotmp.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_kb_transaksi_proses_depo_fDepotmp.prototype.simpan = function()
{
	...
	if (this.standarLib.checkEmptyByTag(this,["0","1","2","3"]))
	{
		try
		{
			...
			sql.add("insert into depo_m (no_depo,no_kas,no_dokumen,tanggal,due_date,tgl_akru,bank,cabang,rate,basis,"+
					...
					"('"+this.ed_nb.getText()+"','-','"+this.ed_dok.getText()+"','"+this.dp_tgl1.getDate()+"','"+this.dp_tgl2.getDate()+"','"+this.dp_tgl1.getDate()+"','"+this.ed_bank.getText()+"','"+this.ed_cabang.getText()+"',"+parseNilai(this.ed_bunga.getText())+","+parseNilai(this.ed_basis.getText())+","+
...
window.app_saku_kb_transaksi_proses_depo_fDepotmp.prototype.doModalResult = function(event, modalResult)
{
...
window.app_saku_kb_transaksi_proses_depo_fDepotmp.prototype.genClick = function(sender)
{
	try
	{
...
window.app_saku_kb_transaksi_proses_depo_fDepotmp.prototype.doSelect = function(sender, year, month, day)
{
	if (month < 10)
		month = "0"+month;
	this.ed_period.setText(year.toString()+month);
};
window.app_saku_kb_transaksi_proses_depo_fDepotmp.prototype.doEditChange = function(sender)
{
...
window.app_saku_kb_transaksi_proses_depo_fDepotmp.prototype.showClick = function(sender)
{
	try
	{
...
window.app_saku_kb_transaksi_proses_depo_fDepotmp.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_saku_kb_transaksi_proses_depo_fDepotmp.prototype.doRequestReady = function(sender, methodName, result)
{
