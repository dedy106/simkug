window.app_saku_kb_transaksi_fVerspb = function(owner)
{
	if (owner)
	{
		window.app_saku_kb_transaksi_fVerspb.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_kb_transaksi_fVerspb";
		this.maximize();
		this.itemsValue = new portalui_arrayList();	
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Verifikasi Dokumen KasBank Keluar: Input", 0);	
		...
		this.cb_status.addItem(0,"SPB");
		this.cb_status.addItem(1,"SPP");
		this.cb_status.addItem(2,"PJR");
		this.cb_status.addItem(3,"I/F");
		this.cb_status.addItem(4,"PJ.PTG");
		this.cb_status.addItem(5,"PR.PTG");
		this.cb_status.addItem(6,"IF.PTG");
		this.cb_status.addItem(7,"DP.KRM");
		this.cb_status.addItem(8,"DEPO");
		this.cb_status.addItem(9,"A/P");
		this.cb_status.addItem(10,"KP.SPB");
		...
		this.ed_cari.setTag("9");
		
		this.b_cari = new portalui_imageButton(this,{bound:[570,144,20,20],hint:"Cari",image:"icon/"+system.getThemes()+"/tabCont2.png",click:[this,"doCariClick"]});
...
window.app_saku_kb_transaksi_fVerspb.extend(window.portalui_childForm);
window.app_saku_kb_transaksi_fVerspb.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_kb_transaksi_fVerspb.prototype.simpan = function()
{
	this.bGen.click();
		...
		try
		{
			...
			for (var i in this.sg1.data.rs.rows){
				...
				if (line.status != "INPROG")
				{
					...
					if (line[this.sg1.tableColumn[2]] == "PJR")
					{
						if (line[this.sg1.tableColumn[0]] == "APP")
						{
							sql.add("update panjar_m set progress='1' where no_pj='"+line[this.sg1.tableColumn[3]]+"' and kode_lokasi='"+this.app._lokasi+"'");
						}
						if (line[this.sg1.tableColumn[0]] == "NONAPP")
						{
							sql.add("update panjar_m set progress='X' where no_pj='"+line[this.sg1.tableColumn[3]]+"' and kode_lokasi='"+this.app._lokasi+"'");
						}
					}
				
					if (line[this.sg1.tableColumn[2]] == "PJ.PTG" || line[this.sg1.tableColumn[2]] == "PR.PTG")
					{
						if (line[this.sg1.tableColumn[0]] == "APP")
						{
							if (line[this.sg1.tableColumn[2]] == "PJ.PTG") {
								if (parseFloat(line[this.sg1.tableColumn[9]]) == parseFloat(line[this.sg1.tableColumn[12]])){
									var progress = "2";
								} else { var progress = "1"; }
							}
							if (line[this.sg1.tableColumn[2]] == "PR.PTG") {
								if (parseFloat(line[this.sg1.tableColumn[12]])==0){
									var progress = "3";
								} else { var progress = "2"; }
							}
							sql.add("update ptg_m set progress='"+progress+"' where no_ptg='"+line[this.sg1.tableColumn[3]]+"' and kode_lokasi='"+this.app._lokasi+"'");
						}
						if (line[this.sg1.tableColumn[0]] == "NONAPP")
						{
							sql.add("update ptg_m set progress='X' where no_ptg='"+line[this.sg1.tableColumn[3]]+"' and kode_lokasi='"+this.app._lokasi+"'");
						}						
					}
					if (line[this.sg1.tableColumn[2]] == "I/F")
					{
						if (line[this.sg1.tableColumn[0]] == "APP")
						{
							sql.add("update if_m set progress='1' where no_if='"+line[this.sg1.tableColumn[3]]+"' and kode_lokasi='"+this.app._lokasi+"'");
						}
						if (line[this.sg1.tableColumn[0]] == "NONAPP")
						{
							sql.add("update if_m set progress='X' where no_if='"+line[this.sg1.tableColumn[3]]+"' and kode_lokasi='"+this.app._lokasi+"'");
						}
					}
					if (line[this.sg1.tableColumn[2]]== "IF.PTG")
					{
						if (line[this.sg1.tableColumn[0]] == "APP")
						{
							if (line[this.sg1.tableColumn[11]] == "CLOSING"){ //(parseFloat(line[this.sg1.tableColumn[9]]) == parseFloat(line[this.sg1.tableColumn[12]])) && 
								var progress = "2";
							} else { var progress = "1"; }
							sql.add("update ifptg_m set progress='"+progress+"' where no_ifptg='"+line[this.sg1.tableColumn[3]]+"' and kode_lokasi='"+this.app._lokasi+"'");
						}
						if (line[this.sg1.tableColumn[0]] == "NONAPP")
						{
							sql.add("update ifptg_m set progress='X' where no_ifptg='"+line[this.sg1.tableColumn[3]]+"' and kode_lokasi='"+this.app._lokasi+"'");
						}
					}
					if (line[this.sg1.tableColumn[2]] == "DP.KRM")
					{
						if (line[this.sg1.tableColumn[0]] == "APP")
						{
							sql.add("update dropkrm_m set progress='1' where no_kirim='"+line[this.sg1.tableColumn[3]]+"' and kode_lokasi='"+this.app._lokasi+"'");
						}
						if (line[this.sg1.tableColumn[0]] == "NONAPP")
						{
							sql.add("update dropkrm_m set progress='X' where no_kirim='"+line[this.sg1.tableColumn[3]]+"' and kode_lokasi='"+this.app._lokasi+"'");
						}
					}
					if (line[this.sg1.tableColumn[2]] == "DEPO")
					{
						if (line[this.sg1.tableColumn[0]] == "APP")
						{
							sql.add("update depo_m set progress='1' where no_depo='"+line[this.sg1.tableColumn[3]]+"' and kode_lokasi='"+this.app._lokasi+"'");
						}
						if (line[this.sg1.tableColumn[0]] == "NONAPP")
						{
							sql.add("update depo_m set progress='X' where no_depo='"+line[this.sg1.tableColumn[3]]+"' and kode_lokasi='"+this.app._lokasi+"'");
						}
					}
				}
			}								
...
window.app_saku_kb_transaksi_fVerspb.prototype.doModalResult = function(event, modalResult)
{
...
window.app_saku_kb_transaksi_fVerspb.prototype.pAllClick = function(sender)
{
	for (var i=0; i < this.sg1.rows.getLength(); i++)
	{
...
window.app_saku_kb_transaksi_fVerspb.prototype.doCariClick = function(sender){
	for (var i=0; i < this.sg1.rows.getLength(); i++){
...
window.app_saku_kb_transaksi_fVerspb.prototype.doSelectedPage = function(sender, page)
{
	//this.dbLib.listData(this.scriptSql, page, this.baris);
	this.loadDataApproval(page, this.baris);
};
window.app_saku_kb_transaksi_fVerspb.prototype.showClick = function(sender)
{
	try
	{
		this.sg1.clear();
		...
		if (this.cb_status.getText() != "")
		{
			if (this.cb_status.getText() == "KP.SPB") {
				...
				this.scriptSql = "select 'INPROG' as status,'-' as catatan,a.modul,a.no_spb,b.nama as nama_pp,a.tanggal,"+
								...
								"where a.jenis in ('SIMP','SIMPDEPO','PBRGDEPO','PINJDEPO') and a.modul = '"+this.cb_status.getText()+"' and a.progress='0' and a.periode<='"+this.ed_period.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"'"+
								"union "+
								"select 'INPROG' as status,'-' as catatan,a.modul,a.no_spb,b.nama as nama_pp,a.tanggal,"+
								"       a.due_date,a.keterangan,a.kode_curr,a.nilai+a.nilai_ppn as nilai, "+  //nilai_pot sudah include di nilai
								"       c.nama as pemohon, d.nama as peruntukan, 0 as nilai_lain "+
								"from spb_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
								"             inner join karyawan c on c.nik=a.nik_buat and a.kode_lokasi=c.kode_lokasi "+
								"             inner join kop_loker d on d.kode_loker=a.kode_terima and a.kode_lokasi=d.kode_lokasi "+
								"where a.jenis = 'PINJ' and a.modul = '"+this.cb_status.getText()+"' and a.progress='0' and a.periode<='"+this.ed_period.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"'"+
								"union "+
								"select 'INPROG' as status,'-' as catatan,a.modul,a.no_spb,b.nama as nama_pp,a.tanggal,"+
								"       a.due_date,a.keterangan,a.kode_curr,a.nilai+a.nilai_ppn as nilai, "+  //nilai_pot sudah include di nilai
								"       c.nama as pemohon, d.nama as peruntukan, 0 as nilai_lain "+
								...
								"where a.jenis = 'PBRG' and a.modul = '"+this.cb_status.getText()+"' and a.progress='0' and a.periode<='"+this.ed_period.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"'"+
								"union "+
								"select 'INPROG' as status,'-' as catatan,a.modul,a.no_spb,b.nama as nama_pp,a.tanggal,"+
								"       a.due_date,a.keterangan,a.kode_curr,a.nilai+a.nilai_ppn as nilai, "+  //nilai_pot sudah include di nilai
								"       c.nama as pemohon, d.nama as peruntukan, 0 as nilai_lain "+
								...
								"             inner join karyawan c on c.nik=a.nik_buat and a.kode_lokasi=c.kode_lokasi "+
								"             inner join vendor d on d.kode_vendor=a.kode_terima and a.kode_lokasi=d.kode_lokasi "+
								"where a.jenis in ('PINJ_AS','PINJ_TK') and a.modul = '"+this.cb_status.getText()+"' and a.progress='0' and a.periode<='"+this.ed_period.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"'";
			}
			if ((this.cb_status.getText() == "SPB") || (this.cb_status.getText() == "SPP") || (this.cb_status.getText() == "A/P"))
			{
				var pageCount = this.dbLib.getRowCount("select count(a.no_spb) "+
								"from spb_m a "+
								"where a.modul <> 'KP.SPB' and substring(a.modul,1,3) = '"+this.cb_status.getText()+"' and a.progress='0' and a.periode<='"+this.ed_period.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"'",this.baris);
				this.scriptSql = "select 'INPROG' as status,'-' as catatan,substring(a.modul,1,3) as modul,a.no_spb,b.nama as nama_pp,a.tanggal,"+
								"       a.due_date,a.keterangan,a.kode_curr,a.nilai+a.nilai_ppn as nilai, "+ //nilai_pot sudah include di nilai
								"       c.nama as pemohon, d.nama as peruntukan, 0 as nilai_lain "+
								"from spb_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
								"             inner join karyawan c on c.nik=a.nik_buat and a.kode_lokasi=c.kode_lokasi "+
								"             inner join vendor d on d.kode_vendor=a.kode_terima and a.kode_lokasi=d.kode_lokasi "+
								"where a.jenis <> 'NPKO' and substring(a.modul,1,3) = '"+this.cb_status.getText()+"' and a.progress='0' and a.periode<='"+this.ed_period.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' "+
								"union "+
								"select 'INPROG' as status,'-' as catatan,substring(a.modul,1,3) as modul,a.no_spb,b.nama as nama_pp,a.tanggal,"+
								"       a.due_date,a.keterangan,a.kode_curr,a.nilai+a.nilai_ppn as nilai, "+ //nilai_pot sudah include di nilai
								"       c.nama as pemohon, a.no_dokumen as peruntukan, 0 as nilai_lain "+
								"from spb_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
								"             inner join karyawan c on c.nik=a.nik_buat and a.kode_lokasi=c.kode_lokasi "+
								"where a.jenis = 'NPKO' and substring(a.modul,1,3) = '"+this.cb_status.getText()+"' and a.progress='0' and a.periode<='"+this.ed_period.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' ";
			}
			if (this.cb_status.getText() == "PJR")
			{
				var pageCount = this.dbLib.getRowCount("select count(a.no_pj) "+
								"from panjar_m a "+
								"where a.progress='0' and a.periode<='"+this.ed_period.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"'",this.baris);
				this.scriptSql = "select 'INPROG' as status,'-' as catatan,'PJR' as modul,a.no_pj,b.nama as nama_pp,a.tanggal,"+
								"       a.due_date,a.keterangan,a.kode_curr,a.nilai-a.nilai_pot as nilai, "+
								"       c.nama as pemohon, '-' as peruntukan, 0 as nilai_lain "+
								...
								"where a.progress='0' and a.periode<='"+this.ed_period.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"'";
			}
			if (this.cb_status.getText() == "PJ.PTG")
			{
				var pageCount = this.dbLib.getRowCount("select count(a.no_ptg) "+
								"from ptg_m a "+
								"where a.no_pj <> 'PROYEK' and a.progress='0' and a.periode<='"+this.ed_period.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"'",this.baris);
				this.scriptSql = "select 'INPROG' as status,'-' as catatan,'PJ.PTG' as modul,a.no_ptg,b.nama as nama_pp,a.tanggal,"+
								 "       d.due_date,a.keterangan,a.kode_curr,a.nilai, "+
								 "       c.nama as pemohon, '-' as peruntukan, d.nilai as nilai_lain "+
								 ...
								 "where a.no_pj <> 'PROYEK' and a.progress='0' and a.periode<='"+this.ed_period.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"'";
			}
			if (this.cb_status.getText() == "PR.PTG")
			{
				var pageCount = this.dbLib.getRowCount("select count(a.no_ptg) "+
								"from ptg_m a "+
								"where a.no_pj = 'PROYEK' and a.progress='0' and a.periode<='"+this.ed_period.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"'",this.baris);
				this.scriptSql = "select 'INPROG' as status,a.catatan,'PR.PTG' as modul,a.no_ptg,b.nama as nama_pp,a.tanggal,"+
								 "       a.tanggal as due_date,a.keterangan,a.kode_curr,a.nilai, "+
								 "       '-' as pemohon, '-' as peruntukan, a.nilai_kas as nilai_lain "+
								 "from ptg_m a inner join pp b on a.kode_pp=b.kode_pp and a.kode_lokasi=b.kode_lokasi "+
								 "where a.no_pj = 'PROYEK' and a.progress='0' and a.periode<='"+this.ed_period.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"'";
			}
			if (this.cb_status.getText() == "I/F")
			{
				var pageCount = this.dbLib.getRowCount("select count(a.no_if) "+
								"from if_m a "+
								"where a.progress='0' and a.periode<='"+this.ed_period.getText()+"' and a,kode_lokasi='"+this.app._lokasi+"'",this.baris);
				this.scriptSql = "select 'INPROG' as status,'-' as catatan,'I/F' as modul,a.no_if,b.nama as nama_pp,date_format(a.tanggal,'%d-%m-%Y') as tanggal,"+
								"       a.tanggal as due_date,a.keterangan,a.kode_curr,a.nilai, "+
								"       c.nama as pemohon, '-' as peruntukan, 0 as nilai_lain "+
			...
			if (this.cb_status.getText() == "IF.PTG")
			{
				var pageCount = this.dbLib.getRowCount("select count(a.no_ifptg) "+
								"from ifptg_m a "+
								"where a.progress='0' and a.periode<='"+this.ed_period.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"'",this.baris);
				this.scriptSql = "select 'INPROG' as status,'-' as catatan,'IF.PTG' as modul,a.no_ifptg,b.nama as nama_pp,a.tanggal,"+
								"       a.tanggal as due_date,a.keterangan,a.kode_curr,a.nilai, "+
								"       c.nama as pemohon, a.status as peruntukan, d.nilai as nilai_lain "+
								"from ifptg_m a "+
			...
			if (this.cb_status.getText() == "DP.KRM")
			{
				var pageCount = this.dbLib.getRowCount("select count(a.no_kirim) "+
								"from dropkrm_m a "+
								"where a.progress='0' and a.periode<='"+this.ed_period.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' and no_del='-'",this.baris);
				this.scriptSql = "select 'INPROG' as status,'-' as catatan,'DP.KRM' as modul,a.no_kirim,'-' as nama_pp,a.tanggal,"+
								"       a.due_date,a.keterangan,a.kode_curr,a.nilai, "+
								"       c.nama as pemohon, '-' as peruntukan, 0 as nilai_lain "+
								"from dropkrm_m a "+
								"               inner join karyawan c on c.nik=a.nik_buat and c.kode_lokasi=a.kode_lokasi "+
								"where a.progress='0' and a.periode<='"+this.ed_period.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' and no_del='-'";
			}
			if (this.cb_status.getText() == "DEPO")
			{
				var pageCount = this.dbLib.getRowCount("select count(a.no_depo) "+
								"from depo_m a "+
								"where a.modul = 'DEPO_P' and a.progress='0' and a.periode<='"+this.ed_period.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"'",this.baris);
				this.scriptSql = "select 'INPROG' as status,'-' as catatan,'DEPO' as modul,a.no_depo,'-' as nama_pp,a.tanggal,"+
								"       a.tanggal as due_date,a.keterangan,a.kode_curr,a.nilai, "+
								"       c.nama as pemohon, '-' as peruntukan, 0 as nilai_lain "+
								"from depo_m a "+
								"            inner join karyawan c on c.nik=a.nik_buat and a.kode_lokasi=c.kode_lokasi "+
								"where a.modul = 'DEPO_P' and a.progress='0' and a.periode<='"+this.ed_period.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"'";
			}
...
window.app_saku_kb_transaksi_fVerspb.prototype.genClick = function(sender)
{
	try
	{
...
window.app_saku_kb_transaksi_fVerspb.prototype.doSelect = function(sender, year, month, day)
{
	if (month < 10)
		month = "0"+month;
	this.ed_period.setText(year.toString()+month);
};
window.app_saku_kb_transaksi_fVerspb.prototype.doEditChange = function(sender)
{
...
window.app_saku_kb_transaksi_fVerspb.prototype.doCellChange = function(sender, col , row){
	if (col == 0){
...
window.app_saku_kb_transaksi_fVerspb.prototype.sg1ondblclick = function(sender, col , row)
{
	this.sg2.clearAll();
	...
	{		
		...
		if (this.sg1.getCell(2,row) == "PJ.PTG" || this.sg1.getCell(2,row) == "PR.PTG")
		{
...
window.app_saku_kb_transaksi_fVerspb.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_saku_kb_transaksi_fVerspb.prototype.doRequestReady = function(sender, methodName, result)
{
...
window.app_saku_kb_transaksi_fVerspb.prototype.loadDataApproval = function(page, rowPerPage){
	try{	
		this.sg1.showLoading();
