window.app_saku_kb_transaksi_nonpro_depo_fDepotmp = function(owner)
{
	if (owner)
	{
		window.app_saku_kb_transaksi_nonpro_depo_fDepotmp.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_kb_transaksi_nonpro_depo_fDepotmp";
		this.maximize();
		this.itemsValue = new portalui_arrayList();	
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Penempatan Deposito [KB Keluar] Non Proses: Input", 0);	
...
window.app_saku_kb_transaksi_nonpro_depo_fDepotmp.extend(window.portalui_childForm);
window.app_saku_kb_transaksi_nonpro_depo_fDepotmp.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_kb_transaksi_nonpro_depo_fDepotmp.prototype.simpan = function()
{
	...
	if (this.standarLib.checkEmptyByTag(this,["0","1","2","3"]))
	{
		try
		{
			...
			sql.add("insert into depo_m (no_depo,no_kas,no_dokumen,tanggal,due_date,tgl_akru,bank,cabang,rate,basis,"+
					...
					"('"+this.ed_nodepo.getText()+"','"+this.ed_nb.getText()+"','"+this.ed_dok.getText()+"','"+this.dp_tgl1.getDate()+"','"+this.dp_tgl2.getDate()+"','"+this.dp_tgl1.getDate()+"','"+this.ed_bank.getText()+"','"+this.ed_cabang.getText()+"',"+parseNilai(this.ed_bunga.getText())+","+parseNilai(this.ed_basis.getText())+","+
					"'"+this.ed_desc.getText()+"','"+this.ed_nomor.getText()+"','"+this.cb_curr.getText()+"',"+parseNilai(this.ed_kurs.getText())+",'"+this.cb_akun.getText()+"','"+this.cb_akundepo.getText()+"','"+this.cb_cbunga.getText()+"','"+this.cb_buat.getText()+"','"+this.cb_setuju.getText()+"','"+this.app._lokasi+"','-',"+
					"'DEPO_NP',"+parseNilai(this.ed_nilai.getText())+",'2','"+this.ed_period.getText()+"','-','-','"+this.app._userLog+"',now(),'"+
			...
			sql.add("insert into kas_m (no_kas,kode_lokasi,no_dokumen,no_bg,akun_kb,tanggal,keterangan,kode_pp,modul,jenis,"+
					...
					"('"+this.ed_nb.getText()+"','"+this.app._lokasi+"','"+this.ed_dok.getText()+"','"+this.ed_giro.getText()+"','"+this.cb_akun.getText()+"','"+this.dp_tgl1.getDate()+"','"+this.ed_desc.getText()+"','-','DEPO_NP','"+this.cb_jenis.getText()+"','"+
					     this.ed_period.getText()+"','"+this.cb_curr.getText()+"',"+parseNilai(this.ed_kurs.getText())+","+parseNilai(this.ed_nilai.getText())+",'-','-',now(),'"+this.app._userLog+"','F','-','-','"+this.ed_nodepo.getText()+"')");
			...
			sql.add("insert into kas_j (no_kas,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,nilai,kode_pp,kode_drk,ref1,"+
					...
					"'"+this.ed_nodepo.getText()+"','"+this.app._lokasi+"','DEPO_NP','KAS',"+
			...
			sql.add("insert into kas_j (no_kas,no_dokumen,tanggal,no_urut,kode_akun,keterangan,dc,nilai,kode_pp,kode_drk,ref1,"+
					...
					"'"+this.ed_nodepo.getText()+"','"+this.app._lokasi+"','DEPO_NP','DEPO',"+
					"'"+this.ed_period.getText()+"','"+this.cb_curr.getText()+"',"+parseNilai(this.ed_kurs.getText())+
					",'"+this.app._userLog+"',now())");
...
window.app_saku_kb_transaksi_nonpro_depo_fDepotmp.prototype.doModalResult = function(event, modalResult)
{
...
window.app_saku_kb_transaksi_nonpro_depo_fDepotmp.prototype.genClick = function(sender)
{
	try
	{
...
window.app_saku_kb_transaksi_nonpro_depo_fDepotmp.prototype.doSelect = function(sender, year, month, day)
{
	if (month < 10)
		month = "0"+month;
	this.ed_period.setText(year.toString()+month);
};
window.app_saku_kb_transaksi_nonpro_depo_fDepotmp.prototype.doEditChange = function(sender)
{
...
window.app_saku_kb_transaksi_nonpro_depo_fDepotmp.prototype.showClick = function(sender)
{
	try
	{
...
window.app_saku_kb_transaksi_nonpro_depo_fDepotmp.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_saku_kb_transaksi_nonpro_depo_fDepotmp.prototype.doRequestReady = function(sender, methodName, result)
{
