window.app_saku_kb_transaksi_fTak = function(owner){
	if (owner)
	{
		window.app_saku_kb_transaksi_fTak.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_kb_transaksi_fTak";
		this.maximize();
		this.itemsValue = new portalui_arrayList();	
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form TAK Kas Bank Kirim : Input", 0);
		...
		this.ed_nilai = new portalui_saiLabelEdit(this,{bound:[700,188,220,20], caption:"Nilai TAK", readOnly:true, tipeText:ttNilai});		
...
window.app_saku_kb_transaksi_fTak.extend(window.portalui_childForm);
window.app_saku_kb_transaksi_fTak.implement({
	...
	doFindBtnClick: function(sender, col, row){
		...
		{
			alert("[app_saku_kb_transaksi_fTak] : doFindBtnClick : " + e);
		}
	},
	doNilaiChange: function(){
		...
		{
			alert("[app_saku_kb_transaksi_fTak]::doNilaiChange:"+e);
		}
	},
	doCellEnter: function(sender, col, row){
		...
		{
			alert("app_saku_kb_transaksi_fTak::doCellEnter : " + e);
			}	
	},
