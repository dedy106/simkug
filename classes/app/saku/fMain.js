...
window.app_saku_fMain = function(owner)
{
	...
	{	
		try
		{
			...
			this.centerize();							
			uses("portalui_saiCB;portalui_panelWidget;portalui_saiLabelEdit;portalui_image;portalui_imageButton;portalui_button;portalui_timer;portalui_label;portalui_saiCBBL;portalui_panel;portalui_reportNavigator;portalui_treeView;portalui_treeNode;portalui_statusBar;portalui_marquee;util_addOnLib;util_standar;portalui_imageButton");					
			...
			this.bCancel = new portalui_imageButton(this.pTool,{bound:[325,5,17,15],hint:"Cancel",click:[this,"bTutupClick"],image:"icon/"+system.getThemes()+"/bCancel2.png"});
			...
			this.bGenLocal = new portalui_imageButton(this.pTool,{bound:[440,5,17,15],hint:"Open Window",image:"icon/"+system.getThemes()+"/bGenLocal.png",click:[this,"openNewWindow"]});
...
window.app_saku_fMain.implement({
	...
	doAfterLogin: function(){
		try{		    
			...
			this.listInfo = new portalui_panel(this,{bound:[this.getWidth() - 325,55,300,200],caption:"User Info",color:"url(icon/"+system.getThemes()+"/background.png)",visible:false});
				
				this.lUser = new portalui_label(this.listInfo,{bound:[10,5,80,18],fontColor:"#0000ff",underline:true,caption:"User Login"});				
				this.lUser1 = new portalui_label(this.listInfo,{bound:[90,5,this.listInfo.width - 90,18],fontColor:"#0000ff",caption:this.app._userLog});				
				this.lPrd = new portalui_label(this.listInfo,{bound:[10,25,80,18],fontColor:"#0000ff",underline:true,caption:"Periode"});				
				this.lPrd1 = new portalui_label(this.listInfo,{bound:[90,25,this.listInfo.width - 90,18],fontColor:"#0000ff",caption:this.app._periode});				
				...
				this.lTime1 = new portalui_label(this.listInfo,{bound:[90,45,this.listInfo.width - 90,18],fontColor:"#0000ff",caption:dayName[this.app._loginTime.getDay()] +" "+this.app._loginTime.getDate()+"/"+this.app._loginTime.getBln()+"/"+this.app._loginTime.getFullYear()+" "+this.app._loginTime.getHours()+":"+this.app._loginTime.getMinutes()});				
				this.lLok = new portalui_label(this.listInfo,{bound:[10,65,80,18],fontColor:"#0000ff",underline:true,caption:"User Location"});				
				this.lLok1 = new portalui_label(this.listInfo,{bound:[90,65,this.listInfo.width - 90,18],fontColor:"#0000ff",caption:this.app._lokasi});				
				this.lPP = new portalui_label(this.listInfo,{bound:[10,85,80,18],fontColor:"#0000ff",underline:true,caption:"User Office"});
				this.lPP1 = new portalui_label(this.listInfo,{bound:[90,85,this.listInfo.width - 90,18],fontColor:"#0000ff",caption:this.app._pp});				
				this.ldb = new portalui_label(this.listInfo,{bound:[10,105,80,18],fontColor:"#0000ff",underline:true,caption:"Database"});
				this.ldb1 = new portalui_label(this.listInfo,{bound:[90,105,this.listInfo.width - 90,18],fontColor:"#0000ff",caption:this.app._dbname});				
				this.ldb = new portalui_label(this.listInfo,{bound:[10,125,80,18],fontColor:"#0000ff",underline:true,caption:"Host"});
				this.ldb2 = new portalui_label(this.listInfo,{bound:[90,125,this.listInfo.width - 90,18],fontColor:"#0000ff",caption:clientInfo.host});				
				this.ldb = new portalui_label(this.listInfo,{bound:[10,145,80,18],fontColor:"#0000ff",underline:true,caption:"My Comp"});
				this.ldb2 = new portalui_label(this.listInfo,{bound:[90,145,this.listInfo.width - 90,18],fontColor:"#0000ff",caption:this.app._hostname});				
				this.ldb = new portalui_label(this.listInfo,{bound:[10,165,80,18],fontColor:"#0000ff",underline:true,caption:"Session"});
				this.ldb2 = new portalui_label(this.listInfo,{bound:[90,165,this.listInfo.width - 90,18],fontColor:"#0000ff",caption:this.app._userSession});				
	...
	bTutupClick: function(sender){	
		try{
			if (this.form instanceof app_saku_fLogin && !this.app._isLogedIn) {				
				return;
			}
	...
	doSave: function(sender){
		if (this.pTrans.visible && this.bSimpan.visible) this.bSimpan.click();
	},
