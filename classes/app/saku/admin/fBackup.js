window.app_saku_admin_fBackup = function(owner)
{
	if (owner)
	{
		window.app_saku_admin_fBackup.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku_admin_fBackup";
...
window.app_saku_admin_fBackup.extend(window.portalui_childForm);
window.app_saku_admin_fBackup.implement({
