window.app_saku_dmt_report_flFormInvoice = function(owner)
{
	if (owner)
	{
		window.app_saku_dmt_report_flFormInvoice.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_dmt_report_flFormInvoice";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Formulir Invoice", 2);
...
window.app_saku_dmt_report_flFormInvoice.extend(window.portalui_childForm);
window.app_saku_dmt_report_flFormInvoice.implement({
	...
	mainButtonClick: function(sender)
	{
		try
		{
			...
			}else
			{
				...
				this.nama_report="server_report_dmt_rptFormInvoice";
		...
		{
			alert("[app_saku_dmt_report_flFormInvoice]::mainButtonClick:"+e);
		}
	},
