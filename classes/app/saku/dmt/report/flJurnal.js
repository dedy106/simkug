window.app_saku_dmt_report_flJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku_dmt_report_flJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_dmt_report_flJurnal";
		this.maximize();		
...
window.app_saku_dmt_report_flJurnal.extend(window.portalui_childForm);
window.app_saku_dmt_report_flJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku_dmt_report_flJurnal]::mainButtonClick:"+e);
		}
	},
