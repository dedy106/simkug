window.app_saku_dmt_report_flFaktur = function(owner)
{
	if (owner)
	{
		window.app_saku_dmt_report_flFaktur.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_dmt_report_flFaktur";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,5,[0,1,2],["Lembar","=","Semua"]);
	this.pager = 1;
};
window.app_saku_dmt_report_flFaktur.extend(window.portalui_childForm);
window.app_saku_dmt_report_flFaktur.implement({
	...
	mainButtonClick: function(sender)
	{
		...
		{
			alert("[app_saku_dmt_report_flFaktur]::mainButtonClick:"+e);
		}
	},
