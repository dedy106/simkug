window.app_saku_dmt_report_flLampiranInvoice = function(owner)
{
	if (owner)
	{
		window.app_saku_dmt_report_flLampiranInvoice.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_dmt_report_flLampiranInvoice";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Lampiran Invoice", 2);
	...
	this.filterRep.setSGFilterRowTipe(this.sg1, 0,[0,1,2,3,4],["3","3","13","13","13"]);
...
window.app_saku_dmt_report_flLampiranInvoice.extend(window.portalui_childForm);
window.app_saku_dmt_report_flLampiranInvoice.implement({
	...
	mainButtonClick: function(sender)
	{
		try
		{
			...
			}else
			{
				...
				this.nama_report="server_report_dmt_rptLampiranInvoice";
		...
		{
			alert("[app_saku_dmt_report_flLampiranInvoice]::mainButtonClick:"+e);
		}
	},
	...
	doRowPerPageChange: function(sender, rowperpage)
	{
		...
		this.viewer.setTotalPage(this.report.getTotalPage(this.nama_report,this.filter,1));
		this.app._mainForm.reportNavigator.setTotalPage(this.viewer.getTotalPage());
		this.app._mainForm.reportNavigator.rearrange();
