window.app_saku_dmt_report_flPulau = function(owner)
{
	if (owner)
	{
		window.app_saku_dmt_report_flPulau.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_dmt_report_flPulau";
		this.maximize();
		
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Pulau", 2);
...
window.app_saku_dmt_report_flPulau.extend(window.portalui_childForm);
window.app_saku_dmt_report_flPulau.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
		    	...
		    	this.filter = this.filterRep.filterStr("kode_pulau",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"and");
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new portalui_arrayMap();
				var sql = "select kode_pulau, nama   "+
					" from dmt_pulau "+
				...
				this.title = new server_util_arrayList({items:["Kode Pulau","Nama"]});			
			...
			systemAPI.alert("[app_saku_dmt_report_flPulau]::mainButtonClick:"+e);
		}
	},
	...
	previewReport: function(dthtml){
		var html = "<div align='center' class='judul_laporan' style='{width:100%;font-size:14;font-weight:bold;}'><br><br>"+this.app._namalokasi.toUpperCase()+"<br>DAFTAR PULAU<br>";			
		var d = new Date();
