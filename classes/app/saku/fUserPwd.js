...
//* 			SAI, PT											
//***********************************************************************************************
window.app_saku_fUserPwd = function(owner)
{
	if (owner)
	{
		window.app_saku_fUserPwd.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_fUserPwd";
		this.setTop(60);
		this.setWidth(1280);
		this.setHeight(550);
...
window.app_saku_fUserPwd.extend(window.portalui_childForm);
//------------------------------------------------------------------ event
window.app_saku_fUserPwd.prototype.mainButtonClick = function(sender){
...
window.app_saku_fUserPwd.prototype.doModalResult = function(event, modalResult){
...
window.app_saku_fUserPwd.prototype.keyPress = function(sender, charCode, buttonState ){
//	setTipeButton(tbSimpan);
};
window.app_saku_fUserPwd.prototype.doEditChange = function(sender){
};											  
window.app_saku_fUserPwd.prototype.EditExit = function(sender){
};
window.app_saku_fUserPwd.prototype.FindBtnClick = function(sender, event){
	try{
...
window.app_saku_fUserPwd.prototype.doRequestReady = function(sender, methodName, result){
	switch	(methodName){
		case "execArraySQL" :
