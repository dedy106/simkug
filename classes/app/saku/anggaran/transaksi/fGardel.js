window.app_saku_anggaran_transaksi_fGardel = function(owner)
{  
	if (owner)
	{
		window.app_saku_anggaran_transaksi_fGardel.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_anggaran_transaksi_fGardel";
		this.maximize();
		this.itemsValue = new portalui_arrayList();	
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Data Anggaran Pengurang (ABK): Input", 0);
...
window.app_saku_anggaran_transaksi_fGardel.extend(window.portalui_childForm);
window.app_saku_anggaran_transaksi_fGardel.prototype.doSelect = function(sender, year, month, day)
{
	if (month < 10)
		month = "0"+month;
	this.ed_period.setText(year.toString());
};
window.app_saku_anggaran_transaksi_fGardel.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_anggaran_transaksi_fGardel.prototype.simpan = function()
{	
	try
	{
...
window.app_saku_anggaran_transaksi_fGardel.prototype.doModalResult = function(event, modalResult)
{
...
window.app_saku_anggaran_transaksi_fGardel.prototype.genClick = function(sender)
{
	try
	{
...
window.app_saku_anggaran_transaksi_fGardel.prototype.doEditChange = function(sender)
{
...
window.app_saku_anggaran_transaksi_fGardel.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_saku_anggaran_transaksi_fGardel.prototype.doFindBtnClick = function(sender, col, row) 
{
	try
	{
		switch(col)
	...
	{
		alert("[app_saku_anggaran_transaksi_fGardel] : doFindBtnClick : " + e);
	}
};
window.app_saku_anggaran_transaksi_fGardel.prototype.doNilaiChange = function()
{
	try
	{
		var tot = 0;
	...
	{
		alert("[app_saku_anggaran_transaksi_fGardel]::doNilaiChange:"+e);
	}
};
window.app_saku_anggaran_transaksi_fGardel.prototype.doCellExit = function()
{
	this.sg1.validasi();
};
window.app_saku_anggaran_transaksi_fGardel.prototype.doRequestReady = function(sender, methodName, result)
{
...
window.app_saku_anggaran_transaksi_fGardel.prototype.doAfterLoad = function(sender, result,data)
{
	try{	
		if (result){
			var rs, arr;
