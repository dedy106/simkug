// JavaScript Document
window.app_saku_anggaran_report_flAggReal = function(owner)
{
	if (owner)
	{
		window.app_saku_anggaran_report_flAggReal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_anggaran_report_flAggReal";
		this.maximize();
...
window.app_saku_anggaran_report_flAggReal.extend(window.portalui_childForm);
window.app_saku_anggaran_report_flAggReal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			sql="call sp_agg_real ('"+this.sg1.getCell(2,2)+"','L','"+in_lap+"',"+this.sg1.getCell(2,3)+",'"+this.sg1.getCell(2,1)+"','"+this.kode_lokasi+"','"+this.kode_lokasi1+"','"+this.kode_lokasi2+"','"+this.nik_user+"')";
