window.app_saku_anggaran_report_flAggAbt = function(owner)
{
	if (owner)
	{
		window.app_saku_anggaran_report_flAggAbt.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_anggaran_report_flAggAbt";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Anggaran Tambahan", 2);
...
window.app_saku_anggaran_report_flAggAbt.extend(window.portalui_childForm);
window.app_saku_anggaran_report_flAggAbt.prototype.doEllipseClick= function(sender, col, row)
{
	if (row ==1)
	{
...
window.app_saku_anggaran_report_flAggAbt.prototype.doSelectCell = function(sender, col, row)
{
	if (this.userStatus=="A")
	{
...
window.app_saku_anggaran_report_flAggAbt.prototype.mainButtonClick = function(sender)
{
	try
	{
		...
		this.nama_report="server_report_anggaran_rptAggAbt";
...
window.app_saku_anggaran_report_flAggAbt.prototype.doRequestReady = function(sender, methodName, result)
{
	switch (methodName)
	{
		case "preview" : 
...
window.app_saku_anggaran_report_flAggAbt.prototype.doSelectedPage = function(sender, page)
{
	this.report.preview(this.nama_report,this.filter, page, this.pager, this.lokasi, this.showFilter);	
	this.page=page;
	this.allBtn = false;
};
window.app_saku_anggaran_report_flAggAbt.prototype.doCloseReportClick = function(sender)
{
...
window.app_saku_anggaran_report_flAggAbt.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_saku_anggaran_report_flAggAbt.prototype.doRowPerPageChange = function(sender, rowperpage)
{
