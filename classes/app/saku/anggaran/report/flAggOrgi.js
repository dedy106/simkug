window.app_saku_anggaran_report_flAggOrgi = function(owner)
{
	if (owner)
	{
		window.app_saku_anggaran_report_flAggOrgi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_anggaran_report_flAggOrgi";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Anggaran Baru", 2);
...
window.app_saku_anggaran_report_flAggOrgi.extend(window.portalui_childForm);
window.app_saku_anggaran_report_flAggOrgi.prototype.doEllipseClick= function(sender, col, row)
{
	if (row ==1)
	{
...
window.app_saku_anggaran_report_flAggOrgi.prototype.doSelectCell = function(sender, col, row)
{
...
window.app_saku_anggaran_report_flAggOrgi.prototype.mainButtonClick = function(sender)
{
	try
	{
...
window.app_saku_anggaran_report_flAggOrgi.prototype.doRequestReady = function(sender, methodName, result)
{
	switch (methodName)
	{
		case "preview" : 
...
window.app_saku_anggaran_report_flAggOrgi.prototype.doSelectedPage = function(sender, page)
{
	this.report.preview(this.nama_report,this.filter, page, this.pager, this.lokasi, this.showFilter);	
	this.page=page;
	this.allBtn = false;
};
window.app_saku_anggaran_report_flAggOrgi.prototype.doCloseReportClick = function(sender)
{
...
window.app_saku_anggaran_report_flAggOrgi.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_saku_anggaran_report_flAggOrgi.prototype.doRowPerPageChange = function(sender, rowperpage)
{
