window.app_saku_anggaran_report_flRkapSusun = function(owner)
{
	if (owner)
	{
		window.app_saku_anggaran_report_flRkapSusun.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_anggaran_report_flRkapSusun";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Rekapitulasi Rencana Kerja dan Anggaran", 2);
...
window.app_saku_anggaran_report_flRkapSusun.extend(window.portalui_childForm);
window.app_saku_anggaran_report_flRkapSusun.prototype.doEllipseClick= function(sender, col, row)
{
	if (row ==1)
	{
...
window.app_saku_anggaran_report_flRkapSusun.prototype.doSelectCell = function(sender, col, row)
{
...
window.app_saku_anggaran_report_flRkapSusun.prototype.mainButtonClick = function(sender)
{
	try
	{
		...
		var in_lap="S";		
		var sql="call sp_rkap_rka ('"+this.sg1.getCell(2,2)+"','L','"+in_lap+"',"+this.sg1.getCell(2,3)+",'"+this.sg1.getCell(2,0)+"','"+this.kode_lokasi+"','"+this.kode_lokasi1+"','"+this.kode_lokasi2+"','"+this.nik_user+"')";
		this.dbLib.execQuerySync(sql);	
		this.nama_report="server_report_anggaran_rptRkapSusun";
...
window.app_saku_anggaran_report_flRkapSusun.prototype.doRequestReady = function(sender, methodName, result)
{
	switch (methodName)
	{
		case "preview" : 
...
window.app_saku_anggaran_report_flRkapSusun.prototype.doSelectedPage = function(sender, page)
{
	this.report.preview(this.nama_report,this.filter, page, this.pager, this.showFilter, this.lokasi,this.filter2);
	this.page=page;
	this.allBtn = false;
};
window.app_saku_anggaran_report_flRkapSusun.prototype.doCloseReportClick = function(sender)
{
...
window.app_saku_anggaran_report_flRkapSusun.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_saku_anggaran_report_flRkapSusun.prototype.doRowPerPageChange = function(sender, rowperpage)
{
