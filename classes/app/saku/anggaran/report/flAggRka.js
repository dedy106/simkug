window.app_saku_anggaran_report_flAggRka = function(owner)
{
	if (owner)
	{
		window.app_saku_anggaran_report_flAggRka.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_anggaran_report_flAggRka";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Rencana Kerja & Anggaran", 2);
...
window.app_saku_anggaran_report_flAggRka.extend(window.portalui_childForm);
window.app_saku_anggaran_report_flAggRka.prototype.doEllipseClick= function(sender, col, row)
{
	if (row ==1)
	{
...
window.app_saku_anggaran_report_flAggRka.prototype.doSelectCell = function(sender, col, row)
{
...
window.app_saku_anggaran_report_flAggRka.prototype.mainButtonClick = function(sender)
{
	try
	{
		...
		this.nama_report="server_report_anggaran_rptAggRka";
...
window.app_saku_anggaran_report_flAggRka.prototype.doRequestReady = function(sender, methodName, result)
{
	switch (methodName)
	{
		case "preview" : 
...
window.app_saku_anggaran_report_flAggRka.prototype.doSelectedPage = function(sender, page)
{
	this.report.preview(this.nama_report,this.filter, page, this.pager, this.showFilter,this.lokasi, this.filter2);
	this.page=page;
	this.allBtn = false;
};
window.app_saku_anggaran_report_flAggRka.prototype.doCloseReportClick = function(sender)
{
...
window.app_saku_anggaran_report_flAggRka.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_saku_anggaran_report_flAggRka.prototype.doRowPerPageChange = function(sender, rowperpage)
{
