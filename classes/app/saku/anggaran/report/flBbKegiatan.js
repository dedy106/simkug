window.app_saku_anggaran_report_flBbKegiatan = function(owner)
{
	if (owner)
	{
		window.app_saku_anggaran_report_flBbKegiatan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_anggaran_report_flBbKegiatan";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Buku Besar DRK", 2);
...
window.app_saku_anggaran_report_flBbKegiatan.extend(window.portalui_childForm);
window.app_saku_anggaran_report_flBbKegiatan.prototype.doEllipseClick= function(sender, col, row)
{
	if (row ==1)
	{
...
window.app_saku_anggaran_report_flBbKegiatan.prototype.doSelectCell = function(sender, col, row)
{
	if (this.app._userStatus=="A")
	{
...
window.app_saku_anggaran_report_flBbKegiatan.prototype.mainButtonClick = function(sender)
{
	try
	{
		...
		this.nama_report="server_report_anggaran_rptBbKegiatan";
...
window.app_saku_anggaran_report_flBbKegiatan.prototype.doRequestReady = function(sender, methodName, result)
{
	switch (methodName)
	{
		case "preview" : 
...
window.app_saku_anggaran_report_flBbKegiatan.prototype.doSelectedPage = function(sender, page)
{
...
window.app_saku_anggaran_report_flBbKegiatan.prototype.doCloseReportClick = function(sender)
{
...
window.app_saku_anggaran_report_flBbKegiatan.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_saku_anggaran_report_flBbKegiatan.prototype.doRowPerPageChange = function(sender, rowperpage)
{
