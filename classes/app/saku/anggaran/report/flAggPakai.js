window.app_saku_anggaran_report_flAggPakai = function(owner)
{
	if (owner)
	{
		window.app_saku_anggaran_report_flAggPakai.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_anggaran_report_flAggPakai";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Pemakaian Anggaran", 2);
...
window.app_saku_anggaran_report_flAggPakai.extend(window.portalui_childForm);
window.app_saku_anggaran_report_flAggPakai.prototype.doEllipseClick= function(sender, col, row)
{
	if (row ==1)
	{
...
window.app_saku_anggaran_report_flAggPakai.prototype.doSelectCell = function(sender, col, row)
{
	if (this.app._userStatus=="A")
	{
	...
	{
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5],["1234","3","123","3","123","3"]);
...
window.app_saku_anggaran_report_flAggPakai.prototype.mainButtonClick = function(sender)
{
	try
	{
		...
		this.nama_report="server_report_anggaran_rptAggPakai";
...
window.app_saku_anggaran_report_flAggPakai.prototype.doRequestReady = function(sender, methodName, result)
{
	switch (methodName)
	{
		case "preview" : 
...
window.app_saku_anggaran_report_flAggPakai.prototype.doSelectedPage = function(sender, page)
{
	this.report.preview(this.nama_report,this.filter, page, this.pager, this.showFilter,this.lokasi, this.filter2);
	this.page=page;
	this.allBtn = false;
};
window.app_saku_anggaran_report_flAggPakai.prototype.doCloseReportClick = function(sender)
{
...
window.app_saku_anggaran_report_flAggPakai.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_saku_anggaran_report_flAggPakai.prototype.doRowPerPageChange = function(sender, rowperpage)
{
