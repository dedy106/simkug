window.app_saku_referensi_report_flCust = function(owner)
{
	if (owner)
	{
		window.app_saku_referensi_report_flCust.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_referensi_report_flCust";
		this.maximize();
		
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Customer", 2);
...
window.app_saku_referensi_report_flCust.extend(window.portalui_childForm);
window.app_saku_referensi_report_flCust.implement({
	doEllipseClick: function(sender, col, row){
		...
		if (row == 1)
		{
			this.standar.ListDataSGFilter2(this, "Data Customer",this.sg1, this.sg1.row, this.sg1.col,
													  "select kode_cust, nama,kode_lokasi from cust "+this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where"),
													  ...
													  ["kode_cust","nama"],"where",["Kode","Nama","Lokasi"]);
		}
	},
		...
		try
		{
			...
			else
			{
		    	...
		    	this.filter = this.filterRep.filterStr("l.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
								this.filterRep.filterStr("v.kode_cust",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new portalui_arrayMap();
				var sql = "select v.kode_cust,v.kode_lokasi,v.nama,v.alamat,v.kota,v.kode_pos,v.no_telp,v.no_fax,v.npwp,v.pic,k.nama as nmklp "+
							"from cust v left outer join cust_klp k on v.kode_klpcust=k.kode_klpcust and v.kode_lokasi=k.kode_lokasi "+
							"inner join lokasi l on v.kode_lokasi=l.kode_lokasi "+this.filter+
							"order by v.kode_lokasi,v.kode_cust ";
			...
			systemAPI.alert("[app_saku_referensi_report_flCust]::mainButtonClick:"+e);
		}
	},
	...
	previewReport: function(dthtml){
		var html = "<div align='center' class='judul_laporan' style='{width:100%;font-size:14;font-weight:bold;}'><br><br>"+this.app._namalokasi.toUpperCase()+"<br>LAPORAN CUSTOMER<br>";			
		var d = new Date();
