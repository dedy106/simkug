window.app_saku_referensi_report_flPP = function(owner)
{
	if (owner)
	{
		window.app_saku_referensi_report_flPP.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_referensi_report_flPP";
		this.maximize();
...
window.app_saku_referensi_report_flPP.extend(window.portalui_childForm);
window.app_saku_referensi_report_flPP.implement({
	...
	mainButtonClick: function(sender){
		...
		{
			alert("[app_saku_referensi_report_flPP]::mainButtonClick:"+e);
		}
	},
