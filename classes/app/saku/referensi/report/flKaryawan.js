window.app_saku_referensi_report_flKaryawan = function(owner)
{
	if (owner)
	{
		window.app_saku_referensi_report_flKaryawan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_referensi_report_flKaryawan";
		this.maximize();
...
window.app_saku_referensi_report_flKaryawan.extend(window.portalui_childForm);
window.app_saku_referensi_report_flKaryawan.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku_referensi_report_flKaryawan]::mainButtonClick:"+e);
		}
	},
