window.app_saku_referensi_transaksi_fVendor = function(owner){
	if (owner)
	{
		window.app_saku_referensi_transaksi_fVendor.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_referensi_transaksi_fVendor";
		this.maximize();
...
window.app_saku_referensi_transaksi_fVendor.extend(window.portalui_childForm);
window.app_saku_referensi_transaksi_fVendor.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_referensi_transaksi_fVendor.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.app_saku_referensi_transaksi_fVendor.prototype.showClick = function(sender){
...
window.app_saku_referensi_transaksi_fVendor.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_saku_referensi_transaksi_fVendor.prototype.doRequestReady = function(sender, methodName, result)
{
