window.app_saku_referensi_transaksi_fCustklp = function(owner)
{
	if (owner)
	{
		window.app_saku_referensi_transaksi_fCustklp.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_referensi_transaksi_fCustklp";
		this.maximize();
...
window.app_saku_referensi_transaksi_fCustklp.extend(window.portalui_childForm);
window.app_saku_referensi_transaksi_fCustklp.prototype.mainButtonClick = function(sender){
...
window.app_saku_referensi_transaksi_fCustklp.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.app_saku_referensi_transaksi_fCustklp.prototype.showClick = function(sender)
{	
...
window.app_saku_referensi_transaksi_fCustklp.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_saku_referensi_transaksi_fCustklp.prototype.doRequestReady = function(sender, methodName, result)
{
