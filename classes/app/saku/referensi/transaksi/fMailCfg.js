window.app_saku_referensi_transaksi_fMailCfg = function(owner)
{
	if (owner)
	{
		window.app_saku_referensi_transaksi_fMailCfg.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_referensi_transaksi_fMailCfg";
...
window.app_saku_referensi_transaksi_fMailCfg.extend(window.portalui_childForm);
window.app_saku_referensi_transaksi_fMailCfg.implement({
