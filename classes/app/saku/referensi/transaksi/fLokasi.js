window.app_saku_referensi_transaksi_fLokasi = function(owner){
	if (owner){
		window.app_saku_referensi_transaksi_fLokasi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_referensi_transaksi_fLokasi";
		this.setTop(60);
		this.setWidth(1280);
		this.setHeight(550);
...
window.app_saku_referensi_transaksi_fLokasi.extend(window.portalui_childForm);
window.app_saku_referensi_transaksi_fLokasi.implement({
