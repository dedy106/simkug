window.app_saku_sdm_report_flRekapBKes = function(owner)
{
	if (owner)
	{
		window.app_saku_sdm_report_flRekapBKes.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_sdm_report_flRekapBKes";
		this.maximize();
...
window.app_saku_sdm_report_flRekapBKes.extend(window.portalui_childForm);
window.app_saku_sdm_report_flRekapBKes.implement({
	...
	mainButtonClick: function(sender)
	{
		...
		{
			alert("[app_saku_sdm_report_flRekapBKes]::mainButtonClick:"+e);
		}
	},
