window.app_saku_sdm_report_flDftrBayar = function(owner)
{
	if (owner)
	{
		window.app_saku_sdm_report_flDftrBayar.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_sdm_report_flDftrBayar";
		this.maximize();		
...
window.app_saku_sdm_report_flDftrBayar.extend(window.portalui_childForm);
window.app_saku_sdm_report_flDftrBayar.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			}else
			{
				...
				var sql = "select a.nama as nmprov,concat(a.bank,' Cab. ',a.cabang) as bank,a.no_rek,ifnull(sum(b.nilai),0) as byr "+
			...
			systemAPI.alert("[app_saku_sdm_report_flDftrBayar]::mainButtonClick:"+e);
		}
	},
