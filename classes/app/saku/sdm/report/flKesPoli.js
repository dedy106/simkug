window.app_saku_sdm_report_flKesPoli = function(owner)
{
	if (owner)
	{
		window.app_saku_sdm_report_flKesPoli.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_sdm_report_flKesPoli";
		this.maximize();		
...
window.app_saku_sdm_report_flKesPoli.extend(window.portalui_childForm);
window.app_saku_sdm_report_flKesPoli.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku_sdm_report_flKesPoli]::mainButtonClick:"+e);
		}
	},
