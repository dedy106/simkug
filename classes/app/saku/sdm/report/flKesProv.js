window.app_saku_sdm_report_flKesProv = function(owner)
{
	if (owner)
	{
		window.app_saku_sdm_report_flKesProv.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_sdm_report_flKesProv";
		this.maximize();		
...
window.app_saku_sdm_report_flKesProv.extend(window.portalui_childForm);
window.app_saku_sdm_report_flKesProv.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku_sdm_report_flKesProv]::mainButtonClick:"+e);
		}
	},
