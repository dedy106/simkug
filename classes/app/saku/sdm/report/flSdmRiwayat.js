window.app_saku_sdm_report_flSdmRiwayat = function(owner)
{
	if (owner)
	{
		window.app_saku_sdm_report_flSdmRiwayat.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_sdm_report_flSdmRiwayat";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,2,[0,1,2],["NIP",this.tanda,this.nik]);
};
window.app_saku_sdm_report_flSdmRiwayat.extend(window.portalui_childForm);
window.app_saku_sdm_report_flSdmRiwayat.prototype.doEllipseClick= function(sender, col, row)
{
	if (row == 0)
	{
...
window.app_saku_sdm_report_flSdmRiwayat.prototype.doSelectCell = function(sender, col, row)
{
...
window.app_saku_sdm_report_flSdmRiwayat.prototype.mainButtonClick = function(sender)
{
	try
	{
	...
	{
		alert("[app_saku_sdm_report_flSdmRiwayat]::mainButtonClick:"+e);
	}
};
window.app_saku_sdm_report_flSdmRiwayat.prototype.doRequestReady = function(sender, methodName, result)
{
	switch (methodName)
	{
		case "preview" : 
...
window.app_saku_sdm_report_flSdmRiwayat.prototype.doSelectedPage = function(sender, page)
{
	this.report.preview("server_report_sdm_rptRiwayat",this.filter, page, 1, this.showFilter, this.app._namalokasi);		
	this.page=page;
};
window.app_saku_sdm_report_flSdmRiwayat.prototype.doCloseReportClick = function(sender)
{
...
window.app_saku_sdm_report_flSdmRiwayat.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
