window.app_saku_sdm_report_flKesKlaim = function(owner)
{
	if (owner)
	{
		window.app_saku_sdm_report_flKesKlaim.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_sdm_report_flKesKlaim";
		this.maximize();
...
window.app_saku_sdm_report_flKesKlaim.extend(window.portalui_childForm);
window.app_saku_sdm_report_flKesKlaim.prototype.doEllipseClick= function(sender, col, row)
{
	if (row == 0)
	{
...
window.app_saku_sdm_report_flKesKlaim.prototype.doSelectCell = function(sender, col, row)
{	
...
window.app_saku_sdm_report_flKesKlaim.prototype.mainButtonClick = function(sender)
{
	try
	{
...
window.app_saku_sdm_report_flKesKlaim.prototype.doRequestReady = function(sender, methodName, result)
{
	switch (methodName)
	{
		case "preview" : 
...
window.app_saku_sdm_report_flKesKlaim.prototype.doSelectedPage = function(sender, page)
{
	this.report.preview(this.nama_report,this.filter, page,this.pager, this.lokasi, this.showFilter,this.filter2);
	this.page=page;
	this.allBtn = false;
};
window.app_saku_sdm_report_flKesKlaim.prototype.doCloseReportClick = function(sender)
{
...
window.app_saku_sdm_report_flKesKlaim.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_saku_sdm_report_flKesKlaim.prototype.doRowPerPageChange = function(sender, rowperpage)
{
