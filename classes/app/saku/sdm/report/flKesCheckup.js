window.app_saku_sdm_report_flKesCheckup = function(owner)
{
	if (owner)
	{
		window.app_saku_sdm_report_flKesCheckup.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_sdm_report_flKesCheckup";
		this.maximize();
...
window.app_saku_sdm_report_flKesCheckup.extend(window.portalui_childForm);
window.app_saku_sdm_report_flKesCheckup.prototype.doEllipseClick= function(sender, col, row)
{
	if (row == 0)
	{
...
window.app_saku_sdm_report_flKesCheckup.prototype.doSelectCell = function(sender, col, row)
{
...
window.app_saku_sdm_report_flKesCheckup.prototype.mainButtonClick = function(sender)
{
	try
	{
	...
	{
		alert("[app_saku_sdm_report_flKesCheckup]::mainButtonClick:"+e);
	}
};
window.app_saku_sdm_report_flKesCheckup.prototype.jenisReport = function(jenis,filter)
{
	try
	{
	...
	{
		alert("[app_saku_sdm_report_flKesCheckup]::jenisReport:"+e);
	}
};
window.app_saku_sdm_report_flKesCheckup.prototype.doRequestReady = function(sender, methodName, result)
{
	switch (methodName)
	{
		case "preview" : 
...
window.app_saku_sdm_report_flKesCheckup.prototype.doSelectedPage = function(sender, page)
{
...
window.app_saku_sdm_report_flKesCheckup.prototype.previewReport = function(dthtml,jenis)
{
...
window.app_saku_sdm_report_flKesCheckup.prototype.doCloseReportClick = function(sender)
{
...
window.app_saku_sdm_report_flKesCheckup.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_saku_sdm_report_flKesCheckup.prototype.doRowPerPageChange = function(sender, rowperpage)
{
