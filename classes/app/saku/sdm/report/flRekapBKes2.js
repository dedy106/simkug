window.app_saku_sdm_report_flRekapBKes2 = function(owner)
{
	if (owner)
	{
		window.app_saku_sdm_report_flRekapBKes2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_sdm_report_flRekapBKes2";
		this.maximize();
...
window.app_saku_sdm_report_flRekapBKes2.extend(window.portalui_childForm);
window.app_saku_sdm_report_flRekapBKes2.implement({
	...
	mainButtonClick: function(sender)
	{
		...
		{
			alert("[app_saku_sdm_report_flRekapBKes2]::mainButtonClick:"+e);
		}
	},
