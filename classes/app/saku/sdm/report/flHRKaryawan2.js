// JavaScript Document
window.app_saku_sdm_report_flHRKaryawan2 = function(owner)
{
	if (owner)
	{
		window.app_saku_sdm_report_flHRKaryawan2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_sdm_report_flHRKaryawan2";
		this.maximize();
...
window.app_saku_sdm_report_flHRKaryawan2.extend(window.portalui_childForm);

window.app_saku_sdm_report_flHRKaryawan2.prototype.doEllipseClick= function(sender, col, row)
{
		if (row == 0)
		{
...
window.app_saku_sdm_report_flHRKaryawan2.prototype.doSelectCell = function(sender, col, row)
{
	if (this.userStatus=="A")
	{
...
window.app_saku_sdm_report_flHRKaryawan2.prototype.mainButtonClick = function(sender)
{
	try
	{
	...
	{
		alert("[app_saku_sdm_report_flHRKaryawan2]::mainButtonClick:"+e);
	}
}

window.app_saku_sdm_report_flHRKaryawan2.prototype.doRequestReady = function(sender, methodName, result)
{
		switch (methodName)
		{
			case "preview" : 
...
window.app_saku_sdm_report_flHRKaryawan2.prototype.doSelectedPage = function(sender, page)
{
	this.report.preview("server_report_sdm_rptKaryawan2",this.filter, page, 30, this.showFilter, this.app._namalokasi);		
	this.page=page;
}

window.app_saku_sdm_report_flHRKaryawan2.prototype.doCloseReportClick = function(sender)
{
...
window.app_saku_sdm_report_flHRKaryawan2.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
