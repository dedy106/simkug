window.app_saku_sdm_report_flHRKaryawan = function(owner)
{
	if (owner)
	{
		window.app_saku_sdm_report_flHRKaryawan.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_sdm_report_flHRKaryawan";
		this.maximize();
...
window.app_saku_sdm_report_flHRKaryawan.extend(window.portalui_childForm);

window.app_saku_sdm_report_flHRKaryawan.prototype.doEllipseClick= function(sender, col, row)
{
		if (row == 0)
		{
...
window.app_saku_sdm_report_flHRKaryawan.prototype.doSelectCell = function(sender, col, row)
{
	if (this.userStatus=="A")
	{
...
window.app_saku_sdm_report_flHRKaryawan.prototype.mainButtonClick = function(sender)
{
	try
	{
	...
	{
		alert("[app_saku_sdm_report_flHRKaryawan]::mainButtonClick:"+e);
	}
}

window.app_saku_sdm_report_flHRKaryawan.prototype.doRequestReady = function(sender, methodName, result)
{
		switch (methodName)
		{
			case "preview" : 
...
window.app_saku_sdm_report_flHRKaryawan.prototype.doSelectedPage = function(sender, page)
{
...
window.app_saku_sdm_report_flHRKaryawan.prototype.previewReport = function(dthtml)
{
...
window.app_saku_sdm_report_flHRKaryawan.prototype.doCloseReportClick = function(sender)
{
...
window.app_saku_sdm_report_flHRKaryawan.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
