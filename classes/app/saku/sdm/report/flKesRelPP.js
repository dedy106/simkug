window.app_saku_sdm_report_flKesRelPP = function(owner)
{
	if (owner)
	{
		window.app_saku_sdm_report_flKesRelPP.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_sdm_report_flKesRelPP";
		this.maximize();		
...
window.app_saku_sdm_report_flKesRelPP.extend(window.portalui_childForm);
window.app_saku_sdm_report_flKesRelPP.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku_sdm_report_flKesRelPP]::mainButtonClick:"+e);
		}
	},
