window.app_saku_sdm_report_flKesKlpProv = function(owner)
{
	if (owner)
	{
		window.app_saku_sdm_report_flKesKlpProv.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_sdm_report_flKesKlpProv";
		this.maximize();		
...
window.app_saku_sdm_report_flKesKlpProv.extend(window.portalui_childForm);
window.app_saku_sdm_report_flKesKlpProv.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_saku_sdm_report_flKesKlpProv]::mainButtonClick:"+e);
		}
	},
