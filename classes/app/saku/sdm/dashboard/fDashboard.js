...
* 			SAI, PT											
***********************************************************************************************/
window.app_saku_sdm_dashboard_fDashboard = function(owner,options)
{
    if (owner)
    {
		try{
	        window.app_saku_sdm_dashboard_fDashboard.prototype.parent.constructor.call(this, owner,options);        
            this.className = "app_saku_sdm_dashboard_fDashboard";
...
window.app_saku_sdm_dashboard_fDashboard.extend(window.portalui_childForm);
window.app_saku_sdm_dashboard_fDashboard.implement({
    	       ...
    	       switch(methodName){
    	           case "getMultiDataProvider":
    	               ...
    	               if (typeof data != "string"){
	                        ...
	                        this.count = 0;
            				this.fr1 = new portalui_roundPanel(this.tab.childPage[0],{bound:[10,10,frameWidth,250],caption:"Umur",background:"image/themes/dynpro/bluegradient.png",color:"#edf5f8",titleBg:"#95cae8"});									
            		        ...
            		        this.fr2 = new portalui_roundPanel(this.tab.childPage[0],{bound:[this.fr1.left+this.fr1.width + 15,10,frameWidth,250],caption:"Masa Kerja",color:"#edf5f8",titleBg:"#95cae8",background:"image/themes/dynpro/bluegradient.png"});
                            ...
                            this.fr3 = new portalui_roundPanel(this.tab.childPage[0],{bound:[this.fr2.left+this.fr2.width + 15,10,frameWidth,250],caption:"Agama",color:"#edf5f8",titleBg:"#95cae8",background:"image/themes/dynpro/bluegradient.png"});			
							...
							this.fr4 = new portalui_roundPanel(this.tab.childPage[0],{bound:[10,this.fr1.height+20,frameWidth,250],caption:"Status Kawin",color:"#edf5f8",titleBg:"#95cae8",background:"image/themes/dynpro/bluegradient.png"});			
							...
							this.fr5 = new portalui_roundPanel(this.tab.childPage[0],{bound:[this.fr4.left+this.fr4.width + 15,this.fr1.height+20,frameWidth,250],caption:"Pendidikan",color:"#edf5f8",titleBg:"#95cae8",background:"image/themes/dynpro/bluegradient.png"});			
            				...
            				this.fr6 = new portalui_roundPanel(this.tab.childPage[1],{bound:[10,10,frameWidth,250],caption:"Status Pegawai",color:"#edf5f8",titleBg:"#95cae8",background:"image/themes/dynpro/bluegradient.png"});									
							...
							this.fr7 = new portalui_roundPanel(this.tab.childPage[1],{bound:[this.fr6.left+this.fr6.width + 15,10,frameWidth,250],caption:"Tenaga Perbantuan",color:"#edf5f8",titleBg:"#95cae8",background:"image/themes/dynpro/bluegradient.png"});						
							...
							this.fr8 = new portalui_roundPanel(this.tab.childPage[1],{bound:[this.fr7.left+this.fr7.width + 15,10,frameWidth,250],caption:"Jabatan Struktural",color:"#edf5f8",titleBg:"#95cae8",background:"image/themes/dynpro/bluegradient.png"});			
							...
							this.fr9 = new portalui_roundPanel(this.tab.childPage[1],{bound:[10,this.fr6.height+20,frameWidth,250],caption:"Jabatan Fungsional",color:"#edf5f8",titleBg:"#95cae8",background:"image/themes/dynpro/bluegradient.png"});			
            				this.fr9.chart = new portalui_flashChart(this.fr9,{bound:[5,0,this.fr9.getClientWidth() - 30,this.fr9.getClientHeight() - 50],objectReady:[this,"doObjectReady"]});		        
            				this.fr9.chart.data = data.result[8];
							this.fr10 = new portalui_roundPanel(this.tab.childPage[1],{bound:[this.fr9.left+this.fr9.width + 15,this.fr6.height+20,frameWidth,this.height-60],caption:"Profesi",color:"#edf5f8",titleBg:"#95cae8",background:"image/themes/dynpro/bluegradient.png"});
            				this.fr10.chart = new portalui_flashChart(this.fr10,{bound:[5,0,this.fr10.getClientWidth() - 30,this.fr10.getClientHeight() - 50],objectReady:[this,"doObjectReady"]});						
							this.fr10.chart.data = data.result[9];
							
							this.fr11 = new portalui_roundPanel(this.tab.childPage[2],{bound:[10,10,this.width / 2 - 30,this.height-60],caption:"Lokasi Kerja",color:"#edf5f8",titleBg:"#95cae8",background:"image/themes/dynpro/bluegradient.png"});
            				this.fr11.chart = new portalui_flashChart(this.fr11,{bound:[5,0,this.fr11.getClientWidth() - 30,this.fr11.getClientHeight() - 50],objectReady:[this,"doObjectReady"]});						
							this.fr11.chart.data = data.result[10];
							this.fr12 = new portalui_roundPanel(this.tab.childPage[2],{bound:[this.fr11.left+this.fr11.width + 1,10,this.width / 2 - 30,this.height-60],caption:"Unit Kerja",color:"#edf5f8",titleBg:"#95cae8",background:"image/themes/dynpro/bluegradient.png"});
            				this.fr12.chart = new portalui_flashChart(this.fr12,{bound:[5,0,this.fr12.getClientWidth() - 30,this.fr12.getClientHeight() - 50],objectReady:[this,"doObjectReady"]});            				
	...
	getChart: function(data,swf){
		...
		var chart = {
		  ...
		  "elements":[],
		  "x_axis":{
			"stroke": 1,"tick_height": 10,"colour":"#d000d0","grid_colour": "#00ff00","labels":{"labels":[]},"3d": 5 
		   },
		  "y_axis":{
		...
		var male = {"type":"bar_3d","alpha":     0.8,"colour":    "#"+ maleColor,
			  "tip":       "Pria (#val#)",
			  "text":      "Pria",
			  "font-size--": 10,
			  "values" :   [],
	...
	getSQL: function(jnsLap,subtipe){
		...
		if (jnsLap === "Pribadi"){			
			...
			case "umur" : sql= "	(select 'Umur' as nmcol1,'20-35' as col1 "+
				...
				"      , count(sex) as col2 "+
				"    from karyawan a "+
				"        where cast(substring(date_sub(now(),interval substring(a.tgl_lahir,1,7) year_month),3,2) as decimal)>19 "+
				...
				"      , count(sex) as col2 "+
				"    from karyawan a "+
				"        where cast(substring(date_sub(now(),interval substring(a.tgl_lahir,1,7) year_month),3,2) as decimal)>35 "+
				"        and cast(substring(date_sub(now(),interval substring(a.tgl_lahir,1,7) year_month),3,2) as decimal)<46 "+
				"        and a.kode_lokkonsol = '"+this.app._lokKonsol+"' and kode_lokasi = '"+this.app._lokasi+"' "+
				"    group by col1) union "+
				...
				"      , count(sex) as col2 "+
				"    from karyawan a "+
				"        where cast(substring(date_sub(now(),interval substring(a.tgl_lahir,1,7) year_month),3,2) as decimal)>45 "+
				"        and a.kode_lokkonsol = '"+this.app._lokKonsol+"' and kode_lokasi = '"+this.app._lokasi+"' "+
				"    group by col1)"; break;
			case "mk" :	sql = "	(select 'Masa Kerja' as nmcol1,'<2' as col1 "+
				...
				"      , count(sex) as col2 "+
				"    from karyawan a "+
				"        where cast(substring(date_sub(now(),interval substring(a.tgl_masuk,1,7) year_month),3,2) as decimal)<2 "+
				"        and a.kode_lokkonsol = '"+this.app._lokKonsol+"' and kode_lokasi = '"+this.app._lokasi+"' "+
				"    group by col1) union "+
				...
				"      , count(sex) as col2 "+
				"    from karyawan a "+
				"        where cast(substring(date_sub(now(),interval substring(a.tgl_masuk,1,7) year_month),3,2) as decimal)>=2 and "+
				"        cast(substring(date_sub(now(),interval substring(a.tgl_masuk,1,7) year_month),3,2) as decimal)<=5 and a.kode_lokkonsol = '"+this.app._lokKonsol+"' and kode_lokasi = '"+this.app._lokasi+"' "+
				"    group by col1) union "+
				...
				"      , count(sex) as col2 "+
				"    from karyawan a "+
				"        where cast(substring(date_sub(now(),interval substring(a.tgl_masuk,1,7) year_month),3,2) as decimal)>5 and "+
				"        cast(substring(date_sub(now(),interval substring(a.tgl_masuk,1,7) year_month),3,2) as decimal)<=10 and a.kode_lokkonsol = '"+this.app._lokKonsol+"' and kode_lokasi = '"+this.app._lokasi+"' "+
				"    group by col1) union "+
				...
				"      , count(sex) as col2 "+
				"    from karyawan a "+
				"        where cast(substring(date_sub(now(),interval substring(a.tgl_masuk,1,7) year_month),3,2) as decimal)>10 and a.kode_lokkonsol = '"+this.app._lokKonsol+"' and kode_lokasi = '"+this.app._lokasi+"' "+
				"    group by col1)";break;
			...
			case "pendidikan" : sql = "	(select 'Pendidikan' as nmcol1, b.jenjang as col1 "+
				...
				" where b.kode_lokkonsol = '"+this.app._lokKonsol+"' and b.kode_lokasi = '"+this.app._lokasi+"' group by col1) ";break;
			}
			...
			case "status" : sql ="	(select 'Status Pegawai' as nmcol1, a.nama as col1 "+
                ...
                "   where a.kode_lokkonsol = '"+this.app._lokKonsol+"' group by col1)";break;
			...
			case "lokasi":	sql += "	(select 'Lokasi Kerja' as nmcol1, a.nama as col1 "+
                ...
                "      left outer join karyawan c on b.nik = c.nik and c.kode_lokkonsol = a.kode_lokkonsol and c.sex = 'laki-laki' and c.kode_lokasi = b.kode_lokasi "+
                "      left outer join karyawan d on d.nik = b.nik and d.kode_lokkonsol = a.kode_lokkonsol and d.sex = 'perempuan' and d.kode_lokasi = b.kode_lokasi "+
                "   where a.kode_lokkonsol = '"+this.app._lokKonsol+"' and a.kode_lokasi = '"+this.app._lokasi+"' group by col1)";break;
	...
	doGridClick: function(sender, index, title){
		try{
			if (this.trail1 === undefined){
				this.trail1 = new app_saku_sdm_dashboard_fTrail1(this.owner,undefined, this);
				...
				case this.fr2.chart: 		
					switch(parseInt(index,10)) {
						...
						case 1 : sql1 = "select * "+
							"    from karyawan a "+
							"        where cast(substring(date_sub(now(),interval substring(a.tgl_masuk,1,7) year_month),3,2) as decimal)>=2 and "+
							"        cast(substring(date_sub(now(),interval substring(a.tgl_masuk,1,7) year_month),3,2) as decimal)<=5 "+
							"	and a.kode_lokkonsol = '"+this.app._lokKonsol+"' and kode_lokasi = '"+this.app._lokasi+"' "+filter;
							sql2 = "select count(*) "+
							"    from karyawan a "+
							"        where cast(substring(date_sub(now(),interval substring(a.tgl_masuk,1,7) year_month),3,2) as decimal)>=2 and "+
						...
						case 2 : sql1 = "select * "+
							"    from karyawan a "+
							"        where cast(substring(date_sub(now(),interval substring(a.tgl_masuk,1,7) year_month),3,2) as decimal)>5 and "+
							"        cast(substring(date_sub(now(),interval substring(a.tgl_masuk,1,7) year_month),3,2) as decimal)<=10 "+
							"	and a.kode_lokkonsol = '"+this.app._lokKonsol+"' and kode_lokasi = '"+this.app._lokasi+"' "+filter;
							sql2 = "select count(*) "+
							"    from karyawan a "+
							"        where cast(substring(date_sub(now(),interval substring(a.tgl_masuk,1,7) year_month),3,2) as decimal)>5 and "+
						...
						case 3 : sql1 = "select * "+
							"    from karyawan a "+
							"        where cast(substring(date_sub(now(),interval substring(a.tgl_masuk,1,7) year_month),3,2) as decimal)>10 "+
							"	and a.kode_lokkonsol = '"+this.app._lokKonsol+"' and kode_lokasi = '"+this.app._lokasi+"' "+filter;
							sql2 = "select count(*) "+
							"    from karyawan a "+
							"        where cast(substring(date_sub(now(),interval substring(a.tgl_masuk,1,7) year_month),3,2) as decimal)>10 "+
...
window.app_saku_sdm_dashboard_fTrail1 = function(owner,options,callObj)
{
    if (owner)
    {
		try{
	        window.app_saku_sdm_dashboard_fTrail1.prototype.parent.constructor.call(this, owner,options);        
            this.className = "app_saku_sdm_dashboard_fTrail1";			
            this.setCaption("Dashboard");
			this.setColor("");
...
window.app_saku_sdm_dashboard_fTrail1.extend(window.portalui_childForm);
window.app_saku_sdm_dashboard_fTrail1.implement({    
	doClose: function(sender){        	
...
window.app_saku_sdm_dashboard_fTrail2 = function(owner,options, callObj)
{
    if (owner)
    {
		try{
	        window.app_saku_sdm_dashboard_fTrail2.prototype.parent.constructor.call(this, owner,options);        
            this.className = "app_saku_sdm_dashboard_fTrail2";
            this.setCaption("Dashboard");
			this.callObj = callObj;
			this.setColor("");
			this.maximize();
...
window.app_saku_sdm_dashboard_fTrail2.extend(window.portalui_childForm);
window.app_saku_sdm_dashboard_fTrail2.implement({    
	doClick: function(sender){
		this.hide();
		this.callObj.unblock();
	},
