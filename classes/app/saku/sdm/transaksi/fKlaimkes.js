window.app_saku_sdm_transaksi_fKlaimkes = function(owner)
{
	if (owner)
	{
		window.app_saku_sdm_transaksi_fKlaimkes.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_sdm_transaksi_fKlaimkes";
		this.maximize();
...
window.app_saku_sdm_transaksi_fKlaimkes.extend(window.portalui_childForm);
window.app_saku_sdm_transaksi_fKlaimkes.prototype.sg1init = function(sg)
{
	sg.setColWidth([3,2,1,0],[200,200,400,100]);
};
window.app_saku_sdm_transaksi_fKlaimkes.prototype.genClick = function(sender)
{
	try
	{
...
window.app_saku_sdm_transaksi_fKlaimkes.prototype.doEditChange = function(sender)
{
...
window.app_saku_sdm_transaksi_fKlaimkes.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_sdm_transaksi_fKlaimkes.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.app_saku_sdm_transaksi_fKlaimkes.prototype.showClick = function(sender)
{
...
window.app_saku_sdm_transaksi_fKlaimkes.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_saku_sdm_transaksi_fKlaimkes.prototype.doRequestReady = function(sender, methodName, result)
{
