window.app_saku_sdm_transaksi_fHRrwycuti = function(owner)
{
	if (owner)
	{
		window.app_saku_sdm_transaksi_fHRrwycuti.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_sdm_transaksi_fHRrwycuti";
		this.maximize();
...
window.app_saku_sdm_transaksi_fHRrwycuti.extend(window.portalui_childForm);
window.app_saku_sdm_transaksi_fHRrwycuti.prototype.sg1init = function(sg)
{
...
window.app_saku_sdm_transaksi_fHRrwycuti.prototype.tanggal = function(sender,y,m,d)
{
	var d1 = this.dp_tglakhir.toSysDate();
	var d2 = this.dp_tglmulai.toSysDate();
	this.ed_lama.setText(d1.DateDiff(d2));
};
window.app_saku_sdm_transaksi_fHRrwycuti.prototype.sg1onDblClick = function(sender, col, row)
{
	try
	{		
...
window.app_saku_sdm_transaksi_fHRrwycuti.prototype.doEditChange = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRrwycuti.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRrwycuti.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.app_saku_sdm_transaksi_fHRrwycuti.prototype.show2Click = function(sender)
{
	if (this.cb_nik.getText() != "")
	{
		try
...
window.app_saku_sdm_transaksi_fHRrwycuti.prototype.showClick = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRrwycuti.prototype.FindBtnClick = function(sender, event)
{
	try
	{
		if (sender == this.cb_nik) 
...
window.app_saku_sdm_transaksi_fHRrwycuti.prototype.doRequestReady = function(sender, methodName, result)
{
