window.app_saku_sdm_transaksi_fHRrwypddk = function(owner)
{
	if (owner)
	{
		window.app_saku_sdm_transaksi_fHRrwypddk.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_sdm_transaksi_fHRrwypddk";
		this.maximize();
...
window.app_saku_sdm_transaksi_fHRrwypddk.extend(window.portalui_childForm);
window.app_saku_sdm_transaksi_fHRrwypddk.prototype.sg1init = function(sg)
{
	sg.setColWidth([7,6,5,4,3,2,1,0],[100,200,200,120,110,100,120,50]);
};
window.app_saku_sdm_transaksi_fHRrwypddk.prototype.sg1onDblClick = function(sender, col, row)
{
	try
	{		
...
window.app_saku_sdm_transaksi_fHRrwypddk.prototype.doEditChange = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRrwypddk.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRrwypddk.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.app_saku_sdm_transaksi_fHRrwypddk.prototype.show2Click = function(sender)
{
	if (this.cb_nik.getText() != "")
	{
		try
...
window.app_saku_sdm_transaksi_fHRrwypddk.prototype.showClick = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRrwypddk.prototype.FindBtnClick = function(sender, event)
{
	try
	{
		if (sender == this.cb_nik) 
...
window.app_saku_sdm_transaksi_fHRrwypddk.prototype.doRequestReady = function(sender, methodName, result)
{
