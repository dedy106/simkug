window.app_saku_sdm_transaksi_fHRrwygaji = function(owner)
{
	if (owner)
	{
		window.app_saku_sdm_transaksi_fHRrwygaji.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_sdm_transaksi_fHRrwygaji";
		this.maximize();
...
window.app_saku_sdm_transaksi_fHRrwygaji.extend(window.portalui_childForm);
window.app_saku_sdm_transaksi_fHRrwygaji.prototype.sg1init = function(sg)
{
	sg.columns.get(6).setColumnFormat(window.cfNilai);
	sg.setColWidth([8,7,6,5,4,3,2,1,0],
					[80,210,100,100,100,110,80,80,120]);
};
window.app_saku_sdm_transaksi_fHRrwygaji.prototype.sg1onDblClick = function(sender, col, row)
{
	try
	{		
...
window.app_saku_sdm_transaksi_fHRrwygaji.prototype.hitungClick = function(sender)
{
	try
	{
...
window.app_saku_sdm_transaksi_fHRrwygaji.prototype.doEditChange = function(sender)
{
	if (this.cb_nik.getText() != "")
	{
...
window.app_saku_sdm_transaksi_fHRrwygaji.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRrwygaji.prototype.doModalResult = function(event, modalResult)
{			
	var stsAktif = "0";
...
window.app_saku_sdm_transaksi_fHRrwygaji.prototype.show2Click = function(sender)
{
	if (this.cb_nik.getText() != "")
	{
		try
...
window.app_saku_sdm_transaksi_fHRrwygaji.prototype.showClick = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRrwygaji.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_saku_sdm_transaksi_fHRrwygaji.prototype.doRequestReady = function(sender, methodName, result)
{
...
window.app_saku_sdm_transaksi_fHRrwygaji.implement({
