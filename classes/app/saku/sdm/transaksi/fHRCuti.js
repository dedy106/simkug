window.app_saku_sdm_transaksi_fHRCuti = function(owner)
{
	if (owner)
	{
		window.app_saku_sdm_transaksi_fHRCuti.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_sdm_transaksi_fHRCuti";
		this.maximize();
...
window.app_saku_sdm_transaksi_fHRCuti.extend(window.portalui_childForm);

window.app_saku_sdm_transaksi_fHRCuti.prototype.sg1init = function(sg)
{
	sg.setColWidth(new Array(3,2,1,0),
					new Array(100,80,80,150));	
}

window.app_saku_sdm_transaksi_fHRCuti.prototype.sg1onDblClick = function(sender, col, row)
{
	try
	{			
...
window.app_saku_sdm_transaksi_fHRCuti.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRCuti.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.app_saku_sdm_transaksi_fHRCuti.prototype.showClick = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRCuti.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_saku_sdm_transaksi_fHRCuti.prototype.doRequestReady = function(sender, methodName, result)
{
