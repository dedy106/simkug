window.app_saku_sdm_transaksi_fHRrwylatih = function(owner)
{
	if (owner)
	{
		window.app_saku_sdm_transaksi_fHRrwylatih.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_sdm_transaksi_fHRrwylatih";
		this.maximize();
...
window.app_saku_sdm_transaksi_fHRrwylatih.extend(window.portalui_childForm);
window.app_saku_sdm_transaksi_fHRrwylatih.prototype.sg1init = function(sg)
{
	sg.setColWidth([7,6,5,4,3,2,1,0],[100,200,200,120,110,100,120,50]);
};
window.app_saku_sdm_transaksi_fHRrwylatih.prototype.sg1onDblClick = function(sender, col, row)
{
	try
	{		
...
window.app_saku_sdm_transaksi_fHRrwylatih.prototype.doEditChange = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRrwylatih.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRrwylatih.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.app_saku_sdm_transaksi_fHRrwylatih.prototype.show2Click = function(sender)
{
	if (this.cb_nik.getText() != "")
	{
		try
...
window.app_saku_sdm_transaksi_fHRrwylatih.prototype.showClick = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRrwylatih.prototype.FindBtnClick = function(sender, event)
{
	try
	{
		if (sender == this.cb_nik) 
...
window.app_saku_sdm_transaksi_fHRrwylatih.prototype.doRequestReady = function(sender, methodName, result)
{
