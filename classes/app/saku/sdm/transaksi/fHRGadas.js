window.app_saku_sdm_transaksi_fHRGadas = function(owner)
{
	if (owner)
	{
		window.app_saku_sdm_transaksi_fHRGadas.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_sdm_transaksi_fHRGadas";
		this.maximize();
		...
		this.ed_tunjangan = new portalui_saiLabelEdit(this);
		...
		this.ed_band = new portalui_saiLabelEdit(this);
		...
		this.ed_kelas = new portalui_saiLabelEdit(this);
...
window.app_saku_sdm_transaksi_fHRGadas.extend(window.portalui_childForm);

window.app_saku_sdm_transaksi_fHRGadas.prototype.sg1init = function(sg)
{
...
window.app_saku_sdm_transaksi_fHRGadas.prototype.sg1onDblClick = function(sender, col, row)
{
	try
	{			
...
window.app_saku_sdm_transaksi_fHRGadas.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRGadas.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.app_saku_sdm_transaksi_fHRGadas.prototype.showClick = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRGadas.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_saku_sdm_transaksi_fHRGadas.prototype.doRequestReady = function(sender, methodName, result)
{
