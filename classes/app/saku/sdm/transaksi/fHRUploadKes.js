window.app_saku_sdm_transaksi_fHRUploadKes = function(owner)
{
	if (owner)
	{
		window.app_saku_sdm_transaksi_fHRUploadKes.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku_sdm_transaksi_fHRUploadKes";
...
window.app_saku_sdm_transaksi_fHRUploadKes.extend(window.portalui_childForm);
window.app_saku_sdm_transaksi_fHRUploadKes.implement({
	...
	doFindBtnClick: function(sender, col, row){
		...
		if (sender == this.sg1){
			switch (col){
				...
				break;
				case 5:
					this.standarLib.ListDataSGFilter(this, "Daftar Karyawan",this.sg1, this.sg1.row, this.sg1.col, 
	...
	initColumn: function(){
		try{
			...
			if (typeof data != "string"){			
				...
				this.sg1.setButtonStyle([0,5],[bsEllips, bsEllips]);
