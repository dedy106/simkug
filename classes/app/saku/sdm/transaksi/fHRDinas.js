window.app_saku_sdm_transaksi_fHRDinas = function(owner)
{
	if (owner)
	{
		window.app_saku_sdm_transaksi_fHRDinas.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_sdm_transaksi_fHRDinas";
		this.maximize();
		...
		this.ed_divisi = new portalui_saiCBBL(this);
...
window.app_saku_sdm_transaksi_fHRDinas.extend(window.portalui_childForm);

window.app_saku_sdm_transaksi_fHRDinas.prototype.sg1init = function(sg)
{
	sg.setColWidth(new Array(8,7,6,5,4,3,2,1,0),
					new Array(150,100,80,150,80,100,150,80,80));
}

window.app_saku_sdm_transaksi_fHRDinas.prototype.sg1onDblClick = function(sender, col, row)
{
	try
	{			
...
window.app_saku_sdm_transaksi_fHRDinas.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRDinas.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.app_saku_sdm_transaksi_fHRDinas.prototype.showClick = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRDinas.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_saku_sdm_transaksi_fHRDinas.prototype.doRequestReady = function(sender, methodName, result)
{
