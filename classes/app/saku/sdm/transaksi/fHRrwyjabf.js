window.app_saku_sdm_transaksi_fHRrwyjabf = function(owner)
{
	if (owner)
	{
		window.app_saku_sdm_transaksi_fHRrwyjabf.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_sdm_transaksi_fHRrwyjabf";
		this.maximize();
...
window.app_saku_sdm_transaksi_fHRrwyjabf.extend(window.portalui_childForm);
window.app_saku_sdm_transaksi_fHRrwyjabf.prototype.sg1init = function(sg)
{
	sg.setColWidth([9,8,7,6,5,4,3,2,1,0],
					[80,100,100,100,120,120,80,80,80,120]);
};
window.app_saku_sdm_transaksi_fHRrwyjabf.prototype.sg1onDblClick = function(sender, col, row)
{
	try
	{		
...
window.app_saku_sdm_transaksi_fHRrwyjabf.prototype.doEditChange = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRrwyjabf.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRrwyjabf.prototype.doModalResult = function(event, modalResult)
{			
	var stsAktif = "0";
...
window.app_saku_sdm_transaksi_fHRrwyjabf.prototype.show2Click = function(sender)
{
	if (this.cb_nik.getText() != "")
	{
		try
...
window.app_saku_sdm_transaksi_fHRrwyjabf.prototype.showClick = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRrwyjabf.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_saku_sdm_transaksi_fHRrwyjabf.prototype.doRequestReady = function(sender, methodName, result)
{
...
window.app_saku_sdm_transaksi_fHRrwyjabf.implement({
