window.app_saku_sdm_transaksi_fHRPelatihan = function(owner)
{
	if (owner)
	{
		window.app_saku_sdm_transaksi_fHRPelatihan.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_sdm_transaksi_fHRPelatihan";
		this.maximize();
		...
		this.ed_pelatihan = new portalui_saiLabelEdit(this);
		...
		this.ed_penyelenggara = new portalui_saiLabelEdit(this);
		...
		this.ed_angkatan = new portalui_saiLabelEdit(this);
		...
		this.ed_peringkat = new portalui_saiLabelEdit(this);
...
window.app_saku_sdm_transaksi_fHRPelatihan.extend(window.portalui_childForm);

window.app_saku_sdm_transaksi_fHRPelatihan.prototype.sg1init = function(sg)
{
	sg.setColWidth(new Array(5,4,3,2,1,0),
					new Array(100,100,80,80,150,150));
}

window.app_saku_sdm_transaksi_fHRPelatihan.prototype.sg1onDblClick = function(sender, col, row)
{
	try
	{			
...
window.app_saku_sdm_transaksi_fHRPelatihan.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRPelatihan.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.app_saku_sdm_transaksi_fHRPelatihan.prototype.showClick = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRPelatihan.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_saku_sdm_transaksi_fHRPelatihan.prototype.doRequestReady = function(sender, methodName, result)
{
