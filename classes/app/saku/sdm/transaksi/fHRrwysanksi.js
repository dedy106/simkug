window.app_saku_sdm_transaksi_fHRrwysanksi = function(owner)
{
	if (owner)
	{
		window.app_saku_sdm_transaksi_fHRrwysanksi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_sdm_transaksi_fHRrwysanksi";
		this.maximize();
...
window.app_saku_sdm_transaksi_fHRrwysanksi.extend(window.portalui_childForm);
window.app_saku_sdm_transaksi_fHRrwysanksi.prototype.sg1init = function(sg)
{
	sg.columns.get(4).setColumnFormat(window.cfNilai);
	sg.setColWidth([6,5,4,3,2,1,0],[180,100,100,80,180,80,180]);
};
window.app_saku_sdm_transaksi_fHRrwysanksi.prototype.sg1onDblClick = function(sender, col, row)
{
	try
	{		
...
window.app_saku_sdm_transaksi_fHRrwysanksi.prototype.doEditChange = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRrwysanksi.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRrwysanksi.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.app_saku_sdm_transaksi_fHRrwysanksi.prototype.show2Click = function(sender)
{
	if (this.cb_nik.getText() != "")
	{
		try
...
window.app_saku_sdm_transaksi_fHRrwysanksi.prototype.showClick = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRrwysanksi.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_saku_sdm_transaksi_fHRrwysanksi.prototype.doRequestReady = function(sender, methodName, result)
{
