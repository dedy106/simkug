window.app_saku_sdm_transaksi_fHRrwypangti = function(owner)
{
	if (owner)
	{
		window.app_saku_sdm_transaksi_fHRrwypangti.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_sdm_transaksi_fHRrwypangti";
		this.maximize();
...
window.app_saku_sdm_transaksi_fHRrwypangti.extend(window.portalui_childForm);
window.app_saku_sdm_transaksi_fHRrwypangti.prototype.sg1init = function(sg)
{
	sg.setColWidth([8,7,6,5,4,3,2,1,0],
				[80,210,100,100,100,110,80,80,120]);
};
window.app_saku_sdm_transaksi_fHRrwypangti.prototype.sg1onDblClick = function(sender, col, row)
{
	try
	{
...
window.app_saku_sdm_transaksi_fHRrwypangti.prototype.doEditChange = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRrwypangti.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRrwypangti.prototype.doModalResult = function(event, modalResult)
{			
	var stsAktif = "0";
...
window.app_saku_sdm_transaksi_fHRrwypangti.prototype.show2Click = function(sender)
{
	if (this.cb_nik.getText() != "")
	{
		try
...
window.app_saku_sdm_transaksi_fHRrwypangti.prototype.showClick = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRrwypangti.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_saku_sdm_transaksi_fHRrwypangti.prototype.doRequestReady = function(sender, methodName, result)
{
...
window.app_saku_sdm_transaksi_fHRrwypangti.implement({
