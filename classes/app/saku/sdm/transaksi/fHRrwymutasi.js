window.app_saku_sdm_transaksi_fHRrwymutasi = function(owner)
{
	if (owner)
	{
		window.app_saku_sdm_transaksi_fHRrwymutasi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_sdm_transaksi_fHRrwymutasi";
		this.maximize();
...
window.app_saku_sdm_transaksi_fHRrwymutasi.extend(window.portalui_childForm);
window.app_saku_sdm_transaksi_fHRrwymutasi.prototype.sg1init = function(sg)
{
	sg.setColWidth([8,7,6,5,4,3,2,1,0],[80,190,100,100,120,110,80,80,120]);
};
window.app_saku_sdm_transaksi_fHRrwymutasi.prototype.sg1onDblClick = function(sender, col, row)
{
	try
	{		
...
window.app_saku_sdm_transaksi_fHRrwymutasi.prototype.doEditChange = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRrwymutasi.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRrwymutasi.prototype.doModalResult = function(event, modalResult)
{			
	var stsAktif = "0";
...
window.app_saku_sdm_transaksi_fHRrwymutasi.prototype.show2Click = function(sender)
{
	if (this.cb_nik.getText() != "")
	{
		try
...
window.app_saku_sdm_transaksi_fHRrwymutasi.prototype.showClick = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRrwymutasi.prototype.FindBtnClick = function(sender, event)
{
	try
	{
		if (sender == this.cb_nik) 
...
window.app_saku_sdm_transaksi_fHRrwymutasi.prototype.doRequestReady = function(sender, methodName, result)
{
...
window.app_saku_sdm_transaksi_fHRrwymutasi.implement({
