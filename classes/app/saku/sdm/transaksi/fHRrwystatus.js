window.app_saku_sdm_transaksi_fHRrwystatus = function(owner)
{
	if (owner)
	{
		window.app_saku_sdm_transaksi_fHRrwystatus.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_sdm_transaksi_fHRrwystatus";
		this.maximize();
...
window.app_saku_sdm_transaksi_fHRrwystatus.extend(window.portalui_childForm);
window.app_saku_sdm_transaksi_fHRrwystatus.prototype.sg1init = function(sg)
{
	sg.setColWidth([8,7,6,5,4,3,2,1,0],
				[80,210,100,100,100,110,80,80,120]);
};
window.app_saku_sdm_transaksi_fHRrwystatus.prototype.sg1onDblClick = function(sender, col, row)
{
	try
	{		
...
window.app_saku_sdm_transaksi_fHRrwystatus.prototype.doEditChange = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRrwystatus.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRrwystatus.prototype.doModalResult = function(event, modalResult)
{			
	var stsAktif = "0";
...
window.app_saku_sdm_transaksi_fHRrwystatus.prototype.show2Click = function(sender)
{
	if (this.cb_nik.getText() != "")
	{
		try
...
window.app_saku_sdm_transaksi_fHRrwystatus.prototype.showClick = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRrwystatus.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_saku_sdm_transaksi_fHRrwystatus.prototype.doRequestReady = function(sender, methodName, result)
{
...
window.app_saku_sdm_transaksi_fHRrwystatus.implement({
