window.app_saku_sdm_transaksi_fHRrwynki = function(owner)
{
	if (owner)
	{
		window.app_saku_sdm_transaksi_fHRrwynki.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_sdm_transaksi_fHRrwynki";
		this.maximize();
...
window.app_saku_sdm_transaksi_fHRrwynki.extend(window.portalui_childForm);
window.app_saku_sdm_transaksi_fHRrwynki.prototype.sg1init = function(sg)
{
...
window.app_saku_sdm_transaksi_fHRrwynki.prototype.sg1onDblClick = function(sender, col, row)
{
	try
	{		
...
window.app_saku_sdm_transaksi_fHRrwynki.prototype.doEditChange = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRrwynki.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRrwynki.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.app_saku_sdm_transaksi_fHRrwynki.prototype.show2Click = function(sender)
{
	if (this.cb_nik.getText() != "")
	{
		try
...
window.app_saku_sdm_transaksi_fHRrwynki.prototype.showClick = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRrwynki.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_saku_sdm_transaksi_fHRrwynki.prototype.doRequestReady = function(sender, methodName, result)
{
