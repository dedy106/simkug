window.app_saku_sdm_transaksi_fHRPendidikan = function(owner)
{
	if (owner)
	{
		window.app_saku_sdm_transaksi_fHRPendidikan.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_sdm_transaksi_fHRPendidikan";
		this.maximize();
		...
		this.ed_intitusi = new portalui_saiLabelEdit(this);
		...
		this.dp_tglend = new portalui_datePicker(this);
		this.dp_tglend.setTop(188);
		this.dp_tglend.setLeft(120);
		this.dp_tglend.setWidth(82);
		
		this.ed_biaya = new portalui_saiLabelEdit(this);
...
window.app_saku_sdm_transaksi_fHRPendidikan.extend(window.portalui_childForm);

window.app_saku_sdm_transaksi_fHRPendidikan.prototype.sg1init = function(sg)
{
	sg.setColWidth(new Array(4,3,2,1,0),
					new Array(100,80,80,150,150));
}

window.app_saku_sdm_transaksi_fHRPendidikan.prototype.sg1onDblClick = function(sender, col, row)
{
	try
	{
...
window.app_saku_sdm_transaksi_fHRPendidikan.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRPendidikan.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.app_saku_sdm_transaksi_fHRPendidikan.prototype.showClick = function(sender)
{
...
window.app_saku_sdm_transaksi_fHRPendidikan.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_saku_sdm_transaksi_fHRPendidikan.prototype.doRequestReady = function(sender, methodName, result)
{
