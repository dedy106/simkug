window.app_saku_sdm_master_fHRJab = function(owner)
{
	if (owner)
	{
		window.app_saku_sdm_master_fHRJab.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_sdm_master_fHRJab";
		this.maximize();
...
window.app_saku_sdm_master_fHRJab.extend(window.portalui_childForm);
window.app_saku_sdm_master_fHRJab.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_sdm_master_fHRJab.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.app_saku_sdm_master_fHRJab.prototype.showClick = function(sender)
{	
...
window.app_saku_sdm_master_fHRJab.prototype.tampilClick = function(sender)
{
	this.sg1.clearAll();
...
window.app_saku_sdm_master_fHRJab.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_saku_sdm_master_fHRJab.prototype.doRequestReady = function(sender, methodName, result)
{
