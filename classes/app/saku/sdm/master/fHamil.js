window.app_saku_sdm_master_fHamil = function(owner)
{
	if (owner)
	{
		window.app_saku_sdm_master_fHamil.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_sdm_master_fHamil";
		this.maximize();
...
window.app_saku_sdm_master_fHamil.extend(window.portalui_childForm);
window.app_saku_sdm_master_fHamil.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_sdm_master_fHamil.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.app_saku_sdm_master_fHamil.prototype.doRequestReady = function(sender, methodName, result)
{
