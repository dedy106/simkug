window.app_saku_sdm_master_fHRKaryawan = function(owner)
{
	if (owner)
	{
		window.app_saku_sdm_master_fHRKaryawan.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_sdm_master_fHRKaryawan";
		this.maximize();
...
window.app_saku_sdm_master_fHRKaryawan.extend(window.portalui_childForm);
window.app_saku_sdm_master_fHRKaryawan.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_sdm_master_fHRKaryawan.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.app_saku_sdm_master_fHRKaryawan.prototype.showClick = function(sender)
{
...
window.app_saku_sdm_master_fHRKaryawan.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_saku_sdm_master_fHRKaryawan.prototype.doRequestReady = function(sender, methodName, result)
{
