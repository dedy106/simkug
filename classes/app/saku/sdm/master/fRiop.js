window.app_saku_sdm_master_fRiop = function(owner)
{
	if (owner)
	{
		window.app_saku_sdm_master_fRiop.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_sdm_master_fRiop";
		this.maximize();
...
window.app_saku_sdm_master_fRiop.extend(window.portalui_childForm);
window.app_saku_sdm_master_fRiop.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_sdm_master_fRiop.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.app_saku_sdm_master_fRiop.prototype.showClick = function(sender)
{	
...
window.app_saku_sdm_master_fRiop.prototype.tampilClick = function(sender)
{
	this.sg1.clearAll();
...
window.app_saku_sdm_master_fRiop.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_saku_sdm_master_fRiop.prototype.doRequestReady = function(sender, methodName, result)
{
