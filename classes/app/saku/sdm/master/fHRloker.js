window.app_saku_sdm_master_fHRloker = function(owner)
{
	if (owner)
	{
		window.app_saku_sdm_master_fHRloker.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_sdm_master_fHRloker";
		this.setTop(60);
		this.setWidth(1280);
		this.setHeight(550);
...
window.app_saku_sdm_master_fHRloker.extend(window.portalui_childForm);
window.app_saku_sdm_master_fHRloker.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_sdm_master_fHRloker.prototype.doModalResult = function(event, modalResult)
{
	switch (event)
	{
		case "clear" :
...
window.app_saku_sdm_master_fHRloker.prototype.showClick = function(sender)
{
...
window.app_saku_sdm_master_fHRloker.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_saku_sdm_master_fHRloker.prototype.doRequestReady = function(sender, methodName, result)
{
...
window.app_saku_sdm_master_fHRloker.prototype.doFileChange = function(sender, filename, allow)
{
	if (allow)
