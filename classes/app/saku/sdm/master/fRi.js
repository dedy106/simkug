window.app_saku_sdm_master_fRi = function(owner)
{
	if (owner)
	{
		window.app_saku_sdm_master_fRi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_sdm_master_fRi";
		this.maximize();
...
window.app_saku_sdm_master_fRi.extend(window.portalui_childForm);
window.app_saku_sdm_master_fRi.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_sdm_master_fRi.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.app_saku_sdm_master_fRi.prototype.showClick = function(sender)
{	
...
window.app_saku_sdm_master_fRi.prototype.tampilClick = function(sender)
{
	this.sg1.clearAll();
...
window.app_saku_sdm_master_fRi.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_saku_sdm_master_fRi.prototype.doRequestReady = function(sender, methodName, result)
{
