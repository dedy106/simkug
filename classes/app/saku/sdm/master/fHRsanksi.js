window.app_saku_sdm_master_fHRsanksi = function(owner)
{
	if (owner)
	{
		window.app_saku_sdm_master_fHRsanksi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_sdm_master_fHRsanksi";
		this.maximize();
...
window.app_saku_sdm_master_fHRsanksi.extend(window.portalui_childForm);
window.app_saku_sdm_master_fHRsanksi.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_sdm_master_fHRsanksi.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.app_saku_sdm_master_fHRsanksi.prototype.showClick = function(sender)
{	
...
window.app_saku_sdm_master_fHRsanksi.prototype.tampilClick = function(sender)
{
	this.sg1.clearAll();
...
window.app_saku_sdm_master_fHRsanksi.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_saku_sdm_master_fHRsanksi.prototype.doRequestReady = function(sender, methodName, result)
{
