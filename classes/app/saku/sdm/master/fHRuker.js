window.app_saku_sdm_master_fHRuker = function(owner)
{
	if (owner)
	{
		window.app_saku_sdm_master_fHRuker.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku_sdm_master_fHRuker";
...
window.app_saku_sdm_master_fHRuker.extend(window.portalui_childForm);
window.app_saku_sdm_master_fHRuker.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_sdm_master_fHRuker.prototype.doRequestReady = function(sender, methodName, result)
{
	switch (methodName)
	{
		case "listData" :
...
window.app_saku_sdm_master_fHRuker.prototype.doModalResult = function(event, modalResult, value)
{
	try
	{
		switch (event)
	...
	{
		alert("[app_saku_sdm_master_fHRuker]::doModalResult:"+e);
	}
};
window.app_saku_sdm_master_fHRuker.prototype.loadMenu = function(daftarNrc)
{
	try
	{
...
window.app_saku_sdm_master_fHRuker.prototype.doClick = function(sender)
{	
...
window.app_saku_sdm_master_fHRuker.prototype.entriesClick = function(sender)
{
	try
	{ 
...
window.app_saku_sdm_master_fHRuker.prototype.treeClick = function(item)
{
};
window.app_saku_sdm_master_fHRuker.prototype.getTreeData = function(node)
{
	var result = "";
	var child = undefined;
...
window.app_saku_sdm_master_fHRuker.prototype.getSummary = function(node)
{
	var result = "";
	var child = undefined;
	if (node instanceof portalui_treeView)
...
window.app_saku_sdm_master_fHRuker.prototype.doFindLokasi = function(sender)
{
...
window.app_saku_sdm_master_fHRuker.prototype.copyChilds = function(from, to)
{
	var temp = undefined;
