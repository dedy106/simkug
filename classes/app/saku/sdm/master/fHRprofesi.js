window.app_saku_sdm_master_fHRprofesi = function(owner)
{
	if (owner)
	{
		window.app_saku_sdm_master_fHRprofesi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_sdm_master_fHRprofesi";
		this.maximize();
...
window.app_saku_sdm_master_fHRprofesi.extend(window.portalui_childForm);
window.app_saku_sdm_master_fHRprofesi.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_sdm_master_fHRprofesi.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.app_saku_sdm_master_fHRprofesi.prototype.showClick = function(sender)
{	
...
window.app_saku_sdm_master_fHRprofesi.prototype.tampilClick = function(sender)
{
	this.sg1.clearAll();
...
window.app_saku_sdm_master_fHRprofesi.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_saku_sdm_master_fHRprofesi.prototype.doRequestReady = function(sender, methodName, result)
{
