window.app_saku_sdm_trail_fTrailHRKerja = function(owner)
{
	try
	{
		if (owner)
		{
			window.app_saku_sdm_trail_fTrailHRKerja.prototype.parent.constructor.call(this, owner);
			this.className = "app_saku_sdm_trail_fTrailHRKerja";			
			this.maximize();
	...
	{
		alert("[app_saku_sdm_trail_fTrailHRKerja]::contructor: "+e);
	}
}

window.app_saku_sdm_trail_fTrailHRKerja.extend(window.portalui_childForm);

window.app_saku_sdm_trail_fTrailHRKerja.prototype.mgOnExpand = function(sender)
{
	...
	if (sender.owner == this.mg3)
	{
		...
		this.mg4 = new portalui_mdGrid(pos);
		this.mg4.setTop(0);
		this.mg4.setLeft(1);
		...
		this.mg5 = new portalui_mdGrid(gadas);
		this.mg5.setTop(0);
		this.mg5.setLeft(1);
		...
		this.mg11 = new portalui_mdGrid(status);
		this.mg11.setTop(0);
		this.mg11.setLeft(1);
		...
		this.mg14 = new portalui_mdGrid(ski);
		this.mg14.setTop(0);
		this.mg14.setLeft(1);
		...
		this.mg16 = new portalui_mdGrid(fas);
		this.mg16.setTop(0);
		this.mg16.setLeft(1);
		...
		this.mg17 = new portalui_mdGrid(cuti);
		this.mg17.setTop(0);
		this.mg17.setLeft(1);
		...
		this.mg18 = new portalui_mdGrid(kntr);
		this.mg18.setTop(0);
		this.mg18.setLeft(1);
		...
		this.mg19 = new portalui_mdGrid(rmh);
		this.mg19.setTop(0);
		this.mg19.setLeft(1);
		...
		this.mg20 = new portalui_mdGrid(info);
		this.mg20.setTop(0);
		this.mg20.setLeft(1);
...
window.app_saku_sdm_trail_fTrailHRKerja.prototype.execTrail = function()
{
	try
	{
	...
	{
		alert("[app_saku_sdm_trail_fTrailHRKerja]::execTrail:"+e);
	}
}

window.app_saku_sdm_trail_fTrailHRKerja.prototype.mainButtonClick = function(sender)
{
	try
	{
	...
	{
		alert("[app_saku_sdm_trail_fTrailHRKerja]::mainButtonClick:"+e);
	}
}
