...
window.app_saku_fJurnalViewer = function(owner,options){
	try{
		if (owner)
		{
			window.app_saku_fJurnalViewer.prototype.parent.constructor.call(this, owner,options);
			this.className = "app_saku_fJurnalViewer";			
			this.isClick = false;
			this.mouseX = 0;
			this.mouseY = 0;
			this.maximize();			
		...
		systemAPI.alert("[app_saku_fJurnalViewer]::contruct:"+e);
	}
};
window.app_saku_fJurnalViewer.extend(window.portalui_sysForm);
window.app_saku_fJurnalViewer.implement({
	...
	initComponent: function(){
		try{
			this.p = new portalui_panel(this,{bound:[0,50,800,425],caption:"Data Jurnal"});		
			this.sg = new portalui_saiGrid(this.p,{bound:[1,20,796,380], readOnly:true});
			this.sgn = new portalui_sgNavigator(this.p,{bound:[0,400,800,25],buttonStyle:3,grid:this.sg});		
			this.sgn.setTotalPage(1);		
			this.btn = new portalui_button(this,{bound:[0,480,80,18],caption:"Close",click:[this,"doClick"]});		
			this.ctrl = new portalui_control(this,{bound:[0,26,800,401], visible:false});
			var n = this.getFullId();
			...
			this.iframe = $(n +"_iframe");
			this.pPrint = new portalui_panel(this,{bound:[0,0,this.width,26],visible:false});		
			this.PrintBtn = new portalui_imageButton(this,{bound:[2,2,22,22],image:"icon/"+system.getThemes()+"/print.png", hint:"Print Page",tag:1,click:[this,"doPrintClick"],name:"PrintBtn"});																		
			this.PreviewBtn = new portalui_imageButton(this,{bound:[24,2,22,22],image:"icon/"+system.getThemes()+"/printPreview.png", hint:"Print Preview",tag:1,click:[this,"doPreviewClick"],name:"PreviewBtn"});
		}catch(e){
