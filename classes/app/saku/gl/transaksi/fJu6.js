window.app_saku_gl_transaksi_fJu6 = function(owner)
{
	if (owner)
	{
		window.app_saku_gl_transaksi_fJu6.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_gl_transaksi_fJu6";
		this.maximize();
		this.itemsValue = new portalui_arrayList();	
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Jurnal Umum [Buku Bantu] Lintas Bulan: Input", 0);	
...
window.app_saku_gl_transaksi_fJu6.extend(window.portalui_childForm);
window.app_saku_gl_transaksi_fJu6.prototype.doSelect = function(sender, year, month, day)
{
	if (month < 10)
		month = "0"+month;
...
window.app_saku_gl_transaksi_fJu6.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_gl_transaksi_fJu6.prototype.simpan = function()
{	
	this.hitungGar();
...
window.app_saku_gl_transaksi_fJu6.prototype.doModalResult = function(event, modalResult)
{
...
window.app_saku_gl_transaksi_fJu6.prototype.genClick = function(sender)
{
	try
	{
...
window.app_saku_gl_transaksi_fJu6.prototype.showClick = function(sender)
{
...
window.app_saku_gl_transaksi_fJu6.prototype.doEditChange = function(sender)
{
...
window.app_saku_gl_transaksi_fJu6.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_saku_gl_transaksi_fJu6.prototype.doCellEnter = function(sender, col, row) 
{
	try
	{
		switch(col)
...
window.app_saku_gl_transaksi_fJu6.prototype.doFindBtnClick = function(sender, col, row) 
{
	try
	{
		switch(col)
	...
	{
		alert("[app_saku_gl_transaksi_fJu6] : doFindBtnClick : " + e);
	}
};

window.app_saku_gl_transaksi_fJu6.prototype.doNilaiChange = function()
{
	try{
		var totD = totC = 0;
		for (var i = 0; i < this.sg1.rows.getLength();i++){
	...
	{
		alert("[app_saku_gl_transaksi_fJu6]::doNilaiChange:"+e);
	}
};

window.app_saku_gl_transaksi_fJu6.prototype.doCellExit = function(sender, col, row) 
{
	try
	{
		switch(col)
...
window.app_saku_gl_transaksi_fJu6.prototype.hitungGar = function()
{
...
window.app_saku_gl_transaksi_fJu6.prototype.garClick = function(sender)
{
	try
	{
...
window.app_saku_gl_transaksi_fJu6.prototype.doRequestReady = function(sender, methodName, result)
{
