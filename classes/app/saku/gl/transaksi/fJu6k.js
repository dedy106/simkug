window.app_saku_gl_transaksi_fJu6k = function(owner)
{
	if (owner)
	{
		window.app_saku_gl_transaksi_fJu6k.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_gl_transaksi_fJu6k";
		this.maximize();
		this.itemsValue = new portalui_arrayList();	
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Jurnal Umum [Buku Bantu] Lintas Bulan: Koreksi", 0);	
...
window.app_saku_gl_transaksi_fJu6k.extend(window.portalui_childForm);
window.app_saku_gl_transaksi_fJu6k.implement({
	...
	doFindBtnClick: function(sender, col, row){
		try
		{
			...
			systemAPI.alert("[app_saku_gl_transaksi_fJu6k] : doFindBtnClick : " + e);
		}		
	},
	doNilaiChange: function(){
		try{
			...
			alert("[app_saku_gl_transaksi_fJu6k]::doNilaiChange:"+e);
		}
	},
