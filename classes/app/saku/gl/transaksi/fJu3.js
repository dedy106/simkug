window.app_saku_gl_transaksi_fJu3 = function(owner)
{
	if (owner)
	{
		window.app_saku_gl_transaksi_fJu3.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_gl_transaksi_fJu3";
		this.maximize();
		this.itemsValue = new portalui_arrayList();	
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Jurnal Umum [Buku Bantu]: Input", 0);	
...
window.app_saku_gl_transaksi_fJu3.extend(window.portalui_childForm);
window.app_saku_gl_transaksi_fJu3.prototype.doSelect = function(sender, year, month, day)
{
	if (month < 10)
		month = "0"+month;
...
window.app_saku_gl_transaksi_fJu3.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_gl_transaksi_fJu3.prototype.simpan = function()
{	
	this.hitungGar();
...
window.app_saku_gl_transaksi_fJu3.prototype.doModalResult = function(event, modalResult)
{
...
window.app_saku_gl_transaksi_fJu3.prototype.genClick = function(sender)
{
	try
	{
...
window.app_saku_gl_transaksi_fJu3.prototype.showClick = function(sender)
{
...
window.app_saku_gl_transaksi_fJu3.prototype.doEditChange = function(sender)
{
...
window.app_saku_gl_transaksi_fJu3.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_saku_gl_transaksi_fJu3.prototype.doCellEnter = function(sender, col, row) 
{
	try
	{
		switch(col)
...
window.app_saku_gl_transaksi_fJu3.prototype.doFindBtnClick = function(sender, col, row) 
{
	try
	{
		switch(col)
	...
	{
		alert("[app_saku_gl_transaksi_fJu3] : doFindBtnClick : " + e);
	}
};

window.app_saku_gl_transaksi_fJu3.prototype.doNilaiChange = function()
{
	try
	{
		var totD = totC = 0;
	...
	{
		alert("[app_saku_gl_transaksi_fJu3]::doNilaiChange:"+e);
	}
};

window.app_saku_gl_transaksi_fJu3.prototype.doCellExit = function(sender, col, row) 
{
	try
	{
		switch(col)
...
window.app_saku_gl_transaksi_fJu3.prototype.hitungGar = function()
{
...
window.app_saku_gl_transaksi_fJu3.prototype.garClick = function(sender)
{
	try
	{
...
window.app_saku_gl_transaksi_fJu3.prototype.doRequestReady = function(sender, methodName, result)
{
