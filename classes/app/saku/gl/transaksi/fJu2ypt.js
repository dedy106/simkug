window.app_saku_gl_transaksi_fJu2ypt = function(owner)
{
	if (owner)
	{
		window.app_saku_gl_transaksi_fJu2ypt.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_gl_transaksi_fJu2ypt";
		this.maximize();
...
window.app_saku_gl_transaksi_fJu2ypt.extend(window.portalui_childForm);
window.app_saku_gl_transaksi_fJu2ypt.implement({
	...
	*/
	...
	doFindBtnClick: function(sender, col, row) {
		...
		{
			systemAPI.alert("[app_saku_gl_transaksi_fJu2ypt] : doFindBtnClick : " + e);
		}
	},
	doNilaiChange: function(){
		...
		{
			alert("[app_saku_gl_transaksi_fJu2ypt]::doNilaiChange:"+e);
		}
	},
