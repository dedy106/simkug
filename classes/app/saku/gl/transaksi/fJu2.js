window.app_saku_gl_transaksi_fJu2 = function(owner)
{
	if (owner)
	{
		window.app_saku_gl_transaksi_fJu2.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_gl_transaksi_fJu2";
		this.maximize();
...
window.app_saku_gl_transaksi_fJu2.extend(window.portalui_childForm);
window.app_saku_gl_transaksi_fJu2.implement({
