// JavaScript Document
window.app_saku_gl_report_flLR2 = function(owner)
{
	if (owner)
	{
		window.app_saku_gl_report_flLR2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_gl_report_flLR2";
		this.maximize();
		
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Laba Rugi Komparasi", 2);
...
window.app_saku_gl_report_flLR2.extend(window.portalui_childForm);
window.app_saku_gl_report_flLR2.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			var filter2 = this.nik_user+"/"+this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,4)+"/"+this.sg1.getCell(2,3);
			var in_lap="S";
			...
			this.nama_report="server_report_gl_rptLR2";
			...
			systemAPI.alert("[flLR2]::mainButtonClick:"+e);
		}
	},
		...
		try{
			if (sender === sender.owner.bConfirm){
				...
				if (to !== ""){
					sender.owner.free();
					var d = new Date();
					var subject = "Laporan Laba Rugi Komparasi "+d.toLocaleString();
