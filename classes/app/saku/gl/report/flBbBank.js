...
//* 			SAI, PT											
//***********************************************************************************************
window.app_saku_gl_report_flBbBank = function(owner)
{
	if (owner)
	{
		window.app_saku_gl_report_flBbBank.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_gl_report_flBbBank";
		this.maximize();
...
window.app_saku_gl_report_flBbBank.extend(window.portalui_childForm);
window.app_saku_gl_report_flBbBank.implement({
	...
	mainButtonClick: function(sender){
		try{
			...
			this.nama_report="server_report_gl_rptBbBank";
