...
//* 			SAI, PT											
//***********************************************************************************************
window.app_saku_gl_report_flBbCust = function(owner)
{
	if (owner)
	{
		window.app_saku_gl_report_flBbCust.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_gl_report_flBbCust";
		this.maximize();
...
window.app_saku_gl_report_flBbCust.extend(window.portalui_childForm);
window.app_saku_gl_report_flBbCust.implement({
	...
	mainButtonClick: function(sender){
		try{
			...
			this.nama_report="server_report_gl_rptBbCust";
