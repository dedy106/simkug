// JavaScript Document
window.app_saku_gl_report_flTbCust = function(owner)
{
	if (owner)
	{
		window.app_saku_gl_report_flTbCust.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_gl_report_flTbCust";
		this.maximize();
...
window.app_saku_gl_report_flTbCust.extend(window.portalui_childForm);
window.app_saku_gl_report_flTbCust.implement({
