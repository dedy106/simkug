// JavaScript Document
window.app_saku_gl_report_flNeraca2 = function(owner)
{
	if (owner)
	{
		window.app_saku_gl_report_flNeraca2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_gl_report_flNeraca2";
		this.maximize();
		
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Neraca Komparasi", 2);
...
window.app_saku_gl_report_flNeraca2.extend(window.portalui_childForm);
window.app_saku_gl_report_flNeraca2.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			var filter2 = this.nik_user+"/"+this.sg1.getCell(2,1)+"/"+this.sg1.getCell(2,0)+"/"+this.sg1.getCell(2,4)+"/"+this.sg1.getCell(2,3);
			var in_lap="S";
			...
			{
				sql="call sp_neraca2 ('"+this.sg1.getCell(2,2)+"','N','"+in_lap+"',"+this.sg1.getCell(2,3)+",'"+this.sg1.getCell(2,1)+"','"+this.sg1.getCell(2,4)+"','"+this.kode_lokasi+"','"+this.kode_lokasi1+"','"+this.kode_lokasi2+"','"+this.nik_user+"')";
			}
			else
			{
			...
			this.nama_report="server_report_gl_rptNeraca2";
			...
			systemAPI.alert("[flNeraca2]::mainButtonClick:"+e);
		}
	},
		...
		try{
			if (sender === sender.owner.bConfirm){
				...
				if (to !== ""){
					sender.owner.free();
					var d = new Date();
					var subject = "Laporan Neraca Komparasi "+d.toLocaleString();
