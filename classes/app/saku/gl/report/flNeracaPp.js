// JavaScript Document
window.app_saku_gl_report_flNeracaPp = function(owner)
{
	if (owner)
	{
		window.app_saku_gl_report_flNeracaPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_gl_report_flNeracaPp";
		this.maximize();
		
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Neraca PP", 2);
...
window.app_saku_gl_report_flNeracaPp.extend(window.portalui_childForm);
window.app_saku_gl_report_flNeracaPp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			sql="call sp_neraca_pp ('"+this.sg1.getCell(2,2)+"','N','"+in_lap+"',"+this.sg1.getCell(2,3)+",'"+this.sg1.getCell(2,1)+"','"+this.kode_lokasi+"','"+this.kode_lokasi1+"','"+this.kode_lokasi2+"','"+this.nik_user+"')";
