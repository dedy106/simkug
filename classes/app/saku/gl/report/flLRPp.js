// JavaScript Document
window.app_saku_gl_report_flLRPp = function(owner)
{
	if (owner)
	{
		window.app_saku_gl_report_flLRPp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_gl_report_flLRPp";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,5,new Array(0,1), new Array("Kode PP","All"));
...
window.app_saku_gl_report_flLRPp.extend(window.portalui_childForm);
window.app_saku_gl_report_flLRPp.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			sql="call sp_neraca_pp ('"+this.sg1.getCell(2,2)+"','L','"+in_lap+"',"+this.sg1.getCell(2,3)+",'"+this.sg1.getCell(2,1)+"','"+this.kode_lokasi+"','"+this.kode_lokasi1+"','"+this.kode_lokasi2+"','"+this.nik_user+"')";
