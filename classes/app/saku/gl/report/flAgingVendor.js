// JavaScript Document
window.app_saku_gl_report_flAgingVendor = function(owner)
{
	if (owner)
	{
		window.app_saku_gl_report_flAgingVendor.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_gl_report_flAgingVendor";
		this.maximize();
		
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Aging Hutang", 2);
...
window.app_saku_gl_report_flAgingVendor.extend(window.portalui_childForm);
window.app_saku_gl_report_flAgingVendor.implement({
