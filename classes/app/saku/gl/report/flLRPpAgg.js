// JavaScript Document
window.app_saku_gl_report_flLRPpAgg = function(owner)
{
	if (owner)
	{
		window.app_saku_gl_report_flLRPpAgg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_gl_report_flLRPpAgg";
		this.maximize();
		
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Laba Rugi PP Anggaran", 2);
...
window.app_saku_gl_report_flLRPpAgg.extend(window.portalui_childForm);
window.app_saku_gl_report_flLRPpAgg.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			sql="call sp_neraca_pp_agg ('"+this.sg1.getCell(2,2)+"','L','"+in_lap+"',"+this.sg1.getCell(2,3)+",'"+this.sg1.getCell(2,1)+"','"+this.kode_lokasi+"','"+this.kode_lokasi1+"','"+this.kode_lokasi2+"','"+this.nik_user+"')";
			
			this.dbLib.execQuerySync(sql);	
			
			this.nama_report="server_report_gl_rptLRAgg";
