// JavaScript Document
window.app_saku_gl_report_flLRAgg = function(owner)
{
	if (owner)
	{
		window.app_saku_gl_report_flLRAgg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_gl_report_flLRAgg";
		this.maximize();
		
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Laba Rugi Anggaran", 2);
...
window.app_saku_gl_report_flLRAgg.extend(window.portalui_childForm);
window.app_saku_gl_report_flLRAgg.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[flLRAgg]::mainButtonClick:"+e);
		}
	},
		...
		try{
			if (sender === sender.owner.bConfirm){
				...
				if (to !== ""){
					sender.owner.free();
					var d = new Date();
					var subject = "Laporan Laba Rugi Anggaran "+d.toLocaleString();
