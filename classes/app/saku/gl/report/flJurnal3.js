// JavaScript Document
window.app_saku_gl_report_flJurnal3 = function(owner)
{
	if (owner)
	{
		window.app_saku_gl_report_flJurnal3.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_gl_report_flJurnal3";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,9,new Array(0,1,2), new Array("Sort by","=","Tanggal, No. Dokumen"));
...
window.app_saku_gl_report_flJurnal3.extend(window.portalui_childForm);
window.app_saku_gl_report_flJurnal3.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.filter=this.filter+"/"+this.urut
