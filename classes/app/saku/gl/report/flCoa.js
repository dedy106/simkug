// JavaScript Document
window.app_saku_gl_report_flCoa = function(owner)
{
	if (owner)
	{
		window.app_saku_gl_report_flCoa.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_gl_report_flCoa";
		this.maximize();
		
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Chart Of Account", 2);
		...
		this.sg1.onEllipsClick.set(this, "doEllipseClick");
			...
			this.sg1.setCell(0,3,"Bentuk Laporan");
	...
	this.filterRep.setSGFilterRowTipe(this.sg1, 0,new Array(0,1,2,3),new  Array("123","1234","1234","3"));
	this.filterRep.setSGFilterRowButtonStyle(this.sg1, 0,new Array(0,1,2,3),new  Array(2,2,2,0));
	...
	this.gridLib.SGEditData(this.sg1,3,new Array(0,1,2), new Array("Bentuk Laporan","=","COA"));
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());	
};
window.app_saku_gl_report_flCoa.extend(window.portalui_childForm);
window.app_saku_gl_report_flCoa.implement({
	    ...
	    if (row ==0)
			...
			if (row == 1)
			{
				this.filterRep.ListDataSGFilter(this, "Data Akun",this.sg1, this.sg1.row, this.sg1.col,
														  "select kode_akun, nama from masakun where block= '0' "+
	...
	doSelectCell: function(sender, col, row){
		this.filterRep.setSGFilterRowTipe(this.sg1, 0,[0,1,2,3],["123","1234","1234","3"]);
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, 0,[0,1,2,3],[2,2,2,0]);
	},
	mainButtonClick: function(sender){
		try
		{
			if (sender == this.app._mainForm.bClear2)
			{ this.gridLib.SGEditData(this.sg1,0,new Array(0,1,2), new Array("Kode Currency","All","")); }
			else
			{
				...
				this.viewer.setTotalPage(this.report.getTotalPage("Coa",filter,this.pager));
	    		this.filter = filter;
	    		this.app._mainForm.reportNavigator.setTotalPage(this.viewer.getTotalPage());
	    		this.app._mainForm.reportNavigator.rearrange();
	    		var showFilter = this.filterRep.showFilter(this.sg1);
				this.nama_report = "Coa";
				this.filter2 = "";
		...
		{
			systemAPI.alert("[app_saku_gl_report_flCoa]::mainButtonClick:"+e);
		}
	},
