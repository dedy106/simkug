// JavaScript Document
window.app_saku_gl_report_flTBJejer2 = function(owner)
{
	if (owner)
	{
		window.app_saku_gl_report_flTBJejer2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_gl_report_flTBJejer2";
		this.maximize();
...
window.app_saku_gl_report_flTBJejer2.extend(window.portalui_childForm);
window.app_saku_gl_report_flTBJejer2.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			var sql = "call sp_glma_jejer2_tmp ('"+this.kode_lokasi+"','"+this.sg1.getCell(2,1)+"','"+this.nik_user+"')";
			this.nama_report="server_report_gl_rptTBJejer2";
