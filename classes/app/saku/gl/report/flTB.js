// JavaScript Document
window.app_saku_gl_report_flTB = function(owner)
{
	if (owner)
	{
		window.app_saku_gl_report_flTB.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_gl_report_flTB";
		this.maximize();
...
window.app_saku_gl_report_flTB.extend(window.portalui_childForm);
window.app_saku_gl_report_flTB.implement({
