// JavaScript Document
window.app_saku_gl_report_flInvestasi = function(owner)
{
	if (owner)
	{
		window.app_saku_gl_report_flInvestasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_gl_report_flInvestasi";
		this.maximize();
		
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Investasi", 2);
...
window.app_saku_gl_report_flInvestasi.extend(window.portalui_childForm);
window.app_saku_gl_report_flInvestasi.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,new Array(0,1),new  Array("3","3"));
	...
	mainButtonClick: function(sender){	
		if (sender == this.app._mainForm.bPreview){
			...
			{			
				...
				this.nama_report="server_report_gl_rptInvestasi";
		...
		try{
			if (sender === sender.owner.bConfirm){
				...
				if (to !== ""){
					sender.owner.free();
					var d = new Date();
					var subject = "Laporan Investasi "+d.toLocaleString();
