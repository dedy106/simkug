// JavaScript Document
window.app_saku_gl_report_flAgingCust = function(owner)
{
	if (owner)
	{
		window.app_saku_gl_report_flAgingCust.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_gl_report_flAgingCust";
		this.maximize();
...
window.app_saku_gl_report_flAgingCust.extend(window.portalui_childForm);
window.app_saku_gl_report_flAgingCust.implement({
	doEllipseClick: function(sender, col, row){
		...
		if (row == 3)
		{
			this.filterRep.ListDataSGFilter(this, "Data Customer",this.sg1, this.sg1.row, this.sg1.col,
													  ...
													  "INNER JOIN flag_relasi b ON a.kode_lokasi=b.kode_lokasi AND b.kode_flag='003' AND b.kode_akun='"+this.sg1.getCell(2,2)+"' "+
													  this.filterRep.filterStr("a.kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0)," where "),
													  new Array("a.kode_cust","a.nama"),"where");
		}
	},
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.sql=" select a.kode_cust,a.nama,ifnull(b.so_awal,0) as so_awal,ifnull(c.debet,0) as debet,ifnull(c.kredit,0) as kredit, "+
	...
	previewReport: function(dthtml){
		var html = "<div align='center' class='judul_laporan' style='{width:100%;font-size:14;font-weight:bold;}'><br><br>"+this.app._namalokasi.toUpperCase()+"<br>Laporan Saldo Piutang<br>";			
		var d = new Date();
