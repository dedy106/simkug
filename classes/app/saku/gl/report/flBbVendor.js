...
//* 			SAI, PT											
//***********************************************************************************************
window.app_saku_gl_report_flBbVendor = function(owner)
{
	if (owner)
	{
		window.app_saku_gl_report_flBbVendor.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_gl_report_flBbVendor";
		this.maximize();
...
window.app_saku_gl_report_flBbVendor.extend(window.portalui_childForm);
window.app_saku_gl_report_flBbVendor.implement({
	...
	mainButtonClick: function(sender){
		try{
			...
			this.nama_report="server_report_gl_rptBbVendor";
