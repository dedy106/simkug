// JavaScript Document
window.app_saku_gl_report_flLRBidang = function(owner)
{
	if (owner)
	{
		window.app_saku_gl_report_flLRBidang.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_gl_report_flLRBidang";
		this.maximize();
		
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Laba Rugi PP", 2);
	...
	this.filterRep.setSGFilterRowTipe(this.sg1, 0,new Array(0,1,2,3,4,5),new  Array("3","3","123","3","123"));
	this.filterRep.setSGFilterRowButtonStyle(this.sg1, 0,new Array(0,1,2,3,4,5),new  Array(0,2,2,0,0,2));
	...
	this.gridLib.SGEditData(this.sg1,5,new Array(0,1), new Array("Kode Bidang","All"));
	this.gridLib.SGEditData(this.sg1,6,new Array(0,1,2), new Array("Nilai Laporan","=","Saldo Akhir"));
	this.doSelectCell(this.sg1,3,6);
...
window.app_saku_gl_report_flLRBidang.extend(window.portalui_childForm);
window.app_saku_gl_report_flLRBidang.implement({
	...
	doSelectCell: function(sender, col, row){
		...
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,new Array(0,1,2,3,4,5,6),new  Array("3","3","123","3","3","23","3"));
	...
	mainButtonClick: function(sender){
		try
		{
			...
			sql="call sp_neraca_bidang ('"+this.sg1.getCell(2,2)+"','L','"+in_lap+"',"+this.sg1.getCell(2,3)+",'"+this.sg1.getCell(2,1)+"','"+this.kode_lokasi+"','"+this.kode_lokasi1+"','"+this.kode_lokasi2+"','"+this.nik_user+"')";
			...
			{
				this.nama_report="server_report_gl_rptLRPpMutasi";
			}
			if (this.sg1.getCell(2,6) == "DC")
			{
				this.nama_report="server_report_gl_rptLRPpMutasiDC";
			}
		...
		try{
			if (sender === sender.owner.bConfirm){
				...
				if (to !== ""){
					sender.owner.free();
					var d = new Date();
					var subject = "Laporan Laba Rugi PP "+d.toLocaleString();
