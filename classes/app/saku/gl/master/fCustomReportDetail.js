window.app_saku_gl_master_fCustomReportDetail = function(owner)
{
	if (owner)
	{
		window.app_saku_gl_master_fCustomReportDetail.prototype.parent.constructor.call(this, owner);
		window.app_saku_gl_master_fCustomReportDetail.prototype.parent.setWidth.call(this, 300);
		window.app_saku_gl_master_fCustomReportDetail.prototype.parent.setHeight.call(this, 400);
		
		this.centerize();
		
		this.className = "app_saku_gl_master_fCustomReportDetail";
...
window.app_saku_gl_master_fCustomReportDetail.extend(window.portalui_commonForm);
window.app_saku_gl_master_fCustomReportDetail.prototype.doDraw = function(canvas)
{
...
window.app_saku_gl_master_fCustomReportDetail.prototype.doAfterResize = function(event)
{
	this.p1.setWidth(this.width - 40);
...
window.app_saku_gl_master_fCustomReportDetail.prototype.doSysMouseMove = function(x, y, button, buttonState)
{
	window.app_saku_gl_master_fCustomReportDetail.prototype.parent.doSysMouseMove.call(this,x, y, button, buttonState);
	if (this.isClick)
	{		
...
window.app_saku_gl_master_fCustomReportDetail.prototype.eventMouseDown = function(event)
{
...
window.app_saku_gl_master_fCustomReportDetail.prototype.eventMouseUp = function(event)
{
	this.isClick = false;
	this.blockElm.style.display = "none";
	this.frameElm.style.display = "";
};
window.app_saku_gl_master_fCustomReportDetail.prototype.eventMouseMove = function(event)
{
	if (this.isClick)
	{
		var x = event.clientX;
...
window.app_saku_gl_master_fCustomReportDetail.prototype.doClick = function(sender)
{
	if (sender == this.b1)
...
window.app_saku_gl_master_fCustomReportDetail.prototype.doRequestReady = function(sender, methodName, result)
{
};
window.app_saku_gl_master_fCustomReportDetail.prototype.findBtnClick = function(sender)
{
};
//--------------------------------------------
window.app_saku_gl_master_fCustomReportDetail.prototype.setCaption = function(data)
{
...
window.app_saku_gl_master_fCustomReportDetail.prototype.setItemParent = function(data)
{
	this.itemParent = data;
};
window.app_saku_gl_master_fCustomReportDetail.prototype.setSummaryItems = function(data)
{
	this.e4.clearItem();
	for (var i in data)
		this.e4.addItem(i, data[i]);		
};
window.app_saku_gl_master_fCustomReportDetail.prototype.doClose = function(sender)
{
