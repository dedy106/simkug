window.app_saku_gl_master_fKlpNrc = function(owner)
{
	if (owner)
	{
		window.app_saku_gl_master_fKlpNrc.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_gl_master_fKlpNrc";
		this.setTop(60);
		this.setWidth(1280);
		this.setHeight(550);
...
window.app_saku_gl_master_fKlpNrc.extend(window.portalui_childForm);
//------------------------------------------------------------------ event
window.app_saku_gl_master_fKlpNrc.implement({
