// JavaScript Document
window.app_saku_gl_trail_fTrailNeraca2 = function(owner)
{
	if (owner)
	{
		window.app_saku_gl_trail_fTrailNeraca2.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_gl_trail_fTrailNeraca2";
		this.maximize();
		
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Audit Trail Neraca Komparasi", 2);
	...
	this.filterRep.setSGFilterRowTipe(this.sg1, 0,new Array(0,1,2,3,4),new  Array("3","123","123","3","3"));
	this.filterRep.setSGFilterRowButtonStyle(this.sg1, 0,new Array(0,1,2,3,4),new  Array(0,2,2,0,0));
	...
	this.gridLib.SGEditData(this.sg1,4,new Array(0,1,2), new Array("Periode Pembanding","=",this.app._periode));
...
window.app_saku_gl_trail_fTrailNeraca2.extend(window.portalui_childForm);
window.app_saku_gl_trail_fTrailNeraca2.prototype.doSg2DblClick = function(sender, colIdx, rowIdx)
{
...
window.app_saku_gl_trail_fTrailNeraca2.prototype.doSg3DblClick = function(sender, colIdx, rowIdx)
{
...
window.app_saku_gl_trail_fTrailNeraca2.prototype.SetSg4Mutasi = function()
{
	try
	{
	...
	{
		alert("[app_saku_gl_trail_fTrailNeraca2]::SetSg4Mutasi:"+e);
	}
};
window.app_saku_gl_trail_fTrailNeraca2.prototype.doSg4DblClick = function(sender, colIdx, rowIdx)
{	
	try{
...
window.app_saku_gl_trail_fTrailNeraca2.prototype.SetSg5Mutasi = function()
{
	try
	{
		var debet = kredit = 0;
		...
		alert("[app_saku_gl_trail_fTrailNeraca]::SetSg4Mutasi:"+e);
	}
};
window.app_saku_gl_trail_fTrailNeraca2.prototype.doEllipseClick= function(sender, col, row)
{
...
window.app_saku_gl_trail_fTrailNeraca2.prototype.doSelectCell = function(sender, col, row)
{
	this.filterRep.setSGFilterRowTipe(this.sg1, row,new Array(0,1,2,3,4),new  Array("3","123","123","3","3"));
...
window.app_saku_gl_trail_fTrailNeraca2.prototype.mainButtonClick = function(sender)
{	
	if (sender == this.app._mainForm.bPreview){
		try
		{
			...
			{
				sql="call sp_neraca2 ('"+this.sg1.getCell(2,2)+"','N','"+in_lap+"',"+this.sg1.getCell(2,3)+",'"+this.sg1.getCell(2,0)+"','"+this.sg1.getCell(2,4)+"','"+this.kode_lokasi+"','"+this.kode_lokasi1+"','"+this.kode_lokasi2+"','"+this.nik_user+"')";
			}
			if (this.app._dbEng == "ado_mssql")
			{
				sql="call sp_neraca2 ('"+this.sg1.getCell(2,2)+"','A','"+in_lap+"',"+this.sg1.getCell(2,3)+",'"+this.sg1.getCell(2,0)+"','"+this.sg1.getCell(2,4)+"','"+this.kode_lokasi+"','"+this.kode_lokasi1+"','"+this.kode_lokasi2+"','"+this.nik_user+"')";
			}
			...
			this.dbLib.execQuerySync(sql);	
				...
				if (this.p1.visible){ 
					...
					this.sg2.setColTitle(new Array("No","Kode","Nama",periode1,periode2));
					this.sg2.setTag("2");
...
window.app_saku_gl_trail_fTrailNeraca2.prototype.doRequestReady = function(sender, methodName, result)
{
		switch (methodName)
		{
			case "preview" : 
...
window.app_saku_gl_trail_fTrailNeraca2.prototype.doSelectedPage = function(sender, page)
{
	this.report.preview(this.nama_report,this.filter, page, 30, "YAKES", this.showFilter,this.filter2);	
};

window.app_saku_gl_trail_fTrailNeraca2.prototype.doCloseReportClick = function(sender)
{
...
window.app_saku_gl_trail_fTrailNeraca2.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
