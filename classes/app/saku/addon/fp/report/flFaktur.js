window.app_saku_addon_fp_report_flFaktur = function(owner)
{
	if (owner)
	{
		window.app_saku_addon_fp_report_flFaktur.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_addon_fp_report_flFaktur";
		this.maximize();
...
window.app_saku_addon_fp_report_flFaktur.extend(window.portalui_childForm);
window.app_saku_addon_fp_report_flFaktur.implement({
	...
	doSelectCell: function(sender, col, row)
	{
		...
		{
			this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3],["13","3","13","3"]);
	...
	mainButtonClick: function(sender)
	{
		try
		{
			...
			{ 
				...
				this.gridLib.SGEditData(this.sg1,2,[0,1,2],["No. Faktur","All",""]);
				this.gridLib.SGEditData(this.sg1,3,[0,1,2],["Faktur untuk","=","Pembeli"]);
			}else
			{
		...
		{
			alert("[app_saku_addon_fp_report_flFaktur]::mainButtonClick:"+e);
		}
	},
