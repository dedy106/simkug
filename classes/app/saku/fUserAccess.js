window.app_saku_fUserAccess = function(owner)
{
	if (owner)
	{
		window.app_saku_fUserAccess.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_fUserAccess";
		this.maximize();
...
window.app_saku_fUserAccess.extend(window.portalui_childForm);
window.app_saku_fUserAccess.implement({
