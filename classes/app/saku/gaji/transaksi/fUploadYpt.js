window.app_saku_gaji_transaksi_fUploadYpt = function(owner)
{
	if (owner)
	{
		window.app_saku_gaji_transaksi_fUploadYpt.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku_gaji_transaksi_fUploadYpt";
...
window.app_saku_gaji_transaksi_fUploadYpt.extend(window.portalui_childForm);
window.app_saku_gaji_transaksi_fUploadYpt.implement({
