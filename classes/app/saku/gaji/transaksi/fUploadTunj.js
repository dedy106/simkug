window.app_saku_gaji_transaksi_fUploadTunj = function(owner)
{
	if (owner)
	{
		window.app_saku_gaji_transaksi_fUploadTunj.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku_gaji_transaksi_fUploadTunj";
...
window.app_saku_gaji_transaksi_fUploadTunj.extend(window.portalui_childForm);
window.app_saku_gaji_transaksi_fUploadTunj.implement({
