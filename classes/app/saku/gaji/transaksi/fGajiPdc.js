window.app_saku_gaji_transaksi_fGajiPdc = function(owner)
{
	if (owner)
	{
		window.app_saku_gaji_transaksi_fGajiPdc.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_gaji_transaksi_fGajiPdc";
		this.maximize();
...
window.app_saku_gaji_transaksi_fGajiPdc.extend(window.portalui_childForm);
window.app_saku_gaji_transaksi_fGajiPdc.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_gaji_transaksi_fGajiPdc.prototype.doSelect = function(sender, year, month, day)
{
	if (month < 10)
		month = "0"+month;
	this.ed_period.setText(year.toString()+month);		
};
window.app_saku_gaji_transaksi_fGajiPdc.prototype.genClick = function(sender)
{
	try
	{
...
window.app_saku_gaji_transaksi_fGajiPdc.prototype.simpan = function()
{
	this.bGen.click();
...
window.app_saku_gaji_transaksi_fGajiPdc.prototype.doModalResult = function(event, modalResult)
{			
...
window.app_saku_gaji_transaksi_fGajiPdc.prototype.showClick = function(sender)
{		
...
window.app_saku_gaji_transaksi_fGajiPdc.prototype.hitungClick = function(sender)
{	
...
window.app_saku_gaji_transaksi_fGajiPdc.prototype.doEditChange = function(sender)
{
...
window.app_saku_gaji_transaksi_fGajiPdc.prototype.FindBtnClick = function(sender, event)
{
	try
	{
		if (sender == this.cb_nik) 
...
window.app_saku_gaji_transaksi_fGajiPdc.prototype.doChange = function(sender, col, row) 
{
	try
	{
		switch(col)
...
window.app_saku_gaji_transaksi_fGajiPdc.prototype.doChange2 = function(sender, col, row) 
{
	try
	{
		switch(col)
...
window.app_saku_gaji_transaksi_fGajiPdc.prototype.doNilaiChange = function()
{
	try
	{
		this.sg1.onChange.set(undefined, undefined);
...
window.app_saku_gaji_transaksi_fGajiPdc.prototype.doNilaiChange2 = function()
{
	try
	{
		var tot = 0; 
...
window.app_saku_gaji_transaksi_fGajiPdc.prototype.doRequestReady = function(sender, methodName, result)
{
...
window.app_saku_gaji_transaksi_fGajiPdc.prototype.loadParam = function(){	
	try{
...
window.app_saku_gaji_transaksi_fGajiPdc.prototype.getDplkUsia = function(usia){
	var line;
...
window.app_saku_gaji_transaksi_fGajiPdc.prototype.getDplkTingkat = function(tingkat){
	var line;
...
window.app_saku_gaji_transaksi_fGajiPdc.prototype.getTunjProf = function(kdProf, pddk){
	var line;
...
window.app_saku_gaji_transaksi_fGajiPdc.prototype.getTunjJabs = function(kdJabs, kdJabf){
	var line;
...
window.app_saku_gaji_transaksi_fGajiPdc.prototype.getTunjJabf = function(kdJabf, pddk){
	var line;
...
window.app_saku_gaji_transaksi_fGajiPdc.prototype.getTunjJabatanStruk= function(){
	try{
		var tjabs2 = 0;
...
window.app_saku_gaji_transaksi_fGajiPdc.prototype.getTunjJabatanFung= function(){
	var tjabf;
	if (this.kodejabf == "-"){
	  tjabf = 0;
	}else{	
...
window.app_saku_gaji_transaksi_fGajiPdc.prototype.getTunjProfesi= function(){
	var tprof = 0;
	if (this.kodestspeg == "1")
	{		
		if (this.kodeprof == "-")
...
window.app_saku_gaji_transaksi_fGajiPdc.prototype.getTunjParam= function(kode){
...
window.app_saku_gaji_transaksi_fGajiPdc.prototype.hitungPPh= function(){
	try{
		var rowPPh;
		var totbln = 0;
...
window.app_saku_gaji_transaksi_fGajiPdc.prototype.getDataKontrak = function(kode){
