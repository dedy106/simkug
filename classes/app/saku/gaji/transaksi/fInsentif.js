window.app_saku_gaji_transaksi_fInsentif= function(owner)
{
	if (owner)
	{
		window.app_saku_gaji_transaksi_fInsentif.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_gaji_transaksi_fInsentif";
		this.maximize();
...
window.app_saku_gaji_transaksi_fInsentif.extend(window.portalui_childForm);
window.app_saku_gaji_transaksi_fInsentif.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_gaji_transaksi_fInsentif.prototype.simpan = function()
{
	this.bGen.click();
...
window.app_saku_gaji_transaksi_fInsentif.prototype.doModalResult = function(event, modalResult)
{
...
window.app_saku_gaji_transaksi_fInsentif.prototype.genClick = function(sender)
{
	try
	{
...
window.app_saku_gaji_transaksi_fInsentif.prototype.loadClick = function(sender)
{
	try
	{
		//this.sg2.clearAll();
...
window.app_saku_gaji_transaksi_fInsentif.prototype.doSelect = function(sender, year, month, day)
{
	if (month < 10)
		month = "0"+month;
	this.ed_period.setText(year.toString()+month);
};
window.app_saku_gaji_transaksi_fInsentif.prototype.doEditChange = function(sender)
{
...
window.app_saku_gaji_transaksi_fInsentif.prototype.doRequestReady = function(sender, methodName, result)
{
...
window.app_saku_gaji_transaksi_fInsentif.implement({
