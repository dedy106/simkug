window.app_saku_gaji_transaksi_fUploadPot = function(owner)
{
	if (owner)
	{
		window.app_saku_gaji_transaksi_fUploadPot.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku_gaji_transaksi_fUploadPot";
...
window.app_saku_gaji_transaksi_fUploadPot.extend(window.portalui_childForm);
window.app_saku_gaji_transaksi_fUploadPot.implement({
