window.app_saku_gaji_transaksi_fUploadInsentif = function(owner)
{
	if (owner)
	{
		window.app_saku_gaji_transaksi_fUploadInsentif.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku_gaji_transaksi_fUploadInsentif";
...
window.app_saku_gaji_transaksi_fUploadInsentif.extend(window.portalui_childForm);
window.app_saku_gaji_transaksi_fUploadInsentif.implement({
