window.app_saku_gaji_transaksi_fUploadItt = function(owner)
{
	if (owner)
	{
		window.app_saku_gaji_transaksi_fUploadItt.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku_gaji_transaksi_fUploadItt";
...
window.app_saku_gaji_transaksi_fUploadItt.extend(window.portalui_childForm);
window.app_saku_gaji_transaksi_fUploadItt.implement({
