window.app_saku_gaji_transaksi_fUploadPoltek = function(owner)
{
	if (owner)
	{
		window.app_saku_gaji_transaksi_fUploadPoltek.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku_gaji_transaksi_fUploadPoltek";
...
window.app_saku_gaji_transaksi_fUploadPoltek.extend(window.portalui_childForm);
window.app_saku_gaji_transaksi_fUploadPoltek.implement({
