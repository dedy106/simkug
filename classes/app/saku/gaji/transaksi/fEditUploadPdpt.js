window.app_saku_gaji_transaksi_fEditUploadPdpt = function(owner)
{
	if (owner)
	{
		window.app_saku_gaji_transaksi_fEditUploadPdpt.prototype.parent.constructor.call(this, owner);
		this.className = "app_saku_gaji_transaksi_fEditUploadPdpt";
...
window.app_saku_gaji_transaksi_fEditUploadPdpt.extend(window.portalui_childForm);
window.app_saku_gaji_transaksi_fEditUploadPdpt.implement({
						...
						for (var i=0;i < this.sg1.getRowCount();i++){														
                            for (var c =2;c < this.sg1.getColCount();c++){
                                if (nilaiToFloat(this.sg1.cells(c,i)) > 0){
    								...
    								sqlText[c - 2] +="('"+this.ed_nb.getText()+"','"+this.sg1.cells(0,i)+"','"+fieldName[c]+"','"+ parseNilai(this.sg1.cells(c,i))+"','"+this.app._lokasi+"','"+this.ed_period.getText()+"')"; 							
    								sqlArray[c - 2] += "('"+this.sg1.cells(0,i)+"','"+fieldName[c]+"','"+this.ed_period.getText()+"','"+this.ed_period.getText()+"','"+parseNilai(this.sg1.cells(c,i))+"','"+this.app._lokKonsol+"') ";
    								first[c-2] = false;
    							}														        							
							}
