window.app_saku_gaji_master_fHRtunjtrans = function(owner)
{
	if (owner)
	{
		window.app_saku_gaji_master_fHRtunjtrans.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_gaji_master_fHRtunjtrans";
		this.maximize();
...
window.app_saku_gaji_master_fHRtunjtrans.extend(window.portalui_childForm);
window.app_saku_gaji_master_fHRtunjtrans.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_gaji_master_fHRtunjtrans.prototype.doModalResult = function(event, modalResult)
{
	switch (event)
	{
		case "clear" :
...
window.app_saku_gaji_master_fHRtunjtrans.prototype.showClick = function(sender)
{	
...
window.app_saku_gaji_master_fHRtunjtrans.prototype.tampilClick = function(sender)
{
	this.sg1.clearAll();
...
window.app_saku_gaji_master_fHRtunjtrans.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_saku_gaji_master_fHRtunjtrans.prototype.doRequestReady = function(sender, methodName, result)
{
