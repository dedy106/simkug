window.app_saku_gaji_master_fHRtunjkbm = function(owner)
{
	if (owner)
	{
		window.app_saku_gaji_master_fHRtunjkbm.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_gaji_master_fHRtunjkbm";
		this.maximize();
...
window.app_saku_gaji_master_fHRtunjkbm.extend(window.portalui_childForm);
window.app_saku_gaji_master_fHRtunjkbm.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_gaji_master_fHRtunjkbm.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.app_saku_gaji_master_fHRtunjkbm.prototype.showClick = function(sender)
{	
...
window.app_saku_gaji_master_fHRtunjkbm.prototype.tampilClick = function(sender)
{
	this.sg1.clearAll();
...
window.app_saku_gaji_master_fHRtunjkbm.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_saku_gaji_master_fHRtunjkbm.prototype.doRequestReady = function(sender, methodName, result)
{
