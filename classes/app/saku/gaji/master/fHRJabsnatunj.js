window.app_saku_gaji_master_fHRJabsnatunj = function(owner)
{
	if (owner)
	{
		window.app_saku_gaji_master_fHRJabsnatunj.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_gaji_master_fHRJabsnatunj";
		this.maximize();
...
window.app_saku_gaji_master_fHRJabsnatunj.extend(window.portalui_childForm);
window.app_saku_gaji_master_fHRJabsnatunj.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_gaji_master_fHRJabsnatunj.prototype.doModalResult = function(event, modalResult)
{			
	switch (event)
	{
		case "clear" :
...
window.app_saku_gaji_master_fHRJabsnatunj.prototype.showClick = function(sender)
{	
...
window.app_saku_gaji_master_fHRJabsnatunj.prototype.tampilClick = function(sender)
{
	this.sg1.clearAll();
...
window.app_saku_gaji_master_fHRJabsnatunj.prototype.FindBtnClick = function(sender, event)
{
	try
	{
...
window.app_saku_gaji_master_fHRJabsnatunj.prototype.doRequestReady = function(sender, methodName, result)
{
