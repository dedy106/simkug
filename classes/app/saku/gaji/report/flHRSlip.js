window.app_saku_gaji_report_flHRSlip = function(owner)
{
	if (owner)
	{
		window.app_saku_gaji_report_flHRSlip.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_gaji_report_flHRSlip";
		this.maximize();
...
window.app_saku_gaji_report_flHRSlip.extend(window.portalui_childForm);
window.app_saku_gaji_report_flHRSlip.prototype.doEllipseClick= function(sender, col, row)
{
	if (row == 0)
	{
...
window.app_saku_gaji_report_flHRSlip.prototype.doSelectCell = function(sender, col, row)
{
...
window.app_saku_gaji_report_flHRSlip.prototype.mainButtonClick = function(sender)
{
	try
	{
	...
	{
		alert("[app_saku_gaji_report_flHRSlip]::mainButtonClick:"+e);
	}
};
window.app_saku_gaji_report_flHRSlip.prototype.jenisReport = function(jenis,filter)
{
	try
	{
...
window.app_saku_gaji_report_flHRSlip.prototype.doRequestReady = function(sender, methodName, result)
{
	switch (methodName)
	{
		case "preview" : 
...
window.app_saku_gaji_report_flHRSlip.prototype.doSelectedPage = function(sender, page)
{
...
window.app_saku_gaji_report_flHRSlip.prototype.previewReport = function(dthtml,jenis)
{
	
	this.viewer.preview(html);
	this.allHtml = html;
};
window.app_saku_gaji_report_flHRSlip.prototype.doCloseReportClick = function(sender)
{
...
window.app_saku_gaji_report_flHRSlip.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_saku_gaji_report_flHRSlip.prototype.doRowPerPageChange = function(sender, rowperpage)
{
...
window.app_saku_gaji_report_flHRSlip.prototype.doConfirmClick = function(sender){
	try{		
