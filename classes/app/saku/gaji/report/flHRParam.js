window.app_saku_gaji_report_flHRParam = function(owner)
{
	if (owner)
	{
		window.app_saku_gaji_report_flHRParam.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_gaji_report_flHRParam";
		this.maximize();
...
window.app_saku_gaji_report_flHRParam.extend(window.portalui_childForm);
window.app_saku_gaji_report_flHRParam.prototype.doEllipseClick= function(sender, col, row)
{
	if (row == 0)
	{
...
window.app_saku_gaji_report_flHRParam.prototype.doSelectCell = function(sender, col, row)
{
...
window.app_saku_gaji_report_flHRParam.prototype.mainButtonClick = function(sender)
{
	try
	{
	...
	{
		alert("[app_saku_gaji_report_flHRParam]::mainButtonClick:"+e);
	}
};
window.app_saku_gaji_report_flHRParam.prototype.doRequestReady = function(sender, methodName, result)
{
	switch (methodName)
	{
		case "preview" : 
...
window.app_saku_gaji_report_flHRParam.prototype.doSelectedPage = function(sender, page)
{
	var dthtml = this.dbLib.sqlToHtml(this.sqlScript,page,this.pager, this.title, this.widthTable, this.fieldType,false);			
	this.previewReport(dthtml);			
	this.page=page;
};
window.app_saku_gaji_report_flHRParam.prototype.previewReport = function(dthtml)
{
...
window.app_saku_gaji_report_flHRParam.prototype.doCloseReportClick = function(sender)
{
...
window.app_saku_gaji_report_flHRParam.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_saku_gaji_report_flHRParam.prototype.doRowPerPageChange = function(sender, rowperpage)
{
