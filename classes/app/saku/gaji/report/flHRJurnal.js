window.app_saku_gaji_report_flHRJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku_gaji_report_flHRJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_gaji_report_flHRJurnal";
		this.maximize();
...
window.app_saku_gaji_report_flHRJurnal.extend(window.portalui_childForm);
window.app_saku_gaji_report_flHRJurnal.prototype.doEllipseClick= function(sender, col, row)
{
	if (row ==0)
	{
...
window.app_saku_gaji_report_flHRJurnal.prototype.doSelectCell = function(sender, col, row)
{	
...
window.app_saku_gaji_report_flHRJurnal.prototype.mainButtonClick = function(sender)
{
	try
	{
...
window.app_saku_gaji_report_flHRJurnal.prototype.doRequestReady = function(sender, methodName, result)
{
	switch (methodName)
	{
		case "preview" : 
...
window.app_saku_gaji_report_flHRJurnal.prototype.doSelectedPage = function(sender, page)
{
	this.report.preview(this.nama_report,this.filter, page,this.pager, this.lokasi, this.showFilter,this.filter2);
	this.page=page;
	this.allBtn = false;
};
window.app_saku_gaji_report_flHRJurnal.prototype.doCloseReportClick = function(sender)
{
...
window.app_saku_gaji_report_flHRJurnal.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_saku_gaji_report_flHRJurnal.prototype.doRowPerPageChange = function(sender, rowperpage)
{
