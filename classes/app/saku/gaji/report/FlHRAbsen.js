window.app_saku_gaji_report_flHRAbsen = function(owner)
{
	if (owner)
	{
		window.app_saku_gaji_report_flHRAbsen.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_gaji_report_flHRAbsen";
		this.maximize();
...
window.app_saku_gaji_report_flHRAbsen.extend(window.portalui_childForm);
window.app_saku_gaji_report_flHRAbsen.prototype.doEllipseClick= function(sender, col, row)
{
	if (row == 0)
	{
...
window.app_saku_gaji_report_flHRAbsen.prototype.doSelectCell = function(sender, col, row)
{
...
window.app_saku_gaji_report_flHRAbsen.prototype.mainButtonClick = function(sender)
{
	try
	{
	...
	{
		alert("[app_saku_gaji_report_flHRAbsen]::mainButtonClick:"+e);
	}
};
window.app_saku_gaji_report_flHRAbsen.prototype.doRequestReady = function(sender, methodName, result)
{
	switch (methodName)
	{
		case "preview" : 
...
window.app_saku_gaji_report_flHRAbsen.prototype.doSelectedPage = function(sender, page)
{
	var dthtml = this.dbLib.sqlToHtml(this.sqlScript,page,this.pager, this.title, this.widthTable, this.fieldType,false);			
	this.previewReport(dthtml);			
	this.page=page;
};
window.app_saku_gaji_report_flHRAbsen.prototype.previewReport = function(dthtml)
{
...
window.app_saku_gaji_report_flHRAbsen.prototype.doCloseReportClick = function(sender)
{
...
window.app_saku_gaji_report_flHRAbsen.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_saku_gaji_report_flHRAbsen.prototype.doRowPerPageChange = function(sender, rowperpage)
{
