window.app_saku_gaji_report_flHRPph = function(owner)
{
	if (owner)
	{
		window.app_saku_gaji_report_flHRPph.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_gaji_report_flHRPph";
		this.maximize();
...
window.app_saku_gaji_report_flHRPph.extend(window.portalui_childForm);
window.app_saku_gaji_report_flHRPph.prototype.doEllipseClick= function(sender, col, row)
{
	if (row == 0)
	{
...
window.app_saku_gaji_report_flHRPph.prototype.doSelectCell = function(sender, col, row)
{
...
window.app_saku_gaji_report_flHRPph.prototype.mainButtonClick = function(sender)
{
	try
	{
	...
	{
		alert("[app_saku_gaji_report_flHRPph]::mainButtonClick:"+e);
	}
};

window.app_saku_gaji_report_flHRPph.prototype.doRequestReady = function(sender, methodName, result)
{
	switch (methodName)
	{
		case "preview" : 
...
window.app_saku_gaji_report_flHRPph.prototype.doSelectedPage = function(sender, page)
{
...
window.app_saku_gaji_report_flHRPph.prototype.previewReport = function(dthtml)
{
...
window.app_saku_gaji_report_flHRPph.prototype.doCloseReportClick = function(sender)
{
...
window.app_saku_gaji_report_flHRPph.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_saku_gaji_report_flHRPph.prototype.doRowPerPageChange = function(sender, rowperpage)
{
