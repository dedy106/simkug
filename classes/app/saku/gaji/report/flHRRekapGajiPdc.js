	...
	try
	{
		...
		this.scriptSqlCount = "select count(a.nik) "+
				...
				var sql = "select a.nik,a.nama,sum(b.gdas) as gdas,sum(b.tyay) as tyay,sum(tjab) as tjab,sum(b.tprof) as tprof,sum(b.pdas) as pdas,sum(b.thrt) as thrt, "+
						  "		   sum(b.tran) as tran,sum(b.tkhs) as tkhs,sum(b.bpls) as bpls,sum(b.lmbr) as lmbr,sum(b.rapl) as rapl, sum(b.cuta) as cuta,sum(b.ph21) as ph21, "+
						  "			sum(b.gdas+b.tyay+b.tjab+b.tprof+b.pdas+b.thrt+b.tran+b.tkhs+b.bpls+b.lmbr+b.rapl+b.cuta+b.ph21) as total_pdpt, "+
						  ...
						  "			sum(b.gdas+b.tyay+b.tjab+b.tprof+b.pdas+b.thrt+b.tran+b.tkhs+b.bpls+b.lmbr+b.rapl+b.cuta+b.ph21+b.insentif) -sum(b.ppph+b.ptht+b.pinl+b.pkes+b.kosb+b.koct+b.pll) as total_bersih "+ 
						  "	from karyawan a "+
				...
				this.summary = new server_util_arrayList({items:["N","N","Y","Y","Y","Y","Y","Y","Y","Y","Y","Y","Y","Y","Y","Y","Y","Y","Y","Y","Y","Y","Y","Y","Y","Y","Y","Y","Y","Y","Y","Y","Y"]});	
