window.app_saku_ar_report_flSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku_ar_report_flSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_ar_report_flSaldo";
		this.maximize();
...
window.app_saku_ar_report_flSaldo.extend(window.portalui_childForm);
window.app_saku_ar_report_flSaldo.prototype.doEllipseClick= function(sender, col, row)
{
	if (row == 0)
	{				
...
window.app_saku_ar_report_flSaldo.prototype.doSelectCell = function(sender, col, row)
{
...
window.app_saku_ar_report_flSaldo.prototype.mainButtonClick = function(sender)
{
	try
	{
	...
	{
		alert("[app_saku_ar_report_flSaldo]::mainButtonClick:"+e);
	}
};
window.app_saku_ar_report_flSaldo.prototype.doRequestReady = function(sender, methodName, result)
{
...
window.app_saku_ar_report_flSaldo.prototype.doSelectedPage = function(sender, page)
{	
	this.dbLib.sqlToHtmlA(this.sqlScript,page,this.pager, this.title, this.widthTable, this.fieldType,true,this.groupBy);			
	//this.previewReport(dthtml);			
};
window.app_saku_ar_report_flSaldo.prototype.previewReport = function(dthtml)
{
...
window.app_saku_ar_report_flSaldo.prototype.doCloseReportClick = function(sender)
{
...
window.app_saku_ar_report_flSaldo.prototype.getAR = function()
{
...
window.app_saku_ar_report_flSaldo.prototype.getARByr = function()
{
	return "select b.kode_cust, sum(a.nilai + a.nilai_ppn) as nilai "+
		" from ar_inv a "+
		" inner join ar_kontrak b on b.no_kontrak = a.no_kontrak and b.kode_lokasi = a.kode_lokasi "+
...
window.app_saku_ar_report_flSaldo.prototype.getARBfr = function()
{
	return "select b.kode_cust, sum(a.nilai + a.nilai_ppn) as nilai "+
		" from ar_inv a "+
		" inner join ar_kontrak b on b.no_kontrak = a.no_kontrak and b.kode_lokasi = a.kode_lokasi "+
...
window.app_saku_ar_report_flSaldo.prototype.getARByrBfr = function()
{
	return "select b.kode_cust, sum(a.nilai + a.nilai_ppn) as nilai "+
		" from ar_inv a "+
		" inner join ar_kontrak b on b.no_kontrak = a.no_kontrak and b.kode_lokasi = a.kode_lokasi "+
...
window.app_saku_ar_report_flSaldo.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_saku_ar_report_flSaldo.prototype.doRowPerPageChange = function(sender, rowperpage)
{
