window.app_saku_ar_transaksi_fWriteOff = function(owner)
{
  if (owner)
	{
		window.app_saku_ar_transaksi_fWriteOff.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_ar_transaksi_fWriteOff";
		this.setTop(60);
		this.setWidth(1280);
		this.setHeight(550);
		...
		{
			alert("[app_saku_ar_transaksi_fWriteOff]->constructor : "+e);
		}
	}
};
window.app_saku_ar_transaksi_fWriteOff.extend(window.portalui_childForm);
window.app_saku_ar_transaksi_fWriteOff.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_ar_transaksi_fWriteOff.prototype.doModalResult = function(event, modalResult)
{
	switch (event)
	{
		case "clear" :
...
window.app_saku_ar_transaksi_fWriteOff.prototype.insertData = function(sql)
{	
	var line;	
...
window.app_saku_ar_transaksi_fWriteOff.prototype.FindBtnClick = function(sender, event)
{	
};
window.app_saku_ar_transaksi_fWriteOff.prototype.doRequestReady = function(sender, methodName, result)
{
...
window.app_saku_ar_transaksi_fWriteOff.prototype.doGenerate = function(sender)
{
	try{
...
window.app_saku_ar_transaksi_fWriteOff.prototype.doSelectDate = function(sender, y,m,d)
{
	this.ePeriode.setText(y+""+(m < 10?'0'+m:m));
	this.bGenerate.click();
};
window.app_saku_ar_transaksi_fWriteOff.prototype.createJurnal = function()
{
	try{
...
window.app_saku_ar_transaksi_fWriteOff.prototype.doSGChange = function(sender, col, row)
{
	if (col == 0){
		this.createJurnal();
	}
