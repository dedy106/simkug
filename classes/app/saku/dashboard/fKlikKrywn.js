window.app_saku_dashboard_fKlikKrywn = function(owner,loker,nik)
{
	if (owner)
	{
		try{
			window.app_saku_dashboard_fKlikKrywn.prototype.parent.constructor.call(this,owner);
			//window.app_saku_dashboard_fKlikKrywn.prototype.parent.setBorder.call(this,0);
			//window.app_saku_dashboard_fKlikKrywn.prototype.parent.setColor.call(this,"");
			this.className  = "app_saku_dashboard_fKlikKrywn";
		...
		{
			alert("[app_saku_dashboard_fKlikKrywn]->constructor : "+e);
		}
	}
};
window.app_saku_dashboard_fKlikKrywn.extend(window.portalui_panel);
window.app_saku_dashboard_fKlikKrywn.prototype.doImgClose = function(sender)
{
	this.getForm().doTrailClose();
};
window.app_saku_dashboard_fKlikKrywn.prototype.mgOnExpand = function(sender)
{
