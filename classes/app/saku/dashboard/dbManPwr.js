...
* 			SAI, PT											
********************************************************************************************** */
window.app_saku_dashboard_dbManPwr = function(owner)
{
	try{
		if (owner)
		{
			this.cekLoad=false;
			window.app_saku_dashboard_dbManPwr.prototype.parent.constructor.call(this,owner);
			this.className = "app_saku_dashboard_dbManPwr";
			this.setWidth(500);
		    this.setHeight(425);
		...
		alert("app_saku_dashboard_dbManPwr.constructor "+e);
	}
};
window.app_saku_dashboard_dbManPwr.extend(window.portalui_childForm);
window.app_saku_dashboard_dbManPwr.prototype.doEllipseClick = function(sender, col, row){
	if (row === 0)
	{
...
window.app_saku_dashboard_dbManPwr.prototype.doSelectCell = function(sender, col, row){
...
window.app_saku_dashboard_dbManPwr.prototype.mainButtonClick = function(sender){
	try
	{
		...
		systemAPI.alert("[app_saku_dashboard_dbManPwr]::mainButtonClick:"+e);
	}
};
window.app_saku_dashboard_dbManPwr.prototype.createBlock = function()
{
...
window.app_saku_dashboard_dbManPwr.prototype.doReFresh = function(sender)
{
...
window.app_saku_dashboard_dbManPwr.prototype.setDetailStatus = function(detail,caption)
{
...
window.app_saku_dashboard_dbManPwr.prototype.doSeriesClick = function(sender,series,title)
{
	try{
		...
		if (sender === this.fr7.chart)
		{
			...
			this.block2.show();
			uses("app_saku_dashboard_fKlikStatus",true);
			var detail7 = new app_saku_dashboard_fKlikStatus(this);
		...
		if (sender === this.fr8.chart)
		{
			...
			this.block2.show();
			uses("app_saku_dashboard_fKlikStatus",true);
			var detail8 = new app_saku_dashboard_fKlikStatus(this);
		...
		if (sender === this.fr9.chart)
		{
			...
			this.block2.show();
			uses("app_saku_dashboard_fKlikStatus",true);
			var detail9 = new app_saku_dashboard_fKlikStatus(this);
		...
		if (sender === this.fr10.chart)
		{
			...
			this.block2.show();
			uses("app_saku_dashboard_fKlikStatus",true);
			var detail10 = new app_saku_dashboard_fKlikStatus(this);
		...
		if (sender === this.fr11.chart)
		{
			...
			this.block2.show();
			uses("app_saku_dashboard_fKlikStatus",true);
			var detail11 = new app_saku_dashboard_fKlikStatus(this);
		...
		if (sender === this.fr12.chart)
		{
			...
			this.block2.show();
			uses("app_saku_dashboard_fKlikStatus",true);
			var detail12 = new app_saku_dashboard_fKlikStatus(this);
		...
		if (sender === this.fr13.chart)
		{
			...
			this.block2.show();
			uses("app_saku_dashboard_fKlikStatus",true);
			var detail13 = new app_saku_dashboard_fKlikStatus(this);
			this.setDetailStatus(detail13,"Data Pegawai Berdasar Unit Kerja : "+this.hruker[0]);
		}
	}catch(e){
		alert("window.app_saku_dashboard_dbManPwr.prototype.doSeriesClick : "+e);
	}
};
window.app_saku_dashboard_dbManPwr.prototype.doImgClose = function(sender)
{
	this.panel.free();
	this.block2.hide();
};
window.app_saku_dashboard_dbManPwr.prototype.doTrailClose = function()
{
	this.panel.panel.free();
};
window.app_saku_dashboard_dbManPwr.prototype.doAfterResize = function(width, height)
{	
	try{
		this.getwidth=width;
		...
		alert("app_saku_dashboard_dbManPwr::doAfterResize : "+e);
	}
};
window.app_saku_dashboard_dbManPwr.prototype.rearrange = function(panel)
{
...
window.app_saku_dashboard_dbManPwr.prototype.createFrame = function(frame,sql,title)
{
	frame.setLeft(10);
	frame.setTop(30);
...
window.app_saku_dashboard_dbManPwr.prototype.doLoadDashboard = function(load,filter)
{
	try{
		if (this.cekLoad){
			...
			var sql = "select b.kode_lokasi as nmcol1,a.sex as col1,count(*) as col2 "+
			...
			sql ="select a.nmcol1,a.col1,a.col2 from ( "+
				"	(select b.kode_lokasi as nmcol1,'20-35' as col1,count(a.tgl_lahir) as col2 "+
				"	from karyawan a left outer join hr_dinas2 b on a.nik=b.nik and a.kode_lokkonsol=b.kode_lokkonsol "+
				"	"+filter+" and cast(substring(date_sub(now(),interval substring(a.tgl_lahir,1,7) year_month),3,2) as decimal)>19 "+
				"	and cast(substring(date_sub(now(),interval substring(a.tgl_lahir,1,7) year_month),3,2) as decimal)<36 "+
				"	group by col1) union "+
				"	(select b.kode_lokasi as nmcol1,'36-45' as col1,count(a.tgl_lahir) as col2 "+
				"	from karyawan a left outer join hr_dinas2 b on a.nik=b.nik and a.kode_lokkonsol=b.kode_lokkonsol "+
				"	"+filter+" and cast(substring(date_sub(now(),interval substring(a.tgl_lahir,1,7) year_month),3,2) as decimal)>35 "+
				"	and cast(substring(date_sub(now(),interval substring(a.tgl_lahir,1,7) year_month),3,2) as decimal)<46 "+
				"	group by col1) union "+
				"	(select b.kode_lokasi as nmcol1,'>50' as col1,count(a.tgl_lahir) as col2 "+
				"	from karyawan a left outer join hr_dinas2 b on a.nik=b.nik and a.kode_lokkonsol=b.kode_lokkonsol "+
				"	"+filter+" and cast(substring(date_sub(now(),interval substring(a.tgl_lahir,1,7) year_month),3,2) as decimal)>49 "+
				"	group by col1) "+
				"	) as a";
			...
			sql ="select a.nmcol1,a.col1,a.col2 from ( "+
				"	(select b.kode_lokasi as nmcol1,'<2' as col1,count(*) as col2 "+
				"	from karyawan a left outer join hr_dinas2 b on a.nik=b.nik and a.kode_lokkonsol=b.kode_lokkonsol "+
				"	"+filter+" and cast(substring(date_sub(now(),interval substring(a.tgl_masuk,1,7) year_month),3,2) as decimal)<2 "+
				"	group by col1) union "+
				"	(select b.kode_lokasi as nmcol1,'2<5' as col1,count(*) as col2 "+
				"	from karyawan a left outer join hr_dinas2 b on a.nik=b.nik and a.kode_lokkonsol=b.kode_lokkonsol "+
				"	"+filter+" and cast(substring(date_sub(now(),interval substring(a.tgl_masuk,1,7) year_month),3,2) as decimal)>1 "+
				"	and cast(substring(date_sub(now(),interval substring(a.tgl_masuk,1,7) year_month),3,2) as decimal)<6 "+
				"	group by col1) union "+
				"	(select b.kode_lokasi as nmcol1,'6<10' as col1,count(*) as col2 "+
				"	from karyawan a left outer join hr_dinas2 b on a.nik=b.nik and a.kode_lokkonsol=b.kode_lokkonsol "+
				"	"+filter+" and cast(substring(date_sub(now(),interval substring(a.tgl_masuk,1,7) year_month),3,2) as decimal)>5 "+
				"	and cast(substring(date_sub(now(),interval substring(a.tgl_masuk,1,7) year_month),3,2) as decimal)<11 "+
				"	group by col1) "+
				"	) as a";
			this.fr3 = new portalui_frame(this.panel1);
			this.createFrame(this.fr3,sql,"Masa Kerja");
			
			sql ="select b.kode_lokasi as nmcol1,a.agama as col1,count(*) as col2 "+
			...
			sql = "select b.kode_lokasi as nmcol1,a.status as col1,count(*) as col2 "+
				"	from karyawan a left outer join hr_dinas2 b on a.nik=b.nik and a.kode_lokkonsol=b.kode_lokkonsol "+
			...
			sql = "select b.kode_lokasi as nmcol1,c.institusi as col1,count(*) as col2 "+
				"	from karyawan a left outer join hr_dinas2 b on a.nik=b.nik and a.kode_lokkonsol=b.kode_lokkonsol "+
			...
			sql = "select b.kode_lokasi as nmcol1,c.nama as col1,count(*) as col2 "+
				"	from karyawan a left outer join hr_dinas2 b on a.nik=b.nik and a.kode_lokkonsol=b.kode_lokkonsol "+
			...
			sql = "select b.kode_lokasi as nmcol1,d.nama as col1,count(*) as col2 "+
				"	from karyawan a left outer join hr_dinas2 b on a.nik=b.nik and a.kode_lokkonsol=b.kode_lokkonsol "+
...
window.app_saku_dashboard_dbManPwr.prototype.doMenuClick = function(sender)
{
};
window.app_saku_dashboard_dbManPwr.prototype.doModalResult = function(sender, modalResult)
{
	if (modalResult == mrOk){		
	}
};
window.app_saku_dashboard_dbManPwr.prototype.doRequestReady = function(sender, methodName, result)
{	
...
window.app_saku_dashboard_dbManPwr.prototype.doToolsClick = function(sender)
{
	if (sender == this.b1)
...
window.app_saku_dashboard_dbManPwr.prototype.doKeyDown = function(sender, keyCode)
{
};
window.app_saku_dashboard_dbManPwr.prototype.doClose = function()
{	
	this.rta.disable();
};
window.app_saku_dashboard_dbManPwr.prototype.frameAfterResize = function(sender, width, height)
{	
