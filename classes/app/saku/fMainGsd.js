...
//* 			SAI, PT											
//***********************************************************************************************
window.app_saku_fMainGsd = function(owner)
{
	if (owner)
	{	
		try
		{
			window.app_saku_fMainGsd.prototype.parent.constructor.call(this, owner);
			window.app_saku_fMainGsd.prototype.parent.setWidth.call(this, 600);
			window.app_saku_fMainGsd.prototype.parent.setHeight.call(this, 450);
			this._mainButtonClick = new portalui_eventHandler();
			this.title = "SAKU Form";
			this._isLogedIn	= false;
			this.app._kodeMenu = "DBMENU";
			this._userLog = "";
			this._lokasi = "";
			this._pp = "";
...
window.app_saku_fMainGsd.extend(window.portalui_form);
window.app_saku_fMainGsd.implement({
	gotoLogin: function(){
