window.app_saku_logistik_report_flSpbLog = function(owner)
{
	if (owner)
	{
		window.app_saku_logistik_report_flSpbLog.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_logistik_report_flSpbLog";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan SPB Logistik", 2);
...
window.app_saku_logistik_report_flSpbLog.extend(window.portalui_childForm);
window.app_saku_logistik_report_flSpbLog.prototype.doEllipseClick= function(sender, col, row)
{
	if (row ==0)
	{
...
window.app_saku_logistik_report_flSpbLog.prototype.doSelectCell = function(sender, col, row)
{
	if (this.userStatus=="A")
	{
...
window.app_saku_logistik_report_flSpbLog.prototype.mainButtonClick = function(sender)
{
	try
	{
		...
		this.nama_report="server_report_logistik_rptSpbLog";
...
window.app_saku_logistik_report_flSpbLog.prototype.doRequestReady = function(sender, methodName, result)
{
	switch (methodName)
	{
		case "preview" : 
...
window.app_saku_logistik_report_flSpbLog.prototype.doSelectedPage = function(sender, page)
{
	this.report.preview(this.nama_report,this.filter,page,this.pager,this.lokasi,this.showFilter);	
	this.page=page;
	this.allBtn = false;
};
window.app_saku_logistik_report_flSpbLog.prototype.doCloseReportClick = function(sender)
{
...
window.app_saku_logistik_report_flSpbLog.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_saku_logistik_report_flSpbLog.prototype.doRowPerPageChange = function(sender, rowperpage)
{
