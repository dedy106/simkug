window.app_saku_logistik_transaksi_fFrk = function(owner)
{
	if (owner)
	{
		window.app_saku_logistik_transaksi_fFrk.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_logistik_transaksi_fFrk";
		this.maximize();
		...
		this.cb_bukti.setCaption("No Asset");
...
window.app_saku_logistik_transaksi_fFrk.extend(window.portalui_childForm);
window.app_saku_logistik_transaksi_fFrk.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_logistik_transaksi_fFrk.prototype.ubah = function()
{	
...
window.app_saku_logistik_transaksi_fFrk.prototype.doModalResult = function(event, modalResult)
{
...
/*
window.app_saku_logistik_transaksi_fFrk.prototype.genClick = function(sender)
{
	try
	{
...
*/
window.app_saku_logistik_transaksi_fFrk.prototype.doSelect = function(sender, year, month, day)
{
	if (month < 10)
		month = "0"+month;
...
window.app_saku_logistik_transaksi_fFrk.prototype.doEditChange = function(sender)
{
	/*
...
window.app_saku_logistik_transaksi_fFrk.prototype.showClick = function(sender)
{
	...
	{	
		var strSql =  " select a.nama,a.barcode,a.kode_brg,b.nama as nama_brg,a.kode_akun,a.jenis,a.kode_pp,e.nama as nama_pp,a.kode_klpfa,ifnull(g.nama,'-') as nama_klpfa,a.kode_curr,a.kurs, "+
					  ...
					  "		   a.nilai,a.merk,a.tipe,a.no_seri,a.nilai_residu,a.umur,a.persen "+
...
window.app_saku_logistik_transaksi_fFrk.prototype.FindBtnClick = function(sender, event)
{
	try
	{
		...
		{   
		    this.standarLib.showListData(this, "Daftar Asset FR Non PO",this.cb_bukti,undefined, 
										  ...
										  "where a.kode_lokasi='"+this.app._lokasi+"' and a.progress ='0' and a.periode<='"+this.ed_period.getText()+"'",
...
window.app_saku_logistik_transaksi_fFrk.prototype.doRequestReady = function(sender, methodName, result)
{
