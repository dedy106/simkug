window.app_saku_inventory_transaksi_gudang_fIo = function(owner)
{
	if (owner)
	{
		window.app_saku_inventory_transaksi_gudang_fIo.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_inventory_transaksi_gudang_fIo";
...
window.app_saku_inventory_transaksi_gudang_fIo.extend(window.portalui_childForm);
window.app_saku_inventory_transaksi_gudang_fIo.implement({
