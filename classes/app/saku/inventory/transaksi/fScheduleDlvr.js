...
//* 			SAI, PT											
//***********************************************************************************************
window.app_saku_inventory_transaksi_fScheduleDlvr = function(owner,options){
	try{
		if (owner)
		{
			window.app_saku_inventory_transaksi_fScheduleDlvr.prototype.parent.constructor.call(this, owner,options);			
			this.className = "app_saku_inventory_transaksi_fScheduleDlvr";
			this.maximize();
			this.app._mainForm.childFormConfig(this, "mainButtonClick","Schedule Delivery",0);				
            this.initComponent();		
	...
	{
		alert("[app_saku_inventory_transaksi_fScheduleDlvr]::contruct:"+e,"");
	}
};
window.app_saku_inventory_transaksi_fScheduleDlvr.extend(window.portalui_childForm);
window.app_saku_inventory_transaksi_fScheduleDlvr.implement({
	initComponent: function(){		
		try{
			...
			this.lTgl = new portalui_label(this,{bound:[10,32,100,18],underline:true,caption:"Tanggal Delivery"});
			this.dp_orderip = new portalui_datePicker(this,{bound:[110,32,82,20],selectDate:[this,"doSelect"]});
			this.e0ip = new portalui_saiCBBL(this,{bound:[10,54,250,20],caption:"No. Delivery",btnVisible:false});
			...
			this.sg1ip = new portalui_saiGrid(this.p1ip,{bound:[1,20,this.p1ip.width - 4,203],name:"saiSG1",colCount:8,colTitle:["Kode Customer","Customer","No Order","Keterangan","Kode Barang","Nama Barang","Satuan","Jumlah"],
                colWidth:[[7,6,5,4,3,2,1,0],[100,100,100,76,100,100,100,100]],buttonStyle:[[0,2,4],[bsEllips,bsEllips,bsEllips]],colFormat:[[7],[cfNilai]],
                change:[this,"sg1onChange"],ellipsClick:[this,"doFindBtnClick"],colReadOnly:[true,[1,3,5],[]],rowCount:1});
