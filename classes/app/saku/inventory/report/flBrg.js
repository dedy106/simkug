window.app_saku_inventory_report_flBrg = function(owner)
{
	if (owner)
	{
		window.app_saku_inventory_report_flBrg.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_inventory_report_flBrg";
		this.maximize();
...
window.app_saku_inventory_report_flBrg.extend(window.portalui_childForm);
window.app_saku_inventory_report_flBrg.implement({
		...
		try
		{
			if (sender === this.app._mainForm.bClear2){
		    	...
		    	this.filter = this.filterRep.filterStr("kode_klpbrg",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"and")+
							this.filterRep.filterStr("kode_brg",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");
				
				this.showFilter = this.filterRep.showFilter(this.sg1);
				var result  = new portalui_arrayMap();
				var sql = "select kode_brg,nama,tipe,sat,harga "+
					" from inv_brg "+
					"where kode_lokasi = '"+this.app._lokasi+"' "+this.filter;
				this.scriptSqlCount = "select count(*) "+
								" from inv_brg "+
								"where kode_lokasi = '"+this.app._lokasi+"' "+this.filter;
				this.title = new server_util_arrayList({items:["Kode","Nama Barang","Tipe","Satuan","Harga"]});
			...
			systemAPI.alert("[app_saku_inventory_report_flBrg]::mainButtonClick:"+e);
		}
	},
	...
	previewReport: function(dthtml){
		var html = "<div align='center' class='judul_laporan' style='{width:100%;font-size:14;font-weight:bold;}'><br><br>"+this.app._namalokasi.toUpperCase()+"<br>DAFTAR BARANG<br>";
		var d = new Date();
