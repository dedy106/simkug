// JavaScript Document
window.app_saku_fa_report_flFaKlaim = function(owner)
{
	if (owner)
	{
		window.app_saku_fa_report_flFaKlaim.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_fa_report_flFaKlaim";
		this.maximize();
		
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Klaim Asuransi", 2);
...
window.app_saku_fa_report_flFaKlaim.extend(window.portalui_childForm);
window.app_saku_fa_report_flFaKlaim.implement({
	doEllipseClick: function(sender, col, row){
		...
		if (row == 2)
		{
			var sql1="select no_klaim,keterangan from faklaim_m "+
					 ...
					 " ";
			var sql2="select count(no_klaim) from faklaim_m "+
			         this.filterRep.filterStr("periode",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where") +
					 this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");
			
			this.filterRep.ListDataSGFilter(this, "Data Klaim",this.sg1, this.sg1.row, this.sg1.col,sql1,sql2,new Array("no_klaim","keterangan"),"and");
		}
	},
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_fa_rptFaKlaim";
