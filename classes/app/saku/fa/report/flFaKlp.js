// JavaScript Document
window.app_saku_fa_report_flFaKlp = function(owner)
{
	if (owner)
	{
		window.app_saku_fa_report_flFaKlp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_fa_report_flFaKlp";
		this.maximize();
		
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Kelompok Asset", 2);
...
window.app_saku_fa_report_flFaKlp.extend(window.portalui_childForm);
window.app_saku_fa_report_flFaKlp.implement({
	doEllipseClick: function(sender, col, row){
		...
		if (row ==1)
		{
			this.filterRep.ListDataSGFilter(this, "Data Kelompok",this.sg1, this.sg1.row, this.sg1.col,
											"select kode_klpfa,nama from fa_klp "+
											this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
											"",
											"select count(*) from fa_klp "+
											this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where"),
											new Array("kode_klpfa","nama"),"where",new Array("kode","nama"));
		}
	},
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_fa_rptFaKlp";
	    		...
	    		this.filter = this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where")+
							  this.filterRep.filterStr("kode_klpfa",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");
		...
		{
			alert("[app_saku_fa_report_flFaKlp]::mainButtonClick:"+e);
		}
	},
	...
	doCloseReportClick: function(sender){
	  switch(sender.getName())
	  {
	    ...
	    case "PrintBtn" :
			...
			this.viewer.useIframe(this.report.previewWithHeader(this.nama_report,this.filter, this.page, (this.allBtn ? this.viewer.getTotalPage() * this.pager : this.pager), this.showFilter,this.lokasi));
	      try
	      {
