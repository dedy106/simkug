// JavaScript Document
window.app_saku_fa_report_flFaRekapLokasi = function(owner)
{
	if (owner)
	{
		window.app_saku_fa_report_flFaRekapLokasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_fa_report_flFaRekapLokasi";
		this.maximize();
		
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Rekap Lokasi Asset", 2);
...
window.app_saku_fa_report_flFaRekapLokasi.extend(window.portalui_childForm);
window.app_saku_fa_report_flFaRekapLokasi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_fa_rptFaRekapLokasi";
	...
	sg1onChanges: function(sender, col , row){
	    if (col==1)
		{
