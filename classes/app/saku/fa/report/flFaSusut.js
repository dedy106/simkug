// JavaScript Document
window.app_saku_fa_report_flFaSusut = function(owner)
{
	if (owner)
	{
		window.app_saku_fa_report_flFaSusut.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_fa_report_flFaSusut";
		this.maximize();
		
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Pemyusutan Asset", 2);	
...
window.app_saku_fa_report_flFaSusut.extend(window.portalui_childForm);
window.app_saku_fa_report_flFaSusut.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_fa_rptFaSusut";
