// JavaScript Document
window.app_saku_fa_report_flFaApp = function(owner)
{
	if (owner)
	{
		window.app_saku_fa_report_flFaApp.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_fa_report_flFaApp";
		this.maximize();
		
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Approve Asset", 2);
...
window.app_saku_fa_report_flFaApp.extend(window.portalui_childForm);
window.app_saku_fa_report_flFaApp.implement({
	doEllipseClick: function(sender, col, row){
		...
		if (row == 2)
		{
			...
			this.filterRep.ListDataSGFilter(this, "Data Approve",this.sg1, this.sg1.row, this.sg1.col,sql1,sql2,new Array("no_faapp","keterangan"),"and");
		}
	},
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_fa_rptFaApp";
