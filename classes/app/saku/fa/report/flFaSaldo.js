// JavaScript Document
window.app_saku_fa_report_flFaSaldo = function(owner)
{
	if (owner)
	{
		window.app_saku_fa_report_flFaSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_fa_report_flFaSaldo";
		this.maximize();
		
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Saldo Asset", 2);		
...
window.app_saku_fa_report_flFaSaldo.extend(window.portalui_childForm);
window.app_saku_fa_report_flFaSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_fa_rptFaSaldo";
