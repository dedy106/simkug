// JavaScript Document
window.app_saku_fa_report_flFaPolis = function(owner)
{
	if (owner)
	{
		window.app_saku_fa_report_flFaPolis.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku_fa_report_flFaPolis";
		this.maximize();
		
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Polis Asuransi", 2);
...
window.app_saku_fa_report_flFaPolis.extend(window.portalui_childForm);
window.app_saku_fa_report_flFaPolis.implement({
	doEllipseClick: function(sender, col, row){
		...
		if (row == 2)
		{
			var sql1="select no_polis,keterangan from fapolis_m "+
					 ...
					 " ";
			var sql2="select count(no_polis) from fapolis_m "+
			         this.filterRep.filterStr("periode",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where") +
					 this.filterRep.filterStr("kode_lokasi",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and");
			
			this.filterRep.ListDataSGFilter(this, "Data Polis",this.sg1, this.sg1.row, this.sg1.col,sql1,sql2,new Array("no_polis","keterangan"),"and");
		}
	},
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.filter=this.filterRep.filterStr("a.periode",this.sg1.getCell(1,0),this.sg1.getCell(2,0),this.sg1.getCell(3,0),"where") +
						...
						this.filterRep.filterStr("a.no_polis",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
			this.nama_report="server_report_fa_rptFaPolis";
