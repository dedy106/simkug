window.app_saku_fa_transaksi_fFaAppju = function(owner)
{
	if (owner)
	{
		window.app_saku_fa_transaksi_fFaAppju.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_fa_transaksi_fFaAppju";
		this.maximize();
		...
		this.cb_perJU = new portalui_saiCB(this,{bound:[720,2,200,20],caption:"Periode JU",mustCheck: true, change:[this,"doEditChange"],tag:2});
		...
		this.cb_ju = new portalui_saiCBBL(this,{bound:[720,3,200,20],caption:"No Bukti JU",rightLabelVisible:false});				
		...
		this.ed_ju = new portalui_saiLabelEdit(this,{bound:[720,10,200,20],caption:"Nilai JU", tipeText:ttNilai,readOnly:true,text:"0"});		
...
window.app_saku_fa_transaksi_fFaAppju.extend(window.portalui_childForm);
window.app_saku_fa_transaksi_fFaAppju.implement({
			...
			try{
				...
				for (var i=0;i < this.sg0.getRowCount();i++){
					if (this.sg0.cells(0,i) != "-" && this.sg0.cells(0,i) != ""){
						...
						faScript.push("('"+this.ed_nb.getText()+"','"+this.sg0.cells(1,i)+"','"+this.cb_ju.getText()+"','"+this.sg0.getCell(4,i)+"','"+this.app._lokasi+"',"+parseNilai(this.sg0.getCell(5,i))+",'JU')"); 
					}
				}
	...
	doFindBtnClick: function(sender, col, row){
		...
		{
			alert("[app_saku_fa_transaksi_fFaAppju] : doFindBtnClick : " + e);
		}
	},
