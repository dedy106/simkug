window.app_saku_logistik_transaksi_fFaFrNonApp = function(owner)
{
	if (owner)
	{
		window.app_saku_logistik_transaksi_fFaFrNonApp.prototype.parent.constructor.call(this,owner);
		this.className  = "app_saku_logistik_transaksi_fFaFrNonApp";
		this.maximize();
...
window.app_saku_logistik_transaksi_fFaFrNonApp.extend(window.portalui_childForm);
window.app_saku_logistik_transaksi_fFaFrNonApp.prototype.mainButtonClick = function(sender)
{
...
window.app_saku_logistik_transaksi_fFaFrNonApp.prototype.simpan = function()
{	
	this.bGen.click();
...
window.app_saku_logistik_transaksi_fFaFrNonApp.prototype.doModalResult = function(event, modalResult)
{
...
window.app_saku_logistik_transaksi_fFaFrNonApp.prototype.genClick = function(sender)
{
	try
	{
...
window.app_saku_logistik_transaksi_fFaFrNonApp.prototype.doSelect = function(sender, year, month, day)
{
	if (month < 10)
		month = "0"+month;
...
window.app_saku_logistik_transaksi_fFaFrNonApp.prototype.doEditChange = function(sender)
{
...
window.app_saku_logistik_transaksi_fFaFrNonApp.prototype.FindBtnClick = function(sender, event)
{
	try
	{
		if (sender == this.cb_brg) 
...
window.app_saku_logistik_transaksi_fFaFrNonApp.prototype.doRequestReady = function(sender, methodName, result)
{
