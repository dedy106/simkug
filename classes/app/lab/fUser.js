window.app_lab_fUser = function(owner)
{
	if (owner)
	{
		window.app_lab_fUser.prototype.parent.constructor.call(this,owner);
		this.className  = "app_lab_fUser";
...
window.app_lab_fUser.extend(window.childForm);
window.app_lab_fUser.implement({
