window.app_lab_fUserFormAccess = function(owner)
{
	if (owner)
	{
		window.app_lab_fUserFormAccess.prototype.parent.constructor.call(this,owner);
		this.className  = "app_lab_fUserFormAccess";
		this.maximize();
...
window.app_lab_fUserFormAccess.extend(window.childForm);
window.app_lab_fUserFormAccess.implement({
