window.app_lab_fUserAccess = function(owner)
{
	if (owner)
	{
		window.app_lab_fUserAccess.prototype.parent.constructor.call(this,owner);
		this.className  = "app_lab_fUserAccess";
		this.maximize();
...
window.app_lab_fUserAccess.extend(window.childForm);
window.app_lab_fUserAccess.implement({
