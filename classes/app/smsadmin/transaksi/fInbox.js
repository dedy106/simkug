...
* 			SAI, PT											
***********************************************************************************************/
window.app_smsadmin_transaksi_fInbox = function(owner)
{
	if (owner)
	{
		window.app_smsadmin_transaksi_fInbox.prototype.parent.constructor.call(this,owner);
		this.className  = "app_smsadmin_transaksi_fInbox";
		this.setTop(60);
		this.setWidth(1280);
		this.setHeight(550);
...
window.app_smsadmin_transaksi_fInbox.extend(window.portalui_childForm);
//------------------------------------------------------------------ event
window.app_smsadmin_transaksi_fInbox.prototype.mainButtonClick = function(sender)
{
...
window.app_smsadmin_transaksi_fInbox.prototype.doAfterResize = function(event, height, width)
{
...
window.app_smsadmin_transaksi_fInbox.prototype.doModalResult = function(event, modalResult)
{
	switch (event)
	{
		case "clear" :
...
window.app_smsadmin_transaksi_fInbox.prototype.doClick = function(sender)
{
	try{
		this.timer.setEnabled(false);
...
window.app_smsadmin_transaksi_fInbox.prototype.doRequestReady = function(sender, methodName, result)
{	
...
window.app_smsadmin_transaksi_fInbox.prototype.doClose = function(){
	this.app._mainForm.bSend.setCaption("Send");
};
window.app_smsadmin_transaksi_fInbox.prototype.loadMenu = function(daftarNrc, treev)
{
	try
	{		
		this.isStr = true;
...
window.app_smsadmin_transaksi_fInbox.prototype.treeClick = function(item)
{
	try{
...
window.app_smsadmin_transaksi_fInbox.prototype.getPostingLevel = function(item)
{	
...
window.app_smsadmin_transaksi_fInbox.prototype.doSelectedPage = function(sender, page)
{
