window.app_smsadmin_parameter_fGroupDetail = function(owner)
{
	if (owner)
	{
		window.app_smsadmin_parameter_fGroupDetail.prototype.parent.constructor.call(this, owner);
		window.app_smsadmin_parameter_fGroupDetail.prototype.parent.setWidth.call(this, 300);
		window.app_smsadmin_parameter_fGroupDetail.prototype.parent.setHeight.call(this, 400);
		
		this.centerize();
		
		this.className = "app_smsadmin_parameter_fGroupDetail";
...
window.app_smsadmin_parameter_fGroupDetail.extend(window.portalui_commonForm);

window.app_smsadmin_parameter_fGroupDetail.prototype.doDraw = function(canvas)
{
...
window.app_smsadmin_parameter_fGroupDetail.prototype.doAfterResize = function(event)
{
	this.p1.setWidth(this.width - 40);
...
window.app_smsadmin_parameter_fGroupDetail.prototype.doSysMouseDown = function(x, y, button, buttonState)
{	
	window.app_smsadmin_parameter_fGroupDetail.prototype.parent.doSysMouseDown.call(this,x, y, button, buttonState);
/*	this.mouseX = x;
    this.mouseY = y;
...
window.app_smsadmin_parameter_fGroupDetail.prototype.doSysMouseUp = function(x, y, button, buttonState)
{	
	window.app_smsadmin_parameter_fGroupDetail.prototype.parent.doSysMouseUp.call(this,x, y, button, buttonState);
//	this.isClick = false;

};
window.app_smsadmin_parameter_fGroupDetail.prototype.doSysMouseMove = function(x, y, button, buttonState)
{
	window.app_smsadmin_parameter_fGroupDetail.prototype.parent.doSysMouseMove.call(this,x, y, button, buttonState);
	if (this.isClick)
	{		
...
window.app_smsadmin_parameter_fGroupDetail.prototype.eventMouseDown = function(event)
{
...
window.app_smsadmin_parameter_fGroupDetail.prototype.eventMouseUp = function(event)
{
	this.isClick = false;
	this.blockElm.style.display = "none";
	this.frameElm.style.display = "";
};
window.app_smsadmin_parameter_fGroupDetail.prototype.eventMouseMove = function(event)
{
	if (this.isClick)
	{
		var x = event.clientX;
...
window.app_smsadmin_parameter_fGroupDetail.prototype.doClick = function(sender)
{
	if (sender == this.b1)
		this.modalResult = mrOk;
	else this.modalResult = mrCancel;
	var value = this.e0.getText() + ";" + this.e1.getText() +";"+ this.e2.getText();
	value += ";"+this.e3.getText() + ";" + (this.e4.getText() == ""?"-":this.e4.getText());
	this.formRequester.doModalResult(this.event, this.modalResult, value);
	this.close();
};
window.app_smsadmin_parameter_fGroupDetail.prototype.doRequestReady = function(sender, methodName, result)
{

};
window.app_smsadmin_parameter_fGroupDetail.prototype.findBtnClick = function(sender)
{

};

//--------------------------------------------
window.app_smsadmin_parameter_fGroupDetail.prototype.setCaption = function(data)
{
...
window.app_smsadmin_parameter_fGroupDetail.prototype.setItemParent = function(data)
{
	this.itemParent = data;
};


window.app_smsadmin_parameter_fGroupDetail.prototype.setSummaryItems = function(data)
{
	this.e4.clearItem();
	for (var i in data)
	{
...
window.app_smsadmin_parameter_fGroupDetail.prototype.doClose = function(sender)
{
