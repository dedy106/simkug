...
//* 			SAI, PT											
//***********************************************************************************************
window.app_smsadmin_fMain = function(owner)
{
	if (owner)
	{	
		try
		{
			window.app_smsadmin_fMain.prototype.parent.constructor.call(this, owner);
			window.app_smsadmin_fMain.prototype.parent.setWidth.call(this, 600);
			window.app_smsadmin_fMain.prototype.parent.setHeight.call(this, 450);
			this._mainButtonClick = new portalui_eventHandler();
			this.title = "SMS Admin";
...
window.app_smsadmin_fMain.extend(window.portalui_form);
window.app_smsadmin_fMain.implement({
	gotoLogin: function(){
