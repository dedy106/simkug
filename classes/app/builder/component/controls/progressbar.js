...
//* 			SAI, PT											
//***********************************************************************************************
window.app_builder_component_controls_progressbar = function(owner){
    if (owner){
		this.withImage = false;
		this.color = system.getConfig("form.button.color");
        window.app_builder_component_controls_progressbar.prototype.parent.constructor.call(this, owner);
        this.className = "portalui_progressbar";	
		this.owner = owner;
				
        window.app_builder_component_controls_progressbar.prototype.parent.setWidth.call(this, 73);
        window.app_builder_component_controls_progressbar.prototype.parent.setHeight.call(this, 18);
...
window.app_builder_component_controls_progressbar.extend(window.app_builder_component_controls_control);
window.app_builder_component_controls_progressbar.implement({
