...
//* 			SAI, PT											
//***********************************************************************************************
window.app_builder_component_controls_sysForm = function(owner, options){
try{
    if (owner){    
        this.color = '#ffffff';//system.getConfig("form.color");
		this.caption = "Form";				
		window.app_builder_component_controls_sysForm.prototype.parent.constructor.call(this, owner, options);
		this.className = "portalui_sysForm";
		...
		this.addProperty({className:"portalui_sysForm",color:this.color, caption:this.caption,borderStyle:this.borderStyle});
...
window.app_builder_component_controls_sysForm.extend(window.app_builder_component_controls_commonForm);
window.app_builder_component_controls_sysForm.implement({
	...
	doActivate: function(){
	    window.app_builder_component_controls_sysForm.prototype.parent.doActivate.call(this);
	    
	    var node = $(this.getFullId() + "_title");
	    node.style.color = system.getConfig("form.titleFontColor");	
	},
	doDeactivate: function(){
	    window.app_builder_component_controls_sysForm.prototype.parent.doDeactivate.call(this);
	...
	close: function(){
		if (this.closeToHide)
			...
			window.app_builder_component_controls_sysForm.prototype.parent.close.call(this);
	},
