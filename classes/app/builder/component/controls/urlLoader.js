...
//* 			SAI, PT											
//***********************************************************************************************
window.app_builder_component_controls_urlLoader = function(owner){
    if (owner){
		this.color = '#ffffff';//system.getConfig("form.color");
		this.caption = "Form";
        window.app_builder_component_controls_urlLoader.prototype.parent.constructor.call(this, owner);
        this.className = "portalui_urlLoader";
...
window.app_builder_component_controls_urlLoader.extend(window.app_builder_component_controls_commonForm);
window.app_builder_component_controls_urlLoader.implement({
	doDraw : function(canvas){
		canvas.style.border = "1px solid #ffffff";
		window.app_builder_component_controls_urlLoader.prototype.parent.doDraw.call(this, canvas);
	...
	doActivate: function(){
	    window.app_builder_component_controls_urlLoader.prototype.parent.doActivate.call(this); 	
	},
	doDeactivate: function(){
	    window.app_builder_component_controls_urlLoader.prototype.parent.doDeactivate.call(this);
	},
	getCaption: function(){
		return this.caption;
	},
	...
	close: function(){
		window.app_builder_component_controls_urlLoader.prototype.parent.close.call(this);
	},
