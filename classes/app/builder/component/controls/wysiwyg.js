...
//* 			SAI, PT											
//***********************************************************************************************
window.app_builder_component_controls_wysiwyg = function(owner)
{
    if (owner)
    {        
		window.app_builder_component_controls_wysiwyg.prototype.parent.constructor.call(this, owner);		
        this.className = "portalui_wysiwyg";
        this.owner = owner;		
		this.onKeyPress = new portalui_eventHandler();
		this.onKeyDown	= new portalui_eventHandler();
    }
};
window.app_builder_component_controls_wysiwyg.extend(window.app_builder_component_controls_control);
//---------------------------- Function ----------------------------------------
window.app_builder_component_controls_wysiwyg.prototype.doSerialize = function()
{
    window.app_builder_component_controls_wysiwyg.prototype.parent.doSerialize.call(this);    
};
window.app_builder_component_controls_wysiwyg.prototype.doDraw = function(canvas)
{
    ...
    if (document.all)
        var html =  "<div style='{position: absolute; left: 0; top: 0; width: 100%; height: 100%;}' >" +
				"<textarea id='" + n + "_hidden' style='{visibility:hidden;display:none;position: absolute; left: 0; top: 0; width: 100%; height: 100%}' ></textarea>"+				
				"<iframe id='" + n + "_frame'  frameborder='0' style='{margin-left: 3px; background-color: white; color: black; position: absolute; left: 0; top: 0; width: 100%; height: 100%}' ></iframe>"+
	...
	if (document.all){
		...
		for (var i=0; i < kids.length; i++) { 															
			if (kids[i].getAttribute("name")== n + "_tool"){
				kids[i].onmouseout = new Function("system.getResource("+this.resourceId+").rteMouseOutFormatMenu(event, '"+kids[i].id+"',"+this.resourceId+")");
				kids[i].onmouseover = new Function("system.getResource("+this.resourceId+").rteMouseOverFormatMenu(event, '"+kids[i].id+"',"+this.resourceId+")");
				kids[i].onmousedown = new Function("system.getResource("+this.resourceId+").rteMouseDownFormatMenu(event, '"+kids[i].id+"',"+this.resourceId+")");					
				if (kids[i].className.search("rtebtn") != -1)
					kids[i].onclick = new Function("system.getResource("+this.resourceId+").rteAction(event, '"+kids[i].id+"',"+this.resourceId+")");
			}else if (kids[i].getAttribute("name")== n + "format"){
				kids[i].onmouseout = new Function("system.getResource("+this.resourceId+").rteMouseOutMenuContents(event, '"+kids[i].id+"',"+this.resourceId+")");
				kids[i].onmouseover = new Function("system.getResource("+this.resourceId+").rteMouseOverMenuContents(event, '"+kids[i].id+"',"+this.resourceId+")");
				kids[i].onmousedown = new Function("system.getResource("+this.resourceId+").rteMouseDownMenuContents(event, '"+kids[i].id+"',"+this.resourceId+")");		
			}
		...
		for (var i=0; i < kids.length; i++) { 				
			kids[i].onmouseout = new Function("event","system.getResource("+this.resourceId+").rteMouseOutFormatMenu(event, '"+kids[i].id+"',"+this.resourceId+")");
			kids[i].onmouseover = new Function("event","system.getResource("+this.resourceId+").rteMouseOverFormatMenu(event, '"+kids[i].id+"',"+this.resourceId+")");
			kids[i].onmousedown = new Function("event","system.getResource("+this.resourceId+").rteMouseDownFormatMenu(event, '"+kids[i].id+"',"+this.resourceId+")");					
			if (kids[i].className.search("rtebtn") != -1)
				kids[i].onclick = new Function("event","system.getResource("+this.resourceId+").rteAction(event, '"+kids[i].id+"',"+this.resourceId+")");;				
		}
		kids = document.getElementsByName(n +'format'); 
		for (var i=0; i < kids.length; i++) { 
			kids[i].onmouseout = new Function("event","system.getResource("+this.resourceId+").rteMouseOutMenuContents(event, '"+kids[i].id+"',"+this.resourceId+")");
			kids[i].onmouseover = new Function("event","system.getResource("+this.resourceId+").rteMouseOverMenuContents(event, '"+kids[i].id+"',"+this.resourceId+")");
			kids[i].onmousedown = new Function("event","system.getResource("+this.resourceId+").rteMouseDownMenuContents(event, '"+kids[i].id+"',"+this.resourceId+")");		
		}	
	}
	this.loadCss();	
};
window.app_builder_component_controls_wysiwyg.prototype.eventKeyDown = function (event){
	try{		
		if (this.getElementById("param1") != null){
			var obj = window.system.getResource(this.getElementById("param1").value);
...
window.app_builder_component_controls_wysiwyg.prototype.doResize = function (width, height){	
	this.wysiwyg_content.style.height = this.height - 100;
	this.wysiwyg_hidden.style.height = this.height - 100;
};
window.app_builder_component_controls_wysiwyg.prototype.eventKeyPress = function (event){	
	try{		
		var obj = window.system.getResource(this.getElementById("param1").value);
...
//------------------------------- Event ----------------------------------------
window.app_builder_component_controls_wysiwyg.prototype.disable = function (){
...
window.app_builder_component_controls_wysiwyg.prototype.enable = function (){
	// disable design mode or content editable feature
	if(this.wysiwyg_content.contentWindow.document.body.contentEditable) {
...
window.app_builder_component_controls_wysiwyg.prototype.display = function (){
	try{
	    if(this.isSupported()){
			...
			this.param = "<input type='hidden' id='param1' name='param1' value='"+this.resourceId+"'/>";
...
window.app_builder_component_controls_wysiwyg.prototype._display_textarea = function (){
	this.wysiwyg_hidden.style.display = "";
	this.wysiwyg_hidden.style.visibility = "";
};
window.app_builder_component_controls_wysiwyg.prototype.doTextFormat = function (command, optn, x, y){
	try{		
...
window.app_builder_component_controls_wysiwyg.prototype.toggleMode = function (){
...
window.app_builder_component_controls_wysiwyg.prototype._toggle_mode_ie = function (){
    if(this.viewMode == 2){
...
window.app_builder_component_controls_wysiwyg.prototype._toggle_mode_gecko = function (){
    if(this.viewMode == 2){
        ...
        var html = document.createTextNode(this.wysiwyg_content.contentWindow.document.body.innerHTML);
		html = html.replace(this.param,"");
...
window.app_builder_component_controls_wysiwyg.prototype.getCaretPos = function (){    
	if(document.all)
		{
...
window.app_builder_component_controls_wysiwyg.prototype.insertNodeAtSelection = function (insertNode){    
	try{
		if(document.all)
		{
			var caretPos=this.wysiwyg_content.contentWindow.document.selection.createRange();
...
window.app_builder_component_controls_wysiwyg.prototype.getSelectContainer = function (){    
	try{
		if(document.all)
		{
			var caretPos=this.wysiwyg_content.contentWindow.document.selection.createRange();
...
window.app_builder_component_controls_wysiwyg.prototype.setSelection = function (){  
	var sel = this.getSelection();
	var range = sel.getRangeAt(0);
	var pos = range.startOffset;
...
window.app_builder_component_controls_wysiwyg.prototype.getSelection = function (){    
	try{
		if(document.all)
		{
			var caretPos=this.wysiwyg_content.contentWindow.document.selection.createRange();
...
window.app_builder_component_controls_wysiwyg.prototype.setSelectedColor = function (color, command){    
	try{	    
...
window.app_builder_component_controls_wysiwyg.prototype.setFocus = function(){
	this.wysiwyg_content.contentWindow.focus();
};
window.app_builder_component_controls_wysiwyg.prototype.getPallete = function (command, optn, x, y) {
...
window.app_builder_component_controls_wysiwyg.prototype.isSupported = function () {   
    return true;
};
window.app_builder_component_controls_wysiwyg.prototype.isMSIE = function (){
    return (typeof(document.all) == "object");
};

window.app_builder_component_controls_wysiwyg.prototype._get_palette_html = function (command) {    
    s = '  <table border="0" cellpadding="0" cellspacing="2">';
    s = s + '   <tr>';
    s = s + '    <td id="cFFFFFF" bgcolor="#FFFFFF" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="cFFCCCC" bgcolor="#FFCCCC" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="cFFCC99" bgcolor="#FFCC99" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="cFFFF99" bgcolor="#FFFF99" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="cFFFFCC" bgcolor="#FFFFCC" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c99FF99" bgcolor="#99FF99" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c99FFFF" bgcolor="#99FFFF" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="cCCFFFF" bgcolor="#CCFFFF" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="cCCCCFF" bgcolor="#CCCCFF" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="cFFCCFF" bgcolor="#FFCCFF" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '   </tr>';
    s = s + '   <tr>';
    s = s + '    <td id="cCCCCCC" bgcolor="#CCCCCC" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="cFF6666" bgcolor="#FF6666" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="cFF9966" bgcolor="#FF9966" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="cFFFF66" bgcolor="#FFFF66" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="cFFFF33" bgcolor="#FFFF33" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c66FF99" bgcolor="#66FF99" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c33FFFF" bgcolor="#33FFFF" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c66FFFF" bgcolor="#66FFFF" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c9999FF" bgcolor="#9999FF" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="cFF99FF" bgcolor="#FF99FF" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '   </tr>';
    s = s + '   <tr>';
    s = s + '    <td id="cC0C0C0" bgcolor="#C0C0C0" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="cFF0000" bgcolor="#FF0000" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="cFF9900" bgcolor="#FF9900" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="cFFCC66" bgcolor="#FFCC66" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="cFFFF00" bgcolor="#FFFF00" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c33FF33" bgcolor="#33FF33" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c66CCCC" bgcolor="#66CCCC" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c33CCFF" bgcolor="#33CCFF" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c6666CC" bgcolor="#6666CC" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="cCC66CC" bgcolor="#CC66CC" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '   </tr>';
    s = s + '   <tr>';
    s = s + '    <td id="c999999" bgcolor="#999999" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="cCC0000" bgcolor="#CC0000" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="cFF6600" bgcolor="#FF6600" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="cFFCC33" bgcolor="#FFCC33" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="cFFCC00" bgcolor="#FFCC00" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c33CC00" bgcolor="#33CC00" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c00CCCC" bgcolor="#00CCCC" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c3366FF" bgcolor="#3366FF" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c6633FF" bgcolor="#6633FF" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="cCC33CC" bgcolor="#CC33CC" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '   </tr>';
    s = s + '   <tr>';
    s = s + '    <td id="c666666" bgcolor="#666666" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c990000" bgcolor="#990000" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="cCC6600" bgcolor="#CC6600" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="cCC9933" bgcolor="#CC9933" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c999900" bgcolor="#999900" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c009900" bgcolor="#009900" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c339999" bgcolor="#339999" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c3333FF" bgcolor="#3333FF" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c6600CC" bgcolor="#6600CC" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c993399" bgcolor="#993399" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '   </tr>';
    s = s + '   <tr>';
    s = s + '    <td id="c333333" bgcolor="#333333" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c660000" bgcolor="#660000" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c993300" bgcolor="#993300" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c996633" bgcolor="#996633" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c666600" bgcolor="#666600" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c006600" bgcolor="#006600" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c336666" bgcolor="#336666" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c000099" bgcolor="#000099" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c333399" bgcolor="#333399" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c663366" bgcolor="#663366" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '   </tr>';
    s = s + '   <tr>';
    s = s + '    <td id="c000000" bgcolor="#000000" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c330000" bgcolor="#330000" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c663300" bgcolor="#663300" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c663333" bgcolor="#663333" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c333300" bgcolor="#333300" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c003300" bgcolor="#003300" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c003333" bgcolor="#003333" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c000066" bgcolor="#000066" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c330099" bgcolor="#330099" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '    <td id="c330033" bgcolor="#330033" width="15" height="15" onclick="str=this.id;color=str.replace(\'c\',\'#\');system.getResource('+this.resourceId+').setSelectedColor(color,\''+command+'\');system.getResource('+this.resourceId+').wysiwyg_pallete.style.display=\'none\';"><img width="1" height="1" alt="" src=""></td>';
    s = s + '   </tr>';
    s = s + '  </table>';    	
    return s;
};
//------------------------- Setter & Getter ------------------------------------
window.app_builder_component_controls_wysiwyg.prototype.setColor = function(data)
{
	this.bgColor = data;
	var nd = this.getCanvas()
	nd.style.background = this.bgColor;
};
window.app_builder_component_controls_wysiwyg.prototype.getColor = function()
{
	return this.bgColor;
};
window.app_builder_component_controls_wysiwyg.prototype.block = function()
{
...
window.app_builder_component_controls_wysiwyg.prototype.setHeight = function(data)
{
	window.app_builder_component_controls_wysiwyg.prototype.parent.setHeight.call(this, data);
};
window.app_builder_component_controls_wysiwyg.prototype.unblock = function()
{
    var node = $(this.getFullId() + "_block");
...
window.app_builder_component_controls_wysiwyg.prototype.navigate = function(url)
{
	this.location = url;
	this.frame.src = url;
};
window.app_builder_component_controls_wysiwyg.prototype.getXHTML = function (data){
	return new Html2Xhtml(data).parse()
};
window.app_builder_component_controls_wysiwyg.prototype.loadCss = function(){
...
window.app_builder_component_controls_wysiwyg.prototype.rteMouseOverFormatMenu = function (event, id, resId) {	
...
window.app_builder_component_controls_wysiwyg.prototype.rteMouseDownFormatMenu = function (event, id) { 	
	try{		
...
window.app_builder_component_controls_wysiwyg.prototype.rteMouseOutFormatMenu = function(event, id) { 			
	if (id == this.getFullId() +"format1" || id == this.getFullId() +"format2"){		
...
window.app_builder_component_controls_wysiwyg.prototype.rteGetOffsetTop = function (elm) { 
...
window.app_builder_component_controls_wysiwyg.prototype.rteGetOffsetLeft = function (elm) { 
...
window.app_builder_component_controls_wysiwyg.prototype.rteHideMenus = function (event,id) { 
...
window.app_builder_component_controls_wysiwyg.prototype.rteColorClick = function (hexcolor) { 
	this.rteHideMenus(); 
	this.doTextFormat("forecolor", hexcolor); 
	$(this.getFullId() + "_fontcolor4").style.backgroundColor = hexcolor;
}; 
window.app_builder_component_controls_wysiwyg.prototype.rteMouseOverMenuContents = function (event) { 	
	var target = document.all ? event.srcElement : event.target;
	target.style.color = "#FFFFFF"; 
	target.style.backgroundColor = "#316AC5"; 	
	$(this.rteName).contentWindow.setFocus();
}; 
window.app_builder_component_controls_wysiwyg.prototype.rteMouseOutMenuContents = function (event) { 
	var target = document.all ? event.srcElement : event.target;
	target.style.color = "#000000"; 
	target.style.backgroundColor = "#FFFFFF";	
}; 
window.app_builder_component_controls_wysiwyg.prototype.rteMouseDownMenuContents = function (event) { 
...
window.app_builder_component_controls_wysiwyg.prototype.viewDesignMode = function() { 	
	try{
...
window.app_builder_component_controls_wysiwyg.prototype.viewCodeMode = function() { 
	try{		
		this.rteFormHandler(); 
...
window.app_builder_component_controls_wysiwyg.prototype.viewPreviewMode = function() { 
	try{				
		this.rteFormHandler(); 
...
window.app_builder_component_controls_wysiwyg.prototype.rteFormHandler = function () { 
...
window.app_builder_component_controls_wysiwyg.prototype.rteFormHandler2 = function () { 
	if ($(this.rteFormName).style.display == ""){ 
...
window.app_builder_component_controls_wysiwyg.prototype.rteBtnInsertImage = function () { 
	window.open(rteHTMLPathInsertImage , "blank","toolbar=no,width=300,height=220");
}; 
window.app_builder_component_controls_wysiwyg.prototype.rteBtnEditLink = function() { 
	window.open(rteHTMLPathEditLink , "blank","toolbar=no,width=250,height=300");
}; 
window.app_builder_component_controls_wysiwyg.prototype.rteBtnEditTable = function () { 
	window.open(rteHTMLPathEditTable , "blank","toolbar=no,width=320,height=210");
}; 
window.app_builder_component_controls_wysiwyg.prototype.rteBtnCreateLink = function () { 
	window.open(rteHTMLPathInsertLink , "blank","toolbar=no,width=250,height=300");
}; 
window.app_builder_component_controls_wysiwyg.prototype.rteBtnPrint = function () { 
	if (document.all){ 
...
window.app_builder_component_controls_wysiwyg.prototype.rteInsertHTML = function (html) { 
	if (document.all) { 
...
window.app_builder_component_controls_wysiwyg.prototype.rteBtnInsertForm = function() { 
	window.open(rteHTMLPathInsertForm , "blank","toolbar=no,width=320,height=180");
}; 
window.app_builder_component_controls_wysiwyg.prototype.rteBtnInsertCheckbox = function () { 
	window.open(rteHTMLPathInsertCheckbox , "blank","toolbar=no,width=320,height=150");
}; 
window.app_builder_component_controls_wysiwyg.prototype.rteBtnInsertRadio = function() { 
	window.open(rteHTMLPathInsertRadiobutton , "blank","toolbar=no,width=320,height=150");
}; 
window.app_builder_component_controls_wysiwyg.prototype.rteBtnInsertFlash = function() { 
	window.open(rteHTMLPathInsertFlash , "blank","toolbar=no,width=350,height=130");
}; 
window.app_builder_component_controls_wysiwyg.prototype.rteBtnInsertTextArea = function() { 
	window.open(rteHTMLPathInsertTextArea , "blank","toolbar=no,width=320,height=230");
}; 
window.app_builder_component_controls_wysiwyg.prototype.rteBtnInsertSubmit = function() { 
	window.open(rteHTMLPathInsertSubmit , "blank","toolbar=no,width=320,height=130");
}; 
window.app_builder_component_controls_wysiwyg.prototype.rteBtnInsertImageSubmit = function() { 
	window.open(rteHTMLPathInsertImageSubmit , "blank","toolbar=no,width=320,height=130");
}; 
window.app_builder_component_controls_wysiwyg.prototype.rteBtnInsertReset = function() { 
	window.open(rteHTMLPathInsertReset , "blank","toolbar=no,width=320,height=130");
}; 
window.app_builder_component_controls_wysiwyg.prototype.rteBtnInsertHidden = function() { 
	window.open(rteHTMLPathInsertHidden , "blank","toolbar=no,width=320,height=130");
}; 
window.app_builder_component_controls_wysiwyg.prototype.rteBtnInsertPassword = function() { 
	window.open(rteHTMLPathInsertPassword , "blank","toolbar=no,width=320,height=150");
}; 
window.app_builder_component_controls_wysiwyg.prototype.rteBtnInsertText = function() { 
	window.open(rteHTMLPathInsertText , "blank","toolbar=no,width=320,height=170");
}; 
window.app_builder_component_controls_wysiwyg.prototype.rteBtnInsertTable = function() { 
	window.open(rteHTMLPathInsertTable , "blank","toolbar=no,width=320,height=240");
}; 
window.app_builder_component_controls_wysiwyg.prototype.rteBtnInsertTableRowBefore = function() { 
...
window.app_builder_component_controls_wysiwyg.prototype.rteBtnInsertTableRowAfter = function() { 
	if (window.getSelection){ 
		var selected_obj = $(rteName).contentWindow.window.getSelection().focusNode;
	}else if (document.getSelection){ 
		var selected_obj = $(rteName).contentWindow.document.getSelection().focusNode;
...
window.app_builder_component_controls_wysiwyg.prototype.rteBtnInsertTableColumnBefore = function() {
	if (window.getSelection){ 
		var selected_obj = $(rteName).contentWindow.window.getSelection().focusNode;
	}else if (document.getSelection){ 
		var selected_obj = $(rteName).contentWindow.document.getSelection().focusNode;
...
window.app_builder_component_controls_wysiwyg.prototype.rteBtnInsertTableColumnAfter = function() { 
	if (window.getSelection){ 
		var selected_obj = $(rteName).contentWindow.window.getSelection().focusNode;
	}else if (document.getSelection){ 
		var selected_obj = $(rteName).contentWindow.document.getSelection().focusNode;
...
window.app_builder_component_controls_wysiwyg.prototype.rteBtnDeleteTableColumn = function() { 
	if (window.getSelection){ 
		var selected_obj = $(rteName).contentWindow.window.getSelection().focusNode;
	}else if (document.getSelection){ 
		var selected_obj = $(rteName).contentWindow.document.getSelection().focusNode;
...
window.app_builder_component_controls_wysiwyg.prototype.rteBtnDeleteTableRow = function () { 
	if (window.getSelection){ 
		var selected_obj = $(rteName).contentWindow.window.getSelection().focusNode;
	}else if (document.getSelection){ 
		var selected_obj = $(rteName).contentWindow.document.getSelection().focusNode;
...
window.app_builder_component_controls_wysiwyg.prototype.rteAction = function (event, id) { 	
