...
//* 			SAI, PT											
//***********************************************************************************************
window.app_builder_component_controls_slider = function(owner,options){	
	window.app_builder_component_controls_slider.prototype.parent.constructor.call(this,owner,options);	
	this.className = "portalui_slider";
	this.interval = 5000;	
	this.enabled = false;
	this.selId = -1;
	this.items = [];
	...
	this.addProperty({className:this.className, interval:this.interval, color:this.color, background:this.bgColor, enabled: this.enabled});	
	this.addEvent({itemsClick:""});
};
window.app_builder_component_controls_slider.extend(window.app_builder_component_controls_control);
window.app_builder_component_controls_slider.implement({
	...
	setHeight: function(data){
		window.app_builder_component_controls_slider.prototype.parent.setHeight.call(this,data);
