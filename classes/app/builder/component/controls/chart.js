...
//******************************************************************************
window.app_builder_component_controls_chart = function(owner,options){
    if (owner)
    {
        this.leftPadding = 40;
        ...
        window.app_builder_component_controls_chart.prototype.parent.constructor.call(this, owner,options);
    ...
    if (window.app_builder_component_controls_chart.bullets == undefined){
	   window.app_builder_component_controls_chart.bullets = new portalui_arrayList();
	   window.app_builder_component_controls_chart.colors = new portalui_arrayList();
	   window.app_builder_component_controls_chart.barLegends = new portalui_arrayList();
	   window.app_builder_component_controls_chart.bar = new portalui_arrayList();
	   window.app_builder_component_controls_chart.barColors = new portalui_arrayList();
	   var img = new Image();
	   img.src = "image/chart/line/0-trans.png";
	   if (systemAPI.browser.msie )
			img.onclick = new Function("system.getResource("+this.resourceId+").itemClick(event);");
	   else
			img.onclick = new Function("event","system.getResource("+this.resourceId+").itemClick(event);");
	   window.app_builder_component_controls_chart.bullets.add(img);
	   window.app_builder_component_controls_chart.colors.add("rgba(255, 0, 0,0.7)");
		window.app_builder_component_controls_chart.colors.add("rgba(0, 255, 0,0.7)");
		window.app_builder_component_controls_chart.colors.add("rgba(0, 0, 255,0.7)");
		window.app_builder_component_controls_chart.colors.add("rgba(255, 153, 0,0.7)");
		window.app_builder_component_controls_chart.colors.add("rgba(255, 0, 255,0.7)");
		window.app_builder_component_controls_chart.colors.add("rgba(0, 255, 255,0.7)");
		window.app_builder_component_controls_chart.colors.add("rgba(255, 255, 100,0.7)");
		window.app_builder_component_controls_chart.colors.add("rgba(70, 153, 55,0.7)");
		window.app_builder_component_controls_chart.colors.add("rgba(33, 153, 226,0.7)");		
		window.app_builder_component_controls_chart.colors.add("rgba(104, 121, 167,0.7)");
		window.app_builder_component_controls_chart.colors.add("rgba(213, 94, 100,0.7)");
		window.app_builder_component_controls_chart.colors.add("rgba(150, 114, 178,0.7)");		
		window.app_builder_component_controls_chart.colors.add("rgba(252, 16, 235,0.7)");
		window.app_builder_component_controls_chart.colors.add("rgba(120, 152, 81,0.7)");
		window.app_builder_component_controls_chart.colors.add("rgba(118, 189, 161,0.7)");
	   ...
	   if (systemAPI.browser.msie )
			...
			img.onclick = new Function("event","system.getResource("+this.resourceId+").itemClick(event);");
	   window.app_builder_component_controls_chart.barLegends.add(img);
	   ...
	   if (systemAPI.browser.msie )
			...
			img.onclick = new Function("event","system.getResource("+this.resourceId+").itemClick(event);");
	   window.app_builder_component_controls_chart.bar.add(img);
	   window.app_builder_component_controls_chart.barColors.add("rgba(153, 102, 102,0.7)");
	   ...
	   if (systemAPI.browser.msie )
			...
			img.onclick = new Function("event","system.getResource("+this.resourceId+").itemClick(event);");
	   window.app_builder_component_controls_chart.bar.add(img);
	   window.app_builder_component_controls_chart.barColors.add("rgba(102, 153, 153,0.7)");
	   ...
	   if (systemAPI.browser.msie )
			...
			img.onclick = new Function("event","system.getResource("+this.resourceId+").itemClick(event);");
	   window.app_builder_component_controls_chart.bar.add(img);
	   window.app_builder_component_controls_chart.barColors.add("rgba(51, 102, 51,0.7)");
	   ...
	   if (systemAPI.browser.msie )
			...
			img.onclick = new Function("event","system.getResource("+this.resourceId+").itemClick(event);");
	   window.app_builder_component_controls_chart.bar.add(img);
	   window.app_builder_component_controls_chart.barColors.add("rgba(153, 102, 153,0.7)");
	   ...
	   if (systemAPI.browser.msie )
			...
			img.onclick = new Function("event","system.getResource("+this.resourceId+").itemClick(event);");
	   window.app_builder_component_controls_chart.bar.add(img);
	   window.app_builder_component_controls_chart.barColors.add("rgba(153, 153, 153,0.7)");
	   ...
	   if (systemAPI.browser.msie )
			...
			img.onclick = new Function("event","system.getResource("+this.resourceId+").itemClick(event);");
	   window.app_builder_component_controls_chart.bar.add(img);
	   window.app_builder_component_controls_chart.barColors.add("rgba(62, 153, 153,0.7)");
	   ...
	   if (systemAPI.browser.msie )
			...
			img.onclick = new Function("event","system.getResource("+this.resourceId+").itemClick(event);");
	   window.app_builder_component_controls_chart.bar.add(img);
	   window.app_builder_component_controls_chart.barColors.add("rgba(151, 202, 51,0.7)");
	   ...
	   if (systemAPI.browser.msie )
			...
			img.onclick = new Function("event","system.getResource("+this.resourceId+").itemClick(event);");
	   window.app_builder_component_controls_chart.bar.add(img);
	   window.app_builder_component_controls_chart.barColors.add("rgba(53, 152, 153,0.7)");
	   ...
	   if (systemAPI.browser.msie )
			...
			img.onclick = new Function("event","system.getResource("+this.resourceId+").itemClick(event);");
	   window.app_builder_component_controls_chart.bar.add(img);
	   window.app_builder_component_controls_chart.barColors.add("rgba(13, 153, 153,0.7)");
	   ...
	   if (systemAPI.browser.msie )
			...
			img.onclick = new Function("event","system.getResource("+this.resourceId+").itemClick(event);");
	   window.app_builder_component_controls_chart.bar.add(img);
	   window.app_builder_component_controls_chart.barColors.add("rgba(13, 13, 153,0.7)");
	   ...
	   if (systemAPI.browser.msie )
			...
			img.onclick = new Function("event","system.getResource("+this.resourceId+").itemClick(event);");
	   window.app_builder_component_controls_chart.bar.add(img);
	   window.app_builder_component_controls_chart.barColors.add("rgba(123, 233, 153,0.7)");
	   ...
	   if (systemAPI.browser.msie )
			...
			img.onclick = new Function("event","system.getResource("+this.resourceId+").itemClick(event);");
	   window.app_builder_component_controls_chart.bar.add(img);
	   window.app_builder_component_controls_chart.barColors.add("rgba(145, 53, 13,0.7)");
	   ...
	   if (systemAPI.browser.msie )
			...
			img.onclick = new Function("event","system.getResource("+this.resourceId+").itemClick(event);");
	   window.app_builder_component_controls_chart.bar.add(img);
	   window.app_builder_component_controls_chart.barColors.add("rgba(13, 253, 153,0.7)");
	   ...
	   if (systemAPI.browser.msie )
			...
			img.onclick = new Function("event","system.getResource("+this.resourceId+").itemClick(event);");
	   window.app_builder_component_controls_chart.bar.add(img);
	   window.app_builder_component_controls_chart.barColors.add("rgba(253, 23, 53,0.7)");
	   ...
	   if (systemAPI.browser.msie )
			...
			img.onclick = new Function("event","system.getResource("+this.resourceId+").itemClick(event);");
	   window.app_builder_component_controls_chart.bar.add(img);
	   window.app_builder_component_controls_chart.barColors.add("rgba(253, 35, 213,0.7)");
	   ...
	   if (systemAPI.browser.msie )
			...
			img.onclick = new Function("event","system.getResource("+this.resourceId+").itemClick(event);");
	   window.app_builder_component_controls_chart.bar.add(img);
	   window.app_builder_component_controls_chart.barColors.add("rgba(150, 132, 13,0.7)");
	   ...
	   if (systemAPI.browser.msie )
			...
			img.onclick = new Function("event","system.getResource("+this.resourceId+").itemClick(event);");
	   window.app_builder_component_controls_chart.bar.add(img);
	   window.app_builder_component_controls_chart.barColors.add("rgba(175, 13, 255,0.7)");
	   ...
	   if (systemAPI.browser.msie )
			...
			img.onclick = new Function("event","system.getResource("+this.resourceId+").itemClick(event);");
	   window.app_builder_component_controls_chart.bar.add(img);
	   window.app_builder_component_controls_chart.barColors.add("rgba(230, 139, 53,0.7)");
	   ...
	   if (systemAPI.browser.msie )
			...
			img.onclick = new Function("event","system.getResource("+this.resourceId+").itemClick(event);");
	   window.app_builder_component_controls_chart.bar.add(img);
	   window.app_builder_component_controls_chart.barColors.add("rgba(215, 123, 253,0.7)");
    }
	if (options !== undefined){
		...
		this.addProperty({className:this.className,chartType:this.chartType, dataProvider:"{}",maxValue:this.maxValue, minValue:this.minValue, title:this.title, bgColor:this.bgColor, showBorder:true, leftPadding:this.leftPadding, rightPadding:this.rightPadding, bottomPadding:this.bottomPadding, animate:false, interval:1000});	
		this.addEvent({seriesClick:""});
		uses("portalui_timer");
...
window.app_builder_component_controls_chart.extend(window.app_builder_component_controls_containerControl);
//---------------------------- Function ----------------------------------------
window.app_builder_component_controls_chart.implement({
	doDraw : function(canvas){
	    var n = this.getFullId();
	    var html = "";
	    if (document.all)
	        html =  "<div id='" + n + "_shadow1' style='{position: absolute;left: 1;top: 1;width: 100%;height: 100%;border-right: 1px solid #999999;border-bottom: 1px solid #999999;}'></div>" +
	                ...
	                "<div id='" + n + "_frame' style='{position : absolute; left: 0; top: 0; width: 100%; height: 100%;background: #FFFFFF;overflow: hidden;border: 1px solid #90c2f8}'>" +
	                    ...
	                    "<div id='" + n + "_legend' style='{position : absolute; left: " + (this.width - this.rightPadding) + "; top: 25; width: " + this.rightPadding + "; height: " + (this.height - this.bottomPadding - 25) + ";overflow: auto;}'></div>" +
						"<div id='" + n + "_legendHor' style='{position : absolute; left: " + this.leftPadding + "; top: " + (this.height - this.bottomPadding) + "; width: " + (this.width - this.leftPadding - this.rightPadding) + "; height: " + this.bottomPadding + ";font-size: 6pt}'></div>" +
						"<div id='" + n + "_legendVer' style='{position : absolute; left: -2; top: 17; width: " + this.leftPadding + "; height: " + (this.height - this.bottomPadding - 25) + ";}'></div>" +
	                    "<canvas id='" + n + "_canvas' width='100' height='100' style='{position: absolute;border-left: 1px solid #d7d9ff; border-bottom: 1px solid #d7d9ff;left: 40; top: 25; width: 100; height: 100;}'></canvas>" +
	                "</div>" +
	        ...
	        html =  "<div id='" + n + "_shadow1' style='{position: absolute;left: 1;top: 1;width: 100%;height: 100%;border-right: 1px solid #999999;border-bottom: 1px solid #999999;}'></div>" +
	                ...
	                "<div id='" + n + "_frame' style='{position : absolute; left: 0; top: 0; width: 100%; height: 100%;overflow: hidden;background: #FFFFFF;border: 1px solid #90c2f8}'>" +
						...
						"<div id='" + n + "_legendHor' style='{position : absolute;left: " + this.leftPadding + "; top: " + (this.height - this.bottomPadding) + "; width: " + (this.width - this.leftPadding - this.rightPadding) + "; height: " + this.bottomPadding + ";font-size: 6pt}'></div>" +
						"<div id='" + n + "_legendVer' style='{position : absolute;left: -2; top: 17; width: " + this.leftPadding + "; height: " + (this.height - this.bottomPadding - 25) + ";}'></div>" +
						"<canvas id='" + n + "_canvas' width='" + this.canvasWidth + "' height='" + this.canvasHeight + "' style='{position: absolute;border-left: 2px solid #d7d9ff; border-bottom: 2px solid #d7d9ff;left: " + this.leftPadding + "; top: 25; width: " + (this.width - this.leftPadding - this.rightPadding) + "; height: " + (this.height - this.bottomPadding - 25) + ";}'></canvas>" +
	                "</div>" +
	                "<div id='" + n + "form' style='{position : absolute; left: 0; top: 0; width: 100%; height: 100%;}' " +
	                    "onMouseMove ='system.getResource(" + this.resourceId + ").eventMouseMove(event);' " +
						"onMouseDown ='system.getResource(" + this.resourceId + ").eventMouseClick(event);' " +
	                 "></div>";
		                ...
		                if ((x > xleft) && (x < (xleft + 10)))
		                {
		                    ...
		                    for (var ytop in list.objList)
		                    {
		                        ...
		                        if ((y > ytop) && (y < (ytop + 5)))
		                        {
									...
									system.showHint(event.clientX, event.clientY,title == undefined ? "" : title);                                                        
		                            found = true;
		                            break;
		                        }
		                    }
			            ...
			            for (j in firstSerie){
			                ...
			                if (value != undefined)
			                {
								...
								if (x >= left && x <= left + partWidth && y >= top && y <= top + partHeight){
									this.getCanvas().title = title;
									system.showHint(event.clientX, event.clientY,title);
									return true;	
								}													
			                }
					...
					for (var s in series){
						...
						{									
							...
							if (x >= x1 && x <= x2 && y>=y1&& y<=y2)
							{
								...
								system.showHint(event.clientX, event.clientY,labels[i]+":"+values[i]);
								return true;	
							}
							counter += fraction;
						}
	...
	drawLine: function(ctx, width, height){
		try{
		    ...
		    if (serLength > 0)
		    {
				...
				for (var i in series){
					img = window.app_builder_component_controls_chart.bullets.get(index % 10);						
		        ...
		        html = "<div style='position : absolute;left: 0; top: 0; width: 100%; height: auto;text-align: right;font-size: 8pt'>" + this.formatNumber(maxValue) + "</div>" +
		                "<div style='position : absolute;left: 0; top: " + parseInt(0.25 * height, 10) + "; width: 100%; height: auto;text-align: right;font-size: 8pt'>" + this.formatNumber(minValue + (0.75 * range)) + "</div>" +
		                "<div style='position : absolute;left: 0; top: " + parseInt(0.50 * height, 10) + "; width: 100%; height: auto;text-align: right;font-size: 8pt'>" + this.formatNumber(minValue + (0.50 * range)) + "</div>" +
		                "<div style='position : absolute;left: 0; top: " + parseInt(0.75 * height, 10) + "; width: 100%; height: auto;text-align: right;font-size: 8pt'>" + this.formatNumber(minValue + (0.25 * range)) + "</div>" +
		                "<div style='position : absolute;left: 0; top: " + height + "; width: 100%; height: auto;text-align: right;font-size: 8pt'>" + this.formatNumber(minValue) + "</div>";
		        ...
		        for (var i in series){
		            ...
		            first = true;
		            img = window.app_builder_component_controls_chart.bullets.get(index % 10);					
		            ctx.strokeStyle = window.app_builder_component_controls_chart.colors.get(index % 10);
					ctx.lineWidth = 4.0;						
	...
	drawBar : function(ctx, width, height){
		try
		{
		    ...
		    if (serLength > 0)
		    {
				...
				for (var i in series){					
		            img = window.app_builder_component_controls_chart.barLegends.get(index % 10);
		            html += "<div style='position: absolute;left: 0; top: " + top + "; width: 100%; height: 14;overflow: hidden;'>" +
							   "<div style='position: absolute;left: 2; top: 4; width: 14; height: 8;background: url(" + img.src + ") no-repeat top left;'></div>" +
							   "<div style='position: absolute;left: 18; top: 1; width: 100%; height: 100%;font-size: 7pt;text-align:left' >" + i + "</div>" +
							"</div>";
		            top += 14;
		            index++;
		        }				
		        ...
		        if (verDraw){
					...
					for (var i in firstSerie){
						...
						html += "<div style='position: absolute;left: " + left + "; top: "+top+"; width: " + catWidth + "; height: 100%;overflow: hidden;'>" +
			   				        "<div style='position: absolute;left: 0; top: 1; width: 100%; height: 100%;text-align: center;font-family:Arial;font-size: 6pt' >" + i + "</div>" +
		    	   				"</div>";
		                left += catWidth;
						index++;
		            }
		        ...
		        if (maxValue == -1)
		            maxValue = this.detectMaxValue();
		        var lgnHeight = parseInt(height / 4, 10);
		        html = "<div style='position: absolute;left: 0; top: 0; width: 100%; height: auto;text-align: right;font-size: 7pt'>" + this.formatNumber(maxValue) + "</div>" +
		                "<div style='position: absolute;left: 0; top: " + parseInt(0.25 * height, 10) + "; width: 100%; height: auto;text-align: right;font-size: 7pt'>" + this.formatNumber(minValue + (0.75 * range)) + "</div>" +
		                "<div style='position: absolute;left: 0; top: " + parseInt(0.50 * height, 10) + "; width: 100%; height: auto;text-align: right;font-size: 7pt'>" + this.formatNumber(minValue + (0.50 * range)) + "</div>" +
		                "<div style='position: absolute;left: 0; top: " + parseInt(0.75 * height, 10) + "; width: 100%; height: auto;text-align: right;font-size: 7pt'>" + this.formatNumber(minValue + (0.25 * range)) + "</div>" +
		                "<div style='position: absolute;left: 0; top: " + height + "; width: 100%; height: auto;text-align: right;font-size: 7pt'>" + this.formatNumber(minValue) + "</div>";
		        $(n + "_legendVer").innerHTML = html;
		        var partStart = parseInt(catWidth / 8, 10);
		        var partWidth = parseInt((catWidth - (2 * partStart)) / serLength, 10) - 3;
		        if (partWidth < 1)
		        ...
		        for (var i in series){
					...
					if (!this.useProvider) serie = serie.objList;					
		            left = leftStart;
		            img = window.app_builder_component_controls_chart.bar.get(index % 10);
		            ctx.strokeStyle = window.app_builder_component_controls_chart.barColors.get(index % 10);
		            imgBorder = window.app_builder_component_controls_chart.barLegends.get(index % 10);
		            for (var j in firstSerie){
		                value = serie[j];												
		                if (value != undefined){
		                    value = value - minValue;
		                    partHeight = parseInt(((value / range) * height));
		                    top = height - partHeight;							
							...
							ctx.drawImage(imgBorder, 0, 0, 1, 1, left + partWidth+1, top+1, 1, partHeight-1);
							ctx.drawImage(imgBorder, 0, 0, 1, 1, left + partWidth+2, top+2, 1, ( partHeight <= 1 ? partHeight-1 : partHeight-2));
		                }		                
		                left += catWidth;
		            }
		            index++;
	...
	drawPie: function(ctx, width, height){
		try{
			...
			var html = "";
			for (var i in firstSerie){										
				img = window.app_builder_component_controls_chart.colors.get(index%15);				
				html += "<div style='position: absolute;left: 0; top: " + top + "; width: 100%; height: 14;overflow: hidden;'>" +
			...
			for (var s in series){
			    ...
			    for (var i = 0; i < values.length; i++) {														
			        ...
			        context.closePath();
					context.fillStyle = window.app_builder_component_controls_chart.colors.get(i%15);
				    context.fill();	                
					counter += fraction;
			    }
				var counter = 0.0;	    				
	...
	setWidth: function(data){
			window.app_builder_component_controls_chart.prototype.parent.setWidth.call(this, data);
	...
	setHeight: function(data){
		window.app_builder_component_controls_chart.prototype.parent.setHeight.call(this, data);
	...
	setShowBorder: function(data){
		this.setProperty("showBorder",data);
	...
	setLeftPadding: function(data){
		...
		this.setProperty("leftPadding",data);
	    //if (this.isDrawn())
		{
	        var n = this.getFullId();
	...
	setRightPadding: function(data){
		...
		this.setProperty("rightPadding",data);
	    this.setWidth(this.width);
	},
	...
	setBottomPadding: function(data){
		...
		this.setProperty("bottomPadding",data);
	...
	setMaxValue: function(data){
		...
		this.setProperty("maxValue",data);
		this.maxValue = data;
	},
	...
	setMinValue: function(data){
		data = parseFloat(data);
		this.setProperty("minValue",data);
		this.minValue = data;
	},
	...
	setDataProvider: function(data){					
		this.setProperty("dataProvider",data);
