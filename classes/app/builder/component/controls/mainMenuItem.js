...
//* 			SAI, PT											
//***********************************************************************************************
window.app_builder_component_controls_mainMenuItem = function(owner, options,caption){
    if (owner){
        this.caption = caption;		
		window.app_builder_component_controls_mainMenuItem.prototype.parent.constructor.call(this, owner, options);
		window.app_builder_component_controls_mainMenuItem.prototype.parent.setHeight.call(this,20);		        
		this.className = "portalui_mainMenuItem";
        this.owner = owner;		
		this.setWidth(this.caption.length * 8);
		this.addProperty({className:this.className,caption:this.caption});	
		this.addEvent({});
    }
};
window.app_builder_component_controls_mainMenuItem.extend(window.app_builder_component_controls_control);
window.app_builder_component_controls_mainMenuItem.implement({
