...
//* 			SAI, PT											
//***********************************************************************************************
window.app_builder_component_controls_mainMenu = function(owner){
    if (owner){
        this.caption = "";
		window.app_builder_component_controls_mainMenu.prototype.parent.constructor.call(this, owner);
		window.app_builder_component_controls_mainMenu.prototype.parent.setHeight.call(this,20);		
        this.setWidth(owner.width);		
		this.setTop(0);
		this.setLeft(0);
		this.className = "portalui_mainMenu";
        this.owner = owner;
		...
		uses("portalui_mainMenuItem",true);		
    }
};
window.app_builder_component_controls_mainMenu.extend(window.app_builder_component_controls_containerControl);
window.app_builder_component_controls_mainMenu.implement({
	draw: function(canvas){
		window.app_builder_component_controls_mainMenu.prototype.parent.draw.call(this, canvas);
	...
	setHeight: function(data){
		window.app_builder_component_controls_mainMenu.prototype.parent.setHeight.call(this, data);
	},
	unblock: function(){
	    var node = $(this.getFullId() + "_block");
	    if (node != undefined)
	...
	addItem: function(item, popUp){
		try{		
			var itemObj = new portalui_mainMenuItem(this,item);		
