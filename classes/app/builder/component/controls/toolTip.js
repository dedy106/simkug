...
//* 			SAI, PT											
//***********************************************************************************************
window.app_builder_component_controls_toolTip = function(owner){
    if (owner){
        window.app_builder_component_controls_toolTip.prototype.parent.constructor.call(this, owner);
		window.app_builder_component_controls_toolTip.prototype.parent.setWidth.call(this,200);				
		this.className = "portalui_toolTip";
...
window.app_builder_component_controls_toolTip.extend(window.app_builder_component_controls_commonForm);
window.app_builder_component_controls_toolTip.implement({
