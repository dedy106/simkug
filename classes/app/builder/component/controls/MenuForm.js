...
//* 			SAI, PT											
//***********************************************************************************************
window.app_builder_component_controls_MenuForm = function(owner,options){
    if (owner){
		this.className = "app_builder_component_controls_MenuForm";
        window.app_builder_component_controls_MenuForm.prototype.parent.constructor.call(this, owner,options);        
        this.setWidth(100);
        this.setHeight(30);
...
window.app_builder_component_controls_MenuForm.extend(window.app_builder_component_controls_commonForm);
window.app_builder_component_controls_MenuForm.implement({
	...
	popUp: function(x, y, pointMode){
		try{
		    if (this.parentForm == undefined)
		    {
		        ...
		        if (!(form instanceof app_builder_component_controls_MenuForm))
	...
	doDeactivate: function(){
		window.app_builder_component_controls_MenuForm.prototype.parent.doDeactivate.call(this);
	    var app = this.getApplication();
	...
	setParentForm: function(data){
		if (data instanceof app_builder_component_controls_MenuForm)
