...
//* 			SAI, PT											
//***********************************************************************************************
window.app_builder_component_controls_pager = function(owner,options){
	if (owner){
		window.app_builder_component_controls_pager.prototype.parent.constructor.call(this, owner,options);
		this.className = "portalui_pager";
		window.app_builder_component_controls_pager.prototype.parent.setHeight.call(this, 30);
		window.app_builder_component_controls_pager.prototype.parent.setWidth.call(this, 320);		
...
window.app_builder_component_controls_pager.extend(window.app_builder_component_controls_control);
window.app_builder_component_controls_pager.implement({
	...
	setWidth: function(data){
		window.app_builder_component_controls_pager.prototype.parent.setWidth.call(this, data);	
