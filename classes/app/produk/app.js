...
//* 			SAI, PT											
//***********************************************************************************************
window.app_produk_app = function(owner){
	window.app_produk_app.prototype.parent.constructor.call(this, owner);
	this.className = "app_produk_app";
...
window.app_produk_app.extend(window.application);
window.app_produk_app.implement({
	showForm: function(){
		try
		{
			...
			this._mainForm = new app_produk_fMain(this);	
			//alert("fmain");
	...
	doKeyDown: function(charCode, buttonState, keyCode, event){
		try{			
			window.app_produk_app.prototype.parent.doKeyDown.call(this, charCode, buttonState, keyCode, event);
