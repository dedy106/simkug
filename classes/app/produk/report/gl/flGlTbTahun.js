window.app_produk_report_gl_flGlTbTahun = function(owner)
{
	if (owner)
	{
		window.app_produk_report_gl_flGlTbTahun.prototype.parent.constructor.call(this,owner);
		this.className = "app_produk_report_gl_flGlTbTahun";
		this.maximize();
...
window.app_produk_report_gl_flGlTbTahun.extend(window.childForm);
window.app_produk_report_gl_flGlTbTahun.implement({
