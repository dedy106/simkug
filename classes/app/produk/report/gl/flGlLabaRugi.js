// JavaScript Document
window.app_produk_report_gl_flGlLabaRugi = function(owner)
{
	if (owner)
	{
		window.app_produk_report_gl_flGlLabaRugi.prototype.parent.constructor.call(this,owner);
		this.className = "app_produk_report_gl_flGlLabaRugi";
		this.maximize();
...
window.app_produk_report_gl_flGlLabaRugi.extend(window.portalui_childForm);
window.app_produk_report_gl_flGlLabaRugi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_produk_gl_rptGlLabaRugi";
