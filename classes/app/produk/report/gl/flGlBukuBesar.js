window.app_produk_report_gl_flGlBukuBesar = function(owner)
{
	if (owner)
	{
		window.app_produk_report_gl_flGlBukuBesar.prototype.parent.constructor.call(this,owner);
		this.className = "app_produk_report_gl_flGlBukuBesar";
		this.maximize();
...
window.app_produk_report_gl_flGlBukuBesar.extend(window.childForm);
window.app_produk_report_gl_flGlBukuBesar.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_produk_gl_rptGlBukuBesar";
