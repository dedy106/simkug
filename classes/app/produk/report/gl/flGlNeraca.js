// JavaScript Document
window.app_produk_report_gl_flGlNeraca = function(owner)
{
	if (owner)
	{
		window.app_produk_report_gl_flGlNeraca.prototype.parent.constructor.call(this,owner);
		this.className = "app_produk_report_gl_flGlNeraca";
		this.maximize();
...
window.app_produk_report_gl_flGlNeraca.extend(window.portalui_childForm);
window.app_produk_report_gl_flGlNeraca.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_produk_gl_rptGlNeraca";
