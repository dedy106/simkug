window.app_produk_report_gl_flGlTb = function(owner)
{
	if (owner)
	{
		window.app_produk_report_gl_flGlTb.prototype.parent.constructor.call(this,owner);
		this.className = "app_produk_report_gl_flGlTb";
		this.maximize();
...
window.app_produk_report_gl_flGlTb.extend(window.childForm);
window.app_produk_report_gl_flGlTb.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_produk_gl_rptGlTb";
