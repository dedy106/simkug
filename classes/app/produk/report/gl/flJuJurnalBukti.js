// JavaScript Document
window.app_produk_report_gl_flJuJurnalBukti = function(owner)
{
	if (owner)
	{
		window.app_produk_report_gl_flJuJurnalBukti.prototype.parent.constructor.call(this,owner);
		this.className = "app_produk_report_gl_flJuJurnalBukti";
		this.maximize();
...
window.app_produk_report_gl_flJuJurnalBukti.extend(window.portalui_childForm);
window.app_produk_report_gl_flJuJurnalBukti.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			this.nama_report="server_report_produk_gl_rptJuJurnalBukti";
