// JavaScript Document
window.app_produk_report_gl_flGlNeracaTahun = function(owner)
{
	if (owner)
	{
		window.app_produk_report_gl_flGlNeracaTahun.prototype.parent.constructor.call(this,owner);
		this.className = "app_produk_report_gl_flGlNeracaTahun";
		this.maximize();
...
window.app_produk_report_gl_flGlNeracaTahun.extend(window.portalui_childForm);
window.app_produk_report_gl_flGlNeracaTahun.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report="server_report_produk_gl_rptGlNeracaTahun";
