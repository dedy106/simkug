window.app_saku3_report_tm_flPiutangKartu = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tm_flPiutangKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tm_flPiutangKartu";
		this.maximize();
...
window.app_saku3_report_tm_flPiutangKartu.extend(window.childForm);
window.app_saku3_report_tm_flPiutangKartu.implement({
		...
		try{			
			...
			if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Bukti",this.sg1, this.sg1.row, this.sg1.col,
												...
												new Array("a.no_piutang","b.keterangan"),"and",new Array("No Invoice","Keterangan"));
			}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_saku3_tm_rptPiutangKartu";
			...
			systemAPI.alert("[app_saku3_report_tm_flPiutangKartu]::mainButtonClick:"+e);
		}
	},
