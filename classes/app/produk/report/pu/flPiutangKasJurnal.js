window.app_saku3_report_tm_flPiutangKasJurnal = function(owner)
{
	if (owner)
	{
		window.app_saku3_report_tm_flPiutangKasJurnal.prototype.parent.constructor.call(this,owner);
		this.className = "app_saku3_report_tm_flPiutangKasJurnal";
		this.maximize();
...
window.app_saku3_report_tm_flPiutangKasJurnal.extend(window.childForm);
window.app_saku3_report_tm_flPiutangKasJurnal.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			if (sender === this.app._mainForm.bClear2)
			{
				...
				this.nama_report = "server_report_saku3_tm_rptPiutangKasJurnal";
			...
			systemAPI.alert("[app_saku3_report_tm_flPiutangKasJurnal]::mainButtonClick:"+e);
		}
	},
