...
window.app_saku3_report_tm_flPiutangAging.implement({
		...
		try{			
			...
			if (row ==3)
			{
				...
				this.filterRep.ListDataSGFilter(this, "Data Invoice",this.sg1, this.sg1.row, this.sg1.col,
												...
												"select count(b.no_piutang) from piutang_m a "+filter,
												new Array("b.no_piutang","b.keterangan"),"and",new Array("No Invoice","Keterangan"));
			}
	...
	{		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3],["123","123","123","123","3"]);
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.filter2 =this.sg1.getCellDateValue(2,4);
