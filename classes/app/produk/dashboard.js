window.app_produk_dashboard = function(owner,options)
{
	if (owner)
	{
		window.app_produk_dashboard.prototype.parent.constructor.call(this,owner,options);
		this.className  = "app_produk_dashboard";
		...
		try {
			...
			uses("frame;feed;timer;util_ajaxPush;app_saku2_transaksi_kopeg_tiket_fTiketAjuD;saiMemo");	
			...
			this.pg1 = new pageControl(this,{bound:[0,0,this.width, this.height], childPage:["Dashboard","Konten","Ticketing","Chat","Messaging"], pageChange:[this,"doPageChange"]});
...
window.app_produk_dashboard.extend(window.panel);
window.app_produk_dashboard.implement({
	...
	setWidth: function(data){
		window.app_produk_dashboard.prototype.parent.setWidth.call(this,data);
		if (this.pg1){
