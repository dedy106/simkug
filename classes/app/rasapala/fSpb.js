window.app_rasapala_fSpb = function(owner)
{
	if (owner)
	{
		window.app_rasapala_fSpb.prototype.parent.constructor.call(this,owner);
		this.className  = "app_rasapala_fSpb";
		this.itemsValue = new portalui_arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Akru Hutang Apotek: Input", 0);	
		...
		this.e_tambah = new portalui_saiLabelEdit(this,{bound:[720,16,200,20],caption:"Nilai Bruto",tipeText:ttNilai,readOnly: true, tag:1,change:[this,"doChange"]});
		...
		this.e_spp = new portalui_saiLabelEdit(this,{bound:[720,18,200,20],caption:"Nilai Net Hutang",tipeText:ttNilai,readOnly: true, tag:1,text:"0"});
		...
		this.sg2 = new portalui_saiGrid(this.p2,{bound:[0,20,895,200],colCount:8,tag:1,
					...
					picklist:[[3,7],[new portalui_arrayMap({items:["D","C"]}),new portalui_arrayMap({items:["BAYAR","KOREKSI","RETUR","NON"]})]],ellipsClick:[this,"doEllipseClick2"],checkItem:true,
...
window.app_rasapala_fSpb.extend(window.portalui_childForm);
window.app_rasapala_fSpb.implement({
		...
		try{
			switch(col){
				case 2 : 
					...
					break;
				case 7 :
						if (this.sg2.getCell(7,row) == "") this.sg2.setCell(7,row,"NON");
					break;
			}
		}catch(e)
		{
