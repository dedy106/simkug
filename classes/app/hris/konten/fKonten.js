window.app_hris_konten_fKonten = function(owner)
{
	if (owner)
	{
		window.app_hris_konten_fKonten.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hris_konten_fKonten";
...
window.app_hris_konten_fKonten.extend(window.childForm);
window.app_hris_konten_fKonten.implement({
