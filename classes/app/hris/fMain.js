...
//* 			SAI, PT											
//***********************************************************************************************
window.app_hris_fMain = function(owner)
{
	if (owner)
	{	
		try
		{
			window.app_hris_fMain.prototype.parent.constructor.call(this, owner);			
			...
			this.bCancel = new imageButton(this.pTool,{bound:[325,5,17,15],hint:"Logout",image:"icon/"+system.getThemes()+"/bCancel2.png",click:[this,"doClose"]});
...
//----------------------------------------------------------------- tree View-----------------------------------						
			this.treev = new treeView(this,{bound:[10,95,300,this.height - 150],childLength:500,dblClick:[this,"treeClick"]});			
//------------------------------------------------
...
//--------------------------------------------------
			...
			else this.setImage("url(image/themes/"+system.getThemes()+"/gratika.gif)");
...
window.app_hris_fMain.extend(window.form);
window.app_hris_fMain.implement({
	gotoLogin: function(){
		uses("app_hris_fLogin");
		this.form = new app_hris_fLogin(this);
	...
	initDashboard: function(){		
		uses("saiCBBL;saiEdit;saiGrid;;util_ajaxCaller;sgNavigator;pageControl;app_hris_dashboard;fileExplorer;listView;util_file;PopUpMenu;MenuItem;app_hris_remote_dataProvider");
		this.dashboard = new app_hris_dashboard(this,{bound:[this.treev.width + 20, this.treev.top, this.width - this.treev.width - 30, this.treev.height]});		
	},
