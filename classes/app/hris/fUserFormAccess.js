window.app_assetsap_fUserFormAccess = function(owner)
{
	if (owner)
	{
		window.app_assetsap_fUserFormAccess.prototype.parent.constructor.call(this,owner);
		this.className  = "app_assetsap_fUserFormAccess";
		this.maximize();
...
window.app_assetsap_fUserFormAccess.extend(window.portalui_childForm);
window.app_assetsap_fUserFormAccess.implement({
