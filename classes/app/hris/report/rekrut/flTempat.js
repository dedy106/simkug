window.app_hris_report_rekrut_flTempat = function(owner)
{
	if (owner)
	{
		window.app_hris_report_rekrut_flTempat.prototype.parent.constructor.call(this,owner);
		this.className = "app_hris_report_rekrut_flTempat";
		this.maximize();
...
window.app_hris_report_rekrut_flTempat.extend(window.childForm);
window.app_hris_report_rekrut_flTempat.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_hris_report_rekrut_flTempat]::mainButtonClick:"+e);
		}
	},
