window.app_hris_report_rekrut_flPelamar = function(owner)
{
	if (owner)
	{
		window.app_hris_report_rekrut_flPelamar.prototype.parent.constructor.call(this,owner);
		this.className = "app_hris_report_rekrut_flPelamar";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,6,[0,1,2],["Jenis Laporan","=","Pelamar"]);	
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_hris_report_rekrut_flPelamar.extend(window.childForm);
window.app_hris_report_rekrut_flPelamar.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				if (this.sg1.getCell(2,6)=="Pelamar")
				{
			...
			systemAPI.alert("[app_hris_report_rekrut_flPelamar]::mainButtonClick:"+e);
		}
	},
