window.app_hris_report_kesehatan_flKlaimUser = function(owner)
{
	if (owner)
	{
		window.app_hris_report_kesehatan_flKlaimUser.prototype.parent.constructor.call(this,owner);
		this.className = "app_hris_report_kesehatan_flKlaimUser";
		this.maximize();
...
window.app_hris_report_kesehatan_flKlaimUser.extend(window.childForm);
window.app_hris_report_kesehatan_flKlaimUser.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_hris_report_kesehatan_flKlaimUser]::mainButtonClick:"+e);
		}
	},
