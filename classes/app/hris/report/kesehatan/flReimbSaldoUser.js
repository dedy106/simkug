window.app_hris_report_kesehatan_flReimbSaldoUser = function(owner)
{
	if (owner)
	{
		window.app_hris_report_kesehatan_flReimbSaldoUser.prototype.parent.constructor.call(this,owner);
		this.className = "app_hris_report_kesehatan_flReimbSaldoUser";
		this.maximize();
...
window.app_hris_report_kesehatan_flReimbSaldoUser.extend(window.childForm);
window.app_hris_report_kesehatan_flReimbSaldoUser.implement({
	...
	doSelectCell: function(sender, col, row){		
		...
		this.filterRep.setSGFilterRowButtonStyle(this.sg1, row,[0,1],[0,3]);
