window.app_hris_report_kesehatan_flPosReimb = function(owner)
{
	if (owner)
	{
		window.app_hris_report_kesehatan_flPosReimb.prototype.parent.constructor.call(this,owner);
		this.className = "app_hris_report_kesehatan_flPosReimb";
		this.maximize();
...
window.app_hris_report_kesehatan_flPosReimb.extend(window.childForm);
window.app_hris_report_kesehatan_flPosReimb.implement({
