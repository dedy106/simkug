window.app_hris_report_kesehatan_flReimbKartu = function(owner)
{
	if (owner)
	{
		window.app_hris_report_kesehatan_flReimbKartu.prototype.parent.constructor.call(this,owner);
		this.className = "app_hris_report_kesehatan_flReimbKartu";
		this.maximize();
...
window.app_hris_report_kesehatan_flReimbKartu.extend(window.childForm);
window.app_hris_report_kesehatan_flReimbKartu.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_hris_rptReimbKartu";
