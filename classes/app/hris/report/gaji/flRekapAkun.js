window.app_hris_report_gaji_flRekapAkun = function(owner)
{
	if (owner)
	{
		window.app_hris_report_gaji_flRekapAkun.prototype.parent.constructor.call(this,owner);
		this.className = "app_hris_report_gaji_flRekapAkun";
		this.maximize();
...
window.app_hris_report_gaji_flRekapAkun.extend(window.childForm);
window.app_hris_report_gaji_flRekapAkun.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_hris_report_gaji_flRekapAkun]::mainButtonClick:"+e);
		}
	},
	initColumn: function(){
		try{		
