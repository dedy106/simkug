window.app_hris_report_gaji_flPph2 = function(owner)
{
	if (owner)
	{
		window.app_hris_report_gaji_flPph2.prototype.parent.constructor.call(this,owner);
		this.className = "app_hris_report_gaji_flPph2";
		this.maximize();
...
window.app_hris_report_gaji_flPph2.extend(window.childForm);
window.app_hris_report_gaji_flPph2.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.filter2 = this.sg1.getCell(2,1)+"/"+this.filterRep.filterStr("a.sts_sdm",this.sg1.getCell(1,2),this.sg1.getCell(2,2),this.sg1.getCell(3,2),"and");
					this.showFilter = this.filterRep.showFilter(this.sg1);
					var result  = new arrayMap();		
					this.lokasi=this.app._namalokasi;
					this.nama_report = "server_report_hris_rptGajiPph";
