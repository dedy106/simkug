window.app_hris_report_gaji_flDplk2 = function(owner)
{
	if (owner)
	{
		window.app_hris_report_gaji_flDplk2.prototype.parent.constructor.call(this,owner);
		this.className = "app_hris_report_gaji_flDplk2";
		this.maximize();
...
window.app_hris_report_gaji_flDplk2.extend(window.childForm);
window.app_hris_report_gaji_flDplk2.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_hris_rptGajiDplk";
