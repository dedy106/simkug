window.app_hris_report_gaji_flRekapGaji2 = function(owner)
{
	if (owner)
	{
		window.app_hris_report_gaji_flRekapGaji2.prototype.parent.constructor.call(this,owner);
		this.className = "app_hris_report_gaji_flRekapGaji2";
		this.maximize();
...
window.app_hris_report_gaji_flRekapGaji2.extend(window.childForm);
window.app_hris_report_gaji_flRekapGaji2.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_hris_rptGajiRekap";
