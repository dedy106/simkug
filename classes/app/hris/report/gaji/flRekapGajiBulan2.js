window.app_hris_report_gaji_flRekapGajiBulan2 = function(owner)
{
	if (owner)
	{
		window.app_hris_report_gaji_flRekapGajiBulan2.prototype.parent.constructor.call(this,owner);
		this.className = "app_hris_report_gaji_flRekapGajiBulan2";
		this.maximize();
...
window.app_hris_report_gaji_flRekapGajiBulan2.extend(window.childForm);
window.app_hris_report_gaji_flRekapGajiBulan2.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_hris_rptGajiRekapBulan";
