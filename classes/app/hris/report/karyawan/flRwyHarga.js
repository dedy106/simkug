window.app_hris_report_karyawan_flRwyHarga = function(owner)
{
	if (owner)
	{
		window.app_hris_report_karyawan_flRwyHarga.prototype.parent.constructor.call(this,owner);
		this.className = "app_hris_report_karyawan_flRwyHarga";
		this.maximize();
...
window.app_hris_report_karyawan_flRwyHarga.extend(window.childForm);
window.app_hris_report_karyawan_flRwyHarga.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_hris_report_karyawan_flRwyHarga]::mainButtonClick:"+e);
		}
	},
