window.app_hris_report_karyawan_flMasaKerja2 = function(owner)
{
	if (owner)
	{
		window.app_hris_report_karyawan_flMasaKerja2.prototype.parent.constructor.call(this,owner);
		this.className = "app_hris_report_karyawan_flMasaKerja2";
		this.maximize();
...
window.app_hris_report_karyawan_flMasaKerja2.extend(window.childForm);
window.app_hris_report_karyawan_flMasaKerja2.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_hris_report_karyawan_flMasaKerja2]::mainButtonClick:"+e);
		}
	},
