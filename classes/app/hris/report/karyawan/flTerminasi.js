window.app_hris_report_karyawan_flTerminasi = function(owner)
{
	if (owner)
	{
		window.app_hris_report_karyawan_flTerminasi.prototype.parent.constructor.call(this,owner);
		this.className = "app_hris_report_karyawan_flTerminasi";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Promosi", 2);
...
window.app_hris_report_karyawan_flTerminasi.extend(window.childForm);
window.app_hris_report_karyawan_flTerminasi.implement({
		...
		try
		{
			...
			else
			{
		    	...
		    	this.filter = this.filterRep.filterStr("b.kode_lokasi","=",this.app._lokasi,this.app._lokasi,"where")+
							...
							this.filterRep.filterStr("a.flag_form","=","TERMINASI","TERMINASI","and");;
			...
			systemAPI.alert("[app_hris_report_karyawan_flTerminasi]::mainButtonClick:"+e);
		}
	},
