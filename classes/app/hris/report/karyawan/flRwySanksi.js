window.app_hris_report_karyawan_flRwySanksi = function(owner)
{
	if (owner)
	{
		window.app_hris_report_karyawan_flRwySanksi.prototype.parent.constructor.call(this,owner);
		this.className = "app_hris_report_karyawan_flRwySanksi";
		this.maximize();
...
window.app_hris_report_karyawan_flRwySanksi.extend(window.childForm);
window.app_hris_report_karyawan_flRwySanksi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_hris_report_karyawan_flRwySanksi]::mainButtonClick:"+e);
		}
	},
