window.app_hris_report_karyawan_flSk = function(owner)
{
	if (owner)
	{
		window.app_hris_report_karyawan_flSk.prototype.parent.constructor.call(this,owner);
		this.className = "app_hris_report_karyawan_flSk";
		this.maximize();
...
window.app_hris_report_karyawan_flSk.extend(window.childForm);
window.app_hris_report_karyawan_flSk.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_hris_report_karyawan_flSk]::mainButtonClick:"+e);
		}
	},
