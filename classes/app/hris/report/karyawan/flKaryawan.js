window.app_hris_report_karyawan_flKaryawan = function(owner)
{
	if (owner)
	{
		window.app_hris_report_karyawan_flKaryawan.prototype.parent.constructor.call(this,owner);
		this.className = "app_hris_report_karyawan_flKaryawan";
		this.maximize();
...
window.app_hris_report_karyawan_flKaryawan.extend(window.childForm);
window.app_hris_report_karyawan_flKaryawan.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				{
					this.nama_report = "server_report_hris_rptKaryawan";
			...
			systemAPI.alert("[app_hris_report_karyawan_flKaryawan]::mainButtonClick:"+e);
		}
	},
