window.app_hris_report_karyawan_flPromosi = function(owner)
{
	if (owner)
	{
		window.app_hris_report_karyawan_flPromosi.prototype.parent.constructor.call(this,owner);
		this.className = "app_hris_report_karyawan_flPromosi";
		this.maximize();
...
window.app_hris_report_karyawan_flPromosi.extend(window.childForm);
window.app_hris_report_karyawan_flPromosi.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_hris_report_karyawan_flPromosi]::mainButtonClick:"+e);
		}
	},
