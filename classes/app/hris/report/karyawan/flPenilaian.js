window.app_hris_report_karyawan_flPenilaian = function(owner)
{
	if (owner)
	{
		window.app_hris_report_karyawan_flPenilaian.prototype.parent.constructor.call(this,owner);
		this.className = "app_hris_report_karyawan_flPenilaian";
		this.maximize();
...
window.app_hris_report_karyawan_flPenilaian.extend(window.childForm);
window.app_hris_report_karyawan_flPenilaian.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				{
					this.nama_report = "server_report_hris_rptPenilaian";
			...
			systemAPI.alert("[app_hris_report_karyawan_flPenilaian]::mainButtonClick:"+e);
		}
	},
