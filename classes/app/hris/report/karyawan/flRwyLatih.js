window.app_hris_report_karyawan_flRwyLatih = function(owner)
{
	if (owner)
	{
		window.app_hris_report_karyawan_flRwyLatih.prototype.parent.constructor.call(this,owner);
		this.className = "app_hris_report_karyawan_flRwyLatih";
		this.maximize();
...
window.app_hris_report_karyawan_flRwyLatih.extend(window.childForm);
window.app_hris_report_karyawan_flRwyLatih.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			systemAPI.alert("[app_hris_report_karyawan_flRwyLatih]::mainButtonClick:"+e);
		}
	},
