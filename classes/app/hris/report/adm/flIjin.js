window.app_hris_report_adm_flIjin = function(owner)
{
	if (owner)
	{
		window.app_hris_report_adm_flIjin.prototype.parent.constructor.call(this,owner);
		this.className = "app_hris_report_adm_flIjin";
		this.maximize();
...
window.app_hris_report_adm_flIjin.extend(window.portalui_childForm);
window.app_hris_report_adm_flIjin.prototype.doEllipseClick= function(sender, col, row)
{
...
window.app_hris_report_adm_flIjin.prototype.doSelectCell = function(sender, col, row)
{
	if (this.app._userStatus=="A")
	{
...
window.app_hris_report_adm_flIjin.prototype.mainButtonClick = function(sender)
{
	try
	{
	...
	{
		alert("[app_hris_report_adm_flIjin]::mainButtonClick:"+e);
	}
};
window.app_hris_report_adm_flIjin.prototype.doRequestReady = function(sender, methodName, result)
{
...
window.app_hris_report_adm_flIjin.prototype.getStringHeader = function(){
...
window.app_hris_report_adm_flIjin.prototype.doConfirmClick = function(sender){
	try{
...
window.app_hris_report_adm_flIjin.prototype.doSelectedPage = function(sender, page)
{
	this.viewer.useIframe(this.report.previewWithHeader(this.nama_report,this.filter, this.page,  this.pager, this.showFilter, this.lokasi,this.filter2));
	this.page = page;
	this.allBtn = false;
};
window.app_hris_report_adm_flIjin.prototype.previewReport = function(dthtml)
{
...
window.app_hris_report_adm_flIjin.prototype.doCloseReportClick = function(sender)
{
...
window.app_hris_report_adm_flIjin.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_hris_report_adm_flIjin.prototype.doRowPerPageChange = function(sender, rowperpage)
{
