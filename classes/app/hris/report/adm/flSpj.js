window.app_hris_report_adm_flSpj = function(owner)
{
	if (owner)
	{
		window.app_hris_report_adm_flSpj.prototype.parent.constructor.call(this,owner);
		this.className = "app_hris_report_adm_flSpj";
		this.maximize();
...
window.app_hris_report_adm_flSpj.extend(window.portalui_childForm);
window.app_hris_report_adm_flSpj.prototype.doEllipseClick= function(sender, col, row)
{
...
window.app_hris_report_adm_flSpj.prototype.doSelectCell = function(sender, col, row)
{
...
window.app_hris_report_adm_flSpj.prototype.mainButtonClick = function(sender)
{
	try
	{
	...
	{
		alert("[app_hris_report_adm_flSpj]::mainButtonClick:"+e);
	}
};
window.app_hris_report_adm_flSpj.prototype.doRequestReady = function(sender, methodName, result)
{
...
window.app_hris_report_adm_flSpj.prototype.getStringHeader = function(){
...
window.app_hris_report_adm_flSpj.prototype.doConfirmClick = function(sender){
	try{
...
window.app_hris_report_adm_flSpj.prototype.doSelectedPage = function(sender, page)
{
	this.viewer.useIframe(this.report.previewWithHeader(this.nama_report,this.filter, this.page,  this.pager, this.showFilter, this.lokasi,this.filter2));
	this.page = page;
	this.allBtn = false;
};
window.app_hris_report_adm_flSpj.prototype.previewReport = function(dthtml)
{
...
window.app_hris_report_adm_flSpj.prototype.doCloseReportClick = function(sender)
{
...
window.app_hris_report_adm_flSpj.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_hris_report_adm_flSpj.prototype.doRowPerPageChange = function(sender, rowperpage)
{
