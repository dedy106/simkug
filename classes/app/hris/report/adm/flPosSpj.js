window.app_hris_report_adm_flPosSpj = function(owner)
{
	if (owner)
	{
		window.app_hris_report_adm_flPosSpj.prototype.parent.constructor.call(this,owner);
		this.className = "app_hris_report_adm_flPosSpj";
		this.maximize();
...
window.app_hris_report_adm_flPosSpj.extend(window.childForm);
window.app_hris_report_adm_flPosSpj.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_hris_rptPosSpj";
