window.app_hris_report_adm_flPosIjin = function(owner)
{
	if (owner)
	{
		window.app_hris_report_adm_flPosIjin.prototype.parent.constructor.call(this,owner);
		this.className = "app_hris_report_adm_flPosIjin";
		this.maximize();
...
window.app_hris_report_adm_flPosIjin.extend(window.childForm);
window.app_hris_report_adm_flPosIjin.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_hris_rptPosIjin";
