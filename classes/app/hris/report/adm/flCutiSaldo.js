window.app_hris_report_adm_flCutiSaldo = function(owner)
{
	if (owner)
	{
		window.app_hris_report_adm_flCutiSaldo.prototype.parent.constructor.call(this,owner);
		this.className = "app_hris_report_adm_flCutiSaldo";
		this.maximize();
...
window.app_hris_report_adm_flCutiSaldo.extend(window.childForm);
window.app_hris_report_adm_flCutiSaldo.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_hris_rptCutiSaldo";
		...
		{
			alert("[app_hris_report_adm_flCutiSaldo]::mainButtonClick:"+e);
		}
	},
