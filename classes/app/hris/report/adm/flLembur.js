window.app_hris_report_adm_flLembur = function(owner)
{
	if (owner)
	{
		window.app_hris_report_adm_flLembur.prototype.parent.constructor.call(this,owner);
		this.className = "app_hris_report_adm_flLembur";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan Lembur", 2);
...
window.app_hris_report_adm_flLembur.extend(window.portalui_childForm);
window.app_hris_report_adm_flLembur.prototype.doEllipseClick= function(sender, col, row)
{
...
window.app_hris_report_adm_flLembur.prototype.doSelectCell = function(sender, col, row)
{
	if (this.app._userStatus=="A")
	{
...
window.app_hris_report_adm_flLembur.prototype.mainButtonClick = function(sender)
{
	try
	{
	...
	{
		alert("[app_hris_report_adm_flLembur]::mainButtonClick:"+e);
	}
};
window.app_hris_report_adm_flLembur.prototype.doRequestReady = function(sender, methodName, result)
{
...
window.app_hris_report_adm_flLembur.prototype.getStringHeader = function(){
...
window.app_hris_report_adm_flLembur.prototype.doConfirmClick = function(sender){
	try{
...
window.app_hris_report_adm_flLembur.prototype.doSelectedPage = function(sender, page)
{
	this.viewer.useIframe(this.report.previewWithHeader(this.nama_report,this.filter, this.page,  this.pager, this.showFilter, this.lokasi,this.filter2));
	this.page = page;
	this.allBtn = false;
};
window.app_hris_report_adm_flLembur.prototype.previewReport = function(dthtml)
{
...
window.app_hris_report_adm_flLembur.prototype.doCloseReportClick = function(sender)
{
...
window.app_hris_report_adm_flLembur.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_hris_report_adm_flLembur.prototype.doRowPerPageChange = function(sender, rowperpage)
{
