window.app_hris_report_adm_flPosSurat = function(owner)
{
	if (owner)
	{
		window.app_hris_report_adm_flPosSurat.prototype.parent.constructor.call(this,owner);
		this.className = "app_hris_report_adm_flPosSurat";
		this.maximize();
...
window.app_hris_report_adm_flPosSurat.extend(window.childForm);
window.app_hris_report_adm_flPosSurat.implement({
		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					this.nama_report = "server_report_hris_rptPosSurat";
