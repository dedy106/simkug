window.app_hris_report_adm_flAbsen = function(owner)
{
	if (owner)
	{
		window.app_hris_report_adm_flAbsen.prototype.parent.constructor.call(this,owner);
		this.className = "app_hris_report_adm_flAbsen";
		this.maximize();
...
window.app_hris_report_adm_flAbsen.extend(window.portalui_childForm);
window.app_hris_report_adm_flAbsen.prototype.doEllipseClick= function(sender, col, row)
{
...
window.app_hris_report_adm_flAbsen.prototype.doSelectCell = function(sender, col, row)
{
	if (this.app._userStatus=="A")
	{
...
window.app_hris_report_adm_flAbsen.prototype.mainButtonClick = function(sender)
{
	try
	{
	...
	{
		alert("[app_hris_report_adm_flAbsen]::mainButtonClick:"+e);
	}
};
window.app_hris_report_adm_flAbsen.prototype.doRequestReady = function(sender, methodName, result)
{
...
window.app_hris_report_adm_flAbsen.prototype.getStringHeader = function(){
...
window.app_hris_report_adm_flAbsen.prototype.doConfirmClick = function(sender){
	try{
...
window.app_hris_report_adm_flAbsen.prototype.doSelectedPage = function(sender, page)
{
	this.viewer.useIframe(this.report.previewWithHeader(this.nama_report,this.filter, this.page,  this.pager, this.showFilter, this.lokasi,this.filter2));
	this.page = page;
	this.allBtn = false;
};
window.app_hris_report_adm_flAbsen.prototype.previewReport = function(dthtml)
{
...
window.app_hris_report_adm_flAbsen.prototype.doCloseReportClick = function(sender)
{
...
window.app_hris_report_adm_flAbsen.prototype.sg1onChange = function(sender, col , row)
{
    if (col==1)
	{
...
window.app_hris_report_adm_flAbsen.prototype.doRowPerPageChange = function(sender, rowperpage)
{
