window.app_hris_master_fKlpLokerDetail = function(owner,modul)
{
	if (owner)
	{
		window.app_hris_master_fKlpLokerDetail.prototype.parent.constructor.call(this, owner);
		window.app_hris_master_fKlpLokerDetail.prototype.parent.setWidth.call(this, 300);
		window.app_hris_master_fKlpLokerDetail.prototype.parent.setHeight.call(this, 400);
		
		this.centerize();
		
		this.className = "app_hris_master_fKlpLokerDetail";
...
window.app_hris_master_fKlpLokerDetail.extend(window.commonForm);
window.app_hris_master_fKlpLokerDetail.implement({
	...
	doSysMouseDown: function(x, y, button, buttonState){	
		window.app_hris_master_fKlpLokerDetail.prototype.parent.doSysMouseDown.call(this,x, y, button, buttonState);
	},
	doSysMouseUp: function(x, y, button, buttonState){	
		window.app_hris_master_fKlpLokerDetail.prototype.parent.doSysMouseUp.call(this,x, y, button, buttonState);
	},
	doSysMouseMove: function(x, y, button, buttonState){
		window.app_hris_master_fKlpLokerDetail.prototype.parent.doSysMouseMove.call(this,x, y, button, buttonState);
		if (this.isClick)
		{		
