window.app_hris_master_fSpro = function(owner)
{
	if (owner)
	{
		window.app_hris_master_fSpro.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hris_master_fSpro";
...
window.app_hris_master_fSpro.extend(window.childForm);
window.app_hris_master_fSpro.implement({
