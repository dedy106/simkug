window.app_hris_master_adm_fUHarian = function(owner)
{
	if (owner)
	{
		window.app_hris_master_adm_fUHarian.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hris_master_adm_fUHarian";
		...
		this.p1 = new panel(this,{bound:[10,23,500,433],caption:"Daftar Tarif Uang Harian per Grade"});
...
window.app_hris_master_adm_fUHarian.extend(window.childForm);
window.app_hris_master_adm_fUHarian.implement({
					...
					if (this.sg.getRowValidCount() > 0){
						for (var i=0;i < this.sg.getRowCount();i++){
							if (this.sg.rowValid(i)){
								sql.add("insert into gr_spj_harian(sts_spj,kode_grade,kode_lokasi,nilai) values "+
		...
		try{
			if (this.cb_kode.getText() != ""){
				var data = this.dbLib.getDataProvider(
				            ...
				            "from gr_spj_harian a inner join gr_grade b on a.kode_grade=b.kode_grade and a.kode_lokasi=b.kode_lokasi where a.sts_spj='"+this.cb_kode.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"'",true);
