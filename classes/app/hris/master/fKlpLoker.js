window.app_hris_master_fKlpLoker = function(owner)
{
	if (owner)
	{
		window.app_hris_master_fKlpLoker.prototype.parent.constructor.call(this, owner);
		this.className = "app_hris_master_fKlpLoker";
...
window.app_hris_master_fKlpLoker.extend(window.portalui_childForm);
window.app_hris_master_fKlpLoker.prototype.mainButtonClick = function(sender)
{
...
window.app_hris_master_fKlpLoker.prototype.doRequestReady = function(sender, methodName, result)
{
	switch (methodName)
	{
		case "listData" : 
...
window.app_hris_master_fKlpLoker.prototype.doModalResult = function(event, modalResult, value)
{
	try
	{
		switch (event)
...
window.app_hris_master_fKlpLoker.prototype.loadMenu = function(daftarNrc)
{
	try
	{
...
window.app_hris_master_fKlpLoker.prototype.doClick = function(sender)
{
...
window.app_hris_master_fKlpLoker.prototype.getDataAkun= function(node){
		var result = "";
		var child = undefined;
...
window.app_hris_master_fKlpLoker.prototype.entriesClick = function(sender)
{
	try
	{ 
		...
		}else
		{
			if (sender == this.addBtn || sender == this.editBtn){
				uses("app_hris_master_fKlpLokerDetail",true);
				if (this.entryMenu == undefined)
					this.entryMenu = new app_hris_master_fKlpLokerDetail(this.app);
...
window.app_hris_master_fKlpLoker.prototype.treeClick = function(item)
{
};
window.app_hris_master_fKlpLoker.prototype.getTreeData = function(node)
{
	var result = "";
	var child = undefined;
	if (node instanceof portalui_treeView)
...
window.app_hris_master_fKlpLoker.prototype.getSummary = function(node)
{
	var result = "";
	var child = undefined;
	if (node instanceof portalui_treeView)
...
window.app_hris_master_fKlpLoker.prototype.doFindLokasi = function(sender)
{
...
window.app_hris_master_fKlpLoker.prototype.doFindKlp = function(sender)
{
...
window.app_hris_master_fKlpLoker.prototype.copyChilds = function(from, to)
{
	var temp = undefined;
...
window.app_hris_master_fKlpLoker.prototype.switchItem = function(from, to)
{
...
window.app_hris_master_fKlpLoker.prototype.moveItem = function(item, owner)
{	
