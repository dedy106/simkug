window.app_hris_master_fOtorisasi = function(owner)
{
	if (owner)
	{
		window.app_hris_master_fOtorisasi.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hris_master_fOtorisasi";
		...
		this.cb_kode = new saiCBBL(this,{bound:[20,9,200,20],caption:"Otorisasi", multiSelection:false, maxLength:10, tag:1,change:[this,"doChange"]});		
		this.p1 = new panel(this,{bound:[20,23,580,303],caption:"Data Karyawan"});
		this.sg = new saiGrid(this.p1,{bound:[1,20,575,250],colCount:2,tag:0,
		            colTitle:["NIK","Nama"],
					colWidth:[[1,0],[400,70]],
...
window.app_hris_master_fOtorisasi.extend(window.childForm);
window.app_hris_master_fOtorisasi.implement({
