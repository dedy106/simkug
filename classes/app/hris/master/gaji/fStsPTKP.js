window.app_hris_master_gaji_fStsPTKP = function(owner)
{
	if (owner)
	{
		window.app_hris_master_gaji_fStsPTKP.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hris_master_gaji_fStsPTKP";
...
window.app_hris_master_gaji_fStsPTKP.extend(window.childForm);
window.app_hris_master_gaji_fStsPTKP.implement({
