window.app_hris_master_gaji_fLembur = function(owner)
{
	if (owner)
	{
		window.app_hris_master_gaji_fLembur.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hris_master_gaji_fLembur";
...
window.app_hris_master_gaji_fLembur.extend(window.childForm);
window.app_hris_master_gaji_fLembur.implement({
