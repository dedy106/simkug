window.app_hris_master_gaji_fStsPph = function(owner)
{
	if (owner)
	{
		window.app_hris_master_gaji_fStsPph.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hris_master_gaji_fStsPph";
...
window.app_hris_master_gaji_fStsPph.extend(window.childForm);
window.app_hris_master_gaji_fStsPph.implement({
