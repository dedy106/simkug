window.app_hris_transaksi_kesehatan_fKlaimE = function(owner)
{
	if (owner)
	{
		window.app_hris_transaksi_kesehatan_fKlaimE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hris_transaksi_kesehatan_fKlaimE";
...
window.app_hris_transaksi_kesehatan_fKlaimE.extend(window.childForm);
window.app_hris_transaksi_kesehatan_fKlaimE.implement({
