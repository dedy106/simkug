window.app_hris_transaksi_kesehatan_fFinalReimb = function(owner)
{
	if (owner)
	{
		window.app_hris_transaksi_kesehatan_fFinalReimb.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hris_transaksi_kesehatan_fFinalReimb";
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Finalisasi Reimburse Biaya Kesehatan: Input", 0);	
		...
		this.cb_app = new saiCBBL(this,{bound:[20,18,200,20],caption:"NIK Verifikator", multiSelection:false, maxLength:10, tag:2,readOnly:true});		
		this.bTampil = new button(this,{bound:[838,18,80,18],caption:"Tampil Data",click:[this,"doTampilClick"]});			
...
window.app_hris_transaksi_kesehatan_fFinalReimb.extend(window.childForm);
window.app_hris_transaksi_kesehatan_fFinalReimb.implement({
	...
	doTampilClick:function(sender){		
		if (this.e_periode.getText() != "") {
			var data = this.dbLib.getDataProvider("select a.no_kes,convert(varchar,a.tanggal,103) as tanggal,a.keterangan,b.kode_loker+' - '+b.nama as loker,a.nik_buat+' - '+c.nama as karyawan,convert(varchar,a.tgl_kuitansi,103) as tgl_kuitansi,isnull(x.nilai,0) as nilai  "+
				"from gr_kes_m a "+
