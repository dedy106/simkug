window.app_hris_transaksi_kesehatan_fReimbE = function(owner)
{
	if (owner)
	{
		window.app_hris_transaksi_kesehatan_fReimbE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hris_transaksi_kesehatan_fReimbE";
...
window.app_hris_transaksi_kesehatan_fReimbE.extend(window.childForm);
window.app_hris_transaksi_kesehatan_fReimbE.implement({
