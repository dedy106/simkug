window.app_hris_transaksi_kesehatan_fFinalReimbE = function(owner)
{
	if (owner)
	{
		window.app_hris_transaksi_kesehatan_fFinalReimbE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hris_transaksi_kesehatan_fFinalReimbE";
...
window.app_hris_transaksi_kesehatan_fFinalReimbE.extend(window.childForm);
window.app_hris_transaksi_kesehatan_fFinalReimbE.implement({
