window.app_hris_transaksi_kesehatan_fVerKlaim = function(owner)
{
	if (owner)
	{
		window.app_hris_transaksi_kesehatan_fVerKlaim.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hris_transaksi_kesehatan_fVerKlaim";
		...
		this.cb_app = new saiCBBL(this,{bound:[20,17,200,20],caption:"NIK Verifikator", multiSelection:false, maxLength:10, tag:1,readOnly:true});
...
window.app_hris_transaksi_kesehatan_fVerKlaim.extend(window.childForm);
window.app_hris_transaksi_kesehatan_fVerKlaim.implement({
	...
	doTampilClick:function(sender){		
		if (this.e_periode.getText() != "") {
			var data = this.dbLib.getDataProvider("select a.no_klaim,convert(varchar,a.tanggal,103) as tanggal,a.keterangan,a.kode_asur+' - '+d.nama as nama_asur,b.kode_loker+' - '+b.nama as loker,a.nik_buat+' - '+c.nama as karyawan,convert(varchar,a.tgl_kuitansi,103) as tgl_kuitansi,isnull(x.nilai,0) as nilai  "+
				"from gr_klaim_m a "+
