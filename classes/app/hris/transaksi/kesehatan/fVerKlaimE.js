window.app_hris_transaksi_kesehatan_fVerKlaimE = function(owner)
{
	if (owner)
	{
		window.app_hris_transaksi_kesehatan_fVerKlaimE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hris_transaksi_kesehatan_fVerKlaimE";
...
window.app_hris_transaksi_kesehatan_fVerKlaimE.extend(window.childForm);
window.app_hris_transaksi_kesehatan_fVerKlaimE.implement({
