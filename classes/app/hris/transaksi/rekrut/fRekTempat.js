window.app_hris_transaksi_rekrut_fRekTempat = function(owner)
{
	if (owner)
	{
		window.app_hris_transaksi_rekrut_fRekTempat.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hris_transaksi_rekrut_fRekTempat";
...
window.app_hris_transaksi_rekrut_fRekTempat.extend(window.childForm);
window.app_hris_transaksi_rekrut_fRekTempat.implement({
