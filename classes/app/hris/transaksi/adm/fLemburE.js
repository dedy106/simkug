window.app_hris_transaksi_adm_fLemburE = function(owner)
{
	if (owner)
	{
		window.app_hris_transaksi_adm_fLemburE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hris_transaksi_adm_fLemburE";
...
window.app_hris_transaksi_adm_fLemburE.extend(window.childForm);
window.app_hris_transaksi_adm_fLemburE.implement({
