window.app_hris_transaksi_adm_fApp = function(owner)
{
	if (owner)
	{
		window.app_hris_transaksi_adm_fApp.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hris_transaksi_adm_fApp";
		...
		this.sg = new saiGrid(this.p1,{bound:[0,20,895,280],colCount:9,tag:9,
				colTitle:["Status","Catatan","No Absen","Tanggal","Keterangan","Loker","NIK","Nama Karyawan","Status Absen"],
		...
		this.sg6 = new saiGrid(this.p6,{bound:[0,20,895,280],colCount:8,tag:9,
				colTitle:["Status","Catatan","No Surat","Tanggal","Departemen","Karyawan","Approved","Keterangan"],
				colWidth:[[7,6,5,4,3,2,1,0],[200,220,220,200,70,120,150,80]],
				columnReadOnly:[true,[0,2,3,4,5,6,7],[1]],
				picklist:[[0],[new portalui_arrayMap({items:["APP","INPROG"]})]],
				buttonStyle:[[0],[bsAuto]],defaultRow:1,autoAppend:false});
...
window.app_hris_transaksi_adm_fApp.extend(window.childForm);
window.app_hris_transaksi_adm_fApp.implement({
		...
		try{						
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{									
					...
					sql.add("insert into gr_app_m(no_app,kode_lokasi,periode,tanggal,modul,nik_buat,nik_app,keterangan,tgl_input,nik_user,no_del) values "+
