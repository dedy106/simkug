window.app_hris_transaksi_adm_fSpj3E = function(owner)
{
	if (owner)
	{
		window.app_hris_transaksi_adm_fSpj3E.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hris_transaksi_adm_fSpj3E";
...
window.app_hris_transaksi_adm_fSpj3E.extend(window.childForm);
window.app_hris_transaksi_adm_fSpj3E.implement({
