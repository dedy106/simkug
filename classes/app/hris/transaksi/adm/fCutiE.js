window.app_hris_transaksi_adm_fCutiE = function(owner)
{
	if (owner)
	{
		window.app_hris_transaksi_adm_fCutiE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hris_transaksi_adm_fCutiE";
		this.itemsValue = new arrayList();
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Cuti: Edit", 0);	
		
		uses("saiCBBL;saiEdit;datePicker;saiGrid;sgNavigator;pageControl;checkBox");
		this.e_periode = new portalui_saiLabelEdit(this,{bound:[20,14,202,20],caption:"Periode",tag:2,readOnly:true});
		this.l_tgl1 = new portalui_label(this,{bound:[20,11,100,18],caption:"Tanggal", underline:true});
		this.dp_d1 = new portalui_datePicker(this,{bound:[120,11,100,18],selectDate:[this,"doSelectDate"],date:new Date().getDateStr()}); 
		this.e_nb = new saiCBBL(this,{bound:[20,12,223,20],caption:"No Cuti", multiSelection:false, maxLength:10, tag:1, readOnly:true,change:[this,"doChange"]});						
		...
		this.e_saldo = new saiLabelEdit(this,{bound:[20,16,180,20],caption:"Sisa Cuti", tipeText:ttNilai, text:"0", readOnly:true});		
		...
		try {
			...
			this.e_nb.setSQL("select no_cuti, alasan from gr_cuti where progress = '0' and nik_user='"+this.app._userLog+"' and kode_lokasi='"+this.app._lokasi+"'",["no_cuti","alasan"],false,["No Cuti","Alasan"],"and","Data Cuti",true);			
		}catch(e){
			systemAPI.alert(e);
		}
	}
};
window.app_hris_transaksi_adm_fCutiE.extend(window.childForm);
window.app_hris_transaksi_adm_fCutiE.implement({
