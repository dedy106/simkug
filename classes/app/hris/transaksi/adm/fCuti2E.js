window.app_hris_transaksi_adm_fCuti2E = function(owner)
{
	if (owner)
	{
		window.app_hris_transaksi_adm_fCuti2E.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hris_transaksi_adm_fCuti2E";
...
window.app_hris_transaksi_adm_fCuti2E.extend(window.childForm);
window.app_hris_transaksi_adm_fCuti2E.implement({
