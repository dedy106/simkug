window.app_hris_transaksi_adm_fSuratE = function(owner)
{
	if (owner)
	{
		window.app_hris_transaksi_adm_fSuratE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hris_transaksi_adm_fSuratE";
...
window.app_hris_transaksi_adm_fSuratE.extend(window.childForm);
window.app_hris_transaksi_adm_fSuratE.implement({
