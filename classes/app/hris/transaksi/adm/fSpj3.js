window.app_hris_transaksi_adm_fSpj3 = function(owner)
{
	if (owner)
	{
		window.app_hris_transaksi_adm_fSpj3.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hris_transaksi_adm_fSpj3";
...
window.app_hris_transaksi_adm_fSpj3.extend(window.childForm);
window.app_hris_transaksi_adm_fSpj3.implement({
