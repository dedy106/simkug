window.app_hris_transaksi_adm_fVer = function(owner)
{
	if (owner)
	{
		window.app_hris_transaksi_adm_fVer.prototype.parent.constructor.call(this,owner);
		this.className  = "app_hris_transaksi_adm_fVer";
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form Verifikasi Adm Personalia: Input", 0);	
		...
		this.cb_app = new saiCBBL(this,{bound:[20,17,200,20],caption:"NIK Approve", multiSelection:false, maxLength:10, tag:2,readOnly:true});
		this.c_modul = new saiCB(this,{bound:[20,20,200,20],caption:"Jenis",items:["ABSEN","LEMBUR","CUTI","SPPD","SURAT","IJIN"], tag:2,readOnly:true,change:[this,"doChange"] });
		this.bTampil = new button(this,{bound:[838,20,80,18],caption:"Tampil Data",click:[this,"doTampilClick"]});			
		
		this.p1 = new portalui_panel(this,{bound:[20,189,900,330],caption:"Data Pengajuan Absensi"});
		this.sg = new saiGrid(this.p1,{bound:[0,20,895,280],colCount:8,tag:9,
				colTitle:["Status","Catatan","No Absen","Tanggal","Keterangan","Loker","Karyawan","Status Absen"],
				colWidth:[[7,6,5,4,3,2,1,0],[220,200,200,220,70,120,150,80]],
		...
		this.sg3 = new saiGrid(this.p3,{bound:[0,20,895,280],colCount:13,tag:9,
				colTitle:["Status","Catatan","No Cuti","Tanggal","Loker","Karyawan","Status Cuti","Alasan Cuti","Alamat Cuti","Tgl Mulai","Tgl Selesai","Lama","Sisa Cuti"],
				...
				colFormat:[[11,12],[cfNilai,cfNilai]],
				picklist:[[0],[new portalui_arrayMap({items:["APP","INPROG"]})]],
				buttonStyle:[[0],[bsAuto]],defaultRow:1,autoAppend:false});
		...
		this.sg4 = new saiGrid(this.p4,{bound:[0,20,895,280],colCount:10,tag:9,
				colTitle:["Status","Catatan","No SPPD","Tanggal","Loker","NIK","Nama","Keterangan","Nilai Transport","Uang Harian"],
		...
		this.sg6 = new saiGrid(this.p6,{bound:[0,20,895,280],colCount:8,tag:9,
				...
				colWidth:[[7,6,5,4,3,2,1,0],[220,220,220,200,70,120,150,80]],
				columnReadOnly:[true,[0,2,3,4,5,6,7],[1]],
				picklist:[[0],[new portalui_arrayMap({items:["APP","INPROG"]})]],
				buttonStyle:[[0],[bsAuto]],defaultRow:1,autoAppend:false});
...
window.app_hris_transaksi_adm_fVer.extend(window.childForm);
window.app_hris_transaksi_adm_fVer.implement({
			...
			if (this.e_periode.getText() != "" && this.cb_app.getText() != "") {
				...
				if (typeof data == "object" && data.rs.rows[0] != undefined){
					...
					for (var i in data.rs.rows){
						line = data.rs.rows[i];							
						this.sg.appendData(["INPROG","-",line.no_absen,line.tanggal,line.keterangan,line.loker,line.karyawan,line.absen]);
					}
