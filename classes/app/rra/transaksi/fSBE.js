window.app_rra_transaksi_fSBE = function(owner)
{
	if (owner)
	{
		window.app_rra_transaksi_fSBE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_rra_transaksi_fSBE";
		...
		this.e_nb = new saiCBBL(this,{bound:[20,12,202,20],caption:"No Standby",maxLength:30, multiSelection:false, change:[this,"doChange"]});		
		...
		try {
			...
			this.e_nb.setSQL("select no_pdrk,keterangan from rra_pdrk_m where progress='0' and kode_lokasi='"+this.app._lokasi+"' and sts_pdrk in ('STB') and nik_user = '"+this.app._userLog+"' ",["no_pdrk","keterangan"],false,["No PDRK","Keterangan"],"and","Data PDRK",true);
...
window.app_rra_transaksi_fSBE.extend(window.childForm);
window.app_rra_transaksi_fSBE.implement({
