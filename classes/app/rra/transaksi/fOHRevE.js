window.app_rra_transaksi_fOHRevE = function(owner)
{
	if (owner)
	{
		try{
			window.app_rra_transaksi_fOHRevE.prototype.parent.constructor.call(this,owner);
			this.className  = "app_rra_transaksi_fOHRevE";
			...
			this.cb_pdrk = new saiLabelEdit(this,{bound:[20,13,222,20],caption:"No PDRK", multiSelection:false, tag:1, change:[this,"doChange"]});		
			...
			this.sgn2 = new sgNavigator(this.pc1.childPage[1],{bound:[1,this.pc1.height-25,this.pc1.width-1,25],buttonStyle:bsTransNav,grid:this.sg2, pager:[this,"doPager"]});
			...
			this.e_nb.setSQL("select no_rev, keterangan, no_pdrk from rra_rev_m where progress in ('0','R') and kode_lokasi='"+this.app._lokasi+"' and sts_pdrk in ('OPN','STB') and nik_buat = '"+this.app._userLog+"' ",["no_rev","keterangan","no_pdrk"],false,["No Review","Keterangan","No PDRK"],"and","Data PDRK",true);
...
window.app_rra_transaksi_fOHRevE.extend(window.childForm);
window.app_rra_transaksi_fOHRevE.implement({
