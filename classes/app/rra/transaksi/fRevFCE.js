window.app_rra_transaksi_fRevFCE = function(owner)
{
	if (owner)
	{
		window.app_rra_transaksi_fRevFCE.prototype.parent.constructor.call(this,owner);
		this.className  = "app_rra_transaksi_fRevFCE";
		...
		this.e_nb = new saiCBBL(this,{bound:[20,12,222,20],caption:"No Review",maxLength:30,multiSelection:false, change:[this,"doChange"]});		
		...
		this.cb_pdrk = new saiLabelEdit(this,{bound:[20,13,222,20],caption:"No PDRK", tag:1,readOnly:true});		
		...
		this.pc1 = new pageControl(this,{bound:[20,16,900, 350], childPage:["Data PDRK","Data Donor","Data Penerima","Data Justifikasi","Dokumen Pendukung","View Dokumen","Dokumen PDRK","Nota Kajian"], pageChange:[this,"doPageChange"]});
		...
		try {
			...
			this.e_nb.setSQL("select a.no_frev, a.keterangan, a.no_pdrk from rra_frev_m a "+
										 "where a.sts_pdrk in ('RRR','ABT','OPN') and a.progress in ('0','R') "+
										 " and a.periode<='"+this.e_periode.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"' and a.no_frev like 'FREV%'",["no_frev","keterangan","no_pdrk"],false,["No Review","Keterangan","No PDRK"],"and","Data PDRK",true);
...
window.app_rra_transaksi_fRevFCE.extend(window.childForm);
window.app_rra_transaksi_fRevFCE.implement({
		...
		try{				
			...
			if (this.standarLib.checkEmptyByTag(this, [0,1,2])){
				try{
					...
					sql.add("update rra_frev_m set nik_buat='"+this.cb_buat.getText()+"', "+
									" nik_app1 ='"+this.cb_app1.getText()+"',nik_app2='"+this.cb_app2.getText()+"', "+
									" nik_app3 ='"+this.cb_app3.getText()+"',progress='0',keterangan='"+this.e_ket.getText()+"', "+
									...
									"  nik_review='"+this.cb_reviewer.getText()+"'where no_frev ='"+this.e_nb.getText()+"' "+
							"");
					...
					sql.add("delete from rra_frev_dok where no_frev = '"+this.e_nb.getText()+"' and kode_lokasi = '"+this.app._lokasi+"' ");					
					sql.add("delete from rra_frev_d where no_frev = '"+this.e_nb.getText()+"' and kode_lokasi = '"+this.app._lokasi+"' ");					
					sql.add("delete from rra_frev_orgi where no_frev = '"+this.e_nb.getText()+"' and kode_lokasi = '"+this.app._lokasi+"' ");					
	...
	doChange:function(sender){
		try{
			...
			if (sender == this.e_nb && this.e_nb.getText()!="") {
				...
				this.table = {master:"rra_frev_m", detail:"rra_frev_d", dok :"rra_frev_dok", field:"no_frev"};				
				var data = this.dbLib.getMultiDataProvider(new server_util_arrayList({items:[
						   ...
						   "where a."+this.table.field+"='"+this.e_nb.getText()+"' and a.kode_lokasi='"+this.app._lokasi+"'",
						   "select file_dok, nama from "+this.table.dok+" where "+this.table.field+" = '"+this.e_nb.getText()+"' and kode_lokasi = '"+this.app._lokasi+"' order by no_urut",
						   "select substring(a.periode,5,2) as bulan,a.kode_cc,b.nama as nama_cc,a.kode_drk,isnull(d.nama,'-') as nama_drk,a.kode_akun,c.nama as nama_akun,a.nilai_gar,a.nilai_pakai,a.saldo,a.nilai,a.dc,a.target, a.jenis, a.nilai_keep "+
							 ...
							 "where a."+this.table.field+" = '"+this.e_nb.getText()+"' and a.kode_lokasi = '"+this.app._lokasi+"' order by a.dc"
						   ]}),false);				
				eval("data = "+data+";");
