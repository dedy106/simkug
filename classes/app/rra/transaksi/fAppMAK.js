window.app_rra_transaksi_fAppMAK = function(owner)
{
	if (owner)
	{
		window.app_rra_transaksi_fAppMAK.prototype.parent.constructor.call(this,owner);
		this.className  = "app_rra_transaksi_fAppMAK";
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Form PRDRK ABT Anggaran: Approve MA(Koreksi)", 0);	
...
window.app_rra_transaksi_fAppMAK.extend(window.childForm);
window.app_rra_transaksi_fAppMAK.implement({
