window.app_rra_report_flWasGar = function(owner)
{
	if (owner)
	{
		window.app_rra_report_flWasGar.prototype.parent.constructor.call(this,owner);
		this.className = "app_rra_report_flWasGar";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan REKAP PDRK", 2);
...
window.app_rra_report_flWasGar.extend(window.childForm);
window.app_rra_report_flWasGar.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_rra_rptWasGar";			
			...
			systemAPI.alert("[app_rra_report_flWasGar]::mainButtonClick:"+e);
		}
	},
