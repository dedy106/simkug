window.app_rra_report_flOpenHold = function(owner)
{
	if (owner)
	{
		window.app_rra_report_flOpenHold.prototype.parent.constructor.call(this,owner);
		this.className = "app_rra_report_flOpenHold";
		this.maximize();
	...
	this.gridLib.SGEditData(this.sg1,5,[0,1,2],["Jenis Laporan","=","PDRK-1"]);
	this.doSelectCell(this.sg1,2,5);
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_rra_report_flOpenHold.extend(window.childForm);
window.app_rra_report_flOpenHold.implement({
	...
	doSelectCell: function(sender, col, row){		
		this.filterRep.setSGFilterRowTipe(this.sg1, row,[0,1,2,3,4,5],["3","123","123","13","123","3"]);
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				if (this.sg1.getCell(2,5)=="PDRK-1")
				{
					this.nama_report = "server_report_rra_rptPdrk1";	
				}
				if (this.sg1.getCell(2,5)=="PDRK-2")
				{
					this.nama_report = "server_report_rra_rptPdrk2";	
				}
				if (this.sg1.getCell(2,5)=="PDRK-3")
				{
					this.nama_report = "server_report_rra_rptPdrk3";	
				}
			...
			systemAPI.alert("[app_rra_report_flOpenHold]::mainButtonClick:"+e);
		}
	},
