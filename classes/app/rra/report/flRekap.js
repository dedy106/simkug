window.app_rra_report_flRekap = function(owner)
{
	if (owner)
	{
		window.app_rra_report_flRekap.prototype.parent.constructor.call(this,owner);
		this.className = "app_rra_report_flRekap";
		this.maximize();
...
window.app_rra_report_flRekap.extend(window.childForm);
window.app_rra_report_flRekap.implement({
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_rra_rptRekap";			
			...
			systemAPI.alert("[app_rra_report_flRekap]::mainButtonClick:"+e);
		}
	},
