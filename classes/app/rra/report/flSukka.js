window.app_rra_report_flSukka = function(owner)
{
	if (owner)
	{
		window.app_rra_report_flSukka.prototype.parent.constructor.call(this,owner);
		this.className = "app_rra_report_flSukka";
		this.maximize();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Laporan SUKKA", 2);
	...
	this.gridLib.SGEditData(this.sg1,5,[0,1,2],["Jenis Laporan","=","SUKKA"]);
	this.doSelectCell(this.sg1,2,5);
	this.pager = parseInt(this.app._mainForm.reportNavigator.cb.getText());
};
window.app_rra_report_flSukka.extend(window.childForm);
window.app_rra_report_flSukka.implement({
		...
		try{	
			...
			if (row == 4)
			{
				this.filterRep.ListDataSGFilter(this, "Data PDRK",this.sg1, this.sg1.row, this.sg1.col,
													"select a.no_pdrk, a.keterangan from rra_pdrk_m a inner join rra_sukka b on b.no_pdrk = a.no_pdrk and b.kode_lokasi = a.kode_lokasi "+ 
													" where a.kode_lokasi = '"+this.app._lokasi+"' "+
													this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and"),
													"select count(*) from rra_pdrk_m a inner join rra_sukka b on b.no_pdrk = a.no_pdrk "+ 
													" where a.kode_lokasi = '"+this.app._lokasi+"' "+
													this.filterRep.filterStr("a.periode",this.sg1.getCell(1,1),this.sg1.getCell(2,1),this.sg1.getCell(3,1),"and"),
													["a.no_pdrk","a.keterangan"],"and",["No PDRK","Nama"]);
			}	
	...
	doSelectCell: function(sender, col, row){		
		...
		{
			this.sg1.columns.get(2).pickList.clear();
			this.gridLib.SGIsiItemsFromArray(this.sg1.columns.get(2).pickList,new Array("SUKKA","Summary"));
		}
	...
	mainButtonClick: function(sender){
		try
		{
			...
			else
			{
				...
				this.nama_report = "server_report_rra_rptSukka";	
			...
			systemAPI.alert("[app_rra_report_flSukka]::mainButtonClick:"+e);
		}
	},
