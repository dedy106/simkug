window.app_rra_master_fDraft = function(owner)
{
	if (owner)
	{
		window.app_rra_master_fDraft.prototype.parent.constructor.call(this,owner);
		this.className  = "app_rra_master_fDraft";
		this.itemsValue = new arrayList();
		this.app._mainForm.childFormConfig(this, "mainButtonClick","Data Draft", 0);	
		...
		this.cb_jenis = new saiCB(this,{bound:[20,12,200,20],caption:"Jenis", items:["JUST","SUKKA"]});				
		
		this.mDesk = new tinymceCtrl(this,{bound:[20,10,800,300], withForm:false});
...
window.app_rra_master_fDraft.extend(window.childForm);
window.app_rra_master_fDraft.implement({
	doClose: function(){
