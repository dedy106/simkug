...
//* 			SAI, PT											
//***********************************************************************************************
window.system_fInputDlg = function(owner){
	try
	{
		if (owner)
		{
			window.system_fInputDlg.prototype.parent.constructor.call(this,owner);
			this.className = "system_fInputDlg";			
			window.system_fInputDlg.prototype.parent.setWidth.call(this, 400);
			window.system_fInputDlg.prototype.parent.setHeight.call(this, 200);									
...
window.system_fInputDlg.extend(window.portalui_commonForm);
window.system_fInputDlg.implement({
	...
	show: function(requester, caption,prompt, defaultValue){		
		...
		this.b1.setFocus();
		window.system_fInputDlg.prototype.parent.showModal.call(this);
		this.centerize();
		this.b1.setFocus();
	},	
	...
	doSysMouseDown: function(x, y, button, buttonState){	
		window.system_fInputDlg.prototype.parent.doSysMouseDown.call(this,x, y, button, buttonState);
	},
	doSysMouseUp: function(x, y, button, buttonState){	
		window.system_fInputDlg.prototype.parent.doSysMouseUp.call(this,x, y, button, buttonState);
	},
	doSysMouseMove: function(x, y, button, buttonState){
		window.system_fInputDlg.prototype.parent.doSysMouseMove.call(this,x, y, button, buttonState);
		if (this.isClick)
		{		
