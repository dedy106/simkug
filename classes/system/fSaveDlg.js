window.system_fSaveDlg = function(owner, options){
	if (owner){
		window.system_fSaveDlg.prototype.parent.constructor.call(this,owner, options);				
		...
		this.tFile = new portalui_fileExplorer(this,{bound:[10,31,300,this.height - 40],showFile:true, select:[this,"doSelectFile"], dataReady:[this,"doDataReady"],dblClick:[this,"doTreeClick"]});
		this.lvFile = new portalui_listView(this,{bound:[320,31,this.width - 330,this.height - 40], showIcon:true, dblClick:[this,"doDblClick"]});
		this.fileUtil = new util_file(undefined);		
		this.fileUtil.addListener(this);
		this.dbLib = new util_dbLib();
		this.dbLib.addListener(this);
		this.rootDir = this.tFile.rootDir;		
		this.fileUtil.setFilename(this.rootDir + "/classes/app");		
		this.rootPath = this.rootDir + "/classes/app";		
		if (!this.fileUtil.isDir()){
			this.fileUtil.createDir();
		}else{
			this.tFile.setUsrRoot(window.dataLogin.email,"classes/app","Project");
		}		
		this.initload();
	}
};
window.system_fSaveDlg.extend(portalui_panel);
window.system_fSaveDlg.implement({
...
if (window.system_fUpload !== undefined){
