<?php
    ...
    if(!$_SESSION['isLogedIn']){
        echo "<script>alert('Harap login terlebih dahulu !'); window.location='/web/fLoginSekolah.php';</script>";
    }
...
<body class="skin-red fixed sidebar-mini sidebar-mini-expand-feature sidebar-collapse">
    <div class="wrapper" style='background-color:#ffff' >
        ...
        <?php
            ...
            if (count($daftar_menu) > 0){
                for($i=0; $i<count($daftar_menu); $i++){
                    ...
                    $this_link = "fMainSekolah.php?hal=".$forms.".php";

                    $link_aktif = "fMainSekolah.php?hal=".$_GET['hal'];
        ...
        ?>
                    ...
                    <span><i class='<?php echo $daftar_menu[$i]['icon']; ?> fa-lg' style='text-align: center;'></i></span><br><span style='text-align: center;font-size: 14px;'><?php echo $daftar_menu[$i]["nama"]; ?></span></a>
        <?php   } 
            } else { ?>
