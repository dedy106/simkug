...
<script>
 ...
 $(document).ready(function(){
    ...
    var dataTable = $('#table-konten').DataTable({
        ...
        'serverSide': true,
        'ajax': {
            'url': 'include_lib.php?hal=server/cms/Kontak.php&fx=getKontak',
  ...
  $('#saiweb_container').on('click', '.web_datatable_edit', function(){
      ...
      $.ajax({
        type: 'POST',
        url: 'include_lib.php?hal=server/cms/Kontak.php&fx=getEditKontak',
        dataType: 'json',
  ...
  e.preventDefault();
    ...
    $.ajax({
        type: 'POST',
        url: 'include_lib.php?hal=server/cms/Kontak.php&fx=simpanKontak',
        dataType: 'json',
        data: formData,
        contentType: false,
        cache: false,
  ...
  $('#saiweb_container').on('submit', '#web_form_edit', function(e){
    ...
    $.ajax({
        type: 'POST',
        url: 'include_lib.php?hal=server/cms/Kontak.php&fx=ubahKontak',
        dataType: 'json',
        data: formData,
        contentType: false,
        cache: false,
    ...
    $('#saiweb_container').on('click', '.web_datatable_del', function(){
        if(confirm('Apakah anda ingin menghapus data ini?')){
            ...
            $.ajax({
                type: 'POST',
                url: 'include_lib.php?hal=server/cms/Kontak.php&fx=hapusKontak',
                dataType: 'json',
