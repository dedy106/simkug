        ...
        <div class='row'>
            <div class='col-md-8'>
                <?php
                    ...
                    $sql="select count(a.id) as jml from lab_konten a where a.kode_klp='KLP03' and a.kode_lokasi='$kode_lokasi' $strperiode ";
                    $rs = execute($sql);
                    ...
                    if($jumlah_artikel > 0){
						...
						where a.kode_klp='KLP03' and a.kode_lokasi='$kode_lokasi' $strperiode 
                ...
                <center>
                    <?php generateWebPaging('fMainJava.php?hal=app/java/fArticle.php&page=', $jumlah_artikel, $items_per_page, $active_page); ?>
                </center>
            </div><!--/.col-md-8-->

            <aside class="col-md-4">
                <div class="widget search">
                    <form role="form" action='fMainJava.php?hal=app/java/fSearch.php&param=article/string/1' method='GET'>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <ul class="blog_category">
								...
								where a.kode_klp='KLP03' and a.kode_lokasi='$kode_lokasi' group by b.nama, b.kode_kategori");
                                ...
                                if($rsc->RecordCount()){
                                    ...
                                    foreach($categories as $cat){
                                        echo "<li><a href='fMainJava.php?hal=app/java/fSearch.php&param=article/categories/1/".$cat['kode_kategori']."'>".$cat['nama']." <span class='badge'>".$cat['jml']."</span></a></li>";
                                    }
                                }
                                ?>
                            </ul>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <ul class="blog_archieve">
								...
								from lab_konten a 
								where a.kode_klp='KLP03' and a.kode_lokasi='$kode_lokasi' 
                                ...
                                if($rsa->RecordCount()){
                                    ...
                                    foreach($archive as $arc){
                                        echo "<li><a href='fMainJava.php?hal=app/java/fArticle.php&page=/1/".$arc['bulan']."/".$arc['tahun']."'><i class='fa fa-angle-double-right'></i> ".getNamaBulan($arc['bulan'])." ".$arc['tahun']." <span class='pull-right'>(".$arc['jml'].")</span></a></li>";
                                    }
                                }
                                ?>
                            </ul>
