                ...
                <div class="modal-body">
                    ...
                    <div class='row'>
                        ...
                        <label class='control-label col-sm-3'>Link</label>
                            ...
                            $rs2 = execute("SELECT DISTINCT kode_form as id, nama_form as nama FROM m_form where kode_form like 'JAVA%'
                            UNION
...
<script>
    ...
    $('.sai-treegrid-btn-del').click(function(){
        if($(".ui-selected").length != 1){
            ...
            if(sts){
                ...
                window.location = service_domain+"web/include_lib.php?hal=server/java/Java.php&fx=delMenu&param="+selected_id+"&lok="+lokasi;
    ...
    $("#sai-treegrid-modal-form").on("submit", function(event){
        ...
        $.ajax({
            type: 'POST',
            url: 'include_lib.php?hal=server/java/Java.php&fx=simpanMenu',
            dataType: 'json',
            data: formData,
            contentType: false,
            cache: false,
