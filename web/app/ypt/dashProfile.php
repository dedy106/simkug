    ...
    <div class='row'>
        <div class='col-md-12'>
            <div class='box box-warning'>
                ...
                <div class='box-body pad sai-container-overflow' style='max-height:500px'>
...
<script>
 $('#ajax-content-section').on('submit', '#form-sis-foto', function(event){
        ...
        $.ajax({
            url: "include_lib.php?hal=server/ypt/Siswa.php&fx=ubahFoto",
            data: formData,
            type: "post",
            dataType: "json",
    ...
    $('#ajax-content-section').on('submit', '#form-sis-ubpass', function(event){
        ...
        $.ajax({
            url: 'include_lib.php?hal=server/ypt/Siswa.php&fx=ubahPassword',
            data: formData,
            type: "post",
            dataType: "json",
            contentType: false, 
    ...
    $('#btn-ubtelp').click(function(){
        ...
        $.ajax({
        type: 'POST',
        url: 'include_lib.php?hal=server/ypt/Siswa.php&fx=getEditTelp',
        dataType: 'json',
    ...
    $('#ajax-content-section').on('submit', '#form-sis-ubtelp', function(event){
        ...
        $.ajax({
            url: 'include_lib.php?hal=server/ypt/Siswa.php&fx=ubahNoTelp',
            data: formData,
            type: "post",
            dataType: "json",
            contentType: false, 
