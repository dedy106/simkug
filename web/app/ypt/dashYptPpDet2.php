<?php
    ...
    if ($version[1] == "iPhone" || $version[1] == "Android" || $version[1] == "Blackberry" || $version[1] == "Blazer" ||$version[1] == "Elaine" || $version[1] == "Hiptop" || $version[1] == "iPod" || $version[1] == "Kindle" ||$version[1] == "Midp" || $version[1] == "Mobile" || $version[1] == "O2" || $version[1] == "Opera Mini" ||$version[1] == "Mobile" || $version[1] == "Smartphone"){
        $back1="";
        if($tmp[6] == "" OR $tmp[6]==0){
            $backto="$fmain?hal=app/ypt/dashYptPpDet.php&param=$periode|$kode_pp|$box";
        }else{
            $next=intval($tmp[6])-1;
            // if($next == 1) $next = 0;
            $backto="$fmain?hal=app/ypt/dashYptPpDet2.php&param=$periode|$kode_pp|$box|$jenis|$kunci|$nama|$next";
        }
        $mobile=true;
        include('back.php');
        ...
        if($tmp[6] == "" OR $tmp[6]==0){
            $back1="<div class='panel-heading'><a href='$fmain?hal=app/ypt/dashYptPpDet.php&param=$periode|$kode_pp|$box' class='small-box-footer' > Back <i class='fa fa-arrow-circle-left'></i></a></div>";
        }else{
            $next=intval($tmp[6])-1;
            $back1="<div class='panel-heading'><a href='$fmain?hal=app/ypt/dashYptPpDet2.php&param=$periode|$kode_pp|$box|$jenis|$kunci|$nama|$next' class='small-box-footer' > Back <i class='fa fa-arrow-circle-left'></i></a></div>";
                                ...
                                point: {
                                    events: {
                                        click: function() {
                                            ...
                                            window.location.href='$fmain?hal=app/ypt/dashYptPpDet3.php&param=$periode|$kode_pp|$box|$jenis|$kunci|$nama|NrcL|'+kd;
                                        }
                                    }
                                }
                            }
            ...
            switch($kunci){
                case "k1" :
                    ...
                    while ($row = $rs2->FetchNextObject(false)){
                        $tbody.="
                        <a style='cursor:pointer;color:blue'  onclick=\"window.location.href='$fmain?hal=app/ypt/dashYptPpDet3.php&param=$periode|$kode_pp|$box|$jenis|$kunci|$nama|PB|$row->no_aju';\">
                    ...
                    if($jumpage > 1 AND $page < ($jumpage-1) ){
                        $page++;
                        $tbody.= "<a style='cursor:pointer;'  class='btn btn-default btn-block' onclick=\"window.location.href='$fmain?hal=app/ypt/dashYptPpDet2.php&param=$periode|$kode_pp|$box|$jenis|$kunci|$nama|$page';\">More Detail
                        </a>";
                    }
                ...
                case "k2" :
                    ...
                    while ($row = $rs2->FetchNextObject(false)){
                        $tbody.="
                        <a style='cursor:pointer;color:blue'  onclick=\"window.location.href='$fmain?hal=app/ypt/dashYptPpDet3.php&param=$periode|$kode_pp|$box|$jenis|$kunci|$nama|VER|$row->no_ver';\">
                            <div class='box-footer box-comments' style='background:white;border-top:0px solid white'>
                                <div class='box-comment'>
                                    <div class='comment-text' style='margin-left: 0px;'>
                                        <span class='username'>
                ...
                case "k3" :
                    ...
                    while ($row = $rs2->FetchNextObject(false)){
                        $tbody.="
                        <a style='cursor:pointer;color:blue'  onclick=\"window.location.href='$fmain?hal=app/ypt/dashYptPpDet3.php&param=$periode|$kode_pp|$box|$jenis|$kunci|$nama|FIAT|$row->no_fiat';\">
                            <div class='box-footer box-comments' style='background:white;border-top:0px solid white'>
                                <div class='box-comment'>
                                    <div class='comment-text' style='margin-left: 0px;'>
                                        <span class='username'>
                ...
                case "k4" :
                    ...
                    while ($row = $rs2->FetchNextObject(false)){
                        $tbody.="
                        <a style='cursor:pointer;color:blue'  onclick=\"window.location.href='$fmain?hal=app/ypt/dashYptPpDet3.php&param=$periode|$kode_pp|$box|$jenis|$kunci|$nama|SPB|$row->no_spb';\">
                            <div class='box-footer box-comments' style='background:white;border-top:0px solid white'>
                                <div class='box-comment'>
                                    <div class='comment-text' style='margin-left: 0px;'>
                                        <span class='username'>
                ...
                case "k5" :
                    ...
                    while ($row = $rs2->FetchNextObject(false)){
                        $tbody.="
                        <a style='cursor:pointer;color:blue'  onclick=\"window.location.href='$fmain?hal=app/ypt/dashYptPpDet3.php&param=$periode|$kode_pp|$box|$jenis|$kunci|$nama|KAS|$row->no_kas';\">
                            <div class='box-footer box-comments' style='background:white;border-top:0px solid white'>
                                <div class='box-comment'>
                                    <div class='comment-text' style='margin-left: 0px;'>
                                        <span class='username'>
                ...
                case "app0" :
                    ...
                    while ($row = $rs2->FetchNextObject(false)){
                        $tbody.="
                        <a style='cursor:pointer;color:blue'  onclick=\"window.location.href='$fmain?hal=app/ypt/dashYptPpDet3.php&param=$periode|$kode_pp|$box|$jenis|$kunci|$nama|RRA|$row->no_pdrk';\">
                            <div class='box-footer box-comments' style='background:white;border-top:0px solid white'>
                                <div class='box-comment'>
                                    <div class='comment-text' style='margin-left: 0px;'>
                                        <span class='username'>
                ...
                while ($row = $rs2->FetchNextObject(false)){
                    $tbody.="
                        <a style='cursor:pointer;color:blue'  onclick=\"window.location.href='$fmain?hal=app/ypt/dashYptPpDet3.php&param=$periode|$kode_pp|$box|$jenis|$kunci|$nama|SPJ|$row->no_spj';\">
                            <div class='box-footer box-comments' style='background:white;border-top:0px solid white'>
                                <div class='box-comment'>
                                    <div class='comment-text' style='margin-left: 0px;'>
                                        <span class='username'>
                ...
                while ($row = $rs2->FetchNextObject(false)){
                    $tbody.="
                        <a style='cursor:pointer;color:blue'  onclick=\"window.location.href='$fmain?hal=app/ypt/dashYptPpDet3.php&param=$periode|$kode_pp|$box|$jenis|$kunci|$nama|APD|$row->no_app';\">
                            <div class='box-footer box-comments' style='background:white;border-top:0px solid white'>
                                <div class='box-comment'>
                                    <div class='comment-text' style='margin-left: 0px;'>
                                        <span class='username'>
                ...
                case "ast1" :
                $title= "Data Aset";
                $column_array = array('No Asset','Klp Asset','Nama','Klp Asset','Kode PP','Nama PP','Tanggal');
                $thead="";
                for ($i=0;$i<count($column_array);$i++){
                    $thead.="
                    <th style='text-align:center;'>".$column_array[$i]."</th>
                ...
                $sql = " select a.kode_klpakun,a.kode_lokasi,b.nama as nama_klpakun,
                a.kode_pp,c.nama as nama_pp,a.no_fa,a.nama,convert(varchar,a.tgl_perolehan,103) as tgl,
                    a.umur,a.persen
                from fa_asset a
                left join fa_klpakun b on a.kode_klpakun=b.kode_klpakun and a.kode_lokasi=b.kode_lokasi
                left join pp c on a.kode_pp=c.kode_pp and a.kode_lokasi=b.kode_lokasi
                where a.kode_lokasi='$kode_lokasi' and a.kode_pp='$kode_pp' and a.kode_klpakun='$jenis' ";

                $rs2 = execute($sql);                              
                $tbody="";  
                while ($row = $rs2->FetchNextObject(false)){
                    $tbody.="
                        <a style='cursor:pointer;color:blue'  onclick=\"window.location.href='$fmain?hal=app/ypt/dashYptPpDet3.php&param=$periode|$kode_pp|$box|$jenis|$kunci|$nama|ASET|$row->no_fa';\">
                            <div class='box-footer box-comments' style='background:white;border-top:0px solid white'>
                                <div class='box-comment'>
                                    <div class='comment-text' style='margin-left: 0px;'>
                                        <span class='username'>
                                        $row->no_fa - $row->tgl - $row->kode_pp
                                        <span class='text-muted pull-right' style='font-size:14px'><i class='fa fa-angle-right'></i></span>
                                        </span><!-- /.username -->
                                        <span class='username'>
                                        $row->nama
                            ...
                            point: {
                                events: {
                                    click: function() {
                                        ...
                                        var kd= this.options.key;
                                        // alert(kd);                        
                                        window.location.href='$fmain?hal=app/ypt/dashYptPpDet3.php&param=$periode|$kode_pp|$box|$jenis|$kunci|$nama|GAR|'+kd;
                                    }
                                }
                            }
                        }
