<?php
    ...
    if ($version[1] == "iPhone" || $version[1] == "Android" || $version[1] == "Blackberry" || $version[1] == "Blazer" ||$version[1] == "Elaine" || $version[1] == "Hiptop" || $version[1] == "iPod" || $version[1] == "Kindle" ||$version[1] == "Midp" || $version[1] == "Mobile" || $version[1] == "O2" || $version[1] == "Opera Mini" ||$version[1] == "Mobile" || $version[1] == "Smartphone"){
        $mobile=true;
        $back1="";
        $backto="$fmain?hal=app/ypt/dashYptPpDet2.php&param=$periode|$kode_pp|$box|$jenis|$kunci|$nama";
        ...
        <a href='#' class='small-box-footer ' style='margin-left:10px;margin-top:10px' onclick=\"window.location.href='$fmain?hal=app/ypt/dashYptPpDet2.php&param=$periode|$kode_pp|$box|$jenis|$kunci|$nama'\"> Back <i class='fa fa-arrow-circle-left'></i></a>
        </div>";
    }
        ...
        echo"<div class='row'>
                ...
                case "NrcL" :
                    ...
                    while ($row2 = $rs2->FetchNextObject($toupper=false)){
                        ...
                        echo"
                        <a style='cursor:pointer;color:blue'   onclick=\"window.location.href='$fmain?hal=app/ypt/dashYptPpDet4.php&param=$periode|$kode_pp|$box|$jenis|$kunci|$nama|$param|$key|$row2->kode_akun';\">
                ...
                if($mobile == false) {
                    echo"
                        ...
                        inner join masakun f on b.akun_deprs=f.kode_akun and b.kode_lokasi=f.kode_lokasi where a.kode_lokasi='$kode_lokasi' and a.kode_pp='$kode_pp' and a.no_fa='$key' ";
                        $rs=execute($sql);
                        ...
                        if($mobile == false) {
                            ...
                            <tr>
                                <td colspan='7'><table class='table no-border'>
                                    <tr>
                                        <td width='132' >No Asset</td>
                                        <td width='558' >: $row->no_fa </td>
                                    </tr>
                                    <tr>
                                        <td >Uraian Barang</td>
                                        <td >: $row->nama </td>
                                    ...
                                    <tr>
                                        <td width='132' >Akun Asset</td>
                                        <td width='558' >: $row->kode_akun - $row->nama_akun </td>
                                    </tr>
                                    <tr>
                                        <td  >Akun BP</td>
                                        <td  >: $row->akun_bp - $row->nama_bp </td>
                                    </tr>
                                    <tr>
                                        <td >Akun AP</td>
                                        <td >: $row->akun_deprs - $row->nama_deprs </td>
                                    </tr>
                                    </table>
                                </td>
                            </tr>
                            <tr>
                                <td colspan='5' align='right' >Nilai Perolehan</td>
                                <td width='14%' align='right' >$nilai</td>
                            </tr>
                            <tr align='center'>
                                <td width='30' >No</td>
                                <td width='100' >No Susut</td>
                                <td width='60' >Periode</td>
                                <td width='90' >Debet</td>
                                <td width='90' >Kredit</td>
                        ...
                        echo "</table><br>";
                            ...
                            <div class='row invoice-info' style=''>
                                ...
                                <div class='col-sm-12 invoice-col' style='margin-bottom: 20px;'>
                                    <address'>
                                        <strong>
                                        Kelompok : 
                                        </strong>
                            ...
                            $sql1="select no_fasusut,periode,akun_bp,akun_ap,dc,
                            case dc when 'D' then nilai else 0 end as debet,
                            case dc when 'C' then nilai else 0 end as kredit,nilai
                            from fasusut_d
                            where kode_lokasi='$row->kode_lokasi' and no_fa='$row->no_fa' and periode<='$periode_susut' order by no_fasusut";
                                ...
                                {	
                                    ...
                                    <div class='box-footer box-comments' style='background:white;border-top:0px solid white'>
                                        <div class='box-comment'>
                                            <div class='comment-text' style='margin-left: 5px;'>
                                                <span class='username'>
                                                    $row1->no_fasusut | $row1->periode | $row1->dc
                                                    <span class='text-muted pull-right' style='font-size:14px'>Nilai Susut : ".number_format($nil,0,",",".")."</span>
                                                </span><!-- /.username -->
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class='box-footer box-comments' style='background:white;border-top:0px solid white'>
                                        <div class='box-comment'>
                                            <div class='comment-text' style='margin-left: 5px;'>
                                                <span class='username'>
                                                    Akumulasi 
                                                    <span class='text-muted pull-right' style='font-size:14px'>  ".number_format($akum,0,",",".")."</span>
                                                </span><!-- /.username -->
                                                <span class='username'>
                                                    Nilai Buku
                                                    <span class='text-muted pull-right' style='font-size:14px'> ".number_format($nsaldo,0,",",".")."</span>
                                                </span><!-- /.username -->
                                            </div>
                                        </div>
                                    </div>
