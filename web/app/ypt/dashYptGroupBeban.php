...
<?php
    ...
    if ($version[1] == "iPhone" || $version[1] == "Android" || $version[1] == "Blackberry" || $version[1] == "Blazer" ||$version[1] == "Elaine" || $version[1] == "Hiptop" || $version[1] == "iPod" || $version[1] == "Kindle" ||$version[1] == "Midp" || $version[1] == "Mobile" || $version[1] == "O2" || $version[1] == "Opera Mini" ||$version[1] == "Mobile" || $version[1] == "Smartphone"){
        $back1="";
        $backto="$fmain?hal=app/ypt/dashYptGroup.php$param";
        $mobile=true;
        include('back.php');
        $padding="padding-top:50px;border:0px solid grey;box-shadow: 0 0 0 white;";
    }else{
        $back1="<div class='panel-heading'><a href='$fmain?hal=app/ypt/dashYptGroup.php$param' class='small-box-footer btn btn-default btn-sm' > Back <i class='fa fa-arrow-circle-left'></i></a></div>";
    ...
    $persenAcvp = ($rowAcvp->n4/$rowAcvp->n2)*100;
    $persenYoYp = (($rowAcvp->n4/$rowAcvp->n5)-1)*100;
    
    // echo $sqlbox1;

    //Yoy Growth List

    $sql="select a.kode_bidang as kode_lokasi, a.nama,a.n2,a.n4, ((a.n4/a.n5)-1)*100 as rasio
    ...
    where a.modul='L' and a.kode_lokasi='12' and a.kode_fs='FS1' and a.periode='$periode' and b.kode_bidang in ('1','2','3','4','5') and a.kode_neraca='58T' and a.n5 <> 0
    group by c.kode_bidang,c.nama ) a
    union all
    select a.kode_lokasi,a.skode as nama, b.n2,b.n4,((b.n4/b.n5)-1)*100 as rasio 
    from lokasi a
    ...
    sum(case a.jenis_akun when  'Pendapatan' then -a.n5 else a.n5 end) as n5
    from exs_neraca a
    where a.modul='L' and a.kode_fs='FS1' and a.periode='$periode' and a.level_lap<=1 and a.kode_neraca='58T' and a.kode_lokasi in ('03','08','11','13','14','15') and a.n5 <> 0
...
<div class='panel' style='<?=$padding?>'>
    ...
    <?=$back1?>
        <div class="col-md-6">
            <h3 style="font-size: 30px;margin-top: 0px;margin-bottom: 0px;">KOMPOSISI BEBAN</h3>
        ...
        <div class="col-md-3">
            <div class="small-box bg-red" style="border:1px solid #e8e8e8;color:black !important;background-color:white !important;border-radius: 10px;">
                <div class="inner" style="padding-top: 0px;padding: 0px 10px 10px 10px !important;">
                    ...
                    <p style="font-size: 11px;margin-bottom: 0px;color:#bab0b0;">Beban</p>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="small-box bg-red" style="border:1px solid #e8e8e8;color:black !important;background-color:white !important;border-radius: 10px;">
                <div class="inner" style="padding-top: 0px;padding: 0px 10px 10px 10px !important;">
                    <p class="judul-box" style="text-align:left;font-size: 25px !important;margin-top: 0px;font-weight: normal;margin-bottom: 0px;"> YoY Growth </p>
                    <h3 id="home_kas_box" style="font-size:35px;margin-bottom:0px"><?= number_format($persenYoYp,2,",",".") ?> %</h3>
                    <p style="font-size: 11px;margin-bottom: 0px;color:#bab0b0;">Beban</p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="small-box bg-red" style="border:1px solid #e8e8e8;color:black !important;background-color:white !important;">
                <div class="inner" style="padding: 10px !important;">
                    <h3 style="text-align:left;font-weight: bold !important;font-size: 18px;margin-bottom: 0px;"> YoY Growth (%) </h3>
                    <p style="font-size: 11px;margin-bottom: 0px;color:#bab0b0;text-align:left">Unit Bisnis</p>
                    <div class='table-responsive'>
                        <table class='table no-border'>
                            <?php while($row = $rsYoY->FetchNextObject(false)) : ?>
                                <tr>
                                    <td><?= $row->nama; ?></td>
                ...
                <td align='center'  > 
                    ...
                    <style>
                        ...
                        <tr bgcolor='#dd4b39' style='color:white'>
                            ...
                            <td width='90' rowspan='2' align='center' class='header_laporan isi-td' style='border-bottom:1px solid white;border-right:1px solid white;vertical-align:middle'>Actual Ytd <?php echo $bulan_rev." ".$tahun ?></td>
                            <td colspan='4' align='center' class='header_laporan isi-td' style='border-bottom:1px solid white;'>Ytd <?php echo $bulan." ".$tahun ?></td>
                        </tr>
                        <tr bgcolor='#dd4b39' style='color:white'>
                            ...
                            <td width='60' align='center' class='header_laporan isi-td' style='border-bottom:1px solid white;'>YoY Growth</td>
                        </tr>
        <?php
                        ...
                        while ($row1 = $rs1->FetchNextObject($toupper=false))
                        {
                            ...
                            echo "<tr bgcolor='#dd4b39' style='color:white'>
                                <td class='header_laporan isi-td'>BEBAN OPERASIONAL</td>
                                <td class='isi_laporan isi-td' align='right'>".number_format($row1->n5,0,',','.')."</td>
                                <td class='isi_laporan isi-td' align='right'>".number_format($row1->n2,0,',','.')."</td>
                                <td class='isi_laporan isi-td' align='right'>".number_format($row1->n4,0,',','.')."</td>
                                <td class='isi_laporan isi-td' class='text-center'>".number_format($persen3,2,',','.')."</td>
                                <td class='isi_laporan isi-td' class='text-center'>".number_format($persen4,2,',','.')."</td>
                                </tr>";
                        }
                        ...
                        while ($row1 = $rs1->FetchNextObject($toupper=false))
                        {
                            ...
                            echo "<tr bgcolor='#dd4b39' style='color:white'>
                                <td class='header_laporan isi-td'>Beban $row1->nama</td>
                                <td class='isi_laporan isi-td' align='right'>".number_format($row1->n5,0,',','.')."</td>
                                <td class='isi_laporan isi-td' align='right'>".number_format($row1->n2,0,',','.')."</td>
                                <td class='isi_laporan isi-td' align='right'>".number_format($row1->n4,0,',','.')."</td>
                                <td class='isi_laporan isi-td' class='text-center'>".number_format($persen3,2,',','.')."</td>
                        ...
                        order by a.rowindex";
                            ...
                            while ($row2 = $rs2->FetchNextObject($toupper=false))
                            {
                                ...
                                <td class='isi_laporan isi-td' align='right'>".number_format($row2->n5,0,',','.')."</td>
                                <td class='isi_laporan isi-td' align='right'>".number_format($row2->n2,0,',','.')."</td>
                                <td class='isi_laporan isi-td' align='right'>".number_format($row2->n4,0,',','.')."</td>
                                <td class='isi_laporan isi-td' class='text-center'>".number_format($persen3,2,',','.')."</td>
                                <td class='isi_laporan isi-td' class='text-center'>".number_format($persen4,2,',','.')."</td>
                    ...
                    while ($row2 = $rs2->FetchNextObject($toupper=false))
                    {
                        ...
                        echo "<tr bgcolor='#dd4b39' style='color:white'>
                                <td class='header_laporan isi-td'> Beban $row2->nama</td>
                                <td class='isi_laporan isi-td' align='right'>".number_format($row2->n5,0,',','.')."</td>
                                <td class='isi_laporan isi-td' align='right'>".number_format($row2->n2,0,',','.')."</td>
                                <td class='isi_laporan isi-td' align='right'>".number_format($row2->n4,0,',','.')."</td>
                                <td class='isi_laporan isi-td' class='text-center'>".number_format($persen3,2,',','.')."</td>
...
<script src="https://code.highcharts.com/modules/data.js"></script>
    ...
    $('#control-sidebar-home-tab').on('click','#dash_refresh2', function(){
        ...
        window.location.href='<?=$fmain?>?hal=app/ypt/dashYptGroupBeban.php&param='+per;
