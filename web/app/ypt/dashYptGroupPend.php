...
<?php
    ...
    where a.modul='L' and a.kode_lokasi='12' and a.kode_fs='FS1' and a.periode='$periode' and b.kode_bidang in ('1','2','3','4','5') and a.kode_neraca='57T' and a.n5 <> 0
    ...
    sum(case a.jenis_akun when  'Pendapatan' then -a.n5 else a.n5 end) as n5
    from exs_neraca a
    where a.modul='L' and a.kode_fs='FS1' and a.periode='$periode' and a.level_lap<=1 and a.kode_neraca='57T' and a.kode_lokasi in ('03','08','11','13','14','15') and a.n5 <> 0
...
<script src="https://code.highcharts.com/modules/data.js"></script>
    ...
    $('#control-sidebar-home-tab').on('click','#dash_refresh2', function(){
        ...
        window.location.href='<?=$fmain?>?hal=app/ypt/dashYptGroupPend.php&param='+per;
