...
?>
            ...
            <!-- OR -->
                ...
                <div class="col-md-6">
                    <div class='box' style='box-shadow:none;border:0'>
                        <a href='#' class='small-box-footer' style='color:black;cursor:pointer' onclick = "window.location.href='<?= $fmain ?>?hal=app/ypt/dashYptGroupPend.php&param=<?=$periode?>';">
                ...
                <div class="col-md-6">
                    <div class='box' style='box-shadow:none;border:0'>
                        <a href='#' class='small-box-footer' style='color:black;cursor:pointer' onclick = "window.location.href='<?= $fmain ?>?hal=app/ypt/dashYptGroupBeban.php&param=<?=$periode?>';">
                        <div class='box-header'>
                            <i class='fa fa-pie-chart'></i>
    ...
    // $sql ="select a.kode_lokasi,a.kode_neraca,a.nama, a.n2,a.n4 ,(a.n4/a.n2)*100 as rasio
    ...
    // where a.n2 > 0 
    // union all
    // select a.kode_bidang as kode_lokasi, a.kode_neraca,a.nama,a.n2,a.n4,(a.n4/a.n2)*100 as rasio
   ...
   order by a.kode_lokasi
    ...
    $('#control-sidebar-home-tab').on('click','#dash_refresh2', function(){
        ...
        window.location.href='<?=$fmain?>?hal=app/ypt/dashYptGroup.php&param='+per;
