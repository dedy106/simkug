    ...
    <div id="web_datatable">
        <div class="box box-widget">
            <div class="box-header">                    
                ...
                <div class="col-sm-10 pull-center" style=""><h4> Approval VP </h4>
                </div>
            </div>                                
            <div class="box-body">
            </div>
            <?php 
                ...
                where a.modul = 'MULTI' and a.progress in ('8') and a.periode<='$periode' ";
                $rs1=execute($sql);
                    ...
                    while ($row1 = $rs1->FetchNextObject($toupper=false)){
                        ...
                        <div class='box-footer box-comments' style='background:white'>
                            ...
                            <div class='comment-text'>
                                ...
                                </div><p class='li-lokasi' hidden>$row1->kode_lokasi</p>
                                <span style='margin-left: 40px;font-size:11px;color:black'>$row1->tanggal</span>
                            </div>
                        </div>
                        </a>";
                    }
...
<script>
  ...
  $('#saiweb_container').on('submit', '#web_form_edit', function(e){
    ...
    $.ajax({
        type: 'POST',
        url: 'include_lib.php?hal=server/siaga/Siaga.php&fx=simpanApproval2',
        dataType: 'json',
        data: formData,
        contentType: false,
        cache: false,
