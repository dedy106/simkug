    ...
    <div id='web_datatable'>
        <div class="box box-widget">
            <div class="box-header">                    
                ...
                <div class="col-sm-10 pull-center" style=""><h4> Approve RRA Direksi </h4>
                </div>
            </div>                                
            <div class="box-body">
            </div>
            <?php 
                ...
                where a.modul = 'MULTI' and a.progress='1' and a.periode<='$periode' ";
                $rs1=execute($sql);
...
<script>
  ...
  $('.web_datatable_edit').click(function(){
     ...
     $.ajax({
        type: 'POST',
        url: 'include_lib.php?hal=server/siaga/Siaga.php&fx=getEditApprovalDir',
        dataType: 'json',
  ...
  $('#saiweb_container').on('submit', '#web_form_edit', function(e){
    ...
    $.ajax({
        type: 'POST',
        url: 'include_lib.php?hal=server/siaga/Siaga.php&fx=simpanApprovalDir',
        dataType: 'json',
        data: formData,
        contentType: false,
        cache: false,
