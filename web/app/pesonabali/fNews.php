            ...
            <div class='col-md-8'>
                <?php
                    ...
                    foreach($daftar_artikel as $row){
                        //$url = "fMainpesonabali.php?hal=".generateSEO($row["id"], $row["judul"]);
						$url = "fMainPesonaBali.php?hal=app/pesonabali/fNewsDetail.php&id=".$row["id"];
                ...
                <center>
                    <?php generateWebPaging('fMainPesonaBali.php?hal=app/pesonabali/fNews.php&page=', $jumlah_artikel, $items_per_page, $active_page); ?>
                </center>
            </div><!--/.col-md-8-->

            <aside class="col-md-4">
                <div class="widget search">
                    <form role="form" action='fMainPesonaBali.php?hal=app/pesonabali/fSearch.php&param=news/string/1' method='GET'>
                            ...
                            <ul class="blog_category">
                                ...
                                if($rsc->RecordCount()){
                                    ...
                                    foreach($categories as $cat){
                                        echo "<li><a href='fMainPesonaBali.php?hal=app/pesonabali/fSearch.php&param=news/categories/1/".$cat['kode_kategori']."'>".$cat['nama']." <span class='badge'>".$cat['jml']."</span></a></li>";
                                    }
                                }
                                ?>
                            </ul>
                            ...
                            <ul class="blog_archieve">
                                ...
                                if($rsa->RecordCount()){
                                    ...
                                    foreach($archive as $arc){
                                        echo "<li><a href='fMainPesonaBali.php?hal=app/pesonabali/fNews.php&page=/1/".$arc['bulan']."/".$arc['tahun']."'><i class='fa fa-angle-double-right'></i> ".getNamaBulan($arc['bulan'])." ".$arc['tahun']." <span class='pull-right'>(".$arc['jml'].")</span></a></li>";
                                    }
                                }
                                ?>
                            </ul>
