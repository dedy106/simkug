  ...
  <div class="login-box-body" style="background:white;width:310px;margin:120px auto;padding:20px">
    ...
    <form action="cLogin.php?fx=login" method='POST'>
      ...
      <div class="row">
        ...
        <!-- /.col -->
            <div class="col-xs-6">
                <button type="submit" style="margin-top:3px;background: #c52d2f;border: 1px solid #c52d2f;" class="btn btn-primary btn-block btn-flat" style="margin-top:3px;">Sign In</button>
            </div>
        <!-- /.col -->
      </div>
    </form>
