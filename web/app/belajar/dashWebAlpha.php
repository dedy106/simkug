...
<div class='panel'>
    <div class='panel-heading' style='font-size:18px;padding: 10px;'> Dashboard 
            ...
            <div class='col-md-6'>
                <div class='nav-tabs-custom'>
                    <ul class="nav nav-tabs justify-content-end" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="jum-tab" data-toggle="tab" href="#jum" role="tab" aria-controls="jum" aria-selected="true">Jumlah</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="jum" role="tabpanel" aria-labelledby="jum-tab">  
                            <div id='home_tgh_chartJum'></div>
                        </div>
                        <div class="tab-pane fade show" id="nilai" role="tabpanel" aria-labelledby="nilai-tab">  
            ...
            <div class='col-md-6'>
                <div class='nav-tabs-custom'>
                    <ul class="nav nav-tabs justify-content-end" id="myTab2" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="jum2-tab" data-toggle="tab" href="#jum2" role="tab" aria-controls="jum2" aria-selected="true">Jumlah</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="nilai2-tab" data-toggle="tab" href="#nilai2" role="tab" aria-controls="nilai2" aria-selected="false">Nilai</a>
                        </li>
                    </ul>
                    <div class="tab-content" id="myTab2Content">
                        <div class="tab-pane fade show active" id="jum2" role="tabpanel" aria-labelledby="jum2-tab">  
                            <div id='home_pbyr_chartJum'></div>
                        </div>
                        <div class="tab-pane fade show" id="nilai2" role="tabpanel" aria-labelledby="nilai2-tab">  
