...
function getIsiDetail(){
    $.ajax({
        type: 'POST',
        url: 'include_lib.php?hal=server/trengginas/News.php&fx=getIsiDetail',
        dataType: 'json',
        data: {'kode_lokasi':'<?php echo $kode_lokasi ?>','str_periode':'<?php echo $strperiode ?>','page':'<?php echo $page ?>','id':'<?php echo $id; ?>'},
