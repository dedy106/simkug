...
$folder_css=$root."/web/css";
$folder_js=$root."/web/js";
...
<body class="hold-transition login-page">
    <div class="login-box" style="width:300px;margin: 10% auto !important;">
        ...
        <div class="login-box-body" style="width:300px">
            <img src="<?=$root?>/image/yakeslogo.jpg" style="height:70%; width:90%; max-height:300px; max-width:300px; margin: 0 auto; display:block;"> <br>
            <p class="login-box-msg" style="text-align: left;font-size: 18px;padding-left: 2px;margin-top: 20px;">LOGIN MOBILE</p>

            <form action="<?=$root?>/web/server/yakes/cLoginMobile.php?fx=login" method="post">
