<?php
    ...
    $root_app="http://".$_SERVER['SERVER_NAME']."/web/app/testAPI";
    $root_ser="http://".$_SERVER['SERVER_NAME']."/web/server/testAPI";
	$folder_css=$root2."/web/css";
	$folder_js=$root2."/web/js";
    $folder_img=$root2."/web/img";
    $root_hal="http://".$_SERVER['SERVER_NAME']."/web/app/";
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content" id='ajax-content-section'>
                    ...
                    // include_once("../../../web/app/belajar/fSiswa.php");
                    // $hal=$root_hal."belajar/fSiswa.php";
                    // echo "<script>alert('".$hal."')</script>";
                    ?>
            </section>
            <!-- /.content -->
        </div>
