...
<div class='box' style='border:none; margin-top: 80px; box-shadow: none;'>
    ...
    <a href="<?php echo $_SESSION['exit_url']; ?>" class="btn btn-info" style="margin-left: 2rem; border-radius: 0.8rem; padding: 0.3rem 2rem 0.4rem 2rem; border: none;">Log Out</a>
    </div>
</div>