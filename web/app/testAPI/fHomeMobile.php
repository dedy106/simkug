<?php 
    ...
    echo $header;
?>
<div class='box' style='border:none;margin-top: 50px;'>
	<div class="box-body">
		<div class="row">
			<div class="col-sm-6 col-md-6 col-xs-6">
                <a href="fMainMobile.php?hal=app/testAPI/fLabaRugiMobile.php" style="text-decoration: none;">
        ...
        success: function(response){
            if(response.status){
                switch(index){
                    ...
                    break;
                    case "kas":
                        $('#kas-bank').text(toJuta(response.kas));
                    break;
                     case "chartArus" :
