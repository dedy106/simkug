    ...
    echo "<div class='panel'>
				<div class='panel-body'>
                    <div class='panel-heading' style='padding-left: 0px;padding-top: 0px;'>
                        <a href='#' class='small-box-footer btn btn-default btn-sm' onclick=\"window.location.href='fMain.php?hal=app/dash/dashKeuDet3.php&param=$kode_lokasi|$periode|$nik|$kode_pp|$jenis|$kunci|$nama|$param|$key|$key2';\"> Back <i class='fa fa-arrow-circle-left'></i></a>
                    </div>
