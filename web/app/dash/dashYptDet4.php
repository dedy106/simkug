<?php
    ...
    $back1="";
    $backto="$fmain?hal=app/dash/dashYptDet3.php&param=$periode|$kode_pp|$box|$jenis|$kunci|$nama|$param|$key";
                        ...
                        echo"<div class='row invoice-info'>";
                            ...
                            if($tmp[9] == "semua"){
                                ...
                                echo"
                                    ...
                                    <a class='btn btn-primary btn-sm' id='btnTampil' onclick=\"window.location.href='fMainMobile.php?hal=app/dash/dashYptDet4.php&param=$periode|$kode_pp|$box|$jenis|$kunci|$nama|$param|$key|$key2|semua';\">Tampil Semua</a>
                                    </div>
                                </div>
                            </div> 
                            <div class='row'>";
                                        ...
                                        while ($row1 = $rs1->FetchNextObject($toupper=false))
                                        {
                                            ...
                                            echo"
                                            <a style='cursor:pointer;color:blue' onclick=\"window.location.href='fMainMobile.php?hal=app/dash/dashYptDet5.php&param=$periode|$kode_pp|$box|$jenis|$kunci|$nama|$param|$key|$key2|$row1->no_bukti';\">
