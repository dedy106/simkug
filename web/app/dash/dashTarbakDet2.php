	...
	echo "<div class='panel'>
			<div class='panel-body'>
				<div class='panel-heading' style='padding-left:0px'>
					<a href='fMain.php?hal=app/dash/dashTarbakDet.php&param=$periode|$kode_pp|$box' class='small-box-footer btn btn-default btn-sm' > Back <i class='fa fa-arrow-circle-left'></i></a>
				</div>";
		echo"<div class='row'>
                    ...
                    switch($box){
                        ...
                        where a.kode_lokasi='$kode_lokasi' and a.nik='$kunci'
                        order by a.nik ";
                    ...
                    <tr>
                        ...
                        <div class='box-body'>
                            <div class='table-responsive '>
                                ...
                                <tbody>";
                                $sql="select convert(varchar,tanggal,103) as tgl, DATENAME(weekday, tanggal) as hari, convert(varchar,jam_datang,108) as jam_datang, convert(varchar,jam_pulang,108) as jam_pulang  from hr_absen where nik='$kunci' and kode_lokasi='$kode_lokasi' and substring(convert(varchar,tanggal,112),1,6) = '201906' ";
                                $rs=execute($sql);
