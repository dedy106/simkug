...
getProses();
  ...
  $('#saiweb_container').on('click', '.web_datatable_edit', function(){
     ...
     $.ajax({
        ...
        dataType: 'json',
        data: {'kode_lokasi':<?=$kode_lokasi?>,'username':'<?=$nik?>','api_key':'<?=$_SESSION['api_key']?>','kode_dok':kode},
   ...
   $('#saiweb_container').on('click', '.web_datatable_del', function(){
        if(confirm('Apakah anda ingin menghapus data ini?')){
            ...
            $.ajax({
                ...
                url: '<?=$root_ser?>/Dok.php',
                dataType: 'json',
                data: {'kode_dok':kode, 'kode_lokasi':<?=$kode_lokasi?>,'username':'<?=$nik?>','api_key':'<?=$_SESSION['api_key']?>'},
                success:function(result){
