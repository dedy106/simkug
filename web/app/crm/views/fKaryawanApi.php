...
function getInit(){
    $.ajax({
        type: 'GET',
        url: '<?=$root_ser?>/Karyawan.php?fx=getInit',
        dataType: 'json',
...
$(document).ready(function(){
  ...
  $('#saiweb_container').on('click', '.web_datatable_edit', function(){
     ...
     $.ajax({
        ...
        dataType: 'json',
        data: {'kode_lokasi':<?=$kode_lokasi?>,'username':'<?=$nik?>','api_key':'<?=$_SESSION['api_key']?>','nik':kode},
   ...
   $('#saiweb_container').on('click', '.web_datatable_del', function(){
        if(confirm('Apakah anda ingin menghapus data ini?')){
            ...
            $.ajax({
                ...
                url: '<?=$root_ser?>/Karyawan.php',
                dataType: 'json',
                data: {'nik':kode, 'kode_lokasi':<?=$kode_lokasi?>,'username':'<?=$nik?>','api_key':'<?=$_SESSION['api_key']?>'},
                success:function(result){
