...
function db_Connect() { 
	...
	include_once($root."server/server/ADODB/adodb5/adodb-exceptions.inc.php");
	include_once($root."server/server/ADODB/adodb5/adodb.inc.php");
	include_once($root."server/server/ADODB/adodb5/adodb-xmlschema.inc.php" ); # or adodb-xmlschema03.inc.php
	include_once($root."server/server/conf/dbSetting.php");
