...
<script>
    ...
    function getRekapBulanan(tahun,bulan){
        $.ajax({
            type: 'POST',
            url: 'include_lib.php?hal=server/rtrw/dash_rtrw.php&fx=getRekapBulanan',
            dataType: 'json',
    ...
    $('.content-rekap').on('click','#trace_detrekap', function(e) { 
        ...
        var bulan = $('#dash_bulan').val();
        window.location.href = 'fMainMobile.php?hal=app/rtrw/fRekapDetBulanan.php&drk='+drk+'&tahun='+tahun+'&bulan='+bulan;
    });
</script>
