...
<script>
    ...
    function getKartuIuran(blok =null){
        $.ajax({
            type: 'POST',
            url: 'include_lib.php?hal=server/rtrw/dash_rtrw.php&fx=getBayarIuran',
            dataType: 'json',
            async:false,
            data: {'blok':blok},
            success:function(result){    
                ...
                if(result.status){
                    ...
                    for (var i=0;i<result.daftar.length;i++)
                    {
                        ...
                        html+=`<tr>
                            ...
                            <td width='2%'><a class='btn btn-sm btn-primary' href='fMainMobile.php?hal=app/rtrw/fBayarDetail.php&kode_rumah=`+line.kode_rumah+`&blok=`+blok+`' style='cursor:pointer;'>Bayar</td>
                        </tr>`;
                        x++;
                    }
                }
