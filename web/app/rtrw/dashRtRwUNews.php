<?php
    ...
    // echo "Browser:".$version[1];
        ...
        if ($version[1] == "iPhone" || $version[1] == "Android" || $version[1] == "Blackberry" || $version[1] == "Blazer" ||$version[1] == "Elaine" || $version[1] == "Hiptop" || $version[1] == "iPod" || $version[1] == "Kindle" ||$version[1] == "Midp" || $version[1] == "Mobile" || $version[1] == "O2" || $version[1] == "Opera Mini" ||$version[1] == "Mobile" || $version[1] == "Smartphone"){
            ...
            switch($jenis){
				case "news" :
				$backto = "$fmain?hal=app/rtrw/dashRtRwU.php";
				break;
				case "bp" :
				$backto = "$fmain?hal=app/rtrw/dashRtRwUDet.php&param=$jenis/bp";
                break;
                case "newsdet" :
                $backto= "$fmain?hal=app/rtrw/dashRtRwUDet.php&param=$jenis/news";
                break;
                }
            include('back.php');
        }else{
            ...
            switch($jenis){
				case "news" :
				$back1="<div class='panel-heading'><a class='small-box-footer' href='$fmain?hal=app/rtrw/dashRtRwU.php' > Back <i class='fa fa-arrow-circle-left'></i></a></div>";
				break;
				case "bp" :
				$back1="<div class='panel-heading'><a href='$fmain?hal=app/rtrw/dashRtRwUDet.php&param=$jenis/bp' class='small-box-footer' > Back <i class='fa fa-arrow-circle-left'></i></a></div>";
                break;
                case "newsdet" :
				$back1="<div class='panel-heading'><a href='$fmain?hal=app/rtrw/dashRtRwUDet.php&param=$jenis/news' class='small-box-footer' > Back <i class='fa fa-arrow-circle-left'></i></a></div>";
				break;
				}
        }
