<?php
    ...
    if ($version[1] == "iPhone" || $version[1] == "Android" || $version[1] == "Blackberry" || $version[1] == "Blazer" ||$version[1] == "Elaine" || $version[1] == "Hiptop" || $version[1] == "iPod" || $version[1] == "Kindle" ||$version[1] == "Midp" || $version[1] == "Mobile" || $version[1] == "O2" || $version[1] == "Opera Mini" ||$version[1] == "Mobile" || $version[1] == "Smartphone"){
        ...
        if($param == "detRekap2"){
            ...
            $backto="fMainMobile.php?hal=app/rtrw/dashRtRwDet.php&param=$jenis/$kunci/$blok/$no_rumah";
            ...
            if($tmp[7] == "" OR $tmp[7]==0){
                ...
                $prev=intval($tmp[7])-1;
                // if($next == 1) $next = 0;
                $backto="fMainMobile.php?hal=app/rtrw/dashRtRwDet2.php&param=$jenis/$kunci/$param/$tahun/$no_rumah/$blok/".$tmp[6]."/$prev";
            }
        ...
        if($tmp[4] == "" OR $tmp[4]==0){
            ...
            <a href='fMainMobile.php?hal=app/rtrw/dashRtRwDet.php&param=$jenis/$kunci/$blok/$no_rumah' class='small-box-footer' > Back <i class='fa fa-arrow-circle-left'></i></a>
            </div>";
        }else{
            $prev=intval($tmp[4])-1;
            // if($next == 1) $next = 0;
            $back1="<div class='panel-heading'>
            <a href='fMainMobile.php?hal=app/rtrw/dashRtRwDet2.php&param=$jenis/$kunci/$param/$tahun/$no_rumah/$blok/".$tmp[3]."/$prev' class='small-box-footer' > Back <i class='fa fa-arrow-circle-left'></i></a>
            </div>";
        }
                    ...
                    <div class='box box-widget'>
                            <div class='box-body'>
                                <div class='row'>
                                    ...
                                    $sql="select distinct (substring(periode,1,4)) as periode from rt_bill_d where kode_lokasi='$kode_lokasi' and kode_jenis='IWAJIB' and kode_pp='$kode_pp' order by substring(periode,1,4) desc ";
                                    // echo $sql;
                                    $resLok = execute($sql);
                                    ...
                                    <div class='box-body'>
                                        ...
                                        <div class='row'>
                                            <div class='form-group'>
                                                ...
                                                <div class='col-sm-3'>
                                                    <select name='stsByr' class='form-control selectize' id='stsByr' required>
                        ...
                        <div class='box box-widget'>
                            ...
                            while ($row2 = $rs2->FetchNextObject($toupper=false)){
                                ...
                                if($jumpage > 1 AND $page < ($jumpage-1) ){
                                    $page++;
                                    echo "<a style='cursor:pointer;'  class='btn btn-default btn-block' onclick=\"window.location.href='fMainMobile.php?hal=app/rtrw/dashRtRwDet2.php&param=$jenis/$kunci/$param/$tahun/$no_rumah/$blok/$kode_akun/$page';\">Next Page
                                    </a>";
                                }
                        echo"
                        </div>                   
    ...
    echo "<script type='text/javascript'>
          $(document).ready(function(){
                ...
                $('#dash_tahun').change(function() { 
                    ...
                    window.location.href='fMainMobile.php?hal=app/rtrw/dashRtRwDet2.php&param=$jenis/$kunci/$param/'+tahun+'/$no_rumah/$blok';
                ...
                function getAkun(){
                    $.ajax({
                        type: 'POST',
                        url: 'include_lib.php?hal=server/rtrw/RtRw.php&fx=getAkun2',
                        dataType: 'json',
