...
<script>
    ...
    function getKartuIuran(blok){
        $.ajax({
            type: 'POST',
            url: 'include_lib.php?hal=server/rtrw/dash_rtrw.php&fx=getKartuIuran',
            data : {'blok':blok},
            dataType: 'json',
            success:function(result){    
                var html=``;
                ...
                if(result.status){
                    ...
                    for (var i=0;i<result.daftar.length;i++)
                    {
                        ...
                        html+=`<tr>
                            ...
                            <td width='48%'><b>`+line.kode_rumah+`</b></td>
                            <td width='48%'style='text-align:right;color:`+clr+`'><b>`+sepNum(line.saldo)+`</b></td>
                            <td width='2%'><a href='fMainMobile.php?hal=app/rtrw/fKartuDetail.php&kode_rumah=`+line.kode_rumah+`&blok=`+blok+`' style='cursor:pointer;'><i class='fa fa-angle-right' style='font-size:20px'></a></i></td>
                        </tr>`;
                        x++;
                    }
                }
