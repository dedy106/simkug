...
<script>
    ...
    function getSetoran(){
        $.ajax({
            type: 'POST',
            url: 'include_lib.php?hal=server/rtrw/dash_rtrw.php&fx=getSetoran',
            dataType: 'json',
    ...
    $(document).ready(function(){
        $('#btnSubmit').click(function(e){
            ...
            if(total != 0 && tgl != ""){
                ...
                $.ajax({
                    type: 'POST',
                    url: 'include_lib.php?hal=server/rtrw/dash_rtrw.php&fx=simpanSetoran',
                    dataType: 'json',
                    data: myForm,
                    cache: false,
                    success:function(result){
                ...
                alert('Nilai total dan tanggal tidak boleh kosong !');
            }
