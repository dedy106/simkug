        ...
        <nav class="navbar navbar-inverse" style="background:white;color:black" >
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <?php
                        $logo = $path."web/img/trengginas-logo.png";
                    ?>
                ...
                <div class="collapse navbar-collapse" id="myNavbar" style="border-bottom:1px solid lightgrey;">
                    <ul class="nav navbar-nav navbar-right" style='margin-right:10px;'>
                        ...
                        where a.level_menu = '0' and a.kode_lokasi='$kode_lokasi' 
                        order by a.nu ";
						...
						while ($row = $rs->FetchNextObject($toupper=false))
						{
							if ($row->jenis=="Induk")
							{
								...
								while ($row2 = $rs2->FetchNextObject($toupper=false))
								{
                                    ...
                                    $link_form = "fMainTrengginas.php?hal=app/trengginas/fPage.php&param=".$row2->link;
							...
							else
							{
								...
								$link_form = "fMainTrengginas.php?hal=".$link.".php";
