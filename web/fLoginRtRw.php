...
$logo="/image/rtrw.jpeg";
$height=300;
$width=300;
if ($domain=="kavling.simkug.com")
{
	$logo="/image/dev.jpg";
}
...
<div class="login-box" style="width:300px;margin: 10% auto !important;">
  ...
  <div class="login-box-body" style="background:white;width:310px;margin:120px auto;padding:20px">
    <img src="<?=$logo?>" style="  max-height:<?=$height?>px; max-width:<?=$width?>px; margin: 0 auto; display:block;border-radius: 50%;">
    <h3 style='font-size:25px;text-align:center'>Login</h3>
    <form action="cLoginMobile.php?fx=login" method='POST'>
