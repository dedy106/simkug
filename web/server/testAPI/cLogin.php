<?php
        ...
        if($rs->RecordCount() > 0){
            try{
                ...
                if($rs2){
                    ...
                    $_SESSION['exit_url']=$root_ser."/testAPI/cLogin.php?fx=logout";
                    ...
                    header("Location: $root_app/testAPI/fMain.php?hal=".$dash, true, 301);
                    // echo $root2."/fMain.php?hal=".$dash;
                    exit();
                }else{
                    echo "<script>alert('Error Login : ".$rs2."'); window.location='$root_app/testAPI/fLogin.php';</script>";   
            ...
            echo "<script>alert('Username, password salah !'); window.location='$root_app/testAPI/fLogin.php';</script>";
        }
    ...
    function logout(){
        ...
        $root_app="http://".$_SERVER['SERVER_NAME']."/web/app";
        $header="Location: $root_app/testAPI/fLogin.php";
