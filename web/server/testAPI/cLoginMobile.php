<?php
        ...
        if($rs->RecordCount() > 0){
            try{
                ...
                if($rs2){
                    ...
                    $_SESSION['exit_url']=$root_ser."/testAPI/cLoginMobile.php?fx=logout";
                    ...
                    header("Location: $root_app/testAPI/".$fmain."?hal=".$dash, true, 301);
                    
                    exit();
                }else{
                    echo "<script>alert('Error Login : ".$rs2."'); window.location='$root_app/testAPI/fLoginMobile.php';</script>";   
            ...
            echo "<script>alert('Username, password salah !'); window.location='$root_app/testAPI/fLoginMobile.php';</script>";
        }
    ...
    function logout(){
        ...
        $root_app="http://".$_SERVER['SERVER_NAME']."/web/app";
        $header="Location: $root_app/testAPI/fLoginMobile.php";
