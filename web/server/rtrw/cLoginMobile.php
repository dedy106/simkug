<?php
        ...
        if($rs->RecordCount() > 0){
            try{
                ...
                if($rs2){
                    ...
                    $_SESSION['exit_url']=$root_ser."/rtrw/cLogin.php?fx=logout";
                    ...
                    header("Location: $root_app/rtrw/main/".$dash, true, 301);
                    // echo $root2."/fMain.php?hal=".$dash;
                    exit();
                }else{
                    echo "<script>alert('Error Login : ".$rs2."'); window.location='$root_app/rtrw/login';</script>";   
            ...
            echo "<script>alert('Username, password salah !'); window.location='$root_app/rtrw/login';</script>";
        }
    ...
    function logout(){
        ...
        $root_app="http://".$_SERVER['SERVER_NAME']."/web/app";
        $header="Location: $root_app/rtrw/login";
