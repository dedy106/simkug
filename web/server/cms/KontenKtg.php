<?php
    ...
    function getKontenKtg(){
        ...
        $query .= "SELECT kode_ktg, nama FROM lab_konten_ktg as status where kode_lokasi= '".$kode_lokasi."'  ";
    ...
    function simpanKtg(){
        ...
        $sql1= "insert into lab_konten_ktg (kode_lokasi,kode_ktg,jenis,nama) values ('".$data['kode_lokasi']."','".$id."','Gambar','".$data['nama']."') ";
    ...
    function ubahKtg(){
        ...
        $sql1="update lab_konten_ktg set nama='".$_POST['nama']."' where kode_ktg = '".$_POST['kode_ktg']."' and kode_lokasi='".$_POST['kode_lokasi']."' ";
    ...
    function hapusKtg(){
        ...
        $sql1="delete from lab_konten_ktg where kode_ktg='".$_POST['kode_ktg']."' and kode_lokasi='".$_POST['kode_lokasi']."' ";
