<?php
    ...
    function getJenis() {
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){             
            ...
            from amu_dok_jenis 
            where kode_lokasi='$kode_lokasi' and kode_klp='K03' ";
    ...
    function getData(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){            
            ...
            $query .= "select a.id_pbb,a.nop,a.obyek,isnull(b.jum_dok,'0') as jum_upload 
            from amu_pbb a 
            left join (select no_bukti,kode_lokasi,count(no_bukti) as jum_dok
                        from amu_pbb_dok
                        group by no_bukti,kode_lokasi 
						) b on a.id_pbb=b.no_bukti and a.kode_lokasi=b.kode_lokasi  
            where a.kode_lokasi= '$kode_lokasi' ";
            
            $column_array = array('a.id_pbb','a.nop','a.obyek',"isnull(b.jum_dok,'0')");
            $order_column = 'ORDER BY a.id_pbb '.$data['order'][0]['dir'];
    ...
    function simpanDok(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){            
            ...
            try{
                ...
                $url2 = "https://api.simkug.com/api/aset/upload-dok-pbb";
    ...
    function hapusDok() {
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){             
            ...
            $url = "https://api.simkug.com/api/aset/login";
            $url2 = "https://api.simkug.com/api/aset/delete-dok-pbb/$no_bukti/$no_urut";
