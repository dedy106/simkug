<?php
    ...
    function getData(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){            
            ...
            $query .= "select a.no_bukti,a.nama_inv,a.id_gedung,a.no_ruang,a.kd_asset, isnull(b.jum_dok,'0') as jum_upload 
            from amu_asset_bergerak a 
            left join (select no_bukti,kode_lokasi,kode_pp,count(no_bukti) as jum_dok
                        from amu_asset_bergerak_dok
                        group by no_bukti,kode_lokasi,kode_pp ) b on a.no_bukti=b.no_bukti and a.kode_lokasi=b.kode_lokasi 
            where a.kode_lokasi= '$kode_lokasi'  ";
            
            $column_array = array('a.no_bukti','a.nama_inv','a.id_gedung','a.no_ruang','a.kd_asset',"isnull(b.jum_dok,'0')");
    ...
    function simpanDok(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){            
            ...
            try{
                ...
                $url2 = "https://api.simkug.com/api/aset/upload-dok";
    ...
    function getJenis() {
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){             
            ...
            from amu_dok_jenis 
            where kode_lokasi='$kode_lokasi' and kode_klp='K04' ";
    ...
    function getUploadData() {
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){             
            ...
            $sql = "select a.no_bukti,a.kode_lokasi,a.file_dok,a.no_urut,a.nama,a.kode_jenis+'-'+b.tipe as kode_jenis
    ...
    function hapusDok() {
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){             
            ...
            $url = "https://api.simkug.com/api/aset/login";
            $url2 = "https://api.simkug.com/api/aset/delete-dok/$no_bukti/$no_urut";
