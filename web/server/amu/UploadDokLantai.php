<?php
    ...
    function getJenis() {
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){             
            ...
            from amu_dok_jenis 
            where kode_lokasi='$kode_lokasi' and kode_jenis='JD14' ";
    ...
    function getData(){
        ...
        if($_SESSION['isLogedIn'] AND cekAuth($_SESSION['userLog'])){            
            ...
            $query .= "select a.id_lantai,a.lantai,b.nama_gedung,isnull(c.jum_dok,0) as jum_upload
					from amu_lantai a
					...
					left join (select no_bukti,kode_lokasi,count(no_bukti) as jum_dok
							   ...
							   ) c on a.id_lantai=c.no_bukti and a.kode_lokasi=b.kode_lokasi 
					where a.kode_lokasi= '$kode_lokasi' ";
            
            $column_array = array('a.id_lantai','a.lantai','a.nama_gedung',"isnull(c.jum_dok,'0')");
            $order_column = 'ORDER BY a.id_lantai '.$data['order'][0]['dir'];
