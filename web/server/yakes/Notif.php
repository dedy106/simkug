<?php
    ...
    function getNotif(){
        ...
        a.no_depo,a.kode_kelola,bb.gambar,datediff(day,'2019-08-17',a.tgl_selesai) as jatuhtempo,d.nama as nama_kelola	   
        from inv_depo2_m a
        ...
        left join inv_depotutup_m c on a.no_depo=c.no_depo and c.tanggal <= '2019-08-17'
        where 
        a.kode_lokasi='$kode_lokasi' and a.kode_plan='1' 
        and c.no_depo is null and datediff(day,'2019-08-17',a.tgl_selesai) = $waktu";
