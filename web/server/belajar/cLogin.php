<?php
    ...
    function login(){
        ...
        if($rs->RecordCount() > 0){
            ...
            $_SESSION['exit_url']=$root_ser."/cLogin.php?fx=logout";
            ...
            header("Location: $root_app/fMain.php?hal=".$dash, true, 301);
            // echo $root2."/fMain.php?hal=".$dash;
            
            exit();
        }else{
            echo "<script>alert('Username, password salah !'); window.location='$root_app/fLogin.php';</script>";
        }
    ...
    function logout(){
        ...
        $root_app="http://".$_SERVER['SERVER_NAME']."/web/app/belajar";
        $header="Location: $root_app/fLogin.php";
