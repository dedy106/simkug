<?php
    ...
    function getKlp() {
        ...
        require_once $root.'web/lib/dompdf/autoload.inc.php';
        ...
        $html= "<style>@page { size: A4 landscape }</style><div align='center'>"; 
        while ($row = $rs->FetchNextObject($toupper=false))
        {
          $html.= "<table border='0' cellspacing='2' cellpadding='1' width='500'>
            <tr>
