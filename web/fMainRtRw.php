<?php
    ...
    if(!$_SESSION['isLogedIn']){
        echo "<script>alert('Harap login terlebih dahulu !'); window.location='/web/fLoginRtRw.php';</script>";
    }
...
<?php
    ...
    where a.kode_klp = '$kode_menu' $jenis order by kode_klp, rowindex";
    $rs=execute($sql);
        ...
        <header class="main-header" id='header'>
            ...
            <div class="navbar-custom-menu">
                ...
                <li class="dropdown messages-menu">
                    ...
                    ?>
                        <li class="footer"><a href="fMainRtRw.php?hal=app/cms/vNotif.php">View all</a></li>
                    </ul>
                </li>
            ...
            <section class="sidebar">
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    for($i=0; $i<count($daftar_menu); $i++){
                        ...
                        $this_link = "fMainRtRw.php?hal=".$forms.".php";
        ...
        <?php
            ...
            if (count($daftar_menu) > 0){
                for($i=0; $i<count($daftar_menu); $i++){
                    ...
                    $link_aktif = "fMainRtRw.php?hal=".$_GET['hal'];
