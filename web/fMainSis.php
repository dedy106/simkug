<?php
    ...
    if(!$_SESSION['isLogedIn']){
        echo "<script>alert('Harap login terlebih dahulu !'); window.location='/web/fLoginSis.php';</script>";
    }
        ...
        <?php
            ...
            if (count($daftar_menu) > 0){
                for($i=0; $i<count($daftar_menu); $i++){
                    ...
                    $this_link = "fMainSis.php?hal=".$forms.".php";

                    $link_aktif = "fMainSis.php?hal=".$_GET['hal'];
