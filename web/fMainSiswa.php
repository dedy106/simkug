<?php
    ...
    if(!$_SESSION['isLogedIn']){
        echo "<script>alert('Harap login terlebih dahulu !'); window.location='/web/fLoginSiswa.php';</script>";
    }
    include_once('autoload.php');

    $kode_menu = $_SESSION['kodeMenu'];

                $sqlX = "select a.*,b.form  from menu a 
                left join m_form b on a.kode_form=b.kode_form 
                where a.kode_klp = '$kode_menu' and a.jenis_menu = 'samping' order by kode_klp, rowindex";
        ...
        <header class="main-header" id='header'>
            ...
            <div class="navbar-custom-menu">
                ...
                <li class="dropdown messages-menu">
                    ...
                    ?>
                        <li class="footer"><a href="fMainSiswa.php?hal=app/cms/vNotif.php">View all</a></li>
                    </ul>
                </li>
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    while ($row = $rsX->FetchNextObject($toupper=false))
                    {
                    ...
                    for($i=0; $i<count($daftar_menu); $i++){
                        ...
                        $this_link = "fMainSiswa.php?hal=".$forms.".php";
