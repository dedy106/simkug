...
<body class="hold-transition login-page">
    <div class="login-box" style="width:300px;margin: 10% auto !important;">
        ...
        <div class="login-box-body" style="width:300px">
            ...
            <form action="cLoginSiswa.php?fx=login" method="post">
            ...
            <div class="row">
                ...
                <div class="col-xs-6">
                    <a href='http://simkug.ypt.or.id/apk/siswa.apk'><img src='http://ypt.simkug.com/image/Icon Google play.png' class='pull-right' style='max-height:39px; width:auto;'></a>
                </div>
                <!-- /.col -->
            </div>
            </form>
