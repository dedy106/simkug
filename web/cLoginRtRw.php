<?php
    ...
    function login(){
        ...
        if($rs->RecordCount() > 0){
            ...
            $_SESSION['exit_url']="cLoginRtRw.php?fx=logout";
            $_SESSION['form_login']="fLoginRtRw.php";
            ...
            header("Location: fMainRtRw.php?hal=".$dash, true, 301);
            
            exit();
        }else{
            echo "<script>alert('Username, password salah !'); window.location='/web/fLoginRtRw.php';</script>";
        }
    ...
    function logout(){
        ...
        $header="Location: /web/fLoginRtRw.php";
