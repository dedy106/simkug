...
<body class="homepage" style="background:#f0efef" >

    <header id="header">

        <nav class="navbar navbar-inverse" style="background:white;color:black" >
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <?php
                        $logo = $path."web/img/rumah.png";
                    ?>
                    <a class="navbar-brand"><img src="<?php echo $logo; ?>" style="padding-left:15px; padding-bottom:10px; height:70px; width:auto" alt="logo"></a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="myNavbar" style="border-bottom:1px solid lightgrey;">
                    <ul class="nav navbar-nav navbar-right" style='margin-right:10px;'>
                        ...
                        where a.level_menu = '0' and a.kode_lokasi='$kode_lokasi' and a.kode_klp='GLADIOLA' 
                        order by a.nu ";
						...
						while ($row = $rs->FetchNextObject($toupper=false))
						{
							if ($row->jenis=="Induk")
							{
								...
								while ($row2 = $rs2->FetchNextObject($toupper=false))
								{
                                    ...
                                    $link_form = "fMainGladiola.php?hal=app/gladiola/fPage.php&param=".$row2->link;
							...
							else
							{
								...
								$link_form = "fMainGladiola.php?hal=".$link.".php";
