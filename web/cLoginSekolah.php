<?php
    ...
    function login(){
        ...
        if($rs->RecordCount() > 0){
            ...
            $_SESSION['exit_url']="cLoginSekolah.php?fx=logout";
            ...
            if ($version[1] == "iPhone" || $version[1] == "Android" || $version[1] == "Blackberry" || $version[1] == "Blazer" ||$version[1] == "Elaine" || $version[1] == "Hiptop" || $version[1] == "iPod" || $version[1] == "Kindle" ||$version[1] == "Midp" || $version[1] == "Mobile" || $version[1] == "O2" || $version[1] == "Opera Mini" ||$version[1] == "Mobile" || $version[1] == "Smartphone"){
                $fmain="fMainSekolah.php";
            }else{
                $fmain="fMain.php";
            }
            
            $_SESSION['form_login']="fLoginSekolah.php";
            ...
            echo "<script>alert('Username, password salah !'); window.location='http://".$_SERVER["SERVER_NAME"]."/web/fLoginSekolah.php';</script>";
        }
    ...
    function logout(){
        ...
        $header="Location: http://".$_SERVER["SERVER_NAME"]."/web/fLoginSekolah.php";
