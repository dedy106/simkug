...
//-------------------------	
    ...
    {        		
        ...
        if (file_exists("classes/" . str_replace("_", "/", $className) . ".jui")){			
			convertJuiToJs("classes/" . str_replace("_", "/", $className) . ".jui");						
		}
    ...
    else if ($httpRequest->getParameter("mode") == "loadPackage")
    {
        ...
        $folderName = "classes/" . str_replace("_", "/", $packageName);		
    ...
    {				
		$param2 = $httpRequest->getParameter("param2");		
		$common = array("portalui_arrayList","portalui_arrayMap","server_util_arrayList","portalui_buttonState","portalui_component",
					"portalui_control","portalui_containerControl",
					"portalui_containerComponent","portalui_application","portalui_commonForm","portalui_hintFrame",
					"portalui_font","portalui_form","portalui_timer","portalui_page","portalui_childForm","portalui_msgBoard");															
    ...
    {		
		...
		{									
			//loadClass($fileName, null, $crypted, $param2, $loaded);									
			if (file_exists("classes/" . str_replace("_", "/", $fileName) . ".jui")){
				convertJuiToJs("classes/" . str_replace("_", "/", $fileName) . ".jui");						
			}			
			$fileName = "classes/" . str_replace("_", "/", $fileName) . ".js";			
			if (file_exists($fileName)){
    			$cont = file_get_contents($fileName);		
    			if ($supportsGzip){
					$buffer .= $cont ."\r\n";
